...
allExamples =
  concat
    [ examples (NumeralValue 1) ["1", "u", "un", "una"]
    ...
    , examples (NumeralValue 37) ["trenta-set"]
    , examples (NumeralValue 40) ["quaranta"]
    , examples (NumeralValue 70) ["setanta"]
    , examples (NumeralValue 78) ["Setanta-vuit"]
    , examples (NumeralValue 80) ["vuitanta"]
    , examples (NumeralValue 33) ["33", "trenta-tres", "trenta-3"]
    , examples (NumeralValue 100000) ["100000", "100K", "100k"]
    , examples (NumeralValue 300) ["tres-cents"]
    , examples (NumeralValue 243) ["243"] -- , "dos-cents quaranta-tres"] no veo la regla para esta expresión.
    , examples (NumeralValue 85) ["vuitanta-cinc"]
    ...
    , examples (NumeralValue 3) ["zero tres"]
    , examples (NumeralValue 4) ["zero quatre"]
