...
ruleOrdinalsFirstth = Rule
  ...
  , pattern =
    [ regex "(перв|втор|трет|четверт|пят|шест|седьм|восьм|девят|десят|одинадцат|двенадцат|тринадцат|четырнадцат|пятнадцат|шестнадцат|семнадцат|восемнадцат|девятнадцат|двадцат)(ьего|ьей|ого|ый|ой|ий|ая|ое|ья|ье)"
    ]
...
ruleOrdinal = Rule
  ...
  , pattern =
    ...
    , regex "(перв|втор|трет|четверт|пят|шест|седьм|восьм|девят)(ьего|ьей|ого|ый|ой|ий|ая|ое|ья|ье)"
    ]
  , prod = \tokens -> case tokens of
