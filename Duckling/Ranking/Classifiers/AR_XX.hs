...
classifiers
  = HashMap.fromList
      [("<time> timezone",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.3513978868378886, unseen = -4.07753744390572,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 57},
                   koData =
                     ClassData{prior = -1.2163953243244932, unseen = -3.258096538021482,
       ...
       ("at <time-of-day>",
        Classifier{okData =
                     ClassData{prior = -8.408311721054144e-2,
                               unseen = -4.836281906951478,
                               likelihoods =
                                 HashMap.fromList
                                   [("<hour-of-day> third", -4.135166556742356),
                                    ("<hour-of-day> and integer minutes", -2.5257286443082556),
                                    ("<hour-of-day> quarter", -4.135166556742356),
                                    ("<hour-of-day> till quarter", -3.7297014486341915),
                                    ("time-of-day ordinal (latent)", -1.8838747581358606),
                                    ("<hour-of-day> half", -4.135166556742356),
                                    ("hh:mm", -3.2188758248682006), ("hour", -1.1907275775759154),
                                    ("minute", -1.783791299578878),
                                    ("<hour-of-day> till third", -3.7297014486341915),
                                    ("time-of-day integer (latent)", -1.8325814637483102)],
                               n = 57},
                   koData =
                     ClassData{prior = -2.517696472610991, unseen = -3.0910424533583156,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5978370007556204, unseen = -5.442417710521793,
                               likelihoods =
                                 HashMap.fromList
                                   [("Tuesdayon <date>", -4.74493212836325),
                                    ("in <named-month>year", -4.74493212836325),
                                    ("<hour-of-day> till thirdafter part of days",
                                     -4.339467020255086),
                                    ("dayhour", -4.051784947803305),
                                    ("daymonth", -4.74493212836325),
                                    ("in <named-month>on <date>", -4.74493212836325),
                                    ("monthyear", -3.240854731586976),
                                    ("Mondayon <date>", -4.74493212836325),
                                    ("Christmasyear", -4.74493212836325),
                                    ("Monday<day-of-month> (ordinal or number) <named-month>",
                                     -4.74493212836325),
                                    ("month (integer)year (integer)", -4.339467020255086),
                                    ("<day-of-week> the last of <time><cycle> this|last|next",
                                     -4.74493212836325),
                                    ("at <time-of-day>before part of days", -4.051784947803305),
                                    ("hh:mmbefore part of days", -4.74493212836325),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.74493212836325),
                                    ("intersect<time> <part-of-day>", -4.339467020255086),
                                    ("month (ordinal)year (integer)", -4.74493212836325),
                                    ("dd/mm<time> <part-of-day>", -4.74493212836325),
                                    ("Thursday<time> timezone", -4.74493212836325),
                                    ("<hour-of-day> till quarterthis <part-of-day>",
                                     -4.339467020255086),
                                    ("dayday", -2.953172659135195),
                                    ("absorption of , after named day<day-of-month> (ordinal or number) <named-month>",
                                     -4.74493212836325),
                                    ("hourhour", -3.6463198396951406),
                                    ("month (integer)year", -4.74493212836325),
                                    ("Thursday<day-of-month> (ordinal or number) <named-month>",
                                     -4.74493212836325),
                                    ("dayyear", -3.492169159867882),
                                    ("Thursday<time> <part-of-day>", -4.74493212836325),
                                    ("<cycle> last of <time>year (integer)", -4.339467020255086),
                                    ("last <cycle> of <time>year (integer)", -4.74493212836325),
                                    ("<hour-of-day> quarterafter part of days", -4.74493212836325),
                                    ("minutehour", -2.4423470353692043),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.74493212836325),
                                    ("Monday<cycle> this|last|next", -4.74493212836325),
                                    ("<day-of-month> (ordinal or number) of <named-month>year",
                                     -4.74493212836325),
                                    ("<cycle> <ordinal> day? of <time>year", -4.74493212836325),
                                    ("on a <named-day>dd/mm", -4.74493212836325),
                                    ("on a <named-day>on <date>", -4.74493212836325),
                                    ("on a <named-day><day-of-month> (ordinal or number) <named-month>",
                                     -4.74493212836325),
                                    ("Tuesday<cycle> this|last|next", -4.74493212836325),
                                    ("dayminute", -3.492169159867882),
                                    ("dd/mmintersect", -4.74493212836325),
                                    ("in <named-month><cycle> this|last|next", -4.74493212836325),
                                    ("<hour-of-day> and integer minutesafter part of days",
                                     -4.339467020255086),
                                    ("Saturdaydd/mm", -4.74493212836325),
                                    ("the <cycle> the <ordinal> of <time>year", -4.74493212836325),
                                    ("at <time-of-day>after part of days", -3.6463198396951406),
                                    ("<ordinal> <cycle> of <time>year", -4.74493212836325),
                                    ("Sunday<cycle> this|last|next", -4.74493212836325),
                                    ("Tuesday<day-of-month> (ordinal or number) of <named-month>",
                                     -4.339467020255086),
                                    ("Septemberon <date>", -4.74493212836325),
                                    ("from <datetime> - <datetime> (interval)after part of days",
                                     -4.74493212836325),
                                    ("intersectintersect", -4.339467020255086),
                                    ("dayweek", -4.051784947803305),
                                    ("weekyear", -3.828641396489095),
                                    ("<datetime> - <datetime> (interval)after part of days",
                                     -4.74493212836325),
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)after part of days",
                                     -4.74493212836325),
                                    ("at <time-of-day>this <part-of-day>", -4.74493212836325),
                                    ("<hour-of-day> till thirdbefore part of days",
                                     -4.339467020255086)],
                               n = 66},
                   koData =
                     ClassData{prior = -0.7985076962177716, unseen = -5.332718793265369,
                               likelihoods =
                                 HashMap.fromList
                                   [("Tuesdayon <date>", -4.634728988229636),
                                    ("dayhour", -3.381966019734268),
                                    ("daymonth", -3.536116699561526),
                                    ("monthday", -4.634728988229636),
                                    ("monthyear", -2.7629268113280445),
                                    ("hh:mmafter part of days", -4.634728988229636),
                                    ("houryear", -4.229263880121471),
                                    ("intersectat <time-of-day>", -3.7184382563554808),
                                    ("intersect<time> <part-of-day>", -4.229263880121471),
                                    ("Octoberon <date>", -4.634728988229636),
                                    ("until <time-of-day>after part of days", -4.634728988229636),
                                    ("this|last <cycle>on <date>", -4.634728988229636),
                                    ("Tuesdayafter <time-of-day>", -4.634728988229636),
                                    ("Wednesdayon <date>", -4.229263880121471),
                                    ("dd/mm<time> <part-of-day>", -4.634728988229636),
                                    ("yearyear", -4.229263880121471),
                                    ("<hour-of-day> till quarterthis <part-of-day>",
                                     -4.634728988229636),
                                    ("dayday", -3.9415818076696905),
                                    ("dd/mmat <time-of-day>", -4.229263880121471),
                                    ("hourhour", -4.229263880121471),
                                    ("dayyear", -3.381966019734268),
                                    ("Thursdayat <time-of-day>", -4.634728988229636),
                                    ("Februaryyear", -4.634728988229636),
                                    ("minutemonth", -4.634728988229636),
                                    ("minutehour", -4.229263880121471),
                                    ("for <duration> from <time>on <date>", -4.634728988229636),
                                    ("<day-of-month> (ordinal or number) of <named-month>year",
                                     -4.229263880121471),
                                    ("March<cycle> this|last|next", -4.634728988229636),
                                    ("nth <time> of <time>year", -4.634728988229636),
                                    ("Wednesday<day-of-month> (ordinal or number) of <named-month>",
                                     -4.634728988229636),
                                    ("secondyear", -4.229263880121471),
                                    ("Wednesdayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.634728988229636),
                                    ("on <date>year (integer)", -4.634728988229636),
                                    ("<time> for <duration>year", -3.536116699561526),
                                    ("<duration> after|before|from <time>on <date>",
                                     -4.634728988229636),
                                    ("dayminute", -3.1306515914533617),
                                    ("Julyuntil <time-of-day>", -4.634728988229636),
                                    ("intersecton <date>", -4.634728988229636),
                                    ("at <time-of-day>after part of days", -4.634728988229636),
                                    ("Octoberyear", -4.634728988229636),
                                    ("in|within|after <duration>year", -4.229263880121471),
                                    ("Tuesday<day-of-month> (ordinal or number) of <named-month>",
                                     -4.634728988229636),
                                    ("on a <named-day>intersect", -4.229263880121471),
                                    ("Saturdayintersect", -4.229263880121471),
                                    ("at <time-of-day>year", -4.634728988229636),
                                    ("on <date>year", -4.229263880121471),
                                    ("on <date>on <date>", -4.634728988229636),
                                    ("weekday", -4.634728988229636),
                                    ("weekyear", -4.634728988229636),
                                    ("Tuesdayintersect", -4.634728988229636),
                                    ("after <time-of-day>year", -4.634728988229636),
                                    ("in <number> (implicit minutes)February", -4.634728988229636),
                                    ("last <cycle> of <time>year", -4.634728988229636),
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.5725191927713306, unseen = -4.394449154672439,
                               likelihoods =
                                 HashMap.fromList
                                   [("dayhour", -2.5902671654458267),
                                    ("daymonth", -2.5902671654458267),
                                    ...
                                    ("Thursday<day-of-month> (ordinal or number) <named-month>",
                                     -3.6888794541139363),
                                    ("in <named-month>year (integer)", -3.283414346005772),
                                    ("Thursdayat <time-of-day>", -3.6888794541139363),
                                    ("Thursday<time> <part-of-day>", -3.283414346005772),
                                    ("last <cycle> of <time>year (integer)", -3.6888794541139363),
                                    ("Tuesdaymonth (integer)", -3.6888794541139363),
                                    ("Wednesday<day-of-month> (ordinal or number) of <named-month>",
                                     -3.6888794541139363),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -3.6888794541139363),
                                    ("Septemberyear (integer)", -3.283414346005772),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.6888794541139363),
                                    ("on a <named-day>September", -3.6888794541139363),
                                    ("Octoberyear (integer)", -3.6888794541139363),
                                    ("Sunday<cycle> this|last|next", -3.6888794541139363),
                                    ("dayweek", -3.283414346005772),
                                    ("weekyear", -3.6888794541139363),
                                    ("Mondaythis|last the <cycle>", -3.6888794541139363),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)in <named-month>",
                                     -3.6888794541139363),
                                    ("Wednesdayin <named-month>", -3.6888794541139363)],
                               n = 22},
                   koData =
                     ClassData{prior = -0.8303483020734304,
                               unseen = -4.2626798770413155,
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -2.05127066471314),
                                    ("TuesdaySeptember", -3.5553480614894135),
                                    ("monthyear", -2.639057329615259),
                                    ("on a <named-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -3.5553480614894135),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (integer)",
                                     -2.8622008809294686),
                                    ("dayyear", -2.456735772821304),
                                    ("Monday<cycle> this|last|next", -3.5553480614894135),
                                    ("Wednesdayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -3.5553480614894135),
                                    ("Septemberyear (integer)", -3.5553480614894135),
                                    ("on <date>year (integer)", -3.1498829533812494),
                                    ("Octoberyear (integer)", -3.5553480614894135),
                                    ("intersectyear (integer)", -3.5553480614894135),
                                    ("Mondayin <named-month>", -3.5553480614894135),
       ...
       ("<named-month>|<named-day> <day-of-month> (ordinal)",
        Classifier{okData =
                     ClassData{prior = -0.6931471805599453, unseen = -2.772588722239781,
                               likelihoods =
                                 HashMap.fromList
                                   [("Sundayordinals (thirtieth..nineteenth)", -2.0149030205422647),
                                    ("Tuesdayordinals (first..tenth)", -1.6094379124341003),
                   ...
                   koData =
                     ClassData{prior = -0.6931471805599453, unseen = -2.772588722239781,
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesdayordinals (first..tenth)", -2.0149030205422647),
                                    ("Tuesdayordinals (first..tenth)", -2.0149030205422647),
                                    ("Sundayordinals (first..tenth)", -2.0149030205422647),
                                    ("day", -1.0986122886681098),
                                    ("Saturdayordinals (first..tenth)", -2.0149030205422647)],
                               n = 4}}),
       ("after part of days",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.1972245773362196,
       ...
       ("time-of-day integer (latent)",
        Classifier{okData =
                     ClassData{prior = -0.5212969236332861,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.3629054936893685),
                                    ("integer 3", -1.749199854809259),
                                    ("integer 5", -2.4423470353692043)],
                               n = 19},
                   koData =
                     ClassData{prior = -0.9007865453381898, unseen = -2.890371757896165,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("single <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -4.23410650459726, unseen = -2.9444389791664407,
                               likelihoods =
                                 HashMap.fromList
                   ...
                   koData =
                     ClassData{prior = -1.4598799421152636e-2,
                               unseen = -5.659482215759621,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.61146937309643),
                                    ("month (grain)", -2.2547944291576973),
                                    ("hour (grain)", -1.9924301646902063),
                                    ("year (grain)", -2.883403088580071),
                                    ("second", -4.046553898385752),
                                    ("week (grain)", -2.61146937309643),
                                    ("day", -2.5649493574615367),
                                    ("minute (grain)", -3.353406717825807),
                                    ("year", -2.883403088580071),
                                    ("second (grain) ", -4.046553898385752),
                                    ("hour", -1.9924301646902063), ("month", -2.2547944291576973),
                                    ("minute", -3.353406717825807),
                                    ("day (grain)", -2.5649493574615367)],
                               n = 136}}),
