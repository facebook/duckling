...
classifiers
  = HashMap.fromList
      [("<time> timezone",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.6061358035703156, unseen = -5.44673737166631,
                               likelihoods =
                                 HashMap.fromList
                                   [("Tuesdayon <date>", -4.749270529961848),
                                    ("in <named-month>year", -4.749270529961848),
                                    ("<hour-of-day> till thirdafter part of days",
                                     -4.343805421853684),
                                    ("dayhour", -4.056123349401903),
                                    ("daymonth", -4.749270529961848),
                                    ("in <named-month>on <date>", -4.749270529961848),
                                    ("monthyear", -3.245193133185574),
                                    ("Mondayon <date>", -4.749270529961848),
                                    ("Christmasyear", -4.749270529961848),
                                    ("Monday<day-of-month> (ordinal or number) <named-month>",
                                     -4.749270529961848),
                                    ("month (integer)year (integer)", -4.343805421853684),
                                    ("<day-of-week> the last of <time><cycle> this|last|next",
                                     -4.749270529961848),
                                    ("at <time-of-day>before part of days", -4.056123349401903),
                                    ("hh:mmbefore part of days", -4.749270529961848),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.749270529961848),
                                    ("intersect<time> <part-of-day>", -4.343805421853684),
                                    ("month (ordinal)year (integer)", -4.749270529961848),
                                    ("dd/mm<time> <part-of-day>", -4.749270529961848),
                                    ("Thursday<time> timezone", -4.749270529961848),
                                    ("<hour-of-day> till quarterthis <part-of-day>",
                                     -4.343805421853684),
                                    ("dayday", -2.9575110607337933),
                                    ("absorption of , after named day<day-of-month> (ordinal or number) <named-month>",
                                     -4.749270529961848),
                                    ("hourhour", -3.6506582412937383),
                                    ("month (integer)year", -4.749270529961848),
                                    ("Thursday<day-of-month> (ordinal or number) <named-month>",
                                     -4.749270529961848),
                                    ("dayyear", -3.4965075614664802),
                                    ("Thursday<time> <part-of-day>", -4.749270529961848),
                                    ("<cycle> last of <time>year (integer)", -4.343805421853684),
                                    ("last <cycle> of <time>year (integer)", -4.749270529961848),
                                    ("<hour-of-day> quarterafter part of days", -4.749270529961848),
                                    ("minutehour", -2.4466854369678024),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.749270529961848),
                                    ("Monday<cycle> this|last|next", -4.749270529961848),
                                    ("<day-of-month> (ordinal or number) of <named-month>year",
                                     -4.749270529961848),
                                    ("<cycle> <ordinal> day? of <time>year", -4.749270529961848),
                                    ("on a <named-day>dd/mm", -4.749270529961848),
                                    ("on a <named-day>on <date>", -4.749270529961848),
                                    ("on a <named-day><day-of-month> (ordinal or number) <named-month>",
                                     -4.749270529961848),
                                    ("Tuesday<cycle> this|last|next", -4.749270529961848),
                                    ("dayminute", -3.4965075614664802),
                                    ("dd/mmintersect", -4.749270529961848),
                                    ("in <named-month><cycle> this|last|next", -4.749270529961848),
                                    ("<hour-of-day> and integer minutesafter part of days",
                                     -4.343805421853684),
                                    ("Saturdaydd/mm", -4.749270529961848),
                                    ("the <cycle> the <ordinal> of <time>year", -4.749270529961848),
                                    ("at <time-of-day>after part of days", -3.6506582412937383),
                                    ("<ordinal> <cycle> of <time>year", -4.749270529961848),
                                    ("Sunday<cycle> this|last|next", -4.749270529961848),
                                    ("Tuesday<day-of-month> (ordinal or number) of <named-month>",
                                     -4.343805421853684),
                                    ("Septemberon <date>", -4.749270529961848),
                                    ("from <datetime> - <datetime> (interval)after part of days",
                                     -4.749270529961848),
                                    ("intersectintersect", -4.343805421853684),
                                    ("dayweek", -4.056123349401903),
                                    ("weekyear", -3.832979798087693),
                                    ("<datetime> - <datetime> (interval)after part of days",
                                     -4.749270529961848),
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)after part of days",
                                     -4.749270529961848),
                                    ("at <time-of-day>this <part-of-day>", -4.749270529961848),
                                    ("<hour-of-day> till thirdbefore part of days",
                                     -4.343805421853684)],
                               n = 66},
                   koData =
                     ClassData{prior = -0.7884573603642702,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Tuesdayon <date>", -4.6491870714048655),
                                    ("dayhour", -3.262892710284975),
                                    ("daymonth", -3.550574782736756),
                                    ("monthday", -4.6491870714048655),
                                    ("monthyear", -2.777384894503274),
                                    ("hh:mmafter part of days", -4.6491870714048655),
                                    ("houryear", -4.243721963296701),
                                    ("intersectat <time-of-day>", -3.7328963395307104),
                                    ("intersect<time> <part-of-day>", -4.243721963296701),
                                    ("Octoberon <date>", -4.6491870714048655),
                                    ("until <time-of-day>after part of days", -4.6491870714048655),
                                    ("this|last <cycle>on <date>", -4.6491870714048655),
                                    ("Tuesdayafter <time-of-day>", -4.6491870714048655),
                                    ("Wednesdayon <date>", -4.243721963296701),
                                    ("dd/mm<time> <part-of-day>", -4.6491870714048655),
                                    ("yearyear", -4.243721963296701),
                                    ("<hour-of-day> till quarterthis <part-of-day>",
                                     -4.6491870714048655),
                                    ("dayday", -3.9560398908449206),
                                    ("dd/mmat <time-of-day>", -4.243721963296701),
                                    ("hourhour", -4.243721963296701),
                                    ("dayyear", -3.3964241029094975),
                                    ("Thursdayat <time-of-day>", -4.6491870714048655),
                                    ("Februaryyear", -4.6491870714048655),
                                    ("minutemonth", -4.6491870714048655),
                                    ("minutehour", -4.243721963296701),
                                    ("for <duration> from <time>on <date>", -4.6491870714048655),
                                    ("<day-of-month> (ordinal or number) of <named-month>year",
                                     -4.243721963296701),
                                    ("March<cycle> this|last|next", -4.6491870714048655),
                                    ("nth <time> of <time>year", -4.6491870714048655),
                                    ("Wednesday<day-of-month> (ordinal or number) of <named-month>",
                                     -4.6491870714048655),
                                    ("secondyear", -4.243721963296701),
                                    ("Wednesdayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.6491870714048655),
                                    ("on <date>year (integer)", -4.6491870714048655),
                                    ("<time> for <duration>year", -3.550574782736756),
                                    ("<duration> after|before|from <time>on <date>",
                                     -4.6491870714048655),
                                    ("dayminute", -3.1451096746285914),
                                    ("Julyuntil <time-of-day>", -4.6491870714048655),
                                    ("intersecton <date>", -4.6491870714048655),
                                    ("at <time-of-day>after part of days", -4.6491870714048655),
                                    ("Octoberyear", -4.6491870714048655),
                                    ("in|within|after <duration>year", -4.243721963296701),
                                    ("Tuesday<day-of-month> (ordinal or number) of <named-month>",
                                     -4.6491870714048655),
                                    ("on a <named-day>intersect", -4.243721963296701),
                                    ("Saturdayintersect", -4.243721963296701),
                                    ("at <time-of-day>year", -4.6491870714048655),
                                    ("on <date>year", -4.243721963296701),
                                    ("on <date>on <date>", -4.6491870714048655),
                                    ("weekday", -4.6491870714048655),
                                    ("Tuesdaynth <time> of <time>", -4.6491870714048655),
                                    ("weekyear", -4.6491870714048655),
                                    ("Tuesdayintersect", -4.6491870714048655),
                                    ("after <time-of-day>year", -4.6491870714048655),
                                    ("in <number> (implicit minutes)February", -4.6491870714048655),
                                    ("last <cycle> of <time>year", -4.6491870714048655),
       ...
       ("single <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -4.241326752570746, unseen = -2.9444389791664407,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 2},
                   koData =
                     ClassData{prior = -1.4493007302566864e-2,
                               unseen = -5.666426688112432,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.6184380424125226),
                                    ("month (grain)", -2.2289732756508),
                                    ("hour (grain)", -1.9993988340062996),
                                    ("year (grain)", -2.890371757896165),
                                    ("second", -4.053522567701846),
                                    ("week (grain)", -2.6184380424125226),
                                    ("day", -2.57191802677763),
                                    ("minute (grain)", -3.3603753871419),
                                    ("year", -2.890371757896165),
                                    ("second (grain) ", -4.053522567701846),
                                    ("hour", -1.9993988340062996), ("month", -2.2289732756508),
                                    ("minute", -3.3603753871419),
                                    ("day (grain)", -2.57191802677763)],
                               n = 137}}),
