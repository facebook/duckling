...
classifiers
  = HashMap.fromList
      [("midnight",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6216882165778003, unseen = -4.0943445622221,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 58},
                   koData =
                     ClassData{prior = -0.7701082216960736, unseen = -3.951243718581427,
       ...
       ("<day-of-month> de <named-month>",
        Classifier{okData =
                     ClassData{prior = -7.145896398214498e-2,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("number (0..15)Maig", -2.8183982582710754),
                                    ("integer (numeric)Gener", -3.5115454388310208),
                                    ("integer (numeric)Mar\231", -2.412933150162911),
                                    ("integer (numeric)Juliol", -3.5115454388310208),
                                    ("integer (numeric)Febrer", -2.12525107771113),
                                    ("integer (numeric)Abril", -3.1060803307228566),
                                    ("integer (numeric)Maig", -3.5115454388310208),
                                    ("integer (numeric)Octubre", -3.5115454388310208),
                                    ("number (0..15)Mar\231", -3.1060803307228566),
                                    ("integer (numeric)Agost", -3.5115454388310208),
                                    ("month", -0.8724881092157621),
                                    ("integer (numeric)Setembre", -3.1060803307228566),
                                    ("integer (numeric)Desembre", -3.5115454388310208)],
                               n = 27},
                   koData =
                     ClassData{prior = -2.6741486494265287, unseen = -2.890371757896165,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.23841102344499823,
                               unseen = -4.356708826689592,
                               likelihoods =
                                 HashMap.fromList
                                   [("<day-of-month> de <named-month>in the <part-of-day>",
                                     -3.6506582412937383),
                                    ("dayhour", -1.6357552207514738),
                                    ("daymonth", -3.245193133185574),
                                    ("monthyear", -3.6506582412937383),
                                    ("tomorrowin the <part-of-day>", -2.3978952727983707),
                                    ("Maigdel <year>", -3.6506582412937383),
                                    ("el <day-of-month> de <named-month>in the <part-of-day>",
                                     -3.6506582412937383),
                                    ("Dillunsin the <part-of-day>", -3.6506582412937383),
                                    ("dayyear", -2.1465808445174646),
                                    ("quarteryear", -3.6506582412937383),
                                    ("intersect by `de`in the <part-of-day>", -3.6506582412937383),
                                    ("Dia Internacional de les Cooperativesel <time>",
                                     -3.6506582412937383),
                                    ("intersect by `de`del <year>", -3.6506582412937383),
                                    ("<day-of-month> de <named-month>del <year>",
                                     -3.6506582412937383),
                                    ("Dia Internacional de les Cooperativesdel <year>",
                                     -3.6506582412937383),
                                    ("el <day-of-month> (non ordinal)Agost", -3.245193133185574),
                                    ("<ordinal> quarterdel <year>", -3.6506582412937383),
                                    ("el <time>in the <part-of-day>", -3.6506582412937383),
                                    ("el <day-of-month> de <named-month>del <year>",
                                     -3.6506582412937383),
                                    ("el <time>del <year>", -3.6506582412937383),
                                    ("yesterdayin the <part-of-day>", -2.9575110607337933),
                                    ("dd-dd <month>(interval)del <year>", -3.245193133185574)],
                               n = 26},
                   koData =
                     ClassData{prior = -1.550597412411167, unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
                                   [("monthyear", -2.277267285009756),
                                    ("Maigdel <year>", -2.9704144655697013),
                                    ("Febrerin the <part-of-day>", -2.9704144655697013),
                                    ("monthhour", -2.9704144655697013),
                                    ("dayyear", -2.277267285009756),
                                    ("<day-of-month> de <named-month>del <year>",
                                     -2.277267285009756),
                                    ("Julioldel <year>", -2.5649493574615367)],
                               n = 7}}),
       ("Dilluns",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.1972245773362196,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.19105523676270922),
                                    ("number (0..15)", -1.749199854809259)],
                               n = 21},
                   koData =
                     ClassData{prior = -1.8325814637483102,
                               unseen = -1.9459101490553135,
                               likelihoods =
