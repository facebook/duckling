...
classifiers
  = HashMap.fromList
      [("<time> timezone",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7871761302082216, unseen = -4.969813299576001,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 142},
                   koData =
                     ClassData{prior = -0.6072047507592206, unseen = -5.147494476813453,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.37515975861283546, unseen = -5.84354441703136,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 134},
                   koData =
                     ClassData{prior = -1.1621256943904354, unseen = -5.293304824724492,
                               likelihoods =
                                 HashMap.fromList
                                   [("dayhour", -2.9856819377004897),
                                    ("daymonth", -2.1972245773362196),
                                    ("monthyear", -3.6788291182604347),
                                    ("Marchyear", -3.9019726695746444),
                                    ("intersect by \"of\", \"from\", \"'s\"year",
                                     -3.342356881639222),
                                    ("Sundaythis <time>", -3.6788291182604347),
                                    ("absorption of , after named dayJuly", -4.189654742026425),
                                    ("dd/mmat <time-of-day>", -3.6788291182604347),
                                    ("hourhour", -3.342356881639222),
                                    ("dayyear", -3.2088254890146994),
                                    ("Thursdayat <time-of-day>", -3.0910424533583156),
                                    ("Thursdayhh:mm", -4.189654742026425),
                                    ("WednesdayFebruary", -4.59511985013459),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.59511985013459),
                                    ("in|during the <part-of-day>until <time-of-day>",
                                     -4.189654742026425),
                                    ("Aprilyear", -4.59511985013459),
                                    ("until <time-of-day>on <date>", -4.59511985013459),
                                    ("dayminute", -3.342356881639222),
                                    ("Tuesdaythis <time>", -3.6788291182604347),
                                    ("minuteday", -3.0910424533583156),
                                    ("hh:mmon <date>", -3.2088254890146994),
                                    ("Wednesdaythis <time>", -3.342356881639222),
                                    ("absorption of , after named dayFebruary", -4.189654742026425),
                                    ("this <part-of-day>until <time-of-day>", -4.189654742026425),
                                    ("tomorrownoon", -4.59511985013459),
                                    ("this <time>until <time-of-day>", -4.189654742026425),
                                    ("Mondaythis <time>", -4.189654742026425)],
                               n = 61}}),
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.7926767759069784, unseen = -3.828641396489095,
                               likelihoods =
                                 HashMap.fromList [("integer (numeric)", -2.247285585205863e-2)],
                               n = 43},
                   koData =
                     ClassData{prior = -0.6026331730191135, unseen = -4.007333185232471,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.30010459245033816),
                                    ("integer (0..19)", -1.349926716949016)],
                               n = 52}}),
       ("year",
        Classifier{okData =
