...
classifiers
  = HashMap.fromList
      [("<time> timezone",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7318616927406357,
                               unseen = -4.7535901911063645,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 114},
                   koData =
                     ClassData{prior = -0.6558757857627137,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.23550699933354308,
                               unseen = -6.889591308354466,
                               likelihoods =
                                 HashMap.fromList
                                   [("intersect by ','named-month", -4.403665809777363),
                                    ("hourday", -4.94266231051005),
                                    ("dayhour", -2.5318636328757713),
                                    ("daymonth", -3.1273723438718006),
                                    ("<day-of-month>(ordinal) <named-month> year<time-of-day>  o'clock",
                                     -6.195425279005418),
                                    ("monthyear", -4.490677186766993),
                                    ("yearhour", -6.195425279005418),
                                    ("intersect<time-of-day>  o'clock", -4.055359115509147),
                                    ("christmasyear", -6.195425279005418),
                                    ("after lunchat <time-of-day>", -6.195425279005418),
                                    ("absorption of , after named daymm/dd/yyyy",
                                     -6.195425279005418),
                                    ("named-daylast <cycle>", -6.195425279005418),
                                    ("intersect by 'of', 'from', 'syear", -5.7899601708972535),
                                    ("<time-of-day> am|pmintersect", -5.096812990337308),
                                    ("intersect<time> <part-of-day>", -4.115983737325582),
                                    ("the <day-of-month> (ordinal)named-month", -6.195425279005418),
                                    ("<time-of-day>  o'clockafter lunch", -5.502278098445473),
                                    ("<time> <part-of-day><time-of-day>  o'clock",
                                     -6.195425279005418),
                                    ("today<time-of-day>  o'clock", -6.195425279005418),
                                    ("<time-of-day>  o'clockon <date>", -5.7899601708972535),
                                    ("<time-of-day> am|pmintersect by ','", -5.502278098445473),
                                    ("intersect by ','year", -5.096812990337308),
                                    ("on <date><time-of-day>  o'clock", -6.195425279005418),
                                    ("exactly <time-of-day>tomorrow", -5.7899601708972535),
                                    ("mm/dd<time-of-day>  o'clock", -6.195425279005418),
                                    ("monthhour", -5.7899601708972535),
                                    ("on <date>between <datetime> and <datetime> (interval)",
                                     -6.195425279005418),
                                    ("last <day-of-week> of <time>year", -6.195425279005418),
                                    ("hourmonth", -5.7899601708972535),
                                    ("todayat <time-of-day>", -5.502278098445473),
                                    ("mm/ddabout <time-of-day>", -5.7899601708972535),
                                    ("on <date>between <time-of-day> and <time-of-day> (interval)",
                                     -6.195425279005418),
                                    ("on <date>at <time-of-day>", -5.7899601708972535),
                                    ("named-dayhh:mm", -6.195425279005418),
                                    ("dayday", -3.0173714486574723),
                                    ("<time> <part-of-day>at <time-of-day>", -5.7899601708972535),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -6.195425279005418),
                                    ("about <time-of-day>on <date>", -6.195425279005418),
                                    ("<hour-of-day> <integer> (as relative minutes)in|during the <part-of-day>",
                                     -5.7899601708972535),
                                    ("<day-of-month> (ordinal)intersect", -5.096812990337308),
                                    ("hourhour", -3.6696966346971625),
                                    ("<part-of-day> of <time>named-month", -5.7899601708972535),
                                    ("hh:mmintersect by ','", -4.94266231051005),
                                    ("intersectnamed-month", -3.362211934949202),
                                    ("dayyear", -3.521276629578889),
                                    ("<time-of-day>  o'clockin|during the <part-of-day>",
                                     -5.096812990337308),
                                    ("tomorrow<time-of-day>  o'clock", -6.195425279005418),
                                    ("<time-of-day>  o'clocktomorrow", -5.502278098445473),
                                    ...
                                    ("absorption of , after named day<day-of-month>(ordinal) <named-month>",
                                     -4.94266231051005),
                                    ("hourminute", -5.502278098445473),
                                    ("on <date><day-of-month>(ordinal) <named-month>",
                                     -5.7899601708972535),
                                    ("minutemonth", -3.521276629578889),
                                    ("minutehour", -3.9441334803989228),
                                    ("named-day<time> timezone", -6.195425279005418),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.279134547131263),
                                    ("named-monthyear", -4.490677186766993),
                                    ...
                                    ("named-day<datetime> - <datetime> (interval)",
                                     -6.195425279005418),
                                    ("on <date>named-month", -5.279134547131263),
                                    ...
                                    ("<day-of-month>(ordinal) <named-month>intersect",
                                     -6.195425279005418),
                                    ("hh:mmintersect", -3.7530782436362133),
                                    ("named-dayfrom <datetime> - <datetime> (interval)",
                                     -5.7899601708972535),
                                    ("named-daynext <cycle>", -6.195425279005418),
                                    ("named-dayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.502278098445473),
                                    ("<day-of-month> (ordinal)named-day", -5.7899601708972535),
                                    ("intersect by ','intersect", -4.94266231051005),
                                    ("half <integer> (german style hour-of-day)in|during the <part-of-day>",
                                     -5.7899601708972535),
                                    ("at <time-of-day>intersect", -4.403665809777363),
                                    ...
                                    ("absorption of , after named day<day-of-month> (ordinal)",
                                     -4.94266231051005),
                                    ("dayminute", -3.9982007016691985),
                                    ("on <date>from <datetime> - <datetime> (interval)",
                                     -6.195425279005418),
                                    ("<time> <part-of-day>from <datetime> - <datetime> (interval)",
                                     -6.195425279005418),
                                    ("intersectyear", -4.403665809777363),
                                    ("dd. - dd.mm. (interval)year", -6.195425279005418),
                                    ("on <date>intersect", -5.7899601708972535),
                                    ("on <date><day-of-month> (ordinal)", -5.7899601708972535),
                                    ("<ordinal> <cycle> of <time>year", -6.195425279005418),
                                    ("minuteday", -2.215743625103457),
                                    ...
                                    ("<datetime> - <datetime> (interval)named-month",
                                     -5.7899601708972535),
                                    ("year<time-of-day>  o'clock", -6.195425279005418),
                                    ("at <time-of-day>intersect by ','", -5.502278098445473),
                                    ("named-dayat <time-of-day>", -5.7899601708972535),
                                    ("hh:mmabsorption of , after named day", -5.7899601708972535),
                                    ("<time-of-day> am|pmnamed-day", -6.195425279005418),
                                    ("intersect by ','<time> <part-of-day>", -5.279134547131263),
                                    ("hh:mmon <date>", -3.7530782436362133),
                                    ("named-daybetween <datetime> and <datetime> (interval)",
                                     -6.195425279005418),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.195425279005418),
                                    ("until <time-of-day>after lunch", -6.195425279005418),
                                    ("mm/ddyear", -5.7899601708972535),
                                    ("intersect by ','<time-of-day>  o'clock", -5.279134547131263),
                                    ("intersect<day-of-month> (ordinal)", -4.809130917885527),
                                    ("absorption of , after named daymm/dd", -6.195425279005418),
                                    ("named-day<time-of-day>  o'clock", -6.195425279005418),
                                    ("<day-of-month> (ordinal)intersect by 'of', 'from', 's",
                                     -5.502278098445473),
                                    ("at <time-of-day>on <date>", -4.323623102103826),
                                    ("intersectintersect", -4.055359115509147),
                                    ("dayweek", -5.096812990337308),
                                    ("absorption of , after named daythe <day-of-month> (ordinal)",
                                     -6.195425279005418),
                                    ("weekyear", -5.7899601708972535),
                                    ("hh:mmin|during the <part-of-day>", -5.279134547131263),
                                    ("intersect by 'of', 'from', 'snamed-month",
                                     -6.195425279005418),
                                    ("named-monthintersect", -6.195425279005418),
                                    ("<day-of-month> (ordinal)named-month", -4.323623102103826),
                                    ("tomorrowat <time-of-day>", -5.7899601708972535),
                                    ("<hour-of-day> <integer> (as relative minutes)on <date>",
                                     -6.195425279005418),
                                    ("named-daythis <cycle>", -5.502278098445473),
                                    ("at <time-of-day>tomorrow", -6.195425279005418),
                                    ("about <time-of-day>in|during the <part-of-day>",
                                     -5.7899601708972535),
                                    ("half <integer> (german style hour-of-day)on <date>",
                                     -6.195425279005418),
                                    ("this <part-of-day>at <time-of-day>", -5.7899601708972535),
                                    ("after lunch<hour-of-day> <integer> (as relative minutes)",
                                     -5.7899601708972535),
                                    ("last <cycle> of <time>year", -5.7899601708972535),
                               ...
                               n = 418},
                   koData =
                     ClassData{prior = -1.5614582305459652, unseen = -5.908082938168931,
                               likelihoods =
                                 HashMap.fromList
                                   [("intersect by ','named-month", -4.51906748693468),
                                    ("named-day<part-of-day> of <time>", -5.212214667494625),
                                    ("absorption of , after named daythe <day-of-month> (non ordinal)",
                                     -5.212214667494625),
                                    ("dayhour", -4.51906748693468),
                                    ("daymonth", -3.3404124905930335),
                                    ("monthday", -4.806749559386461),
                                    ("monthyear", -5.212214667494625),
                                    ("yearhour", -5.212214667494625),
                                    ("after lunchat <time-of-day>", -4.806749559386461),
                                    ("intersect by 'of', 'from', 'syear", -4.51906748693468),
                                    ("<time-of-day> am|pmintersect", -3.5074665752562),
                                    ("intersect<time> <part-of-day>", -5.212214667494625),
                                    ("<time-of-day>  o'clockafter lunch", -5.212214667494625),
                                    ("after lunch<time-of-day>  o'clock", -5.212214667494625),
                                    ("at <time-of-day>named-day", -5.212214667494625),
                                    ("absorption of , after named dayhh:mm", -5.212214667494625),
                                    ("<time-of-day> am|pmintersect by ','", -3.9594516989992568),
                                    ("<time-of-day>  o'clock<time> <part-of-day>",
                                     -4.29592393562047),
                                    ("monthhour", -5.212214667494625),
                                    ("on <date>between <datetime> and <datetime> (interval)",
                                     -5.212214667494625),
                                    ("todayat <time-of-day>", -5.212214667494625),
                                    ("on <date>between <time-of-day> and <time-of-day> (interval)",
                                     -5.212214667494625),
                                    ("named-dayhh:mm", -5.212214667494625),
                                    ("dayday", -3.8259203063747345),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.806749559386461),
                                    ("hourhour", -3.7081372707183506),
                                    ("intersectnamed-month", -3.6027767550605247),
                                    ("dayyear", -4.113602378826515),
                                    ("minutemonth", -3.266304518439312),
                                    ("named-monthyear", -5.212214667494625),
                                    ("named-day<time-of-day> - <time-of-day> (interval)",
                                     -5.212214667494625),
                                    ("on <date>named-month", -5.212214667494625),
                                    ("absorption of , after named daynamed-month",
                                     -4.113602378826515),
                                    ("intersect<day-of-month>(ordinal) <named-month>",
                                     -4.51906748693468),
                                    ("named-dayafter <time-of-day>", -4.806749559386461),
                                    ("named-dayfrom <datetime> - <datetime> (interval)",
                                     -4.806749559386461),
                                    ...
                                    ("named-dayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.51906748693468),
                                    ("<day-of-month> (ordinal)named-day", -4.51906748693468),
                                    ("<day-of-month> (ordinal)hh:mm", -4.806749559386461),
                                    ("at <time-of-day>intersect", -4.113602378826515),
                                    ("on <date>from <time-of-day> - <time-of-day> (interval)",
                                     -4.806749559386461),
                                    ("dayminute", -2.9096295745005794),
                                    ("on <date>from <datetime> - <datetime> (interval)",
                                     -5.212214667494625),
                                    ("minuteday", -2.216482393940634),
                                    ("named-daybetween <time-of-day> and <time-of-day> (interval)",
                                     -5.212214667494625),
                                    ("at <time-of-day>intersect by ','", -4.51906748693468),
                                    ("<time-of-day> am|pmnamed-day", -4.806749559386461),
                                    ("named-daybetween <datetime> and <datetime> (interval)",
                                     -5.212214667494625),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.212214667494625),
                                    ("named-month<day-of-month> (non ordinal) <named-month>",
                                     -4.806749559386461),
                                    ("year<time> <part-of-day>", -5.212214667494625),
                                    ("mm/ddyear", -5.212214667494625),
                                    ("intersect<day-of-month> (ordinal)", -4.51906748693468),
                                    ("<day-of-month> (ordinal)intersect by 'of', 'from', 's",
                                     -4.806749559386461),
                                    ("<named-month> <day-of-month> (non ordinal)named-month",
                                     -4.806749559386461),
                                    ("intersectintersect", -4.51906748693468),
                                    ("<day-of-month> (ordinal)named-month", -4.51906748693468),
                                    ("until <time-of-day>named-month", -5.212214667494625),
                                    ("after <time-of-day>year", -5.212214667494625),
                                    ("on <date>after <time-of-day>", -5.212214667494625),
                                    ("tomorrownoon", -5.212214667494625)],
                               n = 111}}),
       ("dd. - dd.mm. (interval)",
        Classifier{okData =
       ...
       ("<day-of-month> (ordinal)",
        Classifier{okData =
                     ClassData{prior = -0.4895482253187058,
                               ...
                               n = 19},
                   koData =
                     ClassData{prior = -0.9490805546971459, unseen = -2.70805020110221,
                               likelihoods =
                                 HashMap.fromList
                                   [("ordinals (first..19th)", -0.6931471805599453),
                                 ...
                                 HashMap.fromList
                                   [("intersecthh:mm", -3.1354942159291497),
                                    ...
                                    ("<day-of-month> (ordinal)<day-of-month> (ordinal)",
                                     -2.7300291078209855),
                                    ("hh:mmhh:mm", -1.8827312474337816),
                                    ("dayday", -2.2192034840549946),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<day-of-month> (ordinal)<day-of-month>(ordinal) <named-month>",
                                     -2.538973871058276),
                                    ("daymonth", -2.538973871058276),
                                    ("<day-of-month> (ordinal)mm/dd", -2.538973871058276),
                                    ("dayday", -1.55814461804655),
                                    ("<day-of-month> (ordinal)intersect", -2.538973871058276),
                                    ("<day-of-month> (ordinal)hh:mm", -2.538973871058276),
                                    ("dayminute", -2.538973871058276),
                                    ("<day-of-month> (ordinal)mm/dd/yyyy", -2.9444389791664407),
                                    ("<named-month> <day-of-month> (non ordinal)named-month",
                                     -2.538973871058276)],
                               n = 11}}),
