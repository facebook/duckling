...
classifiers
  = HashMap.fromList
      [("<time> timezone",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.8376476045550418, unseen = -4.795790545596741,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 119},
                   koData =
                     ClassData{prior = -0.5669150904170343, unseen = -5.062595033026967,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 156}}),
       ("exactly <time-of-day>",
        Classifier{okData =
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.26272534047791335, unseen = -6.90975328164481,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 426},
                   koData =
                     ClassData{prior = -1.4651344228276666,
                               unseen = -6.0063531596017325,
                               likelihoods =
                                 HashMap.fromList
                                   [("intersect by ','named-month", -4.617592705986649),
                                    ("named-day<part-of-day> of <time>", -5.310739886546594),
                                    ("absorption of , after named daythe <day-of-month> (non ordinal)",
                                     -5.310739886546594),
                                    ("<datetime> - <datetime> (interval)year", -5.310739886546594),
                                    ("dayhour", -4.617592705986649),
                                    ("daymonth", -3.4389377096450024),
                                    ("monthday", -4.90527477843843),
                                    ("monthyear", -5.310739886546594),
                                    ("yearhour", -5.310739886546594),
                                    ("after lunchat <time-of-day>", -4.90527477843843),
                                    ("mm/dduntil <time-of-day>", -4.90527477843843),
                                    ("until <time-of-day>year", -4.90527477843843),
                                    ("intersect by 'of', 'from', 'syear", -4.617592705986649),
                                    ("<time-of-day> am|pmintersect", -3.6059917943081685),
                                    ("intersect<time> <part-of-day>", -5.310739886546594),
                                    ("<time-of-day>  o'clockafter lunch", -5.310739886546594),
                                    ("after lunch<time-of-day>  o'clock", -5.310739886546594),
                                    ("at <time-of-day>named-day", -5.310739886546594),
                                    ("absorption of , after named dayhh:mm", -5.310739886546594),
                                    ("<time-of-day> am|pmintersect by ','", -4.057976918051226),
                                    ("<time-of-day>  o'clock<time> <part-of-day>",
                                     -4.394449154672439),
                                    ("mm/ddhh:mm", -4.394449154672439),
                                    ...
                                    ("on <date>between <time-of-day> and <time-of-day> (interval)",
                                     -5.310739886546594),
                                    ("named-dayhh:mm", -5.310739886546594),
                                    ("dayday", -3.9244455254267034),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.90527477843843),
                                    ("hourhour", -3.8066624897703196),
                                    ("intersectnamed-month", -3.7013019741124937),
                                    ("dayyear", -3.231298344866758),
                                    ("minutemonth", -3.364829737491281),
                                    ("named-monthyear", -5.310739886546594),
                                    ("named-day<time-of-day> - <time-of-day> (interval)",
                                     -5.310739886546594),
                                    ("on <date>named-month", -5.310739886546594),
                                    ("absorption of , after named daynamed-month",
                                     -4.212127597878484),
                                    ("intersect<day-of-month>(ordinal) <named-month>",
                                     -4.617592705986649),
                                    ("named-dayafter <time-of-day>", -4.90527477843843),
                                    ("named-dayfrom <datetime> - <datetime> (interval)",
                                     -4.90527477843843),
                                    ...
                                    ("named-dayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.617592705986649),
                                    ("<day-of-month> (ordinal)named-day", -4.617592705986649),
                                    ("<day-of-month> (ordinal)hh:mm", -4.617592705986649),
                                    ("at <time-of-day>intersect", -4.212127597878484),
                                    ("on <date>from <time-of-day> - <time-of-day> (interval)",
                                     -4.90527477843843),
                                    ("dayminute", -2.70805020110221),
                                    ("on <date>from <datetime> - <datetime> (interval)",
                                     -5.310739886546594),
                                    ("minuteday", -2.315007612992603),
                                    ("named-daybetween <time-of-day> and <time-of-day> (interval)",
                                     -5.310739886546594),
                                    ("at <time-of-day>intersect by ','", -4.617592705986649),
                                    ("<time-of-day> am|pmnamed-day", -4.90527477843843),
                                    ("named-daybetween <datetime> and <datetime> (interval)",
                                     -5.310739886546594),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.310739886546594),
                                    ("named-month<day-of-month> (non ordinal) <named-month>",
                                     -4.90527477843843),
                                    ("year<time> <part-of-day>", -5.310739886546594),
                                    ("mm/ddyear", -3.8066624897703196),
                                    ("intersect<day-of-month> (ordinal)", -4.617592705986649),
                                    ("<day-of-month> (ordinal)intersect by 'of', 'from', 's",
                                     -4.90527477843843),
                                    ("<named-month> <day-of-month> (non ordinal)named-month",
                                     -4.90527477843843),
                                    ("intersectintersect", -4.617592705986649),
                                    ("<day-of-month> (ordinal)named-month", -4.617592705986649),
                                    ("until <time-of-day>named-month", -5.310739886546594),
                                    ("after <time-of-day>year", -5.310739886546594),
                                    ("on <date>after <time-of-day>", -5.310739886546594),
                                    ("tomorrownoon", -5.310739886546594)],
                               n = 128}}),
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.7316134613877414, unseen = -4.007333185232471,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 51},
                   koData =
                     ClassData{prior = -0.6561059088795962, unseen = -4.07753744390572,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.534082485930258),
                                    ("integer (0..19)", -1.0159205728229963),
                                    ("couple", -2.9618307218783095)],
                               n = 55}}),
       ("year",
        Classifier{okData =
       ...
       ("hh:mm",
        Classifier{okData =
                     ClassData{prior = -0.528844129268669, unseen = -3.5553480614894135,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 33},
                   koData =
                     ClassData{prior = -0.8898574748059995,
                               unseen = -3.2188758248682006,
       ...
       ("<datetime> - <datetime> (interval)",
        Classifier{okData =
                     ClassData{prior = -0.9343092373768334, unseen = -4.174387269895637,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 22},
                   koData =
                     ClassData{prior = -0.4989911661189879, unseen = -4.48863636973214,
                               likelihoods =
                                 HashMap.fromList
                                   [("<day-of-month> (ordinal)<day-of-month>(ordinal) <named-month>",
                                     -3.378724525810097),
                                    ("daymonth", -3.378724525810097),
                                    ("mm/ddmm/dd/yyyy", -2.531426665422893),
                                    ("<day-of-month> (ordinal)mm/dd", -3.0910424533583156),
                                    ("mm/ddhh:mm", -2.3978952727983707),
                                    ("dayday", -1.3418425985490567),
                                    ("<day-of-month> (ordinal)intersect", -3.0910424533583156),
                                    ("<day-of-month> (ordinal)hh:mm", -3.0910424533583156),
                                    ("mm/ddintersect", -2.531426665422893),
                                    ("dayminute", -2.0794415416798357),
                                    ("<day-of-month> (ordinal)mm/dd/yyyy", -3.378724525810097),
                                    ("<named-month> <day-of-month> (non ordinal)named-month",
                                     -3.378724525810097)],
                               n = 34}}),
