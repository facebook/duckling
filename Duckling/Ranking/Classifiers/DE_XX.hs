...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.14070961725824063,
                               unseen = -7.3343293503005365,
                               likelihoods =
                                 HashMap.fromList
                                   [("Boghiyear", -6.640529215097739),
                                    ("Lailat al-Qadryear", -5.136451818321464),
                                    ("Samstag<time-of-day>  o'clock", -6.640529215097739),
                                    ("hourday", -5.387766246602371),
                                    ("<datetime> - <datetime> (interval)year", -5.387766246602371),
                                    ("dayhour", -2.939227240985245),
                                    ("daymonth", -3.401850762933358),
                                    ("Orthodoxer Ostersonntagyear", -6.640529215097739),
                                    ("<day-of-month>(ordinal) <named-month> year<time-of-day>  o'clock",
                                     -6.640529215097739),
                                    ("monthyear", -4.848769745869683),
                                    ("yearhour", -6.640529215097739),
                                    ("Naraka Chaturdashiyear", -6.235064106989574),
                                    ("Govardhan Pujayear", -6.235064106989574),
                                    ("Juliintersect", -6.640529215097739),
                                    ("intersect<time-of-day>  o'clock", -4.500463051601468),
                                    ("after lunchat <time-of-day>", -6.640529215097739),
                                    ("absorption of , after named daymm/dd/yyyy",
                                     -6.640529215097739),
                                    ("intersectJuli", -5.947382034537793),
                                    ("Isra and Mi'rajyear", -5.7242384832235835),
                                    ("Schawuotyear", -6.235064106989574),
                                    ("Aschermontagyear", -5.947382034537793),
                                    ("<day-of-month> (ordinal)Dienstag", -6.640529215097739),
                                    ("Sukkotyear", -6.235064106989574),
                                    ("intersect by 'of', 'from', 'syear", -6.235064106989574),
                                    ("<day-of-month> (ordinal)September", -6.235064106989574),
                                    ("intersect<time> <part-of-day>", -4.561087673417902),
                                    ("Jom Kippuryear", -6.235064106989574),
                                    ("<time-of-day>  o'clockafter lunch", -5.947382034537793),
                                    ("<day-of-month> (ordinal)Mittwoch", -6.640529215097739),
                                    ("Montagthis <cycle>", -6.640529215097739),
                                    ("Holiyear", -5.947382034537793),
                                    ("<time> <part-of-day><time-of-day>  o'clock",
                                     -6.640529215097739),
                                    ("Oktoberyear", -5.541916926429629),
                                    ("today<time-of-day>  o'clock", -6.640529215097739),
                                    ("Dhanterasyear", -6.235064106989574),
                                    ("<time-of-day>  o'clockon <date>", -6.235064106989574),
                                    ("Islamisches Neujahryear", -6.235064106989574),
                                    ("intersect by ','year", -5.541916926429629),
                                    ("Holika Dahanyear", -5.947382034537793),
                                    ("on <date><time-of-day>  o'clock", -6.640529215097739),
                                    ("exactly <time-of-day>tomorrow", -6.235064106989574),
                                    ("Jumu'atul-Widayear", -5.7242384832235835),
                                    ("mm/dd<time-of-day>  o'clock", -6.640529215097739),
                                    ("monthhour", -6.235064106989574),
                                    ("on <date>between <datetime> and <datetime> (interval)",
                                     -6.235064106989574),
                                    ("last <day-of-week> of <time>year", -6.640529215097739),
                                    ("hourmonth", -6.235064106989574),
                                    ("Krishna Janmashtamiyear", -6.235064106989574),
                                    ("todayat <time-of-day>", -5.947382034537793),
                                    ("Guru Gobind Singh Jayantiyear", -6.640529215097739),
                                    ("mm/ddabout <time-of-day>", -6.235064106989574),
                                    ("Donnerstagfrom <datetime> - <datetime> (interval)",
                                     -5.7242384832235835),
                                    ("<day-of-month> (ordinal)Mai", -6.640529215097739),
                                    ("on <date>between <time-of-day> and <time-of-day> (interval)",
                                     -6.235064106989574),
                                    ("Christi Himmelfahrtyear", -5.947382034537793),
                                    ("on <date>at <time-of-day>", -6.235064106989574),
                                    ("dayday", -3.462475384749793),
                                    ("<time> <part-of-day>at <time-of-day>", -6.235064106989574),
                                    ("Thai Pongalyear", -5.7242384832235835),
                                    ("Thiru Onamyear", -5.947382034537793),
                                    ("Maulid an-Nab\299year", -6.235064106989574),
                                    ("Vijayadashamiyear", -6.235064106989574),
                                    ("about <time-of-day>on <date>", -6.640529215097739),
                                    ("<hour-of-day> <integer> (as relative minutes)in|during the <part-of-day>",
                                     -6.235064106989574),
                                    ("<day-of-month> (ordinal)intersect", -5.387766246602371),
                                    ("hourhour", -4.114800570789483),
                                    ("hh:mmintersect by ','", -5.387766246602371),
                                    ("Donnerstagfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.387766246602371),
                                    ("Dienstagthis <cycle>", -6.640529215097739),
                                    ("<part-of-day> of <time>Februar", -6.235064106989574),
                                    ("Raksha Bandhanyear", -6.640529215097739),
                                    ("Tu biSchevatyear", -6.235064106989574),
                                    ("dayyear", -1.8447386695009973),
                                    ("Eid al-Adhayear", -4.500463051601468),
                                    ("Orthodoxer Palmsonntagyear", -6.640529215097739),
                                    ("K\246nigstagyear", -5.947382034537793),
                                    ("Mittwochthis <cycle>", -6.640529215097739),
                                    ("Jom HaShoahyear", -5.7242384832235835),
                                    ("Lag BaOmeryear", -6.235064106989574),
                                    ("<time-of-day>  o'clockin|during the <part-of-day>",
                                     -5.541916926429629),
                                    ("Guru Ravidass Jayantiyear", -5.541916926429629),
                                    ("tomorrow<time-of-day>  o'clock", -6.235064106989574),
                                    ("<time-of-day>  o'clocktomorrow", -5.947382034537793),
                                    ("Jom Ha'atzmautyear", -5.947382034537793),
                                    ("<day-of-month>(ordinal) <named-month>year",
                                     -5.947382034537793),
                                    ("half <integer> (german style hour-of-day)after lunch",
                                     -6.640529215097739),
                                    ("Pargat Diwasyear", -5.7242384832235835),
                                    ("absorption of , after named day<day-of-month>(ordinal) <named-month>",
                                     -5.387766246602371),
                                    ("Rabindra Jayantiyear", -5.7242384832235835),
                                    ("hourminute", -5.947382034537793),
                                    ("the <day-of-month> (ordinal)Juli", -6.640529215097739),
                                    ("Ostermontagyear", -6.640529215097739),
                                    ("Fastenzeityear", -6.640529215097739),
                                    ("on <date><day-of-month>(ordinal) <named-month>",
                                     -6.235064106989574),
                                    ("minutemonth", -4.114800570789483),
                                    ("minutehour", -4.389237416491243),
                                    ("Maha Navamiyear", -6.640529215097739),
                                    ("Simchat Torahyear", -6.640529215097739),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.7242384832235835),
                                    ("Palmsonntagyear", -6.640529215097739),
                                    ...
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -5.541916926429629),
                                    ("Kaanum Pongalyear", -6.235064106989574),
                                    ("Maha Saptamiyear", -6.640529215097739),
                                    ("<day-of-month>(ordinal) <named-month> year<time> <part-of-day>",
                                     -6.640529215097739),
                                    ("<hour-of-day> <integer> (as relative minutes)after lunch",
                                     -6.640529215097739),
                                    ("Donnerstag<time> timezone", -6.235064106989574),
                                    ("on <date>Dezember", -6.640529215097739),
                                    ("Parsi Neujahryear", -5.7242384832235835),
                                    ("Corpus Christiyear", -6.235064106989574),
                                    ("Samstagat <time-of-day>", -6.235064106989574),
                                    ("intersect<day-of-month>(ordinal) <named-month>",
                                     -5.387766246602371),
                                    ("Orthodoxer Ostermontagyear", -6.640529215097739),
                                    ("this <part-of-day><time-of-day>  o'clock",
                                     -6.640529215097739),
                                    ("<day-of-month>(ordinal) <named-month>intersect",
                                     -6.640529215097739),
                                    ("hh:mmintersect", -4.198182179728534),
                                    ("Fastnachtyear", -5.947382034537793),
                                    ("Donnerstaghh:mm", -6.640529215097739),
                                    ("Weihnachtenyear", -6.640529215097739),
                                    ("<day-of-month> (ordinal)Juli", -5.947382034537793),
                                    ("Dayananda Saraswati Jayantiyear", -6.640529215097739),
                                    ("Orthodoxer Karfreitagyear", -6.640529215097739),
                                    ("Chanukkayear", -6.235064106989574),
                                    ("intersect by ','intersect", -5.387766246602371),
                                    ("intersect by 'of', 'from', 'sJuli", -6.640529215097739),
                                    ("half <integer> (german style hour-of-day)in|during the <part-of-day>",
                                     -6.235064106989574),
                                    ("Mahavir Jayantiyear", -6.235064106989574),
                                    ("from <datetime> - <datetime> (interval)year",
                                     -5.947382034537793),
                                    ("at <time-of-day>intersect", -4.848769745869683),
                                    ...
                                    ("Donnerstagbetween <time-of-day> and <time-of-day> (interval)",
                                     -6.235064106989574),
                                    ("Dreifaltigkeitssonntagyear", -5.7242384832235835),
                                    ("Tisha B'Avyear", -6.640529215097739),
                                    ("the <day-of-month> (ordinal)Dezember", -6.640529215097739),
                                    ("dayminute", -3.867940492857957),
                                    ("on <date>from <datetime> - <datetime> (interval)",
                                     -6.235064106989574),
                                    ("Maiyear", -6.640529215097739),
                                    ("Mittwochnext <cycle>", -6.640529215097739),
                                    ("Donnerstagbetween <datetime> and <datetime> (interval)",
                                     -6.235064106989574),
                                    ("<time> <part-of-day>from <datetime> - <datetime> (interval)",
                                     -6.640529215097739),
                                    ("intersectyear", -4.768727038196147),
                                    ("on <date>intersect", -6.235064106989574),
                                    ("on <date><day-of-month> (ordinal)", -6.235064106989574),
                                    ("intersectSeptember", -4.00147188548248),
                                    ("<ordinal> <cycle> of <time>year", -6.640529215097739),
                                    ("minuteday", -2.7903816133876798),
                                    ("absorption of , after named dayintersect",
                                     -4.242633942299368),
                                    ("intersect by ','September", -5.254234853977848),
                                    ("year<time-of-day>  o'clock", -6.640529215097739),
                                    ("Juliyear", -6.235064106989574),
                                    ("at <time-of-day>intersect by ','", -5.947382034537793),
                                    ("hh:mmabsorption of , after named day", -6.235064106989574),
                                    ("Earth Houryear", -6.235064106989574),
                                    ("intersect by ','<time> <part-of-day>", -5.7242384832235835),
                                    ("Karfreitagyear", -5.947382034537793),
                                    ("Chinesisches Neujahryear", -6.640529215097739),
                                    ("Gr\252ndonnerstagyear", -5.541916926429629),
                                    ("hh:mmon <date>", -4.198182179728534),
                                    ("Pfingstenyear", -6.235064106989574),
                                    ("Mattu Pongalyear", -6.640529215097739),
                                    ("Rosch haSchanayear", -5.947382034537793),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.640529215097739),
                                    ("until <time-of-day>after lunch", -6.640529215097739),
                                    ("Pfingstmontagyear", -6.235064106989574),
                                    ("mm/ddyear", -6.235064106989574),
                                    ("intersect by ','<time-of-day>  o'clock", -5.7242384832235835),
                                    ("intersect<day-of-month> (ordinal)", -5.387766246602371),
                                    ("absorption of , after named daymm/dd", -6.640529215097739),
                                    ("on <date>September", -5.7242384832235835),
                                    ("Septemberyear", -6.235064106989574),
                                    ("<day-of-month> (ordinal)intersect by 'of', 'from', 's",
                                     -5.947382034537793),
                                    ("at <time-of-day>on <date>", -4.768727038196147),
                                    ("Pessachyear", -5.541916926429629),
                                    ("intersectintersect", -4.561087673417902),
                                    ("<day-of-month> (ordinal)Februar", -5.541916926429629),
                                    ("Aschurayear", -5.947382034537793),
                                    ("dayweek", -5.541916926429629),
                                    ("intersect by ','Juli", -5.947382034537793),
                                    ("absorption of , after named daythe <day-of-month> (ordinal)",
                                     -6.640529215097739),
                                    ("weekyear", -6.235064106989574),
                                    ("<day-of-month> (ordinal)Dezember", -5.541916926429629),
                                    ("hh:mmin|during the <part-of-day>", -5.7242384832235835),
                                    ("Karva Chauthyear", -6.235064106989574),
                                    ("Orthodoxer Karsamstagyear", -6.640529215097739),
                                    ("Navaratriyear", -6.235064106989574),
                                    ("Maha Shivaratriyear", -6.640529215097739),
                                    ("Ramadanyear", -5.387766246602371),
                                    ("Marzyear", -6.640529215097739),
                                    ("Bhai Doojyear", -6.640529215097739),
                                    ("tomorrowat <time-of-day>", -6.235064106989574),
                                    ("<hour-of-day> <integer> (as relative minutes)on <date>",
                                     -6.640529215097739),
                                    ("Eid al-Fitryear", -5.254234853977848),
                                    ("Donnerstag<time-of-day> - <time-of-day> (interval)",
                                     -6.235064106989574),
                                    ("Donnerstag<datetime> - <datetime> (interval)",
                                     -6.640529215097739),
                                    ("Aschermittwochyear", -5.947382034537793),
                                    ("Lazarus-Samstagyear", -6.235064106989574),
                                    ("Sonntaglast <cycle>", -6.640529215097739),
                                    ("at <time-of-day>tomorrow", -6.640529215097739),
                                    ("Ostersonntagyear", -6.640529215097739),
                                    ("tomorrowabout <time-of-day>", -6.235064106989574),
                                    ("Gro\223e Fastenzeityear", -6.640529215097739),
                                    ("about <time-of-day>in|during the <part-of-day>",
                                     -6.235064106989574),
                                    ("Schmini Azeretyear", -5.947382034537793),
                                    ("half <integer> (german style hour-of-day)on <date>",
                                     -6.640529215097739),
                                    ("this <part-of-day>at <time-of-day>", -6.235064106989574),
                                    ("<datetime> - <datetime> (interval)Juli", -6.235064106989574),
                                    ("Vaisakhiyear", -5.7242384832235835),
                                    ("Diwaliyear", -5.947382034537793),
                                    ("after lunch<hour-of-day> <integer> (as relative minutes)",
                                     -6.235064106989574),
                                    ("<day-of-month> (ordinal)Marz", -6.640529215097739),
                                    ("last <cycle> of <time>year", -6.235064106989574),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -6.640529215097739),
                                    ("minuteyear", -6.235064106989574),
                                    ("<day-of-month> (non ordinal) <named-month>year",
                                     -6.640529215097739),
                                    ("Chhathyear", -5.947382034537793),
                                    ("Vasant Panchamiyear", -6.235064106989574),
                                    ("Global Youth Service-Tagyear", -6.640529215097739),
                                    ("Karsamstagyear", -5.947382034537793)],
                               n = 642},
                   koData =
                     ClassData{prior = -2.030586942444819, unseen = -6.091309882077698,
                               likelihoods =
                                 HashMap.fromList
                                   [("absorption of , after named daythe <day-of-month> (non ordinal)",
                                     -5.395897694886901),
                                    ("<datetime> - <datetime> (interval)year", -5.395897694886901),
                                    ("dayhour", -3.044522437723423),
                                    ("daymonth", -3.6911496026484754),
                                    ("monthyear", -5.395897694886901),
                                    ("yearhour", -5.395897694886901),
                                    ("after lunchat <time-of-day>", -4.990432586778736),
                                    ("mm/dduntil <time-of-day>", -4.990432586778736),
                                    ("until <time-of-day>year", -4.990432586778736),
                                    ("<day-of-month> (ordinal)Dienstag", -4.990432586778736),
                                    ("absorption of , after named dayFebruar", -4.297285406218791),
                                    ("Donnerstagyear", -4.702750514326955),
                                    ("on <date>Februar", -5.395897694886901),
                                    ("intersect by 'of', 'from', 'syear", -4.702750514326955),
                                    ("intersect<time> <part-of-day>", -5.395897694886901),
                                    ("<time-of-day>  o'clockafter lunch", -5.395897694886901),
                                    ("<day-of-month> (ordinal)Mittwoch", -5.395897694886901),
                                    ("after lunch<time-of-day>  o'clock", -5.395897694886901),
                                    ("Holiyear", -5.395897694886901),
                                    ("absorption of , after named dayhh:mm", -5.395897694886901),
                                    ("<time-of-day>  o'clock<time> <part-of-day>",
                                     -4.4796069630127455),
                                    ("monthhour", -5.395897694886901),
                                    ("todayat <time-of-day>", -5.395897694886901),
                                    ("dayday", -4.00960333376701),
                                    ("Thai Pongalyear", -4.702750514326955),
                                    ("hourhour", -3.891820298110627),
                                    ("Donnerstagafter <time-of-day>", -5.395897694886901),
                                    ("dayyear", -2.3278447597532836),
                                    ("Ostermontagyear", -5.395897694886901),
                                    ("Fastenzeityear", -5.395897694886901),
                                    ("Palmsonntagyear", -5.395897694886901),
                                    ("Aprilyear", -5.395897694886901),
                                    ("Sonntagabout <time-of-day>", -3.891820298110627),
                                    ("Sonntagyear", -5.395897694886901),
                                    ("Montagyear", -4.702750514326955),
                                    ("Dienstagafter <time-of-day>", -5.395897694886901),
                                    ("Sonntag<time-of-day>  o'clock", -4.297285406218791),
                                    ("Donnerstaghh:mm", -4.990432586778736),
                                    ("<day-of-month> (ordinal)Juli", -4.990432586778736),
                                    ("dayminute", -4.00960333376701),
                                    ("until <time-of-day>Juli", -5.395897694886901),
                                    ("Karfreitagyear", -5.395897694886901),
                                    ("Freitagyear", -4.990432586778736),
                                    ("year<time> <part-of-day>", -5.395897694886901),
                                    ("mm/ddyear", -3.891820298110627),
                                    ("Neujahryear", -4.4796069630127455),
                                    ("<day-of-month> (ordinal)intersect by 'of', 'from', 's",
                                     -4.990432586778736),
                                    ("Donnerstag<part-of-day> of <time>", -5.395897694886901),
                                    ("<day-of-month> (ordinal)April", -5.395897694886901),
                                    ("Ostersonntagyear", -5.395897694886901),
                                    ("Sonntagat <time-of-day>", -4.4796069630127455),
                                    ("after <time-of-day>year", -5.395897694886901),
                                    ("on <date>after <time-of-day>", -5.395897694886901),
                                    ("Diwaliyear", -5.395897694886901),
                                    ("tomorrownoon", -5.395897694886901),
                                    ("Samstagyear", -4.702750514326955),
                                    ("Karsamstagyear", -5.395897694886901)],
                               n = 97}}),
