  ...
  = HashMap.fromList
      [("midnight",
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("at <time-of-day>", -1.9459101490553135),
                                    ("absorption of article before time", -1.9459101490553135),
                                    ("<time-of-day> am|pm", -1.9459101490553135),
                                    ("hh:mm", -1.9459101490553135), ("hour", -1.252762968495368),
       ...
       ("ordinals (1st..12th, 20th, 30th..90th)",
        Classifier{okData =
                     ClassData{prior = -0.9354606479818753,
                               unseen = -3.4965075614664802,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 31},
                   koData =
                     ClassData{prior = -0.4982468415591305, unseen = -3.912023005428146,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 48}}),
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6118015411059929, unseen = -5.267858159063328,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 192},
                   koData =
                     ClassData{prior = -0.7817005779013904, unseen = -5.099866427824199,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 162}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("half after|past <integer> (hour-of-day)",
                                     -3.9415818076696905),
                                    ("<time-of-day> am|pm (verbose)", -3.536116699561526),
                                    ("time-of-day (latent)", -1.3766324502081537),
                                    ("<time-of-day> am|pm", -1.8015156441734197),
                                    ("hh:mm", -3.0252910757955354), ("hour", -0.921156921525328),
                                    ("minute", -2.4375044108934163)],
                               n = 48},
                   koData =
                     ClassData{prior = -2.3608540011180215, unseen = -2.890371757896165,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.42046318368559943,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("tuesdaySeptember", -5.245970886175828),
                                    ...
                                    ("absorption of article before timeabsorption of article before time",
                                     -3.559571932605599),
                                    ("thursday<time> timezone", -5.469114437490037),
                                    ("yesterdayabsorption of article before time",
                                     -6.162261618049983),
                               ...
                               n = 375},
                   koData =
                     ClassData{prior = -1.069274550425493, unseen = -6.3835066348840055,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -5.2832037287379885),
                                    ("thursdayabsorption of article before time",
                                     -5.688668836846153),
                                    ("dayhour", -3.7427586877908396),
                                    ("daymonth", -2.5106150064982073),
                                    ("hourquarter", -5.688668836846153),
                                    ("monthday", -5.2832037287379885),
                                    ("absorption of article before timedd/mm", -5.688668836846153),
                                    ("monthyear", -3.337293579682675),
                                    ("absorption of article before timeDecember",
                                     -5.688668836846153),
                                    ("tuesdayFebruary", -5.688668836846153),
                                    ("wednesdayintersect", -5.688668836846153),
                                    ("intersecthh:mm", -5.688668836846153),
                                    ("hh:mmuntil <time>", -4.995521656286208),
                                    ("houryear", -5.2832037287379885),
                                    ("absorption of article before time<day-of-month> (ordinal or number) <named-month>",
                                     -5.688668836846153),
                                    ("intersect by 'of', 'from', 'syear", -4.772378104971998),
                                    ("absorption of article before timeJuly", -5.2832037287379885),
                                    ("thursdayafter <time-of-day>", -4.590056548178043),
                                    ("Marchyear", -4.1845914400698785),
                                    ("after tomorrowat <time-of-day>", -5.688668836846153),
                                    ("absorption of article before timeOctober",
                                     -5.2832037287379885),
                                    ("<time-of-day> am|pmuntil <time>", -5.2832037287379885),
                                    ("wednesdayabsorption of article before time",
                                     -5.2832037287379885),
                                    ("<named-month> <day-of-month> (ordinal or number)July",
                                     -5.688668836846153),
                                    ("intersect by ','<time-of-day> am|pm", -5.688668836846153),
                                    ...
                                    ("intersect by 'of', 'from', 'sabsorption of article before time",
                                     -5.688668836846153),
                                    ("intersect by ','hh:mm", -4.590056548178043),
                                    ("mondayabsorption of article before time", -5.688668836846153),
                                    ("hourmonth", -3.2907735640477824),
                                    ("todayat <time-of-day>", -5.688668836846153),
                                    ("absorption of article before timeabsorption of article before time",
                                     -3.609227295166317),
                                    ("dayday", -3.386083743852107),
                                    ("dayquarter", -5.688668836846153),
                                    ("<time-of-day> - <time-of-day> (interval)absorption of article before time",
                                     -5.688668836846153),
                                    ("thursdayat <time-of-day>", -5.688668836846153),
                                    ("week-endintersect", -5.688668836846153),
                                    ("<datetime> - <datetime> (interval)absorption of article before time",
                                     -5.2832037287379885),
                                    ("dayyear", -3.1629401925378975),
                                    ("thursdaydd/mm", -5.688668836846153),
                                    ("thursdaybetween <time-of-day> and <time-of-day> (interval)",
                                     -5.688668836846153),
                                    ("tuesdayabsorption of article before time",
                                     -4.995521656286208),
                                    ("tuesdayintersect by 'of', 'from', 's", -5.2832037287379885),
                                    ("monthminute", -5.2832037287379885),
                                    ("<time-of-day> am|pmtomorrow", -5.688668836846153),
                                    ("<named-month> <day-of-month> (ordinal or number)August",
                                     -5.688668836846153),
                                    ("tuesdayMarch", -4.772378104971998),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.688668836846153),
                                    ("thursdayhh:mm", -5.688668836846153),
                                    ("after <time-of-day>December", -5.688668836846153),
                                    ("for <duration> from <time>December", -5.688668836846153),
                                    ("thursdayintersect", -5.2832037287379885),
                                    ("Aprilyear", -4.590056548178043),
                                    ("sundayintersect by 'of', 'from', 's", -5.688668836846153),
                                    ("tuesdayJanuary", -5.688668836846153),
                                    ("absorption of article before timehh(:mm) - <time-of-day> am|pm",
                                     -5.688668836846153),
                                    ("tuesdayOctober", -5.2832037287379885),
                                    ...
                                    ("tuesday<day-of-month> (ordinal or number) <named-month>",
                                     -5.688668836846153),
                                    ("weekmonth", -4.772378104971998),
                                    ("daysecond", -3.8168666599445613),
                                    ("sundayabsorption of article before time", -4.995521656286208),
                                    ("todayabsorption of article before time", -5.688668836846153),
                                    ("thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.688668836846153),
                                    ("yearmonth", -5.2832037287379885),
                                    ("absorption of article before timeyear", -4.590056548178043),
                                    ("dayminute", -3.983920744607728),
                                    ("intersectyear", -3.896909367618098),
                                    ("hh:mmabsorption of article before time", -5.2832037287379885),
                                    ("thursdayApril", -5.688668836846153),
                                    ("minuteday", -4.772378104971998),
                                    ("absorption of , after named dayintersect",
                                     -5.688668836846153),
                                    ("the <cycle> of <time>absorption of article before time",
                                     -4.995521656286208),
                                    ("tuesdayApril", -5.2832037287379885),
                                    ("Octoberyear", -5.688668836846153),
                                    ("absorption of , after named dayintersect by ','",
                                     -5.688668836846153),
                                    ("yearhh:mm", -5.688668836846153),
                                    ("this <cycle>hh(:mm) - <time-of-day> am|pm",
                                     -5.688668836846153),
                                    ("intersectabsorption of article before time",
                                     -4.590056548178043),
                                    ...
                                    ("absorption of article before timeuntil <time>",
                                     -4.302374475726262),
                                    ("hoursecond", -4.435905868350785),
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -4.995521656286208),
                                    ("<duration> after <time>December", -5.688668836846153),
                                    ("intersectintersect", -5.688668836846153),
                                    ("tuesdaytuesday", -5.688668836846153),
                                    ("the <day-of-month> (non ordinal)absorption of article before time",
                                     -3.896909367618098),
                                    ("at <time-of-day>February", -5.688668836846153),
                                    ("week-endabsorption of article before time",
                                     -4.772378104971998),
                                    ("thursdayOctober", -5.2832037287379885),
                                    ("tomorrowat <time-of-day>", -5.688668836846153),
                                    ("tuesdayintersect", -3.896909367618098),
                                    ("minutesecond", -4.995521656286208),
                                    ("tomorrowbetween <time-of-day> and <time-of-day> (interval)",
                                     -5.688668836846153),
                                    ("tuesdayMay", -5.688668836846153),
                                    ("after <time-of-day>absorption of article before time",
                                     -5.688668836846153),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.2832037287379885),
                                    ("sundayintersect", -5.688668836846153),
                                    ("thursdayintersect by 'of', 'from', 's", -5.688668836846153),
                                    ("tomorrowabsorption of article before time",
                                     -5.688668836846153),
                                    ("absorption of article before timeAugust", -5.688668836846153),
       ...
       ("absorption of article before time",
        Classifier{okData =
                     ClassData{prior = -0.2431943483597709, unseen = -6.546785410760524,
                               likelihoods =
                                 HashMap.fromList
                                   [("midnight", -5.8522024797744745),
                                    ("last <cycle> <time>'s'", -3.906292330719161),
                                    ("week", -3.654977902438255),
                                    ("Father's Day", -5.44673737166631),
                                    ("thursday", -5.44673737166631), ("fall", -5.44673737166631),
                                    ("<day-of-month> (ordinal or number) <named-month>",
                                     -4.465908118654584),
                                    ("<time> <part-of-day>", -4.242764567340374),
                                    ("absorption of , after named day", -5.44673737166631),
                                    ("revolution day", -4.7535901911063645),
                                    ("October", -4.147454387536049),
                                    ("wednesday", -5.8522024797744745), ("July", -5.44673737166631),
                                    ("<ordinal> quarter", -5.8522024797744745),
                                    ("saturday", -5.159055299214529),
                                    ("Last year", -5.159055299214529),
                                    ("intersect", -2.8076800420510515),
                                    ("half after|past <integer> (hour-of-day)",
                                     -5.8522024797744745),
                                    ("<ordinal> <cycle> of <time>", -5.8522024797744745),
                                    ("next <cycle>", -4.465908118654584),
                                    ("the <cycle> of <time>", -4.599439511279106),
                                    ("<ordinal> quarter <year>", -5.8522024797744745),
                                    ("second", -4.935911747900319), ("monday", -5.44673737166631),
                                    ("valentine's day", -5.44673737166631),
                                    ("<day-of-month> (ordinal or number) of <named-month>",
                                     -5.8522024797744745),
                                    ("this|last|next <cycle>", -4.242764567340374),
                                    ("Mother's Day", -5.44673737166631),
                                    ("friday", -5.44673737166631),
                                    ("<time-of-day> am|pm (verbose)", -5.159055299214529),
                                    ("<time> after next", -5.8522024797744745),
                                    ("day", -1.8819105662223525),
                                    ("next <day-of-week>", -4.935911747900319),
                                    ("afternoon", -4.147454387536049),
                                    ("February", -4.935911747900319),
                                    ("quarter", -4.7535901911063645),
                                    ("this <cycle>", -5.8522024797744745),
                                    ("sunday", -5.8522024797744745),
                                    ("time-of-day (latent)", -2.990001598845006),
                                    ("year", -3.5496173867804286),
                                    ("<time-of-day> am|pm", -3.454307206976104),
                                    ("<duration> after <time>", -5.159055299214529),
                                    ("hh:mm", -4.7535901911063645),
                                    ("intersect by ','", -5.159055299214529),
                                    ("intersect by 'of', 'from', 's", -3.906292330719161),
                                    ("last <time>", -4.465908118654584),
                                    ("EOM|End of month", -5.8522024797744745),
                                    ("March", -4.599439511279106),
                                    ("<day-of-month> (ordinal)", -4.465908118654584),
                                    ("noon", -5.44673737166631), ("hour", -1.9502298101998297),
                                    ("evening", -4.465908118654584), ("month", -2.934431747690195),
                                    ("EOD|End of day", -5.8522024797744745),
                                    ("next <time>", -4.7535901911063645),
                                    ("christmas", -5.44673737166631),
                                    ("next n <cycle>", -4.599439511279106),
                                    ("tuesday", -5.159055299214529),
                                    ("halloween day", -5.8522024797744745),
                                    ("winter", -5.8522024797744745),
                                    ("last n <cycle>", -4.7535901911063645),
                                    ("last <cycle> of <time>", -4.599439511279106),
                                    ("minute", -3.0488420988679397),
                                    ("week-end", -5.44673737166631),
                                    ("summer", -5.8522024797744745),
                                    ("August", -5.8522024797744745)],
                               n = 316},
                   koData =
                     ClassData{prior = -1.5330284432920993, unseen = -5.521460917862246,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.4957877464014501, unseen = -4.248495242049359,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -7.522342123758752e-2),
                                    ("number (0..19, 20, 30..90)", -2.624668592163159)],
                               n = 67},
                   koData =
                     ClassData{prior = -0.9392802500988537, unseen = -3.828641396489095,
                               likelihoods =
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.1686227124357927, unseen = -5.356586274672012,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> approximately", -4.658710952916121),
                                    ("at <time-of-day>", -2.5186447894198505),
                                    ("<time-of-day>  o'clock", -4.658710952916121),
                                    ("quarter to|past <integer> (hour-of-day)", -4.658710952916121),
                                    ("half after|past <integer> (hour-of-day)", -3.965563772356176),
                                    ("absorption of article before time", -2.2608156801177506),
                                    ("about <time-of-day>", -4.658710952916121),
                                    ("time-of-day (latent)", -1.8553505720095862),
                                    ("<time-of-day> am|pm", -4.658710952916121),
                                    ("hh:mm", -2.407419154309626), ("hour", -1.1471655140851005),
                                    ("<integer>-and-half (hour-of-day)", -4.658710952916121),
                                    ("hhmm (military)", -4.658710952916121),
                                    ("minute", -1.8553505720095862),
                                    ("after <time-of-day>", -4.658710952916121)],
                               n = 98},
                   koData =
                     ClassData{prior = -1.8632184332102, unseen = -3.951243718581427,
                               likelihoods =
                                 HashMap.fromList
