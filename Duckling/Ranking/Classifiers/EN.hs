...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.8705223134185743,
                               unseen = -5.0369526024136295,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 152},
                   koData =
                     ClassData{prior = -0.5425447007887843,
       ...
       ("on <date>",
        Classifier{okData =
                     ClassData{prior = -0.20479441264601328, unseen = -4.02535169073515,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursday", -1.8101086078962516),
                                    ("mm/dd", -3.3141860046725258),
                                    ("absorption of , after named day", -2.908720896564361),
                                    ("intersect", -2.908720896564361),
                                    ("Saturday", -2.6210388241125804),
                                    ("Friday", -3.3141860046725258), ("day", -0.916290731874155),
                                    ("the <day-of-month> (ordinal)", -2.908720896564361),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -2.6210388241125804),
                                    ("hour", -3.3141860046725258)],
                               n = 22},
                   koData =
                     ClassData{prior = -1.6863989535702288,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("mm/yyyy", -2.3513752571634776),
                                    ("intersect", -1.9459101490553135), ("day", -1.252762968495368),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -1.9459101490553135)],
                               n = 5}}),
       ("integer (0..19)",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4827235912452959, unseen = -6.133398042996649,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.5217885770490405),
                                    ("hourday", -3.7333312166847703),
                                    ("dayhour", -3.1867875103167003),
                                    ("daymonth", -5.438079308923196),
                                    ("monthday", -5.032614200815031),
                                    ("monthyear", -3.828641396489095),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.438079308923196),
                                    ("Christmasyear", -5.438079308923196),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.438079308923196),
                                    ("Marchyear", -5.438079308923196),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.032614200815031),
                                    ("intersect<time-of-day> am|pm", -5.438079308923196),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.438079308923196),
                                    ("monthhour", -5.032614200815031),
                                    ("last <day-of-week> of <time>year", -5.438079308923196),
                                    ("todayat <time-of-day>", -5.438079308923196),
                                    ("Thursday<time> timezone", -5.032614200815031),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.438079308923196),
                                    ("dayday", -3.4231762883809305),
                                    ("Thanksgiving Dayyear", -5.032614200815031),
                                    ("<time> <part-of-day>at <time-of-day>", -5.438079308923196),
                                    ("Tuesdayin <named-month>", -5.438079308923196),
                                    ("mm/ddat <time-of-day>", -5.438079308923196),
                                    ("tonightat <time-of-day>", -5.438079308923196),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.74493212836325),
                                    ("today<time-of-day> am|pm", -5.438079308923196),
                                    ("Februarythe <day-of-month> (ordinal)", -5.032614200815031),
                                    ("at <time-of-day><time> <part-of-day>", -5.438079308923196),
                                    ("mm/dd<time-of-day> am|pm", -5.438079308923196),
                                    ("hourhour", -4.1853163404278275),
                                    ("<time-of-day> am|pmon <date>", -3.4231762883809305),
                                    ("Wednesdaythis|last|next <cycle>", -5.438079308923196),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.9340019121469214),
                                    ("dayyear", -3.240854731586976),
                                    ("last weekend of <named-month>year", -5.438079308923196),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.438079308923196),
                                    ("<time-of-day> am|pmtomorrow", -4.74493212836325),
                                    ("minutehour", -4.5217885770490405),
                                    ("Mother's Dayyear", -5.438079308923196),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.032614200815031),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.7333312166847703),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.438079308923196),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.5217885770490405),
                                    ("Mondayin|during the <part-of-day>", -5.438079308923196),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.032614200815031),
                                    ("intersectin|during the <part-of-day>", -5.438079308923196),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.438079308923196),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.032614200815031),
                                    ("<ordinal> <cycle> of <time>year", -5.438079308923196),
                                    ("minuteday", -2.03688192726104),
                                    ("absorption of , after named dayintersect",
                                     -5.438079308923196),
                                    ("Octoberyear", -4.1853163404278275),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.438079308923196),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.438079308923196),
                                    ("year<time-of-day> am|pm", -5.438079308923196),
                                    ("Septemberyear", -5.032614200815031),
                                    ("at <time-of-day>on <date>", -4.339467020255086),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.74493212836325),
                                    ("Halloweenyear", -5.438079308923196),
                                    ("dayweek", -5.438079308923196),
                                    ("weekyear", -5.032614200815031),
                                    ("hh:mmin|during the <part-of-day>", -4.74493212836325),
                                    ("Father's Dayyear", -5.438079308923196),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.032614200815031),
                                    ("February<time> <part-of-day>", -5.438079308923196),
                                    ("Martin Luther King's Dayyear", -5.032614200815031),
                                    ("tomorrowat <time-of-day>", -4.74493212836325),
                                    ("between <time> and <time>on <date>", -4.74493212836325),
                                    ("at <time-of-day>tomorrow", -5.032614200815031),
                                    ("tomorrow<time-of-day> am|pm", -5.438079308923196),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.438079308923196),
                                    ("Labor Dayyear", -5.438079308923196),
                                    ("Februaryintersect", -5.438079308923196),
                                    ("last <cycle> of <time>year", -4.74493212836325),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.438079308923196),
                                    ("yearminute", -5.438079308923196)],
                               n = 166},
                   koData =
                     ClassData{prior = -0.9599823913722033, unseen = -5.814130531825066,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.117993812416755),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.117993812416755),
                                    ("hourday", -5.117993812416755),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.117993812416755),
                                    ("dayhour", -3.1030907918744903),
                                    ("daymonth", -3.1030907918744903),
                                    ("monthday", -4.712528704308591),
                                    ("monthyear", -4.42484663185681),
                                    ("intersecthh:mm", -5.117993812416755),
                                    ("houryear", -5.117993812416755),
                                    ("until <time-of-day><time-of-day> am|pm", -5.117993812416755),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.42484663185681),
                                    ("<time-of-day> am|pmintersect", -3.8652308439213874),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.2017030805426),
                                    ("Tuesdayafter <time-of-day>", -5.117993812416755),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.117993812416755),
                                    ("absorption of , after named dayJuly", -4.712528704308591),
                                    ("monthhour", -4.712528704308591),
                                    ("mm/yyyyat <time-of-day>", -4.42484663185681),
                                    ("hourmonth", -5.117993812416755),
                                    ("todayat <time-of-day>", -5.117993812416755),
                                    ("mm/yyyy<time-of-day> am|pm", -5.117993812416755),
                                    ("dayday", -4.42484663185681),
                                    ("mm/ddat <time-of-day>", -4.712528704308591),
                                    ("<time-of-day> am|pmon <date>", -3.8652308439213874),
                                    ("Thursdaymm/yyyy", -5.117993812416755),
                                    ("dayyear", -4.2017030805426),
                                    ("Thursdaymm/dd", -5.117993812416755),
                                    ("Thursdayat <time-of-day>", -5.117993812416755),
                                    ("August<time-of-day> am|pm", -5.117993812416755),
                                    ("monthminute", -5.117993812416755),
                                    ("<time-of-day> am|pmtomorrow", -5.117993812416755),
                                    ("Thursdayhh:mm", -5.117993812416755),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.117993812416755),
                                    ("minutemonth", -3.613916415640481),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.712528704308591),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.712528704308591),
                                    ("Aprilyear", -5.117993812416755),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -4.712528704308591),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.117993812416755),
                                    ("mm/yyyy<time-of-day> - <time-of-day> (interval)",
                                     -4.712528704308591),
                                    ("yesterday<time-of-day> am|pm", -5.117993812416755),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.2017030805426),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.117993812416755),
                                    ("until <time-of-day>on <date>", -4.42484663185681),
                                    ("at <time-of-day>intersect", -4.712528704308591),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.117993812416755),
                                    ("dayminute", -2.9779276489204842),
                                    ("intersectSeptember", -3.613916415640481),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.117993812416755),
                                    ("minuteday", -2.31463343151022),
                                    ("absorption of , after named dayintersect",
                                     -5.117993812416755),
                                    ("Februaryin|during the <part-of-day>", -5.117993812416755),
                                    ("week-endin <named-month>", -5.117993812416755),
                                    ("Octoberyear", -5.117993812416755),
                                    ("yearhh:mm", -5.117993812416755),
                                    ("hh:mmon <date>", -3.613916415640481),
                                    ("absorption of , after named daySeptember", -4.2017030805426),
                                    ("on <date>September", -4.712528704308591),
                                    ("at <time-of-day>on <date>", -4.712528704308591),
                                    ("absorption of , after named dayFebruary", -4.2017030805426),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.117993812416755),
                                    ("tomorrowat <time-of-day>", -5.117993812416755),
                                    ("tomorrow<time-of-day> am|pm", -5.117993812416755),
                                    ("after <time-of-day><time-of-day> am|pm", -5.117993812416755),
                                    ("after <time-of-day>year", -5.117993812416755),
                                    ("yearminute", -5.117993812416755)],
                               n = 103}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("a <unit-of-duration>Christmas", -2.3513752571634776),
                                    ...
                                    ("a <unit-of-duration>(now)|(present)", -2.3513752571634776),
                                    ("<integer> <unit-of-duration>(now)|(present)",
                                     -1.9459101490553135),
