...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.8639649128724154, unseen = -5.043425116919247,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 153},
                   koData =
                     ClassData{prior = -0.5472953035473822, unseen = -5.356586274672012,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4579552907295611, unseen = -6.133398042996649,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.7333312166847703),
                                    ("for <duration> from <time>December", -5.438079308923196),
                               ...
                               n = 167},
                   koData =
                     ClassData{prior = -1.0012381246429334, unseen = -5.771441123130016,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.075173815233827),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.075173815233827),
                                    ("hourday", -5.075173815233827),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.075173815233827),
                                    ("dayhour", -3.283414346005772),
                                    ("daymonth", -2.995732273553991),
                                    ("monthday", -4.669708707125663),
                                    ("monthyear", -4.382026634673881),
                                    ("intersecthh:mm", -5.075173815233827),
                                    ("houryear", -5.075173815233827),
                                    ("until <time-of-day><time-of-day> am|pm", -5.075173815233827),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.382026634673881),
                                    ("<time-of-day> am|pmintersect", -3.822410846738459),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.1588830833596715),
                                    ("Tuesdayafter <time-of-day>", -5.075173815233827),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.075173815233827),
                                    ("absorption of , after named dayJuly", -4.669708707125663),
                                    ("monthhour", -4.669708707125663),
                                    ("hourmonth", -5.075173815233827),
                                    ("todayat <time-of-day>", -5.075173815233827),
                                    ("dayday", -4.669708707125663),
                                    ("mm/ddat <time-of-day>", -4.669708707125663),
                                    ("<time-of-day> am|pmon <date>", -3.822410846738459),
                                    ("dayyear", -4.1588830833596715),
                                    ("Thursdaymm/dd", -5.075173815233827),
                                    ("Thursdayat <time-of-day>", -5.075173815233827),
                                    ("August<time-of-day> am|pm", -5.075173815233827),
                                    ("monthminute", -5.075173815233827),
                                    ...
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.075173815233827),
                                    ("minutemonth", -3.571096418457553),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.669708707125663),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.669708707125663),
                                    ("Aprilyear", -5.075173815233827),
                                    ...
                                    ("<duration> after|before|from <time>December",
                                     -5.075173815233827),
                                    ("yesterday<time-of-day> am|pm", -5.075173815233827),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.1588830833596715),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.075173815233827),
                                    ("until <time-of-day>on <date>", -4.382026634673881),
                                    ("at <time-of-day>intersect", -4.669708707125663),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.075173815233827),
                                    ("dayminute", -3.1292636661785136),
                                    ("intersectSeptember", -3.571096418457553),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.075173815233827),
                                    ("minuteday", -2.271813434327292),
                                    ("absorption of , after named dayintersect",
                                     -5.075173815233827),
                                    ("Februaryin|during the <part-of-day>", -5.075173815233827),
                                    ("week-endin <named-month>", -5.075173815233827),
                                    ("Octoberyear", -5.075173815233827),
                                    ("yearhh:mm", -5.075173815233827),
                                    ("hh:mmon <date>", -3.571096418457553),
                                    ("absorption of , after named daySeptember",
                                     -4.1588830833596715),
                                    ("on <date>September", -4.669708707125663),
                                    ...
                                    ("tomorrow<time-of-day> am|pm", -5.075173815233827),
                                    ("after <time-of-day><time-of-day> am|pm", -5.075173815233827),
                                    ("after <time-of-day>year", -5.075173815233827),
                                    ("yearminute", -5.075173815233827)],
                               n = 97}}),
