        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = 0.0, unseen = -2.0794415416798357,
                               likelihoods =
                                 HashMap.fromList
                                   [("October", -1.252762968495368), ("July", -1.252762968495368),
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.4418327522790392, unseen = -5.14166355650266,
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                     -4.442651256490317),
                                    ("dayhour", -3.1898882879949486),
                                    ("daymonth", -3.1898882879949486),
                                    ...
                                    ("Labor Daythis|last|next <cycle>", -4.442651256490317),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.442651256490317),
                                    ("<part-of-day> of <time>February", -4.442651256490317),
                                    ("Saturday<time-of-day> am|pm", -4.442651256490317),
                                    ("Martin Luther King's Daythis|last|next <cycle>",
                                     -4.442651256490317),
                                    ("on <date><time-of-day> am|pm", -4.442651256490317),
                                    ("hourmonth", -4.442651256490317),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"intersect",
                                     -4.442651256490317),
                                    ("dayday", -2.570849079588725),
                                    ("the <day-of-month> (ordinal)February", -4.037186148382152),
                                    ("WednesdayOctober", -4.442651256490317),
                                    ("Wednesdaythis|last|next <cycle>", -4.037186148382152),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.5263605246161616),
                                    ("dayyear", -2.9385738597140425),
                                    ...
                                    ("Memorial Daythis|last|next <cycle>", -4.442651256490317),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -4.037186148382152),
                                    ("TuesdayOctober", -4.442651256490317),
                                    ("the <day-of-month> (ordinal)March", -4.442651256490317),
                                    ("Mondaythis|last|next <cycle>", -4.442651256490317),
                                    ("Fridayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.037186148382152),
                                    ("Fridayintersect", -4.442651256490317),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -3.7495040759303713),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.5263605246161616),
                                    ("Tuesdaythis|last|next <cycle>", -4.442651256490317),
                                    ("Sunday<named-month> <day-of-month> (non ordinal)",
                                     -4.442651256490317),
                                    ("dayminute", -2.6508917872622613),
                                    ("intersectyear", -4.442651256490317),
                                    ("minuteday", -3.5263605246161616),
                                    ...
                                    ("Thursday<time-of-day> am|pm", -4.442651256490317),
                               ...
                               n = 54},
                   koData =
                     ClassData{prior = -1.0296194171811581, unseen = -4.812184355372417,
                               likelihoods =
                                 HashMap.fromList
                                   [("week-endJuly", -4.110873864173311),
                                    ...
                                    ("intersectintersect", -4.110873864173311),
                                    ("Tuesdayintersect", -4.110873864173311),
                                    ("Sundayintersect", -4.110873864173311)],
                               n = 30}}),
       ("last <time>",
        Classifier{okData =
                     ClassData{prior = -1.4213856809311607, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 7},
                   koData =
                     ClassData{prior = -0.27625337662815824, unseen = -4.04305126783455,
                               likelihoods =
                                 HashMap.fromList
                                   [("Monday", -3.332204510175204), ("day", -2.4159137783010487),
                                    ("Sunday", -3.332204510175204),
                                    ("time-of-day (latent)", -1.3173014896329391),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -2.4159137783010487),
                                    ("hour", -1.0809127115687087),
                                    ("week-end", -2.9267394020670396)],
                               n = 22}}),
       ("March",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.9444389791664407,
