...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6247444536755447,
                               unseen = -5.8998973535824915,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 363},
                   koData =
                     ClassData{prior = -0.7665746491147625, unseen = -5.75890177387728,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.49512512399199327,
                               unseen = -6.953684210870537,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.259581464064923),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.259581464064923),
                                    ("Ramadanyear (latent)", -5.343290732190768),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.244678443522658),
                                    ("Bhai Doojyear (latent)", -6.259581464064923),
                                    ("hourday", -4.244678443522658),
                                    ("dayhour", -3.341810731980644),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.244678443522658),
                                    ("Martin Luther King's Dayyear (latent)", -5.854116355956759),
                                    ("Shemini Atzeretyear (latent)", -6.259581464064923),
                                    ("daymonth", -4.244678443522658),
                                    ("monthday", -5.854116355956759),
                                    ("monthyear", -4.467821994836868),
                                    ("Yom Ha'atzmautyear (latent)", -6.259581464064923),
                                    ("Vijayadashamiyear (latent)", -6.259581464064923),
                                    ("Thai Pongalyear (latent)", -5.566434283504978),
                                    ("Thiru Onamyear (latent)", -5.566434283504978),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.259581464064923),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.343290732190768),
                                    ("<day-of-month> (ordinal)Wednesday", -6.259581464064923),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.259581464064923),
                                    ("houryear", -5.343290732190768),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.259581464064923),
                                    ("Christmas<time-of-day> am|pm", -6.259581464064923),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.259581464064923),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.566434283504978),
                                    ("intersectin|during <named-month>|year", -6.259581464064923),
                                    ("<time-of-day> am|pmintersect", -5.006818495569555),
                                    ("Earth Houryear (latent)", -6.259581464064923),
                                    ("Octoberyear (latent)", -4.755504067288649),
                                    ("intersect<time-of-day> am|pm", -6.259581464064923),
                                    ("Mattu Pongalyear (latent)", -6.259581464064923),
                                    ("Shavuotyear (latent)", -6.259581464064923),
                                    ("Parsi New Yearyear (latent)", -5.343290732190768),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.259581464064923),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.259581464064923),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.854116355956759),
                                    ("Marchyear (latent)", -6.259581464064923),
                                    ("Sukkotyear (latent)", -5.854116355956759),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.854116355956759),
                                    ("Clean Mondayyear (latent)", -5.854116355956759),
                                    ("monthhour", -5.854116355956759),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.566434283504978),
                                    ("todayat <time-of-day>", -6.259581464064923),
                                    ("Thursday<time> timezone", -4.31367131500961),
                                    ("time-of-day (latent)tonight", -5.854116355956759),
                                    ("from|since|after <time>December", -6.259581464064923),
                                    ("<time-of-day> am|pmon <day>", -4.244678443522658),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.259581464064923),
                                    ("yyyy-mm-ddhh:mm:ss", -5.854116355956759),
                                    ("dayday", -3.8172344286957185),
                                    ("<time> <part-of-day>at <time-of-day>", -6.259581464064923),
                                    ("tonightat <time-of-day>", -6.259581464064923),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.566434283504978),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.259581464064923),
                                    ("today<time-of-day> am|pm", -6.259581464064923),
                                    ("Februarythe <day-of-month> (ordinal)", -5.854116355956759),
                                    ("at <time-of-day><time> <part-of-day>", -6.259581464064923),
                                    ("<day-of-month> (ordinal)intersect", -5.854116355956759),
                                    ("hourhour", -4.180139922385087),
                                    ("Navaratriin|during <named-month>|year", -6.259581464064923),
                                    ("Wednesdaythis|last|next <cycle>", -6.259581464064923),
                                    ("Lentyear (latent)", -6.259581464064923),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.755504067288649),
                                    ("Boghiyear (latent)", -6.259581464064923),
                                    ("dayyear", -2.011086222015564),
                                    ("Thursdayfrom|since|after <time>", -5.854116355956759),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.259581464064923),
                                    ("Thursdayat <time-of-day>", -5.566434283504978),
                                    ("Islamic New Yearyear (latent)", -5.854116355956759),
                                    ("Laylat al-Qadryear (latent)", -5.343290732190768),
                                    ("Shrove Tuesdayyear (latent)", -6.259581464064923),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.566434283504978),
                                    ("<time-of-day> am|pmtomorrow", -5.566434283504978),
                                    ("Yom Kippuryear (latent)", -6.259581464064923),
                                    ("<day-of-month> (ordinal)Tuesday", -5.854116355956759),
                                    ("<part-of-day> of <time>year (latent)", -6.259581464064923),
                                    ("minutehour", -5.160969175396813),
                                    ("Kaanum Pongalyear (latent)", -5.854116355956759),
                                    ("Maha Saptamiyear (latent)", -6.259581464064923),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.854116355956759),
                                    ("time-of-day (latent)tomorrow", -5.343290732190768),
                                    ("part of daysat <time-of-day>", -5.854116355956759),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.554833371826498),
                                    ("for <duration> from <time>December", -6.259581464064923),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.259581464064923),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.006818495569555),
                                    ("time-of-day (latent)this <part-of-day>", -6.259581464064923),
                                    ("Pentecostyear (latent)", -6.259581464064923),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.006818495569555),
                                    ("<day-of-month> (ordinal)February", -6.259581464064923),
                                    ("Eid al-Fitryear (latent)", -5.343290732190768),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.259581464064923),
                                    ("Mondayin|during the <part-of-day>", -6.259581464064923),
                                    ("Chhathin|during <named-month>|year", -6.259581464064923),
                                    ("Diwaliin|during <named-month>|year", -6.259581464064923),
                                    ("Vaisakhiin|during <named-month>|year", -6.259581464064923),
                                    ("Raksha Bandhanyear (latent)", -6.259581464064923),
                                    ("daysecond", -5.854116355956759),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.854116355956759),
                                    ("Ashurayear (latent)", -6.259581464064923),
                                    ("Tuesdayin|during <named-month>|year", -6.259581464064923),
                                    ("Chinese New Yearyear (latent)", -6.259581464064923),
                                    ("tomorrowintersect", -6.259581464064923),
                                    ("Lag BaOmeryear (latent)", -6.259581464064923),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.259581464064923),
                                    ("Eid al-Adhayear (latent)", -5.343290732190768),
                                    ("intersectin|during the <part-of-day>", -6.259581464064923),
                                    ("Palm Sundayyear (latent)", -6.259581464064923),
                                    ("Christmasat <time-of-day>", -6.259581464064923),
                                    ("Passoveryear (latent)", -6.259581464064923),
                                    ("Lazarus Saturdayyear (latent)", -6.259581464064923),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.259581464064923),
                                    ("Yom HaShoahyear (latent)", -5.854116355956759),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.854116355956759),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.259581464064923),
                                    ("Septemberyear (latent)", -5.854116355956759),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.755504067288649),
                                    ("Halloweenyear (latent)", -6.259581464064923),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.259581464064923),
                                    ("at <time-of-day>intersect", -5.854116355956759),
                                    ("Rosh Hashanahyear (latent)", -5.566434283504978),
                                    ("Dhanterasyear (latent)", -6.259581464064923),
                                    ("Tu BiShvatyear (latent)", -6.259581464064923),
                                    ("<day-of-month> (ordinal)December", -5.566434283504978),
                                    ("Holiyear (latent)", -5.566434283504978),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.259581464064923),
                                    ("Holika Dahanyear (latent)", -5.566434283504978),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.259581464064923),
                                    ("dayminute", -3.3973805831354547),
                                    ("Mawlidyear (latent)", -6.259581464064923),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.854116355956759),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.259581464064923),
                                    ("Jumu'atul-Widayear (latent)", -5.343290732190768),
                                    ("minuteday", -2.430940067575828),
                                    ("absorption of , after named dayintersect",
                                     -6.259581464064923),
                                    ("intersectyear (latent)", -6.259581464064923),
                                    ("Orthodox Easter Sundayyear (latent)", -6.259581464064923),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.259581464064923),
                                    ("Boss's Dayyear (latent)", -5.854116355956759),
                                    ("Global Youth Service Dayyear (latent)", -6.259581464064923),
                                    ("Dhanterasin|during <named-month>|year", -6.259581464064923),
                                    ("Tisha B'Avyear (latent)", -6.259581464064923),
                                    ("Isra and Mi'rajyear (latent)", -5.343290732190768),
                                    ("at <time-of-day>on <day>", -5.160969175396813),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.259581464064923),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.566434283504978),
                                    ("Christmasyear (latent)", -5.854116355956759),
                                    ("Naraka Chaturdashiyear (latent)", -5.854116355956759),
                                    ("Thai Pongalin|during <named-month>|year", -6.259581464064923),
                                    ("dayweek", -6.259581464064923),
                                    ("Easter Sundayyear (latent)", -5.566434283504978),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.650143551630823),
                                    ("weekyear", -5.160969175396813),
                                    ("King's Dayyear (latent)", -4.755504067288649),
                                    ("hh:mmin|during the <part-of-day>", -5.566434283504978),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.854116355956759),
                                    ("Hanukkahyear (latent)", -5.566434283504978),
                                    ("February<time> <part-of-day>", -6.259581464064923),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.259581464064923),
                                    ("Great Lentyear (latent)", -6.259581464064923),
                                    ("tomorrowat <time-of-day>", -5.566434283504978),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.259581464064923),
                                    ("Vaisakhiyear (latent)", -5.566434283504978),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.259581464064923),
                                    ("last <cycle> of <time>year (latent)", -5.566434283504978),
                                    ("at <time-of-day>tomorrow", -5.854116355956759),
                                    ("tomorrow<time-of-day> am|pm", -6.259581464064923),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.259581464064923),
                                    ("Diwaliyear (latent)", -6.259581464064923),
                                    ("between <time> and <time>on <day>", -4.650143551630823),
                                    ("Black Fridayyear (latent)", -5.854116355956759),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.259581464064923),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.259581464064923),
                                    ("Chhathyear (latent)", -5.854116355956759),
                                    ("Vasant Panchamiyear (latent)", -6.259581464064923),
                                    ("Rabindra Jayantiyear (latent)", -5.006818495569555),
                                    ("St Patrick's Dayyear (latent)", -6.259581464064923),
                                    ("Thursday<time> (timezone)", -6.259581464064923),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.259581464064923),
                                    ("<datetime> - <datetime> (interval)July", -5.854116355956759),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.854116355956759),
                                    ("Februaryintersect", -6.259581464064923),
                                    ("Simchat Torahyear (latent)", -6.259581464064923),
                                    ("minuteyear", -6.259581464064923)],
                               n = 398},
                   koData =
                     ClassData{prior = -0.9403135841180049, unseen = -6.634633357861686,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.2321210516182215),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.940171252720432),
                                    ("<day-of-month> (ordinal)August", -5.940171252720432),
                                    ("dayhour", -3.375221895258895),
                                    ("<time> timezoneyear (latent)", -5.940171252720432),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.0238805208462765),
                                    ("Tuesdayfrom|since|after <time>", -5.940171252720432),
                                    ("daymonth", -3.455264602932431),
                                    ("monthyear", -4.6874082842250635),
                                    ("<time-of-day> am|pmyear (latent)", -5.247024072160486),
                                    ("Thai Pongalyear (latent)", -5.247024072160486),
                                    ("intersecthh:mm", -5.940171252720432),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.534706144612267),
                                    ("<day-of-month> (ordinal)Wednesday", -5.940171252720432),
                                    ("houryear", -4.553876891600541),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.940171252720432),
                                    ("<day-of-month> (ordinal)October", -5.940171252720432),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.247024072160486),
                                    ("<time-of-day> am|pmintersect", -4.6874082842250635),
                                    ("Octoberyear (latent)", -5.940171252720432),
                                    ("until <time>on <day>", -5.247024072160486),
                                    ("time-of-day (latent)intersect", -5.940171252720432),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.247024072160486),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.940171252720432),
                                    ("hh:mmon <day>", -3.497824217351227),
                                    ("absorption of , after named dayJuly", -5.534706144612267),
                                    ("from|since|after <time>July", -5.534706144612267),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.0238805208462765),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.534706144612267),
                                    ("hourmonth", -4.06836907581884),
                                    ("todayat <time-of-day>", -5.940171252720432),
                                    ("from|since|after <time>December", -5.940171252720432),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.940171252720432),
                                    ("<time-of-day> am|pmon <day>", -4.6874082842250635),
                                    ("Mondayyear (latent)", -5.247024072160486),
                                    ("dayday", -4.553876891600541),
                                    ("on <day>September", -5.534706144612267),
                                    ("time-of-day (latent)September", -5.534706144612267),
                                    ("hourhour", -5.940171252720432),
                                    ("time-of-day (latent)on <day>", -3.497824217351227),
                                    ("Thursdaydd/mm", -5.940171252720432),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.534706144612267),
                                    ("dayyear", -3.022400520636152),
                                    ("New Year's Dayyear (latent)", -5.0238805208462765),
                                    ("Thursdayfrom|since|after <time>", -4.235423160482006),
                                    ("Thursdayat <time-of-day>", -4.330733340286331),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.940171252720432),
                                    ("Aprilyear (latent)", -5.940171252720432),
                                    ("the <day-of-month> (ordinal)July", -5.940171252720432),
                                    ("the <day-of-month> (number)July", -5.940171252720432),
                                    ("monthminute", -5.940171252720432),
                                    ("<time-of-day> am|pmtomorrow", -5.940171252720432),
                                    ("Thursdayhh:mm", -5.0238805208462765),
                                    ("<day-of-month> (ordinal)Tuesday", -5.534706144612267),
                                    ("minutemonth", -4.06836907581884),
                                    ("minutehour", -5.940171252720432),
                                    ("Augustyear (latent)", -5.534706144612267),
                                    ("week-endin|during <named-month>|year", -5.940171252720432),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.940171252720432),
                                    ("Sundayyear (latent)", -5.0238805208462765),
                                    ("Christmasat <time-of-day>", -5.940171252720432),
                                    ("from|since|after <time>year (latent)", -4.841558964052322),
                                    ("<duration> after|before|from <time>December",
                                     -5.940171252720432),
                                    ("yesterday<time-of-day> am|pm", -5.940171252720432),
                                    ("<day-of-month> (ordinal)July", -5.247024072160486),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.940171252720432),
                                    ("at <time-of-day>intersect", -5.534706144612267),
                                    ("hh:mmyear (latent)", -3.8607297110405954),
                                    ("Holiyear (latent)", -5.940171252720432),
                                    ("until <time><time-of-day> am|pm", -5.940171252720432),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.940171252720432),
                                    ("dayminute", -3.414442608412176),
                                    ("yyyy-mm-ddhh:mm", -5.534706144612267),
                                    ("intersectSeptember", -4.436093855944157),
                                    ("minuteday", -2.701492800556051),
                                    ("absorption of , after named dayintersect",
                                     -5.940171252720432),
                                    ("intersectyear (latent)", -5.940171252720432),
                                    ("Februaryin|during the <part-of-day>", -5.940171252720432),
                                    ("time-of-day (latent)July", -5.247024072160486),
                                    ("Saturdayyear (latent)", -5.940171252720432),
                                    ("at <time-of-day>on <day>", -5.534706144612267),
                                    ("absorption of , after named daySeptember",
                                     -5.0238805208462765),
                                    ("Naraka Chaturdashiyear (latent)", -5.940171252720432),
                                    ("from|since|after <time>on <day>", -5.0238805208462765),
                                    ("dayweek", -5.940171252720432),
                                    ("Easter Sundayyear (latent)", -5.534706144612267),
                                    ("Thursday<time-of-day> am|pm", -4.6874082842250635),
                                    ("weekyear", -5.534706144612267),
                                    ("time-of-day (latent)Thursday", -5.534706144612267),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.940171252720432),
                                    ("<day-of-month> (ordinal)April", -5.940171252720432),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.534706144612267),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.247024072160486),
                                    ("Sundayfrom|since|after <time>", -5.940171252720432),
                                    ...
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.940171252720432),
                                    ("tomorrowat <time-of-day>", -5.940171252720432),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.534706144612267),
                                    ("last <cycle> of <time>year (latent)", -5.534706144612267),
                                    ("tomorrow<time-of-day> am|pm", -5.940171252720432),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.247024072160486),
                                    ("Diwaliyear (latent)", -5.534706144612267),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.940171252720432),
                                    ("Fridayyear (latent)", -5.534706144612267),
                                    ("time-of-day (latent)April", -5.940171252720432),
                                    ("minuteyear", -3.742946675384212)],
                               n = 255}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.18735935082391175,
                               ...
                               n = 165},
                   koData =
                     ClassData{prior = -1.7669443001083311,
