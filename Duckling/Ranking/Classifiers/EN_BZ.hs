...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5993561165849367, unseen = -5.697093486505405,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 296},
                   koData =
                     ClassData{prior = -0.7966541275684488,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4683521012072626, unseen = -6.70196036600254,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.007583928987866),
                                    ("Ramadanyear (latent)", -6.007583928987866),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.754820960492498),
                                    ("Bhai Doojyear (latent)", -6.007583928987866),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.754820960492498),
                                    ("hourday", -4.30283583674944),
                                    ("dayhour", -3.2042235480813304),
                                    ("Martin Luther King's Dayyear (latent)", -5.602118820879701),
                                    ("Shemini Atzeretyear (latent)", -6.007583928987866),
                                    ("daymonth", -5.0912931971137105),
                                    ("monthday", -5.602118820879701),
                                    ("monthyear", -4.21582445975981),
                                    ("Yom Ha'atzmautyear (latent)", -6.007583928987866),
                                    ("Vijayadashamiyear (latent)", -6.007583928987866),
                                    ("Thai Pongalyear (latent)", -5.31443674842792),
                                    ("Thiru Onamyear (latent)", -5.31443674842792),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.007583928987866),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.007583928987866),
                                    ("houryear", -5.31443674842792),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.007583928987866),
                                    ("Christmas<time-of-day> am|pm", -6.007583928987866),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.007583928987866),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.31443674842792),
                                    ("<time-of-day> am|pmintersect", -4.754820960492498),
                                    ("Earth Houryear (latent)", -6.007583928987866),
                                    ("Octoberyear (latent)", -4.503506532211591),
                                    ("intersect<time-of-day> am|pm", -6.007583928987866),
                                    ("Mattu Pongalyear (latent)", -6.007583928987866),
                                    ("Shavuotyear (latent)", -6.007583928987866),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.007583928987866),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.007583928987866),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.602118820879701),
                                    ("Marchyear (latent)", -6.007583928987866),
                                    ("Sukkotyear (latent)", -5.602118820879701),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.007583928987866),
                                    ("Clean Mondayyear (latent)", -5.602118820879701),
                                    ("monthhour", -5.602118820879701),
                                    ("todayat <time-of-day>", -6.007583928987866),
                                    ("Thursday<time> timezone", -4.30283583674944),
                                    ("from|since|after <time>December", -6.007583928987866),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.007583928987866),
                                    ("yyyy-mm-ddhh:mm:ss", -5.602118820879701),
                                    ("dayday", -3.9926809084456005),
                                    ("<time> <part-of-day>at <time-of-day>", -6.007583928987866),
                                    ("tonightat <time-of-day>", -6.007583928987866),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.31443674842792),
                                    ("today<time-of-day> am|pm", -6.007583928987866),
                                    ("Februarythe <day-of-month> (ordinal)", -5.602118820879701),
                                    ("at <time-of-day><time> <part-of-day>", -6.007583928987866),
                                    ("hourhour", -4.754820960492498),
                                    ("<time-of-day> am|pmon <date>", -3.9926809084456005),
                                    ("Navaratriin|during <named-month>|year", -6.007583928987866),
                                    ("Wednesdaythis|last|next <cycle>", -6.007583928987866),
                                    ("Lentyear (latent)", -6.007583928987866),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.503506532211591),
                                    ("Boghiyear (latent)", -6.007583928987866),
                                    ("dayyear", -2.0279022750859044),
                                    ("Thursdayfrom|since|after <time>", -5.602118820879701),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.007583928987866),
                                    ("Thursdayat <time-of-day>", -5.602118820879701),
                                    ("Islamic New Yearyear (latent)", -5.602118820879701),
                                    ("Laylat al-Qadryear (latent)", -5.0912931971137105),
                                    ("Shrove Tuesdayyear (latent)", -6.007583928987866),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.31443674842792),
                                    ("<time-of-day> am|pmtomorrow", -5.31443674842792),
                                    ("Yom Kippuryear (latent)", -6.007583928987866),
                                    ("<part-of-day> of <time>year (latent)", -6.007583928987866),
                                    ("minutehour", -5.0912931971137105),
                                    ("Kaanum Pongalyear (latent)", -5.602118820879701),
                                    ("Maha Saptamiyear (latent)", -6.007583928987866),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.602118820879701),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.30283583674944),
                                    ("for <duration> from <time>December", -6.007583928987866),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.007583928987866),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.0912931971137105),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.602118820879701),
                                    ("Pentecostyear (latent)", -6.007583928987866),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.0912931971137105),
                                    ("Eid al-Fitryear (latent)", -6.007583928987866),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.007583928987866),
                                    ("Mondayin|during the <part-of-day>", -6.007583928987866),
                                    ("Chhathin|during <named-month>|year", -6.007583928987866),
                                    ("Diwaliin|during <named-month>|year", -6.007583928987866),
                                    ("Raksha Bandhanyear (latent)", -6.007583928987866),
                                    ("daysecond", -5.602118820879701),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.602118820879701),
                                    ("Ashurayear (latent)", -6.007583928987866),
                                    ("Tuesdayin|during <named-month>|year", -6.007583928987866),
                                    ("Chinese New Yearyear (latent)", -6.007583928987866),
                                    ("Lag BaOmeryear (latent)", -6.007583928987866),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.007583928987866),
                                    ("Eid al-Adhayear (latent)", -5.0912931971137105),
                                    ("intersectin|during the <part-of-day>", -6.007583928987866),
                                    ("Palm Sundayyear (latent)", -6.007583928987866),
                                    ("Christmasat <time-of-day>", -6.007583928987866),
                                    ("Passoveryear (latent)", -6.007583928987866),
                                    ("Lazarus Saturdayyear (latent)", -6.007583928987866),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.007583928987866),
                                    ("Yom HaShoahyear (latent)", -5.602118820879701),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.602118820879701),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.007583928987866),
                                    ("Septemberyear (latent)", -5.602118820879701),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.754820960492498),
                                    ("Halloweenyear (latent)", -6.007583928987866),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.007583928987866),
                                    ("at <time-of-day>intersect", -5.602118820879701),
                                    ("Rosh Hashanahyear (latent)", -5.31443674842792),
                                    ("Dhanterasyear (latent)", -6.007583928987866),
                                    ("Tu BiShvatyear (latent)", -6.007583928987866),
                                    ("Holiyear (latent)", -5.31443674842792),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.007583928987866),
                                    ("Holika Dahanyear (latent)", -5.31443674842792),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.007583928987866),
                                    ("dayminute", -3.4426345715263285),
                                    ("Mawlidyear (latent)", -6.007583928987866),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.602118820879701),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.007583928987866),
                                    ("Jumu'atul-Widayear (latent)", -5.0912931971137105),
                                    ("minuteday", -2.3699977692614795),
                                    ("absorption of , after named dayintersect",
                                     -6.007583928987866),
                                    ("Orthodox Easter Sundayyear (latent)", -6.007583928987866),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.007583928987866),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.007583928987866),
                                    ("Boss's Dayyear (latent)", -5.602118820879701),
                                    ("Global Youth Service Dayyear (latent)", -6.007583928987866),
                                    ("Dhanterasin|during <named-month>|year", -6.007583928987866),
                                    ("Tisha B'Avyear (latent)", -6.007583928987866),
                                    ("Isra and Mi'rajyear (latent)", -5.0912931971137105),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.007583928987866),
                                    ("Christmasyear (latent)", -5.602118820879701),
                                    ("Naraka Chaturdashiyear (latent)", -5.602118820879701),
                                    ("at <time-of-day>on <date>", -4.908971640319756),
                                    ("Thai Pongalin|during <named-month>|year", -6.007583928987866),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.398146016553765),
                                    ("dayweek", -6.007583928987866),
                                    ("Easter Sundayyear (latent)", -5.31443674842792),
                                    ("weekyear", -4.908971640319756),
                                    ("hh:mmin|during the <part-of-day>", -5.31443674842792),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.602118820879701),
                                    ("Hanukkahyear (latent)", -5.31443674842792),
                                    ("February<time> <part-of-day>", -6.007583928987866),
                                    ("Great Lentyear (latent)", -6.007583928987866),
                                    ("tomorrowat <time-of-day>", -5.31443674842792),
                                    ("between <time> and <time>on <date>", -4.398146016553765),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.007583928987866),
                                    ("last <cycle> of <time>year (latent)", -5.31443674842792),
                                    ("at <time-of-day>tomorrow", -5.602118820879701),
                                    ("tomorrow<time-of-day> am|pm", -6.007583928987866),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.007583928987866),
                                    ("Diwaliyear (latent)", -6.007583928987866),
                                    ("Black Fridayyear (latent)", -5.602118820879701),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.007583928987866),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.007583928987866),
                                    ("Chhathyear (latent)", -5.602118820879701),
                                    ("Vasant Panchamiyear (latent)", -6.007583928987866),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.007583928987866),
                                    ("Februaryintersect", -6.007583928987866),
                                    ("Simchat Torahyear (latent)", -6.007583928987866),
                                    ("minuteyear", -6.007583928987866)],
                               n = 303},
                   koData =
                     ClassData{prior = -0.9835878754508061, unseen = -6.345636360828596,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.73444252169223),
                                    ("hourday", -4.73444252169223), ("dayhour", -3.208386218197181),
                                    ("Tuesdayfrom|since|after <time>", -5.6507332535663855),
                                    ("daymonth", -3.635830233024121),
                                    ("monthyear", -4.397970285071017),
                                    ("<time-of-day> am|pmyear (latent)", -5.245268145458221),
                                    ("Thai Pongalyear (latent)", -4.95758607300644),
                                    ("intersecthh:mm", -5.6507332535663855),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.6507332535663855),
                                    ("houryear", -4.73444252169223),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.6507332535663855),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.95758607300644),
                                    ("<time-of-day> am|pmintersect", -4.397970285071017),
                                    ("until <time>on <date>", -4.95758607300644),
                                    ("Octoberyear (latent)", -5.6507332535663855),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -4.95758607300644),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.6507332535663855),
                                    ("absorption of , after named dayJuly", -5.245268145458221),
                                    ("from|since|after <time>July", -5.6507332535663855),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.73444252169223),
                                    ("Clean Mondayyear (latent)", -5.6507332535663855),
                                    ("monthhour", -5.6507332535663855),
                                    ("hourmonth", -4.73444252169223),
                                    ("todayat <time-of-day>", -5.6507332535663855),
                                    ("from|since|after <time>December", -5.6507332535663855),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.6507332535663855),
                                    ("Mondayyear (latent)", -4.95758607300644),
                                    ("dayday", -5.245268145458221),
                                    ("<time-of-day> am|pmon <date>", -4.397970285071017),
                                    ("Thursdaydd/mm", -5.6507332535663855),
                                    ("dayyear", -2.7885323726369173),
                                    ("New Year's Dayyear (latent)", -5.245268145458221),
                                    ("Thursdayfrom|since|after <time>", -3.9459851613279606),
                                    ("Thursdayat <time-of-day>", -4.397970285071017),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.6507332535663855),
                                    ("Aprilyear (latent)", -5.6507332535663855),
                                    ("monthminute", -5.6507332535663855),
                                    ("<time-of-day> am|pmtomorrow", -5.6507332535663855),
                                    ("Thursdayhh:mm", -4.73444252169223),
                                    ("minutemonth", -3.8589737843383305),
                                    ("Augustyear (latent)", -5.245268145458221),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.245268145458221),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.245268145458221),
                                    ("week-endin|during <named-month>|year", -5.6507332535663855),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.6507332535663855),
                                    ("Sundayyear (latent)", -4.73444252169223),
                                    ("Christmasat <time-of-day>", -5.6507332535663855),
                                    ("from|since|after <time>year (latent)", -4.552120964898276),
                                    ("<duration> after|before|from <time>December",
                                     -5.6507332535663855),
                                    ("yesterday<time-of-day> am|pm", -5.6507332535663855),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.6507332535663855),
                                    ("at <time-of-day>intersect", -5.245268145458221),
                                    ("hh:mmyear (latent)", -4.552120964898276),
                                    ("Holiyear (latent)", -5.6507332535663855),
                                    ("until <time><time-of-day> am|pm", -5.6507332535663855),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.6507332535663855),
                                    ("dayminute", -3.011675923951127),
                                    ("yyyy-mm-ddhh:mm", -5.245268145458221),
                                    ("intersectSeptember", -4.146655856790112),
                                    ("minuteday", -2.5826803184327685),
                                    ("absorption of , after named dayintersect",
                                     -5.6507332535663855),
                                    ("Februaryin|during the <part-of-day>", -5.6507332535663855),
                                    ("hh:mmon <date>", -3.635830233024121),
                                    ("Saturdayyear (latent)", -5.6507332535663855),
                                    ("from|since|after <time>on <date>", -4.73444252169223),
                                    ("absorption of , after named daySeptember", -4.73444252169223),
                                    ("Naraka Chaturdashiyear (latent)", -5.6507332535663855),
                                    ("on <date>September", -5.245268145458221),
                                    ("at <time-of-day>on <date>", -5.245268145458221),
                                    ("dayweek", -5.6507332535663855),
                                    ("Easter Sundayyear (latent)", -5.245268145458221),
                                    ("Thursday<time-of-day> am|pm", -4.95758607300644),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -4.95758607300644),
                                    ("Sundayfrom|since|after <time>", -5.6507332535663855),
                                    ("absorption of , after named dayFebruary", -4.73444252169223),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.6507332535663855),
                                    ("tomorrowat <time-of-day>", -5.6507332535663855),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.6507332535663855),
                                    ("last <cycle> of <time>year (latent)", -5.245268145458221),
                                    ("tomorrow<time-of-day> am|pm", -5.6507332535663855),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.95758607300644),
                                    ("Diwaliyear (latent)", -5.245268145458221),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.6507332535663855),
                                    ("Fridayyear (latent)", -5.245268145458221),
                                    ("minuteyear", -4.397970285071017)],
                               n = 181}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.19530875232076572,
                               ...
                               n = 102},
                   koData =
                     ClassData{prior = -1.729239112246721, unseen = -4.110873864173311,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("hh:mm",
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -2.681021528714291, unseen = -1.9459101490553135,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 5}}),
       ("Holi",
        Classifier{okData =
                     ClassData{prior = -0.2876820724517809,
