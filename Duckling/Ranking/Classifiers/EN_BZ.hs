...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4720507128674604, unseen = -6.709304340258298,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.014936903293124),
                                    ("Ramadanyear (latent)", -6.014936903293124),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.762173934797756),
                                    ("Bhai Doojyear (latent)", -6.014936903293124),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.762173934797756),
                                    ("hourday", -4.310188811054699),
                                    ("dayhour", -3.211576522386589),
                                    ("Martin Luther King's Dayyear (latent)", -5.60947179518496),
                                    ("Shemini Atzeretyear (latent)", -6.014936903293124),
                                    ("daymonth", -5.098646171418969),
                                    ("monthday", -5.60947179518496),
                                    ("monthyear", -4.223177434065069),
                                    ("Yom Ha'atzmautyear (latent)", -6.014936903293124),
                                    ("Vijayadashamiyear (latent)", -6.014936903293124),
                                    ("Thai Pongalyear (latent)", -5.321789722733179),
                                    ("Thiru Onamyear (latent)", -5.321789722733179),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.014936903293124),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.014936903293124),
                                    ("houryear", -5.321789722733179),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.014936903293124),
                                    ("Christmas<time-of-day> am|pm", -6.014936903293124),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.014936903293124),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.321789722733179),
                                    ("<time-of-day> am|pmintersect", -4.762173934797756),
                                    ("Earth Houryear (latent)", -6.014936903293124),
                                    ("Octoberyear (latent)", -4.51085950651685),
                                    ("intersect<time-of-day> am|pm", -6.014936903293124),
                                    ("Mattu Pongalyear (latent)", -6.014936903293124),
                                    ("Shavuotyear (latent)", -6.014936903293124),
                                    ("Dhanterasin <named-month>|year", -6.014936903293124),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.014936903293124),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.014936903293124),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.60947179518496),
                                    ("Marchyear (latent)", -6.014936903293124),
                                    ("Sukkotyear (latent)", -5.60947179518496),
                                    ...
                                    ("Thursday<time> timezone", -4.310188811054699),
                                    ("from|since|after <time>December", -6.014936903293124),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.014936903293124),
                                    ("Palm SundaySunday", -5.60947179518496),
                                    ("dayday", -3.817712325956905),
                                    ("<time> <part-of-day>at <time-of-day>", -6.014936903293124),
                                    ("tonightat <time-of-day>", -6.014936903293124),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.321789722733179),
                                    ("today<time-of-day> am|pm", -6.014936903293124),
                                    ("Februarythe <day-of-month> (ordinal)", -5.60947179518496),
                                    ("at <time-of-day><time> <part-of-day>", -6.014936903293124),
                                    ("hourhour", -4.762173934797756),
                                    ("<time-of-day> am|pmon <date>", -4.000033882750859),
                                    ("Wednesdaythis|last|next <cycle>", -6.014936903293124),
                                    ("Lentyear (latent)", -6.014936903293124),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.51085950651685),
                                    ("Boghiyear (latent)", -6.014936903293124),
                                    ("dayyear", -2.02595285672885),
                                    ("Thursdayfrom|since|after <time>", -5.60947179518496),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.014936903293124),
                                    ("Thursdayat <time-of-day>", -5.60947179518496),
                                    ("Islamic New Yearyear (latent)", -5.60947179518496),
                                    ("Laylat al-Qadryear (latent)", -5.098646171418969),
                                    ("Chhathin <named-month>|year", -6.014936903293124),
                                    ("Vasant Panchamiin <named-month>|year", -6.014936903293124),
                                    ("Diwaliin <named-month>|year", -6.014936903293124),
                                    ("Shrove Tuesdayyear (latent)", -6.014936903293124),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.321789722733179),
                                    ("<time-of-day> am|pmtomorrow", -5.321789722733179),
                                    ("Yom Kippuryear (latent)", -6.014936903293124),
                                    ("<part-of-day> of <time>year (latent)", -6.014936903293124),
                                    ("minutehour", -5.098646171418969),
                                    ("Kaanum Pongalyear (latent)", -5.60947179518496),
                                    ("Maha Saptamiyear (latent)", -6.014936903293124),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.60947179518496),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.310188811054699),
                                    ("for <duration> from <time>December", -6.014936903293124),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.014936903293124),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.098646171418969),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.60947179518496),
                                    ("Pentecostyear (latent)", -6.014936903293124),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.098646171418969),
                                    ("Eid al-Fitryear (latent)", -6.014936903293124),
                                    ("Mondayin|during the <part-of-day>", -6.014936903293124),
                                    ("Raksha Bandhanyear (latent)", -6.014936903293124),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.60947179518496),
                                    ("Navaratriin <named-month>|year", -6.014936903293124),
                                    ("Ashurayear (latent)", -6.014936903293124),
                                    ("Chinese New Yearyear (latent)", -6.014936903293124),
                                    ("Sundayyear (latent)", -6.014936903293124),
                                    ("Lag BaOmeryear (latent)", -6.014936903293124),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.014936903293124),
                                    ("Eid al-Adhayear (latent)", -5.098646171418969),
                                    ("intersectin|during the <part-of-day>", -6.014936903293124),
                                    ("Christmasat <time-of-day>", -6.014936903293124),
                                    ("Passoveryear (latent)", -6.014936903293124),
                                    ("Lazarus Saturdayyear (latent)", -6.014936903293124),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.014936903293124),
                                    ("Yom HaShoahyear (latent)", -5.60947179518496),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.60947179518496),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.014936903293124),
                                    ("Thai Pongalin <named-month>|year", -6.014936903293124),
                                    ("Septemberyear (latent)", -5.60947179518496),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.762173934797756),
                                    ("Halloweenyear (latent)", -6.014936903293124),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.014936903293124),
                                    ("at <time-of-day>intersect", -5.60947179518496),
                                    ("Rosh Hashanahyear (latent)", -5.321789722733179),
                                    ("Dhanterasyear (latent)", -6.014936903293124),
                                    ("Tu BiShvatyear (latent)", -6.014936903293124),
                                    ("Holiyear (latent)", -5.321789722733179),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.014936903293124),
                                    ("Holika Dahanyear (latent)", -5.321789722733179),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.014936903293124),
                                    ("dayminute", -3.4499875458315876),
                                    ("Mawlidyear (latent)", -6.014936903293124),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.60947179518496),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.014936903293124),
                                    ("Jumu'atul-Widayear (latent)", -5.098646171418969),
                                    ("minuteday", -2.3773507435667383),
                                    ("absorption of , after named dayintersect",
                                     -6.014936903293124),
                                    ("intersectyear (latent)", -6.014936903293124),
                                    ("Orthodox Easter Sundayyear (latent)", -6.014936903293124),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.014936903293124),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.014936903293124),
                                    ("Boss's Dayyear (latent)", -5.60947179518496),
                                    ("Global Youth Service Dayyear (latent)", -6.014936903293124),
                                    ("Tisha B'Avyear (latent)", -6.014936903293124),
                                    ("Isra and Mi'rajyear (latent)", -5.098646171418969),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.014936903293124),
                                    ("Christmasyear (latent)", -5.60947179518496),
                                    ("Naraka Chaturdashiyear (latent)", -5.60947179518496),
                                    ("at <time-of-day>on <date>", -4.916324614625014),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.405498990859024),
                                    ("dayweek", -6.014936903293124),
                                    ("Easter Sundayyear (latent)", -5.321789722733179),
                                    ("weekyear", -4.916324614625014),
                                    ("hh:mmin|during the <part-of-day>", -5.321789722733179),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.60947179518496),
                                    ("Hanukkahyear (latent)", -5.321789722733179),
                                    ("February<time> <part-of-day>", -6.014936903293124),
                                    ("Tuesdayin <named-month>|year", -6.014936903293124),
                                    ("Great Lentyear (latent)", -6.014936903293124),
                                    ("tomorrowat <time-of-day>", -5.321789722733179),
                                    ("between <time> and <time>on <date>", -4.405498990859024),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.014936903293124),
                                    ("last <cycle> of <time>year (latent)", -5.321789722733179),
                                    ("at <time-of-day>tomorrow", -5.60947179518496),
                                    ("tomorrow<time-of-day> am|pm", -6.014936903293124),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.014936903293124),
                                    ("Diwaliyear (latent)", -6.014936903293124),
                                    ("Black Fridayyear (latent)", -5.60947179518496),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.014936903293124),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.014936903293124),
                                    ("Chhathyear (latent)", -5.60947179518496),
                                    ("Vasant Panchamiyear (latent)", -6.014936903293124),
                                    ("Palm Sundayintersect", -6.014936903293124),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.014936903293124),
                                    ("Februaryintersect", -6.014936903293124),
                                    ("Simchat Torahyear (latent)", -6.014936903293124),
                                    ("minuteyear", -6.014936903293124)],
                               n = 305},
                   koData =
                     ClassData{prior = -0.9774267318658864, unseen = -6.359573868672378,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.748404354073999),
                                    ("hourday", -4.748404354073999),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.664695085948154),
                                    ("dayhour", -3.22234805057895),
                                    ("Tuesdayfrom|since|after <time>", -5.664695085948154),
                                    ("daymonth", -3.5246289224518836),
                                    ("monthday", -5.25922997783999),
                                    ("monthyear", -4.411932117452786),
                                    ("<time-of-day> am|pmyear (latent)", -5.25922997783999),
                                    ("Thai Pongalyear (latent)", -4.971547905388209),
                                    ("intersecthh:mm", -5.664695085948154),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.664695085948154),
                                    ("houryear", -4.748404354073999),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.664695085948154),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.971547905388209),
                                    ("<time-of-day> am|pmintersect", -4.411932117452786),
                                    ("until <time>on <date>", -4.971547905388209),
                                    ("Octoberyear (latent)", -5.664695085948154),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.664695085948154),
                                    ("absorption of , after named dayJuly", -5.25922997783999),
                                    ("from|since|after <time>July", -5.664695085948154),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.748404354073999),
                                    ("Clean Mondayyear (latent)", -5.664695085948154),
                                    ("monthhour", -5.664695085948154),
                                    ("hourmonth", -4.748404354073999),
                                    ("todayat <time-of-day>", -5.664695085948154),
                                    ("from|since|after <time>December", -5.664695085948154),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.664695085948154),
                                    ("Mondayyear (latent)", -4.971547905388209),
                                    ("dayday", -5.25922997783999),
                                    ("<time-of-day> am|pmon <date>", -4.411932117452786),
                                    ("Thursdaydd/mm", -5.664695085948154),
                                    ("dayyear", -2.7202561067817137),
                                    ("New Year's Dayyear (latent)", -5.25922997783999),
                                    ("Thursdayfrom|since|after <time>", -3.959946993709729),
                                    ("Thursdayat <time-of-day>", -4.411932117452786),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.664695085948154),
                                    ("Aprilyear (latent)", -5.664695085948154),
                                    ("monthminute", -5.664695085948154),
                                    ("<time-of-day> am|pmtomorrow", -5.664695085948154),
                                    ("Thursdayhh:mm", -4.748404354073999),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.664695085948154),
                                    ("minutemonth", -3.872935616720099),
                                    ("week-endin <named-month>|year", -5.664695085948154),
                                    ("Augustyear (latent)", -5.25922997783999),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.25922997783999),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.25922997783999),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.664695085948154),
                                    ("Sundayyear (latent)", -4.971547905388209),
                                    ("Christmasat <time-of-day>", -5.664695085948154),
                                    ("from|since|after <time>year (latent)", -4.411932117452786),
                                    ("<duration> after|before|from <time>December",
                                     -5.664695085948154),
                                    ("yesterday<time-of-day> am|pm", -5.664695085948154),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.664695085948154),
                                    ("at <time-of-day>intersect", -5.25922997783999),
                                    ("hh:mmyear (latent)", -4.566082797280044),
                                    ("Holiyear (latent)", -5.664695085948154),
                                    ("until <time><time-of-day> am|pm", -5.664695085948154),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.664695085948154),
                                    ("dayminute", -3.179788436160154),
                                    ("intersectSeptember", -4.16061768917188),
                                    ("minuteday", -2.596642150814537),
                                    ("absorption of , after named dayintersect",
                                     -5.664695085948154),
                                    ("Februaryin|during the <part-of-day>", -5.664695085948154),
                                    ("hh:mmon <date>", -3.6497920654058897),
                                    ("Saturdayyear (latent)", -5.664695085948154),
                                    ("from|since|after <time>on <date>", -4.748404354073999),
                                    ("absorption of , after named daySeptember",
                                     -4.748404354073999),
                                    ("Naraka Chaturdashiyear (latent)", -5.664695085948154),
                                    ("on <date>September", -5.25922997783999),
                                    ("at <time-of-day>on <date>", -5.25922997783999),
                                    ("in <named-month>|yearyear (latent)", -5.664695085948154),
                                    ("dayweek", -5.664695085948154),
                                    ("Easter Sundayyear (latent)", -5.25922997783999),
                                    ("Thursday<time-of-day> am|pm", -4.971547905388209),
                                    ("weekyear", -5.25922997783999),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.664695085948154),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -4.971547905388209),
                                    ("Sundayfrom|since|after <time>", -5.664695085948154),
                                    ("absorption of , after named dayFebruary", -4.748404354073999),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.664695085948154),
                                    ("tomorrowat <time-of-day>", -5.664695085948154),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.664695085948154),
                                    ("last <cycle> of <time>year (latent)", -5.25922997783999),
                                    ("tomorrow<time-of-day> am|pm", -5.664695085948154),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.971547905388209),
                                    ("Diwaliyear (latent)", -5.25922997783999),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.664695085948154),
                                    ("Fridayyear (latent)", -5.25922997783999),
                                    ("minuteyear", -4.411932117452786)],
                               n = 184}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6201220455450555, unseen = -4.31748811353631,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 71},
                   koData =
                     ClassData{prior = -0.7719280584130597, unseen = -4.174387269895637,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -8.13456394539524e-2),
                                    ("integer (0..19)", -3.0602707946915624),
