...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5821346514707724, unseen = -5.627621113690637,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 276},
                   koData =
                     ClassData{prior = -0.8180404543988334, unseen = -5.393627546352362,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.480053965099237, unseen = -6.682108597449809,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -5.98770749823027),
                                    ("Ramadanyear (latent)", -5.98770749823027),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.734944529734902),
                                    ("Bhai Doojyear (latent)", -5.98770749823027),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.734944529734902),
                                    ("hourday", -4.2829594059918445),
                                    ("dayhour", -3.0699367661459904),
                                    ("Martin Luther King's Dayyear (latent)", -5.582242390122105),
                                    ("Shemini Atzeretyear (latent)", -5.98770749823027),
                                    ("daymonth", -5.294560317670324),
                                    ("monthday", -5.582242390122105),
                                    ("monthyear", -4.378269585796169),
                                    ("Yom Ha'atzmautyear (latent)", -5.98770749823027),
                                    ("Vijayadashamiyear (latent)", -5.98770749823027),
                                    ("Thai Pongalyear (latent)", -5.294560317670324),
                                    ("Thiru Onamyear (latent)", -5.294560317670324),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.98770749823027),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.98770749823027),
                                    ("houryear", -5.294560317670324),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.98770749823027),
                                    ("Christmas<time-of-day> am|pm", -5.98770749823027),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.98770749823027),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.294560317670324),
                                    ("<time-of-day> am|pmintersect", -4.734944529734902),
                                    ("Octoberyear (latent)", -4.734944529734902),
                                    ("intersect<time-of-day> am|pm", -5.98770749823027),
                                    ("Mattu Pongalyear (latent)", -5.98770749823027),
                                    ("Shavuotyear (latent)", -5.98770749823027),
                                    ("Dhanterasin <named-month>|year", -5.98770749823027),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.98770749823027),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.98770749823027),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.582242390122105),
                                    ("Marchyear (latent)", -5.98770749823027),
                                    ("Sukkotyear (latent)", -5.582242390122105),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.98770749823027),
                                    ("Clean Mondayyear (latent)", -5.582242390122105),
                                    ("monthhour", -5.582242390122105),
                                    ("todayat <time-of-day>", -5.98770749823027),
                                    ("Thursday<time> timezone", -4.2829594059918445),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -5.98770749823027),
                                    ("Palm SundaySunday", -5.582242390122105),
                                    ("dayday", -3.7904829208940503),
                                    ("<time> <part-of-day>at <time-of-day>", -5.98770749823027),
                                    ("tonightat <time-of-day>", -5.98770749823027),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.294560317670324),
                                    ("today<time-of-day> am|pm", -5.98770749823027),
                                    ("Februarythe <day-of-month> (ordinal)", -5.582242390122105),
                                    ("at <time-of-day><time> <part-of-day>", -5.98770749823027),
                                    ("hourhour", -4.734944529734902),
                                    ("<time-of-day> am|pmon <date>", -3.972804477688005),
                                    ("Wednesdaythis|last|next <cycle>", -5.98770749823027),
                                    ("Lentyear (latent)", -5.98770749823027),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.483630101453995),
                                    ("Boghiyear (latent)", -5.98770749823027),
                                    ("dayyear", -2.0461256905605794),
                                    ("Thursdayfrom|since|after <time>", -5.294560317670324),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.98770749823027),
                                    ("Thursdayat <time-of-day>", -5.582242390122105),
                                    ("Islamic New Yearyear (latent)", -5.582242390122105),
                                    ("Laylat al-Qadryear (latent)", -5.071416766356115),
                                    ("Chhathin <named-month>|year", -5.98770749823027),
                                    ("Vasant Panchamiin <named-month>|year", -5.98770749823027),
                                    ("Diwaliin <named-month>|year", -5.98770749823027),
                                    ("Shrove Tuesdayyear (latent)", -5.98770749823027),
                                    ("<time-of-day> am|pmtomorrow", -5.294560317670324),
                                    ("Yom Kippuryear (latent)", -5.98770749823027),
                                    ("<part-of-day> of <time>year (latent)", -5.98770749823027),
                                    ("minutehour", -5.071416766356115),
                                    ("Kaanum Pongalyear (latent)", -5.582242390122105),
                                    ("Maha Saptamiyear (latent)", -5.98770749823027),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.582242390122105),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.2829594059918445),
                                    ("for <duration> from <time>December", -5.98770749823027),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.98770749823027),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.071416766356115),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.582242390122105),
                                    ("Pentecostyear (latent)", -5.98770749823027),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.071416766356115),
                                    ("Eid al-Fitryear (latent)", -5.98770749823027),
                                    ("Mondayin|during the <part-of-day>", -5.98770749823027),
                                    ("Raksha Bandhanyear (latent)", -5.98770749823027),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.582242390122105),
                                    ("Navaratriin <named-month>|year", -5.98770749823027),
                                    ("Ashurayear (latent)", -5.98770749823027),
                                    ("Chinese New Yearyear (latent)", -5.98770749823027),
                                    ("Sundayyear (latent)", -5.98770749823027),
                                    ("Lag BaOmeryear (latent)", -5.98770749823027),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.98770749823027),
                                    ("Eid al-Adhayear (latent)", -5.071416766356115),
                                    ("intersectin|during the <part-of-day>", -5.98770749823027),
                                    ("Christmasat <time-of-day>", -5.98770749823027),
                                    ("Passoveryear (latent)", -5.98770749823027),
                                    ("Lazarus Saturdayyear (latent)", -5.98770749823027),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.98770749823027),
                                    ("Yom HaShoahyear (latent)", -5.582242390122105),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.071416766356115),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.98770749823027),
                                    ("Thai Pongalin <named-month>|year", -5.98770749823027),
                                    ("Septemberyear (latent)", -5.582242390122105),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.734944529734902),
                                    ("Halloweenyear (latent)", -5.98770749823027),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.294560317670324),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -5.071416766356115),
                                    ("at <time-of-day>intersect", -5.582242390122105),
                                    ("Rosh Hashanahyear (latent)", -5.98770749823027),
                                    ("Dhanterasyear (latent)", -5.98770749823027),
                                    ("Tu BiShvatyear (latent)", -5.98770749823027),
                                    ("Holiyear (latent)", -5.294560317670324),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.98770749823027),
                                    ("Holika Dahanyear (latent)", -5.294560317670324),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.98770749823027),
                                    ("dayminute", -3.422758140768733),
                                    ("Mawlidyear (latent)", -5.98770749823027),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.582242390122105),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.98770749823027),
                                    ("Jumu'atul-Widayear (latent)", -5.071416766356115),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.98770749823027),
                                    ("minuteday", -2.3501213385038837),
                                    ("absorption of , after named dayintersect", -5.98770749823027),
                                    ("intersectyear (latent)", -5.98770749823027),
                                    ("Orthodox Easter Sundayyear (latent)", -5.98770749823027),
                                    ("<ordinal> <cycle> of <time>year (latent)", -5.98770749823027),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.98770749823027),
                                    ("Boss's Dayyear (latent)", -5.582242390122105),
                                    ("Tisha B'Avyear (latent)", -5.98770749823027),
                                    ("Isra and Mi'rajyear (latent)", -5.071416766356115),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.98770749823027),
                                    ("Christmasyear (latent)", -5.582242390122105),
                                    ("Naraka Chaturdashiyear (latent)", -5.582242390122105),
                                    ("at <time-of-day>on <date>", -4.88909520956216),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.378269585796169),
                                    ("dayweek", -5.98770749823027),
                                    ("Easter Sundayyear (latent)", -5.294560317670324),
                                    ("Thursday<time-of-day> am|pm", -5.98770749823027),
                                    ("weekyear", -5.582242390122105),
                                    ("hh:mmin|during the <part-of-day>", -5.294560317670324),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.582242390122105),
                                    ("Hanukkahyear (latent)", -5.98770749823027),
                                    ("February<time> <part-of-day>", -5.98770749823027),
                                    ("Tuesdayin <named-month>|year", -5.98770749823027),
                                    ("Great Lentyear (latent)", -5.98770749823027),
                                    ("tomorrowat <time-of-day>", -5.294560317670324),
                                    ("between <time> and <time>on <date>", -4.378269585796169),
                                    ("last <cycle> of <time>year (latent)", -5.294560317670324),
                                    ("at <time-of-day>tomorrow", -5.582242390122105),
                                    ("tomorrow<time-of-day> am|pm", -5.98770749823027),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.98770749823027),
                                    ("Diwaliyear (latent)", -5.98770749823027),
                                    ("Black Fridayyear (latent)", -5.582242390122105),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.98770749823027),
                                    ("Chhathyear (latent)", -5.582242390122105),
                                    ("Vasant Panchamiyear (latent)", -5.98770749823027),
                                    ("Palm Sundayintersect", -5.98770749823027),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.98770749823027),
                                    ("Februaryintersect", -5.98770749823027),
                                    ("Simchat Torahyear (latent)", -5.98770749823027)],
                               n = 297},
                   koData =
                     ClassData{prior = -0.9642999510605157, unseen = -6.345636360828596,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.73444252169223),
                                    ...
                                    ("Thursdayfrom|since|after <time>", -3.778931076664794),
                                    ...
                                    ("Thursday<time-of-day> am|pm", -5.245268145458221),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.16003651200451968,
                               unseen = -4.836281906951478,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -4.919024419077178e-2),
                                    ("intersect 2 numbers", -3.4420193761824103)],
                               n = 121},
                   koData =
                     ClassData{prior = -1.9113046198778378, unseen = -3.258096538021482,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6486954179891115, unseen = -4.290459441148391,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 69},
                   koData =
                     ClassData{prior = -0.7396671961948381, unseen = -4.204692619390966,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.28501895503229724,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("from|since|after <time>", -3.708682081410116),
       ...
       ("<time-of-day> - <time-of-day> (interval)",
        Classifier{okData =
                     ClassData{prior = -0.9343092373768334,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("from|since|after <time>hh:mm", -2.5336968139574325),
                                    ("minuteminute", -1.578185368929996),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -3.4499875458315876),
                                    ("hh:mmhh:mm", -1.9459101490553135),
                                    ("<time-of-day> am|pmtime-of-day (latent)",
                                     -2.5336968139574325),
                                    ("hourhour", -1.7452394535931621),
                               ...
                               n = 22},
                   koData =
                     ClassData{prior = -0.4989911661189879, unseen = -4.477336814478207,
                               likelihoods =
                                 HashMap.fromList
