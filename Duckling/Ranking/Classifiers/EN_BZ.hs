...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5066933864810801, unseen = -6.26530121273771,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.31748811353631),
                                    ("hourday", -3.8655029897932534),
                                    ("dayhour", -2.7370377379754625),
                                    ("daymonth", -4.877103901471733),
                                    ("monthday", -5.1647859739235145),
                                    ("monthyear", -3.960813169597578),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.570251082031678),
                                    ("Christmasyear", -5.570251082031678),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.570251082031678),
                                    ("houryear", -5.570251082031678),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.570251082031678),
                                    ("Marchyear", -5.570251082031678),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.1647859739235145),
                                    ("intersect<time-of-day> am|pm", -5.570251082031678),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.570251082031678),
                                    ("monthhour", -5.1647859739235145),
                                    ("last <day-of-week> of <time>year", -5.570251082031678),
                                    ("todayat <time-of-day>", -5.570251082031678),
                                    ("Thursday<time> timezone", -3.8655029897932534),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.570251082031678),
                                    ("dayday", -3.5553480614894135),
                                    ("<time> <part-of-day>at <time-of-day>", -5.570251082031678),
                                    ("Tuesdayin <named-month>", -5.570251082031678),
                                    ("tonightat <time-of-day>", -5.570251082031678),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.877103901471733),
                                    ("today<time-of-day> am|pm", -5.570251082031678),
                                    ("Februarythe <day-of-month> (ordinal)", -5.1647859739235145),
                                    ("at <time-of-day><time> <part-of-day>", -5.570251082031678),
                                    ("hourhour", -4.31748811353631),
                                    ("<time-of-day> am|pmon <date>", -3.5553480614894135),
                                    ("Wednesdaythis|last|next <cycle>", -5.570251082031678),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.0661736852554045),
                                    ("dayyear", -3.373026504695459),
                                    ("last weekend of <named-month>year", -5.570251082031678),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.570251082031678),
                                    ("Thursdayat <time-of-day>", -5.1647859739235145),
                                    ("<time-of-day> am|pmtomorrow", -4.877103901471733),
                                    ("minutehour", -4.653960350157523),
                                    ("Mother's Dayyear", -5.570251082031678),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.1647859739235145),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.8655029897932534),
                                    ("for <duration> from <time>December", -5.570251082031678),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.570251082031678),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.653960350157523),
                                    ("Mondayin|during the <part-of-day>", -5.570251082031678),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.1647859739235145),
                                    ("intersectin|during the <part-of-day>", -5.570251082031678),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -4.653960350157523),
                                    ("at <time-of-day>intersect", -5.1647859739235145),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.1647859739235145),
                                    ("<ordinal> <cycle> of <time>year", -5.570251082031678),
                                    ("minuteday", -2.104515179231952),
                                    ("absorption of , after named dayintersect",
                                     -5.570251082031678),
                                    ("Octoberyear", -4.31748811353631),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.570251082031678),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.570251082031678),
                                    ("year<time-of-day> am|pm", -5.570251082031678),
                                    ("Septemberyear", -5.1647859739235145),
                                    ("at <time-of-day>on <date>", -4.471638793363569),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.877103901471733),
                                    ("Halloweenyear", -5.570251082031678),
                                    ("dayweek", -5.570251082031678),
                                    ("Thursday<time-of-day> am|pm", -5.570251082031678),
                                    ("weekyear", -5.1647859739235145),
                                    ("hh:mmin|during the <part-of-day>", -4.877103901471733),
                                    ("Father's Dayyear", -5.570251082031678),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.1647859739235145),
                                    ("February<time> <part-of-day>", -5.570251082031678),
                                    ("Martin Luther King's Dayyear", -5.1647859739235145),
                                    ("tomorrowat <time-of-day>", -4.877103901471733),
                                    ("between <time> and <time>on <date>", -4.877103901471733),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.877103901471733),
                                    ("at <time-of-day>tomorrow", -5.1647859739235145),
                                    ("tomorrow<time-of-day> am|pm", -5.570251082031678),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.570251082031678),
                                    ("black fridayyear", -5.1647859739235145),
                                    ("Labor Dayyear", -5.570251082031678),
                                    ("Februaryintersect", -5.570251082031678),
                                    ("last <cycle> of <time>year", -4.877103901471733),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.570251082031678),
                                    ("yearminute", -5.570251082031678)],
                               n = 194},
                   koData =
                     ClassData{prior = -0.9225212816247912, unseen = -5.976350909297934,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.280662431309316),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.280662431309316),
                                    ("hourday", -5.280662431309316),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.280662431309316),
                                    ("dayhour", -3.029370632702821),
                                    ("daymonth", -3.20122088962948),
                                    ("monthday", -4.875197323201151),
                                    ("monthyear", -4.58751525074937),
                                    ("intersecthh:mm", -5.280662431309316),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.280662431309316),
                                    ("houryear", -5.280662431309316),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.280662431309316),
                                    ("until <time-of-day><time-of-day> am|pm", -5.280662431309316),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.58751525074937),
                                    ("<time-of-day> am|pmintersect", -4.027899462813948),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.364371699435161),
                                    ("from|since|after <time-of-day>on <date>", -4.364371699435161),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.280662431309316),
                                    ("absorption of , after named dayJuly", -4.875197323201151),
                                    ("monthhour", -5.280662431309316),
                                    ("hourmonth", -4.58751525074937),
                                    ("todayat <time-of-day>", -5.280662431309316),
                                    ("from|since|after <time-of-day>July", -5.280662431309316),
                                    ("dayday", -4.875197323201151),
                                    ("<time-of-day> am|pmon <date>", -4.027899462813948),
                                    ("Thursdaydd/mm", -5.280662431309316),
                                    ("dayyear", -4.027899462813948),
                                    ("Thursdayat <time-of-day>", -4.027899462813948),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.280662431309316),
                                    ("monthminute", -5.280662431309316),
                                    ("<time-of-day> am|pmtomorrow", -5.280662431309316),
                                    ("Thursdayhh:mm", -4.364371699435161),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.280662431309316),
                                    ("Fridayyear", -4.875197323201151),
                                    ("minutemonth", -3.488902962081261),
                                    ("Sundayfrom|since|after <time-of-day>", -5.280662431309316),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.875197323201151),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.875197323201151),
                                    ("Aprilyear", -5.280662431309316),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.280662431309316),
                                    ("<duration> after|before|from <time>December",
                                     -5.280662431309316),
                                    ("yesterday<time-of-day> am|pm", -5.280662431309316),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.280662431309316),
                                    ("this <time>six thirty six a.m.", -5.280662431309316),
                                    ("until <time-of-day>on <date>", -4.58751525074937),
                                    ("at <time-of-day>intersect", -4.875197323201151),
                                    ("Thursdaysix thirty six a.m.", -5.280662431309316),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.280662431309316),
                                    ("dayminute", -2.677972745864932),
                                    ("intersectSeptember", -3.776585034533042),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.280662431309316),
                                    ("minuteday", -2.362891699225037),
                                    ("absorption of , after named dayintersect",
                                     -5.280662431309316),
                                    ("Februaryin|during the <part-of-day>", -5.280662431309316),
                                    ("week-endin <named-month>", -5.280662431309316),
                                    ("Octoberyear", -5.280662431309316),
                                    ("from|since|after <time-of-day>year", -5.280662431309316),
                                    ("yearhh:mm", -5.280662431309316),
                                    ("hh:mmon <date>", -3.776585034533042),
                                    ...
                                    ("absorption of , after named daySeptember",
                                     -4.364371699435161),
                                    ("on <date>September", -4.875197323201151),
                                    ("at <time-of-day>on <date>", -4.875197323201151),
                                    ("dayweek", -5.280662431309316),
                                    ("Thursday<time-of-day> am|pm", -4.875197323201151),
                                    ("absorption of , after named dayFebruary", -4.364371699435161),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.280662431309316),
                                    ("tomorrowat <time-of-day>", -5.280662431309316),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.280662431309316),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.6712245188752157),
                                    ("tomorrow<time-of-day> am|pm", -5.280662431309316),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.280662431309316),
                                    ("yearminute", -5.280662431309316)],
                               n = 128}}),
