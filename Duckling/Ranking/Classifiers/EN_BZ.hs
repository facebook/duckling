...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5758104738554033, unseen = -5.641907070938114,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 280},
                   koData =
                     ClassData{prior = -0.8261050142355639, unseen = -5.393627546352362,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4805411345485214, unseen = -6.679599185844383,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -5.985194934094387),
                                    ("Ramadanyear (latent)", -5.985194934094387),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.732431965599019),
                                    ("Bhai Doojyear (latent)", -5.985194934094387),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.732431965599019),
                                    ("hourday", -4.280446841855961),
                                    ("dayhour", -3.181834553187852),
                                    ("Martin Luther King's Dayyear (latent)", -5.579729825986222),
                                    ("Shemini Atzeretyear (latent)", -5.985194934094387),
                                    ("daymonth", -5.292047753534441),
                                    ("monthday", -5.579729825986222),
                                    ("monthyear", -4.375757021660286),
                                    ("Yom Ha'atzmautyear (latent)", -5.985194934094387),
                                    ("Vijayadashamiyear (latent)", -5.985194934094387),
                                    ("Thai Pongalyear (latent)", -5.292047753534441),
                                    ("Thiru Onamyear (latent)", -5.292047753534441),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.985194934094387),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.985194934094387),
                                    ("houryear", -5.292047753534441),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.985194934094387),
                                    ("Christmas<time-of-day> am|pm", -5.985194934094387),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.985194934094387),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.292047753534441),
                                    ("<time-of-day> am|pmintersect", -4.732431965599019),
                                    ("Earth Houryear (latent)", -5.985194934094387),
                                    ("Octoberyear (latent)", -4.732431965599019),
                                    ("intersect<time-of-day> am|pm", -5.985194934094387),
                                    ("Mattu Pongalyear (latent)", -5.985194934094387),
                                    ("Shavuotyear (latent)", -5.985194934094387),
                                    ("Dhanterasin <named-month>|year", -5.985194934094387),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.985194934094387),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.985194934094387),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.579729825986222),
                                    ("Marchyear (latent)", -5.985194934094387),
                                    ("Sukkotyear (latent)", -5.579729825986222),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.985194934094387),
                                    ("Clean Mondayyear (latent)", -5.579729825986222),
                                    ("monthhour", -5.579729825986222),
                                    ("todayat <time-of-day>", -5.985194934094387),
                                    ("Thursday<time> timezone", -4.280446841855961),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.985194934094387),
                                    ("Palm SundaySunday", -5.579729825986222),
                                    ("dayday", -3.787970356758167),
                                    ("<time> <part-of-day>at <time-of-day>", -5.985194934094387),
                                    ("tonightat <time-of-day>", -5.985194934094387),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.292047753534441),
                                    ("today<time-of-day> am|pm", -5.985194934094387),
                                    ("Februarythe <day-of-month> (ordinal)", -5.579729825986222),
                                    ("at <time-of-day><time> <part-of-day>", -5.985194934094387),
                                    ("hourhour", -4.732431965599019),
                                    ("<time-of-day> am|pmon <date>", -3.970291913552122),
                                    ("Wednesdaythis|last|next <cycle>", -5.985194934094387),
                                    ("Lentyear (latent)", -5.985194934094387),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.481117537318113),
                                    ("Boghiyear (latent)", -5.985194934094387),
                                    ("dayyear", -2.033951215512959),
                                    ("Thursdayfrom|since|after <time>", -5.579729825986222),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.985194934094387),
                                    ("Thursdayat <time-of-day>", -5.579729825986222),
                                    ("Islamic New Yearyear (latent)", -5.579729825986222),
                                    ("Laylat al-Qadryear (latent)", -5.0689042022202315),
                                    ("Chhathin <named-month>|year", -5.985194934094387),
                                    ("Vasant Panchamiin <named-month>|year", -5.985194934094387),
                                    ("Diwaliin <named-month>|year", -5.985194934094387),
                                    ("Shrove Tuesdayyear (latent)", -5.985194934094387),
                                    ("<time-of-day> am|pmtomorrow", -5.292047753534441),
                                    ("Yom Kippuryear (latent)", -5.985194934094387),
                                    ("<part-of-day> of <time>year (latent)", -5.985194934094387),
                                    ("minutehour", -5.0689042022202315),
                                    ("Kaanum Pongalyear (latent)", -5.579729825986222),
                                    ("Maha Saptamiyear (latent)", -5.985194934094387),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.579729825986222),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.280446841855961),
                                    ("for <duration> from <time>December", -5.985194934094387),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.985194934094387),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.0689042022202315),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.579729825986222),
                                    ("Pentecostyear (latent)", -5.985194934094387),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.0689042022202315),
                                    ("Eid al-Fitryear (latent)", -5.985194934094387),
                                    ("Mondayin|during the <part-of-day>", -5.985194934094387),
                                    ("Raksha Bandhanyear (latent)", -5.985194934094387),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.579729825986222),
                                    ("Navaratriin <named-month>|year", -5.985194934094387),
                                    ("Ashurayear (latent)", -5.985194934094387),
                                    ("Chinese New Yearyear (latent)", -5.985194934094387),
                                    ("Sundayyear (latent)", -5.985194934094387),
                                    ("Lag BaOmeryear (latent)", -5.985194934094387),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.985194934094387),
                                    ("Eid al-Adhayear (latent)", -5.0689042022202315),
                                    ("intersectin|during the <part-of-day>", -5.985194934094387),
                                    ("Christmasat <time-of-day>", -5.985194934094387),
                                    ("Passoveryear (latent)", -5.985194934094387),
                                    ("Lazarus Saturdayyear (latent)", -5.985194934094387),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.985194934094387),
                                    ("Yom HaShoahyear (latent)", -5.579729825986222),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.579729825986222),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.985194934094387),
                                    ("Thai Pongalin <named-month>|year", -5.985194934094387),
                                    ("Septemberyear (latent)", -5.579729825986222),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.732431965599019),
                                    ("Halloweenyear (latent)", -5.985194934094387),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.985194934094387),
                                    ("Dhanterasyear (latent)", -5.985194934094387),
                                    ("Tu BiShvatyear (latent)", -5.985194934094387),
                                    ("Holiyear (latent)", -5.292047753534441),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.985194934094387),
                                    ("Holika Dahanyear (latent)", -5.292047753534441),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.985194934094387),
                                    ("dayminute", -3.42024557663285),
                                    ("Mawlidyear (latent)", -5.985194934094387),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.579729825986222),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.985194934094387),
                                    ("Jumu'atul-Widayear (latent)", -5.0689042022202315),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.985194934094387),
                                    ("minuteday", -2.347608774368001),
                                    ("absorption of , after named dayintersect",
                                     -5.985194934094387),
                                    ("intersectyear (latent)", -5.985194934094387),
                                    ("Orthodox Easter Sundayyear (latent)", -5.985194934094387),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.985194934094387),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.985194934094387),
                                    ("Boss's Dayyear (latent)", -5.579729825986222),
                                    ("Global Youth Service Dayyear (latent)", -5.985194934094387),
                                    ("Tisha B'Avyear (latent)", -5.985194934094387),
                                    ("Isra and Mi'rajyear (latent)", -5.0689042022202315),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.985194934094387),
                                    ("Christmasyear (latent)", -5.579729825986222),
                                    ("Naraka Chaturdashiyear (latent)", -5.579729825986222),
                                    ("at <time-of-day>on <date>", -4.886582645426277),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.375757021660286),
                                    ("dayweek", -5.985194934094387),
                                    ("Easter Sundayyear (latent)", -5.292047753534441),
                                    ("weekyear", -5.579729825986222),
                                    ("hh:mmin|during the <part-of-day>", -5.292047753534441),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.579729825986222),
                                    ("Hanukkahyear (latent)", -5.985194934094387),
                                    ("February<time> <part-of-day>", -5.985194934094387),
                                    ("Tuesdayin <named-month>|year", -5.985194934094387),
                                    ("Great Lentyear (latent)", -5.985194934094387),
                                    ("tomorrowat <time-of-day>", -5.292047753534441),
                                    ("between <time> and <time>on <date>", -4.375757021660286),
                                    ("last <cycle> of <time>year (latent)", -5.292047753534441),
                                    ("at <time-of-day>tomorrow", -5.579729825986222),
                                    ("tomorrow<time-of-day> am|pm", -5.985194934094387),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.985194934094387),
                                    ("Diwaliyear (latent)", -5.985194934094387),
                                    ("Black Fridayyear (latent)", -5.579729825986222),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.985194934094387),
                                    ("Chhathyear (latent)", -5.579729825986222),
                                    ("Vasant Panchamiyear (latent)", -5.985194934094387),
                                    ("Palm Sundayintersect", -5.985194934094387),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.985194934094387),
                                    ("Februaryintersect", -5.985194934094387),
                                    ("Simchat Torahyear (latent)", -5.985194934094387),
                                    ("minuteyear", -5.985194934094387)],
                               n = 295},
                   koData =
                     ClassData{prior = -0.9635098038115459, unseen = -6.345636360828596,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.73444252169223),
                                    ("hourday", -4.73444252169223),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.6507332535663855),
                                    ("dayhour", -3.208386218197181),
                                    ("Tuesdayfrom|since|after <time>", -5.6507332535663855),
                                    ("daymonth", -3.5106670900701147),
                                    ("monthday", -5.245268145458221),
                                    ...
                                    ("week-endin <named-month>|year", -5.6507332535663855),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.6507332535663855),
                                    ("Sundayyear (latent)", -4.95758607300644),
                                    ("Christmasat <time-of-day>", -5.6507332535663855),
                                    ("from|since|after <time>year (latent)", -4.397970285071017),
                                    ...
                                    ("in <named-month>|yearyear (latent)", -5.6507332535663855),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.15762894420358317,
                               ...
                               n = 123},
                   koData =
                     ClassData{prior = -1.9252908618525775, unseen = -3.258096538021482,
                               likelihoods =
                                 HashMap.fromList
