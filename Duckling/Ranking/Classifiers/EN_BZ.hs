...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6583610644745297,
                               unseen = -5.4638318050256105,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 234},
                   koData =
                     ClassData{prior = -0.7291871170431422, unseen = -5.393627546352362,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.49077869182069994, unseen = -6.55250788703459,
                               likelihoods =
                                 HashMap.fromList
                                   [("Ramadanyear (latent)", -5.857933154483459),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.605170185988091),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.605170185988091),
                                    ("hourday", -4.153185062245034), ("dayhour", -2.94016242239918),
                                    ("Martin Luther King's Dayyear (latent)", -5.452468046375295),
                                    ("Shemini Atzeretyear (latent)", -5.857933154483459),
                                    ("daymonth", -5.1647859739235145),
                                    ("monthday", -5.452468046375295),
                                    ("monthyear", -4.248495242049359),
                                    ("Yom Ha'atzmautyear (latent)", -5.857933154483459),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.857933154483459),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.857933154483459),
                                    ("houryear", -5.452468046375295),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.857933154483459),
                                    ("Christmas<time-of-day> am|pm", -5.857933154483459),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.857933154483459),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.1647859739235145),
                                    ("<time-of-day> am|pmintersect", -4.605170185988091),
                                    ("Octoberyear (latent)", -4.605170185988091),
                                    ("intersect<time-of-day> am|pm", -5.857933154483459),
                                    ("Shavuotyear (latent)", -5.857933154483459),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.857933154483459),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.452468046375295),
                                    ("Marchyear (latent)", -5.857933154483459),
                                    ("Sukkotyear (latent)", -5.452468046375295),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.857933154483459),
                                    ("Clean Mondayyear (latent)", -5.452468046375295),
                                    ("monthhour", -5.452468046375295),
                                    ("todayat <time-of-day>", -5.857933154483459),
                                    ("Thursday<time> timezone", -4.153185062245034),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.857933154483459),
                                    ("Palm SundaySunday", -5.452468046375295),
                                    ("dayday", -3.66070857714724),
                                    ("<time> <part-of-day>at <time-of-day>", -5.857933154483459),
                                    ("tonightat <time-of-day>", -5.857933154483459),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.1647859739235145),
                                    ("today<time-of-day> am|pm", -5.857933154483459),
                                    ("Februarythe <day-of-month> (ordinal)", -5.452468046375295),
                                    ("at <time-of-day><time> <part-of-day>", -5.857933154483459),
                                    ("hourhour", -4.605170185988091),
                                    ("<time-of-day> am|pmon <date>", -3.8430301339411947),
                                    ("Wednesdaythis|last|next <cycle>", -5.857933154483459),
                                    ("Lentyear (latent)", -5.857933154483459),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.353855757707185),
                                    ("dayyear", -2.316973830446145),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.857933154483459),
                                    ("Thursdayat <time-of-day>", -5.452468046375295),
                                    ("Islamic New Yearyear (latent)", -5.452468046375295),
                                    ("Laylat al-Qadryear (latent)", -4.941642422609305),
                                    ("Shrove Tuesdayyear (latent)", -5.857933154483459),
                                    ("<time-of-day> am|pmtomorrow", -5.1647859739235145),
                                    ("Yom Kippuryear (latent)", -5.857933154483459),
                                    ("<part-of-day> of <time>year (latent)", -5.857933154483459),
                                    ("minutehour", -4.941642422609305),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.452468046375295),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.153185062245034),
                                    ("for <duration> from <time>December", -5.857933154483459),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.857933154483459),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.941642422609305),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.452468046375295),
                                    ("Pentecostyear (latent)", -5.857933154483459),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.941642422609305),
                                    ("Eid al-Fitryear (latent)", -5.857933154483459),
                                    ("Mondayin|during the <part-of-day>", -5.857933154483459),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.452468046375295),
                                    ("Ashurayear (latent)", -5.857933154483459),
                                    ("Chinese New Yearyear (latent)", -5.857933154483459),
                                    ("Sundayyear (latent)", -5.857933154483459),
                                    ("Lag BaOmeryear (latent)", -5.857933154483459),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.857933154483459),
                                    ("Eid al-Adhayear (latent)", -4.941642422609305),
                                    ("intersectin|during the <part-of-day>", -5.857933154483459),
                                    ("Christmasat <time-of-day>", -5.857933154483459),
                                    ("Passoveryear (latent)", -5.857933154483459),
                                    ("Lazarus Saturdayyear (latent)", -5.857933154483459),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.857933154483459),
                                    ("Yom HaShoahyear (latent)", -5.452468046375295),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.941642422609305),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.857933154483459),
                                    ("Septemberyear (latent)", -5.452468046375295),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.605170185988091),
                                    ("Halloweenyear (latent)", -5.857933154483459),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.1647859739235145),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -4.941642422609305),
                                    ("at <time-of-day>intersect", -5.452468046375295),
                                    ("Rosh Hashanahyear (latent)", -5.857933154483459),
                                    ("Tu BiShvatyear (latent)", -5.857933154483459),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.857933154483459),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.857933154483459),
                                    ("dayminute", -3.2929837970219227),
                                    ("Mawlidyear (latent)", -5.857933154483459),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.452468046375295),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.857933154483459),
                                    ("Jumu'atul-Widayear (latent)", -4.941642422609305),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.857933154483459),
                                    ("minuteday", -2.2203469947570738),
                                    ("absorption of , after named dayintersect",
                                     -5.857933154483459),
                                    ("intersectyear (latent)", -5.857933154483459),
                                    ("Orthodox Easter Sundayyear (latent)", -5.857933154483459),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.857933154483459),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.857933154483459),
                                    ("Boss's Dayyear (latent)", -5.452468046375295),
                                    ("Tisha B'Avyear (latent)", -5.857933154483459),
                                    ("Isra and Mi'rajyear (latent)", -4.941642422609305),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.857933154483459),
                                    ("Christmasyear (latent)", -5.452468046375295),
                                    ("at <time-of-day>on <date>", -4.75932086581535),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.248495242049359),
                                    ("dayweek", -5.857933154483459),
                                    ("Easter Sundayyear (latent)", -5.1647859739235145),
                                    ("Thursday<time-of-day> am|pm", -5.857933154483459),
                                    ("weekyear", -5.452468046375295),
                                    ("hh:mmin|during the <part-of-day>", -5.1647859739235145),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.452468046375295),
                                    ("Hanukkahyear (latent)", -5.857933154483459),
                                    ("February<time> <part-of-day>", -5.857933154483459),
                                    ("Tuesdayin <named-month>|year", -5.857933154483459),
                                    ("Great Lentyear (latent)", -5.857933154483459),
                                    ("tomorrowat <time-of-day>", -5.1647859739235145),
                                    ("between <time> and <time>on <date>", -4.248495242049359),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.1647859739235145),
                                    ("last <cycle> of <time>year (latent)", -5.1647859739235145),
                                    ("at <time-of-day>tomorrow", -5.452468046375295),
                                    ("tomorrow<time-of-day> am|pm", -5.857933154483459),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.857933154483459),
                                    ("Black Fridayyear (latent)", -5.452468046375295),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.857933154483459),
                                    ("Palm Sundayintersect", -5.857933154483459),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.857933154483459),
                                    ("Februaryintersect", -5.857933154483459),
                                    ("Simchat Torahyear (latent)", -5.857933154483459)],
                               n = 262},
                   koData =
                     ClassData{prior = -0.9471354072252536,
                               unseen = -6.2324480165505225,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.537334267018537),
                                    ("hourday", -5.537334267018537),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.537334267018537),
                                    ("dayhour", -3.2347491740244907),
                                    ("daymonth", -3.457892725338701),
                                    ("monthday", -5.131869158910372),
                                    ("monthyear", -4.2845712985231685),
                                    ("<time-of-day> am|pmyear (latent)", -5.131869158910372),
                                    ("intersecthh:mm", -5.537334267018537),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.537334267018537),
                                    ("houryear", -4.6210435351443815),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.537334267018537),
                                    ("until <time-of-day><time-of-day> am|pm", -5.537334267018537),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.844187086458591),
                                    ("<time-of-day> am|pmintersect", -4.2845712985231685),
                                    ("Octoberyear (latent)", -5.537334267018537),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.537334267018537),
                                    ("absorption of , after named dayJuly", -5.131869158910372),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.6210435351443815),
                                    ("Clean Mondayyear (latent)", -5.537334267018537),
                                    ("monthhour", -5.537334267018537),
                                    ("hourmonth", -4.844187086458591),
                                    ("todayat <time-of-day>", -5.537334267018537),
                                    ("from|since|after <time-of-day>July", -5.537334267018537),
                                    ("Mondayyear (latent)", -4.844187086458591),
                                    ("dayday", -5.131869158910372),
                                    ("<time-of-day> am|pmon <date>", -4.2845712985231685),
                                    ("Thursdaydd/mm", -5.537334267018537),
                                    ("dayyear", -2.7964942430933357),
                                    ("New Year's Dayyear (latent)", -5.131869158910372),
                                    ("Thursdayat <time-of-day>", -4.2845712985231685),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.537334267018537),
                                    ("Aprilyear (latent)", -5.537334267018537),
                                    ("monthminute", -5.537334267018537),
                                    ("<time-of-day> am|pmtomorrow", -5.537334267018537),
                                    ("Thursdayhh:mm", -4.6210435351443815),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.537334267018537),
                                    ("minutemonth", -3.7455747977904816),
                                    ("Sundayfrom|since|after <time-of-day>", -5.537334267018537),
                                    ("week-endin <named-month>|year", -5.537334267018537),
                                    ("Augustyear (latent)", -5.131869158910372),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.131869158910372),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.131869158910372),
                                    ...
                                    ("Christmasat <time-of-day>", -5.537334267018537),
                                    ("<duration> after|before|from <time>December",
                                     -5.537334267018537),
                                    ("yesterday<time-of-day> am|pm", -5.537334267018537),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.537334267018537),
                                    ("until <time-of-day>on <date>", -4.844187086458591),
                                    ("at <time-of-day>intersect", -5.131869158910372),
                                    ("hh:mmyear (latent)", -4.438721978350427),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.537334267018537),
                                    ("dayminute", -3.0949872316493323),
                                    ("intersectSeptember", -4.033256870242263),
                                    ("minuteday", -2.4692813318849196),
                                    ("absorption of , after named dayintersect",
                                     -5.537334267018537),
                                    ("Februaryin|during the <part-of-day>", -5.537334267018537),
                                    ("hh:mmon <date>", -3.522431246476272),
                                    ("Saturdayyear (latent)", -5.537334267018537),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.537334267018537),
                                    ("absorption of , after named daySeptember",
                                     -4.6210435351443815),
                                    ("on <date>September", -5.131869158910372),
                                    ("at <time-of-day>on <date>", -5.131869158910372),
                                    ("in <named-month>|yearyear (latent)", -5.537334267018537),
                                    ("dayweek", -5.537334267018537),
                                    ("Easter Sundayyear (latent)", -5.131869158910372),
                                    ("Thursday<time-of-day> am|pm", -5.131869158910372),
                                    ...
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.537334267018537),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.927896354584436),
                                    ("tomorrow<time-of-day> am|pm", -5.537334267018537),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.844187086458591),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.537334267018537),
                                    ("Fridayyear (latent)", -5.131869158910372),
                                    ("minuteyear", -4.2845712985231685)],
                               n = 166}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.5596157879354228, unseen = -4.276666119016055,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 68},
                   koData =
                     ClassData{prior = -0.8472978603872037, unseen = -4.007333185232471,
                               likelihoods =
                                 HashMap.fromList
