...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.456887094343264, unseen = -7.204892510204673,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.511002111475994),
                                    ...
                                    ("Family Dayyear (latent)", -5.594711379601839),
                                    ...
                                    ("dayday", -3.802951910373784),
                                    ("<time> <part-of-day>at <time-of-day>", -6.10553700336783),
                                    ("mm/ddat <time-of-day>", -6.511002111475994),
                                    ...
                                    ("mm/dd<time-of-day> am|pm", -6.511002111475994),
                                    ...
                                    ("National Patriots' Dayyear (latent)", -5.817854930916049),
                                    ...
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.10553700336783),
                                    ("Labour Dayyear (latent)", -6.511002111475994),
                                    ...
                                    ("Mother's Dayyear (latent)", -6.511002111475994),
                                    ("Simchat Torahyear (latent)", -6.511002111475994),
                                    ("Victoria Dayyear (latent)", -6.10553700336783),
                                    ("minuteyear", -6.511002111475994)],
                               n = 518},
                   koData =
                     ClassData{prior = -1.003079861946546, unseen = -6.813444599510896,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.61512051684126),
                                    ("hourday", -3.721302640819163),
                                    ...
                                    ("Good Fridayyear (latent)", -5.713732805509369),
                                    ...
                                    ("dayday", -4.104294893075269),
                                    ("mm/ddat <time-of-day>", -5.713732805509369),
                                    ("on <day>September", -5.426050733057588),
                                    ("time-of-day (latent)September", -5.713732805509369),
                                    ("hourhour", -4.039756371937697),
                                    ("time-of-day (latent)on <day>", -4.61512051684126),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.713732805509369),
                                    ("dayyear", -3.0746754758941104),
                                    ("Thursdaymm/dd", -6.119197913617533),
                                    ...
                                    ("the <day-of-month> (ordinal)Monday", -5.426050733057588),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.119197913617533),
                                    ("mm/ddyear (latent)", -6.119197913617533),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.119197913617533),
                                    ...
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.119197913617533),
                                    ("<day-of-month> (ordinal)Monday", -5.202907181743378),
                                    ...
                                    ("Fridayin|during <named-month>|year", -6.119197913617533),
                                    ...
                                    ("Fridayyear (latent)", -5.202907181743378),
