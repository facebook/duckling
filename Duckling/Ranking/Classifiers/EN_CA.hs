...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6476848064831879, unseen = -5.605802066295998,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 270},
                   koData =
                     ClassData{prior = -0.7407752295491999,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4586518151012465, unseen = -6.684611727667927,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -5.990213765206329),
                                    ("Father's Dayyear (latent)", -5.990213765206329),
                                    ("Ramadanyear (latent)", -5.990213765206329),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.737450796710961),
                                    ("Bhai Doojyear (latent)", -5.990213765206329),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.737450796710961),
                                    ("hourday", -4.285465672967904),
                                    ("dayhour", -3.0724430331220502),
                                    ("Martin Luther King's Dayyear (latent)", -5.584748657098165),
                                    ("Shemini Atzeretyear (latent)", -5.990213765206329),
                                    ("daymonth", -5.297066584646384),
                                    ("monthday", -5.584748657098165),
                                    ("monthyear", -4.380775852772229),
                                    ("Yom Ha'atzmautyear (latent)", -5.990213765206329),
                                    ("Vijayadashamiyear (latent)", -5.990213765206329),
                                    ("Thanksgiving Dayyear (latent)", -4.89160147653822),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.990213765206329),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.990213765206329),
                                    ("houryear", -5.297066584646384),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.990213765206329),
                                    ("Christmas<time-of-day> am|pm", -5.990213765206329),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.990213765206329),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.297066584646384),
                                    ("<time-of-day> am|pmintersect", -4.737450796710961),
                                    ("Family Dayyear (latent)", -5.073923033332174),
                                    ("Octoberyear (latent)", -4.737450796710961),
                                    ("intersect<time-of-day> am|pm", -5.990213765206329),
                                    ("Shavuotyear (latent)", -5.990213765206329),
                                    ("Dhanterasin <named-month>|year", -5.990213765206329),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.990213765206329),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.990213765206329),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.584748657098165),
                                    ("Marchyear (latent)", -5.990213765206329),
                                    ("Sukkotyear (latent)", -5.584748657098165),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.990213765206329),
                                    ("Clean Mondayyear (latent)", -5.584748657098165),
                                    ("monthhour", -5.584748657098165),
                                    ("todayat <time-of-day>", -5.990213765206329),
                                    ("Thursday<time> timezone", -4.285465672967904),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.990213765206329),
                                    ("Palm SundaySunday", -5.584748657098165),
                                    ("dayday", -3.79298918787011),
                                    ("<time> <part-of-day>at <time-of-day>", -5.990213765206329),
                                    ("mm/ddat <time-of-day>", -5.990213765206329),
                                    ("tonightat <time-of-day>", -5.990213765206329),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.297066584646384),
                                    ("today<time-of-day> am|pm", -5.990213765206329),
                                    ("Februarythe <day-of-month> (ordinal)", -5.584748657098165),
                                    ("at <time-of-day><time> <part-of-day>", -5.990213765206329),
                                    ("mm/dd<time-of-day> am|pm", -5.990213765206329),
                                    ("hourhour", -4.737450796710961),
                                    ("<time-of-day> am|pmon <date>", -3.9753107446640645),
                                    ("National Patriots' Dayyear (latent)", -5.297066584646384),
                                    ("Wednesdaythis|last|next <cycle>", -5.990213765206329),
                                    ("Lentyear (latent)", -5.990213765206329),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.4861363684300555),
                                    ("dayyear", -2.0486319575366387),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.990213765206329),
                                    ("Thursdayat <time-of-day>", -5.584748657098165),
                                    ("Islamic New Yearyear (latent)", -5.584748657098165),
                                    ("Laylat al-Qadryear (latent)", -5.073923033332174),
                                    ("Chhathin <named-month>|year", -5.990213765206329),
                                    ("Diwaliin <named-month>|year", -5.990213765206329),
                                    ("Discovery Dayyear (latent)", -5.584748657098165),
                                    ("Shrove Tuesdayyear (latent)", -5.990213765206329),
                                    ("<time-of-day> am|pmtomorrow", -5.297066584646384),
                                    ("Yom Kippuryear (latent)", -5.990213765206329),
                                    ("<part-of-day> of <time>year (latent)", -5.990213765206329),
                                    ("minutehour", -5.073923033332174),
                                    ("Maha Saptamiyear (latent)", -5.990213765206329),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.584748657098165),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.285465672967904),
                                    ("for <duration> from <time>December", -5.990213765206329),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.990213765206329),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.073923033332174),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.584748657098165),
                                    ("Pentecostyear (latent)", -5.990213765206329),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.073923033332174),
                                    ("Eid al-Fitryear (latent)", -5.990213765206329),
                                    ("Mondayin|during the <part-of-day>", -5.990213765206329),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.584748657098165),
                                    ("Navaratriin <named-month>|year", -5.990213765206329),
                                    ("Ashurayear (latent)", -5.990213765206329),
                                    ("Chinese New Yearyear (latent)", -5.990213765206329),
                                    ("Sundayyear (latent)", -5.990213765206329),
                                    ("Lag BaOmeryear (latent)", -5.990213765206329),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.990213765206329),
                                    ("Eid al-Adhayear (latent)", -5.073923033332174),
                                    ("intersectin|during the <part-of-day>", -5.990213765206329),
                                    ("Christmasat <time-of-day>", -5.990213765206329),
                                    ("Passoveryear (latent)", -5.990213765206329),
                                    ("Lazarus Saturdayyear (latent)", -5.990213765206329),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.990213765206329),
                                    ("Yom HaShoahyear (latent)", -5.584748657098165),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.073923033332174),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.990213765206329),
                                    ("Septemberyear (latent)", -5.584748657098165),
                                    ("mm/ddyear (latent)", -5.990213765206329),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.737450796710961),
                                    ("Halloweenyear (latent)", -5.990213765206329),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.990213765206329),
                                    ("Dhanterasyear (latent)", -5.990213765206329),
                                    ("Tu BiShvatyear (latent)", -5.990213765206329),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.990213765206329),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.990213765206329),
                                    ("dayminute", -3.351156435591071),
                                    ("Mawlidyear (latent)", -5.990213765206329),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.584748657098165),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.990213765206329),
                                    ("Jumu'atul-Widayear (latent)", -5.073923033332174),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.990213765206329),
                                    ("minuteday", -2.3526276054799435),
                                    ("absorption of , after named dayintersect",
                                     -5.990213765206329),
                                    ("intersectyear (latent)", -5.990213765206329),
                                    ("Orthodox Easter Sundayyear (latent)", -5.990213765206329),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.990213765206329),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.990213765206329),
                                    ("Boss's Dayyear (latent)", -5.584748657098165),
                                    ("Tisha B'Avyear (latent)", -5.990213765206329),
                                    ("Isra and Mi'rajyear (latent)", -5.073923033332174),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.990213765206329),
                                    ("Christmasyear (latent)", -5.584748657098165),
                                    ("Naraka Chaturdashiyear (latent)", -5.584748657098165),
                                    ("at <time-of-day>on <date>", -4.89160147653822),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.380775852772229),
                                    ("dayweek", -5.990213765206329),
                                    ("Easter Sundayyear (latent)", -5.297066584646384),
                                    ("Thursday<time-of-day> am|pm", -5.990213765206329),
                                    ("Labour Dayyear (latent)", -5.990213765206329),
                                    ("weekyear", -5.584748657098165),
                                    ("hh:mmin|during the <part-of-day>", -5.297066584646384),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.584748657098165),
                                    ("Hanukkahyear (latent)", -5.990213765206329),
                                    ("February<time> <part-of-day>", -5.990213765206329),
                                    ("Tuesdayin <named-month>|year", -5.990213765206329),
                                    ("Great Lentyear (latent)", -5.990213765206329),
                                    ("tomorrowat <time-of-day>", -5.297066584646384),
                                    ("between <time> and <time>on <date>", -4.380775852772229),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.297066584646384),
                                    ("last <cycle> of <time>year (latent)", -5.297066584646384),
                                    ("at <time-of-day>tomorrow", -5.584748657098165),
                                    ("tomorrow<time-of-day> am|pm", -5.990213765206329),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.990213765206329),
                                    ("Diwaliyear (latent)", -5.990213765206329),
                                    ("Black Fridayyear (latent)", -5.584748657098165),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.990213765206329),
                                    ("Chhathyear (latent)", -5.584748657098165),
                                    ("Palm Sundayintersect", -5.990213765206329),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.990213765206329),
                                    ("Februaryintersect", -5.990213765206329),
                                    ("Mother's Dayyear (latent)", -5.990213765206329),
                                    ("Simchat Torahyear (latent)", -5.990213765206329),
                                    ("Victoria Dayyear (latent)", -5.584748657098165)],
                               n = 299},
                   koData =
                     ClassData{prior = -1.000040089277404, unseen = -6.309918278226516,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.614951260949585),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.17229999833293566,
                               ...
                               n = 117},
                   koData =
                     ClassData{prior = -1.843431479772376, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
