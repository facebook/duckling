...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5667332557042866, unseen = -6.1779441140506,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 480},
                   koData =
                     ClassData{prior = -0.837886026204857, unseen = -5.908082938168931,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4535756516033265, unseen = -7.19668657083435,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.502790045915623),
                                    ("Father's Dayyear (latent)", -6.502790045915623),
                                    ("Karva Chauthyear (latent)", -6.502790045915623),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.502790045915623),
                                    ("Maha Shivaratriyear (latent)", -6.502790045915623),
                                    ("Ramadanyear (latent)", -5.250027077420255),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.1164956847957335),
                                    ("Bhai Doojyear (latent)", -6.502790045915623),
                                    ("hourday", -4.487887025373359),
                                    ("dayhour", -3.458267608192201),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.1164956847957335),
                                    ("Martin Luther King's Dayyear (latent)", -6.09732493780746),
                                    ("Shemini Atzeretyear (latent)", -6.502790045915623),
                                    ("daymonth", -4.487887025373359),
                                    ("monthday", -6.09732493780746),
                                    ("monthyear", -4.711030576687569),
                                    ("Yom Ha'atzmautyear (latent)", -6.502790045915623),
                                    ("Vijayadashamiyear (latent)", -6.502790045915623),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -6.09732493780746),
                                    ("Thanksgiving Dayyear (latent)", -5.404177757247514),
                                    ("Thai Pongalyear (latent)", -5.809642865355679),
                                    ("Thiru Onamyear (latent)", -5.809642865355679),
                                    ("hhhmmabsorption of , after named day", -6.502790045915623),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.502790045915623),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.586499314041468),
                                    ("<day-of-month> (ordinal)Wednesday", -6.502790045915623),
                                    ("Krishna Janmashtamiyear (latent)", -6.09732493780746),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.502790045915623),
                                    ("houryear", -5.586499314041468),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.502790045915623),
                                    ("Christmas<time-of-day> am|pm", -6.502790045915623),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.502790045915623),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.809642865355679),
                                    ("intersectin|during <named-month>|year", -6.502790045915623),
                                    ("<time-of-day> am|pmintersect", -5.250027077420255),
                                    ("Earth Houryear (latent)", -6.502790045915623),
                                    ("Ganesh Chaturthiyear (latent)", -6.502790045915623),
                                    ("Family Dayyear (latent)", -5.586499314041468),
                                    ("Octoberyear (latent)", -4.99871264913935),
                                    ("intersect<time-of-day> am|pm", -6.502790045915623),
                                    ("Mattu Pongalyear (latent)", -6.502790045915623),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.502790045915623),
                                    ("Shavuotyear (latent)", -6.502790045915623),
                                    ("Parsi New Yearyear (latent)", -5.586499314041468),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.502790045915623),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.502790045915623),
                                    ("todayin|within|after <duration>", -6.502790045915623),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.09732493780746),
                                    ("Marchyear (latent)", -6.502790045915623),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.09732493780746),
                                    ("Sukkotyear (latent)", -6.09732493780746),
                                    ("hhhmmintersect", -6.09732493780746),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.09732493780746),
                                    ("Clean Mondayyear (latent)", -6.09732493780746),
                                    ("monthhour", -6.09732493780746),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.809642865355679),
                                    ("todayat <time-of-day>", -6.502790045915623),
                                    ("Thursday<time> timezone", -4.104894773117253),
                                    ("tonight<time-of-day> am|pm", -6.502790045915623),
                                    ("time-of-day (latent)tonight", -6.09732493780746),
                                    ("from|since|after <time>December", -6.502790045915623),
                                    ("<time-of-day> am|pmon <day>", -4.487887025373359),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.502790045915623),
                                    ("yyyy-mm-ddhh:mm:ss", -6.09732493780746),
                                    ("dayday", -3.7947398448134138),
                                    ("<time> <part-of-day>at <time-of-day>", -6.09732493780746),
                                    ("mm/ddat <time-of-day>", -6.502790045915623),
                                    ("tonightat <time-of-day>", -5.809642865355679),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.809642865355679),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.502790045915623),
                                    ("today<time-of-day> am|pm", -6.502790045915623),
                                    ("Februarythe <day-of-month> (ordinal)", -6.09732493780746),
                                    ("at <time-of-day><time> <part-of-day>", -6.502790045915623),
                                    ("<day-of-month> (ordinal)intersect", -6.09732493780746),
                                    ("mm/dd<time-of-day> am|pm", -6.502790045915623),
                                    ("hourhour", -3.612418288019459),
                                    ("Mahavir Jayantiyear (latent)", -6.09732493780746),
                                    ("Navaratriin|during <named-month>|year", -6.502790045915623),
                                    ("National Patriots' Dayyear (latent)", -5.809642865355679),
                                    ("Wednesdaythis|last|next <cycle>", -6.502790045915623),
                                    ("Lentyear (latent)", -6.502790045915623),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.6309878690140325),
                                    ("Boghiyear (latent)", -6.502790045915623),
                                    ("dayyear", -1.8632184332102),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.502790045915623),
                                    ("Thursdayfrom|since|after <time>", -6.09732493780746),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.502790045915623),
                                    ("Thursdayat <time-of-day>", -5.809642865355679),
                                    ("Islamic New Yearyear (latent)", -6.09732493780746),
                                    ("Laylat al-Qadryear (latent)", -5.586499314041468),
                                    ("part of days<time-of-day> am|pm", -6.502790045915623),
                                    ("Discovery Dayyear (latent)", -6.09732493780746),
                                    ("Shrove Tuesdayyear (latent)", -6.502790045915623),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.809642865355679),
                                    ("hourminute", -6.09732493780746),
                                    ("<time-of-day> am|pmtomorrow", -5.809642865355679),
                                    ("Yom Kippuryear (latent)", -6.502790045915623),
                                    ("<day-of-month> (ordinal)Tuesday", -6.09732493780746),
                                    ("<part-of-day> of <time>year (latent)", -6.502790045915623),
                                    ("minutehour", -5.250027077420255),
                                    ("Kaanum Pongalyear (latent)", -6.09732493780746),
                                    ("Maha Saptamiyear (latent)", -6.502790045915623),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.809642865355679),
                                    ("time-of-day (latent)tomorrow", -5.586499314041468),
                                    ("part of daysat <time-of-day>", -4.893352133481524),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.487887025373359),
                                    ("for <duration> from <time>December", -6.502790045915623),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.502790045915623),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.250027077420255),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.250027077420255),
                                    ("time-of-day (latent)this <part-of-day>", -6.502790045915623),
                                    ("Pentecostyear (latent)", -6.502790045915623),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.250027077420255),
                                    ("<day-of-month> (ordinal)February", -6.502790045915623),
                                    ("Eid al-Fitryear (latent)", -5.1164956847957335),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.502790045915623),
                                    ("Mondayin|during the <part-of-day>", -6.502790045915623),
                                    ("Chhathin|during <named-month>|year", -6.502790045915623),
                                    ("Diwaliin|during <named-month>|year", -6.502790045915623),
                                    ("this <part-of-day><time-of-day> am|pm", -6.502790045915623),
                                    ("Vaisakhiin|during <named-month>|year", -6.502790045915623),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.250027077420255),
                                    ("Raksha Bandhanyear (latent)", -6.502790045915623),
                                    ("daysecond", -6.09732493780746),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.09732493780746),
                                    ("Ratha-Yatrayear (latent)", -6.502790045915623),
                                    ("Ashurayear (latent)", -6.502790045915623),
                                    ("Tuesdayin|during <named-month>|year", -6.502790045915623),
                                    ("Chinese New Yearyear (latent)", -6.502790045915623),
                                    ("tomorrowintersect", -6.502790045915623),
                                    ("Lag BaOmeryear (latent)", -6.502790045915623),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.502790045915623),
                                    ("Eid al-Adhayear (latent)", -4.362723882419353),
                                    ("intersectin|during the <part-of-day>", -6.502790045915623),
                                    ("Palm Sundayyear (latent)", -6.502790045915623),
                                    ("Christmasat <time-of-day>", -6.502790045915623),
                                    ("Passoveryear (latent)", -6.502790045915623),
                                    ("Lazarus Saturdayyear (latent)", -6.502790045915623),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.502790045915623),
                                    ("hhhmmon <day>", -5.586499314041468),
                                    ("Yom HaShoahyear (latent)", -6.09732493780746),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.09732493780746),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.502790045915623),
                                    ("Septemberyear (latent)", -6.09732493780746),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.99871264913935),
                                    ("Halloweenyear (latent)", -6.502790045915623),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.502790045915623),
                                    ("at <time-of-day>intersect", -5.586499314041468),
                                    ("Rosh Hashanahyear (latent)", -5.809642865355679),
                                    ("Dhanterasyear (latent)", -6.502790045915623),
                                    ("Tu BiShvatyear (latent)", -6.502790045915623),
                                    ("<day-of-month> (ordinal)December", -5.809642865355679),
                                    ("Holiyear (latent)", -5.809642865355679),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.502790045915623),
                                    ("Holika Dahanyear (latent)", -5.809642865355679),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.09732493780746),
                                    ("dayminute", -3.152885958641019),
                                    ("Mawlidyear (latent)", -6.502790045915623),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.09732493780746),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.502790045915623),
                                    ("Jumu'atul-Widayear (latent)", -5.586499314041468),
                                    ("minuteday", -2.7651204276322554),
                                    ("absorption of , after named dayintersect",
                                     -5.809642865355679),
                                    ("intersectyear (latent)", -6.502790045915623),
                                    ("Orthodox Easter Sundayyear (latent)", -6.502790045915623),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.502790045915623),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.502790045915623),
                                    ("intersecthhhmm", -6.09732493780746),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.502790045915623),
                                    ("Boss's Dayyear (latent)", -6.09732493780746),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.502790045915623),
                                    ("Global Youth Service Dayyear (latent)", -6.502790045915623),
                                    ("Dhanterasin|during <named-month>|year", -6.502790045915623),
                                    ("Tisha B'Avyear (latent)", -6.502790045915623),
                                    ("Isra and Mi'rajyear (latent)", -5.586499314041468),
                                    ("at <time-of-day>on <day>", -4.893352133481524),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.09732493780746),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.809642865355679),
                                    ("Christmasyear (latent)", -6.09732493780746),
                                    ("Saturdayintersect", -6.502790045915623),
                                    ("Naraka Chaturdashiyear (latent)", -6.09732493780746),
                                    ("Thai Pongalin|during <named-month>|year", -6.502790045915623),
                                    ("dayweek", -6.502790045915623),
                                    ("Easter Sundayyear (latent)", -5.809642865355679),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.09732493780746),
                                    ("Labour Dayyear (latent)", -6.502790045915623),
                                    ("weekyear", -5.404177757247514),
                                    ("King's Dayyear (latent)", -4.99871264913935),
                                    ("hh:mmin|during the <part-of-day>", -5.586499314041468),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.09732493780746),
                                    ("Hanukkahyear (latent)", -5.809642865355679),
                                    ("Rama Navamiyear (latent)", -6.502790045915623),
                                    ("February<time> <part-of-day>", -6.502790045915623),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.809642865355679),
                                    ("Great Lentyear (latent)", -6.502790045915623),
                                    ("tomorrowat <time-of-day>", -5.809642865355679),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.502790045915623),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.09732493780746),
                                    ("Ugadiyear (latent)", -5.1164956847957335),
                                    ("Vaisakhiyear (latent)", -5.809642865355679),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.809642865355679),
                                    ("last <cycle> of <time>year (latent)", -5.809642865355679),
                                    ("at <time-of-day>tomorrow", -6.09732493780746),
                                    ("tomorrow<time-of-day> am|pm", -6.502790045915623),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.502790045915623),
                                    ("Diwaliyear (latent)", -6.502790045915623),
                                    ("between <time> and <time>on <day>", -6.09732493780746),
                                    ("Black Fridayyear (latent)", -6.09732493780746),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.502790045915623),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.502790045915623),
                                    ("Chhathyear (latent)", -6.09732493780746),
                                    ("Vasant Panchamiyear (latent)", -6.502790045915623),
                                    ("Rabindra Jayantiyear (latent)", -5.250027077420255),
                                    ("this <part-of-day>at <time-of-day>", -5.250027077420255),
                                    ("St Patrick's Dayyear (latent)", -6.502790045915623),
                                    ("Thursday<time> (timezone)", -6.502790045915623),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.502790045915623),
                                    ("Pargat Diwasyear (latent)", -5.250027077420255),
                                    ("<datetime> - <datetime> (interval)July", -6.09732493780746),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.809642865355679),
                                    ("Februaryintersect", -6.502790045915623),
                                    ("Mother's Dayyear (latent)", -6.502790045915623),
                                    ("Simchat Torahyear (latent)", -6.502790045915623),
                                    ("Victoria Dayyear (latent)", -6.09732493780746),
                                    ("minuteyear", -6.502790045915623)],
                               n = 514},
                   koData =
                     ClassData{prior = -1.0088235607186717, unseen = -6.799055862058796,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.23700058597563592,
                               ...
                               n = 86},
                   koData =
                     ClassData{prior = -1.555853666299994, unseen = -4.07753744390572,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("the <day-of-month> (ordinal)",
        Classifier{okData =
                     ClassData{prior = -0.4989911661189879, unseen = -2.995732273553991,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 17},
                   koData =
                     ClassData{prior = -0.9343092373768334, unseen = -2.639057329615259,
                               likelihoods =
                                 HashMap.fromList
                                   [("ordinals (first..twentieth,thirtieth,...)",
                                     -0.6190392084062235),
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.5736020299101626,
                               unseen = -5.3612921657094255,
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                     -4.663439094112067),
                                    ("dayhour", -4.257973986003902),
                                    ("daymonth", -2.2210920587428626),
                                    ("<named-month> <day-of-month> (non ordinal)Friday",
                                     -4.663439094112067),
                                    ("Friday<named-month> <day-of-month> (non ordinal)",
                                     -3.4106761256166993),
                                    ("Wednesdayintersect", -4.663439094112067),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -3.2771447329921766),
                                    ("Black Fridaythis|last|next <cycle>", -4.663439094112067),
                                    ("Labour Daythis|last|next <cycle>", -4.663439094112067),
                                    ("<part-of-day> of <time>February", -4.663439094112067),
                                    ("Saturday<time-of-day> am|pm", -4.663439094112067),
                                    ("Martin Luther King's Daythis|last|next <cycle>",
                                     -4.257973986003902),
                                    ("hourmonth", -4.663439094112067),
                                    ("Fridayintersect by \",\", \"of\", \"from\" for year",
                                     -3.970291913552122),
                                    ("dayday", -2.412147295505572),
                                    ("the <day-of-month> (ordinal)February", -4.257973986003902),
                                    ("WednesdayOctober", -4.663439094112067),
                                    ("Wednesdaythis|last|next <cycle>", -4.257973986003902),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.4106761256166993),
                                    ("dayyear", -3.5648268054439574),
                                    ("Saturday<named-month> <day-of-month> (non ordinal)",
                                     -4.663439094112067),
                                    ("Thursdayhh:mm", -4.257973986003902),
                                    ("Thanksgiving Daythis|last|next <cycle>", -4.663439094112067),
                                    ("TuesdayOctober", -4.663439094112067),
                                    ("the <day-of-month> (ordinal)March", -4.663439094112067),
                                    ("Mondaythis|last|next <cycle>", -3.970291913552122),
                                    ("Fridayintersect", -3.970291913552122),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.257973986003902),
                                    ("intersectOctober", -4.257973986003902),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.747148362237912),
                                    ("Tuesdaythis|last|next <cycle>", -4.663439094112067),
                                    ("Sunday<named-month> <day-of-month> (non ordinal)",
                                     -4.663439094112067),
                                    ("dayminute", -2.871679624884012),
                                    ("minuteday", -3.4106761256166993),
                                    ("this|last|next <cycle>Sunday", -4.663439094112067),
                                    ("Sundaythis|last|next <cycle>", -4.663439094112067),
                                    ("on <day><time-of-day> am|pm", -4.663439094112067),
                                    ("intersectintersect", -4.663439094112067),
                                    ("weekday", -4.663439094112067),
                                    ("dayweek", -3.5648268054439574),
                                    ("Monday<named-month> <day-of-month> (non ordinal)",
                                     -4.257973986003902),
                                    ("<datetime> - <datetime> (interval)July", -3.747148362237912),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -3.970291913552122)],
                               n = 71},
                   koData =
                     ClassData{prior = -0.828948721719007, unseen = -5.198497031265826,
                               likelihoods =
                                 HashMap.fromList
