...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6323622894908235, unseen = -5.971261839790462,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 390},
                   koData =
                     ClassData{prior = -0.7578673712411172, unseen = -5.846438775057725,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4755502789937247, unseen = -7.020190708311925,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.326149473155099),
                                    ("Father's Dayyear (latent)", -6.326149473155099),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.326149473155099),
                                    ("Ramadanyear (latent)", -5.409858741280944),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.311246452612834),
                                    ("Bhai Doojyear (latent)", -6.326149473155099),
                                    ("hourday", -4.311246452612834), ("dayhour", -3.40837874107082),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.311246452612834),
                                    ("Martin Luther King's Dayyear (latent)", -5.9206843650469345),
                                    ("Shemini Atzeretyear (latent)", -6.326149473155099),
                                    ("daymonth", -4.311246452612834),
                                    ("monthday", -5.9206843650469345),
                                    ("monthyear", -4.534390003927045),
                                    ("Yom Ha'atzmautyear (latent)", -6.326149473155099),
                                    ("Vijayadashamiyear (latent)", -6.326149473155099),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.9206843650469345),
                                    ("Thanksgiving Dayyear (latent)", -5.227537184486989),
                                    ("Thai Pongalyear (latent)", -5.633002292595154),
                                    ("Thiru Onamyear (latent)", -5.633002292595154),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.326149473155099),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.409858741280944),
                                    ("<day-of-month> (ordinal)Wednesday", -6.326149473155099),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.326149473155099),
                                    ("houryear", -5.409858741280944),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.326149473155099),
                                    ("Christmas<time-of-day> am|pm", -6.326149473155099),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.326149473155099),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.633002292595154),
                                    ("intersectin|during <named-month>|year", -6.326149473155099),
                                    ("<time-of-day> am|pmintersect", -5.073386504659731),
                                    ("Earth Houryear (latent)", -6.326149473155099),
                                    ("Family Dayyear (latent)", -5.409858741280944),
                                    ("Octoberyear (latent)", -4.822072076378825),
                                    ("intersect<time-of-day> am|pm", -6.326149473155099),
                                    ("Mattu Pongalyear (latent)", -6.326149473155099),
                                    ("Shavuotyear (latent)", -6.326149473155099),
                                    ("Parsi New Yearyear (latent)", -5.409858741280944),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.326149473155099),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.326149473155099),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.9206843650469345),
                                    ("Marchyear (latent)", -6.326149473155099),
                                    ("Sukkotyear (latent)", -5.9206843650469345),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.9206843650469345),
                                    ("Clean Mondayyear (latent)", -5.9206843650469345),
                                    ("monthhour", -5.9206843650469345),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.633002292595154),
                                    ("todayat <time-of-day>", -6.326149473155099),
                                    ("Thursday<time> timezone", -4.380239324099786),
                                    ("time-of-day (latent)tonight", -5.9206843650469345),
                                    ("from|since|after <time>December", -6.326149473155099),
                                    ("<time-of-day> am|pmon <day>", -4.311246452612834),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.326149473155099),
                                    ("yyyy-mm-ddhh:mm:ss", -5.9206843650469345),
                                    ("dayday", -3.883802437785895),
                                    ("<time> <part-of-day>at <time-of-day>", -6.326149473155099),
                                    ("mm/ddat <time-of-day>", -6.326149473155099),
                                    ("tonightat <time-of-day>", -6.326149473155099),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.633002292595154),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.326149473155099),
                                    ("today<time-of-day> am|pm", -6.326149473155099),
                                    ("Februarythe <day-of-month> (ordinal)", -5.9206843650469345),
                                    ("at <time-of-day><time> <part-of-day>", -6.326149473155099),
                                    ("<day-of-month> (ordinal)intersect", -5.9206843650469345),
                                    ("mm/dd<time-of-day> am|pm", -6.326149473155099),
                                    ("hourhour", -4.246707931475263),
                                    ("Navaratriin|during <named-month>|year", -6.326149473155099),
                                    ("National Patriots' Dayyear (latent)", -5.633002292595154),
                                    ("Wednesdaythis|last|next <cycle>", -6.326149473155099),
                                    ("Lentyear (latent)", -6.326149473155099),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.822072076378825),
                                    ("Boghiyear (latent)", -6.326149473155099),
                                    ("dayyear", -1.9013028412982893),
                                    ("Thursdayfrom|since|after <time>", -5.9206843650469345),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.326149473155099),
                                    ("Thursdayat <time-of-day>", -5.633002292595154),
                                    ("Islamic New Yearyear (latent)", -5.9206843650469345),
                                    ("Laylat al-Qadryear (latent)", -5.409858741280944),
                                    ("Discovery Dayyear (latent)", -5.9206843650469345),
                                    ("Shrove Tuesdayyear (latent)", -6.326149473155099),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.633002292595154),
                                    ("<time-of-day> am|pmtomorrow", -5.633002292595154),
                                    ("Yom Kippuryear (latent)", -6.326149473155099),
                                    ("<day-of-month> (ordinal)Tuesday", -5.9206843650469345),
                                    ("<part-of-day> of <time>year (latent)", -6.326149473155099),
                                    ("minutehour", -5.227537184486989),
                                    ("Kaanum Pongalyear (latent)", -5.9206843650469345),
                                    ("Maha Saptamiyear (latent)", -6.326149473155099),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.9206843650469345),
                                    ("time-of-day (latent)tomorrow", -5.409858741280944),
                                    ("part of daysat <time-of-day>", -5.9206843650469345),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.621401380916674),
                                    ("for <duration> from <time>December", -6.326149473155099),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.326149473155099),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.073386504659731),
                                    ("time-of-day (latent)this <part-of-day>", -6.326149473155099),
                                    ("Pentecostyear (latent)", -6.326149473155099),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.073386504659731),
                                    ("<day-of-month> (ordinal)February", -6.326149473155099),
                                    ("Eid al-Fitryear (latent)", -5.409858741280944),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.326149473155099),
                                    ("Mondayin|during the <part-of-day>", -6.326149473155099),
                                    ("Chhathin|during <named-month>|year", -6.326149473155099),
                                    ("Diwaliin|during <named-month>|year", -6.326149473155099),
                                    ("Vaisakhiin|during <named-month>|year", -6.326149473155099),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.073386504659731),
                                    ("Raksha Bandhanyear (latent)", -6.326149473155099),
                                    ("daysecond", -5.9206843650469345),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.9206843650469345),
                                    ("Ashurayear (latent)", -6.326149473155099),
                                    ("Tuesdayin|during <named-month>|year", -6.326149473155099),
                                    ("Chinese New Yearyear (latent)", -6.326149473155099),
                                    ("tomorrowintersect", -6.326149473155099),
                                    ("Lag BaOmeryear (latent)", -6.326149473155099),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.326149473155099),
                                    ("Eid al-Adhayear (latent)", -5.409858741280944),
                                    ("intersectin|during the <part-of-day>", -6.326149473155099),
                                    ("Palm Sundayyear (latent)", -6.326149473155099),
                                    ("Christmasat <time-of-day>", -6.326149473155099),
                                    ("Passoveryear (latent)", -6.326149473155099),
                                    ("Lazarus Saturdayyear (latent)", -6.326149473155099),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.326149473155099),
                                    ("Yom HaShoahyear (latent)", -5.9206843650469345),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.9206843650469345),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.326149473155099),
                                    ("Septemberyear (latent)", -5.9206843650469345),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.822072076378825),
                                    ("Halloweenyear (latent)", -6.326149473155099),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.326149473155099),
                                    ("at <time-of-day>intersect", -5.9206843650469345),
                                    ("Rosh Hashanahyear (latent)", -5.633002292595154),
                                    ("Dhanterasyear (latent)", -6.326149473155099),
                                    ("Tu BiShvatyear (latent)", -6.326149473155099),
                                    ("<day-of-month> (ordinal)December", -5.633002292595154),
                                    ("Holiyear (latent)", -5.633002292595154),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.326149473155099),
                                    ("Holika Dahanyear (latent)", -5.633002292595154),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.326149473155099),
                                    ("dayminute", -3.40837874107082),
                                    ("Mawlidyear (latent)", -6.326149473155099),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.9206843650469345),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.326149473155099),
                                    ("Jumu'atul-Widayear (latent)", -5.409858741280944),
                                    ("minuteday", -2.497508076666004),
                                    ("absorption of , after named dayintersect",
                                     -6.326149473155099),
                                    ("intersectyear (latent)", -6.326149473155099),
                                    ("Orthodox Easter Sundayyear (latent)", -6.326149473155099),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.326149473155099),
                                    ("Boss's Dayyear (latent)", -5.9206843650469345),
                                    ("Global Youth Service Dayyear (latent)", -6.326149473155099),
                                    ("Dhanterasin|during <named-month>|year", -6.326149473155099),
                                    ("Tisha B'Avyear (latent)", -6.326149473155099),
                                    ("Isra and Mi'rajyear (latent)", -5.409858741280944),
                                    ("at <time-of-day>on <day>", -5.227537184486989),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.326149473155099),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.633002292595154),
                                    ("Christmasyear (latent)", -5.9206843650469345),
                                    ("Naraka Chaturdashiyear (latent)", -5.9206843650469345),
                                    ("Thai Pongalin|during <named-month>|year", -6.326149473155099),
                                    ("dayweek", -6.326149473155099),
                                    ("Easter Sundayyear (latent)", -5.633002292595154),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.716711560720999),
                                    ("Labour Dayyear (latent)", -6.326149473155099),
                                    ("weekyear", -5.227537184486989),
                                    ("King's Dayyear (latent)", -4.822072076378825),
                                    ("hh:mmin|during the <part-of-day>", -5.633002292595154),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.9206843650469345),
                                    ("Hanukkahyear (latent)", -5.633002292595154),
                                    ("February<time> <part-of-day>", -6.326149473155099),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.326149473155099),
                                    ("Great Lentyear (latent)", -6.326149473155099),
                                    ("tomorrowat <time-of-day>", -5.633002292595154),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.326149473155099),
                                    ("Vaisakhiyear (latent)", -5.633002292595154),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.326149473155099),
                                    ("last <cycle> of <time>year (latent)", -5.633002292595154),
                                    ("at <time-of-day>tomorrow", -5.9206843650469345),
                                    ("tomorrow<time-of-day> am|pm", -6.326149473155099),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.326149473155099),
                                    ("Diwaliyear (latent)", -6.326149473155099),
                                    ("between <time> and <time>on <day>", -4.716711560720999),
                                    ("Black Fridayyear (latent)", -5.9206843650469345),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.326149473155099),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.326149473155099),
                                    ("Chhathyear (latent)", -5.9206843650469345),
                                    ("Vasant Panchamiyear (latent)", -6.326149473155099),
                                    ("Rabindra Jayantiyear (latent)", -5.073386504659731),
                                    ("St Patrick's Dayyear (latent)", -6.326149473155099),
                                    ("Thursday<time> (timezone)", -6.326149473155099),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.326149473155099),
                                    ("<datetime> - <datetime> (interval)July", -5.9206843650469345),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.9206843650469345),
                                    ("Februaryintersect", -6.326149473155099),
                                    ("Mother's Dayyear (latent)", -6.326149473155099),
                                    ("Simchat Torahyear (latent)", -6.326149473155099),
                                    ("Victoria Dayyear (latent)", -5.9206843650469345),
                                    ("minuteyear", -6.326149473155099)],
                               n = 427},
                   koData =
                     ClassData{prior = -0.9716526612068216, unseen = -6.665683717782408,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1674546454536211,
                               ...
                               n = 192},
                   koData =
                     ClassData{prior = -1.869601955991989, unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
