...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7448191911042662, unseen = -5.298317366548036,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 198},
                   koData =
                     ClassData{prior = -0.6440144919823008,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4833487649250076, unseen = -6.352629396319567,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("Thanksgiving Dayyear", -4.5591262474866845),
                                    ...
                                    ("Mother's Dayyear", -5.6577385361547945),
                                    ("Victoria Dayyear", -5.25227342804663),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.25227342804663),
                                    ...
                                    ("absorption of , after named dayintersect",
                                     -5.6577385361547945),
                                    ("Family Dayyear", -4.741447804280639),
                                    ...
                                    ("Father's Dayyear", -5.6577385361547945),
                               ...
                               n = 214},
                   koData =
                     ClassData{prior = -0.9589756517251055, unseen = -6.021023349349527,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.32544603393629),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.32544603393629),
                                    ("hourday", -5.32544603393629),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.32544603393629),
                                    ("dayhour", -2.883098998567085),
                                    ("daymonth", -3.2460044922564535),
                                    ("monthday", -4.919980925828125),
                                    ("monthyear", -4.632298853376344),
                                    ("intersecthh:mm", -5.32544603393629),
                                    ("Easter Sundayyear", -5.32544603393629),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.32544603393629),
                                    ("houryear", -5.32544603393629),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.32544603393629),
                                    ("until <time-of-day><time-of-day> am|pm", -5.32544603393629),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.632298853376344),
                                    ("<time-of-day> am|pmintersect", -4.072683065440922),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.409155302062135),
                                    ("from|since|after <time-of-day>on <date>", -4.409155302062135),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.32544603393629),
                                    ("absorption of , after named dayJuly", -4.919980925828125),
                                    ("monthhour", -5.32544603393629),
                                    ("hourmonth", -4.632298853376344),
                                    ("todayat <time-of-day>", -5.32544603393629),
                                    ("from|since|after <time-of-day>July", -5.32544603393629),
                                    ("dayday", -4.919980925828125),
                                    ("mm/ddat <time-of-day>", -4.919980925828125),
                                    ("<time-of-day> am|pmon <date>", -4.072683065440922),
                                    ("dayyear", -3.7160081215021887),
                                    ("Thursdaymm/dd", -5.32544603393629),
                                    ("Sundayyear", -4.919980925828125),
                                    ("Thursdayat <time-of-day>", -4.072683065440922),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.32544603393629),
                                    ("monthminute", -5.32544603393629),
                                    ("<time-of-day> am|pmtomorrow", -5.32544603393629),
                                    ("Thursdayhh:mm", -4.409155302062135),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.32544603393629),
                                    ("Fridayyear", -4.919980925828125),
                                    ("minutemonth", -3.5336865647082343),
                                    ("Sundayfrom|since|after <time-of-day>", -5.32544603393629),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.919980925828125),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.919980925828125),
                                    ("Aprilyear", -5.32544603393629),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -4.919980925828125),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.32544603393629),
                                    ("Christmasat <time-of-day>", -5.32544603393629),
                                    ("<duration> after|before|from <time>December",
                                     -5.32544603393629),
                                    ("yesterday<time-of-day> am|pm", -5.32544603393629),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.32544603393629),
                                    ("until <time-of-day>on <date>", -4.632298853376344),
                                    ("at <time-of-day>intersect", -4.919980925828125),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.32544603393629),
                                    ("dayminute", -2.7997173896280336),
                                    ("intersectSeptember", -3.821368637160015),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.32544603393629),
                                    ("minuteday", -2.4076753018520103),
                                    ("absorption of , after named dayintersect", -5.32544603393629),
                                    ("Februaryin|during the <part-of-day>", -5.32544603393629),
                                    ("week-endin <named-month>", -5.32544603393629),
                                    ("Octoberyear", -5.32544603393629),
                                    ("from|since|after <time-of-day>year", -5.32544603393629),
                                    ("yearhh:mm", -5.32544603393629),
                                    ("hh:mmon <date>", -3.821368637160015),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.32544603393629),
                                    ("absorption of , after named daySeptember",
                                     -4.409155302062135),
                                    ("on <date>September", -4.919980925828125),
                                    ("at <time-of-day>on <date>", -4.919980925828125),
                                    ("dayweek", -5.32544603393629),
                                    ("Thursday<time-of-day> am|pm", -4.919980925828125),
                                    ("absorption of , after named dayFebruary", -4.409155302062135),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.32544603393629),
                                    ("tomorrowat <time-of-day>", -5.32544603393629),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.32544603393629),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.7160081215021887),
                                    ("tomorrow<time-of-day> am|pm", -5.32544603393629),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.32544603393629),
       ...
       ("year",
        Classifier{okData =
                     ClassData{prior = -0.23967285326542034,
                               unseen = -3.970291913552122,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -8.004270767353637e-2),
                                    ("intersect 2 numbers", -3.258096538021482)],
                               n = 48},
                   koData =
                     ClassData{prior = -1.5459245067117746, unseen = -2.890371757896165,
                               likelihoods =
                                 HashMap.fromList
