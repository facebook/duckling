...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.615988100013327, unseen = -6.0063531596017325,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 404},
                   koData =
                     ClassData{prior = -0.7767613206010788, unseen = -5.846438775057725,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46404700973296686,
                               unseen = -7.049254841255837,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.355239228161937),
                                    ("Father's Dayyear (latent)", -6.355239228161937),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.355239228161937),
                                    ("Ramadanyear (latent)", -5.438948496287782),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.340336207619672),
                                    ("Bhai Doojyear (latent)", -6.355239228161937),
                                    ("hourday", -4.340336207619672),
                                    ("dayhour", -3.4108002489954967),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.340336207619672),
                                    ("Martin Luther King's Dayyear (latent)", -5.949774120053773),
                                    ("Shemini Atzeretyear (latent)", -6.355239228161937),
                                    ("daymonth", -4.340336207619672),
                                    ("monthday", -5.949774120053773),
                                    ("monthyear", -4.563479758933882),
                                    ("Yom Ha'atzmautyear (latent)", -6.355239228161937),
                                    ("Vijayadashamiyear (latent)", -6.355239228161937),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.949774120053773),
                                    ("Thanksgiving Dayyear (latent)", -5.256626939493827),
                                    ("Thai Pongalyear (latent)", -5.662092047601992),
                                    ("Thiru Onamyear (latent)", -5.662092047601992),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.355239228161937),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.438948496287782),
                                    ("<day-of-month> (ordinal)Wednesday", -6.355239228161937),
                                    ("Krishna Janmashtamiyear (latent)", -5.949774120053773),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.355239228161937),
                                    ("houryear", -5.438948496287782),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.355239228161937),
                                    ("Christmas<time-of-day> am|pm", -6.355239228161937),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.355239228161937),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.662092047601992),
                                    ("intersectin|during <named-month>|year", -6.355239228161937),
                                    ("<time-of-day> am|pmintersect", -5.102476259666569),
                                    ("Earth Houryear (latent)", -6.355239228161937),
                                    ("Family Dayyear (latent)", -5.438948496287782),
                                    ("Octoberyear (latent)", -4.851161831385663),
                                    ("intersect<time-of-day> am|pm", -6.355239228161937),
                                    ("Mattu Pongalyear (latent)", -6.355239228161937),
                                    ("Shavuotyear (latent)", -6.355239228161937),
                                    ("Parsi New Yearyear (latent)", -5.438948496287782),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.355239228161937),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.355239228161937),
                                    ("todayin|within|after <duration>", -6.355239228161937),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.949774120053773),
                                    ("Marchyear (latent)", -6.355239228161937),
                                    ("Sukkotyear (latent)", -5.949774120053773),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.949774120053773),
                                    ("Clean Mondayyear (latent)", -5.949774120053773),
                                    ("monthhour", -5.949774120053773),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.662092047601992),
                                    ("todayat <time-of-day>", -6.355239228161937),
                                    ("Thursday<time> timezone", -4.409329079106624),
                                    ("time-of-day (latent)tonight", -5.949774120053773),
                                    ("from|since|after <time>December", -6.355239228161937),
                                    ("<time-of-day> am|pmon <day>", -4.340336207619672),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.355239228161937),
                                    ("yyyy-mm-ddhh:mm:ss", -5.949774120053773),
                                    ("dayday", -3.912892192792733),
                                    ("<time> <part-of-day>at <time-of-day>", -6.355239228161937),
                                    ("mm/ddat <time-of-day>", -6.355239228161937),
                                    ("tonightat <time-of-day>", -6.355239228161937),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.662092047601992),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.355239228161937),
                                    ("today<time-of-day> am|pm", -6.355239228161937),
                                    ("Februarythe <day-of-month> (ordinal)", -5.949774120053773),
                                    ("at <time-of-day><time> <part-of-day>", -6.355239228161937),
                                    ("<day-of-month> (ordinal)intersect", -5.949774120053773),
                                    ("mm/dd<time-of-day> am|pm", -6.355239228161937),
                                    ("hourhour", -4.275797686482101),
                                    ("Navaratriin|during <named-month>|year", -6.355239228161937),
                                    ("National Patriots' Dayyear (latent)", -5.662092047601992),
                                    ("Wednesdaythis|last|next <cycle>", -6.355239228161937),
                                    ("Lentyear (latent)", -6.355239228161937),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.851161831385663),
                                    ("Boghiyear (latent)", -6.355239228161937),
                                    ("dayyear", -1.849889377456057),
                                    ("Thursdayfrom|since|after <time>", -5.949774120053773),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.355239228161937),
                                    ("Thursdayat <time-of-day>", -5.662092047601992),
                                    ("Islamic New Yearyear (latent)", -5.949774120053773),
                                    ("Laylat al-Qadryear (latent)", -5.438948496287782),
                                    ("Discovery Dayyear (latent)", -5.949774120053773),
                                    ("Shrove Tuesdayyear (latent)", -6.355239228161937),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.662092047601992),
                                    ("<time-of-day> am|pmtomorrow", -5.662092047601992),
                                    ("Yom Kippuryear (latent)", -6.355239228161937),
                                    ("<day-of-month> (ordinal)Tuesday", -5.949774120053773),
                                    ("<part-of-day> of <time>year (latent)", -6.355239228161937),
                                    ("minutehour", -5.256626939493827),
                                    ("Kaanum Pongalyear (latent)", -5.949774120053773),
                                    ("Maha Saptamiyear (latent)", -6.355239228161937),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.949774120053773),
                                    ("time-of-day (latent)tomorrow", -5.438948496287782),
                                    ("part of daysat <time-of-day>", -5.949774120053773),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.650491135923512),
                                    ("for <duration> from <time>December", -6.355239228161937),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.355239228161937),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.102476259666569),
                                    ("time-of-day (latent)this <part-of-day>", -6.355239228161937),
                                    ("Pentecostyear (latent)", -6.355239228161937),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.102476259666569),
                                    ("<day-of-month> (ordinal)February", -6.355239228161937),
                                    ("Eid al-Fitryear (latent)", -5.438948496287782),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.355239228161937),
                                    ("Mondayin|during the <part-of-day>", -6.355239228161937),
                                    ("Chhathin|during <named-month>|year", -6.355239228161937),
                                    ("Diwaliin|during <named-month>|year", -6.355239228161937),
                                    ("Vaisakhiin|during <named-month>|year", -6.355239228161937),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.102476259666569),
                                    ("Raksha Bandhanyear (latent)", -6.355239228161937),
                                    ("daysecond", -5.949774120053773),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.949774120053773),
                                    ("Ashurayear (latent)", -6.355239228161937),
                                    ("Tuesdayin|during <named-month>|year", -6.355239228161937),
                                    ("Chinese New Yearyear (latent)", -6.355239228161937),
                                    ("tomorrowintersect", -6.355239228161937),
                                    ("Lag BaOmeryear (latent)", -6.355239228161937),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.355239228161937),
                                    ("Eid al-Adhayear (latent)", -4.215173064665667),
                                    ("intersectin|during the <part-of-day>", -6.355239228161937),
                                    ("Palm Sundayyear (latent)", -6.355239228161937),
                                    ("Christmasat <time-of-day>", -6.355239228161937),
                                    ("Passoveryear (latent)", -6.355239228161937),
                                    ("Lazarus Saturdayyear (latent)", -6.355239228161937),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.355239228161937),
                                    ("Yom HaShoahyear (latent)", -5.949774120053773),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.949774120053773),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.355239228161937),
                                    ("Septemberyear (latent)", -5.949774120053773),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.851161831385663),
                                    ("Halloweenyear (latent)", -6.355239228161937),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.355239228161937),
                                    ("at <time-of-day>intersect", -5.949774120053773),
                                    ("Rosh Hashanahyear (latent)", -5.662092047601992),
                                    ("Dhanterasyear (latent)", -6.355239228161937),
                                    ("Tu BiShvatyear (latent)", -6.355239228161937),
                                    ("<day-of-month> (ordinal)December", -5.662092047601992),
                                    ("Holiyear (latent)", -5.662092047601992),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.355239228161937),
                                    ("Holika Dahanyear (latent)", -5.662092047601992),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.355239228161937),
                                    ("dayminute", -3.437468496077658),
                                    ("Mawlidyear (latent)", -6.355239228161937),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.949774120053773),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.355239228161937),
                                    ("Jumu'atul-Widayear (latent)", -5.438948496287782),
                                    ("minuteday", -2.5265978316728424),
                                    ("absorption of , after named dayintersect",
                                     -6.355239228161937),
                                    ("intersectyear (latent)", -6.355239228161937),
                                    ("Orthodox Easter Sundayyear (latent)", -6.355239228161937),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.355239228161937),
                                    ("Boss's Dayyear (latent)", -5.949774120053773),
                                    ("Global Youth Service Dayyear (latent)", -6.355239228161937),
                                    ("Dhanterasin|during <named-month>|year", -6.355239228161937),
                                    ("Tisha B'Avyear (latent)", -6.355239228161937),
                                    ("Isra and Mi'rajyear (latent)", -5.438948496287782),
                                    ("at <time-of-day>on <day>", -5.256626939493827),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.355239228161937),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.662092047601992),
                                    ("Christmasyear (latent)", -5.949774120053773),
                                    ("Naraka Chaturdashiyear (latent)", -5.949774120053773),
                                    ("Thai Pongalin|during <named-month>|year", -6.355239228161937),
                                    ("dayweek", -6.355239228161937),
                                    ("Easter Sundayyear (latent)", -5.662092047601992),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.745801315727837),
                                    ("Labour Dayyear (latent)", -6.355239228161937),
                                    ("weekyear", -5.256626939493827),
                                    ("King's Dayyear (latent)", -4.851161831385663),
                                    ("hh:mmin|during the <part-of-day>", -5.662092047601992),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.949774120053773),
                                    ("Hanukkahyear (latent)", -5.662092047601992),
                                    ("February<time> <part-of-day>", -6.355239228161937),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.355239228161937),
                                    ("Great Lentyear (latent)", -6.355239228161937),
                                    ("tomorrowat <time-of-day>", -5.662092047601992),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.355239228161937),
                                    ("Vaisakhiyear (latent)", -5.662092047601992),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.355239228161937),
                                    ("last <cycle> of <time>year (latent)", -5.662092047601992),
                                    ("at <time-of-day>tomorrow", -5.949774120053773),
                                    ("tomorrow<time-of-day> am|pm", -6.355239228161937),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.355239228161937),
                                    ("Diwaliyear (latent)", -6.355239228161937),
                                    ("between <time> and <time>on <day>", -4.745801315727837),
                                    ("Black Fridayyear (latent)", -5.949774120053773),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.355239228161937),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.355239228161937),
                                    ("Chhathyear (latent)", -5.949774120053773),
                                    ("Vasant Panchamiyear (latent)", -6.355239228161937),
                                    ("Rabindra Jayantiyear (latent)", -5.102476259666569),
                                    ("St Patrick's Dayyear (latent)", -6.355239228161937),
                                    ("Thursday<time> (timezone)", -6.355239228161937),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.355239228161937),
                                    ("<datetime> - <datetime> (interval)July", -5.949774120053773),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.949774120053773),
                                    ("Februaryintersect", -6.355239228161937),
                                    ("Mother's Dayyear (latent)", -6.355239228161937),
                                    ("Simchat Torahyear (latent)", -6.355239228161937),
                                    ("Victoria Dayyear (latent)", -5.949774120053773),
                                    ("minuteyear", -6.355239228161937)],
                               n = 442},
                   koData =
                     ClassData{prior = -0.9908364844879716, unseen = -6.672032945461067,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.269568939183719),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.977619140285929),
                                    ("<day-of-month> (ordinal)August", -5.977619140285929),
                                    ("dayhour", -3.3034704908594),
                                    ("<time> timezoneyear (latent)", -5.977619140285929),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.061328408411774),
                                    ("Tuesdayfrom|since|after <time>", -5.977619140285929),
                                    ("daymonth", -3.4927124904979285),
                                    ("monthyear", -4.724856171790561),
                                    ("<time-of-day> am|pmyear (latent)", -5.284471959725984),
                                    ("Thai Pongalyear (latent)", -5.284471959725984),
                                    ("intersecthh:mm", -5.977619140285929),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.572154032177765),
                                    ("<day-of-month> (ordinal)Wednesday", -5.977619140285929),
                                    ("houryear", -4.5913247791660385),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.977619140285929),
                                    ("<day-of-month> (ordinal)October", -5.977619140285929),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.284471959725984),
                                    ("<time-of-day> am|pmintersect", -4.724856171790561),
                                    ("Octoberyear (latent)", -5.977619140285929),
                                    ("until <time>on <day>", -5.284471959725984),
                                    ("time-of-day (latent)intersect", -5.977619140285929),
                                    ("todayin <number> (implicit minutes)", -5.977619140285929),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.284471959725984),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.977619140285929),
                                    ("hh:mmon <day>", -3.5352721049167246),
                                    ("absorption of , after named dayJuly", -5.572154032177765),
                                    ("from|since|after <time>July", -5.572154032177765),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.061328408411774),
                                    ("Clean Mondayyear (latent)", -5.977619140285929),
                                    ("monthhour", -5.977619140285929),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.572154032177765),
                                    ("hourmonth", -4.1058169633843375),
                                    ("todayat <time-of-day>", -5.977619140285929),
                                    ("from|since|after <time>December", -5.977619140285929),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.977619140285929),
                                    ("<time-of-day> am|pmon <day>", -4.724856171790561),
                                    ("Mondayyear (latent)", -5.284471959725984),
                                    ("dayday", -4.5913247791660385),
                                    ("mm/ddat <time-of-day>", -5.572154032177765),
                                    ("on <day>September", -5.572154032177765),
                                    ("time-of-day (latent)September", -5.572154032177765),
                                    ("hourhour", -5.977619140285929),
                                    ("time-of-day (latent)on <day>", -3.5352721049167246),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.572154032177765),
                                    ("dayyear", -3.0331801611194886),
                                    ("Thursdaymm/dd", -5.977619140285929),
                                    ("New Year's Dayyear (latent)", -5.061328408411774),
                                    ("Thursdayfrom|since|after <time>", -4.272871048047504),
                                    ("Thursdayat <time-of-day>", -4.368181227851829),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.977619140285929),
                                    ("Aprilyear (latent)", -5.977619140285929),
                                    ("the <day-of-month> (ordinal)July", -5.977619140285929),
                                    ("the <day-of-month> (number)July", -5.977619140285929),
                                    ("monthminute", -5.977619140285929),
                                    ("<time-of-day> am|pmtomorrow", -5.977619140285929),
                                    ("Thursdayhh:mm", -5.061328408411774),
                                    ("<day-of-month> (ordinal)Tuesday", -5.572154032177765),
                                    ("minutemonth", -4.1058169633843375),
                                    ("minutehour", -5.977619140285929),
                                    ("Augustyear (latent)", -5.572154032177765),
                                    ("week-endin|during <named-month>|year", -5.977619140285929),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.572154032177765),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.977619140285929),
                                    ("Sundayyear (latent)", -5.061328408411774),
                                    ("Christmasat <time-of-day>", -5.977619140285929),
                                    ("from|since|after <time>year (latent)", -4.879006851617819),
                                    ("<duration> after|before|from <time>December",
                                     -5.977619140285929),
                                    ("yesterday<time-of-day> am|pm", -5.977619140285929),
                                    ("<day-of-month> (ordinal)July", -5.284471959725984),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.977619140285929),
                                    ("mm/ddyear (latent)", -5.977619140285929),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.977619140285929),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.977619140285929),
                                    ("at <time-of-day>intersect", -5.572154032177765),
                                    ("hh:mmyear (latent)", -3.898177598606093),
                                    ("Holiyear (latent)", -5.977619140285929),
                                    ("until <time><time-of-day> am|pm", -5.977619140285929),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.977619140285929),
                                    ("dayminute", -3.374929454841545),
                                    ("yyyy-mm-ddhh:mm", -5.572154032177765),
                                    ("intersectSeptember", -4.473541743509655),
                                    ("minuteday", -2.7389406881215486),
                                    ("absorption of , after named dayintersect",
                                     -5.977619140285929),
                                    ("intersectyear (latent)", -5.977619140285929),
                                    ("Februaryin|during the <part-of-day>", -5.977619140285929),
                                    ("time-of-day (latent)July", -5.284471959725984),
                                    ("Saturdayyear (latent)", -5.977619140285929),
                                    ("at <time-of-day>on <day>", -5.572154032177765),
                                    ("absorption of , after named daySeptember",
                                     -5.061328408411774),
                                    ("Naraka Chaturdashiyear (latent)", -5.977619140285929),
                                    ("from|since|after <time>on <day>", -5.061328408411774),
                                    ("dayweek", -5.977619140285929),
                                    ("Easter Sundayyear (latent)", -5.572154032177765),
                                    ("Thursday<time-of-day> am|pm", -4.724856171790561),
                                    ("weekyear", -5.572154032177765),
                                    ("time-of-day (latent)Thursday", -5.572154032177765),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.977619140285929),
                                    ("<day-of-month> (ordinal)April", -5.977619140285929),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.572154032177765),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.284471959725984),
                                    ("Sundayfrom|since|after <time>", -5.977619140285929),
                                    ("absorption of , after named dayFebruary", -5.061328408411774),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.977619140285929),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.977619140285929),
                                    ("tomorrowat <time-of-day>", -5.977619140285929),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.572154032177765),
                                    ("last <cycle> of <time>year (latent)", -5.572154032177765),
                                    ("tomorrow<time-of-day> am|pm", -5.977619140285929),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.284471959725984),
                                    ("Diwaliyear (latent)", -5.572154032177765),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.977619140285929),
                                    ("Fridayyear (latent)", -5.572154032177765),
                                    ("time-of-day (latent)April", -5.977619140285929),
                                    ("minuteyear", -3.7803945629497093)],
                               n = 261}}),
       ("one eleven",
        Classifier{okData =
