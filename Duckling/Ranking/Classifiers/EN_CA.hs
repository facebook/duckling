...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7501638610001811, unseen = -5.288267030694535,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 196},
                   koData =
                     ClassData{prior = -0.6392067904141976,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4877032063451364, unseen = -6.333279628139691,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.385591700838377),
                                    ("hourday", -3.9336065770953206),
                                    ("dayhour", -2.8051413252775297),
                                    ("daymonth", -4.945207488773801),
                                    ("monthday", -5.232889561225582),
                                    ("monthyear", -4.028916756899645),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.638354669333745),
                                    ("Easter Sundayyear", -4.945207488773801),
                                    ("Christmasyear", -5.638354669333745),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.638354669333745),
                                    ("houryear", -5.638354669333745),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.638354669333745),
                                    ("Marchyear", -5.638354669333745),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.232889561225582),
                                    ("intersect<time-of-day> am|pm", -5.638354669333745),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.638354669333745),
                                    ("monthhour", -5.232889561225582),
                                    ("last <day-of-week> of <time>year", -5.638354669333745),
                                    ("todayat <time-of-day>", -5.638354669333745),
                                    ("Thursday<time> timezone", -3.9336065770953206),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.638354669333745),
                                    ("dayday", -3.623451648791481),
                                    ("Thanksgiving Dayyear", -4.539742380665636),
                                    ("<time> <part-of-day>at <time-of-day>", -5.638354669333745),
                                    ("Tuesdayin <named-month>", -5.638354669333745),
                                    ("mm/ddat <time-of-day>", -5.638354669333745),
                                    ("tonightat <time-of-day>", -5.638354669333745),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.945207488773801),
                                    ("today<time-of-day> am|pm", -5.638354669333745),
                                    ("Februarythe <day-of-month> (ordinal)", -5.232889561225582),
                                    ("at <time-of-day><time> <part-of-day>", -5.638354669333745),
                                    ("mm/dd<time-of-day> am|pm", -5.638354669333745),
                                    ("hourhour", -4.385591700838377),
                                    ("<time-of-day> am|pmon <date>", -3.623451648791481),
                                    ("Wednesdaythis|last|next <cycle>", -5.638354669333745),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.134277272557472),
                                    ("dayyear", -2.8657659470939647),
                                    ("last weekend of <named-month>year", -5.638354669333745),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.638354669333745),
                                    ("Thursdayat <time-of-day>", -5.232889561225582),
                                    ("<time-of-day> am|pmtomorrow", -4.945207488773801),
                                    ("minutehour", -4.72206393745959),
                                    ("Mother's Dayyear", -5.638354669333745),
                                    ("Victoria Dayyear", -5.232889561225582),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.232889561225582),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.9336065770953206),
                                    ("for <duration> from <time>December", -5.638354669333745),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.638354669333745),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.72206393745959),
                                    ("Mondayin|during the <part-of-day>", -5.638354669333745),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.232889561225582),
                                    ("intersectin|during the <part-of-day>", -5.638354669333745),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.232889561225582),
                                    ("<ordinal> <cycle> of <time>year", -5.638354669333745),
                                    ("minuteday", -2.1726187665340193),
                                    ("absorption of , after named dayintersect",
                                     -5.638354669333745),
                                    ("Family Dayyear", -4.72206393745959),
                                    ("Octoberyear", -4.385591700838377),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.638354669333745),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.638354669333745),
                                    ("year<time-of-day> am|pm", -5.638354669333745),
                                    ("Septemberyear", -5.232889561225582),
                                    ("at <time-of-day>on <date>", -4.539742380665636),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.945207488773801),
                                    ("Halloweenyear", -5.638354669333745),
                                    ("dayweek", -5.638354669333745),
                                    ("Thursday<time-of-day> am|pm", -5.638354669333745),
                                    ("weekyear", -5.232889561225582),
                                    ("hh:mmin|during the <part-of-day>", -4.945207488773801),
                                    ("Father's Dayyear", -5.638354669333745),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.232889561225582),
                                    ("February<time> <part-of-day>", -5.638354669333745),
                                    ("Martin Luther King's Dayyear", -5.232889561225582),
                                    ("tomorrowat <time-of-day>", -4.945207488773801),
                                    ("between <time> and <time>on <date>", -4.945207488773801),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.945207488773801),
                                    ("at <time-of-day>tomorrow", -5.232889561225582),
                                    ("tomorrow<time-of-day> am|pm", -5.638354669333745),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.638354669333745),
                                    ("Labor Dayyear", -5.638354669333745),
                                    ("Februaryintersect", -5.638354669333745),
                                    ("last <cycle> of <time>year", -4.945207488773801),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.638354669333745),
                                    ("yearminute", -5.638354669333745),
                                    ("Black Fridayyear", -5.232889561225582)],
                               n = 210},
                   koData =
                     ClassData{prior = -0.9520088144762343, unseen = -6.008813185442595,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.313205979041787),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.313205979041787),
                                    ("hourday", -5.313205979041787),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.313205979041787),
                                    ("dayhour", -2.915310706243417),
                                    ("daymonth", -3.2337644373619514),
                                    ("monthday", -4.907740870933623),
                                    ("monthyear", -4.620058798481842),
                                    ("intersecthh:mm", -5.313205979041787),
                                    ("Easter Sundayyear", -5.313205979041787),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.313205979041787),
                                    ("houryear", -5.313205979041787),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.313205979041787),
                                    ("until <time-of-day><time-of-day> am|pm", -5.313205979041787),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.620058798481842),
                                    ("<time-of-day> am|pmintersect", -4.060443010546419),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.396915247167632),
                                    ("from|since|after <time-of-day>on <date>", -4.396915247167632),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.313205979041787),
                                    ("absorption of , after named dayJuly", -4.907740870933623),
                                    ("monthhour", -5.313205979041787),
                                    ("hourmonth", -4.620058798481842),
                                    ("todayat <time-of-day>", -5.313205979041787),
                                    ("from|since|after <time-of-day>July", -5.313205979041787),
                                    ("dayday", -4.907740870933623),
                                    ("mm/ddat <time-of-day>", -4.907740870933623),
                                    ("<time-of-day> am|pmon <date>", -4.060443010546419),
                                    ("dayyear", -3.703768066607687),
                                    ("Thursdaymm/dd", -5.313205979041787),
                                    ("Sundayyear", -4.907740870933623),
                                    ("Thursdayat <time-of-day>", -4.060443010546419),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.313205979041787),
                                    ("monthminute", -5.313205979041787),
                                    ("<time-of-day> am|pmtomorrow", -5.313205979041787),
                                    ("Thursdayhh:mm", -4.396915247167632),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.313205979041787),
                                    ("Fridayyear", -4.907740870933623),
                                    ("minutemonth", -3.521446509813732),
                                    ("Sundayfrom|since|after <time-of-day>", -5.313205979041787),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.907740870933623),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.907740870933623),
                                    ("Aprilyear", -5.313205979041787),
                                    ...
                                    ("<duration> after|before|from <time>December",
                                     -5.313205979041787),
                                    ("yesterday<time-of-day> am|pm", -5.313205979041787),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.313205979041787),
                                    ("until <time-of-day>on <date>", -4.620058798481842),
                                    ("at <time-of-day>intersect", -4.907740870933623),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.313205979041787),
                                    ("dayminute", -2.787477334733532),
                                    ("intersectSeptember", -3.8091285822655134),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.313205979041787),
                                    ("minuteday", -2.395435246957508),
                                    ("absorption of , after named dayintersect",
                                     -5.313205979041787),
                                    ("Februaryin|during the <part-of-day>", -5.313205979041787),
                                    ("week-endin <named-month>", -5.313205979041787),
                                    ("Octoberyear", -5.313205979041787),
                                    ("from|since|after <time-of-day>year", -5.313205979041787),
                                    ("yearhh:mm", -5.313205979041787),
                                    ("hh:mmon <date>", -3.8091285822655134),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.313205979041787),
                                    ("absorption of , after named daySeptember",
                                     -4.396915247167632),
                                    ("on <date>September", -4.907740870933623),
                                    ("at <time-of-day>on <date>", -4.907740870933623),
                                    ("dayweek", -5.313205979041787),
                                    ("Thursday<time-of-day> am|pm", -4.907740870933623),
                                    ("absorption of , after named dayFebruary", -4.396915247167632),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.313205979041787),
                                    ("tomorrowat <time-of-day>", -5.313205979041787),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.313205979041787),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.703768066607687),
                                    ("tomorrow<time-of-day> am|pm", -5.313205979041787),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.313205979041787),
                                    ("yearminute", -5.313205979041787)],
                               n = 132}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year",
        Classifier{okData =
                     ClassData{prior = -0.2441969605120421, unseen = -3.951243718581427,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -8.167803101426724e-2),
                                    ("intersect 2 numbers", -3.2386784521643803)],
                               n = 47},
                   koData =
                     ClassData{prior = -1.529395204760564, unseen = -2.890371757896165,
                               likelihoods =
                                 HashMap.fromList
