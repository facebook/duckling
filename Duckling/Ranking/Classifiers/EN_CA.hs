...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6625993507098479, unseen = -5.860786223465865,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 349},
                   koData =
                     ClassData{prior = -0.7246576645281312, unseen = -5.799092654460526,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48686322309541147,
                               unseen = -6.957497370876951,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.263398262591624),
                                    ("Father's Dayyear (latent)", -6.263398262591624),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.263398262591624),
                                    ("Ramadanyear (latent)", -5.3471075307174685),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.248495242049359),
                                    ("Bhai Doojyear (latent)", -6.263398262591624),
                                    ("hourday", -4.248495242049359),
                                    ("dayhour", -3.3456275305073446),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.248495242049359),
                                    ("Martin Luther King's Dayyear (latent)", -5.857933154483459),
                                    ("Shemini Atzeretyear (latent)", -6.263398262591624),
                                    ("daymonth", -4.653960350157523),
                                    ("monthday", -5.857933154483459),
                                    ("monthyear", -4.471638793363569),
                                    ("Yom Ha'atzmautyear (latent)", -6.263398262591624),
                                    ("Vijayadashamiyear (latent)", -6.263398262591624),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.857933154483459),
                                    ("Thanksgiving Dayyear (latent)", -5.1647859739235145),
                                    ("Thai Pongalyear (latent)", -5.570251082031678),
                                    ("Thiru Onamyear (latent)", -5.570251082031678),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.263398262591624),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.263398262591624),
                                    ("<day-of-month> (ordinal)Wednesday", -6.263398262591624),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.263398262591624),
                                    ("houryear", -5.3471075307174685),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.263398262591624),
                                    ("Christmas<time-of-day> am|pm", -6.263398262591624),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.263398262591624),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.570251082031678),
                                    ("intersectin|during <named-month>|year", -6.263398262591624),
                                    ("<time-of-day> am|pmintersect", -5.0106352940962555),
                                    ("Earth Houryear (latent)", -6.263398262591624),
                                    ("Family Dayyear (latent)", -5.3471075307174685),
                                    ("Octoberyear (latent)", -4.75932086581535),
                                    ("intersect<time-of-day> am|pm", -6.263398262591624),
                                    ("Mattu Pongalyear (latent)", -6.263398262591624),
                                    ("Shavuotyear (latent)", -6.263398262591624),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.263398262591624),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.263398262591624),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.857933154483459),
                                    ("Marchyear (latent)", -6.263398262591624),
                                    ("Sukkotyear (latent)", -5.857933154483459),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.857933154483459),
                                    ("Clean Mondayyear (latent)", -5.857933154483459),
                                    ("monthhour", -5.857933154483459),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.570251082031678),
                                    ("todayat <time-of-day>", -6.263398262591624),
                                    ("Thursday<time> timezone", -4.31748811353631),
                                    ("time-of-day (latent)tonight", -5.857933154483459),
                                    ("from|since|after <time>December", -6.263398262591624),
                                    ("<time-of-day> am|pmon <day>", -4.248495242049359),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.263398262591624),
                                    ("yyyy-mm-ddhh:mm:ss", -5.857933154483459),
                                    ("dayday", -3.8210512272224193),
                                    ("<time> <part-of-day>at <time-of-day>", -6.263398262591624),
                                    ("mm/ddat <time-of-day>", -6.263398262591624),
                                    ("tonightat <time-of-day>", -6.263398262591624),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.570251082031678),
                                    ("today<time-of-day> am|pm", -6.263398262591624),
                                    ("Februarythe <day-of-month> (ordinal)", -5.857933154483459),
                                    ("at <time-of-day><time> <part-of-day>", -6.263398262591624),
                                    ("<day-of-month> (ordinal)intersect", -5.857933154483459),
                                    ("mm/dd<time-of-day> am|pm", -6.263398262591624),
                                    ("hourhour", -4.183956720911787),
                                    ("Navaratriin|during <named-month>|year", -6.263398262591624),
                                    ("National Patriots' Dayyear (latent)", -5.570251082031678),
                                    ("Wednesdaythis|last|next <cycle>", -6.263398262591624),
                                    ("Lentyear (latent)", -6.263398262591624),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.75932086581535),
                                    ("Boghiyear (latent)", -6.263398262591624),
                                    ("dayyear", -2.000718385550308),
                                    ("Thursdayfrom|since|after <time>", -5.857933154483459),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.263398262591624),
                                    ("Thursdayat <time-of-day>", -5.570251082031678),
                                    ("Islamic New Yearyear (latent)", -5.857933154483459),
                                    ("Laylat al-Qadryear (latent)", -5.3471075307174685),
                                    ("Discovery Dayyear (latent)", -5.857933154483459),
                                    ("Shrove Tuesdayyear (latent)", -6.263398262591624),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.570251082031678),
                                    ("<time-of-day> am|pmtomorrow", -5.570251082031678),
                                    ("Yom Kippuryear (latent)", -6.263398262591624),
                                    ("<day-of-month> (ordinal)Tuesday", -5.857933154483459),
                                    ("<part-of-day> of <time>year (latent)", -6.263398262591624),
                                    ("minutehour", -5.1647859739235145),
                                    ("Kaanum Pongalyear (latent)", -5.857933154483459),
                                    ("Maha Saptamiyear (latent)", -6.263398262591624),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.857933154483459),
                                    ("time-of-day (latent)tomorrow", -5.3471075307174685),
                                    ("part of daysat <time-of-day>", -5.857933154483459),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.558650170353198),
                                    ("for <duration> from <time>December", -6.263398262591624),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.263398262591624),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.0106352940962555),
                                    ("time-of-day (latent)this <part-of-day>", -6.263398262591624),
                                    ("Pentecostyear (latent)", -6.263398262591624),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.0106352940962555),
                                    ("<day-of-month> (ordinal)February", -6.263398262591624),
                                    ("Eid al-Fitryear (latent)", -5.3471075307174685),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.263398262591624),
                                    ("Mondayin|during the <part-of-day>", -6.263398262591624),
                                    ("Chhathin|during <named-month>|year", -6.263398262591624),
                                    ("Diwaliin|during <named-month>|year", -6.263398262591624),
                                    ("Vaisakhiin|during <named-month>|year", -6.263398262591624),
                                    ("Raksha Bandhanyear (latent)", -6.263398262591624),
                                    ("daysecond", -5.857933154483459),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.857933154483459),
                                    ("Ashurayear (latent)", -6.263398262591624),
                                    ("Tuesdayin|during <named-month>|year", -6.263398262591624),
                                    ("Chinese New Yearyear (latent)", -6.263398262591624),
                                    ("tomorrowintersect", -6.263398262591624),
                                    ("Lag BaOmeryear (latent)", -6.263398262591624),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.263398262591624),
                                    ("Eid al-Adhayear (latent)", -5.3471075307174685),
                                    ("intersectin|during the <part-of-day>", -6.263398262591624),
                                    ("Palm Sundayyear (latent)", -6.263398262591624),
                                    ("Christmasat <time-of-day>", -6.263398262591624),
                                    ("Passoveryear (latent)", -6.263398262591624),
                                    ("Lazarus Saturdayyear (latent)", -6.263398262591624),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.263398262591624),
                                    ("Yom HaShoahyear (latent)", -5.857933154483459),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.857933154483459),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.263398262591624),
                                    ("Septemberyear (latent)", -5.857933154483459),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.75932086581535),
                                    ("Halloweenyear (latent)", -6.263398262591624),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.263398262591624),
                                    ("at <time-of-day>intersect", -5.857933154483459),
                                    ("Rosh Hashanahyear (latent)", -5.570251082031678),
                                    ("Dhanterasyear (latent)", -6.263398262591624),
                                    ("Tu BiShvatyear (latent)", -6.263398262591624),
                                    ("<day-of-month> (ordinal)December", -5.570251082031678),
                                    ("Holiyear (latent)", -5.570251082031678),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.263398262591624),
                                    ("Holika Dahanyear (latent)", -5.570251082031678),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.263398262591624),
                                    ("dayminute", -3.3456275305073446),
                                    ("Mawlidyear (latent)", -6.263398262591624),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.857933154483459),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.263398262591624),
                                    ("Jumu'atul-Widayear (latent)", -5.3471075307174685),
                                    ("minuteday", -2.4347568661025285),
                                    ("absorption of , after named dayintersect",
                                     -6.263398262591624),
                                    ("intersectyear (latent)", -6.263398262591624),
                                    ("Orthodox Easter Sundayyear (latent)", -6.263398262591624),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.263398262591624),
                                    ("Boss's Dayyear (latent)", -5.857933154483459),
                                    ("Global Youth Service Dayyear (latent)", -6.263398262591624),
                                    ("Dhanterasin|during <named-month>|year", -6.263398262591624),
                                    ("Tisha B'Avyear (latent)", -6.263398262591624),
                                    ("Isra and Mi'rajyear (latent)", -5.3471075307174685),
                                    ("at <time-of-day>on <day>", -5.1647859739235145),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.263398262591624),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.570251082031678),
                                    ("Christmasyear (latent)", -5.857933154483459),
                                    ("Naraka Chaturdashiyear (latent)", -5.857933154483459),
                                    ("Thai Pongalin|during <named-month>|year", -6.263398262591624),
                                    ("dayweek", -6.263398262591624),
                                    ("Easter Sundayyear (latent)", -5.570251082031678),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.653960350157523),
                                    ("Labour Dayyear (latent)", -6.263398262591624),
                                    ("weekyear", -5.1647859739235145),
                                    ("hh:mmin|during the <part-of-day>", -5.570251082031678),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.857933154483459),
                                    ("Hanukkahyear (latent)", -5.570251082031678),
                                    ("February<time> <part-of-day>", -6.263398262591624),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.263398262591624),
                                    ("Great Lentyear (latent)", -6.263398262591624),
                                    ("tomorrowat <time-of-day>", -5.570251082031678),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.263398262591624),
                                    ("Vaisakhiyear (latent)", -5.570251082031678),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.263398262591624),
                                    ("last <cycle> of <time>year (latent)", -5.570251082031678),
                                    ("at <time-of-day>tomorrow", -5.857933154483459),
                                    ("tomorrow<time-of-day> am|pm", -6.263398262591624),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.263398262591624),
                                    ("Diwaliyear (latent)", -6.263398262591624),
                                    ("between <time> and <time>on <day>", -4.653960350157523),
                                    ("Black Fridayyear (latent)", -5.857933154483459),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.263398262591624),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.263398262591624),
                                    ("Chhathyear (latent)", -5.857933154483459),
                                    ("Vasant Panchamiyear (latent)", -6.263398262591624),
                                    ("St Patrick's Dayyear (latent)", -6.263398262591624),
                                    ("Thursday<time> (timezone)", -6.263398262591624),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.263398262591624),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.857933154483459),
                                    ("Februaryintersect", -6.263398262591624),
                                    ("Mother's Dayyear (latent)", -6.263398262591624),
                                    ("Simchat Torahyear (latent)", -6.263398262591624),
                                    ("Victoria Dayyear (latent)", -5.857933154483459),
                                    ("minuteyear", -6.263398262591624)],
                               n = 397},
                   koData =
                     ClassData{prior = -0.9533466073178942, unseen = -6.626717749249025,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1902738849844497, unseen = -5.147494476813453,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.571808260207923e-2),
                                    ("intersect 2 numbers", -3.7553691953827695)],
                               n = 167},
                   koData =
                     ClassData{prior = -1.7529196359117911,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
