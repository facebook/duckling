...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.577656332248447, unseen = -6.142037405587356,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 463},
                   koData =
                     ClassData{prior = -0.82373917450891, unseen = -5.8971538676367405,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.44694262543130986,
                               unseen = -7.1459844677143876,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.452048954437226),
                                    ("Father's Dayyear (latent)", -6.452048954437226),
                                    ("Karva Chauthyear (latent)", -6.452048954437226),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.452048954437226),
                                    ("Maha Shivaratriyear (latent)", -6.452048954437226),
                                    ("Ramadanyear (latent)", -5.199285985941858),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.065754593317335),
                                    ("Bhai Doojyear (latent)", -6.452048954437226),
                                    ("hourday", -4.4371459338949615),
                                    ("dayhour", -3.5076099752707854),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.065754593317335),
                                    ("Martin Luther King's Dayyear (latent)", -6.046583846329061),
                                    ("Shemini Atzeretyear (latent)", -6.452048954437226),
                                    ("daymonth", -4.4371459338949615),
                                    ("monthday", -6.046583846329061),
                                    ("monthyear", -4.660289485209171),
                                    ("Yom Ha'atzmautyear (latent)", -6.452048954437226),
                                    ("Vijayadashamiyear (latent)", -6.452048954437226),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -6.046583846329061),
                                    ("Thanksgiving Dayyear (latent)", -5.353436665769117),
                                    ("Thai Pongalyear (latent)", -5.75890177387728),
                                    ("Thiru Onamyear (latent)", -5.75890177387728),
                                    ("hhhmmabsorption of , after named day", -6.452048954437226),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.452048954437226),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.535758222563071),
                                    ("<day-of-month> (ordinal)Wednesday", -6.452048954437226),
                                    ("Krishna Janmashtamiyear (latent)", -6.046583846329061),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.452048954437226),
                                    ("houryear", -5.535758222563071),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.452048954437226),
                                    ("Christmas<time-of-day> am|pm", -6.452048954437226),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.452048954437226),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.75890177387728),
                                    ("intersectin|during <named-month>|year", -6.452048954437226),
                                    ("<time-of-day> am|pmintersect", -5.199285985941858),
                                    ("Earth Houryear (latent)", -6.452048954437226),
                                    ("Ganesh Chaturthiyear (latent)", -6.452048954437226),
                                    ("Family Dayyear (latent)", -5.535758222563071),
                                    ("Octoberyear (latent)", -4.947971557660952),
                                    ("intersect<time-of-day> am|pm", -6.452048954437226),
                                    ("Mattu Pongalyear (latent)", -6.452048954437226),
                                    ("Shavuotyear (latent)", -6.452048954437226),
                                    ("Parsi New Yearyear (latent)", -5.535758222563071),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.452048954437226),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.452048954437226),
                                    ("todayin|within|after <duration>", -6.452048954437226),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.046583846329061),
                                    ("Marchyear (latent)", -6.452048954437226),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.046583846329061),
                                    ("Sukkotyear (latent)", -6.046583846329061),
                                    ("hhhmmintersect", -6.046583846329061),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.046583846329061),
                                    ("Clean Mondayyear (latent)", -6.046583846329061),
                                    ("monthhour", -6.046583846329061),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.75890177387728),
                                    ("todayat <time-of-day>", -6.452048954437226),
                                    ("Thursday<time> timezone", -4.054153681638855),
                                    ("time-of-day (latent)tonight", -6.046583846329061),
                                    ("from|since|after <time>December", -6.452048954437226),
                                    ("<time-of-day> am|pmon <day>", -4.4371459338949615),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.452048954437226),
                                    ("yyyy-mm-ddhh:mm:ss", -6.046583846329061),
                                    ("dayday", -3.743998753335016),
                                    ("<time> <part-of-day>at <time-of-day>", -6.452048954437226),
                                    ("mm/ddat <time-of-day>", -6.452048954437226),
                                    ("tonightat <time-of-day>", -6.452048954437226),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.75890177387728),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.452048954437226),
                                    ("today<time-of-day> am|pm", -6.452048954437226),
                                    ("Februarythe <day-of-month> (ordinal)", -6.046583846329061),
                                    ("at <time-of-day><time> <part-of-day>", -6.452048954437226),
                                    ("<day-of-month> (ordinal)intersect", -6.046583846329061),
                                    ("mm/dd<time-of-day> am|pm", -6.452048954437226),
                                    ("hourhour", -4.37260741275739),
                                    ("Mahavir Jayantiyear (latent)", -6.046583846329061),
                                    ("Navaratriin|during <named-month>|year", -6.452048954437226),
                                    ("National Patriots' Dayyear (latent)", -5.75890177387728),
                                    ("Wednesdaythis|last|next <cycle>", -6.452048954437226),
                                    ("Lentyear (latent)", -6.452048954437226),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.580246777535635),
                                    ("Boghiyear (latent)", -6.452048954437226),
                                    ("dayyear", -1.812477341731802),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.452048954437226),
                                    ("Thursdayfrom|since|after <time>", -6.046583846329061),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.452048954437226),
                                    ("Thursdayat <time-of-day>", -5.75890177387728),
                                    ("Islamic New Yearyear (latent)", -6.046583846329061),
                                    ("Laylat al-Qadryear (latent)", -5.535758222563071),
                                    ("Discovery Dayyear (latent)", -6.046583846329061),
                                    ("Shrove Tuesdayyear (latent)", -6.452048954437226),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.75890177387728),
                                    ("<time-of-day> am|pmtomorrow", -5.75890177387728),
                                    ("Yom Kippuryear (latent)", -6.452048954437226),
                                    ("<day-of-month> (ordinal)Tuesday", -6.046583846329061),
                                    ("<part-of-day> of <time>year (latent)", -6.452048954437226),
                                    ("minutehour", -5.199285985941858),
                                    ("Kaanum Pongalyear (latent)", -6.046583846329061),
                                    ("Maha Saptamiyear (latent)", -6.452048954437226),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.046583846329061),
                                    ("time-of-day (latent)tomorrow", -5.535758222563071),
                                    ("part of daysat <time-of-day>", -6.046583846329061),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.4371459338949615),
                                    ("for <duration> from <time>December", -6.452048954437226),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.452048954437226),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.199285985941858),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.199285985941858),
                                    ("time-of-day (latent)this <part-of-day>", -6.452048954437226),
                                    ("Pentecostyear (latent)", -6.452048954437226),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.199285985941858),
                                    ("<day-of-month> (ordinal)February", -6.452048954437226),
                                    ("Eid al-Fitryear (latent)", -5.065754593317335),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.452048954437226),
                                    ("Mondayin|during the <part-of-day>", -6.452048954437226),
                                    ("Chhathin|during <named-month>|year", -6.452048954437226),
                                    ("Diwaliin|during <named-month>|year", -6.452048954437226),
                                    ("Vaisakhiin|during <named-month>|year", -6.452048954437226),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.199285985941858),
                                    ("Raksha Bandhanyear (latent)", -6.452048954437226),
                                    ("daysecond", -6.046583846329061),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.046583846329061),
                                    ("Ratha-Yatrayear (latent)", -6.452048954437226),
                                    ("Ashurayear (latent)", -6.452048954437226),
                                    ("Tuesdayin|during <named-month>|year", -6.452048954437226),
                                    ("Chinese New Yearyear (latent)", -6.452048954437226),
                                    ("tomorrowintersect", -6.452048954437226),
                                    ("Lag BaOmeryear (latent)", -6.452048954437226),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.452048954437226),
                                    ("Eid al-Adhayear (latent)", -4.311982790940955),
                                    ("intersectin|during the <part-of-day>", -6.452048954437226),
                                    ("Palm Sundayyear (latent)", -6.452048954437226),
                                    ("Christmasat <time-of-day>", -6.452048954437226),
                                    ("Passoveryear (latent)", -6.452048954437226),
                                    ("Lazarus Saturdayyear (latent)", -6.452048954437226),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.452048954437226),
                                    ("hhhmmon <day>", -5.535758222563071),
                                    ("Yom HaShoahyear (latent)", -6.046583846329061),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.046583846329061),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.452048954437226),
                                    ("Septemberyear (latent)", -6.046583846329061),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.947971557660952),
                                    ("Halloweenyear (latent)", -6.452048954437226),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.452048954437226),
                                    ("at <time-of-day>intersect", -5.535758222563071),
                                    ("Rosh Hashanahyear (latent)", -5.75890177387728),
                                    ("Dhanterasyear (latent)", -6.452048954437226),
                                    ("Tu BiShvatyear (latent)", -6.452048954437226),
                                    ("<day-of-month> (ordinal)December", -5.75890177387728),
                                    ("Holiyear (latent)", -5.75890177387728),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.452048954437226),
                                    ("Holika Dahanyear (latent)", -5.75890177387728),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.046583846329061),
                                    ("dayminute", -3.1021448671626213),
                                    ("Mawlidyear (latent)", -6.452048954437226),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.046583846329061),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.452048954437226),
                                    ("Jumu'atul-Widayear (latent)", -5.535758222563071),
                                    ("minuteday", -2.7143793361538577),
                                    ("absorption of , after named dayintersect", -5.75890177387728),
                                    ("intersectyear (latent)", -6.452048954437226),
                                    ("Orthodox Easter Sundayyear (latent)", -6.452048954437226),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.452048954437226),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.452048954437226),
                                    ("intersecthhhmm", -6.046583846329061),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.452048954437226),
                                    ("Boss's Dayyear (latent)", -6.046583846329061),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.452048954437226),
                                    ("Global Youth Service Dayyear (latent)", -6.452048954437226),
                                    ("Dhanterasin|during <named-month>|year", -6.452048954437226),
                                    ("Tisha B'Avyear (latent)", -6.452048954437226),
                                    ("Isra and Mi'rajyear (latent)", -5.535758222563071),
                                    ("at <time-of-day>on <day>", -4.842611042003125),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.046583846329061),
                                    ("time-of-day (latent)<time> <part-of-day>", -5.75890177387728),
                                    ("Christmasyear (latent)", -6.046583846329061),
                                    ("Naraka Chaturdashiyear (latent)", -6.046583846329061),
                                    ("Thai Pongalin|during <named-month>|year", -6.452048954437226),
                                    ("dayweek", -6.452048954437226),
                                    ("Easter Sundayyear (latent)", -5.75890177387728),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.046583846329061),
                                    ("Labour Dayyear (latent)", -6.452048954437226),
                                    ("weekyear", -5.353436665769117),
                                    ("King's Dayyear (latent)", -4.947971557660952),
                                    ("hh:mmin|during the <part-of-day>", -5.535758222563071),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.046583846329061),
                                    ("Hanukkahyear (latent)", -5.75890177387728),
                                    ("Rama Navamiyear (latent)", -6.452048954437226),
                                    ("February<time> <part-of-day>", -6.452048954437226),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.452048954437226),
                                    ("Great Lentyear (latent)", -6.452048954437226),
                                    ("tomorrowat <time-of-day>", -5.75890177387728),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.452048954437226),
                                    ("Ugadiyear (latent)", -5.065754593317335),
                                    ("Vaisakhiyear (latent)", -5.75890177387728),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.75890177387728),
                                    ("last <cycle> of <time>year (latent)", -5.75890177387728),
                                    ("at <time-of-day>tomorrow", -6.046583846329061),
                                    ("tomorrow<time-of-day> am|pm", -6.452048954437226),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.452048954437226),
                                    ("Diwaliyear (latent)", -6.452048954437226),
                                    ("between <time> and <time>on <day>", -6.046583846329061),
                                    ("Black Fridayyear (latent)", -6.046583846329061),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.452048954437226),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.452048954437226),
                                    ("Chhathyear (latent)", -6.046583846329061),
                                    ("Vasant Panchamiyear (latent)", -6.452048954437226),
                                    ("Rabindra Jayantiyear (latent)", -5.199285985941858),
                                    ("St Patrick's Dayyear (latent)", -6.452048954437226),
                                    ("Thursday<time> (timezone)", -6.452048954437226),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.452048954437226),
                                    ("Pargat Diwasyear (latent)", -5.199285985941858),
                                    ("<datetime> - <datetime> (interval)July", -6.046583846329061),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.75890177387728),
                                    ("Februaryintersect", -6.452048954437226),
                                    ("Mother's Dayyear (latent)", -6.452048954437226),
                                    ("Simchat Torahyear (latent)", -6.452048954437226),
                                    ("Victoria Dayyear (latent)", -6.046583846329061),
                                    ("minuteyear", -6.452048954437226)],
                               n = 488},
                   koData =
                     ClassData{prior = -1.0204869336178857, unseen = -6.736966958001855,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.538555436906107),
                                    ("hourday", -3.644737560884011),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.042632833682381),
                                    ("<day-of-month> (ordinal)August", -6.042632833682381),
                                    ("dayhour", -3.368484184255853),
                                    ("<time> timezoneyear (latent)", -5.349485653122436),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.126342101808226),
                                    ("Tuesdayfrom|since|after <time>", -5.349485653122436),
                                    ("daymonth", -3.368484184255853),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.042632833682381),
                                    ("hh:mmon <day>", -4.789869865187013),
                                    ("hhhmmintersect", -5.637167725574217),
                                    ("absorption of , after named dayJuly", -5.126342101808226),
                                    ...
                                    ("hhhmmyear (latent)", -4.789869865187013),
                                    ...
                                    ("mm/ddat <time-of-day>", -5.637167725574217),
                                    ("on <day>September", -5.349485653122436),
                                    ("time-of-day (latent)September", -5.637167725574217),
                                    ("hourhour", -5.637167725574217),
                                    ("time-of-day (latent)on <day>", -4.538555436906107),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.637167725574217),
                                    ("dayyear", -3.098193854515941),
                                    ("Thursdaymm/dd", -6.042632833682381),
                                    ...
                                    ("minutemonth", -3.9025666701861104),
                                    ...
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.042632833682381),
                                    ("at <time-of-day>on <day>", -5.126342101808226),
