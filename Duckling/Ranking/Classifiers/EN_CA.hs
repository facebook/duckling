...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6772738314036552, unseen = -5.545177444479562,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 254},
                   koData =
                     ClassData{prior = -0.709276562489829, unseen = -5.5134287461649825,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4713231807897444,
                               unseen = -6.6293632534374485,
                               likelihoods =
                                 HashMap.fromList
                                   [("Father's Dayyear (latent)", -5.934894195619588),
                                    ("Ramadanyear (latent)", -5.934894195619588),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.68213122712422),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.68213122712422),
                                    ("hourday", -4.230146103381163),
                                    ("dayhour", -3.0171234635353086),
                                    ("Martin Luther King's Dayyear (latent)", -5.529429087511423),
                                    ("Shemini Atzeretyear (latent)", -5.934894195619588),
                                    ("daymonth", -5.241747015059643),
                                    ("monthday", -5.529429087511423),
                                    ("monthyear", -4.3254562831854875),
                                    ("Yom Ha'atzmautyear (latent)", -5.934894195619588),
                                    ("Thanksgiving Dayyear (latent)", -4.836281906951478),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.934894195619588),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.934894195619588),
                                    ("houryear", -5.529429087511423),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.934894195619588),
                                    ("Christmas<time-of-day> am|pm", -5.934894195619588),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.934894195619588),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.241747015059643),
                                    ("<time-of-day> am|pmintersect", -4.68213122712422),
                                    ("Family Dayyear (latent)", -5.018603463745433),
                                    ("Octoberyear (latent)", -4.68213122712422),
                                    ("intersect<time-of-day> am|pm", -5.934894195619588),
                                    ("Shavuotyear (latent)", -5.934894195619588),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.934894195619588),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.529429087511423),
                                    ("Marchyear (latent)", -5.934894195619588),
                                    ("Sukkotyear (latent)", -5.529429087511423),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.934894195619588),
                                    ("Clean Mondayyear (latent)", -5.529429087511423),
                                    ("monthhour", -5.529429087511423),
                                    ("todayat <time-of-day>", -5.934894195619588),
                                    ("Thursday<time> timezone", -4.230146103381163),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.934894195619588),
                                    ("Palm SundaySunday", -5.529429087511423),
                                    ("dayday", -3.7376696182833684),
                                    ("<time> <part-of-day>at <time-of-day>", -5.934894195619588),
                                    ("mm/ddat <time-of-day>", -5.934894195619588),
                                    ("tonightat <time-of-day>", -5.934894195619588),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.241747015059643),
                                    ("today<time-of-day> am|pm", -5.934894195619588),
                                    ("Februarythe <day-of-month> (ordinal)", -5.529429087511423),
                                    ("at <time-of-day><time> <part-of-day>", -5.934894195619588),
                                    ("mm/dd<time-of-day> am|pm", -5.934894195619588),
                                    ("hourhour", -4.68213122712422),
                                    ("<time-of-day> am|pmon <date>", -3.919991175077323),
                                    ("National Patriots' Dayyear (latent)", -5.241747015059643),
                                    ("Wednesdaythis|last|next <cycle>", -5.934894195619588),
                                    ("Lentyear (latent)", -5.934894195619588),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.430816798843313),
                                    ("dayyear", -2.1394050064473933),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.934894195619588),
                                    ("Thursdayat <time-of-day>", -5.529429087511423),
                                    ("Islamic New Yearyear (latent)", -5.529429087511423),
                                    ("Laylat al-Qadryear (latent)", -5.018603463745433),
                                    ("Discovery Dayyear (latent)", -5.529429087511423),
                                    ("Shrove Tuesdayyear (latent)", -5.934894195619588),
                                    ("<time-of-day> am|pmtomorrow", -5.241747015059643),
                                    ("Yom Kippuryear (latent)", -5.934894195619588),
                                    ("<part-of-day> of <time>year (latent)", -5.934894195619588),
                                    ("minutehour", -5.018603463745433),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.529429087511423),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.230146103381163),
                                    ("for <duration> from <time>December", -5.934894195619588),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.934894195619588),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.018603463745433),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.529429087511423),
                                    ("Pentecostyear (latent)", -5.934894195619588),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.018603463745433),
                                    ("Eid al-Fitryear (latent)", -5.934894195619588),
                                    ("Mondayin|during the <part-of-day>", -5.934894195619588),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.529429087511423),
                                    ("Ashurayear (latent)", -5.934894195619588),
                                    ("Chinese New Yearyear (latent)", -5.934894195619588),
                                    ("Sundayyear (latent)", -5.934894195619588),
                                    ("Lag BaOmeryear (latent)", -5.934894195619588),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.934894195619588),
                                    ("Eid al-Adhayear (latent)", -5.018603463745433),
                                    ("intersectin|during the <part-of-day>", -5.934894195619588),
                                    ("Christmasat <time-of-day>", -5.934894195619588),
                                    ("Passoveryear (latent)", -5.934894195619588),
                                    ("Lazarus Saturdayyear (latent)", -5.934894195619588),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.934894195619588),
                                    ("Yom HaShoahyear (latent)", -5.529429087511423),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.018603463745433),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.934894195619588),
                                    ("Septemberyear (latent)", -5.529429087511423),
                                    ("mm/ddyear (latent)", -5.934894195619588),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.68213122712422),
                                    ("Halloweenyear (latent)", -5.934894195619588),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.934894195619588),
                                    ("Tu BiShvatyear (latent)", -5.934894195619588),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.934894195619588),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.934894195619588),
                                    ("dayminute", -3.295836866004329),
                                    ("Mawlidyear (latent)", -5.934894195619588),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.529429087511423),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.934894195619588),
                                    ("Jumu'atul-Widayear (latent)", -5.018603463745433),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.934894195619588),
                                    ("minuteday", -2.297308035893202),
                                    ("absorption of , after named dayintersect",
                                     -5.934894195619588),
                                    ("intersectyear (latent)", -5.934894195619588),
                                    ("Orthodox Easter Sundayyear (latent)", -5.934894195619588),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.934894195619588),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.934894195619588),
                                    ("Boss's Dayyear (latent)", -5.529429087511423),
                                    ("Tisha B'Avyear (latent)", -5.934894195619588),
                                    ("Isra and Mi'rajyear (latent)", -5.018603463745433),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.934894195619588),
                                    ("Christmasyear (latent)", -5.529429087511423),
                                    ("at <time-of-day>on <date>", -4.836281906951478),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.3254562831854875),
                                    ("dayweek", -5.934894195619588),
                                    ("Easter Sundayyear (latent)", -5.241747015059643),
                                    ("Thursday<time-of-day> am|pm", -5.934894195619588),
                                    ("Labour Dayyear (latent)", -5.934894195619588),
                                    ("weekyear", -5.529429087511423),
                                    ("hh:mmin|during the <part-of-day>", -5.241747015059643),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.529429087511423),
                                    ("Hanukkahyear (latent)", -5.934894195619588),
                                    ("February<time> <part-of-day>", -5.934894195619588),
                                    ("Tuesdayin <named-month>|year", -5.934894195619588),
                                    ("Great Lentyear (latent)", -5.934894195619588),
                                    ("tomorrowat <time-of-day>", -5.241747015059643),
                                    ("between <time> and <time>on <date>", -4.3254562831854875),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.241747015059643),
                                    ("last <cycle> of <time>year (latent)", -5.241747015059643),
                                    ("at <time-of-day>tomorrow", -5.529429087511423),
                                    ("tomorrow<time-of-day> am|pm", -5.934894195619588),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.934894195619588),
                                    ("Black Fridayyear (latent)", -5.529429087511423),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.934894195619588),
                                    ("Palm Sundayintersect", -5.934894195619588),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.934894195619588),
                                    ("Februaryintersect", -5.934894195619588),
                                    ("Mother's Dayyear (latent)", -5.934894195619588),
                                    ("Simchat Torahyear (latent)", -5.934894195619588),
                                    ("Victoria Dayyear (latent)", -5.529429087511423)],
                               n = 284},
                   koData =
                     ClassData{prior = -0.9786338624482905, unseen = -6.274762021241939,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.579729825986222),
                                    ("hourday", -5.579729825986222),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.579729825986222),
                                    ("dayhour", -3.1373827906170177),
                                    ("daymonth", -3.5002882843063863),
                                    ("monthday", -5.174264717878058),
                                    ("monthyear", -4.326966857490854),
                                    ("<time-of-day> am|pmyear (latent)", -5.174264717878058),
                                    ("intersecthh:mm", -5.579729825986222),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.579729825986222),
                                    ("houryear", -4.663439094112067),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.579729825986222),
                                    ("until <time-of-day><time-of-day> am|pm", -5.579729825986222),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.886582645426277),
                                    ("<time-of-day> am|pmintersect", -4.326966857490854),
                                    ("Octoberyear (latent)", -5.579729825986222),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.326966857490854),
                                    ("from|since|after <time-of-day>on <date>", -4.663439094112067),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.579729825986222),
                                    ("absorption of , after named dayJuly", -5.174264717878058),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.663439094112067),
                                    ("Clean Mondayyear (latent)", -5.579729825986222),
                                    ("monthhour", -5.579729825986222),
                                    ("hourmonth", -4.886582645426277),
                                    ("todayat <time-of-day>", -5.579729825986222),
                                    ("from|since|after <time-of-day>July", -5.579729825986222),
                                    ("Mondayyear (latent)", -4.886582645426277),
                                    ("dayday", -5.174264717878058),
                                    ("mm/ddat <time-of-day>", -5.174264717878058),
                                    ("<time-of-day> am|pmon <date>", -4.326966857490854),
                                    ("dayyear", -2.807141103746441),
                                    ("Thursdaymm/dd", -5.579729825986222),
                                    ("New Year's Dayyear (latent)", -5.174264717878058),
                                    ("Thursdayat <time-of-day>", -4.326966857490854),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.579729825986222),
                                    ("Aprilyear (latent)", -5.579729825986222),
                                    ("monthminute", -5.579729825986222),
                                    ("<time-of-day> am|pmtomorrow", -5.579729825986222),
                                    ("Thursdayhh:mm", -4.663439094112067),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.579729825986222),
                                    ("minutemonth", -3.787970356758167),
                                    ("Sundayfrom|since|after <time-of-day>", -5.579729825986222),
                                    ("week-endin <named-month>|year", -5.579729825986222),
                                    ("Augustyear (latent)", -5.174264717878058),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.174264717878058),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.174264717878058),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.579729825986222),
                                    ("Sundayyear (latent)", -4.886582645426277),
                                    ("Christmasat <time-of-day>", -5.579729825986222),
                                    ("<duration> after|before|from <time>December",
                                     -5.579729825986222),
                                    ("yesterday<time-of-day> am|pm", -5.579729825986222),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.663439094112067),
                                    ("mm/ddyear (latent)", -5.579729825986222),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.174264717878058),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.579729825986222),
                                    ("until <time-of-day>on <date>", -4.886582645426277),
                                    ("at <time-of-day>intersect", -5.174264717878058),
                                    ("hh:mmyear (latent)", -4.481117537318113),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.579729825986222),
                                    ("dayminute", -3.094823176198222),
                                    ("intersectSeptember", -4.075652429209948),
                                    ("minuteday", -2.511676890852605),
                                    ("absorption of , after named dayintersect",
                                     -5.579729825986222),
                                    ("Februaryin|during the <part-of-day>", -5.579729825986222),
                                    ("hh:mmon <date>", -3.5648268054439574),
                                    ("Saturdayyear (latent)", -5.579729825986222),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.579729825986222),
                                    ("absorption of , after named daySeptember",
                                     -4.663439094112067),
                                    ("on <date>September", -5.174264717878058),
                                    ("at <time-of-day>on <date>", -5.174264717878058),
                                    ("in <named-month>|yearyear (latent)", -5.579729825986222),
                                    ("dayweek", -5.579729825986222),
                                    ("Easter Sundayyear (latent)", -5.174264717878058),
                                    ("Thursday<time-of-day> am|pm", -5.174264717878058),
                                    ("absorption of , after named dayFebruary", -4.663439094112067),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.579729825986222),
                                    ("tomorrowat <time-of-day>", -5.579729825986222),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.579729825986222),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.970291913552122),
                                    ("tomorrow<time-of-day> am|pm", -5.579729825986222),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.886582645426277),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.579729825986222),
                                    ("Fridayyear (latent)", -5.174264717878058),
                                    ("minuteyear", -4.326966857490854)],
                               n = 171}}),
       ("one eleven",
        Classifier{okData =
