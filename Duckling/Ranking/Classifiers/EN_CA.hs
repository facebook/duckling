...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5786056388277329, unseen = -6.139884552226255,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 462},
                   koData =
                     ClassData{prior = -0.8225263180837006,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4476824326040565, unseen = -7.143617602704121,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.4496802206016755),
                                    ("Father's Dayyear (latent)", -6.4496802206016755),
                                    ("Karva Chauthyear (latent)", -6.4496802206016755),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.4496802206016755),
                                    ("Maha Shivaratriyear (latent)", -6.4496802206016755),
                                    ("Ramadanyear (latent)", -5.196917252106307),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.063385859481785),
                                    ("Bhai Doojyear (latent)", -6.4496802206016755),
                                    ("hourday", -4.43477720005941),
                                    ("dayhour", -3.5052412414352347),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.063385859481785),
                                    ("Martin Luther King's Dayyear (latent)", -6.044215112493511),
                                    ("Shemini Atzeretyear (latent)", -6.4496802206016755),
                                    ("daymonth", -4.43477720005941),
                                    ("monthday", -6.044215112493511),
                                    ("monthyear", -4.65792075137362),
                                    ("Yom Ha'atzmautyear (latent)", -6.4496802206016755),
                                    ("Vijayadashamiyear (latent)", -6.4496802206016755),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -6.044215112493511),
                                    ("Thanksgiving Dayyear (latent)", -5.3510679319335654),
                                    ("Thai Pongalyear (latent)", -5.75653304004173),
                                    ("Thiru Onamyear (latent)", -5.75653304004173),
                                    ("hhhmmabsorption of , after named day", -6.4496802206016755),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.4496802206016755),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.53338948872752),
                                    ("<day-of-month> (ordinal)Wednesday", -6.4496802206016755),
                                    ("Krishna Janmashtamiyear (latent)", -6.044215112493511),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.4496802206016755),
                                    ("houryear", -5.53338948872752),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.4496802206016755),
                                    ("Christmas<time-of-day> am|pm", -6.4496802206016755),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.4496802206016755),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.75653304004173),
                                    ("intersectin|during <named-month>|year", -6.4496802206016755),
                                    ("<time-of-day> am|pmintersect", -5.196917252106307),
                                    ("Earth Houryear (latent)", -6.4496802206016755),
                                    ("Ganesh Chaturthiyear (latent)", -6.4496802206016755),
                                    ("Family Dayyear (latent)", -5.53338948872752),
                                    ("Octoberyear (latent)", -4.945602823825401),
                                    ("intersect<time-of-day> am|pm", -6.4496802206016755),
                                    ("Mattu Pongalyear (latent)", -6.4496802206016755),
                                    ("Shavuotyear (latent)", -6.4496802206016755),
                                    ("Parsi New Yearyear (latent)", -5.53338948872752),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.4496802206016755),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.4496802206016755),
                                    ("todayin|within|after <duration>", -6.4496802206016755),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.044215112493511),
                                    ("Marchyear (latent)", -6.4496802206016755),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.044215112493511),
                                    ("Sukkotyear (latent)", -6.044215112493511),
                                    ("hhhmmintersect", -6.044215112493511),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.044215112493511),
                                    ("Clean Mondayyear (latent)", -6.044215112493511),
                                    ("monthhour", -6.044215112493511),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.75653304004173),
                                    ("todayat <time-of-day>", -6.4496802206016755),
                                    ("Thursday<time> timezone", -4.051784947803305),
                                    ("time-of-day (latent)tonight", -6.044215112493511),
                                    ("from|since|after <time>December", -6.4496802206016755),
                                    ("<time-of-day> am|pmon <day>", -4.43477720005941),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.4496802206016755),
                                    ("yyyy-mm-ddhh:mm:ss", -6.044215112493511),
                                    ("dayday", -3.7416300194994654),
                                    ("<time> <part-of-day>at <time-of-day>", -6.4496802206016755),
                                    ("mm/ddat <time-of-day>", -6.4496802206016755),
                                    ("tonightat <time-of-day>", -6.4496802206016755),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.75653304004173),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.4496802206016755),
                                    ("today<time-of-day> am|pm", -6.4496802206016755),
                                    ("Februarythe <day-of-month> (ordinal)", -6.044215112493511),
                                    ("at <time-of-day><time> <part-of-day>", -6.4496802206016755),
                                    ("<day-of-month> (ordinal)intersect", -6.044215112493511),
                                    ("mm/dd<time-of-day> am|pm", -6.4496802206016755),
                                    ("hourhour", -4.370238678921839),
                                    ("Mahavir Jayantiyear (latent)", -6.044215112493511),
                                    ("Navaratriin|during <named-month>|year", -6.4496802206016755),
                                    ("National Patriots' Dayyear (latent)", -5.75653304004173),
                                    ("Wednesdaythis|last|next <cycle>", -6.4496802206016755),
                                    ("Lentyear (latent)", -6.4496802206016755),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.577878043700084),
                                    ("Boghiyear (latent)", -6.4496802206016755),
                                    ("dayyear", -1.8149512323720396),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.4496802206016755),
                                    ("Thursdayfrom|since|after <time>", -6.044215112493511),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.4496802206016755),
                                    ("Thursdayat <time-of-day>", -5.75653304004173),
                                    ("Islamic New Yearyear (latent)", -6.044215112493511),
                                    ("Laylat al-Qadryear (latent)", -5.53338948872752),
                                    ("Discovery Dayyear (latent)", -6.044215112493511),
                                    ("Shrove Tuesdayyear (latent)", -6.4496802206016755),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.75653304004173),
                                    ("<time-of-day> am|pmtomorrow", -5.75653304004173),
                                    ("Yom Kippuryear (latent)", -6.4496802206016755),
                                    ("<day-of-month> (ordinal)Tuesday", -6.044215112493511),
                                    ("<part-of-day> of <time>year (latent)", -6.4496802206016755),
                                    ("minutehour", -5.196917252106307),
                                    ("Kaanum Pongalyear (latent)", -6.044215112493511),
                                    ("Maha Saptamiyear (latent)", -6.4496802206016755),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.044215112493511),
                                    ("time-of-day (latent)tomorrow", -5.53338948872752),
                                    ("part of daysat <time-of-day>", -6.044215112493511),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.43477720005941),
                                    ("for <duration> from <time>December", -6.4496802206016755),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.4496802206016755),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.196917252106307),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.196917252106307),
                                    ("time-of-day (latent)this <part-of-day>", -6.4496802206016755),
                                    ("Pentecostyear (latent)", -6.4496802206016755),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.196917252106307),
                                    ("<day-of-month> (ordinal)February", -6.4496802206016755),
                                    ("Eid al-Fitryear (latent)", -5.063385859481785),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.4496802206016755),
                                    ("Mondayin|during the <part-of-day>", -6.4496802206016755),
                                    ("Chhathin|during <named-month>|year", -6.4496802206016755),
                                    ("Diwaliin|during <named-month>|year", -6.4496802206016755),
                                    ("Vaisakhiin|during <named-month>|year", -6.4496802206016755),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.196917252106307),
                                    ("Raksha Bandhanyear (latent)", -6.4496802206016755),
                                    ("daysecond", -6.044215112493511),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.044215112493511),
                                    ("Ratha-Yatrayear (latent)", -6.4496802206016755),
                                    ("Ashurayear (latent)", -6.4496802206016755),
                                    ("Tuesdayin|during <named-month>|year", -6.4496802206016755),
                                    ("Chinese New Yearyear (latent)", -6.4496802206016755),
                                    ("tomorrowintersect", -6.4496802206016755),
                                    ("Lag BaOmeryear (latent)", -6.4496802206016755),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.4496802206016755),
                                    ("Eid al-Adhayear (latent)", -4.309614057105405),
                                    ("intersectin|during the <part-of-day>", -6.4496802206016755),
                                    ("Palm Sundayyear (latent)", -6.4496802206016755),
                                    ("Christmasat <time-of-day>", -6.4496802206016755),
                                    ("Passoveryear (latent)", -6.4496802206016755),
                                    ("Lazarus Saturdayyear (latent)", -6.4496802206016755),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.4496802206016755),
                                    ("hhhmmon <day>", -5.53338948872752),
                                    ("Yom HaShoahyear (latent)", -6.044215112493511),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.044215112493511),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.4496802206016755),
                                    ("Septemberyear (latent)", -6.044215112493511),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.945602823825401),
                                    ("Halloweenyear (latent)", -6.4496802206016755),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.75653304004173),
                                    ("Dhanterasyear (latent)", -6.4496802206016755),
                                    ("Tu BiShvatyear (latent)", -6.4496802206016755),
                                    ("<day-of-month> (ordinal)December", -5.75653304004173),
                                    ("Holiyear (latent)", -5.75653304004173),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.4496802206016755),
                                    ("Holika Dahanyear (latent)", -5.75653304004173),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.044215112493511),
                                    ("dayminute", -3.0997761333270706),
                                    ("Mawlidyear (latent)", -6.4496802206016755),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.044215112493511),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.4496802206016755),
                                    ("Jumu'atul-Widayear (latent)", -5.53338948872752),
                                    ("minuteday", -2.712010602318307),
                                    ("absorption of , after named dayintersect", -5.75653304004173),
                                    ("intersectyear (latent)", -6.4496802206016755),
                                    ("Orthodox Easter Sundayyear (latent)", -6.4496802206016755),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.4496802206016755),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.4496802206016755),
                                    ("intersecthhhmm", -6.044215112493511),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.4496802206016755),
                                    ("Boss's Dayyear (latent)", -6.044215112493511),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.4496802206016755),
                                    ("Global Youth Service Dayyear (latent)", -6.4496802206016755),
                                    ("Dhanterasin|during <named-month>|year", -6.4496802206016755),
                                    ("Tisha B'Avyear (latent)", -6.4496802206016755),
                                    ("Isra and Mi'rajyear (latent)", -5.53338948872752),
                                    ("at <time-of-day>on <day>", -4.840242308167575),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.044215112493511),
                                    ("time-of-day (latent)<time> <part-of-day>", -5.75653304004173),
                                    ("Christmasyear (latent)", -6.044215112493511),
                                    ("Naraka Chaturdashiyear (latent)", -6.044215112493511),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.4496802206016755),
                                    ("dayweek", -6.4496802206016755),
                                    ("Easter Sundayyear (latent)", -5.75653304004173),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.044215112493511),
                                    ("Labour Dayyear (latent)", -6.4496802206016755),
                                    ("weekyear", -5.3510679319335654),
                                    ("King's Dayyear (latent)", -4.945602823825401),
                                    ("hh:mmin|during the <part-of-day>", -5.53338948872752),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.044215112493511),
                                    ("Hanukkahyear (latent)", -5.75653304004173),
                                    ("February<time> <part-of-day>", -6.4496802206016755),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.4496802206016755),
                                    ("Great Lentyear (latent)", -6.4496802206016755),
                                    ("tomorrowat <time-of-day>", -5.75653304004173),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.4496802206016755),
                                    ("Ugadiyear (latent)", -5.063385859481785),
                                    ("Vaisakhiyear (latent)", -5.75653304004173),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.75653304004173),
                                    ("last <cycle> of <time>year (latent)", -5.75653304004173),
                                    ("at <time-of-day>tomorrow", -6.044215112493511),
                                    ("tomorrow<time-of-day> am|pm", -6.4496802206016755),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.4496802206016755),
                                    ("Diwaliyear (latent)", -6.4496802206016755),
                                    ("between <time> and <time>on <day>", -6.044215112493511),
                                    ("Black Fridayyear (latent)", -6.044215112493511),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.4496802206016755),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.4496802206016755),
                                    ("Chhathyear (latent)", -6.044215112493511),
                                    ("Vasant Panchamiyear (latent)", -6.4496802206016755),
                                    ("Rabindra Jayantiyear (latent)", -5.196917252106307),
                                    ("St Patrick's Dayyear (latent)", -6.4496802206016755),
                                    ("Thursday<time> (timezone)", -6.4496802206016755),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.4496802206016755),
                                    ("Pargat Diwasyear (latent)", -5.196917252106307),
                                    ("<datetime> - <datetime> (interval)July", -6.044215112493511),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.75653304004173),
                                    ("Februaryintersect", -6.4496802206016755),
                                    ("Mother's Dayyear (latent)", -6.4496802206016755),
                                    ("Simchat Torahyear (latent)", -6.4496802206016755),
                                    ("Victoria Dayyear (latent)", -6.044215112493511),
                                    ("minuteyear", -6.4496802206016755)],
                               n = 487},
                   koData =
                     ClassData{prior = -1.019175458020075, unseen = -6.7357800142423265,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.537367082636728),
                                    ("hourday", -3.643549206614632),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.041444479413003),
                                    ("<day-of-month> (ordinal)August", -6.041444479413003),
                                    ("dayhour", -3.367295829986474),
                                    ("<time> timezoneyear (latent)", -5.3482972988530575),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.125153747538848),
                                    ("Tuesdayfrom|since|after <time>", -5.3482972988530575),
                                    ("daymonth", -3.367295829986474),
                                    ("monthyear", -4.788681510917635),
                                    ("<time-of-day> am|pmyear (latent)", -5.3482972988530575),
                                    ("Thai Pongalyear (latent)", -5.3482972988530575),
                                    ("intersecthh:mm", -6.041444479413003),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.635979371304838),
                                    ("<day-of-month> (ordinal)Wednesday", -6.041444479413003),
                                    ("houryear", -4.655150118293112),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.041444479413003),
                                    ("<day-of-month> (ordinal)October", -6.041444479413003),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.3482972988530575),
                                    ("hournograin", -4.788681510917635),
                                    ("<time-of-day> am|pmintersect", -4.788681510917635),
                                    ("Octoberyear (latent)", -6.041444479413003),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.635979371304838),
                                    ("until <time>on <day>", -5.3482972988530575),
                                    ("time-of-day (latent)intersect", -5.3482972988530575),
                                    ("todayin <number> (implicit minutes)", -6.041444479413003),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.3482972988530575),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.041444479413003),
                                    ("hh:mmon <day>", -4.788681510917635),
                                    ("hhhmmintersect", -5.635979371304838),
                                    ("absorption of , after named dayJuly", -5.125153747538848),
                                    ("from|since|after <time>July", -5.635979371304838),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.125153747538848),
                                    ("Clean Mondayyear (latent)", -6.041444479413003),
                                    ("monthhour", -6.041444479413003),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.635979371304838),
                                    ("hourmonth", -4.169642302511411),
                                    ("todayat <time-of-day>", -6.041444479413003),
                                    ("hhhmmyear (latent)", -4.788681510917635),
                                    ("from|since|after <time>December", -6.041444479413003),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.041444479413003),
                                    ("<time-of-day> am|pmon <day>", -4.788681510917635),
                                    ("Mondayyear (latent)", -5.3482972988530575),
                                    ("dayday", -4.655150118293112),
                                    ("mm/ddat <time-of-day>", -5.635979371304838),
                                    ("on <day>September", -5.3482972988530575),
                                    ("time-of-day (latent)September", -5.635979371304838),
                                    ("hourhour", -5.635979371304838),
                                    ("time-of-day (latent)on <day>", -4.537367082636728),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.635979371304838),
                                    ("dayyear", -3.097005500246562),
                                    ("Thursdaymm/dd", -6.041444479413003),
                                    ("New Year's Dayyear (latent)", -5.125153747538848),
                                    ("time-of-day (latent)Sunday", -5.635979371304838),
                                    ("Thursdayfrom|since|after <time>", -4.336696387174578),
                                    ("Thursdayat <time-of-day>", -4.432006566978902),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.041444479413003),
                                    ("Aprilyear (latent)", -6.041444479413003),
                                    ("the <day-of-month> (ordinal)July", -6.041444479413003),
                                    ("the <day-of-month> (number)July", -6.041444479413003),
                                    ("monthminute", -6.041444479413003),
                                    ("<time-of-day> am|pmtomorrow", -6.041444479413003),
                                    ("Thursdayhh:mm", -5.125153747538848),
                                    ("<day-of-month> (ordinal)Tuesday", -5.635979371304838),
                                    ("minutemonth", -3.901378315916732),
                                    ("time-of-day (latent)Friday", -5.635979371304838),
                                    ("minutehour", -6.041444479413003),
                                    ("Augustyear (latent)", -5.635979371304838),
                                    ("week-endin|during <named-month>|year", -6.041444479413003),
                                    ("time-of-day (latent)Tuesday", -5.635979371304838),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.635979371304838),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.041444479413003),
                                    ("Sundayyear (latent)", -5.125153747538848),
                                    ("Christmasat <time-of-day>", -6.041444479413003),
                                    ("from|since|after <time>year (latent)", -4.942832190744893),
                                    ("hhhmmon <day>", -5.125153747538848),
                                    ("yesterday<time-of-day> am|pm", -6.041444479413003),
                                    ("<day-of-month> (ordinal)July", -5.3482972988530575),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.041444479413003),
                                    ("mm/ddyear (latent)", -6.041444479413003),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.041444479413003),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.041444479413003),
                                    ("at <time-of-day>intersect", -5.125153747538848),
                                    ("hh:mmyear (latent)", -4.655150118293112),
                                    ("Holiyear (latent)", -6.041444479413003),
                                    ("until <time><time-of-day> am|pm", -6.041444479413003),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.635979371304838),
                                    ("dayminute", -3.1792435984835343),
                                    ("yyyy-mm-ddhh:mm", -5.635979371304838),
                                    ("intersectfrom|since|after <time>", -5.635979371304838),
                                    ("intersectSeptember", -4.169642302511411),
                                    ("minuteday", -2.8844440582628894),
                                    ("absorption of , after named dayintersect",
                                     -6.041444479413003),
                                    ("intersectyear (latent)", -6.041444479413003),
                                    ("Februaryin|during the <part-of-day>", -6.041444479413003),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.041444479413003),
                                    ("time-of-day (latent)July", -5.3482972988530575),
                                    ("Saturdayyear (latent)", -6.041444479413003),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.041444479413003),
                                    ("at <time-of-day>on <day>", -5.125153747538848),
                                    ("absorption of , after named daySeptember",
                                     -4.788681510917635),
                                    ("Naraka Chaturdashiyear (latent)", -6.041444479413003),
                                    ("from|since|after <time>on <day>", -5.125153747538848),
                                    ("dayweek", -6.041444479413003),
                                    ("Easter Sundayyear (latent)", -5.635979371304838),
                                    ("Thursday<time-of-day> am|pm", -4.788681510917635),
                                    ("weekyear", -5.635979371304838),
                                    ("time-of-day (latent)Thursday", -5.635979371304838),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.041444479413003),
                                    ("<day-of-month> (ordinal)April", -6.041444479413003),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.635979371304838),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.3482972988530575),
                                    ("Sundayfrom|since|after <time>", -6.041444479413003),
                                    ("absorption of , after named dayFebruary", -5.125153747538848),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.635979371304838),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.041444479413003),
                                    ("tomorrowat <time-of-day>", -6.041444479413003),
                                    ("daynograin", -5.635979371304838),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.635979371304838),
                                    ("last <cycle> of <time>year (latent)", -5.635979371304838),
                                    ("tomorrow<time-of-day> am|pm", -6.041444479413003),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.3482972988530575),
                                    ("Diwaliyear (latent)", -5.635979371304838),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.041444479413003),
                                    ("Fridayyear (latent)", -5.635979371304838),
                                    ("time-of-day (latent)April", -6.041444479413003),
                                    ("minuteyear", -3.8442199020767833)],
                               n = 275}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1399485269451561, unseen = -5.472270673671475,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 233},
                   koData =
                     ClassData{prior = -2.035638919021443, unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
