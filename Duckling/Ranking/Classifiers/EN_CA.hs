      ...
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ...
                     ClassData{prior = -0.6782437750573703,
                               unseen = -5.8289456176102075,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 338},
                   koData =
                     ClassData{prior = -0.7082760621562454, unseen = -5.799092654460526,
       ...
       ("intersect",
        Classifier{okData =
                     ...
                     ClassData{prior = -0.4552716897149041, unseen = -6.852242569051878,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.158037746933798),
                                    ("Father's Dayyear (latent)", -6.158037746933798),
                                    ("Ramadanyear (latent)", -6.158037746933798),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.143134726391533),
                                    ("Bhai Doojyear (latent)", -6.158037746933798),
                                    ("hourday", -4.453289654695372),
                                    ("dayhour", -3.295836866004329),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.143134726391533),
                                    ("Martin Luther King's Dayyear (latent)", -5.752572638825633),
                                    ("Shemini Atzeretyear (latent)", -6.158037746933798),
                                    ("daymonth", -5.241747015059643),
                                    ("monthday", -5.752572638825633),
                                    ("monthyear", -4.366278277705742),
                                    ("yearhour", -5.752572638825633),
                                    ("Yom Ha'atzmautyear (latent)", -6.158037746933798),
                                    ("Vijayadashamiyear (latent)", -6.158037746933798),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.752572638825633),
                                    ("Thanksgiving Dayyear (latent)", -5.059425458265688),
                                    ("Thai Pongalyear (latent)", -5.464890566373852),
                                    ("Thiru Onamyear (latent)", -5.464890566373852),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.158037746933798),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.158037746933798),
                                    ("houryear", -5.464890566373852),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.158037746933798),
                                    ("Christmas<time-of-day> am|pm", -6.158037746933798),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.158037746933798),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.464890566373852),
                                    ("<time-of-day> am|pmintersect", -4.90527477843843),
                                    ("Earth Houryear (latent)", -6.158037746933798),
                                    ("Family Dayyear (latent)", -5.241747015059643),
                                    ("Octoberyear (latent)", -4.653960350157523),
                                    ("intersect<time-of-day> am|pm", -6.158037746933798),
                                    ("Mattu Pongalyear (latent)", -6.158037746933798),
                                    ("Shavuotyear (latent)", -6.158037746933798),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.158037746933798),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.158037746933798),
                                    ("in|within|after <duration>at <time-of-day>",
                                     -6.158037746933798),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.752572638825633),
                                    ("Marchyear (latent)", -6.158037746933798),
                                    ("Sukkotyear (latent)", -5.752572638825633),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.158037746933798),
                                    ("Clean Mondayyear (latent)", -5.752572638825633),
                                    ("monthhour", -5.752572638825633),
                                    ("todayat <time-of-day>", -6.158037746933798),
                                    ("Thursday<time> timezone", -4.212127597878484),
                                    ("from|since|after <time>December", -6.158037746933798),
                                    ("<time-of-day> am|pmon <day>", -4.143134726391533),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.158037746933798),
                                    ("yyyy-mm-ddhh:mm:ss", -5.752572638825633),
                                    ("dayday", -4.143134726391533),
                                    ("<time> <part-of-day>at <time-of-day>", -6.158037746933798),
                                    ("mm/ddat <time-of-day>", -6.158037746933798),
                                    ("tonightat <time-of-day>", -6.158037746933798),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.464890566373852),
                                    ("today<time-of-day> am|pm", -6.158037746933798),
                                    ("Februarythe <day-of-month> (ordinal)", -5.752572638825633),
                                    ("at <time-of-day><time> <part-of-day>", -6.158037746933798),
                                    ("mm/dd<time-of-day> am|pm", -6.158037746933798),
                                    ("hourhour", -4.90527477843843),
                                    ("Navaratriin|during <named-month>|year", -6.158037746933798),
                                    ("National Patriots' Dayyear (latent)", -5.464890566373852),
                                    ("Wednesdaythis|last|next <cycle>", -6.158037746933798),
                                    ("Lentyear (latent)", -6.158037746933798),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.653960350157523),
                                    ("Boghiyear (latent)", -6.158037746933798),
                                    ("dayyear", -1.9683830049073718),
                                    ("Thursdayfrom|since|after <time>", -5.752572638825633),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.158037746933798),
                                    ("Thursdayat <time-of-day>", -5.464890566373852),
                                    ("Islamic New Yearyear (latent)", -5.752572638825633),
                                    ("Laylat al-Qadryear (latent)", -5.241747015059643),
                                    ("Discovery Dayyear (latent)", -5.752572638825633),
                                    ("Shrove Tuesdayyear (latent)", -6.158037746933798),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.464890566373852),
                                    ("<time-of-day> am|pmtomorrow", -5.464890566373852),
                                    ("Yom Kippuryear (latent)", -6.158037746933798),
                                    ("<part-of-day> of <time>year (latent)", -6.158037746933798),
                                    ("minutehour", -5.241747015059643),
                                    ("Kaanum Pongalyear (latent)", -5.752572638825633),
                                    ("Maha Saptamiyear (latent)", -6.158037746933798),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.752572638825633),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.453289654695372),
                                    ("for <duration> from <time>December", -6.158037746933798),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.158037746933798),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.90527477843843),
                                    ("Pentecostyear (latent)", -6.158037746933798),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.90527477843843),
                                    ("Eid al-Fitryear (latent)", -6.158037746933798),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.158037746933798),
                                    ("Mondayin|during the <part-of-day>", -6.158037746933798),
                                    ("Chhathin|during <named-month>|year", -6.158037746933798),
                                    ("Diwaliin|during <named-month>|year", -6.158037746933798),
                                    ("Vaisakhiin|during <named-month>|year", -6.158037746933798),
                                    ("Raksha Bandhanyear (latent)", -6.158037746933798),
                                    ("daysecond", -5.752572638825633),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.752572638825633),
                                    ("Ashurayear (latent)", -6.158037746933798),
                                    ("Tuesdayin|during <named-month>|year", -6.158037746933798),
                                    ("Chinese New Yearyear (latent)", -6.158037746933798),
                                    ("Lag BaOmeryear (latent)", -6.158037746933798),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.158037746933798),
                                    ("Eid al-Adhayear (latent)", -5.241747015059643),
                                    ("intersectin|during the <part-of-day>", -6.158037746933798),
                                    ("Palm Sundayyear (latent)", -6.158037746933798),
                                    ("Christmasat <time-of-day>", -6.158037746933798),
                                    ("Passoveryear (latent)", -6.158037746933798),
                                    ("Lazarus Saturdayyear (latent)", -6.158037746933798),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.158037746933798),
                                    ("Yom HaShoahyear (latent)", -5.752572638825633),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.752572638825633),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.158037746933798),
                                    ("Septemberyear (latent)", -5.752572638825633),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.653960350157523),
                                    ("Halloweenyear (latent)", -6.158037746933798),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.158037746933798),
                                    ("at <time-of-day>intersect", -5.752572638825633),
                                    ("Rosh Hashanahyear (latent)", -5.464890566373852),
                                    ("Dhanterasyear (latent)", -6.158037746933798),
                                    ("Tu BiShvatyear (latent)", -6.158037746933798),
                                    ("Holiyear (latent)", -5.464890566373852),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.158037746933798),
                                    ("Holika Dahanyear (latent)", -5.464890566373852),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.158037746933798),
                                    ("dayminute", -3.2402670148495183),
                                    ("Mawlidyear (latent)", -6.158037746933798),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.752572638825633),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.158037746933798),
                                    ("Jumu'atul-Widayear (latent)", -5.241747015059643),
                                    ("minuteday", -2.329396350444702),
                                    ("absorption of , after named dayintersect",
                                     -6.158037746933798),
                                    ("in|within|after <duration><time-of-day> am|pm",
                                     -6.158037746933798),
                                    ("Orthodox Easter Sundayyear (latent)", -6.158037746933798),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.158037746933798),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.158037746933798),
                                    ("Boss's Dayyear (latent)", -5.752572638825633),
                                    ("Global Youth Service Dayyear (latent)", -6.158037746933798),
                                    ("Dhanterasin|during <named-month>|year", -6.158037746933798),
                                    ("Tisha B'Avyear (latent)", -6.158037746933798),
                                    ("Isra and Mi'rajyear (latent)", -5.241747015059643),
                                    ("at <time-of-day>on <day>", -5.059425458265688),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.158037746933798),
                                    ("Christmasyear (latent)", -5.752572638825633),
                                    ("Naraka Chaturdashiyear (latent)", -5.752572638825633),
                                    ("Thai Pongalin|during <named-month>|year", -6.158037746933798),
                                    ("dayweek", -6.158037746933798),
                                    ("Easter Sundayyear (latent)", -5.464890566373852),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.548599834499697),
                                    ("Labour Dayyear (latent)", -6.158037746933798),
                                    ("weekyear", -5.059425458265688),
                                    ("hh:mmin|during the <part-of-day>", -5.464890566373852),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.752572638825633),
                                    ("Hanukkahyear (latent)", -5.464890566373852),
                                    ("February<time> <part-of-day>", -6.158037746933798),
                                    ("Great Lentyear (latent)", -6.158037746933798),
                                    ("tomorrowat <time-of-day>", -5.464890566373852),
                                    ("Vaisakhiyear (latent)", -5.464890566373852),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.158037746933798),
                                    ("last <cycle> of <time>year (latent)", -5.464890566373852),
                                    ("at <time-of-day>tomorrow", -5.752572638825633),
                                    ("tomorrow<time-of-day> am|pm", -6.158037746933798),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.158037746933798),
                                    ("Diwaliyear (latent)", -6.158037746933798),
                                    ("between <time> and <time>on <day>", -4.548599834499697),
                                    ("Black Fridayyear (latent)", -5.752572638825633),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.158037746933798),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.158037746933798),
                                    ("Chhathyear (latent)", -5.752572638825633),
                                    ("Vasant Panchamiyear (latent)", -6.158037746933798),
                                    ("Thursday<time> (timezone)", -6.158037746933798),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.158037746933798),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.752572638825633),
                                    ("Februaryintersect", -6.158037746933798),
                                    ("Mother's Dayyear (latent)", -6.158037746933798),
                                    ("Simchat Torahyear (latent)", -6.158037746933798),
                                    ("Victoria Dayyear (latent)", -5.752572638825633),
                                    ("minuteyear", -6.158037746933798)],
                               n = 359},
                   koData =
                     ClassData{prior = -1.0058752849378139, unseen = -6.464588303689961,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.853591544486569),
                                    ("dayhour", -3.095733626934196),
                                    ("<time> timezoneyear (latent)", -5.7698822763607245),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.853591544486569),
                                    ("Tuesdayfrom|since|after <time>", -5.7698822763607245),
                                    ("daymonth", -3.75497925581846),
                                    ("monthyear", -4.517119307865356),
                                    ("yearhour", -5.7698822763607245),
                                    ("<time-of-day> am|pmyear (latent)", -5.076735095800779),
                                    ("Thai Pongalyear (latent)", -5.076735095800779),
                                    ("intersecthh:mm", -5.7698822763607245),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.7698822763607245),
                                    ("houryear", -4.671269987692615),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.7698822763607245),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.076735095800779),
                                    ("<time-of-day> am|pmintersect", -4.517119307865356),
                                    ("Octoberyear (latent)", -5.7698822763607245),
                                    ("until <time>on <day>", -5.076735095800779),
                                    ("in|within|after <duration>at <time-of-day>",
                                     -5.7698822763607245),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.076735095800779),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.7698822763607245),
                                    ("hh:mmon <day>", -3.32753524099152),
                                    ("absorption of , after named dayJuly", -5.36441716825256),
                                    ("from|since|after <time>July", -5.7698822763607245),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.853591544486569),
                                    ("Clean Mondayyear (latent)", -5.7698822763607245),
                                    ("monthhour", -5.7698822763607245),
                                    ("hourmonth", -4.853591544486569),
                                    ("todayat <time-of-day>", -5.7698822763607245),
                                    ("from|since|after <time>December", -5.7698822763607245),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.7698822763607245),
                                    ("<time-of-day> am|pmon <day>", -4.517119307865356),
                                    ("Mondayyear (latent)", -5.076735095800779),
                                    ("dayday", -5.36441716825256),
                                    ("mm/ddat <time-of-day>", -5.36441716825256),
                                    ("on <day>September", -5.36441716825256),
                                    ("dayyear", -2.87951051846456),
                                    ("Thursdaymm/dd", -5.7698822763607245),
                                    ("New Year's Dayyear (latent)", -5.36441716825256),
                                    ("Thursdayfrom|since|after <time>", -4.065134184122299),
                                    ("Thursdayat <time-of-day>", -4.160444363926624),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.7698822763607245),
                                    ("Aprilyear (latent)", -5.7698822763607245),
                                    ("monthminute", -5.7698822763607245),
                                    ("<time-of-day> am|pmtomorrow", -5.7698822763607245),
                                    ("Thursdayhh:mm", -4.853591544486569),
                                    ("minutemonth", -3.9781228071326695),
                                    ("Augustyear (latent)", -5.36441716825256),
                                    ("week-endin|during <named-month>|year", -5.7698822763607245),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.36441716825256),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.7698822763607245),
                                    ("Sundayyear (latent)", -4.853591544486569),
                                    ("Christmasat <time-of-day>", -5.7698822763607245),
                                    ("from|since|after <time>year (latent)", -4.671269987692615),
                                    ("<duration> after|before|from <time>December",
                                     -5.7698822763607245),
                                    ("yesterday<time-of-day> am|pm", -5.7698822763607245),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.7698822763607245),
                                    ("mm/ddyear (latent)", -5.7698822763607245),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.7698822763607245),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.7698822763607245),
                                    ("at <time-of-day>intersect", -5.36441716825256),
                                    ("hh:mmyear (latent)", -3.6904407346808887),
                                    ("Holiyear (latent)", -5.7698822763607245),
                                    ("until <time><time-of-day> am|pm", -5.7698822763607245),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7698822763607245),
                                    ("dayminute", -3.2049329188991877),
                                    ("yyyy-mm-ddhh:mm", -5.36441716825256),
                                    ("intersectSeptember", -4.265804879584451),
                                    ("minuteday", -2.531203824196344),
                                    ("absorption of , after named dayintersect",
                                     -5.7698822763607245),
                                    ("Februaryin|during the <part-of-day>", -5.7698822763607245),
                                    ("Saturdayyear (latent)", -5.7698822763607245),
                                    ("at <time-of-day>on <day>", -5.36441716825256),
                                    ("absorption of , after named daySeptember",
                                     -4.853591544486569),
                                    ("Naraka Chaturdashiyear (latent)", -5.7698822763607245),
                                    ("from|since|after <time>on <day>", -4.853591544486569),
                                    ("dayweek", -5.7698822763607245),
                                    ("Easter Sundayyear (latent)", -5.36441716825256),
                                    ("Thursday<time-of-day> am|pm", -4.517119307865356),
                                    ("weekyear", -5.36441716825256),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.076735095800779),
                                    ("Sundayfrom|since|after <time>", -5.7698822763607245),
                                    ("absorption of , after named dayFebruary", -4.853591544486569),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.7698822763607245),
                                    ("tomorrowat <time-of-day>", -5.7698822763607245),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.7698822763607245),
                                    ("last <cycle> of <time>year (latent)", -5.36441716825256),
                                    ("tomorrow<time-of-day> am|pm", -5.7698822763607245),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.076735095800779),
                                    ("Diwaliyear (latent)", -5.36441716825256),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.7698822763607245),
                                    ("Fridayyear (latent)", -5.36441716825256),
                                    ("minuteyear", -3.5726576990245054)],
                               n = 207}}),
       ...
       ("year (latent)",
        Classifier{okData =
                     ...
                     ClassData{prior = -0.19895395684309664,
                               unseen = -5.099866427824199,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 159},
                   koData =
                     ClassData{prior = -1.7125100975739145,
                               unseen = -3.6888794541139363,
