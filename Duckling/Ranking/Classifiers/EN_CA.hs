...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6117212101423798, unseen = -6.049733455231958,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 422},
                   koData =
                     ClassData{prior = -0.7817957933263611, unseen = -5.8805329864007,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.484291587675911, unseen = -7.057036981697891,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.363028103540465),
                                    ("Father's Dayyear (latent)", -6.363028103540465),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.363028103540465),
                                    ("Ramadanyear (latent)", -5.44673737166631),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.3481250829982),
                                    ("Bhai Doojyear (latent)", -6.363028103540465),
                                    ("hourday", -4.3481250829982), ("dayhour", -3.4185891243740243),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.3481250829982),
                                    ("Martin Luther King's Dayyear (latent)", -5.9575629954323),
                                    ("Shemini Atzeretyear (latent)", -6.363028103540465),
                                    ("daymonth", -4.3481250829982), ("monthday", -5.9575629954323),
                                    ("monthyear", -4.57126863431241),
                                    ("Yom Ha'atzmautyear (latent)", -6.363028103540465),
                                    ("Vijayadashamiyear (latent)", -6.363028103540465),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.9575629954323),
                                    ("Thanksgiving Dayyear (latent)", -5.264415814872355),
                                    ("Thai Pongalyear (latent)", -5.66988092298052),
                                    ("Thiru Onamyear (latent)", -5.66988092298052),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.363028103540465),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.44673737166631),
                                    ("<day-of-month> (ordinal)Wednesday", -6.363028103540465),
                                    ("Krishna Janmashtamiyear (latent)", -5.9575629954323),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.363028103540465),
                                    ("houryear", -5.44673737166631),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.363028103540465),
                                    ("Christmas<time-of-day> am|pm", -6.363028103540465),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.363028103540465),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.66988092298052),
                                    ("intersectin|during <named-month>|year", -6.363028103540465),
                                    ("<time-of-day> am|pmintersect", -5.110265135045097),
                                    ("Earth Houryear (latent)", -6.363028103540465),
                                    ("Family Dayyear (latent)", -5.44673737166631),
                                    ("Octoberyear (latent)", -4.858950706764191),
                                    ("intersect<time-of-day> am|pm", -6.363028103540465),
                                    ("Mattu Pongalyear (latent)", -6.363028103540465),
                                    ("Shavuotyear (latent)", -6.363028103540465),
                                    ("Parsi New Yearyear (latent)", -5.44673737166631),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.363028103540465),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.363028103540465),
                                    ("todayin|within|after <duration>", -6.363028103540465),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.9575629954323),
                                    ("Marchyear (latent)", -6.363028103540465),
                                    ("Sukkotyear (latent)", -5.9575629954323),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.9575629954323),
                                    ("Clean Mondayyear (latent)", -5.9575629954323),
                                    ("monthhour", -5.9575629954323),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.66988092298052),
                                    ("todayat <time-of-day>", -6.363028103540465),
                                    ("Thursday<time> timezone", -4.4171179544851515),
                                    ("time-of-day (latent)tonight", -5.9575629954323),
                                    ("from|since|after <time>December", -6.363028103540465),
                                    ("<time-of-day> am|pmon <day>", -4.3481250829982),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.363028103540465),
                                    ("yyyy-mm-ddhh:mm:ss", -5.9575629954323),
                                    ("dayday", -3.9206810681712607),
                                    ("<time> <part-of-day>at <time-of-day>", -6.363028103540465),
                                    ("mm/ddat <time-of-day>", -6.363028103540465),
                                    ("tonightat <time-of-day>", -6.363028103540465),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.66988092298052),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.363028103540465),
                                    ("today<time-of-day> am|pm", -6.363028103540465),
                                    ("Februarythe <day-of-month> (ordinal)", -5.9575629954323),
                                    ("at <time-of-day><time> <part-of-day>", -6.363028103540465),
                                    ("<day-of-month> (ordinal)intersect", -5.9575629954323),
                                    ("mm/dd<time-of-day> am|pm", -6.363028103540465),
                                    ("hourhour", -4.283586561860629),
                                    ("Navaratriin|during <named-month>|year", -6.363028103540465),
                                    ("National Patriots' Dayyear (latent)", -5.66988092298052),
                                    ("Wednesdaythis|last|next <cycle>", -6.363028103540465),
                                    ("Lentyear (latent)", -6.363028103540465),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.858950706764191),
                                    ("Boghiyear (latent)", -6.363028103540465),
                                    ("dayyear", -1.8576782528345845),
                                    ("Thursdayfrom|since|after <time>", -5.9575629954323),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.363028103540465),
                                    ("Thursdayat <time-of-day>", -5.66988092298052),
                                    ("Islamic New Yearyear (latent)", -5.9575629954323),
                                    ("Laylat al-Qadryear (latent)", -5.44673737166631),
                                    ("Discovery Dayyear (latent)", -5.9575629954323),
                                    ("Shrove Tuesdayyear (latent)", -6.363028103540465),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.66988092298052),
                                    ("<time-of-day> am|pmtomorrow", -5.66988092298052),
                                    ("Yom Kippuryear (latent)", -6.363028103540465),
                                    ("<day-of-month> (ordinal)Tuesday", -5.9575629954323),
                                    ("<part-of-day> of <time>year (latent)", -6.363028103540465),
                                    ("minutehour", -5.110265135045097),
                                    ("Kaanum Pongalyear (latent)", -5.9575629954323),
                                    ("Maha Saptamiyear (latent)", -6.363028103540465),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.9575629954323),
                                    ("time-of-day (latent)tomorrow", -5.44673737166631),
                                    ("part of daysat <time-of-day>", -5.9575629954323),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.65828001130204),
                                    ("for <duration> from <time>December", -6.363028103540465),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.363028103540465),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.110265135045097),
                                    ("time-of-day (latent)this <part-of-day>", -6.363028103540465),
                                    ("Pentecostyear (latent)", -6.363028103540465),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.110265135045097),
                                    ("<day-of-month> (ordinal)February", -6.363028103540465),
                                    ("Eid al-Fitryear (latent)", -5.44673737166631),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.363028103540465),
                                    ("Mondayin|during the <part-of-day>", -6.363028103540465),
                                    ("Chhathin|during <named-month>|year", -6.363028103540465),
                                    ("Diwaliin|during <named-month>|year", -6.363028103540465),
                                    ("Vaisakhiin|during <named-month>|year", -6.363028103540465),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.110265135045097),
                                    ("Raksha Bandhanyear (latent)", -6.363028103540465),
                                    ("daysecond", -5.9575629954323),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.9575629954323),
                                    ("Ashurayear (latent)", -6.363028103540465),
                                    ("Tuesdayin|during <named-month>|year", -6.363028103540465),
                                    ("Chinese New Yearyear (latent)", -6.363028103540465),
                                    ("tomorrowintersect", -6.363028103540465),
                                    ("Lag BaOmeryear (latent)", -6.363028103540465),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.363028103540465),
                                    ("Eid al-Adhayear (latent)", -4.222961940044194),
                                    ("intersectin|during the <part-of-day>", -6.363028103540465),
                                    ("Palm Sundayyear (latent)", -6.363028103540465),
                                    ("Christmasat <time-of-day>", -6.363028103540465),
                                    ("Passoveryear (latent)", -6.363028103540465),
                                    ("Lazarus Saturdayyear (latent)", -6.363028103540465),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.363028103540465),
                                    ("Yom HaShoahyear (latent)", -5.9575629954323),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.9575629954323),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.363028103540465),
                                    ("Septemberyear (latent)", -5.9575629954323),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.858950706764191),
                                    ("Halloweenyear (latent)", -6.363028103540465),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.363028103540465),
                                    ("at <time-of-day>intersect", -5.9575629954323),
                                    ("Rosh Hashanahyear (latent)", -5.66988092298052),
                                    ("Dhanterasyear (latent)", -6.363028103540465),
                                    ("Tu BiShvatyear (latent)", -6.363028103540465),
                                    ("<day-of-month> (ordinal)December", -5.66988092298052),
                                    ("Holiyear (latent)", -5.66988092298052),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.363028103540465),
                                    ("Holika Dahanyear (latent)", -5.66988092298052),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.363028103540465),
                                    ("dayminute", -3.445257371456186),
                                    ("Mawlidyear (latent)", -6.363028103540465),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.9575629954323),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.363028103540465),
                                    ("Jumu'atul-Widayear (latent)", -5.44673737166631),
                                    ("minuteday", -2.53438670705137),
                                    ("absorption of , after named dayintersect",
                                     -6.363028103540465),
                                    ("intersectyear (latent)", -6.363028103540465),
                                    ("Orthodox Easter Sundayyear (latent)", -6.363028103540465),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.363028103540465),
                                    ("Boss's Dayyear (latent)", -5.9575629954323),
                                    ("Global Youth Service Dayyear (latent)", -6.363028103540465),
                                    ("Dhanterasin|during <named-month>|year", -6.363028103540465),
                                    ("Tisha B'Avyear (latent)", -6.363028103540465),
                                    ("Isra and Mi'rajyear (latent)", -5.44673737166631),
                                    ("at <time-of-day>on <day>", -5.264415814872355),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.363028103540465),
                                    ("time-of-day (latent)<time> <part-of-day>", -5.66988092298052),
                                    ("Christmasyear (latent)", -5.9575629954323),
                                    ("Naraka Chaturdashiyear (latent)", -5.9575629954323),
                                    ("Thai Pongalin|during <named-month>|year", -6.363028103540465),
                                    ("dayweek", -6.363028103540465),
                                    ("Easter Sundayyear (latent)", -5.66988092298052),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.7535901911063645),
                                    ("Labour Dayyear (latent)", -6.363028103540465),
                                    ("weekyear", -5.264415814872355),
                                    ("King's Dayyear (latent)", -4.858950706764191),
                                    ("hh:mmin|during the <part-of-day>", -5.44673737166631),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.9575629954323),
                                    ("Hanukkahyear (latent)", -5.66988092298052),
                                    ("February<time> <part-of-day>", -6.363028103540465),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.363028103540465),
                                    ("Great Lentyear (latent)", -6.363028103540465),
                                    ("tomorrowat <time-of-day>", -5.66988092298052),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.363028103540465),
                                    ("Vaisakhiyear (latent)", -5.66988092298052),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.363028103540465),
                                    ("last <cycle> of <time>year (latent)", -5.66988092298052),
                                    ("at <time-of-day>tomorrow", -5.9575629954323),
                                    ("tomorrow<time-of-day> am|pm", -6.363028103540465),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.363028103540465),
                                    ("Diwaliyear (latent)", -6.363028103540465),
                                    ("between <time> and <time>on <day>", -4.7535901911063645),
                                    ("Black Fridayyear (latent)", -5.9575629954323),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.363028103540465),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.363028103540465),
                                    ("Chhathyear (latent)", -5.9575629954323),
                                    ("Vasant Panchamiyear (latent)", -6.363028103540465),
                                    ("Rabindra Jayantiyear (latent)", -5.110265135045097),
                                    ("St Patrick's Dayyear (latent)", -6.363028103540465),
                                    ("Thursday<time> (timezone)", -6.363028103540465),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.363028103540465),
                                    ("<datetime> - <datetime> (interval)July", -5.9575629954323),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.9575629954323),
                                    ("Februaryintersect", -6.363028103540465),
                                    ("Mother's Dayyear (latent)", -6.363028103540465),
                                    ("Simchat Torahyear (latent)", -6.363028103540465),
                                    ("Victoria Dayyear (latent)", -5.9575629954323),
                                    ("minuteyear", -6.363028103540465)],
                               n = 443},
                   koData =
                     ClassData{prior = -0.9574604920038966, unseen = -6.717804695023691,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.133075835064868),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.023447592961032),
                                    ("<day-of-month> (ordinal)August", -6.023447592961032),
                                    ("dayhour", -3.349298943534504),
                                    ("<time> timezoneyear (latent)", -6.023447592961032),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.107156861086878),
                                    ("Tuesdayfrom|since|after <time>", -5.330300412401088),
                                    ("daymonth", -3.5385409431730324),
                                    ("monthyear", -4.770684624465665),
                                    ("<time-of-day> am|pmyear (latent)", -5.330300412401088),
                                    ("Thai Pongalyear (latent)", -5.330300412401088),
                                    ("intersecthh:mm", -6.023447592961032),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.6179824848528686),
                                    ("<day-of-month> (ordinal)Wednesday", -6.023447592961032),
                                    ("houryear", -4.637153231841142),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.023447592961032),
                                    ("<day-of-month> (ordinal)October", -6.023447592961032),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.330300412401088),
                                    ("hournograin", -4.770684624465665),
                                    ("<time-of-day> am|pmintersect", -4.770684624465665),
                                    ("Octoberyear (latent)", -6.023447592961032),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.6179824848528686),
                                    ("until <time>on <day>", -5.330300412401088),
                                    ("time-of-day (latent)intersect", -5.330300412401088),
                                    ("todayin <number> (implicit minutes)", -6.023447592961032),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.330300412401088),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.023447592961032),
                                    ("hh:mmon <day>", -3.5811005575918284),
                                    ("absorption of , after named dayJuly", -5.6179824848528686),
                                    ("from|since|after <time>July", -5.6179824848528686),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.107156861086878),
                                    ("Clean Mondayyear (latent)", -6.023447592961032),
                                    ("monthhour", -6.023447592961032),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.6179824848528686),
                                    ("hourmonth", -4.151645416059441),
                                    ...
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.023447592961032),
                                    ("<time-of-day> am|pmon <day>", -4.770684624465665),
                                    ("Mondayyear (latent)", -5.330300412401088),
                                    ("dayday", -4.637153231841142),
                                    ("mm/ddat <time-of-day>", -5.6179824848528686),
                                    ("on <day>September", -5.6179824848528686),
                                    ("time-of-day (latent)September", -5.6179824848528686),
                                    ("hourhour", -5.6179824848528686),
                                    ("time-of-day (latent)on <day>", -3.5811005575918284),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.6179824848528686),
                                    ("dayyear", -3.0790086137945925),
                                    ("Thursdaymm/dd", -6.023447592961032),
                                    ("New Year's Dayyear (latent)", -5.107156861086878),
                                    ("time-of-day (latent)Sunday", -5.6179824848528686),
                                    ("Thursdayfrom|since|after <time>", -4.318699500722608),
                                    ("Thursdayat <time-of-day>", -4.414009680526933),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.023447592961032),
                                    ("Aprilyear (latent)", -6.023447592961032),
                                    ("the <day-of-month> (ordinal)July", -6.023447592961032),
                                    ("the <day-of-month> (number)July", -6.023447592961032),
                                    ("monthminute", -6.023447592961032),
                                    ("<time-of-day> am|pmtomorrow", -6.023447592961032),
                                    ("Thursdayhh:mm", -5.107156861086878),
                                    ("<day-of-month> (ordinal)Tuesday", -5.6179824848528686),
                                    ("minutemonth", -4.151645416059441),
                                    ("time-of-day (latent)Friday", -5.6179824848528686),
                                    ("minutehour", -6.023447592961032),
                                    ("Augustyear (latent)", -5.6179824848528686),
                                    ("week-endin|during <named-month>|year", -6.023447592961032),
                                    ("time-of-day (latent)Tuesday", -5.6179824848528686),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.6179824848528686),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.023447592961032),
                                    ("Sundayyear (latent)", -5.107156861086878),
                                    ("Christmasat <time-of-day>", -6.023447592961032),
                                    ("from|since|after <time>year (latent)", -4.924835304292923),
                                    ("yesterday<time-of-day> am|pm", -6.023447592961032),
                                    ("<day-of-month> (ordinal)July", -5.330300412401088),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.023447592961032),
                                    ("mm/ddyear (latent)", -6.023447592961032),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.023447592961032),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.023447592961032),
                                    ("at <time-of-day>intersect", -5.6179824848528686),
                                    ("hh:mmyear (latent)", -3.944006051281197),
                                    ("Holiyear (latent)", -6.023447592961032),
                                    ("until <time><time-of-day> am|pm", -6.023447592961032),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.023447592961032),
                                    ("dayminute", -3.420757907516649),
                                    ("yyyy-mm-ddhh:mm", -5.6179824848528686),
                                    ("intersectfrom|since|after <time>", -5.6179824848528686),
                                    ("intersectSeptember", -4.5193701961847585),
                                    ("minuteday", -2.7847691407966524),
                                    ("absorption of , after named dayintersect",
                                     -6.023447592961032),
                                    ("intersectyear (latent)", -6.023447592961032),
                                    ("Februaryin|during the <part-of-day>", -6.023447592961032),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.023447592961032),
                                    ("time-of-day (latent)July", -5.330300412401088),
                                    ("Saturdayyear (latent)", -6.023447592961032),
                                    ("at <time-of-day>on <day>", -5.6179824848528686),
                                    ("absorption of , after named daySeptember",
                                     -5.107156861086878),
                                    ("Naraka Chaturdashiyear (latent)", -6.023447592961032),
                                    ("from|since|after <time>on <day>", -5.107156861086878),
                                    ("dayweek", -6.023447592961032),
                                    ("Easter Sundayyear (latent)", -5.6179824848528686),
                                    ("Thursday<time-of-day> am|pm", -4.770684624465665),
                                    ("weekyear", -5.6179824848528686),
                                    ("time-of-day (latent)Thursday", -5.6179824848528686),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.023447592961032),
                                    ("<day-of-month> (ordinal)April", -6.023447592961032),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.6179824848528686),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.330300412401088),
                                    ("Sundayfrom|since|after <time>", -6.023447592961032),
                                    ("absorption of , after named dayFebruary", -5.107156861086878),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.6179824848528686),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.023447592961032),
                                    ("tomorrowat <time-of-day>", -6.023447592961032),
                                    ("daynograin", -5.6179824848528686),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.330300412401088),
                                    ("Diwaliyear (latent)", -5.6179824848528686),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.023447592961032),
                                    ("Fridayyear (latent)", -5.6179824848528686),
                                    ("time-of-day (latent)April", -6.023447592961032),
                                    ("minuteyear", -3.8262230156248136)],
                               n = 276}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.10880285984879906,
                               unseen = -5.2832037287379885,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.639057329615259),
                                    ("integer (0..19)year (grain)", -3.0808900818942977),
                                    ("integer (numeric)day (grain)", -2.639057329615259),
                                    ("integer (0..19)second (grain) ", -3.891820298110627),
                                    ("integer (0..19)hour (grain)", -3.0808900818942977),
                                    ("second", -3.4863551900024623),
                                    ("integer (numeric)second (grain) ", -4.179502370562408),
                                    ("integer (numeric)year (grain)", -3.332204510175204),
                                    ("day", -2.3877429013343523), ("year", -2.570064458128307),
                                    ("integer (numeric)week (grain)", -3.1986731175506815),
                                    ("integer (0..19)month (grain)", -3.6686767467964168),
                                    ("integer (20..90)minute (grain)", -4.584967478670572),
                                    ("hour", -2.7131653017689805), ("month", -3.332204510175204),
                                    ("integer (numeric)minute (grain)", -2.7131653017689805),
                                    ("integer (0..19)minute (grain)", -3.1986731175506815),
                                    ("integer (numeric)month (grain)", -4.179502370562408),
                                    ("minute", -2.2335922215070942),
                                    ("integer (numeric)hour (grain)", -3.6686767467964168),
                                    ("integer (0..19)day (grain)", -3.6686767467964168),
                                    ("integer (0..19)week (grain)", -3.332204510175204)],
                               n = 87},
                   koData =
                     ClassData{prior = -2.2721258855093374,
                               unseen = -3.7612001156935624,
                               likelihoods =
                                 HashMap.fromList
