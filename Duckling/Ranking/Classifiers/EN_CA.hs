...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6792166070239986, unseen = -5.541263545158426,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 253},
                   koData =
                     ClassData{prior = -0.7072745598191559,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4726503003981104, unseen = -6.625392368007956,
                               likelihoods =
                                 HashMap.fromList
                                   [("Father's Dayyear (latent)", -5.930918047239948),
                                    ("Ramadanyear (latent)", -5.930918047239948),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.67815507874458),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.67815507874458),
                                    ("hourday", -4.226169955001523),
                                    ("dayhour", -3.013147315155669),
                                    ("Martin Luther King's Dayyear (latent)", -5.5254529391317835),
                                    ("Shemini Atzeretyear (latent)", -5.930918047239948),
                                    ("daymonth", -5.237770866680003),
                                    ("monthday", -5.5254529391317835),
                                    ("monthyear", -4.321480134805848),
                                    ("Yom Ha'atzmautyear (latent)", -5.930918047239948),
                                    ("Thanksgiving Dayyear (latent)", -4.832305758571839),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.930918047239948),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.930918047239948),
                                    ("houryear", -5.5254529391317835),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.930918047239948),
                                    ("Christmas<time-of-day> am|pm", -5.930918047239948),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.930918047239948),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.237770866680003),
                                    ("<time-of-day> am|pmintersect", -4.67815507874458),
                                    ("Family Dayyear (latent)", -5.014627315365793),
                                    ("Octoberyear (latent)", -4.67815507874458),
                                    ("intersect<time-of-day> am|pm", -5.930918047239948),
                                    ("Shavuotyear (latent)", -5.930918047239948),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.930918047239948),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.5254529391317835),
                                    ("Marchyear (latent)", -5.930918047239948),
                                    ("Sukkotyear (latent)", -5.5254529391317835),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.930918047239948),
                                    ("Clean Mondayyear (latent)", -5.5254529391317835),
                                    ("monthhour", -5.5254529391317835),
                                    ("todayat <time-of-day>", -5.930918047239948),
                                    ("Thursday<time> timezone", -4.226169955001523),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.930918047239948),
                                    ("Palm SundaySunday", -5.5254529391317835),
                                    ("dayday", -3.733693469903729),
                                    ("<time> <part-of-day>at <time-of-day>", -5.930918047239948),
                                    ("mm/ddat <time-of-day>", -5.930918047239948),
                                    ("tonightat <time-of-day>", -5.930918047239948),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.237770866680003),
                                    ("today<time-of-day> am|pm", -5.930918047239948),
                                    ("Februarythe <day-of-month> (ordinal)", -5.5254529391317835),
                                    ("at <time-of-day><time> <part-of-day>", -5.930918047239948),
                                    ("mm/dd<time-of-day> am|pm", -5.930918047239948),
                                    ("hourhour", -4.67815507874458),
                                    ("<time-of-day> am|pmon <date>", -3.9160150266976834),
                                    ("National Patriots' Dayyear (latent)", -5.237770866680003),
                                    ("Wednesdaythis|last|next <cycle>", -5.930918047239948),
                                    ("Lentyear (latent)", -5.930918047239948),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.426840650463674),
                                    ("dayyear", -2.146728413321687),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.930918047239948),
                                    ("Thursdayat <time-of-day>", -5.5254529391317835),
                                    ("Islamic New Yearyear (latent)", -5.5254529391317835),
                                    ("Laylat al-Qadryear (latent)", -5.014627315365793),
                                    ("Discovery Dayyear (latent)", -5.5254529391317835),
                                    ("Shrove Tuesdayyear (latent)", -5.930918047239948),
                                    ("<time-of-day> am|pmtomorrow", -5.237770866680003),
                                    ("Yom Kippuryear (latent)", -5.930918047239948),
                                    ("<part-of-day> of <time>year (latent)", -5.930918047239948),
                                    ("minutehour", -5.014627315365793),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.5254529391317835),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.226169955001523),
                                    ("for <duration> from <time>December", -5.930918047239948),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.930918047239948),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.014627315365793),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.5254529391317835),
                                    ("Pentecostyear (latent)", -5.930918047239948),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.014627315365793),
                                    ("Eid al-Fitryear (latent)", -5.930918047239948),
                                    ("Mondayin|during the <part-of-day>", -5.930918047239948),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.5254529391317835),
                                    ("Ashurayear (latent)", -5.930918047239948),
                                    ("Chinese New Yearyear (latent)", -5.930918047239948),
                                    ("Sundayyear (latent)", -5.930918047239948),
                                    ("Lag BaOmeryear (latent)", -5.930918047239948),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.930918047239948),
                                    ("Eid al-Adhayear (latent)", -5.014627315365793),
                                    ("intersectin|during the <part-of-day>", -5.930918047239948),
                                    ("Christmasat <time-of-day>", -5.930918047239948),
                                    ("Passoveryear (latent)", -5.930918047239948),
                                    ("Lazarus Saturdayyear (latent)", -5.930918047239948),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.930918047239948),
                                    ("Yom HaShoahyear (latent)", -5.5254529391317835),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.014627315365793),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.930918047239948),
                                    ("Septemberyear (latent)", -5.5254529391317835),
                                    ("mm/ddyear (latent)", -5.930918047239948),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.67815507874458),
                                    ("Halloweenyear (latent)", -5.930918047239948),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.930918047239948),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.930918047239948),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.930918047239948),
                                    ("dayminute", -3.2918607176246897),
                                    ("Mawlidyear (latent)", -5.930918047239948),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.5254529391317835),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.930918047239948),
                                    ("Jumu'atul-Widayear (latent)", -5.014627315365793),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.930918047239948),
                                    ("minuteday", -2.2933318875135624),
                                    ("absorption of , after named dayintersect",
                                     -5.930918047239948),
                                    ("intersectyear (latent)", -5.930918047239948),
                                    ("Orthodox Easter Sundayyear (latent)", -5.930918047239948),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.930918047239948),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.930918047239948),
                                    ("Boss's Dayyear (latent)", -5.5254529391317835),
                                    ("Tisha B'Avyear (latent)", -5.930918047239948),
                                    ("Isra and Mi'rajyear (latent)", -5.014627315365793),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.930918047239948),
                                    ("Christmasyear (latent)", -5.5254529391317835),
                                    ("at <time-of-day>on <date>", -4.832305758571839),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.321480134805848),
                                    ("dayweek", -5.930918047239948),
                                    ("Easter Sundayyear (latent)", -5.237770866680003),
                                    ("Thursday<time-of-day> am|pm", -5.930918047239948),
                                    ("Labour Dayyear (latent)", -5.930918047239948),
                                    ("weekyear", -5.5254529391317835),
                                    ("hh:mmin|during the <part-of-day>", -5.237770866680003),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.5254529391317835),
                                    ("Hanukkahyear (latent)", -5.930918047239948),
                                    ("February<time> <part-of-day>", -5.930918047239948),
                                    ("Tuesdayin <named-month>|year", -5.930918047239948),
                                    ("Great Lentyear (latent)", -5.930918047239948),
                                    ("tomorrowat <time-of-day>", -5.237770866680003),
                                    ("between <time> and <time>on <date>", -4.321480134805848),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.237770866680003),
                                    ("last <cycle> of <time>year (latent)", -5.237770866680003),
                                    ("at <time-of-day>tomorrow", -5.5254529391317835),
                                    ("tomorrow<time-of-day> am|pm", -5.930918047239948),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.930918047239948),
                                    ("Black Fridayyear (latent)", -5.5254529391317835),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.930918047239948),
                                    ("Palm Sundayintersect", -5.930918047239948),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.930918047239948),
                                    ("Februaryintersect", -5.930918047239948),
                                    ("Mother's Dayyear (latent)", -5.930918047239948),
                                    ("Simchat Torahyear (latent)", -5.930918047239948),
                                    ("Victoria Dayyear (latent)", -5.5254529391317835)],
                               n = 283},
                   koData =
                     ClassData{prior = -0.9764336415386882, unseen = -6.272877006546167,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.577841251298354),
                                    ("hourday", -5.577841251298354),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.577841251298354),
                                    ("dayhour", -3.1354942159291497),
                                    ("daymonth", -3.498399709618518),
                                    ("monthday", -5.172376143190189),
                                    ("monthyear", -4.325078282802986),
                                    ("<time-of-day> am|pmyear (latent)", -5.172376143190189),
                                    ("intersecthh:mm", -5.577841251298354),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.577841251298354),
                                    ("houryear", -4.661550519424199),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.577841251298354),
                                    ("until <time-of-day><time-of-day> am|pm", -5.577841251298354),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.8846940707384086),
                                    ("<time-of-day> am|pmintersect", -4.325078282802986),
                                    ("Octoberyear (latent)", -5.577841251298354),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.325078282802986),
                                    ("from|since|after <time-of-day>on <date>", -4.661550519424199),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.577841251298354),
                                    ("absorption of , after named dayJuly", -5.172376143190189),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.661550519424199),
                                    ("Clean Mondayyear (latent)", -5.577841251298354),
                                    ("monthhour", -5.577841251298354),
                                    ("hourmonth", -4.8846940707384086),
                                    ("todayat <time-of-day>", -5.577841251298354),
                                    ("from|since|after <time-of-day>July", -5.577841251298354),
                                    ("Mondayyear (latent)", -4.8846940707384086),
                                    ("dayday", -5.172376143190189),
                                    ("mm/ddat <time-of-day>", -5.172376143190189),
                                    ("<time-of-day> am|pmon <date>", -4.325078282802986),
                                    ("dayyear", -2.805252529058573),
                                    ("Thursdaymm/dd", -5.577841251298354),
                                    ("New Year's Dayyear (latent)", -5.172376143190189),
                                    ("Thursdayat <time-of-day>", -4.325078282802986),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.577841251298354),
                                    ("Aprilyear (latent)", -5.577841251298354),
                                    ("monthminute", -5.577841251298354),
                                    ("<time-of-day> am|pmtomorrow", -5.577841251298354),
                                    ("Thursdayhh:mm", -4.661550519424199),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.577841251298354),
                                    ("minutemonth", -3.786081782070299),
                                    ("Sundayfrom|since|after <time-of-day>", -5.577841251298354),
                                    ("week-endin <named-month>|year", -5.577841251298354),
                                    ("Augustyear (latent)", -5.172376143190189),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.172376143190189),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.172376143190189),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.577841251298354),
                                    ("Sundayyear (latent)", -4.8846940707384086),
                                    ("Christmasat <time-of-day>", -5.577841251298354),
                                    ("<duration> after|before|from <time>December",
                                     -5.577841251298354),
                                    ("yesterday<time-of-day> am|pm", -5.577841251298354),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.661550519424199),
                                    ("mm/ddyear (latent)", -5.577841251298354),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.172376143190189),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.577841251298354),
                                    ("until <time-of-day>on <date>", -4.8846940707384086),
                                    ("at <time-of-day>intersect", -5.172376143190189),
                                    ("hh:mmyear (latent)", -4.479228962630244),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.577841251298354),
                                    ("dayminute", -3.0929346015103536),
                                    ("intersectSeptember", -4.07376385452208),
                                    ("minuteday", -2.509788316164737),
                                    ("absorption of , after named dayintersect",
                                     -5.577841251298354),
                                    ("Februaryin|during the <part-of-day>", -5.577841251298354),
                                    ("hh:mmon <date>", -3.5629382307560893),
                                    ("Saturdayyear (latent)", -5.577841251298354),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.577841251298354),
                                    ("absorption of , after named daySeptember",
                                     -4.661550519424199),
                                    ("on <date>September", -5.172376143190189),
                                    ("at <time-of-day>on <date>", -5.172376143190189),
                                    ("in <named-month>|yearyear (latent)", -5.577841251298354),
                                    ("dayweek", -5.577841251298354),
                                    ("Easter Sundayyear (latent)", -5.172376143190189),
                                    ("Thursday<time-of-day> am|pm", -5.172376143190189),
                                    ("absorption of , after named dayFebruary", -4.661550519424199),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.577841251298354),
                                    ("tomorrowat <time-of-day>", -5.577841251298354),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.577841251298354),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.968403338864254),
                                    ("tomorrow<time-of-day> am|pm", -5.577841251298354),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.8846940707384086),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.577841251298354),
                                    ("Fridayyear (latent)", -5.172376143190189),
                                    ("minuteyear", -4.325078282802986)],
                               n = 171}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.18721154208814647,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -4.831857727080768e-2),
                                    ("intersect 2 numbers", -3.5648268054439574)],
                               n = 102},
                   koData =
                     ClassData{prior = -1.7676619176489945, unseen = -3.258096538021482,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.5762828404206344, unseen = -4.276666119016055,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 68},
                   koData =
                     ClassData{prior = -0.8254986320446193, unseen = -4.04305126783455,
                               likelihoods =
                                 HashMap.fromList
