...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5993098384999157, unseen = -6.093569770045136,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 441},
                   koData =
                     ClassData{prior = -0.7967105021209906,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46381499117044095,
                               unseen = -7.105786129481271,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.411818267709897),
                                    ("Father's Dayyear (latent)", -6.411818267709897),
                                    ("Karva Chauthyear (latent)", -6.411818267709897),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.411818267709897),
                                    ("Ramadanyear (latent)", -5.495527535835742),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.025523906590006),
                                    ("Bhai Doojyear (latent)", -6.411818267709897),
                                    ("hourday", -4.396915247167632),
                                    ("dayhour", -3.4673792885434565),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.025523906590006),
                                    ("Martin Luther King's Dayyear (latent)", -6.0063531596017325),
                                    ("Shemini Atzeretyear (latent)", -6.411818267709897),
                                    ("daymonth", -4.396915247167632),
                                    ("monthday", -6.0063531596017325),
                                    ("monthyear", -4.620058798481842),
                                    ("Yom Ha'atzmautyear (latent)", -6.411818267709897),
                                    ("Vijayadashamiyear (latent)", -6.411818267709897),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -6.0063531596017325),
                                    ("Thanksgiving Dayyear (latent)", -5.313205979041787),
                                    ("Thai Pongalyear (latent)", -5.718671087149952),
                                    ("Thiru Onamyear (latent)", -5.718671087149952),
                                    ("hhhmmabsorption of , after named day", -6.411818267709897),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.411818267709897),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.495527535835742),
                                    ("<day-of-month> (ordinal)Wednesday", -6.411818267709897),
                                    ("Krishna Janmashtamiyear (latent)", -6.0063531596017325),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.411818267709897),
                                    ("houryear", -5.495527535835742),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.411818267709897),
                                    ("Christmas<time-of-day> am|pm", -6.411818267709897),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.411818267709897),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.718671087149952),
                                    ("intersectin|during <named-month>|year", -6.411818267709897),
                                    ("<time-of-day> am|pmintersect", -5.159055299214529),
                                    ("Earth Houryear (latent)", -6.411818267709897),
                                    ("Family Dayyear (latent)", -5.495527535835742),
                                    ("Octoberyear (latent)", -4.907740870933623),
                                    ("intersect<time-of-day> am|pm", -6.411818267709897),
                                    ("Mattu Pongalyear (latent)", -6.411818267709897),
                                    ("Shavuotyear (latent)", -6.411818267709897),
                                    ("Parsi New Yearyear (latent)", -5.495527535835742),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.411818267709897),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.411818267709897),
                                    ("todayin|within|after <duration>", -6.411818267709897),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.0063531596017325),
                                    ("Marchyear (latent)", -6.411818267709897),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.0063531596017325),
                                    ("Sukkotyear (latent)", -6.0063531596017325),
                                    ("hhhmmintersect", -6.0063531596017325),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.718671087149952),
                                    ("todayat <time-of-day>", -6.411818267709897),
                                    ("Thursday<time> timezone", -4.0139229949115265),
                                    ("time-of-day (latent)tonight", -6.0063531596017325),
                                    ("from|since|after <time>December", -6.411818267709897),
                                    ("<time-of-day> am|pmon <day>", -4.396915247167632),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.411818267709897),
                                    ("yyyy-mm-ddhh:mm:ss", -6.0063531596017325),
                                    ("dayday", -3.703768066607687),
                                    ("<time> <part-of-day>at <time-of-day>", -6.411818267709897),
                                    ("mm/ddat <time-of-day>", -6.411818267709897),
                                    ("tonightat <time-of-day>", -6.411818267709897),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.718671087149952),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.411818267709897),
                                    ("today<time-of-day> am|pm", -6.411818267709897),
                                    ("Februarythe <day-of-month> (ordinal)", -6.0063531596017325),
                                    ("at <time-of-day><time> <part-of-day>", -6.411818267709897),
                                    ("<day-of-month> (ordinal)intersect", -6.0063531596017325),
                                    ("mm/dd<time-of-day> am|pm", -6.411818267709897),
                                    ("hourhour", -4.332376726030061),
                                    ("Mahavir Jayantiyear (latent)", -6.0063531596017325),
                                    ("Navaratriin|during <named-month>|year", -6.411818267709897),
                                    ("National Patriots' Dayyear (latent)", -5.718671087149952),
                                    ("Wednesdaythis|last|next <cycle>", -6.411818267709897),
                                    ("Lentyear (latent)", -6.411818267709897),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.540016090808305),
                                    ("Boghiyear (latent)", -6.411818267709897),
                                    ("dayyear", -1.8846096231915175),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.411818267709897),
                                    ("Thursdayfrom|since|after <time>", -6.0063531596017325),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.411818267709897),
                                    ("Thursdayat <time-of-day>", -5.718671087149952),
                                    ("Islamic New Yearyear (latent)", -6.0063531596017325),
                                    ("Laylat al-Qadryear (latent)", -5.495527535835742),
                                    ("Discovery Dayyear (latent)", -6.0063531596017325),
                                    ("Shrove Tuesdayyear (latent)", -6.411818267709897),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.718671087149952),
                                    ("<time-of-day> am|pmtomorrow", -5.718671087149952),
                                    ("Yom Kippuryear (latent)", -6.411818267709897),
                                    ("<day-of-month> (ordinal)Tuesday", -6.0063531596017325),
                                    ("<part-of-day> of <time>year (latent)", -6.411818267709897),
                                    ("minutehour", -5.159055299214529),
                                    ("Kaanum Pongalyear (latent)", -6.0063531596017325),
                                    ("Maha Saptamiyear (latent)", -6.411818267709897),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.0063531596017325),
                                    ("time-of-day (latent)tomorrow", -5.495527535835742),
                                    ("part of daysat <time-of-day>", -6.0063531596017325),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.396915247167632),
                                    ("for <duration> from <time>December", -6.411818267709897),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.411818267709897),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.159055299214529),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.159055299214529),
                                    ("time-of-day (latent)this <part-of-day>", -6.411818267709897),
                                    ("Pentecostyear (latent)", -6.411818267709897),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.159055299214529),
                                    ("<day-of-month> (ordinal)February", -6.411818267709897),
                                    ("Eid al-Fitryear (latent)", -5.495527535835742),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.411818267709897),
                                    ("Mondayin|during the <part-of-day>", -6.411818267709897),
                                    ("Chhathin|during <named-month>|year", -6.411818267709897),
                                    ("Diwaliin|during <named-month>|year", -6.411818267709897),
                                    ("Vaisakhiin|during <named-month>|year", -6.411818267709897),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.159055299214529),
                                    ("Raksha Bandhanyear (latent)", -6.411818267709897),
                                    ("daysecond", -6.0063531596017325),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.0063531596017325),
                                    ("Ashurayear (latent)", -6.411818267709897),
                                    ("Tuesdayin|during <named-month>|year", -6.411818267709897),
                                    ("Chinese New Yearyear (latent)", -6.411818267709897),
                                    ("tomorrowintersect", -6.411818267709897),
                                    ("Lag BaOmeryear (latent)", -6.411818267709897),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.411818267709897),
                                    ("Eid al-Adhayear (latent)", -4.271752104213626),
                                    ("intersectin|during the <part-of-day>", -6.411818267709897),
                                    ("Palm Sundayyear (latent)", -6.411818267709897),
                                    ("Christmasat <time-of-day>", -6.411818267709897),
                                    ("Passoveryear (latent)", -6.411818267709897),
                                    ("Lazarus Saturdayyear (latent)", -6.411818267709897),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.411818267709897),
                                    ("hhhmmon <day>", -5.495527535835742),
                                    ("Yom HaShoahyear (latent)", -6.0063531596017325),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.0063531596017325),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.411818267709897),
                                    ("Septemberyear (latent)", -6.0063531596017325),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.907740870933623),
                                    ("Halloweenyear (latent)", -6.411818267709897),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.411818267709897),
                                    ("at <time-of-day>intersect", -5.495527535835742),
                                    ("Rosh Hashanahyear (latent)", -5.718671087149952),
                                    ("Dhanterasyear (latent)", -6.411818267709897),
                                    ("Tu BiShvatyear (latent)", -6.411818267709897),
                                    ("<day-of-month> (ordinal)December", -5.718671087149952),
                                    ("Holiyear (latent)", -5.718671087149952),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.411818267709897),
                                    ("Holika Dahanyear (latent)", -5.718671087149952),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0063531596017325),
                                    ("dayminute", -3.0619141804352923),
                                    ("Mawlidyear (latent)", -6.411818267709897),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.0063531596017325),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.411818267709897),
                                    ("Jumu'atul-Widayear (latent)", -5.495527535835742),
                                    ("minuteday", -2.6741486494265287),
                                    ("absorption of , after named dayintersect",
                                     -5.718671087149952),
                                    ("intersectyear (latent)", -6.411818267709897),
                                    ("Orthodox Easter Sundayyear (latent)", -6.411818267709897),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.411818267709897),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.411818267709897),
                                    ("intersecthhhmm", -6.0063531596017325),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.411818267709897),
                                    ("Boss's Dayyear (latent)", -6.0063531596017325),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.411818267709897),
                                    ("Global Youth Service Dayyear (latent)", -6.411818267709897),
                                    ("Dhanterasin|during <named-month>|year", -6.411818267709897),
                                    ("Tisha B'Avyear (latent)", -6.411818267709897),
                                    ("Isra and Mi'rajyear (latent)", -5.495527535835742),
                                    ("at <time-of-day>on <day>", -4.802380355275797),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.0063531596017325),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.718671087149952),
                                    ("Christmasyear (latent)", -6.0063531596017325),
                                    ("Naraka Chaturdashiyear (latent)", -6.0063531596017325),
                                    ("Thai Pongalin|during <named-month>|year", -6.411818267709897),
                                    ("dayweek", -6.411818267709897),
                                    ("Easter Sundayyear (latent)", -5.718671087149952),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.0063531596017325),
                                    ("Labour Dayyear (latent)", -6.411818267709897),
                                    ("weekyear", -5.313205979041787),
                                    ("King's Dayyear (latent)", -4.907740870933623),
                                    ("hh:mmin|during the <part-of-day>", -5.495527535835742),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.0063531596017325),
                                    ("Hanukkahyear (latent)", -5.718671087149952),
                                    ("February<time> <part-of-day>", -6.411818267709897),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.411818267709897),
                                    ("Great Lentyear (latent)", -6.411818267709897),
                                    ("tomorrowat <time-of-day>", -5.718671087149952),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.411818267709897),
                                    ("Vaisakhiyear (latent)", -5.718671087149952),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.718671087149952),
                                    ("last <cycle> of <time>year (latent)", -5.718671087149952),
                                    ("at <time-of-day>tomorrow", -6.0063531596017325),
                                    ("tomorrow<time-of-day> am|pm", -6.411818267709897),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.411818267709897),
                                    ("Diwaliyear (latent)", -6.411818267709897),
                                    ("between <time> and <time>on <day>", -6.0063531596017325),
                                    ("Black Fridayyear (latent)", -6.0063531596017325),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.411818267709897),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.411818267709897),
                                    ("Chhathyear (latent)", -6.0063531596017325),
                                    ("Vasant Panchamiyear (latent)", -6.411818267709897),
                                    ("Rabindra Jayantiyear (latent)", -5.159055299214529),
                                    ("St Patrick's Dayyear (latent)", -6.411818267709897),
                                    ("Thursday<time> (timezone)", -6.411818267709897),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.411818267709897),
                                    ("<datetime> - <datetime> (interval)July", -6.0063531596017325),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.718671087149952),
                                    ("Februaryintersect", -6.411818267709897),
                                    ("Mother's Dayyear (latent)", -6.411818267709897),
                                    ("Simchat Torahyear (latent)", -6.411818267709897),
                                    ("Victoria Dayyear (latent)", -6.0063531596017325),
                                    ("minuteyear", -6.411818267709897)],
                               n = 466},
                   koData =
                     ClassData{prior = -0.9912295276295155, unseen = -6.729824070489475,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.531404035748483),
                                    ("hourday", -3.6375861597263857),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.035481432524756),
                                    ("<day-of-month> (ordinal)August", -6.035481432524756),
                                    ("dayhour", -3.3613327830982276),
                                    ("<time> timezoneyear (latent)", -5.342334251964811),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.119190700650601),
                                    ("Tuesdayfrom|since|after <time>", -5.342334251964811),
                                    ("daymonth", -3.3613327830982276),
                                    ("monthyear", -4.782718464029388),
                                    ("<time-of-day> am|pmyear (latent)", -5.342334251964811),
                                    ("Thai Pongalyear (latent)", -5.342334251964811),
                                    ("intersecthh:mm", -6.035481432524756),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.630016324416592),
                                    ("<day-of-month> (ordinal)Wednesday", -6.035481432524756),
                                    ("houryear", -4.6491870714048655),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.035481432524756),
                                    ("<day-of-month> (ordinal)October", -6.035481432524756),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.342334251964811),
                                    ("hournograin", -4.782718464029388),
                                    ("<time-of-day> am|pmintersect", -4.782718464029388),
                                    ("Octoberyear (latent)", -6.035481432524756),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.630016324416592),
                                    ("until <time>on <day>", -5.342334251964811),
                                    ("time-of-day (latent)intersect", -5.342334251964811),
                                    ("todayin <number> (implicit minutes)", -6.035481432524756),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.342334251964811),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.035481432524756),
                                    ("hh:mmon <day>", -4.782718464029388),
                                    ("hhhmmintersect", -5.630016324416592),
                                    ("absorption of , after named dayJuly", -5.119190700650601),
                                    ("from|since|after <time>July", -5.630016324416592),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.119190700650601),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.630016324416592),
                                    ("hourmonth", -4.1636792556231645),
                                    ("todayat <time-of-day>", -6.035481432524756),
                                    ("hhhmmyear (latent)", -4.782718464029388),
                                    ("from|since|after <time>December", -6.035481432524756),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.035481432524756),
                                    ("<time-of-day> am|pmon <day>", -4.782718464029388),
                                    ("Mondayyear (latent)", -5.342334251964811),
                                    ("dayday", -4.6491870714048655),
                                    ("mm/ddat <time-of-day>", -5.630016324416592),
                                    ("on <day>September", -5.342334251964811),
                                    ("time-of-day (latent)September", -5.630016324416592),
                                    ("hourhour", -5.630016324416592),
                                    ("time-of-day (latent)on <day>", -4.531404035748483),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.630016324416592),
                                    ("dayyear", -3.0910424533583156),
                                    ("Thursdaymm/dd", -6.035481432524756),
                                    ("New Year's Dayyear (latent)", -5.119190700650601),
                                    ("time-of-day (latent)Sunday", -5.630016324416592),
                                    ("Thursdayfrom|since|after <time>", -4.330733340286331),
                                    ("Thursdayat <time-of-day>", -4.426043520090656),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.035481432524756),
                                    ("Aprilyear (latent)", -6.035481432524756),
                                    ("the <day-of-month> (ordinal)July", -6.035481432524756),
                                    ("the <day-of-month> (number)July", -6.035481432524756),
                                    ("monthminute", -6.035481432524756),
                                    ("<time-of-day> am|pmtomorrow", -6.035481432524756),
                                    ("Thursdayhh:mm", -5.119190700650601),
                                    ("<day-of-month> (ordinal)Tuesday", -5.630016324416592),
                                    ("minutemonth", -3.8954152690284856),
                                    ("time-of-day (latent)Friday", -5.630016324416592),
                                    ("minutehour", -6.035481432524756),
                                    ("Augustyear (latent)", -5.630016324416592),
                                    ("week-endin|during <named-month>|year", -6.035481432524756),
                                    ("time-of-day (latent)Tuesday", -5.630016324416592),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.630016324416592),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.035481432524756),
                                    ("Sundayyear (latent)", -5.119190700650601),
                                    ("Christmasat <time-of-day>", -6.035481432524756),
                                    ("from|since|after <time>year (latent)", -4.936869143856646),
                                    ("hhhmmon <day>", -5.119190700650601),
                                    ("yesterday<time-of-day> am|pm", -6.035481432524756),
                                    ("<day-of-month> (ordinal)July", -5.342334251964811),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.035481432524756),
                                    ("mm/ddyear (latent)", -6.035481432524756),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.035481432524756),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.035481432524756),
                                    ("at <time-of-day>intersect", -5.119190700650601),
                                    ("hh:mmyear (latent)", -4.6491870714048655),
                                    ("Holiyear (latent)", -6.035481432524756),
                                    ("until <time><time-of-day> am|pm", -6.035481432524756),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.630016324416592),
                                    ("dayminute", -3.1732805515952878),
                                    ("yyyy-mm-ddhh:mm", -5.630016324416592),
                                    ("intersectfrom|since|after <time>", -5.630016324416592),
                                    ("intersectSeptember", -4.1636792556231645),
                                    ("minuteday", -2.878481011374643),
                                    ("absorption of , after named dayintersect",
                                     -6.035481432524756),
                                    ("intersectyear (latent)", -6.035481432524756),
                                    ("Februaryin|during the <part-of-day>", -6.035481432524756),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.035481432524756),
                                    ("time-of-day (latent)July", -5.342334251964811),
                                    ("Saturdayyear (latent)", -6.035481432524756),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.035481432524756),
                                    ("at <time-of-day>on <day>", -5.119190700650601),
                                    ("absorption of , after named daySeptember",
                                     -4.782718464029388),
                                    ("Naraka Chaturdashiyear (latent)", -6.035481432524756),
                                    ("from|since|after <time>on <day>", -5.119190700650601),
                                    ("dayweek", -6.035481432524756),
                                    ("Easter Sundayyear (latent)", -5.630016324416592),
                                    ("Thursday<time-of-day> am|pm", -4.782718464029388),
                                    ("weekyear", -5.630016324416592),
                                    ("time-of-day (latent)Thursday", -5.630016324416592),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.035481432524756),
                                    ("<day-of-month> (ordinal)April", -6.035481432524756),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.630016324416592),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.342334251964811),
                                    ("Sundayfrom|since|after <time>", -6.035481432524756),
                                    ("absorption of , after named dayFebruary", -5.119190700650601),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.630016324416592),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.035481432524756),
                                    ("tomorrowat <time-of-day>", -6.035481432524756),
                                    ("daynograin", -5.630016324416592),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.630016324416592),
                                    ("last <cycle> of <time>year (latent)", -5.630016324416592),
                                    ("tomorrow<time-of-day> am|pm", -6.035481432524756),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.342334251964811),
                                    ("Diwaliyear (latent)", -5.630016324416592),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.035481432524756),
                                    ("Fridayyear (latent)", -5.630016324416592),
                                    ("time-of-day (latent)April", -6.035481432524756),
                                    ("minuteyear", -3.8382568551885368)],
                               n = 275}}),
       ("one eleven",
        Classifier{okData =
