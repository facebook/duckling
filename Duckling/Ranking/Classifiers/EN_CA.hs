...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4491695423428935, unseen = -7.138866999945524,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.444925853484402),
                                    ...
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.444925853484402),
                                    ("Maha Shivaratriyear (latent)", -6.444925853484402),
                                    ("Ramadanyear (latent)", -5.192162884989034),
                                    ...
                                    ("Family Dayyear (latent)", -5.528635121610247),
                                    ...
                                    ("National Patriots' Dayyear (latent)", -5.751778672924456),
                                    ...
                                    ("Discovery Dayyear (latent)", -6.039460745376237),
                                    ...
                                    ("Eid al-Fitryear (latent)", -5.058631492364511),
                                    ...
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.039460745376237),
                                    ("Labour Dayyear (latent)", -6.444925853484402),
                                    ...
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.444925853484402),
                                    ("Ugadiyear (latent)", -5.058631492364511),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.444925853484402),
                                    ("Pargat Diwasyear (latent)", -5.192162884989034),
                                    ...
                                    ("Victoria Dayyear (latent)", -6.039460745376237),
                                    ("minuteyear", -6.444925853484402)],
                               n = 485},
                   koData =
                     ClassData{prior = -1.0165473356138055, unseen = -6.733401891837359,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.534986129130987),
                                    ("hourday", -3.6411682531088903),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.0390635259072605),
                                    ("<day-of-month> (ordinal)August", -6.0390635259072605),
                                    ("dayhour", -3.364914876480732),
                                    ("<time> timezoneyear (latent)", -5.345916345347316),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.122772794033106),
                                    ("Tuesdayfrom|since|after <time>", -5.345916345347316),
                                    ("daymonth", -3.364914876480732),
                                    ("monthyear", -4.786300557411892),
                                    ("<time-of-day> am|pmyear (latent)", -5.345916345347316),
                                    ("Thai Pongalyear (latent)", -5.345916345347316),
                                    ("intersecthh:mm", -6.0390635259072605),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.633598417799097),
                                    ("<day-of-month> (ordinal)Wednesday", -6.0390635259072605),
                                    ("houryear", -4.652769164787371),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.0390635259072605),
                                    ("<day-of-month> (ordinal)October", -6.0390635259072605),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.345916345347316),
                                    ("hournograin", -4.786300557411892),
                                    ("<time-of-day> am|pmintersect", -4.786300557411892),
                                    ("Octoberyear (latent)", -6.0390635259072605),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.633598417799097),
                                    ("until <time>on <day>", -5.345916345347316),
                                    ("time-of-day (latent)intersect", -5.345916345347316),
                                    ("todayin <number> (implicit minutes)", -6.0390635259072605),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.345916345347316),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.0390635259072605),
                                    ("hh:mmon <day>", -4.786300557411892),
                                    ("hhhmmintersect", -5.633598417799097),
                                    ("absorption of , after named dayJuly", -5.122772794033106),
                                    ("from|since|after <time>July", -5.633598417799097),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.122772794033106),
                                    ("Clean Mondayyear (latent)", -6.0390635259072605),
                                    ("monthhour", -6.0390635259072605),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.633598417799097),
                                    ("hourmonth", -4.16726134900567),
                                    ("todayat <time-of-day>", -6.0390635259072605),
                                    ("hhhmmyear (latent)", -4.786300557411892),
                                    ("from|since|after <time>December", -6.0390635259072605),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.0390635259072605),
                                    ("<time-of-day> am|pmon <day>", -4.786300557411892),
                                    ("Mondayyear (latent)", -5.345916345347316),
                                    ("dayday", -4.652769164787371),
                                    ("mm/ddat <time-of-day>", -5.633598417799097),
                                    ("on <day>September", -5.345916345347316),
                                    ("time-of-day (latent)September", -5.633598417799097),
                                    ("hourhour", -5.633598417799097),
                                    ("time-of-day (latent)on <day>", -4.534986129130987),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.633598417799097),
                                    ("dayyear", -3.09462454674082),
                                    ("Thursdaymm/dd", -6.0390635259072605),
                                    ("New Year's Dayyear (latent)", -5.122772794033106),
                                    ("time-of-day (latent)Sunday", -5.633598417799097),
                                    ("Thursdayfrom|since|after <time>", -4.334315433668835),
                                    ("Thursdayat <time-of-day>", -4.429625613473161),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.0390635259072605),
                                    ("Aprilyear (latent)", -6.0390635259072605),
                                    ("the <day-of-month> (ordinal)July", -6.0390635259072605),
                                    ("the <day-of-month> (number)July", -6.0390635259072605),
                                    ("monthminute", -6.0390635259072605),
                                    ("<time-of-day> am|pmtomorrow", -6.0390635259072605),
                                    ("Thursdayhh:mm", -5.122772794033106),
                                    ("<day-of-month> (ordinal)Tuesday", -5.633598417799097),
                                    ("minutemonth", -3.89899736241099),
                                    ("time-of-day (latent)Friday", -5.633598417799097),
                                    ("minutehour", -6.0390635259072605),
                                    ("Augustyear (latent)", -5.633598417799097),
                                    ("week-endin|during <named-month>|year", -6.0390635259072605),
                                    ("time-of-day (latent)Tuesday", -5.633598417799097),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.633598417799097),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.0390635259072605),
                                    ("Sundayyear (latent)", -5.122772794033106),
                                    ("Christmasat <time-of-day>", -6.0390635259072605),
                                    ("from|since|after <time>year (latent)", -4.940451237239151),
                                    ("hhhmmon <day>", -5.122772794033106),
                                    ("yesterday<time-of-day> am|pm", -6.0390635259072605),
                                    ("<day-of-month> (ordinal)July", -5.345916345347316),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.0390635259072605),
                                    ("mm/ddyear (latent)", -6.0390635259072605),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.0390635259072605),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.0390635259072605),
                                    ("at <time-of-day>intersect", -5.122772794033106),
                                    ("hh:mmyear (latent)", -4.652769164787371),
                                    ("Holiyear (latent)", -6.0390635259072605),
                                    ("until <time><time-of-day> am|pm", -6.0390635259072605),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.633598417799097),
                                    ("dayminute", -3.1768626449777924),
                                    ("yyyy-mm-ddhh:mm", -5.633598417799097),
                                    ("intersectfrom|since|after <time>", -5.633598417799097),
                                    ("intersectSeptember", -4.16726134900567),
                                    ("minuteday", -2.8820631047571474),
                                    ("absorption of , after named dayintersect",
                                     -6.0390635259072605),
                                    ("intersectyear (latent)", -6.0390635259072605),
                                    ("Februaryin|during the <part-of-day>", -6.0390635259072605),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.0390635259072605),
                                    ("time-of-day (latent)July", -5.345916345347316),
                                    ("Saturdayyear (latent)", -6.0390635259072605),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0390635259072605),
                                    ("at <time-of-day>on <day>", -5.122772794033106),
                                    ("absorption of , after named daySeptember",
                                     -4.786300557411892),
                                    ("Naraka Chaturdashiyear (latent)", -6.0390635259072605),
                                    ("from|since|after <time>on <day>", -5.122772794033106),
                                    ("dayweek", -6.0390635259072605),
                                    ("Easter Sundayyear (latent)", -5.633598417799097),
                                    ("Thursday<time-of-day> am|pm", -4.786300557411892),
                                    ("weekyear", -5.633598417799097),
                                    ("time-of-day (latent)Thursday", -5.633598417799097),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.0390635259072605),
                                    ("<day-of-month> (ordinal)April", -6.0390635259072605),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.633598417799097),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.345916345347316),
                                    ("Sundayfrom|since|after <time>", -6.0390635259072605),
                                    ("absorption of , after named dayFebruary", -5.122772794033106),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.633598417799097),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.0390635259072605),
                                    ("tomorrowat <time-of-day>", -6.0390635259072605),
                                    ("daynograin", -5.633598417799097),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.633598417799097),
                                    ("last <cycle> of <time>year (latent)", -5.633598417799097),
                                    ("tomorrow<time-of-day> am|pm", -6.0390635259072605),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.345916345347316),
                                    ("Diwaliyear (latent)", -5.633598417799097),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.0390635259072605),
                                    ("Fridayyear (latent)", -5.633598417799097),
                                    ("time-of-day (latent)April", -6.0390635259072605),
                                    ("minuteyear", -3.8418389485710414)],
                               n = 275}}),
       ("one eleven",
        Classifier{okData =
