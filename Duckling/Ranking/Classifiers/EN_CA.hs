...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5939205466633852, unseen = -5.733341276897745,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 307},
                   koData =
                     ClassData{prior = -0.8033153977858748,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4595323293784402, unseen = -6.767343125265392,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.073044534100405),
                                    ("Father's Dayyear (latent)", -6.073044534100405),
                                    ("Ramadanyear (latent)", -6.073044534100405),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.820281565605037),
                                    ("Bhai Doojyear (latent)", -6.073044534100405),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.820281565605037),
                                    ("hourday", -4.36829644186198), ("dayhour", -3.26968415319387),
                                    ("Martin Luther King's Dayyear (latent)", -5.6675794259922405),
                                    ("Shemini Atzeretyear (latent)", -6.073044534100405),
                                    ("daymonth", -5.37989735354046),
                                    ("monthday", -5.6675794259922405),
                                    ("monthyear", -4.28128506487235),
                                    ("Yom Ha'atzmautyear (latent)", -6.073044534100405),
                                    ("Vijayadashamiyear (latent)", -6.073044534100405),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.6675794259922405),
                                    ("Thanksgiving Dayyear (latent)", -4.974432245432295),
                                    ("Thai Pongalyear (latent)", -5.37989735354046),
                                    ("Thiru Onamyear (latent)", -5.37989735354046),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.073044534100405),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.073044534100405),
                                    ("houryear", -5.37989735354046),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.073044534100405),
                                    ("Christmas<time-of-day> am|pm", -6.073044534100405),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.073044534100405),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.37989735354046),
                                    ("<time-of-day> am|pmintersect", -4.820281565605037),
                                    ("Earth Houryear (latent)", -6.073044534100405),
                                    ("Family Dayyear (latent)", -5.15675380222625),
                                    ("Octoberyear (latent)", -4.5689671373241305),
                                    ("intersect<time-of-day> am|pm", -6.073044534100405),
                                    ("Mattu Pongalyear (latent)", -6.073044534100405),
                                    ("Shavuotyear (latent)", -6.073044534100405),
                                    ("Dhanterasin <named-month>|year", -6.073044534100405),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.073044534100405),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.073044534100405),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.6675794259922405),
                                    ("Marchyear (latent)", -6.073044534100405),
                                    ("Sukkotyear (latent)", -5.6675794259922405),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.073044534100405),
                                    ("Clean Mondayyear (latent)", -5.6675794259922405),
                                    ("monthhour", -5.6675794259922405),
                                    ("todayat <time-of-day>", -6.073044534100405),
                                    ("Thursday<time> timezone", -4.36829644186198),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.073044534100405),
                                    ("Palm SundaySunday", -5.6675794259922405),
                                    ("dayday", -3.8758199567641856),
                                    ("<time> <part-of-day>at <time-of-day>", -6.073044534100405),
                                    ("mm/ddat <time-of-day>", -6.073044534100405),
                                    ("tonightat <time-of-day>", -6.073044534100405),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.37989735354046),
                                    ("today<time-of-day> am|pm", -6.073044534100405),
                                    ("Februarythe <day-of-month> (ordinal)", -5.6675794259922405),
                                    ("at <time-of-day><time> <part-of-day>", -6.073044534100405),
                                    ("mm/dd<time-of-day> am|pm", -6.073044534100405),
                                    ("hourhour", -4.820281565605037),
                                    ("<time-of-day> am|pmon <date>", -4.05814151355814),
                                    ("National Patriots' Dayyear (latent)", -5.37989735354046),
                                    ("Wednesdaythis|last|next <cycle>", -6.073044534100405),
                                    ("Lentyear (latent)", -6.073044534100405),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.5689671373241305),
                                    ("Boghiyear (latent)", -6.073044534100405),
                                    ("dayyear", -1.929909807708872),
                                    ("Thursdayfrom|since|after <time>", -5.6675794259922405),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.073044534100405),
                                    ("Thursdayat <time-of-day>", -5.6675794259922405),
                                    ("Islamic New Yearyear (latent)", -5.6675794259922405),
                                    ("Laylat al-Qadryear (latent)", -5.15675380222625),
                                    ("Chhathin <named-month>|year", -6.073044534100405),
                                    ("Vasant Panchamiin <named-month>|year", -6.073044534100405),
                                    ("Diwaliin <named-month>|year", -6.073044534100405),
                                    ("Discovery Dayyear (latent)", -5.6675794259922405),
                                    ("Shrove Tuesdayyear (latent)", -6.073044534100405),
                                    ("<time-of-day> am|pmtomorrow", -5.37989735354046),
                                    ("Yom Kippuryear (latent)", -6.073044534100405),
                                    ("<part-of-day> of <time>year (latent)", -6.073044534100405),
                                    ("minutehour", -5.15675380222625),
                                    ("Kaanum Pongalyear (latent)", -5.6675794259922405),
                                    ("Maha Saptamiyear (latent)", -6.073044534100405),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.6675794259922405),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.36829644186198),
                                    ("for <duration> from <time>December", -6.073044534100405),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.073044534100405),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.15675380222625),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.6675794259922405),
                                    ("Pentecostyear (latent)", -6.073044534100405),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.15675380222625),
                                    ("Eid al-Fitryear (latent)", -6.073044534100405),
                                    ("Mondayin|during the <part-of-day>", -6.073044534100405),
                                    ("Raksha Bandhanyear (latent)", -6.073044534100405),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.6675794259922405),
                                    ("Navaratriin <named-month>|year", -6.073044534100405),
                                    ("Ashurayear (latent)", -6.073044534100405),
                                    ("Chinese New Yearyear (latent)", -6.073044534100405),
                                    ("Sundayyear (latent)", -6.073044534100405),
                                    ("Lag BaOmeryear (latent)", -6.073044534100405),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.073044534100405),
                                    ("Eid al-Adhayear (latent)", -5.15675380222625),
                                    ("intersectin|during the <part-of-day>", -6.073044534100405),
                                    ("Christmasat <time-of-day>", -6.073044534100405),
                                    ("Passoveryear (latent)", -6.073044534100405),
                                    ("Lazarus Saturdayyear (latent)", -6.073044534100405),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.073044534100405),
                                    ("Yom HaShoahyear (latent)", -5.6675794259922405),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.6675794259922405),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.073044534100405),
                                    ("Thai Pongalin <named-month>|year", -6.073044534100405),
                                    ("Septemberyear (latent)", -5.6675794259922405),
                                    ("mm/ddyear (latent)", -6.073044534100405),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.820281565605037),
                                    ("Halloweenyear (latent)", -6.073044534100405),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -5.15675380222625),
                                    ("at <time-of-day>intersect", -5.6675794259922405),
                                    ("Rosh Hashanahyear (latent)", -6.073044534100405),
                                    ("Dhanterasyear (latent)", -6.073044534100405),
                                    ("Tu BiShvatyear (latent)", -6.073044534100405),
                                    ("Holiyear (latent)", -5.37989735354046),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.073044534100405),
                                    ("Holika Dahanyear (latent)", -5.37989735354046),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.073044534100405),
                                    ("dayminute", -3.4339872044851463),
                                    ("Mawlidyear (latent)", -6.073044534100405),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.6675794259922405),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.073044534100405),
                                    ("Jumu'atul-Widayear (latent)", -5.15675380222625),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.073044534100405),
                                    ("minuteday", -2.435458374374019),
                                    ("absorption of , after named dayintersect",
                                     -6.073044534100405),
                                    ("intersectyear (latent)", -6.073044534100405),
                                    ("Orthodox Easter Sundayyear (latent)", -6.073044534100405),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.073044534100405),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.073044534100405),
                                    ("Boss's Dayyear (latent)", -5.6675794259922405),
                                    ("Global Youth Service Dayyear (latent)", -6.073044534100405),
                                    ("Tisha B'Avyear (latent)", -6.073044534100405),
                                    ("Isra and Mi'rajyear (latent)", -5.15675380222625),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.073044534100405),
                                    ("Christmasyear (latent)", -5.6675794259922405),
                                    ("Naraka Chaturdashiyear (latent)", -5.6675794259922405),
                                    ("at <time-of-day>on <date>", -4.974432245432295),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.463606621666305),
                                    ("dayweek", -6.073044534100405),
                                    ("Easter Sundayyear (latent)", -5.37989735354046),
                                    ("Labour Dayyear (latent)", -6.073044534100405),
                                    ("weekyear", -4.974432245432295),
                                    ("hh:mmin|during the <part-of-day>", -5.37989735354046),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.6675794259922405),
                                    ("Hanukkahyear (latent)", -6.073044534100405),
                                    ("February<time> <part-of-day>", -6.073044534100405),
                                    ("Tuesdayin <named-month>|year", -6.073044534100405),
                                    ("Great Lentyear (latent)", -6.073044534100405),
                                    ("tomorrowat <time-of-day>", -5.37989735354046),
                                    ("between <time> and <time>on <date>", -4.463606621666305),
                                    ("last <cycle> of <time>year (latent)", -5.37989735354046),
                                    ("at <time-of-day>tomorrow", -5.6675794259922405),
                                    ("tomorrow<time-of-day> am|pm", -6.073044534100405),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.073044534100405),
                                    ("Diwaliyear (latent)", -6.073044534100405),
                                    ("Black Fridayyear (latent)", -5.6675794259922405),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.073044534100405),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.073044534100405),
                                    ("Chhathyear (latent)", -5.6675794259922405),
                                    ("Vasant Panchamiyear (latent)", -6.073044534100405),
                                    ("Palm Sundayintersect", -6.073044534100405),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.073044534100405),
                                    ("Februaryintersect", -6.073044534100405),
                                    ("Mother's Dayyear (latent)", -6.073044534100405),
                                    ("Simchat Torahyear (latent)", -6.073044534100405),
                                    ("Victoria Dayyear (latent)", -5.6675794259922405),
                                    ("minuteyear", -6.073044534100405)],
                               n = 324},
                   koData =
                     ClassData{prior = -0.9985288301111273, unseen = -6.395261598115449,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.784152841516532),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1368591827171973, unseen = -5.043425116919247,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 150},
                   koData =
                     ClassData{prior = -2.056452023455137, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
