...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5983303001161131, unseen = -5.723585101952381,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 304},
                   koData =
                     ClassData{prior = -0.7979051050576272,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4629696025883556,
                               unseen = -6.7580945044277305,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.063785208687608),
                                    ("Father's Dayyear (latent)", -6.063785208687608),
                                    ("Ramadanyear (latent)", -6.063785208687608),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.81102224019224),
                                    ("Bhai Doojyear (latent)", -6.063785208687608),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.81102224019224),
                                    ("hourday", -4.359037116449183),
                                    ("dayhour", -3.260424827781073),
                                    ("Martin Luther King's Dayyear (latent)", -5.658320100579444),
                                    ("Shemini Atzeretyear (latent)", -6.063785208687608),
                                    ("daymonth", -5.3706380281276624),
                                    ("monthday", -5.658320100579444),
                                    ("monthyear", -4.272025739459553),
                                    ("Yom Ha'atzmautyear (latent)", -6.063785208687608),
                                    ("Vijayadashamiyear (latent)", -6.063785208687608),
                                    ("Thanksgiving Dayyear (latent)", -4.965172920019499),
                                    ("Thai Pongalyear (latent)", -5.3706380281276624),
                                    ("Thiru Onamyear (latent)", -5.3706380281276624),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.063785208687608),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.063785208687608),
                                    ("houryear", -5.3706380281276624),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.063785208687608),
                                    ("Christmas<time-of-day> am|pm", -6.063785208687608),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.063785208687608),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.3706380281276624),
                                    ("<time-of-day> am|pmintersect", -4.81102224019224),
                                    ("Family Dayyear (latent)", -5.147494476813453),
                                    ("Octoberyear (latent)", -4.559707811911334),
                                    ("intersect<time-of-day> am|pm", -6.063785208687608),
                                    ("Mattu Pongalyear (latent)", -6.063785208687608),
                                    ("Shavuotyear (latent)", -6.063785208687608),
                                    ("Dhanterasin <named-month>|year", -6.063785208687608),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.063785208687608),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.063785208687608),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.658320100579444),
                                    ("Marchyear (latent)", -6.063785208687608),
                                    ("Sukkotyear (latent)", -5.658320100579444),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.063785208687608),
                                    ("Clean Mondayyear (latent)", -5.658320100579444),
                                    ("monthhour", -5.658320100579444),
                                    ("todayat <time-of-day>", -6.063785208687608),
                                    ("Thursday<time> timezone", -4.359037116449183),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.063785208687608),
                                    ("Palm SundaySunday", -5.658320100579444),
                                    ("dayday", -3.8665606313513887),
                                    ("<time> <part-of-day>at <time-of-day>", -6.063785208687608),
                                    ("mm/ddat <time-of-day>", -6.063785208687608),
                                    ("tonightat <time-of-day>", -6.063785208687608),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.3706380281276624),
                                    ("today<time-of-day> am|pm", -6.063785208687608),
                                    ("Februarythe <day-of-month> (ordinal)", -5.658320100579444),
                                    ("at <time-of-day><time> <part-of-day>", -6.063785208687608),
                                    ("mm/dd<time-of-day> am|pm", -6.063785208687608),
                                    ("hourhour", -4.81102224019224),
                                    ("<time-of-day> am|pmon <date>", -4.048882188145344),
                                    ("National Patriots' Dayyear (latent)", -5.3706380281276624),
                                    ("Wednesdaythis|last|next <cycle>", -6.063785208687608),
                                    ("Lentyear (latent)", -6.063785208687608),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.559707811911334),
                                    ("Boghiyear (latent)", -6.063785208687608),
                                    ("dayyear", -1.9366508236425164),
                                    ("Thursdayfrom|since|after <time>", -5.658320100579444),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.063785208687608),
                                    ("Thursdayat <time-of-day>", -5.658320100579444),
                                    ("Islamic New Yearyear (latent)", -5.658320100579444),
                                    ("Laylat al-Qadryear (latent)", -5.147494476813453),
                                    ("Chhathin <named-month>|year", -6.063785208687608),
                                    ("Vasant Panchamiin <named-month>|year", -6.063785208687608),
                                    ("Diwaliin <named-month>|year", -6.063785208687608),
                                    ("Discovery Dayyear (latent)", -5.658320100579444),
                                    ("Shrove Tuesdayyear (latent)", -6.063785208687608),
                                    ("<time-of-day> am|pmtomorrow", -5.3706380281276624),
                                    ("Yom Kippuryear (latent)", -6.063785208687608),
                                    ("<part-of-day> of <time>year (latent)", -6.063785208687608),
                                    ("minutehour", -5.147494476813453),
                                    ("Kaanum Pongalyear (latent)", -5.658320100579444),
                                    ("Maha Saptamiyear (latent)", -6.063785208687608),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.658320100579444),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.359037116449183),
                                    ("for <duration> from <time>December", -6.063785208687608),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.063785208687608),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.147494476813453),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.658320100579444),
                                    ("Pentecostyear (latent)", -6.063785208687608),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.147494476813453),
                                    ("Eid al-Fitryear (latent)", -6.063785208687608),
                                    ("Mondayin|during the <part-of-day>", -6.063785208687608),
                                    ("Raksha Bandhanyear (latent)", -6.063785208687608),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.658320100579444),
                                    ("Navaratriin <named-month>|year", -6.063785208687608),
                                    ("Ashurayear (latent)", -6.063785208687608),
                                    ("Chinese New Yearyear (latent)", -6.063785208687608),
                                    ("Sundayyear (latent)", -6.063785208687608),
                                    ("Lag BaOmeryear (latent)", -6.063785208687608),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.063785208687608),
                                    ("Eid al-Adhayear (latent)", -5.147494476813453),
                                    ("intersectin|during the <part-of-day>", -6.063785208687608),
                                    ("Christmasat <time-of-day>", -6.063785208687608),
                                    ("Passoveryear (latent)", -6.063785208687608),
                                    ("Lazarus Saturdayyear (latent)", -6.063785208687608),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.063785208687608),
                                    ("Yom HaShoahyear (latent)", -5.658320100579444),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.658320100579444),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.063785208687608),
                                    ("Thai Pongalin <named-month>|year", -6.063785208687608),
                                    ("Septemberyear (latent)", -5.658320100579444),
                                    ("mm/ddyear (latent)", -6.063785208687608),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.81102224019224),
                                    ("Halloweenyear (latent)", -6.063785208687608),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -5.147494476813453),
                                    ("at <time-of-day>intersect", -5.658320100579444),
                                    ("Rosh Hashanahyear (latent)", -6.063785208687608),
                                    ("Dhanterasyear (latent)", -6.063785208687608),
                                    ("Tu BiShvatyear (latent)", -6.063785208687608),
                                    ("Holiyear (latent)", -5.3706380281276624),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.063785208687608),
                                    ("Holika Dahanyear (latent)", -5.3706380281276624),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.063785208687608),
                                    ("dayminute", -3.4247278790723494),
                                    ("Mawlidyear (latent)", -6.063785208687608),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.658320100579444),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.063785208687608),
                                    ("Jumu'atul-Widayear (latent)", -5.147494476813453),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.063785208687608),
                                    ("minuteday", -2.426199048961222),
                                    ("absorption of , after named dayintersect",
                                     -6.063785208687608),
                                    ("intersectyear (latent)", -6.063785208687608),
                                    ("Orthodox Easter Sundayyear (latent)", -6.063785208687608),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.063785208687608),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.063785208687608),
                                    ("Boss's Dayyear (latent)", -5.658320100579444),
                                    ("Global Youth Service Dayyear (latent)", -6.063785208687608),
                                    ("Tisha B'Avyear (latent)", -6.063785208687608),
                                    ("Isra and Mi'rajyear (latent)", -5.147494476813453),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.063785208687608),
                                    ("Christmasyear (latent)", -5.658320100579444),
                                    ("Naraka Chaturdashiyear (latent)", -5.658320100579444),
                                    ("at <time-of-day>on <date>", -4.965172920019499),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.454347296253507),
                                    ("dayweek", -6.063785208687608),
                                    ("Easter Sundayyear (latent)", -5.3706380281276624),
                                    ("Labour Dayyear (latent)", -6.063785208687608),
                                    ("weekyear", -4.965172920019499),
                                    ("hh:mmin|during the <part-of-day>", -5.3706380281276624),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.658320100579444),
                                    ("Hanukkahyear (latent)", -6.063785208687608),
                                    ("February<time> <part-of-day>", -6.063785208687608),
                                    ("Tuesdayin <named-month>|year", -6.063785208687608),
                                    ("Great Lentyear (latent)", -6.063785208687608),
                                    ("tomorrowat <time-of-day>", -5.3706380281276624),
                                    ("between <time> and <time>on <date>", -4.454347296253507),
                                    ("last <cycle> of <time>year (latent)", -5.3706380281276624),
                                    ("at <time-of-day>tomorrow", -5.658320100579444),
                                    ("tomorrow<time-of-day> am|pm", -6.063785208687608),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.063785208687608),
                                    ("Diwaliyear (latent)", -6.063785208687608),
                                    ("Black Fridayyear (latent)", -5.658320100579444),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.063785208687608),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.063785208687608),
                                    ("Chhathyear (latent)", -5.658320100579444),
                                    ("Vasant Panchamiyear (latent)", -6.063785208687608),
                                    ("Palm Sundayintersect", -6.063785208687608),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.063785208687608),
                                    ("Februaryintersect", -6.063785208687608),
                                    ("Mother's Dayyear (latent)", -6.063785208687608),
                                    ("Simchat Torahyear (latent)", -6.063785208687608),
                                    ("Victoria Dayyear (latent)", -5.658320100579444)],
                               n = 321},
                   koData =
                     ClassData{prior = -0.992663710658729, unseen = -6.391917113392602,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.7808027546312495),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.697093486505405),
                                    ("dayhour", -3.132144129043868),
                                    ("Tuesdayfrom|since|after <time>", -5.697093486505405),
                                    ("daymonth", -3.557027323009134),
                                    ("monthday", -5.29162837839724),
                                    ("monthyear", -4.4443305180100365),
                                    ...
                                    ("Octoberyear (latent)", -5.697093486505405),
                                    ...
                                    ("Thursdayat <time-of-day>", -4.4443305180100365),
                                    ...
                                    ("week-endin <named-month>|year", -5.697093486505405),
                                    ...
                                    ("from|since|after <time>year (latent)", -4.4443305180100365),
                                    ...
                                    ("in <named-month>|yearyear (latent)", -5.697093486505405),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.13946612814433718,
                               unseen = -5.0238805208462765,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -4.0546094394349905e-2),
                                    ("intersect 2 numbers", -3.6309854756950335)],
                               n = 147},
                   koData =
                     ClassData{prior = -2.0388562615647574, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
