...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45566385260051984, unseen = -7.20414929203594,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.51025834052315),
                                    ...
                                    ("Orthodox Good Fridayyear (latent)", -6.104793232414985),
                                    ...
                                    ("tonightat <time-of-day>", -5.4116460518550396),
                                    ...
                                    ("tonight<time-of-day> o'clock", -6.51025834052315),
                                    ...
                                    ("between <time> and <time>on <day>", -6.104793232414985),
                               ...
                               n = 518},
                   koData =
                     ClassData{prior = -1.0051955214693165, unseen = -6.810142450115136,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.61181472870676),
                                    ("hourday", -3.7179968526846636),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.115892125483034),
                                    ("<day-of-month> (ordinal)August", -6.115892125483034),
                                    ("dayhour", -3.4417434760565055),
                                    ("<time> timezoneyear (latent)", -5.422744944923089),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.199601393608879),
                                    ("Tuesdayfrom|since|after <time>", -5.422744944923089),
                                    ("daymonth", -3.4417434760565055),
                                    ("monthyear", -4.863129156987666),
                                    ("<time-of-day> am|pmyear (latent)", -5.422744944923089),
                                    ("Thai Pongalyear (latent)", -5.422744944923089),
                                    ("intersecthh:mm", -6.115892125483034),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.71042701737487),
                                    ("<day-of-month> (ordinal)Wednesday", -6.115892125483034),
                                    ("houryear", -4.7295977643631435),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.115892125483034),
                                    ("<day-of-month> (ordinal)October", -6.115892125483034),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.422744944923089),
                                    ("hournograin", -4.863129156987666),
                                    ("<time-of-day> am|pmintersect", -4.863129156987666),
                                    ("Octoberyear (latent)", -6.115892125483034),
                                    ("Good Fridayyear (latent)", -5.71042701737487),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.71042701737487),
                                    ("early morningat <time-of-day>", -6.115892125483034),
                                    ("until <time>on <day>", -5.422744944923089),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.115892125483034),
                                    ("time-of-day (latent)intersect", -5.422744944923089),
                                    ("todayin <number> (implicit minutes)", -6.115892125483034),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.422744944923089),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.115892125483034),
                                    ("hh:mmon <day>", -4.863129156987666),
                                    ("hhhmmintersect", -5.71042701737487),
                                    ("absorption of , after named dayJuly", -5.199601393608879),
                                    ("from|since|after <time>July", -5.71042701737487),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.199601393608879),
                                    ("Clean Mondayyear (latent)", -6.115892125483034),
                                    ("monthhour", -6.115892125483034),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.71042701737487),
                                    ("hourmonth", -4.2440899485814425),
                                    ("todayat <time-of-day>", -6.115892125483034),
                                    ("hhhmmyear (latent)", -4.863129156987666),
                                    ("from|since|after <time>December", -6.115892125483034),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.115892125483034),
                                    ("<time-of-day> am|pmon <day>", -4.863129156987666),
                                    ("Mondayyear (latent)", -5.422744944923089),
                                    ("dayday", -4.100989104940769),
                                    ("mm/ddat <time-of-day>", -5.71042701737487),
                                    ("on <day>September", -5.422744944923089),
                                    ("time-of-day (latent)September", -5.71042701737487),
                                    ("hourhour", -4.036450583803198),
                                    ("time-of-day (latent)on <day>", -4.61181472870676),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.71042701737487),
                                    ("dayyear", -3.071369687759611),
                                    ("Thursdaymm/dd", -6.115892125483034),
                                    ("New Year's Dayyear (latent)", -5.199601393608879),
                                    ("time-of-day (latent)Sunday", -5.71042701737487),
                                    ("Thursdayfrom|since|after <time>", -4.411144033244609),
                                    ("Thursdayat <time-of-day>", -4.506454213048934),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.115892125483034),
                                    ("Aprilyear (latent)", -6.115892125483034),
                                    ("the <day-of-month> (ordinal)July", -6.115892125483034),
                                    ("the <day-of-month> (number)July", -6.115892125483034),
                                    ("monthminute", -6.115892125483034),
                                    ("<time-of-day> am|pmtomorrow", -6.115892125483034),
                                    ("Thursdayhh:mm", -5.199601393608879),
                                    ("<day-of-month> (ordinal)Tuesday", -5.71042701737487),
                                    ("minutemonth", -3.9758259619867635),
                                    ("time-of-day (latent)Friday", -5.71042701737487),
                                    ("minutehour", -6.115892125483034),
                                    ("part of daysat <time-of-day>", -5.017279836814924),
                                    ("Augustyear (latent)", -5.71042701737487),
                                    ("week-endin|during <named-month>|year", -6.115892125483034),
                                    ("time-of-day (latent)Tuesday", -5.71042701737487),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.115892125483034),
                                    ("Sundayyear (latent)", -5.199601393608879),
                                    ("the <day-of-month> (ordinal)Monday", -5.422744944923089),
                                    ("Christmasat <time-of-day>", -6.115892125483034),
                                    ("from|since|after <time>year (latent)", -5.017279836814924),
                                    ("hhhmmon <day>", -5.199601393608879),
                                    ("yesterday<time-of-day> am|pm", -6.115892125483034),
                                    ("<day-of-month> (ordinal)July", -5.422744944923089),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.115892125483034),
                                    ("mm/ddyear (latent)", -6.115892125483034),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.115892125483034),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.115892125483034),
                                    ("at <time-of-day>intersect", -5.199601393608879),
                                    ("hh:mmyear (latent)", -4.7295977643631435),
                                    ("Holiyear (latent)", -6.115892125483034),
                                    ("until <time><time-of-day> am|pm", -6.115892125483034),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.71042701737487),
                                    ("dayminute", -3.2536912445535657),
                                    ("yyyy-mm-ddhh:mm", -5.71042701737487),
                                    ("intersectfrom|since|after <time>", -5.71042701737487),
                                    ("intersectSeptember", -4.2440899485814425),
                                    ("minuteday", -2.958891704332921),
                                    ("absorption of , after named dayintersect",
                                     -6.115892125483034),
                                    ("intersectyear (latent)", -6.115892125483034),
                                    ("Februaryin|during the <part-of-day>", -6.115892125483034),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.115892125483034),
                                    ("time-of-day (latent)July", -5.422744944923089),
                                    ("Saturdayyear (latent)", -6.115892125483034),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.115892125483034),
                                    ("<day-of-month> (ordinal)Monday", -5.199601393608879),
                                    ("at <time-of-day>on <day>", -5.199601393608879),
                                    ("absorption of , after named daySeptember",
                                     -4.863129156987666),
                                    ("Naraka Chaturdashiyear (latent)", -6.115892125483034),
                                    ("from|since|after <time>on <day>", -5.199601393608879),
                                    ("dayweek", -6.115892125483034),
                                    ("Easter Sundayyear (latent)", -5.71042701737487),
                                    ("Thursday<time-of-day> am|pm", -4.863129156987666),
                                    ("weekyear", -5.71042701737487),
                                    ("time-of-day (latent)Thursday", -5.71042701737487),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.115892125483034),
                                    ("<day-of-month> (ordinal)April", -6.115892125483034),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.71042701737487),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.422744944923089),
                                    ("Sundayfrom|since|after <time>", -6.115892125483034),
                                    ("absorption of , after named dayFebruary", -5.199601393608879),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.71042701737487),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.115892125483034),
                                    ("tomorrowat <time-of-day>", -6.115892125483034),
                                    ("daynograin", -5.71042701737487),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.71042701737487),
                                    ("last <cycle> of <time>year (latent)", -5.71042701737487),
                                    ("tomorrow<time-of-day> am|pm", -6.115892125483034),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.422744944923089),
                                    ("Diwaliyear (latent)", -5.71042701737487),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.115892125483034),
                                    ("this <part-of-day>at <time-of-day>", -5.199601393608879),
                                    ("Fridayyear (latent)", -5.199601393608879),
                                    ("time-of-day (latent)April", -6.115892125483034),
                                    ("minuteyear", -3.9186675481468147)],
                               n = 299}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.26415157504158676,
                               ...
                               n = 86},
                   koData =
                     ClassData{prior = -1.4604023332736125, unseen = -4.174387269895637,
                               likelihoods =
                                 HashMap.fromList
