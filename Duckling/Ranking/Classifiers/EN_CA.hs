...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.453070016716296, unseen = -6.795705775173515,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.101439400316553),
                                    ("Father's Dayyear (latent)", -6.101439400316553),
                                    ("Ramadanyear (latent)", -6.101439400316553),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.848676431821186),
                                    ("Bhai Doojyear (latent)", -6.101439400316553),
                                    ("hourday", -4.396691308078129),
                                    ("dayhour", -3.239238519387085),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.848676431821186),
                                    ("Martin Luther King's Dayyear (latent)", -5.69597429220839),
                                    ("Shemini Atzeretyear (latent)", -6.101439400316553),
                                    ("daymonth", -5.185148668442399),
                                    ("monthday", -5.69597429220839),
                                    ("monthyear", -4.309679931088499),
                                    ("Yom Ha'atzmautyear (latent)", -6.101439400316553),
                                    ("Vijayadashamiyear (latent)", -6.101439400316553),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.69597429220839),
                                    ("Thanksgiving Dayyear (latent)", -5.002827111648444),
                                    ("Thai Pongalyear (latent)", -5.408292219756609),
                                    ("Thiru Onamyear (latent)", -5.408292219756609),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.101439400316553),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.101439400316553),
                                    ("houryear", -5.408292219756609),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.101439400316553),
                                    ("Christmas<time-of-day> am|pm", -6.101439400316553),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.101439400316553),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.408292219756609),
                                    ("<time-of-day> am|pmintersect", -4.848676431821186),
                                    ("Earth Houryear (latent)", -6.101439400316553),
                                    ("Family Dayyear (latent)", -5.185148668442399),
                                    ("Octoberyear (latent)", -4.59736200354028),
                                    ("intersect<time-of-day> am|pm", -6.101439400316553),
                                    ("Mattu Pongalyear (latent)", -6.101439400316553),
                                    ("Shavuotyear (latent)", -6.101439400316553),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.101439400316553),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.101439400316553),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.69597429220839),
                                    ("Marchyear (latent)", -6.101439400316553),
                                    ("Sukkotyear (latent)", -5.69597429220839),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.101439400316553),
                                    ("Clean Mondayyear (latent)", -5.69597429220839),
                                    ("monthhour", -5.69597429220839),
                                    ("todayat <time-of-day>", -6.101439400316553),
                                    ("Thursday<time> timezone", -4.155529251261241),
                                    ("from|since|after <time>December", -6.101439400316553),
                                    ("<time-of-day> am|pmon <day>", -4.086536379774289),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.101439400316553),
                                    ("yyyy-mm-ddhh:mm:ss", -5.69597429220839),
                                    ("dayday", -4.086536379774289),
                                    ("<time> <part-of-day>at <time-of-day>", -6.101439400316553),
                                    ("mm/ddat <time-of-day>", -6.101439400316553),
                                    ("tonightat <time-of-day>", -6.101439400316553),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.408292219756609),
                                    ("today<time-of-day> am|pm", -6.101439400316553),
                                    ("Februarythe <day-of-month> (ordinal)", -5.69597429220839),
                                    ("at <time-of-day><time> <part-of-day>", -6.101439400316553),
                                    ("mm/dd<time-of-day> am|pm", -6.101439400316553),
                                    ("hourhour", -4.848676431821186),
                                    ("Navaratriin|during <named-month>|year", -6.101439400316553),
                                    ("National Patriots' Dayyear (latent)", -5.408292219756609),
                                    ("Wednesdaythis|last|next <cycle>", -6.101439400316553),
                                    ("Lentyear (latent)", -6.101439400316553),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.59736200354028),
                                    ("Boghiyear (latent)", -6.101439400316553),
                                    ("dayyear", -1.9117846582901281),
                                    ("Thursdayfrom|since|after <time>", -5.69597429220839),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.101439400316553),
                                    ("Thursdayat <time-of-day>", -5.408292219756609),
                                    ("Islamic New Yearyear (latent)", -5.69597429220839),
                                    ("Laylat al-Qadryear (latent)", -5.185148668442399),
                                    ("Discovery Dayyear (latent)", -5.69597429220839),
                                    ("Shrove Tuesdayyear (latent)", -6.101439400316553),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.408292219756609),
                                    ("<time-of-day> am|pmtomorrow", -5.408292219756609),
                                    ("Yom Kippuryear (latent)", -6.101439400316553),
                                    ("<part-of-day> of <time>year (latent)", -6.101439400316553),
                                    ("minutehour", -5.185148668442399),
                                    ("Kaanum Pongalyear (latent)", -5.69597429220839),
                                    ("Maha Saptamiyear (latent)", -6.101439400316553),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.69597429220839),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.396691308078129),
                                    ("for <duration> from <time>December", -6.101439400316553),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.101439400316553),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.185148668442399),
                                    ("Pentecostyear (latent)", -6.101439400316553),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.185148668442399),
                                    ("Eid al-Fitryear (latent)", -6.101439400316553),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.101439400316553),
                                    ("Mondayin|during the <part-of-day>", -6.101439400316553),
                                    ("Chhathin|during <named-month>|year", -6.101439400316553),
                                    ("Diwaliin|during <named-month>|year", -6.101439400316553),
                                    ("Vaisakhiin|during <named-month>|year", -6.101439400316553),
                                    ("Raksha Bandhanyear (latent)", -6.101439400316553),
                                    ("daysecond", -5.69597429220839),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.69597429220839),
                                    ("Ashurayear (latent)", -6.101439400316553),
                                    ("Tuesdayin|during <named-month>|year", -6.101439400316553),
                                    ("Chinese New Yearyear (latent)", -6.101439400316553),
                                    ("Lag BaOmeryear (latent)", -6.101439400316553),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.101439400316553),
                                    ("Eid al-Adhayear (latent)", -5.185148668442399),
                                    ("intersectin|during the <part-of-day>", -6.101439400316553),
                                    ("Palm Sundayyear (latent)", -6.101439400316553),
                                    ("Christmasat <time-of-day>", -6.101439400316553),
                                    ("Passoveryear (latent)", -6.101439400316553),
                                    ("Lazarus Saturdayyear (latent)", -6.101439400316553),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.101439400316553),
                                    ("Yom HaShoahyear (latent)", -5.69597429220839),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.69597429220839),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.101439400316553),
                                    ("Septemberyear (latent)", -5.69597429220839),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.848676431821186),
                                    ("Halloweenyear (latent)", -6.101439400316553),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.101439400316553),
                                    ("at <time-of-day>intersect", -5.69597429220839),
                                    ("Rosh Hashanahyear (latent)", -5.408292219756609),
                                    ("Dhanterasyear (latent)", -6.101439400316553),
                                    ("Tu BiShvatyear (latent)", -6.101439400316553),
                                    ("Holiyear (latent)", -5.408292219756609),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.101439400316553),
                                    ("Holika Dahanyear (latent)", -5.408292219756609),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.101439400316553),
                                    ("dayminute", -3.360599376391353),
                                    ("Mawlidyear (latent)", -6.101439400316553),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.69597429220839),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.101439400316553),
                                    ("Jumu'atul-Widayear (latent)", -5.185148668442399),
                                    ("minuteday", -2.463853240590168),
                                    ("absorption of , after named dayintersect",
                                     -6.101439400316553),
                                    ("Orthodox Easter Sundayyear (latent)", -6.101439400316553),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.101439400316553),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.101439400316553),
                                    ("Boss's Dayyear (latent)", -5.69597429220839),
                                    ("Global Youth Service Dayyear (latent)", -6.101439400316553),
                                    ("Dhanterasin|during <named-month>|year", -6.101439400316553),
                                    ("Tisha B'Avyear (latent)", -6.101439400316553),
                                    ("Isra and Mi'rajyear (latent)", -5.185148668442399),
                                    ("at <time-of-day>on <day>", -5.002827111648444),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.101439400316553),
                                    ("Christmasyear (latent)", -5.69597429220839),
                                    ("Naraka Chaturdashiyear (latent)", -5.69597429220839),
                                    ("Thai Pongalin|during <named-month>|year", -6.101439400316553),
                                    ("dayweek", -6.101439400316553),
                                    ("Easter Sundayyear (latent)", -5.408292219756609),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.492001487882454),
                                    ("Labour Dayyear (latent)", -6.101439400316553),
                                    ("weekyear", -5.002827111648444),
                                    ("hh:mmin|during the <part-of-day>", -5.408292219756609),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.69597429220839),
                                    ("Hanukkahyear (latent)", -5.408292219756609),
                                    ("February<time> <part-of-day>", -6.101439400316553),
                                    ("Great Lentyear (latent)", -6.101439400316553),
                                    ("tomorrowat <time-of-day>", -5.408292219756609),
                                    ("Vaisakhiyear (latent)", -5.408292219756609),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.101439400316553),
                                    ("last <cycle> of <time>year (latent)", -5.408292219756609),
                                    ("at <time-of-day>tomorrow", -5.69597429220839),
                                    ("tomorrow<time-of-day> am|pm", -6.101439400316553),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.101439400316553),
                                    ("Diwaliyear (latent)", -6.101439400316553),
                                    ("between <time> and <time>on <day>", -4.492001487882454),
                                    ("Black Fridayyear (latent)", -5.69597429220839),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.101439400316553),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.101439400316553),
                                    ("Chhathyear (latent)", -5.69597429220839),
                                    ("Vasant Panchamiyear (latent)", -6.101439400316553),
                                    ("Thursday<time> (timezone)", -6.101439400316553),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.101439400316553),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.69597429220839),
                                    ("Februaryintersect", -6.101439400316553),
                                    ("Mother's Dayyear (latent)", -6.101439400316553),
                                    ("Simchat Torahyear (latent)", -6.101439400316553),
                                    ("Victoria Dayyear (latent)", -5.69597429220839),
                                    ("minuteyear", -6.101439400316553)],
                               n = 335},
                   koData =
                     ClassData{prior = -1.0097051765135807, unseen = -6.410174881966167,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.13510248485656381,
                               unseen = -5.099866427824199,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 159},
                   koData =
                     ClassData{prior = -2.068512471147646, unseen = -3.332204510175204,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                    ...
                                    ("on <day><time-of-day> am|pm", -4.269697449699962),
