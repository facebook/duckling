...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.639658495608959, unseen = -5.955837369464831,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 384},
                   koData =
                     ClassData{prior = -0.7496593908232877, unseen = -5.846438775057725,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4809294724671309, unseen = -7.00850518208228,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.314453433391908),
                                    ("Father's Dayyear (latent)", -6.314453433391908),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.314453433391908),
                                    ("Ramadanyear (latent)", -5.3981627015177525),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.299550412849643),
                                    ("Bhai Doojyear (latent)", -6.314453433391908),
                                    ("hourday", -4.299550412849643),
                                    ("dayhour", -3.3966827013076286),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.299550412849643),
                                    ("Martin Luther King's Dayyear (latent)", -5.908988325283744),
                                    ("Shemini Atzeretyear (latent)", -6.314453433391908),
                                    ("daymonth", -4.299550412849643),
                                    ("monthday", -5.908988325283744),
                                    ("monthyear", -4.522693964163853),
                                    ("Yom Ha'atzmautyear (latent)", -6.314453433391908),
                                    ("Vijayadashamiyear (latent)", -6.314453433391908),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.908988325283744),
                                    ("Thanksgiving Dayyear (latent)", -5.2158411447237985),
                                    ("Thai Pongalyear (latent)", -5.621306252831962),
                                    ("Thiru Onamyear (latent)", -5.621306252831962),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.314453433391908),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.3981627015177525),
                                    ("<day-of-month> (ordinal)Wednesday", -6.314453433391908),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.314453433391908),
                                    ("houryear", -5.3981627015177525),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.314453433391908),
                                    ("Christmas<time-of-day> am|pm", -6.314453433391908),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.314453433391908),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.621306252831962),
                                    ("intersectin|during <named-month>|year", -6.314453433391908),
                                    ("<time-of-day> am|pmintersect", -5.0616904648965395),
                                    ("Earth Houryear (latent)", -6.314453433391908),
                                    ("Family Dayyear (latent)", -5.3981627015177525),
                                    ("Octoberyear (latent)", -4.810376036615634),
                                    ("intersect<time-of-day> am|pm", -6.314453433391908),
                                    ("Mattu Pongalyear (latent)", -6.314453433391908),
                                    ("Shavuotyear (latent)", -6.314453433391908),
                                    ("Parsi New Yearyear (latent)", -5.3981627015177525),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.314453433391908),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.314453433391908),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.908988325283744),
                                    ("Marchyear (latent)", -6.314453433391908),
                                    ("Sukkotyear (latent)", -5.908988325283744),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.908988325283744),
                                    ("Clean Mondayyear (latent)", -5.908988325283744),
                                    ("monthhour", -5.908988325283744),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.621306252831962),
                                    ("todayat <time-of-day>", -6.314453433391908),
                                    ("Thursday<time> timezone", -4.368543284336595),
                                    ("time-of-day (latent)tonight", -5.908988325283744),
                                    ("from|since|after <time>December", -6.314453433391908),
                                    ("<time-of-day> am|pmon <day>", -4.299550412849643),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.314453433391908),
                                    ("yyyy-mm-ddhh:mm:ss", -5.908988325283744),
                                    ("dayday", -3.8721063980227037),
                                    ("<time> <part-of-day>at <time-of-day>", -6.314453433391908),
                                    ("mm/ddat <time-of-day>", -6.314453433391908),
                                    ("tonightat <time-of-day>", -6.314453433391908),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.621306252831962),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.314453433391908),
                                    ("today<time-of-day> am|pm", -6.314453433391908),
                                    ("Februarythe <day-of-month> (ordinal)", -5.908988325283744),
                                    ("at <time-of-day><time> <part-of-day>", -6.314453433391908),
                                    ("<day-of-month> (ordinal)intersect", -5.908988325283744),
                                    ("mm/dd<time-of-day> am|pm", -6.314453433391908),
                                    ("hourhour", -4.235011891712072),
                                    ("Navaratriin|during <named-month>|year", -6.314453433391908),
                                    ("National Patriots' Dayyear (latent)", -5.621306252831962),
                                    ("Wednesdaythis|last|next <cycle>", -6.314453433391908),
                                    ("Lentyear (latent)", -6.314453433391908),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.810376036615634),
                                    ("Boghiyear (latent)", -6.314453433391908),
                                    ("dayyear", -1.92619624896739),
                                    ("Thursdayfrom|since|after <time>", -5.908988325283744),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.314453433391908),
                                    ("Thursdayat <time-of-day>", -5.621306252831962),
                                    ("Islamic New Yearyear (latent)", -5.908988325283744),
                                    ("Laylat al-Qadryear (latent)", -5.3981627015177525),
                                    ("Discovery Dayyear (latent)", -5.908988325283744),
                                    ("Shrove Tuesdayyear (latent)", -6.314453433391908),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.621306252831962),
                                    ("<time-of-day> am|pmtomorrow", -5.621306252831962),
                                    ("Yom Kippuryear (latent)", -6.314453433391908),
                                    ("<day-of-month> (ordinal)Tuesday", -5.908988325283744),
                                    ("<part-of-day> of <time>year (latent)", -6.314453433391908),
                                    ("minutehour", -5.2158411447237985),
                                    ("Kaanum Pongalyear (latent)", -5.908988325283744),
                                    ("Maha Saptamiyear (latent)", -6.314453433391908),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.908988325283744),
                                    ("time-of-day (latent)tomorrow", -5.3981627015177525),
                                    ("part of daysat <time-of-day>", -5.908988325283744),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.609705341153482),
                                    ("for <duration> from <time>December", -6.314453433391908),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.314453433391908),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.0616904648965395),
                                    ("time-of-day (latent)this <part-of-day>", -6.314453433391908),
                                    ("Pentecostyear (latent)", -6.314453433391908),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.0616904648965395),
                                    ("<day-of-month> (ordinal)February", -6.314453433391908),
                                    ("Eid al-Fitryear (latent)", -5.3981627015177525),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.314453433391908),
                                    ("Mondayin|during the <part-of-day>", -6.314453433391908),
                                    ("Chhathin|during <named-month>|year", -6.314453433391908),
                                    ("Diwaliin|during <named-month>|year", -6.314453433391908),
                                    ("Vaisakhiin|during <named-month>|year", -6.314453433391908),
                                    ("Raksha Bandhanyear (latent)", -6.314453433391908),
                                    ("daysecond", -5.908988325283744),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.908988325283744),
                                    ("Ashurayear (latent)", -6.314453433391908),
                                    ("Tuesdayin|during <named-month>|year", -6.314453433391908),
                                    ("Chinese New Yearyear (latent)", -6.314453433391908),
                                    ("tomorrowintersect", -6.314453433391908),
                                    ("Lag BaOmeryear (latent)", -6.314453433391908),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.314453433391908),
                                    ("Eid al-Adhayear (latent)", -5.3981627015177525),
                                    ("intersectin|during the <part-of-day>", -6.314453433391908),
                                    ("Palm Sundayyear (latent)", -6.314453433391908),
                                    ("Christmasat <time-of-day>", -6.314453433391908),
                                    ("Passoveryear (latent)", -6.314453433391908),
                                    ("Lazarus Saturdayyear (latent)", -6.314453433391908),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.314453433391908),
                                    ("Yom HaShoahyear (latent)", -5.908988325283744),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.908988325283744),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.314453433391908),
                                    ("Septemberyear (latent)", -5.908988325283744),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.810376036615634),
                                    ("Halloweenyear (latent)", -6.314453433391908),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.314453433391908),
                                    ("at <time-of-day>intersect", -5.908988325283744),
                                    ("Rosh Hashanahyear (latent)", -5.621306252831962),
                                    ("Dhanterasyear (latent)", -6.314453433391908),
                                    ("Tu BiShvatyear (latent)", -6.314453433391908),
                                    ("<day-of-month> (ordinal)December", -5.621306252831962),
                                    ("Holiyear (latent)", -5.621306252831962),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.314453433391908),
                                    ("Holika Dahanyear (latent)", -5.621306252831962),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.314453433391908),
                                    ("dayminute", -3.3966827013076286),
                                    ("Mawlidyear (latent)", -6.314453433391908),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.908988325283744),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.314453433391908),
                                    ("Jumu'atul-Widayear (latent)", -5.3981627015177525),
                                    ("minuteday", -2.485812036902813),
                                    ("absorption of , after named dayintersect",
                                     -6.314453433391908),
                                    ("intersectyear (latent)", -6.314453433391908),
                                    ("Orthodox Easter Sundayyear (latent)", -6.314453433391908),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.314453433391908),
                                    ("Boss's Dayyear (latent)", -5.908988325283744),
                                    ("Global Youth Service Dayyear (latent)", -6.314453433391908),
                                    ("Dhanterasin|during <named-month>|year", -6.314453433391908),
                                    ("Tisha B'Avyear (latent)", -6.314453433391908),
                                    ("Isra and Mi'rajyear (latent)", -5.3981627015177525),
                                    ("at <time-of-day>on <day>", -5.2158411447237985),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.314453433391908),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.621306252831962),
                                    ("Christmasyear (latent)", -5.908988325283744),
                                    ("Naraka Chaturdashiyear (latent)", -5.908988325283744),
                                    ("Thai Pongalin|during <named-month>|year", -6.314453433391908),
                                    ("dayweek", -6.314453433391908),
                                    ("Easter Sundayyear (latent)", -5.621306252831962),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.705015520957807),
                                    ("Labour Dayyear (latent)", -6.314453433391908),
                                    ("weekyear", -5.2158411447237985),
                                    ("King's Dayyear (latent)", -4.810376036615634),
                                    ("hh:mmin|during the <part-of-day>", -5.621306252831962),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.908988325283744),
                                    ("Hanukkahyear (latent)", -5.621306252831962),
                                    ("February<time> <part-of-day>", -6.314453433391908),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.314453433391908),
                                    ("Great Lentyear (latent)", -6.314453433391908),
                                    ("tomorrowat <time-of-day>", -5.621306252831962),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.314453433391908),
                                    ("Vaisakhiyear (latent)", -5.621306252831962),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.314453433391908),
                                    ("last <cycle> of <time>year (latent)", -5.621306252831962),
                                    ("at <time-of-day>tomorrow", -5.908988325283744),
                                    ("tomorrow<time-of-day> am|pm", -6.314453433391908),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.314453433391908),
                                    ("Diwaliyear (latent)", -6.314453433391908),
                                    ("between <time> and <time>on <day>", -4.705015520957807),
                                    ("Black Fridayyear (latent)", -5.908988325283744),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.314453433391908),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.314453433391908),
                                    ("Chhathyear (latent)", -5.908988325283744),
                                    ("Vasant Panchamiyear (latent)", -6.314453433391908),
                                    ("Rabindra Jayantiyear (latent)", -5.0616904648965395),
                                    ("St Patrick's Dayyear (latent)", -6.314453433391908),
                                    ("Thursday<time> (timezone)", -6.314453433391908),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.314453433391908),
                                    ("<datetime> - <datetime> (interval)July", -5.908988325283744),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.908988325283744),
                                    ("Februaryintersect", -6.314453433391908),
                                    ("Mother's Dayyear (latent)", -6.314453433391908),
                                    ("Simchat Torahyear (latent)", -6.314453433391908),
                                    ("Victoria Dayyear (latent)", -5.908988325283744),
                                    ("minuteyear", -6.314453433391908)],
                               n = 421},
                   koData =
                     ClassData{prior = -0.9628806751339846, unseen = -6.664409020350408,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.261935314328648),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.969985515430857),
                                    ("<day-of-month> (ordinal)August", -5.969985515430857),
                                    ("dayhour", -3.295836866004329),
                                    ("<time> timezoneyear (latent)", -5.969985515430857),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.053694783556702),
                                    ("Tuesdayfrom|since|after <time>", -5.969985515430857),
                                    ("daymonth", -3.4850788656428575),
                                    ("monthyear", -4.71722254693549),
                                    ("<time-of-day> am|pmyear (latent)", -5.276838334870912),
                                    ("Thai Pongalyear (latent)", -5.276838334870912),
                                    ("intersecthh:mm", -5.969985515430857),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.564520407322694),
                                    ("<day-of-month> (ordinal)Wednesday", -5.969985515430857),
                                    ("houryear", -4.5836911543109675),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.969985515430857),
                                    ("<day-of-month> (ordinal)October", -5.969985515430857),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.276838334870912),
                                    ("<time-of-day> am|pmintersect", -4.71722254693549),
                                    ("Octoberyear (latent)", -5.969985515430857),
                                    ("until <time>on <day>", -5.276838334870912),
                                    ("time-of-day (latent)intersect", -5.969985515430857),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.276838334870912),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.969985515430857),
                                    ("hh:mmon <day>", -3.5276384800616536),
                                    ("absorption of , after named dayJuly", -5.564520407322694),
                                    ("from|since|after <time>July", -5.564520407322694),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.053694783556702),
                                    ("Clean Mondayyear (latent)", -5.969985515430857),
                                    ("monthhour", -5.969985515430857),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.564520407322694),
                                    ("hourmonth", -4.0981833385292665),
                                    ("todayat <time-of-day>", -5.969985515430857),
                                    ("from|since|after <time>December", -5.969985515430857),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.969985515430857),
                                    ("<time-of-day> am|pmon <day>", -4.71722254693549),
                                    ("Mondayyear (latent)", -5.276838334870912),
                                    ("dayday", -4.5836911543109675),
                                    ("mm/ddat <time-of-day>", -5.564520407322694),
                                    ("on <day>September", -5.564520407322694),
                                    ("time-of-day (latent)September", -5.564520407322694),
                                    ("hourhour", -5.969985515430857),
                                    ("time-of-day (latent)on <day>", -3.5276384800616536),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.564520407322694),
                                    ("dayyear", -3.025546536264417),
                                    ("Thursdaymm/dd", -5.969985515430857),
                                    ("New Year's Dayyear (latent)", -5.053694783556702),
                                    ("Thursdayfrom|since|after <time>", -4.265237423192432),
                                    ("Thursdayat <time-of-day>", -4.360547602996757),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.969985515430857),
                                    ("Aprilyear (latent)", -5.969985515430857),
                                    ("the <day-of-month> (ordinal)July", -5.969985515430857),
                                    ("the <day-of-month> (number)July", -5.969985515430857),
                                    ("monthminute", -5.969985515430857),
                                    ("<time-of-day> am|pmtomorrow", -5.969985515430857),
                                    ("Thursdayhh:mm", -5.053694783556702),
                                    ("<day-of-month> (ordinal)Tuesday", -5.564520407322694),
                                    ("minutemonth", -4.0981833385292665),
                                    ("minutehour", -5.969985515430857),
                                    ("Augustyear (latent)", -5.564520407322694),
                                    ("week-endin|during <named-month>|year", -5.969985515430857),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.564520407322694),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.969985515430857),
                                    ("Sundayyear (latent)", -5.053694783556702),
                                    ("Christmasat <time-of-day>", -5.969985515430857),
                                    ("from|since|after <time>year (latent)", -4.871373226762748),
                                    ("<duration> after|before|from <time>December",
                                     -5.969985515430857),
                                    ("yesterday<time-of-day> am|pm", -5.969985515430857),
                                    ("<day-of-month> (ordinal)July", -5.276838334870912),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.969985515430857),
                                    ("mm/ddyear (latent)", -5.969985515430857),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.969985515430857),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.969985515430857),
                                    ("at <time-of-day>intersect", -5.564520407322694),
                                    ("hh:mmyear (latent)", -3.8905439737510217),
                                    ("Holiyear (latent)", -5.969985515430857),
                                    ("until <time><time-of-day> am|pm", -5.969985515430857),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.969985515430857),
                                    ("dayminute", -3.405036157969321),
                                    ("yyyy-mm-ddhh:mm", -5.564520407322694),
                                    ("intersectSeptember", -4.465908118654584),
                                    ("minuteday", -2.7313070632664775),
                                    ("absorption of , after named dayintersect",
                                     -5.969985515430857),
                                    ("intersectyear (latent)", -5.969985515430857),
                                    ("Februaryin|during the <part-of-day>", -5.969985515430857),
                                    ("time-of-day (latent)July", -5.276838334870912),
                                    ("Saturdayyear (latent)", -5.969985515430857),
                                    ("at <time-of-day>on <day>", -5.564520407322694),
                                    ("absorption of , after named daySeptember",
                                     -5.053694783556702),
                                    ("Naraka Chaturdashiyear (latent)", -5.969985515430857),
                                    ("from|since|after <time>on <day>", -5.053694783556702),
                                    ("dayweek", -5.969985515430857),
                                    ("Easter Sundayyear (latent)", -5.564520407322694),
                                    ("Thursday<time-of-day> am|pm", -4.71722254693549),
                                    ("weekyear", -5.564520407322694),
                                    ("time-of-day (latent)Thursday", -5.564520407322694),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.969985515430857),
                                    ("<day-of-month> (ordinal)April", -5.969985515430857),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.564520407322694),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.276838334870912),
                                    ("Sundayfrom|since|after <time>", -5.969985515430857),
                                    ("absorption of , after named dayFebruary", -5.053694783556702),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.969985515430857),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.969985515430857),
                                    ("tomorrowat <time-of-day>", -5.969985515430857),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.564520407322694),
                                    ("last <cycle> of <time>year (latent)", -5.564520407322694),
                                    ("tomorrow<time-of-day> am|pm", -5.969985515430857),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.276838334870912),
                                    ("Diwaliyear (latent)", -5.564520407322694),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.969985515430857),
                                    ("Fridayyear (latent)", -5.564520407322694),
                                    ("time-of-day (latent)April", -5.969985515430857),
                                    ("minuteyear", -3.7727609380946383)],
                               n = 260}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.17241602780455156, unseen = -5.25227342804663,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.208831455150051e-2),
                                    ("intersect 2 numbers", -3.8607297110405954)],
                               n = 186},
                   koData =
                     ClassData{prior = -1.8428146400283392,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
