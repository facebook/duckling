...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5982893871012682, unseen = -6.095824562432225,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 442},
                   koData =
                     ClassData{prior = -0.7979550573531953,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46301998549848306,
                               unseen = -7.108244139731541,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.414278293550759),
                                    ("Father's Dayyear (latent)", -6.414278293550759),
                                    ...
                                    ("daymonth", -4.399375273008495),
                                    ("monthday", -6.008813185442595),
                                    ("monthyear", -4.622518824322705),
                                    ...
                                    ("Family Dayyear (latent)", -5.497987561676604),
                                    ("Octoberyear (latent)", -4.9102008967744855),
                                    ...
                                    ("mm/ddat <time-of-day>", -6.414278293550759),
                                    ...
                                    ("<day-of-month> (ordinal)intersect", -6.008813185442595),
                                    ...
                                    ("National Patriots' Dayyear (latent)", -5.721131112990814),
                                    ...
                                    ("Discovery Dayyear (latent)", -6.008813185442595),
                                    ...
                                    ("absorption of , after named dayintersect",
                                     -5.721131112990814),
                                    ("intersectyear (latent)", -6.414278293550759),
                                    ...
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.008813185442595),
                                    ("Labour Dayyear (latent)", -6.414278293550759),
                                    ...
                                    ("Mother's Dayyear (latent)", -6.414278293550759),
                                    ("Simchat Torahyear (latent)", -6.414278293550759),
                                    ("Victoria Dayyear (latent)", -6.008813185442595),
                                    ("minuteyear", -6.414278293550759)],
                               n = 467},
                   koData =
                     ClassData{prior = -0.9925781455008091, unseen = -6.731018100482083,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.532599493153256),
                                    ("hourday", -3.6387816171311593),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.03667688992953),
                                    ("<day-of-month> (ordinal)August", -6.03667688992953),
                                    ("dayhour", -3.3625282405030013),
                                    ("<time> timezoneyear (latent)", -5.343529709369585),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.120386158055375),
                                    ("Tuesdayfrom|since|after <time>", -5.343529709369585),
                                    ("daymonth", -3.3625282405030013),
                                    ("monthyear", -4.783913921434162),
                                    ("<time-of-day> am|pmyear (latent)", -5.343529709369585),
                                    ("Thai Pongalyear (latent)", -5.343529709369585),
                                    ("intersecthh:mm", -6.03667688992953),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.631211781821365),
                                    ("<day-of-month> (ordinal)Wednesday", -6.03667688992953),
                                    ("houryear", -4.650382528809639),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.03667688992953),
                                    ("<day-of-month> (ordinal)October", -6.03667688992953),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.343529709369585),
                                    ("hournograin", -4.783913921434162),
                                    ("<time-of-day> am|pmintersect", -4.783913921434162),
                                    ("Octoberyear (latent)", -6.03667688992953),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.631211781821365),
                                    ("until <time>on <day>", -5.343529709369585),
                                    ("time-of-day (latent)intersect", -5.343529709369585),
                                    ("todayin <number> (implicit minutes)", -6.03667688992953),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.343529709369585),
                                    ("about|exactly <time-of-day>year (latent)", -6.03667688992953),
                                    ("hh:mmon <day>", -4.783913921434162),
                                    ("hhhmmintersect", -5.631211781821365),
                                    ("absorption of , after named dayJuly", -5.120386158055375),
                                    ("from|since|after <time>July", -5.631211781821365),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.120386158055375),
                                    ("Clean Mondayyear (latent)", -6.03667688992953),
                                    ("monthhour", -6.03667688992953),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.631211781821365),
                                    ("hourmonth", -4.164874713027938),
                                    ("todayat <time-of-day>", -6.03667688992953),
                                    ("hhhmmyear (latent)", -4.783913921434162),
                                    ("from|since|after <time>December", -6.03667688992953),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.03667688992953),
                                    ("<time-of-day> am|pmon <day>", -4.783913921434162),
                                    ("Mondayyear (latent)", -5.343529709369585),
                                    ("dayday", -4.650382528809639),
                                    ("mm/ddat <time-of-day>", -5.631211781821365),
                                    ("on <day>September", -5.343529709369585),
                                    ("time-of-day (latent)September", -5.631211781821365),
                                    ("hourhour", -5.631211781821365),
                                    ("time-of-day (latent)on <day>", -4.532599493153256),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.631211781821365),
                                    ("dayyear", -3.0922379107630893),
                                    ("Thursdaymm/dd", -6.03667688992953),
                                    ("New Year's Dayyear (latent)", -5.120386158055375),
                                    ("time-of-day (latent)Sunday", -5.631211781821365),
                                    ("Thursdayfrom|since|after <time>", -4.331928797691105),
                                    ("Thursdayat <time-of-day>", -4.4272389774954295),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.03667688992953),
                                    ("Aprilyear (latent)", -6.03667688992953),
                                    ("the <day-of-month> (ordinal)July", -6.03667688992953),
                                    ("the <day-of-month> (number)July", -6.03667688992953),
                                    ("monthminute", -6.03667688992953),
                                    ("<time-of-day> am|pmtomorrow", -6.03667688992953),
                                    ("Thursdayhh:mm", -5.120386158055375),
                                    ("<day-of-month> (ordinal)Tuesday", -5.631211781821365),
                                    ("minutemonth", -3.8966107264332592),
                                    ("time-of-day (latent)Friday", -5.631211781821365),
                                    ("minutehour", -6.03667688992953),
                                    ("Augustyear (latent)", -5.631211781821365),
                                    ("week-endin|during <named-month>|year", -6.03667688992953),
                                    ("time-of-day (latent)Tuesday", -5.631211781821365),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.631211781821365),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.03667688992953),
                                    ("Sundayyear (latent)", -5.120386158055375),
                                    ("Christmasat <time-of-day>", -6.03667688992953),
                                    ("from|since|after <time>year (latent)", -4.93806460126142),
                                    ("hhhmmon <day>", -5.120386158055375),
                                    ("yesterday<time-of-day> am|pm", -6.03667688992953),
                                    ("<day-of-month> (ordinal)July", -5.343529709369585),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.03667688992953),
                                    ("mm/ddyear (latent)", -6.03667688992953),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.03667688992953),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.03667688992953),
                                    ("at <time-of-day>intersect", -5.120386158055375),
                                    ("hh:mmyear (latent)", -4.650382528809639),
                                    ("Holiyear (latent)", -6.03667688992953),
                                    ("until <time><time-of-day> am|pm", -6.03667688992953),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.631211781821365),
                                    ("dayminute", -3.174476009000062),
                                    ("yyyy-mm-ddhh:mm", -5.631211781821365),
                                    ("intersectfrom|since|after <time>", -5.631211781821365),
                                    ("intersectSeptember", -4.164874713027938),
                                    ("minuteday", -2.8796764687794165),
                                    ("absorption of , after named dayintersect", -6.03667688992953),
                                    ("intersectyear (latent)", -6.03667688992953),
                                    ("Februaryin|during the <part-of-day>", -6.03667688992953),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.03667688992953),
                                    ("time-of-day (latent)July", -5.343529709369585),
                                    ("Saturdayyear (latent)", -6.03667688992953),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.03667688992953),
                                    ("at <time-of-day>on <day>", -5.120386158055375),
                                    ("absorption of , after named daySeptember",
                                     -4.783913921434162),
                                    ("Naraka Chaturdashiyear (latent)", -6.03667688992953),
                                    ("from|since|after <time>on <day>", -5.120386158055375),
                                    ("dayweek", -6.03667688992953),
                                    ("Easter Sundayyear (latent)", -5.631211781821365),
                                    ("Thursday<time-of-day> am|pm", -4.783913921434162),
                                    ("weekyear", -5.631211781821365),
                                    ("time-of-day (latent)Thursday", -5.631211781821365),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.03667688992953),
                                    ("<day-of-month> (ordinal)April", -6.03667688992953),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.631211781821365),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.343529709369585),
                                    ("Sundayfrom|since|after <time>", -6.03667688992953),
                                    ("absorption of , after named dayFebruary", -5.120386158055375),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.631211781821365),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.03667688992953),
                                    ("tomorrowat <time-of-day>", -6.03667688992953),
                                    ("daynograin", -5.631211781821365),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.631211781821365),
                                    ("last <cycle> of <time>year (latent)", -5.631211781821365),
                                    ("tomorrow<time-of-day> am|pm", -6.03667688992953),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.343529709369585),
                                    ("Diwaliyear (latent)", -5.631211781821365),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.03667688992953),
                                    ("Fridayyear (latent)", -5.631211781821365),
                                    ("time-of-day (latent)April", -6.03667688992953),
                                    ("minuteyear", -3.8394523125933104)],
                               n = 275}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.15213658045555706,
                               ...
                               n = 213},
                   koData =
                     ClassData{prior = -1.9580806846755685,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
