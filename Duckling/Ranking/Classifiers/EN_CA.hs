...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5922410152514994,
                               unseen = -6.1092475827643655,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 448},
                   koData =
                     ClassData{prior = -0.8053900358407134,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4583075894825443, unseen = -7.118826249062078,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.424869023905388),
                                    ("Father's Dayyear (latent)", -6.424869023905388),
                                    ("Karva Chauthyear (latent)", -6.424869023905388),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.424869023905388),
                                    ("Maha Shivaratriyear (latent)", -6.424869023905388),
                                    ("Ramadanyear (latent)", -5.508578292031233),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.038574662785497),
                                    ("Bhai Doojyear (latent)", -6.424869023905388),
                                    ("hourday", -4.409966003363123),
                                    ("dayhour", -3.4804300447389473),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.038574662785497),
                                    ("Martin Luther King's Dayyear (latent)", -6.0194039157972234),
                                    ("Shemini Atzeretyear (latent)", -6.424869023905388),
                                    ("daymonth", -4.409966003363123),
                                    ("monthday", -6.0194039157972234),
                                    ("monthyear", -4.633109554677333),
                                    ("Yom Ha'atzmautyear (latent)", -6.424869023905388),
                                    ("Vijayadashamiyear (latent)", -6.424869023905388),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -6.0194039157972234),
                                    ("Thanksgiving Dayyear (latent)", -5.326256735237278),
                                    ("Thai Pongalyear (latent)", -5.731721843345443),
                                    ("Thiru Onamyear (latent)", -5.731721843345443),
                                    ("hhhmmabsorption of , after named day", -6.424869023905388),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.424869023905388),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.508578292031233),
                                    ("<day-of-month> (ordinal)Wednesday", -6.424869023905388),
                                    ("Krishna Janmashtamiyear (latent)", -6.0194039157972234),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.424869023905388),
                                    ("houryear", -5.508578292031233),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.424869023905388),
                                    ("Christmas<time-of-day> am|pm", -6.424869023905388),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.424869023905388),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.731721843345443),
                                    ("intersectin|during <named-month>|year", -6.424869023905388),
                                    ("<time-of-day> am|pmintersect", -5.17210605541002),
                                    ("Earth Houryear (latent)", -6.424869023905388),
                                    ("Family Dayyear (latent)", -5.508578292031233),
                                    ("Octoberyear (latent)", -4.920791627129113),
                                    ("intersect<time-of-day> am|pm", -6.424869023905388),
                                    ("Mattu Pongalyear (latent)", -6.424869023905388),
                                    ("Shavuotyear (latent)", -6.424869023905388),
                                    ("Parsi New Yearyear (latent)", -5.508578292031233),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.424869023905388),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.424869023905388),
                                    ("todayin|within|after <duration>", -6.424869023905388),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.0194039157972234),
                                    ("Marchyear (latent)", -6.424869023905388),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.0194039157972234),
                                    ("Sukkotyear (latent)", -6.0194039157972234),
                                    ("hhhmmintersect", -6.0194039157972234),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.0194039157972234),
                                    ("Clean Mondayyear (latent)", -6.0194039157972234),
                                    ("monthhour", -6.0194039157972234),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.731721843345443),
                                    ("todayat <time-of-day>", -6.424869023905388),
                                    ("Thursday<time> timezone", -4.026973751107017),
                                    ("time-of-day (latent)tonight", -6.0194039157972234),
                                    ("from|since|after <time>December", -6.424869023905388),
                                    ("<time-of-day> am|pmon <day>", -4.409966003363123),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.424869023905388),
                                    ("yyyy-mm-ddhh:mm:ss", -6.0194039157972234),
                                    ("dayday", -3.7168188228031775),
                                    ("<time> <part-of-day>at <time-of-day>", -6.424869023905388),
                                    ("mm/ddat <time-of-day>", -6.424869023905388),
                                    ("tonightat <time-of-day>", -6.424869023905388),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.731721843345443),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.424869023905388),
                                    ("today<time-of-day> am|pm", -6.424869023905388),
                                    ("Februarythe <day-of-month> (ordinal)", -6.0194039157972234),
                                    ("at <time-of-day><time> <part-of-day>", -6.424869023905388),
                                    ("<day-of-month> (ordinal)intersect", -6.0194039157972234),
                                    ("mm/dd<time-of-day> am|pm", -6.424869023905388),
                                    ("hourhour", -4.345427482225552),
                                    ("Mahavir Jayantiyear (latent)", -6.0194039157972234),
                                    ("Navaratriin|during <named-month>|year", -6.424869023905388),
                                    ("National Patriots' Dayyear (latent)", -5.731721843345443),
                                    ("Wednesdaythis|last|next <cycle>", -6.424869023905388),
                                    ("Lentyear (latent)", -6.424869023905388),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.553066847003796),
                                    ("Boghiyear (latent)", -6.424869023905388),
                                    ("dayyear", -1.8605208324375515),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.424869023905388),
                                    ("Thursdayfrom|since|after <time>", -6.0194039157972234),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.424869023905388),
                                    ("Thursdayat <time-of-day>", -5.731721843345443),
                                    ("Islamic New Yearyear (latent)", -6.0194039157972234),
                                    ("Laylat al-Qadryear (latent)", -5.508578292031233),
                                    ("Discovery Dayyear (latent)", -6.0194039157972234),
                                    ("Shrove Tuesdayyear (latent)", -6.424869023905388),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.731721843345443),
                                    ("<time-of-day> am|pmtomorrow", -5.731721843345443),
                                    ("Yom Kippuryear (latent)", -6.424869023905388),
                                    ("<day-of-month> (ordinal)Tuesday", -6.0194039157972234),
                                    ("<part-of-day> of <time>year (latent)", -6.424869023905388),
                                    ("minutehour", -5.17210605541002),
                                    ("Kaanum Pongalyear (latent)", -6.0194039157972234),
                                    ("Maha Saptamiyear (latent)", -6.424869023905388),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.0194039157972234),
                                    ("time-of-day (latent)tomorrow", -5.508578292031233),
                                    ("part of daysat <time-of-day>", -6.0194039157972234),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.409966003363123),
                                    ("for <duration> from <time>December", -6.424869023905388),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.424869023905388),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.17210605541002),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.17210605541002),
                                    ("time-of-day (latent)this <part-of-day>", -6.424869023905388),
                                    ("Pentecostyear (latent)", -6.424869023905388),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.17210605541002),
                                    ("<day-of-month> (ordinal)February", -6.424869023905388),
                                    ("Eid al-Fitryear (latent)", -5.508578292031233),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.424869023905388),
                                    ("Mondayin|during the <part-of-day>", -6.424869023905388),
                                    ("Chhathin|during <named-month>|year", -6.424869023905388),
                                    ("Diwaliin|during <named-month>|year", -6.424869023905388),
                                    ("Vaisakhiin|during <named-month>|year", -6.424869023905388),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.17210605541002),
                                    ("Raksha Bandhanyear (latent)", -6.424869023905388),
                                    ("daysecond", -6.0194039157972234),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.0194039157972234),
                                    ("Ashurayear (latent)", -6.424869023905388),
                                    ("Tuesdayin|during <named-month>|year", -6.424869023905388),
                                    ("Chinese New Yearyear (latent)", -6.424869023905388),
                                    ("tomorrowintersect", -6.424869023905388),
                                    ("Lag BaOmeryear (latent)", -6.424869023905388),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.424869023905388),
                                    ("Eid al-Adhayear (latent)", -4.284802860409117),
                                    ("intersectin|during the <part-of-day>", -6.424869023905388),
                                    ("Palm Sundayyear (latent)", -6.424869023905388),
                                    ("Christmasat <time-of-day>", -6.424869023905388),
                                    ("Passoveryear (latent)", -6.424869023905388),
                                    ("Lazarus Saturdayyear (latent)", -6.424869023905388),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.424869023905388),
                                    ("hhhmmon <day>", -5.508578292031233),
                                    ("Yom HaShoahyear (latent)", -6.0194039157972234),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.0194039157972234),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.424869023905388),
                                    ("Septemberyear (latent)", -6.0194039157972234),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.920791627129113),
                                    ("Halloweenyear (latent)", -6.424869023905388),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.424869023905388),
                                    ("at <time-of-day>intersect", -5.508578292031233),
                                    ("Rosh Hashanahyear (latent)", -5.731721843345443),
                                    ("Dhanterasyear (latent)", -6.424869023905388),
                                    ("Tu BiShvatyear (latent)", -6.424869023905388),
                                    ("<day-of-month> (ordinal)December", -5.731721843345443),
                                    ("Holiyear (latent)", -5.731721843345443),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.424869023905388),
                                    ("Holika Dahanyear (latent)", -5.731721843345443),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0194039157972234),
                                    ("dayminute", -3.0749649366307827),
                                    ("Mawlidyear (latent)", -6.424869023905388),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.0194039157972234),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.424869023905388),
                                    ("Jumu'atul-Widayear (latent)", -5.508578292031233),
                                    ("minuteday", -2.6871994056220196),
                                    ("absorption of , after named dayintersect",
                                     -5.731721843345443),
                                    ("intersectyear (latent)", -6.424869023905388),
                                    ("Orthodox Easter Sundayyear (latent)", -6.424869023905388),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.424869023905388),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.424869023905388),
                                    ("intersecthhhmm", -6.0194039157972234),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.424869023905388),
                                    ("Boss's Dayyear (latent)", -6.0194039157972234),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.424869023905388),
                                    ("Global Youth Service Dayyear (latent)", -6.424869023905388),
                                    ("Dhanterasin|during <named-month>|year", -6.424869023905388),
                                    ("Tisha B'Avyear (latent)", -6.424869023905388),
                                    ("Isra and Mi'rajyear (latent)", -5.508578292031233),
                                    ("at <time-of-day>on <day>", -4.8154311114712876),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.0194039157972234),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.731721843345443),
                                    ("Christmasyear (latent)", -6.0194039157972234),
                                    ("Naraka Chaturdashiyear (latent)", -6.0194039157972234),
                                    ("Thai Pongalin|during <named-month>|year", -6.424869023905388),
                                    ("dayweek", -6.424869023905388),
                                    ("Easter Sundayyear (latent)", -5.731721843345443),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.0194039157972234),
                                    ("Labour Dayyear (latent)", -6.424869023905388),
                                    ("weekyear", -5.326256735237278),
                                    ("King's Dayyear (latent)", -4.920791627129113),
                                    ("hh:mmin|during the <part-of-day>", -5.508578292031233),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.0194039157972234),
                                    ("Hanukkahyear (latent)", -5.731721843345443),
                                    ("February<time> <part-of-day>", -6.424869023905388),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.424869023905388),
                                    ("Great Lentyear (latent)", -6.424869023905388),
                                    ("tomorrowat <time-of-day>", -5.731721843345443),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.424869023905388),
                                    ("Vaisakhiyear (latent)", -5.731721843345443),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.731721843345443),
                                    ("last <cycle> of <time>year (latent)", -5.731721843345443),
                                    ("at <time-of-day>tomorrow", -6.0194039157972234),
                                    ("tomorrow<time-of-day> am|pm", -6.424869023905388),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.424869023905388),
                                    ("Diwaliyear (latent)", -6.424869023905388),
                                    ("between <time> and <time>on <day>", -6.0194039157972234),
                                    ("Black Fridayyear (latent)", -6.0194039157972234),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.424869023905388),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.424869023905388),
                                    ("Chhathyear (latent)", -6.0194039157972234),
                                    ("Vasant Panchamiyear (latent)", -6.424869023905388),
                                    ("Rabindra Jayantiyear (latent)", -5.17210605541002),
                                    ("St Patrick's Dayyear (latent)", -6.424869023905388),
                                    ("Thursday<time> (timezone)", -6.424869023905388),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.424869023905388),
                                    ("Pargat Diwasyear (latent)", -5.17210605541002),
                                    ("<datetime> - <datetime> (interval)July", -6.0194039157972234),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.731721843345443),
                                    ("Februaryintersect", -6.424869023905388),
                                    ("Mother's Dayyear (latent)", -6.424869023905388),
                                    ("Simchat Torahyear (latent)", -6.424869023905388),
                                    ("Victoria Dayyear (latent)", -6.0194039157972234),
                                    ("minuteyear", -6.424869023905388)],
                               n = 473},
                   koData =
                     ClassData{prior = -1.000631880307906, unseen = -6.732210706467206,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.533793523145864),
                                    ...
                                    ("mm/ddat <time-of-day>", -5.632405811813974),
