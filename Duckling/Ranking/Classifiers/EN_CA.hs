...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6200032962128809, unseen = -5.771441123130016,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 319},
                   koData =
                     ClassData{prior = -0.7720662926096552, unseen = -5.62040086571715,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45746308868785995,
                               unseen = -6.784457062637643,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.090178020044014),
                                    ("Father's Dayyear (latent)", -6.090178020044014),
                                    ("Ramadanyear (latent)", -6.090178020044014),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.837415051548647),
                                    ("Bhai Doojyear (latent)", -6.090178020044014),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.837415051548647),
                                    ("hourday", -4.385429927805589),
                                    ("dayhour", -3.227977139114546),
                                    ("Martin Luther King's Dayyear (latent)", -5.684712911935851),
                                    ("Shemini Atzeretyear (latent)", -6.090178020044014),
                                    ("daymonth", -5.17388728816986),
                                    ("monthday", -5.684712911935851),
                                    ("monthyear", -4.29841855081596),
                                    ("Yom Ha'atzmautyear (latent)", -6.090178020044014),
                                    ("Vijayadashamiyear (latent)", -6.090178020044014),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.684712911935851),
                                    ("Thanksgiving Dayyear (latent)", -4.991565731375905),
                                    ("Thai Pongalyear (latent)", -5.397030839484069),
                                    ("Thiru Onamyear (latent)", -5.397030839484069),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.090178020044014),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.090178020044014),
                                    ("houryear", -5.397030839484069),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.090178020044014),
                                    ("Christmas<time-of-day> am|pm", -6.090178020044014),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.090178020044014),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.397030839484069),
                                    ("<time-of-day> am|pmintersect", -4.837415051548647),
                                    ("Earth Houryear (latent)", -6.090178020044014),
                                    ("Family Dayyear (latent)", -5.17388728816986),
                                    ("Octoberyear (latent)", -4.586100623267741),
                                    ("intersect<time-of-day> am|pm", -6.090178020044014),
                                    ("Mattu Pongalyear (latent)", -6.090178020044014),
                                    ("Shavuotyear (latent)", -6.090178020044014),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.090178020044014),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.090178020044014),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.684712911935851),
                                    ("Marchyear (latent)", -6.090178020044014),
                                    ("Sukkotyear (latent)", -5.684712911935851),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.090178020044014),
                                    ("Clean Mondayyear (latent)", -5.684712911935851),
                                    ("monthhour", -5.684712911935851),
                                    ("todayat <time-of-day>", -6.090178020044014),
                                    ("Thursday<time> timezone", -4.144267870988702),
                                    ("from|since|after <time>December", -6.090178020044014),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.090178020044014),
                                    ("yyyy-mm-ddhh:mm:ss", -5.684712911935851),
                                    ("dayday", -4.07527499950175),
                                    ("<time> <part-of-day>at <time-of-day>", -6.090178020044014),
                                    ("mm/ddat <time-of-day>", -6.090178020044014),
                                    ("tonightat <time-of-day>", -6.090178020044014),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.397030839484069),
                                    ("today<time-of-day> am|pm", -6.090178020044014),
                                    ("Februarythe <day-of-month> (ordinal)", -5.684712911935851),
                                    ("at <time-of-day><time> <part-of-day>", -6.090178020044014),
                                    ("mm/dd<time-of-day> am|pm", -6.090178020044014),
                                    ("hourhour", -4.837415051548647),
                                    ("<time-of-day> am|pmon <date>", -4.07527499950175),
                                    ("Navaratriin|during <named-month>|year", -6.090178020044014),
                                    ("National Patriots' Dayyear (latent)", -5.397030839484069),
                                    ("Wednesdaythis|last|next <cycle>", -6.090178020044014),
                                    ("Lentyear (latent)", -6.090178020044014),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.586100623267741),
                                    ("Boghiyear (latent)", -6.090178020044014),
                                    ("dayyear", -1.9312949366843428),
                                    ("Thursdayfrom|since|after <time>", -5.684712911935851),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.090178020044014),
                                    ("Thursdayat <time-of-day>", -5.397030839484069),
                                    ("Islamic New Yearyear (latent)", -5.684712911935851),
                                    ("Laylat al-Qadryear (latent)", -5.17388728816986),
                                    ("Discovery Dayyear (latent)", -5.684712911935851),
                                    ("Shrove Tuesdayyear (latent)", -6.090178020044014),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.397030839484069),
                                    ("<time-of-day> am|pmtomorrow", -5.397030839484069),
                                    ("Yom Kippuryear (latent)", -6.090178020044014),
                                    ("<part-of-day> of <time>year (latent)", -6.090178020044014),
                                    ("minutehour", -5.17388728816986),
                                    ("Kaanum Pongalyear (latent)", -5.684712911935851),
                                    ("Maha Saptamiyear (latent)", -6.090178020044014),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.684712911935851),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.385429927805589),
                                    ("for <duration> from <time>December", -6.090178020044014),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.090178020044014),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.17388728816986),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.684712911935851),
                                    ("Pentecostyear (latent)", -6.090178020044014),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.17388728816986),
                                    ("Eid al-Fitryear (latent)", -6.090178020044014),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.090178020044014),
                                    ("Mondayin|during the <part-of-day>", -6.090178020044014),
                                    ("Chhathin|during <named-month>|year", -6.090178020044014),
                                    ("Diwaliin|during <named-month>|year", -6.090178020044014),
                                    ("Raksha Bandhanyear (latent)", -6.090178020044014),
                                    ("daysecond", -5.684712911935851),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.684712911935851),
                                    ("Ashurayear (latent)", -6.090178020044014),
                                    ("Tuesdayin|during <named-month>|year", -6.090178020044014),
                                    ("Chinese New Yearyear (latent)", -6.090178020044014),
                                    ("Lag BaOmeryear (latent)", -6.090178020044014),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.090178020044014),
                                    ("Eid al-Adhayear (latent)", -5.17388728816986),
                                    ("intersectin|during the <part-of-day>", -6.090178020044014),
                                    ("Palm Sundayyear (latent)", -6.090178020044014),
                                    ("Christmasat <time-of-day>", -6.090178020044014),
                                    ("Passoveryear (latent)", -6.090178020044014),
                                    ("Lazarus Saturdayyear (latent)", -6.090178020044014),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.090178020044014),
                                    ("Yom HaShoahyear (latent)", -5.684712911935851),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.684712911935851),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.090178020044014),
                                    ("Septemberyear (latent)", -5.684712911935851),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.837415051548647),
                                    ("Halloweenyear (latent)", -6.090178020044014),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.090178020044014),
                                    ("at <time-of-day>intersect", -5.684712911935851),
                                    ("Rosh Hashanahyear (latent)", -5.397030839484069),
                                    ("Dhanterasyear (latent)", -6.090178020044014),
                                    ("Tu BiShvatyear (latent)", -6.090178020044014),
                                    ("Holiyear (latent)", -5.397030839484069),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.090178020044014),
                                    ("Holika Dahanyear (latent)", -5.397030839484069),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.090178020044014),
                                    ("dayminute", -3.349337996118814),
                                    ("Mawlidyear (latent)", -6.090178020044014),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.684712911935851),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.090178020044014),
                                    ("Jumu'atul-Widayear (latent)", -5.17388728816986),
                                    ("minuteday", -2.452591860317629),
                                    ("absorption of , after named dayintersect",
                                     -6.090178020044014),
                                    ("Orthodox Easter Sundayyear (latent)", -6.090178020044014),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.090178020044014),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.090178020044014),
                                    ("Boss's Dayyear (latent)", -5.684712911935851),
                                    ("Global Youth Service Dayyear (latent)", -6.090178020044014),
                                    ("Dhanterasin|during <named-month>|year", -6.090178020044014),
                                    ("Tisha B'Avyear (latent)", -6.090178020044014),
                                    ("Isra and Mi'rajyear (latent)", -5.17388728816986),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.090178020044014),
                                    ("Christmasyear (latent)", -5.684712911935851),
                                    ("Naraka Chaturdashiyear (latent)", -5.684712911935851),
                                    ("at <time-of-day>on <date>", -4.991565731375905),
                                    ("Thai Pongalin|during <named-month>|year", -6.090178020044014),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.480740107609915),
                                    ("dayweek", -6.090178020044014),
                                    ("Easter Sundayyear (latent)", -5.397030839484069),
                                    ("Labour Dayyear (latent)", -6.090178020044014),
                                    ("weekyear", -4.991565731375905),
                                    ("hh:mmin|during the <part-of-day>", -5.397030839484069),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.684712911935851),
                                    ("Hanukkahyear (latent)", -5.397030839484069),
                                    ("February<time> <part-of-day>", -6.090178020044014),
                                    ("Great Lentyear (latent)", -6.090178020044014),
                                    ("tomorrowat <time-of-day>", -5.397030839484069),
                                    ("between <time> and <time>on <date>", -4.480740107609915),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.090178020044014),
                                    ("last <cycle> of <time>year (latent)", -5.397030839484069),
                                    ("at <time-of-day>tomorrow", -5.684712911935851),
                                    ("tomorrow<time-of-day> am|pm", -6.090178020044014),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.090178020044014),
                                    ("Diwaliyear (latent)", -6.090178020044014),
                                    ("Black Fridayyear (latent)", -5.684712911935851),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.090178020044014),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.090178020044014),
                                    ("Chhathyear (latent)", -5.684712911935851),
                                    ("Vasant Panchamiyear (latent)", -6.090178020044014),
                                    ("Thursday<time> (timezone)", -6.090178020044014),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.090178020044014),
                                    ("Februaryintersect", -6.090178020044014),
                                    ("Mother's Dayyear (latent)", -6.090178020044014),
                                    ("Simchat Torahyear (latent)", -6.090178020044014),
                                    ("Victoria Dayyear (latent)", -5.684712911935851),
                                    ("minuteyear", -6.090178020044014)],
                               n = 331},
                   koData =
                     ClassData{prior = -1.0020860920371413, unseen = -6.406879986069314,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.795790545596741),
                                    ...
                                    ("<time-of-day> am|pmon <date>", -4.459318308975528),
                                    ...
                                    ("hh:mmon <date>", -3.6971782569286313),
                                    ("Saturdayyear (latent)", -5.7120812774708964),
                                    ("from|since|after <time>on <date>", -4.795790545596741),
                                    ("absorption of , after named daySeptember",
                                     -4.795790545596741),
                                    ("Naraka Chaturdashiyear (latent)", -5.7120812774708964),
                                    ("on <date>September", -5.306616169362732),
                                    ("at <time-of-day>on <date>", -5.306616169362732),
