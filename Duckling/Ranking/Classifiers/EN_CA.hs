...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7095218154317354, unseen = -5.365976015021851,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 212},
                   koData =
                     ClassData{prior = -0.677036360287247, unseen = -5.3981627015177525,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4732173438488313,
                               unseen = -6.4425401664681985,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                     -4.4950363915776075),
                                    ("Lentyear", -5.7477993600729755),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.4950363915776075),
                                    ("hourday", -4.04305126783455),
                                    ("dayhour", -2.8574276021768106),
                                    ("National Patriots' Dayyear", -5.05465217951303),
                                    ("daymonth", -5.05465217951303),
                                    ("monthday", -5.342334251964811),
                                    ("monthyear", -4.138361447638875),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.7477993600729755),
                                    ("Easter Sundayyear", -5.05465217951303),
                                    ("Christmasyear", -5.342334251964811),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.7477993600729755),
                                    ("houryear", -5.342334251964811),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.7477993600729755),
                                    ("Christmas<time-of-day> am|pm", -5.7477993600729755),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.05465217951303),
                                    ("<time-of-day> am|pmintersect", -4.4950363915776075),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.7477993600729755),
                                    ("Marchyear", -5.7477993600729755),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.342334251964811),
                                    ("intersect<time-of-day> am|pm", -5.7477993600729755),
                                    ("Clean Mondayyear", -5.342334251964811),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.7477993600729755),
                                    ("monthhour", -5.342334251964811),
                                    ("last <day-of-week> of <time>year", -5.7477993600729755),
                                    ("todayat <time-of-day>", -5.7477993600729755),
                                    ("Thursday<time> timezone", -4.04305126783455),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.7477993600729755),
                                    ("Palm SundaySunday", -5.342334251964811),
                                    ("dayday", -3.550574782736756),
                                    ("Thanksgiving Dayyear", -4.6491870714048655),
                                    ("<time> <part-of-day>at <time-of-day>", -5.7477993600729755),
                                    ("Tuesdayin <named-month>", -5.7477993600729755),
                                    ("mm/ddat <time-of-day>", -5.7477993600729755),
                                    ("tonightat <time-of-day>", -5.7477993600729755),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.05465217951303),
                                    ("today<time-of-day> am|pm", -5.7477993600729755),
                                    ("Februarythe <day-of-month> (ordinal)", -5.342334251964811),
                                    ("at <time-of-day><time> <part-of-day>", -5.7477993600729755),
                                    ("mm/dd<time-of-day> am|pm", -5.7477993600729755),
                                    ("hourhour", -4.4950363915776075),
                                    ("<time-of-day> am|pmon <date>", -3.7328963395307104),
                                    ("Wednesdaythis|last|next <cycle>", -5.7477993600729755),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.243721963296701),
                                    ("dayyear", -2.549126242522294),
                                    ("last weekend of <named-month>year", -5.7477993600729755),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.7477993600729755),
                                    ("Sundayyear", -5.7477993600729755),
                                    ("Chinese New Yearyear", -5.7477993600729755),
                                    ("Thursdayat <time-of-day>", -5.342334251964811),
                                    ("<time-of-day> am|pmtomorrow", -5.05465217951303),
                                    ("minutehour", -4.83150862819882),
                                    ("Mother's Dayyear", -5.7477993600729755),
                                    ("Victoria Dayyear", -5.342334251964811),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.342334251964811),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.04305126783455),
                                    ("for <duration> from <time>December", -5.7477993600729755),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.7477993600729755),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.83150862819882),
                                    ("Mondayin|during the <part-of-day>", -5.7477993600729755),
                                    ("Shrove Tuesdayyear", -5.7477993600729755),
                                    ("<part-of-day> of <time>year", -5.7477993600729755),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.342334251964811),
                                    ("Labour Dayyear", -5.7477993600729755),
                                    ("intersectin|during the <part-of-day>", -5.7477993600729755),
                                    ("Christmasat <time-of-day>", -5.7477993600729755),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -4.83150862819882),
                                    ("at <time-of-day>intersect", -5.342334251964811),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.7477993600729755),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7477993600729755),
                                    ("dayminute", -3.073650710646447),
                                    ("Boss's Dayyear", -5.342334251964811),
                                    ("Orthodox Easter Sundayyear", -5.7477993600729755),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.342334251964811),
                                    ("intersectyear", -5.7477993600729755),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.7477993600729755),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.342334251964811),
                                    ("<ordinal> <cycle> of <time>year", -5.7477993600729755),
                                    ("minuteday", -2.282063457273249),
                                    ("absorption of , after named dayintersect",
                                     -5.7477993600729755),
                                    ("Family Dayyear", -4.83150862819882),
                                    ("Octoberyear", -4.4950363915776075),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.7477993600729755),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.7477993600729755),
                                    ("year<time-of-day> am|pm", -5.7477993600729755),
                                    ("Septemberyear", -5.342334251964811),
                                    ("at <time-of-day>on <date>", -4.6491870714048655),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -5.05465217951303),
                                    ("Halloweenyear", -5.7477993600729755),
                                    ("dayweek", -5.7477993600729755),
                                    ("Lazarus Saturdayyear", -5.7477993600729755),
                                    ("Thursday<time-of-day> am|pm", -5.7477993600729755),
                                    ("weekyear", -5.342334251964811),
                                    ("hh:mmin|during the <part-of-day>", -5.05465217951303),
                                    ("Father's Dayyear", -5.7477993600729755),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.342334251964811),
                                    ("February<time> <part-of-day>", -5.7477993600729755),
                                    ("Martin Luther King's Dayyear", -5.342334251964811),
                                    ("tomorrowat <time-of-day>", -5.05465217951303),
                                    ("between <time> and <time>on <date>", -5.05465217951303),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.05465217951303),
                                    ("at <time-of-day>tomorrow", -5.342334251964811),
                                    ("tomorrow<time-of-day> am|pm", -5.7477993600729755),
                                    ("Pentecostyear", -5.7477993600729755),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.7477993600729755),
                                    ("Palm Sundayintersect", -5.7477993600729755),
                                    ("Great Lentyear", -5.7477993600729755),
                                    ("Februaryintersect", -5.7477993600729755),
                                    ("last <cycle> of <time>year", -5.05465217951303),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.7477993600729755),
                                    ("yearminute", -5.7477993600729755),
                                    ("Black Fridayyear", -5.342334251964811)],
                               n = 233},
                   koData =
                     ClassData{prior = -0.9754959070363637, unseen = -6.095824562432225,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.40042258948519),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.40042258948519),
                                    ("New Year's Dayyear", -5.40042258948519),
       ...
       ("year",
        Classifier{okData =
                     ClassData{prior = -0.22631312607548876,
                               unseen = -4.219507705176107,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -7.75582343458745e-2),
                                    ("intersect 2 numbers", -3.1060803307228566)],
                               n = 63},
                   koData =
                     ClassData{prior = -1.5968591302272404, unseen = -3.044522437723423,
                               likelihoods =
                                 HashMap.fromList
