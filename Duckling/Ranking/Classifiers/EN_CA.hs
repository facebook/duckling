...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5637225698880761,
                               unseen = -6.1903154058531475,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 486},
                   koData =
                     ClassData{prior = -0.8418482556196389, unseen = -5.91350300563827,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45618020068718085,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.511745329644728),
                                    ...
                                    ("<time-of-day> am|pmtomorrow", -5.595454597770573),
                               ...
                               n = 519},
                   koData =
                     ClassData{prior = -1.0043016091968684, unseen = -6.812345094177479,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.614019801265074),
                                    ("hourday", -3.6757501626721436),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.118097198041348),
                                    ("<day-of-month> (ordinal)August", -6.118097198041348),
                                    ("dayhour", -3.443948548614819),
                                    ("<time> timezoneyear (latent)", -5.424950017481403),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.201806466167193),
                                    ("Tuesdayfrom|since|after <time>", -5.424950017481403),
                                    ("daymonth", -3.443948548614819),
                                    ("monthyear", -4.86533422954598),
                                    ("<time-of-day> am|pmyear (latent)", -5.424950017481403),
                                    ("Thai Pongalyear (latent)", -5.424950017481403),
                                    ("intersecthh:mm", -6.118097198041348),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.712632089933184),
                                    ("<day-of-month> (ordinal)Wednesday", -6.118097198041348),
                                    ("houryear", -4.7318028369214575),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.118097198041348),
                                    ("<day-of-month> (ordinal)October", -6.118097198041348),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.424950017481403),
                                    ("hournograin", -4.86533422954598),
                                    ("<time-of-day> am|pmintersect", -4.86533422954598),
                                    ("Octoberyear (latent)", -6.118097198041348),
                                    ("Good Fridayyear (latent)", -5.712632089933184),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.712632089933184),
                                    ("early morningat <time-of-day>", -6.118097198041348),
                                    ("until <time>on <day>", -5.424950017481403),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.118097198041348),
                                    ("time-of-day (latent)intersect", -5.424950017481403),
                                    ("todayin <number> (implicit minutes)", -6.118097198041348),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.424950017481403),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.118097198041348),
                                    ("hh:mmon <day>", -4.86533422954598),
                                    ("hhhmmintersect", -5.712632089933184),
                                    ("absorption of , after named dayJuly", -5.201806466167193),
                                    ("from|since|after <time>July", -5.712632089933184),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.201806466167193),
                                    ("Clean Mondayyear (latent)", -6.118097198041348),
                                    ("monthhour", -6.118097198041348),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.712632089933184),
                                    ("hourmonth", -4.2462950211397565),
                                    ("todayat <time-of-day>", -6.118097198041348),
                                    ("hhhmmyear (latent)", -4.86533422954598),
                                    ("from|since|after <time>December", -6.118097198041348),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.118097198041348),
                                    ("<time-of-day> am|pmon <day>", -4.86533422954598),
                                    ("Mondayyear (latent)", -5.424950017481403),
                                    ("dayday", -4.103194177499083),
                                    ("mm/ddat <time-of-day>", -5.712632089933184),
                                    ("on <day>September", -5.424950017481403),
                                    ("time-of-day (latent)September", -5.712632089933184),
                                    ("hourhour", -4.038655656361512),
                                    ("time-of-day (latent)on <day>", -4.614019801265074),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.712632089933184),
                                    ("dayyear", -3.073574760317925),
                                    ("Thursdaymm/dd", -6.118097198041348),
                                    ("New Year's Dayyear (latent)", -5.201806466167193),
                                    ("time-of-day (latent)Sunday", -5.712632089933184),
                                    ("Thursdayfrom|since|after <time>", -4.413349105802923),
                                    ("Thursdayat <time-of-day>", -4.508659285607248),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.118097198041348),
                                    ("Aprilyear (latent)", -6.118097198041348),
                                    ("the <day-of-month> (ordinal)July", -6.118097198041348),
                                    ("the <day-of-month> (number)July", -6.118097198041348),
                                    ("monthminute", -6.118097198041348),
                                    ("<time-of-day> am|pmtomorrow", -5.712632089933184),
                                    ("Thursdayhh:mm", -5.201806466167193),
                                    ("<day-of-month> (ordinal)Tuesday", -5.712632089933184),
                                    ("minutemonth", -3.978031034545077),
                                    ("time-of-day (latent)Friday", -5.712632089933184),
                                    ("minutehour", -6.118097198041348),
                                    ("part of daysat <time-of-day>", -5.019484909373238),
                                    ("Augustyear (latent)", -5.712632089933184),
                                    ("week-endin|during <named-month>|year", -6.118097198041348),
                                    ("time-of-day (latent)Tuesday", -5.712632089933184),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.118097198041348),
                                    ("Sundayyear (latent)", -5.201806466167193),
                                    ("the <day-of-month> (ordinal)Monday", -5.424950017481403),
                                    ("Christmasat <time-of-day>", -6.118097198041348),
                                    ("from|since|after <time>year (latent)", -5.019484909373238),
                                    ("hhhmmon <day>", -5.201806466167193),
                                    ("yesterday<time-of-day> am|pm", -6.118097198041348),
                                    ("<day-of-month> (ordinal)July", -5.424950017481403),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.118097198041348),
                                    ("mm/ddyear (latent)", -6.118097198041348),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.118097198041348),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.118097198041348),
                                    ("at <time-of-day>intersect", -5.201806466167193),
                                    ("hh:mmyear (latent)", -4.7318028369214575),
                                    ("Holiyear (latent)", -6.118097198041348),
                                    ("until <time><time-of-day> am|pm", -6.118097198041348),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.712632089933184),
                                    ("dayminute", -3.2558963171118798),
                                    ("yyyy-mm-ddhh:mm", -5.712632089933184),
                                    ("intersectfrom|since|after <time>", -5.712632089933184),
                                    ("intersectSeptember", -4.2462950211397565),
                                    ("minuteday", -2.961096776891235),
                                    ("absorption of , after named dayintersect",
                                     -6.118097198041348),
                                    ("intersectyear (latent)", -6.118097198041348),
                                    ("Februaryin|during the <part-of-day>", -6.118097198041348),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.118097198041348),
                                    ("time-of-day (latent)July", -5.424950017481403),
                                    ("Saturdayyear (latent)", -6.118097198041348),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.118097198041348),
                                    ("<day-of-month> (ordinal)Monday", -5.201806466167193),
                                    ("at <time-of-day>on <day>", -5.201806466167193),
                                    ("absorption of , after named daySeptember", -4.86533422954598),
                                    ("Naraka Chaturdashiyear (latent)", -6.118097198041348),
                                    ("from|since|after <time>on <day>", -5.201806466167193),
                                    ("dayweek", -6.118097198041348),
                                    ("Easter Sundayyear (latent)", -5.712632089933184),
                                    ("Thursday<time-of-day> am|pm", -4.86533422954598),
                                    ("weekyear", -5.712632089933184),
                                    ("time-of-day (latent)Thursday", -5.712632089933184),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.118097198041348),
                                    ("<day-of-month> (ordinal)April", -6.118097198041348),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.712632089933184),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.424950017481403),
                                    ("Sundayfrom|since|after <time>", -6.118097198041348),
                                    ("absorption of , after named dayFebruary", -5.201806466167193),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.712632089933184),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.118097198041348),
                                    ("tomorrowat <time-of-day>", -6.118097198041348),
                                    ("daynograin", -5.712632089933184),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.712632089933184),
                                    ("last <cycle> of <time>year (latent)", -5.712632089933184),
                                    ("tomorrow<time-of-day> am|pm", -6.118097198041348),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.424950017481403),
                                    ("Diwaliyear (latent)", -5.712632089933184),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.118097198041348),
                                    ("this <part-of-day>at <time-of-day>", -5.201806466167193),
                                    ("Fridayyear (latent)", -5.201806466167193),
                                    ("time-of-day (latent)April", -6.118097198041348),
                                    ("minuteyear", -3.9208726207051283)],
                               n = 300}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.48117692984386073,
                               ...
                               n = 89},
                   koData =
                     ClassData{prior = -0.9624801143435298, unseen = -4.890349128221754,
                               likelihoods =
                                 HashMap.fromList
                                   [("hour", -0.8754687373538999),
