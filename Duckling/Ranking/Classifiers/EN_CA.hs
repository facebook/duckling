...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6018557603505381, unseen = -5.703782474656201,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 298},
                   koData =
                     ClassData{prior = -0.7936177109235798,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46602748086609613,
                               unseen = -6.740519359606223,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.046189446797229),
                                    ("Father's Dayyear (latent)", -6.046189446797229),
                                    ("Ramadanyear (latent)", -6.046189446797229),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.7934264783018605),
                                    ("Bhai Doojyear (latent)", -6.046189446797229),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.7934264783018605),
                                    ("hourday", -4.341441354558803),
                                    ("dayhour", -3.2428290658906938),
                                    ("Martin Luther King's Dayyear (latent)", -5.640724338689064),
                                    ("Shemini Atzeretyear (latent)", -6.046189446797229),
                                    ("daymonth", -5.353042266237283),
                                    ("monthday", -5.640724338689064),
                                    ("monthyear", -4.436751534363128),
                                    ("Yom Ha'atzmautyear (latent)", -6.046189446797229),
                                    ("Vijayadashamiyear (latent)", -6.046189446797229),
                                    ("Thanksgiving Dayyear (latent)", -4.947577158129119),
                                    ("Thai Pongalyear (latent)", -5.353042266237283),
                                    ("Thiru Onamyear (latent)", -5.353042266237283),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.046189446797229),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.046189446797229),
                                    ("houryear", -5.353042266237283),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.046189446797229),
                                    ("Christmas<time-of-day> am|pm", -6.046189446797229),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.046189446797229),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.353042266237283),
                                    ("<time-of-day> am|pmintersect", -4.7934264783018605),
                                    ("Family Dayyear (latent)", -5.1298987149230735),
                                    ("Octoberyear (latent)", -4.7934264783018605),
                                    ("intersect<time-of-day> am|pm", -6.046189446797229),
                                    ("Mattu Pongalyear (latent)", -6.046189446797229),
                                    ("Shavuotyear (latent)", -6.046189446797229),
                                    ("Dhanterasin <named-month>|year", -6.046189446797229),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.046189446797229),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.046189446797229),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.640724338689064),
                                    ("Marchyear (latent)", -6.046189446797229),
                                    ("Sukkotyear (latent)", -5.640724338689064),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.046189446797229),
                                    ("Clean Mondayyear (latent)", -5.640724338689064),
                                    ("monthhour", -5.640724338689064),
                                    ("todayat <time-of-day>", -6.046189446797229),
                                    ("Thursday<time> timezone", -4.341441354558803),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.046189446797229),
                                    ("Palm SundaySunday", -5.640724338689064),
                                    ("dayday", -3.848964869461009),
                                    ("<time> <part-of-day>at <time-of-day>", -6.046189446797229),
                                    ("mm/ddat <time-of-day>", -6.046189446797229),
                                    ("tonightat <time-of-day>", -6.046189446797229),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.353042266237283),
                                    ("today<time-of-day> am|pm", -6.046189446797229),
                                    ("Februarythe <day-of-month> (ordinal)", -5.640724338689064),
                                    ("at <time-of-day><time> <part-of-day>", -6.046189446797229),
                                    ("mm/dd<time-of-day> am|pm", -6.046189446797229),
                                    ("hourhour", -4.7934264783018605),
                                    ("<time-of-day> am|pmon <date>", -4.0312864262549635),
                                    ("National Patriots' Dayyear (latent)", -5.353042266237283),
                                    ("Wednesdaythis|last|next <cycle>", -6.046189446797229),
                                    ("Lentyear (latent)", -6.046189446797229),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.542112050020955),
                                    ("Boghiyear (latent)", -6.046189446797229),
                                    ("dayyear", -1.9271522719847562),
                                    ("Thursdayfrom|since|after <time>", -5.640724338689064),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.046189446797229),
                                    ("Thursdayat <time-of-day>", -5.640724338689064),
                                    ("Islamic New Yearyear (latent)", -5.640724338689064),
                                    ("Laylat al-Qadryear (latent)", -5.1298987149230735),
                                    ("Chhathin <named-month>|year", -6.046189446797229),
                                    ("Vasant Panchamiin <named-month>|year", -6.046189446797229),
                                    ("Diwaliin <named-month>|year", -6.046189446797229),
                                    ("Discovery Dayyear (latent)", -5.640724338689064),
                                    ("Shrove Tuesdayyear (latent)", -6.046189446797229),
                                    ("<time-of-day> am|pmtomorrow", -5.353042266237283),
                                    ("Yom Kippuryear (latent)", -6.046189446797229),
                                    ("<part-of-day> of <time>year (latent)", -6.046189446797229),
                                    ("minutehour", -5.1298987149230735),
                                    ("Kaanum Pongalyear (latent)", -5.640724338689064),
                                    ("Maha Saptamiyear (latent)", -6.046189446797229),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.640724338689064),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.341441354558803),
                                    ("for <duration> from <time>December", -6.046189446797229),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.046189446797229),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.1298987149230735),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.640724338689064),
                                    ("Pentecostyear (latent)", -6.046189446797229),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.1298987149230735),
                                    ("Eid al-Fitryear (latent)", -6.046189446797229),
                                    ("Mondayin|during the <part-of-day>", -6.046189446797229),
                                    ("Raksha Bandhanyear (latent)", -6.046189446797229),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.640724338689064),
                                    ("Navaratriin <named-month>|year", -6.046189446797229),
                                    ("Ashurayear (latent)", -6.046189446797229),
                                    ("Chinese New Yearyear (latent)", -6.046189446797229),
                                    ("Sundayyear (latent)", -6.046189446797229),
                                    ("Lag BaOmeryear (latent)", -6.046189446797229),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.046189446797229),
                                    ("Eid al-Adhayear (latent)", -5.1298987149230735),
                                    ("intersectin|during the <part-of-day>", -6.046189446797229),
                                    ("Christmasat <time-of-day>", -6.046189446797229),
                                    ("Passoveryear (latent)", -6.046189446797229),
                                    ("Lazarus Saturdayyear (latent)", -6.046189446797229),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.046189446797229),
                                    ("Yom HaShoahyear (latent)", -5.640724338689064),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.640724338689064),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.046189446797229),
                                    ("Thai Pongalin <named-month>|year", -6.046189446797229),
                                    ("Septemberyear (latent)", -5.640724338689064),
                                    ("mm/ddyear (latent)", -6.046189446797229),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.7934264783018605),
                                    ("Halloweenyear (latent)", -6.046189446797229),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.353042266237283),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -5.1298987149230735),
                                    ("at <time-of-day>intersect", -5.640724338689064),
                                    ("Rosh Hashanahyear (latent)", -6.046189446797229),
                                    ("Dhanterasyear (latent)", -6.046189446797229),
                                    ("Tu BiShvatyear (latent)", -6.046189446797229),
                                    ("Holiyear (latent)", -5.353042266237283),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.046189446797229),
                                    ("Holika Dahanyear (latent)", -5.353042266237283),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.046189446797229),
                                    ("dayminute", -3.4071321171819697),
                                    ("Mawlidyear (latent)", -6.046189446797229),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.640724338689064),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.046189446797229),
                                    ("Jumu'atul-Widayear (latent)", -5.1298987149230735),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.046189446797229),
                                    ("minuteday", -2.408603287070843),
                                    ("absorption of , after named dayintersect",
                                     -6.046189446797229),
                                    ("intersectyear (latent)", -6.046189446797229),
                                    ("Orthodox Easter Sundayyear (latent)", -6.046189446797229),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.046189446797229),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.046189446797229),
                                    ("Boss's Dayyear (latent)", -5.640724338689064),
                                    ("Tisha B'Avyear (latent)", -6.046189446797229),
                                    ("Isra and Mi'rajyear (latent)", -5.1298987149230735),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.046189446797229),
                                    ("Christmasyear (latent)", -5.640724338689064),
                                    ("Naraka Chaturdashiyear (latent)", -5.640724338689064),
                                    ("at <time-of-day>on <date>", -4.947577158129119),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.436751534363128),
                                    ("dayweek", -6.046189446797229),
                                    ("Easter Sundayyear (latent)", -5.353042266237283),
                                    ("Labour Dayyear (latent)", -6.046189446797229),
                                    ("weekyear", -5.640724338689064),
                                    ("hh:mmin|during the <part-of-day>", -5.353042266237283),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.640724338689064),
                                    ("Hanukkahyear (latent)", -6.046189446797229),
                                    ("February<time> <part-of-day>", -6.046189446797229),
                                    ("Tuesdayin <named-month>|year", -6.046189446797229),
                                    ("Great Lentyear (latent)", -6.046189446797229),
                                    ("tomorrowat <time-of-day>", -5.353042266237283),
                                    ("between <time> and <time>on <date>", -4.436751534363128),
                                    ("last <cycle> of <time>year (latent)", -5.353042266237283),
                                    ("at <time-of-day>tomorrow", -5.640724338689064),
                                    ("tomorrow<time-of-day> am|pm", -6.046189446797229),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.046189446797229),
                                    ("Diwaliyear (latent)", -6.046189446797229),
                                    ("Black Fridayyear (latent)", -5.640724338689064),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.046189446797229),
                                    ("Chhathyear (latent)", -5.640724338689064),
                                    ("Vasant Panchamiyear (latent)", -6.046189446797229),
                                    ("Palm Sundayintersect", -6.046189446797229),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.046189446797229),
                                    ("Februaryintersect", -6.046189446797229),
                                    ("Mother's Dayyear (latent)", -6.046189446797229),
                                    ("Simchat Torahyear (latent)", -6.046189446797229),
                                    ("Victoria Dayyear (latent)", -5.640724338689064)],
                               n = 315},
                   koData =
                     ClassData{prior = -0.9874915028371426, unseen = -6.380122536899766,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.768988271217486),
