...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7047617129806383, unseen = -5.375278407684165,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 214},
                   koData =
                     ClassData{prior = -0.681665998185989, unseen = -5.3981627015177525,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4700036292457356, unseen = -6.450470422144176,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                     -4.502979245091544),
                                    ("Lentyear", -5.755742213586912),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.502979245091544),
                                    ("hourday", -4.050994121348487),
                                    ("dayhour", -2.8653704556907473),
                                    ("National Patriots' Dayyear", -5.062595033026967),
                                    ("daymonth", -5.062595033026967),
                                    ("monthday", -5.350277105478748),
                                    ("monthyear", -4.146304301152812),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.755742213586912),
                                    ("Easter Sundayyear", -5.062595033026967),
                                    ("Christmasyear", -5.350277105478748),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.755742213586912),
                                    ("houryear", -5.350277105478748),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.755742213586912),
                                    ("Christmas<time-of-day> am|pm", -5.755742213586912),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.062595033026967),
                                    ("<time-of-day> am|pmintersect", -4.502979245091544),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.755742213586912),
                                    ("Marchyear", -5.755742213586912),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.350277105478748),
                                    ("intersect<time-of-day> am|pm", -5.755742213586912),
                                    ("Clean Mondayyear", -5.350277105478748),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.755742213586912),
                                    ("monthhour", -5.350277105478748),
                                    ("last <day-of-week> of <time>year", -5.755742213586912),
                                    ("todayat <time-of-day>", -5.755742213586912),
                                    ("Thursday<time> timezone", -4.050994121348487),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.755742213586912),
                                    ("Palm SundaySunday", -5.350277105478748),
                                    ("dayday", -3.5585176362506927),
                                    ("Thanksgiving Dayyear", -4.657129924918802),
                                    ("<time> <part-of-day>at <time-of-day>", -5.755742213586912),
                                    ("Tuesdayin <named-month>", -5.755742213586912),
                                    ("mm/ddat <time-of-day>", -5.755742213586912),
                                    ("tonightat <time-of-day>", -5.755742213586912),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.062595033026967),
                                    ("today<time-of-day> am|pm", -5.755742213586912),
                                    ("Februarythe <day-of-month> (ordinal)", -5.350277105478748),
                                    ("at <time-of-day><time> <part-of-day>", -5.755742213586912),
                                    ("mm/dd<time-of-day> am|pm", -5.755742213586912),
                                    ("hourhour", -4.502979245091544),
                                    ("<time-of-day> am|pmon <date>", -3.740839193044647),
                                    ("Wednesdaythis|last|next <cycle>", -5.755742213586912),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.251664816810638),
                                    ("dayyear", -2.5170637614225315),
                                    ("last weekend of <named-month>year", -5.755742213586912),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.755742213586912),
                                    ("Sundayyear", -5.755742213586912),
                                    ("Chinese New Yearyear", -5.755742213586912),
                                    ("Thursdayat <time-of-day>", -5.350277105478748),
                                    ("<time-of-day> am|pmtomorrow", -5.062595033026967),
                                    ("minutehour", -4.839451481712757),
                                    ("Mother's Dayyear", -5.755742213586912),
                                    ("Victoria Dayyear", -5.350277105478748),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.350277105478748),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.050994121348487),
                                    ("for <duration> from <time>December", -5.755742213586912),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.755742213586912),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.839451481712757),
                                    ("Mondayin|during the <part-of-day>", -5.755742213586912),
                                    ("Discovery Dayyear", -5.350277105478748),
                                    ("Shrove Tuesdayyear", -5.755742213586912),
                                    ("<part-of-day> of <time>year", -5.755742213586912),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.350277105478748),
                                    ("Labour Dayyear", -5.755742213586912),
                                    ("intersectin|during the <part-of-day>", -5.755742213586912),
                                    ("Christmasat <time-of-day>", -5.755742213586912),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -4.839451481712757),
                                    ("at <time-of-day>intersect", -5.350277105478748),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.755742213586912),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.755742213586912),
                                    ("dayminute", -3.0815935641603835),
                                    ("Boss's Dayyear", -5.350277105478748),
                                    ("Orthodox Easter Sundayyear", -5.755742213586912),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.350277105478748),
                                    ("intersectyear", -5.755742213586912),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.755742213586912),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.350277105478748),
                                    ("<ordinal> <cycle> of <time>year", -5.755742213586912),
                                    ("minuteday", -2.2900063107871858),
                                    ("absorption of , after named dayintersect",
                                     -5.755742213586912),
                                    ("Family Dayyear", -4.839451481712757),
                                    ("Octoberyear", -4.502979245091544),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.755742213586912),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.755742213586912),
                                    ("year<time-of-day> am|pm", -5.755742213586912),
                                    ("Septemberyear", -5.350277105478748),
                                    ("at <time-of-day>on <date>", -4.657129924918802),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -5.062595033026967),
                                    ("Halloweenyear", -5.755742213586912),
                                    ("dayweek", -5.755742213586912),
                                    ("Lazarus Saturdayyear", -5.755742213586912),
                                    ("Thursday<time-of-day> am|pm", -5.755742213586912),
                                    ("weekyear", -5.350277105478748),
                                    ("hh:mmin|during the <part-of-day>", -5.062595033026967),
                                    ("Father's Dayyear", -5.755742213586912),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.350277105478748),
                                    ("February<time> <part-of-day>", -5.755742213586912),
                                    ("Martin Luther King's Dayyear", -5.350277105478748),
                                    ("tomorrowat <time-of-day>", -5.062595033026967),
                                    ("between <time> and <time>on <date>", -5.062595033026967),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.062595033026967),
                                    ("at <time-of-day>tomorrow", -5.350277105478748),
                                    ("tomorrow<time-of-day> am|pm", -5.755742213586912),
                                    ("Pentecostyear", -5.755742213586912),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.755742213586912),
                                    ("Palm Sundayintersect", -5.755742213586912),
                                    ("Great Lentyear", -5.755742213586912),
                                    ("Februaryintersect", -5.755742213586912),
                                    ("last <cycle> of <time>year", -5.062595033026967),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.755742213586912),
                                    ("yearminute", -5.755742213586912),
                                    ("Black Fridayyear", -5.350277105478748)],
                               n = 235},
                   koData =
                     ClassData{prior = -0.9808292530117262, unseen = -6.09807428216624,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.402677381872279),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.402677381872279),
                                    ("hourday", -5.402677381872279),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.402677381872279),
                                    ("New Year's Dayyear", -5.402677381872279),
                                    ("dayhour", -2.960330346503075),
                                    ("daymonth", -3.3232358401924436),
                                    ("monthday", -4.997212273764115),
                                    ("monthyear", -4.709530201312334),
                                    ("intersecthh:mm", -5.402677381872279),
                                    ...
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.402677381872279),
                                    ("until <time-of-day><time-of-day> am|pm", -5.402677381872279),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.709530201312334),
                                    ("<time-of-day> am|pmintersect", -4.149914413376911),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.486386649998124),
                                    ("Clean Mondayyear", -5.402677381872279),
                                    ("from|since|after <time-of-day>on <date>", -4.486386649998124),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.402677381872279),
                                    ("absorption of , after named dayJuly", -4.997212273764115),
                                    ("monthhour", -5.402677381872279),
                                    ("hourmonth", -4.709530201312334),
                                    ("todayat <time-of-day>", -5.402677381872279),
                                    ("from|since|after <time-of-day>July", -5.402677381872279),
                                    ("dayday", -4.997212273764115),
                                    ("mm/ddat <time-of-day>", -4.997212273764115),
                                    ("<time-of-day> am|pmon <date>", -4.149914413376911),
                                    ("dayyear", -3.20545280453606),
                                    ("Thursdaymm/dd", -5.402677381872279),
                                    ("Sundayyear", -4.709530201312334),
                                    ("Thursdayat <time-of-day>", -4.149914413376911),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.402677381872279),
                                    ("monthminute", -5.402677381872279),
                                    ("<time-of-day> am|pmtomorrow", -5.402677381872279),
                                    ("Thursdayhh:mm", -4.486386649998124),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.402677381872279),
                                    ("Fridayyear", -4.997212273764115),
                                    ("minutemonth", -3.6109179126442243),
                                    ("Sundayfrom|since|after <time-of-day>", -5.402677381872279),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.997212273764115),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.997212273764115),
                                    ("Aprilyear", -5.402677381872279),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -4.997212273764115),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.402677381872279),
                                    ("Christmasat <time-of-day>", -5.402677381872279),
                                    ("<duration> after|before|from <time>December",
                                     -5.402677381872279),
                                    ("yesterday<time-of-day> am|pm", -5.402677381872279),
                                    ...
                                    ("Mondayyear", -4.709530201312334),
                                    ("Saturdayyear", -5.402677381872279),
                                    ("at <time-of-day>intersect", -4.997212273764115),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.402677381872279),
                                    ("dayminute", -2.876948737564024),
                                    ("intersectSeptember", -3.898599985096005),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.402677381872279),
                                    ("minuteday", -2.4849066497880004),
                                    ("absorption of , after named dayintersect",
                                     -5.402677381872279),
                                    ("Februaryin|during the <part-of-day>", -5.402677381872279),
                                    ("week-endin <named-month>", -5.402677381872279),
                                    ("Octoberyear", -5.402677381872279),
                                    ("from|since|after <time-of-day>year", -5.402677381872279),
                                    ("yearhh:mm", -5.402677381872279),
                                    ("hh:mmon <date>", -3.898599985096005),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.402677381872279),
                                    ("absorption of , after named daySeptember",
                                     -4.486386649998124),
                                    ("on <date>September", -4.997212273764115),
                                    ("at <time-of-day>on <date>", -4.997212273764115),
                                    ("dayweek", -5.402677381872279),
                                    ("Thursday<time-of-day> am|pm", -4.997212273764115),
                                    ("absorption of , after named dayFebruary", -4.486386649998124),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.402677381872279),
                                    ("tomorrowat <time-of-day>", -5.402677381872279),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.402677381872279),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.7932394694381792),
                                    ("tomorrow<time-of-day> am|pm", -5.402677381872279),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.402677381872279),
                                    ("yearminute", -5.402677381872279)],
                               n = 141}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year",
        Classifier{okData =
                     ClassData{prior = -0.22006188477680164,
                               ...
                               n = 65},
                   koData =
                     ClassData{prior = -1.6218604324326575, unseen = -3.044522437723423,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                    ...
                                    ("Labour Daythis|last|next <cycle>", -4.465908118654584),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.465908118654584),
