  ...
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("in|within|after <duration>",
        Classifier{okData =
                     ClassData{prior = -0.1388364448542158, unseen = -4.727387818712341,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 47},
                   koData =
                     ClassData{prior = -2.043073897508961, unseen = -3.4965075614664802,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48149800867147063,
                               unseen = -7.208600337960199,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.51471269087253),
                                    ("Father's Dayyear (latent)", -6.51471269087253),
                                    ("Karva Chauthyear (latent)", -6.51471269087253),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.51471269087253),
                                    ("Maha Shivaratriyear (latent)", -6.51471269087253),
                                    ("Ramadanyear (latent)", -5.261949722377162),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.128418329752639),
                                    ("Bhai Doojyear (latent)", -6.51471269087253),
                                    ("hourday", -4.499809670330265),
                                    ("dayhour", -3.494287804728167),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.128418329752639),
                                    ("Martin Luther King's Dayyear (latent)", -6.1092475827643655),
                                    ("Shemini Atzeretyear (latent)", -6.51471269087253),
                                    ("daymonth", -4.499809670330265),
                                    ("monthday", -6.1092475827643655),
                                    ("monthyear", -4.722953221644475),
                                    ("Yom Ha'atzmautyear (latent)", -6.51471269087253),
                                    ("Orthodox Good Fridayyear (latent)", -6.1092475827643655),
                                    ("Vijayadashamiyear (latent)", -6.51471269087253),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -6.1092475827643655),
                                    ("Thanksgiving Dayyear (latent)", -5.41610040220442),
                                    ("Thai Pongalyear (latent)", -5.821565510312585),
                                    ("Thiru Onamyear (latent)", -5.821565510312585),
                                    ("hhhmmabsorption of , after named day", -6.51471269087253),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.51471269087253),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.598421958998375),
                                    ("<day-of-month> (ordinal)Wednesday", -6.51471269087253),
                                    ("Krishna Janmashtamiyear (latent)", -6.1092475827643655),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.51471269087253),
                                    ("houryear", -5.598421958998375),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.51471269087253),
                                    ("Christmas<time-of-day> am|pm", -6.51471269087253),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.51471269087253),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.821565510312585),
                                    ("intersectin|during <named-month>|year", -6.51471269087253),
                                    ("<time-of-day> am|pmintersect", -5.261949722377162),
                                    ("Earth Houryear (latent)", -6.51471269087253),
                                    ("Ganesh Chaturthiyear (latent)", -6.51471269087253),
                                    ("Family Dayyear (latent)", -5.598421958998375),
                                    ("Octoberyear (latent)", -5.0106352940962555),
                                    ("intersect<time-of-day> am|pm", -6.51471269087253),
                                    ("Mattu Pongalyear (latent)", -6.51471269087253),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.51471269087253),
                                    ("Shavuotyear (latent)", -6.51471269087253),
                                    ("Parsi New Yearyear (latent)", -5.598421958998375),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.51471269087253),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.51471269087253),
                                    ("todayin|within|after <duration>", -6.51471269087253),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.1092475827643655),
                                    ("Marchyear (latent)", -6.51471269087253),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.1092475827643655),
                                    ("Sukkotyear (latent)", -6.1092475827643655),
                                    ("hhhmmintersect", -6.1092475827643655),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.821565510312585),
                                    ("todayat <time-of-day>", -6.51471269087253),
                                    ("Thursday<time> timezone", -4.1168174180741595),
                                    ("tonight<time-of-day> am|pm", -6.51471269087253),
                                    ("time-of-day (latent)tonight", -6.1092475827643655),
                                    ("from|since|after <time>December", -6.51471269087253),
                                    ("<time-of-day> am|pmon <day>", -4.499809670330265),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -6.51471269087253),
                                    ("yyyy-mm-ddhh:mm:ss", -6.1092475827643655),
                                    ("dayday", -3.8066624897703196),
                                    ("<time> <part-of-day>at <time-of-day>", -6.1092475827643655),
                                    ("mm/ddat <time-of-day>", -6.51471269087253),
                                    ("tonightat <time-of-day>", -5.41610040220442),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.821565510312585),
                                    ("Dayananda Saraswati Jayantiyear (latent)", -6.51471269087253),
                                    ("today<time-of-day> am|pm", -6.51471269087253),
                                    ("Februarythe <day-of-month> (ordinal)", -6.1092475827643655),
                                    ("at <time-of-day><time> <part-of-day>", -6.51471269087253),
                                    ("<day-of-month> (ordinal)intersect", -6.1092475827643655),
                                    ("mm/dd<time-of-day> am|pm", -6.51471269087253),
                                    ("hourhour", -3.544298225302829),
                                    ("Mahavir Jayantiyear (latent)", -6.1092475827643655),
                                    ("Navaratriin|during <named-month>|year", -6.51471269087253),
                                    ("National Patriots' Dayyear (latent)", -5.821565510312585),
                                    ("Wednesdaythis|last|next <cycle>", -6.51471269087253),
                                    ("Lentyear (latent)", -6.51471269087253),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.642910513970938),
                                    ("Boghiyear (latent)", -6.51471269087253),
                                    ("dayyear", -1.8655256194676642),
                                    ("Karva Chauthin|during <named-month>|year", -6.51471269087253),
                                    ("Thursdayfrom|since|after <time>", -6.1092475827643655),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.51471269087253),
                                    ("Thursdayat <time-of-day>", -5.821565510312585),
                                    ("Islamic New Yearyear (latent)", -6.1092475827643655),
                                    ("Laylat al-Qadryear (latent)", -5.598421958998375),
                                    ("part of days<time-of-day> am|pm", -6.51471269087253),
                                    ("Discovery Dayyear (latent)", -6.1092475827643655),
                                    ("Shrove Tuesdayyear (latent)", -6.51471269087253),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.821565510312585),
                                    ("hourminute", -6.1092475827643655),
                                    ("<time-of-day> am|pmtomorrow", -5.598421958998375),
                                    ("Yom Kippuryear (latent)", -6.51471269087253),
                                    ("<day-of-month> (ordinal)Tuesday", -6.1092475827643655),
                                    ("<part-of-day> of <time>year (latent)", -6.51471269087253),
                                    ("minutehour", -5.261949722377162),
                                    ("Kaanum Pongalyear (latent)", -6.1092475827643655),
                                    ("Maha Saptamiyear (latent)", -6.51471269087253),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.821565510312585),
                                    ("time-of-day (latent)tomorrow", -5.598421958998375),
                                    ("part of daysat <time-of-day>", -4.90527477843843),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.499809670330265),
                                    ("for <duration> from <time>December", -6.51471269087253),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.51471269087253),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.261949722377162),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.261949722377162),
                                    ("time-of-day (latent)this <part-of-day>", -6.51471269087253),
                                    ("Pentecostyear (latent)", -6.51471269087253),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.261949722377162),
                                    ("<day-of-month> (ordinal)February", -6.51471269087253),
                                    ("Eid al-Fitryear (latent)", -5.128418329752639),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.51471269087253),
                                    ("Mondayin|during the <part-of-day>", -6.51471269087253),
                                    ("Chhathin|during <named-month>|year", -6.51471269087253),
                                    ("Diwaliin|during <named-month>|year", -6.51471269087253),
                                    ("this <part-of-day><time-of-day> am|pm", -6.51471269087253),
                                    ("Vaisakhiin|during <named-month>|year", -6.51471269087253),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.261949722377162),
                                    ("Raksha Bandhanyear (latent)", -6.51471269087253),
                                    ("daysecond", -6.1092475827643655),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.1092475827643655),
                                    ("Ratha-Yatrayear (latent)", -6.51471269087253),
                                    ("Ashurayear (latent)", -6.51471269087253),
                                    ("Tuesdayin|during <named-month>|year", -6.51471269087253),
                                    ("Chinese New Yearyear (latent)", -6.51471269087253),
                                    ("tomorrowintersect", -6.51471269087253),
                                    ("Lag BaOmeryear (latent)", -6.51471269087253),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.51471269087253),
                                    ("Eid al-Adhayear (latent)", -4.374646527376259),
                                    ("intersectin|during the <part-of-day>", -6.51471269087253),
                                    ("Palm Sundayyear (latent)", -6.51471269087253),
                                    ("Christmasat <time-of-day>", -6.51471269087253),
                                    ("Passoveryear (latent)", -6.51471269087253),
                                    ("Lazarus Saturdayyear (latent)", -6.51471269087253),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.51471269087253),
                                    ("hhhmmon <day>", -5.598421958998375),
                                    ("Yom HaShoahyear (latent)", -6.1092475827643655),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.1092475827643655),
                                    ("Septemberyear (latent)", -6.1092475827643655),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.0106352940962555),
                                    ("Halloweenyear (latent)", -6.51471269087253),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.51471269087253),
                                    ("at <time-of-day>intersect", -5.598421958998375),
                                    ("Rosh Hashanahyear (latent)", -5.821565510312585),
                                    ("Dhanterasyear (latent)", -6.51471269087253),
                                    ("Tu BiShvatyear (latent)", -6.51471269087253),
                                    ("<day-of-month> (ordinal)December", -5.821565510312585),
                                    ("Holiyear (latent)", -5.821565510312585),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.51471269087253),
                                    ("Holika Dahanyear (latent)", -5.821565510312585),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.1092475827643655),
                                    ("dayminute", -3.164808603597925),
                                    ("Mawlidyear (latent)", -6.51471269087253),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.1092475827643655),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.51471269087253),
                                    ("Jumu'atul-Widayear (latent)", -5.598421958998375),
                                    ("minuteday", -2.765208614942159),
                                    ("absorption of , after named dayintersect",
                                     -5.821565510312585),
                                    ("intersectyear (latent)", -6.51471269087253),
                                    ("Orthodox Easter Sundayyear (latent)", -6.51471269087253),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.51471269087253),
                                    ("<ordinal> <cycle> of <time>year (latent)", -6.51471269087253),
                                    ("intersecthhhmm", -6.1092475827643655),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.51471269087253),
                                    ("Boss's Dayyear (latent)", -6.1092475827643655),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.51471269087253),
                                    ("Global Youth Service Dayyear (latent)", -6.51471269087253),
                                    ("Dhanterasin|during <named-month>|year", -6.51471269087253),
                                    ("tonight<time-of-day> o'clock", -6.51471269087253),
                                    ("Tisha B'Avyear (latent)", -6.51471269087253),
                                    ("Isra and Mi'rajyear (latent)", -5.598421958998375),
                                    ("at <time-of-day>on <day>", -4.90527477843843),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.1092475827643655),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.821565510312585),
                                    ("Christmasyear (latent)", -6.1092475827643655),
                                    ("Saturdayintersect", -6.51471269087253),
                                    ("Naraka Chaturdashiyear (latent)", -6.1092475827643655),
                                    ("Thai Pongalin|during <named-month>|year", -6.51471269087253),
                                    ("dayweek", -6.51471269087253),
                                    ("Easter Sundayyear (latent)", -5.821565510312585),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.1092475827643655),
                                    ("Labour Dayyear (latent)", -6.51471269087253),
                                    ("weekyear", -5.41610040220442),
                                    ("King's Dayyear (latent)", -5.0106352940962555),
                                    ("hh:mmin|during the <part-of-day>", -5.598421958998375),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.1092475827643655),
                                    ("Hanukkahyear (latent)", -5.821565510312585),
                                    ("Rama Navamiyear (latent)", -6.51471269087253),
                                    ("February<time> <part-of-day>", -6.51471269087253),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.821565510312585),
                                    ("Great Lentyear (latent)", -6.51471269087253),
                                    ("tomorrowat <time-of-day>", -5.821565510312585),
                                    ("hhmm (latent)in|during the <part-of-day>", -6.51471269087253),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.1092475827643655),
                                    ("Ugadiyear (latent)", -5.128418329752639),
                                    ("Vaisakhiyear (latent)", -5.821565510312585),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.821565510312585),
                                    ("last <cycle> of <time>year (latent)", -5.821565510312585),
                                    ("at <time-of-day>tomorrow", -6.1092475827643655),
                                    ("tomorrow<time-of-day> am|pm", -6.51471269087253),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.51471269087253),
                                    ("Diwaliyear (latent)", -6.51471269087253),
                                    ("between <time> and <time>on <day>", -6.1092475827643655),
                                    ("Black Fridayyear (latent)", -6.1092475827643655),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.51471269087253),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.51471269087253),
                                    ("Chhathyear (latent)", -6.1092475827643655),
                                    ("Vasant Panchamiyear (latent)", -6.51471269087253),
                                    ("Rabindra Jayantiyear (latent)", -5.261949722377162),
                                    ("this <part-of-day>at <time-of-day>", -5.261949722377162),
                                    ("St Patrick's Dayyear (latent)", -6.51471269087253),
                                    ("Thursday<time> (timezone)", -6.51471269087253),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.51471269087253),
                                    ("Pargat Diwasyear (latent)", -5.261949722377162),
                                    ("<datetime> - <datetime> (interval)July", -6.1092475827643655),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.821565510312585),
                                    ("Februaryintersect", -6.51471269087253),
                                    ("Mother's Dayyear (latent)", -6.51471269087253),
                                    ("Simchat Torahyear (latent)", -6.51471269087253),
                                    ("Victoria Dayyear (latent)", -6.1092475827643655),
                                    ("minuteyear", -6.51471269087253)],
                               n = 519},
                   koData =
                     ClassData{prior = -0.9619607687073435, unseen = -6.86171134048073,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.663439094112067),
                                    ("hourday", -3.5648268054439574),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.1675164908883415),
                                    ("<day-of-month> (ordinal)August", -6.1675164908883415),
                                    ("dayhour", -3.4933678414618123),
                                    ("<time> timezoneyear (latent)", -5.474369310328396),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.251225759014186),
                                    ("Tuesdayfrom|since|after <time>", -5.474369310328396),
                                    ("daymonth", -3.459466289786131),
                                    ("hourquarter", -5.251225759014186),
                                    ("monthyear", -4.9147535223929735),
                                    ("<time-of-day> am|pmyear (latent)", -5.474369310328396),
                                    ("Thai Pongalyear (latent)", -5.474369310328396),
                                    ("intersecthh:mm", -6.1675164908883415),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.762051382780177),
                                    ("<day-of-month> (ordinal)Wednesday", -6.1675164908883415),
                                    ("houryear", -4.375757021660286),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.1675164908883415),
                                    ("<day-of-month> (ordinal)October", -6.1675164908883415),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.474369310328396),
                                    ("hournograin", -4.9147535223929735),
                                    ("<time-of-day> am|pmintersect", -4.9147535223929735),
                                    ("Octoberyear (latent)", -6.1675164908883415),
                                    ("Good Fridayyear (latent)", -5.762051382780177),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.762051382780177),
                                    ("early morningat <time-of-day>", -6.1675164908883415),
                                    ("until <time>on <day>", -5.474369310328396),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.1675164908883415),
                                    ("time-of-day (latent)intersect", -5.474369310328396),
                                    ("todayin <number> (implicit minutes)", -6.1675164908883415),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.474369310328396),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.1675164908883415),
                                    ("hh:mmon <day>", -4.9147535223929735),
                                    ("hhhmmintersect", -5.762051382780177),
                                    ("absorption of , after named dayJuly", -5.251225759014186),
                                    ("from|since|after <time>July", -5.762051382780177),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.251225759014186),
                                    ("Clean Mondayyear (latent)", -6.1675164908883415),
                                    ("monthhour", -6.1675164908883415),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.762051382780177),
                                    ("hourmonth", -4.027450327392071),
                                    ("todayat <time-of-day>", -6.1675164908883415),
                                    ("hhhmmyear (latent)", -4.9147535223929735),
                                    ("from|since|after <time>December", -6.1675164908883415),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.1675164908883415),
                                    ("<time-of-day> am|pmon <day>", -4.9147535223929735),
                                    ("Mondayyear (latent)", -5.474369310328396),
                                    ("dayday", -4.152613470346076),
                                    ("mm/ddat <time-of-day>", -5.762051382780177),
                                    ("on <day>September", -5.474369310328396),
                                    ("time-of-day (latent)September", -5.762051382780177),
                                    ("hourhour", -4.088074949208505),
                                    ("time-of-day (latent)on <day>", -4.663439094112067),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.762051382780177),
                                    ("dayyear", -3.122994053164918),
                                    ("Thursdaymm/dd", -6.1675164908883415),
                                    ("New Year's Dayyear (latent)", -5.251225759014186),
                                    ("time-of-day (latent)Sunday", -5.762051382780177),
                                    ("Thursdayfrom|since|after <time>", -4.462768398649916),
                                    ("Thursdayat <time-of-day>", -4.558078578454241),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.1675164908883415),
                                    ("Aprilyear (latent)", -6.1675164908883415),
                                    ("the <day-of-month> (ordinal)July", -6.1675164908883415),
                                    ("the <day-of-month> (number)July", -6.1675164908883415),
                                    ("monthminute", -6.1675164908883415),
                                    ("<time-of-day> am|pmtomorrow", -5.762051382780177),
                                    ("Thursdayhh:mm", -5.251225759014186),
                                    ("<day-of-month> (ordinal)Tuesday", -5.762051382780177),
                                    ("minutemonth", -4.027450327392071),
                                    ("time-of-day (latent)Friday", -5.762051382780177),
                                    ("minutehour", -6.1675164908883415),
                                    ("part of daysat <time-of-day>", -5.0689042022202315),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.8161412337248635),
                                    ("Augustyear (latent)", -5.762051382780177),
                                    ("week-endin|during <named-month>|year", -6.1675164908883415),
                                    ("time-of-day (latent)Tuesday", -5.762051382780177),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.1675164908883415),
                                    ("Sundayyear (latent)", -5.251225759014186),
                                    ("hourweek", -5.251225759014186),
                                    ("the <day-of-month> (ordinal)Monday", -5.474369310328396),
                                    ("Christmasat <time-of-day>", -6.1675164908883415),
                                    ("from|since|after <time>year (latent)", -5.0689042022202315),
                                    ("hhhmmon <day>", -5.251225759014186),
                                    ("yesterday<time-of-day> am|pm", -6.1675164908883415),
                                    ("<day-of-month> (ordinal)July", -5.474369310328396),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.1675164908883415),
                                    ("mm/ddyear (latent)", -6.1675164908883415),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.1675164908883415),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.1675164908883415),
                                    ("at <time-of-day>intersect", -5.251225759014186),
                                    ("hh:mmyear (latent)", -4.781222129768451),
                                    ("Holiyear (latent)", -6.1675164908883415),
                                    ("until <time><time-of-day> am|pm", -6.1675164908883415),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.762051382780177),
                                    ("dayminute", -3.305315609958873),
                                    ("yyyy-mm-ddhh:mm", -5.762051382780177),
                                    ("intersectfrom|since|after <time>", -5.762051382780177),
                                    ("intersectSeptember", -4.29571431398675),
                                    ("minuteday", -3.010516069738228),
                                    ("absorption of , after named dayintersect",
                                     -6.1675164908883415),
                                    ("intersectyear (latent)", -6.1675164908883415),
                                    ("Februaryin|during the <part-of-day>", -6.1675164908883415),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.1675164908883415),
                                    ("time-of-day (latent)July", -5.474369310328396),
                                    ("Saturdayyear (latent)", -6.1675164908883415),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.1675164908883415),
                                    ("<day-of-month> (ordinal)Monday", -5.251225759014186),
                                    ("at <time-of-day>on <day>", -5.251225759014186),
                                    ("absorption of , after named daySeptember",
                                     -4.9147535223929735),
                                    ("Naraka Chaturdashiyear (latent)", -6.1675164908883415),
                                    ("from|since|after <time>on <day>", -5.251225759014186),
                                    ("dayweek", -6.1675164908883415),
                                    ("Easter Sundayyear (latent)", -5.762051382780177),
                                    ("Thursday<time-of-day> am|pm", -4.9147535223929735),
                                    ("weekyear", -5.762051382780177),
                                    ("time-of-day (latent)Thursday", -5.762051382780177),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.1675164908883415),
                                    ("<day-of-month> (ordinal)April", -6.1675164908883415),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.762051382780177),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.474369310328396),
                                    ("Sundayfrom|since|after <time>", -6.1675164908883415),
                                    ("absorption of , after named dayFebruary", -5.251225759014186),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.762051382780177),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.1675164908883415),
                                    ("tomorrowat <time-of-day>", -6.1675164908883415),
                                    ("daynograin", -5.762051382780177),
                                    ("Fridayin|during <named-month>|year", -6.1675164908883415),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.762051382780177),
                                    ("last <cycle> of <time>year (latent)", -5.762051382780177),
                                    ("tomorrow<time-of-day> am|pm", -6.1675164908883415),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.474369310328396),
                                    ("Diwaliyear (latent)", -5.762051382780177),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.1675164908883415),
                                    ("this <part-of-day>at <time-of-day>", -5.251225759014186),
                                    ("Fridayyear (latent)", -5.251225759014186),
                                    ("time-of-day (latent)April", -6.1675164908883415),
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.42444100956717, unseen = -5.231108616854587,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 87},
                   koData =
                     ClassData{prior = -1.0617077317326589, unseen = -4.653960350157523,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.5577092096648412, unseen = -5.402677381872279,
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                     -4.705015520957807),
                                    ("dayhour", -4.299550412849643),
                                    ("daymonth", -2.102325835513424),
                                    ("<named-month> <day-of-month> (non ordinal)Friday",
                                     -4.705015520957807),
                                    ("Friday<named-month> <day-of-month> (non ordinal)",
                                     -3.4522525524624394),
                                    ("Wednesdayintersect", -4.705015520957807),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -3.3187211598379167),
                                    ("Black Fridaythis|last|next <cycle>", -4.705015520957807),
                                    ("Labour Daythis|last|next <cycle>", -4.705015520957807),
                                    ("<part-of-day> of <time>February", -4.705015520957807),
                                    ("Saturday<time-of-day> am|pm", -4.705015520957807),
                                    ("Martin Luther King's Daythis|last|next <cycle>",
                                     -4.299550412849643),
                                    ("hourmonth", -4.705015520957807),
                                    ("Fridayintersect by \",\", \"of\", \"from\" for year",
                                     -4.011868340397862),
                                    ("dayday", -2.453723722351312),
                                    ("the <day-of-month> (ordinal)February", -4.299550412849643),
                                    ("WednesdayOctober", -4.705015520957807),
                                    ("Wednesdaythis|last|next <cycle>", -4.299550412849643),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.4522525524624394),
                                    ("dayyear", -3.606403232289698),
                                    ("Saturday<named-month> <day-of-month> (non ordinal)",
                                     -4.705015520957807),
                                    ("Thursdayhh:mm", -4.299550412849643),
                                    ("Thanksgiving Daythis|last|next <cycle>", -4.705015520957807),
                                    ("TuesdayOctober", -4.705015520957807),
                                    ("the <day-of-month> (ordinal)March", -3.606403232289698),
                                    ("Mondaythis|last|next <cycle>", -4.011868340397862),
                                    ("Fridayintersect", -4.011868340397862),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.299550412849643),
                                    ("intersectOctober", -4.299550412849643),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.7887247890836524),
                                    ("Tuesdaythis|last|next <cycle>", -4.705015520957807),
                                    ("Sunday<named-month> <day-of-month> (non ordinal)",
                                     -4.705015520957807),
                                    ("dayminute", -2.9132560517297525),
                                    ("minuteday", -3.4522525524624394),
                                    ("this|last|next <cycle>Sunday", -4.705015520957807),
                                    ("Sundaythis|last|next <cycle>", -4.705015520957807),
                                    ("on <day><time-of-day> am|pm", -4.705015520957807),
                                    ("intersectintersect", -4.705015520957807),
                                    ("weekday", -4.705015520957807),
                                    ("dayweek", -3.606403232289698),
                                    ("Monday<named-month> <day-of-month> (non ordinal)",
                                     -4.299550412849643),
                                    ("<datetime> - <datetime> (interval)July", -3.7887247890836524),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -4.011868340397862)],
                               n = 75},
                   koData =
                     ClassData{prior = -0.8498456324660023, unseen = -5.214935757608986,
                               likelihoods =
                                 HashMap.fromList
                                   [("week-endJuly", -4.516338972281476),
                                    ("week-endOctober", -3.82319179172153),
                                    ("daymonth", -1.8082887711792657),
                                    ("TuesdaySeptember", -4.516338972281476),
                                    ("Wednesdayintersect", -4.516338972281476),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -3.417726683613366),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -4.516338972281476),
                                    ("hournograin", -4.110873864173311),
                                    ("from|since|after <time>July", -4.110873864173311),
                                    ("hourmonth", -2.5704288232261625),
                                    ("Fridaythis|last|next <cycle>", -4.516338972281476),
                                    ("SundayFebruary", -4.516338972281476),
                                    ("on <day>September", -3.82319179172153),
                                    ("WednesdayOctober", -4.516338972281476),
                                    ("intersectnow", -4.110873864173311),
                                    ("week-endintersect", -4.516338972281476),
                                    ("dayyear", -4.516338972281476),
                                    ("FridayJuly", -3.6000482404073204),
                                    ("FridaySeptember", -4.110873864173311),
                                    ("the <day-of-month> (ordinal)July", -3.6000482404073204),
                                    ("WednesdayFebruary", -4.516338972281476),
                                    ("minutemonth", -3.012261575505202),
                                    ("SundayMarch", -4.516338972281476),
                                    ("MondayFebruary", -4.110873864173311),
                                    ("Fridayintersect", -4.516338972281476),
                                    ("intersectOctober", -4.516338972281476),
                                    ("dayminute", -4.516338972281476),
                                    ("SaturdaySeptember", -4.516338972281476),
                                    ("intersectSeptember", -3.130044611161585),
                                    ("Tuesdaynow", -4.110873864173311),
                                    ("MondayMarch", -4.516338972281476),
                                    ("FridayOctober", -4.516338972281476),
                                    ("daynograin", -4.110873864173311),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -4.516338972281476),
                                    ("Tuesdayintersect", -4.516338972281476),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -4.516338972281476),
                                    ("<datetime> - <datetime> (interval)July", -4.516338972281476),
                                    ("Sundayintersect", -4.516338972281476)],
                               n = 56}}),
       ("last <time>",
        Classifier{okData =
