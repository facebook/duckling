...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.607604386651842, unseen = -6.075346031088684,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 433},
                   koData =
                     ClassData{prior = -0.7866979028285608,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4670230011075977,
                               unseen = -7.0967213784947605,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.402746040537586),
                                    ("Father's Dayyear (latent)", -6.402746040537586),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.402746040537586),
                                    ("Ramadanyear (latent)", -5.486455308663431),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.016451679417695),
                                    ("Bhai Doojyear (latent)", -6.402746040537586),
                                    ("hourday", -4.387843019995321),
                                    ("dayhour", -3.4583070613711455),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.016451679417695),
                                    ("Martin Luther King's Dayyear (latent)", -5.997280932429422),
                                    ("Shemini Atzeretyear (latent)", -6.402746040537586),
                                    ("daymonth", -4.387843019995321),
                                    ("monthday", -5.997280932429422),
                                    ("monthyear", -4.610986571309531),
                                    ("Yom Ha'atzmautyear (latent)", -6.402746040537586),
                                    ("Vijayadashamiyear (latent)", -6.402746040537586),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.997280932429422),
                                    ("Thanksgiving Dayyear (latent)", -5.304133751869476),
                                    ("Thai Pongalyear (latent)", -5.709598859977641),
                                    ("Thiru Onamyear (latent)", -5.709598859977641),
                                    ("hhhmmabsorption of , after named day", -6.402746040537586),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.402746040537586),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.486455308663431),
                                    ("<day-of-month> (ordinal)Wednesday", -6.402746040537586),
                                    ("Krishna Janmashtamiyear (latent)", -5.997280932429422),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.402746040537586),
                                    ("houryear", -5.486455308663431),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.402746040537586),
                                    ("Christmas<time-of-day> am|pm", -6.402746040537586),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.402746040537586),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.709598859977641),
                                    ("intersectin|during <named-month>|year", -6.402746040537586),
                                    ("<time-of-day> am|pmintersect", -5.149983072042218),
                                    ("Earth Houryear (latent)", -6.402746040537586),
                                    ("Family Dayyear (latent)", -5.486455308663431),
                                    ("Octoberyear (latent)", -4.8986686437613125),
                                    ("intersect<time-of-day> am|pm", -6.402746040537586),
                                    ("Mattu Pongalyear (latent)", -6.402746040537586),
                                    ("Shavuotyear (latent)", -6.402746040537586),
                                    ("Parsi New Yearyear (latent)", -5.486455308663431),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.402746040537586),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.402746040537586),
                                    ("todayin|within|after <duration>", -6.402746040537586),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.997280932429422),
                                    ("Marchyear (latent)", -6.402746040537586),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -5.997280932429422),
                                    ("Sukkotyear (latent)", -5.997280932429422),
                                    ("hhhmmintersect", -5.997280932429422),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.997280932429422),
                                    ("Clean Mondayyear (latent)", -5.997280932429422),
                                    ("monthhour", -5.997280932429422),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.709598859977641),
                                    ("todayat <time-of-day>", -6.402746040537586),
                                    ("Thursday<time> timezone", -4.0048507677392156),
                                    ("time-of-day (latent)tonight", -5.997280932429422),
                                    ("from|since|after <time>December", -6.402746040537586),
                                    ("<time-of-day> am|pmon <day>", -4.387843019995321),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.402746040537586),
                                    ("yyyy-mm-ddhh:mm:ss", -5.997280932429422),
                                    ("dayday", -3.694695839435376),
                                    ("<time> <part-of-day>at <time-of-day>", -6.402746040537586),
                                    ("mm/ddat <time-of-day>", -6.402746040537586),
                                    ("tonightat <time-of-day>", -6.402746040537586),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.709598859977641),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.402746040537586),
                                    ("today<time-of-day> am|pm", -6.402746040537586),
                                    ("Februarythe <day-of-month> (ordinal)", -5.997280932429422),
                                    ("at <time-of-day><time> <part-of-day>", -6.402746040537586),
                                    ("<day-of-month> (ordinal)intersect", -5.997280932429422),
                                    ("mm/dd<time-of-day> am|pm", -6.402746040537586),
                                    ("hourhour", -4.32330449885775),
                                    ("Navaratriin|during <named-month>|year", -6.402746040537586),
                                    ("National Patriots' Dayyear (latent)", -5.709598859977641),
                                    ("Wednesdaythis|last|next <cycle>", -6.402746040537586),
                                    ("Lentyear (latent)", -6.402746040537586),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.530943863635994),
                                    ("Boghiyear (latent)", -6.402746040537586),
                                    ("dayyear", -1.8973961898317058),
                                    ("Thursdayfrom|since|after <time>", -5.997280932429422),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.402746040537586),
                                    ("Thursdayat <time-of-day>", -5.709598859977641),
                                    ("Islamic New Yearyear (latent)", -5.997280932429422),
                                    ("Laylat al-Qadryear (latent)", -5.486455308663431),
                                    ("Discovery Dayyear (latent)", -5.997280932429422),
                                    ("Shrove Tuesdayyear (latent)", -6.402746040537586),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.709598859977641),
                                    ("<time-of-day> am|pmtomorrow", -5.709598859977641),
                                    ("Yom Kippuryear (latent)", -6.402746040537586),
                                    ("<day-of-month> (ordinal)Tuesday", -5.997280932429422),
                                    ("<part-of-day> of <time>year (latent)", -6.402746040537586),
                                    ("minutehour", -5.149983072042218),
                                    ("Kaanum Pongalyear (latent)", -5.997280932429422),
                                    ("Maha Saptamiyear (latent)", -6.402746040537586),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.997280932429422),
                                    ("time-of-day (latent)tomorrow", -5.486455308663431),
                                    ("part of daysat <time-of-day>", -5.997280932429422),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.387843019995321),
                                    ("for <duration> from <time>December", -6.402746040537586),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.402746040537586),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.149983072042218),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.149983072042218),
                                    ("time-of-day (latent)this <part-of-day>", -6.402746040537586),
                                    ("Pentecostyear (latent)", -6.402746040537586),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.149983072042218),
                                    ("<day-of-month> (ordinal)February", -6.402746040537586),
                                    ("Eid al-Fitryear (latent)", -5.486455308663431),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.402746040537586),
                                    ("Mondayin|during the <part-of-day>", -6.402746040537586),
                                    ("Chhathin|during <named-month>|year", -6.402746040537586),
                                    ("Diwaliin|during <named-month>|year", -6.402746040537586),
                                    ("Vaisakhiin|during <named-month>|year", -6.402746040537586),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.149983072042218),
                                    ("Raksha Bandhanyear (latent)", -6.402746040537586),
                                    ("daysecond", -5.997280932429422),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.997280932429422),
                                    ("Ashurayear (latent)", -6.402746040537586),
                                    ("Tuesdayin|during <named-month>|year", -6.402746040537586),
                                    ("Chinese New Yearyear (latent)", -6.402746040537586),
                                    ("tomorrowintersect", -6.402746040537586),
                                    ("Lag BaOmeryear (latent)", -6.402746040537586),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.402746040537586),
                                    ("Eid al-Adhayear (latent)", -4.2626798770413155),
                                    ("intersectin|during the <part-of-day>", -6.402746040537586),
                                    ("Palm Sundayyear (latent)", -6.402746040537586),
                                    ("Christmasat <time-of-day>", -6.402746040537586),
                                    ("Passoveryear (latent)", -6.402746040537586),
                                    ("Lazarus Saturdayyear (latent)", -6.402746040537586),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.402746040537586),
                                    ("hhhmmon <day>", -5.486455308663431),
                                    ("Yom HaShoahyear (latent)", -5.997280932429422),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.997280932429422),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.402746040537586),
                                    ("Septemberyear (latent)", -5.997280932429422),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.8986686437613125),
                                    ("Halloweenyear (latent)", -6.402746040537586),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.402746040537586),
                                    ("at <time-of-day>intersect", -5.486455308663431),
                                    ("Rosh Hashanahyear (latent)", -5.709598859977641),
                                    ("Dhanterasyear (latent)", -6.402746040537586),
                                    ("Tu BiShvatyear (latent)", -6.402746040537586),
                                    ("<day-of-month> (ordinal)December", -5.709598859977641),
                                    ("Holiyear (latent)", -5.709598859977641),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.402746040537586),
                                    ("Holika Dahanyear (latent)", -5.709598859977641),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.997280932429422),
                                    ("dayminute", -3.0528419532629814),
                                    ("Mawlidyear (latent)", -6.402746040537586),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.997280932429422),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.402746040537586),
                                    ("Jumu'atul-Widayear (latent)", -5.486455308663431),
                                    ("minuteday", -2.665076422254218),
                                    ("absorption of , after named dayintersect",
                                     -5.709598859977641),
                                    ("intersectyear (latent)", -6.402746040537586),
                                    ("Orthodox Easter Sundayyear (latent)", -6.402746040537586),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.402746040537586),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.402746040537586),
                                    ("intersecthhhmm", -5.997280932429422),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.402746040537586),
                                    ("Boss's Dayyear (latent)", -5.997280932429422),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.402746040537586),
                                    ("Global Youth Service Dayyear (latent)", -6.402746040537586),
                                    ("Dhanterasin|during <named-month>|year", -6.402746040537586),
                                    ("Tisha B'Avyear (latent)", -6.402746040537586),
                                    ("Isra and Mi'rajyear (latent)", -5.486455308663431),
                                    ("at <time-of-day>on <day>", -4.793308128103486),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.997280932429422),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.709598859977641),
                                    ("Christmasyear (latent)", -5.997280932429422),
                                    ("Naraka Chaturdashiyear (latent)", -5.997280932429422),
                                    ("Thai Pongalin|during <named-month>|year", -6.402746040537586),
                                    ("dayweek", -6.402746040537586),
                                    ("Easter Sundayyear (latent)", -5.709598859977641),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -5.997280932429422),
                                    ("Labour Dayyear (latent)", -6.402746040537586),
                                    ("weekyear", -5.304133751869476),
                                    ("King's Dayyear (latent)", -4.8986686437613125),
                                    ("hh:mmin|during the <part-of-day>", -5.486455308663431),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.997280932429422),
                                    ("Hanukkahyear (latent)", -5.709598859977641),
                                    ("February<time> <part-of-day>", -6.402746040537586),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.402746040537586),
                                    ("Great Lentyear (latent)", -6.402746040537586),
                                    ("tomorrowat <time-of-day>", -5.709598859977641),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.402746040537586),
                                    ("Vaisakhiyear (latent)", -5.709598859977641),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.709598859977641),
                                    ("last <cycle> of <time>year (latent)", -5.709598859977641),
                                    ("at <time-of-day>tomorrow", -5.997280932429422),
                                    ("tomorrow<time-of-day> am|pm", -6.402746040537586),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.402746040537586),
                                    ("Diwaliyear (latent)", -6.402746040537586),
                                    ("between <time> and <time>on <day>", -5.997280932429422),
                                    ("Black Fridayyear (latent)", -5.997280932429422),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.402746040537586),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.402746040537586),
                                    ("Chhathyear (latent)", -5.997280932429422),
                                    ("Vasant Panchamiyear (latent)", -6.402746040537586),
                                    ("Rabindra Jayantiyear (latent)", -5.149983072042218),
                                    ("St Patrick's Dayyear (latent)", -6.402746040537586),
                                    ("Thursday<time> (timezone)", -6.402746040537586),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.402746040537586),
                                    ("<datetime> - <datetime> (interval)July", -5.997280932429422),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.709598859977641),
                                    ("Februaryintersect", -6.402746040537586),
                                    ("Mother's Dayyear (latent)", -6.402746040537586),
                                    ("Simchat Torahyear (latent)", -6.402746040537586),
                                    ("Victoria Dayyear (latent)", -5.997280932429422),
                                    ("minuteyear", -6.402746040537586)],
                               n = 462},
                   koData =
                     ClassData{prior = -0.9858167945227653, unseen = -6.726233402358747,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.527809064830623),
                                    ...
                                    ("mm/ddat <time-of-day>", -5.626421353498733),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1555233636392305,
                               unseen = -5.3612921657094255,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -2.8710105882431367e-2),
                                    ("intersect 2 numbers", -3.970291913552122)],
                               n = 208},
                   koData =
                     ClassData{prior = -1.9377133818511347,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
