...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6715140852045195, unseen = -5.556828061699537,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 257},
                   koData =
                     ClassData{prior = -0.7152586341673763,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4700036292457356, unseen = -6.633318433280377,
                               likelihoods =
                                 HashMap.fromList
                                   [("Father's Dayyear (latent)", -5.938854596835685),
                                    ("Ramadanyear (latent)", -5.938854596835685),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.686091628340317),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.686091628340317),
                                    ("hourday", -4.23410650459726),
                                    ("dayhour", -3.0210838647514056),
                                    ("Martin Luther King's Dayyear (latent)", -5.53338948872752),
                                    ("Shemini Atzeretyear (latent)", -5.938854596835685),
                                    ("daymonth", -5.2457074162757396),
                                    ("monthday", -5.53338948872752),
                                    ("monthyear", -4.3294166844015844),
                                    ("Yom Ha'atzmautyear (latent)", -5.938854596835685),
                                    ("Thanksgiving Dayyear (latent)", -4.840242308167575),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.938854596835685),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.938854596835685),
                                    ("houryear", -5.2457074162757396),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.938854596835685),
                                    ("Christmas<time-of-day> am|pm", -5.938854596835685),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.938854596835685),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.2457074162757396),
                                    ("<time-of-day> am|pmintersect", -4.686091628340317),
                                    ("Family Dayyear (latent)", -5.02256386496153),
                                    ("Octoberyear (latent)", -4.686091628340317),
                                    ("intersect<time-of-day> am|pm", -5.938854596835685),
                                    ("Shavuotyear (latent)", -5.938854596835685),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.938854596835685),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.938854596835685),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.53338948872752),
                                    ("Marchyear (latent)", -5.938854596835685),
                                    ("Sukkotyear (latent)", -5.53338948872752),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.938854596835685),
                                    ("Clean Mondayyear (latent)", -5.53338948872752),
                                    ("monthhour", -5.53338948872752),
                                    ("todayat <time-of-day>", -5.938854596835685),
                                    ("Thursday<time> timezone", -4.23410650459726),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.938854596835685),
                                    ("Palm SundaySunday", -5.53338948872752),
                                    ("dayday", -3.7416300194994654),
                                    ("<time> <part-of-day>at <time-of-day>", -5.938854596835685),
                                    ("mm/ddat <time-of-day>", -5.938854596835685),
                                    ("tonightat <time-of-day>", -5.938854596835685),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.2457074162757396),
                                    ("today<time-of-day> am|pm", -5.938854596835685),
                                    ("Februarythe <day-of-month> (ordinal)", -5.53338948872752),
                                    ("at <time-of-day><time> <part-of-day>", -5.938854596835685),
                                    ("mm/dd<time-of-day> am|pm", -5.938854596835685),
                                    ("hourhour", -4.686091628340317),
                                    ("<time-of-day> am|pmon <date>", -3.92395157629342),
                                    ("National Patriots' Dayyear (latent)", -5.2457074162757396),
                                    ("Wednesdaythis|last|next <cycle>", -5.938854596835685),
                                    ("Lentyear (latent)", -5.938854596835685),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.43477720005941),
                                    ("dayyear", -2.1433654076634903),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.938854596835685),
                                    ("Thursdayat <time-of-day>", -5.53338948872752),
                                    ("Islamic New Yearyear (latent)", -5.53338948872752),
                                    ("Laylat al-Qadryear (latent)", -5.02256386496153),
                                    ("Discovery Dayyear (latent)", -5.53338948872752),
                                    ("Shrove Tuesdayyear (latent)", -5.938854596835685),
                                    ("<time-of-day> am|pmtomorrow", -5.2457074162757396),
                                    ("Yom Kippuryear (latent)", -5.938854596835685),
                                    ("<part-of-day> of <time>year (latent)", -5.938854596835685),
                                    ("minutehour", -5.02256386496153),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.53338948872752),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.23410650459726),
                                    ("for <duration> from <time>December", -5.938854596835685),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.938854596835685),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.02256386496153),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.53338948872752),
                                    ("Pentecostyear (latent)", -5.938854596835685),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.02256386496153),
                                    ("Eid al-Fitryear (latent)", -5.938854596835685),
                                    ("Mondayin|during the <part-of-day>", -5.938854596835685),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.53338948872752),
                                    ("Ashurayear (latent)", -5.938854596835685),
                                    ("Chinese New Yearyear (latent)", -5.938854596835685),
                                    ("Sundayyear (latent)", -5.938854596835685),
                                    ("Lag BaOmeryear (latent)", -5.938854596835685),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.938854596835685),
                                    ("Eid al-Adhayear (latent)", -5.02256386496153),
                                    ("intersectin|during the <part-of-day>", -5.938854596835685),
                                    ("Christmasat <time-of-day>", -5.938854596835685),
                                    ("Passoveryear (latent)", -5.938854596835685),
                                    ("Lazarus Saturdayyear (latent)", -5.938854596835685),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.938854596835685),
                                    ("Yom HaShoahyear (latent)", -5.53338948872752),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.02256386496153),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.938854596835685),
                                    ("Septemberyear (latent)", -5.53338948872752),
                                    ("mm/ddyear (latent)", -5.938854596835685),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.686091628340317),
                                    ("Halloweenyear (latent)", -5.938854596835685),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.938854596835685),
                                    ("Tu BiShvatyear (latent)", -5.938854596835685),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.938854596835685),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.938854596835685),
                                    ("dayminute", -3.299797267220426),
                                    ("Mawlidyear (latent)", -5.938854596835685),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.53338948872752),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.938854596835685),
                                    ("Jumu'atul-Widayear (latent)", -5.02256386496153),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.938854596835685),
                                    ("minuteday", -2.301268437109299),
                                    ("absorption of , after named dayintersect",
                                     -5.938854596835685),
                                    ("intersectyear (latent)", -5.938854596835685),
                                    ("Orthodox Easter Sundayyear (latent)", -5.938854596835685),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.938854596835685),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.938854596835685),
                                    ("Boss's Dayyear (latent)", -5.53338948872752),
                                    ("Tisha B'Avyear (latent)", -5.938854596835685),
                                    ("Isra and Mi'rajyear (latent)", -5.02256386496153),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.938854596835685),
                                    ("Christmasyear (latent)", -5.53338948872752),
                                    ("at <time-of-day>on <date>", -4.840242308167575),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.3294166844015844),
                                    ("dayweek", -5.938854596835685),
                                    ("Easter Sundayyear (latent)", -5.2457074162757396),
                                    ("Thursday<time-of-day> am|pm", -5.938854596835685),
                                    ("Labour Dayyear (latent)", -5.938854596835685),
                                    ("weekyear", -5.53338948872752),
                                    ("hh:mmin|during the <part-of-day>", -5.2457074162757396),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.53338948872752),
                                    ("Hanukkahyear (latent)", -5.938854596835685),
                                    ("February<time> <part-of-day>", -5.938854596835685),
                                    ("Tuesdayin <named-month>|year", -5.938854596835685),
                                    ("Great Lentyear (latent)", -5.938854596835685),
                                    ("tomorrowat <time-of-day>", -5.2457074162757396),
                                    ("between <time> and <time>on <date>", -4.3294166844015844),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.2457074162757396),
                                    ("last <cycle> of <time>year (latent)", -5.2457074162757396),
                                    ("at <time-of-day>tomorrow", -5.53338948872752),
                                    ("tomorrow<time-of-day> am|pm", -5.938854596835685),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.938854596835685),
                                    ("Black Fridayyear (latent)", -5.53338948872752),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.938854596835685),
                                    ("Palm Sundayintersect", -5.938854596835685),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.938854596835685),
                                    ("Februaryintersect", -5.938854596835685),
                                    ("Mother's Dayyear (latent)", -5.938854596835685),
                                    ("Simchat Torahyear (latent)", -5.938854596835685),
                                    ("Victoria Dayyear (latent)", -5.53338948872752)],
                               n = 285},
                   koData =
                     ClassData{prior = -0.9808292530117262,
                               unseen = -6.2766434893416445,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.581614840681993),
                                    ("hourday", -5.581614840681993),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.581614840681993),
                                    ("dayhour", -3.139267805312789),
                                    ("daymonth", -3.5021732990021577),
                                    ("monthday", -5.176149732573829),
                                    ("monthyear", -4.328851872186625),
                                    ("<time-of-day> am|pmyear (latent)", -5.176149732573829),
                                    ("intersecthh:mm", -5.581614840681993),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.581614840681993),
                                    ("houryear", -4.665324108807838),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.581614840681993),
                                    ("until <time-of-day><time-of-day> am|pm", -5.581614840681993),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.888467660122048),
                                    ("<time-of-day> am|pmintersect", -4.328851872186625),
                                    ("Octoberyear (latent)", -5.581614840681993),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.328851872186625),
                                    ("from|since|after <time-of-day>on <date>", -4.665324108807838),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.665324108807838),
                                    ("Clean Mondayyear (latent)", -5.581614840681993),
                                    ("monthhour", -5.581614840681993),
                                    ("hourmonth", -4.888467660122048),
                                    ("todayat <time-of-day>", -5.581614840681993),
                                    ("from|since|after <time-of-day>July", -5.581614840681993),
                                    ("Mondayyear (latent)", -4.888467660122048),
                                    ("dayday", -5.176149732573829),
                                    ("mm/ddat <time-of-day>", -5.176149732573829),
                                    ("<time-of-day> am|pmon <date>", -4.328851872186625),
                                    ("dayyear", -2.8090261184422123),
                                    ("Thursdaymm/dd", -5.581614840681993),
                                    ("New Year's Dayyear (latent)", -5.176149732573829),
                                    ("Thursdayat <time-of-day>", -4.328851872186625),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.581614840681993),
                                    ("Aprilyear (latent)", -5.581614840681993),
                                    ("monthminute", -5.581614840681993),
                                    ("<time-of-day> am|pmtomorrow", -5.581614840681993),
                                    ("Thursdayhh:mm", -4.665324108807838),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.581614840681993),
                                    ("minutemonth", -3.7898553714539385),
                                    ("Sundayfrom|since|after <time-of-day>", -5.581614840681993),
                                    ("week-endin <named-month>|year", -5.581614840681993),
                                    ("Augustyear (latent)", -5.176149732573829),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.176149732573829),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.176149732573829),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.581614840681993),
                                    ("Sundayyear (latent)", -4.888467660122048),
                                    ("Christmasat <time-of-day>", -5.581614840681993),
                                    ("<duration> after|before|from <time>December",
                                     -5.581614840681993),
                                    ("yesterday<time-of-day> am|pm", -5.581614840681993),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.665324108807838),
                                    ("mm/ddyear (latent)", -5.581614840681993),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.176149732573829),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.581614840681993),
                                    ("until <time-of-day>on <date>", -4.888467660122048),
                                    ("at <time-of-day>intersect", -5.176149732573829),
                                    ("hh:mmyear (latent)", -4.483002552013883),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.581614840681993),
                                    ("dayminute", -3.096708190893993),
                                    ("intersectSeptember", -4.07753744390572),
                                    ("minuteday", -2.5135619055483764),
                                    ("absorption of , after named dayintersect",
                                     -5.581614840681993),
                                    ("Februaryin|during the <part-of-day>", -5.581614840681993),
                                    ("hh:mmon <date>", -3.5667118201397288),
                                    ("Saturdayyear (latent)", -5.581614840681993),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.581614840681993),
                                    ("absorption of , after named daySeptember",
                                     -4.665324108807838),
                                    ("on <date>September", -5.176149732573829),
                                    ("at <time-of-day>on <date>", -5.176149732573829),
                                    ("in <named-month>|yearyear (latent)", -5.581614840681993),
                                    ("dayweek", -5.581614840681993),
                                    ("Easter Sundayyear (latent)", -5.176149732573829),
                                    ("Thursday<time-of-day> am|pm", -5.176149732573829),
                                    ("absorption of , after named dayFebruary", -4.665324108807838),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.581614840681993),
                                    ("tomorrowat <time-of-day>", -5.581614840681993),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.581614840681993),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.9721769282478934),
                                    ("tomorrow<time-of-day> am|pm", -5.581614840681993),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.888467660122048),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.581614840681993),
                                    ("Fridayyear (latent)", -5.176149732573829),
                                    ("minuteyear", -4.328851872186625)],
                               n = 171}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.18555257737540104, unseen = -4.68213122712422,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -4.78560211776351e-2),
                                    ("intersect 2 numbers", -3.5742165457937967)],
                               n = 103},
                   koData =
                     ClassData{prior = -1.7757591278816138, unseen = -3.258096538021482,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -1.2729656758128873),
                                    ("negative numbers", -0.579818495252942),
                                    ("compose by multiplication", -2.120263536200091)],
                               n = 21}}),
       ("mm/dd/yyyy",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.0794415416798357,
