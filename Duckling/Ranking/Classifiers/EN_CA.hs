...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5795581576804214, unseen = -6.137727054086234,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 461},
                   koData =
                     ClassData{prior = -0.8213119888512987,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.44842473396119215,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.447305862541213),
                                    ...
                                    ("Ramadanyear (latent)", -5.194542894045845),
                                    ...
                                    ("Family Dayyear (latent)", -5.531015130667058),
                                    ...
                                    ("National Patriots' Dayyear (latent)", -5.754158681981268),
                                    ...
                                    ("Discovery Dayyear (latent)", -6.041840754433049),
                                    ...
                                    ("Eid al-Fitryear (latent)", -5.061011501421323),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.041840754433049),
                                    ("Ratha-Yatrayear (latent)", -6.447305862541213),
                                    ...
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.041840754433049),
                                    ("Labour Dayyear (latent)", -6.447305862541213),
                                    ...
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.447305862541213),
                                    ("Ugadiyear (latent)", -5.061011501421323),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.447305862541213),
                                    ("Pargat Diwasyear (latent)", -5.194542894045845),
                                    ...
                                    ("Victoria Dayyear (latent)", -6.041840754433049),
                                    ("minuteyear", -6.447305862541213)],
                               n = 486},
                   koData =
                     ClassData{prior = -1.0178622601951146, unseen = -6.734591659972948,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.53617731450114),
                                    ("hourday", -3.6423594384790436),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.040254711277414),
                                    ("<day-of-month> (ordinal)August", -6.040254711277414),
                                    ("dayhour", -3.366106061850885),
                                    ("<time> timezoneyear (latent)", -5.3471075307174685),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.123963979403259),
                                    ("Tuesdayfrom|since|after <time>", -5.3471075307174685),
                                    ("daymonth", -3.366106061850885),
                                    ("monthyear", -4.787491742782046),
                                    ("<time-of-day> am|pmyear (latent)", -5.3471075307174685),
                                    ("Thai Pongalyear (latent)", -5.3471075307174685),
                                    ("intersecthh:mm", -6.040254711277414),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.634789603169249),
                                    ("<day-of-month> (ordinal)Wednesday", -6.040254711277414),
                                    ("houryear", -4.653960350157523),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.040254711277414),
                                    ("<day-of-month> (ordinal)October", -6.040254711277414),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.3471075307174685),
                                    ("hournograin", -4.787491742782046),
                                    ("<time-of-day> am|pmintersect", -4.787491742782046),
                                    ("Octoberyear (latent)", -6.040254711277414),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.634789603169249),
                                    ("until <time>on <day>", -5.3471075307174685),
                                    ("time-of-day (latent)intersect", -5.3471075307174685),
                                    ("todayin <number> (implicit minutes)", -6.040254711277414),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.3471075307174685),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.040254711277414),
                                    ("hh:mmon <day>", -4.787491742782046),
                                    ("hhhmmintersect", -5.634789603169249),
                                    ("absorption of , after named dayJuly", -5.123963979403259),
                                    ("from|since|after <time>July", -5.634789603169249),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.123963979403259),
                                    ("Clean Mondayyear (latent)", -6.040254711277414),
                                    ("monthhour", -6.040254711277414),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.634789603169249),
                                    ("hourmonth", -4.168452534375823),
                                    ("todayat <time-of-day>", -6.040254711277414),
                                    ("hhhmmyear (latent)", -4.787491742782046),
                                    ("from|since|after <time>December", -6.040254711277414),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.040254711277414),
                                    ("<time-of-day> am|pmon <day>", -4.787491742782046),
                                    ("Mondayyear (latent)", -5.3471075307174685),
                                    ("dayday", -4.653960350157523),
                                    ("mm/ddat <time-of-day>", -5.634789603169249),
                                    ("on <day>September", -5.3471075307174685),
                                    ("time-of-day (latent)September", -5.634789603169249),
                                    ("hourhour", -5.634789603169249),
                                    ("time-of-day (latent)on <day>", -4.53617731450114),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.634789603169249),
                                    ("dayyear", -3.0958157321109736),
                                    ("Thursdaymm/dd", -6.040254711277414),
                                    ("New Year's Dayyear (latent)", -5.123963979403259),
                                    ("time-of-day (latent)Sunday", -5.634789603169249),
                                    ("Thursdayfrom|since|after <time>", -4.335506619038989),
                                    ("Thursdayat <time-of-day>", -4.430816798843313),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.040254711277414),
                                    ("Aprilyear (latent)", -6.040254711277414),
                                    ("the <day-of-month> (ordinal)July", -6.040254711277414),
                                    ("the <day-of-month> (number)July", -6.040254711277414),
                                    ("monthminute", -6.040254711277414),
                                    ("<time-of-day> am|pmtomorrow", -6.040254711277414),
                                    ("Thursdayhh:mm", -5.123963979403259),
                                    ("<day-of-month> (ordinal)Tuesday", -5.634789603169249),
                                    ("minutemonth", -3.900188547781143),
                                    ("time-of-day (latent)Friday", -5.634789603169249),
                                    ("minutehour", -6.040254711277414),
                                    ("Augustyear (latent)", -5.634789603169249),
                                    ("week-endin|during <named-month>|year", -6.040254711277414),
                                    ("time-of-day (latent)Tuesday", -5.634789603169249),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.634789603169249),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.040254711277414),
                                    ("Sundayyear (latent)", -5.123963979403259),
                                    ("Christmasat <time-of-day>", -6.040254711277414),
                                    ("from|since|after <time>year (latent)", -4.941642422609305),
                                    ("hhhmmon <day>", -5.123963979403259),
                                    ("yesterday<time-of-day> am|pm", -6.040254711277414),
                                    ("<day-of-month> (ordinal)July", -5.3471075307174685),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.040254711277414),
                                    ("at <time-of-day>intersect", -5.123963979403259),
                                    ("hh:mmyear (latent)", -4.653960350157523),
                                    ("Holiyear (latent)", -6.040254711277414),
                                    ("until <time><time-of-day> am|pm", -6.040254711277414),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.634789603169249),
                                    ("dayminute", -3.1780538303479458),
                                    ("yyyy-mm-ddhh:mm", -5.634789603169249),
                                    ("intersectfrom|since|after <time>", -5.634789603169249),
                                    ("intersectSeptember", -4.168452534375823),
                                    ("minuteday", -2.883254290127301),
                                    ("absorption of , after named dayintersect",
                                     -6.040254711277414),
                                    ("intersectyear (latent)", -6.040254711277414),
                                    ("Februaryin|during the <part-of-day>", -6.040254711277414),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.040254711277414),
                                    ("time-of-day (latent)July", -5.3471075307174685),
                                    ("Saturdayyear (latent)", -6.040254711277414),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.040254711277414),
                                    ...
                                    ("from|since|after <time>on <day>", -5.123963979403259),
                                    ("dayweek", -6.040254711277414),
                                    ("Easter Sundayyear (latent)", -5.634789603169249),
                                    ("Thursday<time-of-day> am|pm", -4.787491742782046),
                                    ("weekyear", -5.634789603169249),
                                    ("time-of-day (latent)Thursday", -5.634789603169249),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.040254711277414),
                                    ("<day-of-month> (ordinal)April", -6.040254711277414),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.634789603169249),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.3471075307174685),
                                    ("Sundayfrom|since|after <time>", -6.040254711277414),
                                    ("absorption of , after named dayFebruary", -5.123963979403259),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.634789603169249),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.040254711277414),
                                    ("tomorrowat <time-of-day>", -6.040254711277414),
                                    ("daynograin", -5.634789603169249),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.634789603169249),
                                    ("last <cycle> of <time>year (latent)", -5.634789603169249),
                                    ("tomorrow<time-of-day> am|pm", -6.040254711277414),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.3471075307174685),
                                    ("Diwaliyear (latent)", -5.634789603169249),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.040254711277414),
                                    ("Fridayyear (latent)", -5.634789603169249),
                                    ("time-of-day (latent)April", -6.040254711277414),
                                    ("minuteyear", -3.8430301339411947)],
                               n = 275}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.14051128673393956,
                               ...
                               n = 232},
                   koData =
                     ClassData{prior = -2.031900596910836, unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
