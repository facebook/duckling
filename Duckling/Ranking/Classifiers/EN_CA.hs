...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6586847763737688, unseen = -5.916202062607435,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 369},
                   koData =
                     ClassData{prior = -0.7288397630408976, unseen = -5.846438775057725,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4949365109386564,
                               unseen = -6.9782137426306985,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.284134161070802),
                                    ("Father's Dayyear (latent)", -6.284134161070802),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.284134161070802),
                                    ("Ramadanyear (latent)", -5.367843429196647),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.269231140528537),
                                    ("Bhai Doojyear (latent)", -6.284134161070802),
                                    ("hourday", -4.269231140528537),
                                    ("dayhour", -3.366363428986523),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.269231140528537),
                                    ("Martin Luther King's Dayyear (latent)", -5.878669052962637),
                                    ("Shemini Atzeretyear (latent)", -6.284134161070802),
                                    ("daymonth", -4.269231140528537),
                                    ("monthday", -5.878669052962637),
                                    ("monthyear", -4.492374691842747),
                                    ("Yom Ha'atzmautyear (latent)", -6.284134161070802),
                                    ("Vijayadashamiyear (latent)", -6.284134161070802),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.878669052962637),
                                    ("Thanksgiving Dayyear (latent)", -5.185521872402692),
                                    ("Thai Pongalyear (latent)", -5.5909869805108565),
                                    ("Thiru Onamyear (latent)", -5.5909869805108565),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.284134161070802),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.367843429196647),
                                    ("<day-of-month> (ordinal)Wednesday", -6.284134161070802),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.284134161070802),
                                    ("houryear", -5.367843429196647),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.284134161070802),
                                    ("Christmas<time-of-day> am|pm", -6.284134161070802),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.284134161070802),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.5909869805108565),
                                    ("intersectin|during <named-month>|year", -6.284134161070802),
                                    ("<time-of-day> am|pmintersect", -5.031371192575434),
                                    ("Earth Houryear (latent)", -6.284134161070802),
                                    ("Family Dayyear (latent)", -5.367843429196647),
                                    ("Octoberyear (latent)", -4.780056764294528),
                                    ("intersect<time-of-day> am|pm", -6.284134161070802),
                                    ("Mattu Pongalyear (latent)", -6.284134161070802),
                                    ("Shavuotyear (latent)", -6.284134161070802),
                                    ("Parsi New Yearyear (latent)", -5.367843429196647),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.284134161070802),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.284134161070802),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.878669052962637),
                                    ("Marchyear (latent)", -6.284134161070802),
                                    ("Sukkotyear (latent)", -5.878669052962637),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.878669052962637),
                                    ("Clean Mondayyear (latent)", -5.878669052962637),
                                    ("monthhour", -5.878669052962637),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.5909869805108565),
                                    ("todayat <time-of-day>", -6.284134161070802),
                                    ("Thursday<time> timezone", -4.3382240120154885),
                                    ("time-of-day (latent)tonight", -5.878669052962637),
                                    ("from|since|after <time>December", -6.284134161070802),
                                    ("<time-of-day> am|pmon <day>", -4.269231140528537),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.284134161070802),
                                    ("yyyy-mm-ddhh:mm:ss", -5.878669052962637),
                                    ("dayday", -3.8417871257015976),
                                    ("<time> <part-of-day>at <time-of-day>", -6.284134161070802),
                                    ("mm/ddat <time-of-day>", -6.284134161070802),
                                    ("tonightat <time-of-day>", -6.284134161070802),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.5909869805108565),
                                    ("today<time-of-day> am|pm", -6.284134161070802),
                                    ("Februarythe <day-of-month> (ordinal)", -5.878669052962637),
                                    ("at <time-of-day><time> <part-of-day>", -6.284134161070802),
                                    ("<day-of-month> (ordinal)intersect", -5.878669052962637),
                                    ("mm/dd<time-of-day> am|pm", -6.284134161070802),
                                    ("hourhour", -4.204692619390966),
                                    ("Navaratriin|during <named-month>|year", -6.284134161070802),
                                    ("National Patriots' Dayyear (latent)", -5.5909869805108565),
                                    ("Wednesdaythis|last|next <cycle>", -6.284134161070802),
                                    ("Lentyear (latent)", -6.284134161070802),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.780056764294528),
                                    ("Boghiyear (latent)", -6.284134161070802),
                                    ("dayyear", -1.9936747199224107),
                                    ("Thursdayfrom|since|after <time>", -5.878669052962637),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.284134161070802),
                                    ("Thursdayat <time-of-day>", -5.5909869805108565),
                                    ("Islamic New Yearyear (latent)", -5.878669052962637),
                                    ("Laylat al-Qadryear (latent)", -5.367843429196647),
                                    ("Discovery Dayyear (latent)", -5.878669052962637),
                                    ("Shrove Tuesdayyear (latent)", -6.284134161070802),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.5909869805108565),
                                    ("<time-of-day> am|pmtomorrow", -5.5909869805108565),
                                    ("Yom Kippuryear (latent)", -6.284134161070802),
                                    ("<day-of-month> (ordinal)Tuesday", -5.878669052962637),
                                    ("<part-of-day> of <time>year (latent)", -6.284134161070802),
                                    ("minutehour", -5.185521872402692),
                                    ("Kaanum Pongalyear (latent)", -5.878669052962637),
                                    ("Maha Saptamiyear (latent)", -6.284134161070802),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.878669052962637),
                                    ("time-of-day (latent)tomorrow", -5.367843429196647),
                                    ("part of daysat <time-of-day>", -5.878669052962637),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.579386068832377),
                                    ("for <duration> from <time>December", -6.284134161070802),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.284134161070802),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.031371192575434),
                                    ("time-of-day (latent)this <part-of-day>", -6.284134161070802),
                                    ("Pentecostyear (latent)", -6.284134161070802),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.031371192575434),
                                    ("<day-of-month> (ordinal)February", -6.284134161070802),
                                    ("Eid al-Fitryear (latent)", -5.367843429196647),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.284134161070802),
                                    ("Mondayin|during the <part-of-day>", -6.284134161070802),
                                    ("Chhathin|during <named-month>|year", -6.284134161070802),
                                    ("Diwaliin|during <named-month>|year", -6.284134161070802),
                                    ("Vaisakhiin|during <named-month>|year", -6.284134161070802),
                                    ("Raksha Bandhanyear (latent)", -6.284134161070802),
                                    ("daysecond", -5.878669052962637),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.878669052962637),
                                    ("Ashurayear (latent)", -6.284134161070802),
                                    ("Tuesdayin|during <named-month>|year", -6.284134161070802),
                                    ("Chinese New Yearyear (latent)", -6.284134161070802),
                                    ("tomorrowintersect", -6.284134161070802),
                                    ("Lag BaOmeryear (latent)", -6.284134161070802),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.284134161070802),
                                    ("Eid al-Adhayear (latent)", -5.367843429196647),
                                    ("intersectin|during the <part-of-day>", -6.284134161070802),
                                    ("Palm Sundayyear (latent)", -6.284134161070802),
                                    ("Christmasat <time-of-day>", -6.284134161070802),
                                    ("Passoveryear (latent)", -6.284134161070802),
                                    ("Lazarus Saturdayyear (latent)", -6.284134161070802),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.284134161070802),
                                    ("Yom HaShoahyear (latent)", -5.878669052962637),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.878669052962637),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.284134161070802),
                                    ("Septemberyear (latent)", -5.878669052962637),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.780056764294528),
                                    ("Halloweenyear (latent)", -6.284134161070802),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.284134161070802),
                                    ("at <time-of-day>intersect", -5.878669052962637),
                                    ("Rosh Hashanahyear (latent)", -5.5909869805108565),
                                    ("Dhanterasyear (latent)", -6.284134161070802),
                                    ("Tu BiShvatyear (latent)", -6.284134161070802),
                                    ("<day-of-month> (ordinal)December", -5.5909869805108565),
                                    ("Holiyear (latent)", -5.5909869805108565),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.284134161070802),
                                    ("Holika Dahanyear (latent)", -5.5909869805108565),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.284134161070802),
                                    ("dayminute", -3.366363428986523),
                                    ("Mawlidyear (latent)", -6.284134161070802),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.878669052962637),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.284134161070802),
                                    ("Jumu'atul-Widayear (latent)", -5.367843429196647),
                                    ("minuteday", -2.455492764581707),
                                    ("absorption of , after named dayintersect",
                                     -6.284134161070802),
                                    ("intersectyear (latent)", -6.284134161070802),
                                    ("Orthodox Easter Sundayyear (latent)", -6.284134161070802),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.284134161070802),
                                    ("Boss's Dayyear (latent)", -5.878669052962637),
                                    ("Global Youth Service Dayyear (latent)", -6.284134161070802),
                                    ("Dhanterasin|during <named-month>|year", -6.284134161070802),
                                    ("Tisha B'Avyear (latent)", -6.284134161070802),
                                    ("Isra and Mi'rajyear (latent)", -5.367843429196647),
                                    ("at <time-of-day>on <day>", -5.185521872402692),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.284134161070802),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.5909869805108565),
                                    ("Christmasyear (latent)", -5.878669052962637),
                                    ("Naraka Chaturdashiyear (latent)", -5.878669052962637),
                                    ("Thai Pongalin|during <named-month>|year", -6.284134161070802),
                                    ("dayweek", -6.284134161070802),
                                    ("Easter Sundayyear (latent)", -5.5909869805108565),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.674696248636701),
                                    ("Labour Dayyear (latent)", -6.284134161070802),
                                    ("weekyear", -5.185521872402692),
                                    ("hh:mmin|during the <part-of-day>", -5.5909869805108565),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.878669052962637),
                                    ("Hanukkahyear (latent)", -5.5909869805108565),
                                    ("February<time> <part-of-day>", -6.284134161070802),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.284134161070802),
                                    ("Great Lentyear (latent)", -6.284134161070802),
                                    ("tomorrowat <time-of-day>", -5.5909869805108565),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.284134161070802),
                                    ("Vaisakhiyear (latent)", -5.5909869805108565),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.284134161070802),
                                    ("last <cycle> of <time>year (latent)", -5.5909869805108565),
                                    ("at <time-of-day>tomorrow", -5.878669052962637),
                                    ("tomorrow<time-of-day> am|pm", -6.284134161070802),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.284134161070802),
                                    ("Diwaliyear (latent)", -6.284134161070802),
                                    ("between <time> and <time>on <day>", -4.674696248636701),
                                    ("Black Fridayyear (latent)", -5.878669052962637),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.284134161070802),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.284134161070802),
                                    ("Chhathyear (latent)", -5.878669052962637),
                                    ("Vasant Panchamiyear (latent)", -6.284134161070802),
                                    ("St Patrick's Dayyear (latent)", -6.284134161070802),
                                    ("Thursday<time> (timezone)", -6.284134161070802),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.284134161070802),
                                    ("<datetime> - <datetime> (interval)July", -5.878669052962637),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.878669052962637),
                                    ("Februaryintersect", -6.284134161070802),
                                    ("Mother's Dayyear (latent)", -6.284134161070802),
                                    ("Simchat Torahyear (latent)", -6.284134161070802),
                                    ("Victoria Dayyear (latent)", -5.878669052962637),
                                    ("minuteyear", -6.284134161070802)],
                               n = 406},
                   koData =
                     ClassData{prior = -0.9406080395248615, unseen = -6.660575149839686,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.258096538021482),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.966146739123692),
                                    ("<day-of-month> (ordinal)August", -5.966146739123692),
                                    ("dayhour", -3.2919980896971635),
                                    ("<time> timezoneyear (latent)", -5.966146739123692),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.049856007249537),
                                    ("Tuesdayfrom|since|after <time>", -5.966146739123692),
                                    ("daymonth", -3.481240089335692),
                                    ("monthyear", -4.713383770628324),
                                    ("<time-of-day> am|pmyear (latent)", -5.272999558563747),
                                    ("Thai Pongalyear (latent)", -5.272999558563747),
                                    ("intersecthh:mm", -5.966146739123692),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.560681631015528),
                                    ("<day-of-month> (ordinal)Wednesday", -5.966146739123692),
                                    ("houryear", -4.579852378003801),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.966146739123692),
                                    ("<day-of-month> (ordinal)October", -5.966146739123692),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.272999558563747),
                                    ("<time-of-day> am|pmintersect", -4.713383770628324),
                                    ("Octoberyear (latent)", -5.966146739123692),
                                    ("until <time>on <day>", -5.272999558563747),
                                    ("time-of-day (latent)intersect", -5.966146739123692),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.272999558563747),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.966146739123692),
                                    ("hh:mmon <day>", -3.523799703754488),
                                    ("absorption of , after named dayJuly", -5.560681631015528),
                                    ("from|since|after <time>July", -5.560681631015528),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.049856007249537),
                                    ("Clean Mondayyear (latent)", -5.966146739123692),
                                    ("monthhour", -5.966146739123692),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.560681631015528),
                                    ("hourmonth", -4.0943445622221),
                                    ("todayat <time-of-day>", -5.966146739123692),
                                    ("from|since|after <time>December", -5.966146739123692),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.966146739123692),
                                    ("<time-of-day> am|pmon <day>", -4.713383770628324),
                                    ("Mondayyear (latent)", -5.272999558563747),
                                    ("dayday", -4.579852378003801),
                                    ("mm/ddat <time-of-day>", -5.560681631015528),
                                    ("on <day>September", -5.560681631015528),
                                    ("time-of-day (latent)September", -5.560681631015528),
                                    ("hourhour", -5.966146739123692),
                                    ("time-of-day (latent)on <day>", -3.523799703754488),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.560681631015528),
                                    ("dayyear", -3.0217077599572515),
                                    ("Thursdaymm/dd", -5.966146739123692),
                                    ("New Year's Dayyear (latent)", -5.049856007249537),
                                    ("Thursdayfrom|since|after <time>", -4.261398646885267),
                                    ("Thursdayat <time-of-day>", -4.356708826689592),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.966146739123692),
                                    ("Aprilyear (latent)", -5.966146739123692),
                                    ("the <day-of-month> (ordinal)July", -5.966146739123692),
                                    ("the <day-of-month> (number)July", -5.966146739123692),
                                    ("monthminute", -5.966146739123692),
                                    ("<time-of-day> am|pmtomorrow", -5.966146739123692),
                                    ("Thursdayhh:mm", -5.049856007249537),
                                    ("<day-of-month> (ordinal)Tuesday", -5.560681631015528),
                                    ("minutemonth", -4.0943445622221),
                                    ("minutehour", -5.966146739123692),
                                    ("Augustyear (latent)", -5.560681631015528),
                                    ("week-endin|during <named-month>|year", -5.966146739123692),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.560681631015528),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.966146739123692),
                                    ("Sundayyear (latent)", -5.049856007249537),
                                    ("Christmasat <time-of-day>", -5.966146739123692),
                                    ("from|since|after <time>year (latent)", -4.867534450455582),
                                    ("<duration> after|before|from <time>December",
                                     -5.966146739123692),
                                    ("yesterday<time-of-day> am|pm", -5.966146739123692),
                                    ("<day-of-month> (ordinal)July", -5.272999558563747),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.966146739123692),
                                    ("mm/ddyear (latent)", -5.966146739123692),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.966146739123692),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.966146739123692),
                                    ("at <time-of-day>intersect", -5.560681631015528),
                                    ("hh:mmyear (latent)", -3.886705197443856),
                                    ("Holiyear (latent)", -5.966146739123692),
                                    ("until <time><time-of-day> am|pm", -5.966146739123692),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.966146739123692),
                                    ("dayminute", -3.4011973816621555),
                                    ("yyyy-mm-ddhh:mm", -5.560681631015528),
                                    ("intersectSeptember", -4.462069342347418),
                                    ("minuteday", -2.7274682869593114),
                                    ("absorption of , after named dayintersect",
                                     -5.966146739123692),
                                    ("intersectyear (latent)", -5.966146739123692),
                                    ("Februaryin|during the <part-of-day>", -5.966146739123692),
                                    ("time-of-day (latent)July", -5.272999558563747),
                                    ("Saturdayyear (latent)", -5.966146739123692),
                                    ("at <time-of-day>on <day>", -5.560681631015528),
                                    ("absorption of , after named daySeptember",
                                     -5.049856007249537),
                                    ("Naraka Chaturdashiyear (latent)", -5.966146739123692),
                                    ("from|since|after <time>on <day>", -5.049856007249537),
                                    ("dayweek", -5.966146739123692),
                                    ("Easter Sundayyear (latent)", -5.560681631015528),
                                    ("Thursday<time-of-day> am|pm", -4.713383770628324),
                                    ("weekyear", -5.560681631015528),
                                    ("time-of-day (latent)Thursday", -5.560681631015528),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.966146739123692),
                                    ("<day-of-month> (ordinal)April", -5.966146739123692),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.560681631015528),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.272999558563747),
                                    ("Sundayfrom|since|after <time>", -5.966146739123692),
                                    ("absorption of , after named dayFebruary", -5.049856007249537),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.966146739123692),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.966146739123692),
                                    ("tomorrowat <time-of-day>", -5.966146739123692),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.560681631015528),
                                    ("last <cycle> of <time>year (latent)", -5.560681631015528),
                                    ("tomorrow<time-of-day> am|pm", -5.966146739123692),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.272999558563747),
                                    ("Diwaliyear (latent)", -5.560681631015528),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.966146739123692),
                                    ("Fridayyear (latent)", -5.560681631015528),
                                    ("time-of-day (latent)April", -5.966146739123692),
                                    ("minuteyear", -3.7689221617874726)],
                               n = 260}}),
       ("one eleven",
        Classifier{okData =
