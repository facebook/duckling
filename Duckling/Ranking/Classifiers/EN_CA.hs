...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6548283162578087,
                               unseen = -5.5909869805108565,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 266},
                   koData =
                     ClassData{prior = -0.732993089107145, unseen = -5.5134287461649825,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4636274121064596, unseen = -6.669498089857879,
                               likelihoods =
                                 HashMap.fromList
                                   [("Father's Dayyear (latent)", -5.975081067857458),
                                    ("Ramadanyear (latent)", -5.975081067857458),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.72231809936209),
                                    ("Bhai Doojyear (latent)", -5.975081067857458),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.72231809936209),
                                    ("hourday", -4.2703329756190325),
                                    ("dayhour", -3.057310335773179),
                                    ("Martin Luther King's Dayyear (latent)", -5.569615959749293),
                                    ("Shemini Atzeretyear (latent)", -5.975081067857458),
                                    ("daymonth", -5.281933887297512),
                                    ("monthday", -5.569615959749293),
                                    ("monthyear", -4.365643155423357),
                                    ("Yom Ha'atzmautyear (latent)", -5.975081067857458),
                                    ("Thanksgiving Dayyear (latent)", -4.876468779189349),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.975081067857458),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.975081067857458),
                                    ("houryear", -5.281933887297512),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.975081067857458),
                                    ("Christmas<time-of-day> am|pm", -5.975081067857458),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.975081067857458),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.281933887297512),
                                    ("<time-of-day> am|pmintersect", -4.72231809936209),
                                    ("Family Dayyear (latent)", -5.058790335983303),
                                    ("Octoberyear (latent)", -4.72231809936209),
                                    ("intersect<time-of-day> am|pm", -5.975081067857458),
                                    ("Shavuotyear (latent)", -5.975081067857458),
                                    ("Dhanterasin <named-month>|year", -5.975081067857458),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.975081067857458),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.975081067857458),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.569615959749293),
                                    ("Marchyear (latent)", -5.975081067857458),
                                    ("Sukkotyear (latent)", -5.569615959749293),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.975081067857458),
                                    ("Clean Mondayyear (latent)", -5.569615959749293),
                                    ("monthhour", -5.569615959749293),
                                    ("todayat <time-of-day>", -5.975081067857458),
                                    ("Thursday<time> timezone", -4.2703329756190325),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.975081067857458),
                                    ("Palm SundaySunday", -5.569615959749293),
                                    ("dayday", -3.7778564905212386),
                                    ("<time> <part-of-day>at <time-of-day>", -5.975081067857458),
                                    ("mm/ddat <time-of-day>", -5.975081067857458),
                                    ("tonightat <time-of-day>", -5.975081067857458),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.281933887297512),
                                    ("today<time-of-day> am|pm", -5.975081067857458),
                                    ("Februarythe <day-of-month> (ordinal)", -5.569615959749293),
                                    ("at <time-of-day><time> <part-of-day>", -5.975081067857458),
                                    ("mm/dd<time-of-day> am|pm", -5.975081067857458),
                                    ("hourhour", -4.72231809936209),
                                    ("<time-of-day> am|pmon <date>", -3.960178047315193),
                                    ("National Patriots' Dayyear (latent)", -5.281933887297512),
                                    ("Wednesdaythis|last|next <cycle>", -5.975081067857458),
                                    ("Lentyear (latent)", -5.975081067857458),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.471003671081184),
                                    ("dayyear", -2.0731083982828133),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.975081067857458),
                                    ("Thursdayat <time-of-day>", -5.569615959749293),
                                    ("Islamic New Yearyear (latent)", -5.569615959749293),
                                    ("Laylat al-Qadryear (latent)", -5.058790335983303),
                                    ("Chhathin <named-month>|year", -5.975081067857458),
                                    ("Diwaliin <named-month>|year", -5.975081067857458),
                                    ("Discovery Dayyear (latent)", -5.569615959749293),
                                    ("Shrove Tuesdayyear (latent)", -5.975081067857458),
                                    ("<time-of-day> am|pmtomorrow", -5.281933887297512),
                                    ("Yom Kippuryear (latent)", -5.975081067857458),
                                    ("<part-of-day> of <time>year (latent)", -5.975081067857458),
                                    ("minutehour", -5.058790335983303),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.569615959749293),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.2703329756190325),
                                    ("for <duration> from <time>December", -5.975081067857458),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.975081067857458),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.058790335983303),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.569615959749293),
                                    ("Pentecostyear (latent)", -5.975081067857458),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.058790335983303),
                                    ("Eid al-Fitryear (latent)", -5.975081067857458),
                                    ("Mondayin|during the <part-of-day>", -5.975081067857458),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.569615959749293),
                                    ("Ashurayear (latent)", -5.975081067857458),
                                    ("Chinese New Yearyear (latent)", -5.975081067857458),
                                    ("Sundayyear (latent)", -5.975081067857458),
                                    ("Lag BaOmeryear (latent)", -5.975081067857458),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.975081067857458),
                                    ("Eid al-Adhayear (latent)", -5.058790335983303),
                                    ("intersectin|during the <part-of-day>", -5.975081067857458),
                                    ("Christmasat <time-of-day>", -5.975081067857458),
                                    ("Passoveryear (latent)", -5.975081067857458),
                                    ("Lazarus Saturdayyear (latent)", -5.975081067857458),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.975081067857458),
                                    ("Yom HaShoahyear (latent)", -5.569615959749293),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.058790335983303),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.975081067857458),
                                    ("Septemberyear (latent)", -5.569615959749293),
                                    ("mm/ddyear (latent)", -5.975081067857458),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.72231809936209),
                                    ("Halloweenyear (latent)", -5.975081067857458),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.281933887297512),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -5.058790335983303),
                                    ("at <time-of-day>intersect", -5.569615959749293),
                                    ("Rosh Hashanahyear (latent)", -5.975081067857458),
                                    ("Dhanterasyear (latent)", -5.975081067857458),
                                    ("Tu BiShvatyear (latent)", -5.975081067857458),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.975081067857458),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.975081067857458),
                                    ("dayminute", -3.3360237382421993),
                                    ("Mawlidyear (latent)", -5.975081067857458),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.569615959749293),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.975081067857458),
                                    ("Jumu'atul-Widayear (latent)", -5.058790335983303),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.975081067857458),
                                    ("minuteday", -2.337494908131072),
                                    ("absorption of , after named dayintersect",
                                     -5.975081067857458),
                                    ("intersectyear (latent)", -5.975081067857458),
                                    ("Orthodox Easter Sundayyear (latent)", -5.975081067857458),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.975081067857458),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.975081067857458),
                                    ("Boss's Dayyear (latent)", -5.569615959749293),
                                    ("Tisha B'Avyear (latent)", -5.975081067857458),
                                    ("Isra and Mi'rajyear (latent)", -5.058790335983303),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.975081067857458),
                                    ("Christmasyear (latent)", -5.569615959749293),
                                    ("Naraka Chaturdashiyear (latent)", -5.569615959749293),
                                    ("at <time-of-day>on <date>", -4.876468779189349),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.365643155423357),
                                    ("dayweek", -5.975081067857458),
                                    ("Easter Sundayyear (latent)", -5.281933887297512),
                                    ("Thursday<time-of-day> am|pm", -5.975081067857458),
                                    ("Labour Dayyear (latent)", -5.975081067857458),
                                    ("weekyear", -5.569615959749293),
                                    ("hh:mmin|during the <part-of-day>", -5.281933887297512),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.569615959749293),
                                    ("Hanukkahyear (latent)", -5.975081067857458),
                                    ("February<time> <part-of-day>", -5.975081067857458),
                                    ("Tuesdayin <named-month>|year", -5.975081067857458),
                                    ("Great Lentyear (latent)", -5.975081067857458),
                                    ("tomorrowat <time-of-day>", -5.281933887297512),
                                    ("between <time> and <time>on <date>", -4.365643155423357),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.281933887297512),
                                    ("last <cycle> of <time>year (latent)", -5.281933887297512),
                                    ("at <time-of-day>tomorrow", -5.569615959749293),
                                    ("tomorrow<time-of-day> am|pm", -5.975081067857458),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.975081067857458),
                                    ("Diwaliyear (latent)", -5.975081067857458),
                                    ("Black Fridayyear (latent)", -5.569615959749293),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.975081067857458),
                                    ("Chhathyear (latent)", -5.569615959749293),
                                    ("Palm Sundayintersect", -5.975081067857458),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.975081067857458),
                                    ("Februaryintersect", -5.975081067857458),
                                    ("Mother's Dayyear (latent)", -5.975081067857458),
                                    ("Simchat Torahyear (latent)", -5.975081067857458),
                                    ("Victoria Dayyear (latent)", -5.569615959749293)],
                               n = 295},
                   koData =
                     ClassData{prior = -0.9915474692317503, unseen = -6.302618975744905,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.607638614103299),
                                    ("hourday", -5.607638614103299),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.607638614103299),
                                    ("dayhour", -3.1652915787340943),
                                    ("daymonth", -3.528197072423463),
                                    ("monthday", -5.202173505995134),
                                    ("monthyear", -4.3548756456079305),
                                    ("<time-of-day> am|pmyear (latent)", -5.202173505995134),
                                    ("intersecthh:mm", -5.607638614103299),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.607638614103299),
                                    ("houryear", -4.6913478822291435),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.607638614103299),
                                    ("until <time-of-day><time-of-day> am|pm", -5.607638614103299),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.914491433543353),
                                    ("<time-of-day> am|pmintersect", -4.3548756456079305),
                                    ("Octoberyear (latent)", -5.607638614103299),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.607638614103299),
                                    ("absorption of , after named dayJuly", -5.202173505995134),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.6913478822291435),
                                    ("Clean Mondayyear (latent)", -5.607638614103299),
                                    ("monthhour", -5.607638614103299),
                                    ("hourmonth", -4.914491433543353),
                                    ("todayat <time-of-day>", -5.607638614103299),
                                    ("from|since|after <time-of-day>July", -5.607638614103299),
                                    ("Mondayyear (latent)", -4.914491433543353),
                                    ("dayday", -5.202173505995134),
                                    ("mm/ddat <time-of-day>", -5.202173505995134),
                                    ("<time-of-day> am|pmon <date>", -4.3548756456079305),
                                    ("dayyear", -2.7454377331738304),
                                    ("Thursdaymm/dd", -5.607638614103299),
                                    ("New Year's Dayyear (latent)", -5.202173505995134),
                                    ("Thursdayat <time-of-day>", -4.3548756456079305),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.607638614103299),
                                    ("Aprilyear (latent)", -5.607638614103299),
                                    ("monthminute", -5.607638614103299),
                                    ("<time-of-day> am|pmtomorrow", -5.607638614103299),
                                    ("Thursdayhh:mm", -4.6913478822291435),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.607638614103299),
                                    ("minutemonth", -3.8158791448752436),
                                    ("Sundayfrom|since|after <time-of-day>", -5.607638614103299),
                                    ("week-endin <named-month>|year", -5.607638614103299),
                                    ("Augustyear (latent)", -5.202173505995134),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.202173505995134),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.202173505995134),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.607638614103299),
                                    ("Sundayyear (latent)", -4.914491433543353),
                                    ("Christmasat <time-of-day>", -5.607638614103299),
                                    ("<duration> after|before|from <time>December",
                                     -5.607638614103299),
                                    ("yesterday<time-of-day> am|pm", -5.607638614103299),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.6913478822291435),
                                    ("mm/ddyear (latent)", -5.607638614103299),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.202173505995134),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.607638614103299),
                                    ("until <time-of-day>on <date>", -4.914491433543353),
                                    ("at <time-of-day>intersect", -5.202173505995134),
                                    ("hh:mmyear (latent)", -4.509026325435189),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.607638614103299),
                                    ("dayminute", -3.122731964315298),
                                    ("intersectSeptember", -4.103561217327025),
                                    ("minuteday", -2.5395856789696816),
                                    ("absorption of , after named dayintersect",
                                     -5.607638614103299),
                                    ("Februaryin|during the <part-of-day>", -5.607638614103299),
                                    ("hh:mmon <date>", -3.592735593561034),
                                    ("Saturdayyear (latent)", -5.607638614103299),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.607638614103299),
                                    ("absorption of , after named daySeptember",
                                     -4.6913478822291435),
                                    ("Naraka Chaturdashiyear (latent)", -5.607638614103299),
                                    ("on <date>September", -5.202173505995134),
                                    ("at <time-of-day>on <date>", -5.202173505995134),
                                    ("in <named-month>|yearyear (latent)", -5.607638614103299),
                                    ("dayweek", -5.607638614103299),
                                    ("Easter Sundayyear (latent)", -5.202173505995134),
                                    ("Thursday<time-of-day> am|pm", -5.202173505995134),
                                    ...
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.607638614103299),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.9982007016691985),
                                    ("tomorrow<time-of-day> am|pm", -5.607638614103299),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.914491433543353),
                                    ("Diwaliyear (latent)", -5.202173505995134),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.607638614103299),
                                    ("Fridayyear (latent)", -5.202173505995134),
                                    ("minuteyear", -4.3548756456079305)],
                               n = 174}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1778869597260889, unseen = -4.770684624465665,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -5.264373348542203e-2),
                                    ("intersect 2 numbers", -3.3758795736778655)],
                               n = 113},
                   koData =
                     ClassData{prior = -1.8142323250801136, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
