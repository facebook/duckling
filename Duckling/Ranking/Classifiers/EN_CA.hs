...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.627189212768148, unseen = -5.648974238161206,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 282},
                   koData =
                     ClassData{prior = -0.7637647477738987,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4505224936739131,
                               unseen = -6.7226297948554485,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.028278520230698),
                                    ("Father's Dayyear (latent)", -6.028278520230698),
                                    ("Ramadanyear (latent)", -6.028278520230698),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.775515551735331),
                                    ("Bhai Doojyear (latent)", -6.028278520230698),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.775515551735331),
                                    ("hourday", -4.3235304279922735),
                                    ("dayhour", -3.110507788146419),
                                    ("Martin Luther King's Dayyear (latent)", -5.622813412122534),
                                    ("Shemini Atzeretyear (latent)", -6.028278520230698),
                                    ("daymonth", -5.3351313396707525),
                                    ("monthday", -5.622813412122534),
                                    ("monthyear", -4.418840607796598),
                                    ("Yom Ha'atzmautyear (latent)", -6.028278520230698),
                                    ("Vijayadashamiyear (latent)", -6.028278520230698),
                                    ("Thanksgiving Dayyear (latent)", -4.929666231562589),
                                    ("Thai Pongalyear (latent)", -5.3351313396707525),
                                    ("Thiru Onamyear (latent)", -5.3351313396707525),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.028278520230698),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.028278520230698),
                                    ("houryear", -5.3351313396707525),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.028278520230698),
                                    ("Christmas<time-of-day> am|pm", -6.028278520230698),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.028278520230698),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.3351313396707525),
                                    ("<time-of-day> am|pmintersect", -4.775515551735331),
                                    ("Family Dayyear (latent)", -5.111987788356543),
                                    ("Octoberyear (latent)", -4.775515551735331),
                                    ("intersect<time-of-day> am|pm", -6.028278520230698),
                                    ("Mattu Pongalyear (latent)", -6.028278520230698),
                                    ("Shavuotyear (latent)", -6.028278520230698),
                                    ("Dhanterasin <named-month>|year", -6.028278520230698),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.028278520230698),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.028278520230698),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.622813412122534),
                                    ("Marchyear (latent)", -6.028278520230698),
                                    ("Sukkotyear (latent)", -5.622813412122534),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.028278520230698),
                                    ("Clean Mondayyear (latent)", -5.622813412122534),
                                    ("monthhour", -5.622813412122534),
                                    ("todayat <time-of-day>", -6.028278520230698),
                                    ("Thursday<time> timezone", -4.3235304279922735),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.028278520230698),
                                    ("Palm SundaySunday", -5.622813412122534),
                                    ("dayday", -3.8310539428944788),
                                    ("<time> <part-of-day>at <time-of-day>", -6.028278520230698),
                                    ("mm/ddat <time-of-day>", -6.028278520230698),
                                    ("tonightat <time-of-day>", -6.028278520230698),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.3351313396707525),
                                    ("today<time-of-day> am|pm", -6.028278520230698),
                                    ("Februarythe <day-of-month> (ordinal)", -5.622813412122534),
                                    ("at <time-of-day><time> <part-of-day>", -6.028278520230698),
                                    ("mm/dd<time-of-day> am|pm", -6.028278520230698),
                                    ("hourhour", -4.775515551735331),
                                    ("<time-of-day> am|pmon <date>", -4.013375499688434),
                                    ("National Patriots' Dayyear (latent)", -5.3351313396707525),
                                    ("Wednesdaythis|last|next <cycle>", -6.028278520230698),
                                    ("Lentyear (latent)", -6.028278520230698),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.524201123454424),
                                    ("Boghiyear (latent)", -6.028278520230698),
                                    ("dayyear", -1.9764935724273935),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.028278520230698),
                                    ("Thursdayat <time-of-day>", -5.622813412122534),
                                    ("Islamic New Yearyear (latent)", -5.622813412122534),
                                    ("Laylat al-Qadryear (latent)", -5.111987788356543),
                                    ("Chhathin <named-month>|year", -6.028278520230698),
                                    ("Diwaliin <named-month>|year", -6.028278520230698),
                                    ("Discovery Dayyear (latent)", -5.622813412122534),
                                    ("Shrove Tuesdayyear (latent)", -6.028278520230698),
                                    ("<time-of-day> am|pmtomorrow", -5.3351313396707525),
                                    ("Yom Kippuryear (latent)", -6.028278520230698),
                                    ("<part-of-day> of <time>year (latent)", -6.028278520230698),
                                    ("minutehour", -5.111987788356543),
                                    ("Kaanum Pongalyear (latent)", -5.622813412122534),
                                    ("Maha Saptamiyear (latent)", -6.028278520230698),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.622813412122534),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.3235304279922735),
                                    ("for <duration> from <time>December", -6.028278520230698),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.028278520230698),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.111987788356543),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.622813412122534),
                                    ("Pentecostyear (latent)", -6.028278520230698),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.111987788356543),
                                    ("Eid al-Fitryear (latent)", -6.028278520230698),
                                    ("Mondayin|during the <part-of-day>", -6.028278520230698),
                                    ("Raksha Bandhanyear (latent)", -6.028278520230698),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.622813412122534),
                                    ("Navaratriin <named-month>|year", -6.028278520230698),
                                    ("Ashurayear (latent)", -6.028278520230698),
                                    ("Chinese New Yearyear (latent)", -6.028278520230698),
                                    ("Sundayyear (latent)", -6.028278520230698),
                                    ("Lag BaOmeryear (latent)", -6.028278520230698),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.028278520230698),
                                    ("Eid al-Adhayear (latent)", -5.111987788356543),
                                    ("intersectin|during the <part-of-day>", -6.028278520230698),
                                    ("Christmasat <time-of-day>", -6.028278520230698),
                                    ("Passoveryear (latent)", -6.028278520230698),
                                    ("Lazarus Saturdayyear (latent)", -6.028278520230698),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.028278520230698),
                                    ("Yom HaShoahyear (latent)", -5.622813412122534),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.111987788356543),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.028278520230698),
                                    ("Thai Pongalin <named-month>|year", -6.028278520230698),
                                    ("Septemberyear (latent)", -5.622813412122534),
                                    ("mm/ddyear (latent)", -6.028278520230698),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.775515551735331),
                                    ("Halloweenyear (latent)", -6.028278520230698),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.3351313396707525),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -5.111987788356543),
                                    ("at <time-of-day>intersect", -5.622813412122534),
                                    ("Rosh Hashanahyear (latent)", -6.028278520230698),
                                    ("Dhanterasyear (latent)", -6.028278520230698),
                                    ("Tu BiShvatyear (latent)", -6.028278520230698),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.028278520230698),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.028278520230698),
                                    ("dayminute", -3.3892211906154395),
                                    ("Mawlidyear (latent)", -6.028278520230698),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.622813412122534),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.028278520230698),
                                    ("Jumu'atul-Widayear (latent)", -5.111987788356543),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.028278520230698),
                                    ("minuteday", -2.3906923605043127),
                                    ("absorption of , after named dayintersect",
                                     -6.028278520230698),
                                    ("intersectyear (latent)", -6.028278520230698),
                                    ("Orthodox Easter Sundayyear (latent)", -6.028278520230698),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.028278520230698),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.028278520230698),
                                    ("Boss's Dayyear (latent)", -5.622813412122534),
                                    ("Tisha B'Avyear (latent)", -6.028278520230698),
                                    ("Isra and Mi'rajyear (latent)", -5.111987788356543),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.028278520230698),
                                    ("Christmasyear (latent)", -5.622813412122534),
                                    ("Naraka Chaturdashiyear (latent)", -5.622813412122534),
                                    ("at <time-of-day>on <date>", -4.929666231562589),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.418840607796598),
                                    ("dayweek", -6.028278520230698),
                                    ("Easter Sundayyear (latent)", -5.3351313396707525),
                                    ("Thursday<time-of-day> am|pm", -6.028278520230698),
                                    ("Labour Dayyear (latent)", -6.028278520230698),
                                    ("weekyear", -5.622813412122534),
                                    ("hh:mmin|during the <part-of-day>", -5.3351313396707525),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.622813412122534),
                                    ("Hanukkahyear (latent)", -6.028278520230698),
                                    ("February<time> <part-of-day>", -6.028278520230698),
                                    ("Tuesdayin <named-month>|year", -6.028278520230698),
                                    ("Great Lentyear (latent)", -6.028278520230698),
                                    ("tomorrowat <time-of-day>", -5.3351313396707525),
                                    ("between <time> and <time>on <date>", -4.418840607796598),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.3351313396707525),
                                    ("last <cycle> of <time>year (latent)", -5.3351313396707525),
                                    ("at <time-of-day>tomorrow", -5.622813412122534),
                                    ("tomorrow<time-of-day> am|pm", -6.028278520230698),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.028278520230698),
                                    ("Diwaliyear (latent)", -6.028278520230698),
                                    ("Black Fridayyear (latent)", -5.622813412122534),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.028278520230698),
                                    ("Chhathyear (latent)", -5.622813412122534),
                                    ("Palm Sundayintersect", -6.028278520230698),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.028278520230698),
                                    ("Februaryintersect", -6.028278520230698),
                                    ("Mother's Dayyear (latent)", -6.028278520230698),
                                    ("Simchat Torahyear (latent)", -6.028278520230698),
                                    ("Victoria Dayyear (latent)", -5.622813412122534)],
                               n = 311},
                   koData =
                     ClassData{prior = -1.014165673279318, unseen = -6.333279628139691,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.638354669333745),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.638354669333745),
                                    ("dayhour", -3.1960076339645416),
                                    ("daymonth", -3.55891312765391),
                                    ("monthday", -5.232889561225582),
                                    ("monthyear", -4.385591700838377),
                                    ("<time-of-day> am|pmyear (latent)", -5.232889561225582),
                                    ("Thai Pongalyear (latent)", -4.945207488773801),
                                    ("intersecthh:mm", -5.638354669333745),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.638354669333745),
                                    ("houryear", -4.72206393745959),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.638354669333745),
                                    ("until <time-of-day><time-of-day> am|pm", -5.638354669333745),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.945207488773801),
                                    ("<time-of-day> am|pmintersect", -4.385591700838377),
                                    ("Octoberyear (latent)", -5.638354669333745),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.385591700838377),
                                    ("from|since|after <time-of-day>on <date>", -4.72206393745959),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.638354669333745),
                                    ("absorption of , after named dayJuly", -5.232889561225582),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.72206393745959),
                                    ("Clean Mondayyear (latent)", -5.638354669333745),
                                    ("monthhour", -5.638354669333745),
                                    ("hourmonth", -4.945207488773801),
                                    ("todayat <time-of-day>", -5.638354669333745),
                                    ("from|since|after <time-of-day>July", -5.638354669333745),
                                    ("Mondayyear (latent)", -4.945207488773801),
                                    ("dayday", -5.232889561225582),
                                    ("mm/ddat <time-of-day>", -5.232889561225582),
                                    ("<time-of-day> am|pmon <date>", -4.385591700838377),
                                    ("dayyear", -2.693915690167305),
                                    ("Thursdaymm/dd", -5.638354669333745),
                                    ("New Year's Dayyear (latent)", -5.232889561225582),
                                    ("Thursdayat <time-of-day>", -4.385591700838377),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.638354669333745),
                                    ("Aprilyear (latent)", -5.638354669333745),
                                    ("monthminute", -5.638354669333745),
                                    ("<time-of-day> am|pmtomorrow", -5.638354669333745),
                                    ("Thursdayhh:mm", -4.72206393745959),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.638354669333745),
                                    ("minutemonth", -3.846595200105691),
                                    ("Sundayfrom|since|after <time-of-day>", -5.638354669333745),
                                    ("week-endin <named-month>|year", -5.638354669333745),
                                    ("Augustyear (latent)", -5.232889561225582),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.232889561225582),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.232889561225582),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.638354669333745),
                                    ("Sundayyear (latent)", -4.945207488773801),
                                    ("Christmasat <time-of-day>", -5.638354669333745),
                                    ("<duration> after|before|from <time>December",
                                     -5.638354669333745),
                                    ("yesterday<time-of-day> am|pm", -5.638354669333745),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.72206393745959),
                                    ("mm/ddyear (latent)", -5.638354669333745),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.232889561225582),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.638354669333745),
                                    ("until <time-of-day>on <date>", -4.945207488773801),
                                    ("at <time-of-day>intersect", -5.232889561225582),
                                    ("hh:mmyear (latent)", -4.539742380665636),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.638354669333745),
                                    ("dayminute", -3.1534480195457455),
                                    ("intersectSeptember", -4.134277272557472),
                                    ("minuteday", -2.5703017342001284),
                                    ("absorption of , after named dayintersect",
                                     -5.638354669333745),
                                    ("Februaryin|during the <part-of-day>", -5.638354669333745),
                                    ("hh:mmon <date>", -3.623451648791481),
                                    ("Saturdayyear (latent)", -5.638354669333745),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.638354669333745),
                                    ("absorption of , after named daySeptember", -4.72206393745959),
                                    ("Naraka Chaturdashiyear (latent)", -5.638354669333745),
                                    ("on <date>September", -5.232889561225582),
                                    ("at <time-of-day>on <date>", -5.232889561225582),
                                    ("in <named-month>|yearyear (latent)", -5.638354669333745),
                                    ("dayweek", -5.638354669333745),
                                    ("Easter Sundayyear (latent)", -5.232889561225582),
                                    ("Thursday<time-of-day> am|pm", -5.232889561225582),
                                    ("absorption of , after named dayFebruary", -4.72206393745959),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.638354669333745),
                                    ("tomorrowat <time-of-day>", -5.638354669333745),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.638354669333745),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.028916756899645),
                                    ("tomorrow<time-of-day> am|pm", -5.638354669333745),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.945207488773801),
                                    ("Diwaliyear (latent)", -5.232889561225582),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.638354669333745),
                                    ("Fridayyear (latent)", -5.232889561225582),
                                    ("minuteyear", -4.385591700838377)],
                               n = 177}}),
       ("one eleven",
        Classifier{okData =
