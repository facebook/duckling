...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4802090103310123, unseen = -7.216709486709457,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.522827822091521),
                                    ("Father's Dayyear (latent)", -6.522827822091521),
                                    ("Karva Chauthyear (latent)", -6.522827822091521),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.522827822091521),
                                    ("Maha Shivaratriyear (latent)", -6.522827822091521),
                                    ("Ramadanyear (latent)", -5.2700648535961525),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.13653346097163),
                                    ("Bhai Doojyear (latent)", -6.522827822091521),
                                    ("hourday", -4.507924801549256),
                                    ("dayhour", -3.5024029359471585),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.13653346097163),
                                    ("Martin Luther King's Dayyear (latent)", -6.117362713983356),
                                    ("Shemini Atzeretyear (latent)", -6.522827822091521),
                                    ("daymonth", -4.507924801549256),
                                    ("monthday", -6.117362713983356),
                                    ("monthyear", -4.731068352863466),
                                    ("Yom Ha'atzmautyear (latent)", -6.522827822091521),
                                    ("Orthodox Good Fridayyear (latent)", -6.117362713983356),
                                    ("Vijayadashamiyear (latent)", -6.522827822091521),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -6.117362713983356),
                                    ("Thanksgiving Dayyear (latent)", -5.4242155334234115),
                                    ("Thai Pongalyear (latent)", -5.829680641531575),
                                    ("Thiru Onamyear (latent)", -5.829680641531575),
                                    ("hhhmmabsorption of , after named day", -6.522827822091521),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.522827822091521),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.6065370902173655),
                                    ("<day-of-month> (ordinal)Wednesday", -6.522827822091521),
                                    ("Krishna Janmashtamiyear (latent)", -6.117362713983356),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.522827822091521),
                                    ("houryear", -5.6065370902173655),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.522827822091521),
                                    ("Christmas<time-of-day> am|pm", -6.522827822091521),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.522827822091521),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.829680641531575),
                                    ("intersectin|during <named-month>|year", -6.522827822091521),
                                    ("<time-of-day> am|pmintersect", -5.2700648535961525),
                                    ("Earth Houryear (latent)", -6.522827822091521),
                                    ("Ganesh Chaturthiyear (latent)", -6.522827822091521),
                                    ("Family Dayyear (latent)", -5.6065370902173655),
                                    ("Octoberyear (latent)", -5.018750425315247),
                                    ("intersect<time-of-day> am|pm", -6.522827822091521),
                                    ("Mattu Pongalyear (latent)", -6.522827822091521),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.522827822091521),
                                    ("Shavuotyear (latent)", -6.522827822091521),
                                    ("Parsi New Yearyear (latent)", -5.6065370902173655),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.522827822091521),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.522827822091521),
                                    ("todayin|within|after <duration>", -6.522827822091521),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.117362713983356),
                                    ("Marchyear (latent)", -6.522827822091521),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.117362713983356),
                                    ("Sukkotyear (latent)", -6.117362713983356),
                                    ("hhhmmintersect", -6.117362713983356),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.117362713983356),
                                    ("Clean Mondayyear (latent)", -6.117362713983356),
                                    ("monthhour", -6.117362713983356),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.6065370902173655),
                                    ("todayat <time-of-day>", -6.522827822091521),
                                    ("Thursday<time> timezone", -4.12493254929315),
                                    ("tonight<time-of-day> am|pm", -6.522827822091521),
                                    ("time-of-day (latent)tonight", -6.117362713983356),
                                    ("from|since|after <time>December", -6.522827822091521),
                                    ("<time-of-day> am|pmon <day>", -4.507924801549256),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.522827822091521),
                                    ("yyyy-mm-ddhh:mm:ss", -6.117362713983356),
                                    ("dayday", -3.7502390998517394),
                                    ("<time> <part-of-day>at <time-of-day>", -6.117362713983356),
                                    ("mm/ddat <time-of-day>", -6.522827822091521),
                                    ("tonightat <time-of-day>", -5.4242155334234115),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.829680641531575),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.522827822091521),
                                    ("today<time-of-day> am|pm", -6.522827822091521),
                                    ("Februarythe <day-of-month> (ordinal)", -6.117362713983356),
                                    ("at <time-of-day><time> <part-of-day>", -6.522827822091521),
                                    ("<day-of-month> (ordinal)intersect", -6.117362713983356),
                                    ("mm/dd<time-of-day> am|pm", -6.522827822091521),
                                    ("hourhour", -3.5524133565218197),
                                    ("Mahavir Jayantiyear (latent)", -6.117362713983356),
                                    ("Navaratriin|during <named-month>|year", -6.522827822091521),
                                    ("National Patriots' Dayyear (latent)", -5.829680641531575),
                                    ("Wednesdaythis|last|next <cycle>", -6.522827822091521),
                                    ("Lentyear (latent)", -6.522827822091521),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.65102564518993),
                                    ("Boghiyear (latent)", -6.522827822091521),
                                    ("dayyear", -1.8593887279794536),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.522827822091521),
                                    ("Thursdayfrom|since|after <time>", -6.117362713983356),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.522827822091521),
                                    ("Thursdayat <time-of-day>", -5.829680641531575),
                                    ("Islamic New Yearyear (latent)", -6.117362713983356),
                                    ("Laylat al-Qadryear (latent)", -5.6065370902173655),
                                    ("part of days<time-of-day> am|pm", -6.522827822091521),
                                    ("Discovery Dayyear (latent)", -6.117362713983356),
                                    ("Shrove Tuesdayyear (latent)", -6.522827822091521),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.829680641531575),
                                    ("hourminute", -6.117362713983356),
                                    ("<time-of-day> am|pmtomorrow", -5.6065370902173655),
                                    ("Yom Kippuryear (latent)", -6.522827822091521),
                                    ("<day-of-month> (ordinal)Tuesday", -5.829680641531575),
                                    ("<part-of-day> of <time>year (latent)", -6.522827822091521),
                                    ("minutehour", -5.2700648535961525),
                                    ("Kaanum Pongalyear (latent)", -6.117362713983356),
                                    ("Maha Saptamiyear (latent)", -6.522827822091521),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.829680641531575),
                                    ("time-of-day (latent)tomorrow", -5.6065370902173655),
                                    ("part of daysat <time-of-day>", -4.91338990965742),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.507924801549256),
                                    ("for <duration> from <time>December", -6.522827822091521),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.522827822091521),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.2700648535961525),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.2700648535961525),
                                    ("time-of-day (latent)this <part-of-day>", -6.522827822091521),
                                    ("Pentecostyear (latent)", -6.522827822091521),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.2700648535961525),
                                    ("<day-of-month> (ordinal)February", -6.522827822091521),
                                    ("Eid al-Fitryear (latent)", -5.13653346097163),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.522827822091521),
                                    ("Mondayin|during the <part-of-day>", -6.522827822091521),
                                    ("Chhathin|during <named-month>|year", -6.522827822091521),
                                    ("Diwaliin|during <named-month>|year", -6.522827822091521),
                                    ("this <part-of-day><time-of-day> am|pm", -6.522827822091521),
                                    ("Vaisakhiin|during <named-month>|year", -6.522827822091521),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.2700648535961525),
                                    ("Raksha Bandhanyear (latent)", -6.522827822091521),
                                    ("daysecond", -6.117362713983356),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.117362713983356),
                                    ("Ratha-Yatrayear (latent)", -6.522827822091521),
                                    ("Ashurayear (latent)", -6.522827822091521),
                                    ("Tuesdayin|during <named-month>|year", -6.522827822091521),
                                    ("Chinese New Yearyear (latent)", -6.522827822091521),
                                    ("tomorrowintersect", -6.522827822091521),
                                    ("Lag BaOmeryear (latent)", -6.522827822091521),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.522827822091521),
                                    ("Eid al-Adhayear (latent)", -4.38276165859525),
                                    ("intersectin|during the <part-of-day>", -6.522827822091521),
                                    ("Palm Sundayyear (latent)", -6.522827822091521),
                                    ("Christmasat <time-of-day>", -6.522827822091521),
                                    ("Passoveryear (latent)", -6.522827822091521),
                                    ("Lazarus Saturdayyear (latent)", -6.522827822091521),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.522827822091521),
                                    ("hhhmmon <day>", -5.6065370902173655),
                                    ("Yom HaShoahyear (latent)", -6.117362713983356),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.117362713983356),
                                    ("Septemberyear (latent)", -6.117362713983356),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.018750425315247),
                                    ("Halloweenyear (latent)", -6.522827822091521),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.522827822091521),
                                    ("at <time-of-day>intersect", -5.6065370902173655),
                                    ("Rosh Hashanahyear (latent)", -5.829680641531575),
                                    ("Dhanterasyear (latent)", -6.522827822091521),
                                    ("Tu BiShvatyear (latent)", -6.522827822091521),
                                    ("<day-of-month> (ordinal)December", -5.829680641531575),
                                    ("Holiyear (latent)", -5.829680641531575),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.522827822091521),
                                    ("Holika Dahanyear (latent)", -5.829680641531575),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.117362713983356),
                                    ("dayminute", -3.172923734816916),
                                    ("Mawlidyear (latent)", -6.522827822091521),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.117362713983356),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.522827822091521),
                                    ("Jumu'atul-Widayear (latent)", -5.6065370902173655),
                                    ("minuteday", -2.7733237461611497),
                                    ("absorption of , after named dayintersect",
                                     -5.829680641531575),
                                    ("intersectyear (latent)", -6.522827822091521),
                                    ("Orthodox Easter Sundayyear (latent)", -6.522827822091521),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.522827822091521),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.522827822091521),
                                    ("intersecthhhmm", -6.117362713983356),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.522827822091521),
                                    ("Boss's Dayyear (latent)", -6.117362713983356),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.522827822091521),
                                    ("Global Youth Service Dayyear (latent)", -6.522827822091521),
                                    ("Dhanterasin|during <named-month>|year", -6.522827822091521),
                                    ("tonight<time-of-day> o'clock", -6.522827822091521),
                                    ("Tisha B'Avyear (latent)", -6.522827822091521),
                                    ("Isra and Mi'rajyear (latent)", -5.6065370902173655),
                                    ("at <time-of-day>on <day>", -4.91338990965742),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.117362713983356),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.829680641531575),
                                    ("Christmasyear (latent)", -6.117362713983356),
                                    ("Saturdayintersect", -6.522827822091521),
                                    ("Naraka Chaturdashiyear (latent)", -6.117362713983356),
                                    ("Thai Pongalin|during <named-month>|year", -6.522827822091521),
                                    ("dayweek", -6.522827822091521),
                                    ("Easter Sundayyear (latent)", -5.829680641531575),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.117362713983356),
                                    ("Labour Dayyear (latent)", -6.522827822091521),
                                    ("weekyear", -5.4242155334234115),
                                    ("King's Dayyear (latent)", -5.018750425315247),
                                    ("hh:mmin|during the <part-of-day>", -5.6065370902173655),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.117362713983356),
                                    ("first|second|third|fourth|fifth <day-of-week> of <time>year (latent)",
                                     -5.829680641531575),
                                    ("Hanukkahyear (latent)", -5.829680641531575),
                                    ("Rama Navamiyear (latent)", -6.522827822091521),
                                    ("February<time> <part-of-day>", -6.522827822091521),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.829680641531575),
                                    ("Great Lentyear (latent)", -6.522827822091521),
                                    ("tomorrowat <time-of-day>", -5.829680641531575),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.522827822091521),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.117362713983356),
                                    ("Ugadiyear (latent)", -5.13653346097163),
                                    ("Vaisakhiyear (latent)", -5.829680641531575),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.829680641531575),
                                    ("last <cycle> of <time>year (latent)", -5.829680641531575),
                                    ("at <time-of-day>tomorrow", -6.117362713983356),
                                    ("tomorrow<time-of-day> am|pm", -6.522827822091521),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.522827822091521),
                                    ("Diwaliyear (latent)", -6.522827822091521),
                                    ("between <time> and <time>on <day>", -6.117362713983356),
                                    ("Black Fridayyear (latent)", -6.117362713983356),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.522827822091521),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.522827822091521),
                                    ("Chhathyear (latent)", -6.117362713983356),
                                    ("Vasant Panchamiyear (latent)", -6.522827822091521),
                                    ("Rabindra Jayantiyear (latent)", -5.2700648535961525),
                                    ("this <part-of-day>at <time-of-day>", -5.2700648535961525),
                                    ("St Patrick's Dayyear (latent)", -6.522827822091521),
                                    ("Thursday<time> (timezone)", -6.522827822091521),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.522827822091521),
                                    ("Pargat Diwasyear (latent)", -5.2700648535961525),
                                    ("<datetime> - <datetime> (interval)July", -6.117362713983356),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.829680641531575),
                                    ("Februaryintersect", -6.522827822091521),
                                    ("Mother's Dayyear (latent)", -6.522827822091521),
                                    ("Simchat Torahyear (latent)", -6.522827822091521),
                                    ("Victoria Dayyear (latent)", -6.117362713983356),
                                    ("minuteyear", -6.522827822091521)],
                               n = 524},
                   koData =
                     ClassData{prior = -0.9640483714293979, unseen = -6.866933284461882,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.6686664975472185),
                                    ("hourday", -3.570054208879109),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.172743894323493),
                                    ("<day-of-month> (ordinal)August", -6.172743894323493),
                                    ("dayhour", -3.498595244896964),
                                    ("<time> timezoneyear (latent)", -5.479596713763548),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.256453162449338),
                                    ("Tuesdayfrom|since|after <time>", -5.479596713763548),
                                    ("daymonth", -3.4646936932212826),
                                    ("hourquarter", -5.256453162449338),
                                    ("monthyear", -4.919980925828125),
                                    ("<time-of-day> am|pmyear (latent)", -5.479596713763548),
                                    ("Thai Pongalyear (latent)", -5.479596713763548),
                                    ("intersecthh:mm", -6.172743894323493),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.7672787862153285),
                                    ("<day-of-month> (ordinal)Wednesday", -6.172743894323493),
                                    ("houryear", -4.380984425095438),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.172743894323493),
                                    ("<day-of-month> (ordinal)October", -6.172743894323493),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.479596713763548),
                                    ("hournograin", -4.919980925828125),
                                    ("<time-of-day> am|pmintersect", -4.919980925828125),
                                    ("Octoberyear (latent)", -6.172743894323493),
                                    ("Good Fridayyear (latent)", -5.7672787862153285),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7672787862153285),
                                    ("early morningat <time-of-day>", -6.172743894323493),
                                    ("until <time>on <day>", -5.479596713763548),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.172743894323493),
                                    ("time-of-day (latent)intersect", -5.479596713763548),
                                    ("todayin <number> (implicit minutes)", -6.172743894323493),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.479596713763548),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.172743894323493),
                                    ("hh:mmon <day>", -4.919980925828125),
                                    ("hhhmmintersect", -5.7672787862153285),
                                    ("absorption of , after named dayJuly", -5.256453162449338),
                                    ("from|since|after <time>July", -5.7672787862153285),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.256453162449338),
                                    ("Clean Mondayyear (latent)", -6.172743894323493),
                                    ("monthhour", -6.172743894323493),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7672787862153285),
                                    ("hourmonth", -4.032677730827222),
                                    ("todayat <time-of-day>", -6.172743894323493),
                                    ("hhhmmyear (latent)", -4.919980925828125),
                                    ("from|since|after <time>December", -6.172743894323493),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.172743894323493),
                                    ("<time-of-day> am|pmon <day>", -4.919980925828125),
                                    ("Mondayyear (latent)", -5.479596713763548),
                                    ("dayday", -4.032677730827222),
                                    ("mm/ddat <time-of-day>", -5.7672787862153285),
                                    ("on <day>September", -5.479596713763548),
                                    ("time-of-day (latent)September", -5.7672787862153285),
                                    ("hourhour", -4.093302352643657),
                                    ("time-of-day (latent)on <day>", -4.6686664975472185),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.7672787862153285),
                                    ("dayyear", -3.1282214566000697),
                                    ("Thursdaymm/dd", -6.172743894323493),
                                    ("New Year's Dayyear (latent)", -5.256453162449338),
                                    ("time-of-day (latent)Sunday", -5.7672787862153285),
                                    ("Thursdayfrom|since|after <time>", -4.467995802085068),
                                    ("Thursdayat <time-of-day>", -4.563305981889393),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.172743894323493),
                                    ("Aprilyear (latent)", -6.172743894323493),
                                    ("the <day-of-month> (ordinal)July", -6.172743894323493),
                                    ("the <day-of-month> (number)July", -6.172743894323493),
                                    ("monthminute", -6.172743894323493),
                                    ("<time-of-day> am|pmtomorrow", -5.7672787862153285),
                                    ("Thursdayhh:mm", -5.256453162449338),
                                    ("<day-of-month> (ordinal)Tuesday", -5.7672787862153285),
                                    ("minutemonth", -4.032677730827222),
                                    ("time-of-day (latent)Friday", -5.7672787862153285),
                                    ("minutehour", -6.172743894323493),
                                    ("part of daysat <time-of-day>", -5.074131605655383),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.821368637160015),
                                    ("Augustyear (latent)", -5.7672787862153285),
                                    ("week-endin|during <named-month>|year", -6.172743894323493),
                                    ("time-of-day (latent)Tuesday", -5.7672787862153285),
                                    ...
                                    ("hourweek", -5.256453162449338),
                                    ("the <day-of-month> (ordinal)Monday", -5.479596713763548),
                                    ("Christmasat <time-of-day>", -6.172743894323493),
                                    ("from|since|after <time>year (latent)", -5.074131605655383),
                                    ("hhhmmon <day>", -5.256453162449338),
                                    ("yesterday<time-of-day> am|pm", -6.172743894323493),
                                    ("<day-of-month> (ordinal)July", -5.479596713763548),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.172743894323493),
                                    ("mm/ddyear (latent)", -6.172743894323493),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.172743894323493),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.172743894323493),
                                    ("at <time-of-day>intersect", -5.256453162449338),
                                    ("hh:mmyear (latent)", -4.786449533203602),
                                    ("Holiyear (latent)", -6.172743894323493),
                                    ("until <time><time-of-day> am|pm", -6.172743894323493),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7672787862153285),
                                    ("dayminute", -3.3105430133940246),
                                    ("yyyy-mm-ddhh:mm", -5.7672787862153285),
                                    ("intersectfrom|since|after <time>", -5.7672787862153285),
                                    ("intersectSeptember", -4.300941717421901),
                                    ("minuteday", -3.0157434731733797),
                                    ("absorption of , after named dayintersect",
                                     -6.172743894323493),
                                    ("intersectyear (latent)", -6.172743894323493),
                                    ("Februaryin|during the <part-of-day>", -6.172743894323493),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.172743894323493),
                                    ("time-of-day (latent)July", -5.479596713763548),
                                    ("Saturdayyear (latent)", -6.172743894323493),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.172743894323493),
                                    ("<day-of-month> (ordinal)Monday", -4.919980925828125),
                                    ("at <time-of-day>on <day>", -5.256453162449338),
                                    ("absorption of , after named daySeptember",
                                     -4.919980925828125),
                                    ("Naraka Chaturdashiyear (latent)", -6.172743894323493),
                                    ("from|since|after <time>on <day>", -5.256453162449338),
                                    ("dayweek", -6.172743894323493),
                                    ("Easter Sundayyear (latent)", -5.7672787862153285),
                                    ("Thursday<time-of-day> am|pm", -4.919980925828125),
                                    ("weekyear", -5.7672787862153285),
                                    ("time-of-day (latent)Thursday", -5.7672787862153285),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.479596713763548),
                                    ("Sundayfrom|since|after <time>", -6.172743894323493),
                                    ("absorption of , after named dayFebruary", -5.256453162449338),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.7672787862153285),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.172743894323493),
                                    ("tomorrowat <time-of-day>", -6.172743894323493),
                                    ("daynograin", -5.7672787862153285),
                                    ...
                                    ("tomorrow<time-of-day> am|pm", -6.172743894323493),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.479596713763548),
                                    ("Diwaliyear (latent)", -5.7672787862153285),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.172743894323493),
                                    ("this <part-of-day>at <time-of-day>", -5.256453162449338),
                                    ("Fridayyear (latent)", -5.256453162449338),
                                    ("time-of-day (latent)April", -6.172743894323493),
                                    ("minuteyear", -3.9755193169872736)],
                               n = 323}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
