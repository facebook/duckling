...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6471309432732385, unseen = -5.940171252720432,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 378},
                   koData =
                     ClassData{prior = -0.7413834815194279, unseen = -5.846438775057725,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48643417064183153,
                               unseen = -6.996681488176539,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.302618975744905),
                                    ("Father's Dayyear (latent)", -6.302618975744905),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.302618975744905),
                                    ("Ramadanyear (latent)", -5.38632824387075),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.28771595520264),
                                    ("Bhai Doojyear (latent)", -6.302618975744905),
                                    ("hourday", -4.28771595520264), ("dayhour", -3.384848243660626),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.28771595520264),
                                    ("Martin Luther King's Dayyear (latent)", -5.8971538676367405),
                                    ("Shemini Atzeretyear (latent)", -6.302618975744905),
                                    ("daymonth", -4.28771595520264),
                                    ("monthday", -5.8971538676367405),
                                    ("monthyear", -4.51085950651685),
                                    ("Yom Ha'atzmautyear (latent)", -6.302618975744905),
                                    ("Vijayadashamiyear (latent)", -6.302618975744905),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.8971538676367405),
                                    ("Thanksgiving Dayyear (latent)", -5.204006687076795),
                                    ("Thai Pongalyear (latent)", -5.60947179518496),
                                    ("Thiru Onamyear (latent)", -5.60947179518496),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.302618975744905),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.38632824387075),
                                    ("<day-of-month> (ordinal)Wednesday", -6.302618975744905),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.302618975744905),
                                    ("houryear", -5.38632824387075),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.302618975744905),
                                    ("Christmas<time-of-day> am|pm", -6.302618975744905),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.302618975744905),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.60947179518496),
                                    ("intersectin|during <named-month>|year", -6.302618975744905),
                                    ("<time-of-day> am|pmintersect", -5.049856007249537),
                                    ("Earth Houryear (latent)", -6.302618975744905),
                                    ("Family Dayyear (latent)", -5.38632824387075),
                                    ("Octoberyear (latent)", -4.7985415789686305),
                                    ("intersect<time-of-day> am|pm", -6.302618975744905),
                                    ("Mattu Pongalyear (latent)", -6.302618975744905),
                                    ("Shavuotyear (latent)", -6.302618975744905),
                                    ("Parsi New Yearyear (latent)", -5.38632824387075),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.302618975744905),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.302618975744905),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.8971538676367405),
                                    ("Marchyear (latent)", -6.302618975744905),
                                    ("Sukkotyear (latent)", -5.8971538676367405),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.8971538676367405),
                                    ("Clean Mondayyear (latent)", -5.8971538676367405),
                                    ("monthhour", -5.8971538676367405),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.60947179518496),
                                    ("todayat <time-of-day>", -6.302618975744905),
                                    ("Thursday<time> timezone", -4.356708826689592),
                                    ("time-of-day (latent)tonight", -5.8971538676367405),
                                    ("from|since|after <time>December", -6.302618975744905),
                                    ("<time-of-day> am|pmon <day>", -4.28771595520264),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.302618975744905),
                                    ("yyyy-mm-ddhh:mm:ss", -5.8971538676367405),
                                    ("dayday", -3.8602719403757004),
                                    ("<time> <part-of-day>at <time-of-day>", -6.302618975744905),
                                    ("mm/ddat <time-of-day>", -6.302618975744905),
                                    ("tonightat <time-of-day>", -6.302618975744905),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.60947179518496),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.302618975744905),
                                    ("today<time-of-day> am|pm", -6.302618975744905),
                                    ("Februarythe <day-of-month> (ordinal)", -5.8971538676367405),
                                    ("at <time-of-day><time> <part-of-day>", -6.302618975744905),
                                    ("<day-of-month> (ordinal)intersect", -5.8971538676367405),
                                    ("mm/dd<time-of-day> am|pm", -6.302618975744905),
                                    ("hourhour", -4.223177434065069),
                                    ("Navaratriin|during <named-month>|year", -6.302618975744905),
                                    ("National Patriots' Dayyear (latent)", -5.60947179518496),
                                    ("Wednesdaythis|last|next <cycle>", -6.302618975744905),
                                    ("Lentyear (latent)", -6.302618975744905),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.7985415789686305),
                                    ("Boghiyear (latent)", -6.302618975744905),
                                    ("dayyear", -1.9523410393856038),
                                    ("Thursdayfrom|since|after <time>", -5.8971538676367405),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.302618975744905),
                                    ("Thursdayat <time-of-day>", -5.60947179518496),
                                    ("Islamic New Yearyear (latent)", -5.8971538676367405),
                                    ("Laylat al-Qadryear (latent)", -5.38632824387075),
                                    ("Discovery Dayyear (latent)", -5.8971538676367405),
                                    ("Shrove Tuesdayyear (latent)", -6.302618975744905),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.60947179518496),
                                    ("<time-of-day> am|pmtomorrow", -5.60947179518496),
                                    ("Yom Kippuryear (latent)", -6.302618975744905),
                                    ("<day-of-month> (ordinal)Tuesday", -5.8971538676367405),
                                    ("<part-of-day> of <time>year (latent)", -6.302618975744905),
                                    ("minutehour", -5.204006687076795),
                                    ("Kaanum Pongalyear (latent)", -5.8971538676367405),
                                    ("Maha Saptamiyear (latent)", -6.302618975744905),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.8971538676367405),
                                    ("time-of-day (latent)tomorrow", -5.38632824387075),
                                    ("part of daysat <time-of-day>", -5.8971538676367405),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.59787088350648),
                                    ("for <duration> from <time>December", -6.302618975744905),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.302618975744905),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.049856007249537),
                                    ("time-of-day (latent)this <part-of-day>", -6.302618975744905),
                                    ("Pentecostyear (latent)", -6.302618975744905),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.049856007249537),
                                    ("<day-of-month> (ordinal)February", -6.302618975744905),
                                    ("Eid al-Fitryear (latent)", -5.38632824387075),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.302618975744905),
                                    ("Mondayin|during the <part-of-day>", -6.302618975744905),
                                    ("Chhathin|during <named-month>|year", -6.302618975744905),
                                    ("Diwaliin|during <named-month>|year", -6.302618975744905),
                                    ("Vaisakhiin|during <named-month>|year", -6.302618975744905),
                                    ("Raksha Bandhanyear (latent)", -6.302618975744905),
                                    ("daysecond", -5.8971538676367405),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.8971538676367405),
                                    ("Ashurayear (latent)", -6.302618975744905),
                                    ("Tuesdayin|during <named-month>|year", -6.302618975744905),
                                    ("Chinese New Yearyear (latent)", -6.302618975744905),
                                    ("tomorrowintersect", -6.302618975744905),
                                    ("Lag BaOmeryear (latent)", -6.302618975744905),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.302618975744905),
                                    ("Eid al-Adhayear (latent)", -5.38632824387075),
                                    ("intersectin|during the <part-of-day>", -6.302618975744905),
                                    ("Palm Sundayyear (latent)", -6.302618975744905),
                                    ("Christmasat <time-of-day>", -6.302618975744905),
                                    ("Passoveryear (latent)", -6.302618975744905),
                                    ("Lazarus Saturdayyear (latent)", -6.302618975744905),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.302618975744905),
                                    ("Yom HaShoahyear (latent)", -5.8971538676367405),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.8971538676367405),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.302618975744905),
                                    ("Septemberyear (latent)", -5.8971538676367405),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.7985415789686305),
                                    ("Halloweenyear (latent)", -6.302618975744905),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.302618975744905),
                                    ("at <time-of-day>intersect", -5.8971538676367405),
                                    ("Rosh Hashanahyear (latent)", -5.60947179518496),
                                    ("Dhanterasyear (latent)", -6.302618975744905),
                                    ("Tu BiShvatyear (latent)", -6.302618975744905),
                                    ("<day-of-month> (ordinal)December", -5.60947179518496),
                                    ("Holiyear (latent)", -5.60947179518496),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.302618975744905),
                                    ("Holika Dahanyear (latent)", -5.60947179518496),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.302618975744905),
                                    ("dayminute", -3.384848243660626),
                                    ("Mawlidyear (latent)", -6.302618975744905),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.8971538676367405),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.302618975744905),
                                    ("Jumu'atul-Widayear (latent)", -5.38632824387075),
                                    ("minuteday", -2.47397757925581),
                                    ("absorption of , after named dayintersect",
                                     -6.302618975744905),
                                    ("intersectyear (latent)", -6.302618975744905),
                                    ("Orthodox Easter Sundayyear (latent)", -6.302618975744905),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.302618975744905),
                                    ("Boss's Dayyear (latent)", -5.8971538676367405),
                                    ("Global Youth Service Dayyear (latent)", -6.302618975744905),
                                    ("Dhanterasin|during <named-month>|year", -6.302618975744905),
                                    ("Tisha B'Avyear (latent)", -6.302618975744905),
                                    ("Isra and Mi'rajyear (latent)", -5.38632824387075),
                                    ("at <time-of-day>on <day>", -5.204006687076795),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.302618975744905),
                                    ("time-of-day (latent)<time> <part-of-day>", -5.60947179518496),
                                    ("Christmasyear (latent)", -5.8971538676367405),
                                    ("Naraka Chaturdashiyear (latent)", -5.8971538676367405),
                                    ("Thai Pongalin|during <named-month>|year", -6.302618975744905),
                                    ("dayweek", -6.302618975744905),
                                    ("Easter Sundayyear (latent)", -5.60947179518496),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.693181063310805),
                                    ("Labour Dayyear (latent)", -6.302618975744905),
                                    ("weekyear", -5.204006687076795),
                                    ("King's Dayyear (latent)", -4.7985415789686305),
                                    ("hh:mmin|during the <part-of-day>", -5.60947179518496),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.8971538676367405),
                                    ("Hanukkahyear (latent)", -5.60947179518496),
                                    ("February<time> <part-of-day>", -6.302618975744905),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.302618975744905),
                                    ("Great Lentyear (latent)", -6.302618975744905),
                                    ("tomorrowat <time-of-day>", -5.60947179518496),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.302618975744905),
                                    ("Vaisakhiyear (latent)", -5.60947179518496),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.302618975744905),
                                    ("last <cycle> of <time>year (latent)", -5.60947179518496),
                                    ("at <time-of-day>tomorrow", -5.8971538676367405),
                                    ("tomorrow<time-of-day> am|pm", -6.302618975744905),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.302618975744905),
                                    ("Diwaliyear (latent)", -6.302618975744905),
                                    ("between <time> and <time>on <day>", -4.693181063310805),
                                    ("Black Fridayyear (latent)", -5.8971538676367405),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.302618975744905),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.302618975744905),
                                    ("Chhathyear (latent)", -5.8971538676367405),
                                    ("Vasant Panchamiyear (latent)", -6.302618975744905),
                                    ("St Patrick's Dayyear (latent)", -6.302618975744905),
                                    ("Thursday<time> (timezone)", -6.302618975744905),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.302618975744905),
                                    ("<datetime> - <datetime> (interval)July", -5.8971538676367405),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.8971538676367405),
                                    ("Februaryintersect", -6.302618975744905),
                                    ("Mother's Dayyear (latent)", -6.302618975744905),
                                    ("Simchat Torahyear (latent)", -6.302618975744905),
                                    ("Victoria Dayyear (latent)", -5.8971538676367405),
                                    ("minuteyear", -6.302618975744905)],
                               n = 415},
                   koData =
                     ClassData{prior = -0.9540310598570021, unseen = -6.663132695990803,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.2606573588831558),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.968707559985366),
                                    ("<day-of-month> (ordinal)August", -5.968707559985366),
                                    ("dayhour", -3.294558910558837),
                                    ("<time> timezoneyear (latent)", -5.968707559985366),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.052416828111211),
                                    ("Tuesdayfrom|since|after <time>", -5.968707559985366),
                                    ("daymonth", -3.4838009101973655),
                                    ("monthyear", -4.715944591489998),
                                    ("<time-of-day> am|pmyear (latent)", -5.27556037942542),
                                    ("Thai Pongalyear (latent)", -5.27556037942542),
                                    ("intersecthh:mm", -5.968707559985366),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.563242451877201),
                                    ("<day-of-month> (ordinal)Wednesday", -5.968707559985366),
                                    ("houryear", -4.582413198865475),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.968707559985366),
                                    ("<day-of-month> (ordinal)October", -5.968707559985366),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.27556037942542),
                                    ("<time-of-day> am|pmintersect", -4.715944591489998),
                                    ("Octoberyear (latent)", -5.968707559985366),
                                    ("until <time>on <day>", -5.27556037942542),
                                    ("time-of-day (latent)intersect", -5.968707559985366),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.27556037942542),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.968707559985366),
                                    ("hh:mmon <day>", -3.5263605246161616),
                                    ("absorption of , after named dayJuly", -5.563242451877201),
                                    ("from|since|after <time>July", -5.563242451877201),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.052416828111211),
                                    ("Clean Mondayyear (latent)", -5.968707559985366),
                                    ("monthhour", -5.968707559985366),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.563242451877201),
                                    ("hourmonth", -4.096905383083774),
                                    ("todayat <time-of-day>", -5.968707559985366),
                                    ("from|since|after <time>December", -5.968707559985366),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.968707559985366),
                                    ("<time-of-day> am|pmon <day>", -4.715944591489998),
                                    ("Mondayyear (latent)", -5.27556037942542),
                                    ("dayday", -4.582413198865475),
                                    ("mm/ddat <time-of-day>", -5.563242451877201),
                                    ("on <day>September", -5.563242451877201),
                                    ("time-of-day (latent)September", -5.563242451877201),
                                    ("hourhour", -5.968707559985366),
                                    ("time-of-day (latent)on <day>", -3.5263605246161616),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.563242451877201),
                                    ("dayyear", -3.0242685808189256),
                                    ("Thursdaymm/dd", -5.968707559985366),
                                    ("New Year's Dayyear (latent)", -5.052416828111211),
                                    ("Thursdayfrom|since|after <time>", -4.263959467746941),
                                    ("Thursdayat <time-of-day>", -4.359269647551265),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.968707559985366),
                                    ("Aprilyear (latent)", -5.968707559985366),
                                    ("the <day-of-month> (ordinal)July", -5.968707559985366),
                                    ("the <day-of-month> (number)July", -5.968707559985366),
                                    ("monthminute", -5.968707559985366),
                                    ("<time-of-day> am|pmtomorrow", -5.968707559985366),
                                    ("Thursdayhh:mm", -5.052416828111211),
                                    ("<day-of-month> (ordinal)Tuesday", -5.563242451877201),
                                    ("minutemonth", -4.096905383083774),
                                    ("minutehour", -5.968707559985366),
                                    ("Augustyear (latent)", -5.563242451877201),
                                    ("week-endin|during <named-month>|year", -5.968707559985366),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.563242451877201),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.968707559985366),
                                    ("Sundayyear (latent)", -5.052416828111211),
                                    ("Christmasat <time-of-day>", -5.968707559985366),
                                    ("from|since|after <time>year (latent)", -4.870095271317256),
                                    ("<duration> after|before|from <time>December",
                                     -5.968707559985366),
                                    ("yesterday<time-of-day> am|pm", -5.968707559985366),
                                    ("<day-of-month> (ordinal)July", -5.27556037942542),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.968707559985366),
                                    ("mm/ddyear (latent)", -5.968707559985366),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.968707559985366),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.968707559985366),
                                    ("at <time-of-day>intersect", -5.563242451877201),
                                    ("hh:mmyear (latent)", -3.8892660183055296),
                                    ("Holiyear (latent)", -5.968707559985366),
                                    ("until <time><time-of-day> am|pm", -5.968707559985366),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.968707559985366),
                                    ("dayminute", -3.403758202523829),
                                    ("yyyy-mm-ddhh:mm", -5.563242451877201),
                                    ("intersectSeptember", -4.464630163209091),
                                    ("minuteday", -2.7300291078209855),
                                    ("absorption of , after named dayintersect",
                                     -5.968707559985366),
                                    ("intersectyear (latent)", -5.968707559985366),
                                    ("Februaryin|during the <part-of-day>", -5.968707559985366),
                                    ("time-of-day (latent)July", -5.27556037942542),
                                    ("Saturdayyear (latent)", -5.968707559985366),
                                    ("at <time-of-day>on <day>", -5.563242451877201),
                                    ("absorption of , after named daySeptember",
                                     -5.052416828111211),
                                    ("Naraka Chaturdashiyear (latent)", -5.968707559985366),
                                    ("from|since|after <time>on <day>", -5.052416828111211),
                                    ("dayweek", -5.968707559985366),
                                    ("Easter Sundayyear (latent)", -5.563242451877201),
                                    ("Thursday<time-of-day> am|pm", -4.715944591489998),
                                    ("weekyear", -5.563242451877201),
                                    ("time-of-day (latent)Thursday", -5.563242451877201),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.968707559985366),
                                    ("<day-of-month> (ordinal)April", -5.968707559985366),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.563242451877201),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.27556037942542),
                                    ("Sundayfrom|since|after <time>", -5.968707559985366),
                                    ("absorption of , after named dayFebruary", -5.052416828111211),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.968707559985366),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.968707559985366),
                                    ("tomorrowat <time-of-day>", -5.968707559985366),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.563242451877201),
                                    ("last <cycle> of <time>year (latent)", -5.563242451877201),
                                    ("tomorrow<time-of-day> am|pm", -5.968707559985366),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.27556037942542),
                                    ("Diwaliyear (latent)", -5.563242451877201),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.968707559985366),
                                    ("Fridayyear (latent)", -5.563242451877201),
                                    ("time-of-day (latent)April", -5.968707559985366),
                                    ("minuteyear", -3.7714829826491463)],
                               n = 260}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.17768117723745236,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.315220731690051e-2),
                                    ("intersect 2 numbers", -3.828641396489095)],
                               n = 180},
                   koData =
                     ClassData{prior = -1.8152899666382492,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
