...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6003422212725577, unseen = -5.707110264748875,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 299},
                   koData =
                     ClassData{prior = -0.7954542587308813,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46484795651282707,
                               unseen = -6.744059186311348,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.049733455231958),
                                    ...
                                    ("daymonth", -5.356586274672012),
                                    ("monthday", -5.644268347123793),
                                    ("monthyear", -4.440295542797857),
                                    ...
                                    ("Family Dayyear (latent)", -5.133442723357803),
                                    ("Octoberyear (latent)", -4.79697048673659),
                                    ...
                                    ("Dhanterasin <named-month>|year", -6.049733455231958),
                                    ...
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.049733455231958),
                                    ("Palm SundaySunday", -5.644268347123793),
                                    ("dayday", -3.8525088778957386),
                                    ("<time> <part-of-day>at <time-of-day>", -6.049733455231958),
                                    ("mm/ddat <time-of-day>", -6.049733455231958),
                                    ...
                                    ("mm/dd<time-of-day> am|pm", -6.049733455231958),
                                    ("hourhour", -4.79697048673659),
                                    ("<time-of-day> am|pmon <date>", -4.034830434689693),
                                    ("National Patriots' Dayyear (latent)", -5.356586274672012),
                                    ...
                                    ("Chhathin <named-month>|year", -6.049733455231958),
                                    ("Vasant Panchamiin <named-month>|year", -6.049733455231958),
                                    ("Diwaliin <named-month>|year", -6.049733455231958),
                                    ("Discovery Dayyear (latent)", -5.644268347123793),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.644268347123793),
                                    ("Navaratriin <named-month>|year", -6.049733455231958),
                                    ("Ashurayear (latent)", -6.049733455231958),
                                    ("Chinese New Yearyear (latent)", -6.049733455231958),
                                    ("Sundayyear (latent)", -6.049733455231958),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.049733455231958),
                                    ("Thai Pongalin <named-month>|year", -6.049733455231958),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -6.049733455231958),
                                    ...
                                    ("Palm Sundayintersect", -6.049733455231958),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.049733455231958),
                                    ("Februaryintersect", -6.049733455231958),
                                    ("Mother's Dayyear (latent)", -6.049733455231958),
                                    ("Simchat Torahyear (latent)", -6.049733455231958),
                                    ("Victoria Dayyear (latent)", -5.644268347123793)],
                               n = 316},
                   koData =
                     ClassData{prior = -0.9894815532451526,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1440393702229377, unseen = -4.990432586778736,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 142},
                   koData =
                     ClassData{prior = -2.0088239744658827, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
