...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6573799567013142, unseen = -5.918893854273146,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 370},
                   koData =
                     ClassData{prior = -0.730241304966186, unseen = -5.846438775057725,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4939768604730287, unseen = -6.98100574072173,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.2869287600018176),
                                    ("Father's Dayyear (latent)", -6.2869287600018176),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.2869287600018176),
                                    ...
                                    ("daymonth", -4.272025739459553),
                                    ("monthday", -5.881463651893654),
                                    ("monthyear", -4.495169290773763),
                                    ...
                                    ("Family Dayyear (latent)", -5.3706380281276624),
                                    ("Octoberyear (latent)", -4.782851363225544),
                                    ...
                                    ("<day-of-month> (ordinal)intersect", -5.881463651893654),
                                    ...
                                    ("National Patriots' Dayyear (latent)", -5.593781579441872),
                                    ...
                                    ("Discovery Dayyear (latent)", -5.881463651893654),
                                    ...
                                    ("absorption of , after named dayintersect",
                                     -6.2869287600018176),
                                    ("intersectyear (latent)", -6.2869287600018176),
                                    ...
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.677490847567718),
                                    ("Labour Dayyear (latent)", -6.2869287600018176),
                                    ...
                                    ("Mother's Dayyear (latent)", -6.2869287600018176),
                                    ("Simchat Torahyear (latent)", -6.2869287600018176),
                                    ("Victoria Dayyear (latent)", -5.881463651893654),
                                    ("minuteyear", -6.2869287600018176)],
                               n = 407},
                   koData =
                     ClassData{prior = -0.942108414900096, unseen = -6.661854740545311,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.185224316451916, unseen = -5.176149732573829,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.4685557987889984e-2),
                                    ("intersect 2 numbers", -3.784189633918261)],
                               n = 172},
                   koData =
                     ClassData{prior = -1.7773707317759553,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
