...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4457931534951362, unseen = -6.762729506931879,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.068425588244111),
                                    ("Father's Dayyear (latent)", -6.068425588244111),
                                    ("Ramadanyear (latent)", -6.068425588244111),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.815662619748743),
                                    ("Bhai Doojyear (latent)", -6.068425588244111),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.815662619748743),
                                    ("hourday", -4.363677496005685),
                                    ("dayhour", -3.2650652073375754),
                                    ("Martin Luther King's Dayyear (latent)", -5.662960480135946),
                                    ("Shemini Atzeretyear (latent)", -6.068425588244111),
                                    ("daymonth", -5.152134856369956),
                                    ("monthday", -5.662960480135946),
                                    ("monthyear", -4.276666119016055),
                                    ("Yom Ha'atzmautyear (latent)", -6.068425588244111),
                                    ("Vijayadashamiyear (latent)", -6.068425588244111),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.662960480135946),
                                    ("Thanksgiving Dayyear (latent)", -4.969813299576001),
                                    ("Thai Pongalyear (latent)", -5.375278407684165),
                                    ("Thiru Onamyear (latent)", -5.375278407684165),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.068425588244111),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.068425588244111),
                                    ("houryear", -5.375278407684165),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.068425588244111),
                                    ("Christmas<time-of-day> am|pm", -6.068425588244111),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.068425588244111),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.375278407684165),
                                    ("<time-of-day> am|pmintersect", -4.815662619748743),
                                    ("Earth Houryear (latent)", -6.068425588244111),
                                    ("Family Dayyear (latent)", -5.152134856369956),
                                    ("Octoberyear (latent)", -4.564348191467836),
                                    ("intersect<time-of-day> am|pm", -6.068425588244111),
                                    ("Mattu Pongalyear (latent)", -6.068425588244111),
                                    ("Shavuotyear (latent)", -6.068425588244111),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.068425588244111),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.068425588244111),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.662960480135946),
                                    ("Marchyear (latent)", -6.068425588244111),
                                    ("Sukkotyear (latent)", -5.662960480135946),
                                    ...
                                    ("Thursday<time> timezone", -4.363677496005685),
                                    ("from|since|after <time>December", -6.068425588244111),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.068425588244111),
                                    ("dayday", -4.053522567701846),
                                    ("<time> <part-of-day>at <time-of-day>", -6.068425588244111),
                                    ("mm/ddat <time-of-day>", -6.068425588244111),
                                    ("tonightat <time-of-day>", -6.068425588244111),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.375278407684165),
                                    ("today<time-of-day> am|pm", -6.068425588244111),
                                    ("Februarythe <day-of-month> (ordinal)", -5.662960480135946),
                                    ("at <time-of-day><time> <part-of-day>", -6.068425588244111),
                                    ("mm/dd<time-of-day> am|pm", -6.068425588244111),
                                    ("hourhour", -4.815662619748743),
                                    ("<time-of-day> am|pmon <date>", -4.053522567701846),
                                    ("Navaratriin|during <named-month>|year", -6.068425588244111),
                                    ("National Patriots' Dayyear (latent)", -5.375278407684165),
                                    ("Wednesdaythis|last|next <cycle>", -6.068425588244111),
                                    ("Lentyear (latent)", -6.068425588244111),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.564348191467836),
                                    ("Boghiyear (latent)", -6.068425588244111),
                                    ("dayyear", -1.9095425048844386),
                                    ("Thursdayfrom|since|after <time>", -5.662960480135946),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.068425588244111),
                                    ("Thursdayat <time-of-day>", -5.662960480135946),
                                    ("Islamic New Yearyear (latent)", -5.662960480135946),
                                    ("Laylat al-Qadryear (latent)", -5.152134856369956),
                                    ("Discovery Dayyear (latent)", -5.662960480135946),
                                    ("Shrove Tuesdayyear (latent)", -6.068425588244111),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.375278407684165),
                                    ("<time-of-day> am|pmtomorrow", -5.375278407684165),
                                    ("Yom Kippuryear (latent)", -6.068425588244111),
                                    ("<part-of-day> of <time>year (latent)", -6.068425588244111),
                                    ("minutehour", -5.152134856369956),
                                    ("Kaanum Pongalyear (latent)", -5.662960480135946),
                                    ("Maha Saptamiyear (latent)", -6.068425588244111),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.662960480135946),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.363677496005685),
                                    ("for <duration> from <time>December", -6.068425588244111),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.068425588244111),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.152134856369956),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.662960480135946),
                                    ("Pentecostyear (latent)", -6.068425588244111),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.152134856369956),
                                    ("Eid al-Fitryear (latent)", -6.068425588244111),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.068425588244111),
                                    ("Mondayin|during the <part-of-day>", -6.068425588244111),
                                    ("Chhathin|during <named-month>|year", -6.068425588244111),
                                    ("Diwaliin|during <named-month>|year", -6.068425588244111),
                                    ("Raksha Bandhanyear (latent)", -6.068425588244111),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.662960480135946),
                                    ("Ashurayear (latent)", -6.068425588244111),
                                    ("Tuesdayin|during <named-month>|year", -6.068425588244111),
                                    ("Chinese New Yearyear (latent)", -6.068425588244111),
                                    ("Lag BaOmeryear (latent)", -6.068425588244111),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.068425588244111),
                                    ("Eid al-Adhayear (latent)", -5.152134856369956),
                                    ("intersectin|during the <part-of-day>", -6.068425588244111),
                                    ("Palm Sundayyear (latent)", -6.068425588244111),
                                    ("Christmasat <time-of-day>", -6.068425588244111),
                                    ("Passoveryear (latent)", -6.068425588244111),
                                    ("Lazarus Saturdayyear (latent)", -6.068425588244111),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.068425588244111),
                                    ("Yom HaShoahyear (latent)", -5.662960480135946),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.662960480135946),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.068425588244111),
                                    ("Septemberyear (latent)", -5.662960480135946),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.815662619748743),
                                    ("Halloweenyear (latent)", -6.068425588244111),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.375278407684165),
                                    ("Dhanterasyear (latent)", -6.068425588244111),
                                    ("Tu BiShvatyear (latent)", -6.068425588244111),
                                    ("Holiyear (latent)", -5.375278407684165),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.068425588244111),
                                    ("Holika Dahanyear (latent)", -5.375278407684165),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.068425588244111),
                                    ("dayminute", -3.429368258628852),
                                    ("Mawlidyear (latent)", -6.068425588244111),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.662960480135946),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.068425588244111),
                                    ("Jumu'atul-Widayear (latent)", -5.152134856369956),
                                    ("minuteday", -2.4308394285177246),
                                    ("absorption of , after named dayintersect",
                                     -6.068425588244111),
                                    ("Orthodox Easter Sundayyear (latent)", -6.068425588244111),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.068425588244111),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.068425588244111),
                                    ("Boss's Dayyear (latent)", -5.662960480135946),
                                    ("Global Youth Service Dayyear (latent)", -6.068425588244111),
                                    ("Dhanterasin|during <named-month>|year", -6.068425588244111),
                                    ("Tisha B'Avyear (latent)", -6.068425588244111),
                                    ("Isra and Mi'rajyear (latent)", -5.152134856369956),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.068425588244111),
                                    ("Christmasyear (latent)", -5.662960480135946),
                                    ("Naraka Chaturdashiyear (latent)", -5.662960480135946),
                                    ("at <time-of-day>on <date>", -4.969813299576001),
                                    ("Thai Pongalin|during <named-month>|year", -6.068425588244111),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.45898767581001),
                                    ("dayweek", -6.068425588244111),
                                    ("Easter Sundayyear (latent)", -5.375278407684165),
                                    ("Labour Dayyear (latent)", -6.068425588244111),
                                    ("weekyear", -4.969813299576001),
                                    ("hh:mmin|during the <part-of-day>", -5.375278407684165),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.662960480135946),
                                    ("Hanukkahyear (latent)", -5.375278407684165),
                                    ("February<time> <part-of-day>", -6.068425588244111),
                                    ("Great Lentyear (latent)", -6.068425588244111),
                                    ("tomorrowat <time-of-day>", -5.375278407684165),
                                    ("between <time> and <time>on <date>", -4.45898767581001),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.068425588244111),
                                    ("last <cycle> of <time>year (latent)", -5.375278407684165),
                                    ("at <time-of-day>tomorrow", -5.662960480135946),
                                    ("tomorrow<time-of-day> am|pm", -6.068425588244111),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.068425588244111),
                                    ("Diwaliyear (latent)", -6.068425588244111),
                                    ("Black Fridayyear (latent)", -5.662960480135946),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.068425588244111),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.068425588244111),
                                    ("Chhathyear (latent)", -5.662960480135946),
                                    ("Vasant Panchamiyear (latent)", -6.068425588244111),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.068425588244111),
                                    ("Februaryintersect", -6.068425588244111),
                                    ("Mother's Dayyear (latent)", -6.068425588244111),
                                    ("Simchat Torahyear (latent)", -6.068425588244111),
                                    ("Victoria Dayyear (latent)", -5.662960480135946),
                                    ("minuteyear", -6.068425588244111)],
                               n = 324},
                   koData =
                     ClassData{prior = -1.0225299822106702, unseen = -6.364750756851911,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.7535901911063645),
                                    ("hourday", -4.7535901911063645),
                                    ("dayhour", -3.104931565518983),
                                    ("Tuesdayfrom|since|after <time>", -5.66988092298052),
                                    ("daymonth", -3.654977902438255),
                                    ("monthyear", -4.4171179544851515),
                                    ("<time-of-day> am|pmyear (latent)", -5.264415814872355),
                                    ("Thai Pongalyear (latent)", -4.976733742420574),
                                    ("intersecthh:mm", -5.66988092298052),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.66988092298052),
                                    ...
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.976733742420574),
                                    ("<time-of-day> am|pmintersect", -4.4171179544851515),
                                    ("until <time>on <date>", -4.976733742420574),
                                    ("Octoberyear (latent)", -5.66988092298052),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -4.976733742420574),
                                    ("about|exactly <time-of-day>year (latent)", -5.66988092298052),
                                    ("absorption of , after named dayJuly", -5.264415814872355),
                                    ("from|since|after <time>July", -5.66988092298052),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.7535901911063645),
                                    ("Clean Mondayyear (latent)", -5.66988092298052),
                                    ("monthhour", -5.66988092298052),
                                    ("hourmonth", -4.7535901911063645),
                                    ("todayat <time-of-day>", -5.66988092298052),
                                    ("from|since|after <time>December", -5.66988092298052),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.66988092298052),
                                    ("Mondayyear (latent)", -4.976733742420574),
                                    ("dayday", -5.264415814872355),
                                    ("mm/ddat <time-of-day>", -5.264415814872355),
                                    ("<time-of-day> am|pmon <date>", -4.4171179544851515),
                                    ("dayyear", -2.779509165084355),
                                    ("Thursdaymm/dd", -5.66988092298052),
                                    ("New Year's Dayyear (latent)", -5.264415814872355),
                                    ("Thursdayfrom|since|after <time>", -3.9651328307420943),
                                    ("Thursdayat <time-of-day>", -4.4171179544851515),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.66988092298052),
                                    ("Aprilyear (latent)", -5.66988092298052),
                                    ("monthminute", -5.66988092298052),
                                    ("<time-of-day> am|pmtomorrow", -5.66988092298052),
                                    ("Thursdayhh:mm", -4.7535901911063645),
                                    ("minutemonth", -3.8781214537524646),
                                    ("Augustyear (latent)", -5.264415814872355),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.264415814872355),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.264415814872355),
                                    ("week-endin|during <named-month>|year", -5.66988092298052),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.264415814872355),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.66988092298052),
                                    ("Sundayyear (latent)", -4.7535901911063645),
                                    ("Christmasat <time-of-day>", -5.66988092298052),
                                    ("from|since|after <time>year (latent)", -4.57126863431241),
                                    ("<duration> after|before|from <time>December",
                                     -5.66988092298052),
                                    ("yesterday<time-of-day> am|pm", -5.66988092298052),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.66988092298052),
                                    ("mm/ddyear (latent)", -5.66988092298052),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.976733742420574),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.66988092298052),
                                    ("at <time-of-day>intersect", -5.264415814872355),
                                    ("hh:mmyear (latent)", -4.57126863431241),
                                    ("Holiyear (latent)", -5.66988092298052),
                                    ("until <time><time-of-day> am|pm", -5.66988092298052),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.66988092298052),
                                    ("dayminute", -3.144152278672264),
                                    ("intersectSeptember", -4.165803526204246),
                                    ("minuteday", -2.6018279878469026),
                                    ("absorption of , after named dayintersect", -5.66988092298052),
                                    ("Februaryin|during the <part-of-day>", -5.66988092298052),
                                    ("hh:mmon <date>", -3.654977902438255),
                                    ("Saturdayyear (latent)", -5.66988092298052),
                                    ("from|since|after <time>on <date>", -4.7535901911063645),
                                    ("absorption of , after named daySeptember",
                                     -4.7535901911063645),
                                    ("Naraka Chaturdashiyear (latent)", -5.66988092298052),
                                    ("on <date>September", -5.264415814872355),
                                    ("at <time-of-day>on <date>", -5.264415814872355),
                                    ("dayweek", -5.66988092298052),
                                    ("Easter Sundayyear (latent)", -5.264415814872355),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -4.976733742420574),
                                    ("Sundayfrom|since|after <time>", -5.66988092298052),
                                    ...
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.66988092298052),
                                    ("last <cycle> of <time>year (latent)", -5.264415814872355),
                                    ("tomorrow<time-of-day> am|pm", -5.66988092298052),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.976733742420574),
                                    ("Diwaliyear (latent)", -5.264415814872355),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.66988092298052),
                                    ("Fridayyear (latent)", -5.264415814872355),
                                    ("minuteyear", -4.4171179544851515)],
                               n = 182}}),
       ("one eleven",
        Classifier{okData =
