...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5888343339345626, unseen = -5.768320995793772,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 318},
                   koData =
                     ClassData{prior = -0.8096221715563133, unseen = -5.54907608489522,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4661500599297456, unseen = -6.771935555839602,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.077642243349034),
                                    ("Father's Dayyear (latent)", -6.077642243349034),
                                    ("Ramadanyear (latent)", -6.077642243349034),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.824879274853666),
                                    ("Bhai Doojyear (latent)", -6.077642243349034),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.824879274853666),
                                    ("hourday", -4.372894151110609),
                                    ("dayhour", -3.2742818624424994),
                                    ("Martin Luther King's Dayyear (latent)", -5.67217713524087),
                                    ("Shemini Atzeretyear (latent)", -6.077642243349034),
                                    ("daymonth", -5.161351511474879),
                                    ("monthday", -5.67217713524087),
                                    ("monthyear", -4.285882774120979),
                                    ("Yom Ha'atzmautyear (latent)", -6.077642243349034),
                                    ("Vijayadashamiyear (latent)", -6.077642243349034),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.67217713524087),
                                    ("Thanksgiving Dayyear (latent)", -4.979029954680924),
                                    ("Thai Pongalyear (latent)", -5.384495062789089),
                                    ("Thiru Onamyear (latent)", -5.384495062789089),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.077642243349034),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.077642243349034),
                                    ("houryear", -5.384495062789089),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.077642243349034),
                                    ("Christmas<time-of-day> am|pm", -6.077642243349034),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.077642243349034),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.384495062789089),
                                    ("<time-of-day> am|pmintersect", -4.824879274853666),
                                    ("Earth Houryear (latent)", -6.077642243349034),
                                    ("Family Dayyear (latent)", -5.161351511474879),
                                    ("Octoberyear (latent)", -4.5735648465727605),
                                    ("intersect<time-of-day> am|pm", -6.077642243349034),
                                    ("Mattu Pongalyear (latent)", -6.077642243349034),
                                    ("Shavuotyear (latent)", -6.077642243349034),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.077642243349034),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.077642243349034),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.67217713524087),
                                    ("Marchyear (latent)", -6.077642243349034),
                                    ("Sukkotyear (latent)", -5.67217713524087),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.077642243349034),
                                    ("Clean Mondayyear (latent)", -5.67217713524087),
                                    ("monthhour", -5.67217713524087),
                                    ("todayat <time-of-day>", -6.077642243349034),
                                    ("Thursday<time> timezone", -4.372894151110609),
                                    ("from|since|after <time>December", -6.077642243349034),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.077642243349034),
                                    ("dayday", -4.062739222806769),
                                    ("<time> <part-of-day>at <time-of-day>", -6.077642243349034),
                                    ("mm/ddat <time-of-day>", -6.077642243349034),
                                    ("tonightat <time-of-day>", -6.077642243349034),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.384495062789089),
                                    ("today<time-of-day> am|pm", -6.077642243349034),
                                    ("Februarythe <day-of-month> (ordinal)", -5.67217713524087),
                                    ("at <time-of-day><time> <part-of-day>", -6.077642243349034),
                                    ("mm/dd<time-of-day> am|pm", -6.077642243349034),
                                    ("hourhour", -4.824879274853666),
                                    ("<time-of-day> am|pmon <date>", -4.062739222806769),
                                    ("Navaratriin|during <named-month>|year", -6.077642243349034),
                                    ("National Patriots' Dayyear (latent)", -5.384495062789089),
                                    ("Wednesdaythis|last|next <cycle>", -6.077642243349034),
                                    ("Lentyear (latent)", -6.077642243349034),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.5735648465727605),
                                    ("Boghiyear (latent)", -6.077642243349034),
                                    ("dayyear", -1.9109770195473075),
                                    ("Thursdayfrom|since|after <time>", -5.67217713524087),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.077642243349034),
                                    ("Thursdayat <time-of-day>", -5.67217713524087),
                                    ("Islamic New Yearyear (latent)", -5.67217713524087),
                                    ("Laylat al-Qadryear (latent)", -5.161351511474879),
                                    ("Discovery Dayyear (latent)", -5.67217713524087),
                                    ("Shrove Tuesdayyear (latent)", -6.077642243349034),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.384495062789089),
                                    ("<time-of-day> am|pmtomorrow", -5.384495062789089),
                                    ("Yom Kippuryear (latent)", -6.077642243349034),
                                    ("<part-of-day> of <time>year (latent)", -6.077642243349034),
                                    ("minutehour", -5.161351511474879),
                                    ("Kaanum Pongalyear (latent)", -5.67217713524087),
                                    ("Maha Saptamiyear (latent)", -6.077642243349034),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.67217713524087),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.372894151110609),
                                    ("for <duration> from <time>December", -6.077642243349034),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.077642243349034),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.161351511474879),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.67217713524087),
                                    ("Pentecostyear (latent)", -6.077642243349034),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.161351511474879),
                                    ("Eid al-Fitryear (latent)", -6.077642243349034),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.077642243349034),
                                    ("Mondayin|during the <part-of-day>", -6.077642243349034),
                                    ("Chhathin|during <named-month>|year", -6.077642243349034),
                                    ("Diwaliin|during <named-month>|year", -6.077642243349034),
                                    ("Raksha Bandhanyear (latent)", -6.077642243349034),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.67217713524087),
                                    ("Ashurayear (latent)", -6.077642243349034),
                                    ("Tuesdayin|during <named-month>|year", -6.077642243349034),
                                    ("Chinese New Yearyear (latent)", -6.077642243349034),
                                    ("Lag BaOmeryear (latent)", -6.077642243349034),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.077642243349034),
                                    ("Eid al-Adhayear (latent)", -5.161351511474879),
                                    ("intersectin|during the <part-of-day>", -6.077642243349034),
                                    ("Palm Sundayyear (latent)", -6.077642243349034),
                                    ("Christmasat <time-of-day>", -6.077642243349034),
                                    ("Passoveryear (latent)", -6.077642243349034),
                                    ("Lazarus Saturdayyear (latent)", -6.077642243349034),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.077642243349034),
                                    ("Yom HaShoahyear (latent)", -5.67217713524087),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.67217713524087),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.077642243349034),
                                    ("Septemberyear (latent)", -5.67217713524087),
                                    ("mm/ddyear (latent)", -6.077642243349034),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.824879274853666),
                                    ("Halloweenyear (latent)", -6.077642243349034),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.077642243349034),
                                    ("at <time-of-day>intersect", -5.67217713524087),
                                    ("Rosh Hashanahyear (latent)", -5.384495062789089),
                                    ("Dhanterasyear (latent)", -6.077642243349034),
                                    ("Tu BiShvatyear (latent)", -6.077642243349034),
                                    ("Holiyear (latent)", -5.384495062789089),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.077642243349034),
                                    ("Holika Dahanyear (latent)", -5.384495062789089),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.077642243349034),
                                    ("dayminute", -3.438584913733776),
                                    ("Mawlidyear (latent)", -6.077642243349034),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.67217713524087),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.077642243349034),
                                    ("Jumu'atul-Widayear (latent)", -5.161351511474879),
                                    ("minuteday", -2.4400560836226486),
                                    ("absorption of , after named dayintersect",
                                     -6.077642243349034),
                                    ("Orthodox Easter Sundayyear (latent)", -6.077642243349034),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.077642243349034),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.077642243349034),
                                    ("Boss's Dayyear (latent)", -5.67217713524087),
                                    ("Global Youth Service Dayyear (latent)", -6.077642243349034),
                                    ("Dhanterasin|during <named-month>|year", -6.077642243349034),
                                    ("Tisha B'Avyear (latent)", -6.077642243349034),
                                    ("Isra and Mi'rajyear (latent)", -5.161351511474879),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.077642243349034),
                                    ("Christmasyear (latent)", -5.67217713524087),
                                    ("Naraka Chaturdashiyear (latent)", -5.67217713524087),
                                    ("at <time-of-day>on <date>", -4.979029954680924),
                                    ("Thai Pongalin|during <named-month>|year", -6.077642243349034),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.468204330914934),
                                    ("dayweek", -6.077642243349034),
                                    ("Easter Sundayyear (latent)", -5.384495062789089),
                                    ("Labour Dayyear (latent)", -6.077642243349034),
                                    ("weekyear", -4.979029954680924),
                                    ("hh:mmin|during the <part-of-day>", -5.384495062789089),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.67217713524087),
                                    ("Hanukkahyear (latent)", -5.384495062789089),
                                    ("February<time> <part-of-day>", -6.077642243349034),
                                    ("Great Lentyear (latent)", -6.077642243349034),
                                    ("tomorrowat <time-of-day>", -5.384495062789089),
                                    ("between <time> and <time>on <date>", -4.468204330914934),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.077642243349034),
                                    ("last <cycle> of <time>year (latent)", -5.384495062789089),
                                    ("at <time-of-day>tomorrow", -5.67217713524087),
                                    ("tomorrow<time-of-day> am|pm", -6.077642243349034),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.077642243349034),
                                    ("Diwaliyear (latent)", -6.077642243349034),
                                    ("Black Fridayyear (latent)", -5.67217713524087),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.077642243349034),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.077642243349034),
                                    ("Chhathyear (latent)", -5.67217713524087),
                                    ("Vasant Panchamiyear (latent)", -6.077642243349034),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.077642243349034),
                                    ("Februaryintersect", -6.077642243349034),
                                    ("Mother's Dayyear (latent)", -6.077642243349034),
                                    ("Simchat Torahyear (latent)", -6.077642243349034),
                                    ("Victoria Dayyear (latent)", -5.67217713524087),
                                    ("minuteyear", -6.077642243349034)],
                               n = 325},
                   koData =
                     ClassData{prior = -0.9872850533545976, unseen = -6.411818267709897,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.800736969532067),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.311562593298057),
                                    ("week-endin|during <named-month>|year", -5.717027701406222),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.311562593298057),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.717027701406222),
                                    ("Sundayyear (latent)", -4.800736969532067),
