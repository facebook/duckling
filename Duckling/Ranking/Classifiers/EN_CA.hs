...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6149464332524703, unseen = -5.831882477283517,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 339},
                   koData =
                     ClassData{prior = -0.7779860604969747, unseen = -5.66988092298052,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4378797667924462, unseen = -6.820016364674131,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.125776884715576),
                                    ("Father's Dayyear (latent)", -6.125776884715576),
                                    ("Ramadanyear (latent)", -6.125776884715576),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.873013916220208),
                                    ("Bhai Doojyear (latent)", -6.125776884715576),
                                    ("hourday", -4.42102879247715),
                                    ("dayhour", -3.2635760037861075),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.873013916220208),
                                    ("Martin Luther King's Dayyear (latent)", -5.720311776607412),
                                    ("Shemini Atzeretyear (latent)", -6.125776884715576),
                                    ("daymonth", -5.209486152841421),
                                    ("monthday", -5.720311776607412),
                                    ("monthyear", -4.334017415487521),
                                    ("yearhour", -5.720311776607412),
                                    ("Yom Ha'atzmautyear (latent)", -6.125776884715576),
                                    ("Vijayadashamiyear (latent)", -6.125776884715576),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.720311776607412),
                                    ("Thanksgiving Dayyear (latent)", -5.0271645960474665),
                                    ("Thai Pongalyear (latent)", -5.432629704155631),
                                    ("Thiru Onamyear (latent)", -5.432629704155631),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.125776884715576),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.125776884715576),
                                    ("houryear", -5.432629704155631),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.125776884715576),
                                    ("Christmas<time-of-day> am|pm", -6.125776884715576),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.125776884715576),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.432629704155631),
                                    ("<time-of-day> am|pmintersect", -4.873013916220208),
                                    ("Earth Houryear (latent)", -6.125776884715576),
                                    ("Family Dayyear (latent)", -5.209486152841421),
                                    ("Octoberyear (latent)", -4.621699487939302),
                                    ("intersect<time-of-day> am|pm", -6.125776884715576),
                                    ("Mattu Pongalyear (latent)", -6.125776884715576),
                                    ("Shavuotyear (latent)", -6.125776884715576),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.125776884715576),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.125776884715576),
                                    ("in|within|after <duration>at <time-of-day>",
                                     -6.125776884715576),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.720311776607412),
                                    ("Marchyear (latent)", -6.125776884715576),
                                    ("Sukkotyear (latent)", -5.720311776607412),
                                    ...
                                    ("Thursday<time> timezone", -4.179866735660263),
                                    ("from|since|after <time>December", -6.125776884715576),
                                    ("<time-of-day> am|pmon <day>", -4.110873864173311),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.125776884715576),
                                    ("yyyy-mm-ddhh:mm:ss", -5.720311776607412),
                                    ("dayday", -4.110873864173311),
                                    ("<time> <part-of-day>at <time-of-day>", -6.125776884715576),
                                    ("mm/ddat <time-of-day>", -6.125776884715576),
                                    ("tonightat <time-of-day>", -6.125776884715576),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.432629704155631),
                                    ("today<time-of-day> am|pm", -6.125776884715576),
                                    ("Februarythe <day-of-month> (ordinal)", -5.720311776607412),
                                    ("at <time-of-day><time> <part-of-day>", -6.125776884715576),
                                    ("mm/dd<time-of-day> am|pm", -6.125776884715576),
                                    ("hourhour", -4.873013916220208),
                                    ("Navaratriin|during <named-month>|year", -6.125776884715576),
                                    ("National Patriots' Dayyear (latent)", -5.432629704155631),
                                    ("Wednesdaythis|last|next <cycle>", -6.125776884715576),
                                    ("Lentyear (latent)", -6.125776884715576),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.621699487939302),
                                    ("Boghiyear (latent)", -6.125776884715576),
                                    ("dayyear", -1.9285749370537675),
                                    ("Thursdayfrom|since|after <time>", -5.720311776607412),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.125776884715576),
                                    ("Thursdayat <time-of-day>", -5.432629704155631),
                                    ("Islamic New Yearyear (latent)", -5.720311776607412),
                                    ("Laylat al-Qadryear (latent)", -5.209486152841421),
                                    ("Discovery Dayyear (latent)", -5.720311776607412),
                                    ("Shrove Tuesdayyear (latent)", -6.125776884715576),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.432629704155631),
                                    ("<time-of-day> am|pmtomorrow", -5.432629704155631),
                                    ("Yom Kippuryear (latent)", -6.125776884715576),
                                    ("<part-of-day> of <time>year (latent)", -6.125776884715576),
                                    ("minutehour", -5.209486152841421),
                                    ("Kaanum Pongalyear (latent)", -5.720311776607412),
                                    ("Maha Saptamiyear (latent)", -6.125776884715576),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.720311776607412),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.42102879247715),
                                    ("for <duration> from <time>December", -6.125776884715576),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.125776884715576),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.873013916220208),
                                    ("Pentecostyear (latent)", -6.125776884715576),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.873013916220208),
                                    ("Eid al-Fitryear (latent)", -6.125776884715576),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.125776884715576),
                                    ("Mondayin|during the <part-of-day>", -6.125776884715576),
                                    ("Chhathin|during <named-month>|year", -6.125776884715576),
                                    ("Diwaliin|during <named-month>|year", -6.125776884715576),
                                    ("Vaisakhiin|during <named-month>|year", -6.125776884715576),
                                    ("Raksha Bandhanyear (latent)", -6.125776884715576),
                                    ("daysecond", -5.720311776607412),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.720311776607412),
                                    ("Ashurayear (latent)", -6.125776884715576),
                                    ("Tuesdayin|during <named-month>|year", -6.125776884715576),
                                    ("Chinese New Yearyear (latent)", -6.125776884715576),
                                    ("Lag BaOmeryear (latent)", -6.125776884715576),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.125776884715576),
                                    ("Eid al-Adhayear (latent)", -5.209486152841421),
                                    ("intersectin|during the <part-of-day>", -6.125776884715576),
                                    ("Palm Sundayyear (latent)", -6.125776884715576),
                                    ("Christmasat <time-of-day>", -6.125776884715576),
                                    ("Passoveryear (latent)", -6.125776884715576),
                                    ("Lazarus Saturdayyear (latent)", -6.125776884715576),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.125776884715576),
                                    ("Yom HaShoahyear (latent)", -5.720311776607412),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.720311776607412),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.125776884715576),
                                    ("Septemberyear (latent)", -5.720311776607412),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.621699487939302),
                                    ("Halloweenyear (latent)", -6.125776884715576),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.125776884715576),
                                    ("at <time-of-day>intersect", -5.720311776607412),
                                    ("Rosh Hashanahyear (latent)", -5.432629704155631),
                                    ("Dhanterasyear (latent)", -6.125776884715576),
                                    ("Tu BiShvatyear (latent)", -6.125776884715576),
                                    ("Holiyear (latent)", -5.432629704155631),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.125776884715576),
                                    ("Holika Dahanyear (latent)", -5.432629704155631),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.125776884715576),
                                    ("dayminute", -3.208006152631297),
                                    ("Mawlidyear (latent)", -6.125776884715576),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.720311776607412),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.125776884715576),
                                    ("Jumu'atul-Widayear (latent)", -5.209486152841421),
                                    ("minuteday", -2.4881907249891904),
                                    ("absorption of , after named dayintersect",
                                     -6.125776884715576),
                                    ("in|within|after <duration><time-of-day> am|pm",
                                     -6.125776884715576),
                                    ("Orthodox Easter Sundayyear (latent)", -6.125776884715576),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.125776884715576),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.125776884715576),
                                    ("Boss's Dayyear (latent)", -5.720311776607412),
                                    ("Global Youth Service Dayyear (latent)", -6.125776884715576),
                                    ("Dhanterasin|during <named-month>|year", -6.125776884715576),
                                    ("Tisha B'Avyear (latent)", -6.125776884715576),
                                    ("Isra and Mi'rajyear (latent)", -5.209486152841421),
                                    ("at <time-of-day>on <day>", -5.0271645960474665),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.125776884715576),
                                    ("Christmasyear (latent)", -5.720311776607412),
                                    ("Naraka Chaturdashiyear (latent)", -5.720311776607412),
                                    ("Thai Pongalin|during <named-month>|year", -6.125776884715576),
                                    ("dayweek", -6.125776884715576),
                                    ("Easter Sundayyear (latent)", -5.432629704155631),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.516338972281476),
                                    ("Labour Dayyear (latent)", -6.125776884715576),
                                    ("weekyear", -5.0271645960474665),
                                    ("hh:mmin|during the <part-of-day>", -5.432629704155631),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.720311776607412),
                                    ("Hanukkahyear (latent)", -5.432629704155631),
                                    ("February<time> <part-of-day>", -6.125776884715576),
                                    ("Great Lentyear (latent)", -6.125776884715576),
                                    ("tomorrowat <time-of-day>", -5.432629704155631),
                                    ("Vaisakhiyear (latent)", -5.432629704155631),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.125776884715576),
                                    ("last <cycle> of <time>year (latent)", -5.432629704155631),
                                    ("at <time-of-day>tomorrow", -5.720311776607412),
                                    ("tomorrow<time-of-day> am|pm", -6.125776884715576),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.125776884715576),
                                    ("Diwaliyear (latent)", -6.125776884715576),
                                    ("between <time> and <time>on <day>", -4.516338972281476),
                                    ("Black Fridayyear (latent)", -5.720311776607412),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.125776884715576),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.125776884715576),
                                    ("Chhathyear (latent)", -5.720311776607412),
                                    ("Vasant Panchamiyear (latent)", -6.125776884715576),
                                    ("St Patrick's Dayyear (latent)", -6.125776884715576),
                                    ("Thursday<time> (timezone)", -6.125776884715576),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.125776884715576),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.720311776607412),
                                    ("Februaryintersect", -6.125776884715576),
                                    ("Mother's Dayyear (latent)", -6.125776884715576),
                                    ("Simchat Torahyear (latent)", -6.125776884715576),
                                    ("Victoria Dayyear (latent)", -5.720311776607412),
                                    ("minuteyear", -6.125776884715576)],
                               n = 344},
                   koData =
                     ClassData{prior = -1.036774409106202, unseen = -6.406879986069314,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.795790545596741),
                                    ("dayhour", -3.0379326280443673),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.795790545596741),
                                    ("Tuesdayfrom|since|after <time>", -5.7120812774708964),
                                    ("daymonth", -3.6971782569286313),
                                    ("monthyear", -4.459318308975528),
                                    ("yearhour", -5.7120812774708964),
                                    ("<time-of-day> am|pmyear (latent)", -5.018934096910951),
                                    ("Thai Pongalyear (latent)", -5.018934096910951),
                                    ("intersecthh:mm", -5.7120812774708964),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.7120812774708964),
                                    ("houryear", -4.613468988802786),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.7120812774708964),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.018934096910951),
                                    ("<time-of-day> am|pmintersect", -4.459318308975528),
                                    ("Octoberyear (latent)", -5.7120812774708964),
                                    ("until <time>on <day>", -5.018934096910951),
                                    ("in|within|after <duration>at <time-of-day>",
                                     -5.7120812774708964),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.018934096910951),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.7120812774708964),
                                    ("hh:mmon <day>", -3.6971782569286313),
                                    ("absorption of , after named dayJuly", -5.306616169362732),
                                    ("from|since|after <time>July", -5.7120812774708964),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.795790545596741),
                                    ("Clean Mondayyear (latent)", -5.7120812774708964),
                                    ("monthhour", -5.7120812774708964),
                                    ("hourmonth", -4.795790545596741),
                                    ("todayat <time-of-day>", -5.7120812774708964),
                                    ("from|since|after <time>December", -5.7120812774708964),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.7120812774708964),
                                    ("<time-of-day> am|pmon <day>", -4.459318308975528),
                                    ("Mondayyear (latent)", -5.018934096910951),
                                    ("dayday", -5.306616169362732),
                                    ("mm/ddat <time-of-day>", -5.306616169362732),
                                    ("on <day>September", -5.306616169362732),
                                    ("dayyear", -2.8217095195747315),
                                    ("Thursdaymm/dd", -5.7120812774708964),
                                    ("New Year's Dayyear (latent)", -5.306616169362732),
                                    ("Thursdayfrom|since|after <time>", -4.007333185232471),
                                    ("Thursdayat <time-of-day>", -4.102643365036796),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.7120812774708964),
                                    ("Aprilyear (latent)", -5.7120812774708964),
                                    ("monthminute", -5.7120812774708964),
                                    ("<time-of-day> am|pmtomorrow", -5.7120812774708964),
                                    ("Thursdayhh:mm", -4.795790545596741),
                                    ("minutemonth", -3.920321808242841),
                                    ("Augustyear (latent)", -5.306616169362732),
                                    ("week-endin|during <named-month>|year", -5.7120812774708964),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.306616169362732),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.7120812774708964),
                                    ("Sundayyear (latent)", -4.795790545596741),
                                    ("Christmasat <time-of-day>", -5.7120812774708964),
                                    ("from|since|after <time>year (latent)", -4.613468988802786),
                                    ("<duration> after|before|from <time>December",
                                     -5.7120812774708964),
                                    ("yesterday<time-of-day> am|pm", -5.7120812774708964),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.7120812774708964),
                                    ("mm/ddyear (latent)", -5.7120812774708964),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.7120812774708964),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.7120812774708964),
                                    ("at <time-of-day>intersect", -5.306616169362732),
                                    ("hh:mmyear (latent)", -4.459318308975528),
                                    ("Holiyear (latent)", -5.7120812774708964),
                                    ("until <time><time-of-day> am|pm", -5.7120812774708964),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7120812774708964),
                                    ("dayminute", -3.1471319200093593),
                                    ("yyyy-mm-ddhh:mm", -5.306616169362732),
                                    ("intersectSeptember", -4.208003880694622),
                                    ("minuteday", -2.644028342337279),
                                    ("absorption of , after named dayintersect",
                                     -5.7120812774708964),
                                    ("Februaryin|during the <part-of-day>", -5.7120812774708964),
                                    ("Saturdayyear (latent)", -5.7120812774708964),
                                    ("at <time-of-day>on <day>", -5.306616169362732),
                                    ("absorption of , after named daySeptember",
                                     -4.795790545596741),
                                    ("Naraka Chaturdashiyear (latent)", -5.7120812774708964),
                                    ("from|since|after <time>on <day>", -4.795790545596741),
                                    ("dayweek", -5.7120812774708964),
                                    ("Easter Sundayyear (latent)", -5.306616169362732),
                                    ("Thursday<time-of-day> am|pm", -4.459318308975528),
                                    ("weekyear", -5.306616169362732),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.018934096910951),
                                    ("Sundayfrom|since|after <time>", -5.7120812774708964),
                                    ("absorption of , after named dayFebruary", -4.795790545596741),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.7120812774708964),
                                    ("tomorrowat <time-of-day>", -5.7120812774708964),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.7120812774708964),
                                    ("last <cycle> of <time>year (latent)", -5.306616169362732),
                                    ("tomorrow<time-of-day> am|pm", -5.7120812774708964),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.018934096910951),
                                    ("Diwaliyear (latent)", -5.306616169362732),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.7120812774708964),
                                    ("Fridayyear (latent)", -5.306616169362732),
                                    ("minuteyear", -4.325786916351006)],
                               n = 189}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.14518200984449783, unseen = -5.10594547390058,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 160},
                   koData =
                     ClassData{prior = -2.001480000210124, unseen = -3.4011973816621555,
                               likelihoods =
                                 HashMap.fromList
