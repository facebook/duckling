...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4634630115877441, unseen = -7.045776576879511,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.351757936569426),
                                    ("Father's Dayyear (latent)", -6.351757936569426),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.351757936569426),
                                    ("Ramadanyear (latent)", -5.435467204695271),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.3368549160271606),
                                    ("Bhai Doojyear (latent)", -6.351757936569426),
                                    ("hourday", -4.3368549160271606),
                                    ("dayhour", -3.4339872044851463),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.3368549160271606),
                                    ("Martin Luther King's Dayyear (latent)", -5.946292828461261),
                                    ("Shemini Atzeretyear (latent)", -6.351757936569426),
                                    ("daymonth", -4.3368549160271606),
                                    ("monthday", -5.946292828461261),
                                    ("monthyear", -4.55999846734137),
                                    ("Yom Ha'atzmautyear (latent)", -6.351757936569426),
                                    ("Vijayadashamiyear (latent)", -6.351757936569426),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.946292828461261),
                                    ("Thanksgiving Dayyear (latent)", -5.253145647901316),
                                    ("Thai Pongalyear (latent)", -5.65861075600948),
                                    ("Thiru Onamyear (latent)", -5.65861075600948),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.351757936569426),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.435467204695271),
                                    ("<day-of-month> (ordinal)Wednesday", -6.351757936569426),
                                    ("Krishna Janmashtamiyear (latent)", -5.946292828461261),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.351757936569426),
                                    ("houryear", -5.435467204695271),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.351757936569426),
                                    ("Christmas<time-of-day> am|pm", -6.351757936569426),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.351757936569426),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.65861075600948),
                                    ("intersectin|during <named-month>|year", -6.351757936569426),
                                    ("<time-of-day> am|pmintersect", -5.098994968074058),
                                    ("Earth Houryear (latent)", -6.351757936569426),
                                    ("Family Dayyear (latent)", -5.435467204695271),
                                    ("Octoberyear (latent)", -4.847680539793151),
                                    ("intersect<time-of-day> am|pm", -6.351757936569426),
                                    ("Mattu Pongalyear (latent)", -6.351757936569426),
                                    ("Shavuotyear (latent)", -6.351757936569426),
                                    ("Parsi New Yearyear (latent)", -5.435467204695271),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.351757936569426),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.351757936569426),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.946292828461261),
                                    ("Marchyear (latent)", -6.351757936569426),
                                    ("Sukkotyear (latent)", -5.946292828461261),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.946292828461261),
                                    ("Clean Mondayyear (latent)", -5.946292828461261),
                                    ("monthhour", -5.946292828461261),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.65861075600948),
                                    ("todayat <time-of-day>", -6.351757936569426),
                                    ("Thursday<time> timezone", -4.405847787514112),
                                    ("time-of-day (latent)tonight", -5.946292828461261),
                                    ("from|since|after <time>December", -6.351757936569426),
                                    ("<time-of-day> am|pmon <day>", -4.3368549160271606),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.351757936569426),
                                    ("yyyy-mm-ddhh:mm:ss", -5.946292828461261),
                                    ("dayday", -3.909410901200221),
                                    ("<time> <part-of-day>at <time-of-day>", -6.351757936569426),
                                    ("mm/ddat <time-of-day>", -6.351757936569426),
                                    ("tonightat <time-of-day>", -6.351757936569426),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.65861075600948),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.351757936569426),
                                    ("today<time-of-day> am|pm", -6.351757936569426),
                                    ("Februarythe <day-of-month> (ordinal)", -5.946292828461261),
                                    ("at <time-of-day><time> <part-of-day>", -6.351757936569426),
                                    ("<day-of-month> (ordinal)intersect", -5.946292828461261),
                                    ("mm/dd<time-of-day> am|pm", -6.351757936569426),
                                    ("hourhour", -4.2723163948895895),
                                    ("Navaratriin|during <named-month>|year", -6.351757936569426),
                                    ("National Patriots' Dayyear (latent)", -5.65861075600948),
                                    ("Wednesdaythis|last|next <cycle>", -6.351757936569426),
                                    ("Lentyear (latent)", -6.351757936569426),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.847680539793151),
                                    ("Boghiyear (latent)", -6.351757936569426),
                                    ("dayyear", -1.846408085863545),
                                    ("Thursdayfrom|since|after <time>", -5.946292828461261),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.351757936569426),
                                    ("Thursdayat <time-of-day>", -5.65861075600948),
                                    ("Islamic New Yearyear (latent)", -5.946292828461261),
                                    ("Laylat al-Qadryear (latent)", -5.435467204695271),
                                    ("Discovery Dayyear (latent)", -5.946292828461261),
                                    ("Shrove Tuesdayyear (latent)", -6.351757936569426),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.65861075600948),
                                    ("<time-of-day> am|pmtomorrow", -5.65861075600948),
                                    ("Yom Kippuryear (latent)", -6.351757936569426),
                                    ("<day-of-month> (ordinal)Tuesday", -5.946292828461261),
                                    ("<part-of-day> of <time>year (latent)", -6.351757936569426),
                                    ("minutehour", -5.253145647901316),
                                    ("Kaanum Pongalyear (latent)", -5.946292828461261),
                                    ("Maha Saptamiyear (latent)", -6.351757936569426),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.946292828461261),
                                    ("time-of-day (latent)tomorrow", -5.435467204695271),
                                    ("part of daysat <time-of-day>", -5.946292828461261),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.647009844331),
                                    ("for <duration> from <time>December", -6.351757936569426),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.351757936569426),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.098994968074058),
                                    ("time-of-day (latent)this <part-of-day>", -6.351757936569426),
                                    ("Pentecostyear (latent)", -6.351757936569426),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.098994968074058),
                                    ("<day-of-month> (ordinal)February", -6.351757936569426),
                                    ("Eid al-Fitryear (latent)", -5.435467204695271),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.351757936569426),
                                    ("Mondayin|during the <part-of-day>", -6.351757936569426),
                                    ("Chhathin|during <named-month>|year", -6.351757936569426),
                                    ("Diwaliin|during <named-month>|year", -6.351757936569426),
                                    ("Vaisakhiin|during <named-month>|year", -6.351757936569426),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.098994968074058),
                                    ("Raksha Bandhanyear (latent)", -6.351757936569426),
                                    ("daysecond", -5.946292828461261),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.946292828461261),
                                    ("Ashurayear (latent)", -6.351757936569426),
                                    ("Tuesdayin|during <named-month>|year", -6.351757936569426),
                                    ("Chinese New Yearyear (latent)", -6.351757936569426),
                                    ("tomorrowintersect", -6.351757936569426),
                                    ("Lag BaOmeryear (latent)", -6.351757936569426),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.351757936569426),
                                    ("Eid al-Adhayear (latent)", -4.211691773073155),
                                    ("intersectin|during the <part-of-day>", -6.351757936569426),
                                    ("Palm Sundayyear (latent)", -6.351757936569426),
                                    ("Christmasat <time-of-day>", -6.351757936569426),
                                    ("Passoveryear (latent)", -6.351757936569426),
                                    ("Lazarus Saturdayyear (latent)", -6.351757936569426),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.351757936569426),
                                    ("Yom HaShoahyear (latent)", -5.946292828461261),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.946292828461261),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.351757936569426),
                                    ("Septemberyear (latent)", -5.946292828461261),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.847680539793151),
                                    ("Halloweenyear (latent)", -6.351757936569426),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.351757936569426),
                                    ("at <time-of-day>intersect", -5.946292828461261),
                                    ("Rosh Hashanahyear (latent)", -5.65861075600948),
                                    ("Dhanterasyear (latent)", -6.351757936569426),
                                    ("Tu BiShvatyear (latent)", -6.351757936569426),
                                    ("<day-of-month> (ordinal)December", -5.65861075600948),
                                    ("Holiyear (latent)", -5.65861075600948),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.351757936569426),
                                    ("Holika Dahanyear (latent)", -5.65861075600948),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.351757936569426),
                                    ("dayminute", -3.4339872044851463),
                                    ("Mawlidyear (latent)", -6.351757936569426),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.946292828461261),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.351757936569426),
                                    ("Jumu'atul-Widayear (latent)", -5.435467204695271),
                                    ("minuteday", -2.52311654008033),
                                    ("absorption of , after named dayintersect",
                                     -6.351757936569426),
                                    ("intersectyear (latent)", -6.351757936569426),
                                    ("Orthodox Easter Sundayyear (latent)", -6.351757936569426),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.351757936569426),
                                    ("Boss's Dayyear (latent)", -5.946292828461261),
                                    ("Global Youth Service Dayyear (latent)", -6.351757936569426),
                                    ("Dhanterasin|during <named-month>|year", -6.351757936569426),
                                    ("Tisha B'Avyear (latent)", -6.351757936569426),
                                    ("Isra and Mi'rajyear (latent)", -5.435467204695271),
                                    ("at <time-of-day>on <day>", -5.253145647901316),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.351757936569426),
                                    ("time-of-day (latent)<time> <part-of-day>", -5.65861075600948),
                                    ("Christmasyear (latent)", -5.946292828461261),
                                    ("Naraka Chaturdashiyear (latent)", -5.946292828461261),
                                    ("Thai Pongalin|during <named-month>|year", -6.351757936569426),
                                    ("dayweek", -6.351757936569426),
                                    ("Easter Sundayyear (latent)", -5.65861075600948),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.742320024135325),
                                    ("Labour Dayyear (latent)", -6.351757936569426),
                                    ("weekyear", -5.253145647901316),
                                    ("King's Dayyear (latent)", -4.847680539793151),
                                    ("hh:mmin|during the <part-of-day>", -5.65861075600948),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.946292828461261),
                                    ("Hanukkahyear (latent)", -5.65861075600948),
                                    ("February<time> <part-of-day>", -6.351757936569426),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.351757936569426),
                                    ("Great Lentyear (latent)", -6.351757936569426),
                                    ("tomorrowat <time-of-day>", -5.65861075600948),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.351757936569426),
                                    ("Vaisakhiyear (latent)", -5.65861075600948),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.351757936569426),
                                    ("last <cycle> of <time>year (latent)", -5.65861075600948),
                                    ("at <time-of-day>tomorrow", -5.946292828461261),
                                    ("tomorrow<time-of-day> am|pm", -6.351757936569426),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.351757936569426),
                                    ("Diwaliyear (latent)", -6.351757936569426),
                                    ("between <time> and <time>on <day>", -4.742320024135325),
                                    ("Black Fridayyear (latent)", -5.946292828461261),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.351757936569426),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.351757936569426),
                                    ("Chhathyear (latent)", -5.946292828461261),
                                    ("Vasant Panchamiyear (latent)", -6.351757936569426),
                                    ("Rabindra Jayantiyear (latent)", -5.098994968074058),
                                    ("St Patrick's Dayyear (latent)", -6.351757936569426),
                                    ("Thursday<time> (timezone)", -6.351757936569426),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.351757936569426),
                                    ("<datetime> - <datetime> (interval)July", -5.946292828461261),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.946292828461261),
                                    ("Februaryintersect", -6.351757936569426),
                                    ("Mother's Dayyear (latent)", -6.351757936569426),
                                    ("Simchat Torahyear (latent)", -6.351757936569426),
                                    ("Victoria Dayyear (latent)", -5.946292828461261),
                                    ("minuteyear", -6.351757936569426)],
                               n = 441},
                   koData =
                     ClassData{prior = -0.9918262560190623, unseen = -6.666956792429207,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.264486336120253),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.972536537222463),
                                    ("<day-of-month> (ordinal)August", -5.972536537222463),
                                    ("dayhour", -3.2983878877959345),
                                    ("<time> timezoneyear (latent)", -5.972536537222463),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.056245805348308),
                                    ("Tuesdayfrom|since|after <time>", -5.972536537222463),
                                    ("daymonth", -3.487629887434463),
                                    ("monthyear", -4.719773568727095),
                                    ("<time-of-day> am|pmyear (latent)", -5.279389356662518),
                                    ("Thai Pongalyear (latent)", -5.279389356662518),
                                    ("intersecthh:mm", -5.972536537222463),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.567071429114299),
                                    ("<day-of-month> (ordinal)Wednesday", -5.972536537222463),
                                    ("houryear", -4.586242176102573),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.972536537222463),
                                    ("<day-of-month> (ordinal)October", -5.972536537222463),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.279389356662518),
                                    ("<time-of-day> am|pmintersect", -4.719773568727095),
                                    ("Octoberyear (latent)", -5.972536537222463),
                                    ("until <time>on <day>", -5.279389356662518),
                                    ("time-of-day (latent)intersect", -5.972536537222463),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.279389356662518),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.972536537222463),
                                    ("hh:mmon <day>", -3.5301895018532585),
                                    ("absorption of , after named dayJuly", -5.567071429114299),
                                    ("from|since|after <time>July", -5.567071429114299),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.056245805348308),
                                    ("Clean Mondayyear (latent)", -5.972536537222463),
                                    ("monthhour", -5.972536537222463),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.567071429114299),
                                    ("hourmonth", -4.100734360320872),
                                    ("todayat <time-of-day>", -5.972536537222463),
                                    ("from|since|after <time>December", -5.972536537222463),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.972536537222463),
                                    ("<time-of-day> am|pmon <day>", -4.719773568727095),
                                    ("Mondayyear (latent)", -5.279389356662518),
                                    ("dayday", -4.586242176102573),
                                    ("mm/ddat <time-of-day>", -5.567071429114299),
                                    ("on <day>September", -5.567071429114299),
                                    ("time-of-day (latent)September", -5.567071429114299),
                                    ("hourhour", -5.972536537222463),
                                    ("time-of-day (latent)on <day>", -3.5301895018532585),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.567071429114299),
                                    ("dayyear", -3.0280975580560225),
                                    ("Thursdaymm/dd", -5.972536537222463),
                                    ("New Year's Dayyear (latent)", -5.056245805348308),
                                    ("Thursdayfrom|since|after <time>", -4.2677884449840375),
                                    ("Thursdayat <time-of-day>", -4.363098624788362),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.972536537222463),
                                    ("Aprilyear (latent)", -5.972536537222463),
                                    ("the <day-of-month> (ordinal)July", -5.972536537222463),
                                    ("the <day-of-month> (number)July", -5.972536537222463),
                                    ("monthminute", -5.972536537222463),
                                    ("<time-of-day> am|pmtomorrow", -5.972536537222463),
                                    ("Thursdayhh:mm", -5.056245805348308),
                                    ("<day-of-month> (ordinal)Tuesday", -5.567071429114299),
                                    ("minutemonth", -4.100734360320872),
                                    ("minutehour", -5.972536537222463),
                                    ("Augustyear (latent)", -5.567071429114299),
                                    ("week-endin|during <named-month>|year", -5.972536537222463),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.567071429114299),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.972536537222463),
                                    ("Sundayyear (latent)", -5.056245805348308),
                                    ("Christmasat <time-of-day>", -5.972536537222463),
                                    ("from|since|after <time>year (latent)", -4.873924248554354),
                                    ("<duration> after|before|from <time>December",
                                     -5.972536537222463),
                                    ("yesterday<time-of-day> am|pm", -5.972536537222463),
                                    ("<day-of-month> (ordinal)July", -5.279389356662518),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.972536537222463),
                                    ("mm/ddyear (latent)", -5.972536537222463),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.972536537222463),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.972536537222463),
                                    ("at <time-of-day>intersect", -5.567071429114299),
                                    ("hh:mmyear (latent)", -3.893094995542627),
                                    ("Holiyear (latent)", -5.972536537222463),
                                    ("until <time><time-of-day> am|pm", -5.972536537222463),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.972536537222463),
                                    ("dayminute", -3.4075871797609265),
                                    ("yyyy-mm-ddhh:mm", -5.567071429114299),
                                    ("intersectSeptember", -4.468459140446189),
                                    ("minuteday", -2.7338580850580825),
                                    ("absorption of , after named dayintersect",
                                     -5.972536537222463),
                                    ("intersectyear (latent)", -5.972536537222463),
                                    ("Februaryin|during the <part-of-day>", -5.972536537222463),
                                    ("time-of-day (latent)July", -5.279389356662518),
                                    ("Saturdayyear (latent)", -5.972536537222463),
                                    ("at <time-of-day>on <day>", -5.567071429114299),
                                    ("absorption of , after named daySeptember",
                                     -5.056245805348308),
                                    ("Naraka Chaturdashiyear (latent)", -5.972536537222463),
                                    ("from|since|after <time>on <day>", -5.056245805348308),
                                    ("dayweek", -5.972536537222463),
                                    ("Easter Sundayyear (latent)", -5.567071429114299),
                                    ("Thursday<time-of-day> am|pm", -4.719773568727095),
                                    ("weekyear", -5.567071429114299),
                                    ("time-of-day (latent)Thursday", -5.567071429114299),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.972536537222463),
                                    ("<day-of-month> (ordinal)April", -5.972536537222463),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.567071429114299),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.279389356662518),
                                    ("Sundayfrom|since|after <time>", -5.972536537222463),
                                    ("absorption of , after named dayFebruary", -5.056245805348308),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.972536537222463),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.972536537222463),
                                    ("tomorrowat <time-of-day>", -5.972536537222463),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.567071429114299),
                                    ("last <cycle> of <time>year (latent)", -5.567071429114299),
                                    ("tomorrow<time-of-day> am|pm", -5.972536537222463),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.279389356662518),
                                    ("Diwaliyear (latent)", -5.567071429114299),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.972536537222463),
                                    ("Fridayyear (latent)", -5.567071429114299),
                                    ("time-of-day (latent)April", -5.972536537222463),
                                    ("minuteyear", -3.7753119598862437)],
                               n = 260}}),
       ("one eleven",
        Classifier{okData =
