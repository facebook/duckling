...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.8214015160836241,
                               unseen = -5.2574953720277815,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 190},
                   koData =
                     ClassData{prior = -0.5794878620874239, unseen = -5.497168225293202,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 242}}),
       ("<duration> hence|ago",
        Classifier{okData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Martin Luther King's Day", -2.803360380906535),
                                    ...
                                    ("Canada/Dominion/Memorial Day", -2.803360380906535)],
                               n = 11},
                   koData =
