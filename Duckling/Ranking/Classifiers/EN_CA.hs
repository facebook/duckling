...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6724669753224065, unseen = -5.840641657373398,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 342},
                   koData =
                     ClassData{prior = -0.714264104000868, unseen = -5.799092654460526,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.49375771525384266,
                               unseen = -6.943122422819428,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.249009525139524),
                                    ("Father's Dayyear (latent)", -6.249009525139524),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.249009525139524),
                                    ("Ramadanyear (latent)", -6.249009525139524),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.23410650459726),
                                    ("Bhai Doojyear (latent)", -6.249009525139524),
                                    ("hourday", -4.23410650459726), ("dayhour", -3.331238793055245),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.23410650459726),
                                    ("Martin Luther King's Dayyear (latent)", -5.84354441703136),
                                    ("Shemini Atzeretyear (latent)", -6.249009525139524),
                                    ("daymonth", -4.639571612705423),
                                    ("monthday", -5.84354441703136),
                                    ("monthyear", -4.457250055911469),
                                    ("Yom Ha'atzmautyear (latent)", -6.249009525139524),
                                    ("Vijayadashamiyear (latent)", -6.249009525139524),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.84354441703136),
                                    ("Thanksgiving Dayyear (latent)", -5.150397236471415),
                                    ("Thai Pongalyear (latent)", -5.5558623445795785),
                                    ("Thiru Onamyear (latent)", -5.5558623445795785),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.249009525139524),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.249009525139524),
                                    ("<day-of-month> (ordinal)Wednesday", -6.249009525139524),
                                    ("houryear", -5.332718793265369),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.249009525139524),
                                    ("Christmas<time-of-day> am|pm", -6.249009525139524),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.249009525139524),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.5558623445795785),
                                    ("intersectin|during <named-month>|year", -6.249009525139524),
                                    ("<time-of-day> am|pmintersect", -4.996246556644156),
                                    ("Earth Houryear (latent)", -6.249009525139524),
                                    ("Family Dayyear (latent)", -5.332718793265369),
                                    ("Octoberyear (latent)", -4.74493212836325),
                                    ("intersect<time-of-day> am|pm", -6.249009525139524),
                                    ("Mattu Pongalyear (latent)", -6.249009525139524),
                                    ("Shavuotyear (latent)", -6.249009525139524),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.249009525139524),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.249009525139524),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.84354441703136),
                                    ("Marchyear (latent)", -6.249009525139524),
                                    ("Sukkotyear (latent)", -5.84354441703136),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.84354441703136),
                                    ("Clean Mondayyear (latent)", -5.84354441703136),
                                    ("monthhour", -5.84354441703136),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.5558623445795785),
                                    ("todayat <time-of-day>", -6.249009525139524),
                                    ("Thursday<time> timezone", -4.3030993760842104),
                                    ("time-of-day (latent)tonight", -5.84354441703136),
                                    ("from|since|after <time>December", -6.249009525139524),
                                    ("<time-of-day> am|pmon <day>", -4.23410650459726),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.249009525139524),
                                    ("yyyy-mm-ddhh:mm:ss", -5.84354441703136),
                                    ("dayday", -3.8066624897703196),
                                    ("<time> <part-of-day>at <time-of-day>", -6.249009525139524),
                                    ("mm/ddat <time-of-day>", -6.249009525139524),
                                    ("tonightat <time-of-day>", -6.249009525139524),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.5558623445795785),
                                    ("today<time-of-day> am|pm", -6.249009525139524),
                                    ("Februarythe <day-of-month> (ordinal)", -5.84354441703136),
                                    ("at <time-of-day><time> <part-of-day>", -6.249009525139524),
                                    ("<day-of-month> (ordinal)intersect", -5.84354441703136),
                                    ("mm/dd<time-of-day> am|pm", -6.249009525139524),
                                    ("hourhour", -4.169567983459689),
                                    ("Navaratriin|during <named-month>|year", -6.249009525139524),
                                    ("National Patriots' Dayyear (latent)", -5.5558623445795785),
                                    ("Wednesdaythis|last|next <cycle>", -6.249009525139524),
                                    ("Lentyear (latent)", -6.249009525139524),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.74493212836325),
                                    ("Boghiyear (latent)", -6.249009525139524),
                                    ("dayyear", -2.03688192726104),
                                    ("Thursdayfrom|since|after <time>", -5.84354441703136),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.249009525139524),
                                    ("Thursdayat <time-of-day>", -5.5558623445795785),
                                    ("Islamic New Yearyear (latent)", -5.84354441703136),
                                    ("Laylat al-Qadryear (latent)", -5.332718793265369),
                                    ("Discovery Dayyear (latent)", -5.84354441703136),
                                    ("Shrove Tuesdayyear (latent)", -6.249009525139524),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.5558623445795785),
                                    ("<time-of-day> am|pmtomorrow", -5.5558623445795785),
                                    ("Yom Kippuryear (latent)", -6.249009525139524),
                                    ("<day-of-month> (ordinal)Tuesday", -5.84354441703136),
                                    ("<part-of-day> of <time>year (latent)", -6.249009525139524),
                                    ("minutehour", -5.150397236471415),
                                    ("Kaanum Pongalyear (latent)", -5.84354441703136),
                                    ("Maha Saptamiyear (latent)", -6.249009525139524),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.84354441703136),
                                    ("time-of-day (latent)tomorrow", -5.332718793265369),
                                    ("part of daysat <time-of-day>", -5.84354441703136),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.544261432901099),
                                    ("for <duration> from <time>December", -6.249009525139524),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.249009525139524),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.996246556644156),
                                    ("time-of-day (latent)this <part-of-day>", -6.249009525139524),
                                    ("Pentecostyear (latent)", -6.249009525139524),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.996246556644156),
                                    ("<day-of-month> (ordinal)February", -6.249009525139524),
                                    ("Eid al-Fitryear (latent)", -6.249009525139524),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.249009525139524),
                                    ("Mondayin|during the <part-of-day>", -6.249009525139524),
                                    ("Chhathin|during <named-month>|year", -6.249009525139524),
                                    ("Diwaliin|during <named-month>|year", -6.249009525139524),
                                    ("Vaisakhiin|during <named-month>|year", -6.249009525139524),
                                    ("Raksha Bandhanyear (latent)", -6.249009525139524),
                                    ("daysecond", -5.84354441703136),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.84354441703136),
                                    ("Ashurayear (latent)", -6.249009525139524),
                                    ("Tuesdayin|during <named-month>|year", -6.249009525139524),
                                    ("Chinese New Yearyear (latent)", -6.249009525139524),
                                    ("tomorrowintersect", -6.249009525139524),
                                    ("Lag BaOmeryear (latent)", -6.249009525139524),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.249009525139524),
                                    ("Eid al-Adhayear (latent)", -5.332718793265369),
                                    ("intersectin|during the <part-of-day>", -6.249009525139524),
                                    ("Palm Sundayyear (latent)", -6.249009525139524),
                                    ("Christmasat <time-of-day>", -6.249009525139524),
                                    ("Passoveryear (latent)", -6.249009525139524),
                                    ("Lazarus Saturdayyear (latent)", -6.249009525139524),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.249009525139524),
                                    ("Yom HaShoahyear (latent)", -5.84354441703136),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.84354441703136),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.249009525139524),
                                    ("Septemberyear (latent)", -5.84354441703136),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.74493212836325),
                                    ("Halloweenyear (latent)", -6.249009525139524),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.249009525139524),
                                    ("at <time-of-day>intersect", -5.84354441703136),
                                    ("Rosh Hashanahyear (latent)", -5.5558623445795785),
                                    ("Dhanterasyear (latent)", -6.249009525139524),
                                    ("Tu BiShvatyear (latent)", -6.249009525139524),
                                    ("<day-of-month> (ordinal)December", -5.5558623445795785),
                                    ("Holiyear (latent)", -5.5558623445795785),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.249009525139524),
                                    ("Holika Dahanyear (latent)", -5.5558623445795785),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.249009525139524),
                                    ("dayminute", -3.331238793055245),
                                    ("Mawlidyear (latent)", -6.249009525139524),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.84354441703136),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.249009525139524),
                                    ("Jumu'atul-Widayear (latent)", -5.332718793265369),
                                    ("minuteday", -2.4203681286504293),
                                    ("absorption of , after named dayintersect",
                                     -6.249009525139524),
                                    ("intersectyear (latent)", -6.249009525139524),
                                    ("Orthodox Easter Sundayyear (latent)", -6.249009525139524),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.249009525139524),
                                    ("Boss's Dayyear (latent)", -5.84354441703136),
                                    ("Global Youth Service Dayyear (latent)", -6.249009525139524),
                                    ("Dhanterasin|during <named-month>|year", -6.249009525139524),
                                    ("Tisha B'Avyear (latent)", -6.249009525139524),
                                    ("Isra and Mi'rajyear (latent)", -5.332718793265369),
                                    ("at <time-of-day>on <day>", -5.150397236471415),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.249009525139524),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.5558623445795785),
                                    ("Christmasyear (latent)", -5.84354441703136),
                                    ("Naraka Chaturdashiyear (latent)", -5.84354441703136),
                                    ("Thai Pongalin|during <named-month>|year", -6.249009525139524),
                                    ("dayweek", -6.249009525139524),
                                    ("Easter Sundayyear (latent)", -5.5558623445795785),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.639571612705423),
                                    ("Labour Dayyear (latent)", -6.249009525139524),
                                    ("weekyear", -5.150397236471415),
                                    ("hh:mmin|during the <part-of-day>", -5.5558623445795785),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.84354441703136),
                                    ("Hanukkahyear (latent)", -5.5558623445795785),
                                    ("February<time> <part-of-day>", -6.249009525139524),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.249009525139524),
                                    ("Great Lentyear (latent)", -6.249009525139524),
                                    ("tomorrowat <time-of-day>", -5.5558623445795785),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.249009525139524),
                                    ("Vaisakhiyear (latent)", -5.5558623445795785),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.249009525139524),
                                    ("last <cycle> of <time>year (latent)", -5.5558623445795785),
                                    ("at <time-of-day>tomorrow", -5.84354441703136),
                                    ("tomorrow<time-of-day> am|pm", -6.249009525139524),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.249009525139524),
                                    ("Diwaliyear (latent)", -6.249009525139524),
                                    ("between <time> and <time>on <day>", -4.639571612705423),
                                    ("Black Fridayyear (latent)", -5.84354441703136),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.249009525139524),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.249009525139524),
                                    ("Chhathyear (latent)", -5.84354441703136),
                                    ("Vasant Panchamiyear (latent)", -6.249009525139524),
                                    ("St Patrick's Dayyear (latent)", -6.249009525139524),
                                    ("Thursday<time> (timezone)", -6.249009525139524),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.249009525139524),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.84354441703136),
                                    ("Februaryintersect", -6.249009525139524),
                                    ("Mother's Dayyear (latent)", -6.249009525139524),
                                    ("Simchat Torahyear (latent)", -6.249009525139524),
                                    ("Victoria Dayyear (latent)", -5.84354441703136),
                                    ("minuteyear", -6.249009525139524)],
                               n = 390},
                   koData =
                     ClassData{prior = -0.9424515579128272, unseen = -6.625392368007956,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.222867846137738),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.930918047239948),
                                    ("<day-of-month> (ordinal)August", -5.930918047239948),
                                    ("dayhour", -3.2567693978134193),
                                    ("<time> timezoneyear (latent)", -5.930918047239948),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.014627315365793),
                                    ("Tuesdayfrom|since|after <time>", -5.930918047239948),
                                    ("daymonth", -3.6796262486334532),
                                    ("monthyear", -4.67815507874458),
                                    ("<time-of-day> am|pmyear (latent)", -5.237770866680003),
                                    ("Thai Pongalyear (latent)", -5.237770866680003),
                                    ("intersecthh:mm", -5.930918047239948),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.930918047239948),
                                    ("<day-of-month> (ordinal)Wednesday", -5.930918047239948),
                                    ("houryear", -4.544623686120057),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.930918047239948),
                                    ("<day-of-month> (ordinal)October", -5.930918047239948),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.237770866680003),
                                    ("<time-of-day> am|pmintersect", -4.67815507874458),
                                    ("Octoberyear (latent)", -5.930918047239948),
                                    ("until <time>on <day>", -5.237770866680003),
                                    ("time-of-day (latent)intersect", -5.930918047239948),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.237770866680003),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.930918047239948),
                                    ("hh:mmon <day>", -3.488571011870744),
                                    ("absorption of , after named dayJuly", -5.5254529391317835),
                                    ("from|since|after <time>July", -5.930918047239948),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.014627315365793),
                                    ("Clean Mondayyear (latent)", -5.930918047239948),
                                    ("monthhour", -5.930918047239948),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.5254529391317835),
                                    ("hourmonth", -4.321480134805848),
                                    ("todayat <time-of-day>", -5.930918047239948),
                                    ("from|since|after <time>December", -5.930918047239948),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.930918047239948),
                                    ("<time-of-day> am|pmon <day>", -4.67815507874458),
                                    ("Mondayyear (latent)", -5.237770866680003),
                                    ("dayday", -4.544623686120057),
                                    ("mm/ddat <time-of-day>", -5.5254529391317835),
                                    ("on <day>September", -5.5254529391317835),
                                    ("time-of-day (latent)September", -5.5254529391317835),
                                    ("hourhour", -5.930918047239948),
                                    ("time-of-day (latent)on <day>", -3.488571011870744),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.5254529391317835),
                                    ("dayyear", -3.0405462893437836),
                                    ("Thursdaymm/dd", -5.930918047239948),
                                    ("New Year's Dayyear (latent)", -5.5254529391317835),
                                    ("Thursdayfrom|since|after <time>", -4.226169955001523),
                                    ("Thursdayat <time-of-day>", -4.321480134805848),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.930918047239948),
                                    ("Aprilyear (latent)", -5.930918047239948),
                                    ("monthminute", -5.930918047239948),
                                    ("<time-of-day> am|pmtomorrow", -5.930918047239948),
                                    ("Thursdayhh:mm", -5.014627315365793),
                                    ("<day-of-month> (ordinal)Tuesday", -5.5254529391317835),
                                    ("minutemonth", -4.139158578011894),
                                    ("minutehour", -5.930918047239948),
                                    ("Augustyear (latent)", -5.5254529391317835),
                                    ("week-endin|during <named-month>|year", -5.930918047239948),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.5254529391317835),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.930918047239948),
                                    ("Sundayyear (latent)", -5.014627315365793),
                                    ("Christmasat <time-of-day>", -5.930918047239948),
                                    ("from|since|after <time>year (latent)", -4.832305758571839),
                                    ("<duration> after|before|from <time>December",
                                     -5.930918047239948),
                                    ("yesterday<time-of-day> am|pm", -5.930918047239948),
                                    ("<day-of-month> (ordinal)July", -5.930918047239948),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.930918047239948),
                                    ("mm/ddyear (latent)", -5.930918047239948),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.930918047239948),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.930918047239948),
                                    ("at <time-of-day>intersect", -5.5254529391317835),
                                    ("hh:mmyear (latent)", -3.8514765055601123),
                                    ("Holiyear (latent)", -5.930918047239948),
                                    ("until <time><time-of-day> am|pm", -5.930918047239948),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.930918047239948),
                                    ("dayminute", -3.365968689778412),
                                    ("yyyy-mm-ddhh:mm", -5.5254529391317835),
                                    ("intersectSeptember", -4.426840650463674),
                                    ("minuteday", -2.6922395950755678),
                                    ("absorption of , after named dayintersect",
                                     -5.930918047239948),
                                    ("intersectyear (latent)", -5.930918047239948),
                                    ("Februaryin|during the <part-of-day>", -5.930918047239948),
                                    ("time-of-day (latent)July", -5.930918047239948),
                                    ("Saturdayyear (latent)", -5.930918047239948),
                                    ("at <time-of-day>on <day>", -5.5254529391317835),
                                    ("absorption of , after named daySeptember",
                                     -5.014627315365793),
                                    ("Naraka Chaturdashiyear (latent)", -5.930918047239948),
                                    ("from|since|after <time>on <day>", -5.014627315365793),
                                    ("dayweek", -5.930918047239948),
                                    ("Easter Sundayyear (latent)", -5.5254529391317835),
                                    ("Thursday<time-of-day> am|pm", -4.67815507874458),
                                    ("weekyear", -5.5254529391317835),
                                    ("time-of-day (latent)Thursday", -5.5254529391317835),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.930918047239948),
                                    ("<day-of-month> (ordinal)April", -5.930918047239948),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.5254529391317835),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.237770866680003),
                                    ("Sundayfrom|since|after <time>", -5.930918047239948),
                                    ("absorption of , after named dayFebruary", -5.014627315365793),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.930918047239948),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.930918047239948),
                                    ("tomorrowat <time-of-day>", -5.930918047239948),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.930918047239948),
                                    ("last <cycle> of <time>year (latent)", -5.5254529391317835),
                                    ("tomorrow<time-of-day> am|pm", -5.930918047239948),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.237770866680003),
                                    ("Diwaliyear (latent)", -5.5254529391317835),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.930918047239948),
                                    ("Fridayyear (latent)", -5.5254529391317835),
                                    ("time-of-day (latent)April", -5.930918047239948),
                                    ("minuteyear", -3.733693469903729)],
                               n = 249}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.19782574332991992, unseen = -5.10594547390058,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.7271394797231655e-2),
                                    ("intersect 2 numbers", -3.713572066704308)],
                               n = 160},
                   koData =
                     ClassData{prior = -1.717651497074333, unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
