...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7703960328939159, unseen = -5.272999558563747,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 193},
                   koData =
                     ClassData{prior = -0.6214401699437616, unseen = -5.420534999272286,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5020919437972361, unseen = -6.322565239927284,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("Christmasyear", -5.627621113690637),
                                    ...
                                    ("August Bank Holidayyear", -4.9344739331306915),
                                    ...
                                    ("Father's Dayyear", -5.627621113690637),
                               ...
                               n = 207},
                   koData =
                     ClassData{prior = -0.9295359586241757, unseen = -6.023447592961032,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.327876168789581),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.327876168789581),
                                    ("hourday", -5.327876168789581),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.327876168789581),
                                    ("dayhour", -2.9299808959912106),
                                    ("daymonth", -3.248434627109745),
                                    ("monthday", -4.922411060681417),
                                    ("monthyear", -4.634728988229636),
                                    ("intersecthh:mm", -5.327876168789581),
                                    ("Easter Sundayyear", -5.327876168789581),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.327876168789581),
                                    ("houryear", -5.327876168789581),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.327876168789581),
                                    ("until <time-of-day><time-of-day> am|pm", -5.327876168789581),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.634728988229636),
                                    ("<time-of-day> am|pmintersect", -4.075113200294213),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.411585436915426),
                                    ("from|since|after <time-of-day>on <date>", -4.411585436915426),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.327876168789581),
                                    ("absorption of , after named dayJuly", -4.922411060681417),
                                    ("monthhour", -5.327876168789581),
                                    ("hourmonth", -4.634728988229636),
                                    ("todayat <time-of-day>", -5.327876168789581),
                                    ("from|since|after <time-of-day>July", -5.327876168789581),
                                    ("dayday", -4.922411060681417),
                                    ("dd/mmat <time-of-day>", -4.922411060681417),
                                    ("<time-of-day> am|pmon <date>", -4.075113200294213),
                                    ("Thursdaydd/mm", -5.327876168789581),
                                    ("dayyear", -3.4560739918879895),
                                    ("Sundayyear", -4.922411060681417),
                                    ("Thursdayat <time-of-day>", -4.075113200294213),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.327876168789581),
                                    ("monthminute", -5.327876168789581),
                                    ("<time-of-day> am|pmtomorrow", -5.327876168789581),
                                    ("Thursdayhh:mm", -4.411585436915426),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.327876168789581),
                                    ("Fridayyear", -4.922411060681417),
                                    ("minutemonth", -3.536116699561526),
                                    ("Sundayfrom|since|after <time-of-day>", -5.327876168789581),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.922411060681417),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.922411060681417),
                                    ("Aprilyear", -5.327876168789581),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.327876168789581),
                                    ...
                                    ("<duration> after|before|from <time>December",
                                     -5.327876168789581),
                                    ("yesterday<time-of-day> am|pm", -5.327876168789581),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.411585436915426),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.922411060681417),
                                    ("Bank Holidayyear", -4.634728988229636),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.327876168789581),
                                    ("until <time-of-day>on <date>", -4.634728988229636),
                                    ("at <time-of-day>intersect", -4.922411060681417),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.327876168789581),
                                    ("dayminute", -2.8021475244813256),
                                    ("intersectSeptember", -3.823798772013307),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.327876168789581),
                                    ("minuteday", -2.410105436705302),
                                    ("absorption of , after named dayintersect",
                                     -5.327876168789581),
                                    ("Februaryin|during the <part-of-day>", -5.327876168789581),
                                    ("week-endin <named-month>", -5.327876168789581),
                                    ("Octoberyear", -5.327876168789581),
                                    ("from|since|after <time-of-day>year", -5.327876168789581),
                                    ("yearhh:mm", -5.327876168789581),
                                    ("hh:mmon <date>", -3.823798772013307),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.327876168789581),
                                    ("absorption of , after named daySeptember",
                                     -4.411585436915426),
                                    ("on <date>September", -4.922411060681417),
                                    ("at <time-of-day>on <date>", -4.922411060681417),
                                    ("dayweek", -5.327876168789581),
                                    ("Thursday<time-of-day> am|pm", -4.922411060681417),
                                    ("absorption of , after named dayFebruary", -4.411585436915426),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.327876168789581),
                                    ("tomorrowat <time-of-day>", -5.327876168789581),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.327876168789581),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.7184382563554808),
                                    ("tomorrow<time-of-day> am|pm", -5.327876168789581),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.327876168789581),
                                    ("yearminute", -5.327876168789581)],
                               n = 135}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
