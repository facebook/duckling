...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4849722449396568, unseen = -7.028201432058005,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.334167333479831),
                                    ("Father's Dayyear (latent)", -6.334167333479831),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.334167333479831),
                                    ("Ramadanyear (latent)", -5.417876601605676),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.319264312937566),
                                    ("Bhai Doojyear (latent)", -6.334167333479831),
                                    ("hourday", -4.319264312937566),
                                    ("dayhour", -3.416396601395552),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.319264312937566),
                                    ("Martin Luther King's Dayyear (latent)", -5.928702225371667),
                                    ("Shemini Atzeretyear (latent)", -6.334167333479831),
                                    ("daymonth", -4.319264312937566),
                                    ("monthday", -5.928702225371667),
                                    ("monthyear", -4.542407864251776),
                                    ("Yom Ha'atzmautyear (latent)", -6.334167333479831),
                                    ("Vijayadashamiyear (latent)", -6.334167333479831),
                                    ("Thanksgiving Dayyear (latent)", -5.235555044811721),
                                    ("Thai Pongalyear (latent)", -5.641020152919886),
                                    ("Thiru Onamyear (latent)", -5.641020152919886),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.334167333479831),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.417876601605676),
                                    ("<day-of-month> (ordinal)Wednesday", -6.334167333479831),
                                    ("Krishna Janmashtamiyear (latent)", -5.928702225371667),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.334167333479831),
                                    ("houryear", -5.417876601605676),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.334167333479831),
                                    ("Christmas<time-of-day> am|pm", -6.334167333479831),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.334167333479831),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.641020152919886),
                                    ("intersectin|during <named-month>|year", -6.334167333479831),
                                    ("<time-of-day> am|pmintersect", -5.081404364984463),
                                    ("Earth Houryear (latent)", -6.334167333479831),
                                    ("Octoberyear (latent)", -4.830089936703557),
                                    ("intersect<time-of-day> am|pm", -6.334167333479831),
                                    ("Mattu Pongalyear (latent)", -6.334167333479831),
                                    ("Shavuotyear (latent)", -6.334167333479831),
                                    ("Parsi New Yearyear (latent)", -5.417876601605676),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.334167333479831),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.334167333479831),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.928702225371667),
                                    ("Marchyear (latent)", -6.334167333479831),
                                    ("Sukkotyear (latent)", -5.928702225371667),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.928702225371667),
                                    ("Clean Mondayyear (latent)", -5.928702225371667),
                                    ("monthhour", -5.928702225371667),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.641020152919886),
                                    ("todayat <time-of-day>", -6.334167333479831),
                                    ("Thursday<time> timezone", -4.388257184424518),
                                    ("time-of-day (latent)tonight", -5.928702225371667),
                                    ("from|since|after <time>December", -6.334167333479831),
                                    ("dd/mm<time-of-day> am|pm", -6.334167333479831),
                                    ("<time-of-day> am|pmon <day>", -4.319264312937566),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.334167333479831),
                                    ("yyyy-mm-ddhh:mm:ss", -5.928702225371667),
                                    ("dayday", -3.891820298110627),
                                    ("dd/mmat <time-of-day>", -6.334167333479831),
                                    ("<time> <part-of-day>at <time-of-day>", -6.334167333479831),
                                    ("tonightat <time-of-day>", -6.334167333479831),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.641020152919886),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.334167333479831),
                                    ("today<time-of-day> am|pm", -6.334167333479831),
                                    ("Februarythe <day-of-month> (ordinal)", -5.928702225371667),
                                    ("at <time-of-day><time> <part-of-day>", -6.334167333479831),
                                    ("<day-of-month> (ordinal)intersect", -5.928702225371667),
                                    ("hourhour", -4.254725791799995),
                                    ("Navaratriin|during <named-month>|year", -6.334167333479831),
                                    ("Wednesdaythis|last|next <cycle>", -6.334167333479831),
                                    ("Lentyear (latent)", -6.334167333479831),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.830089936703557),
                                    ("Boghiyear (latent)", -6.334167333479831),
                                    ("dayyear", -1.8856509575371163),
                                    ("Thursdayfrom|since|after <time>", -5.928702225371667),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.334167333479831),
                                    ("Thursdayat <time-of-day>", -5.641020152919886),
                                    ("Islamic New Yearyear (latent)", -5.928702225371667),
                                    ("Laylat al-Qadryear (latent)", -5.417876601605676),
                                    ("Shrove Tuesdayyear (latent)", -6.334167333479831),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.641020152919886),
                                    ("<time-of-day> am|pmtomorrow", -5.641020152919886),
                                    ("Yom Kippuryear (latent)", -6.334167333479831),
                                    ("<day-of-month> (ordinal)Tuesday", -5.928702225371667),
                                    ("<part-of-day> of <time>year (latent)", -6.334167333479831),
                                    ("minutehour", -5.235555044811721),
                                    ("Kaanum Pongalyear (latent)", -5.928702225371667),
                                    ("Maha Saptamiyear (latent)", -6.334167333479831),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.928702225371667),
                                    ("time-of-day (latent)tomorrow", -5.417876601605676),
                                    ("part of daysat <time-of-day>", -5.928702225371667),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.629419241241406),
                                    ("for <duration> from <time>December", -6.334167333479831),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.334167333479831),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.081404364984463),
                                    ("time-of-day (latent)this <part-of-day>", -6.334167333479831),
                                    ("Pentecostyear (latent)", -6.334167333479831),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.081404364984463),
                                    ("<day-of-month> (ordinal)February", -6.334167333479831),
                                    ("Eid al-Fitryear (latent)", -5.417876601605676),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.334167333479831),
                                    ("Mondayin|during the <part-of-day>", -6.334167333479831),
                                    ("Chhathin|during <named-month>|year", -6.334167333479831),
                                    ("Diwaliin|during <named-month>|year", -6.334167333479831),
                                    ("Vaisakhiin|during <named-month>|year", -6.334167333479831),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.081404364984463),
                                    ("Raksha Bandhanyear (latent)", -6.334167333479831),
                                    ("daysecond", -5.928702225371667),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.928702225371667),
                                    ("Ashurayear (latent)", -6.334167333479831),
                                    ("Tuesdayin|during <named-month>|year", -6.334167333479831),
                                    ("Chinese New Yearyear (latent)", -6.334167333479831),
                                    ("tomorrowintersect", -6.334167333479831),
                                    ("Lag BaOmeryear (latent)", -6.334167333479831),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.334167333479831),
                                    ("Eid al-Adhayear (latent)", -4.19410116998356),
                                    ("intersectin|during the <part-of-day>", -6.334167333479831),
                                    ("Palm Sundayyear (latent)", -6.334167333479831),
                                    ("Christmasat <time-of-day>", -6.334167333479831),
                                    ("Passoveryear (latent)", -6.334167333479831),
                                    ("Lazarus Saturdayyear (latent)", -6.334167333479831),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.334167333479831),
                                    ("Yom HaShoahyear (latent)", -5.928702225371667),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.928702225371667),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.334167333479831),
                                    ("Septemberyear (latent)", -5.928702225371667),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.830089936703557),
                                    ("Halloweenyear (latent)", -6.334167333479831),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.334167333479831),
                                    ("at <time-of-day>intersect", -5.928702225371667),
                                    ("Rosh Hashanahyear (latent)", -5.641020152919886),
                                    ("Dhanterasyear (latent)", -6.334167333479831),
                                    ("Tu BiShvatyear (latent)", -6.334167333479831),
                                    ("<day-of-month> (ordinal)December", -5.641020152919886),
                                    ("Holiyear (latent)", -5.641020152919886),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.334167333479831),
                                    ("Holika Dahanyear (latent)", -5.641020152919886),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.334167333479831),
                                    ("dayminute", -3.416396601395552),
                                    ("Mawlidyear (latent)", -6.334167333479831),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.928702225371667),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.334167333479831),
                                    ("Jumu'atul-Widayear (latent)", -5.417876601605676),
                                    ("minuteday", -2.505525936990736),
                                    ("absorption of , after named dayintersect",
                                     -6.334167333479831),
                                    ("intersectyear (latent)", -6.334167333479831),
                                    ("Orthodox Easter Sundayyear (latent)", -6.334167333479831),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.334167333479831),
                                    ("Mothering Sundayyear (latent)", -5.928702225371667),
                                    ("Boss's Dayyear (latent)", -5.928702225371667),
                                    ("Global Youth Service Dayyear (latent)", -6.334167333479831),
                                    ("Dhanterasin|during <named-month>|year", -6.334167333479831),
                                    ("Tisha B'Avyear (latent)", -6.334167333479831),
                                    ("Isra and Mi'rajyear (latent)", -5.417876601605676),
                                    ("at <time-of-day>on <day>", -5.235555044811721),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.334167333479831),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.641020152919886),
                                    ("Christmasyear (latent)", -5.928702225371667),
                                    ("Naraka Chaturdashiyear (latent)", -5.928702225371667),
                                    ("Thai Pongalin|during <named-month>|year", -6.334167333479831),
                                    ("dayweek", -6.334167333479831),
                                    ("Easter Sundayyear (latent)", -5.641020152919886),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.724729421045731),
                                    ("weekyear", -5.235555044811721),
                                    ("King's Dayyear (latent)", -4.830089936703557),
                                    ("hh:mmin|during the <part-of-day>", -5.641020152919886),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.928702225371667),
                                    ("Hanukkahyear (latent)", -5.641020152919886),
                                    ("February<time> <part-of-day>", -6.334167333479831),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.334167333479831),
                                    ("Great Lentyear (latent)", -6.334167333479831),
                                    ("tomorrowat <time-of-day>", -5.641020152919886),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.334167333479831),
                                    ("Vaisakhiyear (latent)", -5.641020152919886),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.334167333479831),
                                    ("last <cycle> of <time>year (latent)", -5.641020152919886),
                                    ("at <time-of-day>tomorrow", -5.928702225371667),
                                    ("tomorrow<time-of-day> am|pm", -6.334167333479831),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.334167333479831),
                                    ("Diwaliyear (latent)", -6.334167333479831),
                                    ("between <time> and <time>on <day>", -4.724729421045731),
                                    ("Black Fridayyear (latent)", -5.928702225371667),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.334167333479831),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.334167333479831),
                                    ("Chhathyear (latent)", -5.928702225371667),
                                    ("Vasant Panchamiyear (latent)", -6.334167333479831),
                                    ("Rabindra Jayantiyear (latent)", -5.081404364984463),
                                    ("St Patrick's Dayyear (latent)", -6.334167333479831),
                                    ("Thursday<time> (timezone)", -6.334167333479831),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.334167333479831),
                                    ("August Bank Holidayyear (latent)", -5.641020152919886),
                                    ("<datetime> - <datetime> (interval)July", -5.928702225371667),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.928702225371667),
                                    ("Februaryintersect", -6.334167333479831),
                                    ("Simchat Torahyear (latent)", -6.334167333479831),
                                    ("minuteyear", -6.334167333479831)],
                               n = 431},
                   koData =
                     ClassData{prior = -0.9563689554415655,
                               unseen = -6.6895992691789665,
                               likelihoods =
                                 HashMap.fromList
                                   [("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.589742425278652),
                                    ("hourday", -3.2871573322846066),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.995207533386816),
                                    ("<day-of-month> (ordinal)August", -5.995207533386816),
                                    ("dayhour", -3.3210588839602875),
                                    ("<time> timezoneyear (latent)", -5.995207533386816),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.078916801512661),
                                    ("Tuesdayfrom|since|after <time>", -5.995207533386816),
                                    ...
                                    ("time-of-day (latent)intersect", -5.995207533386816),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.302060352826871),
                                    ...
                                    ("Bank Holidayyear (latent)", -5.302060352826871),
                                    ...
                                    ("dd/mmyear (latent)", -5.995207533386816),
                                    ...
                                    ("time-of-day (latent)<time-of-day> am|pm", -5.995207533386816),
                                    ...
                                    ("time-of-day (latent)at <time-of-day>", -5.302060352826871),
