...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.504837581921368, unseen = -6.298949246855942,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.351199170878622),
                                    ("hourday", -3.899214047135565),
                                    ("dayhour", -2.770748795317774),
                                    ("daymonth", -4.910814958814044),
                                    ("monthday", -5.198497031265826),
                                    ("monthyear", -3.9945242269398897),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.60396213937399),
                                    ("Christmasyear", -5.60396213937399),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.60396213937399),
                                    ("houryear", -5.60396213937399),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.60396213937399),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.910814958814044),
                                    ("<time-of-day> am|pmintersect", -4.351199170878622),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.60396213937399),
                                    ("Marchyear", -5.60396213937399),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.198497031265826),
                                    ("intersect<time-of-day> am|pm", -5.60396213937399),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.60396213937399),
                                    ("monthhour", -5.198497031265826),
                                    ("last <day-of-week> of <time>year", -5.60396213937399),
                                    ("todayat <time-of-day>", -5.60396213937399),
                                    ("Thursday<time> timezone", -3.899214047135565),
                                    ("dd/mm<time-of-day> am|pm", -5.60396213937399),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -5.60396213937399),
                                    ("dayday", -3.5890591188317256),
                                    ("Thanksgiving Dayyear", -4.505349850705881),
                                    ("dd/mmat <time-of-day>", -5.60396213937399),
                                    ("<time> <part-of-day>at <time-of-day>", -5.60396213937399),
                                    ("Tuesdayin <named-month>", -5.60396213937399),
                                    ("tonightat <time-of-day>", -5.60396213937399),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.910814958814044),
                                    ("today<time-of-day> am|pm", -5.60396213937399),
                                    ("Februarythe <day-of-month> (ordinal)", -5.198497031265826),
                                    ("at <time-of-day><time> <part-of-day>", -5.60396213937399),
                                    ("hourhour", -4.351199170878622),
                                    ("<time-of-day> am|pmon <date>", -3.5890591188317256),
                                    ("Wednesdaythis|last|next <cycle>", -5.60396213937399),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.099884742597716),
                                    ("dayyear", -3.1616151040047855),
                                    ("last weekend of <named-month>year", -5.60396213937399),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.60396213937399),
                                    ("Thursdayat <time-of-day>", -5.198497031265826),
                                    ("<time-of-day> am|pmtomorrow", -4.910814958814044),
                                    ("minutehour", -4.687671407499835),
                                    ("Mother's Dayyear", -5.60396213937399),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.198497031265826),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.899214047135565),
                                    ("for <duration> from <time>December", -5.60396213937399),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.60396213937399),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.687671407499835),
                                    ("Mondayin|during the <part-of-day>", -5.60396213937399),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.198497031265826),
                                    ("intersectin|during the <part-of-day>", -5.60396213937399),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.198497031265826),
                                    ("<ordinal> <cycle> of <time>year", -5.60396213937399),
                                    ("minuteday", -2.1382262365742637),
                                    ("absorption of , after named dayintersect", -5.60396213937399),
                                    ("Octoberyear", -4.351199170878622),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.60396213937399),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.60396213937399),
                                    ("year<time-of-day> am|pm", -5.60396213937399),
                                    ("Septemberyear", -5.198497031265826),
                                    ("at <time-of-day>on <date>", -4.505349850705881),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.910814958814044),
                                    ("Halloweenyear", -5.60396213937399),
                                    ("dayweek", -5.60396213937399),
                                    ("Thursday<time-of-day> am|pm", -5.60396213937399),
                                    ("weekyear", -5.198497031265826),
                                    ("hh:mmin|during the <part-of-day>", -4.910814958814044),
                                    ("Father's Dayyear", -5.60396213937399),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.198497031265826),
                                    ("February<time> <part-of-day>", -5.60396213937399),
                                    ("Martin Luther King's Dayyear", -5.198497031265826),
                                    ("tomorrowat <time-of-day>", -4.910814958814044),
                                    ("between <time> and <time>on <date>", -4.910814958814044),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.910814958814044),
                                    ("at <time-of-day>tomorrow", -5.198497031265826),
                                    ("tomorrow<time-of-day> am|pm", -5.60396213937399),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.60396213937399),
                                    ("black fridayyear", -5.198497031265826),
                                    ("Labor Dayyear", -5.60396213937399),
                                    ("Februaryintersect", -5.60396213937399),
                                    ("last <cycle> of <time>year", -4.910814958814044),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.60396213937399),
                                    ("yearminute", -5.60396213937399)],
                               n = 201},
                   koData =
                     ClassData{prior = -0.925340567394073, unseen = -6.0063531596017325,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.310739886546594),
                                    ...
                                    ("dd/mmat <time-of-day>", -4.90527477843843),
                                    ("<time-of-day> am|pmon <date>", -4.057976918051226),
                                    ("Thursdaydd/mm", -5.310739886546594),
                                    ("dayyear", -4.057976918051226),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.310739886546594),
                                    ("this <time>six thirty six a.m.", -5.310739886546594),
                                    ("until <time-of-day>on <date>", -4.617592705986649),
                                    ("at <time-of-day>intersect", -4.90527477843843),
                                    ("Thursdaysix thirty six a.m.", -5.310739886546594),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.310739886546594),
                                    ("dayminute", -2.6716825569313354),
