...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5804933729569778, unseen = -6.16541785423142,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 474},
                   koData =
                     ClassData{prior = -0.8201222750082389, unseen = -5.926926025970411,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47515764728152093,
                               unseen = -7.1891677384203225,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.495265555937008),
                                    ("Father's Dayyear (latent)", -6.495265555937008),
                                    ...
                                    ("daymonth", -4.480362535394743),
                                    ("monthday", -6.089800447828844),
                                    ("monthyear", -4.703506086708953),
                                    ...
                                    ("Octoberyear (latent)", -4.9911881591607345),
                                    ...
                                    ("dd/mm<time-of-day> am|pm", -6.495265555937008),
                                    ...
                                    ("dd/mmat <time-of-day>", -6.495265555937008),
                                    ...
                                    ("<day-of-month> (ordinal)intersect", -6.089800447828844),
                                    ...
                                    ("<time-of-day> am|pmtomorrow", -5.802118375377063),
                                    ...
                                    ("minuteday", -2.75759593765364),
                                    ("absorption of , after named dayintersect",
                                     -5.802118375377063),
                                    ("intersectyear (latent)", -6.495265555937008),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.495265555937008),
                                    ("Mothering Sundayyear (latent)", -6.089800447828844),
                                    ...
                                    ("August Bank Holidayyear (latent)", -5.802118375377063),
                               ...
                               n = 508},
                   koData =
                     ClassData{prior = -0.9722978179622573, unseen = -6.831953565565855,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.63364965730996),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.7322619459780695),
                                    ("hourday", -3.7398317812878634),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.137727054086234),
                                    ("<day-of-month> (ordinal)August", -6.137727054086234),
                                    ("dayhour", -3.4635784046597053),
                                    ("<time> timezoneyear (latent)", -5.444579873526289),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.221436322212079),
                                    ("Tuesdayfrom|since|after <time>", -5.444579873526289),
                                    ("daymonth", -3.429676852984024),
                                    ("monthyear", -4.884964085590866),
                                    ("<time-of-day> am|pmyear (latent)", -5.444579873526289),
                                    ("Thai Pongalyear (latent)", -5.444579873526289),
                                    ("intersecthh:mm", -6.137727054086234),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.7322619459780695),
                                    ("<day-of-month> (ordinal)Wednesday", -6.137727054086234),
                                    ("houryear", -4.751432692966343),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.137727054086234),
                                    ("<day-of-month> (ordinal)October", -6.137727054086234),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.444579873526289),
                                    ("hournograin", -4.884964085590866),
                                    ("<time-of-day> am|pmintersect", -4.884964085590866),
                                    ("Octoberyear (latent)", -6.137727054086234),
                                    ("Good Fridayyear (latent)", -5.7322619459780695),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7322619459780695),
                                    ("early morningat <time-of-day>", -6.137727054086234),
                                    ("until <time>on <day>", -5.444579873526289),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.137727054086234),
                                    ("time-of-day (latent)intersect", -5.444579873526289),
                                    ("todayin <number> (implicit minutes)", -6.137727054086234),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.444579873526289),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.137727054086234),
                                    ("hh:mmon <day>", -4.884964085590866),
                                    ("hhhmmintersect", -5.7322619459780695),
                                    ("absorption of , after named dayJuly", -5.221436322212079),
                                    ("from|since|after <time>July", -5.7322619459780695),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.221436322212079),
                                    ("Clean Mondayyear (latent)", -6.137727054086234),
                                    ("monthhour", -6.137727054086234),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7322619459780695),
                                    ("hourmonth", -4.265924877184642),
                                    ("todayat <time-of-day>", -6.137727054086234),
                                    ("Bank Holidayyear (latent)", -5.444579873526289),
                                    ("hhhmmyear (latent)", -4.884964085590866),
                                    ("from|since|after <time>December", -6.137727054086234),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.137727054086234),
                                    ("<time-of-day> am|pmon <day>", -4.884964085590866),
                                    ("Mondayyear (latent)", -5.444579873526289),
                                    ("dayday", -4.122824033543969),
                                    ("dd/mmat <time-of-day>", -5.7322619459780695),
                                    ("on <day>September", -5.444579873526289),
                                    ("time-of-day (latent)September", -5.7322619459780695),
                                    ("hourhour", -3.886435255479739),
                                    ("time-of-day (latent)on <day>", -4.63364965730996),
                                    ("Thursdaydd/mm", -6.137727054086234),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.7322619459780695),
                                    ("dayyear", -3.0242117448758594),
                                    ("New Year's Dayyear (latent)", -5.221436322212079),
                                    ("time-of-day (latent)Sunday", -5.7322619459780695),
                                    ("Thursdayfrom|since|after <time>", -4.432978961847809),
                                    ("Thursdayat <time-of-day>", -4.528289141652134),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.137727054086234),
                                    ("Aprilyear (latent)", -6.137727054086234),
                                    ("the <day-of-month> (ordinal)July", -6.137727054086234),
                                    ("the <day-of-month> (number)July", -6.137727054086234),
                                    ("monthminute", -6.137727054086234),
                                    ("hourminute", -5.444579873526289),
                                    ("<time-of-day> am|pmtomorrow", -6.137727054086234),
                                    ("Thursdayhh:mm", -5.221436322212079),
                                    ("<day-of-month> (ordinal)Tuesday", -5.7322619459780695),
                                    ("minutemonth", -3.9976608905899633),
                                    ("time-of-day (latent)Friday", -5.7322619459780695),
                                    ("minutehour", -6.137727054086234),
                                    ("part of daysat <time-of-day>", -5.039114765418124),
                                    ("Augustyear (latent)", -5.7322619459780695),
                                    ("week-endin|during <named-month>|year", -6.137727054086234),
                                    ("time-of-day (latent)Tuesday", -5.7322619459780695),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.137727054086234),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.7322619459780695),
                                    ("Sundayyear (latent)", -5.221436322212079),
                                    ("the <day-of-month> (ordinal)Monday", -5.444579873526289),
                                    ("Christmasat <time-of-day>", -6.137727054086234),
                                    ("from|since|after <time>year (latent)", -5.039114765418124),
                                    ("dd/mmyear (latent)", -6.137727054086234),
                                    ("hhhmmon <day>", -5.221436322212079),
                                    ("yesterday<time-of-day> am|pm", -6.137727054086234),
                                    ("<day-of-month> (ordinal)July", -5.444579873526289),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.137727054086234),
                                    ("at <time-of-day>intersect", -5.221436322212079),
                                    ("hh:mmyear (latent)", -4.751432692966343),
                                    ("Holiyear (latent)", -6.137727054086234),
                                    ("until <time><time-of-day> am|pm", -6.137727054086234),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7322619459780695),
                                    ("dayminute", -3.2755261731567655),
                                    ("yyyy-mm-ddhh:mm", -5.7322619459780695),
                                    ("intersectfrom|since|after <time>", -5.7322619459780695),
                                    ("intersectSeptember", -4.265924877184642),
                                    ("minuteday", -2.9807266329361206),
                                    ("absorption of , after named dayintersect",
                                     -6.137727054086234),
                                    ("intersectyear (latent)", -6.137727054086234),
                                    ("Februaryin|during the <part-of-day>", -6.137727054086234),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.137727054086234),
                                    ("time-of-day (latent)July", -5.444579873526289),
                                    ("Saturdayyear (latent)", -6.137727054086234),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.137727054086234),
                                    ("<day-of-month> (ordinal)Monday", -5.221436322212079),
                                    ("at <time-of-day>on <day>", -5.221436322212079),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.137727054086234),
                                    ("absorption of , after named daySeptember",
                                     -4.884964085590866),
                                    ("Naraka Chaturdashiyear (latent)", -6.137727054086234),
                                    ("from|since|after <time>on <day>", -5.221436322212079),
                                    ("dayweek", -6.137727054086234),
                                    ("Easter Sundayyear (latent)", -5.7322619459780695),
                                    ("time-of-day (latent)at <time-of-day>", -5.444579873526289),
                                    ("Thursday<time-of-day> am|pm", -4.884964085590866),
                                    ("weekyear", -5.7322619459780695),
                                    ("time-of-day (latent)Thursday", -5.7322619459780695),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.137727054086234),
                                    ("<day-of-month> (ordinal)April", -6.137727054086234),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.7322619459780695),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.444579873526289),
                                    ("Sundayfrom|since|after <time>", -6.137727054086234),
                                    ("absorption of , after named dayFebruary", -5.221436322212079),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.7322619459780695),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.137727054086234),
                                    ("tomorrowat <time-of-day>", -6.137727054086234),
                                    ("daynograin", -5.7322619459780695),
                                    ("Fridayin|during <named-month>|year", -6.137727054086234),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.7322619459780695),
                                    ("last <cycle> of <time>year (latent)", -5.7322619459780695),
                                    ("tomorrow<time-of-day> am|pm", -6.137727054086234),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.444579873526289),
                                    ("Diwaliyear (latent)", -5.7322619459780695),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.137727054086234),
                                    ("this <part-of-day>at <time-of-day>", -5.221436322212079),
                                    ("Fridayyear (latent)", -5.221436322212079),
                                    ("time-of-day (latent)April", -6.137727054086234),
                                    ("minuteyear", -3.9405024767500145)],
                               n = 309}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
