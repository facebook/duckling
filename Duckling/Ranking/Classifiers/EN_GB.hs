      ...
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ...
                     ClassData{prior = -0.7007402314675425, unseen = -5.799092654460526,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 328},
                   koData =
                     ClassData{prior = -0.6856113498712424, unseen = -5.814130531825066,
       ...
       ("intersect",
        Classifier{okData =
                     ...
                     ClassData{prior = -0.471077550952672, unseen = -6.826545223556594,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.132312855695361),
                                    ("Father's Dayyear (latent)", -6.132312855695361),
                                    ("Ramadanyear (latent)", -6.132312855695361),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.117409835153096),
                                    ("Bhai Doojyear (latent)", -6.132312855695361),
                                    ("hourday", -4.427564763456936),
                                    ("dayhour", -3.270111974765893),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.117409835153096),
                                    ("Martin Luther King's Dayyear (latent)", -5.726847747587197),
                                    ("Shemini Atzeretyear (latent)", -6.132312855695361),
                                    ("daymonth", -5.216022123821206),
                                    ("monthday", -5.726847747587197),
                                    ("monthyear", -4.340553386467307),
                                    ("yearhour", -5.726847747587197),
                                    ("Yom Ha'atzmautyear (latent)", -6.132312855695361),
                                    ("Vijayadashamiyear (latent)", -6.132312855695361),
                                    ("Thanksgiving Dayyear (latent)", -5.033700567027251),
                                    ("Thai Pongalyear (latent)", -5.439165675135416),
                                    ("Thiru Onamyear (latent)", -5.439165675135416),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.132312855695361),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.132312855695361),
                                    ("houryear", -5.439165675135416),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.132312855695361),
                                    ("Christmas<time-of-day> am|pm", -6.132312855695361),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.132312855695361),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.439165675135416),
                                    ("<time-of-day> am|pmintersect", -4.879549887199993),
                                    ("Earth Houryear (latent)", -6.132312855695361),
                                    ("Octoberyear (latent)", -4.628235458919088),
                                    ("intersect<time-of-day> am|pm", -6.132312855695361),
                                    ("Mattu Pongalyear (latent)", -6.132312855695361),
                                    ("Shavuotyear (latent)", -6.132312855695361),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.132312855695361),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.132312855695361),
                                    ("in|within|after <duration>at <time-of-day>",
                                     -6.132312855695361),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.726847747587197),
                                    ("Marchyear (latent)", -6.132312855695361),
                                    ("Sukkotyear (latent)", -5.726847747587197),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.132312855695361),
                                    ("Clean Mondayyear (latent)", -5.726847747587197),
                                    ("monthhour", -5.726847747587197),
                                    ("todayat <time-of-day>", -6.132312855695361),
                                    ("Thursday<time> timezone", -4.186402706640048),
                                    ("from|since|after <time>December", -6.132312855695361),
                                    ("dd/mm<time-of-day> am|pm", -6.132312855695361),
                                    ("<time-of-day> am|pmon <day>", -4.117409835153096),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.132312855695361),
                                    ("yyyy-mm-ddhh:mm:ss", -5.726847747587197),
                                    ("dayday", -4.117409835153096),
                                    ("dd/mmat <time-of-day>", -6.132312855695361),
                                    ("<time> <part-of-day>at <time-of-day>", -6.132312855695361),
                                    ("tonightat <time-of-day>", -6.132312855695361),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.439165675135416),
                                    ("today<time-of-day> am|pm", -6.132312855695361),
                                    ("Februarythe <day-of-month> (ordinal)", -5.726847747587197),
                                    ("at <time-of-day><time> <part-of-day>", -6.132312855695361),
                                    ("hourhour", -4.879549887199993),
                                    ("Navaratriin|during <named-month>|year", -6.132312855695361),
                                    ("Wednesdaythis|last|next <cycle>", -6.132312855695361),
                                    ("Lentyear (latent)", -6.132312855695361),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.628235458919088),
                                    ("Boghiyear (latent)", -6.132312855695361),
                                    ("dayyear", -2.02143899152205),
                                    ("Thursdayfrom|since|after <time>", -5.726847747587197),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.132312855695361),
                                    ("Thursdayat <time-of-day>", -5.439165675135416),
                                    ("Islamic New Yearyear (latent)", -5.726847747587197),
                                    ("Laylat al-Qadryear (latent)", -5.216022123821206),
                                    ("Shrove Tuesdayyear (latent)", -6.132312855695361),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.439165675135416),
                                    ("<time-of-day> am|pmtomorrow", -5.439165675135416),
                                    ("Yom Kippuryear (latent)", -6.132312855695361),
                                    ("<part-of-day> of <time>year (latent)", -6.132312855695361),
                                    ("minutehour", -5.216022123821206),
                                    ("Kaanum Pongalyear (latent)", -5.726847747587197),
                                    ("Maha Saptamiyear (latent)", -6.132312855695361),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.726847747587197),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.427564763456936),
                                    ("for <duration> from <time>December", -6.132312855695361),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.132312855695361),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.879549887199993),
                                    ("Pentecostyear (latent)", -6.132312855695361),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.879549887199993),
                                    ("Eid al-Fitryear (latent)", -6.132312855695361),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.132312855695361),
                                    ("Mondayin|during the <part-of-day>", -6.132312855695361),
                                    ("Chhathin|during <named-month>|year", -6.132312855695361),
                                    ("Diwaliin|during <named-month>|year", -6.132312855695361),
                                    ("Vaisakhiin|during <named-month>|year", -6.132312855695361),
                                    ("Raksha Bandhanyear (latent)", -6.132312855695361),
                                    ("daysecond", -5.726847747587197),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.726847747587197),
                                    ("Ashurayear (latent)", -6.132312855695361),
                                    ("Tuesdayin|during <named-month>|year", -6.132312855695361),
                                    ("Chinese New Yearyear (latent)", -6.132312855695361),
                                    ("Lag BaOmeryear (latent)", -6.132312855695361),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.132312855695361),
                                    ("Eid al-Adhayear (latent)", -5.216022123821206),
                                    ("intersectin|during the <part-of-day>", -6.132312855695361),
                                    ("Palm Sundayyear (latent)", -6.132312855695361),
                                    ("Christmasat <time-of-day>", -6.132312855695361),
                                    ("Passoveryear (latent)", -6.132312855695361),
                                    ("Lazarus Saturdayyear (latent)", -6.132312855695361),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.132312855695361),
                                    ("Yom HaShoahyear (latent)", -5.726847747587197),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.726847747587197),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.132312855695361),
                                    ("Septemberyear (latent)", -5.726847747587197),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.628235458919088),
                                    ("Halloweenyear (latent)", -6.132312855695361),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.132312855695361),
                                    ("at <time-of-day>intersect", -5.726847747587197),
                                    ("Rosh Hashanahyear (latent)", -5.439165675135416),
                                    ("Dhanterasyear (latent)", -6.132312855695361),
                                    ("Tu BiShvatyear (latent)", -6.132312855695361),
                                    ("Holiyear (latent)", -5.439165675135416),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.132312855695361),
                                    ("Holika Dahanyear (latent)", -5.439165675135416),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.132312855695361),
                                    ("dayminute", -3.2145421236110825),
                                    ("Mawlidyear (latent)", -6.132312855695361),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.726847747587197),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.132312855695361),
                                    ("Jumu'atul-Widayear (latent)", -5.216022123821206),
                                    ("minuteday", -2.3036714592062664),
                                    ("absorption of , after named dayintersect",
                                     -6.132312855695361),
                                    ("in|within|after <duration><time-of-day> am|pm",
                                     -6.132312855695361),
                                    ("Orthodox Easter Sundayyear (latent)", -6.132312855695361),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.132312855695361),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.132312855695361),
                                    ("Mothering Sundayyear (latent)", -5.726847747587197),
                                    ("Boss's Dayyear (latent)", -5.726847747587197),
                                    ("Global Youth Service Dayyear (latent)", -6.132312855695361),
                                    ("Dhanterasin|during <named-month>|year", -6.132312855695361),
                                    ("Tisha B'Avyear (latent)", -6.132312855695361),
                                    ("Isra and Mi'rajyear (latent)", -5.216022123821206),
                                    ("at <time-of-day>on <day>", -5.033700567027251),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.132312855695361),
                                    ("Christmasyear (latent)", -5.726847747587197),
                                    ("Naraka Chaturdashiyear (latent)", -5.726847747587197),
                                    ("Thai Pongalin|during <named-month>|year", -6.132312855695361),
                                    ("dayweek", -6.132312855695361),
                                    ("Easter Sundayyear (latent)", -5.439165675135416),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.522874943261261),
                                    ("weekyear", -5.033700567027251),
                                    ("hh:mmin|during the <part-of-day>", -5.439165675135416),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.726847747587197),
                                    ("Hanukkahyear (latent)", -5.439165675135416),
                                    ("February<time> <part-of-day>", -6.132312855695361),
                                    ("Great Lentyear (latent)", -6.132312855695361),
                                    ("tomorrowat <time-of-day>", -5.439165675135416),
                                    ("Vaisakhiyear (latent)", -5.439165675135416),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.132312855695361),
                                    ("last <cycle> of <time>year (latent)", -5.439165675135416),
                                    ("at <time-of-day>tomorrow", -5.726847747587197),
                                    ("tomorrow<time-of-day> am|pm", -6.132312855695361),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.132312855695361),
                                    ("Diwaliyear (latent)", -6.132312855695361),
                                    ("between <time> and <time>on <day>", -4.522874943261261),
                                    ("Black Fridayyear (latent)", -5.726847747587197),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.132312855695361),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.132312855695361),
                                    ("Chhathyear (latent)", -5.726847747587197),
                                    ("Vasant Panchamiyear (latent)", -6.132312855695361),
                                    ("Thursday<time> (timezone)", -6.132312855695361),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.132312855695361),
                                    ("August Bank Holidayyear (latent)", -5.439165675135416),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.726847747587197),
                                    ("Februaryintersect", -6.132312855695361),
                                    ("Simchat Torahyear (latent)", -6.132312855695361),
                                    ("minuteyear", -6.132312855695361)],
                               n = 349},
                   koData =
                     ClassData{prior = -0.9790419424376304, unseen = -6.467698726104354,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.856706811803519),
                                    ("dayhour", -3.0988488942511454),
                                    ("<time> timezoneyear (latent)", -5.772997543677674),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.856706811803519),
                                    ("Tuesdayfrom|since|after <time>", -5.772997543677674),
                                    ("daymonth", -3.7580945231354095),
                                    ("monthyear", -4.520234575182306),
                                    ("yearhour", -5.772997543677674),
                                    ("<time-of-day> am|pmyear (latent)", -5.079850363117729),
                                    ("Thai Pongalyear (latent)", -5.079850363117729),
                                    ("intersecthh:mm", -5.772997543677674),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.772997543677674),
                                    ("houryear", -4.674385255009565),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.772997543677674),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.079850363117729),
                                    ("<time-of-day> am|pmintersect", -4.520234575182306),
                                    ("Octoberyear (latent)", -5.772997543677674),
                                    ("until <time>on <day>", -5.079850363117729),
                                    ("in|within|after <duration>at <time-of-day>",
                                     -5.772997543677674),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.079850363117729),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.772997543677674),
                                    ("hh:mmon <day>", -3.33065050830847),
                                    ("absorption of , after named dayJuly", -5.36753243556951),
                                    ("from|since|after <time>July", -5.772997543677674),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.856706811803519),
                                    ("Clean Mondayyear (latent)", -5.772997543677674),
                                    ("monthhour", -5.772997543677674),
                                    ("hourmonth", -4.856706811803519),
                                    ("todayat <time-of-day>", -5.772997543677674),
                                    ("Bank Holidayyear (latent)", -5.079850363117729),
                                    ("from|since|after <time>December", -5.772997543677674),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.772997543677674),
                                    ("<time-of-day> am|pmon <day>", -4.520234575182306),
                                    ("Mondayyear (latent)", -5.079850363117729),
                                    ("dayday", -5.36753243556951),
                                    ("dd/mmat <time-of-day>", -5.36753243556951),
                                    ("on <day>September", -5.36753243556951),
                                    ("Thursdaydd/mm", -5.772997543677674),
                                    ("dayyear", -2.802583078107973),
                                    ("New Year's Dayyear (latent)", -5.36753243556951),
                                    ("Thursdayfrom|since|after <time>", -4.068249451439249),
                                    ("Thursdayat <time-of-day>", -4.163559631243574),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.772997543677674),
                                    ("Aprilyear (latent)", -5.772997543677674),
                                    ("monthminute", -5.772997543677674),
                                    ("<time-of-day> am|pmtomorrow", -5.772997543677674),
                                    ("Thursdayhh:mm", -4.856706811803519),
                                    ("minutemonth", -3.981238074449619),
                                    ("Augustyear (latent)", -5.36753243556951),
                                    ("week-endin|during <named-month>|year", -5.772997543677674),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.772997543677674),
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.36753243556951),
                                    ("Sundayyear (latent)", -4.856706811803519),
                                    ("Christmasat <time-of-day>", -5.772997543677674),
                                    ("from|since|after <time>year (latent)", -4.674385255009565),
                                    ("dd/mmyear (latent)", -5.772997543677674),
                                    ("<duration> after|before|from <time>December",
                                     -5.772997543677674),
                                    ("yesterday<time-of-day> am|pm", -5.772997543677674),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.772997543677674),
                                    ("at <time-of-day>intersect", -5.36753243556951),
                                    ("hh:mmyear (latent)", -3.693556001997838),
                                    ("Holiyear (latent)", -5.772997543677674),
                                    ("until <time><time-of-day> am|pm", -5.772997543677674),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.772997543677674),
                                    ("dayminute", -3.2080481862161374),
                                    ("yyyy-mm-ddhh:mm", -5.36753243556951),
                                    ("intersectSeptember", -4.2689201469014),
                                    ("minuteday", -2.534319091513294),
                                    ("absorption of , after named dayintersect",
                                     -5.772997543677674),
                                    ("Februaryin|during the <part-of-day>", -5.772997543677674),
                                    ("Saturdayyear (latent)", -5.772997543677674),
                                    ("at <time-of-day>on <day>", -5.36753243556951),
                                    ("absorption of , after named daySeptember",
                                     -4.856706811803519),
                                    ("Naraka Chaturdashiyear (latent)", -5.772997543677674),
                                    ("from|since|after <time>on <day>", -4.856706811803519),
                                    ("dayweek", -5.772997543677674),
                                    ("Easter Sundayyear (latent)", -5.36753243556951),
                                    ("Thursday<time-of-day> am|pm", -4.520234575182306),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.079850363117729),
                                    ("Sundayfrom|since|after <time>", -5.772997543677674),
                                    ("absorption of , after named dayFebruary", -4.856706811803519),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.772997543677674),
                                    ("tomorrowat <time-of-day>", -5.772997543677674),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.772997543677674),
                                    ("last <cycle> of <time>year (latent)", -5.36753243556951),
                                    ("tomorrow<time-of-day> am|pm", -5.772997543677674),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.079850363117729),
                                    ("Diwaliyear (latent)", -5.36753243556951),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.772997543677674),
                                    ("Fridayyear (latent)", -5.36753243556951),
                                    ("minuteyear", -3.5757729663414546)],
                               n = 210}}),
       ...
       ("year (latent)",
        Classifier{okData =
                     ...
                     ClassData{prior = -0.21098945166352642,
                               unseen = -5.0369526024136295,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -4.000533461369913e-2),
                                    ("intersect 2 numbers", -3.644143560272545)],
                               n = 149},
                   koData =
                     ClassData{prior = -1.659587696119572, unseen = -3.6888794541139363,
