...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6430532352410299, unseen = -5.733341276897745,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 307},
                   koData =
                     ClassData{prior = -0.7458834766408885, unseen = -5.631211781821365,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 277}}),
       ("<year> (bc|ad)",
        Classifier{okData =
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4688162156884477, unseen = -6.744059186311348,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.049733455231958),
                                    ("Father's Dayyear (latent)", -6.049733455231958),
                                    ("Ramadanyear (latent)", -6.049733455231958),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.79697048673659),
                                    ("Bhai Doojyear (latent)", -6.049733455231958),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.79697048673659),
                                    ("hourday", -4.344985362993532),
                                    ("dayhour", -3.246373074325423),
                                    ("Martin Luther King's Dayyear (latent)", -5.644268347123793),
                                    ("Shemini Atzeretyear (latent)", -6.049733455231958),
                                    ("daymonth", -5.133442723357803),
                                    ("monthday", -5.644268347123793),
                                    ("monthyear", -4.257973986003902),
                                    ("Yom Ha'atzmautyear (latent)", -6.049733455231958),
                                    ("Vijayadashamiyear (latent)", -6.049733455231958),
                                    ("Thanksgiving Dayyear (latent)", -4.951121166563848),
                                    ("Thai Pongalyear (latent)", -5.356586274672012),
                                    ("Thiru Onamyear (latent)", -5.356586274672012),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.049733455231958),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.049733455231958),
                                    ("houryear", -5.356586274672012),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.049733455231958),
                                    ("Christmas<time-of-day> am|pm", -6.049733455231958),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.049733455231958),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.356586274672012),
                                    ("<time-of-day> am|pmintersect", -4.79697048673659),
                                    ("Earth Houryear (latent)", -6.049733455231958),
                                    ("Octoberyear (latent)", -4.545656058455684),
                                    ("intersect<time-of-day> am|pm", -6.049733455231958),
                                    ("Mattu Pongalyear (latent)", -6.049733455231958),
                                    ("Shavuotyear (latent)", -6.049733455231958),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.049733455231958),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.049733455231958),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.644268347123793),
                                    ("Marchyear (latent)", -6.049733455231958),
                                    ("Sukkotyear (latent)", -5.644268347123793),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.049733455231958),
                                    ("Clean Mondayyear (latent)", -5.644268347123793),
                                    ("monthhour", -5.644268347123793),
                                    ("todayat <time-of-day>", -6.049733455231958),
                                    ("Thursday<time> timezone", -4.344985362993532),
                                    ("from|since|after <time>December", -6.049733455231958),
                                    ("dd/mm<time-of-day> am|pm", -6.049733455231958),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.049733455231958),
                                    ("yyyy-mm-ddhh:mm:ss", -5.644268347123793),
                                    ("dayday", -4.034830434689693),
                                    ("dd/mmat <time-of-day>", -6.049733455231958),
                                    ("<time> <part-of-day>at <time-of-day>", -6.049733455231958),
                                    ("tonightat <time-of-day>", -6.049733455231958),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.356586274672012),
                                    ("today<time-of-day> am|pm", -6.049733455231958),
                                    ("Februarythe <day-of-month> (ordinal)", -5.644268347123793),
                                    ("at <time-of-day><time> <part-of-day>", -6.049733455231958),
                                    ("hourhour", -4.79697048673659),
                                    ("<time-of-day> am|pmon <date>", -4.034830434689693),
                                    ("Navaratriin|during <named-month>|year", -6.049733455231958),
                                    ("Wednesdaythis|last|next <cycle>", -6.049733455231958),
                                    ("Lentyear (latent)", -6.049733455231958),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.545656058455684),
                                    ("Boghiyear (latent)", -6.049733455231958),
                                    ("dayyear", -1.9721960113262382),
                                    ("Thursdayfrom|since|after <time>", -5.644268347123793),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.049733455231958),
                                    ("Thursdayat <time-of-day>", -5.644268347123793),
                                    ("Islamic New Yearyear (latent)", -5.644268347123793),
                                    ("Laylat al-Qadryear (latent)", -5.133442723357803),
                                    ("Shrove Tuesdayyear (latent)", -6.049733455231958),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.356586274672012),
                                    ("<time-of-day> am|pmtomorrow", -5.356586274672012),
                                    ("Yom Kippuryear (latent)", -6.049733455231958),
                                    ("<part-of-day> of <time>year (latent)", -6.049733455231958),
                                    ("minutehour", -5.133442723357803),
                                    ("Kaanum Pongalyear (latent)", -5.644268347123793),
                                    ("Maha Saptamiyear (latent)", -6.049733455231958),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.644268347123793),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.344985362993532),
                                    ("for <duration> from <time>December", -6.049733455231958),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.049733455231958),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.133442723357803),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.644268347123793),
                                    ("Pentecostyear (latent)", -6.049733455231958),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.133442723357803),
                                    ("Eid al-Fitryear (latent)", -6.049733455231958),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.049733455231958),
                                    ("Mondayin|during the <part-of-day>", -6.049733455231958),
                                    ("Chhathin|during <named-month>|year", -6.049733455231958),
                                    ("Diwaliin|during <named-month>|year", -6.049733455231958),
                                    ("Raksha Bandhanyear (latent)", -6.049733455231958),
                                    ("daysecond", -5.644268347123793),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.644268347123793),
                                    ("Ashurayear (latent)", -6.049733455231958),
                                    ("Tuesdayin|during <named-month>|year", -6.049733455231958),
                                    ("Chinese New Yearyear (latent)", -6.049733455231958),
                                    ("Lag BaOmeryear (latent)", -6.049733455231958),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.049733455231958),
                                    ("Eid al-Adhayear (latent)", -5.133442723357803),
                                    ("intersectin|during the <part-of-day>", -6.049733455231958),
                                    ("Palm Sundayyear (latent)", -6.049733455231958),
                                    ("Christmasat <time-of-day>", -6.049733455231958),
                                    ("Passoveryear (latent)", -6.049733455231958),
                                    ("Lazarus Saturdayyear (latent)", -6.049733455231958),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.049733455231958),
                                    ("Yom HaShoahyear (latent)", -5.644268347123793),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.644268347123793),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.049733455231958),
                                    ("Septemberyear (latent)", -5.644268347123793),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.79697048673659),
                                    ("Halloweenyear (latent)", -6.049733455231958),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.049733455231958),
                                    ("at <time-of-day>intersect", -5.644268347123793),
                                    ("Rosh Hashanahyear (latent)", -5.356586274672012),
                                    ("Dhanterasyear (latent)", -6.049733455231958),
                                    ("Tu BiShvatyear (latent)", -6.049733455231958),
                                    ("Holiyear (latent)", -5.356586274672012),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.049733455231958),
                                    ("Holika Dahanyear (latent)", -5.356586274672012),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.049733455231958),
                                    ("dayminute", -3.4106761256166993),
                                    ("Mawlidyear (latent)", -6.049733455231958),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.644268347123793),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.049733455231958),
                                    ("Jumu'atul-Widayear (latent)", -5.133442723357803),
                                    ("minuteday", -2.412147295505572),
                                    ("absorption of , after named dayintersect",
                                     -6.049733455231958),
                                    ("Orthodox Easter Sundayyear (latent)", -6.049733455231958),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.049733455231958),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.049733455231958),
                                    ("Mothering Sundayyear (latent)", -5.644268347123793),
                                    ("Boss's Dayyear (latent)", -5.644268347123793),
                                    ("Global Youth Service Dayyear (latent)", -6.049733455231958),
                                    ("Dhanterasin|during <named-month>|year", -6.049733455231958),
                                    ("Tisha B'Avyear (latent)", -6.049733455231958),
                                    ("Isra and Mi'rajyear (latent)", -5.133442723357803),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.049733455231958),
                                    ("Christmasyear (latent)", -5.644268347123793),
                                    ("Naraka Chaturdashiyear (latent)", -5.644268347123793),
                                    ("at <time-of-day>on <date>", -4.951121166563848),
                                    ("Thai Pongalin|during <named-month>|year", -6.049733455231958),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.440295542797857),
                                    ("dayweek", -6.049733455231958),
                                    ("Easter Sundayyear (latent)", -5.356586274672012),
                                    ("weekyear", -4.951121166563848),
                                    ("hh:mmin|during the <part-of-day>", -5.356586274672012),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.644268347123793),
                                    ("Hanukkahyear (latent)", -5.356586274672012),
                                    ("February<time> <part-of-day>", -6.049733455231958),
                                    ("Great Lentyear (latent)", -6.049733455231958),
                                    ("tomorrowat <time-of-day>", -5.356586274672012),
                                    ("between <time> and <time>on <date>", -4.440295542797857),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.049733455231958),
                                    ("last <cycle> of <time>year (latent)", -5.356586274672012),
                                    ("at <time-of-day>tomorrow", -5.644268347123793),
                                    ("tomorrow<time-of-day> am|pm", -6.049733455231958),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.049733455231958),
                                    ("Diwaliyear (latent)", -6.049733455231958),
                                    ("Black Fridayyear (latent)", -5.644268347123793),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.049733455231958),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.049733455231958),
                                    ("Chhathyear (latent)", -5.644268347123793),
                                    ("Vasant Panchamiyear (latent)", -6.049733455231958),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.049733455231958),
                                    ("August Bank Holidayyear (latent)", -5.356586274672012),
                                    ("Februaryintersect", -6.049733455231958),
                                    ("Simchat Torahyear (latent)", -6.049733455231958),
                                    ("minuteyear", -6.049733455231958)],
                               n = 316},
                   koData =
                     ClassData{prior = -0.9828114142157175, unseen = -6.38856140554563,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.777441406928545),
                                    ("hourday", -4.777441406928545),
                                    ("dayhour", -3.128782781341163),
                                    ("Tuesdayfrom|since|after <time>", -5.6937321388027),
                                    ("daymonth", -3.6788291182604347),
                                    ("monthyear", -4.440969170307332),
                                    ("<time-of-day> am|pmyear (latent)", -5.288267030694535),
                                    ("Thai Pongalyear (latent)", -5.000584958242754),
                                    ("intersecthh:mm", -5.6937321388027),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.6937321388027),
                                    ("houryear", -4.777441406928545),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.6937321388027),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.000584958242754),
                                    ("<time-of-day> am|pmintersect", -4.440969170307332),
                                    ("until <time>on <date>", -5.000584958242754),
                                    ("Octoberyear (latent)", -5.6937321388027),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.000584958242754),
                                    ("about|exactly <time-of-day>year (latent)", -5.6937321388027),
                                    ("absorption of , after named dayJuly", -5.288267030694535),
                                    ("from|since|after <time>July", -5.6937321388027),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.777441406928545),
                                    ("Clean Mondayyear (latent)", -5.6937321388027),
                                    ("monthhour", -5.6937321388027),
                                    ("hourmonth", -4.777441406928545),
                                    ("todayat <time-of-day>", -5.6937321388027),
                                    ("Bank Holidayyear (latent)", -5.000584958242754),
                                    ("from|since|after <time>December", -5.6937321388027),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.6937321388027),
                                    ("Mondayyear (latent)", -5.000584958242754),
                                    ("dayday", -5.288267030694535),
                                    ("dd/mmat <time-of-day>", -5.288267030694535),
                                    ("<time-of-day> am|pmon <date>", -4.440969170307332),
                                    ("Thursdaydd/mm", -5.6937321388027),
                                    ("dayyear", -2.7233176732329984),
                                    ("New Year's Dayyear (latent)", -5.288267030694535),
                                    ("Thursdayfrom|since|after <time>", -3.9889840465642745),
                                    ("Thursdayat <time-of-day>", -4.440969170307332),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.6937321388027),
                                    ("Aprilyear (latent)", -5.6937321388027),
                                    ("monthminute", -5.6937321388027),
                                    ("<time-of-day> am|pmtomorrow", -5.6937321388027),
                                    ("Thursdayhh:mm", -4.777441406928545),
                                    ("minutemonth", -3.9019726695746444),
                                    ("Augustyear (latent)", -5.288267030694535),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.288267030694535),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.288267030694535),
                                    ("week-endin|during <named-month>|year", -5.6937321388027),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.6937321388027),
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.288267030694535),
                                    ("Sundayyear (latent)", -4.777441406928545),
                                    ("Christmasat <time-of-day>", -5.6937321388027),
                                    ("from|since|after <time>year (latent)", -4.59511985013459),
                                    ("dd/mmyear (latent)", -5.6937321388027),
                                    ("<duration> after|before|from <time>December",
                                     -5.6937321388027),
                                    ("yesterday<time-of-day> am|pm", -5.6937321388027),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.6937321388027),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.000584958242754),
                                    ("in|during <named-month>|yearyear (latent)", -5.6937321388027),
                                    ("at <time-of-day>intersect", -5.288267030694535),
                                    ("hh:mmyear (latent)", -4.59511985013459),
                                    ("Holiyear (latent)", -5.6937321388027),
                                    ("until <time><time-of-day> am|pm", -5.6937321388027),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.6937321388027),
                                    ("dayminute", -3.019583489376171),
                                    ("yyyy-mm-ddhh:mm", -5.288267030694535),
                                    ("intersectSeptember", -4.189654742026425),
                                    ("minuteday", -2.6256792036690824),
                                    ("absorption of , after named dayintersect", -5.6937321388027),
                                    ("Februaryin|during the <part-of-day>", -5.6937321388027),
                                    ("hh:mmon <date>", -3.6788291182604347),
                                    ("Saturdayyear (latent)", -5.6937321388027),
                                    ("from|since|after <time>on <date>", -4.777441406928545),
                                    ("absorption of , after named daySeptember",
                                     -4.777441406928545),
                                    ("Naraka Chaturdashiyear (latent)", -5.6937321388027),
                                    ("on <date>September", -5.288267030694535),
                                    ("at <time-of-day>on <date>", -5.288267030694535),
                                    ("dayweek", -5.6937321388027),
                                    ("Easter Sundayyear (latent)", -5.288267030694535),
                                    ("Thursday<time-of-day> am|pm", -5.000584958242754),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.000584958242754),
                                    ("Sundayfrom|since|after <time>", -5.6937321388027),
                                    ("absorption of , after named dayFebruary", -4.777441406928545),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.6937321388027),
                                    ("tomorrowat <time-of-day>", -5.6937321388027),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.6937321388027),
                                    ("last <cycle> of <time>year (latent)", -5.288267030694535),
                                    ("tomorrow<time-of-day> am|pm", -5.6937321388027),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.000584958242754),
                                    ("Diwaliyear (latent)", -5.288267030694535),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.6937321388027),
                                    ("Fridayyear (latent)", -5.288267030694535),
                                    ("minuteyear", -4.440969170307332)],
                               n = 189}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.14723023698268448,
                               ...
                               n = 145},
                   koData =
                     ClassData{prior = -1.988469763474109, unseen = -3.332204510175204,
                               likelihoods =
                                 HashMap.fromList
