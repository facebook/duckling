...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.764871361358391, unseen = -5.2832037287379885,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 195},
                   koData =
                     ClassData{prior = -0.6262248680670979, unseen = -5.420534999272286,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4974666464707927, unseen = -6.342121418721152,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.394449154672439),
                                    ("hourday", -3.9424640309293815),
                                    ("dayhour", -2.7568403652716422),
                                    ("daymonth", -4.954064942607862),
                                    ("monthday", -5.241747015059643),
                                    ("monthyear", -4.037774210733707),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.647212123167807),
                                    ("Easter Sundayyear", -4.954064942607862),
                                    ("Christmasyear", -5.241747015059643),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.647212123167807),
                                    ("houryear", -5.241747015059643),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.647212123167807),
                                    ("Christmas<time-of-day> am|pm", -5.647212123167807),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.954064942607862),
                                    ("<time-of-day> am|pmintersect", -4.394449154672439),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.647212123167807),
                                    ("Marchyear", -5.647212123167807),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.241747015059643),
                                    ("intersect<time-of-day> am|pm", -5.647212123167807),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.647212123167807),
                                    ("monthhour", -5.241747015059643),
                                    ("last <day-of-week> of <time>year", -5.647212123167807),
                                    ("todayat <time-of-day>", -5.647212123167807),
                                    ("Thursday<time> timezone", -3.9424640309293815),
                                    ("dd/mm<time-of-day> am|pm", -5.647212123167807),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.647212123167807),
                                    ("dayday", -3.632309102625542),
                                    ("Thanksgiving Dayyear", -4.548599834499697),
                                    ("dd/mmat <time-of-day>", -5.647212123167807),
                                    ("<time> <part-of-day>at <time-of-day>", -5.647212123167807),
                                    ("Tuesdayin <named-month>", -5.647212123167807),
                                    ("tonightat <time-of-day>", -5.647212123167807),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.954064942607862),
                                    ("today<time-of-day> am|pm", -5.647212123167807),
                                    ("Februarythe <day-of-month> (ordinal)", -5.241747015059643),
                                    ("at <time-of-day><time> <part-of-day>", -5.647212123167807),
                                    ("hourhour", -4.394449154672439),
                                    ("<time-of-day> am|pmon <date>", -3.632309102625542),
                                    ("Wednesdaythis|last|next <cycle>", -5.647212123167807),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.143134726391533),
                                    ("dayyear", -2.9391619220655967),
                                    ("last weekend of <named-month>year", -5.647212123167807),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.647212123167807),
                                    ("Thursdayat <time-of-day>", -5.241747015059643),
                                    ("<time-of-day> am|pmtomorrow", -4.954064942607862),
                                    ("August Bank Holidayyear", -4.954064942607862),
                                    ("minutehour", -4.730921391293652),
                                    ("Mother's Dayyear", -5.647212123167807),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.241747015059643),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.9424640309293815),
                                    ("for <duration> from <time>December", -5.647212123167807),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.647212123167807),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.730921391293652),
                                    ("Mondayin|during the <part-of-day>", -5.647212123167807),
                                    ("<part-of-day> of <time>year", -5.647212123167807),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.241747015059643),
                                    ("intersectin|during the <part-of-day>", -5.647212123167807),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.241747015059643),
                                    ("<ordinal> <cycle> of <time>year", -5.647212123167807),
                                    ("minuteday", -2.18147622036808),
                                    ("absorption of , after named dayintersect",
                                     -5.647212123167807),
                                    ("Octoberyear", -4.394449154672439),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.647212123167807),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.647212123167807),
                                    ("year<time-of-day> am|pm", -5.647212123167807),
                                    ("Septemberyear", -5.241747015059643),
                                    ("at <time-of-day>on <date>", -4.548599834499697),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.954064942607862),
                                    ("Halloweenyear", -5.647212123167807),
                                    ("dayweek", -5.647212123167807),
                                    ("Thursday<time-of-day> am|pm", -5.647212123167807),
                                    ("weekyear", -5.241747015059643),
                                    ("hh:mmin|during the <part-of-day>", -4.954064942607862),
                                    ("Father's Dayyear", -5.647212123167807),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.241747015059643),
                                    ("February<time> <part-of-day>", -5.647212123167807),
                                    ("Martin Luther King's Dayyear", -5.241747015059643),
                                    ("tomorrowat <time-of-day>", -4.954064942607862),
                                    ("between <time> and <time>on <date>", -4.954064942607862),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.954064942607862),
                                    ("at <time-of-day>tomorrow", -5.241747015059643),
                                    ("tomorrow<time-of-day> am|pm", -5.647212123167807),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.647212123167807),
                                    ("Labor Dayyear", -5.647212123167807),
                                    ("Februaryintersect", -5.647212123167807),
                                    ("last <cycle> of <time>year", -4.954064942607862),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.647212123167807),
                                    ("yearminute", -5.647212123167807),
                                    ("Black Fridayyear", -5.241747015059643)],
                               n = 211},
                   koData =
                     ClassData{prior = -0.9366698942108072, unseen = -6.035481432524756,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.339939041238856),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.339939041238856),
                                    ("hourday", -5.339939041238856),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.339939041238856),
                                    ("dayhour", -2.897592005869652),
                                    ("daymonth", -3.2604974995590204),
                                    ("monthday", -4.9344739331306915),
                                    ("monthyear", -4.646791860678911),
                                    ("intersecthh:mm", -5.339939041238856),
                                    ("Easter Sundayyear", -5.339939041238856),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.339939041238856),
                                    ("houryear", -5.339939041238856),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.339939041238856),
                                    ("until <time-of-day><time-of-day> am|pm", -5.339939041238856),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.646791860678911),
                                    ("<time-of-day> am|pmintersect", -4.087176072743488),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.423648309364701),
                                    ("from|since|after <time-of-day>on <date>", -4.423648309364701),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.339939041238856),
                                    ("absorption of , after named dayJuly", -4.9344739331306915),
                                    ("monthhour", -5.339939041238856),
                                    ("hourmonth", -4.646791860678911),
                                    ("todayat <time-of-day>", -5.339939041238856),
                                    ("from|since|after <time-of-day>July", -5.339939041238856),
                                    ("dayday", -4.9344739331306915),
                                    ("dd/mmat <time-of-day>", -4.9344739331306915),
                                    ("<time-of-day> am|pmon <date>", -4.087176072743488),
                                    ("Thursdaydd/mm", -5.339939041238856),
                                    ("dayyear", -3.4681368643372648),
                                    ("Sundayyear", -4.9344739331306915),
                                    ("Thursdayat <time-of-day>", -4.087176072743488),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.339939041238856),
                                    ("monthminute", -5.339939041238856),
                                    ("<time-of-day> am|pmtomorrow", -5.339939041238856),
                                    ("Thursdayhh:mm", -4.423648309364701),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.339939041238856),
                                    ("Fridayyear", -4.9344739331306915),
                                    ("minutemonth", -3.548179572010801),
                                    ("Sundayfrom|since|after <time-of-day>", -5.339939041238856),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.9344739331306915),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.9344739331306915),
                                    ("Aprilyear", -5.339939041238856),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.339939041238856),
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -4.9344739331306915),
                                    ("Christmasat <time-of-day>", -5.339939041238856),
                                    ("<duration> after|before|from <time>December",
                                     -5.339939041238856),
                                    ("yesterday<time-of-day> am|pm", -5.339939041238856),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.423648309364701),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.9344739331306915),
                                    ("Bank Holidayyear", -4.646791860678911),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.339939041238856),
                                    ("until <time-of-day>on <date>", -4.646791860678911),
                                    ("at <time-of-day>intersect", -4.9344739331306915),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.339939041238856),
                                    ("dayminute", -2.8142103969306005),
                                    ("intersectSeptember", -3.835861644462582),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.339939041238856),
                                    ("minuteday", -2.422168309154577),
                                    ("absorption of , after named dayintersect",
                                     -5.339939041238856),
                                    ("Februaryin|during the <part-of-day>", -5.339939041238856),
                                    ("week-endin <named-month>", -5.339939041238856),
                                    ("Octoberyear", -5.339939041238856),
                                    ("from|since|after <time-of-day>year", -5.339939041238856),
                                    ("yearhh:mm", -5.339939041238856),
                                    ("hh:mmon <date>", -3.835861644462582),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.339939041238856),
                                    ("absorption of , after named daySeptember",
                                     -4.423648309364701),
                                    ("on <date>September", -4.9344739331306915),
                                    ("at <time-of-day>on <date>", -4.9344739331306915),
                                    ("dayweek", -5.339939041238856),
                                    ("Thursday<time-of-day> am|pm", -4.9344739331306915),
                                    ("absorption of , after named dayFebruary", -4.423648309364701),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.339939041238856),
                                    ("tomorrowat <time-of-day>", -5.339939041238856),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.339939041238856),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.7305011288047556),
                                    ("tomorrow<time-of-day> am|pm", -5.339939041238856),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.339939041238856),
                                    ("yearminute", -5.339939041238856)],
                               n = 136}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year",
        Classifier{okData =
                     ClassData{prior = -0.27087495413539975,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -8.515780834030683e-2),
                                    ("intersect 2 numbers", -3.1986731175506815)],
                               n = 45},
                   koData =
