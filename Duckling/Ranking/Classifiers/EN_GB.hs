...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6160005073460609, unseen = -6.07073772800249,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 431},
                   koData =
                     ClassData{prior = -0.7767467493952385, unseen = -5.910796644040527,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4841573766838293, unseen = -7.089243155027514,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.395261598115449),
                                    ("Father's Dayyear (latent)", -6.395261598115449),
                                    ("Karva Chauthyear (latent)", -6.395261598115449),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.395261598115449),
                                    ("Ramadanyear (latent)", -5.478970866241294),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.0089672369955585),
                                    ("Bhai Doojyear (latent)", -6.395261598115449),
                                    ("hourday", -4.380358577573184),
                                    ("dayhour", -3.450822618949009),
                                    ...
                                    ("daymonth", -4.380358577573184),
                                    ("monthday", -5.989796490007285),
                                    ("monthyear", -4.603502128887395),
                                    ...
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.702114417555504),
                                    ("intersectin|during <named-month>|year", -6.395261598115449),
                                    ...
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.989796490007285),
                                    ("Marchyear (latent)", -6.395261598115449),
                                    ...
                                    ("monthhour", -5.989796490007285),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.702114417555504),
                                    ("todayat <time-of-day>", -6.395261598115449),
                                    ("Thursday<time> timezone", -3.997366325317079),
                                    ("time-of-day (latent)tonight", -5.989796490007285),
                                    ("from|since|after <time>December", -6.395261598115449),
                                    ("dd/mm<time-of-day> am|pm", -6.395261598115449),
                                    ("<time-of-day> am|pmon <day>", -4.380358577573184),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.395261598115449),
                                    ("yyyy-mm-ddhh:mm:ss", -5.989796490007285),
                                    ("dayday", -3.687211397013239),
                                    ("dd/mmat <time-of-day>", -6.395261598115449),
                                    ("<time> <part-of-day>at <time-of-day>", -6.395261598115449),
                                    ("tonightat <time-of-day>", -6.395261598115449),
                                    ...
                                    ("Februarythe <day-of-month> (ordinal)", -5.989796490007285),
                                    ("at <time-of-day><time> <part-of-day>", -6.395261598115449),
                                    ("<day-of-month> (ordinal)intersect", -5.989796490007285),
                                    ("hourhour", -4.315820056435613),
                                    ...
                                    ("dayyear", -1.9236228047518806),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.395261598115449),
                                    ("Thursdayfrom|since|after <time>", -5.989796490007285),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.395261598115449),
                                    ...
                                    ("<day-of-month> (ordinal)Tuesday", -5.989796490007285),
                                    ("<part-of-day> of <time>year (latent)", -6.395261598115449),
                                    ("minutehour", -5.142498629620081),
                                    ("Kaanum Pongalyear (latent)", -5.989796490007285),
                                    ("Maha Saptamiyear (latent)", -6.395261598115449),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.989796490007285),
                                    ("time-of-day (latent)tomorrow", -5.478970866241294),
                                    ("part of daysat <time-of-day>", -5.989796490007285),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.142498629620081),
                                    ("time-of-day (latent)this <part-of-day>", -6.395261598115449),
                                    ("Pentecostyear (latent)", -6.395261598115449),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.142498629620081),
                                    ("<day-of-month> (ordinal)February", -6.395261598115449),
                                    ("Eid al-Fitryear (latent)", -5.478970866241294),
                                    ...
                                    ("<day-of-month> (ordinal)December", -5.702114417555504),
                                    ...
                                    ("minuteday", -2.6575919798320813),
                                    ("absorption of , after named dayintersect",
                                     -5.702114417555504),
                                    ("intersectyear (latent)", -6.395261598115449),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.395261598115449),
                                    ("Mothering Sundayyear (latent)", -5.989796490007285),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.395261598115449),
                                    ("August Bank Holidayyear (latent)", -5.702114417555504),
                                    ("<datetime> - <datetime> (interval)July", -5.989796490007285),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.702114417555504),
                                    ("Februaryintersect", -6.395261598115449),
                                    ("Simchat Torahyear (latent)", -6.395261598115449),
                                    ("minuteyear", -6.395261598115449)],
                               n = 456},
                   koData =
                     ClassData{prior = -0.9576759480370094, unseen = -6.75110146893676,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.55270661645235),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.65131890512046),
                                    ("hourday", -3.658888740430254),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.056784013228625),
                                    ("<day-of-month> (ordinal)August", -6.056784013228625),
                                    ("dayhour", -3.3826353638020956),
                                    ("<time> timezoneyear (latent)", -5.363636832668679),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.14049328135447),
                                    ("Tuesdayfrom|since|after <time>", -5.363636832668679),
                                    ("daymonth", -3.3826353638020956),
                                    ("monthyear", -4.804021044733257),
                                    ("<time-of-day> am|pmyear (latent)", -5.363636832668679),
                                    ("Thai Pongalyear (latent)", -5.363636832668679),
                                    ("intersecthh:mm", -6.056784013228625),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.65131890512046),
                                    ("<day-of-month> (ordinal)Wednesday", -6.056784013228625),
                                    ("houryear", -4.670489652108734),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.056784013228625),
                                    ("<day-of-month> (ordinal)October", -6.056784013228625),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.363636832668679),
                                    ("hournograin", -4.804021044733257),
                                    ("<time-of-day> am|pmintersect", -4.804021044733257),
                                    ("Octoberyear (latent)", -6.056784013228625),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.65131890512046),
                                    ("until <time>on <day>", -5.363636832668679),
                                    ("time-of-day (latent)intersect", -5.363636832668679),
                                    ("todayin <number> (implicit minutes)", -6.056784013228625),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.363636832668679),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.056784013228625),
                                    ("hh:mmon <day>", -4.804021044733257),
                                    ("hhhmmintersect", -5.65131890512046),
                                    ("absorption of , after named dayJuly", -5.14049328135447),
                                    ("from|since|after <time>July", -5.65131890512046),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.14049328135447),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.65131890512046),
                                    ("hourmonth", -4.184981836327033),
                                    ("todayat <time-of-day>", -6.056784013228625),
                                    ("Bank Holidayyear (latent)", -5.363636832668679),
                                    ("hhhmmyear (latent)", -4.804021044733257),
                                    ("from|since|after <time>December", -6.056784013228625),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.056784013228625),
                                    ("<time-of-day> am|pmon <day>", -4.804021044733257),
                                    ("Mondayyear (latent)", -5.363636832668679),
                                    ("dayday", -4.670489652108734),
                                    ("dd/mmat <time-of-day>", -5.65131890512046),
                                    ("on <day>September", -5.363636832668679),
                                    ("time-of-day (latent)September", -5.65131890512046),
                                    ("hourhour", -4.958171724560515),
                                    ("time-of-day (latent)on <day>", -4.55270661645235),
                                    ("Thursdaydd/mm", -6.056784013228625),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.65131890512046),
                                    ("dayyear", -3.0363591270842623),
                                    ("New Year's Dayyear (latent)", -5.14049328135447),
                                    ("time-of-day (latent)Sunday", -5.65131890512046),
                                    ("Thursdayfrom|since|after <time>", -4.3520359209901995),
                                    ("Thursdayat <time-of-day>", -4.447346100794524),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.056784013228625),
                                    ("Aprilyear (latent)", -6.056784013228625),
                                    ("the <day-of-month> (ordinal)July", -6.056784013228625),
                                    ("the <day-of-month> (number)July", -6.056784013228625),
                                    ("monthminute", -6.056784013228625),
                                    ("hourminute", -5.363636832668679),
                                    ("<time-of-day> am|pmtomorrow", -6.056784013228625),
                                    ("Thursdayhh:mm", -5.14049328135447),
                                    ("<day-of-month> (ordinal)Tuesday", -5.65131890512046),
                                    ("minutemonth", -3.9167178497323536),
                                    ("time-of-day (latent)Friday", -5.65131890512046),
                                    ("minutehour", -6.056784013228625),
                                    ("Augustyear (latent)", -5.65131890512046),
                                    ("week-endin|during <named-month>|year", -6.056784013228625),
                                    ("time-of-day (latent)Tuesday", -5.65131890512046),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.056784013228625),
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.65131890512046),
                                    ("Sundayyear (latent)", -5.14049328135447),
                                    ("Christmasat <time-of-day>", -6.056784013228625),
                                    ("from|since|after <time>year (latent)", -4.958171724560515),
                                    ("dd/mmyear (latent)", -6.056784013228625),
                                    ("hhhmmon <day>", -5.14049328135447),
                                    ("yesterday<time-of-day> am|pm", -6.056784013228625),
                                    ("<day-of-month> (ordinal)July", -5.363636832668679),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.056784013228625),
                                    ("at <time-of-day>intersect", -5.14049328135447),
                                    ("hh:mmyear (latent)", -4.670489652108734),
                                    ("Holiyear (latent)", -6.056784013228625),
                                    ("until <time><time-of-day> am|pm", -6.056784013228625),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.65131890512046),
                                    ("dayminute", -3.1945831322991562),
                                    ("yyyy-mm-ddhh:mm", -5.65131890512046),
                                    ("intersectfrom|since|after <time>", -5.65131890512046),
                                    ("intersectSeptember", -4.184981836327033),
                                    ("minuteday", -2.8997835920785113),
                                    ("absorption of , after named dayintersect",
                                     -6.056784013228625),
                                    ("intersectyear (latent)", -6.056784013228625),
                                    ("Februaryin|during the <part-of-day>", -6.056784013228625),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.056784013228625),
                                    ("time-of-day (latent)July", -5.363636832668679),
                                    ("Saturdayyear (latent)", -6.056784013228625),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.056784013228625),
                                    ("at <time-of-day>on <day>", -5.14049328135447),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.056784013228625),
                                    ("absorption of , after named daySeptember",
                                     -4.804021044733257),
                                    ("Naraka Chaturdashiyear (latent)", -6.056784013228625),
                                    ("from|since|after <time>on <day>", -5.14049328135447),
                                    ("dayweek", -6.056784013228625),
                                    ("Easter Sundayyear (latent)", -5.65131890512046),
                                    ("time-of-day (latent)at <time-of-day>", -5.363636832668679),
                                    ("Thursday<time-of-day> am|pm", -4.804021044733257),
                                    ("weekyear", -5.65131890512046),
                                    ("time-of-day (latent)Thursday", -5.65131890512046),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.056784013228625),
                                    ("<day-of-month> (ordinal)April", -6.056784013228625),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.65131890512046),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.363636832668679),
                                    ("Sundayfrom|since|after <time>", -6.056784013228625),
                                    ("absorption of , after named dayFebruary", -5.14049328135447),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.65131890512046),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.056784013228625),
                                    ("tomorrowat <time-of-day>", -6.056784013228625),
                                    ("daynograin", -5.65131890512046),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.65131890512046),
                                    ("last <cycle> of <time>year (latent)", -5.65131890512046),
                                    ("tomorrow<time-of-day> am|pm", -6.056784013228625),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.363636832668679),
                                    ("Diwaliyear (latent)", -5.65131890512046),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.056784013228625),
                                    ("Fridayyear (latent)", -5.65131890512046),
                                    ("time-of-day (latent)April", -6.056784013228625),
                                    ("minuteyear", -3.8595594358924052)],
                               n = 284}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1597924437339264, unseen = -5.332718793265369,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -2.955880224154439e-2),
                                    ("intersect 2 numbers", -3.9415818076696905)],
                               n = 202},
                   koData =
                     ClassData{prior = -1.9127120796457175,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
