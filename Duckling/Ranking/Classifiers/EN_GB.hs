...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6292556992378956, unseen = -6.025865973825314,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 412},
                   koData =
                     ClassData{prior = -0.7614010902545411,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5057318410457343, unseen = -7.039660349862076,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.345636360828596),
                                    ("Father's Dayyear (latent)", -6.345636360828596),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.345636360828596),
                                    ("Ramadanyear (latent)", -5.429345628954441),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.330733340286331),
                                    ("Bhai Doojyear (latent)", -6.345636360828596),
                                    ("hourday", -4.330733340286331),
                                    ("dayhour", -3.4011973816621555),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.330733340286331),
                                    ("Martin Luther King's Dayyear (latent)", -5.940171252720432),
                                    ("Shemini Atzeretyear (latent)", -6.345636360828596),
                                    ("daymonth", -4.330733340286331),
                                    ("monthday", -5.940171252720432),
                                    ("monthyear", -4.553876891600541),
                                    ("Yom Ha'atzmautyear (latent)", -6.345636360828596),
                                    ("Vijayadashamiyear (latent)", -6.345636360828596),
                                    ("Thanksgiving Dayyear (latent)", -5.247024072160486),
                                    ("Thai Pongalyear (latent)", -5.652489180268651),
                                    ("Thiru Onamyear (latent)", -5.652489180268651),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.345636360828596),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.429345628954441),
                                    ("<day-of-month> (ordinal)Wednesday", -6.345636360828596),
                                    ("Krishna Janmashtamiyear (latent)", -5.940171252720432),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.345636360828596),
                                    ("houryear", -5.429345628954441),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.345636360828596),
                                    ("Christmas<time-of-day> am|pm", -6.345636360828596),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.345636360828596),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.652489180268651),
                                    ("intersectin|during <named-month>|year", -6.345636360828596),
                                    ("<time-of-day> am|pmintersect", -5.092873392333228),
                                    ("Earth Houryear (latent)", -6.345636360828596),
                                    ("Octoberyear (latent)", -4.841558964052322),
                                    ("intersect<time-of-day> am|pm", -6.345636360828596),
                                    ("Mattu Pongalyear (latent)", -6.345636360828596),
                                    ("Shavuotyear (latent)", -6.345636360828596),
                                    ("Parsi New Yearyear (latent)", -5.429345628954441),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.345636360828596),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.345636360828596),
                                    ("todayin|within|after <duration>", -6.345636360828596),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.940171252720432),
                                    ("Marchyear (latent)", -6.345636360828596),
                                    ("Sukkotyear (latent)", -5.940171252720432),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.940171252720432),
                                    ("Clean Mondayyear (latent)", -5.940171252720432),
                                    ("monthhour", -5.940171252720432),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.652489180268651),
                                    ("todayat <time-of-day>", -6.345636360828596),
                                    ("Thursday<time> timezone", -4.399726211773283),
                                    ("time-of-day (latent)tonight", -5.940171252720432),
                                    ("from|since|after <time>December", -6.345636360828596),
                                    ("dd/mm<time-of-day> am|pm", -6.345636360828596),
                                    ("<time-of-day> am|pmon <day>", -4.330733340286331),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.345636360828596),
                                    ("yyyy-mm-ddhh:mm:ss", -5.940171252720432),
                                    ("dayday", -3.9032893254593914),
                                    ("dd/mmat <time-of-day>", -6.345636360828596),
                                    ("<time> <part-of-day>at <time-of-day>", -6.345636360828596),
                                    ("tonightat <time-of-day>", -6.345636360828596),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.652489180268651),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.345636360828596),
                                    ("today<time-of-day> am|pm", -6.345636360828596),
                                    ("Februarythe <day-of-month> (ordinal)", -5.940171252720432),
                                    ("at <time-of-day><time> <part-of-day>", -6.345636360828596),
                                    ("<day-of-month> (ordinal)intersect", -5.940171252720432),
                                    ("hourhour", -4.26619481914876),
                                    ("Navaratriin|during <named-month>|year", -6.345636360828596),
                                    ("Wednesdaythis|last|next <cycle>", -6.345636360828596),
                                    ("Lentyear (latent)", -6.345636360828596),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.841558964052322),
                                    ("Boghiyear (latent)", -6.345636360828596),
                                    ("dayyear", -1.8971199848858813),
                                    ("Thursdayfrom|since|after <time>", -5.940171252720432),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.345636360828596),
                                    ("Thursdayat <time-of-day>", -5.652489180268651),
                                    ("Islamic New Yearyear (latent)", -5.940171252720432),
                                    ("Laylat al-Qadryear (latent)", -5.429345628954441),
                                    ("Shrove Tuesdayyear (latent)", -6.345636360828596),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.652489180268651),
                                    ("<time-of-day> am|pmtomorrow", -5.652489180268651),
                                    ("Yom Kippuryear (latent)", -6.345636360828596),
                                    ("<day-of-month> (ordinal)Tuesday", -5.940171252720432),
                                    ("<part-of-day> of <time>year (latent)", -6.345636360828596),
                                    ("minutehour", -5.092873392333228),
                                    ("Kaanum Pongalyear (latent)", -5.940171252720432),
                                    ("Maha Saptamiyear (latent)", -6.345636360828596),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.940171252720432),
                                    ("time-of-day (latent)tomorrow", -5.429345628954441),
                                    ("part of daysat <time-of-day>", -5.940171252720432),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.640888268590171),
                                    ("for <duration> from <time>December", -6.345636360828596),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.345636360828596),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.092873392333228),
                                    ("time-of-day (latent)this <part-of-day>", -6.345636360828596),
                                    ("Pentecostyear (latent)", -6.345636360828596),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.092873392333228),
                                    ("<day-of-month> (ordinal)February", -6.345636360828596),
                                    ("Eid al-Fitryear (latent)", -5.429345628954441),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.345636360828596),
                                    ("Mondayin|during the <part-of-day>", -6.345636360828596),
                                    ("Chhathin|during <named-month>|year", -6.345636360828596),
                                    ("Diwaliin|during <named-month>|year", -6.345636360828596),
                                    ("Vaisakhiin|during <named-month>|year", -6.345636360828596),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.092873392333228),
                                    ("Raksha Bandhanyear (latent)", -6.345636360828596),
                                    ("daysecond", -5.940171252720432),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.940171252720432),
                                    ("Ashurayear (latent)", -6.345636360828596),
                                    ("Tuesdayin|during <named-month>|year", -6.345636360828596),
                                    ("Chinese New Yearyear (latent)", -6.345636360828596),
                                    ("tomorrowintersect", -6.345636360828596),
                                    ("Lag BaOmeryear (latent)", -6.345636360828596),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.345636360828596),
                                    ("Eid al-Adhayear (latent)", -4.205570197332325),
                                    ("intersectin|during the <part-of-day>", -6.345636360828596),
                                    ("Palm Sundayyear (latent)", -6.345636360828596),
                                    ("Christmasat <time-of-day>", -6.345636360828596),
                                    ("Passoveryear (latent)", -6.345636360828596),
                                    ("Lazarus Saturdayyear (latent)", -6.345636360828596),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.345636360828596),
                                    ("Yom HaShoahyear (latent)", -5.940171252720432),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.940171252720432),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.345636360828596),
                                    ("Septemberyear (latent)", -5.940171252720432),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.841558964052322),
                                    ("Halloweenyear (latent)", -6.345636360828596),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.345636360828596),
                                    ("at <time-of-day>intersect", -5.940171252720432),
                                    ("Rosh Hashanahyear (latent)", -5.652489180268651),
                                    ("Dhanterasyear (latent)", -6.345636360828596),
                                    ("Tu BiShvatyear (latent)", -6.345636360828596),
                                    ("<day-of-month> (ordinal)December", -5.652489180268651),
                                    ("Holiyear (latent)", -5.652489180268651),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.345636360828596),
                                    ("Holika Dahanyear (latent)", -5.652489180268651),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.345636360828596),
                                    ("dayminute", -3.4278656287443168),
                                    ("Mawlidyear (latent)", -6.345636360828596),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.940171252720432),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.345636360828596),
                                    ("Jumu'atul-Widayear (latent)", -5.429345628954441),
                                    ("minuteday", -2.5169949643395007),
                                    ("absorption of , after named dayintersect",
                                     -6.345636360828596),
                                    ("intersectyear (latent)", -6.345636360828596),
                                    ("Orthodox Easter Sundayyear (latent)", -6.345636360828596),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.345636360828596),
                                    ("Mothering Sundayyear (latent)", -5.940171252720432),
                                    ("Boss's Dayyear (latent)", -5.940171252720432),
                                    ("Global Youth Service Dayyear (latent)", -6.345636360828596),
                                    ("Dhanterasin|during <named-month>|year", -6.345636360828596),
                                    ("Tisha B'Avyear (latent)", -6.345636360828596),
                                    ("Isra and Mi'rajyear (latent)", -5.429345628954441),
                                    ("at <time-of-day>on <day>", -5.247024072160486),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.345636360828596),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.652489180268651),
                                    ("Christmasyear (latent)", -5.940171252720432),
                                    ("Naraka Chaturdashiyear (latent)", -5.940171252720432),
                                    ("Thai Pongalin|during <named-month>|year", -6.345636360828596),
                                    ("dayweek", -6.345636360828596),
                                    ("Easter Sundayyear (latent)", -5.652489180268651),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.736198448394496),
                                    ("weekyear", -5.247024072160486),
                                    ("King's Dayyear (latent)", -4.841558964052322),
                                    ("hh:mmin|during the <part-of-day>", -5.429345628954441),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.940171252720432),
                                    ("Hanukkahyear (latent)", -5.652489180268651),
                                    ("February<time> <part-of-day>", -6.345636360828596),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.345636360828596),
                                    ("Great Lentyear (latent)", -6.345636360828596),
                                    ("tomorrowat <time-of-day>", -5.652489180268651),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.345636360828596),
                                    ("Vaisakhiyear (latent)", -5.652489180268651),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.345636360828596),
                                    ("last <cycle> of <time>year (latent)", -5.652489180268651),
                                    ("at <time-of-day>tomorrow", -5.940171252720432),
                                    ("tomorrow<time-of-day> am|pm", -6.345636360828596),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.345636360828596),
                                    ("Diwaliyear (latent)", -6.345636360828596),
                                    ("between <time> and <time>on <day>", -4.736198448394496),
                                    ("Black Fridayyear (latent)", -5.940171252720432),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.345636360828596),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.345636360828596),
                                    ("Chhathyear (latent)", -5.940171252720432),
                                    ("Vasant Panchamiyear (latent)", -6.345636360828596),
                                    ("Rabindra Jayantiyear (latent)", -5.092873392333228),
                                    ("St Patrick's Dayyear (latent)", -6.345636360828596),
                                    ("Thursday<time> (timezone)", -6.345636360828596),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.345636360828596),
                                    ("August Bank Holidayyear (latent)", -5.652489180268651),
                                    ("<datetime> - <datetime> (interval)July", -5.940171252720432),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.940171252720432),
                                    ("Februaryintersect", -6.345636360828596),
                                    ("Simchat Torahyear (latent)", -6.345636360828596),
                                    ("minuteyear", -6.345636360828596)],
                               n = 433},
                   koData =
                     ClassData{prior = -0.9239803887795737, unseen = -6.739336627357174,
                               likelihoods =
                                 HashMap.fromList
                                   [("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.639540205927847),
                                    ("hourday", -3.154633556139847),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.045005314036012),
                                    ("<day-of-month> (ordinal)August", -6.045005314036012),
                                    ("dayhour", -3.370856664609483),
                                    ("<time> timezoneyear (latent)", -6.045005314036012),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.128714582161857),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.045005314036012),
                                    ("hh:mmon <day>", -3.6026582786668073),
                                    ("absorption of , after named dayJuly", -5.639540205927847),
                                    ...
                                    ("Bank Holidayyear (latent)", -5.351858133476067),
                                    ...
                                    ("Mondayyear (latent)", -5.351858133476067),
                                    ("dayday", -4.658710952916121),
                                    ("dd/mmat <time-of-day>", -5.639540205927847),
                                    ("on <day>September", -5.639540205927847),
                                    ("time-of-day (latent)September", -5.639540205927847),
                                    ("hourhour", -4.946393025367902),
                                    ("time-of-day (latent)on <day>", -3.6026582786668073),
                                    ("Thursdaydd/mm", -6.045005314036012),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.639540205927847),
                                    ("dayyear", -3.024580427891649),
                                    ...
                                    ("dd/mmyear (latent)", -6.045005314036012),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.045005314036012),
                                    ("at <time-of-day>intersect", -5.639540205927847),
                                    ("hh:mmyear (latent)", -3.965563772356176),
                                    ("Holiyear (latent)", -6.045005314036012),
                                    ("until <time><time-of-day> am|pm", -6.045005314036012),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.045005314036012),
                                    ("dayminute", -3.4423156285916283),
                                    ("yyyy-mm-ddhh:mm", -5.639540205927847),
                                    ("intersectfrom|since|after <time>", -5.639540205927847),
                                    ("intersectSeptember", -4.540927917259737),
                                    ("minuteday", -2.8063268618716313),
                                    ("absorption of , after named dayintersect",
                                     -6.045005314036012),
                                    ...
                                    ("at <time-of-day>on <day>", -5.639540205927847),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.045005314036012),
                                    ...
                                    ("time-of-day (latent)at <time-of-day>", -5.351858133476067),
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.8109302162163288, unseen = -4.634728988229636,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 100},
                   koData =
                     ClassData{prior = -0.587786664902119, unseen = -4.852030263919617,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -6.506359334706188e-2),
                                    ("integer (0..19)", -2.7647455447787554)],
                               n = 125}}),
       ("beginning of year",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.791759469228055,
       ...
       ("hh:mm",
        Classifier{okData =
                     ClassData{prior = -8.617769624105227e-2,
                               unseen = -4.624972813284271,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 100},
                   koData =
                     ClassData{prior = -2.4941233048929243,
