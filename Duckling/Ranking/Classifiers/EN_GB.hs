...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4771436833792122, unseen = -6.739336627357174,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.045005314036012),
                                    ("Father's Dayyear (latent)", -6.045005314036012),
                                    ("Ramadanyear (latent)", -6.045005314036012),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.792242345540644),
                                    ("Bhai Doojyear (latent)", -6.045005314036012),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.792242345540644),
                                    ("hourday", -4.340257221797587),
                                    ("dayhour", -3.2416449331294768),
                                    ("Martin Luther King's Dayyear (latent)", -5.639540205927847),
                                    ("Shemini Atzeretyear (latent)", -6.045005314036012),
                                    ("daymonth", -5.351858133476067),
                                    ("monthday", -5.639540205927847),
                                    ("monthyear", -4.253245844807957),
                                    ("Yom Ha'atzmautyear (latent)", -6.045005314036012),
                                    ("Vijayadashamiyear (latent)", -6.045005314036012),
                                    ("Thanksgiving Dayyear (latent)", -4.946393025367902),
                                    ("Thai Pongalyear (latent)", -5.351858133476067),
                                    ("Thiru Onamyear (latent)", -5.351858133476067),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.045005314036012),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.045005314036012),
                                    ("houryear", -5.351858133476067),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.045005314036012),
                                    ("Christmas<time-of-day> am|pm", -6.045005314036012),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.045005314036012),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.351858133476067),
                                    ("<time-of-day> am|pmintersect", -4.792242345540644),
                                    ("Earth Houryear (latent)", -6.045005314036012),
                                    ("Octoberyear (latent)", -4.540927917259737),
                                    ("intersect<time-of-day> am|pm", -6.045005314036012),
                                    ("Mattu Pongalyear (latent)", -6.045005314036012),
                                    ("Shavuotyear (latent)", -6.045005314036012),
                                    ("Dhanterasin <named-month>|year", -6.045005314036012),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.045005314036012),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.045005314036012),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.639540205927847),
                                    ("Marchyear (latent)", -6.045005314036012),
                                    ("Sukkotyear (latent)", -5.639540205927847),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.045005314036012),
                                    ("Clean Mondayyear (latent)", -5.639540205927847),
                                    ("monthhour", -5.639540205927847),
                                    ("todayat <time-of-day>", -6.045005314036012),
                                    ("Thursday<time> timezone", -4.340257221797587),
                                    ("dd/mm<time-of-day> am|pm", -6.045005314036012),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.045005314036012),
                                    ("Palm SundaySunday", -5.639540205927847),
                                    ("dayday", -3.8477807366997925),
                                    ("dd/mmat <time-of-day>", -6.045005314036012),
                                    ("<time> <part-of-day>at <time-of-day>", -6.045005314036012),
                                    ("tonightat <time-of-day>", -6.045005314036012),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.351858133476067),
                                    ("today<time-of-day> am|pm", -6.045005314036012),
                                    ("Februarythe <day-of-month> (ordinal)", -5.639540205927847),
                                    ("at <time-of-day><time> <part-of-day>", -6.045005314036012),
                                    ("hourhour", -4.792242345540644),
                                    ("<time-of-day> am|pmon <date>", -4.030102293493747),
                                    ("Wednesdaythis|last|next <cycle>", -6.045005314036012),
                                    ("Lentyear (latent)", -6.045005314036012),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.540927917259737),
                                    ("Boghiyear (latent)", -6.045005314036012),
                                    ("dayyear", -1.9845623034895925),
                                    ("Thursdayfrom|since|after <time>", -5.639540205927847),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.045005314036012),
                                    ("Thursdayat <time-of-day>", -5.639540205927847),
                                    ("Islamic New Yearyear (latent)", -5.639540205927847),
                                    ("Laylat al-Qadryear (latent)", -5.128714582161857),
                                    ("Chhathin <named-month>|year", -6.045005314036012),
                                    ("Vasant Panchamiin <named-month>|year", -6.045005314036012),
                                    ("Diwaliin <named-month>|year", -6.045005314036012),
                                    ("Shrove Tuesdayyear (latent)", -6.045005314036012),
                                    ("<time-of-day> am|pmtomorrow", -5.351858133476067),
                                    ("Yom Kippuryear (latent)", -6.045005314036012),
                                    ("<part-of-day> of <time>year (latent)", -6.045005314036012),
                                    ("minutehour", -5.128714582161857),
                                    ("Kaanum Pongalyear (latent)", -5.639540205927847),
                                    ("Maha Saptamiyear (latent)", -6.045005314036012),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.639540205927847),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.340257221797587),
                                    ("for <duration> from <time>December", -6.045005314036012),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.045005314036012),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.128714582161857),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.639540205927847),
                                    ("Pentecostyear (latent)", -6.045005314036012),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.128714582161857),
                                    ("Eid al-Fitryear (latent)", -6.045005314036012),
                                    ("Mondayin|during the <part-of-day>", -6.045005314036012),
                                    ("Raksha Bandhanyear (latent)", -6.045005314036012),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.639540205927847),
                                    ("Navaratriin <named-month>|year", -6.045005314036012),
                                    ("Ashurayear (latent)", -6.045005314036012),
                                    ("Chinese New Yearyear (latent)", -6.045005314036012),
                                    ("Sundayyear (latent)", -6.045005314036012),
                                    ("Lag BaOmeryear (latent)", -6.045005314036012),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.045005314036012),
                                    ("Eid al-Adhayear (latent)", -5.128714582161857),
                                    ("intersectin|during the <part-of-day>", -6.045005314036012),
                                    ("Christmasat <time-of-day>", -6.045005314036012),
                                    ("Passoveryear (latent)", -6.045005314036012),
                                    ("Lazarus Saturdayyear (latent)", -6.045005314036012),
                                    ("dd/mmyear (latent)", -6.045005314036012),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.045005314036012),
                                    ("Yom HaShoahyear (latent)", -5.639540205927847),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.639540205927847),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.045005314036012),
                                    ("Thai Pongalin <named-month>|year", -6.045005314036012),
                                    ("Septemberyear (latent)", -5.639540205927847),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.792242345540644),
                                    ("Halloweenyear (latent)", -6.045005314036012),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -6.045005314036012),
                                    ("Dhanterasyear (latent)", -6.045005314036012),
                                    ("Tu BiShvatyear (latent)", -6.045005314036012),
                                    ("Holiyear (latent)", -5.351858133476067),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.045005314036012),
                                    ("Holika Dahanyear (latent)", -5.351858133476067),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.045005314036012),
                                    ("dayminute", -3.405947984420753),
                                    ("Mawlidyear (latent)", -6.045005314036012),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.639540205927847),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.045005314036012),
                                    ("Jumu'atul-Widayear (latent)", -5.128714582161857),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.045005314036012),
                                    ("minuteday", -2.407419154309626),
                                    ("absorption of , after named dayintersect",
                                     -6.045005314036012),
                                    ("intersectyear (latent)", -6.045005314036012),
                                    ("Orthodox Easter Sundayyear (latent)", -6.045005314036012),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.045005314036012),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.045005314036012),
                                    ("Mothering Sundayyear (latent)", -5.639540205927847),
                                    ("Boss's Dayyear (latent)", -5.639540205927847),
                                    ("Global Youth Service Dayyear (latent)", -6.045005314036012),
                                    ("Tisha B'Avyear (latent)", -6.045005314036012),
                                    ("Isra and Mi'rajyear (latent)", -5.128714582161857),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.045005314036012),
                                    ("Christmasyear (latent)", -5.639540205927847),
                                    ("Naraka Chaturdashiyear (latent)", -5.639540205927847),
                                    ("at <time-of-day>on <date>", -4.946393025367902),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.4355674016019115),
                                    ("dayweek", -6.045005314036012),
                                    ("Easter Sundayyear (latent)", -5.351858133476067),
                                    ("weekyear", -4.946393025367902),
                                    ("hh:mmin|during the <part-of-day>", -5.351858133476067),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.639540205927847),
                                    ("Hanukkahyear (latent)", -6.045005314036012),
                                    ("February<time> <part-of-day>", -6.045005314036012),
                                    ("Tuesdayin <named-month>|year", -6.045005314036012),
                                    ("Great Lentyear (latent)", -6.045005314036012),
                                    ("tomorrowat <time-of-day>", -5.351858133476067),
                                    ("between <time> and <time>on <date>", -4.4355674016019115),
                                    ("last <cycle> of <time>year (latent)", -5.351858133476067),
                                    ("at <time-of-day>tomorrow", -5.639540205927847),
                                    ("tomorrow<time-of-day> am|pm", -6.045005314036012),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.045005314036012),
                                    ("Diwaliyear (latent)", -6.045005314036012),
                                    ("Black Fridayyear (latent)", -5.639540205927847),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.045005314036012),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.045005314036012),
                                    ("Chhathyear (latent)", -5.639540205927847),
                                    ("Vasant Panchamiyear (latent)", -6.045005314036012),
                                    ("Palm Sundayintersect", -6.045005314036012),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.045005314036012),
                                    ("August Bank Holidayyear (latent)", -5.351858133476067),
                                    ("Februaryintersect", -6.045005314036012),
                                    ("Simchat Torahyear (latent)", -6.045005314036012),
                                    ("minuteyear", -6.045005314036012)],
                               n = 314},
                   koData =
                     ClassData{prior = -0.969041297259684, unseen = -6.398594934535208,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.787491742782046),
