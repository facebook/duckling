...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6246607664147893, unseen = -6.052089168924417,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 423},
                   koData =
                     ClassData{prior = -0.766671097406497, unseen = -5.910796644040527,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4875479388966451, unseen = -7.080026499922591,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.386037214049723),
                                    ("Father's Dayyear (latent)", -6.386037214049723),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.386037214049723),
                                    ...
                                    ("daymonth", -4.371134193507458),
                                    ("monthday", -5.980572105941558),
                                    ("monthyear", -4.594277744821667),
                                    ...
                                    ("Octoberyear (latent)", -4.881959817273449),
                                    ...
                                    ("dd/mm<time-of-day> am|pm", -6.386037214049723),
                                    ...
                                    ("dd/mmat <time-of-day>", -6.386037214049723),
                                    ...
                                    ("<day-of-month> (ordinal)intersect", -5.980572105941558),
                                    ...
                                    ("absorption of , after named dayintersect",
                                     -5.692890033489777),
                                    ("intersectyear (latent)", -6.386037214049723),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.386037214049723),
                                    ("Mothering Sundayyear (latent)", -5.980572105941558),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.386037214049723),
                                    ("August Bank Holidayyear (latent)", -5.692890033489777),
                               ...
                               n = 452},
                   koData =
                     ClassData{prior = -0.9522558805676702, unseen = -6.747586526829315,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.5491875512371545),
                                    ...
                                    ("Bank Holidayyear (latent)", -5.360117767453484),
                                    ...
                                    ("dd/mmyear (latent)", -6.053264948013429),
                                    ...
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.053264948013429),
                                    ...
                                    ("time-of-day (latent)at <time-of-day>", -5.360117767453484),
