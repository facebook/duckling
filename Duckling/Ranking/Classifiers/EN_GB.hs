...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6219427342681536, unseen = -5.680172609017068,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 291},
                   koData =
                     ClassData{prior = -0.7698130623078623, unseen = -5.53338948872752,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4805002940510784, unseen = -6.721425700790643,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.02707297457535),
                                    ("Father's Dayyear (latent)", -6.02707297457535),
                                    ("Ramadanyear (latent)", -6.02707297457535),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.774310006079982),
                                    ("Bhai Doojyear (latent)", -6.02707297457535),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.774310006079982),
                                    ("hourday", -4.3223248823369245),
                                    ("dayhour", -3.223712593668815),
                                    ("Martin Luther King's Dayyear (latent)", -5.621607866467185),
                                    ("Shemini Atzeretyear (latent)", -6.02707297457535),
                                    ("daymonth", -5.333925794015404),
                                    ("monthday", -5.621607866467185),
                                    ("monthyear", -4.417635062141249),
                                    ("Yom Ha'atzmautyear (latent)", -6.02707297457535),
                                    ("Vijayadashamiyear (latent)", -6.02707297457535),
                                    ("Thanksgiving Dayyear (latent)", -4.92846068590724),
                                    ("Thai Pongalyear (latent)", -5.333925794015404),
                                    ("Thiru Onamyear (latent)", -5.333925794015404),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.02707297457535),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.02707297457535),
                                    ("houryear", -5.333925794015404),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.02707297457535),
                                    ("Christmas<time-of-day> am|pm", -6.02707297457535),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.02707297457535),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.333925794015404),
                                    ("<time-of-day> am|pmintersect", -4.774310006079982),
                                    ("Octoberyear (latent)", -4.774310006079982),
                                    ("intersect<time-of-day> am|pm", -6.02707297457535),
                                    ("Mattu Pongalyear (latent)", -6.02707297457535),
                                    ("Shavuotyear (latent)", -6.02707297457535),
                                    ("Dhanterasin <named-month>|year", -6.02707297457535),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.02707297457535),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.02707297457535),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.621607866467185),
                                    ("Marchyear (latent)", -6.02707297457535),
                                    ("Sukkotyear (latent)", -5.621607866467185),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.02707297457535),
                                    ("Clean Mondayyear (latent)", -5.621607866467185),
                                    ("monthhour", -5.621607866467185),
                                    ("todayat <time-of-day>", -6.02707297457535),
                                    ("Thursday<time> timezone", -4.3223248823369245),
                                    ("dd/mm<time-of-day> am|pm", -6.02707297457535),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -6.02707297457535),
                                    ("Palm SundaySunday", -5.621607866467185),
                                    ("dayday", -3.82984839723913),
                                    ("dd/mmat <time-of-day>", -6.02707297457535),
                                    ("<time> <part-of-day>at <time-of-day>", -6.02707297457535),
                                    ("tonightat <time-of-day>", -6.02707297457535),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.333925794015404),
                                    ("today<time-of-day> am|pm", -6.02707297457535),
                                    ("Februarythe <day-of-month> (ordinal)", -5.621607866467185),
                                    ("at <time-of-day><time> <part-of-day>", -6.02707297457535),
                                    ("hourhour", -4.774310006079982),
                                    ("<time-of-day> am|pmon <date>", -4.012169954033085),
                                    ("Wednesdaythis|last|next <cycle>", -6.02707297457535),
                                    ("Lentyear (latent)", -6.02707297457535),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.522995577799075),
                                    ("Boghiyear (latent)", -6.02707297457535),
                                    ("dayyear", -1.9666299640289302),
                                    ("Thursdayfrom|since|after <time>", -5.621607866467185),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.02707297457535),
                                    ("Thursdayat <time-of-day>", -5.621607866467185),
                                    ("Islamic New Yearyear (latent)", -5.621607866467185),
                                    ("Laylat al-Qadryear (latent)", -5.110782242701195),
                                    ("Chhathin <named-month>|year", -6.02707297457535),
                                    ("Vasant Panchamiin <named-month>|year", -6.02707297457535),
                                    ("Diwaliin <named-month>|year", -6.02707297457535),
                                    ("Shrove Tuesdayyear (latent)", -6.02707297457535),
                                    ("<time-of-day> am|pmtomorrow", -5.333925794015404),
                                    ("Yom Kippuryear (latent)", -6.02707297457535),
                                    ("<part-of-day> of <time>year (latent)", -6.02707297457535),
                                    ("minutehour", -5.110782242701195),
                                    ("Kaanum Pongalyear (latent)", -5.621607866467185),
                                    ("Maha Saptamiyear (latent)", -6.02707297457535),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.621607866467185),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.3223248823369245),
                                    ("for <duration> from <time>December", -6.02707297457535),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.02707297457535),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.110782242701195),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.621607866467185),
                                    ("Pentecostyear (latent)", -6.02707297457535),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.110782242701195),
                                    ("Eid al-Fitryear (latent)", -6.02707297457535),
                                    ("Mondayin|during the <part-of-day>", -6.02707297457535),
                                    ("Raksha Bandhanyear (latent)", -6.02707297457535),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.621607866467185),
                                    ("Navaratriin <named-month>|year", -6.02707297457535),
                                    ("Ashurayear (latent)", -6.02707297457535),
                                    ("Chinese New Yearyear (latent)", -6.02707297457535),
                                    ("Sundayyear (latent)", -6.02707297457535),
                                    ("Lag BaOmeryear (latent)", -6.02707297457535),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.02707297457535),
                                    ("Eid al-Adhayear (latent)", -5.110782242701195),
                                    ("intersectin|during the <part-of-day>", -6.02707297457535),
                                    ("Christmasat <time-of-day>", -6.02707297457535),
                                    ("Passoveryear (latent)", -6.02707297457535),
                                    ("Lazarus Saturdayyear (latent)", -6.02707297457535),
                                    ("dd/mmyear (latent)", -6.02707297457535),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.02707297457535),
                                    ("Yom HaShoahyear (latent)", -5.621607866467185),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.621607866467185),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.02707297457535),
                                    ("Thai Pongalin <named-month>|year", -6.02707297457535),
                                    ("Septemberyear (latent)", -5.621607866467185),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.774310006079982),
                                    ("Halloweenyear (latent)", -6.02707297457535),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.333925794015404),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -5.110782242701195),
                                    ("at <time-of-day>intersect", -5.621607866467185),
                                    ("Rosh Hashanahyear (latent)", -6.02707297457535),
                                    ("Dhanterasyear (latent)", -6.02707297457535),
                                    ("Tu BiShvatyear (latent)", -6.02707297457535),
                                    ("Holiyear (latent)", -5.333925794015404),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.02707297457535),
                                    ("Holika Dahanyear (latent)", -5.333925794015404),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.02707297457535),
                                    ("dayminute", -3.388015644960091),
                                    ("Mawlidyear (latent)", -6.02707297457535),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.621607866467185),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.02707297457535),
                                    ("Jumu'atul-Widayear (latent)", -5.110782242701195),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.02707297457535),
                                    ("minuteday", -2.389486814848964),
                                    ("absorption of , after named dayintersect", -6.02707297457535),
                                    ("intersectyear (latent)", -6.02707297457535),
                                    ("Orthodox Easter Sundayyear (latent)", -6.02707297457535),
                                    ("<ordinal> <cycle> of <time>year (latent)", -6.02707297457535),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.02707297457535),
                                    ("Mothering Sundayyear (latent)", -5.621607866467185),
                                    ("Boss's Dayyear (latent)", -5.621607866467185),
                                    ("Global Youth Service Dayyear (latent)", -6.02707297457535),
                                    ("Tisha B'Avyear (latent)", -6.02707297457535),
                                    ("Isra and Mi'rajyear (latent)", -5.110782242701195),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.02707297457535),
                                    ("Christmasyear (latent)", -5.621607866467185),
                                    ("Naraka Chaturdashiyear (latent)", -5.621607866467185),
                                    ("at <time-of-day>on <date>", -4.92846068590724),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.417635062141249),
                                    ("dayweek", -6.02707297457535),
                                    ("Easter Sundayyear (latent)", -5.333925794015404),
                                    ("weekyear", -5.621607866467185),
                                    ("hh:mmin|during the <part-of-day>", -5.333925794015404),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.621607866467185),
                                    ("Hanukkahyear (latent)", -6.02707297457535),
                                    ("February<time> <part-of-day>", -6.02707297457535),
                                    ("Tuesdayin <named-month>|year", -6.02707297457535),
                                    ("Great Lentyear (latent)", -6.02707297457535),
                                    ("tomorrowat <time-of-day>", -5.333925794015404),
                                    ("between <time> and <time>on <date>", -4.417635062141249),
                                    ("last <cycle> of <time>year (latent)", -5.333925794015404),
                                    ("at <time-of-day>tomorrow", -5.621607866467185),
                                    ("tomorrow<time-of-day> am|pm", -6.02707297457535),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.02707297457535),
                                    ("Diwaliyear (latent)", -6.02707297457535),
                                    ("Black Fridayyear (latent)", -5.621607866467185),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.02707297457535),
                                    ("Chhathyear (latent)", -5.621607866467185),
                                    ("Vasant Panchamiyear (latent)", -6.02707297457535),
                                    ("Palm Sundayintersect", -6.02707297457535),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.02707297457535),
                                    ("August Bank Holidayyear (latent)", -5.333925794015404),
                                    ("Februaryintersect", -6.02707297457535),
                                    ("Simchat Torahyear (latent)", -6.02707297457535)],
                               n = 308},
                   koData =
                     ClassData{prior = -0.9635760048641667, unseen = -6.386879319362645,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.775756486563625),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.69204721843778),
                                    ("dayhour", -3.127097860976243),
                                    ("Tuesdayfrom|since|after <time>", -5.69204721843778),
                                    ("daymonth", -3.551981054941509),
                                    ("monthday", -5.286582110329616),
                                    ("monthyear", -4.439284249942412),
                                    ("<time-of-day> am|pmyear (latent)", -5.286582110329616),
                                    ("Thai Pongalyear (latent)", -4.998900037877835),
                                    ("intersecthh:mm", -5.69204721843778),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.69204721843778),
                                    ("houryear", -4.775756486563625),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.69204721843778),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.998900037877835),
                                    ("<time-of-day> am|pmintersect", -4.439284249942412),
                                    ("until <time>on <date>", -4.998900037877835),
                                    ("Octoberyear (latent)", -5.69204721843778),
                                    ...
                                    ("Bank Holidayyear (latent)", -4.998900037877835),
                                    ...
                                    ("dd/mmat <time-of-day>", -5.286582110329616),
                                    ("<time-of-day> am|pmon <date>", -4.439284249942412),
                                    ("Thursdaydd/mm", -5.69204721843778),
                                    ("dayyear", -2.647524780714357),
                                    ("New Year's Dayyear (latent)", -5.286582110329616),
                                    ("Thursdayfrom|since|after <time>", -3.9872991261993547),
                                    ("Thursdayat <time-of-day>", -4.439284249942412),
                                    ...
                                    ("week-endin <named-month>|year", -5.69204721843778),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.286582110329616),
                                    ("Sundayyear (latent)", -4.998900037877835),
                                    ("Christmasat <time-of-day>", -5.69204721843778),
                                    ("from|since|after <time>year (latent)", -4.439284249942412),
                                    ("dd/mmyear (latent)", -5.69204721843778),
                                    ...
                                    ("hh:mmon <date>", -3.6771441978955153),
                                    ("Saturdayyear (latent)", -5.69204721843778),
                                    ("from|since|after <time>on <date>", -4.775756486563625),
                                    ("absorption of , after named daySeptember",
                                     -4.775756486563625),
                                    ("Naraka Chaturdashiyear (latent)", -5.69204721843778),
                                    ("on <date>September", -5.286582110329616),
                                    ("at <time-of-day>on <date>", -5.286582110329616),
                                    ("in <named-month>|yearyear (latent)", -5.69204721843778),
                                    ("dayweek", -5.69204721843778),
                                    ("Easter Sundayyear (latent)", -5.286582110329616),
                                    ("Thursday<time-of-day> am|pm", -4.998900037877835),
