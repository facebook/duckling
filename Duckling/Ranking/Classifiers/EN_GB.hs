...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.49857008393156027,
                               unseen = -7.192182058713246,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.498282149476434),
                                    ...
                                    ("<time-of-day> am|pmtomorrow", -5.5819914176022785),
                               ...
                               n = 509},
                   koData =
                     ClassData{prior = -0.9349603497167112, unseen = -6.876264611890766,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.6780075099403575),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.7766197986084675),
                                    ("hourday", -3.579395221272248),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.182084906716631),
                                    ("<day-of-month> (ordinal)August", -6.182084906716631),
                                    ("dayhour", -3.507936257290103),
                                    ("<time> timezoneyear (latent)", -5.488937726156687),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.265794174842477),
                                    ("Tuesdayfrom|since|after <time>", -5.488937726156687),
                                    ("daymonth", -3.507936257290103),
                                    ("hourquarter", -5.265794174842477),
                                    ("monthyear", -4.929321938221264),
                                    ("<time-of-day> am|pmyear (latent)", -5.488937726156687),
                                    ("Thai Pongalyear (latent)", -5.488937726156687),
                                    ("intersecthh:mm", -6.182084906716631),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.7766197986084675),
                                    ("<day-of-month> (ordinal)Wednesday", -6.182084906716631),
                                    ("houryear", -4.390325437488577),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.182084906716631),
                                    ("<day-of-month> (ordinal)October", -6.182084906716631),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.488937726156687),
                                    ("hournograin", -4.929321938221264),
                                    ("<time-of-day> am|pmintersect", -4.929321938221264),
                                    ("Octoberyear (latent)", -6.182084906716631),
                                    ("Good Fridayyear (latent)", -5.7766197986084675),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7766197986084675),
                                    ("early morningat <time-of-day>", -6.182084906716631),
                                    ("until <time>on <day>", -5.488937726156687),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.182084906716631),
                                    ("time-of-day (latent)intersect", -5.488937726156687),
                                    ("todayin <number> (implicit minutes)", -6.182084906716631),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.488937726156687),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.182084906716631),
                                    ("hh:mmon <day>", -4.929321938221264),
                                    ("hhhmmintersect", -5.7766197986084675),
                                    ("absorption of , after named dayJuly", -5.265794174842477),
                                    ("from|since|after <time>July", -5.7766197986084675),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.265794174842477),
                                    ("Clean Mondayyear (latent)", -6.182084906716631),
                                    ("monthhour", -6.182084906716631),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7766197986084675),
                                    ("hourmonth", -4.0420187432203605),
                                    ("todayat <time-of-day>", -6.182084906716631),
                                    ("Bank Holidayyear (latent)", -5.488937726156687),
                                    ("hhhmmyear (latent)", -4.929321938221264),
                                    ("from|since|after <time>December", -6.182084906716631),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.182084906716631),
                                    ("<time-of-day> am|pmon <day>", -4.929321938221264),
                                    ("Mondayyear (latent)", -5.488937726156687),
                                    ("dayday", -4.167181886174367),
                                    ("dd/mmat <time-of-day>", -5.7766197986084675),
                                    ("on <day>September", -5.488937726156687),
                                    ("time-of-day (latent)September", -5.7766197986084675),
                                    ("hourhour", -3.9307931081101364),
                                    ("time-of-day (latent)on <day>", -4.6780075099403575),
                                    ("Thursdaydd/mm", -6.182084906716631),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.7766197986084675),
                                    ("dayyear", -3.0685695975062575),
                                    ("New Year's Dayyear (latent)", -5.265794174842477),
                                    ("time-of-day (latent)Sunday", -5.7766197986084675),
                                    ("Thursdayfrom|since|after <time>", -4.477336814478207),
                                    ("Thursdayat <time-of-day>", -4.572646994282532),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.182084906716631),
                                    ("Aprilyear (latent)", -6.182084906716631),
                                    ("the <day-of-month> (ordinal)July", -6.182084906716631),
                                    ("the <day-of-month> (number)July", -6.182084906716631),
                                    ("monthminute", -6.182084906716631),
                                    ("hourminute", -5.488937726156687),
                                    ("<time-of-day> am|pmtomorrow", -5.7766197986084675),
                                    ("Thursdayhh:mm", -5.265794174842477),
                                    ("<day-of-month> (ordinal)Tuesday", -5.7766197986084675),
                                    ("minutemonth", -4.0420187432203605),
                                    ("time-of-day (latent)Friday", -5.7766197986084675),
                                    ("minutehour", -6.182084906716631),
                                    ("part of daysat <time-of-day>", -5.083472618048522),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.830709649553154),
                                    ("Augustyear (latent)", -5.7766197986084675),
                                    ("week-endin|during <named-month>|year", -6.182084906716631),
                                    ("time-of-day (latent)Tuesday", -5.7766197986084675),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.182084906716631),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.7766197986084675),
                                    ("Sundayyear (latent)", -5.265794174842477),
                                    ("hourweek", -5.265794174842477),
                                    ("the <day-of-month> (ordinal)Monday", -5.488937726156687),
                                    ("Christmasat <time-of-day>", -6.182084906716631),
                                    ("from|since|after <time>year (latent)", -5.083472618048522),
                                    ("dd/mmyear (latent)", -6.182084906716631),
                                    ("hhhmmon <day>", -5.265794174842477),
                                    ("yesterday<time-of-day> am|pm", -6.182084906716631),
                                    ("<day-of-month> (ordinal)July", -5.488937726156687),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.182084906716631),
                                    ("at <time-of-day>intersect", -5.265794174842477),
                                    ("hh:mmyear (latent)", -4.795790545596741),
                                    ("Holiyear (latent)", -6.182084906716631),
                                    ("until <time><time-of-day> am|pm", -6.182084906716631),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7766197986084675),
                                    ("dayminute", -3.3198840257871636),
                                    ("yyyy-mm-ddhh:mm", -5.7766197986084675),
                                    ("intersectfrom|since|after <time>", -5.7766197986084675),
                                    ("intersectSeptember", -4.31028272981504),
                                    ("minuteday", -3.0250844855665187),
                                    ("absorption of , after named dayintersect",
                                     -6.182084906716631),
                                    ("intersectyear (latent)", -6.182084906716631),
                                    ("Februaryin|during the <part-of-day>", -6.182084906716631),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.182084906716631),
                                    ("time-of-day (latent)July", -5.488937726156687),
                                    ("Saturdayyear (latent)", -6.182084906716631),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.182084906716631),
                                    ("<day-of-month> (ordinal)Monday", -5.265794174842477),
                                    ("at <time-of-day>on <day>", -5.265794174842477),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.182084906716631),
                                    ("absorption of , after named daySeptember",
                                     -4.929321938221264),
                                    ("Naraka Chaturdashiyear (latent)", -6.182084906716631),
                                    ("from|since|after <time>on <day>", -5.265794174842477),
                                    ("dayweek", -6.182084906716631),
                                    ("Easter Sundayyear (latent)", -5.7766197986084675),
                                    ("time-of-day (latent)at <time-of-day>", -5.488937726156687),
                                    ("Thursday<time-of-day> am|pm", -4.929321938221264),
                                    ("weekyear", -5.7766197986084675),
                                    ("time-of-day (latent)Thursday", -5.7766197986084675),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.182084906716631),
                                    ("<day-of-month> (ordinal)April", -6.182084906716631),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.7766197986084675),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.488937726156687),
                                    ("Sundayfrom|since|after <time>", -6.182084906716631),
                                    ("absorption of , after named dayFebruary", -5.265794174842477),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.7766197986084675),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.182084906716631),
                                    ("tomorrowat <time-of-day>", -6.182084906716631),
                                    ("daynograin", -5.7766197986084675),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.7766197986084675),
                                    ("last <cycle> of <time>year (latent)", -5.7766197986084675),
                                    ("tomorrow<time-of-day> am|pm", -6.182084906716631),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.488937726156687),
                                    ("Diwaliyear (latent)", -5.7766197986084675),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.182084906716631),
                                    ("this <part-of-day>at <time-of-day>", -5.265794174842477),
                                    ("Fridayyear (latent)", -5.265794174842477),
                                    ("time-of-day (latent)April", -6.182084906716631),
                                    ("minuteyear", -3.984860329380412)],
                               n = 329}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
