...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6149353575221643, unseen = -6.073044534100405,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 432},
                   koData =
                     ClassData{prior = -0.7779990977117044, unseen = -5.910796644040527,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4833172344018821, unseen = -7.091742115095153,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 457},
                   koData =
                     ClassData{prior = -0.9590263871348809, unseen = -6.752270376141742,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.553876891600541),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.652489180268651),
                                    ("hourday", -3.6600590155784443),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.0579542883768145),
                                    ("<day-of-month> (ordinal)August", -6.0579542883768145),
                                    ("dayhour", -3.383805638950286),
                                    ("<time> timezoneyear (latent)", -5.36480710781687),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.14166355650266),
                                    ("Tuesdayfrom|since|after <time>", -5.36480710781687),
                                    ("daymonth", -3.383805638950286),
                                    ("monthyear", -4.805191319881446),
                                    ...
                                    ("time-of-day (latent)intersect", -5.36480710781687),
                                    ...
                                    ("from|since|after <time>year (latent)", -4.959341999708705),
                                    ("dd/mmyear (latent)", -6.0579542883768145),
                                    ...
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.652489180268651),
                                    ("dayminute", -3.1957534074473464),
                                    ("yyyy-mm-ddhh:mm", -5.652489180268651),
                                    ("intersectfrom|since|after <time>", -5.652489180268651),
                                    ("intersectSeptember", -4.186152111475224),
                                    ("minuteday", -2.9009538672267015),
                                    ("absorption of , after named dayintersect",
                                     -6.0579542883768145),
                                    ...
                                    ("from|since|after <time>on <day>", -5.14166355650266),
                                    ("dayweek", -6.0579542883768145),
                                    ("Easter Sundayyear (latent)", -5.652489180268651),
                                    ("time-of-day (latent)at <time-of-day>", -5.36480710781687),
                                    ("Thursday<time-of-day> am|pm", -4.805191319881446),
                                    ("weekyear", -5.652489180268651),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.36480710781687),
                                    ("Sundayfrom|since|after <time>", -6.0579542883768145),
