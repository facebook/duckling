...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4982960941510582, unseen = -7.201170883281678,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.507277712385012),
                                    ...
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.507277712385012),
                                    ...
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.101812604276847),
                                    ("Marchyear (latent)", -6.507277712385012),
                                    ...
                                    ("from|since|after <time>December", -6.507277712385012),
                                    ("dd/mm<time-of-day> am|pm", -6.507277712385012),
                                    ("<time-of-day> am|pmon <day>", -4.492374691842747),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.507277712385012),
                                    ("yyyy-mm-ddhh:mm:ss", -6.101812604276847),
                                    ("dayday", -3.7346889901452305),
                                    ("dd/mmat <time-of-day>", -6.507277712385012),
                                    ...
                                    ("Februarythe <day-of-month> (ordinal)", -6.101812604276847),
                                    ...
                                    ("dayyear", -1.8921571955437522),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.507277712385012),
                                    ("Thursdayfrom|since|after <time>", -6.101812604276847),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.507277712385012),
                                    ...
                                    ("intersectin|during the <part-of-day>", -6.507277712385012),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.507277712385012),
                                    ("Mothering Sundayyear (latent)", -6.101812604276847),
                                    ...
                                    ("August Bank Holidayyear (latent)", -5.814130531825066),
                                    ("<datetime> - <datetime> (interval)July", -6.101812604276847),
                               ...
                               n = 514},
                   koData =
                     ClassData{prior = -0.9353843906897347, unseen = -6.884486652042782,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.686238009076873),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.784850297744983),
                                    ("hourday", -3.5876257204087634),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.1903154058531475),
                                    ("<day-of-month> (ordinal)August", -6.1903154058531475),
                                    ("dayhour", -3.5161667564266184),
                                    ("<time> timezoneyear (latent)", -5.497168225293202),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.274024673978992),
                                    ("Tuesdayfrom|since|after <time>", -5.497168225293202),
                                    ("daymonth", -3.482265204750937),
                                    ("hourquarter", -5.274024673978992),
                                    ("monthyear", -4.9375524373577795),
                                    ("<time-of-day> am|pmyear (latent)", -5.497168225293202),
                                    ("Thai Pongalyear (latent)", -5.497168225293202),
                                    ("intersecthh:mm", -6.1903154058531475),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.784850297744983),
                                    ("<day-of-month> (ordinal)Wednesday", -6.1903154058531475),
                                    ("houryear", -4.398555936625092),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.1903154058531475),
                                    ("<day-of-month> (ordinal)October", -6.1903154058531475),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.497168225293202),
                                    ("hournograin", -4.9375524373577795),
                                    ("<time-of-day> am|pmintersect", -4.9375524373577795),
                                    ("Octoberyear (latent)", -6.1903154058531475),
                                    ("Good Fridayyear (latent)", -5.784850297744983),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.784850297744983),
                                    ("early morningat <time-of-day>", -6.1903154058531475),
                                    ("until <time>on <day>", -5.497168225293202),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.1903154058531475),
                                    ("time-of-day (latent)intersect", -5.497168225293202),
                                    ("todayin <number> (implicit minutes)", -6.1903154058531475),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.497168225293202),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.1903154058531475),
                                    ("hh:mmon <day>", -4.9375524373577795),
                                    ("hhhmmintersect", -5.784850297744983),
                                    ("absorption of , after named dayJuly", -5.274024673978992),
                                    ("from|since|after <time>July", -5.784850297744983),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.274024673978992),
                                    ("Clean Mondayyear (latent)", -6.1903154058531475),
                                    ("monthhour", -6.1903154058531475),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.784850297744983),
                                    ("hourmonth", -4.050249242356877),
                                    ("todayat <time-of-day>", -6.1903154058531475),
                                    ("Bank Holidayyear (latent)", -5.497168225293202),
                                    ("hhhmmyear (latent)", -4.9375524373577795),
                                    ("from|since|after <time>December", -6.1903154058531475),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.1903154058531475),
                                    ("<time-of-day> am|pmon <day>", -4.9375524373577795),
                                    ("Mondayyear (latent)", -5.497168225293202),
                                    ("dayday", -4.050249242356877),
                                    ("dd/mmat <time-of-day>", -5.784850297744983),
                                    ("on <day>September", -5.497168225293202),
                                    ("time-of-day (latent)September", -5.784850297744983),
                                    ("hourhour", -3.939023607246652),
                                    ("time-of-day (latent)on <day>", -4.686238009076873),
                                    ("Thursdaydd/mm", -6.1903154058531475),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.784850297744983),
                                    ("dayyear", -3.076800096642773),
                                    ("New Year's Dayyear (latent)", -5.274024673978992),
                                    ("time-of-day (latent)Sunday", -5.784850297744983),
                                    ("Thursdayfrom|since|after <time>", -4.485567313614722),
                                    ("Thursdayat <time-of-day>", -4.580877493419047),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.1903154058531475),
                                    ("Aprilyear (latent)", -6.1903154058531475),
                                    ("the <day-of-month> (ordinal)July", -6.1903154058531475),
                                    ("the <day-of-month> (number)July", -6.1903154058531475),
                                    ("monthminute", -6.1903154058531475),
                                    ("hourminute", -5.497168225293202),
                                    ("<time-of-day> am|pmtomorrow", -5.784850297744983),
                                    ("Thursdayhh:mm", -5.274024673978992),
                                    ("<day-of-month> (ordinal)Tuesday", -5.784850297744983),
                                    ("minutemonth", -4.050249242356877),
                                    ("time-of-day (latent)Friday", -5.784850297744983),
                                    ("minutehour", -6.1903154058531475),
                                    ("part of daysat <time-of-day>", -5.0917031171850375),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.8389401486896695),
                                    ("Augustyear (latent)", -5.784850297744983),
                                    ("week-endin|during <named-month>|year", -6.1903154058531475),
                                    ("time-of-day (latent)Tuesday", -5.784850297744983),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.1903154058531475),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.784850297744983),
                                    ("Sundayyear (latent)", -5.274024673978992),
                                    ("hourweek", -5.274024673978992),
                                    ("the <day-of-month> (ordinal)Monday", -5.497168225293202),
                                    ("Christmasat <time-of-day>", -6.1903154058531475),
                                    ("from|since|after <time>year (latent)", -5.0917031171850375),
                                    ("dd/mmyear (latent)", -6.1903154058531475),
                                    ("hhhmmon <day>", -5.274024673978992),
                                    ("yesterday<time-of-day> am|pm", -6.1903154058531475),
                                    ("<day-of-month> (ordinal)July", -5.497168225293202),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.1903154058531475),
                                    ("at <time-of-day>intersect", -5.274024673978992),
                                    ("hh:mmyear (latent)", -4.804021044733257),
                                    ("Holiyear (latent)", -6.1903154058531475),
                                    ("until <time><time-of-day> am|pm", -6.1903154058531475),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.784850297744983),
                                    ("dayminute", -3.328114524923679),
                                    ("yyyy-mm-ddhh:mm", -5.784850297744983),
                                    ("intersectfrom|since|after <time>", -5.784850297744983),
                                    ("intersectSeptember", -4.318513228951556),
                                    ("minuteday", -3.033314984703034),
                                    ("absorption of , after named dayintersect",
                                     -6.1903154058531475),
                                    ("intersectyear (latent)", -6.1903154058531475),
                                    ("Februaryin|during the <part-of-day>", -6.1903154058531475),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.1903154058531475),
                                    ("time-of-day (latent)July", -5.497168225293202),
                                    ("Saturdayyear (latent)", -6.1903154058531475),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.1903154058531475),
                                    ("<day-of-month> (ordinal)Monday", -4.9375524373577795),
                                    ("at <time-of-day>on <day>", -5.274024673978992),
                                    ("time-of-day (latent)<time-of-day> am|pm",
                                     -6.1903154058531475),
                                    ("absorption of , after named daySeptember",
                                     -4.9375524373577795),
                                    ("Naraka Chaturdashiyear (latent)", -6.1903154058531475),
                                    ("from|since|after <time>on <day>", -5.274024673978992),
                                    ("dayweek", -6.1903154058531475),
                                    ("Easter Sundayyear (latent)", -5.784850297744983),
                                    ("time-of-day (latent)at <time-of-day>", -5.497168225293202),
                                    ("Thursday<time-of-day> am|pm", -4.9375524373577795),
                                    ("weekyear", -5.784850297744983),
                                    ("time-of-day (latent)Thursday", -5.784850297744983),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.1903154058531475),
                                    ("<day-of-month> (ordinal)April", -6.1903154058531475),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.784850297744983),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.497168225293202),
                                    ("Sundayfrom|since|after <time>", -6.1903154058531475),
                                    ("absorption of , after named dayFebruary", -5.274024673978992),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.784850297744983),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.1903154058531475),
                                    ("tomorrowat <time-of-day>", -6.1903154058531475),
                                    ("daynograin", -5.784850297744983),
                                    ("Fridayin|during <named-month>|year", -6.1903154058531475),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.784850297744983),
                                    ("last <cycle> of <time>year (latent)", -5.784850297744983),
                                    ("tomorrow<time-of-day> am|pm", -6.1903154058531475),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.497168225293202),
                                    ("Diwaliyear (latent)", -5.784850297744983),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.1903154058531475),
                                    ("this <part-of-day>at <time-of-day>", -5.274024673978992),
                                    ("Fridayyear (latent)", -5.274024673978992),
                                    ("time-of-day (latent)April", -6.1903154058531475),
                                    ("minuteyear", -3.993090828516928)],
                               n = 332}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
