...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7869240096932806, unseen = -5.19295685089021,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 178},
                   koData =
                     ClassData{prior = -0.6074153942759406,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.120983351265121),
                                    ...
                                    ("dd/mmat <time-of-day>", -4.715518243156957),
                                    ("<time-of-day> am|pmon <date>", -3.868220382769753),
                                    ("Thursdaydd/mm", -5.120983351265121),
