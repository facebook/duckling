...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4739329073856251, unseen = -7.188412736496954,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.494509983555011),
                                    ...
                                    ("Orthodox Good Fridayyear (latent)", -6.089044875446846),
                               ...
                               n = 508},
                   koData =
                     ClassData{prior = -0.9743145719905326, unseen = -6.828712071641684,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.630404657166633),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.729016945834743),
                                    ("hourday", -3.736586781144536),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.134482053942907),
                                    ("<day-of-month> (ordinal)August", -6.134482053942907),
                                    ("dayhour", -3.460333404516378),
                                    ("<time> timezoneyear (latent)", -5.441334873382962),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.218191322068752),
                                    ("Tuesdayfrom|since|after <time>", -5.441334873382962),
                                    ("daymonth", -3.460333404516378),
                                    ("monthyear", -4.881719085447539),
                                    ("<time-of-day> am|pmyear (latent)", -5.441334873382962),
                                    ("Thai Pongalyear (latent)", -5.441334873382962),
                                    ("intersecthh:mm", -6.134482053942907),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.729016945834743),
                                    ("<day-of-month> (ordinal)Wednesday", -6.134482053942907),
                                    ("houryear", -4.7481876928230164),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.134482053942907),
                                    ("<day-of-month> (ordinal)October", -6.134482053942907),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.441334873382962),
                                    ("hournograin", -4.881719085447539),
                                    ("<time-of-day> am|pmintersect", -4.881719085447539),
                                    ("Octoberyear (latent)", -6.134482053942907),
                                    ("Good Fridayyear (latent)", -5.729016945834743),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.729016945834743),
                                    ("early morningat <time-of-day>", -6.134482053942907),
                                    ("until <time>on <day>", -5.441334873382962),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.134482053942907),
                                    ("time-of-day (latent)intersect", -5.441334873382962),
                                    ("todayin <number> (implicit minutes)", -6.134482053942907),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.441334873382962),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.134482053942907),
                                    ("hh:mmon <day>", -4.881719085447539),
                                    ("hhhmmintersect", -5.729016945834743),
                                    ("absorption of , after named dayJuly", -5.218191322068752),
                                    ("from|since|after <time>July", -5.729016945834743),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.218191322068752),
                                    ("Clean Mondayyear (latent)", -6.134482053942907),
                                    ("monthhour", -6.134482053942907),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.729016945834743),
                                    ("hourmonth", -4.2626798770413155),
                                    ("todayat <time-of-day>", -6.134482053942907),
                                    ("Bank Holidayyear (latent)", -5.441334873382962),
                                    ("hhhmmyear (latent)", -4.881719085447539),
                                    ("from|since|after <time>December", -6.134482053942907),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.134482053942907),
                                    ("<time-of-day> am|pmon <day>", -4.881719085447539),
                                    ("Mondayyear (latent)", -5.441334873382962),
                                    ("dayday", -4.119579033400642),
                                    ("dd/mmat <time-of-day>", -5.729016945834743),
                                    ("on <day>September", -5.441334873382962),
                                    ("time-of-day (latent)September", -5.729016945834743),
                                    ("hourhour", -3.883190255336412),
                                    ("time-of-day (latent)on <day>", -4.630404657166633),
                                    ("Thursdaydd/mm", -6.134482053942907),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.729016945834743),
                                    ("dayyear", -3.0209667447325326),
                                    ("New Year's Dayyear (latent)", -5.218191322068752),
                                    ("time-of-day (latent)Sunday", -5.729016945834743),
                                    ("Thursdayfrom|since|after <time>", -4.429733961704482),
                                    ("Thursdayat <time-of-day>", -4.525044141508807),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.134482053942907),
                                    ("Aprilyear (latent)", -6.134482053942907),
                                    ("the <day-of-month> (ordinal)July", -6.134482053942907),
                                    ("the <day-of-month> (number)July", -6.134482053942907),
                                    ("monthminute", -6.134482053942907),
                                    ("hourminute", -5.441334873382962),
                                    ("<time-of-day> am|pmtomorrow", -6.134482053942907),
                                    ("Thursdayhh:mm", -5.218191322068752),
                                    ("<day-of-month> (ordinal)Tuesday", -5.729016945834743),
                                    ("minutemonth", -3.994415890446636),
                                    ("time-of-day (latent)Friday", -5.729016945834743),
                                    ("minutehour", -6.134482053942907),
                                    ("part of daysat <time-of-day>", -5.035869765274797),
                                    ("Augustyear (latent)", -5.729016945834743),
                                    ("week-endin|during <named-month>|year", -6.134482053942907),
                                    ("time-of-day (latent)Tuesday", -5.729016945834743),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.134482053942907),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.729016945834743),
                                    ("Sundayyear (latent)", -5.218191322068752),
                                    ("the <day-of-month> (ordinal)Monday", -5.441334873382962),
                                    ("Christmasat <time-of-day>", -6.134482053942907),
                                    ("from|since|after <time>year (latent)", -5.035869765274797),
                                    ("dd/mmyear (latent)", -6.134482053942907),
                                    ("hhhmmon <day>", -5.218191322068752),
                                    ("yesterday<time-of-day> am|pm", -6.134482053942907),
                                    ("<day-of-month> (ordinal)July", -5.441334873382962),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.134482053942907),
                                    ("at <time-of-day>intersect", -5.218191322068752),
                                    ("hh:mmyear (latent)", -4.7481876928230164),
                                    ("Holiyear (latent)", -6.134482053942907),
                                    ("until <time><time-of-day> am|pm", -6.134482053942907),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.729016945834743),
                                    ("dayminute", -3.2722811730134387),
                                    ("yyyy-mm-ddhh:mm", -5.729016945834743),
                                    ("intersectfrom|since|after <time>", -5.729016945834743),
                                    ("intersectSeptember", -4.2626798770413155),
                                    ("minuteday", -2.9774816327927938),
                                    ("absorption of , after named dayintersect",
                                     -6.134482053942907),
                                    ("intersectyear (latent)", -6.134482053942907),
                                    ("Februaryin|during the <part-of-day>", -6.134482053942907),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.134482053942907),
                                    ("time-of-day (latent)July", -5.441334873382962),
                                    ("Saturdayyear (latent)", -6.134482053942907),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.134482053942907),
                                    ("<day-of-month> (ordinal)Monday", -5.218191322068752),
                                    ("at <time-of-day>on <day>", -5.218191322068752),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.134482053942907),
                                    ("absorption of , after named daySeptember",
                                     -4.881719085447539),
                                    ("Naraka Chaturdashiyear (latent)", -6.134482053942907),
                                    ("from|since|after <time>on <day>", -5.218191322068752),
                                    ("dayweek", -6.134482053942907),
                                    ("Easter Sundayyear (latent)", -5.729016945834743),
                                    ("time-of-day (latent)at <time-of-day>", -5.441334873382962),
                                    ("Thursday<time-of-day> am|pm", -4.881719085447539),
                                    ("weekyear", -5.729016945834743),
                                    ("time-of-day (latent)Thursday", -5.729016945834743),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.134482053942907),
                                    ("<day-of-month> (ordinal)April", -6.134482053942907),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.729016945834743),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.441334873382962),
                                    ("Sundayfrom|since|after <time>", -6.134482053942907),
                                    ("absorption of , after named dayFebruary", -5.218191322068752),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.729016945834743),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.134482053942907),
                                    ("tomorrowat <time-of-day>", -6.134482053942907),
                                    ("daynograin", -5.729016945834743),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.729016945834743),
                                    ("last <cycle> of <time>year (latent)", -5.729016945834743),
                                    ("tomorrow<time-of-day> am|pm", -6.134482053942907),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.441334873382962),
                                    ("Diwaliyear (latent)", -5.729016945834743),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.134482053942907),
                                    ("this <part-of-day>at <time-of-day>", -5.218191322068752),
                                    ("Fridayyear (latent)", -5.218191322068752),
                                    ("time-of-day (latent)April", -6.134482053942907),
                                    ("minuteyear", -3.9372574766066877)],
                               n = 308}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
