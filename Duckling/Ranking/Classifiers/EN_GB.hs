...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7813217541446108, unseen = -5.198497031265826,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 179},
                   koData =
                     ClassData{prior = -0.6121212853133533, unseen = -5.365976015021851,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4743295191928581, unseen = -6.175867270105761,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.564348191467836),
                                    ("hourday", -3.775890831103566),
                                    ("dayhour", -3.2293471247354963),
                                    ("daymonth", -4.787491742782046),
                                    ("monthday", -5.075173815233827),
                                    ("monthyear", -3.871201010907891),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.480638923341991),
                                    ("Christmasyear", -5.480638923341991),
                                    ...
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.787491742782046),
                                    ("<time-of-day> am|pmintersect", -4.227875954846623),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.480638923341991),
                                    ("Marchyear", -5.480638923341991),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.075173815233827),
                                    ("intersect<time-of-day> am|pm", -5.480638923341991),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.480638923341991),
                                    ("monthhour", -5.075173815233827),
                                    ("last <day-of-week> of <time>year", -5.480638923341991),
                                    ("todayat <time-of-day>", -5.480638923341991),
                                    ("Thursday<time> timezone", -5.075173815233827),
                                    ("dd/mm<time-of-day> am|pm", -5.480638923341991),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.480638923341991),
                                    ("dayday", -3.4657359027997265),
                                    ("Thanksgiving Dayyear", -4.382026634673881),
                                    ("dd/mmat <time-of-day>", -5.480638923341991),
                                    ("<time> <part-of-day>at <time-of-day>", -5.480638923341991),
                                    ("Tuesdayin <named-month>", -5.480638923341991),
                                    ("tonightat <time-of-day>", -5.480638923341991),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.787491742782046),
                                    ("today<time-of-day> am|pm", -5.480638923341991),
                                    ("Februarythe <day-of-month> (ordinal)", -5.075173815233827),
                                    ("at <time-of-day><time> <part-of-day>", -5.480638923341991),
                                    ("hourhour", -4.227875954846623),
                                    ("<time-of-day> am|pmon <date>", -3.4657359027997265),
                                    ("Wednesdaythis|last|next <cycle>", -5.480638923341991),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.9765615265657175),
                                    ("dayyear", -3.038291887972787),
                                    ("last weekend of <named-month>year", -5.480638923341991),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.480638923341991),
                                    ("<time-of-day> am|pmtomorrow", -4.787491742782046),
                                    ("minutehour", -4.564348191467836),
                                    ("Mother's Dayyear", -5.480638923341991),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.075173815233827),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.775890831103566),
                                    ("for <duration> from <time>December", -5.480638923341991),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.480638923341991),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.564348191467836),
                                    ("Mondayin|during the <part-of-day>", -5.480638923341991),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.075173815233827),
                                    ("intersectin|during the <part-of-day>", -5.480638923341991),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.480638923341991),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -4.564348191467836),
                                    ("at <time-of-day>intersect", -5.075173815233827),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.075173815233827),
                                    ("<ordinal> <cycle> of <time>year", -5.480638923341991),
                                    ("minuteday", -2.0794415416798357),
                                    ("absorption of , after named dayintersect",
                                     -5.480638923341991),
                                    ("Octoberyear", -4.227875954846623),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.480638923341991),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.480638923341991),
                                    ("year<time-of-day> am|pm", -5.480638923341991),
                                    ("Septemberyear", -5.075173815233827),
                                    ("at <time-of-day>on <date>", -4.382026634673881),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.787491742782046),
                                    ("Halloweenyear", -5.480638923341991),
                                    ("dayweek", -5.480638923341991),
                                    ("weekyear", -5.075173815233827),
                                    ("hh:mmin|during the <part-of-day>", -4.787491742782046),
                                    ("Father's Dayyear", -5.480638923341991),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.075173815233827),
                                    ("February<time> <part-of-day>", -5.480638923341991),
                                    ("Martin Luther King's Dayyear", -5.075173815233827),
                                    ("tomorrowat <time-of-day>", -4.787491742782046),
                                    ("between <time> and <time>on <date>", -4.787491742782046),
                                    ("at <time-of-day>tomorrow", -5.075173815233827),
                                    ("tomorrow<time-of-day> am|pm", -5.480638923341991),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.480638923341991),
                                    ("black fridayyear", -5.075173815233827),
                                    ("Labor Dayyear", -5.480638923341991),
                                    ("Februaryintersect", -5.480638923341991),
                                    ("last <cycle> of <time>year", -4.787491742782046),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.480638923341991),
                                    ("yearminute", -5.480638923341991)],
                               n = 173},
                   koData =
                     ClassData{prior = -0.9736607635331137, unseen = -5.84354441703136,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.147494476813453),
                                    ...
                                    ("monthhour", -5.147494476813453),
                                    ("hourmonth", -4.454347296253507),
                                    ("todayat <time-of-day>", -5.147494476813453),
                                    ("dayday", -4.742029368705289),
                                    ("dd/mmat <time-of-day>", -4.742029368705289),
                                    ("<time-of-day> am|pmon <date>", -3.894731508318085),
                                    ("Thursdaydd/mm", -5.147494476813453),
                                    ("dayyear", -3.894731508318085),
                                    ...
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.147494476813453),
                                    ("Fridayyear", -4.742029368705289),
                                    ("minutemonth", -3.442746384575028),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.742029368705289),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.742029368705289),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.147494476813453),
                                    ("this <time>six thirty six a.m.", -5.147494476813453),
                                    ("until <time-of-day>on <date>", -4.454347296253507),
                                    ("at <time-of-day>intersect", -4.742029368705289),
                                    ("Thursdaysix thirty six a.m.", -5.147494476813453),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.147494476813453),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.147494476813453),
                                    ("minuteday", -2.344134095906918),
                                    ("absorption of , after named dayintersect",
                                     -5.147494476813453),
                                    ("Februaryin|during the <part-of-day>", -5.147494476813453),
                                    ("week-endin <named-month>", -5.147494476813453),
                                    ("Octoberyear", -5.147494476813453),
                                    ...
                                    ("at <time-of-day>on <date>", -4.742029368705289),
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.5642134971840521, unseen = -4.189654742026425,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 62},
                   koData =
                     ClassData{prior = -0.841200280519085, unseen = -3.9318256327243257,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.3109389346160482, unseen = -5.231108616854587,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 85},
                   koData =
                     ClassData{prior = -1.3196029866212184,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -3.258096538021482),
                                    ...
                                    ("hour", -0.9894129967031177), ("minute", -2.9704144655697013),
                                    ("after <time-of-day>", -3.6635616461296463)],
                               n = 31}}),
