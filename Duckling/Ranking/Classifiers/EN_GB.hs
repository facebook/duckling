...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7053177161802004,
                               unseen = -5.5093883366279774,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 245},
                   koData =
                     ClassData{prior = -0.6811229875931435, unseen = -5.53338948872752,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.490251790075683, unseen = -6.5998704992128365,
                               likelihoods =
                                 HashMap.fromList
                                   [("Father's Dayyear (latent)", -5.905361848054571),
                                    ("Ramadanyear (latent)", -5.905361848054571),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.652598879559203),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.652598879559203),
                                    ("hourday", -4.200613755816145),
                                    ("dayhour", -2.9875911159702913),
                                    ("Martin Luther King's Dayyear (latent)", -5.499896739946406),
                                    ("Shemini Atzeretyear (latent)", -5.905361848054571),
                                    ("daymonth", -5.212214667494625),
                                    ("monthday", -5.499896739946406),
                                    ("monthyear", -4.29592393562047),
                                    ("Yom Ha'atzmautyear (latent)", -5.905361848054571),
                                    ("Thanksgiving Dayyear (latent)", -4.806749559386461),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.905361848054571),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.905361848054571),
                                    ("houryear", -5.499896739946406),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.905361848054571),
                                    ("Christmas<time-of-day> am|pm", -5.905361848054571),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.905361848054571),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.212214667494625),
                                    ("<time-of-day> am|pmintersect", -4.652598879559203),
                                    ("Octoberyear (latent)", -4.652598879559203),
                                    ("intersect<time-of-day> am|pm", -5.905361848054571),
                                    ("Shavuotyear (latent)", -5.905361848054571),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.905361848054571),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.499896739946406),
                                    ("Marchyear (latent)", -5.905361848054571),
                                    ("Sukkotyear (latent)", -5.499896739946406),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.905361848054571),
                                    ("Clean Mondayyear (latent)", -5.499896739946406),
                                    ("monthhour", -5.499896739946406),
                                    ("todayat <time-of-day>", -5.905361848054571),
                                    ("Thursday<time> timezone", -4.200613755816145),
                                    ("dd/mm<time-of-day> am|pm", -5.905361848054571),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.905361848054571),
                                    ("Palm SundaySunday", -5.499896739946406),
                                    ("dayday", -3.7081372707183506),
                                    ("dd/mmat <time-of-day>", -5.905361848054571),
                                    ("<time> <part-of-day>at <time-of-day>", -5.905361848054571),
                                    ("tonightat <time-of-day>", -5.905361848054571),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.212214667494625),
                                    ("today<time-of-day> am|pm", -5.905361848054571),
                                    ("Februarythe <day-of-month> (ordinal)", -5.499896739946406),
                                    ("at <time-of-day><time> <part-of-day>", -5.905361848054571),
                                    ("hourhour", -4.652598879559203),
                                    ("<time-of-day> am|pmon <date>", -3.8904588275123055),
                                    ("Wednesdaythis|last|next <cycle>", -5.905361848054571),
                                    ("Lentyear (latent)", -5.905361848054571),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.401284451278296),
                                    ("dayyear", -2.216482393940634),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.905361848054571),
                                    ("Thursdayat <time-of-day>", -5.499896739946406),
                                    ("Islamic New Yearyear (latent)", -5.499896739946406),
                                    ("Laylat al-Qadryear (latent)", -4.9890711161804155),
                                    ("Shrove Tuesdayyear (latent)", -5.905361848054571),
                                    ("<time-of-day> am|pmtomorrow", -5.212214667494625),
                                    ("Yom Kippuryear (latent)", -5.905361848054571),
                                    ("<part-of-day> of <time>year (latent)", -5.905361848054571),
                                    ("minutehour", -4.9890711161804155),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.499896739946406),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.200613755816145),
                                    ("for <duration> from <time>December", -5.905361848054571),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.905361848054571),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.9890711161804155),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.499896739946406),
                                    ("Pentecostyear (latent)", -5.905361848054571),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.9890711161804155),
                                    ("Eid al-Fitryear (latent)", -5.905361848054571),
                                    ("Mondayin|during the <part-of-day>", -5.905361848054571),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.499896739946406),
                                    ("Ashurayear (latent)", -5.905361848054571),
                                    ("Chinese New Yearyear (latent)", -5.905361848054571),
                                    ("Sundayyear (latent)", -5.905361848054571),
                                    ("Lag BaOmeryear (latent)", -5.905361848054571),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.905361848054571),
                                    ("Eid al-Adhayear (latent)", -4.9890711161804155),
                                    ("intersectin|during the <part-of-day>", -5.905361848054571),
                                    ("Christmasat <time-of-day>", -5.905361848054571),
                                    ("Passoveryear (latent)", -5.905361848054571),
                                    ("Lazarus Saturdayyear (latent)", -5.905361848054571),
                                    ("dd/mmyear (latent)", -5.905361848054571),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.905361848054571),
                                    ("Yom HaShoahyear (latent)", -5.499896739946406),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.9890711161804155),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.905361848054571),
                                    ("Septemberyear (latent)", -5.499896739946406),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.652598879559203),
                                    ("Halloweenyear (latent)", -5.905361848054571),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.212214667494625),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -4.9890711161804155),
                                    ("at <time-of-day>intersect", -5.499896739946406),
                                    ("Rosh Hashanahyear (latent)", -5.905361848054571),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.905361848054571),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.905361848054571),
                                    ("dayminute", -3.266304518439312),
                                    ("Mawlidyear (latent)", -5.905361848054571),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.499896739946406),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.905361848054571),
                                    ("Jumu'atul-Widayear (latent)", -4.9890711161804155),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.905361848054571),
                                    ("minuteday", -2.2677756883281845),
                                    ("absorption of , after named dayintersect",
                                     -5.905361848054571),
                                    ("intersectyear (latent)", -5.905361848054571),
                                    ("Orthodox Easter Sundayyear (latent)", -5.905361848054571),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.905361848054571),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.905361848054571),
                                    ("Mothering Sundayyear (latent)", -5.499896739946406),
                                    ("Boss's Dayyear (latent)", -5.499896739946406),
                                    ("Tisha B'Avyear (latent)", -5.905361848054571),
                                    ("Isra and Mi'rajyear (latent)", -4.9890711161804155),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.905361848054571),
                                    ("Christmasyear (latent)", -5.499896739946406),
                                    ("at <time-of-day>on <date>", -4.806749559386461),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.29592393562047),
                                    ("dayweek", -5.905361848054571),
                                    ("Easter Sundayyear (latent)", -5.212214667494625),
                                    ("Thursday<time-of-day> am|pm", -5.905361848054571),
                                    ("weekyear", -5.499896739946406),
                                    ("hh:mmin|during the <part-of-day>", -5.212214667494625),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.499896739946406),
                                    ("Hanukkahyear (latent)", -5.905361848054571),
                                    ("February<time> <part-of-day>", -5.905361848054571),
                                    ("Tuesdayin <named-month>|year", -5.905361848054571),
                                    ("Great Lentyear (latent)", -5.905361848054571),
                                    ("tomorrowat <time-of-day>", -5.212214667494625),
                                    ("between <time> and <time>on <date>", -4.29592393562047),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.212214667494625),
                                    ("last <cycle> of <time>year (latent)", -5.212214667494625),
                                    ("at <time-of-day>tomorrow", -5.499896739946406),
                                    ("tomorrow<time-of-day> am|pm", -5.905361848054571),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.905361848054571),
                                    ("Black Fridayyear (latent)", -5.499896739946406),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.905361848054571),
                                    ("Palm Sundayintersect", -5.905361848054571),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.905361848054571),
                                    ("August Bank Holidayyear (latent)", -5.212214667494625),
                                    ("Februaryintersect", -5.905361848054571),
                                    ("Simchat Torahyear (latent)", -5.905361848054571)],
                               n = 275},
                   koData =
                     ClassData{prior = -0.9479675885277252, unseen = -6.278521424165844,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.583496308781699),
                                    ("hourday", -5.583496308781699),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.583496308781699),
                                    ("dayhour", -3.141149273412495),
                                    ("daymonth", -3.5040547671018634),
                                    ("monthday", -5.1780312006735345),
                                    ("monthyear", -4.330733340286331),
                                    ("<time-of-day> am|pmyear (latent)", -5.1780312006735345),
                                    ("intersecthh:mm", -5.583496308781699),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.583496308781699),
                                    ("houryear", -4.667205576907544),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.583496308781699),
                                    ("until <time-of-day><time-of-day> am|pm", -5.583496308781699),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.890349128221754),
                                    ("<time-of-day> am|pmintersect", -4.330733340286331),
                                    ("Octoberyear (latent)", -5.583496308781699),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.330733340286331),
                                    ("from|since|after <time-of-day>on <date>", -4.667205576907544),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.583496308781699),
                                    ("absorption of , after named dayJuly", -5.1780312006735345),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.667205576907544),
                                    ("Clean Mondayyear (latent)", -5.583496308781699),
                                    ("monthhour", -5.583496308781699),
                                    ("hourmonth", -4.890349128221754),
                                    ("todayat <time-of-day>", -5.583496308781699),
                                    ("Bank Holidayyear (latent)", -4.890349128221754),
                                    ("from|since|after <time-of-day>July", -5.583496308781699),
                                    ("Mondayyear (latent)", -4.890349128221754),
                                    ("dayday", -5.1780312006735345),
                                    ("dd/mmat <time-of-day>", -5.1780312006735345),
                                    ("<time-of-day> am|pmon <date>", -4.330733340286331),
                                    ("Thursdaydd/mm", -5.583496308781699),
                                    ("dayyear", -2.7212954278522306),
                                    ("New Year's Dayyear (latent)", -5.1780312006735345),
                                    ("Thursdayat <time-of-day>", -4.330733340286331),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.583496308781699),
                                    ("Aprilyear (latent)", -5.583496308781699),
                                    ("monthminute", -5.583496308781699),
                                    ("<time-of-day> am|pmtomorrow", -5.583496308781699),
                                    ("Thursdayhh:mm", -4.667205576907544),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.583496308781699),
                                    ("minutemonth", -3.791736839553644),
                                    ("Sundayfrom|since|after <time-of-day>", -5.583496308781699),
                                    ("week-endin <named-month>|year", -5.583496308781699),
                                    ("Augustyear (latent)", -5.1780312006735345),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.1780312006735345),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.1780312006735345),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.1780312006735345),
                                    ("Sundayyear (latent)", -4.890349128221754),
                                    ("Christmasat <time-of-day>", -5.583496308781699),
                                    ("dd/mmyear (latent)", -5.583496308781699),
                                    ("<duration> after|before|from <time>December",
                                     -5.583496308781699),
                                    ("yesterday<time-of-day> am|pm", -5.583496308781699),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.583496308781699),
                                    ("until <time-of-day>on <date>", -4.890349128221754),
                                    ("at <time-of-day>intersect", -5.1780312006735345),
                                    ("hh:mmyear (latent)", -4.484884020113589),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.583496308781699),
                                    ("dayminute", -3.0985896589936988),
                                    ("intersectSeptember", -4.079418912005425),
                                    ("minuteday", -2.515443373648082),
                                    ("absorption of , after named dayintersect",
                                     -5.583496308781699),
                                    ("Februaryin|during the <part-of-day>", -5.583496308781699),
                                    ("hh:mmon <date>", -3.5685932882394344),
                                    ("Saturdayyear (latent)", -5.583496308781699),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.583496308781699),
                                    ("absorption of , after named daySeptember",
                                     -4.667205576907544),
                                    ("on <date>September", -5.1780312006735345),
                                    ("at <time-of-day>on <date>", -5.1780312006735345),
                                    ("in <named-month>|yearyear (latent)", -5.583496308781699),
                                    ("dayweek", -5.583496308781699),
                                    ("Easter Sundayyear (latent)", -5.1780312006735345),
                                    ("Thursday<time-of-day> am|pm", -5.1780312006735345),
                                    ("absorption of , after named dayFebruary", -4.667205576907544),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.583496308781699),
                                    ("tomorrowat <time-of-day>", -5.583496308781699),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.583496308781699),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.9740583963475986),
                                    ("tomorrow<time-of-day> am|pm", -5.583496308781699),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.890349128221754),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.583496308781699),
                                    ("Fridayyear (latent)", -5.1780312006735345),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.2016373460932461, unseen = -4.59511985013459,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -5.2367985517315925e-2),
                                    ("intersect 2 numbers", -3.4863551900024623)],
                               n = 94},
                   koData =
                     ClassData{prior = -1.7004096906398272, unseen = -3.258096538021482,
                               likelihoods =
                                 HashMap.fromList
