...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5768013960819182, unseen = -6.173786103901937,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 478},
                   koData =
                     ClassData{prior = -0.8248337089295585, unseen = -5.926926025970411,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4788228926798169, unseen = -7.189922170745808,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.496020557860377),
                                    ...
                                    ("daymonth", -4.481117537318113),
                                    ("monthday", -6.0905554497522125),
                                    ("monthyear", -4.704261088632323),
                                    ("Yom Ha'atzmautyear (latent)", -6.496020557860377),
                                    ("Orthodox Good Fridayyear (latent)", -6.0905554497522125),
                                    ...
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.496020557860377),
                                    ...
                                    ("Februarythe <day-of-month> (ordinal)", -6.0905554497522125),
                                    ...
                                    ("intersectin|during the <part-of-day>", -6.496020557860377),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.496020557860377),
                                    ("Mothering Sundayyear (latent)", -6.0905554497522125),
                                    ...
                                    ("August Bank Holidayyear (latent)", -5.802873377300432),
                                    ("<datetime> - <datetime> (interval)July", -6.0905554497522125),
                               ...
                               n = 508},
                   koData =
                     ClassData{prior = -0.9663011524488164, unseen = -6.839476438228843,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.641180623511124),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.739792912179234),
                                    ("hourday", -3.747362747489028),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.1452580202873985),
                                    ("<day-of-month> (ordinal)August", -6.1452580202873985),
                                    ("dayhour", -3.47110937086087),
                                    ("<time> timezoneyear (latent)", -5.452110839727453),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.228967288413243),
                                    ("Tuesdayfrom|since|after <time>", -5.452110839727453),
                                    ("daymonth", -3.47110937086087),
                                    ("monthyear", -4.8924950517920305),
                                    ("<time-of-day> am|pmyear (latent)", -5.452110839727453),
                                    ("Thai Pongalyear (latent)", -5.452110839727453),
                                    ("intersecthh:mm", -6.1452580202873985),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.739792912179234),
                                    ("<day-of-month> (ordinal)Wednesday", -6.1452580202873985),
                                    ("houryear", -4.758963659167508),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.1452580202873985),
                                    ("<day-of-month> (ordinal)October", -6.1452580202873985),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.452110839727453),
                                    ("hournograin", -4.8924950517920305),
                                    ("<time-of-day> am|pmintersect", -4.8924950517920305),
                                    ("Octoberyear (latent)", -6.1452580202873985),
                                    ("Good Fridayyear (latent)", -5.739792912179234),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.739792912179234),
                                    ("early morningat <time-of-day>", -6.1452580202873985),
                                    ("until <time>on <day>", -5.452110839727453),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.1452580202873985),
                                    ("time-of-day (latent)intersect", -5.452110839727453),
                                    ("todayin <number> (implicit minutes)", -6.1452580202873985),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.452110839727453),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.1452580202873985),
                                    ("hh:mmon <day>", -4.8924950517920305),
                                    ("hhhmmintersect", -5.739792912179234),
                                    ("absorption of , after named dayJuly", -5.228967288413243),
                                    ("from|since|after <time>July", -5.739792912179234),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.228967288413243),
                                    ("Clean Mondayyear (latent)", -6.1452580202873985),
                                    ("monthhour", -6.1452580202873985),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.739792912179234),
                                    ("hourmonth", -4.273455843385807),
                                    ("todayat <time-of-day>", -6.1452580202873985),
                                    ("Bank Holidayyear (latent)", -5.452110839727453),
                                    ("hhhmmyear (latent)", -4.8924950517920305),
                                    ("from|since|after <time>December", -6.1452580202873985),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.1452580202873985),
                                    ("<time-of-day> am|pmon <day>", -4.8924950517920305),
                                    ("Mondayyear (latent)", -5.452110839727453),
                                    ("dayday", -4.130354999745133),
                                    ("dd/mmat <time-of-day>", -5.739792912179234),
                                    ("on <day>September", -5.452110839727453),
                                    ("time-of-day (latent)September", -5.739792912179234),
                                    ("hourhour", -3.8939662216809032),
                                    ("time-of-day (latent)on <day>", -4.641180623511124),
                                    ("Thursdaydd/mm", -6.1452580202873985),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.739792912179234),
                                    ("dayyear", -3.0317427110770243),
                                    ("New Year's Dayyear (latent)", -5.228967288413243),
                                    ("time-of-day (latent)Sunday", -5.739792912179234),
                                    ("Thursdayfrom|since|after <time>", -4.440509928048973),
                                    ("Thursdayat <time-of-day>", -4.535820107853298),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.1452580202873985),
                                    ("Aprilyear (latent)", -6.1452580202873985),
                                    ("the <day-of-month> (ordinal)July", -6.1452580202873985),
                                    ("the <day-of-month> (number)July", -6.1452580202873985),
                                    ("monthminute", -6.1452580202873985),
                                    ("hourminute", -5.452110839727453),
                                    ("<time-of-day> am|pmtomorrow", -6.1452580202873985),
                                    ("Thursdayhh:mm", -5.228967288413243),
                                    ("<day-of-month> (ordinal)Tuesday", -5.739792912179234),
                                    ("minutemonth", -4.005191856791128),
                                    ("time-of-day (latent)Friday", -5.739792912179234),
                                    ("minutehour", -6.1452580202873985),
                                    ("part of daysat <time-of-day>", -5.0466457316192885),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -5.228967288413243),
                                    ("Augustyear (latent)", -5.739792912179234),
                                    ("week-endin|during <named-month>|year", -6.1452580202873985),
                                    ("time-of-day (latent)Tuesday", -5.739792912179234),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.1452580202873985),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.739792912179234),
                                    ("Sundayyear (latent)", -5.228967288413243),
                                    ("hourweek", -5.228967288413243),
                                    ("the <day-of-month> (ordinal)Monday", -5.452110839727453),
                                    ("Christmasat <time-of-day>", -6.1452580202873985),
                                    ("from|since|after <time>year (latent)", -5.0466457316192885),
                                    ("dd/mmyear (latent)", -6.1452580202873985),
                                    ("hhhmmon <day>", -5.228967288413243),
                                    ("yesterday<time-of-day> am|pm", -6.1452580202873985),
                                    ("<day-of-month> (ordinal)July", -5.452110839727453),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.1452580202873985),
                                    ("at <time-of-day>intersect", -5.228967288413243),
                                    ("hh:mmyear (latent)", -4.758963659167508),
                                    ("Holiyear (latent)", -6.1452580202873985),
                                    ("until <time><time-of-day> am|pm", -6.1452580202873985),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.739792912179234),
                                    ("dayminute", -3.28305713935793),
                                    ("yyyy-mm-ddhh:mm", -5.739792912179234),
                                    ("intersectfrom|since|after <time>", -5.739792912179234),
                                    ("intersectSeptember", -4.273455843385807),
                                    ("minuteday", -2.988257599137285),
                                    ("absorption of , after named dayintersect",
                                     -6.1452580202873985),
                                    ("intersectyear (latent)", -6.1452580202873985),
                                    ("Februaryin|during the <part-of-day>", -6.1452580202873985),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.1452580202873985),
                                    ("time-of-day (latent)July", -5.452110839727453),
                                    ("Saturdayyear (latent)", -6.1452580202873985),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.1452580202873985),
                                    ("<day-of-month> (ordinal)Monday", -5.228967288413243),
                                    ("at <time-of-day>on <day>", -5.228967288413243),
                                    ("time-of-day (latent)<time-of-day> am|pm",
                                     -6.1452580202873985),
                                    ("absorption of , after named daySeptember",
                                     -4.8924950517920305),
                                    ("Naraka Chaturdashiyear (latent)", -6.1452580202873985),
                                    ("from|since|after <time>on <day>", -5.228967288413243),
                                    ("dayweek", -6.1452580202873985),
                                    ("Easter Sundayyear (latent)", -5.739792912179234),
                                    ("time-of-day (latent)at <time-of-day>", -5.452110839727453),
                                    ("Thursday<time-of-day> am|pm", -4.8924950517920305),
                                    ("weekyear", -5.739792912179234),
                                    ("time-of-day (latent)Thursday", -5.739792912179234),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.1452580202873985),
                                    ("<day-of-month> (ordinal)April", -6.1452580202873985),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.739792912179234),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.452110839727453),
                                    ("Sundayfrom|since|after <time>", -6.1452580202873985),
                                    ("absorption of , after named dayFebruary", -5.228967288413243),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.739792912179234),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.1452580202873985),
                                    ("tomorrowat <time-of-day>", -6.1452580202873985),
                                    ("daynograin", -5.739792912179234),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.739792912179234),
                                    ("last <cycle> of <time>year (latent)", -5.739792912179234),
                                    ("tomorrow<time-of-day> am|pm", -6.1452580202873985),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.452110839727453),
                                    ("Diwaliyear (latent)", -5.739792912179234),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.1452580202873985),
                                    ("this <part-of-day>at <time-of-day>", -5.228967288413243),
                                    ("Fridayyear (latent)", -5.228967288413243),
                                    ("time-of-day (latent)April", -6.1452580202873985),
                                    ("minuteyear", -3.948033442951179)],
                               n = 312}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6401816449800326, unseen = -4.859812404361672,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 126},
                   koData =
                     ClassData{prior = -0.7490757332191701,
