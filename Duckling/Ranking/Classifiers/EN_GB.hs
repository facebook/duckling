...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6502701562035536, unseen = -5.62040086571715,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 274},
                   koData =
                     ClassData{prior = -0.7379453234598399, unseen = -5.53338948872752,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4662838481432036, unseen = -6.699500340161678,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.005120873555468),
                                    ("Father's Dayyear (latent)", -6.005120873555468),
                                    ...
                                    ("Octoberyear (latent)", -4.7523579050601),
                                    ...
                                    ("Dhanterasin <named-month>|year", -6.005120873555468),
                                    ...
                                    ("dd/mm<time-of-day> am|pm", -6.005120873555468),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.005120873555468),
                                    ("Palm SundaySunday", -5.599655765447303),
                                    ("dayday", -3.807896296219248),
                                    ("dd/mmat <time-of-day>", -6.005120873555468),
                                    ...
                                    ("Chhathin <named-month>|year", -6.005120873555468),
                                    ("Diwaliin <named-month>|year", -6.005120873555468),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.599655765447303),
                                    ("Navaratriin <named-month>|year", -6.005120873555468),
                                    ("Ashurayear (latent)", -6.005120873555468),
                                    ("Chinese New Yearyear (latent)", -6.005120873555468),
                                    ("Sundayyear (latent)", -6.005120873555468),
                                    ...
                                    ("dd/mmyear (latent)", -6.005120873555468),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.005120873555468),
                                    ("Thai Pongalin <named-month>|year", -6.005120873555468),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -6.005120873555468),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.005120873555468),
                                    ("Mothering Sundayyear (latent)", -5.599655765447303),
                                    ...
                                    ("Thursday<time-of-day> am|pm", -6.005120873555468),
                                    ("weekyear", -5.599655765447303),
                                    ("hh:mmin|during the <part-of-day>", -5.311973692995522),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.599655765447303),
                                    ("Hanukkahyear (latent)", -6.005120873555468),
                                    ("February<time> <part-of-day>", -6.005120873555468),
                                    ("Tuesdayin <named-month>|year", -6.005120873555468),
                                    ...
                                    ("Thursdayfrom|since|after <time-of-day>", -5.311973692995522),
                                    ...
                                    ("Palm Sundayintersect", -6.005120873555468),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.005120873555468),
                                    ("August Bank Holidayyear (latent)", -5.311973692995522),
                                    ("Februaryintersect", -6.005120873555468),
                                    ("Simchat Torahyear (latent)", -6.005120873555468)],
                               n = 303},
                   koData =
                     ClassData{prior = -0.9870598027623624, unseen = -6.338594078203183,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.643678550586496),
                                    ("hourday", -5.643678550586496),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.643678550586496),
                                    ("dayhour", -3.201331515217291),
                                    ("daymonth", -3.5642370089066597),
                                    ("monthday", -5.238213442478331),
                                    ("monthyear", -4.390915582091128),
                                    ("<time-of-day> am|pmyear (latent)", -5.238213442478331),
                                    ("Thai Pongalyear (latent)", -4.9505313700265505),
                                    ("intersecthh:mm", -5.643678550586496),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.643678550586496),
                                    ("houryear", -4.727387818712341),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.643678550586496),
                                    ("until <time-of-day><time-of-day> am|pm", -5.643678550586496),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.9505313700265505),
                                    ("<time-of-day> am|pmintersect", -4.390915582091128),
                                    ("Octoberyear (latent)", -5.643678550586496),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.390915582091128),
                                    ("from|since|after <time-of-day>on <date>", -4.727387818712341),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.643678550586496),
                                    ("absorption of , after named dayJuly", -5.238213442478331),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.727387818712341),
                                    ("Clean Mondayyear (latent)", -5.643678550586496),
                                    ("monthhour", -5.643678550586496),
                                    ("hourmonth", -4.9505313700265505),
                                    ("todayat <time-of-day>", -5.643678550586496),
                                    ("Bank Holidayyear (latent)", -4.9505313700265505),
                                    ("from|since|after <time-of-day>July", -5.643678550586496),
                                    ("Mondayyear (latent)", -4.9505313700265505),
                                    ("dayday", -5.238213442478331),
                                    ("dd/mmat <time-of-day>", -5.238213442478331),
                                    ("<time-of-day> am|pmon <date>", -4.390915582091128),
                                    ("Thursdaydd/mm", -5.643678550586496),
                                    ("dayyear", -2.6232536644421334),
                                    ("New Year's Dayyear (latent)", -5.238213442478331),
                                    ("Thursdayat <time-of-day>", -4.390915582091128),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.643678550586496),
                                    ("Aprilyear (latent)", -5.643678550586496),
                                    ("monthminute", -5.643678550586496),
                                    ("<time-of-day> am|pmtomorrow", -5.643678550586496),
                                    ("Thursdayhh:mm", -4.727387818712341),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.643678550586496),
                                    ("minutemonth", -3.8519190813584405),
                                    ("Sundayfrom|since|after <time-of-day>", -5.643678550586496),
                                    ("week-endin <named-month>|year", -5.643678550586496),
                                    ("Augustyear (latent)", -5.238213442478331),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.238213442478331),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.238213442478331),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.238213442478331),
                                    ("Sundayyear (latent)", -4.9505313700265505),
                                    ("Christmasat <time-of-day>", -5.643678550586496),
                                    ("dd/mmyear (latent)", -5.643678550586496),
                                    ("<duration> after|before|from <time>December",
                                     -5.643678550586496),
                                    ("yesterday<time-of-day> am|pm", -5.643678550586496),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.643678550586496),
                                    ("until <time-of-day>on <date>", -4.9505313700265505),
                                    ("at <time-of-day>intersect", -5.238213442478331),
                                    ("hh:mmyear (latent)", -4.545066261918386),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.643678550586496),
                                    ("dayminute", -3.158771900798495),
                                    ("intersectSeptember", -4.139601153810221),
                                    ("minuteday", -2.5756256154528785),
                                    ("absorption of , after named dayintersect",
                                     -5.643678550586496),
                                    ("Februaryin|during the <part-of-day>", -5.643678550586496),
                                    ("hh:mmon <date>", -3.628775530044231),
                                    ("Saturdayyear (latent)", -5.643678550586496),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.643678550586496),
                                    ("absorption of , after named daySeptember",
                                     -4.727387818712341),
                                    ("Naraka Chaturdashiyear (latent)", -5.643678550586496),
                                    ("on <date>September", -5.238213442478331),
                                    ("at <time-of-day>on <date>", -5.238213442478331),
                                    ("in <named-month>|yearyear (latent)", -5.643678550586496),
                                    ("dayweek", -5.643678550586496),
                                    ("Easter Sundayyear (latent)", -5.238213442478331),
                                    ("Thursday<time-of-day> am|pm", -5.238213442478331),
                                    ("absorption of , after named dayFebruary", -4.727387818712341),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.643678550586496),
                                    ("tomorrowat <time-of-day>", -5.643678550586496),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.643678550586496),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.034240638152395),
                                    ("tomorrow<time-of-day> am|pm", -5.643678550586496),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.9505313700265505),
                                    ("Diwaliyear (latent)", -5.238213442478331),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.643678550586496),
                                    ("Fridayyear (latent)", -5.238213442478331),
                                    ("minuteyear", -4.390915582091128)],
                               n = 180}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1670540846631662, unseen = -4.836281906951478,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 121},
                   koData =
                     ClassData{prior = -1.8718021769015913, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
