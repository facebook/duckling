...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5934122147752647, unseen = -6.12029741895095,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 453},
                   koData =
                     ClassData{prior = -0.8039424922037285, unseen = -5.910796644040527,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46633582319519024,
                               unseen = -7.130098510125578,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.436150368369428),
                                    ("Father's Dayyear (latent)", -6.436150368369428),
                                    ("Karva Chauthyear (latent)", -6.436150368369428),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.436150368369428),
                                    ("Maha Shivaratriyear (latent)", -6.436150368369428),
                                    ("Ramadanyear (latent)", -5.18338739987406),
                                    ...
                                    ("Ganesh Chaturthiyear (latent)", -6.436150368369428),
                                    ...
                                    ("dd/mm<time-of-day> am|pm", -6.436150368369428),
                                    ...
                                    ("dd/mmat <time-of-day>", -6.436150368369428),
                                    ...
                                    ("Mahavir Jayantiyear (latent)", -6.030685260261263),
                                    ...
                                    ("Eid al-Fitryear (latent)", -5.049856007249537),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.030685260261263),
                                    ("Ratha-Yatrayear (latent)", -6.436150368369428),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.436150368369428),
                                    ("Mothering Sundayyear (latent)", -6.030685260261263),
                                    ...
                                    ("Rama Navamiyear (latent)", -6.436150368369428),
                                    ...
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.436150368369428),
                                    ("Ugadiyear (latent)", -5.049856007249537),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.436150368369428),
                                    ("Pargat Diwasyear (latent)", -5.18338739987406),
                                    ("August Bank Holidayyear (latent)", -5.7430031878094825),
                               ...
                               n = 478},
                   koData =
                     ClassData{prior = -0.9869723175254401,
                               unseen = -6.7580945044277305,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.559707811911334),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.658320100579444),
                                    ("hourday", -3.6658899358892376),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.063785208687608),
                                    ("<day-of-month> (ordinal)August", -6.063785208687608),
                                    ("dayhour", -3.389636559261079),
                                    ("<time> timezoneyear (latent)", -5.3706380281276624),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.147494476813453),
                                    ("Tuesdayfrom|since|after <time>", -5.3706380281276624),
                                    ("daymonth", -3.389636559261079),
                                    ("monthyear", -4.81102224019224),
                                    ("<time-of-day> am|pmyear (latent)", -5.3706380281276624),
                                    ("Thai Pongalyear (latent)", -5.3706380281276624),
                                    ("intersecthh:mm", -6.063785208687608),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.658320100579444),
                                    ("<day-of-month> (ordinal)Wednesday", -6.063785208687608),
                                    ("houryear", -4.677490847567718),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.063785208687608),
                                    ("<day-of-month> (ordinal)October", -6.063785208687608),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.3706380281276624),
                                    ("hournograin", -4.81102224019224),
                                    ("<time-of-day> am|pmintersect", -4.81102224019224),
                                    ("Octoberyear (latent)", -6.063785208687608),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.658320100579444),
                                    ("until <time>on <day>", -5.3706380281276624),
                                    ("time-of-day (latent)intersect", -5.3706380281276624),
                                    ("todayin <number> (implicit minutes)", -6.063785208687608),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.3706380281276624),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.063785208687608),
                                    ("hh:mmon <day>", -4.81102224019224),
                                    ("hhhmmintersect", -5.658320100579444),
                                    ("absorption of , after named dayJuly", -5.147494476813453),
                                    ("from|since|after <time>July", -5.658320100579444),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.147494476813453),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.658320100579444),
                                    ("hourmonth", -4.191983031786017),
                                    ("todayat <time-of-day>", -6.063785208687608),
                                    ("Bank Holidayyear (latent)", -5.3706380281276624),
                                    ("hhhmmyear (latent)", -4.81102224019224),
                                    ("from|since|after <time>December", -6.063785208687608),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.063785208687608),
                                    ("<time-of-day> am|pmon <day>", -4.81102224019224),
                                    ("Mondayyear (latent)", -5.3706380281276624),
                                    ("dayday", -4.677490847567718),
                                    ("dd/mmat <time-of-day>", -5.658320100579444),
                                    ("on <day>September", -5.3706380281276624),
                                    ("time-of-day (latent)September", -5.658320100579444),
                                    ("hourhour", -4.965172920019499),
                                    ("time-of-day (latent)on <day>", -4.559707811911334),
                                    ("Thursdaydd/mm", -6.063785208687608),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.658320100579444),
                                    ("dayyear", -3.0433603225432457),
                                    ("New Year's Dayyear (latent)", -5.147494476813453),
                                    ("time-of-day (latent)Sunday", -5.658320100579444),
                                    ("Thursdayfrom|since|after <time>", -4.359037116449183),
                                    ("Thursdayat <time-of-day>", -4.454347296253507),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.063785208687608),
                                    ("Aprilyear (latent)", -6.063785208687608),
                                    ("the <day-of-month> (ordinal)July", -6.063785208687608),
                                    ("the <day-of-month> (number)July", -6.063785208687608),
                                    ("monthminute", -6.063785208687608),
                                    ("hourminute", -5.3706380281276624),
                                    ("<time-of-day> am|pmtomorrow", -6.063785208687608),
                                    ("Thursdayhh:mm", -5.147494476813453),
                                    ("<day-of-month> (ordinal)Tuesday", -5.658320100579444),
                                    ("minutemonth", -3.9237190451913375),
                                    ("time-of-day (latent)Friday", -5.658320100579444),
                                    ("minutehour", -6.063785208687608),
                                    ("Augustyear (latent)", -5.658320100579444),
                                    ("week-endin|during <named-month>|year", -6.063785208687608),
                                    ("time-of-day (latent)Tuesday", -5.658320100579444),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.063785208687608),
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.658320100579444),
                                    ("Sundayyear (latent)", -5.147494476813453),
                                    ("Christmasat <time-of-day>", -6.063785208687608),
                                    ("from|since|after <time>year (latent)", -4.965172920019499),
                                    ("dd/mmyear (latent)", -6.063785208687608),
                                    ("hhhmmon <day>", -5.147494476813453),
                                    ("yesterday<time-of-day> am|pm", -6.063785208687608),
                                    ("<day-of-month> (ordinal)July", -5.3706380281276624),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.063785208687608),
                                    ("at <time-of-day>intersect", -5.147494476813453),
                                    ("hh:mmyear (latent)", -4.677490847567718),
                                    ("Holiyear (latent)", -6.063785208687608),
                                    ("until <time><time-of-day> am|pm", -6.063785208687608),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.658320100579444),
                                    ("dayminute", -3.2015843277581397),
                                    ("yyyy-mm-ddhh:mm", -5.658320100579444),
                                    ("intersectfrom|since|after <time>", -5.658320100579444),
                                    ("intersectSeptember", -4.191983031786017),
                                    ("minuteday", -2.906784787537495),
                                    ("absorption of , after named dayintersect",
                                     -6.063785208687608),
                                    ("intersectyear (latent)", -6.063785208687608),
                                    ("Februaryin|during the <part-of-day>", -6.063785208687608),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.063785208687608),
                                    ("time-of-day (latent)July", -5.3706380281276624),
                                    ("Saturdayyear (latent)", -6.063785208687608),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.063785208687608),
                                    ("at <time-of-day>on <day>", -5.147494476813453),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.063785208687608),
                                    ("absorption of , after named daySeptember", -4.81102224019224),
                                    ("Naraka Chaturdashiyear (latent)", -6.063785208687608),
                                    ("from|since|after <time>on <day>", -5.147494476813453),
                                    ("dayweek", -6.063785208687608),
                                    ("Easter Sundayyear (latent)", -5.658320100579444),
                                    ("time-of-day (latent)at <time-of-day>", -5.3706380281276624),
                                    ("Thursday<time-of-day> am|pm", -4.81102224019224),
                                    ("weekyear", -5.658320100579444),
                                    ("time-of-day (latent)Thursday", -5.658320100579444),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.063785208687608),
                                    ("<day-of-month> (ordinal)April", -6.063785208687608),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.658320100579444),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.3706380281276624),
                                    ("Sundayfrom|since|after <time>", -6.063785208687608),
                                    ("absorption of , after named dayFebruary", -5.147494476813453),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.658320100579444),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.063785208687608),
                                    ("tomorrowat <time-of-day>", -6.063785208687608),
                                    ("daynograin", -5.658320100579444),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.658320100579444),
                                    ("last <cycle> of <time>year (latent)", -5.658320100579444),
                                    ("tomorrow<time-of-day> am|pm", -6.063785208687608),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.3706380281276624),
                                    ("Diwaliyear (latent)", -5.658320100579444),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.063785208687608),
                                    ("Fridayyear (latent)", -5.658320100579444),
                                    ("time-of-day (latent)April", -6.063785208687608),
                                    ("minuteyear", -3.8665606313513887)],
                               n = 284}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
