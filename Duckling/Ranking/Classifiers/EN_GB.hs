...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4888467170472155,
                               unseen = -6.6039438246004725,
                               likelihoods =
                                 HashMap.fromList
                                   [("Father's Dayyear (latent)", -5.909440711629391),
                                    ("Ramadanyear (latent)", -5.909440711629391),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.656677743134023),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.656677743134023),
                                    ("hourday", -4.204692619390966),
                                    ("dayhour", -2.991669979545112),
                                    ("Martin Luther King's Dayyear (latent)", -5.503975603521227),
                                    ("Shemini Atzeretyear (latent)", -5.909440711629391),
                                    ("daymonth", -5.2162935310694465),
                                    ("monthday", -5.503975603521227),
                                    ("monthyear", -4.3000027991952905),
                                    ("Yom Ha'atzmautyear (latent)", -5.909440711629391),
                                    ("Thanksgiving Dayyear (latent)", -4.810828422961282),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.909440711629391),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.909440711629391),
                                    ("houryear", -5.503975603521227),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.909440711629391),
                                    ("Christmas<time-of-day> am|pm", -5.909440711629391),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.909440711629391),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.2162935310694465),
                                    ("<time-of-day> am|pmintersect", -4.656677743134023),
                                    ("Octoberyear (latent)", -4.656677743134023),
                                    ("intersect<time-of-day> am|pm", -5.909440711629391),
                                    ("Shavuotyear (latent)", -5.909440711629391),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.909440711629391),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.503975603521227),
                                    ("Marchyear (latent)", -5.909440711629391),
                                    ("Sukkotyear (latent)", -5.503975603521227),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.909440711629391),
                                    ("Clean Mondayyear (latent)", -5.503975603521227),
                                    ("monthhour", -5.503975603521227),
                                    ("todayat <time-of-day>", -5.909440711629391),
                                    ("Thursday<time> timezone", -4.204692619390966),
                                    ("dd/mm<time-of-day> am|pm", -5.909440711629391),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.909440711629391),
                                    ("Palm SundaySunday", -5.503975603521227),
                                    ("dayday", -3.712216134293172),
                                    ("dd/mmat <time-of-day>", -5.909440711629391),
                                    ("<time> <part-of-day>at <time-of-day>", -5.909440711629391),
                                    ("tonightat <time-of-day>", -5.909440711629391),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.2162935310694465),
                                    ("today<time-of-day> am|pm", -5.909440711629391),
                                    ("Februarythe <day-of-month> (ordinal)", -5.503975603521227),
                                    ("at <time-of-day><time> <part-of-day>", -5.909440711629391),
                                    ("hourhour", -4.656677743134023),
                                    ("<time-of-day> am|pmon <date>", -3.8945376910871263),
                                    ("Wednesdaythis|last|next <cycle>", -5.909440711629391),
                                    ("Lentyear (latent)", -5.909440711629391),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.405363314853117),
                                    ("dayyear", -2.2081387375168977),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.909440711629391),
                                    ("Thursdayat <time-of-day>", -5.503975603521227),
                                    ("Islamic New Yearyear (latent)", -5.503975603521227),
                                    ("Laylat al-Qadryear (latent)", -4.993149979755236),
                                    ("Shrove Tuesdayyear (latent)", -5.909440711629391),
                                    ("<time-of-day> am|pmtomorrow", -5.2162935310694465),
                                    ("Yom Kippuryear (latent)", -5.909440711629391),
                                    ("<part-of-day> of <time>year (latent)", -5.909440711629391),
                                    ("minutehour", -4.993149979755236),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.503975603521227),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.204692619390966),
                                    ("for <duration> from <time>December", -5.909440711629391),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.909440711629391),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.993149979755236),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.503975603521227),
                                    ("Pentecostyear (latent)", -5.909440711629391),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.993149979755236),
                                    ("Eid al-Fitryear (latent)", -5.909440711629391),
                                    ("Mondayin|during the <part-of-day>", -5.909440711629391),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.503975603521227),
                                    ("Ashurayear (latent)", -5.909440711629391),
                                    ("Chinese New Yearyear (latent)", -5.909440711629391),
                                    ("Sundayyear (latent)", -5.909440711629391),
                                    ("Lag BaOmeryear (latent)", -5.909440711629391),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.909440711629391),
                                    ("Eid al-Adhayear (latent)", -4.993149979755236),
                                    ("intersectin|during the <part-of-day>", -5.909440711629391),
                                    ("Christmasat <time-of-day>", -5.909440711629391),
                                    ("Passoveryear (latent)", -5.909440711629391),
                                    ("Lazarus Saturdayyear (latent)", -5.909440711629391),
                                    ("dd/mmyear (latent)", -5.909440711629391),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.909440711629391),
                                    ("Yom HaShoahyear (latent)", -5.503975603521227),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.993149979755236),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.909440711629391),
                                    ("Septemberyear (latent)", -5.503975603521227),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.656677743134023),
                                    ("Halloweenyear (latent)", -5.909440711629391),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.2162935310694465),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -4.993149979755236),
                                    ("at <time-of-day>intersect", -5.503975603521227),
                                    ("Rosh Hashanahyear (latent)", -5.909440711629391),
                                    ("Tu BiShvatyear (latent)", -5.909440711629391),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.909440711629391),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.909440711629391),
                                    ("dayminute", -3.2703833820141326),
                                    ("Mawlidyear (latent)", -5.909440711629391),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.503975603521227),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.909440711629391),
                                    ("Jumu'atul-Widayear (latent)", -4.993149979755236),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.909440711629391),
                                    ("minuteday", -2.2718545519030053),
                                    ("absorption of , after named dayintersect",
                                     -5.909440711629391),
                                    ("intersectyear (latent)", -5.909440711629391),
                                    ("Orthodox Easter Sundayyear (latent)", -5.909440711629391),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.909440711629391),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.909440711629391),
                                    ("Mothering Sundayyear (latent)", -5.503975603521227),
                                    ("Boss's Dayyear (latent)", -5.503975603521227),
                                    ("Tisha B'Avyear (latent)", -5.909440711629391),
                                    ("Isra and Mi'rajyear (latent)", -4.993149979755236),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.909440711629391),
                                    ("Christmasyear (latent)", -5.503975603521227),
                                    ("at <time-of-day>on <date>", -4.810828422961282),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.3000027991952905),
                                    ("dayweek", -5.909440711629391),
                                    ("Easter Sundayyear (latent)", -5.2162935310694465),
                                    ("Thursday<time-of-day> am|pm", -5.909440711629391),
                                    ("weekyear", -5.503975603521227),
                                    ("hh:mmin|during the <part-of-day>", -5.2162935310694465),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.503975603521227),
                                    ("Hanukkahyear (latent)", -5.909440711629391),
                                    ("February<time> <part-of-day>", -5.909440711629391),
                                    ("Tuesdayin <named-month>|year", -5.909440711629391),
                                    ("Great Lentyear (latent)", -5.909440711629391),
                                    ("tomorrowat <time-of-day>", -5.2162935310694465),
                                    ("between <time> and <time>on <date>", -4.3000027991952905),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.2162935310694465),
                                    ("last <cycle> of <time>year (latent)", -5.2162935310694465),
                                    ("at <time-of-day>tomorrow", -5.503975603521227),
                                    ("tomorrow<time-of-day> am|pm", -5.909440711629391),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.909440711629391),
                                    ("Black Fridayyear (latent)", -5.503975603521227),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.909440711629391),
                                    ("Palm Sundayintersect", -5.909440711629391),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.909440711629391),
                                    ("August Bank Holidayyear (latent)", -5.2162935310694465),
                                    ("Februaryintersect", -5.909440711629391),
                                    ("Simchat Torahyear (latent)", -5.909440711629391)],
                               n = 276},
                   koData =
                     ClassData{prior = -0.9501922835498364, unseen = -6.280395838960195,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.585374243605899),
                                    ...
                                    ("Bank Holidayyear (latent)", -4.892227063045954),
                                    ("from|since|after <time-of-day>July", -5.585374243605899),
                                    ("Mondayyear (latent)", -4.892227063045954),
                                    ("dayday", -5.179909135497735),
                                    ("dd/mmat <time-of-day>", -5.179909135497735),
                                    ("<time-of-day> am|pmon <date>", -4.332611275110531),
                                    ("Thursdaydd/mm", -5.585374243605899),
                                    ("dayyear", -2.7231733626764307),
                                    ...
                                    ("dd/mmyear (latent)", -5.585374243605899),
