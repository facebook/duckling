...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6195588239024562, unseen = -5.697093486505405,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 296},
                   koData =
                     ClassData{prior = -0.77258401120798, unseen = -5.545177444479562,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47835523873520663,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.041444479413003),
                                    ...
                                    ("Octoberyear (latent)", -4.537367082636728),
                                    ...
                                    ("dayyear", -1.9810014688665833),
                                    ("Thursdayfrom|since|after <time>", -5.635979371304838),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.041444479413003),
                                    ...
                                    ("dd/mmyear (latent)", -6.041444479413003),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.041444479413003),
                                    ("Mothering Sundayyear (latent)", -5.635979371304838),
                                    ("Boss's Dayyear (latent)", -5.635979371304838),
                                    ("Global Youth Service Dayyear (latent)", -6.041444479413003),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.041444479413003),
                                    ("August Bank Holidayyear (latent)", -5.3482972988530575),
                                    ("Februaryintersect", -6.041444479413003),
                                    ("Simchat Torahyear (latent)", -6.041444479413003)],
                               n = 313},
                   koData =
                     ClassData{prior = -0.9670630572475782, unseen = -6.396929655216146,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.785823685681349),
                                    ...
                                    ("Bank Holidayyear (latent)", -5.0089672369955585),
                                    ...
                                    ("dd/mmat <time-of-day>", -5.296649309447339),
                                    ("<time-of-day> am|pmon <date>", -4.449351449060136),
                                    ("Thursdaydd/mm", -5.702114417555504),
                                    ("dayyear", -2.6575919798320813),
                                    ...
                                    ("dd/mmyear (latent)", -5.702114417555504),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.14693043185377128,
                               ...
                               n = 139},
                   koData =
                     ClassData{prior = -1.990361911626147, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
