...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.735909039898027, unseen = -5.337538079701318,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 206},
                   koData =
                     ClassData{prior = -0.6521391568325683, unseen = -5.420534999272286,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.49125204512603243,
                               unseen = -6.419994928147142,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                     -4.472454786880898),
                                    ("Lentyear", -5.725217755376266),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.472454786880898),
                                    ("hourday", -4.020469663137841),
                                    ("dayhour", -2.8348459974801012),
                                    ("daymonth", -5.032070574816321),
                                    ("monthday", -5.319752647268102),
                                    ("monthyear", -4.115779842942166),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.725217755376266),
                                    ("Easter Sundayyear", -5.032070574816321),
                                    ("Christmasyear", -5.319752647268102),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.725217755376266),
                                    ("houryear", -5.319752647268102),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.725217755376266),
                                    ("Christmas<time-of-day> am|pm", -5.725217755376266),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.032070574816321),
                                    ("<time-of-day> am|pmintersect", -4.472454786880898),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.725217755376266),
                                    ("Marchyear", -5.725217755376266),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.319752647268102),
                                    ("intersect<time-of-day> am|pm", -5.725217755376266),
                                    ("Clean Mondayyear", -5.319752647268102),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.725217755376266),
                                    ("monthhour", -5.319752647268102),
                                    ("last <day-of-week> of <time>year", -5.725217755376266),
                                    ("todayat <time-of-day>", -5.725217755376266),
                                    ("Thursday<time> timezone", -4.020469663137841),
                                    ("dd/mm<time-of-day> am|pm", -5.725217755376266),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.725217755376266),
                                    ("Palm SundaySunday", -5.319752647268102),
                                    ("dayday", -3.5279931780400466),
                                    ("Thanksgiving Dayyear", -4.626605466708156),
                                    ("dd/mmat <time-of-day>", -5.725217755376266),
                                    ("<time> <part-of-day>at <time-of-day>", -5.725217755376266),
                                    ("Tuesdayin <named-month>", -5.725217755376266),
                                    ("tonightat <time-of-day>", -5.725217755376266),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.032070574816321),
                                    ("today<time-of-day> am|pm", -5.725217755376266),
                                    ("Februarythe <day-of-month> (ordinal)", -5.319752647268102),
                                    ("at <time-of-day><time> <part-of-day>", -5.725217755376266),
                                    ("hourhour", -4.472454786880898),
                                    ("<time-of-day> am|pmon <date>", -3.710314734834001),
                                    ("Wednesdaythis|last|next <cycle>", -5.725217755376266),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.221140358599992),
                                    ("dayyear", -2.6571648202426488),
                                    ("last weekend of <named-month>year", -5.725217755376266),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.725217755376266),
                                    ("Sundayyear", -5.725217755376266),
                                    ("Chinese New Yearyear", -5.725217755376266),
                                    ("Thursdayat <time-of-day>", -5.319752647268102),
                                    ("<time-of-day> am|pmtomorrow", -5.032070574816321),
                                    ("August Bank Holidayyear", -5.032070574816321),
                                    ("minutehour", -4.808927023502111),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.319752647268102),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.020469663137841),
                                    ("for <duration> from <time>December", -5.725217755376266),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.725217755376266),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.808927023502111),
                                    ("Mondayin|during the <part-of-day>", -5.725217755376266),
                                    ("Shrove Tuesdayyear", -5.725217755376266),
                                    ("<part-of-day> of <time>year", -5.725217755376266),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.319752647268102),
                                    ("intersectin|during the <part-of-day>", -5.725217755376266),
                                    ("Christmasat <time-of-day>", -5.725217755376266),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -4.808927023502111),
                                    ("at <time-of-day>intersect", -5.319752647268102),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.725217755376266),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.725217755376266),
                                    ("dayminute", -3.0510691059497375),
                                    ("Mothering Sundayyear", -5.319752647268102),
                                    ("Boss's Dayyear", -5.319752647268102),
                                    ("Orthodox Easter Sundayyear", -5.725217755376266),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.319752647268102),
                                    ("intersectyear", -5.725217755376266),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.725217755376266),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.319752647268102),
                                    ("<ordinal> <cycle> of <time>year", -5.725217755376266),
                                    ("minuteday", -2.2594818525765397),
                                    ("absorption of , after named dayintersect",
                                     -5.725217755376266),
                                    ("Octoberyear", -4.472454786880898),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.725217755376266),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.725217755376266),
                                    ("year<time-of-day> am|pm", -5.725217755376266),
                                    ("Septemberyear", -5.319752647268102),
                                    ("at <time-of-day>on <date>", -4.626605466708156),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -5.032070574816321),
                                    ("Halloweenyear", -5.725217755376266),
                                    ("dayweek", -5.725217755376266),
                                    ("Lazarus Saturdayyear", -5.725217755376266),
                                    ("Thursday<time-of-day> am|pm", -5.725217755376266),
                                    ("weekyear", -5.319752647268102),
                                    ("hh:mmin|during the <part-of-day>", -5.032070574816321),
                                    ("Father's Dayyear", -5.725217755376266),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.319752647268102),
                                    ("February<time> <part-of-day>", -5.725217755376266),
                                    ("Martin Luther King's Dayyear", -5.319752647268102),
                                    ("tomorrowat <time-of-day>", -5.032070574816321),
                                    ("between <time> and <time>on <date>", -5.032070574816321),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.032070574816321),
                                    ("at <time-of-day>tomorrow", -5.319752647268102),
                                    ("tomorrow<time-of-day> am|pm", -5.725217755376266),
                                    ("Pentecostyear", -5.725217755376266),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.725217755376266),
                                    ("Palm Sundayintersect", -5.725217755376266),
                                    ("Great Lentyear", -5.725217755376266),
                                    ("Februaryintersect", -5.725217755376266),
                                    ("last <cycle> of <time>year", -5.032070574816321),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.725217755376266),
                                    ("yearminute", -5.725217755376266),
                                    ("Black Fridayyear", -5.319752647268102)],
                               n = 227},
                   koData =
                     ClassData{prior = -0.9463887630314345, unseen = -6.104793232414985,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.409411414053624),
                                    ...
                                    ("dd/mmat <time-of-day>", -5.003946305945459),
                                    ("<time-of-day> am|pmon <date>", -4.156648445558256),
                                    ("Thursdaydd/mm", -5.409411414053624),
                                    ("dayyear", -3.0580361568901457),
       ...
       ("year",
        Classifier{okData =
                     ClassData{prior = -0.2610138253696196, unseen = -4.127134385045092,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 57},
                   koData =
                     ClassData{prior = -1.4708517491479536,
                               unseen = -3.0910424533583156,
                               likelihoods =
                                 HashMap.fromList
