...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6591534247442327, unseen = -5.929589143389895,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 374},
                   koData =
                     ClassData{prior = -0.7283372999563376, unseen = -5.860786223465865,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5034995836739179, unseen = -6.990256500493881,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.296188085414615),
                                    ("Father's Dayyear (latent)", -6.296188085414615),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.296188085414615),
                                    ("Ramadanyear (latent)", -5.37989735354046),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.28128506487235),
                                    ("Bhai Doojyear (latent)", -6.296188085414615),
                                    ("hourday", -4.28128506487235),
                                    ("dayhour", -3.3784173533303354),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.28128506487235),
                                    ("Martin Luther King's Dayyear (latent)", -5.89072297730645),
                                    ("Shemini Atzeretyear (latent)", -6.296188085414615),
                                    ("daymonth", -4.28128506487235),
                                    ("monthday", -5.89072297730645),
                                    ("monthyear", -4.504428616186559),
                                    ("Yom Ha'atzmautyear (latent)", -6.296188085414615),
                                    ("Vijayadashamiyear (latent)", -6.296188085414615),
                                    ("Thanksgiving Dayyear (latent)", -5.197575796746505),
                                    ("Thai Pongalyear (latent)", -5.603040904854669),
                                    ("Thiru Onamyear (latent)", -5.603040904854669),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.296188085414615),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.37989735354046),
                                    ("<day-of-month> (ordinal)Wednesday", -6.296188085414615),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.296188085414615),
                                    ("houryear", -5.37989735354046),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.296188085414615),
                                    ("Christmas<time-of-day> am|pm", -6.296188085414615),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.296188085414615),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.603040904854669),
                                    ("intersectin|during <named-month>|year", -6.296188085414615),
                                    ("<time-of-day> am|pmintersect", -5.043425116919247),
                                    ("Earth Houryear (latent)", -6.296188085414615),
                                    ("Octoberyear (latent)", -4.79211068863834),
                                    ("intersect<time-of-day> am|pm", -6.296188085414615),
                                    ("Mattu Pongalyear (latent)", -6.296188085414615),
                                    ("Shavuotyear (latent)", -6.296188085414615),
                                    ("Parsi New Yearyear (latent)", -5.37989735354046),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.296188085414615),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.296188085414615),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.89072297730645),
                                    ("Marchyear (latent)", -6.296188085414615),
                                    ("Sukkotyear (latent)", -5.89072297730645),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.89072297730645),
                                    ("Clean Mondayyear (latent)", -5.89072297730645),
                                    ("monthhour", -5.89072297730645),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.603040904854669),
                                    ("todayat <time-of-day>", -6.296188085414615),
                                    ("Thursday<time> timezone", -4.350277936359301),
                                    ("time-of-day (latent)tonight", -5.89072297730645),
                                    ("from|since|after <time>December", -6.296188085414615),
                                    ("dd/mm<time-of-day> am|pm", -6.296188085414615),
                                    ("<time-of-day> am|pmon <day>", -4.28128506487235),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.296188085414615),
                                    ("yyyy-mm-ddhh:mm:ss", -5.89072297730645),
                                    ("dayday", -3.85384105004541),
                                    ("dd/mmat <time-of-day>", -6.296188085414615),
                                    ("<time> <part-of-day>at <time-of-day>", -6.296188085414615),
                                    ("tonightat <time-of-day>", -6.296188085414615),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.603040904854669),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.296188085414615),
                                    ("today<time-of-day> am|pm", -6.296188085414615),
                                    ("Februarythe <day-of-month> (ordinal)", -5.89072297730645),
                                    ("at <time-of-day><time> <part-of-day>", -6.296188085414615),
                                    ("<day-of-month> (ordinal)intersect", -5.89072297730645),
                                    ("hourhour", -4.216746543734779),
                                    ("Navaratriin|during <named-month>|year", -6.296188085414615),
                                    ("Wednesdaythis|last|next <cycle>", -6.296188085414615),
                                    ("Lentyear (latent)", -6.296188085414615),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.79211068863834),
                                    ("Boghiyear (latent)", -6.296188085414615),
                                    ("dayyear", -1.9720554291596355),
                                    ("Thursdayfrom|since|after <time>", -5.89072297730645),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.296188085414615),
                                    ("Thursdayat <time-of-day>", -5.603040904854669),
                                    ("Islamic New Yearyear (latent)", -5.89072297730645),
                                    ("Laylat al-Qadryear (latent)", -5.37989735354046),
                                    ("Shrove Tuesdayyear (latent)", -6.296188085414615),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.603040904854669),
                                    ("<time-of-day> am|pmtomorrow", -5.603040904854669),
                                    ("Yom Kippuryear (latent)", -6.296188085414615),
                                    ("<day-of-month> (ordinal)Tuesday", -5.89072297730645),
                                    ("<part-of-day> of <time>year (latent)", -6.296188085414615),
                                    ("minutehour", -5.197575796746505),
                                    ("Kaanum Pongalyear (latent)", -5.89072297730645),
                                    ("Maha Saptamiyear (latent)", -6.296188085414615),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.89072297730645),
                                    ("time-of-day (latent)tomorrow", -5.37989735354046),
                                    ("part of daysat <time-of-day>", -5.89072297730645),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.59143999317619),
                                    ("for <duration> from <time>December", -6.296188085414615),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.296188085414615),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.043425116919247),
                                    ("time-of-day (latent)this <part-of-day>", -6.296188085414615),
                                    ("Pentecostyear (latent)", -6.296188085414615),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.043425116919247),
                                    ("<day-of-month> (ordinal)February", -6.296188085414615),
                                    ("Eid al-Fitryear (latent)", -5.37989735354046),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.296188085414615),
                                    ("Mondayin|during the <part-of-day>", -6.296188085414615),
                                    ("Chhathin|during <named-month>|year", -6.296188085414615),
                                    ("Diwaliin|during <named-month>|year", -6.296188085414615),
                                    ("Vaisakhiin|during <named-month>|year", -6.296188085414615),
                                    ("Raksha Bandhanyear (latent)", -6.296188085414615),
                                    ("daysecond", -5.89072297730645),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.89072297730645),
                                    ("Ashurayear (latent)", -6.296188085414615),
                                    ("Tuesdayin|during <named-month>|year", -6.296188085414615),
                                    ("Chinese New Yearyear (latent)", -6.296188085414615),
                                    ("tomorrowintersect", -6.296188085414615),
                                    ("Lag BaOmeryear (latent)", -6.296188085414615),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.296188085414615),
                                    ("Eid al-Adhayear (latent)", -5.37989735354046),
                                    ("intersectin|during the <part-of-day>", -6.296188085414615),
                                    ("Palm Sundayyear (latent)", -6.296188085414615),
                                    ("Christmasat <time-of-day>", -6.296188085414615),
                                    ("Passoveryear (latent)", -6.296188085414615),
                                    ("Lazarus Saturdayyear (latent)", -6.296188085414615),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.296188085414615),
                                    ("Yom HaShoahyear (latent)", -5.89072297730645),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.89072297730645),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.296188085414615),
                                    ("Septemberyear (latent)", -5.89072297730645),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.79211068863834),
                                    ("Halloweenyear (latent)", -6.296188085414615),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.296188085414615),
                                    ("at <time-of-day>intersect", -5.89072297730645),
                                    ("Rosh Hashanahyear (latent)", -5.603040904854669),
                                    ("Dhanterasyear (latent)", -6.296188085414615),
                                    ("Tu BiShvatyear (latent)", -6.296188085414615),
                                    ("<day-of-month> (ordinal)December", -5.603040904854669),
                                    ("Holiyear (latent)", -5.603040904854669),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.296188085414615),
                                    ("Holika Dahanyear (latent)", -5.603040904854669),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.296188085414615),
                                    ("dayminute", -3.3784173533303354),
                                    ("Mawlidyear (latent)", -6.296188085414615),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.89072297730645),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.296188085414615),
                                    ("Jumu'atul-Widayear (latent)", -5.37989735354046),
                                    ("minuteday", -2.4675466889255198),
                                    ("absorption of , after named dayintersect",
                                     -6.296188085414615),
                                    ("intersectyear (latent)", -6.296188085414615),
                                    ("Orthodox Easter Sundayyear (latent)", -6.296188085414615),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.296188085414615),
                                    ("Mothering Sundayyear (latent)", -5.89072297730645),
                                    ("Boss's Dayyear (latent)", -5.89072297730645),
                                    ("Global Youth Service Dayyear (latent)", -6.296188085414615),
                                    ("Dhanterasin|during <named-month>|year", -6.296188085414615),
                                    ("Tisha B'Avyear (latent)", -6.296188085414615),
                                    ("Isra and Mi'rajyear (latent)", -5.37989735354046),
                                    ("at <time-of-day>on <day>", -5.197575796746505),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.296188085414615),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.603040904854669),
                                    ("Christmasyear (latent)", -5.89072297730645),
                                    ("Naraka Chaturdashiyear (latent)", -5.89072297730645),
                                    ("Thai Pongalin|during <named-month>|year", -6.296188085414615),
                                    ("dayweek", -6.296188085414615),
                                    ("Easter Sundayyear (latent)", -5.603040904854669),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.686750172980514),
                                    ("weekyear", -5.197575796746505),
                                    ("King's Dayyear (latent)", -4.79211068863834),
                                    ("hh:mmin|during the <part-of-day>", -5.603040904854669),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.89072297730645),
                                    ("Hanukkahyear (latent)", -5.603040904854669),
                                    ("February<time> <part-of-day>", -6.296188085414615),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.296188085414615),
                                    ("Great Lentyear (latent)", -6.296188085414615),
                                    ("tomorrowat <time-of-day>", -5.603040904854669),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.296188085414615),
                                    ("Vaisakhiyear (latent)", -5.603040904854669),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.296188085414615),
                                    ("last <cycle> of <time>year (latent)", -5.603040904854669),
                                    ("at <time-of-day>tomorrow", -5.89072297730645),
                                    ("tomorrow<time-of-day> am|pm", -6.296188085414615),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.296188085414615),
                                    ("Diwaliyear (latent)", -6.296188085414615),
                                    ("between <time> and <time>on <day>", -4.686750172980514),
                                    ("Black Fridayyear (latent)", -5.89072297730645),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.296188085414615),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.296188085414615),
                                    ("Chhathyear (latent)", -5.89072297730645),
                                    ("Vasant Panchamiyear (latent)", -6.296188085414615),
                                    ("Rabindra Jayantiyear (latent)", -5.043425116919247),
                                    ("St Patrick's Dayyear (latent)", -6.296188085414615),
                                    ("Thursday<time> (timezone)", -6.296188085414615),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.296188085414615),
                                    ("August Bank Holidayyear (latent)", -5.603040904854669),
                                    ("<datetime> - <datetime> (interval)July", -5.89072297730645),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.89072297730645),
                                    ("Februaryintersect", -6.296188085414615),
                                    ("Simchat Torahyear (latent)", -6.296188085414615),
                                    ("minuteyear", -6.296188085414615)],
                               n = 411},
                   koData =
                     ClassData{prior = -0.9273814185683134, unseen = -6.687108607866515,
                               likelihoods =
                                 HashMap.fromList
                                   [("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.58724865840025),
                                    ("hourday", -3.2846635654062037),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.992713766508414),
                                    ("<day-of-month> (ordinal)August", -5.992713766508414),
                                    ("dayhour", -3.318565117081885),
                                    ("<time> timezoneyear (latent)", -5.992713766508414),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.076423034634259),
                                    ("Tuesdayfrom|since|after <time>", -5.992713766508414),
                                    ...
                                    ("time-of-day (latent)intersect", -5.992713766508414),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.299566585948469),
                                    ...
                                    ("Bank Holidayyear (latent)", -5.299566585948469),
                                    ...
                                    ("dd/mmyear (latent)", -5.992713766508414),
                                    ...
                                    ("time-of-day (latent)<time-of-day> am|pm", -5.992713766508414),
                                    ...
                                    ("time-of-day (latent)at <time-of-day>", -5.299566585948469),
