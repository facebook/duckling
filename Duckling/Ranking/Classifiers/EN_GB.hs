...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5625034595926193, unseen = -6.206575926724928,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 494},
                   koData =
                     ClassData{prior = -0.8434605571367263, unseen = -5.926926025970411,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4981471655062198, unseen = -7.190676034332207,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.4967749901858625),
                                    ("Father's Dayyear (latent)", -6.4967749901858625),
                                    ("Karva Chauthyear (latent)", -6.4967749901858625),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.4967749901858625),
                                    ("Maha Shivaratriyear (latent)", -6.4967749901858625),
                                    ("Ramadanyear (latent)", -5.244012021690494),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.110480629065972),
                                    ("Bhai Doojyear (latent)", -6.4967749901858625),
                                    ("hourday", -4.481871969643597), ("dayhour", -3.4763501040415),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.110480629065972),
                                    ("Martin Luther King's Dayyear (latent)", -6.091309882077698),
                                    ("Shemini Atzeretyear (latent)", -6.4967749901858625),
                                    ("daymonth", -4.481871969643597),
                                    ("monthday", -6.091309882077698),
                                    ("monthyear", -4.705015520957807),
                                    ("Yom Ha'atzmautyear (latent)", -6.4967749901858625),
                                    ("Orthodox Good Fridayyear (latent)", -6.091309882077698),
                                    ("Vijayadashamiyear (latent)", -6.4967749901858625),
                                    ("Thanksgiving Dayyear (latent)", -5.3981627015177525),
                                    ("Thai Pongalyear (latent)", -5.803627809625917),
                                    ("Thiru Onamyear (latent)", -5.803627809625917),
                                    ("hhhmmabsorption of , after named day", -6.4967749901858625),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.4967749901858625),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.580484258311707),
                                    ("<day-of-month> (ordinal)Wednesday", -6.4967749901858625),
                                    ("Krishna Janmashtamiyear (latent)", -6.091309882077698),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.4967749901858625),
                                    ("houryear", -5.580484258311707),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.4967749901858625),
                                    ("Christmas<time-of-day> am|pm", -6.4967749901858625),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.4967749901858625),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.803627809625917),
                                    ("intersectin|during <named-month>|year", -6.4967749901858625),
                                    ("<time-of-day> am|pmintersect", -5.244012021690494),
                                    ("Earth Houryear (latent)", -6.4967749901858625),
                                    ("Ganesh Chaturthiyear (latent)", -6.4967749901858625),
                                    ("Octoberyear (latent)", -4.992697593409589),
                                    ("intersect<time-of-day> am|pm", -6.4967749901858625),
                                    ("Mattu Pongalyear (latent)", -6.4967749901858625),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.4967749901858625),
                                    ("Shavuotyear (latent)", -6.4967749901858625),
                                    ("Parsi New Yearyear (latent)", -5.580484258311707),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.4967749901858625),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.4967749901858625),
                                    ("todayin|within|after <duration>", -6.4967749901858625),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.091309882077698),
                                    ("Marchyear (latent)", -6.4967749901858625),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.091309882077698),
                                    ("Sukkotyear (latent)", -6.091309882077698),
                                    ("hhhmmintersect", -6.091309882077698),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.091309882077698),
                                    ("Clean Mondayyear (latent)", -6.091309882077698),
                                    ("monthhour", -6.091309882077698),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.803627809625917),
                                    ("todayat <time-of-day>", -6.4967749901858625),
                                    ("Thursday<time> timezone", -4.098879717387492),
                                    ("tonight<time-of-day> am|pm", -6.4967749901858625),
                                    ("time-of-day (latent)tonight", -6.091309882077698),
                                    ("from|since|after <time>December", -6.4967749901858625),
                                    ("dd/mm<time-of-day> am|pm", -6.4967749901858625),
                                    ("<time-of-day> am|pmon <day>", -4.481871969643597),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.4967749901858625),
                                    ("yyyy-mm-ddhh:mm:ss", -6.091309882077698),
                                    ("dayday", -3.7887247890836524),
                                    ("dd/mmat <time-of-day>", -6.4967749901858625),
                                    ("<time> <part-of-day>at <time-of-day>", -6.091309882077698),
                                    ("tonightat <time-of-day>", -5.3981627015177525),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.803627809625917),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.4967749901858625),
                                    ("today<time-of-day> am|pm", -6.4967749901858625),
                                    ("Februarythe <day-of-month> (ordinal)", -6.091309882077698),
                                    ("at <time-of-day><time> <part-of-day>", -6.4967749901858625),
                                    ("<day-of-month> (ordinal)intersect", -6.091309882077698),
                                    ("hourhour", -3.5263605246161616),
                                    ("Mahavir Jayantiyear (latent)", -6.091309882077698),
                                    ("Navaratriin|during <named-month>|year", -6.4967749901858625),
                                    ("Wednesdaythis|last|next <cycle>", -6.4967749901858625),
                                    ("Lentyear (latent)", -6.4967749901858625),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.624972813284271),
                                    ("Boghiyear (latent)", -6.4967749901858625),
                                    ("dayyear", -1.8966173460213154),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.4967749901858625),
                                    ("Thursdayfrom|since|after <time>", -6.091309882077698),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.4967749901858625),
                                    ("Thursdayat <time-of-day>", -5.803627809625917),
                                    ("Islamic New Yearyear (latent)", -6.091309882077698),
                                    ("Laylat al-Qadryear (latent)", -5.580484258311707),
                                    ("part of days<time-of-day> am|pm", -6.4967749901858625),
                                    ("Shrove Tuesdayyear (latent)", -6.4967749901858625),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.803627809625917),
                                    ("hourminute", -6.091309882077698),
                                    ("<time-of-day> am|pmtomorrow", -5.803627809625917),
                                    ("Yom Kippuryear (latent)", -6.4967749901858625),
                                    ("<day-of-month> (ordinal)Tuesday", -6.091309882077698),
                                    ("<part-of-day> of <time>year (latent)", -6.4967749901858625),
                                    ("minutehour", -5.244012021690494),
                                    ("Kaanum Pongalyear (latent)", -6.091309882077698),
                                    ("Maha Saptamiyear (latent)", -6.4967749901858625),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.803627809625917),
                                    ("time-of-day (latent)tomorrow", -5.580484258311707),
                                    ("part of daysat <time-of-day>", -4.887337077751762),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.481871969643597),
                                    ("for <duration> from <time>December", -6.4967749901858625),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.4967749901858625),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.244012021690494),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.244012021690494),
                                    ("time-of-day (latent)this <part-of-day>", -6.4967749901858625),
                                    ("Pentecostyear (latent)", -6.4967749901858625),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.244012021690494),
                                    ("<day-of-month> (ordinal)February", -6.4967749901858625),
                                    ("Eid al-Fitryear (latent)", -5.110480629065972),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.4967749901858625),
                                    ("Mondayin|during the <part-of-day>", -6.4967749901858625),
                                    ("Chhathin|during <named-month>|year", -6.4967749901858625),
                                    ("Diwaliin|during <named-month>|year", -6.4967749901858625),
                                    ("this <part-of-day><time-of-day> am|pm", -6.4967749901858625),
                                    ("Vaisakhiin|during <named-month>|year", -6.4967749901858625),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.244012021690494),
                                    ("Raksha Bandhanyear (latent)", -6.4967749901858625),
                                    ("daysecond", -6.091309882077698),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.091309882077698),
                                    ("Ratha-Yatrayear (latent)", -6.4967749901858625),
                                    ("Ashurayear (latent)", -6.4967749901858625),
                                    ("Tuesdayin|during <named-month>|year", -6.4967749901858625),
                                    ("Chinese New Yearyear (latent)", -6.4967749901858625),
                                    ("tomorrowintersect", -6.4967749901858625),
                                    ("Lag BaOmeryear (latent)", -6.4967749901858625),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.4967749901858625),
                                    ("Eid al-Adhayear (latent)", -4.356708826689592),
                                    ("intersectin|during the <part-of-day>", -6.4967749901858625),
                                    ("Palm Sundayyear (latent)", -6.4967749901858625),
                                    ("Christmasat <time-of-day>", -6.4967749901858625),
                                    ("Passoveryear (latent)", -6.4967749901858625),
                                    ("Lazarus Saturdayyear (latent)", -6.4967749901858625),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.4967749901858625),
                                    ("hhhmmon <day>", -5.580484258311707),
                                    ("Yom HaShoahyear (latent)", -6.091309882077698),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.091309882077698),
                                    ("Septemberyear (latent)", -6.091309882077698),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.992697593409589),
                                    ("Halloweenyear (latent)", -6.4967749901858625),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.4967749901858625),
                                    ("at <time-of-day>intersect", -5.580484258311707),
                                    ("Rosh Hashanahyear (latent)", -5.803627809625917),
                                    ("Dhanterasyear (latent)", -6.4967749901858625),
                                    ("Tu BiShvatyear (latent)", -6.4967749901858625),
                                    ("<day-of-month> (ordinal)December", -5.803627809625917),
                                    ("Holiyear (latent)", -5.803627809625917),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.4967749901858625),
                                    ("Holika Dahanyear (latent)", -5.803627809625917),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.091309882077698),
                                    ("dayminute", -3.1468709029112576),
                                    ("Mawlidyear (latent)", -6.4967749901858625),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.091309882077698),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.4967749901858625),
                                    ("Jumu'atul-Widayear (latent)", -5.580484258311707),
                                    ("minuteday", -2.759105371902494),
                                    ("absorption of , after named dayintersect",
                                     -5.803627809625917),
                                    ("intersectyear (latent)", -6.4967749901858625),
                                    ("Orthodox Easter Sundayyear (latent)", -6.4967749901858625),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.4967749901858625),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.4967749901858625),
                                    ("intersecthhhmm", -6.091309882077698),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.4967749901858625),
                                    ("Mothering Sundayyear (latent)", -6.091309882077698),
                                    ("Boss's Dayyear (latent)", -6.091309882077698),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.4967749901858625),
                                    ("Global Youth Service Dayyear (latent)", -6.4967749901858625),
                                    ("Dhanterasin|during <named-month>|year", -6.4967749901858625),
                                    ("tonight<time-of-day> o'clock", -6.4967749901858625),
                                    ("Tisha B'Avyear (latent)", -6.4967749901858625),
                                    ("Isra and Mi'rajyear (latent)", -5.580484258311707),
                                    ("at <time-of-day>on <day>", -4.887337077751762),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.091309882077698),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.803627809625917),
                                    ("Christmasyear (latent)", -6.091309882077698),
                                    ("Saturdayintersect", -6.4967749901858625),
                                    ("Naraka Chaturdashiyear (latent)", -6.091309882077698),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.4967749901858625),
                                    ("dayweek", -6.4967749901858625),
                                    ("Easter Sundayyear (latent)", -5.803627809625917),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.091309882077698),
                                    ("weekyear", -5.3981627015177525),
                                    ("King's Dayyear (latent)", -4.992697593409589),
                                    ("hh:mmin|during the <part-of-day>", -5.580484258311707),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.091309882077698),
                                    ("Hanukkahyear (latent)", -5.803627809625917),
                                    ("Rama Navamiyear (latent)", -6.4967749901858625),
                                    ("February<time> <part-of-day>", -6.4967749901858625),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.803627809625917),
                                    ("Great Lentyear (latent)", -6.4967749901858625),
                                    ("tomorrowat <time-of-day>", -5.803627809625917),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.4967749901858625),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.091309882077698),
                                    ("Ugadiyear (latent)", -5.110480629065972),
                                    ("Vaisakhiyear (latent)", -5.803627809625917),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.803627809625917),
                                    ("last <cycle> of <time>year (latent)", -5.803627809625917),
                                    ("at <time-of-day>tomorrow", -6.091309882077698),
                                    ("tomorrow<time-of-day> am|pm", -6.4967749901858625),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.4967749901858625),
                                    ("Diwaliyear (latent)", -6.4967749901858625),
                                    ("between <time> and <time>on <day>", -6.091309882077698),
                                    ("Black Fridayyear (latent)", -6.091309882077698),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.4967749901858625),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.4967749901858625),
                                    ("Chhathyear (latent)", -6.091309882077698),
                                    ("Vasant Panchamiyear (latent)", -6.4967749901858625),
                                    ("Rabindra Jayantiyear (latent)", -5.244012021690494),
                                    ("this <part-of-day>at <time-of-day>", -5.244012021690494),
                                    ("St Patrick's Dayyear (latent)", -6.4967749901858625),
                                    ("Thursday<time> (timezone)", -6.4967749901858625),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.4967749901858625),
                                    ("Pargat Diwasyear (latent)", -5.244012021690494),
                                    ("August Bank Holidayyear (latent)", -5.803627809625917),
                                    ("<datetime> - <datetime> (interval)July", -6.091309882077698),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.803627809625917),
                                    ("Februaryintersect", -6.4967749901858625),
                                    ("Simchat Torahyear (latent)", -6.4967749901858625),
                                    ("minuteyear", -6.4967749901858625)],
                               n = 508},
                   koData =
                     ClassData{prior = -0.9356150047005579, unseen = -6.874198495453294,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.6759392568762985),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.7745515455444085),
                                    ("hourday", -3.615067296191036),
                                    ...
                                    ("Bank Holidayyear (latent)", -5.486869473092628),
                                    ...
                                    ("hourminute", -5.486869473092628),
                                    ("<time-of-day> am|pmtomorrow", -6.180016653652572),
                                    ...
                                    ("dd/mmyear (latent)", -6.180016653652572),
                                    ...
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.180016653652572),
                                    ("<day-of-month> (ordinal)Monday", -5.263725921778418),
                                    ("at <time-of-day>on <day>", -5.263725921778418),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.180016653652572),
                                    ...
                                    ("time-of-day (latent)at <time-of-day>", -5.486869473092628),
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.7127941779437419, unseen = -4.859812404361672,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 126},
                   koData =
                     ClassData{prior = -0.6738787616940684, unseen = -4.897839799950911,
                               likelihoods =
                                 HashMap.fromList
