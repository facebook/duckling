...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6515024792882267, unseen = -5.945420608606575,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 380},
                   koData =
                     ClassData{prior = -0.736601809806231, unseen = -5.860786223465865,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4977914059270838, unseen = -7.002155954403621,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.3080984415095305),
                                    ("Father's Dayyear (latent)", -6.3080984415095305),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.3080984415095305),
                                    ("Ramadanyear (latent)", -5.391807709635375),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.293195420967266),
                                    ("Bhai Doojyear (latent)", -6.3080984415095305),
                                    ("hourday", -4.293195420967266),
                                    ("dayhour", -3.3903277094252515),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.293195420967266),
                                    ("Martin Luther King's Dayyear (latent)", -5.902633333401366),
                                    ("Shemini Atzeretyear (latent)", -6.3080984415095305),
                                    ("daymonth", -4.293195420967266),
                                    ("monthday", -5.902633333401366),
                                    ("monthyear", -4.516338972281476),
                                    ("Yom Ha'atzmautyear (latent)", -6.3080984415095305),
                                    ("Vijayadashamiyear (latent)", -6.3080984415095305),
                                    ("Thanksgiving Dayyear (latent)", -5.209486152841421),
                                    ("Thai Pongalyear (latent)", -5.614951260949585),
                                    ("Thiru Onamyear (latent)", -5.614951260949585),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.3080984415095305),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.391807709635375),
                                    ("<day-of-month> (ordinal)Wednesday", -6.3080984415095305),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.3080984415095305),
                                    ("houryear", -5.391807709635375),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.3080984415095305),
                                    ("Christmas<time-of-day> am|pm", -6.3080984415095305),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.3080984415095305),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.614951260949585),
                                    ("intersectin|during <named-month>|year", -6.3080984415095305),
                                    ("<time-of-day> am|pmintersect", -5.055335473014162),
                                    ("Earth Houryear (latent)", -6.3080984415095305),
                                    ("Octoberyear (latent)", -4.804021044733257),
                                    ("intersect<time-of-day> am|pm", -6.3080984415095305),
                                    ("Mattu Pongalyear (latent)", -6.3080984415095305),
                                    ("Shavuotyear (latent)", -6.3080984415095305),
                                    ("Parsi New Yearyear (latent)", -5.391807709635375),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.3080984415095305),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.3080984415095305),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.902633333401366),
                                    ("Marchyear (latent)", -6.3080984415095305),
                                    ("Sukkotyear (latent)", -5.902633333401366),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.902633333401366),
                                    ("Clean Mondayyear (latent)", -5.902633333401366),
                                    ("monthhour", -5.902633333401366),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.614951260949585),
                                    ("todayat <time-of-day>", -6.3080984415095305),
                                    ("Thursday<time> timezone", -4.362188292454217),
                                    ("time-of-day (latent)tonight", -5.902633333401366),
                                    ("from|since|after <time>December", -6.3080984415095305),
                                    ("dd/mm<time-of-day> am|pm", -6.3080984415095305),
                                    ("<time-of-day> am|pmon <day>", -4.293195420967266),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.3080984415095305),
                                    ("yyyy-mm-ddhh:mm:ss", -5.902633333401366),
                                    ("dayday", -3.865751406140326),
                                    ("dd/mmat <time-of-day>", -6.3080984415095305),
                                    ("<time> <part-of-day>at <time-of-day>", -6.3080984415095305),
                                    ("tonightat <time-of-day>", -6.3080984415095305),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.614951260949585),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.3080984415095305),
                                    ("today<time-of-day> am|pm", -6.3080984415095305),
                                    ("Februarythe <day-of-month> (ordinal)", -5.902633333401366),
                                    ("at <time-of-day><time> <part-of-day>", -6.3080984415095305),
                                    ("<day-of-month> (ordinal)intersect", -5.902633333401366),
                                    ("hourhour", -4.228656899829694),
                                    ("Navaratriin|during <named-month>|year", -6.3080984415095305),
                                    ("Wednesdaythis|last|next <cycle>", -6.3080984415095305),
                                    ("Lentyear (latent)", -6.3080984415095305),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.804021044733257),
                                    ("Boghiyear (latent)", -6.3080984415095305),
                                    ("dayyear", -1.9449998167211677),
                                    ("Thursdayfrom|since|after <time>", -5.902633333401366),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.3080984415095305),
                                    ("Thursdayat <time-of-day>", -5.614951260949585),
                                    ("Islamic New Yearyear (latent)", -5.902633333401366),
                                    ("Laylat al-Qadryear (latent)", -5.391807709635375),
                                    ("Shrove Tuesdayyear (latent)", -6.3080984415095305),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.614951260949585),
                                    ("<time-of-day> am|pmtomorrow", -5.614951260949585),
                                    ("Yom Kippuryear (latent)", -6.3080984415095305),
                                    ("<day-of-month> (ordinal)Tuesday", -5.902633333401366),
                                    ("<part-of-day> of <time>year (latent)", -6.3080984415095305),
                                    ("minutehour", -5.209486152841421),
                                    ("Kaanum Pongalyear (latent)", -5.902633333401366),
                                    ("Maha Saptamiyear (latent)", -6.3080984415095305),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.902633333401366),
                                    ("time-of-day (latent)tomorrow", -5.391807709635375),
                                    ("part of daysat <time-of-day>", -5.902633333401366),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.603350349271105),
                                    ("for <duration> from <time>December", -6.3080984415095305),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.3080984415095305),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.055335473014162),
                                    ("time-of-day (latent)this <part-of-day>", -6.3080984415095305),
                                    ("Pentecostyear (latent)", -6.3080984415095305),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.055335473014162),
                                    ("<day-of-month> (ordinal)February", -6.3080984415095305),
                                    ("Eid al-Fitryear (latent)", -5.391807709635375),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.3080984415095305),
                                    ("Mondayin|during the <part-of-day>", -6.3080984415095305),
                                    ("Chhathin|during <named-month>|year", -6.3080984415095305),
                                    ("Diwaliin|during <named-month>|year", -6.3080984415095305),
                                    ("Vaisakhiin|during <named-month>|year", -6.3080984415095305),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.055335473014162),
                                    ("Raksha Bandhanyear (latent)", -6.3080984415095305),
                                    ("daysecond", -5.902633333401366),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.902633333401366),
                                    ("Ashurayear (latent)", -6.3080984415095305),
                                    ("Tuesdayin|during <named-month>|year", -6.3080984415095305),
                                    ("Chinese New Yearyear (latent)", -6.3080984415095305),
                                    ("tomorrowintersect", -6.3080984415095305),
                                    ("Lag BaOmeryear (latent)", -6.3080984415095305),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.3080984415095305),
                                    ("Eid al-Adhayear (latent)", -5.391807709635375),
                                    ("intersectin|during the <part-of-day>", -6.3080984415095305),
                                    ("Palm Sundayyear (latent)", -6.3080984415095305),
                                    ("Christmasat <time-of-day>", -6.3080984415095305),
                                    ("Passoveryear (latent)", -6.3080984415095305),
                                    ("Lazarus Saturdayyear (latent)", -6.3080984415095305),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.3080984415095305),
                                    ("Yom HaShoahyear (latent)", -5.902633333401366),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.902633333401366),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.3080984415095305),
                                    ("Septemberyear (latent)", -5.902633333401366),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.804021044733257),
                                    ("Halloweenyear (latent)", -6.3080984415095305),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.3080984415095305),
                                    ("at <time-of-day>intersect", -5.902633333401366),
                                    ("Rosh Hashanahyear (latent)", -5.614951260949585),
                                    ("Dhanterasyear (latent)", -6.3080984415095305),
                                    ("Tu BiShvatyear (latent)", -6.3080984415095305),
                                    ("<day-of-month> (ordinal)December", -5.614951260949585),
                                    ("Holiyear (latent)", -5.614951260949585),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.3080984415095305),
                                    ("Holika Dahanyear (latent)", -5.614951260949585),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.3080984415095305),
                                    ("dayminute", -3.3903277094252515),
                                    ("Mawlidyear (latent)", -6.3080984415095305),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.902633333401366),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.3080984415095305),
                                    ("Jumu'atul-Widayear (latent)", -5.391807709635375),
                                    ("minuteday", -2.4794570450204354),
                                    ("absorption of , after named dayintersect",
                                     -6.3080984415095305),
                                    ("intersectyear (latent)", -6.3080984415095305),
                                    ("Orthodox Easter Sundayyear (latent)", -6.3080984415095305),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.3080984415095305),
                                    ("Mothering Sundayyear (latent)", -5.902633333401366),
                                    ("Boss's Dayyear (latent)", -5.902633333401366),
                                    ("Global Youth Service Dayyear (latent)", -6.3080984415095305),
                                    ("Dhanterasin|during <named-month>|year", -6.3080984415095305),
                                    ("Tisha B'Avyear (latent)", -6.3080984415095305),
                                    ("Isra and Mi'rajyear (latent)", -5.391807709635375),
                                    ("at <time-of-day>on <day>", -5.209486152841421),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.3080984415095305),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.614951260949585),
                                    ("Christmasyear (latent)", -5.902633333401366),
                                    ("Naraka Chaturdashiyear (latent)", -5.902633333401366),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.3080984415095305),
                                    ("dayweek", -6.3080984415095305),
                                    ("Easter Sundayyear (latent)", -5.614951260949585),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.69866052907543),
                                    ("weekyear", -5.209486152841421),
                                    ("King's Dayyear (latent)", -4.804021044733257),
                                    ("hh:mmin|during the <part-of-day>", -5.614951260949585),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.902633333401366),
                                    ("Hanukkahyear (latent)", -5.614951260949585),
                                    ("February<time> <part-of-day>", -6.3080984415095305),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.3080984415095305),
                                    ("Great Lentyear (latent)", -6.3080984415095305),
                                    ("tomorrowat <time-of-day>", -5.614951260949585),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.3080984415095305),
                                    ("Vaisakhiyear (latent)", -5.614951260949585),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.3080984415095305),
                                    ("last <cycle> of <time>year (latent)", -5.614951260949585),
                                    ("at <time-of-day>tomorrow", -5.902633333401366),
                                    ("tomorrow<time-of-day> am|pm", -6.3080984415095305),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.3080984415095305),
                                    ("Diwaliyear (latent)", -6.3080984415095305),
                                    ("between <time> and <time>on <day>", -4.69866052907543),
                                    ("Black Fridayyear (latent)", -5.902633333401366),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.3080984415095305),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.3080984415095305),
                                    ("Chhathyear (latent)", -5.902633333401366),
                                    ("Vasant Panchamiyear (latent)", -6.3080984415095305),
                                    ("Rabindra Jayantiyear (latent)", -5.055335473014162),
                                    ("St Patrick's Dayyear (latent)", -6.3080984415095305),
                                    ("Thursday<time> (timezone)", -6.3080984415095305),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.3080984415095305),
                                    ("August Bank Holidayyear (latent)", -5.614951260949585),
                                    ("<datetime> - <datetime> (interval)July", -5.902633333401366),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.902633333401366),
                                    ("Februaryintersect", -6.3080984415095305),
                                    ("Simchat Torahyear (latent)", -6.3080984415095305),
                                    ("minuteyear", -6.3080984415095305)],
                               n = 417},
                   koData =
                     ClassData{prior = -0.936166248124046, unseen = -6.688354713946762,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.17589066646366416,
                               ...
                               n = 182},
                   koData =
                     ClassData{prior = -1.824549292051046, unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
