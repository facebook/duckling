...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6024434916831882, unseen = -6.100318952020064,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 444},
                   koData =
                     ClassData{prior = -0.7929062060608426, unseen = -5.910796644040527,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4734624593536142, unseen = -7.113142108707088,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.419180264150966),
                                    ("Father's Dayyear (latent)", -6.419180264150966),
                                    ("Karva Chauthyear (latent)", -6.419180264150966),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.419180264150966),
                                    ("Maha Shivaratriyear (latent)", -6.419180264150966),
                                    ("Ramadanyear (latent)", -5.502889532276811),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.032885903031076),
                                    ("Bhai Doojyear (latent)", -6.419180264150966),
                                    ("hourday", -4.404277243608702),
                                    ("dayhour", -3.4747412849845256),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.032885903031076),
                                    ("Martin Luther King's Dayyear (latent)", -6.013715156042802),
                                    ("Shemini Atzeretyear (latent)", -6.419180264150966),
                                    ("daymonth", -4.404277243608702),
                                    ("monthday", -6.013715156042802),
                                    ("monthyear", -4.627420794922911),
                                    ("Yom Ha'atzmautyear (latent)", -6.419180264150966),
                                    ("Vijayadashamiyear (latent)", -6.419180264150966),
                                    ("Thanksgiving Dayyear (latent)", -5.320567975482857),
                                    ("Thai Pongalyear (latent)", -5.7260330835910205),
                                    ("Thiru Onamyear (latent)", -5.7260330835910205),
                                    ("hhhmmabsorption of , after named day", -6.419180264150966),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.419180264150966),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.502889532276811),
                                    ("<day-of-month> (ordinal)Wednesday", -6.419180264150966),
                                    ("Krishna Janmashtamiyear (latent)", -6.013715156042802),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.419180264150966),
                                    ("houryear", -5.502889532276811),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.419180264150966),
                                    ("Christmas<time-of-day> am|pm", -6.419180264150966),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.419180264150966),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7260330835910205),
                                    ("intersectin|during <named-month>|year", -6.419180264150966),
                                    ("<time-of-day> am|pmintersect", -5.166417295655598),
                                    ("Earth Houryear (latent)", -6.419180264150966),
                                    ("Octoberyear (latent)", -4.915102867374692),
                                    ("intersect<time-of-day> am|pm", -6.419180264150966),
                                    ("Mattu Pongalyear (latent)", -6.419180264150966),
                                    ("Shavuotyear (latent)", -6.419180264150966),
                                    ("Parsi New Yearyear (latent)", -5.502889532276811),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.419180264150966),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.419180264150966),
                                    ("todayin|within|after <duration>", -6.419180264150966),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.013715156042802),
                                    ("Marchyear (latent)", -6.419180264150966),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.013715156042802),
                                    ("Sukkotyear (latent)", -6.013715156042802),
                                    ("hhhmmintersect", -6.013715156042802),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7260330835910205),
                                    ("todayat <time-of-day>", -6.419180264150966),
                                    ("Thursday<time> timezone", -4.021284991352595),
                                    ("time-of-day (latent)tonight", -6.013715156042802),
                                    ("from|since|after <time>December", -6.419180264150966),
                                    ("dd/mm<time-of-day> am|pm", -6.419180264150966),
                                    ("<time-of-day> am|pmon <day>", -4.404277243608702),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.419180264150966),
                                    ("yyyy-mm-ddhh:mm:ss", -6.013715156042802),
                                    ("dayday", -3.711130063048756),
                                    ("dd/mmat <time-of-day>", -6.419180264150966),
                                    ("<time> <part-of-day>at <time-of-day>", -6.419180264150966),
                                    ("tonightat <time-of-day>", -6.419180264150966),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.7260330835910205),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.419180264150966),
                                    ("today<time-of-day> am|pm", -6.419180264150966),
                                    ("Februarythe <day-of-month> (ordinal)", -6.013715156042802),
                                    ("at <time-of-day><time> <part-of-day>", -6.419180264150966),
                                    ("<day-of-month> (ordinal)intersect", -6.013715156042802),
                                    ("hourhour", -4.339738722471131),
                                    ("Mahavir Jayantiyear (latent)", -6.013715156042802),
                                    ("Navaratriin|during <named-month>|year", -6.419180264150966),
                                    ("Wednesdaythis|last|next <cycle>", -6.419180264150966),
                                    ("Lentyear (latent)", -6.419180264150966),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.547378087249375),
                                    ("Boghiyear (latent)", -6.419180264150966),
                                    ("dayyear", -1.875885481880962),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.419180264150966),
                                    ("Thursdayfrom|since|after <time>", -6.013715156042802),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.419180264150966),
                                    ("Thursdayat <time-of-day>", -5.7260330835910205),
                                    ("Islamic New Yearyear (latent)", -6.013715156042802),
                                    ("Laylat al-Qadryear (latent)", -5.502889532276811),
                                    ("Shrove Tuesdayyear (latent)", -6.419180264150966),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.7260330835910205),
                                    ("<time-of-day> am|pmtomorrow", -5.7260330835910205),
                                    ("Yom Kippuryear (latent)", -6.419180264150966),
                                    ("<day-of-month> (ordinal)Tuesday", -6.013715156042802),
                                    ("<part-of-day> of <time>year (latent)", -6.419180264150966),
                                    ("minutehour", -5.166417295655598),
                                    ("Kaanum Pongalyear (latent)", -6.013715156042802),
                                    ("Maha Saptamiyear (latent)", -6.419180264150966),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.013715156042802),
                                    ("time-of-day (latent)tomorrow", -5.502889532276811),
                                    ("part of daysat <time-of-day>", -6.013715156042802),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.404277243608702),
                                    ("for <duration> from <time>December", -6.419180264150966),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.419180264150966),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.166417295655598),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.166417295655598),
                                    ("time-of-day (latent)this <part-of-day>", -6.419180264150966),
                                    ("Pentecostyear (latent)", -6.419180264150966),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.166417295655598),
                                    ("<day-of-month> (ordinal)February", -6.419180264150966),
                                    ("Eid al-Fitryear (latent)", -5.502889532276811),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.419180264150966),
                                    ("Mondayin|during the <part-of-day>", -6.419180264150966),
                                    ("Chhathin|during <named-month>|year", -6.419180264150966),
                                    ("Diwaliin|during <named-month>|year", -6.419180264150966),
                                    ("Vaisakhiin|during <named-month>|year", -6.419180264150966),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.166417295655598),
                                    ("Raksha Bandhanyear (latent)", -6.419180264150966),
                                    ("daysecond", -6.013715156042802),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.013715156042802),
                                    ("Ashurayear (latent)", -6.419180264150966),
                                    ("Tuesdayin|during <named-month>|year", -6.419180264150966),
                                    ("Chinese New Yearyear (latent)", -6.419180264150966),
                                    ("tomorrowintersect", -6.419180264150966),
                                    ("Lag BaOmeryear (latent)", -6.419180264150966),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.419180264150966),
                                    ("Eid al-Adhayear (latent)", -4.279114100654695),
                                    ("intersectin|during the <part-of-day>", -6.419180264150966),
                                    ("Palm Sundayyear (latent)", -6.419180264150966),
                                    ("Christmasat <time-of-day>", -6.419180264150966),
                                    ("Passoveryear (latent)", -6.419180264150966),
                                    ("Lazarus Saturdayyear (latent)", -6.419180264150966),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.419180264150966),
                                    ("hhhmmon <day>", -5.502889532276811),
                                    ("Yom HaShoahyear (latent)", -6.013715156042802),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.013715156042802),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.419180264150966),
                                    ("Septemberyear (latent)", -6.013715156042802),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.915102867374692),
                                    ("Halloweenyear (latent)", -6.419180264150966),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.419180264150966),
                                    ("at <time-of-day>intersect", -5.502889532276811),
                                    ("Rosh Hashanahyear (latent)", -5.7260330835910205),
                                    ("Dhanterasyear (latent)", -6.419180264150966),
                                    ("Tu BiShvatyear (latent)", -6.419180264150966),
                                    ("<day-of-month> (ordinal)December", -5.7260330835910205),
                                    ("Holiyear (latent)", -5.7260330835910205),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.419180264150966),
                                    ("Holika Dahanyear (latent)", -5.7260330835910205),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.013715156042802),
                                    ("dayminute", -3.0692761768763615),
                                    ("Mawlidyear (latent)", -6.419180264150966),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.013715156042802),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.419180264150966),
                                    ("Jumu'atul-Widayear (latent)", -5.502889532276811),
                                    ("minuteday", -2.681510645867598),
                                    ("absorption of , after named dayintersect",
                                     -5.7260330835910205),
                                    ("intersectyear (latent)", -6.419180264150966),
                                    ("Orthodox Easter Sundayyear (latent)", -6.419180264150966),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.419180264150966),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.419180264150966),
                                    ("intersecthhhmm", -6.013715156042802),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.419180264150966),
                                    ("Mothering Sundayyear (latent)", -6.013715156042802),
                                    ("Boss's Dayyear (latent)", -6.013715156042802),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.419180264150966),
                                    ("Global Youth Service Dayyear (latent)", -6.419180264150966),
                                    ("Dhanterasin|during <named-month>|year", -6.419180264150966),
                                    ("Tisha B'Avyear (latent)", -6.419180264150966),
                                    ("Isra and Mi'rajyear (latent)", -5.502889532276811),
                                    ("at <time-of-day>on <day>", -4.809742351716866),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.013715156042802),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.7260330835910205),
                                    ("Christmasyear (latent)", -6.013715156042802),
                                    ("Naraka Chaturdashiyear (latent)", -6.013715156042802),
                                    ("Thai Pongalin|during <named-month>|year", -6.419180264150966),
                                    ("dayweek", -6.419180264150966),
                                    ("Easter Sundayyear (latent)", -5.7260330835910205),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.013715156042802),
                                    ("weekyear", -5.320567975482857),
                                    ("King's Dayyear (latent)", -4.915102867374692),
                                    ("hh:mmin|during the <part-of-day>", -5.502889532276811),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.013715156042802),
                                    ("Hanukkahyear (latent)", -5.7260330835910205),
                                    ("February<time> <part-of-day>", -6.419180264150966),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.419180264150966),
                                    ("Great Lentyear (latent)", -6.419180264150966),
                                    ("tomorrowat <time-of-day>", -5.7260330835910205),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.419180264150966),
                                    ("Ugadiyear (latent)", -5.166417295655598),
                                    ("Vaisakhiyear (latent)", -5.7260330835910205),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.7260330835910205),
                                    ("last <cycle> of <time>year (latent)", -5.7260330835910205),
                                    ("at <time-of-day>tomorrow", -6.013715156042802),
                                    ("tomorrow<time-of-day> am|pm", -6.419180264150966),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.419180264150966),
                                    ("Diwaliyear (latent)", -6.419180264150966),
                                    ("between <time> and <time>on <day>", -6.013715156042802),
                                    ("Black Fridayyear (latent)", -6.013715156042802),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.419180264150966),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.419180264150966),
                                    ("Chhathyear (latent)", -6.013715156042802),
                                    ("Vasant Panchamiyear (latent)", -6.419180264150966),
                                    ("Rabindra Jayantiyear (latent)", -5.166417295655598),
                                    ("St Patrick's Dayyear (latent)", -6.419180264150966),
                                    ("Thursday<time> (timezone)", -6.419180264150966),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.419180264150966),
                                    ("Pargat Diwasyear (latent)", -5.166417295655598),
                                    ("August Bank Holidayyear (latent)", -5.7260330835910205),
                                    ("<datetime> - <datetime> (interval)July", -6.013715156042802),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.7260330835910205),
                                    ("Februaryintersect", -6.419180264150966),
                                    ("Simchat Torahyear (latent)", -6.419180264150966),
                                    ("minuteyear", -6.419180264150966)],
                               n = 469},
                   koData =
                     ClassData{prior = -0.9750909896386876, unseen = -6.754604099487962,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.55621334126156),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.65482562992967),
                                    ("hourday", -3.662395465239464),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.060290738037835),
                                    ("<day-of-month> (ordinal)August", -6.060290738037835),
                                    ("dayhour", -3.386142088611306),
                                    ("<time> timezoneyear (latent)", -5.367143557477889),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.1440000061636795),
                                    ("Tuesdayfrom|since|after <time>", -5.367143557477889),
                                    ("daymonth", -3.386142088611306),
                                    ("monthyear", -4.8075277695424665),
                                    ("<time-of-day> am|pmyear (latent)", -5.367143557477889),
                                    ("Thai Pongalyear (latent)", -5.367143557477889),
                                    ("intersecthh:mm", -6.060290738037835),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.65482562992967),
                                    ("<day-of-month> (ordinal)Wednesday", -6.060290738037835),
                                    ("houryear", -4.673996376917944),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.060290738037835),
                                    ("<day-of-month> (ordinal)October", -6.060290738037835),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.367143557477889),
                                    ("hournograin", -4.8075277695424665),
                                    ("<time-of-day> am|pmintersect", -4.8075277695424665),
                                    ("Octoberyear (latent)", -6.060290738037835),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.65482562992967),
                                    ("until <time>on <day>", -5.367143557477889),
                                    ("time-of-day (latent)intersect", -5.367143557477889),
                                    ("todayin <number> (implicit minutes)", -6.060290738037835),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.367143557477889),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.060290738037835),
                                    ("hh:mmon <day>", -4.8075277695424665),
                                    ("hhhmmintersect", -5.65482562992967),
                                    ("absorption of , after named dayJuly", -5.1440000061636795),
                                    ("from|since|after <time>July", -5.65482562992967),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.1440000061636795),
                                    ("Clean Mondayyear (latent)", -6.060290738037835),
                                    ("monthhour", -6.060290738037835),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.65482562992967),
                                    ("hourmonth", -4.188488561136243),
                                    ("todayat <time-of-day>", -6.060290738037835),
                                    ("Bank Holidayyear (latent)", -5.367143557477889),
                                    ("hhhmmyear (latent)", -4.8075277695424665),
                                    ("from|since|after <time>December", -6.060290738037835),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.060290738037835),
                                    ("<time-of-day> am|pmon <day>", -4.8075277695424665),
                                    ("Mondayyear (latent)", -5.367143557477889),
                                    ("dayday", -4.673996376917944),
                                    ("dd/mmat <time-of-day>", -5.65482562992967),
                                    ("on <day>September", -5.367143557477889),
                                    ("time-of-day (latent)September", -5.65482562992967),
                                    ("hourhour", -4.961678449369725),
                                    ("time-of-day (latent)on <day>", -4.55621334126156),
                                    ("Thursdaydd/mm", -6.060290738037835),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.65482562992967),
                                    ("dayyear", -3.039865851893472),
                                    ("New Year's Dayyear (latent)", -5.1440000061636795),
                                    ("time-of-day (latent)Sunday", -5.65482562992967),
                                    ("Thursdayfrom|since|after <time>", -4.355542645799409),
                                    ("Thursdayat <time-of-day>", -4.450852825603734),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.060290738037835),
                                    ("Aprilyear (latent)", -6.060290738037835),
                                    ("the <day-of-month> (ordinal)July", -6.060290738037835),
                                    ("the <day-of-month> (number)July", -6.060290738037835),
                                    ("monthminute", -6.060290738037835),
                                    ("hourminute", -5.367143557477889),
                                    ("<time-of-day> am|pmtomorrow", -6.060290738037835),
                                    ("Thursdayhh:mm", -5.1440000061636795),
                                    ("<day-of-month> (ordinal)Tuesday", -5.65482562992967),
                                    ("minutemonth", -3.920224574541564),
                                    ("time-of-day (latent)Friday", -5.65482562992967),
                                    ("minutehour", -6.060290738037835),
                                    ("Augustyear (latent)", -5.65482562992967),
                                    ("week-endin|during <named-month>|year", -6.060290738037835),
                                    ("time-of-day (latent)Tuesday", -5.65482562992967),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.060290738037835),
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.65482562992967),
                                    ("Sundayyear (latent)", -5.1440000061636795),
                                    ("Christmasat <time-of-day>", -6.060290738037835),
                                    ("from|since|after <time>year (latent)", -4.961678449369725),
                                    ("dd/mmyear (latent)", -6.060290738037835),
                                    ("hhhmmon <day>", -5.1440000061636795),
                                    ("yesterday<time-of-day> am|pm", -6.060290738037835),
                                    ("<day-of-month> (ordinal)July", -5.367143557477889),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.060290738037835),
                                    ("at <time-of-day>intersect", -5.1440000061636795),
                                    ("hh:mmyear (latent)", -4.673996376917944),
                                    ("Holiyear (latent)", -6.060290738037835),
                                    ("until <time><time-of-day> am|pm", -6.060290738037835),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.65482562992967),
                                    ("dayminute", -3.198089857108366),
                                    ("yyyy-mm-ddhh:mm", -5.65482562992967),
                                    ("intersectfrom|since|after <time>", -5.65482562992967),
                                    ("intersectSeptember", -4.188488561136243),
                                    ("minuteday", -2.903290316887721),
                                    ("absorption of , after named dayintersect",
                                     -6.060290738037835),
                                    ("intersectyear (latent)", -6.060290738037835),
                                    ("Februaryin|during the <part-of-day>", -6.060290738037835),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.060290738037835),
                                    ("time-of-day (latent)July", -5.367143557477889),
                                    ("Saturdayyear (latent)", -6.060290738037835),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.060290738037835),
                                    ("at <time-of-day>on <day>", -5.1440000061636795),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.060290738037835),
                                    ("absorption of , after named daySeptember",
                                     -4.8075277695424665),
                                    ("Naraka Chaturdashiyear (latent)", -6.060290738037835),
                                    ("from|since|after <time>on <day>", -5.1440000061636795),
                                    ("dayweek", -6.060290738037835),
                                    ("Easter Sundayyear (latent)", -5.65482562992967),
                                    ("time-of-day (latent)at <time-of-day>", -5.367143557477889),
                                    ("Thursday<time-of-day> am|pm", -4.8075277695424665),
                                    ("weekyear", -5.65482562992967),
                                    ("time-of-day (latent)Thursday", -5.65482562992967),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.060290738037835),
                                    ("<day-of-month> (ordinal)April", -6.060290738037835),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.65482562992967),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.367143557477889),
                                    ("Sundayfrom|since|after <time>", -6.060290738037835),
                                    ...
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.060290738037835),
                                    ("tomorrowat <time-of-day>", -6.060290738037835),
                                    ("daynograin", -5.65482562992967),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.65482562992967),
                                    ("last <cycle> of <time>year (latent)", -5.65482562992967),
                                    ("tomorrow<time-of-day> am|pm", -6.060290738037835),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.367143557477889),
                                    ("Diwaliyear (latent)", -5.65482562992967),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.060290738037835),
                                    ("Fridayyear (latent)", -5.65482562992967),
                                    ("time-of-day (latent)April", -6.060290738037835),
                                    ("minuteyear", -3.863066160701615)],
                               n = 284}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
