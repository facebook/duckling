...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6842582331426993, unseen = -5.831882477283517,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 339},
                   koData =
                     ClassData{prior = -0.7021158505427056, unseen = -5.814130531825066,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5108256237659907, unseen = -6.93828448401696,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.244166900663736),
                                    ("Father's Dayyear (latent)", -6.244166900663736),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.244166900663736),
                                    ("Ramadanyear (latent)", -5.327876168789581),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.229263880121471),
                                    ("Bhai Doojyear (latent)", -6.244166900663736),
                                    ("hourday", -4.229263880121471),
                                    ("dayhour", -3.326396168579457),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.229263880121471),
                                    ("Martin Luther King's Dayyear (latent)", -5.838701792555572),
                                    ("Shemini Atzeretyear (latent)", -6.244166900663736),
                                    ("daymonth", -4.634728988229636),
                                    ("monthday", -5.838701792555572),
                                    ("monthyear", -4.452407431435681),
                                    ("Yom Ha'atzmautyear (latent)", -6.244166900663736),
                                    ("Vijayadashamiyear (latent)", -6.244166900663736),
                                    ("Thanksgiving Dayyear (latent)", -5.145554611995626),
                                    ("Thai Pongalyear (latent)", -5.551019720103791),
                                    ("Thiru Onamyear (latent)", -5.551019720103791),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.244166900663736),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.244166900663736),
                                    ("<day-of-month> (ordinal)Wednesday", -6.244166900663736),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.244166900663736),
                                    ("houryear", -5.327876168789581),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.244166900663736),
                                    ("Christmas<time-of-day> am|pm", -6.244166900663736),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.244166900663736),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.551019720103791),
                                    ("intersectin|during <named-month>|year", -6.244166900663736),
                                    ("<time-of-day> am|pmintersect", -4.991403932168368),
                                    ("Earth Houryear (latent)", -6.244166900663736),
                                    ("Octoberyear (latent)", -4.740089503887462),
                                    ("intersect<time-of-day> am|pm", -6.244166900663736),
                                    ("Mattu Pongalyear (latent)", -6.244166900663736),
                                    ("Shavuotyear (latent)", -6.244166900663736),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.244166900663736),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.244166900663736),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.838701792555572),
                                    ("Marchyear (latent)", -6.244166900663736),
                                    ("Sukkotyear (latent)", -5.838701792555572),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.838701792555572),
                                    ("Clean Mondayyear (latent)", -5.838701792555572),
                                    ("monthhour", -5.838701792555572),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.551019720103791),
                                    ("todayat <time-of-day>", -6.244166900663736),
                                    ("Thursday<time> timezone", -4.298256751608423),
                                    ("time-of-day (latent)tonight", -5.838701792555572),
                                    ("from|since|after <time>December", -6.244166900663736),
                                    ("dd/mm<time-of-day> am|pm", -6.244166900663736),
                                    ("<time-of-day> am|pmon <day>", -4.229263880121471),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.244166900663736),
                                    ("yyyy-mm-ddhh:mm:ss", -5.838701792555572),
                                    ("dayday", -3.8018198652945316),
                                    ("dd/mmat <time-of-day>", -6.244166900663736),
                                    ("<time> <part-of-day>at <time-of-day>", -6.244166900663736),
                                    ("tonightat <time-of-day>", -6.244166900663736),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.551019720103791),
                                    ("today<time-of-day> am|pm", -6.244166900663736),
                                    ("Februarythe <day-of-month> (ordinal)", -5.838701792555572),
                                    ("at <time-of-day><time> <part-of-day>", -6.244166900663736),
                                    ("<day-of-month> (ordinal)intersect", -5.838701792555572),
                                    ("hourhour", -4.1647253589839),
                                    ("Navaratriin|during <named-month>|year", -6.244166900663736),
                                    ("Wednesdaythis|last|next <cycle>", -6.244166900663736),
                                    ("Lentyear (latent)", -6.244166900663736),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.740089503887462),
                                    ("Boghiyear (latent)", -6.244166900663736),
                                    ("dayyear", -2.0545121586373107),
                                    ("Thursdayfrom|since|after <time>", -5.838701792555572),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.244166900663736),
                                    ("Thursdayat <time-of-day>", -5.551019720103791),
                                    ("Islamic New Yearyear (latent)", -5.838701792555572),
                                    ("Laylat al-Qadryear (latent)", -5.327876168789581),
                                    ("Shrove Tuesdayyear (latent)", -6.244166900663736),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.551019720103791),
                                    ("<time-of-day> am|pmtomorrow", -5.551019720103791),
                                    ("Yom Kippuryear (latent)", -6.244166900663736),
                                    ("<day-of-month> (ordinal)Tuesday", -5.838701792555572),
                                    ("<part-of-day> of <time>year (latent)", -6.244166900663736),
                                    ("minutehour", -5.145554611995626),
                                    ("Kaanum Pongalyear (latent)", -5.838701792555572),
                                    ("Maha Saptamiyear (latent)", -6.244166900663736),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.838701792555572),
                                    ("time-of-day (latent)tomorrow", -5.327876168789581),
                                    ("part of daysat <time-of-day>", -5.838701792555572),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.539418808425311),
                                    ("for <duration> from <time>December", -6.244166900663736),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.244166900663736),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.991403932168368),
                                    ("time-of-day (latent)this <part-of-day>", -6.244166900663736),
                                    ("Pentecostyear (latent)", -6.244166900663736),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.991403932168368),
                                    ("<day-of-month> (ordinal)February", -6.244166900663736),
                                    ("Eid al-Fitryear (latent)", -5.327876168789581),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.244166900663736),
                                    ("Mondayin|during the <part-of-day>", -6.244166900663736),
                                    ("Chhathin|during <named-month>|year", -6.244166900663736),
                                    ("Diwaliin|during <named-month>|year", -6.244166900663736),
                                    ("Vaisakhiin|during <named-month>|year", -6.244166900663736),
                                    ("Raksha Bandhanyear (latent)", -6.244166900663736),
                                    ("daysecond", -5.838701792555572),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.838701792555572),
                                    ("Ashurayear (latent)", -6.244166900663736),
                                    ("Tuesdayin|during <named-month>|year", -6.244166900663736),
                                    ("Chinese New Yearyear (latent)", -6.244166900663736),
                                    ("tomorrowintersect", -6.244166900663736),
                                    ("Lag BaOmeryear (latent)", -6.244166900663736),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.244166900663736),
                                    ("Eid al-Adhayear (latent)", -5.327876168789581),
                                    ("intersectin|during the <part-of-day>", -6.244166900663736),
                                    ("Palm Sundayyear (latent)", -6.244166900663736),
                                    ("Christmasat <time-of-day>", -6.244166900663736),
                                    ("Passoveryear (latent)", -6.244166900663736),
                                    ("Lazarus Saturdayyear (latent)", -6.244166900663736),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.244166900663736),
                                    ("Yom HaShoahyear (latent)", -5.838701792555572),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.838701792555572),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.244166900663736),
                                    ("Septemberyear (latent)", -5.838701792555572),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.740089503887462),
                                    ("Halloweenyear (latent)", -6.244166900663736),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.244166900663736),
                                    ("at <time-of-day>intersect", -5.838701792555572),
                                    ("Rosh Hashanahyear (latent)", -5.551019720103791),
                                    ("Dhanterasyear (latent)", -6.244166900663736),
                                    ("Tu BiShvatyear (latent)", -6.244166900663736),
                                    ("<day-of-month> (ordinal)December", -5.551019720103791),
                                    ("Holiyear (latent)", -5.551019720103791),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.244166900663736),
                                    ("Holika Dahanyear (latent)", -5.551019720103791),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.244166900663736),
                                    ("dayminute", -3.326396168579457),
                                    ("Mawlidyear (latent)", -6.244166900663736),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.838701792555572),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.244166900663736),
                                    ("Jumu'atul-Widayear (latent)", -5.327876168789581),
                                    ("minuteday", -2.4155255041746413),
                                    ("absorption of , after named dayintersect",
                                     -6.244166900663736),
                                    ("intersectyear (latent)", -6.244166900663736),
                                    ("Orthodox Easter Sundayyear (latent)", -6.244166900663736),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.244166900663736),
                                    ("Mothering Sundayyear (latent)", -5.838701792555572),
                                    ("Boss's Dayyear (latent)", -5.838701792555572),
                                    ("Global Youth Service Dayyear (latent)", -6.244166900663736),
                                    ("Dhanterasin|during <named-month>|year", -6.244166900663736),
                                    ("Tisha B'Avyear (latent)", -6.244166900663736),
                                    ("Isra and Mi'rajyear (latent)", -5.327876168789581),
                                    ("at <time-of-day>on <day>", -5.145554611995626),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.244166900663736),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.551019720103791),
                                    ("Christmasyear (latent)", -5.838701792555572),
                                    ("Naraka Chaturdashiyear (latent)", -5.838701792555572),
                                    ("Thai Pongalin|during <named-month>|year", -6.244166900663736),
                                    ("dayweek", -6.244166900663736),
                                    ("Easter Sundayyear (latent)", -5.551019720103791),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.634728988229636),
                                    ("weekyear", -5.145554611995626),
                                    ("hh:mmin|during the <part-of-day>", -5.551019720103791),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.838701792555572),
                                    ("Hanukkahyear (latent)", -5.551019720103791),
                                    ("February<time> <part-of-day>", -6.244166900663736),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.244166900663736),
                                    ("Great Lentyear (latent)", -6.244166900663736),
                                    ("tomorrowat <time-of-day>", -5.551019720103791),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.244166900663736),
                                    ("Vaisakhiyear (latent)", -5.551019720103791),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.244166900663736),
                                    ("last <cycle> of <time>year (latent)", -5.551019720103791),
                                    ("at <time-of-day>tomorrow", -5.838701792555572),
                                    ("tomorrow<time-of-day> am|pm", -6.244166900663736),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.244166900663736),
                                    ("Diwaliyear (latent)", -6.244166900663736),
                                    ("between <time> and <time>on <day>", -4.634728988229636),
                                    ("Black Fridayyear (latent)", -5.838701792555572),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.244166900663736),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.244166900663736),
                                    ("Chhathyear (latent)", -5.838701792555572),
                                    ("Vasant Panchamiyear (latent)", -6.244166900663736),
                                    ("St Patrick's Dayyear (latent)", -6.244166900663736),
                                    ("Thursday<time> (timezone)", -6.244166900663736),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.244166900663736),
                                    ("August Bank Holidayyear (latent)", -5.551019720103791),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.838701792555572),
                                    ("Februaryintersect", -6.244166900663736),
                                    ("Simchat Torahyear (latent)", -6.244166900663736),
                                    ("minuteyear", -6.244166900663736)],
                               n = 387},
                   koData =
                     ClassData{prior = -0.916290731874155, unseen = -6.6502790485874215,
                               likelihoods =
                                 HashMap.fromList
