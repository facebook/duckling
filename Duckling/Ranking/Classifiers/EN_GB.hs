...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6203555176656538, unseen = -5.683579767338681,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 292},
                   koData =
                     ClassData{prior = -0.7716563808021516, unseen = -5.53338948872752,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47926481885377326,
                               unseen = -6.725033642166843,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.030685260261263),
                                    ("Father's Dayyear (latent)", -6.030685260261263),
                                    ("Ramadanyear (latent)", -6.030685260261263),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.777922291765895),
                                    ("Bhai Doojyear (latent)", -6.030685260261263),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.777922291765895),
                                    ("hourday", -4.325937168022838),
                                    ("dayhour", -3.2273248793547284),
                                    ("Martin Luther King's Dayyear (latent)", -5.625220152153099),
                                    ("Shemini Atzeretyear (latent)", -6.030685260261263),
                                    ("daymonth", -5.337538079701318),
                                    ("monthday", -5.625220152153099),
                                    ("monthyear", -4.421247347827163),
                                    ("Yom Ha'atzmautyear (latent)", -6.030685260261263),
                                    ("Vijayadashamiyear (latent)", -6.030685260261263),
                                    ("Thanksgiving Dayyear (latent)", -4.932072971593153),
                                    ("Thai Pongalyear (latent)", -5.337538079701318),
                                    ("Thiru Onamyear (latent)", -5.337538079701318),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.030685260261263),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.030685260261263),
                                    ("houryear", -5.337538079701318),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.030685260261263),
                                    ("Christmas<time-of-day> am|pm", -6.030685260261263),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.030685260261263),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.337538079701318),
                                    ("<time-of-day> am|pmintersect", -4.777922291765895),
                                    ("Earth Houryear (latent)", -6.030685260261263),
                                    ("Octoberyear (latent)", -4.777922291765895),
                                    ("intersect<time-of-day> am|pm", -6.030685260261263),
                                    ("Mattu Pongalyear (latent)", -6.030685260261263),
                                    ("Shavuotyear (latent)", -6.030685260261263),
                                    ("Dhanterasin <named-month>|year", -6.030685260261263),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.030685260261263),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.030685260261263),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.625220152153099),
                                    ("Marchyear (latent)", -6.030685260261263),
                                    ("Sukkotyear (latent)", -5.625220152153099),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.030685260261263),
                                    ("Clean Mondayyear (latent)", -5.625220152153099),
                                    ("monthhour", -5.625220152153099),
                                    ("todayat <time-of-day>", -6.030685260261263),
                                    ("Thursday<time> timezone", -4.325937168022838),
                                    ("dd/mm<time-of-day> am|pm", -6.030685260261263),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.030685260261263),
                                    ("Palm SundaySunday", -5.625220152153099),
                                    ("dayday", -3.8334606829250437),
                                    ("dd/mmat <time-of-day>", -6.030685260261263),
                                    ("<time> <part-of-day>at <time-of-day>", -6.030685260261263),
                                    ("tonightat <time-of-day>", -6.030685260261263),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.337538079701318),
                                    ("today<time-of-day> am|pm", -6.030685260261263),
                                    ("Februarythe <day-of-month> (ordinal)", -5.625220152153099),
                                    ("at <time-of-day><time> <part-of-day>", -6.030685260261263),
                                    ("hourhour", -4.777922291765895),
                                    ("<time-of-day> am|pmon <date>", -4.015782239718999),
                                    ("Wednesdaythis|last|next <cycle>", -6.030685260261263),
                                    ("Lentyear (latent)", -6.030685260261263),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.52660786348499),
                                    ("Boghiyear (latent)", -6.030685260261263),
                                    ("dayyear", -1.970242249714844),
                                    ("Thursdayfrom|since|after <time>", -5.625220152153099),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.030685260261263),
                                    ("Thursdayat <time-of-day>", -5.625220152153099),
                                    ("Islamic New Yearyear (latent)", -5.625220152153099),
                                    ("Laylat al-Qadryear (latent)", -5.114394528387108),
                                    ("Chhathin <named-month>|year", -6.030685260261263),
                                    ("Vasant Panchamiin <named-month>|year", -6.030685260261263),
                                    ("Diwaliin <named-month>|year", -6.030685260261263),
                                    ("Shrove Tuesdayyear (latent)", -6.030685260261263),
                                    ("<time-of-day> am|pmtomorrow", -5.337538079701318),
                                    ("Yom Kippuryear (latent)", -6.030685260261263),
                                    ("<part-of-day> of <time>year (latent)", -6.030685260261263),
                                    ("minutehour", -5.114394528387108),
                                    ("Kaanum Pongalyear (latent)", -5.625220152153099),
                                    ("Maha Saptamiyear (latent)", -6.030685260261263),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.625220152153099),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.325937168022838),
                                    ("for <duration> from <time>December", -6.030685260261263),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.030685260261263),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.114394528387108),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.625220152153099),
                                    ("Pentecostyear (latent)", -6.030685260261263),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.114394528387108),
                                    ("Eid al-Fitryear (latent)", -6.030685260261263),
                                    ("Mondayin|during the <part-of-day>", -6.030685260261263),
                                    ("Raksha Bandhanyear (latent)", -6.030685260261263),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.625220152153099),
                                    ("Navaratriin <named-month>|year", -6.030685260261263),
                                    ("Ashurayear (latent)", -6.030685260261263),
                                    ("Chinese New Yearyear (latent)", -6.030685260261263),
                                    ("Sundayyear (latent)", -6.030685260261263),
                                    ("Lag BaOmeryear (latent)", -6.030685260261263),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.030685260261263),
                                    ("Eid al-Adhayear (latent)", -5.114394528387108),
                                    ("intersectin|during the <part-of-day>", -6.030685260261263),
                                    ("Christmasat <time-of-day>", -6.030685260261263),
                                    ("Passoveryear (latent)", -6.030685260261263),
                                    ("Lazarus Saturdayyear (latent)", -6.030685260261263),
                                    ("dd/mmyear (latent)", -6.030685260261263),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.030685260261263),
                                    ("Yom HaShoahyear (latent)", -5.625220152153099),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.625220152153099),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.030685260261263),
                                    ("Thai Pongalin <named-month>|year", -6.030685260261263),
                                    ("Septemberyear (latent)", -5.625220152153099),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.777922291765895),
                                    ("Halloweenyear (latent)", -6.030685260261263),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.337538079701318),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -5.114394528387108),
                                    ("at <time-of-day>intersect", -5.625220152153099),
                                    ("Rosh Hashanahyear (latent)", -6.030685260261263),
                                    ("Dhanterasyear (latent)", -6.030685260261263),
                                    ("Tu BiShvatyear (latent)", -6.030685260261263),
                                    ("Holiyear (latent)", -5.337538079701318),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.030685260261263),
                                    ("Holika Dahanyear (latent)", -5.337538079701318),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.030685260261263),
                                    ("dayminute", -3.391627930646005),
                                    ("Mawlidyear (latent)", -6.030685260261263),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.625220152153099),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.030685260261263),
                                    ("Jumu'atul-Widayear (latent)", -5.114394528387108),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.030685260261263),
                                    ("minuteday", -2.3930991005348776),
                                    ("absorption of , after named dayintersect",
                                     -6.030685260261263),
                                    ("intersectyear (latent)", -6.030685260261263),
                                    ("Orthodox Easter Sundayyear (latent)", -6.030685260261263),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.030685260261263),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.030685260261263),
                                    ("Mothering Sundayyear (latent)", -5.625220152153099),
                                    ("Boss's Dayyear (latent)", -5.625220152153099),
                                    ("Global Youth Service Dayyear (latent)", -6.030685260261263),
                                    ("Tisha B'Avyear (latent)", -6.030685260261263),
                                    ("Isra and Mi'rajyear (latent)", -5.114394528387108),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.030685260261263),
                                    ("Christmasyear (latent)", -5.625220152153099),
                                    ("Naraka Chaturdashiyear (latent)", -5.625220152153099),
                                    ("at <time-of-day>on <date>", -4.932072971593153),
                                    ...
                                    ("hh:mmin|during the <part-of-day>", -5.337538079701318),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.625220152153099),
                                    ("Hanukkahyear (latent)", -6.030685260261263),
                                    ("February<time> <part-of-day>", -6.030685260261263),
                                    ("Tuesdayin <named-month>|year", -6.030685260261263),
                                    ("Great Lentyear (latent)", -6.030685260261263),
                                    ("tomorrowat <time-of-day>", -5.337538079701318),
                                    ("between <time> and <time>on <date>", -4.421247347827163),
                                    ("last <cycle> of <time>year (latent)", -5.337538079701318),
                                    ("at <time-of-day>tomorrow", -5.625220152153099),
                                    ("tomorrow<time-of-day> am|pm", -6.030685260261263),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.030685260261263),
                                    ("Diwaliyear (latent)", -6.030685260261263),
                                    ("Black Fridayyear (latent)", -5.625220152153099),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.030685260261263),
                                    ("Chhathyear (latent)", -5.625220152153099),
                                    ("Vasant Panchamiyear (latent)", -6.030685260261263),
                                    ("Palm Sundayintersect", -6.030685260261263),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.030685260261263),
                                    ("August Bank Holidayyear (latent)", -5.337538079701318),
                                    ("Februaryintersect", -6.030685260261263),
                                    ("Simchat Torahyear (latent)", -6.030685260261263),
                                    ("minuteyear", -6.030685260261263)],
                               n = 309},
                   koData =
                     ClassData{prior = -0.9655820235910325, unseen = -6.38856140554563,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.777441406928545),
                                    ...
                                    ("daymonth", -3.5536659753064286),
                                    ("monthday", -5.288267030694535),
                                    ...
                                    ("week-endin <named-month>|year", -5.6937321388027),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.288267030694535),
                                    ("Sundayyear (latent)", -5.000584958242754),
                                    ("Christmasat <time-of-day>", -5.6937321388027),
                                    ("from|since|after <time>year (latent)", -4.440969170307332),
                                    ...
                                    ("in <named-month>|yearyear (latent)", -5.6937321388027),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.15097102690987857,
                               unseen = -4.941642422609305,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -4.412480490893794e-2),
                                    ("intersect 2 numbers", -3.548179572010801)],
                               n = 135},
                   koData =
                     ClassData{prior = -1.9652033519899923, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
