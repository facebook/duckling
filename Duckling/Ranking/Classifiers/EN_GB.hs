...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6368823419738074, unseen = -5.802118375377063,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 329},
                   koData =
                     ClassData{prior = -0.7527674837221121, unseen = -5.68697535633982,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45416021976100945, unseen = -6.79346613258001,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.0991972469108635),
                                    ("Father's Dayyear (latent)", -6.0991972469108635),
                                    ("Ramadanyear (latent)", -6.0991972469108635),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.846434278415496),
                                    ("Bhai Doojyear (latent)", -6.0991972469108635),
                                    ("hourday", -4.394449154672439),
                                    ("dayhour", -3.2369963659813954),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.846434278415496),
                                    ("Martin Luther King's Dayyear (latent)", -5.6937321388027),
                                    ("Shemini Atzeretyear (latent)", -6.0991972469108635),
                                    ("daymonth", -5.182906515036709),
                                    ("monthday", -5.6937321388027),
                                    ("monthyear", -4.307437777682809),
                                    ("yearhour", -5.6937321388027),
                                    ("Yom Ha'atzmautyear (latent)", -6.0991972469108635),
                                    ("Vijayadashamiyear (latent)", -6.0991972469108635),
                                    ("Thanksgiving Dayyear (latent)", -5.000584958242754),
                                    ("Thai Pongalyear (latent)", -5.406050066350919),
                                    ("Thiru Onamyear (latent)", -5.406050066350919),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.0991972469108635),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.0991972469108635),
                                    ("houryear", -5.406050066350919),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.0991972469108635),
                                    ("Christmas<time-of-day> am|pm", -6.0991972469108635),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.0991972469108635),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.406050066350919),
                                    ("<time-of-day> am|pmintersect", -4.846434278415496),
                                    ("Earth Houryear (latent)", -6.0991972469108635),
                                    ("Octoberyear (latent)", -4.59511985013459),
                                    ("intersect<time-of-day> am|pm", -6.0991972469108635),
                                    ("Mattu Pongalyear (latent)", -6.0991972469108635),
                                    ("Shavuotyear (latent)", -6.0991972469108635),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.0991972469108635),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.0991972469108635),
                                    ("in|within|after <duration>at <time-of-day>",
                                     -6.0991972469108635),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.6937321388027),
                                    ("Marchyear (latent)", -6.0991972469108635),
                                    ("Sukkotyear (latent)", -5.6937321388027),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.0991972469108635),
                                    ("Clean Mondayyear (latent)", -5.6937321388027),
                                    ("monthhour", -5.6937321388027),
                                    ("todayat <time-of-day>", -6.0991972469108635),
                                    ("Thursday<time> timezone", -4.153287097855551),
                                    ("from|since|after <time>December", -6.0991972469108635),
                                    ("dd/mm<time-of-day> am|pm", -6.0991972469108635),
                                    ("<time-of-day> am|pmon <day>", -4.084294226368599),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.0991972469108635),
                                    ("yyyy-mm-ddhh:mm:ss", -5.6937321388027),
                                    ("dayday", -4.084294226368599),
                                    ("dd/mmat <time-of-day>", -6.0991972469108635),
                                    ("<time> <part-of-day>at <time-of-day>", -6.0991972469108635),
                                    ("tonightat <time-of-day>", -6.0991972469108635),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.406050066350919),
                                    ("today<time-of-day> am|pm", -6.0991972469108635),
                                    ("Februarythe <day-of-month> (ordinal)", -5.6937321388027),
                                    ("at <time-of-day><time> <part-of-day>", -6.0991972469108635),
                                    ("hourhour", -4.846434278415496),
                                    ("Navaratriin|during <named-month>|year", -6.0991972469108635),
                                    ("Wednesdaythis|last|next <cycle>", -6.0991972469108635),
                                    ("Lentyear (latent)", -6.0991972469108635),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.59511985013459),
                                    ("Boghiyear (latent)", -6.0991972469108635),
                                    ("dayyear", -1.9801600720983918),
                                    ("Thursdayfrom|since|after <time>", -5.6937321388027),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.0991972469108635),
                                    ("Thursdayat <time-of-day>", -5.406050066350919),
                                    ("Islamic New Yearyear (latent)", -5.6937321388027),
                                    ("Laylat al-Qadryear (latent)", -5.182906515036709),
                                    ("Shrove Tuesdayyear (latent)", -6.0991972469108635),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.406050066350919),
                                    ("<time-of-day> am|pmtomorrow", -5.406050066350919),
                                    ("Yom Kippuryear (latent)", -6.0991972469108635),
                                    ("<part-of-day> of <time>year (latent)", -6.0991972469108635),
                                    ("minutehour", -5.182906515036709),
                                    ("Kaanum Pongalyear (latent)", -5.6937321388027),
                                    ("Maha Saptamiyear (latent)", -6.0991972469108635),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.6937321388027),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.394449154672439),
                                    ("for <duration> from <time>December", -6.0991972469108635),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.0991972469108635),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.846434278415496),
                                    ("Pentecostyear (latent)", -6.0991972469108635),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.846434278415496),
                                    ("Eid al-Fitryear (latent)", -6.0991972469108635),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.0991972469108635),
                                    ("Mondayin|during the <part-of-day>", -6.0991972469108635),
                                    ("Chhathin|during <named-month>|year", -6.0991972469108635),
                                    ("Diwaliin|during <named-month>|year", -6.0991972469108635),
                                    ("Vaisakhiin|during <named-month>|year", -6.0991972469108635),
                                    ("Raksha Bandhanyear (latent)", -6.0991972469108635),
                                    ("daysecond", -5.6937321388027),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.6937321388027),
                                    ("Ashurayear (latent)", -6.0991972469108635),
                                    ("Tuesdayin|during <named-month>|year", -6.0991972469108635),
                                    ("Chinese New Yearyear (latent)", -6.0991972469108635),
                                    ("Lag BaOmeryear (latent)", -6.0991972469108635),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.0991972469108635),
                                    ("Eid al-Adhayear (latent)", -5.182906515036709),
                                    ("intersectin|during the <part-of-day>", -6.0991972469108635),
                                    ("Palm Sundayyear (latent)", -6.0991972469108635),
                                    ("Christmasat <time-of-day>", -6.0991972469108635),
                                    ("Passoveryear (latent)", -6.0991972469108635),
                                    ("Lazarus Saturdayyear (latent)", -6.0991972469108635),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.0991972469108635),
                                    ("Yom HaShoahyear (latent)", -5.6937321388027),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.6937321388027),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.0991972469108635),
                                    ("Septemberyear (latent)", -5.6937321388027),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.59511985013459),
                                    ("Halloweenyear (latent)", -6.0991972469108635),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.0991972469108635),
                                    ("at <time-of-day>intersect", -5.6937321388027),
                                    ("Rosh Hashanahyear (latent)", -5.406050066350919),
                                    ("Dhanterasyear (latent)", -6.0991972469108635),
                                    ("Tu BiShvatyear (latent)", -6.0991972469108635),
                                    ("Holiyear (latent)", -5.406050066350919),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.0991972469108635),
                                    ("Holika Dahanyear (latent)", -5.406050066350919),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0991972469108635),
                                    ("dayminute", -3.181426514826585),
                                    ("Mawlidyear (latent)", -6.0991972469108635),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.6937321388027),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.0991972469108635),
                                    ("Jumu'atul-Widayear (latent)", -5.182906515036709),
                                    ("minuteday", -2.4616110871844783),
                                    ("absorption of , after named dayintersect",
                                     -6.0991972469108635),
                                    ("in|within|after <duration><time-of-day> am|pm",
                                     -6.0991972469108635),
                                    ("Orthodox Easter Sundayyear (latent)", -6.0991972469108635),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.0991972469108635),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.0991972469108635),
                                    ("Mothering Sundayyear (latent)", -5.6937321388027),
                                    ("Boss's Dayyear (latent)", -5.6937321388027),
                                    ("Global Youth Service Dayyear (latent)", -6.0991972469108635),
                                    ("Dhanterasin|during <named-month>|year", -6.0991972469108635),
                                    ("Tisha B'Avyear (latent)", -6.0991972469108635),
                                    ("Isra and Mi'rajyear (latent)", -5.182906515036709),
                                    ("at <time-of-day>on <day>", -5.000584958242754),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.0991972469108635),
                                    ("Christmasyear (latent)", -5.6937321388027),
                                    ("Naraka Chaturdashiyear (latent)", -5.6937321388027),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.0991972469108635),
                                    ("dayweek", -6.0991972469108635),
                                    ("Easter Sundayyear (latent)", -5.406050066350919),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.489759334476764),
                                    ("weekyear", -5.000584958242754),
                                    ("hh:mmin|during the <part-of-day>", -5.406050066350919),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.6937321388027),
                                    ("Hanukkahyear (latent)", -5.406050066350919),
                                    ("February<time> <part-of-day>", -6.0991972469108635),
                                    ("Great Lentyear (latent)", -6.0991972469108635),
                                    ("tomorrowat <time-of-day>", -5.406050066350919),
                                    ("Vaisakhiyear (latent)", -5.406050066350919),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.0991972469108635),
                                    ("last <cycle> of <time>year (latent)", -5.406050066350919),
                                    ("at <time-of-day>tomorrow", -5.6937321388027),
                                    ("tomorrow<time-of-day> am|pm", -6.0991972469108635),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.0991972469108635),
                                    ("Diwaliyear (latent)", -6.0991972469108635),
                                    ("between <time> and <time>on <day>", -4.489759334476764),
                                    ("Black Fridayyear (latent)", -5.6937321388027),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.0991972469108635),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.0991972469108635),
                                    ("Chhathyear (latent)", -5.6937321388027),
                                    ("Vasant Panchamiyear (latent)", -6.0991972469108635),
                                    ("St Patrick's Dayyear (latent)", -6.0991972469108635),
                                    ("Thursday<time> (timezone)", -6.0991972469108635),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.0991972469108635),
                                    ("August Bank Holidayyear (latent)", -5.406050066350919),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.6937321388027),
                                    ("Februaryintersect", -6.0991972469108635),
                                    ("Simchat Torahyear (latent)", -6.0991972469108635),
                                    ("minuteyear", -6.0991972469108635)],
                               n = 334},
                   koData =
                     ClassData{prior = -1.0078058407099282, unseen = -6.410174881966167,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.799090878625398),
                                    ("dayhour", -3.041232961073024),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.799090878625398),
                                    ("Tuesdayfrom|since|after <time>", -5.715381610499553),
                                    ("daymonth", -3.7004785899572883),
                                    ("monthyear", -4.462618642004185),
                                    ("yearhour", -5.715381610499553),
                                    ("<time-of-day> am|pmyear (latent)", -5.022234429939608),
                                    ("Thai Pongalyear (latent)", -5.022234429939608),
                                    ("intersecthh:mm", -5.715381610499553),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.715381610499553),
                                    ("houryear", -4.616769321831443),
                                    ...
                                    ("until <time>on <day>", -5.022234429939608),
                                    ("in|within|after <duration>at <time-of-day>",
                                     -5.715381610499553),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.022234429939608),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.715381610499553),
                                    ("hh:mmon <day>", -3.7004785899572883),
                                    ...
                                    ("Bank Holidayyear (latent)", -5.022234429939608),
                                    ("from|since|after <time>December", -5.715381610499553),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.715381610499553),
                                    ("<time-of-day> am|pmon <day>", -4.462618642004185),
                                    ("Mondayyear (latent)", -5.022234429939608),
                                    ("dayday", -5.309916502391388),
                                    ("dd/mmat <time-of-day>", -5.309916502391388),
                                    ("on <day>September", -5.309916502391388),
                                    ("Thursdaydd/mm", -5.715381610499553),
                                    ("dayyear", -2.744967144929852),
                                    ("New Year's Dayyear (latent)", -5.309916502391388),
                                    ("Thursdayfrom|since|after <time>", -4.010633518261128),
                                    ("Thursdayat <time-of-day>", -4.1059436980654525),
                                    ...
                                    ("week-endin|during <named-month>|year", -5.715381610499553),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.715381610499553),
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.309916502391388),
                                    ("Sundayyear (latent)", -4.799090878625398),
                                    ("Christmasat <time-of-day>", -5.715381610499553),
                                    ("from|since|after <time>year (latent)", -4.616769321831443),
                                    ("dd/mmyear (latent)", -5.715381610499553),
                                    ...
                                    ("hh:mmyear (latent)", -4.462618642004185),
                                    ("Holiyear (latent)", -5.715381610499553),
                                    ("until <time><time-of-day> am|pm", -5.715381610499553),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.715381610499553),
                                    ("dayminute", -3.150432253038016),
                                    ("yyyy-mm-ddhh:mm", -5.309916502391388),
