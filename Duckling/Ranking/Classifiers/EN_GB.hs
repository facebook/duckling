...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6086233670421173,
                               unseen = -6.0867747269123065,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 438},
                   koData =
                     ClassData{prior = -0.7854804293639931, unseen = -5.910796644040527,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4783381310465832, unseen = -7.102499355774649,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.408528791059498),
                                    ("Father's Dayyear (latent)", -6.408528791059498),
                                    ("Karva Chauthyear (latent)", -6.408528791059498),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.408528791059498),
                                    ("Maha Shivaratriyear (latent)", -6.408528791059498),
                                    ("Ramadanyear (latent)", -5.492238059185343),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.022234429939608),
                                    ("Bhai Doojyear (latent)", -6.408528791059498),
                                    ("hourday", -4.393625770517233),
                                    ("dayhour", -3.4640898118930576),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.022234429939608),
                                    ("Martin Luther King's Dayyear (latent)", -6.003063682951334),
                                    ("Shemini Atzeretyear (latent)", -6.408528791059498),
                                    ("daymonth", -4.393625770517233),
                                    ("monthday", -6.003063682951334),
                                    ("monthyear", -4.616769321831443),
                                    ("Yom Ha'atzmautyear (latent)", -6.408528791059498),
                                    ("Vijayadashamiyear (latent)", -6.408528791059498),
                                    ("Thanksgiving Dayyear (latent)", -5.309916502391388),
                                    ("Thai Pongalyear (latent)", -5.715381610499553),
                                    ("Thiru Onamyear (latent)", -5.715381610499553),
                                    ("hhhmmabsorption of , after named day", -6.408528791059498),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.408528791059498),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.492238059185343),
                                    ("<day-of-month> (ordinal)Wednesday", -6.408528791059498),
                                    ("Krishna Janmashtamiyear (latent)", -6.003063682951334),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.408528791059498),
                                    ("houryear", -5.492238059185343),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.408528791059498),
                                    ("Christmas<time-of-day> am|pm", -6.408528791059498),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.408528791059498),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.715381610499553),
                                    ("intersectin|during <named-month>|year", -6.408528791059498),
                                    ("<time-of-day> am|pmintersect", -5.15576582256413),
                                    ("Earth Houryear (latent)", -6.408528791059498),
                                    ("Octoberyear (latent)", -4.904451394283225),
                                    ("intersect<time-of-day> am|pm", -6.408528791059498),
                                    ("Mattu Pongalyear (latent)", -6.408528791059498),
                                    ("Shavuotyear (latent)", -6.408528791059498),
                                    ("Parsi New Yearyear (latent)", -5.492238059185343),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.408528791059498),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.408528791059498),
                                    ("todayin|within|after <duration>", -6.408528791059498),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.003063682951334),
                                    ("Marchyear (latent)", -6.408528791059498),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.003063682951334),
                                    ("Sukkotyear (latent)", -6.003063682951334),
                                    ("hhhmmintersect", -6.003063682951334),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.003063682951334),
                                    ("Clean Mondayyear (latent)", -6.003063682951334),
                                    ("monthhour", -6.003063682951334),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.715381610499553),
                                    ("todayat <time-of-day>", -6.408528791059498),
                                    ("Thursday<time> timezone", -4.010633518261128),
                                    ("time-of-day (latent)tonight", -6.003063682951334),
                                    ("from|since|after <time>December", -6.408528791059498),
                                    ("dd/mm<time-of-day> am|pm", -6.408528791059498),
                                    ("<time-of-day> am|pmon <day>", -4.393625770517233),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.408528791059498),
                                    ("yyyy-mm-ddhh:mm:ss", -6.003063682951334),
                                    ("dayday", -3.7004785899572883),
                                    ("dd/mmat <time-of-day>", -6.408528791059498),
                                    ("<time> <part-of-day>at <time-of-day>", -6.408528791059498),
                                    ("tonightat <time-of-day>", -6.408528791059498),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.715381610499553),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.408528791059498),
                                    ("today<time-of-day> am|pm", -6.408528791059498),
                                    ("Februarythe <day-of-month> (ordinal)", -6.003063682951334),
                                    ("at <time-of-day><time> <part-of-day>", -6.408528791059498),
                                    ("<day-of-month> (ordinal)intersect", -6.003063682951334),
                                    ("hourhour", -4.329087249379662),
                                    ("Mahavir Jayantiyear (latent)", -6.003063682951334),
                                    ("Navaratriin|during <named-month>|year", -6.408528791059498),
                                    ("Wednesdaythis|last|next <cycle>", -6.408528791059498),
                                    ("Lentyear (latent)", -6.408528791059498),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.536726614157907),
                                    ("Boghiyear (latent)", -6.408528791059498),
                                    ("dayyear", -1.8976692845426484),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.408528791059498),
                                    ("Thursdayfrom|since|after <time>", -6.003063682951334),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.408528791059498),
                                    ("Thursdayat <time-of-day>", -5.715381610499553),
                                    ("Islamic New Yearyear (latent)", -6.003063682951334),
                                    ("Laylat al-Qadryear (latent)", -5.492238059185343),
                                    ("Shrove Tuesdayyear (latent)", -6.408528791059498),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.715381610499553),
                                    ("<time-of-day> am|pmtomorrow", -5.715381610499553),
                                    ("Yom Kippuryear (latent)", -6.408528791059498),
                                    ("<day-of-month> (ordinal)Tuesday", -6.003063682951334),
                                    ("<part-of-day> of <time>year (latent)", -6.408528791059498),
                                    ("minutehour", -5.15576582256413),
                                    ("Kaanum Pongalyear (latent)", -6.003063682951334),
                                    ("Maha Saptamiyear (latent)", -6.408528791059498),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.003063682951334),
                                    ("time-of-day (latent)tomorrow", -5.492238059185343),
                                    ("part of daysat <time-of-day>", -6.003063682951334),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.393625770517233),
                                    ("for <duration> from <time>December", -6.408528791059498),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.408528791059498),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.15576582256413),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.15576582256413),
                                    ("time-of-day (latent)this <part-of-day>", -6.408528791059498),
                                    ("Pentecostyear (latent)", -6.408528791059498),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.15576582256413),
                                    ("<day-of-month> (ordinal)February", -6.408528791059498),
                                    ("Eid al-Fitryear (latent)", -5.492238059185343),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.408528791059498),
                                    ("Mondayin|during the <part-of-day>", -6.408528791059498),
                                    ("Chhathin|during <named-month>|year", -6.408528791059498),
                                    ("Diwaliin|during <named-month>|year", -6.408528791059498),
                                    ("Vaisakhiin|during <named-month>|year", -6.408528791059498),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.15576582256413),
                                    ("Raksha Bandhanyear (latent)", -6.408528791059498),
                                    ("daysecond", -6.003063682951334),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.003063682951334),
                                    ("Ashurayear (latent)", -6.408528791059498),
                                    ("Tuesdayin|during <named-month>|year", -6.408528791059498),
                                    ("Chinese New Yearyear (latent)", -6.408528791059498),
                                    ("tomorrowintersect", -6.408528791059498),
                                    ("Lag BaOmeryear (latent)", -6.408528791059498),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.408528791059498),
                                    ("Eid al-Adhayear (latent)", -4.268462627563228),
                                    ("intersectin|during the <part-of-day>", -6.408528791059498),
                                    ("Palm Sundayyear (latent)", -6.408528791059498),
                                    ("Christmasat <time-of-day>", -6.408528791059498),
                                    ("Passoveryear (latent)", -6.408528791059498),
                                    ("Lazarus Saturdayyear (latent)", -6.408528791059498),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.408528791059498),
                                    ("hhhmmon <day>", -5.492238059185343),
                                    ("Yom HaShoahyear (latent)", -6.003063682951334),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.003063682951334),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.408528791059498),
                                    ("Septemberyear (latent)", -6.003063682951334),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.904451394283225),
                                    ("Halloweenyear (latent)", -6.408528791059498),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.408528791059498),
                                    ("at <time-of-day>intersect", -5.492238059185343),
                                    ("Rosh Hashanahyear (latent)", -5.715381610499553),
                                    ("Dhanterasyear (latent)", -6.408528791059498),
                                    ("Tu BiShvatyear (latent)", -6.408528791059498),
                                    ("<day-of-month> (ordinal)December", -5.715381610499553),
                                    ("Holiyear (latent)", -5.715381610499553),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.408528791059498),
                                    ("Holika Dahanyear (latent)", -5.715381610499553),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.003063682951334),
                                    ("dayminute", -3.0586247037848935),
                                    ("Mawlidyear (latent)", -6.408528791059498),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.003063682951334),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.408528791059498),
                                    ("Jumu'atul-Widayear (latent)", -5.492238059185343),
                                    ("minuteday", -2.67085917277613),
                                    ("absorption of , after named dayintersect",
                                     -5.715381610499553),
                                    ("intersectyear (latent)", -6.408528791059498),
                                    ("Orthodox Easter Sundayyear (latent)", -6.408528791059498),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.408528791059498),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.408528791059498),
                                    ("intersecthhhmm", -6.003063682951334),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.408528791059498),
                                    ("Mothering Sundayyear (latent)", -6.003063682951334),
                                    ("Boss's Dayyear (latent)", -6.003063682951334),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.408528791059498),
                                    ("Global Youth Service Dayyear (latent)", -6.408528791059498),
                                    ("Dhanterasin|during <named-month>|year", -6.408528791059498),
                                    ("Tisha B'Avyear (latent)", -6.408528791059498),
                                    ("Isra and Mi'rajyear (latent)", -5.492238059185343),
                                    ("at <time-of-day>on <day>", -4.799090878625398),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.003063682951334),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.715381610499553),
                                    ("Christmasyear (latent)", -6.003063682951334),
                                    ("Naraka Chaturdashiyear (latent)", -6.003063682951334),
                                    ("Thai Pongalin|during <named-month>|year", -6.408528791059498),
                                    ("dayweek", -6.408528791059498),
                                    ("Easter Sundayyear (latent)", -5.715381610499553),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.003063682951334),
                                    ("weekyear", -5.309916502391388),
                                    ("King's Dayyear (latent)", -4.904451394283225),
                                    ("hh:mmin|during the <part-of-day>", -5.492238059185343),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.003063682951334),
                                    ("Hanukkahyear (latent)", -5.715381610499553),
                                    ("February<time> <part-of-day>", -6.408528791059498),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.408528791059498),
                                    ("Great Lentyear (latent)", -6.408528791059498),
                                    ("tomorrowat <time-of-day>", -5.715381610499553),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.408528791059498),
                                    ("Vaisakhiyear (latent)", -5.715381610499553),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.715381610499553),
                                    ("last <cycle> of <time>year (latent)", -5.715381610499553),
                                    ("at <time-of-day>tomorrow", -6.003063682951334),
                                    ("tomorrow<time-of-day> am|pm", -6.408528791059498),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.408528791059498),
                                    ("Diwaliyear (latent)", -6.408528791059498),
                                    ("between <time> and <time>on <day>", -6.003063682951334),
                                    ("Black Fridayyear (latent)", -6.003063682951334),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.408528791059498),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.408528791059498),
                                    ("Chhathyear (latent)", -6.003063682951334),
                                    ("Vasant Panchamiyear (latent)", -6.408528791059498),
                                    ("Rabindra Jayantiyear (latent)", -5.15576582256413),
                                    ("St Patrick's Dayyear (latent)", -6.408528791059498),
                                    ("Thursday<time> (timezone)", -6.408528791059498),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.408528791059498),
                                    ("Pargat Diwasyear (latent)", -5.15576582256413),
                                    ("August Bank Holidayyear (latent)", -5.715381610499553),
                                    ("<datetime> - <datetime> (interval)July", -6.003063682951334),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.715381610499553),
                                    ("Februaryintersect", -6.408528791059498),
                                    ("Simchat Torahyear (latent)", -6.408528791059498),
                                    ("minuteyear", -6.408528791059498)],
                               n = 463},
                   koData =
                     ClassData{prior = -0.9670909469716112, unseen = -6.75343791859778,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.555045798805523),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.653658087473633),
                                    ("hourday", -3.6612279227834263),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.059123195581797),
                                    ("<day-of-month> (ordinal)August", -6.059123195581797),
                                    ("dayhour", -3.3849745461552683),
                                    ("<time> timezoneyear (latent)", -5.365976015021851),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.1428324637076415),
                                    ("Tuesdayfrom|since|after <time>", -5.365976015021851),
                                    ("daymonth", -3.3849745461552683),
                                    ("monthyear", -4.8063602270864285),
                                    ("<time-of-day> am|pmyear (latent)", -5.365976015021851),
                                    ("Thai Pongalyear (latent)", -5.365976015021851),
                                    ("intersecthh:mm", -6.059123195581797),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.653658087473633),
                                    ("<day-of-month> (ordinal)Wednesday", -6.059123195581797),
                                    ("houryear", -4.672828834461907),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.059123195581797),
                                    ("<day-of-month> (ordinal)October", -6.059123195581797),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.365976015021851),
                                    ("hournograin", -4.8063602270864285),
                                    ("<time-of-day> am|pmintersect", -4.8063602270864285),
                                    ("Octoberyear (latent)", -6.059123195581797),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.653658087473633),
                                    ("until <time>on <day>", -5.365976015021851),
                                    ("time-of-day (latent)intersect", -5.365976015021851),
                                    ("todayin <number> (implicit minutes)", -6.059123195581797),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.365976015021851),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.059123195581797),
                                    ("hh:mmon <day>", -4.8063602270864285),
                                    ("hhhmmintersect", -5.653658087473633),
                                    ("absorption of , after named dayJuly", -5.1428324637076415),
                                    ("from|since|after <time>July", -5.653658087473633),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.1428324637076415),
                                    ("Clean Mondayyear (latent)", -6.059123195581797),
                                    ("monthhour", -6.059123195581797),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.653658087473633),
                                    ("hourmonth", -4.187321018680206),
                                    ("todayat <time-of-day>", -6.059123195581797),
                                    ("Bank Holidayyear (latent)", -5.365976015021851),
                                    ("hhhmmyear (latent)", -4.8063602270864285),
                                    ("from|since|after <time>December", -6.059123195581797),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.059123195581797),
                                    ("<time-of-day> am|pmon <day>", -4.8063602270864285),
                                    ("Mondayyear (latent)", -5.365976015021851),
                                    ("dayday", -4.672828834461907),
                                    ("dd/mmat <time-of-day>", -5.653658087473633),
                                    ("on <day>September", -5.365976015021851),
                                    ("time-of-day (latent)September", -5.653658087473633),
                                    ("hourhour", -4.9605109069136875),
                                    ("time-of-day (latent)on <day>", -4.555045798805523),
                                    ("Thursdaydd/mm", -6.059123195581797),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.653658087473633),
                                    ("dayyear", -3.0386983094374345),
                                    ("New Year's Dayyear (latent)", -5.1428324637076415),
                                    ("time-of-day (latent)Sunday", -5.653658087473633),
                                    ("Thursdayfrom|since|after <time>", -4.354375103343371),
                                    ("Thursdayat <time-of-day>", -4.449685283147696),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.059123195581797),
                                    ("Aprilyear (latent)", -6.059123195581797),
                                    ("the <day-of-month> (ordinal)July", -6.059123195581797),
                                    ("the <day-of-month> (number)July", -6.059123195581797),
                                    ("monthminute", -6.059123195581797),
                                    ("hourminute", -5.365976015021851),
                                    ("<time-of-day> am|pmtomorrow", -6.059123195581797),
                                    ("Thursdayhh:mm", -5.1428324637076415),
                                    ("<day-of-month> (ordinal)Tuesday", -5.653658087473633),
                                    ("minutemonth", -3.9190570320855262),
                                    ("time-of-day (latent)Friday", -5.653658087473633),
                                    ("minutehour", -6.059123195581797),
                                    ("Augustyear (latent)", -5.653658087473633),
                                    ("week-endin|during <named-month>|year", -6.059123195581797),
                                    ("time-of-day (latent)Tuesday", -5.653658087473633),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.059123195581797),
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.653658087473633),
                                    ("Sundayyear (latent)", -5.1428324637076415),
                                    ("Christmasat <time-of-day>", -6.059123195581797),
                                    ("from|since|after <time>year (latent)", -4.9605109069136875),
                                    ("dd/mmyear (latent)", -6.059123195581797),
                                    ("hhhmmon <day>", -5.1428324637076415),
                                    ("yesterday<time-of-day> am|pm", -6.059123195581797),
                                    ("<day-of-month> (ordinal)July", -5.365976015021851),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.059123195581797),
                                    ("at <time-of-day>intersect", -5.1428324637076415),
                                    ("hh:mmyear (latent)", -4.672828834461907),
                                    ("Holiyear (latent)", -6.059123195581797),
                                    ("until <time><time-of-day> am|pm", -6.059123195581797),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.653658087473633),
                                    ("dayminute", -3.1969223146523285),
                                    ("yyyy-mm-ddhh:mm", -5.653658087473633),
                                    ("intersectfrom|since|after <time>", -5.653658087473633),
                                    ("intersectSeptember", -4.187321018680206),
                                    ("minuteday", -2.9021227744316835),
                                    ("absorption of , after named dayintersect",
                                     -6.059123195581797),
                                    ("intersectyear (latent)", -6.059123195581797),
                                    ("Februaryin|during the <part-of-day>", -6.059123195581797),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.059123195581797),
                                    ("time-of-day (latent)July", -5.365976015021851),
                                    ("Saturdayyear (latent)", -6.059123195581797),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.059123195581797),
                                    ("at <time-of-day>on <day>", -5.1428324637076415),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.059123195581797),
                                    ("absorption of , after named daySeptember",
                                     -4.8063602270864285),
                                    ("Naraka Chaturdashiyear (latent)", -6.059123195581797),
                                    ("from|since|after <time>on <day>", -5.1428324637076415),
                                    ("dayweek", -6.059123195581797),
                                    ("Easter Sundayyear (latent)", -5.653658087473633),
                                    ("time-of-day (latent)at <time-of-day>", -5.365976015021851),
                                    ("Thursday<time-of-day> am|pm", -4.8063602270864285),
                                    ("weekyear", -5.653658087473633),
                                    ("time-of-day (latent)Thursday", -5.653658087473633),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.059123195581797),
                                    ("<day-of-month> (ordinal)April", -6.059123195581797),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.653658087473633),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.365976015021851),
                                    ("Sundayfrom|since|after <time>", -6.059123195581797),
                                    ...
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.059123195581797),
                                    ("tomorrowat <time-of-day>", -6.059123195581797),
                                    ("daynograin", -5.653658087473633),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.653658087473633),
                                    ("last <cycle> of <time>year (latent)", -5.653658087473633),
                                    ("tomorrow<time-of-day> am|pm", -6.059123195581797),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.365976015021851),
                                    ("Diwaliyear (latent)", -5.653658087473633),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.059123195581797),
                                    ("Fridayyear (latent)", -5.653658087473633),
                                    ("time-of-day (latent)April", -6.059123195581797),
                                    ("minuteyear", -3.8618986182455775)],
                               n = 284}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
