...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47049757837901895,
                               unseen = -7.183870715062453,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.489964521183336),
                                    ("Father's Dayyear (latent)", -6.489964521183336),
                                    ("Karva Chauthyear (latent)", -6.489964521183336),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.489964521183336),
                                    ("Maha Shivaratriyear (latent)", -6.489964521183336),
                                    ("Ramadanyear (latent)", -5.237201552687968),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.103670160063445),
                                    ("Bhai Doojyear (latent)", -6.489964521183336),
                                    ("hourday", -4.475061500641071),
                                    ("dayhour", -3.469539635038973),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.103670160063445),
                                    ("Martin Luther King's Dayyear (latent)", -6.0844994130751715),
                                    ("Shemini Atzeretyear (latent)", -6.489964521183336),
                                    ("daymonth", -4.475061500641071),
                                    ("monthday", -6.0844994130751715),
                                    ("monthyear", -4.698205051955281),
                                    ("Yom Ha'atzmautyear (latent)", -6.489964521183336),
                                    ("Vijayadashamiyear (latent)", -6.489964521183336),
                                    ("Thanksgiving Dayyear (latent)", -5.391352232515226),
                                    ("Thai Pongalyear (latent)", -5.796817340623391),
                                    ("Thiru Onamyear (latent)", -5.796817340623391),
                                    ("hhhmmabsorption of , after named day", -6.489964521183336),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.489964521183336),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.573673789309181),
                                    ("<day-of-month> (ordinal)Wednesday", -6.489964521183336),
                                    ("Krishna Janmashtamiyear (latent)", -6.0844994130751715),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.489964521183336),
                                    ("houryear", -5.573673789309181),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.489964521183336),
                                    ("Christmas<time-of-day> am|pm", -6.489964521183336),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.489964521183336),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.796817340623391),
                                    ("intersectin|during <named-month>|year", -6.489964521183336),
                                    ("<time-of-day> am|pmintersect", -5.237201552687968),
                                    ("Earth Houryear (latent)", -6.489964521183336),
                                    ("Ganesh Chaturthiyear (latent)", -6.489964521183336),
                                    ("Octoberyear (latent)", -4.9858871244070615),
                                    ("intersect<time-of-day> am|pm", -6.489964521183336),
                                    ("Mattu Pongalyear (latent)", -6.489964521183336),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.489964521183336),
                                    ("Shavuotyear (latent)", -6.489964521183336),
                                    ("Parsi New Yearyear (latent)", -5.573673789309181),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.489964521183336),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.489964521183336),
                                    ("todayin|within|after <duration>", -6.489964521183336),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.0844994130751715),
                                    ("Marchyear (latent)", -6.489964521183336),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.0844994130751715),
                                    ("Sukkotyear (latent)", -6.0844994130751715),
                                    ("hhhmmintersect", -6.0844994130751715),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.0844994130751715),
                                    ("Clean Mondayyear (latent)", -6.0844994130751715),
                                    ("monthhour", -6.0844994130751715),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.796817340623391),
                                    ("todayat <time-of-day>", -6.489964521183336),
                                    ("Thursday<time> timezone", -4.092069248384965),
                                    ("tonight<time-of-day> am|pm", -6.489964521183336),
                                    ("time-of-day (latent)tonight", -6.0844994130751715),
                                    ("from|since|after <time>December", -6.489964521183336),
                                    ("dd/mm<time-of-day> am|pm", -6.489964521183336),
                                    ("<time-of-day> am|pmon <day>", -4.475061500641071),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.489964521183336),
                                    ("yyyy-mm-ddhh:mm:ss", -6.0844994130751715),
                                    ("dayday", -3.7819143200811256),
                                    ("dd/mmat <time-of-day>", -6.489964521183336),
                                    ("<time> <part-of-day>at <time-of-day>", -6.0844994130751715),
                                    ("tonightat <time-of-day>", -5.391352232515226),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.796817340623391),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.489964521183336),
                                    ("today<time-of-day> am|pm", -6.489964521183336),
                                    ("Februarythe <day-of-month> (ordinal)", -6.0844994130751715),
                                    ("at <time-of-day><time> <part-of-day>", -6.489964521183336),
                                    ("<day-of-month> (ordinal)intersect", -6.0844994130751715),
                                    ("hourhour", -3.5195500556136348),
                                    ("Mahavir Jayantiyear (latent)", -6.0844994130751715),
                                    ("Navaratriin|during <named-month>|year", -6.489964521183336),
                                    ("Wednesdaythis|last|next <cycle>", -6.489964521183336),
                                    ("Lentyear (latent)", -6.489964521183336),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.618162344281744),
                                    ("Boghiyear (latent)", -6.489964521183336),
                                    ("dayyear", -1.8999079730052926),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.489964521183336),
                                    ("Thursdayfrom|since|after <time>", -6.0844994130751715),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.489964521183336),
                                    ("Thursdayat <time-of-day>", -5.796817340623391),
                                    ("Islamic New Yearyear (latent)", -6.0844994130751715),
                                    ("Laylat al-Qadryear (latent)", -5.573673789309181),
                                    ("part of days<time-of-day> am|pm", -6.489964521183336),
                                    ("Shrove Tuesdayyear (latent)", -6.489964521183336),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.796817340623391),
                                    ("hourminute", -6.0844994130751715),
                                    ("<time-of-day> am|pmtomorrow", -5.796817340623391),
                                    ("Yom Kippuryear (latent)", -6.489964521183336),
                                    ("<day-of-month> (ordinal)Tuesday", -6.0844994130751715),
                                    ("<part-of-day> of <time>year (latent)", -6.489964521183336),
                                    ("minutehour", -5.237201552687968),
                                    ("Kaanum Pongalyear (latent)", -6.0844994130751715),
                                    ("Maha Saptamiyear (latent)", -6.489964521183336),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.796817340623391),
                                    ("time-of-day (latent)tomorrow", -5.573673789309181),
                                    ("part of daysat <time-of-day>", -4.880526608749236),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.475061500641071),
                                    ("for <duration> from <time>December", -6.489964521183336),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.489964521183336),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.237201552687968),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.237201552687968),
                                    ("time-of-day (latent)this <part-of-day>", -6.489964521183336),
                                    ("Pentecostyear (latent)", -6.489964521183336),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.237201552687968),
                                    ("<day-of-month> (ordinal)February", -6.489964521183336),
                                    ("Eid al-Fitryear (latent)", -5.103670160063445),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.489964521183336),
                                    ("Mondayin|during the <part-of-day>", -6.489964521183336),
                                    ("Chhathin|during <named-month>|year", -6.489964521183336),
                                    ("Diwaliin|during <named-month>|year", -6.489964521183336),
                                    ("this <part-of-day><time-of-day> am|pm", -6.489964521183336),
                                    ("Vaisakhiin|during <named-month>|year", -6.489964521183336),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.237201552687968),
                                    ("Raksha Bandhanyear (latent)", -6.489964521183336),
                                    ("daysecond", -6.0844994130751715),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.0844994130751715),
                                    ("Ratha-Yatrayear (latent)", -6.489964521183336),
                                    ("Ashurayear (latent)", -6.489964521183336),
                                    ("Tuesdayin|during <named-month>|year", -6.489964521183336),
                                    ("Chinese New Yearyear (latent)", -6.489964521183336),
                                    ("tomorrowintersect", -6.489964521183336),
                                    ("Lag BaOmeryear (latent)", -6.489964521183336),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.489964521183336),
                                    ("Eid al-Adhayear (latent)", -4.349898357687065),
                                    ("intersectin|during the <part-of-day>", -6.489964521183336),
                                    ("Palm Sundayyear (latent)", -6.489964521183336),
                                    ("Christmasat <time-of-day>", -6.489964521183336),
                                    ("Passoveryear (latent)", -6.489964521183336),
                                    ("Lazarus Saturdayyear (latent)", -6.489964521183336),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.489964521183336),
                                    ("hhhmmon <day>", -5.573673789309181),
                                    ("Yom HaShoahyear (latent)", -6.0844994130751715),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.0844994130751715),
                                    ("Septemberyear (latent)", -6.0844994130751715),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.9858871244070615),
                                    ("Halloweenyear (latent)", -6.489964521183336),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.489964521183336),
                                    ("at <time-of-day>intersect", -5.573673789309181),
                                    ("Rosh Hashanahyear (latent)", -5.796817340623391),
                                    ("Dhanterasyear (latent)", -6.489964521183336),
                                    ("Tu BiShvatyear (latent)", -6.489964521183336),
                                    ("<day-of-month> (ordinal)December", -5.796817340623391),
                                    ("Holiyear (latent)", -5.796817340623391),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.489964521183336),
                                    ("Holika Dahanyear (latent)", -5.796817340623391),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0844994130751715),
                                    ("dayminute", -3.140060433908731),
                                    ("Mawlidyear (latent)", -6.489964521183336),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.0844994130751715),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.489964521183336),
                                    ("Jumu'atul-Widayear (latent)", -5.573673789309181),
                                    ("minuteday", -2.7522949028999673),
                                    ("absorption of , after named dayintersect",
                                     -5.796817340623391),
                                    ("intersectyear (latent)", -6.489964521183336),
                                    ("Orthodox Easter Sundayyear (latent)", -6.489964521183336),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.489964521183336),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.489964521183336),
                                    ("intersecthhhmm", -6.0844994130751715),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.489964521183336),
                                    ("Mothering Sundayyear (latent)", -6.0844994130751715),
                                    ("Boss's Dayyear (latent)", -6.0844994130751715),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.489964521183336),
                                    ("Global Youth Service Dayyear (latent)", -6.489964521183336),
                                    ("Dhanterasin|during <named-month>|year", -6.489964521183336),
                                    ("tonight<time-of-day> o'clock", -6.489964521183336),
                                    ("Tisha B'Avyear (latent)", -6.489964521183336),
                                    ("Isra and Mi'rajyear (latent)", -5.573673789309181),
                                    ("at <time-of-day>on <day>", -4.880526608749236),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.0844994130751715),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.796817340623391),
                                    ("Christmasyear (latent)", -6.0844994130751715),
                                    ("Saturdayintersect", -6.489964521183336),
                                    ("Naraka Chaturdashiyear (latent)", -6.0844994130751715),
                                    ("Thai Pongalin|during <named-month>|year", -6.489964521183336),
                                    ("dayweek", -6.489964521183336),
                                    ("Easter Sundayyear (latent)", -5.796817340623391),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.0844994130751715),
                                    ("weekyear", -5.391352232515226),
                                    ("King's Dayyear (latent)", -4.9858871244070615),
                                    ("hh:mmin|during the <part-of-day>", -5.573673789309181),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.0844994130751715),
                                    ("Hanukkahyear (latent)", -5.796817340623391),
                                    ("Rama Navamiyear (latent)", -6.489964521183336),
                                    ("February<time> <part-of-day>", -6.489964521183336),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.796817340623391),
                                    ("Great Lentyear (latent)", -6.489964521183336),
                                    ("tomorrowat <time-of-day>", -5.796817340623391),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.489964521183336),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.0844994130751715),
                                    ("Ugadiyear (latent)", -5.103670160063445),
                                    ("Vaisakhiyear (latent)", -5.796817340623391),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.796817340623391),
                                    ("last <cycle> of <time>year (latent)", -5.796817340623391),
                                    ("at <time-of-day>tomorrow", -6.0844994130751715),
                                    ("tomorrow<time-of-day> am|pm", -6.489964521183336),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.489964521183336),
                                    ("Diwaliyear (latent)", -6.489964521183336),
                                    ("between <time> and <time>on <day>", -6.0844994130751715),
                                    ("Black Fridayyear (latent)", -6.0844994130751715),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.489964521183336),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.489964521183336),
                                    ("Chhathyear (latent)", -6.0844994130751715),
                                    ("Vasant Panchamiyear (latent)", -6.489964521183336),
                                    ("Rabindra Jayantiyear (latent)", -5.237201552687968),
                                    ("this <part-of-day>at <time-of-day>", -5.237201552687968),
                                    ("St Patrick's Dayyear (latent)", -6.489964521183336),
                                    ("Thursday<time> (timezone)", -6.489964521183336),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.489964521183336),
                                    ("Pargat Diwasyear (latent)", -5.237201552687968),
                                    ("August Bank Holidayyear (latent)", -5.796817340623391),
                                    ("<datetime> - <datetime> (interval)July", -6.0844994130751715),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.796817340623391),
                                    ("Februaryintersect", -6.489964521183336),
                                    ("Simchat Torahyear (latent)", -6.489964521183336),
                                    ("minuteyear", -6.489964521183336)],
                               n = 506},
                   koData =
                     ClassData{prior = -0.9800065462602627, unseen = -6.81783057145415,
                               likelihoods =
                                 HashMap.fromList
