...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6367387855056243, unseen = -5.976350909297934,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 392},
                   koData =
                     ClassData{prior = -0.7529287030936597, unseen = -5.860786223465865,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4867621838343555, unseen = -7.023758954738443,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.329720905522696),
                                    ("Father's Dayyear (latent)", -6.329720905522696),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.329720905522696),
                                    ("Ramadanyear (latent)", -5.413430173648541),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.314817884980432),
                                    ("Bhai Doojyear (latent)", -6.329720905522696),
                                    ("hourday", -4.314817884980432),
                                    ("dayhour", -3.4119501734384174),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.314817884980432),
                                    ("Martin Luther King's Dayyear (latent)", -5.924255797414532),
                                    ("Shemini Atzeretyear (latent)", -6.329720905522696),
                                    ("daymonth", -4.314817884980432),
                                    ("monthday", -5.924255797414532),
                                    ("monthyear", -4.537961436294641),
                                    ("Yom Ha'atzmautyear (latent)", -6.329720905522696),
                                    ("Vijayadashamiyear (latent)", -6.329720905522696),
                                    ("Thanksgiving Dayyear (latent)", -5.231108616854587),
                                    ("Thai Pongalyear (latent)", -5.636573724962751),
                                    ("Thiru Onamyear (latent)", -5.636573724962751),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.329720905522696),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.413430173648541),
                                    ("<day-of-month> (ordinal)Wednesday", -6.329720905522696),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.329720905522696),
                                    ("houryear", -5.413430173648541),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.329720905522696),
                                    ("Christmas<time-of-day> am|pm", -6.329720905522696),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.329720905522696),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.636573724962751),
                                    ("intersectin|during <named-month>|year", -6.329720905522696),
                                    ("<time-of-day> am|pmintersect", -5.076957937027328),
                                    ("Earth Houryear (latent)", -6.329720905522696),
                                    ("Octoberyear (latent)", -4.825643508746422),
                                    ("intersect<time-of-day> am|pm", -6.329720905522696),
                                    ("Mattu Pongalyear (latent)", -6.329720905522696),
                                    ("Shavuotyear (latent)", -6.329720905522696),
                                    ("Parsi New Yearyear (latent)", -5.413430173648541),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.329720905522696),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.329720905522696),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.924255797414532),
                                    ("Marchyear (latent)", -6.329720905522696),
                                    ("Sukkotyear (latent)", -5.924255797414532),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.924255797414532),
                                    ("Clean Mondayyear (latent)", -5.924255797414532),
                                    ("monthhour", -5.924255797414532),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.636573724962751),
                                    ("todayat <time-of-day>", -6.329720905522696),
                                    ("Thursday<time> timezone", -4.383810756467383),
                                    ("time-of-day (latent)tonight", -5.924255797414532),
                                    ("from|since|after <time>December", -6.329720905522696),
                                    ("dd/mm<time-of-day> am|pm", -6.329720905522696),
                                    ("<time-of-day> am|pmon <day>", -4.314817884980432),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.329720905522696),
                                    ("yyyy-mm-ddhh:mm:ss", -5.924255797414532),
                                    ("dayday", -3.8873738701534917),
                                    ("dd/mmat <time-of-day>", -6.329720905522696),
                                    ("<time> <part-of-day>at <time-of-day>", -6.329720905522696),
                                    ("tonightat <time-of-day>", -6.329720905522696),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.636573724962751),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.329720905522696),
                                    ("today<time-of-day> am|pm", -6.329720905522696),
                                    ("Februarythe <day-of-month> (ordinal)", -5.924255797414532),
                                    ("at <time-of-day><time> <part-of-day>", -6.329720905522696),
                                    ("<day-of-month> (ordinal)intersect", -5.924255797414532),
                                    ("hourhour", -4.250279363842861),
                                    ("Navaratriin|during <named-month>|year", -6.329720905522696),
                                    ("Wednesdaythis|last|next <cycle>", -6.329720905522696),
                                    ("Lentyear (latent)", -6.329720905522696),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.825643508746422),
                                    ("Boghiyear (latent)", -6.329720905522696),
                                    ("dayyear", -1.892969371159568),
                                    ("Thursdayfrom|since|after <time>", -5.924255797414532),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.329720905522696),
                                    ("Thursdayat <time-of-day>", -5.636573724962751),
                                    ("Islamic New Yearyear (latent)", -5.924255797414532),
                                    ("Laylat al-Qadryear (latent)", -5.413430173648541),
                                    ("Shrove Tuesdayyear (latent)", -6.329720905522696),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.636573724962751),
                                    ("<time-of-day> am|pmtomorrow", -5.636573724962751),
                                    ("Yom Kippuryear (latent)", -6.329720905522696),
                                    ("<day-of-month> (ordinal)Tuesday", -5.924255797414532),
                                    ("<part-of-day> of <time>year (latent)", -6.329720905522696),
                                    ("minutehour", -5.231108616854587),
                                    ("Kaanum Pongalyear (latent)", -5.924255797414532),
                                    ("Maha Saptamiyear (latent)", -6.329720905522696),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.924255797414532),
                                    ("time-of-day (latent)tomorrow", -5.413430173648541),
                                    ("part of daysat <time-of-day>", -5.924255797414532),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.624972813284271),
                                    ("for <duration> from <time>December", -6.329720905522696),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.329720905522696),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.076957937027328),
                                    ("time-of-day (latent)this <part-of-day>", -6.329720905522696),
                                    ("Pentecostyear (latent)", -6.329720905522696),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.076957937027328),
                                    ("<day-of-month> (ordinal)February", -6.329720905522696),
                                    ("Eid al-Fitryear (latent)", -5.413430173648541),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.329720905522696),
                                    ("Mondayin|during the <part-of-day>", -6.329720905522696),
                                    ("Chhathin|during <named-month>|year", -6.329720905522696),
                                    ("Diwaliin|during <named-month>|year", -6.329720905522696),
                                    ("Vaisakhiin|during <named-month>|year", -6.329720905522696),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.076957937027328),
                                    ("Raksha Bandhanyear (latent)", -6.329720905522696),
                                    ("daysecond", -5.924255797414532),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.924255797414532),
                                    ("Ashurayear (latent)", -6.329720905522696),
                                    ("Tuesdayin|during <named-month>|year", -6.329720905522696),
                                    ("Chinese New Yearyear (latent)", -6.329720905522696),
                                    ("tomorrowintersect", -6.329720905522696),
                                    ("Lag BaOmeryear (latent)", -6.329720905522696),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.329720905522696),
                                    ("Eid al-Adhayear (latent)", -4.189654742026425),
                                    ("intersectin|during the <part-of-day>", -6.329720905522696),
                                    ("Palm Sundayyear (latent)", -6.329720905522696),
                                    ("Christmasat <time-of-day>", -6.329720905522696),
                                    ("Passoveryear (latent)", -6.329720905522696),
                                    ("Lazarus Saturdayyear (latent)", -6.329720905522696),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.329720905522696),
                                    ("Yom HaShoahyear (latent)", -5.924255797414532),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.924255797414532),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.329720905522696),
                                    ("Septemberyear (latent)", -5.924255797414532),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.825643508746422),
                                    ("Halloweenyear (latent)", -6.329720905522696),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.329720905522696),
                                    ("at <time-of-day>intersect", -5.924255797414532),
                                    ("Rosh Hashanahyear (latent)", -5.636573724962751),
                                    ("Dhanterasyear (latent)", -6.329720905522696),
                                    ("Tu BiShvatyear (latent)", -6.329720905522696),
                                    ("<day-of-month> (ordinal)December", -5.636573724962751),
                                    ("Holiyear (latent)", -5.636573724962751),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.329720905522696),
                                    ("Holika Dahanyear (latent)", -5.636573724962751),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.329720905522696),
                                    ("dayminute", -3.4119501734384174),
                                    ("Mawlidyear (latent)", -6.329720905522696),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.924255797414532),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.329720905522696),
                                    ("Jumu'atul-Widayear (latent)", -5.413430173648541),
                                    ("minuteday", -2.5010795090336013),
                                    ("absorption of , after named dayintersect",
                                     -6.329720905522696),
                                    ("intersectyear (latent)", -6.329720905522696),
                                    ("Orthodox Easter Sundayyear (latent)", -6.329720905522696),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.329720905522696),
                                    ("Mothering Sundayyear (latent)", -5.924255797414532),
                                    ("Boss's Dayyear (latent)", -5.924255797414532),
                                    ("Global Youth Service Dayyear (latent)", -6.329720905522696),
                                    ("Dhanterasin|during <named-month>|year", -6.329720905522696),
                                    ("Tisha B'Avyear (latent)", -6.329720905522696),
                                    ("Isra and Mi'rajyear (latent)", -5.413430173648541),
                                    ("at <time-of-day>on <day>", -5.231108616854587),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.329720905522696),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.636573724962751),
                                    ("Christmasyear (latent)", -5.924255797414532),
                                    ("Naraka Chaturdashiyear (latent)", -5.924255797414532),
                                    ("Thai Pongalin|during <named-month>|year", -6.329720905522696),
                                    ("dayweek", -6.329720905522696),
                                    ("Easter Sundayyear (latent)", -5.636573724962751),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.720282993088596),
                                    ("weekyear", -5.231108616854587),
                                    ("King's Dayyear (latent)", -4.825643508746422),
                                    ("hh:mmin|during the <part-of-day>", -5.636573724962751),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.924255797414532),
                                    ("Hanukkahyear (latent)", -5.636573724962751),
                                    ("February<time> <part-of-day>", -6.329720905522696),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.329720905522696),
                                    ("Great Lentyear (latent)", -6.329720905522696),
                                    ("tomorrowat <time-of-day>", -5.636573724962751),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.329720905522696),
                                    ("Vaisakhiyear (latent)", -5.636573724962751),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.329720905522696),
                                    ("last <cycle> of <time>year (latent)", -5.636573724962751),
                                    ("at <time-of-day>tomorrow", -5.924255797414532),
                                    ("tomorrow<time-of-day> am|pm", -6.329720905522696),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.329720905522696),
                                    ("Diwaliyear (latent)", -6.329720905522696),
                                    ("between <time> and <time>on <day>", -4.720282993088596),
                                    ("Black Fridayyear (latent)", -5.924255797414532),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.329720905522696),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.329720905522696),
                                    ("Chhathyear (latent)", -5.924255797414532),
                                    ("Vasant Panchamiyear (latent)", -6.329720905522696),
                                    ("Rabindra Jayantiyear (latent)", -5.076957937027328),
                                    ("St Patrick's Dayyear (latent)", -6.329720905522696),
                                    ("Thursday<time> (timezone)", -6.329720905522696),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.329720905522696),
                                    ("August Bank Holidayyear (latent)", -5.636573724962751),
                                    ("<datetime> - <datetime> (interval)July", -5.924255797414532),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.924255797414532),
                                    ("Februaryintersect", -6.329720905522696),
                                    ("Simchat Torahyear (latent)", -6.329720905522696),
                                    ("minuteyear", -6.329720905522696)],
                               n = 429},
                   koData =
                     ClassData{prior = -0.9535077231605333, unseen = -6.688354713946762,
                               likelihoods =
                                 HashMap.fromList
                                   [("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.588496319198405),
                                    ("hourday", -3.2859112262043593),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.993961427306569),
                                    ("<day-of-month> (ordinal)August", -5.993961427306569),
                                    ("dayhour", -3.3198127778800406),
                                    ("<time> timezoneyear (latent)", -5.993961427306569),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.077670695432414),
                                    ("Tuesdayfrom|since|after <time>", -5.993961427306569),
                                    ("daymonth", -3.509054777518569),
                                    ("monthyear", -4.741198458811201),
                                    ("<time-of-day> am|pmyear (latent)", -5.300814246746624),
                                    ("Thai Pongalyear (latent)", -5.300814246746624),
                                    ("intersecthh:mm", -5.993961427306569),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.588496319198405),
                                    ("<day-of-month> (ordinal)Wednesday", -5.993961427306569),
                                    ("houryear", -4.6076670661866785),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.993961427306569),
                                    ("<day-of-month> (ordinal)October", -5.993961427306569),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.300814246746624),
                                    ("<time-of-day> am|pmintersect", -4.741198458811201),
                                    ("Octoberyear (latent)", -5.993961427306569),
                                    ("until <time>on <day>", -5.300814246746624),
                                    ("time-of-day (latent)intersect", -5.993961427306569),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.300814246746624),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.993961427306569),
                                    ("hh:mmon <day>", -3.5516143919373646),
                                    ("absorption of , after named dayJuly", -5.588496319198405),
                                    ("from|since|after <time>July", -5.588496319198405),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.077670695432414),
                                    ("Clean Mondayyear (latent)", -5.993961427306569),
                                    ("monthhour", -5.993961427306569),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.588496319198405),
                                    ("hourmonth", -4.1221592504049775),
                                    ("todayat <time-of-day>", -5.993961427306569),
                                    ("Bank Holidayyear (latent)", -5.300814246746624),
                                    ("from|since|after <time>December", -5.993961427306569),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.993961427306569),
                                    ("<time-of-day> am|pmon <day>", -4.741198458811201),
                                    ("Mondayyear (latent)", -5.300814246746624),
                                    ("dayday", -4.6076670661866785),
                                    ("dd/mmat <time-of-day>", -5.588496319198405),
                                    ("on <day>September", -5.588496319198405),
                                    ("time-of-day (latent)September", -5.588496319198405),
                                    ("hourhour", -5.077670695432414),
                                    ("time-of-day (latent)on <day>", -3.5516143919373646),
                                    ("Thursdaydd/mm", -5.993961427306569),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.588496319198405),
                                    ("dayyear", -2.973536541162207),
                                    ("New Year's Dayyear (latent)", -5.077670695432414),
                                    ("Thursdayfrom|since|after <time>", -4.289213335068144),
                                    ("Thursdayat <time-of-day>", -4.384523514872469),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.993961427306569),
                                    ("Aprilyear (latent)", -5.993961427306569),
                                    ("the <day-of-month> (ordinal)July", -5.993961427306569),
                                    ("the <day-of-month> (number)July", -5.993961427306569),
                                    ("monthminute", -5.993961427306569),
                                    ("hourminute", -5.300814246746624),
                                    ("<time-of-day> am|pmtomorrow", -5.993961427306569),
                                    ("Thursdayhh:mm", -5.077670695432414),
                                    ("<day-of-month> (ordinal)Tuesday", -5.588496319198405),
                                    ("minutemonth", -4.1221592504049775),
                                    ("minutehour", -5.993961427306569),
                                    ("Augustyear (latent)", -5.588496319198405),
                                    ("week-endin|during <named-month>|year", -5.993961427306569),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.993961427306569),
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.588496319198405),
                                    ("Sundayyear (latent)", -5.077670695432414),
                                    ("Christmasat <time-of-day>", -5.993961427306569),
                                    ("from|since|after <time>year (latent)", -4.895349138638459),
                                    ("dd/mmyear (latent)", -5.993961427306569),
                                    ("<duration> after|before|from <time>December",
                                     -5.993961427306569),
                                    ("yesterday<time-of-day> am|pm", -5.993961427306569),
                                    ("<day-of-month> (ordinal)July", -5.300814246746624),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.993961427306569),
                                    ("at <time-of-day>intersect", -5.588496319198405),
                                    ("hh:mmyear (latent)", -3.914519885626733),
                                    ("Holiyear (latent)", -5.993961427306569),
                                    ("until <time><time-of-day> am|pm", -5.993961427306569),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.993961427306569),
                                    ("dayminute", -3.4290120698450326),
                                    ("yyyy-mm-ddhh:mm", -5.588496319198405),
                                    ("intersectSeptember", -4.489884030530295),
                                    ("minuteday", -2.755282975142189),
                                    ("absorption of , after named dayintersect",
                                     -5.993961427306569),
                                    ("intersectyear (latent)", -5.993961427306569),
                                    ("Februaryin|during the <part-of-day>", -5.993961427306569),
                                    ("time-of-day (latent)July", -5.300814246746624),
                                    ("Saturdayyear (latent)", -5.993961427306569),
                                    ("at <time-of-day>on <day>", -5.588496319198405),
                                    ("time-of-day (latent)<time-of-day> am|pm", -5.993961427306569),
                                    ("absorption of , after named daySeptember",
                                     -5.077670695432414),
                                    ("Naraka Chaturdashiyear (latent)", -5.993961427306569),
                                    ("from|since|after <time>on <day>", -5.077670695432414),
                                    ("dayweek", -5.993961427306569),
                                    ("Easter Sundayyear (latent)", -5.588496319198405),
                                    ("time-of-day (latent)at <time-of-day>", -5.300814246746624),
                                    ("Thursday<time-of-day> am|pm", -4.741198458811201),
                                    ("weekyear", -5.588496319198405),
                                    ("time-of-day (latent)Thursday", -5.588496319198405),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.993961427306569),
                                    ("<day-of-month> (ordinal)April", -5.993961427306569),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.588496319198405),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.300814246746624),
                                    ("Sundayfrom|since|after <time>", -5.993961427306569),
                                    ("absorption of , after named dayFebruary", -5.077670695432414),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.993961427306569),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.993961427306569),
                                    ("tomorrowat <time-of-day>", -5.993961427306569),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.588496319198405),
                                    ("last <cycle> of <time>year (latent)", -5.588496319198405),
                                    ("tomorrow<time-of-day> am|pm", -5.993961427306569),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.300814246746624),
                                    ("Diwaliyear (latent)", -5.588496319198405),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.993961427306569),
                                    ("Fridayyear (latent)", -5.588496319198405),
                                    ("time-of-day (latent)April", -5.993961427306569),
                                    ("minuteyear", -3.7967368499703498)],
                               n = 269}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.16586384449091154,
                               unseen = -5.293304824724492,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.077165866675366e-2),
                                    ("intersect 2 numbers", -3.9019726695746444)],
                               n = 194},
                   koData =
                     ClassData{prior = -1.878373942064826, unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
