...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5960268527875748, unseen = -6.156978985585555,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 470},
                   koData =
                     ClassData{prior = -0.8007245583110331, unseen = -5.953243334287785,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4663203838294391, unseen = -7.188412736496954,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.494509983555011),
                                    ("Father's Dayyear (latent)", -6.494509983555011),
                                    ...
                                    ("daymonth", -4.4796069630127455),
                                    ("monthday", -6.089044875446846),
                                    ("monthyear", -4.702750514326955),
                                    ...
                                    ("Octoberyear (latent)", -4.990432586778736),
                                    ...
                                    ("dd/mm<time-of-day> am|pm", -6.494509983555011),
                                    ...
                                    ("dd/mmat <time-of-day>", -6.494509983555011),
                                    ("<time> <part-of-day>at <time-of-day>", -6.089044875446846),
                                    ("tonightat <time-of-day>", -5.801362802995065),
                                    ...
                                    ("<day-of-month> (ordinal)intersect", -6.089044875446846),
                                    ("hourhour", -3.6041382256588457),
                                    ...
                                    ("minuteday", -2.6878474937846906),
                                    ("absorption of , after named dayintersect",
                                     -5.801362802995065),
                                    ("intersectyear (latent)", -6.494509983555011),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.494509983555011),
                                    ("Mothering Sundayyear (latent)", -6.089044875446846),
                                    ...
                                    ("between <time> and <time>on <day>", -5.395897694886901),
                                    ...
                                    ("August Bank Holidayyear (latent)", -5.801362802995065),
                               ...
                               n = 510},
                   koData =
                     ClassData{prior = -0.9869983040384415, unseen = -6.813444599510896,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.61512051684126),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.713732805509369),
                                    ("hourday", -3.5934692693092782),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.119197913617533),
                                    ("<day-of-month> (ordinal)August", -6.119197913617533),
                                    ("dayhour", -3.4450492641910047),
                                    ("<time> timezoneyear (latent)", -5.426050733057588),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.202907181743378),
                                    ("Tuesdayfrom|since|after <time>", -5.426050733057588),
                                    ("daymonth", -3.4450492641910047),
                                    ("monthyear", -4.866434945122165),
                                    ("<time-of-day> am|pmyear (latent)", -5.426050733057588),
                                    ("Thai Pongalyear (latent)", -5.426050733057588),
                                    ("intersecthh:mm", -6.119197913617533),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.713732805509369),
                                    ("<day-of-month> (ordinal)Wednesday", -6.119197913617533),
                                    ("houryear", -4.732903552497643),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.119197913617533),
                                    ("<day-of-month> (ordinal)October", -6.119197913617533),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.426050733057588),
                                    ("hournograin", -4.866434945122165),
                                    ("<time-of-day> am|pmintersect", -4.866434945122165),
                                    ("Octoberyear (latent)", -6.119197913617533),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.713732805509369),
                                    ("early morningat <time-of-day>", -6.119197913617533),
                                    ("until <time>on <day>", -5.426050733057588),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.119197913617533),
                                    ("time-of-day (latent)intersect", -5.426050733057588),
                                    ("todayin <number> (implicit minutes)", -6.119197913617533),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.426050733057588),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.119197913617533),
                                    ("hh:mmon <day>", -4.509760001183433),
                                    ("hhhmmintersect", -5.713732805509369),
                                    ("absorption of , after named dayJuly", -5.202907181743378),
                                    ("from|since|after <time>July", -5.713732805509369),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.202907181743378),
                                    ("Clean Mondayyear (latent)", -6.119197913617533),
                                    ("monthhour", -6.119197913617533),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.713732805509369),
                                    ("hourmonth", -4.247395736715942),
                                    ("todayat <time-of-day>", -6.119197913617533),
                                    ("Bank Holidayyear (latent)", -5.426050733057588),
                                    ("hhhmmyear (latent)", -4.866434945122165),
                                    ("from|since|after <time>December", -6.119197913617533),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.119197913617533),
                                    ("<time-of-day> am|pmon <day>", -4.866434945122165),
                                    ("Mondayyear (latent)", -5.426050733057588),
                                    ("dayday", -4.732903552497643),
                                    ("dd/mmat <time-of-day>", -5.713732805509369),
                                    ("on <day>September", -5.426050733057588),
                                    ("time-of-day (latent)September", -5.713732805509369),
                                    ("hourhour", -3.8679061150110385),
                                    ("time-of-day (latent)on <day>", -4.327438444389479),
                                    ("Thursdaydd/mm", -6.119197913617533),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.713732805509369),
                                    ("dayyear", -3.098773027473171),
                                    ("New Year's Dayyear (latent)", -5.202907181743378),
                                    ("time-of-day (latent)Sunday", -5.713732805509369),
                                    ("Thursdayfrom|since|after <time>", -4.414449821379108),
                                    ("Thursdayat <time-of-day>", -4.509760001183433),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.119197913617533),
                                    ("Aprilyear (latent)", -6.119197913617533),
                                    ("the <day-of-month> (ordinal)July", -6.119197913617533),
                                    ("the <day-of-month> (number)July", -6.119197913617533),
                                    ("monthminute", -6.119197913617533),
                                    ("hourminute", -5.426050733057588),
                                    ("<time-of-day> am|pmtomorrow", -6.119197913617533),
                                    ("Thursdayhh:mm", -5.202907181743378),
                                    ("<day-of-month> (ordinal)Tuesday", -5.713732805509369),
                                    ("minutemonth", -3.9791317501212626),
                                    ("time-of-day (latent)Friday", -5.713732805509369),
                                    ("minutehour", -6.119197913617533),
                                    ("part of daysat <time-of-day>", -5.020585624949423),
                                    ("Augustyear (latent)", -5.713732805509369),
                                    ("week-endin|during <named-month>|year", -6.119197913617533),
                                    ("time-of-day (latent)Tuesday", -5.713732805509369),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.119197913617533),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.713732805509369),
                                    ("Sundayyear (latent)", -5.202907181743378),
                                    ("Christmasat <time-of-day>", -6.119197913617533),
                                    ("from|since|after <time>year (latent)", -5.020585624949423),
                                    ("dd/mmyear (latent)", -6.119197913617533),
                                    ("hhhmmon <day>", -5.202907181743378),
                                    ("yesterday<time-of-day> am|pm", -6.119197913617533),
                                    ("<day-of-month> (ordinal)July", -5.426050733057588),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.119197913617533),
                                    ("at <time-of-day>intersect", -5.202907181743378),
                                    ("hh:mmyear (latent)", -4.732903552497643),
                                    ("Holiyear (latent)", -6.119197913617533),
                                    ("until <time><time-of-day> am|pm", -6.119197913617533),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.713732805509369),
                                    ("dayminute", -3.2569970326880653),
                                    ("yyyy-mm-ddhh:mm", -5.713732805509369),
                                    ("intersectfrom|since|after <time>", -5.713732805509369),
                                    ("intersectSeptember", -4.247395736715942),
                                    ("minuteday", -2.900322088749333),
                                    ("absorption of , after named dayintersect",
                                     -6.119197913617533),
                                    ("intersectyear (latent)", -6.119197913617533),
                                    ("Februaryin|during the <part-of-day>", -6.119197913617533),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.119197913617533),
                                    ("time-of-day (latent)July", -5.426050733057588),
                                    ("Saturdayyear (latent)", -6.119197913617533),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.119197913617533),
                                    ("at <time-of-day>on <day>", -5.202907181743378),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.119197913617533),
                                    ("absorption of , after named daySeptember",
                                     -4.866434945122165),
                                    ("Naraka Chaturdashiyear (latent)", -6.119197913617533),
                                    ("from|since|after <time>on <day>", -5.202907181743378),
                                    ("dayweek", -6.119197913617533),
                                    ("Easter Sundayyear (latent)", -5.713732805509369),
                                    ("time-of-day (latent)at <time-of-day>", -5.426050733057588),
                                    ("Thursday<time-of-day> am|pm", -4.866434945122165),
                                    ("weekyear", -5.713732805509369),
                                    ("time-of-day (latent)Thursday", -5.713732805509369),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.119197913617533),
                                    ("<day-of-month> (ordinal)April", -6.119197913617533),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.713732805509369),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.426050733057588),
                                    ("Sundayfrom|since|after <time>", -6.119197913617533),
                                    ("absorption of , after named dayFebruary", -5.202907181743378),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.713732805509369),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.119197913617533),
                                    ("tomorrowat <time-of-day>", -6.119197913617533),
                                    ("daynograin", -5.713732805509369),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.713732805509369),
                                    ("last <cycle> of <time>year (latent)", -5.713732805509369),
                                    ("tomorrow<time-of-day> am|pm", -6.119197913617533),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.426050733057588),
                                    ("Diwaliyear (latent)", -5.713732805509369),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.119197913617533),
                                    ("this <part-of-day>at <time-of-day>", -5.202907181743378),
                                    ("Fridayyear (latent)", -5.713732805509369),
                                    ("time-of-day (latent)April", -6.119197913617533),
                                    ("minuteyear", -3.9219733362813143)],
                               n = 303}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6523251860396901, unseen = -4.852030263919617,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 125},
                   koData =
                     ClassData{prior = -0.7357067949787413, unseen = -4.770684624465665,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -7.08260525686124e-2),
                                    ("integer (0..19)", -2.68273239311792)],
                               n = 115}}),
       ("beginning of year",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.791759469228055,
       ...
       ("hh:mm",
        Classifier{okData =
                     ClassData{prior = -0.11191791620398532,
                               unseen = -4.356708826689592,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 76},
                   koData =
                     ClassData{prior = -2.245426679154097, unseen = -2.3978952727983707,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 9}}),
       ("Holi",
        Classifier{okData =
                     ClassData{prior = -0.2876820724517809,
