...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6784626288770242, unseen = -5.84354441703136,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 343},
                   koData =
                     ClassData{prior = -0.7080505860625202, unseen = -5.814130531825066,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5098020822232034, unseen = -6.946975992135418,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.252866810539282),
                                    ("Father's Dayyear (latent)", -6.252866810539282),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.252866810539282),
                                    ("Ramadanyear (latent)", -5.336576078665127),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.237963789997018),
                                    ("Bhai Doojyear (latent)", -6.252866810539282),
                                    ("hourday", -4.237963789997018),
                                    ("dayhour", -3.335096078455003),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.237963789997018),
                                    ("Martin Luther King's Dayyear (latent)", -5.847401702431117),
                                    ("Shemini Atzeretyear (latent)", -6.252866810539282),
                                    ("daymonth", -4.6434288981051814),
                                    ("monthday", -5.847401702431117),
                                    ("monthyear", -4.461107341311227),
                                    ("Yom Ha'atzmautyear (latent)", -6.252866810539282),
                                    ("Vijayadashamiyear (latent)", -6.252866810539282),
                                    ("Thanksgiving Dayyear (latent)", -5.154254521871173),
                                    ("Thai Pongalyear (latent)", -5.5597196299793366),
                                    ("Thiru Onamyear (latent)", -5.5597196299793366),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.252866810539282),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.252866810539282),
                                    ("<day-of-month> (ordinal)Wednesday", -6.252866810539282),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.252866810539282),
                                    ("houryear", -5.336576078665127),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.252866810539282),
                                    ("Christmas<time-of-day> am|pm", -6.252866810539282),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.252866810539282),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.5597196299793366),
                                    ("intersectin|during <named-month>|year", -6.252866810539282),
                                    ("<time-of-day> am|pmintersect", -5.000103842043914),
                                    ("Earth Houryear (latent)", -6.252866810539282),
                                    ("Octoberyear (latent)", -4.748789413763008),
                                    ("intersect<time-of-day> am|pm", -6.252866810539282),
                                    ("Mattu Pongalyear (latent)", -6.252866810539282),
                                    ("Shavuotyear (latent)", -6.252866810539282),
                                    ("Parsi New Yearyear (latent)", -5.336576078665127),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.252866810539282),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.252866810539282),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.847401702431117),
                                    ("Marchyear (latent)", -6.252866810539282),
                                    ("Sukkotyear (latent)", -5.847401702431117),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.847401702431117),
                                    ("Clean Mondayyear (latent)", -5.847401702431117),
                                    ("monthhour", -5.847401702431117),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.5597196299793366),
                                    ("todayat <time-of-day>", -6.252866810539282),
                                    ("Thursday<time> timezone", -4.3069566614839685),
                                    ("time-of-day (latent)tonight", -5.847401702431117),
                                    ("from|since|after <time>December", -6.252866810539282),
                                    ("dd/mm<time-of-day> am|pm", -6.252866810539282),
                                    ("<time-of-day> am|pmon <day>", -4.237963789997018),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.252866810539282),
                                    ("yyyy-mm-ddhh:mm:ss", -5.847401702431117),
                                    ("dayday", -3.8105197751700777),
                                    ("dd/mmat <time-of-day>", -6.252866810539282),
                                    ("<time> <part-of-day>at <time-of-day>", -6.252866810539282),
                                    ("tonightat <time-of-day>", -6.252866810539282),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.5597196299793366),
                                    ("today<time-of-day> am|pm", -6.252866810539282),
                                    ("Februarythe <day-of-month> (ordinal)", -5.847401702431117),
                                    ("at <time-of-day><time> <part-of-day>", -6.252866810539282),
                                    ("<day-of-month> (ordinal)intersect", -5.847401702431117),
                                    ("hourhour", -4.173425268859446),
                                    ("Navaratriin|during <named-month>|year", -6.252866810539282),
                                    ("Wednesdaythis|last|next <cycle>", -6.252866810539282),
                                    ("Lentyear (latent)", -6.252866810539282),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.748789413763008),
                                    ("Boghiyear (latent)", -6.252866810539282),
                                    ("dayyear", -2.0333591053631754),
                                    ("Thursdayfrom|since|after <time>", -5.847401702431117),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.252866810539282),
                                    ("Thursdayat <time-of-day>", -5.5597196299793366),
                                    ("Islamic New Yearyear (latent)", -5.847401702431117),
                                    ("Laylat al-Qadryear (latent)", -5.336576078665127),
                                    ("Shrove Tuesdayyear (latent)", -6.252866810539282),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.5597196299793366),
                                    ("<time-of-day> am|pmtomorrow", -5.5597196299793366),
                                    ("Yom Kippuryear (latent)", -6.252866810539282),
                                    ("<day-of-month> (ordinal)Tuesday", -5.847401702431117),
                                    ("<part-of-day> of <time>year (latent)", -6.252866810539282),
                                    ("minutehour", -5.154254521871173),
                                    ("Kaanum Pongalyear (latent)", -5.847401702431117),
                                    ("Maha Saptamiyear (latent)", -6.252866810539282),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.847401702431117),
                                    ("time-of-day (latent)tomorrow", -5.336576078665127),
                                    ("part of daysat <time-of-day>", -5.847401702431117),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.548118718300857),
                                    ("for <duration> from <time>December", -6.252866810539282),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.252866810539282),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.000103842043914),
                                    ("time-of-day (latent)this <part-of-day>", -6.252866810539282),
                                    ("Pentecostyear (latent)", -6.252866810539282),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.000103842043914),
                                    ("<day-of-month> (ordinal)February", -6.252866810539282),
                                    ("Eid al-Fitryear (latent)", -5.336576078665127),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.252866810539282),
                                    ("Mondayin|during the <part-of-day>", -6.252866810539282),
                                    ("Chhathin|during <named-month>|year", -6.252866810539282),
                                    ("Diwaliin|during <named-month>|year", -6.252866810539282),
                                    ("Vaisakhiin|during <named-month>|year", -6.252866810539282),
                                    ("Raksha Bandhanyear (latent)", -6.252866810539282),
                                    ("daysecond", -5.847401702431117),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.847401702431117),
                                    ("Ashurayear (latent)", -6.252866810539282),
                                    ("Tuesdayin|during <named-month>|year", -6.252866810539282),
                                    ("Chinese New Yearyear (latent)", -6.252866810539282),
                                    ("tomorrowintersect", -6.252866810539282),
                                    ("Lag BaOmeryear (latent)", -6.252866810539282),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.252866810539282),
                                    ("Eid al-Adhayear (latent)", -5.336576078665127),
                                    ("intersectin|during the <part-of-day>", -6.252866810539282),
                                    ("Palm Sundayyear (latent)", -6.252866810539282),
                                    ("Christmasat <time-of-day>", -6.252866810539282),
                                    ("Passoveryear (latent)", -6.252866810539282),
                                    ("Lazarus Saturdayyear (latent)", -6.252866810539282),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.252866810539282),
                                    ("Yom HaShoahyear (latent)", -5.847401702431117),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.847401702431117),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.252866810539282),
                                    ("Septemberyear (latent)", -5.847401702431117),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.748789413763008),
                                    ("Halloweenyear (latent)", -6.252866810539282),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.252866810539282),
                                    ("at <time-of-day>intersect", -5.847401702431117),
                                    ("Rosh Hashanahyear (latent)", -5.5597196299793366),
                                    ("Dhanterasyear (latent)", -6.252866810539282),
                                    ("Tu BiShvatyear (latent)", -6.252866810539282),
                                    ("<day-of-month> (ordinal)December", -5.5597196299793366),
                                    ("Holiyear (latent)", -5.5597196299793366),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.252866810539282),
                                    ("Holika Dahanyear (latent)", -5.5597196299793366),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.252866810539282),
                                    ("dayminute", -3.335096078455003),
                                    ("Mawlidyear (latent)", -6.252866810539282),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.847401702431117),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.252866810539282),
                                    ("Jumu'atul-Widayear (latent)", -5.336576078665127),
                                    ("minuteday", -2.4242254140501873),
                                    ("absorption of , after named dayintersect",
                                     -6.252866810539282),
                                    ("intersectyear (latent)", -6.252866810539282),
                                    ("Orthodox Easter Sundayyear (latent)", -6.252866810539282),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.252866810539282),
                                    ("Mothering Sundayyear (latent)", -5.847401702431117),
                                    ("Boss's Dayyear (latent)", -5.847401702431117),
                                    ("Global Youth Service Dayyear (latent)", -6.252866810539282),
                                    ("Dhanterasin|during <named-month>|year", -6.252866810539282),
                                    ("Tisha B'Avyear (latent)", -6.252866810539282),
                                    ("Isra and Mi'rajyear (latent)", -5.336576078665127),
                                    ("at <time-of-day>on <day>", -5.154254521871173),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.252866810539282),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.5597196299793366),
                                    ("Christmasyear (latent)", -5.847401702431117),
                                    ("Naraka Chaturdashiyear (latent)", -5.847401702431117),
                                    ("Thai Pongalin|during <named-month>|year", -6.252866810539282),
                                    ("dayweek", -6.252866810539282),
                                    ("Easter Sundayyear (latent)", -5.5597196299793366),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.6434288981051814),
                                    ("weekyear", -5.154254521871173),
                                    ("hh:mmin|during the <part-of-day>", -5.5597196299793366),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.847401702431117),
                                    ("Hanukkahyear (latent)", -5.5597196299793366),
                                    ("February<time> <part-of-day>", -6.252866810539282),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.252866810539282),
                                    ("Great Lentyear (latent)", -6.252866810539282),
                                    ("tomorrowat <time-of-day>", -5.5597196299793366),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.252866810539282),
                                    ("Vaisakhiyear (latent)", -5.5597196299793366),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.252866810539282),
                                    ("last <cycle> of <time>year (latent)", -5.5597196299793366),
                                    ("at <time-of-day>tomorrow", -5.847401702431117),
                                    ("tomorrow<time-of-day> am|pm", -6.252866810539282),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.252866810539282),
                                    ("Diwaliyear (latent)", -6.252866810539282),
                                    ("between <time> and <time>on <day>", -4.6434288981051814),
                                    ("Black Fridayyear (latent)", -5.847401702431117),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.252866810539282),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.252866810539282),
                                    ("Chhathyear (latent)", -5.847401702431117),
                                    ("Vasant Panchamiyear (latent)", -6.252866810539282),
                                    ("St Patrick's Dayyear (latent)", -6.252866810539282),
                                    ("Thursday<time> (timezone)", -6.252866810539282),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.252866810539282),
                                    ("August Bank Holidayyear (latent)", -5.5597196299793366),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.847401702431117),
                                    ("Februaryintersect", -6.252866810539282),
                                    ("Simchat Torahyear (latent)", -6.252866810539282),
                                    ("minuteyear", -6.252866810539282)],
                               n = 391},
                   koData =
                     ClassData{prior = -0.9178280111930415, unseen = -6.656726524178391,
                               likelihoods =
                                 HashMap.fromList
                                   [("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                    ...
                                    ("from|since|after <time>July", -5.962293169807702),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.046002437933547),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.556828061699537),
                                    ("hourmonth", -4.3528552573736015),
                                    ("todayat <time-of-day>", -5.962293169807702),
                                    ("Bank Holidayyear (latent)", -5.269145989247757),
                                    ...
                                    ("time-of-day (latent)July", -5.962293169807702),
                                    ("Saturdayyear (latent)", -5.962293169807702),
                                    ("at <time-of-day>on <day>", -5.556828061699537),
                                    ("time-of-day (latent)<time-of-day> am|pm", -5.962293169807702),
                                    ...
                                    ("time-of-day (latent)at <time-of-day>", -5.269145989247757),
