...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6719313414096727, unseen = -5.575949103146316,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 262},
                   koData =
                     ClassData{prior = -0.7148229060389857, unseen = -5.53338948872752,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4751450287461542, unseen = -6.660575149839686,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -5.966146739123692),
                                    ("Father's Dayyear (latent)", -5.966146739123692),
                                    ("Ramadanyear (latent)", -5.966146739123692),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.713383770628324),
                                    ("Bhai Doojyear (latent)", -5.966146739123692),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.713383770628324),
                                    ("hourday", -4.261398646885267),
                                    ("dayhour", -3.048376007039413),
                                    ("Martin Luther King's Dayyear (latent)", -5.560681631015528),
                                    ("Shemini Atzeretyear (latent)", -5.966146739123692),
                                    ("daymonth", -5.272999558563747),
                                    ("monthday", -5.560681631015528),
                                    ("monthyear", -4.356708826689592),
                                    ("Yom Ha'atzmautyear (latent)", -5.966146739123692),
                                    ("Vijayadashamiyear (latent)", -5.966146739123692),
                                    ("Thanksgiving Dayyear (latent)", -4.867534450455582),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.966146739123692),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.966146739123692),
                                    ("houryear", -5.272999558563747),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.966146739123692),
                                    ("Christmas<time-of-day> am|pm", -5.966146739123692),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.966146739123692),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.272999558563747),
                                    ("<time-of-day> am|pmintersect", -4.713383770628324),
                                    ("Octoberyear (latent)", -4.713383770628324),
                                    ("intersect<time-of-day> am|pm", -5.966146739123692),
                                    ("Shavuotyear (latent)", -5.966146739123692),
                                    ("Dhanterasin <named-month>|year", -5.966146739123692),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.966146739123692),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.966146739123692),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.560681631015528),
                                    ("Marchyear (latent)", -5.966146739123692),
                                    ("Sukkotyear (latent)", -5.560681631015528),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.966146739123692),
                                    ("Clean Mondayyear (latent)", -5.560681631015528),
                                    ("monthhour", -5.560681631015528),
                                    ("todayat <time-of-day>", -5.966146739123692),
                                    ("Thursday<time> timezone", -4.261398646885267),
                                    ("dd/mm<time-of-day> am|pm", -5.966146739123692),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.966146739123692),
                                    ("Palm SundaySunday", -5.560681631015528),
                                    ("dayday", -3.7689221617874726),
                                    ("dd/mmat <time-of-day>", -5.966146739123692),
                                    ("<time> <part-of-day>at <time-of-day>", -5.966146739123692),
                                    ("tonightat <time-of-day>", -5.966146739123692),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.272999558563747),
                                    ("today<time-of-day> am|pm", -5.966146739123692),
                                    ("Februarythe <day-of-month> (ordinal)", -5.560681631015528),
                                    ("at <time-of-day><time> <part-of-day>", -5.966146739123692),
                                    ("hourhour", -4.713383770628324),
                                    ("<time-of-day> am|pmon <date>", -3.951243718581427),
                                    ("Wednesdaythis|last|next <cycle>", -5.966146739123692),
                                    ("Lentyear (latent)", -5.966146739123692),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.462069342347418),
                                    ("dayyear", -2.1054170280830964),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.966146739123692),
                                    ("Thursdayat <time-of-day>", -5.560681631015528),
                                    ("Islamic New Yearyear (latent)", -5.560681631015528),
                                    ("Laylat al-Qadryear (latent)", -5.049856007249537),
                                    ("Chhathin <named-month>|year", -5.966146739123692),
                                    ("Diwaliin <named-month>|year", -5.966146739123692),
                                    ("Shrove Tuesdayyear (latent)", -5.966146739123692),
                                    ("<time-of-day> am|pmtomorrow", -5.272999558563747),
                                    ("Yom Kippuryear (latent)", -5.966146739123692),
                                    ("<part-of-day> of <time>year (latent)", -5.966146739123692),
                                    ("minutehour", -5.049856007249537),
                                    ("Maha Saptamiyear (latent)", -5.966146739123692),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.560681631015528),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.261398646885267),
                                    ("for <duration> from <time>December", -5.966146739123692),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.966146739123692),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.049856007249537),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.560681631015528),
                                    ("Pentecostyear (latent)", -5.966146739123692),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.049856007249537),
                                    ("Eid al-Fitryear (latent)", -5.966146739123692),
                                    ("Mondayin|during the <part-of-day>", -5.966146739123692),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.560681631015528),
                                    ("Navaratriin <named-month>|year", -5.966146739123692),
                                    ("Ashurayear (latent)", -5.966146739123692),
                                    ("Chinese New Yearyear (latent)", -5.966146739123692),
                                    ("Sundayyear (latent)", -5.966146739123692),
                                    ("Lag BaOmeryear (latent)", -5.966146739123692),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.966146739123692),
                                    ("Eid al-Adhayear (latent)", -5.049856007249537),
                                    ("intersectin|during the <part-of-day>", -5.966146739123692),
                                    ("Christmasat <time-of-day>", -5.966146739123692),
                                    ("Passoveryear (latent)", -5.966146739123692),
                                    ("Lazarus Saturdayyear (latent)", -5.966146739123692),
                                    ("dd/mmyear (latent)", -5.966146739123692),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.966146739123692),
                                    ("Yom HaShoahyear (latent)", -5.560681631015528),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.049856007249537),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.966146739123692),
                                    ("Septemberyear (latent)", -5.560681631015528),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.713383770628324),
                                    ("Halloweenyear (latent)", -5.966146739123692),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.966146739123692),
                                    ("Dhanterasyear (latent)", -5.966146739123692),
                                    ("Tu BiShvatyear (latent)", -5.966146739123692),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.966146739123692),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.966146739123692),
                                    ("dayminute", -3.3270894095084333),
                                    ("Mawlidyear (latent)", -5.966146739123692),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.560681631015528),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.966146739123692),
                                    ("Jumu'atul-Widayear (latent)", -5.049856007249537),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.966146739123692),
                                    ("minuteday", -2.3285605793973065),
                                    ("absorption of , after named dayintersect",
                                     -5.966146739123692),
                                    ("intersectyear (latent)", -5.966146739123692),
                                    ("Orthodox Easter Sundayyear (latent)", -5.966146739123692),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.966146739123692),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.966146739123692),
                                    ("Mothering Sundayyear (latent)", -5.560681631015528),
                                    ("Boss's Dayyear (latent)", -5.560681631015528),
                                    ("Tisha B'Avyear (latent)", -5.966146739123692),
                                    ("Isra and Mi'rajyear (latent)", -5.049856007249537),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.966146739123692),
                                    ("Christmasyear (latent)", -5.560681631015528),
                                    ("Naraka Chaturdashiyear (latent)", -5.560681631015528),
                                    ("at <time-of-day>on <date>", -4.867534450455582),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.356708826689592),
                                    ("dayweek", -5.966146739123692),
                                    ("Easter Sundayyear (latent)", -5.272999558563747),
                                    ("Thursday<time-of-day> am|pm", -5.966146739123692),
                                    ("weekyear", -5.560681631015528),
                                    ("hh:mmin|during the <part-of-day>", -5.272999558563747),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.560681631015528),
                                    ("Hanukkahyear (latent)", -5.966146739123692),
                                    ("February<time> <part-of-day>", -5.966146739123692),
                                    ("Tuesdayin <named-month>|year", -5.966146739123692),
                                    ("Great Lentyear (latent)", -5.966146739123692),
                                    ("tomorrowat <time-of-day>", -5.272999558563747),
                                    ("between <time> and <time>on <date>", -4.356708826689592),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.272999558563747),
                                    ("last <cycle> of <time>year (latent)", -5.272999558563747),
                                    ("at <time-of-day>tomorrow", -5.560681631015528),
                                    ("tomorrow<time-of-day> am|pm", -5.966146739123692),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.966146739123692),
                                    ("Diwaliyear (latent)", -5.966146739123692),
                                    ("Black Fridayyear (latent)", -5.560681631015528),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.966146739123692),
                                    ("Chhathyear (latent)", -5.560681631015528),
                                    ("Palm Sundayintersect", -5.966146739123692),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.966146739123692),
                                    ("August Bank Holidayyear (latent)", -5.272999558563747),
                                    ("Februaryintersect", -5.966146739123692),
                                    ("Simchat Torahyear (latent)", -5.966146739123692)],
                               n = 291},
                   koData =
                     ClassData{prior = -0.9723185633438176, unseen = -6.315358001522335,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.62040086571715),
                                    ("hourday", -5.62040086571715),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.62040086571715),
                                    ("dayhour", -3.1780538303479458),
                                    ("daymonth", -3.5409593240373143),
                                    ("monthday", -5.214935757608986),
                                    ("monthyear", -4.3676378972217815),
                                    ("<time-of-day> am|pmyear (latent)", -5.214935757608986),
                                    ("intersecthh:mm", -5.62040086571715),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.62040086571715),
                                    ("houryear", -4.7041101338429945),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.62040086571715),
                                    ("until <time-of-day><time-of-day> am|pm", -5.62040086571715),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.927253685157205),
                                    ("<time-of-day> am|pmintersect", -4.3676378972217815),
                                    ("Octoberyear (latent)", -5.62040086571715),
                                    ...
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -4.3676378972217815),
                                    ("about|exactly <time-of-day>year (latent)", -5.62040086571715),
                                    ("absorption of , after named dayJuly", -5.214935757608986),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.7041101338429945),
                                    ("Clean Mondayyear (latent)", -5.62040086571715),
                                    ("monthhour", -5.62040086571715),
                                    ("hourmonth", -4.927253685157205),
                                    ("todayat <time-of-day>", -5.62040086571715),
                                    ("Bank Holidayyear (latent)", -4.927253685157205),
                                    ("from|since|after <time-of-day>July", -5.62040086571715),
                                    ("Mondayyear (latent)", -4.927253685157205),
                                    ("dayday", -5.214935757608986),
                                    ("dd/mmat <time-of-day>", -5.214935757608986),
                                    ("<time-of-day> am|pmon <date>", -4.3676378972217815),
                                    ("Thursdaydd/mm", -5.62040086571715),
                                    ("dayyear", -2.6759618865507093),
                                    ("New Year's Dayyear (latent)", -5.214935757608986),
                                    ("Thursdayat <time-of-day>", -4.3676378972217815),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.62040086571715),
                                    ("Aprilyear (latent)", -5.62040086571715),
                                    ("monthminute", -5.62040086571715),
                                    ("<time-of-day> am|pmtomorrow", -5.62040086571715),
                                    ("Thursdayhh:mm", -4.7041101338429945),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.62040086571715),
                                    ("minutemonth", -3.828641396489095),
                                    ("Sundayfrom|since|after <time-of-day>", -5.62040086571715),
                                    ("week-endin <named-month>|year", -5.62040086571715),
                                    ("Augustyear (latent)", -5.214935757608986),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.214935757608986),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.214935757608986),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.214935757608986),
                                    ("Sundayyear (latent)", -4.927253685157205),
                                    ("Christmasat <time-of-day>", -5.62040086571715),
                                    ("dd/mmyear (latent)", -5.62040086571715),
                                    ("<duration> after|before|from <time>December",
                                     -5.62040086571715),
                                    ("yesterday<time-of-day> am|pm", -5.62040086571715),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.62040086571715),
                                    ("until <time-of-day>on <date>", -4.927253685157205),
                                    ("at <time-of-day>intersect", -5.214935757608986),
                                    ("hh:mmyear (latent)", -4.5217885770490405),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.62040086571715),
                                    ("dayminute", -3.1354942159291497),
                                    ("intersectSeptember", -4.116323468940876),
                                    ("minuteday", -2.552347930583533),
                                    ("absorption of , after named dayintersect", -5.62040086571715),
                                    ("Februaryin|during the <part-of-day>", -5.62040086571715),
                                    ("hh:mmon <date>", -3.6054978451748854),
                                    ("Saturdayyear (latent)", -5.62040086571715),
                                    ...
                                    ("on <date>September", -5.214935757608986),
                                    ("at <time-of-day>on <date>", -5.214935757608986),
                                    ("in <named-month>|yearyear (latent)", -5.62040086571715),
                                    ("dayweek", -5.62040086571715),
                                    ("Easter Sundayyear (latent)", -5.214935757608986),
                                    ("Thursday<time-of-day> am|pm", -5.214935757608986),
                                    ("absorption of , after named dayFebruary",
                                     -4.7041101338429945),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.62040086571715),
                                    ("tomorrowat <time-of-day>", -5.62040086571715),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.62040086571715),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.01096295328305),
                                    ("tomorrow<time-of-day> am|pm", -5.62040086571715),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.927253685157205),
                                    ("Diwaliyear (latent)", -5.214935757608986),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.62040086571715),
                                    ("Fridayyear (latent)", -5.214935757608986),
                                    ("minuteyear", -4.3676378972217815)],
                               n = 177}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.18384944097200778,
                               ...
                               n = 109},
                   koData =
                     ClassData{prior = -1.7841548698428358, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
