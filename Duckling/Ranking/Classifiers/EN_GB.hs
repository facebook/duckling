                                 ...
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.160969175396813),
                                    ("Thursdaysince <time-of-day>", -4.873287102945032),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.260096153727839),
                                    ("Sundaysince <time-of-day>", -5.260096153727839),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.260096153727839),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.260096153727839),
                                    ("Thursdaysince <time-of-day>", -3.6506582412937383),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.343805421853684),
                                    ("since <time-of-day>on <date>", -4.343805421853684),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.854631045619675),
                                    ...
                                    ("since <time-of-day>July", -5.260096153727839),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer after|past <hour-of-day>", -3.876395827784995),
                                    ...
                                    ("since <time-of-day>", -4.164077900236776),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -3.295836866004329),
                                    ...
                                    ("since <time-of-day>", -3.7013019741124937),
       ...
       ("<time-of-day> - <time-of-day> (interval)",
        Classifier{okData =
                     ClassData{prior = -0.7375989431307791, unseen = -4.110873864173311,
                               likelihoods =
                                 HashMap.fromList
                                   [("since <time-of-day><time-of-day> am|pm", -3.4011973816621555),
                                    ("since <time-of-day>time-of-day (latent)",
                                     -3.4011973816621555),
                                    ("since <time-of-day>hh:mm", -2.4849066497880004),
