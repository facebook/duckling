...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4919825359645108, unseen = -6.410174881966167,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                     -4.462618642004185),
                                    ("Lentyear", -5.715381610499553),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.462618642004185),
                                    ("hourday", -4.010633518261128),
                                    ("dayhour", -2.8250098526033884),
                                    ("daymonth", -5.022234429939608),
                                    ("monthday", -5.309916502391388),
                                    ("monthyear", -4.1059436980654525),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.715381610499553),
                                    ("Easter Sundayyear", -5.022234429939608),
                                    ("Christmasyear", -5.309916502391388),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.715381610499553),
                                    ("houryear", -5.309916502391388),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.715381610499553),
                                    ("Christmas<time-of-day> am|pm", -5.715381610499553),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.022234429939608),
                                    ("<time-of-day> am|pmintersect", -4.462618642004185),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.715381610499553),
                                    ("Marchyear", -5.715381610499553),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.309916502391388),
                                    ("intersect<time-of-day> am|pm", -5.715381610499553),
                                    ("Clean Mondayyear", -5.309916502391388),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.715381610499553),
                                    ("monthhour", -5.309916502391388),
                                    ("last <day-of-week> of <time>year", -5.715381610499553),
                                    ("todayat <time-of-day>", -5.715381610499553),
                                    ("Thursday<time> timezone", -4.010633518261128),
                                    ("dd/mm<time-of-day> am|pm", -5.715381610499553),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.715381610499553),
                                    ("Palm SundaySunday", -5.309916502391388),
                                    ("dayday", -3.5181570331633334),
                                    ("Thanksgiving Dayyear", -4.616769321831443),
                                    ("dd/mmat <time-of-day>", -5.715381610499553),
                                    ("<time> <part-of-day>at <time-of-day>", -5.715381610499553),
                                    ("Tuesdayin <named-month>", -5.715381610499553),
                                    ("tonightat <time-of-day>", -5.715381610499553),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.022234429939608),
                                    ("today<time-of-day> am|pm", -5.715381610499553),
                                    ("Februarythe <day-of-month> (ordinal)", -5.309916502391388),
                                    ("at <time-of-day><time> <part-of-day>", -5.715381610499553),
                                    ("hourhour", -4.462618642004185),
                                    ("<time-of-day> am|pmon <date>", -3.7004785899572883),
                                    ("Wednesdaythis|last|next <cycle>", -5.715381610499553),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.211304213723279),
                                    ("dayyear", -2.6949567243551904),
                                    ("last weekend of <named-month>year", -5.715381610499553),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.715381610499553),
                                    ("Sundayyear", -5.715381610499553),
                                    ("Thursdayat <time-of-day>", -5.309916502391388),
                                    ("<time-of-day> am|pmtomorrow", -5.022234429939608),
                                    ("August Bank Holidayyear", -5.022234429939608),
                                    ("minutehour", -4.799090878625398),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.309916502391388),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.010633518261128),
                                    ("for <duration> from <time>December", -5.715381610499553),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.715381610499553),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.799090878625398),
                                    ("Mondayin|during the <part-of-day>", -5.715381610499553),
                                    ("Shrove Tuesdayyear", -5.715381610499553),
                                    ("<part-of-day> of <time>year", -5.715381610499553),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.309916502391388),
                                    ("intersectin|during the <part-of-day>", -5.715381610499553),
                                    ...
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.715381610499553),
                                    ("dayminute", -3.041232961073024),
                                    ("Mothering Sundayyear", -5.309916502391388),
                                    ("Orthodox Easter Sundayyear", -5.715381610499553),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.309916502391388),
                                    ("intersectyear", -5.715381610499553),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.715381610499553),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.309916502391388),
                                    ("<ordinal> <cycle> of <time>year", -5.715381610499553),
                                    ("minuteday", -2.2496457076998264),
                                    ("absorption of , after named dayintersect",
                                     -5.715381610499553),
                                    ("Octoberyear", -4.462618642004185),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.715381610499553),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.715381610499553),
                                    ("year<time-of-day> am|pm", -5.715381610499553),
                                    ("Septemberyear", -5.309916502391388),
                                    ("at <time-of-day>on <date>", -4.616769321831443),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -5.022234429939608),
                                    ("Halloweenyear", -5.715381610499553),
                                    ("dayweek", -5.715381610499553),
                                    ("Lazarus Saturdayyear", -5.715381610499553),
                                    ("Thursday<time-of-day> am|pm", -5.715381610499553),
                                    ("weekyear", -5.309916502391388),
                                    ("hh:mmin|during the <part-of-day>", -5.022234429939608),
                                    ("Father's Dayyear", -5.715381610499553),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.309916502391388),
                                    ("February<time> <part-of-day>", -5.715381610499553),
                                    ("Martin Luther King's Dayyear", -5.309916502391388),
                                    ("tomorrowat <time-of-day>", -5.022234429939608),
                                    ("between <time> and <time>on <date>", -5.022234429939608),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.022234429939608),
                                    ("at <time-of-day>tomorrow", -5.309916502391388),
                                    ("tomorrow<time-of-day> am|pm", -5.715381610499553),
                                    ("Pentecostyear", -5.715381610499553),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.715381610499553),
                                    ("Palm Sundayintersect", -5.715381610499553),
                                    ("Labor Dayyear", -5.715381610499553),
                                    ("Great Lentyear", -5.715381610499553),
                                    ("Februaryintersect", -5.715381610499553),
                                    ("last <cycle> of <time>year", -5.022234429939608),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.715381610499553),
                                    ("yearminute", -5.715381610499553),
                                    ("Black Fridayyear", -5.309916502391388)],
                               n = 225},
                   koData =
                     ClassData{prior = -0.9452383079090236, unseen = -6.095824562432225,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.40042258948519),
                                    ...
                                    ("dd/mmat <time-of-day>", -4.994957481377026),
                                    ("<time-of-day> am|pmon <date>", -4.147659620989822),
                                    ("Thursdaydd/mm", -5.40042258948519),
                                    ("dayyear", -3.097837496491145),
                                    ...
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.994957481377026),
                                    ("Bank Holidayyear", -4.707275408925245),
