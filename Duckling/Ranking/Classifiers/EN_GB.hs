...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5786413320799273, unseen = -6.169610732491456,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 476},
                   koData =
                     ClassData{prior = -0.8224807666675318, unseen = -5.926926025970411,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4744143200522243, unseen = -7.189922170745808,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.496020557860377),
                                    ...
                                    ("<time-of-day> am|pmtomorrow", -5.579729825986222),
                               ...
                               n = 509},
                   koData =
                     ClassData{prior = -0.9735210597050016,
                               unseen = -6.8308742346461795,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.632569160176206),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.731181448844316),
                                    ("hourday", -3.6942995215832757),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.1366465569524795),
                                    ("<day-of-month> (ordinal)August", -6.1366465569524795),
                                    ("dayhour", -3.462497907525951),
                                    ("<time> timezoneyear (latent)", -5.443499376392534),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.220355825078324),
                                    ("Tuesdayfrom|since|after <time>", -5.443499376392534),
                                    ("daymonth", -3.462497907525951),
                                    ("monthyear", -4.883883588457112),
                                    ("<time-of-day> am|pmyear (latent)", -5.443499376392534),
                                    ("Thai Pongalyear (latent)", -5.443499376392534),
                                    ("intersecthh:mm", -6.1366465569524795),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.731181448844316),
                                    ("<day-of-month> (ordinal)Wednesday", -6.1366465569524795),
                                    ("houryear", -4.75035219583259),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.1366465569524795),
                                    ("<day-of-month> (ordinal)October", -6.1366465569524795),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.443499376392534),
                                    ("hournograin", -4.883883588457112),
                                    ("<time-of-day> am|pmintersect", -4.883883588457112),
                                    ("Octoberyear (latent)", -6.1366465569524795),
                                    ("Good Fridayyear (latent)", -5.731181448844316),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.731181448844316),
                                    ("early morningat <time-of-day>", -6.1366465569524795),
                                    ("until <time>on <day>", -5.443499376392534),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.1366465569524795),
                                    ("time-of-day (latent)intersect", -5.443499376392534),
                                    ("todayin <number> (implicit minutes)", -6.1366465569524795),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.443499376392534),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.1366465569524795),
                                    ("hh:mmon <day>", -4.883883588457112),
                                    ("hhhmmintersect", -5.731181448844316),
                                    ("absorption of , after named dayJuly", -5.220355825078324),
                                    ("from|since|after <time>July", -5.731181448844316),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.220355825078324),
                                    ("Clean Mondayyear (latent)", -6.1366465569524795),
                                    ("monthhour", -6.1366465569524795),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.731181448844316),
                                    ("hourmonth", -4.264844380050889),
                                    ("todayat <time-of-day>", -6.1366465569524795),
                                    ("Bank Holidayyear (latent)", -5.443499376392534),
                                    ("hhhmmyear (latent)", -4.883883588457112),
                                    ("from|since|after <time>December", -6.1366465569524795),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.1366465569524795),
                                    ("<time-of-day> am|pmon <day>", -4.883883588457112),
                                    ("Mondayyear (latent)", -5.443499376392534),
                                    ("dayday", -4.121743536410215),
                                    ("dd/mmat <time-of-day>", -5.731181448844316),
                                    ("on <day>September", -5.443499376392534),
                                    ("time-of-day (latent)September", -5.731181448844316),
                                    ("hourhour", -3.8853547583459846),
                                    ("time-of-day (latent)on <day>", -4.632569160176206),
                                    ("Thursdaydd/mm", -6.1366465569524795),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.731181448844316),
                                    ("dayyear", -3.0231312477421053),
                                    ("New Year's Dayyear (latent)", -5.220355825078324),
                                    ("time-of-day (latent)Sunday", -5.731181448844316),
                                    ("Thursdayfrom|since|after <time>", -4.431898464714054),
                                    ("Thursdayat <time-of-day>", -4.527208644518379),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.1366465569524795),
                                    ("Aprilyear (latent)", -6.1366465569524795),
                                    ("the <day-of-month> (ordinal)July", -6.1366465569524795),
                                    ("the <day-of-month> (number)July", -6.1366465569524795),
                                    ("monthminute", -6.1366465569524795),
                                    ("hourminute", -5.443499376392534),
                                    ("<time-of-day> am|pmtomorrow", -5.731181448844316),
                                    ("Thursdayhh:mm", -5.220355825078324),
                                    ("<day-of-month> (ordinal)Tuesday", -5.731181448844316),
                                    ("minutemonth", -3.996580393456209),
                                    ("time-of-day (latent)Friday", -5.731181448844316),
                                    ("minutehour", -6.1366465569524795),
                                    ("part of daysat <time-of-day>", -5.03803426828437),
                                    ("Augustyear (latent)", -5.731181448844316),
                                    ("week-endin|during <named-month>|year", -6.1366465569524795),
                                    ("time-of-day (latent)Tuesday", -5.731181448844316),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.1366465569524795),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.731181448844316),
                                    ("Sundayyear (latent)", -5.220355825078324),
                                    ("the <day-of-month> (ordinal)Monday", -5.443499376392534),
                                    ("Christmasat <time-of-day>", -6.1366465569524795),
                                    ("from|since|after <time>year (latent)", -5.03803426828437),
                                    ("dd/mmyear (latent)", -6.1366465569524795),
                                    ("hhhmmon <day>", -5.220355825078324),
                                    ("yesterday<time-of-day> am|pm", -6.1366465569524795),
                                    ("<day-of-month> (ordinal)July", -5.443499376392534),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.1366465569524795),
                                    ("at <time-of-day>intersect", -5.220355825078324),
                                    ("hh:mmyear (latent)", -4.75035219583259),
                                    ("Holiyear (latent)", -6.1366465569524795),
                                    ("until <time><time-of-day> am|pm", -6.1366465569524795),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.731181448844316),
                                    ("dayminute", -3.2744456760230114),
                                    ("yyyy-mm-ddhh:mm", -5.731181448844316),
                                    ("intersectfrom|since|after <time>", -5.731181448844316),
                                    ("intersectSeptember", -4.264844380050889),
                                    ("minuteday", -2.9796461358023665),
                                    ("absorption of , after named dayintersect",
                                     -6.1366465569524795),
                                    ("intersectyear (latent)", -6.1366465569524795),
                                    ("Februaryin|during the <part-of-day>", -6.1366465569524795),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.1366465569524795),
                                    ("time-of-day (latent)July", -5.443499376392534),
                                    ("Saturdayyear (latent)", -6.1366465569524795),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.1366465569524795),
                                    ("<day-of-month> (ordinal)Monday", -5.220355825078324),
                                    ("at <time-of-day>on <day>", -5.220355825078324),
                                    ("time-of-day (latent)<time-of-day> am|pm",
                                     -6.1366465569524795),
                                    ("absorption of , after named daySeptember",
                                     -4.883883588457112),
                                    ("Naraka Chaturdashiyear (latent)", -6.1366465569524795),
                                    ("from|since|after <time>on <day>", -5.220355825078324),
                                    ("dayweek", -6.1366465569524795),
                                    ("Easter Sundayyear (latent)", -5.731181448844316),
                                    ("time-of-day (latent)at <time-of-day>", -5.443499376392534),
                                    ("Thursday<time-of-day> am|pm", -4.883883588457112),
                                    ("weekyear", -5.731181448844316),
                                    ("time-of-day (latent)Thursday", -5.731181448844316),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.1366465569524795),
                                    ("<day-of-month> (ordinal)April", -6.1366465569524795),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.731181448844316),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.443499376392534),
                                    ("Sundayfrom|since|after <time>", -6.1366465569524795),
                                    ("absorption of , after named dayFebruary", -5.220355825078324),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.731181448844316),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.1366465569524795),
                                    ("tomorrowat <time-of-day>", -6.1366465569524795),
                                    ("daynograin", -5.731181448844316),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.731181448844316),
                                    ("last <cycle> of <time>year (latent)", -5.731181448844316),
                                    ("tomorrow<time-of-day> am|pm", -6.1366465569524795),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.443499376392534),
                                    ("Diwaliyear (latent)", -5.731181448844316),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.1366465569524795),
                                    ("this <part-of-day>at <time-of-day>", -5.220355825078324),
                                    ("Fridayyear (latent)", -5.220355825078324),
                                    ("time-of-day (latent)April", -6.1366465569524795),
                                    ("minuteyear", -3.9394219796162604)],
                               n = 309}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6196447185670187, unseen = -4.867534450455582,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 127},
                   koData =
                     ClassData{prior = -0.7724839227964664, unseen = -4.718498871295094,
                               likelihoods =
                                 HashMap.fromList
