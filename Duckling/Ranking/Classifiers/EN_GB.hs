...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6343451354198253, unseen = -5.981414211254481,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 394},
                   koData =
                     ClassData{prior = -0.7556241225153321, unseen = -5.860786223465865,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48550781578170077,
                               unseen = -7.0317412587631285,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.3377102955561755),
                                    ("Father's Dayyear (latent)", -6.3377102955561755),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.3377102955561755),
                                    ("Ramadanyear (latent)", -5.42141956368202),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.32280727501391),
                                    ("Bhai Doojyear (latent)", -6.3377102955561755),
                                    ("hourday", -4.32280727501391), ("dayhour", -3.393271316389735),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.32280727501391),
                                    ("Martin Luther King's Dayyear (latent)", -5.932245187448011),
                                    ("Shemini Atzeretyear (latent)", -6.3377102955561755),
                                    ("daymonth", -4.32280727501391),
                                    ("monthday", -5.932245187448011),
                                    ("monthyear", -4.54595082632812),
                                    ("Yom Ha'atzmautyear (latent)", -6.3377102955561755),
                                    ("Vijayadashamiyear (latent)", -6.3377102955561755),
                                    ("Thanksgiving Dayyear (latent)", -5.2390980068880655),
                                    ("Thai Pongalyear (latent)", -5.64456311499623),
                                    ("Thiru Onamyear (latent)", -5.64456311499623),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.3377102955561755),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.42141956368202),
                                    ("<day-of-month> (ordinal)Wednesday", -6.3377102955561755),
                                    ("Krishna Janmashtamiyear (latent)", -5.932245187448011),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.3377102955561755),
                                    ("houryear", -5.42141956368202),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.3377102955561755),
                                    ("Christmas<time-of-day> am|pm", -6.3377102955561755),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.3377102955561755),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.64456311499623),
                                    ("intersectin|during <named-month>|year", -6.3377102955561755),
                                    ("<time-of-day> am|pmintersect", -5.084947327060807),
                                    ("Earth Houryear (latent)", -6.3377102955561755),
                                    ("Octoberyear (latent)", -4.833632898779901),
                                    ("intersect<time-of-day> am|pm", -6.3377102955561755),
                                    ("Mattu Pongalyear (latent)", -6.3377102955561755),
                                    ("Shavuotyear (latent)", -6.3377102955561755),
                                    ("Parsi New Yearyear (latent)", -5.42141956368202),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.3377102955561755),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.3377102955561755),
                                    ("todayin|within|after <duration>", -6.3377102955561755),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.932245187448011),
                                    ("Marchyear (latent)", -6.3377102955561755),
                                    ("Sukkotyear (latent)", -5.932245187448011),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.64456311499623),
                                    ("todayat <time-of-day>", -6.3377102955561755),
                                    ("Thursday<time> timezone", -4.391800146500862),
                                    ("time-of-day (latent)tonight", -5.932245187448011),
                                    ("from|since|after <time>December", -6.3377102955561755),
                                    ("dd/mm<time-of-day> am|pm", -6.3377102955561755),
                                    ("<time-of-day> am|pmon <day>", -4.32280727501391),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.3377102955561755),
                                    ("yyyy-mm-ddhh:mm:ss", -5.932245187448011),
                                    ("dayday", -3.8953632601869708),
                                    ("dd/mmat <time-of-day>", -6.3377102955561755),
                                    ("<time> <part-of-day>at <time-of-day>", -6.3377102955561755),
                                    ("tonightat <time-of-day>", -6.3377102955561755),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.64456311499623),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.3377102955561755),
                                    ("today<time-of-day> am|pm", -6.3377102955561755),
                                    ("Februarythe <day-of-month> (ordinal)", -5.932245187448011),
                                    ("at <time-of-day><time> <part-of-day>", -6.3377102955561755),
                                    ("<day-of-month> (ordinal)intersect", -5.932245187448011),
                                    ("hourhour", -4.258268753876339),
                                    ("Navaratriin|during <named-month>|year", -6.3377102955561755),
                                    ("Wednesdaythis|last|next <cycle>", -6.3377102955561755),
                                    ("Lentyear (latent)", -6.3377102955561755),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.833632898779901),
                                    ("Boghiyear (latent)", -6.3377102955561755),
                                    ("dayyear", -1.8891939196134606),
                                    ("Thursdayfrom|since|after <time>", -5.932245187448011),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.3377102955561755),
                                    ("Thursdayat <time-of-day>", -5.64456311499623),
                                    ("Islamic New Yearyear (latent)", -5.932245187448011),
                                    ("Laylat al-Qadryear (latent)", -5.42141956368202),
                                    ("Shrove Tuesdayyear (latent)", -6.3377102955561755),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.64456311499623),
                                    ("<time-of-day> am|pmtomorrow", -5.64456311499623),
                                    ("Yom Kippuryear (latent)", -6.3377102955561755),
                                    ("<day-of-month> (ordinal)Tuesday", -5.932245187448011),
                                    ("<part-of-day> of <time>year (latent)", -6.3377102955561755),
                                    ("minutehour", -5.2390980068880655),
                                    ("Kaanum Pongalyear (latent)", -5.932245187448011),
                                    ("Maha Saptamiyear (latent)", -6.3377102955561755),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.932245187448011),
                                    ("time-of-day (latent)tomorrow", -5.42141956368202),
                                    ("part of daysat <time-of-day>", -5.932245187448011),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.63296220331775),
                                    ("for <duration> from <time>December", -6.3377102955561755),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.3377102955561755),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.084947327060807),
                                    ("time-of-day (latent)this <part-of-day>", -6.3377102955561755),
                                    ("Pentecostyear (latent)", -6.3377102955561755),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.084947327060807),
                                    ("<day-of-month> (ordinal)February", -6.3377102955561755),
                                    ("Eid al-Fitryear (latent)", -5.42141956368202),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.3377102955561755),
                                    ("Mondayin|during the <part-of-day>", -6.3377102955561755),
                                    ("Chhathin|during <named-month>|year", -6.3377102955561755),
                                    ("Diwaliin|during <named-month>|year", -6.3377102955561755),
                                    ("Vaisakhiin|during <named-month>|year", -6.3377102955561755),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.084947327060807),
                                    ("Raksha Bandhanyear (latent)", -6.3377102955561755),
                                    ("daysecond", -5.932245187448011),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.932245187448011),
                                    ("Ashurayear (latent)", -6.3377102955561755),
                                    ("Tuesdayin|during <named-month>|year", -6.3377102955561755),
                                    ("Chinese New Yearyear (latent)", -6.3377102955561755),
                                    ("tomorrowintersect", -6.3377102955561755),
                                    ("Lag BaOmeryear (latent)", -6.3377102955561755),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.3377102955561755),
                                    ("Eid al-Adhayear (latent)", -4.197644132059905),
                                    ("intersectin|during the <part-of-day>", -6.3377102955561755),
                                    ("Palm Sundayyear (latent)", -6.3377102955561755),
                                    ("Christmasat <time-of-day>", -6.3377102955561755),
                                    ("Passoveryear (latent)", -6.3377102955561755),
                                    ("Lazarus Saturdayyear (latent)", -6.3377102955561755),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.3377102955561755),
                                    ("Yom HaShoahyear (latent)", -5.932245187448011),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.932245187448011),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.3377102955561755),
                                    ("Septemberyear (latent)", -5.932245187448011),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.833632898779901),
                                    ("Halloweenyear (latent)", -6.3377102955561755),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.3377102955561755),
                                    ("at <time-of-day>intersect", -5.932245187448011),
                                    ("Rosh Hashanahyear (latent)", -5.64456311499623),
                                    ("Dhanterasyear (latent)", -6.3377102955561755),
                                    ("Tu BiShvatyear (latent)", -6.3377102955561755),
                                    ("<day-of-month> (ordinal)December", -5.64456311499623),
                                    ("Holiyear (latent)", -5.64456311499623),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.3377102955561755),
                                    ("Holika Dahanyear (latent)", -5.64456311499623),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.3377102955561755),
                                    ("dayminute", -3.419939563471896),
                                    ("Mawlidyear (latent)", -6.3377102955561755),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.932245187448011),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.3377102955561755),
                                    ("Jumu'atul-Widayear (latent)", -5.42141956368202),
                                    ("minuteday", -2.50906889906708),
                                    ("absorption of , after named dayintersect",
                                     -6.3377102955561755),
                                    ("intersectyear (latent)", -6.3377102955561755),
                                    ("Orthodox Easter Sundayyear (latent)", -6.3377102955561755),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.3377102955561755),
                                    ("Mothering Sundayyear (latent)", -5.932245187448011),
                                    ("Boss's Dayyear (latent)", -5.932245187448011),
                                    ("Global Youth Service Dayyear (latent)", -6.3377102955561755),
                                    ("Dhanterasin|during <named-month>|year", -6.3377102955561755),
                                    ("Tisha B'Avyear (latent)", -6.3377102955561755),
                                    ("Isra and Mi'rajyear (latent)", -5.42141956368202),
                                    ("at <time-of-day>on <day>", -5.2390980068880655),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.3377102955561755),
                                    ("time-of-day (latent)<time> <part-of-day>", -5.64456311499623),
                                    ("Christmasyear (latent)", -5.932245187448011),
                                    ("Naraka Chaturdashiyear (latent)", -5.932245187448011),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.3377102955561755),
                                    ("dayweek", -6.3377102955561755),
                                    ("Easter Sundayyear (latent)", -5.64456311499623),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.728272383122075),
                                    ("weekyear", -5.2390980068880655),
                                    ("King's Dayyear (latent)", -4.833632898779901),
                                    ("hh:mmin|during the <part-of-day>", -5.64456311499623),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.932245187448011),
                                    ("Hanukkahyear (latent)", -5.64456311499623),
                                    ("February<time> <part-of-day>", -6.3377102955561755),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.3377102955561755),
                                    ("Great Lentyear (latent)", -6.3377102955561755),
                                    ("tomorrowat <time-of-day>", -5.64456311499623),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.3377102955561755),
                                    ("Vaisakhiyear (latent)", -5.64456311499623),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.3377102955561755),
                                    ("last <cycle> of <time>year (latent)", -5.64456311499623),
                                    ("at <time-of-day>tomorrow", -5.932245187448011),
                                    ("tomorrow<time-of-day> am|pm", -6.3377102955561755),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.3377102955561755),
                                    ("Diwaliyear (latent)", -6.3377102955561755),
                                    ("between <time> and <time>on <day>", -4.728272383122075),
                                    ("Black Fridayyear (latent)", -5.932245187448011),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.3377102955561755),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.3377102955561755),
                                    ("Chhathyear (latent)", -5.932245187448011),
                                    ("Vasant Panchamiyear (latent)", -6.3377102955561755),
                                    ("Rabindra Jayantiyear (latent)", -5.084947327060807),
                                    ("St Patrick's Dayyear (latent)", -6.3377102955561755),
                                    ("Thursday<time> (timezone)", -6.3377102955561755),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.3377102955561755),
                                    ("August Bank Holidayyear (latent)", -5.64456311499623),
                                    ("<datetime> - <datetime> (interval)July", -5.932245187448011),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.932245187448011),
                                    ("Februaryintersect", -6.3377102955561755),
                                    ("Simchat Torahyear (latent)", -6.3377102955561755),
                                    ("minuteyear", -6.3377102955561755)],
                               n = 432},
                   koData =
                     ClassData{prior = -0.9555114450274363, unseen = -6.694562058521095,
                               likelihoods =
                                 HashMap.fromList
                                   [("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.594711379601839),
                                    ("hourday", -3.292126286607793),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.000176487710004),
                                    ("<day-of-month> (ordinal)August", -6.000176487710004),
                                    ("dayhour", -3.326027838283475),
                                    ("<time> timezoneyear (latent)", -6.000176487710004),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.083885755835849),
                                    ("Tuesdayfrom|since|after <time>", -6.000176487710004),
                                    ("daymonth", -3.5152698379220033),
                                    ("monthyear", -4.747413519214636),
                                    ("<time-of-day> am|pmyear (latent)", -5.307029307150058),
                                    ("Thai Pongalyear (latent)", -5.307029307150058),
                                    ("intersecthh:mm", -6.000176487710004),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.594711379601839),
                                    ("<day-of-month> (ordinal)Wednesday", -6.000176487710004),
                                    ("houryear", -4.613882126590113),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.000176487710004),
                                    ("<day-of-month> (ordinal)October", -6.000176487710004),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.307029307150058),
                                    ("<time-of-day> am|pmintersect", -4.747413519214636),
                                    ("Octoberyear (latent)", -6.000176487710004),
                                    ("until <time>on <day>", -5.307029307150058),
                                    ("time-of-day (latent)intersect", -6.000176487710004),
                                    ("todayin <number> (implicit minutes)", -6.000176487710004),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.307029307150058),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.000176487710004),
                                    ("hh:mmon <day>", -3.557829452340799),
                                    ("absorption of , after named dayJuly", -5.594711379601839),
                                    ("from|since|after <time>July", -5.594711379601839),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.083885755835849),
                                    ("Clean Mondayyear (latent)", -6.000176487710004),
                                    ("monthhour", -6.000176487710004),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.594711379601839),
                                    ("hourmonth", -4.128374310808412),
                                    ("todayat <time-of-day>", -6.000176487710004),
                                    ("Bank Holidayyear (latent)", -5.307029307150058),
                                    ("from|since|after <time>December", -6.000176487710004),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.000176487710004),
                                    ("<time-of-day> am|pmon <day>", -4.747413519214636),
                                    ("Mondayyear (latent)", -5.307029307150058),
                                    ("dayday", -4.613882126590113),
                                    ("dd/mmat <time-of-day>", -5.594711379601839),
                                    ("on <day>September", -5.594711379601839),
                                    ("time-of-day (latent)September", -5.594711379601839),
                                    ("hourhour", -5.083885755835849),
                                    ("time-of-day (latent)on <day>", -3.557829452340799),
                                    ("Thursdaydd/mm", -6.000176487710004),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.594711379601839),
                                    ("dayyear", -2.979751601565641),
                                    ("New Year's Dayyear (latent)", -5.083885755835849),
                                    ("Thursdayfrom|since|after <time>", -4.295428395471578),
                                    ("Thursdayat <time-of-day>", -4.390738575275903),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.000176487710004),
                                    ("Aprilyear (latent)", -6.000176487710004),
                                    ("the <day-of-month> (ordinal)July", -6.000176487710004),
                                    ("the <day-of-month> (number)July", -6.000176487710004),
                                    ("monthminute", -6.000176487710004),
                                    ("hourminute", -5.307029307150058),
                                    ("<time-of-day> am|pmtomorrow", -6.000176487710004),
                                    ("Thursdayhh:mm", -5.083885755835849),
                                    ("<day-of-month> (ordinal)Tuesday", -5.594711379601839),
                                    ("minutemonth", -4.128374310808412),
                                    ("minutehour", -6.000176487710004),
                                    ("Augustyear (latent)", -5.594711379601839),
                                    ("week-endin|during <named-month>|year", -6.000176487710004),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.000176487710004),
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.594711379601839),
                                    ("Sundayyear (latent)", -5.083885755835849),
                                    ("Christmasat <time-of-day>", -6.000176487710004),
                                    ("from|since|after <time>year (latent)", -4.901564199041894),
                                    ("dd/mmyear (latent)", -6.000176487710004),
                                    ("<duration> after|before|from <time>December",
                                     -6.000176487710004),
                                    ("yesterday<time-of-day> am|pm", -6.000176487710004),
                                    ("<day-of-month> (ordinal)July", -5.307029307150058),
                                    ...
                                    ("hh:mmyear (latent)", -3.9207349460301675),
                                    ("Holiyear (latent)", -6.000176487710004),
                                    ("until <time><time-of-day> am|pm", -6.000176487710004),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.000176487710004),
                                    ("dayminute", -3.39748680226562),
                                    ("yyyy-mm-ddhh:mm", -5.594711379601839),
                                    ("intersectSeptember", -4.496099090933729),
                                    ("minuteday", -2.761498035545623),
                                    ("absorption of , after named dayintersect",
                                     -6.000176487710004),
                                    ("intersectyear (latent)", -6.000176487710004),
                                    ("Februaryin|during the <part-of-day>", -6.000176487710004),
                                    ("time-of-day (latent)July", -5.307029307150058),
                                    ("Saturdayyear (latent)", -6.000176487710004),
                                    ("at <time-of-day>on <day>", -5.594711379601839),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.000176487710004),
                                    ("absorption of , after named daySeptember",
                                     -5.083885755835849),
                                    ("Naraka Chaturdashiyear (latent)", -6.000176487710004),
                                    ("from|since|after <time>on <day>", -5.083885755835849),
                                    ("dayweek", -6.000176487710004),
                                    ("Easter Sundayyear (latent)", -5.594711379601839),
                                    ("time-of-day (latent)at <time-of-day>", -5.307029307150058),
                                    ("Thursday<time-of-day> am|pm", -4.747413519214636),
                                    ("weekyear", -5.594711379601839),
                                    ("time-of-day (latent)Thursday", -5.594711379601839),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.000176487710004),
                                    ("<day-of-month> (ordinal)April", -6.000176487710004),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.594711379601839),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.307029307150058),
                                    ("Sundayfrom|since|after <time>", -6.000176487710004),
                                    ("absorption of , after named dayFebruary", -5.083885755835849),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.000176487710004),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.000176487710004),
                                    ("tomorrowat <time-of-day>", -6.000176487710004),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.594711379601839),
                                    ("last <cycle> of <time>year (latent)", -5.594711379601839),
                                    ("tomorrow<time-of-day> am|pm", -6.000176487710004),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.307029307150058),
                                    ("Diwaliyear (latent)", -5.594711379601839),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.000176487710004),
                                    ("Fridayyear (latent)", -5.594711379601839),
                                    ("time-of-day (latent)April", -6.000176487710004),
                                    ("minuteyear", -3.802951910373784)],
                               n = 270}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
