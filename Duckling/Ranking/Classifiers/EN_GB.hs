...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("at <time-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.22931006622987374,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<time> timezone", -3.9560398908449206),
                                    ...
                                    ("hhhmm", -3.7328963395307104),
                                    ("<hour-of-day> <integer>", -3.9560398908449206),
                                    ("time-of-day (latent)", -1.6534547978508747),
                                    ("hhmm (latent)", -3.9560398908449206),
                                    ("<time-of-day> am|pm", -1.975038421978337),
                                    ("hh:mm", -3.262892710284975),
                                    ("about|exactly <time-of-day>", -4.243721963296701),
                                    ("hour", -1.1228265467887044),
                                    ("<time-of-day> sharp|exactly", -4.6491870714048655),
                                    ("minute", -1.9083470474796649)],
                               n = 97},
                   koData =
                     ClassData{prior = -1.5851452198650557, unseen = -4.189654742026425,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -3.332204510175204),
                                    ("<integer> more <unit-of-duration>", -4.02535169073515),
                                    ("three-quarters of an hour", -3.109060958860994),
                                    ("<integer> + '\"", -3.332204510175204),
                                    ("number.number hours", -4.02535169073515),
                                    ("second", -3.619886582626985),
                                    ("half a <time-grain>", -3.109060958860994),
                                    ("day", -3.332204510175204), ("year", -4.02535169073515),
                                    ("<integer> <unit-of-duration>", -1.6274564179367788),
                                    ("a <unit-of-duration>", -3.109060958860994),
                                    ("quarter of an hour", -3.109060958860994),
                                    ("hour", -2.521274293958875),
                                    ("about|exactly <duration>", -3.619886582626985),
                                    ("half an hour (abbrev).", -3.619886582626985),
                                    ("<integer> and an half hour", -4.02535169073515),
                                    ("minute", -1.2845116668099483)],
                               n = 47},
                   koData =
                     ClassData{prior = -2.178532444324067, unseen = -3.4339872044851463,
                               likelihoods =
                                 HashMap.fromList
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = 0.0, unseen = -3.0910424533583156,
                               likelihoods =
                                 HashMap.fromList
                                   [("negative numbersinteger (numeric)", -1.252762968495368),
                                    ("about|exactly <numeral>integer (numeric)",
                                     -2.3513752571634776),
                                    ("integer (numeric)integer (numeric)", -0.6466271649250525),
                                    ("fractional numberinteger (numeric)", -2.3513752571634776)],
                               n = 17}}),
       ("one twenty two",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.0986122886681098,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4997626899166835, unseen = -7.1929342212158,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.4990348781533),
                                    ("Father's Dayyear (latent)", -6.4990348781533),
                                    ("Karva Chauthyear (latent)", -6.4990348781533),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.4990348781533),
                                    ("Maha Shivaratriyear (latent)", -6.4990348781533),
                                    ("Ramadanyear (latent)", -5.246271909657932),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.1127405170334095),
                                    ("Bhai Doojyear (latent)", -6.4990348781533),
                                    ("hourday", -4.484131857611035),
                                    ("dayhour", -3.4786099920089377),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.1127405170334095),
                                    ("Martin Luther King's Dayyear (latent)", -6.093569770045136),
                                    ("Shemini Atzeretyear (latent)", -6.4990348781533),
                                    ("daymonth", -4.484131857611035),
                                    ("monthday", -6.093569770045136),
                                    ("monthyear", -4.707275408925245),
                                    ("Yom Ha'atzmautyear (latent)", -6.4990348781533),
                                    ("Orthodox Good Fridayyear (latent)", -6.093569770045136),
                                    ("Vijayadashamiyear (latent)", -6.4990348781533),
                                    ("Thanksgiving Dayyear (latent)", -5.40042258948519),
                                    ("Thai Pongalyear (latent)", -5.805887697593355),
                                    ("Thiru Onamyear (latent)", -5.805887697593355),
                                    ("hhhmmabsorption of , after named day", -6.4990348781533),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.4990348781533),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.582744146279145),
                                    ("<day-of-month> (ordinal)Wednesday", -6.4990348781533),
                                    ("Krishna Janmashtamiyear (latent)", -6.093569770045136),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.4990348781533),
                                    ("houryear", -5.582744146279145),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.4990348781533),
                                    ("Christmas<time-of-day> am|pm", -6.4990348781533),
                                    ("last <day-of-week> of <time>year (latent)", -6.4990348781533),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.805887697593355),
                                    ("intersectin|during <named-month>|year", -6.4990348781533),
                                    ("<time-of-day> am|pmintersect", -5.246271909657932),
                                    ("Earth Houryear (latent)", -6.4990348781533),
                                    ("Ganesh Chaturthiyear (latent)", -6.4990348781533),
                                    ("Octoberyear (latent)", -4.994957481377026),
                                    ("intersect<time-of-day> am|pm", -6.4990348781533),
                                    ("Mattu Pongalyear (latent)", -6.4990348781533),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.4990348781533),
                                    ("Shavuotyear (latent)", -6.4990348781533),
                                    ("Parsi New Yearyear (latent)", -5.582744146279145),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.4990348781533),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.4990348781533),
                                    ("todayin|within|after <duration>", -6.4990348781533),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.093569770045136),
                                    ("Marchyear (latent)", -6.4990348781533),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.093569770045136),
                                    ("Sukkotyear (latent)", -6.093569770045136),
                                    ("hhhmmintersect", -6.093569770045136),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.093569770045136),
                                    ("Clean Mondayyear (latent)", -6.093569770045136),
                                    ("monthhour", -6.093569770045136),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.805887697593355),
                                    ("todayat <time-of-day>", -6.4990348781533),
                                    ("Thursday<time> timezone", -4.10113960535493),
                                    ("tonight<time-of-day> am|pm", -6.4990348781533),
                                    ("time-of-day (latent)tonight", -6.093569770045136),
                                    ("from|since|after <time>December", -6.4990348781533),
                                    ("dd/mm<time-of-day> am|pm", -6.4990348781533),
                                    ("<time-of-day> am|pmon <day>", -4.484131857611035),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -6.4990348781533),
                                    ("yyyy-mm-ddhh:mm:ss", -6.093569770045136),
                                    ("dayday", -3.7909846770510898),
                                    ("dd/mmat <time-of-day>", -6.4990348781533),
                                    ("<time> <part-of-day>at <time-of-day>", -6.093569770045136),
                                    ("tonightat <time-of-day>", -5.40042258948519),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.805887697593355),
                                    ("Dayananda Saraswati Jayantiyear (latent)", -6.4990348781533),
                                    ("today<time-of-day> am|pm", -6.4990348781533),
                                    ("Februarythe <day-of-month> (ordinal)", -6.093569770045136),
                                    ("at <time-of-day><time> <part-of-day>", -6.4990348781533),
                                    ("<day-of-month> (ordinal)intersect", -6.093569770045136),
                                    ("hourhour", -3.528620412583599),
                                    ("Mahavir Jayantiyear (latent)", -6.093569770045136),
                                    ("Navaratriin|during <named-month>|year", -6.4990348781533),
                                    ("Wednesdaythis|last|next <cycle>", -6.4990348781533),
                                    ("Lentyear (latent)", -6.4990348781533),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.6272327012517085),
                                    ("Boghiyear (latent)", -6.4990348781533),
                                    ("dayyear", -1.898877233988753),
                                    ("Karva Chauthin|during <named-month>|year", -6.4990348781533),
                                    ("Thursdayfrom|since|after <time>", -6.093569770045136),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.4990348781533),
                                    ("Thursdayat <time-of-day>", -5.805887697593355),
                                    ("Islamic New Yearyear (latent)", -6.093569770045136),
                                    ("Laylat al-Qadryear (latent)", -5.582744146279145),
                                    ("part of days<time-of-day> am|pm", -6.4990348781533),
                                    ("Shrove Tuesdayyear (latent)", -6.4990348781533),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.805887697593355),
                                    ("hourminute", -6.093569770045136),
                                    ("<time-of-day> am|pmtomorrow", -5.582744146279145),
                                    ("Yom Kippuryear (latent)", -6.4990348781533),
                                    ("<day-of-month> (ordinal)Tuesday", -6.093569770045136),
                                    ("<part-of-day> of <time>year (latent)", -6.4990348781533),
                                    ("minutehour", -5.246271909657932),
                                    ("Kaanum Pongalyear (latent)", -6.093569770045136),
                                    ("Maha Saptamiyear (latent)", -6.4990348781533),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.805887697593355),
                                    ("time-of-day (latent)tomorrow", -5.582744146279145),
                                    ("part of daysat <time-of-day>", -4.8895969657192),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.484131857611035),
                                    ("for <duration> from <time>December", -6.4990348781533),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.4990348781533),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.246271909657932),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.246271909657932),
                                    ("time-of-day (latent)this <part-of-day>", -6.4990348781533),
                                    ("Pentecostyear (latent)", -6.4990348781533),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.246271909657932),
                                    ("<day-of-month> (ordinal)February", -6.4990348781533),
                                    ("Eid al-Fitryear (latent)", -5.1127405170334095),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.4990348781533),
                                    ("Mondayin|during the <part-of-day>", -6.4990348781533),
                                    ("Chhathin|during <named-month>|year", -6.4990348781533),
                                    ("Diwaliin|during <named-month>|year", -6.4990348781533),
                                    ("this <part-of-day><time-of-day> am|pm", -6.4990348781533),
                                    ("Vaisakhiin|during <named-month>|year", -6.4990348781533),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.246271909657932),
                                    ("Raksha Bandhanyear (latent)", -6.4990348781533),
                                    ("daysecond", -6.093569770045136),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.093569770045136),
                                    ("Ratha-Yatrayear (latent)", -6.4990348781533),
                                    ("Ashurayear (latent)", -6.4990348781533),
                                    ("Tuesdayin|during <named-month>|year", -6.4990348781533),
                                    ("Chinese New Yearyear (latent)", -6.4990348781533),
                                    ("tomorrowintersect", -6.4990348781533),
                                    ("Lag BaOmeryear (latent)", -6.4990348781533),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.4990348781533),
                                    ("Eid al-Adhayear (latent)", -4.3589687146570295),
                                    ("intersectin|during the <part-of-day>", -6.4990348781533),
                                    ("Palm Sundayyear (latent)", -6.4990348781533),
                                    ("Christmasat <time-of-day>", -6.4990348781533),
                                    ("Passoveryear (latent)", -6.4990348781533),
                                    ("Lazarus Saturdayyear (latent)", -6.4990348781533),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.4990348781533),
                                    ("hhhmmon <day>", -5.582744146279145),
                                    ("Yom HaShoahyear (latent)", -6.093569770045136),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.093569770045136),
                                    ("Septemberyear (latent)", -6.093569770045136),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.994957481377026),
                                    ("Halloweenyear (latent)", -6.4990348781533),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.4990348781533),
                                    ("at <time-of-day>intersect", -5.582744146279145),
                                    ("Rosh Hashanahyear (latent)", -5.805887697593355),
                                    ("Dhanterasyear (latent)", -6.4990348781533),
                                    ("Tu BiShvatyear (latent)", -6.4990348781533),
                                    ("<day-of-month> (ordinal)December", -5.805887697593355),
                                    ("Holiyear (latent)", -5.805887697593355),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.4990348781533),
                                    ("Holika Dahanyear (latent)", -5.805887697593355),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.093569770045136),
                                    ("dayminute", -3.149130790878695),
                                    ("Mawlidyear (latent)", -6.4990348781533),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.093569770045136),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.4990348781533),
                                    ("Jumu'atul-Widayear (latent)", -5.582744146279145),
                                    ("minuteday", -2.7495308022229286),
                                    ("absorption of , after named dayintersect",
                                     -5.805887697593355),
                                    ("intersectyear (latent)", -6.4990348781533),
                                    ("Orthodox Easter Sundayyear (latent)", -6.4990348781533),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.4990348781533),
                                    ("<ordinal> <cycle> of <time>year (latent)", -6.4990348781533),
                                    ("intersecthhhmm", -6.093569770045136),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.4990348781533),
                                    ("Mothering Sundayyear (latent)", -6.093569770045136),
                                    ("Boss's Dayyear (latent)", -6.093569770045136),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.4990348781533),
                                    ("Global Youth Service Dayyear (latent)", -6.4990348781533),
                                    ("Dhanterasin|during <named-month>|year", -6.4990348781533),
                                    ("tonight<time-of-day> o'clock", -6.4990348781533),
                                    ("Tisha B'Avyear (latent)", -6.4990348781533),
                                    ("Isra and Mi'rajyear (latent)", -5.582744146279145),
                                    ("at <time-of-day>on <day>", -4.8895969657192),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.093569770045136),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.805887697593355),
                                    ("Christmasyear (latent)", -6.093569770045136),
                                    ("Saturdayintersect", -6.4990348781533),
                                    ("Naraka Chaturdashiyear (latent)", -6.093569770045136),
                                    ("Thai Pongalin|during <named-month>|year", -6.4990348781533),
                                    ("dayweek", -6.4990348781533),
                                    ("Easter Sundayyear (latent)", -5.805887697593355),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.093569770045136),
                                    ("weekyear", -5.40042258948519),
                                    ("King's Dayyear (latent)", -4.994957481377026),
                                    ("hh:mmin|during the <part-of-day>", -5.582744146279145),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.093569770045136),
                                    ("Hanukkahyear (latent)", -5.805887697593355),
                                    ("Rama Navamiyear (latent)", -6.4990348781533),
                                    ("February<time> <part-of-day>", -6.4990348781533),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.805887697593355),
                                    ("Great Lentyear (latent)", -6.4990348781533),
                                    ("tomorrowat <time-of-day>", -5.805887697593355),
                                    ("hhmm (latent)in|during the <part-of-day>", -6.4990348781533),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.093569770045136),
                                    ("Ugadiyear (latent)", -5.1127405170334095),
                                    ("Vaisakhiyear (latent)", -5.805887697593355),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.805887697593355),
                                    ("last <cycle> of <time>year (latent)", -5.805887697593355),
                                    ("at <time-of-day>tomorrow", -6.093569770045136),
                                    ("tomorrow<time-of-day> am|pm", -6.4990348781533),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.4990348781533),
                                    ("Diwaliyear (latent)", -6.4990348781533),
                                    ("between <time> and <time>on <day>", -6.093569770045136),
                                    ("Black Fridayyear (latent)", -6.093569770045136),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.4990348781533),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.4990348781533),
                                    ("Chhathyear (latent)", -6.093569770045136),
                                    ("Vasant Panchamiyear (latent)", -6.4990348781533),
                                    ("Rabindra Jayantiyear (latent)", -5.246271909657932),
                                    ("this <part-of-day>at <time-of-day>", -5.246271909657932),
                                    ("St Patrick's Dayyear (latent)", -6.4990348781533),
                                    ("Thursday<time> (timezone)", -6.4990348781533),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.4990348781533),
                                    ("Pargat Diwasyear (latent)", -5.246271909657932),
                                    ("August Bank Holidayyear (latent)", -5.805887697593355),
                                    ("<datetime> - <datetime> (interval)July", -6.093569770045136),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.805887697593355),
                                    ("Februaryintersect", -6.4990348781533),
                                    ("Simchat Torahyear (latent)", -6.4990348781533),
                                    ("minuteyear", -6.4990348781533)],
                               n = 509},
                   koData =
                     ClassData{prior = -0.9331180520066802, unseen = -6.879355804460439,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.681101890955105),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.779714179623215),
                                    ("hourday", -3.582489602286996),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.18517928773138),
                                    ("<day-of-month> (ordinal)August", -6.18517928773138),
                                    ("dayhour", -3.511030638304851),
                                    ("<time> timezoneyear (latent)", -5.492032107171434),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.268888555857225),
                                    ("Tuesdayfrom|since|after <time>", -5.492032107171434),
                                    ("daymonth", -3.4771290866291693),
                                    ("hourquarter", -5.268888555857225),
                                    ("monthyear", -4.932416319236012),
                                    ("<time-of-day> am|pmyear (latent)", -5.492032107171434),
                                    ("Thai Pongalyear (latent)", -5.492032107171434),
                                    ("intersecthh:mm", -6.18517928773138),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.779714179623215),
                                    ("<day-of-month> (ordinal)Wednesday", -6.18517928773138),
                                    ("houryear", -4.393419818503324),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.18517928773138),
                                    ("<day-of-month> (ordinal)October", -6.18517928773138),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.492032107171434),
                                    ("hournograin", -4.932416319236012),
                                    ("<time-of-day> am|pmintersect", -4.932416319236012),
                                    ("Octoberyear (latent)", -6.18517928773138),
                                    ("Good Fridayyear (latent)", -5.779714179623215),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.779714179623215),
                                    ("early morningat <time-of-day>", -6.18517928773138),
                                    ("until <time>on <day>", -5.492032107171434),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.18517928773138),
                                    ("time-of-day (latent)intersect", -5.492032107171434),
                                    ("todayin <number> (implicit minutes)", -6.18517928773138),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.492032107171434),
                                    ("this <part-of-day><time-of-day> - <time-of-day> (interval)",
                                     -6.18517928773138),
                                    ("about|exactly <time-of-day>year (latent)", -6.18517928773138),
                                    ("hh:mmon <day>", -4.932416319236012),
                                    ("hhhmmintersect", -5.779714179623215),
                                    ("absorption of , after named dayJuly", -5.268888555857225),
                                    ("from|since|after <time>July", -5.779714179623215),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.268888555857225),
                                    ("Clean Mondayyear (latent)", -6.18517928773138),
                                    ("monthhour", -6.18517928773138),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.779714179623215),
                                    ("hourmonth", -4.045113124235109),
                                    ("todayat <time-of-day>", -6.18517928773138),
                                    ("Bank Holidayyear (latent)", -5.492032107171434),
                                    ("hhhmmyear (latent)", -4.932416319236012),
                                    ("from|since|after <time>December", -6.18517928773138),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.18517928773138),
                                    ("<time-of-day> am|pmon <day>", -4.932416319236012),
                                    ("Mondayyear (latent)", -5.492032107171434),
                                    ("dayday", -4.170276267189115),
                                    ("dd/mmat <time-of-day>", -5.779714179623215),
                                    ("on <day>September", -5.492032107171434),
                                    ("time-of-day (latent)September", -5.779714179623215),
                                    ("hourhour", -3.9338874891248845),
                                    ("time-of-day (latent)on <day>", -4.681101890955105),
                                    ("Thursdaydd/mm", -6.18517928773138),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.779714179623215),
                                    ("dayyear", -3.071663978521005),
                                    ("New Year's Dayyear (latent)", -5.268888555857225),
                                    ("time-of-day (latent)Sunday", -5.779714179623215),
                                    ("Thursdayfrom|since|after <time>", -4.4804311954929545),
                                    ("Thursdayat <time-of-day>", -4.575741375297279),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.18517928773138),
                                    ("Aprilyear (latent)", -6.18517928773138),
                                    ("the <day-of-month> (ordinal)July", -6.18517928773138),
                                    ("the <day-of-month> (number)July", -6.18517928773138),
                                    ("monthminute", -6.18517928773138),
                                    ("hourminute", -5.492032107171434),
                                    ("<time-of-day> am|pmtomorrow", -5.779714179623215),
                                    ("Thursdayhh:mm", -5.268888555857225),
                                    ("<day-of-month> (ordinal)Tuesday", -5.779714179623215),
                                    ("minutemonth", -4.045113124235109),
                                    ("time-of-day (latent)Friday", -5.779714179623215),
                                    ("minutehour", -6.18517928773138),
                                    ("part of daysat <time-of-day>", -5.08656699906327),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.8338040305679018),
                                    ("Augustyear (latent)", -5.779714179623215),
                                    ("week-endin|during <named-month>|year", -6.18517928773138),
                                    ("time-of-day (latent)Tuesday", -5.779714179623215),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.18517928773138),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.779714179623215),
                                    ("Sundayyear (latent)", -5.268888555857225),
                                    ("hourweek", -5.268888555857225),
                                    ("the <day-of-month> (ordinal)Monday", -5.492032107171434),
                                    ("Christmasat <time-of-day>", -6.18517928773138),
                                    ("from|since|after <time>year (latent)", -5.08656699906327),
                                    ("dd/mmyear (latent)", -6.18517928773138),
                                    ("hhhmmon <day>", -5.268888555857225),
                                    ("yesterday<time-of-day> am|pm", -6.18517928773138),
                                    ("<day-of-month> (ordinal)July", -5.492032107171434),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.18517928773138),
                                    ("at <time-of-day>intersect", -5.268888555857225),
                                    ("hh:mmyear (latent)", -4.798884926611489),
                                    ("Holiyear (latent)", -6.18517928773138),
                                    ("until <time><time-of-day> am|pm", -6.18517928773138),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.779714179623215),
                                    ("dayminute", -3.3229784068019113),
                                    ("yyyy-mm-ddhh:mm", -5.779714179623215),
                                    ("intersectfrom|since|after <time>", -5.779714179623215),
                                    ("intersectSeptember", -4.313377110829788),
                                    ("minuteday", -3.0281788665812663),
                                    ("absorption of , after named dayintersect", -6.18517928773138),
                                    ("intersectyear (latent)", -6.18517928773138),
                                    ("Februaryin|during the <part-of-day>", -6.18517928773138),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.18517928773138),
                                    ("time-of-day (latent)July", -5.492032107171434),
                                    ("Saturdayyear (latent)", -6.18517928773138),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.18517928773138),
                                    ("<day-of-month> (ordinal)Monday", -5.268888555857225),
                                    ("at <time-of-day>on <day>", -5.268888555857225),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.18517928773138),
                                    ("absorption of , after named daySeptember",
                                     -4.932416319236012),
                                    ("Naraka Chaturdashiyear (latent)", -6.18517928773138),
                                    ("from|since|after <time>on <day>", -5.268888555857225),
                                    ("dayweek", -6.18517928773138),
                                    ("Easter Sundayyear (latent)", -5.779714179623215),
                                    ("time-of-day (latent)at <time-of-day>", -5.492032107171434),
                                    ("Thursday<time-of-day> am|pm", -4.932416319236012),
                                    ("weekyear", -5.779714179623215),
                                    ("time-of-day (latent)Thursday", -5.779714179623215),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.18517928773138),
                                    ("<day-of-month> (ordinal)April", -6.18517928773138),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.779714179623215),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.492032107171434),
                                    ("Sundayfrom|since|after <time>", -6.18517928773138),
                                    ("absorption of , after named dayFebruary", -5.268888555857225),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.779714179623215),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.18517928773138),
                                    ("tomorrowat <time-of-day>", -6.18517928773138),
                                    ("daynograin", -5.779714179623215),
                                    ("Fridayin|during <named-month>|year", -6.18517928773138),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.779714179623215),
                                    ("last <cycle> of <time>year (latent)", -5.779714179623215),
                                    ("tomorrow<time-of-day> am|pm", -6.18517928773138),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.492032107171434),
                                    ("Diwaliyear (latent)", -5.779714179623215),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.18517928773138),
                                    ("this <part-of-day>at <time-of-day>", -5.268888555857225),
                                    ("Fridayyear (latent)", -5.268888555857225),
                                    ("time-of-day (latent)April", -6.18517928773138),
                                    ("minuteyear", -3.9879547103951603)],
                               n = 330}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.7047977977799206, unseen = -4.882801922586371,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 128},
                   koData =
                     ClassData{prior = -0.6816307384983862, unseen = -4.90527477843843,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.1616413515564159),
