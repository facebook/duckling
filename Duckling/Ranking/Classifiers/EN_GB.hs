...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7783049889002521, unseen = -5.204006687076795,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 180},
                   koData =
                     ClassData{prior = -0.61467556511845, unseen = -5.365976015021851,
                                 ...
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.873287102945032),
                                    ("Thursdayfrom <time-of-day>", -4.873287102945032),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.260096153727839),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.343805421853684),
                                    ("Tuesdayafter <time-of-day>", -5.260096153727839),
                                    ...
                                    ("Thursdayfrom <time-of-day>", -3.6506582412937383),
                                    ("dayweek", -5.260096153727839),
                                    ("from <time-of-day>on <date>", -4.343805421853684),
                                    ...
                                    ("after <time-of-day><time-of-day> am|pm", -5.260096153727839),
                                    ("after <time-of-day>year", -5.260096153727839),
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.5573456394008836, unseen = -4.204692619390966,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 63},
                   koData =
                     ClassData{prior = -0.8503327640823577,
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.3101549283038396, unseen = -5.267858159063328,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer after|past <hour-of-day>", -3.876395827784995),
                                    ("at <time-of-day>", -2.2669579153508947),
                                    ("<time-of-day> o'clock", -4.164077900236776),
                                    ("half after|past <hour-of-day>", -4.164077900236776),
                                    ("from <time-of-day>", -4.164077900236776),
                                    ("time-of-day (latent)", -1.7661826274384054),
                                    ("hhmm (latent)", -4.56954300834494),
                                    ("hh:mm", -2.2181677511814626),
                                    ("quarter after|past <hour-of-day>", -4.56954300834494),
                                    ("about|exactly <time-of-day>", -4.56954300834494),
                                    ("until <time-of-day>", -3.876395827784995),
                                    ("hour", -1.273706142340611),
                                    ("<time-of-day> sharp|exactly", -4.56954300834494),
                                    ("minute", -1.6791712504487755),
                                    ("after <time-of-day>", -4.56954300834494)],
                               n = 88},
                   koData =
                     ClassData{prior = -1.3217558399823195, unseen = -4.406719247264253,
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -3.295836866004329),
                                    ("<hour-of-day> <integer>", -3.7013019741124937),
                                    ("from <time-of-day>", -3.7013019741124937),
                                    ("time-of-day (latent)", -1.0622446444972349),
                                    ("hour", -1.0271533246859648), ("minute", -2.7850112422383386),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("minuteminute", -1.529395204760564),
                                    ...
                                    ("from <time-of-day>time-of-day (latent)", -3.4011973816621555),
                                    ("from <time-of-day><time-of-day> am|pm", -3.4011973816621555),
                                    ("<time-of-day> am|pm<time-of-day> am|pm", -2.4849066497880004),
                                    ("from <time-of-day>hh:mm", -2.4849066497880004)],
                               n = 22},
                   koData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("about|exactly <time-of-day>time-of-day (latent)",
                                    ...
                                    ("from <time-of-day>time-of-day (latent)", -2.5494451709255714),
