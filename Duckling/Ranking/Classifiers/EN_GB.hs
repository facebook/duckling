...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6441255081130586, unseen = -5.786897381366708,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 324},
                   koData =
                     ClassData{prior = -0.7446964148883205, unseen = -5.68697535633982,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 293}}),
       ("<year> (bc|ad)",
        Classifier{okData =
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4555492125055758, unseen = -6.782192056006791,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.0879104453762345),
                                    ("Father's Dayyear (latent)", -6.0879104453762345),
                                    ("Ramadanyear (latent)", -6.0879104453762345),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.835147476880866),
                                    ("Bhai Doojyear (latent)", -6.0879104453762345),
                                    ("hourday", -4.383162353137809),
                                    ("dayhour", -3.225709564446766),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.835147476880866),
                                    ("Martin Luther King's Dayyear (latent)", -5.68244533726807),
                                    ("Shemini Atzeretyear (latent)", -6.0879104453762345),
                                    ("daymonth", -5.171619713502079),
                                    ("monthday", -5.68244533726807),
                                    ("monthyear", -4.296150976148179),
                                    ("Yom Ha'atzmautyear (latent)", -6.0879104453762345),
                                    ("Vijayadashamiyear (latent)", -6.0879104453762345),
                                    ("Thanksgiving Dayyear (latent)", -4.9892981567081245),
                                    ("Thai Pongalyear (latent)", -5.394763264816289),
                                    ("Thiru Onamyear (latent)", -5.394763264816289),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.0879104453762345),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.0879104453762345),
                                    ("houryear", -5.394763264816289),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.0879104453762345),
                                    ("Christmas<time-of-day> am|pm", -6.0879104453762345),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.0879104453762345),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.394763264816289),
                                    ("<time-of-day> am|pmintersect", -4.835147476880866),
                                    ("Earth Houryear (latent)", -6.0879104453762345),
                                    ("Octoberyear (latent)", -4.58383304859996),
                                    ("intersect<time-of-day> am|pm", -6.0879104453762345),
                                    ("Mattu Pongalyear (latent)", -6.0879104453762345),
                                    ("Shavuotyear (latent)", -6.0879104453762345),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.0879104453762345),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.0879104453762345),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.68244533726807),
                                    ("Marchyear (latent)", -6.0879104453762345),
                                    ("Sukkotyear (latent)", -5.68244533726807),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.0879104453762345),
                                    ("Clean Mondayyear (latent)", -5.68244533726807),
                                    ("monthhour", -5.68244533726807),
                                    ("todayat <time-of-day>", -6.0879104453762345),
                                    ("Thursday<time> timezone", -4.142000296320921),
                                    ("from|since|after <time>December", -6.0879104453762345),
                                    ("dd/mm<time-of-day> am|pm", -6.0879104453762345),
                                    ("<time-of-day> am|pmon <day>", -4.073007424833969),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.0879104453762345),
                                    ("yyyy-mm-ddhh:mm:ss", -5.68244533726807),
                                    ("dayday", -4.073007424833969),
                                    ("dd/mmat <time-of-day>", -6.0879104453762345),
                                    ("<time> <part-of-day>at <time-of-day>", -6.0879104453762345),
                                    ("tonightat <time-of-day>", -6.0879104453762345),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.394763264816289),
                                    ("today<time-of-day> am|pm", -6.0879104453762345),
                                    ("Februarythe <day-of-month> (ordinal)", -5.68244533726807),
                                    ("at <time-of-day><time> <part-of-day>", -6.0879104453762345),
                                    ("hourhour", -4.835147476880866),
                                    ("Navaratriin|during <named-month>|year", -6.0879104453762345),
                                    ("Wednesdaythis|last|next <cycle>", -6.0879104453762345),
                                    ("Lentyear (latent)", -6.0879104453762345),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.58383304859996),
                                    ("Boghiyear (latent)", -6.0879104453762345),
                                    ("dayyear", -1.977036581202923),
                                    ("Thursdayfrom|since|after <time>", -5.68244533726807),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.0879104453762345),
                                    ("Thursdayat <time-of-day>", -5.394763264816289),
                                    ("Islamic New Yearyear (latent)", -5.68244533726807),
                                    ("Laylat al-Qadryear (latent)", -5.171619713502079),
                                    ("Shrove Tuesdayyear (latent)", -6.0879104453762345),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.394763264816289),
                                    ("<time-of-day> am|pmtomorrow", -5.394763264816289),
                                    ("Yom Kippuryear (latent)", -6.0879104453762345),
                                    ("<part-of-day> of <time>year (latent)", -6.0879104453762345),
                                    ("minutehour", -5.171619713502079),
                                    ("Kaanum Pongalyear (latent)", -5.68244533726807),
                                    ("Maha Saptamiyear (latent)", -6.0879104453762345),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.68244533726807),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.383162353137809),
                                    ("for <duration> from <time>December", -6.0879104453762345),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.0879104453762345),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.835147476880866),
                                    ("Pentecostyear (latent)", -6.0879104453762345),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.835147476880866),
                                    ("Eid al-Fitryear (latent)", -6.0879104453762345),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.0879104453762345),
                                    ("Mondayin|during the <part-of-day>", -6.0879104453762345),
                                    ("Chhathin|during <named-month>|year", -6.0879104453762345),
                                    ("Diwaliin|during <named-month>|year", -6.0879104453762345),
                                    ("Vaisakhiin|during <named-month>|year", -6.0879104453762345),
                                    ("Raksha Bandhanyear (latent)", -6.0879104453762345),
                                    ("daysecond", -5.68244533726807),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.68244533726807),
                                    ("Ashurayear (latent)", -6.0879104453762345),
                                    ("Tuesdayin|during <named-month>|year", -6.0879104453762345),
                                    ("Chinese New Yearyear (latent)", -6.0879104453762345),
                                    ("Lag BaOmeryear (latent)", -6.0879104453762345),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.0879104453762345),
                                    ("Eid al-Adhayear (latent)", -5.171619713502079),
                                    ("intersectin|during the <part-of-day>", -6.0879104453762345),
                                    ("Palm Sundayyear (latent)", -6.0879104453762345),
                                    ("Christmasat <time-of-day>", -6.0879104453762345),
                                    ("Passoveryear (latent)", -6.0879104453762345),
                                    ("Lazarus Saturdayyear (latent)", -6.0879104453762345),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.0879104453762345),
                                    ("Yom HaShoahyear (latent)", -5.68244533726807),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.68244533726807),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.0879104453762345),
                                    ("Septemberyear (latent)", -5.68244533726807),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.58383304859996),
                                    ("Halloweenyear (latent)", -6.0879104453762345),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.0879104453762345),
                                    ("at <time-of-day>intersect", -5.68244533726807),
                                    ("Rosh Hashanahyear (latent)", -5.394763264816289),
                                    ("Dhanterasyear (latent)", -6.0879104453762345),
                                    ("Tu BiShvatyear (latent)", -6.0879104453762345),
                                    ("Holiyear (latent)", -5.394763264816289),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.0879104453762345),
                                    ("Holika Dahanyear (latent)", -5.394763264816289),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0879104453762345),
                                    ("dayminute", -3.170139713291955),
                                    ("Mawlidyear (latent)", -6.0879104453762345),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.68244533726807),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.0879104453762345),
                                    ("Jumu'atul-Widayear (latent)", -5.171619713502079),
                                    ("minuteday", -2.4503242856498484),
                                    ("absorption of , after named dayintersect",
                                     -6.0879104453762345),
                                    ("Orthodox Easter Sundayyear (latent)", -6.0879104453762345),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.0879104453762345),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.0879104453762345),
                                    ("Mothering Sundayyear (latent)", -5.68244533726807),
                                    ("Boss's Dayyear (latent)", -5.68244533726807),
                                    ("Global Youth Service Dayyear (latent)", -6.0879104453762345),
                                    ("Dhanterasin|during <named-month>|year", -6.0879104453762345),
                                    ("Tisha B'Avyear (latent)", -6.0879104453762345),
                                    ("Isra and Mi'rajyear (latent)", -5.171619713502079),
                                    ("at <time-of-day>on <day>", -4.9892981567081245),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.0879104453762345),
                                    ("Christmasyear (latent)", -5.68244533726807),
                                    ("Naraka Chaturdashiyear (latent)", -5.68244533726807),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.0879104453762345),
                                    ("dayweek", -6.0879104453762345),
                                    ("Easter Sundayyear (latent)", -5.394763264816289),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.478472532942134),
                                    ("weekyear", -4.9892981567081245),
                                    ("hh:mmin|during the <part-of-day>", -5.394763264816289),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.68244533726807),
                                    ("Hanukkahyear (latent)", -5.394763264816289),
                                    ("February<time> <part-of-day>", -6.0879104453762345),
                                    ("Great Lentyear (latent)", -6.0879104453762345),
                                    ("tomorrowat <time-of-day>", -5.394763264816289),
                                    ("Vaisakhiyear (latent)", -5.394763264816289),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.0879104453762345),
                                    ("last <cycle> of <time>year (latent)", -5.394763264816289),
                                    ("at <time-of-day>tomorrow", -5.68244533726807),
                                    ("tomorrow<time-of-day> am|pm", -6.0879104453762345),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.0879104453762345),
                                    ("Diwaliyear (latent)", -6.0879104453762345),
                                    ("between <time> and <time>on <day>", -4.478472532942134),
                                    ("Black Fridayyear (latent)", -5.68244533726807),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.0879104453762345),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.0879104453762345),
                                    ("Chhathyear (latent)", -5.68244533726807),
                                    ("Vasant Panchamiyear (latent)", -6.0879104453762345),
                                    ("Thursday<time> (timezone)", -6.0879104453762345),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.0879104453762345),
                                    ("August Bank Holidayyear (latent)", -5.394763264816289),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.68244533726807),
                                    ("Februaryintersect", -6.0879104453762345),
                                    ("Simchat Torahyear (latent)", -6.0879104453762345),
                                    ("minuteyear", -6.0879104453762345)],
                               n = 331},
                   koData =
                     ClassData{prior = -1.005394159836009, unseen = -6.400257445308821,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.789157022101107),
                                    ("dayhour", -3.0312991045487334),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.789157022101107),
                                    ("Tuesdayfrom|since|after <time>", -5.705447753975262),
                                    ("daymonth", -3.6905447334329975),
                                    ("monthyear", -4.452684785479894),
                                    ("<time-of-day> am|pmyear (latent)", -5.012300573415317),
                                    ("Thai Pongalyear (latent)", -5.012300573415317),
                                    ("intersecthh:mm", -5.705447753975262),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.705447753975262),
                                    ("houryear", -4.606835465307152),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.705447753975262),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.012300573415317),
                                    ("<time-of-day> am|pmintersect", -4.452684785479894),
                                    ("Octoberyear (latent)", -5.705447753975262),
                                    ("until <time>on <day>", -5.012300573415317),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.012300573415317),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.705447753975262),
                                    ("hh:mmon <day>", -3.6905447334329975),
                                    ("absorption of , after named dayJuly", -5.2999826458670976),
                                    ("from|since|after <time>July", -5.705447753975262),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.789157022101107),
                                    ("Clean Mondayyear (latent)", -5.705447753975262),
                                    ("monthhour", -5.705447753975262),
                                    ("hourmonth", -4.789157022101107),
                                    ("todayat <time-of-day>", -5.705447753975262),
                                    ("Bank Holidayyear (latent)", -5.012300573415317),
                                    ("from|since|after <time>December", -5.705447753975262),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.705447753975262),
                                    ("<time-of-day> am|pmon <day>", -4.452684785479894),
                                    ("Mondayyear (latent)", -5.012300573415317),
                                    ("dayday", -5.2999826458670976),
                                    ("dd/mmat <time-of-day>", -5.2999826458670976),
                                    ("on <day>September", -5.2999826458670976),
                                    ("Thursdaydd/mm", -5.705447753975262),
                                    ("dayyear", -2.7350332884055613),
                                    ("New Year's Dayyear (latent)", -5.2999826458670976),
                                    ("Thursdayfrom|since|after <time>", -4.000699661736837),
                                    ("Thursdayat <time-of-day>", -4.096009841541162),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.705447753975262),
                                    ("Aprilyear (latent)", -5.705447753975262),
                                    ("monthminute", -5.705447753975262),
                                    ("<time-of-day> am|pmtomorrow", -5.705447753975262),
                                    ("Thursdayhh:mm", -4.789157022101107),
                                    ("minutemonth", -3.913688284747207),
                                    ("Augustyear (latent)", -5.2999826458670976),
                                    ("week-endin|during <named-month>|year", -5.705447753975262),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.705447753975262),
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.2999826458670976),
                                    ("Sundayyear (latent)", -4.789157022101107),
                                    ("Christmasat <time-of-day>", -5.705447753975262),
                                    ("from|since|after <time>year (latent)", -4.606835465307152),
                                    ("dd/mmyear (latent)", -5.705447753975262),
                                    ("<duration> after|before|from <time>December",
                                     -5.705447753975262),
                                    ("yesterday<time-of-day> am|pm", -5.705447753975262),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.705447753975262),
                                    ("at <time-of-day>intersect", -5.2999826458670976),
                                    ("hh:mmyear (latent)", -4.452684785479894),
                                    ("Holiyear (latent)", -5.705447753975262),
                                    ("until <time><time-of-day> am|pm", -5.705447753975262),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.705447753975262),
                                    ("dayminute", -3.1404983965137254),
                                    ("yyyy-mm-ddhh:mm", -5.2999826458670976),
                                    ("intersectSeptember", -4.201370357198988),
                                    ("minuteday", -2.637394818841645),
                                    ("absorption of , after named dayintersect",
                                     -5.705447753975262),
                                    ("Februaryin|during the <part-of-day>", -5.705447753975262),
                                    ("Saturdayyear (latent)", -5.705447753975262),
                                    ("at <time-of-day>on <day>", -5.2999826458670976),
                                    ("absorption of , after named daySeptember",
                                     -4.789157022101107),
                                    ("Naraka Chaturdashiyear (latent)", -5.705447753975262),
                                    ("from|since|after <time>on <day>", -4.789157022101107),
                                    ("dayweek", -5.705447753975262),
                                    ("Easter Sundayyear (latent)", -5.2999826458670976),
                                    ("Thursday<time-of-day> am|pm", -4.452684785479894),
                                    ("weekyear", -5.2999826458670976),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.012300573415317),
                                    ("Sundayfrom|since|after <time>", -5.705447753975262),
                                    ("absorption of , after named dayFebruary", -4.789157022101107),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.705447753975262),
                                    ("tomorrowat <time-of-day>", -5.705447753975262),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.705447753975262),
                                    ("last <cycle> of <time>year (latent)", -5.2999826458670976),
                                    ("tomorrow<time-of-day> am|pm", -5.705447753975262),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.012300573415317),
                                    ("Diwaliyear (latent)", -5.2999826458670976),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.705447753975262),
                                    ("Fridayyear (latent)", -5.2999826458670976),
                                    ("minuteyear", -4.319153392855371)],
                               n = 191}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.15510899326906988,
                               ...
                               n = 149},
                   koData =
                     ClassData{prior = -1.9401794743463283,
       ...
       ("hh:mm",
        Classifier{okData =
                     ClassData{prior = -0.11477551459242818,
                               unseen = -4.330733340286331,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 74},
                   koData =
                     ClassData{prior = -2.2216160304603787,
                               unseen = -2.3978952727983707,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 9}}),
       ("Holi",
        Classifier{okData =
