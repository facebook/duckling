...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.638317473549335, unseen = -5.799092654460526,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 328},
                   koData =
                     ClassData{prior = -0.7511584729164115, unseen = -5.68697535633982,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45525577261118, unseen = -6.790097235513905,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.095824562432225),
                                    ("Father's Dayyear (latent)", -6.095824562432225),
                                    ("Ramadanyear (latent)", -6.095824562432225),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.843061593936857),
                                    ("Bhai Doojyear (latent)", -6.095824562432225),
                                    ("hourday", -4.391076470193799),
                                    ("dayhour", -3.2336236815027566),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.843061593936857),
                                    ("Martin Luther King's Dayyear (latent)", -5.69035945432406),
                                    ("Shemini Atzeretyear (latent)", -6.095824562432225),
                                    ("daymonth", -5.17953383055807),
                                    ("monthday", -5.69035945432406),
                                    ("monthyear", -4.304065093204169),
                                    ("yearhour", -5.69035945432406),
                                    ("Yom Ha'atzmautyear (latent)", -6.095824562432225),
                                    ("Vijayadashamiyear (latent)", -6.095824562432225),
                                    ("Thanksgiving Dayyear (latent)", -4.997212273764115),
                                    ("Thai Pongalyear (latent)", -5.402677381872279),
                                    ("Thiru Onamyear (latent)", -5.402677381872279),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.095824562432225),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.095824562432225),
                                    ("houryear", -5.402677381872279),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.095824562432225),
                                    ("Christmas<time-of-day> am|pm", -6.095824562432225),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.095824562432225),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.402677381872279),
                                    ("<time-of-day> am|pmintersect", -4.843061593936857),
                                    ("Earth Houryear (latent)", -6.095824562432225),
                                    ("Octoberyear (latent)", -4.591747165655951),
                                    ("intersect<time-of-day> am|pm", -6.095824562432225),
                                    ("Mattu Pongalyear (latent)", -6.095824562432225),
                                    ("Shavuotyear (latent)", -6.095824562432225),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.095824562432225),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.095824562432225),
                                    ("in|within|after <duration>at <time-of-day>",
                                     -6.095824562432225),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.69035945432406),
                                    ("Marchyear (latent)", -6.095824562432225),
                                    ("Sukkotyear (latent)", -5.69035945432406),
                                    ...
                                    ("Thursday<time> timezone", -4.149914413376911),
                                    ("from|since|after <time>December", -6.095824562432225),
                                    ("dd/mm<time-of-day> am|pm", -6.095824562432225),
                                    ("<time-of-day> am|pmon <day>", -4.08092154188996),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.095824562432225),
                                    ("yyyy-mm-ddhh:mm:ss", -5.69035945432406),
                                    ("dayday", -4.08092154188996),
                                    ("dd/mmat <time-of-day>", -6.095824562432225),
                                    ("<time> <part-of-day>at <time-of-day>", -6.095824562432225),
                                    ("tonightat <time-of-day>", -6.095824562432225),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.402677381872279),
                                    ("today<time-of-day> am|pm", -6.095824562432225),
                                    ("Februarythe <day-of-month> (ordinal)", -5.69035945432406),
                                    ("at <time-of-day><time> <part-of-day>", -6.095824562432225),
                                    ("hourhour", -4.843061593936857),
                                    ("Navaratriin|during <named-month>|year", -6.095824562432225),
                                    ("Wednesdaythis|last|next <cycle>", -6.095824562432225),
                                    ("Lentyear (latent)", -6.095824562432225),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.591747165655951),
                                    ("Boghiyear (latent)", -6.095824562432225),
                                    ("dayyear", -1.9849506982589133),
                                    ("Thursdayfrom|since|after <time>", -5.69035945432406),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.095824562432225),
                                    ("Thursdayat <time-of-day>", -5.402677381872279),
                                    ("Islamic New Yearyear (latent)", -5.69035945432406),
                                    ("Laylat al-Qadryear (latent)", -5.17953383055807),
                                    ("Shrove Tuesdayyear (latent)", -6.095824562432225),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.402677381872279),
                                    ("<time-of-day> am|pmtomorrow", -5.402677381872279),
                                    ("Yom Kippuryear (latent)", -6.095824562432225),
                                    ("<part-of-day> of <time>year (latent)", -6.095824562432225),
                                    ("minutehour", -5.17953383055807),
                                    ("Kaanum Pongalyear (latent)", -5.69035945432406),
                                    ("Maha Saptamiyear (latent)", -6.095824562432225),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.69035945432406),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.391076470193799),
                                    ("for <duration> from <time>December", -6.095824562432225),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.095824562432225),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.843061593936857),
                                    ("Pentecostyear (latent)", -6.095824562432225),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.843061593936857),
                                    ("Eid al-Fitryear (latent)", -6.095824562432225),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.095824562432225),
                                    ("Mondayin|during the <part-of-day>", -6.095824562432225),
                                    ("Chhathin|during <named-month>|year", -6.095824562432225),
                                    ("Diwaliin|during <named-month>|year", -6.095824562432225),
                                    ("Vaisakhiin|during <named-month>|year", -6.095824562432225),
                                    ("Raksha Bandhanyear (latent)", -6.095824562432225),
                                    ("daysecond", -5.69035945432406),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.69035945432406),
                                    ("Ashurayear (latent)", -6.095824562432225),
                                    ("Tuesdayin|during <named-month>|year", -6.095824562432225),
                                    ("Chinese New Yearyear (latent)", -6.095824562432225),
                                    ("Lag BaOmeryear (latent)", -6.095824562432225),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.095824562432225),
                                    ("Eid al-Adhayear (latent)", -5.17953383055807),
                                    ("intersectin|during the <part-of-day>", -6.095824562432225),
                                    ("Palm Sundayyear (latent)", -6.095824562432225),
                                    ("Christmasat <time-of-day>", -6.095824562432225),
                                    ("Passoveryear (latent)", -6.095824562432225),
                                    ("Lazarus Saturdayyear (latent)", -6.095824562432225),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.095824562432225),
                                    ("Yom HaShoahyear (latent)", -5.69035945432406),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.69035945432406),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.095824562432225),
                                    ("Septemberyear (latent)", -5.69035945432406),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.591747165655951),
                                    ("Halloweenyear (latent)", -6.095824562432225),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.095824562432225),
                                    ("at <time-of-day>intersect", -5.69035945432406),
                                    ("Rosh Hashanahyear (latent)", -5.402677381872279),
                                    ("Dhanterasyear (latent)", -6.095824562432225),
                                    ("Tu BiShvatyear (latent)", -6.095824562432225),
                                    ("Holiyear (latent)", -5.402677381872279),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.095824562432225),
                                    ("Holika Dahanyear (latent)", -5.402677381872279),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.095824562432225),
                                    ("dayminute", -3.1780538303479458),
                                    ("Mawlidyear (latent)", -6.095824562432225),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.69035945432406),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.095824562432225),
                                    ("Jumu'atul-Widayear (latent)", -5.17953383055807),
                                    ("minuteday", -2.458238402705839),
                                    ("absorption of , after named dayintersect",
                                     -6.095824562432225),
                                    ("in|within|after <duration><time-of-day> am|pm",
                                     -6.095824562432225),
                                    ("Orthodox Easter Sundayyear (latent)", -6.095824562432225),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.095824562432225),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.095824562432225),
                                    ("Mothering Sundayyear (latent)", -5.69035945432406),
                                    ("Boss's Dayyear (latent)", -5.69035945432406),
                                    ("Global Youth Service Dayyear (latent)", -6.095824562432225),
                                    ("Dhanterasin|during <named-month>|year", -6.095824562432225),
                                    ("Tisha B'Avyear (latent)", -6.095824562432225),
                                    ("Isra and Mi'rajyear (latent)", -5.17953383055807),
                                    ("at <time-of-day>on <day>", -4.997212273764115),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.095824562432225),
                                    ("Christmasyear (latent)", -5.69035945432406),
                                    ("Naraka Chaturdashiyear (latent)", -5.69035945432406),
                                    ("Thai Pongalin|during <named-month>|year", -6.095824562432225),
                                    ("dayweek", -6.095824562432225),
                                    ("Easter Sundayyear (latent)", -5.402677381872279),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.486386649998124),
                                    ("weekyear", -4.997212273764115),
                                    ("hh:mmin|during the <part-of-day>", -5.402677381872279),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.69035945432406),
                                    ("Hanukkahyear (latent)", -5.402677381872279),
                                    ("February<time> <part-of-day>", -6.095824562432225),
                                    ("Great Lentyear (latent)", -6.095824562432225),
                                    ("tomorrowat <time-of-day>", -5.402677381872279),
                                    ("Vaisakhiyear (latent)", -5.402677381872279),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.095824562432225),
                                    ("last <cycle> of <time>year (latent)", -5.402677381872279),
                                    ("at <time-of-day>tomorrow", -5.69035945432406),
                                    ...
                                    ("between <time> and <time>on <day>", -4.486386649998124),
                                    ("Black Fridayyear (latent)", -5.69035945432406),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.095824562432225),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.095824562432225),
                                    ("Chhathyear (latent)", -5.69035945432406),
                                    ("Vasant Panchamiyear (latent)", -6.095824562432225),
                                    ("Thursday<time> (timezone)", -6.095824562432225),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.095824562432225),
                                    ("August Bank Holidayyear (latent)", -5.402677381872279),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.69035945432406),
                                    ("Februaryintersect", -6.095824562432225),
                                    ("Simchat Torahyear (latent)", -6.095824562432225),
                                    ("minuteyear", -6.095824562432225)],
                               n = 333},
                   koData =
                     ClassData{prior = -1.0059028905638423, unseen = -6.408528791059498,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.797442073635215),
                                    ("dayhour", -3.0395841560828405),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.797442073635215),
                                    ("Tuesdayfrom|since|after <time>", -5.713732805509369),
                                    ("daymonth", -3.698829784967104),
                                    ("monthyear", -4.460969837014002),
                                    ("yearhour", -5.713732805509369),
                                    ("<time-of-day> am|pmyear (latent)", -5.020585624949423),
                                    ("Thai Pongalyear (latent)", -5.020585624949423),
                                    ("intersecthh:mm", -5.713732805509369),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.713732805509369),
                                    ("houryear", -4.61512051684126),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.713732805509369),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.020585624949423),
                                    ("<time-of-day> am|pmintersect", -4.460969837014002),
                                    ("Octoberyear (latent)", -5.713732805509369),
                                    ("until <time>on <day>", -5.020585624949423),
                                    ("in|within|after <duration>at <time-of-day>",
                                     -5.713732805509369),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.020585624949423),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.713732805509369),
                                    ("hh:mmon <day>", -3.698829784967104),
                                    ("absorption of , after named dayJuly", -5.308267697401205),
                                    ("from|since|after <time>July", -5.713732805509369),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.797442073635215),
                                    ("Clean Mondayyear (latent)", -5.713732805509369),
                                    ("monthhour", -5.713732805509369),
                                    ("hourmonth", -4.797442073635215),
                                    ("todayat <time-of-day>", -5.713732805509369),
                                    ("Bank Holidayyear (latent)", -5.020585624949423),
                                    ("from|since|after <time>December", -5.713732805509369),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.713732805509369),
                                    ("<time-of-day> am|pmon <day>", -4.460969837014002),
                                    ("Mondayyear (latent)", -5.020585624949423),
                                    ("dayday", -5.308267697401205),
                                    ("dd/mmat <time-of-day>", -5.308267697401205),
                                    ("on <day>September", -5.308267697401205),
                                    ("Thursdaydd/mm", -5.713732805509369),
                                    ("dayyear", -2.743318339939668),
                                    ("New Year's Dayyear (latent)", -5.308267697401205),
                                    ("Thursdayfrom|since|after <time>", -4.0089847132709435),
                                    ("Thursdayat <time-of-day>", -4.104294893075269),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.713732805509369),
                                    ("Aprilyear (latent)", -5.713732805509369),
                                    ("monthminute", -5.713732805509369),
                                    ("<time-of-day> am|pmtomorrow", -5.713732805509369),
                                    ("Thursdayhh:mm", -4.797442073635215),
                                    ("minutemonth", -3.9219733362813143),
                                    ("Augustyear (latent)", -5.308267697401205),
                                    ("week-endin|during <named-month>|year", -5.713732805509369),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.713732805509369),
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.308267697401205),
                                    ("Sundayyear (latent)", -4.797442073635215),
                                    ("Christmasat <time-of-day>", -5.713732805509369),
                                    ("from|since|after <time>year (latent)", -4.61512051684126),
                                    ("dd/mmyear (latent)", -5.713732805509369),
                                    ("<duration> after|before|from <time>December",
                                     -5.713732805509369),
                                    ("yesterday<time-of-day> am|pm", -5.713732805509369),
                                    ...
                                    ("hh:mmyear (latent)", -4.460969837014002),
                                    ("Holiyear (latent)", -5.713732805509369),
                                    ("until <time><time-of-day> am|pm", -5.713732805509369),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.713732805509369),
                                    ("dayminute", -3.1487834480478325),
                                    ("yyyy-mm-ddhh:mm", -5.308267697401205),
                                    ("intersectSeptember", -4.209655408733095),
                                    ("minuteday", -2.6456798703757523),
                                    ("absorption of , after named dayintersect",
                                     -5.713732805509369),
                                    ("Februaryin|during the <part-of-day>", -5.713732805509369),
                                    ("Saturdayyear (latent)", -5.713732805509369),
                                    ("at <time-of-day>on <day>", -5.308267697401205),
                                    ("absorption of , after named daySeptember",
                                     -4.797442073635215),
                                    ("Naraka Chaturdashiyear (latent)", -5.713732805509369),
                                    ("from|since|after <time>on <day>", -4.797442073635215),
                                    ("dayweek", -5.713732805509369),
                                    ("Easter Sundayyear (latent)", -5.308267697401205),
                                    ("Thursday<time-of-day> am|pm", -4.460969837014002),
                                    ("weekyear", -5.308267697401205),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.020585624949423),
                                    ("Sundayfrom|since|after <time>", -5.713732805509369),
                                    ("absorption of , after named dayFebruary", -4.797442073635215),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.713732805509369),
                                    ("tomorrowat <time-of-day>", -5.713732805509369),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.713732805509369),
                                    ("last <cycle> of <time>year (latent)", -5.308267697401205),
                                    ("tomorrow<time-of-day> am|pm", -5.713732805509369),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.020585624949423),
                                    ("Diwaliyear (latent)", -5.308267697401205),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.713732805509369),
                                    ("Fridayyear (latent)", -5.308267697401205),
                                    ("minuteyear", -4.327438444389479)],
                               n = 192}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
