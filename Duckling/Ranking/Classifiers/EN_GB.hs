...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4700036292457356, unseen = -6.76849321164863,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.074195944705447),
                                    ("Father's Dayyear (latent)", -6.074195944705447),
                                    ("Ramadanyear (latent)", -6.074195944705447),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.821432976210079),
                                    ("Bhai Doojyear (latent)", -6.074195944705447),
                                    ("hourday", -4.3694478524670215),
                                    ("dayhour", -3.211995063775978),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.821432976210079),
                                    ("Martin Luther King's Dayyear (latent)", -5.668730836597282),
                                    ("Shemini Atzeretyear (latent)", -6.074195944705447),
                                    ("daymonth", -5.157905212831292),
                                    ("monthday", -5.668730836597282),
                                    ("monthyear", -4.282436475477391),
                                    ("Yom Ha'atzmautyear (latent)", -6.074195944705447),
                                    ("Vijayadashamiyear (latent)", -6.074195944705447),
                                    ("Thanksgiving Dayyear (latent)", -4.975583656037337),
                                    ("Thai Pongalyear (latent)", -5.381048764145501),
                                    ("Thiru Onamyear (latent)", -5.381048764145501),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.074195944705447),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.074195944705447),
                                    ("houryear", -5.381048764145501),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.074195944705447),
                                    ("Christmas<time-of-day> am|pm", -6.074195944705447),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.074195944705447),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.381048764145501),
                                    ("<time-of-day> am|pmintersect", -4.821432976210079),
                                    ("Earth Houryear (latent)", -6.074195944705447),
                                    ("Octoberyear (latent)", -4.570118547929173),
                                    ("intersect<time-of-day> am|pm", -6.074195944705447),
                                    ("Mattu Pongalyear (latent)", -6.074195944705447),
                                    ("Shavuotyear (latent)", -6.074195944705447),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.074195944705447),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.074195944705447),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.668730836597282),
                                    ("Marchyear (latent)", -6.074195944705447),
                                    ("Sukkotyear (latent)", -5.668730836597282),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.074195944705447),
                                    ("Clean Mondayyear (latent)", -5.668730836597282),
                                    ("monthhour", -5.668730836597282),
                                    ("todayat <time-of-day>", -6.074195944705447),
                                    ("Thursday<time> timezone", -4.128285795650133),
                                    ("from|since|after <time>December", -6.074195944705447),
                                    ("dd/mm<time-of-day> am|pm", -6.074195944705447),
                                    ("<time-of-day> am|pmon <day>", -4.059292924163182),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.074195944705447),
                                    ("yyyy-mm-ddhh:mm:ss", -5.668730836597282),
                                    ("dayday", -4.059292924163182),
                                    ("dd/mmat <time-of-day>", -6.074195944705447),
                                    ("<time> <part-of-day>at <time-of-day>", -6.074195944705447),
                                    ("tonightat <time-of-day>", -6.074195944705447),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.381048764145501),
                                    ("today<time-of-day> am|pm", -6.074195944705447),
                                    ("Februarythe <day-of-month> (ordinal)", -5.668730836597282),
                                    ("at <time-of-day><time> <part-of-day>", -6.074195944705447),
                                    ("hourhour", -4.821432976210079),
                                    ("Navaratriin|during <named-month>|year", -6.074195944705447),
                                    ("Wednesdaythis|last|next <cycle>", -6.074195944705447),
                                    ("Lentyear (latent)", -6.074195944705447),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.570118547929173),
                                    ("Boghiyear (latent)", -6.074195944705447),
                                    ("dayyear", -1.9633220805321354),
                                    ("Thursdayfrom|since|after <time>", -5.668730836597282),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.074195944705447),
                                    ("Thursdayat <time-of-day>", -5.381048764145501),
                                    ("Islamic New Yearyear (latent)", -5.668730836597282),
                                    ("Laylat al-Qadryear (latent)", -5.157905212831292),
                                    ("Shrove Tuesdayyear (latent)", -6.074195944705447),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.381048764145501),
                                    ("<time-of-day> am|pmtomorrow", -5.381048764145501),
                                    ("Yom Kippuryear (latent)", -6.074195944705447),
                                    ("<part-of-day> of <time>year (latent)", -6.074195944705447),
                                    ("minutehour", -5.157905212831292),
                                    ("Kaanum Pongalyear (latent)", -5.668730836597282),
                                    ("Maha Saptamiyear (latent)", -6.074195944705447),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.668730836597282),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.3694478524670215),
                                    ("for <duration> from <time>December", -6.074195944705447),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.074195944705447),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.157905212831292),
                                    ("Pentecostyear (latent)", -6.074195944705447),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.157905212831292),
                                    ("Eid al-Fitryear (latent)", -6.074195944705447),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.074195944705447),
                                    ("Mondayin|during the <part-of-day>", -6.074195944705447),
                                    ("Chhathin|during <named-month>|year", -6.074195944705447),
                                    ("Diwaliin|during <named-month>|year", -6.074195944705447),
                                    ("Vaisakhiin|during <named-month>|year", -6.074195944705447),
                                    ("Raksha Bandhanyear (latent)", -6.074195944705447),
                                    ("daysecond", -5.668730836597282),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.668730836597282),
                                    ("Ashurayear (latent)", -6.074195944705447),
                                    ("Tuesdayin|during <named-month>|year", -6.074195944705447),
                                    ("Chinese New Yearyear (latent)", -6.074195944705447),
                                    ("Lag BaOmeryear (latent)", -6.074195944705447),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.074195944705447),
                                    ("Eid al-Adhayear (latent)", -5.157905212831292),
                                    ("intersectin|during the <part-of-day>", -6.074195944705447),
                                    ("Palm Sundayyear (latent)", -6.074195944705447),
                                    ("Christmasat <time-of-day>", -6.074195944705447),
                                    ("Passoveryear (latent)", -6.074195944705447),
                                    ("Lazarus Saturdayyear (latent)", -6.074195944705447),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.074195944705447),
                                    ("Yom HaShoahyear (latent)", -5.668730836597282),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.668730836597282),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.074195944705447),
                                    ("Septemberyear (latent)", -5.668730836597282),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.821432976210079),
                                    ("Halloweenyear (latent)", -6.074195944705447),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.074195944705447),
                                    ("at <time-of-day>intersect", -5.668730836597282),
                                    ("Rosh Hashanahyear (latent)", -5.381048764145501),
                                    ("Dhanterasyear (latent)", -6.074195944705447),
                                    ("Tu BiShvatyear (latent)", -6.074195944705447),
                                    ("Holiyear (latent)", -5.381048764145501),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.074195944705447),
                                    ("Holika Dahanyear (latent)", -5.381048764145501),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.074195944705447),
                                    ("dayminute", -3.333355920780246),
                                    ("Mawlidyear (latent)", -6.074195944705447),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.668730836597282),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.074195944705447),
                                    ("Jumu'atul-Widayear (latent)", -5.157905212831292),
                                    ("minuteday", -2.436609784979061),
                                    ("absorption of , after named dayintersect",
                                     -6.074195944705447),
                                    ("Orthodox Easter Sundayyear (latent)", -6.074195944705447),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.074195944705447),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.074195944705447),
                                    ("Mothering Sundayyear (latent)", -5.668730836597282),
                                    ("Boss's Dayyear (latent)", -5.668730836597282),
                                    ("Global Youth Service Dayyear (latent)", -6.074195944705447),
                                    ("Dhanterasin|during <named-month>|year", -6.074195944705447),
                                    ("Tisha B'Avyear (latent)", -6.074195944705447),
                                    ("Isra and Mi'rajyear (latent)", -5.157905212831292),
                                    ("at <time-of-day>on <day>", -4.975583656037337),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.074195944705447),
                                    ("Christmasyear (latent)", -5.668730836597282),
                                    ("Naraka Chaturdashiyear (latent)", -5.668730836597282),
                                    ("Thai Pongalin|during <named-month>|year", -6.074195944705447),
                                    ("dayweek", -6.074195944705447),
                                    ("Easter Sundayyear (latent)", -5.381048764145501),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.464758032271346),
                                    ("weekyear", -4.975583656037337),
                                    ("hh:mmin|during the <part-of-day>", -5.381048764145501),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.668730836597282),
                                    ("Hanukkahyear (latent)", -5.381048764145501),
                                    ("February<time> <part-of-day>", -6.074195944705447),
                                    ("Great Lentyear (latent)", -6.074195944705447),
                                    ("tomorrowat <time-of-day>", -5.381048764145501),
                                    ("Vaisakhiyear (latent)", -5.381048764145501),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.074195944705447),
                                    ("last <cycle> of <time>year (latent)", -5.381048764145501),
                                    ("at <time-of-day>tomorrow", -5.668730836597282),
                                    ("tomorrow<time-of-day> am|pm", -6.074195944705447),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.074195944705447),
                                    ("Diwaliyear (latent)", -6.074195944705447),
                                    ("between <time> and <time>on <day>", -4.464758032271346),
                                    ("Black Fridayyear (latent)", -5.668730836597282),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.074195944705447),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.074195944705447),
                                    ("Chhathyear (latent)", -5.668730836597282),
                                    ("Vasant Panchamiyear (latent)", -6.074195944705447),
                                    ("Thursday<time> (timezone)", -6.074195944705447),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.074195944705447),
                                    ("August Bank Holidayyear (latent)", -5.381048764145501),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.668730836597282),
                                    ("Februaryintersect", -6.074195944705447),
                                    ("Simchat Torahyear (latent)", -6.074195944705447),
                                    ("minuteyear", -6.074195944705447)],
                               n = 325},
                   koData =
                     ClassData{prior = -0.9808292530117262, unseen = -6.413458957167357,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.802380355275797),
                                    ...
                                    ("until <time>on <day>", -5.025523906590006),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.025523906590006),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.718671087149952),
                                    ("hh:mmon <day>", -3.703768066607687),
                                    ...
                                    ("Bank Holidayyear (latent)", -5.025523906590006),
                                    ...
                                    ("Mondayyear (latent)", -5.025523906590006),
                                    ("dayday", -5.313205979041787),
                                    ("dd/mmat <time-of-day>", -5.313205979041787),
                                    ("on <day>September", -5.313205979041787),
                                    ("Thursdaydd/mm", -5.718671087149952),
                                    ("dayyear", -2.7482566215802504),
                                    ("New Year's Dayyear (latent)", -5.313205979041787),
                                    ("Thursdayfrom|since|after <time>", -4.0139229949115265),
                                    ("Thursdayat <time-of-day>", -4.109233174715851),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.313205979041787),
                                    ("week-endin|during <named-month>|year", -5.718671087149952),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.718671087149952),
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.313205979041787),
                                    ("Sundayyear (latent)", -4.802380355275797),
                                    ("Christmasat <time-of-day>", -5.718671087149952),
                                    ("from|since|after <time>year (latent)", -4.620058798481842),
                                    ("dd/mmyear (latent)", -5.718671087149952),
                                    ...
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.718671087149952),
                                    ("dayminute", -2.9460823649101706),
                                    ("yyyy-mm-ddhh:mm", -5.313205979041787),
                                    ...
                                    ("from|since|after <time>on <day>", -4.802380355275797),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.14354817086799393,
                               ...
                               n = 149},
                   koData =
                     ClassData{prior = -2.0120002608843035, unseen = -3.332204510175204,
                               likelihoods =
                                 HashMap.fromList
