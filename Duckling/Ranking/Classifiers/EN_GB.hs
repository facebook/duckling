...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5953949971000688, unseen = -6.115892125483034,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 451},
                   koData =
                     ClassData{prior = -0.8015004885481768, unseen = -5.910796644040527,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4679005790489568,
                               unseen = -7.1252830915107115,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.431331081933479),
                                    ("Father's Dayyear (latent)", -6.431331081933479),
                                    ...
                                    ("daymonth", -4.416428061391214),
                                    ("monthday", -6.025865973825314),
                                    ("monthyear", -4.639571612705423),
                                    ...
                                    ("Octoberyear (latent)", -4.927253685157205),
                                    ...
                                    ("dd/mm<time-of-day> am|pm", -6.431331081933479),
                                    ...
                                    ("dd/mmat <time-of-day>", -6.431331081933479),
                                    ...
                                    ("<day-of-month> (ordinal)intersect", -6.025865973825314),
                                    ...
                                    ("absorption of , after named dayintersect",
                                     -5.738183901373533),
                                    ("intersectyear (latent)", -6.431331081933479),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.431331081933479),
                                    ("Mothering Sundayyear (latent)", -6.025865973825314),
                                    ...
                                    ("August Bank Holidayyear (latent)", -5.738183901373533),
                               ...
                               n = 476},
                   koData =
                     ClassData{prior = -0.9843441951191707, unseen = -6.755768921984256,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.557379522151743),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.655991810819852),
                                    ("hourday", -3.6635616461296463),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.061456918928017),
                                    ("<day-of-month> (ordinal)August", -6.061456918928017),
                                    ("dayhour", -3.3873082695014882),
                                    ("<time> timezoneyear (latent)", -5.368309738368072),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.145166187053862),
                                    ("Tuesdayfrom|since|after <time>", -5.368309738368072),
                                    ("daymonth", -3.3873082695014882),
                                    ("monthyear", -4.808693950432649),
                                    ("<time-of-day> am|pmyear (latent)", -5.368309738368072),
                                    ("Thai Pongalyear (latent)", -5.368309738368072),
                                    ("intersecthh:mm", -6.061456918928017),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.655991810819852),
                                    ("<day-of-month> (ordinal)Wednesday", -6.061456918928017),
                                    ("houryear", -4.675162557808126),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.061456918928017),
                                    ("<day-of-month> (ordinal)October", -6.061456918928017),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.368309738368072),
                                    ("hournograin", -4.808693950432649),
                                    ("<time-of-day> am|pmintersect", -4.808693950432649),
                                    ("Octoberyear (latent)", -6.061456918928017),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.655991810819852),
                                    ("until <time>on <day>", -5.368309738368072),
                                    ("time-of-day (latent)intersect", -5.368309738368072),
                                    ("todayin <number> (implicit minutes)", -6.061456918928017),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.368309738368072),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.061456918928017),
                                    ("hh:mmon <day>", -4.808693950432649),
                                    ("hhhmmintersect", -5.655991810819852),
                                    ("absorption of , after named dayJuly", -5.145166187053862),
                                    ("from|since|after <time>July", -5.655991810819852),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.145166187053862),
                                    ("Clean Mondayyear (latent)", -6.061456918928017),
                                    ("monthhour", -6.061456918928017),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.655991810819852),
                                    ("hourmonth", -4.189654742026425),
                                    ("todayat <time-of-day>", -6.061456918928017),
                                    ("Bank Holidayyear (latent)", -5.368309738368072),
                                    ("hhhmmyear (latent)", -4.808693950432649),
                                    ("from|since|after <time>December", -6.061456918928017),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.061456918928017),
                                    ("<time-of-day> am|pmon <day>", -4.808693950432649),
                                    ("Mondayyear (latent)", -5.368309738368072),
                                    ("dayday", -4.675162557808126),
                                    ("dd/mmat <time-of-day>", -5.655991810819852),
                                    ("on <day>September", -5.368309738368072),
                                    ("time-of-day (latent)September", -5.655991810819852),
                                    ("hourhour", -4.962844630259907),
                                    ("time-of-day (latent)on <day>", -4.557379522151743),
                                    ("Thursdaydd/mm", -6.061456918928017),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.655991810819852),
                                    ("dayyear", -3.0410320327836544),
                                    ("New Year's Dayyear (latent)", -5.145166187053862),
                                    ("time-of-day (latent)Sunday", -5.655991810819852),
                                    ("Thursdayfrom|since|after <time>", -4.356708826689592),
                                    ("Thursdayat <time-of-day>", -4.4520190064939165),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.061456918928017),
                                    ("Aprilyear (latent)", -6.061456918928017),
                                    ("the <day-of-month> (ordinal)July", -6.061456918928017),
                                    ("the <day-of-month> (number)July", -6.061456918928017),
                                    ("monthminute", -6.061456918928017),
                                    ("hourminute", -5.368309738368072),
                                    ("<time-of-day> am|pmtomorrow", -6.061456918928017),
                                    ("Thursdayhh:mm", -5.145166187053862),
                                    ("<day-of-month> (ordinal)Tuesday", -5.655991810819852),
                                    ("minutemonth", -3.921390755431746),
                                    ("time-of-day (latent)Friday", -5.655991810819852),
                                    ("minutehour", -6.061456918928017),
                                    ("Augustyear (latent)", -5.655991810819852),
                                    ("week-endin|during <named-month>|year", -6.061456918928017),
                                    ("time-of-day (latent)Tuesday", -5.655991810819852),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.061456918928017),
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.655991810819852),
                                    ("Sundayyear (latent)", -5.145166187053862),
                                    ("Christmasat <time-of-day>", -6.061456918928017),
                                    ("from|since|after <time>year (latent)", -4.962844630259907),
                                    ("dd/mmyear (latent)", -6.061456918928017),
                                    ("hhhmmon <day>", -5.145166187053862),
                                    ("yesterday<time-of-day> am|pm", -6.061456918928017),
                                    ("<day-of-month> (ordinal)July", -5.368309738368072),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.061456918928017),
                                    ("at <time-of-day>intersect", -5.145166187053862),
                                    ("hh:mmyear (latent)", -4.675162557808126),
                                    ("Holiyear (latent)", -6.061456918928017),
                                    ("until <time><time-of-day> am|pm", -6.061456918928017),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.655991810819852),
                                    ("dayminute", -3.1992560379985484),
                                    ("yyyy-mm-ddhh:mm", -5.655991810819852),
                                    ("intersectfrom|since|after <time>", -5.655991810819852),
                                    ("intersectSeptember", -4.189654742026425),
                                    ("minuteday", -2.904456497777904),
                                    ("absorption of , after named dayintersect",
                                     -6.061456918928017),
                                    ("intersectyear (latent)", -6.061456918928017),
                                    ("Februaryin|during the <part-of-day>", -6.061456918928017),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.061456918928017),
                                    ("time-of-day (latent)July", -5.368309738368072),
                                    ("Saturdayyear (latent)", -6.061456918928017),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.061456918928017),
                                    ("at <time-of-day>on <day>", -5.145166187053862),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.061456918928017),
                                    ("absorption of , after named daySeptember",
                                     -4.808693950432649),
                                    ("Naraka Chaturdashiyear (latent)", -6.061456918928017),
                                    ("from|since|after <time>on <day>", -5.145166187053862),
                                    ("dayweek", -6.061456918928017),
                                    ("Easter Sundayyear (latent)", -5.655991810819852),
                                    ("time-of-day (latent)at <time-of-day>", -5.368309738368072),
                                    ("Thursday<time-of-day> am|pm", -4.808693950432649),
                                    ("weekyear", -5.655991810819852),
                                    ("time-of-day (latent)Thursday", -5.655991810819852),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.061456918928017),
                                    ("<day-of-month> (ordinal)April", -6.061456918928017),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.655991810819852),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.368309738368072),
                                    ("Sundayfrom|since|after <time>", -6.061456918928017),
                                    ("absorption of , after named dayFebruary", -5.145166187053862),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.655991810819852),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.061456918928017),
                                    ("tomorrowat <time-of-day>", -6.061456918928017),
                                    ("daynograin", -5.655991810819852),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.655991810819852),
                                    ("last <cycle> of <time>year (latent)", -5.655991810819852),
                                    ("tomorrow<time-of-day> am|pm", -6.061456918928017),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.368309738368072),
                                    ("Diwaliyear (latent)", -5.655991810819852),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.061456918928017),
                                    ("Fridayyear (latent)", -5.655991810819852),
                                    ("time-of-day (latent)April", -6.061456918928017),
                                    ("minuteyear", -3.8642323415917974)],
                               n = 284}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1463987030229403, unseen = -5.424950017481403,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 222},
                   koData =
                     ClassData{prior = -1.9937280234058061,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
