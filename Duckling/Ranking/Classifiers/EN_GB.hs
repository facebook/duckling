...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6433856710008815, unseen = -5.739792912179234,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 309},
                   koData =
                     ClassData{prior = -0.7455151660772612, unseen = -5.638354669333745,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4746656423515469, unseen = -6.756932389247553,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.06262174142431),
                                    ("Father's Dayyear (latent)", -6.06262174142431),
                                    ("Ramadanyear (latent)", -6.06262174142431),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.809858772928942),
                                    ("Bhai Doojyear (latent)", -6.06262174142431),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.809858772928942),
                                    ("hourday", -4.357873649185885),
                                    ("dayhour", -3.200420860494842),
                                    ("Martin Luther King's Dayyear (latent)", -5.657156633316146),
                                    ("Shemini Atzeretyear (latent)", -6.06262174142431),
                                    ("daymonth", -5.146331009550155),
                                    ("monthday", -5.657156633316146),
                                    ("monthyear", -4.270862272196255),
                                    ("Yom Ha'atzmautyear (latent)", -6.06262174142431),
                                    ("Vijayadashamiyear (latent)", -6.06262174142431),
                                    ("Thanksgiving Dayyear (latent)", -4.9640094527562),
                                    ("Thai Pongalyear (latent)", -5.369474560864365),
                                    ("Thiru Onamyear (latent)", -5.369474560864365),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.06262174142431),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.06262174142431),
                                    ("houryear", -5.369474560864365),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.06262174142431),
                                    ("Christmas<time-of-day> am|pm", -6.06262174142431),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.06262174142431),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.369474560864365),
                                    ("<time-of-day> am|pmintersect", -4.809858772928942),
                                    ("Earth Houryear (latent)", -6.06262174142431),
                                    ("Octoberyear (latent)", -4.558544344648036),
                                    ("intersect<time-of-day> am|pm", -6.06262174142431),
                                    ("Mattu Pongalyear (latent)", -6.06262174142431),
                                    ("Shavuotyear (latent)", -6.06262174142431),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.06262174142431),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.06262174142431),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.657156633316146),
                                    ("Marchyear (latent)", -6.06262174142431),
                                    ("Sukkotyear (latent)", -5.657156633316146),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.06262174142431),
                                    ("Clean Mondayyear (latent)", -5.657156633316146),
                                    ("monthhour", -5.657156633316146),
                                    ("todayat <time-of-day>", -6.06262174142431),
                                    ("Thursday<time> timezone", -4.116711592368997),
                                    ("from|since|after <time>December", -6.06262174142431),
                                    ("dd/mm<time-of-day> am|pm", -6.06262174142431),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -6.06262174142431),
                                    ("yyyy-mm-ddhh:mm:ss", -5.657156633316146),
                                    ("dayday", -4.047718720882045),
                                    ("dd/mmat <time-of-day>", -6.06262174142431),
                                    ("<time> <part-of-day>at <time-of-day>", -6.06262174142431),
                                    ("tonightat <time-of-day>", -6.06262174142431),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.369474560864365),
                                    ("today<time-of-day> am|pm", -6.06262174142431),
                                    ("Februarythe <day-of-month> (ordinal)", -5.657156633316146),
                                    ("at <time-of-day><time> <part-of-day>", -6.06262174142431),
                                    ("hourhour", -4.809858772928942),
                                    ("<time-of-day> am|pmon <date>", -4.047718720882045),
                                    ("Navaratriin|during <named-month>|year", -6.06262174142431),
                                    ("Wednesdaythis|last|next <cycle>", -6.06262174142431),
                                    ("Lentyear (latent)", -6.06262174142431),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.558544344648036),
                                    ("Boghiyear (latent)", -6.06262174142431),
                                    ("dayyear", -1.9850842975185905),
                                    ("Thursdayfrom|since|after <time>", -5.657156633316146),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.06262174142431),
                                    ("Thursdayat <time-of-day>", -5.369474560864365),
                                    ("Islamic New Yearyear (latent)", -5.657156633316146),
                                    ("Laylat al-Qadryear (latent)", -5.146331009550155),
                                    ("Shrove Tuesdayyear (latent)", -6.06262174142431),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.369474560864365),
                                    ("<time-of-day> am|pmtomorrow", -5.369474560864365),
                                    ("Yom Kippuryear (latent)", -6.06262174142431),
                                    ("<part-of-day> of <time>year (latent)", -6.06262174142431),
                                    ("minutehour", -5.146331009550155),
                                    ("Kaanum Pongalyear (latent)", -5.657156633316146),
                                    ("Maha Saptamiyear (latent)", -6.06262174142431),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.657156633316146),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.357873649185885),
                                    ("for <duration> from <time>December", -6.06262174142431),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.06262174142431),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.146331009550155),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.657156633316146),
                                    ("Pentecostyear (latent)", -6.06262174142431),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.146331009550155),
                                    ("Eid al-Fitryear (latent)", -6.06262174142431),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.06262174142431),
                                    ("Mondayin|during the <part-of-day>", -6.06262174142431),
                                    ("Chhathin|during <named-month>|year", -6.06262174142431),
                                    ("Diwaliin|during <named-month>|year", -6.06262174142431),
                                    ("Raksha Bandhanyear (latent)", -6.06262174142431),
                                    ("daysecond", -5.657156633316146),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.657156633316146),
                                    ("Ashurayear (latent)", -6.06262174142431),
                                    ("Tuesdayin|during <named-month>|year", -6.06262174142431),
                                    ("Chinese New Yearyear (latent)", -6.06262174142431),
                                    ("Lag BaOmeryear (latent)", -6.06262174142431),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.06262174142431),
                                    ("Eid al-Adhayear (latent)", -5.146331009550155),
                                    ("intersectin|during the <part-of-day>", -6.06262174142431),
                                    ("Palm Sundayyear (latent)", -6.06262174142431),
                                    ("Christmasat <time-of-day>", -6.06262174142431),
                                    ("Passoveryear (latent)", -6.06262174142431),
                                    ("Lazarus Saturdayyear (latent)", -6.06262174142431),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.06262174142431),
                                    ("Yom HaShoahyear (latent)", -5.657156633316146),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.657156633316146),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.06262174142431),
                                    ("Septemberyear (latent)", -5.657156633316146),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.809858772928942),
                                    ("Halloweenyear (latent)", -6.06262174142431),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.06262174142431),
                                    ("at <time-of-day>intersect", -5.657156633316146),
                                    ("Rosh Hashanahyear (latent)", -5.369474560864365),
                                    ("Dhanterasyear (latent)", -6.06262174142431),
                                    ("Tu BiShvatyear (latent)", -6.06262174142431),
                                    ("Holiyear (latent)", -5.369474560864365),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.06262174142431),
                                    ("Holika Dahanyear (latent)", -5.369474560864365),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.06262174142431),
                                    ("dayminute", -3.321781717499109),
                                    ("Mawlidyear (latent)", -6.06262174142431),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.657156633316146),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.06262174142431),
                                    ("Jumu'atul-Widayear (latent)", -5.146331009550155),
                                    ("minuteday", -2.4250355816979243),
                                    ("absorption of , after named dayintersect", -6.06262174142431),
                                    ("Orthodox Easter Sundayyear (latent)", -6.06262174142431),
                                    ("<ordinal> <cycle> of <time>year (latent)", -6.06262174142431),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.06262174142431),
                                    ("Mothering Sundayyear (latent)", -5.657156633316146),
                                    ("Boss's Dayyear (latent)", -5.657156633316146),
                                    ("Global Youth Service Dayyear (latent)", -6.06262174142431),
                                    ("Dhanterasin|during <named-month>|year", -6.06262174142431),
                                    ("Tisha B'Avyear (latent)", -6.06262174142431),
                                    ("Isra and Mi'rajyear (latent)", -5.146331009550155),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.06262174142431),
                                    ("Christmasyear (latent)", -5.657156633316146),
                                    ("Naraka Chaturdashiyear (latent)", -5.657156633316146),
                                    ("at <time-of-day>on <date>", -4.9640094527562),
                                    ("Thai Pongalin|during <named-month>|year", -6.06262174142431),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.45318382899021),
                                    ("dayweek", -6.06262174142431),
                                    ("Easter Sundayyear (latent)", -5.369474560864365),
                                    ("weekyear", -4.9640094527562),
                                    ("hh:mmin|during the <part-of-day>", -5.369474560864365),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.657156633316146),
                                    ("Hanukkahyear (latent)", -5.369474560864365),
                                    ("February<time> <part-of-day>", -6.06262174142431),
                                    ("Great Lentyear (latent)", -6.06262174142431),
                                    ("tomorrowat <time-of-day>", -5.369474560864365),
                                    ("between <time> and <time>on <date>", -4.45318382899021),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.06262174142431),
                                    ("last <cycle> of <time>year (latent)", -5.369474560864365),
                                    ("at <time-of-day>tomorrow", -5.657156633316146),
                                    ("tomorrow<time-of-day> am|pm", -6.06262174142431),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.06262174142431),
                                    ("Diwaliyear (latent)", -6.06262174142431),
                                    ("Black Fridayyear (latent)", -5.657156633316146),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.06262174142431),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.06262174142431),
                                    ("Chhathyear (latent)", -5.657156633316146),
                                    ("Vasant Panchamiyear (latent)", -6.06262174142431),
                                    ("Thursday<time> (timezone)", -6.06262174142431),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.06262174142431),
                                    ("August Bank Holidayyear (latent)", -5.369474560864365),
                                    ("Februaryintersect", -6.06262174142431),
                                    ("Simchat Torahyear (latent)", -6.06262174142431),
                                    ("minuteyear", -6.06262174142431)],
                               n = 321},
                   koData =
                     ClassData{prior = -0.9731072069178159, unseen = -6.410174881966167,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.799090878625398),
