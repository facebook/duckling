...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6971552019574841,
                               unseen = -5.5254529391317835,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 249},
                   koData =
                     ClassData{prior = -0.6891551592904078, unseen = -5.53338948872752,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4874498333153399, unseen = -6.608000625296087,
                               likelihoods =
                                 HashMap.fromList
                                   [("Father's Dayyear (latent)", -5.91350300563827),
                                    ("Ramadanyear (latent)", -5.91350300563827),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.660740037142902),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.660740037142902),
                                    ("hourday", -4.2087549133998445),
                                    ("dayhour", -2.995732273553991),
                                    ("Martin Luther King's Dayyear (latent)", -5.508037897530106),
                                    ("Shemini Atzeretyear (latent)", -5.91350300563827),
                                    ("daymonth", -5.220355825078324),
                                    ("monthday", -5.508037897530106),
                                    ("monthyear", -4.304065093204169),
                                    ("Yom Ha'atzmautyear (latent)", -5.91350300563827),
                                    ("Thanksgiving Dayyear (latent)", -4.814890716970161),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.91350300563827),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.91350300563827),
                                    ("houryear", -5.220355825078324),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.91350300563827),
                                    ("Christmas<time-of-day> am|pm", -5.91350300563827),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.91350300563827),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.220355825078324),
                                    ("<time-of-day> am|pmintersect", -4.660740037142902),
                                    ("Octoberyear (latent)", -4.660740037142902),
                                    ("intersect<time-of-day> am|pm", -5.91350300563827),
                                    ("Shavuotyear (latent)", -5.91350300563827),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.91350300563827),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.91350300563827),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.508037897530106),
                                    ("Marchyear (latent)", -5.91350300563827),
                                    ("Sukkotyear (latent)", -5.508037897530106),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.91350300563827),
                                    ("Clean Mondayyear (latent)", -5.508037897530106),
                                    ("monthhour", -5.508037897530106),
                                    ("todayat <time-of-day>", -5.91350300563827),
                                    ("Thursday<time> timezone", -4.2087549133998445),
                                    ("dd/mm<time-of-day> am|pm", -5.91350300563827),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -5.91350300563827),
                                    ("Palm SundaySunday", -5.508037897530106),
                                    ("dayday", -3.7162784283020507),
                                    ("dd/mmat <time-of-day>", -5.91350300563827),
                                    ("<time> <part-of-day>at <time-of-day>", -5.91350300563827),
                                    ("tonightat <time-of-day>", -5.91350300563827),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.220355825078324),
                                    ("today<time-of-day> am|pm", -5.91350300563827),
                                    ("Februarythe <day-of-month> (ordinal)", -5.508037897530106),
                                    ("at <time-of-day><time> <part-of-day>", -5.91350300563827),
                                    ("hourhour", -4.660740037142902),
                                    ("<time-of-day> am|pmon <date>", -3.898599985096005),
                                    ("Wednesdaythis|last|next <cycle>", -5.91350300563827),
                                    ("Lentyear (latent)", -5.91350300563827),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.409425608861996),
                                    ("dayyear", -2.2122010315257765),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.91350300563827),
                                    ("Thursdayat <time-of-day>", -5.508037897530106),
                                    ("Islamic New Yearyear (latent)", -5.508037897530106),
                                    ("Laylat al-Qadryear (latent)", -4.997212273764115),
                                    ("Shrove Tuesdayyear (latent)", -5.91350300563827),
                                    ("<time-of-day> am|pmtomorrow", -5.220355825078324),
                                    ("Yom Kippuryear (latent)", -5.91350300563827),
                                    ("<part-of-day> of <time>year (latent)", -5.91350300563827),
                                    ("minutehour", -4.997212273764115),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.508037897530106),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.2087549133998445),
                                    ("for <duration> from <time>December", -5.91350300563827),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.91350300563827),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.997212273764115),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.508037897530106),
                                    ("Pentecostyear (latent)", -5.91350300563827),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.997212273764115),
                                    ("Eid al-Fitryear (latent)", -5.91350300563827),
                                    ("Mondayin|during the <part-of-day>", -5.91350300563827),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.508037897530106),
                                    ("Ashurayear (latent)", -5.91350300563827),
                                    ("Chinese New Yearyear (latent)", -5.91350300563827),
                                    ("Sundayyear (latent)", -5.91350300563827),
                                    ("Lag BaOmeryear (latent)", -5.91350300563827),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.91350300563827),
                                    ("Eid al-Adhayear (latent)", -4.997212273764115),
                                    ("intersectin|during the <part-of-day>", -5.91350300563827),
                                    ("Christmasat <time-of-day>", -5.91350300563827),
                                    ("Passoveryear (latent)", -5.91350300563827),
                                    ("Lazarus Saturdayyear (latent)", -5.91350300563827),
                                    ("dd/mmyear (latent)", -5.91350300563827),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.91350300563827),
                                    ("Yom HaShoahyear (latent)", -5.508037897530106),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.997212273764115),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.91350300563827),
                                    ("Septemberyear (latent)", -5.508037897530106),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.660740037142902),
                                    ("Halloweenyear (latent)", -5.91350300563827),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.220355825078324),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -4.997212273764115),
                                    ("at <time-of-day>intersect", -5.508037897530106),
                                    ("Rosh Hashanahyear (latent)", -5.91350300563827),
                                    ("Tu BiShvatyear (latent)", -5.91350300563827),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.91350300563827),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.91350300563827),
                                    ("dayminute", -3.2744456760230114),
                                    ("Mawlidyear (latent)", -5.91350300563827),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.508037897530106),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.91350300563827),
                                    ("Jumu'atul-Widayear (latent)", -4.997212273764115),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.91350300563827),
                                    ("minuteday", -2.275916845911884),
                                    ("absorption of , after named dayintersect", -5.91350300563827),
                                    ("intersectyear (latent)", -5.91350300563827),
                                    ("Orthodox Easter Sundayyear (latent)", -5.91350300563827),
                                    ("<ordinal> <cycle> of <time>year (latent)", -5.91350300563827),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.91350300563827),
                                    ("Mothering Sundayyear (latent)", -5.508037897530106),
                                    ("Boss's Dayyear (latent)", -5.508037897530106),
                                    ("Tisha B'Avyear (latent)", -5.91350300563827),
                                    ("Isra and Mi'rajyear (latent)", -4.997212273764115),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.91350300563827),
                                    ("Christmasyear (latent)", -5.508037897530106),
                                    ("at <time-of-day>on <date>", -4.814890716970161),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.304065093204169),
                                    ("dayweek", -5.91350300563827),
                                    ("Easter Sundayyear (latent)", -5.220355825078324),
                                    ("Thursday<time-of-day> am|pm", -5.91350300563827),
                                    ("weekyear", -5.508037897530106),
                                    ("hh:mmin|during the <part-of-day>", -5.220355825078324),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.508037897530106),
                                    ("Hanukkahyear (latent)", -5.91350300563827),
                                    ("February<time> <part-of-day>", -5.91350300563827),
                                    ("Tuesdayin <named-month>|year", -5.91350300563827),
                                    ("Great Lentyear (latent)", -5.91350300563827),
                                    ("tomorrowat <time-of-day>", -5.220355825078324),
                                    ("between <time> and <time>on <date>", -4.304065093204169),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.220355825078324),
                                    ("last <cycle> of <time>year (latent)", -5.220355825078324),
                                    ("at <time-of-day>tomorrow", -5.508037897530106),
                                    ("tomorrow<time-of-day> am|pm", -5.91350300563827),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.91350300563827),
                                    ("Black Fridayyear (latent)", -5.508037897530106),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.91350300563827),
                                    ("Palm Sundayintersect", -5.91350300563827),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.91350300563827),
                                    ("August Bank Holidayyear (latent)", -5.220355825078324),
                                    ("Februaryintersect", -5.91350300563827),
                                    ("Simchat Torahyear (latent)", -5.91350300563827)],
                               n = 277},
                   koData =
                     ClassData{prior = -0.9524120402881493, unseen = -6.282266746896006,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.58724865840025),
                                    ("hourday", -5.58724865840025),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.58724865840025),
                                    ("dayhour", -3.144901623031045),
                                    ("daymonth", -3.5078071167204135),
                                    ("monthday", -5.181783550292085),
                                    ("monthyear", -4.334485689904882),
                                    ("<time-of-day> am|pmyear (latent)", -5.181783550292085),
                                    ("intersecthh:mm", -5.58724865840025),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.58724865840025),
                                    ("houryear", -4.6709579265260945),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.58724865840025),
                                    ("until <time-of-day><time-of-day> am|pm", -5.58724865840025),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.894101477840304),
                                    ("<time-of-day> am|pmintersect", -4.334485689904882),
                                    ("Octoberyear (latent)", -5.58724865840025),
                                    ...
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -4.334485689904882),
                                    ("about|exactly <time-of-day>year (latent)", -5.58724865840025),
                                    ("absorption of , after named dayJuly", -5.181783550292085),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.6709579265260945),
                                    ("Clean Mondayyear (latent)", -5.58724865840025),
                                    ("monthhour", -5.58724865840025),
                                    ("hourmonth", -4.894101477840304),
                                    ("todayat <time-of-day>", -5.58724865840025),
                                    ("Bank Holidayyear (latent)", -4.894101477840304),
                                    ("from|since|after <time-of-day>July", -5.58724865840025),
                                    ("Mondayyear (latent)", -4.894101477840304),
                                    ("dayday", -5.181783550292085),
                                    ("dd/mmat <time-of-day>", -5.181783550292085),
                                    ("<time-of-day> am|pmon <date>", -4.334485689904882),
                                    ("Thursdaydd/mm", -5.58724865840025),
                                    ("dayyear", -2.725047777470781),
                                    ("New Year's Dayyear (latent)", -5.181783550292085),
                                    ("Thursdayat <time-of-day>", -4.334485689904882),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.58724865840025),
                                    ("Aprilyear (latent)", -5.58724865840025),
                                    ("monthminute", -5.58724865840025),
                                    ("<time-of-day> am|pmtomorrow", -5.58724865840025),
                                    ("Thursdayhh:mm", -4.6709579265260945),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.58724865840025),
                                    ("minutemonth", -3.7954891891721947),
                                    ("Sundayfrom|since|after <time-of-day>", -5.58724865840025),
                                    ("week-endin <named-month>|year", -5.58724865840025),
                                    ("Augustyear (latent)", -5.181783550292085),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.181783550292085),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.181783550292085),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.181783550292085),
                                    ("Sundayyear (latent)", -4.894101477840304),
                                    ("Christmasat <time-of-day>", -5.58724865840025),
                                    ("dd/mmyear (latent)", -5.58724865840025),
                                    ("<duration> after|before|from <time>December",
                                     -5.58724865840025),
                                    ("yesterday<time-of-day> am|pm", -5.58724865840025),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.58724865840025),
                                    ("until <time-of-day>on <date>", -4.894101477840304),
                                    ("at <time-of-day>intersect", -5.181783550292085),
                                    ("hh:mmyear (latent)", -4.48863636973214),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.58724865840025),
                                    ("dayminute", -3.1023420086122493),
                                    ("intersectSeptember", -4.083171261623976),
                                    ("minuteday", -2.519195723266632),
                                    ("absorption of , after named dayintersect", -5.58724865840025),
                                    ("Februaryin|during the <part-of-day>", -5.58724865840025),
                                    ("hh:mmon <date>", -3.572345637857985),
                                    ("Saturdayyear (latent)", -5.58724865840025),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.58724865840025),
                                    ("absorption of , after named daySeptember",
                                     -4.6709579265260945),
                                    ("on <date>September", -5.181783550292085),
                                    ("at <time-of-day>on <date>", -5.181783550292085),
                                    ("in <named-month>|yearyear (latent)", -5.58724865840025),
                                    ("dayweek", -5.58724865840025),
                                    ("Easter Sundayyear (latent)", -5.181783550292085),
                                    ("Thursday<time-of-day> am|pm", -5.181783550292085),
                                    ("absorption of , after named dayFebruary",
                                     -4.6709579265260945),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.58724865840025),
                                    ("tomorrowat <time-of-day>", -5.58724865840025),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.58724865840025),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.977810745966149),
                                    ("tomorrow<time-of-day> am|pm", -5.58724865840025),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.894101477840304),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.58724865840025),
                                    ("Fridayyear (latent)", -5.181783550292085),
                                    ("minuteyear", -4.334485689904882)],
                               n = 174}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.19971329950582378,
                               ...
                               n = 95},
                   koData =
                     ClassData{prior = -1.7090677533829417, unseen = -3.258096538021482,
                               likelihoods =
                                 HashMap.fromList
