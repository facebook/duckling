...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5832944005795394, unseen = -6.159095388491933,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 471},
                   koData =
                     ClassData{prior = -0.8165740749521416, unseen = -5.926926025970411,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.474194440260345, unseen = -7.1853870155804165,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.491481972157369),
                                    ...
                                    ("daymonth", -4.476578951615105),
                                    ("monthday", -6.0860168640492045),
                                    ("monthyear", -4.699722502929315),
                               ...
                               n = 506},
                   koData =
                     ClassData{prior = -0.9738833619606134, unseen = -6.826545223556594,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.628235458919088),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.726847747587197),
                                    ("hourday", -3.7344175828969908),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.132312855695361),
                                    ("<day-of-month> (ordinal)August", -6.132312855695361),
                                    ("dayhour", -3.4581642062688327),
                                    ("<time> timezoneyear (latent)", -5.439165675135416),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.216022123821206),
                                    ("Tuesdayfrom|since|after <time>", -5.439165675135416),
                                    ("daymonth", -3.4581642062688327),
                                    ("monthyear", -4.879549887199993),
                                    ("<time-of-day> am|pmyear (latent)", -5.439165675135416),
                                    ("Thai Pongalyear (latent)", -5.439165675135416),
                                    ("intersecthh:mm", -6.132312855695361),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.726847747587197),
                                    ("<day-of-month> (ordinal)Wednesday", -6.132312855695361),
                                    ("houryear", -4.746018494575471),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.132312855695361),
                                    ("<day-of-month> (ordinal)October", -6.132312855695361),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.439165675135416),
                                    ("hournograin", -4.879549887199993),
                                    ("<time-of-day> am|pmintersect", -4.879549887199993),
                                    ("Octoberyear (latent)", -6.132312855695361),
                                    ("Good Fridayyear (latent)", -6.132312855695361),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.726847747587197),
                                    ("early morningat <time-of-day>", -6.132312855695361),
                                    ("until <time>on <day>", -5.439165675135416),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.132312855695361),
                                    ("time-of-day (latent)intersect", -5.439165675135416),
                                    ("todayin <number> (implicit minutes)", -6.132312855695361),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.439165675135416),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.132312855695361),
                                    ("hh:mmon <day>", -4.879549887199993),
                                    ("hhhmmintersect", -5.726847747587197),
                                    ("absorption of , after named dayJuly", -5.216022123821206),
                                    ("from|since|after <time>July", -5.726847747587197),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.216022123821206),
                                    ("Clean Mondayyear (latent)", -6.132312855695361),
                                    ("monthhour", -6.132312855695361),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.726847747587197),
                                    ("hourmonth", -4.2605106787937705),
                                    ("todayat <time-of-day>", -6.132312855695361),
                                    ("Bank Holidayyear (latent)", -5.439165675135416),
                                    ("hhhmmyear (latent)", -4.879549887199993),
                                    ("from|since|after <time>December", -6.132312855695361),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.132312855695361),
                                    ("<time-of-day> am|pmon <day>", -4.879549887199993),
                                    ("Mondayyear (latent)", -5.439165675135416),
                                    ("dayday", -4.117409835153096),
                                    ("dd/mmat <time-of-day>", -5.726847747587197),
                                    ("on <day>September", -5.439165675135416),
                                    ("time-of-day (latent)September", -5.726847747587197),
                                    ("hourhour", -3.8810210570888666),
                                    ("time-of-day (latent)on <day>", -4.628235458919088),
                                    ("Thursdaydd/mm", -6.132312855695361),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.726847747587197),
                                    ("dayyear", -3.041270402337046),
                                    ("New Year's Dayyear (latent)", -5.216022123821206),
                                    ("time-of-day (latent)Sunday", -5.726847747587197),
                                    ("Thursdayfrom|since|after <time>", -4.427564763456936),
                                    ("Thursdayat <time-of-day>", -4.522874943261261),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.132312855695361),
                                    ("Aprilyear (latent)", -6.132312855695361),
                                    ("the <day-of-month> (ordinal)July", -6.132312855695361),
                                    ("the <day-of-month> (number)July", -6.132312855695361),
                                    ("monthminute", -6.132312855695361),
                                    ("hourminute", -5.439165675135416),
                                    ("<time-of-day> am|pmtomorrow", -6.132312855695361),
                                    ("Thursdayhh:mm", -5.216022123821206),
                                    ("<day-of-month> (ordinal)Tuesday", -5.726847747587197),
                                    ("minutemonth", -3.9922466921990907),
                                    ("time-of-day (latent)Friday", -5.726847747587197),
                                    ("minutehour", -6.132312855695361),
                                    ("part of daysat <time-of-day>", -5.033700567027251),
                                    ("Augustyear (latent)", -5.726847747587197),
                                    ("Orthodox Great Fridayyear (latent)", -6.132312855695361),
                                    ("week-endin|during <named-month>|year", -6.132312855695361),
                                    ("time-of-day (latent)Tuesday", -5.726847747587197),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.132312855695361),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.726847747587197),
                                    ("Sundayyear (latent)", -5.216022123821206),
                                    ("the <day-of-month> (ordinal)Monday", -5.439165675135416),
                                    ("Christmasat <time-of-day>", -6.132312855695361),
                                    ("from|since|after <time>year (latent)", -5.033700567027251),
                                    ("dd/mmyear (latent)", -6.132312855695361),
                                    ("hhhmmon <day>", -5.216022123821206),
                                    ("yesterday<time-of-day> am|pm", -6.132312855695361),
                                    ("<day-of-month> (ordinal)July", -5.439165675135416),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.132312855695361),
                                    ("at <time-of-day>intersect", -5.216022123821206),
                                    ("hh:mmyear (latent)", -4.746018494575471),
                                    ("Holiyear (latent)", -6.132312855695361),
                                    ("until <time><time-of-day> am|pm", -6.132312855695361),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.726847747587197),
                                    ("dayminute", -3.270111974765893),
                                    ("yyyy-mm-ddhh:mm", -5.726847747587197),
                                    ("intersectfrom|since|after <time>", -5.726847747587197),
                                    ("intersectSeptember", -4.2605106787937705),
                                    ("minuteday", -2.9753124345452484),
                                    ("absorption of , after named dayintersect",
                                     -6.132312855695361),
                                    ("intersectyear (latent)", -6.132312855695361),
                                    ("Februaryin|during the <part-of-day>", -6.132312855695361),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.132312855695361),
                                    ("time-of-day (latent)July", -5.439165675135416),
                                    ("Saturdayyear (latent)", -6.132312855695361),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.132312855695361),
                                    ("<day-of-month> (ordinal)Monday", -5.216022123821206),
                                    ("at <time-of-day>on <day>", -5.216022123821206),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.132312855695361),
                                    ("absorption of , after named daySeptember",
                                     -4.879549887199993),
                                    ("Naraka Chaturdashiyear (latent)", -6.132312855695361),
                                    ("from|since|after <time>on <day>", -5.216022123821206),
                                    ("dayweek", -6.132312855695361),
                                    ("Easter Sundayyear (latent)", -5.726847747587197),
                                    ("time-of-day (latent)at <time-of-day>", -5.439165675135416),
                                    ("Thursday<time-of-day> am|pm", -4.879549887199993),
                                    ("weekyear", -5.726847747587197),
                                    ("time-of-day (latent)Thursday", -5.726847747587197),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.132312855695361),
                                    ("<day-of-month> (ordinal)April", -6.132312855695361),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.726847747587197),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.439165675135416),
                                    ("Sundayfrom|since|after <time>", -6.132312855695361),
                                    ("absorption of , after named dayFebruary", -5.216022123821206),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.726847747587197),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.132312855695361),
                                    ("tomorrowat <time-of-day>", -6.132312855695361),
                                    ("daynograin", -5.726847747587197),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.726847747587197),
                                    ("last <cycle> of <time>year (latent)", -5.726847747587197),
                                    ("tomorrow<time-of-day> am|pm", -6.132312855695361),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.439165675135416),
                                    ("Diwaliyear (latent)", -5.726847747587197),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.132312855695361),
                                    ("this <part-of-day>at <time-of-day>", -5.216022123821206),
                                    ("Fridayyear (latent)", -5.439165675135416),
                                    ("time-of-day (latent)April", -6.132312855695361),
                                    ("minuteyear", -3.9350882783591423)],
                               n = 307}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.14903557916048782, unseen = -5.43372200355424,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 224},
                   koData =
                     ClassData{prior = -1.9771626925594177, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
