...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5818589652688437, unseen = -6.156978985585555,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 470},
                   koData =
                     ClassData{prior = -0.818389597365513, unseen = -5.921578419643816,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47198579044972677,
                               unseen = -7.1808311990445555,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.486922693742851),
                                    ("Father's Dayyear (latent)", -6.486922693742851),
                                    ("Karva Chauthyear (latent)", -6.486922693742851),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.486922693742851),
                                    ("Maha Shivaratriyear (latent)", -6.486922693742851),
                                    ("Ramadanyear (latent)", -5.2341597252474825),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.100628332622961),
                                    ("Bhai Doojyear (latent)", -6.486922693742851),
                                    ("hourday", -4.472019673200586),
                                    ("dayhour", -3.442400256019428),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.100628332622961),
                                    ("Martin Luther King's Dayyear (latent)", -6.081457585634687),
                                    ("Shemini Atzeretyear (latent)", -6.486922693742851),
                                    ("daymonth", -4.472019673200586),
                                    ("monthday", -6.081457585634687),
                                    ("monthyear", -4.695163224514796),
                                    ("Yom Ha'atzmautyear (latent)", -6.486922693742851),
                                    ("Vijayadashamiyear (latent)", -6.486922693742851),
                                    ("Thanksgiving Dayyear (latent)", -5.3883104050747415),
                                    ("Thai Pongalyear (latent)", -5.793775513182905),
                                    ("Thiru Onamyear (latent)", -5.793775513182905),
                                    ("hhhmmabsorption of , after named day", -6.486922693742851),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.486922693742851),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.5706319618686955),
                                    ("<day-of-month> (ordinal)Wednesday", -6.486922693742851),
                                    ("Krishna Janmashtamiyear (latent)", -6.081457585634687),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.486922693742851),
                                    ("houryear", -5.5706319618686955),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.486922693742851),
                                    ("Christmas<time-of-day> am|pm", -6.486922693742851),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.486922693742851),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.793775513182905),
                                    ("intersectin|during <named-month>|year", -6.486922693742851),
                                    ("<time-of-day> am|pmintersect", -5.2341597252474825),
                                    ("Earth Houryear (latent)", -6.486922693742851),
                                    ("Ganesh Chaturthiyear (latent)", -6.486922693742851),
                                    ("Octoberyear (latent)", -4.982845296966577),
                                    ("intersect<time-of-day> am|pm", -6.486922693742851),
                                    ("Mattu Pongalyear (latent)", -6.486922693742851),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.486922693742851),
                                    ("Shavuotyear (latent)", -6.486922693742851),
                                    ("Parsi New Yearyear (latent)", -5.5706319618686955),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.486922693742851),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.486922693742851),
                                    ("todayin|within|after <duration>", -6.486922693742851),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.081457585634687),
                                    ("Marchyear (latent)", -6.486922693742851),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.081457585634687),
                                    ("Sukkotyear (latent)", -6.081457585634687),
                                    ("hhhmmintersect", -6.081457585634687),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.081457585634687),
                                    ("Clean Mondayyear (latent)", -6.081457585634687),
                                    ("monthhour", -6.081457585634687),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.793775513182905),
                                    ("todayat <time-of-day>", -6.486922693742851),
                                    ("Thursday<time> timezone", -4.089027420944481),
                                    ("tonight<time-of-day> am|pm", -6.486922693742851),
                                    ("time-of-day (latent)tonight", -6.081457585634687),
                                    ("from|since|after <time>December", -6.486922693742851),
                                    ("dd/mm<time-of-day> am|pm", -6.486922693742851),
                                    ("<time-of-day> am|pmon <day>", -4.472019673200586),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.486922693742851),
                                    ("yyyy-mm-ddhh:mm:ss", -6.081457585634687),
                                    ("dayday", -3.778872492640641),
                                    ("dd/mmat <time-of-day>", -6.486922693742851),
                                    ("<time> <part-of-day>at <time-of-day>", -6.081457585634687),
                                    ("tonightat <time-of-day>", -5.793775513182905),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.793775513182905),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.486922693742851),
                                    ("today<time-of-day> am|pm", -6.486922693742851),
                                    ("Februarythe <day-of-month> (ordinal)", -6.081457585634687),
                                    ("at <time-of-day><time> <part-of-day>", -6.486922693742851),
                                    ("<day-of-month> (ordinal)intersect", -6.081457585634687),
                                    ("hourhour", -3.596550935846686),
                                    ("Mahavir Jayantiyear (latent)", -6.081457585634687),
                                    ("Navaratriin|during <named-month>|year", -6.486922693742851),
                                    ("Wednesdaythis|last|next <cycle>", -6.486922693742851),
                                    ("Lentyear (latent)", -6.486922693742851),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.61512051684126),
                                    ("Boghiyear (latent)", -6.486922693742851),
                                    ("dayyear", -1.8968661455648077),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.486922693742851),
                                    ("Thursdayfrom|since|after <time>", -6.081457585634687),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.486922693742851),
                                    ("Thursdayat <time-of-day>", -5.793775513182905),
                                    ("Islamic New Yearyear (latent)", -6.081457585634687),
                                    ("Laylat al-Qadryear (latent)", -5.5706319618686955),
                                    ("part of days<time-of-day> am|pm", -6.486922693742851),
                                    ("Shrove Tuesdayyear (latent)", -6.486922693742851),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.793775513182905),
                                    ("hourminute", -6.081457585634687),
                                    ("<time-of-day> am|pmtomorrow", -5.793775513182905),
                                    ("Yom Kippuryear (latent)", -6.486922693742851),
                                    ("<day-of-month> (ordinal)Tuesday", -6.081457585634687),
                                    ("<part-of-day> of <time>year (latent)", -6.486922693742851),
                                    ("minutehour", -5.2341597252474825),
                                    ("Kaanum Pongalyear (latent)", -6.081457585634687),
                                    ("Maha Saptamiyear (latent)", -6.486922693742851),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.793775513182905),
                                    ("time-of-day (latent)tomorrow", -5.5706319618686955),
                                    ("part of daysat <time-of-day>", -4.87748478130875),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.472019673200586),
                                    ("for <duration> from <time>December", -6.486922693742851),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.486922693742851),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.2341597252474825),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.2341597252474825),
                                    ("time-of-day (latent)this <part-of-day>", -6.486922693742851),
                                    ("Pentecostyear (latent)", -6.486922693742851),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.2341597252474825),
                                    ("<day-of-month> (ordinal)February", -6.486922693742851),
                                    ("Eid al-Fitryear (latent)", -5.100628332622961),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.486922693742851),
                                    ("Mondayin|during the <part-of-day>", -6.486922693742851),
                                    ("Chhathin|during <named-month>|year", -6.486922693742851),
                                    ("Diwaliin|during <named-month>|year", -6.486922693742851),
                                    ("this <part-of-day><time-of-day> am|pm", -6.486922693742851),
                                    ("Vaisakhiin|during <named-month>|year", -6.486922693742851),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.2341597252474825),
                                    ("Raksha Bandhanyear (latent)", -6.486922693742851),
                                    ("daysecond", -6.081457585634687),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.081457585634687),
                                    ("Ratha-Yatrayear (latent)", -6.486922693742851),
                                    ("Ashurayear (latent)", -6.486922693742851),
                                    ("Tuesdayin|during <named-month>|year", -6.486922693742851),
                                    ("Chinese New Yearyear (latent)", -6.486922693742851),
                                    ("tomorrowintersect", -6.486922693742851),
                                    ("Lag BaOmeryear (latent)", -6.486922693742851),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.486922693742851),
                                    ("Eid al-Adhayear (latent)", -4.34685653024658),
                                    ("intersectin|during the <part-of-day>", -6.486922693742851),
                                    ("Palm Sundayyear (latent)", -6.486922693742851),
                                    ("Christmasat <time-of-day>", -6.486922693742851),
                                    ("Passoveryear (latent)", -6.486922693742851),
                                    ("Lazarus Saturdayyear (latent)", -6.486922693742851),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.486922693742851),
                                    ("hhhmmon <day>", -5.5706319618686955),
                                    ("Yom HaShoahyear (latent)", -6.081457585634687),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.081457585634687),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.486922693742851),
                                    ("Septemberyear (latent)", -6.081457585634687),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.982845296966577),
                                    ("Halloweenyear (latent)", -6.486922693742851),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.486922693742851),
                                    ("at <time-of-day>intersect", -5.5706319618686955),
                                    ("Rosh Hashanahyear (latent)", -5.793775513182905),
                                    ("Dhanterasyear (latent)", -6.486922693742851),
                                    ("Tu BiShvatyear (latent)", -6.486922693742851),
                                    ("<day-of-month> (ordinal)December", -5.793775513182905),
                                    ("Holiyear (latent)", -5.793775513182905),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.486922693742851),
                                    ("Holika Dahanyear (latent)", -5.793775513182905),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.081457585634687),
                                    ("dayminute", -3.137018606468246),
                                    ("Mawlidyear (latent)", -6.486922693742851),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.081457585634687),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.486922693742851),
                                    ("Jumu'atul-Widayear (latent)", -5.5706319618686955),
                                    ("minuteday", -2.7492530754594826),
                                    ("absorption of , after named dayintersect",
                                     -5.793775513182905),
                                    ("intersectyear (latent)", -6.486922693742851),
                                    ("Orthodox Easter Sundayyear (latent)", -6.486922693742851),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.486922693742851),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.486922693742851),
                                    ("intersecthhhmm", -6.081457585634687),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.486922693742851),
                                    ("Mothering Sundayyear (latent)", -6.081457585634687),
                                    ("Boss's Dayyear (latent)", -6.081457585634687),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.486922693742851),
                                    ("Global Youth Service Dayyear (latent)", -6.486922693742851),
                                    ("Dhanterasin|during <named-month>|year", -6.486922693742851),
                                    ("Tisha B'Avyear (latent)", -6.486922693742851),
                                    ("Isra and Mi'rajyear (latent)", -5.5706319618686955),
                                    ("at <time-of-day>on <day>", -4.87748478130875),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.081457585634687),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.793775513182905),
                                    ("Christmasyear (latent)", -6.081457585634687),
                                    ("Saturdayintersect", -6.486922693742851),
                                    ("Naraka Chaturdashiyear (latent)", -6.081457585634687),
                                    ("Thai Pongalin|during <named-month>|year", -6.486922693742851),
                                    ("dayweek", -6.486922693742851),
                                    ("Easter Sundayyear (latent)", -5.793775513182905),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.081457585634687),
                                    ("weekyear", -5.3883104050747415),
                                    ("King's Dayyear (latent)", -4.982845296966577),
                                    ("hh:mmin|during the <part-of-day>", -5.5706319618686955),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.081457585634687),
                                    ("Hanukkahyear (latent)", -5.793775513182905),
                                    ("Rama Navamiyear (latent)", -6.486922693742851),
                                    ("February<time> <part-of-day>", -6.486922693742851),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.793775513182905),
                                    ("Great Lentyear (latent)", -6.486922693742851),
                                    ("tomorrowat <time-of-day>", -5.793775513182905),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.486922693742851),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.081457585634687),
                                    ("Ugadiyear (latent)", -5.100628332622961),
                                    ("Vaisakhiyear (latent)", -5.793775513182905),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.793775513182905),
                                    ("last <cycle> of <time>year (latent)", -5.793775513182905),
                                    ("at <time-of-day>tomorrow", -6.081457585634687),
                                    ("tomorrow<time-of-day> am|pm", -6.486922693742851),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.486922693742851),
                                    ("Diwaliyear (latent)", -6.486922693742851),
                                    ("between <time> and <time>on <day>", -6.081457585634687),
                                    ("Black Fridayyear (latent)", -6.081457585634687),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.486922693742851),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.486922693742851),
                                    ("Chhathyear (latent)", -6.081457585634687),
                                    ("Vasant Panchamiyear (latent)", -6.486922693742851),
                                    ("Rabindra Jayantiyear (latent)", -5.2341597252474825),
                                    ("this <part-of-day>at <time-of-day>", -5.2341597252474825),
                                    ("St Patrick's Dayyear (latent)", -6.486922693742851),
                                    ("Thursday<time> (timezone)", -6.486922693742851),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.486922693742851),
                                    ("Pargat Diwasyear (latent)", -5.2341597252474825),
                                    ("August Bank Holidayyear (latent)", -5.793775513182905),
                                    ("<datetime> - <datetime> (interval)July", -6.081457585634687),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.793775513182905),
                                    ("Februaryintersect", -6.486922693742851),
                                    ("Simchat Torahyear (latent)", -6.486922693742851),
                                    ("minuteyear", -6.486922693742851)],
                               n = 504},
                   koData =
                     ClassData{prior = -0.9775343571148737, unseen = -6.81783057145415,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.619511303258749),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.718123591926859),
                                    ("hourday", -3.7256934272366524),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.1235887000350235),
                                    ("<day-of-month> (ordinal)August", -6.1235887000350235),
                                    ("dayhour", -3.4494400506084943),
                                    ("<time> timezoneyear (latent)", -5.430441519475078),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.207297968160868),
                                    ("Tuesdayfrom|since|after <time>", -5.430441519475078),
                                    ("daymonth", -3.4494400506084943),
                                    ("monthyear", -4.8708257315396555),
                                    ("<time-of-day> am|pmyear (latent)", -5.430441519475078),
                                    ("Thai Pongalyear (latent)", -5.430441519475078),
                                    ("intersecthh:mm", -6.1235887000350235),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.718123591926859),
                                    ("<day-of-month> (ordinal)Wednesday", -6.1235887000350235),
                                    ("houryear", -4.737294338915133),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.1235887000350235),
                                    ("<day-of-month> (ordinal)October", -6.1235887000350235),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.430441519475078),
                                    ("hournograin", -4.8708257315396555),
                                    ("<time-of-day> am|pmintersect", -4.8708257315396555),
                                    ("Octoberyear (latent)", -6.1235887000350235),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.718123591926859),
                                    ("early morningat <time-of-day>", -6.1235887000350235),
                                    ("until <time>on <day>", -5.430441519475078),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.1235887000350235),
                                    ("time-of-day (latent)intersect", -5.430441519475078),
                                    ("todayin <number> (implicit minutes)", -6.1235887000350235),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.430441519475078),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.1235887000350235),
                                    ("hh:mmon <day>", -4.8708257315396555),
                                    ("hhhmmintersect", -5.718123591926859),
                                    ("absorption of , after named dayJuly", -5.207297968160868),
                                    ("from|since|after <time>July", -5.718123591926859),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.207297968160868),
                                    ("Clean Mondayyear (latent)", -6.1235887000350235),
                                    ("monthhour", -6.1235887000350235),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.718123591926859),
                                    ("hourmonth", -4.251786523133432),
                                    ("todayat <time-of-day>", -6.1235887000350235),
                                    ("Bank Holidayyear (latent)", -5.430441519475078),
                                    ("hhhmmyear (latent)", -4.8708257315396555),
                                    ("from|since|after <time>December", -6.1235887000350235),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.1235887000350235),
                                    ("<time-of-day> am|pmon <day>", -4.8708257315396555),
                                    ("Mondayyear (latent)", -5.430441519475078),
                                    ("dayday", -4.108685679492758),
                                    ("dd/mmat <time-of-day>", -5.718123591926859),
                                    ("on <day>September", -5.430441519475078),
                                    ("time-of-day (latent)September", -5.718123591926859),
                                    ("hourhour", -3.872296901428528),
                                    ("time-of-day (latent)on <day>", -4.619511303258749),
                                    ("Thursdaydd/mm", -6.1235887000350235),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.718123591926859),
                                    ("dayyear", -3.1031638138906605),
                                    ("New Year's Dayyear (latent)", -5.207297968160868),
                                    ("time-of-day (latent)Sunday", -5.718123591926859),
                                    ("Thursdayfrom|since|after <time>", -4.418840607796598),
                                    ("Thursdayat <time-of-day>", -4.514150787600923),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.1235887000350235),
                                    ("Aprilyear (latent)", -6.1235887000350235),
                                    ("the <day-of-month> (ordinal)July", -6.1235887000350235),
                                    ("the <day-of-month> (number)July", -6.1235887000350235),
                                    ("monthminute", -6.1235887000350235),
                                    ("hourminute", -5.430441519475078),
                                    ("<time-of-day> am|pmtomorrow", -6.1235887000350235),
                                    ("Thursdayhh:mm", -5.207297968160868),
                                    ("<day-of-month> (ordinal)Tuesday", -5.718123591926859),
                                    ("minutemonth", -3.9835225365387523),
                                    ("time-of-day (latent)Friday", -5.718123591926859),
                                    ("minutehour", -6.1235887000350235),
                                    ("part of daysat <time-of-day>", -5.0249764113669135),
                                    ("Augustyear (latent)", -5.718123591926859),
                                    ("week-endin|during <named-month>|year", -6.1235887000350235),
                                    ("time-of-day (latent)Tuesday", -5.718123591926859),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.1235887000350235),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.718123591926859),
                                    ("Sundayyear (latent)", -5.207297968160868),
                                    ("the <day-of-month> (ordinal)Monday", -5.430441519475078),
                                    ("Christmasat <time-of-day>", -6.1235887000350235),
                                    ("from|since|after <time>year (latent)", -5.0249764113669135),
                                    ("dd/mmyear (latent)", -6.1235887000350235),
                                    ("hhhmmon <day>", -5.207297968160868),
                                    ("yesterday<time-of-day> am|pm", -6.1235887000350235),
                                    ("<day-of-month> (ordinal)July", -5.430441519475078),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.1235887000350235),
                                    ("at <time-of-day>intersect", -5.207297968160868),
                                    ("hh:mmyear (latent)", -4.737294338915133),
                                    ("Holiyear (latent)", -6.1235887000350235),
                                    ("until <time><time-of-day> am|pm", -6.1235887000350235),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.718123591926859),
                                    ("dayminute", -3.261387819105555),
                                    ("yyyy-mm-ddhh:mm", -5.718123591926859),
                                    ("intersectfrom|since|after <time>", -5.718123591926859),
                                    ("intersectSeptember", -4.251786523133432),
                                    ("minuteday", -2.96658827888491),
                                    ("absorption of , after named dayintersect",
                                     -6.1235887000350235),
                                    ("intersectyear (latent)", -6.1235887000350235),
                                    ("Februaryin|during the <part-of-day>", -6.1235887000350235),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.1235887000350235),
                                    ("time-of-day (latent)July", -5.430441519475078),
                                    ("Saturdayyear (latent)", -6.1235887000350235),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.1235887000350235),
                                    ("<day-of-month> (ordinal)Monday", -5.207297968160868),
                                    ("at <time-of-day>on <day>", -5.207297968160868),
                                    ("time-of-day (latent)<time-of-day> am|pm",
                                     -6.1235887000350235),
                                    ("absorption of , after named daySeptember",
                                     -4.8708257315396555),
                                    ("Naraka Chaturdashiyear (latent)", -6.1235887000350235),
                                    ("from|since|after <time>on <day>", -5.207297968160868),
                                    ("dayweek", -6.1235887000350235),
                                    ("Easter Sundayyear (latent)", -5.718123591926859),
                                    ("time-of-day (latent)at <time-of-day>", -5.430441519475078),
                                    ("Thursday<time-of-day> am|pm", -4.8708257315396555),
                                    ("weekyear", -5.718123591926859),
                                    ("time-of-day (latent)Thursday", -5.718123591926859),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.1235887000350235),
                                    ("<day-of-month> (ordinal)April", -6.1235887000350235),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.718123591926859),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.430441519475078),
                                    ("Sundayfrom|since|after <time>", -6.1235887000350235),
                                    ("absorption of , after named dayFebruary", -5.207297968160868),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.718123591926859),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.1235887000350235),
                                    ("tomorrowat <time-of-day>", -6.1235887000350235),
                                    ("daynograin", -5.718123591926859),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.718123591926859),
                                    ("last <cycle> of <time>year (latent)", -5.718123591926859),
                                    ("tomorrow<time-of-day> am|pm", -6.1235887000350235),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.430441519475078),
                                    ("Diwaliyear (latent)", -5.718123591926859),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.1235887000350235),
                                    ("this <part-of-day>at <time-of-day>", -5.207297968160868),
                                    ("Fridayyear (latent)", -5.718123591926859),
                                    ("time-of-day (latent)April", -6.1235887000350235),
                                    ("minuteyear", -3.9263641226988035)],
                               n = 304}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.14518200984449783, unseen = -5.43372200355424,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 224},
                   koData =
                     ClassData{prior = -2.001480000210124, unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6270073780554003, unseen = -4.852030263919617,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 125},
                   koData =
                     ClassData{prior = -0.7639732331285577, unseen = -4.718498871295094,
                               likelihoods =
                                 HashMap.fromList
