...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6449250368545221, unseen = -5.736572297479192,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 308},
                   koData =
                     ClassData{prior = -0.7438130380067308, unseen = -5.638354669333745,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47390226966139287, unseen = -6.75343791859778,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                    ...
                                    ("Bank Holidayyear (latent)", -5.017279836814924),
                                    ...
                                    ("dd/mmat <time-of-day>", -5.304961909266705),
                                    ("<time-of-day> am|pmon <date>", -4.457664048879502),
                                    ("Thursdaydd/mm", -5.71042701737487),
                                    ("dayyear", -2.740012551805169),
                                    ...
                                    ("dd/mmyear (latent)", -5.71042701737487),
                                    ...
                                    ("hh:mmyear (latent)", -4.61181472870676),
                                    ...
                                    ("hh:mmon <date>", -3.695523996832605),
                                    ("Saturdayyear (latent)", -5.71042701737487),
                                    ("from|since|after <time>on <date>", -4.794136285500715),
                                    ("absorption of , after named daySeptember",
                                     -4.794136285500715),
                                    ("Naraka Chaturdashiyear (latent)", -5.71042701737487),
                                    ("on <date>September", -5.304961909266705),
                                    ("at <time-of-day>on <date>", -5.304961909266705),
                                    ("dayweek", -5.71042701737487),
                                    ("Easter Sundayyear (latent)", -5.304961909266705),
                                    ("Thursday<time-of-day> am|pm", -4.61181472870676),
