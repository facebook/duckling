...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6235383558659617, unseen = -5.676753802268282,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 290},
                   koData =
                     ClassData{prior = -0.7679663397146976, unseen = -5.53338948872752,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48174227850943147,
                               unseen = -6.717804695023691,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.023447592961032),
                                    ("Father's Dayyear (latent)", -6.023447592961032),
                                    ...
                                    ("daymonth", -5.330300412401088),
                                    ("monthday", -5.6179824848528686),
                                    ("monthyear", -4.414009680526933),
                                    ...
                                    ("Octoberyear (latent)", -4.770684624465665),
                                    ...
                                    ("Dhanterasin <named-month>|year", -6.023447592961032),
                                    ...
                                    ("dd/mm<time-of-day> am|pm", -6.023447592961032),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.023447592961032),
                                    ("Palm SundaySunday", -5.6179824848528686),
                                    ("dayday", -3.8262230156248136),
                                    ("dd/mmat <time-of-day>", -6.023447592961032),
                                    ...
                                    ("Chhathin <named-month>|year", -6.023447592961032),
                                    ("Vasant Panchamiin <named-month>|year", -6.023447592961032),
                                    ("Diwaliin <named-month>|year", -6.023447592961032),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.6179824848528686),
                                    ("Navaratriin <named-month>|year", -6.023447592961032),
                                    ("Ashurayear (latent)", -6.023447592961032),
                                    ("Chinese New Yearyear (latent)", -6.023447592961032),
                                    ("Sundayyear (latent)", -6.023447592961032),
                                    ...
                                    ("dd/mmyear (latent)", -6.023447592961032),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.023447592961032),
                                    ("Thai Pongalin <named-month>|year", -6.023447592961032),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -6.023447592961032),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.023447592961032),
                                    ("Mothering Sundayyear (latent)", -5.6179824848528686),
                                    ...
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.6179824848528686),
                                    ("Hanukkahyear (latent)", -6.023447592961032),
                                    ("February<time> <part-of-day>", -6.023447592961032),
                                    ("Tuesdayin <named-month>|year", -6.023447592961032),
                                    ...
                                    ("Palm Sundayintersect", -6.023447592961032),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.023447592961032),
                                    ("August Bank Holidayyear (latent)", -5.330300412401088),
                                    ("Februaryintersect", -6.023447592961032),
                                    ("Simchat Torahyear (latent)", -6.023447592961032)],
                               n = 307},
                   koData =
                     ClassData{prior = -0.9615659539361425, unseen = -6.385194398997726,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.774068722449905),
                                    ...
                                    ("Bank Holidayyear (latent)", -4.997212273764115),
                                    ...
                                    ("dd/mmat <time-of-day>", -5.284894346215896),
                                    ("<time-of-day> am|pmon <date>", -4.437596485828692),
                                    ("Thursdaydd/mm", -5.69035945432406),
                                    ("dayyear", -2.6458370166006375),
                                    ...
                                    ("dd/mmyear (latent)", -5.69035945432406),
