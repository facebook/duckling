...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5644851369496048, unseen = -6.089044875446846,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 439},
                   koData =
                     ClassData{prior = -0.8408420600443324, unseen = -5.814130531825066,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46021562287957263,
                               unseen = -7.0909098220799835,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.396929655216146),
                                    ("Karva Chauthyear (latent)", -6.396929655216146),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.396929655216146),
                                    ("Maha Shivaratriyear (latent)", -6.396929655216146),
                                    ("Ramadanyear (latent)", -5.144166686720778),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.0106352940962555),
                                    ("Bhai Doojyear (latent)", -6.396929655216146),
                                    ("hourday", -4.382026634673881),
                                    ("dayhour", -3.4524906760497056),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.0106352940962555),
                                    ("Martin Luther King's Dayyear (latent)", -5.991464547107982),
                                    ("Shemini Atzeretyear (latent)", -6.396929655216146),
                                    ("daymonth", -4.382026634673881),
                                    ("monthday", -5.991464547107982),
                                    ("monthyear", -4.605170185988091),
                                    ("Yom Ha'atzmautyear (latent)", -6.396929655216146),
                                    ("Vijayadashamiyear (latent)", -6.396929655216146),
                                    ("Thai Pongalyear (latent)", -5.703782474656201),
                                    ("Thiru Onamyear (latent)", -5.703782474656201),
                                    ("hhhmmabsorption of , after named day", -6.396929655216146),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.396929655216146),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.480638923341991),
                                    ("<day-of-month> (ordinal)Wednesday", -6.396929655216146),
                                    ("Krishna Janmashtamiyear (latent)", -5.991464547107982),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.396929655216146),
                                    ("houryear", -5.480638923341991),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.396929655216146),
                                    ("Christmas<time-of-day> am|pm", -6.396929655216146),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.396929655216146),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.703782474656201),
                                    ("intersectin|during <named-month>|year", -6.396929655216146),
                                    ("<time-of-day> am|pmintersect", -5.144166686720778),
                                    ("Earth Houryear (latent)", -6.396929655216146),
                                    ("Octoberyear (latent)", -4.892852258439873),
                                    ("intersect<time-of-day> am|pm", -6.396929655216146),
                                    ("Mattu Pongalyear (latent)", -6.396929655216146),
                                    ("Shavuotyear (latent)", -6.396929655216146),
                                    ("Parsi New Yearyear (latent)", -5.480638923341991),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.396929655216146),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.396929655216146),
                                    ("todayin|within|after <duration>", -6.396929655216146),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.991464547107982),
                                    ("Marchyear (latent)", -6.396929655216146),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -5.991464547107982),
                                    ("Sukkotyear (latent)", -5.991464547107982),
                                    ("hhhmmintersect", -5.991464547107982),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.703782474656201),
                                    ("todayat <time-of-day>", -6.396929655216146),
                                    ("Thursday<time> timezone", -3.9990343824177756),
                                    ("time-of-day (latent)tonight", -5.991464547107982),
                                    ("from|since|after <time>December", -6.396929655216146),
                                    ("<time-of-day> am|pmon <day>", -4.382026634673881),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.396929655216146),
                                    ("yyyy-mm-ddhh:mm:ss", -5.991464547107982),
                                    ("dayday", -3.6888794541139363),
                                    ("<time> <part-of-day>at <time-of-day>", -6.396929655216146),
                                    ("tonightat <time-of-day>", -6.396929655216146),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.703782474656201),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.396929655216146),
                                    ("today<time-of-day> am|pm", -6.396929655216146),
                                    ("Februarythe <day-of-month> (ordinal)", -5.991464547107982),
                                    ("at <time-of-day><time> <part-of-day>", -6.396929655216146),
                                    ("<day-of-month> (ordinal)intersect", -5.991464547107982),
                                    ("hourhour", -4.31748811353631),
                                    ("Mahavir Jayantiyear (latent)", -5.991464547107982),
                                    ("Navaratriin|during <named-month>|year", -6.396929655216146),
                                    ("Wednesdaythis|last|next <cycle>", -6.396929655216146),
                                    ("Lentyear (latent)", -6.396929655216146),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.5251274783145545),
                                    ("Boghiyear (latent)", -6.396929655216146),
                                    ("dayyear", -1.8805906829346708),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.396929655216146),
                                    ("Thursdayfrom|since|after <time>", -5.991464547107982),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.396929655216146),
                                    ("Thursdayat <time-of-day>", -5.703782474656201),
                                    ("Islamic New Yearyear (latent)", -5.991464547107982),
                                    ("Laylat al-Qadryear (latent)", -5.480638923341991),
                                    ("Shrove Tuesdayyear (latent)", -6.396929655216146),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.703782474656201),
                                    ("<time-of-day> am|pmtomorrow", -5.703782474656201),
                                    ("Yom Kippuryear (latent)", -6.396929655216146),
                                    ("<day-of-month> (ordinal)Tuesday", -5.991464547107982),
                                    ("<part-of-day> of <time>year (latent)", -6.396929655216146),
                                    ("minutehour", -5.144166686720778),
                                    ("Kaanum Pongalyear (latent)", -5.991464547107982),
                                    ("Maha Saptamiyear (latent)", -6.396929655216146),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.991464547107982),
                                    ("time-of-day (latent)tomorrow", -5.480638923341991),
                                    ("part of daysat <time-of-day>", -5.991464547107982),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.382026634673881),
                                    ("for <duration> from <time>December", -6.396929655216146),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.396929655216146),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.144166686720778),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.144166686720778),
                                    ("time-of-day (latent)this <part-of-day>", -6.396929655216146),
                                    ("Pentecostyear (latent)", -6.396929655216146),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.144166686720778),
                                    ("<day-of-month> (ordinal)February", -6.396929655216146),
                                    ("Eid al-Fitryear (latent)", -5.0106352940962555),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.396929655216146),
                                    ("Mondayin|during the <part-of-day>", -6.396929655216146),
                                    ("Chhathin|during <named-month>|year", -6.396929655216146),
                                    ("Diwaliin|during <named-month>|year", -6.396929655216146),
                                    ("Vaisakhiin|during <named-month>|year", -6.396929655216146),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.144166686720778),
                                    ("Raksha Bandhanyear (latent)", -6.396929655216146),
                                    ("daysecond", -5.991464547107982),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.991464547107982),
                                    ("Ashurayear (latent)", -6.396929655216146),
                                    ("Tuesdayin|during <named-month>|year", -6.396929655216146),
                                    ("Chinese New Yearyear (latent)", -6.396929655216146),
                                    ("tomorrowintersect", -6.396929655216146),
                                    ("Lag BaOmeryear (latent)", -6.396929655216146),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.396929655216146),
                                    ("Eid al-Adhayear (latent)", -4.2568634917198755),
                                    ("intersectin|during the <part-of-day>", -6.396929655216146),
                                    ("Palm Sundayyear (latent)", -6.396929655216146),
                                    ("Christmasat <time-of-day>", -6.396929655216146),
                                    ("Passoveryear (latent)", -6.396929655216146),
                                    ("Lazarus Saturdayyear (latent)", -6.396929655216146),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.396929655216146),
                                    ("hhhmmon <day>", -5.480638923341991),
                                    ("Yom HaShoahyear (latent)", -5.991464547107982),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.991464547107982),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.396929655216146),
                                    ("Septemberyear (latent)", -5.991464547107982),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.892852258439873),
                                    ("Halloweenyear (latent)", -6.396929655216146),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.396929655216146),
                                    ("at <time-of-day>intersect", -5.480638923341991),
                                    ("Rosh Hashanahyear (latent)", -5.703782474656201),
                                    ("Dhanterasyear (latent)", -6.396929655216146),
                                    ("Tu BiShvatyear (latent)", -6.396929655216146),
                                    ("<day-of-month> (ordinal)December", -5.703782474656201),
                                    ("Holiyear (latent)", -5.703782474656201),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.396929655216146),
                                    ("Holika Dahanyear (latent)", -5.703782474656201),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.991464547107982),
                                    ("dayminute", -3.082743650543621),
                                    ("Mawlidyear (latent)", -6.396929655216146),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.991464547107982),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.396929655216146),
                                    ("Jumu'atul-Widayear (latent)", -5.480638923341991),
                                    ("minuteday", -2.659260036932778),
                                    ("absorption of , after named dayintersect",
                                     -5.703782474656201),
                                    ("intersectyear (latent)", -6.396929655216146),
                                    ("Orthodox Easter Sundayyear (latent)", -6.396929655216146),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.396929655216146),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.396929655216146),
                                    ("intersecthhhmm", -5.991464547107982),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.396929655216146),
                                    ("Boss's Dayyear (latent)", -5.991464547107982),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.396929655216146),
                                    ("Global Youth Service Dayyear (latent)", -6.396929655216146),
                                    ("Dhanterasin|during <named-month>|year", -6.396929655216146),
                                    ("Tisha B'Avyear (latent)", -6.396929655216146),
                                    ("Isra and Mi'rajyear (latent)", -5.480638923341991),
                                    ("at <time-of-day>on <day>", -4.787491742782046),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.991464547107982),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.703782474656201),
                                    ("Christmasyear (latent)", -5.991464547107982),
                                    ("Naraka Chaturdashiyear (latent)", -5.991464547107982),
                                    ("Thai Pongalin|during <named-month>|year", -6.396929655216146),
                                    ("dayweek", -6.396929655216146),
                                    ("Easter Sundayyear (latent)", -5.703782474656201),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -5.991464547107982),
                                    ("weekyear", -5.298317366548036),
                                    ("King's Dayyear (latent)", -4.892852258439873),
                                    ("hh:mmin|during the <part-of-day>", -5.480638923341991),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.991464547107982),
                                    ("Hanukkahyear (latent)", -5.703782474656201),
                                    ("February<time> <part-of-day>", -6.396929655216146),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.396929655216146),
                                    ("Great Lentyear (latent)", -6.396929655216146),
                                    ("tomorrowat <time-of-day>", -5.703782474656201),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.396929655216146),
                                    ("Ugadiyear (latent)", -5.0106352940962555),
                                    ("Vaisakhiyear (latent)", -5.703782474656201),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.703782474656201),
                                    ("last <cycle> of <time>year (latent)", -5.703782474656201),
                                    ("at <time-of-day>tomorrow", -5.991464547107982),
                                    ("tomorrow<time-of-day> am|pm", -6.396929655216146),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.396929655216146),
                                    ("Diwaliyear (latent)", -6.396929655216146),
                                    ("between <time> and <time>on <day>", -5.991464547107982),
                                    ("Black Fridayyear (latent)", -5.991464547107982),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.396929655216146),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.396929655216146),
                                    ("Chhathyear (latent)", -5.991464547107982),
                                    ("Vasant Panchamiyear (latent)", -6.396929655216146),
                                    ("Rabindra Jayantiyear (latent)", -5.144166686720778),
                                    ("St Patrick's Dayyear (latent)", -6.396929655216146),
                                    ("Thursday<time> (timezone)", -6.396929655216146),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.396929655216146),
                                    ("Pargat Diwasyear (latent)", -5.144166686720778),
                                    ("<datetime> - <datetime> (interval)July", -5.991464547107982),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.703782474656201),
                                    ("Februaryintersect", -6.396929655216146),
                                    ("Simchat Torahyear (latent)", -6.396929655216146),
                                    ("minuteyear", -6.396929655216146)],
                               n = 462},
                   koData =
                     ClassData{prior = -0.9973585549629368, unseen = -6.705639094860003,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.15006069457573323,
                               ...
                               n = 210},
                   koData =
                     ClassData{prior = -1.9708077006770406,
                               unseen = -3.6635616461296463,
                               likelihoods =
                                 HashMap.fromList
