...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46960290794203635,
                               unseen = -6.727431724850855,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.0330862217988015),
                                    ("Ramadanyear (latent)", -6.0330862217988015),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.780323253303433),
                                    ("Bhai Doojyear (latent)", -6.0330862217988015),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.780323253303433),
                                    ("hourday", -4.328338129560376),
                                    ("dayhour", -3.170885340869333),
                                    ("Martin Luther King's Dayyear (latent)", -5.627621113690637),
                                    ("Shemini Atzeretyear (latent)", -6.0330862217988015),
                                    ("daymonth", -5.116795489924646),
                                    ("monthday", -5.627621113690637),
                                    ("monthyear", -4.241326752570746),
                                    ("Yom Ha'atzmautyear (latent)", -6.0330862217988015),
                                    ("Vijayadashamiyear (latent)", -6.0330862217988015),
                                    ("Thai Pongalyear (latent)", -5.339939041238856),
                                    ("Thiru Onamyear (latent)", -5.339939041238856),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.0330862217988015),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.0330862217988015),
                                    ("houryear", -5.339939041238856),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.0330862217988015),
                                    ("Christmas<time-of-day> am|pm", -6.0330862217988015),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.0330862217988015),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.339939041238856),
                                    ("<time-of-day> am|pmintersect", -4.780323253303433),
                                    ("Earth Houryear (latent)", -6.0330862217988015),
                                    ("Octoberyear (latent)", -4.529008825022527),
                                    ("intersect<time-of-day> am|pm", -6.0330862217988015),
                                    ("Mattu Pongalyear (latent)", -6.0330862217988015),
                                    ("Shavuotyear (latent)", -6.0330862217988015),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.0330862217988015),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.0330862217988015),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.627621113690637),
                                    ("Marchyear (latent)", -6.0330862217988015),
                                    ("Sukkotyear (latent)", -5.627621113690637),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.0330862217988015),
                                    ("Clean Mondayyear (latent)", -5.627621113690637),
                                    ("monthhour", -5.627621113690637),
                                    ("todayat <time-of-day>", -6.0330862217988015),
                                    ("Thursday<time> timezone", -4.087176072743488),
                                    ("from|since|after <time>December", -6.0330862217988015),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.0330862217988015),
                                    ("yyyy-mm-ddhh:mm:ss", -5.627621113690637),
                                    ("dayday", -4.018183201256536),
                                    ("<time> <part-of-day>at <time-of-day>", -6.0330862217988015),
                                    ("tonightat <time-of-day>", -6.0330862217988015),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.339939041238856),
                                    ("today<time-of-day> am|pm", -6.0330862217988015),
                                    ("Februarythe <day-of-month> (ordinal)", -5.627621113690637),
                                    ("at <time-of-day><time> <part-of-day>", -6.0330862217988015),
                                    ("hourhour", -4.780323253303433),
                                    ("<time-of-day> am|pmon <date>", -4.018183201256536),
                                    ("Navaratriin|during <named-month>|year", -6.0330862217988015),
                                    ("Wednesdaythis|last|next <cycle>", -6.0330862217988015),
                                    ("Lentyear (latent)", -6.0330862217988015),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.529008825022527),
                                    ("Boghiyear (latent)", -6.0330862217988015),
                                    ("dayyear", -2.0167032010464125),
                                    ("Thursdayfrom|since|after <time>", -5.627621113690637),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.0330862217988015),
                                    ("Thursdayat <time-of-day>", -5.339939041238856),
                                    ("Islamic New Yearyear (latent)", -5.627621113690637),
                                    ("Laylat al-Qadryear (latent)", -5.116795489924646),
                                    ("Shrove Tuesdayyear (latent)", -6.0330862217988015),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.339939041238856),
                                    ("<time-of-day> am|pmtomorrow", -5.339939041238856),
                                    ("Yom Kippuryear (latent)", -6.0330862217988015),
                                    ("<part-of-day> of <time>year (latent)", -6.0330862217988015),
                                    ("minutehour", -5.116795489924646),
                                    ("Kaanum Pongalyear (latent)", -5.627621113690637),
                                    ("Maha Saptamiyear (latent)", -6.0330862217988015),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.627621113690637),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.328338129560376),
                                    ("for <duration> from <time>December", -6.0330862217988015),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.0330862217988015),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.116795489924646),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.627621113690637),
                                    ("Pentecostyear (latent)", -6.0330862217988015),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.116795489924646),
                                    ("Eid al-Fitryear (latent)", -6.0330862217988015),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.0330862217988015),
                                    ("Mondayin|during the <part-of-day>", -6.0330862217988015),
                                    ("Chhathin|during <named-month>|year", -6.0330862217988015),
                                    ("Diwaliin|during <named-month>|year", -6.0330862217988015),
                                    ("Vaisakhiin|during <named-month>|year", -6.0330862217988015),
                                    ("Raksha Bandhanyear (latent)", -6.0330862217988015),
                                    ("daysecond", -5.627621113690637),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.627621113690637),
                                    ("Ashurayear (latent)", -6.0330862217988015),
                                    ("Tuesdayin|during <named-month>|year", -6.0330862217988015),
                                    ("Chinese New Yearyear (latent)", -6.0330862217988015),
                                    ("Lag BaOmeryear (latent)", -6.0330862217988015),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.0330862217988015),
                                    ("Eid al-Adhayear (latent)", -5.116795489924646),
                                    ("intersectin|during the <part-of-day>", -6.0330862217988015),
                                    ("Palm Sundayyear (latent)", -6.0330862217988015),
                                    ("Christmasat <time-of-day>", -6.0330862217988015),
                                    ("Passoveryear (latent)", -6.0330862217988015),
                                    ("Lazarus Saturdayyear (latent)", -6.0330862217988015),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.0330862217988015),
                                    ("Yom HaShoahyear (latent)", -5.627621113690637),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.627621113690637),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.0330862217988015),
                                    ("Septemberyear (latent)", -5.627621113690637),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.780323253303433),
                                    ("Halloweenyear (latent)", -6.0330862217988015),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.339939041238856),
                                    ("Dhanterasyear (latent)", -6.0330862217988015),
                                    ("Tu BiShvatyear (latent)", -6.0330862217988015),
                                    ("Holiyear (latent)", -5.339939041238856),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.0330862217988015),
                                    ("Holika Dahanyear (latent)", -5.339939041238856),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0330862217988015),
                                    ("dayminute", -3.3589375723722728),
                                    ("Mawlidyear (latent)", -6.0330862217988015),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.627621113690637),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.0330862217988015),
                                    ("Jumu'atul-Widayear (latent)", -5.116795489924646),
                                    ("minuteday", -2.395500062072416),
                                    ("absorption of , after named dayintersect",
                                     -6.0330862217988015),
                                    ("Orthodox Easter Sundayyear (latent)", -6.0330862217988015),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.0330862217988015),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.0330862217988015),
                                    ("Boss's Dayyear (latent)", -5.627621113690637),
                                    ("Global Youth Service Dayyear (latent)", -6.0330862217988015),
                                    ("Dhanterasin|during <named-month>|year", -6.0330862217988015),
                                    ("Tisha B'Avyear (latent)", -6.0330862217988015),
                                    ("Isra and Mi'rajyear (latent)", -5.116795489924646),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.0330862217988015),
                                    ("Christmasyear (latent)", -5.627621113690637),
                                    ("Naraka Chaturdashiyear (latent)", -5.627621113690637),
                                    ("at <time-of-day>on <date>", -4.9344739331306915),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.0330862217988015),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.423648309364701),
                                    ("dayweek", -6.0330862217988015),
                                    ("Easter Sundayyear (latent)", -5.339939041238856),
                                    ("weekyear", -4.9344739331306915),
                                    ("hh:mmin|during the <part-of-day>", -5.339939041238856),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.627621113690637),
                                    ("Hanukkahyear (latent)", -5.339939041238856),
                                    ("February<time> <part-of-day>", -6.0330862217988015),
                                    ("Great Lentyear (latent)", -6.0330862217988015),
                                    ("tomorrowat <time-of-day>", -5.339939041238856),
                                    ("between <time> and <time>on <date>", -4.423648309364701),
                                    ("Vaisakhiyear (latent)", -5.339939041238856),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.0330862217988015),
                                    ("last <cycle> of <time>year (latent)", -5.339939041238856),
                                    ("at <time-of-day>tomorrow", -5.627621113690637),
                                    ("tomorrow<time-of-day> am|pm", -6.0330862217988015),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.0330862217988015),
                                    ("Diwaliyear (latent)", -6.0330862217988015),
                                    ("Black Fridayyear (latent)", -5.627621113690637),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.0330862217988015),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.0330862217988015),
                                    ("Chhathyear (latent)", -5.627621113690637),
                                    ("Vasant Panchamiyear (latent)", -6.0330862217988015),
                                    ("Thursday<time> (timezone)", -6.0330862217988015),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.0330862217988015),
                                    ("Februaryintersect", -6.0330862217988015),
                                    ("Simchat Torahyear (latent)", -6.0330862217988015),
                                    ("minuteyear", -6.0330862217988015)],
                               n = 312},
                   koData =
                     ClassData{prior = -0.9814974788969321, unseen = -6.371611847231857,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.760463070394127),
                                    ("hourday", -4.760463070394127),
                                    ("dayhour", -3.111804444806745),
                                    ("Tuesdayfrom|since|after <time>", -5.676753802268282),
                                    ("daymonth", -3.661850781726017),
                                    ("monthyear", -4.423990833772914),
                                    ("<time-of-day> am|pmyear (latent)", -5.271288694160117),
                                    ("Thai Pongalyear (latent)", -4.983606621708336),
                                    ("intersecthh:mm", -5.676753802268282),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.676753802268282),
                                    ("houryear", -4.760463070394127),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.676753802268282),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.983606621708336),
                                    ("<time-of-day> am|pmintersect", -4.423990833772914),
                                    ("until <time>on <date>", -4.983606621708336),
                                    ("Octoberyear (latent)", -5.676753802268282),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -4.983606621708336),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.676753802268282),
                                    ("absorption of , after named dayJuly", -5.271288694160117),
                                    ("from|since|after <time>July", -5.676753802268282),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.760463070394127),
                                    ("Clean Mondayyear (latent)", -5.676753802268282),
                                    ("monthhour", -5.676753802268282),
                                    ("hourmonth", -4.760463070394127),
                                    ("todayat <time-of-day>", -5.676753802268282),
                                    ("from|since|after <time>December", -5.676753802268282),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.676753802268282),
                                    ("Mondayyear (latent)", -4.983606621708336),
                                    ("dayday", -5.271288694160117),
                                    ("<time-of-day> am|pmon <date>", -4.423990833772914),
                                    ("Thursdaydd/mm", -5.676753802268282),
                                    ("dayyear", -2.8145529213388136),
                                    ("New Year's Dayyear (latent)", -5.271288694160117),
                                    ("Thursdayfrom|since|after <time>", -3.9720057100298565),
                                    ("Thursdayat <time-of-day>", -4.067315889834181),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.676753802268282),
                                    ("Aprilyear (latent)", -5.676753802268282),
                                    ("monthminute", -5.676753802268282),
                                    ("<time-of-day> am|pmtomorrow", -5.676753802268282),
                                    ("Thursdayhh:mm", -4.760463070394127),
                                    ("minutemonth", -3.884994333040227),
                                    ("Augustyear (latent)", -5.271288694160117),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.271288694160117),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.271288694160117),
                                    ("week-endin|during <named-month>|year", -5.676753802268282),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.676753802268282),
                                    ("Sundayyear (latent)", -4.760463070394127),
                                    ("Christmasat <time-of-day>", -5.676753802268282),
                                    ("from|since|after <time>year (latent)", -4.578141513600172),
                                    ("<duration> after|before|from <time>December",
                                     -5.676753802268282),
                                    ("yesterday<time-of-day> am|pm", -5.676753802268282),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.676753802268282),
                                    ("at <time-of-day>intersect", -5.271288694160117),
                                    ("hh:mmyear (latent)", -4.578141513600172),
                                    ("Holiyear (latent)", -5.676753802268282),
                                    ("until <time><time-of-day> am|pm", -5.676753802268282),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.676753802268282),
                                    ("dayminute", -2.935913778343081),
                                    ("yyyy-mm-ddhh:mm", -5.271288694160117),
                                    ("intersectSeptember", -4.172676405492008),
                                    ("minuteday", -2.6087008671346648),
                                    ("absorption of , after named dayintersect",
                                     -5.676753802268282),
                                    ("Februaryin|during the <part-of-day>", -5.676753802268282),
                                    ("hh:mmon <date>", -3.661850781726017),
                                    ("Saturdayyear (latent)", -5.676753802268282),
                                    ("from|since|after <time>on <date>", -4.760463070394127),
                                    ("absorption of , after named daySeptember",
                                     -4.760463070394127),
                                    ("Naraka Chaturdashiyear (latent)", -5.676753802268282),
                                    ("on <date>September", -5.271288694160117),
                                    ("at <time-of-day>on <date>", -5.271288694160117),
                                    ("dayweek", -5.676753802268282),
                                    ("Easter Sundayyear (latent)", -5.271288694160117),
                                    ("Thursday<time-of-day> am|pm", -4.423990833772914),
                                    ("weekyear", -5.271288694160117),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -4.983606621708336),
                                    ("Sundayfrom|since|after <time>", -5.676753802268282),
                                    ("absorption of , after named dayFebruary", -4.760463070394127),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.676753802268282),
                                    ("tomorrowat <time-of-day>", -5.676753802268282),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.676753802268282),
                                    ("last <cycle> of <time>year (latent)", -5.271288694160117),
                                    ("tomorrow<time-of-day> am|pm", -5.676753802268282),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.983606621708336),
                                    ("Diwaliyear (latent)", -5.271288694160117),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.676753802268282),
                                    ("Fridayyear (latent)", -5.271288694160117),
                                    ("minuteyear", -4.423990833772914)],
                               n = 187}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1479201300766222, unseen = -4.962844630259907,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 138},
                   koData =
                     ClassData{prior = -1.984131361875511, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
