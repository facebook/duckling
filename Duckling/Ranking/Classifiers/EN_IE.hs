...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47126545906615774,
                               unseen = -7.160845906664299,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.466922027036182),
                                    ...
                                    ("hourday", -4.4520190064939165),
                                    ("dayhour", -3.446497140891819),
                                    ...
                                    ("daymonth", -4.4520190064939165),
                                    ("monthday", -6.061456918928017),
                                    ("monthyear", -4.675162557808126),
                                    ...
                                    ("hhhmmabsorption of , after named day", -6.466922027036182),
                                    ...
                                    ("houryear", -5.5506312951620265),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.466922027036182),
                                    ("Christmas<time-of-day> am|pm", -6.466922027036182),
                                    ...
                                    ("<time-of-day> am|pmintersect", -5.2141590585408135),
                                    ("Earth Houryear (latent)", -6.466922027036182),
                                    ("Ganesh Chaturthiyear (latent)", -6.466922027036182),
                                    ("Octoberyear (latent)", -4.962844630259907),
                                    ("intersect<time-of-day> am|pm", -6.466922027036182),
                                    ("Mattu Pongalyear (latent)", -6.466922027036182),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.466922027036182),
                                    ("Shavuotyear (latent)", -6.466922027036182),
                                    ("Parsi New Yearyear (latent)", -5.5506312951620265),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.466922027036182),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.466922027036182),
                                    ("todayin|within|after <duration>", -6.466922027036182),
                                    ...
                                    ("hhhmmintersect", -6.061456918928017),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.773774846476236),
                                    ("todayat <time-of-day>", -6.466922027036182),
                                    ("Thursday<time> timezone", -4.069026754237811),
                                    ("tonight<time-of-day> am|pm", -6.466922027036182),
                                    ("time-of-day (latent)tonight", -6.061456918928017),
                                    ("from|since|after <time>December", -6.466922027036182),
                                    ("<time-of-day> am|pmon <day>", -4.4520190064939165),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.466922027036182),
                                    ("yyyy-mm-ddhh:mm:ss", -6.061456918928017),
                                    ("dayday", -3.758871825933971),
                                    ("<time> <part-of-day>at <time-of-day>", -6.061456918928017),
                                    ("tonightat <time-of-day>", -5.368309738368072),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.773774846476236),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.466922027036182),
                                    ("today<time-of-day> am|pm", -6.466922027036182),
                                    ("Februarythe <day-of-month> (ordinal)", -6.061456918928017),
                                    ("at <time-of-day><time> <part-of-day>", -6.466922027036182),
                                    ("<day-of-month> (ordinal)intersect", -6.061456918928017),
                                    ("hourhour", -3.4965075614664802),
                                    ("Mahavir Jayantiyear (latent)", -6.061456918928017),
                                    ("Navaratriin|during <named-month>|year", -6.466922027036182),
                                    ...
                                    ("dayyear", -1.9236272447661775),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.466922027036182),
                                    ("Thursdayfrom|since|after <time>", -6.061456918928017),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.466922027036182),
                                    ("Thursdayat <time-of-day>", -5.773774846476236),
                                    ("Islamic New Yearyear (latent)", -6.061456918928017),
                                    ("Laylat al-Qadryear (latent)", -5.5506312951620265),
                                    ("part of days<time-of-day> am|pm", -6.466922027036182),
                                    ("Shrove Tuesdayyear (latent)", -6.466922027036182),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.773774846476236),
                                    ("hourminute", -6.061456918928017),
                                    ("<time-of-day> am|pmtomorrow", -5.773774846476236),
                                    ("Yom Kippuryear (latent)", -6.466922027036182),
                                    ("<day-of-month> (ordinal)Tuesday", -6.061456918928017),
                                    ("<part-of-day> of <time>year (latent)", -6.466922027036182),
                                    ("minutehour", -5.2141590585408135),
                                    ("Kaanum Pongalyear (latent)", -6.061456918928017),
                                    ("Maha Saptamiyear (latent)", -6.466922027036182),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.773774846476236),
                                    ("time-of-day (latent)tomorrow", -5.5506312951620265),
                                    ("part of daysat <time-of-day>", -4.857484114602081),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.4520190064939165),
                                    ("for <duration> from <time>December", -6.466922027036182),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.466922027036182),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.2141590585408135),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.2141590585408135),
                                    ("time-of-day (latent)this <part-of-day>", -6.466922027036182),
                                    ...
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.466922027036182),
                                    ("Mondayin|during the <part-of-day>", -6.466922027036182),
                                    ("Chhathin|during <named-month>|year", -6.466922027036182),
                                    ("Diwaliin|during <named-month>|year", -6.466922027036182),
                                    ("this <part-of-day><time-of-day> am|pm", -6.466922027036182),
                                    ("Vaisakhiin|during <named-month>|year", -6.466922027036182),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.2141590585408135),
                                    ("Raksha Bandhanyear (latent)", -6.466922027036182),
                                    ("daysecond", -6.061456918928017),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.466922027036182),
                                    ("hhhmmon <day>", -5.5506312951620265),
                                    ...
                                    ("minuteday", -2.729252408752813),
                                    ("absorption of , after named dayintersect",
                                     -5.773774846476236),
                                    ("intersectyear (latent)", -6.466922027036182),
                                    ...
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.466922027036182),
                                    ("intersecthhhmm", -6.061456918928017),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.466922027036182),
                                    ...
                                    ("at <time-of-day>tomorrow", -6.061456918928017),
                                    ("tomorrow<time-of-day> am|pm", -6.466922027036182),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.466922027036182),
                                    ("Diwaliyear (latent)", -6.466922027036182),
                                    ("between <time> and <time>on <day>", -6.061456918928017),
                                    ...
                                    ("this <part-of-day>at <time-of-day>", -5.2141590585408135),
                                    ("St Patrick's Dayyear (latent)", -6.466922027036182),
                                    ("Thursday<time> (timezone)", -6.466922027036182),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.466922027036182),
                                    ("Pargat Diwasyear (latent)", -5.2141590585408135),
                                    ("<datetime> - <datetime> (interval)July", -6.061456918928017),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.773774846476236),
                                    ("Februaryintersect", -6.466922027036182),
                                    ("Simchat Torahyear (latent)", -6.466922027036182),
                                    ("minuteyear", -6.466922027036182)],
                               n = 495},
                   koData =
                     ClassData{prior = -0.9787297351294435, unseen = -6.795705775173515,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.59736200354028),
                                    ("hourday", -3.703544127518183),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.101439400316553),
                                    ("<day-of-month> (ordinal)August", -6.101439400316553),
                                    ("dayhour", -3.536490042855017),
                                    ("<time> timezoneyear (latent)", -5.408292219756609),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.185148668442399),
                                    ("Tuesdayfrom|since|after <time>", -5.408292219756609),
                                    ("daymonth", -3.427290750890025),
                                    ("monthyear", -4.848676431821186),
                                    ("<time-of-day> am|pmyear (latent)", -5.408292219756609),
                                    ("Thai Pongalyear (latent)", -5.408292219756609),
                                    ("intersecthh:mm", -6.101439400316553),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.69597429220839),
                                    ("<day-of-month> (ordinal)Wednesday", -6.101439400316553),
                                    ("houryear", -4.715145039196663),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.101439400316553),
                                    ("<day-of-month> (ordinal)October", -6.101439400316553),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.408292219756609),
                                    ("hournograin", -4.848676431821186),
                                    ("<time-of-day> am|pmintersect", -4.848676431821186),
                                    ("Octoberyear (latent)", -6.101439400316553),
                                    ("Good Fridayyear (latent)", -5.69597429220839),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.69597429220839),
                                    ("early morningat <time-of-day>", -6.101439400316553),
                                    ("until <time>on <day>", -5.408292219756609),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.101439400316553),
                                    ("time-of-day (latent)intersect", -5.408292219756609),
                                    ("todayin <number> (implicit minutes)", -6.101439400316553),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.408292219756609),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.101439400316553),
                                    ("hh:mmon <day>", -4.848676431821186),
                                    ("hhhmmintersect", -5.69597429220839),
                                    ("absorption of , after named dayJuly", -5.185148668442399),
                                    ("from|since|after <time>July", -5.69597429220839),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.185148668442399),
                                    ("Clean Mondayyear (latent)", -6.101439400316553),
                                    ("monthhour", -6.101439400316553),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.69597429220839),
                                    ("hourmonth", -4.229637223414962),
                                    ("todayat <time-of-day>", -6.101439400316553),
                                    ("hhhmmyear (latent)", -4.848676431821186),
                                    ("from|since|after <time>December", -6.101439400316553),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.101439400316553),
                                    ("<time-of-day> am|pmon <day>", -4.848676431821186),
                                    ("Mondayyear (latent)", -5.408292219756609),
                                    ("dayday", -4.086536379774289),
                                    ("on <day>September", -5.408292219756609),
                                    ("time-of-day (latent)September", -5.69597429220839),
                                    ("hourhour", -4.021997858636718),
                                    ("time-of-day (latent)on <day>", -4.59736200354028),
                                    ("Thursdaydd/mm", -6.101439400316553),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.69597429220839),
                                    ("dayyear", -3.081014514172191),
                                    ("New Year's Dayyear (latent)", -5.185148668442399),
                                    ("time-of-day (latent)Sunday", -5.69597429220839),
                                    ("Thursdayfrom|since|after <time>", -4.396691308078129),
                                    ("Thursdayat <time-of-day>", -4.492001487882454),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.101439400316553),
                                    ("Aprilyear (latent)", -6.101439400316553),
                                    ("the <day-of-month> (ordinal)July", -6.101439400316553),
                                    ("the <day-of-month> (number)July", -6.101439400316553),
                                    ("monthminute", -6.101439400316553),
                                    ("<time-of-day> am|pmtomorrow", -6.101439400316553),
                                    ("Thursdayhh:mm", -5.185148668442399),
                                    ("<day-of-month> (ordinal)Tuesday", -5.69597429220839),
                                    ("minutemonth", -3.961373236820283),
                                    ("time-of-day (latent)Friday", -5.69597429220839),
                                    ("minutehour", -6.101439400316553),
                                    ("part of daysat <time-of-day>", -5.002827111648444),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -5.185148668442399),
                                    ("Augustyear (latent)", -5.69597429220839),
                                    ("week-endin|during <named-month>|year", -6.101439400316553),
                                    ("time-of-day (latent)Tuesday", -5.69597429220839),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.101439400316553),
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.101439400316553),
                                    ("Sundayyear (latent)", -5.185148668442399),
                                    ("hourweek", -5.185148668442399),
                                    ("the <day-of-month> (ordinal)Monday", -5.408292219756609),
                                    ("Christmasat <time-of-day>", -6.101439400316553),
                                    ("from|since|after <time>year (latent)", -5.002827111648444),
                                    ("hhhmmon <day>", -5.185148668442399),
                                    ("yesterday<time-of-day> am|pm", -6.101439400316553),
                                    ("<day-of-month> (ordinal)July", -5.408292219756609),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.101439400316553),
                                    ("at <time-of-day>intersect", -5.185148668442399),
                                    ("hh:mmyear (latent)", -4.715145039196663),
                                    ("Holiyear (latent)", -6.101439400316553),
                                    ("until <time><time-of-day> am|pm", -6.101439400316553),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.69597429220839),
                                    ("dayminute", -3.2682260562603376),
                                    ("yyyy-mm-ddhh:mm", -5.69597429220839),
                                    ("intersectfrom|since|after <time>", -5.69597429220839),
                                    ("intersectSeptember", -4.229637223414962),
                                    ("minuteday", -2.9444389791664407),
                                    ("absorption of , after named dayintersect",
                                     -6.101439400316553),
                                    ("intersectyear (latent)", -6.101439400316553),
                                    ("Februaryin|during the <part-of-day>", -6.101439400316553),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.101439400316553),
                                    ("time-of-day (latent)July", -5.408292219756609),
                                    ("Saturdayyear (latent)", -6.101439400316553),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.101439400316553),
                                    ("<day-of-month> (ordinal)Monday", -5.185148668442399),
                                    ("at <time-of-day>on <day>", -5.185148668442399),
                                    ("absorption of , after named daySeptember",
                                     -4.848676431821186),
                                    ("Naraka Chaturdashiyear (latent)", -6.101439400316553),
                                    ("from|since|after <time>on <day>", -5.185148668442399),
                                    ("dayweek", -6.101439400316553),
                                    ("Easter Sundayyear (latent)", -5.69597429220839),
                                    ("Thursday<time-of-day> am|pm", -4.848676431821186),
                                    ("weekyear", -5.69597429220839),
                                    ("time-of-day (latent)Thursday", -5.69597429220839),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.101439400316553),
                                    ("<day-of-month> (ordinal)April", -6.101439400316553),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.69597429220839),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.408292219756609),
                                    ("Sundayfrom|since|after <time>", -6.101439400316553),
                                    ("absorption of , after named dayFebruary", -5.185148668442399),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.69597429220839),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.101439400316553),
                                    ("tomorrowat <time-of-day>", -6.101439400316553),
                                    ("daynograin", -5.69597429220839),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.69597429220839),
                                    ("last <cycle> of <time>year (latent)", -5.69597429220839),
                                    ("tomorrow<time-of-day> am|pm", -6.101439400316553),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.408292219756609),
                                    ("Diwaliyear (latent)", -5.69597429220839),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.101439400316553),
                                    ("this <part-of-day>at <time-of-day>", -5.185148668442399),
                                    ("Fridayyear (latent)", -5.185148668442399),
                                    ("time-of-day (latent)April", -6.101439400316553),
                                    ("minuteyear", -3.904214822980334)],
                               n = 298}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.3022808718729337, unseen = -5.209486152841421,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 85},
                   koData =
                     ClassData{prior = -1.3437347467010947, unseen = -4.290459441148391,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -9.352605801082348e-2),
                                    ("integer (0..19)", -2.4159137783010487)],
                               n = 110}}),
       ("beginning of year",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.791759469228055,
