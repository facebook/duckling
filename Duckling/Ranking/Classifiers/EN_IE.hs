...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5789548130342905, unseen = -5.634789603169249,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 278},
                   koData =
                     ClassData{prior = -0.8220808639358385, unseen = -5.393627546352362,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48314219501757394,
                               unseen = -6.672032945461067,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -5.977619140285929),
                                    ("Ramadanyear (latent)", -5.977619140285929),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.724856171790561),
                                    ("Bhai Doojyear (latent)", -5.977619140285929),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.724856171790561),
                                    ("hourday", -4.272871048047504),
                                    ("dayhour", -3.174258759379394),
                                    ("Martin Luther King's Dayyear (latent)", -5.572154032177765),
                                    ("Shemini Atzeretyear (latent)", -5.977619140285929),
                                    ("daymonth", -5.284471959725984),
                                    ("monthday", -5.572154032177765),
                                    ("monthyear", -4.368181227851829),
                                    ("Yom Ha'atzmautyear (latent)", -5.977619140285929),
                                    ("Vijayadashamiyear (latent)", -5.977619140285929),
                                    ("Thai Pongalyear (latent)", -5.284471959725984),
                                    ("Thiru Onamyear (latent)", -5.284471959725984),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.977619140285929),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.977619140285929),
                                    ("houryear", -5.284471959725984),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.977619140285929),
                                    ("Christmas<time-of-day> am|pm", -5.977619140285929),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.977619140285929),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.284471959725984),
                                    ("<time-of-day> am|pmintersect", -4.724856171790561),
                                    ("Octoberyear (latent)", -4.724856171790561),
                                    ("intersect<time-of-day> am|pm", -5.977619140285929),
                                    ("Mattu Pongalyear (latent)", -5.977619140285929),
                                    ("Shavuotyear (latent)", -5.977619140285929),
                                    ("Dhanterasin <named-month>|year", -5.977619140285929),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.977619140285929),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.977619140285929),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.572154032177765),
                                    ("Marchyear (latent)", -5.977619140285929),
                                    ("Sukkotyear (latent)", -5.572154032177765),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.977619140285929),
                                    ("Clean Mondayyear (latent)", -5.572154032177765),
                                    ("monthhour", -5.572154032177765),
                                    ("todayat <time-of-day>", -5.977619140285929),
                                    ("Thursday<time> timezone", -4.272871048047504),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.977619140285929),
                                    ("Palm SundaySunday", -5.572154032177765),
                                    ("dayday", -3.7803945629497093),
                                    ("<time> <part-of-day>at <time-of-day>", -5.977619140285929),
                                    ("tonightat <time-of-day>", -5.977619140285929),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.284471959725984),
                                    ("today<time-of-day> am|pm", -5.977619140285929),
                                    ("Februarythe <day-of-month> (ordinal)", -5.572154032177765),
                                    ("at <time-of-day><time> <part-of-day>", -5.977619140285929),
                                    ("hourhour", -4.724856171790561),
                                    ("<time-of-day> am|pmon <date>", -3.9627161197436642),
                                    ("Wednesdaythis|last|next <cycle>", -5.977619140285929),
                                    ("Lentyear (latent)", -5.977619140285929),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.473541743509655),
                                    ("Boghiyear (latent)", -5.977619140285929),
                                    ("dayyear", -2.0360373326162384),
                                    ("Thursdayfrom|since|after <time>", -5.572154032177765),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.977619140285929),
                                    ("Thursdayat <time-of-day>", -5.572154032177765),
                                    ("Islamic New Yearyear (latent)", -5.572154032177765),
                                    ("Laylat al-Qadryear (latent)", -5.061328408411774),
                                    ("Chhathin <named-month>|year", -5.977619140285929),
                                    ("Vasant Panchamiin <named-month>|year", -5.977619140285929),
                                    ("Diwaliin <named-month>|year", -5.977619140285929),
                                    ("Shrove Tuesdayyear (latent)", -5.977619140285929),
                                    ("<time-of-day> am|pmtomorrow", -5.284471959725984),
                                    ("Yom Kippuryear (latent)", -5.977619140285929),
                                    ("<part-of-day> of <time>year (latent)", -5.977619140285929),
                                    ("minutehour", -5.061328408411774),
                                    ("Kaanum Pongalyear (latent)", -5.572154032177765),
                                    ("Maha Saptamiyear (latent)", -5.977619140285929),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.572154032177765),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.272871048047504),
                                    ("for <duration> from <time>December", -5.977619140285929),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.977619140285929),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.061328408411774),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.572154032177765),
                                    ("Pentecostyear (latent)", -5.977619140285929),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.061328408411774),
                                    ("Eid al-Fitryear (latent)", -5.977619140285929),
                                    ("Mondayin|during the <part-of-day>", -5.977619140285929),
                                    ("Raksha Bandhanyear (latent)", -5.977619140285929),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.572154032177765),
                                    ("Navaratriin <named-month>|year", -5.977619140285929),
                                    ("Ashurayear (latent)", -5.977619140285929),
                                    ("Chinese New Yearyear (latent)", -5.977619140285929),
                                    ("Sundayyear (latent)", -5.977619140285929),
                                    ("Lag BaOmeryear (latent)", -5.977619140285929),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.977619140285929),
                                    ("Eid al-Adhayear (latent)", -5.061328408411774),
                                    ("intersectin|during the <part-of-day>", -5.977619140285929),
                                    ("Christmasat <time-of-day>", -5.977619140285929),
                                    ("Passoveryear (latent)", -5.977619140285929),
                                    ("Lazarus Saturdayyear (latent)", -5.977619140285929),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.977619140285929),
                                    ("Yom HaShoahyear (latent)", -5.572154032177765),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.572154032177765),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.977619140285929),
                                    ("Thai Pongalin <named-month>|year", -5.977619140285929),
                                    ("Septemberyear (latent)", -5.572154032177765),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.724856171790561),
                                    ("Halloweenyear (latent)", -5.977619140285929),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.977619140285929),
                                    ("Dhanterasyear (latent)", -5.977619140285929),
                                    ("Tu BiShvatyear (latent)", -5.977619140285929),
                                    ("Holiyear (latent)", -5.284471959725984),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.977619140285929),
                                    ("Holika Dahanyear (latent)", -5.284471959725984),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.977619140285929),
                                    ("dayminute", -3.412669782824392),
                                    ("Mawlidyear (latent)", -5.977619140285929),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.572154032177765),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.977619140285929),
                                    ("Jumu'atul-Widayear (latent)", -5.061328408411774),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.977619140285929),
                                    ("minuteday", -2.3400329805595432),
                                    ("absorption of , after named dayintersect",
                                     -5.977619140285929),
                                    ("intersectyear (latent)", -5.977619140285929),
                                    ("Orthodox Easter Sundayyear (latent)", -5.977619140285929),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.977619140285929),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.977619140285929),
                                    ("Boss's Dayyear (latent)", -5.572154032177765),
                                    ("Tisha B'Avyear (latent)", -5.977619140285929),
                                    ("Isra and Mi'rajyear (latent)", -5.061328408411774),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.977619140285929),
                                    ("Christmasyear (latent)", -5.572154032177765),
                                    ("Naraka Chaturdashiyear (latent)", -5.572154032177765),
                                    ("at <time-of-day>on <date>", -4.879006851617819),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.368181227851829),
                                    ("dayweek", -5.977619140285929),
                                    ("Easter Sundayyear (latent)", -5.284471959725984),
                                    ("weekyear", -5.572154032177765),
                                    ("hh:mmin|during the <part-of-day>", -5.284471959725984),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.572154032177765),
                                    ("Hanukkahyear (latent)", -5.977619140285929),
                                    ("February<time> <part-of-day>", -5.977619140285929),
                                    ("Tuesdayin <named-month>|year", -5.977619140285929),
                                    ("Great Lentyear (latent)", -5.977619140285929),
                                    ("tomorrowat <time-of-day>", -5.284471959725984),
                                    ("between <time> and <time>on <date>", -4.368181227851829),
                                    ("last <cycle> of <time>year (latent)", -5.284471959725984),
                                    ("at <time-of-day>tomorrow", -5.572154032177765),
                                    ("tomorrow<time-of-day> am|pm", -5.977619140285929),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.977619140285929),
                                    ("Diwaliyear (latent)", -5.977619140285929),
                                    ("Black Fridayyear (latent)", -5.572154032177765),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.977619140285929),
                                    ("Chhathyear (latent)", -5.572154032177765),
                                    ("Vasant Panchamiyear (latent)", -5.977619140285929),
                                    ("Palm Sundayintersect", -5.977619140285929),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.977619140285929),
                                    ("Februaryintersect", -5.977619140285929),
                                    ("Simchat Torahyear (latent)", -5.977619140285929)],
                               n = 293},
                   koData =
                     ClassData{prior = -0.9593081169578459, unseen = -6.342121418721152,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.730921391293652),
                                    ("hourday", -4.730921391293652),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.647212123167807),
                                    ("dayhour", -3.2048650877986025),
                                    ("Tuesdayfrom|since|after <time>", -5.647212123167807),
                                    ("daymonth", -3.507145959671536),
                                    ("monthday", -5.241747015059643),
                                    ("monthyear", -4.394449154672439),
                                    ("<time-of-day> am|pmyear (latent)", -5.241747015059643),
                                    ("Thai Pongalyear (latent)", -4.954064942607862),
                                    ("intersecthh:mm", -5.647212123167807),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.647212123167807),
                                    ("houryear", -4.730921391293652),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.647212123167807),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.954064942607862),
                                    ("<time-of-day> am|pmintersect", -4.394449154672439),
                                    ("until <time>on <date>", -4.954064942607862),
                                    ("Octoberyear (latent)", -5.647212123167807),
                                    ...
                                    ("from|since|after <time>July", -5.647212123167807),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.730921391293652),
                                    ("Clean Mondayyear (latent)", -5.647212123167807),
                                    ("monthhour", -5.647212123167807),
                                    ("hourmonth", -4.730921391293652),
                                    ("todayat <time-of-day>", -5.647212123167807),
                                    ("from|since|after <time>December", -5.647212123167807),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.647212123167807),
                                    ("Mondayyear (latent)", -4.954064942607862),
                                    ("dayday", -5.241747015059643),
                                    ("<time-of-day> am|pmon <date>", -4.394449154672439),
                                    ("Thursdaydd/mm", -5.647212123167807),
                                    ("dayyear", -2.7027731440013665),
                                    ("New Year's Dayyear (latent)", -5.241747015059643),
                                    ("Thursdayfrom|since|after <time>", -3.9424640309293815),
                                    ("Thursdayat <time-of-day>", -4.394449154672439),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.647212123167807),
                                    ("Aprilyear (latent)", -5.647212123167807),
                                    ("monthminute", -5.647212123167807),
                                    ("<time-of-day> am|pmtomorrow", -5.647212123167807),
                                    ("Thursdayhh:mm", -4.730921391293652),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.647212123167807),
                                    ("minutemonth", -3.855452653939752),
                                    ("week-endin <named-month>|year", -5.647212123167807),
                                    ("Augustyear (latent)", -5.241747015059643),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.241747015059643),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.241747015059643),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.647212123167807),
                                    ("Sundayyear (latent)", -4.954064942607862),
                                    ("Christmasat <time-of-day>", -5.647212123167807),
                                    ("from|since|after <time>year (latent)", -4.394449154672439),
                                    ("<duration> after|before|from <time>December",
                                     -5.647212123167807),
                                    ("yesterday<time-of-day> am|pm", -5.647212123167807),
                                    ...
                                    ("Holiyear (latent)", -5.647212123167807),
                                    ("until <time><time-of-day> am|pm", -5.647212123167807),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.647212123167807),
                                    ("dayminute", -3.1623054733798064),
                                    ("intersectSeptember", -4.143134726391533),
                                    ("minuteday", -2.5791591880341898),
                                    ("absorption of , after named dayintersect",
                                     -5.647212123167807),
                                    ("Februaryin|during the <part-of-day>", -5.647212123167807),
                                    ("hh:mmon <date>", -3.632309102625542),
                                    ("Saturdayyear (latent)", -5.647212123167807),
                                    ("from|since|after <time>on <date>", -4.730921391293652),
                                    ("absorption of , after named daySeptember",
                                     -4.730921391293652),
                                    ("Naraka Chaturdashiyear (latent)", -5.647212123167807),
                                    ("on <date>September", -5.241747015059643),
                                    ("at <time-of-day>on <date>", -5.241747015059643),
                                    ("in <named-month>|yearyear (latent)", -5.647212123167807),
                                    ("dayweek", -5.647212123167807),
                                    ("Easter Sundayyear (latent)", -5.241747015059643),
                                    ("Thursday<time-of-day> am|pm", -4.954064942607862),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.647212123167807),
                                    ("Sundayfrom|since|after <time>", -5.647212123167807),
                                    ("absorption of , after named dayFebruary", -4.730921391293652),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.647212123167807),
                                    ("tomorrowat <time-of-day>", -5.647212123167807),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.647212123167807),
                                    ("tomorrow<time-of-day> am|pm", -5.647212123167807),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.954064942607862),
                                    ("Diwaliyear (latent)", -5.241747015059643),
