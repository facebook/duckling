...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5827595343255747,
                               unseen = -6.0473721790462776,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 421},
                   koData =
                     ClassData{prior = -0.8172498780275123, unseen = -5.814130531825066,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4750583999073596,
                               unseen = -7.0587581525186645,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.364750756851911),
                                    ("Karva Chauthyear (latent)", -6.364750756851911),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.364750756851911),
                                    ("Maha Shivaratriyear (latent)", -6.364750756851911),
                                    ("Ramadanyear (latent)", -5.448460024977757),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.978456395732021),
                                    ("Bhai Doojyear (latent)", -6.364750756851911),
                                    ("hourday", -4.349847736309647),
                                    ("dayhour", -3.4203117776854706),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.978456395732021),
                                    ("Martin Luther King's Dayyear (latent)", -5.959285648743747),
                                    ("Shemini Atzeretyear (latent)", -6.364750756851911),
                                    ("daymonth", -4.349847736309647),
                                    ("monthday", -5.959285648743747),
                                    ("monthyear", -4.572991287623856),
                                    ("Yom Ha'atzmautyear (latent)", -6.364750756851911),
                                    ("Vijayadashamiyear (latent)", -6.364750756851911),
                                    ("Thai Pongalyear (latent)", -5.671603576291966),
                                    ("Thiru Onamyear (latent)", -5.671603576291966),
                                    ("hhhmmabsorption of , after named day", -6.364750756851911),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.364750756851911),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.448460024977757),
                                    ("<day-of-month> (ordinal)Wednesday", -6.364750756851911),
                                    ("Krishna Janmashtamiyear (latent)", -5.959285648743747),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.364750756851911),
                                    ("houryear", -5.448460024977757),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.364750756851911),
                                    ("Christmas<time-of-day> am|pm", -6.364750756851911),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.364750756851911),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.671603576291966),
                                    ("intersectin|during <named-month>|year", -6.364750756851911),
                                    ("<time-of-day> am|pmintersect", -5.111987788356543),
                                    ("Earth Houryear (latent)", -6.364750756851911),
                                    ("Octoberyear (latent)", -4.860673360075637),
                                    ("intersect<time-of-day> am|pm", -6.364750756851911),
                                    ("Mattu Pongalyear (latent)", -6.364750756851911),
                                    ("Shavuotyear (latent)", -6.364750756851911),
                                    ("Parsi New Yearyear (latent)", -5.448460024977757),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.364750756851911),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.364750756851911),
                                    ("todayin|within|after <duration>", -6.364750756851911),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.959285648743747),
                                    ("Marchyear (latent)", -6.364750756851911),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -5.959285648743747),
                                    ("Sukkotyear (latent)", -5.959285648743747),
                                    ("hhhmmintersect", -5.959285648743747),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.959285648743747),
                                    ("Clean Mondayyear (latent)", -5.959285648743747),
                                    ("monthhour", -5.959285648743747),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.671603576291966),
                                    ("todayat <time-of-day>", -6.364750756851911),
                                    ("Thursday<time> timezone", -3.9668554840535406),
                                    ("time-of-day (latent)tonight", -5.959285648743747),
                                    ("from|since|after <time>December", -6.364750756851911),
                                    ("<time-of-day> am|pmon <day>", -4.349847736309647),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.364750756851911),
                                    ("yyyy-mm-ddhh:mm:ss", -5.959285648743747),
                                    ("dayday", -3.656700555749701),
                                    ("<time> <part-of-day>at <time-of-day>", -6.364750756851911),
                                    ("tonightat <time-of-day>", -6.364750756851911),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.671603576291966),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.364750756851911),
                                    ("today<time-of-day> am|pm", -6.364750756851911),
                                    ("Februarythe <day-of-month> (ordinal)", -5.959285648743747),
                                    ("at <time-of-day><time> <part-of-day>", -6.364750756851911),
                                    ("<day-of-month> (ordinal)intersect", -5.959285648743747),
                                    ("hourhour", -4.2853092151720755),
                                    ("Mahavir Jayantiyear (latent)", -5.959285648743747),
                                    ("Navaratriin|during <named-month>|year", -6.364750756851911),
                                    ("Wednesdaythis|last|next <cycle>", -6.364750756851911),
                                    ("Lentyear (latent)", -6.364750756851911),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.49294857995032),
                                    ("Boghiyear (latent)", -6.364750756851911),
                                    ("dayyear", -1.951952463511276),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.364750756851911),
                                    ("Thursdayfrom|since|after <time>", -5.959285648743747),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.364750756851911),
                                    ("Thursdayat <time-of-day>", -5.671603576291966),
                                    ("Islamic New Yearyear (latent)", -5.959285648743747),
                                    ("Laylat al-Qadryear (latent)", -5.448460024977757),
                                    ("Shrove Tuesdayyear (latent)", -6.364750756851911),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.671603576291966),
                                    ("<time-of-day> am|pmtomorrow", -5.671603576291966),
                                    ("Yom Kippuryear (latent)", -6.364750756851911),
                                    ("<day-of-month> (ordinal)Tuesday", -5.959285648743747),
                                    ("<part-of-day> of <time>year (latent)", -6.364750756851911),
                                    ("minutehour", -5.111987788356543),
                                    ("Kaanum Pongalyear (latent)", -5.959285648743747),
                                    ("Maha Saptamiyear (latent)", -6.364750756851911),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.959285648743747),
                                    ("time-of-day (latent)tomorrow", -5.448460024977757),
                                    ("part of daysat <time-of-day>", -5.959285648743747),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.349847736309647),
                                    ("for <duration> from <time>December", -6.364750756851911),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.364750756851911),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.111987788356543),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.111987788356543),
                                    ("time-of-day (latent)this <part-of-day>", -6.364750756851911),
                                    ("Pentecostyear (latent)", -6.364750756851911),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.111987788356543),
                                    ("<day-of-month> (ordinal)February", -6.364750756851911),
                                    ("Eid al-Fitryear (latent)", -5.448460024977757),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.364750756851911),
                                    ("Mondayin|during the <part-of-day>", -6.364750756851911),
                                    ("Chhathin|during <named-month>|year", -6.364750756851911),
                                    ("Diwaliin|during <named-month>|year", -6.364750756851911),
                                    ("Vaisakhiin|during <named-month>|year", -6.364750756851911),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.111987788356543),
                                    ("Raksha Bandhanyear (latent)", -6.364750756851911),
                                    ("daysecond", -5.959285648743747),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.959285648743747),
                                    ("Ashurayear (latent)", -6.364750756851911),
                                    ("Tuesdayin|during <named-month>|year", -6.364750756851911),
                                    ("Chinese New Yearyear (latent)", -6.364750756851911),
                                    ("tomorrowintersect", -6.364750756851911),
                                    ("Lag BaOmeryear (latent)", -6.364750756851911),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.364750756851911),
                                    ("Eid al-Adhayear (latent)", -4.22468459335564),
                                    ("intersectin|during the <part-of-day>", -6.364750756851911),
                                    ("Palm Sundayyear (latent)", -6.364750756851911),
                                    ("Christmasat <time-of-day>", -6.364750756851911),
                                    ("Passoveryear (latent)", -6.364750756851911),
                                    ("Lazarus Saturdayyear (latent)", -6.364750756851911),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.364750756851911),
                                    ("hhhmmon <day>", -5.448460024977757),
                                    ("Yom HaShoahyear (latent)", -5.959285648743747),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.959285648743747),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.364750756851911),
                                    ("Septemberyear (latent)", -5.959285648743747),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.860673360075637),
                                    ("Halloweenyear (latent)", -6.364750756851911),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.364750756851911),
                                    ("at <time-of-day>intersect", -5.448460024977757),
                                    ("Rosh Hashanahyear (latent)", -5.671603576291966),
                                    ("Dhanterasyear (latent)", -6.364750756851911),
                                    ("Tu BiShvatyear (latent)", -6.364750756851911),
                                    ("<day-of-month> (ordinal)December", -5.671603576291966),
                                    ("Holiyear (latent)", -5.671603576291966),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.364750756851911),
                                    ("Holika Dahanyear (latent)", -5.671603576291966),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.959285648743747),
                                    ("dayminute", -3.0505647521793855),
                                    ("Mawlidyear (latent)", -6.364750756851911),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.959285648743747),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.364750756851911),
                                    ("Jumu'atul-Widayear (latent)", -5.448460024977757),
                                    ("minuteday", -2.627081138568543),
                                    ("absorption of , after named dayintersect",
                                     -5.671603576291966),
                                    ("intersectyear (latent)", -6.364750756851911),
                                    ("Orthodox Easter Sundayyear (latent)", -6.364750756851911),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.364750756851911),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.364750756851911),
                                    ("intersecthhhmm", -5.959285648743747),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.364750756851911),
                                    ("Boss's Dayyear (latent)", -5.959285648743747),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.364750756851911),
                                    ("Global Youth Service Dayyear (latent)", -6.364750756851911),
                                    ("Dhanterasin|during <named-month>|year", -6.364750756851911),
                                    ("Tisha B'Avyear (latent)", -6.364750756851911),
                                    ("Isra and Mi'rajyear (latent)", -5.448460024977757),
                                    ("at <time-of-day>on <day>", -4.755312844417811),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.959285648743747),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.671603576291966),
                                    ("Christmasyear (latent)", -5.959285648743747),
                                    ("Naraka Chaturdashiyear (latent)", -5.959285648743747),
                                    ("Thai Pongalin|during <named-month>|year", -6.364750756851911),
                                    ("dayweek", -6.364750756851911),
                                    ("Easter Sundayyear (latent)", -5.671603576291966),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -5.959285648743747),
                                    ("weekyear", -5.266138468183802),
                                    ("King's Dayyear (latent)", -4.860673360075637),
                                    ("hh:mmin|during the <part-of-day>", -5.448460024977757),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.959285648743747),
                                    ("Hanukkahyear (latent)", -5.671603576291966),
                                    ("February<time> <part-of-day>", -6.364750756851911),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.364750756851911),
                                    ("Great Lentyear (latent)", -6.364750756851911),
                                    ("tomorrowat <time-of-day>", -5.671603576291966),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.364750756851911),
                                    ("Vaisakhiyear (latent)", -5.671603576291966),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.671603576291966),
                                    ("last <cycle> of <time>year (latent)", -5.671603576291966),
                                    ("at <time-of-day>tomorrow", -5.959285648743747),
                                    ("tomorrow<time-of-day> am|pm", -6.364750756851911),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.364750756851911),
                                    ("Diwaliyear (latent)", -6.364750756851911),
                                    ("between <time> and <time>on <day>", -5.959285648743747),
                                    ("Black Fridayyear (latent)", -5.959285648743747),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.364750756851911),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.364750756851911),
                                    ("Chhathyear (latent)", -5.959285648743747),
                                    ("Vasant Panchamiyear (latent)", -6.364750756851911),
                                    ("Rabindra Jayantiyear (latent)", -5.111987788356543),
                                    ("St Patrick's Dayyear (latent)", -6.364750756851911),
                                    ("Thursday<time> (timezone)", -6.364750756851911),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.364750756851911),
                                    ("<datetime> - <datetime> (interval)July", -5.959285648743747),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.671603576291966),
                                    ("Februaryintersect", -6.364750756851911),
                                    ("Simchat Torahyear (latent)", -6.364750756851911),
                                    ("minuteyear", -6.364750756851911)],
                               n = 444},
                   koData =
                     ClassData{prior = -0.9724610033412097, unseen = -6.703188113240863,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.504735788666321),
                                    ("hourday", -3.6109179126442243),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.008813185442595),
                                    ("<day-of-month> (ordinal)August", -6.008813185442595),
                                    ("dayhour", -3.4438638279810583),
                                    ("<time> timezoneyear (latent)", -5.31566600488265),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.09252245356844),
                                    ("Tuesdayfrom|since|after <time>", -5.31566600488265),
                                    ("daymonth", -3.3346645360160663),
                                    ("monthyear", -4.756050216947227),
                                    ("<time-of-day> am|pmyear (latent)", -5.31566600488265),
                                    ("Thai Pongalyear (latent)", -5.31566600488265),
                                    ("intersecthh:mm", -6.008813185442595),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.603348077334431),
                                    ("<day-of-month> (ordinal)Wednesday", -6.008813185442595),
                                    ("houryear", -4.622518824322705),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.008813185442595),
                                    ("<day-of-month> (ordinal)October", -6.008813185442595),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.31566600488265),
                                    ("hournograin", -4.756050216947227),
                                    ("<time-of-day> am|pmintersect", -4.756050216947227),
                                    ("Octoberyear (latent)", -6.008813185442595),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.603348077334431),
                                    ("until <time>on <day>", -5.31566600488265),
                                    ("time-of-day (latent)intersect", -5.31566600488265),
                                    ("todayin <number> (implicit minutes)", -6.008813185442595),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.31566600488265),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.008813185442595),
                                    ("hh:mmon <day>", -4.756050216947227),
                                    ("hhhmmintersect", -5.603348077334431),
                                    ("absorption of , after named dayJuly", -5.09252245356844),
                                    ("from|since|after <time>July", -5.603348077334431),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.09252245356844),
                                    ("Clean Mondayyear (latent)", -6.008813185442595),
                                    ("monthhour", -6.008813185442595),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.603348077334431),
                                    ("hourmonth", -4.137011008541004),
                                    ("todayat <time-of-day>", -6.008813185442595),
                                    ("hhhmmyear (latent)", -4.756050216947227),
                                    ("from|since|after <time>December", -6.008813185442595),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.008813185442595),
                                    ("<time-of-day> am|pmon <day>", -4.756050216947227),
                                    ("Mondayyear (latent)", -5.31566600488265),
                                    ("dayday", -4.622518824322705),
                                    ("on <day>September", -5.31566600488265),
                                    ("time-of-day (latent)September", -5.603348077334431),
                                    ("hourhour", -5.603348077334431),
                                    ("time-of-day (latent)on <day>", -4.504735788666321),
                                    ("Thursdaydd/mm", -6.008813185442595),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.603348077334431),
                                    ("dayyear", -3.0910424533583156),
                                    ("New Year's Dayyear (latent)", -5.09252245356844),
                                    ("time-of-day (latent)Sunday", -5.603348077334431),
                                    ("Thursdayfrom|since|after <time>", -4.304065093204169),
                                    ("Thursdayat <time-of-day>", -4.399375273008495),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.008813185442595),
                                    ("Aprilyear (latent)", -6.008813185442595),
                                    ("the <day-of-month> (ordinal)July", -6.008813185442595),
                                    ("the <day-of-month> (number)July", -6.008813185442595),
                                    ("monthminute", -6.008813185442595),
                                    ("<time-of-day> am|pmtomorrow", -6.008813185442595),
                                    ("Thursdayhh:mm", -5.09252245356844),
                                    ("<day-of-month> (ordinal)Tuesday", -5.603348077334431),
                                    ("minutemonth", -3.8687470219463242),
                                    ("time-of-day (latent)Friday", -5.603348077334431),
                                    ("minutehour", -6.008813185442595),
                                    ("Augustyear (latent)", -5.603348077334431),
                                    ("week-endin|during <named-month>|year", -6.008813185442595),
                                    ("time-of-day (latent)Tuesday", -5.603348077334431),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.008813185442595),
                                    ("Sundayyear (latent)", -5.09252245356844),
                                    ("Christmasat <time-of-day>", -6.008813185442595),
                                    ("from|since|after <time>year (latent)", -4.9102008967744855),
                                    ("hhhmmon <day>", -5.09252245356844),
                                    ("yesterday<time-of-day> am|pm", -6.008813185442595),
                                    ("<day-of-month> (ordinal)July", -5.31566600488265),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.008813185442595),
                                    ("at <time-of-day>intersect", -5.09252245356844),
                                    ("hh:mmyear (latent)", -4.622518824322705),
                                    ("Holiyear (latent)", -6.008813185442595),
                                    ("until <time><time-of-day> am|pm", -6.008813185442595),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.603348077334431),
                                    ("dayminute", -3.175599841386379),
                                    ("yyyy-mm-ddhh:mm", -5.603348077334431),
                                    ("intersectfrom|since|after <time>", -5.603348077334431),
                                    ("intersectSeptember", -4.137011008541004),
                                    ("minuteday", -2.8518127642924815),
                                    ("absorption of , after named dayintersect",
                                     -6.008813185442595),
                                    ("intersectyear (latent)", -6.008813185442595),
                                    ("Februaryin|during the <part-of-day>", -6.008813185442595),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.008813185442595),
                                    ("time-of-day (latent)July", -5.31566600488265),
                                    ("Saturdayyear (latent)", -6.008813185442595),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.008813185442595),
                                    ("at <time-of-day>on <day>", -5.09252245356844),
                                    ("absorption of , after named daySeptember",
                                     -4.756050216947227),
                                    ("Naraka Chaturdashiyear (latent)", -6.008813185442595),
                                    ("from|since|after <time>on <day>", -5.09252245356844),
                                    ("dayweek", -6.008813185442595),
                                    ("Easter Sundayyear (latent)", -5.603348077334431),
                                    ("Thursday<time-of-day> am|pm", -4.756050216947227),
                                    ("weekyear", -5.603348077334431),
                                    ("time-of-day (latent)Thursday", -5.603348077334431),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.008813185442595),
                                    ("<day-of-month> (ordinal)April", -6.008813185442595),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.603348077334431),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.31566600488265),
                                    ("Sundayfrom|since|after <time>", -6.008813185442595),
                                    ("absorption of , after named dayFebruary", -5.09252245356844),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.603348077334431),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.008813185442595),
                                    ("tomorrowat <time-of-day>", -6.008813185442595),
                                    ("daynograin", -5.603348077334431),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.603348077334431),
                                    ("last <cycle> of <time>year (latent)", -5.603348077334431),
                                    ("tomorrow<time-of-day> am|pm", -6.008813185442595),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.31566600488265),
                                    ("Diwaliyear (latent)", -5.603348077334431),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.008813185442595),
                                    ("Fridayyear (latent)", -5.603348077334431),
                                    ("time-of-day (latent)April", -6.008813185442595),
                                    ("minuteyear", -3.8115886081063755)],
=======
                     ClassData{prior = -0.4700036292457356, unseen = -7.069874128458572,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.375876246018314),
                                    ("Karva Chauthyear (latent)", -6.375876246018314),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.375876246018314),
                                    ("Maha Shivaratriyear (latent)", -6.375876246018314),
                                    ("Ramadanyear (latent)", -5.459585514144159),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.989581884898423),
                                    ("Bhai Doojyear (latent)", -6.375876246018314),
                                    ("hourday", -4.360973225476049),
                                    ("dayhour", -3.431437266851874),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.989581884898423),
                                    ("Martin Luther King's Dayyear (latent)", -5.970411137910149),
                                    ("Shemini Atzeretyear (latent)", -6.375876246018314),
                                    ("daymonth", -4.360973225476049),
                                    ("monthday", -5.970411137910149),
                                    ("monthyear", -4.584116776790259),
                                    ("Yom Ha'atzmautyear (latent)", -6.375876246018314),
                                    ("Vijayadashamiyear (latent)", -6.375876246018314),
                                    ("Thai Pongalyear (latent)", -5.682729065458369),
                                    ("Thiru Onamyear (latent)", -5.682729065458369),
                                    ("hhhmmabsorption of , after named day", -6.375876246018314),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.375876246018314),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.459585514144159),
                                    ("<day-of-month> (ordinal)Wednesday", -6.375876246018314),
                                    ("Krishna Janmashtamiyear (latent)", -5.970411137910149),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.375876246018314),
                                    ("houryear", -5.459585514144159),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.375876246018314),
                                    ("Christmas<time-of-day> am|pm", -6.375876246018314),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.375876246018314),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.682729065458369),
                                    ("intersectin|during <named-month>|year", -6.375876246018314),
                                    ("<time-of-day> am|pmintersect", -5.123113277522946),
                                    ("Earth Houryear (latent)", -6.375876246018314),
                                    ("Octoberyear (latent)", -4.87179884924204),
                                    ("intersect<time-of-day> am|pm", -6.375876246018314),
                                    ("Mattu Pongalyear (latent)", -6.375876246018314),
                                    ("Shavuotyear (latent)", -6.375876246018314),
                                    ("Parsi New Yearyear (latent)", -5.459585514144159),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.375876246018314),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.375876246018314),
                                    ("todayin|within|after <duration>", -6.375876246018314),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.970411137910149),
                                    ("Marchyear (latent)", -6.375876246018314),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -5.970411137910149),
                                    ("Sukkotyear (latent)", -5.970411137910149),
                                    ("hhhmmintersect", -5.970411137910149),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.970411137910149),
                                    ("Clean Mondayyear (latent)", -5.970411137910149),
                                    ("monthhour", -5.970411137910149),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.682729065458369),
                                    ("todayat <time-of-day>", -6.375876246018314),
                                    ("Thursday<time> timezone", -3.9779809732199434),
                                    ("time-of-day (latent)tonight", -5.970411137910149),
                                    ("from|since|after <time>December", -6.375876246018314),
                                    ("<time-of-day> am|pmon <day>", -4.360973225476049),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.375876246018314),
                                    ("yyyy-mm-ddhh:mm:ss", -5.970411137910149),
                                    ("dayday", -3.667826044916104),
                                    ("<time> <part-of-day>at <time-of-day>", -6.375876246018314),
                                    ("tonightat <time-of-day>", -6.375876246018314),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.682729065458369),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.375876246018314),
                                    ("today<time-of-day> am|pm", -6.375876246018314),
                                    ("Februarythe <day-of-month> (ordinal)", -5.970411137910149),
                                    ("at <time-of-day><time> <part-of-day>", -6.375876246018314),
                                    ("<day-of-month> (ordinal)intersect", -5.970411137910149),
                                    ("hourhour", -4.296434704338478),
                                    ("Mahavir Jayantiyear (latent)", -5.970411137910149),
                                    ("Navaratriin|during <named-month>|year", -6.375876246018314),
                                    ("Wednesdaythis|last|next <cycle>", -6.375876246018314),
                                    ("Lentyear (latent)", -6.375876246018314),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.504074069116722),
                                    ("Boghiyear (latent)", -6.375876246018314),
                                    ("dayyear", -1.9273598700755994),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.375876246018314),
                                    ("Thursdayfrom|since|after <time>", -5.970411137910149),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.375876246018314),
                                    ("Thursdayat <time-of-day>", -5.682729065458369),
                                    ("Islamic New Yearyear (latent)", -5.970411137910149),
                                    ("Laylat al-Qadryear (latent)", -5.459585514144159),
                                    ("Shrove Tuesdayyear (latent)", -6.375876246018314),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.682729065458369),
                                    ("<time-of-day> am|pmtomorrow", -5.682729065458369),
                                    ("Yom Kippuryear (latent)", -6.375876246018314),
                                    ("<day-of-month> (ordinal)Tuesday", -5.970411137910149),
                                    ("<part-of-day> of <time>year (latent)", -6.375876246018314),
                                    ("minutehour", -5.123113277522946),
                                    ("Kaanum Pongalyear (latent)", -5.970411137910149),
                                    ("Maha Saptamiyear (latent)", -6.375876246018314),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.970411137910149),
                                    ("time-of-day (latent)tomorrow", -5.459585514144159),
                                    ("part of daysat <time-of-day>", -5.970411137910149),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.360973225476049),
                                    ("for <duration> from <time>December", -6.375876246018314),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.375876246018314),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.123113277522946),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.123113277522946),
                                    ("time-of-day (latent)this <part-of-day>", -6.375876246018314),
                                    ("Pentecostyear (latent)", -6.375876246018314),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.123113277522946),
                                    ("<day-of-month> (ordinal)February", -6.375876246018314),
                                    ("Eid al-Fitryear (latent)", -5.459585514144159),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.375876246018314),
                                    ("Mondayin|during the <part-of-day>", -6.375876246018314),
                                    ("Chhathin|during <named-month>|year", -6.375876246018314),
                                    ("Diwaliin|during <named-month>|year", -6.375876246018314),
                                    ("Vaisakhiin|during <named-month>|year", -6.375876246018314),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.123113277522946),
                                    ("Raksha Bandhanyear (latent)", -6.375876246018314),
                                    ("daysecond", -5.970411137910149),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.970411137910149),
                                    ("Ashurayear (latent)", -6.375876246018314),
                                    ("Tuesdayin|during <named-month>|year", -6.375876246018314),
                                    ("Chinese New Yearyear (latent)", -6.375876246018314),
                                    ("tomorrowintersect", -6.375876246018314),
                                    ("Lag BaOmeryear (latent)", -6.375876246018314),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.375876246018314),
                                    ("Eid al-Adhayear (latent)", -4.235810082522043),
                                    ("intersectin|during the <part-of-day>", -6.375876246018314),
                                    ("Palm Sundayyear (latent)", -6.375876246018314),
                                    ("Christmasat <time-of-day>", -6.375876246018314),
                                    ("Passoveryear (latent)", -6.375876246018314),
                                    ("Lazarus Saturdayyear (latent)", -6.375876246018314),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.375876246018314),
                                    ("hhhmmon <day>", -5.459585514144159),
                                    ("Yom HaShoahyear (latent)", -5.970411137910149),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.970411137910149),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.375876246018314),
                                    ("Septemberyear (latent)", -5.970411137910149),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.87179884924204),
                                    ("Halloweenyear (latent)", -6.375876246018314),
                                    ("<ordinal> last <cycle> of <time>year (latent)",
                                     -5.970411137910149),
                                    ("from <time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.682729065458369),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.375876246018314),
                                    ("at <time-of-day>intersect", -5.459585514144159),
                                    ("Rosh Hashanahyear (latent)", -5.682729065458369),
                                    ("Dhanterasyear (latent)", -6.375876246018314),
                                    ("Tu BiShvatyear (latent)", -6.375876246018314),
                                    ("<day-of-month> (ordinal)December", -5.682729065458369),
                                    ("Holiyear (latent)", -5.682729065458369),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.375876246018314),
                                    ("Holika Dahanyear (latent)", -5.682729065458369),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.970411137910149),
                                    ("dayminute", -3.0616902413457883),
                                    ("Mawlidyear (latent)", -6.375876246018314),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.970411137910149),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.375876246018314),
                                    ("Jumu'atul-Widayear (latent)", -5.459585514144159),
                                    ("minuteday", -2.6382066277349456),
                                    ("absorption of , after named dayintersect",
                                     -5.682729065458369),
                                    ("intersectyear (latent)", -6.375876246018314),
                                    ("Orthodox Easter Sundayyear (latent)", -6.375876246018314),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.375876246018314),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.375876246018314),
                                    ("intersecthhhmm", -5.970411137910149),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.375876246018314),
                                    ("Boss's Dayyear (latent)", -5.970411137910149),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.375876246018314),
                                    ("Global Youth Service Dayyear (latent)", -6.375876246018314),
                                    ("Dhanterasin|during <named-month>|year", -6.375876246018314),
                                    ("Tisha B'Avyear (latent)", -6.375876246018314),
                                    ("Isra and Mi'rajyear (latent)", -5.459585514144159),
                                    ("at <time-of-day>on <day>", -4.7664383335842135),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.970411137910149),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.682729065458369),
                                    ("Christmasyear (latent)", -5.970411137910149),
                                    ("Naraka Chaturdashiyear (latent)", -5.970411137910149),
                                    ("Thai Pongalin|during <named-month>|year", -6.375876246018314),
                                    ("dayweek", -6.375876246018314),
                                    ("Easter Sundayyear (latent)", -5.682729065458369),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -5.970411137910149),
                                    ("weekyear", -5.277263957350204),
                                    ("King's Dayyear (latent)", -4.87179884924204),
                                    ("hh:mmin|during the <part-of-day>", -5.459585514144159),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.970411137910149),
                                    ("Hanukkahyear (latent)", -5.682729065458369),
                                    ("February<time> <part-of-day>", -6.375876246018314),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.375876246018314),
                                    ("Great Lentyear (latent)", -6.375876246018314),
                                    ("tomorrowat <time-of-day>", -5.682729065458369),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.375876246018314),
                                    ("Vaisakhiyear (latent)", -5.682729065458369),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.682729065458369),
                                    ("last <cycle> of <time>year (latent)", -5.682729065458369),
                                    ("at <time-of-day>tomorrow", -5.970411137910149),
                                    ("tomorrow<time-of-day> am|pm", -6.375876246018314),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.375876246018314),
                                    ("Diwaliyear (latent)", -6.375876246018314),
                                    ("between <time> and <time>on <day>", -5.970411137910149),
                                    ("Black Fridayyear (latent)", -5.970411137910149),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.375876246018314),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.375876246018314),
                                    ("Chhathyear (latent)", -5.970411137910149),
                                    ("Vasant Panchamiyear (latent)", -6.375876246018314),
                                    ("Rabindra Jayantiyear (latent)", -5.123113277522946),
                                    ("St Patrick's Dayyear (latent)", -6.375876246018314),
                                    ("Thursday<time> (timezone)", -6.375876246018314),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.375876246018314),
                                    ("Pargat Diwasyear (latent)", -5.123113277522946),
                                    ("<datetime> - <datetime> (interval)July", -5.970411137910149),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.682729065458369),
                                    ("Februaryintersect", -6.375876246018314),
                                    ("Simchat Torahyear (latent)", -6.375876246018314),
                                    ("minuteyear", -6.375876246018314)],
                               n = 450},
                   koData =
                     ClassData{prior = -0.9808292530117262, unseen = -6.704414354964107,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.505963535904644),
                                    ("hourday", -3.6121456598825468),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.010040932680917),
                                    ("<day-of-month> (ordinal)August", -6.010040932680917),
                                    ("dayhour", -3.4450915752193807),
                                    ("<time> timezoneyear (latent)", -5.316893752120972),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.093750200806762),
                                    ("Tuesdayfrom|since|after <time>", -5.316893752120972),
                                    ("daymonth", -3.3358922832543887),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.010040932680917),
                                    ("hh:mmon <day>", -4.757277964185549),
                                    ("hhhmmintersect", -5.604575824572753),
                                    ("absorption of , after named dayJuly", -5.093750200806762),
                                    ...
                                    ("hhhmmyear (latent)", -4.757277964185549),
                                    ...
                                    ("on <day>September", -5.316893752120972),
                                    ("time-of-day (latent)September", -5.604575824572753),
                                    ("hourhour", -5.604575824572753),
                                    ("time-of-day (latent)on <day>", -4.505963535904644),
                                    ("Thursdaydd/mm", -6.010040932680917),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.604575824572753),
                                    ("dayyear", -3.092270200596638),
                                    ...
                                    ("minutemonth", -3.8699747691846467),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.16303962724450435,
                               unseen = -5.2832037287379885,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.109058707003112e-2),
                                    ("intersect 2 numbers", -3.891820298110627)],
                               n = 192},
                   koData =
