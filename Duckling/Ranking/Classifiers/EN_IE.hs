...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6270073780554003, unseen = -5.529429087511423,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 250},
                   koData =
                     ClassData{prior = -0.7639732331285577, unseen = -5.393627546352362,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47630144583272555,
                               unseen = -6.612041034833092,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -5.917548864157814),
                                    ("Ramadanyear (latent)", -5.917548864157814),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.664785895662446),
                                    ("Bhai Doojyear (latent)", -5.917548864157814),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.664785895662446),
                                    ("hourday", -4.2128007719193885),
                                    ("dayhour", -2.999778132073535),
                                    ("Martin Luther King's Dayyear (latent)", -5.512083756049649),
                                    ("Shemini Atzeretyear (latent)", -5.917548864157814),
                                    ("daymonth", -5.224401683597868),
                                    ("monthday", -5.512083756049649),
                                    ("monthyear", -4.308110951723713),
                                    ("Yom Ha'atzmautyear (latent)", -5.917548864157814),
                                    ("Vijayadashamiyear (latent)", -5.917548864157814),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.917548864157814),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.917548864157814),
                                    ("houryear", -5.224401683597868),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.917548864157814),
                                    ("Christmas<time-of-day> am|pm", -5.917548864157814),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.917548864157814),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.224401683597868),
                                    ("<time-of-day> am|pmintersect", -4.664785895662446),
                                    ("Octoberyear (latent)", -4.664785895662446),
                                    ("intersect<time-of-day> am|pm", -5.917548864157814),
                                    ("Shavuotyear (latent)", -5.917548864157814),
                                    ("Dhanterasin <named-month>|year", -5.917548864157814),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.917548864157814),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.917548864157814),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.512083756049649),
                                    ("Marchyear (latent)", -5.917548864157814),
                                    ("Sukkotyear (latent)", -5.512083756049649),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.917548864157814),
                                    ("Clean Mondayyear (latent)", -5.512083756049649),
                                    ("monthhour", -5.512083756049649),
                                    ("todayat <time-of-day>", -5.917548864157814),
                                    ("Thursday<time> timezone", -4.2128007719193885),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.917548864157814),
                                    ("Palm SundaySunday", -5.512083756049649),
                                    ("dayday", -3.7203242868215947),
                                    ("<time> <part-of-day>at <time-of-day>", -5.917548864157814),
                                    ("tonightat <time-of-day>", -5.917548864157814),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.224401683597868),
                                    ("today<time-of-day> am|pm", -5.917548864157814),
                                    ("Februarythe <day-of-month> (ordinal)", -5.512083756049649),
                                    ("at <time-of-day><time> <part-of-day>", -5.917548864157814),
                                    ("hourhour", -4.664785895662446),
                                    ("<time-of-day> am|pmon <date>", -3.902645843615549),
                                    ("Wednesdaythis|last|next <cycle>", -5.917548864157814),
                                    ("Lentyear (latent)", -5.917548864157814),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.41347146738154),
                                    ("dayyear", -2.1918554369211614),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.917548864157814),
                                    ("Thursdayat <time-of-day>", -5.512083756049649),
                                    ("Islamic New Yearyear (latent)", -5.512083756049649),
                                    ("Laylat al-Qadryear (latent)", -5.001258132283659),
                                    ("Chhathin <named-month>|year", -5.917548864157814),
                                    ("Diwaliin <named-month>|year", -5.917548864157814),
                                    ("Shrove Tuesdayyear (latent)", -5.917548864157814),
                                    ("<time-of-day> am|pmtomorrow", -5.224401683597868),
                                    ("Yom Kippuryear (latent)", -5.917548864157814),
                                    ("<part-of-day> of <time>year (latent)", -5.917548864157814),
                                    ("minutehour", -5.001258132283659),
                                    ("Maha Saptamiyear (latent)", -5.917548864157814),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.512083756049649),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.2128007719193885),
                                    ("for <duration> from <time>December", -5.917548864157814),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.917548864157814),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.001258132283659),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.512083756049649),
                                    ("Pentecostyear (latent)", -5.917548864157814),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.001258132283659),
                                    ("Eid al-Fitryear (latent)", -5.917548864157814),
                                    ("Mondayin|during the <part-of-day>", -5.917548864157814),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.512083756049649),
                                    ("Navaratriin <named-month>|year", -5.917548864157814),
                                    ("Ashurayear (latent)", -5.917548864157814),
                                    ("Chinese New Yearyear (latent)", -5.917548864157814),
                                    ("Sundayyear (latent)", -5.917548864157814),
                                    ("Lag BaOmeryear (latent)", -5.917548864157814),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.917548864157814),
                                    ("Eid al-Adhayear (latent)", -5.001258132283659),
                                    ("intersectin|during the <part-of-day>", -5.917548864157814),
                                    ("Christmasat <time-of-day>", -5.917548864157814),
                                    ("Passoveryear (latent)", -5.917548864157814),
                                    ("Lazarus Saturdayyear (latent)", -5.917548864157814),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.917548864157814),
                                    ("Yom HaShoahyear (latent)", -5.512083756049649),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.001258132283659),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.917548864157814),
                                    ("Septemberyear (latent)", -5.512083756049649),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.664785895662446),
                                    ("Halloweenyear (latent)", -5.917548864157814),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.224401683597868),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -5.001258132283659),
                                    ("at <time-of-day>intersect", -5.512083756049649),
                                    ("Rosh Hashanahyear (latent)", -5.917548864157814),
                                    ("Dhanterasyear (latent)", -5.917548864157814),
                                    ("Tu BiShvatyear (latent)", -5.917548864157814),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.917548864157814),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.917548864157814),
                                    ("dayminute", -3.352599506696277),
                                    ("Mawlidyear (latent)", -5.917548864157814),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.512083756049649),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.917548864157814),
                                    ("Jumu'atul-Widayear (latent)", -5.001258132283659),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.917548864157814),
                                    ("minuteday", -2.279962704431428),
                                    ("absorption of , after named dayintersect",
                                     -5.917548864157814),
                                    ("intersectyear (latent)", -5.917548864157814),
                                    ("Orthodox Easter Sundayyear (latent)", -5.917548864157814),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.917548864157814),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.917548864157814),
                                    ("Boss's Dayyear (latent)", -5.512083756049649),
                                    ("Tisha B'Avyear (latent)", -5.917548864157814),
                                    ("Isra and Mi'rajyear (latent)", -5.001258132283659),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.917548864157814),
                                    ("Christmasyear (latent)", -5.512083756049649),
                                    ("Naraka Chaturdashiyear (latent)", -5.512083756049649),
                                    ("at <time-of-day>on <date>", -4.818936575489704),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.308110951723713),
                                    ("dayweek", -5.917548864157814),
                                    ("Easter Sundayyear (latent)", -5.224401683597868),
                                    ("Thursday<time-of-day> am|pm", -5.917548864157814),
                                    ("weekyear", -5.512083756049649),
                                    ("hh:mmin|during the <part-of-day>", -5.224401683597868),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.512083756049649),
                                    ("Hanukkahyear (latent)", -5.917548864157814),
                                    ("February<time> <part-of-day>", -5.917548864157814),
                                    ("Tuesdayin <named-month>|year", -5.917548864157814),
                                    ("Great Lentyear (latent)", -5.917548864157814),
                                    ("tomorrowat <time-of-day>", -5.224401683597868),
                                    ("between <time> and <time>on <date>", -4.308110951723713),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.224401683597868),
                                    ("last <cycle> of <time>year (latent)", -5.224401683597868),
                                    ("at <time-of-day>tomorrow", -5.512083756049649),
                                    ("tomorrow<time-of-day> am|pm", -5.917548864157814),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.917548864157814),
                                    ("Diwaliyear (latent)", -5.917548864157814),
                                    ("Black Fridayyear (latent)", -5.512083756049649),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.917548864157814),
                                    ("Chhathyear (latent)", -5.512083756049649),
                                    ("Palm Sundayintersect", -5.917548864157814),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.917548864157814),
                                    ("Februaryintersect", -5.917548864157814),
                                    ("Simchat Torahyear (latent)", -5.917548864157814)],
                               n = 277},
                   koData =
                     ClassData{prior = -0.9704202370969907, unseen = -6.269096283706261,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.574053367981417),
                                    ("hourday", -5.574053367981417),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.574053367981417),
                                    ("dayhour", -3.2714682749873716),
                                    ("daymonth", -3.494611826301581),
                                    ("monthday", -5.168588259873252),
                                    ("monthyear", -4.321290399486049),
                                    ("<time-of-day> am|pmyear (latent)", -5.168588259873252),
                                    ("intersecthh:mm", -5.574053367981417),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.574053367981417),
                                    ("houryear", -4.657762636107262),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.574053367981417),
                                    ("until <time-of-day><time-of-day> am|pm", -5.574053367981417),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.880906187421472),
                                    ("<time-of-day> am|pmintersect", -4.321290399486049),
                                    ("Octoberyear (latent)", -5.574053367981417),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.321290399486049),
                                    ("from|since|after <time-of-day>on <date>", -4.657762636107262),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.574053367981417),
                                    ("absorption of , after named dayJuly", -5.168588259873252),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.657762636107262),
                                    ("Clean Mondayyear (latent)", -5.574053367981417),
                                    ("monthhour", -5.574053367981417),
                                    ("hourmonth", -4.880906187421472),
                                    ("todayat <time-of-day>", -5.574053367981417),
                                    ("from|since|after <time-of-day>July", -5.574053367981417),
                                    ("Mondayyear (latent)", -4.880906187421472),
                                    ("dayday", -5.168588259873252),
                                    ("<time-of-day> am|pmon <date>", -4.321290399486049),
                                    ("Thursdaydd/mm", -5.574053367981417),
                                    ("dayyear", -2.740840023925201),
                                    ("New Year's Dayyear (latent)", -5.168588259873252),
                                    ("Thursdayat <time-of-day>", -4.321290399486049),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.574053367981417),
                                    ("Aprilyear (latent)", -5.574053367981417),
                                    ("monthminute", -5.574053367981417),
                                    ("<time-of-day> am|pmtomorrow", -5.574053367981417),
                                    ("Thursdayhh:mm", -4.657762636107262),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.574053367981417),
                                    ("minutemonth", -3.782293898753362),
                                    ("Sundayfrom|since|after <time-of-day>", -5.574053367981417),
                                    ("week-endin <named-month>|year", -5.574053367981417),
                                    ("Augustyear (latent)", -5.168588259873252),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.168588259873252),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.168588259873252),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.574053367981417),
                                    ("Sundayyear (latent)", -4.880906187421472),
                                    ("Christmasat <time-of-day>", -5.574053367981417),
                                    ("<duration> after|before|from <time>December",
                                     -5.574053367981417),
                                    ("yesterday<time-of-day> am|pm", -5.574053367981417),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.574053367981417),
                                    ("until <time-of-day>on <date>", -4.880906187421472),
                                    ("at <time-of-day>intersect", -5.168588259873252),
                                    ("hh:mmyear (latent)", -4.475441079313307),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.574053367981417),
                                    ("dayminute", -3.1317063326122128),
                                    ("intersectSeptember", -4.069975971205143),
                                    ("minuteday", -2.5060004328478),
                                    ("absorption of , after named dayintersect",
                                     -5.574053367981417),
                                    ("Februaryin|during the <part-of-day>", -5.574053367981417),
                                    ("hh:mmon <date>", -3.5591503474391524),
                                    ("Saturdayyear (latent)", -5.574053367981417),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.574053367981417),
                                    ("absorption of , after named daySeptember",
                                     -4.657762636107262),
                                    ("Naraka Chaturdashiyear (latent)", -5.574053367981417),
                                    ("on <date>September", -5.168588259873252),
                                    ("at <time-of-day>on <date>", -5.168588259873252),
                                    ("in <named-month>|yearyear (latent)", -5.574053367981417),
                                    ("dayweek", -5.574053367981417),
                                    ("Easter Sundayyear (latent)", -5.168588259873252),
                                    ("Thursday<time-of-day> am|pm", -5.168588259873252),
                                    ("absorption of , after named dayFebruary", -4.657762636107262),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.574053367981417),
                                    ("tomorrowat <time-of-day>", -5.574053367981417),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.574053367981417),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.9646154555473165),
                                    ("tomorrow<time-of-day> am|pm", -5.574053367981417),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.880906187421472),
                                    ("Diwaliyear (latent)", -5.168588259873252),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.574053367981417),
                                    ("Fridayyear (latent)", -5.168588259873252),
                                    ("minuteyear", -4.321290399486049)],
                               n = 169}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1959736459622819, unseen = -4.624972813284271,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -6.124362524071867e-2),
                                    ("intersect 2 numbers", -3.228826155721369)],
                               n = 97},
                   koData =
                     ClassData{prior = -1.7261621867422419, unseen = -3.258096538021482,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("in <named-month>|year",
        Classifier{okData =
                     ClassData{prior = -0.35667494393873245,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("October", -2.2512917986064953),
                                    ("year (latent)", -1.1526795099383855),
                                    ("year", -1.1526795099383855), ("March", -2.2512917986064953),
