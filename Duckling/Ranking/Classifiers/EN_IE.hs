...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.49147798276820454,
                               unseen = -7.172424577124845,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 501},
                   koData =
                     ClassData{prior = -0.9460327010728926, unseen = -6.842683282238422,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.6443908991413725),
                                    ("hourday", -3.545778610473263),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.148468295917646),
                                    ("<day-of-month> (ordinal)August", -6.148468295917646),
                                    ("dayhour", -3.58351893845611),
                                    ("<time> timezoneyear (latent)", -5.455321115357702),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.232177564043492),
                                    ("Tuesdayfrom|since|after <time>", -5.455321115357702),
                                    ("daymonth", -3.4404180948154366),
                                    ("hourquarter", -5.232177564043492),
                                    ("monthyear", -4.895705327422279),
                                    ("<time-of-day> am|pmyear (latent)", -5.455321115357702),
                                    ("Thai Pongalyear (latent)", -5.455321115357702),
                                    ("intersecthh:mm", -6.148468295917646),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.7430031878094825),
                                    ("<day-of-month> (ordinal)Wednesday", -6.148468295917646),
                                    ("houryear", -4.356708826689592),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.148468295917646),
                                    ("<day-of-month> (ordinal)October", -6.148468295917646),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.455321115357702),
                                    ("hournograin", -4.895705327422279),
                                    ("<time-of-day> am|pmintersect", -4.895705327422279),
                                    ("Octoberyear (latent)", -6.148468295917646),
                                    ("Good Fridayyear (latent)", -5.7430031878094825),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7430031878094825),
                                    ("early morningat <time-of-day>", -6.148468295917646),
                                    ("until <time>on <day>", -5.455321115357702),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.148468295917646),
                                    ("time-of-day (latent)intersect", -5.455321115357702),
                                    ("todayin <number> (implicit minutes)", -6.148468295917646),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.455321115357702),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.148468295917646),
                                    ("hh:mmon <day>", -4.895705327422279),
                                    ("hhhmmintersect", -5.7430031878094825),
                                    ("absorption of , after named dayJuly", -5.232177564043492),
                                    ("from|since|after <time>July", -5.7430031878094825),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.232177564043492),
                                    ("Clean Mondayyear (latent)", -6.148468295917646),
                                    ("monthhour", -6.148468295917646),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7430031878094825),
                                    ("hourmonth", -4.008402132421376),
                                    ("todayat <time-of-day>", -6.148468295917646),
                                    ("hhhmmyear (latent)", -4.895705327422279),
                                    ("from|since|after <time>December", -6.148468295917646),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.148468295917646),
                                    ("<time-of-day> am|pmon <day>", -4.895705327422279),
                                    ("Mondayyear (latent)", -5.455321115357702),
                                    ("dayday", -4.008402132421376),
                                    ("on <day>September", -5.455321115357702),
                                    ("time-of-day (latent)September", -5.7430031878094825),
                                    ("hourhour", -4.069026754237811),
                                    ("time-of-day (latent)on <day>", -4.6443908991413725),
                                    ("Thursdaydd/mm", -6.148468295917646),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.7430031878094825),
                                    ("dayyear", -3.128043409773284),
                                    ("New Year's Dayyear (latent)", -5.232177564043492),
                                    ("time-of-day (latent)Sunday", -5.7430031878094825),
                                    ("Thursdayfrom|since|after <time>", -4.443720203679222),
                                    ("Thursdayat <time-of-day>", -4.539030383483547),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.148468295917646),
                                    ("Aprilyear (latent)", -6.148468295917646),
                                    ("the <day-of-month> (ordinal)July", -6.148468295917646),
                                    ("the <day-of-month> (number)July", -6.148468295917646),
                                    ("monthminute", -6.148468295917646),
                                    ("<time-of-day> am|pmtomorrow", -5.7430031878094825),
                                    ("Thursdayhh:mm", -5.232177564043492),
                                    ("<day-of-month> (ordinal)Tuesday", -5.7430031878094825),
                                    ("minutemonth", -4.008402132421376),
                                    ("time-of-day (latent)Friday", -5.7430031878094825),
                                    ("minutehour", -6.148468295917646),
                                    ("part of daysat <time-of-day>", -5.049856007249537),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.797093038754169),
                                    ("Augustyear (latent)", -5.7430031878094825),
                                    ("week-endin|during <named-month>|year", -6.148468295917646),
                                    ("time-of-day (latent)Tuesday", -5.7430031878094825),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.148468295917646),
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.148468295917646),
                                    ("Sundayyear (latent)", -5.232177564043492),
                                    ("hourweek", -5.232177564043492),
                                    ("the <day-of-month> (ordinal)Monday", -5.455321115357702),
                                    ("Christmasat <time-of-day>", -6.148468295917646),
                                    ("from|since|after <time>year (latent)", -5.049856007249537),
                                    ("hhhmmon <day>", -5.232177564043492),
                                    ("yesterday<time-of-day> am|pm", -6.148468295917646),
                                    ("<day-of-month> (ordinal)July", -5.455321115357702),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.148468295917646),
                                    ("at <time-of-day>intersect", -5.232177564043492),
                                    ("hh:mmyear (latent)", -4.762173934797756),
                                    ("Holiyear (latent)", -6.148468295917646),
                                    ("until <time><time-of-day> am|pm", -6.148468295917646),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7430031878094825),
                                    ("dayminute", -3.3152549518614305),
                                    ("yyyy-mm-ddhh:mm", -5.7430031878094825),
                                    ("intersectfrom|since|after <time>", -5.7430031878094825),
                                    ("intersectSeptember", -4.276666119016055),
                                    ("minuteday", -2.9914678747675336),
                                    ("absorption of , after named dayintersect",
                                     -6.148468295917646),
                                    ("intersectyear (latent)", -6.148468295917646),
                                    ("Februaryin|during the <part-of-day>", -6.148468295917646),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.148468295917646),
                                    ("time-of-day (latent)July", -5.455321115357702),
                                    ("Saturdayyear (latent)", -6.148468295917646),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.148468295917646),
                                    ("<day-of-month> (ordinal)Monday", -4.895705327422279),
                                    ("at <time-of-day>on <day>", -5.232177564043492),
                                    ("absorption of , after named daySeptember",
                                     -4.895705327422279),
                                    ("Naraka Chaturdashiyear (latent)", -6.148468295917646),
                                    ("from|since|after <time>on <day>", -5.232177564043492),
                                    ("dayweek", -6.148468295917646),
                                    ("Easter Sundayyear (latent)", -5.7430031878094825),
                                    ("Thursday<time-of-day> am|pm", -4.895705327422279),
                                    ("weekyear", -5.7430031878094825),
                                    ("time-of-day (latent)Thursday", -5.7430031878094825),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.148468295917646),
                                    ("<day-of-month> (ordinal)April", -6.148468295917646),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.7430031878094825),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.455321115357702),
                                    ("Sundayfrom|since|after <time>", -6.148468295917646),
                                    ("absorption of , after named dayFebruary", -5.232177564043492),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.7430031878094825),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.148468295917646),
                                    ("tomorrowat <time-of-day>", -6.148468295917646),
                                    ("daynograin", -5.7430031878094825),
                                    ("Fridayin|during <named-month>|year", -6.148468295917646),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.7430031878094825),
                                    ("last <cycle> of <time>year (latent)", -5.7430031878094825),
                                    ("tomorrow<time-of-day> am|pm", -6.148468295917646),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.455321115357702),
                                    ("Diwaliyear (latent)", -5.7430031878094825),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.148468295917646),
                                    ("this <part-of-day>at <time-of-day>", -5.232177564043492),
                                    ("Fridayyear (latent)", -5.232177564043492),
                                    ("time-of-day (latent)April", -6.148468295917646),
                                    ("minuteyear", -3.951243718581427)],
                               n = 318}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
