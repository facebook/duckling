...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("at <time-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.2252466015109885, unseen = -5.327876168789581,
                               likelihoods =
                                 HashMap.fromList
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = 0.0, unseen = -2.995732273553991,
                               likelihoods =
                                 HashMap.fromList
                                   [("negative numbersinteger (numeric)", -1.3350010667323402),
                                    ("about|exactly <numeral>integer (numeric)",
                                     -2.2512917986064953),
                                    ("integer (numeric)integer (numeric)", -0.6418538861723948),
                                    ("fractional numberinteger (numeric)", -2.2512917986064953)],
                               n = 15}}),
       ("one twenty two",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.0986122886681098,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4929244134367504, unseen = -7.163946684342547,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.470025210286697),
                                    ("Karva Chauthyear (latent)", -6.470025210286697),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.470025210286697),
                                    ("Maha Shivaratriyear (latent)", -6.470025210286697),
                                    ("Ramadanyear (latent)", -5.217262241791329),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.083730849166806),
                                    ("Bhai Doojyear (latent)", -6.470025210286697),
                                    ("hourday", -4.455122189744433),
                                    ("dayhour", -3.4496003241423345),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.083730849166806),
                                    ("Martin Luther King's Dayyear (latent)", -6.0645601021785325),
                                    ("Shemini Atzeretyear (latent)", -6.470025210286697),
                                    ("daymonth", -4.455122189744433),
                                    ("monthday", -6.0645601021785325),
                                    ("monthyear", -4.678265741058643),
                                    ("Yom Ha'atzmautyear (latent)", -6.470025210286697),
                                    ("Orthodox Good Fridayyear (latent)", -6.0645601021785325),
                                    ("Vijayadashamiyear (latent)", -6.470025210286697),
                                    ("Thai Pongalyear (latent)", -5.776878029726752),
                                    ("Thiru Onamyear (latent)", -5.776878029726752),
                                    ("hhhmmabsorption of , after named day", -6.470025210286697),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.470025210286697),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.553734478412542),
                                    ("<day-of-month> (ordinal)Wednesday", -6.470025210286697),
                                    ("Krishna Janmashtamiyear (latent)", -6.0645601021785325),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.470025210286697),
                                    ("houryear", -5.553734478412542),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.470025210286697),
                                    ("Christmas<time-of-day> am|pm", -6.470025210286697),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.470025210286697),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.776878029726752),
                                    ("intersectin|during <named-month>|year", -6.470025210286697),
                                    ("<time-of-day> am|pmintersect", -5.217262241791329),
                                    ("Earth Houryear (latent)", -6.470025210286697),
                                    ("Ganesh Chaturthiyear (latent)", -6.470025210286697),
                                    ("Octoberyear (latent)", -4.965947813510423),
                                    ("intersect<time-of-day> am|pm", -6.470025210286697),
                                    ("Mattu Pongalyear (latent)", -6.470025210286697),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.470025210286697),
                                    ("Shavuotyear (latent)", -6.470025210286697),
                                    ("Parsi New Yearyear (latent)", -5.553734478412542),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.470025210286697),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.470025210286697),
                                    ("todayin|within|after <duration>", -6.470025210286697),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.0645601021785325),
                                    ("Marchyear (latent)", -6.470025210286697),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.0645601021785325),
                                    ("Sukkotyear (latent)", -6.0645601021785325),
                                    ("hhhmmintersect", -6.0645601021785325),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.0645601021785325),
                                    ("Clean Mondayyear (latent)", -6.0645601021785325),
                                    ("monthhour", -6.0645601021785325),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.776878029726752),
                                    ("todayat <time-of-day>", -6.470025210286697),
                                    ("Thursday<time> timezone", -4.072129937488326),
                                    ("tonight<time-of-day> am|pm", -6.470025210286697),
                                    ("time-of-day (latent)tonight", -6.0645601021785325),
                                    ("from|since|after <time>December", -6.470025210286697),
                                    ("<time-of-day> am|pmon <day>", -4.455122189744433),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.470025210286697),
                                    ("yyyy-mm-ddhh:mm:ss", -6.0645601021785325),
                                    ("dayday", -3.761975009184487),
                                    ("<time> <part-of-day>at <time-of-day>", -6.0645601021785325),
                                    ("tonightat <time-of-day>", -5.371412921618588),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.776878029726752),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.470025210286697),
                                    ("today<time-of-day> am|pm", -6.470025210286697),
                                    ("Februarythe <day-of-month> (ordinal)", -6.0645601021785325),
                                    ("at <time-of-day><time> <part-of-day>", -6.470025210286697),
                                    ("<day-of-month> (ordinal)intersect", -6.0645601021785325),
                                    ("hourhour", -3.499610744716996),
                                    ("Mahavir Jayantiyear (latent)", -6.0645601021785325),
                                    ("Navaratriin|during <named-month>|year", -6.470025210286697),
                                    ("Wednesdaythis|last|next <cycle>", -6.470025210286697),
                                    ("Lentyear (latent)", -6.470025210286697),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.598223033385106),
                                    ("Boghiyear (latent)", -6.470025210286697),
                                    ("dayyear", -1.9267304280166933),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.470025210286697),
                                    ("Thursdayfrom|since|after <time>", -6.0645601021785325),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.470025210286697),
                                    ("Thursdayat <time-of-day>", -5.776878029726752),
                                    ("Islamic New Yearyear (latent)", -6.0645601021785325),
                                    ("Laylat al-Qadryear (latent)", -5.553734478412542),
                                    ("part of days<time-of-day> am|pm", -6.470025210286697),
                                    ("Shrove Tuesdayyear (latent)", -6.470025210286697),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.776878029726752),
                                    ("hourminute", -6.0645601021785325),
                                    ("<time-of-day> am|pmtomorrow", -5.553734478412542),
                                    ("Yom Kippuryear (latent)", -6.470025210286697),
                                    ("<day-of-month> (ordinal)Tuesday", -6.0645601021785325),
                                    ("<part-of-day> of <time>year (latent)", -6.470025210286697),
                                    ("minutehour", -5.217262241791329),
                                    ("Kaanum Pongalyear (latent)", -6.0645601021785325),
                                    ("Maha Saptamiyear (latent)", -6.470025210286697),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.776878029726752),
                                    ("time-of-day (latent)tomorrow", -5.553734478412542),
                                    ("part of daysat <time-of-day>", -4.860587297852597),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.455122189744433),
                                    ("for <duration> from <time>December", -6.470025210286697),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.470025210286697),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.217262241791329),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.217262241791329),
                                    ("time-of-day (latent)this <part-of-day>", -6.470025210286697),
                                    ("Pentecostyear (latent)", -6.470025210286697),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.217262241791329),
                                    ("<day-of-month> (ordinal)February", -6.470025210286697),
                                    ("Eid al-Fitryear (latent)", -5.083730849166806),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.470025210286697),
                                    ("Mondayin|during the <part-of-day>", -6.470025210286697),
                                    ("Chhathin|during <named-month>|year", -6.470025210286697),
                                    ("Diwaliin|during <named-month>|year", -6.470025210286697),
                                    ("this <part-of-day><time-of-day> am|pm", -6.470025210286697),
                                    ("Vaisakhiin|during <named-month>|year", -6.470025210286697),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.217262241791329),
                                    ("Raksha Bandhanyear (latent)", -6.470025210286697),
                                    ("daysecond", -6.0645601021785325),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.0645601021785325),
                                    ("Ratha-Yatrayear (latent)", -6.470025210286697),
                                    ("Ashurayear (latent)", -6.470025210286697),
                                    ("Tuesdayin|during <named-month>|year", -6.470025210286697),
                                    ("Chinese New Yearyear (latent)", -6.470025210286697),
                                    ("tomorrowintersect", -6.470025210286697),
                                    ("Lag BaOmeryear (latent)", -6.470025210286697),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.470025210286697),
                                    ("Eid al-Adhayear (latent)", -4.329959046790426),
                                    ("intersectin|during the <part-of-day>", -6.470025210286697),
                                    ("Palm Sundayyear (latent)", -6.470025210286697),
                                    ("Christmasat <time-of-day>", -6.470025210286697),
                                    ("Passoveryear (latent)", -6.470025210286697),
                                    ("Lazarus Saturdayyear (latent)", -6.470025210286697),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.470025210286697),
                                    ("hhhmmon <day>", -5.553734478412542),
                                    ("Yom HaShoahyear (latent)", -6.0645601021785325),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.0645601021785325),
                                    ("Septemberyear (latent)", -6.0645601021785325),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.965947813510423),
                                    ("Halloweenyear (latent)", -6.470025210286697),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.470025210286697),
                                    ("at <time-of-day>intersect", -5.553734478412542),
                                    ("Rosh Hashanahyear (latent)", -5.776878029726752),
                                    ("Dhanterasyear (latent)", -6.470025210286697),
                                    ("Tu BiShvatyear (latent)", -6.470025210286697),
                                    ("<day-of-month> (ordinal)December", -5.776878029726752),
                                    ("Holiyear (latent)", -5.776878029726752),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.470025210286697),
                                    ("Holika Dahanyear (latent)", -5.776878029726752),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0645601021785325),
                                    ("dayminute", -3.1558392056141713),
                                    ("Mawlidyear (latent)", -6.470025210286697),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.0645601021785325),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.470025210286697),
                                    ("Jumu'atul-Widayear (latent)", -5.553734478412542),
                                    ("minuteday", -2.7205211343563263),
                                    ("absorption of , after named dayintersect",
                                     -5.776878029726752),
                                    ("intersectyear (latent)", -6.470025210286697),
                                    ("Orthodox Easter Sundayyear (latent)", -6.470025210286697),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.470025210286697),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.470025210286697),
                                    ("intersecthhhmm", -6.0645601021785325),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.470025210286697),
                                    ("Boss's Dayyear (latent)", -6.0645601021785325),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.470025210286697),
                                    ("Global Youth Service Dayyear (latent)", -6.470025210286697),
                                    ("Dhanterasin|during <named-month>|year", -6.470025210286697),
                                    ("tonight<time-of-day> o'clock", -6.470025210286697),
                                    ("Tisha B'Avyear (latent)", -6.470025210286697),
                                    ("Isra and Mi'rajyear (latent)", -5.553734478412542),
                                    ("at <time-of-day>on <day>", -4.860587297852597),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.0645601021785325),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.776878029726752),
                                    ("Christmasyear (latent)", -6.0645601021785325),
                                    ("Saturdayintersect", -6.470025210286697),
                                    ("Naraka Chaturdashiyear (latent)", -6.0645601021785325),
                                    ("Thai Pongalin|during <named-month>|year", -6.470025210286697),
                                    ("dayweek", -6.470025210286697),
                                    ("Easter Sundayyear (latent)", -5.776878029726752),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.0645601021785325),
                                    ("weekyear", -5.371412921618588),
                                    ("King's Dayyear (latent)", -4.965947813510423),
                                    ("hh:mmin|during the <part-of-day>", -5.553734478412542),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.0645601021785325),
                                    ("Hanukkahyear (latent)", -5.776878029726752),
                                    ("Rama Navamiyear (latent)", -6.470025210286697),
                                    ("February<time> <part-of-day>", -6.470025210286697),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.776878029726752),
                                    ("Great Lentyear (latent)", -6.470025210286697),
                                    ("tomorrowat <time-of-day>", -5.776878029726752),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.470025210286697),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.0645601021785325),
                                    ("Ugadiyear (latent)", -5.083730849166806),
                                    ("Vaisakhiyear (latent)", -5.776878029726752),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.776878029726752),
                                    ("last <cycle> of <time>year (latent)", -5.776878029726752),
                                    ("at <time-of-day>tomorrow", -6.0645601021785325),
                                    ("tomorrow<time-of-day> am|pm", -6.470025210286697),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.470025210286697),
                                    ("Diwaliyear (latent)", -6.470025210286697),
                                    ("between <time> and <time>on <day>", -6.0645601021785325),
                                    ("Black Fridayyear (latent)", -6.0645601021785325),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.470025210286697),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.470025210286697),
                                    ("Chhathyear (latent)", -6.0645601021785325),
                                    ("Vasant Panchamiyear (latent)", -6.470025210286697),
                                    ("Rabindra Jayantiyear (latent)", -5.217262241791329),
                                    ("this <part-of-day>at <time-of-day>", -5.217262241791329),
                                    ("St Patrick's Dayyear (latent)", -6.470025210286697),
                                    ("Thursday<time> (timezone)", -6.470025210286697),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.470025210286697),
                                    ("Pargat Diwasyear (latent)", -5.217262241791329),
                                    ("<datetime> - <datetime> (interval)July", -6.0645601021785325),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.776878029726752),
                                    ("Februaryintersect", -6.470025210286697),
                                    ("Simchat Torahyear (latent)", -6.470025210286697),
                                    ("minuteyear", -6.470025210286697)],
                               n = 496},
                   koData =
                     ClassData{prior = -0.9437581265747658, unseen = -6.837332814685591,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.639034699940848),
                                    ("hourday", -3.540422411272738),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.143112096717122),
                                    ("<day-of-month> (ordinal)August", -6.143112096717122),
                                    ("dayhour", -3.578162739255585),
                                    ("<time> timezoneyear (latent)", -5.449964916157176),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.226821364842967),
                                    ("Tuesdayfrom|since|after <time>", -5.449964916157176),
                                    ("daymonth", -3.4350618956149117),
                                    ("hourquarter", -5.226821364842967),
                                    ("monthyear", -4.890349128221754),
                                    ("<time-of-day> am|pmyear (latent)", -5.449964916157176),
                                    ("Thai Pongalyear (latent)", -5.449964916157176),
                                    ("intersecthh:mm", -6.143112096717122),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.737646988608957),
                                    ("<day-of-month> (ordinal)Wednesday", -6.143112096717122),
                                    ("houryear", -4.351352627489066),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.143112096717122),
                                    ("<day-of-month> (ordinal)October", -6.143112096717122),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.449964916157176),
                                    ("hournograin", -4.890349128221754),
                                    ("<time-of-day> am|pmintersect", -4.890349128221754),
                                    ("Octoberyear (latent)", -6.143112096717122),
                                    ("Good Fridayyear (latent)", -5.737646988608957),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.737646988608957),
                                    ("early morningat <time-of-day>", -6.143112096717122),
                                    ("until <time>on <day>", -5.449964916157176),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.143112096717122),
                                    ("time-of-day (latent)intersect", -5.449964916157176),
                                    ("todayin <number> (implicit minutes)", -6.143112096717122),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.449964916157176),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.143112096717122),
                                    ("hh:mmon <day>", -4.890349128221754),
                                    ("hhhmmintersect", -5.737646988608957),
                                    ("absorption of , after named dayJuly", -5.226821364842967),
                                    ("from|since|after <time>July", -5.737646988608957),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.226821364842967),
                                    ("Clean Mondayyear (latent)", -6.143112096717122),
                                    ("monthhour", -6.143112096717122),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.737646988608957),
                                    ("hourmonth", -4.003045933220851),
                                    ("todayat <time-of-day>", -6.143112096717122),
                                    ("hhhmmyear (latent)", -4.890349128221754),
                                    ("from|since|after <time>December", -6.143112096717122),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.143112096717122),
                                    ("<time-of-day> am|pmon <day>", -4.890349128221754),
                                    ("Mondayyear (latent)", -5.449964916157176),
                                    ("dayday", -4.128209076174857),
                                    ("on <day>September", -5.449964916157176),
                                    ("time-of-day (latent)September", -5.737646988608957),
                                    ("hourhour", -4.063670555037286),
                                    ("time-of-day (latent)on <day>", -4.639034699940848),
                                    ("Thursdaydd/mm", -6.143112096717122),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.737646988608957),
                                    ("dayyear", -3.122687210572759),
                                    ("New Year's Dayyear (latent)", -5.226821364842967),
                                    ("time-of-day (latent)Sunday", -5.737646988608957),
                                    ("Thursdayfrom|since|after <time>", -4.4383640044786965),
                                    ("Thursdayat <time-of-day>", -4.533674184283021),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.143112096717122),
                                    ("Aprilyear (latent)", -6.143112096717122),
                                    ("the <day-of-month> (ordinal)July", -6.143112096717122),
                                    ("the <day-of-month> (number)July", -6.143112096717122),
                                    ("monthminute", -6.143112096717122),
                                    ("<time-of-day> am|pmtomorrow", -5.737646988608957),
                                    ("Thursdayhh:mm", -5.226821364842967),
                                    ("<day-of-month> (ordinal)Tuesday", -5.737646988608957),
                                    ("minutemonth", -4.003045933220851),
                                    ("time-of-day (latent)Friday", -5.737646988608957),
                                    ("minutehour", -6.143112096717122),
                                    ("part of daysat <time-of-day>", -5.044499808049012),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.791736839553644),
                                    ("Augustyear (latent)", -5.737646988608957),
                                    ("week-endin|during <named-month>|year", -6.143112096717122),
                                    ("time-of-day (latent)Tuesday", -5.737646988608957),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.143112096717122),
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.143112096717122),
                                    ("Sundayyear (latent)", -5.226821364842967),
                                    ("hourweek", -5.226821364842967),
                                    ("the <day-of-month> (ordinal)Monday", -5.449964916157176),
                                    ("Christmasat <time-of-day>", -6.143112096717122),
                                    ("from|since|after <time>year (latent)", -5.044499808049012),
                                    ("hhhmmon <day>", -5.226821364842967),
                                    ("yesterday<time-of-day> am|pm", -6.143112096717122),
                                    ("<day-of-month> (ordinal)July", -5.449964916157176),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.143112096717122),
                                    ("at <time-of-day>intersect", -5.226821364842967),
                                    ("hh:mmyear (latent)", -4.756817735597231),
                                    ("Holiyear (latent)", -6.143112096717122),
                                    ("until <time><time-of-day> am|pm", -6.143112096717122),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.737646988608957),
                                    ("dayminute", -3.3098987526609056),
                                    ("yyyy-mm-ddhh:mm", -5.737646988608957),
                                    ("intersectfrom|since|after <time>", -5.737646988608957),
                                    ("intersectSeptember", -4.27130991981553),
                                    ("minuteday", -2.9861116755670083),
                                    ("absorption of , after named dayintersect",
                                     -6.143112096717122),
                                    ("intersectyear (latent)", -6.143112096717122),
                                    ("Februaryin|during the <part-of-day>", -6.143112096717122),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.143112096717122),
                                    ("time-of-day (latent)July", -5.449964916157176),
                                    ("Saturdayyear (latent)", -6.143112096717122),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.143112096717122),
                                    ("<day-of-month> (ordinal)Monday", -5.226821364842967),
                                    ("at <time-of-day>on <day>", -5.226821364842967),
                                    ("absorption of , after named daySeptember",
                                     -4.890349128221754),
                                    ("Naraka Chaturdashiyear (latent)", -6.143112096717122),
                                    ("from|since|after <time>on <day>", -5.226821364842967),
                                    ("dayweek", -6.143112096717122),
                                    ("Easter Sundayyear (latent)", -5.737646988608957),
                                    ("Thursday<time-of-day> am|pm", -4.890349128221754),
                                    ("weekyear", -5.737646988608957),
                                    ("time-of-day (latent)Thursday", -5.737646988608957),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.143112096717122),
                                    ("<day-of-month> (ordinal)April", -6.143112096717122),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.737646988608957),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.449964916157176),
                                    ("Sundayfrom|since|after <time>", -6.143112096717122),
                                    ("absorption of , after named dayFebruary", -5.226821364842967),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.737646988608957),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.143112096717122),
                                    ("tomorrowat <time-of-day>", -6.143112096717122),
                                    ("daynograin", -5.737646988608957),
                                    ("Fridayin|during <named-month>|year", -6.143112096717122),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.737646988608957),
                                    ("last <cycle> of <time>year (latent)", -5.737646988608957),
                                    ("tomorrow<time-of-day> am|pm", -6.143112096717122),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.449964916157176),
                                    ("Diwaliyear (latent)", -5.737646988608957),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.143112096717122),
                                    ("this <part-of-day>at <time-of-day>", -5.226821364842967),
                                    ("Fridayyear (latent)", -5.226821364842967),
                                    ("time-of-day (latent)April", -6.143112096717122),
                                    ("minuteyear", -3.945887519380902)],
                               n = 316}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6931471805599453, unseen = -4.882801922586371,
                               likelihoods =
                                 HashMap.fromList
                   ...
                   koData =
                     ClassData{prior = -0.6931471805599453, unseen = -4.882801922586371,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.16566712188881744),
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.25524679669862704, unseen = -5.71042701737487,
                               likelihoods =
                                 HashMap.fromList
