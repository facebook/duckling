...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7093200398055463, unseen = -5.225746673713201,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 184},
                   koData =
                     ClassData{prior = -0.6772317252540457,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5026288565618121, unseen = -6.269096283706261,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.321290399486049),
                                    ("hourday", -3.8693052757429918),
                                    ("dayhour", -2.740840023925201),
                                    ("daymonth", -4.880906187421472),
                                    ("monthday", -5.168588259873252),
                                    ("monthyear", -3.9646154555473165),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.574053367981417),
                                    ("Easter Sundayyear", -4.880906187421472),
                                    ("Christmasyear", -5.574053367981417),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.574053367981417),
                                    ("houryear", -5.574053367981417),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.574053367981417),
                                    ("Marchyear", -5.574053367981417),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.168588259873252),
                                    ("intersect<time-of-day> am|pm", -5.574053367981417),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.574053367981417),
                                    ("monthhour", -5.168588259873252),
                                    ("last <day-of-week> of <time>year", -5.574053367981417),
                                    ("todayat <time-of-day>", -5.574053367981417),
                                    ("Thursday<time> timezone", -3.8693052757429918),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.574053367981417),
                                    ("dayday", -3.5591503474391524),
                                    ("<time> <part-of-day>at <time-of-day>", -5.574053367981417),
                                    ("Tuesdayin <named-month>", -5.574053367981417),
                                    ("tonightat <time-of-day>", -5.574053367981417),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.880906187421472),
                                    ("today<time-of-day> am|pm", -5.574053367981417),
                                    ("Februarythe <day-of-month> (ordinal)", -5.168588259873252),
                                    ("at <time-of-day><time> <part-of-day>", -5.574053367981417),
                                    ("hourhour", -4.321290399486049),
                                    ("<time-of-day> am|pmon <date>", -3.5591503474391524),
                                    ("Wednesdaythis|last|next <cycle>", -5.574053367981417),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.069975971205143),
                                    ("dayyear", -3.2714682749873716),
                                    ("last weekend of <named-month>year", -5.574053367981417),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.574053367981417),
                                    ("Thursdayat <time-of-day>", -5.168588259873252),
                                    ("<time-of-day> am|pmtomorrow", -4.880906187421472),
                                    ("minutehour", -4.657762636107262),
                                    ("Mother's Dayyear", -5.574053367981417),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.168588259873252),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.8693052757429918),
                                    ("for <duration> from <time>December", -5.574053367981417),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.574053367981417),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.657762636107262),
                                    ("Mondayin|during the <part-of-day>", -5.574053367981417),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.168588259873252),
                                    ("intersectin|during the <part-of-day>", -5.574053367981417),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.168588259873252),
                                    ("<ordinal> <cycle> of <time>year", -5.574053367981417),
                                    ("minuteday", -2.1083174651816905),
                                    ("absorption of , after named dayintersect",
                                     -5.574053367981417),
                                    ("Octoberyear", -4.321290399486049),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.574053367981417),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.574053367981417),
                                    ("year<time-of-day> am|pm", -5.574053367981417),
                                    ("Septemberyear", -5.168588259873252),
                                    ("at <time-of-day>on <date>", -4.475441079313307),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.880906187421472),
                                    ("Halloweenyear", -5.574053367981417),
                                    ("dayweek", -5.574053367981417),
                                    ("Thursday<time-of-day> am|pm", -5.574053367981417),
                                    ("weekyear", -5.168588259873252),
                                    ("hh:mmin|during the <part-of-day>", -4.880906187421472),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.168588259873252),
                                    ("February<time> <part-of-day>", -5.574053367981417),
                                    ("Martin Luther King's Dayyear", -5.168588259873252),
                                    ("tomorrowat <time-of-day>", -4.880906187421472),
                                    ("between <time> and <time>on <date>", -4.880906187421472),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.880906187421472),
                                    ("at <time-of-day>tomorrow", -5.168588259873252),
                                    ("tomorrow<time-of-day> am|pm", -5.574053367981417),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.574053367981417),
                                    ("Labor Dayyear", -5.574053367981417),
                                    ("Februaryintersect", -5.574053367981417),
                                    ("last <cycle> of <time>year", -4.880906187421472),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.574053367981417),
                                    ("yearminute", -5.574053367981417),
                                    ("Black Fridayyear", -5.168588259873252)],
                               n = 196},
                   koData =
                     ClassData{prior = -0.9287132518727123, unseen = -5.971261839790462,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.27556037942542),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.27556037942542),
                                    ("hourday", -5.27556037942542),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.27556037942542),
                                    ("dayhour", -3.0242685808189256),
                                    ("daymonth", -3.1961188377455843),
                                    ("monthday", -4.870095271317256),
                                    ("monthyear", -4.582413198865475),
                                    ("intersecthh:mm", -5.27556037942542),
                                    ("Easter Sundayyear", -5.27556037942542),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.27556037942542),
                                    ("houryear", -5.27556037942542),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.27556037942542),
                                    ("until <time-of-day><time-of-day> am|pm", -5.27556037942542),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.582413198865475),
                                    ("<time-of-day> am|pmintersect", -4.022797410930052),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.359269647551265),
                                    ("from|since|after <time-of-day>on <date>", -4.359269647551265),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.27556037942542),
                                    ("absorption of , after named dayJuly", -4.870095271317256),
                                    ("monthhour", -5.27556037942542),
                                    ("hourmonth", -4.582413198865475),
                                    ("todayat <time-of-day>", -5.27556037942542),
                                    ("from|since|after <time-of-day>July", -5.27556037942542),
                                    ("dayday", -4.870095271317256),
                                    ("<time-of-day> am|pmon <date>", -4.022797410930052),
                                    ("Thursdaydd/mm", -5.27556037942542),
                                    ("dayyear", -3.66612246699132),
                                    ("Sundayyear", -4.870095271317256),
                                    ("Thursdayat <time-of-day>", -4.022797410930052),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.27556037942542),
                                    ("monthminute", -5.27556037942542),
                                    ("<time-of-day> am|pmtomorrow", -5.27556037942542),
                                    ("Thursdayhh:mm", -4.359269647551265),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.27556037942542),
                                    ("Fridayyear", -4.870095271317256),
                                    ("minutemonth", -3.4838009101973655),
                                    ("Sundayfrom|since|after <time-of-day>", -5.27556037942542),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.870095271317256),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.870095271317256),
                                    ("Aprilyear", -5.27556037942542),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.27556037942542),
                                    ("<duration> after|before|from <time>December",
                                     -5.27556037942542),
                                    ("yesterday<time-of-day> am|pm", -5.27556037942542),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.27556037942542),
                                    ("until <time-of-day>on <date>", -4.582413198865475),
                                    ("at <time-of-day>intersect", -4.870095271317256),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.27556037942542),
                                    ("dayminute", -2.79065372963742),
                                    ("intersectSeptember", -3.7714829826491463),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.27556037942542),
                                    ("minuteday", -2.3577896473411415),
                                    ("absorption of , after named dayintersect", -5.27556037942542),
                                    ("Februaryin|during the <part-of-day>", -5.27556037942542),
                                    ("week-endin <named-month>", -5.27556037942542),
                                    ("Octoberyear", -5.27556037942542),
                                    ("from|since|after <time-of-day>year", -5.27556037942542),
                                    ("yearhh:mm", -5.27556037942542),
                                    ("hh:mmon <date>", -3.7714829826491463),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.27556037942542),
                                    ("absorption of , after named daySeptember",
                                     -4.359269647551265),
                                    ("on <date>September", -4.870095271317256),
                                    ("at <time-of-day>on <date>", -4.870095271317256),
                                    ("dayweek", -5.27556037942542),
                                    ("Thursday<time-of-day> am|pm", -4.870095271317256),
                                    ("absorption of , after named dayFebruary", -4.359269647551265),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.27556037942542),
                                    ("tomorrowat <time-of-day>", -5.27556037942542),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.27556037942542),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.66612246699132),
                                    ("tomorrow<time-of-day> am|pm", -5.27556037942542),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.27556037942542),
                                    ("yearminute", -5.27556037942542)],
                               n = 128}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year",
        Classifier{okData =
                     ClassData{prior = -0.25131442828090605,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.10821358464023272),
                                    ("intersect 2 numbers", -2.9704144655697013)],
                               n = 35},
                   koData =
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.48835276791393206,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                    ...
                                    ("Black Fridaythis|last|next <cycle>", -4.448516375942715),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.448516375942715),
                               ...
                               n = 54},
                   koData =
                     ClassData{prior = -0.9509762898620451, unseen = -4.882801922586371,
                               likelihoods =
                                 HashMap.fromList
        ...
        Classifier{okData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Martin Luther King's Day", -2.1972245773362196),
                                    ("Mother's Day", -2.1972245773362196),
                                    ("day", -1.2809338454620642), ("Sunday", -2.1972245773362196),
                                    ("hour", -2.1972245773362196), ("Tuesday", -2.1972245773362196),
                   ...
                   koData =
                     ClassData{prior = -0.5389965007326869,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Monday", -2.3978952727983707), ("day", -1.9924301646902063),
                                    ("Sunday", -2.3978952727983707), ("hour", -1.2992829841302609),
