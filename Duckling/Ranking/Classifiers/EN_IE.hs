...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4852522247259964, unseen = -6.699500340161678,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.005120873555468),
                                    ("Ramadanyear (latent)", -6.005120873555468),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.7523579050601),
                                    ("Bhai Doojyear (latent)", -6.005120873555468),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.7523579050601),
                                    ("hourday", -4.3003727813170425),
                                    ("dayhour", -3.2017604926489325),
                                    ("Martin Luther King's Dayyear (latent)", -5.599655765447303),
                                    ("Shemini Atzeretyear (latent)", -6.005120873555468),
                                    ("daymonth", -5.088830141681313),
                                    ("monthday", -5.599655765447303),
                                    ("monthyear", -4.213361404327412),
                                    ("Yom Ha'atzmautyear (latent)", -6.005120873555468),
                                    ("Vijayadashamiyear (latent)", -6.005120873555468),
                                    ("Thai Pongalyear (latent)", -5.311973692995522),
                                    ("Thiru Onamyear (latent)", -5.311973692995522),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.005120873555468),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.005120873555468),
                                    ("houryear", -5.311973692995522),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.005120873555468),
                                    ("Christmas<time-of-day> am|pm", -6.005120873555468),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.005120873555468),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.311973692995522),
                                    ("<time-of-day> am|pmintersect", -4.7523579050601),
                                    ("Earth Houryear (latent)", -6.005120873555468),
                                    ("Octoberyear (latent)", -4.501043476779194),
                                    ("intersect<time-of-day> am|pm", -6.005120873555468),
                                    ("Mattu Pongalyear (latent)", -6.005120873555468),
                                    ("Shavuotyear (latent)", -6.005120873555468),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.005120873555468),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.005120873555468),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.599655765447303),
                                    ("Marchyear (latent)", -6.005120873555468),
                                    ("Sukkotyear (latent)", -5.599655765447303),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.005120873555468),
                                    ("Clean Mondayyear (latent)", -5.599655765447303),
                                    ("monthhour", -5.599655765447303),
                                    ("todayat <time-of-day>", -6.005120873555468),
                                    ("Thursday<time> timezone", -4.3003727813170425),
                                    ("from|since|after <time>December", -6.005120873555468),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.005120873555468),
                                    ("dayday", -3.9902178530132026),
                                    ("<time> <part-of-day>at <time-of-day>", -6.005120873555468),
                                    ("tonightat <time-of-day>", -6.005120873555468),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.311973692995522),
                                    ("today<time-of-day> am|pm", -6.005120873555468),
                                    ("Februarythe <day-of-month> (ordinal)", -5.599655765447303),
                                    ("at <time-of-day><time> <part-of-day>", -6.005120873555468),
                                    ("hourhour", -4.7523579050601),
                                    ("<time-of-day> am|pmon <date>", -3.9902178530132026),
                                    ("Navaratriin|during <named-month>|year", -6.005120873555468),
                                    ("Wednesdaythis|last|next <cycle>", -6.005120873555468),
                                    ("Lentyear (latent)", -6.005120873555468),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.501043476779194),
                                    ("Boghiyear (latent)", -6.005120873555468),
                                    ("dayyear", -2.025439219653507),
                                    ("Thursdayfrom|since|after <time>", -5.599655765447303),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.005120873555468),
                                    ("Thursdayat <time-of-day>", -5.599655765447303),
                                    ("Islamic New Yearyear (latent)", -5.599655765447303),
                                    ("Laylat al-Qadryear (latent)", -5.088830141681313),
                                    ("Shrove Tuesdayyear (latent)", -6.005120873555468),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.311973692995522),
                                    ("<time-of-day> am|pmtomorrow", -5.311973692995522),
                                    ("Yom Kippuryear (latent)", -6.005120873555468),
                                    ("<part-of-day> of <time>year (latent)", -6.005120873555468),
                                    ("minutehour", -5.088830141681313),
                                    ("Kaanum Pongalyear (latent)", -5.599655765447303),
                                    ("Maha Saptamiyear (latent)", -6.005120873555468),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.599655765447303),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.3003727813170425),
                                    ("for <duration> from <time>December", -6.005120873555468),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.005120873555468),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.088830141681313),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.599655765447303),
                                    ("Pentecostyear (latent)", -6.005120873555468),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.088830141681313),
                                    ("Eid al-Fitryear (latent)", -6.005120873555468),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.005120873555468),
                                    ("Mondayin|during the <part-of-day>", -6.005120873555468),
                                    ("Chhathin|during <named-month>|year", -6.005120873555468),
                                    ("Diwaliin|during <named-month>|year", -6.005120873555468),
                                    ("Raksha Bandhanyear (latent)", -6.005120873555468),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.599655765447303),
                                    ("Ashurayear (latent)", -6.005120873555468),
                                    ("Tuesdayin|during <named-month>|year", -6.005120873555468),
                                    ("Chinese New Yearyear (latent)", -6.005120873555468),
                                    ("Lag BaOmeryear (latent)", -6.005120873555468),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.005120873555468),
                                    ("Eid al-Adhayear (latent)", -5.088830141681313),
                                    ("intersectin|during the <part-of-day>", -6.005120873555468),
                                    ("Palm Sundayyear (latent)", -6.005120873555468),
                                    ("Christmasat <time-of-day>", -6.005120873555468),
                                    ("Passoveryear (latent)", -6.005120873555468),
                                    ("Lazarus Saturdayyear (latent)", -6.005120873555468),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.005120873555468),
                                    ("Yom HaShoahyear (latent)", -5.599655765447303),
                                    ...
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.7523579050601),
                                    ("Halloweenyear (latent)", -6.005120873555468),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.005120873555468),
                                    ("at <time-of-day>intersect", -5.599655765447303),
                                    ("Rosh Hashanahyear (latent)", -5.311973692995522),
                                    ("Dhanterasyear (latent)", -6.005120873555468),
                                    ("Tu BiShvatyear (latent)", -6.005120873555468),
                                    ("Holiyear (latent)", -5.311973692995522),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.005120873555468),
                                    ("Holika Dahanyear (latent)", -5.311973692995522),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.005120873555468),
                                    ("dayminute", -3.440171516093931),
                                    ("Mawlidyear (latent)", -6.005120873555468),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.599655765447303),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.005120873555468),
                                    ("Jumu'atul-Widayear (latent)", -5.088830141681313),
                                    ("minuteday", -2.3675347138290816),
                                    ("absorption of , after named dayintersect",
                                     -6.005120873555468),
                                    ("Orthodox Easter Sundayyear (latent)", -6.005120873555468),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.005120873555468),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.005120873555468),
                                    ("Boss's Dayyear (latent)", -5.599655765447303),
                                    ("Global Youth Service Dayyear (latent)", -6.005120873555468),
                                    ("Dhanterasin|during <named-month>|year", -6.005120873555468),
                                    ("Tisha B'Avyear (latent)", -6.005120873555468),
                                    ("Isra and Mi'rajyear (latent)", -5.088830141681313),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.005120873555468),
                                    ("Christmasyear (latent)", -5.599655765447303),
                                    ("Naraka Chaturdashiyear (latent)", -5.599655765447303),
                                    ("at <time-of-day>on <date>", -4.906508584887358),
                                    ("Thai Pongalin|during <named-month>|year", -6.005120873555468),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.395682961121367),
                                    ("dayweek", -6.005120873555468),
                                    ("Easter Sundayyear (latent)", -5.311973692995522),
                                    ("weekyear", -4.906508584887358),
                                    ("hh:mmin|during the <part-of-day>", -5.311973692995522),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.599655765447303),
                                    ("Hanukkahyear (latent)", -5.311973692995522),
                                    ("February<time> <part-of-day>", -6.005120873555468),
                                    ("Great Lentyear (latent)", -6.005120873555468),
                                    ("tomorrowat <time-of-day>", -5.311973692995522),
                                    ("between <time> and <time>on <date>", -4.395682961121367),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.005120873555468),
                                    ("last <cycle> of <time>year (latent)", -5.311973692995522),
                                    ("at <time-of-day>tomorrow", -5.599655765447303),
                                    ("tomorrow<time-of-day> am|pm", -6.005120873555468),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.005120873555468),
                                    ("Diwaliyear (latent)", -6.005120873555468),
                                    ("Black Fridayyear (latent)", -5.599655765447303),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.005120873555468),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.005120873555468),
                                    ("Chhathyear (latent)", -5.599655765447303),
                                    ("Vasant Panchamiyear (latent)", -6.005120873555468),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.005120873555468),
                                    ("Februaryintersect", -6.005120873555468),
                                    ("Simchat Torahyear (latent)", -6.005120873555468),
                                    ("minuteyear", -6.005120873555468)],
                               n = 301},
                   koData =
                     ClassData{prior = -0.9559205266449229, unseen = -6.373319789577012,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.762173934797756),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.272999558563747),
                                    ("week-endin|during <named-month>|year", -5.678464666671911),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.678464666671911),
                                    ("Sundayyear (latent)", -4.762173934797756),
