...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4625004677425803, unseen = -6.692083742506628,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -5.997695096858618),
                                    ("Ramadanyear (latent)", -5.997695096858618),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.74493212836325),
                                    ("Bhai Doojyear (latent)", -5.997695096858618),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.74493212836325),
                                    ("hourday", -4.292947004620193),
                                    ("dayhour", -3.194334715952083),
                                    ("Martin Luther King's Dayyear (latent)", -5.592229988750454),
                                    ("Shemini Atzeretyear (latent)", -5.997695096858618),
                                    ("daymonth", -5.081404364984463),
                                    ("monthday", -5.592229988750454),
                                    ("monthyear", -4.205935627630563),
                                    ("Yom Ha'atzmautyear (latent)", -5.997695096858618),
                                    ("Vijayadashamiyear (latent)", -5.997695096858618),
                                    ("Thai Pongalyear (latent)", -5.304547916298673),
                                    ("Thiru Onamyear (latent)", -5.304547916298673),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.997695096858618),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.997695096858618),
                                    ("houryear", -5.304547916298673),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.997695096858618),
                                    ("Christmas<time-of-day> am|pm", -5.997695096858618),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.997695096858618),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.304547916298673),
                                    ("<time-of-day> am|pmintersect", -4.74493212836325),
                                    ("Earth Houryear (latent)", -5.997695096858618),
                                    ("Octoberyear (latent)", -4.493617700082344),
                                    ("intersect<time-of-day> am|pm", -5.997695096858618),
                                    ("Mattu Pongalyear (latent)", -5.997695096858618),
                                    ("Shavuotyear (latent)", -5.997695096858618),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.997695096858618),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.997695096858618),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.592229988750454),
                                    ("Marchyear (latent)", -5.997695096858618),
                                    ("Sukkotyear (latent)", -5.592229988750454),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.997695096858618),
                                    ("Clean Mondayyear (latent)", -5.592229988750454),
                                    ("monthhour", -5.592229988750454),
                                    ("todayat <time-of-day>", -5.997695096858618),
                                    ("Thursday<time> timezone", -4.292947004620193),
                                    ("from|since|after <time>December", -5.997695096858618),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.997695096858618),
                                    ("dayday", -3.982792076316353),
                                    ("<time> <part-of-day>at <time-of-day>", -5.997695096858618),
                                    ("tonightat <time-of-day>", -5.997695096858618),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.304547916298673),
                                    ("today<time-of-day> am|pm", -5.997695096858618),
                                    ("Februarythe <day-of-month> (ordinal)", -5.592229988750454),
                                    ("at <time-of-day><time> <part-of-day>", -5.997695096858618),
                                    ("hourhour", -4.74493212836325),
                                    ("<time-of-day> am|pmon <date>", -3.982792076316353),
                                    ("Navaratriin|during <named-month>|year", -5.997695096858618),
                                    ("Wednesdaythis|last|next <cycle>", -5.997695096858618),
                                    ("Lentyear (latent)", -5.997695096858618),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.493617700082344),
                                    ("Boghiyear (latent)", -5.997695096858618),
                                    ("dayyear", -2.0180134429566574),
                                    ("Thursdayfrom|since|after <time>", -5.592229988750454),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.997695096858618),
                                    ("Thursdayat <time-of-day>", -5.592229988750454),
                                    ("Islamic New Yearyear (latent)", -5.592229988750454),
                                    ("Laylat al-Qadryear (latent)", -5.081404364984463),
                                    ("Shrove Tuesdayyear (latent)", -5.997695096858618),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.304547916298673),
                                    ("<time-of-day> am|pmtomorrow", -5.304547916298673),
                                    ("Yom Kippuryear (latent)", -5.997695096858618),
                                    ("<part-of-day> of <time>year (latent)", -5.997695096858618),
                                    ("minutehour", -5.081404364984463),
                                    ("Kaanum Pongalyear (latent)", -5.592229988750454),
                                    ("Maha Saptamiyear (latent)", -5.997695096858618),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.592229988750454),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.292947004620193),
                                    ("for <duration> from <time>December", -5.997695096858618),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.997695096858618),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.081404364984463),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.592229988750454),
                                    ("Pentecostyear (latent)", -5.997695096858618),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.081404364984463),
                                    ("Eid al-Fitryear (latent)", -5.997695096858618),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -5.997695096858618),
                                    ("Mondayin|during the <part-of-day>", -5.997695096858618),
                                    ("Chhathin|during <named-month>|year", -5.997695096858618),
                                    ("Diwaliin|during <named-month>|year", -5.997695096858618),
                                    ("Raksha Bandhanyear (latent)", -5.997695096858618),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.592229988750454),
                                    ("Ashurayear (latent)", -5.997695096858618),
                                    ("Tuesdayin|during <named-month>|year", -5.997695096858618),
                                    ("Chinese New Yearyear (latent)", -5.997695096858618),
                                    ("Lag BaOmeryear (latent)", -5.997695096858618),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.997695096858618),
                                    ("Eid al-Adhayear (latent)", -5.081404364984463),
                                    ("intersectin|during the <part-of-day>", -5.997695096858618),
                                    ("Palm Sundayyear (latent)", -5.997695096858618),
                                    ("Christmasat <time-of-day>", -5.997695096858618),
                                    ("Passoveryear (latent)", -5.997695096858618),
                                    ("Lazarus Saturdayyear (latent)", -5.997695096858618),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.997695096858618),
                                    ("Yom HaShoahyear (latent)", -5.592229988750454),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.592229988750454),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.997695096858618),
                                    ("Septemberyear (latent)", -5.592229988750454),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.74493212836325),
                                    ("Halloweenyear (latent)", -5.997695096858618),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -5.997695096858618),
                                    ("at <time-of-day>intersect", -5.592229988750454),
                                    ("Rosh Hashanahyear (latent)", -5.304547916298673),
                                    ("Dhanterasyear (latent)", -5.997695096858618),
                                    ("Tu BiShvatyear (latent)", -5.997695096858618),
                                    ("Holiyear (latent)", -5.304547916298673),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.997695096858618),
                                    ("Holika Dahanyear (latent)", -5.304547916298673),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.997695096858618),
                                    ("dayminute", -3.4327457393970815),
                                    ("Mawlidyear (latent)", -5.997695096858618),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.592229988750454),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.997695096858618),
                                    ("Jumu'atul-Widayear (latent)", -5.081404364984463),
                                    ("minuteday", -2.360108937132232),
                                    ("absorption of , after named dayintersect",
                                     -5.997695096858618),
                                    ("Orthodox Easter Sundayyear (latent)", -5.997695096858618),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.997695096858618),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.997695096858618),
                                    ("Boss's Dayyear (latent)", -5.592229988750454),
                                    ("Global Youth Service Dayyear (latent)", -5.997695096858618),
                                    ("Dhanterasin|during <named-month>|year", -5.997695096858618),
                                    ("Tisha B'Avyear (latent)", -5.997695096858618),
                                    ("Isra and Mi'rajyear (latent)", -5.081404364984463),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.997695096858618),
                                    ("Christmasyear (latent)", -5.592229988750454),
                                    ("Naraka Chaturdashiyear (latent)", -5.592229988750454),
                                    ("at <time-of-day>on <date>", -4.899082808190508),
                                    ("Thai Pongalin|during <named-month>|year", -5.997695096858618),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.388257184424518),
                                    ("dayweek", -5.997695096858618),
                                    ("Easter Sundayyear (latent)", -5.304547916298673),
                                    ("weekyear", -4.899082808190508),
                                    ("hh:mmin|during the <part-of-day>", -5.304547916298673),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.592229988750454),
                                    ("Hanukkahyear (latent)", -5.304547916298673),
                                    ("February<time> <part-of-day>", -5.997695096858618),
                                    ("Great Lentyear (latent)", -5.997695096858618),
                                    ("tomorrowat <time-of-day>", -5.304547916298673),
                                    ("between <time> and <time>on <date>", -4.388257184424518),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.997695096858618),
                                    ("last <cycle> of <time>year (latent)", -5.304547916298673),
                                    ("at <time-of-day>tomorrow", -5.592229988750454),
                                    ("tomorrow<time-of-day> am|pm", -5.997695096858618),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.997695096858618),
                                    ("Diwaliyear (latent)", -5.997695096858618),
                                    ("Black Fridayyear (latent)", -5.592229988750454),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -5.997695096858618),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.997695096858618),
                                    ("Chhathyear (latent)", -5.592229988750454),
                                    ("Vasant Panchamiyear (latent)", -5.997695096858618),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.997695096858618),
                                    ("Februaryintersect", -5.997695096858618),
                                    ("Simchat Torahyear (latent)", -5.997695096858618),
                                    ("minuteyear", -5.997695096858618)],
                               n = 301},
                   koData =
                     ClassData{prior = -0.9934609999176268, unseen = -6.324358962381311,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.713127327493184),
                                    ("hourday", -4.713127327493184),
                                    ("dayhour", -3.187071023998134),
                                    ("Tuesdayfrom|since|after <time>", -5.629418059367339),
                                    ("daymonth", -3.614515038825074),
                                    ("monthyear", -4.376655090871971),
                                    ("<time-of-day> am|pmyear (latent)", -5.223952951259174),
                                    ("Thai Pongalyear (latent)", -4.9362708788073935),
                                    ("intersecthh:mm", -5.629418059367339),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.629418059367339),
                                    ("houryear", -4.713127327493184),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.629418059367339),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.9362708788073935),
                                    ("<time-of-day> am|pmintersect", -4.376655090871971),
                                    ("until <time>on <date>", -4.9362708788073935),
                                    ("Octoberyear (latent)", -5.629418059367339),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -4.9362708788073935),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.629418059367339),
                                    ("absorption of , after named dayJuly", -5.223952951259174),
                                    ("from|since|after <time>July", -5.629418059367339),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.713127327493184),
                                    ("Clean Mondayyear (latent)", -5.629418059367339),
                                    ("monthhour", -5.629418059367339),
                                    ("hourmonth", -4.713127327493184),
                                    ("todayat <time-of-day>", -5.629418059367339),
                                    ("from|since|after <time>December", -5.629418059367339),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.629418059367339),
                                    ("Mondayyear (latent)", -4.9362708788073935),
                                    ("dayday", -5.223952951259174),
                                    ("<time-of-day> am|pmon <date>", -4.376655090871971),
                                    ("Thursdaydd/mm", -5.629418059367339),
                                    ("dayyear", -2.7672171784378703),
                                    ("New Year's Dayyear (latent)", -5.223952951259174),
                                    ("Thursdayfrom|since|after <time>", -3.9246699671289136),
                                    ("Thursdayat <time-of-day>", -4.376655090871971),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.629418059367339),
                                    ("Aprilyear (latent)", -5.629418059367339),
                                    ("monthminute", -5.629418059367339),
                                    ("<time-of-day> am|pmtomorrow", -5.629418059367339),
                                    ("Thursdayhh:mm", -4.713127327493184),
                                    ("minutemonth", -3.8376585901392835),
                                    ("Augustyear (latent)", -5.223952951259174),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.223952951259174),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.223952951259174),
                                    ("week-endin|during <named-month>|year", -5.629418059367339),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.629418059367339),
                                    ("Sundayyear (latent)", -4.713127327493184),
                                    ("Christmasat <time-of-day>", -5.629418059367339),
                                    ("from|since|after <time>year (latent)", -4.530805770699229),
                                    ("<duration> after|before|from <time>December",
                                     -5.629418059367339),
                                    ("yesterday<time-of-day> am|pm", -5.629418059367339),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.629418059367339),
                                    ("at <time-of-day>intersect", -5.223952951259174),
                                    ("hh:mmyear (latent)", -4.530805770699229),
                                    ("Holiyear (latent)", -5.629418059367339),
                                    ("until <time><time-of-day> am|pm", -5.629418059367339),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.629418059367339),
                                    ("dayminute", -3.1445114095793385),
                                    ("intersectSeptember", -4.125340662591065),
                                    ("minuteday", -2.5613651242337214),
                                    ("absorption of , after named dayintersect",
                                     -5.629418059367339),
                                    ("Februaryin|during the <part-of-day>", -5.629418059367339),
                                    ("hh:mmon <date>", -3.614515038825074),
                                    ("Saturdayyear (latent)", -5.629418059367339),
                                    ("from|since|after <time>on <date>", -4.713127327493184),
                                    ("absorption of , after named daySeptember",
                                     -4.713127327493184),
                                    ("Naraka Chaturdashiyear (latent)", -5.629418059367339),
                                    ("on <date>September", -5.223952951259174),
                                    ("at <time-of-day>on <date>", -5.223952951259174),
                                    ("dayweek", -5.629418059367339),
                                    ("Easter Sundayyear (latent)", -5.223952951259174),
                                    ("Thursday<time-of-day> am|pm", -4.9362708788073935),
                                    ("weekyear", -5.223952951259174),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.629418059367339),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -4.9362708788073935),
                                    ("Sundayfrom|since|after <time>", -5.629418059367339),
                                    ("absorption of , after named dayFebruary", -4.713127327493184),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.629418059367339),
                                    ("tomorrowat <time-of-day>", -5.629418059367339),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.629418059367339),
                                    ("last <cycle> of <time>year (latent)", -5.223952951259174),
                                    ("tomorrow<time-of-day> am|pm", -5.629418059367339),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.9362708788073935),
                                    ("Diwaliyear (latent)", -5.223952951259174),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.629418059367339),
                                    ("Fridayyear (latent)", -5.223952951259174),
                                    ("minuteyear", -4.376655090871971)],
                               n = 177}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.5577092096648412, unseen = -4.356708826689592,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 75},
                   koData =
                     ClassData{prior = -0.8498456324660023, unseen = -4.07753744390572,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -5.310982531394841e-2),
                                    ("integer (0..19)", -2.9618307218783095)],
                               n = 56}}),
       ("beginning of year",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.791759469228055,
