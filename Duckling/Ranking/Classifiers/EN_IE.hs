...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5957908837279227, unseen = -5.768320995793772,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 318},
                   koData =
                     ClassData{prior = -0.8010142048085619, unseen = -5.564520407322694,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45311730614534396, unseen = -6.75343791859778,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.059123195581797),
                                    ...
                                    ("Thursday<time> timezone", -4.113213046526484),
                                    ("from|since|after <time>December", -6.059123195581797),
                                    ("<time-of-day> am|pmon <day>", -4.044220175039532),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.059123195581797),
                                    ("yyyy-mm-ddhh:mm:ss", -5.653658087473633),
                                    ("dayday", -4.044220175039532),
                                    ...
                                    ("Navaratriin|during <named-month>|year", -6.059123195581797),
                                    ...
                                    ("dayyear", -2.033771504846648),
                                    ("Thursdayfrom|since|after <time>", -5.653658087473633),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.059123195581797),
                                    ("Thursdayat <time-of-day>", -5.365976015021851),
                                    ...
                                    ("Chhathin|during <named-month>|year", -6.059123195581797),
                                    ("Diwaliin|during <named-month>|year", -6.059123195581797),
                                    ("Vaisakhiin|during <named-month>|year", -6.059123195581797),
                                    ("Raksha Bandhanyear (latent)", -6.059123195581797),
                                    ("daysecond", -5.653658087473633),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.653658087473633),
                                    ("Ashurayear (latent)", -6.059123195581797),
                                    ("Tuesdayin|during <named-month>|year", -6.059123195581797),
                                    ...
                                    ("Palm Sundayyear (latent)", -6.059123195581797),
                                    ...
                                    ("Dhanterasin|during <named-month>|year", -6.059123195581797),
                                    ("Tisha B'Avyear (latent)", -6.059123195581797),
                                    ("Isra and Mi'rajyear (latent)", -5.1428324637076415),
                                    ("at <time-of-day>on <day>", -4.9605109069136875),
                                    ...
                                    ("Thai Pongalin|during <named-month>|year", -6.059123195581797),
                                    ...
                                    ("Vaisakhiyear (latent)", -5.365976015021851),
                                    ...
                                    ("between <time> and <time>on <day>", -4.449685283147696),
                                    ...
                                    ("St Patrick's Dayyear (latent)", -6.059123195581797),
                                    ("Thursday<time> (timezone)", -6.059123195581797),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.059123195581797),
                               ...
                               n = 321},
                   koData =
                     ClassData{prior = -1.0096226716663743, unseen = -6.368187186350492,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.757032535297338),
                                    ...
                                    ("yearhour", -5.673323267171493),
                                    ("<time-of-day> am|pmyear (latent)", -4.980176086611547),
                                    ...
                                    ("until <time>on <day>", -4.980176086611547),
                                    ("in|within|after <duration>at <time-of-day>",
                                     -5.673323267171493),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -4.980176086611547),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.673323267171493),
                                    ("hh:mmon <day>", -3.6584202466292277),
                                    ...
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.673323267171493),
                                    ("<time-of-day> am|pmon <day>", -4.420560298676125),
                                    ("Mondayyear (latent)", -4.980176086611547),
                                    ("dayday", -5.267858159063328),
                                    ("on <day>September", -5.267858159063328),
                                    ...
                                    ("from|since|after <time>on <day>", -4.757032535297338),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.15927626767607062,
                               ...
                               n = 139},
                   koData =
                     ClassData{prior = -1.9156963704588166, unseen = -3.367295829986474,
                               likelihoods =
                                 HashMap.fromList
