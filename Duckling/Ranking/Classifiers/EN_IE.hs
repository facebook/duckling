...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7715162476754521, unseen = -5.225746673713201,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 184},
                   koData =
                     ClassData{prior = -0.6204759902625863, unseen = -5.375278407684165,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5616840409994818, unseen = -6.315358001522335,
                               likelihoods =
                                 HashMap.fromList
                                   [("Father's Dayyear (latent)", -5.62040086571715),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.3676378972217815),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.3676378972217815),
                                    ("hourday", -3.9156527734787248),
                                    ("dayhour", -2.787187521660934),
                                    ("Martin Luther King's Dayyear (latent)", -5.214935757608986),
                                    ("daymonth", -4.927253685157205),
                                    ("monthday", -5.214935757608986),
                                    ("monthyear", -4.01096295328305),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.62040086571715),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.62040086571715),
                                    ("houryear", -5.62040086571715),
                                    ...
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.927253685157205),
                                    ("<time-of-day> am|pmintersect", -4.3676378972217815),
                                    ("Octoberyear (latent)", -4.3676378972217815),
                                    ("intersect<time-of-day> am|pm", -5.62040086571715),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.62040086571715),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.214935757608986),
                                    ("Marchyear (latent)", -5.62040086571715),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.62040086571715),
                                    ("monthhour", -5.214935757608986),
                                    ("todayat <time-of-day>", -5.62040086571715),
                                    ("Thursday<time> timezone", -3.9156527734787248),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -5.62040086571715),
                                    ("dayday", -3.6054978451748854),
                                    ("<time> <part-of-day>at <time-of-day>", -5.62040086571715),
                                    ("Tuesdayin <named-month>", -5.62040086571715),
                                    ("tonightat <time-of-day>", -5.62040086571715),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.927253685157205),
                                    ("today<time-of-day> am|pm", -5.62040086571715),
                                    ("Februarythe <day-of-month> (ordinal)", -5.214935757608986),
                                    ("at <time-of-day><time> <part-of-day>", -5.62040086571715),
                                    ("hourhour", -4.3676378972217815),
                                    ("<time-of-day> am|pmon <date>", -3.6054978451748854),
                                    ("Wednesdaythis|last|next <cycle>", -5.62040086571715),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.116323468940876),
                                    ("dayyear", -3.2690256085536724),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.62040086571715),
                                    ("Thursdayat <time-of-day>", -5.214935757608986),
                                    ("<time-of-day> am|pmtomorrow", -4.927253685157205),
                                    ("minutehour", -4.7041101338429945),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.214935757608986),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.9156527734787248),
                                    ("for <duration> from <time>December", -5.62040086571715),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.62040086571715),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.7041101338429945),
                                    ("Mondayin|during the <part-of-day>", -5.62040086571715),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.214935757608986),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.62040086571715),
                                    ("intersectin|during the <part-of-day>", -5.62040086571715),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.62040086571715),
                                    ("Septemberyear (latent)", -5.214935757608986),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.3676378972217815),
                                    ("Halloweenyear (latent)", -5.62040086571715),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.62040086571715),
                                    ("minuteday", -1.9828147059907641),
                                    ("absorption of , after named dayintersect", -5.62040086571715),
                                    ("<ordinal> <cycle> of <time>year (latent)", -5.62040086571715),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.62040086571715),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.62040086571715),
                                    ("Christmasyear (latent)", -5.62040086571715),
                                    ("at <time-of-day>on <date>", -4.5217885770490405),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.01096295328305),
                                    ("dayweek", -5.62040086571715),
                                    ("Easter Sundayyear (latent)", -4.927253685157205),
                                    ("Thursday<time-of-day> am|pm", -5.62040086571715),
                                    ("weekyear", -5.214935757608986),
                                    ("hh:mmin|during the <part-of-day>", -4.927253685157205),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.214935757608986),
                                    ("February<time> <part-of-day>", -5.62040086571715),
                                    ("tomorrowat <time-of-day>", -4.927253685157205),
                                    ("Labor Dayyear (latent)", -5.62040086571715),
                                    ("between <time> and <time>on <date>", -4.01096295328305),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.927253685157205),
                                    ("last <cycle> of <time>year (latent)", -4.927253685157205),
                                    ("at <time-of-day>tomorrow", -5.214935757608986),
                                    ("tomorrow<time-of-day> am|pm", -5.62040086571715),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.62040086571715),
                                    ("Black Fridayyear (latent)", -5.214935757608986),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.62040086571715),
                                    ("Februaryintersect", -5.62040086571715),
                                    ("Mother's Dayyear (latent)", -5.62040086571715)],
                               n = 207},
                   koData =
                     ClassData{prior = -0.8445468270153137, unseen = -6.111467339502679,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.41610040220442),
                                    ...
                                    ("monthyear", -4.163337433709052),
                                    ("<time-of-day> am|pmyear (latent)", -5.0106352940962555),
                                    ("intersecthh:mm", -5.41610040220442),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.41610040220442),
                                    ("houryear", -4.499809670330265),
                                    ...
                                    ("Octoberyear (latent)", -5.41610040220442),
                                    ...
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -4.163337433709052),
                                    ("about|exactly <time-of-day>year (latent)", -5.41610040220442),
                                    ...
                                    ("Thursdaydd/mm", -5.41610040220442),
                                    ("dayyear", -3.0182051294060495),
                                    ("in <named-month>year (latent)", -5.41610040220442),
                                    ("Thursdayat <time-of-day>", -4.163337433709052),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.41610040220442),
                                    ("Aprilyear (latent)", -5.41610040220442),
                                    ...
                                    ("Augustyear (latent)", -5.0106352940962555),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.0106352940962555),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.0106352940962555),
                                    ...
                                    ("hh:mmyear (latent)", -4.31748811353631),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.41610040220442),
                                    ("dayminute", -2.973753366835216),
                                    ("intersectSeptember", -3.912023005428146),
                                    ("minuteday", -2.348047467070803),
                                    ...
                                    ("hh:mmon <date>", -3.4011973816621555),
                                    ...
                                    ("Easter Sundayyear (latent)", -5.41610040220442),
                                    ...
                                    ("Fridayyear (latent)", -5.0106352940962555),
                                    ("minuteyear", -4.163337433709052)],
                               n = 156}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.41494385206270823,
                               ...
                               n = 35},
                   koData =
                     ClassData{prior = -1.0799201556559572,
                               unseen = -3.1354942159291497,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -1.2992829841302609),
                                    ("negative numbers", -0.5260930958967791),
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.5659920050746986,
                               ...
                               n = 67},
                   koData =
                     ClassData{prior = -0.8388589917413389, unseen = -4.007333185232471,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.3694478524670215),
                                    ("on <date><time-of-day> am|pm", -4.3694478524670215),
