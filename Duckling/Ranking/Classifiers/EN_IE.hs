...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5635043216751151, unseen = -6.091309882077698,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 440},
                   koData =
                     ClassData{prior = -0.8421365586069781, unseen = -5.814130531825066,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45941864780041747,
                               unseen = -7.093404625868766,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.399426535414734),
                                    ("Karva Chauthyear (latent)", -6.399426535414734),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.399426535414734),
                                    ("Maha Shivaratriyear (latent)", -6.399426535414734),
                                    ("Ramadanyear (latent)", -5.146663566919366),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.013132174294843),
                                    ("Bhai Doojyear (latent)", -6.399426535414734),
                                    ("hourday", -4.384523514872469),
                                    ("dayhour", -3.4549875562482932),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.013132174294843),
                                    ("Martin Luther King's Dayyear (latent)", -5.993961427306569),
                                    ("Shemini Atzeretyear (latent)", -6.399426535414734),
                                    ("daymonth", -4.384523514872469),
                                    ("monthday", -5.993961427306569),
                                    ("monthyear", -4.6076670661866785),
                                    ("Yom Ha'atzmautyear (latent)", -6.399426535414734),
                                    ("Vijayadashamiyear (latent)", -6.399426535414734),
                                    ("Thai Pongalyear (latent)", -5.7062793548547885),
                                    ("Thiru Onamyear (latent)", -5.7062793548547885),
                                    ("hhhmmabsorption of , after named day", -6.399426535414734),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.399426535414734),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.483135803540579),
                                    ("<day-of-month> (ordinal)Wednesday", -6.399426535414734),
                                    ("Krishna Janmashtamiyear (latent)", -5.993961427306569),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.399426535414734),
                                    ("houryear", -5.483135803540579),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.399426535414734),
                                    ("Christmas<time-of-day> am|pm", -6.399426535414734),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.399426535414734),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7062793548547885),
                                    ("intersectin|during <named-month>|year", -6.399426535414734),
                                    ("<time-of-day> am|pmintersect", -5.146663566919366),
                                    ("Earth Houryear (latent)", -6.399426535414734),
                                    ("Octoberyear (latent)", -4.895349138638459),
                                    ("intersect<time-of-day> am|pm", -6.399426535414734),
                                    ("Mattu Pongalyear (latent)", -6.399426535414734),
                                    ("Shavuotyear (latent)", -6.399426535414734),
                                    ("Parsi New Yearyear (latent)", -5.483135803540579),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.399426535414734),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.399426535414734),
                                    ("todayin|within|after <duration>", -6.399426535414734),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.993961427306569),
                                    ("Marchyear (latent)", -6.399426535414734),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -5.993961427306569),
                                    ("Sukkotyear (latent)", -5.993961427306569),
                                    ("hhhmmintersect", -5.993961427306569),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7062793548547885),
                                    ("todayat <time-of-day>", -6.399426535414734),
                                    ("Thursday<time> timezone", -4.001531262616363),
                                    ("time-of-day (latent)tonight", -5.993961427306569),
                                    ("from|since|after <time>December", -6.399426535414734),
                                    ("<time-of-day> am|pmon <day>", -4.384523514872469),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.399426535414734),
                                    ("yyyy-mm-ddhh:mm:ss", -5.993961427306569),
                                    ("dayday", -3.6913763343125234),
                                    ("<time> <part-of-day>at <time-of-day>", -6.399426535414734),
                                    ("tonightat <time-of-day>", -6.399426535414734),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.7062793548547885),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.399426535414734),
                                    ("today<time-of-day> am|pm", -6.399426535414734),
                                    ("Februarythe <day-of-month> (ordinal)", -5.993961427306569),
                                    ("at <time-of-day><time> <part-of-day>", -6.399426535414734),
                                    ("<day-of-month> (ordinal)intersect", -5.993961427306569),
                                    ("hourhour", -4.319984993734898),
                                    ("Mahavir Jayantiyear (latent)", -5.993961427306569),
                                    ("Navaratriin|during <named-month>|year", -6.399426535414734),
                                    ("Wednesdaythis|last|next <cycle>", -6.399426535414734),
                                    ("Lentyear (latent)", -6.399426535414734),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.527624358513142),
                                    ("Boghiyear (latent)", -6.399426535414734),
                                    ("dayyear", -1.8776379583656932),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.399426535414734),
                                    ("Thursdayfrom|since|after <time>", -5.993961427306569),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.399426535414734),
                                    ("Thursdayat <time-of-day>", -5.7062793548547885),
                                    ("Islamic New Yearyear (latent)", -5.993961427306569),
                                    ("Laylat al-Qadryear (latent)", -5.483135803540579),
                                    ("Shrove Tuesdayyear (latent)", -6.399426535414734),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.7062793548547885),
                                    ("<time-of-day> am|pmtomorrow", -5.7062793548547885),
                                    ("Yom Kippuryear (latent)", -6.399426535414734),
                                    ("<day-of-month> (ordinal)Tuesday", -5.993961427306569),
                                    ("<part-of-day> of <time>year (latent)", -6.399426535414734),
                                    ("minutehour", -5.146663566919366),
                                    ("Kaanum Pongalyear (latent)", -5.993961427306569),
                                    ("Maha Saptamiyear (latent)", -6.399426535414734),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.993961427306569),
                                    ("time-of-day (latent)tomorrow", -5.483135803540579),
                                    ("part of daysat <time-of-day>", -5.993961427306569),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.384523514872469),
                                    ("for <duration> from <time>December", -6.399426535414734),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.399426535414734),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.146663566919366),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.146663566919366),
                                    ("time-of-day (latent)this <part-of-day>", -6.399426535414734),
                                    ("Pentecostyear (latent)", -6.399426535414734),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.146663566919366),
                                    ("<day-of-month> (ordinal)February", -6.399426535414734),
                                    ("Eid al-Fitryear (latent)", -5.013132174294843),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.399426535414734),
                                    ("Mondayin|during the <part-of-day>", -6.399426535414734),
                                    ("Chhathin|during <named-month>|year", -6.399426535414734),
                                    ("Diwaliin|during <named-month>|year", -6.399426535414734),
                                    ("Vaisakhiin|during <named-month>|year", -6.399426535414734),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.146663566919366),
                                    ("Raksha Bandhanyear (latent)", -6.399426535414734),
                                    ("daysecond", -5.993961427306569),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.993961427306569),
                                    ("Ratha-Yatrayear (latent)", -6.399426535414734),
                                    ("Ashurayear (latent)", -6.399426535414734),
                                    ("Tuesdayin|during <named-month>|year", -6.399426535414734),
                                    ("Chinese New Yearyear (latent)", -6.399426535414734),
                                    ("tomorrowintersect", -6.399426535414734),
                                    ("Lag BaOmeryear (latent)", -6.399426535414734),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.399426535414734),
                                    ("Eid al-Adhayear (latent)", -4.259360371918463),
                                    ("intersectin|during the <part-of-day>", -6.399426535414734),
                                    ("Palm Sundayyear (latent)", -6.399426535414734),
                                    ("Christmasat <time-of-day>", -6.399426535414734),
                                    ("Passoveryear (latent)", -6.399426535414734),
                                    ("Lazarus Saturdayyear (latent)", -6.399426535414734),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.399426535414734),
                                    ("hhhmmon <day>", -5.483135803540579),
                                    ("Yom HaShoahyear (latent)", -5.993961427306569),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.993961427306569),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.399426535414734),
                                    ("Septemberyear (latent)", -5.993961427306569),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.895349138638459),
                                    ("Halloweenyear (latent)", -6.399426535414734),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.399426535414734),
                                    ("at <time-of-day>intersect", -5.483135803540579),
                                    ("Rosh Hashanahyear (latent)", -5.7062793548547885),
                                    ("Dhanterasyear (latent)", -6.399426535414734),
                                    ("Tu BiShvatyear (latent)", -6.399426535414734),
                                    ("<day-of-month> (ordinal)December", -5.7062793548547885),
                                    ("Holiyear (latent)", -5.7062793548547885),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.399426535414734),
                                    ("Holika Dahanyear (latent)", -5.7062793548547885),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.993961427306569),
                                    ("dayminute", -3.0852405307422077),
                                    ("Mawlidyear (latent)", -6.399426535414734),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.993961427306569),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.399426535414734),
                                    ("Jumu'atul-Widayear (latent)", -5.483135803540579),
                                    ("minuteday", -2.6617569171313655),
                                    ("absorption of , after named dayintersect",
                                     -5.7062793548547885),
                                    ("intersectyear (latent)", -6.399426535414734),
                                    ("Orthodox Easter Sundayyear (latent)", -6.399426535414734),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.399426535414734),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.399426535414734),
                                    ("intersecthhhmm", -5.993961427306569),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.399426535414734),
                                    ("Boss's Dayyear (latent)", -5.993961427306569),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.399426535414734),
                                    ("Global Youth Service Dayyear (latent)", -6.399426535414734),
                                    ("Dhanterasin|during <named-month>|year", -6.399426535414734),
                                    ("Tisha B'Avyear (latent)", -6.399426535414734),
                                    ("Isra and Mi'rajyear (latent)", -5.483135803540579),
                                    ("at <time-of-day>on <day>", -4.789988622980633),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.993961427306569),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.7062793548547885),
                                    ("Christmasyear (latent)", -5.993961427306569),
                                    ("Naraka Chaturdashiyear (latent)", -5.993961427306569),
                                    ("Thai Pongalin|during <named-month>|year", -6.399426535414734),
                                    ("dayweek", -6.399426535414734),
                                    ("Easter Sundayyear (latent)", -5.7062793548547885),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -5.993961427306569),
                                    ("weekyear", -5.300814246746624),
                                    ("King's Dayyear (latent)", -4.895349138638459),
                                    ("hh:mmin|during the <part-of-day>", -5.483135803540579),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.993961427306569),
                                    ("Hanukkahyear (latent)", -5.7062793548547885),
                                    ("February<time> <part-of-day>", -6.399426535414734),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.399426535414734),
                                    ("Great Lentyear (latent)", -6.399426535414734),
                                    ("tomorrowat <time-of-day>", -5.7062793548547885),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.399426535414734),
                                    ("Ugadiyear (latent)", -5.013132174294843),
                                    ("Vaisakhiyear (latent)", -5.7062793548547885),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.7062793548547885),
                                    ("last <cycle> of <time>year (latent)", -5.7062793548547885),
                                    ("at <time-of-day>tomorrow", -5.993961427306569),
                                    ("tomorrow<time-of-day> am|pm", -6.399426535414734),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.399426535414734),
                                    ("Diwaliyear (latent)", -6.399426535414734),
                                    ("between <time> and <time>on <day>", -5.993961427306569),
                                    ("Black Fridayyear (latent)", -5.993961427306569),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.399426535414734),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.399426535414734),
                                    ("Chhathyear (latent)", -5.993961427306569),
                                    ("Vasant Panchamiyear (latent)", -6.399426535414734),
                                    ("Rabindra Jayantiyear (latent)", -5.146663566919366),
                                    ("St Patrick's Dayyear (latent)", -6.399426535414734),
                                    ("Thursday<time> (timezone)", -6.399426535414734),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.399426535414734),
                                    ("Pargat Diwasyear (latent)", -5.146663566919366),
                                    ("<datetime> - <datetime> (interval)July", -5.993961427306569),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.7062793548547885),
                                    ("Februaryintersect", -6.399426535414734),
                                    ("Simchat Torahyear (latent)", -6.399426535414734),
                                    ("minuteyear", -6.399426535414734)],
                               n = 463},
                   koData =
                     ClassData{prior = -0.9987237428882767, unseen = -6.706862336602747,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.508414517523783),
                                    ("hourday", -3.614596641501687),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.012491914300058),
                                    ("<day-of-month> (ordinal)August", -6.012491914300058),
                                    ("dayhour", -3.447542556838521),
                                    ("<time> timezoneyear (latent)", -5.319344733740112),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.096201182425903),
                                    ("Tuesdayfrom|since|after <time>", -5.319344733740112),
                                    ("daymonth", -3.338343264873529),
                                    ("monthyear", -4.75972894580469),
                                    ("<time-of-day> am|pmyear (latent)", -5.319344733740112),
                                    ("Thai Pongalyear (latent)", -5.319344733740112),
                                    ("intersecthh:mm", -6.012491914300058),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.607026806191893),
                                    ("<day-of-month> (ordinal)Wednesday", -6.012491914300058),
                                    ("houryear", -4.626197553180167),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.012491914300058),
                                    ("<day-of-month> (ordinal)October", -6.012491914300058),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.319344733740112),
                                    ("hournograin", -4.75972894580469),
                                    ("<time-of-day> am|pmintersect", -4.75972894580469),
                                    ("Octoberyear (latent)", -6.012491914300058),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.607026806191893),
                                    ("until <time>on <day>", -5.319344733740112),
                                    ("time-of-day (latent)intersect", -5.319344733740112),
                                    ("todayin <number> (implicit minutes)", -6.012491914300058),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.319344733740112),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.012491914300058),
                                    ("hh:mmon <day>", -4.75972894580469),
                                    ("hhhmmintersect", -5.607026806191893),
                                    ("absorption of , after named dayJuly", -5.096201182425903),
                                    ("from|since|after <time>July", -5.607026806191893),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.096201182425903),
                                    ("Clean Mondayyear (latent)", -6.012491914300058),
                                    ("monthhour", -6.012491914300058),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.607026806191893),
                                    ("hourmonth", -4.140689737398466),
                                    ("todayat <time-of-day>", -6.012491914300058),
                                    ("hhhmmyear (latent)", -4.75972894580469),
                                    ("from|since|after <time>December", -6.012491914300058),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.012491914300058),
                                    ("<time-of-day> am|pmon <day>", -4.75972894580469),
                                    ("Mondayyear (latent)", -5.319344733740112),
                                    ("dayday", -4.626197553180167),
                                    ("on <day>September", -5.319344733740112),
                                    ("time-of-day (latent)September", -5.607026806191893),
                                    ("hourhour", -5.607026806191893),
                                    ("time-of-day (latent)on <day>", -4.508414517523783),
                                    ("Thursdaydd/mm", -6.012491914300058),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.607026806191893),
                                    ("dayyear", -3.0947211822157783),
                                    ("New Year's Dayyear (latent)", -5.096201182425903),
                                    ("time-of-day (latent)Sunday", -5.607026806191893),
                                    ("Thursdayfrom|since|after <time>", -4.307743822061632),
                                    ("Thursdayat <time-of-day>", -4.403054001865957),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.012491914300058),
                                    ("Aprilyear (latent)", -6.012491914300058),
                                    ("the <day-of-month> (ordinal)July", -6.012491914300058),
                                    ("the <day-of-month> (number)July", -6.012491914300058),
                                    ("monthminute", -6.012491914300058),
                                    ("<time-of-day> am|pmtomorrow", -6.012491914300058),
                                    ("Thursdayhh:mm", -5.096201182425903),
                                    ("<day-of-month> (ordinal)Tuesday", -5.607026806191893),
                                    ("minutemonth", -3.872425750803787),
                                    ("time-of-day (latent)Friday", -5.607026806191893),
                                    ("minutehour", -6.012491914300058),
                                    ("Augustyear (latent)", -5.607026806191893),
                                    ("week-endin|during <named-month>|year", -6.012491914300058),
                                    ("time-of-day (latent)Tuesday", -5.607026806191893),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.012491914300058),
                                    ("Sundayyear (latent)", -5.096201182425903),
                                    ("Christmasat <time-of-day>", -6.012491914300058),
                                    ("from|since|after <time>year (latent)", -4.913879625631948),
                                    ("hhhmmon <day>", -5.096201182425903),
                                    ("yesterday<time-of-day> am|pm", -6.012491914300058),
                                    ("<day-of-month> (ordinal)July", -5.319344733740112),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.012491914300058),
                                    ("at <time-of-day>intersect", -5.096201182425903),
                                    ("hh:mmyear (latent)", -4.626197553180167),
                                    ("Holiyear (latent)", -6.012491914300058),
                                    ("until <time><time-of-day> am|pm", -6.012491914300058),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.607026806191893),
                                    ("dayminute", -3.1792785702438415),
                                    ("yyyy-mm-ddhh:mm", -5.607026806191893),
                                    ("intersectfrom|since|after <time>", -5.607026806191893),
                                    ("intersectSeptember", -4.140689737398466),
                                    ("minuteday", -2.855491493149944),
                                    ("absorption of , after named dayintersect",
                                     -6.012491914300058),
                                    ("intersectyear (latent)", -6.012491914300058),
                                    ("Februaryin|during the <part-of-day>", -6.012491914300058),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.012491914300058),
                                    ("time-of-day (latent)July", -5.319344733740112),
                                    ("Saturdayyear (latent)", -6.012491914300058),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.012491914300058),
                                    ("at <time-of-day>on <day>", -5.096201182425903),
                                    ("absorption of , after named daySeptember", -4.75972894580469),
                                    ("Naraka Chaturdashiyear (latent)", -6.012491914300058),
                                    ("from|since|after <time>on <day>", -5.096201182425903),
                                    ("dayweek", -6.012491914300058),
                                    ("Easter Sundayyear (latent)", -5.607026806191893),
                                    ("Thursday<time-of-day> am|pm", -4.75972894580469),
                                    ("weekyear", -5.607026806191893),
                                    ("time-of-day (latent)Thursday", -5.607026806191893),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.012491914300058),
                                    ("<day-of-month> (ordinal)April", -6.012491914300058),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.607026806191893),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.319344733740112),
                                    ("Sundayfrom|since|after <time>", -6.012491914300058),
                                    ("absorption of , after named dayFebruary", -5.096201182425903),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.607026806191893),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.012491914300058),
                                    ("tomorrowat <time-of-day>", -6.012491914300058),
                                    ("daynograin", -5.607026806191893),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.607026806191893),
                                    ("last <cycle> of <time>year (latent)", -5.607026806191893),
                                    ("tomorrow<time-of-day> am|pm", -6.012491914300058),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.319344733740112),
                                    ("Diwaliyear (latent)", -5.607026806191893),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.012491914300058),
                                    ("Fridayyear (latent)", -5.607026806191893),
                                    ("time-of-day (latent)April", -6.012491914300058),
                                    ("minuteyear", -3.815267336963838)],
                               n = 270}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1494000770686605, unseen = -5.375278407684165,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 211},
                   koData =
                     ClassData{prior = -1.9748976859285656,
                               unseen = -3.6635616461296463,
                               likelihoods =
                                 HashMap.fromList
