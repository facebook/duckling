...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5765344200517522, unseen = -6.061456918928017,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 427},
                   koData =
                     ClassData{prior = -0.825175943299933, unseen = -5.814130531825066,
                                 ...
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.505963535904644),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.010040932680917),
                                    ("at <time-of-day>intersect", -5.093750200806762),
                                    ("hh:mmyear (latent)", -4.623746571561027),
                                    ("Holiyear (latent)", -6.010040932680917),
                                    ("until <time><time-of-day> am|pm", -6.010040932680917),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.604575824572753),
                                    ("dayminute", -3.1768275886247013),
                                    ("yyyy-mm-ddhh:mm", -5.604575824572753),
                                    ("intersectfrom|since|after <time>", -5.604575824572753),
                                    ("intersectSeptember", -4.138238755779326),
                                    ("minuteday", -2.853040511530804),
                                    ("absorption of , after named dayintersect",
                                     -6.010040932680917),
                                    ...
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.010040932680917),
                                    ("at <time-of-day>on <day>", -5.093750200806762),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.15847034097177473,
                               ...
                               n = 198},
                   koData =
                     ClassData{prior = -1.9203768470501485,
                               unseen = -3.6635616461296463,
                               likelihoods =
                                 HashMap.fromList
