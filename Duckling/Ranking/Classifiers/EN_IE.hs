...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.695789190022784, unseen = -5.25227342804663,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 189},
                   koData =
                     ClassData{prior = -0.6905121329219402,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48736413708699267,
                               unseen = -6.324358962381311,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                     -4.376655090871971),
                                    ("Lentyear", -5.629418059367339),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.376655090871971),
                                    ("hourday", -3.9246699671289136),
                                    ("dayhour", -2.739046301471174),
                                    ("daymonth", -4.9362708788073935),
                                    ("monthday", -5.223952951259174),
                                    ("monthyear", -4.019980146933238),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.629418059367339),
                                    ("Easter Sundayyear", -4.9362708788073935),
                                    ("Christmasyear", -5.223952951259174),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.629418059367339),
                                    ("houryear", -5.223952951259174),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.629418059367339),
                                    ("Christmas<time-of-day> am|pm", -5.629418059367339),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.9362708788073935),
                                    ("<time-of-day> am|pmintersect", -4.376655090871971),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.629418059367339),
                                    ("Marchyear", -5.629418059367339),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.223952951259174),
                                    ("intersect<time-of-day> am|pm", -5.629418059367339),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.629418059367339),
                                    ("monthhour", -5.223952951259174),
                                    ("last <day-of-week> of <time>year", -5.629418059367339),
                                    ("todayat <time-of-day>", -5.629418059367339),
                                    ("Thursday<time> timezone", -3.9246699671289136),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.629418059367339),
                                    ("Palm SundaySunday", -5.223952951259174),
                                    ("dayday", -3.4321934820311193),
                                    ("<time> <part-of-day>at <time-of-day>", -5.629418059367339),
                                    ("Tuesdayin <named-month>", -5.629418059367339),
                                    ("tonightat <time-of-day>", -5.629418059367339),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.9362708788073935),
                                    ("today<time-of-day> am|pm", -5.629418059367339),
                                    ("Februarythe <day-of-month> (ordinal)", -5.223952951259174),
                                    ("at <time-of-day><time> <part-of-day>", -5.629418059367339),
                                    ("hourhour", -4.376655090871971),
                                    ("<time-of-day> am|pmon <date>", -3.614515038825074),
                                    ("Wednesdaythis|last|next <cycle>", -5.629418059367339),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.125340662591065),
                                    ("dayyear", -3.1036894150590832),
                                    ("last weekend of <named-month>year", -5.629418059367339),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.629418059367339),
                                    ("Sundayyear", -5.629418059367339),
                                    ("Thursdayat <time-of-day>", -5.223952951259174),
                                    ("<time-of-day> am|pmtomorrow", -4.9362708788073935),
                                    ("minutehour", -4.713127327493184),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.223952951259174),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.9246699671289136),
                                    ("for <duration> from <time>December", -5.629418059367339),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.629418059367339),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.713127327493184),
                                    ("Mondayin|during the <part-of-day>", -5.629418059367339),
                                    ("Shrove Tuesdayyear", -5.629418059367339),
                                    ("<part-of-day> of <time>year", -5.629418059367339),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.223952951259174),
                                    ("intersectin|during the <part-of-day>", -5.629418059367339),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.629418059367339),
                                    ("year<time-of-day> am|pm", -5.629418059367339),
                                    ("Septemberyear", -5.223952951259174),
                                    ("at <time-of-day>on <date>", -4.530805770699229),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.9362708788073935),
                                    ("Halloweenyear", -5.629418059367339),
                                    ("dayweek", -5.629418059367339),
                                    ("Thursday<time-of-day> am|pm", -5.629418059367339),
                                    ("weekyear", -5.223952951259174),
                                    ("hh:mmin|during the <part-of-day>", -4.9362708788073935),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.223952951259174),
                                    ("February<time> <part-of-day>", -5.629418059367339),
                                    ("Martin Luther King's Dayyear", -5.223952951259174),
                                    ("tomorrowat <time-of-day>", -4.9362708788073935),
                                    ("between <time> and <time>on <date>", -4.9362708788073935),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.9362708788073935),
                                    ("at <time-of-day>tomorrow", -5.223952951259174),
                                    ("tomorrow<time-of-day> am|pm", -5.629418059367339),
                                    ("Pentecostyear", -5.629418059367339),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.629418059367339),
                                    ("Palm Sundayintersect", -5.629418059367339),
                                    ("Labor Dayyear", -5.629418059367339),
                                    ("Februaryintersect", -5.629418059367339),
                                    ("last <cycle> of <time>year", -4.9362708788073935),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.629418059367339),
                                    ("yearminute", -5.629418059367339),
                                    ("Black Fridayyear", -5.223952951259174)],
                               n = 207},
                   koData =
                     ClassData{prior = -0.9525484798967793,
                               unseen = -6.0014148779611505,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.305789381386738),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.305789381386738),
                                    ("hourday", -5.305789381386738),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.305789381386738),
                                    ("dayhour", -3.0032042883926917),
                                    ("daymonth", -3.226347839706902),
                                    ("monthday", -4.9003242732785735),
                                    ("monthyear", -4.612642200826793),
                                    ("intersecthh:mm", -5.305789381386738),
                                    ("Easter Sundayyear", -5.305789381386738),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.305789381386738),
                                    ("houryear", -5.305789381386738),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.305789381386738),
                                    ("until <time-of-day><time-of-day> am|pm", -5.305789381386738),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.612642200826793),
                                    ("<time-of-day> am|pmintersect", -4.05302641289137),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.389498649512583),
                                    ("from|since|after <time-of-day>on <date>", -4.389498649512583),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.305789381386738),
                                    ("absorption of , after named dayJuly", -4.9003242732785735),
                                    ("monthhour", -5.305789381386738),
                                    ("hourmonth", -4.612642200826793),
                                    ("todayat <time-of-day>", -5.305789381386738),
                                    ("from|since|after <time-of-day>July", -5.305789381386738),
                                    ("dayday", -4.9003242732785735),
                                    ("<time-of-day> am|pmon <date>", -4.05302641289137),
                                    ("Thursdaydd/mm", -5.305789381386738),
                                    ("dayyear", -3.6010412891483123),
                                    ("Sundayyear", -4.612642200826793),
                                    ("Thursdayat <time-of-day>", -4.05302641289137),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.305789381386738),
                                    ("monthminute", -5.305789381386738),
                                    ("<time-of-day> am|pmtomorrow", -5.305789381386738),
                                    ("Thursdayhh:mm", -4.389498649512583),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.305789381386738),
                                    ("Fridayyear", -4.9003242732785735),
                                    ("minutemonth", -3.5140299121586827),
                                    ("Sundayfrom|since|after <time-of-day>", -5.305789381386738),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.9003242732785735),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.9003242732785735),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.305789381386738),
                                    ("Christmasat <time-of-day>", -5.305789381386738),
                                    ("<duration> after|before|from <time>December",
                                     -5.305789381386738),
                                    ("yesterday<time-of-day> am|pm", -5.305789381386738),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.305789381386738),
                                    ("until <time-of-day>on <date>", -4.612642200826793),
                                    ("at <time-of-day>intersect", -4.9003242732785735),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.305789381386738),
                                    ("dayminute", -2.8208827315987373),
                                    ("intersectSeptember", -3.8017119846104634),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.305789381386738),
                                    ("minuteday", -2.3880186493024587),
                                    ("absorption of , after named dayintersect",
                                     -5.305789381386738),
                                    ("Februaryin|during the <part-of-day>", -5.305789381386738),
                                    ("week-endin <named-month>", -5.305789381386738),
                                    ("Octoberyear", -5.305789381386738),
                                    ("from|since|after <time-of-day>year", -5.305789381386738),
                                    ("yearhh:mm", -5.305789381386738),
                                    ("hh:mmon <date>", -3.8017119846104634),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.305789381386738),
                                    ("absorption of , after named daySeptember",
                                     -4.389498649512583),
                                    ("on <date>September", -4.9003242732785735),
                                    ("at <time-of-day>on <date>", -4.9003242732785735),
                                    ("dayweek", -5.305789381386738),
                                    ("Thursday<time-of-day> am|pm", -4.9003242732785735),
                                    ("absorption of , after named dayFebruary", -4.389498649512583),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.305789381386738),
                                    ("tomorrowat <time-of-day>", -5.305789381386738),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.305789381386738),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.696351468952637),
                                    ("tomorrow<time-of-day> am|pm", -5.305789381386738),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.305789381386738),
                                    ("yearminute", -5.305789381386738)],
                               n = 130}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year",
        Classifier{okData =
                     ClassData{prior = -0.2282586519809802, unseen = -3.784189633918261,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -9.763846956391606e-2),
                                    ("intersect 2 numbers", -3.068052935133617)],
                               n = 39},
                   koData =
                     ClassData{prior = -1.589235205116581, unseen = -2.70805020110221,
                               likelihoods =
                                 HashMap.fromList
