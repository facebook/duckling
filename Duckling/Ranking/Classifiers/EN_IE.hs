...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5704444417381015, unseen = -6.075346031088684,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 433},
                   koData =
                     ClassData{prior = -0.8330396797601475, unseen = -5.814130531825066,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46505720531041, unseen = -7.080867896690782,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.386879319362645),
                                    ("Karva Chauthyear (latent)", -6.386879319362645),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.386879319362645),
                                    ("Maha Shivaratriyear (latent)", -6.386879319362645),
                                    ("Ramadanyear (latent)", -5.47058858748849),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.000584958242754),
                                    ("Bhai Doojyear (latent)", -6.386879319362645),
                                    ("hourday", -4.37197629882038),
                                    ("dayhour", -3.4424403401962045),
                                    ...
                                    ("hhhmmabsorption of , after named day", -6.386879319362645),
                                    ...
                                    ("todayin|within|after <duration>", -6.386879319362645),
                                    ...
                                    ("hhhmmintersect", -5.981414211254481),
                                    ...
                                    ("Thursday<time> timezone", -3.9889840465642745),
                                    ...
                                    ("Mahavir Jayantiyear (latent)", -5.981414211254481),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.386879319362645),
                                    ("at <time-of-day>intersect", -5.47058858748849),
                                    ...
                                    ("minuteday", -2.649209701079277),
                                    ("absorption of , after named dayintersect", -5.6937321388027),
                                    ...
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.386879319362645),
                                    ("intersecthhhmm", -5.981414211254481),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.386879319362645),
                                    ...
                                    ("at <time-of-day>on <day>", -4.777441406928545),
                                    ...
                                    ("hh:mmin|during the <part-of-day>", -5.47058858748849),
                                    ...
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.386879319362645),
                                    ("Ugadiyear (latent)", -5.134116350867277),
                                    ...
                                    ("between <time> and <time>on <day>", -5.981414211254481),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.386879319362645),
                                    ("Pargat Diwasyear (latent)", -5.134116350867277),
                               ...
                               n = 456},
                   koData =
                     ClassData{prior = -0.9891280558264214, unseen = -6.705639094860003,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.507189777627888),
                                    ("hourday", -3.6133719016057912),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.0112671744041615),
                                    ("<day-of-month> (ordinal)August", -6.0112671744041615),
                                    ("dayhour", -3.446317816942625),
                                    ("<time> timezoneyear (latent)", -5.318119993844216),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.094976442530006),
                                    ("Tuesdayfrom|since|after <time>", -5.318119993844216),
                                    ("daymonth", -3.337118524977633),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.0112671744041615),
                                    ("hh:mmon <day>", -4.758504205908793),
                                    ("hhhmmintersect", -5.605802066295998),
                                    ("absorption of , after named dayJuly", -5.094976442530006),
                                    ...
                                    ("hhhmmyear (latent)", -4.758504205908793),
                                    ...
                                    ("on <day>September", -5.318119993844216),
                                    ("time-of-day (latent)September", -5.605802066295998),
                                    ("hourhour", -5.605802066295998),
                                    ("time-of-day (latent)on <day>", -4.507189777627888),
                                    ("Thursdaydd/mm", -6.0112671744041615),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.605802066295998),
                                    ("dayyear", -3.0934964423198825),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.0112671744041615),
                                    ("at <time-of-day>intersect", -5.094976442530006),
                                    ("hh:mmyear (latent)", -4.624972813284271),
                                    ...
                                    ("intersectSeptember", -4.139464997502571),
                                    ("minuteday", -2.8542667532540484),
                                    ...
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0112671744041615),
                                    ("at <time-of-day>on <day>", -5.094976442530006),
