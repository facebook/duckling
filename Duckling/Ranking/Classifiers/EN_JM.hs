...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7272413919029214,
                               unseen = -5.1647859739235145,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 173},
                   koData =
                     ClassData{prior = -0.6601771613223754, unseen = -5.231108616854587,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4639613147897729, unseen = -6.131226489483141,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.519612297626445),
                                    ("hourday", -3.7311549372621746),
                                    ("dayhour", -3.1846112308941046),
                                    ("daymonth", -4.7427558489406545),
                                    ("monthday", -5.030437921392435),
                                    ("monthyear", -3.8264651170664994),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.4359030295006),
                                    ("Christmasyear", -5.4359030295006),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.4359030295006),
                                    ("Marchyear", -5.4359030295006),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.030437921392435),
                                    ("intersect<time-of-day> am|pm", -5.4359030295006),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.4359030295006),
                                    ("monthhour", -5.030437921392435),
                                    ("last <day-of-week> of <time>year", -5.4359030295006),
                                    ("todayat <time-of-day>", -5.4359030295006),
                                    ("Thursday<time> timezone", -5.030437921392435),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -5.4359030295006),
                                    ("dayday", -3.4210000089583352),
                                    ("<time> <part-of-day>at <time-of-day>", -5.4359030295006),
                                    ("Tuesdayin <named-month>", -5.4359030295006),
                                    ("tonightat <time-of-day>", -5.4359030295006),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.7427558489406545),
                                    ("today<time-of-day> am|pm", -5.4359030295006),
                                    ("Februarythe <day-of-month> (ordinal)", -5.030437921392435),
                                    ("at <time-of-day><time> <part-of-day>", -5.4359030295006),
                                    ("hourhour", -4.183140061005232),
                                    ("<time-of-day> am|pmon <date>", -3.4210000089583352),
                                    ("Wednesdaythis|last|next <cycle>", -5.4359030295006),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.9318256327243257),
                                    ("dayyear", -3.2386784521643803),
                                    ("last weekend of <named-month>year", -5.4359030295006),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.4359030295006),
                                    ("<time-of-day> am|pmtomorrow", -4.7427558489406545),
                                    ("minutehour", -4.519612297626445),
                                    ("Mother's Dayyear", -5.4359030295006),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.030437921392435),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.7311549372621746),
                                    ("for <duration> from <time>December", -5.4359030295006),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.4359030295006),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.519612297626445),
                                    ("Mondayin|during the <part-of-day>", -5.4359030295006),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.030437921392435),
                                    ("intersectin|during the <part-of-day>", -5.4359030295006),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.4359030295006),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.030437921392435),
                                    ("<ordinal> <cycle> of <time>year", -5.4359030295006),
                                    ("minuteday", -2.0347056478384444),
                                    ("absorption of , after named dayintersect", -5.4359030295006),
                                    ("Octoberyear", -4.183140061005232),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.4359030295006),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.4359030295006),
                                    ("year<time-of-day> am|pm", -5.4359030295006),
                                    ("Septemberyear", -5.030437921392435),
                                    ("at <time-of-day>on <date>", -4.33729074083249),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.7427558489406545),
                                    ("Halloweenyear", -5.4359030295006),
                                    ("dayweek", -5.4359030295006), ("weekyear", -5.030437921392435),
                                    ("hh:mmin|during the <part-of-day>", -4.7427558489406545),
                                    ("Father's Dayyear", -5.4359030295006),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.030437921392435),
                                    ("February<time> <part-of-day>", -5.4359030295006),
                                    ("Martin Luther King's Dayyear", -5.030437921392435),
                                    ("tomorrowat <time-of-day>", -4.7427558489406545),
                                    ("between <time> and <time>on <date>", -4.7427558489406545),
                                    ("at <time-of-day>tomorrow", -5.030437921392435),
                                    ("tomorrow<time-of-day> am|pm", -5.4359030295006),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.4359030295006),
                                    ("black fridayyear", -5.030437921392435),
                                    ("Labor Dayyear", -5.4359030295006),
                                    ("Februaryintersect", -5.4359030295006),
                                    ("last <cycle> of <time>year", -4.7427558489406545),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.4359030295006),
                                    ("yearminute", -5.4359030295006)],
                               n = 166},
                   koData =
                     ClassData{prior = -0.9909816244757442, unseen = -5.780743515792329,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.084505142662711),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.084505142662711),
                                    ("hourday", -5.084505142662711),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.084505142662711),
                                    ("dayhour", -3.5804277458864373),
                                    ("daymonth", -3.0050636009828753),
                                    ("monthday", -4.679040034554547),
                                    ("monthyear", -4.391357962102766),
                                    ("intersecthh:mm", -5.084505142662711),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.084505142662711),
                                    ("houryear", -5.084505142662711),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.084505142662711),
                                    ("until <time-of-day><time-of-day> am|pm", -5.084505142662711),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.391357962102766),
                                    ("<time-of-day> am|pmintersect", -3.8317421741673434),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.168214410788556),
                                    ("Tuesdayafter <time-of-day>", -5.084505142662711),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.084505142662711),
                                    ("absorption of , after named dayJuly", -4.679040034554547),
                                    ("monthhour", -5.084505142662711),
                                    ("hourmonth", -4.391357962102766),
                                    ("todayat <time-of-day>", -5.084505142662711),
                                    ("dayday", -4.679040034554547),
                                    ("<time-of-day> am|pmon <date>", -3.8317421741673434),
                                    ("Thursdaydd/mm", -5.084505142662711),
                                    ("dayyear", -3.8317421741673434),
                                    ("Thursdayat <time-of-day>", -5.084505142662711),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.084505142662711),
                                    ("monthminute", -5.084505142662711),
                                    ("<time-of-day> am|pmtomorrow", -5.084505142662711),
                                    ("Thursdayhh:mm", -5.084505142662711),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.084505142662711),
                                    ("Fridayyear", -4.679040034554547),
                                    ("minutemonth", -3.379757050424286),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.679040034554547),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.679040034554547),
                                    ("Aprilyear", -5.084505142662711),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.084505142662711),
                                    ("<duration> after|before|from <time>December",
                                     -5.084505142662711),
                                    ("yesterday<time-of-day> am|pm", -5.084505142662711),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.168214410788556),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.084505142662711),
                                    ("until <time-of-day>on <date>", -4.391357962102766),
                                    ("at <time-of-day>intersect", -4.679040034554547),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.084505142662711),
                                    ("dayminute", -3.2127029657611197),
                                    ("intersectSeptember", -3.5804277458864373),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.084505142662711),
                                    ("minuteday", -2.281144761756176),
                                    ("absorption of , after named dayintersect",
                                     -5.084505142662711),
                                    ("Februaryin|during the <part-of-day>", -5.084505142662711),
                                    ("week-endin <named-month>", -5.084505142662711),
                                    ("Octoberyear", -5.084505142662711),
                                    ("yearhh:mm", -5.084505142662711),
                                    ("hh:mmon <date>", -3.5804277458864373),
                                    ("absorption of , after named daySeptember",
                                     -4.168214410788556),
                                    ("on <date>September", -4.679040034554547),
                                    ("at <time-of-day>on <date>", -4.679040034554547),
                                    ("absorption of , after named dayFebruary", -4.168214410788556),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.084505142662711),
                                    ("tomorrowat <time-of-day>", -5.084505142662711),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.084505142662711),
                                    ("tomorrow<time-of-day> am|pm", -5.084505142662711),
                                    ("after <time-of-day><time-of-day> am|pm", -5.084505142662711),
                                    ("after <time-of-day>year", -5.084505142662711),
                                    ("yearminute", -5.084505142662711)],
                               n = 98}}),
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.5172565140962812, unseen = -4.174387269895637,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 62},
                   koData =
                     ClassData{prior = -0.9067212808580043,
                               unseen = -3.8066624897703196,
                               likelihoods =
                                 HashMap.fromList [("integer (numeric)", -2.298951822469872e-2)],
                               n = 42}}),
       ("year",
        Classifier{okData =
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.28163975799581836,
                               unseen = -5.209486152841421,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer after|past <hour-of-day>", -3.817712325956905),
                                    ("at <time-of-day>", -2.259567707910355),
                                    ("<time-of-day> o'clock", -4.105394398408686),
                                    ("half after|past <hour-of-day>", -4.105394398408686),
                                    ("time-of-day (latent)", -1.7382707842770688),
                                    ("hhmm (latent)", -4.51085950651685),
                                    ("hh:mm", -2.2082744135228043),
                                    ("quarter after|past <hour-of-day>", -4.51085950651685),
                                    ("about|exactly <time-of-day>", -4.51085950651685),
                                    ("until <time-of-day>", -3.817712325956905),
                                    ("hour", -1.2721810543524696),
                                    ("<time-of-day> sharp|exactly", -4.51085950651685),
                                    ("minute", -1.677646162460634),
                                    ("after <time-of-day>", -4.51085950651685)],
                               n = 83},
                   koData =
                     ClassData{prior = -1.4046434997880872,
                               unseen = -4.2626798770413155,
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -3.1498829533812494),
                                    ("<hour-of-day> <integer>", -3.5553480614894135),
                                    ("time-of-day (latent)", -1.0704414117014134),
                                    ("hour", -1.0296194171811581), ("minute", -2.8622008809294686),
                                    ("after <time-of-day>", -3.5553480614894135)],
                               n = 27}}),
       ...
       ("<time-of-day> - <time-of-day> (interval)",
        Classifier{okData =
                     ClassData{prior = -0.8266785731844679, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 14},
                   koData =
                     ClassData{prior = -0.5753641449035618, unseen = -3.891820298110627,
                               likelihoods =
                                 HashMap.fromList
                                   [("about|exactly <time-of-day>time-of-day (latent)",
                                     -3.1780538303479458),
                                    ("hh:mmtime-of-day (latent)", -1.4733057381095205),
                                    ("hh:mm<time-of-day> am|pm", -2.772588722239781),
                                    ("<time-of-day> am|pmtime-of-day (latent)",
                                     -3.1780538303479458),
                                    ("hourhour", -2.2617630984737906),
                                    ("minutehour", -1.1631508098056809),
                                    ("about|exactly <time-of-day><time-of-day> am|pm",
                                     -3.1780538303479458),
                                    ("at <time-of-day>time-of-day (latent)", -3.1780538303479458),
