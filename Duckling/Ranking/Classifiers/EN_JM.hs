...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.647932932248777, unseen = -5.799092654460526,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 328},
                   koData =
                     ClassData{prior = -0.7405029672422343, unseen = -5.707110264748875,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5022326600431588, unseen = -6.899723107284873,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.205567353770043),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.205567353770043),
                                    ("Ramadanyear (latent)", -5.289276621895888),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.190664333227778),
                                    ("Bhai Doojyear (latent)", -6.205567353770043),
                                    ("hourday", -4.190664333227778),
                                    ("dayhour", -3.2877966216857635),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.190664333227778),
                                    ("Martin Luther King's Dayyear (latent)", -5.800102245661878),
                                    ("Shemini Atzeretyear (latent)", -6.205567353770043),
                                    ("daymonth", -4.596129441335942),
                                    ("monthday", -5.800102245661878),
                                    ("monthyear", -4.4138078845419875),
                                    ("Yom Ha'atzmautyear (latent)", -6.205567353770043),
                                    ("Vijayadashamiyear (latent)", -6.205567353770043),
                                    ("Thai Pongalyear (latent)", -5.5124201732100975),
                                    ("Thiru Onamyear (latent)", -5.5124201732100975),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.205567353770043),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.205567353770043),
                                    ("<day-of-month> (ordinal)Wednesday", -6.205567353770043),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.205567353770043),
                                    ("houryear", -5.289276621895888),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.205567353770043),
                                    ("Christmas<time-of-day> am|pm", -6.205567353770043),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.205567353770043),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.5124201732100975),
                                    ("intersectin|during <named-month>|year", -6.205567353770043),
                                    ("<time-of-day> am|pmintersect", -4.952804385274675),
                                    ("Earth Houryear (latent)", -6.205567353770043),
                                    ("Octoberyear (latent)", -4.701489956993768),
                                    ("intersect<time-of-day> am|pm", -6.205567353770043),
                                    ("Mattu Pongalyear (latent)", -6.205567353770043),
                                    ("Shavuotyear (latent)", -6.205567353770043),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.205567353770043),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.205567353770043),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.800102245661878),
                                    ("Marchyear (latent)", -6.205567353770043),
                                    ("Sukkotyear (latent)", -5.800102245661878),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.800102245661878),
                                    ("Clean Mondayyear (latent)", -5.800102245661878),
                                    ("monthhour", -5.800102245661878),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.5124201732100975),
                                    ("todayat <time-of-day>", -6.205567353770043),
                                    ("Thursday<time> timezone", -4.259657204714729),
                                    ("time-of-day (latent)tonight", -5.800102245661878),
                                    ("from|since|after <time>December", -6.205567353770043),
                                    ("<time-of-day> am|pmon <day>", -4.190664333227778),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.205567353770043),
                                    ("yyyy-mm-ddhh:mm:ss", -5.800102245661878),
                                    ("dayday", -3.763220318400838),
                                    ("<time> <part-of-day>at <time-of-day>", -6.205567353770043),
                                    ("tonightat <time-of-day>", -6.205567353770043),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.5124201732100975),
                                    ("today<time-of-day> am|pm", -6.205567353770043),
                                    ("Februarythe <day-of-month> (ordinal)", -5.800102245661878),
                                    ("at <time-of-day><time> <part-of-day>", -6.205567353770043),
                                    ("<day-of-month> (ordinal)intersect", -5.800102245661878),
                                    ("hourhour", -4.126125812090207),
                                    ("Navaratriin|during <named-month>|year", -6.205567353770043),
                                    ("Wednesdaythis|last|next <cycle>", -6.205567353770043),
                                    ("Lentyear (latent)", -6.205567353770043),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.701489956993768),
                                    ("Boghiyear (latent)", -6.205567353770043),
                                    ("dayyear", -2.102923988733247),
                                    ("Thursdayfrom|since|after <time>", -5.800102245661878),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.205567353770043),
                                    ("Thursdayat <time-of-day>", -5.5124201732100975),
                                    ("Islamic New Yearyear (latent)", -5.800102245661878),
                                    ("Laylat al-Qadryear (latent)", -5.289276621895888),
                                    ("Shrove Tuesdayyear (latent)", -6.205567353770043),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.5124201732100975),
                                    ("<time-of-day> am|pmtomorrow", -5.5124201732100975),
                                    ("Yom Kippuryear (latent)", -6.205567353770043),
                                    ("<day-of-month> (ordinal)Tuesday", -5.800102245661878),
                                    ("<part-of-day> of <time>year (latent)", -6.205567353770043),
                                    ("minutehour", -5.106955065101933),
                                    ("Kaanum Pongalyear (latent)", -5.800102245661878),
                                    ("Maha Saptamiyear (latent)", -6.205567353770043),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.800102245661878),
                                    ("time-of-day (latent)tomorrow", -5.289276621895888),
                                    ("part of daysat <time-of-day>", -5.800102245661878),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.500819261531618),
                                    ("for <duration> from <time>December", -6.205567353770043),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.205567353770043),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.952804385274675),
                                    ("time-of-day (latent)this <part-of-day>", -6.205567353770043),
                                    ("Pentecostyear (latent)", -6.205567353770043),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.952804385274675),
                                    ("<day-of-month> (ordinal)February", -6.205567353770043),
                                    ("Eid al-Fitryear (latent)", -5.289276621895888),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.205567353770043),
                                    ("Mondayin|during the <part-of-day>", -6.205567353770043),
                                    ("Chhathin|during <named-month>|year", -6.205567353770043),
                                    ("Diwaliin|during <named-month>|year", -6.205567353770043),
                                    ("Vaisakhiin|during <named-month>|year", -6.205567353770043),
                                    ("Raksha Bandhanyear (latent)", -6.205567353770043),
                                    ("daysecond", -5.800102245661878),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.800102245661878),
                                    ("Ashurayear (latent)", -6.205567353770043),
                                    ("Tuesdayin|during <named-month>|year", -6.205567353770043),
                                    ("Chinese New Yearyear (latent)", -6.205567353770043),
                                    ("tomorrowintersect", -6.205567353770043),
                                    ("Lag BaOmeryear (latent)", -6.205567353770043),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.205567353770043),
                                    ("Eid al-Adhayear (latent)", -5.289276621895888),
                                    ("intersectin|during the <part-of-day>", -6.205567353770043),
                                    ("Palm Sundayyear (latent)", -6.205567353770043),
                                    ("Christmasat <time-of-day>", -6.205567353770043),
                                    ("Passoveryear (latent)", -6.205567353770043),
                                    ("Lazarus Saturdayyear (latent)", -6.205567353770043),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.205567353770043),
                                    ("Yom HaShoahyear (latent)", -5.800102245661878),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.800102245661878),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.205567353770043),
                                    ("Septemberyear (latent)", -5.800102245661878),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.701489956993768),
                                    ("Halloweenyear (latent)", -6.205567353770043),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.205567353770043),
                                    ("at <time-of-day>intersect", -5.800102245661878),
                                    ("Rosh Hashanahyear (latent)", -5.5124201732100975),
                                    ("Dhanterasyear (latent)", -6.205567353770043),
                                    ("Tu BiShvatyear (latent)", -6.205567353770043),
                                    ("<day-of-month> (ordinal)December", -5.5124201732100975),
                                    ("Holiyear (latent)", -5.5124201732100975),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.205567353770043),
                                    ("Holika Dahanyear (latent)", -5.5124201732100975),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.205567353770043),
                                    ("dayminute", -3.3433664728405743),
                                    ("Mawlidyear (latent)", -6.205567353770043),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.800102245661878),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.205567353770043),
                                    ("Jumu'atul-Widayear (latent)", -5.289276621895888),
                                    ("minuteday", -2.376925957280948),
                                    ("absorption of , after named dayintersect",
                                     -6.205567353770043),
                                    ("intersectyear (latent)", -6.205567353770043),
                                    ("Orthodox Easter Sundayyear (latent)", -6.205567353770043),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.205567353770043),
                                    ("Boss's Dayyear (latent)", -5.800102245661878),
                                    ("Global Youth Service Dayyear (latent)", -6.205567353770043),
                                    ("Dhanterasin|during <named-month>|year", -6.205567353770043),
                                    ("Tisha B'Avyear (latent)", -6.205567353770043),
                                    ("Isra and Mi'rajyear (latent)", -5.289276621895888),
                                    ("at <time-of-day>on <day>", -5.106955065101933),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.205567353770043),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.5124201732100975),
                                    ("Christmasyear (latent)", -5.800102245661878),
                                    ("Naraka Chaturdashiyear (latent)", -5.800102245661878),
                                    ("Thai Pongalin|during <named-month>|year", -6.205567353770043),
                                    ("dayweek", -6.205567353770043),
                                    ("Easter Sundayyear (latent)", -5.5124201732100975),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.596129441335942),
                                    ("weekyear", -5.106955065101933),
                                    ("hh:mmin|during the <part-of-day>", -5.5124201732100975),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.800102245661878),
                                    ("Hanukkahyear (latent)", -5.5124201732100975),
                                    ("February<time> <part-of-day>", -6.205567353770043),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.205567353770043),
                                    ("Great Lentyear (latent)", -6.205567353770043),
                                    ("tomorrowat <time-of-day>", -5.5124201732100975),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.205567353770043),
                                    ("Vaisakhiyear (latent)", -5.5124201732100975),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.205567353770043),
                                    ("last <cycle> of <time>year (latent)", -5.5124201732100975),
                                    ("at <time-of-day>tomorrow", -5.800102245661878),
                                    ("tomorrow<time-of-day> am|pm", -6.205567353770043),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.205567353770043),
                                    ("Diwaliyear (latent)", -6.205567353770043),
                                    ("between <time> and <time>on <day>", -4.596129441335942),
                                    ("Black Fridayyear (latent)", -5.800102245661878),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.205567353770043),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.205567353770043),
                                    ("Chhathyear (latent)", -5.800102245661878),
                                    ("Vasant Panchamiyear (latent)", -6.205567353770043),
                                    ("St Patrick's Dayyear (latent)", -6.205567353770043),
                                    ("Thursday<time> (timezone)", -6.205567353770043),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.205567353770043),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.800102245661878),
                                    ("Februaryintersect", -6.205567353770043),
                                    ("Simchat Torahyear (latent)", -6.205567353770043),
                                    ("minuteyear", -6.205567353770043)],
                               n = 374},
                   koData =
                     ClassData{prior = -0.929320232164489, unseen = -6.595780513961311,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.20935022918187393,
                               ...
                               n = 146},
                   koData =
                     ClassData{prior = -1.666596326274049, unseen = -3.6635616461296463,
                               likelihoods =
                                 HashMap.fromList
