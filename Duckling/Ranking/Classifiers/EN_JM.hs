...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47626389711997147,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.298949246855942),
                                    ...
                                    ("daymonth", -4.284046226313678),
                                    ("monthday", -5.8934841387477785),
                                    ("monthyear", -4.507189777627888),
                                    ...
                                    ("Krishna Janmashtamiyear (latent)", -5.8934841387477785),
                                    ...
                                    ("Octoberyear (latent)", -4.7948718500796685),
                                    ...
                                    ("<day-of-month> (ordinal)intersect", -5.8934841387477785),
                                    ...
                                    ("last weekend of <named-month>year (latent)",
                                     -6.298949246855942),
                                    ("Eid al-Adhayear (latent)", -4.1588830833596715),
                                    ...
                                    ("absorption of , after named dayintersect",
                                     -6.298949246855942),
                                    ("intersectyear (latent)", -6.298949246855942),
                               ...
                               n = 418},
                   koData =
                     ClassData{prior = -0.9704817844863017, unseen = -6.637258031284457,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.2347491740244907),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.942799375126701),
                                    ("<day-of-month> (ordinal)August", -5.942799375126701),
                                    ("dayhour", -3.3778500176651645),
                                    ("<time> timezoneyear (latent)", -5.942799375126701),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.026508643252546),
                                    ("Tuesdayfrom|since|after <time>", -5.942799375126701),
                                    ("daymonth", -3.457892725338701),
                                    ("monthyear", -4.690036406631333),
                                    ("<time-of-day> am|pmyear (latent)", -5.249652194566756),
                                    ("Thai Pongalyear (latent)", -5.249652194566756),
                                    ("intersecthh:mm", -5.942799375126701),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.537334267018537),
                                    ("<day-of-month> (ordinal)Wednesday", -5.942799375126701),
                                    ("houryear", -4.55650501400681),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.942799375126701),
                                    ("<day-of-month> (ordinal)October", -5.942799375126701),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.249652194566756),
                                    ("<time-of-day> am|pmintersect", -4.690036406631333),
                                    ("Octoberyear (latent)", -5.942799375126701),
                                    ("until <time>on <day>", -5.249652194566756),
                                    ("time-of-day (latent)intersect", -5.942799375126701),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.249652194566756),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.942799375126701),
                                    ("hh:mmon <day>", -3.5004523397574965),
                                    ("absorption of , after named dayJuly", -5.537334267018537),
                                    ("from|since|after <time>July", -5.537334267018537),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.026508643252546),
                                    ("Clean Mondayyear (latent)", -5.942799375126701),
                                    ("monthhour", -5.942799375126701),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.537334267018537),
                                    ("hourmonth", -4.070997198225109),
                                    ("todayat <time-of-day>", -5.942799375126701),
                                    ("from|since|after <time>December", -5.942799375126701),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.942799375126701),
                                    ("<time-of-day> am|pmon <day>", -4.690036406631333),
                                    ("Mondayyear (latent)", -5.249652194566756),
                                    ("dayday", -4.55650501400681),
                                    ("on <day>September", -5.537334267018537),
                                    ("time-of-day (latent)September", -5.537334267018537),
                                    ("hourhour", -5.942799375126701),
                                    ("time-of-day (latent)on <day>", -3.5004523397574965),
                                    ("Thursdaydd/mm", -5.942799375126701),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.537334267018537),
                                    ("dayyear", -3.025028643042422),
                                    ("New Year's Dayyear (latent)", -5.026508643252546),
                                    ("Thursdayfrom|since|after <time>", -4.238051282888276),
                                    ("Thursdayat <time-of-day>", -4.333361462692601),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.942799375126701),
                                    ("Aprilyear (latent)", -5.942799375126701),
                                    ("the <day-of-month> (ordinal)July", -5.942799375126701),
                                    ("the <day-of-month> (number)July", -5.942799375126701),
                                    ("monthminute", -5.942799375126701),
                                    ("<time-of-day> am|pmtomorrow", -5.942799375126701),
                                    ("Thursdayhh:mm", -5.026508643252546),
                                    ("<day-of-month> (ordinal)Tuesday", -5.537334267018537),
                                    ("minutemonth", -4.070997198225109),
                                    ("minutehour", -5.942799375126701),
                                    ("Augustyear (latent)", -5.537334267018537),
                                    ("week-endin|during <named-month>|year", -5.942799375126701),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.942799375126701),
                                    ("Sundayyear (latent)", -5.026508643252546),
                                    ("Christmasat <time-of-day>", -5.942799375126701),
                                    ("from|since|after <time>year (latent)", -4.844187086458591),
                                    ("<duration> after|before|from <time>December",
                                     -5.942799375126701),
                                    ("yesterday<time-of-day> am|pm", -5.942799375126701),
                                    ("<day-of-month> (ordinal)July", -5.249652194566756),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.942799375126701),
                                    ("at <time-of-day>intersect", -5.537334267018537),
                                    ("hh:mmyear (latent)", -3.863357833446865),
                                    ("Holiyear (latent)", -5.942799375126701),
                                    ("until <time><time-of-day> am|pm", -5.942799375126701),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.942799375126701),
                                    ("dayminute", -3.4170707308184456),
                                    ("yyyy-mm-ddhh:mm", -5.537334267018537),
                                    ("intersectSeptember", -4.438721978350427),
                                    ("minuteday", -2.7041209229623204),
                                    ("absorption of , after named dayintersect",
                                     -5.942799375126701),
                                    ("intersectyear (latent)", -5.942799375126701),
                                    ("Februaryin|during the <part-of-day>", -5.942799375126701),
                                    ("time-of-day (latent)July", -5.249652194566756),
                                    ("Saturdayyear (latent)", -5.942799375126701),
                                    ("at <time-of-day>on <day>", -5.537334267018537),
                                    ("absorption of , after named daySeptember",
                                     -5.026508643252546),
                                    ("Naraka Chaturdashiyear (latent)", -5.942799375126701),
                                    ("from|since|after <time>on <day>", -5.026508643252546),
                                    ("dayweek", -5.942799375126701),
                                    ("Easter Sundayyear (latent)", -5.537334267018537),
                                    ("Thursday<time-of-day> am|pm", -4.690036406631333),
                                    ("weekyear", -5.537334267018537),
                                    ("time-of-day (latent)Thursday", -5.537334267018537),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.942799375126701),
                                    ("<day-of-month> (ordinal)April", -5.942799375126701),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.537334267018537),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.249652194566756),
                                    ("Sundayfrom|since|after <time>", -5.942799375126701),
                                    ("absorption of , after named dayFebruary", -5.026508643252546),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.942799375126701),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.942799375126701),
                                    ("tomorrowat <time-of-day>", -5.942799375126701),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.537334267018537),
                                    ("last <cycle> of <time>year (latent)", -5.537334267018537),
                                    ("tomorrow<time-of-day> am|pm", -5.942799375126701),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.249652194566756),
                                    ("Diwaliyear (latent)", -5.537334267018537),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.942799375126701),
                                    ("Fridayyear (latent)", -5.537334267018537),
                                    ("time-of-day (latent)April", -5.942799375126701),
                                    ("minuteyear", -3.7455747977904816)],
                               n = 255}}),
       ("one eleven",
        Classifier{okData =
