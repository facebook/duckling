...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6522372778158192, unseen = -5.476463551931511,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 237},
                   koData =
                     ClassData{prior = -0.7358023561618614, unseen = -5.393627546352362,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4893028867502524, unseen = -6.556778356158042,
                               likelihoods =
                                 HashMap.fromList
                                   [("Ramadanyear (latent)", -5.86220971125072),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.609446742755352),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.609446742755352),
                                    ("hourday", -4.157461619012294),
                                    ("dayhour", -2.9444389791664407),
                                    ("Martin Luther King's Dayyear (latent)", -5.456744603142555),
                                    ("Shemini Atzeretyear (latent)", -5.86220971125072),
                                    ("daymonth", -5.169062530690774),
                                    ("monthday", -5.456744603142555),
                                    ("monthyear", -4.252771798816619),
                                    ("Yom Ha'atzmautyear (latent)", -5.86220971125072),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.86220971125072),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.86220971125072),
                                    ("houryear", -5.169062530690774),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.86220971125072),
                                    ("Christmas<time-of-day> am|pm", -5.86220971125072),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.86220971125072),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.169062530690774),
                                    ("<time-of-day> am|pmintersect", -4.609446742755352),
                                    ("Octoberyear (latent)", -4.609446742755352),
                                    ("intersect<time-of-day> am|pm", -5.86220971125072),
                                    ("Shavuotyear (latent)", -5.86220971125072),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.86220971125072),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.86220971125072),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.456744603142555),
                                    ("Marchyear (latent)", -5.86220971125072),
                                    ("Sukkotyear (latent)", -5.456744603142555),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.86220971125072),
                                    ("Clean Mondayyear (latent)", -5.456744603142555),
                                    ("monthhour", -5.456744603142555),
                                    ("todayat <time-of-day>", -5.86220971125072),
                                    ("Thursday<time> timezone", -4.157461619012294),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -5.86220971125072),
                                    ("Palm SundaySunday", -5.456744603142555),
                                    ("dayday", -3.6649851339145),
                                    ("<time> <part-of-day>at <time-of-day>", -5.86220971125072),
                                    ("tonightat <time-of-day>", -5.86220971125072),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.169062530690774),
                                    ("today<time-of-day> am|pm", -5.86220971125072),
                                    ("Februarythe <day-of-month> (ordinal)", -5.456744603142555),
                                    ("at <time-of-day><time> <part-of-day>", -5.86220971125072),
                                    ("hourhour", -4.609446742755352),
                                    ("<time-of-day> am|pmon <date>", -3.847306690708455),
                                    ("Wednesdaythis|last|next <cycle>", -5.86220971125072),
                                    ("Lentyear (latent)", -5.86220971125072),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.358132314474446),
                                    ("dayyear", -2.3212503872134054),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.86220971125072),
                                    ("Thursdayat <time-of-day>", -5.456744603142555),
                                    ("Islamic New Yearyear (latent)", -5.456744603142555),
                                    ("Laylat al-Qadryear (latent)", -4.9459189793765646),
                                    ("Shrove Tuesdayyear (latent)", -5.86220971125072),
                                    ("<time-of-day> am|pmtomorrow", -5.169062530690774),
                                    ("Yom Kippuryear (latent)", -5.86220971125072),
                                    ("<part-of-day> of <time>year (latent)", -5.86220971125072),
                                    ("minutehour", -4.9459189793765646),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.456744603142555),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.157461619012294),
                                    ("for <duration> from <time>December", -5.86220971125072),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.86220971125072),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.9459189793765646),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.456744603142555),
                                    ("Pentecostyear (latent)", -5.86220971125072),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.9459189793765646),
                                    ("Eid al-Fitryear (latent)", -5.86220971125072),
                                    ("Mondayin|during the <part-of-day>", -5.86220971125072),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.456744603142555),
                                    ("Ashurayear (latent)", -5.86220971125072),
                                    ("Chinese New Yearyear (latent)", -5.86220971125072),
                                    ("Sundayyear (latent)", -5.86220971125072),
                                    ("Lag BaOmeryear (latent)", -5.86220971125072),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.86220971125072),
                                    ("Eid al-Adhayear (latent)", -4.9459189793765646),
                                    ("intersectin|during the <part-of-day>", -5.86220971125072),
                                    ("Christmasat <time-of-day>", -5.86220971125072),
                                    ("Passoveryear (latent)", -5.86220971125072),
                                    ("Lazarus Saturdayyear (latent)", -5.86220971125072),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.86220971125072),
                                    ("Yom HaShoahyear (latent)", -5.456744603142555),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.9459189793765646),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.86220971125072),
                                    ("Septemberyear (latent)", -5.456744603142555),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.609446742755352),
                                    ("Halloweenyear (latent)", -5.86220971125072),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.169062530690774),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -4.9459189793765646),
                                    ("at <time-of-day>intersect", -5.456744603142555),
                                    ("Rosh Hashanahyear (latent)", -5.86220971125072),
                                    ("Tu BiShvatyear (latent)", -5.86220971125072),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.86220971125072),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.86220971125072),
                                    ("dayminute", -3.297260353789183),
                                    ("Mawlidyear (latent)", -5.86220971125072),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.456744603142555),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.86220971125072),
                                    ("Jumu'atul-Widayear (latent)", -4.9459189793765646),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.86220971125072),
                                    ("minuteday", -2.2246235515243336),
                                    ("absorption of , after named dayintersect", -5.86220971125072),
                                    ("intersectyear (latent)", -5.86220971125072),
                                    ("Orthodox Easter Sundayyear (latent)", -5.86220971125072),
                                    ("<ordinal> <cycle> of <time>year (latent)", -5.86220971125072),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.86220971125072),
                                    ("Boss's Dayyear (latent)", -5.456744603142555),
                                    ("Tisha B'Avyear (latent)", -5.86220971125072),
                                    ("Isra and Mi'rajyear (latent)", -4.9459189793765646),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.86220971125072),
                                    ("Christmasyear (latent)", -5.456744603142555),
                                    ("at <time-of-day>on <date>", -4.76359742258261),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.252771798816619),
                                    ("dayweek", -5.86220971125072),
                                    ("Easter Sundayyear (latent)", -5.169062530690774),
                                    ("Thursday<time-of-day> am|pm", -5.86220971125072),
                                    ("weekyear", -5.456744603142555),
                                    ("hh:mmin|during the <part-of-day>", -5.169062530690774),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.456744603142555),
                                    ("Hanukkahyear (latent)", -5.86220971125072),
                                    ("February<time> <part-of-day>", -5.86220971125072),
                                    ("Tuesdayin <named-month>|year", -5.86220971125072),
                                    ("Great Lentyear (latent)", -5.86220971125072),
                                    ("tomorrowat <time-of-day>", -5.169062530690774),
                                    ("between <time> and <time>on <date>", -4.252771798816619),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.169062530690774),
                                    ("last <cycle> of <time>year (latent)", -5.169062530690774),
                                    ("at <time-of-day>tomorrow", -5.456744603142555),
                                    ("tomorrow<time-of-day> am|pm", -5.86220971125072),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.86220971125072),
                                    ("Black Fridayyear (latent)", -5.456744603142555),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.86220971125072),
                                    ("Palm Sundayintersect", -5.86220971125072),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.86220971125072),
                                    ("Februaryintersect", -5.86220971125072),
                                    ("Simchat Torahyear (latent)", -5.86220971125072)],
                               n = 263},
                   koData =
                     ClassData{prior = -0.9494691305714738, unseen = -6.234410725718371,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.539300835990577),
                                    ("hourday", -5.539300835990577),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.539300835990577),
                                    ("dayhour", -3.2367157429965316),
                                    ("daymonth", -3.459859294310742),
                                    ("monthday", -5.133835727882413),
                                    ("monthyear", -4.286537867495209),
                                    ("<time-of-day> am|pmyear (latent)", -5.133835727882413),
                                    ("intersecthh:mm", -5.539300835990577),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.539300835990577),
                                    ("houryear", -4.623010104116422),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.539300835990577),
                                    ("until <time-of-day><time-of-day> am|pm", -5.539300835990577),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.846153655430633),
                                    ("<time-of-day> am|pmintersect", -4.286537867495209),
                                    ("Octoberyear (latent)", -5.539300835990577),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.286537867495209),
                                    ("from|since|after <time-of-day>on <date>", -4.623010104116422),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.539300835990577),
                                    ("absorption of , after named dayJuly", -5.133835727882413),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.623010104116422),
                                    ("Clean Mondayyear (latent)", -5.539300835990577),
                                    ("monthhour", -5.539300835990577),
                                    ("hourmonth", -4.846153655430633),
                                    ("todayat <time-of-day>", -5.539300835990577),
                                    ("from|since|after <time-of-day>July", -5.539300835990577),
                                    ("Mondayyear (latent)", -4.846153655430633),
                                    ("dayday", -5.133835727882413),
                                    ("<time-of-day> am|pmon <date>", -4.286537867495209),
                                    ("Thursdaydd/mm", -5.539300835990577),
                                    ("dayyear", -2.7984608120653767),
                                    ("New Year's Dayyear (latent)", -5.133835727882413),
                                    ("Thursdayat <time-of-day>", -4.286537867495209),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.539300835990577),
                                    ("Aprilyear (latent)", -5.539300835990577),
                                    ("monthminute", -5.539300835990577),
                                    ("<time-of-day> am|pmtomorrow", -5.539300835990577),
                                    ("Thursdayhh:mm", -4.623010104116422),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.539300835990577),
                                    ("minutemonth", -3.7475413667625226),
                                    ("Sundayfrom|since|after <time-of-day>", -5.539300835990577),
                                    ("week-endin <named-month>|year", -5.539300835990577),
                                    ("Augustyear (latent)", -5.133835727882413),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.133835727882413),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.133835727882413),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.539300835990577),
                                    ("Sundayyear (latent)", -4.846153655430633),
                                    ("Christmasat <time-of-day>", -5.539300835990577),
                                    ("<duration> after|before|from <time>December",
                                     -5.539300835990577),
                                    ("yesterday<time-of-day> am|pm", -5.539300835990577),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.539300835990577),
                                    ("until <time-of-day>on <date>", -4.846153655430633),
                                    ("at <time-of-day>intersect", -5.133835727882413),
                                    ("hh:mmyear (latent)", -4.440688547322468),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.539300835990577),
                                    ("dayminute", -3.096953800621373),
                                    ("intersectSeptember", -4.035223439214303),
                                    ("minuteday", -2.4712479008569606),
                                    ("absorption of , after named dayintersect",
                                     -5.539300835990577),
                                    ("Februaryin|during the <part-of-day>", -5.539300835990577),
                                    ("hh:mmon <date>", -3.5243978154483124),
                                    ("Saturdayyear (latent)", -5.539300835990577),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.539300835990577),
                                    ("absorption of , after named daySeptember",
                                     -4.623010104116422),
                                    ("on <date>September", -5.133835727882413),
                                    ("at <time-of-day>on <date>", -5.133835727882413),
                                    ("in <named-month>|yearyear (latent)", -5.539300835990577),
                                    ("dayweek", -5.539300835990577),
                                    ("Easter Sundayyear (latent)", -5.133835727882413),
                                    ("Thursday<time-of-day> am|pm", -5.133835727882413),
                                    ("absorption of , after named dayFebruary", -4.623010104116422),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.539300835990577),
                                    ("tomorrowat <time-of-day>", -5.539300835990577),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.539300835990577),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.929862923556477),
                                    ("tomorrow<time-of-day> am|pm", -5.539300835990577),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.846153655430633),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.539300835990577),
                                    ("Fridayyear (latent)", -5.133835727882413),
                                    ("minuteyear", -4.286537867495209)],
                               n = 166}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.21588838043303787,
                               unseen = -4.477336814478207,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -5.918887139033065e-2),
                                    ("intersect 2 numbers", -3.367295829986474)],
                               n = 83},
                   koData =
                     ClassData{prior = -1.6389967146756448,
                               unseen = -3.2188758248682006,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -1.2321436812926323),
                                    ("negative numbers", -0.6131044728864089),
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.1421744887805426, unseen = -5.123963979403259,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.4789364828014966),
                                    ("integer (0..19)year (grain)", -3.3262343431887),
                                    ("integer (numeric)day (grain)", -2.7200985396183843),
                                    ("integer (0..19)second (grain) ", -3.7316994512968646),
                                    ("integer (0..19)hour (grain)", -3.0385522707369192),
                                    ("second", -3.3262343431887),
                                    ("integer (numeric)second (grain) ", -4.019381523748645),
                                    ("integer (numeric)year (grain)", -3.3262343431887),
                                    ("day", -2.409943611314545), ("year", -2.7200985396183843),
                                    ("integer (numeric)week (grain)", -3.0385522707369192),
                                    ("integer (0..19)month (grain)", -3.508555899982655),
                                    ("hour", -2.6330871626287546), ("month", -3.172083663361442),
                                    ("integer (numeric)minute (grain)", -3.172083663361442),
                                    ("integer (0..19)minute (grain)", -3.0385522707369192),
                                    ("integer (numeric)month (grain)", -4.019381523748645),
                                    ("minute", -2.4789364828014966),
                                    ("integer (numeric)hour (grain)", -3.508555899982655),
                                    ("integer (0..19)day (grain)", -3.508555899982655),
                                    ("integer (0..19)week (grain)", -3.172083663361442)],
                               n = 72},
                   koData =
                     ClassData{prior = -2.020945334998227, unseen = -3.828641396489095,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("October", -1.7047480922384253),
                                    ...
                                    ("year", -1.7047480922384253), ("March", -1.7047480922384253),
