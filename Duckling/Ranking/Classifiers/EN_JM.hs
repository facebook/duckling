...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6001841135817264, unseen = -5.953243334287785,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 383},
                   koData =
                     ClassData{prior = -0.7956464639367394, unseen = -5.75890177387728,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47684177095039215,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.302618975744905),
                                    ...
                                    ("hourday", -4.28771595520264),
                                    ("dayhour", -3.3581799965784644),
                                    ...
                                    ("Krishna Janmashtamiyear (latent)", -5.8971538676367405),
                                    ...
                                    ("todayin|within|after <duration>", -6.302618975744905),
                                    ...
                                    ("Guru Ravidass Jayantiyear (latent)", -5.049856007249537),
                                    ...
                                    ("last weekend of <named-month>year (latent)",
                                     -6.302618975744905),
                                    ("Eid al-Adhayear (latent)", -4.162552812248634),
                                    ...
                                    ("Rabindra Jayantiyear (latent)", -5.049856007249537),
                               ...
                               n = 419},
                   koData =
                     ClassData{prior = -0.9695352463929674, unseen = -6.642486801367256,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.239984788078436),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.948034989180646),
                                    ("<day-of-month> (ordinal)August", -5.948034989180646),
                                    ("dayhour", -3.3830856317191094),
                                    ("<time> timezoneyear (latent)", -5.948034989180646),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.0317442573064906),
                                    ("Tuesdayfrom|since|after <time>", -5.948034989180646),
                                    ("daymonth", -3.4631283393926457),
                                    ("monthyear", -4.695272020685278),
                                    ("<time-of-day> am|pmyear (latent)", -5.2548878086207),
                                    ("Thai Pongalyear (latent)", -5.2548878086207),
                                    ("intersecthh:mm", -5.948034989180646),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.542569881072482),
                                    ("<day-of-month> (ordinal)Wednesday", -5.948034989180646),
                                    ("houryear", -4.561740628060756),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.948034989180646),
                                    ("<day-of-month> (ordinal)October", -5.948034989180646),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.2548878086207),
                                    ("<time-of-day> am|pmintersect", -4.695272020685278),
                                    ("Octoberyear (latent)", -5.948034989180646),
                                    ("until <time>on <day>", -5.2548878086207),
                                    ("time-of-day (latent)intersect", -5.948034989180646),
                                    ("todayin <number> (implicit minutes)", -5.948034989180646),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.2548878086207),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.948034989180646),
                                    ("hh:mmon <day>", -3.5056879538114414),
                                    ("absorption of , after named dayJuly", -5.542569881072482),
                                    ("from|since|after <time>July", -5.542569881072482),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.0317442573064906),
                                    ("Clean Mondayyear (latent)", -5.948034989180646),
                                    ("monthhour", -5.948034989180646),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.542569881072482),
                                    ("hourmonth", -4.076232812279055),
                                    ("todayat <time-of-day>", -5.948034989180646),
                                    ("from|since|after <time>December", -5.948034989180646),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.948034989180646),
                                    ("<time-of-day> am|pmon <day>", -4.695272020685278),
                                    ("Mondayyear (latent)", -5.2548878086207),
                                    ("dayday", -4.561740628060756),
                                    ("on <day>September", -5.542569881072482),
                                    ("time-of-day (latent)September", -5.542569881072482),
                                    ("hourhour", -5.948034989180646),
                                    ("time-of-day (latent)on <day>", -3.5056879538114414),
                                    ("Thursdaydd/mm", -5.948034989180646),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.542569881072482),
                                    ("dayyear", -3.0302642570963667),
                                    ("New Year's Dayyear (latent)", -5.0317442573064906),
                                    ("Thursdayfrom|since|after <time>", -4.24328689694222),
                                    ("Thursdayat <time-of-day>", -4.338597076746546),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.948034989180646),
                                    ("Aprilyear (latent)", -5.948034989180646),
                                    ("the <day-of-month> (ordinal)July", -5.948034989180646),
                                    ("the <day-of-month> (number)July", -5.948034989180646),
                                    ("monthminute", -5.948034989180646),
                                    ("<time-of-day> am|pmtomorrow", -5.948034989180646),
                                    ("Thursdayhh:mm", -5.0317442573064906),
                                    ("<day-of-month> (ordinal)Tuesday", -5.542569881072482),
                                    ("minutemonth", -4.076232812279055),
                                    ("minutehour", -5.948034989180646),
                                    ("Augustyear (latent)", -5.542569881072482),
                                    ("week-endin|during <named-month>|year", -5.948034989180646),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.948034989180646),
                                    ("Sundayyear (latent)", -5.0317442573064906),
                                    ("Christmasat <time-of-day>", -5.948034989180646),
                                    ("from|since|after <time>year (latent)", -4.8494227005125365),
                                    ("<duration> after|before|from <time>December",
                                     -5.948034989180646),
                                    ("yesterday<time-of-day> am|pm", -5.948034989180646),
                                    ("<day-of-month> (ordinal)July", -5.2548878086207),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.948034989180646),
                                    ("at <time-of-day>intersect", -5.542569881072482),
                                    ("hh:mmyear (latent)", -3.86859344750081),
                                    ("Holiyear (latent)", -5.948034989180646),
                                    ("until <time><time-of-day> am|pm", -5.948034989180646),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.948034989180646),
                                    ("dayminute", -3.3830856317191094),
                                    ("yyyy-mm-ddhh:mm", -5.542569881072482),
                                    ("intersectSeptember", -4.443957592404372),
                                    ("minuteday", -2.7093565370162653),
                                    ("absorption of , after named dayintersect",
                                     -5.948034989180646),
                                    ("intersectyear (latent)", -5.948034989180646),
                                    ("Februaryin|during the <part-of-day>", -5.948034989180646),
                                    ("time-of-day (latent)July", -5.2548878086207),
                                    ("Saturdayyear (latent)", -5.948034989180646),
                                    ("at <time-of-day>on <day>", -5.542569881072482),
                                    ("absorption of , after named daySeptember",
                                     -5.0317442573064906),
                                    ("Naraka Chaturdashiyear (latent)", -5.948034989180646),
                                    ("from|since|after <time>on <day>", -5.0317442573064906),
                                    ("dayweek", -5.948034989180646),
                                    ("Easter Sundayyear (latent)", -5.542569881072482),
                                    ("Thursday<time-of-day> am|pm", -4.695272020685278),
                                    ("weekyear", -5.542569881072482),
                                    ("time-of-day (latent)Thursday", -5.542569881072482),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.948034989180646),
                                    ("<day-of-month> (ordinal)April", -5.948034989180646),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.542569881072482),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.2548878086207),
                                    ("Sundayfrom|since|after <time>", -5.948034989180646),
                                    ...
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.948034989180646),
                                    ("tomorrowat <time-of-day>", -5.948034989180646),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.542569881072482),
                                    ("last <cycle> of <time>year (latent)", -5.542569881072482),
                                    ("tomorrow<time-of-day> am|pm", -5.948034989180646),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.2548878086207),
                                    ("Diwaliyear (latent)", -5.542569881072482),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.948034989180646),
                                    ("Fridayyear (latent)", -5.542569881072482),
                                    ("time-of-day (latent)April", -5.948034989180646),
                                    ("minuteyear", -3.7508104118444265)],
                               n = 256}}),
       ("one eleven",
        Classifier{okData =
