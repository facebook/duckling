...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.552134456283134, unseen = -6.135564891081739,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 460},
                   koData =
                     ClassData{prior = -0.8573608383858243, unseen = -5.831882477283517,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4664476183865164, unseen = -7.156176637480615,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.4622491213367885),
                                    ...
                                    ("daymonth", -4.447346100794524),
                                    ("monthday", -6.056784013228625),
                                    ("monthyear", -4.670489652108734),
                                    ...
                                    ("Februarythe <day-of-month> (ordinal)", -6.056784013228625),
                                    ...
                                    ("dayyear", -1.9296496281835331),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.4622491213367885),
                                    ("Thursdayfrom|since|after <time>", -6.056784013228625),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.4622491213367885),
                                    ...
                                    ("<time-of-day> am|pmtomorrow", -5.769101940776844),
                                    ("Yom Kippuryear (latent)", -6.4622491213367885),
                                    ("<day-of-month> (ordinal)Tuesday", -6.056784013228625),
                                    ...
                                    ("intersectin|during the <part-of-day>", -6.4622491213367885),
                                    ...
                                    ("<datetime> - <datetime> (interval)July", -6.056784013228625),
                               ...
                               n = 493},
                   koData =
                     ClassData{prior = -0.9867841834121394, unseen = -6.782192056006791,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.58383304859996),
                                    ("hourday", -3.690015172577864),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.0879104453762345),
                                    ("<day-of-month> (ordinal)August", -6.0879104453762345),
                                    ("dayhour", -3.5229610879146973),
                                    ("<time> timezoneyear (latent)", -5.394763264816289),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.171619713502079),
                                    ("Tuesdayfrom|since|after <time>", -5.394763264816289),
                                    ("daymonth", -3.4137617959497053),
                                    ("monthyear", -4.835147476880866),
                                    ("<time-of-day> am|pmyear (latent)", -5.394763264816289),
                                    ("Thai Pongalyear (latent)", -5.394763264816289),
                                    ("intersecthh:mm", -6.0879104453762345),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.68244533726807),
                                    ("<day-of-month> (ordinal)Wednesday", -6.0879104453762345),
                                    ("houryear", -4.701616084256344),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.0879104453762345),
                                    ("<day-of-month> (ordinal)October", -6.0879104453762345),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.394763264816289),
                                    ("hournograin", -4.835147476880866),
                                    ("<time-of-day> am|pmintersect", -4.835147476880866),
                                    ("Octoberyear (latent)", -6.0879104453762345),
                                    ("Good Fridayyear (latent)", -6.0879104453762345),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.68244533726807),
                                    ("early morningat <time-of-day>", -6.0879104453762345),
                                    ("until <time>on <day>", -5.394763264816289),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.0879104453762345),
                                    ("time-of-day (latent)intersect", -5.394763264816289),
                                    ("todayin <number> (implicit minutes)", -6.0879104453762345),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.394763264816289),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.0879104453762345),
                                    ("hh:mmon <day>", -4.835147476880866),
                                    ("hhhmmintersect", -5.68244533726807),
                                    ("absorption of , after named dayJuly", -5.171619713502079),
                                    ("from|since|after <time>July", -5.68244533726807),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.171619713502079),
                                    ("Clean Mondayyear (latent)", -6.0879104453762345),
                                    ("monthhour", -6.0879104453762345),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.68244533726807),
                                    ("hourmonth", -4.216108268474643),
                                    ("todayat <time-of-day>", -6.0879104453762345),
                                    ("hhhmmyear (latent)", -4.835147476880866),
                                    ("from|since|after <time>December", -6.0879104453762345),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.0879104453762345),
                                    ("<time-of-day> am|pmon <day>", -4.835147476880866),
                                    ("Mondayyear (latent)", -5.394763264816289),
                                    ("dayday", -4.073007424833969),
                                    ("on <day>September", -5.394763264816289),
                                    ("time-of-day (latent)September", -5.68244533726807),
                                    ("hourhour", -4.008468903696398),
                                    ("time-of-day (latent)on <day>", -4.58383304859996),
                                    ("Thursdaydd/mm", -6.0879104453762345),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.68244533726807),
                                    ("dayyear", -3.092178171822243),
                                    ("New Year's Dayyear (latent)", -5.171619713502079),
                                    ("time-of-day (latent)Sunday", -5.68244533726807),
                                    ("Thursdayfrom|since|after <time>", -4.383162353137809),
                                    ("Thursdayat <time-of-day>", -4.478472532942134),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.0879104453762345),
                                    ("Aprilyear (latent)", -6.0879104453762345),
                                    ("the <day-of-month> (ordinal)July", -6.0879104453762345),
                                    ("the <day-of-month> (number)July", -6.0879104453762345),
                                    ("monthminute", -6.0879104453762345),
                                    ("<time-of-day> am|pmtomorrow", -6.0879104453762345),
                                    ("Thursdayhh:mm", -5.171619713502079),
                                    ("<day-of-month> (ordinal)Tuesday", -5.68244533726807),
                                    ("minutemonth", -3.9478442818799633),
                                    ("time-of-day (latent)Friday", -5.68244533726807),
                                    ("minutehour", -6.0879104453762345),
                                    ("part of daysat <time-of-day>", -4.9892981567081245),
                                    ("Augustyear (latent)", -5.68244533726807),
                                    ("Orthodox Great Fridayyear (latent)", -6.0879104453762345),
                                    ("week-endin|during <named-month>|year", -6.0879104453762345),
                                    ("time-of-day (latent)Tuesday", -5.68244533726807),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.0879104453762345),
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.0879104453762345),
                                    ("Sundayyear (latent)", -5.171619713502079),
                                    ("the <day-of-month> (ordinal)Monday", -5.394763264816289),
                                    ("Christmasat <time-of-day>", -6.0879104453762345),
                                    ("from|since|after <time>year (latent)", -4.9892981567081245),
                                    ("hhhmmon <day>", -5.171619713502079),
                                    ("yesterday<time-of-day> am|pm", -6.0879104453762345),
                                    ("<day-of-month> (ordinal)July", -5.394763264816289),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.0879104453762345),
                                    ("at <time-of-day>intersect", -5.171619713502079),
                                    ("hh:mmyear (latent)", -4.701616084256344),
                                    ("Holiyear (latent)", -6.0879104453762345),
                                    ("until <time><time-of-day> am|pm", -6.0879104453762345),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.68244533726807),
                                    ("dayminute", -3.2546971013200183),
                                    ("yyyy-mm-ddhh:mm", -5.68244533726807),
                                    ("intersectfrom|since|after <time>", -5.68244533726807),
                                    ("intersectSeptember", -4.216108268474643),
                                    ("minuteday", -2.930910024226121),
                                    ("absorption of , after named dayintersect",
                                     -6.0879104453762345),
                                    ("intersectyear (latent)", -6.0879104453762345),
                                    ("Februaryin|during the <part-of-day>", -6.0879104453762345),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.0879104453762345),
                                    ("time-of-day (latent)July", -5.394763264816289),
                                    ("Saturdayyear (latent)", -6.0879104453762345),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0879104453762345),
                                    ("<day-of-month> (ordinal)Monday", -5.171619713502079),
                                    ("at <time-of-day>on <day>", -5.171619713502079),
                                    ("absorption of , after named daySeptember",
                                     -4.835147476880866),
                                    ("Naraka Chaturdashiyear (latent)", -6.0879104453762345),
                                    ("from|since|after <time>on <day>", -5.171619713502079),
                                    ("dayweek", -6.0879104453762345),
                                    ("Easter Sundayyear (latent)", -5.68244533726807),
                                    ("Thursday<time-of-day> am|pm", -4.835147476880866),
                                    ("weekyear", -5.68244533726807),
                                    ("time-of-day (latent)Thursday", -5.68244533726807),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.0879104453762345),
                                    ("<day-of-month> (ordinal)April", -6.0879104453762345),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.68244533726807),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.394763264816289),
                                    ("Sundayfrom|since|after <time>", -6.0879104453762345),
                                    ("absorption of , after named dayFebruary", -5.171619713502079),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.68244533726807),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.0879104453762345),
                                    ("tomorrowat <time-of-day>", -6.0879104453762345),
                                    ("daynograin", -5.68244533726807),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.68244533726807),
                                    ("last <cycle> of <time>year (latent)", -5.68244533726807),
                                    ("tomorrow<time-of-day> am|pm", -6.0879104453762345),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.394763264816289),
                                    ("Diwaliyear (latent)", -5.68244533726807),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.0879104453762345),
                                    ("this <part-of-day>at <time-of-day>", -5.171619713502079),
                                    ("Fridayyear (latent)", -5.394763264816289),
                                    ("time-of-day (latent)April", -6.0879104453762345),
                                    ("minuteyear", -3.890685868040015)],
                               n = 293}}),
       ("one eleven",
        Classifier{okData =
