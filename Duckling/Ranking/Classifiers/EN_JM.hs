...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("at <time-of-day>",
        Classifier{okData =
                     ClassData{prior = -7.095173597228449e-2,
                               unseen = -5.0106352940962555,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time> timezone", -3.9053340172773496),
                                    ("noon|midnight|EOD|end of day", -3.9053340172773496),
                                    ("integer after|past <hour-of-day>", -3.9053340172773496),
                                    ("half after|past <hour-of-day>", -4.310799125385514),
                                    ("<hour-of-day> <integer>", -3.9053340172773496),
                                    ("time-of-day (latent)", -1.6717417957702552),
                                    ("hhmm (latent)", -3.6176519448255684),
                                    ("<time-of-day> am|pm", -1.8258924755975137),
                                    ("hh:mm", -3.6176519448255684),
                                    ("about|exactly <time-of-day>", -3.9053340172773496),
                                    ("hour", -1.0527025873640319),
                                    ("<time-of-day> sharp|exactly", -4.310799125385514),
                                    ("minute", -2.1135745480492942)],
                               n = 68},
                   koData =
                     ClassData{prior = -2.681021528714291, unseen = -3.1780538303479458,
                               likelihoods =
                                 HashMap.fromList
                                   [("time-of-day (latent)", -1.3437347467010947),
                                    ("hour", -1.3437347467010947)],
                               n = 5}}),
       ("December",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.6094379124341003,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47816693988489656, unseen = -6.71174039505618,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.017375928892483),
                                    ...
                                    ("Dhanterasin <named-month>|year", -6.017375928892483),
                                    ...
                                    ("Thursday<time> timezone", -4.312627836654058),
                                    ("from|since|after <time>December", -6.017375928892483),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.017375928892483),
                                    ("Palm SundaySunday", -5.611910820784319),
                                    ("dayday", -3.8201513515562633),
                                    ...
                                    ("dayyear", -2.0283918823282088),
                                    ("Thursdayfrom|since|after <time>", -5.611910820784319),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.017375928892483),
                                    ("Thursdayat <time-of-day>", -5.611910820784319),
                                    ("Islamic New Yearyear (latent)", -5.611910820784319),
                                    ("Laylat al-Qadryear (latent)", -5.101085197018328),
                                    ("Chhathin <named-month>|year", -6.017375928892483),
                                    ("Vasant Panchamiin <named-month>|year", -6.017375928892483),
                                    ("Diwaliin <named-month>|year", -6.017375928892483),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.611910820784319),
                                    ("Navaratriin <named-month>|year", -6.017375928892483),
                                    ("Ashurayear (latent)", -6.017375928892483),
                                    ("Chinese New Yearyear (latent)", -6.017375928892483),
                                    ("Sundayyear (latent)", -6.017375928892483),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.017375928892483),
                                    ("Thai Pongalin <named-month>|year", -6.017375928892483),
                                    ...
                                    ("absorption of , after named dayintersect",
                                     -6.017375928892483),
                                    ("intersectyear (latent)", -6.017375928892483),
                                    ...
                                    ("Tuesdayin <named-month>|year", -6.017375928892483),
                                    ...
                                    ("Palm Sundayintersect", -6.017375928892483),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.017375928892483),
                               ...
                               n = 305},
                   koData =
                     ClassData{prior = -0.9673700996377216, unseen = -6.373319789577012,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.762173934797756),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.678464666671911),
                                    ("dayhour", -3.2361176313027067),
                                    ("Tuesdayfrom|since|after <time>", -5.678464666671911),
                                    ("daymonth", -3.53839850317564),
                                    ("monthday", -5.272999558563747),
                                    ("monthyear", -4.425701698176543),
                                    ("<time-of-day> am|pmyear (latent)", -5.272999558563747),
                                    ("Thai Pongalyear (latent)", -4.985317486111966),
                                    ("intersecthh:mm", -5.678464666671911),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.678464666671911),
                                    ("houryear", -4.762173934797756),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.678464666671911),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.985317486111966),
                                    ("<time-of-day> am|pmintersect", -4.425701698176543),
                                    ("until <time>on <date>", -4.985317486111966),
                                    ("Octoberyear (latent)", -5.678464666671911),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.678464666671911),
                                    ("absorption of , after named dayJuly", -5.272999558563747),
                                    ("from|since|after <time>July", -5.678464666671911),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.762173934797756),
                                    ("Clean Mondayyear (latent)", -5.678464666671911),
                                    ("monthhour", -5.678464666671911),
                                    ("hourmonth", -4.762173934797756),
                                    ("todayat <time-of-day>", -5.678464666671911),
                                    ("from|since|after <time>December", -5.678464666671911),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.678464666671911),
                                    ("Mondayyear (latent)", -4.985317486111966),
                                    ("dayday", -5.272999558563747),
                                    ("<time-of-day> am|pmon <date>", -4.425701698176543),
                                    ("Thursdaydd/mm", -5.678464666671911),
                                    ("dayyear", -2.7340256875054707),
                                    ("New Year's Dayyear (latent)", -5.272999558563747),
                                    ("Thursdayfrom|since|after <time>", -3.973716574433486),
                                    ("Thursdayat <time-of-day>", -4.425701698176543),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.678464666671911),
                                    ("Aprilyear (latent)", -5.678464666671911),
                                    ("this <time><time-of-day> am|pm", -5.678464666671911),
                                    ("monthminute", -5.678464666671911),
                                    ("<time-of-day> am|pmtomorrow", -5.678464666671911),
                                    ("Thursdayhh:mm", -4.762173934797756),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.678464666671911),
                                    ("minutemonth", -3.886705197443856),
                                    ("week-endin <named-month>|year", -5.678464666671911),
                                    ("Augustyear (latent)", -5.272999558563747),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.272999558563747),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.272999558563747),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.678464666671911),
                                    ("Sundayyear (latent)", -4.985317486111966),
                                    ("Christmasat <time-of-day>", -5.678464666671911),
                                    ("from|since|after <time>year (latent)", -4.425701698176543),
                                    ("<duration> after|before|from <time>December",
                                     -5.678464666671911),
                                    ("yesterday<time-of-day> am|pm", -5.678464666671911),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.678464666671911),
                                    ("at <time-of-day>intersect", -5.272999558563747),
                                    ("hh:mmyear (latent)", -4.579852378003801),
                                    ("Holiyear (latent)", -5.678464666671911),
                                    ("until <time><time-of-day> am|pm", -5.678464666671911),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.678464666671911),
                                    ("dayminute", -3.0757749812275272),
                                    ("intersectSeptember", -4.174387269895637),
                                    ("minuteday", -2.610411731538294),
                                    ("absorption of , after named dayintersect",
                                     -5.678464666671911),
                                    ("Februaryin|during the <part-of-day>", -5.678464666671911),
                                    ("hh:mmon <date>", -3.6635616461296463),
                                    ("Saturdayyear (latent)", -5.678464666671911),
                                    ("from|since|after <time>on <date>", -4.762173934797756),
                                    ("absorption of , after named daySeptember",
                                     -4.762173934797756),
                                    ("Naraka Chaturdashiyear (latent)", -5.678464666671911),
                                    ("on <date>September", -5.272999558563747),
                                    ("at <time-of-day>on <date>", -5.272999558563747),
                                    ("in <named-month>|yearyear (latent)", -5.678464666671911),
                                    ("dayweek", -5.678464666671911),
                                    ("Easter Sundayyear (latent)", -5.272999558563747),
                                    ("Thursday<time-of-day> am|pm", -4.762173934797756),
                                    ("weekyear", -5.272999558563747),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.678464666671911),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -4.985317486111966),
                                    ("Sundayfrom|since|after <time>", -5.678464666671911),
                                    ("absorption of , after named dayFebruary", -4.762173934797756),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.678464666671911),
                                    ("tomorrowat <time-of-day>", -5.678464666671911),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.678464666671911),
                                    ("last <cycle> of <time>year (latent)", -5.272999558563747),
                                    ("tomorrow<time-of-day> am|pm", -5.678464666671911),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.985317486111966),
                                    ("Diwaliyear (latent)", -5.272999558563747),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.678464666671911),
                                    ("Fridayyear (latent)", -5.272999558563747),
                                    ("this|next <day-of-week><time-of-day> am|pm",
                                     -5.678464666671911),
                                    ("minuteyear", -4.425701698176543)],
                               n = 187}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.5728610146854433, unseen = -4.356708826689592,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 75},
                   koData =
                     ClassData{prior = -0.8299061176753345, unseen = -4.110873864173311,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.23483959107740107,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("from|since|after <time>", -3.784189633918261),
                                    ("integer after|past <hour-of-day>", -4.007333185232471),
                                    ("at <time-of-day>", -2.2155737160044158),
                                    ("<time-of-day> o'clock", -4.295015257684252),
                                    ("half after|past <hour-of-day>", -4.295015257684252),
                                    ("<hour-of-day> <integer>", -3.784189633918261),
                                    ("time-of-day (latent)", -1.730065900222715),
                                    ("hhmm (latent)", -4.700480365792417),
                                    ("hh:mm", -2.3978952727983707),
                                    ("quarter after|past <hour-of-day>", -4.700480365792417),
                                    ("until <time>", -4.007333185232471),
                                    ("about|exactly <time-of-day>", -4.700480365792417),
                                    ("hour", -1.2039728043259361),
                                    ("<time-of-day> sharp|exactly", -4.700480365792417),
                                    ("minute", -1.7560413866259759)],
                               n = 102},
                   koData =
                     ClassData{prior = -1.563975538357343, unseen = -4.2626798770413155,
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -3.1498829533812494),
                                    ("from|since|after <time>", -3.1498829533812494),
                                    ("<hour-of-day> <integer>", -2.639057329615259),
                                    ("time-of-day (latent)", -1.3040562628829186),
                                    ("about|exactly <time-of-day>", -3.5553480614894135),
                                    ("hour", -1.252762968495368), ("minute", -2.05127066471314)],
                               n = 27}}),
       ("Yom Ha'atzmaut",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.0986122886681098,
