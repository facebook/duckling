...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.592360869030033, unseen = -6.025865973825314,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 412},
                   koData =
                     ClassData{prior = -0.8052417283991157, unseen = -5.814130531825066,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4793561134569561, unseen = -7.046647277848756,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.352629396319567),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.352629396319567),
                                    ("Ramadanyear (latent)", -5.436338664445412),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.966335035199676),
                                    ("Bhai Doojyear (latent)", -6.352629396319567),
                                    ("hourday", -4.337726375777302),
                                    ("dayhour", -3.408190417153126),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.966335035199676),
                                    ("Martin Luther King's Dayyear (latent)", -5.947164288211402),
                                    ("Shemini Atzeretyear (latent)", -6.352629396319567),
                                    ("daymonth", -4.337726375777302),
                                    ("monthday", -5.947164288211402),
                                    ("monthyear", -4.560869927091511),
                                    ("Yom Ha'atzmautyear (latent)", -6.352629396319567),
                                    ("Vijayadashamiyear (latent)", -6.352629396319567),
                                    ("Thai Pongalyear (latent)", -5.659482215759621),
                                    ("Thiru Onamyear (latent)", -5.659482215759621),
                                    ("hhhmmabsorption of , after named day", -6.352629396319567),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.352629396319567),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.436338664445412),
                                    ("<day-of-month> (ordinal)Wednesday", -6.352629396319567),
                                    ("Krishna Janmashtamiyear (latent)", -5.947164288211402),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.352629396319567),
                                    ("houryear", -5.436338664445412),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.352629396319567),
                                    ("Christmas<time-of-day> am|pm", -6.352629396319567),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.352629396319567),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.659482215759621),
                                    ("intersectin|during <named-month>|year", -6.352629396319567),
                                    ("<time-of-day> am|pmintersect", -5.099866427824199),
                                    ("Earth Houryear (latent)", -6.352629396319567),
                                    ("Octoberyear (latent)", -4.848551999543292),
                                    ("intersect<time-of-day> am|pm", -6.352629396319567),
                                    ("Mattu Pongalyear (latent)", -6.352629396319567),
                                    ("Shavuotyear (latent)", -6.352629396319567),
                                    ("Parsi New Yearyear (latent)", -5.436338664445412),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.352629396319567),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.352629396319567),
                                    ("todayin|within|after <duration>", -6.352629396319567),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.947164288211402),
                                    ("Marchyear (latent)", -6.352629396319567),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -5.947164288211402),
                                    ("Sukkotyear (latent)", -5.947164288211402),
                                    ("hhhmmintersect", -5.947164288211402),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.947164288211402),
                                    ("Clean Mondayyear (latent)", -5.947164288211402),
                                    ("monthhour", -5.947164288211402),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.659482215759621),
                                    ("todayat <time-of-day>", -6.352629396319567),
                                    ("Thursday<time> timezone", -3.954734123521196),
                                    ("time-of-day (latent)tonight", -5.947164288211402),
                                    ("from|since|after <time>December", -6.352629396319567),
                                    ("<time-of-day> am|pmon <day>", -4.337726375777302),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.352629396319567),
                                    ("yyyy-mm-ddhh:mm:ss", -5.947164288211402),
                                    ("dayday", -3.6445791952173563),
                                    ("<time> <part-of-day>at <time-of-day>", -6.352629396319567),
                                    ("tonightat <time-of-day>", -6.352629396319567),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.659482215759621),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.352629396319567),
                                    ("today<time-of-day> am|pm", -6.352629396319567),
                                    ("Februarythe <day-of-month> (ordinal)", -5.947164288211402),
                                    ("at <time-of-day><time> <part-of-day>", -6.352629396319567),
                                    ("<day-of-month> (ordinal)intersect", -5.947164288211402),
                                    ("hourhour", -4.273187854639731),
                                    ("Navaratriin|during <named-month>|year", -6.352629396319567),
                                    ("Wednesdaythis|last|next <cycle>", -6.352629396319567),
                                    ("Lentyear (latent)", -6.352629396319567),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.480827219417975),
                                    ("Boghiyear (latent)", -6.352629396319567),
                                    ("dayyear", -1.970602761645685),
                                    ("Thursdayfrom|since|after <time>", -5.947164288211402),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.352629396319567),
                                    ("Thursdayat <time-of-day>", -5.659482215759621),
                                    ("Islamic New Yearyear (latent)", -5.947164288211402),
                                    ("Laylat al-Qadryear (latent)", -5.436338664445412),
                                    ("Shrove Tuesdayyear (latent)", -6.352629396319567),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.659482215759621),
                                    ("<time-of-day> am|pmtomorrow", -5.659482215759621),
                                    ("Yom Kippuryear (latent)", -6.352629396319567),
                                    ("<day-of-month> (ordinal)Tuesday", -5.947164288211402),
                                    ("<part-of-day> of <time>year (latent)", -6.352629396319567),
                                    ("minutehour", -5.099866427824199),
                                    ("Kaanum Pongalyear (latent)", -5.947164288211402),
                                    ("Maha Saptamiyear (latent)", -6.352629396319567),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.947164288211402),
                                    ("time-of-day (latent)tomorrow", -5.436338664445412),
                                    ("part of daysat <time-of-day>", -5.947164288211402),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.337726375777302),
                                    ("for <duration> from <time>December", -6.352629396319567),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.352629396319567),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.099866427824199),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.099866427824199),
                                    ("time-of-day (latent)this <part-of-day>", -6.352629396319567),
                                    ("Pentecostyear (latent)", -6.352629396319567),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.099866427824199),
                                    ("<day-of-month> (ordinal)February", -6.352629396319567),
                                    ("Eid al-Fitryear (latent)", -5.436338664445412),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.352629396319567),
                                    ("Mondayin|during the <part-of-day>", -6.352629396319567),
                                    ("Chhathin|during <named-month>|year", -6.352629396319567),
                                    ("Diwaliin|during <named-month>|year", -6.352629396319567),
                                    ("Vaisakhiin|during <named-month>|year", -6.352629396319567),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.099866427824199),
                                    ("Raksha Bandhanyear (latent)", -6.352629396319567),
                                    ("daysecond", -5.947164288211402),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.947164288211402),
                                    ("Ashurayear (latent)", -6.352629396319567),
                                    ("Tuesdayin|during <named-month>|year", -6.352629396319567),
                                    ("Chinese New Yearyear (latent)", -6.352629396319567),
                                    ("tomorrowintersect", -6.352629396319567),
                                    ("Lag BaOmeryear (latent)", -6.352629396319567),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.352629396319567),
                                    ("Eid al-Adhayear (latent)", -4.212563232823296),
                                    ("intersectin|during the <part-of-day>", -6.352629396319567),
                                    ("Palm Sundayyear (latent)", -6.352629396319567),
                                    ("Christmasat <time-of-day>", -6.352629396319567),
                                    ("Passoveryear (latent)", -6.352629396319567),
                                    ("Lazarus Saturdayyear (latent)", -6.352629396319567),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.352629396319567),
                                    ("hhhmmon <day>", -5.436338664445412),
                                    ("Yom HaShoahyear (latent)", -5.947164288211402),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.947164288211402),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.352629396319567),
                                    ("Septemberyear (latent)", -5.947164288211402),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.848551999543292),
                                    ("Halloweenyear (latent)", -6.352629396319567),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.352629396319567),
                                    ("at <time-of-day>intersect", -5.436338664445412),
                                    ("Rosh Hashanahyear (latent)", -5.659482215759621),
                                    ("Dhanterasyear (latent)", -6.352629396319567),
                                    ("Tu BiShvatyear (latent)", -6.352629396319567),
                                    ("<day-of-month> (ordinal)December", -5.659482215759621),
                                    ("Holiyear (latent)", -5.659482215759621),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.352629396319567),
                                    ("Holika Dahanyear (latent)", -5.659482215759621),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.947164288211402),
                                    ("dayminute", -3.0384433916470406),
                                    ("Mawlidyear (latent)", -6.352629396319567),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.947164288211402),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.352629396319567),
                                    ("Jumu'atul-Widayear (latent)", -5.436338664445412),
                                    ("minuteday", -2.6149597780361984),
                                    ("absorption of , after named dayintersect",
                                     -5.659482215759621),
                                    ("intersectyear (latent)", -6.352629396319567),
                                    ("Orthodox Easter Sundayyear (latent)", -6.352629396319567),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.352629396319567),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.352629396319567),
                                    ("intersecthhhmm", -5.947164288211402),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.352629396319567),
                                    ("Boss's Dayyear (latent)", -5.947164288211402),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.352629396319567),
                                    ("Global Youth Service Dayyear (latent)", -6.352629396319567),
                                    ("Dhanterasin|during <named-month>|year", -6.352629396319567),
                                    ("Tisha B'Avyear (latent)", -6.352629396319567),
                                    ("Isra and Mi'rajyear (latent)", -5.436338664445412),
                                    ("at <time-of-day>on <day>", -4.743191483885466),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.947164288211402),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.659482215759621),
                                    ("Christmasyear (latent)", -5.947164288211402),
                                    ("Naraka Chaturdashiyear (latent)", -5.947164288211402),
                                    ("Thai Pongalin|during <named-month>|year", -6.352629396319567),
                                    ("dayweek", -6.352629396319567),
                                    ("Easter Sundayyear (latent)", -5.659482215759621),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -5.947164288211402),
                                    ("weekyear", -5.254017107651457),
                                    ("King's Dayyear (latent)", -4.848551999543292),
                                    ("hh:mmin|during the <part-of-day>", -5.436338664445412),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.947164288211402),
                                    ("Hanukkahyear (latent)", -5.659482215759621),
                                    ("February<time> <part-of-day>", -6.352629396319567),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.352629396319567),
                                    ("Great Lentyear (latent)", -6.352629396319567),
                                    ("tomorrowat <time-of-day>", -5.659482215759621),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.352629396319567),
                                    ("Vaisakhiyear (latent)", -5.659482215759621),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.659482215759621),
                                    ("last <cycle> of <time>year (latent)", -5.659482215759621),
                                    ("at <time-of-day>tomorrow", -5.947164288211402),
                                    ("tomorrow<time-of-day> am|pm", -6.352629396319567),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.352629396319567),
                                    ("Diwaliyear (latent)", -6.352629396319567),
                                    ("between <time> and <time>on <day>", -5.947164288211402),
                                    ("Black Fridayyear (latent)", -5.947164288211402),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.352629396319567),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.352629396319567),
                                    ("Chhathyear (latent)", -5.947164288211402),
                                    ("Vasant Panchamiyear (latent)", -6.352629396319567),
                                    ("Rabindra Jayantiyear (latent)", -5.099866427824199),
                                    ("St Patrick's Dayyear (latent)", -6.352629396319567),
                                    ("Thursday<time> (timezone)", -6.352629396319567),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.352629396319567),
                                    ("<datetime> - <datetime> (interval)July", -5.947164288211402),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.659482215759621),
                                    ("Februaryintersect", -6.352629396319567),
                                    ("Simchat Torahyear (latent)", -6.352629396319567),
                                    ("minuteyear", -6.352629396319567)],
                               n = 439},
                   koData =
                     ClassData{prior = -0.9654335675337526, unseen = -6.698268054115413,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.499809670330265),
                                    ("hourday", -3.6059917943081685),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.003887067106539),
                                    ("<day-of-month> (ordinal)August", -6.003887067106539),
                                    ("dayhour", -3.4389377096450024),
                                    ("<time> timezoneyear (latent)", -5.310739886546594),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.0875963352323845),
                                    ("Tuesdayfrom|since|after <time>", -5.310739886546594),
                                    ("daymonth", -3.3297384176800104),
                                    ("monthyear", -4.751124098611172),
                                    ("<time-of-day> am|pmyear (latent)", -5.310739886546594),
                                    ("Thai Pongalyear (latent)", -5.310739886546594),
                                    ("intersecthh:mm", -6.003887067106539),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.598421958998375),
                                    ("<day-of-month> (ordinal)Wednesday", -6.003887067106539),
                                    ("houryear", -4.617592705986649),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.003887067106539),
                                    ("<day-of-month> (ordinal)October", -6.003887067106539),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.310739886546594),
                                    ("hournograin", -4.751124098611172),
                                    ("<time-of-day> am|pmintersect", -4.751124098611172),
                                    ("Octoberyear (latent)", -6.003887067106539),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.598421958998375),
                                    ("until <time>on <day>", -5.310739886546594),
                                    ("time-of-day (latent)intersect", -5.310739886546594),
                                    ("todayin <number> (implicit minutes)", -6.003887067106539),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.310739886546594),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.003887067106539),
                                    ("hh:mmon <day>", -4.751124098611172),
                                    ("hhhmmintersect", -5.598421958998375),
                                    ("absorption of , after named dayJuly", -5.0875963352323845),
                                    ("from|since|after <time>July", -5.598421958998375),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.0875963352323845),
                                    ("Clean Mondayyear (latent)", -6.003887067106539),
                                    ("monthhour", -6.003887067106539),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.598421958998375),
                                    ("hourmonth", -4.132084890204948),
                                    ("todayat <time-of-day>", -6.003887067106539),
                                    ("hhhmmyear (latent)", -4.751124098611172),
                                    ("from|since|after <time>December", -6.003887067106539),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.003887067106539),
                                    ("<time-of-day> am|pmon <day>", -4.751124098611172),
                                    ("Mondayyear (latent)", -5.310739886546594),
                                    ("dayday", -4.617592705986649),
                                    ("on <day>September", -5.310739886546594),
                                    ("time-of-day (latent)September", -5.598421958998375),
                                    ("hourhour", -5.598421958998375),
                                    ("time-of-day (latent)on <day>", -4.499809670330265),
                                    ("Thursdaydd/mm", -6.003887067106539),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.598421958998375),
                                    ("dayyear", -3.0861163350222602),
                                    ("New Year's Dayyear (latent)", -5.0875963352323845),
                                    ("time-of-day (latent)Sunday", -5.598421958998375),
                                    ("Thursdayfrom|since|after <time>", -4.2991389748681135),
                                    ("Thursdayat <time-of-day>", -4.394449154672439),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.003887067106539),
                                    ("Aprilyear (latent)", -6.003887067106539),
                                    ("the <day-of-month> (ordinal)July", -6.003887067106539),
                                    ("the <day-of-month> (number)July", -6.003887067106539),
                                    ("monthminute", -6.003887067106539),
                                    ("<time-of-day> am|pmtomorrow", -6.003887067106539),
                                    ("Thursdayhh:mm", -5.0875963352323845),
                                    ("<day-of-month> (ordinal)Tuesday", -5.598421958998375),
                                    ("minutemonth", -3.8638209036102684),
                                    ("time-of-day (latent)Friday", -5.598421958998375),
                                    ("minutehour", -6.003887067106539),
                                    ("Augustyear (latent)", -5.598421958998375),
                                    ("week-endin|during <named-month>|year", -6.003887067106539),
                                    ("time-of-day (latent)Tuesday", -5.598421958998375),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.003887067106539),
                                    ("Sundayyear (latent)", -5.0875963352323845),
                                    ("Christmasat <time-of-day>", -6.003887067106539),
                                    ("from|since|after <time>year (latent)", -4.90527477843843),
                                    ("hhhmmon <day>", -5.0875963352323845),
                                    ("yesterday<time-of-day> am|pm", -6.003887067106539),
                                    ("<day-of-month> (ordinal)July", -5.310739886546594),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.003887067106539),
                                    ("at <time-of-day>intersect", -5.0875963352323845),
                                    ("hh:mmyear (latent)", -4.617592705986649),
                                    ("Holiyear (latent)", -6.003887067106539),
                                    ("until <time><time-of-day> am|pm", -6.003887067106539),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.598421958998375),
                                    ("dayminute", -3.170673723050323),
                                    ("yyyy-mm-ddhh:mm", -5.598421958998375),
                                    ("intersectfrom|since|after <time>", -5.598421958998375),
                                    ("intersectSeptember", -4.132084890204948),
                                    ("minuteday", -2.8468866459564257),
                                    ("absorption of , after named dayintersect",
                                     -6.003887067106539),
                                    ("intersectyear (latent)", -6.003887067106539),
                                    ("Februaryin|during the <part-of-day>", -6.003887067106539),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.003887067106539),
                                    ("time-of-day (latent)July", -5.310739886546594),
                                    ("Saturdayyear (latent)", -6.003887067106539),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.003887067106539),
                                    ("at <time-of-day>on <day>", -5.0875963352323845),
                                    ("absorption of , after named daySeptember",
                                     -4.751124098611172),
                                    ("Naraka Chaturdashiyear (latent)", -6.003887067106539),
                                    ("from|since|after <time>on <day>", -5.0875963352323845),
                                    ("dayweek", -6.003887067106539),
                                    ("Easter Sundayyear (latent)", -5.598421958998375),
                                    ("Thursday<time-of-day> am|pm", -4.751124098611172),
                                    ("weekyear", -5.598421958998375),
                                    ("time-of-day (latent)Thursday", -5.598421958998375),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.003887067106539),
                                    ("<day-of-month> (ordinal)April", -6.003887067106539),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.598421958998375),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.310739886546594),
                                    ("Sundayfrom|since|after <time>", -6.003887067106539),
                                    ...
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.003887067106539),
                                    ("tomorrowat <time-of-day>", -6.003887067106539),
                                    ("daynograin", -5.598421958998375),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.598421958998375),
                                    ("last <cycle> of <time>year (latent)", -5.598421958998375),
                                    ("tomorrow<time-of-day> am|pm", -6.003887067106539),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.310739886546594),
                                    ("Diwaliyear (latent)", -5.598421958998375),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.003887067106539),
                                    ("Fridayyear (latent)", -5.598421958998375),
                                    ("time-of-day (latent)April", -6.003887067106539),
                                    ("minuteyear", -3.8066624897703196)],
                               n = 270}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1670540846631662,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.1917602968305085e-2),
                                    ("intersect 2 numbers", -3.865979066926739)],
                               n = 187},
                   koData =
