...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7038424696766933, unseen = -5.236441962829949,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 186},
                   koData =
                     ClassData{prior = -0.6825650712294083,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.49774038421733524,
                                 ...
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.341948411106471),
                                    ("hourday", -3.889963287363414),
                                    ("dayhour", -2.7043396217056745),
                                    ("daymonth", -4.901564199041894),
                                    ("monthday", -5.1892462714936745),
                                    ("monthyear", -3.9852734671677386),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.594711379601839),
                                    ("Easter Sundayyear", -4.901564199041894),
                                    ("Christmasyear", -5.1892462714936745),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.594711379601839),
                                    ("houryear", -5.1892462714936745),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.594711379601839),
                                    ("Christmas<time-of-day> am|pm", -5.594711379601839),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.901564199041894),
                                    ("<time-of-day> am|pmintersect", -4.341948411106471),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.594711379601839),
                                    ("Marchyear", -5.594711379601839),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.1892462714936745),
                                    ("intersect<time-of-day> am|pm", -5.594711379601839),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.594711379601839),
                                    ("monthhour", -5.1892462714936745),
                                    ("last <day-of-week> of <time>year", -5.594711379601839),
                                    ("todayat <time-of-day>", -5.594711379601839),
                                    ("Thursday<time> timezone", -3.889963287363414),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.594711379601839),
                                    ("dayday", -3.5798083590595744),
                                    ("<time> <part-of-day>at <time-of-day>", -5.594711379601839),
                                    ("Tuesdayin <named-month>", -5.594711379601839),
                                    ("tonightat <time-of-day>", -5.594711379601839),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.901564199041894),
                                    ("today<time-of-day> am|pm", -5.594711379601839),
                                    ("Februarythe <day-of-month> (ordinal)", -5.1892462714936745),
                                    ("at <time-of-day><time> <part-of-day>", -5.594711379601839),
                                    ("hourhour", -4.341948411106471),
                                    ("<time-of-day> am|pmon <date>", -3.5798083590595744),
                                    ("Wednesdaythis|last|next <cycle>", -5.594711379601839),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.090633982825565),
                                    ("dayyear", -3.2433361224383614),
                                    ("last weekend of <named-month>year", -5.594711379601839),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.594711379601839),
                                    ("Thursdayat <time-of-day>", -5.1892462714936745),
                                    ("<time-of-day> am|pmtomorrow", -4.901564199041894),
                                    ("minutehour", -4.678420647727684),
                                    ("Mother's Dayyear", -5.594711379601839),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.1892462714936745),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.889963287363414),
                                    ("for <duration> from <time>December", -5.594711379601839),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.594711379601839),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.678420647727684),
                                    ("Mondayin|during the <part-of-day>", -5.594711379601839),
                                    ("<part-of-day> of <time>year", -5.594711379601839),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.1892462714936745),
                                    ("intersectin|during the <part-of-day>", -5.594711379601839),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.1892462714936745),
                                    ("<ordinal> <cycle> of <time>year", -5.594711379601839),
                                    ("minuteday", -2.1289754768021125),
                                    ("absorption of , after named dayintersect",
                                     -5.594711379601839),
                                    ("Octoberyear", -4.341948411106471),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.594711379601839),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.594711379601839),
                                    ("year<time-of-day> am|pm", -5.594711379601839),
                                    ("Septemberyear", -5.1892462714936745),
                                    ("at <time-of-day>on <date>", -4.496099090933729),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.901564199041894),
                                    ("Halloweenyear", -5.594711379601839),
                                    ("dayweek", -5.594711379601839),
                                    ("Thursday<time-of-day> am|pm", -5.594711379601839),
                                    ("weekyear", -5.1892462714936745),
                                    ("hh:mmin|during the <part-of-day>", -4.901564199041894),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.1892462714936745),
                                    ("February<time> <part-of-day>", -5.594711379601839),
                                    ("Martin Luther King's Dayyear", -5.1892462714936745),
                                    ("tomorrowat <time-of-day>", -4.901564199041894),
                                    ("between <time> and <time>on <date>", -4.901564199041894),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.901564199041894),
                                    ("at <time-of-day>tomorrow", -5.1892462714936745),
                                    ("tomorrow<time-of-day> am|pm", -5.594711379601839),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.594711379601839),
                                    ("Labor Dayyear", -5.594711379601839),
                                    ("Februaryintersect", -5.594711379601839),
                                    ("last <cycle> of <time>year", -4.901564199041894),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.594711379601839),
                                    ("yearminute", -5.594711379601839),
                                    ("Black Fridayyear", -5.1892462714936745)],
                               n = 200},
                   koData =
                     ClassData{prior = -0.9362453464036997, unseen = -5.983936280687191,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.288267030694535),
                                    ...
                                    ("dayyear", -3.6788291182604347),
                                    ("Sundayyear", -4.882801922586371),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.288267030694535),
                                    ("Christmasat <time-of-day>", -5.288267030694535),
       ...
       ("year",
        Classifier{okData =
                     ClassData{prior = -0.24512245803298496,
                               ...
                               n = 36},
                   koData =
                     ClassData{prior = -1.5260563034950494, unseen = -2.70805020110221,
                               likelihoods =
                                 HashMap.fromList
