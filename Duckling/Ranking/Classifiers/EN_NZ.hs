...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5615531472756489, unseen = -6.095824562432225,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 442},
                   koData =
                     ClassData{prior = -0.8447205393729031, unseen = -5.814130531825066,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4578330936254803, unseen = -7.098375638590787,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.404401670054847),
                                    ("Karva Chauthyear (latent)", -6.404401670054847),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.404401670054847),
                                    ("Maha Shivaratriyear (latent)", -6.404401670054847),
                                    ("Ramadanyear (latent)", -5.151638701559479),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.018107308934956),
                                    ("Bhai Doojyear (latent)", -6.404401670054847),
                                    ("hourday", -4.389498649512583),
                                    ("dayhour", -3.459962690888407),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.018107308934956),
                                    ("Martin Luther King's Dayyear (latent)", -5.998936561946683),
                                    ("Shemini Atzeretyear (latent)", -6.404401670054847),
                                    ("daymonth", -4.389498649512583),
                                    ("monthday", -5.998936561946683),
                                    ("monthyear", -4.612642200826793),
                                    ("Yom Ha'atzmautyear (latent)", -6.404401670054847),
                                    ("Vijayadashamiyear (latent)", -6.404401670054847),
                                    ("Thai Pongalyear (latent)", -5.711254489494902),
                                    ("Thiru Onamyear (latent)", -5.711254489494902),
                                    ("hhhmmabsorption of , after named day", -6.404401670054847),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.404401670054847),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.488110938180692),
                                    ("<day-of-month> (ordinal)Wednesday", -6.404401670054847),
                                    ("Krishna Janmashtamiyear (latent)", -5.998936561946683),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.404401670054847),
                                    ("houryear", -5.488110938180692),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.404401670054847),
                                    ("Christmas<time-of-day> am|pm", -6.404401670054847),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.404401670054847),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.711254489494902),
                                    ("intersectin|during <named-month>|year", -6.404401670054847),
                                    ("<time-of-day> am|pmintersect", -5.151638701559479),
                                    ("Earth Houryear (latent)", -6.404401670054847),
                                    ("Ganesh Chaturthiyear (latent)", -6.404401670054847),
                                    ("Octoberyear (latent)", -4.9003242732785735),
                                    ("intersect<time-of-day> am|pm", -6.404401670054847),
                                    ("Mattu Pongalyear (latent)", -6.404401670054847),
                                    ("Shavuotyear (latent)", -6.404401670054847),
                                    ("Parsi New Yearyear (latent)", -5.488110938180692),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.404401670054847),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.404401670054847),
                                    ("todayin|within|after <duration>", -6.404401670054847),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.998936561946683),
                                    ("Marchyear (latent)", -6.404401670054847),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -5.998936561946683),
                                    ("Sukkotyear (latent)", -5.998936561946683),
                                    ("hhhmmintersect", -5.998936561946683),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.998936561946683),
                                    ("Clean Mondayyear (latent)", -5.998936561946683),
                                    ("monthhour", -5.998936561946683),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.711254489494902),
                                    ("todayat <time-of-day>", -6.404401670054847),
                                    ("Thursday<time> timezone", -4.0065063972564765),
                                    ("time-of-day (latent)tonight", -5.998936561946683),
                                    ("from|since|after <time>December", -6.404401670054847),
                                    ("<time-of-day> am|pmon <day>", -4.389498649512583),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.404401670054847),
                                    ("yyyy-mm-ddhh:mm:ss", -5.998936561946683),
                                    ("dayday", -3.696351468952637),
                                    ("<time> <part-of-day>at <time-of-day>", -6.404401670054847),
                                    ("tonightat <time-of-day>", -6.404401670054847),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.711254489494902),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.404401670054847),
                                    ("today<time-of-day> am|pm", -6.404401670054847),
                                    ("Februarythe <day-of-month> (ordinal)", -5.998936561946683),
                                    ("at <time-of-day><time> <part-of-day>", -6.404401670054847),
                                    ("<day-of-month> (ordinal)intersect", -5.998936561946683),
                                    ("hourhour", -4.324960128375012),
                                    ("Mahavir Jayantiyear (latent)", -5.998936561946683),
                                    ("Navaratriin|during <named-month>|year", -6.404401670054847),
                                    ("Wednesdaythis|last|next <cycle>", -6.404401670054847),
                                    ("Lentyear (latent)", -6.404401670054847),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.532599493153256),
                                    ("Boghiyear (latent)", -6.404401670054847),
                                    ("dayyear", -1.8718021769015913),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.404401670054847),
                                    ("Thursdayfrom|since|after <time>", -5.998936561946683),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.404401670054847),
                                    ("Thursdayat <time-of-day>", -5.711254489494902),
                                    ("Islamic New Yearyear (latent)", -5.998936561946683),
                                    ("Laylat al-Qadryear (latent)", -5.488110938180692),
                                    ("Shrove Tuesdayyear (latent)", -6.404401670054847),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.711254489494902),
                                    ("<time-of-day> am|pmtomorrow", -5.711254489494902),
                                    ("Yom Kippuryear (latent)", -6.404401670054847),
                                    ("<day-of-month> (ordinal)Tuesday", -5.998936561946683),
                                    ("<part-of-day> of <time>year (latent)", -6.404401670054847),
                                    ("minutehour", -5.151638701559479),
                                    ("Kaanum Pongalyear (latent)", -5.998936561946683),
                                    ("Maha Saptamiyear (latent)", -6.404401670054847),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.998936561946683),
                                    ("time-of-day (latent)tomorrow", -5.488110938180692),
                                    ("part of daysat <time-of-day>", -5.998936561946683),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.389498649512583),
                                    ("for <duration> from <time>December", -6.404401670054847),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.404401670054847),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.151638701559479),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.151638701559479),
                                    ("time-of-day (latent)this <part-of-day>", -6.404401670054847),
                                    ("Pentecostyear (latent)", -6.404401670054847),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.151638701559479),
                                    ("<day-of-month> (ordinal)February", -6.404401670054847),
                                    ("Eid al-Fitryear (latent)", -5.018107308934956),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.404401670054847),
                                    ("Mondayin|during the <part-of-day>", -6.404401670054847),
                                    ("Chhathin|during <named-month>|year", -6.404401670054847),
                                    ("Diwaliin|during <named-month>|year", -6.404401670054847),
                                    ("Vaisakhiin|during <named-month>|year", -6.404401670054847),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.151638701559479),
                                    ("Raksha Bandhanyear (latent)", -6.404401670054847),
                                    ("daysecond", -5.998936561946683),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.998936561946683),
                                    ("Ratha-Yatrayear (latent)", -6.404401670054847),
                                    ("Ashurayear (latent)", -6.404401670054847),
                                    ("Tuesdayin|during <named-month>|year", -6.404401670054847),
                                    ("Chinese New Yearyear (latent)", -6.404401670054847),
                                    ("tomorrowintersect", -6.404401670054847),
                                    ("Lag BaOmeryear (latent)", -6.404401670054847),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.404401670054847),
                                    ("Eid al-Adhayear (latent)", -4.264335506558576),
                                    ("intersectin|during the <part-of-day>", -6.404401670054847),
                                    ("Palm Sundayyear (latent)", -6.404401670054847),
                                    ("Christmasat <time-of-day>", -6.404401670054847),
                                    ("Passoveryear (latent)", -6.404401670054847),
                                    ("Lazarus Saturdayyear (latent)", -6.404401670054847),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.404401670054847),
                                    ("hhhmmon <day>", -5.488110938180692),
                                    ("Yom HaShoahyear (latent)", -5.998936561946683),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.998936561946683),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.404401670054847),
                                    ("Septemberyear (latent)", -5.998936561946683),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.9003242732785735),
                                    ("Halloweenyear (latent)", -6.404401670054847),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.404401670054847),
                                    ("at <time-of-day>intersect", -5.488110938180692),
                                    ("Rosh Hashanahyear (latent)", -5.711254489494902),
                                    ("Dhanterasyear (latent)", -6.404401670054847),
                                    ("Tu BiShvatyear (latent)", -6.404401670054847),
                                    ("<day-of-month> (ordinal)December", -5.711254489494902),
                                    ("Holiyear (latent)", -5.711254489494902),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.404401670054847),
                                    ("Holika Dahanyear (latent)", -5.711254489494902),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.998936561946683),
                                    ("dayminute", -3.090215665382322),
                                    ("Mawlidyear (latent)", -6.404401670054847),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.998936561946683),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.404401670054847),
                                    ("Jumu'atul-Widayear (latent)", -5.488110938180692),
                                    ("minuteday", -2.666732051771479),
                                    ("absorption of , after named dayintersect",
                                     -5.711254489494902),
                                    ("intersectyear (latent)", -6.404401670054847),
                                    ("Orthodox Easter Sundayyear (latent)", -6.404401670054847),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.404401670054847),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.404401670054847),
                                    ("intersecthhhmm", -5.998936561946683),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.404401670054847),
                                    ("Boss's Dayyear (latent)", -5.998936561946683),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.404401670054847),
                                    ("Global Youth Service Dayyear (latent)", -6.404401670054847),
                                    ("Dhanterasin|during <named-month>|year", -6.404401670054847),
                                    ("Tisha B'Avyear (latent)", -6.404401670054847),
                                    ("Isra and Mi'rajyear (latent)", -5.488110938180692),
                                    ("at <time-of-day>on <day>", -4.794963757620747),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.998936561946683),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.711254489494902),
                                    ("Christmasyear (latent)", -5.998936561946683),
                                    ("Naraka Chaturdashiyear (latent)", -5.998936561946683),
                                    ("Thai Pongalin|during <named-month>|year", -6.404401670054847),
                                    ("dayweek", -6.404401670054847),
                                    ("Easter Sundayyear (latent)", -5.711254489494902),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -5.998936561946683),
                                    ("weekyear", -5.305789381386738),
                                    ("King's Dayyear (latent)", -4.9003242732785735),
                                    ("hh:mmin|during the <part-of-day>", -5.488110938180692),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.998936561946683),
                                    ("Hanukkahyear (latent)", -5.711254489494902),
                                    ("Rama Navamiyear (latent)", -6.404401670054847),
                                    ("February<time> <part-of-day>", -6.404401670054847),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.404401670054847),
                                    ("Great Lentyear (latent)", -6.404401670054847),
                                    ("tomorrowat <time-of-day>", -5.711254489494902),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.404401670054847),
                                    ("Ugadiyear (latent)", -5.018107308934956),
                                    ("Vaisakhiyear (latent)", -5.711254489494902),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.711254489494902),
                                    ("last <cycle> of <time>year (latent)", -5.711254489494902),
                                    ("at <time-of-day>tomorrow", -5.998936561946683),
                                    ("tomorrow<time-of-day> am|pm", -6.404401670054847),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.404401670054847),
                                    ("Diwaliyear (latent)", -6.404401670054847),
                                    ("between <time> and <time>on <day>", -5.998936561946683),
                                    ("Black Fridayyear (latent)", -5.998936561946683),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.404401670054847),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.404401670054847),
                                    ("Chhathyear (latent)", -5.998936561946683),
                                    ("Vasant Panchamiyear (latent)", -6.404401670054847),
                                    ("Rabindra Jayantiyear (latent)", -5.151638701559479),
                                    ("St Patrick's Dayyear (latent)", -6.404401670054847),
                                    ("Thursday<time> (timezone)", -6.404401670054847),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.404401670054847),
                                    ("Pargat Diwasyear (latent)", -5.151638701559479),
                                    ("<datetime> - <datetime> (interval)July", -5.998936561946683),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.711254489494902),
                                    ("Februaryintersect", -6.404401670054847),
                                    ("Simchat Torahyear (latent)", -6.404401670054847),
                                    ("minuteyear", -6.404401670054847)],
                               n = 465},
                   koData =
                     ClassData{prior = -1.001448540214462, unseen = -6.709304340258298,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.51085950651685),
                                    ("hourday", -3.6170416304947537),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.014936903293124),
                                    ("<day-of-month> (ordinal)August", -6.014936903293124),
                                    ("dayhour", -3.4499875458315876),
                                    ("<time> timezoneyear (latent)", -5.321789722733179),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.098646171418969),
                                    ("Tuesdayfrom|since|after <time>", -5.321789722733179),
                                    ("daymonth", -3.3407882538665956),
                                    ("monthyear", -4.762173934797756),
                                    ("<time-of-day> am|pmyear (latent)", -5.321789722733179),
                                    ("Thai Pongalyear (latent)", -5.321789722733179),
                                    ("intersecthh:mm", -6.014936903293124),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.60947179518496),
                                    ("<day-of-month> (ordinal)Wednesday", -6.014936903293124),
                                    ("houryear", -4.628642542173234),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.014936903293124),
                                    ("<day-of-month> (ordinal)October", -6.014936903293124),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.321789722733179),
                                    ("hournograin", -4.762173934797756),
                                    ("<time-of-day> am|pmintersect", -4.762173934797756),
                                    ("Octoberyear (latent)", -6.014936903293124),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.60947179518496),
                                    ("until <time>on <day>", -5.321789722733179),
                                    ("time-of-day (latent)intersect", -5.321789722733179),
                                    ("todayin <number> (implicit minutes)", -6.014936903293124),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.321789722733179),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.014936903293124),
                                    ("hh:mmon <day>", -4.762173934797756),
                                    ("hhhmmintersect", -5.60947179518496),
                                    ("absorption of , after named dayJuly", -5.098646171418969),
                                    ("from|since|after <time>July", -5.60947179518496),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.098646171418969),
                                    ("Clean Mondayyear (latent)", -6.014936903293124),
                                    ("monthhour", -6.014936903293124),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.60947179518496),
                                    ("hourmonth", -4.143134726391533),
                                    ("todayat <time-of-day>", -6.014936903293124),
                                    ("hhhmmyear (latent)", -4.762173934797756),
                                    ("from|since|after <time>December", -6.014936903293124),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.014936903293124),
                                    ("<time-of-day> am|pmon <day>", -4.762173934797756),
                                    ("Mondayyear (latent)", -5.321789722733179),
                                    ("dayday", -4.628642542173234),
                                    ("on <day>September", -5.321789722733179),
                                    ("time-of-day (latent)September", -5.60947179518496),
                                    ("hourhour", -5.60947179518496),
                                    ("time-of-day (latent)on <day>", -4.51085950651685),
                                    ("Thursdaydd/mm", -6.014936903293124),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.60947179518496),
                                    ("dayyear", -3.097166171208845),
                                    ("New Year's Dayyear (latent)", -5.098646171418969),
                                    ("time-of-day (latent)Sunday", -5.60947179518496),
                                    ("Thursdayfrom|since|after <time>", -4.310188811054699),
                                    ("Thursdayat <time-of-day>", -4.405498990859024),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.014936903293124),
                                    ("Aprilyear (latent)", -6.014936903293124),
                                    ("the <day-of-month> (ordinal)July", -6.014936903293124),
                                    ("the <day-of-month> (number)July", -6.014936903293124),
                                    ("monthminute", -6.014936903293124),
                                    ("<time-of-day> am|pmtomorrow", -6.014936903293124),
                                    ("Thursdayhh:mm", -5.098646171418969),
                                    ("<day-of-month> (ordinal)Tuesday", -5.60947179518496),
                                    ("minutemonth", -3.8748707397968536),
                                    ("time-of-day (latent)Friday", -5.60947179518496),
                                    ("minutehour", -6.014936903293124),
                                    ("Augustyear (latent)", -5.60947179518496),
                                    ("week-endin|during <named-month>|year", -6.014936903293124),
                                    ("time-of-day (latent)Tuesday", -5.60947179518496),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.014936903293124),
                                    ("Sundayyear (latent)", -5.098646171418969),
                                    ("Christmasat <time-of-day>", -6.014936903293124),
                                    ("from|since|after <time>year (latent)", -4.916324614625014),
                                    ("hhhmmon <day>", -5.098646171418969),
                                    ("yesterday<time-of-day> am|pm", -6.014936903293124),
                                    ("<day-of-month> (ordinal)July", -5.321789722733179),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.014936903293124),
                                    ("at <time-of-day>intersect", -5.098646171418969),
                                    ("hh:mmyear (latent)", -4.628642542173234),
                                    ("Holiyear (latent)", -6.014936903293124),
                                    ("until <time><time-of-day> am|pm", -6.014936903293124),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.60947179518496),
                                    ("dayminute", -3.181723559236908),
                                    ("yyyy-mm-ddhh:mm", -5.60947179518496),
                                    ("intersectfrom|since|after <time>", -5.60947179518496),
                                    ("intersectSeptember", -4.143134726391533),
                                    ("minuteday", -2.857936482143011),
                                    ("absorption of , after named dayintersect",
                                     -6.014936903293124),
                                    ("intersectyear (latent)", -6.014936903293124),
                                    ("Februaryin|during the <part-of-day>", -6.014936903293124),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.014936903293124),
                                    ("time-of-day (latent)July", -5.321789722733179),
                                    ("Saturdayyear (latent)", -6.014936903293124),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.014936903293124),
                                    ("at <time-of-day>on <day>", -5.098646171418969),
                                    ("absorption of , after named daySeptember",
                                     -4.762173934797756),
                                    ("Naraka Chaturdashiyear (latent)", -6.014936903293124),
                                    ("from|since|after <time>on <day>", -5.098646171418969),
                                    ("dayweek", -6.014936903293124),
                                    ("Easter Sundayyear (latent)", -5.60947179518496),
                                    ("Thursday<time-of-day> am|pm", -4.762173934797756),
                                    ("weekyear", -5.60947179518496),
                                    ("time-of-day (latent)Thursday", -5.60947179518496),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.014936903293124),
                                    ("<day-of-month> (ordinal)April", -6.014936903293124),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.60947179518496),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.321789722733179),
                                    ("Sundayfrom|since|after <time>", -6.014936903293124),
                                    ("absorption of , after named dayFebruary", -5.098646171418969),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.60947179518496),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.014936903293124),
                                    ("tomorrowat <time-of-day>", -6.014936903293124),
                                    ("daynograin", -5.60947179518496),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.60947179518496),
                                    ("last <cycle> of <time>year (latent)", -5.60947179518496),
                                    ("tomorrow<time-of-day> am|pm", -6.014936903293124),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.321789722733179),
                                    ("Diwaliyear (latent)", -5.60947179518496),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.014936903293124),
                                    ("Fridayyear (latent)", -5.60947179518496),
                                    ("time-of-day (latent)April", -6.014936903293124),
                                    ("minuteyear", -3.817712325956905)],
                               n = 270}}),
       ("one eleven",
        Classifier{okData =
