...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6029358008396447, unseen = -5.752572638825633,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 313},
                   koData =
                     ClassData{prior = -0.7923109296802601, unseen = -5.564520407322694,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45455471830468797,
                               unseen = -6.741700694652055,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.0473721790462776),
                                    ("Ramadanyear (latent)", -6.0473721790462776),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.79460921055091),
                                    ("Bhai Doojyear (latent)", -6.0473721790462776),
                                    ("hourday", -4.342624086807853), ("dayhour", -3.18517129811681),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.79460921055091),
                                    ("Martin Luther King's Dayyear (latent)", -5.641907070938114),
                                    ("Shemini Atzeretyear (latent)", -6.0473721790462776),
                                    ("daymonth", -5.131081447172123),
                                    ("monthday", -5.641907070938114),
                                    ("monthyear", -4.255612709818223),
                                    ("Yom Ha'atzmautyear (latent)", -6.0473721790462776),
                                    ("Vijayadashamiyear (latent)", -6.0473721790462776),
                                    ("Thai Pongalyear (latent)", -5.354224998486333),
                                    ("Thiru Onamyear (latent)", -5.354224998486333),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.0473721790462776),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.0473721790462776),
                                    ("houryear", -5.354224998486333),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.0473721790462776),
                                    ("Christmas<time-of-day> am|pm", -6.0473721790462776),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.0473721790462776),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.354224998486333),
                                    ("<time-of-day> am|pmintersect", -4.79460921055091),
                                    ("Earth Houryear (latent)", -6.0473721790462776),
                                    ("Octoberyear (latent)", -4.543294782270004),
                                    ("intersect<time-of-day> am|pm", -6.0473721790462776),
                                    ("Mattu Pongalyear (latent)", -6.0473721790462776),
                                    ("Shavuotyear (latent)", -6.0473721790462776),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.0473721790462776),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.0473721790462776),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.641907070938114),
                                    ("Marchyear (latent)", -6.0473721790462776),
                                    ("Sukkotyear (latent)", -5.641907070938114),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.0473721790462776),
                                    ("Clean Mondayyear (latent)", -5.641907070938114),
                                    ("monthhour", -5.641907070938114),
                                    ("todayat <time-of-day>", -6.0473721790462776),
                                    ("Thursday<time> timezone", -4.101462029990965),
                                    ("from|since|after <time>December", -6.0473721790462776),
                                    ("<time-of-day> am|pmon <day>", -4.032469158504013),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.0473721790462776),
                                    ("yyyy-mm-ddhh:mm:ss", -5.641907070938114),
                                    ("dayday", -4.032469158504013),
                                    ("<time> <part-of-day>at <time-of-day>", -6.0473721790462776),
                                    ("tonightat <time-of-day>", -6.0473721790462776),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.354224998486333),
                                    ("today<time-of-day> am|pm", -6.0473721790462776),
                                    ("Februarythe <day-of-month> (ordinal)", -5.641907070938114),
                                    ("at <time-of-day><time> <part-of-day>", -6.0473721790462776),
                                    ("hourhour", -4.79460921055091),
                                    ("Navaratriin|during <named-month>|year", -6.0473721790462776),
                                    ("Wednesdaythis|last|next <cycle>", -6.0473721790462776),
                                    ("Lentyear (latent)", -6.0473721790462776),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.543294782270004),
                                    ("Boghiyear (latent)", -6.0473721790462776),
                                    ("dayyear", -2.030989158293889),
                                    ("Thursdayfrom|since|after <time>", -5.641907070938114),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.0473721790462776),
                                    ("Thursdayat <time-of-day>", -5.354224998486333),
                                    ("Islamic New Yearyear (latent)", -5.641907070938114),
                                    ("Laylat al-Qadryear (latent)", -5.131081447172123),
                                    ("Shrove Tuesdayyear (latent)", -6.0473721790462776),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.354224998486333),
                                    ("<time-of-day> am|pmtomorrow", -5.354224998486333),
                                    ("Yom Kippuryear (latent)", -6.0473721790462776),
                                    ("<part-of-day> of <time>year (latent)", -6.0473721790462776),
                                    ("minutehour", -5.131081447172123),
                                    ("Kaanum Pongalyear (latent)", -5.641907070938114),
                                    ("Maha Saptamiyear (latent)", -6.0473721790462776),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.641907070938114),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.342624086807853),
                                    ("for <duration> from <time>December", -6.0473721790462776),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.0473721790462776),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.79460921055091),
                                    ("Pentecostyear (latent)", -6.0473721790462776),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.79460921055091),
                                    ("Eid al-Fitryear (latent)", -6.0473721790462776),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.0473721790462776),
                                    ("Mondayin|during the <part-of-day>", -6.0473721790462776),
                                    ("Chhathin|during <named-month>|year", -6.0473721790462776),
                                    ("Diwaliin|during <named-month>|year", -6.0473721790462776),
                                    ("Vaisakhiin|during <named-month>|year", -6.0473721790462776),
                                    ("Raksha Bandhanyear (latent)", -6.0473721790462776),
                                    ("daysecond", -5.641907070938114),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.641907070938114),
                                    ("Ashurayear (latent)", -6.0473721790462776),
                                    ("Tuesdayin|during <named-month>|year", -6.0473721790462776),
                                    ("Chinese New Yearyear (latent)", -6.0473721790462776),
                                    ("Lag BaOmeryear (latent)", -6.0473721790462776),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.0473721790462776),
                                    ("Eid al-Adhayear (latent)", -5.131081447172123),
                                    ("intersectin|during the <part-of-day>", -6.0473721790462776),
                                    ("Palm Sundayyear (latent)", -6.0473721790462776),
                                    ("Christmasat <time-of-day>", -6.0473721790462776),
                                    ("Passoveryear (latent)", -6.0473721790462776),
                                    ("Lazarus Saturdayyear (latent)", -6.0473721790462776),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.0473721790462776),
                                    ("Yom HaShoahyear (latent)", -5.641907070938114),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.641907070938114),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.0473721790462776),
                                    ("Septemberyear (latent)", -5.641907070938114),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.543294782270004),
                                    ("Halloweenyear (latent)", -6.0473721790462776),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.0473721790462776),
                                    ("at <time-of-day>intersect", -5.641907070938114),
                                    ("Rosh Hashanahyear (latent)", -5.354224998486333),
                                    ("Dhanterasyear (latent)", -6.0473721790462776),
                                    ("Tu BiShvatyear (latent)", -6.0473721790462776),
                                    ("Holiyear (latent)", -5.354224998486333),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.0473721790462776),
                                    ("Holika Dahanyear (latent)", -5.354224998486333),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0473721790462776),
                                    ("dayminute", -3.18517129811681),
                                    ("Mawlidyear (latent)", -6.0473721790462776),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.641907070938114),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.0473721790462776),
                                    ("Jumu'atul-Widayear (latent)", -5.131081447172123),
                                    ("minuteday", -2.4097860193198923),
                                    ("absorption of , after named dayintersect",
                                     -6.0473721790462776),
                                    ("Orthodox Easter Sundayyear (latent)", -6.0473721790462776),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.0473721790462776),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.0473721790462776),
                                    ("Boss's Dayyear (latent)", -5.641907070938114),
                                    ("Global Youth Service Dayyear (latent)", -6.0473721790462776),
                                    ("Dhanterasin|during <named-month>|year", -6.0473721790462776),
                                    ("Tisha B'Avyear (latent)", -6.0473721790462776),
                                    ("Isra and Mi'rajyear (latent)", -5.131081447172123),
                                    ("at <time-of-day>on <day>", -4.948759890378168),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.0473721790462776),
                                    ("Christmasyear (latent)", -5.641907070938114),
                                    ("Naraka Chaturdashiyear (latent)", -5.641907070938114),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.0473721790462776),
                                    ("dayweek", -6.0473721790462776),
                                    ("Easter Sundayyear (latent)", -5.354224998486333),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.437934266612178),
                                    ("weekyear", -4.948759890378168),
                                    ("hh:mmin|during the <part-of-day>", -5.354224998486333),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.641907070938114),
                                    ("Hanukkahyear (latent)", -5.354224998486333),
                                    ("February<time> <part-of-day>", -6.0473721790462776),
                                    ("Great Lentyear (latent)", -6.0473721790462776),
                                    ("tomorrowat <time-of-day>", -5.354224998486333),
                                    ("Vaisakhiyear (latent)", -5.354224998486333),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.0473721790462776),
                                    ("last <cycle> of <time>year (latent)", -5.354224998486333),
                                    ("at <time-of-day>tomorrow", -5.641907070938114),
                                    ("tomorrow<time-of-day> am|pm", -6.0473721790462776),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.0473721790462776),
                                    ("Diwaliyear (latent)", -6.0473721790462776),
                                    ("between <time> and <time>on <day>", -4.437934266612178),
                                    ("Black Fridayyear (latent)", -5.641907070938114),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.0473721790462776),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.0473721790462776),
                                    ("Chhathyear (latent)", -5.641907070938114),
                                    ("Vasant Panchamiyear (latent)", -6.0473721790462776),
                                    ("Thursday<time> (timezone)", -6.0473721790462776),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.0473721790462776),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.641907070938114),
                                    ("Februaryintersect", -6.0473721790462776),
                                    ("Simchat Torahyear (latent)", -6.0473721790462776),
                                    ("minuteyear", -6.0473721790462776)],
                               n = 318},
                   koData =
                     ClassData{prior = -1.0071199482434439, unseen = -6.3578422665081,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.746669748261791),
                                    ("dayhour", -3.0980111226744094),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.746669748261791),
                                    ("Tuesdayfrom|since|after <time>", -5.662960480135946),
                                    ("daymonth", -3.648057459593681),
                                    ("monthyear", -4.410197511640578),
                                    ("<time-of-day> am|pmyear (latent)", -4.969813299576001),
                                    ("Thai Pongalyear (latent)", -4.969813299576001),
                                    ("intersecthh:mm", -5.662960480135946),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.662960480135946),
                                    ("houryear", -4.564348191467836),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.662960480135946),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.969813299576001),
                                    ("<time-of-day> am|pmintersect", -4.410197511640578),
                                    ("Octoberyear (latent)", -5.662960480135946),
                                    ("until <time>on <day>", -4.969813299576001),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -4.969813299576001),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.662960480135946),
                                    ("hh:mmon <day>", -3.648057459593681),
                                    ("absorption of , after named dayJuly", -5.2574953720277815),
                                    ("from|since|after <time>July", -5.662960480135946),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.746669748261791),
                                    ("Clean Mondayyear (latent)", -5.662960480135946),
                                    ("monthhour", -5.662960480135946),
                                    ("hourmonth", -4.746669748261791),
                                    ("todayat <time-of-day>", -5.662960480135946),
                                    ("from|since|after <time>December", -5.662960480135946),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.662960480135946),
                                    ("<time-of-day> am|pmon <day>", -4.410197511640578),
                                    ("Mondayyear (latent)", -4.969813299576001),
                                    ("dayday", -5.2574953720277815),
                                    ("on <day>September", -5.2574953720277815),
                                    ("Thursdaydd/mm", -5.662960480135946),
                                    ("dayyear", -2.8007595992064775),
                                    ("New Year's Dayyear (latent)", -5.2574953720277815),
                                    ("Thursdayfrom|since|after <time>", -3.958212387897521),
                                    ("Thursdayat <time-of-day>", -4.053522567701846),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.662960480135946),
                                    ("Aprilyear (latent)", -5.662960480135946),
                                    ("monthminute", -5.662960480135946),
                                    ("<time-of-day> am|pmtomorrow", -5.662960480135946),
                                    ("Thursdayhh:mm", -4.746669748261791),
                                    ("minutemonth", -3.871201010907891),
                                    ("Augustyear (latent)", -5.2574953720277815),
                                    ("week-endin|during <named-month>|year", -5.662960480135946),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.662960480135946),
                                    ("Sundayyear (latent)", -4.746669748261791),
                                    ("Christmasat <time-of-day>", -5.662960480135946),
                                    ("from|since|after <time>year (latent)", -4.564348191467836),
                                    ("<duration> after|before|from <time>December",
                                     -5.662960480135946),
                                    ("yesterday<time-of-day> am|pm", -5.662960480135946),
                                    ...
                                    ("hh:mmyear (latent)", -4.410197511640578),
                                    ("Holiyear (latent)", -5.662960480135946),
                                    ("until <time><time-of-day> am|pm", -5.662960480135946),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.662960480135946),
                                    ("dayminute", -3.1372318358276905),
                                    ("yyyy-mm-ddhh:mm", -5.2574953720277815),
                                    ("intersectSeptember", -4.1588830833596715),
                                    ("minuteday", -2.5949075450023287),
                                    ("absorption of , after named dayintersect",
                                     -5.662960480135946),
                                    ("Februaryin|during the <part-of-day>", -5.662960480135946),
                                    ("Saturdayyear (latent)", -5.662960480135946),
                                    ("at <time-of-day>on <day>", -5.2574953720277815),
                                    ("absorption of , after named daySeptember",
                                     -4.746669748261791),
                                    ("Naraka Chaturdashiyear (latent)", -5.662960480135946),
                                    ("from|since|after <time>on <day>", -4.746669748261791),
                                    ("dayweek", -5.662960480135946),
                                    ("Easter Sundayyear (latent)", -5.2574953720277815),
                                    ("Thursday<time-of-day> am|pm", -4.410197511640578),
                                    ("weekyear", -5.2574953720277815),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -4.969813299576001),
                                    ("Sundayfrom|since|after <time>", -5.662960480135946),
                                    ("absorption of , after named dayFebruary", -4.746669748261791),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.662960480135946),
                                    ("tomorrowat <time-of-day>", -5.662960480135946),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.662960480135946),
                                    ("last <cycle> of <time>year (latent)", -5.2574953720277815),
                                    ("tomorrow<time-of-day> am|pm", -5.662960480135946),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.969813299576001),
                                    ("Diwaliyear (latent)", -5.2574953720277815),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.662960480135946),
                                    ("Fridayyear (latent)", -5.2574953720277815),
                                    ("minuteyear", -4.276666119016055)],
                               n = 183}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.5513717181603407, unseen = -4.499809670330265,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 87},
                   koData =
                     ClassData{prior = -0.8583967534552525, unseen = -4.204692619390966,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.2282586519809802, unseen = -5.53338948872752,
                               likelihoods =
                                 HashMap.fromList
                                   [("from|since|after <time>", -3.58351893845611),
                                    ("integer after|past <hour-of-day>", -4.143134726391533),
                                    ("at <time-of-day>", -2.310553262643223),
                                    ("<time-of-day> o'clock", -4.430816798843313),
                                    ("half after|past <hour-of-day>", -4.430816798843313),
                                    ("second", -4.836281906951478),
                                    ("hh:mm:ss", -4.836281906951478),
                                    ("<hour-of-day> <integer>", -3.919991175077323),
                                    ("time-of-day (latent)", -1.6792814858013647),
                                    ("hhmm (latent)", -4.836281906951478),
                                    ("hh:mm", -2.3939348715822737),
                                    ("quarter after|past <hour-of-day>", -4.836281906951478),
                                    ("until <time>", -4.143134726391533),
                                    ("about|exactly <time-of-day>", -4.836281906951478),
                                    ("hour", -1.1986957472250923),
                                    ("<time-of-day> sharp|exactly", -4.836281906951478),
                                    ("minute", -1.791759469228055)],
                               n = 117},
                   koData =
                     ClassData{prior = -1.589235205116581, unseen = -4.3694478524670215,
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -2.9704144655697013),
                                    ("from|since|after <time>", -3.258096538021482),
                                    ("time-of-day (latent)", -1.221214610760442),
                                    ("hh:mm", -3.258096538021482),
                                    ("until <time>", -3.6635616461296463),
                                    ("hour", -1.137833001821391), ("minute", -2.4107986776342782)],
                               n = 30}}),
       ("Yom Ha'atzmaut",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.0986122886681098,
