...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6445725104113881, unseen = -5.857933154483459,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 348},
                   koData =
                     ClassData{prior = -0.7442023513602295, unseen = -5.75890177387728,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.510303294164144, unseen = -6.921658184151128,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.227524323688738),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.227524323688738),
                                    ("Ramadanyear (latent)", -5.311233591814583),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.212621303146474),
                                    ("Bhai Doojyear (latent)", -6.227524323688738),
                                    ("hourday", -4.212621303146474),
                                    ("dayhour", -3.309753591604459),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.212621303146474),
                                    ("Martin Luther King's Dayyear (latent)", -5.822059215580573),
                                    ("Shemini Atzeretyear (latent)", -6.227524323688738),
                                    ("daymonth", -4.212621303146474),
                                    ("monthday", -5.822059215580573),
                                    ("monthyear", -4.435764854460683),
                                    ("Yom Ha'atzmautyear (latent)", -6.227524323688738),
                                    ("Vijayadashamiyear (latent)", -6.227524323688738),
                                    ("Thai Pongalyear (latent)", -5.5343771431287925),
                                    ("Thiru Onamyear (latent)", -5.5343771431287925),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.227524323688738),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.311233591814583),
                                    ("<day-of-month> (ordinal)Wednesday", -6.227524323688738),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.227524323688738),
                                    ("houryear", -5.311233591814583),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.227524323688738),
                                    ("Christmas<time-of-day> am|pm", -6.227524323688738),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.227524323688738),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.5343771431287925),
                                    ("intersectin|during <named-month>|year", -6.227524323688738),
                                    ("<time-of-day> am|pmintersect", -4.97476135519337),
                                    ("Earth Houryear (latent)", -6.227524323688738),
                                    ("Octoberyear (latent)", -4.723446926912464),
                                    ("intersect<time-of-day> am|pm", -6.227524323688738),
                                    ("Mattu Pongalyear (latent)", -6.227524323688738),
                                    ("Shavuotyear (latent)", -6.227524323688738),
                                    ("Parsi New Yearyear (latent)", -5.311233591814583),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.227524323688738),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.227524323688738),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.822059215580573),
                                    ("Marchyear (latent)", -6.227524323688738),
                                    ("Sukkotyear (latent)", -5.822059215580573),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.822059215580573),
                                    ("Clean Mondayyear (latent)", -5.822059215580573),
                                    ("monthhour", -5.822059215580573),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.5343771431287925),
                                    ("todayat <time-of-day>", -6.227524323688738),
                                    ("Thursday<time> timezone", -4.281614174633424),
                                    ("time-of-day (latent)tonight", -5.822059215580573),
                                    ("from|since|after <time>December", -6.227524323688738),
                                    ("<time-of-day> am|pmon <day>", -4.212621303146474),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.227524323688738),
                                    ("yyyy-mm-ddhh:mm:ss", -5.822059215580573),
                                    ("dayday", -3.7851772883195336),
                                    ("<time> <part-of-day>at <time-of-day>", -6.227524323688738),
                                    ("tonightat <time-of-day>", -6.227524323688738),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.5343771431287925),
                                    ("today<time-of-day> am|pm", -6.227524323688738),
                                    ("Februarythe <day-of-month> (ordinal)", -5.822059215580573),
                                    ("at <time-of-day><time> <part-of-day>", -6.227524323688738),
                                    ("<day-of-month> (ordinal)intersect", -5.822059215580573),
                                    ("hourhour", -4.148082782008903),
                                    ("Navaratriin|during <named-month>|year", -6.227524323688738),
                                    ("Wednesdaythis|last|next <cycle>", -6.227524323688738),
                                    ("Lentyear (latent)", -6.227524323688738),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.723446926912464),
                                    ("Boghiyear (latent)", -6.227524323688738),
                                    ("dayyear", -2.092357766946382),
                                    ("Thursdayfrom|since|after <time>", -5.822059215580573),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.227524323688738),
                                    ("Thursdayat <time-of-day>", -5.5343771431287925),
                                    ("Islamic New Yearyear (latent)", -5.822059215580573),
                                    ("Laylat al-Qadryear (latent)", -5.311233591814583),
                                    ("Shrove Tuesdayyear (latent)", -6.227524323688738),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.5343771431287925),
                                    ("<time-of-day> am|pmtomorrow", -5.5343771431287925),
                                    ("Yom Kippuryear (latent)", -6.227524323688738),
                                    ("<day-of-month> (ordinal)Tuesday", -5.822059215580573),
                                    ("<part-of-day> of <time>year (latent)", -6.227524323688738),
                                    ("minutehour", -5.128912035020629),
                                    ("Kaanum Pongalyear (latent)", -5.822059215580573),
                                    ("Maha Saptamiyear (latent)", -6.227524323688738),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.822059215580573),
                                    ("time-of-day (latent)tomorrow", -5.311233591814583),
                                    ("part of daysat <time-of-day>", -5.822059215580573),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.522776231450313),
                                    ("for <duration> from <time>December", -6.227524323688738),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.227524323688738),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.97476135519337),
                                    ("time-of-day (latent)this <part-of-day>", -6.227524323688738),
                                    ("Pentecostyear (latent)", -6.227524323688738),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.97476135519337),
                                    ("<day-of-month> (ordinal)February", -6.227524323688738),
                                    ("Eid al-Fitryear (latent)", -5.311233591814583),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.227524323688738),
                                    ("Mondayin|during the <part-of-day>", -6.227524323688738),
                                    ("Chhathin|during <named-month>|year", -6.227524323688738),
                                    ("Diwaliin|during <named-month>|year", -6.227524323688738),
                                    ("Vaisakhiin|during <named-month>|year", -6.227524323688738),
                                    ("Raksha Bandhanyear (latent)", -6.227524323688738),
                                    ("daysecond", -5.822059215580573),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.822059215580573),
                                    ("Ashurayear (latent)", -6.227524323688738),
                                    ("Tuesdayin|during <named-month>|year", -6.227524323688738),
                                    ("Chinese New Yearyear (latent)", -6.227524323688738),
                                    ("tomorrowintersect", -6.227524323688738),
                                    ("Lag BaOmeryear (latent)", -6.227524323688738),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.227524323688738),
                                    ("Eid al-Adhayear (latent)", -5.311233591814583),
                                    ("intersectin|during the <part-of-day>", -6.227524323688738),
                                    ("Palm Sundayyear (latent)", -6.227524323688738),
                                    ("Christmasat <time-of-day>", -6.227524323688738),
                                    ("Passoveryear (latent)", -6.227524323688738),
                                    ("Lazarus Saturdayyear (latent)", -6.227524323688738),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.227524323688738),
                                    ("Yom HaShoahyear (latent)", -5.822059215580573),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.822059215580573),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.227524323688738),
                                    ("Septemberyear (latent)", -5.822059215580573),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.723446926912464),
                                    ("Halloweenyear (latent)", -6.227524323688738),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.227524323688738),
                                    ("at <time-of-day>intersect", -5.822059215580573),
                                    ("Rosh Hashanahyear (latent)", -5.5343771431287925),
                                    ("Dhanterasyear (latent)", -6.227524323688738),
                                    ("Tu BiShvatyear (latent)", -6.227524323688738),
                                    ("<day-of-month> (ordinal)December", -5.5343771431287925),
                                    ("Holiyear (latent)", -5.5343771431287925),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.227524323688738),
                                    ("Holika Dahanyear (latent)", -5.5343771431287925),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.227524323688738),
                                    ("dayminute", -3.3653234427592698),
                                    ("Mawlidyear (latent)", -6.227524323688738),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.822059215580573),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.227524323688738),
                                    ("Jumu'atul-Widayear (latent)", -5.311233591814583),
                                    ("minuteday", -2.3988829271996432),
                                    ("absorption of , after named dayintersect",
                                     -6.227524323688738),
                                    ("intersectyear (latent)", -6.227524323688738),
                                    ("Orthodox Easter Sundayyear (latent)", -6.227524323688738),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.227524323688738),
                                    ("Boss's Dayyear (latent)", -5.822059215580573),
                                    ("Global Youth Service Dayyear (latent)", -6.227524323688738),
                                    ("Dhanterasin|during <named-month>|year", -6.227524323688738),
                                    ("Tisha B'Avyear (latent)", -6.227524323688738),
                                    ("Isra and Mi'rajyear (latent)", -5.311233591814583),
                                    ("at <time-of-day>on <day>", -5.128912035020629),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.227524323688738),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.5343771431287925),
                                    ("Christmasyear (latent)", -5.822059215580573),
                                    ("Naraka Chaturdashiyear (latent)", -5.822059215580573),
                                    ("Thai Pongalin|during <named-month>|year", -6.227524323688738),
                                    ("dayweek", -6.227524323688738),
                                    ("Easter Sundayyear (latent)", -5.5343771431287925),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.618086411254637),
                                    ("weekyear", -5.128912035020629),
                                    ("hh:mmin|during the <part-of-day>", -5.5343771431287925),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.822059215580573),
                                    ("Hanukkahyear (latent)", -5.5343771431287925),
                                    ("February<time> <part-of-day>", -6.227524323688738),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.227524323688738),
                                    ("Great Lentyear (latent)", -6.227524323688738),
                                    ("tomorrowat <time-of-day>", -5.5343771431287925),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.227524323688738),
                                    ("Vaisakhiyear (latent)", -5.5343771431287925),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.227524323688738),
                                    ("last <cycle> of <time>year (latent)", -5.5343771431287925),
                                    ("at <time-of-day>tomorrow", -5.822059215580573),
                                    ("tomorrow<time-of-day> am|pm", -6.227524323688738),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.227524323688738),
                                    ("Diwaliyear (latent)", -6.227524323688738),
                                    ("between <time> and <time>on <day>", -4.618086411254637),
                                    ("Black Fridayyear (latent)", -5.822059215580573),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.227524323688738),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.227524323688738),
                                    ("Chhathyear (latent)", -5.822059215580573),
                                    ("Vasant Panchamiyear (latent)", -6.227524323688738),
                                    ("St Patrick's Dayyear (latent)", -6.227524323688738),
                                    ("Thursday<time> (timezone)", -6.227524323688738),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.227524323688738),
                                    ("<datetime> - <datetime> (interval)July", -5.822059215580573),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.822059215580573),
                                    ("Februaryintersect", -6.227524323688738),
                                    ("Simchat Torahyear (latent)", -6.227524323688738),
                                    ("minuteyear", -6.227524323688738)],
                               n = 383},
                   koData =
                     ClassData{prior = -0.9170747381863638, unseen = -6.630683385642372,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.2281658717752935),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.936216072877503),
                                    ("<day-of-month> (ordinal)August", -5.936216072877503),
                                    ("dayhour", -3.371266715415967),
                                    ("<time> timezoneyear (latent)", -5.936216072877503),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.019925341003348),
                                    ("Tuesdayfrom|since|after <time>", -5.936216072877503),
                                    ("daymonth", -3.451309423089503),
                                    ("monthyear", -4.683453104382135),
                                    ("<time-of-day> am|pmyear (latent)", -5.243068892317559),
                                    ("Thai Pongalyear (latent)", -5.243068892317559),
                                    ("intersecthh:mm", -5.936216072877503),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.530750964769339),
                                    ("<day-of-month> (ordinal)Wednesday", -5.936216072877503),
                                    ("houryear", -4.549921711757613),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.936216072877503),
                                    ("<day-of-month> (ordinal)October", -5.936216072877503),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.243068892317559),
                                    ("<time-of-day> am|pmintersect", -4.683453104382135),
                                    ("Octoberyear (latent)", -5.936216072877503),
                                    ("until <time>on <day>", -5.243068892317559),
                                    ("time-of-day (latent)intersect", -5.936216072877503),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.243068892317559),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.936216072877503),
                                    ("hh:mmon <day>", -3.4938690375082992),
                                    ("absorption of , after named dayJuly", -5.530750964769339),
                                    ("from|since|after <time>July", -5.530750964769339),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.019925341003348),
                                    ("Clean Mondayyear (latent)", -5.936216072877503),
                                    ("monthhour", -5.936216072877503),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.530750964769339),
                                    ("hourmonth", -4.064413895975912),
                                    ("todayat <time-of-day>", -5.936216072877503),
                                    ("from|since|after <time>December", -5.936216072877503),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.936216072877503),
                                    ("<time-of-day> am|pmon <day>", -4.683453104382135),
                                    ("Mondayyear (latent)", -5.243068892317559),
                                    ("dayday", -4.549921711757613),
                                    ("on <day>September", -5.530750964769339),
                                    ("time-of-day (latent)September", -5.530750964769339),
                                    ("hourhour", -5.936216072877503),
                                    ("time-of-day (latent)on <day>", -3.4938690375082992),
                                    ("Thursdaydd/mm", -5.936216072877503),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.530750964769339),
                                    ("dayyear", -3.018445340793224),
                                    ("New Year's Dayyear (latent)", -5.019925341003348),
                                    ("Thursdayfrom|since|after <time>", -4.231467980639078),
                                    ("Thursdayat <time-of-day>", -4.3267781604434035),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.936216072877503),
                                    ("Aprilyear (latent)", -5.936216072877503),
                                    ("the <day-of-month> (ordinal)July", -5.936216072877503),
                                    ("the <day-of-month> (number)July", -5.936216072877503),
                                    ("monthminute", -5.936216072877503),
                                    ("<time-of-day> am|pmtomorrow", -5.936216072877503),
                                    ("Thursdayhh:mm", -5.019925341003348),
                                    ("<day-of-month> (ordinal)Tuesday", -5.530750964769339),
                                    ("minutemonth", -4.064413895975912),
                                    ("minutehour", -5.936216072877503),
                                    ("Augustyear (latent)", -5.530750964769339),
                                    ("week-endin|during <named-month>|year", -5.936216072877503),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.936216072877503),
                                    ("Sundayyear (latent)", -5.019925341003348),
                                    ("Christmasat <time-of-day>", -5.936216072877503),
                                    ("from|since|after <time>year (latent)", -4.837603784209394),
                                    ("<duration> after|before|from <time>December",
                                     -5.936216072877503),
                                    ("yesterday<time-of-day> am|pm", -5.936216072877503),
                                    ("<day-of-month> (ordinal)July", -5.243068892317559),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.936216072877503),
                                    ("at <time-of-day>intersect", -5.530750964769339),
                                    ("hh:mmyear (latent)", -3.8567745311976673),
                                    ("Holiyear (latent)", -5.936216072877503),
                                    ("until <time><time-of-day> am|pm", -5.936216072877503),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.936216072877503),
                                    ("dayminute", -3.410487428569248),
                                    ("yyyy-mm-ddhh:mm", -5.530750964769339),
                                    ("intersectSeptember", -4.432138676101229),
                                    ("minuteday", -2.697537620713123),
                                    ("absorption of , after named dayintersect",
                                     -5.936216072877503),
                                    ("intersectyear (latent)", -5.936216072877503),
                                    ("Februaryin|during the <part-of-day>", -5.936216072877503),
                                    ("time-of-day (latent)July", -5.243068892317559),
                                    ("Saturdayyear (latent)", -5.936216072877503),
                                    ("at <time-of-day>on <day>", -5.530750964769339),
                                    ("absorption of , after named daySeptember",
                                     -5.019925341003348),
                                    ("Naraka Chaturdashiyear (latent)", -5.936216072877503),
                                    ("from|since|after <time>on <day>", -5.019925341003348),
                                    ("dayweek", -5.936216072877503),
                                    ("Easter Sundayyear (latent)", -5.530750964769339),
                                    ("Thursday<time-of-day> am|pm", -4.683453104382135),
                                    ("weekyear", -5.530750964769339),
                                    ("time-of-day (latent)Thursday", -5.530750964769339),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.936216072877503),
                                    ("<day-of-month> (ordinal)April", -5.936216072877503),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.530750964769339),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.243068892317559),
                                    ("Sundayfrom|since|after <time>", -5.936216072877503),
                                    ("absorption of , after named dayFebruary", -5.019925341003348),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.936216072877503),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.936216072877503),
                                    ("tomorrowat <time-of-day>", -5.936216072877503),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.530750964769339),
                                    ("last <cycle> of <time>year (latent)", -5.530750964769339),
                                    ("tomorrow<time-of-day> am|pm", -5.936216072877503),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.243068892317559),
                                    ("Diwaliyear (latent)", -5.530750964769339),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.936216072877503),
                                    ("Fridayyear (latent)", -5.530750964769339),
                                    ("time-of-day (latent)April", -5.936216072877503),
                                    ("minuteyear", -3.738991495541284)],
                               n = 255}}),
       ("one eleven",
        Classifier{okData =
