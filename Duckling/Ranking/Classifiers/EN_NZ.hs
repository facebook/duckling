...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6432102272740067, unseen = -5.860786223465865,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 349},
                   koData =
                     ClassData{prior = -0.7457095106508007, unseen = -5.75890177387728,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5092619017898079, unseen = -6.92461239604856,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.230481447578482),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.230481447578482),
                                    ("Ramadanyear (latent)", -5.314190715704327),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.215578427036217),
                                    ("Bhai Doojyear (latent)", -6.230481447578482),
                                    ("hourday", -4.215578427036217),
                                    ("dayhour", -3.312710715494203),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.215578427036217),
                                    ("Martin Luther King's Dayyear (latent)", -5.825016339470317),
                                    ("Shemini Atzeretyear (latent)", -6.230481447578482),
                                    ("daymonth", -4.215578427036217),
                                    ("monthday", -5.825016339470317),
                                    ("monthyear", -4.438721978350427),
                                    ("Yom Ha'atzmautyear (latent)", -6.230481447578482),
                                    ("Vijayadashamiyear (latent)", -6.230481447578482),
                                    ("Thai Pongalyear (latent)", -5.537334267018537),
                                    ("Thiru Onamyear (latent)", -5.537334267018537),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.230481447578482),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.314190715704327),
                                    ("<day-of-month> (ordinal)Wednesday", -6.230481447578482),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.230481447578482),
                                    ("houryear", -5.314190715704327),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.230481447578482),
                                    ("Christmas<time-of-day> am|pm", -6.230481447578482),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.230481447578482),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.537334267018537),
                                    ("intersectin|during <named-month>|year", -6.230481447578482),
                                    ("<time-of-day> am|pmintersect", -4.977718479083114),
                                    ("Earth Houryear (latent)", -6.230481447578482),
                                    ("Octoberyear (latent)", -4.726404050802208),
                                    ("intersect<time-of-day> am|pm", -6.230481447578482),
                                    ("Mattu Pongalyear (latent)", -6.230481447578482),
                                    ("Shavuotyear (latent)", -6.230481447578482),
                                    ("Parsi New Yearyear (latent)", -5.314190715704327),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.230481447578482),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.230481447578482),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.825016339470317),
                                    ("Marchyear (latent)", -6.230481447578482),
                                    ("Sukkotyear (latent)", -5.825016339470317),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.825016339470317),
                                    ("Clean Mondayyear (latent)", -5.825016339470317),
                                    ("monthhour", -5.825016339470317),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.537334267018537),
                                    ("todayat <time-of-day>", -6.230481447578482),
                                    ("Thursday<time> timezone", -4.2845712985231685),
                                    ("time-of-day (latent)tonight", -5.825016339470317),
                                    ("from|since|after <time>December", -6.230481447578482),
                                    ("<time-of-day> am|pmon <day>", -4.215578427036217),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.230481447578482),
                                    ("yyyy-mm-ddhh:mm:ss", -5.825016339470317),
                                    ("dayday", -3.7881344122092773),
                                    ("<time> <part-of-day>at <time-of-day>", -6.230481447578482),
                                    ("tonightat <time-of-day>", -6.230481447578482),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.537334267018537),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.230481447578482),
                                    ("today<time-of-day> am|pm", -6.230481447578482),
                                    ("Februarythe <day-of-month> (ordinal)", -5.825016339470317),
                                    ("at <time-of-day><time> <part-of-day>", -6.230481447578482),
                                    ("<day-of-month> (ordinal)intersect", -5.825016339470317),
                                    ("hourhour", -4.151039905898646),
                                    ("Navaratriin|during <named-month>|year", -6.230481447578482),
                                    ("Wednesdaythis|last|next <cycle>", -6.230481447578482),
                                    ("Lentyear (latent)", -6.230481447578482),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.726404050802208),
                                    ("Boghiyear (latent)", -6.230481447578482),
                                    ("dayyear", -2.087346721186949),
                                    ("Thursdayfrom|since|after <time>", -5.825016339470317),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.230481447578482),
                                    ("Thursdayat <time-of-day>", -5.537334267018537),
                                    ("Islamic New Yearyear (latent)", -5.825016339470317),
                                    ("Laylat al-Qadryear (latent)", -5.314190715704327),
                                    ("Shrove Tuesdayyear (latent)", -6.230481447578482),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.537334267018537),
                                    ("<time-of-day> am|pmtomorrow", -5.537334267018537),
                                    ("Yom Kippuryear (latent)", -6.230481447578482),
                                    ("<day-of-month> (ordinal)Tuesday", -5.825016339470317),
                                    ("<part-of-day> of <time>year (latent)", -6.230481447578482),
                                    ("minutehour", -5.131869158910372),
                                    ("Kaanum Pongalyear (latent)", -5.825016339470317),
                                    ("Maha Saptamiyear (latent)", -6.230481447578482),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.825016339470317),
                                    ("time-of-day (latent)tomorrow", -5.314190715704327),
                                    ("part of daysat <time-of-day>", -5.825016339470317),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.525733355340057),
                                    ("for <duration> from <time>December", -6.230481447578482),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.230481447578482),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.977718479083114),
                                    ("time-of-day (latent)this <part-of-day>", -6.230481447578482),
                                    ("Pentecostyear (latent)", -6.230481447578482),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.977718479083114),
                                    ("<day-of-month> (ordinal)February", -6.230481447578482),
                                    ("Eid al-Fitryear (latent)", -5.314190715704327),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.230481447578482),
                                    ("Mondayin|during the <part-of-day>", -6.230481447578482),
                                    ("Chhathin|during <named-month>|year", -6.230481447578482),
                                    ("Diwaliin|during <named-month>|year", -6.230481447578482),
                                    ("Vaisakhiin|during <named-month>|year", -6.230481447578482),
                                    ("Raksha Bandhanyear (latent)", -6.230481447578482),
                                    ("daysecond", -5.825016339470317),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.825016339470317),
                                    ("Ashurayear (latent)", -6.230481447578482),
                                    ("Tuesdayin|during <named-month>|year", -6.230481447578482),
                                    ("Chinese New Yearyear (latent)", -6.230481447578482),
                                    ("tomorrowintersect", -6.230481447578482),
                                    ("Lag BaOmeryear (latent)", -6.230481447578482),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.230481447578482),
                                    ("Eid al-Adhayear (latent)", -5.314190715704327),
                                    ("intersectin|during the <part-of-day>", -6.230481447578482),
                                    ("Palm Sundayyear (latent)", -6.230481447578482),
                                    ("Christmasat <time-of-day>", -6.230481447578482),
                                    ("Passoveryear (latent)", -6.230481447578482),
                                    ("Lazarus Saturdayyear (latent)", -6.230481447578482),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.230481447578482),
                                    ("Yom HaShoahyear (latent)", -5.825016339470317),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.825016339470317),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.230481447578482),
                                    ("Septemberyear (latent)", -5.825016339470317),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.726404050802208),
                                    ("Halloweenyear (latent)", -6.230481447578482),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.230481447578482),
                                    ("at <time-of-day>intersect", -5.825016339470317),
                                    ("Rosh Hashanahyear (latent)", -5.537334267018537),
                                    ("Dhanterasyear (latent)", -6.230481447578482),
                                    ("Tu BiShvatyear (latent)", -6.230481447578482),
                                    ("<day-of-month> (ordinal)December", -5.537334267018537),
                                    ("Holiyear (latent)", -5.537334267018537),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.230481447578482),
                                    ("Holika Dahanyear (latent)", -5.537334267018537),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.230481447578482),
                                    ("dayminute", -3.3682805666490134),
                                    ("Mawlidyear (latent)", -6.230481447578482),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.825016339470317),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.230481447578482),
                                    ("Jumu'atul-Widayear (latent)", -5.314190715704327),
                                    ("minuteday", -2.401840051089387),
                                    ("absorption of , after named dayintersect",
                                     -6.230481447578482),
                                    ("intersectyear (latent)", -6.230481447578482),
                                    ("Orthodox Easter Sundayyear (latent)", -6.230481447578482),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.230481447578482),
                                    ("Boss's Dayyear (latent)", -5.825016339470317),
                                    ("Global Youth Service Dayyear (latent)", -6.230481447578482),
                                    ("Dhanterasin|during <named-month>|year", -6.230481447578482),
                                    ("Tisha B'Avyear (latent)", -6.230481447578482),
                                    ("Isra and Mi'rajyear (latent)", -5.314190715704327),
                                    ("at <time-of-day>on <day>", -5.131869158910372),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.230481447578482),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.537334267018537),
                                    ("Christmasyear (latent)", -5.825016339470317),
                                    ("Naraka Chaturdashiyear (latent)", -5.825016339470317),
                                    ("Thai Pongalin|during <named-month>|year", -6.230481447578482),
                                    ("dayweek", -6.230481447578482),
                                    ("Easter Sundayyear (latent)", -5.537334267018537),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.6210435351443815),
                                    ("weekyear", -5.131869158910372),
                                    ("hh:mmin|during the <part-of-day>", -5.537334267018537),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.825016339470317),
                                    ("Hanukkahyear (latent)", -5.537334267018537),
                                    ("February<time> <part-of-day>", -6.230481447578482),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.230481447578482),
                                    ("Great Lentyear (latent)", -6.230481447578482),
                                    ("tomorrowat <time-of-day>", -5.537334267018537),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.230481447578482),
                                    ("Vaisakhiyear (latent)", -5.537334267018537),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.230481447578482),
                                    ("last <cycle> of <time>year (latent)", -5.537334267018537),
                                    ("at <time-of-day>tomorrow", -5.825016339470317),
                                    ("tomorrow<time-of-day> am|pm", -6.230481447578482),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.230481447578482),
                                    ("Diwaliyear (latent)", -6.230481447578482),
                                    ("between <time> and <time>on <day>", -4.6210435351443815),
                                    ("Black Fridayyear (latent)", -5.825016339470317),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.230481447578482),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.230481447578482),
                                    ("Chhathyear (latent)", -5.825016339470317),
                                    ("Vasant Panchamiyear (latent)", -6.230481447578482),
                                    ("St Patrick's Dayyear (latent)", -6.230481447578482),
                                    ("Thursday<time> (timezone)", -6.230481447578482),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.230481447578482),
                                    ("<datetime> - <datetime> (interval)July", -5.825016339470317),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.825016339470317),
                                    ("Februaryintersect", -6.230481447578482),
                                    ("Simchat Torahyear (latent)", -6.230481447578482),
                                    ("minuteyear", -6.230481447578482)],
                               n = 384},
                   koData =
                     ClassData{prior = -0.9186409092191087,
                               unseen = -6.6320017773956295,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.2294860039802162),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.937536205082426),
                                    ("<day-of-month> (ordinal)August", -5.937536205082426),
                                    ("dayhour", -3.3725868476208896),
                                    ("<time> timezoneyear (latent)", -5.937536205082426),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.021245473208271),
                                    ("Tuesdayfrom|since|after <time>", -5.937536205082426),
                                    ("daymonth", -3.452629555294426),
                                    ("monthyear", -4.684773236587058),
                                    ("<time-of-day> am|pmyear (latent)", -5.244389024522481),
                                    ("Thai Pongalyear (latent)", -5.244389024522481),
                                    ("intersecthh:mm", -5.937536205082426),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.532071096974262),
                                    ("<day-of-month> (ordinal)Wednesday", -5.937536205082426),
                                    ("houryear", -4.5512418439625355),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.937536205082426),
                                    ("<day-of-month> (ordinal)October", -5.937536205082426),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.244389024522481),
                                    ("<time-of-day> am|pmintersect", -4.684773236587058),
                                    ("Octoberyear (latent)", -5.937536205082426),
                                    ("until <time>on <day>", -5.244389024522481),
                                    ("time-of-day (latent)intersect", -5.937536205082426),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.244389024522481),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.937536205082426),
                                    ("hh:mmon <day>", -3.495189169713222),
                                    ("absorption of , after named dayJuly", -5.532071096974262),
                                    ("from|since|after <time>July", -5.532071096974262),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.021245473208271),
                                    ("Clean Mondayyear (latent)", -5.937536205082426),
                                    ("monthhour", -5.937536205082426),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.532071096974262),
                                    ("hourmonth", -4.065734028180835),
                                    ("todayat <time-of-day>", -5.937536205082426),
                                    ("from|since|after <time>December", -5.937536205082426),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.937536205082426),
                                    ("<time-of-day> am|pmon <day>", -4.684773236587058),
                                    ("Mondayyear (latent)", -5.244389024522481),
                                    ("dayday", -4.5512418439625355),
                                    ("on <day>September", -5.532071096974262),
                                    ("time-of-day (latent)September", -5.532071096974262),
                                    ("hourhour", -5.937536205082426),
                                    ("time-of-day (latent)on <day>", -3.495189169713222),
                                    ("Thursdaydd/mm", -5.937536205082426),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.532071096974262),
                                    ("dayyear", -3.0197654729981473),
                                    ("New Year's Dayyear (latent)", -5.021245473208271),
                                    ("Thursdayfrom|since|after <time>", -4.232788112844001),
                                    ("Thursdayat <time-of-day>", -4.328098292648326),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.937536205082426),
                                    ("Aprilyear (latent)", -5.937536205082426),
                                    ("the <day-of-month> (ordinal)July", -5.937536205082426),
                                    ("the <day-of-month> (number)July", -5.937536205082426),
                                    ("monthminute", -5.937536205082426),
                                    ("<time-of-day> am|pmtomorrow", -5.937536205082426),
                                    ("Thursdayhh:mm", -5.021245473208271),
                                    ("<day-of-month> (ordinal)Tuesday", -5.532071096974262),
                                    ("minutemonth", -4.065734028180835),
                                    ("minutehour", -5.937536205082426),
                                    ("Augustyear (latent)", -5.532071096974262),
                                    ("week-endin|during <named-month>|year", -5.937536205082426),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.937536205082426),
                                    ("Sundayyear (latent)", -5.021245473208271),
                                    ("Christmasat <time-of-day>", -5.937536205082426),
                                    ("from|since|after <time>year (latent)", -4.838923916414316),
                                    ("<duration> after|before|from <time>December",
                                     -5.937536205082426),
                                    ("yesterday<time-of-day> am|pm", -5.937536205082426),
                                    ("<day-of-month> (ordinal)July", -5.244389024522481),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.937536205082426),
                                    ("at <time-of-day>intersect", -5.532071096974262),
                                    ("hh:mmyear (latent)", -3.8580946634025906),
                                    ("Holiyear (latent)", -5.937536205082426),
                                    ("until <time><time-of-day> am|pm", -5.937536205082426),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.937536205082426),
                                    ("dayminute", -3.4118075607741707),
                                    ("yyyy-mm-ddhh:mm", -5.532071096974262),
                                    ("intersectSeptember", -4.433458808306153),
                                    ("minuteday", -2.698857752918046),
                                    ("absorption of , after named dayintersect",
                                     -5.937536205082426),
                                    ("intersectyear (latent)", -5.937536205082426),
                                    ("Februaryin|during the <part-of-day>", -5.937536205082426),
                                    ("time-of-day (latent)July", -5.244389024522481),
                                    ("Saturdayyear (latent)", -5.937536205082426),
                                    ("at <time-of-day>on <day>", -5.532071096974262),
                                    ("absorption of , after named daySeptember",
                                     -5.021245473208271),
                                    ("Naraka Chaturdashiyear (latent)", -5.937536205082426),
                                    ("from|since|after <time>on <day>", -5.021245473208271),
                                    ("dayweek", -5.937536205082426),
                                    ("Easter Sundayyear (latent)", -5.532071096974262),
                                    ("Thursday<time-of-day> am|pm", -4.684773236587058),
                                    ("weekyear", -5.532071096974262),
                                    ("time-of-day (latent)Thursday", -5.532071096974262),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.937536205082426),
                                    ("<day-of-month> (ordinal)April", -5.937536205082426),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.532071096974262),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.244389024522481),
                                    ("Sundayfrom|since|after <time>", -5.937536205082426),
                                    ("absorption of , after named dayFebruary", -5.021245473208271),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.937536205082426),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.937536205082426),
                                    ("tomorrowat <time-of-day>", -5.937536205082426),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.532071096974262),
                                    ("last <cycle> of <time>year (latent)", -5.532071096974262),
                                    ("tomorrow<time-of-day> am|pm", -5.937536205082426),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.244389024522481),
                                    ("Diwaliyear (latent)", -5.532071096974262),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.937536205082426),
                                    ("Fridayyear (latent)", -5.532071096974262),
                                    ("time-of-day (latent)April", -5.937536205082426),
                                    ("minuteyear", -3.740311627746207)],
                               n = 255}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.2030759882634005, unseen = -5.049856007249537,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 151},
                   koData =
                     ClassData{prior = -1.6939953004621633,
