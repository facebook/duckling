                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("last weekend of <named-month>year", -5.6577385361547945),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.6577385361547945),
                                    ("Sundayyear", -5.6577385361547945),
                                    ...
                                    ("Shrove Tuesdayyear", -5.6577385361547945),
                                    ("<part-of-day> of <time>year", -5.6577385361547945),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.25227342804663),
                                    ("intersectin|during the <part-of-day>", -5.6577385361547945),
                                    ("Christmasat <time-of-day>", -5.6577385361547945),
                                    ...
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.6577385361547945),
                                    ("dayminute", -3.0550488507104103),
                                    ("Orthodox Easter Sundayyear", -5.6577385361547945),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.25227342804663),
                                    ("intersectyear", -5.6577385361547945),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.6577385361547945),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.25227342804663),
                                    ("<ordinal> <cycle> of <time>year", -5.6577385361547945),
                                    ("minuteday", -2.1920026333550675),
                                    ("absorption of , after named dayintersect",
                                     -5.6577385361547945),
                                    ("Octoberyear", -4.404975567659426),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.6577385361547945),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.6577385361547945),
                                    ("year<time-of-day> am|pm", -5.6577385361547945),
                                    ...
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.964591355594849),
                                    ("Halloweenyear", -5.6577385361547945),
                                    ("dayweek", -5.6577385361547945),
                                    ("Lazarus Saturdayyear", -5.6577385361547945),
                                    ...
                                    ("Martin Luther King's Dayyear", -5.25227342804663),
                                    ("tomorrowat <time-of-day>", -4.964591355594849),
                                    ("between <time> and <time>on <date>", -4.964591355594849),
                                    ...
                                    ("Pentecostyear", -5.6577385361547945),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.6577385361547945),
                                    ("Palm Sundayintersect", -5.6577385361547945),
                                    ("Labor Dayyear", -5.6577385361547945),
                                    ("Great Lentyear", -5.6577385361547945),
                                    ("Februaryintersect", -5.6577385361547945),
                                    ("last <cycle> of <time>year", -4.964591355594849),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.6577385361547945),
                                    ("yearminute", -5.6577385361547945),
                                    ("Black Fridayyear", -5.25227342804663)],
                               n = 212},
                   koData =
                     ClassData{prior = -0.9395475940384223, unseen = -6.045005314036012,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.349485653122436),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.349485653122436),
                                    ("hourday", -5.349485653122436),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.349485653122436),
                                    ("dayhour", -3.0469005601283903),
                                    ("daymonth", -3.2700441114426),
                                    ("monthday", -4.944020545014272),
                                    ("monthyear", -4.65633847256249),
                                    ("intersecthh:mm", -5.349485653122436),
                                    ("Easter Sundayyear", -4.944020545014272),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.349485653122436),
                                    ("houryear", -5.349485653122436),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.349485653122436),
                                    ("until <time-of-day><time-of-day> am|pm", -5.349485653122436),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.65633847256249),
                                    ("<time-of-day> am|pmintersect", -4.096722684627068),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.433194921248281),
                                    ("Clean Mondayyear", -5.349485653122436),
                                    ("from|since|after <time-of-day>on <date>", -4.433194921248281),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.349485653122436),
                                    ("absorption of , after named dayJuly", -4.944020545014272),
                                    ("monthhour", -5.349485653122436),
                                    ("hourmonth", -4.65633847256249),
                                    ("todayat <time-of-day>", -5.349485653122436),
                                    ("from|since|after <time-of-day>July", -5.349485653122436),
                                    ("dayday", -4.944020545014272),
                                    ("<time-of-day> am|pmon <date>", -4.096722684627068),
                                    ("Thursdaydd/mm", -5.349485653122436),
                                    ("dayyear", -3.2094194896261654),
                                    ("Sundayyear", -4.65633847256249),
                                    ("Thursdayat <time-of-day>", -4.096722684627068),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.349485653122436),
                                    ("monthminute", -5.349485653122436),
                                    ("<time-of-day> am|pmtomorrow", -5.349485653122436),
                                    ("Thursdayhh:mm", -4.433194921248281),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.349485653122436),
                                    ("Fridayyear", -4.944020545014272),
                                    ("minutemonth", -3.5577261838943812),
                                    ("Sundayfrom|since|after <time-of-day>", -5.349485653122436),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.944020545014272),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.944020545014272),
                                    ("Aprilyear", -5.349485653122436),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.349485653122436),
                                    ("Christmasat <time-of-day>", -5.349485653122436),
                                    ("<duration> after|before|from <time>December",
                                     -5.349485653122436),
                                    ("yesterday<time-of-day> am|pm", -5.349485653122436),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.349485653122436),
                                    ("until <time-of-day>on <date>", -4.65633847256249),
                                    ("Mondayyear", -4.65633847256249),
                                    ("Saturdayyear", -5.349485653122436),
                                    ("at <time-of-day>intersect", -4.944020545014272),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.349485653122436),
                                    ("dayminute", -2.864579003334436),
                                    ("intersectSeptember", -3.845408256346162),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.349485653122436),
                                    ("minuteday", -2.431714921038157),
                                    ("absorption of , after named dayintersect",
                                     -5.349485653122436),
                                    ("Februaryin|during the <part-of-day>", -5.349485653122436),
                                    ("week-endin <named-month>", -5.349485653122436),
                                    ("Octoberyear", -5.349485653122436),
                                    ("from|since|after <time-of-day>year", -5.349485653122436),
                                    ("yearhh:mm", -5.349485653122436),
                                    ("hh:mmon <date>", -3.845408256346162),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.349485653122436),
                                    ("absorption of , after named daySeptember",
                                     -4.433194921248281),
                                    ("on <date>September", -4.944020545014272),
                                    ("at <time-of-day>on <date>", -4.944020545014272),
                                    ("dayweek", -5.349485653122436),
                                    ("Thursday<time-of-day> am|pm", -4.944020545014272),
                                    ("absorption of , after named dayFebruary", -4.433194921248281),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.349485653122436),
                                    ("tomorrowat <time-of-day>", -5.349485653122436),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.349485653122436),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.7400477406883357),
                                    ("tomorrow<time-of-day> am|pm", -5.349485653122436),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.349485653122436),
                                    ("yearminute", -5.349485653122436)],
                               n = 136}}),
       ("one eleven",
        Classifier{okData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Martin Luther King's Day", -2.4849066497880004),
                                    ("Halloween", -2.4849066497880004),
                                    ("Wednesday", -2.4849066497880004),
                                    ("Monday", -2.4849066497880004), ("day", -1.0986122886681098),
                                    ("March", -2.4849066497880004), ("month", -2.4849066497880004),
