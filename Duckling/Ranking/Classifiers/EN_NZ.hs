                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.0330862217988015),
                                    ...
                                    ("<time-of-day> am|pmon <day>", -4.018183201256536),
                                    ...
                                    ("between <time> and <time>on <day>", -4.423648309364701),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.760463070394127),
                                    ...
                                    ("until <time>on <day>", -4.983606621708336),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -4.983606621708336),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.676753802268282),
                                    ("hh:mmon <day>", -3.661850781726017),
                                    ...
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.676753802268282),
                                    ("<time-of-day> am|pmon <day>", -4.423990833772914),
                                    ("Mondayyear (latent)", -4.983606621708336),
                                    ("dayday", -5.271288694160117),
                                    ("on <day>September", -5.271288694160117),
                                    ...
                                    ("at <time-of-day>on <day>", -5.271288694160117),
                                    ("absorption of , after named daySeptember",
                                     -4.760463070394127),
                                    ("Naraka Chaturdashiyear (latent)", -5.676753802268282),
                                    ("from|since|after <time>on <day>", -4.760463070394127),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                    ...
                                    ("on <day><time-of-day> am|pm", -4.22683374526818),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week-endJuly", -4.051784947803305),
                                    ...
                                    ("on <day>September", -3.6463198396951406),
