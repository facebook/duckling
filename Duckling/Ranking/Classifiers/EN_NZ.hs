...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7185364145647648, unseen = -5.176149732573829,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 175},
                   koData =
                     ClassData{prior = -0.6683866308792932, unseen = -5.225746673713201,
                                 ...
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.838264068155469),
                                    ("Thursdayfrom <time-of-day>", -4.838264068155469),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.2284312390838705),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.312140507209715),
                                    ("Tuesdayafter <time-of-day>", -5.2284312390838705),
                                    ...
                                    ("Thursdayfrom <time-of-day>", -3.61899332664977),
                                    ("dayweek", -5.2284312390838705),
                                    ("from <time-of-day>on <date>", -4.312140507209715),
                                    ...
                                    ("after <time-of-day><time-of-day> am|pm", -5.2284312390838705),
                                    ("after <time-of-day>year", -5.2284312390838705),
       ...
       ("from <time-of-day>",
        Classifier{okData =
                     ClassData{prior = -1.62924053973028, unseen = -3.8501476017100584,
                               likelihoods =
                                 HashMap.fromList
                                   [("July", -3.1354942159291497),
                                    ("time-of-day (latent)", -2.7300291078209855),
                                    ("<time-of-day> am|pm", -2.7300291078209855),
                                    ("hh:mm", -2.2192034840549946), ("hour", -2.2192034840549946),
                                    ("month", -2.7300291078209855), ("minute", -2.2192034840549946),
                                    ("August", -3.1354942159291497)],
                               n = 10},
                   koData =
                     ClassData{prior = -0.21825356602001794,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -3.58351893845611),
                                    ("week", -3.9889840465642745),
                                    ("<day-of-month> (ordinal or number) <named-month>",
                                     -3.9889840465642745),
                                    ("today", -3.9889840465642745),
                                    ("intersect", -2.890371757896165),
                                    ("second", -3.9889840465642745), ("now", -3.295836866004329),
                                    ("this|last|next <cycle>", -3.9889840465642745),
                                    ("day", -2.1972245773362196),
                                    ("<time-of-day> am|pm", -3.9889840465642745),
                                    ("nograin", -3.295836866004329),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)",
                                     -3.9889840465642745),
                                    ("Christmas", -3.9889840465642745),
                                    ("hour", -3.295836866004329),
                                    ("<datetime> - <datetime> (interval)", -2.6026896854443837),
                                    ("<time-of-day> - <time-of-day> (interval)",
                                     -2.2842359543258492),
                                    ("<named-month> <day-of-month> (non ordinal)",
                                     -3.58351893845611),
                                    ("minute", -1.54663701119507),
                                    ("right now", -3.9889840465642745),
                                    ("<month> dd-dd (interval)", -3.295836866004329),
                                    ("dd-dd <month> (interval)", -3.58351893845611)],
                               n = 41}}),
       ("February",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.70805020110221,
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.5389965007326869, unseen = -4.204692619390966,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.12921173148000623),
                                    ("integer (0..19)", -2.243744592971112)],
                               n = 63},
                   koData =
                     ClassData{prior = -0.8754687373538999, unseen = -3.891820298110627,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.3078266385442483, unseen = -5.247024072160486,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer after|past <hour-of-day>", -3.855452653939752),
                                    ("at <time-of-day>", -2.297308035893202),
                                    ("<time-of-day> o'clock", -4.143134726391533),
                                    ("half after|past <hour-of-day>", -4.143134726391533),
                                    ("from <time-of-day>", -4.143134726391533),
                                    ("time-of-day (latent)", -1.7452394535931621),
                                    ("hhmm (latent)", -4.548599834499697),
                                    ("hh:mm", -2.2460147415056513),
                                    ("quarter after|past <hour-of-day>", -4.548599834499697),
                                    ("about|exactly <time-of-day>", -4.548599834499697),
                                    ("until <time-of-day>", -3.855452653939752),
                                    ("hour", -1.252762968495368),
                                    ("<time-of-day> sharp|exactly", -4.548599834499697),
                                    ("minute", -1.715386490443481),
                                    ("after <time-of-day>", -4.548599834499697)],
                               n = 86},
                   koData =
                     ClassData{prior = -1.3281867303126098, unseen = -4.382026634673881,
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -3.270835563798912),
                                    ("<hour-of-day> <integer>", -3.676300671907076),
                                    ("from <time-of-day>", -3.676300671907076),
                                    ("time-of-day (latent)", -1.0736109864626924),
                                    ("hour", -1.0372433422918175), ("minute", -2.760009940032921),
                                    ("after <time-of-day>", -3.676300671907076)],
                               n = 31}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Augustordinal (digits)", -1.8718021769015913),
                                    ("from <time-of-day>ordinal (digits)", -1.8718021769015913),
                                 ...
                                 HashMap.fromList
                                   [("intersecthh:mm", -3.1918471524802814),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)<named-month> <day-of-month> (non ordinal)",
                                     -3.1918471524802814),
                                    ("from <time-of-day><time-of-day> am|pm", -3.597312260588446),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -3.1918471524802814),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -3.597312260588446),
                                    ("<time-of-day> am|pm<time-of-day> am|pm", -2.681021528714291),
                                    ("from <time-of-day>hh:mm", -2.681021528714291)],
                               n = 26},
                   koData =
                                 ...
                                 HashMap.fromList
                                   [("<named-month> <day-of-month> (non ordinal)July",
                                    ...
                                    ("about|exactly <time-of-day><time-of-day> am|pm",
                                     -3.1135153092103742),
                                    ("from <time-of-day>intersect", -2.70805020110221)],
                               n = 12}}),
       ("Tuesday",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.639057329615259,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("minuteminute", -1.5125880864441827),
                                    ...
                                    ("from <time-of-day>time-of-day (latent)", -3.3843902633457743),
                                    ("from <time-of-day><time-of-day> am|pm", -3.3843902633457743),
                                    ("<time-of-day> am|pm<time-of-day> am|pm", -2.468099531471619),
                                    ("from <time-of-day>hh:mm", -2.468099531471619)],
                               n = 22},
                   koData =
                     ClassData{prior = -0.6931471805599453, unseen = -4.0943445622221,
                               likelihoods =
                                 HashMap.fromList
                                   [("about|exactly <time-of-day>time-of-day (latent)",
                                    ...
                                    ("from <time-of-day>time-of-day (latent)", -2.468099531471619),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Augustinteger (numeric)", -2.3353749158170367),
                                    ...
                                    ("from <time-of-day>integer (numeric)", -2.3353749158170367),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Julyinteger (numeric)integer (numeric)", -1.6422277352570913),
                                    ("Augustordinal (digits)integer (numeric)",
                                     -2.3353749158170367),
                                    ("from <time-of-day>ordinal (digits)integer (numeric)",
                                     -2.740840023925201),
                                    ("from <time-of-day>ordinal (digits)ordinal (digits)",
                                     -2.740840023925201),
                                    ("from <time-of-day>integer (numeric)integer (numeric)",
                                     -2.740840023925201),
