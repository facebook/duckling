...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5505489757838379, unseen = -6.133398042996649,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 459},
                   koData =
                     ClassData{prior = -0.8595162554920214, unseen = -5.82600010738045,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 337}}),
       ("<year> (bc|ad)",
        Classifier{okData =
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4641310220451653, unseen = -7.151485463904735,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.457554277032581),
                                    ...
                                    ("Ganesh Chaturthiyear (latent)", -6.457554277032581),
                                    ...
                                    ("Saturday<part-of-day> at <time-of-day>", -6.457554277032581),
                                    ...
                                    ("tonight<time-of-day> am|pm", -6.457554277032581),
                                    ...
                                    ("tonightat <time-of-day>", -5.764407096472636),
                                    ...
                                    ("part of daysat <time-of-day>", -4.848116364598481),
                                    ...
                                    ("Eid al-Fitryear (latent)", -5.071259915912691),
                                    ...
                                    ("this <part-of-day><time-of-day> am|pm", -6.457554277032581),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.052089168924417),
                                    ("Ratha-Yatrayear (latent)", -6.457554277032581),
                                    ...
                                    ("Saturdayintersect", -6.457554277032581),
                                    ...
                                    ("Rama Navamiyear (latent)", -6.457554277032581),
                                    ...
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.457554277032581),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.052089168924417),
                                    ("Ugadiyear (latent)", -5.071259915912691),
                                    ...
                                    ("this <part-of-day>at <time-of-day>", -5.204791308537213),
                               ...
                               n = 491},
                   koData =
                     ClassData{prior = -0.9906942268591662, unseen = -6.773080375655535,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.574710978503383),
                                    ("hourday", -3.6808931024812863),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.0787883752796565),
                                    ("<day-of-month> (ordinal)August", -6.0787883752796565),
                                    ("dayhour", -3.5138390178181202),
                                    ("<time> timezoneyear (latent)", -5.385641194719711),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.162497643405502),
                                    ("Tuesdayfrom|since|after <time>", -5.385641194719711),
                                    ("daymonth", -3.4046397258531282),
                                    ("monthyear", -4.826025406784289),
                                    ("<time-of-day> am|pmyear (latent)", -5.385641194719711),
                                    ("Thai Pongalyear (latent)", -5.385641194719711),
                                    ("intersecthh:mm", -6.0787883752796565),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.673323267171493),
                                    ("<day-of-month> (ordinal)Wednesday", -6.0787883752796565),
                                    ("houryear", -4.692494014159767),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.0787883752796565),
                                    ("<day-of-month> (ordinal)October", -6.0787883752796565),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.385641194719711),
                                    ("hournograin", -4.826025406784289),
                                    ("<time-of-day> am|pmintersect", -4.826025406784289),
                                    ("Octoberyear (latent)", -6.0787883752796565),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.673323267171493),
                                    ("early morningat <time-of-day>", -6.0787883752796565),
                                    ("until <time>on <day>", -5.385641194719711),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.0787883752796565),
                                    ("time-of-day (latent)intersect", -5.385641194719711),
                                    ("todayin <number> (implicit minutes)", -6.0787883752796565),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.385641194719711),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.0787883752796565),
                                    ("hh:mmon <day>", -4.826025406784289),
                                    ("hhhmmintersect", -5.673323267171493),
                                    ("absorption of , after named dayJuly", -5.162497643405502),
                                    ("from|since|after <time>July", -5.673323267171493),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.162497643405502),
                                    ("Clean Mondayyear (latent)", -6.0787883752796565),
                                    ("monthhour", -6.0787883752796565),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.673323267171493),
                                    ("hourmonth", -4.206986198378066),
                                    ("todayat <time-of-day>", -6.0787883752796565),
                                    ("hhhmmyear (latent)", -4.826025406784289),
                                    ("from|since|after <time>December", -6.0787883752796565),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.0787883752796565),
                                    ("<time-of-day> am|pmon <day>", -4.826025406784289),
                                    ("Mondayyear (latent)", -5.385641194719711),
                                    ("dayday", -4.063885354737392),
                                    ("on <day>September", -5.385641194719711),
                                    ("time-of-day (latent)September", -5.673323267171493),
                                    ("hourhour", -3.999346833599821),
                                    ("time-of-day (latent)on <day>", -4.574710978503383),
                                    ("Thursdaydd/mm", -6.0787883752796565),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.673323267171493),
                                    ("dayyear", -3.1610176431953776),
                                    ("New Year's Dayyear (latent)", -5.162497643405502),
                                    ("time-of-day (latent)Sunday", -5.673323267171493),
                                    ("Thursdayfrom|since|after <time>", -4.374040283041231),
                                    ("Thursdayat <time-of-day>", -4.469350462845557),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.0787883752796565),
                                    ("Aprilyear (latent)", -6.0787883752796565),
                                    ("the <day-of-month> (ordinal)July", -6.0787883752796565),
                                    ("the <day-of-month> (number)July", -6.0787883752796565),
                                    ("monthminute", -6.0787883752796565),
                                    ("<time-of-day> am|pmtomorrow", -6.0787883752796565),
                                    ("Thursdayhh:mm", -5.162497643405502),
                                    ("<day-of-month> (ordinal)Tuesday", -5.673323267171493),
                                    ("minutemonth", -3.938722211783386),
                                    ("time-of-day (latent)Friday", -5.673323267171493),
                                    ("minutehour", -6.0787883752796565),
                                    ("part of daysat <time-of-day>", -4.980176086611547),
                                    ("Augustyear (latent)", -5.673323267171493),
                                    ("week-endin|during <named-month>|year", -6.0787883752796565),
                                    ("time-of-day (latent)Tuesday", -5.673323267171493),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.0787883752796565),
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.0787883752796565),
                                    ("Sundayyear (latent)", -5.162497643405502),
                                    ("the <day-of-month> (ordinal)Monday", -5.385641194719711),
                                    ("Christmasat <time-of-day>", -6.0787883752796565),
                                    ("from|since|after <time>year (latent)", -4.980176086611547),
                                    ("hhhmmon <day>", -5.162497643405502),
                                    ("yesterday<time-of-day> am|pm", -6.0787883752796565),
                                    ("<day-of-month> (ordinal)July", -5.385641194719711),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.0787883752796565),
                                    ("at <time-of-day>intersect", -5.162497643405502),
                                    ("hh:mmyear (latent)", -4.692494014159767),
                                    ("Holiyear (latent)", -6.0787883752796565),
                                    ("until <time><time-of-day> am|pm", -6.0787883752796565),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.673323267171493),
                                    ("dayminute", -3.245575031223441),
                                    ("yyyy-mm-ddhh:mm", -5.673323267171493),
                                    ("intersectfrom|since|after <time>", -5.673323267171493),
                                    ("intersectSeptember", -4.206986198378066),
                                    ("minuteday", -2.9217879541295435),
                                    ("absorption of , after named dayintersect",
                                     -6.0787883752796565),
                                    ("intersectyear (latent)", -6.0787883752796565),
                                    ("Februaryin|during the <part-of-day>", -6.0787883752796565),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.0787883752796565),
                                    ("time-of-day (latent)July", -5.385641194719711),
                                    ("Saturdayyear (latent)", -6.0787883752796565),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0787883752796565),
                                    ("<day-of-month> (ordinal)Monday", -5.162497643405502),
                                    ("at <time-of-day>on <day>", -5.162497643405502),
                                    ("absorption of , after named daySeptember",
                                     -4.826025406784289),
                                    ("Naraka Chaturdashiyear (latent)", -6.0787883752796565),
                                    ("from|since|after <time>on <day>", -5.162497643405502),
                                    ("dayweek", -6.0787883752796565),
                                    ("Easter Sundayyear (latent)", -5.673323267171493),
                                    ("Thursday<time-of-day> am|pm", -4.826025406784289),
                                    ("weekyear", -5.673323267171493),
                                    ("time-of-day (latent)Thursday", -5.673323267171493),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.0787883752796565),
                                    ("<day-of-month> (ordinal)April", -6.0787883752796565),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.673323267171493),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.385641194719711),
                                    ("Sundayfrom|since|after <time>", -6.0787883752796565),
                                    ("absorption of , after named dayFebruary", -5.162497643405502),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.673323267171493),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.0787883752796565),
                                    ("tomorrowat <time-of-day>", -6.0787883752796565),
                                    ("daynograin", -5.673323267171493),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.673323267171493),
                                    ("last <cycle> of <time>year (latent)", -5.673323267171493),
                                    ("tomorrow<time-of-day> am|pm", -6.0787883752796565),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.385641194719711),
                                    ("Diwaliyear (latent)", -5.673323267171493),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.0787883752796565),
                                    ("this <part-of-day>at <time-of-day>", -5.162497643405502),
                                    ("Fridayyear (latent)", -5.673323267171493),
                                    ("time-of-day (latent)April", -6.0787883752796565),
                                    ("minuteyear", -3.8815637979434374)],
                               n = 290}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.24201203561859258,
                               ...
                               n = 84},
                   koData =
                     ClassData{prior = -1.5373346185327565, unseen = -4.07753744390572,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6141039732194924, unseen = -4.852030263919617,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 125},
                   koData =
                     ClassData{prior = -0.7789786164097264,
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.5861750610077776, unseen = -5.332718793265369,
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                     -4.634728988229636),
                                    ("dayhour", -4.229263880121471),
                                    ("daymonth", -2.192381952860431),
                                    ...
                                    ("from <datetime> - <datetime> (interval)July",
                                     -3.248434627109745),
                                    ("Black Fridaythis|last|next <cycle>", -4.634728988229636),
                                    ...
                                    ("Mondaythis|last|next <cycle>", -3.9415818076696905),
                                    ("Fridayintersect", -3.9415818076696905),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.229263880121471),
                                    ("intersectOctober", -4.229263880121471),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.7184382563554808),
                                    ...
                                    ("Monday<named-month> <day-of-month> (non ordinal)",
                                     -4.229263880121471),
                                    ("<datetime> - <datetime> (interval)July", -3.7184382563554808),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -3.9415818076696905)],
                               n = 69},
                   koData =
                     ClassData{prior = -0.812948380372566, unseen = -5.187385805840755,
                               likelihoods =
                                 HashMap.fromList
