...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5475618635916102,
                               unseen = -6.1463292576688975,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 465},
                   koData =
                     ClassData{prior = -0.8635991617985161, unseen = -5.831882477283517,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46672204104272635,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.466922027036182),
                                    ...
                                    ("<time-of-day> am|pmtomorrow", -5.5506312951620265),
                               ...
                               n = 496},
                   koData =
                     ClassData{prior = -0.986322611427834, unseen = -6.786716950605081,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.58836306767171),
                                    ("hourday", -3.65009342907878),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.092440464447984),
                                    ("<day-of-month> (ordinal)August", -6.092440464447984),
                                    ("dayhour", -3.5274911069864476),
                                    ("<time> timezoneyear (latent)", -5.3992932838880385),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.176149732573829),
                                    ("Tuesdayfrom|since|after <time>", -5.3992932838880385),
                                    ("daymonth", -3.4182918150214556),
                                    ("monthyear", -4.839677495952616),
                                    ("<time-of-day> am|pmyear (latent)", -5.3992932838880385),
                                    ("Thai Pongalyear (latent)", -5.3992932838880385),
                                    ("intersecthh:mm", -6.092440464447984),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.68697535633982),
                                    ("<day-of-month> (ordinal)Wednesday", -6.092440464447984),
                                    ("houryear", -4.706146103328093),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.092440464447984),
                                    ("<day-of-month> (ordinal)October", -6.092440464447984),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.3992932838880385),
                                    ("hournograin", -4.839677495952616),
                                    ("<time-of-day> am|pmintersect", -4.839677495952616),
                                    ("Octoberyear (latent)", -6.092440464447984),
                                    ("Good Fridayyear (latent)", -5.68697535633982),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.68697535633982),
                                    ("early morningat <time-of-day>", -6.092440464447984),
                                    ("until <time>on <day>", -5.3992932838880385),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.092440464447984),
                                    ("time-of-day (latent)intersect", -5.3992932838880385),
                                    ("todayin <number> (implicit minutes)", -6.092440464447984),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.3992932838880385),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.092440464447984),
                                    ("hh:mmon <day>", -4.839677495952616),
                                    ("hhhmmintersect", -5.68697535633982),
                                    ("absorption of , after named dayJuly", -5.176149732573829),
                                    ("from|since|after <time>July", -5.68697535633982),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.176149732573829),
                                    ("Clean Mondayyear (latent)", -6.092440464447984),
                                    ("monthhour", -6.092440464447984),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.68697535633982),
                                    ("hourmonth", -4.220638287546393),
                                    ("todayat <time-of-day>", -6.092440464447984),
                                    ("hhhmmyear (latent)", -4.839677495952616),
                                    ("from|since|after <time>December", -6.092440464447984),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.092440464447984),
                                    ("<time-of-day> am|pmon <day>", -4.839677495952616),
                                    ("Mondayyear (latent)", -5.3992932838880385),
                                    ("dayday", -4.07753744390572),
                                    ("on <day>September", -5.3992932838880385),
                                    ("time-of-day (latent)September", -5.68697535633982),
                                    ("hourhour", -4.012998922768149),
                                    ("time-of-day (latent)on <day>", -4.58836306767171),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.68697535633982),
                                    ("dayyear", -3.072015578303622),
                                    ("Thursdaymm/dd", -6.092440464447984),
                                    ("New Year's Dayyear (latent)", -5.176149732573829),
                                    ("time-of-day (latent)Sunday", -5.68697535633982),
                                    ("Thursdayfrom|since|after <time>", -4.387692372209559),
                                    ("Thursdayat <time-of-day>", -4.483002552013883),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.092440464447984),
                                    ("Aprilyear (latent)", -6.092440464447984),
                                    ("the <day-of-month> (ordinal)July", -6.092440464447984),
                                    ("the <day-of-month> (number)July", -6.092440464447984),
                                    ("monthminute", -6.092440464447984),
                                    ("<time-of-day> am|pmtomorrow", -5.68697535633982),
                                    ("Thursdayhh:mm", -5.176149732573829),
                                    ("<day-of-month> (ordinal)Tuesday", -5.68697535633982),
                                    ("minutemonth", -3.952374300951713),
                                    ("time-of-day (latent)Friday", -5.68697535633982),
                                    ("minutehour", -6.092440464447984),
                                    ("part of daysat <time-of-day>", -4.993828175779875),
                                    ("Augustyear (latent)", -5.68697535633982),
                                    ("week-endin|during <named-month>|year", -6.092440464447984),
                                    ("time-of-day (latent)Tuesday", -5.68697535633982),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.092440464447984),
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.092440464447984),
                                    ("Sundayyear (latent)", -5.176149732573829),
                                    ("the <day-of-month> (ordinal)Monday", -5.3992932838880385),
                                    ("Christmasat <time-of-day>", -6.092440464447984),
                                    ("from|since|after <time>year (latent)", -4.993828175779875),
                                    ("hhhmmon <day>", -5.176149732573829),
                                    ("yesterday<time-of-day> am|pm", -6.092440464447984),
                                    ("<day-of-month> (ordinal)July", -5.3992932838880385),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.092440464447984),
                                    ("at <time-of-day>intersect", -5.176149732573829),
                                    ("hh:mmyear (latent)", -4.706146103328093),
                                    ("Holiyear (latent)", -6.092440464447984),
                                    ("until <time><time-of-day> am|pm", -6.092440464447984),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.68697535633982),
                                    ("dayminute", -3.259227120391768),
                                    ("yyyy-mm-ddhh:mm", -5.68697535633982),
                                    ("intersectfrom|since|after <time>", -5.68697535633982),
                                    ("intersectSeptember", -4.220638287546393),
                                    ("minuteday", -2.935440043297871),
                                    ("absorption of , after named dayintersect",
                                     -6.092440464447984),
                                    ("intersectyear (latent)", -6.092440464447984),
                                    ("Februaryin|during the <part-of-day>", -6.092440464447984),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.092440464447984),
                                    ("time-of-day (latent)July", -5.3992932838880385),
                                    ("Saturdayyear (latent)", -6.092440464447984),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.092440464447984),
                                    ("<day-of-month> (ordinal)Monday", -5.176149732573829),
                                    ("at <time-of-day>on <day>", -5.176149732573829),
                                    ("absorption of , after named daySeptember",
                                     -4.839677495952616),
                                    ("Naraka Chaturdashiyear (latent)", -6.092440464447984),
                                    ("from|since|after <time>on <day>", -5.176149732573829),
                                    ("dayweek", -6.092440464447984),
                                    ("Easter Sundayyear (latent)", -5.68697535633982),
                                    ("Thursday<time-of-day> am|pm", -4.839677495952616),
                                    ("weekyear", -5.68697535633982),
                                    ("time-of-day (latent)Thursday", -5.68697535633982),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.092440464447984),
                                    ("<day-of-month> (ordinal)April", -6.092440464447984),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.68697535633982),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.3992932838880385),
                                    ("Sundayfrom|since|after <time>", -6.092440464447984),
                                    ("absorption of , after named dayFebruary", -5.176149732573829),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.68697535633982),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.092440464447984),
                                    ("tomorrowat <time-of-day>", -6.092440464447984),
                                    ("daynograin", -5.68697535633982),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.68697535633982),
                                    ("last <cycle> of <time>year (latent)", -5.68697535633982),
                                    ("tomorrow<time-of-day> am|pm", -6.092440464447984),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.3992932838880385),
                                    ("Diwaliyear (latent)", -5.68697535633982),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.092440464447984),
                                    ("this <part-of-day>at <time-of-day>", -5.176149732573829),
                                    ("Fridayyear (latent)", -5.176149732573829),
                                    ("time-of-day (latent)April", -6.092440464447984),
                                    ("minuteyear", -3.895215887111765)],
                               n = 295}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6068513671071093, unseen = -4.867534450455582,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 127},
                   koData =
                     ClassData{prior = -0.7875993594536335,
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.48550781578170077,
                               ...
                               n = 88},
                   koData =
                     ClassData{prior = -0.9555114450274363, unseen = -4.890349128221754,
                               likelihoods =
                                 HashMap.fromList
                                   [("hour", -0.8754687373538999),
