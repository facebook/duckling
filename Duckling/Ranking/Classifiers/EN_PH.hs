...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6325225587435105, unseen = -5.883322388488279,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 357},
                   koData =
                     ClassData{prior = -0.7576857016975165, unseen = -5.75890177387728,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5010844547104379,
                               unseen = -6.9411900550683745,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.247075288559693),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.247075288559693),
                                    ("Ramadanyear (latent)", -5.330784556685538),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.232172268017428),
                                    ("Bhai Doojyear (latent)", -6.247075288559693),
                                    ("hourday", -4.232172268017428),
                                    ("dayhour", -3.3293045564754142),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.232172268017428),
                                    ("Martin Luther King's Dayyear (latent)", -5.841610180451529),
                                    ("Shemini Atzeretyear (latent)", -6.247075288559693),
                                    ("daymonth", -4.232172268017428),
                                    ("monthday", -5.841610180451529),
                                    ("monthyear", -4.455315819331638),
                                    ("Yom Ha'atzmautyear (latent)", -6.247075288559693),
                                    ("Vijayadashamiyear (latent)", -6.247075288559693),
                                    ("Thai Pongalyear (latent)", -5.553928107999748),
                                    ("Thiru Onamyear (latent)", -5.553928107999748),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.247075288559693),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.330784556685538),
                                    ("<day-of-month> (ordinal)Wednesday", -6.247075288559693),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.247075288559693),
                                    ("houryear", -5.330784556685538),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.247075288559693),
                                    ("Christmas<time-of-day> am|pm", -6.247075288559693),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.247075288559693),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.553928107999748),
                                    ("intersectin|during <named-month>|year", -6.247075288559693),
                                    ("<time-of-day> am|pmintersect", -4.994312320064325),
                                    ("Earth Houryear (latent)", -6.247075288559693),
                                    ("Octoberyear (latent)", -4.7429978917834195),
                                    ("intersect<time-of-day> am|pm", -6.247075288559693),
                                    ("Mattu Pongalyear (latent)", -6.247075288559693),
                                    ("Shavuotyear (latent)", -6.247075288559693),
                                    ("Parsi New Yearyear (latent)", -5.330784556685538),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.247075288559693),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.247075288559693),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.841610180451529),
                                    ("Marchyear (latent)", -6.247075288559693),
                                    ("Sukkotyear (latent)", -5.841610180451529),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.841610180451529),
                                    ("Clean Mondayyear (latent)", -5.841610180451529),
                                    ("monthhour", -5.841610180451529),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.553928107999748),
                                    ("todayat <time-of-day>", -6.247075288559693),
                                    ("Thursday<time> timezone", -4.30116513950438),
                                    ("time-of-day (latent)tonight", -5.841610180451529),
                                    ("from|since|after <time>December", -6.247075288559693),
                                    ("<time-of-day> am|pmon <day>", -4.232172268017428),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.247075288559693),
                                    ("yyyy-mm-ddhh:mm:ss", -5.841610180451529),
                                    ("dayday", -3.804728253190489),
                                    ("<time> <part-of-day>at <time-of-day>", -6.247075288559693),
                                    ("tonightat <time-of-day>", -6.247075288559693),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.553928107999748),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.247075288559693),
                                    ("today<time-of-day> am|pm", -6.247075288559693),
                                    ("Februarythe <day-of-month> (ordinal)", -5.841610180451529),
                                    ("at <time-of-day><time> <part-of-day>", -6.247075288559693),
                                    ("<day-of-month> (ordinal)intersect", -5.841610180451529),
                                    ("hourhour", -4.167633746879857),
                                    ("Navaratriin|during <named-month>|year", -6.247075288559693),
                                    ("Wednesdaythis|last|next <cycle>", -6.247075288559693),
                                    ("Lentyear (latent)", -6.247075288559693),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.7429978917834195),
                                    ("Boghiyear (latent)", -6.247075288559693),
                                    ("dayyear", -2.042382669168727),
                                    ("Thursdayfrom|since|after <time>", -5.841610180451529),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.247075288559693),
                                    ("Thursdayat <time-of-day>", -5.553928107999748),
                                    ("Islamic New Yearyear (latent)", -5.841610180451529),
                                    ("Laylat al-Qadryear (latent)", -5.330784556685538),
                                    ("Shrove Tuesdayyear (latent)", -6.247075288559693),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.553928107999748),
                                    ("<time-of-day> am|pmtomorrow", -5.553928107999748),
                                    ("Yom Kippuryear (latent)", -6.247075288559693),
                                    ("<day-of-month> (ordinal)Tuesday", -5.841610180451529),
                                    ("<part-of-day> of <time>year (latent)", -6.247075288559693),
                                    ("minutehour", -5.148462999891583),
                                    ("Kaanum Pongalyear (latent)", -5.841610180451529),
                                    ("Maha Saptamiyear (latent)", -6.247075288559693),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.841610180451529),
                                    ("time-of-day (latent)tomorrow", -5.330784556685538),
                                    ("part of daysat <time-of-day>", -5.841610180451529),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.542327196321268),
                                    ("for <duration> from <time>December", -6.247075288559693),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.247075288559693),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.994312320064325),
                                    ("time-of-day (latent)this <part-of-day>", -6.247075288559693),
                                    ("Pentecostyear (latent)", -6.247075288559693),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.994312320064325),
                                    ("<day-of-month> (ordinal)February", -6.247075288559693),
                                    ("Eid al-Fitryear (latent)", -5.330784556685538),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.247075288559693),
                                    ("Mondayin|during the <part-of-day>", -6.247075288559693),
                                    ("Chhathin|during <named-month>|year", -6.247075288559693),
                                    ("Diwaliin|during <named-month>|year", -6.247075288559693),
                                    ("Vaisakhiin|during <named-month>|year", -6.247075288559693),
                                    ("Raksha Bandhanyear (latent)", -6.247075288559693),
                                    ("daysecond", -5.841610180451529),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.841610180451529),
                                    ("Ashurayear (latent)", -6.247075288559693),
                                    ("Tuesdayin|during <named-month>|year", -6.247075288559693),
                                    ("Chinese New Yearyear (latent)", -6.247075288559693),
                                    ("tomorrowintersect", -6.247075288559693),
                                    ("Lag BaOmeryear (latent)", -6.247075288559693),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.247075288559693),
                                    ("Eid al-Adhayear (latent)", -5.330784556685538),
                                    ("intersectin|during the <part-of-day>", -6.247075288559693),
                                    ("Palm Sundayyear (latent)", -6.247075288559693),
                                    ("Christmasat <time-of-day>", -6.247075288559693),
                                    ("Passoveryear (latent)", -6.247075288559693),
                                    ("Lazarus Saturdayyear (latent)", -6.247075288559693),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.247075288559693),
                                    ("Yom HaShoahyear (latent)", -5.841610180451529),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.841610180451529),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.247075288559693),
                                    ("Septemberyear (latent)", -5.841610180451529),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.7429978917834195),
                                    ("Halloweenyear (latent)", -6.247075288559693),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.247075288559693),
                                    ("at <time-of-day>intersect", -5.841610180451529),
                                    ("Rosh Hashanahyear (latent)", -5.553928107999748),
                                    ("Dhanterasyear (latent)", -6.247075288559693),
                                    ("Tu BiShvatyear (latent)", -6.247075288559693),
                                    ("<day-of-month> (ordinal)December", -5.553928107999748),
                                    ("Holiyear (latent)", -5.553928107999748),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.247075288559693),
                                    ("Holika Dahanyear (latent)", -5.553928107999748),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.247075288559693),
                                    ("dayminute", -3.384874407630225),
                                    ("Mawlidyear (latent)", -6.247075288559693),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.841610180451529),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.247075288559693),
                                    ("Jumu'atul-Widayear (latent)", -5.330784556685538),
                                    ("minuteday", -2.418433892070598),
                                    ("absorption of , after named dayintersect",
                                     -6.247075288559693),
                                    ("intersectyear (latent)", -6.247075288559693),
                                    ("Orthodox Easter Sundayyear (latent)", -6.247075288559693),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.247075288559693),
                                    ("Boss's Dayyear (latent)", -5.841610180451529),
                                    ("Global Youth Service Dayyear (latent)", -6.247075288559693),
                                    ("Dhanterasin|during <named-month>|year", -6.247075288559693),
                                    ("Tisha B'Avyear (latent)", -6.247075288559693),
                                    ("Isra and Mi'rajyear (latent)", -5.330784556685538),
                                    ("at <time-of-day>on <day>", -5.148462999891583),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.247075288559693),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.553928107999748),
                                    ("Christmasyear (latent)", -5.841610180451529),
                                    ("Naraka Chaturdashiyear (latent)", -5.841610180451529),
                                    ("Thai Pongalin|during <named-month>|year", -6.247075288559693),
                                    ("dayweek", -6.247075288559693),
                                    ("Easter Sundayyear (latent)", -5.553928107999748),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.637637376125593),
                                    ("weekyear", -5.148462999891583),
                                    ("King's Dayyear (latent)", -4.7429978917834195),
                                    ("hh:mmin|during the <part-of-day>", -5.553928107999748),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.841610180451529),
                                    ("Hanukkahyear (latent)", -5.553928107999748),
                                    ("February<time> <part-of-day>", -6.247075288559693),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.247075288559693),
                                    ("Great Lentyear (latent)", -6.247075288559693),
                                    ("tomorrowat <time-of-day>", -5.553928107999748),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.247075288559693),
                                    ("Vaisakhiyear (latent)", -5.553928107999748),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.247075288559693),
                                    ("last <cycle> of <time>year (latent)", -5.553928107999748),
                                    ("at <time-of-day>tomorrow", -5.841610180451529),
                                    ("tomorrow<time-of-day> am|pm", -6.247075288559693),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.247075288559693),
                                    ("Diwaliyear (latent)", -6.247075288559693),
                                    ("between <time> and <time>on <day>", -4.637637376125593),
                                    ("Black Fridayyear (latent)", -5.841610180451529),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.247075288559693),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.247075288559693),
                                    ("Chhathyear (latent)", -5.841610180451529),
                                    ("Vasant Panchamiyear (latent)", -6.247075288559693),
                                    ("St Patrick's Dayyear (latent)", -6.247075288559693),
                                    ("Thursday<time> (timezone)", -6.247075288559693),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.247075288559693),
                                    ("<datetime> - <datetime> (interval)July", -5.841610180451529),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.841610180451529),
                                    ("Februaryintersect", -6.247075288559693),
                                    ("Simchat Torahyear (latent)", -6.247075288559693),
                                    ("minuteyear", -6.247075288559693)],
                               n = 392},
                   koData =
                     ClassData{prior = -0.9310827493424744, unseen = -6.633318433280377,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.2308043957334744),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.938854596835685),
                                    ("<day-of-month> (ordinal)August", -5.938854596835685),
                                    ("dayhour", -3.3739052393741478),
                                    ("<time> timezoneyear (latent)", -5.938854596835685),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.02256386496153),
                                    ("Tuesdayfrom|since|after <time>", -5.938854596835685),
                                    ("daymonth", -3.453947947047684),
                                    ("monthyear", -4.686091628340317),
                                    ("<time-of-day> am|pmyear (latent)", -5.2457074162757396),
                                    ("Thai Pongalyear (latent)", -5.2457074162757396),
                                    ("intersecthh:mm", -5.938854596835685),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.53338948872752),
                                    ("<day-of-month> (ordinal)Wednesday", -5.938854596835685),
                                    ("houryear", -4.552560235715794),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.938854596835685),
                                    ("<day-of-month> (ordinal)October", -5.938854596835685),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.2457074162757396),
                                    ("<time-of-day> am|pmintersect", -4.686091628340317),
                                    ("Octoberyear (latent)", -5.938854596835685),
                                    ("until <time>on <day>", -5.2457074162757396),
                                    ("time-of-day (latent)intersect", -5.938854596835685),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.2457074162757396),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.938854596835685),
                                    ("hh:mmon <day>", -3.4965075614664802),
                                    ("absorption of , after named dayJuly", -5.53338948872752),
                                    ("from|since|after <time>July", -5.53338948872752),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.02256386496153),
                                    ("Clean Mondayyear (latent)", -5.938854596835685),
                                    ("monthhour", -5.938854596835685),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.53338948872752),
                                    ("hourmonth", -4.067052419934093),
                                    ("todayat <time-of-day>", -5.938854596835685),
                                    ("from|since|after <time>December", -5.938854596835685),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.938854596835685),
                                    ("<time-of-day> am|pmon <day>", -4.686091628340317),
                                    ("Mondayyear (latent)", -5.2457074162757396),
                                    ("dayday", -4.552560235715794),
                                    ("on <day>September", -5.53338948872752),
                                    ("time-of-day (latent)September", -5.53338948872752),
                                    ("hourhour", -5.938854596835685),
                                    ("time-of-day (latent)on <day>", -3.4965075614664802),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.53338948872752),
                                    ("dayyear", -3.0210838647514056),
                                    ("Thursdaymm/dd", -5.938854596835685),
                                    ("New Year's Dayyear (latent)", -5.02256386496153),
                                    ("Thursdayfrom|since|after <time>", -4.23410650459726),
                                    ("Thursdayat <time-of-day>", -4.3294166844015844),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.938854596835685),
                                    ("Aprilyear (latent)", -5.938854596835685),
                                    ("the <day-of-month> (ordinal)July", -5.938854596835685),
                                    ("the <day-of-month> (number)July", -5.938854596835685),
                                    ("monthminute", -5.938854596835685),
                                    ("<time-of-day> am|pmtomorrow", -5.938854596835685),
                                    ("Thursdayhh:mm", -5.02256386496153),
                                    ("<day-of-month> (ordinal)Tuesday", -5.53338948872752),
                                    ("minutemonth", -4.067052419934093),
                                    ("minutehour", -5.938854596835685),
                                    ("Augustyear (latent)", -5.53338948872752),
                                    ("week-endin|during <named-month>|year", -5.938854596835685),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.938854596835685),
                                    ("Sundayyear (latent)", -5.02256386496153),
                                    ("Christmasat <time-of-day>", -5.938854596835685),
                                    ("from|since|after <time>year (latent)", -4.840242308167575),
                                    ("<duration> after|before|from <time>December",
                                     -5.938854596835685),
                                    ("yesterday<time-of-day> am|pm", -5.938854596835685),
                                    ("<day-of-month> (ordinal)July", -5.2457074162757396),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.938854596835685),
                                    ("at <time-of-day>intersect", -5.53338948872752),
                                    ("hh:mmyear (latent)", -3.8594130551558488),
                                    ("Holiyear (latent)", -5.938854596835685),
                                    ("until <time><time-of-day> am|pm", -5.938854596835685),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.938854596835685),
                                    ("dayminute", -3.4131259525274293),
                                    ("yyyy-mm-ddhh:mm", -5.53338948872752),
                                    ("intersectSeptember", -4.43477720005941),
                                    ("minuteday", -2.700176144671304),
                                    ("absorption of , after named dayintersect",
                                     -5.938854596835685),
                                    ("intersectyear (latent)", -5.938854596835685),
                                    ("Februaryin|during the <part-of-day>", -5.938854596835685),
                                    ("time-of-day (latent)July", -5.2457074162757396),
                                    ("Saturdayyear (latent)", -5.938854596835685),
                                    ("at <time-of-day>on <day>", -5.53338948872752),
                                    ("absorption of , after named daySeptember", -5.02256386496153),
                                    ("Naraka Chaturdashiyear (latent)", -5.938854596835685),
                                    ("from|since|after <time>on <day>", -5.02256386496153),
                                    ("dayweek", -5.938854596835685),
                                    ("Easter Sundayyear (latent)", -5.53338948872752),
                                    ("Thursday<time-of-day> am|pm", -4.686091628340317),
                                    ("weekyear", -5.53338948872752),
                                    ("time-of-day (latent)Thursday", -5.53338948872752),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.938854596835685),
                                    ("<day-of-month> (ordinal)April", -5.938854596835685),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.53338948872752),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.2457074162757396),
                                    ("Sundayfrom|since|after <time>", -5.938854596835685),
                                    ("absorption of , after named dayFebruary", -5.02256386496153),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.938854596835685),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.938854596835685),
                                    ("tomorrowat <time-of-day>", -5.938854596835685),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.53338948872752),
                                    ("last <cycle> of <time>year (latent)", -5.53338948872752),
                                    ("tomorrow<time-of-day> am|pm", -5.938854596835685),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.2457074162757396),
                                    ("Diwaliyear (latent)", -5.53338948872752),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.938854596835685),
                                    ("Fridayyear (latent)", -5.53338948872752),
                                    ("time-of-day (latent)April", -5.938854596835685),
                                    ("minuteyear", -3.7416300194994654)],
                               n = 255}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.19378598668465397,
                               ...
                               n = 159},
                   koData =
                     ClassData{prior = -1.7363296642887243,
