...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6345530162938925,
                               unseen = -5.5134287461649825,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 246},
                   koData =
                     ClassData{prior = -0.7553894894371662, unseen = -5.393627546352362,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4818380868927383, unseen = -6.595780513961311,
                               likelihoods =
                                 HashMap.fromList
                                   [("Ramadanyear (latent)", -5.901266279189834),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.6485033106944655),
                                    ("Bhai Doojyear (latent)", -5.901266279189834),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.6485033106944655),
                                    ("hourday", -4.196518186951408),
                                    ("dayhour", -2.983495547105554),
                                    ("Martin Luther King's Dayyear (latent)", -5.495801171081669),
                                    ("Shemini Atzeretyear (latent)", -5.901266279189834),
                                    ("daymonth", -5.208119098629888),
                                    ("monthday", -5.495801171081669),
                                    ("monthyear", -4.291828366755733),
                                    ("Yom Ha'atzmautyear (latent)", -5.901266279189834),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.901266279189834),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.901266279189834),
                                    ("houryear", -5.208119098629888),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.901266279189834),
                                    ("Christmas<time-of-day> am|pm", -5.901266279189834),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.901266279189834),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.208119098629888),
                                    ("<time-of-day> am|pmintersect", -4.6485033106944655),
                                    ("Octoberyear (latent)", -4.6485033106944655),
                                    ("intersect<time-of-day> am|pm", -5.901266279189834),
                                    ("Shavuotyear (latent)", -5.901266279189834),
                                    ("Dhanterasin <named-month>|year", -5.901266279189834),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.901266279189834),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.901266279189834),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.495801171081669),
                                    ("Marchyear (latent)", -5.901266279189834),
                                    ("Sukkotyear (latent)", -5.495801171081669),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.901266279189834),
                                    ("Clean Mondayyear (latent)", -5.495801171081669),
                                    ("monthhour", -5.495801171081669),
                                    ("todayat <time-of-day>", -5.901266279189834),
                                    ("Thursday<time> timezone", -4.196518186951408),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.901266279189834),
                                    ("Palm SundaySunday", -5.495801171081669),
                                    ("dayday", -3.704041701853614),
                                    ("<time> <part-of-day>at <time-of-day>", -5.901266279189834),
                                    ("tonightat <time-of-day>", -5.901266279189834),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.208119098629888),
                                    ("today<time-of-day> am|pm", -5.901266279189834),
                                    ("Februarythe <day-of-month> (ordinal)", -5.495801171081669),
                                    ("at <time-of-day><time> <part-of-day>", -5.901266279189834),
                                    ("hourhour", -4.6485033106944655),
                                    ("<time-of-day> am|pmon <date>", -3.8863632586475685),
                                    ("Wednesdaythis|last|next <cycle>", -5.901266279189834),
                                    ("Lentyear (latent)", -5.901266279189834),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.397188882413559),
                                    ("dayyear", -2.224965607282757),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.901266279189834),
                                    ("Thursdayat <time-of-day>", -5.495801171081669),
                                    ("Islamic New Yearyear (latent)", -5.495801171081669),
                                    ("Laylat al-Qadryear (latent)", -4.9849755473156785),
                                    ("Chhathin <named-month>|year", -5.901266279189834),
                                    ("Diwaliin <named-month>|year", -5.901266279189834),
                                    ("Shrove Tuesdayyear (latent)", -5.901266279189834),
                                    ("<time-of-day> am|pmtomorrow", -5.208119098629888),
                                    ("Yom Kippuryear (latent)", -5.901266279189834),
                                    ("<part-of-day> of <time>year (latent)", -5.901266279189834),
                                    ("minutehour", -4.9849755473156785),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.495801171081669),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.196518186951408),
                                    ("for <duration> from <time>December", -5.901266279189834),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.901266279189834),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.9849755473156785),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.495801171081669),
                                    ("Pentecostyear (latent)", -5.901266279189834),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.9849755473156785),
                                    ("Eid al-Fitryear (latent)", -5.901266279189834),
                                    ("Mondayin|during the <part-of-day>", -5.901266279189834),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.495801171081669),
                                    ("Ashurayear (latent)", -5.901266279189834),
                                    ("Chinese New Yearyear (latent)", -5.901266279189834),
                                    ("Sundayyear (latent)", -5.901266279189834),
                                    ("Lag BaOmeryear (latent)", -5.901266279189834),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.901266279189834),
                                    ("Eid al-Adhayear (latent)", -4.9849755473156785),
                                    ("intersectin|during the <part-of-day>", -5.901266279189834),
                                    ("Christmasat <time-of-day>", -5.901266279189834),
                                    ("Passoveryear (latent)", -5.901266279189834),
                                    ("Lazarus Saturdayyear (latent)", -5.901266279189834),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.901266279189834),
                                    ("Yom HaShoahyear (latent)", -5.495801171081669),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.9849755473156785),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.901266279189834),
                                    ("Septemberyear (latent)", -5.495801171081669),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.6485033106944655),
                                    ("Halloweenyear (latent)", -5.901266279189834),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.901266279189834),
                                    ("Dhanterasyear (latent)", -5.901266279189834),
                                    ("Tu BiShvatyear (latent)", -5.901266279189834),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.901266279189834),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.901266279189834),
                                    ("dayminute", -3.3363169217282964),
                                    ("Mawlidyear (latent)", -5.901266279189834),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.495801171081669),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.901266279189834),
                                    ("Jumu'atul-Widayear (latent)", -4.9849755473156785),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.901266279189834),
                                    ("minuteday", -2.2636801194634475),
                                    ("absorption of , after named dayintersect",
                                     -5.901266279189834),
                                    ("intersectyear (latent)", -5.901266279189834),
                                    ("Orthodox Easter Sundayyear (latent)", -5.901266279189834),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.901266279189834),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.901266279189834),
                                    ("Boss's Dayyear (latent)", -5.495801171081669),
                                    ("Tisha B'Avyear (latent)", -5.901266279189834),
                                    ("Isra and Mi'rajyear (latent)", -4.9849755473156785),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.901266279189834),
                                    ("Christmasyear (latent)", -5.495801171081669),
                                    ("Naraka Chaturdashiyear (latent)", -5.495801171081669),
                                    ("at <time-of-day>on <date>", -4.802653990521724),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.291828366755733),
                                    ("dayweek", -5.901266279189834),
                                    ("Easter Sundayyear (latent)", -5.208119098629888),
                                    ("Thursday<time-of-day> am|pm", -5.901266279189834),
                                    ("weekyear", -5.495801171081669),
                                    ("hh:mmin|during the <part-of-day>", -5.208119098629888),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.495801171081669),
                                    ("Hanukkahyear (latent)", -5.901266279189834),
                                    ("February<time> <part-of-day>", -5.901266279189834),
                                    ("Tuesdayin <named-month>|year", -5.901266279189834),
                                    ("Great Lentyear (latent)", -5.901266279189834),
                                    ("tomorrowat <time-of-day>", -5.208119098629888),
                                    ("between <time> and <time>on <date>", -4.291828366755733),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.208119098629888),
                                    ("last <cycle> of <time>year (latent)", -5.208119098629888),
                                    ("at <time-of-day>tomorrow", -5.495801171081669),
                                    ("tomorrow<time-of-day> am|pm", -5.901266279189834),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.901266279189834),
                                    ("Diwaliyear (latent)", -5.901266279189834),
                                    ("Black Fridayyear (latent)", -5.495801171081669),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.901266279189834),
                                    ("Chhathyear (latent)", -5.495801171081669),
                                    ("Palm Sundayintersect", -5.901266279189834),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.901266279189834),
                                    ("Februaryintersect", -5.901266279189834),
                                    ("Simchat Torahyear (latent)", -5.901266279189834)],
                               n = 273},
                   koData =
                     ClassData{prior = -0.9614111671546247, unseen = -6.261491684321042,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.566434283504978),
                                    ("hourday", -5.566434283504978),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.566434283504978),
                                    ("dayhour", -3.263849190510932),
                                    ("daymonth", -3.4869927418251416),
                                    ("monthday", -5.160969175396813),
                                    ("monthyear", -4.31367131500961),
                                    ("<time-of-day> am|pmyear (latent)", -5.160969175396813),
                                    ("intersecthh:mm", -5.566434283504978),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.566434283504978),
                                    ("houryear", -4.650143551630823),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.566434283504978),
                                    ("until <time-of-day><time-of-day> am|pm", -5.566434283504978),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.873287102945032),
                                    ("<time-of-day> am|pmintersect", -4.31367131500961),
                                    ("Octoberyear (latent)", -5.566434283504978),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.31367131500961),
                                    ("from|since|after <time-of-day>on <date>", -4.650143551630823),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.566434283504978),
                                    ("absorption of , after named dayJuly", -5.160969175396813),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.650143551630823),
                                    ("Clean Mondayyear (latent)", -5.566434283504978),
                                    ("monthhour", -5.566434283504978),
                                    ("hourmonth", -4.873287102945032),
                                    ("todayat <time-of-day>", -5.566434283504978),
                                    ("from|since|after <time-of-day>July", -5.566434283504978),
                                    ("Mondayyear (latent)", -4.873287102945032),
                                    ("dayday", -5.160969175396813),
                                    ("<time-of-day> am|pmon <date>", -4.31367131500961),
                                    ("dayyear", -2.733220939448761),
                                    ("Thursdaymm/dd", -5.566434283504978),
                                    ("New Year's Dayyear (latent)", -5.160969175396813),
                                    ("Thursdayat <time-of-day>", -4.31367131500961),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.566434283504978),
                                    ("Aprilyear (latent)", -5.566434283504978),
                                    ("monthminute", -5.566434283504978),
                                    ("<time-of-day> am|pmtomorrow", -5.566434283504978),
                                    ("Thursdayhh:mm", -4.650143551630823),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.566434283504978),
                                    ("minutemonth", -3.7746748142769224),
                                    ("Sundayfrom|since|after <time-of-day>", -5.566434283504978),
                                    ("week-endin <named-month>|year", -5.566434283504978),
                                    ("Augustyear (latent)", -5.160969175396813),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.160969175396813),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.160969175396813),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.566434283504978),
                                    ("Sundayyear (latent)", -4.873287102945032),
                                    ("Christmasat <time-of-day>", -5.566434283504978),
                                    ("<duration> after|before|from <time>December",
                                     -5.566434283504978),
                                    ("yesterday<time-of-day> am|pm", -5.566434283504978),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.566434283504978),
                                    ("until <time-of-day>on <date>", -4.873287102945032),
                                    ("at <time-of-day>intersect", -5.160969175396813),
                                    ("hh:mmyear (latent)", -4.467821994836868),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.566434283504978),
                                    ("dayminute", -3.124087248135773),
                                    ("intersectSeptember", -4.062356886728703),
                                    ("minuteday", -2.4983813483713604),
                                    ("absorption of , after named dayintersect",
                                     -5.566434283504978),
                                    ("Februaryin|during the <part-of-day>", -5.566434283504978),
                                    ("hh:mmon <date>", -3.5515312629627127),
                                    ("Saturdayyear (latent)", -5.566434283504978),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.566434283504978),
                                    ("absorption of , after named daySeptember",
                                     -4.650143551630823),
                                    ("Naraka Chaturdashiyear (latent)", -5.566434283504978),
                                    ("on <date>September", -5.160969175396813),
                                    ("at <time-of-day>on <date>", -5.160969175396813),
                                    ("in <named-month>|yearyear (latent)", -5.566434283504978),
                                    ("dayweek", -5.566434283504978),
                                    ("Easter Sundayyear (latent)", -5.160969175396813),
                                    ("Thursday<time-of-day> am|pm", -5.160969175396813),
                                    ("absorption of , after named dayFebruary", -4.650143551630823),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.566434283504978),
                                    ("tomorrowat <time-of-day>", -5.566434283504978),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.566434283504978),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.9569963710708773),
                                    ("tomorrow<time-of-day> am|pm", -5.566434283504978),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.873287102945032),
                                    ("Diwaliyear (latent)", -5.160969175396813),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.566434283504978),
                                    ("Fridayyear (latent)", -5.160969175396813),
                                    ("minuteyear", -4.31367131500961)],
                               n = 169}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.20359895524123955,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -6.385147198653278e-2),
                                    ("intersect 2 numbers", -3.188416617383492)],
                               n = 93},
                   koData =
                     ClassData{prior = -1.6916760106710724, unseen = -3.258096538021482,
                               likelihoods =
                                 HashMap.fromList
