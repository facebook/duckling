...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6604288859369778, unseen = -5.459585514144159,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 233},
                   koData =
                     ClassData{prior = -0.7269722767135893, unseen = -5.393627546352362,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4922636059059311, unseen = -6.548219102762372,
                               likelihoods =
                                 HashMap.fromList
                                   [("Ramadanyear (latent)", -5.853638230200579),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.600875261705211),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.600875261705211),
                                    ("hourday", -4.1488901379621534),
                                    ("dayhour", -2.9358674981162993),
                                    ("Martin Luther King's Dayyear (latent)", -5.448173122092414),
                                    ("Shemini Atzeretyear (latent)", -5.853638230200579),
                                    ("daymonth", -5.160491049640633),
                                    ("monthday", -5.448173122092414),
                                    ("monthyear", -4.244200317766478),
                                    ("Yom Ha'atzmautyear (latent)", -5.853638230200579),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.853638230200579),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.853638230200579),
                                    ("houryear", -5.448173122092414),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.853638230200579),
                                    ("Christmas<time-of-day> am|pm", -5.853638230200579),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.853638230200579),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.160491049640633),
                                    ("<time-of-day> am|pmintersect", -4.600875261705211),
                                    ("Octoberyear (latent)", -4.600875261705211),
                                    ("intersect<time-of-day> am|pm", -5.853638230200579),
                                    ("Shavuotyear (latent)", -5.853638230200579),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.853638230200579),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.448173122092414),
                                    ("Marchyear (latent)", -5.853638230200579),
                                    ("Sukkotyear (latent)", -5.448173122092414),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.853638230200579),
                                    ("Clean Mondayyear (latent)", -5.448173122092414),
                                    ("monthhour", -5.448173122092414),
                                    ("todayat <time-of-day>", -5.853638230200579),
                                    ("Thursday<time> timezone", -4.1488901379621534),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.853638230200579),
                                    ("Palm SundaySunday", -5.448173122092414),
                                    ("dayday", -3.656413652864359),
                                    ("<time> <part-of-day>at <time-of-day>", -5.853638230200579),
                                    ("tonightat <time-of-day>", -5.853638230200579),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.160491049640633),
                                    ("today<time-of-day> am|pm", -5.853638230200579),
                                    ("Februarythe <day-of-month> (ordinal)", -5.448173122092414),
                                    ("at <time-of-day><time> <part-of-day>", -5.853638230200579),
                                    ("hourhour", -4.600875261705211),
                                    ("<time-of-day> am|pmon <date>", -3.8387352096583136),
                                    ("Wednesdaythis|last|next <cycle>", -5.853638230200579),
                                    ("Lentyear (latent)", -5.853638230200579),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.349560833424304),
                                    ("dayyear", -2.327277705584417),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.853638230200579),
                                    ("Thursdayat <time-of-day>", -5.448173122092414),
                                    ("Islamic New Yearyear (latent)", -5.448173122092414),
                                    ("Laylat al-Qadryear (latent)", -4.937347498326424),
                                    ("Shrove Tuesdayyear (latent)", -5.853638230200579),
                                    ("<time-of-day> am|pmtomorrow", -5.160491049640633),
                                    ("Yom Kippuryear (latent)", -5.853638230200579),
                                    ("<part-of-day> of <time>year (latent)", -5.853638230200579),
                                    ("minutehour", -4.937347498326424),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.448173122092414),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.1488901379621534),
                                    ("for <duration> from <time>December", -5.853638230200579),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.853638230200579),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.937347498326424),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.448173122092414),
                                    ("Pentecostyear (latent)", -5.853638230200579),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.937347498326424),
                                    ("Eid al-Fitryear (latent)", -5.853638230200579),
                                    ("Mondayin|during the <part-of-day>", -5.853638230200579),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.448173122092414),
                                    ("Ashurayear (latent)", -5.853638230200579),
                                    ("Chinese New Yearyear (latent)", -5.853638230200579),
                                    ("Sundayyear (latent)", -5.853638230200579),
                                    ("Lag BaOmeryear (latent)", -5.853638230200579),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.853638230200579),
                                    ("Eid al-Adhayear (latent)", -4.937347498326424),
                                    ("intersectin|during the <part-of-day>", -5.853638230200579),
                                    ("Christmasat <time-of-day>", -5.853638230200579),
                                    ("Passoveryear (latent)", -5.853638230200579),
                                    ("Lazarus Saturdayyear (latent)", -5.853638230200579),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.853638230200579),
                                    ("Yom HaShoahyear (latent)", -5.448173122092414),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.937347498326424),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.853638230200579),
                                    ("Septemberyear (latent)", -5.448173122092414),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.600875261705211),
                                    ("Halloweenyear (latent)", -5.853638230200579),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.160491049640633),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -4.937347498326424),
                                    ("at <time-of-day>intersect", -5.448173122092414),
                                    ("Rosh Hashanahyear (latent)", -5.853638230200579),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.853638230200579),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.853638230200579),
                                    ("dayminute", -3.288688872739042),
                                    ("Mawlidyear (latent)", -5.853638230200579),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.448173122092414),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.853638230200579),
                                    ("Jumu'atul-Widayear (latent)", -4.937347498326424),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.853638230200579),
                                    ("minuteday", -2.2160520704741926),
                                    ("absorption of , after named dayintersect",
                                     -5.853638230200579),
                                    ("intersectyear (latent)", -5.853638230200579),
                                    ("Orthodox Easter Sundayyear (latent)", -5.853638230200579),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.853638230200579),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.853638230200579),
                                    ("Boss's Dayyear (latent)", -5.448173122092414),
                                    ("Tisha B'Avyear (latent)", -5.853638230200579),
                                    ("Isra and Mi'rajyear (latent)", -4.937347498326424),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.853638230200579),
                                    ("Christmasyear (latent)", -5.448173122092414),
                                    ("at <time-of-day>on <date>", -4.755025941532469),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.244200317766478),
                                    ("dayweek", -5.853638230200579),
                                    ("Easter Sundayyear (latent)", -5.160491049640633),
                                    ("Thursday<time-of-day> am|pm", -5.853638230200579),
                                    ("weekyear", -5.448173122092414),
                                    ("hh:mmin|during the <part-of-day>", -5.160491049640633),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.448173122092414),
                                    ("Hanukkahyear (latent)", -5.853638230200579),
                                    ("February<time> <part-of-day>", -5.853638230200579),
                                    ("Tuesdayin <named-month>|year", -5.853638230200579),
                                    ("Great Lentyear (latent)", -5.853638230200579),
                                    ("tomorrowat <time-of-day>", -5.160491049640633),
                                    ("between <time> and <time>on <date>", -4.244200317766478),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.160491049640633),
                                    ("last <cycle> of <time>year (latent)", -5.160491049640633),
                                    ("at <time-of-day>tomorrow", -5.448173122092414),
                                    ("tomorrow<time-of-day> am|pm", -5.853638230200579),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.853638230200579),
                                    ("Black Fridayyear (latent)", -5.448173122092414),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.853638230200579),
                                    ("Palm Sundayintersect", -5.853638230200579),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.853638230200579),
                                    ("Februaryintersect", -5.853638230200579),
                                    ("Simchat Torahyear (latent)", -5.853638230200579)],
                               n = 261},
                   koData =
                     ClassData{prior = -0.9447962248720814, unseen = -6.230481447578482,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.535363823031238),
                                    ("hourday", -5.535363823031238),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.535363823031238),
                                    ("dayhour", -3.232778730037192),
                                    ("daymonth", -3.455922281351402),
                                    ("monthday", -5.1298987149230735),
                                    ("monthyear", -4.28260085453587),
                                    ("<time-of-day> am|pmyear (latent)", -5.1298987149230735),
                                    ("intersecthh:mm", -5.535363823031238),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.535363823031238),
                                    ("houryear", -4.619073091157083),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.535363823031238),
                                    ("until <time-of-day><time-of-day> am|pm", -5.535363823031238),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.842216642471293),
                                    ("<time-of-day> am|pmintersect", -4.28260085453587),
                                    ("Octoberyear (latent)", -5.535363823031238),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.28260085453587),
                                    ("from|since|after <time-of-day>on <date>", -4.619073091157083),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.535363823031238),
                                    ("absorption of , after named dayJuly", -5.1298987149230735),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.619073091157083),
                                    ("Clean Mondayyear (latent)", -5.535363823031238),
                                    ("monthhour", -5.535363823031238),
                                    ("hourmonth", -4.842216642471293),
                                    ("todayat <time-of-day>", -5.535363823031238),
                                    ("from|since|after <time-of-day>July", -5.535363823031238),
                                    ("Mondayyear (latent)", -4.842216642471293),
                                    ("dayday", -5.1298987149230735),
                                    ("<time-of-day> am|pmon <date>", -4.28260085453587),
                                    ("dayyear", -2.7945237991060368),
                                    ("Thursdaymm/dd", -5.535363823031238),
                                    ("New Year's Dayyear (latent)", -5.1298987149230735),
                                    ("Thursdayat <time-of-day>", -4.28260085453587),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.535363823031238),
                                    ("Aprilyear (latent)", -5.535363823031238),
                                    ("monthminute", -5.535363823031238),
                                    ("<time-of-day> am|pmtomorrow", -5.535363823031238),
                                    ("Thursdayhh:mm", -4.619073091157083),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.535363823031238),
                                    ("minutemonth", -3.7436043538031827),
                                    ("Sundayfrom|since|after <time-of-day>", -5.535363823031238),
                                    ("week-endin <named-month>|year", -5.535363823031238),
                                    ("Augustyear (latent)", -5.1298987149230735),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.1298987149230735),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.1298987149230735),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.535363823031238),
                                    ("Sundayyear (latent)", -4.842216642471293),
                                    ("Christmasat <time-of-day>", -5.535363823031238),
                                    ("<duration> after|before|from <time>December",
                                     -5.535363823031238),
                                    ("yesterday<time-of-day> am|pm", -5.535363823031238),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.535363823031238),
                                    ("until <time-of-day>on <date>", -4.842216642471293),
                                    ("at <time-of-day>intersect", -5.1298987149230735),
                                    ("hh:mmyear (latent)", -4.436751534363128),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.535363823031238),
                                    ("dayminute", -3.0930167876620334),
                                    ("intersectSeptember", -4.0312864262549635),
                                    ("minuteday", -2.4673108878976207),
                                    ("absorption of , after named dayintersect",
                                     -5.535363823031238),
                                    ("Februaryin|during the <part-of-day>", -5.535363823031238),
                                    ("hh:mmon <date>", -3.520460802488973),
                                    ("Saturdayyear (latent)", -5.535363823031238),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.535363823031238),
                                    ("absorption of , after named daySeptember",
                                     -4.619073091157083),
                                    ("on <date>September", -5.1298987149230735),
                                    ("at <time-of-day>on <date>", -5.1298987149230735),
                                    ("in <named-month>|yearyear (latent)", -5.535363823031238),
                                    ("dayweek", -5.535363823031238),
                                    ("Easter Sundayyear (latent)", -5.1298987149230735),
                                    ("Thursday<time-of-day> am|pm", -5.1298987149230735),
                                    ("absorption of , after named dayFebruary", -4.619073091157083),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.535363823031238),
                                    ("tomorrowat <time-of-day>", -5.535363823031238),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.535363823031238),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.9259259105971376),
                                    ("tomorrow<time-of-day> am|pm", -5.535363823031238),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.842216642471293),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.535363823031238),
                                    ("Fridayyear (latent)", -5.1298987149230735),
                                    ("minuteyear", -4.28260085453587)],
                               n = 166}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.21825356602001794,
                               ...
                               n = 82},
                   koData =
                     ClassData{prior = -1.62924053973028, unseen = -3.2188758248682006,
                               likelihoods =
                                 HashMap.fromList
