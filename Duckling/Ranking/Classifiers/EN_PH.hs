...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5773782442752631, unseen = -5.638354669333745,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 279},
                   koData =
                     ClassData{prior = -0.8240949633075397, unseen = -5.393627546352362,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4818380868927383, unseen = -6.675823221634848,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -5.981414211254481),
                                    ("Ramadanyear (latent)", -5.981414211254481),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.7286512427591125),
                                    ("Bhai Doojyear (latent)", -5.981414211254481),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.7286512427591125),
                                    ("hourday", -4.276666119016055),
                                    ("dayhour", -3.1780538303479458),
                                    ("Martin Luther King's Dayyear (latent)", -5.575949103146316),
                                    ("Shemini Atzeretyear (latent)", -5.981414211254481),
                                    ("daymonth", -5.288267030694535),
                                    ("monthday", -5.575949103146316),
                                    ("monthyear", -4.37197629882038),
                                    ("Yom Ha'atzmautyear (latent)", -5.981414211254481),
                                    ("Vijayadashamiyear (latent)", -5.981414211254481),
                                    ("Thai Pongalyear (latent)", -5.288267030694535),
                                    ("Thiru Onamyear (latent)", -5.288267030694535),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.981414211254481),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.981414211254481),
                                    ("houryear", -5.288267030694535),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.981414211254481),
                                    ("Christmas<time-of-day> am|pm", -5.981414211254481),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.981414211254481),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.288267030694535),
                                    ("<time-of-day> am|pmintersect", -4.7286512427591125),
                                    ("Octoberyear (latent)", -4.7286512427591125),
                                    ("intersect<time-of-day> am|pm", -5.981414211254481),
                                    ("Mattu Pongalyear (latent)", -5.981414211254481),
                                    ("Shavuotyear (latent)", -5.981414211254481),
                                    ("Dhanterasin <named-month>|year", -5.981414211254481),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.981414211254481),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.981414211254481),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.575949103146316),
                                    ("Marchyear (latent)", -5.981414211254481),
                                    ("Sukkotyear (latent)", -5.575949103146316),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.981414211254481),
                                    ("Clean Mondayyear (latent)", -5.575949103146316),
                                    ("monthhour", -5.575949103146316),
                                    ("todayat <time-of-day>", -5.981414211254481),
                                    ("Thursday<time> timezone", -4.276666119016055),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.981414211254481),
                                    ("Palm SundaySunday", -5.575949103146316),
                                    ("dayday", -3.784189633918261),
                                    ("<time> <part-of-day>at <time-of-day>", -5.981414211254481),
                                    ("tonightat <time-of-day>", -5.981414211254481),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.288267030694535),
                                    ("today<time-of-day> am|pm", -5.981414211254481),
                                    ("Februarythe <day-of-month> (ordinal)", -5.575949103146316),
                                    ("at <time-of-day><time> <part-of-day>", -5.981414211254481),
                                    ("hourhour", -4.7286512427591125),
                                    ("<time-of-day> am|pmon <date>", -3.966511190712216),
                                    ("Wednesdaythis|last|next <cycle>", -5.981414211254481),
                                    ("Lentyear (latent)", -5.981414211254481),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.477336814478207),
                                    ("Boghiyear (latent)", -5.981414211254481),
                                    ("dayyear", -2.030170492673053),
                                    ("Thursdayfrom|since|after <time>", -5.575949103146316),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.981414211254481),
                                    ("Thursdayat <time-of-day>", -5.575949103146316),
                                    ("Islamic New Yearyear (latent)", -5.575949103146316),
                                    ("Laylat al-Qadryear (latent)", -5.0651234793803255),
                                    ("Chhathin <named-month>|year", -5.981414211254481),
                                    ("Vasant Panchamiin <named-month>|year", -5.981414211254481),
                                    ("Diwaliin <named-month>|year", -5.981414211254481),
                                    ("Shrove Tuesdayyear (latent)", -5.981414211254481),
                                    ("<time-of-day> am|pmtomorrow", -5.288267030694535),
                                    ("Yom Kippuryear (latent)", -5.981414211254481),
                                    ("<part-of-day> of <time>year (latent)", -5.981414211254481),
                                    ("minutehour", -5.0651234793803255),
                                    ("Kaanum Pongalyear (latent)", -5.575949103146316),
                                    ("Maha Saptamiyear (latent)", -5.981414211254481),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.575949103146316),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.276666119016055),
                                    ("for <duration> from <time>December", -5.981414211254481),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.981414211254481),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.0651234793803255),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.575949103146316),
                                    ("Pentecostyear (latent)", -5.981414211254481),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.0651234793803255),
                                    ("Eid al-Fitryear (latent)", -5.981414211254481),
                                    ("Mondayin|during the <part-of-day>", -5.981414211254481),
                                    ("Raksha Bandhanyear (latent)", -5.981414211254481),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.575949103146316),
                                    ("Navaratriin <named-month>|year", -5.981414211254481),
                                    ("Ashurayear (latent)", -5.981414211254481),
                                    ("Chinese New Yearyear (latent)", -5.981414211254481),
                                    ("Sundayyear (latent)", -5.981414211254481),
                                    ("Lag BaOmeryear (latent)", -5.981414211254481),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.981414211254481),
                                    ("Eid al-Adhayear (latent)", -5.0651234793803255),
                                    ("intersectin|during the <part-of-day>", -5.981414211254481),
                                    ("Christmasat <time-of-day>", -5.981414211254481),
                                    ("Passoveryear (latent)", -5.981414211254481),
                                    ("Lazarus Saturdayyear (latent)", -5.981414211254481),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.981414211254481),
                                    ("Yom HaShoahyear (latent)", -5.575949103146316),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.575949103146316),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.981414211254481),
                                    ("Thai Pongalin <named-month>|year", -5.981414211254481),
                                    ("Septemberyear (latent)", -5.575949103146316),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.7286512427591125),
                                    ("Halloweenyear (latent)", -5.981414211254481),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.981414211254481),
                                    ("Dhanterasyear (latent)", -5.981414211254481),
                                    ("Tu BiShvatyear (latent)", -5.981414211254481),
                                    ("Holiyear (latent)", -5.288267030694535),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.981414211254481),
                                    ("Holika Dahanyear (latent)", -5.288267030694535),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.981414211254481),
                                    ("dayminute", -3.416464853792944),
                                    ("Mawlidyear (latent)", -5.981414211254481),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.575949103146316),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.981414211254481),
                                    ("Jumu'atul-Widayear (latent)", -5.0651234793803255),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.981414211254481),
                                    ("minuteday", -2.343828051528095),
                                    ("absorption of , after named dayintersect",
                                     -5.981414211254481),
                                    ("intersectyear (latent)", -5.981414211254481),
                                    ("Orthodox Easter Sundayyear (latent)", -5.981414211254481),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.981414211254481),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.981414211254481),
                                    ("Boss's Dayyear (latent)", -5.575949103146316),
                                    ("Global Youth Service Dayyear (latent)", -5.981414211254481),
                                    ("Tisha B'Avyear (latent)", -5.981414211254481),
                                    ("Isra and Mi'rajyear (latent)", -5.0651234793803255),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.981414211254481),
                                    ("Christmasyear (latent)", -5.575949103146316),
                                    ("Naraka Chaturdashiyear (latent)", -5.575949103146316),
                                    ...
                                    ("hh:mmin|during the <part-of-day>", -5.288267030694535),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.575949103146316),
                                    ("Hanukkahyear (latent)", -5.981414211254481),
                                    ("February<time> <part-of-day>", -5.981414211254481),
                                    ("Tuesdayin <named-month>|year", -5.981414211254481),
                                    ("Great Lentyear (latent)", -5.981414211254481),
                                    ("tomorrowat <time-of-day>", -5.288267030694535),
                                    ("between <time> and <time>on <date>", -4.37197629882038),
                                    ("last <cycle> of <time>year (latent)", -5.288267030694535),
                                    ("at <time-of-day>tomorrow", -5.575949103146316),
                                    ("tomorrow<time-of-day> am|pm", -5.981414211254481),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.981414211254481),
                                    ("Diwaliyear (latent)", -5.981414211254481),
                                    ("Black Fridayyear (latent)", -5.575949103146316),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.981414211254481),
                                    ("Chhathyear (latent)", -5.575949103146316),
                                    ("Vasant Panchamiyear (latent)", -5.981414211254481),
                                    ("Palm Sundayintersect", -5.981414211254481),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.981414211254481),
                                    ("Februaryintersect", -5.981414211254481),
                                    ("Simchat Torahyear (latent)", -5.981414211254481)],
                               n = 294},
                   koData =
                     ClassData{prior = -0.9614111671546247, unseen = -6.343880434126331,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.732683506287051),
                                    ("hourday", -4.732683506287051),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.648974238161206),
                                    ("dayhour", -3.2066272027920015),
                                    ("Tuesdayfrom|since|after <time>", -5.648974238161206),
                                    ("daymonth", -3.5089080746649355),
                                    ...
                                    ("until <time>on <date>", -4.955827057601261),
                                    ...
                                    ("hourmonth", -4.732683506287051),
                                    ("todayat <time-of-day>", -5.648974238161206),
                                    ("from|since|after <time>December", -5.648974238161206),
                                    ...
                                    ("from|since|after <time>year (latent)", -4.396211269665838),
                                    ...
                                    ("until <time><time-of-day> am|pm", -5.648974238161206),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.648974238161206),
                                    ...
                                    ("from|since|after <time>on <date>", -4.732683506287051),
                                    ...
                                    ("Thursday<time-of-day> am|pm", -4.955827057601261),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.648974238161206),
                                    ("Sundayfrom|since|after <time>", -5.648974238161206),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.15882358552665074,
                               unseen = -4.844187086458591,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -4.8790164169432056e-2),
                                    ("intersect 2 numbers", -3.4499875458315876)],
                               n = 122},
                   koData =
                     ClassData{prior = -1.9183221925364844, unseen = -3.258096538021482,
                               likelihoods =
                                 HashMap.fromList
