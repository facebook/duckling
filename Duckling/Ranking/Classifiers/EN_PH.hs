...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6582783549091215, unseen = -5.777652323222656,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 321},
                   koData =
                     ClassData{prior = -0.7292759046484508, unseen = -5.707110264748875,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5097351111170251, unseen = -6.884486652042782,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.1903154058531475),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.1903154058531475),
                                    ("Ramadanyear (latent)", -6.1903154058531475),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.175412385310882),
                                    ("Bhai Doojyear (latent)", -6.1903154058531475),
                                    ("hourday", -4.175412385310882),
                                    ("dayhour", -3.272544673768868),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.175412385310882),
                                    ("Martin Luther King's Dayyear (latent)", -5.784850297744983),
                                    ("Shemini Atzeretyear (latent)", -6.1903154058531475),
                                    ("daymonth", -4.580877493419047),
                                    ("monthday", -5.784850297744983),
                                    ("monthyear", -4.398555936625092),
                                    ("Yom Ha'atzmautyear (latent)", -6.1903154058531475),
                                    ("Vijayadashamiyear (latent)", -6.1903154058531475),
                                    ("Thai Pongalyear (latent)", -5.497168225293202),
                                    ("Thiru Onamyear (latent)", -5.497168225293202),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.1903154058531475),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.1903154058531475),
                                    ("<day-of-month> (ordinal)Wednesday", -6.1903154058531475),
                                    ("houryear", -5.274024673978992),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.1903154058531475),
                                    ("Christmas<time-of-day> am|pm", -6.1903154058531475),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.1903154058531475),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.497168225293202),
                                    ("intersectin|during <named-month>|year", -6.1903154058531475),
                                    ("<time-of-day> am|pmintersect", -4.9375524373577795),
                                    ("Earth Houryear (latent)", -6.1903154058531475),
                                    ("Octoberyear (latent)", -4.686238009076873),
                                    ("intersect<time-of-day> am|pm", -6.1903154058531475),
                                    ("Mattu Pongalyear (latent)", -6.1903154058531475),
                                    ("Shavuotyear (latent)", -6.1903154058531475),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.1903154058531475),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.1903154058531475),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.784850297744983),
                                    ("Marchyear (latent)", -6.1903154058531475),
                                    ("Sukkotyear (latent)", -5.784850297744983),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.784850297744983),
                                    ("Clean Mondayyear (latent)", -5.784850297744983),
                                    ("monthhour", -5.784850297744983),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.497168225293202),
                                    ("todayat <time-of-day>", -6.1903154058531475),
                                    ("Thursday<time> timezone", -4.244405256797834),
                                    ("time-of-day (latent)tonight", -5.784850297744983),
                                    ("from|since|after <time>December", -6.1903154058531475),
                                    ("<time-of-day> am|pmon <day>", -4.175412385310882),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.1903154058531475),
                                    ("yyyy-mm-ddhh:mm:ss", -5.784850297744983),
                                    ("dayday", -3.747968370483943),
                                    ("<time> <part-of-day>at <time-of-day>", -6.1903154058531475),
                                    ("tonightat <time-of-day>", -6.1903154058531475),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.497168225293202),
                                    ("today<time-of-day> am|pm", -6.1903154058531475),
                                    ("Februarythe <day-of-month> (ordinal)", -5.784850297744983),
                                    ("at <time-of-day><time> <part-of-day>", -6.1903154058531475),
                                    ("<day-of-month> (ordinal)intersect", -5.784850297744983),
                                    ("hourhour", -4.110873864173311),
                                    ("Navaratriin|during <named-month>|year", -6.1903154058531475),
                                    ("Wednesdaythis|last|next <cycle>", -6.1903154058531475),
                                    ("Lentyear (latent)", -6.1903154058531475),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.686238009076873),
                                    ("Boghiyear (latent)", -6.1903154058531475),
                                    ("dayyear", -2.147264138018597),
                                    ("Thursdayfrom|since|after <time>", -5.784850297744983),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.1903154058531475),
                                    ("Thursdayat <time-of-day>", -5.497168225293202),
                                    ("Islamic New Yearyear (latent)", -5.784850297744983),
                                    ("Laylat al-Qadryear (latent)", -5.274024673978992),
                                    ("Shrove Tuesdayyear (latent)", -6.1903154058531475),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.497168225293202),
                                    ("<time-of-day> am|pmtomorrow", -5.497168225293202),
                                    ("Yom Kippuryear (latent)", -6.1903154058531475),
                                    ("<day-of-month> (ordinal)Tuesday", -5.784850297744983),
                                    ("<part-of-day> of <time>year (latent)", -6.1903154058531475),
                                    ("minutehour", -5.0917031171850375),
                                    ("Kaanum Pongalyear (latent)", -5.784850297744983),
                                    ("Maha Saptamiyear (latent)", -6.1903154058531475),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.784850297744983),
                                    ("time-of-day (latent)tomorrow", -5.274024673978992),
                                    ("part of daysat <time-of-day>", -5.784850297744983),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.485567313614722),
                                    ("for <duration> from <time>December", -6.1903154058531475),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.1903154058531475),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.9375524373577795),
                                    ("time-of-day (latent)this <part-of-day>", -6.1903154058531475),
                                    ("Pentecostyear (latent)", -6.1903154058531475),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.9375524373577795),
                                    ("<day-of-month> (ordinal)February", -6.1903154058531475),
                                    ("Eid al-Fitryear (latent)", -6.1903154058531475),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.1903154058531475),
                                    ("Mondayin|during the <part-of-day>", -6.1903154058531475),
                                    ("Chhathin|during <named-month>|year", -6.1903154058531475),
                                    ("Diwaliin|during <named-month>|year", -6.1903154058531475),
                                    ("Vaisakhiin|during <named-month>|year", -6.1903154058531475),
                                    ("Raksha Bandhanyear (latent)", -6.1903154058531475),
                                    ("daysecond", -5.784850297744983),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.784850297744983),
                                    ("Ashurayear (latent)", -6.1903154058531475),
                                    ("Tuesdayin|during <named-month>|year", -6.1903154058531475),
                                    ("Chinese New Yearyear (latent)", -6.1903154058531475),
                                    ("tomorrowintersect", -6.1903154058531475),
                                    ("Lag BaOmeryear (latent)", -6.1903154058531475),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.1903154058531475),
                                    ("Eid al-Adhayear (latent)", -5.274024673978992),
                                    ("intersectin|during the <part-of-day>", -6.1903154058531475),
                                    ("Palm Sundayyear (latent)", -6.1903154058531475),
                                    ("Christmasat <time-of-day>", -6.1903154058531475),
                                    ("Passoveryear (latent)", -6.1903154058531475),
                                    ("Lazarus Saturdayyear (latent)", -6.1903154058531475),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.1903154058531475),
                                    ("Yom HaShoahyear (latent)", -5.784850297744983),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.784850297744983),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.1903154058531475),
                                    ("Septemberyear (latent)", -5.784850297744983),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.686238009076873),
                                    ("Halloweenyear (latent)", -6.1903154058531475),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.1903154058531475),
                                    ("at <time-of-day>intersect", -5.784850297744983),
                                    ("Rosh Hashanahyear (latent)", -5.497168225293202),
                                    ("Dhanterasyear (latent)", -6.1903154058531475),
                                    ("Tu BiShvatyear (latent)", -6.1903154058531475),
                                    ("<day-of-month> (ordinal)December", -5.497168225293202),
                                    ("Holiyear (latent)", -5.497168225293202),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.1903154058531475),
                                    ("Holika Dahanyear (latent)", -5.497168225293202),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.1903154058531475),
                                    ("dayminute", -3.328114524923679),
                                    ("Mawlidyear (latent)", -6.1903154058531475),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.784850297744983),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.1903154058531475),
                                    ("Jumu'atul-Widayear (latent)", -5.274024673978992),
                                    ("minuteday", -2.361674009364052),
                                    ("absorption of , after named dayintersect",
                                     -6.1903154058531475),
                                    ("intersectyear (latent)", -6.1903154058531475),
                                    ("Orthodox Easter Sundayyear (latent)", -6.1903154058531475),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.1903154058531475),
                                    ("Boss's Dayyear (latent)", -5.784850297744983),
                                    ("Global Youth Service Dayyear (latent)", -6.1903154058531475),
                                    ("Dhanterasin|during <named-month>|year", -6.1903154058531475),
                                    ("Tisha B'Avyear (latent)", -6.1903154058531475),
                                    ("Isra and Mi'rajyear (latent)", -5.274024673978992),
                                    ("at <time-of-day>on <day>", -5.0917031171850375),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.1903154058531475),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.497168225293202),
                                    ("Christmasyear (latent)", -5.784850297744983),
                                    ("Naraka Chaturdashiyear (latent)", -5.784850297744983),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.1903154058531475),
                                    ("dayweek", -6.1903154058531475),
                                    ("Easter Sundayyear (latent)", -5.497168225293202),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.580877493419047),
                                    ("weekyear", -5.0917031171850375),
                                    ("hh:mmin|during the <part-of-day>", -5.497168225293202),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.784850297744983),
                                    ("Hanukkahyear (latent)", -5.497168225293202),
                                    ("February<time> <part-of-day>", -6.1903154058531475),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.1903154058531475),
                                    ("Great Lentyear (latent)", -6.1903154058531475),
                                    ("tomorrowat <time-of-day>", -5.497168225293202),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.1903154058531475),
                                    ("Vaisakhiyear (latent)", -5.497168225293202),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.1903154058531475),
                                    ("last <cycle> of <time>year (latent)", -5.497168225293202),
                                    ("at <time-of-day>tomorrow", -5.784850297744983),
                                    ("tomorrow<time-of-day> am|pm", -6.1903154058531475),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.1903154058531475),
                                    ("Diwaliyear (latent)", -6.1903154058531475),
                                    ("between <time> and <time>on <day>", -4.580877493419047),
                                    ("Black Fridayyear (latent)", -5.784850297744983),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.1903154058531475),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.1903154058531475),
                                    ("Chhathyear (latent)", -5.784850297744983),
                                    ("Vasant Panchamiyear (latent)", -6.1903154058531475),
                                    ("St Patrick's Dayyear (latent)", -6.1903154058531475),
                                    ("Thursday<time> (timezone)", -6.1903154058531475),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.1903154058531475),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.784850297744983),
                                    ("Februaryintersect", -6.1903154058531475),
                                    ("Simchat Torahyear (latent)", -6.1903154058531475),
                                    ("minuteyear", -6.1903154058531475)],
                               n = 367},
                   koData =
                     ClassData{prior = -0.9179287338783935, unseen = -6.594413459749778,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.1918471524802814),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.8998973535824915),
                                    ("<day-of-month> (ordinal)August", -5.8998973535824915),
                                    ("dayhour", -3.3349479961209547),
                                    ("<time> timezoneyear (latent)", -5.8998973535824915),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.983606621708336),
                                    ("Tuesdayfrom|since|after <time>", -5.8998973535824915),
                                    ("daymonth", -3.648605554975996),
                                    ("monthyear", -4.647134385087123),
                                    ("<time-of-day> am|pmyear (latent)", -5.206750173022546),
                                    ("Thai Pongalyear (latent)", -5.206750173022546),
                                    ("intersecthh:mm", -5.8998973535824915),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.8998973535824915),
                                    ("<day-of-month> (ordinal)Wednesday", -5.8998973535824915),
                                    ("houryear", -4.513602992462601),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.8998973535824915),
                                    ("<day-of-month> (ordinal)October", -5.8998973535824915),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.206750173022546),
                                    ("<time-of-day> am|pmintersect", -4.647134385087123),
                                    ("Octoberyear (latent)", -5.8998973535824915),
                                    ("until <time>on <day>", -5.206750173022546),
                                    ("time-of-day (latent)intersect", -5.8998973535824915),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.206750173022546),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.8998973535824915),
                                    ("hh:mmon <day>", -3.457550318213287),
                                    ("absorption of , after named dayJuly", -5.494432245474327),
                                    ("from|since|after <time>July", -5.8998973535824915),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.983606621708336),
                                    ("Clean Mondayyear (latent)", -5.8998973535824915),
                                    ("monthhour", -5.8998973535824915),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.494432245474327),
                                    ("hourmonth", -4.290459441148391),
                                    ("todayat <time-of-day>", -5.8998973535824915),
                                    ("from|since|after <time>December", -5.8998973535824915),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.8998973535824915),
                                    ("<time-of-day> am|pmon <day>", -4.647134385087123),
                                    ("Mondayyear (latent)", -5.206750173022546),
                                    ("dayday", -4.513602992462601),
                                    ("on <day>September", -5.494432245474327),
                                    ("time-of-day (latent)September", -5.494432245474327),
                                    ("hourhour", -5.8998973535824915),
                                    ("time-of-day (latent)on <day>", -3.457550318213287),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.494432245474327),
                                    ("dayyear", -3.0376964726530233),
                                    ("Thursdaymm/dd", -5.8998973535824915),
                                    ("New Year's Dayyear (latent)", -5.494432245474327),
                                    ("Thursdayfrom|since|after <time>", -4.195149261344066),
                                    ("Thursdayat <time-of-day>", -4.290459441148391),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.8998973535824915),
                                    ("Aprilyear (latent)", -5.8998973535824915),
                                    ("monthminute", -5.8998973535824915),
                                    ("<time-of-day> am|pmtomorrow", -5.8998973535824915),
                                    ("Thursdayhh:mm", -4.983606621708336),
                                    ("<day-of-month> (ordinal)Tuesday", -5.494432245474327),
                                    ("minutemonth", -4.108137884354437),
                                    ("minutehour", -5.8998973535824915),
                                    ("Augustyear (latent)", -5.494432245474327),
                                    ("week-endin|during <named-month>|year", -5.8998973535824915),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.8998973535824915),
                                    ("Sundayyear (latent)", -4.983606621708336),
                                    ("Christmasat <time-of-day>", -5.8998973535824915),
                                    ("from|since|after <time>year (latent)", -4.801285064914382),
                                    ("<duration> after|before|from <time>December",
                                     -5.8998973535824915),
                                    ("yesterday<time-of-day> am|pm", -5.8998973535824915),
                                    ("<day-of-month> (ordinal)July", -5.8998973535824915),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.8998973535824915),
                                    ("at <time-of-day>intersect", -5.494432245474327),
                                    ("hh:mmyear (latent)", -3.8204558119026557),
                                    ("Holiyear (latent)", -5.8998973535824915),
                                    ("until <time><time-of-day> am|pm", -5.8998973535824915),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.8998973535824915),
                                    ("dayminute", -3.3741687092742363),
                                    ("yyyy-mm-ddhh:mm", -5.494432245474327),
                                    ("intersectSeptember", -4.395819956806218),
                                    ("minuteday", -2.661218901418111),
                                    ("absorption of , after named dayintersect",
                                     -5.8998973535824915),
                                    ("intersectyear (latent)", -5.8998973535824915),
                                    ("Februaryin|during the <part-of-day>", -5.8998973535824915),
                                    ("time-of-day (latent)July", -5.8998973535824915),
                                    ("Saturdayyear (latent)", -5.8998973535824915),
                                    ("at <time-of-day>on <day>", -5.494432245474327),
                                    ("absorption of , after named daySeptember",
                                     -4.983606621708336),
                                    ("Naraka Chaturdashiyear (latent)", -5.8998973535824915),
                                    ("from|since|after <time>on <day>", -4.983606621708336),
                                    ("dayweek", -5.8998973535824915),
                                    ("Easter Sundayyear (latent)", -5.494432245474327),
                                    ("Thursday<time-of-day> am|pm", -4.647134385087123),
                                    ("weekyear", -5.494432245474327),
                                    ("time-of-day (latent)Thursday", -5.494432245474327),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.8998973535824915),
                                    ("<day-of-month> (ordinal)April", -5.8998973535824915),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.494432245474327),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.206750173022546),
                                    ("Sundayfrom|since|after <time>", -5.8998973535824915),
                                    ("absorption of , after named dayFebruary", -4.983606621708336),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.8998973535824915),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.8998973535824915),
                                    ("tomorrowat <time-of-day>", -5.8998973535824915),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.8998973535824915),
                                    ("last <cycle> of <time>year (latent)", -5.494432245474327),
                                    ("tomorrow<time-of-day> am|pm", -5.8998973535824915),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.206750173022546),
                                    ("Diwaliyear (latent)", -5.494432245474327),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.8998973535824915),
                                    ("Fridayyear (latent)", -5.494432245474327),
                                    ("time-of-day (latent)April", -5.8998973535824915),
                                    ("minuteyear", -3.7026727762462723)],
                               n = 244}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.21881766136708722,
                               unseen = -4.969813299576001,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -4.286370443178239e-2),
                                    ("intersect 2 numbers", -3.5765502691400166)],
                               n = 139},
                   koData =
                     ClassData{prior = -1.6269310698816175,
