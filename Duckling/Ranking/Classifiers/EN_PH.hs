                                 ...
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.12594614060725),
                                    ("Thursdaysince <time-of-day>", -4.838264068155469),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.2284312390838705),
                                    ("Sundaysince <time-of-day>", -5.2284312390838705),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.2284312390838705),
                                    ...
                                    ("since <time-of-day>July", -5.2284312390838705),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer after|past <hour-of-day>", -3.855452653939752),
                                    ...
                                    ("since <time-of-day>", -4.143134726391533),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -3.270835563798912),
                                    ...
                                    ("since <time-of-day>", -3.676300671907076),
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -1.6094379124341003, unseen = -2.639057329615259,
                               likelihoods =
                                 HashMap.fromList
                                   [("since <time-of-day>ordinal (digits)", -1.8718021769015913),
       ...
       ("<datetime> - <datetime> (interval)",
        Classifier{okData =
                     ClassData{prior = -0.3794896217049037, unseen = -4.304065093204169,
                               likelihoods =
                                 HashMap.fromList
                                   [("since <time-of-day><time-of-day> am|pm", -3.597312260588446),
                                    ("intersecthh:mm", -3.1918471524802814),
                                    ("since <time-of-day>hh:mm", -2.681021528714291),
       ...
       ("<time-of-day> - <time-of-day> (interval)",
        Classifier{okData =
                     ClassData{prior = -0.6931471805599453, unseen = -4.0943445622221,
                               likelihoods =
                                 HashMap.fromList
                                   [("since <time-of-day><time-of-day> am|pm", -3.3843902633457743),
                                    ("since <time-of-day>time-of-day (latent)",
                                     -3.3843902633457743),
                                    ("since <time-of-day>hh:mm", -2.468099531471619),
                   ...
                   koData =
                     ClassData{prior = -0.6931471805599453, unseen = -4.0943445622221,
                               likelihoods =
                                 HashMap.fromList
                                   [("since <time-of-day>time-of-day (latent)", -2.468099531471619),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Augustinteger (numeric)", -2.3353749158170367),
                                    ...
                                    ("since <time-of-day>integer (numeric)", -2.3353749158170367),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Julyinteger (numeric)integer (numeric)", -1.6422277352570913),
                                    ("Augustordinal (digits)integer (numeric)",
                                     -2.3353749158170367),
                                    ("since <time-of-day>ordinal (digits)integer (numeric)",
                                     -2.740840023925201),
                                    ("month", -0.8690378470236094),
                                    ("since <time-of-day>ordinal (digits)ordinal (digits)",
                                     -2.740840023925201),
                                    ("since <time-of-day>integer (numeric)integer (numeric)",
                                     -2.740840023925201),
                                    ("Augustordinal (digits)ordinal (digits)",
                                     -2.3353749158170367)],
                               n = 12},
