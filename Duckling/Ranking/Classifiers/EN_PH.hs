...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5508821079666681, unseen = -6.135564891081739,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 460},
                   koData =
                     ClassData{prior = -0.85906270196679, unseen = -5.8289456176102075,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46262352194811296,
                               unseen = -7.154615356913663,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.460686621018898),
                                    ("Karva Chauthyear (latent)", -6.460686621018898),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.460686621018898),
                                    ("Maha Shivaratriyear (latent)", -6.460686621018898),
                                    ("Ramadanyear (latent)", -5.2079236525235295),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.074392259899007),
                                    ("Bhai Doojyear (latent)", -6.460686621018898),
                                    ("hourday", -4.4457836004766325),
                                    ("dayhour", -3.440261734874535),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.074392259899007),
                                    ("Martin Luther King's Dayyear (latent)", -6.055221512910733),
                                    ("Shemini Atzeretyear (latent)", -6.460686621018898),
                                    ("daymonth", -4.4457836004766325),
                                    ("monthday", -6.055221512910733),
                                    ("monthyear", -4.668927151790842),
                                    ("Yom Ha'atzmautyear (latent)", -6.460686621018898),
                                    ("Vijayadashamiyear (latent)", -6.460686621018898),
                                    ("Thai Pongalyear (latent)", -5.767539440458952),
                                    ("Thiru Onamyear (latent)", -5.767539440458952),
                                    ("hhhmmabsorption of , after named day", -6.460686621018898),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.460686621018898),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.5443958891447425),
                                    ("<day-of-month> (ordinal)Wednesday", -6.460686621018898),
                                    ("Krishna Janmashtamiyear (latent)", -6.055221512910733),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.460686621018898),
                                    ("houryear", -5.5443958891447425),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.460686621018898),
                                    ("Christmas<time-of-day> am|pm", -6.460686621018898),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.460686621018898),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.767539440458952),
                                    ("intersectin|during <named-month>|year", -6.460686621018898),
                                    ("<time-of-day> am|pmintersect", -5.2079236525235295),
                                    ("Earth Houryear (latent)", -6.460686621018898),
                                    ("Ganesh Chaturthiyear (latent)", -6.460686621018898),
                                    ("Octoberyear (latent)", -4.956609224242623),
                                    ("intersect<time-of-day> am|pm", -6.460686621018898),
                                    ("Mattu Pongalyear (latent)", -6.460686621018898),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.460686621018898),
                                    ("Shavuotyear (latent)", -6.460686621018898),
                                    ("Parsi New Yearyear (latent)", -5.5443958891447425),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.460686621018898),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.460686621018898),
                                    ("todayin|within|after <duration>", -6.460686621018898),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.055221512910733),
                                    ("Marchyear (latent)", -6.460686621018898),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.055221512910733),
                                    ("Sukkotyear (latent)", -6.055221512910733),
                                    ("hhhmmintersect", -6.055221512910733),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.055221512910733),
                                    ("Clean Mondayyear (latent)", -6.055221512910733),
                                    ("monthhour", -6.055221512910733),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.767539440458952),
                                    ("todayat <time-of-day>", -6.460686621018898),
                                    ("Thursday<time> timezone", -4.062791348220527),
                                    ("tonight<time-of-day> am|pm", -6.460686621018898),
                                    ("time-of-day (latent)tonight", -6.055221512910733),
                                    ("from|since|after <time>December", -6.460686621018898),
                                    ("<time-of-day> am|pmon <day>", -4.4457836004766325),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.460686621018898),
                                    ("yyyy-mm-ddhh:mm:ss", -6.055221512910733),
                                    ("dayday", -3.7526364199166875),
                                    ("<time> <part-of-day>at <time-of-day>", -6.055221512910733),
                                    ("tonightat <time-of-day>", -5.362074332350788),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.767539440458952),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.460686621018898),
                                    ("today<time-of-day> am|pm", -6.460686621018898),
                                    ("Februarythe <day-of-month> (ordinal)", -6.055221512910733),
                                    ("at <time-of-day><time> <part-of-day>", -6.460686621018898),
                                    ("<day-of-month> (ordinal)intersect", -6.055221512910733),
                                    ("hourhour", -3.4902721554491962),
                                    ("Mahavir Jayantiyear (latent)", -6.055221512910733),
                                    ("Navaratriin|during <named-month>|year", -6.460686621018898),
                                    ("Wednesdaythis|last|next <cycle>", -6.460686621018898),
                                    ("Lentyear (latent)", -6.460686621018898),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.588884444117306),
                                    ("Boghiyear (latent)", -6.460686621018898),
                                    ("dayyear", -1.9280871278656415),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.460686621018898),
                                    ("Thursdayfrom|since|after <time>", -6.055221512910733),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.460686621018898),
                                    ("Thursdayat <time-of-day>", -5.767539440458952),
                                    ("Islamic New Yearyear (latent)", -6.055221512910733),
                                    ("Laylat al-Qadryear (latent)", -5.5443958891447425),
                                    ("part of days<time-of-day> am|pm", -6.460686621018898),
                                    ("Shrove Tuesdayyear (latent)", -6.460686621018898),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.767539440458952),
                                    ("hourminute", -6.055221512910733),
                                    ("<time-of-day> am|pmtomorrow", -5.767539440458952),
                                    ("Yom Kippuryear (latent)", -6.460686621018898),
                                    ("<day-of-month> (ordinal)Tuesday", -6.055221512910733),
                                    ("<part-of-day> of <time>year (latent)", -6.460686621018898),
                                    ("minutehour", -5.2079236525235295),
                                    ("Kaanum Pongalyear (latent)", -6.055221512910733),
                                    ("Maha Saptamiyear (latent)", -6.460686621018898),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.767539440458952),
                                    ("time-of-day (latent)tomorrow", -5.5443958891447425),
                                    ("part of daysat <time-of-day>", -4.851248708584797),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.4457836004766325),
                                    ("for <duration> from <time>December", -6.460686621018898),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.460686621018898),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.2079236525235295),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.2079236525235295),
                                    ("time-of-day (latent)this <part-of-day>", -6.460686621018898),
                                    ("Pentecostyear (latent)", -6.460686621018898),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.2079236525235295),
                                    ("<day-of-month> (ordinal)February", -6.460686621018898),
                                    ("Eid al-Fitryear (latent)", -5.074392259899007),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.460686621018898),
                                    ("Mondayin|during the <part-of-day>", -6.460686621018898),
                                    ("Chhathin|during <named-month>|year", -6.460686621018898),
                                    ("Diwaliin|during <named-month>|year", -6.460686621018898),
                                    ("this <part-of-day><time-of-day> am|pm", -6.460686621018898),
                                    ("Vaisakhiin|during <named-month>|year", -6.460686621018898),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.2079236525235295),
                                    ("Raksha Bandhanyear (latent)", -6.460686621018898),
                                    ("daysecond", -6.055221512910733),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.055221512910733),
                                    ("Ratha-Yatrayear (latent)", -6.460686621018898),
                                    ("Ashurayear (latent)", -6.460686621018898),
                                    ("Tuesdayin|during <named-month>|year", -6.460686621018898),
                                    ("Chinese New Yearyear (latent)", -6.460686621018898),
                                    ("tomorrowintersect", -6.460686621018898),
                                    ("Lag BaOmeryear (latent)", -6.460686621018898),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.460686621018898),
                                    ("Eid al-Adhayear (latent)", -4.320620457522627),
                                    ("intersectin|during the <part-of-day>", -6.460686621018898),
                                    ("Palm Sundayyear (latent)", -6.460686621018898),
                                    ("Christmasat <time-of-day>", -6.460686621018898),
                                    ("Passoveryear (latent)", -6.460686621018898),
                                    ("Lazarus Saturdayyear (latent)", -6.460686621018898),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.460686621018898),
                                    ("hhhmmon <day>", -5.5443958891447425),
                                    ("Yom HaShoahyear (latent)", -6.055221512910733),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.055221512910733),
                                    ("Septemberyear (latent)", -6.055221512910733),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.956609224242623),
                                    ("Halloweenyear (latent)", -6.460686621018898),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.460686621018898),
                                    ("at <time-of-day>intersect", -5.5443958891447425),
                                    ("Rosh Hashanahyear (latent)", -5.767539440458952),
                                    ("Dhanterasyear (latent)", -6.460686621018898),
                                    ("Tu BiShvatyear (latent)", -6.460686621018898),
                                    ("<day-of-month> (ordinal)December", -5.767539440458952),
                                    ("Holiyear (latent)", -5.767539440458952),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.460686621018898),
                                    ("Holika Dahanyear (latent)", -5.767539440458952),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.055221512910733),
                                    ("dayminute", -3.146500616346372),
                                    ("Mawlidyear (latent)", -6.460686621018898),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.055221512910733),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.460686621018898),
                                    ("Jumu'atul-Widayear (latent)", -5.5443958891447425),
                                    ("minuteday", -2.723017002735529),
                                    ("absorption of , after named dayintersect",
                                     -5.767539440458952),
                                    ("intersectyear (latent)", -6.460686621018898),
                                    ("Orthodox Easter Sundayyear (latent)", -6.460686621018898),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.460686621018898),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.460686621018898),
                                    ("intersecthhhmm", -6.055221512910733),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.460686621018898),
                                    ("Boss's Dayyear (latent)", -6.055221512910733),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.460686621018898),
                                    ("Global Youth Service Dayyear (latent)", -6.460686621018898),
                                    ("Dhanterasin|during <named-month>|year", -6.460686621018898),
                                    ("tonight<time-of-day> o'clock", -6.460686621018898),
                                    ("Tisha B'Avyear (latent)", -6.460686621018898),
                                    ("Isra and Mi'rajyear (latent)", -5.5443958891447425),
                                    ("at <time-of-day>on <day>", -4.851248708584797),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.055221512910733),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.767539440458952),
                                    ("Christmasyear (latent)", -6.055221512910733),
                                    ("Saturdayintersect", -6.460686621018898),
                                    ("Naraka Chaturdashiyear (latent)", -6.055221512910733),
                                    ("Thai Pongalin|during <named-month>|year", -6.460686621018898),
                                    ("dayweek", -6.460686621018898),
                                    ("Easter Sundayyear (latent)", -5.767539440458952),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.055221512910733),
                                    ("weekyear", -5.362074332350788),
                                    ("King's Dayyear (latent)", -4.956609224242623),
                                    ("hh:mmin|during the <part-of-day>", -5.5443958891447425),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.055221512910733),
                                    ("Hanukkahyear (latent)", -5.767539440458952),
                                    ("Rama Navamiyear (latent)", -6.460686621018898),
                                    ("February<time> <part-of-day>", -6.460686621018898),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.767539440458952),
                                    ("Great Lentyear (latent)", -6.460686621018898),
                                    ("tomorrowat <time-of-day>", -5.767539440458952),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.460686621018898),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.055221512910733),
                                    ("Ugadiyear (latent)", -5.074392259899007),
                                    ("Vaisakhiyear (latent)", -5.767539440458952),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.767539440458952),
                                    ("last <cycle> of <time>year (latent)", -5.767539440458952),
                                    ("at <time-of-day>tomorrow", -6.055221512910733),
                                    ("tomorrow<time-of-day> am|pm", -6.460686621018898),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.460686621018898),
                                    ("Diwaliyear (latent)", -6.460686621018898),
                                    ("between <time> and <time>on <day>", -6.055221512910733),
                                    ("Black Fridayyear (latent)", -6.055221512910733),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.460686621018898),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.460686621018898),
                                    ("Chhathyear (latent)", -6.055221512910733),
                                    ("Vasant Panchamiyear (latent)", -6.460686621018898),
                                    ("Rabindra Jayantiyear (latent)", -5.2079236525235295),
                                    ("this <part-of-day>at <time-of-day>", -5.2079236525235295),
                                    ("St Patrick's Dayyear (latent)", -6.460686621018898),
                                    ("Thursday<time> (timezone)", -6.460686621018898),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.460686621018898),
                                    ("Pargat Diwasyear (latent)", -5.2079236525235295),
                                    ("<datetime> - <datetime> (interval)July", -6.055221512910733),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.767539440458952),
                                    ("Februaryintersect", -6.460686621018898),
                                    ("Simchat Torahyear (latent)", -6.460686621018898),
                                    ("minuteyear", -6.460686621018898)],
                               n = 493},
                   koData =
                     ClassData{prior = -0.9932517730102834, unseen = -6.773080375655535,
                               likelihoods =
                                 HashMap.fromList
