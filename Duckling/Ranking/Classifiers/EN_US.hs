...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5628910625620327, unseen = -6.175867270105761,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 479},
                   koData =
                     ClassData{prior = -0.8429474481471769,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.43870374958389813,
                               unseen = -7.1731917424865985,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.4792773965649),
                                    ("Father's Dayyear (latent)", -6.4792773965649),
                                    ("Karva Chauthyear (latent)", -6.4792773965649),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.4792773965649),
                                    ("Maha Shivaratriyear (latent)", -6.4792773965649),
                                    ("Ramadanyear (latent)", -5.226514428069532),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.092983035445009),
                                    ("Military Spouse Dayyear (latent)", -6.4792773965649),
                                    ("Bhai Doojyear (latent)", -6.4792773965649),
                                    ("hourday", -4.464374376022635),
                                    ("dayhour", -3.5348384173984595),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.092983035445009),
                                    ("Martin Luther King's Dayyear (latent)", -6.073812288456735),
                                    ("Shemini Atzeretyear (latent)", -6.4792773965649),
                                    ("daymonth", -4.464374376022635),
                                    ("monthday", -6.073812288456735),
                                    ("monthyear", -4.687517927336844),
                                    ("Yom Ha'atzmautyear (latent)", -6.4792773965649),
                                    ("Vijayadashamiyear (latent)", -6.4792773965649),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.092983035445009),
                                    ("Thanksgiving Dayyear (latent)", -5.38066510789679),
                                    ("Thai Pongalyear (latent)", -5.786130216004954),
                                    ("Thiru Onamyear (latent)", -5.786130216004954),
                                    ("hhhmmabsorption of , after named day", -6.4792773965649),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.4792773965649),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.562986664690745),
                                    ("<day-of-month> (ordinal)Wednesday", -6.4792773965649),
                                    ("Krishna Janmashtamiyear (latent)", -6.073812288456735),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.4792773965649),
                                    ("houryear", -5.562986664690745),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.4792773965649),
                                    ("Christmas<time-of-day> am|pm", -6.4792773965649),
                                    ("last <day-of-week> of <time>year (latent)", -6.4792773965649),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.786130216004954),
                                    ("intersectin|during <named-month>|year", -6.4792773965649),
                                    ("<time-of-day> am|pmintersect", -5.226514428069532),
                                    ("Earth Houryear (latent)", -6.4792773965649),
                                    ("Octoberyear (latent)", -4.975199999788626),
                                    ("intersect<time-of-day> am|pm", -6.4792773965649),
                                    ("Mattu Pongalyear (latent)", -6.4792773965649),
                                    ("Daylight Saving Start Dayyear (latent)", -5.562986664690745),
                                    ("Shavuotyear (latent)", -6.4792773965649),
                                    ("Parsi New Yearyear (latent)", -5.562986664690745),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.4792773965649),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.4792773965649),
                                    ("todayin|within|after <duration>", -6.4792773965649),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.073812288456735),
                                    ("Marchyear (latent)", -6.4792773965649),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.073812288456735),
                                    ("Sukkotyear (latent)", -6.073812288456735),
                                    ("hhhmmintersect", -6.073812288456735),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.073812288456735),
                                    ("Daylight Saving End Dayyear (latent)", -5.562986664690745),
                                    ("Clean Mondayyear (latent)", -6.073812288456735),
                                    ("monthhour", -6.073812288456735),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.786130216004954),
                                    ("todayat <time-of-day>", -6.4792773965649),
                                    ("Thursday<time> timezone", -4.081382123766529),
                                    ("time-of-day (latent)tonight", -6.073812288456735),
                                    ("from|since|after <time>December", -6.4792773965649),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.4792773965649),
                                    ("<time-of-day> am|pmon <day>", -4.464374376022635),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -6.4792773965649),
                                    ("yyyy-mm-ddhh:mm:ss", -6.073812288456735),
                                    ("Tax Daythis|last|next <cycle>", -6.4792773965649),
                                    ("dayday", -3.7712271954626897),
                                    ("<time> <part-of-day>at <time-of-day>", -6.4792773965649),
                                    ("mm/ddat <time-of-day>", -6.4792773965649),
                                    ("tonightat <time-of-day>", -6.4792773965649),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.786130216004954),
                                    ("Dayananda Saraswati Jayantiyear (latent)", -6.4792773965649),
                                    ("today<time-of-day> am|pm", -6.4792773965649),
                                    ("Februarythe <day-of-month> (ordinal)", -6.073812288456735),
                                    ("at <time-of-day><time> <part-of-day>", -6.4792773965649),
                                    ("<day-of-month> (ordinal)intersect", -6.073812288456735),
                                    ("mm/dd<time-of-day> am|pm", -6.4792773965649),
                                    ("hourhour", -4.399835854885064),
                                    ("Mahavir Jayantiyear (latent)", -6.073812288456735),
                                    ("Navaratriin|during <named-month>|year", -6.4792773965649),
                                    ("Wednesdaythis|last|next <cycle>", -6.4792773965649),
                                    ("Lentyear (latent)", -6.4792773965649),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.607475219663308),
                                    ("Boghiyear (latent)", -6.4792773965649),
                                    ("dayyear", -1.7697471952525656),
                                    ("Karva Chauthin|during <named-month>|year", -6.4792773965649),
                                    ("Thursdayfrom|since|after <time>", -6.073812288456735),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.4792773965649),
                                    ("Thursdayat <time-of-day>", -5.786130216004954),
                                    ("Islamic New Yearyear (latent)", -6.073812288456735),
                                    ("Laylat al-Qadryear (latent)", -5.562986664690745),
                                    ("Shrove Tuesdayyear (latent)", -6.4792773965649),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.786130216004954),
                                    ("<time-of-day> am|pmtomorrow", -5.786130216004954),
                                    ("Yom Kippuryear (latent)", -6.4792773965649),
                                    ("<day-of-month> (ordinal)Tuesday", -6.073812288456735),
                                    ("<part-of-day> of <time>year (latent)", -6.4792773965649),
                                    ("minutehour", -5.226514428069532),
                                    ("Kaanum Pongalyear (latent)", -6.073812288456735),
                                    ("Maha Saptamiyear (latent)", -6.4792773965649),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.073812288456735),
                                    ("time-of-day (latent)tomorrow", -5.562986664690745),
                                    ("part of daysat <time-of-day>", -6.073812288456735),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.464374376022635),
                                    ("for <duration> from <time>December", -6.4792773965649),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.4792773965649),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.226514428069532),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.226514428069532),
                                    ("time-of-day (latent)this <part-of-day>", -6.4792773965649),
                                    ("Pentecostyear (latent)", -6.4792773965649),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.226514428069532),
                                    ("<day-of-month> (ordinal)February", -6.4792773965649),
                                    ("Eid al-Fitryear (latent)", -5.092983035445009),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.4792773965649),
                                    ("Mondayin|during the <part-of-day>", -6.4792773965649),
                                    ("Chhathin|during <named-month>|year", -6.4792773965649),
                                    ("Diwaliin|during <named-month>|year", -6.4792773965649),
                                    ("Vaisakhiin|during <named-month>|year", -6.4792773965649),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.226514428069532),
                                    ("Raksha Bandhanyear (latent)", -6.4792773965649),
                                    ("daysecond", -6.073812288456735),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.073812288456735),
                                    ("Emancipation Dayyear (latent)", -5.786130216004954),
                                    ("Ratha-Yatrayear (latent)", -6.4792773965649),
                                    ("Ashurayear (latent)", -6.4792773965649),
                                    ("Tuesdayin|during <named-month>|year", -6.4792773965649),
                                    ("Chinese New Yearyear (latent)", -6.4792773965649),
                                    ("tomorrowintersect", -6.4792773965649),
                                    ("Lag BaOmeryear (latent)", -6.4792773965649),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.4792773965649),
                                    ("Eid al-Adhayear (latent)", -4.339211233068629),
                                    ("intersectin|during the <part-of-day>", -6.4792773965649),
                                    ("Palm Sundayyear (latent)", -6.4792773965649),
                                    ("Christmasat <time-of-day>", -6.4792773965649),
                                    ("Passoveryear (latent)", -6.4792773965649),
                                    ("Lazarus Saturdayyear (latent)", -6.4792773965649),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.4792773965649),
                                    ("Cyber Mondayyear (latent)", -6.073812288456735),
                                    ("hhhmmon <day>", -5.562986664690745),
                                    ("Yom HaShoahyear (latent)", -6.073812288456735),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.073812288456735),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.4792773965649),
                                    ("Septemberyear (latent)", -6.073812288456735),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.975199999788626),
                                    ("Halloweenyear (latent)", -6.4792773965649),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.4792773965649),
                                    ("at <time-of-day>intersect", -5.562986664690745),
                                    ("Rosh Hashanahyear (latent)", -5.786130216004954),
                                    ("Dhanterasyear (latent)", -6.4792773965649),
                                    ("Tu BiShvatyear (latent)", -6.4792773965649),
                                    ("<day-of-month> (ordinal)December", -5.786130216004954),
                                    ("Holiyear (latent)", -5.786130216004954),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.4792773965649),
                                    ("Holika Dahanyear (latent)", -5.786130216004954),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.073812288456735),
                                    ("dayminute", -3.129373309290295),
                                    ("Mawlidyear (latent)", -6.4792773965649),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.073812288456735),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.4792773965649),
                                    ("Jumu'atul-Widayear (latent)", -5.562986664690745),
                                    ("minuteday", -2.7416077782815313),
                                    ("absorption of , after named dayintersect",
                                     -5.786130216004954),
                                    ("intersectyear (latent)", -6.4792773965649),
                                    ("Orthodox Easter Sundayyear (latent)", -6.4792773965649),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.4792773965649),
                                    ("<ordinal> <cycle> of <time>year (latent)", -6.4792773965649),
                                    ("intersecthhhmm", -6.073812288456735),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.4792773965649),
                                    ("Boss's Dayyear (latent)", -6.073812288456735),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.4792773965649),
                                    ("Global Youth Service Dayyear (latent)", -6.4792773965649),
                                    ("Dhanterasin|during <named-month>|year", -6.4792773965649),
                                    ("Tisha B'Avyear (latent)", -6.4792773965649),
                                    ("Isra and Mi'rajyear (latent)", -5.562986664690745),
                                    ("at <time-of-day>on <day>", -4.869839484130799),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.073812288456735),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.786130216004954),
                                    ("Christmasyear (latent)", -6.073812288456735),
                                    ("Naraka Chaturdashiyear (latent)", -6.073812288456735),
                                    ("Thai Pongalin|during <named-month>|year", -6.4792773965649),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.4792773965649),
                                    ("dayweek", -6.4792773965649),
                                    ("Easter Sundayyear (latent)", -5.786130216004954),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.073812288456735),
                                    ("weekyear", -5.38066510789679),
                                    ("King's Dayyear (latent)", -4.975199999788626),
                                    ("hh:mmin|during the <part-of-day>", -5.562986664690745),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.073812288456735),
                                    ("Hanukkahyear (latent)", -5.786130216004954),
                                    ("February<time> <part-of-day>", -6.4792773965649),
                                    ("National Grandparents Dayyear (latent)", -6.4792773965649),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.4792773965649),
                                    ("Great Lentyear (latent)", -6.4792773965649),
                                    ("tomorrowat <time-of-day>", -5.786130216004954),
                                    ("hhmm (latent)in|during the <part-of-day>", -6.4792773965649),
                                    ("Labor Dayyear (latent)", -6.4792773965649),
                                    ("Ugadiyear (latent)", -5.092983035445009),
                                    ("Vaisakhiyear (latent)", -5.786130216004954),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.786130216004954),
                                    ("last <cycle> of <time>year (latent)", -5.786130216004954),
                                    ("at <time-of-day>tomorrow", -6.073812288456735),
                                    ("tomorrow<time-of-day> am|pm", -6.4792773965649),
                                    ("President's Dayyear (latent)", -6.4792773965649),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.4792773965649),
                                    ("Diwaliyear (latent)", -6.4792773965649),
                                    ("between <time> and <time>on <day>", -6.073812288456735),
                                    ("Black Fridayyear (latent)", -6.073812288456735),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.4792773965649),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.4792773965649),
                                    ("Chhathyear (latent)", -6.073812288456735),
                                    ("Vasant Panchamiyear (latent)", -6.4792773965649),
                                    ("Tax Dayyear (latent)", -5.562986664690745),
                                    ("Rabindra Jayantiyear (latent)", -5.226514428069532),
                                    ("St Patrick's Dayyear (latent)", -6.4792773965649),
                                    ("Thursday<time> (timezone)", -6.4792773965649),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.4792773965649),
                                    ("Pargat Diwasyear (latent)", -5.226514428069532),
                                    ("<datetime> - <datetime> (interval)July", -6.073812288456735),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.786130216004954),
                                    ("Februaryintersect", -6.4792773965649),
                                    ("Mother's Dayyear (latent)", -6.4792773965649),
                                    ("Simchat Torahyear (latent)", -6.4792773965649),
                                    ("minuteyear", -6.4792773965649)],
                               n = 503},
                   koData =
                     ClassData{prior = -1.0352764134962988, unseen = -6.747586526829315,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.5491875512371545),
                                    ("hourday", -3.6553696752150584),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.053264948013429),
                                    ("<day-of-month> (ordinal)August", -6.053264948013429),
                                    ("dayhour", -3.3791162985869003),
                                    ("<time> timezoneyear (latent)", -5.360117767453484),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.136974216139274),
                                    ("Tuesdayfrom|since|after <time>", -5.360117767453484),
                                    ("daymonth", -3.3791162985869003),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.13152134169649837,
                               ...
                               n = 249},
                   koData =
                     ClassData{prior = -2.0936261766717923,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
