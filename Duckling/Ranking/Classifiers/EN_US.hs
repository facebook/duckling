...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46357273891544515,
                               unseen = -7.262628600974241,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.568779912142806),
                                    ...
                                    ("<time-of-day> am|pmtomorrow", -5.8756327315828605),
                               ...
                               n = 546},
                   koData =
                     ClassData{prior = -0.9916401691159419, unseen = -6.885509670034817,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.687262074706563),
                                    ("hourday", -3.7934441986844667),
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.275048739608683),
                                    ("Tuesdayfrom|since|after <time>", -5.092727182814728),
                                    ("daymonth", -3.5171908220563086),
                                    ...
                                    ("Mondayyear (latent)", -5.092727182814728),
                                    ("dayday", -3.9400476728763425),
                                    ("mm/ddat <time-of-day>", -5.785874363374673),
                                    ("on <day>September", -5.498192290922892),
                                    ("time-of-day (latent)September", -5.785874363374673),
                                    ("hourhour", -4.111897929803002),
                                    ...
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.785874363374673),
                                    ("dayyear", -2.8591349613076336),
                                    ("Thursdaymm/dd", -6.191339471482838),
                                    ("New Year's Dayyear (latent)", -5.275048739608683),
                                    ("Tuesdayyear (latent)", -5.092727182814728),
                                    ...
                                    ("<time-of-day> am|pmtomorrow", -6.191339471482838),
                                    ...
                                    ("Tuesdayin <number> (implicit minutes)", -6.191339471482838),
                                    ("part of daysat <time-of-day>", -5.092727182814728),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -5.275048739608683),
                                    ("<day-of-month> (ordinal)Sunday", -6.191339471482838),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.191339471482838),
                                    ("Tuesdayin|during <named-month>|year", -6.191339471482838),
                                    ...
                                    ("Tuesday<duration> hence|ago", -6.191339471482838),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.191339471482838),
                                    ("mm/ddyear (latent)", -6.191339471482838),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.191339471482838),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.191339471482838),
                                    ("Tuesdaythis|last|next <cycle>", -6.191339471482838),
                                    ...
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.191339471482838),
                                    ("<day-of-month> (ordinal)Monday", -5.275048739608683),
                                    ...
                                    ("Tuesdayin|within|after <duration>", -6.191339471482838),
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.30132484885556743,
                               ...
                               n = 91},
                   koData =
                     ClassData{prior = -1.3464484525726907, unseen = -4.343805421853684,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.497519996230115),
                                    ("month (grain)", -2.7212954278522306),
                                    ("second", -2.384823191231018),
                                    ("week (grain)", -1.497519996230115),
                                    ("day", -2.384823191231018),
                                    ("second (grain) ", -2.384823191231018),
                                    ("month", -2.7212954278522306),
                                    ("day (grain)", -2.384823191231018)],
                               n = 32}}),
       ("Mother's Day",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.791759469228055,
