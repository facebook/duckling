...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5983130778891066, unseen = -6.045005314036012,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 420},
                   koData =
                     ClassData{prior = -0.7979261317931222, unseen = -5.846438775057725,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45397675953383815,
                               unseen = -7.076653815443951,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.3826616834184415),
                                    ("Father's Dayyear (latent)", -6.3826616834184415),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.3826616834184415),
                                    ("Ramadanyear (latent)", -5.466370951544286),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.367758662876176),
                                    ("Military Spouse Dayyear (latent)", -6.3826616834184415),
                                    ("Bhai Doojyear (latent)", -6.3826616834184415),
                                    ("hourday", -4.367758662876176),
                                    ("dayhour", -3.464890951334162),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.367758662876176),
                                    ("Martin Luther King's Dayyear (latent)", -5.977196575310277),
                                    ("Shemini Atzeretyear (latent)", -6.3826616834184415),
                                    ("daymonth", -4.367758662876176),
                                    ("monthday", -5.977196575310277),
                                    ("monthyear", -4.590902214190386),
                                    ("Yom Ha'atzmautyear (latent)", -6.3826616834184415),
                                    ("Vijayadashamiyear (latent)", -6.3826616834184415),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -4.996367322298551),
                                    ("Thanksgiving Dayyear (latent)", -5.2840493947503315),
                                    ("Thai Pongalyear (latent)", -5.689514502858496),
                                    ("Thiru Onamyear (latent)", -5.689514502858496),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.3826616834184415),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.466370951544286),
                                    ("<day-of-month> (ordinal)Wednesday", -6.3826616834184415),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.3826616834184415),
                                    ("houryear", -5.466370951544286),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.3826616834184415),
                                    ("Christmas<time-of-day> am|pm", -6.3826616834184415),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.3826616834184415),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.689514502858496),
                                    ("intersectin|during <named-month>|year", -6.3826616834184415),
                                    ("<time-of-day> am|pmintersect", -5.1298987149230735),
                                    ("Earth Houryear (latent)", -6.3826616834184415),
                                    ("Octoberyear (latent)", -4.878584286642168),
                                    ("intersect<time-of-day> am|pm", -6.3826616834184415),
                                    ("Mattu Pongalyear (latent)", -6.3826616834184415),
                                    ("Daylight Saving Start Dayyear (latent)", -5.466370951544286),
                                    ("Shavuotyear (latent)", -6.3826616834184415),
                                    ("Parsi New Yearyear (latent)", -5.466370951544286),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.3826616834184415),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.3826616834184415),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.977196575310277),
                                    ("Marchyear (latent)", -6.3826616834184415),
                                    ("Sukkotyear (latent)", -5.977196575310277),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.977196575310277),
                                    ("Daylight Saving End Dayyear (latent)", -5.466370951544286),
                                    ("Clean Mondayyear (latent)", -5.977196575310277),
                                    ("monthhour", -5.977196575310277),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.689514502858496),
                                    ("todayat <time-of-day>", -6.3826616834184415),
                                    ("Thursday<time> timezone", -4.436751534363128),
                                    ("time-of-day (latent)tonight", -5.977196575310277),
                                    ("from|since|after <time>December", -6.3826616834184415),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.3826616834184415),
                                    ("<time-of-day> am|pmon <day>", -4.367758662876176),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.3826616834184415),
                                    ("yyyy-mm-ddhh:mm:ss", -5.977196575310277),
                                    ("Tax Daythis|last|next <cycle>", -6.3826616834184415),
                                    ("dayday", -3.940314648049237),
                                    ("<time> <part-of-day>at <time-of-day>", -6.3826616834184415),
                                    ("mm/ddat <time-of-day>", -6.3826616834184415),
                                    ("tonightat <time-of-day>", -6.3826616834184415),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.689514502858496),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.3826616834184415),
                                    ("today<time-of-day> am|pm", -6.3826616834184415),
                                    ("Februarythe <day-of-month> (ordinal)", -5.977196575310277),
                                    ("at <time-of-day><time> <part-of-day>", -6.3826616834184415),
                                    ("<day-of-month> (ordinal)intersect", -5.977196575310277),
                                    ("mm/dd<time-of-day> am|pm", -6.3826616834184415),
                                    ("hourhour", -4.303220141738605),
                                    ("Navaratriin|during <named-month>|year", -6.3826616834184415),
                                    ("Wednesdaythis|last|next <cycle>", -6.3826616834184415),
                                    ("Lentyear (latent)", -6.3826616834184415),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.878584286642168),
                                    ("Boghiyear (latent)", -6.3826616834184415),
                                    ("dayyear", -1.7976942047478695),
                                    ("Thursdayfrom|since|after <time>", -5.977196575310277),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.3826616834184415),
                                    ("Thursdayat <time-of-day>", -5.689514502858496),
                                    ("Islamic New Yearyear (latent)", -5.977196575310277),
                                    ("Laylat al-Qadryear (latent)", -5.466370951544286),
                                    ("Shrove Tuesdayyear (latent)", -6.3826616834184415),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.689514502858496),
                                    ("<time-of-day> am|pmtomorrow", -5.689514502858496),
                                    ("Yom Kippuryear (latent)", -6.3826616834184415),
                                    ("<day-of-month> (ordinal)Tuesday", -5.977196575310277),
                                    ("<part-of-day> of <time>year (latent)", -6.3826616834184415),
                                    ("minutehour", -5.2840493947503315),
                                    ("Kaanum Pongalyear (latent)", -5.977196575310277),
                                    ("Maha Saptamiyear (latent)", -6.3826616834184415),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.977196575310277),
                                    ("time-of-day (latent)tomorrow", -5.466370951544286),
                                    ("part of daysat <time-of-day>", -5.977196575310277),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.677913591180016),
                                    ("for <duration> from <time>December", -6.3826616834184415),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.3826616834184415),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.1298987149230735),
                                    ("time-of-day (latent)this <part-of-day>", -6.3826616834184415),
                                    ("Pentecostyear (latent)", -6.3826616834184415),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.1298987149230735),
                                    ("<day-of-month> (ordinal)February", -6.3826616834184415),
                                    ("Eid al-Fitryear (latent)", -5.466370951544286),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.3826616834184415),
                                    ("Mondayin|during the <part-of-day>", -6.3826616834184415),
                                    ("Chhathin|during <named-month>|year", -6.3826616834184415),
                                    ("Diwaliin|during <named-month>|year", -6.3826616834184415),
                                    ("Vaisakhiin|during <named-month>|year", -6.3826616834184415),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.1298987149230735),
                                    ("Raksha Bandhanyear (latent)", -6.3826616834184415),
                                    ("daysecond", -5.977196575310277),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.977196575310277),
                                    ("Emancipation Dayyear (latent)", -5.689514502858496),
                                    ("Ashurayear (latent)", -6.3826616834184415),
                                    ("Tuesdayin|during <named-month>|year", -6.3826616834184415),
                                    ("Chinese New Yearyear (latent)", -6.3826616834184415),
                                    ("tomorrowintersect", -6.3826616834184415),
                                    ("Lag BaOmeryear (latent)", -6.3826616834184415),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.3826616834184415),
                                    ("Eid al-Adhayear (latent)", -4.242595519922171),
                                    ("intersectin|during the <part-of-day>", -6.3826616834184415),
                                    ("Palm Sundayyear (latent)", -6.3826616834184415),
                                    ("Christmasat <time-of-day>", -6.3826616834184415),
                                    ("Passoveryear (latent)", -6.3826616834184415),
                                    ("Lazarus Saturdayyear (latent)", -6.3826616834184415),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.3826616834184415),
                                    ("Cyber Mondayyear (latent)", -5.977196575310277),
                                    ("Yom HaShoahyear (latent)", -5.977196575310277),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.977196575310277),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.3826616834184415),
                                    ("Septemberyear (latent)", -5.977196575310277),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.878584286642168),
                                    ("Halloweenyear (latent)", -6.3826616834184415),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.3826616834184415),
                                    ("at <time-of-day>intersect", -5.977196575310277),
                                    ("Rosh Hashanahyear (latent)", -5.689514502858496),
                                    ("Dhanterasyear (latent)", -6.3826616834184415),
                                    ("Tu BiShvatyear (latent)", -6.3826616834184415),
                                    ("<day-of-month> (ordinal)December", -5.689514502858496),
                                    ("Holiyear (latent)", -5.689514502858496),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.3826616834184415),
                                    ("Holika Dahanyear (latent)", -5.689514502858496),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.3826616834184415),
                                    ("dayminute", -3.464890951334162),
                                    ("Mawlidyear (latent)", -6.3826616834184415),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.977196575310277),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.3826616834184415),
                                    ("Jumu'atul-Widayear (latent)", -5.466370951544286),
                                    ("minuteday", -2.5540202869293465),
                                    ("absorption of , after named dayintersect",
                                     -6.3826616834184415),
                                    ("intersectyear (latent)", -6.3826616834184415),
                                    ("Orthodox Easter Sundayyear (latent)", -6.3826616834184415),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.3826616834184415),
                                    ("Boss's Dayyear (latent)", -5.977196575310277),
                                    ("Global Youth Service Dayyear (latent)", -6.3826616834184415),
                                    ("Dhanterasin|during <named-month>|year", -6.3826616834184415),
                                    ("Tisha B'Avyear (latent)", -6.3826616834184415),
                                    ("Isra and Mi'rajyear (latent)", -5.466370951544286),
                                    ("at <time-of-day>on <day>", -5.2840493947503315),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.3826616834184415),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.689514502858496),
                                    ("Christmasyear (latent)", -5.977196575310277),
                                    ("Naraka Chaturdashiyear (latent)", -5.977196575310277),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.3826616834184415),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.3826616834184415),
                                    ("dayweek", -6.3826616834184415),
                                    ("Easter Sundayyear (latent)", -5.689514502858496),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.773223770984341),
                                    ("weekyear", -5.2840493947503315),
                                    ("King's Dayyear (latent)", -4.878584286642168),
                                    ("hh:mmin|during the <part-of-day>", -5.689514502858496),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.977196575310277),
                                    ("Hanukkahyear (latent)", -5.689514502858496),
                                    ("February<time> <part-of-day>", -6.3826616834184415),
                                    ("National Grandparents Dayyear (latent)", -6.3826616834184415),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.3826616834184415),
                                    ("Great Lentyear (latent)", -6.3826616834184415),
                                    ("tomorrowat <time-of-day>", -5.689514502858496),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.3826616834184415),
                                    ("Labor Dayyear (latent)", -6.3826616834184415),
                                    ("Vaisakhiyear (latent)", -5.689514502858496),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.3826616834184415),
                                    ("last <cycle> of <time>year (latent)", -5.689514502858496),
                                    ("at <time-of-day>tomorrow", -5.977196575310277),
                                    ("tomorrow<time-of-day> am|pm", -6.3826616834184415),
                                    ("President's Dayyear (latent)", -6.3826616834184415),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.3826616834184415),
                                    ("Diwaliyear (latent)", -6.3826616834184415),
                                    ("between <time> and <time>on <day>", -4.773223770984341),
                                    ("Black Fridayyear (latent)", -5.977196575310277),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.3826616834184415),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.3826616834184415),
                                    ("Chhathyear (latent)", -5.977196575310277),
                                    ("Vasant Panchamiyear (latent)", -6.3826616834184415),
                                    ("Tax Dayyear (latent)", -5.466370951544286),
                                    ("Rabindra Jayantiyear (latent)", -5.1298987149230735),
                                    ("St Patrick's Dayyear (latent)", -6.3826616834184415),
                                    ("Thursday<time> (timezone)", -6.3826616834184415),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.3826616834184415),
                                    ("<datetime> - <datetime> (interval)July", -5.977196575310277),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.977196575310277),
                                    ("Februaryintersect", -6.3826616834184415),
                                    ("Mother's Dayyear (latent)", -6.3826616834184415),
                                    ("Simchat Torahyear (latent)", -6.3826616834184415),
                                    ("minuteyear", -6.3826616834184415)],
                               n = 456},
                   koData =
                     ClassData{prior = -1.0081250652871274, unseen = -6.679599185844383,
                               likelihoods =
                                 HashMap.fromList
