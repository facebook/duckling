...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4676348954101849, unseen = -6.748759547491679,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.05443934626937),
                                    ...
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.801676377774002),
                                    ("Military Spouse Dayyear (latent)", -6.05443934626937),
                                    ...
                                    ("Octoberyear (latent)", -4.801676377774002),
                                    ...
                                    ("Tax Daythis|last|next <cycle>", -6.05443934626937),
                                    ("dayday", -3.857214768933151),
                                    ("<time> <part-of-day>at <time-of-day>", -6.05443934626937),
                                    ("mm/ddat <time-of-day>", -6.05443934626937),
                                    ...
                                    ("mm/dd<time-of-day> am|pm", -6.05443934626937),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.648974238161206),
                                    ("Emancipation Dayyear (latent)", -5.3612921657094255),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.05443934626937),
                                    ("Cyber Mondayyear (latent)", -5.648974238161206),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -6.05443934626937),
                                    ...
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.648974238161206),
                                    ("Hanukkahyear (latent)", -6.05443934626937),
                                    ("February<time> <part-of-day>", -6.05443934626937),
                                    ("National Grandparents Dayyear (latent)", -6.05443934626937),
                                    ...
                                    ("Labor Dayyear (latent)", -6.05443934626937),
                                    ...
                                    ("President's Dayyear (latent)", -6.05443934626937),
                                    ...
                                    ("Tax Dayyear (latent)", -5.138148614395216),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.05443934626937),
                                    ("Februaryintersect", -6.05443934626937),
                                    ("Mother's Dayyear (latent)", -6.05443934626937),
                                    ("Simchat Torahyear (latent)", -6.05443934626937)],
                               n = 317},
                   koData =
                     ClassData{prior = -0.9847896542278232, unseen = -6.391917113392602,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.7808027546312495),
