...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6658550382719377, unseen = -5.568344503761097,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 260},
                   koData =
                     ClassData{prior = -0.7212051333551027,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4756107174749242, unseen = -6.654152520183219,
                               likelihoods =
                                 HashMap.fromList
                                   [("Father's Dayyear (latent)", -5.959715848793402),
                                    ("Ramadanyear (latent)", -5.959715848793402),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.706952880298034),
                                    ("Military Spouse Dayyear (latent)", -5.959715848793402),
                                    ("Bhai Doojyear (latent)", -5.959715848793402),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.706952880298034),
                                    ("hourday", -4.254967756554977),
                                    ("dayhour", -3.0419451167091225),
                                    ("Martin Luther King's Dayyear (latent)", -5.554250740685237),
                                    ("Shemini Atzeretyear (latent)", -5.959715848793402),
                                    ("daymonth", -5.2665686682334565),
                                    ("monthday", -5.554250740685237),
                                    ("monthyear", -4.350277936359301),
                                    ("Yom Ha'atzmautyear (latent)", -5.959715848793402),
                                    ("Thanksgiving Dayyear (latent)", -4.861103560125292),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.959715848793402),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.959715848793402),
                                    ("houryear", -5.2665686682334565),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.959715848793402),
                                    ("Christmas<time-of-day> am|pm", -5.959715848793402),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.959715848793402),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.2665686682334565),
                                    ("<time-of-day> am|pmintersect", -4.706952880298034),
                                    ("Octoberyear (latent)", -4.706952880298034),
                                    ("intersect<time-of-day> am|pm", -5.959715848793402),
                                    ("Shavuotyear (latent)", -5.959715848793402),
                                    ("Dhanterasin <named-month>|year", -5.959715848793402),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.959715848793402),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.959715848793402),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.554250740685237),
                                    ("Marchyear (latent)", -5.959715848793402),
                                    ("Sukkotyear (latent)", -5.554250740685237),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.959715848793402),
                                    ("Clean Mondayyear (latent)", -5.554250740685237),
                                    ("monthhour", -5.554250740685237),
                                    ("todayat <time-of-day>", -5.959715848793402),
                                    ("Thursday<time> timezone", -4.254967756554977),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.959715848793402),
                                    ("Palm SundaySunday", -5.554250740685237),
                                    ("dayday", -3.7624912714571823),
                                    ("<time> <part-of-day>at <time-of-day>", -5.959715848793402),
                                    ("mm/ddat <time-of-day>", -5.959715848793402),
                                    ("tonightat <time-of-day>", -5.959715848793402),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.2665686682334565),
                                    ("today<time-of-day> am|pm", -5.959715848793402),
                                    ("Februarythe <day-of-month> (ordinal)", -5.554250740685237),
                                    ("at <time-of-day><time> <part-of-day>", -5.959715848793402),
                                    ("mm/dd<time-of-day> am|pm", -5.959715848793402),
                                    ("hourhour", -4.706952880298034),
                                    ("<time-of-day> am|pmon <date>", -3.9448128282511368),
                                    ("Wednesdaythis|last|next <cycle>", -5.959715848793402),
                                    ("Lentyear (latent)", -5.959715848793402),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.455638452017127),
                                    ("dayyear", -2.120263536200091),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.959715848793402),
                                    ("Thursdayat <time-of-day>", -5.554250740685237),
                                    ("Islamic New Yearyear (latent)", -5.554250740685237),
                                    ("Laylat al-Qadryear (latent)", -5.043425116919247),
                                    ("Chhathin <named-month>|year", -5.959715848793402),
                                    ("Diwaliin <named-month>|year", -5.959715848793402),
                                    ("Shrove Tuesdayyear (latent)", -5.959715848793402),
                                    ("<time-of-day> am|pmtomorrow", -5.2665686682334565),
                                    ("Yom Kippuryear (latent)", -5.959715848793402),
                                    ("<part-of-day> of <time>year (latent)", -5.959715848793402),
                                    ("minutehour", -5.043425116919247),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.554250740685237),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.254967756554977),
                                    ("for <duration> from <time>December", -5.959715848793402),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.959715848793402),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.043425116919247),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.554250740685237),
                                    ("Pentecostyear (latent)", -5.959715848793402),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.043425116919247),
                                    ("Eid al-Fitryear (latent)", -5.959715848793402),
                                    ("Mondayin|during the <part-of-day>", -5.959715848793402),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.554250740685237),
                                    ("Ashurayear (latent)", -5.959715848793402),
                                    ("Chinese New Yearyear (latent)", -5.959715848793402),
                                    ("Sundayyear (latent)", -5.959715848793402),
                                    ("Lag BaOmeryear (latent)", -5.959715848793402),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.959715848793402),
                                    ("Eid al-Adhayear (latent)", -5.043425116919247),
                                    ("intersectin|during the <part-of-day>", -5.959715848793402),
                                    ("Christmasat <time-of-day>", -5.959715848793402),
                                    ("Passoveryear (latent)", -5.959715848793402),
                                    ("Lazarus Saturdayyear (latent)", -5.959715848793402),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.959715848793402),
                                    ("Cyber Mondayyear (latent)", -5.554250740685237),
                                    ("Yom HaShoahyear (latent)", -5.554250740685237),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.043425116919247),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.959715848793402),
                                    ("Septemberyear (latent)", -5.554250740685237),
                                    ("mm/ddyear (latent)", -5.959715848793402),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.706952880298034),
                                    ("Halloweenyear (latent)", -5.959715848793402),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.959715848793402),
                                    ("Dhanterasyear (latent)", -5.959715848793402),
                                    ("Tu BiShvatyear (latent)", -5.959715848793402),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.959715848793402),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.959715848793402),
                                    ("dayminute", -3.320658519178143),
                                    ("Mawlidyear (latent)", -5.959715848793402),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.554250740685237),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.959715848793402),
                                    ("Jumu'atul-Widayear (latent)", -5.043425116919247),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.959715848793402),
                                    ("minuteday", -2.322129689067016),
                                    ("absorption of , after named dayintersect",
                                     -5.959715848793402),
                                    ("intersectyear (latent)", -5.959715848793402),
                                    ("Orthodox Easter Sundayyear (latent)", -5.959715848793402),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.959715848793402),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.959715848793402),
                                    ("Boss's Dayyear (latent)", -5.554250740685237),
                                    ("Tisha B'Avyear (latent)", -5.959715848793402),
                                    ("Isra and Mi'rajyear (latent)", -5.043425116919247),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.959715848793402),
                                    ("Christmasyear (latent)", -5.554250740685237),
                                    ("Naraka Chaturdashiyear (latent)", -5.554250740685237),
                                    ("at <time-of-day>on <date>", -4.861103560125292),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.350277936359301),
                                    ("dayweek", -5.959715848793402),
                                    ("Easter Sundayyear (latent)", -5.2665686682334565),
                                    ("Thursday<time-of-day> am|pm", -5.959715848793402),
                                    ("weekyear", -5.554250740685237),
                                    ("hh:mmin|during the <part-of-day>", -5.2665686682334565),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.554250740685237),
                                    ("Hanukkahyear (latent)", -5.959715848793402),
                                    ("February<time> <part-of-day>", -5.959715848793402),
                                    ("National Grandparents Dayyear (latent)", -5.959715848793402),
                                    ("Tuesdayin <named-month>|year", -5.959715848793402),
                                    ("Great Lentyear (latent)", -5.959715848793402),
                                    ("tomorrowat <time-of-day>", -5.2665686682334565),
                                    ("Labor Dayyear (latent)", -5.959715848793402),
                                    ("between <time> and <time>on <date>", -4.350277936359301),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.2665686682334565),
                                    ("last <cycle> of <time>year (latent)", -5.2665686682334565),
                                    ("at <time-of-day>tomorrow", -5.554250740685237),
                                    ("tomorrow<time-of-day> am|pm", -5.959715848793402),
                                    ("President's Dayyear (latent)", -5.959715848793402),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.959715848793402),
                                    ("Diwaliyear (latent)", -5.959715848793402),
                                    ("Black Fridayyear (latent)", -5.554250740685237),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.959715848793402),
                                    ("Chhathyear (latent)", -5.554250740685237),
                                    ("Palm Sundayintersect", -5.959715848793402),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.959715848793402),
                                    ("Februaryintersect", -5.959715848793402),
                                    ("Mother's Dayyear (latent)", -5.959715848793402),
                                    ("Simchat Torahyear (latent)", -5.959715848793402)],
                               n = 289},
                   koData =
                     ClassData{prior = -0.9715534105492045, unseen = -6.309918278226516,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.614951260949585),
                                    ("hourday", -5.614951260949585),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.614951260949585),
                                    ("dayhour", -3.172604225580381),
                                    ("daymonth", -3.5355097192697493),
                                    ("monthday", -5.209486152841421),
                                    ("monthyear", -4.362188292454217),
                                    ("<time-of-day> am|pmyear (latent)", -5.209486152841421),
                                    ("intersecthh:mm", -5.614951260949585),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.614951260949585),
                                    ("houryear", -4.69866052907543),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.614951260949585),
                                    ("until <time-of-day><time-of-day> am|pm", -5.614951260949585),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.92180408038964),
                                    ("<time-of-day> am|pmintersect", -4.362188292454217),
                                    ("Octoberyear (latent)", -5.614951260949585),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.362188292454217),
                                    ("from|since|after <time-of-day>on <date>", -4.69866052907543),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.69866052907543),
                                    ("Clean Mondayyear (latent)", -5.614951260949585),
                                    ("monthhour", -5.614951260949585),
                                    ("hourmonth", -4.92180408038964),
                                    ("todayat <time-of-day>", -5.614951260949585),
                                    ("from|since|after <time-of-day>July", -5.614951260949585),
                                    ("Mondayyear (latent)", -4.516338972281476),
                                    ("dayday", -5.209486152841421),
                                    ("mm/ddat <time-of-day>", -5.209486152841421),
                                    ("<time-of-day> am|pmon <date>", -4.362188292454217),
                                    ("dayyear", -2.697180528865306),
                                    ("Thursdaymm/dd", -5.614951260949585),
                                    ("New Year's Dayyear (latent)", -5.209486152841421),
                                    ("Thursdayat <time-of-day>", -4.362188292454217),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.614951260949585),
                                    ("Aprilyear (latent)", -5.614951260949585),
                                    ("monthminute", -5.614951260949585),
                                    ("<time-of-day> am|pmtomorrow", -5.614951260949585),
                                    ("Thursdayhh:mm", -4.69866052907543),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.614951260949585),
                                    ("minutemonth", -3.82319179172153),
                                    ("Sundayfrom|since|after <time-of-day>", -5.614951260949585),
                                    ("week-endin <named-month>|year", -5.614951260949585),
                                    ("Augustyear (latent)", -5.209486152841421),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.209486152841421),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.209486152841421),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.614951260949585),
                                    ("Sundayyear (latent)", -4.92180408038964),
                                    ("Christmasat <time-of-day>", -5.614951260949585),
                                    ("<duration> after|before|from <time>December",
                                     -5.614951260949585),
                                    ("yesterday<time-of-day> am|pm", -5.614951260949585),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.69866052907543),
                                    ("mm/ddyear (latent)", -5.614951260949585),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.209486152841421),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.614951260949585),
                                    ("until <time-of-day>on <date>", -4.92180408038964),
                                    ("at <time-of-day>intersect", -5.209486152841421),
                                    ("hh:mmyear (latent)", -4.516338972281476),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.614951260949585),
                                    ("dayminute", -3.130044611161585),
                                    ("intersectSeptember", -4.110873864173311),
                                    ("minuteday", -2.546898325815968),
                                    ("absorption of , after named dayintersect",
                                     -5.614951260949585),
                                    ("Februaryin|during the <part-of-day>", -5.614951260949585),
                                    ("hh:mmon <date>", -3.6000482404073204),
                                    ("Saturdayyear (latent)", -5.614951260949585),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.614951260949585),
                                    ("absorption of , after named daySeptember", -4.69866052907543),
                                    ("Naraka Chaturdashiyear (latent)", -5.614951260949585),
                                    ("on <date>September", -5.209486152841421),
                                    ("at <time-of-day>on <date>", -5.209486152841421),
                                    ("in <named-month>|yearyear (latent)", -5.614951260949585),
                                    ("dayweek", -5.614951260949585),
                                    ("Easter Sundayyear (latent)", -5.209486152841421),
                                    ("Thursday<time-of-day> am|pm", -5.209486152841421),
                                    ("absorption of , after named dayFebruary", -4.69866052907543),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.614951260949585),
                                    ("tomorrowat <time-of-day>", -5.614951260949585),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.614951260949585),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.005513348515485),
                                    ("tomorrow<time-of-day> am|pm", -5.614951260949585),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.92180408038964),
                                    ("Diwaliyear (latent)", -5.209486152841421),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.614951260949585),
                                    ("Fridayyear (latent)", -5.209486152841421),
                                    ("minuteyear", -4.362188292454217)],
                               n = 176}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.18698356989976592,
                               unseen = -4.718498871295094,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -5.5569851154810765e-2),
                                    ("intersect 2 numbers", -3.3232358401924436)],
                               n = 107},
                   koData =
                     ClassData{prior = -1.7687699510033563, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
