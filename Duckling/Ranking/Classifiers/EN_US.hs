...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5509726917794028, unseen = -6.214608098422191,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 498},
                   koData =
                     ClassData{prior = -0.8589394354026894, unseen = -5.908082938168931,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.44425113314332093,
                               unseen = -7.226936018493289,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.533061829540727),
                                    ("Father's Dayyear (latent)", -6.533061829540727),
                                    ("Karva Chauthyear (latent)", -6.533061829540727),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.533061829540727),
                                    ("Maha Shivaratriyear (latent)", -6.533061829540727),
                                    ("Ramadanyear (latent)", -5.280298861045359),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.146767468420836),
                                    ("Military Spouse Dayyear (latent)", -6.533061829540727),
                                    ("Bhai Doojyear (latent)", -6.533061829540727),
                                    ("hourday", -4.518158808998462),
                                    ("dayhour", -3.4885393918173033),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.146767468420836),
                                    ("Martin Luther King's Dayyear (latent)", -6.127596721432562),
                                    ("Shemini Atzeretyear (latent)", -6.533061829540727),
                                    ("daymonth", -4.518158808998462),
                                    ("monthday", -6.127596721432562),
                                    ("monthyear", -4.741302360312671),
                                    ("Yom Ha'atzmautyear (latent)", -6.533061829540727),
                                    ("Vijayadashamiyear (latent)", -6.533061829540727),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.146767468420836),
                                    ("Thanksgiving Dayyear (latent)", -5.434449540872617),
                                    ("Thai Pongalyear (latent)", -5.839914648980781),
                                    ("Thiru Onamyear (latent)", -5.839914648980781),
                                    ("hhhmmabsorption of , after named day", -6.533061829540727),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.533061829540727),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.616771097666572),
                                    ("<day-of-month> (ordinal)Wednesday", -6.533061829540727),
                                    ("Krishna Janmashtamiyear (latent)", -6.127596721432562),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.533061829540727),
                                    ("houryear", -5.616771097666572),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.533061829540727),
                                    ("Christmas<time-of-day> am|pm", -6.533061829540727),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.533061829540727),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.839914648980781),
                                    ("intersectin|during <named-month>|year", -6.533061829540727),
                                    ("<time-of-day> am|pmintersect", -5.280298861045359),
                                    ("Earth Houryear (latent)", -6.533061829540727),
                                    ("Ganesh Chaturthiyear (latent)", -6.533061829540727),
                                    ("Octoberyear (latent)", -5.028984432764452),
                                    ("intersect<time-of-day> am|pm", -6.533061829540727),
                                    ("Mattu Pongalyear (latent)", -6.533061829540727),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.533061829540727),
                                    ("Daylight Saving Start Dayyear (latent)", -5.616771097666572),
                                    ("Shavuotyear (latent)", -6.533061829540727),
                                    ("Parsi New Yearyear (latent)", -5.616771097666572),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.533061829540727),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.533061829540727),
                                    ("todayin|within|after <duration>", -6.533061829540727),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.127596721432562),
                                    ("Marchyear (latent)", -6.533061829540727),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.127596721432562),
                                    ("Sukkotyear (latent)", -6.127596721432562),
                                    ("hhhmmintersect", -6.127596721432562),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.127596721432562),
                                    ("Daylight Saving End Dayyear (latent)", -5.616771097666572),
                                    ("Clean Mondayyear (latent)", -6.127596721432562),
                                    ("monthhour", -6.127596721432562),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.839914648980781),
                                    ("todayat <time-of-day>", -6.533061829540727),
                                    ("Thursday<time> timezone", -4.135166556742356),
                                    ("tonight<time-of-day> am|pm", -6.533061829540727),
                                    ("time-of-day (latent)tonight", -6.127596721432562),
                                    ("from|since|after <time>December", -6.533061829540727),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.533061829540727),
                                    ("<time-of-day> am|pmon <day>", -4.518158808998462),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.533061829540727),
                                    ("yyyy-mm-ddhh:mm:ss", -6.127596721432562),
                                    ("Tax Daythis|last|next <cycle>", -6.533061829540727),
                                    ("dayday", -3.8250116284385163),
                                    ("<time> <part-of-day>at <time-of-day>", -6.127596721432562),
                                    ("mm/ddat <time-of-day>", -6.533061829540727),
                                    ("tonightat <time-of-day>", -5.839914648980781),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.839914648980781),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.533061829540727),
                                    ("today<time-of-day> am|pm", -6.533061829540727),
                                    ("Februarythe <day-of-month> (ordinal)", -6.127596721432562),
                                    ("at <time-of-day><time> <part-of-day>", -6.533061829540727),
                                    ("<day-of-month> (ordinal)intersect", -6.127596721432562),
                                    ("mm/dd<time-of-day> am|pm", -6.533061829540727),
                                    ("hourhour", -3.642690071644562),
                                    ("Mahavir Jayantiyear (latent)", -6.127596721432562),
                                    ("Navaratriin|during <named-month>|year", -6.533061829540727),
                                    ("Wednesdaythis|last|next <cycle>", -6.533061829540727),
                                    ("Lentyear (latent)", -6.533061829540727),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.661259652639135),
                                    ("Boghiyear (latent)", -6.533061829540727),
                                    ("dayyear", -1.8145629582456317),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.533061829540727),
                                    ("Thursdayfrom|since|after <time>", -6.127596721432562),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.533061829540727),
                                    ("Thursdayat <time-of-day>", -5.839914648980781),
                                    ("Islamic New Yearyear (latent)", -6.127596721432562),
                                    ("Laylat al-Qadryear (latent)", -5.616771097666572),
                                    ("part of days<time-of-day> am|pm", -6.533061829540727),
                                    ("Shrove Tuesdayyear (latent)", -6.533061829540727),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.839914648980781),
                                    ("hourminute", -6.127596721432562),
                                    ("<time-of-day> am|pmtomorrow", -5.839914648980781),
                                    ("Yom Kippuryear (latent)", -6.533061829540727),
                                    ("<day-of-month> (ordinal)Tuesday", -6.127596721432562),
                                    ("<part-of-day> of <time>year (latent)", -6.533061829540727),
                                    ("minutehour", -5.280298861045359),
                                    ("Kaanum Pongalyear (latent)", -6.127596721432562),
                                    ("Maha Saptamiyear (latent)", -6.533061829540727),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.839914648980781),
                                    ("time-of-day (latent)tomorrow", -5.616771097666572),
                                    ("part of daysat <time-of-day>", -4.923623917106626),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.518158808998462),
                                    ("for <duration> from <time>December", -6.533061829540727),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.533061829540727),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.280298861045359),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.280298861045359),
                                    ("time-of-day (latent)this <part-of-day>", -6.533061829540727),
                                    ("Pentecostyear (latent)", -6.533061829540727),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.280298861045359),
                                    ("<day-of-month> (ordinal)February", -6.533061829540727),
                                    ("Eid al-Fitryear (latent)", -5.146767468420836),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.533061829540727),
                                    ("Mondayin|during the <part-of-day>", -6.533061829540727),
                                    ("Chhathin|during <named-month>|year", -6.533061829540727),
                                    ("Diwaliin|during <named-month>|year", -6.533061829540727),
                                    ("this <part-of-day><time-of-day> am|pm", -6.533061829540727),
                                    ("Vaisakhiin|during <named-month>|year", -6.533061829540727),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.280298861045359),
                                    ("Raksha Bandhanyear (latent)", -6.533061829540727),
                                    ("daysecond", -6.127596721432562),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.127596721432562),
                                    ("Emancipation Dayyear (latent)", -5.839914648980781),
                                    ("Ratha-Yatrayear (latent)", -6.533061829540727),
                                    ("Ashurayear (latent)", -6.533061829540727),
                                    ("Tuesdayin|during <named-month>|year", -6.533061829540727),
                                    ("Chinese New Yearyear (latent)", -6.533061829540727),
                                    ("tomorrowintersect", -6.533061829540727),
                                    ("Lag BaOmeryear (latent)", -6.533061829540727),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.533061829540727),
                                    ("Eid al-Adhayear (latent)", -4.392995666044456),
                                    ("intersectin|during the <part-of-day>", -6.533061829540727),
                                    ("Palm Sundayyear (latent)", -6.533061829540727),
                                    ("Christmasat <time-of-day>", -6.533061829540727),
                                    ("Passoveryear (latent)", -6.533061829540727),
                                    ("Lazarus Saturdayyear (latent)", -6.533061829540727),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.533061829540727),
                                    ("Cyber Mondayyear (latent)", -6.127596721432562),
                                    ("hhhmmon <day>", -5.616771097666572),
                                    ("Yom HaShoahyear (latent)", -6.127596721432562),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.127596721432562),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.533061829540727),
                                    ("Septemberyear (latent)", -6.127596721432562),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.028984432764452),
                                    ("Halloweenyear (latent)", -6.533061829540727),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.533061829540727),
                                    ("at <time-of-day>intersect", -5.616771097666572),
                                    ("Rosh Hashanahyear (latent)", -5.839914648980781),
                                    ("Dhanterasyear (latent)", -6.533061829540727),
                                    ("Tu BiShvatyear (latent)", -6.533061829540727),
                                    ("<day-of-month> (ordinal)December", -5.839914648980781),
                                    ("Holiyear (latent)", -5.839914648980781),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.533061829540727),
                                    ("Holika Dahanyear (latent)", -5.839914648980781),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.127596721432562),
                                    ("dayminute", -3.1831577422661215),
                                    ("Mawlidyear (latent)", -6.533061829540727),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.127596721432562),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.533061829540727),
                                    ("Jumu'atul-Widayear (latent)", -5.616771097666572),
                                    ("minuteday", -2.795392211257358),
                                    ("absorption of , after named dayintersect",
                                     -5.839914648980781),
                                    ("intersectyear (latent)", -6.533061829540727),
                                    ("Orthodox Easter Sundayyear (latent)", -6.533061829540727),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.533061829540727),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.533061829540727),
                                    ("intersecthhhmm", -6.127596721432562),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.533061829540727),
                                    ("Boss's Dayyear (latent)", -6.127596721432562),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.533061829540727),
                                    ("Global Youth Service Dayyear (latent)", -6.533061829540727),
                                    ("Dhanterasin|during <named-month>|year", -6.533061829540727),
                                    ("Tisha B'Avyear (latent)", -6.533061829540727),
                                    ("Isra and Mi'rajyear (latent)", -5.616771097666572),
                                    ("at <time-of-day>on <day>", -4.923623917106626),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.127596721432562),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.839914648980781),
                                    ("Christmasyear (latent)", -6.127596721432562),
                                    ("Saturdayintersect", -6.533061829540727),
                                    ("Naraka Chaturdashiyear (latent)", -6.127596721432562),
                                    ("Thai Pongalin|during <named-month>|year", -6.533061829540727),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.533061829540727),
                                    ("dayweek", -6.533061829540727),
                                    ("Easter Sundayyear (latent)", -5.839914648980781),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.127596721432562),
                                    ("weekyear", -5.434449540872617),
                                    ("King's Dayyear (latent)", -5.028984432764452),
                                    ("hh:mmin|during the <part-of-day>", -5.616771097666572),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.127596721432562),
                                    ("Hanukkahyear (latent)", -5.839914648980781),
                                    ("Rama Navamiyear (latent)", -6.533061829540727),
                                    ("February<time> <part-of-day>", -6.533061829540727),
                                    ("National Grandparents Dayyear (latent)", -6.533061829540727),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.839914648980781),
                                    ("Great Lentyear (latent)", -6.533061829540727),
                                    ("tomorrowat <time-of-day>", -5.839914648980781),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.533061829540727),
                                    ("Labor Dayyear (latent)", -6.533061829540727),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.127596721432562),
                                    ("Ugadiyear (latent)", -5.146767468420836),
                                    ("Vaisakhiyear (latent)", -5.839914648980781),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.839914648980781),
                                    ("last <cycle> of <time>year (latent)", -5.839914648980781),
                                    ("at <time-of-day>tomorrow", -6.127596721432562),
                                    ("tomorrow<time-of-day> am|pm", -6.533061829540727),
                                    ("President's Dayyear (latent)", -6.533061829540727),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.533061829540727),
                                    ("Diwaliyear (latent)", -6.533061829540727),
                                    ("between <time> and <time>on <day>", -6.127596721432562),
                                    ("Black Fridayyear (latent)", -6.127596721432562),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.533061829540727),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.533061829540727),
                                    ("Chhathyear (latent)", -6.127596721432562),
                                    ("Vasant Panchamiyear (latent)", -6.533061829540727),
                                    ("Tax Dayyear (latent)", -5.616771097666572),
                                    ("Rabindra Jayantiyear (latent)", -5.280298861045359),
                                    ("this <part-of-day>at <time-of-day>", -5.280298861045359),
                                    ("St Patrick's Dayyear (latent)", -6.533061829540727),
                                    ("Thursday<time> (timezone)", -6.533061829540727),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.533061829540727),
                                    ("Pargat Diwasyear (latent)", -5.280298861045359),
                                    ("<datetime> - <datetime> (interval)July", -6.127596721432562),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.839914648980781),
                                    ("Februaryintersect", -6.533061829540727),
                                    ("Mother's Dayyear (latent)", -6.533061829540727),
                                    ("Simchat Torahyear (latent)", -6.533061829540727),
                                    ("minuteyear", -6.533061829540727)],
                               n = 531},
                   koData =
                     ClassData{prior = -1.02528101558256, unseen = -6.811244378601293,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.23219338683412766,
                               ...
                               n = 88},
                   koData =
                     ClassData{prior = -1.5740359853831845, unseen = -4.07753744390572,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6227247162633995, unseen = -4.852030263919617,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 125},
                   koData =
                     ClassData{prior = -0.7689072264414809, unseen = -4.709530201312334,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.567520967442536, unseen = -5.375278407684165,
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                     -4.677490847567718),
                                    ("dayhour", -4.272025739459553),
                                    ("daymonth", -2.235143812198513),
                                    ("<named-month> <day-of-month> (non ordinal)Friday",
                                     -4.677490847567718),
                                    ("Friday<named-month> <day-of-month> (non ordinal)",
                                     -3.4247278790723494),
                                    ("Wednesdayintersect", -4.677490847567718),
                                    ("Labor Daythis|last|next <cycle>", -4.677490847567718),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -3.2911964864478267),
                                    ("Black Fridaythis|last|next <cycle>", -4.677490847567718),
                                    ("<part-of-day> of <time>February", -4.677490847567718),
                                    ("Saturday<time-of-day> am|pm", -4.677490847567718),
                                    ("Martin Luther King's Daythis|last|next <cycle>",
                                     -4.272025739459553),
                                    ("hourmonth", -4.677490847567718),
                                    ("Fridayintersect by \",\", \"of\", \"from\" for year",
                                     -3.984343667007772),
                                    ("dayday", -2.426199048961222),
                                    ("the <day-of-month> (ordinal)February", -4.272025739459553),
                                    ("WednesdayOctober", -4.677490847567718),
                                    ("Wednesdaythis|last|next <cycle>", -4.272025739459553),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.4247278790723494),
                                    ("dayyear", -3.4247278790723494),
                                    ("Saturday<named-month> <day-of-month> (non ordinal)",
                                     -4.677490847567718),
                                    ("Thursdayhh:mm", -4.272025739459553),
                                    ("Thanksgiving Daythis|last|next <cycle>", -4.677490847567718),
                                    ("Memorial Daythis|last|next <cycle>", -4.677490847567718),
                                    ("TuesdayOctober", -4.677490847567718),
                                    ("the <day-of-month> (ordinal)March", -4.677490847567718),
                                    ("Mondaythis|last|next <cycle>", -3.984343667007772),
                                    ("Fridayintersect", -3.984343667007772),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.272025739459553),
                                    ("intersectOctober", -4.272025739459553),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.7612001156935624),
                                    ("Tuesdaythis|last|next <cycle>", -4.677490847567718),
                                    ("Sunday<named-month> <day-of-month> (non ordinal)",
                                     -4.677490847567718),
                                    ("dayminute", -2.8857313783396625),
                                    ("minuteday", -3.4247278790723494),
                                    ("this|last|next <cycle>Sunday", -4.677490847567718),
                                    ("Sundaythis|last|next <cycle>", -4.677490847567718),
                                    ("on <day><time-of-day> am|pm", -4.677490847567718),
                                    ("intersectintersect", -4.677490847567718),
                                    ("weekday", -4.677490847567718),
                                    ("dayweek", -3.578878558899608),
                                    ("Monday<named-month> <day-of-month> (non ordinal)",
                                     -4.272025739459553),
                                    ("<datetime> - <datetime> (interval)July", -3.7612001156935624),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -3.984343667007772)],
                               n = 72},
                   koData =
                     ClassData{prior = -0.8368539012261204, unseen = -5.204006687076795,
                               likelihoods =
                                 HashMap.fromList
