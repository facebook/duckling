...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6584616225720552, unseen = -5.583496308781699,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 264},
                   koData =
                     ClassData{prior = -0.7290791897860086,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47043015942921207,
                               unseen = -6.669498089857879,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -5.975081067857458),
                                    ("Father's Dayyear (latent)", -5.975081067857458),
                                    ("Ramadanyear (latent)", -5.975081067857458),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.72231809936209),
                                    ("Military Spouse Dayyear (latent)", -5.975081067857458),
                                    ...
                                    ("Vijayadashamiyear (latent)", -5.975081067857458),
                                    ...
                                    ("Maha Saptamiyear (latent)", -5.975081067857458),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.569615959749293),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.569615959749293),
                                    ("Navaratriin <named-month>|year", -5.975081067857458),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.975081067857458),
                                    ("Cyber Mondayyear (latent)", -5.569615959749293),
                                    ...
                                    ("National Grandparents Dayyear (latent)", -5.975081067857458),
                                    ...
                                    ("Labor Dayyear (latent)", -5.975081067857458),
                                    ...
                                    ("President's Dayyear (latent)", -5.975081067857458),
                               ...
                               n = 293},
                   koData =
                     ClassData{prior = -0.9801187734081275, unseen = -6.317164686747284,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.6222108209623896),
                                    ("hourday", -5.6222108209623896),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.6222108209623896),
                                    ("dayhour", -3.1798637855931853),
                                    ("daymonth", -3.542769279282554),
                                    ("monthday", -5.216745712854225),
                                    ("monthyear", -4.3694478524670215),
                                    ("<time-of-day> am|pmyear (latent)", -5.216745712854225),
                                    ("intersecthh:mm", -5.6222108209623896),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.6222108209623896),
                                    ("houryear", -4.7059200890882344),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.6222108209623896),
                                    ("until <time-of-day><time-of-day> am|pm", -5.6222108209623896),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.929063640402444),
                                    ("<time-of-day> am|pmintersect", -4.3694478524670215),
                                    ("Octoberyear (latent)", -5.6222108209623896),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.6222108209623896),
                                    ("absorption of , after named dayJuly", -5.216745712854225),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.7059200890882344),
                                    ("Clean Mondayyear (latent)", -5.6222108209623896),
                                    ("monthhour", -5.6222108209623896),
                                    ("hourmonth", -4.929063640402444),
                                    ("todayat <time-of-day>", -5.6222108209623896),
                                    ("from|since|after <time-of-day>July", -5.6222108209623896),
                                    ("Mondayyear (latent)", -4.5235985322942796),
                                    ("dayday", -5.216745712854225),
                                    ("mm/ddat <time-of-day>", -5.216745712854225),
                                    ("<time-of-day> am|pmon <date>", -4.3694478524670215),
                                    ("dayyear", -2.70444008887811),
                                    ("Thursdaymm/dd", -5.6222108209623896),
                                    ("New Year's Dayyear (latent)", -5.216745712854225),
                                    ("Thursdayat <time-of-day>", -4.3694478524670215),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.6222108209623896),
                                    ("Aprilyear (latent)", -5.6222108209623896),
                                    ("monthminute", -5.6222108209623896),
                                    ("<time-of-day> am|pmtomorrow", -5.6222108209623896),
                                    ("Thursdayhh:mm", -4.7059200890882344),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.6222108209623896),
                                    ("minutemonth", -3.8304513517343346),
                                    ("Sundayfrom|since|after <time-of-day>", -5.6222108209623896),
                                    ("week-endin <named-month>|year", -5.6222108209623896),
                                    ("Augustyear (latent)", -5.216745712854225),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.216745712854225),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.216745712854225),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.6222108209623896),
                                    ("Sundayyear (latent)", -4.929063640402444),
                                    ("Christmasat <time-of-day>", -5.6222108209623896),
                                    ("<duration> after|before|from <time>December",
                                     -5.6222108209623896),
                                    ("yesterday<time-of-day> am|pm", -5.6222108209623896),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.7059200890882344),
                                    ("mm/ddyear (latent)", -5.6222108209623896),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.216745712854225),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.6222108209623896),
                                    ("until <time-of-day>on <date>", -4.929063640402444),
                                    ("at <time-of-day>intersect", -5.216745712854225),
                                    ("hh:mmyear (latent)", -4.5235985322942796),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.6222108209623896),
                                    ("dayminute", -3.137304171174389),
                                    ("intersectSeptember", -4.118133424186115),
                                    ("minuteday", -2.5541578858287726),
                                    ("absorption of , after named dayintersect",
                                     -5.6222108209623896),
                                    ("Februaryin|during the <part-of-day>", -5.6222108209623896),
                                    ("hh:mmon <date>", -3.607307800420125),
                                    ("Saturdayyear (latent)", -5.6222108209623896),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.6222108209623896),
                                    ("absorption of , after named daySeptember",
                                     -4.7059200890882344),
                                    ("Naraka Chaturdashiyear (latent)", -5.6222108209623896),
                                    ("on <date>September", -5.216745712854225),
                                    ("at <time-of-day>on <date>", -5.216745712854225),
                                    ("in <named-month>|yearyear (latent)", -5.6222108209623896),
                                    ("dayweek", -5.6222108209623896),
                                    ("Easter Sundayyear (latent)", -5.216745712854225),
                                    ("Thursday<time-of-day> am|pm", -5.216745712854225),
                                    ("absorption of , after named dayFebruary",
                                     -4.7059200890882344),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.6222108209623896),
                                    ("tomorrowat <time-of-day>", -5.6222108209623896),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.6222108209623896),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.012772908528289),
                                    ("tomorrow<time-of-day> am|pm", -5.6222108209623896),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.929063640402444),
                                    ("Diwaliyear (latent)", -5.216745712854225),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.6222108209623896),
                                    ("Fridayyear (latent)", -5.216745712854225),
                                    ("minuteyear", -4.3694478524670215)],
                               n = 176}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.18081892690941961,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -5.35842461341064e-2),
                                    ("intersect 2 numbers", -3.3586377672433594)],
                               n = 111},
                   koData =
                     ClassData{prior = -1.7993066748634379, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
