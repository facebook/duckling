...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6003863010790546, unseen = -5.814130531825066,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 333},
                   koData =
                     ClassData{prior = -0.795400684671428, unseen = -5.62040086571715,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.44721690278838616,
                               unseen = -6.821107472256465,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.126869184114185),
                                    ("Father's Dayyear (latent)", -6.126869184114185),
                                    ("Ramadanyear (latent)", -6.126869184114185),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.874106215618817),
                                    ("Military Spouse Dayyear (latent)", -6.126869184114185),
                                    ("Bhai Doojyear (latent)", -6.126869184114185),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.874106215618817),
                                    ("hourday", -4.42212109187576), ("dayhour", -3.264668303184717),
                                    ("Martin Luther King's Dayyear (latent)", -5.721404076006021),
                                    ("Shemini Atzeretyear (latent)", -6.126869184114185),
                                    ("daymonth", -5.21057845224003),
                                    ("monthday", -5.721404076006021),
                                    ("monthyear", -4.33510971488613),
                                    ("Yom Ha'atzmautyear (latent)", -6.126869184114185),
                                    ("Vijayadashamiyear (latent)", -6.126869184114185),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -4.740574822994295),
                                    ("Thanksgiving Dayyear (latent)", -5.028256895446075),
                                    ("Thai Pongalyear (latent)", -5.43372200355424),
                                    ("Thiru Onamyear (latent)", -5.43372200355424),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.126869184114185),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.126869184114185),
                                    ("houryear", -5.43372200355424),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.126869184114185),
                                    ("Christmas<time-of-day> am|pm", -6.126869184114185),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.126869184114185),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.43372200355424),
                                    ("<time-of-day> am|pmintersect", -4.874106215618817),
                                    ("Earth Houryear (latent)", -6.126869184114185),
                                    ("Octoberyear (latent)", -4.622791787337911),
                                    ("intersect<time-of-day> am|pm", -6.126869184114185),
                                    ("Mattu Pongalyear (latent)", -6.126869184114185),
                                    ("Shavuotyear (latent)", -6.126869184114185),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.126869184114185),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.126869184114185),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.721404076006021),
                                    ("Marchyear (latent)", -6.126869184114185),
                                    ("Sukkotyear (latent)", -5.721404076006021),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.126869184114185),
                                    ("Clean Mondayyear (latent)", -5.721404076006021),
                                    ("monthhour", -5.721404076006021),
                                    ("todayat <time-of-day>", -6.126869184114185),
                                    ("Thursday<time> timezone", -4.180959035058872),
                                    ...
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.126869184114185),
                                    ("yyyy-mm-ddhh:mm:ss", -5.721404076006021),
                                    ("Tax Daythis|last|next <cycle>", -6.126869184114185),
                                    ("dayday", -4.11196616357192),
                                    ("<time> <part-of-day>at <time-of-day>", -6.126869184114185),
                                    ("mm/ddat <time-of-day>", -6.126869184114185),
                                    ("tonightat <time-of-day>", -6.126869184114185),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.43372200355424),
                                    ("today<time-of-day> am|pm", -6.126869184114185),
                                    ("Februarythe <day-of-month> (ordinal)", -5.721404076006021),
                                    ("at <time-of-day><time> <part-of-day>", -6.126869184114185),
                                    ("mm/dd<time-of-day> am|pm", -6.126869184114185),
                                    ("hourhour", -4.874106215618817),
                                    ("<time-of-day> am|pmon <date>", -4.11196616357192),
                                    ("Navaratriin|during <named-month>|year", -6.126869184114185),
                                    ("Wednesdaythis|last|next <cycle>", -6.126869184114185),
                                    ("Lentyear (latent)", -6.126869184114185),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.622791787337911),
                                    ("Boghiyear (latent)", -6.126869184114185),
                                    ("dayyear", -1.871256474295962),
                                    ("Thursdayfrom|since|after <time>", -5.721404076006021),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.126869184114185),
                                    ("Thursdayat <time-of-day>", -5.43372200355424),
                                    ("Islamic New Yearyear (latent)", -5.721404076006021),
                                    ("Laylat al-Qadryear (latent)", -5.21057845224003),
                                    ("Shrove Tuesdayyear (latent)", -6.126869184114185),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.43372200355424),
                                    ("<time-of-day> am|pmtomorrow", -5.43372200355424),
                                    ("Yom Kippuryear (latent)", -6.126869184114185),
                                    ("<part-of-day> of <time>year (latent)", -6.126869184114185),
                                    ("minutehour", -5.21057845224003),
                                    ("Kaanum Pongalyear (latent)", -5.721404076006021),
                                    ("Maha Saptamiyear (latent)", -6.126869184114185),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.721404076006021),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.42212109187576),
                                    ("for <duration> from <time>December", -6.126869184114185),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.126869184114185),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.21057845224003),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.721404076006021),
                                    ("Pentecostyear (latent)", -6.126869184114185),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.21057845224003),
                                    ("Eid al-Fitryear (latent)", -6.126869184114185),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.126869184114185),
                                    ("Mondayin|during the <part-of-day>", -6.126869184114185),
                                    ("Chhathin|during <named-month>|year", -6.126869184114185),
                                    ("Diwaliin|during <named-month>|year", -6.126869184114185),
                                    ("Vaisakhiin|during <named-month>|year", -6.126869184114185),
                                    ("Raksha Bandhanyear (latent)", -6.126869184114185),
                                    ("daysecond", -5.721404076006021),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.721404076006021),
                                    ("Emancipation Dayyear (latent)", -5.43372200355424),
                                    ("Ashurayear (latent)", -6.126869184114185),
                                    ("Tuesdayin|during <named-month>|year", -6.126869184114185),
                                    ("Chinese New Yearyear (latent)", -6.126869184114185),
                                    ("Lag BaOmeryear (latent)", -6.126869184114185),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.126869184114185),
                                    ("Eid al-Adhayear (latent)", -5.21057845224003),
                                    ("intersectin|during the <part-of-day>", -6.126869184114185),
                                    ("Palm Sundayyear (latent)", -6.126869184114185),
                                    ("Christmasat <time-of-day>", -6.126869184114185),
                                    ("Passoveryear (latent)", -6.126869184114185),
                                    ("Lazarus Saturdayyear (latent)", -6.126869184114185),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.126869184114185),
                                    ("Cyber Mondayyear (latent)", -5.721404076006021),
                                    ("Yom HaShoahyear (latent)", -5.721404076006021),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.721404076006021),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.126869184114185),
                                    ("Septemberyear (latent)", -5.721404076006021),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.874106215618817),
                                    ("Halloweenyear (latent)", -6.126869184114185),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.126869184114185),
                                    ("at <time-of-day>intersect", -5.721404076006021),
                                    ("Rosh Hashanahyear (latent)", -5.43372200355424),
                                    ("Dhanterasyear (latent)", -6.126869184114185),
                                    ("Tu BiShvatyear (latent)", -6.126869184114185),
                                    ("Holiyear (latent)", -5.43372200355424),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.126869184114185),
                                    ("Holika Dahanyear (latent)", -5.43372200355424),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.126869184114185),
                                    ("dayminute", -3.386029160188984),
                                    ("Mawlidyear (latent)", -6.126869184114185),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.721404076006021),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.126869184114185),
                                    ("Jumu'atul-Widayear (latent)", -5.21057845224003),
                                    ("minuteday", -2.4892830243877992),
                                    ("absorption of , after named dayintersect",
                                     -6.126869184114185),
                                    ("Orthodox Easter Sundayyear (latent)", -6.126869184114185),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.126869184114185),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.126869184114185),
                                    ("Boss's Dayyear (latent)", -5.721404076006021),
                                    ("Global Youth Service Dayyear (latent)", -6.126869184114185),
                                    ("Dhanterasin|during <named-month>|year", -6.126869184114185),
                                    ("Tisha B'Avyear (latent)", -6.126869184114185),
                                    ("Isra and Mi'rajyear (latent)", -5.21057845224003),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.126869184114185),
                                    ("Christmasyear (latent)", -5.721404076006021),
                                    ("Naraka Chaturdashiyear (latent)", -5.721404076006021),
                                    ("at <time-of-day>on <date>", -5.028256895446075),
                                    ("Thai Pongalin|during <named-month>|year", -6.126869184114185),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.126869184114185),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.517431271680085),
                                    ("dayweek", -6.126869184114185),
                                    ("Easter Sundayyear (latent)", -5.43372200355424),
                                    ("weekyear", -5.028256895446075),
                                    ("hh:mmin|during the <part-of-day>", -5.43372200355424),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.721404076006021),
                                    ("Hanukkahyear (latent)", -5.43372200355424),
                                    ("February<time> <part-of-day>", -6.126869184114185),
                                    ("National Grandparents Dayyear (latent)", -6.126869184114185),
                                    ("Great Lentyear (latent)", -6.126869184114185),
                                    ("tomorrowat <time-of-day>", -5.43372200355424),
                                    ("Labor Dayyear (latent)", -6.126869184114185),
                                    ("between <time> and <time>on <date>", -4.517431271680085),
                                    ("Vaisakhiyear (latent)", -5.43372200355424),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.126869184114185),
                                    ("last <cycle> of <time>year (latent)", -5.43372200355424),
                                    ("at <time-of-day>tomorrow", -5.721404076006021),
                                    ("tomorrow<time-of-day> am|pm", -6.126869184114185),
                                    ("President's Dayyear (latent)", -6.126869184114185),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.126869184114185),
                                    ("Diwaliyear (latent)", -6.126869184114185),
                                    ("Black Fridayyear (latent)", -5.721404076006021),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.126869184114185),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.126869184114185),
                                    ("Chhathyear (latent)", -5.721404076006021),
                                    ("Vasant Panchamiyear (latent)", -6.126869184114185),
                                    ("Tax Dayyear (latent)", -5.21057845224003),
                                    ("Thursday<time> (timezone)", -6.126869184114185),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.126869184114185),
                                    ("Februaryintersect", -6.126869184114185),
                                    ("Mother's Dayyear (latent)", -6.126869184114185),
                                    ("Simchat Torahyear (latent)", -6.126869184114185),
                                    ("minuteyear", -6.126869184114185)],
                               n = 344},
                   koData =
                     ClassData{prior = -1.0200004010984562, unseen = -6.424869023905388,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.81380905109942),
                                    ...
                                    ("<time-of-day> am|pmon <date>", -4.477336814478207),
                                    ...
                                    ("hh:mmyear (latent)", -4.631487494305465),
                                    ...
                                    ("hh:mmon <date>", -3.71519676243131),
                                    ("Saturdayyear (latent)", -5.730099782973574),
                                    ("from|since|after <time>on <date>", -4.81380905109942),
                                    ("absorption of , after named daySeptember", -4.81380905109942),
                                    ("Naraka Chaturdashiyear (latent)", -5.730099782973574),
                                    ("on <date>September", -5.32463467486541),
                                    ("at <time-of-day>on <date>", -5.32463467486541),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1283094486433709, unseen = -5.153291594497779,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.550668845690976e-2),
                                    ("intersect 2 numbers", -3.7612001156935624)],
                               n = 168},
                   koData =
                     ClassData{prior = -2.11677921211748, unseen = -3.332204510175204,
                               likelihoods =
                                 HashMap.fromList
