...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5928244589320762, unseen = -6.091309882077698,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 440},
                   koData =
                     ClassData{prior = -0.8046684549923526, unseen = -5.8805329864007,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4727173351173319, unseen = -7.091742115095153,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.397762641520038),
                                    ...
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.397762641520038),
                                    ("Ramadanyear (latent)", -5.481471909645883),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.382859620977774),
                                    ("Military Spouse Dayyear (latent)", -6.397762641520038),
                                    ("Bhai Doojyear (latent)", -6.397762641520038),
                                    ("hourday", -4.382859620977774),
                                    ("dayhour", -3.453323662353598),
                                    ...
                                    ("daymonth", -4.382859620977774),
                                    ("monthday", -5.9922975334118735),
                                    ...
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.397762641520038),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.481471909645883),
                                    ("<day-of-month> (ordinal)Wednesday", -6.397762641520038),
                                    ...
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.704615460960093),
                                    ("intersectin|during <named-month>|year", -6.397762641520038),
                                    ...
                                    ("Daylight Saving Start Dayyear (latent)", -5.481471909645883),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.9922975334118735),
                                    ("Daylight Saving End Dayyear (latent)", -5.481471909645883),
                                    ("Clean Mondayyear (latent)", -5.9922975334118735),
                                    ("monthhour", -5.9922975334118735),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.704615460960093),
                                    ("todayat <time-of-day>", -6.397762641520038),
                                    ("Thursday<time> timezone", -4.451852492464725),
                                    ("time-of-day (latent)tonight", -5.9922975334118735),
                                    ("from|since|after <time>December", -6.397762641520038),
                                    ...
                                    ("Tax Daythis|last|next <cycle>", -6.397762641520038),
                                    ("dayday", -3.955415606150834),
                                    ("<time> <part-of-day>at <time-of-day>", -6.397762641520038),
                                    ("mm/ddat <time-of-day>", -6.397762641520038),
                                    ("tonightat <time-of-day>", -6.397762641520038),
                                    ...
                                    ("Februarythe <day-of-month> (ordinal)", -5.9922975334118735),
                                    ("at <time-of-day><time> <part-of-day>", -6.397762641520038),
                                    ("<day-of-month> (ordinal)intersect", -5.9922975334118735),
                                    ("mm/dd<time-of-day> am|pm", -6.397762641520038),
                                    ("hourhour", -4.318321099840202),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.704615460960093),
                                    ("<time-of-day> am|pmtomorrow", -5.704615460960093),
                                    ("Yom Kippuryear (latent)", -6.397762641520038),
                                    ("<day-of-month> (ordinal)Tuesday", -5.9922975334118735),
                                    ...
                                    ("part of daysat <time-of-day>", -5.9922975334118735),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.14499967302467),
                                    ("<day-of-month> (ordinal)February", -6.397762641520038),
                                    ("Eid al-Fitryear (latent)", -5.481471909645883),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.9922975334118735),
                                    ("Emancipation Dayyear (latent)", -5.704615460960093),
                                    ...
                                    ("intersectin|during the <part-of-day>", -6.397762641520038),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.397762641520038),
                                    ("Cyber Mondayyear (latent)", -5.9922975334118735),
                                    ...
                                    ("minuteday", -2.569121245030943),
                                    ("absorption of , after named dayintersect",
                                     -6.397762641520038),
                                    ("intersectyear (latent)", -6.397762641520038),
                                    ...
                                    ("at <time-of-day>on <day>", -5.299150352851928),
                                    ...
                                    ("National Grandparents Dayyear (latent)", -6.397762641520038),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.397762641520038),
                                    ...
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.397762641520038),
                                    ("Labor Dayyear (latent)", -6.397762641520038),
                                    ...
                                    ("President's Dayyear (latent)", -6.397762641520038),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.397762641520038),
                                    ("Diwaliyear (latent)", -6.397762641520038),
                                    ("between <time> and <time>on <day>", -4.788324729085938),
                                    ...
                                    ("Tax Dayyear (latent)", -5.481471909645883),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.397762641520038),
                                    ("<datetime> - <datetime> (interval)July", -5.9922975334118735),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.9922975334118735),
                                    ("Februaryintersect", -6.397762641520038),
                                    ("Mother's Dayyear (latent)", -6.397762641520038),
                                    ("Simchat Torahyear (latent)", -6.397762641520038),
                                    ("minuteyear", -6.397762641520038)],
                               n = 460},
                   koData =
                     ClassData{prior = -0.9763227109098355, unseen = -6.731018100482083,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.146305132033365),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.03667688992953),
                                    ("<day-of-month> (ordinal)August", -6.03667688992953),
                                    ("dayhour", -3.3625282405030013),
                                    ("<time> timezoneyear (latent)", -6.03667688992953),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.120386158055375),
                                    ("Tuesdayfrom|since|after <time>", -5.343529709369585),
                                    ("daymonth", -3.5517702401415296),
                                    ...
                                    ("hh:mmon <day>", -3.5943298545603257),
                                    ("absorption of , after named dayJuly", -5.631211781821365),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.03667688992953),
                                    ("at <time-of-day>intersect", -5.631211781821365),
                                    ("hh:mmyear (latent)", -3.9572353482496943),
                                    ...
                                    ("at <time-of-day>on <day>", -5.631211781821365),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.649209701079277),
                                    ("integer (0..19)year (grain)", -3.0910424533583156),
                                    ...
                                    ("integer (numeric)year (grain)", -3.2088254890146994),
                                    ("day", -2.3978952727983707), ("year", -2.515678308454754),
