...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7474815315232748, unseen = -5.293304824724492,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 197},
                   koData =
                     ClassData{prior = -0.6416135304447624,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4909103140650493, unseen = -6.354370040797351,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("Thanksgiving Dayyear", -4.560869927091511),
                                    ...
                                    ("mm/dd<time-of-day> am|pm", -5.659482215759621),
                                    ...
                                    ("Mother's Dayyear", -5.659482215759621),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.254017107651457),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.254017107651457),
                                    ("National Grandparents Dayyear", -5.659482215759621),
                                    ...
                                    ("Cyber Mondayyear", -5.254017107651457),
                                    ...
                                    ("Father's Dayyear", -5.659482215759621),
                                    ...
                                    ("Military Spouse Dayyear", -5.659482215759621),
                                    ...
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.659482215759621),
                                    ("Labor Dayyear", -5.659482215759621),
                                    ("Februaryintersect", -5.659482215759621),
                                    ("last <cycle> of <time>year", -4.966335035199676),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.659482215759621),
                                    ("President's Dayyear", -5.659482215759621),
                                    ("yearminute", -5.659482215759621),
                                    ("Black Fridayyear", -5.254017107651457)],
                               n = 213},
                   koData =
                     ClassData{prior = -0.9469277013360449, unseen = -6.037870919922137,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.342334251964811),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.342334251964811),
                                    ("hourday", -5.342334251964811),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.342334251964811),
                                    ("dayhour", -2.8999872165956067),
                                    ("daymonth", -3.262892710284975),
                                    ("monthday", -4.936869143856646),
                                    ("monthyear", -4.6491870714048655),
                                    ("intersecthh:mm", -5.342334251964811),
                                    ("Easter Sundayyear", -5.342334251964811),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.342334251964811),
                                    ("houryear", -5.342334251964811),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.342334251964811),
                                    ("until <time-of-day><time-of-day> am|pm", -5.342334251964811),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.6491870714048655),
                                    ("<time-of-day> am|pmintersect", -4.089571283469443),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.426043520090656),
                                    ("from|since|after <time-of-day>on <date>", -4.426043520090656),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.342334251964811),
                                    ("absorption of , after named dayJuly", -4.936869143856646),
                                    ("monthhour", -5.342334251964811),
                                    ("hourmonth", -4.6491870714048655),
                                    ("todayat <time-of-day>", -5.342334251964811),
                                    ("from|since|after <time-of-day>July", -5.342334251964811),
                                    ("dayday", -4.936869143856646),
                                    ("mm/ddat <time-of-day>", -4.936869143856646),
                                    ("<time-of-day> am|pmon <date>", -4.089571283469443),
                                    ("dayyear", -3.550574782736756),
                                    ("Thursdaymm/dd", -5.342334251964811),
                                    ("Sundayyear", -4.936869143856646),
                                    ("Thursdayat <time-of-day>", -4.089571283469443),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.342334251964811),
                                    ("monthminute", -5.342334251964811),
                                    ("<time-of-day> am|pmtomorrow", -5.342334251964811),
                                    ("Thursdayhh:mm", -4.426043520090656),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.342334251964811),
                                    ("Fridayyear", -4.936869143856646),
                                    ("minutemonth", -3.550574782736756),
                                    ("Sundayfrom|since|after <time-of-day>", -5.342334251964811),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.936869143856646),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.936869143856646),
                                    ("Aprilyear", -5.342334251964811),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -4.936869143856646),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.342334251964811),
                                    ("Christmasat <time-of-day>", -5.342334251964811),
                                    ("<duration> after|before|from <time>December",
                                     -5.342334251964811),
                                    ("yesterday<time-of-day> am|pm", -5.342334251964811),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.342334251964811),
                                    ("until <time-of-day>on <date>", -4.6491870714048655),
                                    ("Mondayyear", -4.936869143856646),
                                    ("at <time-of-day>intersect", -4.936869143856646),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.342334251964811),
                                    ("dayminute", -2.8166056076565558),
                                    ("intersectSeptember", -3.8382568551885368),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.342334251964811),
                                    ("minuteday", -2.424563519880532),
                                    ("absorption of , after named dayintersect",
                                     -5.342334251964811),
                                    ("Februaryin|during the <part-of-day>", -5.342334251964811),
                                    ("week-endin <named-month>", -5.342334251964811),
                                    ("Octoberyear", -5.342334251964811),
                                    ("from|since|after <time-of-day>year", -5.342334251964811),
                                    ("yearhh:mm", -5.342334251964811),
                                    ("hh:mmon <date>", -3.8382568551885368),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.342334251964811),
                                    ("absorption of , after named daySeptember",
                                     -4.426043520090656),
                                    ("on <date>September", -4.936869143856646),
                                    ("at <time-of-day>on <date>", -4.936869143856646),
                                    ("dayweek", -5.342334251964811),
                                    ("Thursday<time-of-day> am|pm", -4.936869143856646),
                                    ("absorption of , after named dayFebruary", -4.426043520090656),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.342334251964811),
                                    ("tomorrowat <time-of-day>", -5.342334251964811),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.342334251964811),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.7328963395307104),
                                    ("tomorrow<time-of-day> am|pm", -5.342334251964811),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.342334251964811),
                                    ("yearminute", -5.342334251964811)],
                               n = 135}}),
       ("one eleven",
        Classifier{okData =
