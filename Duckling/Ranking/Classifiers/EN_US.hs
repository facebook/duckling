...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46011053118697426,
                               unseen = -7.261927092702751,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.568077911411976),
                                    ("Father's Dayyear (latent)", -6.568077911411976),
                                    ("Karva Chauthyear (latent)", -6.568077911411976),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.568077911411976),
                                    ("Maha Shivaratriyear (latent)", -6.568077911411976),
                                    ("Ramadanyear (latent)", -5.315314942916608),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.181783550292085),
                                    ("Military Spouse Dayyear (latent)", -6.568077911411976),
                                    ("Bhai Doojyear (latent)", -6.568077911411976),
                                    ("hourday", -4.553174890869711),
                                    ("dayhour", -3.5476530252676133),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.181783550292085),
                                    ("Martin Luther King's Dayyear (latent)", -6.162612803303811),
                                    ("Shemini Atzeretyear (latent)", -6.568077911411976),
                                    ("daymonth", -4.553174890869711),
                                    ("monthday", -6.162612803303811),
                                    ("monthyear", -4.77631844218392),
                                    ("Yom Ha'atzmautyear (latent)", -6.568077911411976),
                                    ("Orthodox Good Fridayyear (latent)", -6.162612803303811),
                                    ("Vijayadashamiyear (latent)", -6.568077911411976),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.181783550292085),
                                    ("Thanksgiving Dayyear (latent)", -5.469465622743866),
                                    ("Thai Pongalyear (latent)", -5.87493073085203),
                                    ("Thiru Onamyear (latent)", -5.87493073085203),
                                    ("hhhmmabsorption of , after named day", -6.568077911411976),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.568077911411976),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.651787179537821),
                                    ("<day-of-month> (ordinal)Wednesday", -6.568077911411976),
                                    ("Krishna Janmashtamiyear (latent)", -6.162612803303811),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.568077911411976),
                                    ("houryear", -5.651787179537821),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.568077911411976),
                                    ("Christmas<time-of-day> am|pm", -6.568077911411976),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.568077911411976),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.87493073085203),
                                    ("intersectin|during <named-month>|year", -6.568077911411976),
                                    ("<time-of-day> am|pmintersect", -5.315314942916608),
                                    ("Earth Houryear (latent)", -6.568077911411976),
                                    ("Ganesh Chaturthiyear (latent)", -6.568077911411976),
                                    ("Octoberyear (latent)", -5.064000514635702),
                                    ("intersect<time-of-day> am|pm", -6.568077911411976),
                                    ("Mattu Pongalyear (latent)", -6.568077911411976),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.568077911411976),
                                    ("Daylight Saving Start Dayyear (latent)", -5.651787179537821),
                                    ("Shavuotyear (latent)", -6.568077911411976),
                                    ("Parsi New Yearyear (latent)", -5.651787179537821),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.568077911411976),
                                    ("the <day-of-month> (ordinal)intersect by \",\", \"of\", \"from\" for year",
                                     -6.568077911411976),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.568077911411976),
                                    ("todayin|within|after <duration>", -6.568077911411976),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.162612803303811),
                                    ("Marchyear (latent)", -6.568077911411976),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.162612803303811),
                                    ("Sukkotyear (latent)", -6.162612803303811),
                                    ("hhhmmintersect", -6.162612803303811),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.162612803303811),
                                    ("Daylight Saving End Dayyear (latent)", -5.651787179537821),
                                    ("Clean Mondayyear (latent)", -6.162612803303811),
                                    ("the <day-of-month> (ordinal)Sunday", -6.568077911411976),
                                    ("monthhour", -6.162612803303811),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.87493073085203),
                                    ("todayat <time-of-day>", -6.568077911411976),
                                    ("Thursday<time> timezone", -4.170182638613605),
                                    ("tonight<time-of-day> am|pm", -6.568077911411976),
                                    ("time-of-day (latent)tonight", -6.162612803303811),
                                    ("from|since|after <time>December", -6.568077911411976),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.568077911411976),
                                    ("<time-of-day> am|pmon <day>", -4.553174890869711),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.568077911411976),
                                    ("yyyy-mm-ddhh:mm:ss", -6.162612803303811),
                                    ("Tax Daythis|last|next <cycle>", -6.568077911411976),
                                    ("dayday", -3.7954891891721947),
                                    ("<time> <part-of-day>at <time-of-day>", -6.162612803303811),
                                    ("mm/ddat <time-of-day>", -6.568077911411976),
                                    ("tonightat <time-of-day>", -5.469465622743866),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.87493073085203),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.568077911411976),
                                    ("today<time-of-day> am|pm", -6.568077911411976),
                                    ("Februarythe <day-of-month> (ordinal)", -6.162612803303811),
                                    ("at <time-of-day><time> <part-of-day>", -6.568077911411976),
                                    ("<day-of-month> (ordinal)intersect", -6.162612803303811),
                                    ("mm/dd<time-of-day> am|pm", -6.568077911411976),
                                    ("hourhour", -3.5976634458422745),
                                    ("Mahavir Jayantiyear (latent)", -6.162612803303811),
                                    ("Navaratriin|during <named-month>|year", -6.568077911411976),
                                    ("Wednesdaythis|last|next <cycle>", -6.568077911411976),
                                    ("Lentyear (latent)", -6.568077911411976),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.696275734510384),
                                    ("Boghiyear (latent)", -6.568077911411976),
                                    ("dayyear", -1.801639577827762),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.568077911411976),
                                    ("Thursdayfrom|since|after <time>", -6.162612803303811),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.568077911411976),
                                    ("Thursdayat <time-of-day>", -5.87493073085203),
                                    ("Islamic New Yearyear (latent)", -6.162612803303811),
                                    ("Laylat al-Qadryear (latent)", -5.651787179537821),
                                    ("part of days<time-of-day> am|pm", -6.568077911411976),
                                    ("Shrove Tuesdayyear (latent)", -6.568077911411976),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.87493073085203),
                                    ("hourminute", -6.162612803303811),
                                    ("<time-of-day> am|pmtomorrow", -5.87493073085203),
                                    ("Yom Kippuryear (latent)", -6.568077911411976),
                                    ("<day-of-month> (ordinal)Tuesday", -6.162612803303811),
                                    ("<part-of-day> of <time>year (latent)", -6.568077911411976),
                                    ("minutehour", -5.315314942916608),
                                    ("Kaanum Pongalyear (latent)", -6.162612803303811),
                                    ("Maha Saptamiyear (latent)", -6.568077911411976),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.87493073085203),
                                    ("time-of-day (latent)tomorrow", -5.651787179537821),
                                    ("part of daysat <time-of-day>", -4.958639998977875),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.553174890869711),
                                    ("for <duration> from <time>December", -6.568077911411976),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.568077911411976),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.315314942916608),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.315314942916608),
                                    ("time-of-day (latent)this <part-of-day>", -6.568077911411976),
                                    ("Pentecostyear (latent)", -6.568077911411976),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.315314942916608),
                                    ("<day-of-month> (ordinal)February", -6.568077911411976),
                                    ("Eid al-Fitryear (latent)", -5.181783550292085),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.568077911411976),
                                    ("Mini-Tuesday<duration> hence|ago", -6.568077911411976),
                                    ("Mondayin|during the <part-of-day>", -6.568077911411976),
                                    ("Chhathin|during <named-month>|year", -6.568077911411976),
                                    ("Diwaliin|during <named-month>|year", -6.568077911411976),
                                    ("this <part-of-day><time-of-day> am|pm", -6.568077911411976),
                                    ("Vaisakhiin|during <named-month>|year", -6.568077911411976),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.315314942916608),
                                    ("Raksha Bandhanyear (latent)", -6.568077911411976),
                                    ("daysecond", -6.162612803303811),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.162612803303811),
                                    ("Emancipation Dayyear (latent)", -5.87493073085203),
                                    ("Ratha-Yatrayear (latent)", -6.568077911411976),
                                    ("Ashurayear (latent)", -6.568077911411976),
                                    ("Tuesdayin|during <named-month>|year", -6.568077911411976),
                                    ("Chinese New Yearyear (latent)", -6.568077911411976),
                                    ("tomorrowintersect", -6.568077911411976),
                                    ("Lag BaOmeryear (latent)", -6.568077911411976),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.568077911411976),
                                    ("Eid al-Adhayear (latent)", -4.428011747915705),
                                    ("intersectin|during the <part-of-day>", -6.568077911411976),
                                    ("Palm Sundayyear (latent)", -6.568077911411976),
                                    ("Christmasat <time-of-day>", -6.568077911411976),
                                    ("Passoveryear (latent)", -6.568077911411976),
                                    ("Lazarus Saturdayyear (latent)", -6.568077911411976),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.568077911411976),
                                    ("Cyber Mondayyear (latent)", -6.162612803303811),
                                    ("hhhmmon <day>", -5.651787179537821),
                                    ("Yom HaShoahyear (latent)", -6.162612803303811),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.162612803303811),
                                    ("Septemberyear (latent)", -6.162612803303811),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.064000514635702),
                                    ("Halloweenyear (latent)", -6.568077911411976),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.568077911411976),
                                    ("at <time-of-day>intersect", -5.651787179537821),
                                    ("Rosh Hashanahyear (latent)", -5.87493073085203),
                                    ("Super Tuesdayyear (latent)", -5.651787179537821),
                                    ("Dhanterasyear (latent)", -6.568077911411976),
                                    ("Tu BiShvatyear (latent)", -6.568077911411976),
                                    ("<day-of-month> (ordinal)December", -5.87493073085203),
                                    ("Holiyear (latent)", -5.87493073085203),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.568077911411976),
                                    ("Holika Dahanyear (latent)", -5.87493073085203),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.162612803303811),
                                    ("dayminute", -3.218173824137371),
                                    ("Mawlidyear (latent)", -6.568077911411976),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.162612803303811),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.568077911411976),
                                    ("Jumu'atul-Widayear (latent)", -5.651787179537821),
                                    ("minuteday", -2.8304082931286074),
                                    ("absorption of , after named dayintersect", -5.87493073085203),
                                    ("intersectyear (latent)", -6.568077911411976),
                                    ("Orthodox Easter Sundayyear (latent)", -6.568077911411976),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.568077911411976),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.568077911411976),
                                    ("Mini-Tuesdayyear (latent)", -6.568077911411976),
                                    ("intersecthhhmm", -6.162612803303811),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.568077911411976),
                                    ("Boss's Dayyear (latent)", -6.162612803303811),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.568077911411976),
                                    ("Global Youth Service Dayyear (latent)", -6.568077911411976),
                                    ("Dhanterasin|during <named-month>|year", -6.568077911411976),
                                    ("Super Tuesdayin|during <named-month>|year",
                                     -6.568077911411976),
                                    ("tonight<time-of-day> o'clock", -6.568077911411976),
                                    ("Tisha B'Avyear (latent)", -6.568077911411976),
                                    ("Isra and Mi'rajyear (latent)", -5.651787179537821),
                                    ("at <time-of-day>on <day>", -4.958639998977875),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.162612803303811),
                                    ("time-of-day (latent)<time> <part-of-day>", -5.87493073085203),
                                    ("Christmasyear (latent)", -6.162612803303811),
                                    ("Saturdayintersect", -6.568077911411976),
                                    ("Naraka Chaturdashiyear (latent)", -6.162612803303811),
                                    ("Thai Pongalin|during <named-month>|year", -6.568077911411976),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.568077911411976),
                                    ("dayweek", -6.568077911411976),
                                    ("Easter Sundayyear (latent)", -5.87493073085203),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.162612803303811),
                                    ("weekyear", -5.469465622743866),
                                    ("Super Tuesdaythis|last|next <cycle>", -6.568077911411976),
                                    ("King's Dayyear (latent)", -5.064000514635702),
                                    ("hh:mmin|during the <part-of-day>", -5.651787179537821),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.162612803303811),
                                    ("Hanukkahyear (latent)", -5.87493073085203),
                                    ("Rama Navamiyear (latent)", -6.568077911411976),
                                    ("February<time> <part-of-day>", -6.568077911411976),
                                    ("National Grandparents Dayyear (latent)", -6.568077911411976),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.87493073085203),
                                    ("Great Lentyear (latent)", -6.568077911411976),
                                    ("tomorrowat <time-of-day>", -5.87493073085203),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.568077911411976),
                                    ("Labor Dayyear (latent)", -6.568077911411976),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.162612803303811),
                                    ("Ugadiyear (latent)", -5.181783550292085),
                                    ("Vaisakhiyear (latent)", -5.87493073085203),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.87493073085203),
                                    ("last <cycle> of <time>year (latent)", -5.87493073085203),
                                    ("at <time-of-day>tomorrow", -6.162612803303811),
                                    ("tomorrow<time-of-day> am|pm", -6.568077911411976),
                                    ("President's Dayyear (latent)", -6.568077911411976),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.568077911411976),
                                    ("Diwaliyear (latent)", -6.568077911411976),
                                    ("between <time> and <time>on <day>", -6.162612803303811),
                                    ("Black Fridayyear (latent)", -6.162612803303811),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.568077911411976),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.568077911411976),
                                    ("Chhathyear (latent)", -6.162612803303811),
                                    ("Vasant Panchamiyear (latent)", -6.568077911411976),
                                    ("Tax Dayyear (latent)", -5.469465622743866),
                                    ("Rabindra Jayantiyear (latent)", -5.315314942916608),
                                    ("this <part-of-day>at <time-of-day>", -5.315314942916608),
                                    ("St Patrick's Dayyear (latent)", -6.568077911411976),
                                    ("Thursday<time> (timezone)", -6.568077911411976),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.568077911411976),
                                    ("Pargat Diwasyear (latent)", -5.315314942916608),
                                    ("<datetime> - <datetime> (interval)July", -6.162612803303811),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.87493073085203),
                                    ("Februaryintersect", -6.568077911411976),
                                    ("Mother's Dayyear (latent)", -6.568077911411976),
                                    ("Simchat Torahyear (latent)", -6.568077911411976),
                                    ("minuteyear", -6.568077911411976)],
                               n = 546},
                   koData =
                     ClassData{prior = -0.9975384041470348, unseen = -6.878326468291325,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.680071494161209),
                                    ("hourday", -3.7862536181391127),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.184148890937483),
                                    ("<day-of-month> (ordinal)August", -6.184148890937483),
                                    ("dayhour", -3.5100002415109546),
                                    ("<time> timezoneyear (latent)", -5.491001710377538),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.267858159063328),
                                    ("Tuesdayfrom|since|after <time>", -5.085536602269373),
                                    ("daymonth", -3.4760986898352733),
                                    ("monthyear", -4.931385922442115),
                                    ("<time-of-day> am|pmyear (latent)", -5.491001710377538),
                                    ("Thai Pongalyear (latent)", -5.491001710377538),
                                    ("intersecthh:mm", -6.184148890937483),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.778683782829319),
                                    ("<datetime> - <datetime> (interval)Sunday",
                                     -5.778683782829319),
                                    ("<day-of-month> (ordinal)Wednesday", -6.184148890937483),
                                    ("houryear", -4.7978545298175925),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.184148890937483),
                                    ("<day-of-month> (ordinal)October", -6.184148890937483),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.491001710377538),
                                    ("hournograin", -4.931385922442115),
                                    ("<time-of-day> am|pmintersect", -4.931385922442115),
                                    ("Octoberyear (latent)", -6.184148890937483),
                                    ("Good Fridayyear (latent)", -5.778683782829319),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.778683782829319),
                                    ("early morningat <time-of-day>", -6.184148890937483),
                                    ("until <time>on <day>", -5.491001710377538),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.184148890937483),
                                    ("time-of-day (latent)intersect", -5.491001710377538),
                                    ("todayin <number> (implicit minutes)", -6.184148890937483),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.491001710377538),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.184148890937483),
                                    ("hh:mmon <day>", -4.931385922442115),
                                    ("hhhmmintersect", -5.778683782829319),
                                    ("absorption of , after named dayJuly", -5.267858159063328),
                                    ("from|since|after <time>July", -5.778683782829319),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.267858159063328),
                                    ("Clean Mondayyear (latent)", -6.184148890937483),
                                    ("monthhour", -6.184148890937483),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.778683782829319),
                                    ("hourmonth", -4.3123467140358915),
                                    ("todayat <time-of-day>", -6.184148890937483),
                                    ("hhhmmyear (latent)", -4.931385922442115),
                                    ("from|since|after <time>December", -6.184148890937483),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.184148890937483),
                                    ("<time-of-day> am|pmon <day>", -4.931385922442115),
                                    ("Mondayyear (latent)", -5.085536602269373),
                                    ("dayday", -3.932857092330988),
                                    ("mm/ddat <time-of-day>", -5.778683782829319),
                                    ("on <day>September", -5.491001710377538),
                                    ("time-of-day (latent)September", -5.778683782829319),
                                    ("hourhour", -4.104707349257647),
                                    ("time-of-day (latent)on <day>", -4.680071494161209),
                                    ("<datetime> - <datetime> (interval)year (latent)",
                                     -6.184148890937483),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.778683782829319),
                                    ("dayyear", -2.851944380762279),
                                    ("Thursdaymm/dd", -6.184148890937483),
                                    ("New Year's Dayyear (latent)", -5.267858159063328),
                                    ("Tuesdayyear (latent)", -5.085536602269373),
                                    ("time-of-day (latent)Sunday", -5.778683782829319),
                                    ("Thursdayfrom|since|after <time>", -4.479400798699058),
                                    ("Thursdayat <time-of-day>", -4.574710978503383),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.184148890937483),
                                    ("Aprilyear (latent)", -6.184148890937483),
                                    ("the <day-of-month> (ordinal)July", -6.184148890937483),
                                    ("the <day-of-month> (number)July", -6.184148890937483),
                                    ("monthminute", -6.184148890937483),
                                    ("<time-of-day> am|pmtomorrow", -6.184148890937483),
                                    ("Thursdayhh:mm", -5.267858159063328),
                                    ("<day-of-month> (ordinal)Tuesday", -5.778683782829319),
                                    ("minutemonth", -4.0440827274412126),
                                    ("time-of-day (latent)Friday", -5.778683782829319),
                                    ("minutehour", -6.184148890937483),
                                    ("Tuesdayin <number> (implicit minutes)", -6.184148890937483),
                                    ("part of daysat <time-of-day>", -5.085536602269373),
                                    ("<day-of-month> (ordinal)Sunday", -6.184148890937483),
                                    ("Augustyear (latent)", -5.778683782829319),
                                    ("week-endin|during <named-month>|year", -6.184148890937483),
                                    ("time-of-day (latent)Tuesday", -5.778683782829319),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.184148890937483),
                                    ("Tuesdayin|during <named-month>|year", -6.184148890937483),
                                    ("Sundayyear (latent)", -5.267858159063328),
                                    ("the <day-of-month> (ordinal)Monday", -5.491001710377538),
                                    ("Christmasat <time-of-day>", -6.184148890937483),
                                    ("from|since|after <time>year (latent)", -5.085536602269373),
                                    ("hhhmmon <day>", -5.267858159063328),
                                    ("yesterday<time-of-day> am|pm", -6.184148890937483),
                                    ("<day-of-month> (ordinal)July", -5.491001710377538),
                                    ("Tuesday<duration> hence|ago", -6.184148890937483),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.184148890937483),
                                    ("mm/ddyear (latent)", -6.184148890937483),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.184148890937483),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.184148890937483),
                                    ("Tuesdaythis|last|next <cycle>", -6.184148890937483),
                                    ("at <time-of-day>intersect", -5.267858159063328),
                                    ("hh:mmyear (latent)", -4.7978545298175925),
                                    ("Holiyear (latent)", -6.184148890937483),
                                    ("until <time><time-of-day> am|pm", -6.184148890937483),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.778683782829319),
                                    ("dayminute", -3.2937771330413184),
                                    ("yyyy-mm-ddhh:mm", -5.778683782829319),
                                    ("intersectfrom|since|after <time>", -5.778683782829319),
                                    ("intersectSeptember", -4.3123467140358915),
                                    ("minuteday", -3.02714846978737),
                                    ("absorption of , after named dayintersect",
                                     -6.184148890937483),
                                    ("intersectyear (latent)", -6.184148890937483),
                                    ("Februaryin|during the <part-of-day>", -6.184148890937483),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.184148890937483),
                                    ("time-of-day (latent)July", -5.491001710377538),
                                    ("Saturdayyear (latent)", -6.184148890937483),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.184148890937483),
                                    ("<day-of-month> (ordinal)Monday", -5.267858159063328),
                                    ("at <time-of-day>on <day>", -5.267858159063328),
                                    ("absorption of , after named daySeptember",
                                     -4.931385922442115),
                                    ("Naraka Chaturdashiyear (latent)", -6.184148890937483),
                                    ("from|since|after <time>on <day>", -5.267858159063328),
                                    ("dayweek", -6.184148890937483),
                                    ("Easter Sundayyear (latent)", -5.778683782829319),
                                    ("Thursday<time-of-day> am|pm", -4.931385922442115),
                                    ("weekyear", -5.778683782829319),
                                    ("time-of-day (latent)Thursday", -5.778683782829319),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.184148890937483),
                                    ("<day-of-month> (ordinal)April", -6.184148890937483),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.778683782829319),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.491001710377538),
                                    ("Sundayfrom|since|after <time>", -6.184148890937483),
                                    ("absorption of , after named dayFebruary", -5.267858159063328),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.778683782829319),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.184148890937483),
                                    ("tomorrowat <time-of-day>", -6.184148890937483),
                                    ("daynograin", -5.778683782829319),
                                    ("Fridayin|during <named-month>|year", -6.184148890937483),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.778683782829319),
                                    ("last <cycle> of <time>year (latent)", -5.778683782829319),
                                    ("tomorrow<time-of-day> am|pm", -6.184148890937483),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.491001710377538),
                                    ("Diwaliyear (latent)", -5.778683782829319),
                                    ...
                                    ("Tuesdayin|within|after <duration>", -6.184148890937483),
                                    ("time-of-day (latent)April", -6.184148890937483),
                                    ("minuteyear", -3.9869243136012638)],
                               n = 319}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.5520685823000397, unseen = -5.41610040220442,
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                     -4.718498871295094),
                                    ("dayhour", -4.31303376318693),
                                    ("daymonth", -2.115809185850711),
                                    ("<named-month> <day-of-month> (non ordinal)Friday",
                                     -4.718498871295094),
                                    ("Friday<named-month> <day-of-month> (non ordinal)",
                                     -3.4657359027997265),
                                    ("Wednesdayintersect", -4.718498871295094),
                                    ("Labor Daythis|last|next <cycle>", -4.718498871295094),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -3.332204510175204),
                                    ("Black Fridaythis|last|next <cycle>", -4.718498871295094),
                                    ("<part-of-day> of <time>February", -4.718498871295094),
                                    ("Saturday<time-of-day> am|pm", -4.718498871295094),
                                    ("Martin Luther King's Daythis|last|next <cycle>",
                                     -4.31303376318693),
                                    ("hourmonth", -4.718498871295094),
                                    ("Fridayintersect by \",\", \"of\", \"from\" for year",
                                     -4.02535169073515),
                                    ("dayday", -2.4672070726885993),
                                    ("the <day-of-month> (ordinal)February", -4.31303376318693),
                                    ("WednesdayOctober", -4.718498871295094),
                                    ("Wednesdaythis|last|next <cycle>", -4.31303376318693),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.4657359027997265),
                                    ("dayyear", -3.4657359027997265),
                                    ("Saturday<named-month> <day-of-month> (non ordinal)",
                                     -4.718498871295094),
                                    ("Thursdayhh:mm", -4.31303376318693),
                                    ("Thanksgiving Daythis|last|next <cycle>", -4.718498871295094),
                                    ("Memorial Daythis|last|next <cycle>", -4.718498871295094),
                                    ("TuesdayOctober", -4.718498871295094),
                                    ("the <day-of-month> (ordinal)March", -3.619886582626985),
                                    ("Mondaythis|last|next <cycle>", -4.02535169073515),
                                    ("Fridayintersect", -4.02535169073515),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.31303376318693),
                                    ("intersectOctober", -4.31303376318693),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.8022081394209395),
                                    ("Tuesdaythis|last|next <cycle>", -4.718498871295094),
                                    ("Sunday<named-month> <day-of-month> (non ordinal)",
                                     -4.718498871295094),
                                    ("dayminute", -2.9267394020670396),
                                    ("minuteday", -3.4657359027997265),
                                    ("this|last|next <cycle>Sunday", -4.718498871295094),
                                    ("Sundaythis|last|next <cycle>", -4.718498871295094),
                                    ("on <day><time-of-day> am|pm", -4.718498871295094),
                                    ("intersectintersect", -4.718498871295094),
                                    ("weekday", -4.718498871295094),
                                    ("dayweek", -3.619886582626985),
                                    ("Monday<named-month> <day-of-month> (non ordinal)",
                                     -4.31303376318693),
                                    ("<datetime> - <datetime> (interval)July", -3.8022081394209395),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -4.02535169073515)],
                               n = 76},
                   koData =
                     ClassData{prior = -0.8574502318512216, unseen = -5.220355825078324,
                               likelihoods =
                                 HashMap.fromList
                                   [("week-endJuly", -4.5217885770490405),
                                    ("week-endOctober", -3.828641396489095),
                                    ("daymonth", -1.8137383759468302),
