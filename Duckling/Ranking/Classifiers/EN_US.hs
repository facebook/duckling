...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5930018005812271, unseen = -6.056784013228625,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 425},
                   koData =
                     ClassData{prior = -0.8044493121322456, unseen = -5.846438775057725,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47217990866833115,
                               unseen = -7.090076835776092,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.396095974467569),
                                    ("Father's Dayyear (latent)", -6.396095974467569),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.396095974467569),
                                    ("Ramadanyear (latent)", -5.479805242593414),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.3811929539253045),
                                    ("Military Spouse Dayyear (latent)", -6.396095974467569),
                                    ("Bhai Doojyear (latent)", -6.396095974467569),
                                    ("hourday", -4.3811929539253045),
                                    ("dayhour", -3.4516569953011285),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.3811929539253045),
                                    ("Martin Luther King's Dayyear (latent)", -5.990630866359405),
                                    ("Shemini Atzeretyear (latent)", -6.396095974467569),
                                    ("daymonth", -4.3811929539253045),
                                    ("monthday", -5.990630866359405),
                                    ("monthyear", -4.604336505239514),
                                    ("Yom Ha'atzmautyear (latent)", -6.396095974467569),
                                    ("Vijayadashamiyear (latent)", -6.396095974467569),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.009801613347678),
                                    ("Thanksgiving Dayyear (latent)", -5.29748368579946),
                                    ("Thai Pongalyear (latent)", -5.702948793907623),
                                    ("Thiru Onamyear (latent)", -5.702948793907623),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.396095974467569),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.479805242593414),
                                    ("<day-of-month> (ordinal)Wednesday", -6.396095974467569),
                                    ("Krishna Janmashtamiyear (latent)", -5.990630866359405),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.396095974467569),
                                    ("houryear", -5.479805242593414),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.396095974467569),
                                    ("Christmas<time-of-day> am|pm", -6.396095974467569),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.396095974467569),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.702948793907623),
                                    ("intersectin|during <named-month>|year", -6.396095974467569),
                                    ("<time-of-day> am|pmintersect", -5.143333005972201),
                                    ("Earth Houryear (latent)", -6.396095974467569),
                                    ("Octoberyear (latent)", -4.892018577691295),
                                    ("intersect<time-of-day> am|pm", -6.396095974467569),
                                    ("Mattu Pongalyear (latent)", -6.396095974467569),
                                    ("Daylight Saving Start Dayyear (latent)", -5.479805242593414),
                                    ("Shavuotyear (latent)", -6.396095974467569),
                                    ("Parsi New Yearyear (latent)", -5.479805242593414),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.396095974467569),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.396095974467569),
                                    ("todayin|within|after <duration>", -6.396095974467569),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.990630866359405),
                                    ("Marchyear (latent)", -6.396095974467569),
                                    ("Sukkotyear (latent)", -5.990630866359405),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.990630866359405),
                                    ("Daylight Saving End Dayyear (latent)", -5.479805242593414),
                                    ("Clean Mondayyear (latent)", -5.990630866359405),
                                    ("monthhour", -5.990630866359405),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.702948793907623),
                                    ("todayat <time-of-day>", -6.396095974467569),
                                    ("Thursday<time> timezone", -4.450185825412255),
                                    ("time-of-day (latent)tonight", -5.990630866359405),
                                    ("from|since|after <time>December", -6.396095974467569),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.396095974467569),
                                    ("<time-of-day> am|pmon <day>", -4.3811929539253045),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.396095974467569),
                                    ("yyyy-mm-ddhh:mm:ss", -5.990630866359405),
                                    ("Tax Daythis|last|next <cycle>", -6.396095974467569),
                                    ("dayday", -3.9537489390983644),
                                    ("<time> <part-of-day>at <time-of-day>", -6.396095974467569),
                                    ("mm/ddat <time-of-day>", -6.396095974467569),
                                    ("tonightat <time-of-day>", -6.396095974467569),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.702948793907623),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.396095974467569),
                                    ("today<time-of-day> am|pm", -6.396095974467569),
                                    ("Februarythe <day-of-month> (ordinal)", -5.990630866359405),
                                    ("at <time-of-day><time> <part-of-day>", -6.396095974467569),
                                    ("<day-of-month> (ordinal)intersect", -5.990630866359405),
                                    ("mm/dd<time-of-day> am|pm", -6.396095974467569),
                                    ("hourhour", -4.316654432787733),
                                    ("Navaratriin|during <named-month>|year", -6.396095974467569),
                                    ("Wednesdaythis|last|next <cycle>", -6.396095974467569),
                                    ("Lentyear (latent)", -6.396095974467569),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.892018577691295),
                                    ("Boghiyear (latent)", -6.396095974467569),
                                    ("dayyear", -1.800976124332979),
                                    ("Thursdayfrom|since|after <time>", -5.990630866359405),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.396095974467569),
                                    ("Thursdayat <time-of-day>", -5.702948793907623),
                                    ("Islamic New Yearyear (latent)", -5.990630866359405),
                                    ("Laylat al-Qadryear (latent)", -5.479805242593414),
                                    ("Shrove Tuesdayyear (latent)", -6.396095974467569),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.702948793907623),
                                    ("<time-of-day> am|pmtomorrow", -5.702948793907623),
                                    ("Yom Kippuryear (latent)", -6.396095974467569),
                                    ("<day-of-month> (ordinal)Tuesday", -5.990630866359405),
                                    ("<part-of-day> of <time>year (latent)", -6.396095974467569),
                                    ("minutehour", -5.29748368579946),
                                    ("Kaanum Pongalyear (latent)", -5.990630866359405),
                                    ("Maha Saptamiyear (latent)", -6.396095974467569),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.990630866359405),
                                    ("time-of-day (latent)tomorrow", -5.479805242593414),
                                    ("part of daysat <time-of-day>", -5.990630866359405),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.6913478822291435),
                                    ("for <duration> from <time>December", -6.396095974467569),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.396095974467569),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.143333005972201),
                                    ("time-of-day (latent)this <part-of-day>", -6.396095974467569),
                                    ("Pentecostyear (latent)", -6.396095974467569),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.143333005972201),
                                    ("<day-of-month> (ordinal)February", -6.396095974467569),
                                    ("Eid al-Fitryear (latent)", -5.479805242593414),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.396095974467569),
                                    ("Mondayin|during the <part-of-day>", -6.396095974467569),
                                    ("Chhathin|during <named-month>|year", -6.396095974467569),
                                    ("Diwaliin|during <named-month>|year", -6.396095974467569),
                                    ("Vaisakhiin|during <named-month>|year", -6.396095974467569),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.143333005972201),
                                    ("Raksha Bandhanyear (latent)", -6.396095974467569),
                                    ("daysecond", -5.990630866359405),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.990630866359405),
                                    ("Emancipation Dayyear (latent)", -5.702948793907623),
                                    ("Ashurayear (latent)", -6.396095974467569),
                                    ("Tuesdayin|during <named-month>|year", -6.396095974467569),
                                    ("Chinese New Yearyear (latent)", -6.396095974467569),
                                    ("tomorrowintersect", -6.396095974467569),
                                    ("Lag BaOmeryear (latent)", -6.396095974467569),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.396095974467569),
                                    ("Eid al-Adhayear (latent)", -4.256029810971298),
                                    ("intersectin|during the <part-of-day>", -6.396095974467569),
                                    ("Palm Sundayyear (latent)", -6.396095974467569),
                                    ("Christmasat <time-of-day>", -6.396095974467569),
                                    ("Passoveryear (latent)", -6.396095974467569),
                                    ("Lazarus Saturdayyear (latent)", -6.396095974467569),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.396095974467569),
                                    ("Cyber Mondayyear (latent)", -5.990630866359405),
                                    ("Yom HaShoahyear (latent)", -5.990630866359405),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.990630866359405),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.396095974467569),
                                    ("Septemberyear (latent)", -5.990630866359405),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.892018577691295),
                                    ("Halloweenyear (latent)", -6.396095974467569),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.396095974467569),
                                    ("at <time-of-day>intersect", -5.990630866359405),
                                    ("Rosh Hashanahyear (latent)", -5.702948793907623),
                                    ("Dhanterasyear (latent)", -6.396095974467569),
                                    ("Tu BiShvatyear (latent)", -6.396095974467569),
                                    ("<day-of-month> (ordinal)December", -5.702948793907623),
                                    ("Holiyear (latent)", -5.702948793907623),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.396095974467569),
                                    ("Holika Dahanyear (latent)", -5.702948793907623),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.396095974467569),
                                    ("dayminute", -3.4783252423832898),
                                    ("Mawlidyear (latent)", -6.396095974467569),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.990630866359405),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.396095974467569),
                                    ("Jumu'atul-Widayear (latent)", -5.479805242593414),
                                    ("minuteday", -2.567454577978474),
                                    ("absorption of , after named dayintersect",
                                     -6.396095974467569),
                                    ("intersectyear (latent)", -6.396095974467569),
                                    ("Orthodox Easter Sundayyear (latent)", -6.396095974467569),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.396095974467569),
                                    ("Boss's Dayyear (latent)", -5.990630866359405),
                                    ("Global Youth Service Dayyear (latent)", -6.396095974467569),
                                    ("Dhanterasin|during <named-month>|year", -6.396095974467569),
                                    ("Tisha B'Avyear (latent)", -6.396095974467569),
                                    ("Isra and Mi'rajyear (latent)", -5.479805242593414),
                                    ("at <time-of-day>on <day>", -5.29748368579946),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.396095974467569),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.702948793907623),
                                    ("Christmasyear (latent)", -5.990630866359405),
                                    ("Naraka Chaturdashiyear (latent)", -5.990630866359405),
                                    ("Thai Pongalin|during <named-month>|year", -6.396095974467569),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.396095974467569),
                                    ("dayweek", -6.396095974467569),
                                    ("Easter Sundayyear (latent)", -5.702948793907623),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.786658062033468),
                                    ("weekyear", -5.29748368579946),
                                    ("King's Dayyear (latent)", -4.892018577691295),
                                    ("hh:mmin|during the <part-of-day>", -5.702948793907623),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.990630866359405),
                                    ("Hanukkahyear (latent)", -5.702948793907623),
                                    ("February<time> <part-of-day>", -6.396095974467569),
                                    ("National Grandparents Dayyear (latent)", -6.396095974467569),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.396095974467569),
                                    ("Great Lentyear (latent)", -6.396095974467569),
                                    ("tomorrowat <time-of-day>", -5.702948793907623),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.396095974467569),
                                    ("Labor Dayyear (latent)", -6.396095974467569),
                                    ("Vaisakhiyear (latent)", -5.702948793907623),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.396095974467569),
                                    ("last <cycle> of <time>year (latent)", -5.702948793907623),
                                    ("at <time-of-day>tomorrow", -5.990630866359405),
                                    ("tomorrow<time-of-day> am|pm", -6.396095974467569),
                                    ("President's Dayyear (latent)", -6.396095974467569),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.396095974467569),
                                    ("Diwaliyear (latent)", -6.396095974467569),
                                    ("between <time> and <time>on <day>", -4.786658062033468),
                                    ("Black Fridayyear (latent)", -5.990630866359405),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.396095974467569),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.396095974467569),
                                    ("Chhathyear (latent)", -5.990630866359405),
                                    ("Vasant Panchamiyear (latent)", -6.396095974467569),
                                    ("Tax Dayyear (latent)", -5.479805242593414),
                                    ("Rabindra Jayantiyear (latent)", -5.143333005972201),
                                    ("St Patrick's Dayyear (latent)", -6.396095974467569),
                                    ("Thursday<time> (timezone)", -6.396095974467569),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.396095974467569),
                                    ("<datetime> - <datetime> (interval)July", -5.990630866359405),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.990630866359405),
                                    ("Februaryintersect", -6.396095974467569),
                                    ("Mother's Dayyear (latent)", -6.396095974467569),
                                    ("Simchat Torahyear (latent)", -6.396095974467569),
                                    ("minuteyear", -6.396095974467569)],
                               n = 459},
                   koData =
                     ClassData{prior = -0.9772126125415378, unseen = -6.728628613084702,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.1439127863947456),
                                    ...
                                    ("Mondayyear (latent)", -4.9356722556228005),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.597384633214691),
                                    ("integer (0..19)year (grain)", -3.0392173854937297),
                                    ("integer (numeric)day (grain)", -2.597384633214691),
                                    ("integer (0..19)second (grain) ", -3.8501476017100584),
                                    ("integer (0..19)hour (grain)", -3.0392173854937297),
                                    ("second", -3.4446824936018943),
                                    ("integer (numeric)second (grain) ", -4.137829674161839),
                                    ("integer (numeric)year (grain)", -3.1570004211501135),
                                    ("day", -2.3460702049337847), ("year", -2.463853240590168),
                                    ...
                                    ("hour", -2.6714926053684125), ("month", -3.2905318137746358),
                                    ("integer (numeric)minute (grain)", -3.1570004211501135),
                                    ("integer (0..19)minute (grain)", -3.1570004211501135),
                                    ("integer (numeric)month (grain)", -4.137829674161839),
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.5970033200070429,
                                 ...
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                    ...
                                    ("Fridayintersect by \",\", \"of\", \"from\" for year",
                                     -4.5591262474866845),
                                    ("dayday", -2.687324070585093),
                                    ("the <day-of-month> (ordinal)February", -4.15366113937852),
                                    ...
                                    ("the <day-of-month> (ordinal)March", -4.5591262474866845),
                                    ("Mondaythis|last|next <cycle>", -4.5591262474866845),
                                    ("Fridayintersect", -4.5591262474866845),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.15366113937852),
                                    ...
                                    ("Monday<named-month> <day-of-month> (non ordinal)",
                                     -4.15366113937852),
                                    ("<datetime> - <datetime> (interval)July", -3.6428355156125294),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -4.15366113937852)],
                               n = 60},
                   koData =
                     ClassData{prior = -0.799527584118517, unseen = -5.135798437050262,
                               likelihoods =
                                 HashMap.fromList
                                   [("week-endJuly", -4.436751534363128),
                                    ("week-endOctober", -3.7436043538031827),
                                    ("daymonth", -1.9110228900548727),
                                    ("TuesdaySeptember", -4.436751534363128),
                                    ("Wednesdayintersect", -4.436751534363128),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -3.3381392456950185),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -4.436751534363128),
                                    ("hournograin", -4.0312864262549635),
                                    ("from|since|after <time>July", -4.0312864262549635),
                                    ("hourmonth", -2.4908413853078146),
                                    ("Fridaythis|last|next <cycle>", -4.436751534363128),
                                    ("SundayFebruary", -4.436751534363128),
                                    ("on <day>September", -4.0312864262549635),
                                    ("WednesdayOctober", -4.436751534363128),
                                    ("intersectnow", -4.0312864262549635),
                                    ("week-endintersect", -4.436751534363128),
                                    ("dayyear", -4.436751534363128),
                                    ("FridayJuly", -4.0312864262549635),
                                    ("FridaySeptember", -4.436751534363128),
                                    ("the <day-of-month> (ordinal)July", -3.520460802488973),
                                    ("WednesdayFebruary", -4.436751534363128),
                                    ("minutemonth", -3.18398856586776),
                                    ("SundayMarch", -4.436751534363128),
                                    ("MondayFebruary", -4.0312864262549635),
                                    ("Fridayintersect", -4.436751534363128),
                                    ("intersectOctober", -4.436751534363128),
                                    ("dayminute", -4.436751534363128),
                                    ("SaturdaySeptember", -4.436751534363128),
                                    ("intersectSeptember", -3.3381392456950185),
                                    ("Tuesdaynow", -4.0312864262549635),
                                    ("MondayMarch", -4.436751534363128),
                                    ("daynograin", -4.0312864262549635),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -4.436751534363128),
                                    ("Tuesdayintersect", -4.436751534363128),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -4.436751534363128),
                                    ("<datetime> - <datetime> (interval)July", -4.436751534363128),
                                    ("Sundayintersect", -4.436751534363128)],
                               n = 49}}),
       ("last <time>",
        Classifier{okData =
