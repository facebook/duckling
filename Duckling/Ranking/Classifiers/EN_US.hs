...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5978370007556204, unseen = -5.869296913133774,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 352},
                   koData =
                     ClassData{prior = -0.7985076962177716, unseen = -5.66988092298052,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.42574230054731516,
                               unseen = -6.853299093186078,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.159095388491933),
                                    ("Father's Dayyear (latent)", -6.159095388491933),
                                    ("Ramadanyear (latent)", -6.159095388491933),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.906332419996565),
                                    ("Military Spouse Dayyear (latent)", -6.159095388491933),
                                    ("Bhai Doojyear (latent)", -6.159095388491933),
                                    ("hourday", -4.454347296253507),
                                    ("dayhour", -3.2968945075624645),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.906332419996565),
                                    ("Martin Luther King's Dayyear (latent)", -5.753630280383769),
                                    ("Shemini Atzeretyear (latent)", -6.159095388491933),
                                    ("daymonth", -5.2428046566177775),
                                    ("monthday", -5.753630280383769),
                                    ("monthyear", -4.367335919263878),
                                    ("Yom Ha'atzmautyear (latent)", -6.159095388491933),
                                    ("Vijayadashamiyear (latent)", -6.159095388491933),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -4.772801027372043),
                                    ("Thanksgiving Dayyear (latent)", -5.0604830998238235),
                                    ("Thai Pongalyear (latent)", -5.465948207931987),
                                    ("Thiru Onamyear (latent)", -5.465948207931987),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.159095388491933),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.159095388491933),
                                    ("houryear", -5.465948207931987),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.159095388491933),
                                    ("Christmas<time-of-day> am|pm", -6.159095388491933),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.159095388491933),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.465948207931987),
                                    ("<time-of-day> am|pmintersect", -4.906332419996565),
                                    ("Earth Houryear (latent)", -6.159095388491933),
                                    ("Octoberyear (latent)", -4.655017991715659),
                                    ("intersect<time-of-day> am|pm", -6.159095388491933),
                                    ("Mattu Pongalyear (latent)", -6.159095388491933),
                                    ("Daylight Saving Start Dayyear (latent)", -5.2428046566177775),
                                    ("Shavuotyear (latent)", -6.159095388491933),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.159095388491933),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.159095388491933),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.753630280383769),
                                    ("Marchyear (latent)", -6.159095388491933),
                                    ("Sukkotyear (latent)", -5.753630280383769),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.159095388491933),
                                    ("Daylight Saving End Dayyear (latent)", -5.2428046566177775),
                                    ("Clean Mondayyear (latent)", -5.753630280383769),
                                    ("monthhour", -5.753630280383769),
                                    ("todayat <time-of-day>", -6.159095388491933),
                                    ("Thursday<time> timezone", -4.21318523943662),
                                    ("from|since|after <time>December", -6.159095388491933),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.159095388491933),
                                    ("<time-of-day> am|pmon <day>", -4.144192367949668),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.159095388491933),
                                    ("yyyy-mm-ddhh:mm:ss", -5.753630280383769),
                                    ("Tax Daythis|last|next <cycle>", -6.159095388491933),
                                    ("dayday", -4.144192367949668),
                                    ("<time> <part-of-day>at <time-of-day>", -6.159095388491933),
                                    ("mm/ddat <time-of-day>", -6.159095388491933),
                                    ("tonightat <time-of-day>", -6.159095388491933),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.465948207931987),
                                    ("today<time-of-day> am|pm", -6.159095388491933),
                                    ("Februarythe <day-of-month> (ordinal)", -5.753630280383769),
                                    ("at <time-of-day><time> <part-of-day>", -6.159095388491933),
                                    ("mm/dd<time-of-day> am|pm", -6.159095388491933),
                                    ("hourhour", -4.906332419996565),
                                    ("Navaratriin|during <named-month>|year", -6.159095388491933),
                                    ("Wednesdaythis|last|next <cycle>", -6.159095388491933),
                                    ("Lentyear (latent)", -6.159095388491933),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.655017991715659),
                                    ("Boghiyear (latent)", -6.159095388491933),
                                    ("dayyear", -1.848296263106419),
                                    ("Thursdayfrom|since|after <time>", -5.753630280383769),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.159095388491933),
                                    ("Thursdayat <time-of-day>", -5.465948207931987),
                                    ("Islamic New Yearyear (latent)", -5.753630280383769),
                                    ("Laylat al-Qadryear (latent)", -5.2428046566177775),
                                    ("Shrove Tuesdayyear (latent)", -6.159095388491933),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.465948207931987),
                                    ("<time-of-day> am|pmtomorrow", -5.465948207931987),
                                    ("Yom Kippuryear (latent)", -6.159095388491933),
                                    ("<part-of-day> of <time>year (latent)", -6.159095388491933),
                                    ("minutehour", -5.2428046566177775),
                                    ("Kaanum Pongalyear (latent)", -5.753630280383769),
                                    ("Maha Saptamiyear (latent)", -6.159095388491933),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.753630280383769),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.454347296253507),
                                    ("for <duration> from <time>December", -6.159095388491933),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.159095388491933),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.906332419996565),
                                    ("Pentecostyear (latent)", -6.159095388491933),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.906332419996565),
                                    ("Eid al-Fitryear (latent)", -6.159095388491933),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.159095388491933),
                                    ("Mondayin|during the <part-of-day>", -6.159095388491933),
                                    ("Chhathin|during <named-month>|year", -6.159095388491933),
                                    ("Diwaliin|during <named-month>|year", -6.159095388491933),
                                    ("Vaisakhiin|during <named-month>|year", -6.159095388491933),
                                    ("Raksha Bandhanyear (latent)", -6.159095388491933),
                                    ("daysecond", -5.753630280383769),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.753630280383769),
                                    ("Emancipation Dayyear (latent)", -5.465948207931987),
                                    ("Ashurayear (latent)", -6.159095388491933),
                                    ("Tuesdayin|during <named-month>|year", -6.159095388491933),
                                    ("Chinese New Yearyear (latent)", -6.159095388491933),
                                    ("Lag BaOmeryear (latent)", -6.159095388491933),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.159095388491933),
                                    ("Eid al-Adhayear (latent)", -5.2428046566177775),
                                    ("intersectin|during the <part-of-day>", -6.159095388491933),
                                    ("Palm Sundayyear (latent)", -6.159095388491933),
                                    ("Christmasat <time-of-day>", -6.159095388491933),
                                    ("Passoveryear (latent)", -6.159095388491933),
                                    ("Lazarus Saturdayyear (latent)", -6.159095388491933),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.159095388491933),
                                    ("Cyber Mondayyear (latent)", -5.753630280383769),
                                    ("Yom HaShoahyear (latent)", -5.753630280383769),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.753630280383769),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.159095388491933),
                                    ("Septemberyear (latent)", -5.753630280383769),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.655017991715659),
                                    ("Halloweenyear (latent)", -6.159095388491933),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.159095388491933),
                                    ("at <time-of-day>intersect", -5.753630280383769),
                                    ("Rosh Hashanahyear (latent)", -5.465948207931987),
                                    ("Dhanterasyear (latent)", -6.159095388491933),
                                    ("Tu BiShvatyear (latent)", -6.159095388491933),
                                    ("Holiyear (latent)", -5.465948207931987),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.159095388491933),
                                    ("Holika Dahanyear (latent)", -5.465948207931987),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.159095388491933),
                                    ("dayminute", -3.2413246564076537),
                                    ("Mawlidyear (latent)", -6.159095388491933),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.753630280383769),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.159095388491933),
                                    ("Jumu'atul-Widayear (latent)", -5.2428046566177775),
                                    ("minuteday", -2.5215092287655474),
                                    ("absorption of , after named dayintersect",
                                     -6.159095388491933),
                                    ("Orthodox Easter Sundayyear (latent)", -6.159095388491933),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.159095388491933),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.159095388491933),
                                    ("Boss's Dayyear (latent)", -5.753630280383769),
                                    ("Global Youth Service Dayyear (latent)", -6.159095388491933),
                                    ("Dhanterasin|during <named-month>|year", -6.159095388491933),
                                    ("Tisha B'Avyear (latent)", -6.159095388491933),
                                    ("Isra and Mi'rajyear (latent)", -5.2428046566177775),
                                    ("at <time-of-day>on <day>", -5.0604830998238235),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.159095388491933),
                                    ("Christmasyear (latent)", -5.753630280383769),
                                    ("Naraka Chaturdashiyear (latent)", -5.753630280383769),
                                    ("Thai Pongalin|during <named-month>|year", -6.159095388491933),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.159095388491933),
                                    ("dayweek", -6.159095388491933),
                                    ("Easter Sundayyear (latent)", -5.465948207931987),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.549657476057833),
                                    ("weekyear", -5.0604830998238235),
                                    ("hh:mmin|during the <part-of-day>", -5.465948207931987),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.753630280383769),
                                    ("Hanukkahyear (latent)", -5.465948207931987),
                                    ("February<time> <part-of-day>", -6.159095388491933),
                                    ("National Grandparents Dayyear (latent)", -6.159095388491933),
                                    ("Great Lentyear (latent)", -6.159095388491933),
                                    ("tomorrowat <time-of-day>", -5.465948207931987),
                                    ("Labor Dayyear (latent)", -6.159095388491933),
                                    ("Vaisakhiyear (latent)", -5.465948207931987),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.159095388491933),
                                    ("last <cycle> of <time>year (latent)", -5.465948207931987),
                                    ("at <time-of-day>tomorrow", -5.753630280383769),
                                    ("tomorrow<time-of-day> am|pm", -6.159095388491933),
                                    ("President's Dayyear (latent)", -6.159095388491933),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.159095388491933),
                                    ("Diwaliyear (latent)", -6.159095388491933),
                                    ("between <time> and <time>on <day>", -4.549657476057833),
                                    ("Black Fridayyear (latent)", -5.753630280383769),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.159095388491933),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.159095388491933),
                                    ("Chhathyear (latent)", -5.753630280383769),
                                    ("Vasant Panchamiyear (latent)", -6.159095388491933),
                                    ("Tax Dayyear (latent)", -5.2428046566177775),
                                    ("Thursday<time> (timezone)", -6.159095388491933),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.159095388491933),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.753630280383769),
                                    ("Februaryintersect", -6.159095388491933),
                                    ("Mother's Dayyear (latent)", -6.159095388491933),
                                    ("Simchat Torahyear (latent)", -6.159095388491933),
                                    ("minuteyear", -6.159095388491933)],
                               n = 358},
                   koData =
                     ClassData{prior = -1.0592512147875293, unseen = -6.415096959171596,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.804021044733257),
                                    ("dayhour", -3.046163127180883),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.804021044733257),
                                    ("Tuesdayfrom|since|after <time>", -5.720311776607412),
                                    ("daymonth", -3.7054087560651467),
                                    ("monthyear", -4.467548808112044),
                                    ("<time-of-day> am|pmyear (latent)", -5.0271645960474665),
                                    ("Thai Pongalyear (latent)", -5.0271645960474665),
                                    ("intersecthh:mm", -5.720311776607412),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.720311776607412),
                                    ("houryear", -4.621699487939302),
                                    ...
                                    ("until <time>on <day>", -5.0271645960474665),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.0271645960474665),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.720311776607412),
                                    ("hh:mmon <day>", -3.7054087560651467),
                                    ...
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.720311776607412),
                                    ("<time-of-day> am|pmon <day>", -4.467548808112044),
                                    ("Mondayyear (latent)", -4.621699487939302),
                                    ("dayday", -5.314846668499247),
                                    ("mm/ddat <time-of-day>", -5.314846668499247),
                                    ("on <day>September", -5.314846668499247),
                                    ("dayyear", -2.775872797440971),
                                    ("Thursdaymm/dd", -5.720311776607412),
                                    ("New Year's Dayyear (latent)", -5.314846668499247),
                                    ("Thursdayfrom|since|after <time>", -4.015563684368987),
                                    ("Thursdayat <time-of-day>", -4.110873864173311),
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.5645298027378518, unseen = -4.499809670330265,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.144830947878456),
                                    ("integer (0..19)", -2.0037297199441397)],
                               n = 87},
                   koData =
                     ClassData{prior = -0.8407831793660099, unseen = -4.23410650459726,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.23151180098472637, unseen = -5.54907608489522,
                               likelihoods =
                                 HashMap.fromList
                                   [("from|since|after <time>", -3.5992672954242493),
                                    ("integer after|past <hour-of-day>", -4.1588830833596715),
                                    ("at <time-of-day>", -2.2870809064580806),
                                    ...
                                    ("time-of-day (latent)", -1.6950298427695039),
                                    ...
                                    ("hour", -1.2144441041932315),
                                    ("<time-of-day> sharp|exactly", -4.852030263919617),
                                    ("minute", -1.7609878105613013)],
                               n = 119},
                   koData =
                     ClassData{prior = -1.5766480896111095, unseen = -4.394449154672439,
                               likelihoods =
                                 HashMap.fromList
