...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -4.01096295328305),
                                    ...
                                    ("second", -4.927253685157205), ("now", -3.317815772723104),
                                    ...
                                    ("hh:mm", -4.5217885770490405), ("nograin", -3.317815772723104),
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.449680975258207, unseen = -7.272398392570047,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.578556526327422),
                                    ("Father's Dayyear (latent)", -6.578556526327422),
                                    ("Karva Chauthyear (latent)", -6.578556526327422),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.578556526327422),
                                    ("Maha Shivaratriyear (latent)", -6.578556526327422),
                                    ("Ramadanyear (latent)", -5.325793557832054),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.192262165207532),
                                    ("Military Spouse Dayyear (latent)", -6.578556526327422),
                                    ("Bhai Doojyear (latent)", -6.578556526327422),
                                    ("hourday", -4.563653505785158),
                                    ("dayhour", -3.5340340886039994),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.192262165207532),
                                    ("Martin Luther King's Dayyear (latent)", -6.173091418219258),
                                    ("Shemini Atzeretyear (latent)", -6.578556526327422),
                                    ("daymonth", -4.563653505785158),
                                    ("monthday", -6.173091418219258),
                                    ("monthyear", -4.786797057099368),
                                    ("Yom Ha'atzmautyear (latent)", -6.578556526327422),
                                    ("Orthodox Good Fridayyear (latent)", -6.173091418219258),
                                    ("Vijayadashamiyear (latent)", -6.578556526327422),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.192262165207532),
                                    ("Thanksgiving Dayyear (latent)", -5.479944237659313),
                                    ("Thai Pongalyear (latent)", -5.885409345767477),
                                    ("Thiru Onamyear (latent)", -5.885409345767477),
                                    ("hhhmmabsorption of , after named day", -6.578556526327422),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.578556526327422),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.662265794453267),
                                    ("<day-of-month> (ordinal)Wednesday", -6.578556526327422),
                                    ("Krishna Janmashtamiyear (latent)", -6.173091418219258),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.578556526327422),
                                    ("houryear", -5.662265794453267),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.578556526327422),
                                    ("Christmas<time-of-day> am|pm", -6.578556526327422),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.578556526327422),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.885409345767477),
                                    ("intersectin|during <named-month>|year", -6.578556526327422),
                                    ("<time-of-day> am|pmintersect", -5.325793557832054),
                                    ("Earth Houryear (latent)", -6.578556526327422),
                                    ("Ganesh Chaturthiyear (latent)", -6.578556526327422),
                                    ("Octoberyear (latent)", -5.074479129551149),
                                    ("intersect<time-of-day> am|pm", -6.578556526327422),
                                    ("Mattu Pongalyear (latent)", -6.578556526327422),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.578556526327422),
                                    ("Daylight Saving Start Dayyear (latent)", -5.662265794453267),
                                    ("Shavuotyear (latent)", -6.578556526327422),
                                    ("Parsi New Yearyear (latent)", -5.662265794453267),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.578556526327422),
                                    ("the <day-of-month> (ordinal)intersect by \",\", \"of\", \"from\" for year",
                                     -6.578556526327422),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.578556526327422),
                                    ("todayin|within|after <duration>", -6.578556526327422),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.173091418219258),
                                    ("Marchyear (latent)", -6.578556526327422),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.173091418219258),
                                    ("Sukkotyear (latent)", -6.173091418219258),
                                    ("hhhmmintersect", -6.173091418219258),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.173091418219258),
                                    ("Daylight Saving End Dayyear (latent)", -5.662265794453267),
                                    ("Clean Mondayyear (latent)", -6.173091418219258),
                                    ("the <day-of-month> (ordinal)Sunday", -6.578556526327422),
                                    ("monthhour", -6.173091418219258),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.662265794453267),
                                    ("todayat <time-of-day>", -6.578556526327422),
                                    ("Thursday<time> timezone", -4.180661253529052),
                                    ("tonight<time-of-day> am|pm", -6.578556526327422),
                                    ("time-of-day (latent)tonight", -6.173091418219258),
                                    ("from|since|after <time>December", -6.578556526327422),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.578556526327422),
                                    ("<time-of-day> am|pmon <day>", -4.563653505785158),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.578556526327422),
                                    ("yyyy-mm-ddhh:mm:ss", -6.173091418219258),
                                    ("Tax Daythis|last|next <cycle>", -6.578556526327422),
                                    ("dayday", -3.745343182271206),
                                    ("<time> <part-of-day>at <time-of-day>", -6.173091418219258),
                                    ("mm/ddat <time-of-day>", -6.578556526327422),
                                    ("tonightat <time-of-day>", -5.479944237659313),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.885409345767477),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.578556526327422),
                                    ("today<time-of-day> am|pm", -6.578556526327422),
                                    ("Februarythe <day-of-month> (ordinal)", -6.173091418219258),
                                    ("at <time-of-day><time> <part-of-day>", -6.578556526327422),
                                    ("<day-of-month> (ordinal)intersect", -6.173091418219258),
                                    ("mm/dd<time-of-day> am|pm", -6.578556526327422),
                                    ("hourhour", -3.6081420607577215),
                                    ("Mahavir Jayantiyear (latent)", -6.173091418219258),
                                    ("Navaratriin|during <named-month>|year", -6.578556526327422),
                                    ("Wednesdaythis|last|next <cycle>", -6.578556526327422),
                                    ("Lentyear (latent)", -6.578556526327422),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.7067543494258315),
                                    ("Boghiyear (latent)", -6.578556526327422),
                                    ("dayyear", -1.7994330332158932),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.578556526327422),
                                    ("Thursdayfrom|since|after <time>", -6.173091418219258),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.578556526327422),
                                    ("Thursdayat <time-of-day>", -5.885409345767477),
                                    ("Islamic New Yearyear (latent)", -6.173091418219258),
                                    ("Laylat al-Qadryear (latent)", -5.662265794453267),
                                    ("part of days<time-of-day> am|pm", -6.578556526327422),
                                    ("Shrove Tuesdayyear (latent)", -6.578556526327422),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.885409345767477),
                                    ("hourminute", -6.173091418219258),
                                    ("<time-of-day> am|pmtomorrow", -5.662265794453267),
                                    ("Yom Kippuryear (latent)", -6.578556526327422),
                                    ("<day-of-month> (ordinal)Tuesday", -5.885409345767477),
                                    ("<part-of-day> of <time>year (latent)", -6.578556526327422),
                                    ("minutehour", -5.325793557832054),
                                    ("Kaanum Pongalyear (latent)", -6.173091418219258),
                                    ("Maha Saptamiyear (latent)", -6.578556526327422),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.885409345767477),
                                    ("time-of-day (latent)tomorrow", -5.662265794453267),
                                    ("part of daysat <time-of-day>", -4.969118613893322),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.563653505785158),
                                    ("for <duration> from <time>December", -6.578556526327422),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.578556526327422),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.325793557832054),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.325793557832054),
                                    ("time-of-day (latent)this <part-of-day>", -6.578556526327422),
                                    ("Pentecostyear (latent)", -6.578556526327422),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.325793557832054),
                                    ("<day-of-month> (ordinal)February", -6.578556526327422),
                                    ("Eid al-Fitryear (latent)", -5.192262165207532),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.578556526327422),
                                    ("Mini-Tuesday<duration> hence|ago", -6.578556526327422),
                                    ("Mondayin|during the <part-of-day>", -6.578556526327422),
                                    ("Chhathin|during <named-month>|year", -6.578556526327422),
                                    ("Diwaliin|during <named-month>|year", -6.578556526327422),
                                    ("this <part-of-day><time-of-day> am|pm", -6.578556526327422),
                                    ("Vaisakhiin|during <named-month>|year", -6.578556526327422),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.325793557832054),
                                    ("Raksha Bandhanyear (latent)", -6.578556526327422),
                                    ("daysecond", -6.173091418219258),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.173091418219258),
                                    ("Emancipation Dayyear (latent)", -5.885409345767477),
                                    ("Ratha-Yatrayear (latent)", -6.578556526327422),
                                    ("Ashurayear (latent)", -6.578556526327422),
                                    ("Tuesdayin|during <named-month>|year", -6.578556526327422),
                                    ("Chinese New Yearyear (latent)", -6.578556526327422),
                                    ("tomorrowintersect", -6.578556526327422),
                                    ("Lag BaOmeryear (latent)", -6.578556526327422),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.578556526327422),
                                    ("Eid al-Adhayear (latent)", -4.438490362831152),
                                    ("intersectin|during the <part-of-day>", -6.578556526327422),
                                    ("Palm Sundayyear (latent)", -6.578556526327422),
                                    ("Christmasat <time-of-day>", -6.578556526327422),
                                    ("Passoveryear (latent)", -6.578556526327422),
                                    ("Lazarus Saturdayyear (latent)", -6.578556526327422),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.578556526327422),
                                    ("Cyber Mondayyear (latent)", -6.173091418219258),
                                    ("hhhmmon <day>", -5.662265794453267),
                                    ("Yom HaShoahyear (latent)", -6.173091418219258),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.173091418219258),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.578556526327422),
                                    ("Septemberyear (latent)", -6.173091418219258),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.074479129551149),
                                    ("Halloweenyear (latent)", -6.578556526327422),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.578556526327422),
                                    ("at <time-of-day>intersect", -5.662265794453267),
                                    ("Rosh Hashanahyear (latent)", -5.885409345767477),
                                    ("Super Tuesdayyear (latent)", -5.662265794453267),
                                    ("Dhanterasyear (latent)", -6.578556526327422),
                                    ("Tu BiShvatyear (latent)", -6.578556526327422),
                                    ("<day-of-month> (ordinal)December", -5.885409345767477),
                                    ("Holiyear (latent)", -5.885409345767477),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.578556526327422),
                                    ("Holika Dahanyear (latent)", -5.885409345767477),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.173091418219258),
                                    ("dayminute", -3.228652439052818),
                                    ("Mawlidyear (latent)", -6.578556526327422),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.173091418219258),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.578556526327422),
                                    ("Jumu'atul-Widayear (latent)", -5.662265794453267),
                                    ("minuteday", -2.8290524503970516),
                                    ("absorption of , after named dayintersect",
                                     -5.885409345767477),
                                    ("intersectyear (latent)", -6.578556526327422),
                                    ("Orthodox Easter Sundayyear (latent)", -6.578556526327422),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.578556526327422),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.578556526327422),
                                    ("Mini-Tuesdayyear (latent)", -6.578556526327422),
                                    ("intersecthhhmm", -6.173091418219258),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.578556526327422),
                                    ("Boss's Dayyear (latent)", -6.173091418219258),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.578556526327422),
                                    ("Global Youth Service Dayyear (latent)", -6.578556526327422),
                                    ("Dhanterasin|during <named-month>|year", -6.578556526327422),
                                    ("Super Tuesdayin|during <named-month>|year",
                                     -6.578556526327422),
                                    ("tonight<time-of-day> o'clock", -6.578556526327422),
                                    ("Tisha B'Avyear (latent)", -6.578556526327422),
                                    ("Isra and Mi'rajyear (latent)", -5.662265794453267),
                                    ("at <time-of-day>on <day>", -4.969118613893322),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.173091418219258),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.885409345767477),
                                    ("Christmasyear (latent)", -6.173091418219258),
                                    ("Saturdayintersect", -6.578556526327422),
                                    ("Naraka Chaturdashiyear (latent)", -6.173091418219258),
                                    ("Thai Pongalin|during <named-month>|year", -6.578556526327422),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.578556526327422),
                                    ("dayweek", -6.578556526327422),
                                    ("Easter Sundayyear (latent)", -5.885409345767477),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.173091418219258),
                                    ("weekyear", -5.479944237659313),
                                    ("Super Tuesdaythis|last|next <cycle>", -6.578556526327422),
                                    ("King's Dayyear (latent)", -5.074479129551149),
                                    ("hh:mmin|during the <part-of-day>", -5.662265794453267),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.173091418219258),
                                    ("first|second|third|fourth|fifth <day-of-week> of <time>year (latent)",
                                     -5.885409345767477),
                                    ("Hanukkahyear (latent)", -5.885409345767477),
                                    ("Rama Navamiyear (latent)", -6.578556526327422),
                                    ("February<time> <part-of-day>", -6.578556526327422),
                                    ("National Grandparents Dayyear (latent)", -6.578556526327422),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.885409345767477),
                                    ("Great Lentyear (latent)", -6.578556526327422),
                                    ("tomorrowat <time-of-day>", -5.885409345767477),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.578556526327422),
                                    ("Labor Dayyear (latent)", -6.578556526327422),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.173091418219258),
                                    ("Ugadiyear (latent)", -5.192262165207532),
                                    ("Vaisakhiyear (latent)", -5.885409345767477),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.885409345767477),
                                    ("last <cycle> of <time>year (latent)", -5.885409345767477),
                                    ("at <time-of-day>tomorrow", -6.173091418219258),
                                    ("tomorrow<time-of-day> am|pm", -6.578556526327422),
                                    ("President's Dayyear (latent)", -6.578556526327422),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.578556526327422),
                                    ("Diwaliyear (latent)", -6.578556526327422),
                                    ("between <time> and <time>on <day>", -6.173091418219258),
                                    ("Black Fridayyear (latent)", -6.173091418219258),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.578556526327422),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.578556526327422),
                                    ("Chhathyear (latent)", -6.173091418219258),
                                    ("Vasant Panchamiyear (latent)", -6.578556526327422),
                                    ("Tax Dayyear (latent)", -5.479944237659313),
                                    ("Rabindra Jayantiyear (latent)", -5.325793557832054),
                                    ("this <part-of-day>at <time-of-day>", -5.325793557832054),
                                    ("St Patrick's Dayyear (latent)", -6.578556526327422),
                                    ("Thursday<time> (timezone)", -6.578556526327422),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.578556526327422),
                                    ("Pargat Diwasyear (latent)", -5.325793557832054),
                                    ("<datetime> - <datetime> (interval)July", -6.173091418219258),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.885409345767477),
                                    ("Februaryintersect", -6.578556526327422),
                                    ("Mother's Dayyear (latent)", -6.578556526327422),
                                    ("Simchat Torahyear (latent)", -6.578556526327422),
                                    ("minuteyear", -6.578556526327422)],
                               n = 553},
                   koData =
                     ClassData{prior = -1.0156459908722884,
                               unseen = -6.8690144506657065,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.670749831634073),
                                    ("hourday", -3.5721375429659634),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.174827228410347),
                                    ("<day-of-month> (ordinal)August", -6.174827228410347),
                                    ("dayhour", -3.5006785789838184),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.258536496536192),
                                    ("Tuesdayfrom|since|after <time>", -5.076214939742237),
                                    ("daymonth", -3.466777027308137),
                                    ("hourquarter", -5.258536496536192),
                                    ("monthday", -5.7693621203021825),
                                    ("monthyear", -4.922064259914979),
                                    ("Thai Pongalyear (latent)", -5.481680047850402),
                                    ("intersecthh:mm", -6.174827228410347),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.7693621203021825),
                                    ("<datetime> - <datetime> (interval)Sunday",
                                     -5.7693621203021825),
                                    ("<day-of-month> (ordinal)Wednesday", -6.174827228410347),
                                    ("houryear", -4.788532867290456),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.174827228410347),
                                    ("<day-of-month> (ordinal)October", -6.174827228410347),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.481680047850402),
                                    ("hournograin", -4.922064259914979),
                                    ("<time-of-day> am|pmintersect", -4.922064259914979),
                                    ("Octoberyear (latent)", -6.174827228410347),
                                    ("Good Fridayyear (latent)", -5.7693621203021825),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7693621203021825),
                                    ("early morningat <time-of-day>", -6.174827228410347),
                                    ("until <time>on <day>", -5.481680047850402),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.174827228410347),
                                    ("time-of-day (latent)intersect", -5.481680047850402),
                                    ("todayin <number> (implicit minutes)", -6.174827228410347),
                                    ("this <part-of-day><time-of-day> - <time-of-day> (interval)",
                                     -6.174827228410347),
                                    ("hh:mmon <day>", -4.922064259914979),
                                    ("hhhmmintersect", -5.7693621203021825),
                                    ("absorption of , after named dayJuly", -5.258536496536192),
                                    ("from|since|after <time>July", -5.7693621203021825),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.258536496536192),
                                    ("Clean Mondayyear (latent)", -6.174827228410347),
                                    ("monthhour", -6.174827228410347),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7693621203021825),
                                    ("hourmonth", -4.034761064914076),
                                    ("todayat <time-of-day>", -6.174827228410347),
                                    ("from|since|after <time>December", -6.174827228410347),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.174827228410347),
                                    ("<time-of-day> am|pmon <day>", -4.922064259914979),
                                    ("Mondayyear (latent)", -5.076214939742237),
                                    ("dayday", -3.8234519712468695),
                                    ("mm/ddat <time-of-day>", -5.7693621203021825),
                                    ("on <day>September", -5.481680047850402),
                                    ("time-of-day (latent)September", -5.7693621203021825),
                                    ("hourhour", -4.095385686730511),
                                    ("time-of-day (latent)on <day>", -4.670749831634073),
                                    ("<datetime> - <datetime> (interval)year (latent)",
                                     -6.174827228410347),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.7693621203021825),
                                    ("dayyear", -3.017826807260234),
                                    ("Thursdaymm/dd", -6.174827228410347),
                                    ("New Year's Dayyear (latent)", -5.258536496536192),
                                    ("Tuesdayyear (latent)", -5.076214939742237),
                                    ("time-of-day (latent)Sunday", -5.7693621203021825),
                                    ("Thursdayfrom|since|after <time>", -4.470079136171922),
                                    ("Thursdayat <time-of-day>", -4.565389315976247),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.174827228410347),
                                    ("Aprilyear (latent)", -6.174827228410347),
                                    ("the <day-of-month> (ordinal)July", -6.174827228410347),
                                    ("the <day-of-month> (number)July", -6.174827228410347),
                                    ("monthminute", -6.174827228410347),
                                    ("<time-of-day> am|pmtomorrow", -5.7693621203021825),
                                    ("Thursdayhh:mm", -5.258536496536192),
                                    ("<day-of-month> (ordinal)Tuesday", -5.7693621203021825),
                                    ("minutemonth", -4.034761064914076),
                                    ("time-of-day (latent)Friday", -5.7693621203021825),
                                    ("minutehour", -6.174827228410347),
                                    ("Tuesdayin <number> (implicit minutes)", -6.174827228410347),
                                    ("part of daysat <time-of-day>", -5.076214939742237),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.8234519712468695),
                                    ("<day-of-month> (ordinal)Sunday", -6.174827228410347),
                                    ("Augustyear (latent)", -5.7693621203021825),
                                    ("week-endin|during <named-month>|year", -6.174827228410347),
                                    ("time-of-day (latent)Tuesday", -5.7693621203021825),
                                    ...
                                    ("July<day-of-month> (ordinal or number) of <named-month>",
                                     -6.174827228410347),
                                    ("Tuesdayin|during <named-month>|year", -6.174827228410347),
                                    ("Sundayyear (latent)", -5.258536496536192),
                                    ("hourweek", -5.258536496536192),
                                    ("the <day-of-month> (ordinal)Monday", -5.481680047850402),
                                    ("Christmasat <time-of-day>", -6.174827228410347),
                                    ("from|since|after <time>year (latent)", -5.7693621203021825),
                                    ("hhhmmon <day>", -5.258536496536192),
                                    ("yesterday<time-of-day> am|pm", -6.174827228410347),
                                    ("<day-of-month> (ordinal)July", -5.481680047850402),
                                    ("Tuesday<duration> hence|ago", -6.174827228410347),
                                    ...
                                    ("August<day-of-month> (ordinal or number) of <named-month>",
                                     -6.174827228410347),
                                    ("Tuesdaythis|last|next <cycle>", -6.174827228410347),
                                    ("at <time-of-day>intersect", -5.258536496536192),
                                    ("Holiyear (latent)", -6.174827228410347),
                                    ("until <time><time-of-day> am|pm", -6.174827228410347),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7693621203021825),
                                    ("dayminute", -3.2844554705141826),
                                    ("yyyy-mm-ddhh:mm", -5.7693621203021825),
                                    ("intersectfrom|since|after <time>", -5.7693621203021825),
                                    ("intersectSeptember", -4.303025051508755),
                                    ("minuteday", -3.017826807260234),
                                    ("absorption of , after named dayintersect",
                                     -6.174827228410347),
                                    ("intersectyear (latent)", -6.174827228410347),
                                    ("Februaryin|during the <part-of-day>", -6.174827228410347),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.174827228410347),
                                    ("time-of-day (latent)July", -5.481680047850402),
                                    ("Saturdayyear (latent)", -6.174827228410347),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.174827228410347),
                                    ("<day-of-month> (ordinal)Monday", -4.922064259914979),
                                    ("at <time-of-day>on <day>", -5.258536496536192),
                                    ("absorption of , after named daySeptember",
                                     -4.922064259914979),
                                    ("Naraka Chaturdashiyear (latent)", -6.174827228410347),
                                    ("from|since|after <time>on <day>", -5.258536496536192),
                                    ("dayweek", -6.174827228410347),
                                    ("Easter Sundayyear (latent)", -5.7693621203021825),
                                    ("Thursday<time-of-day> am|pm", -4.922064259914979),
                                    ("weekyear", -5.7693621203021825),
                                    ("time-of-day (latent)Thursday", -5.7693621203021825),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.174827228410347),
                                    ("<day-of-month> (ordinal)April", -6.174827228410347),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.7693621203021825),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.481680047850402),
                                    ("Sundayfrom|since|after <time>", -6.174827228410347),
                                    ("absorption of , after named dayFebruary", -5.258536496536192),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.7693621203021825),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.174827228410347),
                                    ("tomorrowat <time-of-day>", -6.174827228410347),
                                    ("daynograin", -5.7693621203021825),
                                    ("Fridayin|during <named-month>|year", -6.174827228410347),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.7693621203021825),
                                    ("last <cycle> of <time>year (latent)", -5.7693621203021825),
                                    ("tomorrow<time-of-day> am|pm", -6.174827228410347),
                                    ("Diwaliyear (latent)", -5.7693621203021825),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.174827228410347),
                                    ("this <part-of-day>at <time-of-day>", -5.258536496536192),
                                    ("Fridayyear (latent)", -5.258536496536192),
                                    ("Tuesdayin|within|after <duration>", -6.174827228410347),
                                    ("time-of-day (latent)April", -6.174827228410347)],
                               n = 314}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -infinity, unseen = -0.6931471805599453,
       ...
       ("<day-of-month> (ordinal or number) of <named-month>",
        Classifier{okData =
                     ClassData{prior = -0.8109302162163288,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("ordinal (digits)July", -2.772588722239781),
                                    ("ordinals (first..twentieth,thirtieth,...)March",
                                     -1.6739764335716716),
                                    ("ordinal (digits)February", -2.772588722239781),
                                    ("integer (numeric)February", -2.367123614131617),
                                    ("month", -0.9007865453381898),
                                    ("ordinal (digits)March", -2.367123614131617),
                                    ("integer (numeric)July", -2.772588722239781)],
                               n = 12},
                   koData =
                     ClassData{prior = -0.587786664902119, unseen = -3.6635616461296463,
                               likelihoods =
                                 HashMap.fromList
                                   [("ordinal (digits)July", -1.6916760106710724),
                                    ("ordinal (digits)February", -2.9444389791664407),
                                    ("integer (numeric)August", -2.9444389791664407),
                                    ("month", -0.8649974374866046),
                                    ("integer (numeric)July", -1.55814461804655)],
                               n = 15}}),
       ("this <part-of-day>",
        Classifier{okData =
