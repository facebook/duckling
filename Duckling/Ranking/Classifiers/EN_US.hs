...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5637911593459034, unseen = -6.173786103901937,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 478},
                   koData =
                     ClassData{prior = -0.8417576800115882,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4394109261790191, unseen = -7.170888478512505,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.476972362889683),
                                    ("Father's Dayyear (latent)", -6.476972362889683),
                                    ...
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.090678001769792),
                                    ("Military Spouse Dayyear (latent)", -6.476972362889683),
                                    ("Bhai Doojyear (latent)", -6.476972362889683),
                                    ("hourday", -4.462069342347418),
                                    ("dayhour", -3.5325333837232424),
                                    ...
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.090678001769792),
                                    ("Thanksgiving Dayyear (latent)", -5.378360074221573),
                                    ...
                                    ("Daylight Saving Start Dayyear (latent)", -5.560681631015528),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.071507254781518),
                                    ("Daylight Saving End Dayyear (latent)", -5.560681631015528),
                                    ...
                                    ("Tax Daythis|last|next <cycle>", -6.476972362889683),
                                    ("dayday", -3.7689221617874726),
                                    ("<time> <part-of-day>at <time-of-day>", -6.476972362889683),
                                    ("mm/ddat <time-of-day>", -6.476972362889683),
                                    ("tonightat <time-of-day>", -6.476972362889683),
                                    ...
                                    ("mm/dd<time-of-day> am|pm", -6.476972362889683),
                                    ("hourhour", -4.3975308212098465),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.783825182329737),
                                    ("<time-of-day> am|pmtomorrow", -5.783825182329737),
                                    ("Yom Kippuryear (latent)", -6.476972362889683),
                                    ("<day-of-month> (ordinal)Tuesday", -6.071507254781518),
                                    ...
                                    ("part of daysat <time-of-day>", -6.071507254781518),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.071507254781518),
                                    ("Emancipation Dayyear (latent)", -5.783825182329737),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.476972362889683),
                                    ("Cyber Mondayyear (latent)", -6.071507254781518),
                                    ...
                                    ("National Grandparents Dayyear (latent)", -6.476972362889683),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.476972362889683),
                                    ...
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.476972362889683),
                                    ("Labor Dayyear (latent)", -6.476972362889683),
                                    ...
                                    ("President's Dayyear (latent)", -6.476972362889683),
                                    ...
                                    ("Tax Dayyear (latent)", -5.560681631015528),
                                    ...
                                    ("Mother's Dayyear (latent)", -6.476972362889683),
                                    ("Simchat Torahyear (latent)", -6.476972362889683),
                                    ("minuteyear", -6.476972362889683)],
                               n = 502},
                   koData =
                     ClassData{prior = -1.03399353968341, unseen = -6.7464121285733745,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.548011772148143),
                                    ("hourday", -3.654193896126046),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.052089168924417),
                                    ("<day-of-month> (ordinal)August", -6.052089168924417),
                                    ("dayhour", -3.377940519497888),
                                    ("<time> timezoneyear (latent)", -5.358941988364472),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.135798437050262),
                                    ("Tuesdayfrom|since|after <time>", -5.358941988364472),
                                    ("daymonth", -3.377940519497888),
                                    ("monthyear", -4.799326200429049),
                                    ("<time-of-day> am|pmyear (latent)", -5.358941988364472),
                                    ("Thai Pongalyear (latent)", -5.358941988364472),
                                    ("intersecthh:mm", -6.052089168924417),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.646624060816253),
                                    ("<day-of-month> (ordinal)Wednesday", -6.052089168924417),
                                    ("houryear", -4.665794807804526),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.052089168924417),
                                    ("<day-of-month> (ordinal)October", -6.052089168924417),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.358941988364472),
                                    ("hournograin", -4.799326200429049),
                                    ("<time-of-day> am|pmintersect", -4.799326200429049),
                                    ("Octoberyear (latent)", -6.052089168924417),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.646624060816253),
                                    ("until <time>on <day>", -5.358941988364472),
                                    ("time-of-day (latent)intersect", -5.358941988364472),
                                    ("todayin <number> (implicit minutes)", -6.052089168924417),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.358941988364472),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.052089168924417),
                                    ("hh:mmon <day>", -4.799326200429049),
                                    ("hhhmmintersect", -5.646624060816253),
                                    ("absorption of , after named dayJuly", -5.135798437050262),
                                    ("from|since|after <time>July", -5.646624060816253),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.135798437050262),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.646624060816253),
                                    ("hourmonth", -4.180286992022825),
                                    ("todayat <time-of-day>", -6.052089168924417),
                                    ("hhhmmyear (latent)", -4.799326200429049),
                                    ("from|since|after <time>December", -6.052089168924417),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.052089168924417),
                                    ("<time-of-day> am|pmon <day>", -4.799326200429049),
                                    ("Mondayyear (latent)", -4.953476880256307),
                                    ("dayday", -4.665794807804526),
                                    ("mm/ddat <time-of-day>", -5.646624060816253),
                                    ("on <day>September", -5.358941988364472),
                                    ("time-of-day (latent)September", -5.646624060816253),
                                    ("hourhour", -5.646624060816253),
                                    ("time-of-day (latent)on <day>", -4.548011772148143),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.646624060816253),
                                    ("dayyear", -3.056356895370426),
                                    ("Thursdaymm/dd", -6.052089168924417),
                                    ("New Year's Dayyear (latent)", -5.135798437050262),
                                    ("time-of-day (latent)Sunday", -5.646624060816253),
                                    ("Thursdayfrom|since|after <time>", -4.347341076685992),
                                    ("Thursdayat <time-of-day>", -4.442651256490317),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.052089168924417),
                                    ("Aprilyear (latent)", -6.052089168924417),
                                    ("the <day-of-month> (ordinal)July", -6.052089168924417),
                                    ("the <day-of-month> (number)July", -6.052089168924417),
                                    ("monthminute", -6.052089168924417),
                                    ("<time-of-day> am|pmtomorrow", -6.052089168924417),
                                    ("Thursdayhh:mm", -5.135798437050262),
                                    ("<day-of-month> (ordinal)Tuesday", -5.646624060816253),
                                    ("minutemonth", -3.912023005428146),
                                    ("time-of-day (latent)Friday", -5.646624060816253),
                                    ("minutehour", -6.052089168924417),
                                    ("Augustyear (latent)", -5.646624060816253),
                                    ("week-endin|during <named-month>|year", -6.052089168924417),
                                    ("time-of-day (latent)Tuesday", -5.646624060816253),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.646624060816253),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.052089168924417),
                                    ("Sundayyear (latent)", -5.135798437050262),
                                    ("Christmasat <time-of-day>", -6.052089168924417),
                                    ("from|since|after <time>year (latent)", -4.953476880256307),
                                    ("hhhmmon <day>", -5.135798437050262),
                                    ("yesterday<time-of-day> am|pm", -6.052089168924417),
                                    ("<day-of-month> (ordinal)July", -5.358941988364472),
                                    ...
                                    ("hh:mmyear (latent)", -4.665794807804526),
                                    ("Holiyear (latent)", -6.052089168924417),
                                    ("until <time><time-of-day> am|pm", -6.052089168924417),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.646624060816253),
                                    ("dayminute", -3.1898882879949486),
                                    ("yyyy-mm-ddhh:mm", -5.646624060816253),
                                    ("intersectfrom|since|after <time>", -5.646624060816253),
                                    ("intersectSeptember", -4.180286992022825),
                                    ("minuteday", -2.8950887477743037),
                                    ("absorption of , after named dayintersect",
                                     -6.052089168924417),
                                    ("intersectyear (latent)", -6.052089168924417),
                                    ("Februaryin|during the <part-of-day>", -6.052089168924417),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.052089168924417),
                                    ("time-of-day (latent)July", -5.358941988364472),
                                    ("Saturdayyear (latent)", -6.052089168924417),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.052089168924417),
                                    ("at <time-of-day>on <day>", -5.135798437050262),
                                    ("absorption of , after named daySeptember",
                                     -4.799326200429049),
                                    ("Naraka Chaturdashiyear (latent)", -6.052089168924417),
                                    ("from|since|after <time>on <day>", -5.135798437050262),
                                    ("dayweek", -6.052089168924417),
                                    ("Easter Sundayyear (latent)", -5.646624060816253),
                                    ("Thursday<time-of-day> am|pm", -4.799326200429049),
                                    ("weekyear", -5.646624060816253),
                                    ("time-of-day (latent)Thursday", -5.646624060816253),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.052089168924417),
                                    ("<day-of-month> (ordinal)April", -6.052089168924417),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.646624060816253),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.358941988364472),
                                    ("Sundayfrom|since|after <time>", -6.052089168924417),
                                    ("absorption of , after named dayFebruary", -5.135798437050262),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.646624060816253),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.052089168924417),
                                    ("tomorrowat <time-of-day>", -6.052089168924417),
                                    ("daynograin", -5.646624060816253),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.646624060816253),
                                    ("last <cycle> of <time>year (latent)", -5.646624060816253),
                                    ("tomorrow<time-of-day> am|pm", -6.052089168924417),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.358941988364472),
                                    ("Diwaliyear (latent)", -5.646624060816253),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.052089168924417),
                                    ("Fridayyear (latent)", -5.646624060816253),
                                    ("time-of-day (latent)April", -6.052089168924417),
                                    ("minuteyear", -3.8548645915881976)],
                               n = 277}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.13201815147825544, unseen = -5.53338948872752,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 248},
                   koData =
                     ClassData{prior = -2.0900988361538237,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
