...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5610996878960942, unseen = -6.180016653652572,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 481},
                   koData =
                     ClassData{prior = -0.8453227461760844,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.43729631126995133,
                               unseen = -7.177782416195197,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.483871585349955),
                                    ("Father's Dayyear (latent)", -6.483871585349955),
                                    ("Karva Chauthyear (latent)", -6.483871585349955),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.483871585349955),
                                    ("Maha Shivaratriyear (latent)", -6.483871585349955),
                                    ("Ramadanyear (latent)", -5.231108616854587),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.097577224230064),
                                    ("Military Spouse Dayyear (latent)", -6.483871585349955),
                                    ("Bhai Doojyear (latent)", -6.483871585349955),
                                    ("hourday", -4.46896856480769), ("dayhour", -3.539432606183514),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.097577224230064),
                                    ("Martin Luther King's Dayyear (latent)", -6.07840647724179),
                                    ("Shemini Atzeretyear (latent)", -6.483871585349955),
                                    ("daymonth", -4.46896856480769),
                                    ("monthday", -6.07840647724179),
                                    ("monthyear", -4.6921121161218995),
                                    ("Yom Ha'atzmautyear (latent)", -6.483871585349955),
                                    ("Vijayadashamiyear (latent)", -6.483871585349955),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.097577224230064),
                                    ("Thanksgiving Dayyear (latent)", -5.385259296681845),
                                    ("Thai Pongalyear (latent)", -5.7907244047900095),
                                    ("Thiru Onamyear (latent)", -5.7907244047900095),
                                    ("hhhmmabsorption of , after named day", -6.483871585349955),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.483871585349955),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.5675808534758),
                                    ("<day-of-month> (ordinal)Wednesday", -6.483871585349955),
                                    ("Krishna Janmashtamiyear (latent)", -6.07840647724179),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.483871585349955),
                                    ("houryear", -5.5675808534758),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.483871585349955),
                                    ("Christmas<time-of-day> am|pm", -6.483871585349955),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.483871585349955),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7907244047900095),
                                    ("intersectin|during <named-month>|year", -6.483871585349955),
                                    ("<time-of-day> am|pmintersect", -5.231108616854587),
                                    ("Earth Houryear (latent)", -6.483871585349955),
                                    ("Ganesh Chaturthiyear (latent)", -6.483871585349955),
                                    ("Octoberyear (latent)", -4.97979418857368),
                                    ("intersect<time-of-day> am|pm", -6.483871585349955),
                                    ("Mattu Pongalyear (latent)", -6.483871585349955),
                                    ("Daylight Saving Start Dayyear (latent)", -5.5675808534758),
                                    ("Shavuotyear (latent)", -6.483871585349955),
                                    ("Parsi New Yearyear (latent)", -5.5675808534758),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.483871585349955),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.483871585349955),
                                    ("todayin|within|after <duration>", -6.483871585349955),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.07840647724179),
                                    ("Marchyear (latent)", -6.483871585349955),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.07840647724179),
                                    ("Sukkotyear (latent)", -6.07840647724179),
                                    ("hhhmmintersect", -6.07840647724179),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.07840647724179),
                                    ("Daylight Saving End Dayyear (latent)", -5.5675808534758),
                                    ("Clean Mondayyear (latent)", -6.07840647724179),
                                    ("monthhour", -6.07840647724179),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7907244047900095),
                                    ("todayat <time-of-day>", -6.483871585349955),
                                    ("Thursday<time> timezone", -4.085976312551584),
                                    ("time-of-day (latent)tonight", -6.07840647724179),
                                    ("from|since|after <time>December", -6.483871585349955),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.483871585349955),
                                    ("<time-of-day> am|pmon <day>", -4.46896856480769),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.483871585349955),
                                    ("yyyy-mm-ddhh:mm:ss", -6.07840647724179),
                                    ("Tax Daythis|last|next <cycle>", -6.483871585349955),
                                    ("dayday", -3.7758213842477444),
                                    ("<time> <part-of-day>at <time-of-day>", -6.483871585349955),
                                    ("mm/ddat <time-of-day>", -6.483871585349955),
                                    ("tonightat <time-of-day>", -6.483871585349955),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.7907244047900095),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.483871585349955),
                                    ("today<time-of-day> am|pm", -6.483871585349955),
                                    ("Februarythe <day-of-month> (ordinal)", -6.07840647724179),
                                    ("at <time-of-day><time> <part-of-day>", -6.483871585349955),
                                    ("<day-of-month> (ordinal)intersect", -6.07840647724179),
                                    ("mm/dd<time-of-day> am|pm", -6.483871585349955),
                                    ("hourhour", -4.404430043670119),
                                    ("Mahavir Jayantiyear (latent)", -6.07840647724179),
                                    ("Navaratriin|during <named-month>|year", -6.483871585349955),
                                    ("Wednesdaythis|last|next <cycle>", -6.483871585349955),
                                    ("Lentyear (latent)", -6.483871585349955),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.612069408448363),
                                    ("Boghiyear (latent)", -6.483871585349955),
                                    ("dayyear", -1.76537271405486),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.483871585349955),
                                    ("Thursdayfrom|since|after <time>", -6.07840647724179),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.483871585349955),
                                    ("Thursdayat <time-of-day>", -5.7907244047900095),
                                    ("Islamic New Yearyear (latent)", -6.07840647724179),
                                    ("Laylat al-Qadryear (latent)", -5.5675808534758),
                                    ("Shrove Tuesdayyear (latent)", -6.483871585349955),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.7907244047900095),
                                    ("<time-of-day> am|pmtomorrow", -5.7907244047900095),
                                    ("Yom Kippuryear (latent)", -6.483871585349955),
                                    ("<day-of-month> (ordinal)Tuesday", -6.07840647724179),
                                    ("<part-of-day> of <time>year (latent)", -6.483871585349955),
                                    ("minutehour", -5.231108616854587),
                                    ("Kaanum Pongalyear (latent)", -6.07840647724179),
                                    ("Maha Saptamiyear (latent)", -6.483871585349955),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.07840647724179),
                                    ("time-of-day (latent)tomorrow", -5.5675808534758),
                                    ("part of daysat <time-of-day>", -6.07840647724179),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.46896856480769),
                                    ("for <duration> from <time>December", -6.483871585349955),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.483871585349955),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.231108616854587),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.231108616854587),
                                    ("time-of-day (latent)this <part-of-day>", -6.483871585349955),
                                    ("Pentecostyear (latent)", -6.483871585349955),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.231108616854587),
                                    ("<day-of-month> (ordinal)February", -6.483871585349955),
                                    ("Eid al-Fitryear (latent)", -5.097577224230064),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.483871585349955),
                                    ("Mondayin|during the <part-of-day>", -6.483871585349955),
                                    ("Chhathin|during <named-month>|year", -6.483871585349955),
                                    ("Diwaliin|during <named-month>|year", -6.483871585349955),
                                    ("Vaisakhiin|during <named-month>|year", -6.483871585349955),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.231108616854587),
                                    ("Raksha Bandhanyear (latent)", -6.483871585349955),
                                    ("daysecond", -6.07840647724179),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.07840647724179),
                                    ("Emancipation Dayyear (latent)", -5.7907244047900095),
                                    ("Ratha-Yatrayear (latent)", -6.483871585349955),
                                    ("Ashurayear (latent)", -6.483871585349955),
                                    ("Tuesdayin|during <named-month>|year", -6.483871585349955),
                                    ("Chinese New Yearyear (latent)", -6.483871585349955),
                                    ("tomorrowintersect", -6.483871585349955),
                                    ("Lag BaOmeryear (latent)", -6.483871585349955),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.483871585349955),
                                    ("Eid al-Adhayear (latent)", -4.343805421853684),
                                    ("intersectin|during the <part-of-day>", -6.483871585349955),
                                    ("Palm Sundayyear (latent)", -6.483871585349955),
                                    ("Christmasat <time-of-day>", -6.483871585349955),
                                    ("Passoveryear (latent)", -6.483871585349955),
                                    ("Lazarus Saturdayyear (latent)", -6.483871585349955),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.483871585349955),
                                    ("Cyber Mondayyear (latent)", -6.07840647724179),
                                    ("hhhmmon <day>", -5.5675808534758),
                                    ("Yom HaShoahyear (latent)", -6.07840647724179),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.07840647724179),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.483871585349955),
                                    ("Septemberyear (latent)", -6.07840647724179),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.97979418857368),
                                    ("Halloweenyear (latent)", -6.483871585349955),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.483871585349955),
                                    ("at <time-of-day>intersect", -5.5675808534758),
                                    ("Rosh Hashanahyear (latent)", -5.7907244047900095),
                                    ("Dhanterasyear (latent)", -6.483871585349955),
                                    ("Tu BiShvatyear (latent)", -6.483871585349955),
                                    ("<day-of-month> (ordinal)December", -5.7907244047900095),
                                    ("Holiyear (latent)", -5.7907244047900095),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.483871585349955),
                                    ("Holika Dahanyear (latent)", -5.7907244047900095),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.07840647724179),
                                    ("dayminute", -3.13396749807535),
                                    ("Mawlidyear (latent)", -6.483871585349955),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.07840647724179),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.483871585349955),
                                    ("Jumu'atul-Widayear (latent)", -5.5675808534758),
                                    ("minuteday", -2.746201967066586),
                                    ("absorption of , after named dayintersect",
                                     -5.7907244047900095),
                                    ("intersectyear (latent)", -6.483871585349955),
                                    ("Orthodox Easter Sundayyear (latent)", -6.483871585349955),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.483871585349955),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.483871585349955),
                                    ("intersecthhhmm", -6.07840647724179),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.483871585349955),
                                    ("Boss's Dayyear (latent)", -6.07840647724179),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.483871585349955),
                                    ("Global Youth Service Dayyear (latent)", -6.483871585349955),
                                    ("Dhanterasin|during <named-month>|year", -6.483871585349955),
                                    ("Tisha B'Avyear (latent)", -6.483871585349955),
                                    ("Isra and Mi'rajyear (latent)", -5.5675808534758),
                                    ("at <time-of-day>on <day>", -4.874433672915854),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.07840647724179),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.7907244047900095),
                                    ("Christmasyear (latent)", -6.07840647724179),
                                    ("Naraka Chaturdashiyear (latent)", -6.07840647724179),
                                    ("Thai Pongalin|during <named-month>|year", -6.483871585349955),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.483871585349955),
                                    ("dayweek", -6.483871585349955),
                                    ("Easter Sundayyear (latent)", -5.7907244047900095),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.07840647724179),
                                    ("weekyear", -5.385259296681845),
                                    ("King's Dayyear (latent)", -4.97979418857368),
                                    ("hh:mmin|during the <part-of-day>", -5.5675808534758),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.07840647724179),
                                    ("Hanukkahyear (latent)", -5.7907244047900095),
                                    ("Rama Navamiyear (latent)", -6.483871585349955),
                                    ("February<time> <part-of-day>", -6.483871585349955),
                                    ("National Grandparents Dayyear (latent)", -6.483871585349955),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.483871585349955),
                                    ("Great Lentyear (latent)", -6.483871585349955),
                                    ("tomorrowat <time-of-day>", -5.7907244047900095),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.483871585349955),
                                    ("Labor Dayyear (latent)", -6.483871585349955),
                                    ("Ugadiyear (latent)", -5.097577224230064),
                                    ("Vaisakhiyear (latent)", -5.7907244047900095),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.7907244047900095),
                                    ("last <cycle> of <time>year (latent)", -5.7907244047900095),
                                    ("at <time-of-day>tomorrow", -6.07840647724179),
                                    ("tomorrow<time-of-day> am|pm", -6.483871585349955),
                                    ("President's Dayyear (latent)", -6.483871585349955),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.483871585349955),
                                    ("Diwaliyear (latent)", -6.483871585349955),
                                    ("between <time> and <time>on <day>", -6.07840647724179),
                                    ("Black Fridayyear (latent)", -6.07840647724179),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.483871585349955),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.483871585349955),
                                    ("Chhathyear (latent)", -6.07840647724179),
                                    ("Vasant Panchamiyear (latent)", -6.483871585349955),
                                    ("Tax Dayyear (latent)", -5.5675808534758),
                                    ("Rabindra Jayantiyear (latent)", -5.231108616854587),
                                    ("St Patrick's Dayyear (latent)", -6.483871585349955),
                                    ("Thursday<time> (timezone)", -6.483871585349955),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.483871585349955),
                                    ("Pargat Diwasyear (latent)", -5.231108616854587),
                                    ("<datetime> - <datetime> (interval)July", -6.07840647724179),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.7907244047900095),
                                    ("Februaryintersect", -6.483871585349955),
                                    ("Mother's Dayyear (latent)", -6.483871585349955),
                                    ("Simchat Torahyear (latent)", -6.483871585349955),
                                    ("minuteyear", -6.483871585349955)],
                               n = 505},
                   koData =
                     ClassData{prior = -1.0378372343579727, unseen = -6.74993119378857,
                               likelihoods =
                                 HashMap.fromList
