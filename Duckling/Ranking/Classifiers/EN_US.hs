...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6053014272181959, unseen = -5.796057750765372,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 327},
                   koData =
                     ClassData{prior = -0.7894595318194519,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4454509322398565, unseen = -6.79794041297493,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.10367653771491),
                                    ("Father's Dayyear (latent)", -6.10367653771491),
                                    ("Ramadanyear (latent)", -6.10367653771491),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.850913569219542),
                                    ("Military Spouse Dayyear (latent)", -6.10367653771491),
                                    ("Bhai Doojyear (latent)", -6.10367653771491),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.850913569219542),
                                    ("hourday", -4.398928445476485),
                                    ("dayhour", -3.300316156808375),
                                    ("Martin Luther King's Dayyear (latent)", -5.698211429606745),
                                    ("Shemini Atzeretyear (latent)", -6.10367653771491),
                                    ("daymonth", -5.187385805840755),
                                    ("monthday", -5.698211429606745),
                                    ("monthyear", -4.3119170684868555),
                                    ("Yom Ha'atzmautyear (latent)", -6.10367653771491),
                                    ("Vijayadashamiyear (latent)", -6.10367653771491),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -4.717382176595019),
                                    ("Thanksgiving Dayyear (latent)", -5.0050642490468),
                                    ("Thai Pongalyear (latent)", -5.410529357154965),
                                    ("Thiru Onamyear (latent)", -5.410529357154965),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.10367653771491),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.10367653771491),
                                    ("houryear", -5.410529357154965),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.10367653771491),
                                    ("Christmas<time-of-day> am|pm", -6.10367653771491),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.10367653771491),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.410529357154965),
                                    ("<time-of-day> am|pmintersect", -4.850913569219542),
                                    ("Earth Houryear (latent)", -6.10367653771491),
                                    ("Octoberyear (latent)", -4.599599140938636),
                                    ("intersect<time-of-day> am|pm", -6.10367653771491),
                                    ("Mattu Pongalyear (latent)", -6.10367653771491),
                                    ("Shavuotyear (latent)", -6.10367653771491),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.10367653771491),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.10367653771491),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.698211429606745),
                                    ("Marchyear (latent)", -6.10367653771491),
                                    ("Sukkotyear (latent)", -5.698211429606745),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.10367653771491),
                                    ("Clean Mondayyear (latent)", -5.698211429606745),
                                    ("monthhour", -5.698211429606745),
                                    ("todayat <time-of-day>", -6.10367653771491),
                                    ("Thursday<time> timezone", -4.398928445476485),
                                    ("from|since|after <time>December", -6.10367653771491),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.10367653771491),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -6.10367653771491),
                                    ("yyyy-mm-ddhh:mm:ss", -5.698211429606745),
                                    ("Tax Daythis|last|next <cycle>", -6.10367653771491),
                                    ("dayday", -4.088773517172645),
                                    ("<time> <part-of-day>at <time-of-day>", -6.10367653771491),
                                    ("mm/ddat <time-of-day>", -6.10367653771491),
                                    ("tonightat <time-of-day>", -6.10367653771491),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.410529357154965),
                                    ("today<time-of-day> am|pm", -6.10367653771491),
                                    ("Februarythe <day-of-month> (ordinal)", -5.698211429606745),
                                    ("at <time-of-day><time> <part-of-day>", -6.10367653771491),
                                    ("mm/dd<time-of-day> am|pm", -6.10367653771491),
                                    ("hourhour", -4.850913569219542),
                                    ("<time-of-day> am|pmon <date>", -4.088773517172645),
                                    ("Navaratriin|during <named-month>|year", -6.10367653771491),
                                    ("Wednesdaythis|last|next <cycle>", -6.10367653771491),
                                    ("Lentyear (latent)", -6.10367653771491),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.599599140938636),
                                    ("Boghiyear (latent)", -6.10367653771491),
                                    ("dayyear", -1.8768427924467304),
                                    ("Thursdayfrom|since|after <time>", -5.698211429606745),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.10367653771491),
                                    ("Thursdayat <time-of-day>", -5.698211429606745),
                                    ("Islamic New Yearyear (latent)", -5.698211429606745),
                                    ("Laylat al-Qadryear (latent)", -5.187385805840755),
                                    ("Shrove Tuesdayyear (latent)", -6.10367653771491),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.410529357154965),
                                    ("<time-of-day> am|pmtomorrow", -5.410529357154965),
                                    ("Yom Kippuryear (latent)", -6.10367653771491),
                                    ("<part-of-day> of <time>year (latent)", -6.10367653771491),
                                    ("minutehour", -5.187385805840755),
                                    ("Kaanum Pongalyear (latent)", -5.698211429606745),
                                    ("Maha Saptamiyear (latent)", -6.10367653771491),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.698211429606745),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.398928445476485),
                                    ("for <duration> from <time>December", -6.10367653771491),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.10367653771491),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.187385805840755),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.698211429606745),
                                    ("Pentecostyear (latent)", -6.10367653771491),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.187385805840755),
                                    ("Eid al-Fitryear (latent)", -6.10367653771491),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.10367653771491),
                                    ("Mondayin|during the <part-of-day>", -6.10367653771491),
                                    ("Chhathin|during <named-month>|year", -6.10367653771491),
                                    ("Diwaliin|during <named-month>|year", -6.10367653771491),
                                    ("Raksha Bandhanyear (latent)", -6.10367653771491),
                                    ("daysecond", -5.698211429606745),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.698211429606745),
                                    ("Emancipation Dayyear (latent)", -5.410529357154965),
                                    ("Ashurayear (latent)", -6.10367653771491),
                                    ("Tuesdayin|during <named-month>|year", -6.10367653771491),
                                    ("Chinese New Yearyear (latent)", -6.10367653771491),
                                    ("Lag BaOmeryear (latent)", -6.10367653771491),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.10367653771491),
                                    ("Eid al-Adhayear (latent)", -5.187385805840755),
                                    ("intersectin|during the <part-of-day>", -6.10367653771491),
                                    ("Palm Sundayyear (latent)", -6.10367653771491),
                                    ("Christmasat <time-of-day>", -6.10367653771491),
                                    ("Passoveryear (latent)", -6.10367653771491),
                                    ("Lazarus Saturdayyear (latent)", -6.10367653771491),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.10367653771491),
                                    ("Cyber Mondayyear (latent)", -5.698211429606745),
                                    ("Yom HaShoahyear (latent)", -5.698211429606745),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.698211429606745),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.10367653771491),
                                    ("Septemberyear (latent)", -5.698211429606745),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.850913569219542),
                                    ("Halloweenyear (latent)", -6.10367653771491),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.10367653771491),
                                    ("at <time-of-day>intersect", -5.698211429606745),
                                    ("Rosh Hashanahyear (latent)", -5.410529357154965),
                                    ("Dhanterasyear (latent)", -6.10367653771491),
                                    ("Tu BiShvatyear (latent)", -6.10367653771491),
                                    ("Holiyear (latent)", -5.410529357154965),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.10367653771491),
                                    ("Holika Dahanyear (latent)", -5.410529357154965),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.10367653771491),
                                    ("dayminute", -3.464619208099651),
                                    ("Mawlidyear (latent)", -6.10367653771491),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.698211429606745),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.10367653771491),
                                    ("Jumu'atul-Widayear (latent)", -5.187385805840755),
                                    ("minuteday", -2.4660903779885244),
                                    ("absorption of , after named dayintersect", -6.10367653771491),
                                    ("Orthodox Easter Sundayyear (latent)", -6.10367653771491),
                                    ("<ordinal> <cycle> of <time>year (latent)", -6.10367653771491),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.10367653771491),
                                    ("Boss's Dayyear (latent)", -5.698211429606745),
                                    ("Global Youth Service Dayyear (latent)", -6.10367653771491),
                                    ("Dhanterasin|during <named-month>|year", -6.10367653771491),
                                    ("Tisha B'Avyear (latent)", -6.10367653771491),
                                    ("Isra and Mi'rajyear (latent)", -5.187385805840755),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.10367653771491),
                                    ("Christmasyear (latent)", -5.698211429606745),
                                    ("Naraka Chaturdashiyear (latent)", -5.698211429606745),
                                    ("at <time-of-day>on <date>", -5.0050642490468),
                                    ("Thai Pongalin|during <named-month>|year", -6.10367653771491),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.10367653771491),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.4942386252808095),
                                    ("dayweek", -6.10367653771491),
                                    ("Easter Sundayyear (latent)", -5.410529357154965),
                                    ("weekyear", -5.0050642490468),
                                    ("hh:mmin|during the <part-of-day>", -5.410529357154965),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.698211429606745),
                                    ("Hanukkahyear (latent)", -5.410529357154965),
                                    ("February<time> <part-of-day>", -6.10367653771491),
                                    ("National Grandparents Dayyear (latent)", -6.10367653771491),
                                    ("Great Lentyear (latent)", -6.10367653771491),
                                    ("tomorrowat <time-of-day>", -5.410529357154965),
                                    ("Labor Dayyear (latent)", -6.10367653771491),
                                    ("between <time> and <time>on <date>", -4.4942386252808095),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.10367653771491),
                                    ("last <cycle> of <time>year (latent)", -5.410529357154965),
                                    ("at <time-of-day>tomorrow", -5.698211429606745),
                                    ("tomorrow<time-of-day> am|pm", -6.10367653771491),
                                    ("President's Dayyear (latent)", -6.10367653771491),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.10367653771491),
                                    ("Diwaliyear (latent)", -6.10367653771491),
                                    ("Black Fridayyear (latent)", -5.698211429606745),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.10367653771491),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.10367653771491),
                                    ("Chhathyear (latent)", -5.698211429606745),
                                    ("Vasant Panchamiyear (latent)", -6.10367653771491),
                                    ("Tax Dayyear (latent)", -5.187385805840755),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.10367653771491),
                                    ("Februaryintersect", -6.10367653771491),
                                    ("Mother's Dayyear (latent)", -6.10367653771491),
                                    ("Simchat Torahyear (latent)", -6.10367653771491),
                                    ("minuteyear", -6.10367653771491)],
                               n = 335},
                   koData =
                     ClassData{prior = -1.0231395012349735, unseen = -6.400257445308821,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.789157022101107),
                                    ("hourday", -4.789157022101107),
                                    ("dayhour", -3.1404983965137254),
                                    ("Tuesdayfrom|since|after <time>", -5.705447753975262),
                                    ("daymonth", -3.6905447334329975),
                                    ("monthyear", -4.452684785479894),
                                    ("<time-of-day> am|pmyear (latent)", -5.2999826458670976),
                                    ("Thai Pongalyear (latent)", -5.012300573415317),
                                    ("intersecthh:mm", -5.705447753975262),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.705447753975262),
                                    ("houryear", -4.789157022101107),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.705447753975262),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.012300573415317),
                                    ("<time-of-day> am|pmintersect", -4.452684785479894),
                                    ("until <time>on <date>", -5.012300573415317),
                                    ...
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.705447753975262),
                                    ("Mondayyear (latent)", -4.606835465307152),
                                    ("dayday", -5.2999826458670976),
                                    ("mm/ddat <time-of-day>", -5.2999826458670976),
                                    ("<time-of-day> am|pmon <date>", -4.452684785479894),
                                    ("dayyear", -2.761008774808822),
                                    ("Thursdaymm/dd", -5.705447753975262),
                                    ("New Year's Dayyear (latent)", -5.2999826458670976),
                                    ("Thursdayfrom|since|after <time>", -4.000699661736837),
                                    ("Thursdayat <time-of-day>", -4.452684785479894),
                                    ...
                                    ("hh:mmon <date>", -3.6905447334329975),
                                    ("Saturdayyear (latent)", -5.705447753975262),
                                    ("from|since|after <time>on <date>", -4.789157022101107),
                                    ("absorption of , after named daySeptember",
                                     -4.789157022101107),
                                    ("Naraka Chaturdashiyear (latent)", -5.705447753975262),
                                    ("on <date>September", -5.2999826458670976),
                                    ("at <time-of-day>on <date>", -5.2999826458670976),
                                    ("dayweek", -5.705447753975262),
                                    ("Easter Sundayyear (latent)", -5.2999826458670976),
                                    ("Thursday<time-of-day> am|pm", -5.012300573415317),
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.19979618731721863, unseen = -5.41610040220442,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 104},
                   koData =
                     ClassData{prior = -1.7086928705294415, unseen = -4.143134726391533,
                               likelihoods =
                                 HashMap.fromList
