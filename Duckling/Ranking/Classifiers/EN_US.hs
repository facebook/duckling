...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4822681481830997, unseen = -7.264730177929867,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.570882962339584),
                                    ("Father's Dayyear (latent)", -6.570882962339584),
                                    ("Karva Chauthyear (latent)", -6.570882962339584),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.570882962339584),
                                    ("Maha Shivaratriyear (latent)", -6.570882962339584),
                                    ("Ramadanyear (latent)", -5.318119993844216),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.184588601219693),
                                    ("Military Spouse Dayyear (latent)", -6.570882962339584),
                                    ("Bhai Doojyear (latent)", -6.570882962339584),
                                    ("hourday", -4.55597994179732), ("dayhour", -3.550458076195222),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.184588601219693),
                                    ("Martin Luther King's Dayyear (latent)", -6.16541785423142),
                                    ("Shemini Atzeretyear (latent)", -6.570882962339584),
                                    ("daymonth", -4.55597994179732),
                                    ("monthday", -6.16541785423142),
                                    ("monthyear", -4.77912349311153),
                                    ("Yom Ha'atzmautyear (latent)", -6.570882962339584),
                                    ("Orthodox Good Fridayyear (latent)", -6.16541785423142),
                                    ("Vijayadashamiyear (latent)", -6.570882962339584),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.184588601219693),
                                    ("Thanksgiving Dayyear (latent)", -5.472270673671475),
                                    ("Thai Pongalyear (latent)", -5.877735781779639),
                                    ("Thiru Onamyear (latent)", -5.877735781779639),
                                    ("hhhmmabsorption of , after named day", -6.570882962339584),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.570882962339584),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.654592230465429),
                                    ("<day-of-month> (ordinal)Wednesday", -6.570882962339584),
                                    ("Krishna Janmashtamiyear (latent)", -6.16541785423142),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.570882962339584),
                                    ("houryear", -5.654592230465429),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.570882962339584),
                                    ("Christmas<time-of-day> am|pm", -6.570882962339584),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.570882962339584),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.877735781779639),
                                    ("intersectin|during <named-month>|year", -6.570882962339584),
                                    ("<time-of-day> am|pmintersect", -5.318119993844216),
                                    ("Earth Houryear (latent)", -6.570882962339584),
                                    ("Ganesh Chaturthiyear (latent)", -6.570882962339584),
                                    ("Octoberyear (latent)", -5.06680556556331),
                                    ("intersect<time-of-day> am|pm", -6.570882962339584),
                                    ("Mattu Pongalyear (latent)", -6.570882962339584),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.570882962339584),
                                    ("Daylight Saving Start Dayyear (latent)", -5.654592230465429),
                                    ("Shavuotyear (latent)", -6.570882962339584),
                                    ("Parsi New Yearyear (latent)", -5.654592230465429),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.570882962339584),
                                    ("the <day-of-month> (ordinal)intersect by \",\", \"of\", \"from\" for year",
                                     -6.570882962339584),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.570882962339584),
                                    ("todayin|within|after <duration>", -6.570882962339584),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.16541785423142),
                                    ("Marchyear (latent)", -6.570882962339584),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.16541785423142),
                                    ("Sukkotyear (latent)", -6.16541785423142),
                                    ("hhhmmintersect", -6.16541785423142),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.16541785423142),
                                    ("Daylight Saving End Dayyear (latent)", -5.654592230465429),
                                    ("Clean Mondayyear (latent)", -6.16541785423142),
                                    ("the <day-of-month> (ordinal)Sunday", -6.570882962339584),
                                    ("monthhour", -6.16541785423142),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.877735781779639),
                                    ("todayat <time-of-day>", -6.570882962339584),
                                    ("Thursday<time> timezone", -4.1729876895412135),
                                    ("tonight<time-of-day> am|pm", -6.570882962339584),
                                    ("time-of-day (latent)tonight", -6.16541785423142),
                                    ("from|since|after <time>December", -6.570882962339584),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.570882962339584),
                                    ("<time-of-day> am|pmon <day>", -4.55597994179732),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.570882962339584),
                                    ("yyyy-mm-ddhh:mm:ss", -6.16541785423142),
                                    ("Tax Daythis|last|next <cycle>", -6.570882962339584),
                                    ("dayday", -3.798294240099803),
                                    ("<time> <part-of-day>at <time-of-day>", -6.16541785423142),
                                    ("mm/ddat <time-of-day>", -6.570882962339584),
                                    ...
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.570882962339584),
                                    ("today<time-of-day> am|pm", -6.570882962339584),
                                    ("Februarythe <day-of-month> (ordinal)", -6.16541785423142),
                                    ("at <time-of-day><time> <part-of-day>", -6.570882962339584),
                                    ("<day-of-month> (ordinal)intersect", -6.16541785423142),
                                    ("mm/dd<time-of-day> am|pm", -6.570882962339584),
                                    ("hourhour", -3.6004684967698832),
                                    ("Mahavir Jayantiyear (latent)", -6.16541785423142),
                                    ("Navaratriin|during <named-month>|year", -6.570882962339584),
                                    ("Wednesdaythis|last|next <cycle>", -6.570882962339584),
                                    ("Lentyear (latent)", -6.570882962339584),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.699080785437993),
                                    ("Boghiyear (latent)", -6.570882962339584),
                                    ("dayyear", -1.8044446287553708),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.570882962339584),
                                    ("Thursdayfrom|since|after <time>", -6.16541785423142),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.570882962339584),
                                    ("Thursdayat <time-of-day>", -5.877735781779639),
                                    ("Islamic New Yearyear (latent)", -6.16541785423142),
                                    ("Laylat al-Qadryear (latent)", -5.654592230465429),
                                    ("part of days<time-of-day> am|pm", -6.570882962339584),
                                    ("Shrove Tuesdayyear (latent)", -6.570882962339584),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.877735781779639),
                                    ("hourminute", -6.16541785423142),
                                    ("<time-of-day> am|pmtomorrow", -5.654592230465429),
                                    ("Yom Kippuryear (latent)", -6.570882962339584),
                                    ("<day-of-month> (ordinal)Tuesday", -6.16541785423142),
                                    ("<part-of-day> of <time>year (latent)", -6.570882962339584),
                                    ("minutehour", -5.318119993844216),
                                    ("Kaanum Pongalyear (latent)", -6.16541785423142),
                                    ("Maha Saptamiyear (latent)", -6.570882962339584),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.877735781779639),
                                    ("time-of-day (latent)tomorrow", -5.654592230465429),
                                    ("part of daysat <time-of-day>", -4.961445049905484),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.55597994179732),
                                    ("for <duration> from <time>December", -6.570882962339584),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.570882962339584),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.318119993844216),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.318119993844216),
                                    ("time-of-day (latent)this <part-of-day>", -6.570882962339584),
                                    ("Pentecostyear (latent)", -6.570882962339584),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.318119993844216),
                                    ("<day-of-month> (ordinal)February", -6.570882962339584),
                                    ("Eid al-Fitryear (latent)", -5.184588601219693),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.570882962339584),
                                    ("Mini-Tuesday<duration> hence|ago", -6.570882962339584),
                                    ("Mondayin|during the <part-of-day>", -6.570882962339584),
                                    ("Chhathin|during <named-month>|year", -6.570882962339584),
                                    ("Diwaliin|during <named-month>|year", -6.570882962339584),
                                    ("this <part-of-day><time-of-day> am|pm", -6.570882962339584),
                                    ("Vaisakhiin|during <named-month>|year", -6.570882962339584),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.318119993844216),
                                    ("Raksha Bandhanyear (latent)", -6.570882962339584),
                                    ("daysecond", -6.16541785423142),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.16541785423142),
                                    ("Emancipation Dayyear (latent)", -5.877735781779639),
                                    ("Ratha-Yatrayear (latent)", -6.570882962339584),
                                    ("Ashurayear (latent)", -6.570882962339584),
                                    ("Tuesdayin|during <named-month>|year", -6.570882962339584),
                                    ("Chinese New Yearyear (latent)", -6.570882962339584),
                                    ("tomorrowintersect", -6.570882962339584),
                                    ("Lag BaOmeryear (latent)", -6.570882962339584),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.570882962339584),
                                    ("Eid al-Adhayear (latent)", -4.430816798843313),
                                    ("intersectin|during the <part-of-day>", -6.570882962339584),
                                    ("Palm Sundayyear (latent)", -6.570882962339584),
                                    ("Christmasat <time-of-day>", -6.570882962339584),
                                    ("Passoveryear (latent)", -6.570882962339584),
                                    ("Lazarus Saturdayyear (latent)", -6.570882962339584),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.570882962339584),
                                    ("Cyber Mondayyear (latent)", -6.16541785423142),
                                    ("hhhmmon <day>", -5.654592230465429),
                                    ("Yom HaShoahyear (latent)", -6.16541785423142),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.16541785423142),
                                    ("Septemberyear (latent)", -6.16541785423142),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.06680556556331),
                                    ("Halloweenyear (latent)", -6.570882962339584),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.570882962339584),
                                    ("at <time-of-day>intersect", -5.654592230465429),
                                    ("Rosh Hashanahyear (latent)", -5.877735781779639),
                                    ("Super Tuesdayyear (latent)", -5.654592230465429),
                                    ("Dhanterasyear (latent)", -6.570882962339584),
                                    ("Tu BiShvatyear (latent)", -6.570882962339584),
                                    ("<day-of-month> (ordinal)December", -5.877735781779639),
                                    ("Holiyear (latent)", -5.877735781779639),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.570882962339584),
                                    ("Holika Dahanyear (latent)", -5.877735781779639),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.16541785423142),
                                    ("dayminute", -3.2209788750649797),
                                    ("Mawlidyear (latent)", -6.570882962339584),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.16541785423142),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.570882962339584),
                                    ("Jumu'atul-Widayear (latent)", -5.654592230465429),
                                    ("minuteday", -2.8213788864092133),
                                    ("absorption of , after named dayintersect",
                                     -5.877735781779639),
                                    ("intersectyear (latent)", -6.570882962339584),
                                    ("Orthodox Easter Sundayyear (latent)", -6.570882962339584),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.570882962339584),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.570882962339584),
                                    ("Mini-Tuesdayyear (latent)", -6.570882962339584),
                                    ("intersecthhhmm", -6.16541785423142),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.570882962339584),
                                    ("Boss's Dayyear (latent)", -6.16541785423142),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.570882962339584),
                                    ("Global Youth Service Dayyear (latent)", -6.570882962339584),
                                    ("Dhanterasin|during <named-month>|year", -6.570882962339584),
                                    ("Super Tuesdayin|during <named-month>|year",
                                     -6.570882962339584),
                                    ("tonight<time-of-day> o'clock", -6.570882962339584),
                                    ("Tisha B'Avyear (latent)", -6.570882962339584),
                                    ("Isra and Mi'rajyear (latent)", -5.654592230465429),
                                    ("at <time-of-day>on <day>", -4.961445049905484),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.16541785423142),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.877735781779639),
                                    ("Christmasyear (latent)", -6.16541785423142),
                                    ("Saturdayintersect", -6.570882962339584),
                                    ("Naraka Chaturdashiyear (latent)", -6.16541785423142),
                                    ("Thai Pongalin|during <named-month>|year", -6.570882962339584),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.570882962339584),
                                    ("dayweek", -6.570882962339584),
                                    ("Easter Sundayyear (latent)", -5.877735781779639),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.16541785423142),
                                    ("weekyear", -5.472270673671475),
                                    ("Super Tuesdaythis|last|next <cycle>", -6.570882962339584),
                                    ("King's Dayyear (latent)", -5.06680556556331),
                                    ("hh:mmin|during the <part-of-day>", -5.654592230465429),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.16541785423142),
                                    ("Hanukkahyear (latent)", -5.877735781779639),
                                    ("Rama Navamiyear (latent)", -6.570882962339584),
                                    ("February<time> <part-of-day>", -6.570882962339584),
                                    ("National Grandparents Dayyear (latent)", -6.570882962339584),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.877735781779639),
                                    ("Great Lentyear (latent)", -6.570882962339584),
                                    ("tomorrowat <time-of-day>", -5.877735781779639),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.570882962339584),
                                    ("Labor Dayyear (latent)", -6.570882962339584),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.16541785423142),
                                    ("Ugadiyear (latent)", -5.184588601219693),
                                    ("Vaisakhiyear (latent)", -5.877735781779639),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.877735781779639),
                                    ("last <cycle> of <time>year (latent)", -5.877735781779639),
                                    ("at <time-of-day>tomorrow", -6.16541785423142),
                                    ("tomorrow<time-of-day> am|pm", -6.570882962339584),
                                    ("President's Dayyear (latent)", -6.570882962339584),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.570882962339584),
                                    ("Diwaliyear (latent)", -6.570882962339584),
                                    ("between <time> and <time>on <day>", -6.16541785423142),
                                    ("Black Fridayyear (latent)", -6.16541785423142),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.570882962339584),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.570882962339584),
                                    ("Chhathyear (latent)", -6.16541785423142),
                                    ("Vasant Panchamiyear (latent)", -6.570882962339584),
                                    ("Tax Dayyear (latent)", -5.472270673671475),
                                    ("Rabindra Jayantiyear (latent)", -5.318119993844216),
                                    ("this <part-of-day>at <time-of-day>", -5.318119993844216),
                                    ("St Patrick's Dayyear (latent)", -6.570882962339584),
                                    ("Thursday<time> (timezone)", -6.570882962339584),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.570882962339584),
                                    ("Pargat Diwasyear (latent)", -5.318119993844216),
                                    ("<datetime> - <datetime> (interval)July", -6.16541785423142),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.877735781779639),
                                    ("Februaryintersect", -6.570882962339584),
                                    ("Mother's Dayyear (latent)", -6.570882962339584),
                                    ("Simchat Torahyear (latent)", -6.570882962339584),
                                    ("minuteyear", -6.570882962339584)],
                               n = 547},
                   koData =
                     ClassData{prior = -0.9607168432246306, unseen = -6.920671504248683,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.722459272511191),
                                    ("hourday", -3.623846983843082),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.226536669287466),
                                    ("<day-of-month> (ordinal)August", -6.226536669287466),
                                    ("dayhour", -3.552388019860937),
                                    ("<time> timezoneyear (latent)", -5.53338948872752),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.310245937413311),
                                    ("Tuesdayfrom|since|after <time>", -5.127924380619356),
                                    ("daymonth", -3.552388019860937),
                                    ("hourquarter", -5.310245937413311),
                                    ("monthyear", -4.973773700792098),
                                    ("<time-of-day> am|pmyear (latent)", -5.53338948872752),
                                    ("Thai Pongalyear (latent)", -5.53338948872752),
                                    ("intersecthh:mm", -6.226536669287466),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.821071561179301),
                                    ("<datetime> - <datetime> (interval)Sunday",
                                     -5.821071561179301),
                                    ("<day-of-month> (ordinal)Wednesday", -6.226536669287466),
                                    ("houryear", -4.43477720005941),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.226536669287466),
                                    ("<day-of-month> (ordinal)October", -6.226536669287466),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.53338948872752),
                                    ("hournograin", -4.973773700792098),
                                    ("<time-of-day> am|pmintersect", -4.973773700792098),
                                    ("Octoberyear (latent)", -6.226536669287466),
                                    ("Good Fridayyear (latent)", -5.821071561179301),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.821071561179301),
                                    ("early morningat <time-of-day>", -6.226536669287466),
                                    ("until <time>on <day>", -5.53338948872752),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.226536669287466),
                                    ("time-of-day (latent)intersect", -5.53338948872752),
                                    ("todayin <number> (implicit minutes)", -6.226536669287466),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.53338948872752),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.226536669287466),
                                    ("hh:mmon <day>", -4.973773700792098),
                                    ("hhhmmintersect", -5.821071561179301),
                                    ("absorption of , after named dayJuly", -5.310245937413311),
                                    ("from|since|after <time>July", -5.821071561179301),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.310245937413311),
                                    ("Clean Mondayyear (latent)", -6.226536669287466),
                                    ("monthhour", -6.226536669287466),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.821071561179301),
                                    ("hourmonth", -4.086470505791195),
                                    ("todayat <time-of-day>", -6.226536669287466),
                                    ("hhhmmyear (latent)", -4.973773700792098),
                                    ("from|since|after <time>December", -6.226536669287466),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.226536669287466),
                                    ("<time-of-day> am|pmon <day>", -4.973773700792098),
                                    ("Mondayyear (latent)", -5.127924380619356),
                                    ("dayday", -3.9752448706809704),
                                    ("mm/ddat <time-of-day>", -5.821071561179301),
                                    ("on <day>September", -5.53338948872752),
                                    ("time-of-day (latent)September", -5.821071561179301),
                                    ("hourhour", -4.1470951276076295),
                                    ("time-of-day (latent)on <day>", -4.722459272511191),
                                    ("<datetime> - <datetime> (interval)year (latent)",
                                     -6.226536669287466),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.821071561179301),
                                    ("dayyear", -2.8943321591122615),
                                    ("Thursdaymm/dd", -6.226536669287466),
                                    ("New Year's Dayyear (latent)", -5.310245937413311),
                                    ("Tuesdayyear (latent)", -5.127924380619356),
                                    ("time-of-day (latent)Sunday", -5.821071561179301),
                                    ("Thursdayfrom|since|after <time>", -4.5217885770490405),
                                    ("Thursdayat <time-of-day>", -4.617098756853365),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.226536669287466),
                                    ("Aprilyear (latent)", -6.226536669287466),
                                    ("the <day-of-month> (ordinal)July", -6.226536669287466),
                                    ("the <day-of-month> (number)July", -6.226536669287466),
                                    ("monthminute", -6.226536669287466),
                                    ("<time-of-day> am|pmtomorrow", -5.821071561179301),
                                    ("Thursdayhh:mm", -5.310245937413311),
                                    ("<day-of-month> (ordinal)Tuesday", -5.821071561179301),
                                    ("minutemonth", -4.086470505791195),
                                    ("time-of-day (latent)Friday", -5.821071561179301),
                                    ("minutehour", -6.226536669287466),
                                    ("Tuesdayin <number> (implicit minutes)", -6.226536669287466),
                                    ("part of daysat <time-of-day>", -5.127924380619356),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.8751614121239877),
                                    ("<day-of-month> (ordinal)Sunday", -6.226536669287466),
                                    ("Augustyear (latent)", -5.821071561179301),
                                    ("week-endin|during <named-month>|year", -6.226536669287466),
                                    ("time-of-day (latent)Tuesday", -5.821071561179301),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.226536669287466),
                                    ("Tuesdayin|during <named-month>|year", -6.226536669287466),
                                    ("Sundayyear (latent)", -5.310245937413311),
                                    ("hourweek", -5.310245937413311),
                                    ("the <day-of-month> (ordinal)Monday", -5.53338948872752),
                                    ("Christmasat <time-of-day>", -6.226536669287466),
                                    ("from|since|after <time>year (latent)", -5.127924380619356),
                                    ("hhhmmon <day>", -5.310245937413311),
                                    ("yesterday<time-of-day> am|pm", -6.226536669287466),
                                    ("<day-of-month> (ordinal)July", -5.53338948872752),
                                    ("Tuesday<duration> hence|ago", -6.226536669287466),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.226536669287466),
                                    ("mm/ddyear (latent)", -6.226536669287466),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.226536669287466),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.226536669287466),
                                    ("Tuesdaythis|last|next <cycle>", -6.226536669287466),
                                    ("at <time-of-day>intersect", -5.310245937413311),
                                    ("hh:mmyear (latent)", -4.840242308167575),
                                    ("Holiyear (latent)", -6.226536669287466),
                                    ("until <time><time-of-day> am|pm", -6.226536669287466),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.821071561179301),
                                    ("dayminute", -3.336164911391301),
                                    ("yyyy-mm-ddhh:mm", -5.821071561179301),
                                    ("intersectfrom|since|after <time>", -5.821071561179301),
                                    ("intersectSeptember", -4.354734492385874),
                                    ("minuteday", -3.0695362481373523),
                                    ("absorption of , after named dayintersect",
                                     -6.226536669287466),
                                    ("intersectyear (latent)", -6.226536669287466),
                                    ("Februaryin|during the <part-of-day>", -6.226536669287466),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.226536669287466),
                                    ("time-of-day (latent)July", -5.53338948872752),
                                    ("Saturdayyear (latent)", -6.226536669287466),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.226536669287466),
                                    ("<day-of-month> (ordinal)Monday", -5.310245937413311),
                                    ("at <time-of-day>on <day>", -5.310245937413311),
                                    ("absorption of , after named daySeptember",
                                     -4.973773700792098),
                                    ("Naraka Chaturdashiyear (latent)", -6.226536669287466),
                                    ("from|since|after <time>on <day>", -5.310245937413311),
                                    ("dayweek", -6.226536669287466),
                                    ("Easter Sundayyear (latent)", -5.821071561179301),
                                    ("Thursday<time-of-day> am|pm", -4.973773700792098),
                                    ("weekyear", -5.821071561179301),
                                    ("time-of-day (latent)Thursday", -5.821071561179301),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.226536669287466),
                                    ("<day-of-month> (ordinal)April", -6.226536669287466),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.821071561179301),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.53338948872752),
                                    ("Sundayfrom|since|after <time>", -6.226536669287466),
                                    ("absorption of , after named dayFebruary", -5.310245937413311),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.821071561179301),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.226536669287466),
                                    ("tomorrowat <time-of-day>", -6.226536669287466),
                                    ("daynograin", -5.821071561179301),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.821071561179301),
                                    ("last <cycle> of <time>year (latent)", -5.821071561179301),
                                    ("tomorrow<time-of-day> am|pm", -6.226536669287466),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.53338948872752),
                                    ("Diwaliyear (latent)", -5.821071561179301),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.226536669287466),
                                    ("this <part-of-day>at <time-of-day>", -5.310245937413311),
                                    ("Fridayyear (latent)", -5.310245937413311),
                                    ("Tuesdayin|within|after <duration>", -6.226536669287466),
                                    ("time-of-day (latent)April", -6.226536669287466),
                                    ("minuteyear", -4.029312091951246)],
                               n = 339}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
