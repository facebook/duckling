...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7369498032183383, unseen = -5.313205979041787,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 201},
                   koData =
                     ClassData{prior = -0.6511829814609131,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4795730802618862, unseen = -6.391917113392602,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                     -4.4443305180100365),
                                    ("Lentyear", -5.697093486505405),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.4443305180100365),
                                    ("hourday", -3.9923453942669793),
                                    ("dayhour", -2.8067217286092396),
                                    ("daymonth", -5.003946305945459),
                                    ("monthday", -5.29162837839724),
                                    ("monthyear", -4.087655574071304),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.697093486505405),
                                    ("Easter Sundayyear", -5.003946305945459),
                                    ("Christmasyear", -5.29162837839724),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.697093486505405),
                                    ("houryear", -5.29162837839724),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.697093486505405),
                                    ("Christmas<time-of-day> am|pm", -5.697093486505405),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.003946305945459),
                                    ("<time-of-day> am|pmintersect", -4.4443305180100365),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.697093486505405),
                                    ("Marchyear", -5.697093486505405),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.29162837839724),
                                    ("intersect<time-of-day> am|pm", -5.697093486505405),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.697093486505405),
                                    ("monthhour", -5.29162837839724),
                                    ("last <day-of-week> of <time>year", -5.697093486505405),
                                    ("todayat <time-of-day>", -5.697093486505405),
                                    ("Thursday<time> timezone", -3.9923453942669793),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.697093486505405),
                                    ("Palm SundaySunday", -5.29162837839724),
                                    ("dayday", -3.499868909169185),
                                    ("Thanksgiving Dayyear", -4.598481197837295),
                                    ("<time> <part-of-day>at <time-of-day>", -5.697093486505405),
                                    ("Tuesdayin <named-month>", -5.697093486505405),
                                    ("mm/ddat <time-of-day>", -5.697093486505405),
                                    ("tonightat <time-of-day>", -5.697093486505405),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.003946305945459),
                                    ("today<time-of-day> am|pm", -5.697093486505405),
                                    ("Februarythe <day-of-month> (ordinal)", -5.29162837839724),
                                    ("at <time-of-day><time> <part-of-day>", -5.697093486505405),
                                    ("mm/dd<time-of-day> am|pm", -5.697093486505405),
                                    ("hourhour", -4.4443305180100365),
                                    ("<time-of-day> am|pmon <date>", -3.68219046596314),
                                    ("Wednesdaythis|last|next <cycle>", -5.697093486505405),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.19301608972913),
                                    ("dayyear", -2.779322754421125),
                                    ("last weekend of <named-month>year", -5.697093486505405),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.697093486505405),
                                    ("Sundayyear", -5.697093486505405),
                                    ("Thursdayat <time-of-day>", -5.29162837839724),
                                    ("<time-of-day> am|pmtomorrow", -5.003946305945459),
                                    ("minutehour", -4.7808027546312495),
                                    ("Mother's Dayyear", -5.697093486505405),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.29162837839724),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.9923453942669793),
                                    ("for <duration> from <time>December", -5.697093486505405),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.697093486505405),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.7808027546312495),
                                    ("Mondayin|during the <part-of-day>", -5.697093486505405),
                                    ("Shrove Tuesdayyear", -5.697093486505405),
                                    ("<part-of-day> of <time>year", -5.697093486505405),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.29162837839724),
                                    ("National Grandparents Dayyear", -5.697093486505405),
                                    ("intersectin|during the <part-of-day>", -5.697093486505405),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.697093486505405),
                                    ("year<time-of-day> am|pm", -5.697093486505405),
                                    ("Cyber Mondayyear", -5.29162837839724),
                                    ("Septemberyear", -5.29162837839724),
                                    ("at <time-of-day>on <date>", -4.598481197837295),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -5.003946305945459),
                                    ("Halloweenyear", -5.697093486505405),
                                    ("dayweek", -5.697093486505405),
                                    ("Thursday<time-of-day> am|pm", -5.697093486505405),
                                    ("weekyear", -5.29162837839724),
                                    ("hh:mmin|during the <part-of-day>", -5.003946305945459),
                                    ("Father's Dayyear", -5.697093486505405),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.29162837839724),
                                    ("February<time> <part-of-day>", -5.697093486505405),
                                    ("Martin Luther King's Dayyear", -5.29162837839724),
                                    ("Military Spouse Dayyear", -5.697093486505405),
                                    ("tomorrowat <time-of-day>", -5.003946305945459),
                                    ("between <time> and <time>on <date>", -5.003946305945459),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.003946305945459),
                                    ("at <time-of-day>tomorrow", -5.29162837839724),
                                    ("tomorrow<time-of-day> am|pm", -5.697093486505405),
                                    ("Pentecostyear", -5.697093486505405),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.697093486505405),
                                    ("Palm Sundayintersect", -5.697093486505405),
                                    ("Labor Dayyear", -5.697093486505405),
                                    ("Februaryintersect", -5.697093486505405),
                                    ("last <cycle> of <time>year", -5.003946305945459),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.697093486505405),
                                    ("President's Dayyear", -5.697093486505405),
                                    ("yearminute", -5.697093486505405),
                                    ("Black Fridayyear", -5.29162837839724)],
                               n = 221},
                   koData =
                     ClassData{prior = -0.9650808960435872, unseen = -6.056784013228625,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.3612921657094255),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.3612921657094255),
                                    ("hourday", -5.3612921657094255),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.3612921657094255),
                                    ("dayhour", -2.9189451303402207),
                                    ("daymonth", -3.2818506240295893),
                                    ("monthday", -4.955827057601261),
                                    ("monthyear", -4.66814498514948),
                                    ("intersecthh:mm", -5.3612921657094255),
                                    ("Easter Sundayyear", -5.3612921657094255),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.3612921657094255),
                                    ("houryear", -5.3612921657094255),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.3612921657094255),
                                    ("until <time-of-day><time-of-day> am|pm", -5.3612921657094255),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.66814498514948),
                                    ("<time-of-day> am|pmintersect", -4.108529197214057),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.44500143383527),
                                    ("from|since|after <time-of-day>on <date>", -4.44500143383527),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.3612921657094255),
                                    ("absorption of , after named dayJuly", -4.955827057601261),
                                    ("monthhour", -5.3612921657094255),
                                    ("hourmonth", -4.66814498514948),
                                    ("todayat <time-of-day>", -5.3612921657094255),
                                    ("from|since|after <time-of-day>July", -5.3612921657094255),
                                    ("dayday", -4.955827057601261),
                                    ("mm/ddat <time-of-day>", -4.955827057601261),
                                    ("<time-of-day> am|pmon <date>", -4.108529197214057),
                                    ("dayyear", -3.4894899888078337),
                                    ("Thursdaymm/dd", -5.3612921657094255),
                                    ("Sundayyear", -4.66814498514948),
                                    ("Thursdayat <time-of-day>", -4.108529197214057),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.3612921657094255),
                                    ("monthminute", -5.3612921657094255),
                                    ("<time-of-day> am|pmtomorrow", -5.3612921657094255),
                                    ("Thursdayhh:mm", -4.44500143383527),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.3612921657094255),
                                    ("Fridayyear", -4.955827057601261),
                                    ("minutemonth", -3.56953269648137),
                                    ("Sundayfrom|since|after <time-of-day>", -5.3612921657094255),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.955827057601261),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.955827057601261),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.3612921657094255),
                                    ("Christmasat <time-of-day>", -5.3612921657094255),
                                    ("<duration> after|before|from <time>December",
                                     -5.3612921657094255),
                                    ("yesterday<time-of-day> am|pm", -5.3612921657094255),
                                    ...
                                    ("Mondayyear", -4.955827057601261),
                                    ("at <time-of-day>intersect", -4.955827057601261),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.3612921657094255),
                                    ("dayminute", -2.83556352140117),
                                    ("intersectSeptember", -3.857214768933151),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.3612921657094255),
                                    ("minuteday", -2.443521433625146),
                                    ("absorption of , after named dayintersect",
                                     -5.3612921657094255),
                                    ("Februaryin|during the <part-of-day>", -5.3612921657094255),
                                    ("week-endin <named-month>", -5.3612921657094255),
                                    ("Octoberyear", -5.3612921657094255),
                                    ("from|since|after <time-of-day>year", -5.3612921657094255),
                                    ("yearhh:mm", -5.3612921657094255),
                                    ("hh:mmon <date>", -3.857214768933151),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.3612921657094255),
                                    ("absorption of , after named daySeptember", -4.44500143383527),
                                    ("on <date>September", -4.955827057601261),
                                    ("at <time-of-day>on <date>", -4.955827057601261),
                                    ("dayweek", -5.3612921657094255),
                                    ("Thursday<time-of-day> am|pm", -4.955827057601261),
                                    ("absorption of , after named dayFebruary", -4.44500143383527),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.3612921657094255),
                                    ("tomorrowat <time-of-day>", -5.3612921657094255),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.3612921657094255),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.751854253275325),
                                    ("tomorrow<time-of-day> am|pm", -5.3612921657094255),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.3612921657094255),
                                    ("yearminute", -5.3612921657094255)],
                               n = 136}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year",
        Classifier{okData =
                     ClassData{prior = -0.22705745063534608, unseen = -4.02535169073515,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -7.550755250814517e-2),
                                    ("intersect 2 numbers", -3.3141860046725258)],
                               n = 51},
                   koData =
                     ClassData{prior = -1.5939337258981352, unseen = -2.890371757896165,
                               likelihoods =
                                 HashMap.fromList
