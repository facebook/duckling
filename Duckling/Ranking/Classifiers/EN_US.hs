...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7528664152615676,
                               unseen = -5.2832037287379885,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 195},
                   koData =
                     ClassData{prior = -0.6367942440088136,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4953961952011289, unseen = -6.335054251498059,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.387369479084377),
                                    ("hourday", -3.93538435534132), ("dayhour", -2.806919103523529),
                                    ("daymonth", -4.9469852670198),
                                    ("monthday", -5.234667339471581),
                                    ("monthyear", -4.030694535145645),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.640132447579745),
                                    ("Easter Sundayyear", -4.9469852670198),
                                    ("Christmasyear", -5.640132447579745),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.640132447579745),
                                    ("houryear", -5.640132447579745),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.640132447579745),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.9469852670198),
                                    ("<time-of-day> am|pmintersect", -4.387369479084377),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.640132447579745),
                                    ("Marchyear", -5.640132447579745),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.234667339471581),
                                    ("intersect<time-of-day> am|pm", -5.640132447579745),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.640132447579745),
                                    ("monthhour", -5.234667339471581),
                                    ("last <day-of-week> of <time>year", -5.640132447579745),
                                    ("todayat <time-of-day>", -5.640132447579745),
                                    ("Thursday<time> timezone", -3.93538435534132),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.640132447579745),
                                    ("dayday", -3.6252294270374805),
                                    ("Thanksgiving Dayyear", -4.541520158911635),
                                    ("<time> <part-of-day>at <time-of-day>", -5.640132447579745),
                                    ("Tuesdayin <named-month>", -5.640132447579745),
                                    ("mm/ddat <time-of-day>", -5.640132447579745),
                                    ("tonightat <time-of-day>", -5.640132447579745),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.9469852670198),
                                    ("today<time-of-day> am|pm", -5.640132447579745),
                                    ("Februarythe <day-of-month> (ordinal)", -5.234667339471581),
                                    ("at <time-of-day><time> <part-of-day>", -5.640132447579745),
                                    ("mm/dd<time-of-day> am|pm", -5.640132447579745),
                                    ("hourhour", -4.387369479084377),
                                    ("<time-of-day> am|pmon <date>", -3.6252294270374805),
                                    ("Wednesdaythis|last|next <cycle>", -5.640132447579745),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.136055050803471),
                                    ("dayyear", -2.899292423654544),
                                    ("last weekend of <named-month>year", -5.640132447579745),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.640132447579745),
                                    ("Thursdayat <time-of-day>", -5.234667339471581),
                                    ("<time-of-day> am|pmtomorrow", -4.9469852670198),
                                    ("minutehour", -4.72384171570559),
                                    ("Mother's Dayyear", -5.640132447579745),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.234667339471581),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.93538435534132),
                                    ("for <duration> from <time>December", -5.640132447579745),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.640132447579745),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.72384171570559),
                                    ("Mondayin|during the <part-of-day>", -5.640132447579745),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.234667339471581),
                                    ("National Grandparents Dayyear", -5.640132447579745),
                                    ("intersectin|during the <part-of-day>", -5.640132447579745),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.234667339471581),
                                    ("<ordinal> <cycle> of <time>year", -5.640132447579745),
                                    ("minuteday", -2.1743965447800186),
                                    ("absorption of , after named dayintersect",
                                     -5.640132447579745),
                                    ("Octoberyear", -4.387369479084377),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.640132447579745),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.640132447579745),
                                    ("year<time-of-day> am|pm", -5.640132447579745),
                                    ("Cyber Mondayyear", -5.234667339471581),
                                    ("Septemberyear", -5.234667339471581),
                                    ("at <time-of-day>on <date>", -4.541520158911635),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.9469852670198),
                                    ("Halloweenyear", -5.640132447579745),
                                    ("dayweek", -5.640132447579745),
                                    ("Thursday<time-of-day> am|pm", -5.640132447579745),
                                    ("weekyear", -5.234667339471581),
                                    ("hh:mmin|during the <part-of-day>", -4.9469852670198),
                                    ("Father's Dayyear", -5.640132447579745),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.234667339471581),
                                    ("February<time> <part-of-day>", -5.640132447579745),
                                    ("Martin Luther King's Dayyear", -5.234667339471581),
                                    ("Military Spouse Dayyear", -5.640132447579745),
                                    ("tomorrowat <time-of-day>", -4.9469852670198),
                                    ("between <time> and <time>on <date>", -4.9469852670198),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.9469852670198),
                                    ("at <time-of-day>tomorrow", -5.234667339471581),
                                    ("tomorrow<time-of-day> am|pm", -5.640132447579745),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.640132447579745),
                                    ("Labor Dayyear", -5.640132447579745),
                                    ("Februaryintersect", -5.640132447579745),
                                    ("last <cycle> of <time>year", -4.9469852670198),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.640132447579745),
                                    ("yearminute", -5.640132447579745),
                                    ("Black Fridayyear", -5.234667339471581)],
                               n = 209},
                   koData =
                     ClassData{prior = -0.9398906472150286, unseen = -6.025865973825314,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.330300412401088),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.330300412401088),
                                    ("hourday", -5.330300412401088),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.330300412401088),
                                    ("dayhour", -2.932405139602717),
                                    ("daymonth", -3.2508588707212516),
                                    ("monthday", -4.924835304292923),
                                    ("monthyear", -4.637153231841142),
                                    ("intersecthh:mm", -5.330300412401088),
                                    ("Easter Sundayyear", -5.330300412401088),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.330300412401088),
                                    ("houryear", -5.330300412401088),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.330300412401088),
                                    ("until <time-of-day><time-of-day> am|pm", -5.330300412401088),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.637153231841142),
                                    ("<time-of-day> am|pmintersect", -4.07753744390572),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.414009680526933),
                                    ("from|since|after <time-of-day>on <date>", -4.414009680526933),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.330300412401088),
                                    ("absorption of , after named dayJuly", -4.924835304292923),
                                    ("monthhour", -5.330300412401088),
                                    ("hourmonth", -4.637153231841142),
                                    ("todayat <time-of-day>", -5.330300412401088),
                                    ("from|since|after <time-of-day>July", -5.330300412401088),
                                    ("dayday", -4.924835304292923),
                                    ("mm/ddat <time-of-day>", -4.924835304292923),
                                    ("<time-of-day> am|pmon <date>", -4.07753744390572),
                                    ("dayyear", -3.5385409431730324),
                                    ("Thursdaymm/dd", -5.330300412401088),
                                    ("Sundayyear", -4.924835304292923),
                                    ("Thursdayat <time-of-day>", -4.07753744390572),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.330300412401088),
                                    ("monthminute", -5.330300412401088),
                                    ("<time-of-day> am|pmtomorrow", -5.330300412401088),
                                    ("Thursdayhh:mm", -4.414009680526933),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.330300412401088),
                                    ("Fridayyear", -4.924835304292923),
                                    ("minutemonth", -3.5385409431730324),
                                    ("Sundayfrom|since|after <time-of-day>", -5.330300412401088),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.924835304292923),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.924835304292923),
                                    ("Aprilyear", -5.330300412401088),
                                    ...
                                    ("<duration> after|before|from <time>December",
                                     -5.330300412401088),
                                    ("yesterday<time-of-day> am|pm", -5.330300412401088),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.330300412401088),
                                    ("until <time-of-day>on <date>", -4.637153231841142),
                                    ("Mondayyear", -4.924835304292923),
                                    ("at <time-of-day>intersect", -4.924835304292923),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.330300412401088),
                                    ("dayminute", -2.804571768092832),
                                    ("intersectSeptember", -3.8262230156248136),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.330300412401088),
                                    ("minuteday", -2.4125296803168084),
                                    ("absorption of , after named dayintersect",
                                     -5.330300412401088),
                                    ("Februaryin|during the <part-of-day>", -5.330300412401088),
                                    ("week-endin <named-month>", -5.330300412401088),
                                    ("Octoberyear", -5.330300412401088),
                                    ("from|since|after <time-of-day>year", -5.330300412401088),
                                    ("yearhh:mm", -5.330300412401088),
                                    ("hh:mmon <date>", -3.8262230156248136),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.330300412401088),
                                    ("absorption of , after named daySeptember",
                                     -4.414009680526933),
                                    ("on <date>September", -4.924835304292923),
                                    ("at <time-of-day>on <date>", -4.924835304292923),
                                    ("dayweek", -5.330300412401088),
                                    ("Thursday<time-of-day> am|pm", -4.924835304292923),
                                    ("absorption of , after named dayFebruary", -4.414009680526933),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.330300412401088),
                                    ("tomorrowat <time-of-day>", -5.330300412401088),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.330300412401088),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.7208624999669873),
                                    ("tomorrow<time-of-day> am|pm", -5.330300412401088),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.330300412401088),
                                    ("yearminute", -5.330300412401088)],
                               n = 134}}),
       ("one eleven",
        Classifier{okData =
