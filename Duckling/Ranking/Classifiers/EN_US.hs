...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.81846429995586, unseen = -5.262690188904886,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 191},
                   koData =
                     ClassData{prior = -0.5818000018458035, unseen = -5.497168225293202,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5569667797638457, unseen = -6.3578422665081,
                               likelihoods =
                                 HashMap.fromList
                                   [("Father's Dayyear (latent)", -5.662960480135946),
                                    ("Washington's Birthday/President's Dayyear (latent)",
                                     -5.662960480135946),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.410197511640578),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.410197511640578),
                                    ("hourday", -3.958212387897521), ("dayhour", -2.82974713607973),
                                    ("Martin Luther King's Dayyear (latent)", -5.2574953720277815),
                                    ("daymonth", -4.969813299576001),
                                    ("monthday", -5.2574953720277815),
                                    ("monthyear", -4.053522567701846),
                                    ("Thanksgiving Dayyear (latent)", -4.564348191467836),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.662960480135946),
                                    ...
                                    ("Octoberyear (latent)", -4.410197511640578),
                                    ("intersect<time-of-day> am|pm", -5.662960480135946),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.662960480135946),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.2574953720277815),
                                    ("Marchyear (latent)", -5.662960480135946),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.662960480135946),
                                    ("monthhour", -5.2574953720277815),
                                    ("todayat <time-of-day>", -5.662960480135946),
                                    ("Thursday<time> timezone", -3.958212387897521),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.662960480135946),
                                    ("dayday", -3.648057459593681),
                                    ("<time> <part-of-day>at <time-of-day>", -5.662960480135946),
                                    ("Tuesdayin <named-month>", -5.662960480135946),
                                    ("mm/ddat <time-of-day>", -5.662960480135946),
                                    ("tonightat <time-of-day>", -5.662960480135946),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.969813299576001),
                                    ("today<time-of-day> am|pm", -5.662960480135946),
                                    ("Februarythe <day-of-month> (ordinal)", -5.2574953720277815),
                                    ("at <time-of-day><time> <part-of-day>", -5.662960480135946),
                                    ("mm/dd<time-of-day> am|pm", -5.662960480135946),
                                    ("hourhour", -4.410197511640578),
                                    ("<time-of-day> am|pmon <date>", -3.648057459593681),
                                    ("Wednesdaythis|last|next <cycle>", -5.662960480135946),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.1588830833596715),
                                    ("dayyear", -3.0239031505206873),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.662960480135946),
                                    ("Thursdayat <time-of-day>", -5.2574953720277815),
                                    ("<time-of-day> am|pmtomorrow", -4.969813299576001),
                                    ("minutehour", -4.746669748261791),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.2574953720277815),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.958212387897521),
                                    ("for <duration> from <time>December", -5.662960480135946),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.662960480135946),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.746669748261791),
                                    ("Mondayin|during the <part-of-day>", -5.662960480135946),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.2574953720277815),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.662960480135946),
                                    ("intersectin|during the <part-of-day>", -5.662960480135946),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.662960480135946),
                                    ("Septemberyear (latent)", -5.2574953720277815),
                                    ("mm/ddyear (latent)", -5.662960480135946),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.410197511640578),
                                    ("Halloweenyear (latent)", -5.662960480135946),
                                    ...
                                    ("at <time-of-day>on <date>", -4.564348191467836),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.053522567701846),
                                    ("dayweek", -5.662960480135946),
                                    ("Easter Sundayyear (latent)", -4.969813299576001),
                                    ("Thursday<time-of-day> am|pm", -5.662960480135946),
                                    ("weekyear", -5.2574953720277815),
                                    ("hh:mmin|during the <part-of-day>", -4.969813299576001),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.2574953720277815),
                                    ("February<time> <part-of-day>", -5.662960480135946),
                                    ("tomorrowat <time-of-day>", -4.969813299576001),
                                    ("Labor Dayyear (latent)", -5.662960480135946),
                                    ("between <time> and <time>on <date>", -4.053522567701846),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.969813299576001),
                                    ("last <cycle> of <time>year (latent)", -4.969813299576001),
                                    ("at <time-of-day>tomorrow", -5.2574953720277815),
                                    ("tomorrow<time-of-day> am|pm", -5.662960480135946),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.662960480135946),
                                    ("Black Fridayyear (latent)", -5.2574953720277815),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.662960480135946),
                                    ("Februaryintersect", -5.662960480135946),
                                    ("Mother's Dayyear (latent)", -5.662960480135946)],
                               n = 216},
                   koData =
                     ClassData{prior = -0.8508408224635478,
                               unseen = -6.1463292576688975,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.4510384535657),
                                    ("hourday", -5.4510384535657),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.4510384535657),
                                    ("dayhour", -3.05314318076733),
                                    ("daymonth", -3.371596911885865),
                                    ("monthday", -5.045573345457536),
                                    ("monthyear", -4.198275485070333),
                                    ("<time-of-day> am|pmyear (latent)", -5.045573345457536),
                                    ("intersecthh:mm", -5.4510384535657),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.4510384535657),
                                    ("houryear", -4.534747721691546),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.4510384535657),
                                    ("until <time-of-day><time-of-day> am|pm", -5.4510384535657),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.757891273005756),
                                    ("<time-of-day> am|pmintersect", -4.198275485070333),
                                    ("Octoberyear (latent)", -5.4510384535657),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.198275485070333),
                                    ("from|since|after <time-of-day>on <date>", -4.534747721691546),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.4510384535657),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -4.198275485070333),
                                    ("about|exactly <time-of-day>year (latent)", -5.4510384535657),
                                    ("absorption of , after named dayJuly", -5.045573345457536),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.534747721691546),
                                    ("monthhour", -5.4510384535657),
                                    ("hourmonth", -4.757891273005756),
                                    ("todayat <time-of-day>", -5.4510384535657),
                                    ("from|since|after <time-of-day>July", -5.4510384535657),
                                    ("dayday", -5.045573345457536),
                                    ("mm/ddat <time-of-day>", -5.045573345457536),
                                    ("<time-of-day> am|pmon <date>", -4.198275485070333),
                                    ("dayyear", -3.0086914181964963),
                                    ("Thursdaymm/dd", -5.4510384535657),
                                    ("in <named-month>year (latent)", -5.4510384535657),
                                    ("Thursdayat <time-of-day>", -4.198275485070333),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.4510384535657),
                                    ("Aprilyear (latent)", -5.4510384535657),
                                    ("monthminute", -5.4510384535657),
                                    ("<time-of-day> am|pmtomorrow", -5.4510384535657),
                                    ("Thursdayhh:mm", -4.534747721691546),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.4510384535657),
                                    ("minutemonth", -3.6592789843376456),
                                    ("Sundayfrom|since|after <time-of-day>", -5.4510384535657),
                                    ("Augustyear (latent)", -5.045573345457536),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.045573345457536),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.045573345457536),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.4510384535657),
                                    ("Sundayyear (latent)", -5.045573345457536),
                                    ("<duration> after|before|from <time>December",
                                     -5.4510384535657),
                                    ("yesterday<time-of-day> am|pm", -5.4510384535657),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.534747721691546),
                                    ("mm/ddyear (latent)", -5.4510384535657),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.045573345457536),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.4510384535657),
                                    ("until <time-of-day>on <date>", -4.757891273005756),
                                    ("at <time-of-day>intersect", -5.045573345457536),
                                    ("hh:mmyear (latent)", -4.352426164897591),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.4510384535657),
                                    ("dayminute", -2.9661318037777002),
                                    ("intersectSeptember", -3.9469610567894264),
                                    ("minuteday", -2.3829855184320836),
                                    ("absorption of , after named dayintersect", -5.4510384535657),
                                    ("Februaryin|during the <part-of-day>", -5.4510384535657),
                                    ("week-endin <named-month>", -5.4510384535657),
                                    ("hh:mmon <date>", -3.436135433023436),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.4510384535657),
                                    ("absorption of , after named daySeptember",
                                     -4.534747721691546),
                                    ("on <date>September", -5.045573345457536),
                                    ("at <time-of-day>on <date>", -5.045573345457536),
                                    ("dayweek", -5.4510384535657),
                                    ("Easter Sundayyear (latent)", -5.4510384535657),
                                    ("Thursday<time-of-day> am|pm", -5.045573345457536),
                                    ("absorption of , after named dayFebruary", -4.534747721691546),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.4510384535657),
                                    ("tomorrowat <time-of-day>", -5.4510384535657),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.4510384535657),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.8416005411316),
                                    ("tomorrow<time-of-day> am|pm", -5.4510384535657),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.757891273005756),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.4510384535657),
                                    ("Fridayyear (latent)", -5.045573345457536),
                                    ("minuteyear", -4.198275485070333)],
                               n = 161}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.46262352194811296, unseen = -5.10594547390058,
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                     -4.406719247264253),
                                    ("dayhour", -3.153956278768885),
                                    ("daymonth", -3.153956278768885),
                                    ...
                                    ("Labor Daythis|last|next <cycle>", -4.406719247264253),
                                    ("Black Fridaythis|last|next <cycle>", -4.406719247264253),
                                    ("<part-of-day> of <time>February", -4.406719247264253),
                                    ("Saturday<time-of-day> am|pm", -4.406719247264253),
                                    ("Martin Luther King's Daythis|last|next <cycle>",
                                     -4.406719247264253),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.406719247264253),
                                    ("on <date><time-of-day> am|pm", -4.406719247264253),
                                    ("hourmonth", -4.406719247264253),
                                    ("dayday", -2.5349170703626616),
                                    ("the <day-of-month> (ordinal)February", -4.001254139156089),
                                    ("WednesdayOctober", -4.406719247264253),
                                    ("Wednesdaythis|last|next <cycle>", -4.001254139156089),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.4904285153900982),
                                    ("dayyear", -2.797281334830153),
                                    ("Saturday<named-month> <day-of-month> (non ordinal)",
                                     -4.406719247264253),
                                    ("Thursdayhh:mm", -4.001254139156089),
                                    ("Thanksgiving Daythis|last|next <cycle>", -4.406719247264253),
                                    ("Memorial Daythis|last|next <cycle>", -4.406719247264253),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -4.001254139156089),
                                    ("TuesdayOctober", -4.406719247264253),
                                    ("the <day-of-month> (ordinal)March", -4.406719247264253),
                                    ("Mondaythis|last|next <cycle>", -4.406719247264253),
                                    ("Fridayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.406719247264253),
                                    ("Fridayintersect", -4.406719247264253),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -3.713572066704308),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.4904285153900982),
                                    ("Tuesdaythis|last|next <cycle>", -4.406719247264253),
                                    ("Sunday<named-month> <day-of-month> (non ordinal)",
                                     -4.406719247264253),
                                    ("dayminute", -3.0204248861443626),
                                    ("minuteday", -3.4904285153900982),
                                    ("this|last|next <cycle>Sunday", -4.406719247264253),
                                    ("intersectyear (latent)", -4.406719247264253),
                                    ("Sundaythis|last|next <cycle>", -4.406719247264253),
                                    ("weekday", -4.406719247264253),
                                    ("dayweek", -3.3081069585961433),
                                    ("Thursday<time-of-day> am|pm", -4.406719247264253),
                               ...
                               n = 51},
                   koData =
                     ClassData{prior = -0.9932517730102834, unseen = -4.812184355372417,
                               likelihoods =
                                 HashMap.fromList
