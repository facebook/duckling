...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6372667221654886, unseen = -5.627621113690637,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 276},
                   koData =
                     ClassData{prior = -0.752336051950276, unseen = -5.5134287461649825,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46177313010922016, unseen = -6.70808408385307,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.013715156042802),
                                    ("Father's Dayyear (latent)", -6.013715156042802),
                                    ("Ramadanyear (latent)", -6.013715156042802),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.760952187547434),
                                    ("Military Spouse Dayyear (latent)", -6.013715156042802),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.013715156042802),
                                    ("Cyber Mondayyear (latent)", -5.6082500479346375),
                                    ...
                                    ("National Grandparents Dayyear (latent)", -6.013715156042802),
                                    ...
                                    ("Labor Dayyear (latent)", -6.013715156042802),
                                    ("between <time> and <time>on <date>", -4.404277243608702),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.320567975482857),
                                    ...
                                    ("President's Dayyear (latent)", -6.013715156042802),
                                    ...
                                    ("Mother's Dayyear (latent)", -6.013715156042802),
                                    ("Simchat Torahyear (latent)", -6.013715156042802)],
                               n = 305},
                   koData =
                     ClassData{prior = -0.9946991008758768, unseen = -6.340359303727752,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.645446897643238),
                                    ("hourday", -5.645446897643238),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.645446897643238),
                                    ("dayhour", -3.2030998622740334),
                                    ("daymonth", -3.5660053559634015),
                                    ("monthday", -5.239981789535073),
                                    ("monthyear", -4.39268392914787),
                                    ("<time-of-day> am|pmyear (latent)", -5.239981789535073),
                                    ("Thai Pongalyear (latent)", -4.952299717083292),
                                    ("intersecthh:mm", -5.645446897643238),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.645446897643238),
                                    ("houryear", -4.729156165769083),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.645446897643238),
                                    ("until <time-of-day><time-of-day> am|pm", -5.645446897643238),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.952299717083292),
                                    ("<time-of-day> am|pmintersect", -4.39268392914787),
                                    ("Octoberyear (latent)", -5.645446897643238),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.39268392914787),
                                    ("from|since|after <time-of-day>on <date>", -4.729156165769083),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.645446897643238),
                                    ("absorption of , after named dayJuly", -5.239981789535073),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.729156165769083),
                                    ("Clean Mondayyear (latent)", -5.645446897643238),
                                    ("monthhour", -5.645446897643238),
                                    ("hourmonth", -4.952299717083292),
                                    ("todayat <time-of-day>", -5.645446897643238),
                                    ("from|since|after <time-of-day>July", -5.645446897643238),
                                    ("Mondayyear (latent)", -4.546834608975128),
                                    ("dayday", -5.239981789535073),
                                    ("mm/ddat <time-of-day>", -5.239981789535073),
                                    ("<time-of-day> am|pmon <date>", -4.39268392914787),
                                    ("dayyear", -2.6497146240892464),
                                    ("Thursdaymm/dd", -5.645446897643238),
                                    ("New Year's Dayyear (latent)", -5.239981789535073),
                                    ("Thursdayat <time-of-day>", -4.39268392914787),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.645446897643238),
                                    ("Aprilyear (latent)", -5.645446897643238),
                                    ("monthminute", -5.645446897643238),
                                    ("<time-of-day> am|pmtomorrow", -5.645446897643238),
                                    ("Thursdayhh:mm", -4.729156165769083),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.645446897643238),
                                    ("minutemonth", -3.8536874284151827),
                                    ("Sundayfrom|since|after <time-of-day>", -5.645446897643238),
                                    ("week-endin <named-month>|year", -5.645446897643238),
                                    ("Augustyear (latent)", -5.239981789535073),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.239981789535073),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.239981789535073),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.645446897643238),
                                    ("Sundayyear (latent)", -4.952299717083292),
                                    ("Christmasat <time-of-day>", -5.645446897643238),
                                    ("<duration> after|before|from <time>December",
                                     -5.645446897643238),
                                    ("yesterday<time-of-day> am|pm", -5.645446897643238),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.729156165769083),
                                    ("mm/ddyear (latent)", -5.645446897643238),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.239981789535073),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.645446897643238),
                                    ("until <time-of-day>on <date>", -4.952299717083292),
                                    ("at <time-of-day>intersect", -5.239981789535073),
                                    ("hh:mmyear (latent)", -4.546834608975128),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.645446897643238),
                                    ("dayminute", -3.1605402478552374),
                                    ("intersectSeptember", -4.141369500866964),
                                    ("minuteday", -2.5773939625096207),
                                    ("absorption of , after named dayintersect",
                                     -5.645446897643238),
                                    ("Februaryin|during the <part-of-day>", -5.645446897643238),
                                    ("hh:mmon <date>", -3.630543877100973),
                                    ("Saturdayyear (latent)", -5.645446897643238),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.645446897643238),
                                    ("absorption of , after named daySeptember",
                                     -4.729156165769083),
                                    ("Naraka Chaturdashiyear (latent)", -5.645446897643238),
                                    ("on <date>September", -5.239981789535073),
                                    ("at <time-of-day>on <date>", -5.239981789535073),
                                    ("in <named-month>|yearyear (latent)", -5.645446897643238),
                                    ("dayweek", -5.645446897643238),
                                    ("Easter Sundayyear (latent)", -5.239981789535073),
                                    ("Thursday<time-of-day> am|pm", -5.239981789535073),
                                    ("absorption of , after named dayFebruary", -4.729156165769083),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.645446897643238),
                                    ("tomorrowat <time-of-day>", -5.645446897643238),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.645446897643238),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.036008985209137),
                                    ("tomorrow<time-of-day> am|pm", -5.645446897643238),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.952299717083292),
                                    ("Diwaliyear (latent)", -5.239981789535073),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.645446897643238),
                                    ("Fridayyear (latent)", -5.239981789535073),
                                    ("minuteyear", -4.39268392914787)],
                               n = 179}}),
       ("one eleven",
        Classifier{okData =
