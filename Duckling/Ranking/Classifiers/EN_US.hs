...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.43990038452798524, unseen = -6.78897174299217,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.094697801749634),
                                    ("Father's Dayyear (latent)", -6.094697801749634),
                                    ("Ramadanyear (latent)", -6.094697801749634),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.841934833254267),
                                    ("Military Spouse Dayyear (latent)", -6.094697801749634),
                                    ("Bhai Doojyear (latent)", -6.094697801749634),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.841934833254267),
                                    ("hourday", -4.3899497095112086),
                                    ("dayhour", -3.291337420843099),
                                    ("Martin Luther King's Dayyear (latent)", -5.68923269364147),
                                    ("Shemini Atzeretyear (latent)", -6.094697801749634),
                                    ("daymonth", -5.178407069875479),
                                    ("monthday", -5.68923269364147),
                                    ("monthyear", -4.302938332521579),
                                    ("Yom Ha'atzmautyear (latent)", -6.094697801749634),
                                    ("Vijayadashamiyear (latent)", -6.094697801749634),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -4.708403440629744),
                                    ("Thanksgiving Dayyear (latent)", -4.996085513081525),
                                    ("Thai Pongalyear (latent)", -5.401550621189689),
                                    ("Thiru Onamyear (latent)", -5.401550621189689),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.094697801749634),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.094697801749634),
                                    ("houryear", -5.401550621189689),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.094697801749634),
                                    ("Christmas<time-of-day> am|pm", -6.094697801749634),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.094697801749634),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.401550621189689),
                                    ("<time-of-day> am|pmintersect", -4.841934833254267),
                                    ("Earth Houryear (latent)", -6.094697801749634),
                                    ("Octoberyear (latent)", -4.59062040497336),
                                    ("intersect<time-of-day> am|pm", -6.094697801749634),
                                    ("Mattu Pongalyear (latent)", -6.094697801749634),
                                    ("Shavuotyear (latent)", -6.094697801749634),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.094697801749634),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.094697801749634),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.68923269364147),
                                    ("Marchyear (latent)", -6.094697801749634),
                                    ("Sukkotyear (latent)", -5.68923269364147),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.094697801749634),
                                    ("Clean Mondayyear (latent)", -5.68923269364147),
                                    ("monthhour", -5.68923269364147),
                                    ("todayat <time-of-day>", -6.094697801749634),
                                    ("Thursday<time> timezone", -4.3899497095112086),
                                    ...
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.094697801749634),
                                    ("Tax Daythis|last|next <cycle>", -6.094697801749634),
                                    ("dayday", -4.07979478120737),
                                    ("<time> <part-of-day>at <time-of-day>", -6.094697801749634),
                                    ("mm/ddat <time-of-day>", -6.094697801749634),
                                    ("tonightat <time-of-day>", -6.094697801749634),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.401550621189689),
                                    ("today<time-of-day> am|pm", -6.094697801749634),
                                    ("Februarythe <day-of-month> (ordinal)", -5.68923269364147),
                                    ("at <time-of-day><time> <part-of-day>", -6.094697801749634),
                                    ("mm/dd<time-of-day> am|pm", -6.094697801749634),
                                    ("hourhour", -4.841934833254267),
                                    ("<time-of-day> am|pmon <date>", -4.07979478120737),
                                    ("Navaratriin|during <named-month>|year", -6.094697801749634),
                                    ("Wednesdaythis|last|next <cycle>", -6.094697801749634),
                                    ("Lentyear (latent)", -6.094697801749634),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.59062040497336),
                                    ("Boghiyear (latent)", -6.094697801749634),
                                    ("dayyear", -1.8678640564814546),
                                    ("Thursdayfrom|since|after <time>", -5.68923269364147),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.094697801749634),
                                    ("Thursdayat <time-of-day>", -5.68923269364147),
                                    ("Islamic New Yearyear (latent)", -5.68923269364147),
                                    ("Laylat al-Qadryear (latent)", -5.178407069875479),
                                    ("Shrove Tuesdayyear (latent)", -6.094697801749634),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.401550621189689),
                                    ("<time-of-day> am|pmtomorrow", -5.401550621189689),
                                    ("Yom Kippuryear (latent)", -6.094697801749634),
                                    ("<part-of-day> of <time>year (latent)", -6.094697801749634),
                                    ("minutehour", -5.178407069875479),
                                    ("Kaanum Pongalyear (latent)", -5.68923269364147),
                                    ("Maha Saptamiyear (latent)", -6.094697801749634),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.68923269364147),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.3899497095112086),
                                    ("for <duration> from <time>December", -6.094697801749634),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.094697801749634),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.178407069875479),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.68923269364147),
                                    ("Pentecostyear (latent)", -6.094697801749634),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.178407069875479),
                                    ("Eid al-Fitryear (latent)", -6.094697801749634),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.094697801749634),
                                    ("Mondayin|during the <part-of-day>", -6.094697801749634),
                                    ("Chhathin|during <named-month>|year", -6.094697801749634),
                                    ("Diwaliin|during <named-month>|year", -6.094697801749634),
                                    ("Raksha Bandhanyear (latent)", -6.094697801749634),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.68923269364147),
                                    ("Emancipation Dayyear (latent)", -5.401550621189689),
                                    ("Ashurayear (latent)", -6.094697801749634),
                                    ("Tuesdayin|during <named-month>|year", -6.094697801749634),
                                    ("Chinese New Yearyear (latent)", -6.094697801749634),
                                    ("Lag BaOmeryear (latent)", -6.094697801749634),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.094697801749634),
                                    ("Eid al-Adhayear (latent)", -5.178407069875479),
                                    ("intersectin|during the <part-of-day>", -6.094697801749634),
                                    ("Palm Sundayyear (latent)", -6.094697801749634),
                                    ("Christmasat <time-of-day>", -6.094697801749634),
                                    ("Passoveryear (latent)", -6.094697801749634),
                                    ("Lazarus Saturdayyear (latent)", -6.094697801749634),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.094697801749634),
                                    ("Cyber Mondayyear (latent)", -5.68923269364147),
                                    ("Yom HaShoahyear (latent)", -5.68923269364147),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.68923269364147),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.094697801749634),
                                    ("Septemberyear (latent)", -5.68923269364147),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.841934833254267),
                                    ("Halloweenyear (latent)", -6.094697801749634),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.094697801749634),
                                    ("at <time-of-day>intersect", -5.68923269364147),
                                    ("Rosh Hashanahyear (latent)", -5.401550621189689),
                                    ("Dhanterasyear (latent)", -6.094697801749634),
                                    ("Tu BiShvatyear (latent)", -6.094697801749634),
                                    ("Holiyear (latent)", -5.401550621189689),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.094697801749634),
                                    ("Holika Dahanyear (latent)", -5.401550621189689),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.094697801749634),
                                    ("dayminute", -3.4556404721343754),
                                    ("Mawlidyear (latent)", -6.094697801749634),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.68923269364147),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.094697801749634),
                                    ("Jumu'atul-Widayear (latent)", -5.178407069875479),
                                    ("minuteday", -2.4571116420232486),
                                    ("absorption of , after named dayintersect",
                                     -6.094697801749634),
                                    ("Orthodox Easter Sundayyear (latent)", -6.094697801749634),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.094697801749634),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.094697801749634),
                                    ("Boss's Dayyear (latent)", -5.68923269364147),
                                    ("Global Youth Service Dayyear (latent)", -6.094697801749634),
                                    ("Dhanterasin|during <named-month>|year", -6.094697801749634),
                                    ("Tisha B'Avyear (latent)", -6.094697801749634),
                                    ("Isra and Mi'rajyear (latent)", -5.178407069875479),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.094697801749634),
                                    ("Christmasyear (latent)", -5.68923269364147),
                                    ("Naraka Chaturdashiyear (latent)", -5.68923269364147),
                                    ("at <time-of-day>on <date>", -4.996085513081525),
                                    ("Thai Pongalin|during <named-month>|year", -6.094697801749634),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.094697801749634),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.485259889315534),
                                    ("dayweek", -6.094697801749634),
                                    ("Easter Sundayyear (latent)", -5.401550621189689),
                                    ("weekyear", -4.996085513081525),
                                    ("hh:mmin|during the <part-of-day>", -5.401550621189689),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.68923269364147),
                                    ("Hanukkahyear (latent)", -5.401550621189689),
                                    ("February<time> <part-of-day>", -6.094697801749634),
                                    ("National Grandparents Dayyear (latent)", -6.094697801749634),
                                    ("Great Lentyear (latent)", -6.094697801749634),
                                    ("tomorrowat <time-of-day>", -5.401550621189689),
                                    ("Labor Dayyear (latent)", -6.094697801749634),
                                    ("between <time> and <time>on <date>", -4.485259889315534),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.094697801749634),
                                    ("last <cycle> of <time>year (latent)", -5.401550621189689),
                                    ("at <time-of-day>tomorrow", -5.68923269364147),
                                    ("tomorrow<time-of-day> am|pm", -6.094697801749634),
                                    ("President's Dayyear (latent)", -6.094697801749634),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.094697801749634),
                                    ("Diwaliyear (latent)", -6.094697801749634),
                                    ("Black Fridayyear (latent)", -5.68923269364147),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.094697801749634),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.094697801749634),
                                    ("Chhathyear (latent)", -5.68923269364147),
                                    ("Vasant Panchamiyear (latent)", -6.094697801749634),
                                    ("Tax Dayyear (latent)", -5.178407069875479),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.094697801749634),
                                    ("Februaryintersect", -6.094697801749634),
                                    ("Mother's Dayyear (latent)", -6.094697801749634),
                                    ("Simchat Torahyear (latent)", -6.094697801749634),
                                    ("minuteyear", -6.094697801749634)],
                               n = 333},
                   koData =
                     ClassData{prior = -1.0331071168994435, unseen = -6.380122536899766,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.768988271217486),
                                    ...
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.685279003091641),
                                    ("Mondayyear (latent)", -4.586666714423532),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.2798138949834765),
                                    ("week-endin|during <named-month>|year", -5.685279003091641),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.2798138949834765),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.685279003091641),
                                    ("Sundayyear (latent)", -4.768988271217486),
                                    ("Christmasat <time-of-day>", -5.685279003091641),
                                    ("from|since|after <time>year (latent)", -4.586666714423532),
