...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6334486796263751, unseen = -5.921578419643816,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 371},
                   koData =
                     ClassData{prior = -0.7566371338496665, unseen = -5.799092654460526,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4732877044469254, unseen = -7.00397413672268,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.309918278226516),
                                    ("Father's Dayyear (latent)", -6.309918278226516),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.309918278226516),
                                    ("Ramadanyear (latent)", -5.393627546352362),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.295015257684252),
                                    ("Military Spouse Dayyear (latent)", -6.309918278226516),
                                    ("Bhai Doojyear (latent)", -6.309918278226516),
                                    ("hourday", -4.295015257684252),
                                    ("dayhour", -3.3921475461422372),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.295015257684252),
                                    ("Martin Luther King's Dayyear (latent)", -5.9044531701183525),
                                    ("Shemini Atzeretyear (latent)", -6.309918278226516),
                                    ("daymonth", -4.700480365792417),
                                    ("monthday", -5.9044531701183525),
                                    ("monthyear", -4.518158808998462),
                                    ("Yom Ha'atzmautyear (latent)", -6.309918278226516),
                                    ("Vijayadashamiyear (latent)", -6.309918278226516),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -4.923623917106626),
                                    ("Thanksgiving Dayyear (latent)", -5.211305989558407),
                                    ("Thai Pongalyear (latent)", -5.616771097666572),
                                    ("Thiru Onamyear (latent)", -5.616771097666572),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.309918278226516),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.309918278226516),
                                    ("<day-of-month> (ordinal)Wednesday", -6.309918278226516),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.309918278226516),
                                    ("houryear", -5.393627546352362),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.309918278226516),
                                    ("Christmas<time-of-day> am|pm", -6.309918278226516),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.309918278226516),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.616771097666572),
                                    ("intersectin|during <named-month>|year", -6.309918278226516),
                                    ("<time-of-day> am|pmintersect", -5.057155309731149),
                                    ("Earth Houryear (latent)", -6.309918278226516),
                                    ("Octoberyear (latent)", -4.8058408814502425),
                                    ("intersect<time-of-day> am|pm", -6.309918278226516),
                                    ("Mattu Pongalyear (latent)", -6.309918278226516),
                                    ("Daylight Saving Start Dayyear (latent)", -5.393627546352362),
                                    ("Shavuotyear (latent)", -6.309918278226516),
                                    ("Parsi New Yearyear (latent)", -5.393627546352362),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.309918278226516),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.309918278226516),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.9044531701183525),
                                    ("Marchyear (latent)", -6.309918278226516),
                                    ("Sukkotyear (latent)", -5.9044531701183525),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.9044531701183525),
                                    ("Daylight Saving End Dayyear (latent)", -5.393627546352362),
                                    ("Clean Mondayyear (latent)", -5.9044531701183525),
                                    ("monthhour", -5.9044531701183525),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.616771097666572),
                                    ("todayat <time-of-day>", -6.309918278226516),
                                    ("Thursday<time> timezone", -4.364008129171204),
                                    ("time-of-day (latent)tonight", -5.9044531701183525),
                                    ("from|since|after <time>December", -6.309918278226516),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.309918278226516),
                                    ("<time-of-day> am|pmon <day>", -4.295015257684252),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.309918278226516),
                                    ("yyyy-mm-ddhh:mm:ss", -5.9044531701183525),
                                    ("Tax Daythis|last|next <cycle>", -6.309918278226516),
                                    ("dayday", -3.8675712428573124),
                                    ("<time> <part-of-day>at <time-of-day>", -6.309918278226516),
                                    ("mm/ddat <time-of-day>", -6.309918278226516),
                                    ("tonightat <time-of-day>", -6.309918278226516),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.616771097666572),
                                    ("today<time-of-day> am|pm", -6.309918278226516),
                                    ("Februarythe <day-of-month> (ordinal)", -5.9044531701183525),
                                    ("at <time-of-day><time> <part-of-day>", -6.309918278226516),
                                    ("<day-of-month> (ordinal)intersect", -5.9044531701183525),
                                    ("mm/dd<time-of-day> am|pm", -6.309918278226516),
                                    ("hourhour", -4.230476736546681),
                                    ("Navaratriin|during <named-month>|year", -6.309918278226516),
                                    ("Wednesdaythis|last|next <cycle>", -6.309918278226516),
                                    ("Lentyear (latent)", -6.309918278226516),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.8058408814502425),
                                    ("Boghiyear (latent)", -6.309918278226516),
                                    ("dayyear", -1.9093152579796995),
                                    ("Thursdayfrom|since|after <time>", -5.9044531701183525),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.309918278226516),
                                    ("Thursdayat <time-of-day>", -5.616771097666572),
                                    ("Islamic New Yearyear (latent)", -5.9044531701183525),
                                    ("Laylat al-Qadryear (latent)", -5.393627546352362),
                                    ("Shrove Tuesdayyear (latent)", -6.309918278226516),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.616771097666572),
                                    ("<time-of-day> am|pmtomorrow", -5.616771097666572),
                                    ("Yom Kippuryear (latent)", -6.309918278226516),
                                    ("<day-of-month> (ordinal)Tuesday", -5.9044531701183525),
                                    ("<part-of-day> of <time>year (latent)", -6.309918278226516),
                                    ("minutehour", -5.211305989558407),
                                    ("Kaanum Pongalyear (latent)", -5.9044531701183525),
                                    ("Maha Saptamiyear (latent)", -6.309918278226516),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.9044531701183525),
                                    ("time-of-day (latent)tomorrow", -5.393627546352362),
                                    ("part of daysat <time-of-day>", -5.9044531701183525),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.605170185988091),
                                    ("for <duration> from <time>December", -6.309918278226516),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.309918278226516),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.057155309731149),
                                    ("time-of-day (latent)this <part-of-day>", -6.309918278226516),
                                    ("Pentecostyear (latent)", -6.309918278226516),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.057155309731149),
                                    ("<day-of-month> (ordinal)February", -6.309918278226516),
                                    ("Eid al-Fitryear (latent)", -5.393627546352362),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.309918278226516),
                                    ("Mondayin|during the <part-of-day>", -6.309918278226516),
                                    ("Chhathin|during <named-month>|year", -6.309918278226516),
                                    ("Diwaliin|during <named-month>|year", -6.309918278226516),
                                    ("Vaisakhiin|during <named-month>|year", -6.309918278226516),
                                    ("Raksha Bandhanyear (latent)", -6.309918278226516),
                                    ("daysecond", -5.9044531701183525),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.9044531701183525),
                                    ("Emancipation Dayyear (latent)", -5.616771097666572),
                                    ("Ashurayear (latent)", -6.309918278226516),
                                    ("Tuesdayin|during <named-month>|year", -6.309918278226516),
                                    ("Chinese New Yearyear (latent)", -6.309918278226516),
                                    ("tomorrowintersect", -6.309918278226516),
                                    ("Lag BaOmeryear (latent)", -6.309918278226516),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.309918278226516),
                                    ("Eid al-Adhayear (latent)", -5.393627546352362),
                                    ("intersectin|during the <part-of-day>", -6.309918278226516),
                                    ("Palm Sundayyear (latent)", -6.309918278226516),
                                    ("Christmasat <time-of-day>", -6.309918278226516),
                                    ("Passoveryear (latent)", -6.309918278226516),
                                    ("Lazarus Saturdayyear (latent)", -6.309918278226516),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.309918278226516),
                                    ("Cyber Mondayyear (latent)", -5.9044531701183525),
                                    ("Yom HaShoahyear (latent)", -5.9044531701183525),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.9044531701183525),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.309918278226516),
                                    ("Septemberyear (latent)", -5.9044531701183525),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.8058408814502425),
                                    ("Halloweenyear (latent)", -6.309918278226516),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.309918278226516),
                                    ("at <time-of-day>intersect", -5.9044531701183525),
                                    ("Rosh Hashanahyear (latent)", -5.616771097666572),
                                    ("Dhanterasyear (latent)", -6.309918278226516),
                                    ("Tu BiShvatyear (latent)", -6.309918278226516),
                                    ("<day-of-month> (ordinal)December", -5.616771097666572),
                                    ("Holiyear (latent)", -5.616771097666572),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.309918278226516),
                                    ("Holika Dahanyear (latent)", -5.616771097666572),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.309918278226516),
                                    ("dayminute", -3.3921475461422372),
                                    ("Mawlidyear (latent)", -6.309918278226516),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.9044531701183525),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.309918278226516),
                                    ("Jumu'atul-Widayear (latent)", -5.393627546352362),
                                    ("minuteday", -2.4812768817374216),
                                    ("absorption of , after named dayintersect",
                                     -6.309918278226516),
                                    ("intersectyear (latent)", -6.309918278226516),
                                    ("Orthodox Easter Sundayyear (latent)", -6.309918278226516),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.309918278226516),
                                    ("Boss's Dayyear (latent)", -5.9044531701183525),
                                    ("Global Youth Service Dayyear (latent)", -6.309918278226516),
                                    ("Dhanterasin|during <named-month>|year", -6.309918278226516),
                                    ("Tisha B'Avyear (latent)", -6.309918278226516),
                                    ("Isra and Mi'rajyear (latent)", -5.393627546352362),
                                    ("at <time-of-day>on <day>", -5.211305989558407),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.309918278226516),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.616771097666572),
                                    ("Christmasyear (latent)", -5.9044531701183525),
                                    ("Naraka Chaturdashiyear (latent)", -5.9044531701183525),
                                    ("Thai Pongalin|during <named-month>|year", -6.309918278226516),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.309918278226516),
                                    ("dayweek", -6.309918278226516),
                                    ("Easter Sundayyear (latent)", -5.616771097666572),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.700480365792417),
                                    ("weekyear", -5.211305989558407),
                                    ("hh:mmin|during the <part-of-day>", -5.616771097666572),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.9044531701183525),
                                    ("Hanukkahyear (latent)", -5.616771097666572),
                                    ("February<time> <part-of-day>", -6.309918278226516),
                                    ("National Grandparents Dayyear (latent)", -6.309918278226516),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.309918278226516),
                                    ("Great Lentyear (latent)", -6.309918278226516),
                                    ("tomorrowat <time-of-day>", -5.616771097666572),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.309918278226516),
                                    ("Labor Dayyear (latent)", -6.309918278226516),
                                    ("Vaisakhiyear (latent)", -5.616771097666572),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.309918278226516),
                                    ("last <cycle> of <time>year (latent)", -5.616771097666572),
                                    ("at <time-of-day>tomorrow", -5.9044531701183525),
                                    ("tomorrow<time-of-day> am|pm", -6.309918278226516),
                                    ("President's Dayyear (latent)", -6.309918278226516),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.309918278226516),
                                    ("Diwaliyear (latent)", -6.309918278226516),
                                    ("between <time> and <time>on <day>", -4.700480365792417),
                                    ("Black Fridayyear (latent)", -5.9044531701183525),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.309918278226516),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.309918278226516),
                                    ("Chhathyear (latent)", -5.9044531701183525),
                                    ("Vasant Panchamiyear (latent)", -6.309918278226516),
                                    ("Tax Dayyear (latent)", -5.393627546352362),
                                    ("St Patrick's Dayyear (latent)", -6.309918278226516),
                                    ("Thursday<time> (timezone)", -6.309918278226516),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.309918278226516),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.9044531701183525),
                                    ("Februaryintersect", -6.309918278226516),
                                    ("Mother's Dayyear (latent)", -6.309918278226516),
                                    ("Simchat Torahyear (latent)", -6.309918278226516),
                                    ("minuteyear", -6.309918278226516)],
                               n = 418},
                   koData =
                     ClassData{prior = -0.9753796482441617, unseen = -6.647688373563329,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.245193133185574),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.953243334287785),
                                    ("<day-of-month> (ordinal)August", -5.953243334287785),
                                    ("dayhour", -3.2790946848612554),
                                    ("<time> timezoneyear (latent)", -5.953243334287785),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.0369526024136295),
                                    ("Tuesdayfrom|since|after <time>", -5.953243334287785),
                                    ("daymonth", -3.701951535681289),
                                    ("monthyear", -4.700480365792417),
                                    ("<time-of-day> am|pmyear (latent)", -5.260096153727839),
                                    ("Thai Pongalyear (latent)", -5.260096153727839),
                                    ("intersecthh:mm", -5.953243334287785),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.953243334287785),
                                    ("<day-of-month> (ordinal)Wednesday", -5.953243334287785),
                                    ("houryear", -4.566948973167894),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.953243334287785),
                                    ("<day-of-month> (ordinal)October", -5.953243334287785),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.260096153727839),
                                    ("<time-of-day> am|pmintersect", -4.700480365792417),
                                    ("Octoberyear (latent)", -5.953243334287785),
                                    ("until <time>on <day>", -5.260096153727839),
                                    ("time-of-day (latent)intersect", -5.953243334287785),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.260096153727839),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.953243334287785),
                                    ("hh:mmon <day>", -3.51089629891858),
                                    ("absorption of , after named dayJuly", -5.54777822617962),
                                    ("from|since|after <time>July", -5.953243334287785),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.0369526024136295),
                                    ("Clean Mondayyear (latent)", -5.953243334287785),
                                    ("monthhour", -5.953243334287785),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.54777822617962),
                                    ("hourmonth", -4.343805421853684),
                                    ("todayat <time-of-day>", -5.953243334287785),
                                    ("from|since|after <time>December", -5.953243334287785),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.953243334287785),
                                    ("<time-of-day> am|pmon <day>", -4.700480365792417),
                                    ("Mondayyear (latent)", -4.854631045619675),
                                    ("dayday", -4.566948973167894),
                                    ("mm/ddat <time-of-day>", -5.54777822617962),
                                    ("on <day>September", -5.54777822617962),
                                    ("time-of-day (latent)September", -5.54777822617962),
                                    ("hourhour", -5.953243334287785),
                                    ("time-of-day (latent)on <day>", -3.51089629891858),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.54777822617962),
                                    ("dayyear", -2.9575110607337933),
                                    ("Thursdaymm/dd", -5.953243334287785),
                                    ("New Year's Dayyear (latent)", -5.0369526024136295),
                                    ("Thursdayfrom|since|after <time>", -4.248495242049359),
                                    ("Thursdayat <time-of-day>", -4.343805421853684),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.953243334287785),
                                    ("Aprilyear (latent)", -5.953243334287785),
                                    ("monthminute", -5.953243334287785),
                                    ("<time-of-day> am|pmtomorrow", -5.953243334287785),
                                    ("Thursdayhh:mm", -5.0369526024136295),
                                    ("<day-of-month> (ordinal)Tuesday", -5.54777822617962),
                                    ("minutemonth", -4.161483865059729),
                                    ("minutehour", -5.953243334287785),
                                    ("Augustyear (latent)", -5.54777822617962),
                                    ("week-endin|during <named-month>|year", -5.953243334287785),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.54777822617962),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.953243334287785),
                                    ("Sundayyear (latent)", -5.0369526024136295),
                                    ("Christmasat <time-of-day>", -5.953243334287785),
                                    ("from|since|after <time>year (latent)", -4.854631045619675),
                                    ("<duration> after|before|from <time>December",
                                     -5.953243334287785),
                                    ("yesterday<time-of-day> am|pm", -5.953243334287785),
                                    ("<day-of-month> (ordinal)July", -5.953243334287785),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.953243334287785),
                                    ("mm/ddyear (latent)", -5.953243334287785),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.953243334287785),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.953243334287785),
                                    ("at <time-of-day>intersect", -5.54777822617962),
                                    ("hh:mmyear (latent)", -3.8738017926079484),
                                    ("Holiyear (latent)", -5.953243334287785),
                                    ("until <time><time-of-day> am|pm", -5.953243334287785),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.953243334287785),
                                    ("dayminute", -3.3882939768262474),
                                    ("yyyy-mm-ddhh:mm", -5.54777822617962),
                                    ("intersectSeptember", -4.44916593751151),
                                    ("minuteday", -2.714564882123404),
                                    ("absorption of , after named dayintersect",
                                     -5.953243334287785),
                                    ("intersectyear (latent)", -5.953243334287785),
                                    ("Februaryin|during the <part-of-day>", -5.953243334287785),
                                    ("time-of-day (latent)July", -5.953243334287785),
                                    ("Saturdayyear (latent)", -5.953243334287785),
                                    ("at <time-of-day>on <day>", -5.54777822617962),
                                    ("absorption of , after named daySeptember",
                                     -5.0369526024136295),
                                    ("Naraka Chaturdashiyear (latent)", -5.953243334287785),
                                    ("from|since|after <time>on <day>", -5.0369526024136295),
                                    ("dayweek", -5.953243334287785),
                                    ("Easter Sundayyear (latent)", -5.54777822617962),
                                    ("Thursday<time-of-day> am|pm", -4.700480365792417),
                                    ("weekyear", -5.54777822617962),
                                    ("time-of-day (latent)Thursday", -5.54777822617962),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.953243334287785),
                                    ("<day-of-month> (ordinal)April", -5.953243334287785),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.54777822617962),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.260096153727839),
                                    ("Sundayfrom|since|after <time>", -5.953243334287785),
                                    ...
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.953243334287785),
                                    ("tomorrowat <time-of-day>", -5.953243334287785),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.953243334287785),
                                    ("last <cycle> of <time>year (latent)", -5.54777822617962),
                                    ("tomorrow<time-of-day> am|pm", -5.953243334287785),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.260096153727839),
                                    ("Diwaliyear (latent)", -5.54777822617962),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.953243334287785),
                                    ("Fridayyear (latent)", -5.54777822617962),
                                    ("time-of-day (latent)April", -5.953243334287785),
                                    ("minuteyear", -3.7560187569515646)],
                               n = 253}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.17072980863016957,
                               unseen = -5.262690188904886,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.17486983145803e-2),
                                    ("intersect 2 numbers", -3.871201010907891)],
                               n = 188},
                   koData =
                     ClassData{prior = -1.8518237099707051,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
