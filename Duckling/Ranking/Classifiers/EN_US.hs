...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.625235974943735, unseen = -5.986452005284438,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 396},
                   koData =
                     ClassData{prior = -0.7660085288248171, unseen = -5.846438775057725,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47404637226269414,
                               unseen = -7.033506484287697,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.339477080468061),
                                    ("Father's Dayyear (latent)", -6.339477080468061),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.339477080468061),
                                    ("Ramadanyear (latent)", -5.423186348593906),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.324574059925796),
                                    ("Military Spouse Dayyear (latent)", -6.339477080468061),
                                    ("Bhai Doojyear (latent)", -6.339477080468061),
                                    ("hourday", -4.324574059925796),
                                    ("dayhour", -3.4217063483837817),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.324574059925796),
                                    ("Martin Luther King's Dayyear (latent)", -5.9340119723598965),
                                    ("Shemini Atzeretyear (latent)", -6.339477080468061),
                                    ("daymonth", -4.324574059925796),
                                    ("monthday", -5.9340119723598965),
                                    ("monthyear", -4.547717611240006),
                                    ("Yom Ha'atzmautyear (latent)", -6.339477080468061),
                                    ("Vijayadashamiyear (latent)", -6.339477080468061),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -4.95318271934817),
                                    ("Thanksgiving Dayyear (latent)", -5.240864791799951),
                                    ("Thai Pongalyear (latent)", -5.646329899908116),
                                    ("Thiru Onamyear (latent)", -5.646329899908116),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.339477080468061),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.423186348593906),
                                    ("<day-of-month> (ordinal)Wednesday", -6.339477080468061),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.339477080468061),
                                    ("houryear", -5.423186348593906),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.339477080468061),
                                    ("Christmas<time-of-day> am|pm", -6.339477080468061),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.339477080468061),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.646329899908116),
                                    ("intersectin|during <named-month>|year", -6.339477080468061),
                                    ("<time-of-day> am|pmintersect", -5.086714111972693),
                                    ("Earth Houryear (latent)", -6.339477080468061),
                                    ("Octoberyear (latent)", -4.835399683691787),
                                    ("intersect<time-of-day> am|pm", -6.339477080468061),
                                    ("Mattu Pongalyear (latent)", -6.339477080468061),
                                    ("Daylight Saving Start Dayyear (latent)", -5.423186348593906),
                                    ("Shavuotyear (latent)", -6.339477080468061),
                                    ("Parsi New Yearyear (latent)", -5.423186348593906),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.339477080468061),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.339477080468061),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.9340119723598965),
                                    ("Marchyear (latent)", -6.339477080468061),
                                    ("Sukkotyear (latent)", -5.9340119723598965),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.9340119723598965),
                                    ("Daylight Saving End Dayyear (latent)", -5.423186348593906),
                                    ("Clean Mondayyear (latent)", -5.9340119723598965),
                                    ("monthhour", -5.9340119723598965),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.646329899908116),
                                    ("todayat <time-of-day>", -6.339477080468061),
                                    ("Thursday<time> timezone", -4.393566931412748),
                                    ("time-of-day (latent)tonight", -5.9340119723598965),
                                    ("from|since|after <time>December", -6.339477080468061),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.339477080468061),
                                    ("<time-of-day> am|pmon <day>", -4.324574059925796),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.339477080468061),
                                    ("yyyy-mm-ddhh:mm:ss", -5.9340119723598965),
                                    ("Tax Daythis|last|next <cycle>", -6.339477080468061),
                                    ("dayday", -3.8971300450988564),
                                    ("<time> <part-of-day>at <time-of-day>", -6.339477080468061),
                                    ("mm/ddat <time-of-day>", -6.339477080468061),
                                    ("tonightat <time-of-day>", -6.339477080468061),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.646329899908116),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.339477080468061),
                                    ("today<time-of-day> am|pm", -6.339477080468061),
                                    ("Februarythe <day-of-month> (ordinal)", -5.9340119723598965),
                                    ("at <time-of-day><time> <part-of-day>", -6.339477080468061),
                                    ("<day-of-month> (ordinal)intersect", -5.9340119723598965),
                                    ("mm/dd<time-of-day> am|pm", -6.339477080468061),
                                    ("hourhour", -4.260035538788225),
                                    ("Navaratriin|during <named-month>|year", -6.339477080468061),
                                    ("Wednesdaythis|last|next <cycle>", -6.339477080468061),
                                    ("Lentyear (latent)", -6.339477080468061),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.835399683691787),
                                    ("Boghiyear (latent)", -6.339477080468061),
                                    ("dayyear", -1.8851297842145534),
                                    ("Thursdayfrom|since|after <time>", -5.9340119723598965),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.339477080468061),
                                    ("Thursdayat <time-of-day>", -5.646329899908116),
                                    ("Islamic New Yearyear (latent)", -5.9340119723598965),
                                    ("Laylat al-Qadryear (latent)", -5.423186348593906),
                                    ("Shrove Tuesdayyear (latent)", -6.339477080468061),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.646329899908116),
                                    ("<time-of-day> am|pmtomorrow", -5.646329899908116),
                                    ("Yom Kippuryear (latent)", -6.339477080468061),
                                    ("<day-of-month> (ordinal)Tuesday", -5.9340119723598965),
                                    ("<part-of-day> of <time>year (latent)", -6.339477080468061),
                                    ("minutehour", -5.240864791799951),
                                    ("Kaanum Pongalyear (latent)", -5.9340119723598965),
                                    ("Maha Saptamiyear (latent)", -6.339477080468061),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.9340119723598965),
                                    ("time-of-day (latent)tomorrow", -5.423186348593906),
                                    ("part of daysat <time-of-day>", -5.9340119723598965),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.634728988229636),
                                    ("for <duration> from <time>December", -6.339477080468061),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.339477080468061),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.086714111972693),
                                    ("time-of-day (latent)this <part-of-day>", -6.339477080468061),
                                    ("Pentecostyear (latent)", -6.339477080468061),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.086714111972693),
                                    ("<day-of-month> (ordinal)February", -6.339477080468061),
                                    ("Eid al-Fitryear (latent)", -5.423186348593906),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.339477080468061),
                                    ("Mondayin|during the <part-of-day>", -6.339477080468061),
                                    ("Chhathin|during <named-month>|year", -6.339477080468061),
                                    ("Diwaliin|during <named-month>|year", -6.339477080468061),
                                    ("Vaisakhiin|during <named-month>|year", -6.339477080468061),
                                    ("Raksha Bandhanyear (latent)", -6.339477080468061),
                                    ("daysecond", -5.9340119723598965),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.9340119723598965),
                                    ("Emancipation Dayyear (latent)", -5.646329899908116),
                                    ("Ashurayear (latent)", -6.339477080468061),
                                    ("Tuesdayin|during <named-month>|year", -6.339477080468061),
                                    ("Chinese New Yearyear (latent)", -6.339477080468061),
                                    ("tomorrowintersect", -6.339477080468061),
                                    ("Lag BaOmeryear (latent)", -6.339477080468061),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.339477080468061),
                                    ("Eid al-Adhayear (latent)", -5.423186348593906),
                                    ("intersectin|during the <part-of-day>", -6.339477080468061),
                                    ("Palm Sundayyear (latent)", -6.339477080468061),
                                    ("Christmasat <time-of-day>", -6.339477080468061),
                                    ("Passoveryear (latent)", -6.339477080468061),
                                    ("Lazarus Saturdayyear (latent)", -6.339477080468061),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.339477080468061),
                                    ("Cyber Mondayyear (latent)", -5.9340119723598965),
                                    ("Yom HaShoahyear (latent)", -5.9340119723598965),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.9340119723598965),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.339477080468061),
                                    ("Septemberyear (latent)", -5.9340119723598965),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.835399683691787),
                                    ("Halloweenyear (latent)", -6.339477080468061),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.339477080468061),
                                    ("at <time-of-day>intersect", -5.9340119723598965),
                                    ("Rosh Hashanahyear (latent)", -5.646329899908116),
                                    ("Dhanterasyear (latent)", -6.339477080468061),
                                    ("Tu BiShvatyear (latent)", -6.339477080468061),
                                    ("<day-of-month> (ordinal)December", -5.646329899908116),
                                    ("Holiyear (latent)", -5.646329899908116),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.339477080468061),
                                    ("Holika Dahanyear (latent)", -5.646329899908116),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.339477080468061),
                                    ("dayminute", -3.4217063483837817),
                                    ("Mawlidyear (latent)", -6.339477080468061),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.9340119723598965),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.339477080468061),
                                    ("Jumu'atul-Widayear (latent)", -5.423186348593906),
                                    ("minuteday", -2.510835683978966),
                                    ("absorption of , after named dayintersect",
                                     -6.339477080468061),
                                    ("intersectyear (latent)", -6.339477080468061),
                                    ("Orthodox Easter Sundayyear (latent)", -6.339477080468061),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.339477080468061),
                                    ("Boss's Dayyear (latent)", -5.9340119723598965),
                                    ("Global Youth Service Dayyear (latent)", -6.339477080468061),
                                    ("Dhanterasin|during <named-month>|year", -6.339477080468061),
                                    ("Tisha B'Avyear (latent)", -6.339477080468061),
                                    ("Isra and Mi'rajyear (latent)", -5.423186348593906),
                                    ("at <time-of-day>on <day>", -5.240864791799951),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.339477080468061),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.646329899908116),
                                    ("Christmasyear (latent)", -5.9340119723598965),
                                    ("Naraka Chaturdashiyear (latent)", -5.9340119723598965),
                                    ("Thai Pongalin|during <named-month>|year", -6.339477080468061),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.339477080468061),
                                    ("dayweek", -6.339477080468061),
                                    ("Easter Sundayyear (latent)", -5.646329899908116),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.730039168033961),
                                    ("weekyear", -5.240864791799951),
                                    ("King's Dayyear (latent)", -4.835399683691787),
                                    ("hh:mmin|during the <part-of-day>", -5.646329899908116),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.9340119723598965),
                                    ("Hanukkahyear (latent)", -5.646329899908116),
                                    ("February<time> <part-of-day>", -6.339477080468061),
                                    ("National Grandparents Dayyear (latent)", -6.339477080468061),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.339477080468061),
                                    ("Great Lentyear (latent)", -6.339477080468061),
                                    ("tomorrowat <time-of-day>", -5.646329899908116),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.339477080468061),
                                    ("Labor Dayyear (latent)", -6.339477080468061),
                                    ("Vaisakhiyear (latent)", -5.646329899908116),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.339477080468061),
                                    ("last <cycle> of <time>year (latent)", -5.646329899908116),
                                    ("at <time-of-day>tomorrow", -5.9340119723598965),
                                    ("tomorrow<time-of-day> am|pm", -6.339477080468061),
                                    ("President's Dayyear (latent)", -6.339477080468061),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.339477080468061),
                                    ("Diwaliyear (latent)", -6.339477080468061),
                                    ("between <time> and <time>on <day>", -4.730039168033961),
                                    ("Black Fridayyear (latent)", -5.9340119723598965),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.339477080468061),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.339477080468061),
                                    ("Chhathyear (latent)", -5.9340119723598965),
                                    ("Vasant Panchamiyear (latent)", -6.339477080468061),
                                    ("Tax Dayyear (latent)", -5.423186348593906),
                                    ("St Patrick's Dayyear (latent)", -6.339477080468061),
                                    ("Thursday<time> (timezone)", -6.339477080468061),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.339477080468061),
                                    ("<datetime> - <datetime> (interval)July", -5.9340119723598965),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.9340119723598965),
                                    ("Februaryintersect", -6.339477080468061),
                                    ("Mother's Dayyear (latent)", -6.339477080468061),
                                    ("Simchat Torahyear (latent)", -6.339477080468061),
                                    ("minuteyear", -6.339477080468061)],
                               n = 432},
                   koData =
                     ClassData{prior = -0.9741274567457076, unseen = -6.677083461247136,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.2746258399726926),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.982676041074902),
                                    ("<day-of-month> (ordinal)August", -5.982676041074902),
                                    ("dayhour", -3.308527391648374),
                                    ("<time> timezoneyear (latent)", -5.982676041074902),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.066385309200748),
                                    ("Tuesdayfrom|since|after <time>", -5.982676041074902),
                                    ("daymonth", -3.4977693912869023),
                                    ("monthyear", -4.729913072579534),
                                    ("<time-of-day> am|pmyear (latent)", -5.289528860514958),
                                    ("Thai Pongalyear (latent)", -5.289528860514958),
                                    ("intersecthh:mm", -5.982676041074902),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.5772109329667385),
                                    ("<day-of-month> (ordinal)Wednesday", -5.982676041074902),
                                    ("houryear", -4.596381679955012),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.982676041074902),
                                    ("<day-of-month> (ordinal)October", -5.982676041074902),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.289528860514958),
                                    ("<time-of-day> am|pmintersect", -4.729913072579534),
                                    ("Octoberyear (latent)", -5.982676041074902),
                                    ("until <time>on <day>", -5.289528860514958),
                                    ("time-of-day (latent)intersect", -5.982676041074902),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.289528860514958),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.982676041074902),
                                    ("hh:mmon <day>", -3.5403290057056984),
                                    ("absorption of , after named dayJuly", -5.5772109329667385),
                                    ("from|since|after <time>July", -5.5772109329667385),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.066385309200748),
                                    ("Clean Mondayyear (latent)", -5.982676041074902),
                                    ("monthhour", -5.982676041074902),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.5772109329667385),
                                    ("hourmonth", -4.110873864173311),
                                    ("todayat <time-of-day>", -5.982676041074902),
                                    ("from|since|after <time>December", -5.982676041074902),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.982676041074902),
                                    ("<time-of-day> am|pmon <day>", -4.729913072579534),
                                    ("Mondayyear (latent)", -4.884063752406793),
                                    ("dayday", -4.596381679955012),
                                    ("mm/ddat <time-of-day>", -5.5772109329667385),
                                    ("on <day>September", -5.5772109329667385),
                                    ("time-of-day (latent)September", -5.5772109329667385),
                                    ("hourhour", -5.982676041074902),
                                    ("time-of-day (latent)on <day>", -3.5403290057056984),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.5772109329667385),
                                    ("dayyear", -2.986943767520912),
                                    ("Thursdaymm/dd", -5.982676041074902),
                                    ("New Year's Dayyear (latent)", -5.066385309200748),
                                    ("Thursdayfrom|since|after <time>", -4.277927948836477),
                                    ("Thursdayat <time-of-day>", -4.373238128640803),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.982676041074902),
                                    ("Aprilyear (latent)", -5.982676041074902),
                                    ("the <day-of-month> (ordinal)July", -5.982676041074902),
                                    ("the <day-of-month> (number)July", -5.982676041074902),
                                    ("monthminute", -5.982676041074902),
                                    ("<time-of-day> am|pmtomorrow", -5.982676041074902),
                                    ("Thursdayhh:mm", -5.066385309200748),
                                    ("<day-of-month> (ordinal)Tuesday", -5.5772109329667385),
                                    ("minutemonth", -4.110873864173311),
                                    ("minutehour", -5.982676041074902),
                                    ("Augustyear (latent)", -5.5772109329667385),
                                    ("week-endin|during <named-month>|year", -5.982676041074902),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.5772109329667385),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.982676041074902),
                                    ("Sundayyear (latent)", -5.066385309200748),
                                    ("Christmasat <time-of-day>", -5.982676041074902),
                                    ("from|since|after <time>year (latent)", -4.884063752406793),
                                    ("<duration> after|before|from <time>December",
                                     -5.982676041074902),
                                    ("yesterday<time-of-day> am|pm", -5.982676041074902),
                                    ("<day-of-month> (ordinal)July", -5.289528860514958),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.982676041074902),
                                    ("mm/ddyear (latent)", -5.982676041074902),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.982676041074902),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.982676041074902),
                                    ("at <time-of-day>intersect", -5.5772109329667385),
                                    ("hh:mmyear (latent)", -3.903234499395067),
                                    ("Holiyear (latent)", -5.982676041074902),
                                    ("until <time><time-of-day> am|pm", -5.982676041074902),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.982676041074902),
                                    ("dayminute", -3.417726683613366),
                                    ("yyyy-mm-ddhh:mm", -5.5772109329667385),
                                    ("intersectSeptember", -4.4785986442986285),
                                    ("minuteday", -2.7439975889105224),
                                    ("absorption of , after named dayintersect",
                                     -5.982676041074902),
                                    ("intersectyear (latent)", -5.982676041074902),
                                    ("Februaryin|during the <part-of-day>", -5.982676041074902),
                                    ("time-of-day (latent)July", -5.289528860514958),
                                    ("Saturdayyear (latent)", -5.982676041074902),
                                    ("at <time-of-day>on <day>", -5.5772109329667385),
                                    ("absorption of , after named daySeptember",
                                     -5.066385309200748),
                                    ("Naraka Chaturdashiyear (latent)", -5.982676041074902),
                                    ("from|since|after <time>on <day>", -5.066385309200748),
                                    ("dayweek", -5.982676041074902),
                                    ("Easter Sundayyear (latent)", -5.5772109329667385),
                                    ("Thursday<time-of-day> am|pm", -4.729913072579534),
                                    ("weekyear", -5.5772109329667385),
                                    ("time-of-day (latent)Thursday", -5.5772109329667385),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.982676041074902),
                                    ("<day-of-month> (ordinal)April", -5.982676041074902),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.5772109329667385),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.289528860514958),
                                    ("Sundayfrom|since|after <time>", -5.982676041074902),
                                    ("absorption of , after named dayFebruary", -5.066385309200748),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.982676041074902),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.982676041074902),
                                    ("tomorrowat <time-of-day>", -5.982676041074902),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.5772109329667385),
                                    ("last <cycle> of <time>year (latent)", -5.5772109329667385),
                                    ("tomorrow<time-of-day> am|pm", -5.982676041074902),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.289528860514958),
                                    ("Diwaliyear (latent)", -5.5772109329667385),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.982676041074902),
                                    ("Fridayyear (latent)", -5.5772109329667385),
                                    ("time-of-day (latent)April", -5.982676041074902),
                                    ("minuteyear", -3.785451463738683)],
                               n = 262}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.16353364292832145,
                               unseen = -5.308267697401205,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.0305349495328922e-2),
                                    ("intersect 2 numbers", -3.917010546939185)],
                               n = 197},
                   koData =
                     ClassData{prior = -1.8913893101768964,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
