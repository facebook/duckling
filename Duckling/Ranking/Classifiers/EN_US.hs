...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6831370869648449, unseen = -5.53338948872752,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 251},
                   koData =
                     ClassData{prior = -0.7032584901642659,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48247039801086555,
                               unseen = -6.617402977974478,
                               likelihoods =
                                 HashMap.fromList
                                   [("Father's Dayyear (latent)", -5.922918004572872),
                                    ("Ramadanyear (latent)", -5.922918004572872),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.670155036077504),
                                    ("Military Spouse Dayyear (latent)", -5.922918004572872),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.670155036077504),
                                    ("hourday", -4.218169912334447),
                                    ("dayhour", -3.005147272488593),
                                    ("Martin Luther King's Dayyear (latent)", -5.517452896464707),
                                    ("Shemini Atzeretyear (latent)", -5.922918004572872),
                                    ("daymonth", -5.229770824012927),
                                    ("monthday", -5.517452896464707),
                                    ("monthyear", -4.3134800921387715),
                                    ("Yom Ha'atzmautyear (latent)", -5.922918004572872),
                                    ("Thanksgiving Dayyear (latent)", -4.824305715904762),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.922918004572872),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.922918004572872),
                                    ("houryear", -5.229770824012927),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.922918004572872),
                                    ("Christmas<time-of-day> am|pm", -5.922918004572872),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.922918004572872),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.229770824012927),
                                    ("<time-of-day> am|pmintersect", -4.670155036077504),
                                    ("Octoberyear (latent)", -4.670155036077504),
                                    ("intersect<time-of-day> am|pm", -5.922918004572872),
                                    ("Shavuotyear (latent)", -5.922918004572872),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.922918004572872),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.922918004572872),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.517452896464707),
                                    ("Marchyear (latent)", -5.922918004572872),
                                    ("Sukkotyear (latent)", -5.517452896464707),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.922918004572872),
                                    ("Clean Mondayyear (latent)", -5.517452896464707),
                                    ("monthhour", -5.517452896464707),
                                    ("todayat <time-of-day>", -5.922918004572872),
                                    ("Thursday<time> timezone", -4.218169912334447),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.922918004572872),
                                    ("Palm SundaySunday", -5.517452896464707),
                                    ("dayday", -3.7256934272366524),
                                    ("<time> <part-of-day>at <time-of-day>", -5.922918004572872),
                                    ("mm/ddat <time-of-day>", -5.922918004572872),
                                    ("tonightat <time-of-day>", -5.922918004572872),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.229770824012927),
                                    ("today<time-of-day> am|pm", -5.922918004572872),
                                    ("Februarythe <day-of-month> (ordinal)", -5.517452896464707),
                                    ("at <time-of-day><time> <part-of-day>", -5.922918004572872),
                                    ("mm/dd<time-of-day> am|pm", -5.922918004572872),
                                    ("hourhour", -4.670155036077504),
                                    ("<time-of-day> am|pmon <date>", -3.9080149840306073),
                                    ("Wednesdaythis|last|next <cycle>", -5.922918004572872),
                                    ("Lentyear (latent)", -5.922918004572872),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.418840607796598),
                                    ("dayyear", -2.1972245773362196),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.922918004572872),
                                    ("Thursdayat <time-of-day>", -5.517452896464707),
                                    ("Islamic New Yearyear (latent)", -5.517452896464707),
                                    ("Laylat al-Qadryear (latent)", -5.006627272698717),
                                    ("Shrove Tuesdayyear (latent)", -5.922918004572872),
                                    ("<time-of-day> am|pmtomorrow", -5.229770824012927),
                                    ("Yom Kippuryear (latent)", -5.922918004572872),
                                    ("<part-of-day> of <time>year (latent)", -5.922918004572872),
                                    ("minutehour", -5.006627272698717),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.517452896464707),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.218169912334447),
                                    ("for <duration> from <time>December", -5.922918004572872),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.922918004572872),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.006627272698717),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.517452896464707),
                                    ("Pentecostyear (latent)", -5.922918004572872),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.006627272698717),
                                    ("Eid al-Fitryear (latent)", -5.922918004572872),
                                    ("Mondayin|during the <part-of-day>", -5.922918004572872),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.517452896464707),
                                    ("Ashurayear (latent)", -5.922918004572872),
                                    ("Chinese New Yearyear (latent)", -5.922918004572872),
                                    ("Sundayyear (latent)", -5.922918004572872),
                                    ("Lag BaOmeryear (latent)", -5.922918004572872),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.922918004572872),
                                    ("Eid al-Adhayear (latent)", -5.006627272698717),
                                    ("intersectin|during the <part-of-day>", -5.922918004572872),
                                    ("Christmasat <time-of-day>", -5.922918004572872),
                                    ("Passoveryear (latent)", -5.922918004572872),
                                    ("Lazarus Saturdayyear (latent)", -5.922918004572872),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.922918004572872),
                                    ("Cyber Mondayyear (latent)", -5.517452896464707),
                                    ("Yom HaShoahyear (latent)", -5.517452896464707),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.006627272698717),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.922918004572872),
                                    ("Septemberyear (latent)", -5.517452896464707),
                                    ("mm/ddyear (latent)", -5.922918004572872),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.670155036077504),
                                    ("Halloweenyear (latent)", -5.922918004572872),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.922918004572872),
                                    ("Tu BiShvatyear (latent)", -5.922918004572872),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.922918004572872),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.922918004572872),
                                    ("dayminute", -3.283860674957613),
                                    ("Mawlidyear (latent)", -5.922918004572872),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.517452896464707),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.922918004572872),
                                    ("Jumu'atul-Widayear (latent)", -5.006627272698717),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.922918004572872),
                                    ("minuteday", -2.2853318448464863),
                                    ("absorption of , after named dayintersect",
                                     -5.922918004572872),
                                    ("intersectyear (latent)", -5.922918004572872),
                                    ("Orthodox Easter Sundayyear (latent)", -5.922918004572872),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.922918004572872),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.922918004572872),
                                    ("Boss's Dayyear (latent)", -5.517452896464707),
                                    ("Tisha B'Avyear (latent)", -5.922918004572872),
                                    ("Isra and Mi'rajyear (latent)", -5.006627272698717),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.922918004572872),
                                    ("Christmasyear (latent)", -5.517452896464707),
                                    ("at <time-of-day>on <date>", -4.824305715904762),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.3134800921387715),
                                    ("dayweek", -5.922918004572872),
                                    ("Easter Sundayyear (latent)", -5.229770824012927),
                                    ("Thursday<time-of-day> am|pm", -5.922918004572872),
                                    ("weekyear", -5.517452896464707),
                                    ("hh:mmin|during the <part-of-day>", -5.229770824012927),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.517452896464707),
                                    ("Hanukkahyear (latent)", -5.922918004572872),
                                    ("February<time> <part-of-day>", -5.922918004572872),
                                    ("National Grandparents Dayyear (latent)", -5.922918004572872),
                                    ("Tuesdayin <named-month>|year", -5.922918004572872),
                                    ("Great Lentyear (latent)", -5.922918004572872),
                                    ("tomorrowat <time-of-day>", -5.229770824012927),
                                    ("Labor Dayyear (latent)", -5.922918004572872),
                                    ("between <time> and <time>on <date>", -4.3134800921387715),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.229770824012927),
                                    ("last <cycle> of <time>year (latent)", -5.229770824012927),
                                    ("at <time-of-day>tomorrow", -5.517452896464707),
                                    ("tomorrow<time-of-day> am|pm", -5.922918004572872),
                                    ("President's Dayyear (latent)", -5.922918004572872),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.922918004572872),
                                    ("Black Fridayyear (latent)", -5.517452896464707),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.922918004572872),
                                    ("Palm Sundayintersect", -5.922918004572872),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.922918004572872),
                                    ("Februaryintersect", -5.922918004572872),
                                    ("Mother's Dayyear (latent)", -5.922918004572872),
                                    ("Simchat Torahyear (latent)", -5.922918004572872)],
                               n = 279},
                   koData =
                     ClassData{prior = -0.9603905853344523, unseen = -6.284134161070802,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.589119566336061),
                                    ("hourday", -5.589119566336061),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.589119566336061),
                                    ("dayhour", -3.1467725309668566),
                                    ("daymonth", -3.509678024656225),
                                    ("monthday", -5.183654458227897),
                                    ("monthyear", -4.336356597840693),
                                    ("<time-of-day> am|pmyear (latent)", -5.183654458227897),
                                    ...
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.589119566336061),
                                    ("until <time-of-day><time-of-day> am|pm", -5.589119566336061),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.8959723857761155),
                                    ("<time-of-day> am|pmintersect", -4.336356597840693),
                                    ("Octoberyear (latent)", -5.589119566336061),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.336356597840693),
                                    ("from|since|after <time-of-day>on <date>", -4.672828834461907),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.589119566336061),
                                    ("absorption of , after named dayJuly", -5.183654458227897),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.672828834461907),
                                    ("Clean Mondayyear (latent)", -5.589119566336061),
                                    ("monthhour", -5.589119566336061),
                                    ("hourmonth", -4.8959723857761155),
                                    ("todayat <time-of-day>", -5.589119566336061),
                                    ("from|since|after <time-of-day>July", -5.589119566336061),
                                    ("Mondayyear (latent)", -4.490507277667952),
                                    ("dayday", -5.183654458227897),
                                    ("mm/ddat <time-of-day>", -5.183654458227897),
                                    ("<time-of-day> am|pmon <date>", -4.336356597840693),
                                    ("dayyear", -2.755906222279845),
                                    ("Thursdaymm/dd", -5.589119566336061),
                                    ("New Year's Dayyear (latent)", -5.183654458227897),
                                    ("Thursdayat <time-of-day>", -4.336356597840693),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.589119566336061),
                                    ("Aprilyear (latent)", -5.589119566336061),
                                    ("monthminute", -5.589119566336061),
                                    ("<time-of-day> am|pmtomorrow", -5.589119566336061),
                                    ("Thursdayhh:mm", -4.672828834461907),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.589119566336061),
                                    ("minutemonth", -3.7973600971080064),
                                    ("Sundayfrom|since|after <time-of-day>", -5.589119566336061),
                                    ("week-endin <named-month>|year", -5.589119566336061),
                                    ("Augustyear (latent)", -5.183654458227897),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.183654458227897),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.183654458227897),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.589119566336061),
                                    ("Sundayyear (latent)", -4.8959723857761155),
                                    ("Christmasat <time-of-day>", -5.589119566336061),
                                    ("<duration> after|before|from <time>December",
                                     -5.589119566336061),
                                    ("yesterday<time-of-day> am|pm", -5.589119566336061),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.672828834461907),
                                    ("mm/ddyear (latent)", -5.589119566336061),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.183654458227897),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.589119566336061),
                                    ("until <time-of-day>on <date>", -4.8959723857761155),
                                    ("at <time-of-day>intersect", -5.183654458227897),
                                    ("hh:mmyear (latent)", -4.490507277667952),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.589119566336061),
                                    ("dayminute", -3.104212916548061),
                                    ("intersectSeptember", -4.085042169559787),
                                    ("minuteday", -2.521066631202444),
                                    ("absorption of , after named dayintersect",
                                     -5.589119566336061),
                                    ("Februaryin|during the <part-of-day>", -5.589119566336061),
                                    ("hh:mmon <date>", -3.5742165457937967),
                                    ("Saturdayyear (latent)", -5.589119566336061),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.589119566336061),
                                    ("absorption of , after named daySeptember",
                                     -4.672828834461907),
                                    ("on <date>September", -5.183654458227897),
                                    ("at <time-of-day>on <date>", -5.183654458227897),
                                    ("in <named-month>|yearyear (latent)", -5.589119566336061),
                                    ("dayweek", -5.589119566336061),
                                    ("Easter Sundayyear (latent)", -5.183654458227897),
                                    ("Thursday<time-of-day> am|pm", -5.183654458227897),
                                    ("absorption of , after named dayFebruary", -4.672828834461907),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.589119566336061),
                                    ("tomorrowat <time-of-day>", -5.589119566336061),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.589119566336061),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.979681653901961),
                                    ("tomorrow<time-of-day> am|pm", -5.589119566336061),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.8959723857761155),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.589119566336061),
                                    ("Fridayyear (latent)", -5.183654458227897),
                                    ("minuteyear", -4.336356597840693)],
                               n = 173}}),
       ("one eleven",
        Classifier{okData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -5.077232537342326e-2),
                                    ("intersect 2 numbers", -3.5165082281731497)],
                               n = 97},
                   koData =
