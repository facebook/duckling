...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5961768557045796, unseen = -6.049733455231958,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 422},
                   koData =
                     ClassData{prior = -0.8005405123671929, unseen = -5.846438775057725,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4523820278959161, unseen = -7.080867896690782,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.386879319362645),
                                    ("Father's Dayyear (latent)", -6.386879319362645),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.386879319362645),
                                    ("Ramadanyear (latent)", -5.47058858748849),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.37197629882038),
                                    ("Military Spouse Dayyear (latent)", -6.386879319362645),
                                    ("Bhai Doojyear (latent)", -6.386879319362645),
                                    ("hourday", -4.37197629882038), ("dayhour", -3.469108587278366),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.37197629882038),
                                    ("Martin Luther King's Dayyear (latent)", -5.981414211254481),
                                    ("Shemini Atzeretyear (latent)", -6.386879319362645),
                                    ("daymonth", -4.37197629882038),
                                    ("monthday", -5.981414211254481),
                                    ("monthyear", -4.59511985013459),
                                    ("Yom Ha'atzmautyear (latent)", -6.386879319362645),
                                    ("Vijayadashamiyear (latent)", -6.386879319362645),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.000584958242754),
                                    ("Thanksgiving Dayyear (latent)", -5.288267030694535),
                                    ("Thai Pongalyear (latent)", -5.6937321388027),
                                    ("Thiru Onamyear (latent)", -5.6937321388027),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.386879319362645),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.47058858748849),
                                    ("<day-of-month> (ordinal)Wednesday", -6.386879319362645),
                                    ("Krishna Janmashtamiyear (latent)", -5.981414211254481),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.386879319362645),
                                    ("houryear", -5.47058858748849),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.386879319362645),
                                    ("Christmas<time-of-day> am|pm", -6.386879319362645),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.386879319362645),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.6937321388027),
                                    ("intersectin|during <named-month>|year", -6.386879319362645),
                                    ("<time-of-day> am|pmintersect", -5.134116350867277),
                                    ("Earth Houryear (latent)", -6.386879319362645),
                                    ("Octoberyear (latent)", -4.882801922586371),
                                    ("intersect<time-of-day> am|pm", -6.386879319362645),
                                    ("Mattu Pongalyear (latent)", -6.386879319362645),
                                    ("Daylight Saving Start Dayyear (latent)", -5.47058858748849),
                                    ("Shavuotyear (latent)", -6.386879319362645),
                                    ("Parsi New Yearyear (latent)", -5.47058858748849),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.386879319362645),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.386879319362645),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.981414211254481),
                                    ("Marchyear (latent)", -6.386879319362645),
                                    ("Sukkotyear (latent)", -5.981414211254481),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.981414211254481),
                                    ("Daylight Saving End Dayyear (latent)", -5.47058858748849),
                                    ("Clean Mondayyear (latent)", -5.981414211254481),
                                    ("monthhour", -5.981414211254481),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.6937321388027),
                                    ("todayat <time-of-day>", -6.386879319362645),
                                    ("Thursday<time> timezone", -4.440969170307332),
                                    ("time-of-day (latent)tonight", -5.981414211254481),
                                    ("from|since|after <time>December", -6.386879319362645),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.386879319362645),
                                    ("<time-of-day> am|pmon <day>", -4.37197629882038),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.386879319362645),
                                    ("yyyy-mm-ddhh:mm:ss", -5.981414211254481),
                                    ("Tax Daythis|last|next <cycle>", -6.386879319362645),
                                    ("dayday", -3.9445322839934405),
                                    ("<time> <part-of-day>at <time-of-day>", -6.386879319362645),
                                    ("mm/ddat <time-of-day>", -6.386879319362645),
                                    ("tonightat <time-of-day>", -6.386879319362645),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.6937321388027),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.386879319362645),
                                    ("today<time-of-day> am|pm", -6.386879319362645),
                                    ("Februarythe <day-of-month> (ordinal)", -5.981414211254481),
                                    ("at <time-of-day><time> <part-of-day>", -6.386879319362645),
                                    ("<day-of-month> (ordinal)intersect", -5.981414211254481),
                                    ("mm/dd<time-of-day> am|pm", -6.386879319362645),
                                    ("hourhour", -4.307437777682809),
                                    ("Navaratriin|during <named-month>|year", -6.386879319362645),
                                    ("Wednesdaythis|last|next <cycle>", -6.386879319362645),
                                    ("Lentyear (latent)", -6.386879319362645),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.882801922586371),
                                    ("Boghiyear (latent)", -6.386879319362645),
                                    ("dayyear", -1.791759469228055),
                                    ("Thursdayfrom|since|after <time>", -5.981414211254481),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.386879319362645),
                                    ("Thursdayat <time-of-day>", -5.6937321388027),
                                    ("Islamic New Yearyear (latent)", -5.981414211254481),
                                    ("Laylat al-Qadryear (latent)", -5.47058858748849),
                                    ("Shrove Tuesdayyear (latent)", -6.386879319362645),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.6937321388027),
                                    ("<time-of-day> am|pmtomorrow", -5.6937321388027),
                                    ("Yom Kippuryear (latent)", -6.386879319362645),
                                    ("<day-of-month> (ordinal)Tuesday", -5.981414211254481),
                                    ("<part-of-day> of <time>year (latent)", -6.386879319362645),
                                    ("minutehour", -5.288267030694535),
                                    ("Kaanum Pongalyear (latent)", -5.981414211254481),
                                    ("Maha Saptamiyear (latent)", -6.386879319362645),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.981414211254481),
                                    ("time-of-day (latent)tomorrow", -5.47058858748849),
                                    ("part of daysat <time-of-day>", -5.981414211254481),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.68213122712422),
                                    ("for <duration> from <time>December", -6.386879319362645),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.386879319362645),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.134116350867277),
                                    ("time-of-day (latent)this <part-of-day>", -6.386879319362645),
                                    ("Pentecostyear (latent)", -6.386879319362645),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.134116350867277),
                                    ("<day-of-month> (ordinal)February", -6.386879319362645),
                                    ("Eid al-Fitryear (latent)", -5.47058858748849),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.386879319362645),
                                    ("Mondayin|during the <part-of-day>", -6.386879319362645),
                                    ("Chhathin|during <named-month>|year", -6.386879319362645),
                                    ("Diwaliin|during <named-month>|year", -6.386879319362645),
                                    ("Vaisakhiin|during <named-month>|year", -6.386879319362645),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.134116350867277),
                                    ("Raksha Bandhanyear (latent)", -6.386879319362645),
                                    ("daysecond", -5.981414211254481),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.981414211254481),
                                    ("Emancipation Dayyear (latent)", -5.6937321388027),
                                    ("Ashurayear (latent)", -6.386879319362645),
                                    ("Tuesdayin|during <named-month>|year", -6.386879319362645),
                                    ("Chinese New Yearyear (latent)", -6.386879319362645),
                                    ("tomorrowintersect", -6.386879319362645),
                                    ("Lag BaOmeryear (latent)", -6.386879319362645),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.386879319362645),
                                    ("Eid al-Adhayear (latent)", -4.246813155866374),
                                    ("intersectin|during the <part-of-day>", -6.386879319362645),
                                    ("Palm Sundayyear (latent)", -6.386879319362645),
                                    ("Christmasat <time-of-day>", -6.386879319362645),
                                    ("Passoveryear (latent)", -6.386879319362645),
                                    ("Lazarus Saturdayyear (latent)", -6.386879319362645),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.386879319362645),
                                    ("Cyber Mondayyear (latent)", -5.981414211254481),
                                    ("Yom HaShoahyear (latent)", -5.981414211254481),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.981414211254481),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.386879319362645),
                                    ("Septemberyear (latent)", -5.981414211254481),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.882801922586371),
                                    ("Halloweenyear (latent)", -6.386879319362645),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.386879319362645),
                                    ("at <time-of-day>intersect", -5.981414211254481),
                                    ("Rosh Hashanahyear (latent)", -5.6937321388027),
                                    ("Dhanterasyear (latent)", -6.386879319362645),
                                    ("Tu BiShvatyear (latent)", -6.386879319362645),
                                    ("<day-of-month> (ordinal)December", -5.6937321388027),
                                    ("Holiyear (latent)", -5.6937321388027),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.386879319362645),
                                    ("Holika Dahanyear (latent)", -5.6937321388027),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.386879319362645),
                                    ("dayminute", -3.469108587278366),
                                    ("Mawlidyear (latent)", -6.386879319362645),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.981414211254481),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.386879319362645),
                                    ("Jumu'atul-Widayear (latent)", -5.47058858748849),
                                    ("minuteday", -2.55823792287355),
                                    ("absorption of , after named dayintersect",
                                     -6.386879319362645),
                                    ("intersectyear (latent)", -6.386879319362645),
                                    ("Orthodox Easter Sundayyear (latent)", -6.386879319362645),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.386879319362645),
                                    ("Boss's Dayyear (latent)", -5.981414211254481),
                                    ("Global Youth Service Dayyear (latent)", -6.386879319362645),
                                    ("Dhanterasin|during <named-month>|year", -6.386879319362645),
                                    ("Tisha B'Avyear (latent)", -6.386879319362645),
                                    ("Isra and Mi'rajyear (latent)", -5.47058858748849),
                                    ("at <time-of-day>on <day>", -5.288267030694535),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.386879319362645),
                                    ("time-of-day (latent)<time> <part-of-day>", -5.6937321388027),
                                    ("Christmasyear (latent)", -5.981414211254481),
                                    ("Naraka Chaturdashiyear (latent)", -5.981414211254481),
                                    ("Thai Pongalin|during <named-month>|year", -6.386879319362645),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.386879319362645),
                                    ("dayweek", -6.386879319362645),
                                    ("Easter Sundayyear (latent)", -5.6937321388027),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.777441406928545),
                                    ("weekyear", -5.288267030694535),
                                    ("King's Dayyear (latent)", -4.882801922586371),
                                    ("hh:mmin|during the <part-of-day>", -5.6937321388027),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.981414211254481),
                                    ("Hanukkahyear (latent)", -5.6937321388027),
                                    ("February<time> <part-of-day>", -6.386879319362645),
                                    ("National Grandparents Dayyear (latent)", -6.386879319362645),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.386879319362645),
                                    ("Great Lentyear (latent)", -6.386879319362645),
                                    ("tomorrowat <time-of-day>", -5.6937321388027),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.386879319362645),
                                    ("Labor Dayyear (latent)", -6.386879319362645),
                                    ("Vaisakhiyear (latent)", -5.6937321388027),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.386879319362645),
                                    ("last <cycle> of <time>year (latent)", -5.6937321388027),
                                    ("at <time-of-day>tomorrow", -5.981414211254481),
                                    ("tomorrow<time-of-day> am|pm", -6.386879319362645),
                                    ("President's Dayyear (latent)", -6.386879319362645),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.386879319362645),
                                    ("Diwaliyear (latent)", -6.386879319362645),
                                    ("between <time> and <time>on <day>", -4.777441406928545),
                                    ("Black Fridayyear (latent)", -5.981414211254481),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.386879319362645),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.386879319362645),
                                    ("Chhathyear (latent)", -5.981414211254481),
                                    ("Vasant Panchamiyear (latent)", -6.386879319362645),
                                    ("Tax Dayyear (latent)", -5.47058858748849),
                                    ("Rabindra Jayantiyear (latent)", -5.134116350867277),
                                    ("St Patrick's Dayyear (latent)", -6.386879319362645),
                                    ("Thursday<time> (timezone)", -6.386879319362645),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.386879319362645),
                                    ("<datetime> - <datetime> (interval)July", -5.981414211254481),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.981414211254481),
                                    ("Februaryintersect", -6.386879319362645),
                                    ("Mother's Dayyear (latent)", -6.386879319362645),
                                    ("Simchat Torahyear (latent)", -6.386879319362645),
                                    ("minuteyear", -6.386879319362645)],
                               n = 458},
                   koData =
                     ClassData{prior = -1.0109067082490042, unseen = -6.680854678790215,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.2784018041822276),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.986452005284438),
                                    ("<day-of-month> (ordinal)August", -5.986452005284438),
                                    ("dayhour", -3.312303355857909),
                                    ("<time> timezoneyear (latent)", -5.986452005284438),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.0701612734102826),
                                    ("Tuesdayfrom|since|after <time>", -5.986452005284438),
                                    ("daymonth", -3.5015453554964373),
                                    ("monthyear", -4.73368903678907),
                                    ("<time-of-day> am|pmyear (latent)", -5.293304824724492),
                                    ("Thai Pongalyear (latent)", -5.293304824724492),
                                    ("intersecthh:mm", -5.986452005284438),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.580986897176273),
                                    ("<day-of-month> (ordinal)Wednesday", -5.986452005284438),
                                    ("houryear", -4.600157644164547),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.986452005284438),
                                    ("<day-of-month> (ordinal)October", -5.986452005284438),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.293304824724492),
                                    ("<time-of-day> am|pmintersect", -4.73368903678907),
                                    ("Octoberyear (latent)", -5.986452005284438),
                                    ("until <time>on <day>", -5.293304824724492),
                                    ("time-of-day (latent)intersect", -5.986452005284438),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.293304824724492),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.986452005284438),
                                    ("hh:mmon <day>", -3.5441049699152334),
                                    ("absorption of , after named dayJuly", -5.580986897176273),
                                    ("from|since|after <time>July", -5.580986897176273),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.0701612734102826),
                                    ("Clean Mondayyear (latent)", -5.986452005284438),
                                    ("monthhour", -5.986452005284438),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.580986897176273),
                                    ("hourmonth", -4.114649828382846),
                                    ("todayat <time-of-day>", -5.986452005284438),
                                    ("from|since|after <time>December", -5.986452005284438),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.986452005284438),
                                    ("<time-of-day> am|pmon <day>", -4.73368903678907),
                                    ("Mondayyear (latent)", -4.887839716616328),
                                    ("dayday", -4.600157644164547),
                                    ("mm/ddat <time-of-day>", -5.580986897176273),
                                    ("on <day>September", -5.580986897176273),
                                    ("time-of-day (latent)September", -5.580986897176273),
                                    ("hourhour", -5.986452005284438),
                                    ("time-of-day (latent)on <day>", -3.5441049699152334),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.580986897176273),
                                    ("dayyear", -2.990719731730447),
                                    ("Thursdaymm/dd", -5.986452005284438),
                                    ("New Year's Dayyear (latent)", -5.0701612734102826),
                                    ("Thursdayfrom|since|after <time>", -4.281703913046012),
                                    ("Thursdayat <time-of-day>", -4.377014092850337),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.986452005284438),
                                    ("Aprilyear (latent)", -5.986452005284438),
                                    ("the <day-of-month> (ordinal)July", -5.986452005284438),
                                    ("the <day-of-month> (number)July", -5.986452005284438),
                                    ("monthminute", -5.986452005284438),
                                    ("<time-of-day> am|pmtomorrow", -5.986452005284438),
                                    ("Thursdayhh:mm", -5.0701612734102826),
                                    ("<day-of-month> (ordinal)Tuesday", -5.580986897176273),
                                    ("minutemonth", -4.114649828382846),
                                    ("minutehour", -5.986452005284438),
                                    ("Augustyear (latent)", -5.580986897176273),
                                    ("week-endin|during <named-month>|year", -5.986452005284438),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.580986897176273),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.986452005284438),
                                    ("Sundayyear (latent)", -5.0701612734102826),
                                    ("Christmasat <time-of-day>", -5.986452005284438),
                                    ("from|since|after <time>year (latent)", -4.887839716616328),
                                    ("<duration> after|before|from <time>December",
                                     -5.986452005284438),
                                    ("yesterday<time-of-day> am|pm", -5.986452005284438),
                                    ("<day-of-month> (ordinal)July", -5.293304824724492),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.986452005284438),
                                    ("mm/ddyear (latent)", -5.986452005284438),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.986452005284438),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.986452005284438),
                                    ("at <time-of-day>intersect", -5.580986897176273),
                                    ("hh:mmyear (latent)", -3.907010463604602),
                                    ("Holiyear (latent)", -5.986452005284438),
                                    ("until <time><time-of-day> am|pm", -5.986452005284438),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.986452005284438),
                                    ("dayminute", -3.421502647822901),
                                    ("yyyy-mm-ddhh:mm", -5.580986897176273),
                                    ("intersectSeptember", -4.482374608508164),
                                    ("minuteday", -2.7477735531200573),
                                    ("absorption of , after named dayintersect",
                                     -5.986452005284438),
                                    ("intersectyear (latent)", -5.986452005284438),
                                    ("Februaryin|during the <part-of-day>", -5.986452005284438),
                                    ("time-of-day (latent)July", -5.293304824724492),
                                    ("Saturdayyear (latent)", -5.986452005284438),
                                    ("at <time-of-day>on <day>", -5.580986897176273),
                                    ("absorption of , after named daySeptember",
                                     -5.0701612734102826),
                                    ("Naraka Chaturdashiyear (latent)", -5.986452005284438),
                                    ("from|since|after <time>on <day>", -5.0701612734102826),
                                    ("dayweek", -5.986452005284438),
                                    ("Easter Sundayyear (latent)", -5.580986897176273),
                                    ("Thursday<time-of-day> am|pm", -4.73368903678907),
                                    ("weekyear", -5.580986897176273),
                                    ("time-of-day (latent)Thursday", -5.580986897176273),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.986452005284438),
                                    ("<day-of-month> (ordinal)April", -5.986452005284438),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.580986897176273),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.293304824724492),
                                    ("Sundayfrom|since|after <time>", -5.986452005284438),
                                    ...
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.986452005284438),
                                    ("tomorrowat <time-of-day>", -5.986452005284438),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.580986897176273),
                                    ("last <cycle> of <time>year (latent)", -5.580986897176273),
                                    ("tomorrow<time-of-day> am|pm", -5.986452005284438),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.293304824724492),
                                    ("Diwaliyear (latent)", -5.580986897176273),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.986452005284438),
                                    ("Fridayyear (latent)", -5.580986897176273),
                                    ("time-of-day (latent)April", -5.986452005284438),
                                    ("minuteyear", -3.789227427948218)],
                               n = 262}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1457878134614987, unseen = -5.429345628954441,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 223},
                   koData =
                     ClassData{prior = -1.9976115234322038,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
