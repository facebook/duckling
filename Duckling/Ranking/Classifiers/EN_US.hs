...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5524328810290232,
                               unseen = -6.2166061010848646,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 499},
                   koData =
                     ClassData{prior = -0.8569560386116108, unseen = -5.91350300563827,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.44651221800099816,
                               unseen = -7.231287004327616,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.537415972849347),
                                    ("Father's Dayyear (latent)", -6.537415972849347),
                                    ("Karva Chauthyear (latent)", -6.537415972849347),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.537415972849347),
                                    ("Maha Shivaratriyear (latent)", -6.537415972849347),
                                    ("Ramadanyear (latent)", -5.284653004353979),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.151121611729456),
                                    ("Military Spouse Dayyear (latent)", -6.537415972849347),
                                    ("Bhai Doojyear (latent)", -6.537415972849347),
                                    ("hourday", -4.522512952307082),
                                    ("dayhour", -3.5169910867049845),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.151121611729456),
                                    ("Martin Luther King's Dayyear (latent)", -6.1319508647411824),
                                    ("Shemini Atzeretyear (latent)", -6.537415972849347),
                                    ("daymonth", -4.522512952307082),
                                    ("monthday", -6.1319508647411824),
                                    ("monthyear", -4.745656503621292),
                                    ("Yom Ha'atzmautyear (latent)", -6.537415972849347),
                                    ("Vijayadashamiyear (latent)", -6.537415972849347),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.151121611729456),
                                    ("Thanksgiving Dayyear (latent)", -5.438803684181237),
                                    ("Thai Pongalyear (latent)", -5.844268792289402),
                                    ("Thiru Onamyear (latent)", -5.844268792289402),
                                    ("hhhmmabsorption of , after named day", -6.537415972849347),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.537415972849347),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.621125240975192),
                                    ("<day-of-month> (ordinal)Wednesday", -6.537415972849347),
                                    ("Krishna Janmashtamiyear (latent)", -6.1319508647411824),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.537415972849347),
                                    ("houryear", -5.621125240975192),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.537415972849347),
                                    ("Christmas<time-of-day> am|pm", -6.537415972849347),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.537415972849347),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.844268792289402),
                                    ("intersectin|during <named-month>|year", -6.537415972849347),
                                    ("<time-of-day> am|pmintersect", -5.284653004353979),
                                    ("Earth Houryear (latent)", -6.537415972849347),
                                    ("Ganesh Chaturthiyear (latent)", -6.537415972849347),
                                    ("Octoberyear (latent)", -5.0333385760730724),
                                    ("intersect<time-of-day> am|pm", -6.537415972849347),
                                    ("Mattu Pongalyear (latent)", -6.537415972849347),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.537415972849347),
                                    ("Daylight Saving Start Dayyear (latent)", -5.621125240975192),
                                    ("Shavuotyear (latent)", -6.537415972849347),
                                    ("Parsi New Yearyear (latent)", -5.621125240975192),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.537415972849347),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.537415972849347),
                                    ("todayin|within|after <duration>", -6.537415972849347),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.1319508647411824),
                                    ("Marchyear (latent)", -6.537415972849347),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.1319508647411824),
                                    ("Sukkotyear (latent)", -6.1319508647411824),
                                    ("hhhmmintersect", -6.1319508647411824),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.1319508647411824),
                                    ("Daylight Saving End Dayyear (latent)", -5.621125240975192),
                                    ("Clean Mondayyear (latent)", -6.1319508647411824),
                                    ("monthhour", -6.1319508647411824),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.844268792289402),
                                    ("todayat <time-of-day>", -6.537415972849347),
                                    ("Thursday<time> timezone", -4.139520700050976),
                                    ("tonight<time-of-day> am|pm", -6.537415972849347),
                                    ("time-of-day (latent)tonight", -6.1319508647411824),
                                    ("from|since|after <time>December", -6.537415972849347),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.537415972849347),
                                    ("<time-of-day> am|pmon <day>", -4.522512952307082),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.537415972849347),
                                    ("yyyy-mm-ddhh:mm:ss", -6.1319508647411824),
                                    ("Tax Daythis|last|next <cycle>", -6.537415972849347),
                                    ("dayday", -3.8293657717471365),
                                    ("<time> <part-of-day>at <time-of-day>", -6.1319508647411824),
                                    ("mm/ddat <time-of-day>", -6.537415972849347),
                                    ("tonightat <time-of-day>", -5.438803684181237),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.844268792289402),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.537415972849347),
                                    ("today<time-of-day> am|pm", -6.537415972849347),
                                    ("Februarythe <day-of-month> (ordinal)", -6.1319508647411824),
                                    ("at <time-of-day><time> <part-of-day>", -6.537415972849347),
                                    ("<day-of-month> (ordinal)intersect", -6.1319508647411824),
                                    ("mm/dd<time-of-day> am|pm", -6.537415972849347),
                                    ("hourhour", -3.5670015072796457),
                                    ("Mahavir Jayantiyear (latent)", -6.1319508647411824),
                                    ("Navaratriin|during <named-month>|year", -6.537415972849347),
                                    ("Wednesdaythis|last|next <cycle>", -6.537415972849347),
                                    ("Lentyear (latent)", -6.537415972849347),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.665613795947755),
                                    ("Boghiyear (latent)", -6.537415972849347),
                                    ("dayyear", -1.8189171015542522),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.537415972849347),
                                    ("Thursdayfrom|since|after <time>", -6.1319508647411824),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.537415972849347),
                                    ("Thursdayat <time-of-day>", -5.844268792289402),
                                    ("Islamic New Yearyear (latent)", -6.1319508647411824),
                                    ("Laylat al-Qadryear (latent)", -5.621125240975192),
                                    ("part of days<time-of-day> am|pm", -6.537415972849347),
                                    ("Shrove Tuesdayyear (latent)", -6.537415972849347),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.844268792289402),
                                    ("hourminute", -6.1319508647411824),
                                    ("<time-of-day> am|pmtomorrow", -5.844268792289402),
                                    ("Yom Kippuryear (latent)", -6.537415972849347),
                                    ("<day-of-month> (ordinal)Tuesday", -6.1319508647411824),
                                    ("<part-of-day> of <time>year (latent)", -6.537415972849347),
                                    ("minutehour", -5.284653004353979),
                                    ("Kaanum Pongalyear (latent)", -6.1319508647411824),
                                    ("Maha Saptamiyear (latent)", -6.537415972849347),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.844268792289402),
                                    ("time-of-day (latent)tomorrow", -5.621125240975192),
                                    ("part of daysat <time-of-day>", -4.9279780604152466),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.522512952307082),
                                    ("for <duration> from <time>December", -6.537415972849347),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.537415972849347),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.284653004353979),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.284653004353979),
                                    ("time-of-day (latent)this <part-of-day>", -6.537415972849347),
                                    ("Pentecostyear (latent)", -6.537415972849347),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.284653004353979),
                                    ("<day-of-month> (ordinal)February", -6.537415972849347),
                                    ("Eid al-Fitryear (latent)", -5.151121611729456),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.537415972849347),
                                    ("Mondayin|during the <part-of-day>", -6.537415972849347),
                                    ("Chhathin|during <named-month>|year", -6.537415972849347),
                                    ("Diwaliin|during <named-month>|year", -6.537415972849347),
                                    ("this <part-of-day><time-of-day> am|pm", -6.537415972849347),
                                    ("Vaisakhiin|during <named-month>|year", -6.537415972849347),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.284653004353979),
                                    ("Raksha Bandhanyear (latent)", -6.537415972849347),
                                    ("daysecond", -6.1319508647411824),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.1319508647411824),
                                    ("Emancipation Dayyear (latent)", -5.844268792289402),
                                    ("Ratha-Yatrayear (latent)", -6.537415972849347),
                                    ("Ashurayear (latent)", -6.537415972849347),
                                    ("Tuesdayin|during <named-month>|year", -6.537415972849347),
                                    ("Chinese New Yearyear (latent)", -6.537415972849347),
                                    ("tomorrowintersect", -6.537415972849347),
                                    ("Lag BaOmeryear (latent)", -6.537415972849347),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.537415972849347),
                                    ("Eid al-Adhayear (latent)", -4.397349809353076),
                                    ("intersectin|during the <part-of-day>", -6.537415972849347),
                                    ("Palm Sundayyear (latent)", -6.537415972849347),
                                    ("Christmasat <time-of-day>", -6.537415972849347),
                                    ("Passoveryear (latent)", -6.537415972849347),
                                    ("Lazarus Saturdayyear (latent)", -6.537415972849347),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.537415972849347),
                                    ("Cyber Mondayyear (latent)", -6.1319508647411824),
                                    ("hhhmmon <day>", -5.621125240975192),
                                    ("Yom HaShoahyear (latent)", -6.1319508647411824),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.1319508647411824),
                                    ("Septemberyear (latent)", -6.1319508647411824),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.0333385760730724),
                                    ("Halloweenyear (latent)", -6.537415972849347),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.537415972849347),
                                    ("at <time-of-day>intersect", -5.621125240975192),
                                    ("Rosh Hashanahyear (latent)", -5.844268792289402),
                                    ("Dhanterasyear (latent)", -6.537415972849347),
                                    ("Tu BiShvatyear (latent)", -6.537415972849347),
                                    ("<day-of-month> (ordinal)December", -5.844268792289402),
                                    ("Holiyear (latent)", -5.844268792289402),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.537415972849347),
                                    ("Holika Dahanyear (latent)", -5.844268792289402),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.1319508647411824),
                                    ("dayminute", -3.1875118855747417),
                                    ("Mawlidyear (latent)", -6.537415972849347),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.1319508647411824),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.537415972849347),
                                    ("Jumu'atul-Widayear (latent)", -5.621125240975192),
                                    ("minuteday", -2.7997463545659786),
                                    ("absorption of , after named dayintersect",
                                     -5.844268792289402),
                                    ("intersectyear (latent)", -6.537415972849347),
                                    ("Orthodox Easter Sundayyear (latent)", -6.537415972849347),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.537415972849347),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.537415972849347),
                                    ("intersecthhhmm", -6.1319508647411824),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.537415972849347),
                                    ("Boss's Dayyear (latent)", -6.1319508647411824),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.537415972849347),
                                    ("Global Youth Service Dayyear (latent)", -6.537415972849347),
                                    ("Dhanterasin|during <named-month>|year", -6.537415972849347),
                                    ("tonight<time-of-day> o'clock", -6.537415972849347),
                                    ("Tisha B'Avyear (latent)", -6.537415972849347),
                                    ("Isra and Mi'rajyear (latent)", -5.621125240975192),
                                    ("at <time-of-day>on <day>", -4.9279780604152466),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.1319508647411824),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.844268792289402),
                                    ("Christmasyear (latent)", -6.1319508647411824),
                                    ("Saturdayintersect", -6.537415972849347),
                                    ("Naraka Chaturdashiyear (latent)", -6.1319508647411824),
                                    ("Thai Pongalin|during <named-month>|year", -6.537415972849347),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.537415972849347),
                                    ("dayweek", -6.537415972849347),
                                    ("Easter Sundayyear (latent)", -5.844268792289402),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.1319508647411824),
                                    ("weekyear", -5.438803684181237),
                                    ("King's Dayyear (latent)", -5.0333385760730724),
                                    ("hh:mmin|during the <part-of-day>", -5.621125240975192),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.1319508647411824),
                                    ("Hanukkahyear (latent)", -5.844268792289402),
                                    ("Rama Navamiyear (latent)", -6.537415972849347),
                                    ("February<time> <part-of-day>", -6.537415972849347),
                                    ("National Grandparents Dayyear (latent)", -6.537415972849347),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.844268792289402),
                                    ("Great Lentyear (latent)", -6.537415972849347),
                                    ("tomorrowat <time-of-day>", -5.844268792289402),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.537415972849347),
                                    ("Labor Dayyear (latent)", -6.537415972849347),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.1319508647411824),
                                    ("Ugadiyear (latent)", -5.151121611729456),
                                    ("Vaisakhiyear (latent)", -5.844268792289402),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.844268792289402),
                                    ("last <cycle> of <time>year (latent)", -5.844268792289402),
                                    ("at <time-of-day>tomorrow", -6.1319508647411824),
                                    ("tomorrow<time-of-day> am|pm", -6.537415972849347),
                                    ("President's Dayyear (latent)", -6.537415972849347),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.537415972849347),
                                    ("Diwaliyear (latent)", -6.537415972849347),
                                    ("between <time> and <time>on <day>", -6.1319508647411824),
                                    ("Black Fridayyear (latent)", -6.1319508647411824),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.537415972849347),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.537415972849347),
                                    ("Chhathyear (latent)", -6.1319508647411824),
                                    ("Vasant Panchamiyear (latent)", -6.537415972849347),
                                    ("Tax Dayyear (latent)", -5.621125240975192),
                                    ("Rabindra Jayantiyear (latent)", -5.284653004353979),
                                    ("this <part-of-day>at <time-of-day>", -5.284653004353979),
                                    ("St Patrick's Dayyear (latent)", -6.537415972849347),
                                    ("Thursday<time> (timezone)", -6.537415972849347),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.537415972849347),
                                    ("Pargat Diwasyear (latent)", -5.284653004353979),
                                    ("<datetime> - <datetime> (interval)July", -6.1319508647411824),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.844268792289402),
                                    ("Februaryintersect", -6.537415972849347),
                                    ("Mother's Dayyear (latent)", -6.537415972849347),
                                    ("Simchat Torahyear (latent)", -6.537415972849347),
                                    ("minuteyear", -6.537415972849347)],
                               n = 533},
                   koData =
                     ClassData{prior = -1.0212511675106415, unseen = -6.820016364674131,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.621699487939302),
                                    ("hourday", -3.7278816119172054),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.125776884715576),
                                    ("<day-of-month> (ordinal)August", -6.125776884715576),
                                    ("dayhour", -3.4516282352890473),
                                    ("<time> timezoneyear (latent)", -5.432629704155631),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.209486152841421),
                                    ("Tuesdayfrom|since|after <time>", -5.432629704155631),
                                    ("daymonth", -3.4516282352890473),
                                    ("monthyear", -4.873013916220208),
                                    ("<time-of-day> am|pmyear (latent)", -5.432629704155631),
                                    ("Thai Pongalyear (latent)", -5.432629704155631),
                                    ("intersecthh:mm", -6.125776884715576),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.720311776607412),
                                    ("<day-of-month> (ordinal)Wednesday", -6.125776884715576),
                                    ("houryear", -4.739482523595686),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.125776884715576),
                                    ("<day-of-month> (ordinal)October", -6.125776884715576),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.432629704155631),
                                    ("hournograin", -4.873013916220208),
                                    ("<time-of-day> am|pmintersect", -4.873013916220208),
                                    ("Octoberyear (latent)", -6.125776884715576),
                                    ("Good Fridayyear (latent)", -6.125776884715576),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.720311776607412),
                                    ("early morningat <time-of-day>", -6.125776884715576),
                                    ("until <time>on <day>", -5.432629704155631),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.125776884715576),
                                    ("time-of-day (latent)intersect", -5.432629704155631),
                                    ("todayin <number> (implicit minutes)", -6.125776884715576),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.432629704155631),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.125776884715576),
                                    ("hh:mmon <day>", -4.873013916220208),
                                    ("hhhmmintersect", -5.720311776607412),
                                    ("absorption of , after named dayJuly", -5.209486152841421),
                                    ("from|since|after <time>July", -5.720311776607412),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.209486152841421),
                                    ("Clean Mondayyear (latent)", -6.125776884715576),
                                    ("monthhour", -6.125776884715576),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.720311776607412),
                                    ("hourmonth", -4.253974707813985),
                                    ("todayat <time-of-day>", -6.125776884715576),
                                    ("hhhmmyear (latent)", -4.873013916220208),
                                    ("from|since|after <time>December", -6.125776884715576),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.125776884715576),
                                    ("<time-of-day> am|pmon <day>", -4.873013916220208),
                                    ("Mondayyear (latent)", -5.0271645960474665),
                                    ("dayday", -4.110873864173311),
                                    ("mm/ddat <time-of-day>", -5.720311776607412),
                                    ("on <day>September", -5.432629704155631),
                                    ("time-of-day (latent)September", -5.720311776607412),
                                    ("hourhour", -4.04633534303574),
                                    ("time-of-day (latent)on <day>", -4.621699487939302),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.720311776607412),
                                    ("dayyear", -3.057723949581959),
                                    ("Thursdaymm/dd", -6.125776884715576),
                                    ("New Year's Dayyear (latent)", -5.209486152841421),
                                    ("time-of-day (latent)Sunday", -5.720311776607412),
                                    ("Thursdayfrom|since|after <time>", -4.42102879247715),
                                    ("Thursdayat <time-of-day>", -4.516338972281476),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.125776884715576),
                                    ("Aprilyear (latent)", -6.125776884715576),
                                    ("the <day-of-month> (ordinal)July", -6.125776884715576),
                                    ("the <day-of-month> (number)July", -6.125776884715576),
                                    ("monthminute", -6.125776884715576),
                                    ("<time-of-day> am|pmtomorrow", -6.125776884715576),
                                    ("Thursdayhh:mm", -5.209486152841421),
                                    ("<day-of-month> (ordinal)Tuesday", -5.720311776607412),
                                    ("minutemonth", -3.9857107212193053),
                                    ("time-of-day (latent)Friday", -5.720311776607412),
                                    ("minutehour", -6.125776884715576),
                                    ("part of daysat <time-of-day>", -5.0271645960474665),
                                    ("Augustyear (latent)", -5.720311776607412),
                                    ("Orthodox Great Fridayyear (latent)", -6.125776884715576),
                                    ("week-endin|during <named-month>|year", -6.125776884715576),
                                    ("time-of-day (latent)Tuesday", -5.720311776607412),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.125776884715576),
                                    ("Sundayyear (latent)", -5.209486152841421),
                                    ("the <day-of-month> (ordinal)Monday", -5.432629704155631),
                                    ("Christmasat <time-of-day>", -6.125776884715576),
                                    ("from|since|after <time>year (latent)", -5.0271645960474665),
                                    ("hhhmmon <day>", -5.209486152841421),
                                    ("yesterday<time-of-day> am|pm", -6.125776884715576),
                                    ("<day-of-month> (ordinal)July", -5.432629704155631),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.125776884715576),
                                    ("mm/ddyear (latent)", -6.125776884715576),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.125776884715576),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.125776884715576),
                                    ("at <time-of-day>intersect", -5.209486152841421),
                                    ("hh:mmyear (latent)", -4.739482523595686),
                                    ("Holiyear (latent)", -6.125776884715576),
                                    ("until <time><time-of-day> am|pm", -6.125776884715576),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.720311776607412),
                                    ("dayminute", -3.2635760037861075),
                                    ("yyyy-mm-ddhh:mm", -5.720311776607412),
                                    ("intersectfrom|since|after <time>", -5.720311776607412),
                                    ("intersectSeptember", -4.253974707813985),
                                    ("minuteday", -2.968776463565463),
                                    ("absorption of , after named dayintersect",
                                     -6.125776884715576),
                                    ("intersectyear (latent)", -6.125776884715576),
                                    ("Februaryin|during the <part-of-day>", -6.125776884715576),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.125776884715576),
                                    ("time-of-day (latent)July", -5.432629704155631),
                                    ("Saturdayyear (latent)", -6.125776884715576),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.125776884715576),
                                    ("<day-of-month> (ordinal)Monday", -5.209486152841421),
                                    ("at <time-of-day>on <day>", -5.209486152841421),
                                    ("absorption of , after named daySeptember",
                                     -4.873013916220208),
                                    ("Naraka Chaturdashiyear (latent)", -6.125776884715576),
                                    ("from|since|after <time>on <day>", -5.209486152841421),
                                    ("dayweek", -6.125776884715576),
                                    ("Easter Sundayyear (latent)", -5.720311776607412),
                                    ("Thursday<time-of-day> am|pm", -4.873013916220208),
                                    ("weekyear", -5.720311776607412),
                                    ("time-of-day (latent)Thursday", -5.720311776607412),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.125776884715576),
                                    ("<day-of-month> (ordinal)April", -6.125776884715576),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.720311776607412),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.432629704155631),
                                    ("Sundayfrom|since|after <time>", -6.125776884715576),
                                    ("absorption of , after named dayFebruary", -5.209486152841421),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.720311776607412),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.125776884715576),
                                    ("tomorrowat <time-of-day>", -6.125776884715576),
                                    ("daynograin", -5.720311776607412),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.720311776607412),
                                    ("last <cycle> of <time>year (latent)", -5.720311776607412),
                                    ("tomorrow<time-of-day> am|pm", -6.125776884715576),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.432629704155631),
                                    ("Diwaliyear (latent)", -5.720311776607412),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.125776884715576),
                                    ("this <part-of-day>at <time-of-day>", -5.209486152841421),
                                    ("Fridayyear (latent)", -5.432629704155631),
                                    ("time-of-day (latent)April", -6.125776884715576),
                                    ("minuteyear", -3.9285523073793565)],
                               n = 300}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.13402927662783717,
                               ...
                               n = 251},
                   koData =
                     ClassData{prior = -2.075963277303511, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
