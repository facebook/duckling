...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("in|within|after <duration>",
        Classifier{okData =
                     ClassData{prior = -0.15718558352241238,
                               ...
                               n = 47},
                   koData =
                     ClassData{prior = -1.927891643552635, unseen = -3.5553480614894135,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48339617988759825,
                               unseen = -7.265429723253953,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.571582997369922),
                                    ("Father's Dayyear (latent)", -6.571582997369922),
                                    ("Karva Chauthyear (latent)", -6.571582997369922),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.571582997369922),
                                    ("Maha Shivaratriyear (latent)", -6.571582997369922),
                                    ("Ramadanyear (latent)", -5.318820028874554),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.185288636250031),
                                    ("Military Spouse Dayyear (latent)", -6.571582997369922),
                                    ("Bhai Doojyear (latent)", -6.571582997369922),
                                    ("hourday", -4.556679976827658),
                                    ("dayhour", -3.5511581112255595),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.185288636250031),
                                    ("Martin Luther King's Dayyear (latent)", -6.166117889261757),
                                    ("Shemini Atzeretyear (latent)", -6.571582997369922),
                                    ("daymonth", -4.556679976827658),
                                    ("monthday", -6.166117889261757),
                                    ("monthyear", -4.7798235281418675),
                                    ("Yom Ha'atzmautyear (latent)", -6.571582997369922),
                                    ("Orthodox Good Fridayyear (latent)", -6.166117889261757),
                                    ("Vijayadashamiyear (latent)", -6.571582997369922),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.185288636250031),
                                    ("Thanksgiving Dayyear (latent)", -5.472970708701813),
                                    ("Thai Pongalyear (latent)", -5.878435816809977),
                                    ("Thiru Onamyear (latent)", -5.878435816809977),
                                    ("hhhmmabsorption of , after named day", -6.571582997369922),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.571582997369922),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.655292265495767),
                                    ("<day-of-month> (ordinal)Wednesday", -6.571582997369922),
                                    ("Krishna Janmashtamiyear (latent)", -6.166117889261757),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.571582997369922),
                                    ("houryear", -5.655292265495767),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.571582997369922),
                                    ("Christmas<time-of-day> am|pm", -6.571582997369922),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.571582997369922),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.878435816809977),
                                    ("intersectin|during <named-month>|year", -6.571582997369922),
                                    ("<time-of-day> am|pmintersect", -5.318820028874554),
                                    ("Earth Houryear (latent)", -6.571582997369922),
                                    ("Ganesh Chaturthiyear (latent)", -6.571582997369922),
                                    ("Octoberyear (latent)", -5.067505600593648),
                                    ("intersect<time-of-day> am|pm", -6.571582997369922),
                                    ("Mattu Pongalyear (latent)", -6.571582997369922),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.571582997369922),
                                    ("Daylight Saving Start Dayyear (latent)", -5.655292265495767),
                                    ("Shavuotyear (latent)", -6.571582997369922),
                                    ("Parsi New Yearyear (latent)", -5.655292265495767),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.571582997369922),
                                    ("the <day-of-month> (ordinal)intersect by \",\", \"of\", \"from\" for year",
                                     -6.571582997369922),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.571582997369922),
                                    ("todayin|within|after <duration>", -6.571582997369922),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.166117889261757),
                                    ("Marchyear (latent)", -6.571582997369922),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.166117889261757),
                                    ("Sukkotyear (latent)", -6.166117889261757),
                                    ("hhhmmintersect", -6.166117889261757),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.166117889261757),
                                    ("Daylight Saving End Dayyear (latent)", -5.655292265495767),
                                    ("Clean Mondayyear (latent)", -6.166117889261757),
                                    ("the <day-of-month> (ordinal)Sunday", -6.571582997369922),
                                    ("monthhour", -6.166117889261757),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.878435816809977),
                                    ("todayat <time-of-day>", -6.571582997369922),
                                    ("Thursday<time> timezone", -4.173687724571551),
                                    ("tonight<time-of-day> am|pm", -6.571582997369922),
                                    ("time-of-day (latent)tonight", -6.166117889261757),
                                    ("from|since|after <time>December", -6.571582997369922),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.571582997369922),
                                    ("<time-of-day> am|pmon <day>", -4.556679976827658),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.571582997369922),
                                    ("yyyy-mm-ddhh:mm:ss", -6.166117889261757),
                                    ("Tax Daythis|last|next <cycle>", -6.571582997369922),
                                    ("dayday", -3.798994275130141),
                                    ("<time> <part-of-day>at <time-of-day>", -6.166117889261757),
                                    ("mm/ddat <time-of-day>", -6.571582997369922),
                                    ("tonightat <time-of-day>", -5.472970708701813),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.878435816809977),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.571582997369922),
                                    ("today<time-of-day> am|pm", -6.571582997369922),
                                    ("Februarythe <day-of-month> (ordinal)", -6.166117889261757),
                                    ("at <time-of-day><time> <part-of-day>", -6.571582997369922),
                                    ("<day-of-month> (ordinal)intersect", -6.166117889261757),
                                    ("mm/dd<time-of-day> am|pm", -6.571582997369922),
                                    ("hourhour", -3.601168531800221),
                                    ("Mahavir Jayantiyear (latent)", -6.166117889261757),
                                    ("Navaratriin|during <named-month>|year", -6.571582997369922),
                                    ("Wednesdaythis|last|next <cycle>", -6.571582997369922),
                                    ("Lentyear (latent)", -6.571582997369922),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.69978082046833),
                                    ("Boghiyear (latent)", -6.571582997369922),
                                    ("dayyear", -1.8051446637857085),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.571582997369922),
                                    ("Thursdayfrom|since|after <time>", -6.166117889261757),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.571582997369922),
                                    ("Thursdayat <time-of-day>", -5.878435816809977),
                                    ("Islamic New Yearyear (latent)", -6.166117889261757),
                                    ("Laylat al-Qadryear (latent)", -5.655292265495767),
                                    ("part of days<time-of-day> am|pm", -6.571582997369922),
                                    ("Shrove Tuesdayyear (latent)", -6.571582997369922),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.878435816809977),
                                    ("hourminute", -6.166117889261757),
                                    ("<time-of-day> am|pmtomorrow", -5.655292265495767),
                                    ("Yom Kippuryear (latent)", -6.571582997369922),
                                    ("<day-of-month> (ordinal)Tuesday", -6.166117889261757),
                                    ("<part-of-day> of <time>year (latent)", -6.571582997369922),
                                    ("minutehour", -5.318820028874554),
                                    ("Kaanum Pongalyear (latent)", -6.166117889261757),
                                    ("Maha Saptamiyear (latent)", -6.571582997369922),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.878435816809977),
                                    ("time-of-day (latent)tomorrow", -5.655292265495767),
                                    ("part of daysat <time-of-day>", -4.9621450849358215),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.556679976827658),
                                    ("for <duration> from <time>December", -6.571582997369922),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.571582997369922),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.318820028874554),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.318820028874554),
                                    ("time-of-day (latent)this <part-of-day>", -6.571582997369922),
                                    ("Pentecostyear (latent)", -6.571582997369922),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.318820028874554),
                                    ("<day-of-month> (ordinal)February", -6.571582997369922),
                                    ("Eid al-Fitryear (latent)", -5.185288636250031),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.571582997369922),
                                    ("Mini-Tuesday<duration> hence|ago", -6.571582997369922),
                                    ("Mondayin|during the <part-of-day>", -6.571582997369922),
                                    ("Chhathin|during <named-month>|year", -6.571582997369922),
                                    ("Diwaliin|during <named-month>|year", -6.571582997369922),
                                    ("this <part-of-day><time-of-day> am|pm", -6.571582997369922),
                                    ("Vaisakhiin|during <named-month>|year", -6.571582997369922),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.318820028874554),
                                    ("Raksha Bandhanyear (latent)", -6.571582997369922),
                                    ("daysecond", -6.166117889261757),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.166117889261757),
                                    ("Emancipation Dayyear (latent)", -5.878435816809977),
                                    ("Ratha-Yatrayear (latent)", -6.571582997369922),
                                    ("Ashurayear (latent)", -6.571582997369922),
                                    ("Tuesdayin|during <named-month>|year", -6.571582997369922),
                                    ("Chinese New Yearyear (latent)", -6.571582997369922),
                                    ("tomorrowintersect", -6.571582997369922),
                                    ("Lag BaOmeryear (latent)", -6.571582997369922),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.571582997369922),
                                    ("Eid al-Adhayear (latent)", -4.431516833873651),
                                    ("intersectin|during the <part-of-day>", -6.571582997369922),
                                    ("Palm Sundayyear (latent)", -6.571582997369922),
                                    ("Christmasat <time-of-day>", -6.571582997369922),
                                    ("Passoveryear (latent)", -6.571582997369922),
                                    ("Lazarus Saturdayyear (latent)", -6.571582997369922),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.571582997369922),
                                    ("Cyber Mondayyear (latent)", -6.166117889261757),
                                    ("hhhmmon <day>", -5.655292265495767),
                                    ("Yom HaShoahyear (latent)", -6.166117889261757),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.166117889261757),
                                    ("Septemberyear (latent)", -6.166117889261757),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.067505600593648),
                                    ("Halloweenyear (latent)", -6.571582997369922),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.571582997369922),
                                    ("at <time-of-day>intersect", -5.655292265495767),
                                    ("Rosh Hashanahyear (latent)", -5.878435816809977),
                                    ("Super Tuesdayyear (latent)", -5.655292265495767),
                                    ("Dhanterasyear (latent)", -6.571582997369922),
                                    ("Tu BiShvatyear (latent)", -6.571582997369922),
                                    ("<day-of-month> (ordinal)December", -5.878435816809977),
                                    ("Holiyear (latent)", -5.878435816809977),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.571582997369922),
                                    ("Holika Dahanyear (latent)", -5.878435816809977),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.166117889261757),
                                    ("dayminute", -3.221678910095317),
                                    ("Mawlidyear (latent)", -6.571582997369922),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.166117889261757),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.571582997369922),
                                    ("Jumu'atul-Widayear (latent)", -5.655292265495767),
                                    ("minuteday", -2.8220789214395507),
                                    ("absorption of , after named dayintersect",
                                     -5.878435816809977),
                                    ("intersectyear (latent)", -6.571582997369922),
                                    ("Orthodox Easter Sundayyear (latent)", -6.571582997369922),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.571582997369922),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.571582997369922),
                                    ("Mini-Tuesdayyear (latent)", -6.571582997369922),
                                    ("intersecthhhmm", -6.166117889261757),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.571582997369922),
                                    ("Boss's Dayyear (latent)", -6.166117889261757),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.571582997369922),
                                    ("Global Youth Service Dayyear (latent)", -6.571582997369922),
                                    ("Dhanterasin|during <named-month>|year", -6.571582997369922),
                                    ("Super Tuesdayin|during <named-month>|year",
                                     -6.571582997369922),
                                    ("tonight<time-of-day> o'clock", -6.571582997369922),
                                    ("Tisha B'Avyear (latent)", -6.571582997369922),
                                    ("Isra and Mi'rajyear (latent)", -5.655292265495767),
                                    ("at <time-of-day>on <day>", -4.9621450849358215),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.166117889261757),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.878435816809977),
                                    ("Christmasyear (latent)", -6.166117889261757),
                                    ("Saturdayintersect", -6.571582997369922),
                                    ("Naraka Chaturdashiyear (latent)", -6.166117889261757),
                                    ("Thai Pongalin|during <named-month>|year", -6.571582997369922),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.571582997369922),
                                    ("dayweek", -6.571582997369922),
                                    ("Easter Sundayyear (latent)", -5.878435816809977),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.166117889261757),
                                    ("weekyear", -5.472970708701813),
                                    ("Super Tuesdaythis|last|next <cycle>", -6.571582997369922),
                                    ("King's Dayyear (latent)", -5.067505600593648),
                                    ("hh:mmin|during the <part-of-day>", -5.655292265495767),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.166117889261757),
                                    ("Hanukkahyear (latent)", -5.878435816809977),
                                    ("Rama Navamiyear (latent)", -6.571582997369922),
                                    ("February<time> <part-of-day>", -6.571582997369922),
                                    ("National Grandparents Dayyear (latent)", -6.571582997369922),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.878435816809977),
                                    ("Great Lentyear (latent)", -6.571582997369922),
                                    ("tomorrowat <time-of-day>", -5.878435816809977),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.571582997369922),
                                    ("Labor Dayyear (latent)", -6.571582997369922),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.166117889261757),
                                    ("Ugadiyear (latent)", -5.185288636250031),
                                    ("Vaisakhiyear (latent)", -5.878435816809977),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.878435816809977),
                                    ("last <cycle> of <time>year (latent)", -5.878435816809977),
                                    ("at <time-of-day>tomorrow", -6.166117889261757),
                                    ("tomorrow<time-of-day> am|pm", -6.571582997369922),
                                    ("President's Dayyear (latent)", -6.571582997369922),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.571582997369922),
                                    ("Diwaliyear (latent)", -6.571582997369922),
                                    ("between <time> and <time>on <day>", -6.166117889261757),
                                    ("Black Fridayyear (latent)", -6.166117889261757),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.571582997369922),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.571582997369922),
                                    ("Chhathyear (latent)", -6.166117889261757),
                                    ("Vasant Panchamiyear (latent)", -6.571582997369922),
                                    ("Tax Dayyear (latent)", -5.472970708701813),
                                    ("Rabindra Jayantiyear (latent)", -5.318820028874554),
                                    ("this <part-of-day>at <time-of-day>", -5.318820028874554),
                                    ("St Patrick's Dayyear (latent)", -6.571582997369922),
                                    ("Thursday<time> (timezone)", -6.571582997369922),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.571582997369922),
                                    ("Pargat Diwasyear (latent)", -5.318820028874554),
                                    ("<datetime> - <datetime> (interval)July", -6.166117889261757),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.878435816809977),
                                    ("Februaryintersect", -6.571582997369922),
                                    ("Mother's Dayyear (latent)", -6.571582997369922),
                                    ("Simchat Torahyear (latent)", -6.571582997369922),
                                    ("minuteyear", -6.571582997369922)],
                               n = 547},
                   koData =
                     ClassData{prior = -0.9588993646993723, unseen = -6.923628628138427,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.7254193141396685),
                                    ("hourday", -3.6268070254715585),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.229496710915942),
                                    ("<day-of-month> (ordinal)August", -6.229496710915942),
                                    ("dayhour", -3.5553480614894135),
                                    ("<time> timezoneyear (latent)", -5.536349530355997),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.313205979041787),
                                    ("Tuesdayfrom|since|after <time>", -5.130884422247832),
                                    ("daymonth", -3.521446509813732),
                                    ("hourquarter", -5.313205979041787),
                                    ("monthyear", -4.976733742420574),
                                    ("<time-of-day> am|pmyear (latent)", -5.536349530355997),
                                    ("Thai Pongalyear (latent)", -5.536349530355997),
                                    ("intersecthh:mm", -6.229496710915942),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.824031602807778),
                                    ("<datetime> - <datetime> (interval)Sunday",
                                     -5.824031602807778),
                                    ("<day-of-month> (ordinal)Wednesday", -6.229496710915942),
                                    ("houryear", -4.437737241687888),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.229496710915942),
                                    ("<day-of-month> (ordinal)October", -6.229496710915942),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.536349530355997),
                                    ("hournograin", -4.976733742420574),
                                    ("<time-of-day> am|pmintersect", -4.976733742420574),
                                    ("Octoberyear (latent)", -6.229496710915942),
                                    ("Good Fridayyear (latent)", -5.824031602807778),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.824031602807778),
                                    ("early morningat <time-of-day>", -6.229496710915942),
                                    ("until <time>on <day>", -5.536349530355997),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.229496710915942),
                                    ("time-of-day (latent)intersect", -5.536349530355997),
                                    ("todayin <number> (implicit minutes)", -6.229496710915942),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.536349530355997),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.229496710915942),
                                    ("hh:mmon <day>", -4.976733742420574),
                                    ("hhhmmintersect", -5.824031602807778),
                                    ("absorption of , after named dayJuly", -5.313205979041787),
                                    ("from|since|after <time>July", -5.824031602807778),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.313205979041787),
                                    ("Clean Mondayyear (latent)", -6.229496710915942),
                                    ("monthhour", -6.229496710915942),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.824031602807778),
                                    ("hourmonth", -4.0894305474196715),
                                    ("todayat <time-of-day>", -6.229496710915942),
                                    ("hhhmmyear (latent)", -4.976733742420574),
                                    ("from|since|after <time>December", -6.229496710915942),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.229496710915942),
                                    ("<time-of-day> am|pmon <day>", -4.976733742420574),
                                    ("Mondayyear (latent)", -5.130884422247832),
                                    ("dayday", -3.9782049123094474),
                                    ("mm/ddat <time-of-day>", -5.824031602807778),
                                    ("on <day>September", -5.536349530355997),
                                    ("time-of-day (latent)September", -5.824031602807778),
                                    ("hourhour", -4.150055169236107),
                                    ("time-of-day (latent)on <day>", -4.7254193141396685),
                                    ("<datetime> - <datetime> (interval)year (latent)",
                                     -6.229496710915942),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.824031602807778),
                                    ("dayyear", -2.8972922007407385),
                                    ("Thursdaymm/dd", -6.229496710915942),
                                    ("New Year's Dayyear (latent)", -5.313205979041787),
                                    ("Tuesdayyear (latent)", -5.130884422247832),
                                    ("time-of-day (latent)Sunday", -5.824031602807778),
                                    ("Thursdayfrom|since|after <time>", -4.524748618677517),
                                    ("Thursdayat <time-of-day>", -4.620058798481842),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.229496710915942),
                                    ("Aprilyear (latent)", -6.229496710915942),
                                    ("the <day-of-month> (ordinal)July", -6.229496710915942),
                                    ("the <day-of-month> (number)July", -6.229496710915942),
                                    ("monthminute", -6.229496710915942),
                                    ("<time-of-day> am|pmtomorrow", -5.824031602807778),
                                    ("Thursdayhh:mm", -5.313205979041787),
                                    ("<day-of-month> (ordinal)Tuesday", -5.824031602807778),
                                    ("minutemonth", -4.0894305474196715),
                                    ("time-of-day (latent)Friday", -5.824031602807778),
                                    ("minutehour", -6.229496710915942),
                                    ("Tuesdayin <number> (implicit minutes)", -6.229496710915942),
                                    ("part of daysat <time-of-day>", -5.130884422247832),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.8781214537524646),
                                    ("<day-of-month> (ordinal)Sunday", -6.229496710915942),
                                    ("Augustyear (latent)", -5.824031602807778),
                                    ("week-endin|during <named-month>|year", -6.229496710915942),
                                    ("time-of-day (latent)Tuesday", -5.824031602807778),
                                    ...
                                    ("Sundayyear (latent)", -5.313205979041787),
                                    ("hourweek", -5.313205979041787),
                                    ("the <day-of-month> (ordinal)Monday", -5.536349530355997),
                                    ("Christmasat <time-of-day>", -6.229496710915942),
                                    ("from|since|after <time>year (latent)", -5.130884422247832),
                                    ("hhhmmon <day>", -5.313205979041787),
                                    ("yesterday<time-of-day> am|pm", -6.229496710915942),
                                    ("<day-of-month> (ordinal)July", -5.536349530355997),
                                    ("Tuesday<duration> hence|ago", -6.229496710915942),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.229496710915942),
                                    ("mm/ddyear (latent)", -6.229496710915942),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.229496710915942),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.229496710915942),
                                    ("Tuesdaythis|last|next <cycle>", -6.229496710915942),
                                    ("at <time-of-day>intersect", -5.313205979041787),
                                    ("hh:mmyear (latent)", -4.8432023497960515),
                                    ("Holiyear (latent)", -6.229496710915942),
                                    ("until <time><time-of-day> am|pm", -6.229496710915942),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.824031602807778),
                                    ("dayminute", -3.3391249530197777),
                                    ("yyyy-mm-ddhh:mm", -5.824031602807778),
                                    ("intersectfrom|since|after <time>", -5.824031602807778),
                                    ("intersectSeptember", -4.357694534014351),
                                    ("minuteday", -3.0724962897658292),
                                    ("absorption of , after named dayintersect",
                                     -6.229496710915942),
                                    ("intersectyear (latent)", -6.229496710915942),
                                    ("Februaryin|during the <part-of-day>", -6.229496710915942),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.229496710915942),
                                    ("time-of-day (latent)July", -5.536349530355997),
                                    ("Saturdayyear (latent)", -6.229496710915942),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.229496710915942),
                                    ("<day-of-month> (ordinal)Monday", -5.313205979041787),
                                    ("at <time-of-day>on <day>", -5.313205979041787),
                                    ("absorption of , after named daySeptember",
                                     -4.976733742420574),
                                    ("Naraka Chaturdashiyear (latent)", -6.229496710915942),
                                    ("from|since|after <time>on <day>", -5.313205979041787),
                                    ("dayweek", -6.229496710915942),
                                    ("Easter Sundayyear (latent)", -5.824031602807778),
                                    ("Thursday<time-of-day> am|pm", -4.976733742420574),
                                    ("weekyear", -5.824031602807778),
                                    ("time-of-day (latent)Thursday", -5.824031602807778),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.229496710915942),
                                    ("<day-of-month> (ordinal)April", -6.229496710915942),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.824031602807778),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.536349530355997),
                                    ("Sundayfrom|since|after <time>", -6.229496710915942),
                                    ("absorption of , after named dayFebruary", -5.313205979041787),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.824031602807778),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.229496710915942),
                                    ("tomorrowat <time-of-day>", -6.229496710915942),
                                    ("daynograin", -5.824031602807778),
                                    ("Fridayin|during <named-month>|year", -6.229496710915942),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.824031602807778),
                                    ("last <cycle> of <time>year (latent)", -5.824031602807778),
                                    ("tomorrow<time-of-day> am|pm", -6.229496710915942),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.536349530355997),
                                    ("Diwaliyear (latent)", -5.824031602807778),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.229496710915942),
                                    ("this <part-of-day>at <time-of-day>", -5.313205979041787),
                                    ("Fridayyear (latent)", -5.313205979041787),
                                    ("Tuesdayin|within|after <duration>", -6.229496710915942),
                                    ("time-of-day (latent)April", -6.229496710915942),
                                    ("minuteyear", -4.032272133579723)],
                               n = 340}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.7009293210020002, unseen = -4.882801922586371,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 128},
                   koData =
                     ClassData{prior = -0.685425134466035, unseen = -4.897839799950911,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.16296130950941318),
