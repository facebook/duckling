...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5953830117940537, unseen = -5.730099782973574,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 306},
                   koData =
                     ClassData{prior = -0.8015152172817268,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.071891796220597),
                                    ...
                                    ("Dhanterasin <named-month>|year", -6.071891796220597),
                                    ...
                                    ("Thursday<time> timezone", -4.367143703982172),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.071891796220597),
                                    ("Palm SundaySunday", -5.666426688112432),
                                    ("Tax Daythis|last|next <cycle>", -6.071891796220597),
                                    ("dayday", -3.8746672188843774),
                                    ...
                                    ("<time-of-day> am|pmon <date>", -4.056988775678332),
                                    ...
                                    ("dayyear", -1.928757069829064),
                                    ("Thursdayfrom|since|after <time>", -5.666426688112432),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.071891796220597),
                                    ("Thursdayat <time-of-day>", -5.666426688112432),
                                    ("Islamic New Yearyear (latent)", -5.666426688112432),
                                    ("Laylat al-Qadryear (latent)", -5.155601064346442),
                                    ("Chhathin <named-month>|year", -6.071891796220597),
                                    ("Vasant Panchamiin <named-month>|year", -6.071891796220597),
                                    ("Diwaliin <named-month>|year", -6.071891796220597),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.666426688112432),
                                    ("Emancipation Dayyear (latent)", -5.3787446156606515),
                                    ("Navaratriin <named-month>|year", -6.071891796220597),
                                    ("Ashurayear (latent)", -6.071891796220597),
                                    ("Chinese New Yearyear (latent)", -6.071891796220597),
                                    ("Sundayyear (latent)", -6.071891796220597),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.071891796220597),
                                    ("Cyber Mondayyear (latent)", -5.666426688112432),
                                    ("Yom HaShoahyear (latent)", -5.666426688112432),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.666426688112432),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.071891796220597),
                                    ("Thai Pongalin <named-month>|year", -6.071891796220597),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -6.071891796220597),
                                    ...
                                    ("at <time-of-day>on <date>", -4.973279507552487),
                                    ...
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.666426688112432),
                                    ("Hanukkahyear (latent)", -6.071891796220597),
                                    ("February<time> <part-of-day>", -6.071891796220597),
                                    ("National Grandparents Dayyear (latent)", -6.071891796220597),
                                    ("Tuesdayin <named-month>|year", -6.071891796220597),
                                    ("Great Lentyear (latent)", -6.071891796220597),
                                    ("tomorrowat <time-of-day>", -5.3787446156606515),
                                    ("Labor Dayyear (latent)", -6.071891796220597),
                                    ("between <time> and <time>on <date>", -4.462453883786496),
                                    ...
                                    ("President's Dayyear (latent)", -6.071891796220597),
                                    ...
                                    ("Palm Sundayintersect", -6.071891796220597),
                                    ("Tax Dayyear (latent)", -5.155601064346442),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.071891796220597),
                                    ("Februaryintersect", -6.071891796220597),
                                    ("Mother's Dayyear (latent)", -6.071891796220597),
                                    ("Simchat Torahyear (latent)", -6.071891796220597)],
                               n = 323},
                   koData =
                     ClassData{prior = -0.9899498374085351, unseen = -6.403574197934815,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.792479284293085),
                                    ("hourday", -4.792479284293085),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.70877001616724),
                                    ("dayhour", -3.1438206587057036),
                                    ("Tuesdayfrom|since|after <time>", -5.70877001616724),
                                    ("daymonth", -3.5687038526709696),
                                    ("monthday", -5.303304908059076),
                                    ("monthyear", -4.456007047671872),
                                    ("<time-of-day> am|pmyear (latent)", -5.303304908059076),
                                    ("Thai Pongalyear (latent)", -5.015622835607295),
                                    ("intersecthh:mm", -5.70877001616724),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.70877001616724),
                                    ("houryear", -4.792479284293085),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.70877001616724),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.015622835607295),
                                    ("<time-of-day> am|pmintersect", -4.456007047671872),
                                    ("until <time>on <date>", -5.015622835607295),
                                    ("Octoberyear (latent)", -5.70877001616724),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.70877001616724),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -4.456007047671872),
                                    ("about|exactly <time-of-day>year (latent)", -5.70877001616724),
                                    ("absorption of , after named dayJuly", -5.303304908059076),
                                    ("from|since|after <time>July", -5.70877001616724),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.792479284293085),
                                    ("Clean Mondayyear (latent)", -5.70877001616724),
                                    ("monthhour", -5.70877001616724),
                                    ("hourmonth", -4.792479284293085),
                                    ("todayat <time-of-day>", -5.70877001616724),
                                    ("from|since|after <time>December", -5.70877001616724),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.70877001616724),
                                    ("Mondayyear (latent)", -4.61015772749913),
                                    ("dayday", -5.303304908059076),
                                    ("mm/ddat <time-of-day>", -5.303304908059076),
                                    ("<time-of-day> am|pmon <date>", -4.456007047671872),
                                    ("dayyear", -2.688345130022878),
                                    ("Thursdaymm/dd", -5.70877001616724),
                                    ("New Year's Dayyear (latent)", -5.303304908059076),
                                    ("Thursdayfrom|since|after <time>", -4.004021923928815),
                                    ("Thursdayat <time-of-day>", -4.456007047671872),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.70877001616724),
                                    ("Aprilyear (latent)", -5.70877001616724),
                                    ("monthminute", -5.70877001616724),
                                    ("<time-of-day> am|pmtomorrow", -5.70877001616724),
                                    ("Thursdayhh:mm", -4.792479284293085),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.70877001616724),
                                    ("minutemonth", -3.917010546939185),
                                    ("week-endin <named-month>|year", -5.70877001616724),
                                    ("Augustyear (latent)", -5.303304908059076),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.303304908059076),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.303304908059076),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.70877001616724),
                                    ("Sundayyear (latent)", -5.015622835607295),
                                    ("Christmasat <time-of-day>", -5.70877001616724),
                                    ("from|since|after <time>year (latent)", -4.456007047671872),
                                    ("<duration> after|before|from <time>December",
                                     -5.70877001616724),
                                    ("yesterday<time-of-day> am|pm", -5.70877001616724),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.792479284293085),
                                    ("mm/ddyear (latent)", -5.70877001616724),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.015622835607295),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.70877001616724),
                                    ("at <time-of-day>intersect", -5.303304908059076),
                                    ("hh:mmyear (latent)", -4.61015772749913),
                                    ("Holiyear (latent)", -5.70877001616724),
                                    ("until <time><time-of-day> am|pm", -5.70877001616724),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.70877001616724),
                                    ("dayminute", -3.1830413718589847),
                                    ("intersectSeptember", -4.204692619390966),
                                    ("minuteday", -2.640717081033623),
                                    ("absorption of , after named dayintersect", -5.70877001616724),
                                    ("Februaryin|during the <part-of-day>", -5.70877001616724),
                                    ("hh:mmon <date>", -3.6938669956249752),
                                    ("Saturdayyear (latent)", -5.70877001616724),
                                    ("from|since|after <time>on <date>", -4.792479284293085),
                                    ("absorption of , after named daySeptember",
                                     -4.792479284293085),
                                    ("Naraka Chaturdashiyear (latent)", -5.70877001616724),
                                    ("on <date>September", -5.303304908059076),
                                    ("at <time-of-day>on <date>", -5.303304908059076),
                                    ("in <named-month>|yearyear (latent)", -5.70877001616724),
                                    ("dayweek", -5.70877001616724),
                                    ("Easter Sundayyear (latent)", -5.303304908059076),
                                    ("Thursday<time-of-day> am|pm", -5.015622835607295),
                                    ("weekyear", -5.303304908059076),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.70877001616724),
                                    ("Sundayfrom|since|after <time>", -5.70877001616724),
                                    ("absorption of , after named dayFebruary", -4.792479284293085),
                                    ...
                                    ("tomorrow<time-of-day> am|pm", -5.70877001616724),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.015622835607295),
                                    ("Diwaliyear (latent)", -5.303304908059076),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.70877001616724),
                                    ("Fridayyear (latent)", -5.303304908059076),
                                    ("minuteyear", -4.456007047671872)],
                               n = 191}}),
       ("one eleven",
        Classifier{okData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -4.027389913793996e-2),
                                    ("intersect 2 numbers", -3.6375861597263857)],
                               n = 148},
                   koData =
                     ClassData{prior = -2.044755983691946, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
