...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5813557745718286, unseen = -5.749392985908253,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 312},
                   koData =
                     ClassData{prior = -0.8190274264489481,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45502926612428546,
                               unseen = -6.779921907472252,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.085637717125231),
                                    ("Father's Dayyear (latent)", -6.085637717125231),
                                    ("Ramadanyear (latent)", -6.085637717125231),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.832874748629864),
                                    ("Military Spouse Dayyear (latent)", -6.085637717125231),
                                    ("Bhai Doojyear (latent)", -6.085637717125231),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.832874748629864),
                                    ("hourday", -4.380889624886806),
                                    ("dayhour", -3.2822773362186966),
                                    ("Martin Luther King's Dayyear (latent)", -5.680172609017068),
                                    ("Shemini Atzeretyear (latent)", -6.085637717125231),
                                    ("daymonth", -5.392490536565287),
                                    ("monthday", -5.680172609017068),
                                    ("monthyear", -4.476199804691132),
                                    ("Yom Ha'atzmautyear (latent)", -6.085637717125231),
                                    ("Vijayadashamiyear (latent)", -6.085637717125231),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -4.6993433560053415),
                                    ("Thanksgiving Dayyear (latent)", -4.987025428457122),
                                    ("Thai Pongalyear (latent)", -5.392490536565287),
                                    ("Thiru Onamyear (latent)", -5.392490536565287),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.085637717125231),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.085637717125231),
                                    ("houryear", -5.392490536565287),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.085637717125231),
                                    ("Christmas<time-of-day> am|pm", -6.085637717125231),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.085637717125231),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.392490536565287),
                                    ("<time-of-day> am|pmintersect", -4.832874748629864),
                                    ("Earth Houryear (latent)", -6.085637717125231),
                                    ("Octoberyear (latent)", -4.832874748629864),
                                    ("intersect<time-of-day> am|pm", -6.085637717125231),
                                    ("Mattu Pongalyear (latent)", -6.085637717125231),
                                    ("Shavuotyear (latent)", -6.085637717125231),
                                    ("Dhanterasin <named-month>|year", -6.085637717125231),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.085637717125231),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.085637717125231),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.680172609017068),
                                    ("Marchyear (latent)", -6.085637717125231),
                                    ("Sukkotyear (latent)", -5.680172609017068),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.085637717125231),
                                    ("Clean Mondayyear (latent)", -5.680172609017068),
                                    ("monthhour", -5.680172609017068),
                                    ("todayat <time-of-day>", -6.085637717125231),
                                    ("Thursday<time> timezone", -4.380889624886806),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.085637717125231),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.085637717125231),
                                    ("Palm SundaySunday", -5.680172609017068),
                                    ("Tax Daythis|last|next <cycle>", -6.085637717125231),
                                    ("dayday", -3.8884131397890123),
                                    ("<time> <part-of-day>at <time-of-day>", -6.085637717125231),
                                    ("mm/ddat <time-of-day>", -6.085637717125231),
                                    ("tonightat <time-of-day>", -6.085637717125231),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.392490536565287),
                                    ("today<time-of-day> am|pm", -6.085637717125231),
                                    ("Februarythe <day-of-month> (ordinal)", -5.680172609017068),
                                    ("at <time-of-day><time> <part-of-day>", -6.085637717125231),
                                    ("mm/dd<time-of-day> am|pm", -6.085637717125231),
                                    ("hourhour", -4.832874748629864),
                                    ("<time-of-day> am|pmon <date>", -4.070734696582967),
                                    ("Wednesdaythis|last|next <cycle>", -6.085637717125231),
                                    ("Lentyear (latent)", -6.085637717125231),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.581560320348958),
                                    ("Boghiyear (latent)", -6.085637717125231),
                                    ("dayyear", -1.8735101192467476),
                                    ("Thursdayfrom|since|after <time>", -5.680172609017068),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.085637717125231),
                                    ("Thursdayat <time-of-day>", -5.680172609017068),
                                    ("Islamic New Yearyear (latent)", -5.680172609017068),
                                    ("Laylat al-Qadryear (latent)", -5.169346985251076),
                                    ("Chhathin <named-month>|year", -6.085637717125231),
                                    ("Vasant Panchamiin <named-month>|year", -6.085637717125231),
                                    ("Diwaliin <named-month>|year", -6.085637717125231),
                                    ("Shrove Tuesdayyear (latent)", -6.085637717125231),
                                    ("<time-of-day> am|pmtomorrow", -5.392490536565287),
                                    ("Yom Kippuryear (latent)", -6.085637717125231),
                                    ("<part-of-day> of <time>year (latent)", -6.085637717125231),
                                    ("minutehour", -5.169346985251076),
                                    ("Kaanum Pongalyear (latent)", -5.680172609017068),
                                    ("Maha Saptamiyear (latent)", -6.085637717125231),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.680172609017068),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.380889624886806),
                                    ("for <duration> from <time>December", -6.085637717125231),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.085637717125231),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.169346985251076),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.680172609017068),
                                    ("Pentecostyear (latent)", -6.085637717125231),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.169346985251076),
                                    ("Eid al-Fitryear (latent)", -6.085637717125231),
                                    ("Mondayin|during the <part-of-day>", -6.085637717125231),
                                    ("Raksha Bandhanyear (latent)", -6.085637717125231),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.680172609017068),
                                    ("Emancipation Dayyear (latent)", -5.392490536565287),
                                    ("Navaratriin <named-month>|year", -6.085637717125231),
                                    ("Ashurayear (latent)", -6.085637717125231),
                                    ("Chinese New Yearyear (latent)", -6.085637717125231),
                                    ("Sundayyear (latent)", -6.085637717125231),
                                    ("Lag BaOmeryear (latent)", -6.085637717125231),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.085637717125231),
                                    ("Eid al-Adhayear (latent)", -5.169346985251076),
                                    ("intersectin|during the <part-of-day>", -6.085637717125231),
                                    ("Christmasat <time-of-day>", -6.085637717125231),
                                    ("Passoveryear (latent)", -6.085637717125231),
                                    ("Lazarus Saturdayyear (latent)", -6.085637717125231),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.085637717125231),
                                    ("Cyber Mondayyear (latent)", -5.680172609017068),
                                    ("Yom HaShoahyear (latent)", -5.680172609017068),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.680172609017068),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.085637717125231),
                                    ("Thai Pongalin <named-month>|year", -6.085637717125231),
                                    ("Septemberyear (latent)", -5.680172609017068),
                                    ("mm/ddyear (latent)", -6.085637717125231),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.832874748629864),
                                    ("Halloweenyear (latent)", -6.085637717125231),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.392490536565287),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -5.169346985251076),
                                    ("at <time-of-day>intersect", -5.680172609017068),
                                    ("Rosh Hashanahyear (latent)", -6.085637717125231),
                                    ("Dhanterasyear (latent)", -6.085637717125231),
                                    ("Tu BiShvatyear (latent)", -6.085637717125231),
                                    ("Holiyear (latent)", -5.392490536565287),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.085637717125231),
                                    ("Holika Dahanyear (latent)", -5.392490536565287),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.085637717125231),
                                    ("dayminute", -3.446580387509973),
                                    ("Mawlidyear (latent)", -6.085637717125231),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.680172609017068),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.085637717125231),
                                    ("Jumu'atul-Widayear (latent)", -5.169346985251076),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.085637717125231),
                                    ("minuteday", -2.4480515573988457),
                                    ("absorption of , after named dayintersect",
                                     -6.085637717125231),
                                    ("intersectyear (latent)", -6.085637717125231),
                                    ("Orthodox Easter Sundayyear (latent)", -6.085637717125231),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.085637717125231),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.085637717125231),
                                    ("Boss's Dayyear (latent)", -5.680172609017068),
                                    ("Global Youth Service Dayyear (latent)", -6.085637717125231),
                                    ("Tisha B'Avyear (latent)", -6.085637717125231),
                                    ("Isra and Mi'rajyear (latent)", -5.169346985251076),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.085637717125231),
                                    ("Christmasyear (latent)", -5.680172609017068),
                                    ("Naraka Chaturdashiyear (latent)", -5.680172609017068),
                                    ("at <time-of-day>on <date>", -4.987025428457122),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.085637717125231),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.476199804691132),
                                    ("dayweek", -6.085637717125231),
                                    ("Easter Sundayyear (latent)", -5.392490536565287),
                                    ("weekyear", -5.680172609017068),
                                    ("hh:mmin|during the <part-of-day>", -5.392490536565287),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.680172609017068),
                                    ("Hanukkahyear (latent)", -6.085637717125231),
                                    ("February<time> <part-of-day>", -6.085637717125231),
                                    ("National Grandparents Dayyear (latent)", -6.085637717125231),
                                    ("Tuesdayin <named-month>|year", -6.085637717125231),
                                    ("Great Lentyear (latent)", -6.085637717125231),
                                    ("tomorrowat <time-of-day>", -5.392490536565287),
                                    ("Labor Dayyear (latent)", -6.085637717125231),
                                    ("between <time> and <time>on <date>", -4.476199804691132),
                                    ("last <cycle> of <time>year (latent)", -5.392490536565287),
                                    ("at <time-of-day>tomorrow", -5.680172609017068),
                                    ("tomorrow<time-of-day> am|pm", -6.085637717125231),
                                    ("President's Dayyear (latent)", -6.085637717125231),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.085637717125231),
                                    ("Diwaliyear (latent)", -6.085637717125231),
                                    ("Black Fridayyear (latent)", -5.680172609017068),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.085637717125231),
                                    ("Chhathyear (latent)", -5.680172609017068),
                                    ("Vasant Panchamiyear (latent)", -6.085637717125231),
                                    ("Palm Sundayintersect", -6.085637717125231),
                                    ("Tax Dayyear (latent)", -5.169346985251076),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.085637717125231),
                                    ("Februaryintersect", -6.085637717125231),
                                    ("Mother's Dayyear (latent)", -6.085637717125231),
                                    ("Simchat Torahyear (latent)", -6.085637717125231),
                                    ("minuteyear", -6.085637717125231)],
                               n = 328},
                   koData =
                     ClassData{prior = -1.0062958594487867, unseen = -6.400257445308821,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.789157022101107),
                                    ...
                                    ("daymonth", -3.5653815904789914),
                                    ("monthday", -5.2999826458670976),
                                    ...
                                    ("week-endin <named-month>|year", -5.705447753975262),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.705447753975262),
                                    ("Sundayyear (latent)", -5.012300573415317),
                                    ("Christmasat <time-of-day>", -5.705447753975262),
                                    ("from|since|after <time>year (latent)", -4.452684785479894),
                                    ...
                                    ("in <named-month>|yearyear (latent)", -5.705447753975262),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.13353139262452263,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.871451218069039e-2),
                                    ("intersect 2 numbers", -3.676300671907076)],
                               n = 154},
                   koData =
                     ClassData{prior = -2.0794415416798357, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
