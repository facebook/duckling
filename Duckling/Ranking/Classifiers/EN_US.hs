...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4688614246669586, unseen = -7.044905117129371,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.35088571671474),
                                    ("Father's Dayyear (latent)", -6.35088571671474),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.35088571671474),
                                    ("Ramadanyear (latent)", -5.434594984840585),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.335982696172475),
                                    ("Military Spouse Dayyear (latent)", -6.35088571671474),
                                    ("Bhai Doojyear (latent)", -6.35088571671474),
                                    ("hourday", -4.335982696172475),
                                    ("dayhour", -3.4331149846304605),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.335982696172475),
                                    ("Martin Luther King's Dayyear (latent)", -5.945420608606575),
                                    ("Shemini Atzeretyear (latent)", -6.35088571671474),
                                    ("daymonth", -4.335982696172475),
                                    ("monthday", -5.945420608606575),
                                    ("monthyear", -4.5591262474866845),
                                    ("Yom Ha'atzmautyear (latent)", -6.35088571671474),
                                    ("Vijayadashamiyear (latent)", -6.35088571671474),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -4.964591355594849),
                                    ("Thanksgiving Dayyear (latent)", -5.25227342804663),
                                    ("Thai Pongalyear (latent)", -5.6577385361547945),
                                    ("Thiru Onamyear (latent)", -5.6577385361547945),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.35088571671474),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.434594984840585),
                                    ("<day-of-month> (ordinal)Wednesday", -6.35088571671474),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.35088571671474),
                                    ("houryear", -5.434594984840585),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.35088571671474),
                                    ("Christmas<time-of-day> am|pm", -6.35088571671474),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.35088571671474),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.6577385361547945),
                                    ("intersectin|during <named-month>|year", -6.35088571671474),
                                    ("<time-of-day> am|pmintersect", -5.098122748219372),
                                    ("Earth Houryear (latent)", -6.35088571671474),
                                    ("Octoberyear (latent)", -4.846808319938465),
                                    ("intersect<time-of-day> am|pm", -6.35088571671474),
                                    ("Mattu Pongalyear (latent)", -6.35088571671474),
                                    ("Daylight Saving Start Dayyear (latent)", -5.434594984840585),
                                    ("Shavuotyear (latent)", -6.35088571671474),
                                    ("Parsi New Yearyear (latent)", -5.434594984840585),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.35088571671474),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.35088571671474),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.945420608606575),
                                    ("Marchyear (latent)", -6.35088571671474),
                                    ("Sukkotyear (latent)", -5.945420608606575),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.945420608606575),
                                    ("Daylight Saving End Dayyear (latent)", -5.434594984840585),
                                    ("Clean Mondayyear (latent)", -5.945420608606575),
                                    ("monthhour", -5.945420608606575),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.6577385361547945),
                                    ("todayat <time-of-day>", -6.35088571671474),
                                    ("Thursday<time> timezone", -4.404975567659426),
                                    ("time-of-day (latent)tonight", -5.945420608606575),
                                    ("from|since|after <time>December", -6.35088571671474),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.35088571671474),
                                    ("<time-of-day> am|pmon <day>", -4.335982696172475),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -6.35088571671474),
                                    ("yyyy-mm-ddhh:mm:ss", -5.945420608606575),
                                    ("Tax Daythis|last|next <cycle>", -6.35088571671474),
                                    ("dayday", -3.908538681345535),
                                    ("<time> <part-of-day>at <time-of-day>", -6.35088571671474),
                                    ("mm/ddat <time-of-day>", -6.35088571671474),
                                    ("tonightat <time-of-day>", -6.35088571671474),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.6577385361547945),
                                    ("Dayananda Saraswati Jayantiyear (latent)", -6.35088571671474),
                                    ("today<time-of-day> am|pm", -6.35088571671474),
                                    ("Februarythe <day-of-month> (ordinal)", -5.945420608606575),
                                    ("at <time-of-day><time> <part-of-day>", -6.35088571671474),
                                    ("<day-of-month> (ordinal)intersect", -5.945420608606575),
                                    ("mm/dd<time-of-day> am|pm", -6.35088571671474),
                                    ("hourhour", -4.271444175034904),
                                    ("Navaratriin|during <named-month>|year", -6.35088571671474),
                                    ("Wednesdaythis|last|next <cycle>", -6.35088571671474),
                                    ("Lentyear (latent)", -6.35088571671474),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.846808319938465),
                                    ("Boghiyear (latent)", -6.35088571671474),
                                    ("dayyear", -1.8622493469825998),
                                    ("Thursdayfrom|since|after <time>", -5.945420608606575),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.35088571671474),
                                    ("Thursdayat <time-of-day>", -5.6577385361547945),
                                    ("Islamic New Yearyear (latent)", -5.945420608606575),
                                    ("Laylat al-Qadryear (latent)", -5.434594984840585),
                                    ("Shrove Tuesdayyear (latent)", -6.35088571671474),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.6577385361547945),
                                    ("<time-of-day> am|pmtomorrow", -5.6577385361547945),
                                    ("Yom Kippuryear (latent)", -6.35088571671474),
                                    ("<day-of-month> (ordinal)Tuesday", -5.945420608606575),
                                    ("<part-of-day> of <time>year (latent)", -6.35088571671474),
                                    ("minutehour", -5.25227342804663),
                                    ("Kaanum Pongalyear (latent)", -5.945420608606575),
                                    ("Maha Saptamiyear (latent)", -6.35088571671474),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.945420608606575),
                                    ("time-of-day (latent)tomorrow", -5.434594984840585),
                                    ("part of daysat <time-of-day>", -5.945420608606575),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.646137624476315),
                                    ("for <duration> from <time>December", -6.35088571671474),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.35088571671474),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.098122748219372),
                                    ("time-of-day (latent)this <part-of-day>", -6.35088571671474),
                                    ("Pentecostyear (latent)", -6.35088571671474),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.098122748219372),
                                    ("<day-of-month> (ordinal)February", -6.35088571671474),
                                    ("Eid al-Fitryear (latent)", -5.434594984840585),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.35088571671474),
                                    ("Mondayin|during the <part-of-day>", -6.35088571671474),
                                    ("Chhathin|during <named-month>|year", -6.35088571671474),
                                    ("Diwaliin|during <named-month>|year", -6.35088571671474),
                                    ("Vaisakhiin|during <named-month>|year", -6.35088571671474),
                                    ("Raksha Bandhanyear (latent)", -6.35088571671474),
                                    ("daysecond", -5.945420608606575),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.945420608606575),
                                    ("Emancipation Dayyear (latent)", -5.6577385361547945),
                                    ("Ashurayear (latent)", -6.35088571671474),
                                    ("Tuesdayin|during <named-month>|year", -6.35088571671474),
                                    ("Chinese New Yearyear (latent)", -6.35088571671474),
                                    ("tomorrowintersect", -6.35088571671474),
                                    ("Lag BaOmeryear (latent)", -6.35088571671474),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.35088571671474),
                                    ("Eid al-Adhayear (latent)", -5.434594984840585),
                                    ("intersectin|during the <part-of-day>", -6.35088571671474),
                                    ("Palm Sundayyear (latent)", -6.35088571671474),
                                    ("Christmasat <time-of-day>", -6.35088571671474),
                                    ("Passoveryear (latent)", -6.35088571671474),
                                    ("Lazarus Saturdayyear (latent)", -6.35088571671474),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.35088571671474),
                                    ("Cyber Mondayyear (latent)", -5.945420608606575),
                                    ("Yom HaShoahyear (latent)", -5.945420608606575),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.945420608606575),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.35088571671474),
                                    ("Septemberyear (latent)", -5.945420608606575),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.846808319938465),
                                    ("Halloweenyear (latent)", -6.35088571671474),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.35088571671474),
                                    ("at <time-of-day>intersect", -5.945420608606575),
                                    ("Rosh Hashanahyear (latent)", -5.6577385361547945),
                                    ("Dhanterasyear (latent)", -6.35088571671474),
                                    ("Tu BiShvatyear (latent)", -6.35088571671474),
                                    ("<day-of-month> (ordinal)December", -5.6577385361547945),
                                    ("Holiyear (latent)", -5.6577385361547945),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.35088571671474),
                                    ("Holika Dahanyear (latent)", -5.6577385361547945),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.35088571671474),
                                    ("dayminute", -3.4331149846304605),
                                    ("Mawlidyear (latent)", -6.35088571671474),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.945420608606575),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.35088571671474),
                                    ("Jumu'atul-Widayear (latent)", -5.434594984840585),
                                    ("minuteday", -2.522244320225645),
                                    ("absorption of , after named dayintersect", -6.35088571671474),
                                    ("intersectyear (latent)", -6.35088571671474),
                                    ("Orthodox Easter Sundayyear (latent)", -6.35088571671474),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.35088571671474),
                                    ("<ordinal> <cycle> of <time>year (latent)", -6.35088571671474),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.35088571671474),
                                    ("Boss's Dayyear (latent)", -5.945420608606575),
                                    ("Global Youth Service Dayyear (latent)", -6.35088571671474),
                                    ("Dhanterasin|during <named-month>|year", -6.35088571671474),
                                    ("Tisha B'Avyear (latent)", -6.35088571671474),
                                    ("Isra and Mi'rajyear (latent)", -5.434594984840585),
                                    ("at <time-of-day>on <day>", -5.25227342804663),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.35088571671474),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.6577385361547945),
                                    ("Christmasyear (latent)", -5.945420608606575),
                                    ("Naraka Chaturdashiyear (latent)", -5.945420608606575),
                                    ("Thai Pongalin|during <named-month>|year", -6.35088571671474),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.35088571671474),
                                    ("dayweek", -6.35088571671474),
                                    ("Easter Sundayyear (latent)", -5.6577385361547945),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.741447804280639),
                                    ("weekyear", -5.25227342804663),
                                    ("King's Dayyear (latent)", -4.846808319938465),
                                    ("hh:mmin|during the <part-of-day>", -5.6577385361547945),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.945420608606575),
                                    ("Hanukkahyear (latent)", -5.6577385361547945),
                                    ("February<time> <part-of-day>", -6.35088571671474),
                                    ("National Grandparents Dayyear (latent)", -6.35088571671474),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.35088571671474),
                                    ("Great Lentyear (latent)", -6.35088571671474),
                                    ("tomorrowat <time-of-day>", -5.6577385361547945),
                                    ("hhmm (latent)in|during the <part-of-day>", -6.35088571671474),
                                    ("Labor Dayyear (latent)", -6.35088571671474),
                                    ("Vaisakhiyear (latent)", -5.6577385361547945),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.35088571671474),
                                    ("last <cycle> of <time>year (latent)", -5.6577385361547945),
                                    ("at <time-of-day>tomorrow", -5.945420608606575),
                                    ("tomorrow<time-of-day> am|pm", -6.35088571671474),
                                    ("President's Dayyear (latent)", -6.35088571671474),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.35088571671474),
                                    ("Diwaliyear (latent)", -6.35088571671474),
                                    ("between <time> and <time>on <day>", -4.741447804280639),
                                    ("Black Fridayyear (latent)", -5.945420608606575),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.35088571671474),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.35088571671474),
                                    ("Chhathyear (latent)", -5.945420608606575),
                                    ("Vasant Panchamiyear (latent)", -6.35088571671474),
                                    ("Tax Dayyear (latent)", -5.434594984840585),
                                    ("Rabindra Jayantiyear (latent)", -5.098122748219372),
                                    ("St Patrick's Dayyear (latent)", -6.35088571671474),
                                    ("Thursday<time> (timezone)", -6.35088571671474),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.35088571671474),
                                    ("<datetime> - <datetime> (interval)July", -5.945420608606575),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.945420608606575),
                                    ("Februaryintersect", -6.35088571671474),
                                    ("Mother's Dayyear (latent)", -6.35088571671474),
                                    ("Simchat Torahyear (latent)", -6.35088571671474),
                                    ("minuteyear", -6.35088571671474)],
                               n = 438},
                   koData =
                     ClassData{prior = -0.9827358312823078, unseen = -6.678342114654332,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.2758860795849802),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.983936280687191),
                                    ("<day-of-month> (ordinal)August", -5.983936280687191),
                                    ("dayhour", -3.3097876312606616),
                                    ("<time> timezoneyear (latent)", -5.983936280687191),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.067645548813036),
                                    ("Tuesdayfrom|since|after <time>", -5.983936280687191),
                                    ("daymonth", -3.49902963089919),
                                    ("monthyear", -4.731173312191823),
                                    ("<time-of-day> am|pmyear (latent)", -5.290789100127245),
                                    ("Thai Pongalyear (latent)", -5.290789100127245),
                                    ("intersecthh:mm", -5.983936280687191),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.578471172579026),
                                    ("<day-of-month> (ordinal)Wednesday", -5.983936280687191),
                                    ("houryear", -4.5976419195673),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.983936280687191),
                                    ("<day-of-month> (ordinal)October", -5.983936280687191),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.290789100127245),
                                    ("<time-of-day> am|pmintersect", -4.731173312191823),
                                    ("Octoberyear (latent)", -5.983936280687191),
                                    ("until <time>on <day>", -5.290789100127245),
                                    ("time-of-day (latent)intersect", -5.983936280687191),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.290789100127245),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.983936280687191),
                                    ("hh:mmon <day>", -3.541589245317986),
                                    ("absorption of , after named dayJuly", -5.578471172579026),
                                    ("from|since|after <time>July", -5.578471172579026),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.067645548813036),
                                    ("Clean Mondayyear (latent)", -5.983936280687191),
                                    ("monthhour", -5.983936280687191),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.578471172579026),
                                    ("hourmonth", -4.112134103785599),
                                    ("todayat <time-of-day>", -5.983936280687191),
                                    ("from|since|after <time>December", -5.983936280687191),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.983936280687191),
                                    ("<time-of-day> am|pmon <day>", -4.731173312191823),
                                    ("Mondayyear (latent)", -4.885323992019081),
                                    ("dayday", -4.5976419195673),
                                    ("mm/ddat <time-of-day>", -5.578471172579026),
                                    ("on <day>September", -5.578471172579026),
                                    ("time-of-day (latent)September", -5.578471172579026),
                                    ("hourhour", -5.983936280687191),
                                    ("time-of-day (latent)on <day>", -3.541589245317986),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.578471172579026),
                                    ("dayyear", -2.9882040071331994),
                                    ("Thursdaymm/dd", -5.983936280687191),
                                    ("New Year's Dayyear (latent)", -5.067645548813036),
                                    ("Thursdayfrom|since|after <time>", -4.2791881884487655),
                                    ("Thursdayat <time-of-day>", -4.37449836825309),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.983936280687191),
                                    ("Aprilyear (latent)", -5.983936280687191),
                                    ("the <day-of-month> (ordinal)July", -5.983936280687191),
                                    ("the <day-of-month> (number)July", -5.983936280687191),
                                    ("monthminute", -5.983936280687191),
                                    ("<time-of-day> am|pmtomorrow", -5.983936280687191),
                                    ("Thursdayhh:mm", -5.067645548813036),
                                    ("<day-of-month> (ordinal)Tuesday", -5.578471172579026),
                                    ("minutemonth", -4.112134103785599),
                                    ("minutehour", -5.983936280687191),
                                    ("Augustyear (latent)", -5.578471172579026),
                                    ("week-endin|during <named-month>|year", -5.983936280687191),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.578471172579026),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.983936280687191),
                                    ("Sundayyear (latent)", -5.067645548813036),
                                    ("Christmasat <time-of-day>", -5.983936280687191),
                                    ("from|since|after <time>year (latent)", -4.885323992019081),
                                    ("<duration> after|before|from <time>December",
                                     -5.983936280687191),
                                    ("yesterday<time-of-day> am|pm", -5.983936280687191),
                                    ("<day-of-month> (ordinal)July", -5.290789100127245),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.983936280687191),
                                    ("mm/ddyear (latent)", -5.983936280687191),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.983936280687191),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.983936280687191),
                                    ("at <time-of-day>intersect", -5.578471172579026),
                                    ("hh:mmyear (latent)", -3.9044947390073546),
                                    ("Holiyear (latent)", -5.983936280687191),
                                    ("until <time><time-of-day> am|pm", -5.983936280687191),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.983936280687191),
                                    ("dayminute", -3.4189869232256536),
                                    ("yyyy-mm-ddhh:mm", -5.578471172579026),
                                    ("intersectSeptember", -4.479858883910916),
                                    ("minuteday", -2.74525782852281),
                                    ("absorption of , after named dayintersect",
                                     -5.983936280687191),
                                    ("intersectyear (latent)", -5.983936280687191),
                                    ("Februaryin|during the <part-of-day>", -5.983936280687191),
                                    ("time-of-day (latent)July", -5.290789100127245),
                                    ("Saturdayyear (latent)", -5.983936280687191),
                                    ("at <time-of-day>on <day>", -5.578471172579026),
                                    ("absorption of , after named daySeptember",
                                     -5.067645548813036),
                                    ("Naraka Chaturdashiyear (latent)", -5.983936280687191),
                                    ("from|since|after <time>on <day>", -5.067645548813036),
                                    ("dayweek", -5.983936280687191),
                                    ("Easter Sundayyear (latent)", -5.578471172579026),
                                    ("Thursday<time-of-day> am|pm", -4.731173312191823),
                                    ("weekyear", -5.578471172579026),
                                    ("time-of-day (latent)Thursday", -5.578471172579026),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.983936280687191),
                                    ("<day-of-month> (ordinal)April", -5.983936280687191),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.578471172579026),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.290789100127245),
                                    ("Sundayfrom|since|after <time>", -5.983936280687191),
                                    ("absorption of , after named dayFebruary", -5.067645548813036),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.983936280687191),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.983936280687191),
                                    ("tomorrowat <time-of-day>", -5.983936280687191),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.578471172579026),
                                    ("last <cycle> of <time>year (latent)", -5.578471172579026),
                                    ("tomorrow<time-of-day> am|pm", -5.983936280687191),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.290789100127245),
                                    ("Diwaliyear (latent)", -5.578471172579026),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.983936280687191),
                                    ("Fridayyear (latent)", -5.578471172579026),
                                    ("time-of-day (latent)April", -5.983936280687191),
                                    ("minuteyear", -3.786711703350971)],
                               n = 262}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1590646946296874, unseen = -5.337538079701318,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -2.941388520629334e-2),
                                    ("intersect 2 numbers", -3.9464244321454784)],
                               n = 203},
                   koData =
                     ClassData{prior = -1.916922612182061, unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.5596157879354228, unseen = -5.236441962829949,
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                     -4.537961436294641),
                                    ("dayhour", -4.132496328186477),
                                    ("daymonth", -2.1865861791311634),
                                    ...
                                    ("<part-of-day> of <time>February", -4.537961436294641),
                                    ("Saturday<time-of-day> am|pm", -4.537961436294641),
                                    ("Martin Luther King's Daythis|last|next <cycle>",
                                     -4.132496328186477),
                                    ("hourmonth", -4.537961436294641),
                                    ("Fridayintersect by \",\", \"of\", \"from\" for year",
                                     -4.537961436294641),
                                    ("dayday", -2.66615925939305),
                                    ("the <day-of-month> (ordinal)February", -4.132496328186477),
                                    ("WednesdayOctober", -4.537961436294641),
                                    ("Wednesdaythis|last|next <cycle>", -4.132496328186477),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.6216707044204863),
                                    ("dayyear", -3.2851984677992734),
                                    ("Saturday<named-month> <day-of-month> (non ordinal)",
                                     -4.537961436294641),
                                    ("Thursdayhh:mm", -4.132496328186477),
                                    ("Thanksgiving Daythis|last|next <cycle>", -4.537961436294641),
                                    ("Memorial Daythis|last|next <cycle>", -4.537961436294641),
                                    ("TuesdayOctober", -4.537961436294641),
                                    ("the <day-of-month> (ordinal)March", -4.537961436294641),
                                    ("Mondaythis|last|next <cycle>", -4.537961436294641),
                                    ("Fridayintersect", -4.537961436294641),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.132496328186477),
                                    ("intersectOctober", -4.132496328186477),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.6216707044204863),
                                    ("Tuesdaythis|last|next <cycle>", -4.537961436294641),
                                    ("Sunday<named-month> <day-of-month> (non ordinal)",
                                     -4.537961436294641),
                                    ("dayminute", -2.928523523860541),
                                    ("minuteday", -3.6216707044204863),
                                    ("this|last|next <cycle>Sunday", -4.537961436294641),
                                    ("Sundaythis|last|next <cycle>", -4.537961436294641),
                                    ("on <day><time-of-day> am|pm", -4.537961436294641),
                                    ("intersectintersect", -4.537961436294641),
                                    ("weekday", -4.537961436294641),
                                    ("dayweek", -3.4393491476265314),
                                    ("Monday<named-month> <day-of-month> (non ordinal)",
                                     -4.132496328186477),
                                    ("<datetime> - <datetime> (interval)July", -3.6216707044204863),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -4.132496328186477)],
                               n = 60},
                   koData =
                     ClassData{prior = -0.8472978603872037, unseen = -5.062595033026967,
                               likelihoods =
                                 HashMap.fromList
                                   [("week-endJuly", -4.363098624788362),
                                    ("week-endOctober", -3.6699514442284173),
                                    ("daymonth", -1.8373699804801074),
                                    ("TuesdaySeptember", -4.363098624788362),
                                    ("Wednesdayintersect", -4.363098624788362),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -3.264486336120253),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -4.363098624788362),
                                    ("from|since|after <time>July", -3.9576335166801986),
                                    ("hourmonth", -2.4171884757330493),
                                    ("Fridaythis|last|next <cycle>", -4.363098624788362),
                                    ("SundayFebruary", -4.363098624788362),
                                    ("on <day>September", -3.9576335166801986),
                                    ("WednesdayOctober", -4.363098624788362),
                                    ("week-endintersect", -4.363098624788362),
                                    ("dayyear", -4.363098624788362),
                                    ("FridayJuly", -3.9576335166801986),
                                    ("FridaySeptember", -4.363098624788362),
                                    ("the <day-of-month> (ordinal)July", -3.4468078929142076),
                                    ("WednesdayFebruary", -4.363098624788362),
                                    ("minutemonth", -3.1103356562929947),
                                    ("SundayMarch", -4.363098624788362),
                                    ("MondayFebruary", -3.9576335166801986),
                                    ("Fridayintersect", -4.363098624788362),
                                    ("intersectOctober", -4.363098624788362),
                                    ("dayminute", -4.363098624788362),
                                    ("SaturdaySeptember", -4.363098624788362),
                                    ("intersectSeptember", -3.264486336120253),
                                    ("MondayMarch", -4.363098624788362),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -4.363098624788362),
                                    ("Tuesdayintersect", -4.363098624788362),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -4.363098624788362),
                                    ("<datetime> - <datetime> (interval)July", -4.363098624788362),
                                    ("Sundayintersect", -4.363098624788362)],
                               n = 45}}),
       ("last <time>",
        Classifier{okData =
