...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6058594459618136, unseen = -5.802118375377063,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 329},
                   koData =
                     ClassData{prior = -0.7887890903391153, unseen = -5.62040086571715,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45145022134998775,
                               unseen = -6.810142450115136,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.115892125483034),
                                    ("Father's Dayyear (latent)", -6.115892125483034),
                                    ("Ramadanyear (latent)", -6.115892125483034),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.863129156987666),
                                    ("Military Spouse Dayyear (latent)", -6.115892125483034),
                                    ("Bhai Doojyear (latent)", -6.115892125483034),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.863129156987666),
                                    ("hourday", -4.411144033244609),
                                    ("dayhour", -3.2536912445535657),
                                    ("Martin Luther King's Dayyear (latent)", -5.71042701737487),
                                    ("Shemini Atzeretyear (latent)", -6.115892125483034),
                                    ("daymonth", -5.199601393608879),
                                    ("monthday", -5.71042701737487),
                                    ("monthyear", -4.324132656254979),
                                    ("Yom Ha'atzmautyear (latent)", -6.115892125483034),
                                    ("Vijayadashamiyear (latent)", -6.115892125483034),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -4.7295977643631435),
                                    ("Thanksgiving Dayyear (latent)", -5.017279836814924),
                                    ("Thai Pongalyear (latent)", -5.422744944923089),
                                    ("Thiru Onamyear (latent)", -5.422744944923089),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.115892125483034),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.115892125483034),
                                    ("houryear", -5.422744944923089),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.115892125483034),
                                    ("Christmas<time-of-day> am|pm", -6.115892125483034),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.115892125483034),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.422744944923089),
                                    ("<time-of-day> am|pmintersect", -4.863129156987666),
                                    ("Earth Houryear (latent)", -6.115892125483034),
                                    ("Octoberyear (latent)", -4.61181472870676),
                                    ("intersect<time-of-day> am|pm", -6.115892125483034),
                                    ("Mattu Pongalyear (latent)", -6.115892125483034),
                                    ("Shavuotyear (latent)", -6.115892125483034),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.115892125483034),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.115892125483034),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.71042701737487),
                                    ("Marchyear (latent)", -6.115892125483034),
                                    ("Sukkotyear (latent)", -5.71042701737487),
                                    ...
                                    ("Thursday<time> timezone", -4.169981976427721),
                                    ...
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.115892125483034),
                                    ("yyyy-mm-ddhh:mm:ss", -5.71042701737487),
                                    ("Tax Daythis|last|next <cycle>", -6.115892125483034),
                                    ("dayday", -4.100989104940769),
                                    ("<time> <part-of-day>at <time-of-day>", -6.115892125483034),
                                    ("mm/ddat <time-of-day>", -6.115892125483034),
                                    ("tonightat <time-of-day>", -6.115892125483034),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.422744944923089),
                                    ("today<time-of-day> am|pm", -6.115892125483034),
                                    ("Februarythe <day-of-month> (ordinal)", -5.71042701737487),
                                    ("at <time-of-day><time> <part-of-day>", -6.115892125483034),
                                    ("mm/dd<time-of-day> am|pm", -6.115892125483034),
                                    ("hourhour", -4.863129156987666),
                                    ("<time-of-day> am|pmon <date>", -4.100989104940769),
                                    ("Navaratriin|during <named-month>|year", -6.115892125483034),
                                    ("Wednesdaythis|last|next <cycle>", -6.115892125483034),
                                    ("Lentyear (latent)", -6.115892125483034),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.61181472870676),
                                    ("Boghiyear (latent)", -6.115892125483034),
                                    ("dayyear", -1.8890583802148544),
                                    ("Thursdayfrom|since|after <time>", -5.71042701737487),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.115892125483034),
                                    ("Thursdayat <time-of-day>", -5.422744944923089),
                                    ("Islamic New Yearyear (latent)", -5.71042701737487),
                                    ("Laylat al-Qadryear (latent)", -5.199601393608879),
                                    ("Shrove Tuesdayyear (latent)", -6.115892125483034),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.422744944923089),
                                    ("<time-of-day> am|pmtomorrow", -5.422744944923089),
                                    ("Yom Kippuryear (latent)", -6.115892125483034),
                                    ("<part-of-day> of <time>year (latent)", -6.115892125483034),
                                    ("minutehour", -5.199601393608879),
                                    ("Kaanum Pongalyear (latent)", -5.71042701737487),
                                    ("Maha Saptamiyear (latent)", -6.115892125483034),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.71042701737487),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.411144033244609),
                                    ("for <duration> from <time>December", -6.115892125483034),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.115892125483034),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.199601393608879),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.71042701737487),
                                    ("Pentecostyear (latent)", -6.115892125483034),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.199601393608879),
                                    ("Eid al-Fitryear (latent)", -6.115892125483034),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.115892125483034),
                                    ("Mondayin|during the <part-of-day>", -6.115892125483034),
                                    ("Chhathin|during <named-month>|year", -6.115892125483034),
                                    ("Diwaliin|during <named-month>|year", -6.115892125483034),
                                    ("Raksha Bandhanyear (latent)", -6.115892125483034),
                                    ("daysecond", -5.71042701737487),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.71042701737487),
                                    ("Emancipation Dayyear (latent)", -5.422744944923089),
                                    ("Ashurayear (latent)", -6.115892125483034),
                                    ("Tuesdayin|during <named-month>|year", -6.115892125483034),
                                    ("Chinese New Yearyear (latent)", -6.115892125483034),
                                    ("Lag BaOmeryear (latent)", -6.115892125483034),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.115892125483034),
                                    ("Eid al-Adhayear (latent)", -5.199601393608879),
                                    ("intersectin|during the <part-of-day>", -6.115892125483034),
                                    ("Palm Sundayyear (latent)", -6.115892125483034),
                                    ("Christmasat <time-of-day>", -6.115892125483034),
                                    ("Passoveryear (latent)", -6.115892125483034),
                                    ("Lazarus Saturdayyear (latent)", -6.115892125483034),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.115892125483034),
                                    ("Cyber Mondayyear (latent)", -5.71042701737487),
                                    ("Yom HaShoahyear (latent)", -5.71042701737487),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.71042701737487),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.115892125483034),
                                    ("Septemberyear (latent)", -5.71042701737487),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.863129156987666),
                                    ("Halloweenyear (latent)", -6.115892125483034),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.422744944923089),
                                    ("Dhanterasyear (latent)", -6.115892125483034),
                                    ("Tu BiShvatyear (latent)", -6.115892125483034),
                                    ("Holiyear (latent)", -5.422744944923089),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.115892125483034),
                                    ("Holika Dahanyear (latent)", -5.422744944923089),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.115892125483034),
                                    ("dayminute", -3.375052101557833),
                                    ("Mawlidyear (latent)", -6.115892125483034),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.71042701737487),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.115892125483034),
                                    ("Jumu'atul-Widayear (latent)", -5.199601393608879),
                                    ("minuteday", -2.478305965756648),
                                    ("absorption of , after named dayintersect",
                                     -6.115892125483034),
                                    ("Orthodox Easter Sundayyear (latent)", -6.115892125483034),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.115892125483034),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.115892125483034),
                                    ("Boss's Dayyear (latent)", -5.71042701737487),
                                    ("Global Youth Service Dayyear (latent)", -6.115892125483034),
                                    ("Dhanterasin|during <named-month>|year", -6.115892125483034),
                                    ("Tisha B'Avyear (latent)", -6.115892125483034),
                                    ("Isra and Mi'rajyear (latent)", -5.199601393608879),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.115892125483034),
                                    ("Christmasyear (latent)", -5.71042701737487),
                                    ("Naraka Chaturdashiyear (latent)", -5.71042701737487),
                                    ("at <time-of-day>on <date>", -5.017279836814924),
                                    ("Thai Pongalin|during <named-month>|year", -6.115892125483034),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.115892125483034),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.506454213048934),
                                    ("dayweek", -6.115892125483034),
                                    ("Easter Sundayyear (latent)", -5.422744944923089),
                                    ("weekyear", -5.017279836814924),
                                    ("hh:mmin|during the <part-of-day>", -5.422744944923089),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.71042701737487),
                                    ("Hanukkahyear (latent)", -5.422744944923089),
                                    ("February<time> <part-of-day>", -6.115892125483034),
                                    ("National Grandparents Dayyear (latent)", -6.115892125483034),
                                    ("Great Lentyear (latent)", -6.115892125483034),
                                    ("tomorrowat <time-of-day>", -5.422744944923089),
                                    ("Labor Dayyear (latent)", -6.115892125483034),
                                    ("between <time> and <time>on <date>", -4.506454213048934),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.115892125483034),
                                    ("last <cycle> of <time>year (latent)", -5.422744944923089),
                                    ("at <time-of-day>tomorrow", -5.71042701737487),
                                    ("tomorrow<time-of-day> am|pm", -6.115892125483034),
                                    ("President's Dayyear (latent)", -6.115892125483034),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.115892125483034),
                                    ("Diwaliyear (latent)", -6.115892125483034),
                                    ("Black Fridayyear (latent)", -5.71042701737487),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.115892125483034),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.115892125483034),
                                    ("Chhathyear (latent)", -5.71042701737487),
                                    ("Vasant Panchamiyear (latent)", -6.115892125483034),
                                    ("Tax Dayyear (latent)", -5.199601393608879),
                                    ("Thursday<time> (timezone)", -6.115892125483034),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.115892125483034),
                                    ("Februaryintersect", -6.115892125483034),
                                    ("Mother's Dayyear (latent)", -6.115892125483034),
                                    ("Simchat Torahyear (latent)", -6.115892125483034),
                                    ("minuteyear", -6.115892125483034)],
                               n = 340},
                   koData =
                     ClassData{prior = -1.0125376798968666, unseen = -6.421622267806518,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.810557015713042),
                                    ("hourday", -4.810557015713042),
                                    ("dayhour", -3.0526990981606685),
                                    ("Tuesdayfrom|since|after <time>", -5.726847747587197),
                                    ("daymonth", -3.711944727044932),
                                    ("monthyear", -4.474084779091829),
                                    ("<time-of-day> am|pmyear (latent)", -5.321382639479033),
                                    ("Thai Pongalyear (latent)", -5.033700567027251),
                                    ("intersecthh:mm", -5.726847747587197),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.726847747587197),
                                    ("houryear", -4.810557015713042),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.726847747587197),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.033700567027251),
                                    ("<time-of-day> am|pmintersect", -4.474084779091829),
                                    ("until <time>on <date>", -5.033700567027251),
                                    ("Octoberyear (latent)", -5.726847747587197),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.033700567027251),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.726847747587197),
                                    ("absorption of , after named dayJuly", -5.321382639479033),
                                    ("from|since|after <time>July", -5.726847747587197),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.810557015713042),
                                    ("Clean Mondayyear (latent)", -5.726847747587197),
                                    ("monthhour", -5.726847747587197),
                                    ("hourmonth", -4.810557015713042),
                                    ("todayat <time-of-day>", -5.726847747587197),
                                    ("from|since|after <time>December", -5.726847747587197),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.726847747587197),
                                    ("Mondayyear (latent)", -4.628235458919088),
                                    ("dayday", -5.321382639479033),
                                    ("mm/ddat <time-of-day>", -5.321382639479033),
                                    ("<time-of-day> am|pmon <date>", -4.474084779091829),
                                    ("dayyear", -2.7824087684207566),
                                    ("Thursdaymm/dd", -5.726847747587197),
                                    ("New Year's Dayyear (latent)", -5.321382639479033),
                                    ("Thursdayfrom|since|after <time>", -4.022099655348772),
                                    ("Thursdayat <time-of-day>", -4.117409835153096),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.726847747587197),
                                    ("Aprilyear (latent)", -5.726847747587197),
                                    ("monthminute", -5.726847747587197),
                                    ("<time-of-day> am|pmtomorrow", -5.726847747587197),
                                    ("Thursdayhh:mm", -4.810557015713042),
                                    ("minutemonth", -3.9350882783591423),
                                    ("Augustyear (latent)", -5.321382639479033),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.321382639479033),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.321382639479033),
                                    ("week-endin|during <named-month>|year", -5.726847747587197),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.321382639479033),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.726847747587197),
                                    ("Sundayyear (latent)", -4.810557015713042),
                                    ("Christmasat <time-of-day>", -5.726847747587197),
                                    ("from|since|after <time>year (latent)", -4.628235458919088),
                                    ("<duration> after|before|from <time>December",
                                     -5.726847747587197),
                                    ("yesterday<time-of-day> am|pm", -5.726847747587197),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.726847747587197),
                                    ("mm/ddyear (latent)", -5.726847747587197),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.033700567027251),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.726847747587197),
                                    ("at <time-of-day>intersect", -5.321382639479033),
                                    ("hh:mmyear (latent)", -4.628235458919088),
                                    ("Holiyear (latent)", -5.726847747587197),
                                    ("until <time><time-of-day> am|pm", -5.726847747587197),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.726847747587197),
                                    ("dayminute", -2.9542590253474157),
                                    ("yyyy-mm-ddhh:mm", -5.321382639479033),
                                    ("intersectSeptember", -4.222770350810923),
                                    ("minuteday", -2.65879481245358),
                                    ("absorption of , after named dayintersect",
                                     -5.726847747587197),
                                    ("Februaryin|during the <part-of-day>", -5.726847747587197),
                                    ("hh:mmon <date>", -3.711944727044932),
                                    ("Saturdayyear (latent)", -5.726847747587197),
                                    ("from|since|after <time>on <date>", -4.810557015713042),
                                    ("absorption of , after named daySeptember",
                                     -4.810557015713042),
                                    ("Naraka Chaturdashiyear (latent)", -5.726847747587197),
                                    ("on <date>September", -5.321382639479033),
                                    ("at <time-of-day>on <date>", -5.321382639479033),
                                    ("dayweek", -5.726847747587197),
                                    ("Easter Sundayyear (latent)", -5.321382639479033),
                                    ("Thursday<time-of-day> am|pm", -4.474084779091829),
                                    ("weekyear", -5.321382639479033),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.033700567027251),
                                    ("Sundayfrom|since|after <time>", -5.726847747587197),
                                    ("absorption of , after named dayFebruary", -4.810557015713042),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.726847747587197),
                                    ("tomorrowat <time-of-day>", -5.726847747587197),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.726847747587197),
                                    ("last <cycle> of <time>year (latent)", -5.321382639479033),
                                    ("tomorrow<time-of-day> am|pm", -5.726847747587197),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.033700567027251),
                                    ("Diwaliyear (latent)", -5.321382639479033),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.726847747587197),
                                    ("Fridayyear (latent)", -5.321382639479033),
                                    ("minuteyear", -4.474084779091829)],
                               n = 194}}),
       ("one eleven",
        Classifier{okData =
