...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5619939103403901, unseen = -6.1779441140506,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 480},
                   koData =
                     ClassData{prior = -0.8441358024165557,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4379988817683174, unseen = -7.175489713624222,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.481577129276431),
                                    ("Father's Dayyear (latent)", -6.481577129276431),
                                    ("Karva Chauthyear (latent)", -6.481577129276431),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.481577129276431),
                                    ("Maha Shivaratriyear (latent)", -6.481577129276431),
                                    ("Ramadanyear (latent)", -5.228814160781063),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.09528276815654),
                                    ("Military Spouse Dayyear (latent)", -6.481577129276431),
                                    ("Bhai Doojyear (latent)", -6.481577129276431),
                                    ("hourday", -4.466674108734166),
                                    ("dayhour", -3.5371381501099908),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.09528276815654),
                                    ("Martin Luther King's Dayyear (latent)", -6.076112021168266),
                                    ("Shemini Atzeretyear (latent)", -6.481577129276431),
                                    ("daymonth", -4.466674108734166),
                                    ("monthday", -6.076112021168266),
                                    ("monthyear", -4.689817660048376),
                                    ("Yom Ha'atzmautyear (latent)", -6.481577129276431),
                                    ("Vijayadashamiyear (latent)", -6.481577129276431),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.09528276815654),
                                    ("Thanksgiving Dayyear (latent)", -5.382964840608321),
                                    ("Thai Pongalyear (latent)", -5.788429948716486),
                                    ("Thiru Onamyear (latent)", -5.788429948716486),
                                    ("hhhmmabsorption of , after named day", -6.481577129276431),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.481577129276431),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.565286397402276),
                                    ("<day-of-month> (ordinal)Wednesday", -6.481577129276431),
                                    ("Krishna Janmashtamiyear (latent)", -6.076112021168266),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.481577129276431),
                                    ("houryear", -5.565286397402276),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.481577129276431),
                                    ("Christmas<time-of-day> am|pm", -6.481577129276431),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.481577129276431),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.788429948716486),
                                    ("intersectin|during <named-month>|year", -6.481577129276431),
                                    ("<time-of-day> am|pmintersect", -5.228814160781063),
                                    ("Earth Houryear (latent)", -6.481577129276431),
                                    ("Ganesh Chaturthiyear (latent)", -6.481577129276431),
                                    ("Octoberyear (latent)", -4.977499732500157),
                                    ("intersect<time-of-day> am|pm", -6.481577129276431),
                                    ("Mattu Pongalyear (latent)", -6.481577129276431),
                                    ("Daylight Saving Start Dayyear (latent)", -5.565286397402276),
                                    ("Shavuotyear (latent)", -6.481577129276431),
                                    ("Parsi New Yearyear (latent)", -5.565286397402276),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.481577129276431),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.481577129276431),
                                    ("todayin|within|after <duration>", -6.481577129276431),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.076112021168266),
                                    ("Marchyear (latent)", -6.481577129276431),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.076112021168266),
                                    ("Sukkotyear (latent)", -6.076112021168266),
                                    ("hhhmmintersect", -6.076112021168266),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.076112021168266),
                                    ("Daylight Saving End Dayyear (latent)", -5.565286397402276),
                                    ("Clean Mondayyear (latent)", -6.076112021168266),
                                    ("monthhour", -6.076112021168266),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.788429948716486),
                                    ("todayat <time-of-day>", -6.481577129276431),
                                    ("Thursday<time> timezone", -4.08368185647806),
                                    ("time-of-day (latent)tonight", -6.076112021168266),
                                    ("from|since|after <time>December", -6.481577129276431),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.481577129276431),
                                    ("<time-of-day> am|pmon <day>", -4.466674108734166),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.481577129276431),
                                    ("yyyy-mm-ddhh:mm:ss", -6.076112021168266),
                                    ("Tax Daythis|last|next <cycle>", -6.481577129276431),
                                    ("dayday", -3.773526928174221),
                                    ("<time> <part-of-day>at <time-of-day>", -6.481577129276431),
                                    ("mm/ddat <time-of-day>", -6.481577129276431),
                                    ("tonightat <time-of-day>", -6.481577129276431),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.788429948716486),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.481577129276431),
                                    ("today<time-of-day> am|pm", -6.481577129276431),
                                    ("Februarythe <day-of-month> (ordinal)", -6.076112021168266),
                                    ("at <time-of-day><time> <part-of-day>", -6.481577129276431),
                                    ("<day-of-month> (ordinal)intersect", -6.076112021168266),
                                    ("mm/dd<time-of-day> am|pm", -6.481577129276431),
                                    ("hourhour", -4.402135587596595),
                                    ("Mahavir Jayantiyear (latent)", -6.076112021168266),
                                    ("Navaratriin|during <named-month>|year", -6.481577129276431),
                                    ("Wednesdaythis|last|next <cycle>", -6.481577129276431),
                                    ("Lentyear (latent)", -6.481577129276431),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.609774952374839),
                                    ("Boghiyear (latent)", -6.481577129276431),
                                    ("dayyear", -1.7675525383762576),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.481577129276431),
                                    ("Thursdayfrom|since|after <time>", -6.076112021168266),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.481577129276431),
                                    ("Thursdayat <time-of-day>", -5.788429948716486),
                                    ("Islamic New Yearyear (latent)", -6.076112021168266),
                                    ("Laylat al-Qadryear (latent)", -5.565286397402276),
                                    ("Shrove Tuesdayyear (latent)", -6.481577129276431),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.788429948716486),
                                    ("<time-of-day> am|pmtomorrow", -5.788429948716486),
                                    ("Yom Kippuryear (latent)", -6.481577129276431),
                                    ("<day-of-month> (ordinal)Tuesday", -6.076112021168266),
                                    ("<part-of-day> of <time>year (latent)", -6.481577129276431),
                                    ("minutehour", -5.228814160781063),
                                    ("Kaanum Pongalyear (latent)", -6.076112021168266),
                                    ("Maha Saptamiyear (latent)", -6.481577129276431),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.076112021168266),
                                    ("time-of-day (latent)tomorrow", -5.565286397402276),
                                    ("part of daysat <time-of-day>", -6.076112021168266),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.466674108734166),
                                    ("for <duration> from <time>December", -6.481577129276431),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.481577129276431),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.228814160781063),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.228814160781063),
                                    ("time-of-day (latent)this <part-of-day>", -6.481577129276431),
                                    ("Pentecostyear (latent)", -6.481577129276431),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.228814160781063),
                                    ("<day-of-month> (ordinal)February", -6.481577129276431),
                                    ("Eid al-Fitryear (latent)", -5.09528276815654),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.481577129276431),
                                    ("Mondayin|during the <part-of-day>", -6.481577129276431),
                                    ("Chhathin|during <named-month>|year", -6.481577129276431),
                                    ("Diwaliin|during <named-month>|year", -6.481577129276431),
                                    ("Vaisakhiin|during <named-month>|year", -6.481577129276431),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.228814160781063),
                                    ("Raksha Bandhanyear (latent)", -6.481577129276431),
                                    ("daysecond", -6.076112021168266),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.076112021168266),
                                    ("Emancipation Dayyear (latent)", -5.788429948716486),
                                    ("Ratha-Yatrayear (latent)", -6.481577129276431),
                                    ("Ashurayear (latent)", -6.481577129276431),
                                    ("Tuesdayin|during <named-month>|year", -6.481577129276431),
                                    ("Chinese New Yearyear (latent)", -6.481577129276431),
                                    ("tomorrowintersect", -6.481577129276431),
                                    ("Lag BaOmeryear (latent)", -6.481577129276431),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.481577129276431),
                                    ("Eid al-Adhayear (latent)", -4.34151096578016),
                                    ("intersectin|during the <part-of-day>", -6.481577129276431),
                                    ("Palm Sundayyear (latent)", -6.481577129276431),
                                    ("Christmasat <time-of-day>", -6.481577129276431),
                                    ("Passoveryear (latent)", -6.481577129276431),
                                    ("Lazarus Saturdayyear (latent)", -6.481577129276431),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.481577129276431),
                                    ("Cyber Mondayyear (latent)", -6.076112021168266),
                                    ("hhhmmon <day>", -5.565286397402276),
                                    ("Yom HaShoahyear (latent)", -6.076112021168266),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.076112021168266),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.481577129276431),
                                    ("Septemberyear (latent)", -6.076112021168266),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.977499732500157),
                                    ("Halloweenyear (latent)", -6.481577129276431),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.481577129276431),
                                    ("at <time-of-day>intersect", -5.565286397402276),
                                    ("Rosh Hashanahyear (latent)", -5.788429948716486),
                                    ("Dhanterasyear (latent)", -6.481577129276431),
                                    ("Tu BiShvatyear (latent)", -6.481577129276431),
                                    ("<day-of-month> (ordinal)December", -5.788429948716486),
                                    ("Holiyear (latent)", -5.788429948716486),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.481577129276431),
                                    ("Holika Dahanyear (latent)", -5.788429948716486),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.076112021168266),
                                    ("dayminute", -3.131673042001826),
                                    ("Mawlidyear (latent)", -6.481577129276431),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.076112021168266),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.481577129276431),
                                    ("Jumu'atul-Widayear (latent)", -5.565286397402276),
                                    ("minuteday", -2.7439075109930626),
                                    ("absorption of , after named dayintersect",
                                     -5.788429948716486),
                                    ("intersectyear (latent)", -6.481577129276431),
                                    ("Orthodox Easter Sundayyear (latent)", -6.481577129276431),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.481577129276431),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.481577129276431),
                                    ("intersecthhhmm", -6.076112021168266),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.481577129276431),
                                    ("Boss's Dayyear (latent)", -6.076112021168266),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.481577129276431),
                                    ("Global Youth Service Dayyear (latent)", -6.481577129276431),
                                    ("Dhanterasin|during <named-month>|year", -6.481577129276431),
                                    ("Tisha B'Avyear (latent)", -6.481577129276431),
                                    ("Isra and Mi'rajyear (latent)", -5.565286397402276),
                                    ("at <time-of-day>on <day>", -4.8721392168423305),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.076112021168266),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.788429948716486),
                                    ("Christmasyear (latent)", -6.076112021168266),
                                    ("Naraka Chaturdashiyear (latent)", -6.076112021168266),
                                    ("Thai Pongalin|during <named-month>|year", -6.481577129276431),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.481577129276431),
                                    ("dayweek", -6.481577129276431),
                                    ("Easter Sundayyear (latent)", -5.788429948716486),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.076112021168266),
                                    ("weekyear", -5.382964840608321),
                                    ("King's Dayyear (latent)", -4.977499732500157),
                                    ("hh:mmin|during the <part-of-day>", -5.565286397402276),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.076112021168266),
                                    ("Hanukkahyear (latent)", -5.788429948716486),
                                    ("February<time> <part-of-day>", -6.481577129276431),
                                    ("National Grandparents Dayyear (latent)", -6.481577129276431),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.481577129276431),
                                    ("Great Lentyear (latent)", -6.481577129276431),
                                    ("tomorrowat <time-of-day>", -5.788429948716486),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.481577129276431),
                                    ("Labor Dayyear (latent)", -6.481577129276431),
                                    ("Ugadiyear (latent)", -5.09528276815654),
                                    ("Vaisakhiyear (latent)", -5.788429948716486),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.788429948716486),
                                    ("last <cycle> of <time>year (latent)", -5.788429948716486),
                                    ("at <time-of-day>tomorrow", -6.076112021168266),
                                    ("tomorrow<time-of-day> am|pm", -6.481577129276431),
                                    ("President's Dayyear (latent)", -6.481577129276431),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.481577129276431),
                                    ("Diwaliyear (latent)", -6.481577129276431),
                                    ("between <time> and <time>on <day>", -6.076112021168266),
                                    ("Black Fridayyear (latent)", -6.076112021168266),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.481577129276431),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.481577129276431),
                                    ("Chhathyear (latent)", -6.076112021168266),
                                    ("Vasant Panchamiyear (latent)", -6.481577129276431),
                                    ("Tax Dayyear (latent)", -5.565286397402276),
                                    ("Rabindra Jayantiyear (latent)", -5.228814160781063),
                                    ("St Patrick's Dayyear (latent)", -6.481577129276431),
                                    ("Thursday<time> (timezone)", -6.481577129276431),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.481577129276431),
                                    ("Pargat Diwasyear (latent)", -5.228814160781063),
                                    ("<datetime> - <datetime> (interval)July", -6.076112021168266),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.788429948716486),
                                    ("Februaryintersect", -6.481577129276431),
                                    ("Mother's Dayyear (latent)", -6.481577129276431),
                                    ("Simchat Torahyear (latent)", -6.481577129276431),
                                    ("minuteyear", -6.481577129276431)],
                               n = 504},
                   koData =
                     ClassData{prior = -1.0365576436523476, unseen = -6.748759547491679,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.550361949493096),
                                    ("hourday", -3.6565440734709997),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.05443934626937),
                                    ("<day-of-month> (ordinal)August", -6.05443934626937),
                                    ("dayhour", -3.3802906968428417),
                                    ("<time> timezoneyear (latent)", -5.3612921657094255),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.138148614395216),
                                    ("Tuesdayfrom|since|after <time>", -5.3612921657094255),
                                    ("daymonth", -3.3802906968428417),
                                    ("monthyear", -4.801676377774002),
                                    ("<time-of-day> am|pmyear (latent)", -5.3612921657094255),
                                    ("Thai Pongalyear (latent)", -5.3612921657094255),
                                    ("intersecthh:mm", -6.05443934626937),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.648974238161206),
                                    ("<day-of-month> (ordinal)Wednesday", -6.05443934626937),
                                    ("houryear", -4.66814498514948),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.05443934626937),
                                    ("<day-of-month> (ordinal)October", -6.05443934626937),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.3612921657094255),
                                    ("hournograin", -4.801676377774002),
                                    ("<time-of-day> am|pmintersect", -4.801676377774002),
                                    ("Octoberyear (latent)", -6.05443934626937),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.648974238161206),
                                    ("until <time>on <day>", -5.3612921657094255),
                                    ("time-of-day (latent)intersect", -5.3612921657094255),
                                    ("todayin <number> (implicit minutes)", -6.05443934626937),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.3612921657094255),
                                    ("about|exactly <time-of-day>year (latent)", -6.05443934626937),
                                    ("hh:mmon <day>", -4.801676377774002),
                                    ("hhhmmintersect", -5.648974238161206),
                                    ("absorption of , after named dayJuly", -5.138148614395216),
                                    ("from|since|after <time>July", -5.648974238161206),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.138148614395216),
                                    ("Clean Mondayyear (latent)", -6.05443934626937),
                                    ("monthhour", -6.05443934626937),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.648974238161206),
                                    ("hourmonth", -4.182637169367779),
                                    ("todayat <time-of-day>", -6.05443934626937),
                                    ("hhhmmyear (latent)", -4.801676377774002),
                                    ("from|since|after <time>December", -6.05443934626937),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.05443934626937),
                                    ("<time-of-day> am|pmon <day>", -4.801676377774002),
                                    ("Mondayyear (latent)", -4.955827057601261),
                                    ("dayday", -4.66814498514948),
                                    ("mm/ddat <time-of-day>", -5.648974238161206),
                                    ("on <day>September", -5.3612921657094255),
                                    ("time-of-day (latent)September", -5.648974238161206),
                                    ("hourhour", -5.648974238161206),
                                    ("time-of-day (latent)on <day>", -4.550361949493096),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.648974238161206),
                                    ("dayyear", -3.0587070727153796),
                                    ("Thursdaymm/dd", -6.05443934626937),
                                    ("New Year's Dayyear (latent)", -5.138148614395216),
                                    ("time-of-day (latent)Sunday", -5.648974238161206),
                                    ("Thursdayfrom|since|after <time>", -4.349691254030945),
                                    ("Thursdayat <time-of-day>", -4.44500143383527),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.05443934626937),
                                    ("Aprilyear (latent)", -6.05443934626937),
                                    ("the <day-of-month> (ordinal)July", -6.05443934626937),
                                    ("the <day-of-month> (number)July", -6.05443934626937),
                                    ("monthminute", -6.05443934626937),
                                    ("<time-of-day> am|pmtomorrow", -6.05443934626937),
                                    ("Thursdayhh:mm", -5.138148614395216),
                                    ("<day-of-month> (ordinal)Tuesday", -5.648974238161206),
                                    ("minutemonth", -3.9143731827730996),
                                    ("time-of-day (latent)Friday", -5.648974238161206),
                                    ("minutehour", -6.05443934626937),
                                    ("Augustyear (latent)", -5.648974238161206),
                                    ("week-endin|during <named-month>|year", -6.05443934626937),
                                    ("time-of-day (latent)Tuesday", -5.648974238161206),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.648974238161206),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.05443934626937),
                                    ("Sundayyear (latent)", -5.138148614395216),
                                    ("Christmasat <time-of-day>", -6.05443934626937),
                                    ("from|since|after <time>year (latent)", -4.955827057601261),
                                    ("hhhmmon <day>", -5.138148614395216),
                                    ("yesterday<time-of-day> am|pm", -6.05443934626937),
                                    ("<day-of-month> (ordinal)July", -5.3612921657094255),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.05443934626937),
                                    ("mm/ddyear (latent)", -6.05443934626937),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.05443934626937),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.05443934626937),
                                    ("at <time-of-day>intersect", -5.138148614395216),
                                    ("hh:mmyear (latent)", -4.66814498514948),
                                    ("Holiyear (latent)", -6.05443934626937),
                                    ("until <time><time-of-day> am|pm", -6.05443934626937),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.648974238161206),
                                    ("dayminute", -3.192238465339902),
                                    ("yyyy-mm-ddhh:mm", -5.648974238161206),
                                    ("intersectfrom|since|after <time>", -5.648974238161206),
                                    ("intersectSeptember", -4.182637169367779),
                                    ("minuteday", -2.8974389251192574),
                                    ("absorption of , after named dayintersect", -6.05443934626937),
                                    ("intersectyear (latent)", -6.05443934626937),
                                    ("Februaryin|during the <part-of-day>", -6.05443934626937),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.05443934626937),
                                    ("time-of-day (latent)July", -5.3612921657094255),
                                    ("Saturdayyear (latent)", -6.05443934626937),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.05443934626937),
                                    ("at <time-of-day>on <day>", -5.138148614395216),
                                    ("absorption of , after named daySeptember",
                                     -4.801676377774002),
                                    ("Naraka Chaturdashiyear (latent)", -6.05443934626937),
                                    ("from|since|after <time>on <day>", -5.138148614395216),
                                    ("dayweek", -6.05443934626937),
                                    ("Easter Sundayyear (latent)", -5.648974238161206),
                                    ("Thursday<time-of-day> am|pm", -4.801676377774002),
                                    ("weekyear", -5.648974238161206),
                                    ("time-of-day (latent)Thursday", -5.648974238161206),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.05443934626937),
                                    ("<day-of-month> (ordinal)April", -6.05443934626937),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.648974238161206),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.3612921657094255),
                                    ("Sundayfrom|since|after <time>", -6.05443934626937),
                                    ("absorption of , after named dayFebruary", -5.138148614395216),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.648974238161206),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.05443934626937),
                                    ("tomorrowat <time-of-day>", -6.05443934626937),
                                    ("daynograin", -5.648974238161206),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.648974238161206),
                                    ("last <cycle> of <time>year (latent)", -5.648974238161206),
                                    ("tomorrow<time-of-day> am|pm", -6.05443934626937),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.3612921657094255),
                                    ("Diwaliyear (latent)", -5.648974238161206),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.05443934626937),
                                    ("Fridayyear (latent)", -5.648974238161206),
                                    ("time-of-day (latent)April", -6.05443934626937),
                                    ("minuteyear", -3.857214768933151)],
                               n = 277}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.13102826240640414,
                               ...
                               n = 250},
                   koData =
                     ClassData{prior = -2.097141118779237, unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
