...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6891067710229404, unseen = -5.521460917862246,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 248},
                   koData =
                     ClassData{prior = -0.6972039812555597,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48384622581204123, unseen = -6.61338421837956,
                               likelihoods =
                                 HashMap.fromList
                                   [("Father's Dayyear (latent)", -5.918893854273146),
                                    ("Ramadanyear (latent)", -5.918893854273146),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.666130885777778),
                                    ("Military Spouse Dayyear (latent)", -5.918893854273146),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.666130885777778),
                                    ("hourday", -4.214145762034721),
                                    ("dayhour", -3.0011231221888677),
                                    ("Martin Luther King's Dayyear (latent)", -5.5134287461649825),
                                    ("Shemini Atzeretyear (latent)", -5.918893854273146),
                                    ("daymonth", -5.225746673713201),
                                    ("monthday", -5.5134287461649825),
                                    ("monthyear", -4.309455941839047),
                                    ("Yom Ha'atzmautyear (latent)", -5.918893854273146),
                                    ("Thanksgiving Dayyear (latent)", -4.820281565605037),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.918893854273146),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.918893854273146),
                                    ("houryear", -5.5134287461649825),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.918893854273146),
                                    ("Christmas<time-of-day> am|pm", -5.918893854273146),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.918893854273146),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.225746673713201),
                                    ("<time-of-day> am|pmintersect", -4.666130885777778),
                                    ("Octoberyear (latent)", -4.666130885777778),
                                    ("intersect<time-of-day> am|pm", -5.918893854273146),
                                    ("Shavuotyear (latent)", -5.918893854273146),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.918893854273146),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.5134287461649825),
                                    ("Marchyear (latent)", -5.918893854273146),
                                    ("Sukkotyear (latent)", -5.5134287461649825),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.918893854273146),
                                    ("Clean Mondayyear (latent)", -5.5134287461649825),
                                    ("monthhour", -5.5134287461649825),
                                    ("todayat <time-of-day>", -5.918893854273146),
                                    ("Thursday<time> timezone", -4.214145762034721),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.918893854273146),
                                    ("Palm SundaySunday", -5.5134287461649825),
                                    ("dayday", -3.721669276936927),
                                    ("<time> <part-of-day>at <time-of-day>", -5.918893854273146),
                                    ("mm/ddat <time-of-day>", -5.918893854273146),
                                    ("tonightat <time-of-day>", -5.918893854273146),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.225746673713201),
                                    ("today<time-of-day> am|pm", -5.918893854273146),
                                    ("Februarythe <day-of-month> (ordinal)", -5.5134287461649825),
                                    ("at <time-of-day><time> <part-of-day>", -5.918893854273146),
                                    ("mm/dd<time-of-day> am|pm", -5.918893854273146),
                                    ("hourhour", -4.666130885777778),
                                    ("<time-of-day> am|pmon <date>", -3.903990833730882),
                                    ("Wednesdaythis|last|next <cycle>", -5.918893854273146),
                                    ("Lentyear (latent)", -5.918893854273146),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.4148164574968725),
                                    ("dayyear", -2.1932004270364938),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.918893854273146),
                                    ("Thursdayat <time-of-day>", -5.5134287461649825),
                                    ("Islamic New Yearyear (latent)", -5.5134287461649825),
                                    ("Laylat al-Qadryear (latent)", -5.002603122398991),
                                    ("Shrove Tuesdayyear (latent)", -5.918893854273146),
                                    ("<time-of-day> am|pmtomorrow", -5.225746673713201),
                                    ("Yom Kippuryear (latent)", -5.918893854273146),
                                    ("<part-of-day> of <time>year (latent)", -5.918893854273146),
                                    ("minutehour", -5.002603122398991),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.5134287461649825),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.214145762034721),
                                    ("for <duration> from <time>December", -5.918893854273146),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.918893854273146),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.002603122398991),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.5134287461649825),
                                    ("Pentecostyear (latent)", -5.918893854273146),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.002603122398991),
                                    ("Eid al-Fitryear (latent)", -5.918893854273146),
                                    ("Mondayin|during the <part-of-day>", -5.918893854273146),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.5134287461649825),
                                    ("Ashurayear (latent)", -5.918893854273146),
                                    ("Chinese New Yearyear (latent)", -5.918893854273146),
                                    ("Sundayyear (latent)", -5.918893854273146),
                                    ("Lag BaOmeryear (latent)", -5.918893854273146),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.918893854273146),
                                    ("Eid al-Adhayear (latent)", -5.002603122398991),
                                    ("intersectin|during the <part-of-day>", -5.918893854273146),
                                    ("Christmasat <time-of-day>", -5.918893854273146),
                                    ("Passoveryear (latent)", -5.918893854273146),
                                    ("Lazarus Saturdayyear (latent)", -5.918893854273146),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.918893854273146),
                                    ("Cyber Mondayyear (latent)", -5.5134287461649825),
                                    ("Yom HaShoahyear (latent)", -5.5134287461649825),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.002603122398991),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.918893854273146),
                                    ("Septemberyear (latent)", -5.5134287461649825),
                                    ("mm/ddyear (latent)", -5.918893854273146),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.666130885777778),
                                    ("Halloweenyear (latent)", -5.918893854273146),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.225746673713201),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -5.002603122398991),
                                    ("at <time-of-day>intersect", -5.5134287461649825),
                                    ("Rosh Hashanahyear (latent)", -5.918893854273146),
                                    ("Tu BiShvatyear (latent)", -5.918893854273146),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.918893854273146),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.918893854273146),
                                    ("dayminute", -3.2798365246578878),
                                    ("Mawlidyear (latent)", -5.918893854273146),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.5134287461649825),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.918893854273146),
                                    ("Jumu'atul-Widayear (latent)", -5.002603122398991),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.918893854273146),
                                    ("minuteday", -2.2813076945467605),
                                    ("absorption of , after named dayintersect",
                                     -5.918893854273146),
                                    ("intersectyear (latent)", -5.918893854273146),
                                    ("Orthodox Easter Sundayyear (latent)", -5.918893854273146),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.918893854273146),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.918893854273146),
                                    ("Boss's Dayyear (latent)", -5.5134287461649825),
                                    ("Tisha B'Avyear (latent)", -5.918893854273146),
                                    ("Isra and Mi'rajyear (latent)", -5.002603122398991),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.918893854273146),
                                    ("Christmasyear (latent)", -5.5134287461649825),
                                    ("at <time-of-day>on <date>", -4.820281565605037),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.309455941839047),
                                    ("dayweek", -5.918893854273146),
                                    ("Easter Sundayyear (latent)", -5.225746673713201),
                                    ("Thursday<time-of-day> am|pm", -5.918893854273146),
                                    ("weekyear", -5.5134287461649825),
                                    ("hh:mmin|during the <part-of-day>", -5.225746673713201),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.5134287461649825),
                                    ("Hanukkahyear (latent)", -5.918893854273146),
                                    ("February<time> <part-of-day>", -5.918893854273146),
                                    ("National Grandparents Dayyear (latent)", -5.918893854273146),
                                    ("Tuesdayin <named-month>|year", -5.918893854273146),
                                    ("Great Lentyear (latent)", -5.918893854273146),
                                    ("tomorrowat <time-of-day>", -5.225746673713201),
                                    ("Labor Dayyear (latent)", -5.918893854273146),
                                    ("between <time> and <time>on <date>", -4.309455941839047),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.225746673713201),
                                    ("last <cycle> of <time>year (latent)", -5.225746673713201),
                                    ("at <time-of-day>tomorrow", -5.5134287461649825),
                                    ("tomorrow<time-of-day> am|pm", -5.918893854273146),
                                    ("President's Dayyear (latent)", -5.918893854273146),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.918893854273146),
                                    ("Black Fridayyear (latent)", -5.5134287461649825),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.918893854273146),
                                    ("Palm Sundayintersect", -5.918893854273146),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.918893854273146),
                                    ("Februaryintersect", -5.918893854273146),
                                    ("Mother's Dayyear (latent)", -5.918893854273146),
                                    ("Simchat Torahyear (latent)", -5.918893854273146)],
                               n = 278},
                   koData =
                     ClassData{prior = -0.9581757450048993, unseen = -6.282266746896006,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.58724865840025),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.6709579265260945),
                                    ("mm/ddyear (latent)", -5.58724865840025),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.181783550292085),
