...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6911208374147129, unseen = -5.517452896464707,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 247},
                   koData =
                     ClassData{prior = -0.6951776381103273,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.485230076577027, unseen = -6.60934924316738,
                               likelihoods =
                                 HashMap.fromList
                                   [("Father's Dayyear (latent)", -5.914853444736142),
                                    ("Ramadanyear (latent)", -5.914853444736142),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.662090476240773),
                                    ("Military Spouse Dayyear (latent)", -5.914853444736142),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.662090476240773),
                                    ("hourday", -4.210105352497717),
                                    ("dayhour", -2.9970827126518627),
                                    ("Martin Luther King's Dayyear (latent)", -5.5093883366279774),
                                    ("Shemini Atzeretyear (latent)", -5.914853444736142),
                                    ("daymonth", -5.221706264176197),
                                    ("monthday", -5.5093883366279774),
                                    ("monthyear", -4.3054155323020415),
                                    ("Yom Ha'atzmautyear (latent)", -5.914853444736142),
                                    ("Thanksgiving Dayyear (latent)", -4.816241156068032),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.914853444736142),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.914853444736142),
                                    ("houryear", -5.5093883366279774),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.914853444736142),
                                    ("Christmas<time-of-day> am|pm", -5.914853444736142),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.914853444736142),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.221706264176197),
                                    ("<time-of-day> am|pmintersect", -4.662090476240773),
                                    ("Octoberyear (latent)", -4.662090476240773),
                                    ("intersect<time-of-day> am|pm", -5.914853444736142),
                                    ("Shavuotyear (latent)", -5.914853444736142),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.914853444736142),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.5093883366279774),
                                    ("Marchyear (latent)", -5.914853444736142),
                                    ("Sukkotyear (latent)", -5.5093883366279774),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.914853444736142),
                                    ("Clean Mondayyear (latent)", -5.5093883366279774),
                                    ("monthhour", -5.5093883366279774),
                                    ("todayat <time-of-day>", -5.914853444736142),
                                    ("Thursday<time> timezone", -4.210105352497717),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.914853444736142),
                                    ("Palm SundaySunday", -5.5093883366279774),
                                    ("dayday", -3.717628867399922),
                                    ("<time> <part-of-day>at <time-of-day>", -5.914853444736142),
                                    ("mm/ddat <time-of-day>", -5.914853444736142),
                                    ("tonightat <time-of-day>", -5.914853444736142),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.221706264176197),
                                    ("today<time-of-day> am|pm", -5.914853444736142),
                                    ("Februarythe <day-of-month> (ordinal)", -5.5093883366279774),
                                    ("at <time-of-day><time> <part-of-day>", -5.914853444736142),
                                    ("mm/dd<time-of-day> am|pm", -5.914853444736142),
                                    ("hourhour", -4.662090476240773),
                                    ("<time-of-day> am|pmon <date>", -3.899950424193877),
                                    ("Wednesdaythis|last|next <cycle>", -5.914853444736142),
                                    ("Lentyear (latent)", -5.914853444736142),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.410776047959867),
                                    ("dayyear", -2.2012813780318337),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.914853444736142),
                                    ("Thursdayat <time-of-day>", -5.5093883366279774),
                                    ("Islamic New Yearyear (latent)", -5.5093883366279774),
                                    ("Laylat al-Qadryear (latent)", -4.998562712861986),
                                    ("Shrove Tuesdayyear (latent)", -5.914853444736142),
                                    ("<time-of-day> am|pmtomorrow", -5.221706264176197),
                                    ("Yom Kippuryear (latent)", -5.914853444736142),
                                    ("<part-of-day> of <time>year (latent)", -5.914853444736142),
                                    ("minutehour", -4.998562712861986),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.5093883366279774),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.210105352497717),
                                    ("for <duration> from <time>December", -5.914853444736142),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.914853444736142),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.998562712861986),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.5093883366279774),
                                    ("Pentecostyear (latent)", -5.914853444736142),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.998562712861986),
                                    ("Eid al-Fitryear (latent)", -5.914853444736142),
                                    ("Mondayin|during the <part-of-day>", -5.914853444736142),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.5093883366279774),
                                    ("Ashurayear (latent)", -5.914853444736142),
                                    ("Chinese New Yearyear (latent)", -5.914853444736142),
                                    ("Sundayyear (latent)", -5.914853444736142),
                                    ("Lag BaOmeryear (latent)", -5.914853444736142),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.914853444736142),
                                    ("Eid al-Adhayear (latent)", -4.998562712861986),
                                    ("intersectin|during the <part-of-day>", -5.914853444736142),
                                    ("Christmasat <time-of-day>", -5.914853444736142),
                                    ("Passoveryear (latent)", -5.914853444736142),
                                    ("Lazarus Saturdayyear (latent)", -5.914853444736142),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.914853444736142),
                                    ("Cyber Mondayyear (latent)", -5.5093883366279774),
                                    ("Yom HaShoahyear (latent)", -5.5093883366279774),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.998562712861986),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.914853444736142),
                                    ("Septemberyear (latent)", -5.5093883366279774),
                                    ("mm/ddyear (latent)", -5.914853444736142),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.662090476240773),
                                    ("Halloweenyear (latent)", -5.914853444736142),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.221706264176197),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -4.998562712861986),
                                    ("at <time-of-day>intersect", -5.5093883366279774),
                                    ("Rosh Hashanahyear (latent)", -5.914853444736142),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.914853444736142),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.914853444736142),
                                    ("dayminute", -3.2757961151208828),
                                    ("Mawlidyear (latent)", -5.914853444736142),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.5093883366279774),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.914853444736142),
                                    ("Jumu'atul-Widayear (latent)", -4.998562712861986),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.914853444736142),
                                    ("minuteday", -2.277267285009756),
                                    ("absorption of , after named dayintersect",
                                     -5.914853444736142),
                                    ("intersectyear (latent)", -5.914853444736142),
                                    ("Orthodox Easter Sundayyear (latent)", -5.914853444736142),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.914853444736142),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.914853444736142),
                                    ("Boss's Dayyear (latent)", -5.5093883366279774),
                                    ("Tisha B'Avyear (latent)", -5.914853444736142),
                                    ("Isra and Mi'rajyear (latent)", -4.998562712861986),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.914853444736142),
                                    ("Christmasyear (latent)", -5.5093883366279774),
                                    ("at <time-of-day>on <date>", -4.816241156068032),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.3054155323020415),
                                    ("dayweek", -5.914853444736142),
                                    ("Easter Sundayyear (latent)", -5.221706264176197),
                                    ("Thursday<time-of-day> am|pm", -5.914853444736142),
                                    ("weekyear", -5.5093883366279774),
                                    ("hh:mmin|during the <part-of-day>", -5.221706264176197),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.5093883366279774),
                                    ("Hanukkahyear (latent)", -5.914853444736142),
                                    ("February<time> <part-of-day>", -5.914853444736142),
                                    ("National Grandparents Dayyear (latent)", -5.914853444736142),
                                    ("Tuesdayin <named-month>|year", -5.914853444736142),
                                    ("Great Lentyear (latent)", -5.914853444736142),
                                    ("tomorrowat <time-of-day>", -5.221706264176197),
                                    ("Labor Dayyear (latent)", -5.914853444736142),
                                    ("between <time> and <time>on <date>", -4.3054155323020415),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.221706264176197),
                                    ("last <cycle> of <time>year (latent)", -5.221706264176197),
                                    ("at <time-of-day>tomorrow", -5.5093883366279774),
                                    ("tomorrow<time-of-day> am|pm", -5.914853444736142),
                                    ("President's Dayyear (latent)", -5.914853444736142),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.914853444736142),
                                    ("Black Fridayyear (latent)", -5.5093883366279774),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.914853444736142),
                                    ("Palm Sundayintersect", -5.914853444736142),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.914853444736142),
                                    ("Februaryintersect", -5.914853444736142),
                                    ("Mother's Dayyear (latent)", -5.914853444736142),
                                    ("Simchat Torahyear (latent)", -5.914853444736142)],
                               n = 277},
                   koData =
                     ClassData{prior = -0.9559559882665866, unseen = -6.280395838960195,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.585374243605899),
                                    ("hourday", -5.585374243605899),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.585374243605899),
                                    ("dayhour", -3.1430272082366946),
                                    ("daymonth", -3.505932701926063),
                                    ("monthday", -5.179909135497735),
                                    ("monthyear", -4.332611275110531),
                                    ("<time-of-day> am|pmyear (latent)", -5.179909135497735),
                                    ("intersecthh:mm", -5.585374243605899),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.585374243605899),
                                    ("houryear", -4.669083511731744),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.585374243605899),
                                    ("until <time-of-day><time-of-day> am|pm", -5.585374243605899),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.892227063045954),
                                    ("<time-of-day> am|pmintersect", -4.332611275110531),
                                    ("Octoberyear (latent)", -5.585374243605899),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.332611275110531),
                                    ("from|since|after <time-of-day>on <date>", -4.669083511731744),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.585374243605899),
                                    ("absorption of , after named dayJuly", -5.179909135497735),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.669083511731744),
                                    ("Clean Mondayyear (latent)", -5.585374243605899),
                                    ("monthhour", -5.585374243605899),
                                    ("hourmonth", -4.892227063045954),
                                    ("todayat <time-of-day>", -5.585374243605899),
                                    ("from|since|after <time-of-day>July", -5.585374243605899),
                                    ("Mondayyear (latent)", -4.48676195493779),
                                    ("dayday", -5.179909135497735),
                                    ("mm/ddat <time-of-day>", -5.179909135497735),
                                    ("<time-of-day> am|pmon <date>", -4.332611275110531),
                                    ("dayyear", -2.752160899549683),
                                    ("Thursdaymm/dd", -5.585374243605899),
                                    ("New Year's Dayyear (latent)", -5.179909135497735),
                                    ("Thursdayat <time-of-day>", -4.332611275110531),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.585374243605899),
                                    ("Aprilyear (latent)", -5.585374243605899),
                                    ("monthminute", -5.585374243605899),
                                    ("<time-of-day> am|pmtomorrow", -5.585374243605899),
                                    ("Thursdayhh:mm", -4.669083511731744),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.585374243605899),
                                    ("minutemonth", -3.7936147743778443),
                                    ("Sundayfrom|since|after <time-of-day>", -5.585374243605899),
                                    ("week-endin <named-month>|year", -5.585374243605899),
                                    ("Augustyear (latent)", -5.179909135497735),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.179909135497735),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.179909135497735),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.585374243605899),
                                    ("Sundayyear (latent)", -4.892227063045954),
                                    ("Christmasat <time-of-day>", -5.585374243605899),
                                    ("<duration> after|before|from <time>December",
                                     -5.585374243605899),
                                    ("yesterday<time-of-day> am|pm", -5.585374243605899),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.669083511731744),
                                    ("mm/ddyear (latent)", -5.585374243605899),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.179909135497735),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.585374243605899),
                                    ("until <time-of-day>on <date>", -4.892227063045954),
                                    ("at <time-of-day>intersect", -5.179909135497735),
                                    ("hh:mmyear (latent)", -4.48676195493779),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.585374243605899),
                                    ("dayminute", -3.100467593817899),
                                    ("intersectSeptember", -4.081296846829625),
                                    ("minuteday", -2.5173213084722823),
                                    ("absorption of , after named dayintersect",
                                     -5.585374243605899),
                                    ("Februaryin|during the <part-of-day>", -5.585374243605899),
                                    ("hh:mmon <date>", -3.5704712230636346),
                                    ("Saturdayyear (latent)", -5.585374243605899),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.585374243605899),
                                    ("absorption of , after named daySeptember",
                                     -4.669083511731744),
                                    ("on <date>September", -5.179909135497735),
                                    ("at <time-of-day>on <date>", -5.179909135497735),
                                    ("in <named-month>|yearyear (latent)", -5.585374243605899),
                                    ("dayweek", -5.585374243605899),
                                    ("Easter Sundayyear (latent)", -5.179909135497735),
                                    ("Thursday<time-of-day> am|pm", -5.179909135497735),
                                    ("absorption of , after named dayFebruary", -4.669083511731744),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.585374243605899),
                                    ("tomorrowat <time-of-day>", -5.585374243605899),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.585374243605899),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.975936331171799),
                                    ("tomorrow<time-of-day> am|pm", -5.585374243605899),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.892227063045954),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.585374243605899),
                                    ("Fridayyear (latent)", -5.179909135497735),
                                    ("minuteyear", -4.332611275110531)],
                               n = 173}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.19782574332991992, unseen = -4.61512051684126,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -5.129329438755058e-2),
                                    ("intersect 2 numbers", -3.506557897319982)],
                               n = 96},
                   koData =
                     ClassData{prior = -1.717651497074333, unseen = -3.258096538021482,
                               likelihoods =
                                 HashMap.fromList
