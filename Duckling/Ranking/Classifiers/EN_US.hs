...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4836978605364613, unseen = -7.27655640271871,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.582717419986587),
                                    ("Father's Dayyear (latent)", -6.582717419986587),
                                    ("Karva Chauthyear (latent)", -6.582717419986587),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.582717419986587),
                                    ("Maha Shivaratriyear (latent)", -6.582717419986587),
                                    ("Ramadanyear (latent)", -5.329954451491219),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.196423058866697),
                                    ("Military Spouse Dayyear (latent)", -6.582717419986587),
                                    ("Bhai Doojyear (latent)", -6.582717419986587),
                                    ("hourday", -4.567814399444322),
                                    ("dayhour", -3.538194982263164),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.196423058866697),
                                    ("Martin Luther King's Dayyear (latent)", -6.177252311878423),
                                    ("Shemini Atzeretyear (latent)", -6.582717419986587),
                                    ("daymonth", -4.567814399444322),
                                    ("monthday", -6.177252311878423),
                                    ("monthyear", -4.790957950758532),
                                    ("Yom Ha'atzmautyear (latent)", -6.582717419986587),
                                    ("Orthodox Good Fridayyear (latent)", -6.177252311878423),
                                    ("Vijayadashamiyear (latent)", -6.582717419986587),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.196423058866697),
                                    ("Thanksgiving Dayyear (latent)", -5.484105131318477),
                                    ("Thai Pongalyear (latent)", -5.889570239426642),
                                    ("Thiru Onamyear (latent)", -5.889570239426642),
                                    ("hhhmmabsorption of , after named day", -6.582717419986587),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.582717419986587),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.666426688112432),
                                    ("<day-of-month> (ordinal)Wednesday", -6.582717419986587),
                                    ("Krishna Janmashtamiyear (latent)", -6.177252311878423),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.582717419986587),
                                    ("houryear", -5.666426688112432),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.582717419986587),
                                    ("Christmas<time-of-day> am|pm", -6.582717419986587),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.582717419986587),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.889570239426642),
                                    ("intersectin|during <named-month>|year", -6.582717419986587),
                                    ("<time-of-day> am|pmintersect", -5.329954451491219),
                                    ("Earth Houryear (latent)", -6.582717419986587),
                                    ("Ganesh Chaturthiyear (latent)", -6.582717419986587),
                                    ("Octoberyear (latent)", -5.078640023210313),
                                    ("intersect<time-of-day> am|pm", -6.582717419986587),
                                    ("Mattu Pongalyear (latent)", -6.582717419986587),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.582717419986587),
                                    ("Daylight Saving Start Dayyear (latent)", -5.666426688112432),
                                    ("Shavuotyear (latent)", -6.582717419986587),
                                    ("Parsi New Yearyear (latent)", -5.666426688112432),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.582717419986587),
                                    ("the <day-of-month> (ordinal)intersect by \",\", \"of\", \"from\" for year",
                                     -6.582717419986587),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.582717419986587),
                                    ("todayin|within|after <duration>", -6.582717419986587),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.177252311878423),
                                    ("Marchyear (latent)", -6.582717419986587),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.177252311878423),
                                    ("Sukkotyear (latent)", -6.177252311878423),
                                    ("hhhmmintersect", -6.177252311878423),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.177252311878423),
                                    ("Daylight Saving End Dayyear (latent)", -5.666426688112432),
                                    ("Clean Mondayyear (latent)", -6.177252311878423),
                                    ("the <day-of-month> (ordinal)Sunday", -6.582717419986587),
                                    ("monthhour", -6.177252311878423),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.666426688112432),
                                    ("todayat <time-of-day>", -6.582717419986587),
                                    ("Thursday<time> timezone", -4.184822147188217),
                                    ("tonight<time-of-day> am|pm", -6.582717419986587),
                                    ("time-of-day (latent)tonight", -6.177252311878423),
                                    ("from|since|after <time>December", -6.582717419986587),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.582717419986587),
                                    ("<time-of-day> am|pmon <day>", -4.567814399444322),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.582717419986587),
                                    ("yyyy-mm-ddhh:mm:ss", -6.177252311878423),
                                    ("Tax Daythis|last|next <cycle>", -6.582717419986587),
                                    ("dayday", -3.7495040759303713),
                                    ("<time> <part-of-day>at <time-of-day>", -6.177252311878423),
                                    ("mm/ddat <time-of-day>", -6.582717419986587),
                                    ("tonightat <time-of-day>", -5.484105131318477),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.889570239426642),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.582717419986587),
                                    ("today<time-of-day> am|pm", -6.582717419986587),
                                    ("Februarythe <day-of-month> (ordinal)", -6.177252311878423),
                                    ("at <time-of-day><time> <part-of-day>", -6.582717419986587),
                                    ("<day-of-month> (ordinal)intersect", -6.177252311878423),
                                    ("mm/dd<time-of-day> am|pm", -6.582717419986587),
                                    ("hourhour", -3.612302954416886),
                                    ("Mahavir Jayantiyear (latent)", -6.177252311878423),
                                    ("Navaratriin|during <named-month>|year", -6.582717419986587),
                                    ("Wednesdaythis|last|next <cycle>", -6.582717419986587),
                                    ("Lentyear (latent)", -6.582717419986587),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.710915243084996),
                                    ("Boghiyear (latent)", -6.582717419986587),
                                    ("dayyear", -1.8035939268750578),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.582717419986587),
                                    ("Thursdayfrom|since|after <time>", -6.177252311878423),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.582717419986587),
                                    ("Thursdayat <time-of-day>", -5.889570239426642),
                                    ("Islamic New Yearyear (latent)", -6.177252311878423),
                                    ("Laylat al-Qadryear (latent)", -5.666426688112432),
                                    ("part of days<time-of-day> am|pm", -6.582717419986587),
                                    ("Shrove Tuesdayyear (latent)", -6.582717419986587),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.889570239426642),
                                    ("hourminute", -6.177252311878423),
                                    ("<time-of-day> am|pmtomorrow", -5.666426688112432),
                                    ("Yom Kippuryear (latent)", -6.582717419986587),
                                    ("<day-of-month> (ordinal)Tuesday", -5.889570239426642),
                                    ("<part-of-day> of <time>year (latent)", -6.582717419986587),
                                    ("minutehour", -5.329954451491219),
                                    ("Kaanum Pongalyear (latent)", -6.177252311878423),
                                    ("Maha Saptamiyear (latent)", -6.582717419986587),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.889570239426642),
                                    ("time-of-day (latent)tomorrow", -5.666426688112432),
                                    ("part of daysat <time-of-day>", -4.973279507552487),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.567814399444322),
                                    ("for <duration> from <time>December", -6.582717419986587),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.582717419986587),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.329954451491219),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.329954451491219),
                                    ("time-of-day (latent)this <part-of-day>", -6.582717419986587),
                                    ("Pentecostyear (latent)", -6.582717419986587),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.329954451491219),
                                    ("<day-of-month> (ordinal)February", -6.582717419986587),
                                    ("Eid al-Fitryear (latent)", -5.196423058866697),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.582717419986587),
                                    ("Mini-Tuesday<duration> hence|ago", -6.582717419986587),
                                    ("Mondayin|during the <part-of-day>", -6.582717419986587),
                                    ("Chhathin|during <named-month>|year", -6.582717419986587),
                                    ("Diwaliin|during <named-month>|year", -6.582717419986587),
                                    ("this <part-of-day><time-of-day> am|pm", -6.582717419986587),
                                    ("Vaisakhiin|during <named-month>|year", -6.582717419986587),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.329954451491219),
                                    ("Raksha Bandhanyear (latent)", -6.582717419986587),
                                    ("daysecond", -6.177252311878423),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.177252311878423),
                                    ("Emancipation Dayyear (latent)", -5.889570239426642),
                                    ("Ratha-Yatrayear (latent)", -6.582717419986587),
                                    ("Ashurayear (latent)", -6.582717419986587),
                                    ("Tuesdayin|during <named-month>|year", -6.582717419986587),
                                    ("Chinese New Yearyear (latent)", -6.582717419986587),
                                    ("tomorrowintersect", -6.582717419986587),
                                    ("Lag BaOmeryear (latent)", -6.582717419986587),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.582717419986587),
                                    ("Eid al-Adhayear (latent)", -4.442651256490317),
                                    ("intersectin|during the <part-of-day>", -6.582717419986587),
                                    ("Palm Sundayyear (latent)", -6.582717419986587),
                                    ("Christmasat <time-of-day>", -6.582717419986587),
                                    ("Passoveryear (latent)", -6.582717419986587),
                                    ("Lazarus Saturdayyear (latent)", -6.582717419986587),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.582717419986587),
                                    ("Cyber Mondayyear (latent)", -6.177252311878423),
                                    ("hhhmmon <day>", -5.666426688112432),
                                    ("Yom HaShoahyear (latent)", -6.177252311878423),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.177252311878423),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.582717419986587),
                                    ("Septemberyear (latent)", -6.177252311878423),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.078640023210313),
                                    ("Halloweenyear (latent)", -6.582717419986587),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.889570239426642),
                                    ("Super Tuesdayyear (latent)", -5.666426688112432),
                                    ("Dhanterasyear (latent)", -6.582717419986587),
                                    ("Tu BiShvatyear (latent)", -6.582717419986587),
                                    ("<day-of-month> (ordinal)December", -5.889570239426642),
                                    ("Holiyear (latent)", -5.889570239426642),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.582717419986587),
                                    ("Holika Dahanyear (latent)", -5.889570239426642),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.177252311878423),
                                    ("dayminute", -3.2328133327119826),
                                    ("Mawlidyear (latent)", -6.582717419986587),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.177252311878423),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.582717419986587),
                                    ("Jumu'atul-Widayear (latent)", -5.666426688112432),
                                    ("minuteday", -2.833213344056216),
                                    ("absorption of , after named dayintersect",
                                     -5.889570239426642),
                                    ("intersectyear (latent)", -6.582717419986587),
                                    ("Orthodox Easter Sundayyear (latent)", -6.582717419986587),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.582717419986587),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.582717419986587),
                                    ("Mini-Tuesdayyear (latent)", -6.582717419986587),
                                    ("intersecthhhmm", -6.177252311878423),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.582717419986587),
                                    ("Boss's Dayyear (latent)", -6.177252311878423),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.582717419986587),
                                    ("Global Youth Service Dayyear (latent)", -6.582717419986587),
                                    ("Dhanterasin|during <named-month>|year", -6.582717419986587),
                                    ("Super Tuesdayin|during <named-month>|year",
                                     -6.582717419986587),
                                    ("tonight<time-of-day> o'clock", -6.582717419986587),
                                    ("Tisha B'Avyear (latent)", -6.582717419986587),
                                    ("Isra and Mi'rajyear (latent)", -5.666426688112432),
                                    ("at <time-of-day>on <day>", -4.973279507552487),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.177252311878423),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.889570239426642),
                                    ("Christmasyear (latent)", -6.177252311878423),
                                    ("Saturdayintersect", -6.582717419986587),
                                    ("Naraka Chaturdashiyear (latent)", -6.177252311878423),
                                    ("Thai Pongalin|during <named-month>|year", -6.582717419986587),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.582717419986587),
                                    ("dayweek", -6.582717419986587),
                                    ("Easter Sundayyear (latent)", -5.889570239426642),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.177252311878423),
                                    ("weekyear", -5.484105131318477),
                                    ("Super Tuesdaythis|last|next <cycle>", -6.582717419986587),
                                    ("King's Dayyear (latent)", -5.078640023210313),
                                    ("hh:mmin|during the <part-of-day>", -5.666426688112432),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.177252311878423),
                                    ("first|second|third|fourth|fifth <day-of-week> of <time>year (latent)",
                                     -5.889570239426642),
                                    ("Hanukkahyear (latent)", -5.889570239426642),
                                    ("Rama Navamiyear (latent)", -6.582717419986587),
                                    ("February<time> <part-of-day>", -6.582717419986587),
                                    ("National Grandparents Dayyear (latent)", -6.582717419986587),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.889570239426642),
                                    ("Great Lentyear (latent)", -6.582717419986587),
                                    ("tomorrowat <time-of-day>", -5.889570239426642),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.582717419986587),
                                    ("Labor Dayyear (latent)", -6.582717419986587),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.177252311878423),
                                    ("Ugadiyear (latent)", -5.196423058866697),
                                    ("Vaisakhiyear (latent)", -5.889570239426642),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.889570239426642),
                                    ("last <cycle> of <time>year (latent)", -5.889570239426642),
                                    ("at <time-of-day>tomorrow", -6.177252311878423),
                                    ("tomorrow<time-of-day> am|pm", -6.582717419986587),
                                    ("President's Dayyear (latent)", -6.582717419986587),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.582717419986587),
                                    ("Diwaliyear (latent)", -6.582717419986587),
                                    ("between <time> and <time>on <day>", -6.177252311878423),
                                    ("Black Fridayyear (latent)", -6.177252311878423),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.582717419986587),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.582717419986587),
                                    ("Chhathyear (latent)", -6.177252311878423),
                                    ("Vasant Panchamiyear (latent)", -6.582717419986587),
                                    ("Tax Dayyear (latent)", -5.484105131318477),
                                    ("Rabindra Jayantiyear (latent)", -5.329954451491219),
                                    ("this <part-of-day>at <time-of-day>", -5.329954451491219),
                                    ("St Patrick's Dayyear (latent)", -6.582717419986587),
                                    ("Thursday<time> (timezone)", -6.582717419986587),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.582717419986587),
                                    ("Pargat Diwasyear (latent)", -5.329954451491219),
                                    ("<datetime> - <datetime> (interval)July", -6.177252311878423),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.889570239426642),
                                    ("Februaryintersect", -6.582717419986587),
                                    ("Mother's Dayyear (latent)", -6.582717419986587),
                                    ("Simchat Torahyear (latent)", -6.582717419986587),
                                    ("minuteyear", -6.582717419986587)],
                               n = 553},
                   koData =
                     ClassData{prior = -0.9584142046853977, unseen = -6.93537044601511,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.737172632592339),
                                    ("hourday", -3.638560343924229),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.241250029368613),
                                    ("<day-of-month> (ordinal)August", -6.241250029368613),
                                    ("dayhour", -3.567101379942084),
                                    ("<time> timezoneyear (latent)", -5.548102848808668),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.324959297494458),
                                    ("Tuesdayfrom|since|after <time>", -5.142637740700503),
                                    ("daymonth", -3.5331998282664028),
                                    ("hourquarter", -5.324959297494458),
                                    ("monthday", -5.835784921260449),
                                    ("monthyear", -4.988487060873245),
                                    ("<time-of-day> am|pmyear (latent)", -5.548102848808668),
                                    ("Thai Pongalyear (latent)", -5.548102848808668),
                                    ("intersecthh:mm", -6.241250029368613),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.835784921260449),
                                    ("<datetime> - <datetime> (interval)Sunday",
                                     -5.835784921260449),
                                    ("<day-of-month> (ordinal)Wednesday", -6.241250029368613),
                                    ("houryear", -4.449490560140558),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.241250029368613),
                                    ("<day-of-month> (ordinal)October", -6.241250029368613),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.548102848808668),
                                    ("hournograin", -4.988487060873245),
                                    ("<time-of-day> am|pmintersect", -4.988487060873245),
                                    ("Octoberyear (latent)", -6.241250029368613),
                                    ("Good Fridayyear (latent)", -5.835784921260449),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.835784921260449),
                                    ("early morningat <time-of-day>", -6.241250029368613),
                                    ("until <time>on <day>", -5.548102848808668),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.241250029368613),
                                    ("time-of-day (latent)intersect", -5.548102848808668),
                                    ("todayin <number> (implicit minutes)", -6.241250029368613),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.548102848808668),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.241250029368613),
                                    ("hh:mmon <day>", -4.988487060873245),
                                    ("hhhmmintersect", -5.835784921260449),
                                    ("absorption of , after named dayJuly", -5.324959297494458),
                                    ("from|since|after <time>July", -5.835784921260449),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.324959297494458),
                                    ("Clean Mondayyear (latent)", -6.241250029368613),
                                    ("monthhour", -6.241250029368613),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.835784921260449),
                                    ("hourmonth", -4.1011838658723425),
                                    ("todayat <time-of-day>", -6.241250029368613),
                                    ("hhhmmyear (latent)", -4.988487060873245),
                                    ("from|since|after <time>December", -6.241250029368613),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.241250029368613),
                                    ("<time-of-day> am|pmon <day>", -4.988487060873245),
                                    ("Mondayyear (latent)", -5.142637740700503),
                                    ("dayday", -3.8898747722051352),
                                    ("mm/ddat <time-of-day>", -5.835784921260449),
                                    ("on <day>September", -5.548102848808668),
                                    ("time-of-day (latent)September", -5.835784921260449),
                                    ("hourhour", -4.161808487688777),
                                    ("time-of-day (latent)on <day>", -4.737172632592339),
                                    ("<datetime> - <datetime> (interval)year (latent)",
                                     -6.241250029368613),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.835784921260449),
                                    ("dayyear", -2.909045519193409),
                                    ("Thursdaymm/dd", -6.241250029368613),
                                    ("New Year's Dayyear (latent)", -5.324959297494458),
                                    ("Tuesdayyear (latent)", -5.142637740700503),
                                    ("time-of-day (latent)Sunday", -5.835784921260449),
                                    ("Thursdayfrom|since|after <time>", -4.536501937130188),
                                    ("Thursdayat <time-of-day>", -4.631812116934513),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.241250029368613),
                                    ("Aprilyear (latent)", -6.241250029368613),
                                    ("the <day-of-month> (ordinal)July", -6.241250029368613),
                                    ("the <day-of-month> (number)July", -6.241250029368613),
                                    ("monthminute", -6.241250029368613),
                                    ("<time-of-day> am|pmtomorrow", -5.835784921260449),
                                    ("Thursdayhh:mm", -5.324959297494458),
                                    ("<day-of-month> (ordinal)Tuesday", -5.835784921260449),
                                    ("minutemonth", -4.1011838658723425),
                                    ("time-of-day (latent)Friday", -5.835784921260449),
                                    ("minutehour", -6.241250029368613),
                                    ("Tuesdayin <number> (implicit minutes)", -6.241250029368613),
                                    ("part of daysat <time-of-day>", -5.142637740700503),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.8898747722051352),
                                    ("<day-of-month> (ordinal)Sunday", -6.241250029368613),
                                    ("Augustyear (latent)", -5.835784921260449),
                                    ("week-endin|during <named-month>|year", -6.241250029368613),
                                    ("time-of-day (latent)Tuesday", -5.835784921260449),
                                    ...
                                    ("July<day-of-month> (ordinal or number) of <named-month>",
                                     -6.241250029368613),
                                    ("Tuesdayin|during <named-month>|year", -6.241250029368613),
                                    ("Sundayyear (latent)", -5.324959297494458),
                                    ("hourweek", -5.324959297494458),
                                    ("the <day-of-month> (ordinal)Monday", -5.548102848808668),
                                    ("Christmasat <time-of-day>", -6.241250029368613),
                                    ("from|since|after <time>year (latent)", -5.142637740700503),
                                    ("hhhmmon <day>", -5.324959297494458),
                                    ("yesterday<time-of-day> am|pm", -6.241250029368613),
                                    ("<day-of-month> (ordinal)July", -5.548102848808668),
                                    ("Tuesday<duration> hence|ago", -6.241250029368613),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.241250029368613),
                                    ("mm/ddyear (latent)", -6.241250029368613),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.241250029368613),
                                    ...
                                    ("August<day-of-month> (ordinal or number) of <named-month>",
                                     -6.241250029368613),
                                    ("Tuesdaythis|last|next <cycle>", -6.241250029368613),
                                    ("at <time-of-day>intersect", -5.324959297494458),
                                    ("hh:mmyear (latent)", -4.8549556682487225),
                                    ("Holiyear (latent)", -6.241250029368613),
                                    ("until <time><time-of-day> am|pm", -6.241250029368613),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.835784921260449),
                                    ("dayminute", -3.3508782714724483),
                                    ("yyyy-mm-ddhh:mm", -5.835784921260449),
                                    ("intersectfrom|since|after <time>", -5.835784921260449),
                                    ("intersectSeptember", -4.3694478524670215),
                                    ("minuteday", -3.0842496082184994),
                                    ("absorption of , after named dayintersect",
                                     -6.241250029368613),
                                    ("intersectyear (latent)", -6.241250029368613),
                                    ("Februaryin|during the <part-of-day>", -6.241250029368613),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.241250029368613),
                                    ("time-of-day (latent)July", -5.548102848808668),
                                    ("Saturdayyear (latent)", -6.241250029368613),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.241250029368613),
                                    ("<day-of-month> (ordinal)Monday", -4.988487060873245),
                                    ("at <time-of-day>on <day>", -5.324959297494458),
                                    ("absorption of , after named daySeptember",
                                     -4.988487060873245),
                                    ("Naraka Chaturdashiyear (latent)", -6.241250029368613),
                                    ("from|since|after <time>on <day>", -5.324959297494458),
                                    ("dayweek", -6.241250029368613),
                                    ("Easter Sundayyear (latent)", -5.835784921260449),
                                    ("Thursday<time-of-day> am|pm", -4.988487060873245),
                                    ("weekyear", -5.835784921260449),
                                    ("time-of-day (latent)Thursday", -5.835784921260449),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.241250029368613),
                                    ("<day-of-month> (ordinal)April", -6.241250029368613),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.835784921260449),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.548102848808668),
                                    ("Sundayfrom|since|after <time>", -6.241250029368613),
                                    ("absorption of , after named dayFebruary", -5.324959297494458),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.835784921260449),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.241250029368613),
                                    ("tomorrowat <time-of-day>", -6.241250029368613),
                                    ("daynograin", -5.835784921260449),
                                    ("Fridayin|during <named-month>|year", -6.241250029368613),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.835784921260449),
                                    ("last <cycle> of <time>year (latent)", -5.835784921260449),
                                    ("tomorrow<time-of-day> am|pm", -6.241250029368613),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.548102848808668),
                                    ("Diwaliyear (latent)", -5.835784921260449),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.241250029368613),
                                    ("this <part-of-day>at <time-of-day>", -5.324959297494458),
                                    ("Fridayyear (latent)", -5.324959297494458),
                                    ("Tuesdayin|within|after <duration>", -6.241250029368613),
                                    ("time-of-day (latent)April", -6.241250029368613),
                                    ("minuteyear", -4.044025452032393)],
                               n = 344}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -infinity, unseen = -0.6931471805599453,
