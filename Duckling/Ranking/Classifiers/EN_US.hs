...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.452974928832281, unseen = -7.084226422097916,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.39024066706535),
                                    ("Father's Dayyear (latent)", -6.39024066706535),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.39024066706535),
                                    ("Ramadanyear (latent)", -5.473949935191195),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.375337646523085),
                                    ("Military Spouse Dayyear (latent)", -6.39024066706535),
                                    ("Bhai Doojyear (latent)", -6.39024066706535),
                                    ("hourday", -4.375337646523085),
                                    ("dayhour", -3.4458016878989093),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.375337646523085),
                                    ("Martin Luther King's Dayyear (latent)", -5.984775558957185),
                                    ("Shemini Atzeretyear (latent)", -6.39024066706535),
                                    ("daymonth", -4.375337646523085),
                                    ("monthday", -5.984775558957185),
                                    ("monthyear", -4.598481197837295),
                                    ("Yom Ha'atzmautyear (latent)", -6.39024066706535),
                                    ("Vijayadashamiyear (latent)", -6.39024066706535),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.003946305945459),
                                    ("Thanksgiving Dayyear (latent)", -5.29162837839724),
                                    ("Thai Pongalyear (latent)", -5.697093486505405),
                                    ("Thiru Onamyear (latent)", -5.697093486505405),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.39024066706535),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.473949935191195),
                                    ("<day-of-month> (ordinal)Wednesday", -6.39024066706535),
                                    ("Krishna Janmashtamiyear (latent)", -5.984775558957185),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.39024066706535),
                                    ("houryear", -5.473949935191195),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.39024066706535),
                                    ("Christmas<time-of-day> am|pm", -6.39024066706535),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.39024066706535),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.697093486505405),
                                    ("intersectin|during <named-month>|year", -6.39024066706535),
                                    ("<time-of-day> am|pmintersect", -5.137477698569982),
                                    ("Earth Houryear (latent)", -6.39024066706535),
                                    ("Octoberyear (latent)", -4.886163270289075),
                                    ("intersect<time-of-day> am|pm", -6.39024066706535),
                                    ("Mattu Pongalyear (latent)", -6.39024066706535),
                                    ("Daylight Saving Start Dayyear (latent)", -5.473949935191195),
                                    ("Shavuotyear (latent)", -6.39024066706535),
                                    ("Parsi New Yearyear (latent)", -5.473949935191195),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.39024066706535),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.39024066706535),
                                    ("todayin|within|after <duration>", -6.39024066706535),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.984775558957185),
                                    ("Marchyear (latent)", -6.39024066706535),
                                    ("Sukkotyear (latent)", -5.984775558957185),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.984775558957185),
                                    ("Daylight Saving End Dayyear (latent)", -5.473949935191195),
                                    ("Clean Mondayyear (latent)", -5.984775558957185),
                                    ("monthhour", -5.984775558957185),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.697093486505405),
                                    ("todayat <time-of-day>", -6.39024066706535),
                                    ("Thursday<time> timezone", -4.4443305180100365),
                                    ("time-of-day (latent)tonight", -5.984775558957185),
                                    ("from|since|after <time>December", -6.39024066706535),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.39024066706535),
                                    ("<time-of-day> am|pmon <day>", -4.375337646523085),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -6.39024066706535),
                                    ("yyyy-mm-ddhh:mm:ss", -5.984775558957185),
                                    ("Tax Daythis|last|next <cycle>", -6.39024066706535),
                                    ("dayday", -3.9478936316961453),
                                    ("<time> <part-of-day>at <time-of-day>", -6.39024066706535),
                                    ("mm/ddat <time-of-day>", -6.39024066706535),
                                    ("tonightat <time-of-day>", -6.39024066706535),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.697093486505405),
                                    ("Dayananda Saraswati Jayantiyear (latent)", -6.39024066706535),
                                    ("today<time-of-day> am|pm", -6.39024066706535),
                                    ("Februarythe <day-of-month> (ordinal)", -5.984775558957185),
                                    ("at <time-of-day><time> <part-of-day>", -6.39024066706535),
                                    ("<day-of-month> (ordinal)intersect", -5.984775558957185),
                                    ("mm/dd<time-of-day> am|pm", -6.39024066706535),
                                    ("hourhour", -4.310799125385514),
                                    ("Navaratriin|during <named-month>|year", -6.39024066706535),
                                    ("Wednesdaythis|last|next <cycle>", -6.39024066706535),
                                    ("Lentyear (latent)", -6.39024066706535),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.886163270289075),
                                    ("Boghiyear (latent)", -6.39024066706535),
                                    ("dayyear", -1.7951208169307598),
                                    ("Thursdayfrom|since|after <time>", -5.984775558957185),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.39024066706535),
                                    ("Thursdayat <time-of-day>", -5.697093486505405),
                                    ("Islamic New Yearyear (latent)", -5.984775558957185),
                                    ("Laylat al-Qadryear (latent)", -5.473949935191195),
                                    ("Shrove Tuesdayyear (latent)", -6.39024066706535),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.697093486505405),
                                    ("<time-of-day> am|pmtomorrow", -5.697093486505405),
                                    ("Yom Kippuryear (latent)", -6.39024066706535),
                                    ("<day-of-month> (ordinal)Tuesday", -5.984775558957185),
                                    ("<part-of-day> of <time>year (latent)", -6.39024066706535),
                                    ("minutehour", -5.29162837839724),
                                    ("Kaanum Pongalyear (latent)", -5.984775558957185),
                                    ("Maha Saptamiyear (latent)", -6.39024066706535),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.984775558957185),
                                    ("time-of-day (latent)tomorrow", -5.473949935191195),
                                    ("part of daysat <time-of-day>", -5.984775558957185),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.685492574826925),
                                    ("for <duration> from <time>December", -6.39024066706535),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.39024066706535),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.137477698569982),
                                    ("time-of-day (latent)this <part-of-day>", -6.39024066706535),
                                    ("Pentecostyear (latent)", -6.39024066706535),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.137477698569982),
                                    ("<day-of-month> (ordinal)February", -6.39024066706535),
                                    ("Eid al-Fitryear (latent)", -5.473949935191195),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.39024066706535),
                                    ("Mondayin|during the <part-of-day>", -6.39024066706535),
                                    ("Chhathin|during <named-month>|year", -6.39024066706535),
                                    ("Diwaliin|during <named-month>|year", -6.39024066706535),
                                    ("Vaisakhiin|during <named-month>|year", -6.39024066706535),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.137477698569982),
                                    ("Raksha Bandhanyear (latent)", -6.39024066706535),
                                    ("daysecond", -5.984775558957185),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.984775558957185),
                                    ("Emancipation Dayyear (latent)", -5.697093486505405),
                                    ("Ashurayear (latent)", -6.39024066706535),
                                    ("Tuesdayin|during <named-month>|year", -6.39024066706535),
                                    ("Chinese New Yearyear (latent)", -6.39024066706535),
                                    ("tomorrowintersect", -6.39024066706535),
                                    ("Lag BaOmeryear (latent)", -6.39024066706535),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.39024066706535),
                                    ("Eid al-Adhayear (latent)", -4.250174503569079),
                                    ("intersectin|during the <part-of-day>", -6.39024066706535),
                                    ("Palm Sundayyear (latent)", -6.39024066706535),
                                    ("Christmasat <time-of-day>", -6.39024066706535),
                                    ("Passoveryear (latent)", -6.39024066706535),
                                    ("Lazarus Saturdayyear (latent)", -6.39024066706535),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.39024066706535),
                                    ("Cyber Mondayyear (latent)", -5.984775558957185),
                                    ("Yom HaShoahyear (latent)", -5.984775558957185),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.984775558957185),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.39024066706535),
                                    ("Septemberyear (latent)", -5.984775558957185),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.886163270289075),
                                    ("Halloweenyear (latent)", -6.39024066706535),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.39024066706535),
                                    ("at <time-of-day>intersect", -5.984775558957185),
                                    ("Rosh Hashanahyear (latent)", -5.697093486505405),
                                    ("Dhanterasyear (latent)", -6.39024066706535),
                                    ("Tu BiShvatyear (latent)", -6.39024066706535),
                                    ("<day-of-month> (ordinal)December", -5.697093486505405),
                                    ("Holiyear (latent)", -5.697093486505405),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.39024066706535),
                                    ("Holika Dahanyear (latent)", -5.697093486505405),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.39024066706535),
                                    ("dayminute", -3.4724699349810706),
                                    ("Mawlidyear (latent)", -6.39024066706535),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.984775558957185),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.39024066706535),
                                    ("Jumu'atul-Widayear (latent)", -5.473949935191195),
                                    ("minuteday", -2.561599270576255),
                                    ("absorption of , after named dayintersect", -6.39024066706535),
                                    ("intersectyear (latent)", -6.39024066706535),
                                    ("Orthodox Easter Sundayyear (latent)", -6.39024066706535),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.39024066706535),
                                    ("<ordinal> <cycle> of <time>year (latent)", -6.39024066706535),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.39024066706535),
                                    ("Boss's Dayyear (latent)", -5.984775558957185),
                                    ("Global Youth Service Dayyear (latent)", -6.39024066706535),
                                    ("Dhanterasin|during <named-month>|year", -6.39024066706535),
                                    ("Tisha B'Avyear (latent)", -6.39024066706535),
                                    ("Isra and Mi'rajyear (latent)", -5.473949935191195),
                                    ("at <time-of-day>on <day>", -5.29162837839724),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.39024066706535),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.697093486505405),
                                    ("Christmasyear (latent)", -5.984775558957185),
                                    ("Naraka Chaturdashiyear (latent)", -5.984775558957185),
                                    ("Thai Pongalin|during <named-month>|year", -6.39024066706535),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.39024066706535),
                                    ("dayweek", -6.39024066706535),
                                    ("Easter Sundayyear (latent)", -5.697093486505405),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.7808027546312495),
                                    ("weekyear", -5.29162837839724),
                                    ("King's Dayyear (latent)", -4.886163270289075),
                                    ("hh:mmin|during the <part-of-day>", -5.697093486505405),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.984775558957185),
                                    ("Hanukkahyear (latent)", -5.697093486505405),
                                    ("February<time> <part-of-day>", -6.39024066706535),
                                    ("National Grandparents Dayyear (latent)", -6.39024066706535),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.39024066706535),
                                    ("Great Lentyear (latent)", -6.39024066706535),
                                    ("tomorrowat <time-of-day>", -5.697093486505405),
                                    ("hhmm (latent)in|during the <part-of-day>", -6.39024066706535),
                                    ("Labor Dayyear (latent)", -6.39024066706535),
                                    ("Vaisakhiyear (latent)", -5.697093486505405),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.39024066706535),
                                    ("last <cycle> of <time>year (latent)", -5.697093486505405),
                                    ("at <time-of-day>tomorrow", -5.984775558957185),
                                    ("tomorrow<time-of-day> am|pm", -6.39024066706535),
                                    ("President's Dayyear (latent)", -6.39024066706535),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.39024066706535),
                                    ("Diwaliyear (latent)", -6.39024066706535),
                                    ("between <time> and <time>on <day>", -4.7808027546312495),
                                    ("Black Fridayyear (latent)", -5.984775558957185),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.39024066706535),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.39024066706535),
                                    ("Chhathyear (latent)", -5.984775558957185),
                                    ("Vasant Panchamiyear (latent)", -6.39024066706535),
                                    ("Tax Dayyear (latent)", -5.473949935191195),
                                    ("Rabindra Jayantiyear (latent)", -5.137477698569982),
                                    ("St Patrick's Dayyear (latent)", -6.39024066706535),
                                    ("Thursday<time> (timezone)", -6.39024066706535),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.39024066706535),
                                    ("<datetime> - <datetime> (interval)July", -5.984775558957185),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.984775558957185),
                                    ("Februaryintersect", -6.39024066706535),
                                    ("Mother's Dayyear (latent)", -6.39024066706535),
                                    ("Simchat Torahyear (latent)", -6.39024066706535),
                                    ("minuteyear", -6.39024066706535)],
                               n = 459},
                   koData =
                     ClassData{prior = -1.0098711067150616, unseen = -6.68586094706836,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.283414346005772),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.991464547107982),
                                    ("<day-of-month> (ordinal)August", -5.991464547107982),
                                    ("dayhour", -3.3173158976814534),
                                    ("<time> timezoneyear (latent)", -5.991464547107982),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.075173815233827),
                                    ("Tuesdayfrom|since|after <time>", -5.991464547107982),
                                    ...
                                    ("time-of-day (latent)intersect", -5.991464547107982),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.991464547107982),
                                    ("mm/ddyear (latent)", -5.991464547107982),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.991464547107982),
