...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6114691495456782, unseen = -6.016157159698354,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 408},
                   koData =
                     ClassData{prior = -0.7820946665764414, unseen = -5.846438775057725,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46379067506101734, unseen = -7.05617528410041,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.362165662779806),
                                    ("Father's Dayyear (latent)", -6.362165662779806),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.362165662779806),
                                    ("Ramadanyear (latent)", -5.445874930905651),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.347262642237542),
                                    ("Military Spouse Dayyear (latent)", -6.362165662779806),
                                    ("Bhai Doojyear (latent)", -6.362165662779806),
                                    ("hourday", -4.347262642237542),
                                    ("dayhour", -3.4443949306955273),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.347262642237542),
                                    ("Martin Luther King's Dayyear (latent)", -5.9567005546716425),
                                    ("Shemini Atzeretyear (latent)", -6.362165662779806),
                                    ("daymonth", -4.347262642237542),
                                    ("monthday", -5.9567005546716425),
                                    ("monthyear", -4.570406193551752),
                                    ("Yom Ha'atzmautyear (latent)", -6.362165662779806),
                                    ("Vijayadashamiyear (latent)", -6.362165662779806),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -4.975871301659915),
                                    ("Thanksgiving Dayyear (latent)", -5.263553374111697),
                                    ("Thai Pongalyear (latent)", -5.669018482219861),
                                    ("Thiru Onamyear (latent)", -5.669018482219861),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.362165662779806),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.445874930905651),
                                    ("<day-of-month> (ordinal)Wednesday", -6.362165662779806),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.362165662779806),
                                    ("houryear", -5.445874930905651),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.362165662779806),
                                    ("Christmas<time-of-day> am|pm", -6.362165662779806),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.362165662779806),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.669018482219861),
                                    ("intersectin|during <named-month>|year", -6.362165662779806),
                                    ("<time-of-day> am|pmintersect", -5.109402694284438),
                                    ("Earth Houryear (latent)", -6.362165662779806),
                                    ("Octoberyear (latent)", -4.8580882660035325),
                                    ("intersect<time-of-day> am|pm", -6.362165662779806),
                                    ("Mattu Pongalyear (latent)", -6.362165662779806),
                                    ("Daylight Saving Start Dayyear (latent)", -5.445874930905651),
                                    ("Shavuotyear (latent)", -6.362165662779806),
                                    ("Parsi New Yearyear (latent)", -5.445874930905651),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.362165662779806),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.362165662779806),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.9567005546716425),
                                    ("Marchyear (latent)", -6.362165662779806),
                                    ("Sukkotyear (latent)", -5.9567005546716425),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.9567005546716425),
                                    ("Daylight Saving End Dayyear (latent)", -5.445874930905651),
                                    ("Clean Mondayyear (latent)", -5.9567005546716425),
                                    ("monthhour", -5.9567005546716425),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.669018482219861),
                                    ("todayat <time-of-day>", -6.362165662779806),
                                    ("Thursday<time> timezone", -4.416255513724493),
                                    ("time-of-day (latent)tonight", -5.9567005546716425),
                                    ("from|since|after <time>December", -6.362165662779806),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.362165662779806),
                                    ("<time-of-day> am|pmon <day>", -4.347262642237542),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.362165662779806),
                                    ("yyyy-mm-ddhh:mm:ss", -5.9567005546716425),
                                    ("Tax Daythis|last|next <cycle>", -6.362165662779806),
                                    ("dayday", -3.919818627410602),
                                    ("<time> <part-of-day>at <time-of-day>", -6.362165662779806),
                                    ("mm/ddat <time-of-day>", -6.362165662779806),
                                    ("tonightat <time-of-day>", -6.362165662779806),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.669018482219861),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.362165662779806),
                                    ("today<time-of-day> am|pm", -6.362165662779806),
                                    ("Februarythe <day-of-month> (ordinal)", -5.9567005546716425),
                                    ("at <time-of-day><time> <part-of-day>", -6.362165662779806),
                                    ("<day-of-month> (ordinal)intersect", -5.9567005546716425),
                                    ("mm/dd<time-of-day> am|pm", -6.362165662779806),
                                    ("hourhour", -4.28272412109997),
                                    ("Navaratriin|during <named-month>|year", -6.362165662779806),
                                    ("Wednesdaythis|last|next <cycle>", -6.362165662779806),
                                    ("Lentyear (latent)", -6.362165662779806),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.8580882660035325),
                                    ("Boghiyear (latent)", -6.362165662779806),
                                    ("dayyear", -1.8403770857307662),
                                    ("Thursdayfrom|since|after <time>", -5.9567005546716425),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.362165662779806),
                                    ("Thursdayat <time-of-day>", -5.669018482219861),
                                    ("Islamic New Yearyear (latent)", -5.9567005546716425),
                                    ("Laylat al-Qadryear (latent)", -5.445874930905651),
                                    ("Shrove Tuesdayyear (latent)", -6.362165662779806),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.669018482219861),
                                    ("<time-of-day> am|pmtomorrow", -5.669018482219861),
                                    ("Yom Kippuryear (latent)", -6.362165662779806),
                                    ("<day-of-month> (ordinal)Tuesday", -5.9567005546716425),
                                    ("<part-of-day> of <time>year (latent)", -6.362165662779806),
                                    ("minutehour", -5.263553374111697),
                                    ("Kaanum Pongalyear (latent)", -5.9567005546716425),
                                    ("Maha Saptamiyear (latent)", -6.362165662779806),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.9567005546716425),
                                    ("time-of-day (latent)tomorrow", -5.445874930905651),
                                    ("part of daysat <time-of-day>", -5.9567005546716425),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.657417570541381),
                                    ("for <duration> from <time>December", -6.362165662779806),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.362165662779806),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.109402694284438),
                                    ("time-of-day (latent)this <part-of-day>", -6.362165662779806),
                                    ("Pentecostyear (latent)", -6.362165662779806),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.109402694284438),
                                    ("<day-of-month> (ordinal)February", -6.362165662779806),
                                    ("Eid al-Fitryear (latent)", -5.445874930905651),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.362165662779806),
                                    ("Mondayin|during the <part-of-day>", -6.362165662779806),
                                    ("Chhathin|during <named-month>|year", -6.362165662779806),
                                    ("Diwaliin|during <named-month>|year", -6.362165662779806),
                                    ("Vaisakhiin|during <named-month>|year", -6.362165662779806),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.109402694284438),
                                    ("Raksha Bandhanyear (latent)", -6.362165662779806),
                                    ("daysecond", -5.9567005546716425),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.9567005546716425),
                                    ("Emancipation Dayyear (latent)", -5.669018482219861),
                                    ("Ashurayear (latent)", -6.362165662779806),
                                    ("Tuesdayin|during <named-month>|year", -6.362165662779806),
                                    ("Chinese New Yearyear (latent)", -6.362165662779806),
                                    ("tomorrowintersect", -6.362165662779806),
                                    ("Lag BaOmeryear (latent)", -6.362165662779806),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.362165662779806),
                                    ("Eid al-Adhayear (latent)", -5.445874930905651),
                                    ("intersectin|during the <part-of-day>", -6.362165662779806),
                                    ("Palm Sundayyear (latent)", -6.362165662779806),
                                    ("Christmasat <time-of-day>", -6.362165662779806),
                                    ("Passoveryear (latent)", -6.362165662779806),
                                    ("Lazarus Saturdayyear (latent)", -6.362165662779806),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.362165662779806),
                                    ("Cyber Mondayyear (latent)", -5.9567005546716425),
                                    ("Yom HaShoahyear (latent)", -5.9567005546716425),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.9567005546716425),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.362165662779806),
                                    ("Septemberyear (latent)", -5.9567005546716425),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.8580882660035325),
                                    ("Halloweenyear (latent)", -6.362165662779806),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.362165662779806),
                                    ("at <time-of-day>intersect", -5.9567005546716425),
                                    ("Rosh Hashanahyear (latent)", -5.669018482219861),
                                    ("Dhanterasyear (latent)", -6.362165662779806),
                                    ("Tu BiShvatyear (latent)", -6.362165662779806),
                                    ("<day-of-month> (ordinal)December", -5.669018482219861),
                                    ("Holiyear (latent)", -5.669018482219861),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.362165662779806),
                                    ("Holika Dahanyear (latent)", -5.669018482219861),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.362165662779806),
                                    ("dayminute", -3.4443949306955273),
                                    ("Mawlidyear (latent)", -6.362165662779806),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.9567005546716425),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.362165662779806),
                                    ("Jumu'atul-Widayear (latent)", -5.445874930905651),
                                    ("minuteday", -2.5335242662907116),
                                    ("absorption of , after named dayintersect",
                                     -6.362165662779806),
                                    ("intersectyear (latent)", -6.362165662779806),
                                    ("Orthodox Easter Sundayyear (latent)", -6.362165662779806),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.362165662779806),
                                    ("Boss's Dayyear (latent)", -5.9567005546716425),
                                    ("Global Youth Service Dayyear (latent)", -6.362165662779806),
                                    ("Dhanterasin|during <named-month>|year", -6.362165662779806),
                                    ("Tisha B'Avyear (latent)", -6.362165662779806),
                                    ("Isra and Mi'rajyear (latent)", -5.445874930905651),
                                    ("at <time-of-day>on <day>", -5.263553374111697),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.362165662779806),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.669018482219861),
                                    ("Christmasyear (latent)", -5.9567005546716425),
                                    ("Naraka Chaturdashiyear (latent)", -5.9567005546716425),
                                    ("Thai Pongalin|during <named-month>|year", -6.362165662779806),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.362165662779806),
                                    ("dayweek", -6.362165662779806),
                                    ("Easter Sundayyear (latent)", -5.669018482219861),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.752727750345706),
                                    ("weekyear", -5.263553374111697),
                                    ("King's Dayyear (latent)", -4.8580882660035325),
                                    ("hh:mmin|during the <part-of-day>", -5.669018482219861),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.9567005546716425),
                                    ("Hanukkahyear (latent)", -5.669018482219861),
                                    ("February<time> <part-of-day>", -6.362165662779806),
                                    ("National Grandparents Dayyear (latent)", -6.362165662779806),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.362165662779806),
                                    ("Great Lentyear (latent)", -6.362165662779806),
                                    ("tomorrowat <time-of-day>", -5.669018482219861),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.362165662779806),
                                    ("Labor Dayyear (latent)", -6.362165662779806),
                                    ("Vaisakhiyear (latent)", -5.669018482219861),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.362165662779806),
                                    ("last <cycle> of <time>year (latent)", -5.669018482219861),
                                    ("at <time-of-day>tomorrow", -5.9567005546716425),
                                    ("tomorrow<time-of-day> am|pm", -6.362165662779806),
                                    ("President's Dayyear (latent)", -6.362165662779806),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.362165662779806),
                                    ("Diwaliyear (latent)", -6.362165662779806),
                                    ("between <time> and <time>on <day>", -4.752727750345706),
                                    ("Black Fridayyear (latent)", -5.9567005546716425),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.362165662779806),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.362165662779806),
                                    ("Chhathyear (latent)", -5.9567005546716425),
                                    ("Vasant Panchamiyear (latent)", -6.362165662779806),
                                    ("Tax Dayyear (latent)", -5.445874930905651),
                                    ("Rabindra Jayantiyear (latent)", -5.109402694284438),
                                    ("St Patrick's Dayyear (latent)", -6.362165662779806),
                                    ("Thursday<time> (timezone)", -6.362165662779806),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.362165662779806),
                                    ("<datetime> - <datetime> (interval)July", -5.9567005546716425),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.9567005546716425),
                                    ("Februaryintersect", -6.362165662779806),
                                    ("Mother's Dayyear (latent)", -6.362165662779806),
                                    ("Simchat Torahyear (latent)", -6.362165662779806),
                                    ("minuteyear", -6.362165662779806)],
                               n = 444},
                   koData =
                     ClassData{prior = -0.9912707337321452, unseen = -6.679599185844383,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.2771447329921766),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.985194934094387),
                                    ("<day-of-month> (ordinal)August", -5.985194934094387),
                                    ("dayhour", -3.311046284667858),
                                    ("<time> timezoneyear (latent)", -5.985194934094387),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.0689042022202315),
                                    ("Tuesdayfrom|since|after <time>", -5.985194934094387),
                                    ("daymonth", -3.5002882843063863),
                                    ("monthyear", -4.732431965599019),
                                    ("<time-of-day> am|pmyear (latent)", -5.292047753534441),
                                    ("Thai Pongalyear (latent)", -5.292047753534441),
                                    ("intersecthh:mm", -5.985194934094387),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.579729825986222),
                                    ("<day-of-month> (ordinal)Wednesday", -5.985194934094387),
                                    ("houryear", -4.598900572974496),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.985194934094387),
                                    ("<day-of-month> (ordinal)October", -5.985194934094387),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.292047753534441),
                                    ("<time-of-day> am|pmintersect", -4.732431965599019),
                                    ("Octoberyear (latent)", -5.985194934094387),
                                    ("until <time>on <day>", -5.292047753534441),
                                    ("time-of-day (latent)intersect", -5.985194934094387),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.292047753534441),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.985194934094387),
                                    ("hh:mmon <day>", -3.5428478987251824),
                                    ("absorption of , after named dayJuly", -5.579729825986222),
                                    ("from|since|after <time>July", -5.579729825986222),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.0689042022202315),
                                    ("Clean Mondayyear (latent)", -5.985194934094387),
                                    ("monthhour", -5.985194934094387),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.579729825986222),
                                    ("hourmonth", -4.113392757192795),
                                    ("todayat <time-of-day>", -5.985194934094387),
                                    ("from|since|after <time>December", -5.985194934094387),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.985194934094387),
                                    ("<time-of-day> am|pmon <day>", -4.732431965599019),
                                    ("Mondayyear (latent)", -4.886582645426277),
                                    ("dayday", -4.598900572974496),
                                    ("mm/ddat <time-of-day>", -5.579729825986222),
                                    ("on <day>September", -5.579729825986222),
                                    ("time-of-day (latent)September", -5.579729825986222),
                                    ("hourhour", -5.985194934094387),
                                    ("time-of-day (latent)on <day>", -3.5428478987251824),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.579729825986222),
                                    ("dayyear", -2.9894626605403953),
                                    ("Thursdaymm/dd", -5.985194934094387),
                                    ("New Year's Dayyear (latent)", -5.0689042022202315),
                                    ("Thursdayfrom|since|after <time>", -4.280446841855961),
                                    ("Thursdayat <time-of-day>", -4.375757021660286),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.985194934094387),
                                    ("Aprilyear (latent)", -5.985194934094387),
                                    ("the <day-of-month> (ordinal)July", -5.985194934094387),
                                    ("the <day-of-month> (number)July", -5.985194934094387),
                                    ("monthminute", -5.985194934094387),
                                    ("<time-of-day> am|pmtomorrow", -5.985194934094387),
                                    ("Thursdayhh:mm", -5.0689042022202315),
                                    ("<day-of-month> (ordinal)Tuesday", -5.579729825986222),
                                    ("minutemonth", -4.113392757192795),
                                    ("minutehour", -5.985194934094387),
                                    ("Augustyear (latent)", -5.579729825986222),
                                    ("week-endin|during <named-month>|year", -5.985194934094387),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.579729825986222),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.985194934094387),
                                    ("Sundayyear (latent)", -5.0689042022202315),
                                    ("Christmasat <time-of-day>", -5.985194934094387),
                                    ("from|since|after <time>year (latent)", -4.886582645426277),
                                    ("<duration> after|before|from <time>December",
                                     -5.985194934094387),
                                    ("yesterday<time-of-day> am|pm", -5.985194934094387),
                                    ("<day-of-month> (ordinal)July", -5.292047753534441),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.985194934094387),
                                    ("mm/ddyear (latent)", -5.985194934094387),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.985194934094387),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.985194934094387),
                                    ("at <time-of-day>intersect", -5.579729825986222),
                                    ("hh:mmyear (latent)", -3.905753392414551),
                                    ("Holiyear (latent)", -5.985194934094387),
                                    ("until <time><time-of-day> am|pm", -5.985194934094387),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.985194934094387),
                                    ("dayminute", -3.42024557663285),
                                    ("yyyy-mm-ddhh:mm", -5.579729825986222),
                                    ("intersectSeptember", -4.481117537318113),
                                    ("minuteday", -2.7465164819300063),
                                    ("absorption of , after named dayintersect",
                                     -5.985194934094387),
                                    ("intersectyear (latent)", -5.985194934094387),
                                    ("Februaryin|during the <part-of-day>", -5.985194934094387),
                                    ("time-of-day (latent)July", -5.292047753534441),
                                    ("Saturdayyear (latent)", -5.985194934094387),
                                    ("at <time-of-day>on <day>", -5.579729825986222),
                                    ("absorption of , after named daySeptember",
                                     -5.0689042022202315),
                                    ("Naraka Chaturdashiyear (latent)", -5.985194934094387),
                                    ("from|since|after <time>on <day>", -5.0689042022202315),
                                    ("dayweek", -5.985194934094387),
                                    ("Easter Sundayyear (latent)", -5.579729825986222),
                                    ("Thursday<time-of-day> am|pm", -4.732431965599019),
                                    ("weekyear", -5.579729825986222),
                                    ("time-of-day (latent)Thursday", -5.579729825986222),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.985194934094387),
                                    ("<day-of-month> (ordinal)April", -5.985194934094387),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.579729825986222),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.292047753534441),
                                    ("Sundayfrom|since|after <time>", -5.985194934094387),
                                    ...
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.985194934094387),
                                    ("tomorrowat <time-of-day>", -5.985194934094387),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.579729825986222),
                                    ("last <cycle> of <time>year (latent)", -5.579729825986222),
                                    ("tomorrow<time-of-day> am|pm", -5.985194934094387),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.292047753534441),
                                    ("Diwaliyear (latent)", -5.579729825986222),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.985194934094387),
                                    ("Fridayyear (latent)", -5.579729825986222),
                                    ("time-of-day (latent)April", -5.985194934094387),
                                    ("minuteyear", -3.787970356758167)],
                               n = 262}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.15483397332839086,
                               ...
                               n = 209},
                   koData =
                     ClassData{prior = -1.9418201638037882,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
