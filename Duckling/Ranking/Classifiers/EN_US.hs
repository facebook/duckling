...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7192459335273066,
                               unseen = -5.3471075307174685,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 208},
                   koData =
                     ClassData{prior = -0.6677122834121237,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4851718507189069, unseen = -6.431331081933479,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                     -4.483809328983824),
                                    ("Lentyear", -5.736572297479192),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.483809328983824),
                                    ("hourday", -4.031824205240767),
                                    ("dayhour", -2.846200539583027),
                                    ("daymonth", -5.043425116919247),
                                    ("monthday", -5.331107189371028),
                                    ("monthyear", -4.127134385045092),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.736572297479192),
                                    ("Easter Sundayyear", -5.043425116919247),
                                    ("Christmasyear", -5.331107189371028),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.736572297479192),
                                    ("houryear", -5.331107189371028),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.736572297479192),
                                    ("Christmas<time-of-day> am|pm", -5.736572297479192),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.043425116919247),
                                    ("<time-of-day> am|pmintersect", -4.483809328983824),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.736572297479192),
                                    ("Marchyear", -5.736572297479192),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.331107189371028),
                                    ("intersect<time-of-day> am|pm", -5.736572297479192),
                                    ("Clean Mondayyear", -5.331107189371028),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.736572297479192),
                                    ("monthhour", -5.331107189371028),
                                    ("last <day-of-week> of <time>year", -5.736572297479192),
                                    ("todayat <time-of-day>", -5.736572297479192),
                                    ("Thursday<time> timezone", -4.031824205240767),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.736572297479192),
                                    ("Palm SundaySunday", -5.331107189371028),
                                    ("dayday", -3.5393477201429726),
                                    ("Thanksgiving Dayyear", -4.637960008811082),
                                    ("<time> <part-of-day>at <time-of-day>", -5.736572297479192),
                                    ("Tuesdayin <named-month>", -5.736572297479192),
                                    ("mm/ddat <time-of-day>", -5.736572297479192),
                                    ("tonightat <time-of-day>", -5.736572297479192),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.043425116919247),
                                    ("today<time-of-day> am|pm", -5.736572297479192),
                                    ("Februarythe <day-of-month> (ordinal)", -5.331107189371028),
                                    ("at <time-of-day><time> <part-of-day>", -5.736572297479192),
                                    ("mm/dd<time-of-day> am|pm", -5.736572297479192),
                                    ("hourhour", -4.483809328983824),
                                    ("<time-of-day> am|pmon <date>", -3.721669276936927),
                                    ("Wednesdaythis|last|next <cycle>", -5.736572297479192),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.232494900702918),
                                    ("dayyear", -2.6230569882688175),
                                    ("last weekend of <named-month>year", -5.736572297479192),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.736572297479192),
                                    ("Sundayyear", -5.736572297479192),
                                    ("Chinese New Yearyear", -5.736572297479192),
                                    ("Thursdayat <time-of-day>", -5.331107189371028),
                                    ("<time-of-day> am|pmtomorrow", -5.043425116919247),
                                    ("minutehour", -4.820281565605037),
                                    ("Mother's Dayyear", -5.736572297479192),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.331107189371028),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.031824205240767),
                                    ("for <duration> from <time>December", -5.736572297479192),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.736572297479192),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.820281565605037),
                                    ("Mondayin|during the <part-of-day>", -5.736572297479192),
                                    ("Shrove Tuesdayyear", -5.736572297479192),
                                    ("<part-of-day> of <time>year", -5.736572297479192),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.331107189371028),
                                    ("National Grandparents Dayyear", -5.736572297479192),
                                    ("intersectin|during the <part-of-day>", -5.736572297479192),
                                    ("Christmasat <time-of-day>", -5.736572297479192),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -4.820281565605037),
                                    ("at <time-of-day>intersect", -5.331107189371028),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.736572297479192),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.736572297479192),
                                    ("dayminute", -3.062423648052663),
                                    ("Boss's Dayyear", -5.331107189371028),
                                    ("Orthodox Easter Sundayyear", -5.736572297479192),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.331107189371028),
                                    ("intersectyear", -5.736572297479192),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.736572297479192),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.331107189371028),
                                    ("<ordinal> <cycle> of <time>year", -5.736572297479192),
                                    ("minuteday", -2.270836394679465),
                                    ("absorption of , after named dayintersect",
                                     -5.736572297479192),
                                    ("Octoberyear", -4.483809328983824),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.736572297479192),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.736572297479192),
                                    ("year<time-of-day> am|pm", -5.736572297479192),
                                    ("Cyber Mondayyear", -5.331107189371028),
                                    ("Septemberyear", -5.331107189371028),
                                    ("at <time-of-day>on <date>", -4.637960008811082),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -5.043425116919247),
                                    ("Halloweenyear", -5.736572297479192),
                                    ("dayweek", -5.736572297479192),
                                    ("Lazarus Saturdayyear", -5.736572297479192),
                                    ("Thursday<time-of-day> am|pm", -5.736572297479192),
                                    ("weekyear", -5.331107189371028),
                                    ("hh:mmin|during the <part-of-day>", -5.043425116919247),
                                    ("Father's Dayyear", -5.736572297479192),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.331107189371028),
                                    ("February<time> <part-of-day>", -5.736572297479192),
                                    ("Martin Luther King's Dayyear", -5.331107189371028),
                                    ("Military Spouse Dayyear", -5.736572297479192),
                                    ("tomorrowat <time-of-day>", -5.043425116919247),
                                    ("between <time> and <time>on <date>", -5.043425116919247),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.043425116919247),
                                    ("at <time-of-day>tomorrow", -5.331107189371028),
                                    ("tomorrow<time-of-day> am|pm", -5.736572297479192),
                                    ("Pentecostyear", -5.736572297479192),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.736572297479192),
                                    ("Palm Sundayintersect", -5.736572297479192),
                                    ("Labor Dayyear", -5.736572297479192),
                                    ("Great Lentyear", -5.736572297479192),
                                    ("Februaryintersect", -5.736572297479192),
                                    ("last <cycle> of <time>year", -5.043425116919247),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.736572297479192),
                                    ("President's Dayyear", -5.736572297479192),
                                    ("yearminute", -5.736572297479192),
                                    ("Black Fridayyear", -5.331107189371028)],
                               n = 229},
                   koData =
                     ClassData{prior = -0.9560492240132393,
                               unseen = -6.1070228877422545,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.4116460518550396),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.4116460518550396),
                                    ("hourday", -5.4116460518550396),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.4116460518550396),
                                    ("New Year's Dayyear", -5.4116460518550396),
                                    ("dayhour", -2.9692990164858357),
                                    ("daymonth", -3.332204510175204),
                                    ("monthday", -5.006180943746876),
                                    ("monthyear", -4.718498871295094),
                                    ("intersecthh:mm", -5.4116460518550396),
                                    ("Easter Sundayyear", -5.006180943746876),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.4116460518550396),
                                    ("houryear", -5.4116460518550396),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.4116460518550396),
                                    ("until <time-of-day><time-of-day> am|pm", -5.4116460518550396),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.718498871295094),
                                    ...
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.4116460518550396),
                                    ("absorption of , after named dayJuly", -5.006180943746876),
                                    ("monthhour", -5.4116460518550396),
                                    ("hourmonth", -4.718498871295094),
                                    ("todayat <time-of-day>", -5.4116460518550396),
                                    ("from|since|after <time-of-day>July", -5.4116460518550396),
                                    ("dayday", -5.006180943746876),
                                    ("mm/ddat <time-of-day>", -5.006180943746876),
                                    ("<time-of-day> am|pmon <date>", -4.1588830833596715),
                                    ("dayyear", -3.109060958860994),
                                    ("Thursdaymm/dd", -5.4116460518550396),
                                    ("Sundayyear", -4.718498871295094),
                                    ("Thursdayat <time-of-day>", -4.1588830833596715),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.4116460518550396),
                                    ("monthminute", -5.4116460518550396),
                                    ("<time-of-day> am|pmtomorrow", -5.4116460518550396),
                                    ("Thursdayhh:mm", -4.4953553199808844),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.4116460518550396),
                                    ("Fridayyear", -5.006180943746876),
                                    ("minutemonth", -3.619886582626985),
                                    ("Sundayfrom|since|after <time-of-day>", -5.4116460518550396),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.006180943746876),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.006180943746876),
                                    ("Aprilyear", -5.4116460518550396),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.006180943746876),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.4116460518550396),
                                    ("Christmasat <time-of-day>", -5.4116460518550396),
                                    ("<duration> after|before|from <time>December",
                                     -5.4116460518550396),
                                    ("yesterday<time-of-day> am|pm", -5.4116460518550396),
                                    ...
                                    ("Mondayyear", -4.31303376318693),
                                    ("Saturdayyear", -5.4116460518550396),
                                    ("at <time-of-day>intersect", -5.006180943746876),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.4116460518550396),
                                    ("dayminute", -2.8859174075467844),
                                    ("intersectSeptember", -3.907568655078766),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.4116460518550396),
                                    ("minuteday", -2.4938753197707606),
                                    ("absorption of , after named dayintersect",
                                     -5.4116460518550396),
                                    ("Februaryin|during the <part-of-day>", -5.4116460518550396),
                                    ("week-endin <named-month>", -5.4116460518550396),
                                    ("Octoberyear", -5.4116460518550396),
                                    ("from|since|after <time-of-day>year", -5.4116460518550396),
                                    ("yearhh:mm", -5.4116460518550396),
                                    ("hh:mmon <date>", -3.907568655078766),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.4116460518550396),
                                    ("absorption of , after named daySeptember",
                                     -4.4953553199808844),
                                    ("on <date>September", -5.006180943746876),
                                    ("at <time-of-day>on <date>", -5.006180943746876),
                                    ("dayweek", -5.4116460518550396),
                                    ("Thursday<time-of-day> am|pm", -5.006180943746876),
                                    ("absorption of , after named dayFebruary",
                                     -4.4953553199808844),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.4116460518550396),
                                    ("tomorrowat <time-of-day>", -5.4116460518550396),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.4116460518550396),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.8022081394209395),
                                    ("tomorrow<time-of-day> am|pm", -5.4116460518550396),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.4116460518550396),
       ...
       ("year",
        Classifier{okData =
                     ClassData{prior = -0.23995066963059103,
                               unseen = -4.1588830833596715,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -8.269171584511341e-2),
                                    ("intersect 2 numbers", -3.044522437723423)],
                               n = 59},
                   koData =
                     ClassData{prior = -1.5448993912965292, unseen = -3.044522437723423,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.5978370007556204),
                                    ("intersect 2 numbers", -1.8971199848858813),
                                    ("powers of tens", -1.8971199848858813),
                                    ("compose by multiplication", -1.8971199848858813)],
                               n = 16}}),
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.4744579795951158, unseen = -5.181783550292085,
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                     -4.483002552013883),
                                    ("dayhour", -3.230239583518516),
                                    ("daymonth", -3.230239583518516),
                                    ("<named-month> <day-of-month> (non ordinal)Friday",
                                     -4.483002552013883),
                                    ("Friday<named-month> <day-of-month> (non ordinal)",
                                     -3.7898553714539385),
                                    ("Wednesdayintersect", -4.483002552013883),
                                    ("Labor Daythis|last|next <cycle>", -4.483002552013883),
                                    ("Black Fridaythis|last|next <cycle>", -4.483002552013883),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.483002552013883),
                                    ("<part-of-day> of <time>February", -4.483002552013883),
                                    ("Saturday<time-of-day> am|pm", -4.483002552013883),
                                    ("Martin Luther King's Daythis|last|next <cycle>",
                                     -4.07753744390572),
                                    ("on <date><time-of-day> am|pm", -4.483002552013883),
                                    ("hourmonth", -4.483002552013883),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"intersect",
                                     -4.483002552013883),
                                    ("dayday", -2.6112003751122925),
                                    ("the <day-of-month> (ordinal)February", -4.07753744390572),
                                    ("WednesdayOctober", -4.483002552013883),
                                    ("Wednesdaythis|last|next <cycle>", -4.07753744390572),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.5667118201397288),
                                    ("dayyear", -2.7782544597754586),
                                    ("Saturday<named-month> <day-of-month> (non ordinal)",
                                     -4.483002552013883),
                                    ("<named-month> <day-of-month> (non ordinal)intersect",
                                     -4.483002552013883),
                                    ("Thursdayhh:mm", -4.07753744390572),
                                    ("Thanksgiving Daythis|last|next <cycle>", -4.483002552013883),
                                    ("Memorial Daythis|last|next <cycle>", -4.483002552013883),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -4.07753744390572),
                                    ("TuesdayOctober", -4.483002552013883),
                                    ("the <day-of-month> (ordinal)March", -4.483002552013883),
                                    ("Mondaythis|last|next <cycle>", -4.483002552013883),
                                    ("Fridayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.07753744390572),
                                    ("Fridayintersect", -4.483002552013883),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -3.7898553714539385),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.5667118201397288),
                                    ("Tuesdaythis|last|next <cycle>", -4.483002552013883),
                                    ("Sunday<named-month> <day-of-month> (non ordinal)",
                                     -4.483002552013883),
                                    ("dayminute", -2.691243082785829),
                                    ("intersectyear", -4.483002552013883),
                                    ("minuteday", -3.5667118201397288),
                                    ("this|last|next <cycle>Sunday", -4.483002552013883),
                                    ("Sundaythis|last|next <cycle>", -4.483002552013883),
                                    ("intersectintersect", -4.483002552013883),
                                    ("weekday", -4.483002552013883),
                                    ("dayweek", -3.3843902633457743),
                                    ("Thursday<time-of-day> am|pm", -4.483002552013883),
                               ...
                               n = 56},
                   koData =
                     ClassData{prior = -0.9734491457141037, unseen = -4.897839799950911,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("last <time>",
        Classifier{okData =
                     ClassData{prior = -0.5753641449035618,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Father's Day", -2.70805020110221),
                                    ("Martin Luther King's Day", -2.70805020110221),
                                    ("Cyber Monday", -2.70805020110221),
                                    ("Memorial Day", -2.70805020110221),
                                    ("Mother's Day", -2.70805020110221),
                                    ("day", -1.2039728043259361), ("Sunday", -2.70805020110221),
                                    ("Thanksgiving Day", -2.70805020110221),
                                    ("hour", -2.70805020110221), ("Tuesday", -2.70805020110221),
                                    ("week-end", -2.70805020110221)],
                               n = 9},
                   koData =
                     ClassData{prior = -0.8266785731844679, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
