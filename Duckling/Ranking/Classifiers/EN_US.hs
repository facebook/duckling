...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6359887667199967, unseen = -5.963579343618447,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 387},
                   koData =
                     ClassData{prior = -0.7537718023763802, unseen = -5.846438775057725,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48204665921594725, unseen = -7.01571242048723,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.3216671707156),
                                    ...
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.3216671707156),
                                    ("Ramadanyear (latent)", -5.4053764388414445),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.3067641501733345),
                                    ("Military Spouse Dayyear (latent)", -6.3216671707156),
                                    ...
                                    ("Earth Houryear (latent)", -6.3216671707156),
                                    ("Octoberyear (latent)", -4.817589773939325),
                                    ("intersect<time-of-day> am|pm", -6.3216671707156),
                                    ("Mattu Pongalyear (latent)", -6.3216671707156),
                                    ("Daylight Saving Start Dayyear (latent)", -5.4053764388414445),
                                    ("Shavuotyear (latent)", -6.3216671707156),
                                    ...
                                    ("Sukkotyear (latent)", -5.916202062607435),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.916202062607435),
                                    ("Daylight Saving End Dayyear (latent)", -5.4053764388414445),
                                    ...
                                    ("yyyy-mm-ddhh:mm:ss", -5.916202062607435),
                                    ("Tax Daythis|last|next <cycle>", -6.3216671707156),
                                    ("dayday", -3.8793201353463953),
                                    ("<time> <part-of-day>at <time-of-day>", -6.3216671707156),
                                    ("mm/ddat <time-of-day>", -6.3216671707156),
                                    ...
                                    ("mm/dd<time-of-day> am|pm", -6.3216671707156),
                                    ...
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.3216671707156),
                                    ("Mondayin|during the <part-of-day>", -6.3216671707156),
                                    ...
                                    ("daysecond", -5.916202062607435),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.916202062607435),
                                    ("Emancipation Dayyear (latent)", -5.628519990155654),
                                    ...
                                    ("last weekend of <named-month>year (latent)",
                                     -6.3216671707156),
                                    ("Eid al-Adhayear (latent)", -5.4053764388414445),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.3216671707156),
                                    ("Cyber Mondayyear (latent)", -5.916202062607435),
                                    ...
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.3216671707156),
                                    ("Jumu'atul-Widayear (latent)", -5.4053764388414445),
                                    ...
                                    ("Labor Dayyear (latent)", -6.3216671707156),
                                    ...
                                    ("President's Dayyear (latent)", -6.3216671707156),
                                    ...
                                    ("Tax Dayyear (latent)", -5.4053764388414445),
                                    ...
                                    ("Mother's Dayyear (latent)", -6.3216671707156),
                                    ("Simchat Torahyear (latent)", -6.3216671707156),
                                    ("minuteyear", -6.3216671707156)],
                               n = 423},
                   koData =
                     ClassData{prior = -0.9610743345011284, unseen = -6.674561391814426,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.2721005861054984),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.980150787207709),
                                    ("<day-of-month> (ordinal)August", -5.980150787207709),
                                    ("dayhour", -3.3060021377811797),
                                    ("<time> timezoneyear (latent)", -5.980150787207709),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.063860055333554),
                                    ("Tuesdayfrom|since|after <time>", -5.980150787207709),
                                    ("daymonth", -3.495244137419708),
                                    ("monthyear", -4.727387818712341),
                                    ("<time-of-day> am|pmyear (latent)", -5.2870036066477635),
                                    ("Thai Pongalyear (latent)", -5.2870036066477635),
                                    ("intersecthh:mm", -5.980150787207709),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.574685679099544),
                                    ("<day-of-month> (ordinal)Wednesday", -5.980150787207709),
                                    ("houryear", -4.593856426087818),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.980150787207709),
                                    ("<day-of-month> (ordinal)October", -5.980150787207709),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.2870036066477635),
                                    ("<time-of-day> am|pmintersect", -4.727387818712341),
                                    ("Octoberyear (latent)", -5.980150787207709),
                                    ("until <time>on <day>", -5.2870036066477635),
                                    ("time-of-day (latent)intersect", -5.980150787207709),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.2870036066477635),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.980150787207709),
                                    ("hh:mmon <day>", -3.537803751838504),
                                    ("absorption of , after named dayJuly", -5.574685679099544),
                                    ("from|since|after <time>July", -5.574685679099544),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.063860055333554),
                                    ("Clean Mondayyear (latent)", -5.980150787207709),
                                    ("monthhour", -5.980150787207709),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.574685679099544),
                                    ("hourmonth", -4.108348610306117),
                                    ("todayat <time-of-day>", -5.980150787207709),
                                    ("from|since|after <time>December", -5.980150787207709),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.980150787207709),
                                    ("<time-of-day> am|pmon <day>", -4.727387818712341),
                                    ("Mondayyear (latent)", -4.881538498539599),
                                    ("dayday", -4.593856426087818),
                                    ("mm/ddat <time-of-day>", -5.574685679099544),
                                    ("on <day>September", -5.574685679099544),
                                    ("time-of-day (latent)September", -5.574685679099544),
                                    ("hourhour", -5.980150787207709),
                                    ("time-of-day (latent)on <day>", -3.537803751838504),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.574685679099544),
                                    ("dayyear", -2.9844185136537176),
                                    ("Thursdaymm/dd", -5.980150787207709),
                                    ("New Year's Dayyear (latent)", -5.063860055333554),
                                    ("Thursdayfrom|since|after <time>", -4.275402694969284),
                                    ("Thursdayat <time-of-day>", -4.370712874773608),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.980150787207709),
                                    ("Aprilyear (latent)", -5.980150787207709),
                                    ("the <day-of-month> (ordinal)July", -5.980150787207709),
                                    ("the <day-of-month> (number)July", -5.980150787207709),
                                    ("monthminute", -5.980150787207709),
                                    ("<time-of-day> am|pmtomorrow", -5.980150787207709),
                                    ("Thursdayhh:mm", -5.063860055333554),
                                    ("<day-of-month> (ordinal)Tuesday", -5.574685679099544),
                                    ("minutemonth", -4.108348610306117),
                                    ("minutehour", -5.980150787207709),
                                    ("Augustyear (latent)", -5.574685679099544),
                                    ("week-endin|during <named-month>|year", -5.980150787207709),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.574685679099544),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.980150787207709),
                                    ("Sundayyear (latent)", -5.063860055333554),
                                    ("Christmasat <time-of-day>", -5.980150787207709),
                                    ("from|since|after <time>year (latent)", -4.881538498539599),
                                    ("<duration> after|before|from <time>December",
                                     -5.980150787207709),
                                    ("yesterday<time-of-day> am|pm", -5.980150787207709),
                                    ("<day-of-month> (ordinal)July", -5.2870036066477635),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.980150787207709),
                                    ("mm/ddyear (latent)", -5.980150787207709),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.980150787207709),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.980150787207709),
                                    ("at <time-of-day>intersect", -5.574685679099544),
                                    ("hh:mmyear (latent)", -3.9007092455278727),
                                    ("Holiyear (latent)", -5.980150787207709),
                                    ("until <time><time-of-day> am|pm", -5.980150787207709),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.980150787207709),
                                    ("dayminute", -3.4152014297461717),
                                    ("yyyy-mm-ddhh:mm", -5.574685679099544),
                                    ("intersectSeptember", -4.476073390431434),
                                    ("minuteday", -2.741472335043328),
                                    ("absorption of , after named dayintersect",
                                     -5.980150787207709),
                                    ("intersectyear (latent)", -5.980150787207709),
                                    ("Februaryin|during the <part-of-day>", -5.980150787207709),
                                    ("time-of-day (latent)July", -5.2870036066477635),
                                    ("Saturdayyear (latent)", -5.980150787207709),
                                    ("at <time-of-day>on <day>", -5.574685679099544),
                                    ("absorption of , after named daySeptember",
                                     -5.063860055333554),
                                    ("Naraka Chaturdashiyear (latent)", -5.980150787207709),
                                    ("from|since|after <time>on <day>", -5.063860055333554),
                                    ("dayweek", -5.980150787207709),
                                    ("Easter Sundayyear (latent)", -5.574685679099544),
                                    ("Thursday<time-of-day> am|pm", -4.727387818712341),
                                    ("weekyear", -5.574685679099544),
                                    ("time-of-day (latent)Thursday", -5.574685679099544),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.980150787207709),
                                    ("<day-of-month> (ordinal)April", -5.980150787207709),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.574685679099544),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.2870036066477635),
                                    ("Sundayfrom|since|after <time>", -5.980150787207709),
                                    ("absorption of , after named dayFebruary", -5.063860055333554),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.980150787207709),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.980150787207709),
                                    ("tomorrowat <time-of-day>", -5.980150787207709),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.574685679099544),
                                    ("last <cycle> of <time>year (latent)", -5.574685679099544),
                                    ("tomorrow<time-of-day> am|pm", -5.980150787207709),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.2870036066477635),
                                    ("Diwaliyear (latent)", -5.574685679099544),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.980150787207709),
                                    ("Fridayyear (latent)", -5.574685679099544),
                                    ("time-of-day (latent)April", -5.980150787207709),
                                    ("minuteyear", -3.7829262098714893)],
                               n = 262}}),
       ("one eleven",
        Classifier{okData =
