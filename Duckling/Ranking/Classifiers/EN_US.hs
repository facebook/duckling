...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5692544167731913, unseen = -6.161207321695077,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 472},
                   koData =
                     ClassData{prior = -0.8345891905329756,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4437031218624945, unseen = -7.161622002939187,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.467698726104354),
                                    ("Father's Dayyear (latent)", -6.467698726104354),
                                    ("Karva Chauthyear (latent)", -6.467698726104354),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.467698726104354),
                                    ("Maha Shivaratriyear (latent)", -6.467698726104354),
                                    ("Ramadanyear (latent)", -5.551407994230199),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.081404364984463),
                                    ("Military Spouse Dayyear (latent)", -6.467698726104354),
                                    ("Bhai Doojyear (latent)", -6.467698726104354),
                                    ("hourday", -4.452795705562089),
                                    ("dayhour", -3.523259746937913),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.081404364984463),
                                    ("Martin Luther King's Dayyear (latent)", -6.062233617996189),
                                    ("Shemini Atzeretyear (latent)", -6.467698726104354),
                                    ("daymonth", -4.452795705562089),
                                    ("monthday", -6.062233617996189),
                                    ("monthyear", -4.6759392568762985),
                                    ("Yom Ha'atzmautyear (latent)", -6.467698726104354),
                                    ("Vijayadashamiyear (latent)", -6.467698726104354),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.081404364984463),
                                    ("Thanksgiving Dayyear (latent)", -5.369086437436244),
                                    ("Thai Pongalyear (latent)", -5.7745515455444085),
                                    ("Thiru Onamyear (latent)", -5.7745515455444085),
                                    ("hhhmmabsorption of , after named day", -6.467698726104354),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.467698726104354),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.551407994230199),
                                    ("<day-of-month> (ordinal)Wednesday", -6.467698726104354),
                                    ("Krishna Janmashtamiyear (latent)", -6.062233617996189),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.467698726104354),
                                    ("houryear", -5.551407994230199),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.467698726104354),
                                    ("Christmas<time-of-day> am|pm", -6.467698726104354),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.467698726104354),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7745515455444085),
                                    ("intersectin|during <named-month>|year", -6.467698726104354),
                                    ("<time-of-day> am|pmintersect", -5.214935757608986),
                                    ("Earth Houryear (latent)", -6.467698726104354),
                                    ("Octoberyear (latent)", -4.963621329328079),
                                    ("intersect<time-of-day> am|pm", -6.467698726104354),
                                    ("Mattu Pongalyear (latent)", -6.467698726104354),
                                    ("Daylight Saving Start Dayyear (latent)", -5.551407994230199),
                                    ("Shavuotyear (latent)", -6.467698726104354),
                                    ("Parsi New Yearyear (latent)", -5.551407994230199),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.467698726104354),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.467698726104354),
                                    ("todayin|within|after <duration>", -6.467698726104354),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.062233617996189),
                                    ("Marchyear (latent)", -6.467698726104354),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.062233617996189),
                                    ("Sukkotyear (latent)", -6.062233617996189),
                                    ("hhhmmintersect", -6.062233617996189),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.062233617996189),
                                    ("Daylight Saving End Dayyear (latent)", -5.551407994230199),
                                    ("Clean Mondayyear (latent)", -6.062233617996189),
                                    ("monthhour", -6.062233617996189),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7745515455444085),
                                    ("todayat <time-of-day>", -6.467698726104354),
                                    ("Thursday<time> timezone", -4.069803453305983),
                                    ("time-of-day (latent)tonight", -6.062233617996189),
                                    ("from|since|after <time>December", -6.467698726104354),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.467698726104354),
                                    ("<time-of-day> am|pmon <day>", -4.452795705562089),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.467698726104354),
                                    ("yyyy-mm-ddhh:mm:ss", -6.062233617996189),
                                    ("Tax Daythis|last|next <cycle>", -6.467698726104354),
                                    ("dayday", -3.7596485250021434),
                                    ("<time> <part-of-day>at <time-of-day>", -6.467698726104354),
                                    ("mm/ddat <time-of-day>", -6.467698726104354),
                                    ("tonightat <time-of-day>", -6.467698726104354),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.7745515455444085),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.467698726104354),
                                    ("today<time-of-day> am|pm", -6.467698726104354),
                                    ("Februarythe <day-of-month> (ordinal)", -6.062233617996189),
                                    ("at <time-of-day><time> <part-of-day>", -6.467698726104354),
                                    ("<day-of-month> (ordinal)intersect", -6.062233617996189),
                                    ("mm/dd<time-of-day> am|pm", -6.467698726104354),
                                    ("hourhour", -4.388257184424518),
                                    ("Mahavir Jayantiyear (latent)", -6.062233617996189),
                                    ("Navaratriin|during <named-month>|year", -6.467698726104354),
                                    ("Wednesdaythis|last|next <cycle>", -6.467698726104354),
                                    ("Lentyear (latent)", -6.467698726104354),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.595896549202762),
                                    ("Boghiyear (latent)", -6.467698726104354),
                                    ("dayyear", -1.7902078785366362),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.467698726104354),
                                    ("Thursdayfrom|since|after <time>", -6.062233617996189),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.467698726104354),
                                    ("Thursdayat <time-of-day>", -5.7745515455444085),
                                    ("Islamic New Yearyear (latent)", -6.062233617996189),
                                    ("Laylat al-Qadryear (latent)", -5.551407994230199),
                                    ("Shrove Tuesdayyear (latent)", -6.467698726104354),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.7745515455444085),
                                    ("<time-of-day> am|pmtomorrow", -5.7745515455444085),
                                    ("Yom Kippuryear (latent)", -6.467698726104354),
                                    ("<day-of-month> (ordinal)Tuesday", -6.062233617996189),
                                    ("<part-of-day> of <time>year (latent)", -6.467698726104354),
                                    ("minutehour", -5.214935757608986),
                                    ("Kaanum Pongalyear (latent)", -6.062233617996189),
                                    ("Maha Saptamiyear (latent)", -6.467698726104354),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.062233617996189),
                                    ("time-of-day (latent)tomorrow", -5.551407994230199),
                                    ("part of daysat <time-of-day>", -6.062233617996189),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.452795705562089),
                                    ("for <duration> from <time>December", -6.467698726104354),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.467698726104354),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.214935757608986),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.214935757608986),
                                    ("time-of-day (latent)this <part-of-day>", -6.467698726104354),
                                    ("Pentecostyear (latent)", -6.467698726104354),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.214935757608986),
                                    ("<day-of-month> (ordinal)February", -6.467698726104354),
                                    ("Eid al-Fitryear (latent)", -5.551407994230199),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.467698726104354),
                                    ("Mondayin|during the <part-of-day>", -6.467698726104354),
                                    ("Chhathin|during <named-month>|year", -6.467698726104354),
                                    ("Diwaliin|during <named-month>|year", -6.467698726104354),
                                    ("Vaisakhiin|during <named-month>|year", -6.467698726104354),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.214935757608986),
                                    ("Raksha Bandhanyear (latent)", -6.467698726104354),
                                    ("daysecond", -6.062233617996189),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.062233617996189),
                                    ("Emancipation Dayyear (latent)", -5.7745515455444085),
                                    ("Ashurayear (latent)", -6.467698726104354),
                                    ("Tuesdayin|during <named-month>|year", -6.467698726104354),
                                    ("Chinese New Yearyear (latent)", -6.467698726104354),
                                    ("tomorrowintersect", -6.467698726104354),
                                    ("Lag BaOmeryear (latent)", -6.467698726104354),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.467698726104354),
                                    ("Eid al-Adhayear (latent)", -4.327632562608083),
                                    ("intersectin|during the <part-of-day>", -6.467698726104354),
                                    ("Palm Sundayyear (latent)", -6.467698726104354),
                                    ("Christmasat <time-of-day>", -6.467698726104354),
                                    ("Passoveryear (latent)", -6.467698726104354),
                                    ("Lazarus Saturdayyear (latent)", -6.467698726104354),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.467698726104354),
                                    ("Cyber Mondayyear (latent)", -6.062233617996189),
                                    ("hhhmmon <day>", -5.551407994230199),
                                    ("Yom HaShoahyear (latent)", -6.062233617996189),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.062233617996189),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.467698726104354),
                                    ("Septemberyear (latent)", -6.062233617996189),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.963621329328079),
                                    ("Halloweenyear (latent)", -6.467698726104354),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.467698726104354),
                                    ("at <time-of-day>intersect", -5.551407994230199),
                                    ("Rosh Hashanahyear (latent)", -5.7745515455444085),
                                    ("Dhanterasyear (latent)", -6.467698726104354),
                                    ("Tu BiShvatyear (latent)", -6.467698726104354),
                                    ("<day-of-month> (ordinal)December", -5.7745515455444085),
                                    ("Holiyear (latent)", -5.7745515455444085),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.467698726104354),
                                    ("Holika Dahanyear (latent)", -5.7745515455444085),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.062233617996189),
                                    ("dayminute", -3.1177946388297486),
                                    ("Mawlidyear (latent)", -6.467698726104354),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.062233617996189),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.467698726104354),
                                    ("Jumu'atul-Widayear (latent)", -5.551407994230199),
                                    ("minuteday", -2.7300291078209855),
                                    ("absorption of , after named dayintersect",
                                     -5.7745515455444085),
                                    ("intersectyear (latent)", -6.467698726104354),
                                    ("Orthodox Easter Sundayyear (latent)", -6.467698726104354),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.467698726104354),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.467698726104354),
                                    ("intersecthhhmm", -6.062233617996189),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.467698726104354),
                                    ("Boss's Dayyear (latent)", -6.062233617996189),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.467698726104354),
                                    ("Global Youth Service Dayyear (latent)", -6.467698726104354),
                                    ("Dhanterasin|during <named-month>|year", -6.467698726104354),
                                    ("Tisha B'Avyear (latent)", -6.467698726104354),
                                    ("Isra and Mi'rajyear (latent)", -5.551407994230199),
                                    ("at <time-of-day>on <day>", -4.858260813670253),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.062233617996189),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.7745515455444085),
                                    ("Christmasyear (latent)", -6.062233617996189),
                                    ("Naraka Chaturdashiyear (latent)", -6.062233617996189),
                                    ("Thai Pongalin|during <named-month>|year", -6.467698726104354),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.467698726104354),
                                    ("dayweek", -6.467698726104354),
                                    ("Easter Sundayyear (latent)", -5.7745515455444085),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.062233617996189),
                                    ("weekyear", -5.369086437436244),
                                    ("King's Dayyear (latent)", -4.963621329328079),
                                    ("hh:mmin|during the <part-of-day>", -5.551407994230199),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.062233617996189),
                                    ("Hanukkahyear (latent)", -5.7745515455444085),
                                    ("February<time> <part-of-day>", -6.467698726104354),
                                    ("National Grandparents Dayyear (latent)", -6.467698726104354),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.467698726104354),
                                    ("Great Lentyear (latent)", -6.467698726104354),
                                    ("tomorrowat <time-of-day>", -5.7745515455444085),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.467698726104354),
                                    ("Labor Dayyear (latent)", -6.467698726104354),
                                    ("Ugadiyear (latent)", -5.214935757608986),
                                    ("Vaisakhiyear (latent)", -5.7745515455444085),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.7745515455444085),
                                    ("last <cycle> of <time>year (latent)", -5.7745515455444085),
                                    ("at <time-of-day>tomorrow", -6.062233617996189),
                                    ("tomorrow<time-of-day> am|pm", -6.467698726104354),
                                    ("President's Dayyear (latent)", -6.467698726104354),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.467698726104354),
                                    ("Diwaliyear (latent)", -6.467698726104354),
                                    ("between <time> and <time>on <day>", -6.062233617996189),
                                    ("Black Fridayyear (latent)", -6.062233617996189),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.467698726104354),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.467698726104354),
                                    ("Chhathyear (latent)", -6.062233617996189),
                                    ("Vasant Panchamiyear (latent)", -6.467698726104354),
                                    ("Tax Dayyear (latent)", -5.551407994230199),
                                    ("Rabindra Jayantiyear (latent)", -5.214935757608986),
                                    ("St Patrick's Dayyear (latent)", -6.467698726104354),
                                    ("Thursday<time> (timezone)", -6.467698726104354),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.467698726104354),
                                    ("Pargat Diwasyear (latent)", -5.214935757608986),
                                    ("<datetime> - <datetime> (interval)July", -6.062233617996189),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.7745515455444085),
                                    ("Februaryintersect", -6.467698726104354),
                                    ("Mother's Dayyear (latent)", -6.467698726104354),
                                    ("Simchat Torahyear (latent)", -6.467698726104354),
                                    ("minuteyear", -6.467698726104354)],
                               n = 496},
                   koData =
                     ClassData{prior = -1.0262615424000834,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.13507978003065213,
                               unseen = -5.5093883366279774,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -2.469261259037152e-2),
                                    ("intersect 2 numbers", -4.119037174812472)],
                               n = 242},
                   koData =
                     ClassData{prior = -2.068669444697925, unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
