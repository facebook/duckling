...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5805139055730393, unseen = -6.135564891081739,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 460},
                   koData =
                     ClassData{prior = -0.8200961832304088,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45254845114505404,
                               unseen = -7.141245122350491,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.447305862541213),
                                    ("Father's Dayyear (latent)", -6.447305862541213),
                                    ("Karva Chauthyear (latent)", -6.447305862541213),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.447305862541213),
                                    ("Maha Shivaratriyear (latent)", -6.447305862541213),
                                    ("Ramadanyear (latent)", -5.531015130667058),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.061011501421323),
                                    ("Military Spouse Dayyear (latent)", -6.447305862541213),
                                    ("Bhai Doojyear (latent)", -6.447305862541213),
                                    ("hourday", -4.4324028419989485),
                                    ("dayhour", -3.5028668833747725),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.061011501421323),
                                    ("Martin Luther King's Dayyear (latent)", -6.041840754433049),
                                    ("Shemini Atzeretyear (latent)", -6.447305862541213),
                                    ("daymonth", -4.4324028419989485),
                                    ("monthday", -6.041840754433049),
                                    ("monthyear", -4.655546393313158),
                                    ("Yom Ha'atzmautyear (latent)", -6.447305862541213),
                                    ("Vijayadashamiyear (latent)", -6.447305862541213),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.061011501421323),
                                    ("Thanksgiving Dayyear (latent)", -5.348693573873104),
                                    ("Thai Pongalyear (latent)", -5.754158681981268),
                                    ("Thiru Onamyear (latent)", -5.754158681981268),
                                    ("hhhmmabsorption of , after named day", -6.447305862541213),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.447305862541213),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.531015130667058),
                                    ("<day-of-month> (ordinal)Wednesday", -6.447305862541213),
                                    ("Krishna Janmashtamiyear (latent)", -6.041840754433049),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.447305862541213),
                                    ("houryear", -5.531015130667058),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.447305862541213),
                                    ("Christmas<time-of-day> am|pm", -6.447305862541213),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.447305862541213),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.754158681981268),
                                    ("intersectin|during <named-month>|year", -6.447305862541213),
                                    ("<time-of-day> am|pmintersect", -5.194542894045845),
                                    ("Earth Houryear (latent)", -6.447305862541213),
                                    ("Octoberyear (latent)", -4.943228465764939),
                                    ("intersect<time-of-day> am|pm", -6.447305862541213),
                                    ("Mattu Pongalyear (latent)", -6.447305862541213),
                                    ("Daylight Saving Start Dayyear (latent)", -5.531015130667058),
                                    ("Shavuotyear (latent)", -6.447305862541213),
                                    ("Parsi New Yearyear (latent)", -5.531015130667058),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.447305862541213),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.447305862541213),
                                    ("todayin|within|after <duration>", -6.447305862541213),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.041840754433049),
                                    ("Marchyear (latent)", -6.447305862541213),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.041840754433049),
                                    ("Sukkotyear (latent)", -6.041840754433049),
                                    ("hhhmmintersect", -6.041840754433049),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.041840754433049),
                                    ("Daylight Saving End Dayyear (latent)", -5.531015130667058),
                                    ("Clean Mondayyear (latent)", -6.041840754433049),
                                    ("monthhour", -6.041840754433049),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.754158681981268),
                                    ("todayat <time-of-day>", -6.447305862541213),
                                    ("Thursday<time> timezone", -4.049410589742843),
                                    ("time-of-day (latent)tonight", -6.041840754433049),
                                    ("from|since|after <time>December", -6.447305862541213),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.447305862541213),
                                    ("<time-of-day> am|pmon <day>", -4.4324028419989485),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.447305862541213),
                                    ("yyyy-mm-ddhh:mm:ss", -6.041840754433049),
                                    ("Tax Daythis|last|next <cycle>", -6.447305862541213),
                                    ("dayday", -3.739255661439003),
                                    ("<time> <part-of-day>at <time-of-day>", -6.447305862541213),
                                    ("mm/ddat <time-of-day>", -6.447305862541213),
                                    ("tonightat <time-of-day>", -6.447305862541213),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.754158681981268),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.447305862541213),
                                    ("today<time-of-day> am|pm", -6.447305862541213),
                                    ("Februarythe <day-of-month> (ordinal)", -6.041840754433049),
                                    ("at <time-of-day><time> <part-of-day>", -6.447305862541213),
                                    ("<day-of-month> (ordinal)intersect", -6.041840754433049),
                                    ("mm/dd<time-of-day> am|pm", -6.447305862541213),
                                    ("hourhour", -4.367864320861377),
                                    ("Mahavir Jayantiyear (latent)", -6.041840754433049),
                                    ("Navaratriin|during <named-month>|year", -6.447305862541213),
                                    ("Wednesdaythis|last|next <cycle>", -6.447305862541213),
                                    ("Lentyear (latent)", -6.447305862541213),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.575503685639622),
                                    ("Boghiyear (latent)", -6.447305862541213),
                                    ("dayyear", -1.827247064059371),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.447305862541213),
                                    ("Thursdayfrom|since|after <time>", -6.041840754433049),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.447305862541213),
                                    ("Thursdayat <time-of-day>", -5.754158681981268),
                                    ("Islamic New Yearyear (latent)", -6.041840754433049),
                                    ("Laylat al-Qadryear (latent)", -5.531015130667058),
                                    ("Shrove Tuesdayyear (latent)", -6.447305862541213),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.754158681981268),
                                    ("<time-of-day> am|pmtomorrow", -5.754158681981268),
                                    ("Yom Kippuryear (latent)", -6.447305862541213),
                                    ("<day-of-month> (ordinal)Tuesday", -6.041840754433049),
                                    ("<part-of-day> of <time>year (latent)", -6.447305862541213),
                                    ("minutehour", -5.194542894045845),
                                    ("Kaanum Pongalyear (latent)", -6.041840754433049),
                                    ("Maha Saptamiyear (latent)", -6.447305862541213),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.041840754433049),
                                    ("time-of-day (latent)tomorrow", -5.531015130667058),
                                    ("part of daysat <time-of-day>", -6.041840754433049),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.4324028419989485),
                                    ("for <duration> from <time>December", -6.447305862541213),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.447305862541213),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.194542894045845),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.194542894045845),
                                    ("time-of-day (latent)this <part-of-day>", -6.447305862541213),
                                    ("Pentecostyear (latent)", -6.447305862541213),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.194542894045845),
                                    ("<day-of-month> (ordinal)February", -6.447305862541213),
                                    ("Eid al-Fitryear (latent)", -5.531015130667058),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.447305862541213),
                                    ("Mondayin|during the <part-of-day>", -6.447305862541213),
                                    ("Chhathin|during <named-month>|year", -6.447305862541213),
                                    ("Diwaliin|during <named-month>|year", -6.447305862541213),
                                    ("Vaisakhiin|during <named-month>|year", -6.447305862541213),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.194542894045845),
                                    ("Raksha Bandhanyear (latent)", -6.447305862541213),
                                    ("daysecond", -6.041840754433049),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.041840754433049),
                                    ("Emancipation Dayyear (latent)", -5.754158681981268),
                                    ("Ashurayear (latent)", -6.447305862541213),
                                    ("Tuesdayin|during <named-month>|year", -6.447305862541213),
                                    ("Chinese New Yearyear (latent)", -6.447305862541213),
                                    ("tomorrowintersect", -6.447305862541213),
                                    ("Lag BaOmeryear (latent)", -6.447305862541213),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.447305862541213),
                                    ("Eid al-Adhayear (latent)", -4.307239699044942),
                                    ("intersectin|during the <part-of-day>", -6.447305862541213),
                                    ("Palm Sundayyear (latent)", -6.447305862541213),
                                    ("Christmasat <time-of-day>", -6.447305862541213),
                                    ("Passoveryear (latent)", -6.447305862541213),
                                    ("Lazarus Saturdayyear (latent)", -6.447305862541213),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.447305862541213),
                                    ("Cyber Mondayyear (latent)", -6.041840754433049),
                                    ("hhhmmon <day>", -5.531015130667058),
                                    ("Yom HaShoahyear (latent)", -6.041840754433049),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.041840754433049),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.447305862541213),
                                    ("Septemberyear (latent)", -6.041840754433049),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.943228465764939),
                                    ("Halloweenyear (latent)", -6.447305862541213),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.447305862541213),
                                    ("at <time-of-day>intersect", -5.531015130667058),
                                    ("Rosh Hashanahyear (latent)", -5.754158681981268),
                                    ("Dhanterasyear (latent)", -6.447305862541213),
                                    ("Tu BiShvatyear (latent)", -6.447305862541213),
                                    ("<day-of-month> (ordinal)December", -5.754158681981268),
                                    ("Holiyear (latent)", -5.754158681981268),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.447305862541213),
                                    ("Holika Dahanyear (latent)", -5.754158681981268),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.041840754433049),
                                    ("dayminute", -3.0974017752666083),
                                    ("Mawlidyear (latent)", -6.447305862541213),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.041840754433049),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.447305862541213),
                                    ("Jumu'atul-Widayear (latent)", -5.531015130667058),
                                    ("minuteday", -2.7096362442578448),
                                    ("absorption of , after named dayintersect",
                                     -5.754158681981268),
                                    ("intersectyear (latent)", -6.447305862541213),
                                    ("Orthodox Easter Sundayyear (latent)", -6.447305862541213),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.447305862541213),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.447305862541213),
                                    ("intersecthhhmm", -6.041840754433049),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.447305862541213),
                                    ("Boss's Dayyear (latent)", -6.041840754433049),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.447305862541213),
                                    ("Global Youth Service Dayyear (latent)", -6.447305862541213),
                                    ("Dhanterasin|during <named-month>|year", -6.447305862541213),
                                    ("Tisha B'Avyear (latent)", -6.447305862541213),
                                    ("Isra and Mi'rajyear (latent)", -5.531015130667058),
                                    ("at <time-of-day>on <day>", -4.837867950107113),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.041840754433049),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.754158681981268),
                                    ("Christmasyear (latent)", -6.041840754433049),
                                    ("Naraka Chaturdashiyear (latent)", -6.041840754433049),
                                    ("Thai Pongalin|during <named-month>|year", -6.447305862541213),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.447305862541213),
                                    ("dayweek", -6.447305862541213),
                                    ("Easter Sundayyear (latent)", -5.754158681981268),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.041840754433049),
                                    ("weekyear", -5.348693573873104),
                                    ("King's Dayyear (latent)", -4.943228465764939),
                                    ("hh:mmin|during the <part-of-day>", -5.531015130667058),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.041840754433049),
                                    ("Hanukkahyear (latent)", -5.754158681981268),
                                    ("February<time> <part-of-day>", -6.447305862541213),
                                    ("National Grandparents Dayyear (latent)", -6.447305862541213),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.447305862541213),
                                    ("Great Lentyear (latent)", -6.447305862541213),
                                    ("tomorrowat <time-of-day>", -5.754158681981268),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.447305862541213),
                                    ("Labor Dayyear (latent)", -6.447305862541213),
                                    ("Vaisakhiyear (latent)", -5.754158681981268),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.754158681981268),
                                    ("last <cycle> of <time>year (latent)", -5.754158681981268),
                                    ("at <time-of-day>tomorrow", -6.041840754433049),
                                    ("tomorrow<time-of-day> am|pm", -6.447305862541213),
                                    ("President's Dayyear (latent)", -6.447305862541213),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.447305862541213),
                                    ("Diwaliyear (latent)", -6.447305862541213),
                                    ("between <time> and <time>on <day>", -6.041840754433049),
                                    ("Black Fridayyear (latent)", -6.041840754433049),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.447305862541213),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.447305862541213),
                                    ("Chhathyear (latent)", -6.041840754433049),
                                    ("Vasant Panchamiyear (latent)", -6.447305862541213),
                                    ("Tax Dayyear (latent)", -5.531015130667058),
                                    ("Rabindra Jayantiyear (latent)", -5.194542894045845),
                                    ("St Patrick's Dayyear (latent)", -6.447305862541213),
                                    ("Thursday<time> (timezone)", -6.447305862541213),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.447305862541213),
                                    ("<datetime> - <datetime> (interval)July", -6.041840754433049),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.754158681981268),
                                    ("Februaryintersect", -6.447305862541213),
                                    ("Mother's Dayyear (latent)", -6.447305862541213),
                                    ("Simchat Torahyear (latent)", -6.447305862541213),
                                    ("minuteyear", -6.447305862541213)],
                               n = 484},
                   koData =
                     ClassData{prior = -1.0106158516743473, unseen = -6.744059186311348,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.545656058455684),
                                    ("hourday", -3.651838182433587),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.049733455231958),
                                    ("<day-of-month> (ordinal)August", -6.049733455231958),
                                    ("dayhour", -3.375584805805429),
                                    ("<time> timezoneyear (latent)", -5.356586274672012),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.133442723357803),
                                    ("Tuesdayfrom|since|after <time>", -5.356586274672012),
                                    ("daymonth", -3.375584805805429),
                                    ("monthyear", -4.79697048673659),
                                    ("<time-of-day> am|pmyear (latent)", -5.356586274672012),
                                    ("Thai Pongalyear (latent)", -5.356586274672012),
                                    ("intersecthh:mm", -6.049733455231958),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.644268347123793),
                                    ("<day-of-month> (ordinal)Wednesday", -6.049733455231958),
                                    ("houryear", -4.663439094112067),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.049733455231958),
                                    ("<day-of-month> (ordinal)October", -6.049733455231958),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.356586274672012),
                                    ("hournograin", -4.79697048673659),
                                    ("<time-of-day> am|pmintersect", -4.79697048673659),
                                    ("Octoberyear (latent)", -6.049733455231958),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.644268347123793),
                                    ("until <time>on <day>", -5.356586274672012),
                                    ("time-of-day (latent)intersect", -5.356586274672012),
                                    ("todayin <number> (implicit minutes)", -6.049733455231958),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.356586274672012),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.049733455231958),
                                    ("hh:mmon <day>", -4.79697048673659),
                                    ("hhhmmintersect", -5.644268347123793),
                                    ("absorption of , after named dayJuly", -5.133442723357803),
                                    ("from|since|after <time>July", -5.644268347123793),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.133442723357803),
                                    ("Clean Mondayyear (latent)", -6.049733455231958),
                                    ("monthhour", -6.049733455231958),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.644268347123793),
                                    ("hourmonth", -4.177931278330366),
                                    ("todayat <time-of-day>", -6.049733455231958),
                                    ("hhhmmyear (latent)", -4.79697048673659),
                                    ("from|since|after <time>December", -6.049733455231958),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.049733455231958),
                                    ("<time-of-day> am|pmon <day>", -4.79697048673659),
                                    ("Mondayyear (latent)", -4.951121166563848),
                                    ("dayday", -4.663439094112067),
                                    ("mm/ddat <time-of-day>", -5.644268347123793),
                                    ("on <day>September", -5.356586274672012),
                                    ("time-of-day (latent)September", -5.644268347123793),
                                    ("hourhour", -5.644268347123793),
                                    ("time-of-day (latent)on <day>", -4.545656058455684),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.644268347123793),
                                    ("dayyear", -3.054001181677967),
                                    ("Thursdaymm/dd", -6.049733455231958),
                                    ("New Year's Dayyear (latent)", -5.133442723357803),
                                    ("time-of-day (latent)Sunday", -5.644268347123793),
                                    ("Thursdayfrom|since|after <time>", -4.344985362993532),
                                    ("Thursdayat <time-of-day>", -4.440295542797857),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.049733455231958),
                                    ("Aprilyear (latent)", -6.049733455231958),
                                    ("the <day-of-month> (ordinal)July", -6.049733455231958),
                                    ("the <day-of-month> (number)July", -6.049733455231958),
                                    ("monthminute", -6.049733455231958),
                                    ("<time-of-day> am|pmtomorrow", -6.049733455231958),
                                    ("Thursdayhh:mm", -5.133442723357803),
                                    ("<day-of-month> (ordinal)Tuesday", -5.644268347123793),
                                    ("minutemonth", -3.909667291735687),
                                    ("time-of-day (latent)Friday", -5.644268347123793),
                                    ("minutehour", -6.049733455231958),
                                    ("Augustyear (latent)", -5.644268347123793),
                                    ("week-endin|during <named-month>|year", -6.049733455231958),
                                    ("time-of-day (latent)Tuesday", -5.644268347123793),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.644268347123793),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.049733455231958),
                                    ("Sundayyear (latent)", -5.133442723357803),
                                    ("Christmasat <time-of-day>", -6.049733455231958),
                                    ("from|since|after <time>year (latent)", -4.951121166563848),
                                    ("hhhmmon <day>", -5.133442723357803),
                                    ("yesterday<time-of-day> am|pm", -6.049733455231958),
                                    ("<day-of-month> (ordinal)July", -5.356586274672012),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.049733455231958),
                                    ("mm/ddyear (latent)", -6.049733455231958),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.049733455231958),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.049733455231958),
                                    ("at <time-of-day>intersect", -5.133442723357803),
                                    ("hh:mmyear (latent)", -4.663439094112067),
                                    ("Holiyear (latent)", -6.049733455231958),
                                    ("until <time><time-of-day> am|pm", -6.049733455231958),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.644268347123793),
                                    ("dayminute", -3.1875325743024896),
                                    ("yyyy-mm-ddhh:mm", -5.644268347123793),
                                    ("intersectfrom|since|after <time>", -5.644268347123793),
                                    ("intersectSeptember", -4.177931278330366),
                                    ("minuteday", -2.8927330340818447),
                                    ("absorption of , after named dayintersect",
                                     -6.049733455231958),
                                    ("intersectyear (latent)", -6.049733455231958),
                                    ("Februaryin|during the <part-of-day>", -6.049733455231958),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.049733455231958),
                                    ("time-of-day (latent)July", -5.356586274672012),
                                    ("Saturdayyear (latent)", -6.049733455231958),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.049733455231958),
                                    ("at <time-of-day>on <day>", -5.133442723357803),
                                    ("absorption of , after named daySeptember", -4.79697048673659),
                                    ("Naraka Chaturdashiyear (latent)", -6.049733455231958),
                                    ("from|since|after <time>on <day>", -5.133442723357803),
                                    ("dayweek", -6.049733455231958),
                                    ("Easter Sundayyear (latent)", -5.644268347123793),
                                    ("Thursday<time-of-day> am|pm", -4.79697048673659),
                                    ("weekyear", -5.644268347123793),
                                    ("time-of-day (latent)Thursday", -5.644268347123793),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.049733455231958),
                                    ("<day-of-month> (ordinal)April", -6.049733455231958),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.644268347123793),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.356586274672012),
                                    ("Sundayfrom|since|after <time>", -6.049733455231958),
                                    ("absorption of , after named dayFebruary", -5.133442723357803),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.644268347123793),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.049733455231958),
                                    ("tomorrowat <time-of-day>", -6.049733455231958),
                                    ("daynograin", -5.644268347123793),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.644268347123793),
                                    ("last <cycle> of <time>year (latent)", -5.644268347123793),
                                    ("tomorrow<time-of-day> am|pm", -6.049733455231958),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.356586274672012),
                                    ("Diwaliyear (latent)", -5.644268347123793),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.049733455231958),
                                    ("Fridayyear (latent)", -5.644268347123793),
                                    ("time-of-day (latent)April", -6.049733455231958),
                                    ("minuteyear", -3.8525088778957386)],
                               n = 277}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1416505170630268, unseen = -5.459585514144159,
                               likelihoods =
                                 HashMap.fromList
