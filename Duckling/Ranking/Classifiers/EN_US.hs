...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5892637700451322, unseen = -6.115892125483034,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 451},
                   koData =
                     ClassData{prior = -0.8090868977220395,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4563407787686177, unseen = -7.130098510125578,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.436150368369428),
                                    ("Father's Dayyear (latent)", -6.436150368369428),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.436150368369428),
                                    ("Ramadanyear (latent)", -5.519859636495273),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.049856007249537),
                                    ("Military Spouse Dayyear (latent)", -6.436150368369428),
                                    ("Bhai Doojyear (latent)", -6.436150368369428),
                                    ("hourday", -4.421247347827163),
                                    ("dayhour", -3.491711389202987),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.049856007249537),
                                    ("Martin Luther King's Dayyear (latent)", -6.030685260261263),
                                    ("Shemini Atzeretyear (latent)", -6.436150368369428),
                                    ("daymonth", -4.421247347827163),
                                    ("monthday", -6.030685260261263),
                                    ("monthyear", -4.6443908991413725),
                                    ("Yom Ha'atzmautyear (latent)", -6.436150368369428),
                                    ("Vijayadashamiyear (latent)", -6.436150368369428),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.049856007249537),
                                    ("Thanksgiving Dayyear (latent)", -5.337538079701318),
                                    ("Thai Pongalyear (latent)", -5.7430031878094825),
                                    ("Thiru Onamyear (latent)", -5.7430031878094825),
                                    ("hhhmmabsorption of , after named day", -6.436150368369428),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.436150368369428),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.519859636495273),
                                    ("<day-of-month> (ordinal)Wednesday", -6.436150368369428),
                                    ("Krishna Janmashtamiyear (latent)", -6.030685260261263),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.436150368369428),
                                    ("houryear", -5.519859636495273),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.436150368369428),
                                    ("Christmas<time-of-day> am|pm", -6.436150368369428),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.436150368369428),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7430031878094825),
                                    ("intersectin|during <named-month>|year", -6.436150368369428),
                                    ("<time-of-day> am|pmintersect", -5.18338739987406),
                                    ("Earth Houryear (latent)", -6.436150368369428),
                                    ("Octoberyear (latent)", -4.932072971593153),
                                    ("intersect<time-of-day> am|pm", -6.436150368369428),
                                    ("Mattu Pongalyear (latent)", -6.436150368369428),
                                    ("Daylight Saving Start Dayyear (latent)", -5.519859636495273),
                                    ("Shavuotyear (latent)", -6.436150368369428),
                                    ("Parsi New Yearyear (latent)", -5.519859636495273),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.436150368369428),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.436150368369428),
                                    ("todayin|within|after <duration>", -6.436150368369428),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.030685260261263),
                                    ("Marchyear (latent)", -6.436150368369428),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.030685260261263),
                                    ("Sukkotyear (latent)", -6.030685260261263),
                                    ("hhhmmintersect", -6.030685260261263),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.030685260261263),
                                    ("Daylight Saving End Dayyear (latent)", -5.519859636495273),
                                    ("Clean Mondayyear (latent)", -6.030685260261263),
                                    ("monthhour", -6.030685260261263),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7430031878094825),
                                    ("todayat <time-of-day>", -6.436150368369428),
                                    ("Thursday<time> timezone", -4.038255095571057),
                                    ("time-of-day (latent)tonight", -6.030685260261263),
                                    ("from|since|after <time>December", -6.436150368369428),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.436150368369428),
                                    ("<time-of-day> am|pmon <day>", -4.421247347827163),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.436150368369428),
                                    ("yyyy-mm-ddhh:mm:ss", -6.030685260261263),
                                    ("Tax Daythis|last|next <cycle>", -6.436150368369428),
                                    ("dayday", -3.7281001672672174),
                                    ("<time> <part-of-day>at <time-of-day>", -6.436150368369428),
                                    ("mm/ddat <time-of-day>", -6.436150368369428),
                                    ("tonightat <time-of-day>", -6.436150368369428),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.7430031878094825),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.436150368369428),
                                    ("today<time-of-day> am|pm", -6.436150368369428),
                                    ("Februarythe <day-of-month> (ordinal)", -6.030685260261263),
                                    ("at <time-of-day><time> <part-of-day>", -6.436150368369428),
                                    ("<day-of-month> (ordinal)intersect", -6.030685260261263),
                                    ("mm/dd<time-of-day> am|pm", -6.436150368369428),
                                    ("hourhour", -4.356708826689592),
                                    ("Navaratriin|during <named-month>|year", -6.436150368369428),
                                    ("Wednesdaythis|last|next <cycle>", -6.436150368369428),
                                    ("Lentyear (latent)", -6.436150368369428),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.564348191467836),
                                    ("Boghiyear (latent)", -6.436150368369428),
                                    ("dayyear", -1.8410305182348379),
                                    ("Thursdayfrom|since|after <time>", -6.030685260261263),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.436150368369428),
                                    ("Thursdayat <time-of-day>", -5.7430031878094825),
                                    ("Islamic New Yearyear (latent)", -6.030685260261263),
                                    ("Laylat al-Qadryear (latent)", -5.519859636495273),
                                    ("Shrove Tuesdayyear (latent)", -6.436150368369428),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.7430031878094825),
                                    ("<time-of-day> am|pmtomorrow", -5.7430031878094825),
                                    ("Yom Kippuryear (latent)", -6.436150368369428),
                                    ("<day-of-month> (ordinal)Tuesday", -6.030685260261263),
                                    ("<part-of-day> of <time>year (latent)", -6.436150368369428),
                                    ("minutehour", -5.18338739987406),
                                    ("Kaanum Pongalyear (latent)", -6.030685260261263),
                                    ("Maha Saptamiyear (latent)", -6.436150368369428),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.030685260261263),
                                    ("time-of-day (latent)tomorrow", -5.519859636495273),
                                    ("part of daysat <time-of-day>", -6.030685260261263),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.421247347827163),
                                    ("for <duration> from <time>December", -6.436150368369428),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.436150368369428),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.18338739987406),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.18338739987406),
                                    ("time-of-day (latent)this <part-of-day>", -6.436150368369428),
                                    ("Pentecostyear (latent)", -6.436150368369428),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.18338739987406),
                                    ("<day-of-month> (ordinal)February", -6.436150368369428),
                                    ("Eid al-Fitryear (latent)", -5.519859636495273),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.436150368369428),
                                    ("Mondayin|during the <part-of-day>", -6.436150368369428),
                                    ("Chhathin|during <named-month>|year", -6.436150368369428),
                                    ("Diwaliin|during <named-month>|year", -6.436150368369428),
                                    ("Vaisakhiin|during <named-month>|year", -6.436150368369428),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.18338739987406),
                                    ("Raksha Bandhanyear (latent)", -6.436150368369428),
                                    ("daysecond", -6.030685260261263),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.030685260261263),
                                    ("Emancipation Dayyear (latent)", -5.7430031878094825),
                                    ("Ashurayear (latent)", -6.436150368369428),
                                    ("Tuesdayin|during <named-month>|year", -6.436150368369428),
                                    ("Chinese New Yearyear (latent)", -6.436150368369428),
                                    ("tomorrowintersect", -6.436150368369428),
                                    ("Lag BaOmeryear (latent)", -6.436150368369428),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.436150368369428),
                                    ("Eid al-Adhayear (latent)", -4.296084204873157),
                                    ("intersectin|during the <part-of-day>", -6.436150368369428),
                                    ("Palm Sundayyear (latent)", -6.436150368369428),
                                    ("Christmasat <time-of-day>", -6.436150368369428),
                                    ("Passoveryear (latent)", -6.436150368369428),
                                    ("Lazarus Saturdayyear (latent)", -6.436150368369428),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.436150368369428),
                                    ("Cyber Mondayyear (latent)", -6.030685260261263),
                                    ("hhhmmon <day>", -5.519859636495273),
                                    ("Yom HaShoahyear (latent)", -6.030685260261263),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.030685260261263),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.436150368369428),
                                    ("Septemberyear (latent)", -6.030685260261263),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.932072971593153),
                                    ("Halloweenyear (latent)", -6.436150368369428),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.436150368369428),
                                    ("at <time-of-day>intersect", -5.519859636495273),
                                    ("Rosh Hashanahyear (latent)", -5.7430031878094825),
                                    ("Dhanterasyear (latent)", -6.436150368369428),
                                    ("Tu BiShvatyear (latent)", -6.436150368369428),
                                    ("<day-of-month> (ordinal)December", -5.7430031878094825),
                                    ("Holiyear (latent)", -5.7430031878094825),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.436150368369428),
                                    ("Holika Dahanyear (latent)", -5.7430031878094825),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.030685260261263),
                                    ("dayminute", -3.086246281094823),
                                    ("Mawlidyear (latent)", -6.436150368369428),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.030685260261263),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.436150368369428),
                                    ("Jumu'atul-Widayear (latent)", -5.519859636495273),
                                    ("minuteday", -2.6984807500860595),
                                    ("absorption of , after named dayintersect",
                                     -5.7430031878094825),
                                    ("intersectyear (latent)", -6.436150368369428),
                                    ("Orthodox Easter Sundayyear (latent)", -6.436150368369428),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.436150368369428),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.436150368369428),
                                    ("intersecthhhmm", -6.030685260261263),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.436150368369428),
                                    ("Boss's Dayyear (latent)", -6.030685260261263),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.436150368369428),
                                    ("Global Youth Service Dayyear (latent)", -6.436150368369428),
                                    ("Dhanterasin|during <named-month>|year", -6.436150368369428),
                                    ("Tisha B'Avyear (latent)", -6.436150368369428),
                                    ("Isra and Mi'rajyear (latent)", -5.519859636495273),
                                    ("at <time-of-day>on <day>", -4.826712455935327),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.030685260261263),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.7430031878094825),
                                    ("Christmasyear (latent)", -6.030685260261263),
                                    ("Naraka Chaturdashiyear (latent)", -6.030685260261263),
                                    ("Thai Pongalin|during <named-month>|year", -6.436150368369428),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.436150368369428),
                                    ("dayweek", -6.436150368369428),
                                    ("Easter Sundayyear (latent)", -5.7430031878094825),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.030685260261263),
                                    ("weekyear", -5.337538079701318),
                                    ("King's Dayyear (latent)", -4.932072971593153),
                                    ("hh:mmin|during the <part-of-day>", -5.519859636495273),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.030685260261263),
                                    ("Hanukkahyear (latent)", -5.7430031878094825),
                                    ("February<time> <part-of-day>", -6.436150368369428),
                                    ("National Grandparents Dayyear (latent)", -6.436150368369428),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.436150368369428),
                                    ("Great Lentyear (latent)", -6.436150368369428),
                                    ("tomorrowat <time-of-day>", -5.7430031878094825),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.436150368369428),
                                    ("Labor Dayyear (latent)", -6.436150368369428),
                                    ("Vaisakhiyear (latent)", -5.7430031878094825),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.7430031878094825),
                                    ("last <cycle> of <time>year (latent)", -5.7430031878094825),
                                    ("at <time-of-day>tomorrow", -6.030685260261263),
                                    ("tomorrow<time-of-day> am|pm", -6.436150368369428),
                                    ("President's Dayyear (latent)", -6.436150368369428),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.436150368369428),
                                    ("Diwaliyear (latent)", -6.436150368369428),
                                    ("between <time> and <time>on <day>", -6.030685260261263),
                                    ("Black Fridayyear (latent)", -6.030685260261263),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.436150368369428),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.436150368369428),
                                    ("Chhathyear (latent)", -6.030685260261263),
                                    ("Vasant Panchamiyear (latent)", -6.436150368369428),
                                    ("Tax Dayyear (latent)", -5.519859636495273),
                                    ("Rabindra Jayantiyear (latent)", -5.18338739987406),
                                    ("St Patrick's Dayyear (latent)", -6.436150368369428),
                                    ("Thursday<time> (timezone)", -6.436150368369428),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.436150368369428),
                                    ("<datetime> - <datetime> (interval)July", -6.030685260261263),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.7430031878094825),
                                    ("Februaryintersect", -6.436150368369428),
                                    ("Mother's Dayyear (latent)", -6.436150368369428),
                                    ("Simchat Torahyear (latent)", -6.436150368369428),
                                    ("minuteyear", -6.436150368369428)],
                               n = 479},
                   koData =
                     ClassData{prior = -1.0040238699921946, unseen = -6.739336627357174,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.540927917259737),
                                    ("hourday", -3.6471100412376414),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.045005314036012),
                                    ("<day-of-month> (ordinal)August", -6.045005314036012),
                                    ("dayhour", -3.370856664609483),
                                    ("<time> timezoneyear (latent)", -5.351858133476067),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.128714582161857),
                                    ("Tuesdayfrom|since|after <time>", -5.351858133476067),
                                    ("daymonth", -3.370856664609483),
                                    ("monthyear", -4.792242345540644),
                                    ("<time-of-day> am|pmyear (latent)", -5.351858133476067),
                                    ("Thai Pongalyear (latent)", -5.351858133476067),
                                    ("intersecthh:mm", -6.045005314036012),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.639540205927847),
                                    ("<day-of-month> (ordinal)Wednesday", -6.045005314036012),
                                    ("houryear", -4.658710952916121),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.045005314036012),
                                    ("<day-of-month> (ordinal)October", -6.045005314036012),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.351858133476067),
                                    ("hournograin", -4.792242345540644),
                                    ("<time-of-day> am|pmintersect", -4.792242345540644),
                                    ("Octoberyear (latent)", -6.045005314036012),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.639540205927847),
                                    ("until <time>on <day>", -5.351858133476067),
                                    ("time-of-day (latent)intersect", -5.351858133476067),
                                    ("todayin <number> (implicit minutes)", -6.045005314036012),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.351858133476067),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.045005314036012),
                                    ("hh:mmon <day>", -4.792242345540644),
                                    ("hhhmmintersect", -5.639540205927847),
                                    ("absorption of , after named dayJuly", -5.128714582161857),
                                    ("from|since|after <time>July", -5.639540205927847),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.128714582161857),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.639540205927847),
                                    ("hourmonth", -4.17320313713442),
                                    ("todayat <time-of-day>", -6.045005314036012),
                                    ("hhhmmyear (latent)", -4.792242345540644),
                                    ("from|since|after <time>December", -6.045005314036012),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.045005314036012),
                                    ("<time-of-day> am|pmon <day>", -4.792242345540644),
                                    ("Mondayyear (latent)", -4.946393025367902),
                                    ("dayday", -4.658710952916121),
                                    ("mm/ddat <time-of-day>", -5.639540205927847),
                                    ("on <day>September", -5.351858133476067),
                                    ("time-of-day (latent)September", -5.639540205927847),
                                    ("hourhour", -5.639540205927847),
                                    ("time-of-day (latent)on <day>", -4.540927917259737),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.639540205927847),
                                    ("dayyear", -3.0492730404820207),
                                    ("Thursdaymm/dd", -6.045005314036012),
                                    ("New Year's Dayyear (latent)", -5.128714582161857),
                                    ("time-of-day (latent)Sunday", -5.639540205927847),
                                    ("Thursdayfrom|since|after <time>", -4.340257221797587),
                                    ("Thursdayat <time-of-day>", -4.4355674016019115),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.045005314036012),
                                    ("Aprilyear (latent)", -6.045005314036012),
                                    ("the <day-of-month> (ordinal)July", -6.045005314036012),
                                    ("the <day-of-month> (number)July", -6.045005314036012),
                                    ("monthminute", -6.045005314036012),
                                    ("<time-of-day> am|pmtomorrow", -6.045005314036012),
                                    ("Thursdayhh:mm", -5.128714582161857),
                                    ("<day-of-month> (ordinal)Tuesday", -5.639540205927847),
                                    ("minutemonth", -3.904939150539741),
                                    ("time-of-day (latent)Friday", -5.639540205927847),
                                    ("minutehour", -6.045005314036012),
                                    ("Augustyear (latent)", -5.639540205927847),
                                    ("week-endin|during <named-month>|year", -6.045005314036012),
                                    ("time-of-day (latent)Tuesday", -5.639540205927847),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.639540205927847),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.045005314036012),
                                    ("Sundayyear (latent)", -5.128714582161857),
                                    ("Christmasat <time-of-day>", -6.045005314036012),
                                    ("from|since|after <time>year (latent)", -4.946393025367902),
                                    ("hhhmmon <day>", -5.128714582161857),
                                    ("yesterday<time-of-day> am|pm", -6.045005314036012),
                                    ("<day-of-month> (ordinal)July", -5.351858133476067),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.045005314036012),
                                    ("mm/ddyear (latent)", -6.045005314036012),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.045005314036012),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.045005314036012),
                                    ("at <time-of-day>intersect", -5.128714582161857),
                                    ("hh:mmyear (latent)", -4.658710952916121),
                                    ("Holiyear (latent)", -6.045005314036012),
                                    ("until <time><time-of-day> am|pm", -6.045005314036012),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.639540205927847),
                                    ("dayminute", -3.1828044331065435),
                                    ("yyyy-mm-ddhh:mm", -5.639540205927847),
                                    ("intersectfrom|since|after <time>", -5.639540205927847),
                                    ("intersectSeptember", -4.17320313713442),
                                    ("minuteday", -2.8880048928858986),
                                    ("absorption of , after named dayintersect",
                                     -6.045005314036012),
                                    ("intersectyear (latent)", -6.045005314036012),
                                    ("Februaryin|during the <part-of-day>", -6.045005314036012),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.045005314036012),
                                    ("time-of-day (latent)July", -5.351858133476067),
                                    ("Saturdayyear (latent)", -6.045005314036012),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.045005314036012),
                                    ("at <time-of-day>on <day>", -5.128714582161857),
                                    ("absorption of , after named daySeptember",
                                     -4.792242345540644),
                                    ("Naraka Chaturdashiyear (latent)", -6.045005314036012),
                                    ("from|since|after <time>on <day>", -5.128714582161857),
                                    ("dayweek", -6.045005314036012),
                                    ("Easter Sundayyear (latent)", -5.639540205927847),
                                    ("Thursday<time-of-day> am|pm", -4.792242345540644),
                                    ("weekyear", -5.639540205927847),
                                    ("time-of-day (latent)Thursday", -5.639540205927847),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.045005314036012),
                                    ("<day-of-month> (ordinal)April", -6.045005314036012),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.639540205927847),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.351858133476067),
                                    ("Sundayfrom|since|after <time>", -6.045005314036012),
                                    ("absorption of , after named dayFebruary", -5.128714582161857),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.639540205927847),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.045005314036012),
                                    ("tomorrowat <time-of-day>", -6.045005314036012),
                                    ("daynograin", -5.639540205927847),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.639540205927847),
                                    ("last <cycle> of <time>year (latent)", -5.639540205927847),
                                    ("tomorrow<time-of-day> am|pm", -6.045005314036012),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.351858133476067),
                                    ("Diwaliyear (latent)", -5.639540205927847),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.045005314036012),
                                    ("Fridayyear (latent)", -5.639540205927847),
                                    ("time-of-day (latent)April", -6.045005314036012),
                                    ("minuteyear", -3.8477807366997925)],
                               n = 277}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.14458122881110755,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -2.655023209412084e-2),
                                    ("intersect 2 numbers", -4.047427642434349)],
                               n = 225},
                   koData =
                     ClassData{prior = -2.005333569526114, unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
