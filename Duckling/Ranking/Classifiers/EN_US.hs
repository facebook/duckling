...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5856268368486891, unseen = -5.739792912179234,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 309},
                   koData =
                     ClassData{prior = -0.8136365778140716,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4583980831254277, unseen = -6.769641976852503,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.075346031088684),
                                    ("Father's Dayyear (latent)", -6.075346031088684),
                                    ("Ramadanyear (latent)", -6.075346031088684),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.822583062593316),
                                    ("Military Spouse Dayyear (latent)", -6.075346031088684),
                                    ("Bhai Doojyear (latent)", -6.075346031088684),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.822583062593316),
                                    ("hourday", -4.370597938850259),
                                    ("dayhour", -3.2719856501821494),
                                    ("Martin Luther King's Dayyear (latent)", -5.66988092298052),
                                    ("Shemini Atzeretyear (latent)", -6.075346031088684),
                                    ("daymonth", -5.382198850528739),
                                    ("monthday", -5.66988092298052),
                                    ("monthyear", -4.465908118654584),
                                    ("Yom Ha'atzmautyear (latent)", -6.075346031088684),
                                    ("Vijayadashamiyear (latent)", -6.075346031088684),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -4.689051669968793),
                                    ("Thanksgiving Dayyear (latent)", -4.976733742420574),
                                    ("Thai Pongalyear (latent)", -5.382198850528739),
                                    ("Thiru Onamyear (latent)", -5.382198850528739),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.075346031088684),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.075346031088684),
                                    ("houryear", -5.382198850528739),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.075346031088684),
                                    ("Christmas<time-of-day> am|pm", -6.075346031088684),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.075346031088684),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.382198850528739),
                                    ("<time-of-day> am|pmintersect", -4.822583062593316),
                                    ("Octoberyear (latent)", -4.822583062593316),
                                    ("intersect<time-of-day> am|pm", -6.075346031088684),
                                    ("Mattu Pongalyear (latent)", -6.075346031088684),
                                    ("Shavuotyear (latent)", -6.075346031088684),
                                    ("Dhanterasin <named-month>|year", -6.075346031088684),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.075346031088684),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.075346031088684),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.66988092298052),
                                    ("Marchyear (latent)", -6.075346031088684),
                                    ("Sukkotyear (latent)", -5.66988092298052),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.075346031088684),
                                    ("Clean Mondayyear (latent)", -5.66988092298052),
                                    ("monthhour", -5.66988092298052),
                                    ("todayat <time-of-day>", -6.075346031088684),
                                    ("Thursday<time> timezone", -4.370597938850259),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.075346031088684),
                                    ("Palm SundaySunday", -5.66988092298052),
                                    ("Tax Daythis|last|next <cycle>", -6.075346031088684),
                                    ("dayday", -3.8781214537524646),
                                    ("<time> <part-of-day>at <time-of-day>", -6.075346031088684),
                                    ("mm/ddat <time-of-day>", -6.075346031088684),
                                    ("tonightat <time-of-day>", -6.075346031088684),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.382198850528739),
                                    ("today<time-of-day> am|pm", -6.075346031088684),
                                    ("Februarythe <day-of-month> (ordinal)", -5.66988092298052),
                                    ("at <time-of-day><time> <part-of-day>", -6.075346031088684),
                                    ("mm/dd<time-of-day> am|pm", -6.075346031088684),
                                    ("hourhour", -4.822583062593316),
                                    ("<time-of-day> am|pmon <date>", -4.060443010546419),
                                    ("Wednesdaythis|last|next <cycle>", -6.075346031088684),
                                    ("Lentyear (latent)", -6.075346031088684),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.57126863431241),
                                    ("Boghiyear (latent)", -6.075346031088684),
                                    ("dayyear", -1.8781440834268757),
                                    ("Thursdayfrom|since|after <time>", -5.66988092298052),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.075346031088684),
                                    ("Thursdayat <time-of-day>", -5.66988092298052),
                                    ("Islamic New Yearyear (latent)", -5.66988092298052),
                                    ("Laylat al-Qadryear (latent)", -5.159055299214529),
                                    ("Chhathin <named-month>|year", -6.075346031088684),
                                    ("Vasant Panchamiin <named-month>|year", -6.075346031088684),
                                    ("Diwaliin <named-month>|year", -6.075346031088684),
                                    ("Shrove Tuesdayyear (latent)", -6.075346031088684),
                                    ("<time-of-day> am|pmtomorrow", -5.382198850528739),
                                    ("Yom Kippuryear (latent)", -6.075346031088684),
                                    ("<part-of-day> of <time>year (latent)", -6.075346031088684),
                                    ("minutehour", -5.159055299214529),
                                    ("Kaanum Pongalyear (latent)", -5.66988092298052),
                                    ("Maha Saptamiyear (latent)", -6.075346031088684),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.66988092298052),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.370597938850259),
                                    ("for <duration> from <time>December", -6.075346031088684),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.075346031088684),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.159055299214529),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.66988092298052),
                                    ("Pentecostyear (latent)", -6.075346031088684),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.159055299214529),
                                    ("Eid al-Fitryear (latent)", -6.075346031088684),
                                    ("Mondayin|during the <part-of-day>", -6.075346031088684),
                                    ("Raksha Bandhanyear (latent)", -6.075346031088684),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.66988092298052),
                                    ("Emancipation Dayyear (latent)", -5.382198850528739),
                                    ("Navaratriin <named-month>|year", -6.075346031088684),
                                    ("Ashurayear (latent)", -6.075346031088684),
                                    ("Chinese New Yearyear (latent)", -6.075346031088684),
                                    ("Sundayyear (latent)", -6.075346031088684),
                                    ("Lag BaOmeryear (latent)", -6.075346031088684),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.075346031088684),
                                    ("Eid al-Adhayear (latent)", -5.159055299214529),
                                    ("intersectin|during the <part-of-day>", -6.075346031088684),
                                    ("Christmasat <time-of-day>", -6.075346031088684),
                                    ("Passoveryear (latent)", -6.075346031088684),
                                    ("Lazarus Saturdayyear (latent)", -6.075346031088684),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.075346031088684),
                                    ("Cyber Mondayyear (latent)", -5.66988092298052),
                                    ("Yom HaShoahyear (latent)", -5.66988092298052),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.66988092298052),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.075346031088684),
                                    ("Thai Pongalin <named-month>|year", -6.075346031088684),
                                    ("Septemberyear (latent)", -5.66988092298052),
                                    ("mm/ddyear (latent)", -6.075346031088684),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.822583062593316),
                                    ("Halloweenyear (latent)", -6.075346031088684),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.382198850528739),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -5.159055299214529),
                                    ("at <time-of-day>intersect", -5.66988092298052),
                                    ("Rosh Hashanahyear (latent)", -6.075346031088684),
                                    ("Dhanterasyear (latent)", -6.075346031088684),
                                    ("Tu BiShvatyear (latent)", -6.075346031088684),
                                    ("Holiyear (latent)", -5.382198850528739),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.075346031088684),
                                    ("Holika Dahanyear (latent)", -5.382198850528739),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.075346031088684),
                                    ("dayminute", -3.4362887014734254),
                                    ("Mawlidyear (latent)", -6.075346031088684),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.66988092298052),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.075346031088684),
                                    ("Jumu'atul-Widayear (latent)", -5.159055299214529),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.075346031088684),
                                    ("minuteday", -2.4377598713622985),
                                    ("absorption of , after named dayintersect",
                                     -6.075346031088684),
                                    ("intersectyear (latent)", -6.075346031088684),
                                    ("Orthodox Easter Sundayyear (latent)", -6.075346031088684),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.075346031088684),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.075346031088684),
                                    ("Boss's Dayyear (latent)", -5.66988092298052),
                                    ("Global Youth Service Dayyear (latent)", -6.075346031088684),
                                    ("Tisha B'Avyear (latent)", -6.075346031088684),
                                    ("Isra and Mi'rajyear (latent)", -5.159055299214529),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.075346031088684),
                                    ("Christmasyear (latent)", -5.66988092298052),
                                    ("Naraka Chaturdashiyear (latent)", -5.66988092298052),
                                    ("at <time-of-day>on <date>", -4.976733742420574),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.465908118654584),
                                    ("dayweek", -6.075346031088684),
                                    ("Easter Sundayyear (latent)", -5.382198850528739),
                                    ("weekyear", -5.66988092298052),
                                    ("hh:mmin|during the <part-of-day>", -5.382198850528739),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.66988092298052),
                                    ("Hanukkahyear (latent)", -6.075346031088684),
                                    ("February<time> <part-of-day>", -6.075346031088684),
                                    ("National Grandparents Dayyear (latent)", -6.075346031088684),
                                    ("Tuesdayin <named-month>|year", -6.075346031088684),
                                    ("Great Lentyear (latent)", -6.075346031088684),
                                    ("tomorrowat <time-of-day>", -5.382198850528739),
                                    ("Labor Dayyear (latent)", -6.075346031088684),
                                    ("between <time> and <time>on <date>", -4.465908118654584),
                                    ("last <cycle> of <time>year (latent)", -5.382198850528739),
                                    ("at <time-of-day>tomorrow", -5.66988092298052),
                                    ("tomorrow<time-of-day> am|pm", -6.075346031088684),
                                    ("President's Dayyear (latent)", -6.075346031088684),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.075346031088684),
                                    ("Diwaliyear (latent)", -6.075346031088684),
                                    ("Black Fridayyear (latent)", -5.66988092298052),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.075346031088684),
                                    ("Chhathyear (latent)", -5.66988092298052),
                                    ("Vasant Panchamiyear (latent)", -6.075346031088684),
                                    ("Palm Sundayintersect", -6.075346031088684),
                                    ("Tax Dayyear (latent)", -5.159055299214529),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.075346031088684),
                                    ("Februaryintersect", -6.075346031088684),
                                    ("Mother's Dayyear (latent)", -6.075346031088684),
                                    ("Simchat Torahyear (latent)", -6.075346031088684)],
                               n = 325},
                   koData =
                     ClassData{prior = -1.0004762503955227, unseen = -6.395261598115449,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.784152841516532),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.13601175768285467,
                               ...
                               n = 151},
                   koData =
                     ClassData{prior = -2.0622491411394632, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
