...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5448846433579095, unseen = -6.234410725718371,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 508},
                   koData =
                     ClassData{prior = -0.8672831527674606, unseen = -5.91350300563827,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45516105620780667,
                               unseen = -7.252762418053187,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.558906771292869),
                                    ("Father's Dayyear (latent)", -6.558906771292869),
                                    ("Karva Chauthyear (latent)", -6.558906771292869),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.558906771292869),
                                    ("Maha Shivaratriyear (latent)", -6.558906771292869),
                                    ("Ramadanyear (latent)", -5.306143802797501),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.172612410172978),
                                    ("Military Spouse Dayyear (latent)", -6.558906771292869),
                                    ("Bhai Doojyear (latent)", -6.558906771292869),
                                    ("hourday", -4.544003750750604),
                                    ("dayhour", -3.538481885148506),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.172612410172978),
                                    ("Martin Luther King's Dayyear (latent)", -6.153441663184704),
                                    ("Shemini Atzeretyear (latent)", -6.558906771292869),
                                    ("daymonth", -4.544003750750604),
                                    ("monthday", -6.153441663184704),
                                    ("monthyear", -4.767147302064814),
                                    ("Yom Ha'atzmautyear (latent)", -6.558906771292869),
                                    ("Orthodox Good Fridayyear (latent)", -6.153441663184704),
                                    ("Vijayadashamiyear (latent)", -6.558906771292869),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.172612410172978),
                                    ("Thanksgiving Dayyear (latent)", -5.460294482624759),
                                    ("Thai Pongalyear (latent)", -5.865759590732924),
                                    ("Thiru Onamyear (latent)", -5.865759590732924),
                                    ("hhhmmabsorption of , after named day", -6.558906771292869),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.558906771292869),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.642616039418714),
                                    ("<day-of-month> (ordinal)Wednesday", -6.558906771292869),
                                    ("Krishna Janmashtamiyear (latent)", -6.153441663184704),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.558906771292869),
                                    ("houryear", -5.642616039418714),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.558906771292869),
                                    ("Christmas<time-of-day> am|pm", -6.558906771292869),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.558906771292869),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.865759590732924),
                                    ("intersectin|during <named-month>|year", -6.558906771292869),
                                    ("<time-of-day> am|pmintersect", -5.306143802797501),
                                    ("Earth Houryear (latent)", -6.558906771292869),
                                    ("Ganesh Chaturthiyear (latent)", -6.558906771292869),
                                    ("Octoberyear (latent)", -5.054829374516594),
                                    ("intersect<time-of-day> am|pm", -6.558906771292869),
                                    ("Mattu Pongalyear (latent)", -6.558906771292869),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.558906771292869),
                                    ("Daylight Saving Start Dayyear (latent)", -5.642616039418714),
                                    ("Shavuotyear (latent)", -6.558906771292869),
                                    ("Parsi New Yearyear (latent)", -5.642616039418714),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.558906771292869),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.558906771292869),
                                    ("todayin|within|after <duration>", -6.558906771292869),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.153441663184704),
                                    ("Marchyear (latent)", -6.558906771292869),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.153441663184704),
                                    ("Sukkotyear (latent)", -6.153441663184704),
                                    ("hhhmmintersect", -6.153441663184704),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.153441663184704),
                                    ("Daylight Saving End Dayyear (latent)", -5.642616039418714),
                                    ("Clean Mondayyear (latent)", -6.153441663184704),
                                    ("monthhour", -6.153441663184704),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.865759590732924),
                                    ("todayat <time-of-day>", -6.558906771292869),
                                    ("Thursday<time> timezone", -4.161011498494498),
                                    ("tonight<time-of-day> am|pm", -6.558906771292869),
                                    ("time-of-day (latent)tonight", -6.153441663184704),
                                    ("from|since|after <time>December", -6.558906771292869),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.558906771292869),
                                    ("<time-of-day> am|pmon <day>", -4.544003750750604),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.558906771292869),
                                    ("yyyy-mm-ddhh:mm:ss", -6.153441663184704),
                                    ("Tax Daythis|last|next <cycle>", -6.558906771292869),
                                    ("dayday", -3.8508565701906585),
                                    ("<time> <part-of-day>at <time-of-day>", -6.153441663184704),
                                    ("mm/ddat <time-of-day>", -6.558906771292869),
                                    ("tonightat <time-of-day>", -5.460294482624759),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.865759590732924),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.558906771292869),
                                    ("today<time-of-day> am|pm", -6.558906771292869),
                                    ("Februarythe <day-of-month> (ordinal)", -6.153441663184704),
                                    ("at <time-of-day><time> <part-of-day>", -6.558906771292869),
                                    ("<day-of-month> (ordinal)intersect", -6.153441663184704),
                                    ("mm/dd<time-of-day> am|pm", -6.558906771292869),
                                    ("hourhour", -3.5884923057231677),
                                    ("Mahavir Jayantiyear (latent)", -6.153441663184704),
                                    ("Navaratriin|during <named-month>|year", -6.558906771292869),
                                    ("Wednesdaythis|last|next <cycle>", -6.558906771292869),
                                    ("Lentyear (latent)", -6.558906771292869),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.687104594391277),
                                    ("Boghiyear (latent)", -6.558906771292869),
                                    ("dayyear", -1.7967328364951127),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.558906771292869),
                                    ("Thursdayfrom|since|after <time>", -6.153441663184704),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.558906771292869),
                                    ("Thursdayat <time-of-day>", -5.865759590732924),
                                    ("Islamic New Yearyear (latent)", -6.153441663184704),
                                    ("Laylat al-Qadryear (latent)", -5.642616039418714),
                                    ("part of days<time-of-day> am|pm", -6.558906771292869),
                                    ("Shrove Tuesdayyear (latent)", -6.558906771292869),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.865759590732924),
                                    ("hourminute", -6.153441663184704),
                                    ("<time-of-day> am|pmtomorrow", -5.865759590732924),
                                    ("Yom Kippuryear (latent)", -6.558906771292869),
                                    ("<day-of-month> (ordinal)Tuesday", -6.153441663184704),
                                    ("<part-of-day> of <time>year (latent)", -6.558906771292869),
                                    ("minutehour", -5.306143802797501),
                                    ("Kaanum Pongalyear (latent)", -6.153441663184704),
                                    ("Maha Saptamiyear (latent)", -6.558906771292869),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.865759590732924),
                                    ("time-of-day (latent)tomorrow", -5.642616039418714),
                                    ("part of daysat <time-of-day>", -4.9494688588587685),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.544003750750604),
                                    ("for <duration> from <time>December", -6.558906771292869),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.558906771292869),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.306143802797501),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.306143802797501),
                                    ("time-of-day (latent)this <part-of-day>", -6.558906771292869),
                                    ("Pentecostyear (latent)", -6.558906771292869),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.306143802797501),
                                    ("<day-of-month> (ordinal)February", -6.558906771292869),
                                    ("Eid al-Fitryear (latent)", -5.172612410172978),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.558906771292869),
                                    ("Mini-Tuesday<duration> hence|ago", -6.558906771292869),
                                    ("Mondayin|during the <part-of-day>", -6.558906771292869),
                                    ("Chhathin|during <named-month>|year", -6.558906771292869),
                                    ("Diwaliin|during <named-month>|year", -6.558906771292869),
                                    ("this <part-of-day><time-of-day> am|pm", -6.558906771292869),
                                    ("Vaisakhiin|during <named-month>|year", -6.558906771292869),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.306143802797501),
                                    ("Raksha Bandhanyear (latent)", -6.558906771292869),
                                    ("daysecond", -6.153441663184704),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.153441663184704),
                                    ("Emancipation Dayyear (latent)", -5.865759590732924),
                                    ("Ratha-Yatrayear (latent)", -6.558906771292869),
                                    ("Ashurayear (latent)", -6.558906771292869),
                                    ("Tuesdayin|during <named-month>|year", -6.558906771292869),
                                    ("Chinese New Yearyear (latent)", -6.558906771292869),
                                    ("tomorrowintersect", -6.558906771292869),
                                    ("Lag BaOmeryear (latent)", -6.558906771292869),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.558906771292869),
                                    ("Eid al-Adhayear (latent)", -4.418840607796598),
                                    ("intersectin|during the <part-of-day>", -6.558906771292869),
                                    ("Palm Sundayyear (latent)", -6.558906771292869),
                                    ("Christmasat <time-of-day>", -6.558906771292869),
                                    ("Passoveryear (latent)", -6.558906771292869),
                                    ("Lazarus Saturdayyear (latent)", -6.558906771292869),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.558906771292869),
                                    ("Cyber Mondayyear (latent)", -6.153441663184704),
                                    ("hhhmmon <day>", -5.642616039418714),
                                    ("Yom HaShoahyear (latent)", -6.153441663184704),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.153441663184704),
                                    ("Septemberyear (latent)", -6.153441663184704),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.054829374516594),
                                    ("Halloweenyear (latent)", -6.558906771292869),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.558906771292869),
                                    ("at <time-of-day>intersect", -5.642616039418714),
                                    ("Rosh Hashanahyear (latent)", -5.865759590732924),
                                    ("Super Tuesdayyear (latent)", -5.642616039418714),
                                    ("Dhanterasyear (latent)", -6.558906771292869),
                                    ("Tu BiShvatyear (latent)", -6.558906771292869),
                                    ("<day-of-month> (ordinal)December", -5.865759590732924),
                                    ("Holiyear (latent)", -5.865759590732924),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.558906771292869),
                                    ("Holika Dahanyear (latent)", -5.865759590732924),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.153441663184704),
                                    ("dayminute", -3.2090026840182637),
                                    ("Mawlidyear (latent)", -6.558906771292869),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.153441663184704),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.558906771292869),
                                    ("Jumu'atul-Widayear (latent)", -5.642616039418714),
                                    ("minuteday", -2.8212371530095006),
                                    ("absorption of , after named dayintersect",
                                     -5.865759590732924),
                                    ("intersectyear (latent)", -6.558906771292869),
                                    ("Orthodox Easter Sundayyear (latent)", -6.558906771292869),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.558906771292869),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.558906771292869),
                                    ("Mini-Tuesdayyear (latent)", -6.558906771292869),
                                    ("intersecthhhmm", -6.153441663184704),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.558906771292869),
                                    ("Boss's Dayyear (latent)", -6.153441663184704),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.558906771292869),
                                    ("Global Youth Service Dayyear (latent)", -6.558906771292869),
                                    ("Dhanterasin|during <named-month>|year", -6.558906771292869),
                                    ("Super Tuesdayin|during <named-month>|year",
                                     -6.558906771292869),
                                    ("tonight<time-of-day> o'clock", -6.558906771292869),
                                    ("Tisha B'Avyear (latent)", -6.558906771292869),
                                    ("Isra and Mi'rajyear (latent)", -5.642616039418714),
                                    ("at <time-of-day>on <day>", -4.9494688588587685),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.153441663184704),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.865759590732924),
                                    ("Christmasyear (latent)", -6.153441663184704),
                                    ("Saturdayintersect", -6.558906771292869),
                                    ("Naraka Chaturdashiyear (latent)", -6.153441663184704),
                                    ("Thai Pongalin|during <named-month>|year", -6.558906771292869),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.558906771292869),
                                    ("dayweek", -6.558906771292869),
                                    ("Easter Sundayyear (latent)", -5.865759590732924),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.153441663184704),
                                    ("weekyear", -5.460294482624759),
                                    ("Super Tuesdaythis|last|next <cycle>", -6.558906771292869),
                                    ("King's Dayyear (latent)", -5.054829374516594),
                                    ("hh:mmin|during the <part-of-day>", -5.642616039418714),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.153441663184704),
                                    ("Hanukkahyear (latent)", -5.865759590732924),
                                    ("Rama Navamiyear (latent)", -6.558906771292869),
                                    ("February<time> <part-of-day>", -6.558906771292869),
                                    ("National Grandparents Dayyear (latent)", -6.558906771292869),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.865759590732924),
                                    ("Great Lentyear (latent)", -6.558906771292869),
                                    ("tomorrowat <time-of-day>", -5.865759590732924),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.558906771292869),
                                    ("Labor Dayyear (latent)", -6.558906771292869),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.153441663184704),
                                    ("Ugadiyear (latent)", -5.172612410172978),
                                    ("Vaisakhiyear (latent)", -5.865759590732924),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.865759590732924),
                                    ("last <cycle> of <time>year (latent)", -5.865759590732924),
                                    ("at <time-of-day>tomorrow", -6.153441663184704),
                                    ("tomorrow<time-of-day> am|pm", -6.558906771292869),
                                    ("President's Dayyear (latent)", -6.558906771292869),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.558906771292869),
                                    ("Diwaliyear (latent)", -6.558906771292869),
                                    ("between <time> and <time>on <day>", -6.153441663184704),
                                    ("Black Fridayyear (latent)", -6.153441663184704),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.558906771292869),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.558906771292869),
                                    ("Chhathyear (latent)", -6.153441663184704),
                                    ("Vasant Panchamiyear (latent)", -6.558906771292869),
                                    ("Tax Dayyear (latent)", -5.642616039418714),
                                    ("Rabindra Jayantiyear (latent)", -5.306143802797501),
                                    ("this <part-of-day>at <time-of-day>", -5.306143802797501),
                                    ("St Patrick's Dayyear (latent)", -6.558906771292869),
                                    ("Thursday<time> (timezone)", -6.558906771292869),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.558906771292869),
                                    ("Pargat Diwasyear (latent)", -5.306143802797501),
                                    ("<datetime> - <datetime> (interval)July", -6.153441663184704),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.865759590732924),
                                    ("Februaryintersect", -6.558906771292869),
                                    ("Mother's Dayyear (latent)", -6.558906771292869),
                                    ("Simchat Torahyear (latent)", -6.558906771292869),
                                    ("minuteyear", -6.558906771292869)],
                               n = 543},
                   koData =
                     ClassData{prior = -1.0060671856015888, unseen = -6.858565034791365,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.660289485209171),
                                    ("hourday", -3.7664716091870747),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.164366881985445),
                                    ("<day-of-month> (ordinal)August", -6.164366881985445),
                                    ("dayhour", -3.490218232558916),
                                    ("<time> timezoneyear (latent)", -5.4712197014254995),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.24807615011129),
                                    ("Tuesdayfrom|since|after <time>", -5.065754593317335),
                                    ("daymonth", -3.490218232558916),
                                    ("monthyear", -4.911603913490077),
                                    ("<time-of-day> am|pmyear (latent)", -5.4712197014254995),
                                    ("Thai Pongalyear (latent)", -5.4712197014254995),
                                    ("intersecthh:mm", -6.164366881985445),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.75890177387728),
                                    ("<day-of-month> (ordinal)Wednesday", -6.164366881985445),
                                    ("houryear", -4.778072520865554),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.164366881985445),
                                    ("<day-of-month> (ordinal)October", -6.164366881985445),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.4712197014254995),
                                    ("hournograin", -4.911603913490077),
                                    ("<time-of-day> am|pmintersect", -4.911603913490077),
                                    ("Octoberyear (latent)", -6.164366881985445),
                                    ("Good Fridayyear (latent)", -5.75890177387728),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.75890177387728),
                                    ("early morningat <time-of-day>", -6.164366881985445),
                                    ("until <time>on <day>", -5.4712197014254995),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.164366881985445),
                                    ("time-of-day (latent)intersect", -5.4712197014254995),
                                    ("todayin <number> (implicit minutes)", -6.164366881985445),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.4712197014254995),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.164366881985445),
                                    ("hh:mmon <day>", -4.911603913490077),
                                    ("hhhmmintersect", -5.75890177387728),
                                    ("absorption of , after named dayJuly", -5.24807615011129),
                                    ("from|since|after <time>July", -5.75890177387728),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.24807615011129),
                                    ("Clean Mondayyear (latent)", -6.164366881985445),
                                    ("monthhour", -6.164366881985445),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.75890177387728),
                                    ("hourmonth", -4.292564705083853),
                                    ("todayat <time-of-day>", -6.164366881985445),
                                    ("hhhmmyear (latent)", -4.911603913490077),
                                    ("from|since|after <time>December", -6.164366881985445),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.164366881985445),
                                    ("<time-of-day> am|pmon <day>", -4.911603913490077),
                                    ("Mondayyear (latent)", -5.065754593317335),
                                    ("dayday", -4.149463861443181),
                                    ("mm/ddat <time-of-day>", -5.75890177387728),
                                    ("on <day>September", -5.4712197014254995),
                                    ("time-of-day (latent)September", -5.75890177387728),
                                    ("hourhour", -4.084925340305609),
                                    ("time-of-day (latent)on <day>", -4.660289485209171),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.75890177387728),
                                    ("dayyear", -2.8501808773129196),
                                    ("Thursdaymm/dd", -6.164366881985445),
                                    ("New Year's Dayyear (latent)", -5.24807615011129),
                                    ("Tuesdayyear (latent)", -5.065754593317335),
                                    ("time-of-day (latent)Sunday", -5.75890177387728),
                                    ("Thursdayfrom|since|after <time>", -4.45961878974702),
                                    ("Thursdayat <time-of-day>", -4.554928969551344),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.164366881985445),
                                    ("Aprilyear (latent)", -6.164366881985445),
                                    ("the <day-of-month> (ordinal)July", -6.164366881985445),
                                    ("the <day-of-month> (number)July", -6.164366881985445),
                                    ("monthminute", -6.164366881985445),
                                    ("<time-of-day> am|pmtomorrow", -6.164366881985445),
                                    ("Thursdayhh:mm", -5.24807615011129),
                                    ("<day-of-month> (ordinal)Tuesday", -5.75890177387728),
                                    ("minutemonth", -4.024300718489174),
                                    ("time-of-day (latent)Friday", -5.75890177387728),
                                    ("minutehour", -6.164366881985445),
                                    ("Tuesdayin <number> (implicit minutes)", -6.164366881985445),
                                    ("part of daysat <time-of-day>", -5.065754593317335),
                                    ("Augustyear (latent)", -5.75890177387728),
                                    ("week-endin|during <named-month>|year", -6.164366881985445),
                                    ("time-of-day (latent)Tuesday", -5.75890177387728),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.164366881985445),
                                    ("Tuesdayin|during <named-month>|year", -6.164366881985445),
                                    ("Sundayyear (latent)", -5.24807615011129),
                                    ("the <day-of-month> (ordinal)Monday", -5.4712197014254995),
                                    ("Christmasat <time-of-day>", -6.164366881985445),
                                    ("from|since|after <time>year (latent)", -5.065754593317335),
                                    ("hhhmmon <day>", -5.24807615011129),
                                    ("yesterday<time-of-day> am|pm", -6.164366881985445),
                                    ("<day-of-month> (ordinal)July", -5.4712197014254995),
                                    ("Tuesday<duration> hence|ago", -6.164366881985445),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.164366881985445),
                                    ("mm/ddyear (latent)", -6.164366881985445),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.164366881985445),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.164366881985445),
                                    ("Tuesdaythis|last|next <cycle>", -6.164366881985445),
                                    ("at <time-of-day>intersect", -5.24807615011129),
                                    ("hh:mmyear (latent)", -4.778072520865554),
                                    ("Holiyear (latent)", -6.164366881985445),
                                    ("until <time><time-of-day> am|pm", -6.164366881985445),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.75890177387728),
                                    ("dayminute", -3.2739951240892804),
                                    ("yyyy-mm-ddhh:mm", -5.75890177387728),
                                    ("intersectfrom|since|after <time>", -5.75890177387728),
                                    ("intersectSeptember", -4.292564705083853),
                                    ("minuteday", -3.007366460835332),
                                    ("absorption of , after named dayintersect",
                                     -6.164366881985445),
                                    ("intersectyear (latent)", -6.164366881985445),
                                    ("Februaryin|during the <part-of-day>", -6.164366881985445),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.164366881985445),
                                    ("time-of-day (latent)July", -5.4712197014254995),
                                    ("Saturdayyear (latent)", -6.164366881985445),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.164366881985445),
                                    ("<day-of-month> (ordinal)Monday", -5.24807615011129),
                                    ("at <time-of-day>on <day>", -5.24807615011129),
                                    ("absorption of , after named daySeptember",
                                     -4.911603913490077),
                                    ("Naraka Chaturdashiyear (latent)", -6.164366881985445),
                                    ("from|since|after <time>on <day>", -5.24807615011129),
                                    ("dayweek", -6.164366881985445),
                                    ("Easter Sundayyear (latent)", -5.75890177387728),
                                    ("Thursday<time-of-day> am|pm", -4.911603913490077),
                                    ("weekyear", -5.75890177387728),
                                    ("time-of-day (latent)Thursday", -5.75890177387728),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.164366881985445),
                                    ("<day-of-month> (ordinal)April", -6.164366881985445),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.75890177387728),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.4712197014254995),
                                    ("Sundayfrom|since|after <time>", -6.164366881985445),
                                    ("absorption of , after named dayFebruary", -5.24807615011129),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.75890177387728),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.164366881985445),
                                    ("tomorrowat <time-of-day>", -6.164366881985445),
                                    ("daynograin", -5.75890177387728),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.75890177387728),
                                    ("last <cycle> of <time>year (latent)", -5.75890177387728),
                                    ("tomorrow<time-of-day> am|pm", -6.164366881985445),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.4712197014254995),
                                    ("Diwaliyear (latent)", -5.75890177387728),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.164366881985445),
                                    ("this <part-of-day>at <time-of-day>", -5.24807615011129),
                                    ("Fridayyear (latent)", -5.24807615011129),
                                    ("Tuesdayin|within|after <duration>", -6.164366881985445),
                                    ("time-of-day (latent)April", -6.164366881985445),
                                    ("minuteyear", -3.967142304649226)],
                               n = 313}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.12629372532429212,
                               ...
                               n = 260},
                   koData =
                     ClassData{prior = -2.1316272948504063,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.2363887780642304, unseen = -5.262690188904886,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 90},
                   koData =
                     ClassData{prior = -1.55814461804655, unseen = -4.110873864173311,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("Tuesday",
        Classifier{okData =
                     ClassData{prior = -0.8266785731844679, unseen = -2.772588722239781,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 14},
                   koData =
                     ClassData{prior = -0.5753641449035618, unseen = -2.995732273553991,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 18}}),
       ("New Year's Day",
        Classifier{okData =
