...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5814728993918831, unseen = -6.133398042996649,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 459},
                   koData =
                     ClassData{prior = -0.8188788976266572,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45330177962780405,
                               unseen = -7.138866999945524,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.444925853484402),
                                    ("Father's Dayyear (latent)", -6.444925853484402),
                                    ("Karva Chauthyear (latent)", -6.444925853484402),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.444925853484402),
                                    ("Ramadanyear (latent)", -5.528635121610247),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.058631492364511),
                                    ("Military Spouse Dayyear (latent)", -6.444925853484402),
                                    ("Bhai Doojyear (latent)", -6.444925853484402),
                                    ("hourday", -4.430022832942137),
                                    ("dayhour", -3.500486874317961),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.058631492364511),
                                    ("Martin Luther King's Dayyear (latent)", -6.039460745376237),
                                    ("Shemini Atzeretyear (latent)", -6.444925853484402),
                                    ("daymonth", -4.430022832942137),
                                    ("monthday", -6.039460745376237),
                                    ("monthyear", -4.653166384256346),
                                    ("Yom Ha'atzmautyear (latent)", -6.444925853484402),
                                    ("Vijayadashamiyear (latent)", -6.444925853484402),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.058631492364511),
                                    ("Thanksgiving Dayyear (latent)", -5.346313564816292),
                                    ("Thai Pongalyear (latent)", -5.751778672924456),
                                    ("Thiru Onamyear (latent)", -5.751778672924456),
                                    ("hhhmmabsorption of , after named day", -6.444925853484402),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.444925853484402),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.528635121610247),
                                    ("<day-of-month> (ordinal)Wednesday", -6.444925853484402),
                                    ("Krishna Janmashtamiyear (latent)", -6.039460745376237),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.444925853484402),
                                    ("houryear", -5.528635121610247),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.444925853484402),
                                    ("Christmas<time-of-day> am|pm", -6.444925853484402),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.444925853484402),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.751778672924456),
                                    ("intersectin|during <named-month>|year", -6.444925853484402),
                                    ("<time-of-day> am|pmintersect", -5.192162884989034),
                                    ("Earth Houryear (latent)", -6.444925853484402),
                                    ("Octoberyear (latent)", -4.940848456708128),
                                    ("intersect<time-of-day> am|pm", -6.444925853484402),
                                    ("Mattu Pongalyear (latent)", -6.444925853484402),
                                    ("Daylight Saving Start Dayyear (latent)", -5.528635121610247),
                                    ("Shavuotyear (latent)", -6.444925853484402),
                                    ("Parsi New Yearyear (latent)", -5.528635121610247),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.444925853484402),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.444925853484402),
                                    ("todayin|within|after <duration>", -6.444925853484402),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.039460745376237),
                                    ("Marchyear (latent)", -6.444925853484402),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.039460745376237),
                                    ("Sukkotyear (latent)", -6.039460745376237),
                                    ("hhhmmintersect", -6.039460745376237),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.039460745376237),
                                    ("Daylight Saving End Dayyear (latent)", -5.528635121610247),
                                    ("Clean Mondayyear (latent)", -6.039460745376237),
                                    ("monthhour", -6.039460745376237),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.751778672924456),
                                    ("todayat <time-of-day>", -6.444925853484402),
                                    ("Thursday<time> timezone", -4.047030580686031),
                                    ("time-of-day (latent)tonight", -6.039460745376237),
                                    ("from|since|after <time>December", -6.444925853484402),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.444925853484402),
                                    ("<time-of-day> am|pmon <day>", -4.430022832942137),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.444925853484402),
                                    ("yyyy-mm-ddhh:mm:ss", -6.039460745376237),
                                    ("Tax Daythis|last|next <cycle>", -6.444925853484402),
                                    ("dayday", -3.7368756523821918),
                                    ("<time> <part-of-day>at <time-of-day>", -6.444925853484402),
                                    ("mm/ddat <time-of-day>", -6.444925853484402),
                                    ("tonightat <time-of-day>", -6.444925853484402),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.751778672924456),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.444925853484402),
                                    ("today<time-of-day> am|pm", -6.444925853484402),
                                    ("Februarythe <day-of-month> (ordinal)", -6.039460745376237),
                                    ("at <time-of-day><time> <part-of-day>", -6.444925853484402),
                                    ("<day-of-month> (ordinal)intersect", -6.039460745376237),
                                    ("mm/dd<time-of-day> am|pm", -6.444925853484402),
                                    ("hourhour", -4.365484311804566),
                                    ("Mahavir Jayantiyear (latent)", -6.039460745376237),
                                    ("Navaratriin|during <named-month>|year", -6.444925853484402),
                                    ("Wednesdaythis|last|next <cycle>", -6.444925853484402),
                                    ("Lentyear (latent)", -6.444925853484402),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.57312367658281),
                                    ("Boghiyear (latent)", -6.444925853484402),
                                    ("dayyear", -1.8298053366431424),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.444925853484402),
                                    ("Thursdayfrom|since|after <time>", -6.039460745376237),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.444925853484402),
                                    ("Thursdayat <time-of-day>", -5.751778672924456),
                                    ("Islamic New Yearyear (latent)", -6.039460745376237),
                                    ("Laylat al-Qadryear (latent)", -5.528635121610247),
                                    ("Shrove Tuesdayyear (latent)", -6.444925853484402),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.751778672924456),
                                    ("<time-of-day> am|pmtomorrow", -5.751778672924456),
                                    ("Yom Kippuryear (latent)", -6.444925853484402),
                                    ("<day-of-month> (ordinal)Tuesday", -6.039460745376237),
                                    ("<part-of-day> of <time>year (latent)", -6.444925853484402),
                                    ("minutehour", -5.192162884989034),
                                    ("Kaanum Pongalyear (latent)", -6.039460745376237),
                                    ("Maha Saptamiyear (latent)", -6.444925853484402),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.039460745376237),
                                    ("time-of-day (latent)tomorrow", -5.528635121610247),
                                    ("part of daysat <time-of-day>", -6.039460745376237),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.430022832942137),
                                    ("for <duration> from <time>December", -6.444925853484402),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.444925853484402),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.192162884989034),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.192162884989034),
                                    ("time-of-day (latent)this <part-of-day>", -6.444925853484402),
                                    ("Pentecostyear (latent)", -6.444925853484402),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.192162884989034),
                                    ("<day-of-month> (ordinal)February", -6.444925853484402),
                                    ("Eid al-Fitryear (latent)", -5.528635121610247),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.444925853484402),
                                    ("Mondayin|during the <part-of-day>", -6.444925853484402),
                                    ("Chhathin|during <named-month>|year", -6.444925853484402),
                                    ("Diwaliin|during <named-month>|year", -6.444925853484402),
                                    ("Vaisakhiin|during <named-month>|year", -6.444925853484402),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.192162884989034),
                                    ("Raksha Bandhanyear (latent)", -6.444925853484402),
                                    ("daysecond", -6.039460745376237),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.039460745376237),
                                    ("Emancipation Dayyear (latent)", -5.751778672924456),
                                    ("Ashurayear (latent)", -6.444925853484402),
                                    ("Tuesdayin|during <named-month>|year", -6.444925853484402),
                                    ("Chinese New Yearyear (latent)", -6.444925853484402),
                                    ("tomorrowintersect", -6.444925853484402),
                                    ("Lag BaOmeryear (latent)", -6.444925853484402),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.444925853484402),
                                    ("Eid al-Adhayear (latent)", -4.304859689988131),
                                    ("intersectin|during the <part-of-day>", -6.444925853484402),
                                    ("Palm Sundayyear (latent)", -6.444925853484402),
                                    ("Christmasat <time-of-day>", -6.444925853484402),
                                    ("Passoveryear (latent)", -6.444925853484402),
                                    ("Lazarus Saturdayyear (latent)", -6.444925853484402),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.444925853484402),
                                    ("Cyber Mondayyear (latent)", -6.039460745376237),
                                    ("hhhmmon <day>", -5.528635121610247),
                                    ("Yom HaShoahyear (latent)", -6.039460745376237),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.039460745376237),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.444925853484402),
                                    ("Septemberyear (latent)", -6.039460745376237),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.940848456708128),
                                    ("Halloweenyear (latent)", -6.444925853484402),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.444925853484402),
                                    ("at <time-of-day>intersect", -5.528635121610247),
                                    ("Rosh Hashanahyear (latent)", -5.751778672924456),
                                    ("Dhanterasyear (latent)", -6.444925853484402),
                                    ("Tu BiShvatyear (latent)", -6.444925853484402),
                                    ("<day-of-month> (ordinal)December", -5.751778672924456),
                                    ("Holiyear (latent)", -5.751778672924456),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.444925853484402),
                                    ("Holika Dahanyear (latent)", -5.751778672924456),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.039460745376237),
                                    ("dayminute", -3.095021766209797),
                                    ("Mawlidyear (latent)", -6.444925853484402),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.039460745376237),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.444925853484402),
                                    ("Jumu'atul-Widayear (latent)", -5.528635121610247),
                                    ("minuteday", -2.707256235201034),
                                    ("absorption of , after named dayintersect",
                                     -5.751778672924456),
                                    ("intersectyear (latent)", -6.444925853484402),
                                    ("Orthodox Easter Sundayyear (latent)", -6.444925853484402),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.444925853484402),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.444925853484402),
                                    ("intersecthhhmm", -6.039460745376237),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.444925853484402),
                                    ("Boss's Dayyear (latent)", -6.039460745376237),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.444925853484402),
                                    ("Global Youth Service Dayyear (latent)", -6.444925853484402),
                                    ("Dhanterasin|during <named-month>|year", -6.444925853484402),
                                    ("Tisha B'Avyear (latent)", -6.444925853484402),
                                    ("Isra and Mi'rajyear (latent)", -5.528635121610247),
                                    ("at <time-of-day>on <day>", -4.835487941050301),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.039460745376237),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.751778672924456),
                                    ("Christmasyear (latent)", -6.039460745376237),
                                    ("Naraka Chaturdashiyear (latent)", -6.039460745376237),
                                    ("Thai Pongalin|during <named-month>|year", -6.444925853484402),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.444925853484402),
                                    ("dayweek", -6.444925853484402),
                                    ("Easter Sundayyear (latent)", -5.751778672924456),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.039460745376237),
                                    ("weekyear", -5.346313564816292),
                                    ("King's Dayyear (latent)", -4.940848456708128),
                                    ("hh:mmin|during the <part-of-day>", -5.528635121610247),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.039460745376237),
                                    ("Hanukkahyear (latent)", -5.751778672924456),
                                    ("February<time> <part-of-day>", -6.444925853484402),
                                    ("National Grandparents Dayyear (latent)", -6.444925853484402),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.444925853484402),
                                    ("Great Lentyear (latent)", -6.444925853484402),
                                    ("tomorrowat <time-of-day>", -5.751778672924456),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.444925853484402),
                                    ("Labor Dayyear (latent)", -6.444925853484402),
                                    ("Vaisakhiyear (latent)", -5.751778672924456),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.751778672924456),
                                    ("last <cycle> of <time>year (latent)", -5.751778672924456),
                                    ("at <time-of-day>tomorrow", -6.039460745376237),
                                    ("tomorrow<time-of-day> am|pm", -6.444925853484402),
                                    ("President's Dayyear (latent)", -6.444925853484402),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.444925853484402),
                                    ("Diwaliyear (latent)", -6.444925853484402),
                                    ("between <time> and <time>on <day>", -6.039460745376237),
                                    ("Black Fridayyear (latent)", -6.039460745376237),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.444925853484402),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.444925853484402),
                                    ("Chhathyear (latent)", -6.039460745376237),
                                    ("Vasant Panchamiyear (latent)", -6.444925853484402),
                                    ("Tax Dayyear (latent)", -5.528635121610247),
                                    ("Rabindra Jayantiyear (latent)", -5.192162884989034),
                                    ("St Patrick's Dayyear (latent)", -6.444925853484402),
                                    ("Thursday<time> (timezone)", -6.444925853484402),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.444925853484402),
                                    ("<datetime> - <datetime> (interval)July", -6.039460745376237),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.751778672924456),
                                    ("Februaryintersect", -6.444925853484402),
                                    ("Mother's Dayyear (latent)", -6.444925853484402),
                                    ("Simchat Torahyear (latent)", -6.444925853484402),
                                    ("minuteyear", -6.444925853484402)],
                               n = 483},
                   koData =
                     ClassData{prior = -1.0093009270930382, unseen = -6.742880635791903,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.544476117315835),
                                    ("hourday", -3.6506582412937383),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.048553514092109),
                                    ("<day-of-month> (ordinal)August", -6.048553514092109),
                                    ("dayhour", -3.37440486466558),
                                    ("<time> timezoneyear (latent)", -5.355406333532164),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.132262782217954),
                                    ("Tuesdayfrom|since|after <time>", -5.355406333532164),
                                    ("daymonth", -3.37440486466558),
                                    ("monthyear", -4.795790545596741),
                                    ("<time-of-day> am|pmyear (latent)", -5.355406333532164),
                                    ("Thai Pongalyear (latent)", -5.355406333532164),
                                    ("intersecthh:mm", -6.048553514092109),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.643088405983945),
                                    ("<day-of-month> (ordinal)Wednesday", -6.048553514092109),
                                    ("houryear", -4.662259152972219),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.048553514092109),
                                    ("<day-of-month> (ordinal)October", -6.048553514092109),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.355406333532164),
                                    ("hournograin", -4.795790545596741),
                                    ("<time-of-day> am|pmintersect", -4.795790545596741),
                                    ("Octoberyear (latent)", -6.048553514092109),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.643088405983945),
                                    ("until <time>on <day>", -5.355406333532164),
                                    ("time-of-day (latent)intersect", -5.355406333532164),
                                    ("todayin <number> (implicit minutes)", -6.048553514092109),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.355406333532164),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.048553514092109),
                                    ("hh:mmon <day>", -4.795790545596741),
                                    ("hhhmmintersect", -5.643088405983945),
                                    ("absorption of , after named dayJuly", -5.132262782217954),
                                    ("from|since|after <time>July", -5.643088405983945),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.132262782217954),
                                    ("Clean Mondayyear (latent)", -6.048553514092109),
                                    ("monthhour", -6.048553514092109),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.643088405983945),
                                    ("hourmonth", -4.176751337190518),
                                    ("todayat <time-of-day>", -6.048553514092109),
                                    ("hhhmmyear (latent)", -4.795790545596741),
                                    ("from|since|after <time>December", -6.048553514092109),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.048553514092109),
                                    ("<time-of-day> am|pmon <day>", -4.795790545596741),
                                    ("Mondayyear (latent)", -4.949941225423999),
                                    ("dayday", -4.662259152972219),
                                    ("mm/ddat <time-of-day>", -5.643088405983945),
                                    ("on <day>September", -5.355406333532164),
                                    ("time-of-day (latent)September", -5.643088405983945),
                                    ("hourhour", -5.643088405983945),
                                    ("time-of-day (latent)on <day>", -4.544476117315835),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.643088405983945),
                                    ("dayyear", -3.052821240538118),
                                    ("Thursdaymm/dd", -6.048553514092109),
                                    ("New Year's Dayyear (latent)", -5.132262782217954),
                                    ("time-of-day (latent)Sunday", -5.643088405983945),
                                    ("Thursdayfrom|since|after <time>", -4.343805421853684),
                                    ("Thursdayat <time-of-day>", -4.439115601658009),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.048553514092109),
                                    ("Aprilyear (latent)", -6.048553514092109),
                                    ("the <day-of-month> (ordinal)July", -6.048553514092109),
                                    ("the <day-of-month> (number)July", -6.048553514092109),
                                    ("monthminute", -6.048553514092109),
                                    ("<time-of-day> am|pmtomorrow", -6.048553514092109),
                                    ("Thursdayhh:mm", -5.132262782217954),
                                    ("<day-of-month> (ordinal)Tuesday", -5.643088405983945),
                                    ("minutemonth", -3.908487350595838),
                                    ("time-of-day (latent)Friday", -5.643088405983945),
                                    ("minutehour", -6.048553514092109),
                                    ("Augustyear (latent)", -5.643088405983945),
                                    ("week-endin|during <named-month>|year", -6.048553514092109),
                                    ("time-of-day (latent)Tuesday", -5.643088405983945),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.643088405983945),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.048553514092109),
                                    ("Sundayyear (latent)", -5.132262782217954),
                                    ("Christmasat <time-of-day>", -6.048553514092109),
                                    ("from|since|after <time>year (latent)", -4.949941225423999),
                                    ("hhhmmon <day>", -5.132262782217954),
                                    ("yesterday<time-of-day> am|pm", -6.048553514092109),
                                    ("<day-of-month> (ordinal)July", -5.355406333532164),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.048553514092109),
                                    ("mm/ddyear (latent)", -6.048553514092109),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.048553514092109),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.048553514092109),
                                    ("at <time-of-day>intersect", -5.132262782217954),
                                    ("hh:mmyear (latent)", -4.662259152972219),
                                    ("Holiyear (latent)", -6.048553514092109),
                                    ("until <time><time-of-day> am|pm", -6.048553514092109),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.643088405983945),
                                    ("dayminute", -3.186352633162641),
                                    ("yyyy-mm-ddhh:mm", -5.643088405983945),
                                    ("intersectfrom|since|after <time>", -5.643088405983945),
                                    ("intersectSeptember", -4.176751337190518),
                                    ("minuteday", -2.891553092941996),
                                    ("absorption of , after named dayintersect",
                                     -6.048553514092109),
                                    ("intersectyear (latent)", -6.048553514092109),
                                    ("Februaryin|during the <part-of-day>", -6.048553514092109),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.048553514092109),
                                    ("time-of-day (latent)July", -5.355406333532164),
                                    ("Saturdayyear (latent)", -6.048553514092109),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.048553514092109),
                                    ("at <time-of-day>on <day>", -5.132262782217954),
                                    ("absorption of , after named daySeptember",
                                     -4.795790545596741),
                                    ("Naraka Chaturdashiyear (latent)", -6.048553514092109),
                                    ("from|since|after <time>on <day>", -5.132262782217954),
                                    ("dayweek", -6.048553514092109),
                                    ("Easter Sundayyear (latent)", -5.643088405983945),
                                    ("Thursday<time-of-day> am|pm", -4.795790545596741),
                                    ("weekyear", -5.643088405983945),
                                    ("time-of-day (latent)Thursday", -5.643088405983945),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.048553514092109),
                                    ("<day-of-month> (ordinal)April", -6.048553514092109),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.643088405983945),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.355406333532164),
                                    ("Sundayfrom|since|after <time>", -6.048553514092109),
                                    ("absorption of , after named dayFebruary", -5.132262782217954),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.643088405983945),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.048553514092109),
                                    ("tomorrowat <time-of-day>", -6.048553514092109),
                                    ("daynograin", -5.643088405983945),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.643088405983945),
                                    ("last <cycle> of <time>year (latent)", -5.643088405983945),
                                    ("tomorrow<time-of-day> am|pm", -6.048553514092109),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.355406333532164),
                                    ("Diwaliyear (latent)", -5.643088405983945),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.048553514092109),
                                    ("Fridayyear (latent)", -5.643088405983945),
                                    ("time-of-day (latent)April", -6.048553514092109),
                                    ("minuteyear", -3.85132893675589)],
                               n = 277}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1422270995920765, unseen = -5.455321115357702,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -2.6088436084297853e-2),
                                    ("intersect 2 numbers", -4.06474409244581)],
                               n = 229},
                   koData =
                     ClassData{prior = -2.0206010416569025,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
