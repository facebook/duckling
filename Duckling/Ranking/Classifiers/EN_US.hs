...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4389878001468079, unseen = -6.840546529288687,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.1463292576688975),
                                    ("Father's Dayyear (latent)", -6.1463292576688975),
                                    ("Ramadanyear (latent)", -6.1463292576688975),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.893566289173529),
                                    ("Military Spouse Dayyear (latent)", -6.1463292576688975),
                                    ("Bhai Doojyear (latent)", -6.1463292576688975),
                                    ("hourday", -4.441581165430472),
                                    ("dayhour", -3.284128376739429),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.893566289173529),
                                    ("Martin Luther King's Dayyear (latent)", -5.740864149560733),
                                    ("Shemini Atzeretyear (latent)", -6.1463292576688975),
                                    ("daymonth", -5.230038525794742),
                                    ("monthday", -5.740864149560733),
                                    ("monthyear", -4.354569788440842),
                                    ("Yom Ha'atzmautyear (latent)", -6.1463292576688975),
                                    ("Vijayadashamiyear (latent)", -6.1463292576688975),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -4.760034896549007),
                                    ("Thanksgiving Dayyear (latent)", -5.0477169690007875),
                                    ("Thai Pongalyear (latent)", -5.453182077108952),
                                    ("Thiru Onamyear (latent)", -5.453182077108952),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.1463292576688975),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.1463292576688975),
                                    ("houryear", -5.453182077108952),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.1463292576688975),
                                    ("Christmas<time-of-day> am|pm", -6.1463292576688975),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.1463292576688975),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.453182077108952),
                                    ("<time-of-day> am|pmintersect", -4.893566289173529),
                                    ("Earth Houryear (latent)", -6.1463292576688975),
                                    ("Octoberyear (latent)", -4.642251860892623),
                                    ("intersect<time-of-day> am|pm", -6.1463292576688975),
                                    ("Mattu Pongalyear (latent)", -6.1463292576688975),
                                    ("Daylight Saving Start Dayyear (latent)", -5.230038525794742),
                                    ("Shavuotyear (latent)", -6.1463292576688975),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.1463292576688975),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.1463292576688975),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.740864149560733),
                                    ("Marchyear (latent)", -6.1463292576688975),
                                    ("Sukkotyear (latent)", -5.740864149560733),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.1463292576688975),
                                    ("Daylight Saving End Dayyear (latent)", -5.230038525794742),
                                    ("Clean Mondayyear (latent)", -5.740864149560733),
                                    ("monthhour", -5.740864149560733),
                                    ("todayat <time-of-day>", -6.1463292576688975),
                                    ("Thursday<time> timezone", -4.200419108613584),
                                    ("from|since|after <time>December", -6.1463292576688975),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.1463292576688975),
                                    ("<time-of-day> am|pmon <day>", -4.131426237126632),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.1463292576688975),
                                    ("yyyy-mm-ddhh:mm:ss", -5.740864149560733),
                                    ("Tax Daythis|last|next <cycle>", -6.1463292576688975),
                                    ("dayday", -4.131426237126632),
                                    ("<time> <part-of-day>at <time-of-day>", -6.1463292576688975),
                                    ("mm/ddat <time-of-day>", -6.1463292576688975),
                                    ("tonightat <time-of-day>", -6.1463292576688975),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.453182077108952),
                                    ("today<time-of-day> am|pm", -6.1463292576688975),
                                    ("Februarythe <day-of-month> (ordinal)", -5.740864149560733),
                                    ("at <time-of-day><time> <part-of-day>", -6.1463292576688975),
                                    ("mm/dd<time-of-day> am|pm", -6.1463292576688975),
                                    ("hourhour", -4.893566289173529),
                                    ("Navaratriin|during <named-month>|year", -6.1463292576688975),
                                    ("Wednesdaythis|last|next <cycle>", -6.1463292576688975),
                                    ("Lentyear (latent)", -6.1463292576688975),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.642251860892623),
                                    ("Boghiyear (latent)", -6.1463292576688975),
                                    ("dayyear", -1.8355301322833835),
                                    ("Thursdayfrom|since|after <time>", -5.740864149560733),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.1463292576688975),
                                    ("Thursdayat <time-of-day>", -5.453182077108952),
                                    ("Islamic New Yearyear (latent)", -5.740864149560733),
                                    ("Laylat al-Qadryear (latent)", -5.230038525794742),
                                    ("Shrove Tuesdayyear (latent)", -6.1463292576688975),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.453182077108952),
                                    ("<time-of-day> am|pmtomorrow", -5.453182077108952),
                                    ("Yom Kippuryear (latent)", -6.1463292576688975),
                                    ("<part-of-day> of <time>year (latent)", -6.1463292576688975),
                                    ("minutehour", -5.230038525794742),
                                    ("Kaanum Pongalyear (latent)", -5.740864149560733),
                                    ("Maha Saptamiyear (latent)", -6.1463292576688975),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.740864149560733),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.441581165430472),
                                    ("for <duration> from <time>December", -6.1463292576688975),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.1463292576688975),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.230038525794742),
                                    ("Pentecostyear (latent)", -6.1463292576688975),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.230038525794742),
                                    ("Eid al-Fitryear (latent)", -6.1463292576688975),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.1463292576688975),
                                    ("Mondayin|during the <part-of-day>", -6.1463292576688975),
                                    ("Chhathin|during <named-month>|year", -6.1463292576688975),
                                    ("Diwaliin|during <named-month>|year", -6.1463292576688975),
                                    ("Vaisakhiin|during <named-month>|year", -6.1463292576688975),
                                    ("Raksha Bandhanyear (latent)", -6.1463292576688975),
                                    ("daysecond", -5.740864149560733),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.740864149560733),
                                    ("Emancipation Dayyear (latent)", -5.453182077108952),
                                    ("Ashurayear (latent)", -6.1463292576688975),
                                    ("Tuesdayin|during <named-month>|year", -6.1463292576688975),
                                    ("Chinese New Yearyear (latent)", -6.1463292576688975),
                                    ("Lag BaOmeryear (latent)", -6.1463292576688975),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.1463292576688975),
                                    ("Eid al-Adhayear (latent)", -5.230038525794742),
                                    ("intersectin|during the <part-of-day>", -6.1463292576688975),
                                    ("Palm Sundayyear (latent)", -6.1463292576688975),
                                    ("Christmasat <time-of-day>", -6.1463292576688975),
                                    ("Passoveryear (latent)", -6.1463292576688975),
                                    ("Lazarus Saturdayyear (latent)", -6.1463292576688975),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.1463292576688975),
                                    ("Cyber Mondayyear (latent)", -5.740864149560733),
                                    ("Yom HaShoahyear (latent)", -5.740864149560733),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.740864149560733),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.1463292576688975),
                                    ("Septemberyear (latent)", -5.740864149560733),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.893566289173529),
                                    ("Halloweenyear (latent)", -6.1463292576688975),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.1463292576688975),
                                    ("at <time-of-day>intersect", -5.740864149560733),
                                    ("Rosh Hashanahyear (latent)", -5.453182077108952),
                                    ("Dhanterasyear (latent)", -6.1463292576688975),
                                    ("Tu BiShvatyear (latent)", -6.1463292576688975),
                                    ("Holiyear (latent)", -5.453182077108952),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.1463292576688975),
                                    ("Holika Dahanyear (latent)", -5.453182077108952),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.1463292576688975),
                                    ("dayminute", -3.405489233743696),
                                    ("Mawlidyear (latent)", -6.1463292576688975),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.740864149560733),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.1463292576688975),
                                    ("Jumu'atul-Widayear (latent)", -5.230038525794742),
                                    ("minuteday", -2.5087430979425114),
                                    ("absorption of , after named dayintersect",
                                     -6.1463292576688975),
                                    ("Orthodox Easter Sundayyear (latent)", -6.1463292576688975),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.1463292576688975),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.1463292576688975),
                                    ("Boss's Dayyear (latent)", -5.740864149560733),
                                    ("Global Youth Service Dayyear (latent)", -6.1463292576688975),
                                    ("Dhanterasin|during <named-month>|year", -6.1463292576688975),
                                    ("Tisha B'Avyear (latent)", -6.1463292576688975),
                                    ("Isra and Mi'rajyear (latent)", -5.230038525794742),
                                    ("at <time-of-day>on <day>", -5.0477169690007875),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.1463292576688975),
                                    ("Christmasyear (latent)", -5.740864149560733),
                                    ("Naraka Chaturdashiyear (latent)", -5.740864149560733),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.1463292576688975),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.1463292576688975),
                                    ("dayweek", -6.1463292576688975),
                                    ("Easter Sundayyear (latent)", -5.453182077108952),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.536891345234797),
                                    ("weekyear", -5.0477169690007875),
                                    ("hh:mmin|during the <part-of-day>", -5.453182077108952),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.740864149560733),
                                    ("Hanukkahyear (latent)", -5.453182077108952),
                                    ("February<time> <part-of-day>", -6.1463292576688975),
                                    ("National Grandparents Dayyear (latent)", -6.1463292576688975),
                                    ("Great Lentyear (latent)", -6.1463292576688975),
                                    ("tomorrowat <time-of-day>", -5.453182077108952),
                                    ("Labor Dayyear (latent)", -6.1463292576688975),
                                    ("Vaisakhiyear (latent)", -5.453182077108952),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.1463292576688975),
                                    ("last <cycle> of <time>year (latent)", -5.453182077108952),
                                    ("at <time-of-day>tomorrow", -5.740864149560733),
                                    ("tomorrow<time-of-day> am|pm", -6.1463292576688975),
                                    ("President's Dayyear (latent)", -6.1463292576688975),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.1463292576688975),
                                    ("Diwaliyear (latent)", -6.1463292576688975),
                                    ("between <time> and <time>on <day>", -4.536891345234797),
                                    ("Black Fridayyear (latent)", -5.740864149560733),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.1463292576688975),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.1463292576688975),
                                    ("Chhathyear (latent)", -5.740864149560733),
                                    ("Vasant Panchamiyear (latent)", -6.1463292576688975),
                                    ("Tax Dayyear (latent)", -5.230038525794742),
                                    ("Thursday<time> (timezone)", -6.1463292576688975),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.1463292576688975),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.740864149560733),
                                    ("Februaryintersect", -6.1463292576688975),
                                    ("Mother's Dayyear (latent)", -6.1463292576688975),
                                    ("Simchat Torahyear (latent)", -6.1463292576688975),
                                    ("minuteyear", -6.1463292576688975)],
                               n = 352},
                   koData =
                     ClassData{prior = -1.034760816681577, unseen = -6.428105272684596,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.817050545023591),
                                    ("dayhour", -3.0591926274712167),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.817050545023591),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.733341276897745),
                                    ("hh:mmon <day>", -3.7184382563554808),
                                    ...
                                    ("Mondayyear (latent)", -4.634728988229636),
                                    ("dayday", -5.327876168789581),
                                    ("mm/ddat <time-of-day>", -5.327876168789581),
                                    ("on <day>September", -5.327876168789581),
                                    ("dayyear", -2.788902297731305),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.12282082968634055,
                               ...
                               n = 176},
                   koData =
                     ClassData{prior = -2.1578106087953426, unseen = -3.332204510175204,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                    ...
                                    ("on <day><time-of-day> am|pm", -4.290459441148391),
