...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5915145350161334, unseen = -5.883322388488279,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 357},
                   koData =
                     ClassData{prior = -0.8062898366598266, unseen = -5.66988092298052,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.42467008794421435,
                               unseen = -6.863803391452954,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.169610732491456),
                                    ("Father's Dayyear (latent)", -6.169610732491456),
                                    ("Ramadanyear (latent)", -6.169610732491456),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.916847763996088),
                                    ("Military Spouse Dayyear (latent)", -6.169610732491456),
                                    ("Bhai Doojyear (latent)", -6.169610732491456),
                                    ("hourday", -4.46486264025303), ("dayhour", -3.307409851561988),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.916847763996088),
                                    ("Martin Luther King's Dayyear (latent)", -5.764145624383292),
                                    ("Shemini Atzeretyear (latent)", -6.169610732491456),
                                    ("daymonth", -5.253320000617301),
                                    ("monthday", -5.764145624383292),
                                    ("monthyear", -4.377851263263401),
                                    ("yearhour", -5.764145624383292),
                                    ("Yom Ha'atzmautyear (latent)", -6.169610732491456),
                                    ("Vijayadashamiyear (latent)", -6.169610732491456),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -4.783316371371566),
                                    ("Thanksgiving Dayyear (latent)", -5.070998443823346),
                                    ("Thai Pongalyear (latent)", -5.476463551931511),
                                    ("Thiru Onamyear (latent)", -5.476463551931511),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.169610732491456),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.169610732491456),
                                    ("houryear", -5.476463551931511),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.169610732491456),
                                    ("Christmas<time-of-day> am|pm", -6.169610732491456),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.169610732491456),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.476463551931511),
                                    ("<time-of-day> am|pmintersect", -4.916847763996088),
                                    ("Earth Houryear (latent)", -6.169610732491456),
                                    ("Octoberyear (latent)", -4.665533335715182),
                                    ("intersect<time-of-day> am|pm", -6.169610732491456),
                                    ("Mattu Pongalyear (latent)", -6.169610732491456),
                                    ("Daylight Saving Start Dayyear (latent)", -5.253320000617301),
                                    ("Shavuotyear (latent)", -6.169610732491456),
                                    ...
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.764145624383292),
                                    ("Marchyear (latent)", -6.169610732491456),
                                    ("Sukkotyear (latent)", -5.764145624383292),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.169610732491456),
                                    ("Daylight Saving End Dayyear (latent)", -5.253320000617301),
                                    ("Clean Mondayyear (latent)", -5.764145624383292),
                                    ("monthhour", -5.764145624383292),
                                    ("todayat <time-of-day>", -6.169610732491456),
                                    ("Thursday<time> timezone", -4.223700583436143),
                                    ("from|since|after <time>December", -6.169610732491456),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.169610732491456),
                                    ("<time-of-day> am|pmon <day>", -4.154707711949191),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.169610732491456),
                                    ("yyyy-mm-ddhh:mm:ss", -5.764145624383292),
                                    ("Tax Daythis|last|next <cycle>", -6.169610732491456),
                                    ("dayday", -4.154707711949191),
                                    ("<time> <part-of-day>at <time-of-day>", -6.169610732491456),
                                    ("mm/ddat <time-of-day>", -6.169610732491456),
                                    ("tonightat <time-of-day>", -6.169610732491456),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.476463551931511),
                                    ("today<time-of-day> am|pm", -6.169610732491456),
                                    ("Februarythe <day-of-month> (ordinal)", -5.764145624383292),
                                    ("at <time-of-day><time> <part-of-day>", -6.169610732491456),
                                    ("mm/dd<time-of-day> am|pm", -6.169610732491456),
                                    ("hourhour", -4.916847763996088),
                                    ("Navaratriin|during <named-month>|year", -6.169610732491456),
                                    ("Wednesdaythis|last|next <cycle>", -6.169610732491456),
                                    ("Lentyear (latent)", -6.169610732491456),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.665533335715182),
                                    ("Boghiyear (latent)", -6.169610732491456),
                                    ("dayyear", -1.8521226189551456),
                                    ("Thursdayfrom|since|after <time>", -5.764145624383292),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.169610732491456),
                                    ("Thursdayat <time-of-day>", -5.476463551931511),
                                    ("Islamic New Yearyear (latent)", -5.764145624383292),
                                    ("Laylat al-Qadryear (latent)", -5.253320000617301),
                                    ("Shrove Tuesdayyear (latent)", -6.169610732491456),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.476463551931511),
                                    ("<time-of-day> am|pmtomorrow", -5.476463551931511),
                                    ("Yom Kippuryear (latent)", -6.169610732491456),
                                    ("<part-of-day> of <time>year (latent)", -6.169610732491456),
                                    ("minutehour", -5.253320000617301),
                                    ("Kaanum Pongalyear (latent)", -5.764145624383292),
                                    ("Maha Saptamiyear (latent)", -6.169610732491456),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.764145624383292),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.46486264025303),
                                    ("for <duration> from <time>December", -6.169610732491456),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.169610732491456),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.916847763996088),
                                    ("Pentecostyear (latent)", -6.169610732491456),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.916847763996088),
                                    ("Eid al-Fitryear (latent)", -6.169610732491456),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.169610732491456),
                                    ("Mondayin|during the <part-of-day>", -6.169610732491456),
                                    ("Chhathin|during <named-month>|year", -6.169610732491456),
                                    ("Diwaliin|during <named-month>|year", -6.169610732491456),
                                    ("Vaisakhiin|during <named-month>|year", -6.169610732491456),
                                    ("Raksha Bandhanyear (latent)", -6.169610732491456),
                                    ("daysecond", -5.764145624383292),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.764145624383292),
                                    ("Emancipation Dayyear (latent)", -5.476463551931511),
                                    ("Ashurayear (latent)", -6.169610732491456),
                                    ("Tuesdayin|during <named-month>|year", -6.169610732491456),
                                    ("Chinese New Yearyear (latent)", -6.169610732491456),
                                    ("Lag BaOmeryear (latent)", -6.169610732491456),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.169610732491456),
                                    ("Eid al-Adhayear (latent)", -5.253320000617301),
                                    ("intersectin|during the <part-of-day>", -6.169610732491456),
                                    ("Palm Sundayyear (latent)", -6.169610732491456),
                                    ("Christmasat <time-of-day>", -6.169610732491456),
                                    ("Passoveryear (latent)", -6.169610732491456),
                                    ("Lazarus Saturdayyear (latent)", -6.169610732491456),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.169610732491456),
                                    ("Cyber Mondayyear (latent)", -5.764145624383292),
                                    ("Yom HaShoahyear (latent)", -5.764145624383292),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.764145624383292),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.169610732491456),
                                    ("Septemberyear (latent)", -5.764145624383292),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.665533335715182),
                                    ("Halloweenyear (latent)", -6.169610732491456),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.169610732491456),
                                    ("at <time-of-day>intersect", -5.764145624383292),
                                    ("Rosh Hashanahyear (latent)", -5.476463551931511),
                                    ("Dhanterasyear (latent)", -6.169610732491456),
                                    ("Tu BiShvatyear (latent)", -6.169610732491456),
                                    ("Holiyear (latent)", -5.476463551931511),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.169610732491456),
                                    ("Holika Dahanyear (latent)", -5.476463551931511),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.169610732491456),
                                    ("dayminute", -3.251840000407177),
                                    ("Mawlidyear (latent)", -6.169610732491456),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.764145624383292),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.169610732491456),
                                    ("Jumu'atul-Widayear (latent)", -5.253320000617301),
                                    ("minuteday", -2.5320245727650703),
                                    ("absorption of , after named dayintersect",
                                     -6.169610732491456),
                                    ("in|within|after <duration><time-of-day> am|pm",
                                     -6.169610732491456),
                                    ("Orthodox Easter Sundayyear (latent)", -6.169610732491456),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.169610732491456),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.169610732491456),
                                    ("Boss's Dayyear (latent)", -5.764145624383292),
                                    ("Global Youth Service Dayyear (latent)", -6.169610732491456),
                                    ("Dhanterasin|during <named-month>|year", -6.169610732491456),
                                    ("Tisha B'Avyear (latent)", -6.169610732491456),
                                    ("Isra and Mi'rajyear (latent)", -5.253320000617301),
                                    ("at <time-of-day>on <day>", -5.070998443823346),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.169610732491456),
                                    ("Christmasyear (latent)", -5.764145624383292),
                                    ("Naraka Chaturdashiyear (latent)", -5.764145624383292),
                                    ("Thai Pongalin|during <named-month>|year", -6.169610732491456),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.169610732491456),
                                    ("dayweek", -6.169610732491456),
                                    ("Easter Sundayyear (latent)", -5.476463551931511),
                                    ...
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.764145624383292),
                                    ("Hanukkahyear (latent)", -5.476463551931511),
                                    ("February<time> <part-of-day>", -6.169610732491456),
                                    ("National Grandparents Dayyear (latent)", -6.169610732491456),
                                    ("Great Lentyear (latent)", -6.169610732491456),
                                    ("tomorrowat <time-of-day>", -5.476463551931511),
                                    ("Labor Dayyear (latent)", -6.169610732491456),
                                    ("Vaisakhiyear (latent)", -5.476463551931511),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.169610732491456),
                                    ("last <cycle> of <time>year (latent)", -5.476463551931511),
                                    ("at <time-of-day>tomorrow", -5.764145624383292),
                                    ("tomorrow<time-of-day> am|pm", -6.169610732491456),
                                    ("President's Dayyear (latent)", -6.169610732491456),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.169610732491456),
                                    ("Diwaliyear (latent)", -6.169610732491456),
                                    ("between <time> and <time>on <day>", -4.560172820057356),
                                    ("Black Fridayyear (latent)", -5.764145624383292),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.169610732491456),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.169610732491456),
                                    ("Chhathyear (latent)", -5.764145624383292),
                                    ("Vasant Panchamiyear (latent)", -6.169610732491456),
                                    ("Tax Dayyear (latent)", -5.253320000617301),
                                    ("St Patrick's Dayyear (latent)", -6.169610732491456),
                                    ("Thursday<time> (timezone)", -6.169610732491456),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.169610732491456),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.764145624383292),
                                    ("Februaryintersect", -6.169610732491456),
                                    ("Mother's Dayyear (latent)", -6.169610732491456),
                                    ("Simchat Torahyear (latent)", -6.169610732491456),
                                    ("minuteyear", -6.169610732491456)],
                               n = 361},
                   koData =
                     ClassData{prior = -1.0612746182304655, unseen = -6.424869023905388,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.81380905109942),
                                    ("dayhour", -3.0559511335470457),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.81380905109942),
                                    ("Tuesdayfrom|since|after <time>", -5.730099782973574),
                                    ("daymonth", -3.71519676243131),
                                    ("monthyear", -4.477336814478207),
                                    ("yearhour", -5.730099782973574),
                                    ("<time-of-day> am|pmyear (latent)", -5.0369526024136295),
                                    ("Thai Pongalyear (latent)", -5.0369526024136295),
                                    ("intersecthh:mm", -5.730099782973574),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.730099782973574),
                                    ("houryear", -4.631487494305465),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.730099782973574),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.0369526024136295),
                                    ("<time-of-day> am|pmintersect", -4.477336814478207),
                                    ("Octoberyear (latent)", -5.730099782973574),
                                    ("until <time>on <day>", -5.0369526024136295),
                                    ("in|within|after <duration>at <time-of-day>",
                                     -5.730099782973574),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.0369526024136295),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.730099782973574),
                                    ("hh:mmon <day>", -3.71519676243131),
                                    ("absorption of , after named dayJuly", -5.32463467486541),
                                    ("from|since|after <time>July", -5.730099782973574),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.81380905109942),
                                    ("Clean Mondayyear (latent)", -5.730099782973574),
                                    ("monthhour", -5.730099782973574),
                                    ("hourmonth", -4.81380905109942),
                                    ("todayat <time-of-day>", -5.730099782973574),
                                    ("from|since|after <time>December", -5.730099782973574),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.730099782973574),
                                    ("<time-of-day> am|pmon <day>", -4.477336814478207),
                                    ("Mondayyear (latent)", -4.631487494305465),
                                    ("dayday", -5.32463467486541),
                                    ("mm/ddat <time-of-day>", -5.32463467486541),
                                    ("on <day>September", -5.32463467486541),
                                    ("dayyear", -2.785660803807134),
                                    ("Thursdaymm/dd", -5.730099782973574),
                                    ("New Year's Dayyear (latent)", -5.32463467486541),
                                    ("Thursdayfrom|since|after <time>", -4.02535169073515),
                                    ("Thursdayat <time-of-day>", -4.120661870539474),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.730099782973574),
                                    ("Aprilyear (latent)", -5.730099782973574),
                                    ("monthminute", -5.730099782973574),
                                    ("<time-of-day> am|pmtomorrow", -5.730099782973574),
                                    ("Thursdayhh:mm", -4.81380905109942),
                                    ("minutemonth", -3.9383403137455195),
                                    ("Augustyear (latent)", -5.32463467486541),
                                    ("week-endin|during <named-month>|year", -5.730099782973574),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.32463467486541),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.730099782973574),
                                    ("Sundayyear (latent)", -4.81380905109942),
                                    ("Christmasat <time-of-day>", -5.730099782973574),
                                    ("from|since|after <time>year (latent)", -4.631487494305465),
                                    ("<duration> after|before|from <time>December",
                                     -5.730099782973574),
                                    ("yesterday<time-of-day> am|pm", -5.730099782973574),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.730099782973574),
                                    ("mm/ddyear (latent)", -5.730099782973574),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.730099782973574),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.730099782973574),
                                    ("at <time-of-day>intersect", -5.32463467486541),
                                    ("hh:mmyear (latent)", -4.477336814478207),
                                    ("Holiyear (latent)", -5.730099782973574),
                                    ("until <time><time-of-day> am|pm", -5.730099782973574),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.730099782973574),
                                    ("dayminute", -3.1651504255120377),
                                    ("yyyy-mm-ddhh:mm", -5.32463467486541),
                                    ("intersectSeptember", -4.2260223861973),
                                    ("minuteday", -2.6620468478399575),
                                    ("absorption of , after named dayintersect",
                                     -5.730099782973574),
                                    ("Februaryin|during the <part-of-day>", -5.730099782973574),
                                    ("Saturdayyear (latent)", -5.730099782973574),
                                    ("at <time-of-day>on <day>", -5.32463467486541),
                                    ("absorption of , after named daySeptember", -4.81380905109942),
                                    ("Naraka Chaturdashiyear (latent)", -5.730099782973574),
                                    ("from|since|after <time>on <day>", -4.81380905109942),
                                    ("dayweek", -5.730099782973574),
                                    ("Easter Sundayyear (latent)", -5.32463467486541),
                                    ("Thursday<time-of-day> am|pm", -4.477336814478207),
                                    ("weekyear", -5.32463467486541),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.0369526024136295),
                                    ("Sundayfrom|since|after <time>", -5.730099782973574),
                                    ("absorption of , after named dayFebruary", -4.81380905109942),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.730099782973574),
                                    ("tomorrowat <time-of-day>", -5.730099782973574),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.730099782973574),
                                    ("last <cycle> of <time>year (latent)", -5.32463467486541),
                                    ("tomorrow<time-of-day> am|pm", -5.730099782973574),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.0369526024136295),
                                    ("Diwaliyear (latent)", -5.32463467486541),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.730099782973574),
                                    ("Fridayyear (latent)", -5.32463467486541),
                                    ("minuteyear", -4.343805421853684)],
                               n = 191}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.13211796482737562,
                               ...
                               n = 177},
                   koData =
                     ClassData{prior = -2.089391872533004, unseen = -3.4011973816621555,
                               likelihoods =
                                 HashMap.fromList
