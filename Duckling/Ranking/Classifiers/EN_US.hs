...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.592767995252323, unseen = -5.8805329864007,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 356},
                   koData =
                     ClassData{prior = -0.8047382459684077, unseen = -5.66988092298052,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.42563077770275887,
                               unseen = -6.860663671448286,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.166467723094256),
                                    ("Father's Dayyear (latent)", -6.166467723094256),
                                    ("Ramadanyear (latent)", -6.166467723094256),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.913704754598889),
                                    ("Military Spouse Dayyear (latent)", -6.166467723094256),
                                    ("Bhai Doojyear (latent)", -6.166467723094256),
                                    ("hourday", -4.461719630855832),
                                    ("dayhour", -3.3042668421647883),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.913704754598889),
                                    ("Martin Luther King's Dayyear (latent)", -5.761002614986093),
                                    ("Shemini Atzeretyear (latent)", -6.166467723094256),
                                    ("daymonth", -5.250176991220102),
                                    ("monthday", -5.761002614986093),
                                    ("monthyear", -4.374708253866202),
                                    ("yearhour", -5.761002614986093),
                                    ("Yom Ha'atzmautyear (latent)", -6.166467723094256),
                                    ("Vijayadashamiyear (latent)", -6.166467723094256),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -4.7801733619743665),
                                    ("Thanksgiving Dayyear (latent)", -5.067855434426147),
                                    ("Thai Pongalyear (latent)", -5.473320542534312),
                                    ("Thiru Onamyear (latent)", -5.473320542534312),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.166467723094256),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.166467723094256),
                                    ("houryear", -5.473320542534312),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.166467723094256),
                                    ("Christmas<time-of-day> am|pm", -6.166467723094256),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.166467723094256),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.473320542534312),
                                    ("<time-of-day> am|pmintersect", -4.913704754598889),
                                    ("Earth Houryear (latent)", -6.166467723094256),
                                    ("Octoberyear (latent)", -4.662390326317983),
                                    ("intersect<time-of-day> am|pm", -6.166467723094256),
                                    ("Mattu Pongalyear (latent)", -6.166467723094256),
                                    ("Daylight Saving Start Dayyear (latent)", -5.250176991220102),
                                    ("Shavuotyear (latent)", -6.166467723094256),
                                    ...
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.761002614986093),
                                    ("Marchyear (latent)", -6.166467723094256),
                                    ("Sukkotyear (latent)", -5.761002614986093),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.166467723094256),
                                    ("Daylight Saving End Dayyear (latent)", -5.250176991220102),
                                    ("Clean Mondayyear (latent)", -5.761002614986093),
                                    ("monthhour", -5.761002614986093),
                                    ("todayat <time-of-day>", -6.166467723094256),
                                    ("Thursday<time> timezone", -4.220557574038944),
                                    ("from|since|after <time>December", -6.166467723094256),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.166467723094256),
                                    ("<time-of-day> am|pmon <day>", -4.151564702551992),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.166467723094256),
                                    ("yyyy-mm-ddhh:mm:ss", -5.761002614986093),
                                    ("Tax Daythis|last|next <cycle>", -6.166467723094256),
                                    ("dayday", -4.151564702551992),
                                    ("<time> <part-of-day>at <time-of-day>", -6.166467723094256),
                                    ("mm/ddat <time-of-day>", -6.166467723094256),
                                    ("tonightat <time-of-day>", -6.166467723094256),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.473320542534312),
                                    ("today<time-of-day> am|pm", -6.166467723094256),
                                    ("Februarythe <day-of-month> (ordinal)", -5.761002614986093),
                                    ("at <time-of-day><time> <part-of-day>", -6.166467723094256),
                                    ("mm/dd<time-of-day> am|pm", -6.166467723094256),
                                    ("hourhour", -4.913704754598889),
                                    ("Navaratriin|during <named-month>|year", -6.166467723094256),
                                    ("Wednesdaythis|last|next <cycle>", -6.166467723094256),
                                    ("Lentyear (latent)", -6.166467723094256),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.662390326317983),
                                    ("Boghiyear (latent)", -6.166467723094256),
                                    ("dayyear", -1.8556685977087428),
                                    ("Thursdayfrom|since|after <time>", -5.761002614986093),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.166467723094256),
                                    ("Thursdayat <time-of-day>", -5.473320542534312),
                                    ("Islamic New Yearyear (latent)", -5.761002614986093),
                                    ("Laylat al-Qadryear (latent)", -5.250176991220102),
                                    ("Shrove Tuesdayyear (latent)", -6.166467723094256),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.473320542534312),
                                    ("<time-of-day> am|pmtomorrow", -5.473320542534312),
                                    ("Yom Kippuryear (latent)", -6.166467723094256),
                                    ("<part-of-day> of <time>year (latent)", -6.166467723094256),
                                    ("minutehour", -5.250176991220102),
                                    ("Kaanum Pongalyear (latent)", -5.761002614986093),
                                    ("Maha Saptamiyear (latent)", -6.166467723094256),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.761002614986093),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.461719630855832),
                                    ("for <duration> from <time>December", -6.166467723094256),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.166467723094256),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.913704754598889),
                                    ("Pentecostyear (latent)", -6.166467723094256),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.913704754598889),
                                    ("Eid al-Fitryear (latent)", -6.166467723094256),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.166467723094256),
                                    ("Mondayin|during the <part-of-day>", -6.166467723094256),
                                    ("Chhathin|during <named-month>|year", -6.166467723094256),
                                    ("Diwaliin|during <named-month>|year", -6.166467723094256),
                                    ("Vaisakhiin|during <named-month>|year", -6.166467723094256),
                                    ("Raksha Bandhanyear (latent)", -6.166467723094256),
                                    ("daysecond", -5.761002614986093),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.761002614986093),
                                    ("Emancipation Dayyear (latent)", -5.473320542534312),
                                    ("Ashurayear (latent)", -6.166467723094256),
                                    ("Tuesdayin|during <named-month>|year", -6.166467723094256),
                                    ("Chinese New Yearyear (latent)", -6.166467723094256),
                                    ("Lag BaOmeryear (latent)", -6.166467723094256),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.166467723094256),
                                    ("Eid al-Adhayear (latent)", -5.250176991220102),
                                    ("intersectin|during the <part-of-day>", -6.166467723094256),
                                    ("Palm Sundayyear (latent)", -6.166467723094256),
                                    ("Christmasat <time-of-day>", -6.166467723094256),
                                    ("Passoveryear (latent)", -6.166467723094256),
                                    ("Lazarus Saturdayyear (latent)", -6.166467723094256),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.166467723094256),
                                    ("Cyber Mondayyear (latent)", -5.761002614986093),
                                    ("Yom HaShoahyear (latent)", -5.761002614986093),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.761002614986093),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.166467723094256),
                                    ("Septemberyear (latent)", -5.761002614986093),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.662390326317983),
                                    ("Halloweenyear (latent)", -6.166467723094256),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.166467723094256),
                                    ("at <time-of-day>intersect", -5.761002614986093),
                                    ("Rosh Hashanahyear (latent)", -5.473320542534312),
                                    ("Dhanterasyear (latent)", -6.166467723094256),
                                    ("Tu BiShvatyear (latent)", -6.166467723094256),
                                    ("Holiyear (latent)", -5.473320542534312),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.166467723094256),
                                    ("Holika Dahanyear (latent)", -5.473320542534312),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.166467723094256),
                                    ("dayminute", -3.248696991009978),
                                    ("Mawlidyear (latent)", -6.166467723094256),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.761002614986093),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.166467723094256),
                                    ("Jumu'atul-Widayear (latent)", -5.250176991220102),
                                    ("minuteday", -2.528881563367871),
                                    ("absorption of , after named dayintersect",
                                     -6.166467723094256),
                                    ("in|within|after <duration><time-of-day> am|pm",
                                     -6.166467723094256),
                                    ("Orthodox Easter Sundayyear (latent)", -6.166467723094256),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.166467723094256),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.166467723094256),
                                    ("Boss's Dayyear (latent)", -5.761002614986093),
                                    ("Global Youth Service Dayyear (latent)", -6.166467723094256),
                                    ("Dhanterasin|during <named-month>|year", -6.166467723094256),
                                    ("Tisha B'Avyear (latent)", -6.166467723094256),
                                    ("Isra and Mi'rajyear (latent)", -5.250176991220102),
                                    ("at <time-of-day>on <day>", -5.067855434426147),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.166467723094256),
                                    ("Christmasyear (latent)", -5.761002614986093),
                                    ("Naraka Chaturdashiyear (latent)", -5.761002614986093),
                                    ("Thai Pongalin|during <named-month>|year", -6.166467723094256),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.166467723094256),
                                    ("dayweek", -6.166467723094256),
                                    ("Easter Sundayyear (latent)", -5.473320542534312),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.557029810660157),
                                    ("weekyear", -5.067855434426147),
                                    ("hh:mmin|during the <part-of-day>", -5.473320542534312),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.761002614986093),
                                    ("Hanukkahyear (latent)", -5.473320542534312),
                                    ("February<time> <part-of-day>", -6.166467723094256),
                                    ("National Grandparents Dayyear (latent)", -6.166467723094256),
                                    ("Great Lentyear (latent)", -6.166467723094256),
                                    ("tomorrowat <time-of-day>", -5.473320542534312),
                                    ("Labor Dayyear (latent)", -6.166467723094256),
                                    ("Vaisakhiyear (latent)", -5.473320542534312),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.166467723094256),
                                    ("last <cycle> of <time>year (latent)", -5.473320542534312),
                                    ("at <time-of-day>tomorrow", -5.761002614986093),
                                    ("tomorrow<time-of-day> am|pm", -6.166467723094256),
                                    ("President's Dayyear (latent)", -6.166467723094256),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.166467723094256),
                                    ("Diwaliyear (latent)", -6.166467723094256),
                                    ("between <time> and <time>on <day>", -4.557029810660157),
                                    ("Black Fridayyear (latent)", -5.761002614986093),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.166467723094256),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.166467723094256),
                                    ("Chhathyear (latent)", -5.761002614986093),
                                    ("Vasant Panchamiyear (latent)", -6.166467723094256),
                                    ("Tax Dayyear (latent)", -5.250176991220102),
                                    ("Thursday<time> (timezone)", -6.166467723094256),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.166467723094256),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.761002614986093),
                                    ("Februaryintersect", -6.166467723094256),
                                    ("Mother's Dayyear (latent)", -6.166467723094256),
                                    ("Simchat Torahyear (latent)", -6.166467723094256),
                                    ("minuteyear", -6.166467723094256)],
                               n = 360},
                   koData =
                     ClassData{prior = -1.0594613811062847, unseen = -6.423246963533519,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.812184355372417),
                                    ("dayhour", -3.054326437820044),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.812184355372417),
                                    ("Tuesdayfrom|since|after <time>", -5.728475087246572),
                                    ("daymonth", -3.713572066704308),
                                    ("monthyear", -4.475712118751204),
                                    ("yearhour", -5.728475087246572),
                                    ("<time-of-day> am|pmyear (latent)", -5.035327906686628),
                                    ("Thai Pongalyear (latent)", -5.035327906686628),
                                    ("intersecthh:mm", -5.728475087246572),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.728475087246572),
                                    ("houryear", -4.629862798578463),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.728475087246572),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.035327906686628),
                                    ("<time-of-day> am|pmintersect", -4.475712118751204),
                                    ("Octoberyear (latent)", -5.728475087246572),
                                    ("until <time>on <day>", -5.035327906686628),
                                    ("in|within|after <duration>at <time-of-day>",
                                     -5.728475087246572),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.035327906686628),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.728475087246572),
                                    ("hh:mmon <day>", -3.713572066704308),
                                    ("absorption of , after named dayJuly", -5.3230099791384085),
                                    ("from|since|after <time>July", -5.728475087246572),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.812184355372417),
                                    ("Clean Mondayyear (latent)", -5.728475087246572),
                                    ("monthhour", -5.728475087246572),
                                    ("hourmonth", -4.812184355372417),
                                    ("todayat <time-of-day>", -5.728475087246572),
                                    ("from|since|after <time>December", -5.728475087246572),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.728475087246572),
                                    ("<time-of-day> am|pmon <day>", -4.475712118751204),
                                    ("Mondayyear (latent)", -4.629862798578463),
                                    ("dayday", -5.3230099791384085),
                                    ("mm/ddat <time-of-day>", -5.3230099791384085),
                                    ("on <day>September", -5.3230099791384085),
                                    ("dayyear", -2.784036108080132),
                                    ("Thursdaymm/dd", -5.728475087246572),
                                    ("New Year's Dayyear (latent)", -5.3230099791384085),
                                    ("Thursdayfrom|since|after <time>", -4.023726995008147),
                                    ("Thursdayat <time-of-day>", -4.119037174812472),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.728475087246572),
                                    ("Aprilyear (latent)", -5.728475087246572),
                                    ("monthminute", -5.728475087246572),
                                    ("<time-of-day> am|pmtomorrow", -5.728475087246572),
                                    ("Thursdayhh:mm", -4.812184355372417),
                                    ("minutemonth", -3.9367156180185177),
                                    ("Augustyear (latent)", -5.3230099791384085),
                                    ("week-endin|during <named-month>|year", -5.728475087246572),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.3230099791384085),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.728475087246572),
                                    ("Sundayyear (latent)", -4.812184355372417),
                                    ("Christmasat <time-of-day>", -5.728475087246572),
                                    ("from|since|after <time>year (latent)", -4.629862798578463),
                                    ("<duration> after|before|from <time>December",
                                     -5.728475087246572),
                                    ("yesterday<time-of-day> am|pm", -5.728475087246572),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.728475087246572),
                                    ("mm/ddyear (latent)", -5.728475087246572),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.728475087246572),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.728475087246572),
                                    ("at <time-of-day>intersect", -5.3230099791384085),
                                    ("hh:mmyear (latent)", -4.475712118751204),
                                    ("Holiyear (latent)", -5.728475087246572),
                                    ("until <time><time-of-day> am|pm", -5.728475087246572),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.728475087246572),
                                    ("dayminute", -3.163525729785036),
                                    ("yyyy-mm-ddhh:mm", -5.3230099791384085),
                                    ("intersectSeptember", -4.2243976904702984),
                                    ("minuteday", -2.6604221521129556),
                                    ("absorption of , after named dayintersect",
                                     -5.728475087246572),
                                    ("Februaryin|during the <part-of-day>", -5.728475087246572),
                                    ("Saturdayyear (latent)", -5.728475087246572),
                                    ("at <time-of-day>on <day>", -5.3230099791384085),
                                    ("absorption of , after named daySeptember",
                                     -4.812184355372417),
                                    ("Naraka Chaturdashiyear (latent)", -5.728475087246572),
                                    ("from|since|after <time>on <day>", -4.812184355372417),
                                    ("dayweek", -5.728475087246572),
                                    ("Easter Sundayyear (latent)", -5.3230099791384085),
                                    ("Thursday<time-of-day> am|pm", -4.475712118751204),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.035327906686628),
                                    ("Sundayfrom|since|after <time>", -5.728475087246572),
                                    ("absorption of , after named dayFebruary", -4.812184355372417),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.728475087246572),
                                    ("tomorrowat <time-of-day>", -5.728475087246572),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.728475087246572),
                                    ("last <cycle> of <time>year (latent)", -5.3230099791384085),
                                    ("tomorrow<time-of-day> am|pm", -5.728475087246572),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.035327906686628),
                                    ("Diwaliyear (latent)", -5.3230099791384085),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.728475087246572),
                                    ("Fridayyear (latent)", -5.3230099791384085),
                                    ("minuteyear", -4.342180726126682)],
                               n = 191}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.13282091302092397,
                               ...
                               n = 176},
                   koData =
                     ClassData{prior = -2.084429083190875, unseen = -3.4011973816621555,
                               likelihoods =
                                 HashMap.fromList
