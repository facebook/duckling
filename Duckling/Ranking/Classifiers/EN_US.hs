...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5264335214319817, unseen = -6.284134161070802,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 534},
                   koData =
                     ClassData{prior = -0.8933263547539063, unseen = -5.918893854273146,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4818380868927383,
                               unseen = -7.2633296174768365,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.569481420414296),
                                    ("Father's Dayyear (latent)", -6.569481420414296),
                                    ("Karva Chauthyear (latent)", -6.569481420414296),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.569481420414296),
                                    ("Maha Shivaratriyear (latent)", -6.569481420414296),
                                    ("Ramadanyear (latent)", -5.316718451918928),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.183187059294405),
                                    ("Military Spouse Dayyear (latent)", -6.569481420414296),
                                    ("Bhai Doojyear (latent)", -6.569481420414296),
                                    ("hourday", -4.554578399872031),
                                    ("dayhour", -3.5490565342699334),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.183187059294405),
                                    ("Martin Luther King's Dayyear (latent)", -6.164016312306131),
                                    ("Shemini Atzeretyear (latent)", -6.569481420414296),
                                    ("daymonth", -4.554578399872031),
                                    ("monthday", -6.164016312306131),
                                    ("monthyear", -4.7777219511862405),
                                    ("Yom Ha'atzmautyear (latent)", -6.569481420414296),
                                    ("Orthodox Good Fridayyear (latent)", -6.164016312306131),
                                    ("Vijayadashamiyear (latent)", -6.569481420414296),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.183187059294405),
                                    ("Thanksgiving Dayyear (latent)", -5.470869131746186),
                                    ("Thai Pongalyear (latent)", -5.8763342398543505),
                                    ("Thiru Onamyear (latent)", -5.8763342398543505),
                                    ("hhhmmabsorption of , after named day", -6.569481420414296),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.569481420414296),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.653190688540141),
                                    ("<day-of-month> (ordinal)Wednesday", -6.569481420414296),
                                    ("Krishna Janmashtamiyear (latent)", -6.164016312306131),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.569481420414296),
                                    ("houryear", -5.653190688540141),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.569481420414296),
                                    ("Christmas<time-of-day> am|pm", -6.569481420414296),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.569481420414296),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.8763342398543505),
                                    ("intersectin|during <named-month>|year", -6.569481420414296),
                                    ("<time-of-day> am|pmintersect", -5.316718451918928),
                                    ("Earth Houryear (latent)", -6.569481420414296),
                                    ("Ganesh Chaturthiyear (latent)", -6.569481420414296),
                                    ("Octoberyear (latent)", -5.065404023638022),
                                    ("intersect<time-of-day> am|pm", -6.569481420414296),
                                    ("Mattu Pongalyear (latent)", -6.569481420414296),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.569481420414296),
                                    ("Daylight Saving Start Dayyear (latent)", -5.653190688540141),
                                    ("Shavuotyear (latent)", -6.569481420414296),
                                    ("Parsi New Yearyear (latent)", -5.653190688540141),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.569481420414296),
                                    ("the <day-of-month> (ordinal)intersect by \",\", \"of\", \"from\" for year",
                                     -6.569481420414296),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.569481420414296),
                                    ("todayin|within|after <duration>", -6.569481420414296),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.164016312306131),
                                    ("Marchyear (latent)", -6.569481420414296),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.164016312306131),
                                    ("Sukkotyear (latent)", -6.164016312306131),
                                    ("hhhmmintersect", -6.164016312306131),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.164016312306131),
                                    ("Daylight Saving End Dayyear (latent)", -5.653190688540141),
                                    ("Clean Mondayyear (latent)", -6.164016312306131),
                                    ("the <day-of-month> (ordinal)Sunday", -6.569481420414296),
                                    ("monthhour", -6.164016312306131),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.8763342398543505),
                                    ("todayat <time-of-day>", -6.569481420414296),
                                    ("Thursday<time> timezone", -4.171586147615925),
                                    ("tonight<time-of-day> am|pm", -6.569481420414296),
                                    ("time-of-day (latent)tonight", -6.164016312306131),
                                    ("from|since|after <time>December", -6.569481420414296),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.569481420414296),
                                    ("<time-of-day> am|pmon <day>", -4.554578399872031),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.569481420414296),
                                    ("yyyy-mm-ddhh:mm:ss", -6.164016312306131),
                                    ("Tax Daythis|last|next <cycle>", -6.569481420414296),
                                    ("dayday", -3.796892698174515),
                                    ("<time> <part-of-day>at <time-of-day>", -6.164016312306131),
                                    ("mm/ddat <time-of-day>", -6.569481420414296),
                                    ("tonightat <time-of-day>", -5.470869131746186),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.8763342398543505),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.569481420414296),
                                    ("today<time-of-day> am|pm", -6.569481420414296),
                                    ("Februarythe <day-of-month> (ordinal)", -6.164016312306131),
                                    ("at <time-of-day><time> <part-of-day>", -6.569481420414296),
                                    ("<day-of-month> (ordinal)intersect", -6.164016312306131),
                                    ("mm/dd<time-of-day> am|pm", -6.569481420414296),
                                    ("hourhour", -3.599066954844595),
                                    ("Mahavir Jayantiyear (latent)", -6.164016312306131),
                                    ("Navaratriin|during <named-month>|year", -6.569481420414296),
                                    ("Wednesdaythis|last|next <cycle>", -6.569481420414296),
                                    ("Lentyear (latent)", -6.569481420414296),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.697679243512704),
                                    ("Boghiyear (latent)", -6.569481420414296),
                                    ("dayyear", -1.8030430868300822),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.569481420414296),
                                    ("Thursdayfrom|since|after <time>", -6.164016312306131),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.569481420414296),
                                    ("Thursdayat <time-of-day>", -5.8763342398543505),
                                    ("Islamic New Yearyear (latent)", -6.164016312306131),
                                    ("Laylat al-Qadryear (latent)", -5.653190688540141),
                                    ("part of days<time-of-day> am|pm", -6.569481420414296),
                                    ("Shrove Tuesdayyear (latent)", -6.569481420414296),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.8763342398543505),
                                    ("hourminute", -6.164016312306131),
                                    ("<time-of-day> am|pmtomorrow", -5.8763342398543505),
                                    ("Yom Kippuryear (latent)", -6.569481420414296),
                                    ("<day-of-month> (ordinal)Tuesday", -6.164016312306131),
                                    ("<part-of-day> of <time>year (latent)", -6.569481420414296),
                                    ("minutehour", -5.316718451918928),
                                    ("Kaanum Pongalyear (latent)", -6.164016312306131),
                                    ("Maha Saptamiyear (latent)", -6.569481420414296),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.8763342398543505),
                                    ("time-of-day (latent)tomorrow", -5.653190688540141),
                                    ("part of daysat <time-of-day>", -4.960043507980195),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.554578399872031),
                                    ("for <duration> from <time>December", -6.569481420414296),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.569481420414296),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.316718451918928),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.316718451918928),
                                    ("time-of-day (latent)this <part-of-day>", -6.569481420414296),
                                    ("Pentecostyear (latent)", -6.569481420414296),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.316718451918928),
                                    ("<day-of-month> (ordinal)February", -6.569481420414296),
                                    ("Eid al-Fitryear (latent)", -5.183187059294405),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.569481420414296),
                                    ("Mini-Tuesday<duration> hence|ago", -6.569481420414296),
                                    ("Mondayin|during the <part-of-day>", -6.569481420414296),
                                    ("Chhathin|during <named-month>|year", -6.569481420414296),
                                    ("Diwaliin|during <named-month>|year", -6.569481420414296),
                                    ("this <part-of-day><time-of-day> am|pm", -6.569481420414296),
                                    ("Vaisakhiin|during <named-month>|year", -6.569481420414296),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.316718451918928),
                                    ("Raksha Bandhanyear (latent)", -6.569481420414296),
                                    ("daysecond", -6.164016312306131),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.164016312306131),
                                    ("Emancipation Dayyear (latent)", -5.8763342398543505),
                                    ("Ratha-Yatrayear (latent)", -6.569481420414296),
                                    ("Ashurayear (latent)", -6.569481420414296),
                                    ("Tuesdayin|during <named-month>|year", -6.569481420414296),
                                    ("Chinese New Yearyear (latent)", -6.569481420414296),
                                    ("tomorrowintersect", -6.569481420414296),
                                    ("Lag BaOmeryear (latent)", -6.569481420414296),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.569481420414296),
                                    ("Eid al-Adhayear (latent)", -4.429415256918025),
                                    ("intersectin|during the <part-of-day>", -6.569481420414296),
                                    ("Palm Sundayyear (latent)", -6.569481420414296),
                                    ("Christmasat <time-of-day>", -6.569481420414296),
                                    ("Passoveryear (latent)", -6.569481420414296),
                                    ("Lazarus Saturdayyear (latent)", -6.569481420414296),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.569481420414296),
                                    ("Cyber Mondayyear (latent)", -6.164016312306131),
                                    ("hhhmmon <day>", -5.653190688540141),
                                    ("Yom HaShoahyear (latent)", -6.164016312306131),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.164016312306131),
                                    ("Septemberyear (latent)", -6.164016312306131),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.065404023638022),
                                    ("Halloweenyear (latent)", -6.569481420414296),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.569481420414296),
                                    ("at <time-of-day>intersect", -5.653190688540141),
                                    ("Rosh Hashanahyear (latent)", -5.8763342398543505),
                                    ("Super Tuesdayyear (latent)", -5.653190688540141),
                                    ("Dhanterasyear (latent)", -6.569481420414296),
                                    ("Tu BiShvatyear (latent)", -6.569481420414296),
                                    ("<day-of-month> (ordinal)December", -5.8763342398543505),
                                    ("Holiyear (latent)", -5.8763342398543505),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.569481420414296),
                                    ("Holika Dahanyear (latent)", -5.8763342398543505),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.164016312306131),
                                    ("dayminute", -3.219577333139691),
                                    ("Mawlidyear (latent)", -6.569481420414296),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.164016312306131),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.569481420414296),
                                    ("Jumu'atul-Widayear (latent)", -5.653190688540141),
                                    ("minuteday", -2.8318118021309275),
                                    ("absorption of , after named dayintersect",
                                     -5.8763342398543505),
                                    ("intersectyear (latent)", -6.569481420414296),
                                    ("Orthodox Easter Sundayyear (latent)", -6.569481420414296),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.569481420414296),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.569481420414296),
                                    ("Mini-Tuesdayyear (latent)", -6.569481420414296),
                                    ("intersecthhhmm", -6.164016312306131),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.569481420414296),
                                    ("Boss's Dayyear (latent)", -6.164016312306131),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.569481420414296),
                                    ("Global Youth Service Dayyear (latent)", -6.569481420414296),
                                    ("Dhanterasin|during <named-month>|year", -6.569481420414296),
                                    ("Super Tuesdayin|during <named-month>|year",
                                     -6.569481420414296),
                                    ("tonight<time-of-day> o'clock", -6.569481420414296),
                                    ("Tisha B'Avyear (latent)", -6.569481420414296),
                                    ("Isra and Mi'rajyear (latent)", -5.653190688540141),
                                    ("at <time-of-day>on <day>", -4.960043507980195),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.164016312306131),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.8763342398543505),
                                    ("Christmasyear (latent)", -6.164016312306131),
                                    ("Saturdayintersect", -6.569481420414296),
                                    ("Naraka Chaturdashiyear (latent)", -6.164016312306131),
                                    ("Thai Pongalin|during <named-month>|year", -6.569481420414296),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.569481420414296),
                                    ("dayweek", -6.569481420414296),
                                    ("Easter Sundayyear (latent)", -5.8763342398543505),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.164016312306131),
                                    ("weekyear", -5.470869131746186),
                                    ("Super Tuesdaythis|last|next <cycle>", -6.569481420414296),
                                    ("King's Dayyear (latent)", -5.065404023638022),
                                    ("hh:mmin|during the <part-of-day>", -5.653190688540141),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.164016312306131),
                                    ("Hanukkahyear (latent)", -5.8763342398543505),
                                    ("Rama Navamiyear (latent)", -6.569481420414296),
                                    ("February<time> <part-of-day>", -6.569481420414296),
                                    ("National Grandparents Dayyear (latent)", -6.569481420414296),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.8763342398543505),
                                    ("Great Lentyear (latent)", -6.569481420414296),
                                    ("tomorrowat <time-of-day>", -5.8763342398543505),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.569481420414296),
                                    ("Labor Dayyear (latent)", -6.569481420414296),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.164016312306131),
                                    ("Ugadiyear (latent)", -5.183187059294405),
                                    ("Vaisakhiyear (latent)", -5.8763342398543505),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.8763342398543505),
                                    ("last <cycle> of <time>year (latent)", -5.8763342398543505),
                                    ("at <time-of-day>tomorrow", -6.164016312306131),
                                    ("tomorrow<time-of-day> am|pm", -6.569481420414296),
                                    ("President's Dayyear (latent)", -6.569481420414296),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.569481420414296),
                                    ("Diwaliyear (latent)", -6.569481420414296),
                                    ("between <time> and <time>on <day>", -6.164016312306131),
                                    ("Black Fridayyear (latent)", -6.164016312306131),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.569481420414296),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.569481420414296),
                                    ("Chhathyear (latent)", -6.164016312306131),
                                    ("Vasant Panchamiyear (latent)", -6.569481420414296),
                                    ("Tax Dayyear (latent)", -5.470869131746186),
                                    ("Rabindra Jayantiyear (latent)", -5.316718451918928),
                                    ("this <part-of-day>at <time-of-day>", -5.316718451918928),
                                    ("St Patrick's Dayyear (latent)", -6.569481420414296),
                                    ("Thursday<time> (timezone)", -6.569481420414296),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.569481420414296),
                                    ("Pargat Diwasyear (latent)", -5.316718451918928),
                                    ("<datetime> - <datetime> (interval)July", -6.164016312306131),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.8763342398543505),
                                    ("Februaryintersect", -6.569481420414296),
                                    ("Mother's Dayyear (latent)", -6.569481420414296),
                                    ("Simchat Torahyear (latent)", -6.569481420414296),
                                    ("minuteyear", -6.569481420414296)],
                               n = 546},
                   koData =
                     ClassData{prior = -0.9614111671546247, unseen = -6.918695219020472,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.720481032499086),
                                    ("hourday", -3.659609071813823),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.22455842927536),
                                    ("<day-of-month> (ordinal)August", -6.22455842927536),
                                    ("dayhour", -3.550409779848831),
                                    ("<time> timezoneyear (latent)", -5.531411248715415),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.308267697401205),
                                    ("Tuesdayfrom|since|after <time>", -5.12594614060725),
                                    ("daymonth", -3.550409779848831),
                                    ("hourquarter", -5.308267697401205),
                                    ("monthyear", -4.971795460779992),
                                    ("<time-of-day> am|pmyear (latent)", -5.531411248715415),
                                    ("Thai Pongalyear (latent)", -5.531411248715415),
                                    ("intersecthh:mm", -6.22455842927536),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.819093321167196),
                                    ("<datetime> - <datetime> (interval)Sunday",
                                     -5.819093321167196),
                                    ("<day-of-month> (ordinal)Wednesday", -6.22455842927536),
                                    ("houryear", -4.432798960047305),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.22455842927536),
                                    ("<day-of-month> (ordinal)October", -6.22455842927536),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.531411248715415),
                                    ("hournograin", -4.971795460779992),
                                    ("<time-of-day> am|pmintersect", -4.971795460779992),
                                    ("Octoberyear (latent)", -6.22455842927536),
                                    ("Good Fridayyear (latent)", -5.819093321167196),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.819093321167196),
                                    ("early morningat <time-of-day>", -6.22455842927536),
                                    ("until <time>on <day>", -5.531411248715415),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.22455842927536),
                                    ("time-of-day (latent)intersect", -5.531411248715415),
                                    ("todayin <number> (implicit minutes)", -6.22455842927536),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.531411248715415),
                                    ("this <part-of-day><time-of-day> - <time-of-day> (interval)",
                                     -6.22455842927536),
                                    ("about|exactly <time-of-day>year (latent)", -6.22455842927536),
                                    ("hh:mmon <day>", -4.971795460779992),
                                    ("hhhmmintersect", -5.819093321167196),
                                    ("absorption of , after named dayJuly", -5.308267697401205),
                                    ("from|since|after <time>July", -5.819093321167196),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.308267697401205),
                                    ("Clean Mondayyear (latent)", -6.22455842927536),
                                    ("monthhour", -6.22455842927536),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.819093321167196),
                                    ("hourmonth", -4.084492265779089),
                                    ("todayat <time-of-day>", -6.22455842927536),
                                    ("hhhmmyear (latent)", -4.971795460779992),
                                    ("from|since|after <time>December", -6.22455842927536),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.22455842927536),
                                    ("<time-of-day> am|pmon <day>", -4.971795460779992),
                                    ("Mondayyear (latent)", -5.12594614060725),
                                    ("dayday", -3.973266630668865),
                                    ("mm/ddat <time-of-day>", -5.819093321167196),
                                    ("on <day>September", -5.531411248715415),
                                    ("time-of-day (latent)September", -5.819093321167196),
                                    ("hourhour", -4.145116887595524),
                                    ("time-of-day (latent)on <day>", -4.720481032499086),
                                    ("<datetime> - <datetime> (interval)year (latent)",
                                     -6.22455842927536),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.819093321167196),
                                    ("dayyear", -2.892353919100156),
                                    ("Thursdaymm/dd", -6.22455842927536),
                                    ("New Year's Dayyear (latent)", -5.308267697401205),
                                    ("Tuesdayyear (latent)", -5.12594614060725),
                                    ("time-of-day (latent)Sunday", -5.819093321167196),
                                    ("Thursdayfrom|since|after <time>", -4.519810337036935),
                                    ("Thursdayat <time-of-day>", -4.61512051684126),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.22455842927536),
                                    ("Aprilyear (latent)", -6.22455842927536),
                                    ("the <day-of-month> (ordinal)July", -6.22455842927536),
                                    ("the <day-of-month> (number)July", -6.22455842927536),
                                    ("monthminute", -6.22455842927536),
                                    ("<time-of-day> am|pmtomorrow", -6.22455842927536),
                                    ("Thursdayhh:mm", -5.308267697401205),
                                    ("<day-of-month> (ordinal)Tuesday", -5.819093321167196),
                                    ("minutemonth", -4.084492265779089),
                                    ("time-of-day (latent)Friday", -5.819093321167196),
                                    ("minutehour", -6.22455842927536),
                                    ("Tuesdayin <number> (implicit minutes)", -6.22455842927536),
                                    ("part of daysat <time-of-day>", -5.12594614060725),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.873183172111882),
                                    ("<day-of-month> (ordinal)Sunday", -6.22455842927536),
                                    ("Augustyear (latent)", -5.819093321167196),
                                    ("week-endin|during <named-month>|year", -6.22455842927536),
                                    ("time-of-day (latent)Tuesday", -5.819093321167196),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.22455842927536),
                                    ("Tuesdayin|during <named-month>|year", -6.22455842927536),
                                    ("Sundayyear (latent)", -5.308267697401205),
                                    ("hourweek", -5.308267697401205),
                                    ("the <day-of-month> (ordinal)Monday", -5.531411248715415),
                                    ("Christmasat <time-of-day>", -6.22455842927536),
                                    ("from|since|after <time>year (latent)", -5.12594614060725),
                                    ("hhhmmon <day>", -5.308267697401205),
                                    ("yesterday<time-of-day> am|pm", -6.22455842927536),
                                    ("<day-of-month> (ordinal)July", -5.531411248715415),
                                    ("Tuesday<duration> hence|ago", -6.22455842927536),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.22455842927536),
                                    ("mm/ddyear (latent)", -6.22455842927536),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.22455842927536),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.22455842927536),
                                    ("Tuesdaythis|last|next <cycle>", -6.22455842927536),
                                    ("at <time-of-day>intersect", -5.308267697401205),
                                    ("hh:mmyear (latent)", -4.838264068155469),
                                    ("Holiyear (latent)", -6.22455842927536),
                                    ("until <time><time-of-day> am|pm", -6.22455842927536),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.819093321167196),
                                    ("dayminute", -3.334186671379195),
                                    ("yyyy-mm-ddhh:mm", -5.819093321167196),
                                    ("intersectfrom|since|after <time>", -5.819093321167196),
                                    ("intersectSeptember", -4.352756252373768),
                                    ("minuteday", -3.0675580081252467),
                                    ("absorption of , after named dayintersect", -6.22455842927536),
                                    ("intersectyear (latent)", -6.22455842927536),
                                    ("Februaryin|during the <part-of-day>", -6.22455842927536),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.22455842927536),
                                    ("time-of-day (latent)July", -5.531411248715415),
                                    ("Saturdayyear (latent)", -6.22455842927536),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.22455842927536),
                                    ("<day-of-month> (ordinal)Monday", -5.308267697401205),
                                    ("at <time-of-day>on <day>", -5.308267697401205),
                                    ("absorption of , after named daySeptember",
                                     -4.971795460779992),
                                    ("Naraka Chaturdashiyear (latent)", -6.22455842927536),
                                    ("from|since|after <time>on <day>", -5.308267697401205),
                                    ("dayweek", -6.22455842927536),
                                    ("Easter Sundayyear (latent)", -5.819093321167196),
                                    ("Thursday<time-of-day> am|pm", -4.971795460779992),
                                    ("weekyear", -5.819093321167196),
                                    ("time-of-day (latent)Thursday", -5.819093321167196),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.22455842927536),
                                    ("<day-of-month> (ordinal)April", -6.22455842927536),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.819093321167196),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.531411248715415),
                                    ("Sundayfrom|since|after <time>", -6.22455842927536),
                                    ("absorption of , after named dayFebruary", -5.308267697401205),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.819093321167196),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.22455842927536),
                                    ("tomorrowat <time-of-day>", -6.22455842927536),
                                    ("daynograin", -5.819093321167196),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.819093321167196),
                                    ("last <cycle> of <time>year (latent)", -5.819093321167196),
                                    ("tomorrow<time-of-day> am|pm", -6.22455842927536),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.531411248715415),
                                    ("Diwaliyear (latent)", -5.819093321167196),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.22455842927536),
                                    ("this <part-of-day>at <time-of-day>", -5.308267697401205),
                                    ("Fridayyear (latent)", -5.308267697401205),
                                    ("Tuesdayin|within|after <duration>", -6.22455842927536),
                                    ("time-of-day (latent)April", -6.22455842927536),
                                    ("minuteyear", -4.02733385193914)],
                               n = 338}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.42361442661384163,
                               unseen = -5.272999558563747,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.2788741124990537),
                                    ("month (grain)", -2.559807957961118),
                                    ("year (grain)", -2.223335721339905),
                                    ("week (grain)", -1.2788741124990537),
                                    ("quarter", -3.6584202466292277), ("year", -2.223335721339905),
                                    ("month", -2.559807957961118),
                                    ("quarter (grain)", -3.6584202466292277)],
                               n = 91},
                   koData =
                     ClassData{prior = -1.0632729222228008,
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.7088955375280844, unseen = -4.859812404361672,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 126},
                   koData =
                     ClassData{prior = -0.6776429940239801, unseen = -4.890349128221754,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.5901992113075029,
                               ...
                               n = 92},
                   koData =
                     ClassData{prior = -0.8079226951523735, unseen = -5.159055299214529,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -3.543853682063679),
                                    ("integer (0..19)year (grain)", -4.054679305829669),
                                    ("integer (numeric)day (grain)", -4.054679305829669),
                                    ("integer (numeric)quarter (grain)", -4.054679305829669),
                                    ("integer (numeric)year (grain)", -4.054679305829669),
                                    ("day", -3.543853682063679), ("quarter", -3.543853682063679),
                                    ("year", -3.543853682063679),
                                    ("integer (numeric)week (grain)", -4.054679305829669),
                                    ("integer (0..19)month (grain)", -4.054679305829669),
                                    ("hour", -1.145958409265308), ("month", -3.543853682063679),
                                    ("integer (numeric)month (grain)", -4.054679305829669),
                                    ("integer (numeric)hour (grain)", -1.145958409265308),
                                    ("integer (0..19)day (grain)", -4.054679305829669),
                                    ("integer (0..19)week (grain)", -4.054679305829669),
                                    ("integer (0..19)quarter (grain)", -4.054679305829669)],
                               n = 74}}),
