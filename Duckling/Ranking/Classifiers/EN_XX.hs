...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6655320135269719, unseen = -5.556828061699537,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 257},
                   koData =
                     ClassData{prior = -0.7215466550816433,
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -1.9661128563728327,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("quarter", -2.367123614131617), ("year", -1.8562979903656263),
                                    ("<integer> <unit-of-duration>", -1.8562979903656263),
                                    ("a <unit-of-duration>", -2.0794415416798357),
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4819427496172046,
                               unseen = -6.6240652277998935,
                               likelihoods =
                                 HashMap.fromList
                                   [("Ramadanyear (latent)", -5.929589143389895),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.676826174894527),
                                    ("Bhai Doojyear (latent)", -5.929589143389895),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.676826174894527),
                                    ("hourday", -4.224841051151469),
                                    ("dayhour", -3.0118184113056152),
                                    ("Martin Luther King's Dayyear (latent)", -5.52412403528173),
                                    ("Shemini Atzeretyear (latent)", -5.929589143389895),
                                    ("daymonth", -5.236441962829949),
                                    ("monthday", -5.52412403528173),
                                    ("monthyear", -4.320151230955794),
                                    ("Yom Ha'atzmautyear (latent)", -5.929589143389895),
                                    ("Thanksgiving Dayyear (latent)", -4.830976854721785),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.929589143389895),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.929589143389895),
                                    ("houryear", -5.236441962829949),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.929589143389895),
                                    ("Christmas<time-of-day> am|pm", -5.929589143389895),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.929589143389895),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.236441962829949),
                                    ("<time-of-day> am|pmintersect", -4.676826174894527),
                                    ("Octoberyear (latent)", -4.676826174894527),
                                    ("intersect<time-of-day> am|pm", -5.929589143389895),
                                    ("Shavuotyear (latent)", -5.929589143389895),
                                    ("Dhanterasin <named-month>|year", -5.929589143389895),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.929589143389895),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.929589143389895),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.52412403528173),
                                    ("Marchyear (latent)", -5.929589143389895),
                                    ("Sukkotyear (latent)", -5.52412403528173),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.929589143389895),
                                    ("Clean Mondayyear (latent)", -5.52412403528173),
                                    ("monthhour", -5.52412403528173),
                                    ("todayat <time-of-day>", -5.929589143389895),
                                    ("Thursday<time> timezone", -4.224841051151469),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.929589143389895),
                                    ("Palm SundaySunday", -5.52412403528173),
                                    ("dayday", -3.732364566053675),
                                    ("<time> <part-of-day>at <time-of-day>", -5.929589143389895),
                                    ("mm/ddat <time-of-day>", -5.929589143389895),
                                    ("tonightat <time-of-day>", -5.929589143389895),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.236441962829949),
                                    ("today<time-of-day> am|pm", -5.929589143389895),
                                    ("Februarythe <day-of-month> (ordinal)", -5.52412403528173),
                                    ("at <time-of-day><time> <part-of-day>", -5.929589143389895),
                                    ("mm/dd<time-of-day> am|pm", -5.929589143389895),
                                    ("hourhour", -4.676826174894527),
                                    ("<time-of-day> am|pmon <date>", -3.9146861228476295),
                                    ("Wednesdaythis|last|next <cycle>", -5.929589143389895),
                                    ("Lentyear (latent)", -5.929589143389895),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.42551174661362),
                                    ("dayyear", -2.1800850674595234),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.929589143389895),
                                    ("Thursdayat <time-of-day>", -5.52412403528173),
                                    ("Islamic New Yearyear (latent)", -5.52412403528173),
                                    ("Laylat al-Qadryear (latent)", -5.0132984115157395),
                                    ("Chhathin <named-month>|year", -5.929589143389895),
                                    ("Diwaliin <named-month>|year", -5.929589143389895),
                                    ("Shrove Tuesdayyear (latent)", -5.929589143389895),
                                    ("<time-of-day> am|pmtomorrow", -5.236441962829949),
                                    ("Yom Kippuryear (latent)", -5.929589143389895),
                                    ("<part-of-day> of <time>year (latent)", -5.929589143389895),
                                    ("minutehour", -5.0132984115157395),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.52412403528173),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.224841051151469),
                                    ("for <duration> from <time>December", -5.929589143389895),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.929589143389895),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.0132984115157395),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.52412403528173),
                                    ("Pentecostyear (latent)", -5.929589143389895),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.0132984115157395),
                                    ("Eid al-Fitryear (latent)", -5.929589143389895),
                                    ("Mondayin|during the <part-of-day>", -5.929589143389895),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.52412403528173),
                                    ("Ashurayear (latent)", -5.929589143389895),
                                    ("Chinese New Yearyear (latent)", -5.929589143389895),
                                    ("Sundayyear (latent)", -5.929589143389895),
                                    ("Lag BaOmeryear (latent)", -5.929589143389895),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.929589143389895),
                                    ("Eid al-Adhayear (latent)", -5.0132984115157395),
                                    ("intersectin|during the <part-of-day>", -5.929589143389895),
                                    ("Christmasat <time-of-day>", -5.929589143389895),
                                    ("Passoveryear (latent)", -5.929589143389895),
                                    ("Lazarus Saturdayyear (latent)", -5.929589143389895),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.929589143389895),
                                    ("Yom HaShoahyear (latent)", -5.52412403528173),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.0132984115157395),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.929589143389895),
                                    ("Septemberyear (latent)", -5.52412403528173),
                                    ("mm/ddyear (latent)", -5.929589143389895),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.676826174894527),
                                    ("Halloweenyear (latent)", -5.929589143389895),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.236441962829949),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -5.0132984115157395),
                                    ("at <time-of-day>intersect", -5.52412403528173),
                                    ("Rosh Hashanahyear (latent)", -5.929589143389895),
                                    ("Dhanterasyear (latent)", -5.929589143389895),
                                    ("Tu BiShvatyear (latent)", -5.929589143389895),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.929589143389895),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.929589143389895),
                                    ("dayminute", -3.2905318137746358),
                                    ("Mawlidyear (latent)", -5.929589143389895),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.52412403528173),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.929589143389895),
                                    ("Jumu'atul-Widayear (latent)", -5.0132984115157395),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.929589143389895),
                                    ("minuteday", -2.292002983663509),
                                    ("absorption of , after named dayintersect",
                                     -5.929589143389895),
                                    ("intersectyear (latent)", -5.929589143389895),
                                    ("Orthodox Easter Sundayyear (latent)", -5.929589143389895),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.929589143389895),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.929589143389895),
                                    ("Boss's Dayyear (latent)", -5.52412403528173),
                                    ("Tisha B'Avyear (latent)", -5.929589143389895),
                                    ("Isra and Mi'rajyear (latent)", -5.0132984115157395),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.929589143389895),
                                    ("Christmasyear (latent)", -5.52412403528173),
                                    ("Naraka Chaturdashiyear (latent)", -5.52412403528173),
                                    ("at <time-of-day>on <date>", -4.830976854721785),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.320151230955794),
                                    ("dayweek", -5.929589143389895),
                                    ("Easter Sundayyear (latent)", -5.236441962829949),
                                    ("Thursday<time-of-day> am|pm", -5.929589143389895),
                                    ("weekyear", -5.52412403528173),
                                    ("hh:mmin|during the <part-of-day>", -5.236441962829949),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.52412403528173),
                                    ("Hanukkahyear (latent)", -5.929589143389895),
                                    ("February<time> <part-of-day>", -5.929589143389895),
                                    ("Tuesdayin <named-month>|year", -5.929589143389895),
                                    ("Great Lentyear (latent)", -5.929589143389895),
                                    ("tomorrowat <time-of-day>", -5.236441962829949),
                                    ("between <time> and <time>on <date>", -4.320151230955794),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.236441962829949),
                                    ("last <cycle> of <time>year (latent)", -5.236441962829949),
                                    ("at <time-of-day>tomorrow", -5.52412403528173),
                                    ("tomorrow<time-of-day> am|pm", -5.929589143389895),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.929589143389895),
                                    ("Diwaliyear (latent)", -5.929589143389895),
                                    ("Black Fridayyear (latent)", -5.52412403528173),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.929589143389895),
                                    ("Chhathyear (latent)", -5.52412403528173),
                                    ("Palm Sundayintersect", -5.929589143389895),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.929589143389895),
                                    ("Februaryintersect", -5.929589143389895),
                                    ("Simchat Torahyear (latent)", -5.929589143389895)],
                               n = 281},
                   koData =
                     ClassData{prior = -0.9612421197364215, unseen = -6.289715570908998,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.594711379601839),
                                    ("hourday", -5.594711379601839),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.594711379601839),
                                    ("dayhour", -3.152364344232635),
                                    ("daymonth", -3.5152698379220033),
                                    ("monthday", -5.1892462714936745),
                                    ("monthyear", -4.341948411106471),
                                    ("<time-of-day> am|pmyear (latent)", -5.1892462714936745),
                                    ("intersecthh:mm", -5.594711379601839),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.594711379601839),
                                    ("houryear", -4.678420647727684),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.594711379601839),
                                    ("until <time-of-day><time-of-day> am|pm", -5.594711379601839),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.901564199041894),
                                    ("<time-of-day> am|pmintersect", -4.341948411106471),
                                    ("Octoberyear (latent)", -5.594711379601839),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.341948411106471),
                                    ("from|since|after <time-of-day>on <date>", -4.678420647727684),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.594711379601839),
                                    ("absorption of , after named dayJuly", -5.1892462714936745),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.678420647727684),
                                    ("Clean Mondayyear (latent)", -5.594711379601839),
                                    ("monthhour", -5.594711379601839),
                                    ("hourmonth", -4.901564199041894),
                                    ("todayat <time-of-day>", -5.594711379601839),
                                    ("from|since|after <time-of-day>July", -5.594711379601839),
                                    ("Mondayyear (latent)", -4.901564199041894),
                                    ("dayday", -5.1892462714936745),
                                    ("mm/ddat <time-of-day>", -5.1892462714936745),
                                    ("<time-of-day> am|pmon <date>", -4.341948411106471),
                                    ("dayyear", -2.7325104986723705),
                                    ("Thursdaymm/dd", -5.594711379601839),
                                    ("New Year's Dayyear (latent)", -5.1892462714936745),
                                    ("Thursdayat <time-of-day>", -4.341948411106471),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.594711379601839),
                                    ("Aprilyear (latent)", -5.594711379601839),
                                    ("monthminute", -5.594711379601839),
                                    ("<time-of-day> am|pmtomorrow", -5.594711379601839),
                                    ("Thursdayhh:mm", -4.678420647727684),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.594711379601839),
                                    ("minutemonth", -3.802951910373784),
                                    ("Sundayfrom|since|after <time-of-day>", -5.594711379601839),
                                    ("week-endin <named-month>|year", -5.594711379601839),
                                    ("Augustyear (latent)", -5.1892462714936745),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.1892462714936745),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.1892462714936745),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.594711379601839),
                                    ("Sundayyear (latent)", -4.901564199041894),
                                    ("Christmasat <time-of-day>", -5.594711379601839),
                                    ("<duration> after|before|from <time>December",
                                     -5.594711379601839),
                                    ("yesterday<time-of-day> am|pm", -5.594711379601839),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.678420647727684),
                                    ("mm/ddyear (latent)", -5.594711379601839),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.1892462714936745),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.594711379601839),
                                    ("until <time-of-day>on <date>", -4.901564199041894),
                                    ("at <time-of-day>intersect", -5.1892462714936745),
                                    ("hh:mmyear (latent)", -4.496099090933729),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.594711379601839),
                                    ("dayminute", -3.1098047298138387),
                                    ("intersectSeptember", -4.090633982825565),
                                    ("minuteday", -2.526658444468222),
                                    ("absorption of , after named dayintersect",
                                     -5.594711379601839),
                                    ("Februaryin|during the <part-of-day>", -5.594711379601839),
                                    ("hh:mmon <date>", -3.5798083590595744),
                                    ("Saturdayyear (latent)", -5.594711379601839),
                                    ...
                                    ("on <date>September", -5.1892462714936745),
                                    ("at <time-of-day>on <date>", -5.1892462714936745),
                                    ("in <named-month>|yearyear (latent)", -5.594711379601839),
                                    ("dayweek", -5.594711379601839),
                                    ("Easter Sundayyear (latent)", -5.1892462714936745),
                                    ("Thursday<time-of-day> am|pm", -5.1892462714936745),
                                    ("absorption of , after named dayFebruary", -4.678420647727684),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.594711379601839),
                                    ("tomorrowat <time-of-day>", -5.594711379601839),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.594711379601839),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.9852734671677386),
                                    ("tomorrow<time-of-day> am|pm", -5.594711379601839),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.901564199041894),
                                    ("Diwaliyear (latent)", -5.1892462714936745),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.594711379601839),
                                    ("Fridayyear (latent)", -5.1892462714936745),
                                    ("minuteyear", -4.341948411106471)],
                               n = 174}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.2006706954621511,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -6.001800972625292e-2),
                                    ("intersect 2 numbers", -3.248434627109745)],
                               n = 99},
                   koData =
                     ClassData{prior = -1.7047480922384253, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.5483284762254965),
                                    ("integer (0..19)year (grain)", -3.2414756567854415),
                                    ("integer (numeric)day (grain)", -2.7894905330423847),
                                    ...
                                    ("integer (numeric)year (grain)", -3.107944264160919),
                                    ("day", -2.479335604738545), ("year", -2.5483284762254965),
                                    ("integer (numeric)week (grain)", -3.107944264160919),
                                    ("integer (0..19)month (grain)", -3.577947893406655),
                                    ("hour", -2.7024791560527546), ("month", -2.8848007128467095),
                                    ("integer (numeric)minute (grain)", -3.2414756567854415),
                                    ("integer (0..19)minute (grain)", -3.107944264160919),
                                    ("integer (numeric)month (grain)", -3.3956263366127),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -2.1400661634962708),
                                    ...
                                    ("Marcha <unit-of-duration>", -2.1400661634962708),
                                    ("March<integer> <unit-of-duration>", -2.1400661634962708),
                                    ("Thanksgiving Daya <unit-of-duration>", -2.1400661634962708),
                                    ("Thanksgiving Day<integer> <unit-of-duration>",
                                     -1.7346010553881064),
                                    ("dayyear", -1.7346010553881064)],
                               n = 5},
                   koData =
                     ClassData{prior = -infinity, unseen = -2.0794415416798357,
                               likelihoods = HashMap.fromList [], n = 0}}),
