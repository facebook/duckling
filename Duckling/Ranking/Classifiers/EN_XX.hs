...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6250580596993507, unseen = -5.983936280687191,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 395},
                   koData =
                     ClassData{prior = -0.7662133774345327, unseen = -5.84354441703136,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47290638890369696,
                               unseen = -7.0192966537150445,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.3252546185092555),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.3252546185092555),
                                    ("Ramadanyear (latent)", -5.4089638866351),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.31035159796699),
                                    ("Bhai Doojyear (latent)", -6.3252546185092555),
                                    ("hourday", -4.31035159796699), ("dayhour", -3.407483886424976),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.31035159796699),
                                    ("Martin Luther King's Dayyear (latent)", -5.919789510401091),
                                    ("Shemini Atzeretyear (latent)", -6.3252546185092555),
                                    ("daymonth", -4.185188455012985),
                                    ("monthday", -5.919789510401091),
                                    ("monthyear", -4.453452441607664),
                                    ("Yom Ha'atzmautyear (latent)", -6.3252546185092555),
                                    ("Vijayadashamiyear (latent)", -6.3252546185092555),
                                    ("Thanksgiving Dayyear (latent)", -5.2266423298411455),
                                    ("Thai Pongalyear (latent)", -5.63210743794931),
                                    ("Thiru Onamyear (latent)", -5.63210743794931),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.3252546185092555),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.4089638866351),
                                    ("<day-of-month> (ordinal)Wednesday", -6.3252546185092555),
                                    ("Krishna Janmashtamiyear (latent)", -5.919789510401091),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.3252546185092555),
                                    ("houryear", -5.4089638866351),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.3252546185092555),
                                    ("Christmas<time-of-day> am|pm", -6.3252546185092555),
                                    ("<day-of-month> (ordinal)October", -6.3252546185092555),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.3252546185092555),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.63210743794931),
                                    ("intersectin|during <named-month>|year", -6.3252546185092555),
                                    ("<time-of-day> am|pmintersect", -5.0724916500138875),
                                    ("Earth Houryear (latent)", -6.3252546185092555),
                                    ("Octoberyear (latent)", -4.715816706075155),
                                    ("intersect<time-of-day> am|pm", -6.3252546185092555),
                                    ("Mattu Pongalyear (latent)", -6.3252546185092555),
                                    ("Shavuotyear (latent)", -6.3252546185092555),
                                    ("Parsi New Yearyear (latent)", -5.4089638866351),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.3252546185092555),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.3252546185092555),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.919789510401091),
                                    ("Marchyear (latent)", -6.3252546185092555),
                                    ("Sukkotyear (latent)", -5.919789510401091),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.919789510401091),
                                    ("Clean Mondayyear (latent)", -5.919789510401091),
                                    ("monthhour", -5.919789510401091),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.63210743794931),
                                    ("todayat <time-of-day>", -6.3252546185092555),
                                    ("Thursday<time> timezone", -4.379344469453942),
                                    ("time-of-day (latent)tonight", -5.919789510401091),
                                    ("from|since|after <time>December", -6.3252546185092555),
                                    ("<time-of-day> am|pmon <day>", -4.31035159796699),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.3252546185092555),
                                    ("yyyy-mm-ddhh:mm:ss", -5.919789510401091),
                                    ("dayday", -3.882907583140051),
                                    ("<time> <part-of-day>at <time-of-day>", -6.3252546185092555),
                                    ("mm/ddat <time-of-day>", -6.3252546185092555),
                                    ("tonightat <time-of-day>", -6.3252546185092555),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.63210743794931),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.3252546185092555),
                                    ("today<time-of-day> am|pm", -6.3252546185092555),
                                    ("Februarythe <day-of-month> (ordinal)", -5.919789510401091),
                                    ("at <time-of-day><time> <part-of-day>", -6.3252546185092555),
                                    ("<day-of-month> (ordinal)intersect", -5.63210743794931),
                                    ("mm/dd<time-of-day> am|pm", -6.3252546185092555),
                                    ("hourhour", -4.245813076829419),
                                    ("Navaratriin|during <named-month>|year", -6.3252546185092555),
                                    ("Wednesdaythis|last|next <cycle>", -6.3252546185092555),
                                    ("Lentyear (latent)", -6.3252546185092555),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.821177221732981),
                                    ("Boghiyear (latent)", -6.3252546185092555),
                                    ("dayyear", -1.9004079866524457),
                                    ("Thursdayfrom|since|after <time>", -5.919789510401091),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.3252546185092555),
                                    ("Thursdayat <time-of-day>", -5.63210743794931),
                                    ("Islamic New Yearyear (latent)", -5.919789510401091),
                                    ("Laylat al-Qadryear (latent)", -5.4089638866351),
                                    ("Shrove Tuesdayyear (latent)", -6.3252546185092555),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.63210743794931),
                                    ("<time-of-day> am|pmtomorrow", -5.63210743794931),
                                    ("Yom Kippuryear (latent)", -6.3252546185092555),
                                    ("<day-of-month> (ordinal)Tuesday", -5.919789510401091),
                                    ("<part-of-day> of <time>year (latent)", -6.3252546185092555),
                                    ("minutehour", -5.2266423298411455),
                                    ("Kaanum Pongalyear (latent)", -5.919789510401091),
                                    ("Maha Saptamiyear (latent)", -6.3252546185092555),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.919789510401091),
                                    ("time-of-day (latent)tomorrow", -5.4089638866351),
                                    ("part of daysat <time-of-day>", -5.919789510401091),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.62050652627083),
                                    ("for <duration> from <time>December", -6.3252546185092555),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.3252546185092555),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.0724916500138875),
                                    ("time-of-day (latent)this <part-of-day>", -6.3252546185092555),
                                    ("Pentecostyear (latent)", -6.3252546185092555),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.0724916500138875),
                                    ("<day-of-month> (ordinal)February", -6.3252546185092555),
                                    ("Eid al-Fitryear (latent)", -5.4089638866351),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.3252546185092555),
                                    ("Mondayin|during the <part-of-day>", -6.3252546185092555),
                                    ("Chhathin|during <named-month>|year", -6.3252546185092555),
                                    ("Diwaliin|during <named-month>|year", -6.3252546185092555),
                                    ("Vaisakhiin|during <named-month>|year", -6.3252546185092555),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.0724916500138875),
                                    ("Raksha Bandhanyear (latent)", -6.3252546185092555),
                                    ("daysecond", -5.919789510401091),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.919789510401091),
                                    ("Ashurayear (latent)", -6.3252546185092555),
                                    ("Tuesdayin|during <named-month>|year", -6.3252546185092555),
                                    ("Chinese New Yearyear (latent)", -6.3252546185092555),
                                    ("tomorrowintersect", -6.3252546185092555),
                                    ("Lag BaOmeryear (latent)", -6.3252546185092555),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.3252546185092555),
                                    ("Eid al-Adhayear (latent)", -4.185188455012985),
                                    ("intersectin|during the <part-of-day>", -6.3252546185092555),
                                    ("Palm Sundayyear (latent)", -6.3252546185092555),
                                    ("Christmasat <time-of-day>", -6.3252546185092555),
                                    ("Passoveryear (latent)", -6.3252546185092555),
                                    ("Lazarus Saturdayyear (latent)", -6.3252546185092555),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.919789510401091),
                                    ("Yom HaShoahyear (latent)", -5.919789510401091),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.919789510401091),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.3252546185092555),
                                    ("Septemberyear (latent)", -5.919789510401091),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.821177221732981),
                                    ("Halloweenyear (latent)", -6.3252546185092555),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.3252546185092555),
                                    ("at <time-of-day>intersect", -5.919789510401091),
                                    ("Rosh Hashanahyear (latent)", -5.63210743794931),
                                    ("Dhanterasyear (latent)", -6.3252546185092555),
                                    ("Tu BiShvatyear (latent)", -6.3252546185092555),
                                    ("<day-of-month> (ordinal)December", -5.63210743794931),
                                    ("Holiyear (latent)", -5.63210743794931),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.3252546185092555),
                                    ("Holika Dahanyear (latent)", -5.63210743794931),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.3252546185092555),
                                    ("dayminute", -3.407483886424976),
                                    ("Mawlidyear (latent)", -6.3252546185092555),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.919789510401091),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.3252546185092555),
                                    ("Jumu'atul-Widayear (latent)", -5.4089638866351),
                                    ("minuteday", -2.4966132220201604),
                                    ("absorption of , after named dayintersect",
                                     -6.3252546185092555),
                                    ("intersectyear (latent)", -5.919789510401091),
                                    ("Orthodox Easter Sundayyear (latent)", -6.3252546185092555),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.3252546185092555),
                                    ("Boss's Dayyear (latent)", -5.919789510401091),
                                    ("Global Youth Service Dayyear (latent)", -6.3252546185092555),
                                    ("Dhanterasin|during <named-month>|year", -6.3252546185092555),
                                    ("Tisha B'Avyear (latent)", -6.3252546185092555),
                                    ("Isra and Mi'rajyear (latent)", -5.4089638866351),
                                    ("at <time-of-day>on <day>", -5.2266423298411455),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.3252546185092555),
                                    ("time-of-day (latent)<time> <part-of-day>", -5.63210743794931),
                                    ("Christmasyear (latent)", -5.919789510401091),
                                    ("Naraka Chaturdashiyear (latent)", -5.919789510401091),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.3252546185092555),
                                    ("dayweek", -6.3252546185092555),
                                    ("Easter Sundayyear (latent)", -5.63210743794931),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.715816706075155),
                                    ("weekyear", -5.2266423298411455),
                                    ("King's Dayyear (latent)", -4.821177221732981),
                                    ("hh:mmin|during the <part-of-day>", -5.63210743794931),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.919789510401091),
                                    ("Hanukkahyear (latent)", -5.63210743794931),
                                    ("February<time> <part-of-day>", -6.3252546185092555),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.3252546185092555),
                                    ("Great Lentyear (latent)", -6.3252546185092555),
                                    ("tomorrowat <time-of-day>", -5.63210743794931),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.3252546185092555),
                                    ("Vaisakhiyear (latent)", -5.63210743794931),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.3252546185092555),
                                    ("last <cycle> of <time>year (latent)", -5.63210743794931),
                                    ("at <time-of-day>tomorrow", -5.919789510401091),
                                    ("tomorrow<time-of-day> am|pm", -6.3252546185092555),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.3252546185092555),
                                    ("Diwaliyear (latent)", -6.3252546185092555),
                                    ("between <time> and <time>on <day>", -4.715816706075155),
                                    ("Black Fridayyear (latent)", -5.919789510401091),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.3252546185092555),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.3252546185092555),
                                    ("Chhathyear (latent)", -5.919789510401091),
                                    ("Vasant Panchamiyear (latent)", -6.3252546185092555),
                                    ("Rabindra Jayantiyear (latent)", -5.0724916500138875),
                                    ("St Patrick's Dayyear (latent)", -6.3252546185092555),
                                    ("Thursday<time> (timezone)", -6.3252546185092555),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.3252546185092555),
                                    ("<datetime> - <datetime> (interval)July", -5.919789510401091),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.919789510401091),
                                    ("Februaryintersect", -6.3252546185092555),
                                    ("Simchat Torahyear (latent)", -6.3252546185092555),
                                    ("minuteyear", -6.3252546185092555)],
                               n = 430},
                   koData =
                     ClassData{prior = -0.9760099665757773, unseen = -6.656726524178391,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.254242968705492),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.962293169807702),
                                    ("<day-of-month> (ordinal)August", -5.962293169807702),
                                    ("dayhour", -3.288144520381173),
                                    ("<time> timezoneyear (latent)", -5.962293169807702),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.046002437933547),
                                    ("Tuesdayfrom|since|after <time>", -5.962293169807702),
                                    ("daymonth", -3.4773865200197016),
                                    ("monthyear", -4.709530201312334),
                                    ("<time-of-day> am|pmyear (latent)", -5.269145989247757),
                                    ("Thai Pongalyear (latent)", -5.269145989247757),
                                    ("intersecthh:mm", -5.962293169807702),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.556828061699537),
                                    ("<day-of-month> (ordinal)Wednesday", -5.962293169807702),
                                    ("houryear", -4.575998808687811),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.962293169807702),
                                    ("<day-of-month> (ordinal)October", -5.962293169807702),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.269145989247757),
                                    ("<time-of-day> am|pmintersect", -4.709530201312334),
                                    ("Octoberyear (latent)", -5.962293169807702),
                                    ("until <time>on <day>", -5.269145989247757),
                                    ("time-of-day (latent)intersect", -5.962293169807702),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.269145989247757),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.962293169807702),
                                    ("hh:mmon <day>", -3.5199461344384977),
                                    ("absorption of , after named dayJuly", -5.556828061699537),
                                    ("from|since|after <time>July", -5.556828061699537),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.046002437933547),
                                    ("Clean Mondayyear (latent)", -5.962293169807702),
                                    ("monthhour", -5.962293169807702),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.556828061699537),
                                    ("hourmonth", -4.090490992906111),
                                    ("todayat <time-of-day>", -5.962293169807702),
                                    ("from|since|after <time>December", -5.962293169807702),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.962293169807702),
                                    ("<time-of-day> am|pmon <day>", -4.709530201312334),
                                    ("Mondayyear (latent)", -5.269145989247757),
                                    ("dayday", -4.575998808687811),
                                    ("mm/ddat <time-of-day>", -5.556828061699537),
                                    ("on <day>September", -5.556828061699537),
                                    ("time-of-day (latent)September", -5.556828061699537),
                                    ("hourhour", -5.962293169807702),
                                    ("time-of-day (latent)on <day>", -3.5199461344384977),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.556828061699537),
                                    ("dayyear", -3.0178541906412617),
                                    ("Thursdaymm/dd", -5.962293169807702),
                                    ("New Year's Dayyear (latent)", -5.046002437933547),
                                    ("Thursdayfrom|since|after <time>", -4.257545077569277),
                                    ("Thursdayat <time-of-day>", -4.3528552573736015),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.962293169807702),
                                    ("Aprilyear (latent)", -5.962293169807702),
                                    ("the <day-of-month> (ordinal)July", -5.962293169807702),
                                    ("the <day-of-month> (number)July", -5.962293169807702),
                                    ("monthminute", -5.962293169807702),
                                    ("<time-of-day> am|pmtomorrow", -5.962293169807702),
                                    ("Thursdayhh:mm", -5.046002437933547),
                                    ("<day-of-month> (ordinal)Tuesday", -5.556828061699537),
                                    ("minutemonth", -4.090490992906111),
                                    ("minutehour", -5.962293169807702),
                                    ("Augustyear (latent)", -5.556828061699537),
                                    ("week-endin|during <named-month>|year", -5.962293169807702),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.556828061699537),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.962293169807702),
                                    ("Sundayyear (latent)", -5.046002437933547),
                                    ("Christmasat <time-of-day>", -5.962293169807702),
                                    ("from|since|after <time>year (latent)", -4.863680881139593),
                                    ("<duration> after|before|from <time>December",
                                     -5.962293169807702),
                                    ("yesterday<time-of-day> am|pm", -5.962293169807702),
                                    ("<day-of-month> (ordinal)July", -5.269145989247757),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.962293169807702),
                                    ("mm/ddyear (latent)", -5.962293169807702),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.962293169807702),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.962293169807702),
                                    ("at <time-of-day>intersect", -5.556828061699537),
                                    ("hh:mmyear (latent)", -3.882851628127866),
                                    ("Holiyear (latent)", -5.962293169807702),
                                    ("until <time><time-of-day> am|pm", -5.962293169807702),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.962293169807702),
                                    ("dayminute", -3.3973438123461652),
                                    ("yyyy-mm-ddhh:mm", -5.556828061699537),
                                    ("intersectSeptember", -4.458215773031428),
                                    ("minuteday", -2.7236147176433216),
                                    ("absorption of , after named dayintersect",
                                     -5.962293169807702),
                                    ("intersectyear (latent)", -5.962293169807702),
                                    ("Februaryin|during the <part-of-day>", -5.962293169807702),
                                    ("time-of-day (latent)July", -5.269145989247757),
                                    ("Saturdayyear (latent)", -5.962293169807702),
                                    ("at <time-of-day>on <day>", -5.556828061699537),
                                    ("absorption of , after named daySeptember",
                                     -5.046002437933547),
                                    ("Naraka Chaturdashiyear (latent)", -5.962293169807702),
                                    ("from|since|after <time>on <day>", -5.046002437933547),
                                    ("dayweek", -5.962293169807702),
                                    ("Easter Sundayyear (latent)", -5.556828061699537),
                                    ("Thursday<time-of-day> am|pm", -4.709530201312334),
                                    ("weekyear", -5.556828061699537),
                                    ("time-of-day (latent)Thursday", -5.556828061699537),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.962293169807702),
                                    ("<day-of-month> (ordinal)April", -5.962293169807702),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.556828061699537),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.269145989247757),
                                    ("Sundayfrom|since|after <time>", -5.962293169807702),
                                    ("absorption of , after named dayFebruary", -5.046002437933547),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.962293169807702),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.962293169807702),
                                    ("tomorrowat <time-of-day>", -5.962293169807702),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.556828061699537),
                                    ("last <cycle> of <time>year (latent)", -5.556828061699537),
                                    ("tomorrow<time-of-day> am|pm", -5.962293169807702),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.269145989247757),
                                    ("Diwaliyear (latent)", -5.556828061699537),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.962293169807702),
                                    ("Fridayyear (latent)", -5.556828061699537),
                                    ("time-of-day (latent)April", -5.962293169807702),
                                    ("minuteyear", -3.765068592471483)],
                               n = 260}}),
       ("one eleven",
        Classifier{okData =
