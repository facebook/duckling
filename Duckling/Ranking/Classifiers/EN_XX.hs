  ...
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("from|since|after <time>",
        Classifier{okData =
                     ClassData{prior = -1.6218604324326575, unseen = -4.174387269895637,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 16},
                   koData =
                     ClassData{prior = -0.22006188477680164,
                               unseen = -5.093750200806762,
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -3.9889840465642745),
                                    ("week", -4.394449154672439),
                                    ("<day-of-month> (ordinal or number) <named-month>",
                                     -4.394449154672439),
                                    ("today", -4.394449154672439),
                                    ("intersect", -2.5226469777708473),
                                    ("second", -4.394449154672439), ("now", -3.4781584227982836),
                                    ("tomorrow", -3.9889840465642745),
                                    ("this|last|next <cycle>", -4.394449154672439),
                                    ("day", -1.9521021193032344),
                                    ("time-of-day (latent)", -2.6897010624340134),
                                    ("<time-of-day> am|pm", -3.9889840465642745),
                                    ("nograin", -3.4781584227982836),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)",
                                     -4.394449154672439),
                                    ("<day-of-month> (ordinal)", -3.9889840465642745),
                                    ("Easter Sunday", -4.394449154672439),
                                    ("Christmas", -3.7013019741124937),
                                    ("hour", -2.4485390056171257), ("month", -4.394449154672439),
                                    ("<datetime> - <datetime> (interval)", -3.1416861861770706),
                                    ("<time-of-day> - <time-of-day> (interval)",
                                     -2.890371757896165),
                                    ("<named-month> <day-of-month> (non ordinal)",
                                     -3.9889840465642745),
                                    ("minute", -1.9095425048844386),
                                    ("right now", -4.394449154672439),
                                    ("<month> dd-dd (interval)", -3.7013019741124937),
                                    ("part of days", -4.394449154672439),
                                    ("dd-dd <month> (interval)", -3.9889840465642745)],
                               n = 65}}),
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4784902431230543, unseen = -6.720220155135295,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.025865973825314),
                                    ("Ramadanyear (latent)", -6.025865973825314),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.773103005329946),
                                    ("Bhai Doojyear (latent)", -6.025865973825314),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.773103005329946),
                                    ("hourday", -4.321117881586889),
                                    ("dayhour", -3.2225055929187794),
                                    ("Martin Luther King's Dayyear (latent)", -5.62040086571715),
                                    ("Shemini Atzeretyear (latent)", -6.025865973825314),
                                    ("daymonth", -5.332718793265369),
                                    ("monthday", -5.62040086571715),
                                    ("monthyear", -4.23410650459726),
                                    ("Yom Ha'atzmautyear (latent)", -6.025865973825314),
                                    ("Vijayadashamiyear (latent)", -6.025865973825314),
                                    ("Thanksgiving Dayyear (latent)", -4.927253685157205),
                                    ("Thai Pongalyear (latent)", -5.332718793265369),
                                    ("Thiru Onamyear (latent)", -5.332718793265369),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.025865973825314),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.025865973825314),
                                    ("houryear", -5.332718793265369),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.025865973825314),
                                    ("Christmas<time-of-day> am|pm", -6.025865973825314),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.025865973825314),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.332718793265369),
                                    ("<time-of-day> am|pmintersect", -4.773103005329946),
                                    ("Earth Houryear (latent)", -6.025865973825314),
                                    ("Octoberyear (latent)", -4.5217885770490405),
                                    ("intersect<time-of-day> am|pm", -6.025865973825314),
                                    ("Mattu Pongalyear (latent)", -6.025865973825314),
                                    ("Shavuotyear (latent)", -6.025865973825314),
                                    ("Dhanterasin <named-month>|year", -6.025865973825314),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.025865973825314),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.025865973825314),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.62040086571715),
                                    ("Marchyear (latent)", -6.025865973825314),
                                    ("Sukkotyear (latent)", -5.62040086571715),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.025865973825314),
                                    ("Clean Mondayyear (latent)", -5.62040086571715),
                                    ("monthhour", -5.62040086571715),
                                    ("todayat <time-of-day>", -6.025865973825314),
                                    ("Thursday<time> timezone", -4.321117881586889),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.025865973825314),
                                    ("Palm SundaySunday", -5.62040086571715),
                                    ("dayday", -3.828641396489095),
                                    ("<time> <part-of-day>at <time-of-day>", -6.025865973825314),
                                    ("mm/ddat <time-of-day>", -6.025865973825314),
                                    ("tonightat <time-of-day>", -6.025865973825314),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.332718793265369),
                                    ("today<time-of-day> am|pm", -6.025865973825314),
                                    ("Februarythe <day-of-month> (ordinal)", -5.62040086571715),
                                    ("at <time-of-day><time> <part-of-day>", -6.025865973825314),
                                    ("mm/dd<time-of-day> am|pm", -6.025865973825314),
                                    ("hourhour", -4.773103005329946),
                                    ("<time-of-day> am|pmon <date>", -4.01096295328305),
                                    ("Wednesdaythis|last|next <cycle>", -6.025865973825314),
                                    ("Lentyear (latent)", -6.025865973825314),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.5217885770490405),
                                    ("Boghiyear (latent)", -6.025865973825314),
                                    ("dayyear", -2.0185327885928435),
                                    ("Thursdayfrom|since|after <time>", -5.62040086571715),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.025865973825314),
                                    ("Thursdayat <time-of-day>", -5.62040086571715),
                                    ("Islamic New Yearyear (latent)", -5.62040086571715),
                                    ("Laylat al-Qadryear (latent)", -5.109575241951159),
                                    ("Chhathin <named-month>|year", -6.025865973825314),
                                    ("Vasant Panchamiin <named-month>|year", -6.025865973825314),
                                    ("Diwaliin <named-month>|year", -6.025865973825314),
                                    ("Shrove Tuesdayyear (latent)", -6.025865973825314),
                                    ("<time-of-day> am|pmtomorrow", -5.332718793265369),
                                    ("Yom Kippuryear (latent)", -6.025865973825314),
                                    ("<part-of-day> of <time>year (latent)", -6.025865973825314),
                                    ("minutehour", -5.109575241951159),
                                    ("Kaanum Pongalyear (latent)", -5.62040086571715),
                                    ("Maha Saptamiyear (latent)", -6.025865973825314),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.62040086571715),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.321117881586889),
                                    ("for <duration> from <time>December", -6.025865973825314),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.025865973825314),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.109575241951159),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.62040086571715),
                                    ("Pentecostyear (latent)", -6.025865973825314),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.109575241951159),
                                    ("Eid al-Fitryear (latent)", -6.025865973825314),
                                    ("Mondayin|during the <part-of-day>", -6.025865973825314),
                                    ("Raksha Bandhanyear (latent)", -6.025865973825314),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.62040086571715),
                                    ("Navaratriin <named-month>|year", -6.025865973825314),
                                    ("Ashurayear (latent)", -6.025865973825314),
                                    ("Chinese New Yearyear (latent)", -6.025865973825314),
                                    ("Sundayyear (latent)", -6.025865973825314),
                                    ("Lag BaOmeryear (latent)", -6.025865973825314),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.025865973825314),
                                    ("Eid al-Adhayear (latent)", -5.109575241951159),
                                    ("intersectin|during the <part-of-day>", -6.025865973825314),
                                    ("Christmasat <time-of-day>", -6.025865973825314),
                                    ("Passoveryear (latent)", -6.025865973825314),
                                    ("Lazarus Saturdayyear (latent)", -6.025865973825314),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.025865973825314),
                                    ("Yom HaShoahyear (latent)", -5.62040086571715),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.62040086571715),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.025865973825314),
                                    ("Thai Pongalin <named-month>|year", -6.025865973825314),
                                    ("Septemberyear (latent)", -5.62040086571715),
                                    ("mm/ddyear (latent)", -6.025865973825314),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.773103005329946),
                                    ("Halloweenyear (latent)", -6.025865973825314),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -5.109575241951159),
                                    ("at <time-of-day>intersect", -5.62040086571715),
                                    ("Rosh Hashanahyear (latent)", -6.025865973825314),
                                    ("Dhanterasyear (latent)", -6.025865973825314),
                                    ("Tu BiShvatyear (latent)", -6.025865973825314),
                                    ("Holiyear (latent)", -5.332718793265369),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.025865973825314),
                                    ("Holika Dahanyear (latent)", -5.332718793265369),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.025865973825314),
                                    ("dayminute", -3.386808644210056),
                                    ("Mawlidyear (latent)", -6.025865973825314),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.62040086571715),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.025865973825314),
                                    ("Jumu'atul-Widayear (latent)", -5.109575241951159),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.025865973825314),
                                    ("minuteday", -2.3882798140989285),
                                    ("absorption of , after named dayintersect",
                                     -6.025865973825314),
                                    ("intersectyear (latent)", -6.025865973825314),
                                    ("Orthodox Easter Sundayyear (latent)", -6.025865973825314),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.025865973825314),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.025865973825314),
                                    ("Boss's Dayyear (latent)", -5.62040086571715),
                                    ("Global Youth Service Dayyear (latent)", -6.025865973825314),
                                    ("Tisha B'Avyear (latent)", -6.025865973825314),
                                    ("Isra and Mi'rajyear (latent)", -5.109575241951159),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.025865973825314),
                                    ("Christmasyear (latent)", -5.62040086571715),
                                    ("Naraka Chaturdashiyear (latent)", -5.62040086571715),
                                    ("at <time-of-day>on <date>", -4.927253685157205),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.416428061391214),
                                    ("dayweek", -6.025865973825314),
                                    ("Easter Sundayyear (latent)", -5.332718793265369),
                                    ("weekyear", -4.927253685157205),
                                    ("hh:mmin|during the <part-of-day>", -5.332718793265369),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.62040086571715),
                                    ("Hanukkahyear (latent)", -6.025865973825314),
                                    ("February<time> <part-of-day>", -6.025865973825314),
                                    ("Tuesdayin <named-month>|year", -6.025865973825314),
                                    ("Great Lentyear (latent)", -6.025865973825314),
                                    ("tomorrowat <time-of-day>", -5.332718793265369),
                                    ("between <time> and <time>on <date>", -4.416428061391214),
                                    ("last <cycle> of <time>year (latent)", -5.332718793265369),
                                    ("at <time-of-day>tomorrow", -5.62040086571715),
                                    ("tomorrow<time-of-day> am|pm", -6.025865973825314),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.025865973825314),
                                    ("Diwaliyear (latent)", -6.025865973825314),
                                    ("Black Fridayyear (latent)", -5.62040086571715),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.025865973825314),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.025865973825314),
                                    ("Chhathyear (latent)", -5.62040086571715),
                                    ("Vasant Panchamiyear (latent)", -6.025865973825314),
                                    ("Palm Sundayintersect", -6.025865973825314),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.025865973825314),
                                    ("Februaryintersect", -6.025865973825314),
                                    ("Simchat Torahyear (latent)", -6.025865973825314),
                                    ("minuteyear", -6.025865973825314)],
                               n = 308},
                   koData =
                     ClassData{prior = -0.9668430110369863,
                               unseen = -6.3818160174060985,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.770684624465665),
                                    ("hourday", -4.770684624465665),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.68697535633982),
                                    ("dayhour", -3.122025998878283),
                                    ("Tuesdayfrom|since|after <time>", -5.68697535633982),
                                    ("daymonth", -3.546909192843549),
                                    ("monthday", -5.281510248231656),
                                    ("monthyear", -4.434212387844452),
                                    ("<time-of-day> am|pmyear (latent)", -5.281510248231656),
                                    ("Thai Pongalyear (latent)", -4.993828175779875),
                                    ("intersecthh:mm", -5.68697535633982),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.68697535633982),
                                    ("houryear", -4.770684624465665),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.68697535633982),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.993828175779875),
                                    ("<time-of-day> am|pmintersect", -4.434212387844452),
                                    ("until <time>on <date>", -4.993828175779875),
                                    ("Octoberyear (latent)", -5.68697535633982),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.68697535633982),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -4.434212387844452),
                                    ("about|exactly <time-of-day>year (latent)", -5.68697535633982),
                                    ("absorption of , after named dayJuly", -5.281510248231656),
                                    ("from|since|after <time>July", -5.68697535633982),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.770684624465665),
                                    ("Clean Mondayyear (latent)", -5.68697535633982),
                                    ("monthhour", -5.68697535633982),
                                    ("hourmonth", -4.770684624465665),
                                    ("todayat <time-of-day>", -5.68697535633982),
                                    ("from|since|after <time>December", -5.68697535633982),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.68697535633982),
                                    ("Mondayyear (latent)", -4.993828175779875),
                                    ("dayday", -5.281510248231656),
                                    ("mm/ddat <time-of-day>", -5.281510248231656),
                                    ("<time-of-day> am|pmon <date>", -4.434212387844452),
                                    ("dayyear", -2.716560890770119),
                                    ("Thursdaymm/dd", -5.68697535633982),
                                    ("New Year's Dayyear (latent)", -5.281510248231656),
                                    ("Thursdayfrom|since|after <time>", -3.9822272641013945),
                                    ("Thursdayat <time-of-day>", -4.434212387844452),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.68697535633982),
                                    ("Aprilyear (latent)", -5.68697535633982),
                                    ("monthminute", -5.68697535633982),
                                    ("<time-of-day> am|pmtomorrow", -5.68697535633982),
                                    ("Thursdayhh:mm", -4.770684624465665),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.68697535633982),
                                    ("minutemonth", -3.895215887111765),
                                    ("week-endin <named-month>|year", -5.68697535633982),
                                    ("Augustyear (latent)", -5.281510248231656),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.281510248231656),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.281510248231656),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.68697535633982),
                                    ("Sundayyear (latent)", -4.993828175779875),
                                    ("Christmasat <time-of-day>", -5.68697535633982),
                                    ("from|since|after <time>year (latent)", -4.434212387844452),
                                    ("<duration> after|before|from <time>December",
                                     -5.68697535633982),
                                    ("yesterday<time-of-day> am|pm", -5.68697535633982),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.770684624465665),
                                    ("mm/ddyear (latent)", -5.68697535633982),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.993828175779875),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.68697535633982),
                                    ("at <time-of-day>intersect", -5.281510248231656),
                                    ("hh:mmyear (latent)", -4.58836306767171),
                                    ("Holiyear (latent)", -5.68697535633982),
                                    ("until <time><time-of-day> am|pm", -5.68697535633982),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.68697535633982),
                                    ("dayminute", -3.1612467120315646),
                                    ("intersectSeptember", -4.182897959563546),
                                    ("minuteday", -2.6189224212062028),
                                    ("absorption of , after named dayintersect", -5.68697535633982),
                                    ("Februaryin|during the <part-of-day>", -5.68697535633982),
                                    ("hh:mmon <date>", -3.672072335797555),
                                    ("Saturdayyear (latent)", -5.68697535633982),
                                    ("from|since|after <time>on <date>", -4.770684624465665),
                                    ("absorption of , after named daySeptember",
                                     -4.770684624465665),
                                    ("Naraka Chaturdashiyear (latent)", -5.68697535633982),
                                    ("on <date>September", -5.281510248231656),
                                    ("at <time-of-day>on <date>", -5.281510248231656),
                                    ("in <named-month>|yearyear (latent)", -5.68697535633982),
                                    ("dayweek", -5.68697535633982),
                                    ("Easter Sundayyear (latent)", -5.281510248231656),
                                    ("Thursday<time-of-day> am|pm", -4.993828175779875),
                                    ("weekyear", -5.281510248231656),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.68697535633982),
                                    ("Sundayfrom|since|after <time>", -5.68697535633982),
                                    ("absorption of , after named dayFebruary", -4.770684624465665),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.68697535633982),
                                    ("tomorrowat <time-of-day>", -5.68697535633982),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.68697535633982),
                                    ("last <cycle> of <time>year (latent)", -5.281510248231656),
                                    ("tomorrow<time-of-day> am|pm", -5.68697535633982),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.993828175779875),
                                    ("Diwaliyear (latent)", -5.281510248231656),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.68697535633982),
                                    ("Fridayyear (latent)", -5.281510248231656),
                                    ("minuteyear", -4.434212387844452)],
                               n = 189}}),
       ("one eleven",
        Classifier{okData =
