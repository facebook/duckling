...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6329071001825886,
                               unseen = -5.7899601708972535,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 325},
                   koData =
                     ClassData{prior = -0.757250066752705, unseen = -5.666426688112432,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 287}}),
       ("<year> (bc|ad)",
        Classifier{okData =
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45726951929702847,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.071891796220597),
                                    ("Ramadanyear (latent)", -6.071891796220597),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.819128827725229),
                                    ("Bhai Doojyear (latent)", -6.071891796220597),
                                    ("hourday", -4.367143703982172),
                                    ("dayhour", -3.2096909152911284),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.819128827725229),
                                    ("Martin Luther King's Dayyear (latent)", -5.666426688112432),
                                    ("Shemini Atzeretyear (latent)", -6.071891796220597),
                                    ("daymonth", -5.155601064346442),
                                    ("monthday", -5.666426688112432),
                                    ("monthyear", -4.2801323269925415),
                                    ("Yom Ha'atzmautyear (latent)", -6.071891796220597),
                                    ("Vijayadashamiyear (latent)", -6.071891796220597),
                                    ("Thanksgiving Dayyear (latent)", -4.973279507552487),
                                    ("Thai Pongalyear (latent)", -5.3787446156606515),
                                    ("Thiru Onamyear (latent)", -5.3787446156606515),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.071891796220597),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.071891796220597),
                                    ("houryear", -5.3787446156606515),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.071891796220597),
                                    ("Christmas<time-of-day> am|pm", -6.071891796220597),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.071891796220597),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.3787446156606515),
                                    ("<time-of-day> am|pmintersect", -4.819128827725229),
                                    ("Earth Houryear (latent)", -6.071891796220597),
                                    ("Octoberyear (latent)", -4.567814399444322),
                                    ("intersect<time-of-day> am|pm", -6.071891796220597),
                                    ("Mattu Pongalyear (latent)", -6.071891796220597),
                                    ("Shavuotyear (latent)", -6.071891796220597),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.071891796220597),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.071891796220597),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.666426688112432),
                                    ("Marchyear (latent)", -6.071891796220597),
                                    ("Sukkotyear (latent)", -5.666426688112432),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.071891796220597),
                                    ("Clean Mondayyear (latent)", -5.666426688112432),
                                    ("monthhour", -5.666426688112432),
                                    ("todayat <time-of-day>", -6.071891796220597),
                                    ("Thursday<time> timezone", -4.1259816471652835),
                                    ("from|since|after <time>December", -6.071891796220597),
                                    ("<time-of-day> am|pmon <day>", -4.056988775678332),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.071891796220597),
                                    ("yyyy-mm-ddhh:mm:ss", -5.666426688112432),
                                    ("dayday", -4.056988775678332),
                                    ("<time> <part-of-day>at <time-of-day>", -6.071891796220597),
                                    ("mm/ddat <time-of-day>", -6.071891796220597),
                                    ("tonightat <time-of-day>", -6.071891796220597),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.3787446156606515),
                                    ("today<time-of-day> am|pm", -6.071891796220597),
                                    ("Februarythe <day-of-month> (ordinal)", -5.666426688112432),
                                    ("at <time-of-day><time> <part-of-day>", -6.071891796220597),
                                    ("mm/dd<time-of-day> am|pm", -6.071891796220597),
                                    ("hourhour", -4.819128827725229),
                                    ("Navaratriin|during <named-month>|year", -6.071891796220597),
                                    ("Wednesdaythis|last|next <cycle>", -6.071891796220597),
                                    ("Lentyear (latent)", -6.071891796220597),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.567814399444322),
                                    ("Boghiyear (latent)", -6.071891796220597),
                                    ("dayyear", -2.0028650419827856),
                                    ("Thursdayfrom|since|after <time>", -5.666426688112432),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.071891796220597),
                                    ("Thursdayat <time-of-day>", -5.3787446156606515),
                                    ("Islamic New Yearyear (latent)", -5.666426688112432),
                                    ("Laylat al-Qadryear (latent)", -5.155601064346442),
                                    ("Shrove Tuesdayyear (latent)", -6.071891796220597),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.3787446156606515),
                                    ("<time-of-day> am|pmtomorrow", -5.3787446156606515),
                                    ("Yom Kippuryear (latent)", -6.071891796220597),
                                    ("<part-of-day> of <time>year (latent)", -6.071891796220597),
                                    ("minutehour", -5.155601064346442),
                                    ("Kaanum Pongalyear (latent)", -5.666426688112432),
                                    ("Maha Saptamiyear (latent)", -6.071891796220597),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.666426688112432),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.367143703982172),
                                    ("for <duration> from <time>December", -6.071891796220597),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.071891796220597),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.819128827725229),
                                    ("Pentecostyear (latent)", -6.071891796220597),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.819128827725229),
                                    ("Eid al-Fitryear (latent)", -6.071891796220597),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.071891796220597),
                                    ("Mondayin|during the <part-of-day>", -6.071891796220597),
                                    ("Chhathin|during <named-month>|year", -6.071891796220597),
                                    ("Diwaliin|during <named-month>|year", -6.071891796220597),
                                    ("Vaisakhiin|during <named-month>|year", -6.071891796220597),
                                    ("Raksha Bandhanyear (latent)", -6.071891796220597),
                                    ("daysecond", -5.666426688112432),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.666426688112432),
                                    ("Ashurayear (latent)", -6.071891796220597),
                                    ("Tuesdayin|during <named-month>|year", -6.071891796220597),
                                    ("Chinese New Yearyear (latent)", -6.071891796220597),
                                    ("Lag BaOmeryear (latent)", -6.071891796220597),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.071891796220597),
                                    ("Eid al-Adhayear (latent)", -5.155601064346442),
                                    ("intersectin|during the <part-of-day>", -6.071891796220597),
                                    ("Palm Sundayyear (latent)", -6.071891796220597),
                                    ("Christmasat <time-of-day>", -6.071891796220597),
                                    ("Passoveryear (latent)", -6.071891796220597),
                                    ("Lazarus Saturdayyear (latent)", -6.071891796220597),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.666426688112432),
                                    ("Yom HaShoahyear (latent)", -5.666426688112432),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.666426688112432),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.071891796220597),
                                    ("Septemberyear (latent)", -5.666426688112432),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.567814399444322),
                                    ("Halloweenyear (latent)", -6.071891796220597),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.071891796220597),
                                    ("at <time-of-day>intersect", -5.666426688112432),
                                    ("Rosh Hashanahyear (latent)", -5.3787446156606515),
                                    ("Dhanterasyear (latent)", -6.071891796220597),
                                    ("Tu BiShvatyear (latent)", -6.071891796220597),
                                    ("Holiyear (latent)", -5.3787446156606515),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.071891796220597),
                                    ("Holika Dahanyear (latent)", -5.3787446156606515),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.071891796220597),
                                    ("dayminute", -3.1541210641363175),
                                    ("Mawlidyear (latent)", -6.071891796220597),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.666426688112432),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.071891796220597),
                                    ("Jumu'atul-Widayear (latent)", -5.155601064346442),
                                    ("minuteday", -2.434305636494211),
                                    ("absorption of , after named dayintersect",
                                     -6.071891796220597),
                                    ("Orthodox Easter Sundayyear (latent)", -6.071891796220597),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.071891796220597),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.071891796220597),
                                    ("Boss's Dayyear (latent)", -5.666426688112432),
                                    ("Global Youth Service Dayyear (latent)", -6.071891796220597),
                                    ("Dhanterasin|during <named-month>|year", -6.071891796220597),
                                    ("Tisha B'Avyear (latent)", -6.071891796220597),
                                    ("Isra and Mi'rajyear (latent)", -5.155601064346442),
                                    ("at <time-of-day>on <day>", -4.973279507552487),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.071891796220597),
                                    ("Christmasyear (latent)", -5.666426688112432),
                                    ("Naraka Chaturdashiyear (latent)", -5.666426688112432),
                                    ("Thai Pongalin|during <named-month>|year", -6.071891796220597),
                                    ("dayweek", -6.071891796220597),
                                    ("Easter Sundayyear (latent)", -5.3787446156606515),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.462453883786496),
                                    ("weekyear", -4.973279507552487),
                                    ("hh:mmin|during the <part-of-day>", -5.3787446156606515),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.666426688112432),
                                    ("Hanukkahyear (latent)", -5.3787446156606515),
                                    ("February<time> <part-of-day>", -6.071891796220597),
                                    ("Great Lentyear (latent)", -6.071891796220597),
                                    ("tomorrowat <time-of-day>", -5.3787446156606515),
                                    ("Vaisakhiyear (latent)", -5.3787446156606515),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.071891796220597),
                                    ("last <cycle> of <time>year (latent)", -5.3787446156606515),
                                    ("at <time-of-day>tomorrow", -5.666426688112432),
                                    ("tomorrow<time-of-day> am|pm", -6.071891796220597),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.071891796220597),
                                    ("Diwaliyear (latent)", -6.071891796220597),
                                    ("between <time> and <time>on <day>", -4.462453883786496),
                                    ("Black Fridayyear (latent)", -5.666426688112432),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.071891796220597),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.071891796220597),
                                    ("Chhathyear (latent)", -5.666426688112432),
                                    ("Vasant Panchamiyear (latent)", -6.071891796220597),
                                    ("Thursday<time> (timezone)", -6.071891796220597),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.071891796220597),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.666426688112432),
                                    ("Februaryintersect", -6.071891796220597),
                                    ("Simchat Torahyear (latent)", -6.071891796220597),
                                    ("minuteyear", -6.071891796220597)],
                               n = 326},
                   koData =
                     ClassData{prior = -1.0024198856040938, unseen = -6.386879319362645,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.775756486563625),
                                    ("dayhour", -3.017898569011251),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.775756486563625),
                                    ("Tuesdayfrom|since|after <time>", -5.69204721843778),
                                    ("daymonth", -3.6771441978955153),
                                    ("monthyear", -4.30575285731789),
                                    ("<time-of-day> am|pmyear (latent)", -4.998900037877835),
                                    ("Thai Pongalyear (latent)", -4.998900037877835),
                                    ("intersecthh:mm", -5.69204721843778),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.69204721843778),
                                    ("houryear", -4.59343492976967),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.69204721843778),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.998900037877835),
                                    ("<time-of-day> am|pmintersect", -4.439284249942412),
                                    ("Octoberyear (latent)", -5.286582110329616),
                                    ("until <time>on <day>", -4.998900037877835),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -4.998900037877835),
                                    ("about|exactly <time-of-day>year (latent)", -5.69204721843778),
                                    ("hh:mmon <day>", -3.6771441978955153),
                                    ("absorption of , after named dayJuly", -5.286582110329616),
                                    ("from|since|after <time>July", -5.69204721843778),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.775756486563625),
                                    ("Clean Mondayyear (latent)", -5.69204721843778),
                                    ("monthhour", -5.69204721843778),
                                    ("hourmonth", -4.775756486563625),
                                    ("todayat <time-of-day>", -5.69204721843778),
                                    ("from|since|after <time>December", -5.69204721843778),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.69204721843778),
                                    ("<time-of-day> am|pmon <day>", -4.439284249942412),
                                    ("Mondayyear (latent)", -4.998900037877835),
                                    ("dayday", -5.286582110329616),
                                    ("mm/ddat <time-of-day>", -5.286582110329616),
                                    ("on <day>September", -5.286582110329616),
                                    ("dayyear", -2.8016754605416154),
                                    ("Thursdaymm/dd", -5.69204721843778),
                                    ("New Year's Dayyear (latent)", -5.286582110329616),
                                    ("Thursdayfrom|since|after <time>", -3.9872991261993547),
                                    ("Thursdayat <time-of-day>", -4.08260930600368),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.69204721843778),
                                    ("Aprilyear (latent)", -5.69204721843778),
                                    ("monthminute", -5.69204721843778),
                                    ("<time-of-day> am|pmtomorrow", -5.69204721843778),
                                    ("Thursdayhh:mm", -4.775756486563625),
                                    ("minutemonth", -3.900287749209725),
                                    ("Augustyear (latent)", -5.286582110329616),
                                    ("week-endin|during <named-month>|year", -5.69204721843778),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.286582110329616),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.69204721843778),
                                    ("Sundayyear (latent)", -4.775756486563625),
                                    ("Christmasat <time-of-day>", -5.69204721843778),
                                    ("from|since|after <time>year (latent)", -4.59343492976967),
                                    ("<duration> after|before|from <time>December",
                                     -5.69204721843778),
                                    ("yesterday<time-of-day> am|pm", -5.69204721843778),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.69204721843778),
                                    ("mm/ddyear (latent)", -5.69204721843778),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.69204721843778),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.69204721843778),
                                    ("at <time-of-day>intersect", -5.286582110329616),
                                    ("hh:mmyear (latent)", -4.439284249942412),
                                    ("Holiyear (latent)", -5.69204721843778),
                                    ("until <time><time-of-day> am|pm", -5.69204721843778),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.69204721843778),
                                    ("dayminute", -3.127097860976243),
                                    ("yyyy-mm-ddhh:mm", -5.286582110329616),
                                    ("intersectSeptember", -4.187969821661506),
                                    ("minuteday", -2.623994283304163),
                                    ("absorption of , after named dayintersect", -5.69204721843778),
                                    ("Februaryin|during the <part-of-day>", -5.69204721843778),
                                    ("Saturdayyear (latent)", -5.69204721843778),
                                    ("at <time-of-day>on <day>", -5.286582110329616),
                                    ("absorption of , after named daySeptember",
                                     -4.775756486563625),
                                    ("Naraka Chaturdashiyear (latent)", -5.69204721843778),
                                    ("from|since|after <time>on <day>", -4.775756486563625),
                                    ("dayweek", -5.69204721843778),
                                    ("Easter Sundayyear (latent)", -5.286582110329616),
                                    ("Thursday<time-of-day> am|pm", -4.439284249942412),
                                    ("weekyear", -5.286582110329616),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -4.998900037877835),
                                    ("Sundayfrom|since|after <time>", -5.69204721843778),
                                    ("absorption of , after named dayFebruary", -4.775756486563625),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.69204721843778),
                                    ("tomorrowat <time-of-day>", -5.69204721843778),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.69204721843778),
                                    ("last <cycle> of <time>year (latent)", -5.286582110329616),
                                    ("tomorrow<time-of-day> am|pm", -5.69204721843778),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.998900037877835),
                                    ("Diwaliyear (latent)", -5.286582110329616),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.69204721843778),
                                    ("Fridayyear (latent)", -5.286582110329616),
                                    ("minuteyear", -4.30575285731789)],
                               n = 189}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.16008541534707282,
                               ...
                               n = 144},
                   koData =
                     ClassData{prior = -1.9110228900548727,
