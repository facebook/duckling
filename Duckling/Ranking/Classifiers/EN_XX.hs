...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48942171510283705,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.494509983555011),
                                    ...
                                    ("<time-of-day> am|pmtomorrow", -5.5782192516808555),
                               ...
                               n = 510},
                   koData =
                     ClassData{prior = -0.9492808952768003, unseen = -6.854354502255022,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.656074515849859),
                                    ("hourday", -3.557462227181749),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.160151912626133),
                                    ("<day-of-month> (ordinal)August", -6.160151912626133),
                                    ("dayhour", -3.419311888700932),
                                    ("<time> timezoneyear (latent)", -5.467004732066187),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.243861180751978),
                                    ("Tuesdayfrom|since|after <time>", -5.467004732066187),
                                    ("daymonth", -3.486003263199604),
                                    ("hourquarter", -5.243861180751978),
                                    ("monthyear", -4.907388944130765),
                                    ("<time-of-day> am|pmyear (latent)", -5.467004732066187),
                                    ("Thai Pongalyear (latent)", -5.467004732066187),
                                    ("intersecthh:mm", -6.160151912626133),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.754686804517968),
                                    ("<day-of-month> (ordinal)Wednesday", -6.160151912626133),
                                    ("houryear", -4.368392443398078),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.160151912626133),
                                    ("<day-of-month> (ordinal)October", -6.160151912626133),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.467004732066187),
                                    ("hournograin", -4.907388944130765),
                                    ("<time-of-day> am|pmintersect", -4.907388944130765),
                                    ("Octoberyear (latent)", -6.160151912626133),
                                    ("Good Fridayyear (latent)", -5.754686804517968),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.754686804517968),
                                    ("early morningat <time-of-day>", -6.160151912626133),
                                    ("until <time>on <day>", -5.467004732066187),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.160151912626133),
                                    ("time-of-day (latent)intersect", -5.467004732066187),
                                    ("todayin <number> (implicit minutes)", -6.160151912626133),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.467004732066187),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.160151912626133),
                                    ("hh:mmon <day>", -4.907388944130765),
                                    ("hhhmmintersect", -5.754686804517968),
                                    ("absorption of , after named dayJuly", -5.243861180751978),
                                    ("from|since|after <time>July", -5.754686804517968),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.243861180751978),
                                    ("Clean Mondayyear (latent)", -6.160151912626133),
                                    ("monthhour", -6.160151912626133),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.754686804517968),
                                    ("hourmonth", -4.020085749129862),
                                    ("todayat <time-of-day>", -6.160151912626133),
                                    ("hhhmmyear (latent)", -4.907388944130765),
                                    ("from|since|after <time>December", -6.160151912626133),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.160151912626133),
                                    ("<time-of-day> am|pmon <day>", -4.907388944130765),
                                    ("Mondayyear (latent)", -5.467004732066187),
                                    ("dayday", -4.145248892083869),
                                    ("mm/ddat <time-of-day>", -5.243861180751978),
                                    ("on <day>September", -5.467004732066187),
                                    ("time-of-day (latent)September", -5.754686804517968),
                                    ("hourhour", -4.0807103709462975),
                                    ("time-of-day (latent)on <day>", -4.656074515849859),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.754686804517968),
                                    ("dayyear", -3.11562947490271),
                                    ("Thursdaymm/dd", -6.160151912626133),
                                    ("New Year's Dayyear (latent)", -5.243861180751978),
                                    ("time-of-day (latent)Sunday", -5.754686804517968),
                                    ("Thursdayfrom|since|after <time>", -4.4554038203877075),
                                    ("Thursdayat <time-of-day>", -4.550714000192032),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.160151912626133),
                                    ("Aprilyear (latent)", -6.160151912626133),
                                    ("the <day-of-month> (ordinal)July", -6.160151912626133),
                                    ("the <day-of-month> (number)July", -6.160151912626133),
                                    ("monthminute", -6.160151912626133),
                                    ("<time-of-day> am|pmtomorrow", -5.754686804517968),
                                    ("Thursdayhh:mm", -5.243861180751978),
                                    ("<day-of-month> (ordinal)Tuesday", -5.754686804517968),
                                    ("minutemonth", -4.020085749129862),
                                    ("time-of-day (latent)Friday", -5.754686804517968),
                                    ("minutehour", -6.160151912626133),
                                    ("part of daysat <time-of-day>", -5.061539623958023),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.808776655462655),
                                    ("Augustyear (latent)", -5.754686804517968),
                                    ("week-endin|during <named-month>|year", -6.160151912626133),
                                    ("time-of-day (latent)Tuesday", -5.754686804517968),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.160151912626133),
                                    ("Sundayyear (latent)", -5.243861180751978),
                                    ("hourweek", -5.243861180751978),
                                    ("the <day-of-month> (ordinal)Monday", -5.467004732066187),
                                    ("Christmasat <time-of-day>", -6.160151912626133),
                                    ("from|since|after <time>year (latent)", -5.061539623958023),
                                    ("hhhmmon <day>", -5.243861180751978),
                                    ("yesterday<time-of-day> am|pm", -6.160151912626133),
                                    ("<day-of-month> (ordinal)July", -5.467004732066187),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.160151912626133),
                                    ("mm/ddyear (latent)", -6.160151912626133),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.160151912626133),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.160151912626133),
                                    ("at <time-of-day>intersect", -5.243861180751978),
                                    ("hh:mmyear (latent)", -4.773857551506242),
                                    ("Holiyear (latent)", -6.160151912626133),
                                    ("until <time><time-of-day> am|pm", -6.160151912626133),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.754686804517968),
                                    ("dayminute", -3.2979510316966647),
                                    ("yyyy-mm-ddhh:mm", -5.754686804517968),
                                    ("intersectfrom|since|after <time>", -5.754686804517968),
                                    ("intersectSeptember", -4.288349735724542),
                                    ("minuteday", -3.00315149147602),
                                    ("absorption of , after named dayintersect",
                                     -6.160151912626133),
                                    ("intersectyear (latent)", -6.160151912626133),
                                    ("Februaryin|during the <part-of-day>", -6.160151912626133),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.160151912626133),
                                    ("time-of-day (latent)July", -5.467004732066187),
                                    ("Saturdayyear (latent)", -6.160151912626133),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.160151912626133),
                                    ("<day-of-month> (ordinal)Monday", -5.243861180751978),
                                    ("at <time-of-day>on <day>", -5.243861180751978),
                                    ("absorption of , after named daySeptember",
                                     -4.907388944130765),
                                    ("Naraka Chaturdashiyear (latent)", -6.160151912626133),
                                    ("from|since|after <time>on <day>", -5.243861180751978),
                                    ("dayweek", -6.160151912626133),
                                    ("Easter Sundayyear (latent)", -5.754686804517968),
                                    ("Thursday<time-of-day> am|pm", -4.907388944130765),
                                    ("weekyear", -5.754686804517968),
                                    ("time-of-day (latent)Thursday", -5.754686804517968),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.160151912626133),
                                    ("<day-of-month> (ordinal)April", -6.160151912626133),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.754686804517968),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.467004732066187),
                                    ("Sundayfrom|since|after <time>", -6.160151912626133),
                                    ("absorption of , after named dayFebruary", -5.243861180751978),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.754686804517968),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.160151912626133),
                                    ("tomorrowat <time-of-day>", -6.160151912626133),
                                    ("daynograin", -5.754686804517968),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.754686804517968),
                                    ("last <cycle> of <time>year (latent)", -5.754686804517968),
                                    ("tomorrow<time-of-day> am|pm", -6.160151912626133),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.467004732066187),
                                    ("Diwaliyear (latent)", -5.754686804517968),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.160151912626133),
                                    ("this <part-of-day>at <time-of-day>", -5.243861180751978),
                                    ("Fridayyear (latent)", -5.243861180751978),
                                    ("time-of-day (latent)April", -6.160151912626133),
                                    ("minuteyear", -3.9629273352899137)],
                               n = 322}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
