...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47195484937699733,
                               unseen = -6.752270376141742,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.0579542883768145),
                                    ("Ramadanyear (latent)", -6.0579542883768145),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.805191319881446),
                                    ("Bhai Doojyear (latent)", -6.0579542883768145),
                                    ("hourday", -4.353206196138389),
                                    ("dayhour", -3.1957534074473464),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.805191319881446),
                                    ("Martin Luther King's Dayyear (latent)", -5.652489180268651),
                                    ("Shemini Atzeretyear (latent)", -6.0579542883768145),
                                    ("daymonth", -5.14166355650266),
                                    ("monthday", -5.652489180268651),
                                    ("monthyear", -4.26619481914876),
                                    ("Yom Ha'atzmautyear (latent)", -6.0579542883768145),
                                    ("Vijayadashamiyear (latent)", -6.0579542883768145),
                                    ("Thanksgiving Dayyear (latent)", -4.959341999708705),
                                    ("Thai Pongalyear (latent)", -5.36480710781687),
                                    ("Thiru Onamyear (latent)", -5.36480710781687),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.0579542883768145),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.0579542883768145),
                                    ("houryear", -5.36480710781687),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.0579542883768145),
                                    ("Christmas<time-of-day> am|pm", -6.0579542883768145),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.0579542883768145),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.36480710781687),
                                    ("<time-of-day> am|pmintersect", -4.805191319881446),
                                    ("Earth Houryear (latent)", -6.0579542883768145),
                                    ("Octoberyear (latent)", -4.553876891600541),
                                    ("intersect<time-of-day> am|pm", -6.0579542883768145),
                                    ("Mattu Pongalyear (latent)", -6.0579542883768145),
                                    ("Shavuotyear (latent)", -6.0579542883768145),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.0579542883768145),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.0579542883768145),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.652489180268651),
                                    ("Marchyear (latent)", -6.0579542883768145),
                                    ("Sukkotyear (latent)", -5.652489180268651),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.0579542883768145),
                                    ("Clean Mondayyear (latent)", -5.652489180268651),
                                    ("monthhour", -5.652489180268651),
                                    ("todayat <time-of-day>", -6.0579542883768145),
                                    ("Thursday<time> timezone", -4.112044139321502),
                                    ("from|since|after <time>December", -6.0579542883768145),
                                    ("<time-of-day> am|pmon <day>", -4.04305126783455),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.0579542883768145),
                                    ("yyyy-mm-ddhh:mm:ss", -5.652489180268651),
                                    ("dayday", -4.04305126783455),
                                    ("<time> <part-of-day>at <time-of-day>", -6.0579542883768145),
                                    ("mm/ddat <time-of-day>", -6.0579542883768145),
                                    ("tonightat <time-of-day>", -6.0579542883768145),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.36480710781687),
                                    ("today<time-of-day> am|pm", -6.0579542883768145),
                                    ("Februarythe <day-of-month> (ordinal)", -5.652489180268651),
                                    ("at <time-of-day><time> <part-of-day>", -6.0579542883768145),
                                    ("mm/dd<time-of-day> am|pm", -6.0579542883768145),
                                    ("hourhour", -4.805191319881446),
                                    ("Navaratriin|during <named-month>|year", -6.0579542883768145),
                                    ("Wednesdaythis|last|next <cycle>", -6.0579542883768145),
                                    ("Lentyear (latent)", -6.0579542883768145),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.553876891600541),
                                    ("Boghiyear (latent)", -6.0579542883768145),
                                    ("dayyear", -1.988927534139004),
                                    ("Thursdayfrom|since|after <time>", -5.652489180268651),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.0579542883768145),
                                    ("Thursdayat <time-of-day>", -5.36480710781687),
                                    ("Islamic New Yearyear (latent)", -5.652489180268651),
                                    ("Laylat al-Qadryear (latent)", -5.14166355650266),
                                    ("Shrove Tuesdayyear (latent)", -6.0579542883768145),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.36480710781687),
                                    ("<time-of-day> am|pmtomorrow", -5.36480710781687),
                                    ("Yom Kippuryear (latent)", -6.0579542883768145),
                                    ("<part-of-day> of <time>year (latent)", -6.0579542883768145),
                                    ("minutehour", -5.14166355650266),
                                    ("Kaanum Pongalyear (latent)", -5.652489180268651),
                                    ("Maha Saptamiyear (latent)", -6.0579542883768145),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.652489180268651),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.353206196138389),
                                    ("for <duration> from <time>December", -6.0579542883768145),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.0579542883768145),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.14166355650266),
                                    ("Pentecostyear (latent)", -6.0579542883768145),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.14166355650266),
                                    ("Eid al-Fitryear (latent)", -6.0579542883768145),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.0579542883768145),
                                    ("Mondayin|during the <part-of-day>", -6.0579542883768145),
                                    ("Chhathin|during <named-month>|year", -6.0579542883768145),
                                    ("Diwaliin|during <named-month>|year", -6.0579542883768145),
                                    ("Vaisakhiin|during <named-month>|year", -6.0579542883768145),
                                    ("Raksha Bandhanyear (latent)", -6.0579542883768145),
                                    ("daysecond", -5.652489180268651),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.652489180268651),
                                    ("Ashurayear (latent)", -6.0579542883768145),
                                    ("Tuesdayin|during <named-month>|year", -6.0579542883768145),
                                    ("Chinese New Yearyear (latent)", -6.0579542883768145),
                                    ("Lag BaOmeryear (latent)", -6.0579542883768145),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.0579542883768145),
                                    ("Eid al-Adhayear (latent)", -5.14166355650266),
                                    ("intersectin|during the <part-of-day>", -6.0579542883768145),
                                    ("Palm Sundayyear (latent)", -6.0579542883768145),
                                    ("Christmasat <time-of-day>", -6.0579542883768145),
                                    ("Passoveryear (latent)", -6.0579542883768145),
                                    ("Lazarus Saturdayyear (latent)", -6.0579542883768145),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.652489180268651),
                                    ("Yom HaShoahyear (latent)", -5.652489180268651),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.652489180268651),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.0579542883768145),
                                    ("Septemberyear (latent)", -5.652489180268651),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.805191319881446),
                                    ("Halloweenyear (latent)", -6.0579542883768145),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.36480710781687),
                                    ("Dhanterasyear (latent)", -6.0579542883768145),
                                    ("Tu BiShvatyear (latent)", -6.0579542883768145),
                                    ("Holiyear (latent)", -5.36480710781687),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.0579542883768145),
                                    ("Holika Dahanyear (latent)", -5.36480710781687),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0579542883768145),
                                    ("dayminute", -3.317114264451614),
                                    ("Mawlidyear (latent)", -6.0579542883768145),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.652489180268651),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.0579542883768145),
                                    ("Jumu'atul-Widayear (latent)", -5.14166355650266),
                                    ("minuteday", -2.4203681286504293),
                                    ("absorption of , after named dayintersect",
                                     -6.0579542883768145),
                                    ("Orthodox Easter Sundayyear (latent)", -6.0579542883768145),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.0579542883768145),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.0579542883768145),
                                    ("Boss's Dayyear (latent)", -5.652489180268651),
                                    ("Global Youth Service Dayyear (latent)", -6.0579542883768145),
                                    ("Dhanterasin|during <named-month>|year", -6.0579542883768145),
                                    ("Tisha B'Avyear (latent)", -6.0579542883768145),
                                    ("Isra and Mi'rajyear (latent)", -5.14166355650266),
                                    ("at <time-of-day>on <day>", -4.959341999708705),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.0579542883768145),
                                    ("Christmasyear (latent)", -5.652489180268651),
                                    ("Naraka Chaturdashiyear (latent)", -5.652489180268651),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.0579542883768145),
                                    ("dayweek", -6.0579542883768145),
                                    ("Easter Sundayyear (latent)", -5.36480710781687),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.448516375942715),
                                    ("weekyear", -4.959341999708705),
                                    ("hh:mmin|during the <part-of-day>", -5.36480710781687),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.652489180268651),
                                    ("Hanukkahyear (latent)", -5.36480710781687),
                                    ("February<time> <part-of-day>", -6.0579542883768145),
                                    ("Great Lentyear (latent)", -6.0579542883768145),
                                    ("tomorrowat <time-of-day>", -5.36480710781687),
                                    ("Vaisakhiyear (latent)", -5.36480710781687),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.0579542883768145),
                                    ("last <cycle> of <time>year (latent)", -5.36480710781687),
                                    ("at <time-of-day>tomorrow", -5.652489180268651),
                                    ("tomorrow<time-of-day> am|pm", -6.0579542883768145),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.0579542883768145),
                                    ("Diwaliyear (latent)", -6.0579542883768145),
                                    ("between <time> and <time>on <day>", -4.448516375942715),
                                    ("Black Fridayyear (latent)", -5.652489180268651),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.0579542883768145),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.0579542883768145),
                                    ("Chhathyear (latent)", -5.652489180268651),
                                    ("Vasant Panchamiyear (latent)", -6.0579542883768145),
                                    ("Thursday<time> (timezone)", -6.0579542883768145),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.0579542883768145),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.652489180268651),
                                    ("Februaryintersect", -6.0579542883768145),
                                    ("Simchat Torahyear (latent)", -6.0579542883768145),
                                    ("minuteyear", -6.0579542883768145)],
                               n = 320},
                   koData =
                     ClassData{prior = -0.977585656265884, unseen = -6.400257445308821,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.789157022101107),
                                    ...
                                    ("Octoberyear (latent)", -5.2999826458670976),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.14818051284075445,
                               ...
                               n = 144},
                   koData =
                     ClassData{prior = -1.9824995964876053, unseen = -3.332204510175204,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                    ...
                                    ("on <day><time-of-day> am|pm", -4.248495242049359),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week-endJuly", -4.060443010546419),
                                    ...
                                    ("on <day>September", -3.654977902438255),
