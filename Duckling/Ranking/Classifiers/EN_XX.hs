...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6580558607486751, unseen = -5.572154032177765,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47656102979189463,
                               unseen = -6.639875833826536,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -5.945420608606575),
                                    ("Ramadanyear (latent)", -5.945420608606575),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.692657640111207),
                                    ("Bhai Doojyear (latent)", -5.945420608606575),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.692657640111207),
                                    ("hourday", -4.24067251636815), ("dayhour", -3.027649876522296),
                                    ("Martin Luther King's Dayyear (latent)", -5.539955500498411),
                                    ("Shemini Atzeretyear (latent)", -5.945420608606575),
                                    ("daymonth", -5.25227342804663),
                                    ("monthday", -5.539955500498411),
                                    ("monthyear", -4.335982696172475),
                                    ("Yom Ha'atzmautyear (latent)", -5.945420608606575),
                                    ("Vijayadashamiyear (latent)", -5.945420608606575),
                                    ("Thanksgiving Dayyear (latent)", -4.846808319938465),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.945420608606575),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.945420608606575),
                                    ("houryear", -5.25227342804663),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.945420608606575),
                                    ("Christmas<time-of-day> am|pm", -5.945420608606575),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.945420608606575),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.25227342804663),
                                    ("<time-of-day> am|pmintersect", -4.692657640111207),
                                    ("Octoberyear (latent)", -4.692657640111207),
                                    ("intersect<time-of-day> am|pm", -5.945420608606575),
                                    ("Shavuotyear (latent)", -5.945420608606575),
                                    ("Dhanterasin <named-month>|year", -5.945420608606575),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.945420608606575),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.945420608606575),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.539955500498411),
                                    ("Marchyear (latent)", -5.945420608606575),
                                    ("Sukkotyear (latent)", -5.539955500498411),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.945420608606575),
                                    ("Clean Mondayyear (latent)", -5.539955500498411),
                                    ("monthhour", -5.539955500498411),
                                    ("todayat <time-of-day>", -5.945420608606575),
                                    ("Thursday<time> timezone", -4.24067251636815),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.945420608606575),
                                    ("Palm SundaySunday", -5.539955500498411),
                                    ("dayday", -3.7481960312703557),
                                    ("<time> <part-of-day>at <time-of-day>", -5.945420608606575),
                                    ("mm/ddat <time-of-day>", -5.945420608606575),
                                    ("tonightat <time-of-day>", -5.945420608606575),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.25227342804663),
                                    ("today<time-of-day> am|pm", -5.945420608606575),
                                    ("Februarythe <day-of-month> (ordinal)", -5.539955500498411),
                                    ("at <time-of-day><time> <part-of-day>", -5.945420608606575),
                                    ("mm/dd<time-of-day> am|pm", -5.945420608606575),
                                    ("hourhour", -4.692657640111207),
                                    ("<time-of-day> am|pmon <date>", -3.9305175880643106),
                                    ("Wednesdaythis|last|next <cycle>", -5.945420608606575),
                                    ("Lentyear (latent)", -5.945420608606575),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.441343211830301),
                                    ("dayyear", -2.1499314194343806),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.945420608606575),
                                    ("Thursdayat <time-of-day>", -5.539955500498411),
                                    ("Islamic New Yearyear (latent)", -5.539955500498411),
                                    ("Laylat al-Qadryear (latent)", -5.02912987673242),
                                    ("Chhathin <named-month>|year", -5.945420608606575),
                                    ("Diwaliin <named-month>|year", -5.945420608606575),
                                    ("Shrove Tuesdayyear (latent)", -5.945420608606575),
                                    ("<time-of-day> am|pmtomorrow", -5.25227342804663),
                                    ("Yom Kippuryear (latent)", -5.945420608606575),
                                    ("<part-of-day> of <time>year (latent)", -5.945420608606575),
                                    ("minutehour", -5.02912987673242),
                                    ("Maha Saptamiyear (latent)", -5.945420608606575),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.539955500498411),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.24067251636815),
                                    ("for <duration> from <time>December", -5.945420608606575),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.945420608606575),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.02912987673242),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.539955500498411),
                                    ("Pentecostyear (latent)", -5.945420608606575),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.02912987673242),
                                    ("Eid al-Fitryear (latent)", -5.945420608606575),
                                    ("Mondayin|during the <part-of-day>", -5.945420608606575),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.539955500498411),
                                    ("Navaratriin <named-month>|year", -5.945420608606575),
                                    ("Ashurayear (latent)", -5.945420608606575),
                                    ("Chinese New Yearyear (latent)", -5.945420608606575),
                                    ("Sundayyear (latent)", -5.945420608606575),
                                    ("Lag BaOmeryear (latent)", -5.945420608606575),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.945420608606575),
                                    ("Eid al-Adhayear (latent)", -5.02912987673242),
                                    ("intersectin|during the <part-of-day>", -5.945420608606575),
                                    ("Christmasat <time-of-day>", -5.945420608606575),
                                    ("Passoveryear (latent)", -5.945420608606575),
                                    ("Lazarus Saturdayyear (latent)", -5.945420608606575),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.945420608606575),
                                    ("Yom HaShoahyear (latent)", -5.539955500498411),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.02912987673242),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.945420608606575),
                                    ("Septemberyear (latent)", -5.539955500498411),
                                    ("mm/ddyear (latent)", -5.945420608606575),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.692657640111207),
                                    ("Halloweenyear (latent)", -5.945420608606575),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.945420608606575),
                                    ("Dhanterasyear (latent)", -5.945420608606575),
                                    ("Tu BiShvatyear (latent)", -5.945420608606575),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.945420608606575),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.945420608606575),
                                    ("dayminute", -3.3063632789913164),
                                    ("Mawlidyear (latent)", -5.945420608606575),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.539955500498411),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.945420608606575),
                                    ("Jumu'atul-Widayear (latent)", -5.02912987673242),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.945420608606575),
                                    ("minuteday", -2.3078344488801896),
                                    ("absorption of , after named dayintersect",
                                     -5.945420608606575),
                                    ("intersectyear (latent)", -5.945420608606575),
                                    ("Orthodox Easter Sundayyear (latent)", -5.945420608606575),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.945420608606575),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.945420608606575),
                                    ("Boss's Dayyear (latent)", -5.539955500498411),
                                    ("Tisha B'Avyear (latent)", -5.945420608606575),
                                    ("Isra and Mi'rajyear (latent)", -5.02912987673242),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.945420608606575),
                                    ("Christmasyear (latent)", -5.539955500498411),
                                    ("Naraka Chaturdashiyear (latent)", -5.539955500498411),
                                    ("at <time-of-day>on <date>", -4.846808319938465),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.335982696172475),
                                    ("dayweek", -5.945420608606575),
                                    ("Easter Sundayyear (latent)", -5.25227342804663),
                                    ("Thursday<time-of-day> am|pm", -5.945420608606575),
                                    ("weekyear", -5.539955500498411),
                                    ("hh:mmin|during the <part-of-day>", -5.25227342804663),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.539955500498411),
                                    ("Hanukkahyear (latent)", -5.945420608606575),
                                    ("February<time> <part-of-day>", -5.945420608606575),
                                    ("Tuesdayin <named-month>|year", -5.945420608606575),
                                    ("Great Lentyear (latent)", -5.945420608606575),
                                    ("tomorrowat <time-of-day>", -5.25227342804663),
                                    ("between <time> and <time>on <date>", -4.335982696172475),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.25227342804663),
                                    ("last <cycle> of <time>year (latent)", -5.25227342804663),
                                    ("at <time-of-day>tomorrow", -5.539955500498411),
                                    ("tomorrow<time-of-day> am|pm", -5.945420608606575),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.945420608606575),
                                    ("Diwaliyear (latent)", -5.945420608606575),
                                    ("Black Fridayyear (latent)", -5.539955500498411),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.945420608606575),
                                    ("Chhathyear (latent)", -5.539955500498411),
                                    ("Palm Sundayintersect", -5.945420608606575),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.945420608606575),
                                    ("Februaryintersect", -5.945420608606575),
                                    ("Simchat Torahyear (latent)", -5.945420608606575)],
                               n = 285},
                   koData =
                     ClassData{prior = -0.9699949108460162, unseen = -6.297109319933935,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.602118820879701),
                                    ("hourday", -5.602118820879701),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.602118820879701),
                                    ("dayhour", -3.1597717855104963),
                                    ("daymonth", -3.522677279199865),
                                    ("monthday", -5.196653712771536),
                                    ("monthyear", -4.349355852384333),
                                    ("<time-of-day> am|pmyear (latent)", -5.196653712771536),
                                    ("intersecthh:mm", -5.602118820879701),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.602118820879701),
                                    ("houryear", -4.685828089005546),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.602118820879701),
                                    ("until <time-of-day><time-of-day> am|pm", -5.602118820879701),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.908971640319756),
                                    ("<time-of-day> am|pmintersect", -4.349355852384333),
                                    ("Octoberyear (latent)", -5.602118820879701),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.349355852384333),
                                    ("from|since|after <time-of-day>on <date>", -4.685828089005546),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.602118820879701),
                                    ("absorption of , after named dayJuly", -5.196653712771536),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.685828089005546),
                                    ("Clean Mondayyear (latent)", -5.602118820879701),
                                    ("monthhour", -5.602118820879701),
                                    ("hourmonth", -4.908971640319756),
                                    ("todayat <time-of-day>", -5.602118820879701),
                                    ("from|since|after <time-of-day>July", -5.602118820879701),
                                    ("Mondayyear (latent)", -4.908971640319756),
                                    ("dayday", -5.196653712771536),
                                    ("mm/ddat <time-of-day>", -5.196653712771536),
                                    ("<time-of-day> am|pmon <date>", -4.349355852384333),
                                    ("dayyear", -2.7399179399502325),
                                    ("Thursdaymm/dd", -5.602118820879701),
                                    ("New Year's Dayyear (latent)", -5.196653712771536),
                                    ("Thursdayat <time-of-day>", -4.349355852384333),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.602118820879701),
                                    ("Aprilyear (latent)", -5.602118820879701),
                                    ("monthminute", -5.602118820879701),
                                    ("<time-of-day> am|pmtomorrow", -5.602118820879701),
                                    ("Thursdayhh:mm", -4.685828089005546),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.602118820879701),
                                    ("minutemonth", -3.810359351651646),
                                    ("Sundayfrom|since|after <time-of-day>", -5.602118820879701),
                                    ("week-endin <named-month>|year", -5.602118820879701),
                                    ("Augustyear (latent)", -5.196653712771536),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.196653712771536),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.196653712771536),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.602118820879701),
                                    ("Sundayyear (latent)", -4.908971640319756),
                                    ("Christmasat <time-of-day>", -5.602118820879701),
                                    ("<duration> after|before|from <time>December",
                                     -5.602118820879701),
                                    ("yesterday<time-of-day> am|pm", -5.602118820879701),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.685828089005546),
                                    ("mm/ddyear (latent)", -5.602118820879701),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.196653712771536),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.602118820879701),
                                    ("until <time-of-day>on <date>", -4.908971640319756),
                                    ("at <time-of-day>intersect", -5.196653712771536),
                                    ("hh:mmyear (latent)", -4.503506532211591),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.602118820879701),
                                    ("dayminute", -3.1172121710917007),
                                    ("intersectSeptember", -4.098041424103426),
                                    ("minuteday", -2.534065885746084),
                                    ("absorption of , after named dayintersect",
                                     -5.602118820879701),
                                    ("Februaryin|during the <part-of-day>", -5.602118820879701),
                                    ("hh:mmon <date>", -3.5872158003374364),
                                    ("Saturdayyear (latent)", -5.602118820879701),
                                    ...
                                    ("on <date>September", -5.196653712771536),
                                    ("at <time-of-day>on <date>", -5.196653712771536),
                                    ("in <named-month>|yearyear (latent)", -5.602118820879701),
                                    ("dayweek", -5.602118820879701),
                                    ("Easter Sundayyear (latent)", -5.196653712771536),
                                    ("Thursday<time-of-day> am|pm", -5.196653712771536),
                                    ("absorption of , after named dayFebruary", -4.685828089005546),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.602118820879701),
                                    ("tomorrowat <time-of-day>", -5.602118820879701),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.602118820879701),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.9926809084456005),
                                    ("tomorrow<time-of-day> am|pm", -5.602118820879701),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.908971640319756),
                                    ("Diwaliyear (latent)", -5.196653712771536),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.602118820879701),
                                    ("Fridayyear (latent)", -5.196653712771536),
                                    ("minuteyear", -4.349355852384333)],
                               n = 174}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1935847490726654, unseen = -4.68213122712422,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -5.770831762064673e-2),
                                    ("intersect 2 numbers", -3.2865344733420154)],
                               n = 103},
                   koData =
                     ClassData{prior = -1.7372712839439852, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
