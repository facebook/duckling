...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6070725717887023, unseen = -5.680172609017068,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 291},
                   koData =
                     ClassData{prior = -0.7873343956196464,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4806725855953032, unseen = -6.705639094860003,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.0112671744041615),
                                    ("Ramadanyear (latent)", -6.0112671744041615),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.758504205908793),
                                    ("Bhai Doojyear (latent)", -6.0112671744041615),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.758504205908793),
                                    ("hourday", -4.306519082165736),
                                    ("dayhour", -3.2079067934976266),
                                    ("Martin Luther King's Dayyear (latent)", -5.605802066295998),
                                    ("Shemini Atzeretyear (latent)", -6.0112671744041615),
                                    ("daymonth", -5.318119993844216),
                                    ("monthday", -5.605802066295998),
                                    ("monthyear", -4.401829261970061),
                                    ("Yom Ha'atzmautyear (latent)", -6.0112671744041615),
                                    ("Vijayadashamiyear (latent)", -6.0112671744041615),
                                    ("Thanksgiving Dayyear (latent)", -4.912654885736052),
                                    ("Thai Pongalyear (latent)", -5.318119993844216),
                                    ("Thiru Onamyear (latent)", -5.318119993844216),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.0112671744041615),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.0112671744041615),
                                    ("houryear", -5.318119993844216),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.0112671744041615),
                                    ("Christmas<time-of-day> am|pm", -6.0112671744041615),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.0112671744041615),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.318119993844216),
                                    ("<time-of-day> am|pmintersect", -4.758504205908793),
                                    ("Earth Houryear (latent)", -6.0112671744041615),
                                    ("Octoberyear (latent)", -4.758504205908793),
                                    ("intersect<time-of-day> am|pm", -6.0112671744041615),
                                    ("Mattu Pongalyear (latent)", -6.0112671744041615),
                                    ("Shavuotyear (latent)", -6.0112671744041615),
                                    ("Dhanterasin <named-month>|year", -6.0112671744041615),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.0112671744041615),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.0112671744041615),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.605802066295998),
                                    ("Marchyear (latent)", -6.0112671744041615),
                                    ("Sukkotyear (latent)", -5.605802066295998),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.0112671744041615),
                                    ("Clean Mondayyear (latent)", -5.605802066295998),
                                    ("monthhour", -5.605802066295998),
                                    ("todayat <time-of-day>", -6.0112671744041615),
                                    ("Thursday<time> timezone", -4.306519082165736),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.0112671744041615),
                                    ("Palm SundaySunday", -5.605802066295998),
                                    ("dayday", -3.8140425970679424),
                                    ("<time> <part-of-day>at <time-of-day>", -6.0112671744041615),
                                    ("mm/ddat <time-of-day>", -6.0112671744041615),
                                    ("tonightat <time-of-day>", -6.0112671744041615),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.318119993844216),
                                    ("today<time-of-day> am|pm", -6.0112671744041615),
                                    ("Februarythe <day-of-month> (ordinal)", -5.605802066295998),
                                    ("at <time-of-day><time> <part-of-day>", -6.0112671744041615),
                                    ("mm/dd<time-of-day> am|pm", -6.0112671744041615),
                                    ("hourhour", -4.758504205908793),
                                    ("<time-of-day> am|pmon <date>", -3.996364153861897),
                                    ("Wednesdaythis|last|next <cycle>", -6.0112671744041615),
                                    ("Lentyear (latent)", -6.0112671744041615),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.507189777627888),
                                    ("Boghiyear (latent)", -6.0112671744041615),
                                    ("dayyear", -2.0039339891716907),
                                    ("Thursdayfrom|since|after <time>", -5.605802066295998),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.0112671744041615),
                                    ("Thursdayat <time-of-day>", -5.605802066295998),
                                    ("Islamic New Yearyear (latent)", -5.605802066295998),
                                    ("Laylat al-Qadryear (latent)", -5.094976442530006),
                                    ("Chhathin <named-month>|year", -6.0112671744041615),
                                    ("Vasant Panchamiin <named-month>|year", -6.0112671744041615),
                                    ("Diwaliin <named-month>|year", -6.0112671744041615),
                                    ("Shrove Tuesdayyear (latent)", -6.0112671744041615),
                                    ("<time-of-day> am|pmtomorrow", -5.318119993844216),
                                    ("Yom Kippuryear (latent)", -6.0112671744041615),
                                    ("<part-of-day> of <time>year (latent)", -6.0112671744041615),
                                    ("minutehour", -5.094976442530006),
                                    ("Kaanum Pongalyear (latent)", -5.605802066295998),
                                    ("Maha Saptamiyear (latent)", -6.0112671744041615),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.605802066295998),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.306519082165736),
                                    ("for <duration> from <time>December", -6.0112671744041615),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.0112671744041615),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.094976442530006),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.605802066295998),
                                    ("Pentecostyear (latent)", -6.0112671744041615),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.094976442530006),
                                    ("Eid al-Fitryear (latent)", -6.0112671744041615),
                                    ("Mondayin|during the <part-of-day>", -6.0112671744041615),
                                    ("Raksha Bandhanyear (latent)", -6.0112671744041615),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.605802066295998),
                                    ("Navaratriin <named-month>|year", -6.0112671744041615),
                                    ("Ashurayear (latent)", -6.0112671744041615),
                                    ("Chinese New Yearyear (latent)", -6.0112671744041615),
                                    ("Sundayyear (latent)", -6.0112671744041615),
                                    ("Lag BaOmeryear (latent)", -6.0112671744041615),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.0112671744041615),
                                    ("Eid al-Adhayear (latent)", -5.094976442530006),
                                    ("intersectin|during the <part-of-day>", -6.0112671744041615),
                                    ("Christmasat <time-of-day>", -6.0112671744041615),
                                    ("Passoveryear (latent)", -6.0112671744041615),
                                    ("Lazarus Saturdayyear (latent)", -6.0112671744041615),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.0112671744041615),
                                    ("Yom HaShoahyear (latent)", -5.605802066295998),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.605802066295998),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.0112671744041615),
                                    ("Thai Pongalin <named-month>|year", -6.0112671744041615),
                                    ("Septemberyear (latent)", -5.605802066295998),
                                    ("mm/ddyear (latent)", -6.0112671744041615),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.758504205908793),
                                    ("Halloweenyear (latent)", -6.0112671744041615),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -6.0112671744041615),
                                    ("Dhanterasyear (latent)", -6.0112671744041615),
                                    ("Tu BiShvatyear (latent)", -6.0112671744041615),
                                    ("Holiyear (latent)", -5.318119993844216),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.0112671744041615),
                                    ("Holika Dahanyear (latent)", -5.318119993844216),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0112671744041615),
                                    ("dayminute", -3.372209844788903),
                                    ("Mawlidyear (latent)", -6.0112671744041615),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.605802066295998),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.0112671744041615),
                                    ("Jumu'atul-Widayear (latent)", -5.094976442530006),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0112671744041615),
                                    ("minuteday", -2.373681014677776),
                                    ("absorption of , after named dayintersect",
                                     -6.0112671744041615),
                                    ("intersectyear (latent)", -6.0112671744041615),
                                    ("Orthodox Easter Sundayyear (latent)", -6.0112671744041615),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.0112671744041615),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.0112671744041615),
                                    ("Boss's Dayyear (latent)", -5.605802066295998),
                                    ("Global Youth Service Dayyear (latent)", -6.0112671744041615),
                                    ("Tisha B'Avyear (latent)", -6.0112671744041615),
                                    ("Isra and Mi'rajyear (latent)", -5.094976442530006),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.0112671744041615),
                                    ("Christmasyear (latent)", -5.605802066295998),
                                    ("Naraka Chaturdashiyear (latent)", -5.605802066295998),
                                    ("at <time-of-day>on <date>", -4.912654885736052),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.401829261970061),
                                    ("dayweek", -6.0112671744041615),
                                    ("Easter Sundayyear (latent)", -5.318119993844216),
                                    ("weekyear", -5.605802066295998),
                                    ("hh:mmin|during the <part-of-day>", -5.318119993844216),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.605802066295998),
                                    ("Hanukkahyear (latent)", -6.0112671744041615),
                                    ("February<time> <part-of-day>", -6.0112671744041615),
                                    ("Tuesdayin <named-month>|year", -6.0112671744041615),
                                    ("Great Lentyear (latent)", -6.0112671744041615),
                                    ("tomorrowat <time-of-day>", -5.318119993844216),
                                    ("between <time> and <time>on <date>", -4.401829261970061),
                                    ("last <cycle> of <time>year (latent)", -5.318119993844216),
                                    ("at <time-of-day>tomorrow", -5.605802066295998),
                                    ("tomorrow<time-of-day> am|pm", -6.0112671744041615),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.0112671744041615),
                                    ("Diwaliyear (latent)", -6.0112671744041615),
                                    ("Black Fridayyear (latent)", -5.605802066295998),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.0112671744041615),
                                    ("Chhathyear (latent)", -5.605802066295998),
                                    ("Vasant Panchamiyear (latent)", -6.0112671744041615),
                                    ("Palm Sundayintersect", -6.0112671744041615),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.0112671744041615),
                                    ("Februaryintersect", -6.0112671744041615),
                                    ("Simchat Torahyear (latent)", -6.0112671744041615),
                                    ("minuteyear", -6.0112671744041615)],
                               n = 303},
                   koData =
                     ClassData{prior = -0.9632967742500856, unseen = -6.371611847231857,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.760463070394127),
                                    ...
                                    ("daymonth", -3.536687638772011),
                                    ("monthday", -5.271288694160117),
                                    ...
                                    ("mm/ddat <time-of-day>", -5.271288694160117),
                                    ("<time-of-day> am|pmon <date>", -4.423990833772914),
                                    ("dayyear", -2.7063393366985804),
                                    ...
                                    ("Thursdayat <time-of-day>", -4.423990833772914),
                                    ...
                                    ("week-endin <named-month>|year", -5.676753802268282),
                                    ...
                                    ("in <named-month>|yearyear (latent)", -5.676753802268282),
