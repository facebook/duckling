...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6738444283054167, unseen = -5.834810737062605,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 340},
                   koData =
                     ClassData{prior = -0.7128298750183704, unseen = -5.796057750765372,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.49778762942786087,
                               unseen = -6.928537818164665,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.234410725718371),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.234410725718371),
                                    ("Ramadanyear (latent)", -5.318119993844216),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.219507705176107),
                                    ("Bhai Doojyear (latent)", -6.234410725718371),
                                    ("hourday", -4.219507705176107),
                                    ("dayhour", -3.3166399936340922),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.219507705176107),
                                    ("Martin Luther King's Dayyear (latent)", -5.8289456176102075),
                                    ("Shemini Atzeretyear (latent)", -6.234410725718371),
                                    ("daymonth", -4.442651256490317),
                                    ("monthday", -5.8289456176102075),
                                    ("monthyear", -4.36260854881678),
                                    ("Yom Ha'atzmautyear (latent)", -6.234410725718371),
                                    ("Vijayadashamiyear (latent)", -6.234410725718371),
                                    ("Thanksgiving Dayyear (latent)", -5.135798437050262),
                                    ("Thai Pongalyear (latent)", -5.541263545158426),
                                    ("Thiru Onamyear (latent)", -5.541263545158426),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.234410725718371),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.234410725718371),
                                    ("<day-of-month> (ordinal)Wednesday", -6.234410725718371),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.234410725718371),
                                    ("houryear", -5.318119993844216),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.234410725718371),
                                    ("Christmas<time-of-day> am|pm", -6.234410725718371),
                                    ...
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.541263545158426),
                                    ("intersectin|during <named-month>|year", -6.234410725718371),
                                    ("<time-of-day> am|pmintersect", -4.981647757223003),
                                    ("Earth Houryear (latent)", -6.234410725718371),
                                    ("Octoberyear (latent)", -4.624972813284271),
                                    ("intersect<time-of-day> am|pm", -6.234410725718371),
                                    ("Mattu Pongalyear (latent)", -6.234410725718371),
                                    ("Shavuotyear (latent)", -6.234410725718371),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.234410725718371),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.234410725718371),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.8289456176102075),
                                    ("Marchyear (latent)", -6.234410725718371),
                                    ("Sukkotyear (latent)", -5.8289456176102075),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.8289456176102075),
                                    ("Clean Mondayyear (latent)", -5.8289456176102075),
                                    ("monthhour", -5.8289456176102075),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.541263545158426),
                                    ("todayat <time-of-day>", -6.234410725718371),
                                    ("Thursday<time> timezone", -4.288500576663058),
                                    ("time-of-day (latent)tonight", -5.8289456176102075),
                                    ("from|since|after <time>December", -6.234410725718371),
                                    ("<time-of-day> am|pmon <day>", -4.219507705176107),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.234410725718371),
                                    ("yyyy-mm-ddhh:mm:ss", -5.8289456176102075),
                                    ("dayday", -3.792063690349167),
                                    ("<time> <part-of-day>at <time-of-day>", -6.234410725718371),
                                    ("mm/ddat <time-of-day>", -6.234410725718371),
                                    ("tonightat <time-of-day>", -6.234410725718371),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.541263545158426),
                                    ("today<time-of-day> am|pm", -6.234410725718371),
                                    ("Februarythe <day-of-month> (ordinal)", -5.8289456176102075),
                                    ("at <time-of-day><time> <part-of-day>", -6.234410725718371),
                                    ("<day-of-month> (ordinal)intersect", -5.541263545158426),
                                    ("mm/dd<time-of-day> am|pm", -6.234410725718371),
                                    ("hourhour", -4.154969184038536),
                                    ("Navaratriin|during <named-month>|year", -6.234410725718371),
                                    ("Wednesdaythis|last|next <cycle>", -6.234410725718371),
                                    ("Lentyear (latent)", -6.234410725718371),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.7303333289420975),
                                    ("Boghiyear (latent)", -6.234410725718371),
                                    ("dayyear", -2.0755276423586997),
                                    ("Thursdayfrom|since|after <time>", -5.8289456176102075),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.234410725718371),
                                    ("Thursdayat <time-of-day>", -5.541263545158426),
                                    ("Islamic New Yearyear (latent)", -5.8289456176102075),
                                    ("Laylat al-Qadryear (latent)", -5.318119993844216),
                                    ("Shrove Tuesdayyear (latent)", -6.234410725718371),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.541263545158426),
                                    ("<time-of-day> am|pmtomorrow", -5.541263545158426),
                                    ("Yom Kippuryear (latent)", -6.234410725718371),
                                    ("<day-of-month> (ordinal)Tuesday", -5.8289456176102075),
                                    ("<part-of-day> of <time>year (latent)", -6.234410725718371),
                                    ("minutehour", -5.135798437050262),
                                    ("Kaanum Pongalyear (latent)", -5.8289456176102075),
                                    ("Maha Saptamiyear (latent)", -6.234410725718371),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.8289456176102075),
                                    ("time-of-day (latent)tomorrow", -5.318119993844216),
                                    ("part of daysat <time-of-day>", -5.8289456176102075),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.529662633479946),
                                    ("for <duration> from <time>December", -6.234410725718371),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.234410725718371),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.981647757223003),
                                    ("time-of-day (latent)this <part-of-day>", -6.234410725718371),
                                    ("Pentecostyear (latent)", -6.234410725718371),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.981647757223003),
                                    ("<day-of-month> (ordinal)February", -6.234410725718371),
                                    ("Eid al-Fitryear (latent)", -5.318119993844216),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.234410725718371),
                                    ("Mondayin|during the <part-of-day>", -6.234410725718371),
                                    ("Chhathin|during <named-month>|year", -6.234410725718371),
                                    ("Diwaliin|during <named-month>|year", -6.234410725718371),
                                    ("Vaisakhiin|during <named-month>|year", -6.234410725718371),
                                    ("Raksha Bandhanyear (latent)", -6.234410725718371),
                                    ("daysecond", -5.8289456176102075),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.8289456176102075),
                                    ("Ashurayear (latent)", -6.234410725718371),
                                    ("Tuesdayin|during <named-month>|year", -6.234410725718371),
                                    ("Chinese New Yearyear (latent)", -6.234410725718371),
                                    ("tomorrowintersect", -6.234410725718371),
                                    ("Lag BaOmeryear (latent)", -6.234410725718371),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.234410725718371),
                                    ("Eid al-Adhayear (latent)", -5.318119993844216),
                                    ("intersectin|during the <part-of-day>", -6.234410725718371),
                                    ("Palm Sundayyear (latent)", -6.234410725718371),
                                    ("Christmasat <time-of-day>", -6.234410725718371),
                                    ("Passoveryear (latent)", -6.234410725718371),
                                    ("Lazarus Saturdayyear (latent)", -6.234410725718371),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.8289456176102075),
                                    ("Yom HaShoahyear (latent)", -5.8289456176102075),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.8289456176102075),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.234410725718371),
                                    ("Septemberyear (latent)", -5.8289456176102075),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.7303333289420975),
                                    ("Halloweenyear (latent)", -6.234410725718371),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.234410725718371),
                                    ("at <time-of-day>intersect", -5.8289456176102075),
                                    ("Rosh Hashanahyear (latent)", -5.541263545158426),
                                    ("Dhanterasyear (latent)", -6.234410725718371),
                                    ("Tu BiShvatyear (latent)", -6.234410725718371),
                                    ("<day-of-month> (ordinal)December", -5.541263545158426),
                                    ("Holiyear (latent)", -5.541263545158426),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.234410725718371),
                                    ("Holika Dahanyear (latent)", -5.541263545158426),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.234410725718371),
                                    ("dayminute", -3.3166399936340922),
                                    ("Mawlidyear (latent)", -6.234410725718371),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.8289456176102075),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.234410725718371),
                                    ("Jumu'atul-Widayear (latent)", -5.318119993844216),
                                    ("minuteday", -2.4057693292292766),
                                    ("absorption of , after named dayintersect",
                                     -6.234410725718371),
                                    ("intersectyear (latent)", -5.8289456176102075),
                                    ("Orthodox Easter Sundayyear (latent)", -6.234410725718371),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.234410725718371),
                                    ("Boss's Dayyear (latent)", -5.8289456176102075),
                                    ("Global Youth Service Dayyear (latent)", -6.234410725718371),
                                    ("Dhanterasin|during <named-month>|year", -6.234410725718371),
                                    ("Tisha B'Avyear (latent)", -6.234410725718371),
                                    ("Isra and Mi'rajyear (latent)", -5.318119993844216),
                                    ("at <time-of-day>on <day>", -5.135798437050262),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.234410725718371),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.541263545158426),
                                    ("Christmasyear (latent)", -5.8289456176102075),
                                    ("Naraka Chaturdashiyear (latent)", -5.8289456176102075),
                                    ("Thai Pongalin|during <named-month>|year", -6.234410725718371),
                                    ...
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.8289456176102075),
                                    ("Hanukkahyear (latent)", -5.541263545158426),
                                    ("February<time> <part-of-day>", -6.234410725718371),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.234410725718371),
                                    ("Great Lentyear (latent)", -6.234410725718371),
                                    ("tomorrowat <time-of-day>", -5.541263545158426),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.234410725718371),
                                    ("Vaisakhiyear (latent)", -5.541263545158426),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.234410725718371),
                                    ("last <cycle> of <time>year (latent)", -5.541263545158426),
                                    ("at <time-of-day>tomorrow", -5.8289456176102075),
                                    ("tomorrow<time-of-day> am|pm", -6.234410725718371),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.234410725718371),
                                    ("Diwaliyear (latent)", -6.234410725718371),
                                    ("between <time> and <time>on <day>", -4.624972813284271),
                                    ("Black Fridayyear (latent)", -5.8289456176102075),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.234410725718371),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.234410725718371),
                                    ("Chhathyear (latent)", -5.8289456176102075),
                                    ("Vasant Panchamiyear (latent)", -6.234410725718371),
                                    ("St Patrick's Dayyear (latent)", -6.234410725718371),
                                    ("Thursday<time> (timezone)", -6.234410725718371),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.234410725718371),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.8289456176102075),
                                    ("Februaryintersect", -6.234410725718371),
                                    ("Simchat Torahyear (latent)", -6.234410725718371),
                                    ("minuteyear", -6.234410725718371)],
                               n = 386},
                   koData =
                     ClassData{prior = -0.9361721024279841, unseen = -6.616065185132817,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.2072280960083102, unseen = -5.056245805348308,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 152},
                   koData =
                     ClassData{prior = -1.6757605553651729,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
