...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.625776369444862, unseen = -5.805134968916488,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 330},
                   koData =
                     ClassData{prior = -0.7653868081457668, unseen = -5.666426688112432,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45584613240051675,
                               unseen = -6.777646593635117,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.083359811812238),
                                    ("Ramadanyear (latent)", -6.083359811812238),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.83059684331687),
                                    ("Bhai Doojyear (latent)", -6.083359811812238),
                                    ("hourday", -4.378611719573812),
                                    ("dayhour", -3.2211589308827695),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.83059684331687),
                                    ("Martin Luther King's Dayyear (latent)", -5.677894703704073),
                                    ("Shemini Atzeretyear (latent)", -6.083359811812238),
                                    ("daymonth", -5.1670690799380825),
                                    ("monthday", -5.677894703704073),
                                    ("monthyear", -4.291600342584183),
                                    ("yearhour", -5.677894703704073),
                                    ("Yom Ha'atzmautyear (latent)", -6.083359811812238),
                                    ("Vijayadashamiyear (latent)", -6.083359811812238),
                                    ("Thanksgiving Dayyear (latent)", -4.984747523144128),
                                    ("Thai Pongalyear (latent)", -5.390212631252292),
                                    ("Thiru Onamyear (latent)", -5.390212631252292),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.083359811812238),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.083359811812238),
                                    ("houryear", -5.390212631252292),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.083359811812238),
                                    ("Christmas<time-of-day> am|pm", -6.083359811812238),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.083359811812238),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.390212631252292),
                                    ("<time-of-day> am|pmintersect", -4.83059684331687),
                                    ("Earth Houryear (latent)", -6.083359811812238),
                                    ("Octoberyear (latent)", -4.579282415035964),
                                    ("intersect<time-of-day> am|pm", -6.083359811812238),
                                    ("Mattu Pongalyear (latent)", -6.083359811812238),
                                    ("Shavuotyear (latent)", -6.083359811812238),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.083359811812238),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.083359811812238),
                                    ("in|within|after <duration>at <time-of-day>",
                                     -6.083359811812238),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.677894703704073),
                                    ("Marchyear (latent)", -6.083359811812238),
                                    ("Sukkotyear (latent)", -5.677894703704073),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.083359811812238),
                                    ("Clean Mondayyear (latent)", -5.677894703704073),
                                    ("monthhour", -5.677894703704073),
                                    ("todayat <time-of-day>", -6.083359811812238),
                                    ("Thursday<time> timezone", -4.137449662756924),
                                    ("from|since|after <time>December", -6.083359811812238),
                                    ("<time-of-day> am|pmon <day>", -4.0684567912699725),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.083359811812238),
                                    ("yyyy-mm-ddhh:mm:ss", -5.677894703704073),
                                    ("dayday", -4.0684567912699725),
                                    ("<time> <part-of-day>at <time-of-day>", -6.083359811812238),
                                    ("mm/ddat <time-of-day>", -6.083359811812238),
                                    ("tonightat <time-of-day>", -6.083359811812238),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.390212631252292),
                                    ("today<time-of-day> am|pm", -6.083359811812238),
                                    ("Februarythe <day-of-month> (ordinal)", -5.677894703704073),
                                    ("at <time-of-day><time> <part-of-day>", -6.083359811812238),
                                    ("mm/dd<time-of-day> am|pm", -6.083359811812238),
                                    ("hourhour", -4.83059684331687),
                                    ("Navaratriin|during <named-month>|year", -6.083359811812238),
                                    ("Wednesdaythis|last|next <cycle>", -6.083359811812238),
                                    ("Lentyear (latent)", -6.083359811812238),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.579282415035964),
                                    ("Boghiyear (latent)", -6.083359811812238),
                                    ("dayyear", -2.0058223679065184),
                                    ("Thursdayfrom|since|after <time>", -5.677894703704073),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.083359811812238),
                                    ("Thursdayat <time-of-day>", -5.390212631252292),
                                    ("Islamic New Yearyear (latent)", -5.677894703704073),
                                    ("Laylat al-Qadryear (latent)", -5.1670690799380825),
                                    ("Shrove Tuesdayyear (latent)", -6.083359811812238),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.390212631252292),
                                    ("<time-of-day> am|pmtomorrow", -5.390212631252292),
                                    ("Yom Kippuryear (latent)", -6.083359811812238),
                                    ("<part-of-day> of <time>year (latent)", -6.083359811812238),
                                    ("minutehour", -5.1670690799380825),
                                    ("Kaanum Pongalyear (latent)", -5.677894703704073),
                                    ("Maha Saptamiyear (latent)", -6.083359811812238),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.677894703704073),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.378611719573812),
                                    ("for <duration> from <time>December", -6.083359811812238),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.083359811812238),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.83059684331687),
                                    ("Pentecostyear (latent)", -6.083359811812238),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.83059684331687),
                                    ("Eid al-Fitryear (latent)", -6.083359811812238),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.083359811812238),
                                    ("Mondayin|during the <part-of-day>", -6.083359811812238),
                                    ("Chhathin|during <named-month>|year", -6.083359811812238),
                                    ("Diwaliin|during <named-month>|year", -6.083359811812238),
                                    ("Vaisakhiin|during <named-month>|year", -6.083359811812238),
                                    ("Raksha Bandhanyear (latent)", -6.083359811812238),
                                    ("daysecond", -5.677894703704073),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.677894703704073),
                                    ("Ashurayear (latent)", -6.083359811812238),
                                    ("Tuesdayin|during <named-month>|year", -6.083359811812238),
                                    ("Chinese New Yearyear (latent)", -6.083359811812238),
                                    ("Lag BaOmeryear (latent)", -6.083359811812238),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.083359811812238),
                                    ("Eid al-Adhayear (latent)", -5.1670690799380825),
                                    ("intersectin|during the <part-of-day>", -6.083359811812238),
                                    ("Palm Sundayyear (latent)", -6.083359811812238),
                                    ("Christmasat <time-of-day>", -6.083359811812238),
                                    ("Passoveryear (latent)", -6.083359811812238),
                                    ("Lazarus Saturdayyear (latent)", -6.083359811812238),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.677894703704073),
                                    ("Yom HaShoahyear (latent)", -5.677894703704073),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.677894703704073),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.083359811812238),
                                    ("Septemberyear (latent)", -5.677894703704073),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.579282415035964),
                                    ("Halloweenyear (latent)", -6.083359811812238),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.083359811812238),
                                    ("at <time-of-day>intersect", -5.677894703704073),
                                    ("Rosh Hashanahyear (latent)", -5.390212631252292),
                                    ("Dhanterasyear (latent)", -6.083359811812238),
                                    ("Tu BiShvatyear (latent)", -6.083359811812238),
                                    ("Holiyear (latent)", -5.390212631252292),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.083359811812238),
                                    ("Holika Dahanyear (latent)", -5.390212631252292),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.083359811812238),
                                    ("dayminute", -3.1655890797279587),
                                    ("Mawlidyear (latent)", -6.083359811812238),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.677894703704073),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.083359811812238),
                                    ("Jumu'atul-Widayear (latent)", -5.1670690799380825),
                                    ("minuteday", -2.445773652085852),
                                    ("absorption of , after named dayintersect",
                                     -6.083359811812238),
                                    ("in|within|after <duration><time-of-day> am|pm",
                                     -6.083359811812238),
                                    ("Orthodox Easter Sundayyear (latent)", -6.083359811812238),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.083359811812238),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.083359811812238),
                                    ("Boss's Dayyear (latent)", -5.677894703704073),
                                    ("Global Youth Service Dayyear (latent)", -6.083359811812238),
                                    ("Dhanterasin|during <named-month>|year", -6.083359811812238),
                                    ("Tisha B'Avyear (latent)", -6.083359811812238),
                                    ("Isra and Mi'rajyear (latent)", -5.1670690799380825),
                                    ("at <time-of-day>on <day>", -4.984747523144128),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.083359811812238),
                                    ("Christmasyear (latent)", -5.677894703704073),
                                    ("Naraka Chaturdashiyear (latent)", -5.677894703704073),
                                    ("Thai Pongalin|during <named-month>|year", -6.083359811812238),
                                    ("dayweek", -6.083359811812238),
                                    ("Easter Sundayyear (latent)", -5.390212631252292),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.473921899378137),
                                    ("weekyear", -4.984747523144128),
                                    ("hh:mmin|during the <part-of-day>", -5.390212631252292),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.677894703704073),
                                    ("Hanukkahyear (latent)", -5.390212631252292),
                                    ("February<time> <part-of-day>", -6.083359811812238),
                                    ("Great Lentyear (latent)", -6.083359811812238),
                                    ("tomorrowat <time-of-day>", -5.390212631252292),
                                    ("Vaisakhiyear (latent)", -5.390212631252292),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.083359811812238),
                                    ("last <cycle> of <time>year (latent)", -5.390212631252292),
                                    ("at <time-of-day>tomorrow", -5.677894703704073),
                                    ("tomorrow<time-of-day> am|pm", -6.083359811812238),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.083359811812238),
                                    ("Diwaliyear (latent)", -6.083359811812238),
                                    ("between <time> and <time>on <day>", -4.473921899378137),
                                    ("Black Fridayyear (latent)", -5.677894703704073),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.083359811812238),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.083359811812238),
                                    ("Chhathyear (latent)", -5.677894703704073),
                                    ("Vasant Panchamiyear (latent)", -6.083359811812238),
                                    ("St Patrick's Dayyear (latent)", -6.083359811812238),
                                    ("Thursday<time> (timezone)", -6.083359811812238),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.083359811812238),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.677894703704073),
                                    ("Februaryintersect", -6.083359811812238),
                                    ("Simchat Torahyear (latent)", -6.083359811812238),
                                    ("minuteyear", -6.083359811812238)],
                               n = 329},
                   koData =
                     ClassData{prior = -1.0048798110054025, unseen = -6.396929655216146,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.785823685681349),
                                    ("dayhour", -3.027965768128975),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.785823685681349),
                                    ("Tuesdayfrom|since|after <time>", -5.702114417555504),
                                    ("daymonth", -3.687211397013239),
                                    ("monthyear", -4.315820056435613),
                                    ("yearhour", -5.702114417555504),
                                    ("<time-of-day> am|pmyear (latent)", -5.0089672369955585),
                                    ("Thai Pongalyear (latent)", -5.0089672369955585),
                                    ("intersecthh:mm", -5.702114417555504),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.702114417555504),
                                    ("houryear", -4.603502128887395),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.702114417555504),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.0089672369955585),
                                    ("<time-of-day> am|pmintersect", -4.449351449060136),
                                    ("Octoberyear (latent)", -5.296649309447339),
                                    ("until <time>on <day>", -5.0089672369955585),
                                    ("in|within|after <duration>at <time-of-day>",
                                     -5.702114417555504),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.0089672369955585),
                                    ...
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.702114417555504),
                                    ("<time-of-day> am|pmon <day>", -4.449351449060136),
                                    ("Mondayyear (latent)", -5.0089672369955585),
                                    ("dayday", -5.296649309447339),
                                    ("mm/ddat <time-of-day>", -5.296649309447339),
                                    ("on <day>September", -5.296649309447339),
                                    ("dayyear", -2.8117426596593393),
                                    ...
                                    ("Thursdayat <time-of-day>", -4.092676505121403),
                                    ...
                                    ("week-endin|during <named-month>|year", -5.702114417555504),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.296649309447339),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.702114417555504),
                                    ("Sundayyear (latent)", -4.785823685681349),
                                    ("Christmasat <time-of-day>", -5.702114417555504),
                                    ("from|since|after <time>year (latent)", -4.603502128887395),
                                    ...
                                    ("hh:mmyear (latent)", -4.449351449060136),
                                    ("Holiyear (latent)", -5.702114417555504),
                                    ("until <time><time-of-day> am|pm", -5.702114417555504),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.702114417555504),
                                    ("dayminute", -3.137165060093967),
                                    ("yyyy-mm-ddhh:mm", -5.296649309447339),
                                    ...
                                    ("at <time-of-day>on <day>", -5.296649309447339),
                                    ("absorption of , after named daySeptember",
                                     -4.785823685681349),
                                    ("Naraka Chaturdashiyear (latent)", -5.702114417555504),
                                    ("from|since|after <time>on <day>", -4.785823685681349),
                                    ("dayweek", -5.702114417555504),
                                    ("Easter Sundayyear (latent)", -5.296649309447339),
                                    ("Thursday<time-of-day> am|pm", -4.449351449060136),
                                    ("weekyear", -5.296649309447339),
                                    ...
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.702114417555504),
                                    ("last <cycle> of <time>year (latent)", -5.296649309447339),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1590646946296874,
                               ...
                               n = 145},
                   koData =
                     ClassData{prior = -1.916922612182061, unseen = -3.4011973816621555,
                               likelihoods =
                                 HashMap.fromList
