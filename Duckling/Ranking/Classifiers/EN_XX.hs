...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6572812673714487, unseen = -5.916202062607435,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 369},
                   koData =
                     ClassData{prior = -0.7303474642460359, unseen = -5.84354441703136,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.49686727151528376,
                               unseen = -6.968850378341948,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.274762021241939),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.274762021241939),
                                    ("Ramadanyear (latent)", -5.358471289367784),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.259859000699674),
                                    ("Bhai Doojyear (latent)", -6.274762021241939),
                                    ("hourday", -4.259859000699674),
                                    ("dayhour", -3.3569912891576594),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.259859000699674),
                                    ("Martin Luther King's Dayyear (latent)", -5.869296913133774),
                                    ("Shemini Atzeretyear (latent)", -6.274762021241939),
                                    ("daymonth", -4.134695857745668),
                                    ("monthday", -5.869296913133774),
                                    ("monthyear", -4.402959844340347),
                                    ("Yom Ha'atzmautyear (latent)", -6.274762021241939),
                                    ("Vijayadashamiyear (latent)", -6.274762021241939),
                                    ("Thanksgiving Dayyear (latent)", -5.176149732573829),
                                    ("Thai Pongalyear (latent)", -5.581614840681993),
                                    ("Thiru Onamyear (latent)", -5.581614840681993),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.274762021241939),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.358471289367784),
                                    ("<day-of-month> (ordinal)Wednesday", -6.274762021241939),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.274762021241939),
                                    ("houryear", -5.358471289367784),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.274762021241939),
                                    ("Christmas<time-of-day> am|pm", -6.274762021241939),
                                    ("<day-of-month> (ordinal)October", -6.274762021241939),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.274762021241939),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.581614840681993),
                                    ("intersectin|during <named-month>|year", -6.274762021241939),
                                    ("<time-of-day> am|pmintersect", -5.021999052746571),
                                    ("Earth Houryear (latent)", -6.274762021241939),
                                    ("Octoberyear (latent)", -4.665324108807838),
                                    ("intersect<time-of-day> am|pm", -6.274762021241939),
                                    ("Mattu Pongalyear (latent)", -6.274762021241939),
                                    ("Shavuotyear (latent)", -6.274762021241939),
                                    ("Parsi New Yearyear (latent)", -5.358471289367784),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.274762021241939),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.274762021241939),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.869296913133774),
                                    ("Marchyear (latent)", -6.274762021241939),
                                    ("Sukkotyear (latent)", -5.869296913133774),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.869296913133774),
                                    ("Clean Mondayyear (latent)", -5.869296913133774),
                                    ("monthhour", -5.869296913133774),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.581614840681993),
                                    ("todayat <time-of-day>", -6.274762021241939),
                                    ("Thursday<time> timezone", -4.328851872186625),
                                    ("time-of-day (latent)tonight", -5.869296913133774),
                                    ("from|since|after <time>December", -6.274762021241939),
                                    ("<time-of-day> am|pmon <day>", -4.259859000699674),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.274762021241939),
                                    ("yyyy-mm-ddhh:mm:ss", -5.869296913133774),
                                    ("dayday", -3.8324149858727345),
                                    ("<time> <part-of-day>at <time-of-day>", -6.274762021241939),
                                    ("mm/ddat <time-of-day>", -6.274762021241939),
                                    ("tonightat <time-of-day>", -6.274762021241939),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.581614840681993),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.274762021241939),
                                    ("today<time-of-day> am|pm", -6.274762021241939),
                                    ("Februarythe <day-of-month> (ordinal)", -5.869296913133774),
                                    ("at <time-of-day><time> <part-of-day>", -6.274762021241939),
                                    ("<day-of-month> (ordinal)intersect", -5.581614840681993),
                                    ("mm/dd<time-of-day> am|pm", -6.274762021241939),
                                    ("hourhour", -4.195320479562103),
                                    ("Navaratriin|during <named-month>|year", -6.274762021241939),
                                    ("Wednesdaythis|last|next <cycle>", -6.274762021241939),
                                    ("Lentyear (latent)", -6.274762021241939),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.770684624465665),
                                    ("Boghiyear (latent)", -6.274762021241939),
                                    ("dayyear", -2.019149311423716),
                                    ("Thursdayfrom|since|after <time>", -5.869296913133774),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.274762021241939),
                                    ("Thursdayat <time-of-day>", -5.581614840681993),
                                    ("Islamic New Yearyear (latent)", -5.869296913133774),
                                    ("Laylat al-Qadryear (latent)", -5.358471289367784),
                                    ("Shrove Tuesdayyear (latent)", -6.274762021241939),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.581614840681993),
                                    ("<time-of-day> am|pmtomorrow", -5.581614840681993),
                                    ("Yom Kippuryear (latent)", -6.274762021241939),
                                    ("<day-of-month> (ordinal)Tuesday", -5.869296913133774),
                                    ("<part-of-day> of <time>year (latent)", -6.274762021241939),
                                    ("minutehour", -5.176149732573829),
                                    ("Kaanum Pongalyear (latent)", -5.869296913133774),
                                    ("Maha Saptamiyear (latent)", -6.274762021241939),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.869296913133774),
                                    ("time-of-day (latent)tomorrow", -5.358471289367784),
                                    ("part of daysat <time-of-day>", -5.869296913133774),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.5700139290035136),
                                    ("for <duration> from <time>December", -6.274762021241939),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.274762021241939),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.021999052746571),
                                    ("time-of-day (latent)this <part-of-day>", -6.274762021241939),
                                    ("Pentecostyear (latent)", -6.274762021241939),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.021999052746571),
                                    ("<day-of-month> (ordinal)February", -6.274762021241939),
                                    ("Eid al-Fitryear (latent)", -5.358471289367784),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.274762021241939),
                                    ("Mondayin|during the <part-of-day>", -6.274762021241939),
                                    ("Chhathin|during <named-month>|year", -6.274762021241939),
                                    ("Diwaliin|during <named-month>|year", -6.274762021241939),
                                    ("Vaisakhiin|during <named-month>|year", -6.274762021241939),
                                    ("Raksha Bandhanyear (latent)", -6.274762021241939),
                                    ("daysecond", -5.869296913133774),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.869296913133774),
                                    ("Ashurayear (latent)", -6.274762021241939),
                                    ("Tuesdayin|during <named-month>|year", -6.274762021241939),
                                    ("Chinese New Yearyear (latent)", -6.274762021241939),
                                    ("tomorrowintersect", -6.274762021241939),
                                    ("Lag BaOmeryear (latent)", -6.274762021241939),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.274762021241939),
                                    ("Eid al-Adhayear (latent)", -5.358471289367784),
                                    ("intersectin|during the <part-of-day>", -6.274762021241939),
                                    ("Palm Sundayyear (latent)", -6.274762021241939),
                                    ("Christmasat <time-of-day>", -6.274762021241939),
                                    ("Passoveryear (latent)", -6.274762021241939),
                                    ("Lazarus Saturdayyear (latent)", -6.274762021241939),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.869296913133774),
                                    ("Yom HaShoahyear (latent)", -5.869296913133774),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.869296913133774),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.274762021241939),
                                    ("Septemberyear (latent)", -5.869296913133774),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.770684624465665),
                                    ("Halloweenyear (latent)", -6.274762021241939),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.274762021241939),
                                    ("at <time-of-day>intersect", -5.869296913133774),
                                    ("Rosh Hashanahyear (latent)", -5.581614840681993),
                                    ("Dhanterasyear (latent)", -6.274762021241939),
                                    ("Tu BiShvatyear (latent)", -6.274762021241939),
                                    ("<day-of-month> (ordinal)December", -5.581614840681993),
                                    ("Holiyear (latent)", -5.581614840681993),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.274762021241939),
                                    ("Holika Dahanyear (latent)", -5.581614840681993),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.274762021241939),
                                    ("dayminute", -3.3569912891576594),
                                    ("Mawlidyear (latent)", -6.274762021241939),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.869296913133774),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.274762021241939),
                                    ("Jumu'atul-Widayear (latent)", -5.358471289367784),
                                    ("minuteday", -2.4461206247528438),
                                    ("absorption of , after named dayintersect",
                                     -6.274762021241939),
                                    ("intersectyear (latent)", -5.869296913133774),
                                    ("Orthodox Easter Sundayyear (latent)", -6.274762021241939),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.274762021241939),
                                    ("Boss's Dayyear (latent)", -5.869296913133774),
                                    ("Global Youth Service Dayyear (latent)", -6.274762021241939),
                                    ("Dhanterasin|during <named-month>|year", -6.274762021241939),
                                    ("Tisha B'Avyear (latent)", -6.274762021241939),
                                    ("Isra and Mi'rajyear (latent)", -5.358471289367784),
                                    ("at <time-of-day>on <day>", -5.176149732573829),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.274762021241939),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.581614840681993),
                                    ("Christmasyear (latent)", -5.869296913133774),
                                    ("Naraka Chaturdashiyear (latent)", -5.869296913133774),
                                    ("Thai Pongalin|during <named-month>|year", -6.274762021241939),
                                    ("dayweek", -6.274762021241939),
                                    ("Easter Sundayyear (latent)", -5.581614840681993),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.665324108807838),
                                    ("weekyear", -5.176149732573829),
                                    ("King's Dayyear (latent)", -4.770684624465665),
                                    ("hh:mmin|during the <part-of-day>", -5.581614840681993),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.869296913133774),
                                    ("Hanukkahyear (latent)", -5.581614840681993),
                                    ("February<time> <part-of-day>", -6.274762021241939),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.274762021241939),
                                    ("Great Lentyear (latent)", -6.274762021241939),
                                    ("tomorrowat <time-of-day>", -5.581614840681993),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.274762021241939),
                                    ("Vaisakhiyear (latent)", -5.581614840681993),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.274762021241939),
                                    ("last <cycle> of <time>year (latent)", -5.581614840681993),
                                    ("at <time-of-day>tomorrow", -5.869296913133774),
                                    ("tomorrow<time-of-day> am|pm", -6.274762021241939),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.274762021241939),
                                    ("Diwaliyear (latent)", -6.274762021241939),
                                    ("between <time> and <time>on <day>", -4.665324108807838),
                                    ("Black Fridayyear (latent)", -5.869296913133774),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.274762021241939),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.274762021241939),
                                    ("Chhathyear (latent)", -5.869296913133774),
                                    ("Vasant Panchamiyear (latent)", -6.274762021241939),
                                    ("St Patrick's Dayyear (latent)", -6.274762021241939),
                                    ("Thursday<time> (timezone)", -6.274762021241939),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.274762021241939),
                                    ("<datetime> - <datetime> (interval)July", -5.869296913133774),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.869296913133774),
                                    ("Februaryintersect", -6.274762021241939),
                                    ("Simchat Torahyear (latent)", -6.274762021241939),
                                    ("minuteyear", -6.274762021241939)],
                               n = 404},
                   koData =
                     ClassData{prior = -0.9376005184609062, unseen = -6.652863029353347,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.250374491927572),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.958424693029782),
                                    ("<day-of-month> (ordinal)August", -5.958424693029782),
                                    ("dayhour", -3.284276043603253),
                                    ("<time> timezoneyear (latent)", -5.958424693029782),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.042133961155627),
                                    ("Tuesdayfrom|since|after <time>", -5.958424693029782),
                                    ("daymonth", -3.4735180432417816),
                                    ("monthyear", -4.705661724534414),
                                    ("<time-of-day> am|pmyear (latent)", -5.2652775124698366),
                                    ("Thai Pongalyear (latent)", -5.2652775124698366),
                                    ("intersecthh:mm", -5.958424693029782),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.552959584921617),
                                    ("<day-of-month> (ordinal)Wednesday", -5.958424693029782),
                                    ("houryear", -4.572130331909891),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.958424693029782),
                                    ("<day-of-month> (ordinal)October", -5.958424693029782),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.2652775124698366),
                                    ("<time-of-day> am|pmintersect", -4.705661724534414),
                                    ("Octoberyear (latent)", -5.958424693029782),
                                    ("until <time>on <day>", -5.2652775124698366),
                                    ("time-of-day (latent)intersect", -5.958424693029782),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.2652775124698366),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.958424693029782),
                                    ("hh:mmon <day>", -3.5160776576605777),
                                    ("absorption of , after named dayJuly", -5.552959584921617),
                                    ("from|since|after <time>July", -5.552959584921617),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.042133961155627),
                                    ("Clean Mondayyear (latent)", -5.958424693029782),
                                    ("monthhour", -5.958424693029782),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.552959584921617),
                                    ("hourmonth", -4.08662251612819),
                                    ("todayat <time-of-day>", -5.958424693029782),
                                    ("from|since|after <time>December", -5.958424693029782),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.958424693029782),
                                    ("<time-of-day> am|pmon <day>", -4.705661724534414),
                                    ("Mondayyear (latent)", -5.2652775124698366),
                                    ("dayday", -4.572130331909891),
                                    ("mm/ddat <time-of-day>", -5.552959584921617),
                                    ("on <day>September", -5.552959584921617),
                                    ("time-of-day (latent)September", -5.552959584921617),
                                    ("hourhour", -5.958424693029782),
                                    ("time-of-day (latent)on <day>", -3.5160776576605777),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.552959584921617),
                                    ("dayyear", -3.0139857138633412),
                                    ("Thursdaymm/dd", -5.958424693029782),
                                    ("New Year's Dayyear (latent)", -5.042133961155627),
                                    ("Thursdayfrom|since|after <time>", -4.253676600791357),
                                    ("Thursdayat <time-of-day>", -4.3489867805956814),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.958424693029782),
                                    ("Aprilyear (latent)", -5.958424693029782),
                                    ("the <day-of-month> (ordinal)July", -5.958424693029782),
                                    ("the <day-of-month> (number)July", -5.958424693029782),
                                    ("monthminute", -5.958424693029782),
                                    ("<time-of-day> am|pmtomorrow", -5.958424693029782),
                                    ("Thursdayhh:mm", -5.042133961155627),
                                    ("<day-of-month> (ordinal)Tuesday", -5.552959584921617),
                                    ("minutemonth", -4.08662251612819),
                                    ("minutehour", -5.958424693029782),
                                    ("Augustyear (latent)", -5.552959584921617),
                                    ("week-endin|during <named-month>|year", -5.958424693029782),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.552959584921617),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.958424693029782),
                                    ("Sundayyear (latent)", -5.042133961155627),
                                    ("Christmasat <time-of-day>", -5.958424693029782),
                                    ("from|since|after <time>year (latent)", -4.859812404361672),
                                    ("<duration> after|before|from <time>December",
                                     -5.958424693029782),
                                    ("yesterday<time-of-day> am|pm", -5.958424693029782),
                                    ("<day-of-month> (ordinal)July", -5.2652775124698366),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.958424693029782),
                                    ("mm/ddyear (latent)", -5.958424693029782),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.958424693029782),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.958424693029782),
                                    ("at <time-of-day>intersect", -5.552959584921617),
                                    ("hh:mmyear (latent)", -3.8789831513499458),
                                    ("Holiyear (latent)", -5.958424693029782),
                                    ("until <time><time-of-day> am|pm", -5.958424693029782),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.958424693029782),
                                    ("dayminute", -3.393475335568245),
                                    ("yyyy-mm-ddhh:mm", -5.552959584921617),
                                    ("intersectSeptember", -4.454347296253507),
                                    ("minuteday", -2.719746240865401),
                                    ("absorption of , after named dayintersect",
                                     -5.958424693029782),
                                    ("intersectyear (latent)", -5.958424693029782),
                                    ("Februaryin|during the <part-of-day>", -5.958424693029782),
                                    ("time-of-day (latent)July", -5.2652775124698366),
                                    ("Saturdayyear (latent)", -5.958424693029782),
                                    ("at <time-of-day>on <day>", -5.552959584921617),
                                    ("absorption of , after named daySeptember",
                                     -5.042133961155627),
                                    ("Naraka Chaturdashiyear (latent)", -5.958424693029782),
                                    ("from|since|after <time>on <day>", -5.042133961155627),
                                    ("dayweek", -5.958424693029782),
                                    ("Easter Sundayyear (latent)", -5.552959584921617),
                                    ("Thursday<time-of-day> am|pm", -4.705661724534414),
                                    ("weekyear", -5.552959584921617),
                                    ("time-of-day (latent)Thursday", -5.552959584921617),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.958424693029782),
                                    ("<day-of-month> (ordinal)April", -5.958424693029782),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.552959584921617),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.2652775124698366),
                                    ("Sundayfrom|since|after <time>", -5.958424693029782),
                                    ("absorption of , after named dayFebruary", -5.042133961155627),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.958424693029782),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.958424693029782),
                                    ("tomorrowat <time-of-day>", -5.958424693029782),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.552959584921617),
                                    ("last <cycle> of <time>year (latent)", -5.552959584921617),
                                    ("tomorrow<time-of-day> am|pm", -5.958424693029782),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.2652775124698366),
                                    ("Diwaliyear (latent)", -5.552959584921617),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.958424693029782),
                                    ("Fridayyear (latent)", -5.552959584921617),
                                    ("time-of-day (latent)April", -5.958424693029782),
                                    ("minuteyear", -3.7612001156935624)],
                               n = 260}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.19237189264745613,
                               ...
                               n = 165},
                   koData =
                     ClassData{prior = -1.742969305058623, unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
