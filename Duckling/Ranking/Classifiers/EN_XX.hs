...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6993777303105814, unseen = -5.488937726156687,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 240},
                   koData =
                     ClassData{prior = -0.6869552103120243,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4906229164484712, unseen = -6.582025138892826,
                               likelihoods =
                                 HashMap.fromList
                                   [("Ramadanyear (latent)", -5.887491956725004),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.634728988229636),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.634728988229636),
                                    ("hourday", -4.182743864486579),
                                    ("dayhour", -2.9697212246407245),
                                    ("Martin Luther King's Dayyear (latent)", -5.482026848616839),
                                    ("Shemini Atzeretyear (latent)", -5.887491956725004),
                                    ("daymonth", -5.1943447761650585),
                                    ("monthday", -5.482026848616839),
                                    ("monthyear", -4.278054044290903),
                                    ("Yom Ha'atzmautyear (latent)", -5.887491956725004),
                                    ("Thanksgiving Dayyear (latent)", -4.788879668056894),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.887491956725004),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.887491956725004),
                                    ("houryear", -5.482026848616839),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.887491956725004),
                                    ("Christmas<time-of-day> am|pm", -5.887491956725004),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.887491956725004),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.1943447761650585),
                                    ("<time-of-day> am|pmintersect", -4.634728988229636),
                                    ("Octoberyear (latent)", -4.634728988229636),
                                    ("intersect<time-of-day> am|pm", -5.887491956725004),
                                    ("Shavuotyear (latent)", -5.887491956725004),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.887491956725004),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.482026848616839),
                                    ("Marchyear (latent)", -5.887491956725004),
                                    ("Sukkotyear (latent)", -5.482026848616839),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.887491956725004),
                                    ("Clean Mondayyear (latent)", -5.482026848616839),
                                    ("monthhour", -5.482026848616839),
                                    ("todayat <time-of-day>", -5.887491956725004),
                                    ("Thursday<time> timezone", -4.182743864486579),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.887491956725004),
                                    ("Palm SundaySunday", -5.482026848616839),
                                    ("dayday", -3.6902673793887844),
                                    ("<time> <part-of-day>at <time-of-day>", -5.887491956725004),
                                    ("mm/ddat <time-of-day>", -5.887491956725004),
                                    ("tonightat <time-of-day>", -5.887491956725004),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.1943447761650585),
                                    ("today<time-of-day> am|pm", -5.887491956725004),
                                    ("Februarythe <day-of-month> (ordinal)", -5.482026848616839),
                                    ("at <time-of-day><time> <part-of-day>", -5.887491956725004),
                                    ("mm/dd<time-of-day> am|pm", -5.887491956725004),
                                    ("hourhour", -4.634728988229636),
                                    ("<time-of-day> am|pmon <date>", -3.872588936182739),
                                    ("Wednesdaythis|last|next <cycle>", -5.887491956725004),
                                    ("Lentyear (latent)", -5.887491956725004),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.383414559948729),
                                    ("dayyear", -2.2631510237486387),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.887491956725004),
                                    ("Thursdayat <time-of-day>", -5.482026848616839),
                                    ("Islamic New Yearyear (latent)", -5.482026848616839),
                                    ("Laylat al-Qadryear (latent)", -4.971201224850849),
                                    ("Shrove Tuesdayyear (latent)", -5.887491956725004),
                                    ("<time-of-day> am|pmtomorrow", -5.1943447761650585),
                                    ("Yom Kippuryear (latent)", -5.887491956725004),
                                    ("<part-of-day> of <time>year (latent)", -5.887491956725004),
                                    ("minutehour", -4.971201224850849),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.482026848616839),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.182743864486579),
                                    ("for <duration> from <time>December", -5.887491956725004),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.887491956725004),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.971201224850849),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.482026848616839),
                                    ("Pentecostyear (latent)", -5.887491956725004),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.971201224850849),
                                    ("Eid al-Fitryear (latent)", -5.887491956725004),
                                    ("Mondayin|during the <part-of-day>", -5.887491956725004),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.482026848616839),
                                    ("Ashurayear (latent)", -5.887491956725004),
                                    ("Chinese New Yearyear (latent)", -5.887491956725004),
                                    ("Sundayyear (latent)", -5.887491956725004),
                                    ("Lag BaOmeryear (latent)", -5.887491956725004),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.887491956725004),
                                    ("Eid al-Adhayear (latent)", -4.971201224850849),
                                    ("intersectin|during the <part-of-day>", -5.887491956725004),
                                    ("Christmasat <time-of-day>", -5.887491956725004),
                                    ("Passoveryear (latent)", -5.887491956725004),
                                    ("Lazarus Saturdayyear (latent)", -5.887491956725004),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.887491956725004),
                                    ("Yom HaShoahyear (latent)", -5.482026848616839),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.971201224850849),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.887491956725004),
                                    ("Septemberyear (latent)", -5.482026848616839),
                                    ("mm/ddyear (latent)", -5.887491956725004),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.634728988229636),
                                    ("Halloweenyear (latent)", -5.887491956725004),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.1943447761650585),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -4.971201224850849),
                                    ("at <time-of-day>intersect", -5.482026848616839),
                                    ("Rosh Hashanahyear (latent)", -5.887491956725004),
                                    ("Tu BiShvatyear (latent)", -5.887491956725004),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.887491956725004),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.887491956725004),
                                    ("dayminute", -3.248434627109745),
                                    ("Mawlidyear (latent)", -5.887491956725004),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.482026848616839),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.887491956725004),
                                    ("Jumu'atul-Widayear (latent)", -4.971201224850849),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.887491956725004),
                                    ("minuteday", -2.2499057969986183),
                                    ("absorption of , after named dayintersect",
                                     -5.887491956725004),
                                    ("intersectyear (latent)", -5.887491956725004),
                                    ("Orthodox Easter Sundayyear (latent)", -5.887491956725004),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.887491956725004),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.887491956725004),
                                    ("Boss's Dayyear (latent)", -5.482026848616839),
                                    ("Tisha B'Avyear (latent)", -5.887491956725004),
                                    ("Isra and Mi'rajyear (latent)", -4.971201224850849),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.887491956725004),
                                    ("Christmasyear (latent)", -5.482026848616839),
                                    ("at <time-of-day>on <date>", -4.788879668056894),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.278054044290903),
                                    ("dayweek", -5.887491956725004),
                                    ("Easter Sundayyear (latent)", -5.1943447761650585),
                                    ("Thursday<time-of-day> am|pm", -5.887491956725004),
                                    ("weekyear", -5.482026848616839),
                                    ("hh:mmin|during the <part-of-day>", -5.1943447761650585),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.482026848616839),
                                    ("Hanukkahyear (latent)", -5.887491956725004),
                                    ("February<time> <part-of-day>", -5.887491956725004),
                                    ("Tuesdayin <named-month>|year", -5.887491956725004),
                                    ("Great Lentyear (latent)", -5.887491956725004),
                                    ("tomorrowat <time-of-day>", -5.1943447761650585),
                                    ("between <time> and <time>on <date>", -4.278054044290903),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.1943447761650585),
                                    ("last <cycle> of <time>year (latent)", -5.1943447761650585),
                                    ("at <time-of-day>tomorrow", -5.482026848616839),
                                    ("tomorrow<time-of-day> am|pm", -5.887491956725004),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.887491956725004),
                                    ("Black Fridayyear (latent)", -5.482026848616839),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.887491956725004),
                                    ("Palm Sundayintersect", -5.887491956725004),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.887491956725004),
                                    ("Februaryintersect", -5.887491956725004),
                                    ("Simchat Torahyear (latent)", -5.887491956725004)],
                               n = 270},
                   koData =
                     ClassData{prior = -0.9473813189441862, unseen = -6.261491684321042,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.566434283504978),
                                    ...
                                    ("mm/ddat <time-of-day>", -5.160969175396813),
                                    ("<time-of-day> am|pmon <date>", -4.31367131500961),
                                    ("dayyear", -2.7938455612651962),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.650143551630823),
                                    ("mm/ddyear (latent)", -5.566434283504978),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.160969175396813),
