...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6419920172590154, unseen = -5.948034989180646,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 381},
                   koData =
                     ClassData{prior = -0.7470609452197765, unseen = -5.84354441703136,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48550781578170077,
                               unseen = -6.9930151229329605,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.298949246855942),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.298949246855942),
                                    ("Ramadanyear (latent)", -5.382658514981787),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.284046226313678),
                                    ("Bhai Doojyear (latent)", -6.298949246855942),
                                    ("hourday", -4.284046226313678),
                                    ("dayhour", -3.3811785147716638),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.284046226313678),
                                    ("Martin Luther King's Dayyear (latent)", -5.8934841387477785),
                                    ("Shemini Atzeretyear (latent)", -6.298949246855942),
                                    ("daymonth", -4.1588830833596715),
                                    ("monthday", -5.8934841387477785),
                                    ("monthyear", -4.427147069954351),
                                    ("Yom Ha'atzmautyear (latent)", -6.298949246855942),
                                    ("Vijayadashamiyear (latent)", -6.298949246855942),
                                    ("Thanksgiving Dayyear (latent)", -5.200336958187833),
                                    ("Thai Pongalyear (latent)", -5.605802066295998),
                                    ("Thiru Onamyear (latent)", -5.605802066295998),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.298949246855942),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.382658514981787),
                                    ("<day-of-month> (ordinal)Wednesday", -6.298949246855942),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.298949246855942),
                                    ("houryear", -5.382658514981787),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.298949246855942),
                                    ("Christmas<time-of-day> am|pm", -6.298949246855942),
                                    ("<day-of-month> (ordinal)October", -6.298949246855942),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.298949246855942),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.605802066295998),
                                    ("intersectin|during <named-month>|year", -6.298949246855942),
                                    ("<time-of-day> am|pmintersect", -5.046186278360575),
                                    ("Earth Houryear (latent)", -6.298949246855942),
                                    ("Octoberyear (latent)", -4.689511334421843),
                                    ("intersect<time-of-day> am|pm", -6.298949246855942),
                                    ("Mattu Pongalyear (latent)", -6.298949246855942),
                                    ("Shavuotyear (latent)", -6.298949246855942),
                                    ("Parsi New Yearyear (latent)", -5.382658514981787),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.298949246855942),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.298949246855942),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.8934841387477785),
                                    ("Marchyear (latent)", -6.298949246855942),
                                    ("Sukkotyear (latent)", -5.8934841387477785),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.8934841387477785),
                                    ("Clean Mondayyear (latent)", -5.8934841387477785),
                                    ("monthhour", -5.8934841387477785),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.605802066295998),
                                    ("todayat <time-of-day>", -6.298949246855942),
                                    ("Thursday<time> timezone", -4.35303909780063),
                                    ("time-of-day (latent)tonight", -5.8934841387477785),
                                    ("from|since|after <time>December", -6.298949246855942),
                                    ("<time-of-day> am|pmon <day>", -4.284046226313678),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.298949246855942),
                                    ("yyyy-mm-ddhh:mm:ss", -5.8934841387477785),
                                    ("dayday", -3.856602211486738),
                                    ("<time> <part-of-day>at <time-of-day>", -6.298949246855942),
                                    ("mm/ddat <time-of-day>", -6.298949246855942),
                                    ("tonightat <time-of-day>", -6.298949246855942),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.605802066295998),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.298949246855942),
                                    ("today<time-of-day> am|pm", -6.298949246855942),
                                    ("Februarythe <day-of-month> (ordinal)", -5.8934841387477785),
                                    ("at <time-of-day><time> <part-of-day>", -6.298949246855942),
                                    ("<day-of-month> (ordinal)intersect", -5.605802066295998),
                                    ("mm/dd<time-of-day> am|pm", -6.298949246855942),
                                    ("hourhour", -4.219507705176107),
                                    ("Navaratriin|during <named-month>|year", -6.298949246855942),
                                    ("Wednesdaythis|last|next <cycle>", -6.298949246855942),
                                    ("Lentyear (latent)", -6.298949246855942),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.7948718500796685),
                                    ("Boghiyear (latent)", -6.298949246855942),
                                    ("dayyear", -1.9616585060234524),
                                    ("Thursdayfrom|since|after <time>", -5.8934841387477785),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.298949246855942),
                                    ("Thursdayat <time-of-day>", -5.605802066295998),
                                    ("Islamic New Yearyear (latent)", -5.8934841387477785),
                                    ("Laylat al-Qadryear (latent)", -5.382658514981787),
                                    ("Shrove Tuesdayyear (latent)", -6.298949246855942),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.605802066295998),
                                    ("<time-of-day> am|pmtomorrow", -5.605802066295998),
                                    ("Yom Kippuryear (latent)", -6.298949246855942),
                                    ("<day-of-month> (ordinal)Tuesday", -5.8934841387477785),
                                    ("<part-of-day> of <time>year (latent)", -6.298949246855942),
                                    ("minutehour", -5.200336958187833),
                                    ("Kaanum Pongalyear (latent)", -5.8934841387477785),
                                    ("Maha Saptamiyear (latent)", -6.298949246855942),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.8934841387477785),
                                    ("time-of-day (latent)tomorrow", -5.382658514981787),
                                    ("part of daysat <time-of-day>", -5.8934841387477785),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.594201154617517),
                                    ("for <duration> from <time>December", -6.298949246855942),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.298949246855942),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.046186278360575),
                                    ("time-of-day (latent)this <part-of-day>", -6.298949246855942),
                                    ("Pentecostyear (latent)", -6.298949246855942),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.046186278360575),
                                    ("<day-of-month> (ordinal)February", -6.298949246855942),
                                    ("Eid al-Fitryear (latent)", -5.382658514981787),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.298949246855942),
                                    ("Mondayin|during the <part-of-day>", -6.298949246855942),
                                    ("Chhathin|during <named-month>|year", -6.298949246855942),
                                    ("Diwaliin|during <named-month>|year", -6.298949246855942),
                                    ("Vaisakhiin|during <named-month>|year", -6.298949246855942),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.046186278360575),
                                    ("Raksha Bandhanyear (latent)", -6.298949246855942),
                                    ("daysecond", -5.8934841387477785),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.8934841387477785),
                                    ("Ashurayear (latent)", -6.298949246855942),
                                    ("Tuesdayin|during <named-month>|year", -6.298949246855942),
                                    ("Chinese New Yearyear (latent)", -6.298949246855942),
                                    ("tomorrowintersect", -6.298949246855942),
                                    ("Lag BaOmeryear (latent)", -6.298949246855942),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.298949246855942),
                                    ("Eid al-Adhayear (latent)", -5.382658514981787),
                                    ("intersectin|during the <part-of-day>", -6.298949246855942),
                                    ("Palm Sundayyear (latent)", -6.298949246855942),
                                    ("Christmasat <time-of-day>", -6.298949246855942),
                                    ("Passoveryear (latent)", -6.298949246855942),
                                    ("Lazarus Saturdayyear (latent)", -6.298949246855942),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.8934841387477785),
                                    ("Yom HaShoahyear (latent)", -5.8934841387477785),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.8934841387477785),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.298949246855942),
                                    ("Septemberyear (latent)", -5.8934841387477785),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.7948718500796685),
                                    ("Halloweenyear (latent)", -6.298949246855942),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.298949246855942),
                                    ("at <time-of-day>intersect", -5.8934841387477785),
                                    ("Rosh Hashanahyear (latent)", -5.605802066295998),
                                    ("Dhanterasyear (latent)", -6.298949246855942),
                                    ("Tu BiShvatyear (latent)", -6.298949246855942),
                                    ("<day-of-month> (ordinal)December", -5.605802066295998),
                                    ("Holiyear (latent)", -5.605802066295998),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.298949246855942),
                                    ("Holika Dahanyear (latent)", -5.605802066295998),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.298949246855942),
                                    ("dayminute", -3.3811785147716638),
                                    ("Mawlidyear (latent)", -6.298949246855942),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.8934841387477785),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.298949246855942),
                                    ("Jumu'atul-Widayear (latent)", -5.382658514981787),
                                    ("minuteday", -2.4703078503668476),
                                    ("absorption of , after named dayintersect",
                                     -6.298949246855942),
                                    ("intersectyear (latent)", -5.8934841387477785),
                                    ("Orthodox Easter Sundayyear (latent)", -6.298949246855942),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.298949246855942),
                                    ("Boss's Dayyear (latent)", -5.8934841387477785),
                                    ("Global Youth Service Dayyear (latent)", -6.298949246855942),
                                    ("Dhanterasin|during <named-month>|year", -6.298949246855942),
                                    ("Tisha B'Avyear (latent)", -6.298949246855942),
                                    ("Isra and Mi'rajyear (latent)", -5.382658514981787),
                                    ("at <time-of-day>on <day>", -5.200336958187833),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.298949246855942),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.605802066295998),
                                    ("Christmasyear (latent)", -5.8934841387477785),
                                    ("Naraka Chaturdashiyear (latent)", -5.8934841387477785),
                                    ("Thai Pongalin|during <named-month>|year", -6.298949246855942),
                                    ("dayweek", -6.298949246855942),
                                    ("Easter Sundayyear (latent)", -5.605802066295998),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.689511334421843),
                                    ("weekyear", -5.200336958187833),
                                    ("King's Dayyear (latent)", -4.7948718500796685),
                                    ("hh:mmin|during the <part-of-day>", -5.605802066295998),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.8934841387477785),
                                    ("Hanukkahyear (latent)", -5.605802066295998),
                                    ("February<time> <part-of-day>", -6.298949246855942),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.298949246855942),
                                    ("Great Lentyear (latent)", -6.298949246855942),
                                    ("tomorrowat <time-of-day>", -5.605802066295998),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.298949246855942),
                                    ("Vaisakhiyear (latent)", -5.605802066295998),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.298949246855942),
                                    ("last <cycle> of <time>year (latent)", -5.605802066295998),
                                    ("at <time-of-day>tomorrow", -5.8934841387477785),
                                    ("tomorrow<time-of-day> am|pm", -6.298949246855942),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.298949246855942),
                                    ("Diwaliyear (latent)", -6.298949246855942),
                                    ("between <time> and <time>on <day>", -4.689511334421843),
                                    ("Black Fridayyear (latent)", -5.8934841387477785),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.298949246855942),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.298949246855942),
                                    ("Chhathyear (latent)", -5.8934841387477785),
                                    ("Vasant Panchamiyear (latent)", -6.298949246855942),
                                    ("Rabindra Jayantiyear (latent)", -5.046186278360575),
                                    ("St Patrick's Dayyear (latent)", -6.298949246855942),
                                    ("Thursday<time> (timezone)", -6.298949246855942),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.298949246855942),
                                    ("<datetime> - <datetime> (interval)July", -5.8934841387477785),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.8934841387477785),
                                    ("Februaryintersect", -6.298949246855942),
                                    ("Simchat Torahyear (latent)", -6.298949246855942),
                                    ("minuteyear", -6.298949246855942)],
                               n = 416},
                   koData =
                     ClassData{prior = -0.9555114450274363, unseen = -6.655440350367647,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.18043654209818333,
                               unseen = -5.204006687076795,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.371105734231172e-2),
                                    ("intersect 2 numbers", -3.8122026701459353)],
                               n = 177},
                   koData =
                     ClassData{prior = -1.8012382131825988,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
