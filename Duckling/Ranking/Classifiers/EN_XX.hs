...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5633158063873873, unseen = -6.220590170099739,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 501},
                   koData =
                     ClassData{prior = -0.8423857023898258, unseen = -5.942799375126701,
       ...
       ("<day-of-month> (ordinal or number) <named-month>",
        Classifier{okData =
                     ClassData{prior = -0.8649974374866046, unseen = -3.332204510175204,
                               likelihoods =
                                 HashMap.fromList
                                   [("ordinal (digits)October", -2.6026896854443837),
                                    ("ordinal (digits)December", -1.9095425048844386),
                                    ("ordinal (digits)February", -2.6026896854443837),
                                    ("integer (numeric)April", -2.6026896854443837),
                                    ("integer (numeric)February", -2.1972245773362196),
                   ...
                   koData =
                     ClassData{prior = -0.5465437063680699,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("ordinal (digits)October", -2.803360380906535),
                                    ("ordinal (digits)July", -2.1102132003465894),
                                    ("integer (numeric)September", -2.3978952727983707),
                                    ("ordinal (digits)August", -2.803360380906535),
                                    ("ordinal (digits)April", -2.803360380906535),
                                    ("month", -1.0116009116784799),
                                    ("integer (numeric)July", -2.1102132003465894)],
                               n = 11}}),
       ("<time> <part-of-day>",
        Classifier{okData =
       ...
       ("<day-of-month> (ordinal or number) of <named-month>",
        Classifier{okData =
                     ClassData{prior = -0.7949298748698876,
                               unseen = -3.6375861597263857,
                               likelihoods =
                                 HashMap.fromList
                                   [("ordinal (digits)July", -2.917770732084279),
                                    ("ordinals (first..twentieth,thirtieth,...)March",
                                     -1.8191584434161694),
                                    ("ordinal (digits)February", -2.917770732084279),
                                    ("integer (numeric)February", -2.001480000210124),
                                    ("month", -0.9028677115420143),
                                    ("ordinal (digits)March", -2.512305623976115),
                                    ("integer (numeric)July", -2.917770732084279)],
                               n = 14},
                   koData =
                     ClassData{prior = -0.6007738604289302, unseen = -3.784189633918261,
                               likelihoods =
                                 HashMap.fromList
                                   [("ordinal (digits)July", -1.8152899666382492),
                                    ("ordinal (digits)February", -3.068052935133617),
                                    ("integer (numeric)August", -3.068052935133617),
                                    ("month", -0.8708283577973976),
                                    ("integer (numeric)October", -2.662587827025453),
                                    ("integer (numeric)July", -1.6817585740137264)],
                               n = 17}}),
       ("this <part-of-day>",
        Classifier{okData =
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.7241574173025056, unseen = -4.867534450455582,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 127},
                   koData =
                     ClassData{prior = -0.6630697253226674, unseen = -4.927253685157205,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.14929630136246022),
