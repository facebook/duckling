...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5667760648397627, unseen = -6.212606095751519,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 497},
                   koData =
                     ClassData{prior = -0.8378298858539651, unseen = -5.942799375126701,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45216128863385024,
                               unseen = -7.195187320178708,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.501289670540389),
                                    ("Karva Chauthyear (latent)", -6.501289670540389),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.501289670540389),
                                    ("Maha Shivaratriyear (latent)", -6.501289670540389),
                                    ("Ramadanyear (latent)", -5.248526702045021),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.1149953094204985),
                                    ("Bhai Doojyear (latent)", -6.501289670540389),
                                    ("hourday", -4.486386649998124),
                                    ("dayhour", -3.4567672328169663),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.1149953094204985),
                                    ("Martin Luther King's Dayyear (latent)", -6.095824562432225),
                                    ("Shemini Atzeretyear (latent)", -6.501289670540389),
                                    ("daymonth", -4.3612235070441185),
                                    ("monthday", -6.095824562432225),
                                    ("monthyear", -4.6294874936387975),
                                    ("Yom Ha'atzmautyear (latent)", -6.501289670540389),
                                    ("Orthodox Good Fridayyear (latent)", -6.095824562432225),
                                    ("Vijayadashamiyear (latent)", -6.501289670540389),
                                    ("Thanksgiving Dayyear (latent)", -5.402677381872279),
                                    ("Thai Pongalyear (latent)", -5.808142489980444),
                                    ("Thiru Onamyear (latent)", -5.808142489980444),
                                    ("hhhmmabsorption of , after named day", -6.501289670540389),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.501289670540389),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.584998938666234),
                                    ("<day-of-month> (ordinal)Wednesday", -6.501289670540389),
                                    ("Krishna Janmashtamiyear (latent)", -6.095824562432225),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.501289670540389),
                                    ("houryear", -5.584998938666234),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.501289670540389),
                                    ("Christmas<time-of-day> am|pm", -6.501289670540389),
                                    ("<day-of-month> (ordinal)October", -6.501289670540389),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.501289670540389),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.808142489980444),
                                    ("intersectin|during <named-month>|year", -6.501289670540389),
                                    ("<time-of-day> am|pmintersect", -5.248526702045021),
                                    ("Earth Houryear (latent)", -6.501289670540389),
                                    ("Ganesh Chaturthiyear (latent)", -6.501289670540389),
                                    ("Octoberyear (latent)", -4.891851758106289),
                                    ("intersect<time-of-day> am|pm", -6.501289670540389),
                                    ("Mattu Pongalyear (latent)", -6.501289670540389),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.501289670540389),
                                    ("Shavuotyear (latent)", -6.501289670540389),
                                    ("Parsi New Yearyear (latent)", -5.584998938666234),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.501289670540389),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.501289670540389),
                                    ("todayin|within|after <duration>", -6.501289670540389),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.095824562432225),
                                    ("Marchyear (latent)", -6.501289670540389),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.095824562432225),
                                    ("Sukkotyear (latent)", -6.095824562432225),
                                    ("hhhmmintersect", -6.095824562432225),
                                    ...
                                    ("Thursday<time> timezone", -4.103394397742019),
                                    ("tonight<time-of-day> am|pm", -6.501289670540389),
                                    ("time-of-day (latent)tonight", -6.095824562432225),
                                    ("from|since|after <time>December", -6.501289670540389),
                                    ("<time-of-day> am|pmon <day>", -4.486386649998124),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.501289670540389),
                                    ("yyyy-mm-ddhh:mm:ss", -6.095824562432225),
                                    ("dayday", -3.7287009483006077),
                                    ("<time> <part-of-day>at <time-of-day>", -6.095824562432225),
                                    ("mm/ddat <time-of-day>", -5.808142489980444),
                                    ("tonightat <time-of-day>", -5.402677381872279),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.808142489980444),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.501289670540389),
                                    ("today<time-of-day> am|pm", -6.501289670540389),
                                    ("Februarythe <day-of-month> (ordinal)", -6.095824562432225),
                                    ("at <time-of-day><time> <part-of-day>", -6.501289670540389),
                                    ("<day-of-month> (ordinal)intersect", -5.808142489980444),
                                    ("mm/dd<time-of-day> am|pm", -6.501289670540389),
                                    ("hourhour", -3.530875204970688),
                                    ("Mahavir Jayantiyear (latent)", -6.095824562432225),
                                    ("Navaratriin|during <named-month>|year", -6.501289670540389),
                                    ("Wednesdaythis|last|next <cycle>", -6.501289670540389),
                                    ("Lentyear (latent)", -6.501289670540389),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.6294874936387975),
                                    ("Boghiyear (latent)", -6.501289670540389),
                                    ("dayyear", -1.906169820405799),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.501289670540389),
                                    ("Thursdayfrom|since|after <time>", -6.095824562432225),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.501289670540389),
                                    ("Thursdayat <time-of-day>", -5.808142489980444),
                                    ("Islamic New Yearyear (latent)", -6.095824562432225),
                                    ("Laylat al-Qadryear (latent)", -5.584998938666234),
                                    ("part of days<time-of-day> am|pm", -6.501289670540389),
                                    ("Shrove Tuesdayyear (latent)", -6.501289670540389),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.808142489980444),
                                    ("hourminute", -6.095824562432225),
                                    ("<time-of-day> am|pmtomorrow", -5.584998938666234),
                                    ("Yom Kippuryear (latent)", -6.501289670540389),
                                    ("<day-of-month> (ordinal)Tuesday", -5.808142489980444),
                                    ("<part-of-day> of <time>year (latent)", -6.501289670540389),
                                    ("minutehour", -5.248526702045021),
                                    ("Kaanum Pongalyear (latent)", -6.095824562432225),
                                    ("Maha Saptamiyear (latent)", -6.501289670540389),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.808142489980444),
                                    ("time-of-day (latent)tomorrow", -5.584998938666234),
                                    ("part of daysat <time-of-day>", -4.891851758106289),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.486386649998124),
                                    ("for <duration> from <time>December", -6.501289670540389),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.501289670540389),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.248526702045021),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.248526702045021),
                                    ("time-of-day (latent)this <part-of-day>", -6.501289670540389),
                                    ("Pentecostyear (latent)", -6.501289670540389),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.248526702045021),
                                    ("<day-of-month> (ordinal)February", -6.501289670540389),
                                    ("Eid al-Fitryear (latent)", -5.1149953094204985),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.501289670540389),
                                    ("Mondayin|during the <part-of-day>", -6.501289670540389),
                                    ("Chhathin|during <named-month>|year", -6.501289670540389),
                                    ("Diwaliin|during <named-month>|year", -6.501289670540389),
                                    ("this <part-of-day><time-of-day> am|pm", -6.501289670540389),
                                    ("Vaisakhiin|during <named-month>|year", -6.501289670540389),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.248526702045021),
                                    ("Raksha Bandhanyear (latent)", -6.501289670540389),
                                    ("daysecond", -6.095824562432225),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.095824562432225),
                                    ("Ratha-Yatrayear (latent)", -6.501289670540389),
                                    ("Ashurayear (latent)", -6.501289670540389),
                                    ("Tuesdayin|during <named-month>|year", -6.501289670540389),
                                    ("Chinese New Yearyear (latent)", -6.501289670540389),
                                    ("tomorrowintersect", -6.501289670540389),
                                    ("Lag BaOmeryear (latent)", -6.501289670540389),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.501289670540389),
                                    ("Eid al-Adhayear (latent)", -4.3612235070441185),
                                    ("intersectin|during the <part-of-day>", -6.501289670540389),
                                    ("Palm Sundayyear (latent)", -6.501289670540389),
                                    ("Christmasat <time-of-day>", -6.501289670540389),
                                    ("Passoveryear (latent)", -6.501289670540389),
                                    ("Lazarus Saturdayyear (latent)", -6.501289670540389),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.095824562432225),
                                    ("hhhmmon <day>", -5.584998938666234),
                                    ("Yom HaShoahyear (latent)", -6.095824562432225),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.095824562432225),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.501289670540389),
                                    ("Septemberyear (latent)", -6.095824562432225),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.997212273764115),
                                    ("Halloweenyear (latent)", -6.501289670540389),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.501289670540389),
                                    ("at <time-of-day>intersect", -5.584998938666234),
                                    ("Rosh Hashanahyear (latent)", -5.808142489980444),
                                    ("Dhanterasyear (latent)", -6.501289670540389),
                                    ("Tu BiShvatyear (latent)", -6.501289670540389),
                                    ("<day-of-month> (ordinal)December", -5.808142489980444),
                                    ("Holiyear (latent)", -5.808142489980444),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.501289670540389),
                                    ("Holika Dahanyear (latent)", -5.808142489980444),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.095824562432225),
                                    ("dayminute", -3.116899407194615),
                                    ("Mawlidyear (latent)", -6.501289670540389),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.095824562432225),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.501289670540389),
                                    ("Jumu'atul-Widayear (latent)", -5.584998938666234),
                                    ("minuteday", -2.751785594610018),
                                    ("absorption of , after named dayintersect",
                                     -5.808142489980444),
                                    ("intersectyear (latent)", -6.095824562432225),
                                    ("Orthodox Easter Sundayyear (latent)", -6.501289670540389),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.501289670540389),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.501289670540389),
                                    ("intersecthhhmm", -6.095824562432225),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.501289670540389),
                                    ("Boss's Dayyear (latent)", -6.095824562432225),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.501289670540389),
                                    ("Global Youth Service Dayyear (latent)", -6.501289670540389),
                                    ("Dhanterasin|during <named-month>|year", -6.501289670540389),
                                    ("tonight<time-of-day> o'clock", -6.501289670540389),
                                    ("Tisha B'Avyear (latent)", -6.501289670540389),
                                    ("Isra and Mi'rajyear (latent)", -5.584998938666234),
                                    ("at <time-of-day>on <day>", -4.891851758106289),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.095824562432225),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.808142489980444),
                                    ("Christmasyear (latent)", -6.095824562432225),
                                    ("Saturdayintersect", -6.501289670540389),
                                    ("Naraka Chaturdashiyear (latent)", -6.095824562432225),
                                    ("Thai Pongalin|during <named-month>|year", -6.501289670540389),
                                    ("dayweek", -6.501289670540389),
                                    ("Easter Sundayyear (latent)", -5.808142489980444),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.095824562432225),
                                    ("weekyear", -5.402677381872279),
                                    ("King's Dayyear (latent)", -4.997212273764115),
                                    ("hh:mmin|during the <part-of-day>", -5.584998938666234),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.095824562432225),
                                    ("first|second|third|fourth|fifth <day-of-week> of <time>year (latent)",
                                     -5.808142489980444),
                                    ("Hanukkahyear (latent)", -5.808142489980444),
                                    ("Rama Navamiyear (latent)", -6.501289670540389),
                                    ("February<time> <part-of-day>", -6.501289670540389),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.808142489980444),
                                    ("Great Lentyear (latent)", -6.501289670540389),
                                    ("tomorrowat <time-of-day>", -5.808142489980444),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.501289670540389),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.095824562432225),
                                    ("Ugadiyear (latent)", -5.1149953094204985),
                                    ("Vaisakhiyear (latent)", -5.808142489980444),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.808142489980444),
                                    ("last <cycle> of <time>year (latent)", -5.808142489980444),
                                    ("at <time-of-day>tomorrow", -6.095824562432225),
                                    ("tomorrow<time-of-day> am|pm", -6.501289670540389),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.501289670540389),
                                    ("Diwaliyear (latent)", -6.501289670540389),
                                    ("between <time> and <time>on <day>", -6.095824562432225),
                                    ("Black Fridayyear (latent)", -6.095824562432225),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.501289670540389),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.501289670540389),
                                    ("Chhathyear (latent)", -6.095824562432225),
                                    ("Vasant Panchamiyear (latent)", -6.501289670540389),
                                    ("Rabindra Jayantiyear (latent)", -5.248526702045021),
                                    ("this <part-of-day>at <time-of-day>", -5.248526702045021),
                                    ("St Patrick's Dayyear (latent)", -6.501289670540389),
                                    ("Thursday<time> (timezone)", -6.501289670540389),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.501289670540389),
                                    ("Pargat Diwasyear (latent)", -5.248526702045021),
                                    ("<datetime> - <datetime> (interval)July", -6.095824562432225),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.808142489980444),
                                    ("Februaryintersect", -6.501289670540389),
                                    ("Simchat Torahyear (latent)", -6.501289670540389),
                                    ("minuteyear", -6.501289670540389)],
                               n = 516},
                   koData =
                     ClassData{prior = -1.0112926977755932, unseen = -6.792344427470809,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.593996885389966),
                                    ("hourday", -3.4953845967218564),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.09807428216624),
                                    ("<day-of-month> (ordinal)August", -6.09807428216624),
                                    ("dayhour", -3.3572342582410393),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.181783550292085),
                                    ("Tuesdayfrom|since|after <time>", -5.404927101606295),
                                    ("daymonth", -3.39002408106403),
                                    ("hourquarter", -5.181783550292085),
                                    ("monthyear", -4.845311313670872),
                                    ("Thai Pongalyear (latent)", -5.404927101606295),
                                    ("intersecthh:mm", -6.09807428216624),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.6926091740580755),
                                    ("<day-of-month> (ordinal)Wednesday", -6.09807428216624),
                                    ("houryear", -4.711779921046349),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.09807428216624),
                                    ("<day-of-month> (ordinal)October", -6.09807428216624),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.404927101606295),
                                    ("hournograin", -4.845311313670872),
                                    ("<time-of-day> am|pmintersect", -4.845311313670872),
                                    ("Octoberyear (latent)", -6.09807428216624),
                                    ("Good Fridayyear (latent)", -5.6926091740580755),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.6926091740580755),
                                    ("early morningat <time-of-day>", -6.09807428216624),
                                    ("until <time>on <day>", -5.404927101606295),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.09807428216624),
                                    ("time-of-day (latent)intersect", -5.404927101606295),
                                    ("todayin <number> (implicit minutes)", -6.09807428216624),
                                    ("this <part-of-day><time-of-day> - <time-of-day> (interval)",
                                     -6.09807428216624),
                                    ("hh:mmon <day>", -4.845311313670872),
                                    ("hhhmmintersect", -5.6926091740580755),
                                    ("absorption of , after named dayJuly", -5.181783550292085),
                                    ("from|since|after <time>July", -5.6926091740580755),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.181783550292085),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.6926091740580755),
                                    ("hourmonth", -3.9580081186699694),
                                    ("todayat <time-of-day>", -6.09807428216624),
                                    ("from|since|after <time>December", -6.09807428216624),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.09807428216624),
                                    ("<time-of-day> am|pmon <day>", -4.845311313670872),
                                    ("Mondayyear (latent)", -5.404927101606295),
                                    ("dayday", -3.9580081186699694),
                                    ("mm/ddat <time-of-day>", -5.181783550292085),
                                    ("on <day>September", -5.404927101606295),
                                    ("time-of-day (latent)September", -5.6926091740580755),
                                    ("hourhour", -4.018632740486404),
                                    ("time-of-day (latent)on <day>", -4.593996885389966),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.6926091740580755),
                                    ("dayyear", -3.2947139012597053),
                                    ("Thursdaymm/dd", -6.09807428216624),
                                    ("New Year's Dayyear (latent)", -5.181783550292085),
                                    ("time-of-day (latent)Sunday", -5.6926091740580755),
                                    ("Thursdayfrom|since|after <time>", -4.393326189927815),
                                    ("Thursdayat <time-of-day>", -4.48863636973214),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.09807428216624),
                                    ("Aprilyear (latent)", -6.09807428216624),
                                    ("the <day-of-month> (ordinal)July", -6.09807428216624),
                                    ("the <day-of-month> (number)July", -6.09807428216624),
                                    ("monthminute", -6.09807428216624),
                                    ("<time-of-day> am|pmtomorrow", -5.6926091740580755),
                                    ("Thursdayhh:mm", -5.181783550292085),
                                    ("<day-of-month> (ordinal)Tuesday", -5.6926091740580755),
                                    ("minutemonth", -3.9580081186699694),
                                    ("time-of-day (latent)Friday", -5.6926091740580755),
                                    ("minutehour", -6.09807428216624),
                                    ("part of daysat <time-of-day>", -4.99946199349813),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.7466990250027625),
                                    ("Augustyear (latent)", -5.6926091740580755),
                                    ("week-endin|during <named-month>|year", -6.09807428216624),
                                    ("time-of-day (latent)Tuesday", -5.6926091740580755),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.09807428216624),
                                    ("Sundayyear (latent)", -5.181783550292085),
                                    ("hourweek", -5.181783550292085),
                                    ("the <day-of-month> (ordinal)Monday", -5.404927101606295),
                                    ("Christmasat <time-of-day>", -6.09807428216624),
                                    ("from|since|after <time>year (latent)", -5.6926091740580755),
                                    ("hhhmmon <day>", -5.181783550292085),
                                    ("yesterday<time-of-day> am|pm", -6.09807428216624),
                                    ("<day-of-month> (ordinal)July", -5.404927101606295),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.09807428216624),
                                    ("at <time-of-day>intersect", -5.181783550292085),
                                    ("Holiyear (latent)", -6.09807428216624),
                                    ("until <time><time-of-day> am|pm", -6.09807428216624),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.6926091740580755),
                                    ("dayminute", -3.235873401236772),
                                    ("yyyy-mm-ddhh:mm", -5.6926091740580755),
                                    ("intersectfrom|since|after <time>", -5.6926091740580755),
                                    ("intersectSeptember", -4.226272105264648),
                                    ("minuteday", -2.9410738610161267),
                                    ("absorption of , after named dayintersect", -6.09807428216624),
                                    ("intersectyear (latent)", -6.09807428216624),
                                    ("Februaryin|during the <part-of-day>", -6.09807428216624),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.09807428216624),
                                    ("time-of-day (latent)July", -5.404927101606295),
                                    ("Saturdayyear (latent)", -6.09807428216624),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.09807428216624),
                                    ("<day-of-month> (ordinal)Monday", -4.845311313670872),
                                    ("at <time-of-day>on <day>", -5.181783550292085),
                                    ("absorption of , after named daySeptember",
                                     -4.845311313670872),
                                    ("Naraka Chaturdashiyear (latent)", -6.09807428216624),
                                    ("from|since|after <time>on <day>", -5.181783550292085),
                                    ("dayweek", -6.09807428216624),
                                    ("Easter Sundayyear (latent)", -5.6926091740580755),
                                    ("Thursday<time-of-day> am|pm", -4.845311313670872),
                                    ("weekyear", -5.6926091740580755),
                                    ("time-of-day (latent)Thursday", -5.6926091740580755),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.09807428216624),
                                    ("<day-of-month> (ordinal)April", -6.09807428216624),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.6926091740580755),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.404927101606295),
                                    ("Sundayfrom|since|after <time>", -6.09807428216624),
                                    ("absorption of , after named dayFebruary", -5.181783550292085),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.6926091740580755),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.09807428216624),
                                    ("tomorrowat <time-of-day>", -6.09807428216624),
                                    ("daynograin", -5.6926091740580755),
                                    ("Fridayin|during <named-month>|year", -6.09807428216624),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.6926091740580755),
                                    ("last <cycle> of <time>year (latent)", -5.6926091740580755),
                                    ("tomorrow<time-of-day> am|pm", -6.09807428216624),
                                    ("Diwaliyear (latent)", -5.6926091740580755),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.09807428216624),
                                    ("this <part-of-day>at <time-of-day>", -5.181783550292085),
                                    ("Fridayyear (latent)", -5.181783550292085),
                                    ("time-of-day (latent)April", -6.09807428216624)],
                               n = 295}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -infinity, unseen = -0.6931471805599453,
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.7164945445569365, unseen = -4.867534450455582,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 127},
                   koData =
                     ClassData{prior = -0.6703325027937741, unseen = -4.912654885736052,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.15168458733206477),
