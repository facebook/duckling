...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6495435430778134, unseen = -5.932245187448011,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 375},
                   koData =
                     ClassData{prior = -0.7387391218822843, unseen = -5.84354441703136,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4911205526866583, unseen = -6.98100574072173,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.2869287600018176),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.2869287600018176),
                                    ("Ramadanyear (latent)", -5.3706380281276624),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.272025739459553),
                                    ("Bhai Doojyear (latent)", -6.2869287600018176),
                                    ("hourday", -4.272025739459553),
                                    ("dayhour", -3.3691580279175386),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.272025739459553),
                                    ("Martin Luther King's Dayyear (latent)", -5.881463651893654),
                                    ("Shemini Atzeretyear (latent)", -6.2869287600018176),
                                    ("daymonth", -4.146862596505547),
                                    ("monthday", -5.881463651893654),
                                    ("monthyear", -4.415126583100227),
                                    ("Yom Ha'atzmautyear (latent)", -6.2869287600018176),
                                    ("Vijayadashamiyear (latent)", -6.2869287600018176),
                                    ("Thanksgiving Dayyear (latent)", -5.188316471333708),
                                    ("Thai Pongalyear (latent)", -5.593781579441872),
                                    ("Thiru Onamyear (latent)", -5.593781579441872),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.2869287600018176),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.3706380281276624),
                                    ("<day-of-month> (ordinal)Wednesday", -6.2869287600018176),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.2869287600018176),
                                    ("houryear", -5.3706380281276624),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.2869287600018176),
                                    ("Christmas<time-of-day> am|pm", -6.2869287600018176),
                                    ("<day-of-month> (ordinal)October", -6.2869287600018176),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.2869287600018176),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.593781579441872),
                                    ("intersectin|during <named-month>|year", -6.2869287600018176),
                                    ("<time-of-day> am|pmintersect", -5.0341657915064495),
                                    ("Earth Houryear (latent)", -6.2869287600018176),
                                    ("Octoberyear (latent)", -4.677490847567718),
                                    ("intersect<time-of-day> am|pm", -6.2869287600018176),
                                    ("Mattu Pongalyear (latent)", -6.2869287600018176),
                                    ("Shavuotyear (latent)", -6.2869287600018176),
                                    ("Parsi New Yearyear (latent)", -5.3706380281276624),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.2869287600018176),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.2869287600018176),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.881463651893654),
                                    ("Marchyear (latent)", -6.2869287600018176),
                                    ("Sukkotyear (latent)", -5.881463651893654),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.881463651893654),
                                    ("Clean Mondayyear (latent)", -5.881463651893654),
                                    ("monthhour", -5.881463651893654),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.593781579441872),
                                    ("todayat <time-of-day>", -6.2869287600018176),
                                    ("Thursday<time> timezone", -4.341018610946504),
                                    ("time-of-day (latent)tonight", -5.881463651893654),
                                    ("from|since|after <time>December", -6.2869287600018176),
                                    ("<time-of-day> am|pmon <day>", -4.272025739459553),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.2869287600018176),
                                    ("yyyy-mm-ddhh:mm:ss", -5.881463651893654),
                                    ("dayday", -3.8445817246326133),
                                    ("<time> <part-of-day>at <time-of-day>", -6.2869287600018176),
                                    ("mm/ddat <time-of-day>", -6.2869287600018176),
                                    ("tonightat <time-of-day>", -6.2869287600018176),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.593781579441872),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.2869287600018176),
                                    ("today<time-of-day> am|pm", -6.2869287600018176),
                                    ("Februarythe <day-of-month> (ordinal)", -5.881463651893654),
                                    ("at <time-of-day><time> <part-of-day>", -6.2869287600018176),
                                    ("<day-of-month> (ordinal)intersect", -5.593781579441872),
                                    ("mm/dd<time-of-day> am|pm", -6.2869287600018176),
                                    ("hourhour", -4.207487218321982),
                                    ("Navaratriin|during <named-month>|year", -6.2869287600018176),
                                    ("Wednesdaythis|last|next <cycle>", -6.2869287600018176),
                                    ("Lentyear (latent)", -6.2869287600018176),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.782851363225544),
                                    ("Boghiyear (latent)", -6.2869287600018176),
                                    ("dayyear", -1.989643353783027),
                                    ("Thursdayfrom|since|after <time>", -5.881463651893654),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.2869287600018176),
                                    ("Thursdayat <time-of-day>", -5.593781579441872),
                                    ("Islamic New Yearyear (latent)", -5.881463651893654),
                                    ("Laylat al-Qadryear (latent)", -5.3706380281276624),
                                    ("Shrove Tuesdayyear (latent)", -6.2869287600018176),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.593781579441872),
                                    ("<time-of-day> am|pmtomorrow", -5.593781579441872),
                                    ("Yom Kippuryear (latent)", -6.2869287600018176),
                                    ("<day-of-month> (ordinal)Tuesday", -5.881463651893654),
                                    ("<part-of-day> of <time>year (latent)", -6.2869287600018176),
                                    ("minutehour", -5.188316471333708),
                                    ("Kaanum Pongalyear (latent)", -5.881463651893654),
                                    ("Maha Saptamiyear (latent)", -6.2869287600018176),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.881463651893654),
                                    ("time-of-day (latent)tomorrow", -5.3706380281276624),
                                    ("part of daysat <time-of-day>", -5.881463651893654),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.582180667763392),
                                    ("for <duration> from <time>December", -6.2869287600018176),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.2869287600018176),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.0341657915064495),
                                    ("time-of-day (latent)this <part-of-day>", -6.2869287600018176),
                                    ("Pentecostyear (latent)", -6.2869287600018176),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.0341657915064495),
                                    ("<day-of-month> (ordinal)February", -6.2869287600018176),
                                    ("Eid al-Fitryear (latent)", -5.3706380281276624),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.2869287600018176),
                                    ("Mondayin|during the <part-of-day>", -6.2869287600018176),
                                    ("Chhathin|during <named-month>|year", -6.2869287600018176),
                                    ("Diwaliin|during <named-month>|year", -6.2869287600018176),
                                    ("Vaisakhiin|during <named-month>|year", -6.2869287600018176),
                                    ("Raksha Bandhanyear (latent)", -6.2869287600018176),
                                    ("daysecond", -5.881463651893654),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.881463651893654),
                                    ("Ashurayear (latent)", -6.2869287600018176),
                                    ("Tuesdayin|during <named-month>|year", -6.2869287600018176),
                                    ("Chinese New Yearyear (latent)", -6.2869287600018176),
                                    ("tomorrowintersect", -6.2869287600018176),
                                    ("Lag BaOmeryear (latent)", -6.2869287600018176),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.2869287600018176),
                                    ("Eid al-Adhayear (latent)", -5.3706380281276624),
                                    ("intersectin|during the <part-of-day>", -6.2869287600018176),
                                    ("Palm Sundayyear (latent)", -6.2869287600018176),
                                    ("Christmasat <time-of-day>", -6.2869287600018176),
                                    ("Passoveryear (latent)", -6.2869287600018176),
                                    ("Lazarus Saturdayyear (latent)", -6.2869287600018176),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.881463651893654),
                                    ("Yom HaShoahyear (latent)", -5.881463651893654),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.881463651893654),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.2869287600018176),
                                    ("Septemberyear (latent)", -5.881463651893654),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.782851363225544),
                                    ("Halloweenyear (latent)", -6.2869287600018176),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.2869287600018176),
                                    ("at <time-of-day>intersect", -5.881463651893654),
                                    ("Rosh Hashanahyear (latent)", -5.593781579441872),
                                    ("Dhanterasyear (latent)", -6.2869287600018176),
                                    ("Tu BiShvatyear (latent)", -6.2869287600018176),
                                    ("<day-of-month> (ordinal)December", -5.593781579441872),
                                    ("Holiyear (latent)", -5.593781579441872),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.2869287600018176),
                                    ("Holika Dahanyear (latent)", -5.593781579441872),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.2869287600018176),
                                    ("dayminute", -3.3691580279175386),
                                    ("Mawlidyear (latent)", -6.2869287600018176),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.881463651893654),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.2869287600018176),
                                    ("Jumu'atul-Widayear (latent)", -5.3706380281276624),
                                    ("minuteday", -2.458287363512723),
                                    ("absorption of , after named dayintersect",
                                     -6.2869287600018176),
                                    ("intersectyear (latent)", -5.881463651893654),
                                    ("Orthodox Easter Sundayyear (latent)", -6.2869287600018176),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.2869287600018176),
                                    ("Boss's Dayyear (latent)", -5.881463651893654),
                                    ("Global Youth Service Dayyear (latent)", -6.2869287600018176),
                                    ("Dhanterasin|during <named-month>|year", -6.2869287600018176),
                                    ("Tisha B'Avyear (latent)", -6.2869287600018176),
                                    ("Isra and Mi'rajyear (latent)", -5.3706380281276624),
                                    ("at <time-of-day>on <day>", -5.188316471333708),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.2869287600018176),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.593781579441872),
                                    ("Christmasyear (latent)", -5.881463651893654),
                                    ("Naraka Chaturdashiyear (latent)", -5.881463651893654),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.2869287600018176),
                                    ("dayweek", -6.2869287600018176),
                                    ("Easter Sundayyear (latent)", -5.593781579441872),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.677490847567718),
                                    ("weekyear", -5.188316471333708),
                                    ("King's Dayyear (latent)", -4.782851363225544),
                                    ("hh:mmin|during the <part-of-day>", -5.593781579441872),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.881463651893654),
                                    ("Hanukkahyear (latent)", -5.593781579441872),
                                    ("February<time> <part-of-day>", -6.2869287600018176),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.2869287600018176),
                                    ("Great Lentyear (latent)", -6.2869287600018176),
                                    ("tomorrowat <time-of-day>", -5.593781579441872),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.2869287600018176),
                                    ("Vaisakhiyear (latent)", -5.593781579441872),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.2869287600018176),
                                    ("last <cycle> of <time>year (latent)", -5.593781579441872),
                                    ("at <time-of-day>tomorrow", -5.881463651893654),
                                    ("tomorrow<time-of-day> am|pm", -6.2869287600018176),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.2869287600018176),
                                    ("Diwaliyear (latent)", -6.2869287600018176),
                                    ("between <time> and <time>on <day>", -4.677490847567718),
                                    ("Black Fridayyear (latent)", -5.881463651893654),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.2869287600018176),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.2869287600018176),
                                    ("Chhathyear (latent)", -5.881463651893654),
                                    ("Vasant Panchamiyear (latent)", -6.2869287600018176),
                                    ("Rabindra Jayantiyear (latent)", -5.0341657915064495),
                                    ("St Patrick's Dayyear (latent)", -6.2869287600018176),
                                    ("Thursday<time> (timezone)", -6.2869287600018176),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.2869287600018176),
                                    ("<datetime> - <datetime> (interval)July", -5.881463651893654),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.881463651893654),
                                    ("Februaryintersect", -6.2869287600018176),
                                    ("Simchat Torahyear (latent)", -6.2869287600018176),
                                    ("minuteyear", -6.2869287600018176)],
                               n = 410},
                   koData =
                     ClassData{prior = -0.946596081369484, unseen = -6.654152520183219,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.2516656476911914),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.959715848793402),
                                    ("<day-of-month> (ordinal)August", -5.959715848793402),
                                    ("dayhour", -3.2855671993668727),
                                    ("<time> timezoneyear (latent)", -5.959715848793402),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.043425116919247),
                                    ("Tuesdayfrom|since|after <time>", -5.959715848793402),
                                    ("daymonth", -3.4748091990054015),
                                    ("monthyear", -4.706952880298034),
                                    ("<time-of-day> am|pmyear (latent)", -5.2665686682334565),
                                    ("Thai Pongalyear (latent)", -5.2665686682334565),
                                    ("intersecthh:mm", -5.959715848793402),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.554250740685237),
                                    ("<day-of-month> (ordinal)Wednesday", -5.959715848793402),
                                    ("houryear", -4.573421487673511),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.959715848793402),
                                    ("<day-of-month> (ordinal)October", -5.959715848793402),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.2665686682334565),
                                    ("<time-of-day> am|pmintersect", -4.706952880298034),
                                    ("Octoberyear (latent)", -5.959715848793402),
                                    ("until <time>on <day>", -5.2665686682334565),
                                    ("time-of-day (latent)intersect", -5.959715848793402),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.2665686682334565),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.959715848793402),
                                    ("hh:mmon <day>", -3.517368813424197),
                                    ("absorption of , after named dayJuly", -5.554250740685237),
                                    ("from|since|after <time>July", -5.554250740685237),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.043425116919247),
                                    ("Clean Mondayyear (latent)", -5.959715848793402),
                                    ("monthhour", -5.959715848793402),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.554250740685237),
                                    ("hourmonth", -4.08791367189181),
                                    ("todayat <time-of-day>", -5.959715848793402),
                                    ("from|since|after <time>December", -5.959715848793402),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.959715848793402),
                                    ("<time-of-day> am|pmon <day>", -4.706952880298034),
                                    ("Mondayyear (latent)", -5.2665686682334565),
                                    ("dayday", -4.573421487673511),
                                    ("mm/ddat <time-of-day>", -5.554250740685237),
                                    ("on <day>September", -5.554250740685237),
                                    ("time-of-day (latent)September", -5.554250740685237),
                                    ("hourhour", -5.959715848793402),
                                    ("time-of-day (latent)on <day>", -3.517368813424197),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.554250740685237),
                                    ("dayyear", -3.015276869626961),
                                    ("Thursdaymm/dd", -5.959715848793402),
                                    ("New Year's Dayyear (latent)", -5.043425116919247),
                                    ("Thursdayfrom|since|after <time>", -4.254967756554977),
                                    ("Thursdayat <time-of-day>", -4.350277936359301),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.959715848793402),
                                    ("Aprilyear (latent)", -5.959715848793402),
                                    ("the <day-of-month> (ordinal)July", -5.959715848793402),
                                    ("the <day-of-month> (number)July", -5.959715848793402),
                                    ("monthminute", -5.959715848793402),
                                    ("<time-of-day> am|pmtomorrow", -5.959715848793402),
                                    ("Thursdayhh:mm", -5.043425116919247),
                                    ("<day-of-month> (ordinal)Tuesday", -5.554250740685237),
                                    ("minutemonth", -4.08791367189181),
                                    ("minutehour", -5.959715848793402),
                                    ("Augustyear (latent)", -5.554250740685237),
                                    ("week-endin|during <named-month>|year", -5.959715848793402),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.554250740685237),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.959715848793402),
                                    ("Sundayyear (latent)", -5.043425116919247),
                                    ("Christmasat <time-of-day>", -5.959715848793402),
                                    ("from|since|after <time>year (latent)", -4.861103560125292),
                                    ("<duration> after|before|from <time>December",
                                     -5.959715848793402),
                                    ("yesterday<time-of-day> am|pm", -5.959715848793402),
                                    ("<day-of-month> (ordinal)July", -5.2665686682334565),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.959715848793402),
                                    ("mm/ddyear (latent)", -5.959715848793402),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.959715848793402),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.959715848793402),
                                    ("at <time-of-day>intersect", -5.554250740685237),
                                    ("hh:mmyear (latent)", -3.8802743071135657),
                                    ("Holiyear (latent)", -5.959715848793402),
                                    ("until <time><time-of-day> am|pm", -5.959715848793402),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.959715848793402),
                                    ("dayminute", -3.394766491331865),
                                    ("yyyy-mm-ddhh:mm", -5.554250740685237),
                                    ("intersectSeptember", -4.455638452017127),
                                    ("minuteday", -2.721037396629021),
                                    ("absorption of , after named dayintersect",
                                     -5.959715848793402),
                                    ("intersectyear (latent)", -5.959715848793402),
                                    ("Februaryin|during the <part-of-day>", -5.959715848793402),
                                    ("time-of-day (latent)July", -5.2665686682334565),
                                    ("Saturdayyear (latent)", -5.959715848793402),
                                    ("at <time-of-day>on <day>", -5.554250740685237),
                                    ("absorption of , after named daySeptember",
                                     -5.043425116919247),
                                    ("Naraka Chaturdashiyear (latent)", -5.959715848793402),
                                    ("from|since|after <time>on <day>", -5.043425116919247),
                                    ("dayweek", -5.959715848793402),
                                    ("Easter Sundayyear (latent)", -5.554250740685237),
                                    ("Thursday<time-of-day> am|pm", -4.706952880298034),
                                    ("weekyear", -5.554250740685237),
                                    ("time-of-day (latent)Thursday", -5.554250740685237),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.959715848793402),
                                    ("<day-of-month> (ordinal)April", -5.959715848793402),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.554250740685237),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.2665686682334565),
                                    ("Sundayfrom|since|after <time>", -5.959715848793402),
                                    ("absorption of , after named dayFebruary", -5.043425116919247),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.959715848793402),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.959715848793402),
                                    ("tomorrowat <time-of-day>", -5.959715848793402),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.554250740685237),
                                    ("last <cycle> of <time>year (latent)", -5.554250740685237),
                                    ("tomorrow<time-of-day> am|pm", -5.959715848793402),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.2665686682334565),
                                    ("Diwaliyear (latent)", -5.554250740685237),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.959715848793402),
                                    ("Fridayyear (latent)", -5.554250740685237),
                                    ("time-of-day (latent)April", -5.959715848793402),
                                    ("minuteyear", -3.7624912714571823)],
                               n = 260}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1862126122869213, unseen = -5.170483995038151,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.488725900044055e-2),
                                    ("intersect 2 numbers", -3.7784916128036232)],
                               n = 171},
                   koData =
                     ClassData{prior = -1.7725281073001673,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
