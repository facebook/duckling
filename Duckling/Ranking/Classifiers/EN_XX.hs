...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6215486200116492, unseen = -5.991464547107982,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 398},
                   koData =
                     ClassData{prior = -0.770270178130147, unseen = -5.84354441703136,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -3.996364153861897),
                                    ...
                                    ("intersect", -2.966744736680739),
                                    ("<time> for <duration>", -4.219507705176107),
                                    ("second", -4.912654885736052), ("now", -3.2079067934976266),
                                    ...
                                    ("time-of-day (latent)", -2.5147596129376812),
                                    ("<time-of-day> am|pm", -4.507189777627888),
                                    ("hh:mm", -4.507189777627888), ("nograin", -3.2079067934976266),
                                    ...
                                    ("Christmas", -4.219507705176107),
                                    ("hour", -2.3869262414277963), ("month", -4.912654885736052),
                                    ("<datetime> - <datetime> (interval)", -2.833213344056216),
                                    ("<time-of-day> - <time-of-day> (interval)",
                                     -2.966744736680739),
                                    ("<named-month> <day-of-month> (non ordinal)",
                                     -4.507189777627888),
                                    ("minute", -1.9682159065696114),
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.49350714738949436,
                               unseen = -7.029087564149662,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.335054251498059),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.335054251498059),
                                    ("Ramadanyear (latent)", -5.418763519623904),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.320151230955794),
                                    ("Bhai Doojyear (latent)", -6.335054251498059),
                                    ("hourday", -4.320151230955794),
                                    ("dayhour", -3.3906152723316185),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.320151230955794),
                                    ("Martin Luther King's Dayyear (latent)", -5.929589143389895),
                                    ("Shemini Atzeretyear (latent)", -6.335054251498059),
                                    ("daymonth", -4.1949880880017885),
                                    ("monthday", -5.929589143389895),
                                    ("monthyear", -4.4632520745964674),
                                    ("Yom Ha'atzmautyear (latent)", -6.335054251498059),
                                    ("Vijayadashamiyear (latent)", -6.335054251498059),
                                    ("Thanksgiving Dayyear (latent)", -5.236441962829949),
                                    ("Thai Pongalyear (latent)", -5.641907070938114),
                                    ("Thiru Onamyear (latent)", -5.641907070938114),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.335054251498059),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.418763519623904),
                                    ("<day-of-month> (ordinal)Wednesday", -6.335054251498059),
                                    ("Krishna Janmashtamiyear (latent)", -5.929589143389895),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.335054251498059),
                                    ("houryear", -5.418763519623904),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.335054251498059),
                                    ("Christmas<time-of-day> am|pm", -6.335054251498059),
                                    ("<day-of-month> (ordinal)October", -6.335054251498059),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.335054251498059),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.641907070938114),
                                    ("intersectin|during <named-month>|year", -6.335054251498059),
                                    ("<time-of-day> am|pmintersect", -5.082291283002691),
                                    ("Earth Houryear (latent)", -6.335054251498059),
                                    ("Octoberyear (latent)", -4.725616339063959),
                                    ("intersect<time-of-day> am|pm", -6.335054251498059),
                                    ("Mattu Pongalyear (latent)", -6.335054251498059),
                                    ("Shavuotyear (latent)", -6.335054251498059),
                                    ("Parsi New Yearyear (latent)", -5.418763519623904),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.335054251498059),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.335054251498059),
                                    ("todayin|within|after <duration>", -6.335054251498059),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.929589143389895),
                                    ("Marchyear (latent)", -6.335054251498059),
                                    ("Sukkotyear (latent)", -5.929589143389895),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.929589143389895),
                                    ("Clean Mondayyear (latent)", -5.929589143389895),
                                    ("monthhour", -5.929589143389895),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.641907070938114),
                                    ("todayat <time-of-day>", -6.335054251498059),
                                    ("Thursday<time> timezone", -4.389144102442746),
                                    ("time-of-day (latent)tonight", -5.929589143389895),
                                    ("from|since|after <time>December", -6.335054251498059),
                                    ("<time-of-day> am|pmon <day>", -4.320151230955794),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.335054251498059),
                                    ("yyyy-mm-ddhh:mm:ss", -5.929589143389895),
                                    ("dayday", -3.8927072161288545),
                                    ("<time> <part-of-day>at <time-of-day>", -6.335054251498059),
                                    ("mm/ddat <time-of-day>", -6.335054251498059),
                                    ("tonightat <time-of-day>", -6.335054251498059),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.641907070938114),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.335054251498059),
                                    ("today<time-of-day> am|pm", -6.335054251498059),
                                    ("Februarythe <day-of-month> (ordinal)", -5.929589143389895),
                                    ("at <time-of-day><time> <part-of-day>", -6.335054251498059),
                                    ("<day-of-month> (ordinal)intersect", -5.641907070938114),
                                    ("mm/dd<time-of-day> am|pm", -6.335054251498059),
                                    ("hourhour", -4.255612709818223),
                                    ("Navaratriin|during <named-month>|year", -6.335054251498059),
                                    ("Wednesdaythis|last|next <cycle>", -6.335054251498059),
                                    ("Lentyear (latent)", -6.335054251498059),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.830976854721785),
                                    ("Boghiyear (latent)", -6.335054251498059),
                                    ("dayyear", -1.910207619641249),
                                    ("Thursdayfrom|since|after <time>", -5.929589143389895),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.335054251498059),
                                    ("Thursdayat <time-of-day>", -5.641907070938114),
                                    ("Islamic New Yearyear (latent)", -5.929589143389895),
                                    ("Laylat al-Qadryear (latent)", -5.418763519623904),
                                    ("Shrove Tuesdayyear (latent)", -6.335054251498059),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.641907070938114),
                                    ("<time-of-day> am|pmtomorrow", -5.641907070938114),
                                    ("Yom Kippuryear (latent)", -6.335054251498059),
                                    ("<day-of-month> (ordinal)Tuesday", -5.929589143389895),
                                    ("<part-of-day> of <time>year (latent)", -6.335054251498059),
                                    ("minutehour", -5.236441962829949),
                                    ("Kaanum Pongalyear (latent)", -5.929589143389895),
                                    ("Maha Saptamiyear (latent)", -6.335054251498059),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.929589143389895),
                                    ("time-of-day (latent)tomorrow", -5.418763519623904),
                                    ("part of daysat <time-of-day>", -5.929589143389895),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.630306159259634),
                                    ("for <duration> from <time>December", -6.335054251498059),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.335054251498059),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.082291283002691),
                                    ("time-of-day (latent)this <part-of-day>", -6.335054251498059),
                                    ("Pentecostyear (latent)", -6.335054251498059),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.082291283002691),
                                    ("<day-of-month> (ordinal)February", -6.335054251498059),
                                    ("Eid al-Fitryear (latent)", -5.418763519623904),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.335054251498059),
                                    ("Mondayin|during the <part-of-day>", -6.335054251498059),
                                    ("Chhathin|during <named-month>|year", -6.335054251498059),
                                    ("Diwaliin|during <named-month>|year", -6.335054251498059),
                                    ("Vaisakhiin|during <named-month>|year", -6.335054251498059),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.082291283002691),
                                    ("Raksha Bandhanyear (latent)", -6.335054251498059),
                                    ("daysecond", -5.929589143389895),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.929589143389895),
                                    ("Ashurayear (latent)", -6.335054251498059),
                                    ("Tuesdayin|during <named-month>|year", -6.335054251498059),
                                    ("Chinese New Yearyear (latent)", -6.335054251498059),
                                    ("tomorrowintersect", -6.335054251498059),
                                    ("Lag BaOmeryear (latent)", -6.335054251498059),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.335054251498059),
                                    ("Eid al-Adhayear (latent)", -4.1949880880017885),
                                    ("intersectin|during the <part-of-day>", -6.335054251498059),
                                    ("Palm Sundayyear (latent)", -6.335054251498059),
                                    ("Christmasat <time-of-day>", -6.335054251498059),
                                    ("Passoveryear (latent)", -6.335054251498059),
                                    ("Lazarus Saturdayyear (latent)", -6.335054251498059),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.929589143389895),
                                    ("Yom HaShoahyear (latent)", -5.929589143389895),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.929589143389895),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.335054251498059),
                                    ("Septemberyear (latent)", -5.929589143389895),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.830976854721785),
                                    ("Halloweenyear (latent)", -6.335054251498059),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.335054251498059),
                                    ("at <time-of-day>intersect", -5.929589143389895),
                                    ("Rosh Hashanahyear (latent)", -5.641907070938114),
                                    ("Dhanterasyear (latent)", -6.335054251498059),
                                    ("Tu BiShvatyear (latent)", -6.335054251498059),
                                    ("<day-of-month> (ordinal)December", -5.641907070938114),
                                    ("Holiyear (latent)", -5.641907070938114),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.335054251498059),
                                    ("Holika Dahanyear (latent)", -5.641907070938114),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.335054251498059),
                                    ("dayminute", -3.41728351941378),
                                    ("Mawlidyear (latent)", -6.335054251498059),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.929589143389895),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.335054251498059),
                                    ("Jumu'atul-Widayear (latent)", -5.418763519623904),
                                    ("minuteday", -2.5064128550089637),
                                    ("absorption of , after named dayintersect",
                                     -6.335054251498059),
                                    ("intersectyear (latent)", -5.929589143389895),
                                    ("Orthodox Easter Sundayyear (latent)", -6.335054251498059),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.335054251498059),
                                    ("Boss's Dayyear (latent)", -5.929589143389895),
                                    ("Global Youth Service Dayyear (latent)", -6.335054251498059),
                                    ("Dhanterasin|during <named-month>|year", -6.335054251498059),
                                    ("Tisha B'Avyear (latent)", -6.335054251498059),
                                    ("Isra and Mi'rajyear (latent)", -5.418763519623904),
                                    ("at <time-of-day>on <day>", -5.236441962829949),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.335054251498059),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.641907070938114),
                                    ("Christmasyear (latent)", -5.929589143389895),
                                    ("Naraka Chaturdashiyear (latent)", -5.929589143389895),
                                    ("Thai Pongalin|during <named-month>|year", -6.335054251498059),
                                    ("dayweek", -6.335054251498059),
                                    ("Easter Sundayyear (latent)", -5.641907070938114),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.725616339063959),
                                    ("weekyear", -5.236441962829949),
                                    ("King's Dayyear (latent)", -4.830976854721785),
                                    ("hh:mmin|during the <part-of-day>", -5.641907070938114),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.929589143389895),
                                    ("Hanukkahyear (latent)", -5.641907070938114),
                                    ("February<time> <part-of-day>", -6.335054251498059),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.335054251498059),
                                    ("Great Lentyear (latent)", -6.335054251498059),
                                    ("tomorrowat <time-of-day>", -5.641907070938114),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.335054251498059),
                                    ("Vaisakhiyear (latent)", -5.641907070938114),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.335054251498059),
                                    ("last <cycle> of <time>year (latent)", -5.641907070938114),
                                    ("at <time-of-day>tomorrow", -5.929589143389895),
                                    ("tomorrow<time-of-day> am|pm", -6.335054251498059),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.335054251498059),
                                    ("Diwaliyear (latent)", -6.335054251498059),
                                    ("between <time> and <time>on <day>", -4.725616339063959),
                                    ("Black Fridayyear (latent)", -5.929589143389895),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.335054251498059),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.335054251498059),
                                    ("Chhathyear (latent)", -5.929589143389895),
                                    ("Vasant Panchamiyear (latent)", -6.335054251498059),
                                    ("Rabindra Jayantiyear (latent)", -5.082291283002691),
                                    ("St Patrick's Dayyear (latent)", -6.335054251498059),
                                    ("Thursday<time> (timezone)", -6.335054251498059),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.335054251498059),
                                    ("<datetime> - <datetime> (interval)July", -5.929589143389895),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.929589143389895),
                                    ("Februaryintersect", -6.335054251498059),
                                    ("Simchat Torahyear (latent)", -6.335054251498059),
                                    ("minuteyear", -6.335054251498059)],
                               n = 431},
                   koData =
                     ClassData{prior = -0.9428441398266708, unseen = -6.705639094860003,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.120895416507997),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.0112671744041615),
                                    ("<day-of-month> (ordinal)August", -6.0112671744041615),
                                    ("dayhour", -3.337118524977633),
                                    ("<time> timezoneyear (latent)", -6.0112671744041615),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.094976442530006),
                                    ("Tuesdayfrom|since|after <time>", -5.318119993844216),
                                    ("daymonth", -3.5263605246161616),
                                    ("monthyear", -4.758504205908793),
                                    ("<time-of-day> am|pmyear (latent)", -5.318119993844216),
                                    ("Thai Pongalyear (latent)", -5.318119993844216),
                                    ("intersecthh:mm", -6.0112671744041615),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.605802066295998),
                                    ("<day-of-month> (ordinal)Wednesday", -6.0112671744041615),
                                    ("houryear", -4.624972813284271),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.0112671744041615),
                                    ("<day-of-month> (ordinal)October", -6.0112671744041615),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.318119993844216),
                                    ("hournograin", -4.758504205908793),
                                    ("<time-of-day> am|pmintersect", -4.758504205908793),
                                    ("Octoberyear (latent)", -6.0112671744041615),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.605802066295998),
                                    ("until <time>on <day>", -5.318119993844216),
                                    ("time-of-day (latent)intersect", -5.318119993844216),
                                    ("todayin <number> (implicit minutes)", -6.0112671744041615),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.318119993844216),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.0112671744041615),
                                    ("hh:mmon <day>", -3.568920139034957),
                                    ("absorption of , after named dayJuly", -5.605802066295998),
                                    ("from|since|after <time>July", -5.605802066295998),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.094976442530006),
                                    ("Clean Mondayyear (latent)", -6.0112671744041615),
                                    ("monthhour", -6.0112671744041615),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.605802066295998),
                                    ("hourmonth", -4.139464997502571),
                                    ("todayat <time-of-day>", -6.0112671744041615),
                                    ("from|since|after <time>December", -6.0112671744041615),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.0112671744041615),
                                    ("<time-of-day> am|pmon <day>", -4.758504205908793),
                                    ("Mondayyear (latent)", -5.318119993844216),
                                    ("dayday", -4.624972813284271),
                                    ("mm/ddat <time-of-day>", -5.605802066295998),
                                    ("on <day>September", -5.605802066295998),
                                    ("time-of-day (latent)September", -5.605802066295998),
                                    ("hourhour", -6.0112671744041615),
                                    ("time-of-day (latent)on <day>", -3.568920139034957),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.605802066295998),
                                    ("dayyear", -3.066828195237721),
                                    ("Thursdaymm/dd", -6.0112671744041615),
                                    ("New Year's Dayyear (latent)", -5.094976442530006),
                                    ("time-of-day (latent)Sunday", -5.605802066295998),
                                    ("Thursdayfrom|since|after <time>", -4.306519082165736),
                                    ("Thursdayat <time-of-day>", -4.401829261970061),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.0112671744041615),
                                    ("Aprilyear (latent)", -6.0112671744041615),
                                    ("the <day-of-month> (ordinal)July", -6.0112671744041615),
                                    ("the <day-of-month> (number)July", -6.0112671744041615),
                                    ("monthminute", -6.0112671744041615),
                                    ("<time-of-day> am|pmtomorrow", -6.0112671744041615),
                                    ("Thursdayhh:mm", -5.094976442530006),
                                    ("<day-of-month> (ordinal)Tuesday", -5.605802066295998),
                                    ("minutemonth", -4.139464997502571),
                                    ("time-of-day (latent)Friday", -5.605802066295998),
                                    ("minutehour", -6.0112671744041615),
                                    ("Augustyear (latent)", -5.605802066295998),
                                    ("week-endin|during <named-month>|year", -6.0112671744041615),
                                    ("time-of-day (latent)Tuesday", -5.605802066295998),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.605802066295998),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.0112671744041615),
                                    ("Sundayyear (latent)", -5.094976442530006),
                                    ("Christmasat <time-of-day>", -6.0112671744041615),
                                    ("from|since|after <time>year (latent)", -4.912654885736052),
                                    ("<duration> after|before|from <time>December",
                                     -6.0112671744041615),
                                    ("yesterday<time-of-day> am|pm", -6.0112671744041615),
                                    ("<day-of-month> (ordinal)July", -5.318119993844216),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.0112671744041615),
                                    ("mm/ddyear (latent)", -6.0112671744041615),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.0112671744041615),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.0112671744041615),
                                    ("at <time-of-day>intersect", -5.605802066295998),
                                    ("hh:mmyear (latent)", -3.9318256327243257),
                                    ("Holiyear (latent)", -6.0112671744041615),
                                    ("until <time><time-of-day> am|pm", -6.0112671744041615),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0112671744041615),
                                    ("dayminute", -3.4085774889597777),
                                    ("yyyy-mm-ddhh:mm", -5.605802066295998),
                                    ("intersectfrom|since|after <time>", -5.605802066295998),
                                    ("intersectSeptember", -4.507189777627888),
                                    ("minuteday", -2.772588722239781),
                                    ("absorption of , after named dayintersect",
                                     -6.0112671744041615),
                                    ("intersectyear (latent)", -6.0112671744041615),
                                    ("Februaryin|during the <part-of-day>", -6.0112671744041615),
                                    ("time-of-day (latent)July", -5.318119993844216),
                                    ("Saturdayyear (latent)", -6.0112671744041615),
                                    ("at <time-of-day>on <day>", -5.605802066295998),
                                    ("absorption of , after named daySeptember",
                                     -5.094976442530006),
                                    ("Naraka Chaturdashiyear (latent)", -6.0112671744041615),
                                    ("from|since|after <time>on <day>", -5.094976442530006),
                                    ("dayweek", -6.0112671744041615),
                                    ("Easter Sundayyear (latent)", -5.605802066295998),
                                    ("Thursday<time-of-day> am|pm", -4.758504205908793),
                                    ("weekyear", -5.605802066295998),
                                    ("time-of-day (latent)Thursday", -5.605802066295998),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.0112671744041615),
                                    ("<day-of-month> (ordinal)April", -6.0112671744041615),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.605802066295998),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.318119993844216),
                                    ("Sundayfrom|since|after <time>", -6.0112671744041615),
                                    ("absorption of , after named dayFebruary", -5.094976442530006),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.0112671744041615),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.0112671744041615),
                                    ("tomorrowat <time-of-day>", -6.0112671744041615),
                                    ("daynograin", -5.605802066295998),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.605802066295998),
                                    ("last <cycle> of <time>year (latent)", -5.605802066295998),
                                    ("tomorrow<time-of-day> am|pm", -6.0112671744041615),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.318119993844216),
                                    ("Diwaliyear (latent)", -5.605802066295998),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.0112671744041615),
                                    ("Fridayyear (latent)", -5.605802066295998),
                                    ("time-of-day (latent)April", -6.0112671744041615),
                                    ("minuteyear", -3.8140425970679424)],
                               n = 275}}),
       ("one eleven",
        Classifier{okData =
