...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6088242551947775, unseen = -6.089044875446846,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 439},
                   koData =
                     ClassData{prior = -0.7852407301010179, unseen = -5.91350300563827,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4681160730698316, unseen = -7.097548850614793,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.403574197934815),
                                    ...
                                    ("Ramadanyear (latent)", -5.48728346606066),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.017279836814924),
                                    ("Bhai Doojyear (latent)", -6.403574197934815),
                                    ("hourday", -4.38867117739255),
                                    ("dayhour", -3.4591352187683744),
                                    ...
                                    ("daymonth", -4.263508034438544),
                                    ("monthday", -5.9981090898266505),
                                    ("monthyear", -4.531772021033223),
                                    ...
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.9981090898266505),
                                    ("Marchyear (latent)", -6.403574197934815),
                                    ...
                                    ("Februarythe <day-of-month> (ordinal)", -5.9981090898266505),
                                    ("at <time-of-day><time> <part-of-day>", -6.403574197934815),
                                    ("<day-of-month> (ordinal)intersect", -5.71042701737487),
                                    ("mm/dd<time-of-day> am|pm", -6.403574197934815),
                                    ("hourhour", -4.324132656254979),
                                    ...
                                    ("dayyear", -1.914937828202675),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.403574197934815),
                                    ("Thursdayfrom|since|after <time>", -5.9981090898266505),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.403574197934815),
                                    ...
                                    ("<day-of-month> (ordinal)Tuesday", -5.9981090898266505),
                                    ("<part-of-day> of <time>year (latent)", -6.403574197934815),
                                    ("minutehour", -5.150811229439447),
                                    ("Kaanum Pongalyear (latent)", -5.9981090898266505),
                                    ("Maha Saptamiyear (latent)", -6.403574197934815),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.9981090898266505),
                                    ("time-of-day (latent)tomorrow", -5.48728346606066),
                                    ("part of daysat <time-of-day>", -5.9981090898266505),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.150811229439447),
                                    ("time-of-day (latent)this <part-of-day>", -6.403574197934815),
                                    ("Pentecostyear (latent)", -6.403574197934815),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.150811229439447),
                                    ("<day-of-month> (ordinal)February", -6.403574197934815),
                                    ("Eid al-Fitryear (latent)", -5.48728346606066),
                                    ...
                                    ("<day-of-month> (ordinal)December", -5.71042701737487),
                                    ...
                                    ("minuteday", -2.6659045796514467),
                                    ("absorption of , after named dayintersect", -5.71042701737487),
                                    ("intersectyear (latent)", -5.9981090898266505),
                                    ...
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.9981090898266505),
                                    ("time-of-day (latent)<time> <part-of-day>", -5.71042701737487),
                                    ...
                                    ("<datetime> - <datetime> (interval)July", -5.9981090898266505),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.71042701737487),
                                    ("Februaryintersect", -6.403574197934815),
                                    ("Simchat Torahyear (latent)", -6.403574197934815),
                                    ("minuteyear", -6.403574197934815)],
                               n = 464},
                   koData =
                     ClassData{prior = -0.9839831191087485, unseen = -6.727431724850855,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.529008825022527),
                                    ("hourday", -3.635190949000431),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.0330862217988015),
                                    ("<day-of-month> (ordinal)August", -6.0330862217988015),
                                    ("dayhour", -3.2922461978736006),
                                    ("<time> timezoneyear (latent)", -5.339939041238856),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.116795489924646),
                                    ("Tuesdayfrom|since|after <time>", -5.339939041238856),
                                    ("daymonth", -3.3589375723722728),
                                    ("monthyear", -4.780323253303433),
                                    ("<time-of-day> am|pmyear (latent)", -5.339939041238856),
                                    ("Thai Pongalyear (latent)", -5.339939041238856),
                                    ("intersecthh:mm", -6.0330862217988015),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.627621113690637),
                                    ("<day-of-month> (ordinal)Wednesday", -6.0330862217988015),
                                    ("houryear", -4.646791860678911),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.0330862217988015),
                                    ("<day-of-month> (ordinal)October", -6.0330862217988015),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.339939041238856),
                                    ("hournograin", -4.780323253303433),
                                    ("<time-of-day> am|pmintersect", -4.780323253303433),
                                    ("Octoberyear (latent)", -6.0330862217988015),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.627621113690637),
                                    ("until <time>on <day>", -5.339939041238856),
                                    ("time-of-day (latent)intersect", -5.339939041238856),
                                    ("todayin <number> (implicit minutes)", -6.0330862217988015),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.339939041238856),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.0330862217988015),
                                    ("hh:mmon <day>", -4.780323253303433),
                                    ("hhhmmintersect", -5.627621113690637),
                                    ("absorption of , after named dayJuly", -5.116795489924646),
                                    ("from|since|after <time>July", -5.627621113690637),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.116795489924646),
                                    ("Clean Mondayyear (latent)", -6.0330862217988015),
                                    ("monthhour", -6.0330862217988015),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.627621113690637),
                                    ("hourmonth", -4.16128404489721),
                                    ("todayat <time-of-day>", -6.0330862217988015),
                                    ("hhhmmyear (latent)", -4.780323253303433),
                                    ("from|since|after <time>December", -6.0330862217988015),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.0330862217988015),
                                    ("<time-of-day> am|pmon <day>", -4.780323253303433),
                                    ("Mondayyear (latent)", -5.339939041238856),
                                    ("dayday", -4.646791860678911),
                                    ("mm/ddat <time-of-day>", -5.116795489924646),
                                    ("on <day>September", -5.339939041238856),
                                    ("time-of-day (latent)September", -5.627621113690637),
                                    ("hourhour", -5.627621113690637),
                                    ("time-of-day (latent)on <day>", -4.529008825022527),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.627621113690637),
                                    ("dayyear", -3.088647242632361),
                                    ("Thursdaymm/dd", -6.0330862217988015),
                                    ("New Year's Dayyear (latent)", -5.116795489924646),
                                    ("time-of-day (latent)Sunday", -5.627621113690637),
                                    ("Thursdayfrom|since|after <time>", -4.328338129560376),
                                    ("Thursdayat <time-of-day>", -4.423648309364701),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.0330862217988015),
                                    ("Aprilyear (latent)", -6.0330862217988015),
                                    ("the <day-of-month> (ordinal)July", -6.0330862217988015),
                                    ("the <day-of-month> (number)July", -6.0330862217988015),
                                    ("monthminute", -6.0330862217988015),
                                    ("<time-of-day> am|pmtomorrow", -6.0330862217988015),
                                    ("Thursdayhh:mm", -5.116795489924646),
                                    ("<day-of-month> (ordinal)Tuesday", -5.627621113690637),
                                    ("minutemonth", -3.8930200583025307),
                                    ("time-of-day (latent)Friday", -5.627621113690637),
                                    ("minutehour", -6.0330862217988015),
                                    ("Augustyear (latent)", -5.627621113690637),
                                    ("week-endin|during <named-month>|year", -6.0330862217988015),
                                    ("time-of-day (latent)Tuesday", -5.627621113690637),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.627621113690637),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.0330862217988015),
                                    ("Sundayyear (latent)", -5.116795489924646),
                                    ("Christmasat <time-of-day>", -6.0330862217988015),
                                    ("from|since|after <time>year (latent)", -4.9344739331306915),
                                    ("hhhmmon <day>", -5.116795489924646),
                                    ("yesterday<time-of-day> am|pm", -6.0330862217988015),
                                    ("<day-of-month> (ordinal)July", -5.339939041238856),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.0330862217988015),
                                    ("mm/ddyear (latent)", -6.0330862217988015),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.0330862217988015),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.0330862217988015),
                                    ("at <time-of-day>intersect", -5.116795489924646),
                                    ("hh:mmyear (latent)", -4.646791860678911),
                                    ("Holiyear (latent)", -6.0330862217988015),
                                    ("until <time><time-of-day> am|pm", -6.0330862217988015),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.627621113690637),
                                    ("dayminute", -3.170885340869333),
                                    ("yyyy-mm-ddhh:mm", -5.627621113690637),
                                    ("intersectfrom|since|after <time>", -5.627621113690637),
                                    ("intersectSeptember", -4.16128404489721),
                                    ("minuteday", -2.876085800648688),
                                    ("absorption of , after named dayintersect",
                                     -6.0330862217988015),
                                    ("intersectyear (latent)", -6.0330862217988015),
                                    ("Februaryin|during the <part-of-day>", -6.0330862217988015),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.0330862217988015),
                                    ("time-of-day (latent)July", -5.339939041238856),
                                    ("Saturdayyear (latent)", -6.0330862217988015),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0330862217988015),
                                    ("at <time-of-day>on <day>", -5.116795489924646),
                                    ("absorption of , after named daySeptember",
                                     -4.780323253303433),
                                    ("Naraka Chaturdashiyear (latent)", -6.0330862217988015),
                                    ("from|since|after <time>on <day>", -5.116795489924646),
                                    ("dayweek", -6.0330862217988015),
                                    ("Easter Sundayyear (latent)", -5.627621113690637),
                                    ("Thursday<time-of-day> am|pm", -4.780323253303433),
                                    ("weekyear", -5.627621113690637),
                                    ("time-of-day (latent)Thursday", -5.627621113690637),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.0330862217988015),
                                    ("<day-of-month> (ordinal)April", -6.0330862217988015),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.627621113690637),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.339939041238856),
                                    ("Sundayfrom|since|after <time>", -6.0330862217988015),
                                    ("absorption of , after named dayFebruary", -5.116795489924646),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.627621113690637),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.0330862217988015),
                                    ("tomorrowat <time-of-day>", -6.0330862217988015),
                                    ("daynograin", -5.627621113690637),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.627621113690637),
                                    ("last <cycle> of <time>year (latent)", -5.627621113690637),
                                    ("tomorrow<time-of-day> am|pm", -6.0330862217988015),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.339939041238856),
                                    ("Diwaliyear (latent)", -5.627621113690637),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.0330862217988015),
                                    ("Fridayyear (latent)", -5.627621113690637),
                                    ("time-of-day (latent)April", -6.0330862217988015),
                                    ("minuteyear", -3.835861644462582)],
                               n = 277}}),
       ("one eleven",
        Classifier{okData =
