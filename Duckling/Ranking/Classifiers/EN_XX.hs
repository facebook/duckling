...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7565397573959651, unseen = -5.262690188904886,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 191},
                   koData =
                     ClassData{prior = -0.63353477775843, unseen = -5.384495062789089,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4962268243448381, unseen = -6.322565239927284,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.374858145195269),
                                    ("hourday", -3.922873021452212),
                                    ("dayhour", -2.7372493557944724),
                                    ("daymonth", -4.9344739331306915),
                                    ("monthday", -5.222156005582472),
                                    ("monthyear", -4.018183201256536),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.627621113690637),
                                    ("Easter Sundayyear", -4.9344739331306915),
                                    ("Christmasyear", -5.222156005582472),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.627621113690637),
                                    ("houryear", -5.222156005582472),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.627621113690637),
                                    ("Christmas<time-of-day> am|pm", -5.627621113690637),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.9344739331306915),
                                    ("<time-of-day> am|pmintersect", -4.374858145195269),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.627621113690637),
                                    ("Marchyear", -5.627621113690637),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.222156005582472),
                                    ("intersect<time-of-day> am|pm", -5.627621113690637),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.627621113690637),
                                    ("monthhour", -5.222156005582472),
                                    ("last <day-of-week> of <time>year", -5.627621113690637),
                                    ("todayat <time-of-day>", -5.627621113690637),
                                    ("Thursday<time> timezone", -3.922873021452212),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.627621113690637),
                                    ("dayday", -3.6127180931483722),
                                    ("Thanksgiving Dayyear", -4.529008825022527),
                                    ("<time> <part-of-day>at <time-of-day>", -5.627621113690637),
                                    ("Tuesdayin <named-month>", -5.627621113690637),
                                    ("mm/ddat <time-of-day>", -5.627621113690637),
                                    ("tonightat <time-of-day>", -5.627621113690637),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.9344739331306915),
                                    ("today<time-of-day> am|pm", -5.627621113690637),
                                    ("Februarythe <day-of-month> (ordinal)", -5.222156005582472),
                                    ("at <time-of-day><time> <part-of-day>", -5.627621113690637),
                                    ("mm/dd<time-of-day> am|pm", -5.627621113690637),
                                    ("hourhour", -4.374858145195269),
                                    ("<time-of-day> am|pmon <date>", -3.6127180931483722),
                                    ("Wednesdaythis|last|next <cycle>", -5.627621113690637),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.123543716914363),
                                    ("dayyear", -3.0626717562291),
                                    ("last weekend of <named-month>year", -5.627621113690637),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.627621113690637),
                                    ("Thursdayat <time-of-day>", -5.222156005582472),
                                    ("<time-of-day> am|pmtomorrow", -4.9344739331306915),
                                    ("minutehour", -4.711330381816482),
                                    ("Mother's Dayyear", -5.627621113690637),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.222156005582472),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.922873021452212),
                                    ("for <duration> from <time>December", -5.627621113690637),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.627621113690637),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.711330381816482),
                                    ("Mondayin|during the <part-of-day>", -5.627621113690637),
                                    ("<part-of-day> of <time>year", -5.627621113690637),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.222156005582472),
                                    ("intersectin|during the <part-of-day>", -5.627621113690637),
                                    ("Christmasat <time-of-day>", -5.627621113690637),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.222156005582472),
                                    ("<ordinal> <cycle> of <time>year", -5.627621113690637),
                                    ("minuteday", -2.1618852108909103),
                                    ("absorption of , after named dayintersect",
                                     -5.627621113690637),
                                    ("Octoberyear", -4.374858145195269),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.627621113690637),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.627621113690637),
                                    ("year<time-of-day> am|pm", -5.627621113690637),
                                    ("Septemberyear", -5.222156005582472),
                                    ("at <time-of-day>on <date>", -4.529008825022527),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.9344739331306915),
                                    ("Halloweenyear", -5.627621113690637),
                                    ("dayweek", -5.627621113690637),
                                    ("Thursday<time-of-day> am|pm", -5.627621113690637),
                                    ("weekyear", -5.222156005582472),
                                    ("hh:mmin|during the <part-of-day>", -4.9344739331306915),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.222156005582472),
                                    ("February<time> <part-of-day>", -5.627621113690637),
                                    ("Martin Luther King's Dayyear", -5.222156005582472),
                                    ("tomorrowat <time-of-day>", -4.9344739331306915),
                                    ("between <time> and <time>on <date>", -4.9344739331306915),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.9344739331306915),
                                    ("at <time-of-day>tomorrow", -5.222156005582472),
                                    ("tomorrow<time-of-day> am|pm", -5.627621113690637),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.627621113690637),
                                    ("Labor Dayyear", -5.627621113690637),
                                    ("Februaryintersect", -5.627621113690637),
                                    ("last <cycle> of <time>year", -4.9344739331306915),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.627621113690637),
                                    ("yearminute", -5.627621113690637),
                                    ("Black Fridayyear", -5.222156005582472)],
                               n = 207},
                   koData =
                     ClassData{prior = -0.9385964893884533, unseen = -6.013715156042802,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.318119993844216),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.318119993844216),
                                    ("hourday", -5.318119993844216),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.318119993844216),
                                    ("dayhour", -2.875772958475012),
                                    ("daymonth", -3.2386784521643803),
                                    ("monthday", -4.912654885736052),
                                    ("monthyear", -4.624972813284271),
                                    ("intersecthh:mm", -5.318119993844216),
                                    ("Easter Sundayyear", -5.318119993844216),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.318119993844216),
                                    ("houryear", -5.318119993844216),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.318119993844216),
                                    ("until <time-of-day><time-of-day> am|pm", -5.318119993844216),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.624972813284271),
                                    ("<time-of-day> am|pmintersect", -4.065357025348848),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.401829261970061),
                                    ("from|since|after <time-of-day>on <date>", -4.401829261970061),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.318119993844216),
                                    ("absorption of , after named dayJuly", -4.912654885736052),
                                    ("monthhour", -5.318119993844216),
                                    ("hourmonth", -4.624972813284271),
                                    ("todayat <time-of-day>", -5.318119993844216),
                                    ("from|since|after <time-of-day>July", -5.318119993844216),
                                    ("dayday", -4.912654885736052),
                                    ("mm/ddat <time-of-day>", -4.912654885736052),
                                    ("<time-of-day> am|pmon <date>", -4.065357025348848),
                                    ("dayyear", -3.708682081410116),
                                    ("Thursdaymm/dd", -5.318119993844216),
                                    ("Sundayyear", -4.912654885736052),
                                    ("Thursdayat <time-of-day>", -4.065357025348848),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.318119993844216),
                                    ("monthminute", -5.318119993844216),
                                    ("<time-of-day> am|pmtomorrow", -5.318119993844216),
                                    ("Thursdayhh:mm", -4.401829261970061),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.318119993844216),
                                    ("Fridayyear", -4.912654885736052),
                                    ("minutemonth", -3.5263605246161616),
                                    ("Sundayfrom|since|after <time-of-day>", -5.318119993844216),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.912654885736052),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.912654885736052),
                                    ("Aprilyear", -5.318119993844216),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -4.912654885736052),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.318119993844216),
                                    ("Christmasat <time-of-day>", -5.318119993844216),
                                    ("<duration> after|before|from <time>December",
                                     -5.318119993844216),
                                    ("yesterday<time-of-day> am|pm", -5.318119993844216),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.318119993844216),
                                    ("until <time-of-day>on <date>", -4.624972813284271),
                                    ("at <time-of-day>intersect", -4.912654885736052),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.318119993844216),
                                    ("dayminute", -2.792391349535961),
                                    ("intersectSeptember", -3.8140425970679424),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.318119993844216),
                                    ("minuteday", -2.400349261759937),
                                    ("absorption of , after named dayintersect",
                                     -5.318119993844216),
                                    ("Februaryin|during the <part-of-day>", -5.318119993844216),
                                    ("week-endin <named-month>", -5.318119993844216),
                                    ("Octoberyear", -5.318119993844216),
                                    ("from|since|after <time-of-day>year", -5.318119993844216),
                                    ("yearhh:mm", -5.318119993844216),
                                    ("hh:mmon <date>", -3.8140425970679424),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.318119993844216),
                                    ("absorption of , after named daySeptember",
                                     -4.401829261970061),
                                    ("on <date>September", -4.912654885736052),
                                    ("at <time-of-day>on <date>", -4.912654885736052),
                                    ("dayweek", -5.318119993844216),
                                    ("Thursday<time-of-day> am|pm", -4.912654885736052),
                                    ("absorption of , after named dayFebruary", -4.401829261970061),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.318119993844216),
                                    ("tomorrowat <time-of-day>", -5.318119993844216),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.318119993844216),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.708682081410116),
                                    ("tomorrow<time-of-day> am|pm", -5.318119993844216),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.318119993844216),
                                    ("yearminute", -5.318119993844216)],
                               n = 133}}),
       ("one eleven",
        Classifier{okData =
