...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6366349702966029, unseen = -5.616771097666572,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 273},
                   koData =
                     ClassData{prior = -0.7530453221410143,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4674751828923769, unseen = -6.679599185844383,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -5.985194934094387),
                                    ...
                                    ("Thanksgiving Dayyear (latent)", -4.886582645426277),
                                    ...
                                    ("mm/ddat <time-of-day>", -5.985194934094387),
                                    ...
                                    ("mm/dd<time-of-day> am|pm", -5.985194934094387),
                                    ...
                                    ("Thursday<time-of-day> am|pm", -5.985194934094387),
                                    ...
                                    ("Thursdayfrom|since|after <time-of-day>", -5.292047753534441),
                               ...
                               n = 297},
                   koData =
                     ClassData{prior = -0.9850575891212474, unseen = -6.320768294250582,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.625820933186489),
                                    ("hourday", -5.625820933186489),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.625820933186489),
                                    ("dayhour", -3.1834738978172847),
                                    ("daymonth", -3.5463793915066533),
                                    ("monthday", -5.220355825078324),
                                    ("monthyear", -4.373057964691121),
                                    ("<time-of-day> am|pmyear (latent)", -5.220355825078324),
                                    ("Thai Pongalyear (latent)", -4.932673752626544),
                                    ("intersecthh:mm", -5.625820933186489),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.625820933186489),
                                    ("houryear", -4.709530201312334),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.625820933186489),
                                    ("until <time-of-day><time-of-day> am|pm", -5.625820933186489),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.932673752626544),
                                    ("<time-of-day> am|pmintersect", -4.373057964691121),
                                    ("Octoberyear (latent)", -5.625820933186489),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.373057964691121),
                                    ("from|since|after <time-of-day>on <date>", -4.709530201312334),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.709530201312334),
                                    ("Clean Mondayyear (latent)", -5.625820933186489),
                                    ("monthhour", -5.625820933186489),
                                    ("hourmonth", -4.932673752626544),
                                    ("todayat <time-of-day>", -5.625820933186489),
                                    ("from|since|after <time-of-day>July", -5.625820933186489),
                                    ("Mondayyear (latent)", -4.932673752626544),
                                    ("dayday", -5.220355825078324),
                                    ("mm/ddat <time-of-day>", -5.220355825078324),
                                    ("<time-of-day> am|pmon <date>", -4.373057964691121),
                                    ("dayyear", -2.6813819540200488),
                                    ("Thursdaymm/dd", -5.625820933186489),
                                    ("New Year's Dayyear (latent)", -5.220355825078324),
                                    ("Thursdayat <time-of-day>", -4.373057964691121),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.625820933186489),
                                    ("Aprilyear (latent)", -5.625820933186489),
                                    ("monthminute", -5.625820933186489),
                                    ("<time-of-day> am|pmtomorrow", -5.625820933186489),
                                    ("Thursdayhh:mm", -4.709530201312334),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.625820933186489),
                                    ("minutemonth", -3.834061463958434),
                                    ("Sundayfrom|since|after <time-of-day>", -5.625820933186489),
                                    ("week-endin <named-month>|year", -5.625820933186489),
                                    ("Augustyear (latent)", -5.220355825078324),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.220355825078324),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.220355825078324),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.625820933186489),
                                    ("Sundayyear (latent)", -4.932673752626544),
                                    ("Christmasat <time-of-day>", -5.625820933186489),
                                    ("<duration> after|before|from <time>December",
                                     -5.625820933186489),
                                    ("yesterday<time-of-day> am|pm", -5.625820933186489),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.709530201312334),
                                    ("mm/ddyear (latent)", -5.625820933186489),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.220355825078324),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.625820933186489),
                                    ("until <time-of-day>on <date>", -4.932673752626544),
                                    ("at <time-of-day>intersect", -5.220355825078324),
                                    ("hh:mmyear (latent)", -4.527208644518379),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.625820933186489),
                                    ("dayminute", -3.1409142833984887),
                                    ("intersectSeptember", -4.121743536410215),
                                    ("minuteday", -2.557767998052872),
                                    ("absorption of , after named dayintersect",
                                     -5.625820933186489),
                                    ("Februaryin|during the <part-of-day>", -5.625820933186489),
                                    ("hh:mmon <date>", -3.6109179126442243),
                                    ("Saturdayyear (latent)", -5.625820933186489),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.625820933186489),
                                    ("absorption of , after named daySeptember",
                                     -4.709530201312334),
                                    ("Naraka Chaturdashiyear (latent)", -5.625820933186489),
                                    ("on <date>September", -5.220355825078324),
                                    ("at <time-of-day>on <date>", -5.220355825078324),
                                    ("in <named-month>|yearyear (latent)", -5.625820933186489),
                                    ("dayweek", -5.625820933186489),
                                    ("Easter Sundayyear (latent)", -5.220355825078324),
                                    ("Thursday<time-of-day> am|pm", -5.220355825078324),
                                    ("absorption of , after named dayFebruary", -4.709530201312334),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.625820933186489),
                                    ("tomorrowat <time-of-day>", -5.625820933186489),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.625820933186489),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.0163830207523885),
                                    ("tomorrow<time-of-day> am|pm", -5.625820933186489),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.932673752626544),
                                    ("Diwaliyear (latent)", -5.220355825078324),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.625820933186489),
                                    ("Fridayyear (latent)", -5.220355825078324),
                                    ("minuteyear", -4.373057964691121)],
                               n = 177}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1750487974648749, unseen = -4.787491742782046,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -5.1735674399188865e-2),
                                    ("intersect 2 numbers", -3.392829131991639)],
                               n = 115},
                   koData =
                     ClassData{prior = -1.828938472469809, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
