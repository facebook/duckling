...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6182263103801562, unseen = -5.655991810819852,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 284},
                   koData =
                     ClassData{prior = -0.7741391052008139,
                                 ...
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.010040932680917),
                                    ...
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.316893752120972),
                                    ("Navaratriin|since <named-month>|year", -6.010040932680917),
                                    ...
                                    ("Tuesdayin|since <named-month>|year", -6.010040932680917),
                                    ...
                                    ("Diwaliin|since <named-month>|year", -6.010040932680917),
                                    ...
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.316893752120972),
                                    ("Chhathin|since <named-month>|year", -6.010040932680917),
                                    ...
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.604575824572753),
                                    ("Thai Pongalin|since <named-month>|year", -6.010040932680917),
                                    ...
                                    ("Dhanterasin|since <named-month>|year", -6.010040932680917),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                    ...
                                    ("week-endin|since <named-month>|year", -5.636573724962751),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.16332505610329964,
                               unseen = -4.859812404361672,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -4.8009219186360606e-2),
                                    ("intersect 2 numbers", -3.4657359027997265)],
                               n = 124},
                   koData =
                     ClassData{prior = -1.8925641683500207, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
