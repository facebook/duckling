...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6064439225066617, unseen = -5.6937321388027,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 295},
                   koData =
                     ClassData{prior = -0.7880877429141188,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4797281791377304, unseen = -6.716594773520978,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.022236205774735),
                                    ("Ramadanyear (latent)", -6.022236205774735),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.769473237279367),
                                    ("Bhai Doojyear (latent)", -6.022236205774735),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.769473237279367),
                                    ("hourday", -4.31748811353631),
                                    ("dayhour", -3.2188758248682006),
                                    ("Martin Luther King's Dayyear (latent)", -5.616771097666572),
                                    ("Shemini Atzeretyear (latent)", -6.022236205774735),
                                    ("daymonth", -5.32908902521479),
                                    ("monthday", -5.616771097666572),
                                    ("monthyear", -4.230476736546681),
                                    ("Yom Ha'atzmautyear (latent)", -6.022236205774735),
                                    ("Vijayadashamiyear (latent)", -6.022236205774735),
                                    ("Thanksgiving Dayyear (latent)", -4.923623917106626),
                                    ("Thai Pongalyear (latent)", -5.32908902521479),
                                    ("Thiru Onamyear (latent)", -5.32908902521479),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.022236205774735),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.022236205774735),
                                    ("houryear", -5.32908902521479),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.022236205774735),
                                    ("Christmas<time-of-day> am|pm", -6.022236205774735),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.022236205774735),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.32908902521479),
                                    ("<time-of-day> am|pmintersect", -4.769473237279367),
                                    ("Octoberyear (latent)", -4.518158808998462),
                                    ("intersect<time-of-day> am|pm", -6.022236205774735),
                                    ("Mattu Pongalyear (latent)", -6.022236205774735),
                                    ("Shavuotyear (latent)", -6.022236205774735),
                                    ("Dhanterasin <named-month>|year", -6.022236205774735),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.022236205774735),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.022236205774735),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.616771097666572),
                                    ("Marchyear (latent)", -6.022236205774735),
                                    ("Sukkotyear (latent)", -5.616771097666572),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.022236205774735),
                                    ("Clean Mondayyear (latent)", -5.616771097666572),
                                    ("monthhour", -5.616771097666572),
                                    ("todayat <time-of-day>", -6.022236205774735),
                                    ("Thursday<time> timezone", -4.31748811353631),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.022236205774735),
                                    ("Palm SundaySunday", -5.616771097666572),
                                    ("dayday", -3.8250116284385163),
                                    ("<time> <part-of-day>at <time-of-day>", -6.022236205774735),
                                    ("mm/ddat <time-of-day>", -6.022236205774735),
                                    ("tonightat <time-of-day>", -6.022236205774735),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.32908902521479),
                                    ("today<time-of-day> am|pm", -6.022236205774735),
                                    ("Februarythe <day-of-month> (ordinal)", -5.616771097666572),
                                    ("at <time-of-day><time> <part-of-day>", -6.022236205774735),
                                    ("mm/dd<time-of-day> am|pm", -6.022236205774735),
                                    ("hourhour", -4.769473237279367),
                                    ("<time-of-day> am|pmon <date>", -4.007333185232471),
                                    ("Wednesdaythis|last|next <cycle>", -6.022236205774735),
                                    ("Lentyear (latent)", -6.022236205774735),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.518158808998462),
                                    ("Boghiyear (latent)", -6.022236205774735),
                                    ("dayyear", -2.0149030205422647),
                                    ("Thursdayfrom|since|after <time>", -5.616771097666572),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.022236205774735),
                                    ("Thursdayat <time-of-day>", -5.616771097666572),
                                    ("Islamic New Yearyear (latent)", -5.616771097666572),
                                    ("Laylat al-Qadryear (latent)", -5.10594547390058),
                                    ("Chhathin <named-month>|year", -6.022236205774735),
                                    ("Vasant Panchamiin <named-month>|year", -6.022236205774735),
                                    ("Diwaliin <named-month>|year", -6.022236205774735),
                                    ("Shrove Tuesdayyear (latent)", -6.022236205774735),
                                    ("<time-of-day> am|pmtomorrow", -5.32908902521479),
                                    ("Yom Kippuryear (latent)", -6.022236205774735),
                                    ("<part-of-day> of <time>year (latent)", -6.022236205774735),
                                    ("minutehour", -5.10594547390058),
                                    ("Kaanum Pongalyear (latent)", -5.616771097666572),
                                    ("Maha Saptamiyear (latent)", -6.022236205774735),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.616771097666572),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.31748811353631),
                                    ("for <duration> from <time>December", -6.022236205774735),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.022236205774735),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.10594547390058),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.616771097666572),
                                    ("Pentecostyear (latent)", -6.022236205774735),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.10594547390058),
                                    ("Eid al-Fitryear (latent)", -6.022236205774735),
                                    ("Mondayin|during the <part-of-day>", -6.022236205774735),
                                    ("Raksha Bandhanyear (latent)", -6.022236205774735),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.616771097666572),
                                    ("Navaratriin <named-month>|year", -6.022236205774735),
                                    ("Ashurayear (latent)", -6.022236205774735),
                                    ("Chinese New Yearyear (latent)", -6.022236205774735),
                                    ("Sundayyear (latent)", -6.022236205774735),
                                    ("Lag BaOmeryear (latent)", -6.022236205774735),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.022236205774735),
                                    ("Eid al-Adhayear (latent)", -5.10594547390058),
                                    ("intersectin|during the <part-of-day>", -6.022236205774735),
                                    ("Christmasat <time-of-day>", -6.022236205774735),
                                    ("Passoveryear (latent)", -6.022236205774735),
                                    ("Lazarus Saturdayyear (latent)", -6.022236205774735),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.022236205774735),
                                    ("Yom HaShoahyear (latent)", -5.616771097666572),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.616771097666572),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.022236205774735),
                                    ("Thai Pongalin <named-month>|year", -6.022236205774735),
                                    ("Septemberyear (latent)", -5.616771097666572),
                                    ("mm/ddyear (latent)", -6.022236205774735),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.769473237279367),
                                    ("Halloweenyear (latent)", -6.022236205774735),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -6.022236205774735),
                                    ("Dhanterasyear (latent)", -6.022236205774735),
                                    ("Tu BiShvatyear (latent)", -6.022236205774735),
                                    ("Holiyear (latent)", -5.32908902521479),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.022236205774735),
                                    ("Holika Dahanyear (latent)", -5.32908902521479),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.022236205774735),
                                    ("dayminute", -3.383178876159477),
                                    ("Mawlidyear (latent)", -6.022236205774735),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.616771097666572),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.022236205774735),
                                    ("Jumu'atul-Widayear (latent)", -5.10594547390058),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.022236205774735),
                                    ("minuteday", -2.3846500460483497),
                                    ("absorption of , after named dayintersect",
                                     -6.022236205774735),
                                    ("intersectyear (latent)", -6.022236205774735),
                                    ("Orthodox Easter Sundayyear (latent)", -6.022236205774735),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.022236205774735),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.022236205774735),
                                    ("Boss's Dayyear (latent)", -5.616771097666572),
                                    ("Global Youth Service Dayyear (latent)", -6.022236205774735),
                                    ("Tisha B'Avyear (latent)", -6.022236205774735),
                                    ("Isra and Mi'rajyear (latent)", -5.10594547390058),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.022236205774735),
                                    ("Christmasyear (latent)", -5.616771097666572),
                                    ("Naraka Chaturdashiyear (latent)", -5.616771097666572),
                                    ("at <time-of-day>on <date>", -4.923623917106626),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.412798293340635),
                                    ("dayweek", -6.022236205774735),
                                    ("Easter Sundayyear (latent)", -5.32908902521479),
                                    ("weekyear", -4.923623917106626),
                                    ("hh:mmin|during the <part-of-day>", -5.32908902521479),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.616771097666572),
                                    ("Hanukkahyear (latent)", -6.022236205774735),
                                    ("February<time> <part-of-day>", -6.022236205774735),
                                    ("Tuesdayin <named-month>|year", -6.022236205774735),
                                    ("Great Lentyear (latent)", -6.022236205774735),
                                    ("tomorrowat <time-of-day>", -5.32908902521479),
                                    ("between <time> and <time>on <date>", -4.412798293340635),
                                    ("last <cycle> of <time>year (latent)", -5.32908902521479),
                                    ("at <time-of-day>tomorrow", -5.616771097666572),
                                    ("tomorrow<time-of-day> am|pm", -6.022236205774735),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.022236205774735),
                                    ("Diwaliyear (latent)", -6.022236205774735),
                                    ("Black Fridayyear (latent)", -5.616771097666572),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.022236205774735),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.022236205774735),
                                    ("Chhathyear (latent)", -5.616771097666572),
                                    ("Vasant Panchamiyear (latent)", -6.022236205774735),
                                    ("Palm Sundayintersect", -6.022236205774735),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.022236205774735),
                                    ("Februaryintersect", -6.022236205774735),
                                    ("Simchat Torahyear (latent)", -6.022236205774735)],
                               n = 307},
                   koData =
                     ClassData{prior = -0.9648289116652852, unseen = -6.380122536899766,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.768988271217486),
                                    ("hourday", -4.768988271217486),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.685279003091641),
                                    ("dayhour", -3.120329645630105),
                                    ("Tuesdayfrom|since|after <time>", -5.685279003091641),
                                    ("daymonth", -3.545212839595371),
                                    ("monthday", -5.2798138949834765),
                                    ("monthyear", -4.432516034596273),
                                    ("<time-of-day> am|pmyear (latent)", -5.2798138949834765),
                                    ("Thai Pongalyear (latent)", -4.992131822531696),
                                    ("intersecthh:mm", -5.685279003091641),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.685279003091641),
                                    ("houryear", -4.768988271217486),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.685279003091641),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.992131822531696),
                                    ("<time-of-day> am|pmintersect", -4.432516034596273),
                                    ("until <time>on <date>", -4.992131822531696),
                                    ("Octoberyear (latent)", -5.685279003091641),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.685279003091641),
                                    ("absorption of , after named dayJuly", -5.2798138949834765),
                                    ("from|since|after <time>July", -5.685279003091641),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.768988271217486),
                                    ("Clean Mondayyear (latent)", -5.685279003091641),
                                    ("monthhour", -5.685279003091641),
                                    ("hourmonth", -4.768988271217486),
                                    ("todayat <time-of-day>", -5.685279003091641),
                                    ("from|since|after <time>December", -5.685279003091641),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.685279003091641),
                                    ("Mondayyear (latent)", -4.992131822531696),
                                    ("dayday", -5.2798138949834765),
                                    ("mm/ddat <time-of-day>", -5.2798138949834765),
                                    ("<time-of-day> am|pmon <date>", -4.432516034596273),
                                    ("dayyear", -2.7148645375219402),
                                    ("Thursdaymm/dd", -5.685279003091641),
                                    ("New Year's Dayyear (latent)", -5.2798138949834765),
                                    ("Thursdayfrom|since|after <time>", -3.9805309108532163),
                                    ("Thursdayat <time-of-day>", -4.432516034596273),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.685279003091641),
                                    ("Aprilyear (latent)", -5.685279003091641),
                                    ("monthminute", -5.685279003091641),
                                    ("<time-of-day> am|pmtomorrow", -5.685279003091641),
                                    ("Thursdayhh:mm", -4.768988271217486),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.685279003091641),
                                    ("minutemonth", -3.893519533863586),
                                    ("week-endin <named-month>|year", -5.685279003091641),
                                    ("Augustyear (latent)", -5.2798138949834765),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.2798138949834765),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.2798138949834765),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.685279003091641),
                                    ("Sundayyear (latent)", -4.992131822531696),
                                    ("Christmasat <time-of-day>", -5.685279003091641),
                                    ("from|since|after <time>year (latent)", -4.432516034596273),
                                    ("<duration> after|before|from <time>December",
                                     -5.685279003091641),
                                    ("yesterday<time-of-day> am|pm", -5.685279003091641),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.768988271217486),
                                    ("mm/ddyear (latent)", -5.685279003091641),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.992131822531696),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.685279003091641),
                                    ("at <time-of-day>intersect", -5.2798138949834765),
                                    ("hh:mmyear (latent)", -4.586666714423532),
                                    ("Holiyear (latent)", -5.685279003091641),
                                    ("until <time><time-of-day> am|pm", -5.685279003091641),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.685279003091641),
                                    ("dayminute", -3.159550358783386),
                                    ("intersectSeptember", -4.181201606315367),
                                    ("minuteday", -2.617226067958024),
                                    ("absorption of , after named dayintersect",
                                     -5.685279003091641),
                                    ("Februaryin|during the <part-of-day>", -5.685279003091641),
                                    ("hh:mmon <date>", -3.6703759825493765),
                                    ("Saturdayyear (latent)", -5.685279003091641),
                                    ("from|since|after <time>on <date>", -4.768988271217486),
                                    ("absorption of , after named daySeptember",
                                     -4.768988271217486),
                                    ("Naraka Chaturdashiyear (latent)", -5.685279003091641),
                                    ("on <date>September", -5.2798138949834765),
                                    ("at <time-of-day>on <date>", -5.2798138949834765),
                                    ("in <named-month>|yearyear (latent)", -5.685279003091641),
                                    ("dayweek", -5.685279003091641),
                                    ("Easter Sundayyear (latent)", -5.2798138949834765),
                                    ("Thursday<time-of-day> am|pm", -4.992131822531696),
                                    ("weekyear", -5.2798138949834765),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.685279003091641),
                                    ("Sundayfrom|since|after <time>", -5.685279003091641),
                                    ("absorption of , after named dayFebruary", -4.768988271217486),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.685279003091641),
                                    ("tomorrowat <time-of-day>", -5.685279003091641),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.685279003091641),
                                    ("last <cycle> of <time>year (latent)", -5.2798138949834765),
                                    ("tomorrow<time-of-day> am|pm", -5.685279003091641),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.992131822531696),
                                    ("Diwaliyear (latent)", -5.2798138949834765),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.685279003091641),
                                    ("Fridayyear (latent)", -5.2798138949834765),
                                    ("minuteyear", -4.432516034596273)],
                               n = 189}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1530759886974929, unseen = -4.927253685157205,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 133},
                   koData =
                     ClassData{prior = -1.9523826635609307, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
