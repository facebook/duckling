...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6133947907865465, unseen = -5.666426688112432,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 287},
                   koData =
                     ClassData{prior = -0.7798155632056191,
       ...
       ("from|since|after <time>",
        Classifier{okData =
                     ClassData{prior = -1.6582280766035324, unseen = -4.174387269895637,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -4.02535169073515),
                                    ("week", -4.430816798843313),
                                    ("<day-of-month> (ordinal or number) <named-month>",
                                     -4.430816798843313),
                                    ("today", -4.430816798843313),
                                    ("intersect", -2.559014621941722),
                                    ("second", -4.430816798843313), ("now", -3.5145260669691587),
                                    ("tomorrow", -4.02535169073515),
                                    ("this|last|next <cycle>", -4.430816798843313),
                                    ("day", -1.988469763474109),
                                    ("time-of-day (latent)", -2.7260687066048885),
                                    ("<time-of-day> am|pm", -4.02535169073515),
                                    ("nograin", -3.5145260669691587),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)",
                                     -4.430816798843313),
                                    ("<day-of-month> (ordinal)", -4.02535169073515),
                                    ("Easter Sunday", -4.430816798843313),
                                    ("Christmas", -3.7376696182833684),
                                    ("hour", -2.290750635347043), ("month", -4.430816798843313),
                                    ("<datetime> - <datetime> (interval)", -3.044522437723423),
                                    ("<time-of-day> - <time-of-day> (interval)",
                                     -2.7260687066048885),
                                    ("<named-month> <day-of-month> (non ordinal)",
                                     -4.02535169073515),
                                    ("minute", -1.9459101490553135),
                                    ("right now", -4.430816798843313),
                                    ("<month> dd-dd (interval)", -3.7376696182833684),
                                    ("part of days", -4.430816798843313),
                                    ("dd-dd <month> (interval)", -4.02535169073515)],
                               n = 68}}),
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48019739743527856, unseen = -6.70808408385307,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.013715156042802),
                                    ("Ramadanyear (latent)", -6.013715156042802),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.760952187547434),
                                    ("Bhai Doojyear (latent)", -6.013715156042802),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.760952187547434),
                                    ("hourday", -4.308967063804377),
                                    ("dayhour", -3.0959444239585228),
                                    ("Martin Luther King's Dayyear (latent)", -5.6082500479346375),
                                    ("Shemini Atzeretyear (latent)", -6.013715156042802),
                                    ("daymonth", -5.320567975482857),
                                    ("monthday", -5.6082500479346375),
                                    ("monthyear", -4.404277243608702),
                                    ("Yom Ha'atzmautyear (latent)", -6.013715156042802),
                                    ("Vijayadashamiyear (latent)", -6.013715156042802),
                                    ("Thanksgiving Dayyear (latent)", -4.915102867374692),
                                    ("Thai Pongalyear (latent)", -5.320567975482857),
                                    ("Thiru Onamyear (latent)", -5.320567975482857),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.013715156042802),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.013715156042802),
                                    ("houryear", -5.320567975482857),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.013715156042802),
                                    ("Christmas<time-of-day> am|pm", -6.013715156042802),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.013715156042802),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.320567975482857),
                                    ("<time-of-day> am|pmintersect", -4.760952187547434),
                                    ("Octoberyear (latent)", -4.760952187547434),
                                    ("intersect<time-of-day> am|pm", -6.013715156042802),
                                    ("Mattu Pongalyear (latent)", -6.013715156042802),
                                    ("Shavuotyear (latent)", -6.013715156042802),
                                    ("Dhanterasin <named-month>|year", -6.013715156042802),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.013715156042802),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.013715156042802),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.6082500479346375),
                                    ("Marchyear (latent)", -6.013715156042802),
                                    ("Sukkotyear (latent)", -5.6082500479346375),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.013715156042802),
                                    ("Clean Mondayyear (latent)", -5.6082500479346375),
                                    ("monthhour", -5.6082500479346375),
                                    ("todayat <time-of-day>", -6.013715156042802),
                                    ("Thursday<time> timezone", -4.308967063804377),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.013715156042802),
                                    ("Palm SundaySunday", -5.6082500479346375),
                                    ("dayday", -3.816490578706582),
                                    ("<time> <part-of-day>at <time-of-day>", -6.013715156042802),
                                    ("mm/ddat <time-of-day>", -6.013715156042802),
                                    ("tonightat <time-of-day>", -6.013715156042802),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.320567975482857),
                                    ("today<time-of-day> am|pm", -6.013715156042802),
                                    ("Februarythe <day-of-month> (ordinal)", -5.6082500479346375),
                                    ("at <time-of-day><time> <part-of-day>", -6.013715156042802),
                                    ("mm/dd<time-of-day> am|pm", -6.013715156042802),
                                    ("hourhour", -4.760952187547434),
                                    ("<time-of-day> am|pmon <date>", -3.998812135500537),
                                    ("Wednesdaythis|last|next <cycle>", -6.013715156042802),
                                    ("Lentyear (latent)", -6.013715156042802),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.5096377592665275),
                                    ("Boghiyear (latent)", -6.013715156042802),
                                    ("dayyear", -2.015514454373603),
                                    ("Thursdayfrom|since|after <time>", -5.320567975482857),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.013715156042802),
                                    ("Thursdayat <time-of-day>", -5.6082500479346375),
                                    ("Islamic New Yearyear (latent)", -5.6082500479346375),
                                    ("Laylat al-Qadryear (latent)", -5.097424424168647),
                                    ("Chhathin <named-month>|year", -6.013715156042802),
                                    ("Vasant Panchamiin <named-month>|year", -6.013715156042802),
                                    ("Diwaliin <named-month>|year", -6.013715156042802),
                                    ("Shrove Tuesdayyear (latent)", -6.013715156042802),
                                    ("<time-of-day> am|pmtomorrow", -5.320567975482857),
                                    ("Yom Kippuryear (latent)", -6.013715156042802),
                                    ("<part-of-day> of <time>year (latent)", -6.013715156042802),
                                    ("minutehour", -5.097424424168647),
                                    ("Kaanum Pongalyear (latent)", -5.6082500479346375),
                                    ("Maha Saptamiyear (latent)", -6.013715156042802),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.6082500479346375),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.308967063804377),
                                    ("for <duration> from <time>December", -6.013715156042802),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.013715156042802),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.097424424168647),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.6082500479346375),
                                    ("Pentecostyear (latent)", -6.013715156042802),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.097424424168647),
                                    ("Eid al-Fitryear (latent)", -6.013715156042802),
                                    ("Mondayin|during the <part-of-day>", -6.013715156042802),
                                    ("Raksha Bandhanyear (latent)", -6.013715156042802),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.6082500479346375),
                                    ("Navaratriin <named-month>|year", -6.013715156042802),
                                    ("Ashurayear (latent)", -6.013715156042802),
                                    ("Chinese New Yearyear (latent)", -6.013715156042802),
                                    ("Sundayyear (latent)", -6.013715156042802),
                                    ("Lag BaOmeryear (latent)", -6.013715156042802),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.013715156042802),
                                    ("Eid al-Adhayear (latent)", -5.097424424168647),
                                    ("intersectin|during the <part-of-day>", -6.013715156042802),
                                    ("Christmasat <time-of-day>", -6.013715156042802),
                                    ("Passoveryear (latent)", -6.013715156042802),
                                    ("Lazarus Saturdayyear (latent)", -6.013715156042802),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.013715156042802),
                                    ("Yom HaShoahyear (latent)", -5.6082500479346375),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.097424424168647),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.013715156042802),
                                    ("Thai Pongalin <named-month>|year", -6.013715156042802),
                                    ("Septemberyear (latent)", -5.6082500479346375),
                                    ("mm/ddyear (latent)", -6.013715156042802),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.760952187547434),
                                    ("Halloweenyear (latent)", -6.013715156042802),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -6.013715156042802),
                                    ("Dhanterasyear (latent)", -6.013715156042802),
                                    ("Tu BiShvatyear (latent)", -6.013715156042802),
                                    ("Holiyear (latent)", -5.320567975482857),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.013715156042802),
                                    ("Holika Dahanyear (latent)", -5.320567975482857),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.013715156042802),
                                    ("dayminute", -3.3746578264275433),
                                    ("Mawlidyear (latent)", -6.013715156042802),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.6082500479346375),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.013715156042802),
                                    ("Jumu'atul-Widayear (latent)", -5.097424424168647),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.013715156042802),
                                    ("minuteday", -2.376128996316416),
                                    ("absorption of , after named dayintersect",
                                     -6.013715156042802),
                                    ("intersectyear (latent)", -6.013715156042802),
                                    ("Orthodox Easter Sundayyear (latent)", -6.013715156042802),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.013715156042802),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.013715156042802),
                                    ("Boss's Dayyear (latent)", -5.6082500479346375),
                                    ("Tisha B'Avyear (latent)", -6.013715156042802),
                                    ("Isra and Mi'rajyear (latent)", -5.097424424168647),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.013715156042802),
                                    ("Christmasyear (latent)", -5.6082500479346375),
                                    ("Naraka Chaturdashiyear (latent)", -5.6082500479346375),
                                    ("at <time-of-day>on <date>", -4.915102867374692),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.404277243608702),
                                    ("dayweek", -6.013715156042802),
                                    ("Easter Sundayyear (latent)", -5.320567975482857),
                                    ("Thursday<time-of-day> am|pm", -6.013715156042802),
                                    ("weekyear", -5.6082500479346375),
                                    ("hh:mmin|during the <part-of-day>", -5.320567975482857),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.6082500479346375),
                                    ("Hanukkahyear (latent)", -6.013715156042802),
                                    ("February<time> <part-of-day>", -6.013715156042802),
                                    ("Tuesdayin <named-month>|year", -6.013715156042802),
                                    ("Great Lentyear (latent)", -6.013715156042802),
                                    ("tomorrowat <time-of-day>", -5.320567975482857),
                                    ("between <time> and <time>on <date>", -4.404277243608702),
                                    ("last <cycle> of <time>year (latent)", -5.320567975482857),
                                    ("at <time-of-day>tomorrow", -5.6082500479346375),
                                    ("tomorrow<time-of-day> am|pm", -6.013715156042802),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.013715156042802),
                                    ("Diwaliyear (latent)", -6.013715156042802),
                                    ("Black Fridayyear (latent)", -5.6082500479346375),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.013715156042802),
                                    ("Chhathyear (latent)", -5.6082500479346375),
                                    ("Vasant Panchamiyear (latent)", -6.013715156042802),
                                    ("Palm Sundayintersect", -6.013715156042802),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.013715156042802),
                                    ("Februaryintersect", -6.013715156042802),
                                    ("Simchat Torahyear (latent)", -6.013715156042802)],
                               n = 305},
                   koData =
                     ClassData{prior = -0.964067211212741, unseen = -6.371611847231857,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.760463070394127),
                                    ...
                                    ("Thursdayfrom|since|after <time>", -3.8049516253666904),
                                    ...
                                    ("Thursday<time-of-day> am|pm", -5.271288694160117),
