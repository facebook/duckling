...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.596616744350391, unseen = -6.115892125483034,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 451},
                   koData =
                     ClassData{prior = -0.8000011456841385, unseen = -5.91350300563827,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45864737356847357,
                               unseen = -7.1180162044653335,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.424058322604399),
                                    ("Karva Chauthyear (latent)", -6.424058322604399),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.424058322604399),
                                    ("Maha Shivaratriyear (latent)", -6.424058322604399),
                                    ("Ramadanyear (latent)", -5.171295354109031),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.037763961484508),
                                    ("Bhai Doojyear (latent)", -6.424058322604399),
                                    ("hourday", -4.409155302062135),
                                    ("dayhour", -3.4796193434379585),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.037763961484508),
                                    ("Martin Luther King's Dayyear (latent)", -6.018593214496234),
                                    ("Shemini Atzeretyear (latent)", -6.424058322604399),
                                    ("daymonth", -4.283992159108128),
                                    ("monthday", -6.018593214496234),
                                    ("monthyear", -4.552256145702808),
                                    ("Yom Ha'atzmautyear (latent)", -6.424058322604399),
                                    ("Vijayadashamiyear (latent)", -6.424058322604399),
                                    ("Thanksgiving Dayyear (latent)", -5.32544603393629),
                                    ("Thai Pongalyear (latent)", -5.730911142044453),
                                    ("Thiru Onamyear (latent)", -5.730911142044453),
                                    ("hhhmmabsorption of , after named day", -6.424058322604399),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.424058322604399),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.507767590730244),
                                    ("<day-of-month> (ordinal)Wednesday", -6.424058322604399),
                                    ("Krishna Janmashtamiyear (latent)", -6.018593214496234),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.424058322604399),
                                    ("houryear", -5.507767590730244),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.424058322604399),
                                    ("Christmas<time-of-day> am|pm", -6.424058322604399),
                                    ("<day-of-month> (ordinal)October", -6.424058322604399),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.424058322604399),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.730911142044453),
                                    ("intersectin|during <named-month>|year", -6.424058322604399),
                                    ("<time-of-day> am|pmintersect", -5.171295354109031),
                                    ("Earth Houryear (latent)", -6.424058322604399),
                                    ("Octoberyear (latent)", -4.814620410170298),
                                    ("intersect<time-of-day> am|pm", -6.424058322604399),
                                    ("Mattu Pongalyear (latent)", -6.424058322604399),
                                    ("Shavuotyear (latent)", -6.424058322604399),
                                    ("Parsi New Yearyear (latent)", -5.507767590730244),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.424058322604399),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.424058322604399),
                                    ("todayin|within|after <duration>", -6.424058322604399),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.018593214496234),
                                    ("Marchyear (latent)", -6.424058322604399),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.018593214496234),
                                    ("Sukkotyear (latent)", -6.018593214496234),
                                    ("hhhmmintersect", -6.018593214496234),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.018593214496234),
                                    ("Clean Mondayyear (latent)", -6.018593214496234),
                                    ("monthhour", -6.018593214496234),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.730911142044453),
                                    ("todayat <time-of-day>", -6.424058322604399),
                                    ("Thursday<time> timezone", -4.026163049806028),
                                    ("time-of-day (latent)tonight", -6.018593214496234),
                                    ("from|since|after <time>December", -6.424058322604399),
                                    ("<time-of-day> am|pmon <day>", -4.409155302062135),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.424058322604399),
                                    ("yyyy-mm-ddhh:mm:ss", -6.018593214496234),
                                    ("dayday", -3.7160081215021887),
                                    ("<time> <part-of-day>at <time-of-day>", -6.424058322604399),
                                    ("mm/ddat <time-of-day>", -5.730911142044453),
                                    ("tonightat <time-of-day>", -6.424058322604399),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.730911142044453),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.424058322604399),
                                    ("today<time-of-day> am|pm", -6.424058322604399),
                                    ("Februarythe <day-of-month> (ordinal)", -6.018593214496234),
                                    ("at <time-of-day><time> <part-of-day>", -6.424058322604399),
                                    ("<day-of-month> (ordinal)intersect", -5.730911142044453),
                                    ("mm/dd<time-of-day> am|pm", -6.424058322604399),
                                    ("hourhour", -4.344616780924563),
                                    ("Mahavir Jayantiyear (latent)", -6.018593214496234),
                                    ("Navaratriin|during <named-month>|year", -6.424058322604399),
                                    ("Wednesdaythis|last|next <cycle>", -6.424058322604399),
                                    ("Lentyear (latent)", -6.424058322604399),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.552256145702808),
                                    ("Boghiyear (latent)", -6.424058322604399),
                                    ("dayyear", -1.8701814310038583),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.424058322604399),
                                    ("Thursdayfrom|since|after <time>", -6.018593214496234),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.424058322604399),
                                    ("Thursdayat <time-of-day>", -5.730911142044453),
                                    ("Islamic New Yearyear (latent)", -6.018593214496234),
                                    ("Laylat al-Qadryear (latent)", -5.507767590730244),
                                    ("Shrove Tuesdayyear (latent)", -6.424058322604399),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.730911142044453),
                                    ("<time-of-day> am|pmtomorrow", -5.730911142044453),
                                    ("Yom Kippuryear (latent)", -6.424058322604399),
                                    ("<day-of-month> (ordinal)Tuesday", -6.018593214496234),
                                    ("<part-of-day> of <time>year (latent)", -6.424058322604399),
                                    ("minutehour", -5.171295354109031),
                                    ("Kaanum Pongalyear (latent)", -6.018593214496234),
                                    ("Maha Saptamiyear (latent)", -6.424058322604399),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.018593214496234),
                                    ("time-of-day (latent)tomorrow", -5.507767590730244),
                                    ("part of daysat <time-of-day>", -6.018593214496234),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.409155302062135),
                                    ("for <duration> from <time>December", -6.424058322604399),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.424058322604399),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.171295354109031),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.171295354109031),
                                    ("time-of-day (latent)this <part-of-day>", -6.424058322604399),
                                    ("Pentecostyear (latent)", -6.424058322604399),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.171295354109031),
                                    ("<day-of-month> (ordinal)February", -6.424058322604399),
                                    ("Eid al-Fitryear (latent)", -5.037763961484508),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.424058322604399),
                                    ("Mondayin|during the <part-of-day>", -6.424058322604399),
                                    ("Chhathin|during <named-month>|year", -6.424058322604399),
                                    ("Diwaliin|during <named-month>|year", -6.424058322604399),
                                    ("Vaisakhiin|during <named-month>|year", -6.424058322604399),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.171295354109031),
                                    ("Raksha Bandhanyear (latent)", -6.424058322604399),
                                    ("daysecond", -6.018593214496234),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.018593214496234),
                                    ("Ashurayear (latent)", -6.424058322604399),
                                    ("Tuesdayin|during <named-month>|year", -6.424058322604399),
                                    ("Chinese New Yearyear (latent)", -6.424058322604399),
                                    ("tomorrowintersect", -6.424058322604399),
                                    ("Lag BaOmeryear (latent)", -6.424058322604399),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.424058322604399),
                                    ("Eid al-Adhayear (latent)", -4.283992159108128),
                                    ("intersectin|during the <part-of-day>", -6.424058322604399),
                                    ("Palm Sundayyear (latent)", -6.424058322604399),
                                    ("Christmasat <time-of-day>", -6.424058322604399),
                                    ("Passoveryear (latent)", -6.424058322604399),
                                    ("Lazarus Saturdayyear (latent)", -6.424058322604399),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.018593214496234),
                                    ("hhhmmon <day>", -5.507767590730244),
                                    ("Yom HaShoahyear (latent)", -6.018593214496234),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.018593214496234),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.424058322604399),
                                    ("Septemberyear (latent)", -6.018593214496234),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.919980925828125),
                                    ("Halloweenyear (latent)", -6.424058322604399),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.424058322604399),
                                    ("at <time-of-day>intersect", -5.507767590730244),
                                    ("Rosh Hashanahyear (latent)", -5.730911142044453),
                                    ("Dhanterasyear (latent)", -6.424058322604399),
                                    ("Tu BiShvatyear (latent)", -6.424058322604399),
                                    ("<day-of-month> (ordinal)December", -5.730911142044453),
                                    ("Holiyear (latent)", -5.730911142044453),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.424058322604399),
                                    ("Holika Dahanyear (latent)", -5.730911142044453),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.018593214496234),
                                    ("dayminute", -3.039668059258625),
                                    ("Mawlidyear (latent)", -6.424058322604399),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.018593214496234),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.424058322604399),
                                    ("Jumu'atul-Widayear (latent)", -5.507767590730244),
                                    ("minuteday", -2.686388704321031),
                                    ("absorption of , after named dayintersect",
                                     -5.730911142044453),
                                    ("intersectyear (latent)", -6.018593214496234),
                                    ("Orthodox Easter Sundayyear (latent)", -6.424058322604399),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.424058322604399),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.424058322604399),
                                    ("intersecthhhmm", -6.018593214496234),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.424058322604399),
                                    ("Boss's Dayyear (latent)", -6.018593214496234),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.424058322604399),
                                    ("Global Youth Service Dayyear (latent)", -6.424058322604399),
                                    ("Dhanterasin|during <named-month>|year", -6.424058322604399),
                                    ("Tisha B'Avyear (latent)", -6.424058322604399),
                                    ("Isra and Mi'rajyear (latent)", -5.507767590730244),
                                    ("at <time-of-day>on <day>", -4.814620410170298),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.018593214496234),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.730911142044453),
                                    ("Christmasyear (latent)", -6.018593214496234),
                                    ("Naraka Chaturdashiyear (latent)", -6.018593214496234),
                                    ("Thai Pongalin|during <named-month>|year", -6.424058322604399),
                                    ("dayweek", -6.424058322604399),
                                    ("Easter Sundayyear (latent)", -5.730911142044453),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.018593214496234),
                                    ("weekyear", -5.32544603393629),
                                    ("King's Dayyear (latent)", -4.919980925828125),
                                    ("hh:mmin|during the <part-of-day>", -5.507767590730244),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.018593214496234),
                                    ("Hanukkahyear (latent)", -5.730911142044453),
                                    ("February<time> <part-of-day>", -6.424058322604399),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.424058322604399),
                                    ("Great Lentyear (latent)", -6.424058322604399),
                                    ("tomorrowat <time-of-day>", -5.730911142044453),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.424058322604399),
                                    ("Ugadiyear (latent)", -5.037763961484508),
                                    ("Vaisakhiyear (latent)", -5.730911142044453),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.730911142044453),
                                    ("last <cycle> of <time>year (latent)", -5.730911142044453),
                                    ("at <time-of-day>tomorrow", -6.018593214496234),
                                    ("tomorrow<time-of-day> am|pm", -6.424058322604399),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.424058322604399),
                                    ("Diwaliyear (latent)", -6.424058322604399),
                                    ("between <time> and <time>on <day>", -6.018593214496234),
                                    ("Black Fridayyear (latent)", -6.018593214496234),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.424058322604399),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.424058322604399),
                                    ("Chhathyear (latent)", -6.018593214496234),
                                    ("Vasant Panchamiyear (latent)", -6.424058322604399),
                                    ("Rabindra Jayantiyear (latent)", -5.171295354109031),
                                    ("St Patrick's Dayyear (latent)", -6.424058322604399),
                                    ("Thursday<time> (timezone)", -6.424058322604399),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.424058322604399),
                                    ("Pargat Diwasyear (latent)", -5.171295354109031),
                                    ("<datetime> - <datetime> (interval)July", -6.018593214496234),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.730911142044453),
                                    ("Februaryintersect", -6.424058322604399),
                                    ("Simchat Torahyear (latent)", -6.424058322604399),
                                    ("minuteyear", -6.424058322604399)],
                               n = 476},
                   koData =
                     ClassData{prior = -1.000047721612555, unseen = -6.728628613084702,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.15017453144761886,
                               ...
                               n = 216},
                   koData =
                     ClassData{prior = -1.9701048776423702,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
