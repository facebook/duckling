...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6840973450400275, unseen = -5.814130531825066,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 333},
                   koData =
                     ClassData{prior = -0.7022796641232177, unseen = -5.796057750765372,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5050039613857723, unseen = -6.913737350659685,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.219595639933231),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.219595639933231),
                                    ("Ramadanyear (latent)", -6.219595639933231),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.204692619390966),
                                    ("Bhai Doojyear (latent)", -6.219595639933231),
                                    ("hourday", -4.204692619390966),
                                    ("dayhour", -3.3018249078489514),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.204692619390966),
                                    ("Martin Luther King's Dayyear (latent)", -5.814130531825066),
                                    ("Shemini Atzeretyear (latent)", -6.219595639933231),
                                    ("daymonth", -4.427836170705175),
                                    ("monthday", -5.814130531825066),
                                    ("monthyear", -4.347793463031639),
                                    ("Yom Ha'atzmautyear (latent)", -6.219595639933231),
                                    ("Vijayadashamiyear (latent)", -6.219595639933231),
                                    ("Thanksgiving Dayyear (latent)", -5.120983351265121),
                                    ("Thai Pongalyear (latent)", -5.526448459373285),
                                    ("Thiru Onamyear (latent)", -5.526448459373285),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.219595639933231),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.219595639933231),
                                    ("<day-of-month> (ordinal)Wednesday", -6.219595639933231),
                                    ("houryear", -5.303304908059076),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.219595639933231),
                                    ("Christmas<time-of-day> am|pm", -6.219595639933231),
                                    ("<day-of-month> (ordinal)October", -6.219595639933231),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.219595639933231),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.526448459373285),
                                    ("intersectin|during <named-month>|year", -6.219595639933231),
                                    ("<time-of-day> am|pmintersect", -4.966832671437863),
                                    ("Earth Houryear (latent)", -6.219595639933231),
                                    ("Octoberyear (latent)", -4.61015772749913),
                                    ("intersect<time-of-day> am|pm", -6.219595639933231),
                                    ("Mattu Pongalyear (latent)", -6.219595639933231),
                                    ("Shavuotyear (latent)", -6.219595639933231),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.219595639933231),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.219595639933231),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.814130531825066),
                                    ("Marchyear (latent)", -6.219595639933231),
                                    ("Sukkotyear (latent)", -5.814130531825066),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.814130531825066),
                                    ("Clean Mondayyear (latent)", -5.814130531825066),
                                    ("monthhour", -5.814130531825066),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.526448459373285),
                                    ("todayat <time-of-day>", -6.219595639933231),
                                    ("Thursday<time> timezone", -4.273685490877917),
                                    ("time-of-day (latent)tonight", -5.814130531825066),
                                    ("from|since|after <time>December", -6.219595639933231),
                                    ("<time-of-day> am|pmon <day>", -4.204692619390966),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.219595639933231),
                                    ("yyyy-mm-ddhh:mm:ss", -5.814130531825066),
                                    ("dayday", -3.7772486045640266),
                                    ("<time> <part-of-day>at <time-of-day>", -6.219595639933231),
                                    ("mm/ddat <time-of-day>", -6.219595639933231),
                                    ("tonightat <time-of-day>", -6.219595639933231),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.526448459373285),
                                    ("today<time-of-day> am|pm", -6.219595639933231),
                                    ("Februarythe <day-of-month> (ordinal)", -5.814130531825066),
                                    ("at <time-of-day><time> <part-of-day>", -6.219595639933231),
                                    ("<day-of-month> (ordinal)intersect", -5.526448459373285),
                                    ("mm/dd<time-of-day> am|pm", -6.219595639933231),
                                    ("hourhour", -4.140154098253395),
                                    ("Navaratriin|during <named-month>|year", -6.219595639933231),
                                    ("Wednesdaythis|last|next <cycle>", -6.219595639933231),
                                    ("Lentyear (latent)", -6.219595639933231),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.715518243156957),
                                    ("Boghiyear (latent)", -6.219595639933231),
                                    ("dayyear", -2.116952274896435),
                                    ("Thursdayfrom|since|after <time>", -5.814130531825066),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.219595639933231),
                                    ("Thursdayat <time-of-day>", -5.526448459373285),
                                    ("Islamic New Yearyear (latent)", -5.814130531825066),
                                    ("Laylat al-Qadryear (latent)", -5.303304908059076),
                                    ("Shrove Tuesdayyear (latent)", -6.219595639933231),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.526448459373285),
                                    ("<time-of-day> am|pmtomorrow", -5.526448459373285),
                                    ("Yom Kippuryear (latent)", -6.219595639933231),
                                    ("<day-of-month> (ordinal)Tuesday", -5.814130531825066),
                                    ("<part-of-day> of <time>year (latent)", -6.219595639933231),
                                    ("minutehour", -5.120983351265121),
                                    ("Kaanum Pongalyear (latent)", -5.814130531825066),
                                    ("Maha Saptamiyear (latent)", -6.219595639933231),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.814130531825066),
                                    ("time-of-day (latent)tomorrow", -5.303304908059076),
                                    ("part of daysat <time-of-day>", -5.814130531825066),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.514847547694806),
                                    ("for <duration> from <time>December", -6.219595639933231),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.219595639933231),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.966832671437863),
                                    ("time-of-day (latent)this <part-of-day>", -6.219595639933231),
                                    ("Pentecostyear (latent)", -6.219595639933231),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.966832671437863),
                                    ("<day-of-month> (ordinal)February", -6.219595639933231),
                                    ("Eid al-Fitryear (latent)", -6.219595639933231),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.219595639933231),
                                    ("Mondayin|during the <part-of-day>", -6.219595639933231),
                                    ("Chhathin|during <named-month>|year", -6.219595639933231),
                                    ("Diwaliin|during <named-month>|year", -6.219595639933231),
                                    ("Vaisakhiin|during <named-month>|year", -6.219595639933231),
                                    ("Raksha Bandhanyear (latent)", -6.219595639933231),
                                    ("daysecond", -5.814130531825066),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.814130531825066),
                                    ("Ashurayear (latent)", -6.219595639933231),
                                    ("Tuesdayin|during <named-month>|year", -6.219595639933231),
                                    ("Chinese New Yearyear (latent)", -6.219595639933231),
                                    ("tomorrowintersect", -6.219595639933231),
                                    ("Lag BaOmeryear (latent)", -6.219595639933231),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.219595639933231),
                                    ("Eid al-Adhayear (latent)", -5.303304908059076),
                                    ("intersectin|during the <part-of-day>", -6.219595639933231),
                                    ("Palm Sundayyear (latent)", -6.219595639933231),
                                    ("Christmasat <time-of-day>", -6.219595639933231),
                                    ("Passoveryear (latent)", -6.219595639933231),
                                    ("Lazarus Saturdayyear (latent)", -6.219595639933231),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.814130531825066),
                                    ("Yom HaShoahyear (latent)", -5.814130531825066),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.814130531825066),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.219595639933231),
                                    ("Septemberyear (latent)", -5.814130531825066),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.715518243156957),
                                    ("Halloweenyear (latent)", -6.219595639933231),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.219595639933231),
                                    ("at <time-of-day>intersect", -5.814130531825066),
                                    ("Rosh Hashanahyear (latent)", -5.526448459373285),
                                    ("Dhanterasyear (latent)", -6.219595639933231),
                                    ("Tu BiShvatyear (latent)", -6.219595639933231),
                                    ("<day-of-month> (ordinal)December", -5.526448459373285),
                                    ("Holiyear (latent)", -5.526448459373285),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.219595639933231),
                                    ("Holika Dahanyear (latent)", -5.526448459373285),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.219595639933231),
                                    ("dayminute", -3.3018249078489514),
                                    ("Mawlidyear (latent)", -6.219595639933231),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.814130531825066),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.219595639933231),
                                    ("Jumu'atul-Widayear (latent)", -5.303304908059076),
                                    ("minuteday", -2.3909542434441358),
                                    ("absorption of , after named dayintersect",
                                     -6.219595639933231),
                                    ("intersectyear (latent)", -5.814130531825066),
                                    ("Orthodox Easter Sundayyear (latent)", -6.219595639933231),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.219595639933231),
                                    ("Boss's Dayyear (latent)", -5.814130531825066),
                                    ("Global Youth Service Dayyear (latent)", -6.219595639933231),
                                    ("Dhanterasin|during <named-month>|year", -6.219595639933231),
                                    ("Tisha B'Avyear (latent)", -6.219595639933231),
                                    ("Isra and Mi'rajyear (latent)", -5.303304908059076),
                                    ("at <time-of-day>on <day>", -5.120983351265121),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.219595639933231),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.526448459373285),
                                    ("Christmasyear (latent)", -5.814130531825066),
                                    ("Naraka Chaturdashiyear (latent)", -5.814130531825066),
                                    ("Thai Pongalin|during <named-month>|year", -6.219595639933231),
                                    ("dayweek", -6.219595639933231),
                                    ("Easter Sundayyear (latent)", -5.526448459373285),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.61015772749913),
                                    ("weekyear", -5.120983351265121),
                                    ("hh:mmin|during the <part-of-day>", -5.526448459373285),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.814130531825066),
                                    ("Hanukkahyear (latent)", -5.526448459373285),
                                    ("February<time> <part-of-day>", -6.219595639933231),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.219595639933231),
                                    ("Great Lentyear (latent)", -6.219595639933231),
                                    ("tomorrowat <time-of-day>", -5.526448459373285),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.219595639933231),
                                    ("Vaisakhiyear (latent)", -5.526448459373285),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.219595639933231),
                                    ("last <cycle> of <time>year (latent)", -5.526448459373285),
                                    ("at <time-of-day>tomorrow", -5.814130531825066),
                                    ("tomorrow<time-of-day> am|pm", -6.219595639933231),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.219595639933231),
                                    ("Diwaliyear (latent)", -6.219595639933231),
                                    ("between <time> and <time>on <day>", -4.61015772749913),
                                    ("Black Fridayyear (latent)", -5.814130531825066),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.219595639933231),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.219595639933231),
                                    ("Chhathyear (latent)", -5.814130531825066),
                                    ("Vasant Panchamiyear (latent)", -6.219595639933231),
                                    ("St Patrick's Dayyear (latent)", -6.219595639933231),
                                    ("Thursday<time> (timezone)", -6.219595639933231),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.219595639933231),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.814130531825066),
                                    ("Februaryintersect", -6.219595639933231),
                                    ("Simchat Torahyear (latent)", -6.219595639933231),
                                    ("minuteyear", -6.219595639933231)],
                               n = 379},
                   koData =
                     ClassData{prior = -0.925087270003491, unseen = -6.61472560020376,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.2121868367174042),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.920237037819614),
                                    ("<day-of-month> (ordinal)August", -5.920237037819614),
                                    ("dayhour", -3.2460883883930856),
                                    ("<time> timezoneyear (latent)", -5.920237037819614),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.003946305945459),
                                    ("Tuesdayfrom|since|after <time>", -5.920237037819614),
                                    ("daymonth", -3.668945239213119),
                                    ("monthyear", -4.667474069324246),
                                    ("<time-of-day> am|pmyear (latent)", -5.227089857259669),
                                    ("Thai Pongalyear (latent)", -5.227089857259669),
                                    ("intersecthh:mm", -5.920237037819614),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.920237037819614),
                                    ("<day-of-month> (ordinal)Wednesday", -5.920237037819614),
                                    ("houryear", -4.5339426766997235),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.920237037819614),
                                    ("<day-of-month> (ordinal)October", -5.920237037819614),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.227089857259669),
                                    ("<time-of-day> am|pmintersect", -4.667474069324246),
                                    ("Octoberyear (latent)", -5.920237037819614),
                                    ("until <time>on <day>", -5.227089857259669),
                                    ("time-of-day (latent)intersect", -5.920237037819614),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.227089857259669),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.920237037819614),
                                    ("hh:mmon <day>", -3.47789000245041),
                                    ("absorption of , after named dayJuly", -5.51477192971145),
                                    ("from|since|after <time>July", -5.920237037819614),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.003946305945459),
                                    ("Clean Mondayyear (latent)", -5.920237037819614),
                                    ("monthhour", -5.920237037819614),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.51477192971145),
                                    ("hourmonth", -4.310799125385514),
                                    ("todayat <time-of-day>", -5.920237037819614),
                                    ("from|since|after <time>December", -5.920237037819614),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.920237037819614),
                                    ("<time-of-day> am|pmon <day>", -4.667474069324246),
                                    ("Mondayyear (latent)", -5.227089857259669),
                                    ("dayday", -4.5339426766997235),
                                    ("mm/ddat <time-of-day>", -5.51477192971145),
                                    ("on <day>September", -5.51477192971145),
                                    ("time-of-day (latent)September", -5.51477192971145),
                                    ("hourhour", -5.920237037819614),
                                    ("time-of-day (latent)on <day>", -3.47789000245041),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.51477192971145),
                                    ("dayyear", -3.0298652799234493),
                                    ("Thursdaymm/dd", -5.920237037819614),
                                    ("New Year's Dayyear (latent)", -5.51477192971145),
                                    ("Thursdayfrom|since|after <time>", -4.215488945581189),
                                    ("Thursdayat <time-of-day>", -4.310799125385514),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.920237037819614),
                                    ("Aprilyear (latent)", -5.920237037819614),
                                    ("monthminute", -5.920237037819614),
                                    ("<time-of-day> am|pmtomorrow", -5.920237037819614),
                                    ("Thursdayhh:mm", -5.003946305945459),
                                    ("<day-of-month> (ordinal)Tuesday", -5.51477192971145),
                                    ("minutemonth", -4.128477568591559),
                                    ("minutehour", -5.920237037819614),
                                    ("Augustyear (latent)", -5.51477192971145),
                                    ("week-endin|during <named-month>|year", -5.920237037819614),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.51477192971145),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.920237037819614),
                                    ("Sundayyear (latent)", -5.003946305945459),
                                    ("Christmasat <time-of-day>", -5.920237037819614),
                                    ("from|since|after <time>year (latent)", -4.821624749151504),
                                    ("<duration> after|before|from <time>December",
                                     -5.920237037819614),
                                    ("yesterday<time-of-day> am|pm", -5.920237037819614),
                                    ("<day-of-month> (ordinal)July", -5.920237037819614),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.920237037819614),
                                    ("mm/ddyear (latent)", -5.920237037819614),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.920237037819614),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.920237037819614),
                                    ("at <time-of-day>intersect", -5.51477192971145),
                                    ("hh:mmyear (latent)", -3.8407954961397786),
                                    ("Holiyear (latent)", -5.920237037819614),
                                    ("until <time><time-of-day> am|pm", -5.920237037819614),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.920237037819614),
                                    ("dayminute", -3.3552876803580776),
                                    ("yyyy-mm-ddhh:mm", -5.51477192971145),
                                    ("intersectSeptember", -4.416159641043341),
                                    ("minuteday", -2.6815585856552335),
                                    ("absorption of , after named dayintersect",
                                     -5.920237037819614),
                                    ("intersectyear (latent)", -5.920237037819614),
                                    ("Februaryin|during the <part-of-day>", -5.920237037819614),
                                    ("time-of-day (latent)July", -5.920237037819614),
                                    ("Saturdayyear (latent)", -5.920237037819614),
                                    ("at <time-of-day>on <day>", -5.51477192971145),
                                    ("absorption of , after named daySeptember",
                                     -5.003946305945459),
                                    ("Naraka Chaturdashiyear (latent)", -5.920237037819614),
                                    ("from|since|after <time>on <day>", -5.003946305945459),
                                    ("dayweek", -5.920237037819614),
                                    ("Easter Sundayyear (latent)", -5.51477192971145),
                                    ("Thursday<time-of-day> am|pm", -4.667474069324246),
                                    ("weekyear", -5.51477192971145),
                                    ("time-of-day (latent)Thursday", -5.51477192971145),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.920237037819614),
                                    ("<day-of-month> (ordinal)April", -5.920237037819614),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.51477192971145),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.227089857259669),
                                    ("Sundayfrom|since|after <time>", -5.920237037819614),
                                    ("absorption of , after named dayFebruary", -5.003946305945459),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.920237037819614),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.920237037819614),
                                    ("tomorrowat <time-of-day>", -5.920237037819614),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.920237037819614),
                                    ("last <cycle> of <time>year (latent)", -5.51477192971145),
                                    ("tomorrow<time-of-day> am|pm", -5.920237037819614),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.227089857259669),
                                    ("Diwaliyear (latent)", -5.51477192971145),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.920237037819614),
                                    ("Fridayyear (latent)", -5.51477192971145),
                                    ("time-of-day (latent)April", -5.920237037819614),
                                    ("minuteyear", -3.7230124604833947)],
                               n = 249}}),
       ("one eleven",
        Classifier{okData =
