...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.599301725567902, unseen = -5.733341276897745,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 307},
                   koData =
                     ClassData{prior = -0.7967203856436759, unseen = -5.537334267018537,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48525884279398374,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.030685260261263),
                                    ...
                                    ("daymonth", -5.114394528387108),
                                    ("monthday", -5.625220152153099),
                                    ("monthyear", -4.238925791033208),
                                    ...
                                    ("Octoberyear (latent)", -4.52660786348499),
                                    ...
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.030685260261263),
                                    ("dayday", -4.015782239718999),
                                    ("<time> <part-of-day>at <time-of-day>", -6.030685260261263),
                                    ("mm/ddat <time-of-day>", -6.030685260261263),
                                    ...
                                    ("mm/dd<time-of-day> am|pm", -6.030685260261263),
                                    ("hourhour", -4.777922291765895),
                                    ("<time-of-day> am|pmon <date>", -4.015782239718999),
                                    ("Navaratriin|during <named-month>|year", -6.030685260261263),
                                    ...
                                    ("Chhathin|during <named-month>|year", -6.030685260261263),
                                    ("Diwaliin|during <named-month>|year", -6.030685260261263),
                                    ...
                                    ("Tuesdayin|during <named-month>|year", -6.030685260261263),
                                    ...
                                    ("Palm Sundayyear (latent)", -6.030685260261263),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.337538079701318),
                                    ...
                                    ("Dhanterasin|during <named-month>|year", -6.030685260261263),
                               ...
                               n = 309},
                   koData =
                     ClassData{prior = -0.9559099307868437, unseen = -6.398594934535208,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.787491742782046),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.298317366548036),
                                    ("week-endin|during <named-month>|year", -5.703782474656201),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.298317366548036),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.703782474656201),
                                    ("Sundayyear (latent)", -4.787491742782046),
