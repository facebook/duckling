...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4889776842401208, unseen = -7.186901020411631,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.49299712396238),
                                    ("Karva Chauthyear (latent)", -6.49299712396238),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.49299712396238),
                                    ("Maha Shivaratriyear (latent)", -6.49299712396238),
                                    ("Ramadanyear (latent)", -5.240234155467012),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.106702762842489),
                                    ("Bhai Doojyear (latent)", -6.49299712396238),
                                    ("hourday", -4.478094103420116),
                                    ("dayhour", -3.4725722378180173),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.106702762842489),
                                    ("Martin Luther King's Dayyear (latent)", -6.087532015854215),
                                    ("Shemini Atzeretyear (latent)", -6.49299712396238),
                                    ("daymonth", -4.352930960466109),
                                    ("monthday", -6.087532015854215),
                                    ("monthyear", -4.621194947060789),
                                    ("Yom Ha'atzmautyear (latent)", -6.49299712396238),
                                    ("Orthodox Good Fridayyear (latent)", -6.087532015854215),
                                    ("Vijayadashamiyear (latent)", -6.49299712396238),
                                    ("Thanksgiving Dayyear (latent)", -5.394384835294271),
                                    ("Thai Pongalyear (latent)", -5.799849943402434),
                                    ("Thiru Onamyear (latent)", -5.799849943402434),
                                    ("hhhmmabsorption of , after named day", -6.49299712396238),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.49299712396238),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.576706392088225),
                                    ("<day-of-month> (ordinal)Wednesday", -6.49299712396238),
                                    ("Krishna Janmashtamiyear (latent)", -6.087532015854215),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.49299712396238),
                                    ("houryear", -5.576706392088225),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.49299712396238),
                                    ("Christmas<time-of-day> am|pm", -6.49299712396238),
                                    ("<day-of-month> (ordinal)October", -6.49299712396238),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.49299712396238),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.799849943402434),
                                    ("intersectin|during <named-month>|year", -6.49299712396238),
                                    ("<time-of-day> am|pmintersect", -5.240234155467012),
                                    ("Earth Houryear (latent)", -6.49299712396238),
                                    ("Ganesh Chaturthiyear (latent)", -6.49299712396238),
                                    ("Octoberyear (latent)", -4.883559211528279),
                                    ("intersect<time-of-day> am|pm", -6.49299712396238),
                                    ("Mattu Pongalyear (latent)", -6.49299712396238),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.49299712396238),
                                    ("Shavuotyear (latent)", -6.49299712396238),
                                    ("Parsi New Yearyear (latent)", -5.576706392088225),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.49299712396238),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.49299712396238),
                                    ("todayin|within|after <duration>", -6.49299712396238),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.087532015854215),
                                    ("Marchyear (latent)", -6.49299712396238),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.087532015854215),
                                    ("Sukkotyear (latent)", -6.087532015854215),
                                    ("hhhmmintersect", -6.087532015854215),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.087532015854215),
                                    ("Clean Mondayyear (latent)", -6.087532015854215),
                                    ("monthhour", -6.087532015854215),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.799849943402434),
                                    ("todayat <time-of-day>", -6.49299712396238),
                                    ("Thursday<time> timezone", -4.095101851164009),
                                    ("tonight<time-of-day> am|pm", -6.49299712396238),
                                    ("time-of-day (latent)tonight", -6.087532015854215),
                                    ("from|since|after <time>December", -6.49299712396238),
                                    ("<time-of-day> am|pmon <day>", -4.478094103420116),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -6.49299712396238),
                                    ("yyyy-mm-ddhh:mm:ss", -6.087532015854215),
                                    ("dayday", -3.7849469228601698),
                                    ("<time> <part-of-day>at <time-of-day>", -6.087532015854215),
                                    ("mm/ddat <time-of-day>", -5.799849943402434),
                                    ("tonightat <time-of-day>", -5.394384835294271),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.799849943402434),
                                    ("Dayananda Saraswati Jayantiyear (latent)", -6.49299712396238),
                                    ("today<time-of-day> am|pm", -6.49299712396238),
                                    ("Februarythe <day-of-month> (ordinal)", -6.087532015854215),
                                    ("at <time-of-day><time> <part-of-day>", -6.49299712396238),
                                    ("<day-of-month> (ordinal)intersect", -5.799849943402434),
                                    ("mm/dd<time-of-day> am|pm", -6.49299712396238),
                                    ("hourhour", -3.522582658392679),
                                    ("Mahavir Jayantiyear (latent)", -6.087532015854215),
                                    ("Navaratriin|during <named-month>|year", -6.49299712396238),
                                    ("Wednesdaythis|last|next <cycle>", -6.49299712396238),
                                    ("Lentyear (latent)", -6.49299712396238),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.621194947060789),
                                    ("Boghiyear (latent)", -6.49299712396238),
                                    ("dayyear", -1.9131447459585784),
                                    ("Karva Chauthin|during <named-month>|year", -6.49299712396238),
                                    ("Thursdayfrom|since|after <time>", -6.087532015854215),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.49299712396238),
                                    ("Thursdayat <time-of-day>", -5.799849943402434),
                                    ("Islamic New Yearyear (latent)", -6.087532015854215),
                                    ("Laylat al-Qadryear (latent)", -5.576706392088225),
                                    ("part of days<time-of-day> am|pm", -6.49299712396238),
                                    ("Shrove Tuesdayyear (latent)", -6.49299712396238),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.799849943402434),
                                    ("hourminute", -6.087532015854215),
                                    ("<time-of-day> am|pmtomorrow", -5.799849943402434),
                                    ("Yom Kippuryear (latent)", -6.49299712396238),
                                    ("<day-of-month> (ordinal)Tuesday", -6.087532015854215),
                                    ("<part-of-day> of <time>year (latent)", -6.49299712396238),
                                    ("minutehour", -5.240234155467012),
                                    ("Kaanum Pongalyear (latent)", -6.087532015854215),
                                    ("Maha Saptamiyear (latent)", -6.49299712396238),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.799849943402434),
                                    ("time-of-day (latent)tomorrow", -5.576706392088225),
                                    ("part of daysat <time-of-day>", -4.883559211528279),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.478094103420116),
                                    ("for <duration> from <time>December", -6.49299712396238),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.49299712396238),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.240234155467012),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.240234155467012),
                                    ("time-of-day (latent)this <part-of-day>", -6.49299712396238),
                                    ("Pentecostyear (latent)", -6.49299712396238),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.240234155467012),
                                    ("<day-of-month> (ordinal)February", -6.49299712396238),
                                    ("Eid al-Fitryear (latent)", -5.106702762842489),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.49299712396238),
                                    ("Mondayin|during the <part-of-day>", -6.49299712396238),
                                    ("Chhathin|during <named-month>|year", -6.49299712396238),
                                    ("Diwaliin|during <named-month>|year", -6.49299712396238),
                                    ("this <part-of-day><time-of-day> am|pm", -6.49299712396238),
                                    ("Vaisakhiin|during <named-month>|year", -6.49299712396238),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.240234155467012),
                                    ("Raksha Bandhanyear (latent)", -6.49299712396238),
                                    ("daysecond", -6.087532015854215),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.087532015854215),
                                    ("Ratha-Yatrayear (latent)", -6.49299712396238),
                                    ("Ashurayear (latent)", -6.49299712396238),
                                    ("Tuesdayin|during <named-month>|year", -6.49299712396238),
                                    ("Chinese New Yearyear (latent)", -6.49299712396238),
                                    ("tomorrowintersect", -6.49299712396238),
                                    ("Lag BaOmeryear (latent)", -6.49299712396238),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.49299712396238),
                                    ("Eid al-Adhayear (latent)", -4.352930960466109),
                                    ("intersectin|during the <part-of-day>", -6.49299712396238),
                                    ("Palm Sundayyear (latent)", -6.49299712396238),
                                    ("Christmasat <time-of-day>", -6.49299712396238),
                                    ("Passoveryear (latent)", -6.49299712396238),
                                    ("Lazarus Saturdayyear (latent)", -6.49299712396238),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.087532015854215),
                                    ("hhhmmon <day>", -5.576706392088225),
                                    ("Yom HaShoahyear (latent)", -6.087532015854215),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.087532015854215),
                                    ("Septemberyear (latent)", -6.087532015854215),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.988919727186106),
                                    ("Halloweenyear (latent)", -6.49299712396238),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.49299712396238),
                                    ("at <time-of-day>intersect", -5.576706392088225),
                                    ("Rosh Hashanahyear (latent)", -5.799849943402434),
                                    ("Dhanterasyear (latent)", -6.49299712396238),
                                    ("Tu BiShvatyear (latent)", -6.49299712396238),
                                    ("<day-of-month> (ordinal)December", -5.799849943402434),
                                    ("Holiyear (latent)", -5.799849943402434),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.49299712396238),
                                    ("Holika Dahanyear (latent)", -5.799849943402434),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.087532015854215),
                                    ("dayminute", -3.108606860616606),
                                    ("Mawlidyear (latent)", -6.49299712396238),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.087532015854215),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.49299712396238),
                                    ("Jumu'atul-Widayear (latent)", -5.576706392088225),
                                    ("minuteday", -2.755327505679012),
                                    ("absorption of , after named dayintersect",
                                     -5.799849943402434),
                                    ("intersectyear (latent)", -6.087532015854215),
                                    ("Orthodox Easter Sundayyear (latent)", -6.49299712396238),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.49299712396238),
                                    ("<ordinal> <cycle> of <time>year (latent)", -6.49299712396238),
                                    ("intersecthhhmm", -6.087532015854215),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.49299712396238),
                                    ("Boss's Dayyear (latent)", -6.087532015854215),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.49299712396238),
                                    ("Global Youth Service Dayyear (latent)", -6.49299712396238),
                                    ("Dhanterasin|during <named-month>|year", -6.49299712396238),
                                    ("tonight<time-of-day> o'clock", -6.49299712396238),
                                    ("Tisha B'Avyear (latent)", -6.49299712396238),
                                    ("Isra and Mi'rajyear (latent)", -5.576706392088225),
                                    ("at <time-of-day>on <day>", -4.883559211528279),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.087532015854215),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.799849943402434),
                                    ("Christmasyear (latent)", -6.087532015854215),
                                    ("Saturdayintersect", -6.49299712396238),
                                    ("Naraka Chaturdashiyear (latent)", -6.087532015854215),
                                    ("Thai Pongalin|during <named-month>|year", -6.49299712396238),
                                    ("dayweek", -6.49299712396238),
                                    ("Easter Sundayyear (latent)", -5.799849943402434),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.087532015854215),
                                    ("weekyear", -5.394384835294271),
                                    ("King's Dayyear (latent)", -4.988919727186106),
                                    ("hh:mmin|during the <part-of-day>", -5.576706392088225),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.087532015854215),
                                    ("Hanukkahyear (latent)", -5.799849943402434),
                                    ("Rama Navamiyear (latent)", -6.49299712396238),
                                    ("February<time> <part-of-day>", -6.49299712396238),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.799849943402434),
                                    ("Great Lentyear (latent)", -6.49299712396238),
                                    ("tomorrowat <time-of-day>", -5.799849943402434),
                                    ("hhmm (latent)in|during the <part-of-day>", -6.49299712396238),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.087532015854215),
                                    ("Ugadiyear (latent)", -5.106702762842489),
                                    ("Vaisakhiyear (latent)", -5.799849943402434),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.799849943402434),
                                    ("last <cycle> of <time>year (latent)", -5.799849943402434),
                                    ("at <time-of-day>tomorrow", -6.087532015854215),
                                    ("tomorrow<time-of-day> am|pm", -6.49299712396238),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.49299712396238),
                                    ("Diwaliyear (latent)", -6.49299712396238),
                                    ("between <time> and <time>on <day>", -6.087532015854215),
                                    ("Black Fridayyear (latent)", -6.087532015854215),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.49299712396238),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.49299712396238),
                                    ("Chhathyear (latent)", -6.087532015854215),
                                    ("Vasant Panchamiyear (latent)", -6.49299712396238),
                                    ("Rabindra Jayantiyear (latent)", -5.240234155467012),
                                    ("this <part-of-day>at <time-of-day>", -5.240234155467012),
                                    ("St Patrick's Dayyear (latent)", -6.49299712396238),
                                    ("Thursday<time> (timezone)", -6.49299712396238),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.49299712396238),
                                    ("Pargat Diwasyear (latent)", -5.240234155467012),
                                    ("<datetime> - <datetime> (interval)July", -6.087532015854215),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.799849943402434),
                                    ("Februaryintersect", -6.49299712396238),
                                    ("Simchat Torahyear (latent)", -6.49299712396238),
                                    ("minuteyear", -6.49299712396238)],
                               n = 509},
                   koData =
                     ClassData{prior = -0.9499845776606277, unseen = -6.852242569051878,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.653960350157523),
                                    ("hourday", -3.5930883894722605),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.158037746933798),
                                    ("<day-of-month> (ordinal)August", -6.158037746933798),
                                    ("dayhour", -3.417197723008597),
                                    ("<time> timezoneyear (latent)", -5.464890566373852),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.241747015059643),
                                    ("Tuesdayfrom|since|after <time>", -5.464890566373852),
                                    ("daymonth", -3.483889097507269),
                                    ("hourquarter", -5.241747015059643),
                                    ("monthyear", -4.90527477843843),
                                    ("<time-of-day> am|pmyear (latent)", -5.464890566373852),
                                    ("Thai Pongalyear (latent)", -5.464890566373852),
                                    ("intersecthh:mm", -6.158037746933798),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.752572638825633),
                                    ("<day-of-month> (ordinal)Wednesday", -6.158037746933798),
                                    ("houryear", -4.366278277705742),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.158037746933798),
                                    ("<day-of-month> (ordinal)October", -6.158037746933798),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.464890566373852),
                                    ("hournograin", -4.90527477843843),
                                    ("<time-of-day> am|pmintersect", -4.90527477843843),
                                    ("Octoberyear (latent)", -6.158037746933798),
                                    ("Good Fridayyear (latent)", -5.752572638825633),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.752572638825633),
                                    ("early morningat <time-of-day>", -6.158037746933798),
                                    ("until <time>on <day>", -5.464890566373852),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.158037746933798),
                                    ("time-of-day (latent)intersect", -5.464890566373852),
                                    ("todayin <number> (implicit minutes)", -6.158037746933798),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.464890566373852),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.158037746933798),
                                    ("hh:mmon <day>", -4.90527477843843),
                                    ("hhhmmintersect", -5.752572638825633),
                                    ("absorption of , after named dayJuly", -5.241747015059643),
                                    ("from|since|after <time>July", -5.752572638825633),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.241747015059643),
                                    ("Clean Mondayyear (latent)", -6.158037746933798),
                                    ("monthhour", -6.158037746933798),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.752572638825633),
                                    ("hourmonth", -4.017971583437527),
                                    ("todayat <time-of-day>", -6.158037746933798),
                                    ("hhhmmyear (latent)", -4.90527477843843),
                                    ("from|since|after <time>December", -6.158037746933798),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.158037746933798),
                                    ("<time-of-day> am|pmon <day>", -4.90527477843843),
                                    ("Mondayyear (latent)", -5.464890566373852),
                                    ("dayday", -4.143134726391533),
                                    ("mm/ddat <time-of-day>", -5.241747015059643),
                                    ("on <day>September", -5.464890566373852),
                                    ("time-of-day (latent)September", -5.752572638825633),
                                    ("hourhour", -4.0785962052539615),
                                    ("time-of-day (latent)on <day>", -4.653960350157523),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.752572638825633),
                                    ("dayyear", -3.1135153092103742),
                                    ("Thursdaymm/dd", -6.158037746933798),
                                    ("New Year's Dayyear (latent)", -5.241747015059643),
                                    ("time-of-day (latent)Sunday", -5.752572638825633),
                                    ("Thursdayfrom|since|after <time>", -4.453289654695372),
                                    ("Thursdayat <time-of-day>", -4.548599834499697),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.158037746933798),
                                    ("Aprilyear (latent)", -6.158037746933798),
                                    ("the <day-of-month> (ordinal)July", -6.158037746933798),
                                    ("the <day-of-month> (number)July", -6.158037746933798),
                                    ("monthminute", -6.158037746933798),
                                    ("<time-of-day> am|pmtomorrow", -6.158037746933798),
                                    ("Thursdayhh:mm", -5.241747015059643),
                                    ("<day-of-month> (ordinal)Tuesday", -5.752572638825633),
                                    ("minutemonth", -4.017971583437527),
                                    ("time-of-day (latent)Friday", -5.752572638825633),
                                    ("minutehour", -6.158037746933798),
                                    ("part of daysat <time-of-day>", -5.059425458265688),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.8066624897703196),
                                    ("Augustyear (latent)", -5.752572638825633),
                                    ("week-endin|during <named-month>|year", -6.158037746933798),
                                    ("time-of-day (latent)Tuesday", -5.752572638825633),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.158037746933798),
                                    ("Sundayyear (latent)", -5.241747015059643),
                                    ("hourweek", -5.241747015059643),
                                    ("the <day-of-month> (ordinal)Monday", -5.464890566373852),
                                    ("Christmasat <time-of-day>", -6.158037746933798),
                                    ("from|since|after <time>year (latent)", -5.059425458265688),
                                    ("hhhmmon <day>", -5.241747015059643),
                                    ("yesterday<time-of-day> am|pm", -6.158037746933798),
                                    ("<day-of-month> (ordinal)July", -5.464890566373852),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.158037746933798),
                                    ("mm/ddyear (latent)", -6.158037746933798),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.158037746933798),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.158037746933798),
                                    ("at <time-of-day>intersect", -5.241747015059643),
                                    ("hh:mmyear (latent)", -4.771743385813907),
                                    ("Holiyear (latent)", -6.158037746933798),
                                    ("until <time><time-of-day> am|pm", -6.158037746933798),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.752572638825633),
                                    ("dayminute", -3.295836866004329),
                                    ("yyyy-mm-ddhh:mm", -5.752572638825633),
                                    ("intersectfrom|since|after <time>", -5.752572638825633),
                                    ("intersectSeptember", -4.286235570032206),
                                    ("minuteday", -3.001037325783684),
                                    ("absorption of , after named dayintersect",
                                     -6.158037746933798),
                                    ("intersectyear (latent)", -6.158037746933798),
                                    ("Februaryin|during the <part-of-day>", -6.158037746933798),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.158037746933798),
                                    ("time-of-day (latent)July", -5.464890566373852),
                                    ("Saturdayyear (latent)", -6.158037746933798),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.158037746933798),
                                    ("<day-of-month> (ordinal)Monday", -5.241747015059643),
                                    ("at <time-of-day>on <day>", -5.241747015059643),
                                    ("absorption of , after named daySeptember", -4.90527477843843),
                                    ("Naraka Chaturdashiyear (latent)", -6.158037746933798),
                                    ("from|since|after <time>on <day>", -5.241747015059643),
                                    ("dayweek", -6.158037746933798),
                                    ("Easter Sundayyear (latent)", -5.752572638825633),
                                    ("Thursday<time-of-day> am|pm", -4.90527477843843),
                                    ("weekyear", -5.752572638825633),
                                    ("time-of-day (latent)Thursday", -5.752572638825633),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.158037746933798),
                                    ("<day-of-month> (ordinal)April", -6.158037746933798),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.752572638825633),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.464890566373852),
                                    ("Sundayfrom|since|after <time>", -6.158037746933798),
                                    ("absorption of , after named dayFebruary", -5.241747015059643),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.752572638825633),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.158037746933798),
                                    ("tomorrowat <time-of-day>", -6.158037746933798),
                                    ("daynograin", -5.752572638825633),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.752572638825633),
                                    ("last <cycle> of <time>year (latent)", -5.752572638825633),
                                    ("tomorrow<time-of-day> am|pm", -6.158037746933798),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.464890566373852),
                                    ("Diwaliyear (latent)", -5.752572638825633),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.158037746933798),
                                    ("this <part-of-day>at <time-of-day>", -5.241747015059643),
                                    ("Fridayyear (latent)", -5.241747015059643),
                                    ("time-of-day (latent)April", -6.158037746933798),
                                    ("minuteyear", -3.960813169597578)],
                               n = 321}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.7166776779701395, unseen = -4.859812404361672,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 126},
                   koData =
                     ClassData{prior = -0.6701576623352465, unseen = -4.90527477843843,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.5972992217698174, unseen = -5.356586274672012,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 93},
                   koData =
                     ClassData{prior = -0.7991653746367423, unseen = -5.181783550292085,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -3.5667118201397288),
                                    ("integer (0..19)year (grain)", -4.07753744390572),
                                    ("integer (numeric)day (grain)", -4.07753744390572),
                                    ("integer (numeric)quarter (grain)", -4.07753744390572),
                                    ("integer (numeric)year (grain)", -4.07753744390572),
                                    ("day", -3.5667118201397288), ("quarter", -3.5667118201397288),
                                    ("year", -3.5667118201397288),
                                    ("integer (numeric)week (grain)", -4.07753744390572),
                                    ("integer (0..19)month (grain)", -4.07753744390572),
                                    ("hour", -1.133098464739279), ("month", -3.5667118201397288),
                                    ("integer (numeric)month (grain)", -4.07753744390572),
                                    ("integer (numeric)hour (grain)", -1.133098464739279),
                                    ("integer (0..19)day (grain)", -4.07753744390572),
                                    ("integer (0..19)week (grain)", -4.07753744390572),
                                    ("integer (0..19)quarter (grain)", -4.07753744390572)],
                               n = 76}}),
