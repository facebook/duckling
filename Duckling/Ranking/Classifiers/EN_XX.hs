...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.627189212768148, unseen = -5.802118375377063,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 329},
                   koData =
                     ClassData{prior = -0.7637647477738987, unseen = -5.666426688112432,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4569616338753394, unseen = -6.774223886357614,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.07993319509559),
                                    ("Ramadanyear (latent)", -6.07993319509559),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.827170226600222),
                                    ("Bhai Doojyear (latent)", -6.07993319509559),
                                    ("hourday", -4.375185102857165),
                                    ("dayhour", -3.217732314166122),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.827170226600222),
                                    ("Martin Luther King's Dayyear (latent)", -5.674468086987426),
                                    ("Shemini Atzeretyear (latent)", -6.07993319509559),
                                    ("daymonth", -5.163642463221435),
                                    ("monthday", -5.674468086987426),
                                    ("monthyear", -4.288173725867535),
                                    ("yearhour", -5.674468086987426),
                                    ("Yom Ha'atzmautyear (latent)", -6.07993319509559),
                                    ("Vijayadashamiyear (latent)", -6.07993319509559),
                                    ("Thanksgiving Dayyear (latent)", -4.981320906427481),
                                    ("Thai Pongalyear (latent)", -5.3867860145356445),
                                    ("Thiru Onamyear (latent)", -5.3867860145356445),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.07993319509559),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.07993319509559),
                                    ("houryear", -5.3867860145356445),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.07993319509559),
                                    ("Christmas<time-of-day> am|pm", -6.07993319509559),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.07993319509559),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.3867860145356445),
                                    ("<time-of-day> am|pmintersect", -4.827170226600222),
                                    ("Earth Houryear (latent)", -6.07993319509559),
                                    ("Octoberyear (latent)", -4.575855798319316),
                                    ("intersect<time-of-day> am|pm", -6.07993319509559),
                                    ("Mattu Pongalyear (latent)", -6.07993319509559),
                                    ("Shavuotyear (latent)", -6.07993319509559),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.07993319509559),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.07993319509559),
                                    ("in|within|after <duration>at <time-of-day>",
                                     -6.07993319509559),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.674468086987426),
                                    ("Marchyear (latent)", -6.07993319509559),
                                    ("Sukkotyear (latent)", -5.674468086987426),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.07993319509559),
                                    ("Clean Mondayyear (latent)", -5.674468086987426),
                                    ("monthhour", -5.674468086987426),
                                    ("todayat <time-of-day>", -6.07993319509559),
                                    ("Thursday<time> timezone", -4.1340230460402765),
                                    ("from|since|after <time>December", -6.07993319509559),
                                    ("<time-of-day> am|pmon <day>", -4.065030174553326),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -6.07993319509559),
                                    ("yyyy-mm-ddhh:mm:ss", -5.674468086987426),
                                    ("dayday", -4.065030174553326),
                                    ("<time> <part-of-day>at <time-of-day>", -6.07993319509559),
                                    ("mm/ddat <time-of-day>", -6.07993319509559),
                                    ("tonightat <time-of-day>", -6.07993319509559),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.3867860145356445),
                                    ("today<time-of-day> am|pm", -6.07993319509559),
                                    ("Februarythe <day-of-month> (ordinal)", -5.674468086987426),
                                    ("at <time-of-day><time> <part-of-day>", -6.07993319509559),
                                    ("mm/dd<time-of-day> am|pm", -6.07993319509559),
                                    ("hourhour", -4.827170226600222),
                                    ("Navaratriin|during <named-month>|year", -6.07993319509559),
                                    ("Wednesdaythis|last|next <cycle>", -6.07993319509559),
                                    ("Lentyear (latent)", -6.07993319509559),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.575855798319316),
                                    ("Boghiyear (latent)", -6.07993319509559),
                                    ("dayyear", -2.010906440857779),
                                    ("Thursdayfrom|since|after <time>", -5.674468086987426),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.07993319509559),
                                    ("Thursdayat <time-of-day>", -5.3867860145356445),
                                    ("Islamic New Yearyear (latent)", -5.674468086987426),
                                    ("Laylat al-Qadryear (latent)", -5.163642463221435),
                                    ("Shrove Tuesdayyear (latent)", -6.07993319509559),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.3867860145356445),
                                    ("<time-of-day> am|pmtomorrow", -5.3867860145356445),
                                    ("Yom Kippuryear (latent)", -6.07993319509559),
                                    ("<part-of-day> of <time>year (latent)", -6.07993319509559),
                                    ("minutehour", -5.163642463221435),
                                    ("Kaanum Pongalyear (latent)", -5.674468086987426),
                                    ("Maha Saptamiyear (latent)", -6.07993319509559),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.674468086987426),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.375185102857165),
                                    ("for <duration> from <time>December", -6.07993319509559),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.07993319509559),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.827170226600222),
                                    ("Pentecostyear (latent)", -6.07993319509559),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.827170226600222),
                                    ("Eid al-Fitryear (latent)", -6.07993319509559),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.07993319509559),
                                    ("Mondayin|during the <part-of-day>", -6.07993319509559),
                                    ("Chhathin|during <named-month>|year", -6.07993319509559),
                                    ("Diwaliin|during <named-month>|year", -6.07993319509559),
                                    ("Vaisakhiin|during <named-month>|year", -6.07993319509559),
                                    ("Raksha Bandhanyear (latent)", -6.07993319509559),
                                    ("daysecond", -5.674468086987426),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.674468086987426),
                                    ("Ashurayear (latent)", -6.07993319509559),
                                    ("Tuesdayin|during <named-month>|year", -6.07993319509559),
                                    ("Chinese New Yearyear (latent)", -6.07993319509559),
                                    ("Lag BaOmeryear (latent)", -6.07993319509559),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.07993319509559),
                                    ("Eid al-Adhayear (latent)", -5.163642463221435),
                                    ("intersectin|during the <part-of-day>", -6.07993319509559),
                                    ("Palm Sundayyear (latent)", -6.07993319509559),
                                    ("Christmasat <time-of-day>", -6.07993319509559),
                                    ("Passoveryear (latent)", -6.07993319509559),
                                    ("Lazarus Saturdayyear (latent)", -6.07993319509559),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.674468086987426),
                                    ("Yom HaShoahyear (latent)", -5.674468086987426),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.674468086987426),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.07993319509559),
                                    ("Septemberyear (latent)", -5.674468086987426),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.575855798319316),
                                    ("Halloweenyear (latent)", -6.07993319509559),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.07993319509559),
                                    ("at <time-of-day>intersect", -5.674468086987426),
                                    ("Rosh Hashanahyear (latent)", -5.3867860145356445),
                                    ("Dhanterasyear (latent)", -6.07993319509559),
                                    ("Tu BiShvatyear (latent)", -6.07993319509559),
                                    ("Holiyear (latent)", -5.3867860145356445),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.07993319509559),
                                    ("Holika Dahanyear (latent)", -5.3867860145356445),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.07993319509559),
                                    ("dayminute", -3.162162463011311),
                                    ("Mawlidyear (latent)", -6.07993319509559),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.674468086987426),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.07993319509559),
                                    ("Jumu'atul-Widayear (latent)", -5.163642463221435),
                                    ("minuteday", -2.4423470353692043),
                                    ("absorption of , after named dayintersect", -6.07993319509559),
                                    ("in|within|after <duration><time-of-day> am|pm",
                                     -6.07993319509559),
                                    ("Orthodox Easter Sundayyear (latent)", -6.07993319509559),
                                    ("<ordinal> <cycle> of <time>year (latent)", -6.07993319509559),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.07993319509559),
                                    ("Boss's Dayyear (latent)", -5.674468086987426),
                                    ("Global Youth Service Dayyear (latent)", -6.07993319509559),
                                    ("Dhanterasin|during <named-month>|year", -6.07993319509559),
                                    ("Tisha B'Avyear (latent)", -6.07993319509559),
                                    ("Isra and Mi'rajyear (latent)", -5.163642463221435),
                                    ("at <time-of-day>on <day>", -4.981320906427481),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.07993319509559),
                                    ("Christmasyear (latent)", -5.674468086987426),
                                    ("Naraka Chaturdashiyear (latent)", -5.674468086987426),
                                    ("Thai Pongalin|during <named-month>|year", -6.07993319509559),
                                    ("dayweek", -6.07993319509559),
                                    ("Easter Sundayyear (latent)", -5.3867860145356445),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.470495282661489),
                                    ("weekyear", -4.981320906427481),
                                    ("hh:mmin|during the <part-of-day>", -5.3867860145356445),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.674468086987426),
                                    ("Hanukkahyear (latent)", -5.3867860145356445),
                                    ("February<time> <part-of-day>", -6.07993319509559),
                                    ("Great Lentyear (latent)", -6.07993319509559),
                                    ("tomorrowat <time-of-day>", -5.3867860145356445),
                                    ("Vaisakhiyear (latent)", -5.3867860145356445),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.07993319509559),
                                    ("last <cycle> of <time>year (latent)", -5.3867860145356445),
                                    ("at <time-of-day>tomorrow", -5.674468086987426),
                                    ("tomorrow<time-of-day> am|pm", -6.07993319509559),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.07993319509559),
                                    ("Diwaliyear (latent)", -6.07993319509559),
                                    ("between <time> and <time>on <day>", -4.470495282661489),
                                    ("Black Fridayyear (latent)", -5.674468086987426),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.07993319509559),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.07993319509559),
                                    ("Chhathyear (latent)", -5.674468086987426),
                                    ("Vasant Panchamiyear (latent)", -6.07993319509559),
                                    ("Thursday<time> (timezone)", -6.07993319509559),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.07993319509559),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.674468086987426),
                                    ("Februaryintersect", -6.07993319509559),
                                    ("Simchat Torahyear (latent)", -6.07993319509559),
                                    ("minuteyear", -6.07993319509559)],
                               n = 328},
                   koData =
                     ClassData{prior = -1.002951170098997, unseen = -6.395261598115449,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -4.784152841516532),
                                    ("dayhour", -3.0262949239641577),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.784152841516532),
                                    ("Tuesdayfrom|since|after <time>", -5.700443573390687),
                                    ("daymonth", -3.6855405528484217),
                                    ("monthyear", -4.314149212270796),
                                    ("yearhour", -5.700443573390687),
                                    ("<time-of-day> am|pmyear (latent)", -5.0072963928307415),
                                    ("Thai Pongalyear (latent)", -5.0072963928307415),
                                    ("intersecthh:mm", -5.700443573390687),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.700443573390687),
                                    ("houryear", -4.601831284722577),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.700443573390687),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.0072963928307415),
                                    ("<time-of-day> am|pmintersect", -4.447680604895319),
                                    ("Octoberyear (latent)", -5.294978465282522),
                                    ("until <time>on <day>", -5.0072963928307415),
                                    ("in|within|after <duration>at <time-of-day>",
                                     -5.700443573390687),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.0072963928307415),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.700443573390687),
                                    ("hh:mmon <day>", -3.6855405528484217),
                                    ...
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.700443573390687),
                                    ("<time-of-day> am|pmon <day>", -4.447680604895319),
                                    ("Mondayyear (latent)", -5.0072963928307415),
                                    ("dayday", -5.294978465282522),
                                    ("mm/ddat <time-of-day>", -5.294978465282522),
                                    ("on <day>September", -5.294978465282522),
                                    ("dayyear", -2.810071815494522),
                                    ...
                                    ("Thursdayat <time-of-day>", -4.091005660956586),
                                    ...
                                    ("week-endin|during <named-month>|year", -5.700443573390687),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.294978465282522),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.700443573390687),
                                    ("Sundayyear (latent)", -4.784152841516532),
                                    ("Christmasat <time-of-day>", -5.700443573390687),
                                    ("from|since|after <time>year (latent)", -4.601831284722577),
