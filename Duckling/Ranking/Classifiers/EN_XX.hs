...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6830153816295383, unseen = -5.521460917862246,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 248},
                   koData =
                     ClassData{prior = -0.7033826844539721,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48919106119799716,
                               unseen = -6.586171654854675,
                               likelihoods =
                                 HashMap.fromList
                                   [("Ramadanyear (latent)", -5.8916442118257715),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.638881243330403),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.638881243330403),
                                    ("hourday", -4.186896119587346),
                                    ("dayhour", -2.973873479741492),
                                    ("Martin Luther King's Dayyear (latent)", -5.486179103717607),
                                    ("Shemini Atzeretyear (latent)", -5.8916442118257715),
                                    ("daymonth", -5.198497031265826),
                                    ("monthday", -5.486179103717607),
                                    ("monthyear", -4.282206299391671),
                                    ("Yom Ha'atzmautyear (latent)", -5.8916442118257715),
                                    ("Thanksgiving Dayyear (latent)", -4.7930319231576615),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.8916442118257715),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.8916442118257715),
                                    ("houryear", -5.198497031265826),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.8916442118257715),
                                    ("Christmas<time-of-day> am|pm", -5.8916442118257715),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.8916442118257715),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.198497031265826),
                                    ("<time-of-day> am|pmintersect", -4.638881243330403),
                                    ("Octoberyear (latent)", -4.638881243330403),
                                    ("intersect<time-of-day> am|pm", -5.8916442118257715),
                                    ("Shavuotyear (latent)", -5.8916442118257715),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.8916442118257715),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.8916442118257715),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.486179103717607),
                                    ("Marchyear (latent)", -5.8916442118257715),
                                    ("Sukkotyear (latent)", -5.486179103717607),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.8916442118257715),
                                    ("Clean Mondayyear (latent)", -5.486179103717607),
                                    ("monthhour", -5.486179103717607),
                                    ("todayat <time-of-day>", -5.8916442118257715),
                                    ("Thursday<time> timezone", -4.186896119587346),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.8916442118257715),
                                    ("Palm SundaySunday", -5.486179103717607),
                                    ("dayday", -3.694419634489552),
                                    ("<time> <part-of-day>at <time-of-day>", -5.8916442118257715),
                                    ("mm/ddat <time-of-day>", -5.8916442118257715),
                                    ("tonightat <time-of-day>", -5.8916442118257715),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.198497031265826),
                                    ("today<time-of-day> am|pm", -5.8916442118257715),
                                    ("Februarythe <day-of-month> (ordinal)", -5.486179103717607),
                                    ("at <time-of-day><time> <part-of-day>", -5.8916442118257715),
                                    ("mm/dd<time-of-day> am|pm", -5.8916442118257715),
                                    ("hourhour", -4.638881243330403),
                                    ("<time-of-day> am|pmon <date>", -3.8767411912835064),
                                    ("Wednesdaythis|last|next <cycle>", -5.8916442118257715),
                                    ("Lentyear (latent)", -5.8916442118257715),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.387566815049497),
                                    ("dayyear", -2.267303278849406),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.8916442118257715),
                                    ("Thursdayat <time-of-day>", -5.486179103717607),
                                    ("Islamic New Yearyear (latent)", -5.486179103717607),
                                    ("Laylat al-Qadryear (latent)", -4.975353479951616),
                                    ("Shrove Tuesdayyear (latent)", -5.8916442118257715),
                                    ("<time-of-day> am|pmtomorrow", -5.198497031265826),
                                    ("Yom Kippuryear (latent)", -5.8916442118257715),
                                    ("<part-of-day> of <time>year (latent)", -5.8916442118257715),
                                    ("minutehour", -4.975353479951616),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.486179103717607),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.186896119587346),
                                    ("for <duration> from <time>December", -5.8916442118257715),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.8916442118257715),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.975353479951616),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.486179103717607),
                                    ("Pentecostyear (latent)", -5.8916442118257715),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.975353479951616),
                                    ("Eid al-Fitryear (latent)", -5.8916442118257715),
                                    ("Mondayin|during the <part-of-day>", -5.8916442118257715),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.486179103717607),
                                    ("Ashurayear (latent)", -5.8916442118257715),
                                    ("Chinese New Yearyear (latent)", -5.8916442118257715),
                                    ("Sundayyear (latent)", -5.8916442118257715),
                                    ("Lag BaOmeryear (latent)", -5.8916442118257715),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.8916442118257715),
                                    ("Eid al-Adhayear (latent)", -4.975353479951616),
                                    ("intersectin|during the <part-of-day>", -5.8916442118257715),
                                    ("Christmasat <time-of-day>", -5.8916442118257715),
                                    ("Passoveryear (latent)", -5.8916442118257715),
                                    ("Lazarus Saturdayyear (latent)", -5.8916442118257715),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.8916442118257715),
                                    ("Yom HaShoahyear (latent)", -5.486179103717607),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.975353479951616),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.8916442118257715),
                                    ("Septemberyear (latent)", -5.486179103717607),
                                    ("mm/ddyear (latent)", -5.8916442118257715),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.638881243330403),
                                    ("Halloweenyear (latent)", -5.8916442118257715),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.198497031265826),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -4.975353479951616),
                                    ("at <time-of-day>intersect", -5.486179103717607),
                                    ("Rosh Hashanahyear (latent)", -5.8916442118257715),
                                    ("Tu BiShvatyear (latent)", -5.8916442118257715),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.8916442118257715),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.8916442118257715),
                                    ("dayminute", -3.2525868822105126),
                                    ("Mawlidyear (latent)", -5.8916442118257715),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.486179103717607),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.8916442118257715),
                                    ("Jumu'atul-Widayear (latent)", -4.975353479951616),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.8916442118257715),
                                    ("minuteday", -2.2540580520993854),
                                    ("absorption of , after named dayintersect",
                                     -5.8916442118257715),
                                    ("intersectyear (latent)", -5.8916442118257715),
                                    ("Orthodox Easter Sundayyear (latent)", -5.8916442118257715),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.8916442118257715),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.8916442118257715),
                                    ("Boss's Dayyear (latent)", -5.486179103717607),
                                    ("Tisha B'Avyear (latent)", -5.8916442118257715),
                                    ("Isra and Mi'rajyear (latent)", -4.975353479951616),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.8916442118257715),
                                    ("Christmasyear (latent)", -5.486179103717607),
                                    ("at <time-of-day>on <date>", -4.7930319231576615),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.282206299391671),
                                    ("dayweek", -5.8916442118257715),
                                    ("Easter Sundayyear (latent)", -5.198497031265826),
                                    ("Thursday<time-of-day> am|pm", -5.8916442118257715),
                                    ("weekyear", -5.486179103717607),
                                    ("hh:mmin|during the <part-of-day>", -5.198497031265826),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.486179103717607),
                                    ("Hanukkahyear (latent)", -5.8916442118257715),
                                    ("February<time> <part-of-day>", -5.8916442118257715),
                                    ("Tuesdayin <named-month>|year", -5.8916442118257715),
                                    ("Great Lentyear (latent)", -5.8916442118257715),
                                    ("tomorrowat <time-of-day>", -5.198497031265826),
                                    ("between <time> and <time>on <date>", -4.282206299391671),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.198497031265826),
                                    ("last <cycle> of <time>year (latent)", -5.198497031265826),
                                    ("at <time-of-day>tomorrow", -5.486179103717607),
                                    ("tomorrow<time-of-day> am|pm", -5.8916442118257715),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.8916442118257715),
                                    ("Black Fridayyear (latent)", -5.486179103717607),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.8916442118257715),
                                    ("Palm Sundayintersect", -5.8916442118257715),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.8916442118257715),
                                    ("Februaryintersect", -5.8916442118257715),
                                    ("Simchat Torahyear (latent)", -5.8916442118257715)],
                               n = 271},
                   koData =
                     ClassData{prior = -0.9496463255750383, unseen = -6.263398262591624,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.568344503761097),
                                    ("hourday", -5.568344503761097),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.568344503761097),
                                    ("dayhour", -3.1259974683918927),
                                    ("daymonth", -3.488902962081261),
                                    ("monthday", -5.162879395652933),
                                    ("monthyear", -4.3155815352657285),
                                    ("<time-of-day> am|pmyear (latent)", -5.162879395652933),
                                    ("intersecthh:mm", -5.568344503761097),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.568344503761097),
                                    ("houryear", -4.6520537718869415),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.568344503761097),
                                    ("until <time-of-day><time-of-day> am|pm", -5.568344503761097),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.875197323201151),
                                    ("<time-of-day> am|pmintersect", -4.3155815352657285),
                                    ("Octoberyear (latent)", -5.568344503761097),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.568344503761097),
                                    ("absorption of , after named dayJuly", -5.162879395652933),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.6520537718869415),
                                    ("Clean Mondayyear (latent)", -5.568344503761097),
                                    ("monthhour", -5.568344503761097),
                                    ("hourmonth", -4.875197323201151),
                                    ("todayat <time-of-day>", -5.568344503761097),
                                    ("from|since|after <time-of-day>July", -5.568344503761097),
                                    ("Mondayyear (latent)", -4.875197323201151),
                                    ("dayday", -5.162879395652933),
                                    ("mm/ddat <time-of-day>", -5.162879395652933),
                                    ("<time-of-day> am|pmon <date>", -4.3155815352657285),
                                    ("dayyear", -2.795755781521316),
                                    ("Thursdaymm/dd", -5.568344503761097),
                                    ("New Year's Dayyear (latent)", -5.162879395652933),
                                    ("Thursdayat <time-of-day>", -4.3155815352657285),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.568344503761097),
                                    ("Aprilyear (latent)", -5.568344503761097),
                                    ("monthminute", -5.568344503761097),
                                    ("<time-of-day> am|pmtomorrow", -5.568344503761097),
                                    ("Thursdayhh:mm", -4.6520537718869415),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.568344503761097),
                                    ("minutemonth", -3.776585034533042),
                                    ("Sundayfrom|since|after <time-of-day>", -5.568344503761097),
                                    ("week-endin <named-month>|year", -5.568344503761097),
                                    ("Augustyear (latent)", -5.162879395652933),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.162879395652933),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.162879395652933),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.568344503761097),
                                    ("Sundayyear (latent)", -4.875197323201151),
                                    ("Christmasat <time-of-day>", -5.568344503761097),
                                    ("<duration> after|before|from <time>December",
                                     -5.568344503761097),
                                    ("yesterday<time-of-day> am|pm", -5.568344503761097),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.6520537718869415),
                                    ("mm/ddyear (latent)", -5.568344503761097),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.162879395652933),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.568344503761097),
                                    ("until <time-of-day>on <date>", -4.875197323201151),
                                    ("at <time-of-day>intersect", -5.162879395652933),
                                    ("hh:mmyear (latent)", -4.4697322150929875),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.568344503761097),
                                    ("dayminute", -3.0834378539730967),
                                    ("intersectSeptember", -4.064267106984823),
                                    ("minuteday", -2.5002915686274796),
                                    ("absorption of , after named dayintersect",
                                     -5.568344503761097),
                                    ("Februaryin|during the <part-of-day>", -5.568344503761097),
                                    ("hh:mmon <date>", -3.553441483218832),
                                    ("Saturdayyear (latent)", -5.568344503761097),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.568344503761097),
                                    ("absorption of , after named daySeptember",
                                     -4.6520537718869415),
                                    ("on <date>September", -5.162879395652933),
                                    ("at <time-of-day>on <date>", -5.162879395652933),
                                    ("in <named-month>|yearyear (latent)", -5.568344503761097),
                                    ("dayweek", -5.568344503761097),
                                    ("Easter Sundayyear (latent)", -5.162879395652933),
                                    ("Thursday<time-of-day> am|pm", -5.162879395652933),
                                    ("absorption of , after named dayFebruary",
                                     -4.6520537718869415),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.568344503761097),
                                    ("tomorrowat <time-of-day>", -5.568344503761097),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.568344503761097),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.9589065913269965),
                                    ("tomorrow<time-of-day> am|pm", -5.568344503761097),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.875197323201151),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.568344503761097),
                                    ("Fridayyear (latent)", -5.162879395652933),
                                    ("minuteyear", -4.3155815352657285)],
                               n = 171}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.2118439960602764, unseen = -4.543294782270004,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -5.5262678675049415e-2),
                                    ("intersect 2 numbers", -3.4339872044851463)],
                               n = 89},
                   koData =
                     ClassData{prior = -1.6559579280689931, unseen = -3.258096538021482,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.5370924029585704),
                                    ("integer (0..19)year (grain)", -3.3843902633457743),
                                    ("integer (numeric)day (grain)", -2.7782544597754586),
                                    ...
                                    ("integer (numeric)year (grain)", -3.096708190893993),
                                    ("day", -2.468099531471619), ("year", -2.6112003751122925),
                                    ("integer (numeric)week (grain)", -3.096708190893993),
                                    ("integer (0..19)month (grain)", -3.5667118201397288),
                                    ("hour", -2.691243082785829), ("month", -2.8735646395797834),
                                    ("integer (numeric)minute (grain)", -3.230239583518516),
                                    ("integer (0..19)minute (grain)", -3.096708190893993),
                                    ("integer (numeric)month (grain)", -3.3843902633457743),
