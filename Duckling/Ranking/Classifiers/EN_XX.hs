...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7482990006350254, unseen = -5.278114659230518,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 194},
                   koData =
                     ClassData{prior = -0.6408787520141884, unseen = -5.384495062789089,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4862264647526229,
                               unseen = -6.3561076606958915,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                     -4.408459891742037),
                                    ("Lentyear", -5.661222860237405),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.408459891742037),
                                    ("hourday", -3.95647476799898),
                                    ("dayhour", -2.7708511023412403),
                                    ("daymonth", -4.96807567967746),
                                    ("monthday", -5.255757752129241),
                                    ("monthyear", -4.051784947803305),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.661222860237405),
                                    ("Easter Sundayyear", -4.96807567967746),
                                    ("Christmasyear", -5.255757752129241),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.661222860237405),
                                    ("houryear", -5.255757752129241),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.661222860237405),
                                    ("Christmas<time-of-day> am|pm", -5.661222860237405),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.96807567967746),
                                    ("<time-of-day> am|pmintersect", -4.408459891742037),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.661222860237405),
                                    ("Marchyear", -5.661222860237405),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.255757752129241),
                                    ("intersect<time-of-day> am|pm", -5.661222860237405),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.661222860237405),
                                    ("monthhour", -5.255757752129241),
                                    ("last <day-of-week> of <time>year", -5.661222860237405),
                                    ("todayat <time-of-day>", -5.661222860237405),
                                    ("Thursday<time> timezone", -3.95647476799898),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.661222860237405),
                                    ("Palm SundaySunday", -5.255757752129241),
                                    ("dayday", -3.4639982829011857),
                                    ("Thanksgiving Dayyear", -4.562610571569295),
                                    ("<time> <part-of-day>at <time-of-day>", -5.661222860237405),
                                    ("Tuesdayin <named-month>", -5.661222860237405),
                                    ("mm/ddat <time-of-day>", -5.661222860237405),
                                    ("tonightat <time-of-day>", -5.661222860237405),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.96807567967746),
                                    ("today<time-of-day> am|pm", -5.661222860237405),
                                    ("Februarythe <day-of-month> (ordinal)", -5.255757752129241),
                                    ("at <time-of-day><time> <part-of-day>", -5.661222860237405),
                                    ("mm/dd<time-of-day> am|pm", -5.661222860237405),
                                    ("hourhour", -4.408459891742037),
                                    ("<time-of-day> am|pmon <date>", -3.6463198396951406),
                                    ("Wednesdaythis|last|next <cycle>", -5.661222860237405),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.157145463461131),
                                    ("dayyear", -2.953172659135195),
                                    ("last weekend of <named-month>year", -5.661222860237405),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.661222860237405),
                                    ("Sundayyear", -5.661222860237405),
                                    ("Thursdayat <time-of-day>", -5.255757752129241),
                                    ("<time-of-day> am|pmtomorrow", -4.96807567967746),
                                    ("minutehour", -4.74493212836325),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.255757752129241),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.95647476799898),
                                    ("for <duration> from <time>December", -5.661222860237405),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.661222860237405),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.74493212836325),
                                    ("Mondayin|during the <part-of-day>", -5.661222860237405),
                                    ("Shrove Tuesdayyear", -5.661222860237405),
                                    ("<part-of-day> of <time>year", -5.661222860237405),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.255757752129241),
                                    ("intersectin|during the <part-of-day>", -5.661222860237405),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.661222860237405),
                                    ("year<time-of-day> am|pm", -5.661222860237405),
                                    ("Septemberyear", -5.255757752129241),
                                    ("at <time-of-day>on <date>", -4.562610571569295),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.96807567967746),
                                    ("Halloweenyear", -5.661222860237405),
                                    ("dayweek", -5.661222860237405),
                                    ("Thursday<time-of-day> am|pm", -5.661222860237405),
                                    ("weekyear", -5.255757752129241),
                                    ("hh:mmin|during the <part-of-day>", -4.96807567967746),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.255757752129241),
                                    ("February<time> <part-of-day>", -5.661222860237405),
                                    ("Martin Luther King's Dayyear", -5.255757752129241),
                                    ("tomorrowat <time-of-day>", -4.96807567967746),
                                    ("between <time> and <time>on <date>", -4.96807567967746),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.96807567967746),
                                    ("at <time-of-day>tomorrow", -5.255757752129241),
                                    ("tomorrow<time-of-day> am|pm", -5.661222860237405),
                                    ("Pentecostyear", -5.661222860237405),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.661222860237405),
                                    ("Palm Sundayintersect", -5.661222860237405),
                                    ("Labor Dayyear", -5.661222860237405),
                                    ("Februaryintersect", -5.661222860237405),
                                    ("last <cycle> of <time>year", -4.96807567967746),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.661222860237405),
                                    ("yearminute", -5.661222860237405),
                                    ("Black Fridayyear", -5.255757752129241)],
                               n = 214},
                   koData =
                     ClassData{prior = -0.954362679823563, unseen = -6.030685260261263,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.3351313396707525),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.3351313396707525),
                                    ("hourday", -5.3351313396707525),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.3351313396707525),
                                    ("dayhour", -2.8927843043015486),
                                    ("daymonth", -3.255689797990917),
                                    ("monthday", -4.929666231562589),
                                    ("monthyear", -4.641984159110808),
                                    ("intersecthh:mm", -5.3351313396707525),
                                    ("Easter Sundayyear", -5.3351313396707525),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.3351313396707525),
                                    ("houryear", -5.3351313396707525),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.3351313396707525),
                                    ("until <time-of-day><time-of-day> am|pm", -5.3351313396707525),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.641984159110808),
                                    ("<time-of-day> am|pmintersect", -4.082368371175385),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.418840607796598),
                                    ("from|since|after <time-of-day>on <date>", -4.418840607796598),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.3351313396707525),
                                    ("absorption of , after named dayJuly", -4.929666231562589),
                                    ("monthhour", -5.3351313396707525),
                                    ("hourmonth", -4.641984159110808),
                                    ("todayat <time-of-day>", -5.3351313396707525),
                                    ("from|since|after <time-of-day>July", -5.3351313396707525),
                                    ("dayday", -4.929666231562589),
                                    ("mm/ddat <time-of-day>", -4.929666231562589),
                                    ("<time-of-day> am|pmon <date>", -4.082368371175385),
                                    ("dayyear", -3.6303832474323277),
                                    ("Thursdaymm/dd", -5.3351313396707525),
                                    ("Sundayyear", -4.641984159110808),
                                    ("Thursdayat <time-of-day>", -4.082368371175385),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.3351313396707525),
                                    ("monthminute", -5.3351313396707525),
                                    ("<time-of-day> am|pmtomorrow", -5.3351313396707525),
                                    ("Thursdayhh:mm", -4.418840607796598),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.3351313396707525),
                                    ("Fridayyear", -4.929666231562589),
                                    ("minutemonth", -3.543371870442698),
                                    ("Sundayfrom|since|after <time-of-day>", -5.3351313396707525),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.929666231562589),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.929666231562589),
                                    ("Aprilyear", -5.3351313396707525),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -4.929666231562589),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.3351313396707525),
                                    ("Christmasat <time-of-day>", -5.3351313396707525),
                                    ("<duration> after|before|from <time>December",
                                     -5.3351313396707525),
                                    ("yesterday<time-of-day> am|pm", -5.3351313396707525),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.3351313396707525),
                                    ("until <time-of-day>on <date>", -4.641984159110808),
                                    ("at <time-of-day>intersect", -4.929666231562589),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.3351313396707525),
                                    ("dayminute", -2.8094026953624978),
                                    ("intersectSeptember", -3.8310539428944788),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.3351313396707525),
                                    ("minuteday", -2.417360607586474),
                                    ("absorption of , after named dayintersect",
                                     -5.3351313396707525),
                                    ("Februaryin|during the <part-of-day>", -5.3351313396707525),
                                    ("week-endin <named-month>", -5.3351313396707525),
                                    ("Octoberyear", -5.3351313396707525),
                                    ("from|since|after <time-of-day>year", -5.3351313396707525),
                                    ("yearhh:mm", -5.3351313396707525),
                                    ("hh:mmon <date>", -3.8310539428944788),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.3351313396707525),
                                    ("absorption of , after named daySeptember",
                                     -4.418840607796598),
                                    ("on <date>September", -4.929666231562589),
                                    ("at <time-of-day>on <date>", -4.929666231562589),
                                    ("dayweek", -5.3351313396707525),
                                    ("Thursday<time-of-day> am|pm", -4.929666231562589),
                                    ("absorption of , after named dayFebruary", -4.418840607796598),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.3351313396707525),
                                    ("tomorrowat <time-of-day>", -5.3351313396707525),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.3351313396707525),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.7256934272366524),
                                    ("tomorrow<time-of-day> am|pm", -5.3351313396707525),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.3351313396707525),
       ...
       ("year",
        Classifier{okData =
                     ClassData{prior = -0.2411620568168881, unseen = -3.891820298110627,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -8.701137698962981e-2),
                                    ("intersect 2 numbers", -3.1780538303479458)],
                               n = 44},
                   koData =
                     ClassData{prior = -1.540445040947149, unseen = -2.833213344056216,
                               likelihoods =
                                 HashMap.fromList
