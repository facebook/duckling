...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6679003978251614,
                               unseen = -5.8944028342648505,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 361},
                   koData =
                     ClassData{prior = -0.7190479089921025, unseen = -5.84354441703136,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5047465776896085, unseen = -6.952728644624869,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.258624983838966),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.258624983838966),
                                    ("Ramadanyear (latent)", -5.342334251964811),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.243721963296701),
                                    ("Bhai Doojyear (latent)", -6.258624983838966),
                                    ("hourday", -4.243721963296701),
                                    ("dayhour", -3.340854251754687),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.243721963296701),
                                    ("Martin Luther King's Dayyear (latent)", -5.853159875730801),
                                    ("Shemini Atzeretyear (latent)", -6.258624983838966),
                                    ("daymonth", -4.118558820342695),
                                    ("monthday", -5.853159875730801),
                                    ("monthyear", -4.386822806937374),
                                    ("Yom Ha'atzmautyear (latent)", -6.258624983838966),
                                    ("Vijayadashamiyear (latent)", -6.258624983838966),
                                    ("Thanksgiving Dayyear (latent)", -5.160012695170856),
                                    ("Thai Pongalyear (latent)", -5.565477803279021),
                                    ("Thiru Onamyear (latent)", -5.565477803279021),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.258624983838966),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.342334251964811),
                                    ("<day-of-month> (ordinal)Wednesday", -6.258624983838966),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.258624983838966),
                                    ("houryear", -5.342334251964811),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.258624983838966),
                                    ("Christmas<time-of-day> am|pm", -6.258624983838966),
                                    ("<day-of-month> (ordinal)October", -6.258624983838966),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.258624983838966),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.565477803279021),
                                    ("intersectin|during <named-month>|year", -6.258624983838966),
                                    ("<time-of-day> am|pmintersect", -5.005862015343598),
                                    ("Earth Houryear (latent)", -6.258624983838966),
                                    ("Octoberyear (latent)", -4.6491870714048655),
                                    ("intersect<time-of-day> am|pm", -6.258624983838966),
                                    ("Mattu Pongalyear (latent)", -6.258624983838966),
                                    ("Shavuotyear (latent)", -6.258624983838966),
                                    ("Parsi New Yearyear (latent)", -5.342334251964811),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.258624983838966),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.258624983838966),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.853159875730801),
                                    ("Marchyear (latent)", -6.258624983838966),
                                    ("Sukkotyear (latent)", -5.853159875730801),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.853159875730801),
                                    ("Clean Mondayyear (latent)", -5.853159875730801),
                                    ("monthhour", -5.853159875730801),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.565477803279021),
                                    ("todayat <time-of-day>", -6.258624983838966),
                                    ("Thursday<time> timezone", -4.312714834783653),
                                    ("time-of-day (latent)tonight", -5.853159875730801),
                                    ("from|since|after <time>December", -6.258624983838966),
                                    ("<time-of-day> am|pmon <day>", -4.243721963296701),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.258624983838966),
                                    ("yyyy-mm-ddhh:mm:ss", -5.853159875730801),
                                    ("dayday", -3.8162779484697618),
                                    ("<time> <part-of-day>at <time-of-day>", -6.258624983838966),
                                    ("mm/ddat <time-of-day>", -6.258624983838966),
                                    ("tonightat <time-of-day>", -6.258624983838966),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.565477803279021),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.258624983838966),
                                    ("today<time-of-day> am|pm", -6.258624983838966),
                                    ("Februarythe <day-of-month> (ordinal)", -5.853159875730801),
                                    ("at <time-of-day><time> <part-of-day>", -6.258624983838966),
                                    ("<day-of-month> (ordinal)intersect", -5.565477803279021),
                                    ("mm/dd<time-of-day> am|pm", -6.258624983838966),
                                    ("hourhour", -4.17918344215913),
                                    ("Navaratriin|during <named-month>|year", -6.258624983838966),
                                    ("Wednesdaythis|last|next <cycle>", -6.258624983838966),
                                    ("Lentyear (latent)", -6.258624983838966),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.754547587062692),
                                    ("Boghiyear (latent)", -6.258624983838966),
                                    ("dayyear", -2.0614230361771577),
                                    ("Thursdayfrom|since|after <time>", -5.853159875730801),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.258624983838966),
                                    ("Thursdayat <time-of-day>", -5.565477803279021),
                                    ("Islamic New Yearyear (latent)", -5.853159875730801),
                                    ("Laylat al-Qadryear (latent)", -5.342334251964811),
                                    ("Shrove Tuesdayyear (latent)", -6.258624983838966),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.565477803279021),
                                    ("<time-of-day> am|pmtomorrow", -5.565477803279021),
                                    ("Yom Kippuryear (latent)", -6.258624983838966),
                                    ("<day-of-month> (ordinal)Tuesday", -5.853159875730801),
                                    ("<part-of-day> of <time>year (latent)", -6.258624983838966),
                                    ("minutehour", -5.160012695170856),
                                    ("Kaanum Pongalyear (latent)", -5.853159875730801),
                                    ("Maha Saptamiyear (latent)", -6.258624983838966),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.853159875730801),
                                    ("time-of-day (latent)tomorrow", -5.342334251964811),
                                    ("part of daysat <time-of-day>", -5.853159875730801),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.553876891600541),
                                    ("for <duration> from <time>December", -6.258624983838966),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.258624983838966),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.005862015343598),
                                    ("time-of-day (latent)this <part-of-day>", -6.258624983838966),
                                    ("Pentecostyear (latent)", -6.258624983838966),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.005862015343598),
                                    ("<day-of-month> (ordinal)February", -6.258624983838966),
                                    ("Eid al-Fitryear (latent)", -5.342334251964811),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.258624983838966),
                                    ("Mondayin|during the <part-of-day>", -6.258624983838966),
                                    ("Chhathin|during <named-month>|year", -6.258624983838966),
                                    ("Diwaliin|during <named-month>|year", -6.258624983838966),
                                    ("Vaisakhiin|during <named-month>|year", -6.258624983838966),
                                    ("Raksha Bandhanyear (latent)", -6.258624983838966),
                                    ("daysecond", -5.853159875730801),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.853159875730801),
                                    ("Ashurayear (latent)", -6.258624983838966),
                                    ("Tuesdayin|during <named-month>|year", -6.258624983838966),
                                    ("Chinese New Yearyear (latent)", -6.258624983838966),
                                    ("tomorrowintersect", -6.258624983838966),
                                    ("Lag BaOmeryear (latent)", -6.258624983838966),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.258624983838966),
                                    ("Eid al-Adhayear (latent)", -5.342334251964811),
                                    ("intersectin|during the <part-of-day>", -6.258624983838966),
                                    ("Palm Sundayyear (latent)", -6.258624983838966),
                                    ("Christmasat <time-of-day>", -6.258624983838966),
                                    ("Passoveryear (latent)", -6.258624983838966),
                                    ("Lazarus Saturdayyear (latent)", -6.258624983838966),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.853159875730801),
                                    ("Yom HaShoahyear (latent)", -5.853159875730801),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.853159875730801),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.258624983838966),
                                    ("Septemberyear (latent)", -5.853159875730801),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.754547587062692),
                                    ("Halloweenyear (latent)", -6.258624983838966),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.258624983838966),
                                    ("at <time-of-day>intersect", -5.853159875730801),
                                    ("Rosh Hashanahyear (latent)", -5.565477803279021),
                                    ("Dhanterasyear (latent)", -6.258624983838966),
                                    ("Tu BiShvatyear (latent)", -6.258624983838966),
                                    ("<day-of-month> (ordinal)December", -5.565477803279021),
                                    ("Holiyear (latent)", -5.565477803279021),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.258624983838966),
                                    ("Holika Dahanyear (latent)", -5.565477803279021),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.258624983838966),
                                    ("dayminute", -3.340854251754687),
                                    ("Mawlidyear (latent)", -6.258624983838966),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.853159875730801),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.258624983838966),
                                    ("Jumu'atul-Widayear (latent)", -5.342334251964811),
                                    ("minuteday", -2.429983587349871),
                                    ("absorption of , after named dayintersect",
                                     -6.258624983838966),
                                    ("intersectyear (latent)", -5.853159875730801),
                                    ("Orthodox Easter Sundayyear (latent)", -6.258624983838966),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.258624983838966),
                                    ("Boss's Dayyear (latent)", -5.853159875730801),
                                    ("Global Youth Service Dayyear (latent)", -6.258624983838966),
                                    ("Dhanterasin|during <named-month>|year", -6.258624983838966),
                                    ("Tisha B'Avyear (latent)", -6.258624983838966),
                                    ("Isra and Mi'rajyear (latent)", -5.342334251964811),
                                    ("at <time-of-day>on <day>", -5.160012695170856),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.258624983838966),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.565477803279021),
                                    ("Christmasyear (latent)", -5.853159875730801),
                                    ("Naraka Chaturdashiyear (latent)", -5.853159875730801),
                                    ("Thai Pongalin|during <named-month>|year", -6.258624983838966),
                                    ("dayweek", -6.258624983838966),
                                    ("Easter Sundayyear (latent)", -5.565477803279021),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.6491870714048655),
                                    ("weekyear", -5.160012695170856),
                                    ("hh:mmin|during the <part-of-day>", -5.565477803279021),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.853159875730801),
                                    ("Hanukkahyear (latent)", -5.565477803279021),
                                    ("February<time> <part-of-day>", -6.258624983838966),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.258624983838966),
                                    ("Great Lentyear (latent)", -6.258624983838966),
                                    ("tomorrowat <time-of-day>", -5.565477803279021),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.258624983838966),
                                    ("Vaisakhiyear (latent)", -5.565477803279021),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.258624983838966),
                                    ("last <cycle> of <time>year (latent)", -5.565477803279021),
                                    ("at <time-of-day>tomorrow", -5.853159875730801),
                                    ("tomorrow<time-of-day> am|pm", -6.258624983838966),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.258624983838966),
                                    ("Diwaliyear (latent)", -6.258624983838966),
                                    ("between <time> and <time>on <day>", -4.6491870714048655),
                                    ("Black Fridayyear (latent)", -5.853159875730801),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.258624983838966),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.258624983838966),
                                    ("Chhathyear (latent)", -5.853159875730801),
                                    ("Vasant Panchamiyear (latent)", -6.258624983838966),
                                    ("St Patrick's Dayyear (latent)", -6.258624983838966),
                                    ("Thursday<time> (timezone)", -6.258624983838966),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.258624983838966),
                                    ("<datetime> - <datetime> (interval)July", -5.853159875730801),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.853159875730801),
                                    ("Februaryintersect", -6.258624983838966),
                                    ("Simchat Torahyear (latent)", -6.258624983838966),
                                    ("minuteyear", -6.258624983838966)],
                               n = 396},
                   koData =
                     ClassData{prior = -0.9254791579285613, unseen = -6.651571873589727,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.2490816669252665),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.957131868027477),
                                    ("<day-of-month> (ordinal)August", -5.957131868027477),
                                    ("dayhour", -3.2829832186009478),
                                    ("<time> timezoneyear (latent)", -5.957131868027477),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.040841136153322),
                                    ("Tuesdayfrom|since|after <time>", -5.957131868027477),
                                    ("daymonth", -3.472225218239476),
                                    ("monthyear", -4.704368899532109),
                                    ("<time-of-day> am|pmyear (latent)", -5.263984687467532),
                                    ("Thai Pongalyear (latent)", -5.263984687467532),
                                    ("intersecthh:mm", -5.957131868027477),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.551666759919312),
                                    ("<day-of-month> (ordinal)Wednesday", -5.957131868027477),
                                    ("houryear", -4.570837506907586),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.957131868027477),
                                    ("<day-of-month> (ordinal)October", -5.957131868027477),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.263984687467532),
                                    ("<time-of-day> am|pmintersect", -4.704368899532109),
                                    ("Octoberyear (latent)", -5.957131868027477),
                                    ("until <time>on <day>", -5.263984687467532),
                                    ("time-of-day (latent)intersect", -5.957131868027477),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.263984687467532),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.957131868027477),
                                    ("hh:mmon <day>", -3.5147848326582722),
                                    ("absorption of , after named dayJuly", -5.551666759919312),
                                    ("from|since|after <time>July", -5.551666759919312),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.040841136153322),
                                    ("Clean Mondayyear (latent)", -5.957131868027477),
                                    ("monthhour", -5.957131868027477),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.551666759919312),
                                    ("hourmonth", -4.085329691125885),
                                    ("todayat <time-of-day>", -5.957131868027477),
                                    ("from|since|after <time>December", -5.957131868027477),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.957131868027477),
                                    ("<time-of-day> am|pmon <day>", -4.704368899532109),
                                    ("Mondayyear (latent)", -5.263984687467532),
                                    ("dayday", -4.570837506907586),
                                    ("mm/ddat <time-of-day>", -5.551666759919312),
                                    ("on <day>September", -5.551666759919312),
                                    ("time-of-day (latent)September", -5.551666759919312),
                                    ("hourhour", -5.957131868027477),
                                    ("time-of-day (latent)on <day>", -3.5147848326582722),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.551666759919312),
                                    ("dayyear", -3.0126928888610363),
                                    ("Thursdaymm/dd", -5.957131868027477),
                                    ("New Year's Dayyear (latent)", -5.040841136153322),
                                    ("Thursdayfrom|since|after <time>", -4.252383775789052),
                                    ("Thursdayat <time-of-day>", -4.3476939555933765),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.957131868027477),
                                    ("Aprilyear (latent)", -5.957131868027477),
                                    ("the <day-of-month> (ordinal)July", -5.957131868027477),
                                    ("the <day-of-month> (number)July", -5.957131868027477),
                                    ("monthminute", -5.957131868027477),
                                    ("<time-of-day> am|pmtomorrow", -5.957131868027477),
                                    ("Thursdayhh:mm", -5.040841136153322),
                                    ("<day-of-month> (ordinal)Tuesday", -5.551666759919312),
                                    ("minutemonth", -4.085329691125885),
                                    ("minutehour", -5.957131868027477),
                                    ("Augustyear (latent)", -5.551666759919312),
                                    ("week-endin|during <named-month>|year", -5.957131868027477),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.551666759919312),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.957131868027477),
                                    ("Sundayyear (latent)", -5.040841136153322),
                                    ("Christmasat <time-of-day>", -5.957131868027477),
                                    ("from|since|after <time>year (latent)", -4.858519579359367),
                                    ("<duration> after|before|from <time>December",
                                     -5.957131868027477),
                                    ("yesterday<time-of-day> am|pm", -5.957131868027477),
                                    ("<day-of-month> (ordinal)July", -5.263984687467532),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.957131868027477),
                                    ("mm/ddyear (latent)", -5.957131868027477),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.957131868027477),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.957131868027477),
                                    ("at <time-of-day>intersect", -5.551666759919312),
                                    ("hh:mmyear (latent)", -3.8776903263476408),
                                    ("Holiyear (latent)", -5.957131868027477),
                                    ("until <time><time-of-day> am|pm", -5.957131868027477),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.957131868027477),
                                    ("dayminute", -3.3921825105659402),
                                    ("yyyy-mm-ddhh:mm", -5.551666759919312),
                                    ("intersectSeptember", -4.453054471251202),
                                    ("minuteday", -2.718453415863096),
                                    ("absorption of , after named dayintersect",
                                     -5.957131868027477),
                                    ("intersectyear (latent)", -5.957131868027477),
                                    ("Februaryin|during the <part-of-day>", -5.957131868027477),
                                    ("time-of-day (latent)July", -5.263984687467532),
                                    ("Saturdayyear (latent)", -5.957131868027477),
                                    ("at <time-of-day>on <day>", -5.551666759919312),
                                    ("absorption of , after named daySeptember",
                                     -5.040841136153322),
                                    ("Naraka Chaturdashiyear (latent)", -5.957131868027477),
                                    ("from|since|after <time>on <day>", -5.040841136153322),
                                    ("dayweek", -5.957131868027477),
                                    ("Easter Sundayyear (latent)", -5.551666759919312),
                                    ("Thursday<time-of-day> am|pm", -4.704368899532109),
                                    ("weekyear", -5.551666759919312),
                                    ("time-of-day (latent)Thursday", -5.551666759919312),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.957131868027477),
                                    ("<day-of-month> (ordinal)April", -5.957131868027477),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.551666759919312),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.263984687467532),
                                    ("Sundayfrom|since|after <time>", -5.957131868027477),
                                    ("absorption of , after named dayFebruary", -5.040841136153322),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.957131868027477),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.957131868027477),
                                    ("tomorrowat <time-of-day>", -5.957131868027477),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.551666759919312),
                                    ("last <cycle> of <time>year (latent)", -5.551666759919312),
                                    ("tomorrow<time-of-day> am|pm", -5.957131868027477),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.263984687467532),
                                    ("Diwaliyear (latent)", -5.551666759919312),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.957131868027477),
                                    ("Fridayyear (latent)", -5.551666759919312),
                                    ("time-of-day (latent)April", -5.957131868027477),
                                    ("minuteyear", -3.7599072906912574)],
                               n = 260}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.20124956667947344,
                               unseen = -5.0875963352323845,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.797924806521633e-2),
                                    ("intersect 2 numbers", -3.6951100038645723)],
                               n = 157},
                   koData =
                     ClassData{prior = -1.702147310538368, unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
