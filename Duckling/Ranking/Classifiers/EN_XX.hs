...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6312026945994207, unseen = -5.736572297479192,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 308},
                   koData =
                     ClassData{prior = -0.7591836566932944, unseen = -5.60947179518496,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 271}}),
       ("<year> (bc|ad)",
        Classifier{okData =
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4708071648454188, unseen = -6.727431724850855,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.0330862217988015),
                                    ...
                                    ("Thanksgiving Dayyear (latent)", -4.9344739331306915),
                                    ...
                                    ("Thursday<time> timezone", -4.328338129560376),
                                    ...
                                    ("mm/ddat <time-of-day>", -6.0330862217988015),
                                    ...
                                    ("mm/dd<time-of-day> am|pm", -6.0330862217988015),
                               ...
                               n = 311},
                   koData =
                     ClassData{prior = -0.9794914601700663, unseen = -6.375024819828097,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.763881877142913),
                                    ("hourday", -4.763881877142913),
                                    ("dayhour", -3.1152232515555305),
                                    ("Tuesdayfrom|since|after <time>", -5.680172609017068),
                                    ("daymonth", -3.6652695884748026),
                                    ("monthyear", -4.293878247897177),
                                    ("<time-of-day> am|pmyear (latent)", -5.274707500908903),
                                    ("Thai Pongalyear (latent)", -4.987025428457122),
                                    ("intersecthh:mm", -5.680172609017068),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.680172609017068),
                                    ("houryear", -4.763881877142913),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.680172609017068),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.987025428457122),
                                    ("<time-of-day> am|pmintersect", -4.4274096405217),
                                    ("until <time>on <date>", -4.987025428457122),
                                    ("Octoberyear (latent)", -5.274707500908903),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -4.987025428457122),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.680172609017068),
                                    ("absorption of , after named dayJuly", -5.274707500908903),
                                    ("from|since|after <time>July", -5.680172609017068),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.763881877142913),
                                    ("Clean Mondayyear (latent)", -5.680172609017068),
                                    ("monthhour", -5.680172609017068),
                                    ("hourmonth", -4.763881877142913),
                                    ("todayat <time-of-day>", -5.680172609017068),
                                    ("from|since|after <time>December", -5.680172609017068),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.680172609017068),
                                    ("Mondayyear (latent)", -4.987025428457122),
                                    ("dayday", -5.274707500908903),
                                    ("mm/ddat <time-of-day>", -5.274707500908903),
                                    ("<time-of-day> am|pmon <date>", -4.4274096405217),
                                    ("dayyear", -2.7898008511209027),
                                    ("Thursdaymm/dd", -5.680172609017068),
                                    ("New Year's Dayyear (latent)", -5.274707500908903),
                                    ("Thursdayfrom|since|after <time>", -3.975424516778642),
                                    ("Thursdayat <time-of-day>", -4.4274096405217),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.680172609017068),
                                    ("Aprilyear (latent)", -5.680172609017068),
                                    ("monthminute", -5.680172609017068),
                                    ("<time-of-day> am|pmtomorrow", -5.680172609017068),
                                    ("Thursdayhh:mm", -4.763881877142913),
                                    ("minutemonth", -3.8884131397890123),
                                    ("Augustyear (latent)", -5.274707500908903),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.274707500908903),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.274707500908903),
                                    ("week-endin|during <named-month>|year", -5.680172609017068),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.274707500908903),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.680172609017068),
                                    ("Sundayyear (latent)", -4.763881877142913),
                                    ("Christmasat <time-of-day>", -5.680172609017068),
                                    ("from|since|after <time>year (latent)", -4.581560320348958),
                                    ("<duration> after|before|from <time>December",
                                     -5.680172609017068),
                                    ("yesterday<time-of-day> am|pm", -5.680172609017068),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.680172609017068),
                                    ("mm/ddyear (latent)", -5.680172609017068),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.987025428457122),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.680172609017068),
                                    ("at <time-of-day>intersect", -5.274707500908903),
                                    ("hh:mmyear (latent)", -4.581560320348958),
                                    ("Holiyear (latent)", -5.680172609017068),
                                    ("until <time><time-of-day> am|pm", -5.680172609017068),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.680172609017068),
                                    ("dayminute", -3.0060239595905385),
                                    ("yyyy-mm-ddhh:mm", -5.274707500908903),
                                    ("intersectSeptember", -4.176095212240793),
                                    ("minuteday", -2.6121196738834502),
                                    ("absorption of , after named dayintersect",
                                     -5.680172609017068),
                                    ("Februaryin|during the <part-of-day>", -5.680172609017068),
                                    ("hh:mmon <date>", -3.6652695884748026),
                                    ("Saturdayyear (latent)", -5.680172609017068),
                                    ("from|since|after <time>on <date>", -4.763881877142913),
                                    ("absorption of , after named daySeptember",
                                     -4.763881877142913),
                                    ("Naraka Chaturdashiyear (latent)", -5.680172609017068),
                                    ("on <date>September", -5.274707500908903),
                                    ("at <time-of-day>on <date>", -5.274707500908903),
                                    ("dayweek", -5.680172609017068),
                                    ("Easter Sundayyear (latent)", -5.274707500908903),
                                    ("Thursday<time-of-day> am|pm", -4.987025428457122),
                                    ("weekyear", -5.274707500908903),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -4.987025428457122),
                                    ("Sundayfrom|since|after <time>", -5.680172609017068),
                                    ("absorption of , after named dayFebruary", -4.763881877142913),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.680172609017068),
                                    ("tomorrowat <time-of-day>", -5.680172609017068),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.680172609017068),
                                    ("last <cycle> of <time>year (latent)", -5.274707500908903),
                                    ("tomorrow<time-of-day> am|pm", -5.680172609017068),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.987025428457122),
                                    ("Diwaliyear (latent)", -5.274707500908903),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.680172609017068),
                                    ("Fridayyear (latent)", -5.274707500908903),
                                    ("minuteyear", -4.4274096405217)],
                               n = 187}}),
       ("one eleven",
        Classifier{okData =
