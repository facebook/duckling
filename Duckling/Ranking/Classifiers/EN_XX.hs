...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6316148888713004,
                               unseen = -5.7430031878094825,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 310},
                   koData =
                     ClassData{prior = -0.7587153911655327, unseen = -5.616771097666572,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4767058029636107, unseen = -6.740519359606223,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.046189446797229),
                                    ...
                                    ("Earth Houryear (latent)", -6.046189446797229),
                                    ("Octoberyear (latent)", -4.542112050020955),
                                    ...
                                    ("Thursday<time> timezone", -4.100279297741915),
                                    ("from|since|after <time>December", -6.046189446797229),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.046189446797229),
                                    ("yyyy-mm-ddhh:mm:ss", -5.640724338689064),
                                    ("dayday", -4.0312864262549635),
                                    ...
                                    ("Navaratriin|during <named-month>|year", -6.046189446797229),
                                    ...
                                    ("dayyear", -2.011948808644833),
                                    ("Thursdayfrom|since|after <time>", -5.640724338689064),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.046189446797229),
                                    ("Thursdayat <time-of-day>", -5.353042266237283),
                                    ...
                                    ("Chhathin|during <named-month>|year", -6.046189446797229),
                                    ("Diwaliin|during <named-month>|year", -6.046189446797229),
                                    ("Raksha Bandhanyear (latent)", -6.046189446797229),
                                    ("daysecond", -5.640724338689064),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.640724338689064),
                                    ("Ashurayear (latent)", -6.046189446797229),
                                    ("Tuesdayin|during <named-month>|year", -6.046189446797229),
                                    ...
                                    ("Palm Sundayyear (latent)", -6.046189446797229),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.353042266237283),
                                    ...
                                    ("Global Youth Service Dayyear (latent)", -6.046189446797229),
                                    ("Dhanterasin|during <named-month>|year", -6.046189446797229),
                                    ...
                                    ("Thursday<time> (timezone)", -6.046189446797229),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.046189446797229),
                                    ("Februaryintersect", -6.046189446797229),
                                    ("Simchat Torahyear (latent)", -6.046189446797229),
                                    ("minuteyear", -6.046189446797229)],
                               n = 316},
                   koData =
                     ClassData{prior = -0.9697578276456372, unseen = -6.396929655216146,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.785823685681349),
