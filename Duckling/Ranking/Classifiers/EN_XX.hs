...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47347786551392185,
                               unseen = -7.022868086082641,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.328829242512215),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.328829242512215),
                                    ("Ramadanyear (latent)", -5.4125385106380595),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.3139262219699495),
                                    ("Bhai Doojyear (latent)", -6.328829242512215),
                                    ("hourday", -4.3139262219699495),
                                    ("dayhour", -3.3843902633457743),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.3139262219699495),
                                    ("Martin Luther King's Dayyear (latent)", -5.92336413440405),
                                    ("Shemini Atzeretyear (latent)", -6.328829242512215),
                                    ("daymonth", -4.188763079015944),
                                    ("monthday", -5.92336413440405),
                                    ("monthyear", -4.457027065610623),
                                    ("Yom Ha'atzmautyear (latent)", -6.328829242512215),
                                    ("Vijayadashamiyear (latent)", -6.328829242512215),
                                    ("Thanksgiving Dayyear (latent)", -5.230216953844105),
                                    ("Thai Pongalyear (latent)", -5.635682061952269),
                                    ("Thiru Onamyear (latent)", -5.635682061952269),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.328829242512215),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.4125385106380595),
                                    ("<day-of-month> (ordinal)Wednesday", -6.328829242512215),
                                    ("Krishna Janmashtamiyear (latent)", -5.92336413440405),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.328829242512215),
                                    ("houryear", -5.4125385106380595),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.328829242512215),
                                    ("Christmas<time-of-day> am|pm", -6.328829242512215),
                                    ("<day-of-month> (ordinal)October", -6.328829242512215),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.328829242512215),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.635682061952269),
                                    ("intersectin|during <named-month>|year", -6.328829242512215),
                                    ("<time-of-day> am|pmintersect", -5.0760662740168465),
                                    ("Earth Houryear (latent)", -6.328829242512215),
                                    ("Octoberyear (latent)", -4.719391330078114),
                                    ("intersect<time-of-day> am|pm", -6.328829242512215),
                                    ("Mattu Pongalyear (latent)", -6.328829242512215),
                                    ("Shavuotyear (latent)", -6.328829242512215),
                                    ("Parsi New Yearyear (latent)", -5.4125385106380595),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.328829242512215),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.328829242512215),
                                    ("todayin|within|after <duration>", -6.328829242512215),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.92336413440405),
                                    ("Marchyear (latent)", -6.328829242512215),
                                    ("Sukkotyear (latent)", -5.92336413440405),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.92336413440405),
                                    ("Clean Mondayyear (latent)", -5.92336413440405),
                                    ("monthhour", -5.92336413440405),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.635682061952269),
                                    ("todayat <time-of-day>", -6.328829242512215),
                                    ("Thursday<time> timezone", -4.382919093456901),
                                    ("time-of-day (latent)tonight", -5.92336413440405),
                                    ("from|since|after <time>December", -6.328829242512215),
                                    ("<time-of-day> am|pmon <day>", -4.3139262219699495),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.328829242512215),
                                    ("yyyy-mm-ddhh:mm:ss", -5.92336413440405),
                                    ("dayday", -3.8864822071430103),
                                    ("<time> <part-of-day>at <time-of-day>", -6.328829242512215),
                                    ("mm/ddat <time-of-day>", -6.328829242512215),
                                    ("tonightat <time-of-day>", -6.328829242512215),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.635682061952269),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.328829242512215),
                                    ("today<time-of-day> am|pm", -6.328829242512215),
                                    ("Februarythe <day-of-month> (ordinal)", -5.92336413440405),
                                    ("at <time-of-day><time> <part-of-day>", -6.328829242512215),
                                    ("<day-of-month> (ordinal)intersect", -5.635682061952269),
                                    ("mm/dd<time-of-day> am|pm", -6.328829242512215),
                                    ("hourhour", -4.249387700832378),
                                    ("Navaratriin|during <named-month>|year", -6.328829242512215),
                                    ("Wednesdaythis|last|next <cycle>", -6.328829242512215),
                                    ("Lentyear (latent)", -6.328829242512215),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.824751845735941),
                                    ("Boghiyear (latent)", -6.328829242512215),
                                    ("dayyear", -1.9039826106554048),
                                    ("Thursdayfrom|since|after <time>", -5.92336413440405),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.328829242512215),
                                    ("Thursdayat <time-of-day>", -5.635682061952269),
                                    ("Islamic New Yearyear (latent)", -5.92336413440405),
                                    ("Laylat al-Qadryear (latent)", -5.4125385106380595),
                                    ("Shrove Tuesdayyear (latent)", -6.328829242512215),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.635682061952269),
                                    ("<time-of-day> am|pmtomorrow", -5.635682061952269),
                                    ("Yom Kippuryear (latent)", -6.328829242512215),
                                    ("<day-of-month> (ordinal)Tuesday", -5.92336413440405),
                                    ("<part-of-day> of <time>year (latent)", -6.328829242512215),
                                    ("minutehour", -5.230216953844105),
                                    ("Kaanum Pongalyear (latent)", -5.92336413440405),
                                    ("Maha Saptamiyear (latent)", -6.328829242512215),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.92336413440405),
                                    ("time-of-day (latent)tomorrow", -5.4125385106380595),
                                    ("part of daysat <time-of-day>", -5.92336413440405),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.624081150273789),
                                    ("for <duration> from <time>December", -6.328829242512215),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.328829242512215),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.0760662740168465),
                                    ("time-of-day (latent)this <part-of-day>", -6.328829242512215),
                                    ("Pentecostyear (latent)", -6.328829242512215),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.0760662740168465),
                                    ("<day-of-month> (ordinal)February", -6.328829242512215),
                                    ("Eid al-Fitryear (latent)", -5.4125385106380595),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.328829242512215),
                                    ("Mondayin|during the <part-of-day>", -6.328829242512215),
                                    ("Chhathin|during <named-month>|year", -6.328829242512215),
                                    ("Diwaliin|during <named-month>|year", -6.328829242512215),
                                    ("Vaisakhiin|during <named-month>|year", -6.328829242512215),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.0760662740168465),
                                    ("Raksha Bandhanyear (latent)", -6.328829242512215),
                                    ("daysecond", -5.92336413440405),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.92336413440405),
                                    ("Ashurayear (latent)", -6.328829242512215),
                                    ("Tuesdayin|during <named-month>|year", -6.328829242512215),
                                    ("Chinese New Yearyear (latent)", -6.328829242512215),
                                    ("tomorrowintersect", -6.328829242512215),
                                    ("Lag BaOmeryear (latent)", -6.328829242512215),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.328829242512215),
                                    ("Eid al-Adhayear (latent)", -4.188763079015944),
                                    ("intersectin|during the <part-of-day>", -6.328829242512215),
                                    ("Palm Sundayyear (latent)", -6.328829242512215),
                                    ("Christmasat <time-of-day>", -6.328829242512215),
                                    ("Passoveryear (latent)", -6.328829242512215),
                                    ("Lazarus Saturdayyear (latent)", -6.328829242512215),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.92336413440405),
                                    ("Yom HaShoahyear (latent)", -5.92336413440405),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.92336413440405),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.328829242512215),
                                    ("Septemberyear (latent)", -5.92336413440405),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.824751845735941),
                                    ("Halloweenyear (latent)", -6.328829242512215),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.328829242512215),
                                    ("at <time-of-day>intersect", -5.92336413440405),
                                    ("Rosh Hashanahyear (latent)", -5.635682061952269),
                                    ("Dhanterasyear (latent)", -6.328829242512215),
                                    ("Tu BiShvatyear (latent)", -6.328829242512215),
                                    ("<day-of-month> (ordinal)December", -5.635682061952269),
                                    ("Holiyear (latent)", -5.635682061952269),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.328829242512215),
                                    ("Holika Dahanyear (latent)", -5.635682061952269),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.328829242512215),
                                    ("dayminute", -3.411058510427935),
                                    ("Mawlidyear (latent)", -6.328829242512215),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.92336413440405),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.328829242512215),
                                    ("Jumu'atul-Widayear (latent)", -5.4125385106380595),
                                    ("minuteday", -2.5001878460231195),
                                    ("absorption of , after named dayintersect",
                                     -6.328829242512215),
                                    ("intersectyear (latent)", -5.92336413440405),
                                    ("Orthodox Easter Sundayyear (latent)", -6.328829242512215),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.328829242512215),
                                    ("Boss's Dayyear (latent)", -5.92336413440405),
                                    ("Global Youth Service Dayyear (latent)", -6.328829242512215),
                                    ("Dhanterasin|during <named-month>|year", -6.328829242512215),
                                    ("Tisha B'Avyear (latent)", -6.328829242512215),
                                    ("Isra and Mi'rajyear (latent)", -5.4125385106380595),
                                    ("at <time-of-day>on <day>", -5.230216953844105),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.328829242512215),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.635682061952269),
                                    ("Christmasyear (latent)", -5.92336413440405),
                                    ("Naraka Chaturdashiyear (latent)", -5.92336413440405),
                                    ("Thai Pongalin|during <named-month>|year", -6.328829242512215),
                                    ("dayweek", -6.328829242512215),
                                    ("Easter Sundayyear (latent)", -5.635682061952269),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.719391330078114),
                                    ("weekyear", -5.230216953844105),
                                    ("King's Dayyear (latent)", -4.824751845735941),
                                    ("hh:mmin|during the <part-of-day>", -5.635682061952269),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.92336413440405),
                                    ("Hanukkahyear (latent)", -5.635682061952269),
                                    ("February<time> <part-of-day>", -6.328829242512215),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.328829242512215),
                                    ("Great Lentyear (latent)", -6.328829242512215),
                                    ("tomorrowat <time-of-day>", -5.635682061952269),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.328829242512215),
                                    ("Vaisakhiyear (latent)", -5.635682061952269),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.328829242512215),
                                    ("last <cycle> of <time>year (latent)", -5.635682061952269),
                                    ("at <time-of-day>tomorrow", -5.92336413440405),
                                    ("tomorrow<time-of-day> am|pm", -6.328829242512215),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.328829242512215),
                                    ("Diwaliyear (latent)", -6.328829242512215),
                                    ("between <time> and <time>on <day>", -4.719391330078114),
                                    ("Black Fridayyear (latent)", -5.92336413440405),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.328829242512215),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.328829242512215),
                                    ("Chhathyear (latent)", -5.92336413440405),
                                    ("Vasant Panchamiyear (latent)", -6.328829242512215),
                                    ("Rabindra Jayantiyear (latent)", -5.0760662740168465),
                                    ("St Patrick's Dayyear (latent)", -6.328829242512215),
                                    ("Thursday<time> (timezone)", -6.328829242512215),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.328829242512215),
                                    ("<datetime> - <datetime> (interval)July", -5.92336413440405),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.92336413440405),
                                    ("Februaryintersect", -6.328829242512215),
                                    ("Simchat Torahyear (latent)", -6.328829242512215),
                                    ("minuteyear", -6.328829242512215)],
                               n = 431},
                   koData =
                     ClassData{prior = -0.9750655482949762, unseen = -6.661854740545311,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.2593777681775307),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.967427969279741),
                                    ("<day-of-month> (ordinal)August", -5.967427969279741),
                                    ("dayhour", -3.293279319853212),
                                    ("<time> timezoneyear (latent)", -5.967427969279741),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.051137237405586),
                                    ("Tuesdayfrom|since|after <time>", -5.967427969279741),
                                    ("daymonth", -3.4825213194917404),
                                    ("monthyear", -4.714665000784373),
                                    ("<time-of-day> am|pmyear (latent)", -5.274280788719795),
                                    ("Thai Pongalyear (latent)", -5.274280788719795),
                                    ("intersecthh:mm", -5.967427969279741),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.561962861171576),
                                    ("<day-of-month> (ordinal)Wednesday", -5.967427969279741),
                                    ("houryear", -4.58113360815985),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.967427969279741),
                                    ("<day-of-month> (ordinal)October", -5.967427969279741),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.274280788719795),
                                    ("<time-of-day> am|pmintersect", -4.714665000784373),
                                    ("Octoberyear (latent)", -5.967427969279741),
                                    ("until <time>on <day>", -5.274280788719795),
                                    ("time-of-day (latent)intersect", -5.967427969279741),
                                    ("todayin <number> (implicit minutes)", -5.967427969279741),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.274280788719795),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.967427969279741),
                                    ("hh:mmon <day>", -3.525080933910536),
                                    ("absorption of , after named dayJuly", -5.561962861171576),
                                    ("from|since|after <time>July", -5.561962861171576),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.051137237405586),
                                    ("Clean Mondayyear (latent)", -5.967427969279741),
                                    ("monthhour", -5.967427969279741),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.561962861171576),
                                    ("hourmonth", -4.095625792378149),
                                    ("todayat <time-of-day>", -5.967427969279741),
                                    ("from|since|after <time>December", -5.967427969279741),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.967427969279741),
                                    ("<time-of-day> am|pmon <day>", -4.714665000784373),
                                    ("Mondayyear (latent)", -5.274280788719795),
                                    ("dayday", -4.58113360815985),
                                    ("mm/ddat <time-of-day>", -5.561962861171576),
                                    ("on <day>September", -5.561962861171576),
                                    ("time-of-day (latent)September", -5.561962861171576),
                                    ("hourhour", -5.967427969279741),
                                    ("time-of-day (latent)on <day>", -3.525080933910536),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.561962861171576),
                                    ("dayyear", -3.0229889901133),
                                    ("Thursdaymm/dd", -5.967427969279741),
                                    ("New Year's Dayyear (latent)", -5.051137237405586),
                                    ("Thursdayfrom|since|after <time>", -4.2626798770413155),
                                    ("Thursdayat <time-of-day>", -4.35799005684564),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.967427969279741),
                                    ("Aprilyear (latent)", -5.967427969279741),
                                    ("the <day-of-month> (ordinal)July", -5.967427969279741),
                                    ("the <day-of-month> (number)July", -5.967427969279741),
                                    ("monthminute", -5.967427969279741),
                                    ("<time-of-day> am|pmtomorrow", -5.967427969279741),
                                    ("Thursdayhh:mm", -5.051137237405586),
                                    ("<day-of-month> (ordinal)Tuesday", -5.561962861171576),
                                    ("minutemonth", -4.095625792378149),
                                    ("minutehour", -5.967427969279741),
                                    ("Augustyear (latent)", -5.561962861171576),
                                    ("week-endin|during <named-month>|year", -5.967427969279741),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.561962861171576),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.967427969279741),
                                    ("Sundayyear (latent)", -5.051137237405586),
                                    ("Christmasat <time-of-day>", -5.967427969279741),
                                    ("from|since|after <time>year (latent)", -4.868815680611631),
                                    ("<duration> after|before|from <time>December",
                                     -5.967427969279741),
                                    ("yesterday<time-of-day> am|pm", -5.967427969279741),
                                    ("<day-of-month> (ordinal)July", -5.274280788719795),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.967427969279741),
                                    ("mm/ddyear (latent)", -5.967427969279741),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.967427969279741),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.967427969279741),
                                    ("at <time-of-day>intersect", -5.561962861171576),
                                    ("hh:mmyear (latent)", -3.887986427599905),
                                    ("Holiyear (latent)", -5.967427969279741),
                                    ("until <time><time-of-day> am|pm", -5.967427969279741),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.967427969279741),
                                    ("dayminute", -3.364738283835357),
                                    ("yyyy-mm-ddhh:mm", -5.561962861171576),
                                    ("intersectSeptember", -4.463350572503466),
                                    ("minuteday", -2.7287495171153604),
                                    ("absorption of , after named dayintersect",
                                     -5.967427969279741),
                                    ("intersectyear (latent)", -5.967427969279741),
                                    ("Februaryin|during the <part-of-day>", -5.967427969279741),
                                    ("time-of-day (latent)July", -5.274280788719795),
                                    ("Saturdayyear (latent)", -5.967427969279741),
                                    ("at <time-of-day>on <day>", -5.561962861171576),
                                    ("absorption of , after named daySeptember",
                                     -5.051137237405586),
                                    ("Naraka Chaturdashiyear (latent)", -5.967427969279741),
                                    ("from|since|after <time>on <day>", -5.051137237405586),
                                    ("dayweek", -5.967427969279741),
                                    ("Easter Sundayyear (latent)", -5.561962861171576),
                                    ("Thursday<time-of-day> am|pm", -4.714665000784373),
                                    ("weekyear", -5.561962861171576),
                                    ("time-of-day (latent)Thursday", -5.561962861171576),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.967427969279741),
                                    ("<day-of-month> (ordinal)April", -5.967427969279741),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.561962861171576),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.274280788719795),
                                    ("Sundayfrom|since|after <time>", -5.967427969279741),
                                    ("absorption of , after named dayFebruary", -5.051137237405586),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.967427969279741),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.967427969279741),
                                    ("tomorrowat <time-of-day>", -5.967427969279741),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.561962861171576),
                                    ("last <cycle> of <time>year (latent)", -5.561962861171576),
                                    ("tomorrow<time-of-day> am|pm", -5.967427969279741),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.274280788719795),
                                    ("Diwaliyear (latent)", -5.561962861171576),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.967427969279741),
                                    ("Fridayyear (latent)", -5.561962861171576),
                                    ("time-of-day (latent)April", -5.967427969279741),
                                    ("minuteyear", -3.770203391943521)],
                               n = 261}}),
       ("one eleven",
        Classifier{okData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.62880082944807),
                                    ...
                                    ("integer (numeric)year (grain)", -3.0706335817271087),
                                    ("day", -2.3774864011671633), ("year", -2.495269436823547),
                                    ...
                                    ("hour", -2.7029088016017915), ("month", -2.9652730660692823),
                                    ("integer (numeric)minute (grain)", -3.188416617383492),
