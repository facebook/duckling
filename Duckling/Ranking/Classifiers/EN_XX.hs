...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4695123494520176, unseen = -7.186144304522325,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.492239835020471),
                                    ("Karva Chauthyear (latent)", -6.492239835020471),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.492239835020471),
                                    ("Maha Shivaratriyear (latent)", -6.492239835020471),
                                    ("Ramadanyear (latent)", -5.239476866525103),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.10594547390058),
                                    ("Bhai Doojyear (latent)", -6.492239835020471),
                                    ("hourday", -4.477336814478207),
                                    ("dayhour", -3.471814948876109),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.10594547390058),
                                    ("Martin Luther King's Dayyear (latent)", -6.0867747269123065),
                                    ("Shemini Atzeretyear (latent)", -6.492239835020471),
                                    ("daymonth", -4.3521736715242),
                                    ("monthday", -6.0867747269123065),
                                    ("monthyear", -4.62043765811888),
                                    ("Yom Ha'atzmautyear (latent)", -6.492239835020471),
                                    ("Orthodox Good Fridayyear (latent)", -6.0867747269123065),
                                    ("Vijayadashamiyear (latent)", -6.492239835020471),
                                    ("Thanksgiving Dayyear (latent)", -5.393627546352362),
                                    ("Thai Pongalyear (latent)", -5.799092654460526),
                                    ("Thiru Onamyear (latent)", -5.799092654460526),
                                    ("hhhmmabsorption of , after named day", -6.492239835020471),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.492239835020471),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.575949103146316),
                                    ("<day-of-month> (ordinal)Wednesday", -6.492239835020471),
                                    ("Krishna Janmashtamiyear (latent)", -6.0867747269123065),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.492239835020471),
                                    ("houryear", -5.575949103146316),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.492239835020471),
                                    ("Christmas<time-of-day> am|pm", -6.492239835020471),
                                    ("<day-of-month> (ordinal)October", -6.492239835020471),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.492239835020471),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.799092654460526),
                                    ("intersectin|during <named-month>|year", -6.492239835020471),
                                    ("<time-of-day> am|pmintersect", -5.239476866525103),
                                    ("Earth Houryear (latent)", -6.492239835020471),
                                    ("Ganesh Chaturthiyear (latent)", -6.492239835020471),
                                    ("Octoberyear (latent)", -4.882801922586371),
                                    ("intersect<time-of-day> am|pm", -6.492239835020471),
                                    ("Mattu Pongalyear (latent)", -6.492239835020471),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.492239835020471),
                                    ("Shavuotyear (latent)", -6.492239835020471),
                                    ("Parsi New Yearyear (latent)", -5.575949103146316),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.492239835020471),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.492239835020471),
                                    ("todayin|within|after <duration>", -6.492239835020471),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.0867747269123065),
                                    ("Marchyear (latent)", -6.492239835020471),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.0867747269123065),
                                    ("Sukkotyear (latent)", -6.0867747269123065),
                                    ("hhhmmintersect", -6.0867747269123065),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.799092654460526),
                                    ("todayat <time-of-day>", -6.492239835020471),
                                    ("Thursday<time> timezone", -4.0943445622221),
                                    ("tonight<time-of-day> am|pm", -6.492239835020471),
                                    ("time-of-day (latent)tonight", -6.0867747269123065),
                                    ("from|since|after <time>December", -6.492239835020471),
                                    ("<time-of-day> am|pmon <day>", -4.477336814478207),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.492239835020471),
                                    ("yyyy-mm-ddhh:mm:ss", -6.0867747269123065),
                                    ("dayday", -3.784189633918261),
                                    ("<time> <part-of-day>at <time-of-day>", -6.0867747269123065),
                                    ("mm/ddat <time-of-day>", -5.799092654460526),
                                    ("tonightat <time-of-day>", -5.393627546352362),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.799092654460526),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.492239835020471),
                                    ("today<time-of-day> am|pm", -6.492239835020471),
                                    ("Februarythe <day-of-month> (ordinal)", -6.0867747269123065),
                                    ("at <time-of-day><time> <part-of-day>", -6.492239835020471),
                                    ("<day-of-month> (ordinal)intersect", -5.799092654460526),
                                    ("mm/dd<time-of-day> am|pm", -6.492239835020471),
                                    ("hourhour", -3.52182536945077),
                                    ("Mahavir Jayantiyear (latent)", -6.0867747269123065),
                                    ("Navaratriin|during <named-month>|year", -6.492239835020471),
                                    ("Wednesdaythis|last|next <cycle>", -6.492239835020471),
                                    ("Lentyear (latent)", -6.492239835020471),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.62043765811888),
                                    ("Boghiyear (latent)", -6.492239835020471),
                                    ("dayyear", -1.9123874570166697),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.492239835020471),
                                    ("Thursdayfrom|since|after <time>", -6.0867747269123065),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.492239835020471),
                                    ("Thursdayat <time-of-day>", -5.799092654460526),
                                    ("Islamic New Yearyear (latent)", -6.0867747269123065),
                                    ("Laylat al-Qadryear (latent)", -5.575949103146316),
                                    ("part of days<time-of-day> am|pm", -6.492239835020471),
                                    ("Shrove Tuesdayyear (latent)", -6.492239835020471),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.799092654460526),
                                    ("hourminute", -6.0867747269123065),
                                    ("<time-of-day> am|pmtomorrow", -5.799092654460526),
                                    ("Yom Kippuryear (latent)", -6.492239835020471),
                                    ("<day-of-month> (ordinal)Tuesday", -6.0867747269123065),
                                    ("<part-of-day> of <time>year (latent)", -6.492239835020471),
                                    ("minutehour", -5.239476866525103),
                                    ("Kaanum Pongalyear (latent)", -6.0867747269123065),
                                    ("Maha Saptamiyear (latent)", -6.492239835020471),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.799092654460526),
                                    ("time-of-day (latent)tomorrow", -5.575949103146316),
                                    ("part of daysat <time-of-day>", -4.882801922586371),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.477336814478207),
                                    ("for <duration> from <time>December", -6.492239835020471),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.492239835020471),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.239476866525103),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.239476866525103),
                                    ("time-of-day (latent)this <part-of-day>", -6.492239835020471),
                                    ("Pentecostyear (latent)", -6.492239835020471),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.239476866525103),
                                    ("<day-of-month> (ordinal)February", -6.492239835020471),
                                    ("Eid al-Fitryear (latent)", -5.10594547390058),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.492239835020471),
                                    ("Mondayin|during the <part-of-day>", -6.492239835020471),
                                    ("Chhathin|during <named-month>|year", -6.492239835020471),
                                    ("Diwaliin|during <named-month>|year", -6.492239835020471),
                                    ("this <part-of-day><time-of-day> am|pm", -6.492239835020471),
                                    ("Vaisakhiin|during <named-month>|year", -6.492239835020471),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.239476866525103),
                                    ("Raksha Bandhanyear (latent)", -6.492239835020471),
                                    ("daysecond", -6.0867747269123065),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.0867747269123065),
                                    ("Ratha-Yatrayear (latent)", -6.492239835020471),
                                    ("Ashurayear (latent)", -6.492239835020471),
                                    ("Tuesdayin|during <named-month>|year", -6.492239835020471),
                                    ("Chinese New Yearyear (latent)", -6.492239835020471),
                                    ("tomorrowintersect", -6.492239835020471),
                                    ("Lag BaOmeryear (latent)", -6.492239835020471),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.492239835020471),
                                    ("Eid al-Adhayear (latent)", -4.3521736715242),
                                    ("intersectin|during the <part-of-day>", -6.492239835020471),
                                    ("Palm Sundayyear (latent)", -6.492239835020471),
                                    ("Christmasat <time-of-day>", -6.492239835020471),
                                    ("Passoveryear (latent)", -6.492239835020471),
                                    ("Lazarus Saturdayyear (latent)", -6.492239835020471),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.0867747269123065),
                                    ("hhhmmon <day>", -5.575949103146316),
                                    ("Yom HaShoahyear (latent)", -6.0867747269123065),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.0867747269123065),
                                    ("Septemberyear (latent)", -6.0867747269123065),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.988162438244197),
                                    ("Halloweenyear (latent)", -6.492239835020471),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.799092654460526),
                                    ("Dhanterasyear (latent)", -6.492239835020471),
                                    ("Tu BiShvatyear (latent)", -6.492239835020471),
                                    ("<day-of-month> (ordinal)December", -5.799092654460526),
                                    ("Holiyear (latent)", -5.799092654460526),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.492239835020471),
                                    ("Holika Dahanyear (latent)", -5.799092654460526),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0867747269123065),
                                    ("dayminute", -3.107849571674697),
                                    ("Mawlidyear (latent)", -6.492239835020471),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.0867747269123065),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.492239835020471),
                                    ("Jumu'atul-Widayear (latent)", -5.575949103146316),
                                    ("minuteday", -2.754570216737103),
                                    ("absorption of , after named dayintersect",
                                     -5.799092654460526),
                                    ("intersectyear (latent)", -6.0867747269123065),
                                    ("Orthodox Easter Sundayyear (latent)", -6.492239835020471),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.492239835020471),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.492239835020471),
                                    ("intersecthhhmm", -6.0867747269123065),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.492239835020471),
                                    ("Boss's Dayyear (latent)", -6.0867747269123065),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.492239835020471),
                                    ("Global Youth Service Dayyear (latent)", -6.492239835020471),
                                    ("Dhanterasin|during <named-month>|year", -6.492239835020471),
                                    ("tonight<time-of-day> o'clock", -6.492239835020471),
                                    ("Tisha B'Avyear (latent)", -6.492239835020471),
                                    ("Isra and Mi'rajyear (latent)", -5.575949103146316),
                                    ("at <time-of-day>on <day>", -4.882801922586371),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.0867747269123065),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.799092654460526),
                                    ("Christmasyear (latent)", -6.0867747269123065),
                                    ("Saturdayintersect", -6.492239835020471),
                                    ("Naraka Chaturdashiyear (latent)", -6.0867747269123065),
                                    ("Thai Pongalin|during <named-month>|year", -6.492239835020471),
                                    ("dayweek", -6.492239835020471),
                                    ("Easter Sundayyear (latent)", -5.799092654460526),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.0867747269123065),
                                    ("weekyear", -5.393627546352362),
                                    ("King's Dayyear (latent)", -4.988162438244197),
                                    ("hh:mmin|during the <part-of-day>", -5.575949103146316),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.0867747269123065),
                                    ("Hanukkahyear (latent)", -5.799092654460526),
                                    ("Rama Navamiyear (latent)", -6.492239835020471),
                                    ("February<time> <part-of-day>", -6.492239835020471),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.799092654460526),
                                    ("Great Lentyear (latent)", -6.492239835020471),
                                    ("tomorrowat <time-of-day>", -5.799092654460526),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.492239835020471),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.0867747269123065),
                                    ("Ugadiyear (latent)", -5.10594547390058),
                                    ("Vaisakhiyear (latent)", -5.799092654460526),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.799092654460526),
                                    ("last <cycle> of <time>year (latent)", -5.799092654460526),
                                    ("at <time-of-day>tomorrow", -6.0867747269123065),
                                    ("tomorrow<time-of-day> am|pm", -6.492239835020471),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.492239835020471),
                                    ("Diwaliyear (latent)", -6.492239835020471),
                                    ("between <time> and <time>on <day>", -6.0867747269123065),
                                    ("Black Fridayyear (latent)", -6.0867747269123065),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.492239835020471),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.492239835020471),
                                    ("Chhathyear (latent)", -6.0867747269123065),
                                    ("Vasant Panchamiyear (latent)", -6.492239835020471),
                                    ("Rabindra Jayantiyear (latent)", -5.239476866525103),
                                    ("this <part-of-day>at <time-of-day>", -5.239476866525103),
                                    ("St Patrick's Dayyear (latent)", -6.492239835020471),
                                    ("Thursday<time> (timezone)", -6.492239835020471),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.492239835020471),
                                    ("Pargat Diwasyear (latent)", -5.239476866525103),
                                    ("<datetime> - <datetime> (interval)July", -6.0867747269123065),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.799092654460526),
                                    ("Februaryintersect", -6.492239835020471),
                                    ("Simchat Torahyear (latent)", -6.492239835020471),
                                    ("minuteyear", -6.492239835020471)],
                               n = 509},
                   koData =
                     ClassData{prior = -0.9816485893951287, unseen = -6.816735880594968,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.618415412738112),
                                    ("hourday", -3.724597536716016),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.1224928095143865),
                                    ("<day-of-month> (ordinal)August", -6.1224928095143865),
                                    ("dayhour", -3.381652785589185),
                                    ("<time> timezoneyear (latent)", -5.429345628954441),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.206202077640231),
                                    ("Tuesdayfrom|since|after <time>", -5.429345628954441),
                                    ("daymonth", -3.4483441600878573),
                                    ("monthyear", -4.869729841019018),
                                    ("<time-of-day> am|pmyear (latent)", -5.429345628954441),
                                    ("Thai Pongalyear (latent)", -5.429345628954441),
                                    ("intersecthh:mm", -6.1224928095143865),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.717027701406222),
                                    ("<day-of-month> (ordinal)Wednesday", -6.1224928095143865),
                                    ("houryear", -4.736198448394496),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.1224928095143865),
                                    ("<day-of-month> (ordinal)October", -6.1224928095143865),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.429345628954441),
                                    ("hournograin", -4.869729841019018),
                                    ("<time-of-day> am|pmintersect", -4.869729841019018),
                                    ("Octoberyear (latent)", -6.1224928095143865),
                                    ("Good Fridayyear (latent)", -5.717027701406222),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.717027701406222),
                                    ("early morningat <time-of-day>", -6.1224928095143865),
                                    ("until <time>on <day>", -5.429345628954441),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.1224928095143865),
                                    ("time-of-day (latent)intersect", -5.429345628954441),
                                    ("todayin <number> (implicit minutes)", -6.1224928095143865),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.429345628954441),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.1224928095143865),
                                    ("hh:mmon <day>", -4.869729841019018),
                                    ("hhhmmintersect", -5.717027701406222),
                                    ("absorption of , after named dayJuly", -5.206202077640231),
                                    ("from|since|after <time>July", -5.717027701406222),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.206202077640231),
                                    ("Clean Mondayyear (latent)", -6.1224928095143865),
                                    ("monthhour", -6.1224928095143865),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.717027701406222),
                                    ("hourmonth", -4.250690632612795),
                                    ("todayat <time-of-day>", -6.1224928095143865),
                                    ("hhhmmyear (latent)", -4.869729841019018),
                                    ("from|since|after <time>December", -6.1224928095143865),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.1224928095143865),
                                    ("<time-of-day> am|pmon <day>", -4.869729841019018),
                                    ("Mondayyear (latent)", -5.429345628954441),
                                    ("dayday", -4.107589788972121),
                                    ("mm/ddat <time-of-day>", -5.206202077640231),
                                    ("on <day>September", -5.429345628954441),
                                    ("time-of-day (latent)September", -5.717027701406222),
                                    ("hourhour", -4.04305126783455),
                                    ("time-of-day (latent)on <day>", -4.618415412738112),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.717027701406222),
                                    ("dayyear", -3.077970371790963),
                                    ("Thursdaymm/dd", -6.1224928095143865),
                                    ("New Year's Dayyear (latent)", -5.206202077640231),
                                    ("time-of-day (latent)Sunday", -5.717027701406222),
                                    ("Thursdayfrom|since|after <time>", -4.417744717275961),
                                    ("Thursdayat <time-of-day>", -4.513054897080286),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.1224928095143865),
                                    ("Aprilyear (latent)", -6.1224928095143865),
                                    ("the <day-of-month> (ordinal)July", -6.1224928095143865),
                                    ("the <day-of-month> (number)July", -6.1224928095143865),
                                    ("monthminute", -6.1224928095143865),
                                    ("<time-of-day> am|pmtomorrow", -6.1224928095143865),
                                    ("Thursdayhh:mm", -5.206202077640231),
                                    ("<day-of-month> (ordinal)Tuesday", -5.717027701406222),
                                    ("minutemonth", -3.9824266460181152),
                                    ("time-of-day (latent)Friday", -5.717027701406222),
                                    ("minutehour", -6.1224928095143865),
                                    ("part of daysat <time-of-day>", -5.0238805208462765),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -5.206202077640231),
                                    ("Augustyear (latent)", -5.717027701406222),
                                    ("week-endin|during <named-month>|year", -6.1224928095143865),
                                    ("time-of-day (latent)Tuesday", -5.717027701406222),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.1224928095143865),
                                    ("Sundayyear (latent)", -5.206202077640231),
                                    ("hourweek", -5.206202077640231),
                                    ("the <day-of-month> (ordinal)Monday", -5.429345628954441),
                                    ("Christmasat <time-of-day>", -6.1224928095143865),
                                    ("from|since|after <time>year (latent)", -5.0238805208462765),
                                    ("hhhmmon <day>", -5.206202077640231),
                                    ("yesterday<time-of-day> am|pm", -6.1224928095143865),
                                    ("<day-of-month> (ordinal)July", -5.429345628954441),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.1224928095143865),
                                    ("mm/ddyear (latent)", -6.1224928095143865),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.1224928095143865),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.1224928095143865),
                                    ("at <time-of-day>intersect", -5.206202077640231),
                                    ("hh:mmyear (latent)", -4.736198448394496),
                                    ("Holiyear (latent)", -6.1224928095143865),
                                    ("until <time><time-of-day> am|pm", -6.1224928095143865),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.717027701406222),
                                    ("dayminute", -3.2602919285849175),
                                    ("yyyy-mm-ddhh:mm", -5.717027701406222),
                                    ("intersectfrom|since|after <time>", -5.717027701406222),
                                    ("intersectSeptember", -4.250690632612795),
                                    ("minuteday", -2.965492388364273),
                                    ("absorption of , after named dayintersect",
                                     -6.1224928095143865),
                                    ("intersectyear (latent)", -6.1224928095143865),
                                    ("Februaryin|during the <part-of-day>", -6.1224928095143865),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.1224928095143865),
                                    ("time-of-day (latent)July", -5.429345628954441),
                                    ("Saturdayyear (latent)", -6.1224928095143865),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.1224928095143865),
                                    ("<day-of-month> (ordinal)Monday", -5.206202077640231),
                                    ("at <time-of-day>on <day>", -5.206202077640231),
                                    ("absorption of , after named daySeptember",
                                     -4.869729841019018),
                                    ("Naraka Chaturdashiyear (latent)", -6.1224928095143865),
                                    ("from|since|after <time>on <day>", -5.206202077640231),
                                    ("dayweek", -6.1224928095143865),
                                    ("Easter Sundayyear (latent)", -5.717027701406222),
                                    ("Thursday<time-of-day> am|pm", -4.869729841019018),
                                    ("weekyear", -5.717027701406222),
                                    ("time-of-day (latent)Thursday", -5.717027701406222),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.1224928095143865),
                                    ("<day-of-month> (ordinal)April", -6.1224928095143865),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.717027701406222),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.429345628954441),
                                    ("Sundayfrom|since|after <time>", -6.1224928095143865),
                                    ("absorption of , after named dayFebruary", -5.206202077640231),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.717027701406222),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.1224928095143865),
                                    ("tomorrowat <time-of-day>", -6.1224928095143865),
                                    ("daynograin", -5.717027701406222),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.717027701406222),
                                    ("last <cycle> of <time>year (latent)", -5.717027701406222),
                                    ("tomorrow<time-of-day> am|pm", -6.1224928095143865),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.429345628954441),
                                    ("Diwaliyear (latent)", -5.717027701406222),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.1224928095143865),
                                    ("this <part-of-day>at <time-of-day>", -5.206202077640231),
                                    ("Fridayyear (latent)", -5.206202077640231),
                                    ("time-of-day (latent)April", -6.1224928095143865),
                                    ("minuteyear", -3.925268232178167)],
                               n = 305}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("week (grain)",
        Classifier{okData =
                     ClassData{prior = -0.1431008436406733, unseen = -4.382026634673881,
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.2992428948528569, unseen = -5.220355825078324,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.2259517110447111),
                                    ("month (grain)", -2.5068855565067754),
                                    ("year (grain)", -2.4423470353692043),
                                    ("week (grain)", -1.2259517110447111),
                                    ("quarter", -3.6054978451748854), ("year", -2.4423470353692043),
                                    ("month", -2.5068855565067754),
                                    ("quarter (grain)", -3.6054978451748854)],
                               n = 86},
                   koData =
                     ClassData{prior = -1.3523928094442093, unseen = -4.290459441148391,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.4434527749598391),
                                    ("month (grain)", -2.667228206581955),
                                    ("second", -2.667228206581955),
                                    ("week (grain)", -1.4434527749598391),
                                    ("day", -2.330755969960742),
                                    ("second (grain) ", -2.667228206581955),
                                    ("month", -2.667228206581955),
                                    ("day (grain)", -2.330755969960742)],
                               n = 30}}),
       ("Simchat Torah",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.0986122886681098,
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6443570163905132, unseen = -4.859812404361672,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 126},
                   koData =
                     ClassData{prior = -0.7444404749474959, unseen = -4.762173934797756,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -9.015109699429745e-2),
                                    ("integer (0..19)", -2.451005098112319)],
                               n = 114}}),
       ("beginning of year",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.791759469228055,
