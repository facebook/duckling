...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6692528603605091,
                               unseen = -5.8916442118257715,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 360},
                   koData =
                     ClassData{prior = -0.717626444644725, unseen = -5.84354441703136,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.50574947073413, unseen = -6.949856455000773,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.255750041753367),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.255750041753367),
                                    ("Ramadanyear (latent)", -5.339459309879212),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.240847021211102),
                                    ("Bhai Doojyear (latent)", -6.255750041753367),
                                    ("hourday", -4.240847021211102),
                                    ("dayhour", -3.337979309669088),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.240847021211102),
                                    ("Martin Luther King's Dayyear (latent)", -5.850284933645202),
                                    ("Shemini Atzeretyear (latent)", -6.255750041753367),
                                    ("daymonth", -4.115683878257096),
                                    ("monthday", -5.850284933645202),
                                    ("monthyear", -4.383947864851775),
                                    ("Yom Ha'atzmautyear (latent)", -6.255750041753367),
                                    ("Vijayadashamiyear (latent)", -6.255750041753367),
                                    ("Thanksgiving Dayyear (latent)", -5.157137753085257),
                                    ("Thai Pongalyear (latent)", -5.5626028611934215),
                                    ("Thiru Onamyear (latent)", -5.5626028611934215),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.255750041753367),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.339459309879212),
                                    ("<day-of-month> (ordinal)Wednesday", -6.255750041753367),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.255750041753367),
                                    ("houryear", -5.339459309879212),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.255750041753367),
                                    ("Christmas<time-of-day> am|pm", -6.255750041753367),
                                    ("<day-of-month> (ordinal)October", -6.255750041753367),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.255750041753367),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.5626028611934215),
                                    ("intersectin|during <named-month>|year", -6.255750041753367),
                                    ("<time-of-day> am|pmintersect", -5.002987073257999),
                                    ("Earth Houryear (latent)", -6.255750041753367),
                                    ("Octoberyear (latent)", -4.646312129319266),
                                    ("intersect<time-of-day> am|pm", -6.255750041753367),
                                    ("Mattu Pongalyear (latent)", -6.255750041753367),
                                    ("Shavuotyear (latent)", -6.255750041753367),
                                    ("Parsi New Yearyear (latent)", -5.339459309879212),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.255750041753367),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.255750041753367),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.850284933645202),
                                    ("Marchyear (latent)", -6.255750041753367),
                                    ("Sukkotyear (latent)", -5.850284933645202),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.850284933645202),
                                    ("Clean Mondayyear (latent)", -5.850284933645202),
                                    ("monthhour", -5.850284933645202),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.5626028611934215),
                                    ("todayat <time-of-day>", -6.255750041753367),
                                    ("Thursday<time> timezone", -4.3098398926980535),
                                    ("time-of-day (latent)tonight", -5.850284933645202),
                                    ("from|since|after <time>December", -6.255750041753367),
                                    ("<time-of-day> am|pmon <day>", -4.240847021211102),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.255750041753367),
                                    ("yyyy-mm-ddhh:mm:ss", -5.850284933645202),
                                    ("dayday", -3.8134030063841626),
                                    ("<time> <part-of-day>at <time-of-day>", -6.255750041753367),
                                    ("mm/ddat <time-of-day>", -6.255750041753367),
                                    ("tonightat <time-of-day>", -6.255750041753367),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.5626028611934215),
                                    ("today<time-of-day> am|pm", -6.255750041753367),
                                    ("Februarythe <day-of-month> (ordinal)", -5.850284933645202),
                                    ("at <time-of-day><time> <part-of-day>", -6.255750041753367),
                                    ("<day-of-month> (ordinal)intersect", -5.5626028611934215),
                                    ("mm/dd<time-of-day> am|pm", -6.255750041753367),
                                    ("hourhour", -4.176308500073531),
                                    ("Navaratriin|during <named-month>|year", -6.255750041753367),
                                    ("Wednesdaythis|last|next <cycle>", -6.255750041753367),
                                    ("Lentyear (latent)", -6.255750041753367),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.751672644977093),
                                    ("Boghiyear (latent)", -6.255750041753367),
                                    ("dayyear", -2.0660952997269413),
                                    ("Thursdayfrom|since|after <time>", -5.850284933645202),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.255750041753367),
                                    ("Thursdayat <time-of-day>", -5.5626028611934215),
                                    ("Islamic New Yearyear (latent)", -5.850284933645202),
                                    ("Laylat al-Qadryear (latent)", -5.339459309879212),
                                    ("Shrove Tuesdayyear (latent)", -6.255750041753367),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.5626028611934215),
                                    ("<time-of-day> am|pmtomorrow", -5.5626028611934215),
                                    ("Yom Kippuryear (latent)", -6.255750041753367),
                                    ("<day-of-month> (ordinal)Tuesday", -5.850284933645202),
                                    ("<part-of-day> of <time>year (latent)", -6.255750041753367),
                                    ("minutehour", -5.157137753085257),
                                    ("Kaanum Pongalyear (latent)", -5.850284933645202),
                                    ("Maha Saptamiyear (latent)", -6.255750041753367),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.850284933645202),
                                    ("time-of-day (latent)tomorrow", -5.339459309879212),
                                    ("part of daysat <time-of-day>", -5.850284933645202),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.551001949514942),
                                    ("for <duration> from <time>December", -6.255750041753367),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.255750041753367),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.002987073257999),
                                    ("time-of-day (latent)this <part-of-day>", -6.255750041753367),
                                    ("Pentecostyear (latent)", -6.255750041753367),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.002987073257999),
                                    ("<day-of-month> (ordinal)February", -6.255750041753367),
                                    ("Eid al-Fitryear (latent)", -5.339459309879212),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.255750041753367),
                                    ("Mondayin|during the <part-of-day>", -6.255750041753367),
                                    ("Chhathin|during <named-month>|year", -6.255750041753367),
                                    ("Diwaliin|during <named-month>|year", -6.255750041753367),
                                    ("Vaisakhiin|during <named-month>|year", -6.255750041753367),
                                    ("Raksha Bandhanyear (latent)", -6.255750041753367),
                                    ("daysecond", -5.850284933645202),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.850284933645202),
                                    ("Ashurayear (latent)", -6.255750041753367),
                                    ("Tuesdayin|during <named-month>|year", -6.255750041753367),
                                    ("Chinese New Yearyear (latent)", -6.255750041753367),
                                    ("tomorrowintersect", -6.255750041753367),
                                    ("Lag BaOmeryear (latent)", -6.255750041753367),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.255750041753367),
                                    ("Eid al-Adhayear (latent)", -5.339459309879212),
                                    ("intersectin|during the <part-of-day>", -6.255750041753367),
                                    ("Palm Sundayyear (latent)", -6.255750041753367),
                                    ("Christmasat <time-of-day>", -6.255750041753367),
                                    ("Passoveryear (latent)", -6.255750041753367),
                                    ("Lazarus Saturdayyear (latent)", -6.255750041753367),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.850284933645202),
                                    ("Yom HaShoahyear (latent)", -5.850284933645202),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.850284933645202),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.255750041753367),
                                    ("Septemberyear (latent)", -5.850284933645202),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.751672644977093),
                                    ("Halloweenyear (latent)", -6.255750041753367),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.255750041753367),
                                    ("at <time-of-day>intersect", -5.850284933645202),
                                    ("Rosh Hashanahyear (latent)", -5.5626028611934215),
                                    ("Dhanterasyear (latent)", -6.255750041753367),
                                    ("Tu BiShvatyear (latent)", -6.255750041753367),
                                    ("<day-of-month> (ordinal)December", -5.5626028611934215),
                                    ("Holiyear (latent)", -5.5626028611934215),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.255750041753367),
                                    ("Holika Dahanyear (latent)", -5.5626028611934215),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.255750041753367),
                                    ("dayminute", -3.337979309669088),
                                    ("Mawlidyear (latent)", -6.255750041753367),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.850284933645202),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.255750041753367),
                                    ("Jumu'atul-Widayear (latent)", -5.339459309879212),
                                    ("minuteday", -2.427108645264272),
                                    ("absorption of , after named dayintersect",
                                     -6.255750041753367),
                                    ("intersectyear (latent)", -5.850284933645202),
                                    ("Orthodox Easter Sundayyear (latent)", -6.255750041753367),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.255750041753367),
                                    ("Boss's Dayyear (latent)", -5.850284933645202),
                                    ("Global Youth Service Dayyear (latent)", -6.255750041753367),
                                    ("Dhanterasin|during <named-month>|year", -6.255750041753367),
                                    ("Tisha B'Avyear (latent)", -6.255750041753367),
                                    ("Isra and Mi'rajyear (latent)", -5.339459309879212),
                                    ("at <time-of-day>on <day>", -5.157137753085257),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.255750041753367),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.5626028611934215),
                                    ("Christmasyear (latent)", -5.850284933645202),
                                    ("Naraka Chaturdashiyear (latent)", -5.850284933645202),
                                    ("Thai Pongalin|during <named-month>|year", -6.255750041753367),
                                    ("dayweek", -6.255750041753367),
                                    ("Easter Sundayyear (latent)", -5.5626028611934215),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.646312129319266),
                                    ("weekyear", -5.157137753085257),
                                    ("hh:mmin|during the <part-of-day>", -5.5626028611934215),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.850284933645202),
                                    ("Hanukkahyear (latent)", -5.5626028611934215),
                                    ("February<time> <part-of-day>", -6.255750041753367),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.255750041753367),
                                    ("Great Lentyear (latent)", -6.255750041753367),
                                    ("tomorrowat <time-of-day>", -5.5626028611934215),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.255750041753367),
                                    ("Vaisakhiyear (latent)", -5.5626028611934215),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.255750041753367),
                                    ("last <cycle> of <time>year (latent)", -5.5626028611934215),
                                    ("at <time-of-day>tomorrow", -5.850284933645202),
                                    ("tomorrow<time-of-day> am|pm", -6.255750041753367),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.255750041753367),
                                    ("Diwaliyear (latent)", -6.255750041753367),
                                    ("between <time> and <time>on <day>", -4.646312129319266),
                                    ("Black Fridayyear (latent)", -5.850284933645202),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.255750041753367),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.255750041753367),
                                    ("Chhathyear (latent)", -5.850284933645202),
                                    ("Vasant Panchamiyear (latent)", -6.255750041753367),
                                    ("St Patrick's Dayyear (latent)", -6.255750041753367),
                                    ("Thursday<time> (timezone)", -6.255750041753367),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.255750041753367),
                                    ("<datetime> - <datetime> (interval)July", -5.850284933645202),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.850284933645202),
                                    ("Februaryintersect", -6.255750041753367),
                                    ("Simchat Torahyear (latent)", -6.255750041753367),
                                    ("minuteyear", -6.255750041753367)],
                               n = 395},
                   koData =
                     ClassData{prior = -0.9239536046197242,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.247787168362621),
                                    ...
                                    ("from|since|after <time>July", -5.550372261356666),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.039546637590676),
                                    ...
                                    ("the <day-of-month> (ordinal)July", -5.955837369464831),
                                    ("the <day-of-month> (number)July", -5.955837369464831),
                                    ...
                                    ("<day-of-month> (ordinal)July", -5.262690188904886),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.955837369464831),
                                    ("mm/ddyear (latent)", -5.955837369464831),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.955837369464831),
                                    ...
                                    ("time-of-day (latent)July", -5.262690188904886),
