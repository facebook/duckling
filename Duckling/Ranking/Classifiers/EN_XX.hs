...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5936431970148319,
                               unseen = -6.1224928095143865,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 454},
                   koData =
                     ClassData{prior = -0.803657456887249, unseen = -5.91350300563827,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4563407787686177,
                               unseen = -7.1252830915107115,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.431331081933479),
                                    ("Karva Chauthyear (latent)", -6.431331081933479),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.431331081933479),
                                    ("Maha Shivaratriyear (latent)", -6.431331081933479),
                                    ("Ramadanyear (latent)", -5.178568113438111),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.045036720813588),
                                    ("Bhai Doojyear (latent)", -6.431331081933479),
                                    ("hourday", -4.416428061391214),
                                    ("dayhour", -3.486892102767038),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.045036720813588),
                                    ("Martin Luther King's Dayyear (latent)", -6.025865973825314),
                                    ("Shemini Atzeretyear (latent)", -6.431331081933479),
                                    ("daymonth", -4.291264918437208),
                                    ("monthday", -6.025865973825314),
                                    ("monthyear", -4.559528905031887),
                                    ("Yom Ha'atzmautyear (latent)", -6.431331081933479),
                                    ("Vijayadashamiyear (latent)", -6.431331081933479),
                                    ("Thanksgiving Dayyear (latent)", -5.332718793265369),
                                    ("Thai Pongalyear (latent)", -5.738183901373533),
                                    ("Thiru Onamyear (latent)", -5.738183901373533),
                                    ("hhhmmabsorption of , after named day", -6.431331081933479),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.431331081933479),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.515040350059324),
                                    ("<day-of-month> (ordinal)Wednesday", -6.431331081933479),
                                    ("Krishna Janmashtamiyear (latent)", -6.025865973825314),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.431331081933479),
                                    ("houryear", -5.515040350059324),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.431331081933479),
                                    ("Christmas<time-of-day> am|pm", -6.431331081933479),
                                    ("<day-of-month> (ordinal)October", -6.431331081933479),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.431331081933479),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.738183901373533),
                                    ("intersectin|during <named-month>|year", -6.431331081933479),
                                    ("<time-of-day> am|pmintersect", -5.178568113438111),
                                    ("Earth Houryear (latent)", -6.431331081933479),
                                    ("Ganesh Chaturthiyear (latent)", -6.431331081933479),
                                    ("Octoberyear (latent)", -4.821893169499378),
                                    ("intersect<time-of-day> am|pm", -6.431331081933479),
                                    ("Mattu Pongalyear (latent)", -6.431331081933479),
                                    ("Shavuotyear (latent)", -6.431331081933479),
                                    ("Parsi New Yearyear (latent)", -5.515040350059324),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.431331081933479),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.431331081933479),
                                    ("todayin|within|after <duration>", -6.431331081933479),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.025865973825314),
                                    ("Marchyear (latent)", -6.431331081933479),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.025865973825314),
                                    ("Sukkotyear (latent)", -6.025865973825314),
                                    ("hhhmmintersect", -6.025865973825314),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.025865973825314),
                                    ("Clean Mondayyear (latent)", -6.025865973825314),
                                    ("monthhour", -6.025865973825314),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.738183901373533),
                                    ("todayat <time-of-day>", -6.431331081933479),
                                    ("Thursday<time> timezone", -4.033435809135108),
                                    ("time-of-day (latent)tonight", -6.025865973825314),
                                    ("from|since|after <time>December", -6.431331081933479),
                                    ("<time-of-day> am|pmon <day>", -4.416428061391214),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.431331081933479),
                                    ("yyyy-mm-ddhh:mm:ss", -6.025865973825314),
                                    ("dayday", -3.7232808808312687),
                                    ("<time> <part-of-day>at <time-of-day>", -6.431331081933479),
                                    ("mm/ddat <time-of-day>", -5.738183901373533),
                                    ("tonightat <time-of-day>", -6.431331081933479),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.738183901373533),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.431331081933479),
                                    ("today<time-of-day> am|pm", -6.431331081933479),
                                    ("Februarythe <day-of-month> (ordinal)", -6.025865973825314),
                                    ("at <time-of-day><time> <part-of-day>", -6.431331081933479),
                                    ("<day-of-month> (ordinal)intersect", -5.738183901373533),
                                    ("mm/dd<time-of-day> am|pm", -6.431331081933479),
                                    ("hourhour", -4.351889540253643),
                                    ("Mahavir Jayantiyear (latent)", -6.025865973825314),
                                    ("Navaratriin|during <named-month>|year", -6.431331081933479),
                                    ("Wednesdaythis|last|next <cycle>", -6.431331081933479),
                                    ("Lentyear (latent)", -6.431331081933479),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.559528905031887),
                                    ("Boghiyear (latent)", -6.431331081933479),
                                    ("dayyear", -1.8617880735885386),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.431331081933479),
                                    ("Thursdayfrom|since|after <time>", -6.025865973825314),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.431331081933479),
                                    ("Thursdayat <time-of-day>", -5.738183901373533),
                                    ("Islamic New Yearyear (latent)", -6.025865973825314),
                                    ("Laylat al-Qadryear (latent)", -5.515040350059324),
                                    ("Shrove Tuesdayyear (latent)", -6.431331081933479),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.738183901373533),
                                    ("<time-of-day> am|pmtomorrow", -5.738183901373533),
                                    ("Yom Kippuryear (latent)", -6.431331081933479),
                                    ("<day-of-month> (ordinal)Tuesday", -6.025865973825314),
                                    ("<part-of-day> of <time>year (latent)", -6.431331081933479),
                                    ("minutehour", -5.178568113438111),
                                    ("Kaanum Pongalyear (latent)", -6.025865973825314),
                                    ("Maha Saptamiyear (latent)", -6.431331081933479),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.025865973825314),
                                    ("time-of-day (latent)tomorrow", -5.515040350059324),
                                    ("part of daysat <time-of-day>", -6.025865973825314),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.416428061391214),
                                    ("for <duration> from <time>December", -6.431331081933479),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.431331081933479),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.178568113438111),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.178568113438111),
                                    ("time-of-day (latent)this <part-of-day>", -6.431331081933479),
                                    ("Pentecostyear (latent)", -6.431331081933479),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.178568113438111),
                                    ("<day-of-month> (ordinal)February", -6.431331081933479),
                                    ("Eid al-Fitryear (latent)", -5.045036720813588),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.431331081933479),
                                    ("Mondayin|during the <part-of-day>", -6.431331081933479),
                                    ("Chhathin|during <named-month>|year", -6.431331081933479),
                                    ("Diwaliin|during <named-month>|year", -6.431331081933479),
                                    ("Vaisakhiin|during <named-month>|year", -6.431331081933479),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.178568113438111),
                                    ("Raksha Bandhanyear (latent)", -6.431331081933479),
                                    ("daysecond", -6.025865973825314),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.025865973825314),
                                    ("Ratha-Yatrayear (latent)", -6.431331081933479),
                                    ("Ashurayear (latent)", -6.431331081933479),
                                    ("Tuesdayin|during <named-month>|year", -6.431331081933479),
                                    ("Chinese New Yearyear (latent)", -6.431331081933479),
                                    ("tomorrowintersect", -6.431331081933479),
                                    ("Lag BaOmeryear (latent)", -6.431331081933479),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.431331081933479),
                                    ("Eid al-Adhayear (latent)", -4.291264918437208),
                                    ("intersectin|during the <part-of-day>", -6.431331081933479),
                                    ("Palm Sundayyear (latent)", -6.431331081933479),
                                    ("Christmasat <time-of-day>", -6.431331081933479),
                                    ("Passoveryear (latent)", -6.431331081933479),
                                    ("Lazarus Saturdayyear (latent)", -6.431331081933479),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.025865973825314),
                                    ("hhhmmon <day>", -5.515040350059324),
                                    ("Yom HaShoahyear (latent)", -6.025865973825314),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.025865973825314),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.431331081933479),
                                    ("Septemberyear (latent)", -6.025865973825314),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.927253685157205),
                                    ("Halloweenyear (latent)", -6.431331081933479),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.431331081933479),
                                    ("at <time-of-day>intersect", -5.515040350059324),
                                    ("Rosh Hashanahyear (latent)", -5.738183901373533),
                                    ("Dhanterasyear (latent)", -6.431331081933479),
                                    ("Tu BiShvatyear (latent)", -6.431331081933479),
                                    ("<day-of-month> (ordinal)December", -5.738183901373533),
                                    ("Holiyear (latent)", -5.738183901373533),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.431331081933479),
                                    ("Holika Dahanyear (latent)", -5.738183901373533),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.025865973825314),
                                    ("dayminute", -3.0469408185877045),
                                    ("Mawlidyear (latent)", -6.431331081933479),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.025865973825314),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.431331081933479),
                                    ("Jumu'atul-Widayear (latent)", -5.515040350059324),
                                    ("minuteday", -2.6936614636501104),
                                    ("absorption of , after named dayintersect",
                                     -5.738183901373533),
                                    ("intersectyear (latent)", -6.025865973825314),
                                    ("Orthodox Easter Sundayyear (latent)", -6.431331081933479),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.431331081933479),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.431331081933479),
                                    ("intersecthhhmm", -6.025865973825314),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.431331081933479),
                                    ("Boss's Dayyear (latent)", -6.025865973825314),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.431331081933479),
                                    ("Global Youth Service Dayyear (latent)", -6.431331081933479),
                                    ("Dhanterasin|during <named-month>|year", -6.431331081933479),
                                    ("Tisha B'Avyear (latent)", -6.431331081933479),
                                    ("Isra and Mi'rajyear (latent)", -5.515040350059324),
                                    ("at <time-of-day>on <day>", -4.821893169499378),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.025865973825314),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.738183901373533),
                                    ("Christmasyear (latent)", -6.025865973825314),
                                    ("Naraka Chaturdashiyear (latent)", -6.025865973825314),
                                    ("Thai Pongalin|during <named-month>|year", -6.431331081933479),
                                    ("dayweek", -6.431331081933479),
                                    ("Easter Sundayyear (latent)", -5.738183901373533),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.025865973825314),
                                    ("weekyear", -5.332718793265369),
                                    ("King's Dayyear (latent)", -4.927253685157205),
                                    ("hh:mmin|during the <part-of-day>", -5.515040350059324),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.025865973825314),
                                    ("Hanukkahyear (latent)", -5.738183901373533),
                                    ("Rama Navamiyear (latent)", -6.431331081933479),
                                    ("February<time> <part-of-day>", -6.431331081933479),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.431331081933479),
                                    ("Great Lentyear (latent)", -6.431331081933479),
                                    ("tomorrowat <time-of-day>", -5.738183901373533),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.431331081933479),
                                    ("Ugadiyear (latent)", -5.045036720813588),
                                    ("Vaisakhiyear (latent)", -5.738183901373533),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.738183901373533),
                                    ("last <cycle> of <time>year (latent)", -5.738183901373533),
                                    ("at <time-of-day>tomorrow", -6.025865973825314),
                                    ("tomorrow<time-of-day> am|pm", -6.431331081933479),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.431331081933479),
                                    ("Diwaliyear (latent)", -6.431331081933479),
                                    ("between <time> and <time>on <day>", -6.025865973825314),
                                    ("Black Fridayyear (latent)", -6.025865973825314),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.431331081933479),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.431331081933479),
                                    ("Chhathyear (latent)", -6.025865973825314),
                                    ("Vasant Panchamiyear (latent)", -6.431331081933479),
                                    ("Rabindra Jayantiyear (latent)", -5.178568113438111),
                                    ("St Patrick's Dayyear (latent)", -6.431331081933479),
                                    ("Thursday<time> (timezone)", -6.431331081933479),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.431331081933479),
                                    ("Pargat Diwasyear (latent)", -5.178568113438111),
                                    ("<datetime> - <datetime> (interval)July", -6.025865973825314),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.738183901373533),
                                    ("Februaryintersect", -6.431331081933479),
                                    ("Simchat Torahyear (latent)", -6.431331081933479),
                                    ("minuteyear", -6.431331081933479)],
                               n = 479},
                   koData =
                     ClassData{prior = -1.0040238699921946, unseen = -6.732210706467206,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.533793523145864),
                                    ("hourday", -3.639975647123767),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.037870919922137),
                                    ("<day-of-month> (ordinal)August", -6.037870919922137),
                                    ("dayhour", -3.297030895996937),
                                    ("<time> timezoneyear (latent)", -5.344723739362192),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.121580188047982),
                                    ("Tuesdayfrom|since|after <time>", -5.344723739362192),
                                    ("daymonth", -3.363722270495609),
                                    ("monthyear", -4.785107951426769),
                                    ("<time-of-day> am|pmyear (latent)", -5.344723739362192),
                                    ("Thai Pongalyear (latent)", -5.344723739362192),
                                    ("intersecthh:mm", -6.037870919922137),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.632405811813974),
                                    ("<day-of-month> (ordinal)Wednesday", -6.037870919922137),
                                    ("houryear", -4.651576558802247),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.037870919922137),
                                    ("<day-of-month> (ordinal)October", -6.037870919922137),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.344723739362192),
                                    ("hournograin", -4.785107951426769),
                                    ("<time-of-day> am|pmintersect", -4.785107951426769),
                                    ("Octoberyear (latent)", -6.037870919922137),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.632405811813974),
                                    ("until <time>on <day>", -5.344723739362192),
                                    ("time-of-day (latent)intersect", -5.344723739362192),
                                    ("todayin <number> (implicit minutes)", -6.037870919922137),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.344723739362192),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.037870919922137),
                                    ("hh:mmon <day>", -4.785107951426769),
                                    ("hhhmmintersect", -5.632405811813974),
                                    ("absorption of , after named dayJuly", -5.121580188047982),
                                    ("from|since|after <time>July", -5.632405811813974),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.121580188047982),
                                    ("Clean Mondayyear (latent)", -6.037870919922137),
                                    ("monthhour", -6.037870919922137),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.632405811813974),
                                    ("hourmonth", -4.1660687430205465),
                                    ("todayat <time-of-day>", -6.037870919922137),
                                    ("hhhmmyear (latent)", -4.785107951426769),
                                    ("from|since|after <time>December", -6.037870919922137),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.037870919922137),
                                    ("<time-of-day> am|pmon <day>", -4.785107951426769),
                                    ("Mondayyear (latent)", -5.344723739362192),
                                    ("dayday", -4.651576558802247),
                                    ("mm/ddat <time-of-day>", -5.121580188047982),
                                    ("on <day>September", -5.344723739362192),
                                    ("time-of-day (latent)September", -5.632405811813974),
                                    ("hourhour", -5.632405811813974),
                                    ("time-of-day (latent)on <day>", -4.533793523145864),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.632405811813974),
                                    ("dayyear", -3.093431940755697),
                                    ("Thursdaymm/dd", -6.037870919922137),
                                    ("New Year's Dayyear (latent)", -5.121580188047982),
                                    ("time-of-day (latent)Sunday", -5.632405811813974),
                                    ("Thursdayfrom|since|after <time>", -4.333122827683712),
                                    ("Thursdayat <time-of-day>", -4.428433007488038),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.037870919922137),
                                    ("Aprilyear (latent)", -6.037870919922137),
                                    ("the <day-of-month> (ordinal)July", -6.037870919922137),
                                    ("the <day-of-month> (number)July", -6.037870919922137),
                                    ("monthminute", -6.037870919922137),
                                    ("<time-of-day> am|pmtomorrow", -6.037870919922137),
                                    ("Thursdayhh:mm", -5.121580188047982),
                                    ("<day-of-month> (ordinal)Tuesday", -5.632405811813974),
                                    ("minutemonth", -3.897804756425867),
                                    ("time-of-day (latent)Friday", -5.632405811813974),
                                    ("minutehour", -6.037870919922137),
                                    ("Augustyear (latent)", -5.632405811813974),
                                    ("week-endin|during <named-month>|year", -6.037870919922137),
                                    ("time-of-day (latent)Tuesday", -5.632405811813974),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.632405811813974),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.037870919922137),
                                    ("Sundayyear (latent)", -5.121580188047982),
                                    ("Christmasat <time-of-day>", -6.037870919922137),
                                    ("from|since|after <time>year (latent)", -4.939258631254028),
                                    ("hhhmmon <day>", -5.121580188047982),
                                    ("yesterday<time-of-day> am|pm", -6.037870919922137),
                                    ("<day-of-month> (ordinal)July", -5.344723739362192),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.037870919922137),
                                    ("at <time-of-day>intersect", -5.121580188047982),
                                    ("hh:mmyear (latent)", -4.651576558802247),
                                    ("Holiyear (latent)", -6.037870919922137),
                                    ("until <time><time-of-day> am|pm", -6.037870919922137),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.632405811813974),
                                    ("dayminute", -3.1756700389926693),
                                    ("yyyy-mm-ddhh:mm", -5.632405811813974),
                                    ("intersectfrom|since|after <time>", -5.632405811813974),
                                    ("intersectSeptember", -4.1660687430205465),
                                    ("minuteday", -2.8808704987720244),
                                    ("absorption of , after named dayintersect",
                                     -6.037870919922137),
                                    ("intersectyear (latent)", -6.037870919922137),
                                    ("Februaryin|during the <part-of-day>", -6.037870919922137),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.037870919922137),
                                    ("time-of-day (latent)July", -5.344723739362192),
                                    ("Saturdayyear (latent)", -6.037870919922137),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.037870919922137),
                                    ("at <time-of-day>on <day>", -5.121580188047982),
                                    ("absorption of , after named daySeptember",
                                     -4.785107951426769),
                                    ("Naraka Chaturdashiyear (latent)", -6.037870919922137),
                                    ("from|since|after <time>on <day>", -5.121580188047982),
                                    ("dayweek", -6.037870919922137),
                                    ("Easter Sundayyear (latent)", -5.632405811813974),
                                    ("Thursday<time-of-day> am|pm", -4.785107951426769),
                                    ("weekyear", -5.632405811813974),
                                    ("time-of-day (latent)Thursday", -5.632405811813974),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.037870919922137),
                                    ("<day-of-month> (ordinal)April", -6.037870919922137),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.632405811813974),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.344723739362192),
                                    ("Sundayfrom|since|after <time>", -6.037870919922137),
                                    ("absorption of , after named dayFebruary", -5.121580188047982),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.632405811813974),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.037870919922137),
                                    ("tomorrowat <time-of-day>", -6.037870919922137),
                                    ("daynograin", -5.632405811813974),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.632405811813974),
                                    ("last <cycle> of <time>year (latent)", -5.632405811813974),
                                    ("tomorrow<time-of-day> am|pm", -6.037870919922137),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.344723739362192),
                                    ("Diwaliyear (latent)", -5.632405811813974),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.037870919922137),
                                    ("Fridayyear (latent)", -5.632405811813974),
                                    ("time-of-day (latent)April", -6.037870919922137),
                                    ("minuteyear", -3.8406463425859183)],
                               n = 277}}),
       ("one eleven",
        Classifier{okData =
