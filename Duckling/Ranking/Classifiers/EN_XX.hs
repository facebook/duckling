...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6151232190658694, unseen = -6.075346031088684,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 433},
                   koData =
                     ClassData{prior = -0.7777780088994283, unseen = -5.91350300563827,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4730013150986518, unseen = -7.086737934510577,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.392754283805666),
                                    ("Karva Chauthyear (latent)", -6.392754283805666),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.392754283805666),
                                    ("Maha Shivaratriyear (latent)", -6.392754283805666),
                                    ("Ramadanyear (latent)", -5.476463551931511),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.006459922685775),
                                    ("Bhai Doojyear (latent)", -6.392754283805666),
                                    ("hourday", -4.377851263263401),
                                    ("dayhour", -3.4483153046392254),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.006459922685775),
                                    ("Martin Luther King's Dayyear (latent)", -5.9872891756975015),
                                    ("Shemini Atzeretyear (latent)", -6.392754283805666),
                                    ("daymonth", -4.252688120309395),
                                    ("monthday", -5.9872891756975015),
                                    ("monthyear", -4.520952106904074),
                                    ("Yom Ha'atzmautyear (latent)", -6.392754283805666),
                                    ("Vijayadashamiyear (latent)", -6.392754283805666),
                                    ("Thanksgiving Dayyear (latent)", -5.294141995137556),
                                    ("Thai Pongalyear (latent)", -5.699607103245721),
                                    ("Thiru Onamyear (latent)", -5.699607103245721),
                                    ("hhhmmabsorption of , after named day", -6.392754283805666),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.392754283805666),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.476463551931511),
                                    ("<day-of-month> (ordinal)Wednesday", -6.392754283805666),
                                    ("Krishna Janmashtamiyear (latent)", -5.9872891756975015),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.392754283805666),
                                    ("houryear", -5.476463551931511),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.392754283805666),
                                    ("Christmas<time-of-day> am|pm", -6.392754283805666),
                                    ("<day-of-month> (ordinal)October", -6.392754283805666),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.392754283805666),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.699607103245721),
                                    ("intersectin|during <named-month>|year", -6.392754283805666),
                                    ("<time-of-day> am|pmintersect", -5.139991315310298),
                                    ("Earth Houryear (latent)", -6.392754283805666),
                                    ("Octoberyear (latent)", -4.783316371371566),
                                    ("intersect<time-of-day> am|pm", -6.392754283805666),
                                    ("Mattu Pongalyear (latent)", -6.392754283805666),
                                    ("Shavuotyear (latent)", -6.392754283805666),
                                    ("Parsi New Yearyear (latent)", -5.476463551931511),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.392754283805666),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.392754283805666),
                                    ("todayin|within|after <duration>", -6.392754283805666),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.9872891756975015),
                                    ("Marchyear (latent)", -6.392754283805666),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -5.9872891756975015),
                                    ("Sukkotyear (latent)", -5.9872891756975015),
                                    ("hhhmmintersect", -5.9872891756975015),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.9872891756975015),
                                    ("Clean Mondayyear (latent)", -5.9872891756975015),
                                    ("monthhour", -5.9872891756975015),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.699607103245721),
                                    ("todayat <time-of-day>", -6.392754283805666),
                                    ("Thursday<time> timezone", -3.994859011007295),
                                    ("time-of-day (latent)tonight", -5.9872891756975015),
                                    ("from|since|after <time>December", -6.392754283805666),
                                    ("<time-of-day> am|pmon <day>", -4.377851263263401),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.392754283805666),
                                    ("yyyy-mm-ddhh:mm:ss", -5.9872891756975015),
                                    ("dayday", -3.6847040827034556),
                                    ("<time> <part-of-day>at <time-of-day>", -6.392754283805666),
                                    ("mm/ddat <time-of-day>", -5.699607103245721),
                                    ("tonightat <time-of-day>", -6.392754283805666),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.699607103245721),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.392754283805666),
                                    ("today<time-of-day> am|pm", -6.392754283805666),
                                    ("Februarythe <day-of-month> (ordinal)", -5.9872891756975015),
                                    ("at <time-of-day><time> <part-of-day>", -6.392754283805666),
                                    ("<day-of-month> (ordinal)intersect", -5.699607103245721),
                                    ("mm/dd<time-of-day> am|pm", -6.392754283805666),
                                    ("hourhour", -4.31331274212583),
                                    ("Mahavir Jayantiyear (latent)", -5.9872891756975015),
                                    ("Navaratriin|during <named-month>|year", -6.392754283805666),
                                    ("Wednesdaythis|last|next <cycle>", -6.392754283805666),
                                    ("Lentyear (latent)", -6.392754283805666),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.520952106904074),
                                    ("Boghiyear (latent)", -6.392754283805666),
                                    ("dayyear", -1.938406987552158),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.392754283805666),
                                    ("Thursdayfrom|since|after <time>", -5.9872891756975015),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.392754283805666),
                                    ("Thursdayat <time-of-day>", -5.699607103245721),
                                    ("Islamic New Yearyear (latent)", -5.9872891756975015),
                                    ("Laylat al-Qadryear (latent)", -5.476463551931511),
                                    ("Shrove Tuesdayyear (latent)", -6.392754283805666),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.699607103245721),
                                    ("<time-of-day> am|pmtomorrow", -5.699607103245721),
                                    ("Yom Kippuryear (latent)", -6.392754283805666),
                                    ("<day-of-month> (ordinal)Tuesday", -5.9872891756975015),
                                    ("<part-of-day> of <time>year (latent)", -6.392754283805666),
                                    ("minutehour", -5.139991315310298),
                                    ("Kaanum Pongalyear (latent)", -5.9872891756975015),
                                    ("Maha Saptamiyear (latent)", -6.392754283805666),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.9872891756975015),
                                    ("time-of-day (latent)tomorrow", -5.476463551931511),
                                    ("part of daysat <time-of-day>", -5.9872891756975015),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.377851263263401),
                                    ("for <duration> from <time>December", -6.392754283805666),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.392754283805666),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.139991315310298),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.139991315310298),
                                    ("time-of-day (latent)this <part-of-day>", -6.392754283805666),
                                    ("Pentecostyear (latent)", -6.392754283805666),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.139991315310298),
                                    ("<day-of-month> (ordinal)February", -6.392754283805666),
                                    ("Eid al-Fitryear (latent)", -5.476463551931511),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.392754283805666),
                                    ("Mondayin|during the <part-of-day>", -6.392754283805666),
                                    ("Chhathin|during <named-month>|year", -6.392754283805666),
                                    ("Diwaliin|during <named-month>|year", -6.392754283805666),
                                    ("Vaisakhiin|during <named-month>|year", -6.392754283805666),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.139991315310298),
                                    ("Raksha Bandhanyear (latent)", -6.392754283805666),
                                    ("daysecond", -5.9872891756975015),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.9872891756975015),
                                    ("Ashurayear (latent)", -6.392754283805666),
                                    ("Tuesdayin|during <named-month>|year", -6.392754283805666),
                                    ("Chinese New Yearyear (latent)", -6.392754283805666),
                                    ("tomorrowintersect", -6.392754283805666),
                                    ("Lag BaOmeryear (latent)", -6.392754283805666),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.392754283805666),
                                    ("Eid al-Adhayear (latent)", -4.252688120309395),
                                    ("intersectin|during the <part-of-day>", -6.392754283805666),
                                    ("Palm Sundayyear (latent)", -6.392754283805666),
                                    ("Christmasat <time-of-day>", -6.392754283805666),
                                    ("Passoveryear (latent)", -6.392754283805666),
                                    ("Lazarus Saturdayyear (latent)", -6.392754283805666),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.9872891756975015),
                                    ("hhhmmon <day>", -5.476463551931511),
                                    ("Yom HaShoahyear (latent)", -5.9872891756975015),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.9872891756975015),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.392754283805666),
                                    ("Septemberyear (latent)", -5.9872891756975015),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.8886768870293915),
                                    ("Halloweenyear (latent)", -6.392754283805666),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.392754283805666),
                                    ("at <time-of-day>intersect", -5.476463551931511),
                                    ("Rosh Hashanahyear (latent)", -5.699607103245721),
                                    ("Dhanterasyear (latent)", -6.392754283805666),
                                    ("Tu BiShvatyear (latent)", -6.392754283805666),
                                    ("<day-of-month> (ordinal)December", -5.699607103245721),
                                    ("Holiyear (latent)", -5.699607103245721),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.392754283805666),
                                    ("Holika Dahanyear (latent)", -5.699607103245721),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.9872891756975015),
                                    ("dayminute", -3.0083640204598914),
                                    ("Mawlidyear (latent)", -6.392754283805666),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.9872891756975015),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.392754283805666),
                                    ("Jumu'atul-Widayear (latent)", -5.476463551931511),
                                    ("minuteday", -2.6550846655222973),
                                    ("absorption of , after named dayintersect",
                                     -5.699607103245721),
                                    ("intersectyear (latent)", -5.9872891756975015),
                                    ("Orthodox Easter Sundayyear (latent)", -6.392754283805666),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.392754283805666),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.392754283805666),
                                    ("intersecthhhmm", -5.9872891756975015),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.392754283805666),
                                    ("Boss's Dayyear (latent)", -5.9872891756975015),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.392754283805666),
                                    ("Global Youth Service Dayyear (latent)", -6.392754283805666),
                                    ("Dhanterasin|during <named-month>|year", -6.392754283805666),
                                    ("Tisha B'Avyear (latent)", -6.392754283805666),
                                    ("Isra and Mi'rajyear (latent)", -5.476463551931511),
                                    ("at <time-of-day>on <day>", -4.783316371371566),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.9872891756975015),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.699607103245721),
                                    ("Christmasyear (latent)", -5.9872891756975015),
                                    ("Naraka Chaturdashiyear (latent)", -5.9872891756975015),
                                    ("Thai Pongalin|during <named-month>|year", -6.392754283805666),
                                    ("dayweek", -6.392754283805666),
                                    ("Easter Sundayyear (latent)", -5.699607103245721),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -5.9872891756975015),
                                    ("weekyear", -5.294141995137556),
                                    ("King's Dayyear (latent)", -4.8886768870293915),
                                    ("hh:mmin|during the <part-of-day>", -5.476463551931511),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.9872891756975015),
                                    ("Hanukkahyear (latent)", -5.699607103245721),
                                    ("February<time> <part-of-day>", -6.392754283805666),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.392754283805666),
                                    ("Great Lentyear (latent)", -6.392754283805666),
                                    ("tomorrowat <time-of-day>", -5.699607103245721),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.392754283805666),
                                    ("Vaisakhiyear (latent)", -5.699607103245721),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.699607103245721),
                                    ("last <cycle> of <time>year (latent)", -5.699607103245721),
                                    ("at <time-of-day>tomorrow", -5.9872891756975015),
                                    ("tomorrow<time-of-day> am|pm", -6.392754283805666),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.392754283805666),
                                    ("Diwaliyear (latent)", -6.392754283805666),
                                    ("between <time> and <time>on <day>", -5.9872891756975015),
                                    ("Black Fridayyear (latent)", -5.9872891756975015),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.392754283805666),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.392754283805666),
                                    ("Chhathyear (latent)", -5.9872891756975015),
                                    ("Vasant Panchamiyear (latent)", -6.392754283805666),
                                    ("Rabindra Jayantiyear (latent)", -5.139991315310298),
                                    ("St Patrick's Dayyear (latent)", -6.392754283805666),
                                    ("Thursday<time> (timezone)", -6.392754283805666),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.392754283805666),
                                    ("<datetime> - <datetime> (interval)July", -5.9872891756975015),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.699607103245721),
                                    ("Februaryintersect", -6.392754283805666),
                                    ("Simchat Torahyear (latent)", -6.392754283805666),
                                    ("minuteyear", -6.392754283805666)],
                               n = 458},
                   koData =
                     ClassData{prior = -0.9758529930254982, unseen = -6.726233402358747,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.527809064830623),
                                    ("hourday", -3.633991188808527),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.031886461606898),
                                    ("<day-of-month> (ordinal)August", -6.031886461606898),
                                    ("dayhour", -3.2910464376816964),
                                    ("<time> timezoneyear (latent)", -5.338739281046952),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.115595729732743),
                                    ("Tuesdayfrom|since|after <time>", -5.338739281046952),
                                    ("daymonth", -3.357737812180369),
                                    ("monthyear", -4.77912349311153),
                                    ("<time-of-day> am|pmyear (latent)", -5.338739281046952),
                                    ("Thai Pongalyear (latent)", -5.338739281046952),
                                    ("intersecthh:mm", -6.031886461606898),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.626421353498733),
                                    ("<day-of-month> (ordinal)Wednesday", -6.031886461606898),
                                    ("houryear", -4.645592100487007),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.031886461606898),
                                    ("<day-of-month> (ordinal)October", -6.031886461606898),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.338739281046952),
                                    ("hournograin", -4.77912349311153),
                                    ("<time-of-day> am|pmintersect", -4.77912349311153),
                                    ("Octoberyear (latent)", -6.031886461606898),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.626421353498733),
                                    ("until <time>on <day>", -5.338739281046952),
                                    ("time-of-day (latent)intersect", -5.338739281046952),
                                    ("todayin <number> (implicit minutes)", -6.031886461606898),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.338739281046952),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.031886461606898),
                                    ("hh:mmon <day>", -4.77912349311153),
                                    ("hhhmmintersect", -5.626421353498733),
                                    ("absorption of , after named dayJuly", -5.115595729732743),
                                    ("from|since|after <time>July", -5.626421353498733),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.115595729732743),
                                    ("Clean Mondayyear (latent)", -6.031886461606898),
                                    ("monthhour", -6.031886461606898),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.626421353498733),
                                    ("hourmonth", -4.160084284705306),
                                    ("todayat <time-of-day>", -6.031886461606898),
                                    ("hhhmmyear (latent)", -4.77912349311153),
                                    ("from|since|after <time>December", -6.031886461606898),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.031886461606898),
                                    ("<time-of-day> am|pmon <day>", -4.77912349311153),
                                    ("Mondayyear (latent)", -5.338739281046952),
                                    ("dayday", -4.645592100487007),
                                    ("mm/ddat <time-of-day>", -5.115595729732743),
                                    ("on <day>September", -5.338739281046952),
                                    ("time-of-day (latent)September", -5.626421353498733),
                                    ("hourhour", -5.626421353498733),
                                    ("time-of-day (latent)on <day>", -4.527809064830623),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.626421353498733),
                                    ("dayyear", -3.087447482440457),
                                    ("Thursdaymm/dd", -6.031886461606898),
                                    ("New Year's Dayyear (latent)", -5.115595729732743),
                                    ("time-of-day (latent)Sunday", -5.626421353498733),
                                    ("Thursdayfrom|since|after <time>", -4.327138369368472),
                                    ("Thursdayat <time-of-day>", -4.422448549172797),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.031886461606898),
                                    ("Aprilyear (latent)", -6.031886461606898),
                                    ("the <day-of-month> (ordinal)July", -6.031886461606898),
                                    ("the <day-of-month> (number)July", -6.031886461606898),
                                    ("monthminute", -6.031886461606898),
                                    ("<time-of-day> am|pmtomorrow", -6.031886461606898),
                                    ("Thursdayhh:mm", -5.115595729732743),
                                    ("<day-of-month> (ordinal)Tuesday", -5.626421353498733),
                                    ("minutemonth", -3.891820298110627),
                                    ("time-of-day (latent)Friday", -5.626421353498733),
                                    ("minutehour", -6.031886461606898),
                                    ("Augustyear (latent)", -5.626421353498733),
                                    ("week-endin|during <named-month>|year", -6.031886461606898),
                                    ("time-of-day (latent)Tuesday", -5.626421353498733),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.626421353498733),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.031886461606898),
                                    ("Sundayyear (latent)", -5.115595729732743),
                                    ("Christmasat <time-of-day>", -6.031886461606898),
                                    ("from|since|after <time>year (latent)", -4.933274172938788),
                                    ("hhhmmon <day>", -5.115595729732743),
                                    ("yesterday<time-of-day> am|pm", -6.031886461606898),
                                    ("<day-of-month> (ordinal)July", -5.338739281046952),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.031886461606898),
                                    ("mm/ddyear (latent)", -6.031886461606898),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.031886461606898),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.031886461606898),
                                    ("at <time-of-day>intersect", -5.115595729732743),
                                    ("hh:mmyear (latent)", -4.645592100487007),
                                    ("Holiyear (latent)", -6.031886461606898),
                                    ("until <time><time-of-day> am|pm", -6.031886461606898),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.626421353498733),
                                    ("dayminute", -3.169685580677429),
                                    ("yyyy-mm-ddhh:mm", -5.626421353498733),
                                    ("intersectfrom|since|after <time>", -5.626421353498733),
                                    ("intersectSeptember", -4.160084284705306),
                                    ("minuteday", -2.874886040456784),
                                    ("absorption of , after named dayintersect",
                                     -6.031886461606898),
                                    ("intersectyear (latent)", -6.031886461606898),
                                    ("Februaryin|during the <part-of-day>", -6.031886461606898),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.031886461606898),
                                    ("time-of-day (latent)July", -5.338739281046952),
                                    ("Saturdayyear (latent)", -6.031886461606898),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.031886461606898),
                                    ("at <time-of-day>on <day>", -5.115595729732743),
                                    ("absorption of , after named daySeptember", -4.77912349311153),
                                    ("Naraka Chaturdashiyear (latent)", -6.031886461606898),
                                    ("from|since|after <time>on <day>", -5.115595729732743),
                                    ("dayweek", -6.031886461606898),
                                    ("Easter Sundayyear (latent)", -5.626421353498733),
                                    ("Thursday<time-of-day> am|pm", -4.77912349311153),
                                    ("weekyear", -5.626421353498733),
                                    ("time-of-day (latent)Thursday", -5.626421353498733),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.031886461606898),
                                    ("<day-of-month> (ordinal)April", -6.031886461606898),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.626421353498733),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.338739281046952),
                                    ("Sundayfrom|since|after <time>", -6.031886461606898),
                                    ("absorption of , after named dayFebruary", -5.115595729732743),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.626421353498733),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.031886461606898),
                                    ("tomorrowat <time-of-day>", -6.031886461606898),
                                    ("daynograin", -5.626421353498733),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.626421353498733),
                                    ("last <cycle> of <time>year (latent)", -5.626421353498733),
                                    ("tomorrow<time-of-day> am|pm", -6.031886461606898),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.338739281046952),
                                    ("Diwaliyear (latent)", -5.626421353498733),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.031886461606898),
                                    ("Fridayyear (latent)", -5.626421353498733),
                                    ("time-of-day (latent)April", -6.031886461606898),
                                    ("minuteyear", -3.834661884270678)],
                               n = 277}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.16277142287116536,
                               unseen = -5.313205979041787,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.0153038170687558e-2),
                                    ("intersect 2 numbers", -3.9219733362813143)],
                               n = 198},
                   koData =
                     ClassData{prior = -1.8956903920762869,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
