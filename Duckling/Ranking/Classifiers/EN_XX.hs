...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7014805621190896, unseen = -5.484796933490655,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 239},
                   koData =
                     ClassData{prior = -0.6848826707100518,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4920633473104678, unseen = -6.577861357721047,
                               likelihoods =
                                 HashMap.fromList
                                   [("Ramadanyear (latent)", -5.883322388488279),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.6305594199929105),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.6305594199929105),
                                    ("hourday", -4.178574296249853),
                                    ("dayhour", -2.9655516564039996),
                                    ("Martin Luther King's Dayyear (latent)", -5.477857280380115),
                                    ("Shemini Atzeretyear (latent)", -5.883322388488279),
                                    ("daymonth", -5.190175207928333),
                                    ("monthday", -5.477857280380115),
                                    ("monthyear", -4.273884476054178),
                                    ("Yom Ha'atzmautyear (latent)", -5.883322388488279),
                                    ("Thanksgiving Dayyear (latent)", -4.7847100998201695),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.883322388488279),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.883322388488279),
                                    ("houryear", -5.477857280380115),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.883322388488279),
                                    ("Christmas<time-of-day> am|pm", -5.883322388488279),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.883322388488279),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.190175207928333),
                                    ("<time-of-day> am|pmintersect", -4.6305594199929105),
                                    ("Octoberyear (latent)", -4.6305594199929105),
                                    ("intersect<time-of-day> am|pm", -5.883322388488279),
                                    ("Shavuotyear (latent)", -5.883322388488279),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.883322388488279),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.477857280380115),
                                    ("Marchyear (latent)", -5.883322388488279),
                                    ("Sukkotyear (latent)", -5.477857280380115),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.883322388488279),
                                    ("Clean Mondayyear (latent)", -5.477857280380115),
                                    ("monthhour", -5.477857280380115),
                                    ("todayat <time-of-day>", -5.883322388488279),
                                    ("Thursday<time> timezone", -4.178574296249853),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.883322388488279),
                                    ("Palm SundaySunday", -5.477857280380115),
                                    ("dayday", -3.6860978111520595),
                                    ("<time> <part-of-day>at <time-of-day>", -5.883322388488279),
                                    ("mm/ddat <time-of-day>", -5.883322388488279),
                                    ("tonightat <time-of-day>", -5.883322388488279),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.190175207928333),
                                    ("today<time-of-day> am|pm", -5.883322388488279),
                                    ("Februarythe <day-of-month> (ordinal)", -5.477857280380115),
                                    ("at <time-of-day><time> <part-of-day>", -5.883322388488279),
                                    ("mm/dd<time-of-day> am|pm", -5.883322388488279),
                                    ("hourhour", -4.6305594199929105),
                                    ("<time-of-day> am|pmon <date>", -3.868419367946014),
                                    ("Wednesdaythis|last|next <cycle>", -5.883322388488279),
                                    ("Lentyear (latent)", -5.883322388488279),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.379244991712005),
                                    ("dayyear", -2.2724044758440543),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.883322388488279),
                                    ("Thursdayat <time-of-day>", -5.477857280380115),
                                    ("Islamic New Yearyear (latent)", -5.477857280380115),
                                    ("Laylat al-Qadryear (latent)", -4.9670316566141235),
                                    ("Shrove Tuesdayyear (latent)", -5.883322388488279),
                                    ("<time-of-day> am|pmtomorrow", -5.190175207928333),
                                    ("Yom Kippuryear (latent)", -5.883322388488279),
                                    ("<part-of-day> of <time>year (latent)", -5.883322388488279),
                                    ("minutehour", -4.9670316566141235),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.477857280380115),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.178574296249853),
                                    ("for <duration> from <time>December", -5.883322388488279),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.883322388488279),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.9670316566141235),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.477857280380115),
                                    ("Pentecostyear (latent)", -5.883322388488279),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.9670316566141235),
                                    ("Eid al-Fitryear (latent)", -5.883322388488279),
                                    ("Mondayin|during the <part-of-day>", -5.883322388488279),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.477857280380115),
                                    ("Ashurayear (latent)", -5.883322388488279),
                                    ("Chinese New Yearyear (latent)", -5.883322388488279),
                                    ("Sundayyear (latent)", -5.883322388488279),
                                    ("Lag BaOmeryear (latent)", -5.883322388488279),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.883322388488279),
                                    ("Eid al-Adhayear (latent)", -4.9670316566141235),
                                    ("intersectin|during the <part-of-day>", -5.883322388488279),
                                    ("Christmasat <time-of-day>", -5.883322388488279),
                                    ("Passoveryear (latent)", -5.883322388488279),
                                    ("Lazarus Saturdayyear (latent)", -5.883322388488279),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.883322388488279),
                                    ("Yom HaShoahyear (latent)", -5.477857280380115),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.9670316566141235),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.883322388488279),
                                    ("Septemberyear (latent)", -5.477857280380115),
                                    ("mm/ddyear (latent)", -5.883322388488279),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.6305594199929105),
                                    ("Halloweenyear (latent)", -5.883322388488279),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.190175207928333),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -4.9670316566141235),
                                    ("at <time-of-day>intersect", -5.477857280380115),
                                    ("Rosh Hashanahyear (latent)", -5.883322388488279),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.883322388488279),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.883322388488279),
                                    ("dayminute", -3.24426505887302),
                                    ("Mawlidyear (latent)", -5.883322388488279),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.477857280380115),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.883322388488279),
                                    ("Jumu'atul-Widayear (latent)", -4.9670316566141235),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.883322388488279),
                                    ("minuteday", -2.245736228761893),
                                    ("absorption of , after named dayintersect",
                                     -5.883322388488279),
                                    ("intersectyear (latent)", -5.883322388488279),
                                    ("Orthodox Easter Sundayyear (latent)", -5.883322388488279),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.883322388488279),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.883322388488279),
                                    ("Boss's Dayyear (latent)", -5.477857280380115),
                                    ("Tisha B'Avyear (latent)", -5.883322388488279),
                                    ("Isra and Mi'rajyear (latent)", -4.9670316566141235),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.883322388488279),
                                    ("Christmasyear (latent)", -5.477857280380115),
                                    ("at <time-of-day>on <date>", -4.7847100998201695),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.273884476054178),
                                    ("dayweek", -5.883322388488279),
                                    ("Easter Sundayyear (latent)", -5.190175207928333),
                                    ("Thursday<time-of-day> am|pm", -5.883322388488279),
                                    ("weekyear", -5.477857280380115),
                                    ("hh:mmin|during the <part-of-day>", -5.190175207928333),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.477857280380115),
                                    ("Hanukkahyear (latent)", -5.883322388488279),
                                    ("February<time> <part-of-day>", -5.883322388488279),
                                    ("Tuesdayin <named-month>|year", -5.883322388488279),
                                    ("Great Lentyear (latent)", -5.883322388488279),
                                    ("tomorrowat <time-of-day>", -5.190175207928333),
                                    ("between <time> and <time>on <date>", -4.273884476054178),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.190175207928333),
                                    ("last <cycle> of <time>year (latent)", -5.190175207928333),
                                    ("at <time-of-day>tomorrow", -5.477857280380115),
                                    ("tomorrow<time-of-day> am|pm", -5.883322388488279),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.883322388488279),
                                    ("Black Fridayyear (latent)", -5.477857280380115),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.883322388488279),
                                    ("Palm Sundayintersect", -5.883322388488279),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.883322388488279),
                                    ("Februaryintersect", -5.883322388488279),
                                    ("Simchat Torahyear (latent)", -5.883322388488279)],
                               n = 269},
                   koData =
                     ClassData{prior = -0.9451111704096471, unseen = -6.259581464064923,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.564520407322694),
                                    ("hourday", -5.564520407322694),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.564520407322694),
                                    ("dayhour", -3.122173371953489),
                                    ("daymonth", -3.4850788656428575),
                                    ("monthday", -5.159055299214529),
                                    ("monthyear", -4.311757438827326),
                                    ("<time-of-day> am|pmyear (latent)", -5.159055299214529),
                                    ("intersecthh:mm", -5.564520407322694),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.564520407322694),
                                    ("houryear", -4.648229675448539),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.564520407322694),
                                    ("until <time-of-day><time-of-day> am|pm", -5.564520407322694),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.871373226762748),
                                    ("<time-of-day> am|pmintersect", -4.311757438827326),
                                    ("Octoberyear (latent)", -5.564520407322694),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.311757438827326),
                                    ("from|since|after <time-of-day>on <date>", -4.648229675448539),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.564520407322694),
                                    ("absorption of , after named dayJuly", -5.159055299214529),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.648229675448539),
                                    ("Clean Mondayyear (latent)", -5.564520407322694),
                                    ("monthhour", -5.564520407322694),
                                    ("hourmonth", -4.871373226762748),
                                    ("todayat <time-of-day>", -5.564520407322694),
                                    ("from|since|after <time-of-day>July", -5.564520407322694),
                                    ("Mondayyear (latent)", -4.871373226762748),
                                    ("dayday", -5.159055299214529),
                                    ("mm/ddat <time-of-day>", -5.159055299214529),
                                    ("<time-of-day> am|pmon <date>", -4.311757438827326),
                                    ("dayyear", -2.791931685082912),
                                    ("Thursdaymm/dd", -5.564520407322694),
                                    ("New Year's Dayyear (latent)", -5.159055299214529),
                                    ("Thursdayat <time-of-day>", -4.311757438827326),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.564520407322694),
                                    ("Aprilyear (latent)", -5.564520407322694),
                                    ("monthminute", -5.564520407322694),
                                    ("<time-of-day> am|pmtomorrow", -5.564520407322694),
                                    ("Thursdayhh:mm", -4.648229675448539),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.564520407322694),
                                    ("minutemonth", -3.7727609380946383),
                                    ("Sundayfrom|since|after <time-of-day>", -5.564520407322694),
                                    ("week-endin <named-month>|year", -5.564520407322694),
                                    ("Augustyear (latent)", -5.159055299214529),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.159055299214529),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.159055299214529),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.564520407322694),
                                    ("Sundayyear (latent)", -4.871373226762748),
                                    ("Christmasat <time-of-day>", -5.564520407322694),
                                    ("<duration> after|before|from <time>December",
                                     -5.564520407322694),
                                    ("yesterday<time-of-day> am|pm", -5.564520407322694),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.648229675448539),
                                    ("mm/ddyear (latent)", -5.564520407322694),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.159055299214529),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.564520407322694),
                                    ("until <time-of-day>on <date>", -4.871373226762748),
                                    ("at <time-of-day>intersect", -5.159055299214529),
                                    ("hh:mmyear (latent)", -4.465908118654584),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.564520407322694),
                                    ("dayminute", -3.079613757534693),
                                    ("intersectSeptember", -4.060443010546419),
                                    ("minuteday", -2.4964674721890763),
                                    ("absorption of , after named dayintersect",
                                     -5.564520407322694),
                                    ("Februaryin|during the <part-of-day>", -5.564520407322694),
                                    ("hh:mmon <date>", -3.5496173867804286),
                                    ("Saturdayyear (latent)", -5.564520407322694),
                                    ("from|since|after <time-of-day><time-of-day> am|pm",
                                     -5.564520407322694),
                                    ("absorption of , after named daySeptember",
                                     -4.648229675448539),
                                    ("on <date>September", -5.159055299214529),
                                    ("at <time-of-day>on <date>", -5.159055299214529),
                                    ("in <named-month>|yearyear (latent)", -5.564520407322694),
                                    ("dayweek", -5.564520407322694),
                                    ("Easter Sundayyear (latent)", -5.159055299214529),
                                    ("Thursday<time-of-day> am|pm", -5.159055299214529),
                                    ("absorption of , after named dayFebruary", -4.648229675448539),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.564520407322694),
                                    ("tomorrowat <time-of-day>", -5.564520407322694),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.564520407322694),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.955082494888593),
                                    ("tomorrow<time-of-day> am|pm", -5.564520407322694),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.871373226762748),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.564520407322694),
                                    ("Fridayyear (latent)", -5.159055299214529),
                                    ("minuteyear", -4.311757438827326)],
                               n = 171}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.21401106775093717,
                               unseen = -4.532599493153256,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -5.5880458394456614e-2),
                                    ("intersect 2 numbers", -3.4231762883809305)],
                               n = 88},
                   koData =
                     ClassData{prior = -1.6468254445057207, unseen = -3.258096538021482,
                               likelihoods =
                                 HashMap.fromList
