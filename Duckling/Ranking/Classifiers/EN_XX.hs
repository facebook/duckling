...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6086405011853248, unseen = -5.676753802268282,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 290},
                   koData =
                     ClassData{prior = -0.7854599808252961,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48193547210000237, unseen = -6.70196036600254,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.007583928987866),
                                    ...
                                    ("Octoberyear (latent)", -4.754820960492498),
                                    ...
                                    ("Dhanterasin <named-month>|year", -6.007583928987866),
                                    ...
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.007583928987866),
                                    ("Palm SundaySunday", -5.602118820879701),
                                    ("dayday", -3.810359351651646),
                                    ("<time> <part-of-day>at <time-of-day>", -6.007583928987866),
                                    ("mm/ddat <time-of-day>", -6.007583928987866),
                                    ...
                                    ("mm/dd<time-of-day> am|pm", -6.007583928987866),
                                    ...
                                    ("Chhathin <named-month>|year", -6.007583928987866),
                                    ("Vasant Panchamiin <named-month>|year", -6.007583928987866),
                                    ("Diwaliin <named-month>|year", -6.007583928987866),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.602118820879701),
                                    ("Navaratriin <named-month>|year", -6.007583928987866),
                                    ("Ashurayear (latent)", -6.007583928987866),
                                    ("Chinese New Yearyear (latent)", -6.007583928987866),
                                    ("Sundayyear (latent)", -6.007583928987866),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.007583928987866),
                                    ("Thai Pongalin <named-month>|year", -6.007583928987866),
                                    ("Septemberyear (latent)", -5.602118820879701),
                                    ("mm/ddyear (latent)", -6.007583928987866),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -6.007583928987866),
                                    ...
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.602118820879701),
                                    ("Hanukkahyear (latent)", -6.007583928987866),
                                    ("February<time> <part-of-day>", -6.007583928987866),
                                    ("Tuesdayin <named-month>|year", -6.007583928987866),
                                    ...
                                    ("Palm Sundayintersect", -6.007583928987866),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.007583928987866),
                               ...
                               n = 302},
                   koData =
                     ClassData{prior = -0.9612538726202855, unseen = -6.369900982828227,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.758749273916392),
                                    ("hourday", -4.758749273916392),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.675040005790547),
                                    ("dayhour", -3.1100906483290105),
                                    ("Tuesdayfrom|since|after <time>", -5.675040005790547),
                                    ("daymonth", -3.534973842294276),
                                    ("monthday", -5.269574897682382),
                                    ("monthyear", -4.422277037295179),
                                    ("<time-of-day> am|pmyear (latent)", -5.269574897682382),
                                    ("Thai Pongalyear (latent)", -4.981892825230601),
                                    ("intersecthh:mm", -5.675040005790547),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.675040005790547),
                                    ("houryear", -4.758749273916392),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.675040005790547),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.981892825230601),
                                    ("<time-of-day> am|pmintersect", -4.422277037295179),
                                    ("until <time>on <date>", -4.981892825230601),
                                    ("Octoberyear (latent)", -5.675040005790547),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.675040005790547),
                                    ("absorption of , after named dayJuly", -5.269574897682382),
                                    ("from|since|after <time>July", -5.675040005790547),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.758749273916392),
                                    ("Clean Mondayyear (latent)", -5.675040005790547),
                                    ("monthhour", -5.675040005790547),
                                    ("hourmonth", -4.758749273916392),
                                    ("todayat <time-of-day>", -5.675040005790547),
                                    ("from|since|after <time>December", -5.675040005790547),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.675040005790547),
                                    ("Mondayyear (latent)", -4.981892825230601),
                                    ("dayday", -5.269574897682382),
                                    ("mm/ddat <time-of-day>", -5.269574897682382),
                                    ("<time-of-day> am|pmon <date>", -4.422277037295179),
                                    ("dayyear", -2.704625540220846),
                                    ("Thursdaymm/dd", -5.675040005790547),
                                    ("New Year's Dayyear (latent)", -5.269574897682382),
                                    ("Thursdayfrom|since|after <time>", -3.970291913552122),
                                    ("Thursdayat <time-of-day>", -4.422277037295179),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.675040005790547),
                                    ("Aprilyear (latent)", -5.675040005790547),
                                    ("monthminute", -5.675040005790547),
                                    ("<time-of-day> am|pmtomorrow", -5.675040005790547),
                                    ("Thursdayhh:mm", -4.758749273916392),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.675040005790547),
                                    ("minutemonth", -3.883280536562492),
                                    ("week-endin <named-month>|year", -5.675040005790547),
                                    ("Augustyear (latent)", -5.269574897682382),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.269574897682382),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.269574897682382),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.675040005790547),
                                    ("Sundayyear (latent)", -4.981892825230601),
                                    ("Christmasat <time-of-day>", -5.675040005790547),
                                    ("from|since|after <time>year (latent)", -4.422277037295179),
                                    ("<duration> after|before|from <time>December",
                                     -5.675040005790547),
                                    ("yesterday<time-of-day> am|pm", -5.675040005790547),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.758749273916392),
                                    ("mm/ddyear (latent)", -5.675040005790547),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.981892825230601),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.675040005790547),
                                    ("at <time-of-day>intersect", -5.269574897682382),
                                    ("hh:mmyear (latent)", -4.576427717122438),
                                    ("Holiyear (latent)", -5.675040005790547),
                                    ("until <time><time-of-day> am|pm", -5.675040005790547),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.675040005790547),
                                    ("dayminute", -3.1493113614822916),
                                    ("intersectSeptember", -4.170962609014273),
                                    ("minuteday", -2.60698707065693),
                                    ("absorption of , after named dayintersect",
                                     -5.675040005790547),
                                    ("Februaryin|during the <part-of-day>", -5.675040005790547),
                                    ("hh:mmon <date>", -3.660136985248282),
                                    ("Saturdayyear (latent)", -5.675040005790547),
                                    ("from|since|after <time>on <date>", -4.758749273916392),
                                    ("absorption of , after named daySeptember",
                                     -4.758749273916392),
                                    ("Naraka Chaturdashiyear (latent)", -5.675040005790547),
                                    ("on <date>September", -5.269574897682382),
                                    ("at <time-of-day>on <date>", -5.269574897682382),
                                    ("in <named-month>|yearyear (latent)", -5.675040005790547),
                                    ("dayweek", -5.675040005790547),
                                    ("Easter Sundayyear (latent)", -5.269574897682382),
                                    ("Thursday<time-of-day> am|pm", -4.981892825230601),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.675040005790547),
                                    ("Sundayfrom|since|after <time>", -5.675040005790547),
                                    ("absorption of , after named dayFebruary", -4.758749273916392),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.675040005790547),
                                    ("tomorrowat <time-of-day>", -5.675040005790547),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.675040005790547),
                                    ("tomorrow<time-of-day> am|pm", -5.675040005790547),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.981892825230601),
                                    ("Diwaliyear (latent)", -5.269574897682382),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.675040005790547),
                                    ("Fridayyear (latent)", -5.269574897682382),
                                    ("minuteyear", -4.422277037295179)],
                               n = 187}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.15860503017663852,
                               ...
                               n = 128},
                   koData =
                     ClassData{prior = -1.91959284073794, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
