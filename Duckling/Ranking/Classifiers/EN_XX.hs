...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.616186139423817, unseen = -6.073044534100405,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 432},
                   koData =
                     ClassData{prior = -0.7765287894989963, unseen = -5.91350300563827,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47382563772031083,
                               unseen = -7.084226422097916,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.39024066706535),
                                    ("Karva Chauthyear (latent)", -6.39024066706535),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.39024066706535),
                                    ...
                                    ("daymonth", -4.250174503569079),
                                    ("monthday", -5.984775558957185),
                                    ("monthyear", -4.518438490163758),
                                    ...
                                    ("hhhmmabsorption of , after named day", -6.39024066706535),
                                    ...
                                    ("<day-of-month> (ordinal)October", -6.39024066706535),
                                    ...
                                    ("Octoberyear (latent)", -4.7808027546312495),
                                    ...
                                    ("hhhmmintersect", -5.984775558957185),
                                    ...
                                    ("Thursday<time> timezone", -3.9923453942669793),
                                    ...
                                    ("<day-of-month> (ordinal)intersect", -5.697093486505405),
                                    ("mm/dd<time-of-day> am|pm", -6.39024066706535),
                                    ("hourhour", -4.310799125385514),
                                    ("Mahavir Jayantiyear (latent)", -5.984775558957185),
                                    ...
                                    ("dayyear", -1.9417242911226351),
                                    ("Karva Chauthin|during <named-month>|year", -6.39024066706535),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.39024066706535),
                                    ("at <time-of-day>intersect", -5.473949935191195),
                                    ...
                                    ("minuteday", -2.6525710487819816),
                                    ("absorption of , after named dayintersect",
                                     -5.697093486505405),
                                    ("intersectyear (latent)", -5.984775558957185),
                                    ...
                                    ("intersecthhhmm", -5.984775558957185),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.39024066706535),
                                    ...
                                    ("at <time-of-day>on <day>", -4.7808027546312495),
                                    ...
                                    ("hh:mmin|during the <part-of-day>", -5.473949935191195),
                                    ...
                                    ("between <time> and <time>on <day>", -5.984775558957185),
                               ...
                               n = 457},
                   koData =
                     ClassData{prior = -0.9744915224271771, unseen = -6.725033642166843,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.52660786348499),
                                    ("hourday", -3.6327899874628926),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.030685260261263),
                                    ("<day-of-month> (ordinal)August", -6.030685260261263),
                                    ("dayhour", -3.2898452363360624),
                                    ("<time> timezoneyear (latent)", -5.337538079701318),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.114394528387108),
                                    ("Tuesdayfrom|since|after <time>", -5.337538079701318),
                                    ("daymonth", -3.3565366108347345),
                                    ("monthyear", -4.777922291765895),
                                    ...
                                    ("time-of-day (latent)intersect", -5.337538079701318),
                                    ...
                                    ("from|since|after <time>July", -5.625220152153099),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.114394528387108),
                                    ...
                                    ("minutemonth", -3.8906190967649925),
                                    ...
                                    ("from|since|after <time>year (latent)", -4.932072971593153),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.030685260261263),
                                    ("mm/ddyear (latent)", -6.030685260261263),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.030685260261263),
                                    ...
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.625220152153099),
                                    ("dayminute", -3.1684843793317947),
                                    ("yyyy-mm-ddhh:mm", -5.625220152153099),
                                    ("intersectfrom|since|after <time>", -5.625220152153099),
                                    ("intersectSeptember", -4.1588830833596715),
                                    ("minuteday", -2.87368483911115),
                                    ("absorption of , after named dayintersect",
                                     -6.030685260261263),
                                    ...
                                    ("from|since|after <time>on <day>", -5.114394528387108),
                                    ("dayweek", -6.030685260261263),
                                    ("Easter Sundayyear (latent)", -5.625220152153099),
                                    ("Thursday<time-of-day> am|pm", -4.777922291765895),
                                    ("weekyear", -5.625220152153099),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.337538079701318),
                                    ("Sundayfrom|since|after <time>", -6.030685260261263),
