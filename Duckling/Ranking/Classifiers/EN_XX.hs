...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5835403740206678, unseen = -6.161207321695077,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 472},
                   koData =
                     ClassData{prior = -0.8162635621916913, unseen = -5.929589143389895,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4648126646787656, unseen = -7.181591944611865,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.487684018484611),
                                    ...
                                    ("daymonth", -4.34761785498834),
                                    ("monthday", -6.082218910376446),
                                    ("monthyear", -4.615881841583019),
                                    ...
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.487684018484611),
                                    ...
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.082218910376446),
                                    ("Marchyear (latent)", -6.487684018484611),
                                    ...
                                    ("Februarythe <day-of-month> (ordinal)", -6.082218910376446),
                                    ...
                                    ("dayyear", -1.9181410101396703),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.487684018484611),
                                    ("Thursdayfrom|since|after <time>", -6.082218910376446),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.487684018484611),
                                    ...
                                    ("<time-of-day> am|pmtomorrow", -5.794536837924666),
                                    ("Yom Kippuryear (latent)", -6.487684018484611),
                                    ("<day-of-month> (ordinal)Tuesday", -6.082218910376446),
                                    ...
                                    ("intersectin|during the <part-of-day>", -6.487684018484611),
                                    ...
                                    ("<datetime> - <datetime> (interval)July", -6.082218910376446),
                               ...
                               n = 507},
                   koData =
                     ClassData{prior = -0.9895411936137478, unseen = -6.803505257608338,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.605170185988091),
                                    ...
                                    ("dayhour", -3.3684075588391647),
                                    ("<time> timezoneyear (latent)", -5.41610040220442),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.19295685089021),
                                    ("Tuesdayfrom|since|after <time>", -5.41610040220442),
                                    ("daymonth", -3.435098933337837),
                                    ("monthyear", -4.8564846142689975),
                                    ("<time-of-day> am|pmyear (latent)", -5.41610040220442),
                                    ...
                                    ("Good Fridayyear (latent)", -6.1092475827643655),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.703782474656201),
                                    ("hourmonth", -4.237445405862774),
                                    ("todayat <time-of-day>", -6.1092475827643655),
                                    ("hhhmmyear (latent)", -4.8564846142689975),
                                    ...
                                    ("mm/ddat <time-of-day>", -5.19295685089021),
                                    ...
                                    ("<time-of-day> am|pmtomorrow", -6.1092475827643655),
                                    ...
                                    ("Orthodox Great Fridayyear (latent)", -6.1092475827643655),
                                    ...
                                    ("from|since|after <time>year (latent)", -5.0106352940962555),
                                    ...
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.1092475827643655),
                                    ("<day-of-month> (ordinal)Monday", -5.19295685089021),
                                    ...
                                    ("Fridayyear (latent)", -5.41610040220442),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.15219181534192538,
                               ...
                               n = 219},
                   koData =
                     ClassData{prior = -1.957744606702316, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
