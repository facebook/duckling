...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5914230325455029, unseen = -5.726847747587197,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 305},
                   koData =
                     ClassData{prior = -0.8064032732205517,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4736029132753824, unseen = -6.729824070489475,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.035481432524756),
                                    ("Ramadanyear (latent)", -6.035481432524756),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.782718464029388),
                                    ("Bhai Doojyear (latent)", -6.035481432524756),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.782718464029388),
                                    ("hourday", -4.330733340286331),
                                    ("dayhour", -3.2321210516182215),
                                    ("Martin Luther King's Dayyear (latent)", -5.630016324416592),
                                    ("Shemini Atzeretyear (latent)", -6.035481432524756),
                                    ("daymonth", -5.342334251964811),
                                    ("monthday", -5.630016324416592),
                                    ("monthyear", -4.243721963296701),
                                    ("Yom Ha'atzmautyear (latent)", -6.035481432524756),
                                    ("Vijayadashamiyear (latent)", -6.035481432524756),
                                    ("Thanksgiving Dayyear (latent)", -4.936869143856646),
                                    ("Thai Pongalyear (latent)", -5.342334251964811),
                                    ("Thiru Onamyear (latent)", -5.342334251964811),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.035481432524756),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.035481432524756),
                                    ("houryear", -5.342334251964811),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.035481432524756),
                                    ("Christmas<time-of-day> am|pm", -6.035481432524756),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.035481432524756),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.342334251964811),
                                    ("<time-of-day> am|pmintersect", -4.782718464029388),
                                    ("Earth Houryear (latent)", -6.035481432524756),
                                    ("Octoberyear (latent)", -4.531404035748483),
                                    ("intersect<time-of-day> am|pm", -6.035481432524756),
                                    ("Mattu Pongalyear (latent)", -6.035481432524756),
                                    ("Shavuotyear (latent)", -6.035481432524756),
                                    ("Dhanterasin <named-month>|year", -6.035481432524756),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.035481432524756),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.035481432524756),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.630016324416592),
                                    ("Marchyear (latent)", -6.035481432524756),
                                    ("Sukkotyear (latent)", -5.630016324416592),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.035481432524756),
                                    ("Clean Mondayyear (latent)", -5.630016324416592),
                                    ("monthhour", -5.630016324416592),
                                    ("todayat <time-of-day>", -6.035481432524756),
                                    ("Thursday<time> timezone", -4.330733340286331),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.035481432524756),
                                    ("Palm SundaySunday", -5.630016324416592),
                                    ("dayday", -3.8382568551885368),
                                    ("<time> <part-of-day>at <time-of-day>", -6.035481432524756),
                                    ("mm/ddat <time-of-day>", -6.035481432524756),
                                    ("tonightat <time-of-day>", -6.035481432524756),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.342334251964811),
                                    ("today<time-of-day> am|pm", -6.035481432524756),
                                    ("Februarythe <day-of-month> (ordinal)", -5.630016324416592),
                                    ("at <time-of-day><time> <part-of-day>", -6.035481432524756),
                                    ("mm/dd<time-of-day> am|pm", -6.035481432524756),
                                    ("hourhour", -4.782718464029388),
                                    ("<time-of-day> am|pmon <date>", -4.020578411982491),
                                    ("Wednesdaythis|last|next <cycle>", -6.035481432524756),
                                    ("Lentyear (latent)", -6.035481432524756),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.531404035748483),
                                    ("Boghiyear (latent)", -6.035481432524756),
                                    ("dayyear", -1.9924301646902063),
                                    ("Thursdayfrom|since|after <time>", -5.630016324416592),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.035481432524756),
                                    ("Thursdayat <time-of-day>", -5.630016324416592),
                                    ("Islamic New Yearyear (latent)", -5.630016324416592),
                                    ("Laylat al-Qadryear (latent)", -5.119190700650601),
                                    ("Chhathin <named-month>|year", -6.035481432524756),
                                    ("Vasant Panchamiin <named-month>|year", -6.035481432524756),
                                    ("Diwaliin <named-month>|year", -6.035481432524756),
                                    ("Shrove Tuesdayyear (latent)", -6.035481432524756),
                                    ("<time-of-day> am|pmtomorrow", -5.342334251964811),
                                    ("Yom Kippuryear (latent)", -6.035481432524756),
                                    ("<part-of-day> of <time>year (latent)", -6.035481432524756),
                                    ("minutehour", -5.119190700650601),
                                    ("Kaanum Pongalyear (latent)", -5.630016324416592),
                                    ("Maha Saptamiyear (latent)", -6.035481432524756),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.630016324416592),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.330733340286331),
                                    ("for <duration> from <time>December", -6.035481432524756),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.035481432524756),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.119190700650601),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.630016324416592),
                                    ("Pentecostyear (latent)", -6.035481432524756),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.119190700650601),
                                    ("Eid al-Fitryear (latent)", -6.035481432524756),
                                    ("Mondayin|during the <part-of-day>", -6.035481432524756),
                                    ("Raksha Bandhanyear (latent)", -6.035481432524756),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.630016324416592),
                                    ("Navaratriin <named-month>|year", -6.035481432524756),
                                    ("Ashurayear (latent)", -6.035481432524756),
                                    ("Chinese New Yearyear (latent)", -6.035481432524756),
                                    ("Sundayyear (latent)", -6.035481432524756),
                                    ("Lag BaOmeryear (latent)", -6.035481432524756),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.035481432524756),
                                    ("Eid al-Adhayear (latent)", -5.119190700650601),
                                    ("intersectin|during the <part-of-day>", -6.035481432524756),
                                    ("Christmasat <time-of-day>", -6.035481432524756),
                                    ("Passoveryear (latent)", -6.035481432524756),
                                    ("Lazarus Saturdayyear (latent)", -6.035481432524756),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.035481432524756),
                                    ("Yom HaShoahyear (latent)", -5.630016324416592),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.630016324416592),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.035481432524756),
                                    ("Thai Pongalin <named-month>|year", -6.035481432524756),
                                    ("Septemberyear (latent)", -5.630016324416592),
                                    ("mm/ddyear (latent)", -6.035481432524756),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.782718464029388),
                                    ("Halloweenyear (latent)", -6.035481432524756),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -5.119190700650601),
                                    ("at <time-of-day>intersect", -5.630016324416592),
                                    ("Rosh Hashanahyear (latent)", -5.342334251964811),
                                    ("Dhanterasyear (latent)", -6.035481432524756),
                                    ("Tu BiShvatyear (latent)", -6.035481432524756),
                                    ("Holiyear (latent)", -5.342334251964811),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.035481432524756),
                                    ("Holika Dahanyear (latent)", -5.342334251964811),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.035481432524756),
                                    ("dayminute", -3.3964241029094975),
                                    ("Mawlidyear (latent)", -6.035481432524756),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.630016324416592),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.035481432524756),
                                    ("Jumu'atul-Widayear (latent)", -5.119190700650601),
                                    ...
                                    ("Orthodox Easter Sundayyear (latent)", -6.035481432524756),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.035481432524756),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.035481432524756),
                                    ("Boss's Dayyear (latent)", -5.630016324416592),
                                    ("Global Youth Service Dayyear (latent)", -6.035481432524756),
                                    ("Tisha B'Avyear (latent)", -6.035481432524756),
                                    ("Isra and Mi'rajyear (latent)", -5.119190700650601),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.035481432524756),
                                    ("Christmasyear (latent)", -5.630016324416592),
                                    ("Naraka Chaturdashiyear (latent)", -5.630016324416592),
                                    ("at <time-of-day>on <date>", -4.936869143856646),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.426043520090656),
                                    ("dayweek", -6.035481432524756),
                                    ("Easter Sundayyear (latent)", -5.342334251964811),
                                    ("weekyear", -4.936869143856646),
                                    ("hh:mmin|during the <part-of-day>", -5.342334251964811),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.630016324416592),
                                    ("Hanukkahyear (latent)", -5.342334251964811),
                                    ("February<time> <part-of-day>", -6.035481432524756),
                                    ("Tuesdayin <named-month>|year", -6.035481432524756),
                                    ("Great Lentyear (latent)", -6.035481432524756),
                                    ("tomorrowat <time-of-day>", -5.342334251964811),
                                    ("between <time> and <time>on <date>", -4.426043520090656),
                                    ("last <cycle> of <time>year (latent)", -5.342334251964811),
                                    ("at <time-of-day>tomorrow", -5.630016324416592),
                                    ("tomorrow<time-of-day> am|pm", -6.035481432524756),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.035481432524756),
                                    ("Diwaliyear (latent)", -6.035481432524756),
                                    ("Black Fridayyear (latent)", -5.630016324416592),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.035481432524756),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.035481432524756),
                                    ("Chhathyear (latent)", -5.630016324416592),
                                    ("Vasant Panchamiyear (latent)", -6.035481432524756),
                                    ("Palm Sundayintersect", -6.035481432524756),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.035481432524756),
                                    ("Februaryintersect", -6.035481432524756),
                                    ("Simchat Torahyear (latent)", -6.035481432524756),
                                    ("minuteyear", -6.035481432524756)],
                               n = 312},
                   koData =
                     ClassData{prior = -0.9748590860252225,
