...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6026568273815703, unseen = -6.102558594613569,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 445},
                   koData =
                     ClassData{prior = -0.7926481713788797, unseen = -5.91350300563827,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46333249042871294,
                               unseen = -7.108244139731541,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.414278293550759),
                                    ("Karva Chauthyear (latent)", -6.414278293550759),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.414278293550759),
                                    ("Maha Shivaratriyear (latent)", -6.414278293550759),
                                    ("Ramadanyear (latent)", -5.497987561676604),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.027983932430868),
                                    ("Bhai Doojyear (latent)", -6.414278293550759),
                                    ("hourday", -4.399375273008495),
                                    ("dayhour", -3.469839314384319),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.027983932430868),
                                    ("Martin Luther King's Dayyear (latent)", -6.008813185442595),
                                    ("Shemini Atzeretyear (latent)", -6.414278293550759),
                                    ("daymonth", -4.274212130054488),
                                    ("monthday", -6.008813185442595),
                                    ("monthyear", -4.542476116649168),
                                    ("Yom Ha'atzmautyear (latent)", -6.414278293550759),
                                    ("Vijayadashamiyear (latent)", -6.414278293550759),
                                    ("Thanksgiving Dayyear (latent)", -5.31566600488265),
                                    ("Thai Pongalyear (latent)", -5.721131112990814),
                                    ("Thiru Onamyear (latent)", -5.721131112990814),
                                    ("hhhmmabsorption of , after named day", -6.414278293550759),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.414278293550759),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.497987561676604),
                                    ("<day-of-month> (ordinal)Wednesday", -6.414278293550759),
                                    ("Krishna Janmashtamiyear (latent)", -6.008813185442595),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.414278293550759),
                                    ("houryear", -5.497987561676604),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.414278293550759),
                                    ("Christmas<time-of-day> am|pm", -6.414278293550759),
                                    ("<day-of-month> (ordinal)October", -6.414278293550759),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.414278293550759),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.721131112990814),
                                    ("intersectin|during <named-month>|year", -6.414278293550759),
                                    ("<time-of-day> am|pmintersect", -5.161515325055391),
                                    ("Earth Houryear (latent)", -6.414278293550759),
                                    ("Octoberyear (latent)", -4.804840381116659),
                                    ("intersect<time-of-day> am|pm", -6.414278293550759),
                                    ("Mattu Pongalyear (latent)", -6.414278293550759),
                                    ("Shavuotyear (latent)", -6.414278293550759),
                                    ("Parsi New Yearyear (latent)", -5.497987561676604),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.414278293550759),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.414278293550759),
                                    ("todayin|within|after <duration>", -6.414278293550759),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.008813185442595),
                                    ("Marchyear (latent)", -6.414278293550759),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.008813185442595),
                                    ("Sukkotyear (latent)", -6.008813185442595),
                                    ("hhhmmintersect", -6.008813185442595),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.721131112990814),
                                    ("todayat <time-of-day>", -6.414278293550759),
                                    ("Thursday<time> timezone", -4.0163830207523885),
                                    ("time-of-day (latent)tonight", -6.008813185442595),
                                    ("from|since|after <time>December", -6.414278293550759),
                                    ("<time-of-day> am|pmon <day>", -4.399375273008495),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.414278293550759),
                                    ("yyyy-mm-ddhh:mm:ss", -6.008813185442595),
                                    ("dayday", -3.7062280924485496),
                                    ("<time> <part-of-day>at <time-of-day>", -6.414278293550759),
                                    ("mm/ddat <time-of-day>", -5.721131112990814),
                                    ("tonightat <time-of-day>", -6.414278293550759),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.721131112990814),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.414278293550759),
                                    ("today<time-of-day> am|pm", -6.414278293550759),
                                    ("Februarythe <day-of-month> (ordinal)", -6.008813185442595),
                                    ("at <time-of-day><time> <part-of-day>", -6.414278293550759),
                                    ("<day-of-month> (ordinal)intersect", -5.721131112990814),
                                    ("mm/dd<time-of-day> am|pm", -6.414278293550759),
                                    ("hourhour", -4.334836751870923),
                                    ("Mahavir Jayantiyear (latent)", -6.008813185442595),
                                    ("Navaratriin|during <named-month>|year", -6.414278293550759),
                                    ("Wednesdaythis|last|next <cycle>", -6.414278293550759),
                                    ("Lentyear (latent)", -6.414278293550759),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.542476116649168),
                                    ("Boghiyear (latent)", -6.414278293550759),
                                    ("dayyear", -1.8924897165017192),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.414278293550759),
                                    ("Thursdayfrom|since|after <time>", -6.008813185442595),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.414278293550759),
                                    ("Thursdayat <time-of-day>", -5.721131112990814),
                                    ("Islamic New Yearyear (latent)", -6.008813185442595),
                                    ("Laylat al-Qadryear (latent)", -5.497987561676604),
                                    ("Shrove Tuesdayyear (latent)", -6.414278293550759),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.721131112990814),
                                    ("<time-of-day> am|pmtomorrow", -5.721131112990814),
                                    ("Yom Kippuryear (latent)", -6.414278293550759),
                                    ("<day-of-month> (ordinal)Tuesday", -6.008813185442595),
                                    ("<part-of-day> of <time>year (latent)", -6.414278293550759),
                                    ("minutehour", -5.161515325055391),
                                    ("Kaanum Pongalyear (latent)", -6.008813185442595),
                                    ("Maha Saptamiyear (latent)", -6.414278293550759),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.008813185442595),
                                    ("time-of-day (latent)tomorrow", -5.497987561676604),
                                    ("part of daysat <time-of-day>", -6.008813185442595),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.399375273008495),
                                    ("for <duration> from <time>December", -6.414278293550759),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.414278293550759),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.161515325055391),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.161515325055391),
                                    ("time-of-day (latent)this <part-of-day>", -6.414278293550759),
                                    ("Pentecostyear (latent)", -6.414278293550759),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.161515325055391),
                                    ("<day-of-month> (ordinal)February", -6.414278293550759),
                                    ("Eid al-Fitryear (latent)", -5.497987561676604),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.414278293550759),
                                    ("Mondayin|during the <part-of-day>", -6.414278293550759),
                                    ("Chhathin|during <named-month>|year", -6.414278293550759),
                                    ("Diwaliin|during <named-month>|year", -6.414278293550759),
                                    ("Vaisakhiin|during <named-month>|year", -6.414278293550759),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.161515325055391),
                                    ("Raksha Bandhanyear (latent)", -6.414278293550759),
                                    ("daysecond", -6.008813185442595),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.008813185442595),
                                    ("Ashurayear (latent)", -6.414278293550759),
                                    ("Tuesdayin|during <named-month>|year", -6.414278293550759),
                                    ("Chinese New Yearyear (latent)", -6.414278293550759),
                                    ("tomorrowintersect", -6.414278293550759),
                                    ("Lag BaOmeryear (latent)", -6.414278293550759),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.414278293550759),
                                    ("Eid al-Adhayear (latent)", -4.274212130054488),
                                    ("intersectin|during the <part-of-day>", -6.414278293550759),
                                    ("Palm Sundayyear (latent)", -6.414278293550759),
                                    ("Christmasat <time-of-day>", -6.414278293550759),
                                    ("Passoveryear (latent)", -6.414278293550759),
                                    ("Lazarus Saturdayyear (latent)", -6.414278293550759),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.008813185442595),
                                    ("hhhmmon <day>", -5.497987561676604),
                                    ("Yom HaShoahyear (latent)", -6.008813185442595),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.008813185442595),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.414278293550759),
                                    ("Septemberyear (latent)", -6.008813185442595),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.9102008967744855),
                                    ("Halloweenyear (latent)", -6.414278293550759),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.414278293550759),
                                    ("at <time-of-day>intersect", -5.497987561676604),
                                    ("Rosh Hashanahyear (latent)", -5.721131112990814),
                                    ("Dhanterasyear (latent)", -6.414278293550759),
                                    ("Tu BiShvatyear (latent)", -6.414278293550759),
                                    ("<day-of-month> (ordinal)December", -5.721131112990814),
                                    ("Holiyear (latent)", -5.721131112990814),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.414278293550759),
                                    ("Holika Dahanyear (latent)", -5.721131112990814),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.008813185442595),
                                    ("dayminute", -3.0298880302049853),
                                    ("Mawlidyear (latent)", -6.414278293550759),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.008813185442595),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.414278293550759),
                                    ("Jumu'atul-Widayear (latent)", -5.497987561676604),
                                    ("minuteday", -2.676608675267391),
                                    ("absorption of , after named dayintersect",
                                     -5.721131112990814),
                                    ("intersectyear (latent)", -6.008813185442595),
                                    ("Orthodox Easter Sundayyear (latent)", -6.414278293550759),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.414278293550759),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.414278293550759),
                                    ("intersecthhhmm", -6.008813185442595),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.414278293550759),
                                    ("Boss's Dayyear (latent)", -6.008813185442595),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.414278293550759),
                                    ("Global Youth Service Dayyear (latent)", -6.414278293550759),
                                    ("Dhanterasin|during <named-month>|year", -6.414278293550759),
                                    ("Tisha B'Avyear (latent)", -6.414278293550759),
                                    ("Isra and Mi'rajyear (latent)", -5.497987561676604),
                                    ("at <time-of-day>on <day>", -4.804840381116659),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.008813185442595),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.721131112990814),
                                    ("Christmasyear (latent)", -6.008813185442595),
                                    ("Naraka Chaturdashiyear (latent)", -6.008813185442595),
                                    ("Thai Pongalin|during <named-month>|year", -6.414278293550759),
                                    ("dayweek", -6.414278293550759),
                                    ("Easter Sundayyear (latent)", -5.721131112990814),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.008813185442595),
                                    ("weekyear", -5.31566600488265),
                                    ("King's Dayyear (latent)", -4.9102008967744855),
                                    ("hh:mmin|during the <part-of-day>", -5.497987561676604),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.008813185442595),
                                    ("Hanukkahyear (latent)", -5.721131112990814),
                                    ("February<time> <part-of-day>", -6.414278293550759),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.414278293550759),
                                    ("Great Lentyear (latent)", -6.414278293550759),
                                    ("tomorrowat <time-of-day>", -5.721131112990814),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.414278293550759),
                                    ("Ugadiyear (latent)", -5.161515325055391),
                                    ("Vaisakhiyear (latent)", -5.721131112990814),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.721131112990814),
                                    ("last <cycle> of <time>year (latent)", -5.721131112990814),
                                    ("at <time-of-day>tomorrow", -6.008813185442595),
                                    ("tomorrow<time-of-day> am|pm", -6.414278293550759),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.414278293550759),
                                    ("Diwaliyear (latent)", -6.414278293550759),
                                    ("between <time> and <time>on <day>", -6.008813185442595),
                                    ("Black Fridayyear (latent)", -6.008813185442595),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.414278293550759),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.414278293550759),
                                    ("Chhathyear (latent)", -6.008813185442595),
                                    ("Vasant Panchamiyear (latent)", -6.414278293550759),
                                    ("Rabindra Jayantiyear (latent)", -5.161515325055391),
                                    ("St Patrick's Dayyear (latent)", -6.414278293550759),
                                    ("Thursday<time> (timezone)", -6.414278293550759),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.414278293550759),
                                    ("Pargat Diwasyear (latent)", -5.161515325055391),
                                    ("<datetime> - <datetime> (interval)July", -6.008813185442595),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.721131112990814),
                                    ("Februaryintersect", -6.414278293550759),
                                    ("Simchat Torahyear (latent)", -6.414278293550759),
                                    ("minuteyear", -6.414278293550759)],
                               n = 470},
                   koData =
                     ClassData{prior = -0.9920476789454789, unseen = -6.728628613084702,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.530207147514636),
                                    ...
                                    ("mm/ddat <time-of-day>", -5.117993812416755),
