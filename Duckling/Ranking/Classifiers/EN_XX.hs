       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47835523873520663,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.042632833682381),
                                    ...
                                    ("Dhanterasin <named-month>|year", -6.042632833682381),
                                    ...
                                    ("Thursday<time> timezone", -4.337884741443956),
                                    ("from|since|after <time>December", -6.042632833682381),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.042632833682381),
                                    ("Palm SundaySunday", -5.637167725574217),
                                    ("dayday", -3.845408256346162),
                                    ...
                                    ("dayyear", -1.9995815658478313),
                                    ("Thursdayfrom|since|after <time>", -5.637167725574217),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.042632833682381),
                                    ("Thursdayat <time-of-day>", -5.637167725574217),
                                    ("Islamic New Yearyear (latent)", -5.637167725574217),
                                    ("Laylat al-Qadryear (latent)", -5.126342101808226),
                                    ("Chhathin <named-month>|year", -6.042632833682381),
                                    ("Vasant Panchamiin <named-month>|year", -6.042632833682381),
                                    ("Diwaliin <named-month>|year", -6.042632833682381),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.637167725574217),
                                    ("Navaratriin <named-month>|year", -6.042632833682381),
                                    ("Ashurayear (latent)", -6.042632833682381),
                                    ("Chinese New Yearyear (latent)", -6.042632833682381),
                                    ("Sundayyear (latent)", -6.042632833682381),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.042632833682381),
                                    ("Thai Pongalin <named-month>|year", -6.042632833682381),
                                    ...
                                    ("Tuesdayin <named-month>|year", -6.042632833682381),
                                    ...
                                    ("Palm Sundayintersect", -6.042632833682381),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.042632833682381),
                               ...
                               n = 313},
                   koData =
                     ClassData{prior = -0.9670630572475782, unseen = -6.398594934535208,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.787491742782046),
                                    ...
                                    ("this <time><time-of-day> am|pm", -5.703782474656201),
