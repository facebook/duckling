...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7621400520468967, unseen = -5.25227342804663,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 189},
                   koData =
                     ClassData{prior = -0.6286086594223742, unseen = -5.384495062789089,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5009245527832791, unseen = -6.302618975744905,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.3548756456079305),
                                    ("hourday", -3.9028905218648733),
                                    ("dayhour", -2.774425270047083),
                                    ("daymonth", -4.914491433543353),
                                    ("monthday", -5.202173505995134),
                                    ("monthyear", -3.9982007016691985),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.607638614103299),
                                    ("Easter Sundayyear", -4.914491433543353),
                                    ("Christmasyear", -5.607638614103299),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.607638614103299),
                                    ("houryear", -5.607638614103299),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.607638614103299),
                                    ("Marchyear", -5.607638614103299),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.202173505995134),
                                    ("intersect<time-of-day> am|pm", -5.607638614103299),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.607638614103299),
                                    ("monthhour", -5.202173505995134),
                                    ("last <day-of-week> of <time>year", -5.607638614103299),
                                    ("todayat <time-of-day>", -5.607638614103299),
                                    ("Thursday<time> timezone", -3.9028905218648733),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.607638614103299),
                                    ("dayday", -3.592735593561034),
                                    ("Thanksgiving Dayyear", -4.509026325435189),
                                    ("<time> <part-of-day>at <time-of-day>", -5.607638614103299),
                                    ("Tuesdayin <named-month>", -5.607638614103299),
                                    ("mm/ddat <time-of-day>", -5.607638614103299),
                                    ("tonightat <time-of-day>", -5.607638614103299),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.914491433543353),
                                    ("today<time-of-day> am|pm", -5.607638614103299),
                                    ("Februarythe <day-of-month> (ordinal)", -5.202173505995134),
                                    ("at <time-of-day><time> <part-of-day>", -5.607638614103299),
                                    ("mm/dd<time-of-day> am|pm", -5.607638614103299),
                                    ("hourhour", -4.3548756456079305),
                                    ("<time-of-day> am|pmon <date>", -3.592735593561034),
                                    ("Wednesdaythis|last|next <cycle>", -5.607638614103299),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.103561217327025),
                                    ("dayyear", -3.0819099697950434),
                                    ("last weekend of <named-month>year", -5.607638614103299),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.607638614103299),
                                    ("Thursdayat <time-of-day>", -5.202173505995134),
                                    ("<time-of-day> am|pmtomorrow", -4.914491433543353),
                                    ("minutehour", -4.6913478822291435),
                                    ("Mother's Dayyear", -5.607638614103299),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.202173505995134),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.9028905218648733),
                                    ("for <duration> from <time>December", -5.607638614103299),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.607638614103299),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.6913478822291435),
                                    ("Mondayin|during the <part-of-day>", -5.607638614103299),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.202173505995134),
                                    ("intersectin|during the <part-of-day>", -5.607638614103299),
                                    ...
                                    ("minuteday", -2.141902711303572),
                                    ("absorption of , after named dayintersect",
                                     -5.607638614103299),
                                    ("Octoberyear", -4.3548756456079305),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.607638614103299),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.607638614103299),
                                    ("year<time-of-day> am|pm", -5.607638614103299),
                                    ("Septemberyear", -5.202173505995134),
                                    ("at <time-of-day>on <date>", -4.509026325435189),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.914491433543353),
                                    ("Halloweenyear", -5.607638614103299),
                                    ("dayweek", -5.607638614103299),
                                    ("Thursday<time-of-day> am|pm", -5.607638614103299),
                                    ("weekyear", -5.202173505995134),
                                    ("hh:mmin|during the <part-of-day>", -4.914491433543353),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.202173505995134),
                                    ("February<time> <part-of-day>", -5.607638614103299),
                                    ("Martin Luther King's Dayyear", -5.202173505995134),
                                    ("tomorrowat <time-of-day>", -4.914491433543353),
                                    ("between <time> and <time>on <date>", -4.914491433543353),
                                    ("Thursdayfrom|since|after <time-of-day>", -4.914491433543353),
                                    ("at <time-of-day>tomorrow", -5.202173505995134),
                                    ("tomorrow<time-of-day> am|pm", -5.607638614103299),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.607638614103299),
                                    ("Labor Dayyear", -5.607638614103299),
                                    ("Februaryintersect", -5.607638614103299),
                                    ("last <cycle> of <time>year", -4.914491433543353),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.607638614103299),
                                    ("yearminute", -5.607638614103299),
                                    ("Black Fridayyear", -5.202173505995134)],
                               n = 203},
                   koData =
                     ClassData{prior = -0.9313286092386955,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.305789381386738),
                                    ...
                                    ("mm/ddat <time-of-day>", -4.9003242732785735),
                                    ("<time-of-day> am|pmon <date>", -4.05302641289137),
                                    ("dayyear", -3.696351468952637),
                                    ("Thursdaymm/dd", -5.305789381386738),
                                    ("Sundayyear", -4.9003242732785735),
       ...
       ("year",
        Classifier{okData =
                     ClassData{prior = -0.262364264467491, unseen = -3.8066624897703196,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -9.53101798043249e-2),
                                    ("intersect 2 numbers", -3.0910424533583156)],
                               n = 40},
                   koData =
