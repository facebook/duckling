...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46582003756489015,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.491481972157369),
                                    ...
                                    ("daymonth", -4.351415808661098),
                                    ("monthday", -6.0860168640492045),
                                    ("monthyear", -4.619679795255778),
                                    ...
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.491481972157369),
                                    ...
                                    ("<day-of-month> (ordinal)October", -6.491481972157369),
                                    ...
                                    ("Octoberyear (latent)", -4.882044059723269),
                                    ...
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.0860168640492045),
                                    ("Marchyear (latent)", -6.491481972157369),
                                    ...
                                    ("Februarythe <day-of-month> (ordinal)", -6.0860168640492045),
                                    ("at <time-of-day><time> <part-of-day>", -6.491481972157369),
                                    ("<day-of-month> (ordinal)intersect", -5.798334791597424),
                                    ("mm/dd<time-of-day> am|pm", -6.491481972157369),
                                    ...
                                    ("dayyear", -1.911629594153568),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.491481972157369),
                                    ("Thursdayfrom|since|after <time>", -6.0860168640492045),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.491481972157369),
                                    ...
                                    ("<time-of-day> am|pmtomorrow", -5.798334791597424),
                                    ("Yom Kippuryear (latent)", -6.491481972157369),
                                    ("<day-of-month> (ordinal)Tuesday", -6.0860168640492045),
                                    ...
                                    ("intersectin|during the <part-of-day>", -6.491481972157369),
                                    ...
                                    ("minuteday", -2.7538123538740007),
                                    ("absorption of , after named dayintersect",
                                     -5.798334791597424),
                                    ("intersectyear (latent)", -6.0860168640492045),
                                    ...
                                    ("<datetime> - <datetime> (interval)July", -6.0860168640492045),
                               ...
                               n = 509},
                   koData =
                     ClassData{prior = -0.9878410367405434, unseen = -6.80903930604298,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.610710366363707),
                                    ("hourday", -3.71689249034161),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.11478776313998),
                                    ("<day-of-month> (ordinal)August", -6.11478776313998),
                                    ("dayhour", -3.37394773921478),
                                    ("<time> timezoneyear (latent)", -5.421640582580036),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.198497031265826),
                                    ("Tuesdayfrom|since|after <time>", -5.421640582580036),
                                    ("daymonth", -3.4067375620377707),
                                    ("monthyear", -4.862024794644613),
                                    ("<time-of-day> am|pmyear (latent)", -5.421640582580036),
                                    ("Thai Pongalyear (latent)", -5.421640582580036),
                                    ("intersecthh:mm", -6.11478776313998),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.709322655031817),
                                    ("<day-of-month> (ordinal)Wednesday", -6.11478776313998),
                                    ("houryear", -4.72849340202009),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.11478776313998),
                                    ("<day-of-month> (ordinal)October", -6.11478776313998),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.421640582580036),
                                    ("hournograin", -4.862024794644613),
                                    ("<time-of-day> am|pmintersect", -4.862024794644613),
                                    ("Octoberyear (latent)", -6.11478776313998),
                                    ("Good Fridayyear (latent)", -5.709322655031817),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.709322655031817),
                                    ("early morningat <time-of-day>", -6.11478776313998),
                                    ("until <time>on <day>", -5.421640582580036),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.11478776313998),
                                    ("time-of-day (latent)intersect", -5.421640582580036),
                                    ("todayin <number> (implicit minutes)", -6.11478776313998),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.421640582580036),
                                    ("this <part-of-day><time-of-day> - <time-of-day> (interval)",
                                     -6.11478776313998),
                                    ("about|exactly <time-of-day>year (latent)", -6.11478776313998),
                                    ("hh:mmon <day>", -4.862024794644613),
                                    ("hhhmmintersect", -5.709322655031817),
                                    ("absorption of , after named dayJuly", -5.198497031265826),
                                    ("from|since|after <time>July", -5.709322655031817),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.198497031265826),
                                    ("Clean Mondayyear (latent)", -6.11478776313998),
                                    ("monthhour", -6.11478776313998),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.709322655031817),
                                    ("hourmonth", -4.242985586238389),
                                    ("todayat <time-of-day>", -6.11478776313998),
                                    ("hhhmmyear (latent)", -4.862024794644613),
                                    ("from|since|after <time>December", -6.11478776313998),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.11478776313998),
                                    ("<time-of-day> am|pmon <day>", -4.862024794644613),
                                    ("Mondayyear (latent)", -5.421640582580036),
                                    ("dayday", -4.099884742597716),
                                    ("mm/ddat <time-of-day>", -5.198497031265826),
                                    ("on <day>September", -5.421640582580036),
                                    ("time-of-day (latent)September", -5.709322655031817),
                                    ("hourhour", -4.035346221460145),
                                    ("time-of-day (latent)on <day>", -4.610710366363707),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.709322655031817),
                                    ("dayyear", -3.0702653254165577),
                                    ("Thursdaymm/dd", -6.11478776313998),
                                    ("New Year's Dayyear (latent)", -5.198497031265826),
                                    ("time-of-day (latent)Sunday", -5.709322655031817),
                                    ("Thursdayfrom|since|after <time>", -4.410039670901556),
                                    ("Thursdayat <time-of-day>", -4.505349850705881),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.11478776313998),
                                    ("Aprilyear (latent)", -6.11478776313998),
                                    ("the <day-of-month> (ordinal)July", -6.11478776313998),
                                    ("the <day-of-month> (number)July", -6.11478776313998),
                                    ("monthminute", -6.11478776313998),
                                    ("<time-of-day> am|pmtomorrow", -6.11478776313998),
                                    ("Thursdayhh:mm", -5.198497031265826),
                                    ("<day-of-month> (ordinal)Tuesday", -5.709322655031817),
                                    ("minutemonth", -3.97472159964371),
                                    ("time-of-day (latent)Friday", -5.709322655031817),
                                    ("minutehour", -6.11478776313998),
                                    ("part of daysat <time-of-day>", -5.016175474471871),
                                    ("Augustyear (latent)", -5.709322655031817),
                                    ("week-endin|during <named-month>|year", -6.11478776313998),
                                    ("time-of-day (latent)Tuesday", -5.709322655031817),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.11478776313998),
                                    ("Sundayyear (latent)", -5.198497031265826),
                                    ("the <day-of-month> (ordinal)Monday", -5.421640582580036),
                                    ("Christmasat <time-of-day>", -6.11478776313998),
                                    ("from|since|after <time>year (latent)", -5.016175474471871),
                                    ("hhhmmon <day>", -5.198497031265826),
                                    ("yesterday<time-of-day> am|pm", -6.11478776313998),
                                    ("<day-of-month> (ordinal)July", -5.421640582580036),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.11478776313998),
                                    ("at <time-of-day>intersect", -5.198497031265826),
                                    ("hh:mmyear (latent)", -4.72849340202009),
                                    ("Holiyear (latent)", -6.11478776313998),
                                    ("until <time><time-of-day> am|pm", -6.11478776313998),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.709322655031817),
                                    ("dayminute", -3.2525868822105126),
                                    ("yyyy-mm-ddhh:mm", -5.709322655031817),
                                    ("intersectfrom|since|after <time>", -5.709322655031817),
                                    ("intersectSeptember", -4.242985586238389),
                                    ("minuteday", -2.9577873419898677),
                                    ("absorption of , after named dayintersect", -6.11478776313998),
                                    ("intersectyear (latent)", -6.11478776313998),
                                    ("Februaryin|during the <part-of-day>", -6.11478776313998),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.11478776313998),
                                    ("time-of-day (latent)July", -5.421640582580036),
                                    ("Saturdayyear (latent)", -6.11478776313998),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.11478776313998),
                                    ("<day-of-month> (ordinal)Monday", -5.198497031265826),
                                    ("at <time-of-day>on <day>", -5.198497031265826),
                                    ("absorption of , after named daySeptember",
                                     -4.862024794644613),
                                    ("Naraka Chaturdashiyear (latent)", -6.11478776313998),
                                    ("from|since|after <time>on <day>", -5.198497031265826),
                                    ("dayweek", -6.11478776313998),
                                    ("Easter Sundayyear (latent)", -5.709322655031817),
                                    ("Thursday<time-of-day> am|pm", -4.862024794644613),
                                    ("weekyear", -5.709322655031817),
                                    ("time-of-day (latent)Thursday", -5.709322655031817),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.11478776313998),
                                    ("<day-of-month> (ordinal)April", -6.11478776313998),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.709322655031817),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.421640582580036),
                                    ("Sundayfrom|since|after <time>", -6.11478776313998),
                                    ("absorption of , after named dayFebruary", -5.198497031265826),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.709322655031817),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.11478776313998),
                                    ("tomorrowat <time-of-day>", -6.11478776313998),
                                    ("daynograin", -5.709322655031817),
                                    ("Fridayin|during <named-month>|year", -6.11478776313998),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.709322655031817),
                                    ("last <cycle> of <time>year (latent)", -5.709322655031817),
                                    ("tomorrow<time-of-day> am|pm", -6.11478776313998),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.421640582580036),
                                    ("Diwaliyear (latent)", -5.709322655031817),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.11478776313998),
                                    ("this <part-of-day>at <time-of-day>", -5.198497031265826),
                                    ("Fridayyear (latent)", -5.198497031265826),
                                    ("time-of-day (latent)April", -6.11478776313998),
                                    ("minuteyear", -3.9175631858037616)],
                               n = 302}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
