...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7323678937132265, unseen = -5.308267697401205,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 200},
                   koData =
                     ClassData{prior = -0.6554068525770982, unseen = -5.384495062789089,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4934815103080182, unseen = -6.393590753950631,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                     -4.446006964337289),
                                    ("Lentyear", -5.698769932832657),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.446006964337289),
                                    ("hourday", -3.9940218405942316),
                                    ("dayhour", -2.808398174936492),
                                    ("daymonth", -5.0056227522727115),
                                    ("monthday", -5.293304824724492),
                                    ("monthyear", -4.089332020398556),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.698769932832657),
                                    ("Easter Sundayyear", -5.0056227522727115),
                                    ("Christmasyear", -5.293304824724492),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.698769932832657),
                                    ("houryear", -5.293304824724492),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.698769932832657),
                                    ("Christmas<time-of-day> am|pm", -5.698769932832657),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.0056227522727115),
                                    ("<time-of-day> am|pmintersect", -4.446006964337289),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.698769932832657),
                                    ("Marchyear", -5.698769932832657),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.293304824724492),
                                    ("intersect<time-of-day> am|pm", -5.698769932832657),
                                    ("Clean Mondayyear", -5.293304824724492),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.698769932832657),
                                    ("monthhour", -5.293304824724492),
                                    ("last <day-of-week> of <time>year", -5.698769932832657),
                                    ("todayat <time-of-day>", -5.698769932832657),
                                    ("Thursday<time> timezone", -3.9940218405942316),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.698769932832657),
                                    ("Palm SundaySunday", -5.293304824724492),
                                    ("dayday", -3.5015453554964373),
                                    ("Thanksgiving Dayyear", -4.600157644164547),
                                    ("<time> <part-of-day>at <time-of-day>", -5.698769932832657),
                                    ("Tuesdayin <named-month>", -5.698769932832657),
                                    ("mm/ddat <time-of-day>", -5.698769932832657),
                                    ("tonightat <time-of-day>", -5.698769932832657),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.0056227522727115),
                                    ("today<time-of-day> am|pm", -5.698769932832657),
                                    ("Februarythe <day-of-month> (ordinal)", -5.293304824724492),
                                    ("at <time-of-day><time> <part-of-day>", -5.698769932832657),
                                    ("mm/dd<time-of-day> am|pm", -5.698769932832657),
                                    ("hourhour", -4.446006964337289),
                                    ("<time-of-day> am|pmon <date>", -3.6838669122903918),
                                    ("Wednesdaythis|last|next <cycle>", -5.698769932832657),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.194692536056383),
                                    ("dayyear", -2.7809992007483775),
                                    ("last weekend of <named-month>year", -5.698769932832657),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.698769932832657),
                                    ("Sundayyear", -5.698769932832657),
                                    ("Chinese New Yearyear", -5.698769932832657),
                                    ("Thursdayat <time-of-day>", -5.293304824724492),
                                    ("<time-of-day> am|pmtomorrow", -5.0056227522727115),
                                    ("minutehour", -4.782479200958502),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.293304824724492),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.9940218405942316),
                                    ("for <duration> from <time>December", -5.698769932832657),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.698769932832657),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.782479200958502),
                                    ("Mondayin|during the <part-of-day>", -5.698769932832657),
                                    ("Shrove Tuesdayyear", -5.698769932832657),
                                    ("<part-of-day> of <time>year", -5.698769932832657),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.293304824724492),
                                    ("intersectin|during the <part-of-day>", -5.698769932832657),
                                    ...
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.698769932832657),
                                    ("dayminute", -3.024621283406128),
                                    ("Boss's Dayyear", -5.293304824724492),
                                    ("Orthodox Easter Sundayyear", -5.698769932832657),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.293304824724492),
                                    ("intersectyear", -5.698769932832657),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.698769932832657),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.293304824724492),
                                    ("<ordinal> <cycle> of <time>year", -5.698769932832657),
                                    ("minuteday", -2.2330340300329303),
                                    ("absorption of , after named dayintersect",
                                     -5.698769932832657),
                                    ("Octoberyear", -4.446006964337289),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.698769932832657),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.698769932832657),
                                    ("year<time-of-day> am|pm", -5.698769932832657),
                                    ("Septemberyear", -5.293304824724492),
                                    ("at <time-of-day>on <date>", -4.600157644164547),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -5.0056227522727115),
                                    ("Halloweenyear", -5.698769932832657),
                                    ("dayweek", -5.698769932832657),
                                    ("Lazarus Saturdayyear", -5.698769932832657),
                                    ("Thursday<time-of-day> am|pm", -5.698769932832657),
                                    ("weekyear", -5.293304824724492),
                                    ("hh:mmin|during the <part-of-day>", -5.0056227522727115),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.293304824724492),
                                    ("February<time> <part-of-day>", -5.698769932832657),
                                    ("Martin Luther King's Dayyear", -5.293304824724492),
                                    ("tomorrowat <time-of-day>", -5.0056227522727115),
                                    ("between <time> and <time>on <date>", -5.0056227522727115),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.0056227522727115),
                                    ("at <time-of-day>tomorrow", -5.293304824724492),
                                    ("tomorrow<time-of-day> am|pm", -5.698769932832657),
                                    ("Pentecostyear", -5.698769932832657),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.698769932832657),
                                    ("Palm Sundayintersect", -5.698769932832657),
                                    ("Great Lentyear", -5.698769932832657),
                                    ("Februaryintersect", -5.698769932832657),
                                    ("last <cycle> of <time>year", -5.0056227522727115),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.698769932832657),
                                    ("yearminute", -5.698769932832657),
                                    ("Black Fridayyear", -5.293304824724492)],
                               n = 221},
                   koData =
                     ClassData{prior = -0.9428843214476028, unseen = -6.082218910376446,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.3867860145356445),
                                    ...
                                    ("mm/ddat <time-of-day>", -4.981320906427481),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -9.53101798043249e-2),
                                    ("intersect 2 numbers", -2.908720896564361)],
                               n = 51},
                   koData =
                     ClassData{prior = -1.4816045409242156, unseen = -2.995732273553991,
                               likelihoods =
                                 HashMap.fromList
