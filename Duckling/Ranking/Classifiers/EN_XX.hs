...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("<year> (bc|ad)",
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -infinity, unseen = -0.6931471805599453,
                               likelihoods = HashMap.fromList [], n = 0}}),
       ("between|from <numeral> to|and <numeral>",
        Classifier{okData =
                     ClassData{prior = -infinity, unseen = -0.6931471805599453,
                               likelihoods = HashMap.fromList [], n = 0},
                   koData =
       ...
       ("at <time-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.2411620568168881, unseen = -5.365976015021851,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time> timezone", -3.9749978045895347),
                                    ("noon|midnight|EOD|end of day", -4.2626798770413155),
                                    ("integer after|past <hour-of-day>", -3.9749978045895347),
                                    ("<time-of-day> o'clock", -4.66814498514948),
                                    ("half after|past <hour-of-day>", -4.66814498514948),
                                    ("hhhmm", -3.4153820166541116),
                                    ("<hour-of-day> <integer>", -3.9749978045895347),
                                    ("time-of-day (latent)", -1.6724127115954888),
                                    ("hhmm (latent)", -3.9749978045895347),
                                    ("<time-of-day> am|pm", -1.993996335722951),
                                    ("hh:mm", -3.2818506240295893),
                                    ("about|exactly <time-of-day>", -4.2626798770413155),
                                    ("hour", -1.1417844605333185),
                                    ("<time-of-day> sharp|exactly", -4.66814498514948),
                                    ("minute", -1.864784604242945)],
                               n = 99},
                   koData =
       ...
       ("in|within|after <duration>",
        Classifier{okData =
                     ClassData{prior = -0.17520408902509063,
                               unseen = -4.736198448394496,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -3.34109345759245),
                                    ("<integer> more <unit-of-duration>", -4.034240638152395),
                                    ("three-quarters of an hour", -3.1179499062782403),
                                    ("<integer> + '\"", -3.34109345759245),
                                    ("number.number hours", -4.034240638152395),
                                    ("second", -3.628775530044231),
                                    ("half a <time-grain>", -3.1179499062782403),
                                    ("day", -3.34109345759245), ("year", -4.034240638152395),
                                    ("<integer> <unit-of-duration>", -1.6363453653540248),
                                    ("a <unit-of-duration>", -3.1179499062782403),
                                    ("quarter of an hour", -3.1179499062782403),
                                    ("hour", -2.5301632413761213),
                                    ("about|exactly <duration>", -3.628775530044231),
                                    ("half an hour (abbrev).", -3.628775530044231),
                                    ("<integer> and an half hour", -4.034240638152395),
                                    ("minute", -1.2934006142271943)],
                               n = 47},
                   koData =
                     ClassData{prior = -1.8281271133989299,
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = 0.0, unseen = -3.2188758248682006,
                               likelihoods =
                                 HashMap.fromList
                                   [("negative numbersinteger (numeric)", -1.3862943611198906),
                                    ("about|exactly <numeral>integer (numeric)",
                                     -2.4849066497880004),
                                    ("integer (numeric)integer (numeric)", -0.5389965007326869),
                                    ("fractional numberinteger (numeric)", -2.4849066497880004)],
                               n = 20}}),
       ("one twenty two",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.0986122886681098,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4906229164484712,
                               unseen = -7.1891677384203225,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.495265555937008),
                                    ("Karva Chauthyear (latent)", -6.495265555937008),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.495265555937008),
                                    ("Maha Shivaratriyear (latent)", -6.495265555937008),
                                    ("Ramadanyear (latent)", -5.24250258744164),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.1089711948171175),
                                    ("Bhai Doojyear (latent)", -6.495265555937008),
                                    ("hourday", -4.480362535394743),
                                    ("dayhour", -3.4748406697926457),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.1089711948171175),
                                    ("Martin Luther King's Dayyear (latent)", -6.089800447828844),
                                    ("Shemini Atzeretyear (latent)", -6.495265555937008),
                                    ("daymonth", -4.3551993924407375),
                                    ("monthday", -6.089800447828844),
                                    ("monthyear", -4.6234633790354165),
                                    ("Yom Ha'atzmautyear (latent)", -6.495265555937008),
                                    ("Orthodox Good Fridayyear (latent)", -6.089800447828844),
                                    ("Vijayadashamiyear (latent)", -6.495265555937008),
                                    ("Thanksgiving Dayyear (latent)", -5.396653267268898),
                                    ("Thai Pongalyear (latent)", -5.802118375377063),
                                    ("Thiru Onamyear (latent)", -5.802118375377063),
                                    ("hhhmmabsorption of , after named day", -6.495265555937008),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.495265555937008),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.578974824062853),
                                    ("<day-of-month> (ordinal)Wednesday", -6.495265555937008),
                                    ("Krishna Janmashtamiyear (latent)", -6.089800447828844),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.495265555937008),
                                    ("houryear", -5.578974824062853),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.495265555937008),
                                    ("Christmas<time-of-day> am|pm", -6.495265555937008),
                                    ("<day-of-month> (ordinal)October", -6.495265555937008),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.495265555937008),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.802118375377063),
                                    ("intersectin|during <named-month>|year", -6.495265555937008),
                                    ("<time-of-day> am|pmintersect", -5.24250258744164),
                                    ("Earth Houryear (latent)", -6.495265555937008),
                                    ("Ganesh Chaturthiyear (latent)", -6.495265555937008),
                                    ("Octoberyear (latent)", -4.885827643502908),
                                    ("intersect<time-of-day> am|pm", -6.495265555937008),
                                    ("Mattu Pongalyear (latent)", -6.495265555937008),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.495265555937008),
                                    ("Shavuotyear (latent)", -6.495265555937008),
                                    ("Parsi New Yearyear (latent)", -5.578974824062853),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.495265555937008),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.495265555937008),
                                    ("todayin|within|after <duration>", -6.495265555937008),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.089800447828844),
                                    ("Marchyear (latent)", -6.495265555937008),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.089800447828844),
                                    ("Sukkotyear (latent)", -6.089800447828844),
                                    ("hhhmmintersect", -6.089800447828844),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.089800447828844),
                                    ("Clean Mondayyear (latent)", -6.089800447828844),
                                    ("monthhour", -6.089800447828844),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.802118375377063),
                                    ("todayat <time-of-day>", -6.495265555937008),
                                    ("Thursday<time> timezone", -4.097370283138638),
                                    ("tonight<time-of-day> am|pm", -6.495265555937008),
                                    ("time-of-day (latent)tonight", -6.089800447828844),
                                    ("from|since|after <time>December", -6.495265555937008),
                                    ("<time-of-day> am|pmon <day>", -4.480362535394743),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.495265555937008),
                                    ("yyyy-mm-ddhh:mm:ss", -6.089800447828844),
                                    ("dayday", -3.787215354834798),
                                    ("<time> <part-of-day>at <time-of-day>", -6.089800447828844),
                                    ("mm/ddat <time-of-day>", -5.802118375377063),
                                    ("tonightat <time-of-day>", -5.396653267268898),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.802118375377063),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.495265555937008),
                                    ("today<time-of-day> am|pm", -6.495265555937008),
                                    ("Februarythe <day-of-month> (ordinal)", -6.089800447828844),
                                    ("at <time-of-day><time> <part-of-day>", -6.495265555937008),
                                    ("<day-of-month> (ordinal)intersect", -5.802118375377063),
                                    ("mm/dd<time-of-day> am|pm", -6.495265555937008),
                                    ("hourhour", -3.524851090367307),
                                    ("Mahavir Jayantiyear (latent)", -6.089800447828844),
                                    ("Navaratriin|during <named-month>|year", -6.495265555937008),
                                    ("Wednesdaythis|last|next <cycle>", -6.495265555937008),
                                    ("Lentyear (latent)", -6.495265555937008),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.6234633790354165),
                                    ("Boghiyear (latent)", -6.495265555937008),
                                    ("dayyear", -1.9154131779332066),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.495265555937008),
                                    ("Thursdayfrom|since|after <time>", -6.089800447828844),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.495265555937008),
                                    ("Thursdayat <time-of-day>", -5.802118375377063),
                                    ("Islamic New Yearyear (latent)", -6.089800447828844),
                                    ("Laylat al-Qadryear (latent)", -5.578974824062853),
                                    ("part of days<time-of-day> am|pm", -6.495265555937008),
                                    ("Shrove Tuesdayyear (latent)", -6.495265555937008),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.802118375377063),
                                    ("hourminute", -6.089800447828844),
                                    ("<time-of-day> am|pmtomorrow", -5.578974824062853),
                                    ("Yom Kippuryear (latent)", -6.495265555937008),
                                    ("<day-of-month> (ordinal)Tuesday", -6.089800447828844),
                                    ("<part-of-day> of <time>year (latent)", -6.495265555937008),
                                    ("minutehour", -5.24250258744164),
                                    ("Kaanum Pongalyear (latent)", -6.089800447828844),
                                    ("Maha Saptamiyear (latent)", -6.495265555937008),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.802118375377063),
                                    ("time-of-day (latent)tomorrow", -5.578974824062853),
                                    ("part of daysat <time-of-day>", -4.885827643502908),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.480362535394743),
                                    ("for <duration> from <time>December", -6.495265555937008),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.495265555937008),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.24250258744164),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.24250258744164),
                                    ("time-of-day (latent)this <part-of-day>", -6.495265555937008),
                                    ("Pentecostyear (latent)", -6.495265555937008),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.24250258744164),
                                    ("<day-of-month> (ordinal)February", -6.495265555937008),
                                    ("Eid al-Fitryear (latent)", -5.1089711948171175),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.495265555937008),
                                    ("Mondayin|during the <part-of-day>", -6.495265555937008),
                                    ("Chhathin|during <named-month>|year", -6.495265555937008),
                                    ("Diwaliin|during <named-month>|year", -6.495265555937008),
                                    ("this <part-of-day><time-of-day> am|pm", -6.495265555937008),
                                    ("Vaisakhiin|during <named-month>|year", -6.495265555937008),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.24250258744164),
                                    ("Raksha Bandhanyear (latent)", -6.495265555937008),
                                    ("daysecond", -6.089800447828844),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.089800447828844),
                                    ("Ratha-Yatrayear (latent)", -6.495265555937008),
                                    ("Ashurayear (latent)", -6.495265555937008),
                                    ("Tuesdayin|during <named-month>|year", -6.495265555937008),
                                    ("Chinese New Yearyear (latent)", -6.495265555937008),
                                    ("tomorrowintersect", -6.495265555937008),
                                    ("Lag BaOmeryear (latent)", -6.495265555937008),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.495265555937008),
                                    ("Eid al-Adhayear (latent)", -4.3551993924407375),
                                    ("intersectin|during the <part-of-day>", -6.495265555937008),
                                    ("Palm Sundayyear (latent)", -6.495265555937008),
                                    ("Christmasat <time-of-day>", -6.495265555937008),
                                    ("Passoveryear (latent)", -6.495265555937008),
                                    ("Lazarus Saturdayyear (latent)", -6.495265555937008),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.089800447828844),
                                    ("hhhmmon <day>", -5.578974824062853),
                                    ("Yom HaShoahyear (latent)", -6.089800447828844),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.089800447828844),
                                    ("Septemberyear (latent)", -6.089800447828844),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.9911881591607345),
                                    ("Halloweenyear (latent)", -6.495265555937008),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.495265555937008),
                                    ("at <time-of-day>intersect", -5.578974824062853),
                                    ("Rosh Hashanahyear (latent)", -5.802118375377063),
                                    ("Dhanterasyear (latent)", -6.495265555937008),
                                    ("Tu BiShvatyear (latent)", -6.495265555937008),
                                    ("<day-of-month> (ordinal)December", -5.802118375377063),
                                    ("Holiyear (latent)", -5.802118375377063),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.495265555937008),
                                    ("Holika Dahanyear (latent)", -5.802118375377063),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.089800447828844),
                                    ("dayminute", -3.110875292591234),
                                    ("Mawlidyear (latent)", -6.495265555937008),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.089800447828844),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.495265555937008),
                                    ("Jumu'atul-Widayear (latent)", -5.578974824062853),
                                    ("minuteday", -2.745761480006637),
                                    ("absorption of , after named dayintersect",
                                     -5.802118375377063),
                                    ("intersectyear (latent)", -6.089800447828844),
                                    ("Orthodox Easter Sundayyear (latent)", -6.495265555937008),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.495265555937008),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.495265555937008),
                                    ("intersecthhhmm", -6.089800447828844),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.495265555937008),
                                    ("Boss's Dayyear (latent)", -6.089800447828844),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.495265555937008),
                                    ("Global Youth Service Dayyear (latent)", -6.495265555937008),
                                    ("Dhanterasin|during <named-month>|year", -6.495265555937008),
                                    ("tonight<time-of-day> o'clock", -6.495265555937008),
                                    ("Tisha B'Avyear (latent)", -6.495265555937008),
                                    ("Isra and Mi'rajyear (latent)", -5.578974824062853),
                                    ("at <time-of-day>on <day>", -4.885827643502908),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.089800447828844),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.802118375377063),
                                    ("Christmasyear (latent)", -6.089800447828844),
                                    ("Saturdayintersect", -6.495265555937008),
                                    ("Naraka Chaturdashiyear (latent)", -6.089800447828844),
                                    ("Thai Pongalin|during <named-month>|year", -6.495265555937008),
                                    ("dayweek", -6.495265555937008),
                                    ("Easter Sundayyear (latent)", -5.802118375377063),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.089800447828844),
                                    ("weekyear", -5.396653267268898),
                                    ("King's Dayyear (latent)", -4.9911881591607345),
                                    ("hh:mmin|during the <part-of-day>", -5.578974824062853),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.089800447828844),
                                    ("Hanukkahyear (latent)", -5.802118375377063),
                                    ("Rama Navamiyear (latent)", -6.495265555937008),
                                    ("February<time> <part-of-day>", -6.495265555937008),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.802118375377063),
                                    ("Great Lentyear (latent)", -6.495265555937008),
                                    ("tomorrowat <time-of-day>", -5.802118375377063),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.495265555937008),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.089800447828844),
                                    ("Ugadiyear (latent)", -5.1089711948171175),
                                    ("Vaisakhiyear (latent)", -5.802118375377063),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.802118375377063),
                                    ("last <cycle> of <time>year (latent)", -5.802118375377063),
                                    ("at <time-of-day>tomorrow", -6.089800447828844),
                                    ("tomorrow<time-of-day> am|pm", -6.495265555937008),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.495265555937008),
                                    ("Diwaliyear (latent)", -6.495265555937008),
                                    ("between <time> and <time>on <day>", -6.089800447828844),
                                    ("Black Fridayyear (latent)", -6.089800447828844),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.495265555937008),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.495265555937008),
                                    ("Chhathyear (latent)", -6.089800447828844),
                                    ("Vasant Panchamiyear (latent)", -6.495265555937008),
                                    ("Rabindra Jayantiyear (latent)", -5.24250258744164),
                                    ("this <part-of-day>at <time-of-day>", -5.24250258744164),
                                    ("St Patrick's Dayyear (latent)", -6.495265555937008),
                                    ("Thursday<time> (timezone)", -6.495265555937008),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.495265555937008),
                                    ("Pargat Diwasyear (latent)", -5.24250258744164),
                                    ("<datetime> - <datetime> (interval)July", -6.089800447828844),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.802118375377063),
                                    ("Februaryintersect", -6.495265555937008),
                                    ("Simchat Torahyear (latent)", -6.495265555937008),
                                    ("minuteyear", -6.495265555937008)],
                               n = 510},
                   koData =
                     ClassData{prior = -0.9473813189441862, unseen = -6.85751406254539,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.659237407258367),
                                    ("hourday", -3.5606251185902575),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.163314804034641),
                                    ("<day-of-month> (ordinal)August", -6.163314804034641),
                                    ("dayhour", -3.4224747801094404),
                                    ("<time> timezoneyear (latent)", -5.470167623474696),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.247024072160486),
                                    ("Tuesdayfrom|since|after <time>", -5.470167623474696),
                                    ("daymonth", -3.455264602932431),
                                    ("hourquarter", -5.247024072160486),
                                    ("monthyear", -4.910551835539273),
                                    ("<time-of-day> am|pmyear (latent)", -5.470167623474696),
                                    ("Thai Pongalyear (latent)", -5.470167623474696),
                                    ("intersecthh:mm", -6.163314804034641),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.757849695926477),
                                    ("<day-of-month> (ordinal)Wednesday", -6.163314804034641),
                                    ("houryear", -4.371555334806586),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.163314804034641),
                                    ("<day-of-month> (ordinal)October", -6.163314804034641),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.470167623474696),
                                    ("hournograin", -4.910551835539273),
                                    ("<time-of-day> am|pmintersect", -4.910551835539273),
                                    ("Octoberyear (latent)", -6.163314804034641),
                                    ("Good Fridayyear (latent)", -5.757849695926477),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.757849695926477),
                                    ("early morningat <time-of-day>", -6.163314804034641),
                                    ("until <time>on <day>", -5.470167623474696),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.163314804034641),
                                    ("time-of-day (latent)intersect", -5.470167623474696),
                                    ("todayin <number> (implicit minutes)", -6.163314804034641),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.470167623474696),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.163314804034641),
                                    ("hh:mmon <day>", -4.910551835539273),
                                    ("hhhmmintersect", -5.757849695926477),
                                    ("absorption of , after named dayJuly", -5.247024072160486),
                                    ("from|since|after <time>July", -5.757849695926477),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.247024072160486),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.757849695926477),
                                    ("hourmonth", -4.0232486405383705),
                                    ("todayat <time-of-day>", -6.163314804034641),
                                    ("hhhmmyear (latent)", -4.910551835539273),
                                    ("from|since|after <time>December", -6.163314804034641),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.163314804034641),
                                    ("<time-of-day> am|pmon <day>", -4.910551835539273),
                                    ("Mondayyear (latent)", -5.470167623474696),
                                    ("dayday", -4.148411783492376),
                                    ("mm/ddat <time-of-day>", -5.247024072160486),
                                    ("on <day>September", -5.470167623474696),
                                    ("time-of-day (latent)September", -5.757849695926477),
                                    ("hourhour", -4.083873262354805),
                                    ("time-of-day (latent)on <day>", -4.659237407258367),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.757849695926477),
                                    ("dayyear", -3.1187923663112183),
                                    ("Thursdaymm/dd", -6.163314804034641),
                                    ("New Year's Dayyear (latent)", -5.247024072160486),
                                    ("time-of-day (latent)Sunday", -5.757849695926477),
                                    ("Thursdayfrom|since|after <time>", -4.458566711796216),
                                    ("Thursdayat <time-of-day>", -4.553876891600541),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.163314804034641),
                                    ("Aprilyear (latent)", -6.163314804034641),
                                    ("the <day-of-month> (ordinal)July", -6.163314804034641),
                                    ("the <day-of-month> (number)July", -6.163314804034641),
                                    ("monthminute", -6.163314804034641),
                                    ("<time-of-day> am|pmtomorrow", -5.757849695926477),
                                    ("Thursdayhh:mm", -5.247024072160486),
                                    ("<day-of-month> (ordinal)Tuesday", -5.757849695926477),
                                    ("minutemonth", -4.0232486405383705),
                                    ("time-of-day (latent)Friday", -5.757849695926477),
                                    ("minutehour", -6.163314804034641),
                                    ("part of daysat <time-of-day>", -5.064702515366531),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.8119395468711637),
                                    ("Augustyear (latent)", -5.757849695926477),
                                    ("week-endin|during <named-month>|year", -6.163314804034641),
                                    ("time-of-day (latent)Tuesday", -5.757849695926477),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.163314804034641),
                                    ("Sundayyear (latent)", -5.247024072160486),
                                    ("hourweek", -5.247024072160486),
                                    ("the <day-of-month> (ordinal)Monday", -5.470167623474696),
                                    ("Christmasat <time-of-day>", -6.163314804034641),
                                    ("from|since|after <time>year (latent)", -5.064702515366531),
                                    ("hhhmmon <day>", -5.247024072160486),
                                    ("yesterday<time-of-day> am|pm", -6.163314804034641),
                                    ("<day-of-month> (ordinal)July", -5.470167623474696),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.163314804034641),
                                    ("mm/ddyear (latent)", -6.163314804034641),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.163314804034641),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.163314804034641),
                                    ("at <time-of-day>intersect", -5.247024072160486),
                                    ("hh:mmyear (latent)", -4.7770204429147505),
                                    ("Holiyear (latent)", -6.163314804034641),
                                    ("until <time><time-of-day> am|pm", -6.163314804034641),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.757849695926477),
                                    ("dayminute", -3.301113923105173),
                                    ("yyyy-mm-ddhh:mm", -5.757849695926477),
                                    ("intersectfrom|since|after <time>", -5.757849695926477),
                                    ("intersectSeptember", -4.2915126271330495),
                                    ("minuteday", -3.006314382884528),
                                    ("absorption of , after named dayintersect",
                                     -6.163314804034641),
                                    ("intersectyear (latent)", -6.163314804034641),
                                    ("Februaryin|during the <part-of-day>", -6.163314804034641),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.163314804034641),
                                    ("time-of-day (latent)July", -5.470167623474696),
                                    ("Saturdayyear (latent)", -6.163314804034641),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.163314804034641),
                                    ("<day-of-month> (ordinal)Monday", -5.247024072160486),
                                    ...
                                    ("from|since|after <time>on <day>", -5.247024072160486),
                                    ("dayweek", -6.163314804034641),
                                    ("Easter Sundayyear (latent)", -5.757849695926477),
                                    ("Thursday<time-of-day> am|pm", -4.910551835539273),
                                    ("weekyear", -5.757849695926477),
                                    ("time-of-day (latent)Thursday", -5.757849695926477),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.163314804034641),
                                    ("<day-of-month> (ordinal)April", -6.163314804034641),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.757849695926477),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.470167623474696),
                                    ("Sundayfrom|since|after <time>", -6.163314804034641),
                                    ("absorption of , after named dayFebruary", -5.247024072160486),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.757849695926477),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.163314804034641),
                                    ("tomorrowat <time-of-day>", -6.163314804034641),
                                    ("daynograin", -5.757849695926477),
                                    ("Fridayin|during <named-month>|year", -6.163314804034641),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.757849695926477),
                                    ("last <cycle> of <time>year (latent)", -5.757849695926477),
                                    ("tomorrow<time-of-day> am|pm", -6.163314804034641),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.470167623474696),
                                    ("Diwaliyear (latent)", -5.757849695926477),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.163314804034641),
                                    ("this <part-of-day>at <time-of-day>", -5.247024072160486),
                                    ("Fridayyear (latent)", -5.247024072160486),
                                    ("time-of-day (latent)April", -6.163314804034641),
                                    ("minuteyear", -3.9660902266984217)],
                               n = 323}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.42845462633286313,
                               ...
                               n = 86},
                   koData =
                     ClassData{prior = -1.0541605260972757, unseen = -4.653960350157523,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.7086513670959105, unseen = -4.882801922586371,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.11302338840339538),
                                    ("integer (0..19)", -2.3902906734131513),
                                    ("about|exactly <numeral>", -4.182050142641207)],
                               n = 128},
                   koData =
                     ClassData{prior = -0.6778797084291569, unseen = -4.912654885736052,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.16034265007517937),
                                    ("integer (0..19)", -1.960835799271989)],
                               n = 132}}),
       ("beginning of year",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.791759469228055,
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.25751119481841755,
                               unseen = -5.723585101952381,
                               likelihoods =
                                 HashMap.fromList
                                   [("from|since|after <time>", -3.7744016275520984),
                                    ("integer after|past <hour-of-day>", -4.334017415487521),
                                    ("at <time-of-day>", -2.3530159466209377),
                                    ("<time-of-day> o'clock", -4.621699487939302),
                                    ("half after|past <hour-of-day>", -4.621699487939302),
                                    ("second", -5.0271645960474665),
                                    ("hh:mm:ss", -5.0271645960474665),
                                    ("<hour-of-day> <integer>", -4.110873864173311),
                                    ("<integer> minutes to|till|before <hour-of-day>",
                                     -5.0271645960474665),
                                    ("time-of-day (latent)", -1.6949600858722624),
                                    ("hhmm (latent)", -5.0271645960474665),
                                    ("hh:mm", -2.3881072664322076),
                                    ("quarter after|past <hour-of-day>", -3.5230871992711923),
                                    ("until <time>", -4.334017415487521),
                                    ("about|exactly <time-of-day>", -5.0271645960474665),
                                    ("hour", -1.242974962129205),
                                    ("<time-of-day> sharp|exactly", -5.0271645960474665),
                                    ("minute", -1.6949600858722624)],
                               n = 143},
                   koData =
                     ClassData{prior = -1.4826862067949564,
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.5634693572514127, unseen = -5.389071729816501,
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                     -4.6913478822291435),
                                    ("dayhour", -4.285882774120979),
                                    ("daymonth", -2.0886581967847597),
                                    ("<named-month> <day-of-month> (non ordinal)Friday",
                                     -4.6913478822291435),
                                    ("Friday<named-month> <day-of-month> (non ordinal)",
                                     -3.438584913733776),
                                    ("Wednesdayintersect", -4.6913478822291435),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -3.305053521109253),
                                    ("Black Fridaythis|last|next <cycle>", -4.6913478822291435),
                                    ("<part-of-day> of <time>February", -4.6913478822291435),
                                    ("Saturday<time-of-day> am|pm", -4.6913478822291435),
                                    ("Martin Luther King's Daythis|last|next <cycle>",
                                     -4.285882774120979),
                                    ("hourmonth", -4.6913478822291435),
                                    ("Fridayintersect by \",\", \"of\", \"from\" for year",
                                     -3.9982007016691985),
                                    ("dayday", -2.4400560836226486),
                                    ("the <day-of-month> (ordinal)February", -4.285882774120979),
                                    ("WednesdayOctober", -4.6913478822291435),
                                    ("Wednesdaythis|last|next <cycle>", -4.285882774120979),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.438584913733776),
                                    ("dayyear", -3.775057150354989),
                                    ("Saturday<named-month> <day-of-month> (non ordinal)",
                                     -4.6913478822291435),
                                    ("Thursdayhh:mm", -4.285882774120979),
                                    ("Thanksgiving Daythis|last|next <cycle>", -4.6913478822291435),
                                    ("TuesdayOctober", -4.6913478822291435),
                                    ("the <day-of-month> (ordinal)March", -3.592735593561034),
                                    ("Mondaythis|last|next <cycle>", -3.9982007016691985),
                                    ("Fridayintersect", -3.9982007016691985),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.285882774120979),
                                    ("intersectOctober", -4.285882774120979),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.775057150354989),
                                    ("Tuesdaythis|last|next <cycle>", -4.6913478822291435),
                                    ("Sunday<named-month> <day-of-month> (non ordinal)",
                                     -4.6913478822291435),
                                    ("dayminute", -2.8995884130010885),
                                    ("minuteday", -3.438584913733776),
                                    ("this|last|next <cycle>Sunday", -4.6913478822291435),
                                    ("Sundaythis|last|next <cycle>", -4.6913478822291435),
                                    ("on <day><time-of-day> am|pm", -4.6913478822291435),
                                    ("intersectintersect", -4.6913478822291435),
                                    ("weekday", -4.6913478822291435),
                                    ("dayweek", -3.592735593561034),
                                    ("Monday<named-month> <day-of-month> (non ordinal)",
                                     -4.285882774120979),
                                    ("<datetime> - <datetime> (interval)July", -3.775057150354989),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -3.9982007016691985)],
                               n = 74},
                   koData =
                     ClassData{prior = -0.8421827597204331, unseen = -5.209486152841421,
                               likelihoods =
                                 HashMap.fromList
                                   [("week-endJuly", -4.51085950651685),
                                    ("week-endOctober", -3.817712325956905),
                                    ("daymonth", -1.80280930541464),
                                    ("TuesdaySeptember", -4.51085950651685),
                                    ("Wednesdayintersect", -4.51085950651685),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -3.41224721784874),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -4.51085950651685),
                                    ("hournograin", -4.105394398408686),
                                    ("from|since|after <time>July", -4.105394398408686),
                                    ("hourmonth", -2.5649493574615367),
                                    ("Fridaythis|last|next <cycle>", -4.51085950651685),
                                    ("SundayFebruary", -4.51085950651685),
                                    ("on <day>September", -3.817712325956905),
                                    ("WednesdayOctober", -4.51085950651685),
                                    ("intersectnow", -4.105394398408686),
                                    ("week-endintersect", -4.51085950651685),
                                    ("dayyear", -4.51085950651685),
                                    ("FridayJuly", -3.594568774642695),
                                    ("FridaySeptember", -4.105394398408686),
                                    ("the <day-of-month> (ordinal)July", -3.594568774642695),
                                    ("WednesdayFebruary", -4.51085950651685),
                                    ("minutemonth", -3.006782109740576),
                                    ("SundayMarch", -4.51085950651685),
                                    ("MondayFebruary", -4.105394398408686),
                                    ("Fridayintersect", -4.51085950651685),
                                    ("intersectOctober", -4.51085950651685),
                                    ("dayminute", -4.51085950651685),
                                    ("SaturdaySeptember", -4.51085950651685),
                                    ("intersectSeptember", -3.1245651453969594),
                                    ("Tuesdaynow", -4.105394398408686),
                                    ("MondayMarch", -4.51085950651685),
                                    ("FridayOctober", -4.51085950651685),
                                    ("daynograin", -4.105394398408686),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -4.51085950651685),
                                    ("Tuesdayintersect", -4.51085950651685),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -4.51085950651685),
                                    ("<datetime> - <datetime> (interval)July", -4.51085950651685),
                                    ("Sundayintersect", -4.51085950651685)],
                               n = 56}}),
       ("last <time>",
        Classifier{okData =
                     ClassData{prior = -0.6931471805599453,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.40546510810816444),
                                    ("<numeral> - <numeral>", -1.0986122886681098)],
                               n = 4}}),
       ("Shushan Purim",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.0986122886681098,
