...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5838105165224797, unseen = -6.045005314036012,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 420},
                   koData =
                     ClassData{prior = -0.8159227378194498, unseen = -5.814130531825066,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4759116503691604, unseen = -7.05617528410041,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.362165662779806),
                                    ("Karva Chauthyear (latent)", -6.362165662779806),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.362165662779806),
                                    ...
                                    ("hhhmmabsorption of , after named day", -6.362165662779806),
                                    ...
                                    ("Krishna Janmashtamiyear (latent)", -5.9567005546716425),
                                    ...
                                    ("todayin|within|after <duration>", -6.362165662779806),
                                    ...
                                    ("hhhmmintersect", -5.9567005546716425),
                                    ...
                                    ("Thursday<time> timezone", -3.964270389981436),
                                    ...
                                    ("Mahavir Jayantiyear (latent)", -5.9567005546716425),
                                    ...
                                    ("last weekend of <named-month>year (latent)",
                                     -6.362165662779806),
                                    ("Eid al-Adhayear (latent)", -4.2220994992835355),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.362165662779806),
                                    ("at <time-of-day>intersect", -5.445874930905651),
                                    ...
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.362165662779806),
                                    ("intersecthhhmm", -5.9567005546716425),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.362165662779806),
                                    ...
                                    ("at <time-of-day>on <day>", -4.752727750345706),
                                    ...
                                    ("hh:mmin|during the <part-of-day>", -5.445874930905651),
                                    ...
                                    ("between <time> and <time>on <day>", -5.9567005546716425),
                               ...
                               n = 443},
                   koData =
                     ClassData{prior = -0.9710594614159213, unseen = -6.70196036600254,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.503506532211591),
                                    ("hourday", -3.6096886561894945),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.007583928987866),
                                    ("<day-of-month> (ordinal)August", -6.007583928987866),
                                    ("dayhour", -3.4426345715263285),
                                    ("<time> timezoneyear (latent)", -5.31443674842792),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.0912931971137105),
                                    ("Tuesdayfrom|since|after <time>", -5.31443674842792),
                                    ("daymonth", -3.3334352795613365),
                                    ("monthyear", -4.754820960492498),
                                    ("<time-of-day> am|pmyear (latent)", -5.31443674842792),
                                    ("Thai Pongalyear (latent)", -5.31443674842792),
                                    ("intersecthh:mm", -6.007583928987866),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.602118820879701),
                                    ("<day-of-month> (ordinal)Wednesday", -6.007583928987866),
                                    ("houryear", -4.621289567867975),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.007583928987866),
                                    ("<day-of-month> (ordinal)October", -6.007583928987866),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.31443674842792),
                                    ("hournograin", -4.754820960492498),
                                    ("<time-of-day> am|pmintersect", -4.754820960492498),
                                    ("Octoberyear (latent)", -6.007583928987866),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.602118820879701),
                                    ("until <time>on <day>", -5.31443674842792),
                                    ("time-of-day (latent)intersect", -5.31443674842792),
                                    ("todayin <number> (implicit minutes)", -6.007583928987866),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.31443674842792),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.007583928987866),
                                    ("hh:mmon <day>", -4.754820960492498),
                                    ("hhhmmintersect", -5.602118820879701),
                                    ("absorption of , after named dayJuly", -5.0912931971137105),
                                    ("from|since|after <time>July", -5.602118820879701),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.0912931971137105),
                                    ("Clean Mondayyear (latent)", -6.007583928987866),
                                    ("monthhour", -6.007583928987866),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.602118820879701),
                                    ("hourmonth", -4.135781752086274),
                                    ("todayat <time-of-day>", -6.007583928987866),
                                    ("hhhmmyear (latent)", -4.754820960492498),
                                    ("from|since|after <time>December", -6.007583928987866),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.007583928987866),
                                    ("<time-of-day> am|pmon <day>", -4.754820960492498),
                                    ("Mondayyear (latent)", -5.31443674842792),
                                    ("dayday", -4.621289567867975),
                                    ("on <day>September", -5.31443674842792),
                                    ("time-of-day (latent)September", -5.602118820879701),
                                    ("hourhour", -5.602118820879701),
                                    ("time-of-day (latent)on <day>", -4.503506532211591),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.602118820879701),
                                    ("dayyear", -3.0898131969035862),
                                    ("Thursdaymm/dd", -6.007583928987866),
                                    ("New Year's Dayyear (latent)", -5.0912931971137105),
                                    ("time-of-day (latent)Sunday", -5.602118820879701),
                                    ("Thursdayfrom|since|after <time>", -4.30283583674944),
                                    ("Thursdayat <time-of-day>", -4.398146016553765),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.007583928987866),
                                    ("Aprilyear (latent)", -6.007583928987866),
                                    ("the <day-of-month> (ordinal)July", -6.007583928987866),
                                    ("the <day-of-month> (number)July", -6.007583928987866),
                                    ("monthminute", -6.007583928987866),
                                    ("<time-of-day> am|pmtomorrow", -6.007583928987866),
                                    ("Thursdayhh:mm", -5.0912931971137105),
                                    ("<day-of-month> (ordinal)Tuesday", -5.602118820879701),
                                    ("minutemonth", -3.8675177654915944),
                                    ("time-of-day (latent)Friday", -5.602118820879701),
                                    ("minutehour", -6.007583928987866),
                                    ("Augustyear (latent)", -5.602118820879701),
                                    ("week-endin|during <named-month>|year", -6.007583928987866),
                                    ("time-of-day (latent)Tuesday", -5.602118820879701),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.007583928987866),
                                    ("Sundayyear (latent)", -5.0912931971137105),
                                    ("Christmasat <time-of-day>", -6.007583928987866),
                                    ("from|since|after <time>year (latent)", -4.908971640319756),
                                    ("hhhmmon <day>", -5.0912931971137105),
                                    ("yesterday<time-of-day> am|pm", -6.007583928987866),
                                    ("<day-of-month> (ordinal)July", -5.31443674842792),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.007583928987866),
                                    ("at <time-of-day>intersect", -5.0912931971137105),
                                    ("hh:mmyear (latent)", -4.621289567867975),
                                    ("Holiyear (latent)", -6.007583928987866),
                                    ("until <time><time-of-day> am|pm", -6.007583928987866),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.602118820879701),
                                    ("dayminute", -3.174370584931649),
                                    ("yyyy-mm-ddhh:mm", -5.602118820879701),
                                    ("intersectfrom|since|after <time>", -5.602118820879701),
                                    ("intersectSeptember", -4.135781752086274),
                                    ("minuteday", -2.850583507837752),
                                    ("absorption of , after named dayintersect",
                                     -6.007583928987866),
                                    ("intersectyear (latent)", -6.007583928987866),
                                    ("Februaryin|during the <part-of-day>", -6.007583928987866),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.007583928987866),
                                    ("time-of-day (latent)July", -5.31443674842792),
                                    ("Saturdayyear (latent)", -6.007583928987866),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.007583928987866),
                                    ("at <time-of-day>on <day>", -5.0912931971137105),
                                    ("absorption of , after named daySeptember",
                                     -4.754820960492498),
                                    ("Naraka Chaturdashiyear (latent)", -6.007583928987866),
                                    ("from|since|after <time>on <day>", -5.0912931971137105),
                                    ("dayweek", -6.007583928987866),
                                    ("Easter Sundayyear (latent)", -5.602118820879701),
                                    ("Thursday<time-of-day> am|pm", -4.754820960492498),
                                    ("weekyear", -5.602118820879701),
                                    ("time-of-day (latent)Thursday", -5.602118820879701),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.007583928987866),
                                    ("<day-of-month> (ordinal)April", -6.007583928987866),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.602118820879701),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.31443674842792),
                                    ("Sundayfrom|since|after <time>", -6.007583928987866),
                                    ...
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.007583928987866),
                                    ("tomorrowat <time-of-day>", -6.007583928987866),
                                    ("daynograin", -5.602118820879701),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.602118820879701),
                                    ("last <cycle> of <time>year (latent)", -5.602118820879701),
                                    ("tomorrow<time-of-day> am|pm", -6.007583928987866),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.31443674842792),
                                    ("Diwaliyear (latent)", -5.602118820879701),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.007583928987866),
                                    ("Fridayyear (latent)", -5.602118820879701),
                                    ("time-of-day (latent)April", -6.007583928987866),
                                    ("minuteyear", -3.810359351651646)],
                               n = 270}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.16382697415779024,
                               ...
                               n = 191},
                   koData =
                     ClassData{prior = -1.8897398775882588,
                               unseen = -3.6635616461296463,
                               likelihoods =
                                 HashMap.fromList
