...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6171612735820232, unseen = -5.916202062607435,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 369},
                   koData =
                     ClassData{prior = -0.7753852787969174, unseen = -5.75890177387728,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4893086565413572, unseen = -6.966024187106113,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.271933165041461),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.271933165041461),
                                    ("Ramadanyear (latent)", -5.355642433167306),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.257030144499196),
                                    ("Bhai Doojyear (latent)", -6.271933165041461),
                                    ("hourday", -4.257030144499196),
                                    ("dayhour", -3.354162432957182),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.257030144499196),
                                    ("Martin Luther King's Dayyear (latent)", -5.8664680569332965),
                                    ("Shemini Atzeretyear (latent)", -6.271933165041461),
                                    ("daymonth", -4.257030144499196),
                                    ("monthday", -5.8664680569332965),
                                    ("monthyear", -4.480173695813406),
                                    ("Yom Ha'atzmautyear (latent)", -6.271933165041461),
                                    ("Vijayadashamiyear (latent)", -6.271933165041461),
                                    ("Thai Pongalyear (latent)", -5.578785984481516),
                                    ("Thiru Onamyear (latent)", -5.578785984481516),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.271933165041461),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.355642433167306),
                                    ("<day-of-month> (ordinal)Wednesday", -6.271933165041461),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.271933165041461),
                                    ("houryear", -5.355642433167306),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.271933165041461),
                                    ("Christmas<time-of-day> am|pm", -6.271933165041461),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.271933165041461),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.578785984481516),
                                    ("intersectin|during <named-month>|year", -6.271933165041461),
                                    ("<time-of-day> am|pmintersect", -5.019170196546093),
                                    ("Earth Houryear (latent)", -6.271933165041461),
                                    ("Octoberyear (latent)", -4.767855768265187),
                                    ("intersect<time-of-day> am|pm", -6.271933165041461),
                                    ("Mattu Pongalyear (latent)", -6.271933165041461),
                                    ("Shavuotyear (latent)", -6.271933165041461),
                                    ("Parsi New Yearyear (latent)", -5.355642433167306),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.271933165041461),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.271933165041461),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.8664680569332965),
                                    ("Marchyear (latent)", -6.271933165041461),
                                    ("Sukkotyear (latent)", -5.8664680569332965),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.578785984481516),
                                    ("todayat <time-of-day>", -6.271933165041461),
                                    ("Thursday<time> timezone", -4.326023015986148),
                                    ("time-of-day (latent)tonight", -5.8664680569332965),
                                    ("from|since|after <time>December", -6.271933165041461),
                                    ("<time-of-day> am|pmon <day>", -4.257030144499196),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.271933165041461),
                                    ("yyyy-mm-ddhh:mm:ss", -5.8664680569332965),
                                    ("dayday", -3.829586129672257),
                                    ("<time> <part-of-day>at <time-of-day>", -6.271933165041461),
                                    ("tonightat <time-of-day>", -6.271933165041461),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.578785984481516),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.271933165041461),
                                    ("today<time-of-day> am|pm", -6.271933165041461),
                                    ("Februarythe <day-of-month> (ordinal)", -5.8664680569332965),
                                    ("at <time-of-day><time> <part-of-day>", -6.271933165041461),
                                    ("<day-of-month> (ordinal)intersect", -5.8664680569332965),
                                    ("hourhour", -4.192491623361625),
                                    ("Navaratriin|during <named-month>|year", -6.271933165041461),
                                    ("Wednesdaythis|last|next <cycle>", -6.271933165041461),
                                    ("Lentyear (latent)", -6.271933165041461),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.767855768265187),
                                    ("Boghiyear (latent)", -6.271933165041461),
                                    ("dayyear", -1.98147372389307),
                                    ("Thursdayfrom|since|after <time>", -5.8664680569332965),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.271933165041461),
                                    ("Thursdayat <time-of-day>", -5.578785984481516),
                                    ("Islamic New Yearyear (latent)", -5.8664680569332965),
                                    ("Laylat al-Qadryear (latent)", -5.355642433167306),
                                    ("Shrove Tuesdayyear (latent)", -6.271933165041461),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.578785984481516),
                                    ("<time-of-day> am|pmtomorrow", -5.578785984481516),
                                    ("Yom Kippuryear (latent)", -6.271933165041461),
                                    ("<day-of-month> (ordinal)Tuesday", -5.8664680569332965),
                                    ("<part-of-day> of <time>year (latent)", -6.271933165041461),
                                    ("minutehour", -5.173320876373351),
                                    ("Kaanum Pongalyear (latent)", -5.8664680569332965),
                                    ("Maha Saptamiyear (latent)", -6.271933165041461),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.8664680569332965),
                                    ("time-of-day (latent)tomorrow", -5.355642433167306),
                                    ("part of daysat <time-of-day>", -5.8664680569332965),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.567185072803036),
                                    ("for <duration> from <time>December", -6.271933165041461),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.271933165041461),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.019170196546093),
                                    ("time-of-day (latent)this <part-of-day>", -6.271933165041461),
                                    ("Pentecostyear (latent)", -6.271933165041461),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.019170196546093),
                                    ("<day-of-month> (ordinal)February", -6.271933165041461),
                                    ("Eid al-Fitryear (latent)", -5.355642433167306),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.271933165041461),
                                    ("Mondayin|during the <part-of-day>", -6.271933165041461),
                                    ("Chhathin|during <named-month>|year", -6.271933165041461),
                                    ("Diwaliin|during <named-month>|year", -6.271933165041461),
                                    ("Vaisakhiin|during <named-month>|year", -6.271933165041461),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.019170196546093),
                                    ("Raksha Bandhanyear (latent)", -6.271933165041461),
                                    ("daysecond", -5.8664680569332965),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.8664680569332965),
                                    ("Ashurayear (latent)", -6.271933165041461),
                                    ("Tuesdayin|during <named-month>|year", -6.271933165041461),
                                    ("Chinese New Yearyear (latent)", -6.271933165041461),
                                    ("tomorrowintersect", -6.271933165041461),
                                    ("Lag BaOmeryear (latent)", -6.271933165041461),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.271933165041461),
                                    ("Eid al-Adhayear (latent)", -5.355642433167306),
                                    ("intersectin|during the <part-of-day>", -6.271933165041461),
                                    ("Palm Sundayyear (latent)", -6.271933165041461),
                                    ("Christmasat <time-of-day>", -6.271933165041461),
                                    ("Passoveryear (latent)", -6.271933165041461),
                                    ("Lazarus Saturdayyear (latent)", -6.271933165041461),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.271933165041461),
                                    ("Yom HaShoahyear (latent)", -5.8664680569332965),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.8664680569332965),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.271933165041461),
                                    ("Septemberyear (latent)", -5.8664680569332965),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.767855768265187),
                                    ("Halloweenyear (latent)", -6.271933165041461),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.271933165041461),
                                    ("at <time-of-day>intersect", -5.8664680569332965),
                                    ("Rosh Hashanahyear (latent)", -5.578785984481516),
                                    ("Dhanterasyear (latent)", -6.271933165041461),
                                    ("Tu BiShvatyear (latent)", -6.271933165041461),
                                    ("<day-of-month> (ordinal)December", -5.578785984481516),
                                    ("Holiyear (latent)", -5.578785984481516),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.271933165041461),
                                    ("Holika Dahanyear (latent)", -5.578785984481516),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.271933165041461),
                                    ("dayminute", -3.4097322841119926),
                                    ("Mawlidyear (latent)", -6.271933165041461),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.8664680569332965),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.271933165041461),
                                    ("Jumu'atul-Widayear (latent)", -5.355642433167306),
                                    ("minuteday", -2.443291768552366),
                                    ("absorption of , after named dayintersect",
                                     -6.271933165041461),
                                    ("intersectyear (latent)", -6.271933165041461),
                                    ("Orthodox Easter Sundayyear (latent)", -6.271933165041461),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.271933165041461),
                                    ("Boss's Dayyear (latent)", -5.8664680569332965),
                                    ("Global Youth Service Dayyear (latent)", -6.271933165041461),
                                    ("Dhanterasin|during <named-month>|year", -6.271933165041461),
                                    ("Tisha B'Avyear (latent)", -6.271933165041461),
                                    ("Isra and Mi'rajyear (latent)", -5.355642433167306),
                                    ("at <time-of-day>on <day>", -5.173320876373351),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.271933165041461),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.578785984481516),
                                    ("Christmasyear (latent)", -5.8664680569332965),
                                    ("Naraka Chaturdashiyear (latent)", -5.8664680569332965),
                                    ("Thai Pongalin|during <named-month>|year", -6.271933165041461),
                                    ("dayweek", -6.271933165041461),
                                    ("Easter Sundayyear (latent)", -5.578785984481516),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.662495252607361),
                                    ("weekyear", -5.173320876373351),
                                    ("King's Dayyear (latent)", -4.767855768265187),
                                    ("hh:mmin|during the <part-of-day>", -5.578785984481516),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.8664680569332965),
                                    ("Hanukkahyear (latent)", -5.578785984481516),
                                    ("February<time> <part-of-day>", -6.271933165041461),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.271933165041461),
                                    ("Great Lentyear (latent)", -6.271933165041461),
                                    ("tomorrowat <time-of-day>", -5.578785984481516),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.271933165041461),
                                    ("Vaisakhiyear (latent)", -5.578785984481516),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.271933165041461),
                                    ("last <cycle> of <time>year (latent)", -5.578785984481516),
                                    ("at <time-of-day>tomorrow", -5.8664680569332965),
                                    ("tomorrow<time-of-day> am|pm", -6.271933165041461),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.271933165041461),
                                    ("Diwaliyear (latent)", -6.271933165041461),
                                    ("between <time> and <time>on <day>", -4.662495252607361),
                                    ("Black Fridayyear (latent)", -5.8664680569332965),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.271933165041461),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.271933165041461),
                                    ("Chhathyear (latent)", -5.8664680569332965),
                                    ("Vasant Panchamiyear (latent)", -6.271933165041461),
                                    ("Rabindra Jayantiyear (latent)", -5.019170196546093),
                                    ("St Patrick's Dayyear (latent)", -6.271933165041461),
                                    ("Thursday<time> (timezone)", -6.271933165041461),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.271933165041461),
                                    ("<datetime> - <datetime> (interval)July", -5.8664680569332965),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.8664680569332965),
                                    ("Februaryintersect", -6.271933165041461),
                                    ("Simchat Torahyear (latent)", -6.271933165041461),
                                    ("minuteyear", -6.271933165041461)],
                               n = 404},
                   koData =
                     ClassData{prior = -0.949459989344081, unseen = -6.635946555686647,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.18134642263574838,
                               ...
                               n = 171},
                   koData =
                     ClassData{prior = -1.7966494545222467,
