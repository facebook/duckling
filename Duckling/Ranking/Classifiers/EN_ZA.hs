...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5740474890188151, unseen = -5.659482215759621,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 285},
                   koData =
                     ClassData{prior = -0.8283739677697127, unseen = -5.407171771460119,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47830243206043055,
                               unseen = -6.694562058521095,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.000176487710004),
                                    ("Ramadanyear (latent)", -6.000176487710004),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.747413519214636),
                                    ("Bhai Doojyear (latent)", -6.000176487710004),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.747413519214636),
                                    ("hourday", -4.295428395471578),
                                    ("dayhour", -3.1968161068034684),
                                    ("Martin Luther King's Dayyear (latent)", -5.594711379601839),
                                    ("Shemini Atzeretyear (latent)", -6.000176487710004),
                                    ("daymonth", -5.307029307150058),
                                    ("monthday", -5.594711379601839),
                                    ("monthyear", -4.208417018481948),
                                    ("Yom Ha'atzmautyear (latent)", -6.000176487710004),
                                    ("Vijayadashamiyear (latent)", -6.000176487710004),
                                    ("Thai Pongalyear (latent)", -5.307029307150058),
                                    ("Thiru Onamyear (latent)", -5.307029307150058),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.000176487710004),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.000176487710004),
                                    ("houryear", -5.307029307150058),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.000176487710004),
                                    ("Christmas<time-of-day> am|pm", -6.000176487710004),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.000176487710004),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.307029307150058),
                                    ("<time-of-day> am|pmintersect", -4.747413519214636),
                                    ("Earth Houryear (latent)", -6.000176487710004),
                                    ("Octoberyear (latent)", -4.496099090933729),
                                    ("intersect<time-of-day> am|pm", -6.000176487710004),
                                    ("Mattu Pongalyear (latent)", -6.000176487710004),
                                    ("Shavuotyear (latent)", -6.000176487710004),
                                    ("Dhanterasin <named-month>|year", -6.000176487710004),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.000176487710004),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.000176487710004),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.594711379601839),
                                    ("Marchyear (latent)", -6.000176487710004),
                                    ("Sukkotyear (latent)", -5.594711379601839),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.000176487710004),
                                    ("Clean Mondayyear (latent)", -5.594711379601839),
                                    ("monthhour", -5.594711379601839),
                                    ("todayat <time-of-day>", -6.000176487710004),
                                    ("Thursday<time> timezone", -4.295428395471578),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.000176487710004),
                                    ("Palm SundaySunday", -5.594711379601839),
                                    ("dayday", -3.802951910373784),
                                    ("<time> <part-of-day>at <time-of-day>", -6.000176487710004),
                                    ("tonightat <time-of-day>", -6.000176487710004),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.307029307150058),
                                    ("today<time-of-day> am|pm", -6.000176487710004),
                                    ("Februarythe <day-of-month> (ordinal)", -5.594711379601839),
                                    ("at <time-of-day><time> <part-of-day>", -6.000176487710004),
                                    ("hourhour", -4.747413519214636),
                                    ("<time-of-day> am|pmon <date>", -3.9852734671677386),
                                    ("Wednesdaythis|last|next <cycle>", -6.000176487710004),
                                    ("Lentyear (latent)", -6.000176487710004),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.496099090933729),
                                    ("Boghiyear (latent)", -6.000176487710004),
                                    ("dayyear", -2.048932769128576),
                                    ("Thursdayfrom|since|after <time>", -5.594711379601839),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.000176487710004),
                                    ("Thursdayat <time-of-day>", -5.594711379601839),
                                    ("Islamic New Yearyear (latent)", -5.594711379601839),
                                    ("Laylat al-Qadryear (latent)", -5.083885755835849),
                                    ("Chhathin <named-month>|year", -6.000176487710004),
                                    ("Vasant Panchamiin <named-month>|year", -6.000176487710004),
                                    ("Diwaliin <named-month>|year", -6.000176487710004),
                                    ("Shrove Tuesdayyear (latent)", -6.000176487710004),
                                    ("<time-of-day> am|pmtomorrow", -5.307029307150058),
                                    ("Yom Kippuryear (latent)", -6.000176487710004),
                                    ("<part-of-day> of <time>year (latent)", -6.000176487710004),
                                    ("minutehour", -5.083885755835849),
                                    ("Kaanum Pongalyear (latent)", -5.594711379601839),
                                    ("Maha Saptamiyear (latent)", -6.000176487710004),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.594711379601839),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.295428395471578),
                                    ("for <duration> from <time>December", -6.000176487710004),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.000176487710004),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.083885755835849),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.594711379601839),
                                    ("Pentecostyear (latent)", -6.000176487710004),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.083885755835849),
                                    ("Eid al-Fitryear (latent)", -6.000176487710004),
                                    ("Mondayin|during the <part-of-day>", -6.000176487710004),
                                    ("Raksha Bandhanyear (latent)", -6.000176487710004),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.594711379601839),
                                    ("Navaratriin <named-month>|year", -6.000176487710004),
                                    ("Ashurayear (latent)", -6.000176487710004),
                                    ("Chinese New Yearyear (latent)", -6.000176487710004),
                                    ("Sundayyear (latent)", -6.000176487710004),
                                    ("Lag BaOmeryear (latent)", -6.000176487710004),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.000176487710004),
                                    ("Eid al-Adhayear (latent)", -5.083885755835849),
                                    ("intersectin|during the <part-of-day>", -6.000176487710004),
                                    ("Christmasat <time-of-day>", -6.000176487710004),
                                    ("Passoveryear (latent)", -6.000176487710004),
                                    ("Lazarus Saturdayyear (latent)", -6.000176487710004),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.000176487710004),
                                    ("Yom HaShoahyear (latent)", -5.594711379601839),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.594711379601839),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.000176487710004),
                                    ("Thai Pongalin <named-month>|year", -6.000176487710004),
                                    ("Septemberyear (latent)", -5.594711379601839),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.747413519214636),
                                    ("Halloweenyear (latent)", -6.000176487710004),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -6.000176487710004),
                                    ("Dhanterasyear (latent)", -6.000176487710004),
                                    ("Tu BiShvatyear (latent)", -6.000176487710004),
                                    ("Holiyear (latent)", -5.307029307150058),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.000176487710004),
                                    ("Holika Dahanyear (latent)", -5.307029307150058),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.000176487710004),
                                    ("dayminute", -3.435227130248467),
                                    ("Mawlidyear (latent)", -6.000176487710004),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.594711379601839),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.000176487710004),
                                    ("Jumu'atul-Widayear (latent)", -5.083885755835849),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.000176487710004),
                                    ("minuteday", -2.362590327983618),
                                    ("absorption of , after named dayintersect",
                                     -6.000176487710004),
                                    ("intersectyear (latent)", -6.000176487710004),
                                    ("Orthodox Easter Sundayyear (latent)", -6.000176487710004),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.000176487710004),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.000176487710004),
                                    ("Boss's Dayyear (latent)", -5.594711379601839),
                                    ("Global Youth Service Dayyear (latent)", -6.000176487710004),
                                    ("Tisha B'Avyear (latent)", -6.000176487710004),
                                    ("Isra and Mi'rajyear (latent)", -5.083885755835849),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.000176487710004),
                                    ("Christmasyear (latent)", -5.594711379601839),
                                    ("Naraka Chaturdashiyear (latent)", -5.594711379601839),
                                    ("at <time-of-day>on <date>", -4.901564199041894),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.390738575275903),
                                    ("dayweek", -6.000176487710004),
                                    ("Easter Sundayyear (latent)", -5.307029307150058),
                                    ("weekyear", -4.901564199041894),
                                    ("hh:mmin|during the <part-of-day>", -5.307029307150058),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.594711379601839),
                                    ("Hanukkahyear (latent)", -6.000176487710004),
                                    ("February<time> <part-of-day>", -6.000176487710004),
                                    ("Tuesdayin <named-month>|year", -6.000176487710004),
                                    ("Great Lentyear (latent)", -6.000176487710004),
                                    ("tomorrowat <time-of-day>", -5.307029307150058),
                                    ("between <time> and <time>on <date>", -4.390738575275903),
                                    ("last <cycle> of <time>year (latent)", -5.307029307150058),
                                    ("at <time-of-day>tomorrow", -5.594711379601839),
                                    ("tomorrow<time-of-day> am|pm", -6.000176487710004),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.000176487710004),
                                    ("Diwaliyear (latent)", -6.000176487710004),
                                    ("Black Fridayyear (latent)", -5.594711379601839),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.000176487710004),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.000176487710004),
                                    ("Chhathyear (latent)", -5.594711379601839),
                                    ("Vasant Panchamiyear (latent)", -6.000176487710004),
                                    ("Palm Sundayintersect", -6.000176487710004),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.000176487710004),
                                    ("Februaryintersect", -6.000176487710004),
                                    ("Simchat Torahyear (latent)", -6.000176487710004),
                                    ("minuteyear", -6.000176487710004)],
                               n = 300},
                   koData =
                     ClassData{prior = -0.967149149107646, unseen = -6.3561076606958915,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.74493212836325),
                                    ...
                                    ("Thursdaymm/dd", -5.661222860237405),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.151916042025842, unseen = -4.890349128221754,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 128},
                   koData =
                     ClassData{prior = -1.9594238682220362, unseen = -3.258096538021482,
                               likelihoods =
                                 HashMap.fromList
