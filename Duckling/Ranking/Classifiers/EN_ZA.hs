...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5755841911141537, unseen = -5.655991810819852,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 284},
                   koData =
                     ClassData{prior = -0.8263957277576071, unseen = -5.407171771460119,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4795730802618862, unseen = -6.690842277418564,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -5.996452088619021),
                                    ("Ramadanyear (latent)", -5.996452088619021),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.743689120123653),
                                    ("Bhai Doojyear (latent)", -5.996452088619021),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.743689120123653),
                                    ("hourday", -4.291703996380596),
                                    ("dayhour", -3.1930917077124863),
                                    ("Martin Luther King's Dayyear (latent)", -5.5909869805108565),
                                    ("Shemini Atzeretyear (latent)", -5.996452088619021),
                                    ("daymonth", -5.303304908059076),
                                    ("monthday", -5.5909869805108565),
                                    ("monthyear", -4.204692619390966),
                                    ("Yom Ha'atzmautyear (latent)", -5.996452088619021),
                                    ("Vijayadashamiyear (latent)", -5.996452088619021),
                                    ("Thai Pongalyear (latent)", -5.303304908059076),
                                    ("Thiru Onamyear (latent)", -5.303304908059076),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.996452088619021),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.996452088619021),
                                    ("houryear", -5.303304908059076),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.996452088619021),
                                    ("Christmas<time-of-day> am|pm", -5.996452088619021),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.996452088619021),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.303304908059076),
                                    ("<time-of-day> am|pmintersect", -4.743689120123653),
                                    ("Octoberyear (latent)", -4.492374691842747),
                                    ("intersect<time-of-day> am|pm", -5.996452088619021),
                                    ("Mattu Pongalyear (latent)", -5.996452088619021),
                                    ("Shavuotyear (latent)", -5.996452088619021),
                                    ("Dhanterasin <named-month>|year", -5.996452088619021),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.996452088619021),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.996452088619021),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.5909869805108565),
                                    ("Marchyear (latent)", -5.996452088619021),
                                    ("Sukkotyear (latent)", -5.5909869805108565),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.996452088619021),
                                    ("Clean Mondayyear (latent)", -5.5909869805108565),
                                    ("monthhour", -5.5909869805108565),
                                    ("todayat <time-of-day>", -5.996452088619021),
                                    ("Thursday<time> timezone", -4.291703996380596),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.996452088619021),
                                    ("Palm SundaySunday", -5.5909869805108565),
                                    ("dayday", -3.7992275112828016),
                                    ("<time> <part-of-day>at <time-of-day>", -5.996452088619021),
                                    ("tonightat <time-of-day>", -5.996452088619021),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.303304908059076),
                                    ("today<time-of-day> am|pm", -5.996452088619021),
                                    ("Februarythe <day-of-month> (ordinal)", -5.5909869805108565),
                                    ("at <time-of-day><time> <part-of-day>", -5.996452088619021),
                                    ("hourhour", -4.743689120123653),
                                    ("<time-of-day> am|pmon <date>", -3.9815490680767565),
                                    ("Wednesdaythis|last|next <cycle>", -5.996452088619021),
                                    ("Lentyear (latent)", -5.996452088619021),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.492374691842747),
                                    ("Boghiyear (latent)", -5.996452088619021),
                                    ("dayyear", -2.0452083700375936),
                                    ("Thursdayfrom|since|after <time>", -5.5909869805108565),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.996452088619021),
                                    ("Thursdayat <time-of-day>", -5.5909869805108565),
                                    ("Islamic New Yearyear (latent)", -5.5909869805108565),
                                    ("Laylat al-Qadryear (latent)", -5.080161356744866),
                                    ("Chhathin <named-month>|year", -5.996452088619021),
                                    ("Vasant Panchamiin <named-month>|year", -5.996452088619021),
                                    ("Diwaliin <named-month>|year", -5.996452088619021),
                                    ("Shrove Tuesdayyear (latent)", -5.996452088619021),
                                    ("<time-of-day> am|pmtomorrow", -5.303304908059076),
                                    ("Yom Kippuryear (latent)", -5.996452088619021),
                                    ("<part-of-day> of <time>year (latent)", -5.996452088619021),
                                    ("minutehour", -5.080161356744866),
                                    ("Kaanum Pongalyear (latent)", -5.5909869805108565),
                                    ("Maha Saptamiyear (latent)", -5.996452088619021),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.5909869805108565),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.291703996380596),
                                    ("for <duration> from <time>December", -5.996452088619021),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.996452088619021),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.080161356744866),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.5909869805108565),
                                    ("Pentecostyear (latent)", -5.996452088619021),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.080161356744866),
                                    ("Eid al-Fitryear (latent)", -5.996452088619021),
                                    ("Mondayin|during the <part-of-day>", -5.996452088619021),
                                    ("Raksha Bandhanyear (latent)", -5.996452088619021),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.5909869805108565),
                                    ("Navaratriin <named-month>|year", -5.996452088619021),
                                    ("Ashurayear (latent)", -5.996452088619021),
                                    ("Chinese New Yearyear (latent)", -5.996452088619021),
                                    ("Sundayyear (latent)", -5.996452088619021),
                                    ("Lag BaOmeryear (latent)", -5.996452088619021),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.996452088619021),
                                    ("Eid al-Adhayear (latent)", -5.080161356744866),
                                    ("intersectin|during the <part-of-day>", -5.996452088619021),
                                    ("Christmasat <time-of-day>", -5.996452088619021),
                                    ("Passoveryear (latent)", -5.996452088619021),
                                    ("Lazarus Saturdayyear (latent)", -5.996452088619021),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.996452088619021),
                                    ("Yom HaShoahyear (latent)", -5.5909869805108565),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.5909869805108565),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.996452088619021),
                                    ("Thai Pongalin <named-month>|year", -5.996452088619021),
                                    ("Septemberyear (latent)", -5.5909869805108565),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.743689120123653),
                                    ("Halloweenyear (latent)", -5.996452088619021),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.996452088619021),
                                    ("Dhanterasyear (latent)", -5.996452088619021),
                                    ("Tu BiShvatyear (latent)", -5.996452088619021),
                                    ("Holiyear (latent)", -5.303304908059076),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.996452088619021),
                                    ("Holika Dahanyear (latent)", -5.303304908059076),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.996452088619021),
                                    ("dayminute", -3.4315027311574844),
                                    ("Mawlidyear (latent)", -5.996452088619021),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.5909869805108565),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.996452088619021),
                                    ("Jumu'atul-Widayear (latent)", -5.080161356744866),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.996452088619021),
                                    ("minuteday", -2.3588659288926355),
                                    ("absorption of , after named dayintersect",
                                     -5.996452088619021),
                                    ("intersectyear (latent)", -5.996452088619021),
                                    ("Orthodox Easter Sundayyear (latent)", -5.996452088619021),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.996452088619021),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.996452088619021),
                                    ("Boss's Dayyear (latent)", -5.5909869805108565),
                                    ("Global Youth Service Dayyear (latent)", -5.996452088619021),
                                    ("Tisha B'Avyear (latent)", -5.996452088619021),
                                    ("Isra and Mi'rajyear (latent)", -5.080161356744866),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.996452088619021),
                                    ("Christmasyear (latent)", -5.5909869805108565),
                                    ("Naraka Chaturdashiyear (latent)", -5.5909869805108565),
                                    ("at <time-of-day>on <date>", -4.897839799950911),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.387014176184921),
                                    ("dayweek", -5.996452088619021),
                                    ("Easter Sundayyear (latent)", -5.303304908059076),
                                    ("weekyear", -4.897839799950911),
                                    ("hh:mmin|during the <part-of-day>", -5.303304908059076),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.5909869805108565),
                                    ("Hanukkahyear (latent)", -5.996452088619021),
                                    ("February<time> <part-of-day>", -5.996452088619021),
                                    ("Tuesdayin <named-month>|year", -5.996452088619021),
                                    ("Great Lentyear (latent)", -5.996452088619021),
                                    ("tomorrowat <time-of-day>", -5.303304908059076),
                                    ("between <time> and <time>on <date>", -4.387014176184921),
                                    ("last <cycle> of <time>year (latent)", -5.303304908059076),
                                    ("at <time-of-day>tomorrow", -5.5909869805108565),
                                    ("tomorrow<time-of-day> am|pm", -5.996452088619021),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.996452088619021),
                                    ("Diwaliyear (latent)", -5.996452088619021),
                                    ("Black Fridayyear (latent)", -5.5909869805108565),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -5.996452088619021),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.996452088619021),
                                    ("Chhathyear (latent)", -5.5909869805108565),
                                    ("Vasant Panchamiyear (latent)", -5.996452088619021),
                                    ("Palm Sundayintersect", -5.996452088619021),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.996452088619021),
                                    ("Februaryintersect", -5.996452088619021),
                                    ("Simchat Torahyear (latent)", -5.996452088619021)],
                               n = 299},
                   koData =
                     ClassData{prior = -0.9650808960435872, unseen = -6.354370040797351,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.743191483885466),
                                    ("hourday", -4.743191483885466),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.659482215759621),
                                    ("dayhour", -3.2171351803904167),
                                    ("Tuesdayfrom|since|after <time>", -5.659482215759621),
                                    ("daymonth", -3.51941605226335),
                                    ("monthday", -5.254017107651457),
                                    ("monthyear", -4.406719247264253),
                                    ("<time-of-day> am|pmyear (latent)", -5.254017107651457),
                                    ("Thai Pongalyear (latent)", -4.966335035199676),
                                    ("intersecthh:mm", -5.659482215759621),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.659482215759621),
                                    ("houryear", -4.743191483885466),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.659482215759621),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.966335035199676),
                                    ("<time-of-day> am|pmintersect", -4.406719247264253),
                                    ("until <time>on <date>", -4.966335035199676),
                                    ("Octoberyear (latent)", -5.659482215759621),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.659482215759621),
                                    ("absorption of , after named dayJuly", -5.254017107651457),
                                    ("from|since|after <time>July", -5.659482215759621),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.743191483885466),
                                    ("Clean Mondayyear (latent)", -5.659482215759621),
                                    ("monthhour", -5.659482215759621),
                                    ("hourmonth", -4.743191483885466),
                                    ("todayat <time-of-day>", -5.659482215759621),
                                    ("from|since|after <time>December", -5.659482215759621),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.659482215759621),
                                    ("Mondayyear (latent)", -4.966335035199676),
                                    ("dayday", -5.254017107651457),
                                    ("<time-of-day> am|pmon <date>", -4.406719247264253),
                                    ("dayyear", -2.7150432365931807),
                                    ("Thursdaymm/dd", -5.659482215759621),
                                    ("New Year's Dayyear (latent)", -5.254017107651457),
                                    ("Thursdayfrom|since|after <time>", -3.954734123521196),
                                    ("Thursdayat <time-of-day>", -4.406719247264253),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.659482215759621),
                                    ("Aprilyear (latent)", -5.659482215759621),
                                    ("monthminute", -5.659482215759621),
                                    ("<time-of-day> am|pmtomorrow", -5.659482215759621),
                                    ("Thursdayhh:mm", -4.743191483885466),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.659482215759621),
                                    ("minutemonth", -3.867722746531566),
                                    ("week-endin <named-month>|year", -5.659482215759621),
                                    ("Augustyear (latent)", -5.254017107651457),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.254017107651457),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.254017107651457),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.659482215759621),
                                    ("Sundayyear (latent)", -4.966335035199676),
                                    ("Christmasat <time-of-day>", -5.659482215759621),
                                    ("from|since|after <time>year (latent)", -4.406719247264253),
                                    ("<duration> after|before|from <time>December",
                                     -5.659482215759621),
                                    ("yesterday<time-of-day> am|pm", -5.659482215759621),
                                    ...
                                    ("hh:mmyear (latent)", -4.560869927091511),
                                    ("Holiyear (latent)", -5.659482215759621),
                                    ("until <time><time-of-day> am|pm", -5.659482215759621),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.659482215759621),
                                    ("dayminute", -3.1745755659716206),
                                    ("intersectSeptember", -4.155404818983347),
                                    ("minuteday", -2.591429280626004),
                                    ("absorption of , after named dayintersect",
                                     -5.659482215759621),
                                    ("Februaryin|during the <part-of-day>", -5.659482215759621),
                                    ("hh:mmon <date>", -3.6445791952173563),
                                    ("Saturdayyear (latent)", -5.659482215759621),
                                    ("from|since|after <time>on <date>", -4.743191483885466),
                                    ("absorption of , after named daySeptember",
                                     -4.743191483885466),
                                    ("Naraka Chaturdashiyear (latent)", -5.659482215759621),
                                    ("on <date>September", -5.254017107651457),
                                    ("at <time-of-day>on <date>", -5.254017107651457),
                                    ("in <named-month>|yearyear (latent)", -5.659482215759621),
                                    ("dayweek", -5.659482215759621),
                                    ("Easter Sundayyear (latent)", -5.254017107651457),
                                    ("Thursday<time-of-day> am|pm", -4.966335035199676),
                                    ("weekyear", -5.254017107651457),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.659482215759621),
                                    ("Sundayfrom|since|after <time>", -5.659482215759621),
                                    ("absorption of , after named dayFebruary", -4.743191483885466),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.659482215759621),
                                    ("tomorrowat <time-of-day>", -5.659482215759621),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.659482215759621),
                                    ("last <cycle> of <time>year (latent)", -5.254017107651457),
                                    ("tomorrow<time-of-day> am|pm", -5.659482215759621),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.966335035199676),
                                    ("Diwaliyear (latent)", -5.254017107651457),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.659482215759621),
                                    ("Fridayyear (latent)", -5.254017107651457),
                                    ("minuteyear", -4.406719247264253)],
                               n = 184}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.15302518730552378,
                               unseen = -4.882801922586371,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -4.688358589885038e-2),
                                    ("intersect 2 numbers", -3.488902962081261)],
                               n = 127},
                   koData =
                     ClassData{prior = -1.9526898360406921, unseen = -3.258096538021482,
                               likelihoods =
                                 HashMap.fromList
