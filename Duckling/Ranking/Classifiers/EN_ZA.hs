...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5655118484605504, unseen = -6.133398042996649,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 459},
                   koData =
                     ClassData{prior = -0.8394901363186682, unseen = -5.860786223465865,
       ...
       ("at <time-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.23407262184640004,
                               unseen = -5.2832037287379885,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time> timezone", -3.891820298110627),
                                    ("noon|midnight|EOD|end of day", -4.179502370562408),
                                    ("integer after|past <hour-of-day>", -3.891820298110627),
                                    ("half after|past <hour-of-day>", -4.584967478670572),
                                    ("hhhmm", -3.6686767467964168),
                                    ("<hour-of-day> <integer>", -3.891820298110627),
                                    ("time-of-day (latent)", -1.6405284995041316),
                                    ("hhmm (latent)", -3.891820298110627),
                                    ("<time-of-day> am|pm", -1.9822777932261884),
                                    ("hh:mm", -3.332204510175204),
                                    ("about|exactly <time-of-day>", -4.179502370562408),
                                    ("hour", -1.1192315758708455),
                                    ("<time-of-day> sharp|exactly", -4.584967478670572),
                                    ("minute", -1.9108188292440431)],
                               n = 91},
                   koData =
                     ClassData{prior = -1.5668782980153044, unseen = -4.143134726391533,
                               likelihoods =
                                 HashMap.fromList
                                   [("time-of-day (latent)", -0.9916401691159419),
                                    ("<time-of-day> am|pm", -3.028522096376982),
                                    ("hour", -0.9082585601768909)],
                               n = 24}}),
       ("December",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.6094379124341003,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4583667663325779,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.465366816769375),
                                    ...
                                    ("tonightat <time-of-day>", -5.77221963620943),
                                    ...
                                    ("between <time> and <time>on <day>", -5.366754528101265),
                               ...
                               n = 497},
                   koData =
                     ClassData{prior = -1.0005301043167745, unseen = -6.76849321164863,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.570118547929173),
                                    ("hourday", -3.548467300397191),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.074195944705447),
                                    ("<day-of-month> (ordinal)August", -6.074195944705447),
                                    ("dayhour", -3.50924658724391),
                                    ("<time> timezoneyear (latent)", -5.381048764145501),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.157905212831292),
                                    ("Tuesdayfrom|since|after <time>", -5.381048764145501),
                                    ("daymonth", -3.400047295278918),
                                    ("monthyear", -4.821432976210079),
                                    ("<time-of-day> am|pmyear (latent)", -5.381048764145501),
                                    ("Thai Pongalyear (latent)", -5.381048764145501),
                                    ("intersecthh:mm", -6.074195944705447),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.668730836597282),
                                    ("<day-of-month> (ordinal)Wednesday", -6.074195944705447),
                                    ("houryear", -4.687901583585556),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.074195944705447),
                                    ("<day-of-month> (ordinal)October", -6.074195944705447),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.381048764145501),
                                    ("hournograin", -4.821432976210079),
                                    ("<time-of-day> am|pmintersect", -4.821432976210079),
                                    ("Octoberyear (latent)", -6.074195944705447),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.668730836597282),
                                    ("early morningat <time-of-day>", -6.074195944705447),
                                    ("until <time>on <day>", -5.381048764145501),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.074195944705447),
                                    ("time-of-day (latent)intersect", -5.381048764145501),
                                    ("todayin <number> (implicit minutes)", -6.074195944705447),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.381048764145501),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.074195944705447),
                                    ("hh:mmon <day>", -4.464758032271346),
                                    ("hhhmmintersect", -5.668730836597282),
                                    ("absorption of , after named dayJuly", -5.157905212831292),
                                    ("from|since|after <time>July", -5.668730836597282),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.157905212831292),
                                    ("Clean Mondayyear (latent)", -6.074195944705447),
                                    ("monthhour", -6.074195944705447),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.668730836597282),
                                    ("hourmonth", -4.202393767803855),
                                    ("todayat <time-of-day>", -6.074195944705447),
                                    ("hhhmmyear (latent)", -4.821432976210079),
                                    ("from|since|after <time>December", -6.074195944705447),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.074195944705447),
                                    ("<time-of-day> am|pmon <day>", -4.821432976210079),
                                    ("Mondayyear (latent)", -5.381048764145501),
                                    ("dayday", -4.687901583585556),
                                    ("on <day>September", -5.381048764145501),
                                    ("time-of-day (latent)September", -5.668730836597282),
                                    ("hourhour", -3.9947544030256106),
                                    ("time-of-day (latent)on <day>", -4.282436475477391),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.668730836597282),
                                    ("dayyear", -3.156425212621168),
                                    ("Thursdaymm/dd", -6.074195944705447),
                                    ("New Year's Dayyear (latent)", -5.157905212831292),
                                    ("time-of-day (latent)Sunday", -5.668730836597282),
                                    ("Thursdayfrom|since|after <time>", -4.3694478524670215),
                                    ("Thursdayat <time-of-day>", -4.464758032271346),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.074195944705447),
                                    ("Aprilyear (latent)", -6.074195944705447),
                                    ("the <day-of-month> (ordinal)July", -6.074195944705447),
                                    ("the <day-of-month> (number)July", -6.074195944705447),
                                    ("monthminute", -6.074195944705447),
                                    ("<time-of-day> am|pmtomorrow", -6.074195944705447),
                                    ("Thursdayhh:mm", -5.157905212831292),
                                    ("<day-of-month> (ordinal)Tuesday", -5.668730836597282),
                                    ("minutemonth", -3.934129781209176),
                                    ("time-of-day (latent)Friday", -5.668730836597282),
                                    ("minutehour", -6.074195944705447),
                                    ("part of daysat <time-of-day>", -4.975583656037337),
                                    ("Augustyear (latent)", -5.668730836597282),
                                    ("week-endin|during <named-month>|year", -6.074195944705447),
                                    ("time-of-day (latent)Tuesday", -5.668730836597282),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.074195944705447),
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.074195944705447),
                                    ("Sundayyear (latent)", -5.157905212831292),
                                    ("Christmasat <time-of-day>", -6.074195944705447),
                                    ("from|since|after <time>year (latent)", -4.975583656037337),
                                    ("hhhmmon <day>", -5.157905212831292),
                                    ("yesterday<time-of-day> am|pm", -6.074195944705447),
                                    ("<day-of-month> (ordinal)July", -5.381048764145501),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.074195944705447),
                                    ("at <time-of-day>intersect", -5.157905212831292),
                                    ("hh:mmyear (latent)", -4.687901583585556),
                                    ("Holiyear (latent)", -6.074195944705447),
                                    ("until <time><time-of-day> am|pm", -6.074195944705447),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.668730836597282),
                                    ("dayminute", -3.2409826006492306),
                                    ("yyyy-mm-ddhh:mm", -5.668730836597282),
                                    ("intersectfrom|since|after <time>", -5.668730836597282),
                                    ("intersectSeptember", -4.202393767803855),
                                    ("minuteday", -2.855320119837246),
                                    ("absorption of , after named dayintersect",
                                     -6.074195944705447),
                                    ("intersectyear (latent)", -6.074195944705447),
                                    ("Februaryin|during the <part-of-day>", -6.074195944705447),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.074195944705447),
                                    ("time-of-day (latent)July", -5.381048764145501),
                                    ("Saturdayyear (latent)", -6.074195944705447),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.074195944705447),
                                    ("at <time-of-day>on <day>", -5.157905212831292),
                                    ("absorption of , after named daySeptember",
                                     -4.821432976210079),
                                    ("Naraka Chaturdashiyear (latent)", -6.074195944705447),
                                    ("from|since|after <time>on <day>", -5.157905212831292),
                                    ("dayweek", -6.074195944705447),
                                    ("Easter Sundayyear (latent)", -5.668730836597282),
                                    ("Thursday<time-of-day> am|pm", -4.821432976210079),
                                    ("weekyear", -5.668730836597282),
                                    ("time-of-day (latent)Thursday", -5.668730836597282),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.074195944705447),
                                    ("<day-of-month> (ordinal)April", -6.074195944705447),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.668730836597282),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.381048764145501),
                                    ("Sundayfrom|since|after <time>", -6.074195944705447),
                                    ("absorption of , after named dayFebruary", -5.157905212831292),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.668730836597282),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.074195944705447),
                                    ("tomorrowat <time-of-day>", -6.074195944705447),
                                    ("daynograin", -5.668730836597282),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.668730836597282),
                                    ("last <cycle> of <time>year (latent)", -5.668730836597282),
                                    ("tomorrow<time-of-day> am|pm", -6.074195944705447),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.381048764145501),
                                    ("Diwaliyear (latent)", -5.668730836597282),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.074195944705447),
                                    ("this <part-of-day>at <time-of-day>", -5.157905212831292),
                                    ("Fridayyear (latent)", -5.668730836597282),
                                    ("time-of-day (latent)April", -6.074195944705447),
                                    ("minuteyear", -3.876971367369227)],
                               n = 289}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.14809617091855204,
                               unseen = -5.384495062789089,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -2.8039220064393047e-2),
                                    ("intersect 2 numbers", -3.993602992420569)],
                               n = 213},
                   koData =
                     ClassData{prior = -1.9830278120118159,
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6397464038328301, unseen = -4.852030263919617,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 125},
                   koData =
                     ClassData{prior = -0.7495612698400367, unseen = -4.74493212836325,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -7.275935428242832e-2),
                                    ("integer (0..19)", -2.6567569067146595)],
                               n = 112}}),
       ("beginning of year",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.791759469228055,
       ...
       ("on <day>",
        Classifier{okData =
                     ClassData{prior = -0.2006706954621511, unseen = -4.143134726391533,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursday", -1.6422277352570913),
                                    ("absorption of , after named day", -2.740840023925201),
                                    ("intersect", -2.740840023925201),
                                    ("Saturday", -2.740840023925201),
                                    ("Friday", -3.028522096376982), ("day", -0.7949298748698876),
                                    ("the <day-of-month> (ordinal)", -3.028522096376982),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -2.740840023925201)],
                               n = 27},
                   koData =
                     ClassData{prior = -1.7047480922384253, unseen = -3.044522437723423,
                               likelihoods =
                                 HashMap.fromList
