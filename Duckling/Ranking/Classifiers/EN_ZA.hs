...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4674751828923769, unseen = -7.160069207596127,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.466144724237619),
                                    ("Karva Chauthyear (latent)", -6.466144724237619),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.466144724237619),
                                    ("Maha Shivaratriyear (latent)", -6.466144724237619),
                                    ("Ramadanyear (latent)", -5.213381755742251),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.079850363117729),
                                    ("Bhai Doojyear (latent)", -6.466144724237619),
                                    ("hourday", -4.451241703695355),
                                    ("dayhour", -3.445719838093257),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.079850363117729),
                                    ("Martin Luther King's Dayyear (latent)", -6.0606796161294545),
                                    ("Shemini Atzeretyear (latent)", -6.466144724237619),
                                    ("daymonth", -4.451241703695355),
                                    ("monthday", -6.0606796161294545),
                                    ("monthyear", -4.674385255009565),
                                    ("Yom Ha'atzmautyear (latent)", -6.466144724237619),
                                    ("Orthodox Good Fridayyear (latent)", -6.0606796161294545),
                                    ("Vijayadashamiyear (latent)", -6.466144724237619),
                                    ("Thai Pongalyear (latent)", -5.772997543677674),
                                    ("Thiru Onamyear (latent)", -5.772997543677674),
                                    ("hhhmmabsorption of , after named day", -6.466144724237619),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.466144724237619),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.549853992363464),
                                    ("<day-of-month> (ordinal)Wednesday", -6.466144724237619),
                                    ("Krishna Janmashtamiyear (latent)", -6.0606796161294545),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.466144724237619),
                                    ("houryear", -5.549853992363464),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.466144724237619),
                                    ("Christmas<time-of-day> am|pm", -6.466144724237619),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.466144724237619),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.772997543677674),
                                    ("intersectin|during <named-month>|year", -6.466144724237619),
                                    ("<time-of-day> am|pmintersect", -5.213381755742251),
                                    ("Earth Houryear (latent)", -6.466144724237619),
                                    ("Ganesh Chaturthiyear (latent)", -6.466144724237619),
                                    ("Octoberyear (latent)", -4.962067327461345),
                                    ("intersect<time-of-day> am|pm", -6.466144724237619),
                                    ("Mattu Pongalyear (latent)", -6.466144724237619),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.466144724237619),
                                    ("Shavuotyear (latent)", -6.466144724237619),
                                    ("Parsi New Yearyear (latent)", -5.549853992363464),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.466144724237619),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.466144724237619),
                                    ("todayin|within|after <duration>", -6.466144724237619),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.0606796161294545),
                                    ("Marchyear (latent)", -6.466144724237619),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.0606796161294545),
                                    ("Sukkotyear (latent)", -6.0606796161294545),
                                    ("hhhmmintersect", -6.0606796161294545),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.0606796161294545),
                                    ("Clean Mondayyear (latent)", -6.0606796161294545),
                                    ("monthhour", -6.0606796161294545),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.772997543677674),
                                    ("todayat <time-of-day>", -6.466144724237619),
                                    ("Thursday<time> timezone", -4.068249451439249),
                                    ("tonight<time-of-day> am|pm", -6.466144724237619),
                                    ("time-of-day (latent)tonight", -6.0606796161294545),
                                    ("from|since|after <time>December", -6.466144724237619),
                                    ("<time-of-day> am|pmon <day>", -4.451241703695355),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.466144724237619),
                                    ("yyyy-mm-ddhh:mm:ss", -6.0606796161294545),
                                    ("dayday", -3.7580945231354095),
                                    ("<time> <part-of-day>at <time-of-day>", -6.0606796161294545),
                                    ("tonightat <time-of-day>", -5.36753243556951),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.772997543677674),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.466144724237619),
                                    ("today<time-of-day> am|pm", -6.466144724237619),
                                    ("Februarythe <day-of-month> (ordinal)", -6.0606796161294545),
                                    ("at <time-of-day><time> <part-of-day>", -6.466144724237619),
                                    ("<day-of-month> (ordinal)intersect", -6.0606796161294545),
                                    ("hourhour", -3.495730258667918),
                                    ("Mahavir Jayantiyear (latent)", -6.0606796161294545),
                                    ("Navaratriin|during <named-month>|year", -6.466144724237619),
                                    ("Wednesdaythis|last|next <cycle>", -6.466144724237619),
                                    ("Lentyear (latent)", -6.466144724237619),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.594342547336028),
                                    ("Boghiyear (latent)", -6.466144724237619),
                                    ("dayyear", -1.9228499419676155),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.466144724237619),
                                    ("Thursdayfrom|since|after <time>", -6.0606796161294545),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.466144724237619),
                                    ("Thursdayat <time-of-day>", -5.772997543677674),
                                    ("Islamic New Yearyear (latent)", -6.0606796161294545),
                                    ("Laylat al-Qadryear (latent)", -5.549853992363464),
                                    ("part of days<time-of-day> am|pm", -6.466144724237619),
                                    ("Shrove Tuesdayyear (latent)", -6.466144724237619),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.772997543677674),
                                    ("hourminute", -6.0606796161294545),
                                    ("<time-of-day> am|pmtomorrow", -5.772997543677674),
                                    ("Yom Kippuryear (latent)", -6.466144724237619),
                                    ("<day-of-month> (ordinal)Tuesday", -6.0606796161294545),
                                    ("<part-of-day> of <time>year (latent)", -6.466144724237619),
                                    ("minutehour", -5.213381755742251),
                                    ("Kaanum Pongalyear (latent)", -6.0606796161294545),
                                    ("Maha Saptamiyear (latent)", -6.466144724237619),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.772997543677674),
                                    ("time-of-day (latent)tomorrow", -5.549853992363464),
                                    ("part of daysat <time-of-day>", -4.856706811803519),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.451241703695355),
                                    ("for <duration> from <time>December", -6.466144724237619),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.466144724237619),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.213381755742251),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.213381755742251),
                                    ("time-of-day (latent)this <part-of-day>", -6.466144724237619),
                                    ("Pentecostyear (latent)", -6.466144724237619),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.213381755742251),
                                    ("<day-of-month> (ordinal)February", -6.466144724237619),
                                    ("Eid al-Fitryear (latent)", -5.079850363117729),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.466144724237619),
                                    ("Mondayin|during the <part-of-day>", -6.466144724237619),
                                    ("Chhathin|during <named-month>|year", -6.466144724237619),
                                    ("Diwaliin|during <named-month>|year", -6.466144724237619),
                                    ("this <part-of-day><time-of-day> am|pm", -6.466144724237619),
                                    ("Vaisakhiin|during <named-month>|year", -6.466144724237619),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.213381755742251),
                                    ("Raksha Bandhanyear (latent)", -6.466144724237619),
                                    ("daysecond", -6.0606796161294545),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.0606796161294545),
                                    ("Ratha-Yatrayear (latent)", -6.466144724237619),
                                    ("Ashurayear (latent)", -6.466144724237619),
                                    ("Tuesdayin|during <named-month>|year", -6.466144724237619),
                                    ("Chinese New Yearyear (latent)", -6.466144724237619),
                                    ("tomorrowintersect", -6.466144724237619),
                                    ("Lag BaOmeryear (latent)", -6.466144724237619),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.466144724237619),
                                    ("Eid al-Adhayear (latent)", -4.326078560741348),
                                    ("intersectin|during the <part-of-day>", -6.466144724237619),
                                    ("Palm Sundayyear (latent)", -6.466144724237619),
                                    ("Christmasat <time-of-day>", -6.466144724237619),
                                    ("Passoveryear (latent)", -6.466144724237619),
                                    ("Lazarus Saturdayyear (latent)", -6.466144724237619),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.466144724237619),
                                    ("hhhmmon <day>", -5.549853992363464),
                                    ("Yom HaShoahyear (latent)", -6.0606796161294545),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.0606796161294545),
                                    ("Septemberyear (latent)", -6.0606796161294545),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.962067327461345),
                                    ("Halloweenyear (latent)", -6.466144724237619),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.466144724237619),
                                    ("at <time-of-day>intersect", -5.549853992363464),
                                    ("Rosh Hashanahyear (latent)", -5.772997543677674),
                                    ("Dhanterasyear (latent)", -6.466144724237619),
                                    ("Tu BiShvatyear (latent)", -6.466144724237619),
                                    ("<day-of-month> (ordinal)December", -5.772997543677674),
                                    ("Holiyear (latent)", -5.772997543677674),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.466144724237619),
                                    ("Holika Dahanyear (latent)", -5.772997543677674),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0606796161294545),
                                    ("dayminute", -3.1519587195650938),
                                    ("Mawlidyear (latent)", -6.466144724237619),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.0606796161294545),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.466144724237619),
                                    ("Jumu'atul-Widayear (latent)", -5.549853992363464),
                                    ("minuteday", -2.728475105954251),
                                    ("absorption of , after named dayintersect",
                                     -5.772997543677674),
                                    ("intersectyear (latent)", -6.466144724237619),
                                    ("Orthodox Easter Sundayyear (latent)", -6.466144724237619),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.466144724237619),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.466144724237619),
                                    ("intersecthhhmm", -6.0606796161294545),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.466144724237619),
                                    ("Boss's Dayyear (latent)", -6.0606796161294545),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.466144724237619),
                                    ("Global Youth Service Dayyear (latent)", -6.466144724237619),
                                    ("Dhanterasin|during <named-month>|year", -6.466144724237619),
                                    ("tonight<time-of-day> o'clock", -6.466144724237619),
                                    ("Tisha B'Avyear (latent)", -6.466144724237619),
                                    ("Isra and Mi'rajyear (latent)", -5.549853992363464),
                                    ("at <time-of-day>on <day>", -4.856706811803519),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.0606796161294545),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.772997543677674),
                                    ("Christmasyear (latent)", -6.0606796161294545),
                                    ("Saturdayintersect", -6.466144724237619),
                                    ("Naraka Chaturdashiyear (latent)", -6.0606796161294545),
                                    ("Thai Pongalin|during <named-month>|year", -6.466144724237619),
                                    ("dayweek", -6.466144724237619),
                                    ("Easter Sundayyear (latent)", -5.772997543677674),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.0606796161294545),
                                    ("weekyear", -5.36753243556951),
                                    ("King's Dayyear (latent)", -4.962067327461345),
                                    ("hh:mmin|during the <part-of-day>", -5.549853992363464),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.0606796161294545),
                                    ("Hanukkahyear (latent)", -5.772997543677674),
                                    ("Rama Navamiyear (latent)", -6.466144724237619),
                                    ("February<time> <part-of-day>", -6.466144724237619),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.772997543677674),
                                    ("Great Lentyear (latent)", -6.466144724237619),
                                    ("tomorrowat <time-of-day>", -5.772997543677674),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.466144724237619),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.0606796161294545),
                                    ("Ugadiyear (latent)", -5.079850363117729),
                                    ("Vaisakhiyear (latent)", -5.772997543677674),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.772997543677674),
                                    ("last <cycle> of <time>year (latent)", -5.772997543677674),
                                    ("at <time-of-day>tomorrow", -6.0606796161294545),
                                    ("tomorrow<time-of-day> am|pm", -6.466144724237619),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.466144724237619),
                                    ("Diwaliyear (latent)", -6.466144724237619),
                                    ("between <time> and <time>on <day>", -6.0606796161294545),
                                    ("Black Fridayyear (latent)", -6.0606796161294545),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.466144724237619),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.466144724237619),
                                    ("Chhathyear (latent)", -6.0606796161294545),
                                    ("Vasant Panchamiyear (latent)", -6.466144724237619),
                                    ("Rabindra Jayantiyear (latent)", -5.213381755742251),
                                    ("this <part-of-day>at <time-of-day>", -5.213381755742251),
                                    ("St Patrick's Dayyear (latent)", -6.466144724237619),
                                    ("Thursday<time> (timezone)", -6.466144724237619),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.466144724237619),
                                    ("Pargat Diwasyear (latent)", -5.213381755742251),
                                    ("<datetime> - <datetime> (interval)July", -6.0606796161294545),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.772997543677674),
                                    ("Februaryintersect", -6.466144724237619),
                                    ("Simchat Torahyear (latent)", -6.466144724237619),
                                    ("minuteyear", -6.466144724237619)],
                               n = 495},
                   koData =
                     ClassData{prior = -0.9850575891212474, unseen = -6.787844982309579,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.589492373268862),
                                    ("hourday", -3.695674497246765),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.093569770045136),
                                    ("<day-of-month> (ordinal)August", -6.093569770045136),
                                    ("dayhour", -3.528620412583599),
                                    ("<time> timezoneyear (latent)", -5.40042258948519),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.177279038170981),
                                    ("Tuesdayfrom|since|after <time>", -5.40042258948519),
                                    ("daymonth", -3.3855195689429256),
                                    ("monthyear", -4.840806801549768),
                                    ("<time-of-day> am|pmyear (latent)", -5.40042258948519),
                                    ("Thai Pongalyear (latent)", -5.40042258948519),
                                    ("intersecthh:mm", -6.093569770045136),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.688104661936971),
                                    ("<day-of-month> (ordinal)Wednesday", -6.093569770045136),
                                    ("houryear", -4.707275408925245),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.093569770045136),
                                    ("<day-of-month> (ordinal)October", -6.093569770045136),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.40042258948519),
                                    ("hournograin", -4.840806801549768),
                                    ("<time-of-day> am|pmintersect", -4.840806801549768),
                                    ("Octoberyear (latent)", -6.093569770045136),
                                    ("Good Fridayyear (latent)", -5.688104661936971),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.688104661936971),
                                    ("early morningat <time-of-day>", -6.093569770045136),
                                    ("until <time>on <day>", -5.40042258948519),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.093569770045136),
                                    ("time-of-day (latent)intersect", -5.40042258948519),
                                    ("todayin <number> (implicit minutes)", -6.093569770045136),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.40042258948519),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.093569770045136),
                                    ("hh:mmon <day>", -4.840806801549768),
                                    ("hhhmmintersect", -5.688104661936971),
                                    ("absorption of , after named dayJuly", -5.177279038170981),
                                    ("from|since|after <time>July", -5.688104661936971),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.177279038170981),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.688104661936971),
                                    ("hourmonth", -4.221767593143544),
                                    ("todayat <time-of-day>", -6.093569770045136),
                                    ("hhhmmyear (latent)", -4.840806801549768),
                                    ("from|since|after <time>December", -6.093569770045136),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.093569770045136),
                                    ("<time-of-day> am|pmon <day>", -4.840806801549768),
                                    ("Mondayyear (latent)", -5.40042258948519),
                                    ("dayday", -4.078666749502871),
                                    ("on <day>September", -5.40042258948519),
                                    ("time-of-day (latent)September", -5.688104661936971),
                                    ("hourhour", -4.0141282283652995),
                                    ("time-of-day (latent)on <day>", -4.589492373268862),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.688104661936971),
                                    ("dayyear", -3.073144883900773),
                                    ("Thursdaymm/dd", -6.093569770045136),
                                    ("New Year's Dayyear (latent)", -5.177279038170981),
                                    ("time-of-day (latent)Sunday", -5.688104661936971),
                                    ("Thursdayfrom|since|after <time>", -4.38882167780671),
                                    ("Thursdayat <time-of-day>", -4.484131857611035),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.093569770045136),
                                    ("Aprilyear (latent)", -6.093569770045136),
                                    ("the <day-of-month> (ordinal)July", -6.093569770045136),
                                    ("the <day-of-month> (number)July", -6.093569770045136),
                                    ("monthminute", -6.093569770045136),
                                    ("<time-of-day> am|pmtomorrow", -6.093569770045136),
                                    ("Thursdayhh:mm", -5.177279038170981),
                                    ("<day-of-month> (ordinal)Tuesday", -5.688104661936971),
                                    ("minutemonth", -3.953503606548865),
                                    ("time-of-day (latent)Friday", -5.688104661936971),
                                    ("minutehour", -6.093569770045136),
                                    ("part of daysat <time-of-day>", -4.994957481377026),
                                    ("Augustyear (latent)", -5.688104661936971),
                                    ("week-endin|during <named-month>|year", -6.093569770045136),
                                    ("time-of-day (latent)Tuesday", -5.688104661936971),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.093569770045136),
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.093569770045136),
                                    ("Sundayyear (latent)", -5.177279038170981),
                                    ("the <day-of-month> (ordinal)Monday", -5.40042258948519),
                                    ("Christmasat <time-of-day>", -6.093569770045136),
                                    ("from|since|after <time>year (latent)", -4.994957481377026),
                                    ("hhhmmon <day>", -5.177279038170981),
                                    ("yesterday<time-of-day> am|pm", -6.093569770045136),
                                    ("<day-of-month> (ordinal)July", -5.40042258948519),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.093569770045136),
                                    ("at <time-of-day>intersect", -5.177279038170981),
                                    ("hh:mmyear (latent)", -4.707275408925245),
                                    ("Holiyear (latent)", -6.093569770045136),
                                    ("until <time><time-of-day> am|pm", -6.093569770045136),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.688104661936971),
                                    ("dayminute", -3.2603564259889195),
                                    ("yyyy-mm-ddhh:mm", -5.688104661936971),
                                    ("intersectfrom|since|after <time>", -5.688104661936971),
                                    ("intersectSeptember", -4.221767593143544),
                                    ("minuteday", -2.936569348895022),
                                    ("absorption of , after named dayintersect",
                                     -6.093569770045136),
                                    ("intersectyear (latent)", -6.093569770045136),
                                    ("Februaryin|during the <part-of-day>", -6.093569770045136),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.093569770045136),
                                    ("time-of-day (latent)July", -5.40042258948519),
                                    ("Saturdayyear (latent)", -6.093569770045136),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.093569770045136),
                                    ("<day-of-month> (ordinal)Monday", -5.177279038170981),
                                    ("at <time-of-day>on <day>", -5.177279038170981),
                                    ("absorption of , after named daySeptember",
                                     -4.840806801549768),
                                    ("Naraka Chaturdashiyear (latent)", -6.093569770045136),
                                    ("from|since|after <time>on <day>", -5.177279038170981),
                                    ("dayweek", -6.093569770045136),
                                    ("Easter Sundayyear (latent)", -5.688104661936971),
                                    ("Thursday<time-of-day> am|pm", -4.840806801549768),
                                    ("weekyear", -5.688104661936971),
                                    ("time-of-day (latent)Thursday", -5.688104661936971),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.093569770045136),
                                    ("<day-of-month> (ordinal)April", -6.093569770045136),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.688104661936971),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.40042258948519),
                                    ("Sundayfrom|since|after <time>", -6.093569770045136),
                                    ("absorption of , after named dayFebruary", -5.177279038170981),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.688104661936971),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.093569770045136),
                                    ("tomorrowat <time-of-day>", -6.093569770045136),
                                    ("daynograin", -5.688104661936971),
                                    ("Fridayin|during <named-month>|year", -6.093569770045136),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.688104661936971),
                                    ("last <cycle> of <time>year (latent)", -5.688104661936971),
                                    ("tomorrow<time-of-day> am|pm", -6.093569770045136),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.40042258948519),
                                    ("Diwaliyear (latent)", -5.688104661936971),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.093569770045136),
                                    ("this <part-of-day>at <time-of-day>", -5.177279038170981),
                                    ("Fridayyear (latent)", -5.177279038170981),
                                    ("time-of-day (latent)April", -6.093569770045136),
                                    ("minuteyear", -3.896345192708916)],
                               n = 295}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.569352963213281, unseen = -5.375278407684165,
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                     -4.677490847567718),
                                    ("dayhour", -4.272025739459553),
                                    ("daymonth", -2.0748011621233338),
                               ...
                               n = 73},
                   koData =
                     ClassData{prior = -0.8344607136265229, unseen = -5.204006687076795,
                               likelihoods =
                                 HashMap.fromList
                                   [("week-endJuly", -4.505349850705881),
                                    ("week-endOctober", -3.8122026701459353),
                                    ("daymonth", -1.7972996496036704),
                                    ...
                                    ("FridayOctober", -4.505349850705881),
