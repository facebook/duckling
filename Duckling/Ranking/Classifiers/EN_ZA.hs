...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6054416001408398, unseen = -5.575949103146316,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 262},
                   koData =
                     ClassData{prior = -0.7892910411128476, unseen = -5.393627546352362,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4669713548842164, unseen = -6.652863029353347,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -5.958424693029782),
                                    ("Ramadanyear (latent)", -5.958424693029782),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.705661724534414),
                                    ("Bhai Doojyear (latent)", -5.958424693029782),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.705661724534414),
                                    ("hourday", -4.253676600791357),
                                    ("dayhour", -3.0406539609455026),
                                    ("Martin Luther King's Dayyear (latent)", -5.552959584921617),
                                    ("Shemini Atzeretyear (latent)", -5.958424693029782),
                                    ("daymonth", -5.2652775124698366),
                                    ("monthday", -5.552959584921617),
                                    ("monthyear", -4.3489867805956814),
                                    ("Yom Ha'atzmautyear (latent)", -5.958424693029782),
                                    ("Vijayadashamiyear (latent)", -5.958424693029782),
                                    ("Thai Pongalyear (latent)", -5.2652775124698366),
                                    ("Thiru Onamyear (latent)", -5.2652775124698366),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.958424693029782),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.958424693029782),
                                    ("houryear", -5.2652775124698366),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.958424693029782),
                                    ("Christmas<time-of-day> am|pm", -5.958424693029782),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -5.958424693029782),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.2652775124698366),
                                    ("<time-of-day> am|pmintersect", -4.705661724534414),
                                    ("Octoberyear (latent)", -4.705661724534414),
                                    ("intersect<time-of-day> am|pm", -5.958424693029782),
                                    ("Mattu Pongalyear (latent)", -5.958424693029782),
                                    ("Shavuotyear (latent)", -5.958424693029782),
                                    ("Dhanterasin <named-month>|year", -5.958424693029782),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -5.958424693029782),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.958424693029782),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.552959584921617),
                                    ("Marchyear (latent)", -5.958424693029782),
                                    ("Sukkotyear (latent)", -5.552959584921617),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.958424693029782),
                                    ("Clean Mondayyear (latent)", -5.552959584921617),
                                    ("monthhour", -5.552959584921617),
                                    ("todayat <time-of-day>", -5.958424693029782),
                                    ("Thursday<time> timezone", -4.253676600791357),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.958424693029782),
                                    ("Palm SundaySunday", -5.552959584921617),
                                    ("dayday", -3.7612001156935624),
                                    ("<time> <part-of-day>at <time-of-day>", -5.958424693029782),
                                    ("tonightat <time-of-day>", -5.958424693029782),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.2652775124698366),
                                    ("today<time-of-day> am|pm", -5.958424693029782),
                                    ("Februarythe <day-of-month> (ordinal)", -5.552959584921617),
                                    ("at <time-of-day><time> <part-of-day>", -5.958424693029782),
                                    ("hourhour", -4.705661724534414),
                                    ("<time-of-day> am|pmon <date>", -3.9435216724875173),
                                    ("Wednesdaythis|last|next <cycle>", -5.958424693029782),
                                    ("Lentyear (latent)", -5.958424693029782),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.454347296253507),
                                    ("Boghiyear (latent)", -5.958424693029782),
                                    ("dayyear", -2.097694981989186),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.958424693029782),
                                    ("Thursdayat <time-of-day>", -5.552959584921617),
                                    ("Islamic New Yearyear (latent)", -5.552959584921617),
                                    ("Laylat al-Qadryear (latent)", -5.042133961155627),
                                    ("Chhathin <named-month>|year", -5.958424693029782),
                                    ("Diwaliin <named-month>|year", -5.958424693029782),
                                    ("Shrove Tuesdayyear (latent)", -5.958424693029782),
                                    ("<time-of-day> am|pmtomorrow", -5.2652775124698366),
                                    ("Yom Kippuryear (latent)", -5.958424693029782),
                                    ("<part-of-day> of <time>year (latent)", -5.958424693029782),
                                    ("minutehour", -5.042133961155627),
                                    ("Kaanum Pongalyear (latent)", -5.552959584921617),
                                    ("Maha Saptamiyear (latent)", -5.958424693029782),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.552959584921617),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.253676600791357),
                                    ("for <duration> from <time>December", -5.958424693029782),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.958424693029782),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.042133961155627),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.552959584921617),
                                    ("Pentecostyear (latent)", -5.958424693029782),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.042133961155627),
                                    ("Eid al-Fitryear (latent)", -5.958424693029782),
                                    ("Mondayin|during the <part-of-day>", -5.958424693029782),
                                    ("Raksha Bandhanyear (latent)", -5.958424693029782),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.552959584921617),
                                    ("Navaratriin <named-month>|year", -5.958424693029782),
                                    ("Ashurayear (latent)", -5.958424693029782),
                                    ("Chinese New Yearyear (latent)", -5.958424693029782),
                                    ("Sundayyear (latent)", -5.958424693029782),
                                    ("Lag BaOmeryear (latent)", -5.958424693029782),
                                    ("last weekend of <named-month>year (latent)",
                                     -5.958424693029782),
                                    ("Eid al-Adhayear (latent)", -5.042133961155627),
                                    ("intersectin|during the <part-of-day>", -5.958424693029782),
                                    ("Christmasat <time-of-day>", -5.958424693029782),
                                    ("Passoveryear (latent)", -5.958424693029782),
                                    ("Lazarus Saturdayyear (latent)", -5.958424693029782),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.958424693029782),
                                    ("Yom HaShoahyear (latent)", -5.552959584921617),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.042133961155627),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.958424693029782),
                                    ("Thai Pongalin <named-month>|year", -5.958424693029782),
                                    ("Septemberyear (latent)", -5.552959584921617),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.705661724534414),
                                    ("Halloweenyear (latent)", -5.958424693029782),
                                    ...
                                    ("Rosh Hashanahyear (latent)", -5.958424693029782),
                                    ("Dhanterasyear (latent)", -5.958424693029782),
                                    ("Tu BiShvatyear (latent)", -5.958424693029782),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.958424693029782),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.958424693029782),
                                    ("dayminute", -3.393475335568245),
                                    ("Mawlidyear (latent)", -5.958424693029782),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.552959584921617),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -5.958424693029782),
                                    ("Jumu'atul-Widayear (latent)", -5.042133961155627),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.958424693029782),
                                    ("minuteday", -2.320838533303396),
                                    ("absorption of , after named dayintersect",
                                     -5.958424693029782),
                                    ("intersectyear (latent)", -5.958424693029782),
                                    ("Orthodox Easter Sundayyear (latent)", -5.958424693029782),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.958424693029782),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.958424693029782),
                                    ("Boss's Dayyear (latent)", -5.552959584921617),
                                    ("Tisha B'Avyear (latent)", -5.958424693029782),
                                    ("Isra and Mi'rajyear (latent)", -5.042133961155627),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.958424693029782),
                                    ("Christmasyear (latent)", -5.552959584921617),
                                    ("Naraka Chaturdashiyear (latent)", -5.552959584921617),
                                    ("at <time-of-day>on <date>", -4.859812404361672),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.3489867805956814),
                                    ("dayweek", -5.958424693029782),
                                    ("Easter Sundayyear (latent)", -5.2652775124698366),
                                    ("Thursday<time-of-day> am|pm", -5.958424693029782),
                                    ("weekyear", -5.552959584921617),
                                    ("hh:mmin|during the <part-of-day>", -5.2652775124698366),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.552959584921617),
                                    ("Hanukkahyear (latent)", -5.958424693029782),
                                    ("February<time> <part-of-day>", -5.958424693029782),
                                    ("Tuesdayin <named-month>|year", -5.958424693029782),
                                    ("Great Lentyear (latent)", -5.958424693029782),
                                    ("tomorrowat <time-of-day>", -5.2652775124698366),
                                    ("between <time> and <time>on <date>", -4.3489867805956814),
                                    ("Thursdayfrom|since|after <time-of-day>", -5.2652775124698366),
                                    ("last <cycle> of <time>year (latent)", -5.2652775124698366),
                                    ("at <time-of-day>tomorrow", -5.552959584921617),
                                    ("tomorrow<time-of-day> am|pm", -5.958424693029782),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.958424693029782),
                                    ("Diwaliyear (latent)", -5.958424693029782),
                                    ("Black Fridayyear (latent)", -5.552959584921617),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.958424693029782),
                                    ("Chhathyear (latent)", -5.552959584921617),
                                    ("Palm Sundayintersect", -5.958424693029782),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -5.958424693029782),
                                    ("Februaryintersect", -5.958424693029782),
                                    ("Simchat Torahyear (latent)", -5.958424693029782)],
                               n = 289},
                   koData =
                     ClassData{prior = -0.9859035661831955, unseen = -6.293419278846481,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.598421958998375),
                                    ("hourday", -5.598421958998375),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.598421958998375),
                                    ("dayhour", -3.295836866004329),
                                    ("daymonth", -3.518980417318539),
                                    ("monthday", -5.19295685089021),
                                    ("monthyear", -4.345658990503007),
                                    ("<time-of-day> am|pmyear (latent)", -5.19295685089021),
                                    ("Thai Pongalyear (latent)", -4.90527477843843),
                                    ("intersecthh:mm", -5.598421958998375),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.598421958998375),
                                    ("houryear", -4.68213122712422),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.598421958998375),
                                    ("until <time-of-day><time-of-day> am|pm", -5.598421958998375),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.90527477843843),
                                    ("<time-of-day> am|pmintersect", -4.345658990503007),
                                    ("Octoberyear (latent)", -5.598421958998375),
                                    ("from|since|after <time-of-day>year (latent)",
                                     -4.345658990503007),
                                    ("from|since|after <time-of-day>on <date>", -4.68213122712422),
                                    ...
                                    ("hourmonth", -4.90527477843843),
                                    ("todayat <time-of-day>", -5.598421958998375),
                                    ("from|since|after <time-of-day>July", -5.598421958998375),
                                    ("Mondayyear (latent)", -4.90527477843843),
                                    ("dayday", -5.19295685089021),
                                    ("<time-of-day> am|pmon <date>", -4.345658990503007),
                                    ("dayyear", -2.6806512269140956),
                                    ("Thursdaymm/dd", -5.598421958998375),
                                    ("New Year's Dayyear (latent)", -5.19295685089021),
                                    ("Thursdayat <time-of-day>", -4.345658990503007),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.598421958998375),
                                    ("Aprilyear (latent)", -5.598421958998375),
                                    ("monthminute", -5.598421958998375),
                                    ("<time-of-day> am|pmtomorrow", -5.598421958998375),
                                    ("Thursdayhh:mm", -4.68213122712422),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.598421958998375),
                                    ("minutemonth", -3.8066624897703196),
                                    ("Sundayfrom|since|after <time-of-day>", -5.598421958998375),
                                    ("week-endin <named-month>|year", -5.598421958998375),
                                    ("Augustyear (latent)", -5.19295685089021),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.19295685089021),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.19295685089021),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.598421958998375),
                                    ("Sundayyear (latent)", -4.90527477843843),
                                    ("Christmasat <time-of-day>", -5.598421958998375),
                                    ("<duration> after|before|from <time>December",
                                     -5.598421958998375),
                                    ("yesterday<time-of-day> am|pm", -5.598421958998375),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.598421958998375),
                                    ("until <time-of-day>on <date>", -4.90527477843843),
                                    ("at <time-of-day>intersect", -5.19295685089021),
                                    ("hh:mmyear (latent)", -4.499809670330265),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.598421958998375),
                                    ("dayminute", -3.1560749236291703),
                                    ("intersectSeptember", -4.0943445622221),
                                    ("minuteday", -2.5303690238647576),
                                    ("absorption of , after named dayintersect",
                                     -5.598421958998375),
                                    ("Februaryin|during the <part-of-day>", -5.598421958998375),
                                    ("hh:mmon <date>", -3.58351893845611),
                                    ("Saturdayyear (latent)", -5.598421958998375),
                                    ...
                                    ("on <date>September", -5.19295685089021),
                                    ("at <time-of-day>on <date>", -5.19295685089021),
                                    ("in <named-month>|yearyear (latent)", -5.598421958998375),
                                    ("dayweek", -5.598421958998375),
                                    ("Easter Sundayyear (latent)", -5.19295685089021),
                                    ("Thursday<time-of-day> am|pm", -5.19295685089021),
                                    ("absorption of , after named dayFebruary", -4.68213122712422),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.598421958998375),
                                    ("tomorrowat <time-of-day>", -5.598421958998375),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.598421958998375),
                                    ("Thursdayfrom|since|after <time-of-day>", -3.9889840465642745),
                                    ("tomorrow<time-of-day> am|pm", -5.598421958998375),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -4.90527477843843),
                                    ("Diwaliyear (latent)", -5.19295685089021),
                                    ("Tuesdayfrom|since|after <time-of-day>", -5.598421958998375),
                                    ("Fridayyear (latent)", -5.19295685089021),
                                    ("minuteyear", -4.345658990503007)],
                               n = 172}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1761865682264387, unseen = -4.736198448394496,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -5.4558984250434366e-2),
                                    ("intersect 2 numbers", -3.34109345759245)],
                               n = 109},
                   koData =
                     ClassData{prior = -1.8230120127321594, unseen = -3.258096538021482,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("in <named-month>|year",
        Classifier{okData =
                     ClassData{prior = -0.3184537311185346,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("October", -2.3513752571634776),
                                    ("year (latent)", -1.0986122886681098),
                                    ("year", -1.0986122886681098), ("March", -2.3513752571634776),
