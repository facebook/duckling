...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7214776871861713, unseen = -5.170483995038151,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 174},
                   koData =
                     ClassData{prior = -0.6655972287917147, unseen = -5.225746673713201,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4752608700437064, unseen = -6.137727054086234,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("dayhour", -3.1911259119152984),
                                    ("daymonth", -4.749270529961848),
                                    ("monthday", -5.0369526024136295),
                                    ("monthyear", -3.832979798087693),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.442417710521793),
                                    ...
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.749270529961848),
                                    ("<time-of-day> am|pmintersect", -4.189654742026425),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.442417710521793),
                                    ("Marchyear", -5.442417710521793),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.0369526024136295),
                                    ("intersect<time-of-day> am|pm", -5.442417710521793),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.442417710521793),
                                    ("monthhour", -5.0369526024136295),
                                    ("last <day-of-week> of <time>year", -5.442417710521793),
                                    ("todayat <time-of-day>", -5.442417710521793),
                                    ("Thursday<time> timezone", -5.0369526024136295),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.442417710521793),
                                    ("dayday", -3.427514689979529),
                                    ("<time> <part-of-day>at <time-of-day>", -5.442417710521793),
                                    ("Tuesdayin <named-month>", -5.442417710521793),
                                    ("tonightat <time-of-day>", -5.442417710521793),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.749270529961848),
                                    ("today<time-of-day> am|pm", -5.442417710521793),
                                    ("Februarythe <day-of-month> (ordinal)", -5.0369526024136295),
                                    ("at <time-of-day><time> <part-of-day>", -5.442417710521793),
                                    ("hourhour", -4.189654742026425),
                                    ("<time-of-day> am|pmon <date>", -3.427514689979529),
                                    ("Wednesdaythis|last|next <cycle>", -5.442417710521793),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.9383403137455195),
                                    ("dayyear", -3.245193133185574),
                                    ("last weekend of <named-month>year", -5.442417710521793),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.442417710521793),
                                    ("<time-of-day> am|pmtomorrow", -4.749270529961848),
                                    ("minutehour", -4.526126978647638),
                                    ("Mother's Dayyear", -5.442417710521793),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.0369526024136295),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.7376696182833684),
                                    ("for <duration> from <time>December", -5.442417710521793),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.442417710521793),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.526126978647638),
                                    ("Mondayin|during the <part-of-day>", -5.442417710521793),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.0369526024136295),
                                    ("intersectin|during the <part-of-day>", -5.442417710521793),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.442417710521793),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.0369526024136295),
                                    ("<ordinal> <cycle> of <time>year", -5.442417710521793),
                                    ("minuteday", -2.0412203288596382),
                                    ("absorption of , after named dayintersect",
                                     -5.442417710521793),
                                    ("Octoberyear", -4.189654742026425),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.442417710521793),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.442417710521793),
                                    ("year<time-of-day> am|pm", -5.442417710521793),
                                    ("Septemberyear", -5.0369526024136295),
                                    ("at <time-of-day>on <date>", -4.343805421853684),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.749270529961848),
                                    ("Halloweenyear", -5.442417710521793),
                                    ("dayweek", -5.442417710521793),
                                    ("weekyear", -5.0369526024136295),
                                    ("hh:mmin|during the <part-of-day>", -4.749270529961848),
                                    ("Father's Dayyear", -5.442417710521793),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.0369526024136295),
                                    ("February<time> <part-of-day>", -5.442417710521793),
                                    ("Martin Luther King's Dayyear", -5.0369526024136295),
                                    ("tomorrowat <time-of-day>", -4.749270529961848),
                                    ("between <time> and <time>on <date>", -4.749270529961848),
                                    ("at <time-of-day>tomorrow", -5.0369526024136295),
                                    ("tomorrow<time-of-day> am|pm", -5.442417710521793),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.442417710521793),
                                    ("black fridayyear", -5.0369526024136295),
                                    ("Labor Dayyear", -5.442417710521793),
                                    ("Februaryintersect", -5.442417710521793),
                                    ("last <cycle> of <time>year", -4.749270529961848),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.442417710521793),
                                    ("yearminute", -5.442417710521793)],
                               n = 166},
                   koData =
                     ClassData{prior = -0.9721281415589901, unseen = -5.808142489980444,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.111987788356543),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.111987788356543),
                                    ("this <time>six thirty six a.m.", -5.111987788356543),
                                    ("until <time-of-day>on <date>", -4.418840607796598),
                                    ("at <time-of-day>intersect", -4.706522680248379),
                                    ("Thursdaysix thirty six a.m.", -5.111987788356543),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.111987788356543),
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.5456944494168147, unseen = -4.189654742026425,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.13133600206108698),
                                    ("integer (0..19)", -2.228477120840324)],
                               n = 62},
                   koData =
                     ClassData{prior = -0.8661663446915865, unseen = -3.891820298110627,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.3085472109157426, unseen = -5.209486152841421,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 83},
                   koData =
                     ClassData{prior = -1.3261904370501851, unseen = -4.343805421853684,
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -3.2321210516182215),
                                    ("<hour-of-day> <integer>", -3.6375861597263857),
                                    ("time-of-day (latent)", -1.034896474282002),
                                    ("hour", -0.9985288301111273), ("minute", -2.9444389791664407),
                                    ("after <time-of-day>", -3.6375861597263857)],
                               n = 30}}),
