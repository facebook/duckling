...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5625269981428811, unseen = -6.093569770045136,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 441},
                   koData =
                     ClassData{prior = -0.8434293836092833, unseen = -5.814130531825066,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4586244763882603, unseen = -7.095893221097532,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.401917196727186),
                                    ("Karva Chauthyear (latent)", -6.401917196727186),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.401917196727186),
                                    ("Maha Shivaratriyear (latent)", -6.401917196727186),
                                    ("Ramadanyear (latent)", -5.149154228231818),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.015622835607295),
                                    ("Bhai Doojyear (latent)", -6.401917196727186),
                                    ("hourday", -4.387014176184921),
                                    ("dayhour", -3.457478217560745),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.015622835607295),
                                    ("Martin Luther King's Dayyear (latent)", -5.996452088619021),
                                    ("Shemini Atzeretyear (latent)", -6.401917196727186),
                                    ("daymonth", -4.387014176184921),
                                    ("monthday", -5.996452088619021),
                                    ("monthyear", -4.61015772749913),
                                    ("Yom Ha'atzmautyear (latent)", -6.401917196727186),
                                    ("Vijayadashamiyear (latent)", -6.401917196727186),
                                    ("Thai Pongalyear (latent)", -5.70877001616724),
                                    ("Thiru Onamyear (latent)", -5.70877001616724),
                                    ("hhhmmabsorption of , after named day", -6.401917196727186),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.401917196727186),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.485626464853031),
                                    ("<day-of-month> (ordinal)Wednesday", -6.401917196727186),
                                    ("Krishna Janmashtamiyear (latent)", -5.996452088619021),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.401917196727186),
                                    ("houryear", -5.485626464853031),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.401917196727186),
                                    ("Christmas<time-of-day> am|pm", -6.401917196727186),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.401917196727186),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.70877001616724),
                                    ("intersectin|during <named-month>|year", -6.401917196727186),
                                    ("<time-of-day> am|pmintersect", -5.149154228231818),
                                    ("Earth Houryear (latent)", -6.401917196727186),
                                    ("Ganesh Chaturthiyear (latent)", -6.401917196727186),
                                    ("Octoberyear (latent)", -4.897839799950911),
                                    ("intersect<time-of-day> am|pm", -6.401917196727186),
                                    ("Mattu Pongalyear (latent)", -6.401917196727186),
                                    ("Shavuotyear (latent)", -6.401917196727186),
                                    ("Parsi New Yearyear (latent)", -5.485626464853031),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.401917196727186),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.401917196727186),
                                    ("todayin|within|after <duration>", -6.401917196727186),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.996452088619021),
                                    ("Marchyear (latent)", -6.401917196727186),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -5.996452088619021),
                                    ("Sukkotyear (latent)", -5.996452088619021),
                                    ("hhhmmintersect", -5.996452088619021),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.996452088619021),
                                    ("Clean Mondayyear (latent)", -5.996452088619021),
                                    ("monthhour", -5.996452088619021),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.70877001616724),
                                    ("todayat <time-of-day>", -6.401917196727186),
                                    ("Thursday<time> timezone", -4.004021923928815),
                                    ("time-of-day (latent)tonight", -5.996452088619021),
                                    ("from|since|after <time>December", -6.401917196727186),
                                    ("<time-of-day> am|pmon <day>", -4.387014176184921),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.401917196727186),
                                    ("yyyy-mm-ddhh:mm:ss", -5.996452088619021),
                                    ("dayday", -3.6938669956249752),
                                    ("<time> <part-of-day>at <time-of-day>", -6.401917196727186),
                                    ("tonightat <time-of-day>", -6.401917196727186),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.70877001616724),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.401917196727186),
                                    ("today<time-of-day> am|pm", -6.401917196727186),
                                    ("Februarythe <day-of-month> (ordinal)", -5.996452088619021),
                                    ("at <time-of-day><time> <part-of-day>", -6.401917196727186),
                                    ("<day-of-month> (ordinal)intersect", -5.996452088619021),
                                    ("hourhour", -4.3224756550473495),
                                    ("Mahavir Jayantiyear (latent)", -5.996452088619021),
                                    ("Navaratriin|during <named-month>|year", -6.401917196727186),
                                    ("Wednesdaythis|last|next <cycle>", -6.401917196727186),
                                    ("Lentyear (latent)", -6.401917196727186),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.530115019825594),
                                    ("Boghiyear (latent)", -6.401917196727186),
                                    ("dayyear", -1.874708552208806),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.401917196727186),
                                    ("Thursdayfrom|since|after <time>", -5.996452088619021),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.401917196727186),
                                    ("Thursdayat <time-of-day>", -5.70877001616724),
                                    ("Islamic New Yearyear (latent)", -5.996452088619021),
                                    ("Laylat al-Qadryear (latent)", -5.485626464853031),
                                    ("Shrove Tuesdayyear (latent)", -6.401917196727186),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.70877001616724),
                                    ("<time-of-day> am|pmtomorrow", -5.70877001616724),
                                    ("Yom Kippuryear (latent)", -6.401917196727186),
                                    ("<day-of-month> (ordinal)Tuesday", -5.996452088619021),
                                    ("<part-of-day> of <time>year (latent)", -6.401917196727186),
                                    ("minutehour", -5.149154228231818),
                                    ("Kaanum Pongalyear (latent)", -5.996452088619021),
                                    ("Maha Saptamiyear (latent)", -6.401917196727186),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.996452088619021),
                                    ("time-of-day (latent)tomorrow", -5.485626464853031),
                                    ("part of daysat <time-of-day>", -5.996452088619021),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.387014176184921),
                                    ("for <duration> from <time>December", -6.401917196727186),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.401917196727186),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.149154228231818),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.149154228231818),
                                    ("time-of-day (latent)this <part-of-day>", -6.401917196727186),
                                    ("Pentecostyear (latent)", -6.401917196727186),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.149154228231818),
                                    ("<day-of-month> (ordinal)February", -6.401917196727186),
                                    ("Eid al-Fitryear (latent)", -5.015622835607295),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.401917196727186),
                                    ("Mondayin|during the <part-of-day>", -6.401917196727186),
                                    ("Chhathin|during <named-month>|year", -6.401917196727186),
                                    ("Diwaliin|during <named-month>|year", -6.401917196727186),
                                    ("Vaisakhiin|during <named-month>|year", -6.401917196727186),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.149154228231818),
                                    ("Raksha Bandhanyear (latent)", -6.401917196727186),
                                    ("daysecond", -5.996452088619021),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.996452088619021),
                                    ("Ratha-Yatrayear (latent)", -6.401917196727186),
                                    ("Ashurayear (latent)", -6.401917196727186),
                                    ("Tuesdayin|during <named-month>|year", -6.401917196727186),
                                    ("Chinese New Yearyear (latent)", -6.401917196727186),
                                    ("tomorrowintersect", -6.401917196727186),
                                    ("Lag BaOmeryear (latent)", -6.401917196727186),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.401917196727186),
                                    ("Eid al-Adhayear (latent)", -4.261851033230915),
                                    ("intersectin|during the <part-of-day>", -6.401917196727186),
                                    ("Palm Sundayyear (latent)", -6.401917196727186),
                                    ("Christmasat <time-of-day>", -6.401917196727186),
                                    ("Passoveryear (latent)", -6.401917196727186),
                                    ("Lazarus Saturdayyear (latent)", -6.401917196727186),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.401917196727186),
                                    ("hhhmmon <day>", -5.485626464853031),
                                    ("Yom HaShoahyear (latent)", -5.996452088619021),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.996452088619021),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.401917196727186),
                                    ("Septemberyear (latent)", -5.996452088619021),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.897839799950911),
                                    ("Halloweenyear (latent)", -6.401917196727186),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.401917196727186),
                                    ("at <time-of-day>intersect", -5.485626464853031),
                                    ("Rosh Hashanahyear (latent)", -5.70877001616724),
                                    ("Dhanterasyear (latent)", -6.401917196727186),
                                    ("Tu BiShvatyear (latent)", -6.401917196727186),
                                    ("<day-of-month> (ordinal)December", -5.70877001616724),
                                    ("Holiyear (latent)", -5.70877001616724),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.401917196727186),
                                    ("Holika Dahanyear (latent)", -5.70877001616724),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.996452088619021),
                                    ("dayminute", -3.08773119205466),
                                    ("Mawlidyear (latent)", -6.401917196727186),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.996452088619021),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.401917196727186),
                                    ("Jumu'atul-Widayear (latent)", -5.485626464853031),
                                    ("minuteday", -2.6642475784438173),
                                    ("absorption of , after named dayintersect", -5.70877001616724),
                                    ("intersectyear (latent)", -6.401917196727186),
                                    ("Orthodox Easter Sundayyear (latent)", -6.401917196727186),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.401917196727186),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.401917196727186),
                                    ("intersecthhhmm", -5.996452088619021),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.401917196727186),
                                    ("Boss's Dayyear (latent)", -5.996452088619021),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.401917196727186),
                                    ("Global Youth Service Dayyear (latent)", -6.401917196727186),
                                    ("Dhanterasin|during <named-month>|year", -6.401917196727186),
                                    ("Tisha B'Avyear (latent)", -6.401917196727186),
                                    ("Isra and Mi'rajyear (latent)", -5.485626464853031),
                                    ("at <time-of-day>on <day>", -4.792479284293085),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.996452088619021),
                                    ("time-of-day (latent)<time> <part-of-day>", -5.70877001616724),
                                    ("Christmasyear (latent)", -5.996452088619021),
                                    ("Naraka Chaturdashiyear (latent)", -5.996452088619021),
                                    ("Thai Pongalin|during <named-month>|year", -6.401917196727186),
                                    ("dayweek", -6.401917196727186),
                                    ("Easter Sundayyear (latent)", -5.70877001616724),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -5.996452088619021),
                                    ("weekyear", -5.303304908059076),
                                    ("King's Dayyear (latent)", -4.897839799950911),
                                    ("hh:mmin|during the <part-of-day>", -5.485626464853031),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.996452088619021),
                                    ("Hanukkahyear (latent)", -5.70877001616724),
                                    ("February<time> <part-of-day>", -6.401917196727186),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.401917196727186),
                                    ("Great Lentyear (latent)", -6.401917196727186),
                                    ("tomorrowat <time-of-day>", -5.70877001616724),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.401917196727186),
                                    ("Ugadiyear (latent)", -5.015622835607295),
                                    ("Vaisakhiyear (latent)", -5.70877001616724),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.70877001616724),
                                    ("last <cycle> of <time>year (latent)", -5.70877001616724),
                                    ("at <time-of-day>tomorrow", -5.996452088619021),
                                    ("tomorrow<time-of-day> am|pm", -6.401917196727186),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.401917196727186),
                                    ("Diwaliyear (latent)", -6.401917196727186),
                                    ("between <time> and <time>on <day>", -5.996452088619021),
                                    ("Black Fridayyear (latent)", -5.996452088619021),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.401917196727186),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.401917196727186),
                                    ("Chhathyear (latent)", -5.996452088619021),
                                    ("Vasant Panchamiyear (latent)", -6.401917196727186),
                                    ("Rabindra Jayantiyear (latent)", -5.149154228231818),
                                    ("St Patrick's Dayyear (latent)", -6.401917196727186),
                                    ("Thursday<time> (timezone)", -6.401917196727186),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.401917196727186),
                                    ("Pargat Diwasyear (latent)", -5.149154228231818),
                                    ("<datetime> - <datetime> (interval)July", -5.996452088619021),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.70877001616724),
                                    ("Februaryintersect", -6.401917196727186),
                                    ("Simchat Torahyear (latent)", -6.401917196727186),
                                    ("minuteyear", -6.401917196727186)],
                               n = 464},
                   koData =
                     ClassData{prior = -1.0000870696161408, unseen = -6.70808408385307,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.5096377592665275),
                                    ("hourday", -3.615819883244431),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.013715156042802),
                                    ("<day-of-month> (ordinal)August", -6.013715156042802),
                                    ("dayhour", -3.448765798581265),
                                    ("<time> timezoneyear (latent)", -5.320567975482857),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.097424424168647),
                                    ("Tuesdayfrom|since|after <time>", -5.320567975482857),
                                    ("daymonth", -3.339566506616273),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.013715156042802),
                                    ("hh:mmon <day>", -4.760952187547434),
                                    ("hhhmmintersect", -5.6082500479346375),
                                    ("absorption of , after named dayJuly", -5.097424424168647),
                                    ...
                                    ("hhhmmyear (latent)", -4.760952187547434),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.013715156042802),
                                    ("at <time-of-day>intersect", -5.097424424168647),
                                    ("hh:mmyear (latent)", -4.627420794922911),
                                    ("Holiyear (latent)", -6.013715156042802),
                                    ("until <time><time-of-day> am|pm", -6.013715156042802),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.6082500479346375),
                                    ("dayminute", -3.1805018119865855),
                                    ("yyyy-mm-ddhh:mm", -5.6082500479346375),
                                    ("intersectfrom|since|after <time>", -5.6082500479346375),
                                    ("intersectSeptember", -4.14191297914121),
                                    ("minuteday", -2.8567147348926882),
                                    ...
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.013715156042802),
                                    ("at <time-of-day>on <day>", -5.097424424168647),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.14874526126035031, unseen = -5.37989735354046,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 212},
                   koData =
                     ClassData{prior = -1.9789710113162013,
                               unseen = -3.6635616461296463,
                               likelihoods =
                                 HashMap.fromList
