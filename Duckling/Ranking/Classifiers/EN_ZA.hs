...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6015338626369465, unseen = -5.700443573390687,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 297},
                   koData =
                     ClassData{prior = -0.7940077908949192,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.473661426455493, unseen = -6.71174039505618,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.017375928892483),
                                    ("Ramadanyear (latent)", -6.017375928892483),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.764612960397115),
                                    ("Bhai Doojyear (latent)", -6.017375928892483),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.764612960397115),
                                    ("hourday", -4.312627836654058),
                                    ("dayhour", -3.1841625848362667),
                                    ("Martin Luther King's Dayyear (latent)", -5.611910820784319),
                                    ("Shemini Atzeretyear (latent)", -6.017375928892483),
                                    ("daymonth", -5.101085197018328),
                                    ("monthday", -5.611910820784319),
                                    ("monthyear", -4.225616459664428),
                                    ("Yom Ha'atzmautyear (latent)", -6.017375928892483),
                                    ("Vijayadashamiyear (latent)", -6.017375928892483),
                                    ("Thai Pongalyear (latent)", -5.324228748332538),
                                    ("Thiru Onamyear (latent)", -5.324228748332538),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.017375928892483),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.017375928892483),
                                    ("houryear", -5.324228748332538),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.017375928892483),
                                    ("Christmas<time-of-day> am|pm", -6.017375928892483),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.017375928892483),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.324228748332538),
                                    ("<time-of-day> am|pmintersect", -4.764612960397115),
                                    ("Earth Houryear (latent)", -6.017375928892483),
                                    ("Octoberyear (latent)", -4.513298532116209),
                                    ("intersect<time-of-day> am|pm", -6.017375928892483),
                                    ("Mattu Pongalyear (latent)", -6.017375928892483),
                                    ("Shavuotyear (latent)", -6.017375928892483),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.017375928892483),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.017375928892483),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.611910820784319),
                                    ("Marchyear (latent)", -6.017375928892483),
                                    ("Sukkotyear (latent)", -5.611910820784319),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.017375928892483),
                                    ("Clean Mondayyear (latent)", -5.611910820784319),
                                    ("monthhour", -5.611910820784319),
                                    ("todayat <time-of-day>", -6.017375928892483),
                                    ("Thursday<time> timezone", -4.07146577983717),
                                    ("from|since|after <time>December", -6.017375928892483),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.017375928892483),
                                    ("yyyy-mm-ddhh:mm:ss", -5.611910820784319),
                                    ("dayday", -4.002472908350218),
                                    ("<time> <part-of-day>at <time-of-day>", -6.017375928892483),
                                    ("tonightat <time-of-day>", -6.017375928892483),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.324228748332538),
                                    ("today<time-of-day> am|pm", -6.017375928892483),
                                    ("Februarythe <day-of-month> (ordinal)", -5.611910820784319),
                                    ("at <time-of-day><time> <part-of-day>", -6.017375928892483),
                                    ("hourhour", -4.764612960397115),
                                    ("<time-of-day> am|pmon <date>", -4.002472908350218),
                                    ("Navaratriin|during <named-month>|year", -6.017375928892483),
                                    ("Wednesdaythis|last|next <cycle>", -6.017375928892483),
                                    ("Lentyear (latent)", -6.017375928892483),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.513298532116209),
                                    ("Boghiyear (latent)", -6.017375928892483),
                                    ("dayyear", -2.037694274990522),
                                    ("Thursdayfrom|since|after <time>", -5.611910820784319),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.017375928892483),
                                    ("Thursdayat <time-of-day>", -5.324228748332538),
                                    ("Islamic New Yearyear (latent)", -5.611910820784319),
                                    ("Laylat al-Qadryear (latent)", -5.101085197018328),
                                    ("Shrove Tuesdayyear (latent)", -6.017375928892483),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.324228748332538),
                                    ("<time-of-day> am|pmtomorrow", -5.324228748332538),
                                    ("Yom Kippuryear (latent)", -6.017375928892483),
                                    ("<part-of-day> of <time>year (latent)", -6.017375928892483),
                                    ("minutehour", -5.101085197018328),
                                    ("Kaanum Pongalyear (latent)", -5.611910820784319),
                                    ("Maha Saptamiyear (latent)", -6.017375928892483),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.611910820784319),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.312627836654058),
                                    ("for <duration> from <time>December", -6.017375928892483),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.017375928892483),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.101085197018328),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -5.611910820784319),
                                    ("Pentecostyear (latent)", -6.017375928892483),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.101085197018328),
                                    ("Eid al-Fitryear (latent)", -6.017375928892483),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.017375928892483),
                                    ("Mondayin|during the <part-of-day>", -6.017375928892483),
                                    ("Chhathin|during <named-month>|year", -6.017375928892483),
                                    ("Diwaliin|during <named-month>|year", -6.017375928892483),
                                    ("Raksha Bandhanyear (latent)", -6.017375928892483),
                                    ("daysecond", -5.611910820784319),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.611910820784319),
                                    ("Ashurayear (latent)", -6.017375928892483),
                                    ("Tuesdayin|during <named-month>|year", -6.017375928892483),
                                    ("Chinese New Yearyear (latent)", -6.017375928892483),
                                    ("Lag BaOmeryear (latent)", -6.017375928892483),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.017375928892483),
                                    ("Eid al-Adhayear (latent)", -5.101085197018328),
                                    ("intersectin|during the <part-of-day>", -6.017375928892483),
                                    ("Palm Sundayyear (latent)", -6.017375928892483),
                                    ("Christmasat <time-of-day>", -6.017375928892483),
                                    ("Passoveryear (latent)", -6.017375928892483),
                                    ("Lazarus Saturdayyear (latent)", -6.017375928892483),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.017375928892483),
                                    ("Yom HaShoahyear (latent)", -5.611910820784319),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.611910820784319),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.017375928892483),
                                    ("Septemberyear (latent)", -5.611910820784319),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.764612960397115),
                                    ("Halloweenyear (latent)", -6.017375928892483),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.017375928892483),
                                    ("at <time-of-day>intersect", -5.611910820784319),
                                    ("Rosh Hashanahyear (latent)", -5.324228748332538),
                                    ("Dhanterasyear (latent)", -6.017375928892483),
                                    ("Tu BiShvatyear (latent)", -6.017375928892483),
                                    ("Holiyear (latent)", -5.324228748332538),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.017375928892483),
                                    ("Holika Dahanyear (latent)", -5.324228748332538),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.017375928892483),
                                    ("dayminute", -3.343227279465954),
                                    ("Mawlidyear (latent)", -6.017375928892483),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.611910820784319),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.017375928892483),
                                    ("Jumu'atul-Widayear (latent)", -5.101085197018328),
                                    ("minuteday", -2.379789769166097),
                                    ("absorption of , after named dayintersect",
                                     -6.017375928892483),
                                    ("Orthodox Easter Sundayyear (latent)", -6.017375928892483),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.017375928892483),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.017375928892483),
                                    ("Boss's Dayyear (latent)", -5.611910820784319),
                                    ("Global Youth Service Dayyear (latent)", -6.017375928892483),
                                    ("Dhanterasin|during <named-month>|year", -6.017375928892483),
                                    ("Tisha B'Avyear (latent)", -6.017375928892483),
                                    ("Isra and Mi'rajyear (latent)", -5.101085197018328),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.017375928892483),
                                    ("Christmasyear (latent)", -5.611910820784319),
                                    ("Naraka Chaturdashiyear (latent)", -5.611910820784319),
                                    ("at <time-of-day>on <date>", -4.918763640224373),
                                    ("Thai Pongalin|during <named-month>|year", -6.017375928892483),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.407938016458383),
                                    ("dayweek", -6.017375928892483),
                                    ("Easter Sundayyear (latent)", -5.324228748332538),
                                    ("weekyear", -4.918763640224373),
                                    ("hh:mmin|during the <part-of-day>", -5.324228748332538),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.611910820784319),
                                    ("Hanukkahyear (latent)", -5.324228748332538),
                                    ("February<time> <part-of-day>", -6.017375928892483),
                                    ("Great Lentyear (latent)", -6.017375928892483),
                                    ("tomorrowat <time-of-day>", -5.324228748332538),
                                    ("between <time> and <time>on <date>", -4.407938016458383),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.017375928892483),
                                    ("last <cycle> of <time>year (latent)", -5.324228748332538),
                                    ("at <time-of-day>tomorrow", -5.611910820784319),
                                    ("tomorrow<time-of-day> am|pm", -6.017375928892483),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.017375928892483),
                                    ("Diwaliyear (latent)", -6.017375928892483),
                                    ("Black Fridayyear (latent)", -5.611910820784319),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.017375928892483),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.017375928892483),
                                    ("Chhathyear (latent)", -5.611910820784319),
                                    ("Vasant Panchamiyear (latent)", -6.017375928892483),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.017375928892483),
                                    ("Februaryintersect", -6.017375928892483),
                                    ("Simchat Torahyear (latent)", -6.017375928892483),
                                    ("minuteyear", -6.017375928892483)],
                               n = 307},
                   koData =
                     ClassData{prior = -0.9747625003294887, unseen = -6.363028103540465,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.751864565138895),
                                    ("hourday", -4.751864565138895),
                                    ("dayhour", -3.1424266527047946),
                                    ("Tuesdayfrom|since|after <time>", -5.66815529701305),
                                    ("daymonth", -3.653252276470785),
                                    ("monthyear", -4.415392328517682),
                                    ("<time-of-day> am|pmyear (latent)", -5.262690188904886),
                                    ("Thai Pongalyear (latent)", -4.975008116453105),
                                    ("intersecthh:mm", -5.66815529701305),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.66815529701305),
                                    ("houryear", -4.751864565138895),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.66815529701305),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.975008116453105),
                                    ("<time-of-day> am|pmintersect", -4.415392328517682),
                                    ("until <time>on <date>", -4.975008116453105),
                                    ("Octoberyear (latent)", -5.66815529701305),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -4.975008116453105),
                                    ("about|exactly <time-of-day>year (latent)", -5.66815529701305),
                                    ("absorption of , after named dayJuly", -5.262690188904886),
                                    ("from|since|after <time>July", -5.66815529701305),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.751864565138895),
                                    ("Clean Mondayyear (latent)", -5.66815529701305),
                                    ("monthhour", -5.66815529701305),
                                    ("hourmonth", -4.751864565138895),
                                    ("todayat <time-of-day>", -5.66815529701305),
                                    ("from|since|after <time>December", -5.66815529701305),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.66815529701305),
                                    ("Mondayyear (latent)", -4.975008116453105),
                                    ("dayday", -5.262690188904886),
                                    ("<time-of-day> am|pmon <date>", -4.415392328517682),
                                    ("dayyear", -2.8059544160835816),
                                    ("Thursdaymm/dd", -5.66815529701305),
                                    ("New Year's Dayyear (latent)", -5.262690188904886),
                                    ("Thursdayfrom|since|after <time>", -3.9634072047746245),
                                    ("Thursdayat <time-of-day>", -4.05871738457895),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.66815529701305),
                                    ("Aprilyear (latent)", -5.66815529701305),
                                    ("monthminute", -5.66815529701305),
                                    ("<time-of-day> am|pmtomorrow", -5.66815529701305),
                                    ("Thursdayhh:mm", -4.751864565138895),
                                    ("minutemonth", -3.876395827784995),
                                    ("Augustyear (latent)", -5.262690188904886),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.262690188904886),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.262690188904886),
                                    ("week-endin|during <named-month>|year", -5.66815529701305),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.66815529701305),
                                    ("Sundayyear (latent)", -4.751864565138895),
                                    ("Christmasat <time-of-day>", -5.66815529701305),
                                    ("from|since|after <time>year (latent)", -4.56954300834494),
                                    ("<duration> after|before|from <time>December",
                                     -5.66815529701305),
                                    ("yesterday<time-of-day> am|pm", -5.66815529701305),
                                    ...
                                    ("hh:mmyear (latent)", -4.56954300834494),
                                    ("Holiyear (latent)", -5.66815529701305),
                                    ("until <time><time-of-day> am|pm", -5.66815529701305),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.66815529701305),
                                    ("dayminute", -2.927315273087849),
                                    ("yyyy-mm-ddhh:mm", -5.262690188904886),
                                    ("intersectSeptember", -4.164077900236776),
                                    ("minuteday", -2.6001023618794328),
                                    ("absorption of , after named dayintersect", -5.66815529701305),
                                    ("Februaryin|during the <part-of-day>", -5.66815529701305),
                                    ("hh:mmon <date>", -3.653252276470785),
                                    ("Saturdayyear (latent)", -5.66815529701305),
                                    ("from|since|after <time>on <date>", -4.751864565138895),
                                    ("absorption of , after named daySeptember",
                                     -4.751864565138895),
                                    ("Naraka Chaturdashiyear (latent)", -5.66815529701305),
                                    ("on <date>September", -5.262690188904886),
                                    ("at <time-of-day>on <date>", -5.262690188904886),
                                    ("dayweek", -5.66815529701305),
                                    ("Easter Sundayyear (latent)", -5.262690188904886),
                                    ("Thursday<time-of-day> am|pm", -4.56954300834494),
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.5745414381520983,
                               unseen = -4.3694478524670215,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 76},
                   koData =
                     ClassData{prior = -0.8277373345327099, unseen = -4.127134385045092,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.19022673630106793,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("from|since|after <time>", -3.8110970868381857),
                                    ("integer after|past <hour-of-day>", -4.034240638152395),
                                    ("at <time-of-day>", -2.201659174404085),
                                    ("<time-of-day> o'clock", -4.321922710604176),
                                    ("half after|past <hour-of-day>", -4.321922710604176),
                                    ("<hour-of-day> <integer>", -3.8110970868381857),
                                    ("time-of-day (latent)", -1.7316555451583495),
                                    ("hhmm (latent)", -4.727387818712341),
                                    ("hh:mm", -2.3760125615488628),
                                    ("quarter after|past <hour-of-day>", -4.727387818712341),
                                    ("until <time>", -4.034240638152395),
                                    ("about|exactly <time-of-day>", -4.727387818712341),
                                    ("hour", -1.2158423798813198),
                                    ("<time-of-day> sharp|exactly", -4.727387818712341),
                                    ("minute", -1.7316555451583495)],
                               n = 105},
                   koData =
                     ClassData{prior = -1.7531446331002754, unseen = -4.110873864173311,
                               likelihoods =
                                 HashMap.fromList
