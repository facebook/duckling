                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("el <day-of-month> (non ordinal)intersect by `de`",
                                     -3.6463198396951406),
                                    ("day of month (1st)named-month", -3.1354942159291497),
                                    ("daymonth", -1.7004096906398272),
                                    ("monthyear", -3.6463198396951406),
                                    ("named-dayel proximo <cycle> ", -4.051784947803305),
                                    ("named-dayla <cycle> pasado", -4.051784947803305),
                                    ("el <time>named-month", -3.6463198396951406),
                                    ("dayyear", -2.3470368555648795),
                                    ("dd-dd <month>(interval)year", -4.051784947803305),
                                    ("el <time>el <cycle> (proximo|que viene)", -4.051784947803305),
                                    ("two time tokens separated by \",\"named-month",
                                     -4.051784947803305),
                                    ("named-monthyear", -3.6463198396951406),
                                    ("el <time>year", -3.6463198396951406),
                                    ("el <time>la <cycle> pasado", -4.051784947803305),
                                    ("el <day-of-month> de <named-month>year", -3.6463198396951406),
                                    ("el <time>este|en un <cycle>", -3.6463198396951406),
                                    ("named-dayel <cycle> (proximo|que viene)", -4.051784947803305),
                                    ("el <day-of-month> (non ordinal)named-month",
                                     -2.3470368555648795),
                                    ("<day-of-month> de <named-month>year", -3.6463198396951406),
                                    ("two time tokens separated by \",\"intersect by `de`",
                                     -4.051784947803305),
                                    ("dayweek", -2.3470368555648795),
                                    ("intersect by `de`year", -3.3586377672433594),
                                    ("named-dayeste|en un <cycle>", -3.3586377672433594)],
                               n = 42},
                   koData =
                     ClassData{prior = -1.8325814637483102, unseen = -3.871201010907891,
                               likelihoods =
                                 HashMap.fromList
                                   [("monthyear", -3.1570004211501135),
                                    ("hourmonth", -2.751535313041949),
                                    ("monthmonth", -3.1570004211501135),
                                    ("a las <time-of-day>named-month", -2.751535313041949),
                                    ("dayyear", -3.1570004211501135),
                                    ("minutemonth", -2.751535313041949),
                                    ("named-monthyear", -3.1570004211501135),
                                    ("de <datetime> - <datetime> (interval)named-month",
                                     -3.1570004211501135),
                                    ("<hour-of-day> <integer> (as relative minutes)named-month",
                                     -3.1570004211501135),
                                    ("<day-of-month> de <named-month>year", -3.1570004211501135),
                                    ("intersect by `de`year", -3.1570004211501135),
                                    ("<hour-of-day> <integer> (as relative minutes)intersect by `de`",
                                     -3.1570004211501135),
                                    ("minuteyear", -3.1570004211501135)],
                               n = 8}}),
       ("n pasados <cycle>",
        Classifier{okData =
