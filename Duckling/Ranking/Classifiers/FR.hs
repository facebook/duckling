  ...
  = HashMap.fromList
      [("n derniers <cycle>",
       ...
       ("du|dans le <part-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.7221347174331976,
                               unseen = -3.6635616461296463,
                               likelihoods =
                                 HashMap.fromList
                                   [("soir", -1.3350010667323402),
                                    ("apr\232s-midi", -2.0281482472922856),
                                    ("matin", -2.0281482472922856), ("hour", -0.7472144018302211)],
                               n = 17},
                   koData =
                     ClassData{prior = -0.6649763035932491, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
                                   [("soir", -2.3025850929940455),
                                    ("apr\232s-midi", -2.3025850929940455),
                                    ("matin", -1.1239300966523995), ("hour", -0.7444404749474959)],
                               n = 18}}),
       ("dans <duration>",
        Classifier{okData =
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.2649710281915663, unseen = -7.10085190894405,
                               likelihoods =
                                 HashMap.fromList
                                   [("apr\232s <time-of-day>named-month", -5.713732805509369),
                                    ("intersect<dim time> du matin", -6.0014148779611505),
                                    ("<hour-of-day> <integer> (as relative minutes)intersect",
                                     -6.0014148779611505),
                                    ("hh(:|h)mm (time-of-day)named-day", -6.0014148779611505),
                                    ("<day-of-month> <named-month>d\233but de journ\233e",
                                     -6.406879986069314),
                                    ("demain<time-of-day> heures", -6.0014148779611505),
                                    ("hourday", -4.155588187462819),
                                    ("<day-of-month> <named-month>year", -5.713732805509369),
                                    ("dayhour", -1.627756492957785),
                                    ("daymonth", -2.9891533024559487),
                                    ("monthyear", -4.9028025892930405),
                                    ("<day-of-month> <named-month>d\233but de matin\233e",
                                     -6.406879986069314),
                                    ("dernier <cycle> de <time> (latent)year", -5.490589254195159),
                                    ("aujourd'huimilieu d'apr\232s-midi", -6.406879986069314),
                                    ("named-month<dim time> du matin", -6.0014148779611505),
                                    ("<day-of-month> <named-month>\224|vers <time-of-day>",
                                     -4.266813822573043),
                                    ("dd mmyear", -5.154117017573946),
                                    ("named-monthd\233but d'apr\232s-midi", -6.406879986069314),
                                    ("aujourd'huifin d'apr\232s-midi", -6.406879986069314),
                                    ("le <day-of-month> (non ordinal)<dim time> du matin",
                                     -6.0014148779611505),
                                    ("named-monthd\233but de matin\233e", -6.406879986069314),
                                    ("aujourd'huimilieu de matin\233e", -6.406879986069314),
                                    ("hh(:|h)mm (time-of-day)<day-of-week> <day-of-month>",
                                     -6.406879986069314),
                                    ("named-month\224|vers <time-of-day>", -5.154117017573946),
                                    ("named-dayday of month (premier)", -5.713732805509369),
                                    ("<time-of-day> heuresdu|dans le <part-of-day>",
                                     -5.308267697401205),
                                    ("named-monthd\233but de soir\233e", -6.406879986069314),
                                    ("<hour-of-day> et quart<dim time> <part-of-day>",
                                     -5.713732805509369),
                                    ("<day-of-week> <day-of-month>named-month", -5.713732805509369),
                                    ("le <time>du|dans le <part-of-day>", -6.0014148779611505),
                                    ("aujourd'huifin de matin\233e", -6.406879986069314),
                                    ("aujourd'huifin de soir\233e", -6.406879986069314),
                                    ("\224|vers <time-of-day>ce <part-of-day>", -5.713732805509369),
                                    ("<day-of-month> <named-month>d\233but d'apr\232s-midi",
                                     -6.406879986069314),
                                    ("le <day-of-month> (non ordinal)<dim time> du soir",
                                     -5.154117017573946),
                                    ("named-monthmilieu de matin\233e", -6.406879986069314),
                                    ("aujourd'huid\233but de soir\233e", -6.406879986069314),
                                    ("named-monthfin de soir\233e", -6.406879986069314),
                                    ("entre <datetime> et <datetime> (interval)named-day",
                                     -6.0014148779611505),
                                    ("<hour-of-day> et demice <part-of-day>", -5.713732805509369),
                                    ("le <time>fin de matin\233e", -6.406879986069314),
                                    ("intersectmilieu de journ\233e", -6.406879986069314),
                                    ("intersectfin de journ\233e", -6.406879986069314),
                                    ("le <day-of-month> (non ordinal)<time-of-day> heures",
                                     -4.797442073635215),
                                    ...
                                    ("le <day-of-month> (non ordinal)named-month",
                                     -3.841930628607778),
                                    ("monthhour", -3.96453295070011),
                                    ("le <time><time-of-day> heures", -5.308267697401205),
                                    ("le <time>fin d'apr\232s-midi", -6.406879986069314),
                                    ("hourmonth", -4.9028025892930405),
                                    ("named-monthmilieu d'apr\232s-midi", -6.406879986069314),
                                    ("<time-of-day> heuresle <time>", -4.9028025892930405),
                                    ("dayday", -4.055504728905837),
                                    ("aujourd'hui<hour-of-day> <integer> (as relative minutes)",
                                     -5.713732805509369),
                                    ("apr\232s <time-of-day>named-day", -6.0014148779611505),
                                    ("named-dayle <cycle> prochain|suivant|d'apr\232s",
                                     -5.020585624949423),
                                    ("named-dayapr\232s <time-of-day>", -5.308267697401205),
                                    ("hourhour", -4.055504728905837),
                                    ("<day-of-week> <day-of-month>\224|vers <time-of-day>",
                                     -4.702131893830889),
                                    ("le <time>intersect", -6.406879986069314),
                                    ("\224|vers <time-of-day><dim time> <part-of-day>",
                                     -6.406879986069314),
                                    ("aujourd'huiau d\233jeuner", -6.406879986069314),
                                    ("<time-of-day> heuresintersect", -5.490589254195159),
                                    ("intersectnamed-month", -4.797442073635215),
                                    ("intersect<time-of-day> heures", -5.713732805509369),
                                    ("<hour-of-day> et quartce <part-of-day>", -5.713732805509369),
                                    ("dayyear", -4.0089847132709435),
                                    ("named-dayce|dans le <cycle>", -5.713732805509369),
                                    ("apr\232s-demain\224|vers <time-of-day>", -5.490589254195159),
                                    ("intersectfin d'apr\232s-midi", -6.406879986069314),
                                    ("le <ordinal> <cycle> de <time>year", -6.406879986069314),
                                    ("intersectmilieu d'apr\232s-midi", -6.406879986069314),
                                    ("named-monthfin de journ\233e", -6.406879986069314),
                                    ("le <time>milieu de journ\233e", -6.406879986069314),
                                    ("aujourd'huid\233but de journ\233e", -6.406879986069314),
                                    ("demain\224|vers <time-of-day>", -5.490589254195159),
                                    ("le <day-of-month> (non ordinal)intersect",
                                     -3.698829784967104),
                                    ("hourminute", -6.406879986069314),
                                    ("dd-dd <month>(interval)year", -6.406879986069314),
                                    ("intersect<day-of-month> <named-month>", -6.0014148779611505),
                                    ("minutemonth", -6.0014148779611505),
                                    ("\224|vers <time-of-day>demain", -6.406879986069314),
                                    ("minutehour", -4.535077809167723),
                                    ("named-daydu|dans le <part-of-day>", -6.0014148779611505),
                                    ("aujourd'huimilieu de journ\233e", -6.406879986069314),
                                    ("named-monthyear", -4.9028025892930405),
                                    ("intersectd\233but de soir\233e", -6.406879986069314),
                                    ("entre <datetime> et <datetime> (interval)named-month",
                                     -6.406879986069314),
                                    ("aujourd'huifin de journ\233e", -6.406879986069314),
                                    ("intersectdu|dans le <part-of-day>", -4.9028025892930405),
                                    ("le <day-of-month> \224 <datetime>du|dans le <part-of-day>",
                                     -6.406879986069314),
                                    ("named-monthd\233but de journ\233e", -6.406879986069314),
                                    ("le <day-of-month> (non ordinal)apr\232s <time-of-day>",
                                     -6.406879986069314),
                                    ("named-day<day-of-month> <named-month>", -5.713732805509369),
                                    ("named-dayle <time>", -4.266813822573043),
                                    ("le <day-of-month> (non ordinal)<dim time> <part-of-day>",
                                     -4.209655408733095),
                                    ("dd/-mm<time-of-day> heures", -6.0014148779611505),
                                    ("de <datetime> - <datetime> (interval)named-month",
                                     -6.0014148779611505),
                                    ("apr\232s <time-of-day>le <time>", -5.490589254195159),
                                    ("named-day<time-of-day> heures", -5.713732805509369),
                                    ("intersectd\233but d'apr\232s-midi", -6.406879986069314),
                                    ("named-dayfin d'apr\232s-midi", -6.0014148779611505),
                                    ("<hour-of-day> et quartdemain", -5.713732805509369),
                                    ("<time-of-day> heuresce <time>", -6.406879986069314),
                                    ("le <time>d\233but d'apr\232s-midi", -6.406879986069314),
                                    ("<day-of-month> <named-month>du|dans le <part-of-day>",
                                     -6.0014148779611505),
                                    ("named-dayintersect", -6.406879986069314),
                                    ("le <time><dim time> du matin", -6.0014148779611505),
                                    ("apr\232s <time-of-day>intersect", -6.0014148779611505),
                                    ("le <day-of-month> (non ordinal)\224|vers <time-of-day>",
                                     -4.460969837014002),
                                    ("<day-of-month> <named-month>d\233but de soir\233e",
                                     -6.406879986069314),
                                    ("hierdu|dans le <part-of-day>", -6.406879986069314),
                                    ("le <time>d\233but de soir\233e", -6.406879986069314),
                                    ("dayminute", -4.702131893830889),
                                    ("intersectd\233but de journ\233e", -6.406879986069314),
                                    ("<ordinal> <cycle> de <time>year", -6.0014148779611505),
                                    ("le <time>\224|vers <time-of-day>", -4.702131893830889),
                                    ("<day-of-month> <named-month><dim time> du matin",
                                     -6.0014148779611505),
                                    ("intersectyear", -5.713732805509369),
                                    ("<day-of-week> <day-of-month><time-of-day> heures",
                                     -5.308267697401205),
                                    ("minuteday", -3.4364655204996133),
                                    ("le <time>d\233but de matin\233e", -6.406879986069314),
                                    ("<datetime> - <datetime> (interval)named-month",
                                     -5.154117017573946),
                                    ("<day-of-month> <named-month><time-of-day> heures",
                                     -4.9028025892930405),
                                    ("aujourd'hui\224|vers <time-of-day>", -5.490589254195159),
                                    ("<day-of-month> <named-month>milieu d'apr\232s-midi",
                                     -6.406879986069314),
                                    ("day of month (premier)intersect", -6.406879986069314),
                                    ("<day-of-month> <named-month>fin d'apr\232s-midi",
                                     -6.406879986069314),
                                    ("entre <time-of-day> et <time-of-day> (interval)named-day",
                                     -6.0014148779611505),
                                    ("named-monthfin de matin\233e", -6.406879986069314),
                                    ("named-day<named-month|named-day> suivant|d'apr\232s",
                                     -5.490589254195159),
                                    ("le <time>milieu de matin\233e", -6.406879986069314),
                                    ("aujourd'huid\233but de matin\233e", -5.308267697401205),
                                    ("<dim time> <part-of-day>apr\232s <time-of-day>",
                                     -6.406879986069314),
                                    ("le <time>fin de soir\233e", -6.406879986069314),
                                    ("<day-of-month> <named-month>milieu de matin\233e",
                                     -6.406879986069314),
                                    ("<day-of-month> <named-month>fin de soir\233e",
                                     -6.406879986069314),
                                    ("named-month<time-of-day> heures", -5.713732805509369),
                                    ("<day-of-month> <named-month>fin de matin\233e",
                                     -6.406879986069314),
                                    ("<time-of-day> heuresce <part-of-day>", -5.713732805509369),
                                    ("named-monthfin d'apr\232s-midi", -6.406879986069314),
                                    ("le <time>named-month", -5.154117017573946),
                                    ("apr\232s le <day-of-month>named-month", -6.406879986069314),
                                    ("aujourd'huid\233but d'apr\232s-midi", -6.406879986069314),
                                    ("le <time>milieu d'apr\232s-midi", -6.406879986069314),
                                    ...
                                    ("weekyear", -5.020585624949423),
                                    ("<hour-of-day> <integer> (as relative minutes)named-day",
                                     -6.0014148779611505),
                                    ("hh(:|h)mm (time-of-day)intersect", -6.0014148779611505),
                                    ("<day-of-month> <named-month>fin de journ\233e",
                                     -6.406879986069314),
                                    ("<day-of-month> <named-month>milieu de journ\233e",
                                     -6.406879986069314),
                                    ("le <time>fin de journ\233e", -6.406879986069314),
                                    ("dd/-mm\224|vers <time-of-day>", -5.490589254195159),
                                    ("intersectfin de matin\233e", -6.406879986069314),
                                    ("day of month (premier)named-month", -4.61512051684126),
                                    ("named-day\224|vers <time-of-day>", -5.020585624949423),
                                    ("named-monthmilieu de journ\233e", -6.406879986069314),
                                    ("intersectfin de soir\233e", -6.406879986069314),
                                    ("intersectmilieu de matin\233e", -6.406879986069314),
                                    ("intersect\224|vers <time-of-day>", -5.154117017573946),
                                    ("le <time>year", -4.9028025892930405),
                                    ("<time-of-day> - <time-of-day> (interval)named-day",
                                     -5.154117017573946),
                                    ("apr\232s-demain<time-of-day> heures", -6.0014148779611505),
                                    ("le <time>d\233but de journ\233e", -6.406879986069314),
                                    ("intersectd\233but de matin\233e", -6.406879986069314),
                                    ("<datetime> - <datetime> (interval)named-day",
                                     -5.490589254195159)],
                               n = 501},
                   koData =
                     ClassData{prior = -1.4576966084301546, unseen = -6.244166900663736,
                               likelihoods =
                                 HashMap.fromList
                                   [("<hour-of-day> <integer> (as relative minutes)intersect",
                                     -5.54907608489522),
                                    ("hh(:|h)mm (time-of-day)named-day", -5.54907608489522),
                                    ("year<time-of-day> - <time-of-day> (interval)",
                                     -4.855928904335275),
                                    ("demain<time-of-day> heures", -4.855928904335275),
                                    ("hourday", -3.197700827731742),
                                    ("<day-of-month> <named-month>year", -5.54907608489522),
                                    ("demainavant <time-of-day>", -5.54907608489522),
                                    ("dayhour", -2.5045536471717966),
                                    ("le lendemain du <time>named-month", -5.54907608489522),
                                    ("daymonth", -3.9396381724611196),
                                    ("monthday", -5.54907608489522),
                                    ("monthyear", -4.855928904335275),
                                    ("yearhour", -4.855928904335275),
                                    ("houryear", -5.1436109767870555),
                                    ("aujourd'hui<time-of-day> heures", -5.54907608489522),
                                    ("named-month\224|vers <time-of-day>", -3.8443279926567944),
                                    ("<time-of-day> heuresdu|dans le <part-of-day>",
                                     -5.1436109767870555),
                                    ("<day-of-week> <day-of-month>named-month", -4.162781723775329),
                                    ("le <time>du|dans le <part-of-day>", -5.54907608489522),
                                    ("le <day-of-month> (non ordinal)<hour-of-day> <integer> (as relative minutes)",
                                     -4.855928904335275),
                                    ("named-month<day-of-month> <named-month>", -5.54907608489522),
                                    ("<time-of-day> heuresle <day-of-month> (non ordinal)",
                                     -4.632785353021065),
                                    ("le <day-of-month> (non ordinal)<time-of-day> heures",
                                     -5.54907608489522),
                                    ("aujourd'huidu|dans le <part-of-day>", -5.1436109767870555),
                                    ("le <day-of-month> (non ordinal)named-month",
                                     -5.54907608489522),
                                    ("monthhour", -3.3518515075590005),
                                    ("hourmonth", -4.296313116399852),
                                    ("dayday", -3.7573166156671647),
                                    ("named-dayapr\232s <time-of-day>", -4.855928904335275),
                                    ("hourhour", -4.296313116399852),
                                    ("named-day<hour-of-day> <integer> (as relative minutes)",
                                     -4.632785353021065),
                                    ("dayyear", -4.296313116399852),
                                    ("le <cycle> de <time>named-month", -5.1436109767870555),
                                    ("year<hour-of-day> <integer> (as relative minutes)",
                                     -4.855928904335275),
                                    ("demain\224|vers <time-of-day>", -4.632785353021065),
                                    ("<dim time> <part-of-day><hour-of-day> <integer> (as relative minutes)",
                                     -5.1436109767870555),
                                    ("hourminute", -5.1436109767870555),
                                    ("minutemonth", -4.855928904335275),
                                    ("named-monthyear", -4.855928904335275),
                                    ("intersect by 'de' or ','year", -5.1436109767870555),
                                    ("named-day<time-of-day> - <time-of-day> (interval)",
                                     -3.8443279926567944),
                                    ("named-day<datetime> - <datetime> (interval)",
                                     -5.1436109767870555),
                                    ("named-day<day-of-month> <named-month>", -4.162781723775329),
                                    ("weekmonth", -5.1436109767870555),
                                    ("named-dayle <time>", -5.1436109767870555),
                                    ("avant <time-of-day>named-day", -5.54907608489522),
                                    ("de <datetime> - <datetime> (interval)named-month",
                                     -5.54907608489522),
                                    ("le <day-of-month> (non ordinal)year", -5.1436109767870555),
                                    ("named-day<time-of-day> heures", -5.1436109767870555),
                                    ("<time-of-day> heuresnamed-day", -4.0449986881189455),
                                    ("apr\232s <time-of-day><time-of-day> heures",
                                     -5.1436109767870555),
                                    ("<time-of-day> heuresdd/-mm", -5.54907608489522),
                                    ...
                                    ("le <day-of-month> (non ordinal)\224|vers <time-of-day>",
                                     -4.855928904335275),
                                    ("dayminute", -4.162781723775329),
                                    ("named-monthdu|dans le <part-of-day>", -5.1436109767870555),
                                    ("intersectyear", -5.1436109767870555),
                                    ("minuteday", -4.855928904335275),
                                    ("aujourd'hui\224|vers <time-of-day>", -4.855928904335275),
                                    ("<datetime>-dd <month>(interval)year", -5.1436109767870555),
                                    ...
                                    ("<dim time> <part-of-day>apr\232s <time-of-day>",
                                     -5.54907608489522),
                                    ("named-month<time-of-day> heures", -4.45046379622711),
                                    ("demainapr\232s <time-of-day>", -5.54907608489522),
                                    ("<hour-of-day> <integer> (as relative minutes)named-day",
                                     -5.1436109767870555),
                                    ...
                                    ("apr\232s <time-of-day>\224|vers <time-of-day>",
                                     -4.632785353021065),
                                    ("\224|vers <time-of-day>named-day", -4.855928904335275),
                                    ("le <time>year", -5.1436109767870555),
                                    ("apr\232s <time-of-day>le <day-of-month> (non ordinal)",
                                     -5.1436109767870555),
                                    ("de <datetime> - <datetime> (interval)<day-of-month> <named-month>",
                                     -5.54907608489522),
                                    ("minuteyear", -4.162781723775329),
                                    ("yearminute", -4.855928904335275),
       ...
       ("le <day-of-month> \224 <datetime>",
        Classifier{okData =
                     ClassData{prior = -0.3746934494414107,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)<time-of-day> heures", -1.824549292051046),
                                    ("integer (numeric)<dim time> du soir", -2.740840023925201),
                                    ("integer (numeric)intersect", -2.740840023925201),
                                    ("integer (numeric)<dim time> du matin", -2.740840023925201),
                                    ("hour", -0.9490805546971459),
                                    ("integer (numeric)time-of-day (latent)", -2.0476928433652555),
       ...
       ("<dim time> <part-of-day>",
        Classifier{okData =
                     ClassData{prior = -7.08260525686124e-2, unseen = -5.71042701737487,
                               likelihoods =
                                 HashMap.fromList
                                   [("<day-of-month> <named-month>d\233but de journ\233e",
                                     -5.01396308418893),
                                    ("dayhour", -1.487602559572769),
                                    ("<day-of-month> <named-month>d\233but de matin\233e",
                                     -5.01396308418893),
                                    ("aujourd'huimilieu d'apr\232s-midi", -5.01396308418893),
                                    ("named-monthd\233but d'apr\232s-midi", -5.01396308418893),
                                    ("aujourd'huifin d'apr\232s-midi", -5.01396308418893),
                                    ("named-monthd\233but de matin\233e", -5.01396308418893),
                                    ("aujourd'huimilieu de matin\233e", -5.01396308418893),
                                    ("<time-of-day> heuresdu|dans le <part-of-day>",
                                     -3.915350795520821),
                                    ("named-monthd\233but de soir\233e", -5.01396308418893),
                                    ("le <time>du|dans le <part-of-day>", -4.608497976080766),
                                    ("aujourd'huifin de matin\233e", -5.01396308418893),
                                    ("aujourd'huifin de soir\233e", -5.01396308418893),
                                    ("\224|vers <time-of-day>ce <part-of-day>",
                                     -4.3208159036289855),
                                    ("<day-of-month> <named-month>d\233but d'apr\232s-midi",
                                     -5.01396308418893),
                                    ("named-daymatin", -4.608497976080766),
                                    ("named-monthmilieu de matin\233e", -5.01396308418893),
                                    ("demainsoir", -5.01396308418893),
                                    ("aujourd'huid\233but de soir\233e", -5.01396308418893),
                                    ("named-monthfin de soir\233e", -5.01396308418893),
                                    ("<hour-of-day> et demice <part-of-day>", -4.3208159036289855),
                                    ("le <time>fin de matin\233e", -5.01396308418893),
                                    ("intersectmilieu de journ\233e", -5.01396308418893),
                                    ("intersectfin de journ\233e", -5.01396308418893),
                                    ("monthhour", -3.2222036149608755),
                                    ("le <time>fin d'apr\232s-midi", -5.01396308418893),
                                    ("named-monthmilieu d'apr\232s-midi", -5.01396308418893),
                                    ("hourhour", -2.7113779911948845),
                                    ("aujourd'huiau d\233jeuner", -5.01396308418893),
                                    ("<hour-of-day> et quartce <part-of-day>", -4.3208159036289855),
                                    ("intersectfin d'apr\232s-midi", -5.01396308418893),
                                    ("intersectmilieu d'apr\232s-midi", -5.01396308418893),
                                    ("named-monthfin de journ\233e", -5.01396308418893),
                                    ("le <time>milieu de journ\233e", -5.01396308418893),
                                    ("aujourd'huid\233but de journ\233e", -5.01396308418893),
                                    ("demainapr\232s-midi", -5.01396308418893),
                                    ("minutehour", -3.142160907287339),
                                    ("named-daydu|dans le <part-of-day>", -4.608497976080766),
                                    ("aujourd'huimilieu de journ\233e", -5.01396308418893),
                                    ("intersectd\233but de soir\233e", -5.01396308418893),
                                    ("aujourd'huifin de journ\233e", -5.01396308418893),
                                    ("intersectdu|dans le <part-of-day>", -3.5098856874126563),
                                    ("le <day-of-month> \224 <datetime>du|dans le <part-of-day>",
                                     -5.01396308418893),
                                    ("named-monthd\233but de journ\233e", -5.01396308418893),
                                    ("intersectd\233but d'apr\232s-midi", -5.01396308418893),
                                    ("named-dayfin d'apr\232s-midi", -4.608497976080766),
                                    ("le <time>d\233but d'apr\232s-midi", -5.01396308418893),
                                    ("<day-of-month> <named-month>du|dans le <part-of-day>",
                                     -4.608497976080766),
                                    ("<day-of-month> <named-month>d\233but de soir\233e",
                                     -5.01396308418893),
                                    ("hierdu|dans le <part-of-day>", -5.01396308418893),
                                    ("le <time>d\233but de soir\233e", -5.01396308418893),
                                    ("intersectd\233but de journ\233e", -5.01396308418893),
                                    ("le <time>d\233but de matin\233e", -5.01396308418893),
                                    ("<day-of-month> <named-month>milieu d'apr\232s-midi",
                                     -5.01396308418893),
                                    ("<day-of-month> <named-month>fin d'apr\232s-midi",
                                     -5.01396308418893),
                                    ("named-daysoir", -5.01396308418893),
                                    ("named-monthfin de matin\233e", -5.01396308418893),
                                    ("le <time>milieu de matin\233e", -5.01396308418893),
                                    ("aujourd'huid\233but de matin\233e", -3.915350795520821),
                                    ("le <time>fin de soir\233e", -5.01396308418893),
                                    ("<day-of-month> <named-month>milieu de matin\233e",
                                     -5.01396308418893),
                                    ("<day-of-month> <named-month>fin de soir\233e",
                                     -5.01396308418893),
                                    ("<day-of-month> <named-month>fin de matin\233e",
                                     -5.01396308418893),
                                    ("<time-of-day> heuresce <part-of-day>", -4.3208159036289855),
                                    ("named-monthfin d'apr\232s-midi", -5.01396308418893),
                                    ("aujourd'huid\233but d'apr\232s-midi", -5.01396308418893),
                                    ("le <time>milieu d'apr\232s-midi", -5.01396308418893),
                                    ("\224|vers <time-of-day>du|dans le <part-of-day>",
                                     -4.3208159036289855),
                                    ("<day-of-month> <named-month>fin de journ\233e",
                                     -5.01396308418893),
                                    ("<day-of-month> <named-month>milieu de journ\233e",
                                     -5.01396308418893),
                                    ("le <time>fin de journ\233e", -5.01396308418893),
                                    ("intersectfin de matin\233e", -5.01396308418893),
                                    ("named-monthmilieu de journ\233e", -5.01396308418893),
                                    ("named-dayapr\232s-midi", -5.01396308418893),
                                    ("intersectfin de soir\233e", -5.01396308418893),
                                    ("intersectmilieu de matin\233e", -5.01396308418893),
                                    ("intersectapr\232s-midi", -4.097672352314775),
                                    ("le <time>d\233but de journ\233e", -5.01396308418893),
                                    ("intersectd\233but de matin\233e", -5.01396308418893),
                                    ("hiersoir", -5.01396308418893)],
                               n = 109},
                   koData =
                     ClassData{prior = -2.68273239311792, unseen = -4.605170185988091,
                               likelihoods =
                                 HashMap.fromList
                                   [("dayhour", -3.4965075614664802),
                                    ("<time-of-day> heuresdu|dans le <part-of-day>",
                                     -3.4965075614664802),
                                    ("le <time>du|dans le <part-of-day>", -3.9019726695746444),
                                    ("aujourd'huidu|dans le <part-of-day>", -3.4965075614664802),
                                    ("monthhour", -3.4965075614664802),
                                    ("hourhour", -2.9856819377004897),
                                    ("<time-of-day> - <time-of-day> (interval)du|dans le <part-of-day>",
                                     -3.9019726695746444),
                                    ("named-monthdu|dans le <part-of-day>", -3.4965075614664802)],
                               n = 8}}),
       ("jour de l'an",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.3862943611198906,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.639057329615259),
                                    ("<named-month|named-day> suivant|d'apr\232s",
                                     -3.6999292903005214),
                                    ("<ordinal> <cycle> de <time>", -4.51085950651685),
                                    ("premi\232re quinzaine de <named-month>(interval)",
                                     -5.204006687076795),
                                    ("intersect", -2.068512471147646),
                                    ("soir de no\235l", -5.204006687076795),
                                    ("en semaine", -3.4992585948383703),
                                    ("toussaint", -4.7985415789686305),
                                    ("day", -1.3538590853667367),
                                    ("deuxi\232me quinzaine de <named-month>(interval)",
                                     -5.204006687076795),
                                    ("<dim time> <part-of-day>", -3.258096538021482),
                                    ("dd/-mm", -3.951243718581427),
                                    ("dd/-mm/-yyyy", -4.51085950651685),
                                    ("dd mm yyyy", -3.951243718581427),
                                    ("day of month (premier)", -3.951243718581427),
                                    ("dd mm", -3.951243718581427), ("hour", -2.02595285672885),
                                    ("month", -4.51085950651685),
                                    ("dernier <cycle> de <time> (latent)", -4.28771595520264),
                                    ("<day-of-month> <named-month>", -2.639057329615259),
                                    ("<cycle> prochain|suivant|d'apr\232s", -2.8526314299133175),
                                    ("dernier week-end de <time>", -5.204006687076795),
                                    ("<ordinal> week-end de <time>", -4.7985415789686305),
                                    ("<cycle> dernier", -4.105394398408686)],
                               n = 168},
                   koData =
                     ClassData{prior = -1.5040773967762742,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<named-month|named-day> suivant|d'apr\232s",
                                     -4.127134385045092),
                                    ("intersect", -3.4339872044851463),
                                    ("en semaine", -2.0476928433652555),
                                    ("day", -1.5244446996007077),
                                    ("<dim time> <part-of-day>", -4.127134385045092),
                                    ("dd/-mm", -3.4339872044851463),
                                    ("<named-month|named-day> dernier|pass\233",
                                     -3.721669276936927),
                                    ("day of month (premier)", -4.127134385045092),
                                    ("dd mm", -3.4339872044851463), ("hour", -2.2553322081435),
                                    ("<day-of-month> <named-month>", -4.127134385045092),
                                    ("<time-of-day> - <time-of-day> (interval)",
                                     -2.4223862928066664),
                                    ("minute", -2.4223862928066664),
                                    ("<hour-of-day> <integer> (as relative minutes)",
                                     -2.6230569882688175)],
                               n = 48}}),
