...
classifiers
  = HashMap.fromList
      [("<time> timezone",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7011153502091222, unseen = -4.844187086458591,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 125},
                   koData =
                     ClassData{prior = -0.6852420010528321, unseen = -4.859812404361672,
       ...
       ("<time> <part-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.1590646946296874, unseen = -4.997212273764115,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day>  o'clockmorning", -3.044522437723423),
                                    ("until <time-of-day>afternoon", -4.297285406218791),
                                    ("dayhour", -3.1986731175506815),
                                    ("todayevening", -4.297285406218791),
                                    ("on <date>evening", -3.891820298110627),
                                    ("thursdaymorning", -4.297285406218791),
                                    ("intersectevening", -2.3513752571634776),
                                    ("tomorrowafternoon", -4.297285406218791),
                                    ("half to|till|before <integer> (hour-of-day)afternoon",
                                     -4.297285406218791),
                                    ("hourhour", -1.1402849850686776),
                                    ("<day-of-month> (non ordinal) <named-month>morning",
                                     -3.891820298110627),
                                    ("at <time-of-day>afternoon", -4.297285406218791),
                                    ("<time-of-day>  o'clockafternoon", -3.1986731175506815),
                                    ("<time-of-day>  o'clocknight", -4.297285406218791),
                                    ("until <time-of-day>morning", -3.891820298110627),
                                    ("minutehour", -2.9109910450989003),
                                    ("<time-of-day> am|pmmorning", -3.891820298110627),
                                    ("hh:mmmorning", -3.891820298110627),
                                    ("about <time-of-day>evening", -4.297285406218791),
                                    ("<time-of-day>  o'clockevening", -3.6041382256588457),
                                    ("<hour-of-day> <integer> (as relative minutes)afternoon",
                                     -3.891820298110627),
                                    ("intersectmorning", -3.044522437723423),
                                    ("about <time-of-day>afternoon", -4.297285406218791),
                                    ("hh:mmafternoon", -4.297285406218791),
                                    ("on <date>morning", -3.891820298110627),
                                    ("at <time-of-day>morning", -4.297285406218791)],
                               n = 58},
                   koData =
                     ClassData{prior = -1.916922612182061, unseen = -3.951243718581427,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day>  o'clockmorning", -3.2386784521643803),
                                    ("yearhour", -3.2386784521643803),
                                    ...
                                    ("Februarymorning", -2.833213344056216),
                                    ("<time-of-day>  o'clockevening", -3.2386784521643803),
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.3053816495511819, unseen = -6.1779441140506,
                               likelihoods =
                                 HashMap.fromList
                                   [("last <cycle>sunday", -5.482720089545816),
                                    ("hourday", -4.384107800877706),
                                    ("on a named-day<day-of-month> (non ordinal) <named-month>",
                                     -5.482720089545816),
                                    ("<day-of-month> (non ordinal) <named-month><time-of-day>  o'clock",
                                     -5.482720089545816),
                                    ("dayhour", -2.347225873616666),
                                    ("daymonth", -4.566429357671661),
                                    ("next <cycle>friday", -5.482720089545816),
                                    ("monthyear", -3.8732821771117156),
                                    ("friday<day-of-month> (non ordinal) <named-month>",
                                     -5.077254981437651),
                                    ("yearhour", -5.482720089545816),
                                    ("intersect<time-of-day>  o'clock", -4.78957290898587),
                                    ("tuesdaythis <cycle>", -5.482720089545816),
                                    ("christmasyear", -5.482720089545816),
                                    ("on a named-dayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.077254981437651),
                                    ("saturday<time-of-day>  o'clock", -5.482720089545816),
                                    ("absorption of , after named daydd/mm/yyyy",
                                     -5.077254981437651),
                                    ("<time-of-day> am|pmintersect", -5.482720089545816),
                                    ("intersect<time> <part-of-day>", -4.78957290898587),
                                    ("Marchyear", -5.482720089545816),
                                    ("saturdayat <time-of-day>", -5.077254981437651),
                                    ("saturday<time> <part-of-day>", -5.077254981437651),
                                    ("dd/mm<time-of-day>  o'clock", -5.482720089545816),
                                    ("on a named-dayat <time-of-day>", -4.78957290898587),
                                    ("today<time-of-day>  o'clock", -5.482720089545816),
                                    ("at <time-of-day>on a named-day", -5.482720089545816),
                                    ("on a named-daybetween <datetime> and <datetime> (interval)",
                                     -5.482720089545816),
                                    ("intersect by ','year", -5.482720089545816),
                                    ("on <date><time-of-day>  o'clock", -4.78957290898587),
                                    ...
                                    ("on <date>between <datetime> and <datetime> (interval)",
                                     -5.482720089545816),
                                    ("last <day-of-week> of <time>year", -5.482720089545816),
                                    ("on a named-day<time-of-day>  o'clock", -5.482720089545816),
                                    ("next <cycle>March", -5.482720089545816),
                                    ("todayat <time-of-day>", -4.78957290898587),
                                    ("on <date>between <time-of-day> and <time-of-day> (interval)",
                                     -5.482720089545816),
                                    ("on <date>at <time-of-day>", -4.78957290898587),
                                    ("thursday<time> timezone", -5.482720089545816),
                                    ("on <date>about <time-of-day>", -4.78957290898587),
                                    ("dayday", -3.1801349965517702),
                                    ("on <date><time> <part-of-day>", -4.566429357671661),
                                    ("dd/mmabout <time-of-day>", -5.077254981437651),
                                    ("<day-of-month> (ordinal)intersect", -5.482720089545816),
                                    ("hourhour", -4.384107800877706),
                                    ("saturday<day-of-month> (non ordinal) <named-month>",
                                     -5.482720089545816),
                                    ("thursdayat <time-of-day>", -5.482720089545816),
                                    ("intersect<day-of-month> (non ordinal) <named-month>",
                                     -4.384107800877706),
                                    ("dayyear", -3.40327854786598),
                                    ("tuesdayafter <duration>", -5.482720089545816),
                                    ("tomorrow<time-of-day>  o'clock", -5.482720089545816),
                                    ("<time-of-day>  o'clocktomorrow", -4.78957290898587),
                                    ...
                                    ("<day-of-month>(ordinal) <named-month>year",
                                     -5.482720089545816),
                                    ("<day-of-month> (ordinal)tuesday", -5.482720089545816),
                                    ("hourminute", -4.78957290898587),
                                    ("thursdayhh:mm", -5.482720089545816),
                                    ("this <cycle>wednesday", -5.482720089545816),
                                    ...
                                    ("on <date><day-of-month> (non ordinal) <named-month>",
                                     -5.482720089545816),
                                    ("Aprilabout <time-of-day>", -5.482720089545816),
                                    ("thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.482720089545816),
                                    ("<day-of-month> (ordinal)February", -5.482720089545816),
                                    ...
                                    ("on <date><datetime> - <datetime> (interval)",
                                     -5.482720089545816),
                                    ("this <cycle>monday", -5.482720089545816),
                                    ("April<time-of-day>  o'clock", -5.482720089545816),
                                    ("next <cycle>wednesday", -5.482720089545816),
                                    ("hh:mmintersect", -5.077254981437651),
                                    ("thursday<datetime> - <datetime> (interval)",
                                     -5.077254981437651),
                                    ("<day-of-month> (ordinal)July", -5.482720089545816),
                                    ("thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.077254981437651),
                                    ("yearmonth", -5.482720089545816),
                                    ("at <time-of-day>intersect", -5.077254981437651),
                                    ("on <date>from <time-of-day> - <time-of-day> (interval)",
                                     -5.077254981437651),
                                    ("<time> <part-of-day>from <time-of-day> - <time-of-day> (interval)",
                                     -5.482720089545816),
                                    ("dayminute", -2.808571440119287),
                                    ...
                                    ("absorption of , after named dayintersect",
                                     -5.482720089545816),
                                    ("Julyyear", -5.482720089545816),
                                    ("year<time-of-day>  o'clock", -5.482720089545816),
                                    ("Octoberyear", -4.384107800877706),
                                    ("today evening<time-of-day>  o'clock", -5.482720089545816),
                                    ("hh:mmon <date>", -5.077254981437651),
                                    ("dd/mmyear", -5.482720089545816),
                                    ("tuesdayin <duration>", -5.482720089545816),
                                    ("today eveningat <time-of-day>", -5.077254981437651),
                                    ("Septemberyear", -5.077254981437651),
                                    ("at <time-of-day>on <date>", -5.077254981437651),
                                    ("absorption of , after named daydd/mm", -5.077254981437651),
                                    ("intersectintersect", -5.482720089545816),
                                    ...
                                    ("tomorrowat <time-of-day>", -5.077254981437651),
                                    ("next <cycle>tuesday", -5.482720089545816),
                                    ("monday<day-of-month> (non ordinal) <named-month>",
                                     -5.482720089545816),
                                    ("at <time-of-day>tomorrow", -5.482720089545816),
                                    ...
                                    ("on a named-day<time-of-day> - <time-of-day> (interval)",
                                     -5.482720089545816),
                                    ("last <cycle> of <time>year", -5.077254981437651),
                                    ("on a named-day<datetime> - <datetime> (interval)",
                                     -5.482720089545816),
                                    ("<day-of-month> (non ordinal) <named-month>year",
                                     -4.566429357671661),
                                    ("April<time> <part-of-day>", -5.077254981437651)],
                               n = 168},
                   koData =
                     ClassData{prior = -1.3350010667323402, unseen = -5.583496308781699,
                               likelihoods =
                                 HashMap.fromList
                                   [("<named-month> <day-of-month> (non ordinal)July",
                                     -4.886582645426277),
                                    ("dayhour", -3.5002882843063863),
                                    ("on a named-dayafter <time-of-day>", -4.886582645426277),
                                    ("July<day-of-month> (non ordinal) <named-month>",
                                     -4.886582645426277),
                                    ("daymonth", -3.970291913552122),
                                    ("monthday", -4.481117537318113),
                                    ("monthyear", -3.787970356758167),
                                    ("yearhour", -4.886582645426277),
                                    ("intersect<time-of-day>  o'clock", -4.886582645426277),
                                    ("on a named-dayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.481117537318113),
                                    ("<day-of-month> (ordinal)wednesday", -4.481117537318113),
                                    ("Julyintersect", -4.886582645426277),
                                    ("thursdayafter <time-of-day>", -4.886582645426277),
                                    ("intersect<time> <part-of-day>", -4.886582645426277),
                                    ("Marchyear", -4.886582645426277),
                                    ("<day-of-month> (ordinal)year", -4.886582645426277),
                                    ("on a named-dayat <time-of-day>", -4.886582645426277),
                                    ("on a named-daybetween <datetime> and <datetime> (interval)",
                                     -4.886582645426277),
                                    ("tuesdayafter <time-of-day>", -4.886582645426277),
                                    ("on a named-daybetween <time-of-day> and <time-of-day> (interval)",
                                     -4.886582645426277),
                                    ("monthhour", -3.970291913552122),
                                    ("on <date>between <datetime> and <datetime> (interval)",
                                     -4.886582645426277),
                                    ("todayat <time-of-day>", -4.886582645426277),
                                    ("on <date>between <time-of-day> and <time-of-day> (interval)",
                                     -4.886582645426277),
                                    ("on <date>at <time-of-day>", -4.886582645426277),
                                    ("on <date>about <time-of-day>", -4.886582645426277),
                                    ("dayday", -3.5002882843063863),
                                    ("hourhour", -4.193435464866331),
                                    ("thursdayat <time-of-day>", -4.886582645426277),
                                    ("dayyear", -4.193435464866331),
                                    ("thursdaybetween <time-of-day> and <time-of-day> (interval)",
                                     -4.886582645426277),
                                    ("thursdaybetween <datetime> and <datetime> (interval)",
                                     -4.886582645426277),
                                    ...
                                    ("on <date><time-of-day> - <time-of-day> (interval)",
                                     -4.886582645426277),
                                    ("yearuntil <time-of-day>", -4.481117537318113),
                                    ("thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.481117537318113),
                                    ...
                                    ("on <date>from <time-of-day> - <time-of-day> (interval)",
                                     -4.481117537318113),
                                    ("dayminute", -2.444235610057073),
                                    ("thursday<part-of-day> of <time>", -4.886582645426277),
                                    ("Julyyear", -4.481117537318113),
                                    ...
                                    ("<day-of-month> (non ordinal) <named-month>about <time-of-day>",
                                     -4.886582645426277),
                                    ("after <time-of-day>year", -4.886582645426277),
                                    ("on a named-day<time-of-day> - <time-of-day> (interval)",
                                     -4.886582645426277),
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.5373926511507126, unseen = -4.02535169073515,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 52},
                   koData =
                     ClassData{prior = -0.8777184570879154, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.2876820724517809),
                                    ("integer (0..19)", -1.6094379124341003),
                                    ("couple", -2.995732273553991)],
                               n = 37}}),
       ("year",
        Classifier{okData =
       ...
       ("last <time>",
        Classifier{okData =
                     ClassData{prior = -1.6094379124341003,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -1.0116009116784799), ("sunday", -1.7047480922384253),
                                    ("tuesday", -1.2992829841302609)],
                               n = 3},
                   koData =
