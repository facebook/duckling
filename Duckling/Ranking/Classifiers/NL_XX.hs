...
classifiers
  = HashMap.fromList
      [("Kerstmis",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6545323444321658, unseen = -4.897839799950911,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 132},
                   koData =
                     ClassData{prior = -0.7333132222852801, unseen = -4.820281565605037,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.18142509774691756,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("last <cycle>sunday", -5.541263545158426),
                                    ("Koningsdagyear", -5.541263545158426),
                                    ...
                                    ("<day-of-month> (non ordinal) <named-month><time-of-day>  o'clock",
                                     -5.541263545158426),
                                    ("dayhour", -2.4057693292292766),
                                    ("daymonth", -4.624972813284271),
                                    ("next <cycle>friday", -5.541263545158426),
                                    ("monthyear", -3.9318256327243257),
                                    ("friday<day-of-month> (non ordinal) <named-month>",
                                     -5.135798437050262),
                                    ("yearhour", -5.541263545158426),
                                    ("intersect<time-of-day>  o'clock", -4.848116364598481),
                                    ("tuesdaythis <cycle>", -5.541263545158426),
                                    ("on a named-dayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.624972813284271),
                                    ("saturday<time-of-day>  o'clock", -5.541263545158426),
                                    ("absorption of , after named daydd/mm/yyyy",
                                     -5.135798437050262),
                                    ("<time-of-day> am|pmintersect", -5.541263545158426),
                                    ("intersect<time> <part-of-day>", -4.848116364598481),
                                    ("Marchyear", -5.541263545158426),
                                    ("saturdayat <time-of-day>", -5.135798437050262),
                                    ("saturday<time> <part-of-day>", -5.135798437050262),
                                    ("dd/mm<time-of-day>  o'clock", -5.541263545158426),
                                    ("on a named-dayat <time-of-day>", -4.848116364598481),
                                    ("today<time-of-day>  o'clock", -5.541263545158426),
                                    ("at <time-of-day>on a named-day", -5.541263545158426),
                                    ("on a named-daybetween <datetime> and <datetime> (interval)",
                                     -5.135798437050262),
                                    ("intersect by ','year", -5.541263545158426),
                                    ("on <date><time-of-day>  o'clock", -4.848116364598481),
                                    ("next <cycle>monday", -5.541263545158426),
                                    ("on a named-daybetween <time-of-day> and <time-of-day> (interval)",
                                     -5.135798437050262),
                                    ("exactly <time-of-day>tomorrow", -5.541263545158426),
                                    ("on a named-day<time> <part-of-day>", -5.135798437050262),
                                    ("monthhour", -4.624972813284271),
                                    ("on <date>between <datetime> and <datetime> (interval)",
                                     -5.135798437050262),
                                    ("last <day-of-week> of <time>year", -5.541263545158426),
                                    ("on a named-day<time-of-day>  o'clock", -5.541263545158426),
                                    ("next <cycle>March", -5.541263545158426),
                                    ("todayat <time-of-day>", -4.848116364598481),
                                    ("on <date>between <time-of-day> and <time-of-day> (interval)",
                                     -5.135798437050262),
                                    ("on <date>at <time-of-day>", -4.848116364598481),
                                    ("thursday<time> timezone", -5.135798437050262),
                                    ("on <date>about <time-of-day>", -4.848116364598481),
                                    ("dayday", -3.2386784521643803),
                                    ("on <date><time> <part-of-day>", -4.624972813284271),
                                    ("dd/mmabout <time-of-day>", -5.135798437050262),
                                    ...
                                    ("intersect<day-of-month> (non ordinal) <named-month>",
                                     -4.442651256490317),
                                    ("dayyear", -3.5263605246161616),
                                    ("tuesdayafter <duration>", -5.541263545158426),
                                    ("tomorrow<time-of-day>  o'clock", -5.541263545158426),
                                    ("<time-of-day>  o'clocktomorrow", -4.848116364598481),
                                    ...
                                    ("hourminute", -4.848116364598481),
                                    ("thursdayhh:mm", -5.541263545158426),
                                    ("this <cycle>wednesday", -5.541263545158426),
                                    ...
                                    ("on <date><day-of-month> (non ordinal) <named-month>",
                                     -5.541263545158426),
                                    ("Aprilabout <time-of-day>", -5.541263545158426),
                                    ("thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.135798437050262),
                                    ("<day-of-month> (ordinal)February", -5.541263545158426),
                                    ...
                                    ("today/tomorrow/yesterday evening<time-of-day>  o'clock",
                                     -5.541263545158426),
                                    ("fridayintersect", -4.848116364598481),
                                    ("on <date><time-of-day> - <time-of-day> (interval)",
                                     -5.135798437050262),
                                    ("on <date><datetime> - <datetime> (interval)",
                                     -5.541263545158426),
                                    ("this <cycle>monday", -5.541263545158426),
                                    ("April<time-of-day>  o'clock", -5.541263545158426),
                                    ("next <cycle>wednesday", -5.541263545158426),
                                    ("hh:mmintersect", -5.135798437050262),
                                    ("thursday<datetime> - <datetime> (interval)",
                                     -5.135798437050262),
                                    ("<day-of-month> (ordinal)July", -5.541263545158426),
                                    ("thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.624972813284271),
                                    ("yearmonth", -5.541263545158426),
                                    ...
                                    ("<time> <part-of-day>from <datetime> - <datetime> (interval)",
                                     -5.541263545158426),
                                    ("intersectyear", -4.848116364598481),
                                    ("<time-of-day> am|pmsaturday", -5.541263545158426),
                                    ("<ordinal> <cycle> of <time>year", -5.541263545158426),
                                    ("minuteday", -3.3440389678222067),
                                    ("absorption of , after named dayintersect",
                                     -5.541263545158426),
                                    ("Julyyear", -5.541263545158426),
                                    ("year<time-of-day>  o'clock", -5.541263545158426),
                                    ("Octoberyear", -4.442651256490317),
                                    ("hh:mmon <date>", -5.135798437050262),
                                    ("today/tomorrow/yesterday afternoonat <time-of-day>",
                                     -5.541263545158426),
                                    ("tuesdayin <duration>", -5.541263545158426),
                                    ("Septemberyear", -5.135798437050262),
                                    ("at <time-of-day>on <date>", -5.135798437050262),
                                    ("absorption of , after named daydd/mm", -5.135798437050262),
                                    ("intersectintersect", -5.541263545158426),
                                    ("hh:mmon a named-day", -5.541263545158426),
                                    ("weekday", -4.154969184038536),
                                    ("dayweek", -4.848116364598481),
                                    ("weekyear", -5.135798437050262),
                                    ("on <date>February", -5.541263545158426),
                                    ("Kerstmisyear", -5.541263545158426),
                                    ("<month> dd-dd (interval)year", -5.541263545158426),
                                    ("tomorrowat <time-of-day>", -5.135798437050262),
                                    ("next <cycle>tuesday", -5.541263545158426),
                                    ("monday<day-of-month> (non ordinal) <named-month>",
                                     -5.541263545158426),
                                    ("at <time-of-day>tomorrow", -5.541263545158426),
                                    ...
                                    ("today/tomorrow/yesterday eveningat <time-of-day>",
                                     -5.135798437050262),
                                    ("last <cycle> of <time>year", -5.135798437050262),
                                    ("on a named-day<datetime> - <datetime> (interval)",
                                     -5.541263545158426),
                                    ("<day-of-month> (non ordinal) <named-month>year",
                                     -4.624972813284271),
                                    ("April<time> <part-of-day>", -5.135798437050262)],
                               n = 186},
                   koData =
                     ClassData{prior = -1.7962538588158943,
