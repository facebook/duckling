...
classifiers
  = HashMap.fromList
      [("five",
                                 ...
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("<hour-of-day> - <hour-of-day> (interval)on <date>",
                                     -5.145554611995626),
                                    ("named-daynamed-month", -4.634728988229636),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.145554611995626),
                                    ("hourday", -3.759260250875736),
                                    ("dayhour", -2.6888188391743224),
                                    ("daymonth", -3.759260250875736),
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocyabsorption of , after named day",
                                     -4.634728988229636),
                                    ("monthyear", -3.0661130703157906),
                                    ("from <hour-of-day> - <hour-of-day> (interval)on a named-day",
                                     -5.551019720103791),
                                    ("from <time-of-day> - <time-of-day> (interval)on a named-day",
                                     -5.551019720103791),
                                    ("intersecthh:mm", -5.551019720103791),
                                    ("from <datetime> - <datetime> (interval)on a named-day",
                                     -5.551019720103791),
                                    ("named-daylast <cycle>", -5.145554611995626),
                                    ("named-day<time-of-day> rano", -5.551019720103791),
                                    ("on a named-dayat <time-of-day>", -5.145554611995626),
                                    ("at <time-of-day>named-day", -5.145554611995626),
                                    ("at <time-of-day>on a named-day", -5.551019720103791),
                                    ("<time> <part-of-day>on a named-day", -5.145554611995626),
                                    ("on a named-day<time> <part-of-day>", -5.551019720103791),
                                    ("last <day-of-week> of <time>year", -5.551019720103791),
                                    ("today<time> <part-of-day>", -5.551019720103791),
                                    ("todayat <time-of-day>", -5.551019720103791),
                                    ("on <date>at <time-of-day>", -5.145554611995626),
                                    ("dayday", -2.911962390488532),
                                    ("on <date><time> <part-of-day>", -5.551019720103791),
                                    ("intersect by \",\"hh:mm", -4.634728988229636),
                                    ("mm/ddat <time-of-day>", -4.857872539543846),
                                    ("last <cycle> <time>year", -4.634728988229636),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.857872539543846),
                                    ("intersect<day-of-month> (non ordinal) <named-month>",
                                     -4.857872539543846),
                                    ("dayyear", -3.536116699561526),
                                    ...
                                    ("tomorrow<time-of-day> popo\322udniu/wieczorem/w nocy",
                                     -5.551019720103791),
                                    ("named-monthyear", -3.4109535566075198),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.1647253589839),
                                    ("tomorrowuntil <time-of-day>", -5.145554611995626),
                                    ("absorption of , after named day<day-of-month> (non ordinal) <named-month>",
                                     -4.046942323327516),
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocyintersect by \",\"",
                                     -4.634728988229636),
                                    ("named-dayin <duration>", -5.551019720103791),
                                    ("last <day-of-week> <time>year", -5.145554611995626),
                                    ("<time-of-day> ranoon <date>", -5.145554611995626),
                                    ("named-dayfrom <datetime> - <datetime> (interval)",
                                     -4.857872539543846),
                                    ("named-daynext <cycle>", -4.634728988229636),
                                    ("named-dayintersect", -5.145554611995626),
                                    ("named-dayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.857872539543846),
                                    ("on <date><time-of-day> rano", -5.551019720103791),
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocytomorrow",
                                     -5.551019720103791),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.551019720103791),
                                    ("at <time-of-day>intersect", -5.145554611995626),
                                    ("dayminute", -3.9415818076696905),
                                    ("<time-of-day> ranoon a named-day", -5.145554611995626),
                                    ("from <hour-of-day> - <hour-of-day> (interval)on <date>",
                                     -5.551019720103791),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.551019720103791),
                                    ("intersectyear", -5.145554611995626),
                                    ("on a named-day<time-of-day> rano", -5.551019720103791),
                                    ("<ordinal> <cycle> of <time>year", -5.551019720103791),
                                    ("minuteday", -2.3523466025531095),
                                    ("absorption of , after named dayintersect",
                                     -5.551019720103791),
                                    ("named-dayon <date>", -3.9415818076696905),
                                    ("named-day<time> <part-of-day>", -4.857872539543846),
                                    ("named-dayat <time-of-day>", -5.145554611995626),
                                    ("yearhh:mm", -5.551019720103791),
                                    ("at <time-of-day>intersect by \",\"", -5.145554611995626),
                                    ("absorption of , after named dayintersect by \",\"",
                                     -5.145554611995626),
                                    ("tomorrowexactly <time-of-day>", -4.857872539543846),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.145554611995626),
                                    ("at <time-of-day>on <date>", -5.551019720103791),
                                    ("on <date>year", -4.1647253589839),
                                    ("dayweek", -3.6051095710484775),
                                    ("<time> <part-of-day>on <date>", -5.145554611995626),
                                    ("weekyear", -4.298256751608423),
                                    ("named-day<day-of-month>(ordinal) <named-month>",
                                     -4.857872539543846),
                                    ("<ordinal> <cycle> <time>year", -5.145554611995626),
                                    ("tomorrowat <time-of-day>", -5.551019720103791),
                                    ("named-daythis <cycle>", -5.145554611995626),
                                    ("tomorrow<time> <part-of-day>", -5.551019720103791),
                                    ...
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocynamed-day",
                                     -4.634728988229636),
                                    ("tomorrow<time-of-day> rano", -5.551019720103791),
                                    ("<datetime> - <datetime> (interval)on a named-day",
                                     -5.145554611995626),
                                    ("last <cycle> of <time>year", -5.145554611995626),
                                    ...
                                    ("<hour-of-day> - <hour-of-day> (interval)on a named-day",
                                     -5.145554611995626),
                                    ("yearminute", -5.551019720103791)],
                               n = 197},
                   koData =
                     ClassData{prior = -1.2693226845343863, unseen = -5.62040086571715,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> ranoby <time>", -4.518158808998462),
                                    ("named-daynamed-month", -4.518158808998462),
                                    ("dayhour", -3.8250116284385163),
                                    ("daymonth", -2.5257286443082556),
                                    ("monthday", -4.518158808998462),
                                    ("monthyear", -4.007333185232471),
                                    ("named-month<hour-of-day> <integer> (as relative minutes)",
                                     -4.923623917106626),
                                    ("<time> <part-of-day>until <time-of-day>", -4.518158808998462),
                                    ("<time> <part-of-day><time> <part-of-day>",
                                     -4.230476736546681),
                                    ("mm/ddat <time-of-day>", -4.923623917106626),
                                    ("hourhour", -4.007333185232471),
                                    ("<time> <part-of-day>by <time>", -4.518158808998462),
                                    ("intersectnamed-month", -4.230476736546681),
                                    ("dayyear", -3.670860948611258),
                                    ("<time-of-day> ranoby the end of <time>", -4.518158808998462),
                                    ("<named-month> <day-of-month> (non ordinal)until <time-of-day>",
                                     -4.923623917106626),
                                    ("year<hour-of-day> <integer> (as relative minutes)",
                                     -4.518158808998462),
                                    ("monthminute", -4.518158808998462),
                                    ("minutemonth", -4.230476736546681),
                                    ("named-monthyear", -4.007333185232471),
                                    ("absorption of , after named daynamed-month",
                                     -3.5373295559867355),
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocyintersect by \",\"",
                                     -4.518158808998462),
                                    ("after <time-of-day>at <time-of-day>", -4.923623917106626),
                                    ("hh:mmby the end of <time>", -4.923623917106626),
                                    ("daysecond", -4.518158808998462),
                                    ("<time> <part-of-day>by the end of <time>",
                                     -4.518158808998462),
                                    ("<time> <part-of-day><time-of-day> rano", -4.923623917106626),
                                    ("named-dayfrom <datetime> - <datetime> (interval)",
                                     -4.923623917106626),
                                    ("named-dayintersect", -3.670860948611258),
                                    ("named-dayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.923623917106626),
                                    ("<time-of-day> rano<time> <part-of-day>", -4.518158808998462),
                                    ("at <time-of-day>intersect", -4.923623917106626),
                                    ("dayminute", -4.518158808998462),
                                    ("<named-month> <day-of-month> (non ordinal)by <time>",
                                     -4.923623917106626),
                                    ("intersectyear", -3.670860948611258),
                                    ("minuteday", -3.2188758248682006),
                                    ("named-dayon <date>", -4.007333185232471),
                                    ("hh:mmon <date>", -4.518158808998462),
                                    ("at <time-of-day>intersect by \",\"", -4.923623917106626),
                                    ("<named-month> <day-of-month> (non ordinal)by the end of <time>",
                                     -4.923623917106626),
                                    ("tomorrowexactly <time-of-day>", -4.923623917106626),
                                    ("hoursecond", -3.0518217402050345),
                                    ...
                                    ("<named-month> <day-of-month> (non ordinal)named-month",
                                     -4.518158808998462),
                                    ("hh:mmon a named-day", -4.518158808998462),
                                    ("hh:mmby <time>", -4.923623917106626),
                                    ("tomorrowat <time-of-day>", -4.923623917106626),
                                    ("minutesecond", -4.518158808998462),
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocyintersect",
                                     -4.518158808998462),
                                    ("yearminute", -4.518158808998462)],
                               n = 77}}),
       ...
       ("intersect by \",\"",
        Classifier{okData =
                     ClassData{prior = -0.2282586519809802, unseen = -4.605170185988091,
                               likelihoods =
                                 HashMap.fromList
                                   [("intersect by \",\"year", -3.9019726695746444),
                                    ("dayday", -1.376244025266389),
                                    ("named-dayintersect by \",\"", -3.4965075614664802),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.2088254890146994),
                                    ("intersect<day-of-month> (non ordinal) <named-month>",
                                     -3.2088254890146994),
                                    ...
                                    ("named-day<named-month> <day-of-month> (non ordinal)",
                                     -2.515678308454754),
                                    ("intersect by \",\"intersect", -3.9019726695746444),
                                    ("named-dayintersect", -3.9019726695746444),
                                    ("dayminute", -2.803360380906535),
                                    ("intersectyear", -3.9019726695746444),
                                    ("minuteday", -2.649209701079277),
                                    ("intersectintersect", -3.9019726695746444),
                                    ("named-day<day-of-month>(ordinal) <named-month>",
                                     -2.3978952727983707),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -3.4965075614664802)],
                               n = 39},
                   koData =
                     ClassData{prior = -1.589235205116581, unseen = -3.7376696182833684,
                               likelihoods =
                                 HashMap.fromList
                                   [("named-daynamed-month", -1.6341305250244718),
                                    ("daymonth", -1.6341305250244718),
                                    ("intersectnamed-month", -2.327277705584417),
                                    ("minutemonth", -2.327277705584417)],
                               n = 10}}),
       ("hh:mm",
        Classifier{okData =
       ...
       ("<datetime> - <datetime> (interval)",
        Classifier{okData =
                     ClassData{prior = -1.1526795099383855, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
                                   [("minuteminute", -1.6486586255873816),
                                    ("hh:mmhh:mm", -1.6486586255873816),
                                    ("dayday", -2.159484249353372),
                                    ("<named-month> <day-of-month> (non ordinal)<named-month> <day-of-month> (non ordinal)",
                                     -2.159484249353372)],
                               n = 6},
                   koData =
                     ClassData{prior = -0.3794896217049037, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -2.5902671654458267),
                                    ("about <time-of-day>noon", -2.995732273553991),
                                    ("minuteminute", -1.8971199848858813),
                                    ("<time-of-day> rano<time-of-day> rano", -2.995732273553991),
                                    ("until <time-of-day>noon", -2.995732273553991),
                                    ("hh:mmhh:mm", -2.995732273553991),
                                    ("hourhour", -2.0794415416798357),
                                    ("year<hour-of-day> <integer> (as relative minutes)",
                                     -2.5902671654458267),
                                    ("hh:mmintersect", -2.0794415416798357),
                                    ("at <time-of-day>noon", -2.995732273553991),
                                    ("<named-month> <day-of-month> (non ordinal)named-month",
                                     -2.5902671654458267),
                                    ("yearminute", -2.5902671654458267)],
                               n = 13}}),
       ("second ordinal",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.639057329615259,
