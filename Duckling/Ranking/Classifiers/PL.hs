...
classifiers
  = HashMap.fromList
      [("five",
       ...
       ("intersect by \",\" 2",
        Classifier{okData =
                     ClassData{prior = -0.5679840376059393, unseen = -4.477336814478207,
                               likelihoods =
                                 HashMap.fromList
                                   [("dayday", -1.2078115806331016),
                                    ("named-dayintersect by \",\"", -3.7727609380946383),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.079613757534693),
                                    ("intersect<day-of-month> (non ordinal) <named-month>",
                                     -3.079613757534693),
                                    ("dayyear", -3.079613757534693),
                                    ("named-day<day-of-month> (non ordinal) <named-month>",
                                     -2.268683541318364),
                                    ("named-day<named-month> <day-of-month> (non ordinal)",
                                     -2.386466576974748),
                                    ("intersect by \",\" 2year", -3.7727609380946383),
                                    ("named-dayintersect by \",\" 2", -3.7727609380946383),
                                    ("minuteday", -2.5199979695992702),
                                    ("named-day<day-of-month>(ordinal) <named-month>",
                                     -2.268683541318364),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -3.367295829986474)],
                               n = 34},
                   koData =
                     ClassData{prior = -0.8362480242006186, unseen = -4.276666119016055,
                               likelihoods =
                                 HashMap.fromList
                                   [("named-daynamed-month", -2.1832383353614793),
                                    ("dayhour", -1.4294665329850993),
                                    ("daymonth", -2.1832383353614793),
                                    ("intersectnamed-month", -2.8763855159214247),
                                    ("minutemonth", -2.8763855159214247),
                                    ("named-dayintersect", -2.065455299705096),
                                    ("named-day<ordinal> (as hour)", -2.065455299705096)],
                               n = 26}}),
       ("16th ordinal",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.3862943611198906,
       ...
       ("intersect by \",\"",
        Classifier{okData =
                     ClassData{prior = -0.640037355245997, unseen = -4.330733340286331,
                               likelihoods =
                                 HashMap.fromList
                                   [("dayday", -1.2729656758128873),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -2.9311937524164198),
                                    ("intersect<day-of-month> (non ordinal) <named-month>",
                                     -2.9311937524164198),
                                    ("dayyear", -2.9311937524164198),
                                    ("named-day<day-of-month> (non ordinal) <named-month>",
                                     -2.2380465718564744),
                                    ("named-day<named-month> <day-of-month> (non ordinal)",
                                     -2.5257286443082556),
                                    ("intersect by \",\" 2year", -3.624340932976365),
                                    ("minuteday", -2.371577964480997),
                                    ("named-day<day-of-month>(ordinal) <named-month>",
                                     -2.120263536200091),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -3.2188758248682006)],
                               n = 29},
                   koData =
                     ClassData{prior = -0.7492366472109889, unseen = -4.248495242049359,
                               likelihoods =
                                 HashMap.fromList
                                   [("named-daynamed-month", -2.1546649629174235),
                                    ("dayhour", -1.4008931605410433),
                                    ("daymonth", -2.1546649629174235),
                                    ("intersectnamed-month", -2.847812143477369),
                                    ("minutemonth", -2.847812143477369),
                                    ("named-dayintersect", -2.03688192726104),
                                    ("named-day<ordinal> (as hour)", -2.03688192726104)],
                               n = 26}}),
       ("hh:mm",
        Classifier{okData =
