...
classifiers
  = HashMap.fromList
      [("<cycle> (que vem)",
       ...
       ("intersect2",
        Classifier{okData =
                     ClassData{prior = -0.3930425881096072,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<day-of-month> de <named-month>in the <part-of-day>",
                                    ...
                                    ("intersect2named-day", -4.430816798843313),
                                    ...
                                    ("named-dayintersect2", -4.430816798843313),
                                    ...
                                    ("two time tokens separated by \",\"de <year>",
                                     -4.02535169073515),
                                    ("intersect2de <year>", -4.430816798843313),
                               ...
                               n = 54},
                   koData =
                     ClassData{prior = -1.1239300966523995, unseen = -4.727387818712341,
                               likelihoods =
                                 HashMap.fromList
                                   [("dayhour", -3.619886582626985),
                                    ("monthday", -2.639057329615259),
                                    ("named-month\224s <time-of-day>", -4.02535169073515),
                                    ("monthyear", -2.521274293958875),
                                    ("intersectnamed-day", -4.02535169073515),
                                    ("now\224s <time-of-day>", -3.619886582626985),
                                    ("intersect by `da` or `de`named-day", -4.02535169073515),
                                    ("intersect2named-day", -4.02535169073515),
                                    ("monthhour", -3.332204510175204),
                                    ("dayyear", -4.02535169073515),
                                    ("now<hour-of-day> and <relative minutes>", -4.02535169073515),
                                    ("daysecond", -4.02535169073515),
                                    ("named-dayright now", -4.02535169073515),
                                    ("dayminute", -3.619886582626985),
                                    ("named-monthde <year>", -2.521274293958875),
                                    ("named-monthin the <part-of-day>", -3.619886582626985),
                                    ("named-monthtwo time tokens separated by \",\"2",
                                     -4.02535169073515),
                                    ("intersect by `da` or `de`de <year>", -4.02535169073515),
                                    ("named-monthintersect", -4.02535169073515),
                                    ("<day-of-month> de <named-month>\224s <time-of-day>",
                                     -4.02535169073515),
                                    ("<hour-of-day> <integer> (as relative minutes)year",
                                     -4.02535169073515),
                                    ("<day-of-month> de <named-month>de <year>", -4.02535169073515),
                                    ("named-monthintersect2", -4.02535169073515),
                                    ("minuteyear", -3.619886582626985),
                                    ("named-monthtwo time tokens separated by \",\"",
                                     -4.02535169073515)],
                               n = 26}}),
       ("intersect by `da` or `de`",
        Classifier{okData =
                     ClassData{prior = -0.6486954179891115, unseen = -4.418840607796598,
                               likelihoods =
                                 HashMap.fromList
                                   [("day of month (1st)named-month", -3.3081069585961433),
                                    ...
                                    ("<day-of-month> de <named-month>two time tokens separated by \",\"",
                                     -3.713572066704308),
                                    ("dayday", -2.797281334830153), ("dayyear", -1.698669046162043),
                                    ("named-dayproximo <cycle> ", -3.713572066704308),
                                    ("dd-dd <month>(interval)year", -3.713572066704308),
                                    ("named-day<cycle> (que vem)", -3.713572066704308),
                                    ("two time tokens separated by \",\"2year",
                                     -3.3081069585961433),
                                    ("intersectyear", -3.713572066704308),
                                    ("<day-of-month> de <named-month>year", -2.327277705584417),
                                    ("two time tokens separated by \",\"year", -3.3081069585961433),
                                    ("dayweek", -3.0204248861443626),
                                    ("intersect2year", -3.713572066704308),
                                    ("named-day<cycle> passado", -3.713572066704308)],
                               n = 23},
                   koData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<hour-of-day> <integer> (as relative minutes)intersect",
                                     -3.6635616461296463),
                                    ("monthday", -2.7472709142554916),
                                    ("monthyear", -2.159484249353372),
                                    ("hourmonth", -3.258096538021482),
                                    ("monthmonth", -3.6635616461296463),
                                    ("dayyear", -3.6635616461296463),
                                    ("<hour-of-day> <integer> (as relative minutes)intersect2",
                                     -3.6635616461296463),
                                    ("minutemonth", -2.7472709142554916),
                                    ("named-monthyear", -2.159484249353372),
                                    ("de <datetime> - <datetime> (interval)named-month",
                                     -3.6635616461296463),
                                    ("\224s <time-of-day>named-month", -3.258096538021482),
                                    ("<hour-of-day> <integer> (as relative minutes)named-month",
                                     -3.6635616461296463),
                                    ("<day-of-month> de <named-month>year", -3.6635616461296463),
                                    ("intersect by `da` or `de`year", -3.6635616461296463),
                                    ("named-monthtwo time tokens separated by \",\"2",
                                     -3.6635616461296463),
                                    ("named-monthintersect", -3.6635616461296463),
                                    ("<hour-of-day> <integer> (as relative minutes)intersect by `da` or `de`",
                                     -3.6635616461296463),
                                    ("named-monthintersect2", -3.6635616461296463),
                                    ("minuteyear", -3.6635616461296463),
                                    ("named-monthtwo time tokens separated by \",\"",
                                     -3.6635616461296463)],
                               n = 21}}),
       ...
       ("two time tokens separated by \",\"",
        Classifier{okData =
                     ClassData{prior = -0.1941560144409575, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
                                   [("intersectnamed-day", -2.995732273553991),
                                    ("intersect by `da` or `de`named-day", -2.995732273553991),
                                    ("intersect2named-day", -2.995732273553991),
                                    ("dayday", -1.1239300966523995),
                                    ("de <year>named-day", -2.995732273553991),
                                    ("named-dayintersect", -2.5902671654458267),
                                    ("named-dayintersect2", -2.5902671654458267),
                                    ("named-dayintersect by `da` or `de`", -2.5902671654458267),
                                    ("yearnamed-day", -2.995732273553991),
                                    ("named-day<day-of-month> de <named-month>",
                                     -2.3025850929940455),
                                    ("yearday", -2.5902671654458267)],
                               n = 14},
                   koData =
