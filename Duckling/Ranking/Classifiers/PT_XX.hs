...
classifiers
  = HashMap.fromList
      [("<cycle> (que vem)",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.2212726433783981, unseen = -5.375278407684165,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 214},
                   koData =
                     ClassData{prior = -1.6169567448481277, unseen = -4.007333185232471,
       ...
       ("intersect by `da` or `de`",
        Classifier{okData =
                     ClassData{prior = -1.9564365620423008, unseen = -4.852030263919617,
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -3.0524276172305362),
                                    ("dd-dd <month> de (interval)year", -4.151039905898646),
                                    ("dayday", -3.457892725338701),
                                    ("Quart-feira<cycle> (que vem)", -4.151039905898646),
                                    ("dayyear", -2.07159836421881),
                                    ("quarteryear", -4.151039905898646),
                                    ("dd-dd <month>(interval)year", -4.151039905898646),
                                    ("<ordinal> trimestreyear", -4.151039905898646),
                                    ("<day-of-month> (ordinal or number) de <named-month>year",
                                     -2.7647455447787554),
                                    ("day of month (1st)Mar\231o", -3.457892725338701),
                                    ("two time tokens separated by \",\"2year",
                                     -3.7455747977904816),
                                    ("intersectyear", -4.151039905898646),
                                    ("dia <day-of-month> (non ordinal)Fevereiro",
                                     -3.7455747977904816),
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -4.151039905898646),
                                    ("two time tokens separated by \",\"year", -3.7455747977904816),
                                    ("Domingo<cycle> passado", -4.151039905898646),
                                    ("dayweek", -3.457892725338701),
                                    ...
                                    ("<day-of-month> (ordinal or number) de <named-month>intersect",
                                     -4.151039905898646),
                                    ("Quart-feiraproximo <cycle> ", -4.151039905898646),
                                    ("<day-of-month> (ordinal or number) de <named-month>two time tokens separated by \",\"",
                                     -4.151039905898646)],
                               n = 27},
                   koData =
                     ClassData{prior = -0.15240700022243142,
                               unseen = -5.996452088619021,
                               likelihoods =
                                 HashMap.fromList
                                   [("time-of-day (latent)<datetime> - <datetime> (interval)",
                                     -4.895349138638459),
                                    ("hourday", -3.160748083250353),
                                    ("year (latent)Abril", -4.895349138638459),
                                    ("year (latent)Julho", -3.3549040976913105),
                                    ("time-of-day (latent)Fevereiro", -4.048051278251256),
                                    ("monthday", -4.6076670661866785),
                                    ("monthyear", -3.5960661545081987),
                                    ("yearhour", -3.914519885626733),
                                    ("entre <datetime> e <datetime> (interval)Julho",
                                     -3.6913763343125234),
                                    ("houryear", -3.3549040976913105),
                                    ("year (latent)Maio", -4.202201958078514),
                                    ("time-of-day (latent)two time tokens separated by \",\"2",
                                     -4.895349138638459),
                                    ("Setembroyear", -4.202201958078514),
                                    ("time-of-day (latent)Setembro", -4.202201958078514),
                                    ("time-of-day (latent)intersect", -3.2859112262043593),
                                    ("year (latent)<time-of-day> <part-of-day>",
                                     -5.300814246746624),
                                    ("\224s <time-of-day>Julho", -4.6076670661866785),
                                    ("year (latent)intersect", -4.6076670661866785),
                                    ("Setembrointersect", -5.300814246746624),
                                    ("intersect by `da` or `de`two time tokens separated by \",\"",
                                     -5.300814246746624),
                                    ("year (latent)amanh\227 pela <part-of-day>",
                                     -5.300814246746624),
                                    ("hourmonth", -1.7598549227093099),
                                    ("time-of-day (latent)intersect by `da` or `de`",
                                     -3.509054777518569),
                                    ("monthmonth", -5.300814246746624),
                                    ("Setembrotwo time tokens separated by \",\"2",
                                     -5.300814246746624),
                                    ("year (latent)Fevereiro", -4.048051278251256),
                                    ("time-of-day (latent)Dezembro", -5.300814246746624),
                                    ("dayyear", -5.300814246746624),
                                    ("time-of-day (latent)Julho", -3.509054777518569),
                                    ("time-of-day (latent)Abril", -4.895349138638459),
                                    ("passado <cycle>year", -5.300814246746624),
                                    ("year (latent)<dim time> da manha", -5.300814246746624),
                                    ("<day-of-month> (ordinal or number) de <named-month>year",
                                     -5.300814246746624),
                                    ("time-of-day (latent)Mar\231o", -4.202201958078514),
                                    ("year (latent)Janeiro", -5.300814246746624),
                                    ("year (latent)Dezembro", -5.300814246746624),
                                    ("entre <datetime> e <datetime> (interval)Janeiro",
                                     -5.300814246746624),
                                    ("yearmonth", -2.1872989375362493),
                                    ("two time tokens separated by \",\"2year", -4.895349138638459),
                                    ("Setembrotwo time tokens separated by \",\"",
                                     -5.300814246746624),
                                    ("intersect by `da` or `de`intersect", -5.300814246746624),
                                    ("intersectyear", -5.300814246746624),
                                    ("intersect by `da` or `de`two time tokens separated by \",\"2",
                                     -5.300814246746624),
                                    ("time-of-day (latent)Maio", -4.202201958078514),
                                    ("antes das <time-of-day>Julho", -4.048051278251256),
                                    ("Maioyear", -4.6076670661866785),
                                    ("year (latent)Setembro", -4.202201958078514),
                                    ("\224s <time-of-day>Janeiro", -5.300814246746624),
                                    ("two time tokens separated by \",\"year", -4.895349138638459),
                                    ("time-of-day (latent)two time tokens separated by \",\"",
                                     -4.895349138638459),
                                    ("intersect by `da` or `de`year", -3.7967368499703498),
                                    ("year (latent)<datetime> - <datetime> (interval)",
                                     -4.895349138638459),
                                    ("yearday", -5.300814246746624),
                                    ("time-of-day (latent)Janeiro", -5.300814246746624),
                                    ("Julhoyear", -5.300814246746624),
                                    ("de <datetime> - <datetime> (interval)Julho",
                                     -5.300814246746624),
                                    ("year (latent)Mar\231o", -4.202201958078514)],
                               n = 164}}),
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -1.2729656758128873, unseen = -5.288267030694535,
                               likelihoods =
                                 HashMap.fromList
                                   [("dayhour", -2.5106150064982073),
                                    ("nowquinze para as <hour-of-day> (as relative minutes)",
                                     -4.590056548178043),
                                    ("Quart-feiraamanh\227 pela <part-of-day>", -4.590056548178043),
                                    ("now\224s <time-of-day>", -4.1845914400698785),
                                    ("now<hour-of-day> and 3/4", -4.590056548178043),
                                    ("Segunda-feirain the <part-of-day>", -4.590056548178043),
                                    ("Quart-feira<time-of-day> <part-of-day>", -4.590056548178043),
                                    ("yearSexta-feira", -4.590056548178043),
                                    ("dayday", -3.0859791514017694),
                                    ("hourhour", -4.590056548178043),
                                    ("dayyear", -2.392831970841824),
                                    ("de <year>Sexta-feira", -4.590056548178043),
                                    ("quarteryear", -4.590056548178043),
                                    ("minutehour", -3.337293579682675),
                                    ...
                                    ("<day-of-month> (ordinal or number) de <named-month>year",
                                     -4.590056548178043),
                                    ("now<hour-of-day> and <relative minutes>", -4.590056548178043),
                                    ("tomorrow<time-of-day> horas", -4.1845914400698785),
                                    ("dd-dd <month> de (interval)de <year>", -4.590056548178043),
                                    ("now<integer> para as <hour-of-day> (as relative minutes)",
                                     -4.590056548178043),
                                    ("\224s <time-of-day>in the <part-of-day>", -3.896909367618098),
                                    ("Sexta-feiraintersect", -4.590056548178043),
                                    ("dayminute", -3.337293579682675),
                                    ("<ordinal> trimestrede <year>", -4.590056548178043),
                                    ("<day-of-month> (ordinal or number) de <named-month>de <year>",
                                     -3.2037621870581527),
                                    ("intersectSexta-feira", -4.590056548178043),
                                    ("dd-dd <month>(interval)de <year>", -4.590056548178043),
                                    ("Sexta-feiraintersect by `da` or `de`", -4.590056548178043),
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -4.590056548178043),
                                    ("intersect by `da` or `de`Sexta-feira", -4.590056548178043),
                                    ...
                                    ("two time tokens separated by \",\"de <year>",
                                     -4.1845914400698785),
                                    ("Quart-feira\224s <time-of-day>", -4.590056548178043),
                                    ("Quart-feira<dim time> da manha", -4.590056548178043),
                                    ("<day-of-month> (ordinal or number) de <named-month>two time tokens separated by \",\"",
                                     -4.590056548178043),
                                    ("tomorrowdepois das <time-of-day>", -4.1845914400698785),
                                    ("<hour-of-day> and <relative minutes>in the <part-of-day>",
                                     -4.1845914400698785),
                                    ("two time tokens separated by \",\"2de <year>",
                                     -4.1845914400698785),
                                    ("intersectde <year>", -4.590056548178043)],
                               n = 56},
                   koData =
                     ClassData{prior = -0.3285040669720361, unseen = -5.924255797414532,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.3566290621822787),
                                    ("dayhour", -3.8421368779639797),
                                    ("daymonth", -5.2284312390838705),
                                    ("monthday", -4.1298189504157605),
                                    ("monthyear", -3.282521090028557),
                                    ("<day-of-month> (ordinal or number) de <named-month>\224s <time-of-day>",
                                     -5.2284312390838705),
                                    ("now\224s <time-of-day>", -4.822966130975706),
                                    ("entre <datetime> e <datetime> (interval)Julho",
                                     -3.61899332664977),
                                    ("houryear", -3.2135282185416054),
                                    ("Dezembro\224s <time-of-day>", -5.2284312390838705),
                                    ("\224s <time-of-day>Julho", -4.822966130975706),
                                    ("Fevereiroin the <part-of-day>", -4.822966130975706),
                                    ("de <year>antes das <time-of-day>", -2.487591215158669),
                                    ("monthhour", -3.9756682705885025),
                                    ("Setembrointersect", -5.2284312390838705),
                                    ("intersect by `da` or `de`two time tokens separated by \",\"",
                                     -5.2284312390838705),
                                    ("hourmonth", -3.3566290621822787),
                                    ("Julhode <year>", -5.2284312390838705),
                                    ("<time-of-day> am|pmintersect by `da` or `de`",
                                     -4.535284058523925),
                                    ("Setembrotwo time tokens separated by \",\"2",
                                     -5.2284312390838705),
                                    ("dayyear", -5.2284312390838705),
                                    ("intersect by `da` or `de`\224s <time-of-day>",
                                     -5.2284312390838705),
                                    ("passado <cycle>year", -5.2284312390838705),
                                    ("de <year>o <ordinal> <cycle> de <time>", -4.822966130975706),
                                    ("intersect by `da` or `de`in the <part-of-day>",
                                     -4.822966130975706),
                                    ("Setembrode <year>", -4.1298189504157605),
                                    ("now<hour-of-day> and <relative minutes>",
                                     -5.2284312390838705),
                                    ("yearmonth", -2.487591215158669),
                                    ("Ter\231a-feiraright now", -5.2284312390838705),
                                    ("Sexta-feiraintersect", -5.2284312390838705),
                                    ("dayminute", -4.822966130975706),
                                    ("Setembrotwo time tokens separated by \",\"",
                                     -5.2284312390838705),
                                    ("intersect by `da` or `de`intersect", -5.2284312390838705),
                                    ("<day-of-month> (ordinal or number) de <named-month>de <year>",
                                     -5.2284312390838705),
                                    ("intersectSexta-feira", -4.822966130975706),
                                    ("intersect by `da` or `de`two time tokens separated by \",\"2",
                                     -5.2284312390838705),
                                    ("yearo <ordinal> <cycle> de <time>", -4.822966130975706),
                                    ("Maioyear", -4.822966130975706),
                                    ("passado <cycle>de <year>", -5.2284312390838705),
                                    ("Sexta-feiraintersect by `da` or `de`", -4.1298189504157605),
                                    ("intersect by `da` or `de`Sexta-feira", -4.312140507209715),
                                    ("<time-of-day> am|pm<day-of-month> (ordinal or number) <named-month>",
                                     -4.822966130975706),
                                    ("intersect by `da` or `de`year", -5.2284312390838705),
                                    ("two time tokens separated by \",\"de <year>",
                                     -4.822966130975706),
                                    ("intersect by `da` or `de`de <year>", -3.7243538423075964),
                                    ("yearquarter", -2.2080063529395075),
                                    ("de <datetime> - <datetime> (interval)Julho",
                                     -5.2284312390838705),
                                    ("daynograin", -5.2284312390838705),
                                    ("yearantes das <time-of-day>", -2.395217895027654),
                                    ("Maiode <year>", -4.535284058523925),
                                    ("two time tokens separated by \",\"2de <year>",
                                     -4.822966130975706),
                                    ("intersectde <year>", -5.2284312390838705),
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = 0.0, unseen = -4.174387269895637,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.39768296766610944),
       ...
       ("<day-of-month> (ordinal or number) de <named-month>",
        Classifier{okData =
                     ClassData{prior = -0.24362208265775043,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)Fevereiro", -2.330755969960742),
                                    ("integer (numeric)Mar\231o", -3.1780538303479458),
                                    ("integer (0..19)Maio", -3.1780538303479458),
                                    ("integer (numeric)Abril", -3.58351893845611),
                                    ("integer (numeric)Julho", -3.1780538303479458),
                                    ("ordinals (1..10)Mar\231o", -3.58351893845611),
                                    ("integer (numeric)Dezembro", -3.58351893845611),
                                    ("integer (numeric)Janeiro", -3.58351893845611),
                                    ("month", -0.8754687373538999),
                                    ("integer (0..19)Julho", -3.58351893845611),
                                    ("integer (0..19)Abril", -3.58351893845611),
                                    ("integer (numeric)Maio", -2.890371757896165),
                                    ("integer (0..19)Mar\231o", -2.890371757896165),
                                    ("integer (numeric)Setembro", -2.4849066497880004)],
                               n = 29},
                   koData =
       ...
       ("ordinals (1..10)",
        Classifier{okData =
                     ClassData{prior = -0.24183568432636227, unseen = -4.68213122712422,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 106},
                   koData =
                     ClassData{prior = -1.5379789484519555,
                               unseen = -3.4339872044851463,
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -1.2407867774486523, unseen = -3.332204510175204,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 24},
                   koData =
                     ClassData{prior = -0.34130316389087856,
                               unseen = -4.143134726391533,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.29849298855599654),
                                    ("integer (0..19)", -1.488077055429833),
