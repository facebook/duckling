...
classifiers
  = HashMap.fromList
      [("<cycle> (que vem)",
       ...
       ("<ordinal> <cycle> <time>",
        Classifier{okData =
                     ClassData{prior = -1.3334518797455106,
                               unseen = -5.3981627015177525,
                               likelihoods =
                                 HashMap.fromList
                                   [("monthyear", -1.4423838277709342),
                                    ("quarteryear", -1.4423838277709342),
                                    ("ordinals (primeiro..10)mes (grain)year", -2.6210388241125804),
                               ...
                               n = 102},
                   koData =
                     ClassData{prior = -0.3059355127611313, unseen = -6.375024819828097,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("ordinals (primeiro..10)",
        Classifier{okData =
                     ClassData{prior = -0.2534489008095387, unseen = -4.663439094112067,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 104},
                   koData =
                     ClassData{prior = -1.4966424182887559,
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = 0.0, unseen = -5.802118375377063,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -5.10594547390058), ("monthday", -5.10594547390058),
                                    ("monthyear", -5.10594547390058),
                                    ("yearhour", -4.412798293340635),
                                    ("year (latent)intersect by `da` or `de`", -4.700480365792417),
                                    ("<ordinal> <cycle> <time><ordinal> trimestre <year>",
                                     -4.189654742026425),
                                    ("time-of-day (latent)year (latent)", -4.700480365792417),
                                    ("houryear", -4.700480365792417),
                                    ("<ordinal> trimestre <year><ordinal> <cycle> <time>",
                                     -4.189654742026425),
                                    ("year<ordinal> <cycle> de <time>", -2.36510544997538),
                                    ("year (latent)<day-of-month> de <named-month>",
                                     -5.10594547390058),
                                    ("time-of-day (latent)<day-of-month> de <named-month>",
                                     -5.10594547390058),
                                    ("quarterquarter", -2.1881747418163013),
                                    ("monthhour", -4.700480365792417),
                                    ("yearyear", -4.700480365792417),
                                    ("<ordinal> <cycle> <time><ordinal> <cycle> <time>",
                                     -3.6018680771243066),
                                    ("hourmonth", -5.10594547390058),
                                    ("time-of-day (latent)intersect by `da` or `de`",
                                     -4.700480365792417),
                                    ("time-of-day (latent)time-of-day (latent)",
                                     -4.700480365792417),
                                    ("year (latent)year (latent)", -4.700480365792417),
                                    ("monthmonth", -2.908720896564361),
                                    ("<ordinal> trimestre <year><ordinal> trimestre <year>",
                                     -4.189654742026425),
                                    ("hourhour", -4.412798293340635),
                                    ("Dezembrotime-of-day (latent)", -5.10594547390058),
                                    ("<ordinal> trimestre <year><ordinal> <cycle> de <time>",
                                     -4.189654742026425),
                                    ("Dezembro<day-of-month> de <named-month>", -5.10594547390058),
                                    ("<ordinal> <cycle> <time><ordinal> <cycle> de <time>",
                                     -3.6018680771243066),
                                    ("<ordinal> <cycle> de <time><ordinal> <cycle> <time>",
                                     -3.6018680771243066),
                                    ("year<ordinal> trimestre <year>", -3.0265039322207445),
                                    ("Dezembroyear (latent)", -5.10594547390058),
                                    ("year (latent)time-of-day (latent)", -4.700480365792417),
                                    ("yearmonth", -2.3333567516607996),
                                    ("<ordinal> <cycle> de <time><ordinal> <cycle> de <time>",
                                     -3.6018680771243066),
                                    ("year<ordinal> <cycle> <time>", -2.36510544997538),
                                    ("yearday", -5.10594547390058),
                                    ("Dezembrointersect by `da` or `de`", -4.700480365792417),
                                    ("yearquarter", -1.9704512579714308),
       ...
       ("<ordinal> <cycle> de <time>",
        Classifier{okData =
                     ClassData{prior = -0.9107196868246996, unseen = -5.043425116919247,
                               likelihoods =
                                 HashMap.fromList
                                   [("monthyear", -1.4260346897694047),
                                    ("quarteryear", -1.4260346897694047),
                                    ("ordinals (primeiro..10)mes (grain)year", -1.4260346897694047),
                                    ("ordinals (primeiro..10)trimestre (grain)year",
                                     -1.4260346897694047)],
                               n = 72},
                   koData =
                     ClassData{prior = -0.5145569713788488, unseen = -5.41610040220442,
                               likelihoods =
                                 HashMap.fromList
                                   [("ordinals (primeiro..10)trimestre (grain)intersect",
                                     -2.4159137783010487),
                                    ("ordinals (primeiro..10)mes (grain)<datetime> - <datetime> (interval)",
                                     -1.9776588473698935),
                                    ("quarterquarter", -1.2372587819594028),
                                    ("monthmonth", -1.6274564179367788),
                                    ("ordinals (primeiro..10)mes (grain)intersect",
                                     -2.772588722239781),
                                    ("ordinals (primeiro..10)trimestre (grain)<datetime> - <datetime> (interval)",
                                     -1.583004655365945)],
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -1.2923982753527639, unseen = -5.225746673713201,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 53},
                   koData =
                     ClassData{prior = -0.32104776629558124,
                               unseen = -5.886104031450156,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.4854271156899084),
                                    ("dayhour", -3.803880846808443),
                                    ("daymonth", -5.190175207928333),
                                    ("monthday", -4.091562919260224),
                                    ("monthyear", -3.4854271156899084),
                                    ("now\224s <time-of-day>", -4.7847100998201695),
                                    ("entre <datetime> e <datetime> (interval)Julho",
                                     -3.580737295494233),
                                    ("houryear", -3.24426505887302),
                                    ("Dezembro\224s <time-of-day>", -5.190175207928333),
                                    ("\224s <time-of-day>Julho", -4.7847100998201695),
                                    ("<time-of-day> am|pm<day-of-month> de <named-month>",
                                     -4.497028027368389),
                                    ("Fevereiroin the <part-of-day>", -4.7847100998201695),
                                    ("de <year>antes das <time-of-day>", -2.4493351840031328),
                                    ("monthhour", -3.9374122394329656),
                                    ("Setembrointersect", -5.190175207928333),
                                    ("intersect by `da` or `de`two time tokens separated by \",\"",
                                     -5.190175207928333),
                                    ("hourmonth", -3.24426505887302),
                                    ("Julhode <year>", -5.190175207928333),
                                    ("<time-of-day> am|pmintersect by `da` or `de`",
                                     -4.497028027368389),
                                    ("Setembrotwo time tokens separated by \",\"2",
                                     -5.190175207928333),
                                    ("dayyear", -5.190175207928333),
                                    ("intersect by `da` or `de`\224s <time-of-day>",
                                     -5.190175207928333),
                                    ("passado <cycle>year", -5.190175207928333),
                                    ("de <year>o <ordinal> <cycle> de <time>", -4.7847100998201695),
                                    ("intersect by `da` or `de`in the <part-of-day>",
                                     -4.7847100998201695),
                                    ("Setembrode <year>", -4.091562919260224),
                                    ("now<hour-of-day> and <relative minutes>", -5.190175207928333),
                                    ("yearmonth", -2.4175864856885525),
                                    ("Ter\231a-feiraright now", -5.190175207928333),
                                    ("Sexta-feiraintersect", -5.190175207928333),
                                    ("dayminute", -4.7847100998201695),
                                    ("Setembrotwo time tokens separated by \",\"",
                                     -5.190175207928333),
                                    ("intersect by `da` or `de`intersect", -5.190175207928333),
                                    ("intersectSexta-feira", -4.7847100998201695),
                                    ("intersect by `da` or `de`two time tokens separated by \",\"2",
                                     -5.190175207928333),
                                    ("yearo <ordinal> <cycle> de <time>", -4.7847100998201695),
                                    ("passado <cycle>de <year>", -5.190175207928333),
                                    ("Sexta-feiraintersect by `da` or `de`", -4.091562919260224),
                                    ("intersect by `da` or `de`Sexta-feira", -4.273884476054178),
                                    ("two time tokens separated by \",\"de <year>",
                                     -4.7847100998201695),
                                    ("intersect by `da` or `de`de <year>", -3.6860978111520595),
                                    ("<day-of-month> de <named-month>\224s <time-of-day>",
                                     -5.190175207928333),
                                    ("yearquarter", -2.169750321783971),
                                    ("de <datetime> - <datetime> (interval)Julho",
                                     -4.497028027368389),
                                    ("daynograin", -5.190175207928333),
                                    ("yearantes das <time-of-day>", -2.3569618638721175),
                                    ("Maiode <year>", -4.7847100998201695),
                                    ("<day-of-month> de <named-month>de <year>",
                                     -5.190175207928333),
                                    ("two time tokens separated by \",\"2de <year>",
                                     -4.7847100998201695),
                                    ("intersectde <year>", -5.190175207928333)],
                               n = 140}}),
       ...
       ("<ordinal> trimestre <year>",
        Classifier{okData =
                     ClassData{prior = -1.4753461387357931, unseen = -4.709530201312334,
                               likelihoods =
                                 HashMap.fromList
                                   [("quarteryear", -0.7492366472109889),
                                    ("ordinals (primeiro..10)trimestre (grain)year",
                                     -1.927891643552635),
                                    ("ordinals (primeiro..10)trimestre (grain)de <year>",
                                     -1.0895624531481918)],
                               n = 51},
                   koData =
                     ClassData{prior = -0.2596772946466657,
                               unseen = -5.8664680569332965,
                               likelihoods =
                                 HashMap.fromList
                                   [("ordinals (primeiro..10)trimestre (grain)intersect",
                                     -2.772588722239781),
                                    ("quarterquarter", -0.7103395811003181),
                                    ("ordinals (primeiro..10)trimestre (grain)de <datetime> - <datetime> (interval)",
                                     -2.034989779109002),
                                    ("ordinals (primeiro..10)trimestre (grain)entre <datetime> e <datetime> (interval)",
                                     -1.9123874570166697),
