...
classifiers
  = HashMap.fromList
      [("<cycle> (que vem)",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.2507950826447198, unseen = -5.375278407684165,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 214},
                   koData =
                     ClassData{prior = -1.5058972334932599, unseen = -4.143134726391533,
       ...
       ("intersect by `da` or `de`",
        Classifier{okData =
                     ClassData{prior = -1.920068917871426, unseen = -4.890349128221754,
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -2.9368917735310576),
                                    ("<day-of-month> de <named-month>two time tokens separated by \",\"2",
                                     -4.189654742026425),
                                    ("<day-of-month> de <named-month>intersect",
                                     -4.189654742026425),
                                    ("dd-dd <month> de (interval)year", -4.189654742026425),
                                    ("<day-of-month> de <named-month>two time tokens separated by \",\"",
                                     -4.189654742026425),
                                    ("dayday", -3.4965075614664802),
                                    ("Quart-feira<cycle> (que vem)", -4.189654742026425),
                                    ("dayyear", -2.174751721484161),
                                    ("quarteryear", -4.189654742026425),
                                    ("dd-dd <month>(interval)year", -4.189654742026425),
                                    ("<ordinal> trimestreyear", -4.189654742026425),
                                    ("day of month (1st)Mar\231o", -3.4965075614664802),
                                    ("dayminute", -4.189654742026425),
                                    ("two time tokens separated by \",\"2year", -3.784189633918261),
                                    ("intersectyear", -4.189654742026425),
                                    ("<day-of-month> de <named-month>year", -2.803360380906535),
                                    ("dia <day-of-month> (non ordinal)Fevereiro",
                                     -3.4965075614664802),
                                    ("two time tokens separated by \",\"year", -3.784189633918261),
                                    ("Domingo<cycle> passado", -4.189654742026425),
                                    ("dayweek", -3.4965075614664802),
                                    ("Quart-feiraproximo <cycle> ", -4.189654742026425),
                                    ("dia <day-of-month> (non ordinal)intersect",
                                     -4.189654742026425)],
                               n = 28},
                   koData =
                     ClassData{prior = -0.1585232272398676, unseen = -5.998936561946683,
                               likelihoods =
                                 HashMap.fromList
                                   [("time-of-day (latent)<datetime> - <datetime> (interval)",
                                     -4.897839799950911),
                                    ("hourday", -3.163238744562805),
                                    ("year (latent)Abril", -4.897839799950911),
                                    ("year (latent)Julho", -3.4315027311574844),
                                    ("dayhour", -5.303304908059076),
                                    ("time-of-day (latent)Fevereiro", -3.917010546939185),
                                    ("monthday", -4.61015772749913),
                                    ("monthyear", -3.6938669956249752),
                                    ("yearhour", -3.7992275112828016),
                                    ("entre <datetime> e <datetime> (interval)Julho",
                                     -3.6938669956249752),
                                    ("houryear", -3.3573947590037623),
                                    ("year (latent)Maio", -4.387014176184921),
                                    ("time-of-day (latent)two time tokens separated by \",\"2",
                                     -4.897839799950911),
                                    ("Setembroyear", -4.204692619390966),
                                    ("time-of-day (latent)Setembro", -4.204692619390966),
                                    ("time-of-day (latent)intersect", -3.3573947590037623),
                                    ("year (latent)<time-of-day> <part-of-day>",
                                     -5.303304908059076),
                                    ("\224s <time-of-day>Julho", -4.61015772749913),
                                    ("year (latent)intersect", -4.204692619390966),
                                    ("Setembrointersect", -5.303304908059076),
                                    ...
                                    ("time-of-day (latent)intersect by `da` or `de`",
                                     -3.5115454388310208),
                                    ("monthmonth", -5.303304908059076),
                                    ("Setembrotwo time tokens separated by \",\"2",
                                     -5.303304908059076),
                                    ("year (latent)Fevereiro", -3.917010546939185),
                                    ("time-of-day (latent)Dezembro", -5.303304908059076),
                                    ("dayyear", -5.303304908059076),
                                    ("time-of-day (latent)Julho", -3.5985568158206505),
                                    ("time-of-day (latent)Abril", -4.897839799950911),
                                    ("passado <cycle>year", -5.303304908059076),
                                    ("year (latent)<dim time> da manha", -5.303304908059076),
                                    ("time-of-day (latent)Mar\231o", -4.204692619390966),
                                    ("year (latent)Janeiro", -5.303304908059076),
                                    ("year (latent)Dezembro", -5.303304908059076),
                                    ("entre <datetime> e <datetime> (interval)Janeiro",
                                     -5.303304908059076),
                                    ("yearmonth", -2.21226245470076),
                                    ("two time tokens separated by \",\"2year", -4.897839799950911),
                                    ("Setembrotwo time tokens separated by \",\"",
                                     -5.303304908059076),
                                    ("intersect by `da` or `de`intersect", -5.303304908059076),
                                    ("intersectyear", -5.303304908059076),
                                    ("intersect by `da` or `de`two time tokens separated by \",\"2",
                                     -5.303304908059076),
                                    ("time-of-day (latent)Maio", -4.387014176184921),
                                    ("<day-of-month> de <named-month>year", -5.303304908059076),
                                    ("antes das <time-of-day>Julho", -4.050541939563708),
                                    ("Maioyear", -4.897839799950911),
                                    ("year (latent)Setembro", -4.204692619390966),
                                    ("\224s <time-of-day>Janeiro", -5.303304908059076),
                                    ("two time tokens separated by \",\"year", -4.897839799950911),
                                    ("time-of-day (latent)two time tokens separated by \",\"",
                                     -4.897839799950911),
                                    ("intersect by `da` or `de`year", -3.7992275112828016),
                                    ("year (latent)<datetime> - <datetime> (interval)",
                                     -4.897839799950911),
                                    ("yearday", -5.303304908059076),
                                    ("time-of-day (latent)Janeiro", -5.303304908059076),
                                    ("dia <day-of-month> (non ordinal)intersect",
                                     -5.303304908059076),
                                    ("Julhoyear", -5.303304908059076),
                                    ("de <datetime> - <datetime> (interval)Julho",
                                     -5.303304908059076),
                                    ("year (latent)Mar\231o", -4.204692619390966),
       ...
       ("<day-of-month> de <named-month>",
        Classifier{okData =
                     ClassData{prior = -0.25951119548508456,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)Fevereiro", -2.12525107771113),
                                    ("integer (numeric)Mar\231o", -3.1060803307228566),
                                    ("integer (0..19)Maio", -3.1060803307228566),
                                    ("integer (numeric)Abril", -3.5115454388310208),
                                    ("integer (numeric)Julho", -3.5115454388310208),
                                    ("integer (numeric)Dezembro", -3.5115454388310208),
                                    ("integer (numeric)Janeiro", -3.5115454388310208),
                                    ("month", -0.8724881092157621),
                                    ("integer (0..19)Julho", -3.5115454388310208),
                                    ("integer (0..19)Abril", -3.5115454388310208),
                                    ("integer (numeric)Maio", -3.1060803307228566),
                                    ("integer (0..19)Mar\231o", -2.8183982582710754),
                                    ("integer (numeric)Setembro", -2.412933150162911)],
                               n = 27},
                   koData =
                     ClassData{prior = -1.4759065198095778,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<hour-of-day> and quinzeafternoon", -3.044522437723423),
                                    ("<day-of-month> de <named-month>morning", -3.960813169597578),
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -1.026085844599847, unseen = -5.541263545158426,
                               likelihoods =
                                 HashMap.fromList
                                   [("<day-of-month> de <named-month>in the <part-of-day>",
                                     -4.438721978350427),
                                    ("dayhour", -1.87377262088889),
                                    ...
                                    ("dia <day-of-month> de <named-month>\224s <time-of-day>",
                                     -4.844187086458591),
                                    ("tomorrowin the <part-of-day>", -3.927896354584436),
                                    ("nowquinze para as <hour-of-day> (as relative minutes)",
                                     -4.844187086458591),
                                    ("Quart-feiraamanh\227 pela <part-of-day>", -4.844187086458591),
                                    ("now\224s <time-of-day>", -4.438721978350427),
                                    ("<day-of-month> de <named-month>intersect",
                                     -4.844187086458591),
                                    ("now<hour-of-day> and 3/4", -4.844187086458591),
                                    ("<day-of-month> de <named-month>two time tokens separated by \",\"",
                                     -4.844187086458591),
                                    ("Segunda-feirain the <part-of-day>", -4.844187086458591),
                                    ("Quart-feira<time-of-day> <part-of-day>", -4.844187086458591),
                                    ("yearSexta-feira", -4.844187086458591),
                                    ("dayday", -3.340109689682317),
                                    ("hourhour", -4.844187086458591),
                                    ("dayyear", -2.8292840659163265),
                                    ("Quinta-feira\224s <time-of-day>", -4.151039905898646),
                                    ("de <year>Sexta-feira", -4.844187086458591),
                                    ("quarteryear", -4.844187086458591),
                                    ("intersect by `da` or `de`\224s <time-of-day>",
                                     -4.844187086458591),
                                    ("monthminute", -4.844187086458591),
                                    ("minutehour", -3.591424117963223),
                                    ("<hour-of-day> and quinzein the <part-of-day>",
                                     -4.438721978350427),
                                    ("intersect by `da` or `de`in the <part-of-day>",
                                     -4.438721978350427),
                                    ("now<hour-of-day> and <relative minutes>", -4.844187086458591),
                                    ("tomorrow<time-of-day> horas", -4.438721978350427),
                                    ("dd-dd <month> de (interval)de <year>", -4.844187086458591),
                                    ("now<integer> para as <hour-of-day> (as relative minutes)",
                                     -4.844187086458591),
                                    ("Quinta-feira<time-of-day> horas", -4.844187086458591),
                                    ("\224s <time-of-day>in the <part-of-day>", -4.151039905898646),
                                    ("Sexta-feiraintersect", -4.844187086458591),
                                    ("Fevereiro\224s <time-of-day>", -4.844187086458591),
                                    ("dayminute", -3.139438994220166),
                                    ("<ordinal> trimestrede <year>", -4.844187086458591),
                                    ("intersectSexta-feira", -4.844187086458591),
                                    ("Sexta-feira<day-of-month> de <named-month>",
                                     -4.844187086458591),
                                    ("dd-dd <month>(interval)de <year>", -4.844187086458591),
                                    ("Sexta-feiraintersect by `da` or `de`", -4.844187086458591),
                                    ("intersect by `da` or `de`Sexta-feira", -4.844187086458591),
                                    ("tomorrow\224s <time-of-day>", -4.844187086458591),
                                    ("dia <day-of-month> de <named-month>in the <part-of-day>",
                                     -4.438721978350427),
                                    ("tomorrow<time-of-day> <part-of-day>", -4.844187086458591),
                                    ("yearday", -4.438721978350427),
                                    ...
                                    ("<day-of-month> de <named-month>\224s <time-of-day>",
                                     -4.844187086458591),
                                    ("Quart-feira\224s <time-of-day>", -4.844187086458591),
                                    ("<day-of-month> de <named-month>de <year>",
                                     -3.457892725338701),
                                    ("Quart-feira<dim time> da manha", -4.844187086458591),
                                    ("yesterdayin the <part-of-day>", -3.927896354584436),
                                    ("tomorrowdepois das <time-of-day>", -4.438721978350427),
                                    ("<hour-of-day> and <relative minutes>in the <part-of-day>",
                                     -4.438721978350427),
                                    ("tomorrowamanh\227 pela <part-of-day>", -4.844187086458591),
                                    ("two time tokens separated by \",\"2de <year>",
                                     -4.438721978350427),
                                    ("intersectde <year>", -4.844187086458591),
                                    ("n[ao] <date>\224s <time-of-day>", -4.844187086458591)],
                               n = 81},
                   koData =
                     ClassData{prior = -0.44380125685171146,
                               unseen = -5.948034989180646,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.5475253358082046),
                                    ("dayhour", -3.460513958818575),
                                    ("daymonth", -5.25227342804663),
                                    ("monthday", -4.15366113937852),
                                    ("monthyear", -3.5475253358082046),
                                    ("dia <day-of-month> (non ordinal)\224s <time-of-day>",
                                     -5.25227342804663),
                                    ("dia <day-of-month> de <named-month>\224s <time-of-day>",
                                     -5.25227342804663),
                                    ("now\224s <time-of-day>", -4.846808319938465),
                                    ("entre <datetime> e <datetime> (interval)Julho",
                                     -3.6428355156125294),
                                    ("houryear", -3.3063632789913164),
                                    ("Dezembro\224s <time-of-day>", -5.25227342804663),
                                    ("\224s <time-of-day>Julho", -4.846808319938465),
                                    ("<time-of-day> am|pm<day-of-month> de <named-month>",
                                     -4.5591262474866845),
                                    ("Fevereiroin the <part-of-day>", -4.846808319938465),
                                    ("de <year>antes das <time-of-day>", -2.511433404121429),
                                    ("monthhour", -3.7481960312703557),
                                    ("Setembrointersect", -5.25227342804663),
                                    ("intersect by `da` or `de`two time tokens separated by \",\"",
                                     -5.25227342804663),
                                    ("hourmonth", -3.3804712511450385),
                                    ("Julhode <year>", -5.25227342804663),
                                    ("<time-of-day> am|pmintersect by `da` or `de`",
                                     -4.5591262474866845),
                                    ("Setembrotwo time tokens separated by \",\"2",
                                     -5.25227342804663),
                                    ("dayyear", -5.25227342804663),
                                    ("intersect by `da` or `de`\224s <time-of-day>",
                                     -4.335982696172475),
                                    ("monthminute", -5.25227342804663),
                                    ("passado <cycle>year", -5.25227342804663),
                                    ("de <year>o <ordinal> <cycle> de <time>", -4.846808319938465),
                                    ("intersect by `da` or `de`in the <part-of-day>",
                                     -4.846808319938465),
                                    ("Setembrode <year>", -4.15366113937852),
                                    ("now<hour-of-day> and <relative minutes>", -5.25227342804663),
                                    ("yearmonth", -2.511433404121429),
                                    ("Ter\231a-feiraright now", -5.25227342804663),
                                    ("Sexta-feiraintersect", -5.25227342804663),
                                    ("Fevereiro\224s <time-of-day>", -5.25227342804663),
                                    ("dayminute", -4.846808319938465),
                                    ("Setembrotwo time tokens separated by \",\"",
                                     -5.25227342804663),
                                    ("intersect by `da` or `de`intersect", -5.25227342804663),
                                    ("intersectSexta-feira", -4.846808319938465),
                                    ("intersect by `da` or `de`two time tokens separated by \",\"2",
                                     -5.25227342804663),
                                    ("yearo <ordinal> <cycle> de <time>", -4.846808319938465),
                                    ("passado <cycle>de <year>", -5.25227342804663),
                                    ("Sexta-feiraintersect by `da` or `de`", -4.15366113937852),
                                    ("intersect by `da` or `de`Sexta-feira", -4.335982696172475),
                                    ("two time tokens separated by \",\"de <year>",
                                     -4.846808319938465),
                                    ("intersect by `da` or `de`de <year>", -3.7481960312703557),
                                    ("<day-of-month> de <named-month>\224s <time-of-day>",
                                     -4.846808319938465),
                                    ("yearquarter", -2.2318485419022673),
                                    ("de <datetime> - <datetime> (interval)Julho",
                                     -5.25227342804663),
                                    ("daynograin", -5.25227342804663),
                                    ("yearantes das <time-of-day>", -2.4190600839904137),
                                    ("Maiode <year>", -4.846808319938465),
                                    ("<day-of-month> de <named-month>de <year>", -5.25227342804663),
                                    ("two time tokens separated by \",\"2de <year>",
                                     -4.846808319938465),
                                    ("intersectde <year>", -5.25227342804663)],
                               n = 145}}),
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = 0.0, unseen = -4.174387269895637,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.42121346507630353),
                                    ("integer (0..19)", -1.3256697393034558),
                                    ("negative numbers", -3.0602707946915624),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<hour-of-day> and quinzeafternoon", -3.152736022363656),
                                    ("<day-of-month> de <named-month>morning", -4.069026754237811),
       ...
       ("ordinals (1..10)",
        Classifier{okData =
                     ClassData{prior = -0.2660205756706016, unseen = -4.672828834461907,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 105},
                   koData =
                     ClassData{prior = -1.4542450230283983,
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -1.0775588794702773, unseen = -3.58351893845611,
                               likelihoods =
                                 HashMap.fromList
                   ...
                   koData =
                     ClassData{prior = -0.41616039722491244,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.2825669717850105),
                                    ("integer (0..19)", -1.5353299402803784),
                                    ("tens (20..90)", -3.481240089335692)],
                               n = 62}}),
