...
classifiers
  = HashMap.fromList
      [("<cycle> (que vem)",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -1.1824309605511811, unseen = -5.318119993844216,
                               likelihoods =
                                 HashMap.fromList
                                   [("<day-of-month> de <named-month>in the <part-of-day>",
                                     -4.214593690373678),
                                    ("dayhour", -2.135152148693842),
                                    ("<day-of-month> de <named-month>two time tokens separated by \",\"2",
                                     -4.620058798481842),
                                    ("tomorrowin the <part-of-day>", -3.703768066607687),
                                    ("nowquinze para as <hour-of-day> (as relative minutes)",
                                     -4.620058798481842),
                                    ("Quart-feiraamanh\227 pela <part-of-day>", -4.620058798481842),
                                    ("now\224s <time-of-day>", -4.214593690373678),
                                    ("<day-of-month> de <named-month>intersect",
                                     -4.620058798481842),
                                    ("now<hour-of-day> and 3/4", -4.620058798481842),
                                    ("<day-of-month> de <named-month>two time tokens separated by \",\"",
                                     -4.620058798481842),
                                    ("Segunda-feirain the <part-of-day>", -4.620058798481842),
                                    ("Quart-feira<time-of-day> <part-of-day>", -4.620058798481842),
                                    ("yearSexta-feira", -4.620058798481842),
                                    ("dayday", -3.115981401705568),
                                    ("hourhour", -4.620058798481842),
                                    ("dayyear", -2.605155777939577),
                                    ("de <year>Sexta-feira", -4.620058798481842),
                                    ("quarteryear", -4.620058798481842),
                                    ("minutehour", -3.367295829986474),
                                    ("<hour-of-day> and quinzein the <part-of-day>",
                                     -4.214593690373678),
                                    ("intersect by `da` or `de`in the <part-of-day>",
                                     -4.214593690373678),
                                    ("now<hour-of-day> and <relative minutes>", -4.620058798481842),
                                    ("tomorrow<time-of-day> horas", -4.214593690373678),
                                    ("dd-dd <month> de (interval)de <year>", -4.620058798481842),
                                    ("now<integer> para as <hour-of-day> (as relative minutes)",
                                     -4.620058798481842),
                                    ("\224s <time-of-day>in the <part-of-day>", -3.926911617921897),
                                    ("Sexta-feiraintersect", -4.620058798481842),
                                    ("dayminute", -3.367295829986474),
                                    ("<ordinal> trimestrede <year>", -4.620058798481842),
                                    ("intersectSexta-feira", -4.620058798481842),
                                    ("Sexta-feira<day-of-month> de <named-month>",
                                     -4.620058798481842),
                                    ("dd-dd <month>(interval)de <year>", -4.620058798481842),
                                    ("Sexta-feiraintersect by `da` or `de`", -4.620058798481842),
                                    ("intersect by `da` or `de`Sexta-feira", -4.620058798481842),
                                    ("dia <day-of-month> de <named-month>in the <part-of-day>",
                                     -4.214593690373678),
                                    ("yearday", -4.214593690373678),
                                    ("two time tokens separated by \",\"de <year>",
                                     -4.214593690373678),
                                    ("Quart-feira\224s <time-of-day>", -4.620058798481842),
                                    ("<day-of-month> de <named-month>de <year>",
                                     -3.2337644373619514),
                                    ("Quart-feira<dim time> da manha", -4.620058798481842),
                                    ("yesterdayin the <part-of-day>", -3.703768066607687),
                                    ("tomorrowdepois das <time-of-day>", -4.214593690373678),
                                    ("<hour-of-day> and <relative minutes>in the <part-of-day>",
                                     -4.214593690373678),
                                    ("two time tokens separated by \",\"2de <year>",
                                     -4.214593690373678),
                                    ("intersectde <year>", -4.620058798481842)],
                               n = 61},
                   koData =
                     ClassData{prior = -0.3660511395672877, unseen = -5.8805329864007,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.4798405089812685),
                                    ("dayhour", -3.798294240099803),
                                    ("daymonth", -5.184588601219693),
                                    ("monthday", -4.085976312551584),
                                    ("monthyear", -3.4798405089812685),
                                    ("now\224s <time-of-day>", -4.77912349311153),
                                    ("entre <datetime> e <datetime> (interval)Julho",
                                     -3.5751506887855933),
                                    ("houryear", -3.2386784521643803),
                                    ("Dezembro\224s <time-of-day>", -5.184588601219693),
                                    ("\224s <time-of-day>Julho", -4.77912349311153),
                                    ("<time-of-day> am|pm<day-of-month> de <named-month>",
                                     -4.491441420659749),
                                    ("Fevereiroin the <part-of-day>", -4.77912349311153),
                                    ("de <year>antes das <time-of-day>", -2.443748577294493),
                                    ("monthhour", -3.9318256327243257),
                                    ("Setembrointersect", -5.184588601219693),
                                    ("intersect by `da` or `de`two time tokens separated by \",\"",
                                     -5.184588601219693),
                                    ("hourmonth", -3.3127864243181024),
                                    ("Julhode <year>", -5.184588601219693),
                                    ("<time-of-day> am|pmintersect by `da` or `de`",
                                     -4.491441420659749),
                                    ("Setembrotwo time tokens separated by \",\"2",
                                     -5.184588601219693),
                                    ("dayyear", -5.184588601219693),
                                    ("intersect by `da` or `de`\224s <time-of-day>",
                                     -5.184588601219693),
                                    ("passado <cycle>year", -5.184588601219693),
                                    ("de <year>o <ordinal> <cycle> de <time>", -4.77912349311153),
                                    ("intersect by `da` or `de`in the <part-of-day>",
                                     -4.77912349311153),
                                    ("Setembrode <year>", -4.085976312551584),
                                    ("now<hour-of-day> and <relative minutes>", -5.184588601219693),
                                    ("yearmonth", -2.443748577294493),
                                    ("Ter\231a-feiraright now", -5.184588601219693),
                                    ("Sexta-feiraintersect", -5.184588601219693),
                                    ("dayminute", -4.77912349311153),
                                    ("Setembrotwo time tokens separated by \",\"",
                                     -5.184588601219693),
                                    ("intersect by `da` or `de`intersect", -5.184588601219693),
                                    ("intersectSexta-feira", -4.77912349311153),
                                    ("intersect by `da` or `de`two time tokens separated by \",\"2",
                                     -5.184588601219693),
                                    ("yearo <ordinal> <cycle> de <time>", -4.77912349311153),
                                    ("passado <cycle>de <year>", -5.184588601219693),
                                    ("Sexta-feiraintersect by `da` or `de`", -4.085976312551584),
                                    ("intersect by `da` or `de`Sexta-feira", -4.268297869345538),
                                    ("two time tokens separated by \",\"de <year>",
                                     -4.77912349311153),
                                    ("intersect by `da` or `de`de <year>", -3.6805112044434196),
                                    ("<day-of-month> de <named-month>\224s <time-of-day>",
                                     -5.184588601219693),
                                    ("yearquarter", -2.1641637150753312),
                                    ("de <datetime> - <datetime> (interval)Julho",
                                     -5.184588601219693),
                                    ("daynograin", -5.184588601219693),
                                    ("yearantes das <time-of-day>", -2.3513752571634776),
                                    ("Maiode <year>", -4.77912349311153),
                                    ("<day-of-month> de <named-month>de <year>",
                                     -5.184588601219693),
                                    ("two time tokens separated by \",\"2de <year>",
                                     -4.77912349311153),
                                    ("intersectde <year>", -5.184588601219693)],
                               n = 138}}),
       ...
       ("amanh\227 pela <part-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.3163373282121571, unseen = -4.727387818712341,
                               likelihoods =
                                 HashMap.fromList
                                   [("<hour-of-day> and quinzeafternoon", -3.109060958860994),
                                    ("<day-of-month> de <named-month>morning", -4.02535169073515),
                                    ("dayhour", -2.639057329615259),
                                    ("\224s <time-of-day>morning", -3.332204510175204),
                                    ("tomorrowafternoon", -4.02535169073515),
                                    ("hourhour", -1.9459101490553135),
                                    ("<hour-of-day> and halfafternoon", -3.109060958860994),
                                    ("minutehour", -1.6274564179367788),
                                    ("tomorrowevening", -4.02535169073515),
                                    ("time-of-day (latent)morning", -3.332204510175204),
                                    ("yesterdayafternoon", -4.02535169073515),
                                    ("time-of-day (latent)evening", -3.619886582626985),
                                    ("\224s <time-of-day>afternoon", -2.4159137783010487),
                                    ("dia <day-of-month> de <named-month>morning",
                                     -4.02535169073515),
                                    ("yesterdayevening", -4.02535169073515),
                                    ("time-of-day (latent)afternoon", -3.619886582626985),
                                    ("<hour-of-day> and <relative minutes>afternoon",
                                     -2.772588722239781),
                                    ("intersectmorning", -4.02535169073515),
                                    ("\224s <time-of-day>evening", -3.619886582626985),
                                    ("intersect by `da` or `de`morning", -4.02535169073515)],
                               n = 43},
                   koData =
                     ClassData{prior = -1.3049487216659381, unseen = -4.07753744390572,
                               likelihoods =
                                 HashMap.fromList
                                   [("yearhour", -1.575536360758419),
                                    ("monthhour", -2.9618307218783095),
                                    ("hourhour", -2.6741486494265287),
                                    ("time-of-day (latent)morning", -3.367295829986474),
                                    ("year (latent)afternoon", -2.268683541318364),
                                    ("Fevereiromorning", -3.367295829986474),
                                    ("year (latent)evening", -2.9618307218783095),
                                    ("time-of-day (latent)afternoon", -2.9618307218783095),
                                    ("year (latent)morning", -2.451005098112319),
                                    ("intersect by `da` or `de`morning", -3.367295829986474)],
                               n = 16}}),
       ("dentro de <duration>",
        Classifier{okData =
