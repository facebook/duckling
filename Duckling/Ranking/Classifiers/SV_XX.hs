...
classifiers
  = HashMap.fromList
      [("<time> timezone",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.8126381585614849, unseen = -4.882801922586371,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 130},
                   koData =
                     ClassData{prior = -0.5864224082103051, unseen = -5.10594547390058,
       ...
       ("at <time-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.29266961396281993, unseen = -4.68213122712422,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time> timezone", -3.5742165457937967),
                                    ("time-of-day (latent)", -1.271631452799751),
                                    ("relative minutes after|past <integer> (hour-of-day)",
                                     -3.5742165457937967),
                                    ("hh:mm", -1.900240112222125),
                                    ("<time-of-day> sharp", -3.5742165457937967),
                                    ("hour", -1.2070929316621797), ("minute", -1.6770965609079151)],
                               n = 50},
                   koData =
                     ClassData{prior = -1.37147927533475, unseen = -3.7376696182833684,
                               likelihoods =
                                 HashMap.fromList
                                   [("time-of-day (latent)", -0.8232003088081431),
                                    ("hour", -0.8232003088081431)],
                               n = 17}}),
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.42050298547270487,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Onsdagthis <cycle>", -5.153291594497779),
                                    ("Torsdag<time> timezone", -4.460144413937834),
                                    ...
                                    ("daymonth", -3.013225431001508),
                                    ("monthyear", -3.138388573955514),
                                    ("Torsdagbetween <time-of-day> and <time-of-day> (interval)",
                                     -5.153291594497779),
                                    ("Mandagon <date>", -5.153291594497779),
                                    ("yyyy-mm-ddat <time-of-day>", -4.460144413937834),
                                    ("intersecthh:mm", -5.153291594497779),
                                    ("Torsdagbetween <datetime> and <datetime> (interval)",
                                     -5.153291594497779),
                                    ("Torsdagat <time-of-day>", -4.747826486389615),
                                    ("Marsyear", -5.153291594497779),
                                    ("intersect by \"of\", \"from\", \"'s\"year",
                                     -4.747826486389615),
                                    ("Oktoberyear", -3.543853682063679),
                                    ("Torsdagfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.747826486389615),
                                    ("Torsdagfrom <datetime> - <datetime> (interval)",
                                     -4.747826486389615),
                                    ("last <day-of-week> of <time>year", -5.153291594497779),
                                    ("todayat <time-of-day>", -4.747826486389615),
                                    ("the <day-of-month> (ordinal)Februari", -5.153291594497779),
                                    ("dayday", -3.2814894175961875),
                                    ("dd/mmat <time-of-day>", -4.237000862623624),
                                    ("intersect by \",\"hh:mm", -4.237000862623624),
                                    ("dayyear", -3.361532125269724),
                                    ...
                                    ("Onsdag<named-month> <day-of-month> (non ordinal)",
                                     -5.153291594497779),
                                    ("Onsdagthis <time>", -4.460144413937834),
                                    ...
                                    ("the <day-of-month> (ordinal)Mars", -4.054679305829669),
                                    ("intersect by \",\"<day-of-month> (non ordinal) <named-month>",
                                     -4.747826486389615),
                                    ("Mandagthis <cycle>", -5.153291594497779),
                                    ...
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -4.460144413937834),
                                    ("on <date>Mars", -4.054679305829669),
                                    ...
                                    ("Tisdagthis <time>", -4.747826486389615),
                                    ("Onsdagnext <cycle>", -5.153291594497779),
                                    ("absorption of , after named dayintersect by \",\"",
                                     -4.747826486389615),
                                    ("Sondaglast <cycle>", -5.153291594497779),
                                    ...
                                    ("between <datetime> and <datetime> (interval)on <date>",
                                     -5.153291594497779),
                                    ("dayweek", -3.900528626002411),
                                    ("Tisdagthis <cycle>", -5.153291594497779),
                                    ("on <date>Februari", -5.153291594497779),
                   ...
                   koData =
                     ClassData{prior = -1.0691984034618165,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("OnsdagFebruari", -4.700480365792417),
                                    ("dayhour", -2.908720896564361),
                                    ("daymonth", -2.1355310083308794),
                                    ("monthday", -3.784189633918261),
                                    ("monthyear", -3.784189633918261),
                                    ("Torsdagbetween <time-of-day> and <time-of-day> (interval)",
                                     -4.700480365792417),
                                    ("Mandagon <date>", -4.295015257684252),
                                    ("yyyy-mm-ddat <time-of-day>", -4.007333185232471),
                                    ("Torsdagbetween <datetime> and <datetime> (interval)",
                                     -4.700480365792417),
                                    ("Torsdagat <time-of-day>", -3.784189633918261),
                                    ("Marsyear", -4.007333185232471),
                                    ("intersect by \"of\", \"from\", \"'s\"year",
                                     -3.6018680771243066),
                                    ("Torsdagfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.700480365792417),
                                    ("Torsdagfrom <datetime> - <datetime> (interval)",
                                     -4.295015257684252),
                                    ("Mandagintersect", -4.295015257684252),
                                    ("absorption of , after named dayJuli", -4.295015257684252),
                                    ("hourmonth", -4.295015257684252),
                                    ("dd/mmat <time-of-day>", -3.784189633918261),
                                    ("dayyear", -3.3141860046725258),
                                    ("<named-month> <day-of-month> (non ordinal)Augusti",
                                     -3.784189633918261),
                                    ("Augusti<day-of-month> (non ordinal) <named-month>",
                                     -3.784189633918261),
                                    ("Onsdagthis <time>", -3.4477173972970485),
                                    ("Aprilyear", -4.700480365792417),
                                    ("yearmonth", -4.700480365792417),
                                    ("until <time-of-day>on <date>", -4.700480365792417),
                                    ("Torsdaghh:mm", -4.700480365792417),
                                    ("dayminute", -3.3141860046725258),
                                    ("minuteday", -3.196402969016142),
                                    ("Tisdagthis <time>", -3.784189633918261),
                                    ("hh:mmon <date>", -3.3141860046725258),
                                    ("on <date>Februari", -4.295015257684252),
                                    ("absorption of , after named dayFebruari", -4.007333185232471),
                                    ("intersectFebruari", -4.295015257684252),
                                    ("Mandagthis <time>", -4.700480365792417),
                                    ("Sondagthis <time>", -4.295015257684252)],
                               n = 69}}),
