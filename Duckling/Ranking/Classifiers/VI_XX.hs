...
classifiers
  = HashMap.fromList
      [("<time> timezone",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5028732955754956, unseen = -4.634728988229636,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 101},
                   koData =
                     ClassData{prior = -0.9283390703903296, unseen = -4.219507705176107,
       ...
       ("<part-of-day> <time>",
        Classifier{okData =
                     ClassData{prior = -0.3746934494414107,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -1.0116009116784799),
                                    ("noonh\244m nay", -2.803360380906535),
                                    ("lunchng\224y mai", -2.3978952727983707),
                                    ("noonng\224y h\244m qua", -2.3978952727983707),
                                    ("morningSunday", -2.3978952727983707),
                                    ("noonng\224y mai", -2.3978952727983707),
                                    ("afternoonng\224y dd/mm", -2.803360380906535),
                                    ("afternoonng\224y mai", -2.803360380906535)],
                               n = 11},
                   koData =
                                 ...
                                 HashMap.fromList
                                   [("<time-of-day> s\225ng|chi\7873u|t\7889ing\224y dd/mm",
                                    ...
                                    ("h\244m nay<time-of-day> s\225ng|chi\7873u|t\7889i",
                                     -4.330733340286331),
                                    ("monthyear", -3.414442608412176),
                                    ("Wednesdaynext <cycle>", -4.330733340286331),
                                    ("Tuesday<day-of-month> (numeric with day symbol) <named-month>",
                                     -4.330733340286331),
                                    ("time-of-day gi\7901<part-of-day> <time>", -4.330733340286331),
                                    ("Sunday<day-of-month> (numeric with day symbol) <named-month>",
                                     -3.6375861597263857),
                                    ("time-of-day gi\7901<time> n\224y", -4.330733340286331),
                                    ("month (numeric with month symbol)year (numeric with year symbol)",
                                     -3.6375861597263857),
                                    ("dayday", -2.538973871058276),
                                    ("hourhour", -3.414442608412176),
                                    ("intersectyear (numeric with year symbol)",
                                     -3.6375861597263857),
                                    ("dayyear", -2.4589311633847397),
                                    ("<ordinal> <cycle> of <time>year (numeric with year symbol)",
                                     -4.330733340286331),
                                    ("minutehour", -3.925268232178167),
                                    ("<time-of-day> s\225ng|chi\7873u|t\7889iintersect",
                                     -3.925268232178167),
                                    ("Thursdaynext <cycle>", -3.925268232178167),
                                    ("Octoberyear (numeric with year symbol)", -4.330733340286331),
                                    ...
                                    ("<time-of-day> s\225ng|chi\7873u|t\7889i<day-of-month> (numeric with day symbol) <named-month>",
                                     -3.414442608412176),
                                    ("time-of-day gi\7901tonight", -4.330733340286331),
                                    ("minuteday", -2.826655943510057),
                                    ("hh:mm<part-of-day> <time>", -4.330733340286331),
                                    ("<day-of-month> <named-month>year (numeric with year symbol)",
                                     -3.2321210516182215),
                                    ("Fridaythis <cycle>", -3.925268232178167),
                                    ("Thursdaythis <cycle>", -4.330733340286331),
                                    ("at hh:mm<part-of-day> <time>", -4.330733340286331),
                                    ("dayweek", -3.077970371790963),
                                    ...
                                    ("Monday<day-of-month> (numeric with day symbol) <named-month>",
                                     -3.077970371790963),
                                    ("seasonthis <cycle>", -4.330733340286331),
                                    ("minuteyear", -3.925268232178167)],
                               n = 54},
                   koData =
                     ClassData{prior = -1.5260563034950494, unseen = -4.31748811353631,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> s\225ng|chi\7873u|t\7889ing\224y dd/mm",
                                     -3.6109179126442243),
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -infinity, unseen = -2.995732273553991,
                               likelihoods = HashMap.fromList [], n = 0},
                   koData =
                     ClassData{prior = 0.0, unseen = -5.236441962829949,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -3.4393491476265314),
                                    ("integer (0..19)year (grain)", -4.537961436294641),
                                    ("integer (numeric)day (grain)", -3.0338840395183673),
                                    ("integer (0..19)hour (grain)", -3.844814255734696),
                                    ("second", -3.6216707044204863),
                                    ("integer (numeric)second (grain)", -3.6216707044204863),
                                    ("integer (numeric)year (grain)", -2.66615925939305),
                                    ("day", -2.833213344056216), ("year", -2.592051287239328),
                                    ("integer (numeric)week (grain)", -4.132496328186477),
                                    ("integer (0..19)month (grain)", -4.537961436294641),
                                    ("hour", -2.012232791986386), ("month", -2.012232791986386),
                                    ("integer (numeric)minute (grain)", -3.6216707044204863),
                                    ("integer (numeric)month (grain)", -2.053054786506641),
                                    ("minute", -3.6216707044204863),
                                    ("integer (numeric)hour (grain)", -2.1400661634962708),
                                    ("integer (0..19)day (grain)", -4.132496328186477),
                                    ("integer (0..19)week (grain)", -3.844814255734696)],
                               n = 84}}),
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.6094379124341003,
