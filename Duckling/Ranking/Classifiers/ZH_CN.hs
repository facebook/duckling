...
classifiers
  = HashMap.fromList
      [("\25490\28783\33410",
       ...
       ("<time-of-day> o'clock",
        Classifier{okData =
                     ClassData{prior = -1.1700712526502546, unseen = -3.044522437723423,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<integer> (latent time-of-day)",
        Classifier{okData =
                     ClassData{prior = -0.3272129112084162,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -1.916922612182061),
                                    ("integer (0..10)", -0.1941560144409575)],
                               n = 31},
                   koData =
                     ClassData{prior = -1.276293465905562, unseen = -2.772588722239781,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<part-of-day> <dim time>",
        Classifier{okData =
                     ClassData{prior = -0.7746402148111282, unseen = -4.762173934797756,
                               likelihoods =
                                 HashMap.fromList
                                   [("tonight<integer> (latent time-of-day)", -3.144152278672264),
                                    ("afternoonrelative (10-59) minutes after|past <integer> (hour-of-day)",
                                     -1.6180959751772148),
                                    ("hourhour", -2.0455399900041544),
                                    ("afternoon<time-of-day> o'clock", -3.367295829986474),
                                    ("hourminute", -1.0647107369924282),
                                    ("afternoon<integer> (latent time-of-day)", -3.367295829986474),
                                    ("afternoonrelative (1-9) minutes after|past <integer> (hour-of-day)",
                                     -2.451005098112319),
                                    ("afternoonhh:mm (time-of-day)", -3.654977902438255),
                                    ("tonight<time-of-day> o'clock", -3.144152278672264),
                                    ("afternoonnumber of 5 minutes after|past <integer> (hour-of-day)",
                                     -2.8076800420510515)],
                               n = 53},
                   koData =
                     ClassData{prior = -0.6177977433181585, unseen = -4.90527477843843,
                               likelihoods =
                                 HashMap.fromList
                                   [("afternoonrelative (10-59) minutes after|past <integer> (hour-of-day)",
                                     -2.0646264558946954),
                                    ("hourhour", -1.0476921982408527),
                                    ("afternoon<time-of-day> o'clock", -1.8533173622274883),
                                    ("hourminute", -2.0646264558946954),
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -infinity, unseen = -3.044522437723423,
                               likelihoods = HashMap.fromList [], n = 0},
                   koData =
                     ClassData{prior = 0.0, unseen = -6.171700597410915,
                               likelihoods =
                                 HashMap.fromList
                                   [("number suffix: \21313|\25342month (grain)",
                                     -4.560172820057356),
                                    ("week", -2.9507349076232554),
                                    ("integer (0..10)month (grain)", -2.7684133508293005),
                                    ("integer (0..10)hour (grain)", -3.0341165165623063),
                                    ("<number>\20010/\20491week (grain)", -3.7717154596930853),
                                    ("second", -3.5305534028761976),
                                    ("integer (0..10)day (grain)", -3.0341165165623063),
                                    ("integer (0..10)year (grain)", -3.8670256394974105),
                                    ("<number>\20010/\20491month (grain)", -3.397022010251675),
                                    ("integer (numeric)year (grain)", -2.2984097215835653),
                                    ("integer (0..10)second (grain)", -3.5305534028761976),
                                    ("day", -3.0341165165623063), ("year", -2.1265594646569057),
                                    ("integer (0..10)minute (grain)", -3.0341165165623063),
                                    ("hour", -3.0341165165623063),
                                    ("integer (0..10)week (grain)", -3.461560531389246),
                                    ("month", -1.995223462595819),
                                    ("integer (numeric)month (grain)", -3.33639738843524),
                                    ("integer with consecutive unit modifiersminute (grain)",
                                     -4.223700583436143),
                                    ("minute", -2.802314902504982)],
                               n = 229}}),
       ("\32769\26495\33410",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.3862943611198906,
       ...
       ("integer (0..10)",
        Classifier{okData =
                     ClassData{prior = -0.6317126453599652, unseen = -5.272999558563747,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 193},
                   koData =
                     ClassData{prior = -0.7586043972145889, unseen = -5.147494476813453,
       ...
       ("<number>\20010/\20491",
        Classifier{okData =
                     ClassData{prior = -0.14842000511827333,
                               unseen = -3.295836866004329,
                               likelihoods = HashMap.fromList [("integer (0..10)", 0.0)], n = 25},
                   koData =
