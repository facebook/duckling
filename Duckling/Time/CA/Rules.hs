...
rulePeriodicHolidays = mkRuleHolidays
  ...
  , ( "Dia Mundial de la Llengua Àrab", "dia mundial de la lengua (á|a)rabe", monthDay 12 18 )
 ...
 -- , ( "Dia de Todos los Santos", "(dia|festividad) de todos los santos", monthDay 10 31 ) Tots sants és l'1 de novembre
  ...
  -- Other
  , ( "Dia de el cap", "(el )?dia (nacional )?de el cap"
...
rules =
  ...
  , ruleInThePartofday
--  , ruleIntegerInThePartofday -- Regla comentada 
  , ruleIntersect
  , ruleIntersectByDe
  , ruleLaCyclePasado
  , ruleLaPasadoCycle
