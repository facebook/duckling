...
allExamples = concat
  ...
  , examples (datetime (2013, 3, 25, 0, 0, 0) Day)
             [ "последний понедельник в марте"
             ]
  , examples (datetime (2014, 3, 30, 0, 0, 0) Day)
             [ "последнее воскресенье в марте 2014"
             ]
  , examples (datetime (2013, 10, 3, 0, 0, 0) Day)
             [ "третий день в октябре"
             ]
  , examples (datetime (2014, 10, 6, 0, 0, 0) Week)
             [ "первая неделя в октябре 2014"
             ]
  ...
  , examples (datetime (2014, 9, 16, 0, 0, 0) Day)
             [ "третий вторник в сентябре 2014"
             ]
