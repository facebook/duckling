...
ruleSeasons = mkRuleSeasons
  [ ( "лето"  , "лето"  , monthDay  6  1, monthDay  8 31 )
...
ruleHolidays = mkRuleHolidays
  ...
  , ( "Рождество Христово"         , "рождество"
    , monthDay  1  7 )
  , ( "День защитника отечества"   , "день защитника"
    , monthDay 2 23 )
  , ( "Международный женский день" , "международный женский день"
    , monthDay  3  8 )
  , ( "День смеха"                 , "день смеха"
    , monthDay  4  1 )
  , ( "Праздник Весны и Труда"     , "день труда"
    , monthDay  5  1 )
  , ( "День Победы"                , "День Победы"
    , monthDay  5  9 )
  , ( "День России"                , "день россии"
    , monthDay  6 12 )
  , ( "День народного единства"    , "день единства"
    , monthDay  11 4 )
  ]
...
ruleLastTime = Rule
  { name = "last <time>"
  , pattern =
    [ regex "(в )?прошл(ый|ого|ому|ом|ые|ых|ым|ыми)"
