...
ruleInstants = mkRuleInstants
  [ ( "now"             , TG.Second,  0, "ş?imdi|hemen|anında|şu(\\s)?an"                                )
...
ruleSeasons = mkRuleSeasons
  [ ( "yaz",      "yaz(ın|a|dan)?",      monthDay  6  1, monthDay  8  31 )
  , ( "sonbahar", "sonbahar(ın|a|dan)?", monthDay  9  1, monthDay  11 30 )
  , ( "kış",      "kış(ın|a|tan)?",      monthDay  12 1, monthDay  2  28 )
  , ( "ilkbahar", "ilkbahar(ın|a|dan)?", monthDay  3  1, monthDay  5  31 )
  ]
