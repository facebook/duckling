...
grains = [ ("second (grain)", "\x79d2(\x949f|\x9418)?", TG.Second)
         ...
         , ("hour (grain)", "\x5c0f\x65f6|\x5c0f\x6642|\x500b\x9418", TG.Hour)
         , ("day (grain)", "\x5929|\x65e5", TG.Day)
         , ("week (grain)", "\x5468|\x9031|\x793c\x62dc|\x79ae\x62dc|\x661f\x671f", TG.Week)
         , ("month (grain)", "(\x500b)?\x6708", TG.Month)
